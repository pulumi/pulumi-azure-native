...
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb:GremlinResourceGremlinGraph';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.GremlinGraphGetPropertiesResponse>;
    /**
...
export interface GremlinResourceGremlinGraphArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.GremlinGraphCreateUpdateProperties>;
    /**
