...
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/preview:GremlinResourceGremlinGraph';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.documentdb.preview.ManagedServiceIdentityResponse | undefined>;
    /**
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.preview.GremlinGraphGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.preview.GremlinGraphGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: GremlinResourceGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:GremlinResourceGremlinGraph" }, { type: "azurerm:documentdb/v20190801:GremlinResourceGremlinGraph" }, { type: "azurerm:documentdb/v20191212:GremlinResourceGremlinGraph" }, { type: "azurerm:documentdb/v20200301:GremlinResourceGremlinGraph" }, { type: "azurerm:documentdb/v20200401:GremlinResourceGremlinGraph" }, { type: "azurerm:documentdb/v20200601preview:GremlinResourceGremlinGraph" }] };
...
export interface GremlinResourceGremlinGraphArgs {
     ...
     * Identity for the resource.
     */
    readonly identity?: pulumi.Input<inputs.documentdb.preview.ManagedServiceIdentity>;
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     */
    readonly options: pulumi.Input<inputs.documentdb.preview.CreateUpdateOptions>;
    /**
     * The standard JSON format of a Gremlin graph
     */
    readonly resource: pulumi.Input<inputs.documentdb.preview.GremlinGraphResource>;
    /**
