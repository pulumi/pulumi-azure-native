...
export class DatabaseAccountMongoDBCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/preview:DatabaseAccountMongoDBCollection';
     ...
     * List of index keys
     */
    public /*out*/ readonly indexes!: pulumi.Output<outputs.documentdb.preview.MongoIndexResponse[] | undefined>;
    /**
