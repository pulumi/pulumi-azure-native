...
export class DatabaseAccountSqlDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/preview:DatabaseAccountSqlDatabase';
...
export interface DatabaseAccountSqlDatabaseArgs {
     ...
     */
    readonly resource: pulumi.Input<inputs.documentdb.preview.SqlDatabaseResource>;
    /**
