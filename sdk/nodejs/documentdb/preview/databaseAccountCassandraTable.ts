...
export class DatabaseAccountCassandraTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/preview:DatabaseAccountCassandraTable';
     ...
     */
    public /*out*/ readonly schema!: pulumi.Output<outputs.documentdb.preview.CassandraSchemaResponse | undefined>;
    /**
...
export interface DatabaseAccountCassandraTableArgs {
     ...
     */
    readonly resource: pulumi.Input<inputs.documentdb.preview.CassandraTableResource>;
    /**
