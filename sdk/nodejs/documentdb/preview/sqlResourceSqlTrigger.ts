...
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/preview:SqlResourceSqlTrigger';
    ...
    public readonly resource!: pulumi.Output<outputs.documentdb.preview.SqlTriggerGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlTriggerArgs {
     ...
     */
    readonly resource: pulumi.Input<inputs.documentdb.preview.SqlTriggerResource>;
    /**
