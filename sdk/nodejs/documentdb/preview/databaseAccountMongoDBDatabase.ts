...
export class DatabaseAccountMongoDBDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/preview:DatabaseAccountMongoDBDatabase';
...
export interface DatabaseAccountMongoDBDatabaseArgs {
     ...
     */
    readonly resource: pulumi.Input<inputs.documentdb.preview.MongoDBDatabaseResource>;
    /**
