...
export function getCassandraResourceCassandraKeyspace(args: GetCassandraResourceCassandraKeyspaceArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraResourceCassandraKeyspaceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:documentdb/preview:getCassandraResourceCassandraKeyspace", {
...
export interface GetCassandraResourceCassandraKeyspaceResult {
    ...
    readonly options?: outputs.documentdb.preview.CassandraKeyspaceGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.preview.CassandraKeyspaceGetPropertiesResponseResource;
    /**
