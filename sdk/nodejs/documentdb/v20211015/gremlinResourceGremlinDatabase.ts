...
export class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20211015:GremlinResourceGremlinDatabase';
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20211015.GremlinDatabaseGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20211015.GremlinDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface GremlinResourceGremlinDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20211015.GremlinDatabaseCreateUpdatePropertiesArgs>;
    /**
