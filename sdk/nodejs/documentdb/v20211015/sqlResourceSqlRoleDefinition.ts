...
export class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlResourceSqlRoleDefinition {
        pulumi.log.warn("SqlResourceSqlRoleDefinition is deprecated: azure-native:documentdb/v20211015:SqlResourceSqlRoleDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:SqlResourceSqlRoleDefinition to guarantee forwards compatibility.")
