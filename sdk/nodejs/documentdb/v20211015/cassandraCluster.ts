...
export class CassandraCluster extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraCluster {
        pulumi.log.warn("CassandraCluster is deprecated: azure-native:documentdb/v20211015:CassandraCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:CassandraCluster to guarantee forwards compatibility.")
