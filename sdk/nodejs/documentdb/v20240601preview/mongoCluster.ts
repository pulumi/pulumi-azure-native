...
export class MongoCluster extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20240601preview.MongoClusterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: MongoClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb/v20230301preview:MongoCluster" }, { type: "azure-native:documentdb/v20230315preview:MongoCluster" }, { type: "azure-native:documentdb/v20230915preview:MongoCluster" }, { type: "azure-native:documentdb/v20231115preview:MongoCluster" }, { type: "azure-native:documentdb/v20240215preview:MongoCluster" }, { type: "azure-native:documentdb/v20240301preview:MongoCluster" }, { type: "azure-native:documentdb/v20240701:MongoCluster" }, { type: "azure-native:documentdb/v20241001preview:MongoCluster" }, { type: "azure-native:documentdb:MongoCluster" }] };
...
export interface MongoClusterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.documentdb.v20240601preview.MongoClusterPropertiesArgs>;
    /**
