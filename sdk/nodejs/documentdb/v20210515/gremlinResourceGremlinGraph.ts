...
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20210515.GremlinGraphGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20210515.GremlinGraphGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: GremlinResourceGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.documentdb.v20210515.gremlinGraphCreateUpdatePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface GremlinResourceGremlinGraphArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20210515.GremlinGraphCreateUpdatePropertiesArgs>;
    /**
