...
export class DatabaseAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20210515:DatabaseAccount';
     ...
     */
    public readonly analyticalStorageConfiguration!: pulumi.Output<outputs.documentdb.v20210515.AnalyticalStorageConfigurationResponse | undefined>;
    /**
     * API specific properties.
     */
    public readonly apiProperties!: pulumi.Output<outputs.documentdb.v20210515.ApiPropertiesResponse | undefined>;
    /**
     * The object representing the policy for taking backups on an account.
     */
    public readonly backupPolicy!: pulumi.Output<outputs.documentdb.v20210515.ContinuousModeBackupPolicyResponse | outputs.documentdb.v20210515.PeriodicModeBackupPolicyResponse | undefined>;
    /**
     * List of Cosmos DB capabilities for the account
     */
    public readonly capabilities!: pulumi.Output<outputs.documentdb.v20210515.CapabilityResponse[] | undefined>;
    /**
     ...
     */
    public readonly consistencyPolicy!: pulumi.Output<outputs.documentdb.v20210515.ConsistencyPolicyResponse | undefined>;
    /**
     * The CORS policy for the Cosmos DB database account.
     */
    public readonly cors!: pulumi.Output<outputs.documentdb.v20210515.CorsPolicyResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly failoverPolicies!: pulumi.Output<outputs.documentdb.v20210515.FailoverPolicyResponse[]>;
    /**
     * Identity for the resource.
     */
    public readonly identity!: pulumi.Output<outputs.documentdb.v20210515.ManagedServiceIdentityResponse | undefined>;
    /**
     * List of IpRules.
     */
    public readonly ipRules!: pulumi.Output<outputs.documentdb.v20210515.IpAddressOrRangeResponse[] | undefined>;
    /**
     ...
     */
    public readonly locations!: pulumi.Output<outputs.documentdb.v20210515.LocationResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.documentdb.v20210515.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly readLocations!: pulumi.Output<outputs.documentdb.v20210515.LocationResponse[]>;
    /**
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<outputs.documentdb.v20210515.VirtualNetworkRuleResponse[] | undefined>;
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    public /*out*/ readonly writeLocations!: pulumi.Output<outputs.documentdb.v20210515.LocationResponse[]>;
    ...
    constructor(name: string, args: DatabaseAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["analyticalStorageConfiguration"] = args ? args.analyticalStorageConfiguration : undefined;
            ...
            inputs["analyticalStorageConfiguration"] = undefined /*out*/;
...
export interface DatabaseAccountArgs {
     ...
     * Analytical storage specific properties.
     */
    analyticalStorageConfiguration?: pulumi.Input<inputs.documentdb.v20210515.AnalyticalStorageConfigurationArgs>;
    /**
     * API specific properties. Currently, supported only for MongoDB API.
     */
    apiProperties?: pulumi.Input<inputs.documentdb.v20210515.ApiPropertiesArgs>;
    /**
     * The object representing the policy for taking backups on an account.
     */
    backupPolicy?: pulumi.Input<inputs.documentdb.v20210515.ContinuousModeBackupPolicyArgs | inputs.documentdb.v20210515.PeriodicModeBackupPolicyArgs>;
    /**
     * List of Cosmos DB capabilities for the account
     */
    capabilities?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210515.CapabilityArgs>[]>;
    /**
     * The cassandra connector offer type for the Cosmos DB database C* account.
     */
    connectorOffer?: pulumi.Input<string | enums.documentdb.v20210515.ConnectorOffer>;
    /**
     * The consistency policy for the Cosmos DB account.
     */
    consistencyPolicy?: pulumi.Input<inputs.documentdb.v20210515.ConsistencyPolicyArgs>;
    /**
     * The CORS policy for the Cosmos DB database account.
     */
    cors?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210515.CorsPolicyArgs>[]>;
    /**
     * The offer type for the database
     */
    databaseAccountOfferType: pulumi.Input<enums.documentdb.v20210515.DatabaseAccountOfferType>;
    /**
     * The default identity for accessing key vault used in features like customer managed keys. The default identity needs to be explicitly set by the users. It can be "FirstPartyIdentity", "SystemAssignedIdentity" and more.
     */
     ...
     * Identity for the resource.
     */
    identity?: pulumi.Input<inputs.documentdb.v20210515.ManagedServiceIdentityArgs>;
    /**
     * List of IpRules.
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210515.IpAddressOrRangeArgs>[]>;
    /**
     * Flag to indicate whether to enable/disable Virtual Network ACL rules.
     */
     ...
     * Indicates the type of database account. This can only be set at database account creation.
     */
    kind?: pulumi.Input<string | enums.documentdb.v20210515.DatabaseAccountKind>;
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     */
    locations: pulumi.Input<pulumi.Input<inputs.documentdb.v20210515.LocationArgs>[]>;
    /**
     * Indicates what services are allowed to bypass firewall checks.
     */
    networkAclBypass?: pulumi.Input<enums.documentdb.v20210515.NetworkAclBypass>;
    /**
     * An array that contains the Resource Ids for Network Acl Bypass for the Cosmos DB account.
     */
     ...
     * Whether requests from Public Network are allowed
     */
    publicNetworkAccess?: pulumi.Input<string | enums.documentdb.v20210515.PublicNetworkAccess>;
    /**
     ...
     * List of Virtual Network ACL rules configured for the Cosmos DB account.
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210515.VirtualNetworkRuleArgs>[]>;
}
