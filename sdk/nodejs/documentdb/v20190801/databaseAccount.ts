...
export class DatabaseAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20190801:DatabaseAccount';
     ...
     */
    public readonly capabilities!: pulumi.Output<outputs.documentdb.v20190801.CapabilityResponse[] | undefined>;
    /**
     ...
     */
    public readonly consistencyPolicy!: pulumi.Output<outputs.documentdb.v20190801.ConsistencyPolicyResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly failoverPolicies!: pulumi.Output<outputs.documentdb.v20190801.FailoverPolicyResponse[]>;
    /**
     ...
     */
    public readonly locations!: pulumi.Output<outputs.documentdb.v20190801.LocationResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly readLocations!: pulumi.Output<outputs.documentdb.v20190801.LocationResponse[]>;
    /**
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<outputs.documentdb.v20190801.VirtualNetworkRuleResponse[] | undefined>;
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    public /*out*/ readonly writeLocations!: pulumi.Output<outputs.documentdb.v20190801.LocationResponse[]>;
    ...
    constructor(name: string, args: DatabaseAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:documentdb/v20190801:DatabaseAccount" }, { type: "azure-native:documentdb:DatabaseAccount" }, { type: "azure-nextgen:documentdb:DatabaseAccount" }, { type: "azure-native:documentdb/v20150401:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20150401:DatabaseAccount" }, { type: "azure-native:documentdb/v20150408:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20150408:DatabaseAccount" }, { type: "azure-native:documentdb/v20151106:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20151106:DatabaseAccount" }, { type: "azure-native:documentdb/v20160319:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20160319:DatabaseAccount" }, { type: "azure-native:documentdb/v20160331:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20160331:DatabaseAccount" }, { type: "azure-native:documentdb/v20191212:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20191212:DatabaseAccount" }, { type: "azure-native:documentdb/v20200301:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20200301:DatabaseAccount" }, { type: "azure-native:documentdb/v20200401:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20200401:DatabaseAccount" }, { type: "azure-native:documentdb/v20200601preview:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20200601preview:DatabaseAccount" }, { type: "azure-native:documentdb/v20200901:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20200901:DatabaseAccount" }, { type: "azure-native:documentdb/v20210115:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20210115:DatabaseAccount" }, { type: "azure-native:documentdb/v20210301preview:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20210301preview:DatabaseAccount" }, { type: "azure-native:documentdb/v20210315:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20210315:DatabaseAccount" }, { type: "azure-native:documentdb/v20210401preview:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20210401preview:DatabaseAccount" }] };
...
export interface DatabaseAccountArgs {
     ...
     * List of Cosmos DB capabilities for the account
     */
    readonly capabilities?: pulumi.Input<pulumi.Input<inputs.documentdb.v20190801.CapabilityArgs>[]>;
    /**
     * The cassandra connector offer type for the Cosmos DB database C* account.
     */
    readonly connectorOffer?: pulumi.Input<string | enums.documentdb.v20190801.ConnectorOffer>;
    /**
     * The consistency policy for the Cosmos DB account.
     */
    readonly consistencyPolicy?: pulumi.Input<inputs.documentdb.v20190801.ConsistencyPolicyArgs>;
    /**
     * The offer type for the database
     */
    readonly databaseAccountOfferType: pulumi.Input<enums.documentdb.v20190801.DatabaseAccountOfferType>;
    /**
     * Disable write operations on metadata resources (databases, containers, throughput) via account keys
     */
     ...
     * Indicates the type of database account. This can only be set at database account creation.
     */
    readonly kind?: pulumi.Input<string | enums.documentdb.v20190801.DatabaseAccountKind>;
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     */
    readonly locations: pulumi.Input<pulumi.Input<inputs.documentdb.v20190801.LocationArgs>[]>;
    /**
     ...
     * List of Virtual Network ACL rules configured for the Cosmos DB account.
     */
    readonly virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.documentdb.v20190801.VirtualNetworkRuleArgs>[]>;
}
