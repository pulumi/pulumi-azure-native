 ...
 *
 * const sqlResourceSqlDatabase = new azure_native.documentdb.v20190801.SqlResourceSqlDatabase("sqlResourceSqlDatabase", {
 *     accountName: "ddb1",
