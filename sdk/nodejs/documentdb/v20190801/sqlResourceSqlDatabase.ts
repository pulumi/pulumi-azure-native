...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: SqlResourceSqlDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/v20191212:SqlResourceSqlDatabase" }, { type: "azurerm:documentdb/v20200301:SqlResourceSqlDatabase" }, { type: "azurerm:documentdb/v20200401:SqlResourceSqlDatabase" }] };
