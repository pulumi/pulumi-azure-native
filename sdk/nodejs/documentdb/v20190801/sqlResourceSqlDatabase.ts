...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20190801.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20190801.SqlDatabaseCreateUpdatePropertiesArgs>;
    /**
