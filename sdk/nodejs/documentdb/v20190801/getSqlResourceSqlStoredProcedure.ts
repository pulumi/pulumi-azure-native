...
export function getSqlResourceSqlStoredProcedure(args: GetSqlResourceSqlStoredProcedureArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlStoredProcedureResult> {
    pulumi.log.warn("getSqlResourceSqlStoredProcedure is deprecated: Version v20190801 will be removed in the next major version of the provider. Upgrade to version v20210301preview or later.")
    if (!opts) {
        opts = {}
    }
