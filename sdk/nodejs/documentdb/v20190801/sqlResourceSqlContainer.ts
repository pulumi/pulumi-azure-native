 ...
 *
 * const sqlResourceSqlContainer = new azure_native.documentdb.v20190801.SqlResourceSqlContainer("sqlResourceSqlContainer", {
 *     accountName: "ddb1",
...
export class SqlResourceSqlContainer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlResourceSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20190801.sqlContainerResourceArgsProvideDefaults) : undefined) : undefined;
