 ...
 *
 * const mongoDBResourceMongoDBCollection = new azurerm.documentdb.v20190801.MongoDBResourceMongoDBCollection("mongoDBResourceMongoDBCollection", {
 *     accountName: "ddb1",
...
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20190801:MongoDBResourceMongoDBCollection';
    ...
    public readonly resource!: pulumi.Output<outputs.documentdb.v20190801.MongoDBCollectionGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MongoDBResourceMongoDBCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:MongoDBResourceMongoDBCollection" }, { type: "azurerm:documentdb/v20191212:MongoDBResourceMongoDBCollection" }, { type: "azurerm:documentdb/v20200301:MongoDBResourceMongoDBCollection" }, { type: "azurerm:documentdb/v20200401:MongoDBResourceMongoDBCollection" }] };
