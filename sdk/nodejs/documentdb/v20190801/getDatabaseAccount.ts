...
export function getDatabaseAccount(args: GetDatabaseAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseAccountResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:documentdb/v20190801:getDatabaseAccount", {
...
export interface GetDatabaseAccountResult {
     ...
     */
    readonly capabilities?: outputs.documentdb.v20190801.CapabilityInvokeResponse[];
    /**
     ...
     */
    readonly consistencyPolicy?: outputs.documentdb.v20190801.ConsistencyPolicyInvokeResponse;
    /**
     ...
     */
    readonly failoverPolicies: outputs.documentdb.v20190801.FailoverPolicyInvokeResponse[];
    /**
     ...
     */
    readonly locations: outputs.documentdb.v20190801.LocationInvokeResponse[];
    /**
     ...
     */
    readonly readLocations: outputs.documentdb.v20190801.LocationInvokeResponse[];
    /**
     ...
     */
    readonly virtualNetworkRules?: outputs.documentdb.v20190801.VirtualNetworkRuleInvokeResponse[];
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    readonly writeLocations: outputs.documentdb.v20190801.LocationInvokeResponse[];
}
