...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20190801.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20190801.MongoDBDatabaseCreateUpdatePropertiesArgs>;
    /**
