 ...
 *
 * const gremlinResourceGremlinGraph = new azure_native.documentdb.v20190801.GremlinResourceGremlinGraph("gremlinResourceGremlinGraph", {
 *     accountName: "ddb1",
...
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GremlinResourceGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20190801.gremlinGraphResourceArgsProvideDefaults) : undefined) : undefined;
