...
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20190801.GremlinGraphGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: GremlinResourceGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.documentdb.v20190801.gremlinGraphCreateUpdatePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface GremlinResourceGremlinGraphArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20190801.GremlinGraphCreateUpdatePropertiesArgs>;
    /**
