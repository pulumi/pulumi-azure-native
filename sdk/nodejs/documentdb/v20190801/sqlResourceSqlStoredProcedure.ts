 ...
 *
 * const sqlResourceSqlStoredProcedure = new azurerm.documentdb.v20190801.SqlResourceSqlStoredProcedure("sqlResourceSqlStoredProcedure", {
 *     accountName: "ddb1",
...
export class SqlResourceSqlStoredProcedure extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20190801:SqlResourceSqlStoredProcedure';
    ...
    constructor(name: string, argsOrState?: SqlResourceSqlStoredProcedureArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:SqlResourceSqlStoredProcedure" }, { type: "azurerm:documentdb/v20191212:SqlResourceSqlStoredProcedure" }, { type: "azurerm:documentdb/v20200301:SqlResourceSqlStoredProcedure" }, { type: "azurerm:documentdb/v20200401:SqlResourceSqlStoredProcedure" }] };
