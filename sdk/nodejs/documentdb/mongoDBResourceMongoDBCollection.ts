...
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.MongoDBCollectionGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.MongoDBCollectionGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBCollectionArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.MongoDBCollectionCreateUpdatePropertiesArgs>;
    /**
