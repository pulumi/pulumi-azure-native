...
export class GraphResourceGraph extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GraphResourceGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:GraphResourceGraph" }, { type: "azure-native:documentdb/v20210701preview:GraphResourceGraph" }, { type: "azure-native:documentdb/v20211015preview:GraphResourceGraph" }] };
