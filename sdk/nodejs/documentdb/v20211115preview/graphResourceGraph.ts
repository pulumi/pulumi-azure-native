...
export class GraphResourceGraph extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GraphResourceGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb/v20210701preview:GraphResourceGraph" }, { type: "azure-native:documentdb/v20211015preview:GraphResourceGraph" }, { type: "azure-native:documentdb/v20220215preview:GraphResourceGraph" }, { type: "azure-native:documentdb/v20220515preview:GraphResourceGraph" }] };
