...
export class CassandraResourceCassandraView extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20211115preview.CassandraViewGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20211115preview.CassandraViewGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: CassandraResourceCassandraViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb/v20210701preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20211015preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20220215preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20220515preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20220815preview:CassandraResourceCassandraView" }] };
