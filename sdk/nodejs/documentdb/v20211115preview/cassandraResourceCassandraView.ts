...
export class CassandraResourceCassandraView extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20211115preview:CassandraResourceCassandraView';
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20211115preview.CassandraViewGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20211115preview.CassandraViewGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: CassandraResourceCassandraViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20210701preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20211015preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20220215preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20220515preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20220815preview:CassandraResourceCassandraView" }] };
...
export interface CassandraResourceCassandraViewArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20211115preview.CassandraViewCreateUpdatePropertiesArgs>;
    /**
