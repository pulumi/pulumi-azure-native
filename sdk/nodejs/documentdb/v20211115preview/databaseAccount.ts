...
export class DatabaseAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseAccount {
        pulumi.log.warn("DatabaseAccount is deprecated: azure-native:documentdb/v20211115preview:DatabaseAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:DatabaseAccount to guarantee forwards compatibility.")
