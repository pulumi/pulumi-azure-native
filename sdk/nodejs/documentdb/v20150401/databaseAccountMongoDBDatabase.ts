 ...
 *
 * const databaseAccountMongoDBDatabase = new azurerm.documentdb.v20150401.DatabaseAccountMongoDBDatabase("databaseAccountMongoDBDatabase", {
 *     accountName: "ddb1",
