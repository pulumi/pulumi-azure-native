...
export class DatabaseAccountGremlinGraph extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseAccountGremlinGraph {
        pulumi.log.warn("DatabaseAccountGremlinGraph is deprecated: Version 2015-04-01 will be removed in v2 of the provider.")
    ...
    constructor(name: string, args: DatabaseAccountGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.documentdb.v20150401.gremlinGraphCreateUpdatePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface DatabaseAccountGremlinGraphArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20150401.GremlinGraphCreateUpdatePropertiesArgs>;
    /**
