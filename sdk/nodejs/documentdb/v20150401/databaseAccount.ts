...
export interface DatabaseAccountArgs {
     ...
     * List of Cosmos DB capabilities for the account
     */
    readonly capabilities?: pulumi.Input<pulumi.Input<inputs.documentdb.v20150401.CapabilityArgs>[]>;
    /**
     * The cassandra connector offer type for the Cosmos DB database C* account.
     */
     ...
     */
    readonly consistencyPolicy?: pulumi.Input<inputs.documentdb.v20150401.ConsistencyPolicyArgs>;
    /**
     ...
     */
    readonly locations: pulumi.Input<pulumi.Input<inputs.documentdb.v20150401.LocationArgs>[]>;
    /**
     ...
     * List of Virtual Network ACL rules configured for the Cosmos DB account.
     */
    readonly virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.documentdb.v20150401.VirtualNetworkRuleArgs>[]>;
}
