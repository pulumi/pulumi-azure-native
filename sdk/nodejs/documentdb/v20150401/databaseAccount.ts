...
export class DatabaseAccount extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20150401.DatabaseAccountPropertiesResponse>;
    /**
...
export interface DatabaseAccountArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.v20150401.DatabaseAccountCreateUpdateProperties>;
    /**
