...
export class DatabaseAccountTable extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20150401.TablePropertiesResponse>;
    /**
...
export interface DatabaseAccountTableArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.v20150401.TableCreateUpdateProperties>;
    /**
