 ...
 *
 * const databaseAccountCassandraTable = new azurerm.documentdb.v20150401.DatabaseAccountCassandraTable("databaseAccountCassandraTable", {
 *     accountName: "ddb1",
