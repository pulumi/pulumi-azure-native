...
export class DatabaseAccountSqlDatabase extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20150401.SqlDatabasePropertiesResponse>;
    /**
...
export interface DatabaseAccountSqlDatabaseArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.v20150401.SqlDatabaseCreateUpdateProperties>;
    /**
