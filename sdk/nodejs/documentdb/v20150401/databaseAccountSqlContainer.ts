...
azure-native:documentdb/v20150401:DatabaseAccountSqlContainer is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20160331:DatabaseAccountSqlContainer to guarantee forwards compatibility.
 */
export class DatabaseAccountSqlContainer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseAccountSqlContainer {
        pulumi.log.warn("DatabaseAccountSqlContainer is deprecated: Version 2015-04-01 will be removed in v2 of the provider.\nazure-native:documentdb/v20150401:DatabaseAccountSqlContainer is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20160331:DatabaseAccountSqlContainer to guarantee forwards compatibility.")
...
azure-native:documentdb/v20150401:DatabaseAccountSqlContainer is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20160331:DatabaseAccountSqlContainer to guarantee forwards compatibility. */
    constructor(name: string, args: DatabaseAccountSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20150401.sqlContainerResourceArgsProvideDefaults) : undefined) : undefined;
