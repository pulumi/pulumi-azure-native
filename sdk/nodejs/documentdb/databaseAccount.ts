...
export class DatabaseAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb:DatabaseAccount';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.DatabaseAccountGetPropertiesResponse>;
    /**
...
export interface DatabaseAccountArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.DatabaseAccountCreateUpdateProperties>;
    /**
