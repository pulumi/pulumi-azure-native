...
export class DatabaseAccountMongodbDatabase extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatabaseAccountMongodbDatabaseState, opts?: pulumi.CustomResourceOptions): DatabaseAccountMongodbDatabase {
        return new DatabaseAccountMongodbDatabase(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb:DatabaseAccountMongodbDatabase';
    ...
    constructor(name: string, argsOrState?: DatabaseAccountMongodbDatabaseArgs | DatabaseAccountMongodbDatabaseState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as DatabaseAccountMongodbDatabaseState | undefined;
 ...
 * An Azure Cosmos DB MongoDB database.
 */
export interface DatabaseAccountMongodbDatabaseState {
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     * The properties of an Azure Cosmos DB MongoDB database
     */
    readonly properties: pulumi.Input<inputs.documentdb.MongoDBDatabaseGetPropertiesResponse>;
    /**
     * Tags are a list of key-value pairs that describe the resource. These tags can be used in viewing and grouping this resource (across resource groups). A maximum of 15 tags can be provided for a resource. Each tag must have a key no greater than 128 characters and value no greater than 256 characters. For example, the default experience for a template type is set with "defaultExperience": "Cassandra". Current "defaultExperience" values also include "Table", "Graph", "DocumentDB", and "MongoDB".
     */
