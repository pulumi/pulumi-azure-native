...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315:MongoDBResourceMongoDBDatabase';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20230315.MongoDBDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20230315.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: MongoDBResourceMongoDBDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:MongoDBResourceMongoDBDatabase" }, { type: "azure-native:documentdb/v20210301preview:MongoDBResourceMongoDBDatabase" }, { type: "azure-native:documentdb/v20210315:MongoDBResourceMongoDBDatabase" }, { type: "azure-native:documentdb/v20210401preview:MongoDBResourceMongoDBDatabase" }, { type: "azure-native:documentdb/v20210701preview:MongoDBResourceMongoDBDatabase" }, { type: "azure-native:documentdb/v20211015preview:MongoDBResourceMongoDBDatabase" }, { type: "azure-native:documentdb/v20220815preview:MongoDBResourceMongoDBDatabase" }, { type: "azure-native:documentdb/v20221115preview:MongoDBResourceMongoDBDatabase" }, { type: "azure-native:documentdb/v20230301preview:MongoDBResourceMongoDBDatabase" }, { type: "azure-native:documentdb/v20230315preview:MongoDBResourceMongoDBDatabase" }, { type: "azure-native:documentdb/v20230415:MongoDBResourceMongoDBDatabase" }] };
...
export interface MongoDBResourceMongoDBDatabaseArgs {
     ...
     */
    options?: pulumi.Input<inputs.documentdb.v20230315.CreateUpdateOptionsArgs>;
    /**
     * The standard JSON format of a MongoDB database
     */
    resource: pulumi.Input<inputs.documentdb.v20230315.MongoDBDatabaseResourceArgs>;
    /**
