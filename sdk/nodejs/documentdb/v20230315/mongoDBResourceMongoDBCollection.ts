 ...
 *
 * const mongoDBResourceMongoDBCollection = new azure_native.documentdb.v20230315.MongoDBResourceMongoDBCollection("mongoDBResourceMongoDBCollection", {
 *     accountName: "ddb1",
...
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315:MongoDBResourceMongoDBCollection';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20230315.MongoDBCollectionGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20230315.MongoDBCollectionGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBCollectionArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20230315.MongoDBCollectionResourceArgs>;
    /**
