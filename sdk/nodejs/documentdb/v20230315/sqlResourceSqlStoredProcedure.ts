 ...
 *
 * const sqlResourceSqlStoredProcedure = new azure_native.documentdb.v20230315.SqlResourceSqlStoredProcedure("sqlResourceSqlStoredProcedure", {
 *     accountName: "ddb1",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:documentdb/v20230315:SqlResourceSqlStoredProcedure storedProcedureName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/sqlDatabases/databaseName/sqlContainers/containerName/sqlStoredProcedures/storedProcedureName 
 * ```
 */
export class SqlResourceSqlStoredProcedure extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315:SqlResourceSqlStoredProcedure';
    ...
    public readonly resource!: pulumi.Output<outputs.documentdb.v20230315.SqlStoredProcedureGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlStoredProcedureArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20230315.SqlStoredProcedureResourceArgs>;
    /**
