...
export class MongoDBResourceMongoRoleDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MongoDBResourceMongoRoleDefinition {
        pulumi.log.warn("MongoDBResourceMongoRoleDefinition is deprecated: azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:MongoDBResourceMongoRoleDefinition to guarantee forwards compatibility.")
