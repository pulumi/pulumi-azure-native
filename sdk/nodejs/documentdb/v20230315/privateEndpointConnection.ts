 ...
 *
 * const privateEndpointConnection = new azure_native.documentdb.v20230315.PrivateEndpointConnection("privateEndpointConnection", {
 *     accountName: "ddb1",
