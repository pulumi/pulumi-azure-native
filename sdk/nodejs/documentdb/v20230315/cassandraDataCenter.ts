 ...
 *
 * const cassandraDataCenter = new azure_native.documentdb.v20230315.CassandraDataCenter("cassandraDataCenter", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:documentdb/v20230315:CassandraDataCenter dc1 /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/cassandra-prod-rg/providers/Microsoft.DocumentDB/cassandraClusters/cassandra-prod/dataCenters/dc1 
 * ```
 */
export class CassandraDataCenter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315:CassandraDataCenter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20230315.DataCenterResourceResponseProperties>;
    /**
...
export interface CassandraDataCenterArgs {
     ...
     * Properties of a managed Cassandra data center.
     */
    properties?: pulumi.Input<inputs.documentdb.v20230315.DataCenterResourcePropertiesArgs>;
    /**
