 ...
 *
 * const sqlResourceSqlRoleAssignment = new azure_native.documentdb.v20230315.SqlResourceSqlRoleAssignment("sqlResourceSqlRoleAssignment", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:documentdb/v20230315:SqlResourceSqlRoleAssignment myRoleAssignmentId /subscriptions/mySubscriptionId/resourceGroups/myResourceGroupName/providers/Microsoft.DocumentDB/databaseAccounts/myAccountName/sqlRoleAssignments/myRoleAssignmentId 
 * ```
 */
export class SqlResourceSqlRoleAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315:SqlResourceSqlRoleAssignment';
