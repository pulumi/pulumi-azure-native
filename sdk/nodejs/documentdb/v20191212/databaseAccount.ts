...
export class DatabaseAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20191212:DatabaseAccount';
     ...
     */
    public readonly capabilities!: pulumi.Output<outputs.documentdb.v20191212.CapabilityResponse[] | undefined>;
    /**
     ...
     */
    public readonly consistencyPolicy!: pulumi.Output<outputs.documentdb.v20191212.ConsistencyPolicyResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly failoverPolicies!: pulumi.Output<outputs.documentdb.v20191212.FailoverPolicyResponse[]>;
    /**
     ...
     */
    public readonly locations!: pulumi.Output<outputs.documentdb.v20191212.LocationResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly readLocations!: pulumi.Output<outputs.documentdb.v20191212.LocationResponse[]>;
    /**
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<outputs.documentdb.v20191212.VirtualNetworkRuleResponse[] | undefined>;
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    public /*out*/ readonly writeLocations!: pulumi.Output<outputs.documentdb.v20191212.LocationResponse[]>;
    ...
    constructor(name: string, args: DatabaseAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:documentdb/v20191212:DatabaseAccount" }, { type: "azure-native:documentdb:DatabaseAccount" }, { type: "azure-nextgen:documentdb:DatabaseAccount" }, { type: "azure-native:documentdb/latest:DatabaseAccount" }, { type: "azure-nextgen:documentdb/latest:DatabaseAccount" }, { type: "azure-native:documentdb/v20150401:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20150401:DatabaseAccount" }, { type: "azure-native:documentdb/v20150408:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20150408:DatabaseAccount" }, { type: "azure-native:documentdb/v20151106:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20151106:DatabaseAccount" }, { type: "azure-native:documentdb/v20160319:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20160319:DatabaseAccount" }, { type: "azure-native:documentdb/v20160331:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20160331:DatabaseAccount" }, { type: "azure-native:documentdb/v20190801:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20190801:DatabaseAccount" }, { type: "azure-native:documentdb/v20200301:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20200301:DatabaseAccount" }, { type: "azure-native:documentdb/v20200401:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20200401:DatabaseAccount" }, { type: "azure-native:documentdb/v20200601preview:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20200601preview:DatabaseAccount" }, { type: "azure-native:documentdb/v20200901:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20200901:DatabaseAccount" }, { type: "azure-native:documentdb/v20210115:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20210115:DatabaseAccount" }, { type: "azure-native:documentdb/v20210301preview:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20210301preview:DatabaseAccount" }, { type: "azure-native:documentdb/v20210315:DatabaseAccount" }, { type: "azure-nextgen:documentdb/v20210315:DatabaseAccount" }] };
...
export interface DatabaseAccountArgs {
     ...
     * List of Cosmos DB capabilities for the account
     */
    readonly capabilities?: pulumi.Input<pulumi.Input<inputs.documentdb.v20191212.Capability>[]>;
    /**
     * The cassandra connector offer type for the Cosmos DB database C* account.
     */
     ...
     */
    readonly consistencyPolicy?: pulumi.Input<inputs.documentdb.v20191212.ConsistencyPolicy>;
    /**
     ...
     * List of Virtual Network ACL rules configured for the Cosmos DB account.
     */
    readonly virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.documentdb.v20191212.VirtualNetworkRule>[]>;
}
