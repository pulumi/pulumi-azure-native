...
export class DatabaseAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseAccount {
        pulumi.log.warn("DatabaseAccount is deprecated: Version 2019-12-12 will be removed in v2 of the provider.")
     ...
     */
    public /*out*/ readonly capabilities!: pulumi.Output<outputs.documentdb.v20191212.CapabilityResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly consistencyPolicy!: pulumi.Output<outputs.documentdb.v20191212.ConsistencyPolicyResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly locations!: pulumi.Output<outputs.documentdb.v20191212.LocationResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly virtualNetworkRules!: pulumi.Output<outputs.documentdb.v20191212.VirtualNetworkRuleResponse[] | undefined>;
    /**
...
export interface DatabaseAccountArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20191212.DatabaseAccountCreateUpdatePropertiesArgs>;
    /**
