...
export class SqlResourceSqlUserDefinedFunction extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlResourceSqlUserDefinedFunction {
        pulumi.log.warn("SqlResourceSqlUserDefinedFunction is deprecated: Version 2019-12-12 will be removed in v2 of the provider.")
    ...
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20191212.SqlUserDefinedFunctionGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlUserDefinedFunctionArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20191212.SqlUserDefinedFunctionCreateUpdatePropertiesArgs>;
    /**
