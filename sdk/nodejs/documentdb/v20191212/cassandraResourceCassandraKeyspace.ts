...
export class CassandraResourceCassandraKeyspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraResourceCassandraKeyspace {
        pulumi.log.warn("CassandraResourceCassandraKeyspace is deprecated: Version 2019-12-12 will be removed in v2 of the provider.")
    ...
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20191212.CassandraKeyspaceGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraKeyspaceArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20191212.CassandraKeyspaceCreateUpdatePropertiesArgs>;
    /**
