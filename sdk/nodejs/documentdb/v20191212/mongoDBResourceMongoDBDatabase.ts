...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MongoDBResourceMongoDBDatabase {
        pulumi.log.warn("MongoDBResourceMongoDBDatabase is deprecated: Version 2019-12-12 will be removed in v2 of the provider.")
    ...
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20191212.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20191212.MongoDBDatabaseCreateUpdatePropertiesArgs>;
    /**
