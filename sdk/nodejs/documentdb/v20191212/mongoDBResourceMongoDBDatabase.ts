...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MongoDBResourceMongoDBDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:documentdb/latest:MongoDBResourceMongoDBDatabase" }, { type: "azure-nextgen:documentdb/v20190801:MongoDBResourceMongoDBDatabase" }, { type: "azure-nextgen:documentdb/v20200301:MongoDBResourceMongoDBDatabase" }, { type: "azure-nextgen:documentdb/v20200401:MongoDBResourceMongoDBDatabase" }, { type: "azure-nextgen:documentdb/v20200601preview:MongoDBResourceMongoDBDatabase" }] };
