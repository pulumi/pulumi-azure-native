...
export class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20211015preview:GremlinResourceGremlinDatabase';
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20211015preview.GremlinDatabaseGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20211015preview.GremlinDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface GremlinResourceGremlinDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20211015preview.GremlinDatabaseCreateUpdatePropertiesArgs>;
    /**
