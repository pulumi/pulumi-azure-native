 ...
 *
 * @deprecated azure-native:documentdb/v20211015preview:MongoDBResourceMongoDBDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:MongoDBResourceMongoDBDatabase to guarantee forwards compatibility.
 */
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20211015preview.MongoDBDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20211015preview.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**
