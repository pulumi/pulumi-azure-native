 ...
 *
 * @deprecated azure-native:documentdb/v20211015preview:SqlResourceSqlRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:SqlResourceSqlRoleDefinition to guarantee forwards compatibility.
 */
export class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlResourceSqlRoleDefinition {
        pulumi.log.warn("SqlResourceSqlRoleDefinition is deprecated: azure-native:documentdb/v20211015preview:SqlResourceSqlRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:SqlResourceSqlRoleDefinition to guarantee forwards compatibility.")
        return new SqlResourceSqlRoleDefinition(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20211015preview:SqlResourceSqlRoleDefinition';
     ...
     */
    public readonly permissions!: pulumi.Output<outputs.documentdb.v20211015preview.PermissionResponse[] | undefined>;
    /**
