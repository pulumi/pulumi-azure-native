...
export class TableResourceTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20211015preview:TableResourceTable';
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20211015preview.TableGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20211015preview.TableGetPropertiesResponseResource | undefined>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20211015preview.TableCreateUpdatePropertiesArgs>;
    /**
