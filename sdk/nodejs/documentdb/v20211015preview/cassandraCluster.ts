 ...
 *
 * @deprecated azure-native:documentdb/v20211015preview:CassandraCluster is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:CassandraCluster to guarantee forwards compatibility.
 */
export class CassandraCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20211015preview:CassandraCluster';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.documentdb.v20211015preview.ManagedCassandraManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20211015preview.ClusterResourceResponseProperties>;
    /**
