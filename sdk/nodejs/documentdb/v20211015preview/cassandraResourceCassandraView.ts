...
export class CassandraResourceCassandraView extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraResourceCassandraView {
        pulumi.log.warn("CassandraResourceCassandraView is deprecated: azure-native:documentdb/v20211015preview:CassandraResourceCassandraView is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:CassandraResourceCassandraView to guarantee forwards compatibility.")
