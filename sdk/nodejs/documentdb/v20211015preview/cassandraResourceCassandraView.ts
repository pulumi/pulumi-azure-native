 ...
 *
 * @deprecated azure-native:documentdb/v20211015preview:CassandraResourceCassandraView is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:CassandraResourceCassandraView to guarantee forwards compatibility.
 */
export class CassandraResourceCassandraView extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraResourceCassandraView {
        pulumi.log.warn("CassandraResourceCassandraView is deprecated: azure-native:documentdb/v20211015preview:CassandraResourceCassandraView is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:CassandraResourceCassandraView to guarantee forwards compatibility.")
        return new CassandraResourceCassandraView(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20211015preview:CassandraResourceCassandraView';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20211015preview.CassandraViewGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20211015preview.CassandraViewGetPropertiesResponseResource | undefined>;
    /**
