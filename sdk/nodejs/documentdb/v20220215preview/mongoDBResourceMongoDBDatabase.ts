...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220215preview:MongoDBResourceMongoDBDatabase';
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20220215preview.MongoDBDatabaseGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20220215preview.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20220215preview.MongoDBDatabaseCreateUpdatePropertiesArgs>;
    /**
