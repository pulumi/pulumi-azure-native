 ...
 *
 * @deprecated azure-native:documentdb/v20220215preview:CassandraResourceCassandraKeyspace is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:CassandraResourceCassandraKeyspace to guarantee forwards compatibility.
 */
export class CassandraResourceCassandraKeyspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraResourceCassandraKeyspace {
        pulumi.log.warn("CassandraResourceCassandraKeyspace is deprecated: azure-native:documentdb/v20220215preview:CassandraResourceCassandraKeyspace is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:CassandraResourceCassandraKeyspace to guarantee forwards compatibility.")
        return new CassandraResourceCassandraKeyspace(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220215preview:CassandraResourceCassandraKeyspace';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.documentdb.v20220215preview.ManagedServiceIdentityResponse | undefined>;
    /**
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20220215preview.CassandraKeyspaceGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220215preview.CassandraKeyspaceGetPropertiesResponseResource | undefined>;
    /**
