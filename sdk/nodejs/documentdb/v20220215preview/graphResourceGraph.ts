...
export class GraphResourceGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220215preview:GraphResourceGraph';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20220215preview.GraphResourceGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220215preview.GraphResourceGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: GraphResourceGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb/v20210701preview:GraphResourceGraph" }, { type: "azure-native:documentdb/v20211015preview:GraphResourceGraph" }, { type: "azure-native:documentdb/v20211115preview:GraphResourceGraph" }, { type: "azure-native:documentdb/v20220515preview:GraphResourceGraph" }] };
