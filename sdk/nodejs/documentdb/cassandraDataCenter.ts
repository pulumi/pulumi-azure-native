...
export class CassandraDataCenter extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CassandraDataCenterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:documentdb:CassandraDataCenter" }, { type: "azure-native:documentdb/v20210301preview:CassandraDataCenter" }, { type: "azure-nextgen:documentdb/v20210301preview:CassandraDataCenter" }, { type: "azure-native:documentdb/v20210401preview:CassandraDataCenter" }, { type: "azure-nextgen:documentdb/v20210401preview:CassandraDataCenter" }, { type: "azure-native:documentdb/v20210701preview:CassandraDataCenter" }, { type: "azure-nextgen:documentdb/v20210701preview:CassandraDataCenter" }] };
