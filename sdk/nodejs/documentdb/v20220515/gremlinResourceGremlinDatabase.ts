 ...
 *
 * @deprecated azure-native:documentdb/v20220515:GremlinResourceGremlinDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:GremlinResourceGremlinDatabase to guarantee forwards compatibility.
 */
export class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220515:GremlinResourceGremlinDatabase';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20220515.GremlinDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220515.GremlinDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface GremlinResourceGremlinDatabaseArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20220515.GremlinDatabaseResourceArgs>;
    /**
