 ...
 */
/** @deprecated azure-native:documentdb/v20221115:SqlResourceSqlRoleDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:SqlResourceSqlRoleDefinition to guarantee forwards compatibility. */
export function getSqlResourceSqlRoleDefinition(args: GetSqlResourceSqlRoleDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlRoleDefinitionResult> {
    pulumi.log.warn("getSqlResourceSqlRoleDefinition is deprecated: azure-native:documentdb/v20221115:SqlResourceSqlRoleDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:SqlResourceSqlRoleDefinition to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:documentdb/v20221115:getSqlResourceSqlRoleDefinition", {
...
export interface GetSqlResourceSqlRoleDefinitionResult {
     ...
     */
    readonly permissions?: outputs.documentdb.v20221115.PermissionResponse[];
    /**
