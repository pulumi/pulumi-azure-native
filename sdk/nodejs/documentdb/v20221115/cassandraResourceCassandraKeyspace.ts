...
export class CassandraResourceCassandraKeyspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraResourceCassandraKeyspace {
        pulumi.log.warn("CassandraResourceCassandraKeyspace is deprecated: azure-native:documentdb/v20221115:CassandraResourceCassandraKeyspace is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:CassandraResourceCassandraKeyspace to guarantee forwards compatibility.")
