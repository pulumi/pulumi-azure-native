...
export class CassandraResourceCassandraKeyspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraResourceCassandraKeyspace {
        pulumi.log.warn("CassandraResourceCassandraKeyspace is deprecated: azure-native:documentdb/v20221115:CassandraResourceCassandraKeyspace is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:CassandraResourceCassandraKeyspace to guarantee forwards compatibility.")
        return new CassandraResourceCassandraKeyspace(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20221115:CassandraResourceCassandraKeyspace';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20221115.CassandraKeyspaceGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20221115.CassandraKeyspaceGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraKeyspaceArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20221115.CassandraKeyspaceResourceArgs>;
    /**
