...
export class MongoDBResourceMongoUserDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MongoDBResourceMongoUserDefinition {
        pulumi.log.warn("MongoDBResourceMongoUserDefinition is deprecated: azure-native:documentdb/v20221115:MongoDBResourceMongoUserDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:MongoDBResourceMongoUserDefinition to guarantee forwards compatibility.")
        return new MongoDBResourceMongoUserDefinition(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20221115:MongoDBResourceMongoUserDefinition';
