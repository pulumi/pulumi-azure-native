...
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20221115:MongoDBResourceMongoDBCollection';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20221115.MongoDBCollectionGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20221115.MongoDBCollectionGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBCollectionArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20221115.MongoDBCollectionResourceArgs>;
    /**
