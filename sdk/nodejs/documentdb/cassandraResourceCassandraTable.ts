...
export class CassandraResourceCassandraTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb:CassandraResourceCassandraTable';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.CassandraTableGetPropertiesResponse>;
    /**
...
export interface CassandraResourceCassandraTableArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.CassandraTableCreateUpdateProperties>;
    /**
