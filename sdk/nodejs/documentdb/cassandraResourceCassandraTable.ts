...
export class CassandraResourceCassandraTable extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.CassandraTableGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.CassandraTableGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraTableArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.CassandraTableCreateUpdatePropertiesArgs>;
    /**
