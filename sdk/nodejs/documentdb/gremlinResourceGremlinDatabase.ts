...
export class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.GremlinDatabaseGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.GremlinDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface GremlinResourceGremlinDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.GremlinDatabaseCreateUpdatePropertiesArgs>;
    /**
