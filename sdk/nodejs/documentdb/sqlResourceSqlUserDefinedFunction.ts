...
export class SqlResourceSqlUserDefinedFunction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:documentdb:SqlResourceSqlUserDefinedFunction';
    ...
    constructor(name: string, args: SqlResourceSqlUserDefinedFunctionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            if ((!args || args.userDefinedFunctionName === undefined) && !(opts && opts.urn)) {
