...
export function getSqlResourceSqlContainer(args: GetSqlResourceSqlContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20241115:getSqlResourceSqlContainer", {
...
export interface GetSqlResourceSqlContainerResult {
    ...
    readonly options?: outputs.documentdb.v20241115.SqlContainerGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20241115.SqlContainerGetPropertiesResponseResource;
    /**
...
export function getSqlResourceSqlContainerOutput(args: GetSqlResourceSqlContainerOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSqlResourceSqlContainerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20241115:getSqlResourceSqlContainer", {
        "accountName": args.accountName,
        "containerName": args.containerName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
