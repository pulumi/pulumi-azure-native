...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20241115:MongoDBResourceMongoDBDatabase';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20241115.MongoDBDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20241115.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBDatabaseArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20241115.MongoDBDatabaseResourceArgs>;
    /**
