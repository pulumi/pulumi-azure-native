...
export interface GetMongoDBResourceMongoDBCollectionResult {
    ...
    readonly options?: outputs.documentdb.v20231115.MongoDBCollectionGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20231115.MongoDBCollectionGetPropertiesResponseResource;
    /**
...
export function getMongoDBResourceMongoDBCollectionOutput(args: GetMongoDBResourceMongoDBCollectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMongoDBResourceMongoDBCollectionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20231115:getMongoDBResourceMongoDBCollection", {
        "accountName": args.accountName,
        "collectionName": args.collectionName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
