...
export function getSqlResourceSqlDatabase(args: GetSqlResourceSqlDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20231115:getSqlResourceSqlDatabase", {
...
export interface GetSqlResourceSqlDatabaseResult {
    ...
    readonly options?: outputs.documentdb.v20231115.SqlDatabaseGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20231115.SqlDatabaseGetPropertiesResponseResource;
    /**
...
export function getSqlResourceSqlDatabaseOutput(args: GetSqlResourceSqlDatabaseOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSqlResourceSqlDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20231115:getSqlResourceSqlDatabase", {
        "accountName": args.accountName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
