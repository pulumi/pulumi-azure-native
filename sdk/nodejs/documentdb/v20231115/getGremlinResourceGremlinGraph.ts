...
export interface GetGremlinResourceGremlinGraphResult {
    ...
    readonly options?: outputs.documentdb.v20231115.GremlinGraphGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20231115.GremlinGraphGetPropertiesResponseResource;
    /**
...
export function getGremlinResourceGremlinGraphOutput(args: GetGremlinResourceGremlinGraphOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGremlinResourceGremlinGraphResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20231115:getGremlinResourceGremlinGraph", {
        "accountName": args.accountName,
        "databaseName": args.databaseName,
        "graphName": args.graphName,
        "resourceGroupName": args.resourceGroupName,
