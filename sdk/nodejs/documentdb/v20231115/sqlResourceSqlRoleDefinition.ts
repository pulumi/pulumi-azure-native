...
export class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly permissions!: pulumi.Output<outputs.documentdb.v20231115.PermissionResponse[] | undefined>;
    /**
...
export interface SqlResourceSqlRoleDefinitionArgs {
     ...
     * The set of operations allowed through this Role Definition.
     */
    permissions?: pulumi.Input<pulumi.Input<inputs.documentdb.v20231115.PermissionArgs>[]>;
    /**
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20231115.RoleDefinitionType>;
}
