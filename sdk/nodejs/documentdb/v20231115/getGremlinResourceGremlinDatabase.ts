...
export interface GetGremlinResourceGremlinDatabaseResult {
    ...
    readonly options?: outputs.documentdb.v20231115.GremlinDatabaseGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20231115.GremlinDatabaseGetPropertiesResponseResource;
    /**
...
export function getGremlinResourceGremlinDatabaseOutput(args: GetGremlinResourceGremlinDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGremlinResourceGremlinDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20231115:getGremlinResourceGremlinDatabase", {
        "accountName": args.accountName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
