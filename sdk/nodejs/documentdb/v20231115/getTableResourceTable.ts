...
export interface GetTableResourceTableResult {
    ...
    readonly options?: outputs.documentdb.v20231115.TableGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20231115.TableGetPropertiesResponseResource;
    /**
...
export function getTableResourceTableOutput(args: GetTableResourceTableOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTableResourceTableResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20231115:getTableResourceTable", {
        "accountName": args.accountName,
        "resourceGroupName": args.resourceGroupName,
        "tableName": args.tableName,
    }, opts);
