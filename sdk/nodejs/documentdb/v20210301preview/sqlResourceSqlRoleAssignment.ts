...
export class SqlResourceSqlRoleAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlResourceSqlRoleAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:SqlResourceSqlRoleAssignment" }, { type: "azure-nextgen:documentdb:SqlResourceSqlRoleAssignment" }, { type: "azure-native:documentdb/v20200601preview:SqlResourceSqlRoleAssignment" }, { type: "azure-nextgen:documentdb/v20200601preview:SqlResourceSqlRoleAssignment" }] };
