...
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GremlinResourceGremlinGraph {
        pulumi.log.warn("GremlinResourceGremlinGraph is deprecated: azure-native:documentdb/v20210301preview:GremlinResourceGremlinGraph is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:GremlinResourceGremlinGraph to guarantee forwards compatibility.")
