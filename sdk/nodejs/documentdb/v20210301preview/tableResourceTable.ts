...
export class TableResourceTable extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20210301preview.TableGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20210301preview.TableGetPropertiesResponseResource | undefined>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20210301preview.TableCreateUpdatePropertiesArgs>;
    /**
