...
export class SqlResourceSqlContainer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlResourceSqlContainer {
        pulumi.log.warn("SqlResourceSqlContainer is deprecated: azure-native:documentdb/v20210301preview:SqlResourceSqlContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:SqlResourceSqlContainer to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: SqlResourceSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20210301preview.sqlContainerResourceArgsProvideDefaults) : undefined) : undefined;
