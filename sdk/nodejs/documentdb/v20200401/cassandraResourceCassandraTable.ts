...
export class CassandraResourceCassandraTable extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraResourceCassandraTable {
        pulumi.log.warn("CassandraResourceCassandraTable is deprecated: Version 2020-04-01 will be removed in v2 of the provider.")
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20200401.CassandraTableGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20200401.CassandraTableGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraTableArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20200401.CassandraTableCreateUpdatePropertiesArgs>;
    /**
