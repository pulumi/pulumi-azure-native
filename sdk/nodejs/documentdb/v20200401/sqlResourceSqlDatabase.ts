...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20200401:SqlResourceSqlDatabase';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20200401.SqlDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20200401.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: SqlResourceSqlDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:SqlResourceSqlDatabase" }, { type: "azure-nextgen:documentdb:SqlResourceSqlDatabase" }, { type: "azure-native:documentdb/latest:SqlResourceSqlDatabase" }, { type: "azure-nextgen:documentdb/latest:SqlResourceSqlDatabase" }, { type: "azure-native:documentdb/v20190801:SqlResourceSqlDatabase" }, { type: "azure-nextgen:documentdb/v20190801:SqlResourceSqlDatabase" }, { type: "azure-native:documentdb/v20191212:SqlResourceSqlDatabase" }, { type: "azure-nextgen:documentdb/v20191212:SqlResourceSqlDatabase" }, { type: "azure-native:documentdb/v20200301:SqlResourceSqlDatabase" }, { type: "azure-nextgen:documentdb/v20200301:SqlResourceSqlDatabase" }, { type: "azure-native:documentdb/v20200601preview:SqlResourceSqlDatabase" }, { type: "azure-nextgen:documentdb/v20200601preview:SqlResourceSqlDatabase" }, { type: "azure-native:documentdb/v20200901:SqlResourceSqlDatabase" }, { type: "azure-nextgen:documentdb/v20200901:SqlResourceSqlDatabase" }, { type: "azure-native:documentdb/v20210115:SqlResourceSqlDatabase" }, { type: "azure-nextgen:documentdb/v20210115:SqlResourceSqlDatabase" }] };
