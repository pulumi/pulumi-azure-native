...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20200401.SqlDatabaseGetPropertiesResponse>;
    /**
...
export interface SqlResourceSqlDatabaseArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.v20200401.SqlDatabaseCreateUpdateProperties>;
    /**
