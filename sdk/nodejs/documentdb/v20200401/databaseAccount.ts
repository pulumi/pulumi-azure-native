...
export class DatabaseAccount extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20200401.DatabaseAccountGetPropertiesResponse>;
    /**
...
export interface DatabaseAccountArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.v20200401.DatabaseAccountCreateUpdateProperties>;
    /**
