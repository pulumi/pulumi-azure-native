...
export class TableResourceTable extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20200401.TableGetPropertiesResponse>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.v20200401.TableCreateUpdateProperties>;
    /**
