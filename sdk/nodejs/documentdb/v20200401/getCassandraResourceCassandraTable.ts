...
export function getCassandraResourceCassandraTable(args: GetCassandraResourceCassandraTableArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraResourceCassandraTableResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:documentdb/v20200401:getCassandraResourceCassandraTable", {
...
export interface GetCassandraResourceCassandraTableResult {
    ...
    readonly options?: outputs.documentdb.v20200401.CassandraTableGetPropertiesInvokeResponseOptions;
    readonly resource?: outputs.documentdb.v20200401.CassandraTableGetPropertiesInvokeResponseResource;
    /**
