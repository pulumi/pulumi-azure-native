 ...
 *
 * const cassandraResourceCassandraKeyspace = new azurerm.documentdb.v20200401.CassandraResourceCassandraKeyspace("cassandraResourceCassandraKeyspace", {
 *     accountName: "ddb1",
...
export class CassandraResourceCassandraKeyspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraResourceCassandraKeyspace {
        return new CassandraResourceCassandraKeyspace(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20200401:CassandraResourceCassandraKeyspace';
    ...
    constructor(name: string, argsOrState?: CassandraResourceCassandraKeyspaceArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CassandraResourceCassandraKeyspaceArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:CassandraResourceCassandraKeyspace" }, { type: "azurerm:documentdb/v20190801:CassandraResourceCassandraKeyspace" }, { type: "azurerm:documentdb/v20191212:CassandraResourceCassandraKeyspace" }, { type: "azurerm:documentdb/v20200301:CassandraResourceCassandraKeyspace" }] };
