...
export class SqlResourceSqlContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20200401:SqlResourceSqlContainer';
    ...
    constructor(name: string, argsOrState?: SqlResourceSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:SqlResourceSqlContainer" }, { type: "azurerm:documentdb/preview:SqlResourceSqlContainer" }, { type: "azurerm:documentdb/v20190801:SqlResourceSqlContainer" }, { type: "azurerm:documentdb/v20191212:SqlResourceSqlContainer" }, { type: "azurerm:documentdb/v20200301:SqlResourceSqlContainer" }, { type: "azurerm:documentdb/v20200601preview:SqlResourceSqlContainer" }] };
