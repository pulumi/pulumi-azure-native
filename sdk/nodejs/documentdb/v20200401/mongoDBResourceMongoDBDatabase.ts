...
azure-native:documentdb/v20200401:MongoDBResourceMongoDBDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:MongoDBResourceMongoDBDatabase to guarantee forwards compatibility.
 */
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MongoDBResourceMongoDBDatabase {
        pulumi.log.warn("MongoDBResourceMongoDBDatabase is deprecated: Version 2020-04-01 will be removed in v2 of the provider.\nazure-native:documentdb/v20200401:MongoDBResourceMongoDBDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:MongoDBResourceMongoDBDatabase to guarantee forwards compatibility.")
