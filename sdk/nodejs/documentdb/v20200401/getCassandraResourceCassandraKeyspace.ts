...
export function getCassandraResourceCassandraKeyspace(args: GetCassandraResourceCassandraKeyspaceArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraResourceCassandraKeyspaceResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:documentdb/v20200401:getCassandraResourceCassandraKeyspace", {
...
export interface GetCassandraResourceCassandraKeyspaceResult {
    ...
    readonly options?: outputs.documentdb.v20200401.CassandraKeyspaceGetPropertiesInvokeResponseOptions;
    readonly resource?: outputs.documentdb.v20200401.CassandraKeyspaceGetPropertiesInvokeResponseResource;
    /**
