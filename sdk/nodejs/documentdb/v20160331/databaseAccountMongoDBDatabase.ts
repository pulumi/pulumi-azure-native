...
export class DatabaseAccountMongoDBDatabase extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseAccountMongoDBDatabase {
        return new DatabaseAccountMongoDBDatabase(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20160331.MongoDBDatabasePropertiesResponse>;
    /**
     * Tags are a list of key-value pairs that describe the resource. These tags can be used in viewing and grouping this resource (across resource groups). A maximum of 15 tags can be provided for a resource. Each tag must have a key no greater than 128 characters and value no greater than 256 characters. For example, the default experience for a template type is set with "defaultExperience": "Cassandra". Current "defaultExperience" values also include "Table", "Graph", "DocumentDB", and "MongoDB".
     */
    public /*out*/ readonly tags!: pulumi.Output<outputs.documentdb.v20160331.TagsResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DatabaseAccountMongoDBDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DatabaseAccountMongoDBDatabaseArgs | undefined;
...
export interface DatabaseAccountMongoDBDatabaseArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.v20160331.MongoDBDatabaseCreateUpdateProperties>;
    /**
