...
export class DatabaseAccountSqlContainer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatabaseAccountSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20160331.sqlContainerResourceArgsProvideDefaults) : undefined) : undefined;
