...
export class DatabaseAccountGremlinGraph extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatabaseAccountGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20160331.gremlinGraphResourceArgsProvideDefaults) : undefined) : undefined;
