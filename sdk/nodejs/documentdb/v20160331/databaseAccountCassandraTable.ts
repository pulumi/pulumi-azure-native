 ...
 *
 * const databaseAccountCassandraTable = new azurerm.documentdb.v20160331.DatabaseAccountCassandraTable("databaseAccountCassandraTable", {
 *     accountName: "ddb1",
