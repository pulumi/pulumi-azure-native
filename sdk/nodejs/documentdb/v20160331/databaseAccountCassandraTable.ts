...
export class DatabaseAccountCassandraTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20160331:DatabaseAccountCassandraTable';
     ...
     */
    public /*out*/ readonly schema!: pulumi.Output<outputs.documentdb.v20160331.CassandraSchemaResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DatabaseAccountCassandraTableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:documentdb/v20160331:DatabaseAccountCassandraTable" }, { type: "azure-native:documentdb:DatabaseAccountCassandraTable" }, { type: "azure-nextgen:documentdb:DatabaseAccountCassandraTable" }, { type: "azure-native:documentdb/latest:DatabaseAccountCassandraTable" }, { type: "azure-nextgen:documentdb/latest:DatabaseAccountCassandraTable" }, { type: "azure-native:documentdb/v20150401:DatabaseAccountCassandraTable" }, { type: "azure-nextgen:documentdb/v20150401:DatabaseAccountCassandraTable" }, { type: "azure-native:documentdb/v20150408:DatabaseAccountCassandraTable" }, { type: "azure-nextgen:documentdb/v20150408:DatabaseAccountCassandraTable" }, { type: "azure-native:documentdb/v20151106:DatabaseAccountCassandraTable" }, { type: "azure-nextgen:documentdb/v20151106:DatabaseAccountCassandraTable" }, { type: "azure-native:documentdb/v20160319:DatabaseAccountCassandraTable" }, { type: "azure-nextgen:documentdb/v20160319:DatabaseAccountCassandraTable" }] };
...
export interface DatabaseAccountCassandraTableArgs {
     ...
     */
    readonly resource: pulumi.Input<inputs.documentdb.v20160331.CassandraTableResource>;
    /**
