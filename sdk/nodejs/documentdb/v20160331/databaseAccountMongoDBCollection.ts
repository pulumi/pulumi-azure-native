 ...
 *
 * const databaseAccountMongoDBCollection = new azure_native.documentdb.v20160331.DatabaseAccountMongoDBCollection("databaseAccountMongoDBCollection", {
 *     accountName: "ddb1",
