...
export class ResourceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index:ResourceGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ResourceGroupPropertiesResponse>;
    /**
...
export interface ResourceGroupArgs {
     ...
     * The resource group properties.
     */
    readonly properties?: pulumi.Input<inputs.ResourceGroupProperties>;
    /**
     * The tags attached to the resource group.
     */
