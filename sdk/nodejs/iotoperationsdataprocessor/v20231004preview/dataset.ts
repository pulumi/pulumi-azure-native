...
export class Dataset extends pulumi.CustomResource {
     ...
     */
    public readonly keys!: pulumi.Output<{[key: string]: outputs.iotoperationsdataprocessor.v20231004preview.DatasetPropertyKeyResponse} | undefined>;
    /**
...
export interface DatasetArgs {
     ...
     * List of keys that can be used for joining on enrich.
     */
    keys?: pulumi.Input<{[key: string]: pulumi.Input<inputs.iotoperationsdataprocessor.v20231004preview.DatasetPropertyKeyArgs>}>;
    /**
     * The geo-location where the resource lives
     */
