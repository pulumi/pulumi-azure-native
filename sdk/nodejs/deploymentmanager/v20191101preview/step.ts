...
export class Step extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Step {
        return new Step(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public readonly properties!: pulumi.Output<outputs.deploymentmanager.v20191101preview.StepPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: StepArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as StepArgs | undefined;
...
export interface StepArgs {
     ...
     * The properties that define the step.
     */
    readonly properties: pulumi.Input<inputs.deploymentmanager.v20191101preview.StepProperties>;
    /**
