...
export class ServiceUnit extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceUnit {
        return new ServiceUnit(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:deploymentmanager/v20191101preview:ServiceUnit';
    ...
    constructor(name: string, argsOrState?: ServiceUnitArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ServiceUnitArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:deploymentmanager/preview:ServiceUnit" }, { type: "azurerm:deploymentmanager/v20180901preview:ServiceUnit" }] };
