...
export class ServiceUnit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:deploymentmanager/v20191101preview:ServiceUnit';
    ...
    constructor(name: string, args: ServiceUnitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:deploymentmanager:ServiceUnit" }, { type: "azure-nextgen:deploymentmanager/v20180901preview:ServiceUnit" }] };
