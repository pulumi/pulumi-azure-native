...
export class ServiceUnit extends pulumi.CustomResource {
     ...
     */
    public readonly artifacts!: pulumi.Output<outputs.deploymentmanager.v20191101preview.ServiceUnitArtifactsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ServiceUnitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:deploymentmanager/v20191101preview:ServiceUnit" }, { type: "azure-native:deploymentmanager:ServiceUnit" }, { type: "azure-nextgen:deploymentmanager:ServiceUnit" }, { type: "azure-native:deploymentmanager/v20180901preview:ServiceUnit" }, { type: "azure-nextgen:deploymentmanager/v20180901preview:ServiceUnit" }] };
...
export interface ServiceUnitArgs {
     ...
     * The artifacts for the service unit.
     */
    artifacts?: pulumi.Input<inputs.deploymentmanager.v20191101preview.ServiceUnitArtifactsArgs>;
    /**
     * Describes the type of ARM deployment to be performed on the resource.
     */
    deploymentMode: pulumi.Input<enums.deploymentmanager.v20191101preview.DeploymentMode>;
    /**
     * The geo-location where the resource lives
     */
