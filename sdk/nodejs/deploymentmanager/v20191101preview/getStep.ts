...
export function getStep(args: GetStepArgs, opts?: pulumi.InvokeOptions): Promise<GetStepResult> {
    ...
    return pulumi.runtime.invoke("azurerm:deploymentmanager/v20191101preview:getStep", {
...
export interface GetStepResult {
     ...
     */
    readonly properties: outputs.deploymentmanager.v20191101preview.StepPropertiesResponse;
    /**
     * Resource tags.
     */
