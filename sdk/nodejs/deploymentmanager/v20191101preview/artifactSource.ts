...
export class ArtifactSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:deploymentmanager/v20191101preview:ArtifactSource';
     ...
     */
    public readonly authentication!: pulumi.Output<outputs.deploymentmanager.v20191101preview.AuthenticationResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: ArtifactSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:deploymentmanager/preview:ArtifactSource" }, { type: "azurerm:deploymentmanager/v20180901preview:ArtifactSource" }] };
...
export interface ArtifactSourceArgs {
     ...
     * The authentication method to use to access the artifact source.
     */
    readonly authentication: pulumi.Input<inputs.deploymentmanager.v20191101preview.Authentication>;
    /**
     * The geo-location where the resource lives
     */
