...
export class Step extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.deploymentmanager.HealthCheckStepPropertiesResponse | outputs.deploymentmanager.WaitStepPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: StepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:deploymentmanager:Step" }, { type: "azure-native:deploymentmanager/v20180901preview:Step" }, { type: "azure-nextgen:deploymentmanager/v20180901preview:Step" }, { type: "azure-native:deploymentmanager/v20191101preview:Step" }, { type: "azure-nextgen:deploymentmanager/v20191101preview:Step" }] };
...
export interface StepArgs {
     ...
     * The properties that define the step.
     */
    readonly properties: pulumi.Input<inputs.deploymentmanager.HealthCheckStepProperties | inputs.deploymentmanager.WaitStepProperties>;
    /**
