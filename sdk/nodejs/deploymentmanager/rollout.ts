...
export class Rollout extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.deploymentmanager.IdentityResponse>;
    /**
     ...
     */
    public readonly stepGroups!: pulumi.Output<outputs.deploymentmanager.StepGroupResponse[]>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: RolloutArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:deploymentmanager:Rollout" }, { type: "azure-native:deploymentmanager/v20180901preview:Rollout" }, { type: "azure-nextgen:deploymentmanager/v20180901preview:Rollout" }, { type: "azure-native:deploymentmanager/v20191101preview:Rollout" }, { type: "azure-nextgen:deploymentmanager/v20191101preview:Rollout" }] };
...
export interface RolloutArgs {
     ...
     * Identity for the resource.
     */
    readonly identity: pulumi.Input<inputs.deploymentmanager.Identity>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The list of step groups that define the orchestration.
     */
    readonly stepGroups: pulumi.Input<pulumi.Input<inputs.deploymentmanager.StepGroup>[]>;
    /**
     * Resource tags.
     */
