...
export class Rollout extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.deploymentmanager.RolloutRequestPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface RolloutArgs {
     ...
     * Defines the properties that make up a rollout request.
     */
    properties: pulumi.Input<inputs.deploymentmanager.RolloutRequestPropertiesArgs>;
    /**
