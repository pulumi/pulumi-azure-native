...
export function getArtifactSource(args: GetArtifactSourceArgs, opts?: pulumi.InvokeOptions): Promise<GetArtifactSourceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:deploymentmanager/preview:getArtifactSource", {
...
export interface GetArtifactSourceResult {
     ...
     */
    readonly authentication: outputs.deploymentmanager.preview.SasAuthenticationResponse;
    /**
