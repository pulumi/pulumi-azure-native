...
export function getServiceUnit(args: GetServiceUnitArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceUnitResult> {
    ...
    return pulumi.runtime.invoke("azurerm:deploymentmanager/preview:getServiceUnit", {
...
export interface GetServiceUnitResult {
     ...
     */
    readonly artifacts?: outputs.deploymentmanager.preview.ServiceUnitArtifactsResponse;
    /**
