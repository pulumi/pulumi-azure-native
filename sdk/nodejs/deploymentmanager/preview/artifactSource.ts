...
export class ArtifactSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:deploymentmanager/preview:ArtifactSource';
     ...
     */
    public readonly authentication!: pulumi.Output<outputs.deploymentmanager.preview.SasAuthenticationResponse>;
    /**
    ...
    constructor(name: string, args: ArtifactSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:deploymentmanager/v20180901preview:ArtifactSource" }, { type: "azurerm:deploymentmanager/v20191101preview:ArtifactSource" }] };
...
export interface ArtifactSourceArgs {
     ...
     * The authentication method to use to access the artifact source.
     */
    readonly authentication: pulumi.Input<inputs.deploymentmanager.preview.SasAuthentication>;
    /**
     * The geo-location where the resource lives
     */
