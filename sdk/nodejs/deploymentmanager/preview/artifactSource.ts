...
export class ArtifactSource extends pulumi.CustomResource {
     ...
     */
    public readonly authentication!: pulumi.Output<outputs.deploymentmanager.preview.AuthenticationResponse>;
    /**
...
export interface ArtifactSourceArgs {
     ...
     * The authentication method to use to access the artifact source.
     */
    readonly authentication: pulumi.Input<inputs.deploymentmanager.preview.Authentication>;
    /**
     * The geo-location where the resource lives
     */
