...
export class ServiceUnit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:deploymentmanager/preview:ServiceUnit';
     ...
     */
    public readonly artifacts!: pulumi.Output<outputs.deploymentmanager.preview.ServiceUnitArtifactsResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceUnitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:deploymentmanager/v20180901preview:ServiceUnit" }, { type: "azurerm:deploymentmanager/v20191101preview:ServiceUnit" }] };
...
export interface ServiceUnitArgs {
     ...
     * The artifacts for the service unit.
     */
    readonly artifacts?: pulumi.Input<inputs.deploymentmanager.preview.ServiceUnitArtifacts>;
    /**
     * Describes the type of ARM deployment to be performed on the resource.
     */
