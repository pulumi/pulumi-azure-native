...
export class ServiceTopology extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:deploymentmanager/preview:ServiceTopology';
    ...
    constructor(name: string, argsOrState?: ServiceTopologyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:deploymentmanager/v20180901preview:ServiceTopology" }, { type: "azurerm:deploymentmanager/v20191101preview:ServiceTopology" }] };
