...
export class Step extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:deploymentmanager/preview:Step';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.deploymentmanager.preview.HealthCheckStepPropertiesResponse | outputs.deploymentmanager.preview.WaitStepPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: StepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:deploymentmanager/v20180901preview:Step" }, { type: "azurerm:deploymentmanager/v20191101preview:Step" }] };
...
export interface StepArgs {
     ...
     * The properties that define the step.
     */
    readonly properties: pulumi.Input<inputs.deploymentmanager.preview.HealthCheckStepProperties | inputs.deploymentmanager.preview.WaitStepProperties>;
    /**
