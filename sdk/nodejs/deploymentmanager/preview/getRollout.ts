...
export function getRollout(args: GetRolloutArgs, opts?: pulumi.InvokeOptions): Promise<GetRolloutResult> {
    ...
    return pulumi.runtime.invoke("azurerm:deploymentmanager/preview:getRollout", {
...
export interface GetRolloutResult {
     ...
     */
    readonly identity?: outputs.deploymentmanager.preview.IdentityResponse;
    /**
     ...
     */
    readonly operationInfo: outputs.deploymentmanager.preview.RolloutOperationInfoResponse;
    /**
     * The detailed information on the services being deployed.
     */
    readonly services: outputs.deploymentmanager.preview.ServiceResponse[];
    /**
     ...
     */
    readonly stepGroups: outputs.deploymentmanager.preview.StepGroupResponse[];
    /**
     * Resource tags.
     */
