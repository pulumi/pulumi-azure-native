...
export class Rollout extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:deploymentmanager/preview:Rollout';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.deploymentmanager.preview.IdentityResponse>;
    /**
     ...
     */
    public readonly stepGroups!: pulumi.Output<outputs.deploymentmanager.preview.StepGroupResponse[]>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: RolloutArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:deploymentmanager/v20180901preview:Rollout" }, { type: "azurerm:deploymentmanager/v20191101preview:Rollout" }] };
...
export interface RolloutArgs {
     ...
     * Identity for the resource.
     */
    readonly identity: pulumi.Input<inputs.deploymentmanager.preview.Identity>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The list of step groups that define the orchestration.
     */
    readonly stepGroups: pulumi.Input<pulumi.Input<inputs.deploymentmanager.preview.StepGroup>[]>;
    /**
     * Resource tags.
     */
