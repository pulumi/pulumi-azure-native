...
export class Rollout extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RolloutArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:deploymentmanager/v20180901preview:Rollout" }, { type: "azure-native:deploymentmanager:Rollout" }, { type: "azure-nextgen:deploymentmanager:Rollout" }, { type: "azure-native:deploymentmanager/v20191101preview:Rollout" }, { type: "azure-nextgen:deploymentmanager/v20191101preview:Rollout" }] };
