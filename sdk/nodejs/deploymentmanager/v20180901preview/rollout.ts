...
export class Rollout extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.deploymentmanager.v20180901preview.RolloutRequestPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface RolloutArgs {
     ...
     * Defines the properties that make up a rollout request.
     */
    properties: pulumi.Input<inputs.deploymentmanager.v20180901preview.RolloutRequestPropertiesArgs>;
    /**
