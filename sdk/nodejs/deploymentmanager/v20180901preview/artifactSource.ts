...
export class ArtifactSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:deploymentmanager/v20180901preview:ArtifactSource';
    ...
    constructor(name: string, args: ArtifactSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:deploymentmanager/v20180901preview:ArtifactSource" }, { type: "azure-native:deploymentmanager:ArtifactSource" }, { type: "azure-nextgen:deploymentmanager:ArtifactSource" }, { type: "azure-native:deploymentmanager/v20191101preview:ArtifactSource" }, { type: "azure-nextgen:deploymentmanager/v20191101preview:ArtifactSource" }] };
...
export interface ArtifactSourceArgs {
     ...
     * The authentication method to use to access the artifact source.
     */
    readonly authentication: pulumi.Input<inputs.deploymentmanager.v20180901preview.SasAuthenticationArgs>;
    /**
     * The geo-location where the resource lives
     */
