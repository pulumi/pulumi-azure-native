 ...
 *
 * const artifactSource = new azurerm.deploymentmanager.v20180901preview.ArtifactSource("artifactSource", {
...
export class ArtifactSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:deploymentmanager/v20180901preview:ArtifactSource';
    ...
    constructor(name: string, args: ArtifactSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:deploymentmanager/v20191101preview:ArtifactSource" }] };
