...
export class ServiceTopology extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.deploymentmanager.v20180901preview.ServiceTopologyResourceResponseProperties>;
    /**
     * Resource tags.
     */
...
export interface ServiceTopologyArgs {
     ...
     * The properties that define the service topology.
     */
    properties: pulumi.Input<inputs.deploymentmanager.v20180901preview.ServiceTopologyResourcePropertiesArgs>;
    /**
