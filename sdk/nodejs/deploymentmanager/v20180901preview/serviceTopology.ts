...
export class ServiceTopology extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceTopology {
        return new ServiceTopology(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:deploymentmanager/v20180901preview:ServiceTopology';
    ...
    constructor(name: string, argsOrState?: ServiceTopologyArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ServiceTopologyArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:deploymentmanager/preview:ServiceTopology" }, { type: "azurerm:deploymentmanager/v20191101preview:ServiceTopology" }] };
