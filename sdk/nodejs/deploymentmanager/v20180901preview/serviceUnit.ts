 ...
 *
 * const serviceUnit = new azurerm.deploymentmanager.v20180901preview.ServiceUnit("serviceUnit", {
 *     artifacts: {
...
export class ServiceUnit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:deploymentmanager/v20180901preview:ServiceUnit';
    ...
    constructor(name: string, args: ServiceUnitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:deploymentmanager/v20191101preview:ServiceUnit" }] };
