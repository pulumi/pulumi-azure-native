...
export class Step extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:deploymentmanager/v20180901preview:Step';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.deploymentmanager.v20180901preview.StepPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: StepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:deploymentmanager/preview:Step" }, { type: "azurerm:deploymentmanager/v20191101preview:Step" }] };
...
export interface StepArgs {
     ...
     * The properties that define the step.
     */
    readonly properties: pulumi.Input<inputs.deploymentmanager.v20180901preview.StepProperties>;
    /**
