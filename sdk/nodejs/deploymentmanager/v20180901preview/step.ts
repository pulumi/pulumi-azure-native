...
export class Step extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deploymentmanager:Step" }, { type: "azure-nextgen:deploymentmanager:Step" }, { type: "azure-native:deploymentmanager/v20191101preview:Step" }, { type: "azure-nextgen:deploymentmanager/v20191101preview:Step" }] };
