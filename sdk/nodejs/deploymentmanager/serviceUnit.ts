...
export class ServiceUnit extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServiceUnitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:deploymentmanager:ServiceUnit" }, { type: "azure-native:deploymentmanager/v20180901preview:ServiceUnit" }, { type: "azure-nextgen:deploymentmanager/v20180901preview:ServiceUnit" }, { type: "azure-native:deploymentmanager/v20191101preview:ServiceUnit" }, { type: "azure-nextgen:deploymentmanager/v20191101preview:ServiceUnit" }] };
...
export interface ServiceUnitArgs {
     ...
     * The artifacts for the service unit.
     */
    readonly artifacts?: pulumi.Input<inputs.deploymentmanager.ServiceUnitArtifacts>;
    /**
     * Describes the type of ARM deployment to be performed on the resource.
     */
