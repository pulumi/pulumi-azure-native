...
export class ServiceTopology extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:deploymentmanager:ServiceTopology';
    ...
    constructor(name: string, args: ServiceTopologyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:deploymentmanager/v20180901preview:ServiceTopology" }, { type: "azure-nextgen:deploymentmanager/v20191101preview:ServiceTopology" }] };
