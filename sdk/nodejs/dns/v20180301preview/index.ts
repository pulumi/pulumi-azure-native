...
// Export enums:
export * from "../../types/enums/dns/v20180301preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dns/v20180301preview:RecordSet":
                return new RecordSet(name, <any>undefined, { urn })
            case "azure-native:dns/v20180301preview:Zone":
...
pulumi.runtime.registerResourceModule("azure-native", "dns/v20180301preview", _module)
