...
export class DnssecConfig extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DnssecConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:DnssecConfig" }, { type: "azure-native:dns/v20230701preview:DnssecConfig" }, { type: "azure-native:network/v20230701preview:DnssecConfig" }] };
