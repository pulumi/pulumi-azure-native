...
// Export enums:
export * from "../../types/enums/dns/v20171001";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dns/v20171001:RecordSet":
                return new RecordSet(name, <any>undefined, { urn })
            case "azure-native:dns/v20171001:Zone":
...
pulumi.runtime.registerResourceModule("azure-native", "dns/v20171001", _module)
