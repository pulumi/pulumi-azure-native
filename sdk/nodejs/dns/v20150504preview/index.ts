...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dns/v20150504preview:RecordSet":
                return new RecordSet(name, <any>undefined, { urn })
            case "azure-native:dns/v20150504preview:Zone":
...
pulumi.runtime.registerResourceModule("azure-native", "dns/v20150504preview", _module)
