...
export function getZone(args: GetZoneArgs, opts?: pulumi.InvokeOptions): Promise<GetZoneResult> {
    ...
    return pulumi.runtime.invoke("azure-native:dns/v20150504preview:getZone", {
...
export interface GetZoneResult {
     ...
     */
    readonly properties: outputs.dns.v20150504preview.ZonePropertiesResponse;
    /**
     * Resource tags.
     */
...
export function getZoneOutput(args: GetZoneOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZoneResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:dns/v20150504preview:getZone", {
        "resourceGroupName": args.resourceGroupName,
        "zoneName": args.zoneName,
    }, opts);
}
