...
// Export enums:
export * from "../../types/enums/dns/v20170901";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dns/v20170901:RecordSet":
                return new RecordSet(name, <any>undefined, { urn })
            case "azure-native:dns/v20170901:Zone":
...
pulumi.runtime.registerResourceModule("azure-native", "dns/v20170901", _module)
