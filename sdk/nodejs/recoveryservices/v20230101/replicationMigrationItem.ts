 ...
 * Migration item.
 *
 * @deprecated azure-native:recoveryservices/v20230101:ReplicationMigrationItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationMigrationItem to guarantee forwards compatibility.
 */
export class ReplicationMigrationItem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationMigrationItem {
        pulumi.log.warn("ReplicationMigrationItem is deprecated: azure-native:recoveryservices/v20230101:ReplicationMigrationItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationMigrationItem to guarantee forwards compatibility.")
        return new ReplicationMigrationItem(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230101:ReplicationMigrationItem';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20230101.MigrationItemPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationMigrationItemArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20230101.EnableMigrationInputPropertiesArgs>;
    /**
