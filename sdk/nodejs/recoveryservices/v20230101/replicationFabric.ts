 ...
 * Fabric definition.
 *
 * @deprecated azure-native:recoveryservices/v20230101:ReplicationFabric is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationFabric to guarantee forwards compatibility.
 */
export class ReplicationFabric extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230101:ReplicationFabric';
     ...
     * Fabric related data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20230101.FabricPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationFabricArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20230101.FabricCreationInputPropertiesArgs>;
    /**
