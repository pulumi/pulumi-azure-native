 ...
 *
 * @deprecated azure-native:recoveryservices/v20230101:ReplicationProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationProtectedItem to guarantee forwards compatibility.
 */
export class ReplicationProtectedItem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationProtectedItem {
        pulumi.log.warn("ReplicationProtectedItem is deprecated: azure-native:recoveryservices/v20230101:ReplicationProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationProtectedItem to guarantee forwards compatibility.")
        return new ReplicationProtectedItem(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230101:ReplicationProtectedItem';
     ...
     * The custom data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20230101.ReplicationProtectedItemPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, args: ReplicationProtectedItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:recoveryservices:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20160810:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20180110:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20180710:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20210210:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20210301:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20210401:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20210601:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20210701:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20210801:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20211001:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20211101:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20211201:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20220101:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20220201:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20220301:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20220401:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20220501:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20220801:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20220910:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20221001:ReplicationProtectedItem" }, { type: "azure-native:recoveryservices/v20230201:ReplicationProtectedItem" }] };
...
export interface ReplicationProtectedItemArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20230101.EnableProtectionInputPropertiesArgs>;
    /**
