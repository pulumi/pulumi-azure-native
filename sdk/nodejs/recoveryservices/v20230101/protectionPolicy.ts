 ...
 *
 * @deprecated azure-native:recoveryservices/v20230101:ProtectionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionPolicy to guarantee forwards compatibility.
 */
export class ProtectionPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProtectionPolicy {
        pulumi.log.warn("ProtectionPolicy is deprecated: azure-native:recoveryservices/v20230101:ProtectionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionPolicy to guarantee forwards compatibility.")
        return new ProtectionPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230101:ProtectionPolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20230101.AzureFileShareProtectionPolicyResponse | outputs.recoveryservices.v20230101.AzureIaaSVMProtectionPolicyResponse | outputs.recoveryservices.v20230101.AzureSqlProtectionPolicyResponse | outputs.recoveryservices.v20230101.AzureVmWorkloadProtectionPolicyResponse | outputs.recoveryservices.v20230101.GenericProtectionPolicyResponse | outputs.recoveryservices.v20230101.MabProtectionPolicyResponse>;
    /**
     * Resource tags.
     */
...
export interface ProtectionPolicyArgs {
     ...
     * ProtectionPolicyResource properties
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20230101.AzureFileShareProtectionPolicyArgs | inputs.recoveryservices.v20230101.AzureIaaSVMProtectionPolicyArgs | inputs.recoveryservices.v20230101.AzureSqlProtectionPolicyArgs | inputs.recoveryservices.v20230101.AzureVmWorkloadProtectionPolicyArgs | inputs.recoveryservices.v20230101.GenericProtectionPolicyArgs | inputs.recoveryservices.v20230101.MabProtectionPolicyArgs>;
    /**
