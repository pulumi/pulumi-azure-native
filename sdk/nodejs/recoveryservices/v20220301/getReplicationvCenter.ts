 ...
 */
/** @deprecated azure-native:recoveryservices/v20220301:ReplicationvCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationvCenter to guarantee forwards compatibility. */
export function getReplicationvCenter(args: GetReplicationvCenterArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationvCenterResult> {
    pulumi.log.warn("getReplicationvCenter is deprecated: azure-native:recoveryservices/v20220301:ReplicationvCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationvCenter to guarantee forwards compatibility.")
...
export interface GetReplicationvCenterResult {
     ...
     */
    readonly properties: outputs.recoveryservices.v20220301.VCenterPropertiesResponse;
    /**
     * Resource Type
     */
