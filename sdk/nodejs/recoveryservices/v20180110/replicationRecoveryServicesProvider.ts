...
export class ReplicationRecoveryServicesProvider extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ReplicationRecoveryServicesProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationRecoveryServicesProvider" }, { type: "azurerm:recoveryservices/preview:ReplicationRecoveryServicesProvider" }, { type: "azurerm:recoveryservices/v20180710:ReplicationRecoveryServicesProvider" }] };
