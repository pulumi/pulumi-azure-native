...
export class ReplicationProtectedItem extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReplicationProtectedItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationProtectedItem" }, { type: "azurerm:recoveryservices/preview:ReplicationProtectedItem" }, { type: "azurerm:recoveryservices/v20160810:ReplicationProtectedItem" }, { type: "azurerm:recoveryservices/v20180710:ReplicationProtectedItem" }] };
