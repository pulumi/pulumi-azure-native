...
export class ReplicationRecoveryPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20180110:ReplicationRecoveryPlan';
    ...
    constructor(name: string, argsOrState?: ReplicationRecoveryPlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/v20160810:ReplicationRecoveryPlan" }, { type: "azurerm:recoveryservices/v20180710:ReplicationRecoveryPlan" }] };
