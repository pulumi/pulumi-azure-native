 ...
 *
 * const replicationMigrationItem = new azurerm.recoveryservices.v20180110.ReplicationMigrationItem("replicationMigrationItem", {
...
export class ReplicationMigrationItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20180110:ReplicationMigrationItem';
    ...
    constructor(name: string, argsOrState?: ReplicationMigrationItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationMigrationItem" }, { type: "azurerm:recoveryservices/v20180710:ReplicationMigrationItem" }] };
