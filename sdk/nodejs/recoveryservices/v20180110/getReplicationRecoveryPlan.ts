...
export function getReplicationRecoveryPlan(args: GetReplicationRecoveryPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationRecoveryPlanResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:recoveryservices/v20180110:getReplicationRecoveryPlan", {
...
export interface GetReplicationRecoveryPlanResult {
     ...
     * The custom details.
     */
    readonly properties: outputs.recoveryservices.v20180110.RecoveryPlanPropertiesInvokeResponse;
    /**
     * Resource Type
     */
