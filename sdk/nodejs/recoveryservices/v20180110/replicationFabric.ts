 ...
 *
 * const replicationFabric = new azurerm.recoveryservices.v20180110.ReplicationFabric("replicationFabric", {
 *     fabricName: "cloud1",
...
export class ReplicationFabric extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20180110:ReplicationFabric';
    ...
    constructor(name: string, argsOrState?: ReplicationFabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationFabric" }, { type: "azurerm:recoveryservices/v20160810:ReplicationFabric" }, { type: "azurerm:recoveryservices/v20180710:ReplicationFabric" }] };
