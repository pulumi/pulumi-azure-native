...
export class ReplicationvCenter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationvCenter {
        return new ReplicationvCenter(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20180110:ReplicationvCenter';
    ...
    constructor(name: string, argsOrState?: ReplicationvCenterArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ReplicationvCenterArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationvCenter" }, { type: "azurerm:recoveryservices/preview:ReplicationvCenter" }, { type: "azurerm:recoveryservices/v20160810:ReplicationvCenter" }, { type: "azurerm:recoveryservices/v20180710:ReplicationvCenter" }] };
