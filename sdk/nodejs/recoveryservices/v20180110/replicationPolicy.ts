...
export class ReplicationPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ReplicationPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationPolicy" }, { type: "azurerm:recoveryservices/preview:ReplicationPolicy" }, { type: "azurerm:recoveryservices/v20160810:ReplicationPolicy" }, { type: "azurerm:recoveryservices/v20180710:ReplicationPolicy" }] };
