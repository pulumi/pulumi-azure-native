...
export function getReplicationPolicy(args: GetReplicationPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:recoveryservices/v20180110:getReplicationPolicy", {
...
export interface GetReplicationPolicyResult {
     ...
     * The custom data.
     */
    readonly properties: outputs.recoveryservices.v20180110.PolicyPropertiesInvokeResponse;
    /**
     * Resource Type
     */
