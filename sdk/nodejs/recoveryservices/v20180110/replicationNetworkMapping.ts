 ...
 *
 * const replicationNetworkMapping = new azurerm.recoveryservices.v20180110.ReplicationNetworkMapping("replicationNetworkMapping", {
...
export class ReplicationNetworkMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationNetworkMapping {
        return new ReplicationNetworkMapping(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20180110:ReplicationNetworkMapping';
    ...
    constructor(name: string, argsOrState?: ReplicationNetworkMappingArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ReplicationNetworkMappingArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationNetworkMapping" }, { type: "azurerm:recoveryservices/v20160810:ReplicationNetworkMapping" }, { type: "azurerm:recoveryservices/v20180710:ReplicationNetworkMapping" }] };
