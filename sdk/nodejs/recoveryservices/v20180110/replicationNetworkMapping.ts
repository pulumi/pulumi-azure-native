...
export class ReplicationNetworkMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20180110:ReplicationNetworkMapping';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20180110.NetworkMappingPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, args: ReplicationNetworkMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:recoveryservices:ReplicationNetworkMapping" }, { type: "azure-nextgen:recoveryservices:ReplicationNetworkMapping" }, { type: "azure-native:recoveryservices/latest:ReplicationNetworkMapping" }, { type: "azure-nextgen:recoveryservices/latest:ReplicationNetworkMapping" }, { type: "azure-native:recoveryservices/v20160810:ReplicationNetworkMapping" }, { type: "azure-nextgen:recoveryservices/v20160810:ReplicationNetworkMapping" }, { type: "azure-native:recoveryservices/v20180710:ReplicationNetworkMapping" }, { type: "azure-nextgen:recoveryservices/v20180710:ReplicationNetworkMapping" }] };
...
export interface ReplicationNetworkMappingArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.v20180110.CreateNetworkMappingInputProperties>;
    /**
