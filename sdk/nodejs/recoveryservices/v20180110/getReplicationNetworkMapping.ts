...
export function getReplicationNetworkMapping(args: GetReplicationNetworkMappingArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationNetworkMappingResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:recoveryservices/v20180110:getReplicationNetworkMapping", {
...
export interface GetReplicationNetworkMappingResult {
     ...
     */
    readonly properties: outputs.recoveryservices.v20180110.NetworkMappingPropertiesInvokeResponse;
    /**
     * Resource Type
     */
