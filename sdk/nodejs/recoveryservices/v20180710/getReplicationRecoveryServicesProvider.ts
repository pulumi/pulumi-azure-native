 ...
 * Provider details.
 */
/** @deprecated Version 2018-07-10 will be removed in v2 of the provider. */
export function getReplicationRecoveryServicesProvider(args: GetReplicationRecoveryServicesProviderArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationRecoveryServicesProviderResult> {
    pulumi.log.warn("getReplicationRecoveryServicesProvider is deprecated: Version 2018-07-10 will be removed in v2 of the provider.")
