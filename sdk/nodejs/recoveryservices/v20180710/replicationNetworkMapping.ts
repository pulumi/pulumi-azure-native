 ...
 *
 * const replicationNetworkMapping = new azurerm.recoveryservices.v20180710.ReplicationNetworkMapping("replicationNetworkMapping", {
...
export class ReplicationNetworkMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20180710:ReplicationNetworkMapping';
    ...
    constructor(name: string, argsOrState?: ReplicationNetworkMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationNetworkMapping" }, { type: "azurerm:recoveryservices/v20160810:ReplicationNetworkMapping" }, { type: "azurerm:recoveryservices/v20180110:ReplicationNetworkMapping" }] };
