 ...
 *
 * const replicationPolicy = new azurerm.recoveryservices.v20180710.ReplicationPolicy("replicationPolicy", {
...
export class ReplicationPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20180710:ReplicationPolicy';
    ...
    constructor(name: string, argsOrState?: ReplicationPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationPolicy" }, { type: "azurerm:recoveryservices/v20160810:ReplicationPolicy" }, { type: "azurerm:recoveryservices/v20180110:ReplicationPolicy" }] };
