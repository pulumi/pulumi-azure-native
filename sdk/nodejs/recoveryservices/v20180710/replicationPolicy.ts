...
export class ReplicationPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReplicationPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationPolicy" }, { type: "azurerm:recoveryservices/preview:ReplicationPolicy" }, { type: "azurerm:recoveryservices/v20160810:ReplicationPolicy" }, { type: "azurerm:recoveryservices/v20180110:ReplicationPolicy" }] };
