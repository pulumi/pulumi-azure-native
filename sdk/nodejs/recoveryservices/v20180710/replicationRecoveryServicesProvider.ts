...
export class ReplicationRecoveryServicesProvider extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReplicationRecoveryServicesProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices:ReplicationRecoveryServicesProvider" }, { type: "azure-nextgen:recoveryservices/latest:ReplicationRecoveryServicesProvider" }, { type: "azure-nextgen:recoveryservices/v20180110:ReplicationRecoveryServicesProvider" }] };
