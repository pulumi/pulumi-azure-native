 ...
 *
 * const replicationRecoveryServicesProvider = new azurerm.recoveryservices.v20180710.ReplicationRecoveryServicesProvider("replicationRecoveryServicesProvider", {
...
export class ReplicationRecoveryServicesProvider extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationRecoveryServicesProvider {
        return new ReplicationRecoveryServicesProvider(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20180710:ReplicationRecoveryServicesProvider';
    ...
    constructor(name: string, argsOrState?: ReplicationRecoveryServicesProviderArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ReplicationRecoveryServicesProviderArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationRecoveryServicesProvider" }, { type: "azurerm:recoveryservices/v20180110:ReplicationRecoveryServicesProvider" }] };
