...
export class ReplicationMigrationItem extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReplicationMigrationItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices/latest:ReplicationMigrationItem" }, { type: "azure-nextgen:recoveryservices/v20180110:ReplicationMigrationItem" }] };
