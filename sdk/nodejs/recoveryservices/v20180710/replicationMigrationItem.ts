...
export class ReplicationMigrationItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20180710:ReplicationMigrationItem';
    ...
    constructor(name: string, args: ReplicationMigrationItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationMigrationItem" }, { type: "azurerm:recoveryservices/preview:ReplicationMigrationItem" }, { type: "azurerm:recoveryservices/v20180110:ReplicationMigrationItem" }] };
