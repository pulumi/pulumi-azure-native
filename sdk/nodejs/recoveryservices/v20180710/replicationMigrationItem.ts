...
export class ReplicationMigrationItem extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReplicationMigrationItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:recoveryservices:ReplicationMigrationItem" }, { type: "azure-nextgen:recoveryservices:ReplicationMigrationItem" }, { type: "azure-native:recoveryservices/latest:ReplicationMigrationItem" }, { type: "azure-nextgen:recoveryservices/latest:ReplicationMigrationItem" }, { type: "azure-native:recoveryservices/v20180110:ReplicationMigrationItem" }, { type: "azure-nextgen:recoveryservices/v20180110:ReplicationMigrationItem" }] };
...
export interface ReplicationMigrationItemArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.recoveryservices.v20180710.EnableMigrationInputProperties>;
    /**
