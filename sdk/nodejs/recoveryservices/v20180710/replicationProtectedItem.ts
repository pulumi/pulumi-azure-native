...
export class ReplicationProtectedItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20180710:ReplicationProtectedItem';
    ...
    constructor(name: string, argsOrState?: ReplicationProtectedItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationProtectedItem" }, { type: "azurerm:recoveryservices/preview:ReplicationProtectedItem" }, { type: "azurerm:recoveryservices/v20160810:ReplicationProtectedItem" }, { type: "azurerm:recoveryservices/v20180110:ReplicationProtectedItem" }] };
