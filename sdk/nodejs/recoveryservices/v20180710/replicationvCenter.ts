...
export class ReplicationvCenter extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReplicationvCenterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices/v20180710:ReplicationvCenter" }, { type: "azure-native:recoveryservices:ReplicationvCenter" }, { type: "azure-nextgen:recoveryservices:ReplicationvCenter" }, { type: "azure-native:recoveryservices/latest:ReplicationvCenter" }, { type: "azure-nextgen:recoveryservices/latest:ReplicationvCenter" }, { type: "azure-native:recoveryservices/v20160810:ReplicationvCenter" }, { type: "azure-nextgen:recoveryservices/v20160810:ReplicationvCenter" }, { type: "azure-native:recoveryservices/v20180110:ReplicationvCenter" }, { type: "azure-nextgen:recoveryservices/v20180110:ReplicationvCenter" }] };
...
export interface ReplicationvCenterArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.v20180710.AddVCenterRequestProperties>;
    /**
