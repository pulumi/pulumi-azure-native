 ...
 *
 * const replicationStorageClassificationMapping = new azurerm.recoveryservices.v20180710.ReplicationStorageClassificationMapping("replicationStorageClassificationMapping", {
...
export class ReplicationStorageClassificationMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20180710:ReplicationStorageClassificationMapping';
    ...
    constructor(name: string, args: ReplicationStorageClassificationMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationStorageClassificationMapping" }, { type: "azurerm:recoveryservices/v20160810:ReplicationStorageClassificationMapping" }, { type: "azurerm:recoveryservices/v20180110:ReplicationStorageClassificationMapping" }] };
