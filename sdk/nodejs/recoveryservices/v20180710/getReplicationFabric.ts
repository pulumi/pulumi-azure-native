...
export function getReplicationFabric(args: GetReplicationFabricArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationFabricResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:recoveryservices/v20180710:getReplicationFabric", {
...
export interface GetReplicationFabricResult {
     ...
     * Fabric related data.
     */
    readonly properties: outputs.recoveryservices.v20180710.FabricPropertiesInvokeResponse;
    /**
     * Resource Type
     */
