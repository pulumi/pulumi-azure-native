...
export class ProtectionPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20160601:ProtectionPolicy';
    ...
    constructor(name: string, args: ProtectionPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ProtectionPolicy" }, { type: "azurerm:recoveryservices/preview:ProtectionPolicy" }] };
