...
export class Vault extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices:Vault" }, { type: "azure-nextgen:recoveryservices/latest:Vault" }, { type: "azure-nextgen:recoveryservices/v20200202:Vault" }] };
