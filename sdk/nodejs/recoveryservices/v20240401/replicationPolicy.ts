...
export class ReplicationPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20240401:ReplicationPolicy';
     ...
     * The custom data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20240401.PolicyPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationPolicyArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20240401.CreatePolicyInputPropertiesArgs>;
    /**
