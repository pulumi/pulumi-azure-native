...
export class ReplicationProtectionCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20240401:ReplicationProtectionCluster';
     ...
     * The custom data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20240401.ReplicationProtectionClusterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ReplicationProtectionClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:recoveryservices:ReplicationProtectionCluster" }, { type: "azure-native:recoveryservices/v20240201:ReplicationProtectionCluster" }] };
...
export interface ReplicationProtectionClusterArgs {
     ...
     * The custom data.
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20240401.ReplicationProtectionClusterPropertiesArgs>;
    /**
