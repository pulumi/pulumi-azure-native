...
export class ReplicationStorageClassificationMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationStorageClassificationMapping {
        pulumi.log.warn("ReplicationStorageClassificationMapping is deprecated: azure-native:recoveryservices/v20210401:ReplicationStorageClassificationMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationStorageClassificationMapping to guarantee forwards compatibility.")
