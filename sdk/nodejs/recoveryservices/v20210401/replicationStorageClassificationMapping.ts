...
export class ReplicationStorageClassificationMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationStorageClassificationMapping {
        pulumi.log.warn("ReplicationStorageClassificationMapping is deprecated: azure-native:recoveryservices/v20210401:ReplicationStorageClassificationMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationStorageClassificationMapping to guarantee forwards compatibility.")
        return new ReplicationStorageClassificationMapping(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20210401:ReplicationStorageClassificationMapping';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20210401.StorageClassificationMappingPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationStorageClassificationMappingArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20210401.StorageMappingInputPropertiesArgs>;
    /**
