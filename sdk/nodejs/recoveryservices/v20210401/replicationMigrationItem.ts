 ...
 * Migration item.
 *
 * @deprecated azure-native:recoveryservices/v20210401:ReplicationMigrationItem is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationMigrationItem to guarantee forwards compatibility.
 */
export class ReplicationMigrationItem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationMigrationItem {
        pulumi.log.warn("ReplicationMigrationItem is deprecated: azure-native:recoveryservices/v20210401:ReplicationMigrationItem is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationMigrationItem to guarantee forwards compatibility.")
