...
export class ProtectionPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ProtectionPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices/latest:ProtectionPolicy" }, { type: "azure-nextgen:recoveryservices/v20160601:ProtectionPolicy" }, { type: "azure-nextgen:recoveryservices/v20201201:ProtectionPolicy" }] };
