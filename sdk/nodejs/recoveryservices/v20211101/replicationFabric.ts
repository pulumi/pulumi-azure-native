...
export class ReplicationFabric extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationFabric {
        pulumi.log.warn("ReplicationFabric is deprecated: azure-native:recoveryservices/v20211101:ReplicationFabric is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationFabric to guarantee forwards compatibility.")
