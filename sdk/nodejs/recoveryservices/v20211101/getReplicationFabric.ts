...
export function getReplicationFabric(args: GetReplicationFabricArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationFabricResult> {
    pulumi.log.warn("getReplicationFabric is deprecated: azure-native:recoveryservices/v20211101:ReplicationFabric is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationFabric to guarantee forwards compatibility.")
