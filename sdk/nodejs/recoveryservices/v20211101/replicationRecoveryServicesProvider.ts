...
export class ReplicationRecoveryServicesProvider extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationRecoveryServicesProvider {
        pulumi.log.warn("ReplicationRecoveryServicesProvider is deprecated: azure-native:recoveryservices/v20211101:ReplicationRecoveryServicesProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationRecoveryServicesProvider to guarantee forwards compatibility.")
        return new ReplicationRecoveryServicesProvider(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20211101:ReplicationRecoveryServicesProvider';
     ...
     * Provider properties.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20211101.RecoveryServicesProviderPropertiesResponse>;
    /**
     * Resource Type
     */
