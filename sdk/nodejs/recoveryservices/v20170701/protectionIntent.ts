...
export class ProtectionIntent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20170701:ProtectionIntent';
    ...
    constructor(name: string, argsOrState?: ProtectionIntentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ProtectionIntent" }, { type: "azurerm:recoveryservices/preview:ProtectionIntent" }] };
