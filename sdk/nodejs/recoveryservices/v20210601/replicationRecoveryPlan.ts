...
export class ReplicationRecoveryPlan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationRecoveryPlan {
        pulumi.log.warn("ReplicationRecoveryPlan is deprecated: azure-native:recoveryservices/v20210601:ReplicationRecoveryPlan is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationRecoveryPlan to guarantee forwards compatibility.")
