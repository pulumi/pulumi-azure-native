...
export class ProtectedItem extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20190615.ProtectedItemResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: ProtectedItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ProtectedItem" }, { type: "azurerm:recoveryservices/preview:ProtectedItem" }, { type: "azurerm:recoveryservices/v20160601:ProtectedItem" }, { type: "azurerm:recoveryservices/v20190513:ProtectedItem" }] };
