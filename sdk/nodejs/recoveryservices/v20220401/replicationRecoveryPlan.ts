 ...
 *
 * @deprecated azure-native:recoveryservices/v20220401:ReplicationRecoveryPlan is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationRecoveryPlan to guarantee forwards compatibility.
 */
export class ReplicationRecoveryPlan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationRecoveryPlan {
        pulumi.log.warn("ReplicationRecoveryPlan is deprecated: azure-native:recoveryservices/v20220401:ReplicationRecoveryPlan is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationRecoveryPlan to guarantee forwards compatibility.")
        return new ReplicationRecoveryPlan(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20220401:ReplicationRecoveryPlan';
     ...
     * The custom details.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20220401.RecoveryPlanPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationRecoveryPlanArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20220401.CreateRecoveryPlanInputPropertiesArgs>;
    /**
     * Recovery plan name.
     */
