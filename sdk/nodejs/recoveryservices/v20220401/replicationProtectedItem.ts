 ...
 *
 * @deprecated azure-native:recoveryservices/v20220401:ReplicationProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationProtectedItem to guarantee forwards compatibility.
 */
export class ReplicationProtectedItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20220401:ReplicationProtectedItem';
     ...
     * The custom data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20220401.ReplicationProtectedItemPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationProtectedItemArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20220401.EnableProtectionInputPropertiesArgs>;
    /**
