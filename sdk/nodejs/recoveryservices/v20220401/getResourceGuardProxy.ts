 ...
 */
/** @deprecated azure-native:recoveryservices/v20220401:ResourceGuardProxy is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ResourceGuardProxy to guarantee forwards compatibility. */
export function getResourceGuardProxy(args: GetResourceGuardProxyArgs, opts?: pulumi.InvokeOptions): Promise<GetResourceGuardProxyResult> {
    pulumi.log.warn("getResourceGuardProxy is deprecated: azure-native:recoveryservices/v20220401:ResourceGuardProxy is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ResourceGuardProxy to guarantee forwards compatibility.")
...
export interface GetResourceGuardProxyResult {
     ...
     */
    readonly properties: outputs.recoveryservices.v20220401.ResourceGuardProxyBaseResponse;
    /**
     * Resource tags.
     */
