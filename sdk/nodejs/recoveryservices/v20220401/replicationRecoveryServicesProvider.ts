 ...
 * Provider details.
 *
 * @deprecated azure-native:recoveryservices/v20220401:ReplicationRecoveryServicesProvider is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationRecoveryServicesProvider to guarantee forwards compatibility.
 */
export class ReplicationRecoveryServicesProvider extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationRecoveryServicesProvider {
        pulumi.log.warn("ReplicationRecoveryServicesProvider is deprecated: azure-native:recoveryservices/v20220401:ReplicationRecoveryServicesProvider is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationRecoveryServicesProvider to guarantee forwards compatibility.")
        return new ReplicationRecoveryServicesProvider(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20220401:ReplicationRecoveryServicesProvider';
     ...
     * Provider properties.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20220401.RecoveryServicesProviderPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationRecoveryServicesProviderArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20220401.AddRecoveryServicesProviderInputPropertiesArgs>;
    /**
