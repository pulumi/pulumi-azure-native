 ...
 * Migration item.
 *
 * @deprecated azure-native:recoveryservices/v20220401:ReplicationMigrationItem is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationMigrationItem to guarantee forwards compatibility.
 */
export class ReplicationMigrationItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20220401:ReplicationMigrationItem';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20220401.MigrationItemPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationMigrationItemArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20220401.EnableMigrationInputPropertiesArgs>;
    /**
