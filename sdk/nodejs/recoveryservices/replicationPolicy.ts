...
export class ReplicationPolicy extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    declare public readonly properties: pulumi.Output<outputs.recoveryservices.PolicyPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationPolicyArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.CreatePolicyInputPropertiesArgs | undefined>;
    /**
