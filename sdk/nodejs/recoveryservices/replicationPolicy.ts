...
export class ReplicationPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReplicationPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices:ReplicationPolicy" }, { type: "azure-native:recoveryservices/latest:ReplicationPolicy" }, { type: "azure-nextgen:recoveryservices/latest:ReplicationPolicy" }, { type: "azure-native:recoveryservices/v20160810:ReplicationPolicy" }, { type: "azure-nextgen:recoveryservices/v20160810:ReplicationPolicy" }, { type: "azure-native:recoveryservices/v20180110:ReplicationPolicy" }, { type: "azure-nextgen:recoveryservices/v20180110:ReplicationPolicy" }, { type: "azure-native:recoveryservices/v20180710:ReplicationPolicy" }, { type: "azure-nextgen:recoveryservices/v20180710:ReplicationPolicy" }] };
...
export interface ReplicationPolicyArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.CreatePolicyInputProperties>;
    /**
