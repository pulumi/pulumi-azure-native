 ...
 * vCenter definition.
 *
 * @deprecated azure-native:recoveryservices/v20220101:ReplicationvCenter is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationvCenter to guarantee forwards compatibility.
 */
export class ReplicationvCenter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationvCenter {
        pulumi.log.warn("ReplicationvCenter is deprecated: azure-native:recoveryservices/v20220101:ReplicationvCenter is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationvCenter to guarantee forwards compatibility.")
