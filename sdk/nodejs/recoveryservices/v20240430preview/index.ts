...
// Export enums:
export * from "../../types/enums/recoveryservices/v20240430preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:recoveryservices/v20240430preview:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:recoveryservices/v20240430preview:ProtectedItem":
                return new ProtectedItem(name, <any>undefined, { urn })
            case "azure-native:recoveryservices/v20240430preview:ProtectionContainer":
                return new ProtectionContainer(name, <any>undefined, { urn })
            case "azure-native:recoveryservices/v20240430preview:ProtectionIntent":
                return new ProtectionIntent(name, <any>undefined, { urn })
            case "azure-native:recoveryservices/v20240430preview:ProtectionPolicy":
                return new ProtectionPolicy(name, <any>undefined, { urn })
            case "azure-native:recoveryservices/v20240430preview:ResourceGuardProxy":
                return new ResourceGuardProxy(name, <any>undefined, { urn })
            case "azure-native:recoveryservices/v20240430preview:Vault":
...
pulumi.runtime.registerResourceModule("azure-native", "recoveryservices/v20240430preview", _module)
