...
export function getReplicationPolicy(args: GetReplicationPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:recoveryservices/v20160810:getReplicationPolicy", {
...
export interface GetReplicationPolicyResult {
     ...
     * The custom data.
     */
    readonly properties: outputs.recoveryservices.v20160810.PolicyPropertiesInvokeResponse;
    /**
     * Resource Type
     */
