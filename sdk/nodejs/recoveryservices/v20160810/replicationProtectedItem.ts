...
export class ReplicationProtectedItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:recoveryservices/v20160810:ReplicationProtectedItem';
    ...
    constructor(name: string, args: ReplicationProtectedItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices:ReplicationProtectedItem" }, { type: "azure-nextgen:recoveryservices/latest:ReplicationProtectedItem" }, { type: "azure-nextgen:recoveryservices/v20180110:ReplicationProtectedItem" }, { type: "azure-nextgen:recoveryservices/v20180710:ReplicationProtectedItem" }] };
