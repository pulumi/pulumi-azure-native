...
export class ReplicationRecoveryPlan extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReplicationRecoveryPlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationRecoveryPlan" }, { type: "azurerm:recoveryservices/preview:ReplicationRecoveryPlan" }, { type: "azurerm:recoveryservices/v20180110:ReplicationRecoveryPlan" }, { type: "azurerm:recoveryservices/v20180710:ReplicationRecoveryPlan" }] };
