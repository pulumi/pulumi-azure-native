...
export class ReplicationProtectionContainerMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReplicationProtectionContainerMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationProtectionContainerMapping" }, { type: "azurerm:recoveryservices/preview:ReplicationProtectionContainerMapping" }, { type: "azurerm:recoveryservices/v20180110:ReplicationProtectionContainerMapping" }, { type: "azurerm:recoveryservices/v20180710:ReplicationProtectionContainerMapping" }] };
