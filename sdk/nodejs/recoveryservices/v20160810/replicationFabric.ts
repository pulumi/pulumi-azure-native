...
export class ReplicationFabric extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ReplicationFabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationFabric" }, { type: "azurerm:recoveryservices/preview:ReplicationFabric" }, { type: "azurerm:recoveryservices/v20180110:ReplicationFabric" }, { type: "azurerm:recoveryservices/v20180710:ReplicationFabric" }] };
