...
export class ReplicationFabric extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReplicationFabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices/latest:ReplicationFabric" }, { type: "azure-nextgen:recoveryservices/v20180110:ReplicationFabric" }, { type: "azure-nextgen:recoveryservices/v20180710:ReplicationFabric" }] };
