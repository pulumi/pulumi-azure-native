...
export class ReplicationPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ReplicationPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationPolicy" }, { type: "azurerm:recoveryservices/v20180110:ReplicationPolicy" }, { type: "azurerm:recoveryservices/v20180710:ReplicationPolicy" }] };
