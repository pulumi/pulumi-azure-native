 ...
 * Provider details.
 *
 * @deprecated azure-native:recoveryservices/v20210210:ReplicationRecoveryServicesProvider is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationRecoveryServicesProvider to guarantee forwards compatibility.
 */
export class ReplicationRecoveryServicesProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20210210:ReplicationRecoveryServicesProvider';
     ...
     * Provider properties.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20210210.RecoveryServicesProviderPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationRecoveryServicesProviderArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20210210.AddRecoveryServicesProviderInputPropertiesArgs>;
    /**
