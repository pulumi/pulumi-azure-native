...
export class ReplicationNetworkMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationNetworkMapping {
        pulumi.log.warn("ReplicationNetworkMapping is deprecated: azure-native:recoveryservices/v20210210:ReplicationNetworkMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20210301:ReplicationNetworkMapping to guarantee forwards compatibility.")
