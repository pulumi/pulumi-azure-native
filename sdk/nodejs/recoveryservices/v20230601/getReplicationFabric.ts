...
export interface GetReplicationFabricResult {
     ...
     * Fabric related data.
     */
    readonly properties: outputs.recoveryservices.v20230601.FabricPropertiesResponse;
    /**
     * Resource Type
     */
...
export function getReplicationFabricOutput(args: GetReplicationFabricOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetReplicationFabricResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:recoveryservices/v20230601:getReplicationFabric", {
        "fabricName": args.fabricName,
        "filter": args.filter,
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
