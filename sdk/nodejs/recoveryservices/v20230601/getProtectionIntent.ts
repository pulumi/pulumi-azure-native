...
export interface GetProtectionIntentResult {
     ...
     */
    readonly properties: outputs.recoveryservices.v20230601.AzureRecoveryServiceVaultProtectionIntentResponse | outputs.recoveryservices.v20230601.AzureResourceProtectionIntentResponse | outputs.recoveryservices.v20230601.AzureWorkloadAutoProtectionIntentResponse | outputs.recoveryservices.v20230601.AzureWorkloadContainerAutoProtectionIntentResponse | outputs.recoveryservices.v20230601.AzureWorkloadSQLAutoProtectionIntentResponse;
    /**
     * Resource tags.
     */
...
export function getProtectionIntentOutput(args: GetProtectionIntentOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetProtectionIntentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:recoveryservices/v20230601:getProtectionIntent", {
        "fabricName": args.fabricName,
        "intentObjectName": args.intentObjectName,
        "resourceGroupName": args.resourceGroupName,
        "vaultName": args.vaultName,
