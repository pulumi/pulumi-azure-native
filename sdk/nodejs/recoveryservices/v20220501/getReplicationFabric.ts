...
export function getReplicationFabric(args: GetReplicationFabricArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationFabricResult> {
    pulumi.log.warn("getReplicationFabric is deprecated: azure-native:recoveryservices/v20220501:ReplicationFabric is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationFabric to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:recoveryservices/v20220501:getReplicationFabric", {
...
export interface GetReplicationFabricResult {
     ...
     * Fabric related data.
     */
    readonly properties: outputs.recoveryservices.v20220501.FabricPropertiesResponse;
    /**
     * Resource Type
     */
