 ...
 */
/** @deprecated azure-native:recoveryservices/v20220501:ReplicationProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationProtectedItem to guarantee forwards compatibility. */
export function getReplicationProtectedItem(args: GetReplicationProtectedItemArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationProtectedItemResult> {
    pulumi.log.warn("getReplicationProtectedItem is deprecated: azure-native:recoveryservices/v20220501:ReplicationProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationProtectedItem to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:recoveryservices/v20220501:getReplicationProtectedItem", {
...
export interface GetReplicationProtectedItemResult {
     ...
     * The custom data.
     */
    readonly properties: outputs.recoveryservices.v20220501.ReplicationProtectedItemPropertiesResponse;
    /**
     * Resource Type
     */
