...
export class ReplicationRecoveryPlan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationRecoveryPlan {
        pulumi.log.warn("ReplicationRecoveryPlan is deprecated: azure-native:recoveryservices/v20220501:ReplicationRecoveryPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationRecoveryPlan to guarantee forwards compatibility.")
