...
export function getReplicationvCenter(args: GetReplicationvCenterArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationvCenterResult> {
    pulumi.log.warn("getReplicationvCenter is deprecated: azure-native:recoveryservices/v20230201:ReplicationvCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationvCenter to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:recoveryservices/v20230201:getReplicationvCenter", {
...
export interface GetReplicationvCenterResult {
     ...
     */
    readonly properties: outputs.recoveryservices.v20230201.VCenterPropertiesResponse;
    /**
     * Resource Type
     */
