...
export class ReplicationMigrationItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230201:ReplicationMigrationItem';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20230201.MigrationItemPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, args: ReplicationMigrationItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:recoveryservices:ReplicationMigrationItem" }, { type: "azure-native:recoveryservices/v20180710:ReplicationMigrationItem" }, { type: "azure-native:recoveryservices/v20210301:ReplicationMigrationItem" }, { type: "azure-native:recoveryservices/v20230401:ReplicationMigrationItem" }] };
...
export interface ReplicationMigrationItemArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20230201.EnableMigrationInputPropertiesArgs>;
    /**
