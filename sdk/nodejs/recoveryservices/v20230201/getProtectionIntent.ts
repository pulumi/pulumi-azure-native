...
export function getProtectionIntent(args: GetProtectionIntentArgs, opts?: pulumi.InvokeOptions): Promise<GetProtectionIntentResult> {
    pulumi.log.warn("getProtectionIntent is deprecated: azure-native:recoveryservices/v20230201:ProtectionIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionIntent to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:recoveryservices/v20230201:getProtectionIntent", {
...
export interface GetProtectionIntentResult {
     ...
     */
    readonly properties: outputs.recoveryservices.v20230201.AzureRecoveryServiceVaultProtectionIntentResponse | outputs.recoveryservices.v20230201.AzureResourceProtectionIntentResponse | outputs.recoveryservices.v20230201.AzureWorkloadAutoProtectionIntentResponse | outputs.recoveryservices.v20230201.AzureWorkloadContainerAutoProtectionIntentResponse | outputs.recoveryservices.v20230201.AzureWorkloadSQLAutoProtectionIntentResponse;
    /**
     * Resource tags.
     */
