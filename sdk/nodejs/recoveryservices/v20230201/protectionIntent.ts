...
export class ProtectionIntent extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProtectionIntent {
        pulumi.log.warn("ProtectionIntent is deprecated: azure-native:recoveryservices/v20230201:ProtectionIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionIntent to guarantee forwards compatibility.")
        return new ProtectionIntent(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230201:ProtectionIntent';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20230201.AzureRecoveryServiceVaultProtectionIntentResponse | outputs.recoveryservices.v20230201.AzureResourceProtectionIntentResponse | outputs.recoveryservices.v20230201.AzureWorkloadAutoProtectionIntentResponse | outputs.recoveryservices.v20230201.AzureWorkloadContainerAutoProtectionIntentResponse | outputs.recoveryservices.v20230201.AzureWorkloadSQLAutoProtectionIntentResponse>;
    /**
     * Resource tags.
     */
...
export interface ProtectionIntentArgs {
     ...
     * ProtectionIntentResource properties
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20230201.AzureRecoveryServiceVaultProtectionIntentArgs | inputs.recoveryservices.v20230201.AzureResourceProtectionIntentArgs | inputs.recoveryservices.v20230201.AzureWorkloadAutoProtectionIntentArgs | inputs.recoveryservices.v20230201.AzureWorkloadContainerAutoProtectionIntentArgs | inputs.recoveryservices.v20230201.AzureWorkloadSQLAutoProtectionIntentArgs>;
    /**
