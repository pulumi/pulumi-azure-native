...
export class ReplicationRecoveryServicesProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230201:ReplicationRecoveryServicesProvider';
     ...
     * Provider properties.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20230201.RecoveryServicesProviderPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationRecoveryServicesProviderArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20230201.AddRecoveryServicesProviderInputPropertiesArgs>;
    /**
