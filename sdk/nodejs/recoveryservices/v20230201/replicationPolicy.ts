...
export class ReplicationPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230201:ReplicationPolicy';
     ...
     * The custom data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20230201.PolicyPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, args: ReplicationPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:recoveryservices:ReplicationPolicy" }, { type: "azure-native:recoveryservices/v20180710:ReplicationPolicy" }, { type: "azure-native:recoveryservices/v20210301:ReplicationPolicy" }, { type: "azure-native:recoveryservices/v20230401:ReplicationPolicy" }] };
...
export interface ReplicationPolicyArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20230201.CreatePolicyInputPropertiesArgs>;
    /**
