 ...
 * Fabric definition.
 *
 * @deprecated azure-native:recoveryservices/v20220201:ReplicationFabric is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationFabric to guarantee forwards compatibility.
 */
export class ReplicationFabric extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationFabric {
        pulumi.log.warn("ReplicationFabric is deprecated: azure-native:recoveryservices/v20220201:ReplicationFabric is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationFabric to guarantee forwards compatibility.")
        return new ReplicationFabric(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20220201:ReplicationFabric';
     ...
     * Fabric related data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20220201.FabricPropertiesResponse>;
    /**
     * Resource Type
     */
