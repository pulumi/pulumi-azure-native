 ...
 *
 * @deprecated azure-native:recoveryservices/v20220201:ReplicationNetworkMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationNetworkMapping to guarantee forwards compatibility.
 */
export class ReplicationNetworkMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationNetworkMapping {
        pulumi.log.warn("ReplicationNetworkMapping is deprecated: azure-native:recoveryservices/v20220201:ReplicationNetworkMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationNetworkMapping to guarantee forwards compatibility.")
        return new ReplicationNetworkMapping(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20220201:ReplicationNetworkMapping';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20220201.NetworkMappingPropertiesResponse>;
    /**
     * Resource Type
     */
