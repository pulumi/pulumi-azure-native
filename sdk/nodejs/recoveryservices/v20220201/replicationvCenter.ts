 ...
 * vCenter definition.
 *
 * @deprecated azure-native:recoveryservices/v20220201:ReplicationvCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationvCenter to guarantee forwards compatibility.
 */
export class ReplicationvCenter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationvCenter {
        pulumi.log.warn("ReplicationvCenter is deprecated: azure-native:recoveryservices/v20220201:ReplicationvCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationvCenter to guarantee forwards compatibility.")
        return new ReplicationvCenter(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20220201:ReplicationvCenter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20220201.VCenterPropertiesResponse>;
    /**
     * Resource Type
     */
