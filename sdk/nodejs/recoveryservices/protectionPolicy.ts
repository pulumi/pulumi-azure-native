...
export class ProtectionPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices:ProtectionPolicy';
...
export interface ProtectionPolicyArgs {
     ...
     * The base class for a backup policy. Workload-specific backup policies are derived from this class.
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.ProtectionPolicyDefinition>;
    /**
