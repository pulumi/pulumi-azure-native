...
export class ProtectedItem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProtectedItem {
        return new ProtectedItem(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/v20190513:ProtectedItem';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20190513.ProtectedItemResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: ProtectedItemArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ProtectedItemArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ProtectedItem" }, { type: "azurerm:recoveryservices/preview:ProtectedItem" }, { type: "azurerm:recoveryservices/v20160601:ProtectedItem" }, { type: "azurerm:recoveryservices/v20190615:ProtectedItem" }] };
