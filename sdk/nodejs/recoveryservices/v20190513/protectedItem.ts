 ...
 *
 * @deprecated azure-native:recoveryservices/v20190513:ProtectedItem is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ProtectedItem to guarantee forwards compatibility.
 */
export class ProtectedItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20190513:ProtectedItem';
...
export interface ProtectedItemArgs {
     ...
     * ProtectedItemResource properties
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20190513.AzureFileshareProtectedItemArgs | inputs.recoveryservices.v20190513.AzureIaaSClassicComputeVMProtectedItemArgs | inputs.recoveryservices.v20190513.AzureIaaSComputeVMProtectedItemArgs | inputs.recoveryservices.v20190513.AzureIaaSVMProtectedItemArgs | inputs.recoveryservices.v20190513.AzureSqlProtectedItemArgs | inputs.recoveryservices.v20190513.AzureVmWorkloadProtectedItemArgs | inputs.recoveryservices.v20190513.AzureVmWorkloadSAPAseDatabaseProtectedItemArgs | inputs.recoveryservices.v20190513.AzureVmWorkloadSAPHanaDatabaseProtectedItemArgs | inputs.recoveryservices.v20190513.AzureVmWorkloadSQLDatabaseProtectedItemArgs | inputs.recoveryservices.v20190513.DPMProtectedItemArgs | inputs.recoveryservices.v20190513.GenericProtectedItemArgs | inputs.recoveryservices.v20190513.MabFileFolderProtectedItemArgs>;
    /**
