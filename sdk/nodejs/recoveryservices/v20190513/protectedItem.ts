...
export class ProtectedItem extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ProtectedItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ProtectedItem" }, { type: "azurerm:recoveryservices/v20160601:ProtectedItem" }, { type: "azurerm:recoveryservices/v20190615:ProtectedItem" }] };
