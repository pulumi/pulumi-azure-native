...
export class ResourceGuardProxy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20241101preview:ResourceGuardProxy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20241101preview.ResourceGuardProxyBaseResponse>;
    /**
     * Resource tags.
     */
...
export interface ResourceGuardProxyArgs {
     ...
     * ResourceGuardProxyBaseResource properties
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20241101preview.ResourceGuardProxyBaseArgs>;
    /**
