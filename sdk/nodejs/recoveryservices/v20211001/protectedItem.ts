...
export class ProtectedItem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProtectedItem {
        pulumi.log.warn("ProtectedItem is deprecated: azure-native:recoveryservices/v20211001:ProtectedItem is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ProtectedItem to guarantee forwards compatibility.")
