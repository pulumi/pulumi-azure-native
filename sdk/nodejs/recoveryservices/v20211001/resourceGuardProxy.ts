...
export class ResourceGuardProxy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourceGuardProxy {
        pulumi.log.warn("ResourceGuardProxy is deprecated: azure-native:recoveryservices/v20211001:ResourceGuardProxy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ResourceGuardProxy to guarantee forwards compatibility.")
