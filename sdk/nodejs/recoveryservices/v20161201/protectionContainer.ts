...
export class ProtectionContainer extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20161201.ProtectionContainerResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: ProtectionContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ProtectionContainer" }, { type: "azurerm:recoveryservices/preview:ProtectionContainer" }] };
