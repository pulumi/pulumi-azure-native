...
export class ProtectedItem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProtectedItem {
        pulumi.log.warn("ProtectedItem is deprecated: azure-native:recoveryservices/v20210101:ProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectedItem to guarantee forwards compatibility.")
