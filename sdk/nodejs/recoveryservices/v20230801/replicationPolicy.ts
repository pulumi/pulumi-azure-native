...
export class ReplicationPolicy extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20230801.PolicyPropertiesResponse>;
    /**
     * Resource Type
     */
