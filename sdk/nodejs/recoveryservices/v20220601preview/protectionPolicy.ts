 ...
 *
 * @deprecated azure-native:recoveryservices/v20220601preview:ProtectionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionPolicy to guarantee forwards compatibility.
 */
export class ProtectionPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProtectionPolicy {
        pulumi.log.warn("ProtectionPolicy is deprecated: azure-native:recoveryservices/v20220601preview:ProtectionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionPolicy to guarantee forwards compatibility.")
        return new ProtectionPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20220601preview:ProtectionPolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20220601preview.AzureFileShareProtectionPolicyResponse | outputs.recoveryservices.v20220601preview.AzureIaaSVMProtectionPolicyResponse | outputs.recoveryservices.v20220601preview.AzureSqlProtectionPolicyResponse | outputs.recoveryservices.v20220601preview.AzureVmWorkloadProtectionPolicyResponse | outputs.recoveryservices.v20220601preview.GenericProtectionPolicyResponse | outputs.recoveryservices.v20220601preview.MabProtectionPolicyResponse>;
    /**
     * Resource tags.
     */
...
export interface ProtectionPolicyArgs {
     ...
     * ProtectionPolicyResource properties
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20220601preview.AzureFileShareProtectionPolicyArgs | inputs.recoveryservices.v20220601preview.AzureIaaSVMProtectionPolicyArgs | inputs.recoveryservices.v20220601preview.AzureSqlProtectionPolicyArgs | inputs.recoveryservices.v20220601preview.AzureVmWorkloadProtectionPolicyArgs | inputs.recoveryservices.v20220601preview.GenericProtectionPolicyArgs | inputs.recoveryservices.v20220601preview.MabProtectionPolicyArgs>;
    /**
