...
export class ReplicationNetworkMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20241001:ReplicationNetworkMapping';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20241001.NetworkMappingPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationNetworkMappingArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20241001.CreateNetworkMappingInputPropertiesArgs>;
    /**
