...
export class ReplicationFabric extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/preview:ReplicationFabric';
     ...
     * Fabric related data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.preview.FabricPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, args: ReplicationFabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationFabric" }, { type: "azurerm:recoveryservices/v20160810:ReplicationFabric" }, { type: "azurerm:recoveryservices/v20180110:ReplicationFabric" }, { type: "azurerm:recoveryservices/v20180710:ReplicationFabric" }] };
...
export interface ReplicationFabricArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.preview.FabricCreationInputProperties>;
    /**
