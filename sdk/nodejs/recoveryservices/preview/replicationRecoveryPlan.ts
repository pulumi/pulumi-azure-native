...
export class ReplicationRecoveryPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/preview:ReplicationRecoveryPlan';
     ...
     * The custom details.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.preview.RecoveryPlanPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, argsOrState?: ReplicationRecoveryPlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationRecoveryPlan" }, { type: "azurerm:recoveryservices/v20160810:ReplicationRecoveryPlan" }, { type: "azurerm:recoveryservices/v20180110:ReplicationRecoveryPlan" }, { type: "azurerm:recoveryservices/v20180710:ReplicationRecoveryPlan" }] };
...
export interface ReplicationRecoveryPlanArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.recoveryservices.preview.CreateRecoveryPlanInputProperties>;
    /**
     * Recovery plan name.
     */
