...
export class ProtectedItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/preview:ProtectedItem';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.preview.AzureFileshareProtectedItemResponse | outputs.recoveryservices.preview.AzureIaaSVMProtectedItemResponse | outputs.recoveryservices.preview.AzureSqlProtectedItemResponse | outputs.recoveryservices.preview.AzureVmWorkloadProtectedItemResponse | outputs.recoveryservices.preview.DPMProtectedItemResponse | outputs.recoveryservices.preview.GenericProtectedItemResponse | outputs.recoveryservices.preview.MabFileFolderProtectedItemResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ProtectedItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ProtectedItem" }, { type: "azurerm:recoveryservices/v20160601:ProtectedItem" }, { type: "azurerm:recoveryservices/v20190513:ProtectedItem" }, { type: "azurerm:recoveryservices/v20190615:ProtectedItem" }] };
...
export interface ProtectedItemArgs {
     ...
     * ProtectedItemResource properties
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.preview.AzureFileshareProtectedItem | inputs.recoveryservices.preview.AzureIaaSVMProtectedItem | inputs.recoveryservices.preview.AzureSqlProtectedItem | inputs.recoveryservices.preview.AzureVmWorkloadProtectedItem | inputs.recoveryservices.preview.DPMProtectedItem | inputs.recoveryservices.preview.GenericProtectedItem | inputs.recoveryservices.preview.MabFileFolderProtectedItem>;
    /**
