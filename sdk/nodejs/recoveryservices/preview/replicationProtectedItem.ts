...
export class ReplicationProtectedItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/preview:ReplicationProtectedItem';
     ...
     * The custom data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.preview.ReplicationProtectedItemPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, args: ReplicationProtectedItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationProtectedItem" }, { type: "azurerm:recoveryservices/v20160810:ReplicationProtectedItem" }, { type: "azurerm:recoveryservices/v20180110:ReplicationProtectedItem" }, { type: "azurerm:recoveryservices/v20180710:ReplicationProtectedItem" }] };
...
export interface ReplicationProtectedItemArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.preview.EnableProtectionInputProperties>;
    /**
