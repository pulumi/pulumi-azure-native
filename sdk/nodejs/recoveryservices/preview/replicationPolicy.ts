...
export class ReplicationPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/preview:ReplicationPolicy';
     ...
     * The custom data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.preview.PolicyPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, argsOrState?: ReplicationPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationPolicy" }, { type: "azurerm:recoveryservices/v20160810:ReplicationPolicy" }, { type: "azurerm:recoveryservices/v20180110:ReplicationPolicy" }, { type: "azurerm:recoveryservices/v20180710:ReplicationPolicy" }] };
...
export interface ReplicationPolicyArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.preview.CreatePolicyInputProperties>;
    /**
