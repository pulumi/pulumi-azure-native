...
export function getProtectionPolicy(args: GetProtectionPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetProtectionPolicyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:recoveryservices/preview:getProtectionPolicy", {
...
export interface GetProtectionPolicyResult {
     ...
     */
    readonly properties: outputs.recoveryservices.preview.AzureIaaSVMProtectionPolicyResponse | outputs.recoveryservices.preview.AzureSqlProtectionPolicyResponse | outputs.recoveryservices.preview.MabProtectionPolicyResponse;
    /**
     * Resource tags.
     */
