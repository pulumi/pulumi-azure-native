...
export class ProtectionPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/preview:ProtectionPolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.preview.AzureIaaSVMProtectionPolicyResponse | outputs.recoveryservices.preview.AzureSqlProtectionPolicyResponse | outputs.recoveryservices.preview.MabProtectionPolicyResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ProtectionPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ProtectionPolicy" }, { type: "azurerm:recoveryservices/v20160601:ProtectionPolicy" }] };
...
export interface ProtectionPolicyArgs {
     ...
     * The base class for a backup policy. Workload-specific backup policies are derived from this class.
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.preview.AzureIaaSVMProtectionPolicy | inputs.recoveryservices.preview.AzureSqlProtectionPolicy | inputs.recoveryservices.preview.MabProtectionPolicy>;
    /**
