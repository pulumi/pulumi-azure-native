...
export class ProtectionContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/preview:ProtectionContainer';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.preview.AzureSqlContainerResponse | outputs.recoveryservices.preview.AzureStorageContainerResponse | outputs.recoveryservices.preview.AzureWorkloadContainerResponse | outputs.recoveryservices.preview.DpmContainerResponse | outputs.recoveryservices.preview.GenericContainerResponse | outputs.recoveryservices.preview.IaaSVMContainerResponse | outputs.recoveryservices.preview.MabContainerResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ProtectionContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ProtectionContainer" }, { type: "azurerm:recoveryservices/v20161201:ProtectionContainer" }] };
...
export interface ProtectionContainerArgs {
     ...
     * ProtectionContainerResource properties
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.preview.AzureSqlContainer | inputs.recoveryservices.preview.AzureStorageContainer | inputs.recoveryservices.preview.AzureWorkloadContainer | inputs.recoveryservices.preview.DpmContainer | inputs.recoveryservices.preview.GenericContainer | inputs.recoveryservices.preview.IaaSVMContainer | inputs.recoveryservices.preview.MabContainer>;
    /**
