...
export function getProtectionIntent(args: GetProtectionIntentArgs, opts?: pulumi.InvokeOptions): Promise<GetProtectionIntentResult> {
    ...
    return pulumi.runtime.invoke("azurerm:recoveryservices/preview:getProtectionIntent", {
...
export interface GetProtectionIntentResult {
     ...
     */
    readonly properties: outputs.recoveryservices.preview.AzureRecoveryServiceVaultProtectionIntentResponse | outputs.recoveryservices.preview.AzureResourceProtectionIntentResponse;
    /**
     * Resource tags.
     */
