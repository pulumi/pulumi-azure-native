...
export function getReplicationRecoveryPlan(args: GetReplicationRecoveryPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationRecoveryPlanResult> {
    ...
    return pulumi.runtime.invoke("azurerm:recoveryservices/preview:getReplicationRecoveryPlan", {
...
export interface GetReplicationRecoveryPlanResult {
     ...
     * The custom details.
     */
    readonly properties: outputs.recoveryservices.preview.RecoveryPlanPropertiesResponse;
    /**
     * Resource Type
     */
