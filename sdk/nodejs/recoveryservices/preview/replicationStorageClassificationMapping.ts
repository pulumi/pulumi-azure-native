...
export class ReplicationStorageClassificationMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationStorageClassificationMapping {
        return new ReplicationStorageClassificationMapping(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/preview:ReplicationStorageClassificationMapping';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.preview.StorageClassificationMappingPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, argsOrState?: ReplicationStorageClassificationMappingArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ReplicationStorageClassificationMappingArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationStorageClassificationMapping" }, { type: "azurerm:recoveryservices/v20160810:ReplicationStorageClassificationMapping" }, { type: "azurerm:recoveryservices/v20180110:ReplicationStorageClassificationMapping" }, { type: "azurerm:recoveryservices/v20180710:ReplicationStorageClassificationMapping" }] };
...
export interface ReplicationStorageClassificationMappingArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.preview.StorageMappingInputProperties>;
    /**
