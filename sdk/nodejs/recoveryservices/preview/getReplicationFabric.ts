...
export function getReplicationFabric(args: GetReplicationFabricArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationFabricResult> {
    ...
    return pulumi.runtime.invoke("azurerm:recoveryservices/preview:getReplicationFabric", {
...
export interface GetReplicationFabricResult {
     ...
     * Fabric related data.
     */
    readonly properties: outputs.recoveryservices.preview.FabricPropertiesResponse;
    /**
     * Resource Type
     */
