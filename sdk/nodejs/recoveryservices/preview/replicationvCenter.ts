...
export class ReplicationvCenter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/preview:ReplicationvCenter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.preview.VCenterPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, args: ReplicationvCenterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationvCenter" }, { type: "azurerm:recoveryservices/v20160810:ReplicationvCenter" }, { type: "azurerm:recoveryservices/v20180110:ReplicationvCenter" }, { type: "azurerm:recoveryservices/v20180710:ReplicationvCenter" }] };
...
export interface ReplicationvCenterArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.preview.AddVCenterRequestProperties>;
    /**
