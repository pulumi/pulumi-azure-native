...
export function getReplicationPolicy(args: GetReplicationPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationPolicyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:recoveryservices/preview:getReplicationPolicy", {
...
export interface GetReplicationPolicyResult {
     ...
     * The custom data.
     */
    readonly properties: outputs.recoveryservices.preview.PolicyPropertiesResponse;
    /**
     * Resource Type
     */
