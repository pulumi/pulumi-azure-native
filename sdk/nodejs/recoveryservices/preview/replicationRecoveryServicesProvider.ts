...
export class ReplicationRecoveryServicesProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/preview:ReplicationRecoveryServicesProvider';
     ...
     * Provider properties.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.preview.RecoveryServicesProviderPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, argsOrState?: ReplicationRecoveryServicesProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/latest:ReplicationRecoveryServicesProvider" }, { type: "azurerm:recoveryservices/v20180110:ReplicationRecoveryServicesProvider" }, { type: "azurerm:recoveryservices/v20180710:ReplicationRecoveryServicesProvider" }] };
...
export interface ReplicationRecoveryServicesProviderArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.recoveryservices.preview.AddRecoveryServicesProviderInputProperties>;
    /**
