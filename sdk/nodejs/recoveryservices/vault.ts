...
export class Vault extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:recoveryservices:Vault';
    ...
    constructor(name: string, args: VaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices/latest:Vault" }, { type: "azure-nextgen:recoveryservices/v20160601:Vault" }, { type: "azure-nextgen:recoveryservices/v20200202:Vault" }, { type: "azure-nextgen:recoveryservices/v20201001:Vault" }] };
