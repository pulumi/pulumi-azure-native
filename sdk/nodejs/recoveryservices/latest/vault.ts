...
export class Vault extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/latest:Vault';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.recoveryservices.latest.IdentityDataResponse | undefined>;
    /**
     * Resource location.
     */
    ...
    constructor(name: string, argsOrState?: VaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/preview:Vault" }, { type: "azurerm:recoveryservices/v20160601:Vault" }] };
...
export interface VaultArgs {
     ...
     * Identity for the resource.
     */
    readonly identity?: pulumi.Input<inputs.recoveryservices.latest.IdentityData>;
    /**
     * Resource location.
     */
     ...
     * Identifies the unique system identifier for each Azure resource.
     */
    readonly sku?: pulumi.Input<inputs.recoveryservices.latest.Sku>;
    /**
     * Resource tags.
     */
