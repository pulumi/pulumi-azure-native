...
export function getProtectedItem(args: GetProtectedItemArgs, opts?: pulumi.InvokeOptions): Promise<GetProtectedItemResult> {
    pulumi.log.warn("getProtectedItem is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getProtectedItem'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-native:recoveryservices/latest:getProtectedItem", {
