...
export class ReplicationvCenter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationvCenter {
        pulumi.log.warn("ReplicationvCenter is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:recoveryservices:ReplicationvCenter'.")
        return new ReplicationvCenter(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/latest:ReplicationvCenter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.latest.VCenterPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, args: ReplicationvCenterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices/latest:ReplicationvCenter" }, { type: "azure-native:recoveryservices:ReplicationvCenter" }, { type: "azure-nextgen:recoveryservices:ReplicationvCenter" }, { type: "azure-native:recoveryservices/v20160810:ReplicationvCenter" }, { type: "azure-nextgen:recoveryservices/v20160810:ReplicationvCenter" }, { type: "azure-native:recoveryservices/v20180110:ReplicationvCenter" }, { type: "azure-nextgen:recoveryservices/v20180110:ReplicationvCenter" }, { type: "azure-native:recoveryservices/v20180710:ReplicationvCenter" }, { type: "azure-nextgen:recoveryservices/v20180710:ReplicationvCenter" }] };
...
export interface ReplicationvCenterArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.latest.AddVCenterRequestProperties>;
    /**
