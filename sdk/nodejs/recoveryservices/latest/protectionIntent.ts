...
export class ProtectionIntent extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.latest.ProtectionIntentResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: ProtectionIntentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/preview:ProtectionIntent" }, { type: "azurerm:recoveryservices/v20170701:ProtectionIntent" }] };
...
export interface ProtectionIntentArgs {
     ...
     * ProtectionIntentResource properties
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.latest.ProtectionIntent>;
    /**
