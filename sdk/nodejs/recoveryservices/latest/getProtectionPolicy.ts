...
export function getProtectionPolicy(args: GetProtectionPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetProtectionPolicyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:recoveryservices/latest:getProtectionPolicy", {
...
export interface GetProtectionPolicyResult {
     ...
     */
    readonly properties: outputs.recoveryservices.latest.ProtectionPolicyResponse;
    /**
     * Resource tags.
     */
