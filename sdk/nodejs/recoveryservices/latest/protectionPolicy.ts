...
export class ProtectionPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProtectionPolicy {
        return new ProtectionPolicy(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/latest:ProtectionPolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.latest.ProtectionPolicyResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: ProtectionPolicyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ProtectionPolicyArgs {
     ...
     * The base class for a backup policy. Workload-specific backup policies are derived from this class.
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.latest.ProtectionPolicy>;
    /**
