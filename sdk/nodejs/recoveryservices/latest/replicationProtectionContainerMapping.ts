...
export class ReplicationProtectionContainerMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationProtectionContainerMapping {
        return new ReplicationProtectionContainerMapping(name, undefined, { ...opts, id: id });
    }
     ...
     * The custom data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.latest.ProtectionContainerMappingPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, argsOrState?: ReplicationProtectionContainerMappingArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ReplicationProtectionContainerMappingArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/preview:ReplicationProtectionContainerMapping" }, { type: "azurerm:recoveryservices/v20160810:ReplicationProtectionContainerMapping" }, { type: "azurerm:recoveryservices/v20180110:ReplicationProtectionContainerMapping" }, { type: "azurerm:recoveryservices/v20180710:ReplicationProtectionContainerMapping" }] };
...
export interface ReplicationProtectionContainerMappingArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.latest.CreateProtectionContainerMappingInputProperties>;
    /**
