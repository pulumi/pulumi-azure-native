...
export class ProtectionContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/latest:ProtectionContainer';
    ...
    constructor(name: string, args: ProtectionContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/preview:ProtectionContainer" }, { type: "azurerm:recoveryservices/v20161201:ProtectionContainer" }] };
