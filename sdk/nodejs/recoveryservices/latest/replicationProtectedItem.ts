...
export class ReplicationProtectedItem extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReplicationProtectedItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/v20160810:ReplicationProtectedItem" }, { type: "azurerm:recoveryservices/v20180110:ReplicationProtectedItem" }, { type: "azurerm:recoveryservices/v20180710:ReplicationProtectedItem" }] };
