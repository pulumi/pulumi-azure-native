...
export class ReplicationMigrationItem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationMigrationItem {
        pulumi.log.warn("ReplicationMigrationItem is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:recoveryservices:ReplicationMigrationItem'.")
        return new ReplicationMigrationItem(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/latest:ReplicationMigrationItem';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.latest.MigrationItemPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, args: ReplicationMigrationItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices/latest:ReplicationMigrationItem" }, { type: "azure-native:recoveryservices:ReplicationMigrationItem" }, { type: "azure-nextgen:recoveryservices:ReplicationMigrationItem" }, { type: "azure-native:recoveryservices/v20180110:ReplicationMigrationItem" }, { type: "azure-nextgen:recoveryservices/v20180110:ReplicationMigrationItem" }, { type: "azure-native:recoveryservices/v20180710:ReplicationMigrationItem" }, { type: "azure-nextgen:recoveryservices/v20180710:ReplicationMigrationItem" }] };
...
export interface ReplicationMigrationItemArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.recoveryservices.latest.EnableMigrationInputProperties>;
    /**
