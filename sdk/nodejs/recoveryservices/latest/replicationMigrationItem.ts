...
export class ReplicationMigrationItem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationMigrationItem {
        return new ReplicationMigrationItem(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/latest:ReplicationMigrationItem';
    ...
    constructor(name: string, argsOrState?: ReplicationMigrationItemArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ReplicationMigrationItemArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/preview:ReplicationMigrationItem" }, { type: "azurerm:recoveryservices/v20180110:ReplicationMigrationItem" }, { type: "azurerm:recoveryservices/v20180710:ReplicationMigrationItem" }] };
