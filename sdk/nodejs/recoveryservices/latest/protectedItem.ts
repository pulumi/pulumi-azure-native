...
export class ProtectedItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/latest:ProtectedItem';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.latest.ProtectedItemResponse>;
    /**
     * Resource tags.
     */
...
export interface ProtectedItemArgs {
     ...
     * ProtectedItemResource properties
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.latest.ProtectedItem>;
    /**
