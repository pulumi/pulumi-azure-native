...
export function getProtectionIntent(args: GetProtectionIntentArgs, opts?: pulumi.InvokeOptions): Promise<GetProtectionIntentResult> {
    ...
    return pulumi.runtime.invoke("azurerm:recoveryservices/latest:getProtectionIntent", {
...
export interface GetProtectionIntentResult {
     ...
     */
    readonly properties: outputs.recoveryservices.latest.ProtectionIntentResponse;
    /**
     * Resource tags.
     */
