...
export class ReplicationNetworkMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices/latest:ReplicationNetworkMapping';
    ...
    constructor(name: string, args: ReplicationNetworkMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:recoveryservices/preview:ReplicationNetworkMapping" }, { type: "azurerm:recoveryservices/v20160810:ReplicationNetworkMapping" }, { type: "azurerm:recoveryservices/v20180110:ReplicationNetworkMapping" }, { type: "azurerm:recoveryservices/v20180710:ReplicationNetworkMapping" }] };
