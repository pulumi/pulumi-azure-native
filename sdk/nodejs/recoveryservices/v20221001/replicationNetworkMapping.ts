 ...
 *
 * @deprecated azure-native:recoveryservices/v20221001:ReplicationNetworkMapping is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationNetworkMapping to guarantee forwards compatibility.
 */
export class ReplicationNetworkMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20221001:ReplicationNetworkMapping';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20221001.NetworkMappingPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationNetworkMappingArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20221001.CreateNetworkMappingInputPropertiesArgs>;
    /**
