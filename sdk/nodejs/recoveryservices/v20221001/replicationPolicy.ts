...
export class ReplicationPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationPolicy {
        pulumi.log.warn("ReplicationPolicy is deprecated: azure-native:recoveryservices/v20221001:ReplicationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationPolicy to guarantee forwards compatibility.")
