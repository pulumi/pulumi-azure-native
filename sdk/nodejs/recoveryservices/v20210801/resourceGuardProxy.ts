...
export class ResourceGuardProxy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20210801:ResourceGuardProxy';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.recoveryservices.v20210801.ResourceGuardProxyBaseResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ResourceGuardProxyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices/v20210801:ResourceGuardProxy" }, { type: "azure-native:recoveryservices:ResourceGuardProxy" }, { type: "azure-nextgen:recoveryservices:ResourceGuardProxy" }, { type: "azure-native:recoveryservices/v20210201preview:ResourceGuardProxy" }, { type: "azure-nextgen:recoveryservices/v20210201preview:ResourceGuardProxy" }, { type: "azure-native:recoveryservices/v20210701:ResourceGuardProxy" }, { type: "azure-nextgen:recoveryservices/v20210701:ResourceGuardProxy" }] };
