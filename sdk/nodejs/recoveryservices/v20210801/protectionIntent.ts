...
export class ProtectionIntent extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProtectionIntent {
        pulumi.log.warn("ProtectionIntent is deprecated: azure-native:recoveryservices/v20210801:ProtectionIntent is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ProtectionIntent to guarantee forwards compatibility.")
