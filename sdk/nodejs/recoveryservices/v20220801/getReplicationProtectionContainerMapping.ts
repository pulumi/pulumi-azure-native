...
export function getReplicationProtectionContainerMapping(args: GetReplicationProtectionContainerMappingArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationProtectionContainerMappingResult> {
    pulumi.log.warn("getReplicationProtectionContainerMapping is deprecated: azure-native:recoveryservices/v20220801:ReplicationProtectionContainerMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationProtectionContainerMapping to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:recoveryservices/v20220801:getReplicationProtectionContainerMapping", {
...
export interface GetReplicationProtectionContainerMappingResult {
     ...
     * The custom data.
     */
    readonly properties: outputs.recoveryservices.v20220801.ProtectionContainerMappingPropertiesResponse;
    /**
     * Resource Type
     */
