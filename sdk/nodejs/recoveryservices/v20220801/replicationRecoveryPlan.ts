 ...
 *
 * @deprecated azure-native:recoveryservices/v20220801:ReplicationRecoveryPlan is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationRecoveryPlan to guarantee forwards compatibility.
 */
export class ReplicationRecoveryPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20220801:ReplicationRecoveryPlan';
     ...
     * The custom details.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20220801.RecoveryPlanPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationRecoveryPlanArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20220801.CreateRecoveryPlanInputPropertiesArgs>;
    /**
     * Recovery plan name.
     */
