...
export function getReplicationStorageClassificationMapping(args: GetReplicationStorageClassificationMappingArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationStorageClassificationMappingResult> {
    pulumi.log.warn("getReplicationStorageClassificationMapping is deprecated: azure-native:recoveryservices/v20220801:ReplicationStorageClassificationMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationStorageClassificationMapping to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:recoveryservices/v20220801:getReplicationStorageClassificationMapping", {
...
export interface GetReplicationStorageClassificationMappingResult {
     ...
     */
    readonly properties: outputs.recoveryservices.v20220801.StorageClassificationMappingPropertiesResponse;
    /**
     * Resource Type
     */
