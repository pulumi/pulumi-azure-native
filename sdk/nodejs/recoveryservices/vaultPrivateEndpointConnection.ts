...
export class VaultPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:recoveryservices:VaultPrivateEndpointConnection';
...
export interface VaultPrivateEndpointConnectionState {
     ...
     * PrivateEndpointConnectionResource properties
     */
    readonly properties: pulumi.Input<inputs.recoveryservices.PrivateEndpointConnectionResponse>;
    /**
     * Resource tags.
     */
