...
export class ResourceGuardProxy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ResourceGuardProxyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:recoveryservices/v20210701:ResourceGuardProxy" }, { type: "azure-native:recoveryservices:ResourceGuardProxy" }, { type: "azure-nextgen:recoveryservices:ResourceGuardProxy" }, { type: "azure-native:recoveryservices/v20210201preview:ResourceGuardProxy" }, { type: "azure-nextgen:recoveryservices/v20210201preview:ResourceGuardProxy" }] };
