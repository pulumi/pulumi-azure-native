...
export class ReplicationFabric extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20240201:ReplicationFabric';
     ...
     * Fabric related data.
     */
    public readonly properties!: pulumi.Output<outputs.recoveryservices.v20240201.FabricPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationFabricArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20240201.FabricCreationInputPropertiesArgs>;
    /**
