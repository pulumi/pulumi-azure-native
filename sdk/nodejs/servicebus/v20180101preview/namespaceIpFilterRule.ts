...
export class NamespaceIpFilterRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NamespaceIpFilterRule {
        return new NamespaceIpFilterRule(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicebus/v20180101preview:NamespaceIpFilterRule';
    ...
    constructor(name: string, argsOrState?: NamespaceIpFilterRuleArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as NamespaceIpFilterRuleArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicebus/preview:NamespaceIpFilterRule" }] };
