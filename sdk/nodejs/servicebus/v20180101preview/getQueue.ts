 ...
 */
/** @deprecated azure-native:servicebus/v20180101preview:Queue is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:Queue to guarantee forwards compatibility. */
export function getQueue(args: GetQueueArgs, opts?: pulumi.InvokeOptions): Promise<GetQueueResult> {
    pulumi.log.warn("getQueue is deprecated: azure-native:servicebus/v20180101preview:Queue is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:Queue to guarantee forwards compatibility.")
