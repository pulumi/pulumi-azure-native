...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicebus/v20180101preview:PrivateEndpointConnection" }, { type: "azure-native:servicebus:PrivateEndpointConnection" }, { type: "azure-nextgen:servicebus:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * The Private Endpoint resource for this Connection.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.servicebus.v20180101preview.PrivateEndpoint>;
    /**
     ...
     * Details about the state of the connection.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.servicebus.v20180101preview.ConnectionState>;
    /**
     * Provisioning state of the Private Endpoint Connection.
     */
