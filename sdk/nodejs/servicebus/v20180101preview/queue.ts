...
export class Queue extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Queue {
        pulumi.log.warn("Queue is deprecated: azure-native:servicebus/v20180101preview:Queue is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:Queue to guarantee forwards compatibility.")
        return new Queue(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicebus/v20180101preview:Queue';
    ...
    constructor(name: string, args: QueueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicebus:Queue" }, { type: "azure-native:servicebus/v20140901:Queue" }, { type: "azure-native:servicebus/v20150801:Queue" }, { type: "azure-native:servicebus/v20170401:Queue" }, { type: "azure-native:servicebus/v20210101preview:Queue" }, { type: "azure-native:servicebus/v20210601preview:Queue" }, { type: "azure-native:servicebus/v20211101:Queue" }, { type: "azure-native:servicebus/v20220101preview:Queue" }, { type: "azure-native:servicebus/v20221001preview:Queue" }] };
