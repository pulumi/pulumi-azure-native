...
export class NamespaceNetworkRuleSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicebus/v20180101preview:NamespaceNetworkRuleSet';
     ...
     * List of IpRules
     */
    public readonly ipRules!: pulumi.Output<outputs.servicebus.v20180101preview.NWRuleSetIpRulesResponse[] | undefined>;
    /**
     * Resource name
     */
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<outputs.servicebus.v20180101preview.NWRuleSetVirtualNetworkRulesResponse[] | undefined>;
    ...
    constructor(name: string, args: NamespaceNetworkRuleSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicebus/v20180101preview:NamespaceNetworkRuleSet" }, { type: "azure-native:servicebus:NamespaceNetworkRuleSet" }, { type: "azure-nextgen:servicebus:NamespaceNetworkRuleSet" }, { type: "azure-native:servicebus/latest:NamespaceNetworkRuleSet" }, { type: "azure-nextgen:servicebus/latest:NamespaceNetworkRuleSet" }, { type: "azure-native:servicebus/v20170401:NamespaceNetworkRuleSet" }, { type: "azure-nextgen:servicebus/v20170401:NamespaceNetworkRuleSet" }, { type: "azure-native:servicebus/v20210101preview:NamespaceNetworkRuleSet" }, { type: "azure-nextgen:servicebus/v20210101preview:NamespaceNetworkRuleSet" }] };
...
export interface NamespaceNetworkRuleSetArgs {
     ...
     * List of IpRules
     */
    readonly ipRules?: pulumi.Input<pulumi.Input<inputs.servicebus.v20180101preview.NWRuleSetIpRules>[]>;
    /**
     * The namespace name
     */
     ...
     * List VirtualNetwork Rules
     */
    readonly virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.servicebus.v20180101preview.NWRuleSetVirtualNetworkRules>[]>;
}
