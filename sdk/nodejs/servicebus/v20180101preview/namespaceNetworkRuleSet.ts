...
export class NamespaceNetworkRuleSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NamespaceNetworkRuleSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicebus:NamespaceNetworkRuleSet" }, { type: "azure-native:servicebus/v20170401:NamespaceNetworkRuleSet" }, { type: "azure-native:servicebus/v20210101preview:NamespaceNetworkRuleSet" }, { type: "azure-native:servicebus/v20210601preview:NamespaceNetworkRuleSet" }] };
...
export interface NamespaceNetworkRuleSetArgs {
     ...
     * Default Action for Network Rule Set
     */
    defaultAction?: pulumi.Input<string | enums.servicebus.v20180101preview.DefaultAction>;
    /**
     * List of IpRules
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.servicebus.v20180101preview.NWRuleSetIpRulesArgs>[]>;
    /**
     * The namespace name
     */
     ...
     * List VirtualNetwork Rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.servicebus.v20180101preview.NWRuleSetVirtualNetworkRulesArgs>[]>;
}
