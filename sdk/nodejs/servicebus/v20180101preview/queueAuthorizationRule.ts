...
export class QueueAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicebus/v20180101preview:QueueAuthorizationRule';
    ...
    constructor(name: string, args: QueueAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicebus/v20180101preview:QueueAuthorizationRule" }, { type: "azure-native:servicebus:QueueAuthorizationRule" }, { type: "azure-nextgen:servicebus:QueueAuthorizationRule" }, { type: "azure-native:servicebus/v20140901:QueueAuthorizationRule" }, { type: "azure-nextgen:servicebus/v20140901:QueueAuthorizationRule" }, { type: "azure-native:servicebus/v20150801:QueueAuthorizationRule" }, { type: "azure-nextgen:servicebus/v20150801:QueueAuthorizationRule" }, { type: "azure-native:servicebus/v20170401:QueueAuthorizationRule" }, { type: "azure-nextgen:servicebus/v20170401:QueueAuthorizationRule" }, { type: "azure-native:servicebus/v20210101preview:QueueAuthorizationRule" }, { type: "azure-nextgen:servicebus/v20210101preview:QueueAuthorizationRule" }, { type: "azure-native:servicebus/v20210601preview:QueueAuthorizationRule" }, { type: "azure-nextgen:servicebus/v20210601preview:QueueAuthorizationRule" }] };
...
export interface QueueAuthorizationRuleArgs {
     ...
     * The rights associated with the rule.
     */
    rights: pulumi.Input<pulumi.Input<enums.servicebus.v20180101preview.AccessRights>[]>;
}
