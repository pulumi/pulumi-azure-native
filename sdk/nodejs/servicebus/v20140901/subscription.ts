...
export class Subscription extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: SubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicebus/latest:Subscription" }, { type: "azurerm:servicebus/preview:Subscription" }, { type: "azurerm:servicebus/v20150801:Subscription" }, { type: "azurerm:servicebus/v20170401:Subscription" }] };
