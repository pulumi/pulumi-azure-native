 ...
 *
 * const topicAuthorizationRule = new azure_native.servicebus.v20220101preview.TopicAuthorizationRule("topicAuthorizationRule", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:servicebus/v20220101preview:TopicAuthorizationRule sdk-AuthRules-4310 /subscriptions/5f750a97-50d9-4e36-8081-c9ee4c0210d4/resourceGroups/ArunMonocle/providers/Microsoft.ServiceBus/namespaces/sdk-Namespace-6261/topics/sdk-Topics-1984/authorizationRules/sdk-AuthRules-4310 
 * ```
 */
...
export interface TopicAuthorizationRuleArgs {
     ...
     * The rights associated with the rule.
     */
    rights: pulumi.Input<pulumi.Input<string | enums.servicebus.v20220101preview.AccessRights>[]>;
    /**
     * The topic name.
     */
