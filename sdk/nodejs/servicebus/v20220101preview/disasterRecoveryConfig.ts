...
export class DisasterRecoveryConfig extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DisasterRecoveryConfig {
        pulumi.log.warn("DisasterRecoveryConfig is deprecated: azure-native:servicebus/v20220101preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.")
