...
export class TopicAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicebus/preview:TopicAuthorizationRule';
    ...
    constructor(name: string, argsOrState?: TopicAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicebus/latest:TopicAuthorizationRule" }, { type: "azurerm:servicebus/v20140901:TopicAuthorizationRule" }, { type: "azurerm:servicebus/v20150801:TopicAuthorizationRule" }, { type: "azurerm:servicebus/v20170401:TopicAuthorizationRule" }] };
