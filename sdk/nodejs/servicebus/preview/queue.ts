...
export class Queue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicebus/preview:Queue';
     ...
     */
    public /*out*/ readonly countDetails!: pulumi.Output<outputs.servicebus.preview.MessageCountDetailsResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: QueueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicebus/latest:Queue" }, { type: "azurerm:servicebus/v20140901:Queue" }, { type: "azurerm:servicebus/v20150801:Queue" }, { type: "azurerm:servicebus/v20170401:Queue" }] };
