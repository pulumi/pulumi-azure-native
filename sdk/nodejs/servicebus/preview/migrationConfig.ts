...
export class MigrationConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicebus/preview:MigrationConfig';
    ...
    constructor(name: string, argsOrState?: MigrationConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicebus/latest:MigrationConfig" }, { type: "azurerm:servicebus/v20170401:MigrationConfig" }] };
