...
export class QueueAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicebus/preview:QueueAuthorizationRule';
    ...
    constructor(name: string, argsOrState?: QueueAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicebus/latest:QueueAuthorizationRule" }, { type: "azurerm:servicebus/v20140901:QueueAuthorizationRule" }, { type: "azurerm:servicebus/v20150801:QueueAuthorizationRule" }, { type: "azurerm:servicebus/v20170401:QueueAuthorizationRule" }] };
