...
export class NamespaceVirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicebus/preview:NamespaceVirtualNetworkRule';
    ...
    constructor(name: string, argsOrState?: NamespaceVirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicebus/v20180101preview:NamespaceVirtualNetworkRule" }] };
