...
export class DisasterRecoveryConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicebus/preview:DisasterRecoveryConfig';
    ...
    constructor(name: string, args: DisasterRecoveryConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicebus/latest:DisasterRecoveryConfig" }, { type: "azurerm:servicebus/v20170401:DisasterRecoveryConfig" }] };
