...
export class TopicAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:servicebus/v20170401:TopicAuthorizationRule';
    ...
    constructor(name: string, args: TopicAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicebus:TopicAuthorizationRule" }, { type: "azure-nextgen:servicebus/latest:TopicAuthorizationRule" }, { type: "azure-nextgen:servicebus/v20140901:TopicAuthorizationRule" }, { type: "azure-nextgen:servicebus/v20150801:TopicAuthorizationRule" }, { type: "azure-nextgen:servicebus/v20180101preview:TopicAuthorizationRule" }] };
