...
export class DisasterRecoveryConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicebus/v20170401:DisasterRecoveryConfig';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.servicebus.v20170401.ArmDisasterRecoveryResponseProperties>;
    /**
     * Resource type
     */
...
export interface DisasterRecoveryConfigArgs {
     ...
     * Properties required to the Create Or Update Alias(Disaster Recovery configurations)
     */
    readonly properties?: pulumi.Input<inputs.servicebus.v20170401.ArmDisasterRecoveryProperties>;
    /**
