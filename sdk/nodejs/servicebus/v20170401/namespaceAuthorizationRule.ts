...
export class NamespaceAuthorizationRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NamespaceAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicebus/latest:NamespaceAuthorizationRule" }, { type: "azurerm:servicebus/v20140901:NamespaceAuthorizationRule" }, { type: "azurerm:servicebus/v20150801:NamespaceAuthorizationRule" }] };
