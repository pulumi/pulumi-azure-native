 ...
 *
 * @deprecated azure-native:servicebus/v20210601preview:QueueAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20220101preview:QueueAuthorizationRule to guarantee forwards compatibility.
 */
export class QueueAuthorizationRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): QueueAuthorizationRule {
        pulumi.log.warn("QueueAuthorizationRule is deprecated: azure-native:servicebus/v20210601preview:QueueAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20220101preview:QueueAuthorizationRule to guarantee forwards compatibility.")
