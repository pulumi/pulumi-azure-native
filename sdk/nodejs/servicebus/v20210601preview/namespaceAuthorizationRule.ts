...
export class NamespaceAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicebus/v20210601preview:NamespaceAuthorizationRule';
