...
export function getSubscription(args: GetSubscriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetSubscriptionResult> {
    pulumi.log.warn("getSubscription is deprecated: azure-native:servicebus/v20210601preview:Subscription is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:Subscription to guarantee forwards compatibility.")
