...
export class MigrationConfig extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MigrationConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicebus/v20220101preview:MigrationConfig" }, { type: "azure-native:servicebus/v20221001preview:MigrationConfig" }, { type: "azure-native:servicebus/v20230101preview:MigrationConfig" }, { type: "azure-native:servicebus/v20240101:MigrationConfig" }, { type: "azure-native_servicebus_v20170401:servicebus:MigrationConfig" }, { type: "azure-native_servicebus_v20180101preview:servicebus:MigrationConfig" }, { type: "azure-native_servicebus_v20210101preview:servicebus:MigrationConfig" }, { type: "azure-native_servicebus_v20210601preview:servicebus:MigrationConfig" }, { type: "azure-native_servicebus_v20211101:servicebus:MigrationConfig" }, { type: "azure-native_servicebus_v20220101preview:servicebus:MigrationConfig" }, { type: "azure-native_servicebus_v20221001preview:servicebus:MigrationConfig" }, { type: "azure-native_servicebus_v20230101preview:servicebus:MigrationConfig" }, { type: "azure-native_servicebus_v20240101:servicebus:MigrationConfig" }] };
