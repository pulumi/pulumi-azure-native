...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicebus/v20180101preview:PrivateEndpointConnection" }, { type: "azure-nextgen:servicebus/v20180101preview:PrivateEndpointConnection" }] };
