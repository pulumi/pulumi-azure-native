...
export class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    declare public readonly privateEndpoint: pulumi.Output<outputs.servicebus.PrivateEndpointResponse | undefined>;
    /**
     * Details about the state of the connection.
     */
    declare public readonly privateLinkServiceConnectionState: pulumi.Output<outputs.servicebus.ConnectionStateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicebus/v20180101preview:PrivateEndpointConnection" }, { type: "azure-native:servicebus/v20210101preview:PrivateEndpointConnection" }, { type: "azure-native:servicebus/v20210601preview:PrivateEndpointConnection" }, { type: "azure-native:servicebus/v20211101:PrivateEndpointConnection" }, { type: "azure-native:servicebus/v20220101preview:PrivateEndpointConnection" }, { type: "azure-native:servicebus/v20221001preview:PrivateEndpointConnection" }, { type: "azure-native:servicebus/v20230101preview:PrivateEndpointConnection" }, { type: "azure-native:servicebus/v20240101:PrivateEndpointConnection" }, { type: "azure-native:servicebus/v20250501preview:PrivateEndpointConnection" }, { type: "azure-native:servicebus/v20260101:PrivateEndpointConnection" }, { type: "azure-native:servicebus/v20260701preview:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * The Private Endpoint resource for this Connection.
     */
    privateEndpoint?: pulumi.Input<inputs.servicebus.PrivateEndpointArgs | undefined>;
    /**
     ...
     * Details about the state of the connection.
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.servicebus.ConnectionStateArgs | undefined>;
    /**
     * Provisioning state of the Private Endpoint Connection.
     */
    provisioningState?: pulumi.Input<string | enums.servicebus.EndPointProvisioningState | undefined>;
    /**
