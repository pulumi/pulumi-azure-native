...
export class NamespaceVirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:servicebus:NamespaceVirtualNetworkRule';
    ...
    constructor(name: string, args: NamespaceVirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicebus/v20180101preview:NamespaceVirtualNetworkRule" }] };
