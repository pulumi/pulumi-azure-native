 ...
 *
 * @deprecated azure-native:servicebus/v20211101:QueueAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20220101preview:QueueAuthorizationRule to guarantee forwards compatibility.
 */
export class QueueAuthorizationRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): QueueAuthorizationRule {
        pulumi.log.warn("QueueAuthorizationRule is deprecated: azure-native:servicebus/v20211101:QueueAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20220101preview:QueueAuthorizationRule to guarantee forwards compatibility.")
        return new QueueAuthorizationRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicebus/v20211101:QueueAuthorizationRule';
