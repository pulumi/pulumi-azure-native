...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:servicebus/v20211101:DisasterRecoveryConfig":
                return new DisasterRecoveryConfig(name, <any>undefined, { urn })
            case "azure-native:servicebus/v20211101:MigrationConfig":
                return new MigrationConfig(name, <any>undefined, { urn })
            case "azure-native:servicebus/v20211101:Namespace":
                return new Namespace(name, <any>undefined, { urn })
            case "azure-native:servicebus/v20211101:NamespaceAuthorizationRule":
                return new NamespaceAuthorizationRule(name, <any>undefined, { urn })
            case "azure-native:servicebus/v20211101:NamespaceNetworkRuleSet":
                return new NamespaceNetworkRuleSet(name, <any>undefined, { urn })
            case "azure-native:servicebus/v20211101:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:servicebus/v20211101:Queue":
                return new Queue(name, <any>undefined, { urn })
            case "azure-native:servicebus/v20211101:QueueAuthorizationRule":
                return new QueueAuthorizationRule(name, <any>undefined, { urn })
            case "azure-native:servicebus/v20211101:Rule":
                return new Rule(name, <any>undefined, { urn })
            case "azure-native:servicebus/v20211101:Subscription":
                return new Subscription(name, <any>undefined, { urn })
            case "azure-native:servicebus/v20211101:Topic":
                return new Topic(name, <any>undefined, { urn })
            case "azure-native:servicebus/v20211101:TopicAuthorizationRule":
