...
export class Rule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicebus/latest:Rule';
    ...
    constructor(name: string, argsOrState?: RuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicebus/preview:Rule" }, { type: "azurerm:servicebus/v20170401:Rule" }] };
