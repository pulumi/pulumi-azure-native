...
export class NamespaceNetworkRuleSet extends pulumi.CustomResource {
     ...
     * List of IpRules
     */
    public readonly ipRules!: pulumi.Output<outputs.servicebus.latest.NWRuleSetIpRulesResponse[] | undefined>;
    /**
     * Resource name
     */
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<outputs.servicebus.latest.NWRuleSetVirtualNetworkRulesResponse[] | undefined>;
    ...
    constructor(name: string, args: NamespaceNetworkRuleSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicebus/latest:NamespaceNetworkRuleSet" }, { type: "azure-native:servicebus:NamespaceNetworkRuleSet" }, { type: "azure-nextgen:servicebus:NamespaceNetworkRuleSet" }, { type: "azure-native:servicebus/v20170401:NamespaceNetworkRuleSet" }, { type: "azure-nextgen:servicebus/v20170401:NamespaceNetworkRuleSet" }, { type: "azure-native:servicebus/v20180101preview:NamespaceNetworkRuleSet" }, { type: "azure-nextgen:servicebus/v20180101preview:NamespaceNetworkRuleSet" }, { type: "azure-native:servicebus/v20210101preview:NamespaceNetworkRuleSet" }, { type: "azure-nextgen:servicebus/v20210101preview:NamespaceNetworkRuleSet" }] };
...
export interface NamespaceNetworkRuleSetArgs {
     ...
     * Default Action for Network Rule Set
     */
    readonly defaultAction?: pulumi.Input<string | enums.servicebus.latest.DefaultAction>;
    /**
     * List of IpRules
     */
    readonly ipRules?: pulumi.Input<pulumi.Input<inputs.servicebus.latest.NWRuleSetIpRules>[]>;
    /**
     * The namespace name
     */
     ...
     * List VirtualNetwork Rules
     */
    readonly virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.servicebus.latest.NWRuleSetVirtualNetworkRules>[]>;
}
