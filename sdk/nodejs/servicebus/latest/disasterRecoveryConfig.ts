...
export class DisasterRecoveryConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicebus/latest:DisasterRecoveryConfig';
    ...
    constructor(name: string, argsOrState?: DisasterRecoveryConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicebus/preview:DisasterRecoveryConfig" }, { type: "azurerm:servicebus/v20170401:DisasterRecoveryConfig" }] };
