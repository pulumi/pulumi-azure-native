...
export class MigrationConfig extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MigrationConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicebus/latest:MigrationConfig" }, { type: "azure-native:servicebus:MigrationConfig" }, { type: "azure-nextgen:servicebus:MigrationConfig" }, { type: "azure-native:servicebus/v20170401:MigrationConfig" }, { type: "azure-nextgen:servicebus/v20170401:MigrationConfig" }, { type: "azure-native:servicebus/v20180101preview:MigrationConfig" }, { type: "azure-nextgen:servicebus/v20180101preview:MigrationConfig" }] };
