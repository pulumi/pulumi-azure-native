...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:servicebus/v20150801:Namespace":
                return new Namespace(name, <any>undefined, { urn })
            case "azure-nextgen:servicebus/v20150801:NamespaceAuthorizationRule":
                return new NamespaceAuthorizationRule(name, <any>undefined, { urn })
            case "azure-nextgen:servicebus/v20150801:Queue":
                return new Queue(name, <any>undefined, { urn })
            case "azure-nextgen:servicebus/v20150801:QueueAuthorizationRule":
                return new QueueAuthorizationRule(name, <any>undefined, { urn })
            case "azure-nextgen:servicebus/v20150801:Subscription":
                return new Subscription(name, <any>undefined, { urn })
            case "azure-nextgen:servicebus/v20150801:Topic":
                return new Topic(name, <any>undefined, { urn })
            case "azure-nextgen:servicebus/v20150801:TopicAuthorizationRule":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "servicebus/v20150801", _module)
