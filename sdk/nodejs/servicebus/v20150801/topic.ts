...
export class Topic extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TopicArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicebus/latest:Topic" }, { type: "azurerm:servicebus/preview:Topic" }, { type: "azurerm:servicebus/v20140901:Topic" }, { type: "azurerm:servicebus/v20170401:Topic" }] };
