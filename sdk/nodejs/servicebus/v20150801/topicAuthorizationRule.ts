 ...
 *
 * const topicAuthorizationRule = new azure_native.servicebus.v20150801.TopicAuthorizationRule("topicAuthorizationRule", {
...
export class TopicAuthorizationRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TopicAuthorizationRule {
        pulumi.log.warn("TopicAuthorizationRule is deprecated: Version 2015-08-01 will be removed in v2 of the provider.")
