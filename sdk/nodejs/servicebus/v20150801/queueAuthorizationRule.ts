...
export class QueueAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:servicebus/v20150801:QueueAuthorizationRule';
    ...
    constructor(name: string, args: QueueAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicebus/latest:QueueAuthorizationRule" }, { type: "azure-nextgen:servicebus/v20140901:QueueAuthorizationRule" }, { type: "azure-nextgen:servicebus/v20170401:QueueAuthorizationRule" }, { type: "azure-nextgen:servicebus/v20180101preview:QueueAuthorizationRule" }] };
