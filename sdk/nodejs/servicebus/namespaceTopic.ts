...
export class NamespaceTopic extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NamespaceTopic {
        return new NamespaceTopic(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicebus:NamespaceTopic';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.servicebus.SBTopicPropertiesResponse>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, argsOrState?: NamespaceTopicArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NamespaceTopic.__pulumiType, name, inputs, opts);
    }
}
...
export interface NamespaceTopicArgs {
     ...
     * Properties of topic resource.
     */
    readonly properties?: pulumi.Input<inputs.servicebus.SBTopicProperties>;
    /**
