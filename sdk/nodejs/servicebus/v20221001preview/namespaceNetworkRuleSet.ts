 ...
 *
 * const namespaceNetworkRuleSet = new azure_native.servicebus.v20221001preview.NamespaceNetworkRuleSet("namespaceNetworkRuleSet", {
 *     defaultAction: "Deny",
 *     ipRules: [
 *         {
 *             action: "Allow",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:servicebus/v20221001preview:NamespaceNetworkRuleSet default /subscriptions/854d368f-1828-428f-8f3c-f2affa9b2f7d/resourceGroups/Default-ServiceBus-AustraliaEast/providers/Microsoft.ServiceBus/namespaces/sdk-Namespace-9659/networkruleset/default 
 * ```
 */
export class NamespaceNetworkRuleSet extends pulumi.CustomResource {
     ...
     * List of IpRules
     */
    public readonly ipRules!: pulumi.Output<outputs.servicebus.v20221001preview.NWRuleSetIpRulesResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<outputs.servicebus.v20221001preview.NWRuleSetVirtualNetworkRulesResponse[] | undefined>;
...
export interface NamespaceNetworkRuleSetArgs {
     ...
     * Default Action for Network Rule Set
     */
    defaultAction?: pulumi.Input<string | enums.servicebus.v20221001preview.DefaultAction>;
    /**
     * List of IpRules
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.servicebus.v20221001preview.NWRuleSetIpRulesArgs>[]>;
    /**
     * The namespace name
     */
     ...
     * This determines if traffic is allowed over public network. By default it is enabled.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.servicebus.v20221001preview.PublicNetworkAccessFlag>;
    /**
     ...
     * List VirtualNetwork Rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.servicebus.v20221001preview.NWRuleSetVirtualNetworkRulesArgs>[]>;
}
