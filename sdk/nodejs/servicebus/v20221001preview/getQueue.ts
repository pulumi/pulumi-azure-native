...
export interface GetQueueResult {
     ...
     */
    readonly countDetails: outputs.servicebus.v20221001preview.MessageCountDetailsResponse;
    /**
...
export function getQueueOutput(args: GetQueueOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetQueueResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:servicebus/v20221001preview:getQueue", {
        "namespaceName": args.namespaceName,
        "queueName": args.queueName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
