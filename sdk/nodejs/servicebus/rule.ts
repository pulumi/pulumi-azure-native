...
export class Rule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicebus:Rule" }, { type: "azure-native:servicebus/latest:Rule" }, { type: "azure-nextgen:servicebus/latest:Rule" }, { type: "azure-native:servicebus/v20170401:Rule" }, { type: "azure-nextgen:servicebus/v20170401:Rule" }, { type: "azure-native:servicebus/v20180101preview:Rule" }, { type: "azure-nextgen:servicebus/v20180101preview:Rule" }, { type: "azure-native:servicebus/v20210101preview:Rule" }, { type: "azure-nextgen:servicebus/v20210101preview:Rule" }] };
...
export interface RuleArgs {
     ...
     * Represents the filter actions which are allowed for the transformation of a message that have been matched by a filter expression.
     */
    readonly action?: pulumi.Input<inputs.servicebus.Action>;
    /**
     * Properties of correlationFilter
     */
    readonly correlationFilter?: pulumi.Input<inputs.servicebus.CorrelationFilter>;
    /**
     * Filter type that is evaluated against a BrokeredMessage.
     */
     ...
     * Properties of sqlFilter
     */
    readonly sqlFilter?: pulumi.Input<inputs.servicebus.SqlFilter>;
    /**
