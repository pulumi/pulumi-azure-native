...
export class NamespaceDisasterRecoveryConfig extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NamespaceDisasterRecoveryConfig {
        return new NamespaceDisasterRecoveryConfig(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicebus:NamespaceDisasterRecoveryConfig';
    ...
    constructor(name: string, argsOrState?: NamespaceDisasterRecoveryConfigArgs, opts?: pulumi.CustomResourceOptions) {
