 ...
 * A budget resource.
 *
 * @deprecated azure-native:consumption/v20211001:Budget is being removed in the next major version of this provider. Please upgrade to azure-native:consumption/v20220901:Budget to guarantee forwards compatibility.
 */
export class Budget extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Budget {
        pulumi.log.warn("Budget is deprecated: azure-native:consumption/v20211001:Budget is being removed in the next major version of this provider. Please upgrade to azure-native:consumption/v20220901:Budget to guarantee forwards compatibility.")
        return new Budget(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:consumption/v20211001:Budget';
     ...
     */
    public /*out*/ readonly currentSpend!: pulumi.Output<outputs.consumption.v20211001.CurrentSpendResponse>;
    /**
     ...
     */
    public readonly filter!: pulumi.Output<outputs.consumption.v20211001.BudgetFilterResponse | undefined>;
    /**
     * The forecasted cost which is being tracked for a budget.
     */
    public /*out*/ readonly forecastSpend!: pulumi.Output<outputs.consumption.v20211001.ForecastSpendResponse>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly notifications!: pulumi.Output<{[key: string]: outputs.consumption.v20211001.NotificationResponse} | undefined>;
    /**
     ...
     */
    public readonly timePeriod!: pulumi.Output<outputs.consumption.v20211001.BudgetTimePeriodResponse>;
    /**
     * Resource type.
     */
...
export interface BudgetArgs {
     ...
     * Dictionary of notifications associated with the budget. Budget can have up to five notifications.
     */
    notifications?: pulumi.Input<{[key: string]: pulumi.Input<inputs.consumption.v20211001.NotificationArgs>}>;
    /**
