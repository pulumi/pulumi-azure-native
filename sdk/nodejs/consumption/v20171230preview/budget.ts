 ...
 *
 * const budget = new azurerm.consumption.v20171230preview.Budget("budget", {
 *     amount: 100.65,
 *     category: "Cost",
...
export class Budget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:consumption/v20171230preview:Budget';
     ...
     */
    public /*out*/ readonly currentSpend!: pulumi.Output<outputs.consumption.v20171230preview.CurrentSpendResponse>;
    /**
     ...
     */
    public readonly notifications!: pulumi.Output<{[key: string]: outputs.consumption.v20171230preview.NotificationResponse} | undefined>;
    /**
     ...
     */
    public readonly timePeriod!: pulumi.Output<outputs.consumption.v20171230preview.BudgetTimePeriodResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:consumption/v20180131:Budget" }, { type: "azurerm:consumption/v20180331:Budget" }, { type: "azurerm:consumption/v20180630:Budget" }, { type: "azurerm:consumption/v20180831:Budget" }, { type: "azurerm:consumption/v20181001:Budget" }] };
...
export interface BudgetArgs {
     ...
     * Dictionary of notifications associated with the budget. Budget can have up to five notifications.
     */
    readonly notifications?: pulumi.Input<{[key: string]: pulumi.Input<inputs.consumption.v20171230preview.Notification>}>;
    /**
     * The time covered by a budget. Tracking of the amount will be reset based on the time grain.
     */
     ...
     * Has start and end date of the budget. The start date must be first of the month and should be less than the end date. Budget start date must be on or after June 1, 2017. Future start date should not be more than three months. Past start date should  be selected within the timegrain period. There are no restrictions on the end date.
     */
    readonly timePeriod: pulumi.Input<inputs.consumption.v20171230preview.BudgetTimePeriod>;
}
