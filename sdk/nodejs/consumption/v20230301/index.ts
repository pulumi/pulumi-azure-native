...
// Export enums:
export * from "../../types/enums/consumption/v20230301";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:consumption/v20230301:Budget":
...
pulumi.runtime.registerResourceModule("azure-native", "consumption/v20230301", _module)
