...
// Export enums:
export * from "../../types/enums/consumption/v20220901";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:consumption/v20220901:Budget":
...
pulumi.runtime.registerResourceModule("azure-native", "consumption/v20220901", _module)
