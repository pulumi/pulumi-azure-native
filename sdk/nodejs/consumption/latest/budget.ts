...
export class Budget extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:consumption/preview:Budget" }, { type: "azurerm:consumption/v20190101:Budget" }, { type: "azurerm:consumption/v20190401preview:Budget" }, { type: "azurerm:consumption/v20190501:Budget" }, { type: "azurerm:consumption/v20190501preview:Budget" }, { type: "azurerm:consumption/v20190601:Budget" }, { type: "azurerm:consumption/v20191001:Budget" }] };
