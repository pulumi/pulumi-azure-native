...
export function getBudgetByResourceGroupName(args: GetBudgetByResourceGroupNameArgs, opts?: pulumi.InvokeOptions): Promise<GetBudgetByResourceGroupNameResult> {
    pulumi.log.warn("getBudgetByResourceGroupName is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:consumption:getBudgetByResourceGroupName'.")
    if (!opts) {
        opts = {}
    }
