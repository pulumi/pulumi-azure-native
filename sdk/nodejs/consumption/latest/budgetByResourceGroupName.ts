...
export class BudgetByResourceGroupName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:consumption/latest:BudgetByResourceGroupName';
