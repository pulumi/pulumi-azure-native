...
export class BudgetByResourceGroupName extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BudgetByResourceGroupName {
        pulumi.log.warn("BudgetByResourceGroupName is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:consumption:BudgetByResourceGroupName'.")
        return new BudgetByResourceGroupName(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:consumption/latest:BudgetByResourceGroupName';
