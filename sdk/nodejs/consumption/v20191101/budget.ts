...
export class Budget extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Budget {
        pulumi.log.warn("Budget is deprecated: azure-native:consumption/v20191101:Budget is being removed in the next major version of this provider. Please upgrade to azure-native:consumption/v20220901:Budget to guarantee forwards compatibility.")
