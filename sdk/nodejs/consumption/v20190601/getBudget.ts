...
export function getBudget(args: GetBudgetArgs, opts?: pulumi.InvokeOptions): Promise<GetBudgetResult> {
    pulumi.log.warn("getBudget is deprecated: Version 2019-06-01 will be removed in v2 of the provider.")
...
export interface GetBudgetResult {
     ...
     */
    readonly notifications?: {[key: string]: outputs.consumption.v20190601.NotificationResponse};
    /**
