...
export class Budget extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly currentSpend!: pulumi.Output<outputs.consumption.v20190601.CurrentSpendResponse>;
    /**
     ...
     */
    public readonly filters!: pulumi.Output<outputs.consumption.v20190601.FiltersResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly notifications!: pulumi.Output<{[key: string]: outputs.consumption.v20190601.NotificationResponse} | undefined>;
    /**
     ...
     */
    public readonly timePeriod!: pulumi.Output<outputs.consumption.v20190601.BudgetTimePeriodResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:consumption:Budget" }, { type: "azure-nextgen:consumption/latest:Budget" }, { type: "azure-nextgen:consumption/v20190101:Budget" }, { type: "azure-nextgen:consumption/v20190401preview:Budget" }, { type: "azure-nextgen:consumption/v20190501:Budget" }, { type: "azure-nextgen:consumption/v20190501preview:Budget" }, { type: "azure-nextgen:consumption/v20191001:Budget" }] };
...
export interface BudgetArgs {
     ...
     * The category of the budget, whether the budget tracks cost or usage.
     */
    readonly category: pulumi.Input<string | enums.consumption.v20190601.CategoryType>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * The time covered by a budget. Tracking of the amount will be reset based on the time grain.
     */
    readonly timeGrain: pulumi.Input<string | enums.consumption.v20190601.TimeGrainType>;
    /**
     * Has start and end date of the budget. The start date must be first of the month and should be less than the end date. Budget start date must be on or after June 1, 2017. Future start date should not be more than three months. Past start date should  be selected within the timegrain period. There are no restrictions on the end date.
     */
