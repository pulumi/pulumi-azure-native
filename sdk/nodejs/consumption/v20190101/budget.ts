...
export class Budget extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:consumption/latest:Budget" }, { type: "azurerm:consumption/v20190501:Budget" }, { type: "azurerm:consumption/v20190601:Budget" }, { type: "azurerm:consumption/v20191001:Budget" }] };
