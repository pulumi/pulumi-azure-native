...
export class Budget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:consumption/preview:Budget';
     ...
     */
    public readonly filter!: pulumi.Output<outputs.consumption.preview.BudgetFilterResponse | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:consumption/latest:Budget" }, { type: "azurerm:consumption/v20190101:Budget" }, { type: "azurerm:consumption/v20190401preview:Budget" }, { type: "azurerm:consumption/v20190501:Budget" }, { type: "azurerm:consumption/v20190501preview:Budget" }, { type: "azurerm:consumption/v20190601:Budget" }, { type: "azurerm:consumption/v20191001:Budget" }] };
...
export interface BudgetArgs {
     ...
     * May be used to filter budgets by resource group, resource, or meter.
     */
    readonly filter?: pulumi.Input<inputs.consumption.preview.BudgetFilter>;
    /**
     * Dictionary of notifications associated with the budget. Budget can have up to five notifications.
     */
