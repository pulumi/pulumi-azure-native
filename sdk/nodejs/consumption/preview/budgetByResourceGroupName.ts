...
export class BudgetByResourceGroupName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:consumption/preview:BudgetByResourceGroupName';
     ...
     */
    public /*out*/ readonly currentSpend!: pulumi.Output<outputs.consumption.preview.CurrentSpendResponse>;
    /**
     ...
     */
    public readonly filters!: pulumi.Output<outputs.consumption.preview.FiltersResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly notifications!: pulumi.Output<{[key: string]: outputs.consumption.preview.NotificationResponse} | undefined>;
    /**
     ...
     */
    public readonly timePeriod!: pulumi.Output<outputs.consumption.preview.BudgetTimePeriodResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, argsOrState?: BudgetByResourceGroupNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:consumption/latest:BudgetByResourceGroupName" }, { type: "azurerm:consumption/v20180131:BudgetByResourceGroupName" }, { type: "azurerm:consumption/v20180331:BudgetByResourceGroupName" }, { type: "azurerm:consumption/v20180630:BudgetByResourceGroupName" }, { type: "azurerm:consumption/v20180831:BudgetByResourceGroupName" }, { type: "azurerm:consumption/v20181001:BudgetByResourceGroupName" }] };
...
export interface BudgetByResourceGroupNameArgs {
     ...
     * May be used to filter budgets by resource group, resource, or meter.
     */
    readonly filters?: pulumi.Input<inputs.consumption.preview.Filters>;
    /**
     * Dictionary of notifications associated with the budget. Budget can have up to five notifications.
     */
    readonly notifications?: pulumi.Input<{[key: string]: pulumi.Input<inputs.consumption.preview.Notification>}>;
    /**
     ...
     * Has start and end date of the budget. The start date must be first of the month and should be less than the end date. Budget start date must be on or after June 1, 2017. Future start date should not be more than three months. Past start date should  be selected within the timegrain period. There are no restrictions on the end date.
     */
    readonly timePeriod: pulumi.Input<inputs.consumption.preview.BudgetTimePeriod>;
}
