 ...
 *
 * const budget = new azurerm.consumption.v20190401preview.Budget("budget", {
 *     amount: 100.65,
...
export class Budget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:consumption/v20190401preview:Budget';
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:consumption/latest:Budget" }, { type: "azurerm:consumption/v20190101:Budget" }, { type: "azurerm:consumption/v20190501:Budget" }, { type: "azurerm:consumption/v20190501preview:Budget" }, { type: "azurerm:consumption/v20190601:Budget" }, { type: "azurerm:consumption/v20191001:Budget" }] };
