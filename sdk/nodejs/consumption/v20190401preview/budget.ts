...
export class Budget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:consumption/v20190401preview:Budget';
     ...
     */
    public /*out*/ readonly currentSpend!: pulumi.Output<outputs.consumption.v20190401preview.CurrentSpendResponse>;
    /**
     ...
     */
    public readonly filters!: pulumi.Output<outputs.consumption.v20190401preview.FiltersResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly notifications!: pulumi.Output<{[key: string]: outputs.consumption.v20190401preview.NotificationResponse} | undefined>;
    /**
     ...
     */
    public readonly timePeriod!: pulumi.Output<outputs.consumption.v20190401preview.BudgetTimePeriodResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:consumption:Budget" }, { type: "azure-nextgen:consumption/latest:Budget" }, { type: "azure-nextgen:consumption/v20190101:Budget" }, { type: "azure-nextgen:consumption/v20190501:Budget" }, { type: "azure-nextgen:consumption/v20190501preview:Budget" }, { type: "azure-nextgen:consumption/v20190601:Budget" }, { type: "azure-nextgen:consumption/v20191001:Budget" }] };
...
export interface BudgetArgs {
     ...
     * The category of the budget, whether the budget tracks cost or usage.
     */
    readonly category: pulumi.Input<string | enums.consumption.v20190401preview.CategoryType>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * May be used to filter budgets by resource group, resource, or meter.
     */
    readonly filters?: pulumi.Input<inputs.consumption.v20190401preview.Filters>;
    /**
     * Dictionary of notifications associated with the budget. Budget can have up to five notifications.
     */
    readonly notifications?: pulumi.Input<{[key: string]: pulumi.Input<inputs.consumption.v20190401preview.Notification>}>;
    /**
     ...
     * The time covered by a budget. Tracking of the amount will be reset based on the time grain.
     */
    readonly timeGrain: pulumi.Input<string | enums.consumption.v20190401preview.TimeGrainType>;
    /**
     * Has start and end date of the budget. The start date must be first of the month and should be less than the end date. Budget start date must be on or after June 1, 2017. Future start date should not be more than three months. Past start date should  be selected within the timegrain period. There are no restrictions on the end date.
     */
    readonly timePeriod: pulumi.Input<inputs.consumption.v20190401preview.BudgetTimePeriod>;
}
