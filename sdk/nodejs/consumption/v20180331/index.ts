...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:consumption/v20180331:Budget":
                return new Budget(name, <any>undefined, { urn })
            case "azure-nextgen:consumption/v20180331:BudgetByResourceGroupName":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "consumption/v20180331", _module)
