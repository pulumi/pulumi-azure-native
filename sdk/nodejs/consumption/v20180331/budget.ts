...
export class Budget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:consumption/v20180331:Budget';
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:consumption/v20171230preview:Budget" }, { type: "azure-nextgen:consumption/v20180131:Budget" }, { type: "azure-nextgen:consumption/v20180630:Budget" }, { type: "azure-nextgen:consumption/v20180831:Budget" }, { type: "azure-nextgen:consumption/v20181001:Budget" }] };
...
export interface BudgetArgs {
     ...
     * Dictionary of notifications associated with the budget. Budget can have up to five notifications.
     */
    readonly notifications?: pulumi.Input<{[key: string]: pulumi.Input<inputs.consumption.v20180331.Notification>}>;
    /**
     * The time covered by a budget. Tracking of the amount will be reset based on the time grain.
     */
