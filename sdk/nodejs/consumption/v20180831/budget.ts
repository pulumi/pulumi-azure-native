...
export class Budget extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Budget {
        pulumi.log.warn("Budget is deprecated: Version v20180831 will be removed in the next major version of the provider. Upgrade to version v20191001 or later.")
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:consumption/v20171230preview:Budget" }, { type: "azure-native:consumption/v20180131:Budget" }, { type: "azure-native:consumption/v20180331:Budget" }, { type: "azure-native:consumption/v20180630:Budget" }, { type: "azure-native:consumption/v20181001:Budget" }] };
