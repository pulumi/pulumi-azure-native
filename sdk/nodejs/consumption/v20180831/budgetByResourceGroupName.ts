 ...
 *
 * const budgetByResourceGroupName = new azurerm.consumption.v20180831.BudgetByResourceGroupName("budgetByResourceGroupName", {
 *     amount: 100.65,
...
export class BudgetByResourceGroupName extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly currentSpend!: pulumi.Output<outputs.consumption.v20180831.CurrentSpendResponse>;
    /**
     ...
     */
    public readonly filters!: pulumi.Output<outputs.consumption.v20180831.FiltersResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly notifications!: pulumi.Output<{[key: string]: outputs.consumption.v20180831.NotificationResponse} | undefined>;
    /**
     ...
     */
    public readonly timePeriod!: pulumi.Output<outputs.consumption.v20180831.BudgetTimePeriodResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: BudgetByResourceGroupNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:consumption/latest:BudgetByResourceGroupName" }, { type: "azurerm:consumption/v20180131:BudgetByResourceGroupName" }, { type: "azurerm:consumption/v20180331:BudgetByResourceGroupName" }, { type: "azurerm:consumption/v20180630:BudgetByResourceGroupName" }, { type: "azurerm:consumption/v20181001:BudgetByResourceGroupName" }] };
...
export interface BudgetByResourceGroupNameArgs {
     ...
     * May be used to filter budgets by resource group, resource, or meter.
     */
    readonly filters?: pulumi.Input<inputs.consumption.v20180831.Filters>;
    /**
     * Dictionary of notifications associated with the budget. Budget can have up to five notifications.
     */
    readonly notifications?: pulumi.Input<{[key: string]: pulumi.Input<inputs.consumption.v20180831.Notification>}>;
    /**
     ...
     * Has start and end date of the budget. The start date must be first of the month and should be less than the end date. Budget start date must be on or after June 1, 2017. Future start date should not be more than three months. Past start date should  be selected within the timegrain period. There are no restrictions on the end date.
     */
    readonly timePeriod: pulumi.Input<inputs.consumption.v20180831.BudgetTimePeriod>;
}
