...
export function getBudgetByResourceGroupName(args: GetBudgetByResourceGroupNameArgs, opts?: pulumi.InvokeOptions): Promise<GetBudgetByResourceGroupNameResult> {
    pulumi.log.warn("getBudgetByResourceGroupName is deprecated: Version v20180831 will be removed in the next major version of the provider. Upgrade to version v20191001 or later.")
    if (!opts) {
        opts = {}
    }
