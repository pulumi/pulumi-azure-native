...
export class BudgetByResourceGroupName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:consumption/v20180131:BudgetByResourceGroupName';
     ...
     */
    public /*out*/ readonly currentSpend!: pulumi.Output<outputs.consumption.v20180131.CurrentSpendResponse>;
    /**
     ...
     */
    public readonly filters!: pulumi.Output<outputs.consumption.v20180131.FiltersResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly notifications!: pulumi.Output<{[key: string]: outputs.consumption.v20180131.NotificationResponse} | undefined>;
    /**
     ...
     */
    public readonly timePeriod!: pulumi.Output<outputs.consumption.v20180131.BudgetTimePeriodResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: BudgetByResourceGroupNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:consumption/latest:BudgetByResourceGroupName" }, { type: "azure-nextgen:consumption/v20180331:BudgetByResourceGroupName" }, { type: "azure-nextgen:consumption/v20180630:BudgetByResourceGroupName" }, { type: "azure-nextgen:consumption/v20180831:BudgetByResourceGroupName" }, { type: "azure-nextgen:consumption/v20181001:BudgetByResourceGroupName" }] };
...
export interface BudgetByResourceGroupNameArgs {
     ...
     * The category of the budget, whether the budget tracks cost or usage.
     */
    readonly category: pulumi.Input<string | enums.consumption.v20180131.CategoryType>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * The time covered by a budget. Tracking of the amount will be reset based on the time grain.
     */
    readonly timeGrain: pulumi.Input<string | enums.consumption.v20180131.TimeGrainType>;
    /**
     * Has start and end date of the budget. The start date must be first of the month and should be less than the end date. Budget start date must be on or after June 1, 2017. Future start date should not be more than three months. Past start date should  be selected within the timegrain period. There are no restrictions on the end date.
     */
