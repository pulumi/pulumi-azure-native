...
export class BudgetByResourceGroupName extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BudgetByResourceGroupName {
        pulumi.log.warn("BudgetByResourceGroupName is deprecated: Version 2018-01-31 will be removed in v2 of the provider.\nazure-native:consumption/v20180131:BudgetByResourceGroupName is being removed in the next major version of this provider. Please upgrade to azure-native:consumption/v20181001:BudgetByResourceGroupName to guarantee forwards compatibility.")
        return new BudgetByResourceGroupName(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:consumption/v20180131:BudgetByResourceGroupName';
...
export interface BudgetByResourceGroupNameArgs {
     ...
     * Dictionary of notifications associated with the budget. Budget can have up to five notifications.
     */
    notifications?: pulumi.Input<{[key: string]: pulumi.Input<inputs.consumption.v20180131.NotificationArgs>}>;
    /**
