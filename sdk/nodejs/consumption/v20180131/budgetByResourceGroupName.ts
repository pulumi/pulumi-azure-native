...
export class BudgetByResourceGroupName extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.consumption.v20180131.BudgetPropertiesResponse>;
    /**
     * Resource type.
     */
...
export interface BudgetByResourceGroupNameArgs {
     ...
     * The properties of the budget.
     */
    readonly properties?: pulumi.Input<inputs.consumption.v20180131.BudgetProperties>;
    /**
