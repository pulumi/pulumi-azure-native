...
export class SapLandscapeMonitor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:workloads/v20231201preview:SapLandscapeMonitor';
     ...
     */
    public readonly grouping!: pulumi.Output<outputs.workloads.v20231201preview.SapLandscapeMonitorPropertiesGroupingResponse | undefined>;
    /**
     ...
     */
    public readonly topMetricsThresholds!: pulumi.Output<outputs.workloads.v20231201preview.SapLandscapeMonitorMetricThresholdsResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: SapLandscapeMonitorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:workloads:SapLandscapeMonitor" }, { type: "azure-native:workloads/v20221101preview:SapLandscapeMonitor" }, { type: "azure-native:workloads/v20230401:SapLandscapeMonitor" }, { type: "azure-native:workloads/v20231001preview:SapLandscapeMonitor" }] };
...
export interface SapLandscapeMonitorArgs {
     ...
     * Gets or sets the SID groupings by landscape and Environment.
     */
    grouping?: pulumi.Input<inputs.workloads.v20231201preview.SapLandscapeMonitorPropertiesGroupingArgs>;
    /**
     ...
     * Gets or sets the list Top Metric Thresholds for SAP Landscape Monitor Dashboard
     */
    topMetricsThresholds?: pulumi.Input<pulumi.Input<inputs.workloads.v20231201preview.SapLandscapeMonitorMetricThresholdsArgs>[]>;
}
