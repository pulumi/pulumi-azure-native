...
export function getSapLandscapeMonitor(args: GetSapLandscapeMonitorArgs, opts?: pulumi.InvokeOptions): Promise<GetSapLandscapeMonitorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:workloads/v20231201preview:getSapLandscapeMonitor", {
...
export interface GetSapLandscapeMonitorResult {
     ...
     */
    readonly grouping?: outputs.workloads.v20231201preview.SapLandscapeMonitorPropertiesGroupingResponse;
    /**
     ...
     */
    readonly topMetricsThresholds?: outputs.workloads.v20231201preview.SapLandscapeMonitorMetricThresholdsResponse[];
    /**
...
export function getSapLandscapeMonitorOutput(args: GetSapLandscapeMonitorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSapLandscapeMonitorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:workloads/v20231201preview:getSapLandscapeMonitor", {
        "monitorName": args.monitorName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
