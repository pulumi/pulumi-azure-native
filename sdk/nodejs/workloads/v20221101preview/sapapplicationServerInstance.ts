 ...
 *
 * @deprecated azure-native:workloads/v20221101preview:SAPApplicationServerInstance is being removed in the next major version of this provider. Please upgrade to azure-native:workloads/v20230401:SAPApplicationServerInstance to guarantee forwards compatibility.
 */
export class SAPApplicationServerInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:workloads/v20221101preview:SAPApplicationServerInstance';
     ...
     */
    public /*out*/ readonly vmDetails!: pulumi.Output<outputs.workloads.v20221101preview.ApplicationServerVmDetailsResponse[]>;
    ...
    constructor(name: string, args: SAPApplicationServerInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:workloads:SAPApplicationServerInstance" }, { type: "azure-native:workloads/v20211201preview:SAPApplicationServerInstance" }, { type: "azure-native:workloads/v20230401:SAPApplicationServerInstance" }] };
