...
export function getSAPDatabaseInstance(args: GetSAPDatabaseInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetSAPDatabaseInstanceResult> {
    pulumi.log.warn("getSAPDatabaseInstance is deprecated: azure-native:workloads/v20221101preview:SAPDatabaseInstance is being removed in the next major version of this provider. Please upgrade to azure-native:workloads/v20230401:SAPDatabaseInstance to guarantee forwards compatibility.")
