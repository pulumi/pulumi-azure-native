 ...
 *
 * @deprecated azure-native:workloads/v20221101preview:SAPDatabaseInstance is being removed in the next major version of this provider. Please upgrade to azure-native:workloads/v20230401:SAPDatabaseInstance to guarantee forwards compatibility.
 */
export class SAPDatabaseInstance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SAPDatabaseInstance {
        pulumi.log.warn("SAPDatabaseInstance is deprecated: azure-native:workloads/v20221101preview:SAPDatabaseInstance is being removed in the next major version of this provider. Please upgrade to azure-native:workloads/v20230401:SAPDatabaseInstance to guarantee forwards compatibility.")
        return new SAPDatabaseInstance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:workloads/v20221101preview:SAPDatabaseInstance';
     ...
     */
    public /*out*/ readonly loadBalancerDetails!: pulumi.Output<outputs.workloads.v20221101preview.LoadBalancerDetailsResponse>;
    /**
     ...
     */
    public /*out*/ readonly vmDetails!: pulumi.Output<outputs.workloads.v20221101preview.DatabaseVmDetailsResponse[]>;
    ...
    constructor(name: string, args: SAPDatabaseInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:workloads:SAPDatabaseInstance" }, { type: "azure-native:workloads/v20211201preview:SAPDatabaseInstance" }, { type: "azure-native:workloads/v20230401:SAPDatabaseInstance" }] };
