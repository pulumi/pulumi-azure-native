 ...
 *
 * @deprecated azure-native:workloads/v20221101preview:SAPCentralInstance is being removed in the next major version of this provider. Please upgrade to azure-native:workloads/v20230401:SAPCentralInstance to guarantee forwards compatibility.
 */
export class SAPCentralInstance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SAPCentralInstance {
        pulumi.log.warn("SAPCentralInstance is deprecated: azure-native:workloads/v20221101preview:SAPCentralInstance is being removed in the next major version of this provider. Please upgrade to azure-native:workloads/v20230401:SAPCentralInstance to guarantee forwards compatibility.")
        return new SAPCentralInstance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:workloads/v20221101preview:SAPCentralInstance';
     ...
     */
    public /*out*/ readonly enqueueReplicationServerProperties!: pulumi.Output<outputs.workloads.v20221101preview.EnqueueReplicationServerPropertiesResponse | undefined>;
    /**
     * Defines the SAP Enqueue Server properties.
     */
    public /*out*/ readonly enqueueServerProperties!: pulumi.Output<outputs.workloads.v20221101preview.EnqueueServerPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly gatewayServerProperties!: pulumi.Output<outputs.workloads.v20221101preview.GatewayServerPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly messageServerProperties!: pulumi.Output<outputs.workloads.v20221101preview.MessageServerPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly vmDetails!: pulumi.Output<outputs.workloads.v20221101preview.CentralServerVmDetailsResponse[]>;
    ...
    constructor(name: string, args: SAPCentralInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:workloads:SAPCentralInstance" }, { type: "azure-native:workloads/v20211201preview:SAPCentralInstance" }, { type: "azure-native:workloads/v20230401:SAPCentralInstance" }] };
