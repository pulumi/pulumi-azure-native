...
export class WordpressInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:workloads:WordpressInstance';
    ...
    constructor(name: string, args: WordpressInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:workloads/v20211201preview:WordpressInstance" }] };
...
export interface WordpressInstanceArgs {
     ...
     * Application version
     */
    version: pulumi.Input<string | enums.workloads.WordpressVersions>;
}
