 ...
 *
 * const sapVirtualInstance = new azure_native.workloads.v20230401.SAPVirtualInstance("sapVirtualInstance", {
 *     configuration: {
 *         appLocation: "eastus",
...
export class SAPVirtualInstance extends pulumi.CustomResource {
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.workloads.v20230401.DeploymentConfigurationResponse | outputs.workloads.v20230401.DeploymentWithOSConfigurationResponse | outputs.workloads.v20230401.DiscoveryConfigurationResponse>;
    /**
