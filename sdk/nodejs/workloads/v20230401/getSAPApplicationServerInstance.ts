...
export function getSAPApplicationServerInstance(args: GetSAPApplicationServerInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetSAPApplicationServerInstanceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:workloads/v20230401:getSAPApplicationServerInstance", {
...
export interface GetSAPApplicationServerInstanceResult {
     ...
     */
    readonly errors: outputs.workloads.v20230401.SAPVirtualInstanceErrorResponse;
    /**
     ...
     */
    readonly loadBalancerDetails: outputs.workloads.v20230401.LoadBalancerDetailsResponse;
    /**
     ...
     */
    readonly vmDetails: outputs.workloads.v20230401.ApplicationServerVmDetailsResponse[];
}
/**
 * Gets the SAP Application Server Instance corresponding to the Virtual Instance for SAP solutions resource.
 */
