 ...
 *
 * const sapApplicationServerInstance = new azure_native.workloads.v20230401.SAPApplicationServerInstance("sapApplicationServerInstance", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:workloads/v20230401:SAPApplicationServerInstance app01 /subscriptions/6d875e77-e412-4d7d-9af4-8895278b4443/resourceGroups/test-rg/providers/Microsoft.Workloads/sapVirtualInstances/X00/applicationInstances/app01 
 * ```
 */
export class SAPApplicationServerInstance extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly errors!: pulumi.Output<outputs.workloads.v20230401.SAPVirtualInstanceErrorResponse>;
    /**
     ...
     */
    public /*out*/ readonly loadBalancerDetails!: pulumi.Output<outputs.workloads.v20230401.LoadBalancerDetailsResponse>;
    /**
     ...
     */
    public /*out*/ readonly vmDetails!: pulumi.Output<outputs.workloads.v20230401.ApplicationServerVmDetailsResponse[]>;
