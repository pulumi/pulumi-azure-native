...
export class SapLandscapeMonitor extends pulumi.CustomResource {
     ...
     */
    declare public readonly grouping: pulumi.Output<outputs.workloads.SapLandscapeMonitorPropertiesGroupingResponse | undefined>;
    /**
     ...
     */
    declare public readonly topMetricsThresholds: pulumi.Output<outputs.workloads.SapLandscapeMonitorMetricThresholdsResponse[] | undefined>;
    /**
