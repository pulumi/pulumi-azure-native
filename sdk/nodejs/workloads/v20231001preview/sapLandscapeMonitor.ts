...
export class SapLandscapeMonitor extends pulumi.CustomResource {
     ...
     */
    public readonly grouping!: pulumi.Output<outputs.workloads.v20231001preview.SapLandscapeMonitorPropertiesResponseGrouping | undefined>;
    /**
     ...
     */
    public readonly topMetricsThresholds!: pulumi.Output<outputs.workloads.v20231001preview.SapLandscapeMonitorMetricThresholdsResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: SapLandscapeMonitorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:workloads:SapLandscapeMonitor" }, { type: "azure-native:workloads/v20221101preview:SapLandscapeMonitor" }, { type: "azure-native:workloads/v20230401:SapLandscapeMonitor" }, { type: "azure-native:workloads/v20231201preview:SapLandscapeMonitor" }] };
