...
export class SAPVirtualInstance extends pulumi.CustomResource {
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.workloads.v20231001preview.DeploymentConfigurationResponse | outputs.workloads.v20231001preview.DeploymentWithOSConfigurationResponse | outputs.workloads.v20231001preview.DiscoveryConfigurationResponse>;
    /**
     ...
     */
    public /*out*/ readonly errors!: pulumi.Output<outputs.workloads.v20231001preview.SAPVirtualInstanceErrorResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.workloads.v20231001preview.UserAssignedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly managedResourceGroupConfiguration!: pulumi.Output<outputs.workloads.v20231001preview.ManagedRGConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.workloads.v20231001preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface SAPVirtualInstanceArgs {
     ...
     * Defines if the SAP system is being created using Azure Center for SAP solutions (ACSS) or if an existing SAP system is being registered with ACSS
     */
    configuration: pulumi.Input<inputs.workloads.v20231001preview.DeploymentConfigurationArgs | inputs.workloads.v20231001preview.DeploymentWithOSConfigurationArgs | inputs.workloads.v20231001preview.DiscoveryConfigurationArgs>;
    /**
     * Defines the environment type - Production/Non Production.
     */
    environment: pulumi.Input<string | enums.workloads.v20231001preview.SAPEnvironmentType>;
    /**
     * Managed service identity (user assigned identities)
     */
    identity?: pulumi.Input<inputs.workloads.v20231001preview.UserAssignedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Managed resource group configuration
     */
    managedResourceGroupConfiguration?: pulumi.Input<inputs.workloads.v20231001preview.ManagedRGConfigurationArgs>;
    /**
     * Specifies the network access configuration for the resources that will be deployed in the Managed Resource Group. The options to choose from are Public and Private. If 'Private' is chosen, the Storage Account service tag should be enabled on the subnets in which the SAP VMs exist. This is required for establishing connectivity between VM extensions and the managed resource group storage account. This setting is currently applicable only to Storage Account. Learn more here https://go.microsoft.com/fwlink/?linkid=2247228
     */
    managedResourcesNetworkAccessType?: pulumi.Input<string | enums.workloads.v20231001preview.ManagedResourcesNetworkAccessType>;
    /**
     ...
     * Defines the SAP Product type.
     */
    sapProduct: pulumi.Input<string | enums.workloads.v20231001preview.SAPProductType>;
    /**
