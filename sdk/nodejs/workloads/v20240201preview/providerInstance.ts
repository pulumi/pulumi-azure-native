...
export class ProviderInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:workloads/v20240201preview:ProviderInstance';
     ...
     */
    public /*out*/ readonly health!: pulumi.Output<outputs.workloads.v20240201preview.HealthResponse>;
    /**
     ...
     */
    public readonly providerSettings!: pulumi.Output<outputs.workloads.v20240201preview.Db2ProviderInstancePropertiesResponse | outputs.workloads.v20240201preview.HanaDbProviderInstancePropertiesResponse | outputs.workloads.v20240201preview.MsSqlServerProviderInstancePropertiesResponse | outputs.workloads.v20240201preview.OracleProviderInstancePropertiesResponse | outputs.workloads.v20240201preview.PrometheusHaClusterProviderInstancePropertiesResponse | outputs.workloads.v20240201preview.PrometheusOsProviderInstancePropertiesResponse | outputs.workloads.v20240201preview.SapNetWeaverProviderInstancePropertiesResponse | undefined>;
    /**
...
export interface ProviderInstanceArgs {
     ...
     * Defines the provider specific properties.
     */
    providerSettings?: pulumi.Input<inputs.workloads.v20240201preview.Db2ProviderInstancePropertiesArgs | inputs.workloads.v20240201preview.HanaDbProviderInstancePropertiesArgs | inputs.workloads.v20240201preview.MsSqlServerProviderInstancePropertiesArgs | inputs.workloads.v20240201preview.OracleProviderInstancePropertiesArgs | inputs.workloads.v20240201preview.PrometheusHaClusterProviderInstancePropertiesArgs | inputs.workloads.v20240201preview.PrometheusOsProviderInstancePropertiesArgs | inputs.workloads.v20240201preview.SapNetWeaverProviderInstancePropertiesArgs>;
    /**
