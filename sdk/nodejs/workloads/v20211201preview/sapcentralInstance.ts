 ...
 *
 * const sapCentralInstance = new azure_native.workloads.v20211201preview.SAPCentralInstance("sapCentralInstance", {
...
export class SAPCentralInstance extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly loadBalancerDetails!: pulumi.Output<outputs.workloads.v20211201preview.LoadBalancerDetailsResponse>;
    /**
    ...
    constructor(name: string, args: SAPCentralInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:workloads:SAPCentralInstance" }, { type: "azure-native:workloads/v20221101preview:SAPCentralInstance" }, { type: "azure-native:workloads/v20230401:SAPCentralInstance" }] };
