...
export class SAPApplicationServerInstance extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly storageDetails!: pulumi.Output<outputs.workloads.v20211201preview.StorageInformationResponse[]>;
    /**
    ...
    constructor(name: string, args: SAPApplicationServerInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:workloads:SAPApplicationServerInstance" }, { type: "azure-native:workloads/v20221101preview:SAPApplicationServerInstance" }] };
