...
export class Springbootsite extends pulumi.CustomResource {
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.offazurespringboot.v20230101preview.SpringbootsitesModelResponseExtendedLocation | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.offazurespringboot.v20230101preview.SpringbootsitesPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SpringbootsiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazurespringboot/v20230101preview:springbootsite" }, { type: "azure-native:offazurespringboot/v20240401preview:Springbootsite" }, { type: "azure-native:offazurespringboot/v20240401preview:springbootsite" }, { type: "azure-native:offazurespringboot:Springbootsite" }, { type: "azure-native:offazurespringboot:springbootsite" }] };
