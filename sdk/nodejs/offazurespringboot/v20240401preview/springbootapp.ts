...
export class Springbootapp extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.offazurespringboot.v20240401preview.SpringbootappsPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SpringbootappArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazurespringboot:Springbootapp" }] };
