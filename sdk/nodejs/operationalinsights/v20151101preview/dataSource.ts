...
export class DataSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:operationalinsights/v20151101preview:DataSource';
    ...
    constructor(name: string, args: DataSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:operationalinsights:DataSource" }, { type: "azure-nextgen:operationalinsights/latest:DataSource" }, { type: "azure-nextgen:operationalinsights/v20200301preview:DataSource" }, { type: "azure-nextgen:operationalinsights/v20200801:DataSource" }] };
