 ...
 * Data connector.
 */
export class WorkspaceProviderDataConnector extends pulumi.CustomResource {
    /**
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights:WorkspaceProviderDataConnector';

    /**
     * Returns true if the given object is an instance of WorkspaceProviderDataConnector.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WorkspaceProviderDataConnector {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WorkspaceProviderDataConnector.__pulumiType;
    }
 ...
 */
export interface WorkspaceProviderDataConnectorArgs {
    /**
     * Etag of the azure resource
     */
    readonly etag?: pulumi.Input<string>;
