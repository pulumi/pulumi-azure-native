...
export function getAlertRuleAction(args: GetAlertRuleActionArgs, opts?: pulumi.InvokeOptions): Promise<GetAlertRuleActionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:operationalinsights:getAlertRuleAction", {
        "name": args.name,
...
export interface GetAlertRuleActionResult {
     ...
     */
    readonly properties: outputs.operationalinsights.ActionResponsePropertiesResponse;
    /**
     * Azure resource type
     */
