...
export class DataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/latest:DataConnector';
    ...
    constructor(name: string, args: DataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/preview:DataConnector" }, { type: "azurerm:operationalinsights/v20200101:DataConnector" }] };
