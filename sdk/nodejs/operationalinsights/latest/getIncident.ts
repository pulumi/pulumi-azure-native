...
export function getIncident(args: GetIncidentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:operationalinsights/latest:getIncident", {
...
export interface GetIncidentResult {
     ...
     */
    readonly additionalData: outputs.operationalinsights.latest.IncidentAdditionalDataResponse;
    /**
     ...
     */
    readonly labels?: outputs.operationalinsights.latest.IncidentLabelResponse[];
    /**
     ...
     */
    readonly owner?: outputs.operationalinsights.latest.IncidentOwnerInfoResponse;
    /**
