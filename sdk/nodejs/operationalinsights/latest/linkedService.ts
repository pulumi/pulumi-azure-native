...
export class LinkedService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/latest:LinkedService';
    ...
    constructor(name: string, args: LinkedServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/v20151101preview:LinkedService" }, { type: "azurerm:operationalinsights/v20190801preview:LinkedService" }, { type: "azurerm:operationalinsights/v20200301preview:LinkedService" }, { type: "azurerm:operationalinsights/v20200801:LinkedService" }] };
