...
export class LinkedService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:operationalinsights/latest:LinkedService';
    ...
    constructor(name: string, args: LinkedServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:operationalinsights/v20151101preview:LinkedService" }, { type: "azure-nextgen:operationalinsights/v20190801preview:LinkedService" }, { type: "azure-nextgen:operationalinsights/v20200301preview:LinkedService" }, { type: "azure-nextgen:operationalinsights/v20200801:LinkedService" }] };
