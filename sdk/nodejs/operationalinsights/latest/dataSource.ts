...
export class DataSource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:operationalinsights/latest:DataSource" }, { type: "azure-native:operationalinsights:DataSource" }, { type: "azure-nextgen:operationalinsights:DataSource" }, { type: "azure-native:operationalinsights/v20151101preview:DataSource" }, { type: "azure-nextgen:operationalinsights/v20151101preview:DataSource" }, { type: "azure-native:operationalinsights/v20200301preview:DataSource" }, { type: "azure-nextgen:operationalinsights/v20200301preview:DataSource" }, { type: "azure-native:operationalinsights/v20200801:DataSource" }, { type: "azure-nextgen:operationalinsights/v20200801:DataSource" }] };
...
export interface DataSourceArgs {
     ...
     * The kind of the DataSource.
     */
    readonly kind: pulumi.Input<string | enums.operationalinsights.latest.DataSourceKind>;
    /**
     * The data source properties in raw json format, each kind of data source have it's own schema.
     */
