...
export class SavedSearch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:operationalinsights/v20250201:SavedSearch';
     ...
     */
    public readonly tags!: pulumi.Output<outputs.operationalinsights.v20250201.TagResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: SavedSearchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:operationalinsights/v20150320:SavedSearch" }, { type: "azure-native:operationalinsights/v20200301preview:SavedSearch" }, { type: "azure-native:operationalinsights/v20200801:SavedSearch" }, { type: "azure-native:operationalinsights/v20230901:SavedSearch" }, { type: "azure-native:operationalinsights:SavedSearch" }] };
...
export interface SavedSearchArgs {
     ...
     * The tags attached to the saved search.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.operationalinsights.v20250201.TagArgs>[]>;
    /**
     * The version number of the query language. The current version is 2 and is the default.
     */
