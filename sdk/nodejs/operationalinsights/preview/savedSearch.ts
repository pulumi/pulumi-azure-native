...
export class SavedSearch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/preview:SavedSearch';
     ...
     */
    public readonly tags!: pulumi.Output<outputs.operationalinsights.preview.TagResponse[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SavedSearchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:SavedSearch" }, { type: "azurerm:operationalinsights/v20150320:SavedSearch" }, { type: "azurerm:operationalinsights/v20200301preview:SavedSearch" }, { type: "azurerm:operationalinsights/v20200801:SavedSearch" }] };
...
export interface SavedSearchArgs {
     ...
     * The tags attached to the saved search.
     */
    readonly tags?: pulumi.Input<pulumi.Input<inputs.operationalinsights.preview.Tag>[]>;
    /**
     * The version number of the query language. The current version is 2 and is the default.
     */
