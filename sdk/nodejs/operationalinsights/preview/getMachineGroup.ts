...
export function getMachineGroup(args: GetMachineGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetMachineGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:operationalinsights/preview:getMachineGroup", {
...
export interface GetMachineGroupResult {
     ...
     */
    readonly machines?: outputs.operationalinsights.preview.MachineReferenceWithHintsResponse[];
    /**
     * Resource name.
     */
