...
export class Bookmark extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/preview:Bookmark';
     ...
     */
    public readonly createdBy!: pulumi.Output<outputs.operationalinsights.preview.UserInfoResponse | undefined>;
    /**
     ...
     */
    public readonly incidentInfo!: pulumi.Output<outputs.operationalinsights.preview.IncidentInfoResponse | undefined>;
    /**
     ...
     */
    public readonly updatedBy!: pulumi.Output<outputs.operationalinsights.preview.UserInfoResponse | undefined>;
    ...
    constructor(name: string, args: BookmarkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:Bookmark" }, { type: "azurerm:operationalinsights/v20200101:Bookmark" }] };
...
export interface BookmarkArgs {
     ...
     * Describes a user that created the bookmark
     */
    readonly createdBy?: pulumi.Input<inputs.operationalinsights.preview.UserInfo>;
    /**
     * The display name of the bookmark
     */
     ...
     * Describes an incident that relates to bookmark
     */
    readonly incidentInfo?: pulumi.Input<inputs.operationalinsights.preview.IncidentInfo>;
    /**
     * List of labels relevant to this bookmark
     */
     ...
     * Describes a user that updated the bookmark
     */
    readonly updatedBy?: pulumi.Input<inputs.operationalinsights.preview.UserInfo>;
    /**
