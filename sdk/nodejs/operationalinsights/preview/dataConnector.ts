...
export class DataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/preview:DataConnector';
    ...
    constructor(name: string, argsOrState?: DataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:DataConnector" }, { type: "azurerm:operationalinsights/v20200101:DataConnector" }] };
