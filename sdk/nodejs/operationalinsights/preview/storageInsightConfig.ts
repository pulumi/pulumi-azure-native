...
export class StorageInsightConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/preview:StorageInsightConfig';
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.operationalinsights.preview.StorageInsightStatusResponse>;
    /**
     * The storage account connection details
     */
    public readonly storageAccount!: pulumi.Output<outputs.operationalinsights.preview.StorageAccountResponse>;
    /**
    ...
    constructor(name: string, args: StorageInsightConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:StorageInsightConfig" }, { type: "azurerm:operationalinsights/v20150320:StorageInsightConfig" }, { type: "azurerm:operationalinsights/v20200301preview:StorageInsightConfig" }, { type: "azurerm:operationalinsights/v20200801:StorageInsightConfig" }] };
...
export interface StorageInsightConfigArgs {
     ...
     * The storage account connection details
     */
    readonly storageAccount: pulumi.Input<inputs.operationalinsights.preview.StorageAccount>;
    /**
