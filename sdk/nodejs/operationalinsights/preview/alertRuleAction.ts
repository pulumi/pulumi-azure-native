...
export class AlertRuleAction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/preview:AlertRuleAction';
    ...
    constructor(name: string, args: AlertRuleActionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:AlertRuleAction" }, { type: "azurerm:operationalinsights/v20200101:AlertRuleAction" }] };
