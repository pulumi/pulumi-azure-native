...
export class Incident extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/preview:Incident';
     ...
     */
    public /*out*/ readonly additionalData!: pulumi.Output<outputs.operationalinsights.preview.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    public readonly labels!: pulumi.Output<outputs.operationalinsights.preview.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly owner!: pulumi.Output<outputs.operationalinsights.preview.IncidentOwnerInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: IncidentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:Incident" }, { type: "azurerm:operationalinsights/v20200101:Incident" }] };
...
export interface IncidentArgs {
     ...
     * List of labels relevant to this incident
     */
    readonly labels?: pulumi.Input<pulumi.Input<inputs.operationalinsights.preview.IncidentLabel>[]>;
    /**
     * The time of the last activity in the incident
     */
     ...
     * Describes a user that the incident is assigned to
     */
    readonly owner?: pulumi.Input<inputs.operationalinsights.preview.IncidentOwnerInfo>;
    /**
