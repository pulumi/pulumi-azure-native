...
export function getIncident(args: GetIncidentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentResult> {
    ...
    return pulumi.runtime.invoke("azurerm:operationalinsights/preview:getIncident", {
...
export interface GetIncidentResult {
     ...
     */
    readonly additionalData: outputs.operationalinsights.preview.IncidentAdditionalDataResponse;
    /**
     ...
     */
    readonly labels?: outputs.operationalinsights.preview.IncidentLabelResponse[];
    /**
     ...
     */
    readonly owner?: outputs.operationalinsights.preview.IncidentOwnerInfoResponse;
    /**
