...
export function getStorageInsightConfig(args: GetStorageInsightConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageInsightConfigResult> {
    ...
    return pulumi.runtime.invoke("azurerm:operationalinsights/preview:getStorageInsightConfig", {
...
export interface GetStorageInsightConfigResult {
     ...
     */
    readonly status: outputs.operationalinsights.preview.StorageInsightStatusResponse;
    /**
     * The storage account connection details
     */
    readonly storageAccount: outputs.operationalinsights.preview.StorageAccountResponse;
    /**
