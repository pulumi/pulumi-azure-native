...
export class LinkedStorageAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/preview:LinkedStorageAccount';
    ...
    constructor(name: string, args: LinkedStorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:LinkedStorageAccount" }, { type: "azurerm:operationalinsights/v20190801preview:LinkedStorageAccount" }, { type: "azurerm:operationalinsights/v20200301preview:LinkedStorageAccount" }, { type: "azurerm:operationalinsights/v20200801:LinkedStorageAccount" }] };
