...
export class MachineGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/preview:MachineGroup';
     ...
     */
    public readonly machines!: pulumi.Output<outputs.operationalinsights.preview.MachineReferenceWithHintsResponse[] | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: MachineGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/v20151101preview:MachineGroup" }] };
...
export interface MachineGroupArgs {
     ...
     * References of the machines in this group. The hints within each reference do not represent the current value of the corresponding fields. They are a snapshot created during the last time the machine group was updated.
     */
    readonly machines?: pulumi.Input<pulumi.Input<inputs.operationalinsights.preview.MachineReferenceWithHints>[]>;
    /**
