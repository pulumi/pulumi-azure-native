...
export class SavedSearch extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SavedSearchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:operationalinsights/v20200301preview:SavedSearch" }, { type: "azure-native:operationalinsights:SavedSearch" }, { type: "azure-nextgen:operationalinsights:SavedSearch" }, { type: "azure-native:operationalinsights/v20150320:SavedSearch" }, { type: "azure-nextgen:operationalinsights/v20150320:SavedSearch" }, { type: "azure-native:operationalinsights/v20200801:SavedSearch" }, { type: "azure-nextgen:operationalinsights/v20200801:SavedSearch" }] };
...
export interface SavedSearchArgs {
     ...
     * The tags attached to the saved search.
     */
    readonly tags?: pulumi.Input<pulumi.Input<inputs.operationalinsights.v20200301preview.TagArgs>[]>;
    /**
     * The version number of the query language. The current version is 2 and is the default.
     */
