...
export class DataExport extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DataExportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:DataExport" }, { type: "azurerm:operationalinsights/preview:DataExport" }, { type: "azurerm:operationalinsights/v20190801preview:DataExport" }, { type: "azurerm:operationalinsights/v20200801:DataExport" }] };
