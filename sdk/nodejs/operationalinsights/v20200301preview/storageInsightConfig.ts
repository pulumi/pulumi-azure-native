 ...
 *
 * const storageInsightConfig = new azurerm.operationalinsights.v20200301preview.StorageInsightConfig("storageInsightConfig", {
...
export class StorageInsightConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/v20200301preview:StorageInsightConfig';
    ...
    constructor(name: string, args: StorageInsightConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:StorageInsightConfig" }, { type: "azurerm:operationalinsights/v20150320:StorageInsightConfig" }, { type: "azurerm:operationalinsights/v20200801:StorageInsightConfig" }] };
