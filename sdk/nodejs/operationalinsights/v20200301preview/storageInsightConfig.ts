 ...
 *
 * @deprecated azure-native:operationalinsights/v20200301preview:StorageInsightConfig is being removed in the next major version of this provider. Please upgrade to azure-native:operationalinsights/v20200801:StorageInsightConfig to guarantee forwards compatibility.
 */
export class StorageInsightConfig extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageInsightConfig {
        pulumi.log.warn("StorageInsightConfig is deprecated: azure-native:operationalinsights/v20200301preview:StorageInsightConfig is being removed in the next major version of this provider. Please upgrade to azure-native:operationalinsights/v20200801:StorageInsightConfig to guarantee forwards compatibility.")
        return new StorageInsightConfig(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:operationalinsights/v20200301preview:StorageInsightConfig';
...
export interface StorageInsightConfigArgs {
     ...
     * The storage account connection details
     */
    storageAccount: pulumi.Input<inputs.operationalinsights.v20200301preview.StorageAccountArgs>;
    /**
