 ...
 *
 * const linkedService = new azurerm.operationalinsights.v20200301preview.LinkedService("linkedService", {
...
export class LinkedService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/v20200301preview:LinkedService';
    ...
    constructor(name: string, args: LinkedServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:LinkedService" }, { type: "azurerm:operationalinsights/v20151101preview:LinkedService" }, { type: "azurerm:operationalinsights/v20190801preview:LinkedService" }, { type: "azurerm:operationalinsights/v20200801:LinkedService" }] };
