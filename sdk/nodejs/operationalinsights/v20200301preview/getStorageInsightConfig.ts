...
export function getStorageInsightConfig(args: GetStorageInsightConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageInsightConfigResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:operationalinsights/v20200301preview:getStorageInsightConfig", {
...
export interface GetStorageInsightConfigResult {
     ...
     */
    readonly status: outputs.operationalinsights.v20200301preview.StorageInsightStatusInvokeResponse;
    /**
     * The storage account connection details
     */
    readonly storageAccount: outputs.operationalinsights.v20200301preview.StorageAccountInvokeResponse;
    /**
