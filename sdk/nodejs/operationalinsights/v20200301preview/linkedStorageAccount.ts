...
export class LinkedStorageAccount extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LinkedStorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:LinkedStorageAccount" }, { type: "azurerm:operationalinsights/preview:LinkedStorageAccount" }, { type: "azurerm:operationalinsights/v20190801preview:LinkedStorageAccount" }, { type: "azurerm:operationalinsights/v20200801:LinkedStorageAccount" }] };
