...
export class Incident extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:operationalinsights/v20200101:Incident';
    ...
    constructor(name: string, args: IncidentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:operationalinsights/latest:Incident" }] };
...
export interface IncidentArgs {
     ...
     * The reason the incident was closed
     */
    readonly classification?: pulumi.Input<string | enums.operationalinsights.v20200101.IncidentClassification>;
    /**
     * Describes the reason the incident was closed
     */
     ...
     * The classification reason the incident was closed with
     */
    readonly classificationReason?: pulumi.Input<string | enums.operationalinsights.v20200101.IncidentClassificationReason>;
    /**
     * The description of the incident
     */
     ...
     * The severity of the incident
     */
    readonly severity: pulumi.Input<string | enums.operationalinsights.v20200101.IncidentSeverity>;
    /**
     * The status of the incident
     */
    readonly status: pulumi.Input<string | enums.operationalinsights.v20200101.IncidentStatus>;
    /**
     * The title of the incident
     */
