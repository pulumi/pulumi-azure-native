...
export class SummaryLog extends pulumi.CustomResource {
     ...
     */
    declare public readonly ruleDefinition: pulumi.Output<outputs.operationalinsights.RuleDefinitionResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SummaryLogArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["summaryLogsName"] = args?.summaryLogsName;
