...
export class StorageInsightConfig extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageInsightConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:operationalinsights:StorageInsightConfig" }, { type: "azure-nextgen:operationalinsights/latest:StorageInsightConfig" }, { type: "azure-nextgen:operationalinsights/v20150320:StorageInsightConfig" }, { type: "azure-nextgen:operationalinsights/v20200301preview:StorageInsightConfig" }] };
