 ...
 *
 * const storageInsightConfig = new azurerm.operationalinsights.v20200801.StorageInsightConfig("storageInsightConfig", {
...
export class StorageInsightConfig extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: StorageInsightConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:StorageInsightConfig" }, { type: "azurerm:operationalinsights/v20150320:StorageInsightConfig" }] };
