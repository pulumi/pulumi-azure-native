...
export class SavedSearch extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SavedSearchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:SavedSearch" }, { type: "azurerm:operationalinsights/preview:SavedSearch" }, { type: "azurerm:operationalinsights/v20150320:SavedSearch" }, { type: "azurerm:operationalinsights/v20200301preview:SavedSearch" }] };
