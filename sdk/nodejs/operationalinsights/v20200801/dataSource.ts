...
export class DataSource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:DataSource" }, { type: "azurerm:operationalinsights/v20151101preview:DataSource" }, { type: "azurerm:operationalinsights/v20200301preview:DataSource" }] };
