...
export class DataSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/v20200801:DataSource';
    ...
    constructor(name: string, args: DataSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:DataSource" }, { type: "azurerm:operationalinsights/preview:DataSource" }, { type: "azurerm:operationalinsights/v20151101preview:DataSource" }, { type: "azurerm:operationalinsights/v20200301preview:DataSource" }] };
