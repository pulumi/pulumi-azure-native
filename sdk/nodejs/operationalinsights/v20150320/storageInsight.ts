...
export class StorageInsight extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/v20150320:StorageInsight';
    ...
    constructor(name: string, args: StorageInsightArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:StorageInsight" }, { type: "azurerm:operationalinsights/preview:StorageInsight" }, { type: "azurerm:operationalinsights/v20200301preview:StorageInsight" }, { type: "azurerm:operationalinsights/v20200801:StorageInsight" }] };
