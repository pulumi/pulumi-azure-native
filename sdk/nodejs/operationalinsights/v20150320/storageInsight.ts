...
export class StorageInsight extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageInsightArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:operationalinsights/latest:StorageInsight" }, { type: "azure-nextgen:operationalinsights/v20200301preview:StorageInsight" }, { type: "azure-nextgen:operationalinsights/v20200801:StorageInsight" }] };
