...
export class SavedSearch extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: SavedSearchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:SavedSearch" }, { type: "azurerm:operationalinsights/v20200301preview:SavedSearch" }, { type: "azurerm:operationalinsights/v20200801:SavedSearch" }] };
