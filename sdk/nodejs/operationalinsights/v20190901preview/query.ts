...
export class Query extends pulumi.CustomResource {
     ...
     */
    public readonly related!: pulumi.Output<outputs.operationalinsights.v20190901preview.LogAnalyticsQueryPackQueryPropertiesResponseRelated | undefined>;
    /**
     * Read only system data
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.operationalinsights.v20190901preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: QueryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:operationalinsights/v20190901:Query" }, { type: "azure-native:operationalinsights/v20230901:Query" }, { type: "azure-native:operationalinsights/v20250201:Query" }, { type: "azure-native:operationalinsights:Query" }] };
