...
export class DataExport extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataExportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:DataExport" }, { type: "azurerm:operationalinsights/preview:DataExport" }, { type: "azurerm:operationalinsights/v20200301preview:DataExport" }, { type: "azurerm:operationalinsights/v20200801:DataExport" }] };
