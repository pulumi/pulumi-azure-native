 ...
 *
 * const dataExport = new azurerm.operationalinsights.v20190801preview.DataExport("dataExport", {
...
export class DataExport extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationalinsights/v20190801preview:DataExport';
    ...
    constructor(name: string, args: DataExportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationalinsights/latest:DataExport" }, { type: "azurerm:operationalinsights/v20200301preview:DataExport" }, { type: "azurerm:operationalinsights/v20200801:DataExport" }] };
