...
export class DataExport extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataExport {
        pulumi.log.warn("DataExport is deprecated: azure-native:operationalinsights/v20190801preview:DataExport is being removed in the next major version of this provider. Please upgrade to azure-native:operationalinsights/v20200801:DataExport to guarantee forwards compatibility.")
