...
export class CommunityTraining extends pulumi.CustomResource {
     ...
     */
    public readonly identityConfiguration!: pulumi.Output<outputs.community.v20231101.IdentityConfigurationPropertiesResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.community.v20231101.SkuResponse | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.community.v20231101.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: CommunityTrainingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["identityConfiguration"] = args ? (args.identityConfiguration ? pulumi.output(args.identityConfiguration).apply(inputs.community.v20231101.identityConfigurationPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface CommunityTrainingArgs {
     ...
     * The identity configuration of the Community Training resource
     */
    identityConfiguration: pulumi.Input<inputs.community.v20231101.IdentityConfigurationPropertiesArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The SKU (Stock Keeping Unit) assigned to this resource.
     */
    sku?: pulumi.Input<inputs.community.v20231101.SkuArgs>;
    /**
     * Resource tags.
     */
