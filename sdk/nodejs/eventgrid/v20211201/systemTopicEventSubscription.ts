 ...
 * Event Subscription
 *
 * @deprecated azure-native:eventgrid/v20211201:SystemTopicEventSubscription is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20220615:SystemTopicEventSubscription to guarantee forwards compatibility.
 */
export class SystemTopicEventSubscription extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SystemTopicEventSubscription {
        pulumi.log.warn("SystemTopicEventSubscription is deprecated: azure-native:eventgrid/v20211201:SystemTopicEventSubscription is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20220615:SystemTopicEventSubscription to guarantee forwards compatibility.")
        return new SystemTopicEventSubscription(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20211201:SystemTopicEventSubscription';
     ...
     */
    public readonly filter!: pulumi.Output<outputs.eventgrid.v20211201.EventSubscriptionFilterResponse | undefined>;
    /**
     ...
     */
    public readonly retryPolicy!: pulumi.Output<outputs.eventgrid.v20211201.RetryPolicyResponse | undefined>;
    /**
     * The system metadata relating to Event Subscription resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.eventgrid.v20211201.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: SystemTopicEventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["filter"] = args ? (args.filter ? pulumi.output(args.filter).apply(inputs.eventgrid.v20211201.eventSubscriptionFilterArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["labels"] = args ? args.labels : undefined;
            resourceInputs["resourceGroupName"] = args ? args.resourceGroupName : undefined;
            resourceInputs["retryPolicy"] = args ? (args.retryPolicy ? pulumi.output(args.retryPolicy).apply(inputs.eventgrid.v20211201.retryPolicyArgsProvideDefaults) : undefined) : undefined;
