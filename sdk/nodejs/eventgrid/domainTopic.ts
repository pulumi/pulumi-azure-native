...
export class DomainTopic extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DomainTopicArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["domainTopicName"] = args?.domainTopicName;
