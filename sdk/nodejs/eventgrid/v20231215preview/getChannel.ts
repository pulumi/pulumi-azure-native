...
export interface GetChannelResult {
     ...
     */
    readonly partnerDestinationInfo?: outputs.eventgrid.v20231215preview.WebhookPartnerDestinationInfoResponse;
    /**
     * This property should be populated when channelType is PartnerTopic and represents information about the partner topic resource corresponding to the channel.
     */
    readonly partnerTopicInfo?: outputs.eventgrid.v20231215preview.PartnerTopicInfoResponse;
    /**
...
export function getChannelOutput(args: GetChannelOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetChannelResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:eventgrid/v20231215preview:getChannel", {
        "channelName": args.channelName,
        "partnerNamespaceName": args.partnerNamespaceName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
