...
export class PermissionBinding extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PermissionBindingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:PermissionBinding" }, { type: "azure-native:eventgrid/v20230601preview:PermissionBinding" }, { type: "azure-native:eventgrid/v20240601preview:PermissionBinding" }] };
