...
export class Client extends pulumi.CustomResource {
     ...
     */
    public readonly clientCertificateAuthentication!: pulumi.Output<outputs.eventgrid.v20231215preview.ClientCertificateAuthenticationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ClientArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20230601preview:Client" }, { type: "azure-native:eventgrid/v20240601preview:Client" }, { type: "azure-native:eventgrid/v20241215preview:Client" }, { type: "azure-native:eventgrid/v20250215:Client" }, { type: "azure-native:eventgrid:Client" }] };
...
export interface ClientArgs {
     ...
     * The client certificate authentication information.
     */
    clientCertificateAuthentication?: pulumi.Input<inputs.eventgrid.v20231215preview.ClientCertificateAuthenticationArgs>;
    /**
     * The client name.
     */
     ...
     * Indicates if the client is enabled or not. Default value is Enabled.
     */
    state?: pulumi.Input<string | enums.eventgrid.v20231215preview.ClientState>;
}
