...
export class EventChannel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20200401preview:EventChannel';
    ...
    constructor(name: string, args: EventChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20201015preview:EventChannel" }, { type: "azure-native:eventgrid/v20210601preview:EventChannel" }, { type: "azure-native:eventgrid/v20211015preview:EventChannel" }] };
