 ...
 *
 * const privateEndpointConnection = new azurerm.eventgrid.v20200401preview.PrivateEndpointConnection("privateEndpointConnection", {
...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventgrid/v20200401preview:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventgrid/latest:PrivateEndpointConnection" }, { type: "azurerm:eventgrid/v20200601:PrivateEndpointConnection" }] };
