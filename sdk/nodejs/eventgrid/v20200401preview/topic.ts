 ...
 *
 * const topic = new azurerm.eventgrid.v20200401preview.Topic("topic", {
 *     inboundIpRules: [
 *         {
 *             action: "Allow",
 *             ipMask: "12.18.30.15",
...
export class Topic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventgrid/v20200401preview:Topic';
