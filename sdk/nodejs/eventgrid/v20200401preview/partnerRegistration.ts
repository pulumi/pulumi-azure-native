...
export class PartnerRegistration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PartnerRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventgrid/v20200401preview:PartnerRegistration" }, { type: "azure-native:eventgrid:PartnerRegistration" }, { type: "azure-nextgen:eventgrid:PartnerRegistration" }, { type: "azure-native:eventgrid/v20201015preview:PartnerRegistration" }, { type: "azure-nextgen:eventgrid/v20201015preview:PartnerRegistration" }, { type: "azure-native:eventgrid/v20210601preview:PartnerRegistration" }, { type: "azure-nextgen:eventgrid/v20210601preview:PartnerRegistration" }] };
