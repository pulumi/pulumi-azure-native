...
export class PartnerDestination extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PartnerDestinationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:PartnerDestination" }, { type: "azure-native:eventgrid/v20211015preview:PartnerDestination" }, { type: "azure-native:eventgrid/v20231215preview:PartnerDestination" }, { type: "azure-native:eventgrid/v20240601preview:PartnerDestination" }, { type: "azure-native:eventgrid/v20241215preview:PartnerDestination" }] };
...
export interface PartnerDestinationArgs {
     ...
     * Activation state of the partner destination.
     */
    activationState?: pulumi.Input<string | enums.eventgrid.v20230601preview.PartnerDestinationActivationState>;
    /**
     * Endpoint Base URL of the partner destination
     */
