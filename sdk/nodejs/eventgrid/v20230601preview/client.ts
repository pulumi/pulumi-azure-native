...
export class Client extends pulumi.CustomResource {
     ...
     */
    public readonly authentication!: pulumi.Output<outputs.eventgrid.v20230601preview.ClientAuthenticationResponse | undefined>;
    /**
     ...
     */
    public readonly clientCertificateAuthentication!: pulumi.Output<outputs.eventgrid.v20230601preview.ClientCertificateAuthenticationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ClientArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:Client" }, { type: "azure-native:eventgrid/v20231215preview:Client" }, { type: "azure-native:eventgrid/v20240601preview:Client" }] };
...
export interface ClientArgs {
     ...
     * Authentication information for the client.
     */
    authentication?: pulumi.Input<inputs.eventgrid.v20230601preview.ClientAuthenticationArgs>;
    /**
     * The name presented by the client for authentication. The default value is the name of the resource.
     */
     ...
     * The client certificate authentication information.
     */
    clientCertificateAuthentication?: pulumi.Input<inputs.eventgrid.v20230601preview.ClientCertificateAuthenticationArgs>;
    /**
     * The client name.
     */
     ...
     * Indicates if the client is enabled or not. Default value is Enabled.
     */
    state?: pulumi.Input<string | enums.eventgrid.v20230601preview.ClientState>;
}
