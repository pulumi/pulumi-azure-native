...
export class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.eventgrid.v20230601preview.PrivateEndpointResponse | undefined>;
    /**
     * Details about the state of the connection.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.eventgrid.v20230601preview.ConnectionStateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20200401preview:PrivateEndpointConnection" }, { type: "azure-native:eventgrid/v20200601:PrivateEndpointConnection" }, { type: "azure-native:eventgrid/v20201015preview:PrivateEndpointConnection" }, { type: "azure-native:eventgrid/v20210601preview:PrivateEndpointConnection" }, { type: "azure-native:eventgrid/v20211015preview:PrivateEndpointConnection" }, { type: "azure-native:eventgrid/v20211201:PrivateEndpointConnection" }, { type: "azure-native:eventgrid/v20220615:PrivateEndpointConnection" }, { type: "azure-native:eventgrid/v20231215preview:PrivateEndpointConnection" }, { type: "azure-native:eventgrid/v20240601preview:PrivateEndpointConnection" }, { type: "azure-native:eventgrid/v20241215preview:PrivateEndpointConnection" }, { type: "azure-native:eventgrid/v20250215:PrivateEndpointConnection" }, { type: "azure-native:eventgrid:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * The Private Endpoint resource for this Connection.
     */
    privateEndpoint?: pulumi.Input<inputs.eventgrid.v20230601preview.PrivateEndpointArgs>;
    /**
     ...
     * Details about the state of the connection.
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.eventgrid.v20230601preview.ConnectionStateArgs>;
    /**
     * Provisioning state of the Private Endpoint Connection.
     */
    provisioningState?: pulumi.Input<string | enums.eventgrid.v20230601preview.ResourceProvisioningState>;
    /**
