...
export interface GetChannelResult {
     ...
     */
    readonly partnerDestinationInfo?: outputs.eventgrid.v20230601preview.WebhookPartnerDestinationInfoResponse;
    /**
     * This property should be populated when channelType is PartnerTopic and represents information about the partner topic resource corresponding to the channel.
     */
    readonly partnerTopicInfo?: outputs.eventgrid.v20230601preview.PartnerTopicInfoResponse;
    /**
...
export function getChannelOutput(args: GetChannelOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetChannelResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:eventgrid/v20230601preview:getChannel", {
        "channelName": args.channelName,
        "partnerNamespaceName": args.partnerNamespaceName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
