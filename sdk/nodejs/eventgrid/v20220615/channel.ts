 ...
 *
 * const channel = new azure_native.eventgrid.v20220615.Channel("channel", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:eventgrid/v20220615:Channel exampleChannelName1 /subscriptions/5b4b650e-28b9-4790-b3ab-ddbd88d727c4/resourceGroups/examplerg/providers/Microsoft.EventGrid/partnerNamespaces/examplePartnerNamespaceName1/changes/exampleChannelName1 
 * ```
 */
export class Channel extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:Channel" }, { type: "azure-native:eventgrid/v20211015preview:Channel" }] };
