...
export class EventChannel extends pulumi.CustomResource {
     ...
     */
    public readonly destination!: pulumi.Output<outputs.eventgrid.v20211015preview.EventChannelDestinationResponse | undefined>;
    /**
     ...
     */
    public readonly filter!: pulumi.Output<outputs.eventgrid.v20211015preview.EventChannelFilterResponse | undefined>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<outputs.eventgrid.v20211015preview.EventChannelSourceResponse | undefined>;
    /**
    ...
    constructor(name: string, args: EventChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["filter"] = args ? (args.filter ? pulumi.output(args.filter).apply(inputs.eventgrid.v20211015preview.eventChannelFilterArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:EventChannel" }, { type: "azure-native:eventgrid/v20200401preview:EventChannel" }, { type: "azure-native:eventgrid/v20210601preview:EventChannel" }] };
