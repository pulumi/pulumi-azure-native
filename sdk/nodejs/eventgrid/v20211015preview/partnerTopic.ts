...
export class PartnerTopic extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PartnerTopic {
        pulumi.log.warn("PartnerTopic is deprecated: azure-native:eventgrid/v20211015preview:PartnerTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:PartnerTopic to guarantee forwards compatibility.")
        return new PartnerTopic(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20211015preview:PartnerTopic';
     ...
     */
    public readonly eventTypeInfo!: pulumi.Output<outputs.eventgrid.v20211015preview.EventTypeInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PartnerTopicArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:PartnerTopic" }, { type: "azure-native:eventgrid/v20220615:PartnerTopic" }] };
