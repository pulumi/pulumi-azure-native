...
export class PartnerRegistration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:eventgrid:PartnerRegistration';
    ...
    constructor(name: string, args: PartnerRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventgrid/v20200401preview:PartnerRegistration" }, { type: "azure-nextgen:eventgrid/v20201015preview:PartnerRegistration" }] };
