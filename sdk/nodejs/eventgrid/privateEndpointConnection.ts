...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:eventgrid:PrivateEndpointConnection';
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.eventgrid.PrivateEndpointResponse | undefined>;
    /**
     * Details about the state of the connection.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.eventgrid.ConnectionStateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventgrid/latest:PrivateEndpointConnection" }, { type: "azure-nextgen:eventgrid/v20200401preview:PrivateEndpointConnection" }, { type: "azure-nextgen:eventgrid/v20200601:PrivateEndpointConnection" }, { type: "azure-nextgen:eventgrid/v20201015preview:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * The Private Endpoint resource for this Connection.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.eventgrid.PrivateEndpoint>;
    /**
     ...
     * Details about the state of the connection.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.eventgrid.ConnectionState>;
    /**
     * Provisioning state of the Private Endpoint Connection.
     */
    readonly provisioningState?: pulumi.Input<string | enums.eventgrid.ResourceProvisioningState>;
    /**
