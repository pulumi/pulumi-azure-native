...
export class DomainTopic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:eventgrid/v20200601:DomainTopic';
    ...
    constructor(name: string, args: DomainTopicArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventgrid/latest:DomainTopic" }, { type: "azure-nextgen:eventgrid/v20190201preview:DomainTopic" }, { type: "azure-nextgen:eventgrid/v20190601:DomainTopic" }, { type: "azure-nextgen:eventgrid/v20200101preview:DomainTopic" }, { type: "azure-nextgen:eventgrid/v20200401preview:DomainTopic" }] };
