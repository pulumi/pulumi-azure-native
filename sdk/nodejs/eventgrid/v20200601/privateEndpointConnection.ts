...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventgrid/latest:PrivateEndpointConnection" }, { type: "azurerm:eventgrid/preview:PrivateEndpointConnection" }, { type: "azurerm:eventgrid/v20200401preview:PrivateEndpointConnection" }] };
