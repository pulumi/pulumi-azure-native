 ...
 *
 * const systemTopic = new azure_native.eventgrid.v20210601preview.SystemTopic("systemTopic", {
 *     location: "westus2",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:eventgrid/v20210601preview:SystemTopic exampleSystemTopic2 /subscriptions/5b4b650e-28b9-4790-b3ab-ddbd88d727c4/resourceGroups/examplerg/providers/Microsoft.EventGrid/systemTopics/exampleSystemTopic2 
 * ```
 */
export class SystemTopic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20210601preview:SystemTopic';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.eventgrid.v20210601preview.IdentityInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SystemTopicArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:SystemTopic" }, { type: "azure-native:eventgrid/v20200401preview:SystemTopic" }, { type: "azure-native:eventgrid/v20201015preview:SystemTopic" }, { type: "azure-native:eventgrid/v20211015preview:SystemTopic" }, { type: "azure-native:eventgrid/v20211201:SystemTopic" }, { type: "azure-native:eventgrid/v20220615:SystemTopic" }] };
...
export interface SystemTopicArgs {
     ...
     * Identity information for the resource.
     */
    identity?: pulumi.Input<inputs.eventgrid.v20210601preview.IdentityInfoArgs>;
    /**
     * Location of the resource.
     */
