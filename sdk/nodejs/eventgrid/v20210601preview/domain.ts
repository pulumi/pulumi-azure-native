 ...
 * EventGrid Domain.
 *
 * @deprecated azure-native:eventgrid/v20210601preview:Domain is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20211015preview:Domain to guarantee forwards compatibility.
 */
export class Domain extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Domain {
        pulumi.log.warn("Domain is deprecated: azure-native:eventgrid/v20210601preview:Domain is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20211015preview:Domain to guarantee forwards compatibility.")
        return new Domain(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20210601preview:Domain';
     ...
     */
    public readonly inboundIpRules!: pulumi.Output<outputs.eventgrid.v20210601preview.InboundIpRuleResponse[] | undefined>;
    /**
     ...
     */
    public readonly inputSchemaMapping!: pulumi.Output<outputs.eventgrid.v20210601preview.JsonInputSchemaMappingResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.eventgrid.v20210601preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.eventgrid.v20210601preview.ResourceSkuResponse | undefined>;
    /**
...
export interface DomainArgs {
     ...
     * This can be used to restrict traffic from specific IPs instead of all IPs. Note: These are considered only if PublicNetworkAccess is enabled.
     */
    inboundIpRules?: pulumi.Input<pulumi.Input<inputs.eventgrid.v20210601preview.InboundIpRuleArgs>[]>;
    /**
     * This determines the format that Event Grid should expect for incoming events published to the Event Grid Domain Resource.
     */
    inputSchema?: pulumi.Input<string | enums.eventgrid.v20210601preview.InputSchema>;
    /**
     * Information about the InputSchemaMapping which specified the info about mapping event payload.
     */
    inputSchemaMapping?: pulumi.Input<inputs.eventgrid.v20210601preview.JsonInputSchemaMappingArgs>;
    /**
     * Location of the resource.
     */
     ...
     * You can further restrict to specific IPs by configuring <seealso cref="P:Microsoft.Azure.Events.ResourceProvider.Common.Contracts.DomainProperties.InboundIpRules" />
     */
    publicNetworkAccess?: pulumi.Input<string | enums.eventgrid.v20210601preview.PublicNetworkAccess>;
    /**
     ...
     * The Sku pricing tier for the Event Grid Domain resource.
     */
    sku?: pulumi.Input<inputs.eventgrid.v20210601preview.ResourceSkuArgs>;
    /**
     * Tags of the resource.
     */
