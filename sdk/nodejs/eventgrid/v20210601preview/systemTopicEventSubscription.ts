...
export class SystemTopicEventSubscription extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SystemTopicEventSubscription {
        pulumi.log.warn("SystemTopicEventSubscription is deprecated: azure-native:eventgrid/v20210601preview:SystemTopicEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20220615:SystemTopicEventSubscription to guarantee forwards compatibility.")
