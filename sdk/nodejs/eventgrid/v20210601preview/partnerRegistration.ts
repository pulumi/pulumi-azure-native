 ...
 *
 * const partnerRegistration = new azure_native.eventgrid.v20210601preview.PartnerRegistration("partnerRegistration", {
...
export class PartnerRegistration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20210601preview:PartnerRegistration';
    ...
    constructor(name: string, args: PartnerRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:PartnerRegistration" }, { type: "azure-native:eventgrid/v20200401preview:PartnerRegistration" }, { type: "azure-native:eventgrid/v20201015preview:PartnerRegistration" }, { type: "azure-native:eventgrid/v20211015preview:PartnerRegistration" }, { type: "azure-native:eventgrid/v20220615:PartnerRegistration" }] };
...
export interface PartnerRegistrationArgs {
     ...
     * Visibility state of the partner registration.
     */
    visibilityState?: pulumi.Input<string | enums.eventgrid.v20210601preview.PartnerRegistrationVisibilityState>;
}
