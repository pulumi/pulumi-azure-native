...
export class EventChannel extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EventChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:EventChannel" }, { type: "azure-native:eventgrid/v20200401preview:EventChannel" }, { type: "azure-native:eventgrid/v20201015preview:EventChannel" }] };
