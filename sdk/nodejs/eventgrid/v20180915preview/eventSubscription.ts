 ...
 *
 * const eventSubscription = new azurerm.eventgrid.v20180915preview.EventSubscription("eventSubscription", {
 *     destination: {
...
export class EventSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventgrid/v20180915preview:EventSubscription';
     ...
     */
    public readonly deadLetterDestination!: pulumi.Output<outputs.eventgrid.v20180915preview.StorageBlobDeadLetterDestinationResponse | undefined>;
    /**
     ...
     */
    public readonly filter!: pulumi.Output<outputs.eventgrid.v20180915preview.EventSubscriptionFilterResponse | undefined>;
    /**
     ...
     */
    public readonly retryPolicy!: pulumi.Output<outputs.eventgrid.v20180915preview.RetryPolicyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: EventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventgrid/latest:EventSubscription" }, { type: "azurerm:eventgrid/v20170615preview:EventSubscription" }, { type: "azurerm:eventgrid/v20170915preview:EventSubscription" }, { type: "azurerm:eventgrid/v20180101:EventSubscription" }, { type: "azurerm:eventgrid/v20180501preview:EventSubscription" }, { type: "azurerm:eventgrid/v20190101:EventSubscription" }, { type: "azurerm:eventgrid/v20190201preview:EventSubscription" }, { type: "azurerm:eventgrid/v20190601:EventSubscription" }, { type: "azurerm:eventgrid/v20200101preview:EventSubscription" }, { type: "azurerm:eventgrid/v20200401preview:EventSubscription" }, { type: "azurerm:eventgrid/v20200601:EventSubscription" }] };
...
export interface EventSubscriptionArgs {
     ...
     * The DeadLetter destination of the event subscription.
     */
    readonly deadLetterDestination?: pulumi.Input<inputs.eventgrid.v20180915preview.StorageBlobDeadLetterDestination>;
    /**
     * Information about the destination where events have to be delivered for the event subscription.
     */
    readonly destination?: pulumi.Input<inputs.eventgrid.v20180915preview.EventHubEventSubscriptionDestination | inputs.eventgrid.v20180915preview.HybridConnectionEventSubscriptionDestination | inputs.eventgrid.v20180915preview.StorageQueueEventSubscriptionDestination | inputs.eventgrid.v20180915preview.WebHookEventSubscriptionDestination>;
    /**
     * The event delivery schema for the event subscription.
     */
     ...
     * Information about the filter for the event subscription.
     */
    readonly filter?: pulumi.Input<inputs.eventgrid.v20180915preview.EventSubscriptionFilter>;
    /**
     * List of user defined labels.
     */
     ...
     * The retry policy for events. This can be used to configure maximum number of delivery attempts and time to live for events.
     */
    readonly retryPolicy?: pulumi.Input<inputs.eventgrid.v20180915preview.RetryPolicy>;
    /**
