...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:eventgrid/v20180101:EventSubscription":
                return new EventSubscription(name, <any>undefined, { urn })
            case "azure-nextgen:eventgrid/v20180101:Topic":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "eventgrid/v20180101", _module)
