...
export class Client extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20240601preview:Client';
     ...
     */
    public readonly clientCertificateAuthentication!: pulumi.Output<outputs.eventgrid.v20240601preview.ClientCertificateAuthenticationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ClientArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20230601preview:Client" }, { type: "azure-native:eventgrid/v20231215preview:Client" }, { type: "azure-native:eventgrid/v20241215preview:Client" }, { type: "azure-native:eventgrid/v20250215:Client" }, { type: "azure-native:eventgrid:Client" }] };
