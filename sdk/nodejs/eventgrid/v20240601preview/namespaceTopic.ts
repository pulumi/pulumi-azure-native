...
export class NamespaceTopic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20240601preview:NamespaceTopic';
    ...
    constructor(name: string, args: NamespaceTopicArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20230601preview:NamespaceTopic" }, { type: "azure-native:eventgrid/v20231215preview:NamespaceTopic" }, { type: "azure-native:eventgrid/v20241215preview:NamespaceTopic" }, { type: "azure-native:eventgrid/v20250215:NamespaceTopic" }, { type: "azure-native:eventgrid:NamespaceTopic" }] };
...
export interface NamespaceTopicArgs {
     ...
     * This determines the format that is expected for incoming events published to the topic.
     */
    inputSchema?: pulumi.Input<string | enums.eventgrid.v20240601preview.EventInputSchema>;
    /**
     ...
     * Publisher type of the namespace topic.
     */
    publisherType?: pulumi.Input<string | enums.eventgrid.v20240601preview.PublisherType>;
    /**
