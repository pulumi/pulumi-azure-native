 ...
 * EventGrid Domain.
 *
 * @deprecated azure-native:eventgrid/v20201015preview:Domain is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20211015preview:Domain to guarantee forwards compatibility.
 */
export class Domain extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Domain {
        pulumi.log.warn("Domain is deprecated: azure-native:eventgrid/v20201015preview:Domain is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20211015preview:Domain to guarantee forwards compatibility.")
        return new Domain(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20201015preview:Domain';
