...
export class PartnerTopicEventSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PartnerTopicEventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:PartnerTopicEventSubscription" }, { type: "azure-nextgen:eventgrid:PartnerTopicEventSubscription" }, { type: "azure-native:eventgrid/v20200401preview:PartnerTopicEventSubscription" }, { type: "azure-nextgen:eventgrid/v20200401preview:PartnerTopicEventSubscription" }] };
...
export interface PartnerTopicEventSubscriptionArgs {
     ...
     * The event delivery schema for the event subscription.
     */
    readonly eventDeliverySchema?: pulumi.Input<string | enums.eventgrid.v20201015preview.EventDeliverySchema>;
    /**
