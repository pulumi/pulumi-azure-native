...
export class EventChannel extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EventChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20200401preview:EventChannel" }, { type: "azure-native:eventgrid/v20210601preview:EventChannel" }, { type: "azure-native:eventgrid/v20211015preview:EventChannel" }] };
