...
export class EventChannel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20201015preview:EventChannel';
     ...
     */
    public readonly destination!: pulumi.Output<outputs.eventgrid.v20201015preview.EventChannelDestinationResponse | undefined>;
    /**
     ...
     */
    public readonly filter!: pulumi.Output<outputs.eventgrid.v20201015preview.EventChannelFilterResponse | undefined>;
    /**
    ...
    constructor(name: string, args: EventChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventgrid/v20201015preview:EventChannel" }, { type: "azure-native:eventgrid:EventChannel" }, { type: "azure-nextgen:eventgrid:EventChannel" }, { type: "azure-native:eventgrid/v20200401preview:EventChannel" }, { type: "azure-nextgen:eventgrid/v20200401preview:EventChannel" }] };
...
export interface EventChannelArgs {
     ...
     * Represents the destination of an event channel.
     */
    destination?: pulumi.Input<inputs.eventgrid.v20201015preview.EventChannelDestinationArgs>;
    /**
     ...
     * Information about the filter for the event channel.
     */
    filter?: pulumi.Input<inputs.eventgrid.v20201015preview.EventChannelFilterArgs>;
    /**
     ...
     * Source of the event channel. This represents a unique resource in the partner's resource model.
     */
    source?: pulumi.Input<inputs.eventgrid.v20201015preview.EventChannelSourceArgs>;
}
