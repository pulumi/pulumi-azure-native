 ...
 * Domain Topic.
 *
 * @deprecated azure-native:eventgrid/v20201015preview:DomainTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainTopic to guarantee forwards compatibility.
 */
export class DomainTopic extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DomainTopic {
        pulumi.log.warn("DomainTopic is deprecated: azure-native:eventgrid/v20201015preview:DomainTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainTopic to guarantee forwards compatibility.")
