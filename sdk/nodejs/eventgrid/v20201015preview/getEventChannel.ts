...
export function getEventChannel(args: GetEventChannelArgs, opts?: pulumi.InvokeOptions): Promise<GetEventChannelResult> {
    pulumi.log.warn("getEventChannel is deprecated: azure-native:eventgrid/v20201015preview:EventChannel is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20211015preview:EventChannel to guarantee forwards compatibility.")
