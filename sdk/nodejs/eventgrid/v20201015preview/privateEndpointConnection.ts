...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:eventgrid/v20201015preview:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventgrid:PrivateEndpointConnection" }, { type: "azure-nextgen:eventgrid/latest:PrivateEndpointConnection" }, { type: "azure-nextgen:eventgrid/v20200401preview:PrivateEndpointConnection" }, { type: "azure-nextgen:eventgrid/v20200601:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * The Private Endpoint resource for this Connection.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.eventgrid.v20201015preview.PrivateEndpoint>;
    /**
     ...
     * Details about the state of the connection.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.eventgrid.v20201015preview.ConnectionState>;
    /**
     * Provisioning state of the Private Endpoint Connection.
     */
