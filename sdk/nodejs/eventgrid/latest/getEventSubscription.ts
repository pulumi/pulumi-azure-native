...
export function getEventSubscription(args: GetEventSubscriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetEventSubscriptionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:eventgrid/latest:getEventSubscription", {
...
export interface GetEventSubscriptionResult {
     ...
     */
    readonly deadLetterDestination?: outputs.eventgrid.latest.DeadLetterDestinationResponse;
    /**
     * Information about the destination where events have to be delivered for the event subscription.
     */
    readonly destination?: outputs.eventgrid.latest.EventSubscriptionDestinationResponse;
    /**
