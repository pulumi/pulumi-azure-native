...
export class SystemTopic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20241215preview:SystemTopic';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.eventgrid.v20241215preview.IdentityInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SystemTopicArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:SystemTopic" }, { type: "azure-native:eventgrid/v20200401preview:SystemTopic" }, { type: "azure-native:eventgrid/v20201015preview:SystemTopic" }, { type: "azure-native:eventgrid/v20210601preview:SystemTopic" }, { type: "azure-native:eventgrid/v20211015preview:SystemTopic" }, { type: "azure-native:eventgrid/v20211201:SystemTopic" }, { type: "azure-native:eventgrid/v20220615:SystemTopic" }, { type: "azure-native:eventgrid/v20230601preview:SystemTopic" }, { type: "azure-native:eventgrid/v20231215preview:SystemTopic" }, { type: "azure-native:eventgrid/v20240601preview:SystemTopic" }] };
...
export interface SystemTopicArgs {
     ...
     * Identity information for the resource.
     */
    identity?: pulumi.Input<inputs.eventgrid.v20241215preview.IdentityInfoArgs>;
    /**
     * Location of the resource.
     */
