...
export class PartnerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20241215preview:PartnerConfiguration';
     ...
     */
    public readonly partnerAuthorization!: pulumi.Output<outputs.eventgrid.v20241215preview.PartnerAuthorizationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PartnerConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20211015preview:PartnerConfiguration" }, { type: "azure-native:eventgrid/v20220615:PartnerConfiguration" }, { type: "azure-native:eventgrid/v20230601preview:PartnerConfiguration" }, { type: "azure-native:eventgrid/v20231215preview:PartnerConfiguration" }, { type: "azure-native:eventgrid/v20240601preview:PartnerConfiguration" }, { type: "azure-native:eventgrid/v20250215:PartnerConfiguration" }, { type: "azure-native:eventgrid:PartnerConfiguration" }] };
...
export interface PartnerConfigurationArgs {
     ...
     * The details of authorized partners.
     */
    partnerAuthorization?: pulumi.Input<inputs.eventgrid.v20241215preview.PartnerAuthorizationArgs>;
    /**
     * Provisioning state of the partner configuration.
     */
    provisioningState?: pulumi.Input<string | enums.eventgrid.v20241215preview.PartnerConfigurationProvisioningState>;
    /**
