 ...
 *
 * const domainTopic = new azurerm.eventgrid.v20190201preview.DomainTopic("domainTopic", {
...
export class DomainTopic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventgrid/v20190201preview:DomainTopic';
    ...
    constructor(name: string, args: DomainTopicArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventgrid/latest:DomainTopic" }, { type: "azurerm:eventgrid/v20190601:DomainTopic" }, { type: "azurerm:eventgrid/v20200101preview:DomainTopic" }, { type: "azurerm:eventgrid/v20200401preview:DomainTopic" }, { type: "azurerm:eventgrid/v20200601:DomainTopic" }] };
