...
export class EventSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["filter"] = args ? (args.filter ? pulumi.output(args.filter).apply(inputs.eventgrid.v20190201preview.eventSubscriptionFilterArgsProvideDefaults) : undefined) : undefined;
