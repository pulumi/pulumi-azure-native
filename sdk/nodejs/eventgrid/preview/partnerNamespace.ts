...
export class PartnerNamespace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventgrid/preview:PartnerNamespace';
    ...
    constructor(name: string, argsOrState?: PartnerNamespaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventgrid/v20200401preview:PartnerNamespace" }] };
