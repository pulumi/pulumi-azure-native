...
export class EventChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EventChannel {
        return new EventChannel(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventgrid/preview:EventChannel';
     ...
     */
    public readonly destination!: pulumi.Output<outputs.eventgrid.preview.EventChannelDestinationResponse | undefined>;
    /**
     ...
     */
    public readonly filter!: pulumi.Output<outputs.eventgrid.preview.EventChannelFilterResponse | undefined>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<outputs.eventgrid.preview.EventChannelSourceResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: EventChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventgrid/v20200401preview:EventChannel" }] };
...
export interface EventChannelArgs {
     ...
     * Represents the destination of an event channel.
     */
    readonly destination?: pulumi.Input<inputs.eventgrid.preview.EventChannelDestination>;
    /**
     ...
     * Information about the filter for the event channel.
     */
    readonly filter?: pulumi.Input<inputs.eventgrid.preview.EventChannelFilter>;
    /**
     ...
     * Source of the event channel. This represents a unique resource in the partner's resource model.
     */
    readonly source?: pulumi.Input<inputs.eventgrid.preview.EventChannelSource>;
}
