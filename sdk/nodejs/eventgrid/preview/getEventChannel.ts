...
export function getEventChannel(args: GetEventChannelArgs, opts?: pulumi.InvokeOptions): Promise<GetEventChannelResult> {
    ...
    return pulumi.runtime.invoke("azurerm:eventgrid/preview:getEventChannel", {
...
export interface GetEventChannelResult {
     ...
     */
    readonly destination?: outputs.eventgrid.preview.EventChannelDestinationResponse;
    /**
     ...
     */
    readonly filter?: outputs.eventgrid.preview.EventChannelFilterResponse;
    /**
     ...
     */
    readonly source?: outputs.eventgrid.preview.EventChannelSourceResponse;
    /**
