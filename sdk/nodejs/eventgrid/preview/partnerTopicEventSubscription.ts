...
export class PartnerTopicEventSubscription extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PartnerTopicEventSubscription {
        return new PartnerTopicEventSubscription(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventgrid/preview:PartnerTopicEventSubscription';
    ...
    constructor(name: string, argsOrState?: PartnerTopicEventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as PartnerTopicEventSubscriptionArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventgrid/v20200401preview:PartnerTopicEventSubscription" }] };
