...
export class EventSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventgrid/preview:EventSubscription';
     ...
     */
    public readonly deadLetterDestination!: pulumi.Output<outputs.eventgrid.preview.StorageBlobDeadLetterDestinationResponse | undefined>;
    /**
     * Information about the destination where events have to be delivered for the event subscription.
     */
    public readonly destination!: pulumi.Output<outputs.eventgrid.preview.AzureFunctionEventSubscriptionDestinationResponse | outputs.eventgrid.preview.EventHubEventSubscriptionDestinationResponse | outputs.eventgrid.preview.HybridConnectionEventSubscriptionDestinationResponse | outputs.eventgrid.preview.ServiceBusQueueEventSubscriptionDestinationResponse | outputs.eventgrid.preview.ServiceBusTopicEventSubscriptionDestinationResponse | outputs.eventgrid.preview.StorageQueueEventSubscriptionDestinationResponse | outputs.eventgrid.preview.WebHookEventSubscriptionDestinationResponse | undefined>;
    /**
     ...
     */
    public readonly filter!: pulumi.Output<outputs.eventgrid.preview.EventSubscriptionFilterResponse | undefined>;
    /**
     ...
     */
    public readonly retryPolicy!: pulumi.Output<outputs.eventgrid.preview.RetryPolicyResponse | undefined>;
    /**
...
export interface EventSubscriptionArgs {
     ...
     * The DeadLetter destination of the event subscription.
     */
    readonly deadLetterDestination?: pulumi.Input<inputs.eventgrid.preview.StorageBlobDeadLetterDestination>;
    /**
     * Information about the destination where events have to be delivered for the event subscription.
     */
    readonly destination?: pulumi.Input<inputs.eventgrid.preview.AzureFunctionEventSubscriptionDestination | inputs.eventgrid.preview.EventHubEventSubscriptionDestination | inputs.eventgrid.preview.HybridConnectionEventSubscriptionDestination | inputs.eventgrid.preview.ServiceBusQueueEventSubscriptionDestination | inputs.eventgrid.preview.ServiceBusTopicEventSubscriptionDestination | inputs.eventgrid.preview.StorageQueueEventSubscriptionDestination | inputs.eventgrid.preview.WebHookEventSubscriptionDestination>;
    /**
     * The event delivery schema for the event subscription.
     */
     ...
     * Information about the filter for the event subscription.
     */
    readonly filter?: pulumi.Input<inputs.eventgrid.preview.EventSubscriptionFilter>;
    /**
     * List of user defined labels.
     */
     ...
     * The retry policy for events. This can be used to configure maximum number of delivery attempts and time to live for events.
     */
    readonly retryPolicy?: pulumi.Input<inputs.eventgrid.preview.RetryPolicy>;
    /**
