...
export class EventChannel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:eventgrid:EventChannel';
    ...
    constructor(name: string, args: EventChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventgrid/v20200401preview:EventChannel" }, { type: "azure-nextgen:eventgrid/v20201015preview:EventChannel" }] };
...
export interface EventChannelArgs {
     ...
     * Represents the destination of an event channel.
     */
    readonly destination?: pulumi.Input<inputs.eventgrid.EventChannelDestination>;
    /**
     ...
     * Information about the filter for the event channel.
     */
    readonly filter?: pulumi.Input<inputs.eventgrid.EventChannelFilter>;
    /**
     ...
     * Source of the event channel. This represents a unique resource in the partner's resource model.
     */
    readonly source?: pulumi.Input<inputs.eventgrid.EventChannelSource>;
}
