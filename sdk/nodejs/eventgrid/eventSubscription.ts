...
export class EventSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/latest:EventSubscription" }, { type: "azure-nextgen:eventgrid/latest:EventSubscription" }, { type: "azure-native:eventgrid/v20170615preview:EventSubscription" }, { type: "azure-nextgen:eventgrid/v20170615preview:EventSubscription" }, { type: "azure-native:eventgrid/v20170915preview:EventSubscription" }, { type: "azure-nextgen:eventgrid/v20170915preview:EventSubscription" }, { type: "azure-native:eventgrid/v20180101:EventSubscription" }, { type: "azure-nextgen:eventgrid/v20180101:EventSubscription" }, { type: "azure-native:eventgrid/v20180501preview:EventSubscription" }, { type: "azure-nextgen:eventgrid/v20180501preview:EventSubscription" }, { type: "azure-native:eventgrid/v20180915preview:EventSubscription" }, { type: "azure-nextgen:eventgrid/v20180915preview:EventSubscription" }, { type: "azure-native:eventgrid/v20190101:EventSubscription" }, { type: "azure-nextgen:eventgrid/v20190101:EventSubscription" }, { type: "azure-native:eventgrid/v20190201preview:EventSubscription" }, { type: "azure-nextgen:eventgrid/v20190201preview:EventSubscription" }, { type: "azure-native:eventgrid/v20190601:EventSubscription" }, { type: "azure-nextgen:eventgrid/v20190601:EventSubscription" }, { type: "azure-native:eventgrid/v20200101preview:EventSubscription" }, { type: "azure-nextgen:eventgrid/v20200101preview:EventSubscription" }, { type: "azure-native:eventgrid/v20200401preview:EventSubscription" }, { type: "azure-nextgen:eventgrid/v20200401preview:EventSubscription" }, { type: "azure-native:eventgrid/v20200601:EventSubscription" }, { type: "azure-nextgen:eventgrid/v20200601:EventSubscription" }, { type: "azure-native:eventgrid/v20201015preview:EventSubscription" }, { type: "azure-nextgen:eventgrid/v20201015preview:EventSubscription" }] };
...
export interface EventSubscriptionArgs {
     ...
     * The DeadLetter destination of the event subscription.
     */
    readonly deadLetterDestination?: pulumi.Input<inputs.eventgrid.StorageBlobDeadLetterDestination>;
    /**
     * Information about the destination where events have to be delivered for the event subscription.
     */
    readonly destination?: pulumi.Input<inputs.eventgrid.AzureFunctionEventSubscriptionDestination | inputs.eventgrid.EventHubEventSubscriptionDestination | inputs.eventgrid.HybridConnectionEventSubscriptionDestination | inputs.eventgrid.ServiceBusQueueEventSubscriptionDestination | inputs.eventgrid.ServiceBusTopicEventSubscriptionDestination | inputs.eventgrid.StorageQueueEventSubscriptionDestination | inputs.eventgrid.WebHookEventSubscriptionDestination>;
    /**
     * The event delivery schema for the event subscription.
     */
    readonly eventDeliverySchema?: pulumi.Input<string | enums.eventgrid.EventDeliverySchema>;
    /**
     ...
     * Information about the filter for the event subscription.
     */
    readonly filter?: pulumi.Input<inputs.eventgrid.EventSubscriptionFilter>;
    /**
     * List of user defined labels.
     */
     ...
     * The retry policy for events. This can be used to configure maximum number of delivery attempts and time to live for events.
     */
    readonly retryPolicy?: pulumi.Input<inputs.eventgrid.RetryPolicy>;
    /**
