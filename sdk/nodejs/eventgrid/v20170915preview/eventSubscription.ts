...
export class EventSubscription extends pulumi.CustomResource {
     ...
     */
    public readonly destination!: pulumi.Output<outputs.eventgrid.v20170915preview.EventSubscriptionDestinationResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: EventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventgrid/latest:EventSubscription" }, { type: "azurerm:eventgrid/preview:EventSubscription" }, { type: "azurerm:eventgrid/v20170615preview:EventSubscription" }, { type: "azurerm:eventgrid/v20180101:EventSubscription" }, { type: "azurerm:eventgrid/v20180501preview:EventSubscription" }, { type: "azurerm:eventgrid/v20180915preview:EventSubscription" }, { type: "azurerm:eventgrid/v20190101:EventSubscription" }, { type: "azurerm:eventgrid/v20190201preview:EventSubscription" }, { type: "azurerm:eventgrid/v20190601:EventSubscription" }, { type: "azurerm:eventgrid/v20200101preview:EventSubscription" }, { type: "azurerm:eventgrid/v20200401preview:EventSubscription" }, { type: "azurerm:eventgrid/v20200601:EventSubscription" }] };
...
export interface EventSubscriptionArgs {
     ...
     * Information about the destination where events have to be delivered for the event subscription.
     */
    readonly destination?: pulumi.Input<inputs.eventgrid.v20170915preview.EventSubscriptionDestination>;
    /**
