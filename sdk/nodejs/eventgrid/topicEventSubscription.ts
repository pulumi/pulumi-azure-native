...
export class TopicEventSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TopicEventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20220615:TopicEventSubscription" }, { type: "azure-native:eventgrid/v20230601preview:TopicEventSubscription" }, { type: "azure-native:eventgrid/v20231215preview:TopicEventSubscription" }, { type: "azure-native:eventgrid/v20240601preview:TopicEventSubscription" }, { type: "azure-native:eventgrid/v20241215preview:TopicEventSubscription" }, { type: "azure-native_eventgrid_v20211015preview:eventgrid:TopicEventSubscription" }, { type: "azure-native_eventgrid_v20220615:eventgrid:TopicEventSubscription" }, { type: "azure-native_eventgrid_v20230601preview:eventgrid:TopicEventSubscription" }, { type: "azure-native_eventgrid_v20231215preview:eventgrid:TopicEventSubscription" }, { type: "azure-native_eventgrid_v20240601preview:eventgrid:TopicEventSubscription" }, { type: "azure-native_eventgrid_v20241215preview:eventgrid:TopicEventSubscription" }, { type: "azure-native_eventgrid_v20250215:eventgrid:TopicEventSubscription" }] };
