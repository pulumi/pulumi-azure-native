...
export class NamespaceTopicEventSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20250215:NamespaceTopicEventSubscription';
     ...
     */
    public readonly deliveryConfiguration!: pulumi.Output<outputs.eventgrid.v20250215.DeliveryConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly filtersConfiguration!: pulumi.Output<outputs.eventgrid.v20250215.FiltersConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: NamespaceTopicEventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20230601preview:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid/v20231215preview:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid/v20240601preview:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid/v20241215preview:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid:NamespaceTopicEventSubscription" }] };
...
export interface NamespaceTopicEventSubscriptionArgs {
     ...
     * Information about the delivery configuration of the event subscription.
     */
    deliveryConfiguration?: pulumi.Input<inputs.eventgrid.v20250215.DeliveryConfigurationArgs>;
    /**
     * The event delivery schema for the event subscription.
     */
    eventDeliverySchema?: pulumi.Input<string | enums.eventgrid.v20250215.DeliverySchema>;
    /**
     ...
     * Information about the filter for the event subscription.
     */
    filtersConfiguration?: pulumi.Input<inputs.eventgrid.v20250215.FiltersConfigurationArgs>;
    /**
