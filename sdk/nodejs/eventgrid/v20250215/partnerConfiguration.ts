...
export class PartnerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20250215:PartnerConfiguration';
     ...
     */
    public readonly partnerAuthorization!: pulumi.Output<outputs.eventgrid.v20250215.PartnerAuthorizationResponse | undefined>;
    /**
...
export interface PartnerConfigurationArgs {
     ...
     * The details of authorized partners.
     */
    partnerAuthorization?: pulumi.Input<inputs.eventgrid.v20250215.PartnerAuthorizationArgs>;
    /**
     * Provisioning state of the partner configuration.
     */
    provisioningState?: pulumi.Input<string | enums.eventgrid.v20250215.PartnerConfigurationProvisioningState>;
    /**
