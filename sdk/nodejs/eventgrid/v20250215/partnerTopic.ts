...
export class PartnerTopic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20250215:PartnerTopic';
...
export interface PartnerTopicArgs {
     ...
     * Activation state of the partner topic.
     */
    activationState?: pulumi.Input<string | enums.eventgrid.v20250215.PartnerTopicActivationState>;
    /**
     * Event Type information from the corresponding event channel.
     */
