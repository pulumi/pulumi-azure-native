...
export class DomainTopicEventSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DomainTopicEventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20211015preview:DomainTopicEventSubscription" }, { type: "azure-native:eventgrid/v20220615:DomainTopicEventSubscription" }, { type: "azure-native:eventgrid/v20230601preview:DomainTopicEventSubscription" }, { type: "azure-native:eventgrid/v20231215preview:DomainTopicEventSubscription" }, { type: "azure-native:eventgrid/v20240601preview:DomainTopicEventSubscription" }, { type: "azure-native:eventgrid/v20241215preview:DomainTopicEventSubscription" }, { type: "azure-native:eventgrid/v20250215:DomainTopicEventSubscription" }, { type: "azure-native:eventgrid/v20250401preview:DomainTopicEventSubscription" }, { type: "azure-native:eventgrid/v20250715preview:DomainTopicEventSubscription" }, { type: "azure-native:eventgrid/v20251115preview:DomainTopicEventSubscription" }] };
