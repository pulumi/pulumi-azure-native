...
export class Volume extends pulumi.CustomResource {
     ...
     * Volume properties
     */
    public readonly properties!: pulumi.Output<outputs.netapp.v20200201.VolumePropertiesResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: VolumeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.netapp.v20200201.volumePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface VolumeArgs {
     ...
     * Volume properties
     */
    properties: pulumi.Input<inputs.netapp.v20200201.VolumePropertiesArgs>;
    /**
