...
export function getBackup(args: GetBackupArgs, opts?: pulumi.InvokeOptions): Promise<GetBackupResult> {
    pulumi.log.warn("getBackup is deprecated: Version 2020-09-01 will be removed in v2 of the provider.")
...
export interface GetBackupResult {
     ...
     * Backup Properties
     */
    readonly properties: outputs.netapp.v20200901.BackupPropertiesResponse;
    /**
     * Resource type
     */
