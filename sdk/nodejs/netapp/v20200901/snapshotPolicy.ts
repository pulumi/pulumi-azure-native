...
export class SnapshotPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:netapp/v20200901:SnapshotPolicy';
     ...
     */
    public readonly dailySchedule!: pulumi.Output<outputs.netapp.v20200901.DailyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly hourlySchedule!: pulumi.Output<outputs.netapp.v20200901.HourlyScheduleResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly monthlySchedule!: pulumi.Output<outputs.netapp.v20200901.MonthlyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly weeklySchedule!: pulumi.Output<outputs.netapp.v20200901.WeeklyScheduleResponse | undefined>;
    ...
    constructor(name: string, args: SnapshotPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:netapp/latest:SnapshotPolicy" }, { type: "azure-nextgen:netapp/v20200501:SnapshotPolicy" }, { type: "azure-nextgen:netapp/v20200601:SnapshotPolicy" }, { type: "azure-nextgen:netapp/v20200701:SnapshotPolicy" }, { type: "azure-nextgen:netapp/v20200801:SnapshotPolicy" }] };
...
export interface SnapshotPolicyArgs {
     ...
     * Schedule for daily snapshots
     */
    readonly dailySchedule?: pulumi.Input<inputs.netapp.v20200901.DailySchedule>;
    /**
     * The property to decide policy is enabled or not
     */
     ...
     * Schedule for hourly snapshots
     */
    readonly hourlySchedule?: pulumi.Input<inputs.netapp.v20200901.HourlySchedule>;
    /**
     * Resource location
     */
     ...
     * Schedule for monthly snapshots
     */
    readonly monthlySchedule?: pulumi.Input<inputs.netapp.v20200901.MonthlySchedule>;
    /**
     ...
     * Schedule for weekly snapshots
     */
    readonly weeklySchedule?: pulumi.Input<inputs.netapp.v20200901.WeeklySchedule>;
}
