...
export function getPool(args: GetPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetPoolResult> {
    pulumi.log.warn("getPool is deprecated: Version 2020-06-01 will be removed in v2 of the provider.")
...
export interface GetPoolResult {
     ...
     */
    readonly properties: outputs.netapp.v20200601.PoolPropertiesResponse;
    /**
     * Resource tags
     */
