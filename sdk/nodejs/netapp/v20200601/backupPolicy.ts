...
export class BackupPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:netapp/v20200601:backupPolicy';
    ...
    constructor(name: string, argsOrState?: BackupPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:netapp/latest:backupPolicy" }, { type: "azurerm:netapp/preview:backupPolicy" }] };
