...
export function getBackupPolicy(args: GetBackupPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetBackupPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-native:netapp/v20231101preview:getBackupPolicy", {
...
export interface GetBackupPolicyResult {
     ...
     */
    readonly systemData: outputs.netapp.v20231101preview.SystemDataResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly volumeBackups: outputs.netapp.v20231101preview.VolumeBackupsResponse[];
    /**
...
export function getBackupPolicyOutput(args: GetBackupPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBackupPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:netapp/v20231101preview:getBackupPolicy", {
        "accountName": args.accountName,
        "backupPolicyName": args.backupPolicyName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
