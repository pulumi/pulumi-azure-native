...
export class Volume extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VolumeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.netapp.v20191001.volumePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface VolumeArgs {
     ...
     * Volume properties
     */
    properties: pulumi.Input<inputs.netapp.v20191001.VolumePropertiesArgs>;
    /**
