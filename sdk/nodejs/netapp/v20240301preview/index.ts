...
// Export enums:
export * from "../../types/enums/netapp/v20240301preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:netapp/v20240301preview:Account":
                return new Account(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240301preview:Backup":
                return new Backup(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240301preview:BackupPolicy":
                return new BackupPolicy(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240301preview:BackupVault":
                return new BackupVault(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240301preview:CapacityPoolPool":
                return new CapacityPoolPool(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240301preview:CapacityPoolSnapshot":
                return new CapacityPoolSnapshot(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240301preview:CapacityPoolSubvolume":
                return new CapacityPoolSubvolume(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240301preview:CapacityPoolVolume":
                return new CapacityPoolVolume(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240301preview:CapacityPoolVolumeQuotaRule":
                return new CapacityPoolVolumeQuotaRule(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240301preview:SnapshotPolicy":
                return new SnapshotPolicy(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240301preview:VolumeGroup":
...
pulumi.runtime.registerResourceModule("azure-native", "netapp/v20240301preview", _module)
