...
export class Volume extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20220501:Volume';
     ...
     * Volume properties
     */
    public readonly properties!: pulumi.Output<outputs.netapp.v20220501.VolumePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: VolumeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.netapp.v20220501.volumePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface VolumeArgs {
     ...
     * Volume properties
     */
    properties: pulumi.Input<inputs.netapp.v20220501.VolumePropertiesArgs>;
    /**
