...
export class VolumeQuotaRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VolumeQuotaRule {
        pulumi.log.warn("VolumeQuotaRule is deprecated: azure-native:netapp/v20220501:VolumeQuotaRule is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:VolumeQuotaRule to guarantee forwards compatibility.")
