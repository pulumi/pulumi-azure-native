...
export class SnapshotPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.netapp.v20220501.SnapshotPolicyPropertiesResponse>;
    /**
...
export interface SnapshotPolicyArgs {
     ...
     * Snapshot policy Properties
     */
    properties: pulumi.Input<inputs.netapp.v20220501.SnapshotPolicyPropertiesArgs>;
    /**
