...
export function getSnapshotPolicy(args: GetSnapshotPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetSnapshotPolicyResult> {
    pulumi.log.warn("getSnapshotPolicy is deprecated: Version 2020-11-01 will be removed in v2 of the provider.")
...
export interface GetSnapshotPolicyResult {
     ...
     */
    readonly properties: outputs.netapp.v20201101.SnapshotPolicyPropertiesResponse;
    /**
     * Resource tags
     */
