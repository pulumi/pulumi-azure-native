...
export class BackupPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackupPolicy {
        pulumi.log.warn("BackupPolicy is deprecated: Version 2020-11-01 will be removed in v2 of the provider.")
     ...
     */
    public readonly properties!: pulumi.Output<outputs.netapp.v20201101.BackupPolicyPropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface BackupPolicyArgs {
     ...
     * Backup policy Properties
     */
    properties: pulumi.Input<inputs.netapp.v20201101.BackupPolicyPropertiesArgs>;
    /**
