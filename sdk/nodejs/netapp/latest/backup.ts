...
export class Backup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:netapp/latest:Backup';
    ...
    constructor(name: string, argsOrState?: BackupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:netapp/preview:Backup" }, { type: "azurerm:netapp/v20200601:Backup" }] };
