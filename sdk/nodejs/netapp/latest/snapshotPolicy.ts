 ...
 *
 * const snapshotPolicy = new azurerm.netapp.latest.SnapshotPolicy("snapshotPolicy", {
...
export class SnapshotPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:netapp/latest:snapshotPolicy';
    ...
    constructor(name: string, argsOrState?: SnapshotPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:netapp/v20200601:snapshotPolicy" }] };
