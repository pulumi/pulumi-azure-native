...
export class BackupPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/latest:BackupPolicy';
     ...
     */
    public readonly volumeBackups!: pulumi.Output<outputs.netapp.latest.VolumeBackupsResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: BackupPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:netapp:BackupPolicy" }, { type: "azure-nextgen:netapp:BackupPolicy" }, { type: "azure-native:netapp/v20200501:BackupPolicy" }, { type: "azure-nextgen:netapp/v20200501:BackupPolicy" }, { type: "azure-native:netapp/v20200601:BackupPolicy" }, { type: "azure-nextgen:netapp/v20200601:BackupPolicy" }, { type: "azure-native:netapp/v20200701:BackupPolicy" }, { type: "azure-nextgen:netapp/v20200701:BackupPolicy" }, { type: "azure-native:netapp/v20200801:BackupPolicy" }, { type: "azure-nextgen:netapp/v20200801:BackupPolicy" }, { type: "azure-native:netapp/v20200901:BackupPolicy" }, { type: "azure-nextgen:netapp/v20200901:BackupPolicy" }, { type: "azure-native:netapp/v20201101:BackupPolicy" }, { type: "azure-nextgen:netapp/v20201101:BackupPolicy" }] };
...
export interface BackupPolicyArgs {
     ...
     * A list of volumes assigned to this policy
     */
    readonly volumeBackups?: pulumi.Input<pulumi.Input<inputs.netapp.latest.VolumeBackups>[]>;
    /**
     * Volumes using current backup policy
     */
