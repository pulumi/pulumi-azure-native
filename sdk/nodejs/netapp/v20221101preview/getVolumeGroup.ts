...
export interface GetVolumeGroupResult {
     ...
     */
    readonly groupMetaData?: outputs.netapp.v20221101preview.VolumeGroupMetaDataResponse;
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly volumes?: outputs.netapp.v20221101preview.VolumeGroupVolumePropertiesResponse[];
}
/**
 * Get details of the specified volume group
 */
export function getVolumeGroupOutput(args: GetVolumeGroupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetVolumeGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:netapp/v20221101preview:getVolumeGroup", {
        "accountName": args.accountName,
        "resourceGroupName": args.resourceGroupName,
        "volumeGroupName": args.volumeGroupName,
    }, opts);
