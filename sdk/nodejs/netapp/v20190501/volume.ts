...
export class Volume extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: VolumeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:netapp/latest:Volume" }, { type: "azurerm:netapp/v20190601:Volume" }, { type: "azurerm:netapp/v20190701:Volume" }, { type: "azurerm:netapp/v20190801:Volume" }, { type: "azurerm:netapp/v20191001:Volume" }, { type: "azurerm:netapp/v20191101:Volume" }, { type: "azurerm:netapp/v20200201:Volume" }, { type: "azurerm:netapp/v20200601:Volume" }] };
