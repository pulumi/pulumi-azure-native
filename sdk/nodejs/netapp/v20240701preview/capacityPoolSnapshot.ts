...
export class CapacityPoolSnapshot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20240701preview:CapacityPoolSnapshot';
