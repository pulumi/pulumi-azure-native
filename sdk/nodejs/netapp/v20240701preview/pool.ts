...
export class Pool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20240701preview:Pool';
    ...
    constructor(name: string, args: PoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["customThroughputMibps"] = undefined /*out*/;
...
export interface PoolArgs {
     ...
     * Encryption type of the capacity pool, set encryption type for data at rest for this pool and all volumes in it. This value can only be set when creating new pool.
     */
    encryptionType?: pulumi.Input<string | enums.netapp.v20240701preview.EncryptionType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The qos type of the pool
     */
    qosType?: pulumi.Input<string | enums.netapp.v20240701preview.QosType>;
    /**
     ...
     * The service level of the file system
     */
    serviceLevel: pulumi.Input<string | enums.netapp.v20240701preview.ServiceLevel>;
    /**
     * Provisioned size of the pool (in bytes). Allowed values are in 1TiB chunks (value must be multiple of 1099511627776).
     */
