...
export class CapacityPoolSubvolume extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20240701preview:CapacityPoolSubvolume';
