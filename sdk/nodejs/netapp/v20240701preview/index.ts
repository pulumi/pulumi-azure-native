...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "azure-native:netapp/v20240701preview:CapacityPoolSnapshot":
                return new CapacityPoolSnapshot(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240701preview:CapacityPoolSubvolume":
            ...
            case "azure-native:netapp/v20240701preview:CapacityPoolVolumeQuotaRule":
