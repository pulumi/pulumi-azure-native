 ...
 *
 * @deprecated azure-native:netapp/v20210401preview:SnapshotPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:SnapshotPolicy to guarantee forwards compatibility.
 */
export class SnapshotPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SnapshotPolicy {
        pulumi.log.warn("SnapshotPolicy is deprecated: azure-native:netapp/v20210401preview:SnapshotPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:SnapshotPolicy to guarantee forwards compatibility.")
        return new SnapshotPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20210401preview:SnapshotPolicy';
     ...
     */
    public readonly dailySchedule!: pulumi.Output<outputs.netapp.v20210401preview.DailyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly hourlySchedule!: pulumi.Output<outputs.netapp.v20210401preview.HourlyScheduleResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly monthlySchedule!: pulumi.Output<outputs.netapp.v20210401preview.MonthlyScheduleResponse | undefined>;
    /**
     * Resource name
     */
     ...
     */
    public readonly weeklySchedule!: pulumi.Output<outputs.netapp.v20210401preview.WeeklyScheduleResponse | undefined>;
...
export interface SnapshotPolicyArgs {
     ...
     * Schedule for daily snapshots
     */
    dailySchedule?: pulumi.Input<inputs.netapp.v20210401preview.DailyScheduleArgs>;
    /**
     * The property to decide policy is enabled or not
     */
     ...
     * Schedule for hourly snapshots
     */
    hourlySchedule?: pulumi.Input<inputs.netapp.v20210401preview.HourlyScheduleArgs>;
    /**
     * Resource location
     */
     ...
     * Schedule for monthly snapshots
     */
    monthlySchedule?: pulumi.Input<inputs.netapp.v20210401preview.MonthlyScheduleArgs>;
    /**
     ...
     * Schedule for weekly snapshots
     */
    weeklySchedule?: pulumi.Input<inputs.netapp.v20210401preview.WeeklyScheduleArgs>;
}
