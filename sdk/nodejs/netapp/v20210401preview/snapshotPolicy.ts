...
export class SnapshotPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.netapp.v20210401preview.SnapshotPolicyPropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface SnapshotPolicyArgs {
     ...
     * Snapshot policy Properties
     */
    properties: pulumi.Input<inputs.netapp.v20210401preview.SnapshotPolicyPropertiesArgs>;
    /**
