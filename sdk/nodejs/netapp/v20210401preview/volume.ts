 ...
 * Volume resource
 *
 * @deprecated azure-native:netapp/v20210401preview:Volume is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20211001:Volume to guarantee forwards compatibility.
 */
export class Volume extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Volume {
        pulumi.log.warn("Volume is deprecated: azure-native:netapp/v20210401preview:Volume is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20211001:Volume to guarantee forwards compatibility.")
        return new Volume(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20210401preview:Volume';
     ...
     */
    public readonly dataProtection!: pulumi.Output<outputs.netapp.v20210401preview.VolumePropertiesResponseDataProtection | undefined>;
    /**
     ...
     */
    public readonly exportPolicy!: pulumi.Output<outputs.netapp.v20210401preview.VolumePropertiesResponseExportPolicy | undefined>;
    /**
     ...
     */
    public /*out*/ readonly mountTargets!: pulumi.Output<outputs.netapp.v20210401preview.MountTargetPropertiesResponse[]>;
    /**
     * Resource name
     */
...
export interface VolumeArgs {
     ...
     * DataProtection type volumes include an object containing details of the replication
     */
    dataProtection?: pulumi.Input<inputs.netapp.v20210401preview.VolumePropertiesDataProtectionArgs>;
    /**
     * Encryption Key Source. Possible values are: 'Microsoft.NetApp'
     */
     ...
     * Set of export policy rules
     */
    exportPolicy?: pulumi.Input<inputs.netapp.v20210401preview.VolumePropertiesExportPolicyArgs>;
    /**
     * Restoring
     */
     ...
     * Basic network, or Standard features available to the volume.
     */
    networkFeatures?: pulumi.Input<string | enums.netapp.v20210401preview.NetworkFeatures>;
    /**
     ...
     * The security style of volume, default unix, defaults to ntfs for dual protocol or CIFS protocol
     */
    securityStyle?: pulumi.Input<string | enums.netapp.v20210401preview.SecurityStyle>;
    /**
     * The service level of the file system
     */
