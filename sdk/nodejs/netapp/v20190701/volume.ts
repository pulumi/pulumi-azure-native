...
export class Volume extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Volume {
        pulumi.log.warn("Volume is deprecated: Version 2019-07-01 will be removed in v2 of the provider.")
    ...
    constructor(name: string, args: VolumeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.netapp.v20190701.volumePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface VolumeArgs {
     ...
     * Volume properties
     */
    properties: pulumi.Input<inputs.netapp.v20190701.VolumePropertiesArgs>;
    /**
