...
export class Pool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Pool {
        pulumi.log.warn("Pool is deprecated: Version 2019-07-01 will be removed in v2 of the provider.")
    ...
    constructor(name: string, args: PoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.netapp.v20190701.poolPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface PoolArgs {
     ...
     * Capacity pool properties
     */
    properties: pulumi.Input<inputs.netapp.v20190701.PoolPropertiesArgs>;
    /**
