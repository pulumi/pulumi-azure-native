...
export function getBackupPolicy(args: GetBackupPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetBackupPolicyResult> {
    pulumi.log.warn("getBackupPolicy is deprecated: azure-native:netapp/v20210601:BackupPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:BackupPolicy to guarantee forwards compatibility.")
