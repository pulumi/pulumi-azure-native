...
export class Subvolume extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Subvolume {
        pulumi.log.warn("Subvolume is deprecated: azure-native:netapp/v20220901:Subvolume is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:Subvolume to guarantee forwards compatibility.")
