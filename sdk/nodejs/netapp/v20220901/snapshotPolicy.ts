...
export class SnapshotPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly dailySchedule!: pulumi.Output<outputs.netapp.v20220901.DailyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly hourlySchedule!: pulumi.Output<outputs.netapp.v20220901.HourlyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly monthlySchedule!: pulumi.Output<outputs.netapp.v20220901.MonthlyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly weeklySchedule!: pulumi.Output<outputs.netapp.v20220901.WeeklyScheduleResponse | undefined>;
    ...
    constructor(name: string, args: SnapshotPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:netapp:SnapshotPolicy" }, { type: "azure-native:netapp/v20201201:SnapshotPolicy" }, { type: "azure-native:netapp/v20210401:SnapshotPolicy" }, { type: "azure-native:netapp/v20210401preview:SnapshotPolicy" }, { type: "azure-native:netapp/v20211001:SnapshotPolicy" }, { type: "azure-native:netapp/v20220101:SnapshotPolicy" }, { type: "azure-native:netapp/v20220501:SnapshotPolicy" }] };
...
export interface SnapshotPolicyArgs {
     ...
     * Schedule for daily snapshots
     */
    dailySchedule?: pulumi.Input<inputs.netapp.v20220901.DailyScheduleArgs>;
    /**
     * The property to decide policy is enabled or not
     */
     ...
     * Schedule for hourly snapshots
     */
    hourlySchedule?: pulumi.Input<inputs.netapp.v20220901.HourlyScheduleArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Schedule for monthly snapshots
     */
    monthlySchedule?: pulumi.Input<inputs.netapp.v20220901.MonthlyScheduleArgs>;
    /**
     ...
     * Schedule for weekly snapshots
     */
    weeklySchedule?: pulumi.Input<inputs.netapp.v20220901.WeeklyScheduleArgs>;
}
