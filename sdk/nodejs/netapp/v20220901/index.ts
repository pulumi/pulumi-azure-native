...
// Export enums:
export * from "../../types/enums/netapp/v20220901";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:netapp/v20220901:Account":
                return new Account(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220901:BackupPolicy":
                return new BackupPolicy(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220901:CapacityPoolBackup":
                return new CapacityPoolBackup(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220901:CapacityPoolPool":
                return new CapacityPoolPool(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220901:CapacityPoolSnapshot":
                return new CapacityPoolSnapshot(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220901:CapacityPoolSubvolume":
                return new CapacityPoolSubvolume(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220901:CapacityPoolVolume":
                return new CapacityPoolVolume(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220901:CapacityPoolVolumeQuotaRule":
                return new CapacityPoolVolumeQuotaRule(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220901:SnapshotPolicy":
                return new SnapshotPolicy(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220901:VolumeGroup":
...
pulumi.runtime.registerResourceModule("azure-native", "netapp/v20220901", _module)
