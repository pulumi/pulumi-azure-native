...
export function getCapacityPoolVolume(args: GetCapacityPoolVolumeArgs, opts?: pulumi.InvokeOptions): Promise<GetCapacityPoolVolumeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:netapp/v20230501preview:getCapacityPoolVolume", {
...
export interface GetCapacityPoolVolumeResult {
     ...
     */
    readonly dataProtection?: outputs.netapp.v20230501preview.VolumePropertiesResponseDataProtection;
    /**
     ...
     */
    readonly exportPolicy?: outputs.netapp.v20230501preview.VolumePropertiesResponseExportPolicy;
    /**
     ...
     */
    readonly mountTargets: outputs.netapp.v20230501preview.MountTargetPropertiesResponse[];
    /**
     ...
     */
    readonly placementRules?: outputs.netapp.v20230501preview.PlacementKeyValuePairsResponse[];
    /**
...
export function getCapacityPoolVolumeOutput(args: GetCapacityPoolVolumeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCapacityPoolVolumeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:netapp/v20230501preview:getCapacityPoolVolume", {
        "accountName": args.accountName,
        "poolName": args.poolName,
        "resourceGroupName": args.resourceGroupName,
        "volumeName": args.volumeName,
