...
export interface GetVolumeGroupResult {
     ...
     */
    readonly groupMetaData?: outputs.netapp.v20230501preview.VolumeGroupMetaDataResponse;
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly volumes?: outputs.netapp.v20230501preview.VolumeGroupVolumePropertiesResponse[];
}
/**
 * Get details of the specified volume group
 */
export function getVolumeGroupOutput(args: GetVolumeGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVolumeGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:netapp/v20230501preview:getVolumeGroup", {
        "accountName": args.accountName,
        "resourceGroupName": args.resourceGroupName,
        "volumeGroupName": args.volumeGroupName,
    }, opts);
