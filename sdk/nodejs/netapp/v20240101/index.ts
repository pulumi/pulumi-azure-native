...
// Export enums:
export * from "../../types/enums/netapp/v20240101";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:netapp/v20240101:Account":
                return new Account(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240101:Backup":
                return new Backup(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240101:BackupPolicy":
                return new BackupPolicy(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240101:BackupVault":
                return new BackupVault(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240101:CapacityPoolPool":
                return new CapacityPoolPool(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240101:CapacityPoolSnapshot":
                return new CapacityPoolSnapshot(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240101:CapacityPoolSubvolume":
                return new CapacityPoolSubvolume(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240101:CapacityPoolVolume":
                return new CapacityPoolVolume(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240101:CapacityPoolVolumeQuotaRule":
                return new CapacityPoolVolumeQuotaRule(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240101:SnapshotPolicy":
                return new SnapshotPolicy(name, <any>undefined, { urn })
            case "azure-native:netapp/v20240101:VolumeGroup":
...
pulumi.runtime.registerResourceModule("azure-native", "netapp/v20240101", _module)
