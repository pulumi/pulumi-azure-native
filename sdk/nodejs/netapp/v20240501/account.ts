...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20240501:Account';
     ...
     * Active Directories
     */
    public readonly activeDirectories!: pulumi.Output<outputs.netapp.v20240501.ActiveDirectoryResponse[] | undefined>;
    /**
     ...
     * Encryption settings
     */
    public readonly encryption!: pulumi.Output<outputs.netapp.v20240501.AccountEncryptionResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.netapp.v20240501.ManagedServiceIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["encryption"] = args ? (args.encryption ? pulumi.output(args.encryption).apply(inputs.netapp.v20240501.accountEncryptionArgsProvideDefaults) : undefined) : undefined;
...
export interface AccountArgs {
     ...
     * Active Directories
     */
    activeDirectories?: pulumi.Input<pulumi.Input<inputs.netapp.v20240501.ActiveDirectoryArgs>[]>;
    /**
     * Encryption settings
     */
    encryption?: pulumi.Input<inputs.netapp.v20240501.AccountEncryptionArgs>;
    /**
     * The identity used for the resource.
     */
    identity?: pulumi.Input<inputs.netapp.v20240501.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
