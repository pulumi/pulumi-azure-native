...
export class CapacityPoolPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20240501:CapacityPoolPool';
...
export interface CapacityPoolPoolArgs {
     ...
     * Encryption type of the capacity pool, set encryption type for data at rest for this pool and all volumes in it. This value can only be set when creating new pool.
     */
    encryptionType?: pulumi.Input<string | enums.netapp.v20240501.EncryptionType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The qos type of the pool
     */
    qosType?: pulumi.Input<string | enums.netapp.v20240501.QosType>;
    /**
