...
export class CapacityPoolPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp:CapacityPoolPool';
