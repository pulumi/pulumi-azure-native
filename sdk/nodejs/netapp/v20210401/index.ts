...
// Export enums:
export * from "../../types/enums/netapp/v20210401";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "azure-native:netapp/v20210401:CapacityPoolBackup":
                return new CapacityPoolBackup(name, <any>undefined, { urn })
            case "azure-native:netapp/v20210401:CapacityPoolPool":
                return new CapacityPoolPool(name, <any>undefined, { urn })
            case "azure-native:netapp/v20210401:CapacityPoolSnapshot":
                return new CapacityPoolSnapshot(name, <any>undefined, { urn })
            case "azure-native:netapp/v20210401:CapacityPoolVolume":
