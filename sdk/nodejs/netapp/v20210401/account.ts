 ...
 *
 * @deprecated azure-native:netapp/v20210401:Account is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220501:Account to guarantee forwards compatibility.
 */
export class Account extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Account {
        pulumi.log.warn("Account is deprecated: azure-native:netapp/v20210401:Account is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220501:Account to guarantee forwards compatibility.")
        return new Account(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20210401:Account';
     ...
     * Active Directories
     */
    public readonly activeDirectories!: pulumi.Output<outputs.netapp.v20210401.ActiveDirectoryResponse[] | undefined>;
    /**
     * Encryption settings
     */
