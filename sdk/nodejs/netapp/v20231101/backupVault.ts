...
export class BackupVault extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BackupVaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:netapp:BackupVault" }, { type: "azure-native:netapp/v20221101preview:BackupVault" }, { type: "azure-native:netapp/v20230501preview:BackupVault" }, { type: "azure-native:netapp/v20230701preview:BackupVault" }, { type: "azure-native:netapp/v20231101preview:BackupVault" }, { type: "azure-native:netapp/v20240301:BackupVault" }, { type: "azure-native:netapp/v20240301preview:BackupVault" }] };
