...
export function getVolumeGroup(args: GetVolumeGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetVolumeGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:netapp/v20231101:getVolumeGroup", {
...
export interface GetVolumeGroupResult {
     ...
     */
    readonly groupMetaData?: outputs.netapp.v20231101.VolumeGroupMetaDataResponse;
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly volumes?: outputs.netapp.v20231101.VolumeGroupVolumePropertiesResponse[];
}
/**
 * Get details of the specified volume group
 */
export function getVolumeGroupOutput(args: GetVolumeGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVolumeGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:netapp/v20231101:getVolumeGroup", {
        "accountName": args.accountName,
        "resourceGroupName": args.resourceGroupName,
        "volumeGroupName": args.volumeGroupName,
    }, opts);
