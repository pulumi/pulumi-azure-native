 ...
 *
 * @deprecated azure-native:netapp/v20220101:SnapshotPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:SnapshotPolicy to guarantee forwards compatibility.
 */
export class SnapshotPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SnapshotPolicy {
        pulumi.log.warn("SnapshotPolicy is deprecated: azure-native:netapp/v20220101:SnapshotPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:SnapshotPolicy to guarantee forwards compatibility.")
        return new SnapshotPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20220101:SnapshotPolicy';
     ...
     */
    public readonly dailySchedule!: pulumi.Output<outputs.netapp.v20220101.DailyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly hourlySchedule!: pulumi.Output<outputs.netapp.v20220101.HourlyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly monthlySchedule!: pulumi.Output<outputs.netapp.v20220101.MonthlyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly weeklySchedule!: pulumi.Output<outputs.netapp.v20220101.WeeklyScheduleResponse | undefined>;
...
export interface SnapshotPolicyArgs {
     ...
     * Schedule for daily snapshots
     */
    dailySchedule?: pulumi.Input<inputs.netapp.v20220101.DailyScheduleArgs>;
    /**
     * The property to decide policy is enabled or not
     */
     ...
     * Schedule for hourly snapshots
     */
    hourlySchedule?: pulumi.Input<inputs.netapp.v20220101.HourlyScheduleArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Schedule for monthly snapshots
     */
    monthlySchedule?: pulumi.Input<inputs.netapp.v20220101.MonthlyScheduleArgs>;
    /**
     ...
     * Schedule for weekly snapshots
     */
    weeklySchedule?: pulumi.Input<inputs.netapp.v20220101.WeeklyScheduleArgs>;
}
