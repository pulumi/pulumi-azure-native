 ...
 *
 * @deprecated azure-native:netapp/v20220101:Subvolume is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Subvolume to guarantee forwards compatibility.
 */
export class Subvolume extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Subvolume {
        pulumi.log.warn("Subvolume is deprecated: azure-native:netapp/v20220101:Subvolume is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Subvolume to guarantee forwards compatibility.")
        return new Subvolume(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20220101:Subvolume';
    ...
    constructor(name: string, args: SubvolumeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:netapp:Subvolume" }, { type: "azure-native:netapp/v20211001:Subvolume" }, { type: "azure-native:netapp/v20220301:Subvolume" }, { type: "azure-native:netapp/v20220501:Subvolume" }, { type: "azure-native:netapp/v20220901:Subvolume" }] };
