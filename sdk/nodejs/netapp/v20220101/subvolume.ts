...
export class Subvolume extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SubvolumeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:netapp:Subvolume" }, { type: "azure-native:netapp/v20211001:Subvolume" }, { type: "azure-native:netapp/v20220301:Subvolume" }, { type: "azure-native:netapp/v20220501:Subvolume" }] };
