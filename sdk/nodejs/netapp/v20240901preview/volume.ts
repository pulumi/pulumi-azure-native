...
export class Volume extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20240901preview:Volume';
     ...
     */
    public readonly dataProtection!: pulumi.Output<outputs.netapp.v20240901preview.VolumePropertiesResponseDataProtection | undefined>;
    /**
     ...
     */
    public /*out*/ readonly effectiveNetworkFeatures!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly exportPolicy!: pulumi.Output<outputs.netapp.v20240901preview.VolumePropertiesResponseExportPolicy | undefined>;
    /**
     ...
     */
    public /*out*/ readonly mountTargets!: pulumi.Output<outputs.netapp.v20240901preview.MountTargetPropertiesResponse[]>;
    /**
     ...
     */
    public readonly placementRules!: pulumi.Output<outputs.netapp.v20240901preview.PlacementKeyValuePairsResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.netapp.v20240901preview.SystemDataResponse>;
    /**
...
export interface VolumeArgs {
     ...
     * While auto splitting the short term clone volume, if the parent pool does not have enough space to accommodate the volume after split, it will be automatically resized, which will lead to increased billing. To accept capacity pool size auto grow and create a short term clone volume, set the property as accepted.
     */
    acceptGrowCapacityPoolForShortTermCloneSplit?: pulumi.Input<string | enums.netapp.v20240901preview.AcceptGrowCapacityPoolForShortTermCloneSplit>;
    /**
     ...
     * Specifies whether the volume is enabled for Azure VMware Solution (AVS) datastore purpose
     */
    avsDataStore?: pulumi.Input<string | enums.netapp.v20240901preview.AvsDataStore>;
    /**
     * Resource identifier used to identify the Backup.
     */
     ...
     *  Never - No client-driven data is pulled from cool tier to standard storage.
     */
    coolAccessRetrievalPolicy?: pulumi.Input<string | enums.netapp.v20240901preview.CoolAccessRetrievalPolicy>;
    /**
     * coolAccessTieringPolicy determines which cold data blocks are moved to cool tier. The possible values for this field are: Auto - Moves cold user data blocks in both the Snapshot copies and the active file system to the cool tier tier. This policy is the default. SnapshotOnly - Moves user data blocks of the Volume Snapshot copies that are not associated with the active file system to the cool tier.
     */
    coolAccessTieringPolicy?: pulumi.Input<string | enums.netapp.v20240901preview.CoolAccessTieringPolicy>;
    /**
     * Specifies the number of days after which data that is not accessed by clients will be tiered.
     */
     ...
     * DataProtection type volumes include an object containing details of the replication
     */
    dataProtection?: pulumi.Input<inputs.netapp.v20240901preview.VolumePropertiesDataProtectionArgs>;
    /**
     * Default group quota for volume in KiBs. If isDefaultQuotaEnabled is set, the minimum value of 4 KiBs applies.
     */
     ...
     * Flag indicating whether subvolume operations are enabled on the volume
     */
    enableSubvolumes?: pulumi.Input<string | enums.netapp.v20240901preview.EnableSubvolumes>;
    /**
     * Source of key used to encrypt data in volume. Applicable if NetApp account has encryption.keySource = 'Microsoft.KeyVault'. Possible values (case-insensitive) are: 'Microsoft.NetApp, Microsoft.KeyVault'
     */
    encryptionKeySource?: pulumi.Input<string | enums.netapp.v20240901preview.EncryptionKeySource>;
    /**
     * Set of export policy rules
     */
    exportPolicy?: pulumi.Input<inputs.netapp.v20240901preview.VolumePropertiesExportPolicyArgs>;
    /**
     * Specifies if default quota is enabled for the volume.
     */
     ...
     * Language supported for volume.
     */
    language?: pulumi.Input<string | enums.netapp.v20240901preview.VolumeLanguage>;
    /**
     * Specifies whether LDAP is enabled or not for a given NFS volume.
     */
     ...
     * The original value of the network features type available to the volume at the time it was created.
     */
    networkFeatures?: pulumi.Input<string | enums.netapp.v20240901preview.NetworkFeatures>;
    /**
     * Application specific placement rules for the particular volume
     */
    placementRules?: pulumi.Input<pulumi.Input<inputs.netapp.v20240901preview.PlacementKeyValuePairsArgs>[]>;
    /**
     ...
     * The security style of volume, default unix, defaults to ntfs for dual protocol or CIFS protocol
     */
    securityStyle?: pulumi.Input<string | enums.netapp.v20240901preview.SecurityStyle>;
    /**
     * The service level of the file system
     */
    serviceLevel?: pulumi.Input<string | enums.netapp.v20240901preview.ServiceLevel>;
    /**
     * Enables access-based enumeration share property for SMB Shares. Only applicable for SMB/DualProtocol volume
     */
    smbAccessBasedEnumeration?: pulumi.Input<string | enums.netapp.v20240901preview.SmbAccessBasedEnumeration>;
    /**
     * Enables continuously available share property for smb volume. Only applicable for SMB volume
     */
     ...
     * Enables non-browsable property for SMB Shares. Only applicable for SMB/DualProtocol volume
     */
    smbNonBrowsable?: pulumi.Input<string | enums.netapp.v20240901preview.SmbNonBrowsable>;
    /**
     * If enabled (true) the volume will contain a read-only snapshot directory which provides access to each of the volume's snapshots (defaults to true).
     */
