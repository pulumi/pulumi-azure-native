...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20240901preview:Account';
     ...
     * Active Directories
     */
    public readonly activeDirectories!: pulumi.Output<outputs.netapp.v20240901preview.ActiveDirectoryResponse[] | undefined>;
    /**
     ...
     * Encryption settings
     */
    public readonly encryption!: pulumi.Output<outputs.netapp.v20240901preview.AccountEncryptionResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.netapp.v20240901preview.ManagedServiceIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["encryption"] = args ? (args.encryption ? pulumi.output(args.encryption).apply(inputs.netapp.v20240901preview.accountEncryptionArgsProvideDefaults) : undefined) : undefined;
...
export interface AccountArgs {
     ...
     * Active Directories
     */
    activeDirectories?: pulumi.Input<pulumi.Input<inputs.netapp.v20240901preview.ActiveDirectoryArgs>[]>;
    /**
     * Encryption settings
     */
    encryption?: pulumi.Input<inputs.netapp.v20240901preview.AccountEncryptionArgs>;
    /**
     * The identity used for the resource.
     */
    identity?: pulumi.Input<inputs.netapp.v20240901preview.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
