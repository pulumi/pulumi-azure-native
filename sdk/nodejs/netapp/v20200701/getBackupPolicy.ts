...
export function getBackupPolicy(args: GetBackupPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetBackupPolicyResult> {
    pulumi.log.warn("getBackupPolicy is deprecated: Version 2020-07-01 will be removed in v2 of the provider.")
...
export interface GetBackupPolicyResult {
     ...
     */
    readonly properties: outputs.netapp.v20200701.BackupPolicyPropertiesResponse;
    /**
     * Resource tags
     */
