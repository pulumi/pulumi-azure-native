...
export class BackupPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackupPolicy {
        pulumi.log.warn("BackupPolicy is deprecated: azure-native:netapp/v20210801:BackupPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:BackupPolicy to guarantee forwards compatibility.")
     ...
     */
    public /*out*/ readonly volumeBackups!: pulumi.Output<outputs.netapp.v20210801.VolumeBackupsResponse[]>;
    /**
