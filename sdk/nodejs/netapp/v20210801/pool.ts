...
export class Pool extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.netapp.v20210801.PoolPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: PoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.netapp.v20210801.poolPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface PoolArgs {
     ...
     * Capacity pool properties
     */
    properties: pulumi.Input<inputs.netapp.v20210801.PoolPropertiesArgs>;
    /**
