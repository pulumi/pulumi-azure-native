 ...
 *
 * @deprecated azure-native:netapp/v20210801:SnapshotPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:SnapshotPolicy to guarantee forwards compatibility.
 */
export class SnapshotPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SnapshotPolicy {
        pulumi.log.warn("SnapshotPolicy is deprecated: azure-native:netapp/v20210801:SnapshotPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:SnapshotPolicy to guarantee forwards compatibility.")
        return new SnapshotPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20210801:SnapshotPolicy';
     ...
     */
    public readonly dailySchedule!: pulumi.Output<outputs.netapp.v20210801.DailyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly hourlySchedule!: pulumi.Output<outputs.netapp.v20210801.HourlyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly monthlySchedule!: pulumi.Output<outputs.netapp.v20210801.MonthlyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly weeklySchedule!: pulumi.Output<outputs.netapp.v20210801.WeeklyScheduleResponse | undefined>;
