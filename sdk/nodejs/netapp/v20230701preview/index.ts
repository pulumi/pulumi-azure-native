...
// Export enums:
export * from "../../types/enums/netapp/v20230701preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:netapp/v20230701preview:Account":
                return new Account(name, <any>undefined, { urn })
            case "azure-native:netapp/v20230701preview:Backup":
                return new Backup(name, <any>undefined, { urn })
            case "azure-native:netapp/v20230701preview:BackupPolicy":
                return new BackupPolicy(name, <any>undefined, { urn })
            case "azure-native:netapp/v20230701preview:BackupVault":
                return new BackupVault(name, <any>undefined, { urn })
            case "azure-native:netapp/v20230701preview:CapacityPoolPool":
                return new CapacityPoolPool(name, <any>undefined, { urn })
            case "azure-native:netapp/v20230701preview:CapacityPoolSnapshot":
                return new CapacityPoolSnapshot(name, <any>undefined, { urn })
            case "azure-native:netapp/v20230701preview:CapacityPoolSubvolume":
                return new CapacityPoolSubvolume(name, <any>undefined, { urn })
            case "azure-native:netapp/v20230701preview:CapacityPoolVolume":
                return new CapacityPoolVolume(name, <any>undefined, { urn })
            case "azure-native:netapp/v20230701preview:CapacityPoolVolumeQuotaRule":
                return new CapacityPoolVolumeQuotaRule(name, <any>undefined, { urn })
            case "azure-native:netapp/v20230701preview:SnapshotPolicy":
                return new SnapshotPolicy(name, <any>undefined, { urn })
            case "azure-native:netapp/v20230701preview:VolumeGroup":
...
pulumi.runtime.registerResourceModule("azure-native", "netapp/v20230701preview", _module)
