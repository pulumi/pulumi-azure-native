...
export class CapacityPoolPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20221101:CapacityPoolPool';
...
export interface CapacityPoolPoolArgs {
     ...
     * Encryption type of the capacity pool, set encryption type for data at rest for this pool and all volumes in it. This value can only be set when creating new pool.
     */
    encryptionType?: pulumi.Input<string | enums.netapp.v20221101.EncryptionType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The qos type of the pool
     */
    qosType?: pulumi.Input<string | enums.netapp.v20221101.QosType>;
    /**
     ...
     * The service level of the file system
     */
    serviceLevel: pulumi.Input<string | enums.netapp.v20221101.ServiceLevel>;
    /**
     * Provisioned size of the pool (in bytes). Allowed values are in 1TiB chunks (value must be multiply of 4398046511104).
     */
