...
export class Backup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:netapp/preview:Backup';
    ...
    constructor(name: string, argsOrState?: BackupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:netapp/latest:Backup" }, { type: "azurerm:netapp/v20200601:Backup" }] };
