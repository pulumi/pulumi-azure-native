...
export class SnapshotPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:netapp/preview:snapshotPolicy';
    ...
    constructor(name: string, argsOrState?: SnapshotPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:netapp/latest:snapshotPolicy" }, { type: "azurerm:netapp/v20200601:snapshotPolicy" }] };
