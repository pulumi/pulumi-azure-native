...
export class BackupPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:netapp/preview:backupPolicy';
     ...
     */
    public readonly volumeBackups!: pulumi.Output<outputs.netapp.preview.VolumeBackupsResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: BackupPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:netapp/latest:backupPolicy" }, { type: "azurerm:netapp/v20200601:backupPolicy" }] };
...
export interface BackupPolicyArgs {
     ...
     * A list of volumes assigned to this policy
     */
    readonly volumeBackups?: pulumi.Input<pulumi.Input<inputs.netapp.preview.VolumeBackups>[]>;
    /**
     * Volumes using current backup policy
     */
