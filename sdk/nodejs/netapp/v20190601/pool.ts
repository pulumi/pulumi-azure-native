...
azure-native:netapp/v20190601:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20190701:Pool to guarantee forwards compatibility.
 */
export class Pool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Pool {
        pulumi.log.warn("Pool is deprecated: Version 2019-06-01 will be removed in v2 of the provider.\nazure-native:netapp/v20190601:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20190701:Pool to guarantee forwards compatibility.")
