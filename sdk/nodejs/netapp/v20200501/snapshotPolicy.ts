...
export class SnapshotPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20200501:SnapshotPolicy';
     ...
     */
    public readonly dailySchedule!: pulumi.Output<outputs.netapp.v20200501.DailyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly hourlySchedule!: pulumi.Output<outputs.netapp.v20200501.HourlyScheduleResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly monthlySchedule!: pulumi.Output<outputs.netapp.v20200501.MonthlyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly weeklySchedule!: pulumi.Output<outputs.netapp.v20200501.WeeklyScheduleResponse | undefined>;
    ...
    constructor(name: string, args: SnapshotPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:netapp:SnapshotPolicy" }, { type: "azure-nextgen:netapp:SnapshotPolicy" }, { type: "azure-native:netapp/latest:SnapshotPolicy" }, { type: "azure-nextgen:netapp/latest:SnapshotPolicy" }, { type: "azure-native:netapp/v20200601:SnapshotPolicy" }, { type: "azure-nextgen:netapp/v20200601:SnapshotPolicy" }, { type: "azure-native:netapp/v20200701:SnapshotPolicy" }, { type: "azure-nextgen:netapp/v20200701:SnapshotPolicy" }, { type: "azure-native:netapp/v20200801:SnapshotPolicy" }, { type: "azure-nextgen:netapp/v20200801:SnapshotPolicy" }, { type: "azure-native:netapp/v20200901:SnapshotPolicy" }, { type: "azure-nextgen:netapp/v20200901:SnapshotPolicy" }, { type: "azure-native:netapp/v20201101:SnapshotPolicy" }, { type: "azure-nextgen:netapp/v20201101:SnapshotPolicy" }] };
...
export interface SnapshotPolicyArgs {
     ...
     * Schedule for daily snapshots
     */
    readonly dailySchedule?: pulumi.Input<inputs.netapp.v20200501.DailySchedule>;
    /**
     * The property to decide policy is enabled or not
     */
     ...
     * Schedule for hourly snapshots
     */
    readonly hourlySchedule?: pulumi.Input<inputs.netapp.v20200501.HourlySchedule>;
    /**
     * Resource location
     */
     ...
     * Schedule for monthly snapshots
     */
    readonly monthlySchedule?: pulumi.Input<inputs.netapp.v20200501.MonthlySchedule>;
    /**
     ...
     * Schedule for weekly snapshots
     */
    readonly weeklySchedule?: pulumi.Input<inputs.netapp.v20200501.WeeklySchedule>;
}
