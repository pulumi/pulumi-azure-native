...
export interface BackupPolicyArgs {
     ...
     * A list of volumes assigned to this policy
     */
    readonly volumeBackups?: pulumi.Input<pulumi.Input<inputs.netapp.v20200501.VolumeBackupsArgs>[]>;
    /**
     * Volumes using current backup policy
     */
