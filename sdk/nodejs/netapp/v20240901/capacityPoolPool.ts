...
export class CapacityPoolPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20240901:CapacityPoolPool';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.netapp.v20240901.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: CapacityPoolPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:netapp/v20170815:CapacityPoolPool" }, { type: "azure-native:netapp/v20190501:CapacityPoolPool" }, { type: "azure-native:netapp/v20190601:CapacityPoolPool" }, { type: "azure-native:netapp/v20190701:CapacityPoolPool" }, { type: "azure-native:netapp/v20190801:CapacityPoolPool" }, { type: "azure-native:netapp/v20191001:CapacityPoolPool" }, { type: "azure-native:netapp/v20191101:CapacityPoolPool" }, { type: "azure-native:netapp/v20200201:CapacityPoolPool" }, { type: "azure-native:netapp/v20200301:CapacityPoolPool" }, { type: "azure-native:netapp/v20200501:CapacityPoolPool" }, { type: "azure-native:netapp/v20200601:CapacityPoolPool" }, { type: "azure-native:netapp/v20200701:CapacityPoolPool" }, { type: "azure-native:netapp/v20200801:CapacityPoolPool" }, { type: "azure-native:netapp/v20200901:CapacityPoolPool" }, { type: "azure-native:netapp/v20201101:CapacityPoolPool" }, { type: "azure-native:netapp/v20201201:CapacityPoolPool" }, { type: "azure-native:netapp/v20210201:CapacityPoolPool" }, { type: "azure-native:netapp/v20210401:CapacityPoolPool" }, { type: "azure-native:netapp/v20210401preview:CapacityPoolPool" }, { type: "azure-native:netapp/v20210601:CapacityPoolPool" }, { type: "azure-native:netapp/v20210801:CapacityPoolPool" }, { type: "azure-native:netapp/v20211001:CapacityPoolPool" }, { type: "azure-native:netapp/v20220101:CapacityPoolPool" }, { type: "azure-native:netapp/v20220301:CapacityPoolPool" }, { type: "azure-native:netapp/v20220501:CapacityPoolPool" }, { type: "azure-native:netapp/v20220901:CapacityPoolPool" }, { type: "azure-native:netapp/v20221101:CapacityPoolPool" }, { type: "azure-native:netapp/v20221101:Pool" }, { type: "azure-native:netapp/v20221101preview:CapacityPoolPool" }, { type: "azure-native:netapp/v20221101preview:Pool" }, { type: "azure-native:netapp/v20230501:CapacityPoolPool" }, { type: "azure-native:netapp/v20230501:Pool" }, { type: "azure-native:netapp/v20230501preview:CapacityPoolPool" }, { type: "azure-native:netapp/v20230501preview:Pool" }, { type: "azure-native:netapp/v20230701:CapacityPoolPool" }, { type: "azure-native:netapp/v20230701:Pool" }, { type: "azure-native:netapp/v20230701preview:CapacityPoolPool" }, { type: "azure-native:netapp/v20230701preview:Pool" }, { type: "azure-native:netapp/v20231101:CapacityPoolPool" }, { type: "azure-native:netapp/v20231101:Pool" }, { type: "azure-native:netapp/v20231101preview:CapacityPoolPool" }, { type: "azure-native:netapp/v20231101preview:Pool" }, { type: "azure-native:netapp/v20240101:CapacityPoolPool" }, { type: "azure-native:netapp/v20240101:Pool" }, { type: "azure-native:netapp/v20240301:CapacityPoolPool" }, { type: "azure-native:netapp/v20240301:Pool" }, { type: "azure-native:netapp/v20240301preview:CapacityPoolPool" }, { type: "azure-native:netapp/v20240301preview:Pool" }, { type: "azure-native:netapp/v20240501:CapacityPoolPool" }, { type: "azure-native:netapp/v20240501:Pool" }, { type: "azure-native:netapp/v20240501preview:CapacityPoolPool" }, { type: "azure-native:netapp/v20240501preview:Pool" }, { type: "azure-native:netapp/v20240701:CapacityPoolPool" }, { type: "azure-native:netapp/v20240701:Pool" }, { type: "azure-native:netapp/v20240701preview:CapacityPoolPool" }, { type: "azure-native:netapp/v20240701preview:Pool" }, { type: "azure-native:netapp/v20240901:Pool" }, { type: "azure-native:netapp:CapacityPoolPool" }, { type: "azure-native:netapp:Pool" }] };
...
export interface CapacityPoolPoolArgs {
     ...
     * Encryption type of the capacity pool, set encryption type for data at rest for this pool and all volumes in it. This value can only be set when creating new pool.
     */
    encryptionType?: pulumi.Input<string | enums.netapp.v20240901.EncryptionType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The qos type of the pool
     */
    qosType?: pulumi.Input<string | enums.netapp.v20240901.QosType>;
    /**
     ...
     * The service level of the file system
     */
    serviceLevel: pulumi.Input<string | enums.netapp.v20240901.ServiceLevel>;
    /**
     * Provisioned size of the pool (in bytes). Allowed values are in 1TiB chunks (value must be multiple of 1099511627776).
     */
