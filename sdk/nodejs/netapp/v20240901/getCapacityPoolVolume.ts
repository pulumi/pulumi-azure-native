...
export function getCapacityPoolVolume(args: GetCapacityPoolVolumeArgs, opts?: pulumi.InvokeOptions): Promise<GetCapacityPoolVolumeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:netapp/v20240901:getCapacityPoolVolume", {
...
export interface GetCapacityPoolVolumeResult {
     ...
     */
    readonly dataProtection?: outputs.netapp.v20240901.VolumePropertiesResponseDataProtection;
    /**
     ...
     */
    readonly exportPolicy?: outputs.netapp.v20240901.VolumePropertiesResponseExportPolicy;
    /**
     ...
     */
    readonly mountTargets: outputs.netapp.v20240901.MountTargetPropertiesResponse[];
    /**
     ...
     */
    readonly placementRules?: outputs.netapp.v20240901.PlacementKeyValuePairsResponse[];
    /**
     ...
     */
    readonly systemData: outputs.netapp.v20240901.SystemDataResponse;
    /**
...
export function getCapacityPoolVolumeOutput(args: GetCapacityPoolVolumeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCapacityPoolVolumeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:netapp/v20240901:getCapacityPoolVolume", {
        "accountName": args.accountName,
        "poolName": args.poolName,
        "resourceGroupName": args.resourceGroupName,
        "volumeName": args.volumeName,
