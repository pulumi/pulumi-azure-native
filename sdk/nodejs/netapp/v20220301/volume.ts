 ...
 * Volume resource
 *
 * @deprecated azure-native:netapp/v20220301:Volume is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Volume to guarantee forwards compatibility.
 */
export class Volume extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Volume {
        pulumi.log.warn("Volume is deprecated: azure-native:netapp/v20220301:Volume is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Volume to guarantee forwards compatibility.")
     ...
     */
    public readonly dataProtection!: pulumi.Output<outputs.netapp.v20220301.VolumePropertiesResponseDataProtection | undefined>;
    /**
     ...
     */
    public readonly exportPolicy!: pulumi.Output<outputs.netapp.v20220301.VolumePropertiesResponseExportPolicy | undefined>;
    /**
     ...
     */
    public /*out*/ readonly mountTargets!: pulumi.Output<outputs.netapp.v20220301.MountTargetPropertiesResponse[]>;
    /**
     ...
     */
    public readonly placementRules!: pulumi.Output<outputs.netapp.v20220301.PlacementKeyValuePairsResponse[] | undefined>;
    /**
...
export interface VolumeArgs {
     ...
     * Specifies whether the volume is enabled for Azure VMware Solution (AVS) datastore purpose
     */
    avsDataStore?: pulumi.Input<string | enums.netapp.v20220301.AvsDataStore>;
    /**
     * UUID v4 or resource identifier used to identify the Backup.
     */
     ...
     * DataProtection type volumes include an object containing details of the replication
     */
    dataProtection?: pulumi.Input<inputs.netapp.v20220301.VolumePropertiesDataProtectionArgs>;
    /**
     * Default group quota for volume in KiBs. If isDefaultQuotaEnabled is set, the minimum value of 4 KiBs applies.
     */
     ...
     * Flag indicating whether subvolume operations are enabled on the volume
     */
    enableSubvolumes?: pulumi.Input<string | enums.netapp.v20220301.EnableSubvolumes>;
    /**
     * Source of key used to encrypt data in volume. Applicable if NetApp account has encryption.keySource = 'Microsoft.KeyVault'. Possible values (case-insensitive) are: 'Microsoft.NetApp, Microsoft.KeyVault'
     */
    encryptionKeySource?: pulumi.Input<string | enums.netapp.v20220301.EncryptionKeySource>;
    /**
     * Set of export policy rules
     */
    exportPolicy?: pulumi.Input<inputs.netapp.v20220301.VolumePropertiesExportPolicyArgs>;
    /**
     * Specifies if default quota is enabled for the volume.
     */
     ...
     * Basic network, or Standard features available to the volume.
     */
    networkFeatures?: pulumi.Input<string | enums.netapp.v20220301.NetworkFeatures>;
    /**
     * Application specific placement rules for the particular volume
     */
    placementRules?: pulumi.Input<pulumi.Input<inputs.netapp.v20220301.PlacementKeyValuePairsArgs>[]>;
    /**
     ...
     * The security style of volume, default unix, defaults to ntfs for dual protocol or CIFS protocol
     */
    securityStyle?: pulumi.Input<string | enums.netapp.v20220301.SecurityStyle>;
    /**
     * The service level of the file system
     */
    serviceLevel?: pulumi.Input<string | enums.netapp.v20220301.ServiceLevel>;
    /**
     * Enables continuously available share property for smb volume. Only applicable for SMB volume
     */
