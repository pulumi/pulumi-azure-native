 ...
 *
 * @deprecated azure-native:netapp/v20220301:SnapshotPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:SnapshotPolicy to guarantee forwards compatibility.
 */
export class SnapshotPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SnapshotPolicy {
        pulumi.log.warn("SnapshotPolicy is deprecated: azure-native:netapp/v20220301:SnapshotPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:SnapshotPolicy to guarantee forwards compatibility.")
        return new SnapshotPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20220301:SnapshotPolicy';
     ...
     */
    public readonly dailySchedule!: pulumi.Output<outputs.netapp.v20220301.DailyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly hourlySchedule!: pulumi.Output<outputs.netapp.v20220301.HourlyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly monthlySchedule!: pulumi.Output<outputs.netapp.v20220301.MonthlyScheduleResponse | undefined>;
    /**
     ...
     */
    public readonly weeklySchedule!: pulumi.Output<outputs.netapp.v20220301.WeeklyScheduleResponse | undefined>;
...
export interface SnapshotPolicyArgs {
     ...
     * Schedule for daily snapshots
     */
    dailySchedule?: pulumi.Input<inputs.netapp.v20220301.DailyScheduleArgs>;
    /**
     * The property to decide policy is enabled or not
     */
     ...
     * Schedule for hourly snapshots
     */
    hourlySchedule?: pulumi.Input<inputs.netapp.v20220301.HourlyScheduleArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Schedule for monthly snapshots
     */
    monthlySchedule?: pulumi.Input<inputs.netapp.v20220301.MonthlyScheduleArgs>;
    /**
     ...
     * Schedule for weekly snapshots
     */
    weeklySchedule?: pulumi.Input<inputs.netapp.v20220301.WeeklyScheduleArgs>;
}
