...
export function getVolumeQuotaRule(args: GetVolumeQuotaRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetVolumeQuotaRuleResult> {
    pulumi.log.warn("getVolumeQuotaRule is deprecated: azure-native:netapp/v20220301:VolumeQuotaRule is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:VolumeQuotaRule to guarantee forwards compatibility.")
