 ...
 *
 * @deprecated azure-native:netapp/v20220301:VolumeQuotaRule is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:VolumeQuotaRule to guarantee forwards compatibility.
 */
export class VolumeQuotaRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VolumeQuotaRule {
        pulumi.log.warn("VolumeQuotaRule is deprecated: azure-native:netapp/v20220301:VolumeQuotaRule is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:VolumeQuotaRule to guarantee forwards compatibility.")
        return new VolumeQuotaRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20220301:VolumeQuotaRule';
    ...
    constructor(name: string, args: VolumeQuotaRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:netapp:VolumeQuotaRule" }, { type: "azure-native:netapp/v20220101:VolumeQuotaRule" }, { type: "azure-native:netapp/v20220501:VolumeQuotaRule" }, { type: "azure-native:netapp/v20220901:VolumeQuotaRule" }] };
...
export interface VolumeQuotaRuleArgs {
     ...
     * Type of quota
     */
    quotaType?: pulumi.Input<string | enums.netapp.v20220301.Type>;
    /**
