 ...
 */
/** @deprecated azure-native:netapp/v20220301:Subvolume is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Subvolume to guarantee forwards compatibility. */
export function getSubvolume(args: GetSubvolumeArgs, opts?: pulumi.InvokeOptions): Promise<GetSubvolumeResult> {
    pulumi.log.warn("getSubvolume is deprecated: azure-native:netapp/v20220301:Subvolume is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Subvolume to guarantee forwards compatibility.")
