...
export class VolumeGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VolumeGroup {
        pulumi.log.warn("VolumeGroup is deprecated: azure-native:netapp/v20220301:VolumeGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:VolumeGroup to guarantee forwards compatibility.")
        return new VolumeGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20220301:VolumeGroup';
     ...
     */
    public readonly groupMetaData!: pulumi.Output<outputs.netapp.v20220301.VolumeGroupMetaDataResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly volumes!: pulumi.Output<outputs.netapp.v20220301.VolumeGroupVolumePropertiesResponse[] | undefined>;
    ...
    constructor(name: string, args: VolumeGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:netapp:VolumeGroup" }, { type: "azure-native:netapp/v20210801:VolumeGroup" }, { type: "azure-native:netapp/v20211001:VolumeGroup" }, { type: "azure-native:netapp/v20220101:VolumeGroup" }, { type: "azure-native:netapp/v20220501:VolumeGroup" }, { type: "azure-native:netapp/v20220901:VolumeGroup" }] };
...
export interface VolumeGroupArgs {
     ...
     * Volume group details
     */
    groupMetaData?: pulumi.Input<inputs.netapp.v20220301.VolumeGroupMetaDataArgs>;
    /**
     * Resource location
     */
     ...
     * List of volumes from group
     */
    volumes?: pulumi.Input<pulumi.Input<inputs.netapp.v20220301.VolumeGroupVolumePropertiesArgs>[]>;
}
