...
// Export enums:
export * from "../../types/enums/netapp/v20220301";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "azure-native:netapp/v20220301:CapacityPoolBackup":
                return new CapacityPoolBackup(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220301:CapacityPoolPool":
                return new CapacityPoolPool(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220301:CapacityPoolSnapshot":
                return new CapacityPoolSnapshot(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220301:CapacityPoolSubvolume":
                return new CapacityPoolSubvolume(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220301:CapacityPoolVolume":
                return new CapacityPoolVolume(name, <any>undefined, { urn })
            case "azure-native:netapp/v20220301:CapacityPoolVolumeQuotaRule":
...
pulumi.runtime.registerResourceModule("azure-native", "netapp/v20220301", _module)
