...
export class Pool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20220301:Pool';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.netapp.v20220301.PoolPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: PoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.netapp.v20220301.poolPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface PoolArgs {
     ...
     * Capacity pool properties
     */
    properties: pulumi.Input<inputs.netapp.v20220301.PoolPropertiesArgs>;
    /**
