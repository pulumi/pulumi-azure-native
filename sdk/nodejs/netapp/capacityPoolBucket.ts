...
export class CapacityPoolBucket extends pulumi.CustomResource {
     ...
     */
    public readonly fileSystemUser!: pulumi.Output<outputs.netapp.FileSystemUserResponse | undefined>;
    /**
     ...
     */
    public readonly server!: pulumi.Output<outputs.netapp.BucketServerPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: CapacityPoolBucketArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:netapp/v20250101preview:CapacityPoolBucket" }, { type: "azure-native:netapp/v20250301preview:CapacityPoolBucket" }, { type: "azure-native:netapp/v20250701preview:CapacityPoolBucket" }, { type: "azure-native:netapp/v20250801preview:CapacityPoolBucket" }] };
