...
export class CapacityPoolPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20240501preview:CapacityPoolPool';
