...
export function getPool(args: GetPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetPoolResult> {
    pulumi.log.warn("getPool is deprecated: Version 2019-11-01 will be removed in v2 of the provider.")
...
export interface GetPoolResult {
     ...
     */
    readonly properties: outputs.netapp.v20191101.PoolPropertiesResponse;
    /**
     * Resource tags
     */
