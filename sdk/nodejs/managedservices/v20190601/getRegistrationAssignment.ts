...
export function getRegistrationAssignment(args: GetRegistrationAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistrationAssignmentResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:managedservices/v20190601:getRegistrationAssignment", {
...
export interface GetRegistrationAssignmentResult {
     ...
     */
    readonly properties: outputs.managedservices.v20190601.RegistrationAssignmentPropertiesInvokeResponse;
    /**
