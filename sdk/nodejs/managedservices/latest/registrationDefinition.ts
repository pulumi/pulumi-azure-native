...
export class RegistrationDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:managedservices/latest:RegistrationDefinition';
     ...
     */
    public readonly plan!: pulumi.Output<outputs.managedservices.latest.PlanResponse | undefined>;
    /**
     * Properties of a registration definition.
     */
    public readonly properties!: pulumi.Output<outputs.managedservices.latest.RegistrationDefinitionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RegistrationDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:managedservices/preview:RegistrationDefinition" }, { type: "azurerm:managedservices/v20180601preview:RegistrationDefinition" }, { type: "azurerm:managedservices/v20190401preview:RegistrationDefinition" }, { type: "azurerm:managedservices/v20190601:RegistrationDefinition" }, { type: "azurerm:managedservices/v20190901:RegistrationDefinition" }, { type: "azurerm:managedservices/v20200201preview:RegistrationDefinition" }] };
...
export interface RegistrationDefinitionArgs {
     ...
     * Plan details for the managed services.
     */
    readonly plan?: pulumi.Input<inputs.managedservices.latest.Plan>;
    /**
     * Properties of a registration definition.
     */
    readonly properties?: pulumi.Input<inputs.managedservices.latest.RegistrationDefinitionProperties>;
    /**
