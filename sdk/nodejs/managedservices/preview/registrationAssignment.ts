...
export class RegistrationAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:managedservices/preview:RegistrationAssignment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.managedservices.preview.RegistrationAssignmentPropertiesResponse>;
    /**
...
export interface RegistrationAssignmentArgs {
     ...
     * Properties of a registration assignment.
     */
    readonly properties?: pulumi.Input<inputs.managedservices.preview.RegistrationAssignmentProperties>;
    /**
