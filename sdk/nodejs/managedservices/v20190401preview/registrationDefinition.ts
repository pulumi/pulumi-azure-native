 ...
 *
 * const registrationDefinition = new azurerm.managedservices.v20190401preview.RegistrationDefinition("registrationDefinition", {
 *     plan: {
 *         name: "addesai-plan",
 *         product: "test",
...
export class RegistrationDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:managedservices/v20190401preview:RegistrationDefinition';
    ...
    constructor(name: string, args: RegistrationDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:managedservices/latest:RegistrationDefinition" }, { type: "azurerm:managedservices/v20180601preview:RegistrationDefinition" }, { type: "azurerm:managedservices/v20190601:RegistrationDefinition" }, { type: "azurerm:managedservices/v20190901:RegistrationDefinition" }, { type: "azurerm:managedservices/v20200201preview:RegistrationDefinition" }] };
