...
export function getRegistrationAssignment(args: GetRegistrationAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistrationAssignmentResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:managedservices/v20180601preview:getRegistrationAssignment", {
...
export interface GetRegistrationAssignmentResult {
     ...
     */
    readonly properties: outputs.managedservices.v20180601preview.RegistrationAssignmentPropertiesInvokeResponse;
    /**
