...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:managedservices/v20180601preview:RegistrationAssignment":
                return new RegistrationAssignment(name, <any>undefined, { urn })
            case "azure-nextgen:managedservices/v20180601preview:RegistrationDefinition":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "managedservices/v20180601preview", _module)
