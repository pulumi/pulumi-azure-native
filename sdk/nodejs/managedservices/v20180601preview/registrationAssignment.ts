...
export class RegistrationAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:managedservices/v20180601preview:RegistrationAssignment';
    ...
    constructor(name: string, args: RegistrationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:managedservices/latest:RegistrationAssignment" }, { type: "azurerm:managedservices/preview:RegistrationAssignment" }, { type: "azurerm:managedservices/v20190401preview:RegistrationAssignment" }, { type: "azurerm:managedservices/v20190601:RegistrationAssignment" }, { type: "azurerm:managedservices/v20190901:RegistrationAssignment" }, { type: "azurerm:managedservices/v20200201preview:RegistrationAssignment" }] };
