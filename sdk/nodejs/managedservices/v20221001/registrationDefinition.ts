...
export class RegistrationDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly plan!: pulumi.Output<outputs.managedservices.v20221001.PlanResponse | undefined>;
    /**
     * The properties of a registration definition.
     */
    public readonly properties!: pulumi.Output<outputs.managedservices.v20221001.RegistrationDefinitionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RegistrationDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managedservices:RegistrationDefinition" }, { type: "azure-native:managedservices/v20190901:RegistrationDefinition" }, { type: "azure-native:managedservices/v20200201preview:RegistrationDefinition" }, { type: "azure-native:managedservices/v20220101preview:RegistrationDefinition" }] };
...
export interface RegistrationDefinitionArgs {
     ...
     * The details for the Managed Services offer’s plan in Azure Marketplace.
     */
    plan?: pulumi.Input<inputs.managedservices.v20221001.PlanArgs>;
    /**
     * The properties of a registration definition.
     */
    properties?: pulumi.Input<inputs.managedservices.v20221001.RegistrationDefinitionPropertiesArgs>;
    /**
