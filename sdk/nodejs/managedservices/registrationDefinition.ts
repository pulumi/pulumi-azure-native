...
export class RegistrationDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:managedservices:RegistrationDefinition';
...
export interface RegistrationDefinitionArgs {
     ...
     * Plan details for the managed services.
     */
    readonly plan?: pulumi.Input<inputs.managedservices.Plan>;
    /**
     * Properties of a registration definition.
     */
    readonly properties?: pulumi.Input<inputs.managedservices.RegistrationDefinitionProperties>;
    /**
