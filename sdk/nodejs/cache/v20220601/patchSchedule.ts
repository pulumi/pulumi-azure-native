...
export class PatchSchedule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cache.v20220601.ScheduleEntriesResponse>;
    /**
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    properties: pulumi.Input<inputs.cache.v20220601.ScheduleEntriesArgs>;
    /**
