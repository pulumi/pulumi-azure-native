...
export class PatchSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20220601:PatchSchedule';
     ...
     */
    public readonly scheduleEntries!: pulumi.Output<outputs.cache.v20220601.ScheduleEntryResponse[]>;
    /**
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    scheduleEntries: pulumi.Input<pulumi.Input<inputs.cache.v20220601.ScheduleEntryArgs>[]>;
}
