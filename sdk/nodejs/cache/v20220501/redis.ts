...
export class Redis extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Redis {
        pulumi.log.warn("Redis is deprecated: azure-native:cache/v20220501:Redis is being removed in the next major version of this provider. Please upgrade to azure-native:cache/v20220601:Redis to guarantee forwards compatibility.")
