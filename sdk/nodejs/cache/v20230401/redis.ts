...
export class Redis extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RedisArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache:Redis" }, { type: "azure-native:cache/v20200601:Redis" }, { type: "azure-native:cache/v20220601:Redis" }, { type: "azure-native:cache/v20230501preview:Redis" }] };
