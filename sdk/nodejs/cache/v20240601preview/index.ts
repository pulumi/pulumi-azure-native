...
// Export enums:
export * from "../../types/enums/cache/v20240601preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cache/v20240601preview:EnterpriseDatabase":
                return new EnterpriseDatabase(name, <any>undefined, { urn })
            case "azure-native:cache/v20240601preview:EnterprisePrivateEndpointConnection":
                return new EnterprisePrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:cache/v20240601preview:RedisEnterprise":
...
pulumi.runtime.registerResourceModule("azure-native", "cache/v20240601preview", _module)
