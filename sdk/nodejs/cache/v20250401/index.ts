...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cache/v20250401:AccessPolicyAssignment":
                return new AccessPolicyAssignment(name, <any>undefined, { urn })
            case "azure-native:cache/v20250401:Database":
                return new Database(name, <any>undefined, { urn })
            case "azure-native:cache/v20250401:EnterprisePrivateEndpointConnection":
                return new EnterprisePrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:cache/v20250401:RedisEnterprise":
...
pulumi.runtime.registerResourceModule("azure-native", "cache/v20250401", _module)
