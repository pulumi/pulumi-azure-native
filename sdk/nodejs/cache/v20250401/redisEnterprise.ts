...
export class RedisEnterprise extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20250401:RedisEnterprise';
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.cache.v20250401.ClusterPropertiesResponseEncryption | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.cache.v20250401.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.cache.v20250401.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.cache.v20250401.EnterpriseSkuResponse>;
    /**
     * Resource tags.
     */
...
export interface RedisEnterpriseArgs {
     ...
     * Encryption-at-rest configuration for the cluster.
     */
    encryption?: pulumi.Input<inputs.cache.v20250401.ClusterPropertiesEncryptionArgs>;
    /**
     * Enabled by default. If highAvailability is disabled, the data set is not replicated. This affects the availability SLA, and increases the risk of data loss.
     */
    highAvailability?: pulumi.Input<string | enums.cache.v20250401.HighAvailability>;
    /**
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.cache.v20250401.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The minimum TLS version for the cluster to support, e.g. '1.2'. Newer versions can be added in the future. Note that TLS 1.0 and TLS 1.1 are now completely obsolete -- you cannot use them. They are mentioned only for the sake of consistency with old API versions.
     */
    minimumTlsVersion?: pulumi.Input<string | enums.cache.v20250401.TlsVersion>;
    /**
     ...
     * The SKU to create, which affects price, performance, and features.
     */
    sku: pulumi.Input<inputs.cache.v20250401.EnterpriseSkuArgs>;
    /**
     * Resource tags.
     */
