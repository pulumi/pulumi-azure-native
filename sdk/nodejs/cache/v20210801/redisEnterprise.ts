 ...
 *
 * @deprecated azure-native:cache/v20210801:RedisEnterprise is being removed in the next major version of this provider. Please upgrade to azure-native:cache/v20230301preview:RedisEnterprise to guarantee forwards compatibility.
 */
export class RedisEnterprise extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20210801:RedisEnterprise';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.cache.v20210801.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.cache.v20210801.EnterpriseSkuResponse>;
    /**
     * Resource tags.
     */
...
export interface RedisEnterpriseArgs {
     ...
     * The minimum TLS version for the cluster to support, e.g. '1.2'
     */
    minimumTlsVersion?: pulumi.Input<string | enums.cache.v20210801.TlsVersion>;
    /**
     ...
     * The SKU to create, which affects price, performance, and features.
     */
    sku: pulumi.Input<inputs.cache.v20210801.EnterpriseSkuArgs>;
    /**
     * Resource tags.
     */
