...
export function getRedis(args: GetRedisArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:cache/v20180301:getRedis", {
        "name": args.name,
...
export interface GetRedisResult {
     ...
     */
    readonly accessKeys: outputs.cache.v20180301.RedisAccessKeysInvokeResponse;
    /**
     ...
     */
    readonly linkedServers: outputs.cache.v20180301.RedisLinkedServerInvokeResponse[];
    /**
     ...
     */
    readonly sku: outputs.cache.v20180301.SkuInvokeResponse;
    /**
     * Redis SSL port.
     */
