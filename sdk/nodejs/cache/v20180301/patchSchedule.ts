...
export class PatchSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20180301:PatchSchedule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cache.v20180301.ScheduleEntriesResponse>;
    /**
     * Resource type.
     */
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    properties: pulumi.Input<inputs.cache.v20180301.ScheduleEntriesArgs>;
    /**
