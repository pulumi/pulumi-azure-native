...
export function getPatchSchedule(args: GetPatchScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetPatchScheduleResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:cache/v20180301:getPatchSchedule", {
...
export interface GetPatchScheduleResult {
     ...
     */
    readonly scheduleEntries: outputs.cache.v20180301.ScheduleEntryInvokeResponse[];
    /**
     * Resource type.
     */
