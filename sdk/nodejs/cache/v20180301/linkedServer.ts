...
export class LinkedServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:cache/v20180301:LinkedServer';
    ...
    constructor(name: string, argsOrState?: LinkedServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cache/v20170201:LinkedServer" }, { type: "azurerm:cache/v20171001:LinkedServer" }] };
