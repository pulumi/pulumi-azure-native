...
export function getRedis(args: GetRedisArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisResult> {
    pulumi.log.warn("getRedis is deprecated: azure-native:cache/v20210601:Redis is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:Redis to guarantee forwards compatibility.")
