 ...
 *
 * const patchSchedule = new azurerm.cache.v20190701.PatchSchedule("patchSchedule", {
 *     "default": "default",
 *     name: "cache1",
...
export class PatchSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:cache/v20190701:PatchSchedule';
    ...
    constructor(name: string, args: PatchScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cache/latest:PatchSchedule" }, { type: "azurerm:cache/v20171001:PatchSchedule" }, { type: "azurerm:cache/v20180301:PatchSchedule" }] };
