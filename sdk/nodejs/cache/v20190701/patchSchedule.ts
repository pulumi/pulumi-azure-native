...
export class PatchSchedule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PatchScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cache/latest:PatchSchedule" }, { type: "azurerm:cache/preview:PatchSchedule" }, { type: "azurerm:cache/v20171001:PatchSchedule" }, { type: "azurerm:cache/v20180301:PatchSchedule" }] };
