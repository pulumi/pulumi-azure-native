...
export class PatchSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:cache/v20190701:PatchSchedule';
     ...
     */
    public readonly scheduleEntries!: pulumi.Output<outputs.cache.v20190701.ScheduleEntryResponse[]>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: PatchScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            if ((!args || args.scheduleEntries === undefined) && !(opts && opts.urn)) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cache:PatchSchedule" }, { type: "azure-nextgen:cache/latest:PatchSchedule" }, { type: "azure-nextgen:cache/v20171001:PatchSchedule" }, { type: "azure-nextgen:cache/v20180301:PatchSchedule" }, { type: "azure-nextgen:cache/v20200601:PatchSchedule" }] };
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    readonly scheduleEntries: pulumi.Input<pulumi.Input<inputs.cache.v20190701.ScheduleEntry>[]>;
}
