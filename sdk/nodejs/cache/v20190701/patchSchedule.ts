...
export class PatchSchedule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cache.v20190701.ScheduleEntriesResponse>;
    /**
     * Resource type.
     */
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    properties: pulumi.Input<inputs.cache.v20190701.ScheduleEntriesArgs>;
    /**
