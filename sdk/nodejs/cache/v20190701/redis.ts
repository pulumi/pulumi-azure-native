...
export class Redis extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RedisArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cache/latest:Redis" }, { type: "azurerm:cache/v20150801:Redis" }, { type: "azurerm:cache/v20160401:Redis" }, { type: "azurerm:cache/v20170201:Redis" }, { type: "azurerm:cache/v20171001:Redis" }, { type: "azurerm:cache/v20180301:Redis" }] };
