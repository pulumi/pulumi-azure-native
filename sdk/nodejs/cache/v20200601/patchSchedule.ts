...
export class PatchSchedule extends pulumi.CustomResource {
     ...
     */
    public readonly scheduleEntries!: pulumi.Output<outputs.cache.v20200601.ScheduleEntryResponse[]>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: PatchScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache:PatchSchedule" }, { type: "azure-native:cache/v20201201:PatchSchedule" }, { type: "azure-native:cache/v20210601:PatchSchedule" }, { type: "azure-native:cache/v20220501:PatchSchedule" }, { type: "azure-native:cache/v20220601:PatchSchedule" }, { type: "azure-native:cache/v20230401:PatchSchedule" }, { type: "azure-native:cache/v20230501preview:PatchSchedule" }] };
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    scheduleEntries: pulumi.Input<pulumi.Input<inputs.cache.v20200601.ScheduleEntryArgs>[]>;
}
