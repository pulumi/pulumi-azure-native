...
export function getPatchSchedule(args: GetPatchScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetPatchScheduleResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:cache/v20200601:getPatchSchedule", {
...
export interface GetPatchScheduleResult {
     ...
     */
    readonly scheduleEntries: outputs.cache.v20200601.ScheduleEntryInvokeResponse[];
    /**
     * Resource type.
     */
