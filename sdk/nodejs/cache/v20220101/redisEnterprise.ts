 ...
 *
 * @deprecated azure-native:cache/v20220101:RedisEnterprise is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230301preview:RedisEnterprise to guarantee forwards compatibility.
 */
export class RedisEnterprise extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RedisEnterprise {
        pulumi.log.warn("RedisEnterprise is deprecated: azure-native:cache/v20220101:RedisEnterprise is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230301preview:RedisEnterprise to guarantee forwards compatibility.")
        return new RedisEnterprise(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20220101:RedisEnterprise';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.cache.v20220101.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.cache.v20220101.EnterpriseSkuResponse>;
    /**
     * Resource tags.
     */
