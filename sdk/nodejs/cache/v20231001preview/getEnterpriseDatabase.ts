...
export function getEnterpriseDatabase(args: GetEnterpriseDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetEnterpriseDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cache/v20231001preview:getEnterpriseDatabase", {
...
export interface GetEnterpriseDatabaseResult {
     ...
     */
    readonly geoReplication?: outputs.cache.v20231001preview.DatabasePropertiesResponseGeoReplication;
    /**
     ...
     */
    readonly modules?: outputs.cache.v20231001preview.ModuleResponse[];
    /**
     ...
     */
    readonly persistence?: outputs.cache.v20231001preview.PersistenceResponse;
    /**
     ...
     */
    readonly systemData: outputs.cache.v20231001preview.SystemDataResponse;
    /**
...
export function getEnterpriseDatabaseOutput(args: GetEnterpriseDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEnterpriseDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cache/v20231001preview:getEnterpriseDatabase", {
        "clusterName": args.clusterName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
