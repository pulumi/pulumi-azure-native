...
export class RedisEnterprise extends pulumi.CustomResource {
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.cache.v20231101.ClusterPropertiesResponseEncryption | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.cache.v20231101.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.cache.v20231101.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.cache.v20231101.EnterpriseSkuResponse>;
    /**
     * Resource tags.
     */
...
export interface RedisEnterpriseArgs {
     ...
     * Encryption-at-rest configuration for the cluster.
     */
    encryption?: pulumi.Input<inputs.cache.v20231101.ClusterPropertiesEncryptionArgs>;
    /**
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.cache.v20231101.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The minimum TLS version for the cluster to support, e.g. '1.2'
     */
    minimumTlsVersion?: pulumi.Input<string | enums.cache.v20231101.TlsVersion>;
    /**
     ...
     * The SKU to create, which affects price, performance, and features.
     */
    sku: pulumi.Input<inputs.cache.v20231101.EnterpriseSkuArgs>;
    /**
     * Resource tags.
     */
