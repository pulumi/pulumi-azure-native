...
export class AccessPolicyAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20240901preview:AccessPolicyAssignment';
     ...
     */
    public readonly user!: pulumi.Output<outputs.cache.v20240901preview.AccessPolicyAssignmentPropertiesResponseUser>;
    ...
    constructor(name: string, args: AccessPolicyAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache/v20250401:AccessPolicyAssignment" }] };
...
export interface AccessPolicyAssignmentArgs {
     ...
     * The user associated with the access policy.
     */
    user: pulumi.Input<inputs.cache.v20240901preview.AccessPolicyAssignmentPropertiesUserArgs>;
}
