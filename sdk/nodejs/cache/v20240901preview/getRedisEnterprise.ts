...
export function getRedisEnterprise(args: GetRedisEnterpriseArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisEnterpriseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cache/v20240901preview:getRedisEnterprise", {
...
export interface GetRedisEnterpriseResult {
     ...
     */
    readonly encryption?: outputs.cache.v20240901preview.ClusterPropertiesResponseEncryption;
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.cache.v20240901preview.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly sku: outputs.cache.v20240901preview.EnterpriseSkuResponse;
    /**
     * Resource tags.
     */
