...
export class PatchSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20160401:PatchSchedule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cache.v20160401.ScheduleEntriesResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: PatchScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache/v20170201:PatchSchedule" }] };
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    properties: pulumi.Input<inputs.cache.v20160401.ScheduleEntriesArgs>;
    /**
