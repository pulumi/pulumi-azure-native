...
export function getRedis(args: GetRedisArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:cache/v20160401:getRedis", {
        "name": args.name,
...
export interface GetRedisResult {
     ...
     */
    readonly accessKeys: outputs.cache.v20160401.RedisAccessKeysInvokeResponse;
    /**
     ...
     */
    readonly sku?: outputs.cache.v20160401.SkuInvokeResponse;
    /**
     * Redis SSL port.
     */
