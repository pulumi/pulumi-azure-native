...
export class AccessPolicyAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20240301:AccessPolicyAssignment';
    ...
    constructor(name: string, args: AccessPolicyAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache/v20230501preview:AccessPolicyAssignment" }, { type: "azure-native:cache/v20230801:AccessPolicyAssignment" }, { type: "azure-native:cache/v20240401preview:AccessPolicyAssignment" }, { type: "azure-native:cache/v20241101:AccessPolicyAssignment" }, { type: "azure-native:cache:AccessPolicyAssignment" }] };
