...
export class PatchSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:cache/preview:PatchSchedule';
     ...
     */
    public readonly scheduleEntries!: pulumi.Output<outputs.cache.preview.ScheduleEntryResponse[]>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, argsOrState?: PatchScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cache/latest:PatchSchedule" }, { type: "azurerm:cache/v20171001:PatchSchedule" }, { type: "azurerm:cache/v20180301:PatchSchedule" }, { type: "azurerm:cache/v20190701:PatchSchedule" }] };
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    readonly scheduleEntries: pulumi.Input<pulumi.Input<inputs.cache.preview.ScheduleEntry>[]>;
}
