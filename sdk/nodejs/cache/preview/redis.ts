...
export class Redis extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:cache/preview:Redis';
     ...
     */
    public /*out*/ readonly accessKeys!: pulumi.Output<outputs.cache.preview.RedisAccessKeysResponse>;
    /**
     ...
     */
    public /*out*/ readonly instances!: pulumi.Output<outputs.cache.preview.RedisInstanceDetailsResponse[]>;
    /**
     * List of the linked servers associated with the cache
     */
    public /*out*/ readonly linkedServers!: pulumi.Output<outputs.cache.preview.RedisLinkedServerResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.cache.preview.SkuResponse>;
    /**
     * Redis SSL port.
     */
    ...
    constructor(name: string, args: RedisArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cache/latest:Redis" }, { type: "azurerm:cache/v20150801:Redis" }, { type: "azurerm:cache/v20160401:Redis" }, { type: "azurerm:cache/v20170201:Redis" }, { type: "azurerm:cache/v20171001:Redis" }, { type: "azurerm:cache/v20180301:Redis" }, { type: "azurerm:cache/v20190701:Redis" }] };
...
export interface RedisArgs {
     ...
     * The SKU of the Redis cache to deploy.
     */
    readonly sku: pulumi.Input<inputs.cache.preview.Sku>;
    /**
     * Static IP address. Required when deploying a Redis cache inside an existing Azure Virtual Network.
     */
