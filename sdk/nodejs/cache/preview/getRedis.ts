...
export function getRedis(args: GetRedisArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisResult> {
    ...
    return pulumi.runtime.invoke("azurerm:cache/preview:getRedis", {
        "name": args.name,
...
export interface GetRedisResult {
     ...
     */
    readonly accessKeys: outputs.cache.preview.RedisAccessKeysResponse;
    /**
     ...
     */
    readonly instances: outputs.cache.preview.RedisInstanceDetailsResponse[];
    /**
     * List of the linked servers associated with the cache
     */
    readonly linkedServers: outputs.cache.preview.RedisLinkedServerResponse[];
    /**
     ...
     */
    readonly sku: outputs.cache.preview.SkuResponse;
    /**
     * Redis SSL port.
     */
