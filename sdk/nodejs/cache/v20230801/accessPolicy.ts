...
export class AccessPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache:AccessPolicy" }, { type: "azure-native:cache/v20230501preview:AccessPolicy" }, { type: "azure-native:cache/v20240301:AccessPolicy" }] };
