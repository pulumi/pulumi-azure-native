...
export class RedisEnterprise extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/latest:RedisEnterprise';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.cache.latest.EnterpriseSkuResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: RedisEnterpriseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cache/latest:RedisEnterprise" }, { type: "azure-native:cache:RedisEnterprise" }, { type: "azure-nextgen:cache:RedisEnterprise" }, { type: "azure-native:cache/v20201001preview:RedisEnterprise" }, { type: "azure-nextgen:cache/v20201001preview:RedisEnterprise" }, { type: "azure-native:cache/v20210201preview:RedisEnterprise" }, { type: "azure-nextgen:cache/v20210201preview:RedisEnterprise" }, { type: "azure-native:cache/v20210301:RedisEnterprise" }, { type: "azure-nextgen:cache/v20210301:RedisEnterprise" }] };
...
export interface RedisEnterpriseArgs {
     ...
     * The SKU to create, which affects price, performance, and features.
     */
    readonly sku: pulumi.Input<inputs.cache.latest.EnterpriseSku>;
    /**
     * Resource tags.
     */
