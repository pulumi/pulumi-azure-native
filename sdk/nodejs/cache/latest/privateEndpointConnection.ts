...
export class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.cache.latest.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.cache.latest.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cache/latest:PrivateEndpointConnection" }, { type: "azure-native:cache:PrivateEndpointConnection" }, { type: "azure-nextgen:cache:PrivateEndpointConnection" }, { type: "azure-native:cache/v20201001preview:PrivateEndpointConnection" }, { type: "azure-nextgen:cache/v20201001preview:PrivateEndpointConnection" }, { type: "azure-native:cache/v20210201preview:PrivateEndpointConnection" }, { type: "azure-nextgen:cache/v20210201preview:PrivateEndpointConnection" }, { type: "azure-native:cache/v20210301:PrivateEndpointConnection" }, { type: "azure-nextgen:cache/v20210301:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Input<inputs.cache.latest.PrivateLinkServiceConnectionState>;
    /**
