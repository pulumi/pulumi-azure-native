 ...
 *
 * @deprecated azure-native:cache/v20210201preview:Database is being removed in the next major version of this provider. Please upgrade to azure-native:cache/v20230301preview:Database to guarantee forwards compatibility.
 */
export class Database extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Database {
        pulumi.log.warn("Database is deprecated: azure-native:cache/v20210201preview:Database is being removed in the next major version of this provider. Please upgrade to azure-native:cache/v20230301preview:Database to guarantee forwards compatibility.")
        return new Database(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20210201preview:Database';
     ...
     */
    public readonly geoReplication!: pulumi.Output<outputs.cache.v20210201preview.DatabasePropertiesResponseGeoReplication | undefined>;
    /**
     * Optional set of redis modules to enable in this database - modules can only be added at creation time.
     */
    public readonly modules!: pulumi.Output<outputs.cache.v20210201preview.ModuleResponse[] | undefined>;
    /**
     ...
     */
    public readonly persistence!: pulumi.Output<outputs.cache.v20210201preview.PersistenceResponse | undefined>;
    /**
