 ...
 *
 * @deprecated azure-native:cache/v20210201preview:RedisEnterprise is being removed in the next major version of this provider. Please upgrade to azure-native:cache/v20230301preview:RedisEnterprise to guarantee forwards compatibility.
 */
export class RedisEnterprise extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RedisEnterprise {
        pulumi.log.warn("RedisEnterprise is deprecated: azure-native:cache/v20210201preview:RedisEnterprise is being removed in the next major version of this provider. Please upgrade to azure-native:cache/v20230301preview:RedisEnterprise to guarantee forwards compatibility.")
