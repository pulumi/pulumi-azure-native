...
// Export enums:
export * from "../../types/enums/cache/v20221101preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cache/v20221101preview:EnterpriseDatabase":
                return new EnterpriseDatabase(name, <any>undefined, { urn })
            case "azure-native:cache/v20221101preview:EnterprisePrivateEndpointConnection":
                return new EnterprisePrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:cache/v20221101preview:RedisEnterprise":
...
pulumi.runtime.registerResourceModule("azure-native", "cache/v20221101preview", _module)
