...
export class RedisLinkedServer extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cache.v20170201.RedisLinkedServerPropertiesResponse>;
    /**
     * Resource type.
     */
...
export interface RedisLinkedServerArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.cache.v20170201.RedisLinkedServerCreateProperties>;
    /**
