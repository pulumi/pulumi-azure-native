...
export function getPatchSchedule(args: GetPatchScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetPatchScheduleResult> {
    pulumi.log.warn("getPatchSchedule is deprecated: Version 2017-02-01 will be removed in v2 of the provider.")
...
export interface GetPatchScheduleResult {
     ...
     */
    readonly properties: outputs.cache.v20170201.ScheduleEntriesResponse;
    /**
     * Resource type.
     */
