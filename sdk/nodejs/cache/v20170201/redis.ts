...
export class Redis extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20170201:Redis';
     ...
     */
    public /*out*/ readonly enableNonSslPort!: pulumi.Output<boolean | undefined>;
    /**
     * Redis host name.
     */
     ...
     */
    public /*out*/ readonly redisConfiguration!: pulumi.Output<{[key: string]: string} | undefined>;
    /**
     * Redis version.
     */
     ...
     */
    public /*out*/ readonly shardCount!: pulumi.Output<number | undefined>;
    /**
     * The SKU of the Redis cache to deploy.
     */
    public /*out*/ readonly sku!: pulumi.Output<outputs.cache.v20170201.SkuResponse | undefined>;
    /**
     * Redis SSL port.
     */
     ...
     */
    public /*out*/ readonly staticIP!: pulumi.Output<string | undefined>;
    /**
     ...
     * tenantSettings
     */
    public /*out*/ readonly tenantSettings!: pulumi.Output<{[key: string]: string} | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: RedisArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache:Redis" }, { type: "azure-native:cache/v20150801:Redis" }, { type: "azure-native:cache/v20160401:Redis" }, { type: "azure-native:cache/v20171001:Redis" }, { type: "azure-native:cache/v20180301:Redis" }, { type: "azure-native:cache/v20190701:Redis" }, { type: "azure-native:cache/v20200601:Redis" }, { type: "azure-native:cache/v20201201:Redis" }, { type: "azure-native:cache/v20210601:Redis" }, { type: "azure-native:cache/v20220501:Redis" }, { type: "azure-native:cache/v20220601:Redis" }] };
...
export interface RedisArgs {
     ...
     */
    properties: pulumi.Input<inputs.cache.v20170201.RedisCreatePropertiesArgs>;
    /**
