...
export function getRedis(args: GetRedisArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisResult> {
    pulumi.log.warn("getRedis is deprecated: azure-native:cache/v20201201:Redis is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20220601:Redis to guarantee forwards compatibility.")
