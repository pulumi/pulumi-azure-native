...
export class LinkedServer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LinkedServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache:LinkedServer" }, { type: "azure-native:cache/v20200601:LinkedServer" }, { type: "azure-native:cache/v20210601:LinkedServer" }] };
