...
export function getPatchSchedule(args: GetPatchScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetPatchScheduleResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:cache/v20171001:getPatchSchedule", {
...
export interface GetPatchScheduleResult {
     ...
     */
    readonly scheduleEntries: outputs.cache.v20171001.ScheduleEntryInvokeResponse[];
    /**
     * Resource type.
     */
