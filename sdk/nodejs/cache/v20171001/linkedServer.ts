...
export class LinkedServer extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cache.v20171001.RedisLinkedServerPropertiesResponse>;
    /**
     * Resource type.
     */
...
export interface LinkedServerArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.cache.v20171001.RedisLinkedServerCreateProperties>;
    /**
