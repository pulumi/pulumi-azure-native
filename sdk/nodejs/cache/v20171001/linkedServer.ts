...
export class LinkedServer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LinkedServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cache/latest:LinkedServer" }, { type: "azurerm:cache/preview:LinkedServer" }, { type: "azurerm:cache/v20170201:LinkedServer" }, { type: "azurerm:cache/v20180301:LinkedServer" }, { type: "azurerm:cache/v20190701:LinkedServer" }] };
