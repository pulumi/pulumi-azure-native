 ...
 *
 * const redis = new azurerm.cache.v20171001.Redis("redis", {
...
export class Redis extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:cache/v20171001:Redis';
    ...
    constructor(name: string, args: RedisArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cache/latest:Redis" }, { type: "azurerm:cache/v20150801:Redis" }, { type: "azurerm:cache/v20160401:Redis" }, { type: "azurerm:cache/v20170201:Redis" }, { type: "azurerm:cache/v20180301:Redis" }, { type: "azurerm:cache/v20190701:Redis" }] };
...
export interface RedisArgs {
     ...
     * The SKU of the Redis cache to deploy.
     */
    readonly sku: pulumi.Input<inputs.cache.v20171001.Sku>;
    /**
     * Static IP address. Required when deploying a Redis cache inside an existing Azure Virtual Network.
     */
