...
export class PatchSchedule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cache.v20171001.ScheduleEntriesResponse>;
    /**
     * Resource type.
     */
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    readonly properties: pulumi.Input<inputs.cache.v20171001.ScheduleEntries>;
    /**
