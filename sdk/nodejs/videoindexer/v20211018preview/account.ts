...
export class Account extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:videoindexer/v20211018preview:Account" }, { type: "azure-native:videoindexer:Account" }, { type: "azure-nextgen:videoindexer:Account" }] };
