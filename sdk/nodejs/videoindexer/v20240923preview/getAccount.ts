...
export function getAccount(args: GetAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetAccountResult> {
    ...
    return pulumi.runtime.invoke("azure-native:videoindexer/v20240923preview:getAccount", {
...
export interface GetAccountResult {
     ...
     */
    readonly identity?: outputs.videoindexer.v20240923preview.ManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly openAiServices?: outputs.videoindexer.v20240923preview.OpenAiServicesForPutRequestResponse;
    /**
     ...
     */
    readonly storageServices?: outputs.videoindexer.v20240923preview.StorageServicesForPutRequestResponse;
    /**
     * The system meta data relating to this resource.
     */
    readonly systemData: outputs.videoindexer.v20240923preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getAccountOutput(args: GetAccountOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAccountResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:videoindexer/v20240923preview:getAccount", {
        "accountName": args.accountName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
