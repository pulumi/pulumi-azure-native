...
export class EnterpriseKnowledgeGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:enterpriseknowledgegraph/v20181203:EnterpriseKnowledgeGraph';
    ...
    constructor(name: string, argsOrState?: EnterpriseKnowledgeGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:enterpriseknowledgegraph/latest:EnterpriseKnowledgeGraph" }, { type: "azurerm:enterpriseknowledgegraph/preview:EnterpriseKnowledgeGraph" }] };
