...
export class EnterpriseKnowledgeGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:enterpriseknowledgegraph/latest:EnterpriseKnowledgeGraph';
