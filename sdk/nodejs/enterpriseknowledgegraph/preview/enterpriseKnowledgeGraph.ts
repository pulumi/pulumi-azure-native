...
export class EnterpriseKnowledgeGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:enterpriseknowledgegraph/preview:EnterpriseKnowledgeGraph';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.enterpriseknowledgegraph.preview.EnterpriseKnowledgeGraphPropertiesResponse>;
    /**
     * Gets or sets the SKU of the resource.
     */
    public readonly sku!: pulumi.Output<outputs.enterpriseknowledgegraph.preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: EnterpriseKnowledgeGraphArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as EnterpriseKnowledgeGraphArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:enterpriseknowledgegraph/latest:EnterpriseKnowledgeGraph" }, { type: "azurerm:enterpriseknowledgegraph/v20181203:EnterpriseKnowledgeGraph" }] };
...
export interface EnterpriseKnowledgeGraphArgs {
     ...
     * The set of properties specific to EnterpriseKnowledgeGraph resource
     */
    readonly properties?: pulumi.Input<inputs.enterpriseknowledgegraph.preview.EnterpriseKnowledgeGraphProperties>;
    /**
     ...
     * Gets or sets the SKU of the resource.
     */
    readonly sku?: pulumi.Input<inputs.enterpriseknowledgegraph.preview.Sku>;
    /**
     * Contains resource tags defined as key/value pairs.
     */
