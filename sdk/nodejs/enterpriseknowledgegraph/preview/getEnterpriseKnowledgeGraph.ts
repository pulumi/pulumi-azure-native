...
export function getEnterpriseKnowledgeGraph(args: GetEnterpriseKnowledgeGraphArgs, opts?: pulumi.InvokeOptions): Promise<GetEnterpriseKnowledgeGraphResult> {
    ...
    return pulumi.runtime.invoke("azurerm:enterpriseknowledgegraph/preview:getEnterpriseKnowledgeGraph", {
...
export interface GetEnterpriseKnowledgeGraphResult {
     ...
     */
    readonly properties: outputs.enterpriseknowledgegraph.preview.EnterpriseKnowledgeGraphPropertiesResponse;
    /**
     * Gets or sets the SKU of the resource.
     */
    readonly sku?: outputs.enterpriseknowledgegraph.preview.SkuResponse;
    /**
