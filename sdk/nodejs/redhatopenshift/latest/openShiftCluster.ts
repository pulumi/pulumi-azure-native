...
export class OpenShiftCluster extends pulumi.CustomResource {
     ...
     */
    public readonly apiserverProfile!: pulumi.Output<outputs.redhatopenshift.latest.APIServerProfileResponse | undefined>;
    /**
     * The cluster profile.
     */
    public readonly clusterProfile!: pulumi.Output<outputs.redhatopenshift.latest.ClusterProfileResponse | undefined>;
    /**
     * The console profile.
     */
    public readonly consoleProfile!: pulumi.Output<outputs.redhatopenshift.latest.ConsoleProfileResponse | undefined>;
    /**
     * The cluster ingress profiles.
     */
    public readonly ingressProfiles!: pulumi.Output<outputs.redhatopenshift.latest.IngressProfileResponse[] | undefined>;
    /**
     ...
     */
    public readonly masterProfile!: pulumi.Output<outputs.redhatopenshift.latest.MasterProfileResponse | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.redhatopenshift.latest.NetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly servicePrincipalProfile!: pulumi.Output<outputs.redhatopenshift.latest.ServicePrincipalProfileResponse | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly workerProfiles!: pulumi.Output<outputs.redhatopenshift.latest.WorkerProfileResponse[] | undefined>;
    ...
    constructor(name: string, args: OpenShiftClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:redhatopenshift/latest:OpenShiftCluster" }, { type: "azure-native:redhatopenshift:OpenShiftCluster" }, { type: "azure-nextgen:redhatopenshift:OpenShiftCluster" }, { type: "azure-native:redhatopenshift/v20200430:OpenShiftCluster" }, { type: "azure-nextgen:redhatopenshift/v20200430:OpenShiftCluster" }] };
...
export interface OpenShiftClusterArgs {
     ...
     * The cluster API server profile.
     */
    readonly apiserverProfile?: pulumi.Input<inputs.redhatopenshift.latest.APIServerProfile>;
    /**
     * The cluster profile.
     */
    readonly clusterProfile?: pulumi.Input<inputs.redhatopenshift.latest.ClusterProfile>;
    /**
     * The console profile.
     */
    readonly consoleProfile?: pulumi.Input<inputs.redhatopenshift.latest.ConsoleProfile>;
    /**
     * The cluster ingress profiles.
     */
    readonly ingressProfiles?: pulumi.Input<pulumi.Input<inputs.redhatopenshift.latest.IngressProfile>[]>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The cluster master profile.
     */
    readonly masterProfile?: pulumi.Input<inputs.redhatopenshift.latest.MasterProfile>;
    /**
     * The cluster network profile.
     */
    readonly networkProfile?: pulumi.Input<inputs.redhatopenshift.latest.NetworkProfile>;
    /**
     * The cluster provisioning state (immutable).
     */
     ...
     * The cluster service principal profile.
     */
    readonly servicePrincipalProfile?: pulumi.Input<inputs.redhatopenshift.latest.ServicePrincipalProfile>;
    /**
     * Resource tags.
     */
     ...
     * The cluster worker profiles.
     */
    readonly workerProfiles?: pulumi.Input<pulumi.Input<inputs.redhatopenshift.latest.WorkerProfile>[]>;
}
