 ...
 */
/** @deprecated Version 2020-04-30 will be removed in v2 of the provider. */
export function getOpenShiftCluster(args: GetOpenShiftClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetOpenShiftClusterResult> {
    pulumi.log.warn("getOpenShiftCluster is deprecated: Version 2020-04-30 will be removed in v2 of the provider.")
