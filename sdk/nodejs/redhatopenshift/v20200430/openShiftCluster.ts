...
export class OpenShiftCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OpenShiftClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:redhatopenshift:OpenShiftCluster" }, { type: "azure-nextgen:redhatopenshift:OpenShiftCluster" }, { type: "azure-native:redhatopenshift/latest:OpenShiftCluster" }, { type: "azure-nextgen:redhatopenshift/latest:OpenShiftCluster" }] };
