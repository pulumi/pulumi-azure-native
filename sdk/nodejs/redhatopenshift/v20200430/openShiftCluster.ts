...
export class OpenShiftCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OpenShiftClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:redhatopenshift/latest:OpenShiftCluster" }, { type: "azure-nextgen:redhatopenshift/v20210131preview:OpenShiftCluster" }] };
