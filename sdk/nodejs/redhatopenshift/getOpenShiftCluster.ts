...
export function getOpenShiftCluster(args: GetOpenShiftClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetOpenShiftClusterResult> {
    ...
    return pulumi.runtime.invoke("azurerm:redhatopenshift:getOpenShiftCluster", {
        "name": args.name,
...
export interface GetOpenShiftClusterResult {
     ...
     */
    readonly properties: outputs.redhatopenshift.OpenShiftClusterPropertiesResponse;
    /**
     * Resource tags.
     */
