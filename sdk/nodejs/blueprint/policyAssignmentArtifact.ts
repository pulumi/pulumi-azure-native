...
export class PolicyAssignmentArtifact extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PolicyAssignmentArtifactArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:blueprint/v20181101preview:PolicyAssignmentArtifact" }, { type: "azure-native:blueprint/v20181101preview:RoleAssignmentArtifact" }, { type: "azure-native:blueprint/v20181101preview:TemplateArtifact" }, { type: "azure-native:blueprint:RoleAssignmentArtifact" }, { type: "azure-native:blueprint:TemplateArtifact" }, { type: "azure-native_blueprint_v20181101preview:blueprint:PolicyAssignmentArtifact" }] };
