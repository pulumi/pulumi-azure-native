...
export class Assignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:blueprint:Assignment';
    ...
    constructor(name: string, args: AssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:blueprint/v20181101preview:Assignment" }] };
