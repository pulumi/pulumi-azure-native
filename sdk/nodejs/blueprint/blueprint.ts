...
export class Blueprint extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.blueprint.BlueprintPropertiesResponse>;
    /**
...
export interface BlueprintArgs {
     ...
     * Detailed properties for blueprint definition.
     */
    properties: pulumi.Input<inputs.blueprint.BlueprintPropertiesArgs>;
    /**
