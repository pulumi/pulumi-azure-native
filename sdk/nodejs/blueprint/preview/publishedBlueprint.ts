...
export class PublishedBlueprint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:blueprint/preview:PublishedBlueprint';
    ...
    constructor(name: string, args: PublishedBlueprintArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:blueprint/v20181101preview:PublishedBlueprint" }] };
