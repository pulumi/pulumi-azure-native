...
export class Assignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:blueprint/preview:Assignment';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.blueprint.preview.ManagedServiceIdentityResponse>;
    /**
     ...
     */
    public readonly locks!: pulumi.Output<outputs.blueprint.preview.AssignmentLockSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.blueprint.preview.ParameterValueResponse}>;
    /**
     ...
     */
    public readonly resourceGroups!: pulumi.Output<{[key: string]: outputs.blueprint.preview.ResourceGroupValueResponse}>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.blueprint.preview.AssignmentStatusResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: AssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:blueprint/v20181101preview:Assignment" }] };
...
export interface AssignmentArgs {
     ...
     * Managed identity for this blueprint assignment.
     */
    readonly identity: pulumi.Input<inputs.blueprint.preview.ManagedServiceIdentity>;
    /**
     * The location of this blueprint assignment.
     */
     ...
     * Defines how resources deployed by a blueprint assignment are locked.
     */
    readonly locks?: pulumi.Input<inputs.blueprint.preview.AssignmentLockSettings>;
    /**
     * Blueprint assignment parameter values.
     */
    readonly parameters: pulumi.Input<{[key: string]: pulumi.Input<inputs.blueprint.preview.ParameterValue>}>;
    /**
     * Names and locations of resource group placeholders.
     */
    readonly resourceGroups: pulumi.Input<{[key: string]: pulumi.Input<inputs.blueprint.preview.ResourceGroupValue>}>;
    /**
