...
export class Blueprint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Blueprint {
        return new Blueprint(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:blueprint/preview:Blueprint';
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.blueprint.preview.ParameterDefinitionResponse} | undefined>;
    /**
     * Resource group placeholders defined by this blueprint definition.
     */
    public readonly resourceGroups!: pulumi.Output<{[key: string]: outputs.blueprint.preview.ResourceGroupDefinitionResponse} | undefined>;
    /**
     * Status of the blueprint. This field is readonly.
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.blueprint.preview.BlueprintStatusResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: BlueprintArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:blueprint/v20181101preview:Blueprint" }] };
...
export interface BlueprintArgs {
     ...
     * Parameters required by this blueprint definition.
     */
    readonly parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.blueprint.preview.ParameterDefinition>}>;
    /**
     * Resource group placeholders defined by this blueprint definition.
     */
    readonly resourceGroups?: pulumi.Input<{[key: string]: pulumi.Input<inputs.blueprint.preview.ResourceGroupDefinition>}>;
    /**
