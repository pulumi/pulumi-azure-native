...
export class BrokerAuthentication extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BrokerAuthenticationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperationsmq/v20231004preview:BrokerAuthentication" }, { type: "azure-native_iotoperationsmq_v20231004preview:iotoperationsmq:BrokerAuthentication" }] };
