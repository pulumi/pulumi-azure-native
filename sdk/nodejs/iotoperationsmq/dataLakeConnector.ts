...
export class DataLakeConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataLakeConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperationsmq/v20231004preview:DataLakeConnector" }, { type: "azure-native_iotoperationsmq_v20231004preview:iotoperationsmq:DataLakeConnector" }] };
