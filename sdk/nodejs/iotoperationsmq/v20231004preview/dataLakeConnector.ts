...
export class DataLakeConnector extends pulumi.CustomResource {
     ...
     */
    public readonly target!: pulumi.Output<outputs.iotoperationsmq.v20231004preview.DataLakeTargetStorageResponse>;
    /**
...
export interface DataLakeConnectorArgs {
     ...
     * DataLake database format to use.
     */
    databaseFormat: pulumi.Input<string | enums.iotoperationsmq.v20231004preview.DataLakeDatabaseFormat>;
    /**
     * Extended Location
     */
     ...
     * The protocol to use for connecting with Brokers. NOTE - Enum only storage is supported at at time.
     */
    target: pulumi.Input<inputs.iotoperationsmq.v20231004preview.DataLakeTargetStorageArgs>;
}
