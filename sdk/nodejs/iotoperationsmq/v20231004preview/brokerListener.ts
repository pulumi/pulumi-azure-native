...
export class BrokerListener extends pulumi.CustomResource {
     ...
     */
    public readonly tls!: pulumi.Output<outputs.iotoperationsmq.v20231004preview.TlsCertMethodResponse | undefined>;
    /**
    ...
    constructor(name: string, args: BrokerListenerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["tls"] = args ? (args.tls ? pulumi.output(args.tls).apply(inputs.iotoperationsmq.v20231004preview.tlsCertMethodArgsProvideDefaults) : undefined) : undefined;
