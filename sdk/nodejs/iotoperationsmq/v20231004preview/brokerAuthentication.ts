...
export class BrokerAuthentication extends pulumi.CustomResource {
     ...
     */
    public readonly authenticationMethods!: pulumi.Output<outputs.iotoperationsmq.v20231004preview.BrokerAuthenticatorMethodsResponse[]>;
    /**
     * Extended Location
     */
...
export interface BrokerAuthenticationArgs {
     ...
     * The list of authentication methods supported by the Authentication Resource. For each array element, NOTE - Enum only authenticator type supported.
     */
    authenticationMethods: pulumi.Input<pulumi.Input<inputs.iotoperationsmq.v20231004preview.BrokerAuthenticatorMethodsArgs>[]>;
    /**
