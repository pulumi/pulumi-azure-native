...
export class DataLakeConnectorTopicMap extends pulumi.CustomResource {
     ...
     */
    public readonly mapping!: pulumi.Output<outputs.iotoperationsmq.v20231004preview.DataLakeConnectorMapResponse>;
    /**
    ...
    constructor(name: string, args: DataLakeConnectorTopicMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["mapping"] = args ? (args.mapping ? pulumi.output(args.mapping).apply(inputs.iotoperationsmq.v20231004preview.dataLakeConnectorMapArgsProvideDefaults) : undefined) : undefined;
...
export interface DataLakeConnectorTopicMapArgs {
     ...
     * TopicMap for DataLake connector.
     */
    mapping: pulumi.Input<inputs.iotoperationsmq.v20231004preview.DataLakeConnectorMapArgs>;
    /**
     * Name of MQ resource
     */
