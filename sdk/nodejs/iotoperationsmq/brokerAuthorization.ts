...
export class BrokerAuthorization extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BrokerAuthorizationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperationsmq/v20231004preview:BrokerAuthorization" }, { type: "azure-native_iotoperationsmq_v20231004preview:iotoperationsmq:BrokerAuthorization" }] };
