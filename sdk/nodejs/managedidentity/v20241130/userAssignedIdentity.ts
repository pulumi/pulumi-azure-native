...
export class UserAssignedIdentity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managedidentity/v20241130:UserAssignedIdentity';
     ...
     */
    public readonly isolationScope!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.managedidentity.v20241130.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: UserAssignedIdentityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["isolationScope"] = args ? args.isolationScope : undefined;
            ...
            resourceInputs["clientId"] = undefined /*out*/;
            resourceInputs["isolationScope"] = undefined /*out*/;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managedidentity/v20150831preview:UserAssignedIdentity" }, { type: "azure-native:managedidentity/v20181130:UserAssignedIdentity" }, { type: "azure-native:managedidentity/v20210930preview:UserAssignedIdentity" }, { type: "azure-native:managedidentity/v20220131preview:UserAssignedIdentity" }, { type: "azure-native:managedidentity/v20230131:UserAssignedIdentity" }, { type: "azure-native:managedidentity/v20230731preview:UserAssignedIdentity" }, { type: "azure-native:managedidentity/v20250131preview:UserAssignedIdentity" }, { type: "azure-native:managedidentity:UserAssignedIdentity" }] };
...
export interface UserAssignedIdentityArgs {
     ...
     * Enum to configure regional restrictions on identity assignment, as necessary.
     */
    isolationScope?: pulumi.Input<string | enums.managedidentity.v20241130.IsolationScope>;
    /**
     * The geo-location where the resource lives
     */
