...
export class UserAssignedIdentity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:managedidentity/preview:UserAssignedIdentity';
    ...
    constructor(name: string, argsOrState?: UserAssignedIdentityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:managedidentity/latest:UserAssignedIdentity" }, { type: "azurerm:managedidentity/v20150831preview:UserAssignedIdentity" }, { type: "azurerm:managedidentity/v20181130:UserAssignedIdentity" }] };
