 ...
 *
 * const federatedIdentityCredential = new azure_native.managedidentity.v20220131preview.FederatedIdentityCredential("federatedIdentityCredential", {
...
export class FederatedIdentityCredential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managedidentity/v20220131preview:FederatedIdentityCredential';
    ...
    constructor(name: string, args: FederatedIdentityCredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managedidentity:FederatedIdentityCredential" }, { type: "azure-native:managedidentity/v20230131:FederatedIdentityCredential" }] };
