...
export class UserAssignedIdentity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:managedidentity/v20150831preview:UserAssignedIdentity';
    ...
    constructor(name: string, args: UserAssignedIdentityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:managedidentity/latest:UserAssignedIdentity" }, { type: "azurerm:managedidentity/preview:UserAssignedIdentity" }, { type: "azurerm:managedidentity/v20181130:UserAssignedIdentity" }] };
