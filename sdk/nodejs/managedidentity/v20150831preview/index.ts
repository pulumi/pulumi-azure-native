...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:managedidentity/v20150831preview:UserAssignedIdentity":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "managedidentity/v20150831preview", _module)
