...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:managedidentity/v20210930preview:UserAssignedIdentity":
...
pulumi.runtime.registerResourceModule("azure-native", "managedidentity/v20210930preview", _module)
