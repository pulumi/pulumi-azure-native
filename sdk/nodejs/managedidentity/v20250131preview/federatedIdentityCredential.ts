...
export class FederatedIdentityCredential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managedidentity/v20250131preview:FederatedIdentityCredential';
     ...
     */
    public readonly claimsMatchingExpression!: pulumi.Output<outputs.managedidentity.v20250131preview.FederatedIdentityCredentialPropertiesResponseClaimsMatchingExpression | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.managedidentity.v20250131preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: FederatedIdentityCredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["claimsMatchingExpression"] = args ? args.claimsMatchingExpression : undefined;
            ...
            resourceInputs["claimsMatchingExpression"] = undefined /*out*/;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managedidentity/v20220131preview:FederatedIdentityCredential" }, { type: "azure-native:managedidentity/v20230131:FederatedIdentityCredential" }, { type: "azure-native:managedidentity/v20230731preview:FederatedIdentityCredential" }, { type: "azure-native:managedidentity/v20241130:FederatedIdentityCredential" }, { type: "azure-native:managedidentity:FederatedIdentityCredential" }] };
...
export interface FederatedIdentityCredentialArgs {
     ...
     * Object for defining the allowed identifiers of external identities. Either 'subject' or 'claimsMatchingExpression' must be defined, but not both.
     */
    claimsMatchingExpression?: pulumi.Input<inputs.managedidentity.v20250131preview.FederatedIdentityCredentialPropertiesClaimsMatchingExpressionArgs>;
    /**
