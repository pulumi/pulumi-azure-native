...
export class UserAssignedIdentity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:managedidentity/latest:UserAssignedIdentity';
    ...
    constructor(name: string, args: UserAssignedIdentityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:managedidentity/preview:UserAssignedIdentity" }, { type: "azurerm:managedidentity/v20150831preview:UserAssignedIdentity" }, { type: "azurerm:managedidentity/v20181130:UserAssignedIdentity" }] };
