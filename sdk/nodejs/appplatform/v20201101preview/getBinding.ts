...
export function getBinding(args: GetBindingArgs, opts?: pulumi.InvokeOptions): Promise<GetBindingResult> {
    pulumi.log.warn("getBinding is deprecated: azure-native:appplatform/v20201101preview:Binding is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:Binding to guarantee forwards compatibility.")
