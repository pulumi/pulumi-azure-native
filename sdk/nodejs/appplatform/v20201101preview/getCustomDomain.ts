...
export function getCustomDomain(args: GetCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomDomainResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:appplatform/v20201101preview:getCustomDomain", {
...
export interface GetCustomDomainResult {
     ...
     */
    readonly properties: outputs.appplatform.v20201101preview.CustomDomainPropertiesInvokeResponse;
    /**
