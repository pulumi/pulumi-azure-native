...
export class Binding extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BindingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:appplatform/latest:Binding" }, { type: "azure-nextgen:appplatform/v20190501preview:Binding" }, { type: "azure-nextgen:appplatform/v20200701:Binding" }] };
