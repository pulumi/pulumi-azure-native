...
export function getApiPortal(args: GetApiPortalArgs, opts?: pulumi.InvokeOptions): Promise<GetApiPortalResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230301preview:getApiPortal", {
...
export interface GetApiPortalResult {
     ...
     */
    readonly properties: outputs.appplatform.v20230301preview.ApiPortalPropertiesResponse;
    /**
     * Sku of the API portal resource
     */
    readonly sku?: outputs.appplatform.v20230301preview.SkuResponse;
    /**
...
export function getApiPortalOutput(args: GetApiPortalOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApiPortalResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:appplatform/v20230301preview:getApiPortal", {
        "apiPortalName": args.apiPortalName,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
    }, opts);
