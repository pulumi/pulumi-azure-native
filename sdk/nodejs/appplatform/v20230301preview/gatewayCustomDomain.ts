...
export class GatewayCustomDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GatewayCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20220101preview:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20230101preview:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20230501preview:GatewayCustomDomain" }] };
