...
export class ApiPortal extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230301preview:ApiPortal';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20230301preview.ApiPortalPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApiPortalArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.appplatform.v20230301preview.apiPortalPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface ApiPortalArgs {
     ...
     * API portal properties payload
     */
    properties?: pulumi.Input<inputs.appplatform.v20230301preview.ApiPortalPropertiesArgs>;
    /**
