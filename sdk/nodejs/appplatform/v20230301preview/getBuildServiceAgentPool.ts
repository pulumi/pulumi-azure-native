...
export function getBuildServiceAgentPool(args: GetBuildServiceAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildServiceAgentPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230301preview:getBuildServiceAgentPool", {
...
export interface GetBuildServiceAgentPoolResult {
     ...
     */
    readonly properties: outputs.appplatform.v20230301preview.BuildServiceAgentPoolPropertiesResponse;
    /**
...
export function getBuildServiceAgentPoolOutput(args: GetBuildServiceAgentPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBuildServiceAgentPoolResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:appplatform/v20230301preview:getBuildServiceAgentPool", {
        "agentPoolName": args.agentPoolName,
        "buildServiceName": args.buildServiceName,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
