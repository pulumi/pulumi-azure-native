...
export class GatewayCustomDomain extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GatewayCustomDomain {
        pulumi.log.warn("GatewayCustomDomain is deprecated: azure-native:appplatform/v20220901preview:GatewayCustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:GatewayCustomDomain to guarantee forwards compatibility.")
