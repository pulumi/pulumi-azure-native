...
export function getGatewayCustomDomain(args: GetGatewayCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayCustomDomainResult> {
    pulumi.log.warn("getGatewayCustomDomain is deprecated: azure-native:appplatform/v20220901preview:GatewayCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:GatewayCustomDomain to guarantee forwards compatibility.")
...
export interface GetGatewayCustomDomainResult {
     ...
     */
    readonly properties: outputs.appplatform.v20220901preview.GatewayCustomDomainPropertiesResponse;
    /**
