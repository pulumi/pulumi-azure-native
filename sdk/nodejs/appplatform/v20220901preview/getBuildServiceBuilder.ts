...
export function getBuildServiceBuilder(args: GetBuildServiceBuilderArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildServiceBuilderResult> {
    pulumi.log.warn("getBuildServiceBuilder is deprecated: azure-native:appplatform/v20220901preview:BuildServiceBuilder is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:BuildServiceBuilder to guarantee forwards compatibility.")
