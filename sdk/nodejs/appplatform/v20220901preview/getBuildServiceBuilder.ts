...
export function getBuildServiceBuilder(args: GetBuildServiceBuilderArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildServiceBuilderResult> {
    pulumi.log.warn("getBuildServiceBuilder is deprecated: azure-native:appplatform/v20220901preview:BuildServiceBuilder is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:BuildServiceBuilder to guarantee forwards compatibility.")
