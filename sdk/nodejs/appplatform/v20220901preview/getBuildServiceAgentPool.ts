...
export function getBuildServiceAgentPool(args: GetBuildServiceAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildServiceAgentPoolResult> {
    pulumi.log.warn("getBuildServiceAgentPool is deprecated: azure-native:appplatform/v20220901preview:BuildServiceAgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:BuildServiceAgentPool to guarantee forwards compatibility.")
...
export interface GetBuildServiceAgentPoolResult {
     ...
     */
    readonly properties: outputs.appplatform.v20220901preview.BuildServiceAgentPoolPropertiesResponse;
    /**
