...
export function getApplicationAccelerator(args: GetApplicationAcceleratorArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationAcceleratorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20231101preview:getApplicationAccelerator", {
...
export interface GetApplicationAcceleratorResult {
     ...
     */
    readonly properties: outputs.appplatform.v20231101preview.ApplicationAcceleratorPropertiesResponse;
    /**
     * Sku of the application accelerator resource
     */
    readonly sku?: outputs.appplatform.v20231101preview.SkuResponse;
    /**
