...
export class BuildServiceBuild extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20231101preview.BuildPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BuildServiceBuildArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.appplatform.v20231101preview.buildPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface BuildServiceBuildArgs {
     ...
     * Properties of the build resource
     */
    properties?: pulumi.Input<inputs.appplatform.v20231101preview.BuildPropertiesArgs>;
    /**
