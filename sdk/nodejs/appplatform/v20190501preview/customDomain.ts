...
export class CustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:appplatform/v20190501preview:CustomDomain';
    ...
    constructor(name: string, args: CustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appplatform/latest:CustomDomain" }, { type: "azurerm:appplatform/preview:CustomDomain" }, { type: "azurerm:appplatform/v20200701:CustomDomain" }] };
