 ...
 *
 * const binding = new azurerm.appplatform.v20190501preview.Binding("binding", {
 *     appName: "myapp",
...
export class Binding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:appplatform/v20190501preview:Binding';
    ...
    constructor(name: string, args: BindingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appplatform/latest:Binding" }, { type: "azurerm:appplatform/v20200701:Binding" }] };
