 ...
 *
 * const deployment = new azurerm.appplatform.v20190501preview.Deployment("deployment", {
 *     appName: "myapp",
...
export class Deployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:appplatform/v20190501preview:Deployment';
    ...
    constructor(name: string, args: DeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appplatform/latest:Deployment" }, { type: "azurerm:appplatform/v20200701:Deployment" }] };
