...
export class Deployment extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appplatform/latest:Deployment" }, { type: "azurerm:appplatform/preview:Deployment" }, { type: "azurerm:appplatform/v20200701:Deployment" }] };
