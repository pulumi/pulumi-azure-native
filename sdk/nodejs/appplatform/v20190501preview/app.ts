 ...
 *
 * const app = new azurerm.appplatform.v20190501preview.App("app", {
 *     appName: "myapp",
 *     location: "eastus",
...
export class App extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:appplatform/v20190501preview:App';
    ...
    constructor(name: string, args: AppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appplatform/latest:App" }, { type: "azurerm:appplatform/v20200701:App" }] };
