...
export interface GetConfigServerResult {
     ...
     */
    readonly properties: outputs.appplatform.v20240101preview.ConfigServerPropertiesResponse;
    /**
...
export function getConfigServerOutput(args: GetConfigServerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConfigServerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:appplatform/v20240101preview:getConfigServer", {
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
    }, opts);
}
