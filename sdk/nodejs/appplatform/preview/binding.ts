...
export class Binding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:appplatform/preview:Binding';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.preview.BindingResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BindingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appplatform/latest:Binding" }, { type: "azurerm:appplatform/v20190501preview:Binding" }, { type: "azurerm:appplatform/v20200701:Binding" }] };
...
export interface BindingArgs {
     ...
     * Properties of the Binding resource
     */
    readonly properties?: pulumi.Input<inputs.appplatform.preview.BindingResourceProperties>;
    /**
