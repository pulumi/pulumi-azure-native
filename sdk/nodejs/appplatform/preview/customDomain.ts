...
export class CustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:appplatform/preview:CustomDomain';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.preview.CustomDomainPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appplatform/latest:CustomDomain" }, { type: "azurerm:appplatform/v20190501preview:CustomDomain" }, { type: "azurerm:appplatform/v20200701:CustomDomain" }] };
...
export interface CustomDomainArgs {
     ...
     * Properties of the custom domain resource.
     */
    readonly properties?: pulumi.Input<inputs.appplatform.preview.CustomDomainProperties>;
    /**
