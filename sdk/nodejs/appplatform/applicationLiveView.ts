...
export class ApplicationLiveView extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.appplatform.ApplicationLiveViewPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApplicationLiveViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform/v20230101preview:ApplicationLiveView" }, { type: "azure-native:appplatform/v20230301preview:ApplicationLiveView" }, { type: "azure-native:appplatform/v20230501preview:ApplicationLiveView" }] };
