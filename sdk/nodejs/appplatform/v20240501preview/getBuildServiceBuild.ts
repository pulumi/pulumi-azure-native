...
export function getBuildServiceBuild(args: GetBuildServiceBuildArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildServiceBuildResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20240501preview:getBuildServiceBuild", {
...
export interface GetBuildServiceBuildResult {
     ...
     */
    readonly properties: outputs.appplatform.v20240501preview.BuildPropertiesResponse;
    /**
...
export function getBuildServiceBuildOutput(args: GetBuildServiceBuildOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBuildServiceBuildResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:appplatform/v20240501preview:getBuildServiceBuild", {
        "buildName": args.buildName,
        "buildServiceName": args.buildServiceName,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
