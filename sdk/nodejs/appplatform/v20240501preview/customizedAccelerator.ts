...
export class CustomizedAccelerator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20240501preview:CustomizedAccelerator';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20240501preview.CustomizedAcceleratorPropertiesResponse>;
    /**
     * Sku of the customized accelerator resource
     */
    public readonly sku!: pulumi.Output<outputs.appplatform.v20240501preview.SkuResponse | undefined>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.appplatform.v20240501preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: CustomizedAcceleratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["sku"] = args ? (args.sku ? pulumi.output(args.sku).apply(inputs.appplatform.v20240501preview.skuArgsProvideDefaults) : undefined) : undefined;
...
export interface CustomizedAcceleratorArgs {
     ...
     * Customized accelerator properties payload
     */
    properties?: pulumi.Input<inputs.appplatform.v20240501preview.CustomizedAcceleratorPropertiesArgs>;
    /**
     ...
     * Sku of the customized accelerator resource
     */
    sku?: pulumi.Input<inputs.appplatform.v20240501preview.SkuArgs>;
}
