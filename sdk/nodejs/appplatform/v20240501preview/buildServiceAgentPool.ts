...
export class BuildServiceAgentPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20240501preview:BuildServiceAgentPool';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20240501preview.BuildServiceAgentPoolPropertiesResponse>;
    /**
...
export interface BuildServiceAgentPoolArgs {
     ...
     * build service agent pool properties
     */
    properties?: pulumi.Input<inputs.appplatform.v20240501preview.BuildServiceAgentPoolPropertiesArgs>;
    /**
