...
export function getGateway(args: GetGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20240501preview:getGateway", {
...
export interface GetGatewayResult {
     ...
     */
    readonly properties: outputs.appplatform.v20240501preview.GatewayPropertiesResponse;
    /**
...
export function getGatewayOutput(args: GetGatewayOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetGatewayResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:appplatform/v20240501preview:getGateway", {
        "gatewayName": args.gatewayName,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
    }, opts);
