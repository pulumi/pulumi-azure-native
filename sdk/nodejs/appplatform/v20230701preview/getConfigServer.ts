...
export interface GetConfigServerResult {
     ...
     */
    readonly properties: outputs.appplatform.v20230701preview.ConfigServerPropertiesResponse;
    /**
...
export function getConfigServerOutput(args: GetConfigServerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConfigServerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:appplatform/v20230701preview:getConfigServer", {
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
    }, opts);
}
