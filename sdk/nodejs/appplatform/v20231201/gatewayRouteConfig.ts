...
export class GatewayRouteConfig extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20231201.GatewayRouteConfigPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: GatewayRouteConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.appplatform.v20231201.gatewayRouteConfigPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface GatewayRouteConfigArgs {
     ...
     * API route config of the Spring Cloud Gateway
     */
    properties?: pulumi.Input<inputs.appplatform.v20231201.GatewayRouteConfigPropertiesArgs>;
    /**
