...
export class ApiPortal extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20231201.ApiPortalPropertiesResponse>;
    /**
     * Sku of the API portal resource
     */
    public readonly sku!: pulumi.Output<outputs.appplatform.v20231201.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ApiPortalArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.appplatform.v20231201.apiPortalPropertiesArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["resourceGroupName"] = args ? args.resourceGroupName : undefined;
            resourceInputs["serviceName"] = args ? args.serviceName : undefined;
            resourceInputs["sku"] = args ? (args.sku ? pulumi.output(args.sku).apply(inputs.appplatform.v20231201.skuArgsProvideDefaults) : undefined) : undefined;
...
export interface ApiPortalArgs {
     ...
     * API portal properties payload
     */
    properties?: pulumi.Input<inputs.appplatform.v20231201.ApiPortalPropertiesArgs>;
    /**
     ...
     * Sku of the API portal resource
     */
    sku?: pulumi.Input<inputs.appplatform.v20231201.SkuArgs>;
}
