...
export class BuildServiceBuild extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20231201.BuildPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BuildServiceBuildArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.appplatform.v20231201.buildPropertiesArgsProvideDefaults) : undefined) : undefined;
