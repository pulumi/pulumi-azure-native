...
export interface GetGatewayRouteConfigResult {
     ...
     */
    readonly properties: outputs.appplatform.v20231201.GatewayRouteConfigPropertiesResponse;
    /**
...
export function getGatewayRouteConfigOutput(args: GetGatewayRouteConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGatewayRouteConfigResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:appplatform/v20231201:getGatewayRouteConfig", {
        "gatewayName": args.gatewayName,
        "resourceGroupName": args.resourceGroupName,
        "routeConfigName": args.routeConfigName,
        "serviceName": args.serviceName,
