...
export class Binding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20210601preview:Binding';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20210601preview.BindingResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BindingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:appplatform/v20210601preview:Binding" }, { type: "azure-native:appplatform:Binding" }, { type: "azure-nextgen:appplatform:Binding" }, { type: "azure-native:appplatform/v20190501preview:Binding" }, { type: "azure-nextgen:appplatform/v20190501preview:Binding" }, { type: "azure-native:appplatform/v20200701:Binding" }, { type: "azure-nextgen:appplatform/v20200701:Binding" }, { type: "azure-native:appplatform/v20201101preview:Binding" }, { type: "azure-nextgen:appplatform/v20201101preview:Binding" }] };
...
export interface BindingArgs {
     ...
     * Properties of the Binding resource
     */
    properties?: pulumi.Input<inputs.appplatform.v20210601preview.BindingResourcePropertiesArgs>;
    /**
