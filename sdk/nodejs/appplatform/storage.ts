...
export class Storage extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:appplatform:Storage" }, { type: "azure-native:appplatform/v20210901preview:Storage" }, { type: "azure-nextgen:appplatform/v20210901preview:Storage" }] };
