...
export class GatewayRouteConfig extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GatewayRouteConfig {
        pulumi.log.warn("GatewayRouteConfig is deprecated: azure-native:appplatform/v20221101preview:GatewayRouteConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:GatewayRouteConfig to guarantee forwards compatibility.")
        return new GatewayRouteConfig(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20221101preview:GatewayRouteConfig';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20221101preview.GatewayRouteConfigPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: GatewayRouteConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.appplatform.v20221101preview.gatewayRouteConfigPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface GatewayRouteConfigArgs {
     ...
     * API route config of the Spring Cloud Gateway
     */
    properties?: pulumi.Input<inputs.appplatform.v20221101preview.GatewayRouteConfigPropertiesArgs>;
    /**
