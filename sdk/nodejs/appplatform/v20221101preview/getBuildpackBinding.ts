...
export function getBuildpackBinding(args: GetBuildpackBindingArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildpackBindingResult> {
    pulumi.log.warn("getBuildpackBinding is deprecated: azure-native:appplatform/v20221101preview:BuildpackBinding is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:BuildpackBinding to guarantee forwards compatibility.")
...
export interface GetBuildpackBindingResult {
     ...
     */
    readonly properties: outputs.appplatform.v20221101preview.BuildpackBindingPropertiesResponse;
    /**
