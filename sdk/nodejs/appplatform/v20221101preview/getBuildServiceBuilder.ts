...
export function getBuildServiceBuilder(args: GetBuildServiceBuilderArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildServiceBuilderResult> {
    pulumi.log.warn("getBuildServiceBuilder is deprecated: azure-native:appplatform/v20221101preview:BuildServiceBuilder is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:BuildServiceBuilder to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:appplatform/v20221101preview:getBuildServiceBuilder", {
...
export interface GetBuildServiceBuilderResult {
     ...
     */
    readonly properties: outputs.appplatform.v20221101preview.BuilderPropertiesResponse;
    /**
