 ...
 *
 * @deprecated azure-native:appplatform/v20221101preview:ServiceRegistry is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:ServiceRegistry to guarantee forwards compatibility.
 */
export class ServiceRegistry extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceRegistry {
        pulumi.log.warn("ServiceRegistry is deprecated: azure-native:appplatform/v20221101preview:ServiceRegistry is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:ServiceRegistry to guarantee forwards compatibility.")
        return new ServiceRegistry(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20221101preview:ServiceRegistry';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.appplatform.v20221101preview.ServiceRegistryPropertiesResponse>;
    /**
