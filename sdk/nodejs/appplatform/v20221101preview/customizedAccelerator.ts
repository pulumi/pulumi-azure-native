...
export class CustomizedAccelerator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomizedAccelerator {
        pulumi.log.warn("CustomizedAccelerator is deprecated: azure-native:appplatform/v20221101preview:CustomizedAccelerator is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:CustomizedAccelerator to guarantee forwards compatibility.")
