...
export class CustomizedAccelerator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomizedAccelerator {
        pulumi.log.warn("CustomizedAccelerator is deprecated: azure-native:appplatform/v20221101preview:CustomizedAccelerator is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:CustomizedAccelerator to guarantee forwards compatibility.")
        return new CustomizedAccelerator(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20221101preview:CustomizedAccelerator';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20221101preview.CustomizedAcceleratorPropertiesResponse>;
    /**
...
export interface CustomizedAcceleratorArgs {
     ...
     * Customized accelerator properties payload
     */
    properties?: pulumi.Input<inputs.appplatform.v20221101preview.CustomizedAcceleratorPropertiesArgs>;
    /**
