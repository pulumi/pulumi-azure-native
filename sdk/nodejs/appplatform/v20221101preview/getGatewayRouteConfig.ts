 ...
 */
/** @deprecated azure-native:appplatform/v20221101preview:GatewayRouteConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:GatewayRouteConfig to guarantee forwards compatibility. */
export function getGatewayRouteConfig(args: GetGatewayRouteConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayRouteConfigResult> {
    pulumi.log.warn("getGatewayRouteConfig is deprecated: azure-native:appplatform/v20221101preview:GatewayRouteConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:GatewayRouteConfig to guarantee forwards compatibility.")
...
export interface GetGatewayRouteConfigResult {
     ...
     */
    readonly properties: outputs.appplatform.v20221101preview.GatewayRouteConfigPropertiesResponse;
    /**
