...
export function getBuildServiceAgentPool(args: GetBuildServiceAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildServiceAgentPoolResult> {
    pulumi.log.warn("getBuildServiceAgentPool is deprecated: azure-native:appplatform/v20221101preview:BuildServiceAgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:BuildServiceAgentPool to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:appplatform/v20221101preview:getBuildServiceAgentPool", {
...
export interface GetBuildServiceAgentPoolResult {
     ...
     */
    readonly properties: outputs.appplatform.v20221101preview.BuildServiceAgentPoolPropertiesResponse;
    /**
