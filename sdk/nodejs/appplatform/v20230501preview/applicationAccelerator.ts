...
export class ApplicationAccelerator extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.appplatform.v20230501preview.ApplicationAcceleratorPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApplicationAcceleratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:ApplicationAccelerator" }, { type: "azure-native:appplatform/v20230101preview:ApplicationAccelerator" }, { type: "azure-native:appplatform/v20230301preview:ApplicationAccelerator" }] };
