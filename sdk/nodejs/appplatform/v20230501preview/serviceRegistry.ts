...
export class ServiceRegistry extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.appplatform.v20230501preview.ServiceRegistryPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ServiceRegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:ServiceRegistry" }, { type: "azure-native:appplatform/v20220101preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20230101preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20230301preview:ServiceRegistry" }] };
