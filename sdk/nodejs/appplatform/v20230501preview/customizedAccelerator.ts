...
export class CustomizedAccelerator extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20230501preview.CustomizedAcceleratorPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CustomizedAcceleratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform/v20221101preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230101preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230301preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230701preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230901preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20231101preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20231201:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20240101preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20240501preview:CustomizedAccelerator" }, { type: "azure-native:appplatform:CustomizedAccelerator" }] };
...
export interface CustomizedAcceleratorArgs {
     ...
     * Customized accelerator properties payload
     */
    properties?: pulumi.Input<inputs.appplatform.v20230501preview.CustomizedAcceleratorPropertiesArgs>;
    /**
