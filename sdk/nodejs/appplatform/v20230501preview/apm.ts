...
export class Apm extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230501preview:Apm';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20230501preview.ApmPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApmArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform/v20230701preview:Apm" }, { type: "azure-native:appplatform/v20230901preview:Apm" }, { type: "azure-native:appplatform/v20231101preview:Apm" }, { type: "azure-native:appplatform/v20231201:Apm" }, { type: "azure-native:appplatform/v20240101preview:Apm" }, { type: "azure-native:appplatform/v20240501preview:Apm" }, { type: "azure-native:appplatform:Apm" }] };
...
export interface ApmArgs {
     ...
     * Properties of an APM
     */
    properties?: pulumi.Input<inputs.appplatform.v20230501preview.ApmPropertiesArgs>;
    /**
