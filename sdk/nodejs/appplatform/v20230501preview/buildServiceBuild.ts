...
export class BuildServiceBuild extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20230501preview.BuildPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BuildServiceBuildArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:BuildServiceBuild" }, { type: "azure-native:appplatform/v20230301preview:BuildServiceBuild" }, { type: "azure-native:appplatform/v20230701preview:BuildServiceBuild" }] };
