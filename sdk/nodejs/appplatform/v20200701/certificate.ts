 ...
 *
 * const certificate = new azurerm.appplatform.v20200701.Certificate("certificate", {
...
export class Certificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:appplatform/v20200701:Certificate';
    ...
    constructor(name: string, argsOrState?: CertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appplatform/latest:Certificate" }, { type: "azurerm:appplatform/v20190501preview:Certificate" }] };
