...
export class CustomDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:appplatform/latest:CustomDomain" }, { type: "azure-nextgen:appplatform/v20190501preview:CustomDomain" }, { type: "azure-nextgen:appplatform/v20201101preview:CustomDomain" }] };
