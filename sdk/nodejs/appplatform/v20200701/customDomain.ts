...
export class CustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:appplatform/v20200701:CustomDomain';
    ...
    constructor(name: string, args: CustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:appplatform:CustomDomain" }, { type: "azure-nextgen:appplatform/latest:CustomDomain" }, { type: "azure-nextgen:appplatform/v20190501preview:CustomDomain" }, { type: "azure-nextgen:appplatform/v20201101preview:CustomDomain" }] };
