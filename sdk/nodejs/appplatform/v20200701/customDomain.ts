...
export class CustomDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:CustomDomain" }, { type: "azure-nextgen:appplatform:CustomDomain" }, { type: "azure-native:appplatform/latest:CustomDomain" }, { type: "azure-nextgen:appplatform/latest:CustomDomain" }, { type: "azure-native:appplatform/v20190501preview:CustomDomain" }, { type: "azure-nextgen:appplatform/v20190501preview:CustomDomain" }, { type: "azure-native:appplatform/v20201101preview:CustomDomain" }, { type: "azure-nextgen:appplatform/v20201101preview:CustomDomain" }] };
