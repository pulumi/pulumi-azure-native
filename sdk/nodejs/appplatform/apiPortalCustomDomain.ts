...
export class ApiPortalCustomDomain extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.appplatform.ApiPortalCustomDomainPropertiesResponse>;
    /**
...
export interface ApiPortalCustomDomainArgs {
     ...
     * The properties of custom domain for API portal
     */
    properties?: pulumi.Input<inputs.appplatform.ApiPortalCustomDomainPropertiesArgs | undefined>;
    /**
