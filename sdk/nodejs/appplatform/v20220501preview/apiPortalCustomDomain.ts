...
export class ApiPortalCustomDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApiPortalCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20220101preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20220301preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20220901preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20221101preview:ApiPortalCustomDomain" }] };
