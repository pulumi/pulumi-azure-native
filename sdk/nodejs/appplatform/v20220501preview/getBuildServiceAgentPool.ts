...
export function getBuildServiceAgentPool(args: GetBuildServiceAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildServiceAgentPoolResult> {
    pulumi.log.warn("getBuildServiceAgentPool is deprecated: azure-native:appplatform/v20220501preview:BuildServiceAgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:BuildServiceAgentPool to guarantee forwards compatibility.")
