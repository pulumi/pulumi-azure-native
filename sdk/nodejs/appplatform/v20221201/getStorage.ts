...
export function getStorage(args: GetStorageArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageResult> {
    pulumi.log.warn("getStorage is deprecated: azure-native:appplatform/v20221201:Storage is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:Storage to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:appplatform/v20221201:getStorage", {
...
export interface GetStorageResult {
     ...
     */
    readonly properties: outputs.appplatform.v20221201.StorageAccountResponse;
    /**
