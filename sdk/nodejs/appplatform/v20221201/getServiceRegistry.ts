...
export function getServiceRegistry(args: GetServiceRegistryArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceRegistryResult> {
    pulumi.log.warn("getServiceRegistry is deprecated: azure-native:appplatform/v20221201:ServiceRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ServiceRegistry to guarantee forwards compatibility.")
...
export interface GetServiceRegistryResult {
     ...
     */
    readonly properties: outputs.appplatform.v20221201.ServiceRegistryPropertiesResponse;
    /**
