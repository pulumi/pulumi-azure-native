...
export class ServiceRegistry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20221201:ServiceRegistry';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.appplatform.v20221201.ServiceRegistryPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ServiceRegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:ServiceRegistry" }, { type: "azure-native:appplatform/v20220101preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20220301preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20220401:ServiceRegistry" }, { type: "azure-native:appplatform/v20220501preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20220901preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20221101preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20230101preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20230301preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20230501preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20230701preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20230901preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20231101preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20231201:ServiceRegistry" }, { type: "azure-native:appplatform/v20240101preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20240501preview:ServiceRegistry" }] };
