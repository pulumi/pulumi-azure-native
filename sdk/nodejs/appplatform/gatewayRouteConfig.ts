...
export class GatewayRouteConfig extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.GatewayRouteConfigPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: GatewayRouteConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform/v20220101preview:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20230101preview:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20230301preview:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20230501preview:GatewayRouteConfig" }] };
