...
export interface GetApiPortalResult {
     ...
     */
    readonly properties: outputs.appplatform.v20230901preview.ApiPortalPropertiesResponse;
    /**
     * Sku of the API portal resource
     */
    readonly sku?: outputs.appplatform.v20230901preview.SkuResponse;
    /**
...
export function getApiPortalOutput(args: GetApiPortalOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetApiPortalResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:appplatform/v20230901preview:getApiPortal", {
        "apiPortalName": args.apiPortalName,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
    }, opts);
