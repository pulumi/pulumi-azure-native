...
export interface GetApmResult {
     ...
     */
    readonly properties: outputs.appplatform.v20230901preview.ApmPropertiesResponse;
    /**
...
export function getApmOutput(args: GetApmOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetApmResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:appplatform/v20230901preview:getApm", {
        "apmName": args.apmName,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
    }, opts);
