...
export function getBinding(args: GetBindingArgs, opts?: pulumi.InvokeOptions): Promise<GetBindingResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20210303preview:getBinding", {
...
export interface GetBindingResult {
     ...
     */
    readonly properties: outputs.appplatform.v20210303preview.BindingResourcePropertiesResponse;
    /**
