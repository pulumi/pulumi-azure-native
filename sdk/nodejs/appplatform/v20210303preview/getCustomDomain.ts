...
export function getCustomDomain(args: GetCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomDomainResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20210303preview:getCustomDomain", {
...
export interface GetCustomDomainResult {
     ...
     */
    readonly properties: outputs.appplatform.v20210303preview.CustomDomainPropertiesResponse;
    /**
