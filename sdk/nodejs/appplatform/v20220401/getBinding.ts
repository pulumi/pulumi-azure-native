...
export function getBinding(args: GetBindingArgs, opts?: pulumi.InvokeOptions): Promise<GetBindingResult> {
    pulumi.log.warn("getBinding is deprecated: azure-native:appplatform/v20220401:Binding is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:Binding to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:appplatform/v20220401:getBinding", {
...
export interface GetBindingResult {
     ...
     */
    readonly properties: outputs.appplatform.v20220401.BindingResourcePropertiesResponse;
    /**
