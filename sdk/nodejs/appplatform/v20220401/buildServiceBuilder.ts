...
export class BuildServiceBuilder extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BuildServiceBuilderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20220101preview:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20220301preview:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20220501preview:BuildServiceBuilder" }] };
