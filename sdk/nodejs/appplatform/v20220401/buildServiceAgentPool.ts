 ...
 *
 * @deprecated azure-native:appplatform/v20220401:BuildServiceAgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:BuildServiceAgentPool to guarantee forwards compatibility.
 */
export class BuildServiceAgentPool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BuildServiceAgentPool {
        pulumi.log.warn("BuildServiceAgentPool is deprecated: azure-native:appplatform/v20220401:BuildServiceAgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:BuildServiceAgentPool to guarantee forwards compatibility.")
        return new BuildServiceAgentPool(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20220401:BuildServiceAgentPool';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20220401.BuildServiceAgentPoolPropertiesResponse>;
    /**
...
export interface BuildServiceAgentPoolArgs {
     ...
     * build service agent pool properties
     */
    properties?: pulumi.Input<inputs.appplatform.v20220401.BuildServiceAgentPoolPropertiesArgs>;
    /**
