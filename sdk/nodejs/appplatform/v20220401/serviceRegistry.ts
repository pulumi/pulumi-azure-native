...
export class ServiceRegistry extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServiceRegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:ServiceRegistry" }, { type: "azure-native:appplatform/v20220101preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20220301preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20220501preview:ServiceRegistry" }, { type: "azure-native:appplatform/v20220901preview:ServiceRegistry" }] };
