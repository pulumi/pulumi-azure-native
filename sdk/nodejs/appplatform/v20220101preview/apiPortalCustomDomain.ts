...
export class ApiPortalCustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20220101preview:ApiPortalCustomDomain';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20220101preview.ApiPortalCustomDomainPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApiPortalCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20220301preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20220501preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20220901preview:ApiPortalCustomDomain" }] };
