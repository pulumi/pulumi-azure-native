 ...
 *
 * const buildServiceAgentPool = new azure_native.appplatform.v20220101preview.BuildServiceAgentPool("buildServiceAgentPool", {
...
export class BuildServiceAgentPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20220101preview:BuildServiceAgentPool';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20220101preview.BuildServiceAgentPoolPropertiesResponse>;
    /**
...
export interface BuildServiceAgentPoolArgs {
     ...
     * build service agent pool properties
     */
    properties?: pulumi.Input<inputs.appplatform.v20220101preview.BuildServiceAgentPoolPropertiesArgs>;
    /**
