...
export class CustomDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: CustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appplatform/preview:CustomDomain" }, { type: "azurerm:appplatform/v20190501preview:CustomDomain" }, { type: "azurerm:appplatform/v20200701:CustomDomain" }] };
