...
export class Binding extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Binding {
        pulumi.log.warn("Binding is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:appplatform:Binding'.")
        return new Binding(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/latest:Binding';
    ...
    constructor(name: string, args: BindingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:appplatform/latest:Binding" }, { type: "azure-native:appplatform:Binding" }, { type: "azure-nextgen:appplatform:Binding" }, { type: "azure-native:appplatform/v20190501preview:Binding" }, { type: "azure-nextgen:appplatform/v20190501preview:Binding" }, { type: "azure-native:appplatform/v20200701:Binding" }, { type: "azure-nextgen:appplatform/v20200701:Binding" }, { type: "azure-native:appplatform/v20201101preview:Binding" }, { type: "azure-nextgen:appplatform/v20201101preview:Binding" }, { type: "azure-native:appplatform/v20210303preview:Binding" }, { type: "azure-nextgen:appplatform/v20210303preview:Binding" }] };
