...
export class Binding extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BindingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appplatform/preview:Binding" }, { type: "azurerm:appplatform/v20190501preview:Binding" }, { type: "azurerm:appplatform/v20200701:Binding" }] };
