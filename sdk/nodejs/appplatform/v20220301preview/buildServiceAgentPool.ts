...
export class BuildServiceAgentPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20220301preview:BuildServiceAgentPool';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20220301preview.BuildServiceAgentPoolPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BuildServiceAgentPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform/v20220101preview:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20220401:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20220501preview:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20220901preview:BuildServiceAgentPool" }] };
...
export interface BuildServiceAgentPoolArgs {
     ...
     * build service agent pool properties
     */
    properties?: pulumi.Input<inputs.appplatform.v20220301preview.BuildServiceAgentPoolPropertiesArgs>;
    /**
