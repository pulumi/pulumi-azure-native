 ...
 */
/** @deprecated azure-native:appplatform/v20220301preview:ApiPortalCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:ApiPortalCustomDomain to guarantee forwards compatibility. */
export function getApiPortalCustomDomain(args: GetApiPortalCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetApiPortalCustomDomainResult> {
    pulumi.log.warn("getApiPortalCustomDomain is deprecated: azure-native:appplatform/v20220301preview:ApiPortalCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:ApiPortalCustomDomain to guarantee forwards compatibility.")
