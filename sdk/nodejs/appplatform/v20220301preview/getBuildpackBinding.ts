...
export function getBuildpackBinding(args: GetBuildpackBindingArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildpackBindingResult> {
    pulumi.log.warn("getBuildpackBinding is deprecated: azure-native:appplatform/v20220301preview:BuildpackBinding is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:BuildpackBinding to guarantee forwards compatibility.")
