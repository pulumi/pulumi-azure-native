...
export class BuildServiceBuilder extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BuildServiceBuilder {
        pulumi.log.warn("BuildServiceBuilder is deprecated: azure-native:appplatform/v20220301preview:BuildServiceBuilder is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:BuildServiceBuilder to guarantee forwards compatibility.")
