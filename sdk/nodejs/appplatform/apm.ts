...
export class Apm extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.ApmPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApmArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform/v20230501preview:Apm" }, { type: "azure-native:appplatform/v20230701preview:Apm" }] };
