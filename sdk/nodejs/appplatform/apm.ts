...
export class Apm extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.appplatform.ApmPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApmArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if (args?.apmName === undefined && !opts.urn) {
                throw new Error("Missing required property 'apmName'");
            }
