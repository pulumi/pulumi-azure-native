...
export class CustomizedAccelerator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CustomizedAcceleratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform/v20221101preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230301preview:CustomizedAccelerator" }] };
