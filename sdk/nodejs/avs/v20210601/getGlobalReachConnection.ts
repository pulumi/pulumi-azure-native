...
export function getGlobalReachConnection(args: GetGlobalReachConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetGlobalReachConnectionResult> {
    pulumi.log.warn("getGlobalReachConnection is deprecated: azure-native:avs/v20210601:GlobalReachConnection is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:GlobalReachConnection to guarantee forwards compatibility.")
