...
export class WorkloadNetworkPublicIP extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkloadNetworkPublicIPArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs/v20210601:WorkloadNetworkPublicIP" }, { type: "azure-native:avs:WorkloadNetworkPublicIP" }, { type: "azure-nextgen:avs:WorkloadNetworkPublicIP" }] };
