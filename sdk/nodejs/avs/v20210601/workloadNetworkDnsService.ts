...
export class WorkloadNetworkDnsService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20210601:WorkloadNetworkDnsService';
    ...
    constructor(name: string, args: WorkloadNetworkDnsServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs/v20210601:WorkloadNetworkDnsService" }, { type: "azure-native:avs:WorkloadNetworkDnsService" }, { type: "azure-nextgen:avs:WorkloadNetworkDnsService" }, { type: "azure-native:avs/v20200717preview:WorkloadNetworkDnsService" }, { type: "azure-nextgen:avs/v20200717preview:WorkloadNetworkDnsService" }, { type: "azure-native:avs/v20210101preview:WorkloadNetworkDnsService" }, { type: "azure-nextgen:avs/v20210101preview:WorkloadNetworkDnsService" }, { type: "azure-native:avs/v20211201:WorkloadNetworkDnsService" }, { type: "azure-nextgen:avs/v20211201:WorkloadNetworkDnsService" }] };
...
export interface WorkloadNetworkDnsServiceArgs {
     ...
     * DNS Service log level.
     */
    logLevel?: pulumi.Input<string | enums.avs.v20210601.DnsServiceLogLevelEnum>;
    /**
