...
export function getHcxEnterpriseSite(args: GetHcxEnterpriseSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetHcxEnterpriseSiteResult> {
    pulumi.log.warn("getHcxEnterpriseSite is deprecated: azure-native:avs/v20210601:HcxEnterpriseSite is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:HcxEnterpriseSite to guarantee forwards compatibility.")
