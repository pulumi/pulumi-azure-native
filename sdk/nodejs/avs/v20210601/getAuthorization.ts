 ...
 */
/** @deprecated azure-native:avs/v20210601:Authorization is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:Authorization to guarantee forwards compatibility. */
export function getAuthorization(args: GetAuthorizationArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizationResult> {
    pulumi.log.warn("getAuthorization is deprecated: azure-native:avs/v20210601:Authorization is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:Authorization to guarantee forwards compatibility.")
