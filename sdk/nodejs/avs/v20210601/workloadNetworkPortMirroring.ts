 ...
 * NSX Port Mirroring
 *
 * @deprecated azure-native:avs/v20210601:WorkloadNetworkPortMirroring is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkPortMirroring to guarantee forwards compatibility.
 */
export class WorkloadNetworkPortMirroring extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkloadNetworkPortMirroring {
        pulumi.log.warn("WorkloadNetworkPortMirroring is deprecated: azure-native:avs/v20210601:WorkloadNetworkPortMirroring is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkPortMirroring to guarantee forwards compatibility.")
        return new WorkloadNetworkPortMirroring(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20210601:WorkloadNetworkPortMirroring';
    ...
    constructor(name: string, args: WorkloadNetworkPortMirroringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:WorkloadNetworkPortMirroring" }, { type: "azure-native:avs/v20200717preview:WorkloadNetworkPortMirroring" }, { type: "azure-native:avs/v20210101preview:WorkloadNetworkPortMirroring" }, { type: "azure-native:avs/v20211201:WorkloadNetworkPortMirroring" }, { type: "azure-native:avs/v20220501:WorkloadNetworkPortMirroring" }] };
...
export interface WorkloadNetworkPortMirroringArgs {
     ...
     * Direction of port mirroring profile.
     */
    direction?: pulumi.Input<string | enums.avs.v20210601.PortMirroringDirectionEnum>;
    /**
     * Display name of the port mirroring profile.
     */
