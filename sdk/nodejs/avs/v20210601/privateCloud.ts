...
export class PrivateCloud extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateCloud {
        pulumi.log.warn("PrivateCloud is deprecated: azure-native:avs/v20210601:PrivateCloud is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:PrivateCloud to guarantee forwards compatibility.")
        return new PrivateCloud(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20210601:PrivateCloud';
     ...
     */
    public /*out*/ readonly circuit!: pulumi.Output<outputs.avs.v20210601.CircuitResponse | undefined>;
    /**
     * The endpoints
     */
    public /*out*/ readonly endpoints!: pulumi.Output<outputs.avs.v20210601.EndpointsResponse>;
    /**
     ...
     */
    public readonly identitySources!: pulumi.Output<outputs.avs.v20210601.IdentitySourceResponse[] | undefined>;
    /**
     ...
     */
    public readonly managementCluster!: pulumi.Output<outputs.avs.v20210601.ManagementClusterResponse>;
    /**
    ...
    constructor(name: string, args: PrivateCloudArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:PrivateCloud" }, { type: "azure-native:avs/v20200320:PrivateCloud" }, { type: "azure-native:avs/v20200717preview:PrivateCloud" }, { type: "azure-native:avs/v20210101preview:PrivateCloud" }, { type: "azure-native:avs/v20211201:PrivateCloud" }, { type: "azure-native:avs/v20220501:PrivateCloud" }] };
...
export interface PrivateCloudArgs {
     ...
     * vCenter Single Sign On Identity Sources
     */
    identitySources?: pulumi.Input<pulumi.Input<inputs.avs.v20210601.IdentitySourceArgs>[]>;
    /**
     * Connectivity to internet is enabled or disabled
     */
    internet?: pulumi.Input<string | enums.avs.v20210601.InternetEnum>;
    /**
     * Resource location
     */
     ...
     * The default cluster used for management
     */
    managementCluster: pulumi.Input<inputs.avs.v20210601.ManagementClusterArgs>;
    /**
     * The block of addresses should be unique across VNet in your subscription as well as on-premise. Make sure the CIDR format is conformed to (A.B.C.D/X) where A,B,C,D are between 0 and 255, and X is between 0 and 22
     */
