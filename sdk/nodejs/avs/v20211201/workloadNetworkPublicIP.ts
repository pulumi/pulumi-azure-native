 ...
 * NSX Public IP Block
 *
 * @deprecated azure-native:avs/v20211201:WorkloadNetworkPublicIP is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkPublicIP to guarantee forwards compatibility.
 */
export class WorkloadNetworkPublicIP extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkloadNetworkPublicIP {
        pulumi.log.warn("WorkloadNetworkPublicIP is deprecated: azure-native:avs/v20211201:WorkloadNetworkPublicIP is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkPublicIP to guarantee forwards compatibility.")
        return new WorkloadNetworkPublicIP(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20211201:WorkloadNetworkPublicIP';
    ...
    constructor(name: string, args: WorkloadNetworkPublicIPArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:WorkloadNetworkPublicIP" }, { type: "azure-native:avs/v20210601:WorkloadNetworkPublicIP" }, { type: "azure-native:avs/v20220501:WorkloadNetworkPublicIP" }] };
