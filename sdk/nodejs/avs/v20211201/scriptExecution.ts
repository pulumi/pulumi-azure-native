 ...
 *
 * @deprecated azure-native:avs/v20211201:ScriptExecution is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:ScriptExecution to guarantee forwards compatibility.
 */
export class ScriptExecution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20211201:ScriptExecution';
     ...
     */
    public readonly hiddenParameters!: pulumi.Output<(outputs.avs.v20211201.PSCredentialExecutionParameterResponse | outputs.avs.v20211201.ScriptSecureStringExecutionParameterResponse | outputs.avs.v20211201.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
     ...
     */
    public readonly parameters!: pulumi.Output<(outputs.avs.v20211201.PSCredentialExecutionParameterResponse | outputs.avs.v20211201.ScriptSecureStringExecutionParameterResponse | outputs.avs.v20211201.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
    ...
    constructor(name: string, args: ScriptExecutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:ScriptExecution" }, { type: "azure-native:avs/v20210601:ScriptExecution" }, { type: "azure-native:avs/v20220501:ScriptExecution" }] };
