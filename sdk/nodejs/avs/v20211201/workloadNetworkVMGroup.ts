...
export class WorkloadNetworkVMGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20211201:WorkloadNetworkVMGroup';
    ...
    constructor(name: string, args: WorkloadNetworkVMGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs/v20211201:WorkloadNetworkVMGroup" }, { type: "azure-native:avs:WorkloadNetworkVMGroup" }, { type: "azure-nextgen:avs:WorkloadNetworkVMGroup" }, { type: "azure-native:avs/v20200717preview:WorkloadNetworkVMGroup" }, { type: "azure-nextgen:avs/v20200717preview:WorkloadNetworkVMGroup" }, { type: "azure-native:avs/v20210101preview:WorkloadNetworkVMGroup" }, { type: "azure-nextgen:avs/v20210101preview:WorkloadNetworkVMGroup" }, { type: "azure-native:avs/v20210601:WorkloadNetworkVMGroup" }, { type: "azure-nextgen:avs/v20210601:WorkloadNetworkVMGroup" }] };
