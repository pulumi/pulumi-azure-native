...
export class WorkloadNetworkSegment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkloadNetworkSegment {
        pulumi.log.warn("WorkloadNetworkSegment is deprecated: azure-native:avs/v20211201:WorkloadNetworkSegment is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkSegment to guarantee forwards compatibility.")
        return new WorkloadNetworkSegment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20211201:WorkloadNetworkSegment';
     ...
     */
    public /*out*/ readonly portVif!: pulumi.Output<outputs.avs.v20211201.WorkloadNetworkSegmentPortVifResponse[]>;
    /**
     ...
     */
    public readonly subnet!: pulumi.Output<outputs.avs.v20211201.WorkloadNetworkSegmentSubnetResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: WorkloadNetworkSegmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20200717preview:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20210101preview:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20210601:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20220501:WorkloadNetworkSegment" }] };
