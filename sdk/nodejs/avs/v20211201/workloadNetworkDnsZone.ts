...
export class WorkloadNetworkDnsZone extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkloadNetworkDnsZone {
        pulumi.log.warn("WorkloadNetworkDnsZone is deprecated: azure-native:avs/v20211201:WorkloadNetworkDnsZone is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkDnsZone to guarantee forwards compatibility.")
