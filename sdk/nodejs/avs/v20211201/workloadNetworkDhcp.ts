...
export class WorkloadNetworkDhcp extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkloadNetworkDhcp {
        pulumi.log.warn("WorkloadNetworkDhcp is deprecated: azure-native:avs/v20211201:WorkloadNetworkDhcp is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkDhcp to guarantee forwards compatibility.")
        return new WorkloadNetworkDhcp(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20211201:WorkloadNetworkDhcp';
     ...
     * DHCP properties.
     */
    public readonly properties!: pulumi.Output<outputs.avs.v20211201.WorkloadNetworkDhcpRelayResponse | outputs.avs.v20211201.WorkloadNetworkDhcpServerResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: WorkloadNetworkDhcpArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20200717preview:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20210101preview:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20210601:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20220501:WorkloadNetworkDhcp" }] };
