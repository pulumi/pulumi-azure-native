...
export class WorkloadNetworkDhcp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:avs:WorkloadNetworkDhcp';
    ...
    constructor(name: string, args: WorkloadNetworkDhcpArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs/v20200717preview:WorkloadNetworkDhcp" }, { type: "azure-nextgen:avs/v20210101preview:WorkloadNetworkDhcp" }] };
