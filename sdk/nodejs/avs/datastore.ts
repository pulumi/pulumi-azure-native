...
export class Datastore extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatastoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs:Datastore" }, { type: "azure-native:avs/v20210101preview:Datastore" }, { type: "azure-nextgen:avs/v20210101preview:Datastore" }] };
