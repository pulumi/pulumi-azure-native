...
export class WorkloadNetworkVMGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:avs:WorkloadNetworkVMGroup';
    ...
    constructor(name: string, args: WorkloadNetworkVMGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs/v20200717preview:WorkloadNetworkVMGroup" }, { type: "azure-nextgen:avs/v20210101preview:WorkloadNetworkVMGroup" }] };
