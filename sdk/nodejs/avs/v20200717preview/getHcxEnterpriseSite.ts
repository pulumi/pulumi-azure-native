 ...
 */
/** @deprecated azure-native:avs/v20200717preview:HcxEnterpriseSite is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:HcxEnterpriseSite to guarantee forwards compatibility. */
export function getHcxEnterpriseSite(args: GetHcxEnterpriseSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetHcxEnterpriseSiteResult> {
    pulumi.log.warn("getHcxEnterpriseSite is deprecated: azure-native:avs/v20200717preview:HcxEnterpriseSite is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:HcxEnterpriseSite to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:avs/v20200717preview:getHcxEnterpriseSite", {
