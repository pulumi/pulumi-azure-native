...
export class WorkloadNetworkVMGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkloadNetworkVMGroup {
        pulumi.log.warn("WorkloadNetworkVMGroup is deprecated: azure-native:avs/v20200717preview:WorkloadNetworkVMGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkVMGroup to guarantee forwards compatibility.")
