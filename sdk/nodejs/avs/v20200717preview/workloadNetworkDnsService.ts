...
export class WorkloadNetworkDnsService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:avs/v20200717preview:WorkloadNetworkDnsService';
    ...
    constructor(name: string, args: WorkloadNetworkDnsServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs:WorkloadNetworkDnsService" }, { type: "azure-nextgen:avs/v20210101preview:WorkloadNetworkDnsService" }] };
