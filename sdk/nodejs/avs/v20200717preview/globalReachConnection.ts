 ...
 *
 * const globalReachConnection = new azure_native.avs.v20200717preview.GlobalReachConnection("globalReachConnection", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:avs/v20200717preview:GlobalReachConnection connection1 /subscriptions/{subscription-id}/resourceGroups/group1/providers/Microsoft.AVS/privateClouds/cloud1/globalReachConnections/connection1 
 * ```
 */
export class GlobalReachConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20200717preview:GlobalReachConnection';
    ...
    constructor(name: string, args: GlobalReachConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:GlobalReachConnection" }, { type: "azure-native:avs/v20210101preview:GlobalReachConnection" }, { type: "azure-native:avs/v20210601:GlobalReachConnection" }, { type: "azure-native:avs/v20211201:GlobalReachConnection" }, { type: "azure-native:avs/v20220501:GlobalReachConnection" }] };
