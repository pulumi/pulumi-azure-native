...
export class GlobalReachConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GlobalReachConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:GlobalReachConnection" }, { type: "azure-nextgen:avs:GlobalReachConnection" }, { type: "azure-native:avs/v20210101preview:GlobalReachConnection" }, { type: "azure-nextgen:avs/v20210101preview:GlobalReachConnection" }] };
