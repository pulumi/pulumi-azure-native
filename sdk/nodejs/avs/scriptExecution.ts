...
export interface ScriptExecutionArgs {
     ...
     * Parameters that will be hidden/not visible to ARM, such as passwords and credentials
     */
    readonly hiddenParameters?: pulumi.Input<pulumi.Input<inputs.avs.PSCredentialExecutionParameterArgs | inputs.avs.ScriptSecureStringExecutionParameterArgs | inputs.avs.ScriptStringExecutionParameterArgs>[]>;
    /**
     * User-defined dictionary.
     */
     ...
     * Parameters the script will accept
     */
    readonly parameters?: pulumi.Input<pulumi.Input<inputs.avs.PSCredentialExecutionParameterArgs | inputs.avs.ScriptSecureStringExecutionParameterArgs | inputs.avs.ScriptStringExecutionParameterArgs>[]>;
    /**
