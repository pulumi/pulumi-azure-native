...
export class Authorization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:avs/preview:Authorization';
    ...
    constructor(name: string, args: AuthorizationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:avs/latest:Authorization" }, { type: "azurerm:avs/v20200320:Authorization" }] };
