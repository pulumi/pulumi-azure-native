...
export class HcxEnterpriseSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:avs/preview:HcxEnterpriseSite';
    ...
    constructor(name: string, argsOrState?: HcxEnterpriseSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:avs/latest:HcxEnterpriseSite" }, { type: "azurerm:avs/v20200320:HcxEnterpriseSite" }] };
