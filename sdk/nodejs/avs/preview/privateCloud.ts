...
export class PrivateCloud extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:avs/preview:PrivateCloud';
     ...
     */
    public /*out*/ readonly circuit!: pulumi.Output<outputs.avs.preview.CircuitResponse | undefined>;
    /**
     * The endpoints
     */
    public /*out*/ readonly endpoints!: pulumi.Output<outputs.avs.preview.EndpointsResponse>;
    /**
     * vCenter Single Sign On Identity Sources
     */
    public readonly identitySources!: pulumi.Output<outputs.avs.preview.IdentitySourceResponse[] | undefined>;
    /**
     ...
     */
    public readonly managementCluster!: pulumi.Output<outputs.avs.preview.ManagementClusterResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.avs.preview.SkuResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: PrivateCloudArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:avs/latest:PrivateCloud" }, { type: "azurerm:avs/v20190809preview:PrivateCloud" }, { type: "azurerm:avs/v20200320:PrivateCloud" }] };
...
export interface PrivateCloudArgs {
     ...
     * vCenter Single Sign On Identity Sources
     */
    readonly identitySources?: pulumi.Input<pulumi.Input<inputs.avs.preview.IdentitySource>[]>;
    /**
     * Connectivity to internet is enabled or disabled
     */
     ...
     * The default cluster used for management
     */
    readonly managementCluster: pulumi.Input<inputs.avs.preview.ManagementCluster>;
    /**
     * The block of addresses should be unique across VNet in your subscription as well as on-premise. Make sure the CIDR format is conformed to (A.B.C.D/X) where A,B,C,D are between 0 and 255, and X is between 0 and 22
     */
     ...
     * The private cloud SKU
     */
    readonly sku: pulumi.Input<inputs.avs.preview.Sku>;
    /**
     * Resource tags
     */
