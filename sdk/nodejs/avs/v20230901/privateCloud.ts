...
export class PrivateCloud extends pulumi.CustomResource {
     ...
     */
    public readonly availability!: pulumi.Output<outputs.avs.v20230901.AvailabilityPropertiesResponse | undefined>;
    /**
     * An ExpressRoute Circuit
     */
    public /*out*/ readonly circuit!: pulumi.Output<outputs.avs.v20230901.CircuitResponse | undefined>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.avs.v20230901.EncryptionResponse | undefined>;
    /**
     * The endpoints
     */
    public /*out*/ readonly endpoints!: pulumi.Output<outputs.avs.v20230901.EndpointsResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.avs.v20230901.SystemAssignedServiceIdentityResponse | undefined>;
    /**
     * vCenter Single Sign On Identity Sources
     */
    public readonly identitySources!: pulumi.Output<outputs.avs.v20230901.IdentitySourceResponse[] | undefined>;
    /**
     ...
     */
    public readonly managementCluster!: pulumi.Output<outputs.avs.v20230901.ManagementClusterResponse>;
    /**
     ...
     */
    public /*out*/ readonly secondaryCircuit!: pulumi.Output<outputs.avs.v20230901.CircuitResponse | undefined>;
    /**
...
export interface PrivateCloudArgs {
     ...
     * Properties describing how the cloud is distributed across availability zones
     */
    availability?: pulumi.Input<inputs.avs.v20230901.AvailabilityPropertiesArgs>;
    /**
     * The type of DNS zone to use.
     */
    dnsZoneType?: pulumi.Input<string | enums.avs.v20230901.DnsZoneType>;
    /**
     * Customer managed key encryption, can be enabled or disabled
     */
    encryption?: pulumi.Input<inputs.avs.v20230901.EncryptionArgs>;
    /**
     * Array of additional networks noncontiguous with networkBlock. Networks must be
     * unique and non-overlapping across VNet in your subscription, on-premise, and
     * this privateCloud networkBlock attribute. Make sure the CIDR format conforms to
     ...
     * The managed service identities assigned to this resource.
     */
    identity?: pulumi.Input<inputs.avs.v20230901.SystemAssignedServiceIdentityArgs>;
    /**
     * vCenter Single Sign On Identity Sources
     */
    identitySources?: pulumi.Input<pulumi.Input<inputs.avs.v20230901.IdentitySourceArgs>[]>;
    /**
     * Connectivity to internet is enabled or disabled
     */
    internet?: pulumi.Input<string | enums.avs.v20230901.InternetEnum>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The default cluster used for management
     */
    managementCluster: pulumi.Input<inputs.avs.v20230901.ManagementClusterArgs>;
    /**
     * The block of addresses should be unique across VNet in your subscription as
     * well as on-premise. Make sure the CIDR format is conformed to (A.B.C.D/X) where
     * A,B,C,D are between 0 and 255, and X is between 0 and 22
