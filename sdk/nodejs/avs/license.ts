...
export class License extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs:License';
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.avs.VmwareFirewallLicensePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LicenseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs/v20250901:License" }] };
