...
export class PrivateCloud extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:avs/v20190809preview:PrivateCloud';
    ...
    constructor(name: string, argsOrState?: PrivateCloudArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:avs/latest:PrivateCloud" }, { type: "azurerm:avs/preview:PrivateCloud" }, { type: "azurerm:avs/v20200320:PrivateCloud" }] };
