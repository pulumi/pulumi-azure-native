...
export class CloudLink extends pulumi.CustomResource {
     ...
     */
    declare public readonly linkedCloud: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: CloudLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["cloudLinkName"] = args?.cloudLinkName;
            resourceInputs["linkedCloud"] = args?.linkedCloud;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs/v20210601:CloudLink" }, { type: "azure-native:avs/v20211201:CloudLink" }, { type: "azure-native:avs/v20220501:CloudLink" }, { type: "azure-native:avs/v20230301:CloudLink" }, { type: "azure-native:avs/v20230901:CloudLink" }, { type: "azure-native:avs/v20240901:CloudLink" }] };
