 ...
 *
 * const workloadNetworkDhcp = new azure_native.avs.v20220501.WorkloadNetworkDhcp("workloadNetworkDhcp", {
 *     dhcpId: "dhcp1",
...
export class WorkloadNetworkDhcp extends pulumi.CustomResource {
     ...
     * DHCP properties.
     */
    public readonly properties!: pulumi.Output<outputs.avs.v20220501.WorkloadNetworkDhcpRelayResponse | outputs.avs.v20220501.WorkloadNetworkDhcpServerResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: WorkloadNetworkDhcpArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20200717preview:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20210101preview:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20210601:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20211201:WorkloadNetworkDhcp" }] };
