...
export class ScriptExecution extends pulumi.CustomResource {
     ...
     */
    public readonly hiddenParameters!: pulumi.Output<(outputs.avs.v20220501.PSCredentialExecutionParameterResponse | outputs.avs.v20220501.ScriptSecureStringExecutionParameterResponse | outputs.avs.v20220501.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
     ...
     */
    public readonly parameters!: pulumi.Output<(outputs.avs.v20220501.PSCredentialExecutionParameterResponse | outputs.avs.v20220501.ScriptSecureStringExecutionParameterResponse | outputs.avs.v20220501.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
    ...
    constructor(name: string, args: ScriptExecutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs/v20210601:ScriptExecution" }, { type: "azure-native:avs/v20211201:ScriptExecution" }, { type: "azure-native:avs/v20230301:ScriptExecution" }, { type: "azure-native:avs/v20230901:ScriptExecution" }, { type: "azure-native:avs:ScriptExecution" }] };
...
export interface ScriptExecutionArgs {
     ...
     * Parameters that will be hidden/not visible to ARM, such as passwords and credentials
     */
    hiddenParameters?: pulumi.Input<pulumi.Input<inputs.avs.v20220501.PSCredentialExecutionParameterArgs | inputs.avs.v20220501.ScriptSecureStringExecutionParameterArgs | inputs.avs.v20220501.ScriptStringExecutionParameterArgs>[]>;
    /**
     * User-defined dictionary.
     */
     ...
     * Parameters the script will accept
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.avs.v20220501.PSCredentialExecutionParameterArgs | inputs.avs.v20220501.ScriptSecureStringExecutionParameterArgs | inputs.avs.v20220501.ScriptStringExecutionParameterArgs>[]>;
    /**
