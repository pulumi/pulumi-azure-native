 ...
 *
 * const scriptExecution = new azure_native.avs.v20220501.ScriptExecution("scriptExecution", {
 *     hiddenParameters: [{
 *         name: "Password",
...
export class ScriptExecution extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ScriptExecutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:ScriptExecution" }, { type: "azure-native:avs/v20210601:ScriptExecution" }, { type: "azure-native:avs/v20211201:ScriptExecution" }] };
