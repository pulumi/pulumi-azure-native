...
export interface GetWorkloadNetworkSegmentResult {
     ...
     */
    readonly portVif: outputs.avs.v20220501.WorkloadNetworkSegmentPortVifResponse[];
    /**
     ...
     */
    readonly subnet?: outputs.avs.v20220501.WorkloadNetworkSegmentSubnetResponse;
    /**
     * Resource type.
     */
...
export function getWorkloadNetworkSegmentOutput(args: GetWorkloadNetworkSegmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkloadNetworkSegmentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:avs/v20220501:getWorkloadNetworkSegment", {
        "privateCloudName": args.privateCloudName,
        "resourceGroupName": args.resourceGroupName,
        "segmentId": args.segmentId,
    }, opts);
