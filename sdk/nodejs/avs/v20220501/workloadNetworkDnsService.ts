 ...
 *
 * const workloadNetworkDnsService = new azure_native.avs.v20220501.WorkloadNetworkDnsService("workloadNetworkDnsService", {
...
export class WorkloadNetworkDnsService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkloadNetworkDnsServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:WorkloadNetworkDnsService" }, { type: "azure-native:avs/v20200717preview:WorkloadNetworkDnsService" }, { type: "azure-native:avs/v20210101preview:WorkloadNetworkDnsService" }, { type: "azure-native:avs/v20210601:WorkloadNetworkDnsService" }, { type: "azure-native:avs/v20211201:WorkloadNetworkDnsService" }] };
...
export interface WorkloadNetworkDnsServiceArgs {
     ...
     * DNS Service log level.
     */
    logLevel?: pulumi.Input<string | enums.avs.v20220501.DnsServiceLogLevelEnum>;
    /**
