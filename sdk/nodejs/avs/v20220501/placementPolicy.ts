 ...
 *
 * const placementPolicy = new azure_native.avs.v20220501.PlacementPolicy("placementPolicy", {
...
export class PlacementPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.avs.v20220501.VmHostPlacementPolicyPropertiesResponse | outputs.avs.v20220501.VmVmPlacementPolicyPropertiesResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: PlacementPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:PlacementPolicy" }, { type: "azure-native:avs/v20211201:PlacementPolicy" }] };
