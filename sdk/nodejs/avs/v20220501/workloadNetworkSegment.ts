 ...
 *
 * const workloadNetworkSegment = new azure_native.avs.v20220501.WorkloadNetworkSegment("workloadNetworkSegment", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:avs/v20220501:WorkloadNetworkSegment segment1 /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/group1/providers/Microsoft.AVS/privateClouds/cloud1/workloadNetworks/default/segments/segment1 
 * ```
 */
export class WorkloadNetworkSegment extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly portVif!: pulumi.Output<outputs.avs.v20220501.WorkloadNetworkSegmentPortVifResponse[]>;
    /**
     ...
     */
    public readonly subnet!: pulumi.Output<outputs.avs.v20220501.WorkloadNetworkSegmentSubnetResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: WorkloadNetworkSegmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20200717preview:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20210101preview:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20210601:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20211201:WorkloadNetworkSegment" }] };
