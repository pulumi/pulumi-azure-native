 ...
 *
 * const workloadNetworkVMGroup = new azure_native.avs.v20220501.WorkloadNetworkVMGroup("workloadNetworkVMGroup", {
...
export class WorkloadNetworkVMGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkloadNetworkVMGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:WorkloadNetworkVMGroup" }, { type: "azure-native:avs/v20200717preview:WorkloadNetworkVMGroup" }, { type: "azure-native:avs/v20210101preview:WorkloadNetworkVMGroup" }, { type: "azure-native:avs/v20210601:WorkloadNetworkVMGroup" }, { type: "azure-native:avs/v20211201:WorkloadNetworkVMGroup" }] };
