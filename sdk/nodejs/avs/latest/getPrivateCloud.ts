...
export function getPrivateCloud(args: GetPrivateCloudArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateCloudResult> {
    pulumi.log.warn("getPrivateCloud is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:avs:getPrivateCloud'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-native:avs/latest:getPrivateCloud", {
