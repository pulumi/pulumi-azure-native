...
export function getHcxEnterpriseSite(args: GetHcxEnterpriseSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetHcxEnterpriseSiteResult> {
    pulumi.log.warn("getHcxEnterpriseSite is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:avs:getHcxEnterpriseSite'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-native:avs/latest:getHcxEnterpriseSite", {
