...
export class PrivateCloud extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/latest:PrivateCloud';
    ...
    constructor(name: string, args: PrivateCloudArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs/latest:PrivateCloud" }, { type: "azure-native:avs:PrivateCloud" }, { type: "azure-nextgen:avs:PrivateCloud" }, { type: "azure-native:avs/v20200320:PrivateCloud" }, { type: "azure-nextgen:avs/v20200320:PrivateCloud" }, { type: "azure-native:avs/v20200717preview:PrivateCloud" }, { type: "azure-nextgen:avs/v20200717preview:PrivateCloud" }, { type: "azure-native:avs/v20210101preview:PrivateCloud" }, { type: "azure-nextgen:avs/v20210101preview:PrivateCloud" }] };
...
export interface PrivateCloudArgs {
     ...
     * Connectivity to internet is enabled or disabled
     */
    readonly internet?: pulumi.Input<string | enums.avs.latest.InternetEnum>;
    /**
     * Resource location
     */
