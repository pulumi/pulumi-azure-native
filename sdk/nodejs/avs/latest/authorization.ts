...
export class Authorization extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AuthorizationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs/latest:Authorization" }, { type: "azure-native:avs:Authorization" }, { type: "azure-nextgen:avs:Authorization" }, { type: "azure-native:avs/v20200320:Authorization" }, { type: "azure-nextgen:avs/v20200320:Authorization" }, { type: "azure-native:avs/v20200717preview:Authorization" }, { type: "azure-nextgen:avs/v20200717preview:Authorization" }, { type: "azure-native:avs/v20210101preview:Authorization" }, { type: "azure-nextgen:avs/v20210101preview:Authorization" }] };
