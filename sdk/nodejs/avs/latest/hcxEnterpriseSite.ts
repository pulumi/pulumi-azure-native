...
export class HcxEnterpriseSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/latest:HcxEnterpriseSite';
