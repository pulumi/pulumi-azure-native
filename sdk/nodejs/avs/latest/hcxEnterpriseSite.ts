...
export class HcxEnterpriseSite extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HcxEnterpriseSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs:HcxEnterpriseSite" }, { type: "azure-nextgen:avs/v20200320:HcxEnterpriseSite" }, { type: "azure-nextgen:avs/v20200717preview:HcxEnterpriseSite" }] };
