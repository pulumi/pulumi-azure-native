...
export class Datastore extends pulumi.CustomResource {
     ...
     * An iSCSI volume
     */
    public readonly diskPoolVolume!: pulumi.Output<outputs.avs.v20230301.DiskPoolVolumeResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly netAppVolume!: pulumi.Output<outputs.avs.v20230301.NetAppVolumeResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DatastoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["diskPoolVolume"] = args ? (args.diskPoolVolume ? pulumi.output(args.diskPoolVolume).apply(inputs.avs.v20230301.diskPoolVolumeArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs/v20210101preview:Datastore" }, { type: "azure-native:avs/v20210601:Datastore" }, { type: "azure-native:avs/v20211201:Datastore" }, { type: "azure-native:avs/v20220501:Datastore" }, { type: "azure-native:avs/v20230901:Datastore" }, { type: "azure-native:avs:Datastore" }] };
...
export interface DatastoreArgs {
     ...
     * An iSCSI volume
     */
    diskPoolVolume?: pulumi.Input<inputs.avs.v20230301.DiskPoolVolumeArgs>;
    /**
     * An Azure NetApp Files volume
     */
    netAppVolume?: pulumi.Input<inputs.avs.v20230301.NetAppVolumeArgs>;
    /**
