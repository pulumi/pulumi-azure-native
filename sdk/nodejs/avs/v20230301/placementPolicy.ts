...
export class PlacementPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.avs.v20230301.VmHostPlacementPolicyPropertiesResponse | outputs.avs.v20230301.VmVmPlacementPolicyPropertiesResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: PlacementPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs/v20211201:PlacementPolicy" }, { type: "azure-native:avs/v20220501:PlacementPolicy" }, { type: "azure-native:avs/v20230901:PlacementPolicy" }, { type: "azure-native:avs:PlacementPolicy" }] };
...
export interface PlacementPolicyArgs {
     ...
     * placement policy properties
     */
    properties?: pulumi.Input<inputs.avs.v20230301.VmHostPlacementPolicyPropertiesArgs | inputs.avs.v20230301.VmVmPlacementPolicyPropertiesArgs>;
    /**
