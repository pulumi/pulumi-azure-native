...
export class PrivateCloud extends pulumi.CustomResource {
     ...
     */
    public readonly availability!: pulumi.Output<outputs.avs.v20230301.AvailabilityPropertiesResponse | undefined>;
    /**
     * An ExpressRoute Circuit
     */
    public /*out*/ readonly circuit!: pulumi.Output<outputs.avs.v20230301.CircuitResponse | undefined>;
    /**
     * Customer managed key encryption, can be enabled or disabled
     */
    public readonly encryption!: pulumi.Output<outputs.avs.v20230301.EncryptionResponse | undefined>;
    /**
     * The endpoints
     */
    public /*out*/ readonly endpoints!: pulumi.Output<outputs.avs.v20230301.EndpointsResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.avs.v20230301.PrivateCloudIdentityResponse | undefined>;
    /**
     * vCenter Single Sign On Identity Sources
     */
    public readonly identitySources!: pulumi.Output<outputs.avs.v20230301.IdentitySourceResponse[] | undefined>;
    /**
     ...
     */
    public readonly managementCluster!: pulumi.Output<outputs.avs.v20230301.ManagementClusterResponse>;
    /**
     ...
     */
    public /*out*/ readonly secondaryCircuit!: pulumi.Output<outputs.avs.v20230301.CircuitResponse | undefined>;
    /**
     * The private cloud SKU
     */
    public readonly sku!: pulumi.Output<outputs.avs.v20230301.SkuResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: PrivateCloudArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs/v20200320:PrivateCloud" }, { type: "azure-native:avs/v20200717preview:PrivateCloud" }, { type: "azure-native:avs/v20210101preview:PrivateCloud" }, { type: "azure-native:avs/v20210601:PrivateCloud" }, { type: "azure-native:avs/v20211201:PrivateCloud" }, { type: "azure-native:avs/v20220501:PrivateCloud" }, { type: "azure-native:avs/v20230901:PrivateCloud" }, { type: "azure-native:avs:PrivateCloud" }] };
...
export interface PrivateCloudArgs {
     ...
     * Properties describing how the cloud is distributed across availability zones
     */
    availability?: pulumi.Input<inputs.avs.v20230301.AvailabilityPropertiesArgs>;
    /**
     * Customer managed key encryption, can be enabled or disabled
     */
    encryption?: pulumi.Input<inputs.avs.v20230301.EncryptionArgs>;
    /**
     * Array of additional networks noncontiguous with networkBlock. Networks must be unique and non-overlapping across VNet in your subscription, on-premise, and this privateCloud networkBlock attribute. Make sure the CIDR format conforms to (A.B.C.D/X).
     */
     ...
     * The identity of the private cloud, if configured.
     */
    identity?: pulumi.Input<inputs.avs.v20230301.PrivateCloudIdentityArgs>;
    /**
     * vCenter Single Sign On Identity Sources
     */
    identitySources?: pulumi.Input<pulumi.Input<inputs.avs.v20230301.IdentitySourceArgs>[]>;
    /**
     * Connectivity to internet is enabled or disabled
     */
    internet?: pulumi.Input<string | enums.avs.v20230301.InternetEnum>;
    /**
     * Resource location
     */
     ...
     * The default cluster used for management
     */
    managementCluster: pulumi.Input<inputs.avs.v20230301.ManagementClusterArgs>;
    /**
     * The block of addresses should be unique across VNet in your subscription as well as on-premise. Make sure the CIDR format is conformed to (A.B.C.D/X) where A,B,C,D are between 0 and 255, and X is between 0 and 22
     */
     ...
     * The private cloud SKU
     */
    sku: pulumi.Input<inputs.avs.v20230301.SkuArgs>;
    /**
     * Resource tags
     */
