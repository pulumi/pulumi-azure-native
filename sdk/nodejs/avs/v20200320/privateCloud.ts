...
export class PrivateCloud extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateCloudArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs:PrivateCloud" }, { type: "azure-nextgen:avs/latest:PrivateCloud" }, { type: "azure-nextgen:avs/v20200717preview:PrivateCloud" }, { type: "azure-nextgen:avs/v20210101preview:PrivateCloud" }] };
