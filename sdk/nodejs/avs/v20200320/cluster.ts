...
export class Cluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs/latest:Cluster" }, { type: "azure-nextgen:avs/v20190809preview:Cluster" }, { type: "azure-nextgen:avs/v20200717preview:Cluster" }] };
