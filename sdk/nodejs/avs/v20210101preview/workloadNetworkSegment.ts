...
export class WorkloadNetworkSegment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:avs/v20210101preview:WorkloadNetworkSegment';
    ...
    constructor(name: string, args: WorkloadNetworkSegmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs:WorkloadNetworkSegment" }, { type: "azure-nextgen:avs/v20200717preview:WorkloadNetworkSegment" }] };
