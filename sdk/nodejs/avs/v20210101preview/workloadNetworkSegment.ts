...
export class WorkloadNetworkSegment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkloadNetworkSegmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:WorkloadNetworkSegment" }, { type: "azure-nextgen:avs:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20200717preview:WorkloadNetworkSegment" }, { type: "azure-nextgen:avs/v20200717preview:WorkloadNetworkSegment" }] };
