 ...
 * NSX Segment
 *
 * @deprecated azure-native:avs/v20210101preview:WorkloadNetworkSegment is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkSegment to guarantee forwards compatibility.
 */
export class WorkloadNetworkSegment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkloadNetworkSegment {
        pulumi.log.warn("WorkloadNetworkSegment is deprecated: azure-native:avs/v20210101preview:WorkloadNetworkSegment is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkSegment to guarantee forwards compatibility.")
