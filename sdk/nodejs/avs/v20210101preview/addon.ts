...
export class Addon extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AddonArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:Addon" }, { type: "azure-nextgen:avs:Addon" }, { type: "azure-native:avs/v20200717preview:Addon" }, { type: "azure-nextgen:avs/v20200717preview:Addon" }] };
