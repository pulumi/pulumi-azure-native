...
export class PrivateCloud extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateCloudArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs/v20210101preview:PrivateCloud" }, { type: "azure-native:avs:PrivateCloud" }, { type: "azure-nextgen:avs:PrivateCloud" }, { type: "azure-native:avs/latest:PrivateCloud" }, { type: "azure-nextgen:avs/latest:PrivateCloud" }, { type: "azure-native:avs/v20200320:PrivateCloud" }, { type: "azure-nextgen:avs/v20200320:PrivateCloud" }, { type: "azure-native:avs/v20200717preview:PrivateCloud" }, { type: "azure-nextgen:avs/v20200717preview:PrivateCloud" }] };
...
export interface PrivateCloudArgs {
     ...
     * vCenter Single Sign On Identity Sources
     */
    readonly identitySources?: pulumi.Input<pulumi.Input<inputs.avs.v20210101preview.IdentitySource>[]>;
    /**
     * Connectivity to internet is enabled or disabled
     */
     ...
     * The default cluster used for management
     */
    readonly managementCluster: pulumi.Input<inputs.avs.v20210101preview.ManagementCluster>;
    /**
     * The block of addresses should be unique across VNet in your subscription as well as on-premise. Make sure the CIDR format is conformed to (A.B.C.D/X) where A,B,C,D are between 0 and 255, and X is between 0 and 22
     */
