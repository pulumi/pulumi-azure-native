...
export function getWorkloadNetworkDnsService(args: GetWorkloadNetworkDnsServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkloadNetworkDnsServiceResult> {
    pulumi.log.warn("getWorkloadNetworkDnsService is deprecated: azure-native:avs/v20210101preview:WorkloadNetworkDnsService is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkDnsService to guarantee forwards compatibility.")
