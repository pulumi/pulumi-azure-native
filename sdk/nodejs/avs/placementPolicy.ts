...
export class PlacementPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PlacementPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["placementPolicyName"] = args ? args.placementPolicyName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs:PlacementPolicy" }, { type: "azure-native:avs/v20211201:PlacementPolicy" }, { type: "azure-nextgen:avs/v20211201:PlacementPolicy" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(PlacementPolicy.__pulumiType, name, inputs, opts);
    }
}
