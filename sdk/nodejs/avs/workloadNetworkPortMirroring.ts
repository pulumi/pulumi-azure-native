...
export class WorkloadNetworkPortMirroring extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:avs:WorkloadNetworkPortMirroring';
    ...
    constructor(name: string, args: WorkloadNetworkPortMirroringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs/v20200717preview:WorkloadNetworkPortMirroring" }, { type: "azure-nextgen:avs/v20210101preview:WorkloadNetworkPortMirroring" }] };
