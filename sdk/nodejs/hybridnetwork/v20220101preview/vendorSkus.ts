 ...
 *
 * const vendorSkus = new azure_native.hybridnetwork.v20220101preview.VendorSkus("vendorSkus", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:hybridnetwork/v20220101preview:VendorSkus TestSku /subscriptions/subid/providers/Microsoft.HybridNetwork/vendors/TestVendor/vendorskus/TestSku 
 * ```
 */
export class VendorSkus extends pulumi.CustomResource {
     ...
     */
    public readonly networkFunctionTemplate!: pulumi.Output<outputs.hybridnetwork.v20220101preview.NetworkFunctionTemplateResponse | undefined>;
    /**
