...
export class Vendor extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly skus!: pulumi.Output<outputs.hybridnetwork.v20220101preview.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, args?: VendorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridnetwork/v20200101preview:Vendor" }, { type: "azure-native:hybridnetwork/v20210501:Vendor" }, { type: "azure-native:hybridnetwork:Vendor" }] };
