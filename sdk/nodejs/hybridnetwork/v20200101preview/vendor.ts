...
export class Vendor extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Vendor {
        return new Vendor(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: VendorArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as VendorArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridnetwork/preview:Vendor" }] };
