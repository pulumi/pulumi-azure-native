...
export class VirtualNetworkFunction extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkFunction {
        return new VirtualNetworkFunction(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: VirtualNetworkFunctionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as VirtualNetworkFunctionArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridnetwork/preview:VirtualNetworkFunction" }] };
