 ...
 *
 * const networkFunction = new azure_native.hybridnetwork.v20200101preview.NetworkFunction("networkFunction", {
 *     device: {
...
export class NetworkFunction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridnetwork/v20200101preview:NetworkFunction';
    ...
    constructor(name: string, args: NetworkFunctionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridnetwork:NetworkFunction" }, { type: "azure-native:hybridnetwork/v20210501:NetworkFunction" }, { type: "azure-native:hybridnetwork/v20220101preview:NetworkFunction" }] };
