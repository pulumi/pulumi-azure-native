...
export function getDevice(args: GetDeviceArgs, opts?: pulumi.InvokeOptions): Promise<GetDeviceResult> {
    pulumi.log.warn("getDevice is deprecated: azure-native:hybridnetwork/v20200101preview:Device is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridnetwork/v20220101preview:Device to guarantee forwards compatibility.")
