...
export class Vendor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybridnetwork/preview:Vendor';
     ...
     */
    public /*out*/ readonly skus!: pulumi.Output<outputs.hybridnetwork.preview.SubResourceResponse[]>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: VendorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridnetwork/v20200101preview:Vendor" }] };
