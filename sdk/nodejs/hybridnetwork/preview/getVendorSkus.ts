...
export function getVendorSkus(args: GetVendorSkusArgs, opts?: pulumi.InvokeOptions): Promise<GetVendorSkusResult> {
    ...
    return pulumi.runtime.invoke("azurerm:hybridnetwork/preview:getVendorSkus", {
...
export interface GetVendorSkusResult {
     ...
     */
    readonly virtualNetworkFunctionTemplate?: outputs.hybridnetwork.preview.VirtualNetworkFunctionTemplateResponse;
}
