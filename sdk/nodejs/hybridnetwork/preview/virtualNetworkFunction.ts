...
export class VirtualNetworkFunction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybridnetwork/preview:VirtualNetworkFunction';
     ...
     */
    public readonly device!: pulumi.Output<outputs.hybridnetwork.preview.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly managedApplication!: pulumi.Output<outputs.hybridnetwork.preview.SubResourceResponse>;
    /**
     ...
     */
    public readonly virtualNetworkFunctionUserConfigurations!: pulumi.Output<outputs.hybridnetwork.preview.VirtualNetworkFunctionUserConfigurationResponse[] | undefined>;
    ...
    constructor(name: string, args: VirtualNetworkFunctionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridnetwork/v20200101preview:VirtualNetworkFunction" }] };
...
export interface VirtualNetworkFunctionArgs {
     ...
     * The reference to the hybrid network device.
     */
    readonly device?: pulumi.Input<inputs.hybridnetwork.preview.SubResource>;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * The virtual network function configurations from the user.
     */
    readonly virtualNetworkFunctionUserConfigurations?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.preview.VirtualNetworkFunctionUserConfiguration>[]>;
}
