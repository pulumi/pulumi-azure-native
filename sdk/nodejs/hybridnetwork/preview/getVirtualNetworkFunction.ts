...
export function getVirtualNetworkFunction(args: GetVirtualNetworkFunctionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkFunctionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:hybridnetwork/preview:getVirtualNetworkFunction", {
...
export interface GetVirtualNetworkFunctionResult {
     ...
     */
    readonly device?: outputs.hybridnetwork.preview.SubResourceResponse;
    /**
     ...
     */
    readonly managedApplication: outputs.hybridnetwork.preview.SubResourceResponse;
    /**
     ...
     */
    readonly virtualNetworkFunctionUserConfigurations?: outputs.hybridnetwork.preview.VirtualNetworkFunctionUserConfigurationResponse[];
}
