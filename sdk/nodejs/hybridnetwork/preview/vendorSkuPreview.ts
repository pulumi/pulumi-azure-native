...
export class VendorSkuPreview extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybridnetwork/preview:VendorSkuPreview';
    ...
    constructor(name: string, args: VendorSkuPreviewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridnetwork/v20200101preview:VendorSkuPreview" }] };
