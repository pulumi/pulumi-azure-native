...
export class Device extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DeviceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridnetwork/v20200101preview:Device" }, { type: "azure-nextgen:hybridnetwork/v20200101preview:Device" }] };
...
export interface DeviceArgs {
     ...
     * The reference to the Azure stack edge device.
     */
    readonly azureStackEdge?: pulumi.Input<inputs.hybridnetwork.SubResource>;
    /**
