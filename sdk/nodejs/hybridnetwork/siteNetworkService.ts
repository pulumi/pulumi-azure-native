...
export class SiteNetworkService extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.hybridnetwork.SiteNetworkServicePropertiesFormatResponse>;
    /**
     * Sku of the site network service.
     */
    declare public readonly sku: pulumi.Output<outputs.hybridnetwork.SkuResponse | undefined>;
    /**
