...
export class NetworkFunction extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkFunction {
        pulumi.log.warn("NetworkFunction is deprecated: azure-native:hybridnetwork/v20210501:NetworkFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridnetwork/v20220101preview:NetworkFunction to guarantee forwards compatibility.")
        return new NetworkFunction(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridnetwork/v20210501:NetworkFunction';
     ...
     */
    public readonly device!: pulumi.Output<outputs.hybridnetwork.v20210501.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly managedApplication!: pulumi.Output<outputs.hybridnetwork.v20210501.SubResourceResponse>;
    /**
     ...
     */
    public readonly networkFunctionUserConfigurations!: pulumi.Output<outputs.hybridnetwork.v20210501.NetworkFunctionUserConfigurationResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: NetworkFunctionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridnetwork:NetworkFunction" }, { type: "azure-native:hybridnetwork/v20200101preview:NetworkFunction" }, { type: "azure-native:hybridnetwork/v20220101preview:NetworkFunction" }] };
