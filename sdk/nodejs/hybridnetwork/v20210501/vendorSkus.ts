 ...
 * Sku sub resource.
 *
 * @deprecated azure-native:hybridnetwork/v20210501:VendorSkus is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridnetwork/v20220101preview:VendorSkus to guarantee forwards compatibility.
 */
export class VendorSkus extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VendorSkus {
        pulumi.log.warn("VendorSkus is deprecated: azure-native:hybridnetwork/v20210501:VendorSkus is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridnetwork/v20220101preview:VendorSkus to guarantee forwards compatibility.")
        return new VendorSkus(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridnetwork/v20210501:VendorSkus';
     ...
     */
    public readonly networkFunctionTemplate!: pulumi.Output<outputs.hybridnetwork.v20210501.NetworkFunctionTemplateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VendorSkusArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridnetwork:VendorSkus" }, { type: "azure-native:hybridnetwork/v20200101preview:VendorSkus" }, { type: "azure-native:hybridnetwork/v20220101preview:VendorSkus" }] };
...
export interface VendorSkusArgs {
     ...
     * The sku deployment mode.
     */
    deploymentMode?: pulumi.Input<string | enums.hybridnetwork.v20210501.SkuDeploymentMode>;
    /**
     * The parameters for the managed application to be supplied by the vendor.
     */
     ...
     * The template definition of the network function.
     */
    networkFunctionTemplate?: pulumi.Input<inputs.hybridnetwork.v20210501.NetworkFunctionTemplateArgs>;
    /**
     * The network function type.
     */
    networkFunctionType?: pulumi.Input<string | enums.hybridnetwork.v20210501.NetworkFunctionType>;
    /**
     * Indicates if the vendor sku is in preview mode.
     */
     ...
     * The sku type.
     */
    skuType?: pulumi.Input<string | enums.hybridnetwork.v20210501.SkuType>;
    /**
