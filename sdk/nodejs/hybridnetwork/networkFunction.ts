...
export class NetworkFunction extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkFunctionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            if ((!args || args.networkFunctionName === undefined) && !(opts && opts.urn)) {
...
export interface NetworkFunctionArgs {
     ...
     * The reference to the device resource.
     */
    readonly device?: pulumi.Input<inputs.hybridnetwork.SubResource>;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * The network function configurations from the user.
     */
    readonly networkFunctionUserConfigurations?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.NetworkFunctionUserConfiguration>[]>;
    /**
