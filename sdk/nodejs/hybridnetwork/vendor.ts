...
export class Vendor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:hybridnetwork:Vendor';
    ...
    constructor(name: string, args?: VendorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hybridnetwork/v20200101preview:Vendor" }] };
