...
export class VendorSkus extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VendorSkusArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hybridnetwork:VendorSkus" }, { type: "azure-native:hybridnetwork/v20200101preview:VendorSkus" }, { type: "azure-nextgen:hybridnetwork/v20200101preview:VendorSkus" }] };
...
export interface VendorSkusArgs {
     ...
     * The sku deployment mode.
     */
    readonly deploymentMode?: pulumi.Input<string | enums.hybridnetwork.SkuDeploymentMode>;
    /**
     * The parameters for the managed application to be supplied by the vendor.
     */
     ...
     * The template definition of the network function.
     */
    readonly networkFunctionTemplate?: pulumi.Input<inputs.hybridnetwork.NetworkFunctionTemplateArgs>;
    /**
     * Indicates if the vendor sku is in preview mode.
     */
     ...
     * The sku type.
     */
    readonly skuType?: pulumi.Input<string | enums.hybridnetwork.SkuType>;
    /**
