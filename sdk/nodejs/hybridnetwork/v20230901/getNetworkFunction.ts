...
export interface GetNetworkFunctionResult {
     ...
     */
    readonly properties: outputs.hybridnetwork.v20230901.NetworkFunctionValueWithSecretsResponse | outputs.hybridnetwork.v20230901.NetworkFunctionValueWithoutSecretsResponse;
    /**
...
export function getNetworkFunctionOutput(args: GetNetworkFunctionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetNetworkFunctionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:hybridnetwork/v20230901:getNetworkFunction", {
        "networkFunctionName": args.networkFunctionName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
