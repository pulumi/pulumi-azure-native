...
export class NetworkServiceDesignVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridnetwork/v20240415:NetworkServiceDesignVersion';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.hybridnetwork.v20240415.NetworkServiceDesignVersionPropertiesFormatResponse>;
    /**
    ...
    constructor(name: string, args: NetworkServiceDesignVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridnetwork:NetworkServiceDesignVersion" }, { type: "azure-native:hybridnetwork/v20230901:NetworkServiceDesignVersion" }] };
