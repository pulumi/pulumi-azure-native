...
export class SiteNetworkService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridnetwork/v20240415:SiteNetworkService';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.hybridnetwork.v20240415.SiteNetworkServicePropertiesFormatResponse>;
    /**
     * Sku of the site network service.
     */
    public readonly sku!: pulumi.Output<outputs.hybridnetwork.v20240415.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SiteNetworkServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridnetwork/v20230901:SiteNetworkService" }, { type: "azure-native:hybridnetwork:SiteNetworkService" }] };
