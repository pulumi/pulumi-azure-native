...
export function getConfigurationGroupValue(args: GetConfigurationGroupValueArgs, opts?: pulumi.InvokeOptions): Promise<GetConfigurationGroupValueResult> {
    ...
    return pulumi.runtime.invoke("azure-native:hybridnetwork/v20240415:getConfigurationGroupValue", {
...
export interface GetConfigurationGroupValueResult {
     ...
     */
    readonly properties: outputs.hybridnetwork.v20240415.ConfigurationValueWithSecretsResponse | outputs.hybridnetwork.v20240415.ConfigurationValueWithoutSecretsResponse;
    /**
