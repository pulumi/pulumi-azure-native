...
export class ManagedEnvironment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20250101:ManagedEnvironment';
     ...
     */
    public readonly appLogsConfiguration!: pulumi.Output<outputs.app.v20250101.AppLogsConfigurationResponse | undefined>;
    /**
     * Custom domain configuration for the environment
     */
    public readonly customDomainConfiguration!: pulumi.Output<outputs.app.v20250101.CustomDomainConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly daprConfiguration!: pulumi.Output<outputs.app.v20250101.DaprConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.app.v20250101.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly kedaConfiguration!: pulumi.Output<outputs.app.v20250101.KedaConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly peerAuthentication!: pulumi.Output<outputs.app.v20250101.ManagedEnvironmentResponsePeerAuthentication | undefined>;
    /**
     * Peer traffic settings for the Managed Environment
     */
    public readonly peerTrafficConfiguration!: pulumi.Output<outputs.app.v20250101.ManagedEnvironmentResponsePeerTrafficConfiguration | undefined>;
    /**
     ...
     */
    public readonly vnetConfiguration!: pulumi.Output<outputs.app.v20250101.VnetConfigurationResponse | undefined>;
    /**
     * Workload profiles configured for the Managed Environment.
     */
    public readonly workloadProfiles!: pulumi.Output<outputs.app.v20250101.WorkloadProfileResponse[] | undefined>;
    /**
...
export interface ManagedEnvironmentArgs {
     ...
     * Cluster configuration which enables the log daemon to export app logs to configured destination.
     */
    appLogsConfiguration?: pulumi.Input<inputs.app.v20250101.AppLogsConfigurationArgs>;
    /**
     * Custom domain configuration for the environment
     */
    customDomainConfiguration?: pulumi.Input<inputs.app.v20250101.CustomDomainConfigurationArgs>;
    /**
     * Application Insights connection string used by Dapr to export Service to Service communication telemetry
     */
     ...
     * Managed identities for the Managed Environment to interact with other Azure services without maintaining any secrets or credentials in code.
     */
    identity?: pulumi.Input<inputs.app.v20250101.ManagedServiceIdentityArgs>;
    /**
     * Name of the platform-managed resource group created for the Managed Environment to host infrastructure resources. If a subnet ID is provided, this resource group will be created in the same subscription as the subnet.
     */
     ...
     * Peer authentication settings for the Managed Environment
     */
    peerAuthentication?: pulumi.Input<inputs.app.v20250101.ManagedEnvironmentPeerAuthenticationArgs>;
    /**
     * Peer traffic settings for the Managed Environment
     */
    peerTrafficConfiguration?: pulumi.Input<inputs.app.v20250101.ManagedEnvironmentPeerTrafficConfigurationArgs>;
    /**
     ...
     * Vnet configuration for the environment
     */
    vnetConfiguration?: pulumi.Input<inputs.app.v20250101.VnetConfigurationArgs>;
    /**
     * Workload profiles configured for the Managed Environment.
     */
    workloadProfiles?: pulumi.Input<pulumi.Input<inputs.app.v20250101.WorkloadProfileArgs>[]>;
    /**
     * Whether or not this Managed Environment is zone-redundant.
     */
