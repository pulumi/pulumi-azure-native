...
export class JavaComponent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20250101:JavaComponent';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.app.v20250101.SpringBootAdminComponentResponse | outputs.app.v20250101.SpringCloudConfigComponentResponse | outputs.app.v20250101.SpringCloudEurekaComponentResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.app.v20250101.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: JavaComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20231102preview:JavaComponent" }, { type: "azure-native:app/v20240202preview:JavaComponent" }, { type: "azure-native:app/v20240802preview:JavaComponent" }, { type: "azure-native:app/v20241002preview:JavaComponent" }, { type: "azure-native:app:JavaComponent" }] };
...
export interface JavaComponentArgs {
     ...
     * Java Component resource specific properties
     */
    properties?: pulumi.Input<inputs.app.v20250101.SpringBootAdminComponentArgs | inputs.app.v20250101.SpringCloudConfigComponentArgs | inputs.app.v20250101.SpringCloudEurekaComponentArgs>;
    /**
