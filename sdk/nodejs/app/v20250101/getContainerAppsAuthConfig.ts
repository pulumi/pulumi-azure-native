...
export function getContainerAppsAuthConfig(args: GetContainerAppsAuthConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerAppsAuthConfigResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20250101:getContainerAppsAuthConfig", {
...
export interface GetContainerAppsAuthConfigResult {
     ...
     */
    readonly encryptionSettings?: outputs.app.v20250101.EncryptionSettingsResponse;
    /**
     * The configuration settings that determines the validation flow of users using  Service Authentication/Authorization.
     */
    readonly globalValidation?: outputs.app.v20250101.GlobalValidationResponse;
    /**
     * The configuration settings of the HTTP requests for authentication and authorization requests made against ContainerApp Service Authentication/Authorization.
     */
    readonly httpSettings?: outputs.app.v20250101.HttpSettingsResponse;
    /**
     ...
     */
    readonly identityProviders?: outputs.app.v20250101.IdentityProvidersResponse;
    /**
     * The configuration settings of the login flow of users using ContainerApp Service Authentication/Authorization.
     */
    readonly login?: outputs.app.v20250101.LoginResponse;
    /**
     ...
     */
    readonly platform?: outputs.app.v20250101.AuthPlatformResponse;
    /**
...
export function getContainerAppsAuthConfigOutput(args: GetContainerAppsAuthConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerAppsAuthConfigResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:app/v20250101:getContainerAppsAuthConfig", {
        "authConfigName": args.authConfigName,
        "containerAppName": args.containerAppName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
