...
export function getJavaComponent(args: GetJavaComponentArgs, opts?: pulumi.InvokeOptions): Promise<GetJavaComponentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20250101:getJavaComponent", {
...
export interface GetJavaComponentResult {
     ...
     */
    readonly properties: outputs.app.v20250101.SpringBootAdminComponentResponse | outputs.app.v20250101.SpringCloudConfigComponentResponse | outputs.app.v20250101.SpringCloudEurekaComponentResponse;
    /**
...
export function getJavaComponentOutput(args: GetJavaComponentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetJavaComponentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:app/v20250101:getJavaComponent", {
        "environmentName": args.environmentName,
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
