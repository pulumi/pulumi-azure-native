...
export class ContainerAppsSourceControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20250101:ContainerAppsSourceControl';
     ...
     */
    public readonly githubActionConfiguration!: pulumi.Output<outputs.app.v20250101.GithubActionConfigurationResponse | undefined>;
    /**
...
export interface ContainerAppsSourceControlArgs {
     ...
     * as they were at the creation time
     */
    githubActionConfiguration?: pulumi.Input<inputs.app.v20250101.GithubActionConfigurationArgs>;
    /**
     * The repo url which will be integrated to ContainerApp.
     */
