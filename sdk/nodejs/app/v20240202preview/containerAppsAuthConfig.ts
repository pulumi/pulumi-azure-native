...
export class ContainerAppsAuthConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20240202preview:ContainerAppsAuthConfig';
     ...
     */
    public readonly encryptionSettings!: pulumi.Output<outputs.app.v20240202preview.EncryptionSettingsResponse | undefined>;
    /**
     * The configuration settings that determines the validation flow of users using  Service Authentication/Authorization.
     */
    public readonly globalValidation!: pulumi.Output<outputs.app.v20240202preview.GlobalValidationResponse | undefined>;
    /**
     * The configuration settings of the HTTP requests for authentication and authorization requests made against ContainerApp Service Authentication/Authorization.
     */
    public readonly httpSettings!: pulumi.Output<outputs.app.v20240202preview.HttpSettingsResponse | undefined>;
    /**
     * The configuration settings of each of the identity providers used to configure ContainerApp Service Authentication/Authorization.
     */
    public readonly identityProviders!: pulumi.Output<outputs.app.v20240202preview.IdentityProvidersResponse | undefined>;
    /**
     * The configuration settings of the login flow of users using ContainerApp Service Authentication/Authorization.
     */
    public readonly login!: pulumi.Output<outputs.app.v20240202preview.LoginResponse | undefined>;
    /**
     ...
     */
    public readonly platform!: pulumi.Output<outputs.app.v20240202preview.AuthPlatformResponse | undefined>;
    /**
...
export interface ContainerAppsAuthConfigArgs {
     ...
     * The configuration settings of the secrets references of encryption key and signing key for ContainerApp Service Authentication/Authorization.
     */
    encryptionSettings?: pulumi.Input<inputs.app.v20240202preview.EncryptionSettingsArgs>;
    /**
     * The configuration settings that determines the validation flow of users using  Service Authentication/Authorization.
     */
    globalValidation?: pulumi.Input<inputs.app.v20240202preview.GlobalValidationArgs>;
    /**
     * The configuration settings of the HTTP requests for authentication and authorization requests made against ContainerApp Service Authentication/Authorization.
     */
    httpSettings?: pulumi.Input<inputs.app.v20240202preview.HttpSettingsArgs>;
    /**
     * The configuration settings of each of the identity providers used to configure ContainerApp Service Authentication/Authorization.
     */
    identityProviders?: pulumi.Input<inputs.app.v20240202preview.IdentityProvidersArgs>;
    /**
     * The configuration settings of the login flow of users using ContainerApp Service Authentication/Authorization.
     */
    login?: pulumi.Input<inputs.app.v20240202preview.LoginArgs>;
    /**
     * The configuration settings of the platform of ContainerApp Service Authentication/Authorization.
     */
    platform?: pulumi.Input<inputs.app.v20240202preview.AuthPlatformArgs>;
    /**
