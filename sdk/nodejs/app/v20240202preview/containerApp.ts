...
export class ContainerApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20240202preview:ContainerApp';
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.app.v20240202preview.ConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly patchingConfiguration!: pulumi.Output<outputs.app.v20240202preview.ContainerAppResponsePatchingConfiguration | undefined>;
    /**
     ...
     */
    public readonly template!: pulumi.Output<outputs.app.v20240202preview.TemplateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContainerAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["configuration"] = args ? (args.configuration ? pulumi.output(args.configuration).apply(inputs.app.v20240202preview.configurationArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["template"] = args ? (args.template ? pulumi.output(args.template).apply(inputs.app.v20240202preview.templateArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20220101preview:ContainerApp" }, { type: "azure-native:app/v20220301:ContainerApp" }, { type: "azure-native:app/v20220601preview:ContainerApp" }, { type: "azure-native:app/v20221001:ContainerApp" }, { type: "azure-native:app/v20221101preview:ContainerApp" }, { type: "azure-native:app/v20230401preview:ContainerApp" }, { type: "azure-native:app/v20230501:ContainerApp" }, { type: "azure-native:app/v20230502preview:ContainerApp" }, { type: "azure-native:app/v20230801preview:ContainerApp" }, { type: "azure-native:app/v20231102preview:ContainerApp" }, { type: "azure-native:app/v20240301:ContainerApp" }, { type: "azure-native:app/v20240802preview:ContainerApp" }, { type: "azure-native:app/v20241002preview:ContainerApp" }, { type: "azure-native:app/v20250101:ContainerApp" }, { type: "azure-native:app:ContainerApp" }] };
...
export interface ContainerAppArgs {
     ...
     * Non versioned Container App configuration properties.
     */
    configuration?: pulumi.Input<inputs.app.v20240202preview.ConfigurationArgs>;
    /**
     ...
     * Metadata used to render different experiences for resources of the same type; e.g. WorkflowApp is a kind of Microsoft.App/ContainerApps type. If supported, the resource provider must validate and persist this value.
     */
    kind?: pulumi.Input<string | enums.app.v20240202preview.Kind>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Container App auto patch configuration.
     */
    patchingConfiguration?: pulumi.Input<inputs.app.v20240202preview.ContainerAppPatchingConfigurationArgs>;
    /**
     ...
     * Container App versioned application definition.
     */
    template?: pulumi.Input<inputs.app.v20240202preview.TemplateArgs>;
    /**
     * Workload profile name to pin for container app execution.
     */
