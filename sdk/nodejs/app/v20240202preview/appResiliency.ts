...
export class AppResiliency extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20240202preview:AppResiliency';
     ...
     */
    public readonly circuitBreakerPolicy!: pulumi.Output<outputs.app.v20240202preview.CircuitBreakerPolicyResponse | undefined>;
    /**
     * Defines parameters for http connection pooling
     */
    public readonly httpConnectionPool!: pulumi.Output<outputs.app.v20240202preview.HttpConnectionPoolResponse | undefined>;
    /**
     * Policy that defines http request retry conditions
     */
    public readonly httpRetryPolicy!: pulumi.Output<outputs.app.v20240202preview.HttpRetryPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly tcpConnectionPool!: pulumi.Output<outputs.app.v20240202preview.TcpConnectionPoolResponse | undefined>;
    /**
     * Policy that defines tcp request retry conditions
     */
    public readonly tcpRetryPolicy!: pulumi.Output<outputs.app.v20240202preview.TcpRetryPolicyResponse | undefined>;
    /**
     * Policy to set request timeouts
     */
    public readonly timeoutPolicy!: pulumi.Output<outputs.app.v20240202preview.TimeoutPolicyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AppResiliencyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:AppResiliency" }, { type: "azure-native:app/v20230801preview:AppResiliency" }, { type: "azure-native:app/v20231102preview:AppResiliency" }, { type: "azure-native:app/v20240802preview:AppResiliency" }, { type: "azure-native:app/v20241002preview:AppResiliency" }] };
