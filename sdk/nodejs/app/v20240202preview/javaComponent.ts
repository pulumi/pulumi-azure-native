...
export class JavaComponent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20240202preview:JavaComponent';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.app.v20240202preview.NacosComponentResponse | outputs.app.v20240202preview.SpringBootAdminComponentResponse | outputs.app.v20240202preview.SpringCloudConfigComponentResponse | outputs.app.v20240202preview.SpringCloudEurekaComponentResponse>;
    /**
    ...
    constructor(name: string, args: JavaComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20231102preview:JavaComponent" }, { type: "azure-native:app/v20240802preview:JavaComponent" }, { type: "azure-native:app/v20241002preview:JavaComponent" }, { type: "azure-native:app/v20250101:JavaComponent" }, { type: "azure-native:app:JavaComponent" }] };
...
export interface JavaComponentArgs {
     ...
     * Java Component resource specific properties
     */
    properties?: pulumi.Input<inputs.app.v20240202preview.NacosComponentArgs | inputs.app.v20240202preview.SpringBootAdminComponentArgs | inputs.app.v20240202preview.SpringCloudConfigComponentArgs | inputs.app.v20240202preview.SpringCloudEurekaComponentArgs>;
    /**
