...
export class ContainerApp extends pulumi.CustomResource {
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.app.v20231102preview.ConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly template!: pulumi.Output<outputs.app.v20231102preview.TemplateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContainerAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["configuration"] = args ? (args.configuration ? pulumi.output(args.configuration).apply(inputs.app.v20231102preview.configurationArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["template"] = args ? (args.template ? pulumi.output(args.template).apply(inputs.app.v20231102preview.templateArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20220101preview:ContainerApp" }, { type: "azure-native:app/v20220301:ContainerApp" }, { type: "azure-native:app/v20220601preview:ContainerApp" }, { type: "azure-native:app/v20221001:ContainerApp" }, { type: "azure-native:app/v20221101preview:ContainerApp" }, { type: "azure-native:app/v20230401preview:ContainerApp" }, { type: "azure-native:app/v20230501:ContainerApp" }, { type: "azure-native:app/v20230502preview:ContainerApp" }, { type: "azure-native:app/v20230801preview:ContainerApp" }, { type: "azure-native:app/v20240202preview:ContainerApp" }, { type: "azure-native:app/v20240301:ContainerApp" }, { type: "azure-native:app/v20240802preview:ContainerApp" }, { type: "azure-native:app/v20241002preview:ContainerApp" }, { type: "azure-native:app/v20250101:ContainerApp" }, { type: "azure-native:app:ContainerApp" }] };
...
export interface ContainerAppArgs {
     ...
     * Non versioned Container App configuration properties.
     */
    configuration?: pulumi.Input<inputs.app.v20231102preview.ConfigurationArgs>;
    /**
     ...
     * Container App versioned application definition.
     */
    template?: pulumi.Input<inputs.app.v20231102preview.TemplateArgs>;
    /**
     * Workload profile name to pin for container app execution.
     */
