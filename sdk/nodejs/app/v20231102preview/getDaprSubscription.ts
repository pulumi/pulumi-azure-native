...
export interface GetDaprSubscriptionResult {
     ...
     */
    readonly bulkSubscribe?: outputs.app.v20231102preview.DaprSubscriptionBulkSubscribeOptionsResponse;
    /**
     ...
     * Subscription routes
     */
    readonly routes?: outputs.app.v20231102preview.DaprSubscriptionRoutesResponse;
    /**
...
export function getDaprSubscriptionOutput(args: GetDaprSubscriptionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDaprSubscriptionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:app/v20231102preview:getDaprSubscription", {
        "environmentName": args.environmentName,
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
