...
export class ContainerAppsAuthConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20231102preview:ContainerAppsAuthConfig';
     ...
     */
    public readonly encryptionSettings!: pulumi.Output<outputs.app.v20231102preview.EncryptionSettingsResponse | undefined>;
    /**
     * The configuration settings that determines the validation flow of users using  Service Authentication/Authorization.
     */
    public readonly globalValidation!: pulumi.Output<outputs.app.v20231102preview.GlobalValidationResponse | undefined>;
    /**
     * The configuration settings of the HTTP requests for authentication and authorization requests made against ContainerApp Service Authentication/Authorization.
     */
    public readonly httpSettings!: pulumi.Output<outputs.app.v20231102preview.HttpSettingsResponse | undefined>;
    /**
     * The configuration settings of each of the identity providers used to configure ContainerApp Service Authentication/Authorization.
     */
    public readonly identityProviders!: pulumi.Output<outputs.app.v20231102preview.IdentityProvidersResponse | undefined>;
    /**
     * The configuration settings of the login flow of users using ContainerApp Service Authentication/Authorization.
     */
    public readonly login!: pulumi.Output<outputs.app.v20231102preview.LoginResponse | undefined>;
    /**
     ...
     */
    public readonly platform!: pulumi.Output<outputs.app.v20231102preview.AuthPlatformResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContainerAppsAuthConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20220101preview:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20220301:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20220601preview:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20221001:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20221101preview:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20230401preview:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20230501:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20230502preview:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20230801preview:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20240202preview:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20240301:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20240802preview:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20241002preview:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20250101:ContainerAppsAuthConfig" }, { type: "azure-native:app:ContainerAppsAuthConfig" }] };
...
export interface ContainerAppsAuthConfigArgs {
     ...
     * The configuration settings of the secrets references of encryption key and signing key for ContainerApp Service Authentication/Authorization.
     */
    encryptionSettings?: pulumi.Input<inputs.app.v20231102preview.EncryptionSettingsArgs>;
    /**
     * The configuration settings that determines the validation flow of users using  Service Authentication/Authorization.
     */
    globalValidation?: pulumi.Input<inputs.app.v20231102preview.GlobalValidationArgs>;
    /**
     * The configuration settings of the HTTP requests for authentication and authorization requests made against ContainerApp Service Authentication/Authorization.
     */
    httpSettings?: pulumi.Input<inputs.app.v20231102preview.HttpSettingsArgs>;
    /**
     * The configuration settings of each of the identity providers used to configure ContainerApp Service Authentication/Authorization.
     */
    identityProviders?: pulumi.Input<inputs.app.v20231102preview.IdentityProvidersArgs>;
    /**
     * The configuration settings of the login flow of users using ContainerApp Service Authentication/Authorization.
     */
    login?: pulumi.Input<inputs.app.v20231102preview.LoginArgs>;
    /**
     * The configuration settings of the platform of ContainerApp Service Authentication/Authorization.
     */
    platform?: pulumi.Input<inputs.app.v20231102preview.AuthPlatformArgs>;
    /**
