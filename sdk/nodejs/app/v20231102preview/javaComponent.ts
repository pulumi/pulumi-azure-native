...
export class JavaComponent extends pulumi.CustomResource {
     ...
     */
    public readonly configurations!: pulumi.Output<outputs.app.v20231102preview.JavaComponentConfigurationPropertyResponse[] | undefined>;
    /**
     ...
     */
    public readonly serviceBinds!: pulumi.Output<outputs.app.v20231102preview.JavaComponentServiceBindResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: JavaComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20240202preview:JavaComponent" }, { type: "azure-native:app/v20240802preview:JavaComponent" }, { type: "azure-native:app/v20241002preview:JavaComponent" }, { type: "azure-native:app/v20250101:JavaComponent" }, { type: "azure-native:app:JavaComponent" }] };
