...
export class DotNetComponent extends pulumi.CustomResource {
     ...
     */
    public readonly configurations!: pulumi.Output<outputs.app.v20231102preview.DotNetComponentConfigurationPropertyResponse[] | undefined>;
    /**
     ...
     */
    public readonly serviceBinds!: pulumi.Output<outputs.app.v20231102preview.DotNetComponentServiceBindResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: DotNetComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:DotNetComponent" }, { type: "azure-native:app/v20240202preview:DotNetComponent" }, { type: "azure-native:app/v20240802preview:DotNetComponent" }] };
