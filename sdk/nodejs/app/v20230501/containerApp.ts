...
export class ContainerApp extends pulumi.CustomResource {
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.app.v20230501.ConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.app.v20230501.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly template!: pulumi.Output<outputs.app.v20230501.TemplateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContainerAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["configuration"] = args ? (args.configuration ? pulumi.output(args.configuration).apply(inputs.app.v20230501.configurationArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["template"] = args ? (args.template ? pulumi.output(args.template).apply(inputs.app.v20230501.templateArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20220101preview:ContainerApp" }, { type: "azure-native:app/v20220301:ContainerApp" }, { type: "azure-native:app/v20220601preview:ContainerApp" }, { type: "azure-native:app/v20221001:ContainerApp" }, { type: "azure-native:app/v20221101preview:ContainerApp" }, { type: "azure-native:app/v20230401preview:ContainerApp" }, { type: "azure-native:app/v20230502preview:ContainerApp" }, { type: "azure-native:app/v20230801preview:ContainerApp" }, { type: "azure-native:app/v20231102preview:ContainerApp" }, { type: "azure-native:app/v20240202preview:ContainerApp" }, { type: "azure-native:app/v20240301:ContainerApp" }, { type: "azure-native:app/v20240802preview:ContainerApp" }, { type: "azure-native:app/v20241002preview:ContainerApp" }, { type: "azure-native:app/v20250101:ContainerApp" }, { type: "azure-native:app:ContainerApp" }] };
...
export interface ContainerAppArgs {
     ...
     * Non versioned Container App configuration properties.
     */
    configuration?: pulumi.Input<inputs.app.v20230501.ConfigurationArgs>;
    /**
     ...
     * The complex type of the extended location.
     */
    extendedLocation?: pulumi.Input<inputs.app.v20230501.ExtendedLocationArgs>;
    /**
     * managed identities for the Container App to interact with other Azure services without maintaining any secrets or credentials in code.
     */
     ...
     * Container App versioned application definition.
     */
    template?: pulumi.Input<inputs.app.v20230501.TemplateArgs>;
    /**
     * Workload profile name to pin for container app execution.
     */
