...
export class ContainerAppsSourceControl extends pulumi.CustomResource {
     ...
     */
    public readonly githubActionConfiguration!: pulumi.Output<outputs.app.v20230501.GithubActionConfigurationResponse | undefined>;
    /**
...
export interface ContainerAppsSourceControlArgs {
     ...
     * as they were at the creation time
     */
    githubActionConfiguration?: pulumi.Input<inputs.app.v20230501.GithubActionConfigurationArgs>;
    /**
     * The repo url which will be integrated to ContainerApp.
     */
