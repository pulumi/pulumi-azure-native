...
export class HttpRouteConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20241002preview:HttpRouteConfig';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.app.v20241002preview.HttpRouteConfigResponseProperties>;
    /**
    ...
    constructor(name: string, args: HttpRouteConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:HttpRouteConfig" }] };
...
export interface HttpRouteConfigArgs {
     ...
     * Http Route Config properties
     */
    properties?: pulumi.Input<inputs.app.v20241002preview.HttpRouteConfigPropertiesArgs>;
    /**
