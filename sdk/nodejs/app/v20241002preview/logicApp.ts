...
export class LogicApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20241002preview:LogicApp';
    ...
    constructor(name: string, args: LogicAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:LogicApp" }, { type: "azure-native:app/v20240202preview:LogicApp" }, { type: "azure-native:app/v20240802preview:LogicApp" }] };
