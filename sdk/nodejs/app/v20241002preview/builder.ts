...
export class Builder extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20241002preview:Builder';
     ...
     */
    public readonly containerRegistries!: pulumi.Output<outputs.app.v20241002preview.ContainerRegistryResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: BuilderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:Builder" }, { type: "azure-native:app/v20230801preview:Builder" }, { type: "azure-native:app/v20231102preview:Builder" }, { type: "azure-native:app/v20240202preview:Builder" }, { type: "azure-native:app/v20240802preview:Builder" }] };
...
export interface BuilderArgs {
     ...
     * List of mappings of container registries and the managed identity used to connect to it.
     */
    containerRegistries?: pulumi.Input<pulumi.Input<inputs.app.v20241002preview.ContainerRegistryArgs>[]>;
    /**
     * Resource ID of the container apps environment that the builder is associated with.
     */
