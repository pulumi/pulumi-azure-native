...
export class ManagedCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20241002preview:ManagedCertificate';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.app.v20241002preview.ManagedCertificateResponseProperties>;
    /**
    ...
    constructor(name: string, args: ManagedCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20221101preview:ManagedCertificate" }, { type: "azure-native:app/v20230401preview:ManagedCertificate" }, { type: "azure-native:app/v20230501:ManagedCertificate" }, { type: "azure-native:app/v20230502preview:ManagedCertificate" }, { type: "azure-native:app/v20230801preview:ManagedCertificate" }, { type: "azure-native:app/v20231102preview:ManagedCertificate" }, { type: "azure-native:app/v20240202preview:ManagedCertificate" }, { type: "azure-native:app/v20240301:ManagedCertificate" }, { type: "azure-native:app/v20240802preview:ManagedCertificate" }, { type: "azure-native:app/v20250101:ManagedCertificate" }, { type: "azure-native:app:ManagedCertificate" }] };
...
export interface ManagedCertificateArgs {
     ...
     * Certificate resource specific properties
     */
    properties?: pulumi.Input<inputs.app.v20241002preview.ManagedCertificatePropertiesArgs>;
    /**
