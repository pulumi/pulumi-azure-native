...
export function getDotNetComponent(args: GetDotNetComponentArgs, opts?: pulumi.InvokeOptions): Promise<GetDotNetComponentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20241002preview:getDotNetComponent", {
...
export interface GetDotNetComponentResult {
     ...
     */
    readonly configurations?: outputs.app.v20241002preview.DotNetComponentConfigurationPropertyResponse[];
    /**
     ...
     */
    readonly serviceBinds?: outputs.app.v20241002preview.DotNetComponentServiceBindResponse[];
    /**
