...
export class MaintenanceConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20241002preview:MaintenanceConfiguration';
     ...
     */
    public readonly scheduledEntries!: pulumi.Output<outputs.app.v20241002preview.ScheduledEntryResponse[]>;
    /**
    ...
    constructor(name: string, args: MaintenanceConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:MaintenanceConfiguration" }] };
...
export interface MaintenanceConfigurationArgs {
     ...
     * List of maintenance schedules for a managed environment.
     */
    scheduledEntries: pulumi.Input<pulumi.Input<inputs.app.v20241002preview.ScheduledEntryArgs>[]>;
}
