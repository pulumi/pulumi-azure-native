...
export function getConnectedEnvironment(args: GetConnectedEnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectedEnvironmentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20230502preview:getConnectedEnvironment", {
...
export interface GetConnectedEnvironmentResult {
     ...
     */
    readonly customDomainConfiguration?: outputs.app.v20230502preview.CustomDomainConfigurationResponse;
    /**
     ...
     */
    readonly extendedLocation?: outputs.app.v20230502preview.ExtendedLocationResponse;
    /**
     ...
     */
    readonly systemData: outputs.app.v20230502preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getConnectedEnvironmentOutput(args: GetConnectedEnvironmentOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetConnectedEnvironmentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:app/v20230502preview:getConnectedEnvironment", {
        "connectedEnvironmentName": args.connectedEnvironmentName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
