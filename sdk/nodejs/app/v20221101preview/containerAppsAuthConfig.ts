 ...
 *
 * const containerAppsAuthConfig = new azure_native.app.v20221101preview.ContainerAppsAuthConfig("containerAppsAuthConfig", {
 *     authConfigName: "current",
 *     containerAppName: "testcanadacentral",
 *     globalValidation: {
 *         unauthenticatedClientAction: azure_native.app.v20221101preview.UnauthenticatedClientActionV2.AllowAnonymous,
 *     },
 *     identityProviders: {
 *         facebook: {
 *             registration: {
...
export class ContainerAppsAuthConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20221101preview:ContainerAppsAuthConfig';
     ...
     */
    public readonly globalValidation!: pulumi.Output<outputs.app.v20221101preview.GlobalValidationResponse | undefined>;
    /**
     * The configuration settings of the HTTP requests for authentication and authorization requests made against ContainerApp Service Authentication/Authorization.
     */
    public readonly httpSettings!: pulumi.Output<outputs.app.v20221101preview.HttpSettingsResponse | undefined>;
    /**
     * The configuration settings of each of the identity providers used to configure ContainerApp Service Authentication/Authorization.
     */
    public readonly identityProviders!: pulumi.Output<outputs.app.v20221101preview.IdentityProvidersResponse | undefined>;
    /**
     * The configuration settings of the login flow of users using ContainerApp Service Authentication/Authorization.
     */
    public readonly login!: pulumi.Output<outputs.app.v20221101preview.LoginResponse | undefined>;
    /**
     ...
     */
    public readonly platform!: pulumi.Output<outputs.app.v20221101preview.AuthPlatformResponse | undefined>;
    /**
...
export interface ContainerAppsAuthConfigArgs {
     ...
     * The configuration settings that determines the validation flow of users using  Service Authentication/Authorization.
     */
    globalValidation?: pulumi.Input<inputs.app.v20221101preview.GlobalValidationArgs>;
    /**
     * The configuration settings of the HTTP requests for authentication and authorization requests made against ContainerApp Service Authentication/Authorization.
     */
    httpSettings?: pulumi.Input<inputs.app.v20221101preview.HttpSettingsArgs>;
    /**
     * The configuration settings of each of the identity providers used to configure ContainerApp Service Authentication/Authorization.
     */
    identityProviders?: pulumi.Input<inputs.app.v20221101preview.IdentityProvidersArgs>;
    /**
     * The configuration settings of the login flow of users using ContainerApp Service Authentication/Authorization.
     */
    login?: pulumi.Input<inputs.app.v20221101preview.LoginArgs>;
    /**
     * The configuration settings of the platform of ContainerApp Service Authentication/Authorization.
     */
    platform?: pulumi.Input<inputs.app.v20221101preview.AuthPlatformArgs>;
    /**
