...
export class ConnectedEnvironment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20221101preview:ConnectedEnvironment';
     ...
     */
    public readonly customDomainConfiguration!: pulumi.Output<outputs.app.v20221101preview.CustomDomainConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ConnectedEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ConnectedEnvironment" }, { type: "azure-native:app/v20220601preview:ConnectedEnvironment" }, { type: "azure-native:app/v20221001:ConnectedEnvironment" }, { type: "azure-native:app/v20230401preview:ConnectedEnvironment" }, { type: "azure-native:app/v20230501:ConnectedEnvironment" }, { type: "azure-native:app/v20230502preview:ConnectedEnvironment" }, { type: "azure-native:app/v20230801preview:ConnectedEnvironment" }, { type: "azure-native:app/v20231102preview:ConnectedEnvironment" }, { type: "azure-native:app/v20240202preview:ConnectedEnvironment" }, { type: "azure-native:app/v20240301:ConnectedEnvironment" }, { type: "azure-native:app/v20240802preview:ConnectedEnvironment" }, { type: "azure-native:app/v20241002preview:ConnectedEnvironment" }] };
...
export interface ConnectedEnvironmentArgs {
     ...
     * Custom domain configuration for the environment
     */
    customDomainConfiguration?: pulumi.Input<inputs.app.v20221101preview.CustomDomainConfigurationArgs>;
    /**
     * Application Insights connection string used by Dapr to export Service to Service communication telemetry
     */
