...
export class ContainerAppsSourceControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20221101preview:ContainerAppsSourceControl';
     ...
     */
    public readonly githubActionConfiguration!: pulumi.Output<outputs.app.v20221101preview.GithubActionConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContainerAppsSourceControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ContainerAppsSourceControl" }, { type: "azure-native:app/v20220101preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20220301:ContainerAppsSourceControl" }, { type: "azure-native:app/v20220601preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20221001:ContainerAppsSourceControl" }, { type: "azure-native:app/v20230401preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20230501:ContainerAppsSourceControl" }, { type: "azure-native:app/v20230502preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20230801preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20231102preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20240202preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20240301:ContainerAppsSourceControl" }, { type: "azure-native:app/v20240802preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20241002preview:ContainerAppsSourceControl" }] };
...
export interface ContainerAppsSourceControlArgs {
     ...
     * as they were at the creation time
     */
    githubActionConfiguration?: pulumi.Input<inputs.app.v20221101preview.GithubActionConfigurationArgs>;
    /**
     * The repo url which will be integrated to ContainerApp.
     */
