...
export function getDaprComponent(args: GetDaprComponentArgs, opts?: pulumi.InvokeOptions): Promise<GetDaprComponentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20221101preview:getDaprComponent", {
...
export interface GetDaprComponentResult {
     ...
     * Component metadata
     */
    readonly metadata?: outputs.app.v20221101preview.DaprMetadataResponse[];
    /**
     ...
     */
    readonly secrets?: outputs.app.v20221101preview.SecretResponse[];
    /**
...
export function getDaprComponentOutput(args: GetDaprComponentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDaprComponentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:app/v20221101preview:getDaprComponent", {
        "componentName": args.componentName,
        "environmentName": args.environmentName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
