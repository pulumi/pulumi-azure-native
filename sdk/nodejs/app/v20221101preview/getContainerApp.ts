...
export function getContainerApp(args: GetContainerAppArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerAppResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20221101preview:getContainerApp", {
...
export interface GetContainerAppResult {
     ...
     */
    readonly configuration?: outputs.app.v20221101preview.ConfigurationResponse;
    /**
     ...
     */
    readonly extendedLocation?: outputs.app.v20221101preview.ExtendedLocationResponse;
    /**
     ...
     */
    readonly template?: outputs.app.v20221101preview.TemplateResponse;
    /**
...
export function getContainerAppOutput(args: GetContainerAppOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerAppResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:app/v20221101preview:getContainerApp", {
        "containerAppName": args.containerAppName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
