 ...
 *
 * const connectedEnvironmentsDaprComponent = new azure_native.app.v20221101preview.ConnectedEnvironmentsDaprComponent("connectedEnvironmentsDaprComponent", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:app/v20221101preview:ConnectedEnvironmentsDaprComponent reddog /subscriptions/8efdecc5-919e-44eb-b179-915dca89ebf9/resourceGroups/examplerg/providers/Microsoft.App/connectedEnvironments/jlaw-demo1/daprcomponents/reddog 
 * ```
 */
export class ConnectedEnvironmentsDaprComponent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20221101preview:ConnectedEnvironmentsDaprComponent';
     ...
     * Component metadata
     */
    public readonly metadata!: pulumi.Output<outputs.app.v20221101preview.DaprMetadataResponse[] | undefined>;
    /**
     ...
     */
    public readonly secrets!: pulumi.Output<outputs.app.v20221101preview.SecretResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ConnectedEnvironmentsDaprComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20220601preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20221001:ConnectedEnvironmentsDaprComponent" }] };
...
export interface ConnectedEnvironmentsDaprComponentArgs {
     ...
     * Component metadata
     */
    metadata?: pulumi.Input<pulumi.Input<inputs.app.v20221101preview.DaprMetadataArgs>[]>;
    /**
     ...
     * Collection of secrets used by a Dapr component
     */
    secrets?: pulumi.Input<pulumi.Input<inputs.app.v20221101preview.SecretArgs>[]>;
    /**
     * Component version
     */
