...
export function getContainerAppsSourceControl(args: GetContainerAppsSourceControlArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerAppsSourceControlResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20221101preview:getContainerAppsSourceControl", {
...
export interface GetContainerAppsSourceControlResult {
     ...
     */
    readonly githubActionConfiguration?: outputs.app.v20221101preview.GithubActionConfigurationResponse;
    /**
...
export function getContainerAppsSourceControlOutput(args: GetContainerAppsSourceControlOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerAppsSourceControlResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:app/v20221101preview:getContainerAppsSourceControl", {
        "containerAppName": args.containerAppName,
        "resourceGroupName": args.resourceGroupName,
        "sourceControlName": args.sourceControlName,
    }, opts);
