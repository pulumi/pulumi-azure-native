...
export class ManagedCertificate extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.app.v20230401preview.ManagedCertificateResponseProperties>;
    /**
    ...
    constructor(name: string, args: ManagedCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ManagedCertificate" }, { type: "azure-native:app/v20221101preview:ManagedCertificate" }] };
