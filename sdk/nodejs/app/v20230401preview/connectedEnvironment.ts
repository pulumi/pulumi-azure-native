...
export class ConnectedEnvironment extends pulumi.CustomResource {
     ...
     */
    public readonly customDomainConfiguration!: pulumi.Output<outputs.app.v20230401preview.CustomDomainConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.app.v20230401preview.ExtendedLocationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ConnectedEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ConnectedEnvironment" }, { type: "azure-native:app/v20220601preview:ConnectedEnvironment" }, { type: "azure-native:app/v20221001:ConnectedEnvironment" }, { type: "azure-native:app/v20221101preview:ConnectedEnvironment" }, { type: "azure-native:app/v20230501:ConnectedEnvironment" }] };
...
export interface ConnectedEnvironmentArgs {
     ...
     * Custom domain configuration for the environment
     */
    customDomainConfiguration?: pulumi.Input<inputs.app.v20230401preview.CustomDomainConfigurationArgs>;
    /**
     * Application Insights connection string used by Dapr to export Service to Service communication telemetry
     */
     ...
     * The complex type of the extended location.
     */
    extendedLocation?: pulumi.Input<inputs.app.v20230401preview.ExtendedLocationArgs>;
    /**
     * The geo-location where the resource lives
     */
