...
export class ConnectedEnvironmentsDaprComponent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20230401preview:ConnectedEnvironmentsDaprComponent';
     ...
     * Component metadata
     */
    public readonly metadata!: pulumi.Output<outputs.app.v20230401preview.DaprMetadataResponse[] | undefined>;
    /**
     ...
     */
    public readonly secrets!: pulumi.Output<outputs.app.v20230401preview.SecretResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ConnectedEnvironmentsDaprComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20220601preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20221001:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20221101preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20230501:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20230502preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20230801preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20231102preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20240202preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20240301:ConnectedEnvironmentsDaprComponent" }] };
...
export interface ConnectedEnvironmentsDaprComponentArgs {
     ...
     * Component metadata
     */
    metadata?: pulumi.Input<pulumi.Input<inputs.app.v20230401preview.DaprMetadataArgs>[]>;
    /**
     ...
     * Collection of secrets used by a Dapr component
     */
    secrets?: pulumi.Input<pulumi.Input<inputs.app.v20230401preview.SecretArgs>[]>;
    /**
     * Component version
     */
