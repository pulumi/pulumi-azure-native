...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:app/v20230401preview:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-native:app/v20230401preview:ConnectedEnvironment":
                return new ConnectedEnvironment(name, <any>undefined, { urn })
            case "azure-native:app/v20230401preview:ConnectedEnvironmentsCertificate":
                return new ConnectedEnvironmentsCertificate(name, <any>undefined, { urn })
            case "azure-native:app/v20230401preview:ConnectedEnvironmentsDaprComponent":
                return new ConnectedEnvironmentsDaprComponent(name, <any>undefined, { urn })
            case "azure-native:app/v20230401preview:ConnectedEnvironmentsStorage":
                return new ConnectedEnvironmentsStorage(name, <any>undefined, { urn })
            case "azure-native:app/v20230401preview:ContainerApp":
                return new ContainerApp(name, <any>undefined, { urn })
            case "azure-native:app/v20230401preview:ContainerAppsAuthConfig":
                return new ContainerAppsAuthConfig(name, <any>undefined, { urn })
            case "azure-native:app/v20230401preview:ContainerAppsSourceControl":
                return new ContainerAppsSourceControl(name, <any>undefined, { urn })
            case "azure-native:app/v20230401preview:DaprComponent":
            ...
            case "azure-native:app/v20230401preview:ManagedEnvironment":
                return new ManagedEnvironment(name, <any>undefined, { urn })
            case "azure-native:app/v20230401preview:ManagedEnvironmentsStorage":
