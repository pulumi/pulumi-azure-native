 ...
 *
 * const managedEnvironment = new azure_native.app.v20220301.ManagedEnvironment("managedEnvironment", {
...
export class ManagedEnvironment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ManagedEnvironment" }, { type: "azure-native:app/v20220101preview:ManagedEnvironment" }, { type: "azure-native:app/v20220601preview:ManagedEnvironment" }, { type: "azure-native:app/v20221001:ManagedEnvironment" }, { type: "azure-native:app/v20221101preview:ManagedEnvironment" }] };
