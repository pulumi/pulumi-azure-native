...
export class DaprComponent extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DaprComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:DaprComponent" }, { type: "azure-native:app/v20220101preview:DaprComponent" }, { type: "azure-native:app/v20220601preview:DaprComponent" }] };
