...
export class ContainerAppsSourceControl extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ContainerAppsSourceControl {
        pulumi.log.warn("ContainerAppsSourceControl is deprecated: azure-native:app/v20220301:ContainerAppsSourceControl is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:ContainerAppsSourceControl to guarantee forwards compatibility.")
        return new ContainerAppsSourceControl(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20220301:ContainerAppsSourceControl';
     ...
     */
    public readonly githubActionConfiguration!: pulumi.Output<outputs.app.v20220301.GithubActionConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContainerAppsSourceControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ContainerAppsSourceControl" }, { type: "azure-native:app/v20220101preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20220601preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20221001:ContainerAppsSourceControl" }] };
