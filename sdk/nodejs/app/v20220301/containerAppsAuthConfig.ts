...
export class ContainerAppsAuthConfig extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ContainerAppsAuthConfig {
        pulumi.log.warn("ContainerAppsAuthConfig is deprecated: azure-native:app/v20220301:ContainerAppsAuthConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:ContainerAppsAuthConfig to guarantee forwards compatibility.")
        return new ContainerAppsAuthConfig(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20220301:ContainerAppsAuthConfig';
     ...
     */
    public readonly globalValidation!: pulumi.Output<outputs.app.v20220301.GlobalValidationResponse | undefined>;
    /**
     * The configuration settings of the HTTP requests for authentication and authorization requests made against ContainerApp Service Authentication/Authorization.
     */
    public readonly httpSettings!: pulumi.Output<outputs.app.v20220301.HttpSettingsResponse | undefined>;
    /**
     * The configuration settings of each of the identity providers used to configure ContainerApp Service Authentication/Authorization.
     */
    public readonly identityProviders!: pulumi.Output<outputs.app.v20220301.IdentityProvidersResponse | undefined>;
    /**
     * The configuration settings of the login flow of users using ContainerApp Service Authentication/Authorization.
     */
    public readonly login!: pulumi.Output<outputs.app.v20220301.LoginResponse | undefined>;
    /**
     ...
     */
    public readonly platform!: pulumi.Output<outputs.app.v20220301.AuthPlatformResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContainerAppsAuthConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20220101preview:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20220601preview:ContainerAppsAuthConfig" }, { type: "azure-native:app/v20221001:ContainerAppsAuthConfig" }] };
