...
export class AppResiliency extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20240802preview:AppResiliency';
     ...
     */
    public readonly circuitBreakerPolicy!: pulumi.Output<outputs.app.v20240802preview.CircuitBreakerPolicyResponse | undefined>;
    /**
     * Defines parameters for http connection pooling
     */
    public readonly httpConnectionPool!: pulumi.Output<outputs.app.v20240802preview.HttpConnectionPoolResponse | undefined>;
    /**
     * Policy that defines http request retry conditions
     */
    public readonly httpRetryPolicy!: pulumi.Output<outputs.app.v20240802preview.HttpRetryPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly tcpConnectionPool!: pulumi.Output<outputs.app.v20240802preview.TcpConnectionPoolResponse | undefined>;
    /**
     * Policy that defines tcp request retry conditions
     */
    public readonly tcpRetryPolicy!: pulumi.Output<outputs.app.v20240802preview.TcpRetryPolicyResponse | undefined>;
    /**
     * Policy to set request timeouts
     */
    public readonly timeoutPolicy!: pulumi.Output<outputs.app.v20240802preview.TimeoutPolicyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AppResiliencyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:AppResiliency" }, { type: "azure-native:app/v20230801preview:AppResiliency" }, { type: "azure-native:app/v20231102preview:AppResiliency" }, { type: "azure-native:app/v20240202preview:AppResiliency" }] };
...
export interface AppResiliencyArgs {
     ...
     * Policy that defines circuit breaker conditions
     */
    circuitBreakerPolicy?: pulumi.Input<inputs.app.v20240802preview.CircuitBreakerPolicyArgs>;
    /**
     * Defines parameters for http connection pooling
     */
    httpConnectionPool?: pulumi.Input<inputs.app.v20240802preview.HttpConnectionPoolArgs>;
    /**
     * Policy that defines http request retry conditions
     */
    httpRetryPolicy?: pulumi.Input<inputs.app.v20240802preview.HttpRetryPolicyArgs>;
    /**
     ...
     * Defines parameters for tcp connection pooling
     */
    tcpConnectionPool?: pulumi.Input<inputs.app.v20240802preview.TcpConnectionPoolArgs>;
    /**
     * Policy that defines tcp request retry conditions
     */
    tcpRetryPolicy?: pulumi.Input<inputs.app.v20240802preview.TcpRetryPolicyArgs>;
    /**
     * Policy to set request timeouts
     */
    timeoutPolicy?: pulumi.Input<inputs.app.v20240802preview.TimeoutPolicyArgs>;
}
