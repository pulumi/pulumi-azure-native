...
export class DotNetComponent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20240802preview:DotNetComponent';
     ...
     */
    public readonly configurations!: pulumi.Output<outputs.app.v20240802preview.DotNetComponentConfigurationPropertyResponse[] | undefined>;
    /**
     ...
     */
    public readonly serviceBinds!: pulumi.Output<outputs.app.v20240802preview.DotNetComponentServiceBindResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: DotNetComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20231102preview:DotNetComponent" }, { type: "azure-native:app/v20240202preview:DotNetComponent" }, { type: "azure-native:app/v20241002preview:DotNetComponent" }, { type: "azure-native:app:DotNetComponent" }] };
...
export interface DotNetComponentArgs {
     ...
     * Type of the .NET Component.
     */
    componentType?: pulumi.Input<string | enums.app.v20240802preview.DotNetComponentType>;
    /**
     * List of .NET Components configuration properties
     */
    configurations?: pulumi.Input<pulumi.Input<inputs.app.v20240802preview.DotNetComponentConfigurationPropertyArgs>[]>;
    /**
     ...
     * List of .NET Components that are bound to the .NET component
     */
    serviceBinds?: pulumi.Input<pulumi.Input<inputs.app.v20240802preview.DotNetComponentServiceBindArgs>[]>;
}
