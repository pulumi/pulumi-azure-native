...
export class DaprComponentResiliencyPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20240802preview:DaprComponentResiliencyPolicy';
     ...
     */
    public readonly inboundPolicy!: pulumi.Output<outputs.app.v20240802preview.DaprComponentResiliencyPolicyConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly outboundPolicy!: pulumi.Output<outputs.app.v20240802preview.DaprComponentResiliencyPolicyConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DaprComponentResiliencyPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:DaprComponentResiliencyPolicy" }, { type: "azure-native:app/v20230801preview:DaprComponentResiliencyPolicy" }, { type: "azure-native:app/v20231102preview:DaprComponentResiliencyPolicy" }, { type: "azure-native:app/v20240202preview:DaprComponentResiliencyPolicy" }, { type: "azure-native:app/v20241002preview:DaprComponentResiliencyPolicy" }] };
...
export interface DaprComponentResiliencyPolicyArgs {
     ...
     * The optional inbound component resiliency policy configuration
     */
    inboundPolicy?: pulumi.Input<inputs.app.v20240802preview.DaprComponentResiliencyPolicyConfigurationArgs>;
    /**
     ...
     * The optional outbound component resiliency policy configuration
     */
    outboundPolicy?: pulumi.Input<inputs.app.v20240802preview.DaprComponentResiliencyPolicyConfigurationArgs>;
    /**
