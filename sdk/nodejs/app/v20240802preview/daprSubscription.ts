...
export class DaprSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20240802preview:DaprSubscription';
     ...
     */
    public readonly bulkSubscribe!: pulumi.Output<outputs.app.v20240802preview.DaprSubscriptionBulkSubscribeOptionsResponse | undefined>;
    /**
     ...
     * Subscription routes
     */
    public readonly routes!: pulumi.Output<outputs.app.v20240802preview.DaprSubscriptionRoutesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DaprSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:DaprSubscription" }, { type: "azure-native:app/v20230801preview:DaprSubscription" }, { type: "azure-native:app/v20231102preview:DaprSubscription" }, { type: "azure-native:app/v20240202preview:DaprSubscription" }, { type: "azure-native:app/v20241002preview:DaprSubscription" }] };
