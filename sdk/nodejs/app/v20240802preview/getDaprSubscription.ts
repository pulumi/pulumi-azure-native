...
export function getDaprSubscription(args: GetDaprSubscriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetDaprSubscriptionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20240802preview:getDaprSubscription", {
...
export interface GetDaprSubscriptionResult {
     ...
     */
    readonly bulkSubscribe?: outputs.app.v20240802preview.DaprSubscriptionBulkSubscribeOptionsResponse;
    /**
     ...
     * Subscription routes
     */
    readonly routes?: outputs.app.v20240802preview.DaprSubscriptionRoutesResponse;
    /**
...
export function getDaprSubscriptionOutput(args: GetDaprSubscriptionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDaprSubscriptionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:app/v20240802preview:getDaprSubscription", {
        "environmentName": args.environmentName,
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
