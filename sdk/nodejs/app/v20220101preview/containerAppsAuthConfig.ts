 ...
 *
 * const containerAppsAuthConfig = new azure_native.app.v20220101preview.ContainerAppsAuthConfig("containerAppsAuthConfig", {
 *     containerAppName: "testcanadacentral",
 *     globalValidation: {
 *         unauthenticatedClientAction: azure_native.app.v20220101preview.UnauthenticatedClientActionV2.AllowAnonymous,
 *     },
 *     identityProviders: {
 *         facebook: {
 *             registration: {
