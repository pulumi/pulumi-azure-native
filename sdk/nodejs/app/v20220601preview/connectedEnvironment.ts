...
export class ConnectedEnvironment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectedEnvironment {
        pulumi.log.warn("ConnectedEnvironment is deprecated: azure-native:app/v20220601preview:ConnectedEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:app/v20221001:ConnectedEnvironment to guarantee forwards compatibility.")
        return new ConnectedEnvironment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20220601preview:ConnectedEnvironment';
     ...
     */
    public readonly customDomainConfiguration!: pulumi.Output<outputs.app.v20220601preview.CustomDomainConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.app.v20220601preview.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.app.v20220601preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ConnectedEnvironmentArgs {
     ...
     * Custom domain configuration for the environment
     */
    customDomainConfiguration?: pulumi.Input<inputs.app.v20220601preview.CustomDomainConfigurationArgs>;
    /**
     * Application Insights connection string used by Dapr to export Service to Service communication telemetry
     */
     ...
     * The complex type of the extended location.
     */
    extendedLocation?: pulumi.Input<inputs.app.v20220601preview.ExtendedLocationArgs>;
    /**
     * The geo-location where the resource lives
     */
