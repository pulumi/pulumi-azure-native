...
export function getManagedEnvironmentsStorage(args: GetManagedEnvironmentsStorageArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedEnvironmentsStorageResult> {
    pulumi.log.warn("getManagedEnvironmentsStorage is deprecated: azure-native:app/v20220601preview:ManagedEnvironmentsStorage is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:ManagedEnvironmentsStorage to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:app/v20220601preview:getManagedEnvironmentsStorage", {
...
export interface GetManagedEnvironmentsStorageResult {
     ...
     * Storage properties
     */
    readonly properties: outputs.app.v20220601preview.ManagedEnvironmentStorageResponseProperties;
    /**
