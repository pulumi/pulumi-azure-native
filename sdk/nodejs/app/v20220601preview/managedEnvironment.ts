...
export class ManagedEnvironment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20220601preview:ManagedEnvironment';
     ...
     * supported
     */
    public readonly appLogsConfiguration!: pulumi.Output<outputs.app.v20220601preview.AppLogsConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.app.v20220601preview.EnvironmentSkuPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly vnetConfiguration!: pulumi.Output<outputs.app.v20220601preview.VnetConfigurationResponse | undefined>;
    /**
     * Workload profiles configured for the Managed Environment.
     */
    public readonly workloadProfiles!: pulumi.Output<outputs.app.v20220601preview.WorkloadProfileResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ManagedEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ManagedEnvironment" }, { type: "azure-native:app/v20220101preview:ManagedEnvironment" }, { type: "azure-native:app/v20220301:ManagedEnvironment" }, { type: "azure-native:app/v20221001:ManagedEnvironment" }, { type: "azure-native:app/v20221101preview:ManagedEnvironment" }, { type: "azure-native:app/v20230401preview:ManagedEnvironment" }, { type: "azure-native:app/v20230501:ManagedEnvironment" }] };
...
export interface ManagedEnvironmentArgs {
     ...
     * supported
     */
    appLogsConfiguration?: pulumi.Input<inputs.app.v20220601preview.AppLogsConfigurationArgs>;
    /**
     * Custom domain configuration for the environment
     */
     ...
     * SKU properties of the Environment.
     */
    sku?: pulumi.Input<inputs.app.v20220601preview.EnvironmentSkuPropertiesArgs>;
    /**
     * Resource tags.
     */
     ...
     * Vnet configuration for the environment
     */
    vnetConfiguration?: pulumi.Input<inputs.app.v20220601preview.VnetConfigurationArgs>;
    /**
     * Workload profiles configured for the Managed Environment.
     */
    workloadProfiles?: pulumi.Input<pulumi.Input<inputs.app.v20220601preview.WorkloadProfileArgs>[]>;
    /**
     * Whether or not this Managed Environment is zone-redundant.
     */
