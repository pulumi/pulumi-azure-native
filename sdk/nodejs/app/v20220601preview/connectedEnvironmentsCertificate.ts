...
export class ConnectedEnvironmentsCertificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectedEnvironmentsCertificate {
        pulumi.log.warn("ConnectedEnvironmentsCertificate is deprecated: azure-native:app/v20220601preview:ConnectedEnvironmentsCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20221001:ConnectedEnvironmentsCertificate to guarantee forwards compatibility.")
