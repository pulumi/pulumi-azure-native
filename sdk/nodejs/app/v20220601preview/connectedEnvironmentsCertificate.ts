 ...
 *
 * @deprecated azure-native:app/v20220601preview:ConnectedEnvironmentsCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:ConnectedEnvironmentsCertificate to guarantee forwards compatibility.
 */
export class ConnectedEnvironmentsCertificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectedEnvironmentsCertificate {
        pulumi.log.warn("ConnectedEnvironmentsCertificate is deprecated: azure-native:app/v20220601preview:ConnectedEnvironmentsCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:ConnectedEnvironmentsCertificate to guarantee forwards compatibility.")
        return new ConnectedEnvironmentsCertificate(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20220601preview:ConnectedEnvironmentsCertificate';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.app.v20220601preview.CertificateResponseProperties>;
    /**
    ...
    constructor(name: string, args: ConnectedEnvironmentsCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20221001:ConnectedEnvironmentsCertificate" }] };
...
export interface ConnectedEnvironmentsCertificateArgs {
     ...
     * Certificate resource specific properties
     */
    properties?: pulumi.Input<inputs.app.v20220601preview.CertificatePropertiesArgs>;
    /**
