...
export function getConnectedEnvironmentsDaprComponent(args: GetConnectedEnvironmentsDaprComponentArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectedEnvironmentsDaprComponentResult> {
    pulumi.log.warn("getConnectedEnvironmentsDaprComponent is deprecated: azure-native:app/v20220601preview:ConnectedEnvironmentsDaprComponent is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:ConnectedEnvironmentsDaprComponent to guarantee forwards compatibility.")
...
export interface GetConnectedEnvironmentsDaprComponentResult {
     ...
     * Component metadata
     */
    readonly metadata?: outputs.app.v20220601preview.DaprMetadataResponse[];
    /**
     ...
     */
    readonly secrets?: outputs.app.v20220601preview.SecretResponse[];
    /**
