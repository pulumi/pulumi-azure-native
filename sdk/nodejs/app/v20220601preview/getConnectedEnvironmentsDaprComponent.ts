...
export function getConnectedEnvironmentsDaprComponent(args: GetConnectedEnvironmentsDaprComponentArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectedEnvironmentsDaprComponentResult> {
    pulumi.log.warn("getConnectedEnvironmentsDaprComponent is deprecated: azure-native:app/v20220601preview:ConnectedEnvironmentsDaprComponent is being removed in the next major version of this provider. Please upgrade to azure-native:app/v20221001:ConnectedEnvironmentsDaprComponent to guarantee forwards compatibility.")
