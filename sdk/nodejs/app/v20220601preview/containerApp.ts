 ...
 * Container App.
 *
 * @deprecated azure-native:app/v20220601preview:ContainerApp is being removed in the next major version of this provider. Please upgrade to azure-native:app/v20221001:ContainerApp to guarantee forwards compatibility.
 */
export class ContainerApp extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ContainerApp {
        pulumi.log.warn("ContainerApp is deprecated: azure-native:app/v20220601preview:ContainerApp is being removed in the next major version of this provider. Please upgrade to azure-native:app/v20221001:ContainerApp to guarantee forwards compatibility.")
