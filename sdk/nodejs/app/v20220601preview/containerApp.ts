...
export class ContainerApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20220601preview:ContainerApp';
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.app.v20220601preview.ConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.app.v20220601preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly template!: pulumi.Output<outputs.app.v20220601preview.TemplateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContainerAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["configuration"] = args ? (args.configuration ? pulumi.output(args.configuration).apply(inputs.app.v20220601preview.configurationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ContainerApp" }, { type: "azure-native:app/v20220101preview:ContainerApp" }, { type: "azure-native:app/v20220301:ContainerApp" }, { type: "azure-native:app/v20221001:ContainerApp" }, { type: "azure-native:app/v20221101preview:ContainerApp" }, { type: "azure-native:app/v20230401preview:ContainerApp" }, { type: "azure-native:app/v20230501:ContainerApp" }, { type: "azure-native:app/v20230502preview:ContainerApp" }, { type: "azure-native:app/v20230801preview:ContainerApp" }, { type: "azure-native:app/v20231102preview:ContainerApp" }, { type: "azure-native:app/v20240202preview:ContainerApp" }, { type: "azure-native:app/v20240301:ContainerApp" }, { type: "azure-native:app/v20240802preview:ContainerApp" }, { type: "azure-native:app/v20241002preview:ContainerApp" }] };
...
export interface ContainerAppArgs {
     ...
     * Non versioned Container App configuration properties.
     */
    configuration?: pulumi.Input<inputs.app.v20220601preview.ConfigurationArgs>;
    /**
     ...
     * managed identities for the Container App to interact with other Azure services without maintaining any secrets or credentials in code.
     */
    identity?: pulumi.Input<inputs.app.v20220601preview.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Container App versioned application definition.
     */
    template?: pulumi.Input<inputs.app.v20220601preview.TemplateArgs>;
    /**
     * Workload profile type to pin for container app execution.
     */
