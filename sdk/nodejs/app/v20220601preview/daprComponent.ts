...
export class DaprComponent extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DaprComponent {
        pulumi.log.warn("DaprComponent is deprecated: azure-native:app/v20220601preview:DaprComponent is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:DaprComponent to guarantee forwards compatibility.")
        return new DaprComponent(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20220601preview:DaprComponent';
     ...
     * Component metadata
     */
    public readonly metadata!: pulumi.Output<outputs.app.v20220601preview.DaprMetadataResponse[] | undefined>;
    /**
     ...
     */
    public readonly secrets!: pulumi.Output<outputs.app.v20220601preview.SecretResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: DaprComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:DaprComponent" }, { type: "azure-native:app/v20220101preview:DaprComponent" }, { type: "azure-native:app/v20220301:DaprComponent" }, { type: "azure-native:app/v20221001:DaprComponent" }] };
...
export interface DaprComponentArgs {
     ...
     * Component metadata
     */
    metadata?: pulumi.Input<pulumi.Input<inputs.app.v20220601preview.DaprMetadataArgs>[]>;
    /**
