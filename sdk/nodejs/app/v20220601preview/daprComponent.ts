...
export class DaprComponent extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DaprComponent {
        pulumi.log.warn("DaprComponent is deprecated: azure-native:app/v20220601preview:DaprComponent is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20221001:DaprComponent to guarantee forwards compatibility.")
