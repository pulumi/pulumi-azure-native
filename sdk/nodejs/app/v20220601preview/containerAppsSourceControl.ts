...
export class ContainerAppsSourceControl extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ContainerAppsSourceControl {
        pulumi.log.warn("ContainerAppsSourceControl is deprecated: azure-native:app/v20220601preview:ContainerAppsSourceControl is being removed in the next major version of this provider. Please upgrade to azure-native:app/v20221001:ContainerAppsSourceControl to guarantee forwards compatibility.")
        return new ContainerAppsSourceControl(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20220601preview:ContainerAppsSourceControl';
     ...
     */
    public readonly githubActionConfiguration!: pulumi.Output<outputs.app.v20220601preview.GithubActionConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContainerAppsSourceControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ContainerAppsSourceControl" }, { type: "azure-native:app/v20220101preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20220301:ContainerAppsSourceControl" }, { type: "azure-native:app/v20221001:ContainerAppsSourceControl" }] };
...
export interface ContainerAppsSourceControlArgs {
     ...
     * as they were at the creation time
     */
    githubActionConfiguration?: pulumi.Input<inputs.app.v20220601preview.GithubActionConfigurationArgs>;
    /**
     * The repo url which will be integrated to ContainerApp.
     */
