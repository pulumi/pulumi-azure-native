 ...
 * Dapr Component.
 *
 * @deprecated azure-native:app/v20220601preview:ConnectedEnvironmentsDaprComponent is being removed in the next major version of this provider. Please upgrade to azure-native:app/v20221001:ConnectedEnvironmentsDaprComponent to guarantee forwards compatibility.
 */
export class ConnectedEnvironmentsDaprComponent extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConnectedEnvironmentsDaprComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20221001:ConnectedEnvironmentsDaprComponent" }] };
