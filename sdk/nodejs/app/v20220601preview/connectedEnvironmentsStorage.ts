 ...
 *
 * @deprecated azure-native:app/v20220601preview:ConnectedEnvironmentsStorage is being removed in the next major version of this provider. Please upgrade to azure-native:app/v20221001:ConnectedEnvironmentsStorage to guarantee forwards compatibility.
 */
export class ConnectedEnvironmentsStorage extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectedEnvironmentsStorage {
        pulumi.log.warn("ConnectedEnvironmentsStorage is deprecated: azure-native:app/v20220601preview:ConnectedEnvironmentsStorage is being removed in the next major version of this provider. Please upgrade to azure-native:app/v20221001:ConnectedEnvironmentsStorage to guarantee forwards compatibility.")
        return new ConnectedEnvironmentsStorage(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20220601preview:ConnectedEnvironmentsStorage';
     ...
     * Storage properties
     */
    public readonly properties!: pulumi.Output<outputs.app.v20220601preview.ConnectedEnvironmentStorageResponseProperties>;
    /**
...
export interface ConnectedEnvironmentsStorageArgs {
     ...
     * Storage properties
     */
    properties?: pulumi.Input<inputs.app.v20220601preview.ConnectedEnvironmentStoragePropertiesArgs>;
    /**
