...
export class ManagedEnvironmentsStorage extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedEnvironmentsStorageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20220101preview:ManagedEnvironmentsStorage" }, { type: "azure-native:app/v20220301:ManagedEnvironmentsStorage" }, { type: "azure-native:app/v20220601preview:ManagedEnvironmentsStorage" }] };
