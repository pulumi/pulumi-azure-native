 ...
 *
 * const connectedEnvironmentsStorage = new azure_native.app.v20221001.ConnectedEnvironmentsStorage("connectedEnvironmentsStorage", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:app/v20221001:ConnectedEnvironmentsStorage jlaw-demo1 /subscriptions/8efdecc5-919e-44eb-b179-915dca89ebf9/resourceGroups/examplerg/providers/Microsoft.App/connectedEnvironments/env/storages/jlaw-demo1 
 * ```
 */
export class ConnectedEnvironmentsStorage extends pulumi.CustomResource {
     ...
     * Storage properties
     */
    public readonly properties!: pulumi.Output<outputs.app.v20221001.ConnectedEnvironmentStorageResponseProperties>;
    /**
    ...
    constructor(name: string, args: ConnectedEnvironmentsStorageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20220601preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20221101preview:ConnectedEnvironmentsStorage" }] };
...
export interface ConnectedEnvironmentsStorageArgs {
     ...
     * Storage properties
     */
    properties?: pulumi.Input<inputs.app.v20221001.ConnectedEnvironmentStoragePropertiesArgs>;
    /**
