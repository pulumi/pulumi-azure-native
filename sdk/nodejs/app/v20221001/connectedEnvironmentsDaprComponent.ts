 ...
 *
 * const connectedEnvironmentsDaprComponent = new azure_native.app.v20221001.ConnectedEnvironmentsDaprComponent("connectedEnvironmentsDaprComponent", {
...
export class ConnectedEnvironmentsDaprComponent extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConnectedEnvironmentsDaprComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20220601preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20221101preview:ConnectedEnvironmentsDaprComponent" }] };
