 ...
 *
 * const daprComponent = new azure_native.app.v20221001.DaprComponent("daprComponent", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:app/v20221001:DaprComponent reddog /subscriptions/8efdecc5-919e-44eb-b179-915dca89ebf9/resourceGroups/examplerg/providers/Microsoft.App/managedEnvironments/jlaw-demo1/daprcomponents/reddog 
 * ```
 */
export class DaprComponent extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DaprComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:DaprComponent" }, { type: "azure-native:app/v20220101preview:DaprComponent" }, { type: "azure-native:app/v20220301:DaprComponent" }, { type: "azure-native:app/v20220601preview:DaprComponent" }, { type: "azure-native:app/v20221101preview:DaprComponent" }] };
