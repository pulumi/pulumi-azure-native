 ...
 *
 * const containerAppsAuthConfig = new azure_native.app.v20221001.ContainerAppsAuthConfig("containerAppsAuthConfig", {
 *     authConfigName: "current",
 *     containerAppName: "testcanadacentral",
 *     globalValidation: {
 *         unauthenticatedClientAction: azure_native.app.v20221001.UnauthenticatedClientActionV2.AllowAnonymous,
 *     },
 *     identityProviders: {
 *         facebook: {
 *             registration: {
