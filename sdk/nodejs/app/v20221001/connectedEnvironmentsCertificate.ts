 ...
 *
 * const connectedEnvironmentsCertificate = new azure_native.app.v20221001.ConnectedEnvironmentsCertificate("connectedEnvironmentsCertificate", {
...
export class ConnectedEnvironmentsCertificate extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConnectedEnvironmentsCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ConnectedEnvironmentsCertificate" }, { type: "azure-native:app/v20220601preview:ConnectedEnvironmentsCertificate" }, { type: "azure-native:app/v20221101preview:ConnectedEnvironmentsCertificate" }] };
