...
export function getDaprComponent(args: GetDaprComponentArgs, opts?: pulumi.InvokeOptions): Promise<GetDaprComponentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20230801preview:getDaprComponent", {
...
export interface GetDaprComponentResult {
     ...
     * Component metadata
     */
    readonly metadata?: outputs.app.v20230801preview.DaprMetadataResponse[];
    /**
     ...
     */
    readonly secrets?: outputs.app.v20230801preview.SecretResponse[];
    /**
     * List of container app services that are bound to the Dapr component
     */
    readonly serviceComponentBind?: outputs.app.v20230801preview.DaprComponentServiceBindingResponse[];
    /**
...
export function getDaprComponentOutput(args: GetDaprComponentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDaprComponentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:app/v20230801preview:getDaprComponent", {
        "componentName": args.componentName,
        "environmentName": args.environmentName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
