...
export class DaprComponentResiliencyPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly inboundPolicy!: pulumi.Output<outputs.app.v20230801preview.DaprComponentResiliencyPolicyConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly outboundPolicy!: pulumi.Output<outputs.app.v20230801preview.DaprComponentResiliencyPolicyConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DaprComponentResiliencyPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:DaprComponentResiliencyPolicy" }, { type: "azure-native:app/v20231102preview:DaprComponentResiliencyPolicy" }, { type: "azure-native:app/v20240202preview:DaprComponentResiliencyPolicy" }, { type: "azure-native:app/v20240802preview:DaprComponentResiliencyPolicy" }] };
