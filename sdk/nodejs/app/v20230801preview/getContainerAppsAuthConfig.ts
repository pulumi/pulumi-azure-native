...
export interface GetContainerAppsAuthConfigResult {
     ...
     */
    readonly encryptionSettings?: outputs.app.v20230801preview.EncryptionSettingsResponse;
    /**
     * The configuration settings that determines the validation flow of users using  Service Authentication/Authorization.
     */
    readonly globalValidation?: outputs.app.v20230801preview.GlobalValidationResponse;
    /**
     * The configuration settings of the HTTP requests for authentication and authorization requests made against ContainerApp Service Authentication/Authorization.
     */
    readonly httpSettings?: outputs.app.v20230801preview.HttpSettingsResponse;
    /**
     ...
     */
    readonly identityProviders?: outputs.app.v20230801preview.IdentityProvidersResponse;
    /**
     * The configuration settings of the login flow of users using ContainerApp Service Authentication/Authorization.
     */
    readonly login?: outputs.app.v20230801preview.LoginResponse;
    /**
     ...
     */
    readonly platform?: outputs.app.v20230801preview.AuthPlatformResponse;
    /**
...
export function getContainerAppsAuthConfigOutput(args: GetContainerAppsAuthConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerAppsAuthConfigResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:app/v20230801preview:getContainerAppsAuthConfig", {
        "authConfigName": args.authConfigName,
        "containerAppName": args.containerAppName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
