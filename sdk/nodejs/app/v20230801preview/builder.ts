...
export class Builder extends pulumi.CustomResource {
     ...
     */
    public readonly containerRegistries!: pulumi.Output<outputs.app.v20230801preview.ContainerRegistryResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: BuilderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:Builder" }, { type: "azure-native:app/v20231102preview:Builder" }, { type: "azure-native:app/v20240202preview:Builder" }, { type: "azure-native:app/v20240802preview:Builder" }, { type: "azure-native:app/v20241002preview:Builder" }] };
