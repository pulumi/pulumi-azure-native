...
export class ConnectedEnvironmentsDaprComponent extends pulumi.CustomResource {
     ...
     * Component metadata
     */
    public readonly metadata!: pulumi.Output<outputs.app.v20230801preview.DaprMetadataResponse[] | undefined>;
    /**
     ...
     */
    public readonly secrets!: pulumi.Output<outputs.app.v20230801preview.SecretResponse[] | undefined>;
    /**
     * List of container app services that are bound to the Dapr component
     */
    public readonly serviceComponentBind!: pulumi.Output<outputs.app.v20230801preview.DaprComponentServiceBindingResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ConnectedEnvironmentsDaprComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20220601preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20221001:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20221101preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20230401preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20230501:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20230502preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20231102preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20240202preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20240301:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20240802preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20241002preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20250101:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app:ConnectedEnvironmentsDaprComponent" }] };
...
export interface ConnectedEnvironmentsDaprComponentArgs {
     ...
     * Component metadata
     */
    metadata?: pulumi.Input<pulumi.Input<inputs.app.v20230801preview.DaprMetadataArgs>[]>;
    /**
     ...
     * Collection of secrets used by a Dapr component
     */
    secrets?: pulumi.Input<pulumi.Input<inputs.app.v20230801preview.SecretArgs>[]>;
    /**
     * List of container app services that are bound to the Dapr component
     */
    serviceComponentBind?: pulumi.Input<pulumi.Input<inputs.app.v20230801preview.DaprComponentServiceBindingArgs>[]>;
    /**
     * Component version
     */
