...
export class Agent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app:Agent';
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.app.AgentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20260101:Agent" }] };
...
export interface AgentArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.app.AgentPropertiesArgs | undefined>;
    /**
