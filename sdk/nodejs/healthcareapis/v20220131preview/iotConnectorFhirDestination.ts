...
export class IotConnectorFhirDestination extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.healthcareapis.v20220131preview.IotFhirDestinationPropertiesResponse>;
    /**
...
export interface IotConnectorFhirDestinationArgs {
     ...
     * IoT FHIR Destination settings.
     */
    properties: pulumi.Input<inputs.healthcareapis.v20220131preview.IotFhirDestinationPropertiesArgs>;
    /**
