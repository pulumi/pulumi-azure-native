...
export function getFhirService(args: GetFhirServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetFhirServiceResult> {
    pulumi.log.warn("getFhirService is deprecated: azure-native:healthcareapis/v20211101:FhirService is being removed in the next major version of this provider. Please upgrade to azure-native:healthcareapis/v20221201:FhirService to guarantee forwards compatibility.")
