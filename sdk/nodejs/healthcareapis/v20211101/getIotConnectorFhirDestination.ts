...
export function getIotConnectorFhirDestination(args: GetIotConnectorFhirDestinationArgs, opts?: pulumi.InvokeOptions): Promise<GetIotConnectorFhirDestinationResult> {
    pulumi.log.warn("getIotConnectorFhirDestination is deprecated: Version v20211101 will be removed in the next major version of the provider. Upgrade to version v20220515 or later.")
    if (!opts) {
        opts = {}
    }
