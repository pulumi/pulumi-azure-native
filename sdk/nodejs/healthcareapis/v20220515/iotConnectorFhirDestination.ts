...
export class IotConnectorFhirDestination extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IotConnectorFhirDestination {
        pulumi.log.warn("IotConnectorFhirDestination is deprecated: azure-native:healthcareapis/v20220515:IotConnectorFhirDestination is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:IotConnectorFhirDestination to guarantee forwards compatibility.")
        return new IotConnectorFhirDestination(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:healthcareapis/v20220515:IotConnectorFhirDestination';
     ...
     * FHIR Mappings
     */
    public readonly fhirMapping!: pulumi.Output<outputs.healthcareapis.v20220515.IotMappingPropertiesResponse>;
    /**
...
export interface IotConnectorFhirDestinationArgs {
     ...
     * FHIR Mappings
     */
    fhirMapping: pulumi.Input<inputs.healthcareapis.v20220515.IotMappingPropertiesArgs>;
    /**
     * Fully qualified resource id of the FHIR service to connect to.
     */
     ...
     * Determines how resource identity is resolved on the destination.
     */
    resourceIdentityResolutionType: pulumi.Input<string | enums.healthcareapis.v20220515.IotIdentityResolutionType>;
    /**
