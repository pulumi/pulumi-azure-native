 ...
 *
 * const iotConnector = new azure_native.healthcareapis.v20220515.IotConnector("iotConnector", {
 *     deviceMapping: {
 *         content: {
 *             template: [{
 *                 template: {
...
export class IotConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:healthcareapis/v20220515:IotConnector';
     ...
     * Device Mappings.
     */
    public readonly deviceMapping!: pulumi.Output<outputs.healthcareapis.v20220515.IotMappingPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly ingestionEndpointConfiguration!: pulumi.Output<outputs.healthcareapis.v20220515.IotEventHubIngestionEndpointConfigurationResponse | undefined>;
    /**
...
export interface IotConnectorArgs {
     ...
     * Device Mappings.
     */
    deviceMapping?: pulumi.Input<inputs.healthcareapis.v20220515.IotMappingPropertiesArgs>;
    /**
     * Setting indicating whether the service has a managed identity associated with it.
     */
     ...
     * Source configuration.
     */
    ingestionEndpointConfiguration?: pulumi.Input<inputs.healthcareapis.v20220515.IotEventHubIngestionEndpointConfigurationArgs>;
    /**
