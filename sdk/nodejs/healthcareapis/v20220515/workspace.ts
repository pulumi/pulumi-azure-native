...
export class Workspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Workspace {
        pulumi.log.warn("Workspace is deprecated: azure-native:healthcareapis/v20220515:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:Workspace to guarantee forwards compatibility.")
