...
export function getWorkspacePrivateEndpointConnection(args: GetWorkspacePrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspacePrivateEndpointConnectionResult> {
    pulumi.log.warn("getWorkspacePrivateEndpointConnection is deprecated: azure-native:healthcareapis/v20220515:WorkspacePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:WorkspacePrivateEndpointConnection to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:healthcareapis/v20220515:getWorkspacePrivateEndpointConnection", {
...
export interface GetWorkspacePrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint?: outputs.healthcareapis.v20220515.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: outputs.healthcareapis.v20220515.PrivateLinkServiceConnectionStateResponse;
    /**
     ...
     */
    readonly systemData: outputs.healthcareapis.v20220515.SystemDataResponse;
    /**
