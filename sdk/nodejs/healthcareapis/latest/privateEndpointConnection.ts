...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:healthcareapis/latest:PrivateEndpointConnection';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.healthcareapis.latest.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.healthcareapis.latest.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:healthcareapis/latest:PrivateEndpointConnection" }, { type: "azure-native:healthcareapis:PrivateEndpointConnection" }, { type: "azure-nextgen:healthcareapis:PrivateEndpointConnection" }, { type: "azure-native:healthcareapis/v20200330:PrivateEndpointConnection" }, { type: "azure-nextgen:healthcareapis/v20200330:PrivateEndpointConnection" }, { type: "azure-native:healthcareapis/v20210111:PrivateEndpointConnection" }, { type: "azure-nextgen:healthcareapis/v20210111:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Input<inputs.healthcareapis.latest.PrivateLinkServiceConnectionState>;
    /**
