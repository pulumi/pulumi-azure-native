...
export function getIotConnectorFhirDestination(args: GetIotConnectorFhirDestinationArgs, opts?: pulumi.InvokeOptions): Promise<GetIotConnectorFhirDestinationResult> {
    pulumi.log.warn("getIotConnectorFhirDestination is deprecated: azure-native:healthcareapis/v20220601:IotConnectorFhirDestination is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20221201:IotConnectorFhirDestination to guarantee forwards compatibility.")
...
export interface GetIotConnectorFhirDestinationResult {
     ...
     * FHIR Mappings
     */
    readonly fhirMapping: outputs.healthcareapis.v20220601.IotMappingPropertiesResponse;
    /**
