...
export function getDicomService(args: GetDicomServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetDicomServiceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:healthcareapis/v20250301preview:getDicomService", {
...
export interface GetDicomServiceResult {
     ...
     */
    readonly authenticationConfiguration?: outputs.healthcareapis.v20250301preview.DicomServiceAuthenticationConfigurationResponse;
    /**
     * Dicom Service Cors configuration.
     */
    readonly corsConfiguration?: outputs.healthcareapis.v20250301preview.CorsConfigurationResponse;
    /**
     ...
     */
    readonly storageConfiguration?: outputs.healthcareapis.v20250301preview.StorageConfigurationResponse;
    /**
...
export function getDicomServiceOutput(args: GetDicomServiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDicomServiceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:healthcareapis/v20250301preview:getDicomService", {
        "dicomServiceName": args.dicomServiceName,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
