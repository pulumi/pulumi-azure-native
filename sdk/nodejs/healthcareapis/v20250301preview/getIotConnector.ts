...
export function getIotConnector(args: GetIotConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetIotConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:healthcareapis/v20250301preview:getIotConnector", {
...
export interface GetIotConnectorResult {
     ...
     * Device Mappings.
     */
    readonly deviceMapping?: outputs.healthcareapis.v20250301preview.IotMappingPropertiesResponse;
    /**
     ...
     */
    readonly ingestionEndpointConfiguration?: outputs.healthcareapis.v20250301preview.IotEventHubIngestionEndpointConfigurationResponse;
    /**
...
export function getIotConnectorOutput(args: GetIotConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIotConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:healthcareapis/v20250301preview:getIotConnector", {
        "iotConnectorName": args.iotConnectorName,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
