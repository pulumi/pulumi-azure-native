...
export class IotConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:healthcareapis/v20210601preview:IotConnector';
     ...
     * Device Mappings.
     */
    public readonly deviceMapping!: pulumi.Output<outputs.healthcareapis.v20210601preview.IotMappingPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly ingestionEndpointConfiguration!: pulumi.Output<outputs.healthcareapis.v20210601preview.IotEventHubIngestionEndpointConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: IotConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:healthcareapis:IotConnector" }, { type: "azure-native:healthcareapis/v20211101:IotConnector" }, { type: "azure-native:healthcareapis/v20220131preview:IotConnector" }, { type: "azure-native:healthcareapis/v20220515:IotConnector" }, { type: "azure-native:healthcareapis/v20220601:IotConnector" }] };
