...
export class IotConnectorFhirDestination extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.healthcareapis.v20210601preview.IotFhirDestinationPropertiesResponse>;
    /**
...
export interface IotConnectorFhirDestinationArgs {
     ...
     * IoT FHIR Destination settings.
     */
    properties: pulumi.Input<inputs.healthcareapis.v20210601preview.IotFhirDestinationPropertiesArgs>;
    /**
