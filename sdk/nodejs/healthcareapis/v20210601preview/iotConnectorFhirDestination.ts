...
export class IotConnectorFhirDestination extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IotConnectorFhirDestinationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:healthcareapis/v20210601preview:IotConnectorFhirDestination" }, { type: "azure-native:healthcareapis:IotConnectorFhirDestination" }, { type: "azure-nextgen:healthcareapis:IotConnectorFhirDestination" }] };
