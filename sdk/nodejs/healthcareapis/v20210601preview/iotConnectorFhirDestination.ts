 ...
 *
 * @deprecated azure-native:healthcareapis/v20210601preview:IotConnectorFhirDestination is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20221201:IotConnectorFhirDestination to guarantee forwards compatibility.
 */
export class IotConnectorFhirDestination extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:healthcareapis/v20210601preview:IotConnectorFhirDestination';
     ...
     * FHIR Mappings
     */
    public readonly fhirMapping!: pulumi.Output<outputs.healthcareapis.v20210601preview.IotMappingPropertiesResponse>;
    /**
