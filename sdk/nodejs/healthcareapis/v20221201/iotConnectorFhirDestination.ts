 ...
 *
 * const iotConnectorFhirDestination = new azure_native.healthcareapis.v20221201.IotConnectorFhirDestination("iotConnectorFhirDestination", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:healthcareapis/v20221201:IotConnectorFhirDestination dest1 /subscriptions/subid/resourceGroups/testRG/providers/Microsoft.HealthcareApis/workspaces/workspace1/iotconnectors/blue/fhirdestinations/dest1 
 * ```
 */
export class IotConnectorFhirDestination extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:healthcareapis/v20221201:IotConnectorFhirDestination';
     ...
     * FHIR Mappings
     */
    public readonly fhirMapping!: pulumi.Output<outputs.healthcareapis.v20221201.IotMappingPropertiesResponse>;
    /**
...
export interface IotConnectorFhirDestinationArgs {
     ...
     * FHIR Mappings
     */
    fhirMapping: pulumi.Input<inputs.healthcareapis.v20221201.IotMappingPropertiesArgs>;
    /**
     * Fully qualified resource id of the FHIR service to connect to.
     */
     ...
     * Determines how resource identity is resolved on the destination.
     */
    resourceIdentityResolutionType: pulumi.Input<string | enums.healthcareapis.v20221201.IotIdentityResolutionType>;
    /**
