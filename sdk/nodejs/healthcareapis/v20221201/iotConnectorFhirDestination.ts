...
export class IotConnectorFhirDestination extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IotConnectorFhirDestination {
        pulumi.log.warn("IotConnectorFhirDestination is deprecated: azure-native:healthcareapis/v20221201:IotConnectorFhirDestination is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:IotConnectorFhirDestination to guarantee forwards compatibility.")
