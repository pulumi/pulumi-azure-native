 ...
 *
 * const iotConnector = new azure_native.healthcareapis.v20221201.IotConnector("iotConnector", {
 *     deviceMapping: {
 *         content: {
 *             template: [{
 *                 template: {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:healthcareapis/v20221201:IotConnector blue /subscriptions/subid/resourceGroups/testRG/providers/Microsoft.HealthcareApis/workspaces/workspace1/iotconnectors/blue 
 * ```
 */
export class IotConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:healthcareapis/v20221201:IotConnector';
     ...
     * Device Mappings.
     */
    public readonly deviceMapping!: pulumi.Output<outputs.healthcareapis.v20221201.IotMappingPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.healthcareapis.v20221201.ServiceManagedIdentityResponseIdentity | undefined>;
    /**
     * Source configuration.
     */
    public readonly ingestionEndpointConfiguration!: pulumi.Output<outputs.healthcareapis.v20221201.IotEventHubIngestionEndpointConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.healthcareapis.v20221201.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface IotConnectorArgs {
     ...
     * Device Mappings.
     */
    deviceMapping?: pulumi.Input<inputs.healthcareapis.v20221201.IotMappingPropertiesArgs>;
    /**
     * Setting indicating whether the service has a managed identity associated with it.
     */
    identity?: pulumi.Input<inputs.healthcareapis.v20221201.ServiceManagedIdentityIdentityArgs>;
    /**
     * Source configuration.
     */
    ingestionEndpointConfiguration?: pulumi.Input<inputs.healthcareapis.v20221201.IotEventHubIngestionEndpointConfigurationArgs>;
    /**
