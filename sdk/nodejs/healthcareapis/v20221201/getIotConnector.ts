...
export function getIotConnector(args: GetIotConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetIotConnectorResult> {
    pulumi.log.warn("getIotConnector is deprecated: azure-native:healthcareapis/v20221201:IotConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:IotConnector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:healthcareapis/v20221201:getIotConnector", {
...
export interface GetIotConnectorResult {
     ...
     * Device Mappings.
     */
    readonly deviceMapping?: outputs.healthcareapis.v20221201.IotMappingPropertiesResponse;
    /**
     ...
     */
    readonly identity?: outputs.healthcareapis.v20221201.ServiceManagedIdentityResponseIdentity;
    /**
     * Source configuration.
     */
    readonly ingestionEndpointConfiguration?: outputs.healthcareapis.v20221201.IotEventHubIngestionEndpointConfigurationResponse;
    /**
