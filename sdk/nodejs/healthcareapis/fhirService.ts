...
export class FhirService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FhirServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:healthcareapis/v20220515:FhirService" }, { type: "azure-native:healthcareapis/v20221001preview:FhirService" }, { type: "azure-native:healthcareapis/v20221201:FhirService" }, { type: "azure-native:healthcareapis/v20230228:FhirService" }] };
