...
// Export enums:
export * from "../../types/enums/healthcareapis/v20230228";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:healthcareapis/v20230228:DicomService":
                return new DicomService(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20230228:FhirService":
                return new FhirService(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20230228:IotConnector":
                return new IotConnector(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20230228:IotConnectorFhirDestination":
                return new IotConnectorFhirDestination(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20230228:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20230228:Service":
                return new Service(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20230228:Workspace":
                return new Workspace(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20230228:WorkspacePrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "healthcareapis/v20230228", _module)
