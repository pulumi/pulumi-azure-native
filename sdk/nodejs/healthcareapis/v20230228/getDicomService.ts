...
export interface GetDicomServiceResult {
     ...
     */
    readonly authenticationConfiguration?: outputs.healthcareapis.v20230228.DicomServiceAuthenticationConfigurationResponse;
    /**
     * Dicom Service Cors configuration.
     */
    readonly corsConfiguration?: outputs.healthcareapis.v20230228.CorsConfigurationResponse;
    /**
     ...
     */
    readonly identity?: outputs.healthcareapis.v20230228.ServiceManagedIdentityResponseIdentity;
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.healthcareapis.v20230228.PrivateEndpointConnectionResponse[];
    /**
...
export function getDicomServiceOutput(args: GetDicomServiceOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDicomServiceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:healthcareapis/v20230228:getDicomService", {
        "dicomServiceName": args.dicomServiceName,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
