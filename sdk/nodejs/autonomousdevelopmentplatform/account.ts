...
export class Account extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:autonomousdevelopmentplatform:Account" }, { type: "azure-native:autonomousdevelopmentplatform/v20200701preview:Account" }, { type: "azure-nextgen:autonomousdevelopmentplatform/v20200701preview:Account" }, { type: "azure-native:autonomousdevelopmentplatform/v20210201preview:Account" }, { type: "azure-nextgen:autonomousdevelopmentplatform/v20210201preview:Account" }] };
