...
export class DataPool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataPool {
        pulumi.log.warn("DataPool is deprecated: azure-native:autonomousdevelopmentplatform/v20210201preview:DataPool is being removed in the next major version of this provider. Upgrade to at least azure-native:autonomousdevelopmentplatform/v20211101preview:DataPool to guarantee forwards compatibility.")
        return new DataPool(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:autonomousdevelopmentplatform/v20210201preview:DataPool';
     ...
     */
    public readonly locations!: pulumi.Output<outputs.autonomousdevelopmentplatform.v20210201preview.DataPoolLocationResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.autonomousdevelopmentplatform.v20210201preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: DataPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:autonomousdevelopmentplatform:DataPool" }, { type: "azure-native:autonomousdevelopmentplatform/v20200701preview:DataPool" }, { type: "azure-native:autonomousdevelopmentplatform/v20211101preview:DataPool" }] };
...
export interface DataPoolArgs {
     ...
     * Gets or sets the collection of locations where Data Pool resources should be created
     */
    locations: pulumi.Input<pulumi.Input<inputs.autonomousdevelopmentplatform.v20210201preview.DataPoolLocationArgs>[]>;
    /**
