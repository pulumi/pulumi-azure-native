...
export class DataPool extends pulumi.CustomResource {
     ...
     */
    public readonly locations!: pulumi.Output<outputs.autonomousdevelopmentplatform.v20211101preview.DataPoolLocationResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.autonomousdevelopmentplatform.v20211101preview.SystemDataResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: DataPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:autonomousdevelopmentplatform:DataPool" }, { type: "azure-native:autonomousdevelopmentplatform/v20210201preview:DataPool" }] };
