...
export class JobCollection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:scheduler/v20160301:JobCollection" }, { type: "azure-native:scheduler:JobCollection" }, { type: "azure-nextgen:scheduler:JobCollection" }, { type: "azure-native:scheduler/v20140801preview:JobCollection" }, { type: "azure-nextgen:scheduler/v20140801preview:JobCollection" }, { type: "azure-native:scheduler/v20160101:JobCollection" }, { type: "azure-nextgen:scheduler/v20160101:JobCollection" }] };
...
export interface JobCollectionArgs {
     ...
     * Gets or sets the job collection properties.
     */
    readonly properties?: pulumi.Input<inputs.scheduler.v20160301.JobCollectionPropertiesArgs>;
    /**
