...
export function getJobCollection(args: GetJobCollectionArgs, opts?: pulumi.InvokeOptions): Promise<GetJobCollectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:scheduler/v20160301:getJobCollection", {
...
export interface GetJobCollectionResult {
     ...
     */
    readonly properties: outputs.scheduler.v20160301.JobCollectionPropertiesInvokeResponse;
    /**
