...
export function getJobCollection(args: GetJobCollectionArgs, opts?: pulumi.InvokeOptions): Promise<GetJobCollectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:scheduler/v20140801preview:getJobCollection", {
...
export interface GetJobCollectionResult {
     ...
     */
    readonly properties: outputs.scheduler.v20140801preview.JobCollectionPropertiesInvokeResponse;
    /**
