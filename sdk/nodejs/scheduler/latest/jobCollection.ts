...
export class JobCollection extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: JobCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:scheduler/v20140801preview:JobCollection" }, { type: "azurerm:scheduler/v20160101:JobCollection" }, { type: "azurerm:scheduler/v20160301:JobCollection" }] };
