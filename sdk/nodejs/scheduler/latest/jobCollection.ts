...
export class JobCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:scheduler/latest:JobCollection';
    ...
    constructor(name: string, argsOrState?: JobCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:scheduler/preview:JobCollection" }, { type: "azurerm:scheduler/v20140801preview:JobCollection" }, { type: "azurerm:scheduler/v20160101:JobCollection" }, { type: "azurerm:scheduler/v20160301:JobCollection" }] };
