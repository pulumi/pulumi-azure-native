...
export class JobCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:scheduler/v20160101:JobCollection';
    ...
    constructor(name: string, args: JobCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:scheduler/latest:JobCollection" }, { type: "azurerm:scheduler/preview:JobCollection" }, { type: "azurerm:scheduler/v20140801preview:JobCollection" }, { type: "azurerm:scheduler/v20160301:JobCollection" }] };
