...
export class JobCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:scheduler/preview:JobCollection';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.scheduler.preview.JobCollectionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: JobCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:scheduler/latest:JobCollection" }, { type: "azurerm:scheduler/v20140801preview:JobCollection" }, { type: "azurerm:scheduler/v20160101:JobCollection" }, { type: "azurerm:scheduler/v20160301:JobCollection" }] };
...
export interface JobCollectionArgs {
     ...
     * Gets or sets the job collection properties.
     */
    readonly properties?: pulumi.Input<inputs.scheduler.preview.JobCollectionProperties>;
    /**
