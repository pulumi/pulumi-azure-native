 ...
 *
 * const b2cTenant = new azure_native.azureactivedirectory.v20230118preview.B2CTenant("b2cTenant", {
 *     countryCode: "US",
 *     displayName: "Contoso",
...
export class B2CTenant extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly billingConfig!: pulumi.Output<outputs.azureactivedirectory.v20230118preview.B2CTenantResourcePropertiesResponseBillingConfig | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.azureactivedirectory.v20230118preview.B2CResourceSKUResponse>;
    /**
