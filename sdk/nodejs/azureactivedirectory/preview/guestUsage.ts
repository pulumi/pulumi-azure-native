...
export class GuestUsage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:azureactivedirectory/preview:GuestUsage';
    ...
    constructor(name: string, args: GuestUsageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:azureactivedirectory/v20200501preview:GuestUsage" }] };
