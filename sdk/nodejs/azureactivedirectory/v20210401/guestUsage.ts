...
export class GuestUsage extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GuestUsage {
        pulumi.log.warn("GuestUsage is deprecated: azure-native:azureactivedirectory/v20210401:GuestUsage is being removed in the next major version of this provider. Upgrade to at least azure-native:azureactivedirectory/v20230118preview:GuestUsage to guarantee forwards compatibility.")
