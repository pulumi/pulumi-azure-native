...
export class B2CTenant extends pulumi.CustomResource {
    ...
    constructor(name: string, args: B2CTenantArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:azureactivedirectory/v20190101preview:B2CTenant" }, { type: "azure-native:azureactivedirectory:B2CTenant" }, { type: "azure-nextgen:azureactivedirectory:B2CTenant" }] };
...
export interface B2CTenantArgs {
    ...
    readonly properties: pulumi.Input<inputs.azureactivedirectory.v20190101preview.CreateTenantRequestBodyPropertiesArgs>;
    /**
     ...
     * SKU properties of the Azure AD B2C tenant. Learn more about Azure AD B2C billing at [aka.ms/b2cBilling](https://aka.ms/b2cBilling).
     */
    readonly sku: pulumi.Input<inputs.azureactivedirectory.v20190101preview.B2CResourceSKUArgs>;
    /**
     * Resource Tags
     */
