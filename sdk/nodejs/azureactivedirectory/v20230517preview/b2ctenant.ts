...
export class B2CTenant extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly billingConfig!: pulumi.Output<outputs.azureactivedirectory.v20230517preview.B2CTenantResourcePropertiesResponseBillingConfig | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.azureactivedirectory.v20230517preview.B2CResourceSKUResponse>;
    /**
    ...
    constructor(name: string, args: B2CTenantArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azureactivedirectory/v20190101preview:B2CTenant" }, { type: "azure-native:azureactivedirectory/v20210401:B2CTenant" }, { type: "azure-native:azureactivedirectory/v20230118preview:B2CTenant" }, { type: "azure-native:azureactivedirectory:B2CTenant" }] };
...
export interface B2CTenantArgs {
     ...
     * SKU properties of the Azure AD B2C tenant. Learn more about Azure AD B2C billing at [aka.ms/b2cBilling](https://aka.ms/b2cBilling).
     */
    sku: pulumi.Input<inputs.azureactivedirectory.v20230517preview.B2CResourceSKUArgs>;
    /**
     * Resource Tags
     */
