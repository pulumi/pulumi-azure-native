...
export class GuestUsage extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.azureactivedirectory.v20230517preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: GuestUsageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azureactivedirectory/v20200501preview:GuestUsage" }, { type: "azure-native:azureactivedirectory/v20210401:GuestUsage" }, { type: "azure-native:azureactivedirectory/v20230118preview:GuestUsage" }, { type: "azure-native:azureactivedirectory:GuestUsage" }] };
