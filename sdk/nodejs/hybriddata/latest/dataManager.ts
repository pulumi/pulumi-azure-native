...
export class DataManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybriddata/latest:DataManager';
     ...
     * The sku type.
     */
    public readonly sku!: pulumi.Output<outputs.hybriddata.latest.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DataManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hybriddata/latest:DataManager" }, { type: "azure-native:hybriddata:DataManager" }, { type: "azure-nextgen:hybriddata:DataManager" }, { type: "azure-native:hybriddata/v20160601:DataManager" }, { type: "azure-nextgen:hybriddata/v20160601:DataManager" }, { type: "azure-native:hybriddata/v20190601:DataManager" }, { type: "azure-nextgen:hybriddata/v20190601:DataManager" }] };
...
export interface DataManagerArgs {
     ...
     * The sku type.
     */
    readonly sku?: pulumi.Input<inputs.hybriddata.latest.Sku>;
    /**
     * The list of key value pairs that describe the resource. These tags can be used in viewing and grouping this resource
     * (across resource groups).
     */
