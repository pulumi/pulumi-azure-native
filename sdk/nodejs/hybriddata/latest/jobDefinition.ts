...
export class JobDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybriddata/latest:JobDefinition';
     ...
     */
    public readonly customerSecrets!: pulumi.Output<outputs.hybriddata.latest.CustomerSecretResponse[] | undefined>;
    /**
     ...
     */
    public readonly schedules!: pulumi.Output<outputs.hybriddata.latest.ScheduleResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: JobDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hybriddata/latest:JobDefinition" }, { type: "azure-native:hybriddata:JobDefinition" }, { type: "azure-nextgen:hybriddata:JobDefinition" }, { type: "azure-native:hybriddata/v20160601:JobDefinition" }, { type: "azure-nextgen:hybriddata/v20160601:JobDefinition" }, { type: "azure-native:hybriddata/v20190601:JobDefinition" }, { type: "azure-nextgen:hybriddata/v20190601:JobDefinition" }] };
...
export interface JobDefinitionArgs {
     ...
     * List of customer secrets containing a key identifier and key value. The key identifier is a way for the specific data source to understand the key. Value contains customer secret encrypted by the encryptionKeys.
     */
    readonly customerSecrets?: pulumi.Input<pulumi.Input<inputs.hybriddata.latest.CustomerSecret>[]>;
    /**
     ...
     * This is the preferred geo location for the job to run.
     */
    readonly runLocation?: pulumi.Input<enums.hybriddata.latest.RunLocation>;
    /**
     * Schedule for running the job definition
     */
    readonly schedules?: pulumi.Input<pulumi.Input<inputs.hybriddata.latest.Schedule>[]>;
    /**
     * State of the job definition.
     */
    readonly state: pulumi.Input<enums.hybriddata.latest.State>;
    /**
     * Enum to detect if user confirmation is required. If not passed will default to NotRequired.
     */
    readonly userConfirmation?: pulumi.Input<enums.hybriddata.latest.UserConfirmation>;
}
