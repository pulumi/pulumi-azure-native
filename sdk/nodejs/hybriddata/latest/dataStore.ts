...
export class DataStore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybriddata/latest:DataStore';
    ...
    constructor(name: string, args: DataStoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybriddata/preview:DataStore" }, { type: "azurerm:hybriddata/v20160601:DataStore" }, { type: "azurerm:hybriddata/v20190601:DataStore" }] };
