...
export class DataStore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:hybriddata:DataStore';
    ...
    constructor(name: string, args: DataStoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hybriddata/latest:DataStore" }, { type: "azure-nextgen:hybriddata/v20160601:DataStore" }, { type: "azure-nextgen:hybriddata/v20190601:DataStore" }] };
