 ...
 *
 * const dataManager = new azurerm.hybriddata.v20160601.DataManager("dataManager", {
...
export class DataManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybriddata/v20160601:DataManager';
    ...
    constructor(name: string, argsOrState?: DataManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybriddata/latest:DataManager" }, { type: "azurerm:hybriddata/v20190601:DataManager" }] };
