...
export class DataManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybriddata/v20160601:DataManager';
    ...
    constructor(name: string, args: DataManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hybriddata/v20160601:DataManager" }, { type: "azure-native:hybriddata:DataManager" }, { type: "azure-nextgen:hybriddata:DataManager" }, { type: "azure-native:hybriddata/latest:DataManager" }, { type: "azure-nextgen:hybriddata/latest:DataManager" }, { type: "azure-native:hybriddata/v20190601:DataManager" }, { type: "azure-nextgen:hybriddata/v20190601:DataManager" }] };
