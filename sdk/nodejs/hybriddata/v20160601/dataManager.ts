...
export class DataManager extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hybriddata:DataManager" }, { type: "azure-nextgen:hybriddata/latest:DataManager" }, { type: "azure-nextgen:hybriddata/v20190601:DataManager" }] };
