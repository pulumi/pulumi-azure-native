...
export function getDataStore(args: GetDataStoreArgs, opts?: pulumi.InvokeOptions): Promise<GetDataStoreResult> {
    pulumi.log.warn("getDataStore is deprecated: Version 2016-06-01 will be removed in v2 of the provider.")
...
export interface GetDataStoreResult {
     ...
     */
    readonly properties: outputs.hybriddata.v20160601.DataStorePropertiesResponse;
    /**
     * Type of the object.
     */
