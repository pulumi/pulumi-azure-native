...
export class DataStore extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataStoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybriddata/latest:DataStore" }, { type: "azurerm:hybriddata/preview:DataStore" }, { type: "azurerm:hybriddata/v20190601:DataStore" }] };
