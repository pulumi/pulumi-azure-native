...
export class DataManager extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataManagerState, opts?: pulumi.CustomResourceOptions): DataManager {
        return new DataManager(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybriddata:DataManager';
    ...
    constructor(name: string, argsOrState?: DataManagerArgs | DataManagerState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as DataManagerState | undefined;
...
export interface DataManagerState {
     ...
     * The sku type.
     */
    readonly sku?: pulumi.Input<inputs.hybriddata.SkuResponse>;
    /**
     * The list of key value pairs that describe the resource. These tags can be used in viewing and grouping this resource
     * (across resource groups).
     */
...
export interface DataManagerArgs {
     ...
     * The sku type.
     */
    readonly sku?: pulumi.Input<inputs.hybriddata.Sku>;
    /**
     * The list of key value pairs that describe the resource. These tags can be used in viewing and grouping this resource
     * (across resource groups).
     */
