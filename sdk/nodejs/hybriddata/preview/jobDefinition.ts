...
export class JobDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybriddata/preview:JobDefinition';
     ...
     */
    public readonly schedules!: pulumi.Output<outputs.hybriddata.preview.ScheduleResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: JobDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybriddata/latest:JobDefinition" }, { type: "azurerm:hybriddata/v20160601:JobDefinition" }, { type: "azurerm:hybriddata/v20190601:JobDefinition" }] };
...
export interface JobDefinitionArgs {
     ...
     * Schedule for running the job definition
     */
    readonly schedules?: pulumi.Input<pulumi.Input<inputs.hybriddata.preview.Schedule>[]>;
    /**
     * State of the job definition.
     */
