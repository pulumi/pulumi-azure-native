...
export class DataStore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybriddata/preview:DataStore';
     ...
     */
    public readonly customerSecrets!: pulumi.Output<outputs.hybriddata.preview.CustomerSecretResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: DataStoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybriddata/latest:DataStore" }, { type: "azurerm:hybriddata/v20160601:DataStore" }, { type: "azurerm:hybriddata/v20190601:DataStore" }] };
...
export interface DataStoreArgs {
     ...
     * List of customer secrets containing a key identifier and key value. The key identifier is a way for the specific data source to understand the key. Value contains customer secret encrypted by the encryptionKeys.
     */
    readonly customerSecrets?: pulumi.Input<pulumi.Input<inputs.hybriddata.preview.CustomerSecret>[]>;
    /**
