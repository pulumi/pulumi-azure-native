...
export class DataManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybriddata/preview:DataManager';
     ...
     * The sku type.
     */
    public readonly sku!: pulumi.Output<outputs.hybriddata.preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DataManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybriddata/latest:DataManager" }, { type: "azurerm:hybriddata/v20160601:DataManager" }, { type: "azurerm:hybriddata/v20190601:DataManager" }] };
...
export interface DataManagerArgs {
     ...
     * The sku type.
     */
    readonly sku?: pulumi.Input<inputs.hybriddata.preview.Sku>;
    /**
     * The list of key value pairs that describe the resource. These tags can be used in viewing and grouping this resource
     * (across resource groups).
     */
