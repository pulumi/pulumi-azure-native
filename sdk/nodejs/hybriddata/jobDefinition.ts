...
export class JobDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:hybriddata:JobDefinition';
    ...
    constructor(name: string, args: JobDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hybriddata/latest:JobDefinition" }, { type: "azure-nextgen:hybriddata/v20160601:JobDefinition" }, { type: "azure-nextgen:hybriddata/v20190601:JobDefinition" }] };
