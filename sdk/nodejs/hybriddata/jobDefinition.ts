...
export class JobDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.hybriddata.jobDefinitionPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface JobDefinitionArgs {
     ...
     * JobDefinition properties.
     */
    properties: pulumi.Input<inputs.hybriddata.JobDefinitionPropertiesArgs>;
    /**
