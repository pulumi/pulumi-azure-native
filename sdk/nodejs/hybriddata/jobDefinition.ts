...
export class JobDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hybriddata:JobDefinition" }, { type: "azure-native:hybriddata/latest:JobDefinition" }, { type: "azure-nextgen:hybriddata/latest:JobDefinition" }, { type: "azure-native:hybriddata/v20160601:JobDefinition" }, { type: "azure-nextgen:hybriddata/v20160601:JobDefinition" }, { type: "azure-native:hybriddata/v20190601:JobDefinition" }, { type: "azure-nextgen:hybriddata/v20190601:JobDefinition" }] };
...
export interface JobDefinitionArgs {
     ...
     * This is the preferred geo location for the job to run.
     */
    readonly runLocation?: pulumi.Input<enums.hybriddata.RunLocation>;
    /**
     * Schedule for running the job definition
     */
     ...
     * State of the job definition.
     */
    readonly state: pulumi.Input<enums.hybriddata.State>;
    /**
     * Enum to detect if user confirmation is required. If not passed will default to NotRequired.
     */
    readonly userConfirmation?: pulumi.Input<enums.hybriddata.UserConfirmation>;
}
