...
export class JobDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hybriddata/v20190601:JobDefinition" }, { type: "azure-native:hybriddata:JobDefinition" }, { type: "azure-nextgen:hybriddata:JobDefinition" }, { type: "azure-native:hybriddata/latest:JobDefinition" }, { type: "azure-nextgen:hybriddata/latest:JobDefinition" }, { type: "azure-native:hybriddata/v20160601:JobDefinition" }, { type: "azure-nextgen:hybriddata/v20160601:JobDefinition" }] };
...
export interface JobDefinitionArgs {
     ...
     * Schedule for running the job definition
     */
    readonly schedules?: pulumi.Input<pulumi.Input<inputs.hybriddata.v20190601.Schedule>[]>;
    /**
     * State of the job definition.
     */
