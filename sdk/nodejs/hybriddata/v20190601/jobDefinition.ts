...
export class JobDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: JobDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybriddata/latest:JobDefinition" }, { type: "azurerm:hybriddata/preview:JobDefinition" }, { type: "azurerm:hybriddata/v20160601:JobDefinition" }] };
