...
// Export enums:
export * from "../../types/enums/iothub/v20170701";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:iothub/v20170701:IotHubResource":
                return new IotHubResource(name, <any>undefined, { urn })
            case "azure-native:iothub/v20170701:IotHubResourceEventHubConsumerGroup":
...
pulumi.runtime.registerResourceModule("azure-native", "iothub/v20170701", _module)
