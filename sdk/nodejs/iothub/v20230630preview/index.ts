...
// Export enums:
export * from "../../types/enums/iothub/v20230630preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:iothub/v20230630preview:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-native:iothub/v20230630preview:IotHubResource":
                return new IotHubResource(name, <any>undefined, { urn })
            case "azure-native:iothub/v20230630preview:IotHubResourceEventHubConsumerGroup":
                return new IotHubResourceEventHubConsumerGroup(name, <any>undefined, { urn })
            case "azure-native:iothub/v20230630preview:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "iothub/v20230630preview", _module)
