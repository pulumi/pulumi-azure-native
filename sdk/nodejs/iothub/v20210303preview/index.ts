...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:iothub/v20210303preview:IotHubResourceEventHubConsumerGroup":
...
pulumi.runtime.registerResourceModule("azure-native", "iothub/v20210303preview", _module)
