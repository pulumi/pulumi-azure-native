...
export class IoTSpace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IoTSpace {
        return new IoTSpace(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    public readonly properties!: pulumi.Output<outputs.iotspaces.IoTSpacesPropertiesResponse>;
    /**
     * A valid instance SKU.
     */
    public readonly sku!: pulumi.Output<outputs.iotspaces.IoTSpacesSkuInfoResponse>;
    /**
     * The resource tags.
     */
...
export interface IoTSpaceArgs {
     ...
     * The common properties of a IoTSpaces service.
     */
    readonly properties?: pulumi.Input<inputs.iotspaces.IoTSpacesProperties>;
    /**
     ...
     * A valid instance SKU.
     */
    readonly sku: pulumi.Input<inputs.iotspaces.IoTSpacesSkuInfo>;
    /**
     * The resource tags.
     */
