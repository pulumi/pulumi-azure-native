...
export function getIoTSpace(args: GetIoTSpaceArgs, opts?: pulumi.InvokeOptions): Promise<GetIoTSpaceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:iotspaces/preview:getIoTSpace", {
...
export interface GetIoTSpaceResult {
     ...
     */
    readonly properties: outputs.iotspaces.preview.IoTSpacesPropertiesResponse;
    /**
     * A valid instance SKU.
     */
    readonly sku: outputs.iotspaces.preview.IoTSpacesSkuInfoResponse;
    /**
     * The resource tags.
     */
