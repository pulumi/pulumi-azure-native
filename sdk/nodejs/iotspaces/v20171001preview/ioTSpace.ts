...
export class IoTSpace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotspaces/v20171001preview:IoTSpace';
...
export interface IoTSpaceArgs {
     ...
     * The common properties of a IoTSpaces service.
     */
    properties?: pulumi.Input<inputs.iotspaces.v20171001preview.IoTSpacesPropertiesArgs>;
    /**
     ...
     * A valid instance SKU.
     */
    sku: pulumi.Input<inputs.iotspaces.v20171001preview.IoTSpacesSkuInfoArgs>;
    /**
     * The resource tags.
     */
