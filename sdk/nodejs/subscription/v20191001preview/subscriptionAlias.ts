 ...
 *
 * const subscriptionAlias = new azurerm.subscription.v20191001preview.SubscriptionAlias("subscriptionAlias", {aliasName: "aliasForNewSub"});
 *
 * ```
 */
export class SubscriptionAlias extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:subscription/v20191001preview:SubscriptionAlias';
    ...
    constructor(name: string, args: SubscriptionAliasArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:subscription/latest:SubscriptionAlias" }, { type: "azurerm:subscription/v20200901:SubscriptionAlias" }] };
...
export interface SubscriptionAliasArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.subscription.v20191001preview.PutAliasRequestProperties>;
}
