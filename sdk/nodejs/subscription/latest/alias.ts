...
export class Alias extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:subscription/latest:Alias';
    ...
    constructor(name: string, argsOrState?: AliasArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:subscription/preview:Alias" }, { type: "azurerm:subscription/v20191001preview:Alias" }, { type: "azurerm:subscription/v20200901:Alias" }] };
