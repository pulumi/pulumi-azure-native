...
export class Alias extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AliasArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:subscription/latest:Alias" }, { type: "azurerm:subscription/preview:Alias" }, { type: "azurerm:subscription/v20191001preview:Alias" }] };
