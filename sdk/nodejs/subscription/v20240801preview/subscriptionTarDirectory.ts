...
export class SubscriptionTarDirectory extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:subscription/v20240801preview:SubscriptionTarDirectory';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.subscription.v20240801preview.TargetDirectoryResultPropertiesResponse>;
    /**
    ...
    constructor(name: string, args?: SubscriptionTarDirectoryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:subscription:SubscriptionTarDirectory" }] };
...
export interface SubscriptionTarDirectoryArgs {
     ...
     */
    properties?: pulumi.Input<inputs.subscription.v20240801preview.TargetDirectoryRequestPropertiesArgs>;
    /**
     * Subscription Id.
     */
