...
export class Alias extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:subscription/preview:Alias';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.subscription.preview.PutAliasResponsePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AliasArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:subscription/latest:Alias" }, { type: "azurerm:subscription/v20191001preview:Alias" }, { type: "azurerm:subscription/v20200901:Alias" }] };
...
export interface AliasArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.subscription.preview.PutAliasRequestProperties>;
}
