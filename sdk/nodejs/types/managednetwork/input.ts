...
export interface ManagedNetworkPeeringPolicyPropertiesArgs {
     ...
     */
    hub?: pulumi.Input<inputs.managednetwork.ResourceIdArgs>;
    /**
     * Gets or sets the mesh group IDs
     */
    mesh?: pulumi.Input<pulumi.Input<inputs.managednetwork.ResourceIdArgs>[]>;
    /**
     * Gets or sets the spokes group IDs
     */
    spokes?: pulumi.Input<pulumi.Input<inputs.managednetwork.ResourceIdArgs>[]>;
    /**
     * Gets or sets the connectivity type of a network structure policy
     */
    type: pulumi.Input<string | enums.managednetwork.Type>;
}
