...
export interface AkamaiAccessControlResponse {
     ...
     */
    akamaiSignatureHeaderAuthenticationKeyList?: outputs.media.v20180330preview.AkamaiSignatureHeaderAuthenticationKeyResponse[];
}
...
export interface CbcsDrmConfigurationResponse {
     ...
     */
    fairPlay?: outputs.media.v20180330preview.StreamingPolicyFairPlayConfigurationResponse;
    /**
     * PlayReady configurations
     */
    playReady?: outputs.media.v20180330preview.StreamingPolicyPlayReadyConfigurationResponse;
    /**
     * Widevine configurations
     */
    widevine?: outputs.media.v20180330preview.StreamingPolicyWidevineConfigurationResponse;
}
...
export interface CommonEncryptionCbcsResponse {
     ...
     */
    clearTracks?: outputs.media.v20180330preview.TrackSelectionResponse[];
    /**
     * Representing default content key for each encryption scheme and separate content keys for specific tracks
     */
    contentKeys?: outputs.media.v20180330preview.StreamingPolicyContentKeysResponse;
    /**
     * Configuration of DRMs for current encryption scheme
     */
    drm?: outputs.media.v20180330preview.CbcsDrmConfigurationResponse;
    /**
     * Representing supported protocols
     */
    enabledProtocols?: outputs.media.v20180330preview.EnabledProtocolsResponse;
}
...
export interface CommonEncryptionCencResponse {
     ...
     */
    drm?: outputs.media.v20180330preview.CencDrmConfigurationResponse;
    /**
     * Representing supported protocols
     */
    enabledProtocols?: outputs.media.v20180330preview.EnabledProtocolsResponse;
...
export interface ContentKeyPolicyOptionResponse {
     ...
     */
    configuration: outputs.media.v20180330preview.ContentKeyPolicyClearKeyConfigurationResponse | outputs.media.v20180330preview.ContentKeyPolicyFairPlayConfigurationResponse | outputs.media.v20180330preview.ContentKeyPolicyPlayReadyConfigurationResponse | outputs.media.v20180330preview.ContentKeyPolicyUnknownConfigurationResponse | outputs.media.v20180330preview.ContentKeyPolicyWidevineConfigurationResponse;
    /**
     ...
     */
    restriction: outputs.media.v20180330preview.ContentKeyPolicyOpenRestrictionResponse | outputs.media.v20180330preview.ContentKeyPolicyTokenRestrictionResponse | outputs.media.v20180330preview.ContentKeyPolicyUnknownRestrictionResponse;
}
...
export interface ContentKeyPolicyPlayReadyConfigurationResponse {
     ...
     */
    licenses: outputs.media.v20180330preview.ContentKeyPolicyPlayReadyLicenseResponse[];
    /**
     * The discriminator for derived types.
...
export interface ContentKeyPolicyPlayReadyLicenseResponse {
     ...
     */
    contentKeyLocation: outputs.media.v20180330preview.ContentKeyPolicyPlayReadyContentEncryptionKeyFromHeaderResponse | outputs.media.v20180330preview.ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifierResponse;
    /**
     ...
     */
    playRight?: outputs.media.v20180330preview.ContentKeyPolicyPlayReadyPlayRightResponse;
    /**
...
export interface ContentKeyPolicyPlayReadyPlayRightResponse {
     ...
     */
    explicitAnalogTelevisionOutputRestriction?: outputs.media.v20180330preview.ContentKeyPolicyPlayReadyExplicitAnalogTelevisionRestrictionResponse;
    /**
...
export interface ContentKeyPolicyTokenRestrictionResponse {
     ...
     */
    alternateVerificationKeys?: (outputs.media.v20180330preview.ContentKeyPolicyRsaTokenKeyResponse | outputs.media.v20180330preview.ContentKeyPolicySymmetricTokenKeyResponse | outputs.media.v20180330preview.ContentKeyPolicyX509CertificateTokenKeyResponse)[];
    /**
     ...
     */
    primaryVerificationKey: outputs.media.v20180330preview.ContentKeyPolicyRsaTokenKeyResponse | outputs.media.v20180330preview.ContentKeyPolicySymmetricTokenKeyResponse | outputs.media.v20180330preview.ContentKeyPolicyX509CertificateTokenKeyResponse;
    /**
     * A list of required token claims.
     */
    requiredClaims?: outputs.media.v20180330preview.ContentKeyPolicyTokenClaimResponse[];
    /**
     * The type of token.
     */
...
export interface FiltersResponse {
     ...
     */
    crop?: outputs.media.v20180330preview.RectangleResponse;
    /**
     * The de-interlacing settings.
     */
    deinterlace?: outputs.media.v20180330preview.DeinterlaceResponse;
    /**
     * The properties of overlays to be applied to the input video. These could be audio, image or video overlays.
     */
    overlays?: (outputs.media.v20180330preview.AudioOverlayResponse | outputs.media.v20180330preview.VideoOverlayResponse)[];
    /**
...
export interface H264VideoResponse {
     ...
     */
    layers?: outputs.media.v20180330preview.H264LayerResponse[];
    /**
     * The discriminator for derived types.
...
export interface IPAccessControlResponse {
     ...
     * The IP allow list.
     */
    allow?: outputs.media.v20180330preview.IPRangeResponse[];
}
...
export interface JobErrorResponse {
     ...
     */
    details: outputs.media.v20180330preview.JobErrorDetailResponse[];
    /**
...
export interface JobInputsResponse {
     ...
     */
    inputs?: (outputs.media.v20180330preview.JobInputAssetResponse | outputs.media.v20180330preview.JobInputClipResponse | outputs.media.v20180330preview.JobInputHttpResponse | outputs.media.v20180330preview.JobInputsResponse)[];
    /**
     * A label that is assigned to a JobInput, that is used to satisfy a reference used in the Transform. For example, a Transform can be authored so as to take an image file with the label 'xyz' and apply it as an overlay onto the input video before it is encoded. When submitting a Job, exactly one of the JobInputs should be the image file, and it should have the label 'xyz'.
     */
    label?: string;
...
export interface JobOutputAssetResponse {
     ...
     */
    error: outputs.media.v20180330preview.JobErrorResponse;
    /**
     * The discriminator for derived types.
...
export interface JpgImageResponse {
     ...
     */
    layers?: outputs.media.v20180330preview.JpgLayerResponse[];
    /**
     * The discriminator for derived types.
...
export interface LiveEventInputResponse {
     ...
     */
    endpoints?: outputs.media.v20180330preview.LiveEventEndpointResponse[];
    /**
...
export interface LiveEventPreviewAccessControlResponse {
     ...
     */
    ip?: outputs.media.v20180330preview.IPAccessControlResponse;
}
...
export interface LiveEventPreviewResponse {
     ...
     */
    accessControl?: outputs.media.v20180330preview.LiveEventPreviewAccessControlResponse;
    /**
...
export interface Mp4FormatResponse {
     ...
     */
    outputFiles?: outputs.media.v20180330preview.OutputFileResponse[];
}
...
export interface PngImageResponse {
     ...
     */
    layers?: outputs.media.v20180330preview.PngLayerResponse[];
    /**
     * The discriminator for derived types.
...
export interface StandardEncoderPresetResponse {
     ...
     */
    codecs?: (outputs.media.v20180330preview.AacAudioResponse | outputs.media.v20180330preview.AudioResponse | outputs.media.v20180330preview.CopyAudioResponse | outputs.media.v20180330preview.CopyVideoResponse | outputs.media.v20180330preview.H264VideoResponse | outputs.media.v20180330preview.ImageResponse | outputs.media.v20180330preview.JpgImageResponse | outputs.media.v20180330preview.PngImageResponse | outputs.media.v20180330preview.VideoResponse)[];
    /**
     * One or more filtering operations that are applied to the input media before encoding.
     */
    filters?: outputs.media.v20180330preview.FiltersResponse;
    /**
     * The list of outputs to be produced by the encoder.
     */
    formats?: (outputs.media.v20180330preview.ImageFormatResponse | outputs.media.v20180330preview.JpgFormatResponse | outputs.media.v20180330preview.Mp4FormatResponse | outputs.media.v20180330preview.MultiBitrateFormatResponse | outputs.media.v20180330preview.PngFormatResponse | outputs.media.v20180330preview.TransportStreamFormatResponse)[];
    /**
     * The discriminator for derived types.
...
export interface StreamingEndpointAccessControlResponse {
     ...
     */
    akamai?: outputs.media.v20180330preview.AkamaiAccessControlResponse;
    /**
...
export interface StreamingLocatorContentKeyResponse {
     ...
     */
    tracks?: outputs.media.v20180330preview.TrackSelectionResponse[];
    /**
...
export interface StreamingPolicyContentKeysResponse {
     ...
     */
    defaultKey?: outputs.media.v20180330preview.DefaultKeyResponse;
    /**
     * Representing tracks needs separate content key
     */
    keyToTrackMappings?: outputs.media.v20180330preview.StreamingPolicyContentKeyResponse[];
}
...
export interface TrackSelectionResponse {
     ...
     */
    trackSelections?: outputs.media.v20180330preview.TrackPropertyConditionResponse[];
}
...
export interface TransformOutputResponse {
     ...
     */
    preset: outputs.media.v20180330preview.AudioAnalyzerPresetResponse | outputs.media.v20180330preview.BuiltInStandardEncoderPresetResponse | outputs.media.v20180330preview.StandardEncoderPresetResponse | outputs.media.v20180330preview.VideoAnalyzerPresetResponse;
    /**
...
export interface VideoOverlayResponse {
     ...
     */
    cropRectangle?: outputs.media.v20180330preview.RectangleResponse;
    /**
     * The position in the input video at which the overlay ends. The value should be in ISO 8601 duration format. For example, PT30S to end the overlay at 30 seconds in to the input video. If not specified the overlay will be applied until the end of the input video if inputLoop is true. Else, if inputLoop is false, then overlay will last as long as the duration of the overlay media.
     */
    end?: string;
     ...
     */
    position?: outputs.media.v20180330preview.RectangleResponse;
    /**
     * The start position, with reference to the input video, at which the overlay starts. The value should be in ISO 8601 format. For example, PT05S to start the overlay at 5 seconds in to the input video. If not specified the overlay starts from the beginning of the input video.
     */
    start?: string;
