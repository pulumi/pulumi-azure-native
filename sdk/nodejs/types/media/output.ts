...
export * as v20151001 from "./v20151001/output";
export * as v20180330preview from "./v20180330preview/output";
...
export interface ContentKeyPolicyFairPlayConfigurationResponse {
     ...
     */
    offlineRentalConfiguration?: outputs.media.ContentKeyPolicyFairPlayOfflineRentalConfigurationResponse;
    /**
...
export interface ContentKeyPolicyOptionResponse {
     ...
     */
    configuration: outputs.media.ContentKeyPolicyClearKeyConfigurationResponse | outputs.media.ContentKeyPolicyFairPlayConfigurationResponse | outputs.media.ContentKeyPolicyPlayReadyConfigurationResponse | outputs.media.ContentKeyPolicyUnknownConfigurationResponse | outputs.media.ContentKeyPolicyWidevineConfigurationResponse;
    /**
     ...
     */
    restriction: outputs.media.ContentKeyPolicyOpenRestrictionResponse | outputs.media.ContentKeyPolicyTokenRestrictionResponse | outputs.media.ContentKeyPolicyUnknownRestrictionResponse;
}
...
export interface ContentKeyPolicyPlayReadyConfigurationResponse {
     ...
     */
    licenses: outputs.media.ContentKeyPolicyPlayReadyLicenseResponse[];
    /**
     * The discriminator for derived types.
...
export interface ContentKeyPolicyPlayReadyLicenseResponse {
     ...
     */
    contentKeyLocation: outputs.media.ContentKeyPolicyPlayReadyContentEncryptionKeyFromHeaderResponse | outputs.media.ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifierResponse;
    /**
     ...
     */
    playRight?: outputs.media.ContentKeyPolicyPlayReadyPlayRightResponse;
    /**
...
export interface ContentKeyPolicyPlayReadyPlayRightResponse {
     ...
     */
    explicitAnalogTelevisionOutputRestriction?: outputs.media.ContentKeyPolicyPlayReadyExplicitAnalogTelevisionRestrictionResponse;
    /**
...
export interface ContentKeyPolicyTokenRestrictionResponse {
     ...
     */
    alternateVerificationKeys?: (outputs.media.ContentKeyPolicyRsaTokenKeyResponse | outputs.media.ContentKeyPolicySymmetricTokenKeyResponse | outputs.media.ContentKeyPolicyX509CertificateTokenKeyResponse)[];
    /**
     ...
     */
    primaryVerificationKey: outputs.media.ContentKeyPolicyRsaTokenKeyResponse | outputs.media.ContentKeyPolicySymmetricTokenKeyResponse | outputs.media.ContentKeyPolicyX509CertificateTokenKeyResponse;
    /**
     * A list of required token claims.
     */
    requiredClaims?: outputs.media.ContentKeyPolicyTokenClaimResponse[];
    /**
     * The type of token.
     */
...
export interface FiltersResponse {
     ...
     */
    crop?: outputs.media.RectangleResponse;
    /**
     * The de-interlacing settings.
     */
    deinterlace?: outputs.media.DeinterlaceResponse;
    /**
     * The properties of overlays to be applied to the input video. These could be audio, image or video overlays.
     */
    overlays?: (outputs.media.AudioOverlayResponse | outputs.media.VideoOverlayResponse)[];
    /**
...
export interface FromAllInputFileResponse {
     ...
     */
    includedTracks?: (outputs.media.AudioTrackDescriptorResponse | outputs.media.SelectAudioTrackByAttributeResponse | outputs.media.SelectAudioTrackByIdResponse | outputs.media.SelectVideoTrackByAttributeResponse | outputs.media.SelectVideoTrackByIdResponse | outputs.media.VideoTrackDescriptorResponse)[];
    /**
     * The discriminator for derived types.
...
export interface H264VideoResponse {
     ...
     */
    layers?: outputs.media.H264LayerResponse[];
    /**
     * The discriminator for derived types.
...
export interface H265VideoResponse {
     ...
     */
    layers?: outputs.media.H265LayerResponse[];
    /**
     * The discriminator for derived types.
...
export interface JobInputAssetResponse {
     ...
     */
    end?: outputs.media.AbsoluteClipTimeResponse | outputs.media.UtcClipTimeResponse;
    /**
     ...
     */
    inputDefinitions?: (outputs.media.FromAllInputFileResponse | outputs.media.FromEachInputFileResponse | outputs.media.InputFileResponse)[];
    /**
     ...
     */
    start?: outputs.media.AbsoluteClipTimeResponse | outputs.media.UtcClipTimeResponse;
}
...
export interface JobInputSequenceResponse {
     ...
     */
    inputs?: outputs.media.JobInputClipResponse[];
    /**
     * The discriminator for derived types.
...
export interface JobInputsResponse {
     ...
     */
    inputs?: (outputs.media.JobInputAssetResponse | outputs.media.JobInputClipResponse | outputs.media.JobInputHttpResponse | outputs.media.JobInputSequenceResponse | outputs.media.JobInputsResponse)[];
    /**
     * The discriminator for derived types.
...
export interface JpgImageResponse {
     ...
     */
    layers?: outputs.media.JpgLayerResponse[];
    /**
     * The discriminator for derived types.
...
export interface LiveEventTranscriptionResponse {
     ...
     */
    inputTrackSelection?: outputs.media.LiveEventInputTrackSelectionResponse[];
    /**
     ...
     * Describes a transcription track in the output of a live event, generated using speech-to-text transcription. This property is reserved for future use, any value set on this property will be ignored.
     */
    outputTranscriptionTrack?: outputs.media.LiveEventOutputTranscriptionTrackResponse;
}
...
export interface MediaGraphClearEndpointResponse {
     ...
     */
    credentials?: outputs.media.MediaGraphUsernamePasswordCredentialsResponse;
    /**
     * The discriminator for derived types.
...
export interface MediaGraphRtspSourceResponse {
     ...
     */
    endpoint: outputs.media.MediaGraphClearEndpointResponse | outputs.media.MediaGraphTlsEndpointResponse;
    /**
     * Source name.
     */
    name: string;
...
export interface MediaGraphTlsEndpointResponse {
     ...
     */
    trustedCertificates?: outputs.media.MediaGraphPemCertificateListResponse;
    /**
     * Url for the endpoint.
     */
    url: string;
     ...
     */
    validationOptions?: outputs.media.MediaGraphTlsValidationOptionsResponse;
}
...
export interface Mp4FormatResponse {
     ...
     */
    outputFiles?: outputs.media.OutputFileResponse[];
}
...
export interface PngImageResponse {
     ...
     */
    layers?: outputs.media.PngLayerResponse[];
    /**
     * The discriminator for derived types.
...
export interface StandardEncoderPresetResponse {
     ...
     */
    codecs: (outputs.media.AacAudioResponse | outputs.media.AudioResponse | outputs.media.CopyAudioResponse | outputs.media.CopyVideoResponse | outputs.media.H264VideoResponse | outputs.media.H265VideoResponse | outputs.media.ImageResponse | outputs.media.JpgImageResponse | outputs.media.PngImageResponse | outputs.media.VideoResponse)[];
    /**
     * One or more filtering operations that are applied to the input media before encoding.
     */
    filters?: outputs.media.FiltersResponse;
    /**
     * The list of outputs to be produced by the encoder.
     */
    formats: (outputs.media.ImageFormatResponse | outputs.media.JpgFormatResponse | outputs.media.Mp4FormatResponse | outputs.media.MultiBitrateFormatResponse | outputs.media.PngFormatResponse | outputs.media.TransportStreamFormatResponse)[];
    /**
     * The discriminator for derived types.
...
export interface TextTrackResponse {
     ...
     */
    hlsSettings?: outputs.media.HlsSettingsResponse;
    /**
...
export interface TransformOutputResponse {
     ...
     */
    preset: outputs.media.AudioAnalyzerPresetResponse | outputs.media.BuiltInStandardEncoderPresetResponse | outputs.media.FaceDetectorPresetResponse | outputs.media.StandardEncoderPresetResponse | outputs.media.VideoAnalyzerPresetResponse;
    /**
...
export interface VideoOverlayResponse {
     ...
     */
    cropRectangle?: outputs.media.RectangleResponse;
    /**
     * The end position, with reference to the input video, at which the overlay ends. The value should be in ISO 8601 format. For example, PT30S to end the overlay at 30 seconds into the input video. If not specified or the value is greater than the input video duration, the overlay will be applied until the end of the input video if the overlay media duration is greater than the input video duration, else the overlay will last as long as the overlay media duration.
     */
    end?: string;
     ...
     */
    position?: outputs.media.RectangleResponse;
    /**
     * The start position, with reference to the input video, at which the overlay starts. The value should be in ISO 8601 format. For example, PT05S to start the overlay at 5 seconds into the input video. If not specified the overlay starts from the beginning of the input video.
     */
    start?: string;
