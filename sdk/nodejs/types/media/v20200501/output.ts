...
export interface AccountEncryptionResponse {
     ...
     */
    keyVaultProperties?: outputs.media.v20200501.KeyVaultPropertiesResponse;
    /**
...
export interface AkamaiAccessControlResponse {
     ...
     */
    akamaiSignatureHeaderAuthenticationKeyList?: outputs.media.v20200501.AkamaiSignatureHeaderAuthenticationKeyResponse[];
}
...
export interface CbcsDrmConfigurationResponse {
     ...
     */
    fairPlay?: outputs.media.v20200501.StreamingPolicyFairPlayConfigurationResponse;
    /**
     * PlayReady configurations
     */
    playReady?: outputs.media.v20200501.StreamingPolicyPlayReadyConfigurationResponse;
    /**
     * Widevine configurations
     */
    widevine?: outputs.media.v20200501.StreamingPolicyWidevineConfigurationResponse;
}
...
export interface CommonEncryptionCbcsResponse {
     ...
     */
    clearTracks?: outputs.media.v20200501.TrackSelectionResponse[];
    /**
     * Representing default content key for each encryption scheme and separate content keys for specific tracks
     */
    contentKeys?: outputs.media.v20200501.StreamingPolicyContentKeysResponse;
    /**
     * Configuration of DRMs for current encryption scheme
     */
    drm?: outputs.media.v20200501.CbcsDrmConfigurationResponse;
    /**
     * Representing supported protocols
     */
    enabledProtocols?: outputs.media.v20200501.EnabledProtocolsResponse;
}
...
export interface CommonEncryptionCencResponse {
     ...
     */
    drm?: outputs.media.v20200501.CencDrmConfigurationResponse;
    /**
     * Representing supported protocols
     */
    enabledProtocols?: outputs.media.v20200501.EnabledProtocolsResponse;
...
export interface ContentKeyPolicyFairPlayConfigurationResponse {
     ...
     */
    offlineRentalConfiguration?: outputs.media.v20200501.ContentKeyPolicyFairPlayOfflineRentalConfigurationResponse;
    /**
...
export interface ContentKeyPolicyOptionResponse {
     ...
     */
    configuration: outputs.media.v20200501.ContentKeyPolicyClearKeyConfigurationResponse | outputs.media.v20200501.ContentKeyPolicyFairPlayConfigurationResponse | outputs.media.v20200501.ContentKeyPolicyPlayReadyConfigurationResponse | outputs.media.v20200501.ContentKeyPolicyUnknownConfigurationResponse | outputs.media.v20200501.ContentKeyPolicyWidevineConfigurationResponse;
    /**
     ...
     */
    restriction: outputs.media.v20200501.ContentKeyPolicyOpenRestrictionResponse | outputs.media.v20200501.ContentKeyPolicyTokenRestrictionResponse | outputs.media.v20200501.ContentKeyPolicyUnknownRestrictionResponse;
}
...
export interface ContentKeyPolicyPlayReadyConfigurationResponse {
     ...
     */
    licenses: outputs.media.v20200501.ContentKeyPolicyPlayReadyLicenseResponse[];
    /**
     * The discriminator for derived types.
...
export interface ContentKeyPolicyPlayReadyLicenseResponse {
     ...
     */
    contentKeyLocation: outputs.media.v20200501.ContentKeyPolicyPlayReadyContentEncryptionKeyFromHeaderResponse | outputs.media.v20200501.ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifierResponse;
    /**
     ...
     */
    playRight?: outputs.media.v20200501.ContentKeyPolicyPlayReadyPlayRightResponse;
    /**
...
export interface ContentKeyPolicyPlayReadyPlayRightResponse {
     ...
     */
    explicitAnalogTelevisionOutputRestriction?: outputs.media.v20200501.ContentKeyPolicyPlayReadyExplicitAnalogTelevisionRestrictionResponse;
    /**
...
export interface ContentKeyPolicyTokenRestrictionResponse {
     ...
     */
    alternateVerificationKeys?: (outputs.media.v20200501.ContentKeyPolicyRsaTokenKeyResponse | outputs.media.v20200501.ContentKeyPolicySymmetricTokenKeyResponse | outputs.media.v20200501.ContentKeyPolicyX509CertificateTokenKeyResponse)[];
    /**
     ...
     */
    primaryVerificationKey: outputs.media.v20200501.ContentKeyPolicyRsaTokenKeyResponse | outputs.media.v20200501.ContentKeyPolicySymmetricTokenKeyResponse | outputs.media.v20200501.ContentKeyPolicyX509CertificateTokenKeyResponse;
    /**
     * A list of required token claims.
     */
    requiredClaims?: outputs.media.v20200501.ContentKeyPolicyTokenClaimResponse[];
    /**
     * The type of token.
     */
...
export interface EdgeUsageDataCollectionPolicyResponse {
     ...
     */
    eventHubDetails?: outputs.media.v20200501.EdgeUsageDataEventHubResponse;
    /**
...
export interface FilterTrackSelectionResponse {
     ...
     */
    trackSelections: outputs.media.v20200501.FilterTrackPropertyConditionResponse[];
}
...
export interface FiltersResponse {
     ...
     */
    crop?: outputs.media.v20200501.RectangleResponse;
    /**
     * The de-interlacing settings.
     */
    deinterlace?: outputs.media.v20200501.DeinterlaceResponse;
    /**
     * The properties of overlays to be applied to the input video. These could be audio, image or video overlays.
     */
    overlays?: (outputs.media.v20200501.AudioOverlayResponse | outputs.media.v20200501.VideoOverlayResponse)[];
    /**
...
export interface FromAllInputFileResponse {
     ...
     */
    includedTracks?: (outputs.media.v20200501.AudioTrackDescriptorResponse | outputs.media.v20200501.SelectAudioTrackByAttributeResponse | outputs.media.v20200501.SelectAudioTrackByIdResponse | outputs.media.v20200501.SelectVideoTrackByAttributeResponse | outputs.media.v20200501.SelectVideoTrackByIdResponse | outputs.media.v20200501.VideoTrackDescriptorResponse)[];
    /**
     * The discriminator for derived types.
...
export interface H264VideoResponse {
     ...
     */
    layers?: outputs.media.v20200501.H264LayerResponse[];
    /**
     * The discriminator for derived types.
...
export interface H265VideoResponse {
     ...
     */
    layers?: outputs.media.v20200501.H265LayerResponse[];
    /**
     * The discriminator for derived types.
...
export interface IPAccessControlResponse {
     ...
     * The IP allow list.
     */
    allow?: outputs.media.v20200501.IPRangeResponse[];
}
...
export interface JobErrorResponse {
     ...
     */
    details: outputs.media.v20200501.JobErrorDetailResponse[];
    /**
...
export interface JobInputAssetResponse {
     ...
     */
    end?: outputs.media.v20200501.AbsoluteClipTimeResponse | outputs.media.v20200501.UtcClipTimeResponse;
    /**
     ...
     */
    inputDefinitions?: (outputs.media.v20200501.FromAllInputFileResponse | outputs.media.v20200501.FromEachInputFileResponse | outputs.media.v20200501.InputFileResponse)[];
    /**
     ...
     */
    start?: outputs.media.v20200501.AbsoluteClipTimeResponse | outputs.media.v20200501.UtcClipTimeResponse;
}
...
export interface JobInputSequenceResponse {
     ...
     */
    inputs?: outputs.media.v20200501.JobInputClipResponse[];
    /**
     * The discriminator for derived types.
...
export interface JobInputsResponse {
     ...
     */
    inputs?: (outputs.media.v20200501.JobInputAssetResponse | outputs.media.v20200501.JobInputClipResponse | outputs.media.v20200501.JobInputHttpResponse | outputs.media.v20200501.JobInputSequenceResponse | outputs.media.v20200501.JobInputsResponse)[];
    /**
     * The discriminator for derived types.
...
export interface JobOutputAssetResponse {
     ...
     */
    error: outputs.media.v20200501.JobErrorResponse;
    /**
...
export interface JpgImageResponse {
     ...
     */
    layers?: outputs.media.v20200501.JpgLayerResponse[];
    /**
     * The discriminator for derived types.
...
export interface LiveEventInputAccessControlResponse {
     ...
     */
    ip?: outputs.media.v20200501.IPAccessControlResponse;
}
...
export interface LiveEventInputResponse {
     ...
     */
    accessControl?: outputs.media.v20200501.LiveEventInputAccessControlResponse;
    /**
     ...
     */
    endpoints?: outputs.media.v20200501.LiveEventEndpointResponse[];
    /**
...
export interface LiveEventPreviewResponse {
     ...
     */
    accessControl?: outputs.media.v20200501.LiveEventPreviewAccessControlResponse;
    /**
...
export interface LiveEventTranscriptionResponse {
     ...
     */
    inputTrackSelection?: outputs.media.v20200501.LiveEventInputTrackSelectionResponse[];
    /**
     ...
     * Describes a transcription track in the output of a live event, generated using speech-to-text transcription. This property is reserved for future use, any value set on this property will be ignored.
     */
    outputTranscriptionTrack?: outputs.media.v20200501.LiveEventOutputTranscriptionTrackResponse;
}
...
export interface Mp4FormatResponse {
     ...
     */
    outputFiles?: outputs.media.v20200501.OutputFileResponse[];
}
...
export interface PngImageResponse {
     ...
     */
    layers?: outputs.media.v20200501.PngLayerResponse[];
    /**
     * The discriminator for derived types.
...
export interface StandardEncoderPresetResponse {
     ...
     */
    codecs: (outputs.media.v20200501.AacAudioResponse | outputs.media.v20200501.AudioResponse | outputs.media.v20200501.CopyAudioResponse | outputs.media.v20200501.CopyVideoResponse | outputs.media.v20200501.H264VideoResponse | outputs.media.v20200501.H265VideoResponse | outputs.media.v20200501.ImageResponse | outputs.media.v20200501.JpgImageResponse | outputs.media.v20200501.PngImageResponse | outputs.media.v20200501.VideoResponse)[];
    /**
     * One or more filtering operations that are applied to the input media before encoding.
     */
    filters?: outputs.media.v20200501.FiltersResponse;
    /**
     * The list of outputs to be produced by the encoder.
     */
    formats: (outputs.media.v20200501.ImageFormatResponse | outputs.media.v20200501.JpgFormatResponse | outputs.media.v20200501.Mp4FormatResponse | outputs.media.v20200501.MultiBitrateFormatResponse | outputs.media.v20200501.PngFormatResponse | outputs.media.v20200501.TransportStreamFormatResponse)[];
    /**
     * The discriminator for derived types.
...
export interface StreamingEndpointAccessControlResponse {
     ...
     */
    akamai?: outputs.media.v20200501.AkamaiAccessControlResponse;
    /**
...
export interface StreamingLocatorContentKeyResponse {
     ...
     */
    tracks: outputs.media.v20200501.TrackSelectionResponse[];
    /**
...
export interface StreamingPolicyContentKeysResponse {
     ...
     */
    defaultKey?: outputs.media.v20200501.DefaultKeyResponse;
    /**
     * Representing tracks needs separate content key
     */
    keyToTrackMappings?: outputs.media.v20200501.StreamingPolicyContentKeyResponse[];
}
...
export interface TrackSelectionResponse {
     ...
     */
    trackSelections?: outputs.media.v20200501.TrackPropertyConditionResponse[];
}
...
export interface TransformOutputResponse {
     ...
     */
    preset: outputs.media.v20200501.AudioAnalyzerPresetResponse | outputs.media.v20200501.BuiltInStandardEncoderPresetResponse | outputs.media.v20200501.FaceDetectorPresetResponse | outputs.media.v20200501.StandardEncoderPresetResponse | outputs.media.v20200501.VideoAnalyzerPresetResponse;
    /**
...
export interface VideoOverlayResponse {
     ...
     */
    cropRectangle?: outputs.media.v20200501.RectangleResponse;
    /**
     * The end position, with reference to the input video, at which the overlay ends. The value should be in ISO 8601 format. For example, PT30S to end the overlay at 30 seconds into the input video. If not specified or the value is greater than the input video duration, the overlay will be applied until the end of the input video if the overlay media duration is greater than the input video duration, else the overlay will last as long as the overlay media duration.
     */
    end?: string;
     ...
     */
    position?: outputs.media.v20200501.RectangleResponse;
    /**
     * The start position, with reference to the input video, at which the overlay starts. The value should be in ISO 8601 format. For example, PT05S to start the overlay at 5 seconds into the input video. If not specified the overlay starts from the beginning of the input video.
     */
    start?: string;
