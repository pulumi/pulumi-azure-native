...
export interface AddressDetailsResponse {
     ...
     */
    forwardAddress: outputs.edgeorder.AddressPropertiesResponse;
    /**
     * Return shipping address
     */
    returnAddress: outputs.edgeorder.AddressPropertiesResponse;
}
...
export interface AddressPropertiesResponse {
     ...
     */
    contactDetails: outputs.edgeorder.ContactDetailsResponse;
    /**
     * Shipping details for the address
     */
    shippingAddress?: outputs.edgeorder.ShippingAddressResponse;
}
...
export interface BillingMeterDetailsResponse {
     ...
     */
    meterDetails: outputs.edgeorder.Pav2MeterDetailsResponse | outputs.edgeorder.PurchaseMeterDetailsResponse;
    /**
...
export interface ConfigurationResponse {
     ...
     */
    availabilityInformation: outputs.edgeorder.AvailabilityInformationResponse;
    /**
     * Cost information for the product system.
     */
    costInformation: outputs.edgeorder.CostInformationResponse;
    /**
     * Description related to the product system.
     */
    description: outputs.edgeorder.DescriptionResponse;
    /**
     * Dimensions of the configuration
     */
    dimensions: outputs.edgeorder.DimensionsResponse;
    /**
     ...
     */
    filterableProperties: outputs.edgeorder.FilterablePropertyResponse[];
    /**
     * Hierarchy information of a product.
     */
    hierarchyInformation: outputs.edgeorder.HierarchyInformationResponse;
    /**
     * Image information for the product system.
     */
    imageInformation: outputs.edgeorder.ImageInformationResponse[];
    /**
     * Specifications of the configuration
     */
    specifications: outputs.edgeorder.SpecificationResponse[];
}
...
export interface CostInformationResponse {
     ...
     */
    billingMeterDetails: outputs.edgeorder.BillingMeterDetailsResponse[];
}
...
export interface DescriptionResponse {
     ...
     */
    links: outputs.edgeorder.LinkResponse[];
    /**
...
export interface OrderItemDetailsResponse {
     ...
     */
    currentStage: outputs.edgeorder.StageDetailsResponse;
    /**
     ...
     */
    forwardShippingDetails: outputs.edgeorder.ForwardShippingDetailsResponse;
    /**
     * Parent RP details - this returns only the first or default parent RP from the entire list
     */
    managementRpDetails: outputs.edgeorder.ResourceProviderDetailsResponse;
    /**
     * List of parent RP details supported for configuration.
     */
    managementRpDetailsList: outputs.edgeorder.ResourceProviderDetailsResponse[];
    /**
     ...
     */
    orderItemStageHistory: outputs.edgeorder.StageDetailsResponse[];
    /**
     * Order item type.
     */
     ...
     */
    preferences?: outputs.edgeorder.PreferencesResponse;
    /**
     * Unique identifier for configuration.
     */
    productDetails: outputs.edgeorder.ProductDetailsResponse;
    /**
     * Return reason.
     */
    returnReason: string;
     ...
     */
    reverseShippingDetails: outputs.edgeorder.ReverseShippingDetailsResponse;
}
...
export interface PreferencesResponse {
     ...
     */
    encryptionPreferences?: outputs.edgeorder.EncryptionPreferencesResponse;
    /**
     * Preferences related to the Management resource.
     */
    managementResourcePreferences?: outputs.edgeorder.ManagementResourcePreferencesResponse;
    /**
     * Notification preferences.
     */
    notificationPreferences?: outputs.edgeorder.NotificationPreferenceResponse[];
    /**
     * Preferences related to the shipment logistics of the order.
     */
    transportPreferences?: outputs.edgeorder.TransportPreferencesResponse;
}
...
export interface ProductDetailsResponse {
     ...
     */
    deviceDetails: outputs.edgeorder.DeviceDetailsResponse[];
    /**
     * Display details of the product
     */
    displayInfo?: outputs.edgeorder.DisplayInfoResponse;
    /**
...
export interface ProductFamilyResponse {
     ...
     */
    productLines: outputs.edgeorder.ProductLineResponse[];
    /**
     * Contains details related to resource provider
     */
    resourceProviderDetails?: outputs.edgeorder.ResourceProviderDetailsResponse[];
}
...
export interface ProductLineResponse {
     ...
     */
    products: outputs.edgeorder.ProductResponse[];
}
...
export interface ProductResponse {
     ...
     */
    configurations: outputs.edgeorder.ConfigurationResponse[];
    /**
     * Cost information for the product system.
     */
    costInformation: outputs.edgeorder.CostInformationResponse;
