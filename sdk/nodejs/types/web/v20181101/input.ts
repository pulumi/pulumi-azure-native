...
export interface ApplicationLogsConfigArgs {
     ...
     */
    azureBlobStorage?: pulumi.Input<inputs.web.v20181101.AzureBlobStorageApplicationLogsConfigArgs>;
    /**
     * Application logs to azure table storage configuration.
     */
    azureTableStorage?: pulumi.Input<inputs.web.v20181101.AzureTableStorageApplicationLogsConfigArgs>;
    /**
     * Application logs to file system configuration.
     */
    fileSystem?: pulumi.Input<inputs.web.v20181101.FileSystemApplicationLogsConfigArgs>;
}
/**
...
export function applicationLogsConfigArgsProvideDefaults(val: ApplicationLogsConfigArgs): ApplicationLogsConfigArgs {
    return {
        ...val,
        fileSystem: (val.fileSystem ? pulumi.output(val.fileSystem).apply(inputs.web.v20181101.fileSystemApplicationLogsConfigArgsProvideDefaults) : undefined),
    };
}
...
export interface AutoHealActionsArgs {
     ...
     */
    actionType?: pulumi.Input<enums.web.v20181101.AutoHealActionType>;
    /**
     * Custom action to be taken.
     */
    customAction?: pulumi.Input<inputs.web.v20181101.AutoHealCustomActionArgs>;
    /**
...
export interface AutoHealRulesArgs {
     ...
     */
    actions?: pulumi.Input<inputs.web.v20181101.AutoHealActionsArgs>;
    /**
     * Conditions that describe when to execute the auto-heal actions.
     */
    triggers?: pulumi.Input<inputs.web.v20181101.AutoHealTriggersArgs>;
}
...
export interface AutoHealTriggersArgs {
     ...
     */
    requests?: pulumi.Input<inputs.web.v20181101.RequestsBasedTriggerArgs>;
    /**
     * A rule based on request execution time.
     */
    slowRequests?: pulumi.Input<inputs.web.v20181101.SlowRequestsBasedTriggerArgs>;
    /**
     * A rule based on status codes.
     */
    statusCodes?: pulumi.Input<pulumi.Input<inputs.web.v20181101.StatusCodesBasedTriggerArgs>[]>;
}
...
export interface AzureBlobStorageApplicationLogsConfigArgs {
     ...
     * Log level.
     */
    level?: pulumi.Input<enums.web.v20181101.LogLevel>;
    /**
     * Retention in days.
...
export interface AzureStorageInfoValueArgs {
     ...
     * Type of storage.
     */
    type?: pulumi.Input<enums.web.v20181101.AzureStorageType>;
}
...
export interface BackupSchedule {
     ...
     */
    frequencyUnit: enums.web.v20181101.FrequencyUnit;
    /**
...
export interface BackupScheduleArgs {
     ...
     * The unit of time for how often the backup should be executed (e.g. for weekly backup, this should be set to Day and FrequencyInterval should be set to 7)
     */
    frequencyUnit: pulumi.Input<enums.web.v20181101.FrequencyUnit>;
    /**
     * True if the retention policy should always keep at least one backup in the storage account, regardless how old it is; false otherwise.
     */
...
export interface ConnStringInfoArgs {
     ...
     * Type of database.
     */
    type?: pulumi.Input<enums.web.v20181101.ConnectionStringType>;
}
...
export interface DatabaseBackupSetting {
     ...
     */
    databaseType: string | enums.web.v20181101.DatabaseType;
    name?: string;
}
...
export interface DatabaseBackupSettingArgs {
     ...
     * Database type (e.g. SqlAzure / MySql).
     */
    databaseType: pulumi.Input<string | enums.web.v20181101.DatabaseType>;
    name?: pulumi.Input<string>;
}
...
export interface ExperimentsArgs {
     ...
     */
    rampUpRules?: pulumi.Input<pulumi.Input<inputs.web.v20181101.RampUpRuleArgs>[]>;
}
...
export interface HostNameSslStateArgs {
     ...
     */
    hostType?: pulumi.Input<enums.web.v20181101.HostType>;
    /**
     * Hostname.
     */
    name?: pulumi.Input<string>;
...
export interface HttpLogsConfigArgs {
     ...
     * Http logs to azure blob storage configuration.
     */
    azureBlobStorage?: pulumi.Input<inputs.web.v20181101.AzureBlobStorageHttpLogsConfigArgs>;
    /**
     * Http logs to file system configuration.
     */
    fileSystem?: pulumi.Input<inputs.web.v20181101.FileSystemHttpLogsConfigArgs>;
}
...
export interface IpSecurityRestrictionArgs {
     ...
     */
    tag?: pulumi.Input<enums.web.v20181101.IpFilterTag>;
    /**
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.web.v20181101.ManagedServiceIdentityType>;
    /**
...
export interface SiteConfigArgs {
     ...
     * Information about the formal API definition for the app.
     */
    apiDefinition?: pulumi.Input<inputs.web.v20181101.ApiDefinitionInfoArgs>;
    /**
     ...
     */
    appSettings?: pulumi.Input<pulumi.Input<inputs.web.v20181101.NameValuePairArgs>[]>;
    /**
     ...
     * Auto Heal rules.
     */
    autoHealRules?: pulumi.Input<inputs.web.v20181101.AutoHealRulesArgs>;
    /**
     * Auto-swap slot name.
     */
     ...
     */
    azureStorageAccounts?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20181101.AzureStorageInfoValueArgs>}>;
    /**
     * Connection strings.
     */
    connectionStrings?: pulumi.Input<pulumi.Input<inputs.web.v20181101.ConnStringInfoArgs>[]>;
    /**
     * Cross-Origin Resource Sharing (CORS) settings.
     */
    cors?: pulumi.Input<inputs.web.v20181101.CorsSettingsArgs>;
    /**
     * Default documents.
     */
     ...
     */
    experiments?: pulumi.Input<inputs.web.v20181101.ExperimentsArgs>;
    /**
     * State of FTP / FTPS service
     */
    ftpsState?: pulumi.Input<string | enums.web.v20181101.FtpsState>;
    /**
     * Handler mappings.
     */
    handlerMappings?: pulumi.Input<pulumi.Input<inputs.web.v20181101.HandlerMappingArgs>[]>;
    /**
     ...
     */
    ipSecurityRestrictions?: pulumi.Input<pulumi.Input<inputs.web.v20181101.IpSecurityRestrictionArgs>[]>;
    /**
     * Java container.
     */
     ...
     * Site limits.
     */
    limits?: pulumi.Input<inputs.web.v20181101.SiteLimitsArgs>;
    /**
     ...
     * Site load balancing.
     */
    loadBalancing?: pulumi.Input<enums.web.v20181101.SiteLoadBalancing>;
    /**
     ...
     */
    managedPipelineMode?: pulumi.Input<enums.web.v20181101.ManagedPipelineMode>;
    /**
     ...
     */
    minTlsVersion?: pulumi.Input<string | enums.web.v20181101.SupportedTlsVersions>;
    /**
     ...
     */
    push?: pulumi.Input<inputs.web.v20181101.PushSettingsArgs>;
    /**
     * Version of Python.
     */
     ...
     */
    scmIpSecurityRestrictions?: pulumi.Input<pulumi.Input<inputs.web.v20181101.IpSecurityRestrictionArgs>[]>;
    /**
     ...
     * SCM type.
     */
    scmType?: pulumi.Input<string | enums.web.v20181101.ScmType>;
    /**
     * Tracing options.
     */
     ...
     */
    virtualApplications?: pulumi.Input<pulumi.Input<inputs.web.v20181101.VirtualApplicationArgs>[]>;
    /**
...
export interface VirtualApplicationArgs {
     ...
     */
    virtualDirectories?: pulumi.Input<pulumi.Input<inputs.web.v20181101.VirtualDirectoryArgs>[]>;
    /**
     * Virtual path.
     */
