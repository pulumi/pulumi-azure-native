...
export interface AppLogsConfigurationArgs {
    ...
    logAnalyticsConfiguration?: pulumi.Input<inputs.web.v20210201.LogAnalyticsConfigurationArgs>;
}
...
export interface AppleArgs {
     ...
     */
    login?: pulumi.Input<inputs.web.v20210201.LoginScopesArgs>;
    /**
     * The configuration settings of the Apple registration.
     */
    registration?: pulumi.Input<inputs.web.v20210201.AppleRegistrationArgs>;
}
...
export interface ApplicationLogsConfigArgs {
     ...
     */
    azureBlobStorage?: pulumi.Input<inputs.web.v20210201.AzureBlobStorageApplicationLogsConfigArgs>;
    /**
     * Application logs to azure table storage configuration.
     */
    azureTableStorage?: pulumi.Input<inputs.web.v20210201.AzureTableStorageApplicationLogsConfigArgs>;
    /**
     * Application logs to file system configuration.
     */
    fileSystem?: pulumi.Input<inputs.web.v20210201.FileSystemApplicationLogsConfigArgs>;
}
/**
...
export function applicationLogsConfigArgsProvideDefaults(val: ApplicationLogsConfigArgs): ApplicationLogsConfigArgs {
    return {
        ...val,
        fileSystem: (val.fileSystem ? pulumi.output(val.fileSystem).apply(inputs.web.v20210201.fileSystemApplicationLogsConfigArgsProvideDefaults) : undefined),
    };
}
...
export interface ArcConfigurationArgs {
    ...
    artifactsStorageType?: pulumi.Input<enums.web.v20210201.StorageType>;
    frontEndServiceConfiguration?: pulumi.Input<inputs.web.v20210201.FrontEndConfigurationArgs>;
...
export interface AutoHealActionsArgs {
     ...
     */
    actionType?: pulumi.Input<enums.web.v20210201.AutoHealActionType>;
    /**
     * Custom action to be taken.
     */
    customAction?: pulumi.Input<inputs.web.v20210201.AutoHealCustomActionArgs>;
    /**
...
export interface AutoHealRulesArgs {
     ...
     */
    actions?: pulumi.Input<inputs.web.v20210201.AutoHealActionsArgs>;
    /**
     * Conditions that describe when to execute the auto-heal actions.
     */
    triggers?: pulumi.Input<inputs.web.v20210201.AutoHealTriggersArgs>;
}
...
export interface AutoHealTriggersArgs {
     ...
     */
    requests?: pulumi.Input<inputs.web.v20210201.RequestsBasedTriggerArgs>;
    /**
     * A rule based on request execution time.
     */
    slowRequests?: pulumi.Input<inputs.web.v20210201.SlowRequestsBasedTriggerArgs>;
    /**
     * A rule based on multiple Slow Requests Rule with path
     */
    slowRequestsWithPath?: pulumi.Input<pulumi.Input<inputs.web.v20210201.SlowRequestsBasedTriggerArgs>[]>;
    /**
     * A rule based on status codes.
     */
    statusCodes?: pulumi.Input<pulumi.Input<inputs.web.v20210201.StatusCodesBasedTriggerArgs>[]>;
    /**
     * A rule based on status codes ranges.
     */
    statusCodesRange?: pulumi.Input<pulumi.Input<inputs.web.v20210201.StatusCodesRangeBasedTriggerArgs>[]>;
}
...
export interface AzureActiveDirectoryArgs {
     ...
     */
    login?: pulumi.Input<inputs.web.v20210201.AzureActiveDirectoryLoginArgs>;
    /**
     * The configuration settings of the Azure Active Directory app registration.
     */
    registration?: pulumi.Input<inputs.web.v20210201.AzureActiveDirectoryRegistrationArgs>;
    /**
     * The configuration settings of the Azure Active Directory token validation flow.
     */
    validation?: pulumi.Input<inputs.web.v20210201.AzureActiveDirectoryValidationArgs>;
}
...
export interface AzureActiveDirectoryValidationArgs {
     ...
     */
    defaultAuthorizationPolicy?: pulumi.Input<inputs.web.v20210201.DefaultAuthorizationPolicyArgs>;
    /**
     * The configuration settings of the checks that should be made while validating the JWT Claims.
     */
    jwtClaimChecks?: pulumi.Input<inputs.web.v20210201.JwtClaimChecksArgs>;
}
...
export interface AzureBlobStorageApplicationLogsConfigArgs {
     ...
     * Log level.
     */
    level?: pulumi.Input<enums.web.v20210201.LogLevel>;
    /**
     * Retention in days.
...
export interface AzureStaticWebAppsArgs {
     ...
     */
    registration?: pulumi.Input<inputs.web.v20210201.AzureStaticWebAppsRegistrationArgs>;
}
...
export interface AzureStorageInfoValueArgs {
     ...
     * Type of storage.
     */
    type?: pulumi.Input<enums.web.v20210201.AzureStorageType>;
}
...
export interface BackupSchedule {
     ...
     */
    frequencyUnit: enums.web.v20210201.FrequencyUnit;
    /**
...
export interface BackupScheduleArgs {
     ...
     * The unit of time for how often the backup should be executed (e.g. for weekly backup, this should be set to Day and FrequencyInterval should be set to 7)
     */
    frequencyUnit: pulumi.Input<enums.web.v20210201.FrequencyUnit>;
    /**
     * True if the retention policy should always keep at least one backup in the storage account, regardless how old it is; false otherwise.
     */
...
export interface ConnStringInfoArgs {
     ...
     * Type of database.
     */
    type?: pulumi.Input<enums.web.v20210201.ConnectionStringType>;
}
...
export interface CookieExpirationArgs {
     ...
     */
    convention?: pulumi.Input<enums.web.v20210201.CookieExpirationConvention>;
    /**
...
export interface CustomOpenIdConnectProviderArgs {
     ...
     */
    login?: pulumi.Input<inputs.web.v20210201.OpenIdConnectLoginArgs>;
    /**
     * The configuration settings of the app registration for the custom Open ID Connect provider.
     */
    registration?: pulumi.Input<inputs.web.v20210201.OpenIdConnectRegistrationArgs>;
}
...
export interface DatabaseBackupSetting {
     ...
     */
    databaseType: string | enums.web.v20210201.DatabaseType;
    name?: string;
}
...
export interface DatabaseBackupSettingArgs {
     ...
     * Database type (e.g. SqlAzure / MySql).
     */
    databaseType: pulumi.Input<string | enums.web.v20210201.DatabaseType>;
    name?: pulumi.Input<string>;
}
...
export interface DefaultAuthorizationPolicyArgs {
     ...
     * The configuration settings of the Azure Active Directory allowed principals.
     */
    allowedPrincipals?: pulumi.Input<inputs.web.v20210201.AllowedPrincipalsArgs>;
}
...
export interface ExperimentsArgs {
     ...
     */
    rampUpRules?: pulumi.Input<pulumi.Input<inputs.web.v20210201.RampUpRuleArgs>[]>;
}
...
export interface FacebookArgs {
     ...
     */
    registration?: pulumi.Input<inputs.web.v20210201.AppRegistrationArgs>;
}
...
export interface ForwardProxyArgs {
     ...
     */
    convention?: pulumi.Input<enums.web.v20210201.ForwardProxyConvention>;
    /**
...
export interface FrontEndConfigurationArgs {
    kind?: pulumi.Input<enums.web.v20210201.FrontEndServiceType>;
}
...
export interface GitHubArgs {
     ...
     */
    registration?: pulumi.Input<inputs.web.v20210201.ClientRegistrationArgs>;
}
...
export interface GitHubActionConfigurationArgs {
     ...
     */
    codeConfiguration?: pulumi.Input<inputs.web.v20210201.GitHubActionCodeConfigurationArgs>;
    /**
     * GitHub Action container configuration.
     */
    containerConfiguration?: pulumi.Input<inputs.web.v20210201.GitHubActionContainerConfigurationArgs>;
    /**
...
export interface GlobalValidationArgs {
     ...
     */
    unauthenticatedClientAction?: pulumi.Input<enums.web.v20210201.UnauthenticatedClientActionV2>;
}
...
export interface GoogleArgs {
     ...
     * The configuration settings of the Azure Active Directory token validation flow.
     */
    validation?: pulumi.Input<inputs.web.v20210201.AllowedAudiencesValidationArgs>;
}
...
export interface HostNameSslStateArgs {
     ...
     */
    hostType?: pulumi.Input<enums.web.v20210201.HostType>;
    /**
     * Hostname.
     */
    name?: pulumi.Input<string>;
     ...
     * SSL type.
     */
    sslState?: pulumi.Input<enums.web.v20210201.SslState>;
    /**
...
export interface HttpLogsConfigArgs {
     ...
     * Http logs to azure blob storage configuration.
     */
    azureBlobStorage?: pulumi.Input<inputs.web.v20210201.AzureBlobStorageHttpLogsConfigArgs>;
    /**
     * Http logs to file system configuration.
     */
    fileSystem?: pulumi.Input<inputs.web.v20210201.FileSystemHttpLogsConfigArgs>;
}
...
export interface HttpSettingsArgs {
     ...
     * The configuration settings of a forward proxy used to make the requests.
     */
    forwardProxy?: pulumi.Input<inputs.web.v20210201.ForwardProxyArgs>;
    /**
     ...
     */
    routes?: pulumi.Input<inputs.web.v20210201.HttpSettingsRoutesArgs>;
}
...
export interface IdentityProvidersArgs {
     ...
     * The configuration settings of the Apple provider.
     */
    apple?: pulumi.Input<inputs.web.v20210201.AppleArgs>;
    /**
     * The configuration settings of the Azure Active directory provider.
     */
    azureActiveDirectory?: pulumi.Input<inputs.web.v20210201.AzureActiveDirectoryArgs>;
    /**
     * The configuration settings of the Azure Static Web Apps provider.
     */
    azureStaticWebApps?: pulumi.Input<inputs.web.v20210201.AzureStaticWebAppsArgs>;
    /**
     * The map of the name of the alias of each custom Open ID Connect provider to the
     * configuration settings of the custom Open ID Connect provider.
     */
    customOpenIdConnectProviders?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20210201.CustomOpenIdConnectProviderArgs>}>;
    /**
     * The configuration settings of the Facebook provider.
     */
    facebook?: pulumi.Input<inputs.web.v20210201.FacebookArgs>;
    /**
     * The configuration settings of the GitHub provider.
     */
    gitHub?: pulumi.Input<inputs.web.v20210201.GitHubArgs>;
    /**
     * The configuration settings of the Google provider.
     */
    google?: pulumi.Input<inputs.web.v20210201.GoogleArgs>;
    /**
     * The configuration settings of the legacy Microsoft Account provider.
     */
    legacyMicrosoftAccount?: pulumi.Input<inputs.web.v20210201.LegacyMicrosoftAccountArgs>;
    /**
     * The configuration settings of the Twitter provider.
     */
    twitter?: pulumi.Input<inputs.web.v20210201.TwitterArgs>;
}
...
export interface IpSecurityRestrictionArgs {
     ...
     */
    tag?: pulumi.Input<string | enums.web.v20210201.IpFilterTag>;
    /**
...
export interface LoginArgs {
     ...
     * The configuration settings of the session cookie's expiration.
     */
    cookieExpiration?: pulumi.Input<inputs.web.v20210201.CookieExpirationArgs>;
    /**
     * The configuration settings of the nonce used in the login flow.
     */
    nonce?: pulumi.Input<inputs.web.v20210201.NonceArgs>;
    /**
     ...
     */
    routes?: pulumi.Input<inputs.web.v20210201.LoginRoutesArgs>;
    /**
     * The configuration settings of the token store.
     */
    tokenStore?: pulumi.Input<inputs.web.v20210201.TokenStoreArgs>;
}
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.web.v20210201.ManagedServiceIdentityType>;
    /**
...
export interface OpenIdConnectClientCredentialArgs {
     ...
     */
    method?: pulumi.Input<enums.web.v20210201.ClientCredentialMethod>;
}
...
export interface OpenIdConnectRegistrationArgs {
     ...
     */
    clientCredential?: pulumi.Input<inputs.web.v20210201.OpenIdConnectClientCredentialArgs>;
    /**
     ...
     * The configuration settings of the endpoints used for the custom Open ID Connect provider.
     */
    openIdConnectConfiguration?: pulumi.Input<inputs.web.v20210201.OpenIdConnectConfigArgs>;
}
...
export interface SiteConfigArgs {
     ...
     * Information about the formal API definition for the app.
     */
    apiDefinition?: pulumi.Input<inputs.web.v20210201.ApiDefinitionInfoArgs>;
    /**
     * Azure API management settings linked to the app.
     */
    apiManagementConfig?: pulumi.Input<inputs.web.v20210201.ApiManagementConfigArgs>;
    /**
     ...
     */
    appSettings?: pulumi.Input<pulumi.Input<inputs.web.v20210201.NameValuePairArgs>[]>;
    /**
     ...
     * Auto Heal rules.
     */
    autoHealRules?: pulumi.Input<inputs.web.v20210201.AutoHealRulesArgs>;
    /**
     * Auto-swap slot name.
     */
     ...
     */
    azureStorageAccounts?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20210201.AzureStorageInfoValueArgs>}>;
    /**
     * Connection strings.
     */
    connectionStrings?: pulumi.Input<pulumi.Input<inputs.web.v20210201.ConnStringInfoArgs>[]>;
    /**
     * Cross-Origin Resource Sharing (CORS) settings.
     */
    cors?: pulumi.Input<inputs.web.v20210201.CorsSettingsArgs>;
    /**
     * Default documents.
     */
     ...
     */
    experiments?: pulumi.Input<inputs.web.v20210201.ExperimentsArgs>;
    /**
     * State of FTP / FTPS service
     */
    ftpsState?: pulumi.Input<string | enums.web.v20210201.FtpsState>;
    /**
     ...
     * Handler mappings.
     */
    handlerMappings?: pulumi.Input<pulumi.Input<inputs.web.v20210201.HandlerMappingArgs>[]>;
    /**
     * Health check path
     */
     ...
     */
    ipSecurityRestrictions?: pulumi.Input<pulumi.Input<inputs.web.v20210201.IpSecurityRestrictionArgs>[]>;
    /**
     * Java container.
     */
     ...
     * Site limits.
     */
    limits?: pulumi.Input<inputs.web.v20210201.SiteLimitsArgs>;
    /**
     ...
     * Site load balancing.
     */
    loadBalancing?: pulumi.Input<enums.web.v20210201.SiteLoadBalancing>;
    /**
     ...
     */
    managedPipelineMode?: pulumi.Input<enums.web.v20210201.ManagedPipelineMode>;
    /**
     ...
     */
    minTlsVersion?: pulumi.Input<string | enums.web.v20210201.SupportedTlsVersions>;
    /**
     ...
     */
    push?: pulumi.Input<inputs.web.v20210201.PushSettingsArgs>;
    /**
     * Version of Python.
     */
     ...
     */
    scmIpSecurityRestrictions?: pulumi.Input<pulumi.Input<inputs.web.v20210201.IpSecurityRestrictionArgs>[]>;
    /**
     ...
     */
    scmMinTlsVersion?: pulumi.Input<string | enums.web.v20210201.SupportedTlsVersions>;
    /**
     * SCM type.
     */
    scmType?: pulumi.Input<string | enums.web.v20210201.ScmType>;
    /**
     * Tracing options.
     */
     ...
     */
    virtualApplications?: pulumi.Input<pulumi.Input<inputs.web.v20210201.VirtualApplicationArgs>[]>;
    /**
...
export interface SkuDescriptionArgs {
     ...
     */
    capabilities?: pulumi.Input<pulumi.Input<inputs.web.v20210201.CapabilityArgs>[]>;
    /**
     ...
     */
    skuCapacity?: pulumi.Input<inputs.web.v20210201.SkuCapacityArgs>;
    /**
...
export interface TokenStoreArgs {
     ...
     * The configuration settings of the storage of the tokens if blob storage is used.
     */
    azureBlobStorage?: pulumi.Input<inputs.web.v20210201.BlobStorageTokenStoreArgs>;
    /**
     ...
     * The configuration settings of the storage of the tokens if a file system is used.
     */
    fileSystem?: pulumi.Input<inputs.web.v20210201.FileSystemTokenStoreArgs>;
    /**
...
export interface TwitterArgs {
     ...
     */
    registration?: pulumi.Input<inputs.web.v20210201.TwitterRegistrationArgs>;
}
...
export interface VirtualApplicationArgs {
     ...
     */
    virtualDirectories?: pulumi.Input<pulumi.Input<inputs.web.v20210201.VirtualDirectoryArgs>[]>;
    /**
     * Virtual path.
     */
