...
export interface AppLogsConfigurationArgs {
    ...
    logAnalyticsConfiguration?: pulumi.Input<inputs.web.v20210301.LogAnalyticsConfigurationArgs>;
}
...
export interface ApplicationLogsConfigArgs {
     ...
     */
    azureBlobStorage?: pulumi.Input<inputs.web.v20210301.AzureBlobStorageApplicationLogsConfigArgs>;
    /**
     * Application logs to azure table storage configuration.
     */
    azureTableStorage?: pulumi.Input<inputs.web.v20210301.AzureTableStorageApplicationLogsConfigArgs>;
    /**
     * Application logs to file system configuration.
     */
    fileSystem?: pulumi.Input<inputs.web.v20210301.FileSystemApplicationLogsConfigArgs>;
}
/**
...
export function applicationLogsConfigArgsProvideDefaults(val: ApplicationLogsConfigArgs): ApplicationLogsConfigArgs {
    return {
        ...val,
        fileSystem: (val.fileSystem ? pulumi.output(val.fileSystem).apply(inputs.web.v20210301.fileSystemApplicationLogsConfigArgsProvideDefaults) : undefined),
    };
}
...
export interface ArcConfigurationArgs {
    ...
    artifactsStorageType?: pulumi.Input<enums.web.v20210301.StorageType>;
    frontEndServiceConfiguration?: pulumi.Input<inputs.web.v20210301.FrontEndConfigurationArgs>;
...
export interface AutoHealActionsArgs {
     ...
     */
    actionType?: pulumi.Input<enums.web.v20210301.AutoHealActionType>;
    /**
     * Custom action to be taken.
     */
    customAction?: pulumi.Input<inputs.web.v20210301.AutoHealCustomActionArgs>;
    /**
...
export interface AutoHealRulesArgs {
     ...
     */
    actions?: pulumi.Input<inputs.web.v20210301.AutoHealActionsArgs>;
    /**
     * Conditions that describe when to execute the auto-heal actions.
     */
    triggers?: pulumi.Input<inputs.web.v20210301.AutoHealTriggersArgs>;
}
...
export interface AutoHealTriggersArgs {
     ...
     */
    requests?: pulumi.Input<inputs.web.v20210301.RequestsBasedTriggerArgs>;
    /**
     * A rule based on request execution time.
     */
    slowRequests?: pulumi.Input<inputs.web.v20210301.SlowRequestsBasedTriggerArgs>;
    /**
     * A rule based on multiple Slow Requests Rule with path
     */
    slowRequestsWithPath?: pulumi.Input<pulumi.Input<inputs.web.v20210301.SlowRequestsBasedTriggerArgs>[]>;
    /**
     * A rule based on status codes.
     */
    statusCodes?: pulumi.Input<pulumi.Input<inputs.web.v20210301.StatusCodesBasedTriggerArgs>[]>;
    /**
     * A rule based on status codes ranges.
     */
    statusCodesRange?: pulumi.Input<pulumi.Input<inputs.web.v20210301.StatusCodesRangeBasedTriggerArgs>[]>;
}
...
export interface AzureBlobStorageApplicationLogsConfigArgs {
     ...
     * Log level.
     */
    level?: pulumi.Input<enums.web.v20210301.LogLevel>;
    /**
     * Retention in days.
...
export interface AzureStorageInfoValueArgs {
     ...
     * Type of storage.
     */
    type?: pulumi.Input<enums.web.v20210301.AzureStorageType>;
}
...
export interface BackupSchedule {
     ...
     */
    frequencyUnit: enums.web.v20210301.FrequencyUnit;
    /**
...
export interface BackupScheduleArgs {
     ...
     * The unit of time for how often the backup should be executed (e.g. for weekly backup, this should be set to Day and FrequencyInterval should be set to 7)
     */
    frequencyUnit: pulumi.Input<enums.web.v20210301.FrequencyUnit>;
    /**
     * True if the retention policy should always keep at least one backup in the storage account, regardless how old it is; false otherwise.
     */
...
export interface ConfigurationArgs {
     ...
     */
    activeRevisionsMode?: pulumi.Input<string | enums.web.v20210301.ActiveRevisionsMode>;
    /**
     * Ingress configurations.
     */
    ingress?: pulumi.Input<inputs.web.v20210301.IngressArgs>;
    /**
     * Collection of private container registry credentials for containers used by the Container app
     */
    registries?: pulumi.Input<pulumi.Input<inputs.web.v20210301.RegistryCredentialsArgs>[]>;
    /**
     * Collection of secrets used by a Container app
     */
    secrets?: pulumi.Input<pulumi.Input<inputs.web.v20210301.SecretArgs>[]>;
}
/**
...
export function configurationArgsProvideDefaults(val: ConfigurationArgs): ConfigurationArgs {
    return {
        ...val,
        ingress: (val.ingress ? pulumi.output(val.ingress).apply(inputs.web.v20210301.ingressArgsProvideDefaults) : undefined),
    };
}
...
export interface ConnStringInfoArgs {
     ...
     * Type of database.
     */
    type?: pulumi.Input<enums.web.v20210301.ConnectionStringType>;
}
...
export interface ContainerArgs {
     ...
     */
    env?: pulumi.Input<pulumi.Input<inputs.web.v20210301.EnvironmentVarArgs>[]>;
    /**
     * Container image tag.
     */
     ...
     */
    resources?: pulumi.Input<inputs.web.v20210301.ContainerResourcesArgs>;
}
...
export interface CustomScaleRuleArgs {
     ...
     */
    auth?: pulumi.Input<pulumi.Input<inputs.web.v20210301.ScaleRuleAuthArgs>[]>;
    /**
...
export interface DaprArgs {
     ...
     */
    components?: pulumi.Input<pulumi.Input<inputs.web.v20210301.DaprComponentArgs>[]>;
    /**
...
export interface DaprComponentArgs {
     ...
     * Component metadata
     */
    metadata?: pulumi.Input<pulumi.Input<inputs.web.v20210301.DaprMetadataArgs>[]>;
    /**
     * Component name
     */
    name?: pulumi.Input<string>;
...
export interface DatabaseBackupSetting {
     ...
     */
    databaseType: string | enums.web.v20210301.DatabaseType;
    name?: string;
}
...
export interface DatabaseBackupSettingArgs {
     ...
     * Database type (e.g. SqlAzure / MySql).
     */
    databaseType: pulumi.Input<string | enums.web.v20210301.DatabaseType>;
    name?: pulumi.Input<string>;
}
...
export interface ExperimentsArgs {
     ...
     */
    rampUpRules?: pulumi.Input<pulumi.Input<inputs.web.v20210301.RampUpRuleArgs>[]>;
}
...
export interface FrontEndConfigurationArgs {
    kind?: pulumi.Input<enums.web.v20210301.FrontEndServiceType>;
}
...
export interface GitHubActionConfigurationArgs {
     ...
     */
    codeConfiguration?: pulumi.Input<inputs.web.v20210301.GitHubActionCodeConfigurationArgs>;
    /**
     * GitHub Action container configuration.
     */
    containerConfiguration?: pulumi.Input<inputs.web.v20210301.GitHubActionContainerConfigurationArgs>;
    /**
...
export interface HostNameSslStateArgs {
     ...
     */
    hostType?: pulumi.Input<enums.web.v20210301.HostType>;
    /**
     * Hostname.
     */
    name?: pulumi.Input<string>;
...
export interface HttpLogsConfigArgs {
     ...
     * Http logs to azure blob storage configuration.
     */
    azureBlobStorage?: pulumi.Input<inputs.web.v20210301.AzureBlobStorageHttpLogsConfigArgs>;
    /**
     * Http logs to file system configuration.
     */
    fileSystem?: pulumi.Input<inputs.web.v20210301.FileSystemHttpLogsConfigArgs>;
}
...
export interface IngressArgs {
    ...
    traffic?: pulumi.Input<pulumi.Input<inputs.web.v20210301.TrafficWeightArgs>[]>;
    /**
     * Ingress transport protocol
     */
    transport?: pulumi.Input<string | enums.web.v20210301.IngressTransportMethod>;
}
/**
...
export interface IpSecurityRestrictionArgs {
     ...
     */
    tag?: pulumi.Input<string | enums.web.v20210301.IpFilterTag>;
    /**
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.web.v20210301.ManagedServiceIdentityType>;
    /**
...
export interface ScaleArgs {
     ...
     * Scaling rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.web.v20210301.ScaleRuleArgs>[]>;
}
...
export interface ScaleRuleArgs {
     ...
     */
    azureQueue?: pulumi.Input<inputs.web.v20210301.QueueScaleRuleArgs>;
    /**
     * Custom scale rule.
     */
    custom?: pulumi.Input<inputs.web.v20210301.CustomScaleRuleArgs>;
    /**
     * HTTP requests based scaling.
     */
    http?: pulumi.Input<inputs.web.v20210301.HttpScaleRuleArgs>;
    /**
     * Scale Rule Name
     */
    name?: pulumi.Input<string>;
...
export interface SiteConfigArgs {
     ...
     * Information about the formal API definition for the app.
     */
    apiDefinition?: pulumi.Input<inputs.web.v20210301.ApiDefinitionInfoArgs>;
    /**
     * Azure API management settings linked to the app.
     */
    apiManagementConfig?: pulumi.Input<inputs.web.v20210301.ApiManagementConfigArgs>;
    /**
     ...
     */
    appSettings?: pulumi.Input<pulumi.Input<inputs.web.v20210301.NameValuePairArgs>[]>;
    /**
     ...
     * Auto Heal rules.
     */
    autoHealRules?: pulumi.Input<inputs.web.v20210301.AutoHealRulesArgs>;
    /**
     * Auto-swap slot name.
     */
     ...
     */
    azureStorageAccounts?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20210301.AzureStorageInfoValueArgs>}>;
    /**
     * Connection strings.
     */
    connectionStrings?: pulumi.Input<pulumi.Input<inputs.web.v20210301.ConnStringInfoArgs>[]>;
    /**
     * Cross-Origin Resource Sharing (CORS) settings.
     */
    cors?: pulumi.Input<inputs.web.v20210301.CorsSettingsArgs>;
    /**
     * Default documents.
     */
     ...
     */
    experiments?: pulumi.Input<inputs.web.v20210301.ExperimentsArgs>;
    /**
     * State of FTP / FTPS service
     */
    ftpsState?: pulumi.Input<string | enums.web.v20210301.FtpsState>;
    /**
     ...
     * Handler mappings.
     */
    handlerMappings?: pulumi.Input<pulumi.Input<inputs.web.v20210301.HandlerMappingArgs>[]>;
    /**
     * Health check path
     */
     ...
     */
    ipSecurityRestrictions?: pulumi.Input<pulumi.Input<inputs.web.v20210301.IpSecurityRestrictionArgs>[]>;
    /**
     * Java container.
     */
     ...
     * Site limits.
     */
    limits?: pulumi.Input<inputs.web.v20210301.SiteLimitsArgs>;
    /**
     ...
     * Site load balancing.
     */
    loadBalancing?: pulumi.Input<enums.web.v20210301.SiteLoadBalancing>;
    /**
     ...
     */
    managedPipelineMode?: pulumi.Input<enums.web.v20210301.ManagedPipelineMode>;
    /**
     ...
     */
    minTlsVersion?: pulumi.Input<string | enums.web.v20210301.SupportedTlsVersions>;
    /**
     ...
     */
    push?: pulumi.Input<inputs.web.v20210301.PushSettingsArgs>;
    /**
     * Version of Python.
     */
     ...
     */
    scmIpSecurityRestrictions?: pulumi.Input<pulumi.Input<inputs.web.v20210301.IpSecurityRestrictionArgs>[]>;
    /**
     ...
     */
    scmMinTlsVersion?: pulumi.Input<string | enums.web.v20210301.SupportedTlsVersions>;
    /**
     * SCM type.
     */
    scmType?: pulumi.Input<string | enums.web.v20210301.ScmType>;
    /**
     * Tracing options.
     */
     ...
     */
    virtualApplications?: pulumi.Input<pulumi.Input<inputs.web.v20210301.VirtualApplicationArgs>[]>;
    /**
...
export interface SkuDescriptionArgs {
     ...
     */
    capabilities?: pulumi.Input<pulumi.Input<inputs.web.v20210301.CapabilityArgs>[]>;
    /**
     ...
     */
    skuCapacity?: pulumi.Input<inputs.web.v20210301.SkuCapacityArgs>;
    /**
...
export interface TemplateArgs {
     ...
     */
    containers?: pulumi.Input<pulumi.Input<inputs.web.v20210301.ContainerArgs>[]>;
    /**
     * Dapr configuration for the Container App.
     */
    dapr?: pulumi.Input<inputs.web.v20210301.DaprArgs>;
    /**
     ...
     */
    scale?: pulumi.Input<inputs.web.v20210301.ScaleArgs>;
}
...
export interface VirtualApplicationArgs {
     ...
     */
    virtualDirectories?: pulumi.Input<pulumi.Input<inputs.web.v20210301.VirtualDirectoryArgs>[]>;
    /**
     * Virtual path.
     */
