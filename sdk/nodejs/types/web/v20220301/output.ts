...
export interface AppLogsConfigurationResponse {
    destination?: string;
    logAnalyticsConfiguration?: outputs.web.v20220301.LogAnalyticsConfigurationResponse;
}
...
export interface ApplicationLogsConfigResponse {
     ...
     */
    azureBlobStorage?: outputs.web.v20220301.AzureBlobStorageApplicationLogsConfigResponse;
    /**
     * Application logs to azure table storage configuration.
     */
    azureTableStorage?: outputs.web.v20220301.AzureTableStorageApplicationLogsConfigResponse;
    /**
     * Application logs to file system configuration.
     */
    fileSystem?: outputs.web.v20220301.FileSystemApplicationLogsConfigResponse;
}
/**
...
export function applicationLogsConfigResponseProvideDefaults(val: ApplicationLogsConfigResponse): ApplicationLogsConfigResponse {
    return {
        ...val,
        fileSystem: (val.fileSystem ? outputs.web.v20220301.fileSystemApplicationLogsConfigResponseProvideDefaults(val.fileSystem) : undefined),
    };
}
...
export interface ArcConfigurationResponse {
    ...
    frontEndServiceConfiguration?: outputs.web.v20220301.FrontEndConfigurationResponse;
}
...
export interface AutoHealActionsResponse {
     ...
     */
    customAction?: outputs.web.v20220301.AutoHealCustomActionResponse;
    /**
...
export interface AutoHealRulesResponse {
     ...
     */
    actions?: outputs.web.v20220301.AutoHealActionsResponse;
    /**
     * Conditions that describe when to execute the auto-heal actions.
     */
    triggers?: outputs.web.v20220301.AutoHealTriggersResponse;
}
...
export interface AutoHealTriggersResponse {
     ...
     */
    requests?: outputs.web.v20220301.RequestsBasedTriggerResponse;
    /**
     * A rule based on request execution time.
     */
    slowRequests?: outputs.web.v20220301.SlowRequestsBasedTriggerResponse;
    /**
     * A rule based on multiple Slow Requests Rule with path
     */
    slowRequestsWithPath?: outputs.web.v20220301.SlowRequestsBasedTriggerResponse[];
    /**
     * A rule based on status codes.
     */
    statusCodes?: outputs.web.v20220301.StatusCodesBasedTriggerResponse[];
    /**
     * A rule based on status codes ranges.
     */
    statusCodesRange?: outputs.web.v20220301.StatusCodesRangeBasedTriggerResponse[];
}
...
export interface AzureResourceErrorInfoResponse {
     ...
     * The error details.
     */
    details?: outputs.web.v20220301.AzureResourceErrorInfoResponse[];
    /**
     * The error message.
     */
    message: string;
...
export interface BackupItemResponse {
     ...
     */
    databases: outputs.web.v20220301.DatabaseBackupSettingResponse[];
    /**
...
export interface ConfigurationResponse {
     ...
     */
    ingress?: outputs.web.v20220301.IngressResponse;
    /**
     * Collection of private container registry credentials for containers used by the Container app
     */
    registries?: outputs.web.v20220301.RegistryCredentialsResponse[];
    /**
     * Collection of secrets used by a Container app
     */
    secrets?: outputs.web.v20220301.SecretResponse[];
}
/**
...
export function configurationResponseProvideDefaults(val: ConfigurationResponse): ConfigurationResponse {
    return {
        ...val,
        ingress: (val.ingress ? outputs.web.v20220301.ingressResponseProvideDefaults(val.ingress) : undefined),
    };
}
...
export interface ContainerResponse {
     ...
     */
    env?: outputs.web.v20220301.EnvironmentVarResponse[];
    /**
     * Container image tag.
     */
    image?: string;
     ...
     */
    resources?: outputs.web.v20220301.ContainerResourcesResponse;
}
...
export interface CustomScaleRuleResponse {
     ...
     */
    auth?: outputs.web.v20220301.ScaleRuleAuthResponse[];
    /**
...
export interface DaprComponentResponse {
     ...
     * Component metadata
     */
    metadata?: outputs.web.v20220301.DaprMetadataResponse[];
    /**
     * Component name
     */
    name?: string;
...
export interface DaprResponse {
     ...
     */
    components?: outputs.web.v20220301.DaprComponentResponse[];
    /**
...
export interface ErrorEntityResponse {
     ...
     * Error Details.
     */
    details?: outputs.web.v20220301.ErrorEntityResponse[];
    /**
     * Type of error.
     */
    extendedCode?: string;
     ...
     * Inner errors.
     */
    innerErrors?: outputs.web.v20220301.ErrorEntityResponse[];
    /**
...
export interface ExperimentsResponse {
     ...
     */
    rampUpRules?: outputs.web.v20220301.RampUpRuleResponse[];
}
...
export interface ExpressionResponse {
     ...
     * The azure resource error info.
     */
    error?: outputs.web.v20220301.AzureResourceErrorInfoResponse;
    /**
     * The sub expressions.
     */
    subexpressions?: outputs.web.v20220301.ExpressionResponse[];
    /**
     * The text.
     */
    text?: string;
...
export interface GitHubActionConfigurationResponse {
     ...
     */
    codeConfiguration?: outputs.web.v20220301.GitHubActionCodeConfigurationResponse;
    /**
     * GitHub Action container configuration.
     */
    containerConfiguration?: outputs.web.v20220301.GitHubActionContainerConfigurationResponse;
    /**
...
export interface HttpLogsConfigResponse {
     ...
     * Http logs to azure blob storage configuration.
     */
    azureBlobStorage?: outputs.web.v20220301.AzureBlobStorageHttpLogsConfigResponse;
    /**
     * Http logs to file system configuration.
     */
    fileSystem?: outputs.web.v20220301.FileSystemHttpLogsConfigResponse;
}
...
export interface IngressResponse {
     ...
     */
    targetPort?: number;
    traffic?: outputs.web.v20220301.TrafficWeightResponse[];
    /**
...
export interface ManagedServiceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.web.v20220301.UserAssignedIdentityResponse};
}
...
export interface RemotePrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.web.v20220301.ArmIdWrapperResponse;
    /**
     * The state of a private link connection
     */
    privateLinkServiceConnectionState?: outputs.web.v20220301.PrivateLinkConnectionStateResponse;
    provisioningState: string;
    /**
     * Resource type.
     */
...
export interface ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse {
     ...
     */
    error?: outputs.web.v20220301.ErrorEntityResponse;
    /**
     ...
     * MSI resource
     */
    identity?: outputs.web.v20220301.ManagedServiceIdentityResponse;
    /**
     ...
     */
    plan?: outputs.web.v20220301.ArmPlanResponse;
    /**
     * Resource specific properties.
     */
    properties?: outputs.web.v20220301.RemotePrivateEndpointConnectionResponse;
    /**
     * SKU description of the resource.
     */
    sku?: outputs.web.v20220301.SkuDescriptionResponse;
    /**
...
export interface ScaleResponse {
     ...
     * Scaling rules.
     */
    rules?: outputs.web.v20220301.ScaleRuleResponse[];
}
...
export interface ScaleRuleResponse {
     ...
     */
    azureQueue?: outputs.web.v20220301.QueueScaleRuleResponse;
    /**
     * Custom scale rule.
     */
    custom?: outputs.web.v20220301.CustomScaleRuleResponse;
    /**
     * HTTP requests based scaling.
     */
    http?: outputs.web.v20220301.HttpScaleRuleResponse;
    /**
     * Scale Rule Name
     */
    name?: string;
...
export interface SiteConfigResponse {
     ...
     * Information about the formal API definition for the app.
     */
    apiDefinition?: outputs.web.v20220301.ApiDefinitionInfoResponse;
    /**
     * Azure API management settings linked to the app.
     */
    apiManagementConfig?: outputs.web.v20220301.ApiManagementConfigResponse;
    /**
     ...
     */
    appSettings?: outputs.web.v20220301.NameValuePairResponse[];
    /**
     ...
     * Auto Heal rules.
     */
    autoHealRules?: outputs.web.v20220301.AutoHealRulesResponse;
    /**
     * Auto-swap slot name.
     */
     ...
     */
    azureStorageAccounts?: {[key: string]: outputs.web.v20220301.AzureStorageInfoValueResponse};
    /**
     * Connection strings.
     */
    connectionStrings?: outputs.web.v20220301.ConnStringInfoResponse[];
    /**
     * Cross-Origin Resource Sharing (CORS) settings.
     */
    cors?: outputs.web.v20220301.CorsSettingsResponse;
    /**
     * Default documents.
     */
     ...
     */
    experiments?: outputs.web.v20220301.ExperimentsResponse;
    /**
     ...
     * Handler mappings.
     */
    handlerMappings?: outputs.web.v20220301.HandlerMappingResponse[];
    /**
     * Health check path
     */
     ...
     */
    ipSecurityRestrictions?: outputs.web.v20220301.IpSecurityRestrictionResponse[];
    /**
     * Java container.
     */
     ...
     * Site limits.
     */
    limits?: outputs.web.v20220301.SiteLimitsResponse;
    /**
     ...
     * Site MachineKey.
     */
    machineKey: outputs.web.v20220301.SiteMachineKeyResponse;
    /**
     ...
     */
    push?: outputs.web.v20220301.PushSettingsResponse;
    /**
     * Version of Python.
     */
     ...
     */
    scmIpSecurityRestrictions?: outputs.web.v20220301.IpSecurityRestrictionResponse[];
    /**
     ...
     */
    virtualApplications?: outputs.web.v20220301.VirtualApplicationResponse[];
    /**
...
export interface SkuDescriptionResponse {
     ...
     */
    capabilities?: outputs.web.v20220301.CapabilityResponse[];
    /**
     ...
     */
    skuCapacity?: outputs.web.v20220301.SkuCapacityResponse;
    /**
...
export interface TemplateResponse {
     ...
     */
    containers?: outputs.web.v20220301.ContainerResponse[];
    /**
     * Dapr configuration for the Container App.
     */
    dapr?: outputs.web.v20220301.DaprResponse;
    /**
     ...
     */
    scale?: outputs.web.v20220301.ScaleResponse;
}
...
export interface VirtualApplicationResponse {
     ...
     */
    virtualDirectories?: outputs.web.v20220301.VirtualDirectoryResponse[];
    /**
     * Virtual path.
     */
    virtualPath?: string;
