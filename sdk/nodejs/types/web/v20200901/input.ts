...
export interface ApplicationLogsConfigArgs {
     ...
     */
    azureBlobStorage?: pulumi.Input<inputs.web.v20200901.AzureBlobStorageApplicationLogsConfigArgs>;
    /**
     * Application logs to azure table storage configuration.
     */
    azureTableStorage?: pulumi.Input<inputs.web.v20200901.AzureTableStorageApplicationLogsConfigArgs>;
    /**
     * Application logs to file system configuration.
     */
    fileSystem?: pulumi.Input<inputs.web.v20200901.FileSystemApplicationLogsConfigArgs>;
}
/**
...
export function applicationLogsConfigArgsProvideDefaults(val: ApplicationLogsConfigArgs): ApplicationLogsConfigArgs {
    return {
        ...val,
        fileSystem: (val.fileSystem ? pulumi.output(val.fileSystem).apply(inputs.web.v20200901.fileSystemApplicationLogsConfigArgsProvideDefaults) : undefined),
    };
}
...
export interface AutoHealActionsArgs {
     ...
     */
    actionType?: pulumi.Input<enums.web.v20200901.AutoHealActionType>;
    /**
     * Custom action to be taken.
     */
    customAction?: pulumi.Input<inputs.web.v20200901.AutoHealCustomActionArgs>;
    /**
...
export interface AutoHealRulesArgs {
     ...
     */
    actions?: pulumi.Input<inputs.web.v20200901.AutoHealActionsArgs>;
    /**
     * Conditions that describe when to execute the auto-heal actions.
     */
    triggers?: pulumi.Input<inputs.web.v20200901.AutoHealTriggersArgs>;
}
...
export interface AutoHealTriggersArgs {
     ...
     */
    requests?: pulumi.Input<inputs.web.v20200901.RequestsBasedTriggerArgs>;
    /**
     * A rule based on request execution time.
     */
    slowRequests?: pulumi.Input<inputs.web.v20200901.SlowRequestsBasedTriggerArgs>;
    /**
     * A rule based on status codes.
     */
    statusCodes?: pulumi.Input<pulumi.Input<inputs.web.v20200901.StatusCodesBasedTriggerArgs>[]>;
}
...
export interface AzureActiveDirectoryArgs {
     ...
     */
    kind?: pulumi.Input<string>;
    login?: pulumi.Input<inputs.web.v20200901.AzureActiveDirectoryLoginArgs>;
    registration?: pulumi.Input<inputs.web.v20200901.AzureActiveDirectoryRegistrationArgs>;
    validation?: pulumi.Input<inputs.web.v20200901.AzureActiveDirectoryValidationArgs>;
}
...
export interface AzureActiveDirectoryValidationArgs {
    allowedAudiences?: pulumi.Input<pulumi.Input<string>[]>;
    jwtClaimChecks?: pulumi.Input<inputs.web.v20200901.JwtClaimChecksArgs>;
    /**
     * Kind of resource.
     */
    kind?: pulumi.Input<string>;
...
export interface AzureBlobStorageApplicationLogsConfigArgs {
     ...
     * Log level.
     */
    level?: pulumi.Input<enums.web.v20200901.LogLevel>;
    /**
     * Retention in days.
...
export interface AzureStorageInfoValueArgs {
     ...
     * Type of storage.
     */
    type?: pulumi.Input<enums.web.v20200901.AzureStorageType>;
}
...
export interface BackupSchedule {
     ...
     */
    frequencyUnit: enums.web.v20200901.FrequencyUnit;
    /**
...
export interface BackupScheduleArgs {
     ...
     * The unit of time for how often the backup should be executed (e.g. for weekly backup, this should be set to Day and FrequencyInterval should be set to 7)
     */
    frequencyUnit: pulumi.Input<enums.web.v20200901.FrequencyUnit>;
    /**
     * True if the retention policy should always keep at least one backup in the storage account, regardless how old it is; false otherwise.
     */
...
export interface ConnStringInfoArgs {
     ...
     * Type of database.
     */
    type?: pulumi.Input<enums.web.v20200901.ConnectionStringType>;
}
...
export interface CookieExpirationArgs {
    convention?: pulumi.Input<enums.web.v20200901.CookieExpirationConvention>;
    /**
     * Kind of resource.
     */
    kind?: pulumi.Input<string>;
...
export interface CustomOpenIdConnectProviderArgs {
     ...
     */
    kind?: pulumi.Input<string>;
    login?: pulumi.Input<inputs.web.v20200901.OpenIdConnectLoginArgs>;
    registration?: pulumi.Input<inputs.web.v20200901.OpenIdConnectRegistrationArgs>;
}
...
export interface DatabaseBackupSetting {
     ...
     */
    databaseType: string | enums.web.v20200901.DatabaseType;
    name?: string;
}
...
export interface DatabaseBackupSettingArgs {
     ...
     * Database type (e.g. SqlAzure / MySql).
     */
    databaseType: pulumi.Input<string | enums.web.v20200901.DatabaseType>;
    name?: pulumi.Input<string>;
}
...
export interface ExperimentsArgs {
     ...
     */
    rampUpRules?: pulumi.Input<pulumi.Input<inputs.web.v20200901.RampUpRuleArgs>[]>;
}
...
export interface FacebookArgs {
     ...
     */
    kind?: pulumi.Input<string>;
    login?: pulumi.Input<inputs.web.v20200901.LoginScopesArgs>;
    registration?: pulumi.Input<inputs.web.v20200901.AppRegistrationArgs>;
}
...
export interface ForwardProxyArgs {
    convention?: pulumi.Input<enums.web.v20200901.ForwardProxyConvention>;
...
export interface GitHubArgs {
    ...
    kind?: pulumi.Input<string>;
    login?: pulumi.Input<inputs.web.v20200901.LoginScopesArgs>;
    registration?: pulumi.Input<inputs.web.v20200901.ClientRegistrationArgs>;
}
...
export interface GlobalValidationArgs {
    ...
    unauthenticatedClientAction?: pulumi.Input<enums.web.v20200901.UnauthenticatedClientActionV2>;
}
...
export interface GoogleArgs {
    ...
    login?: pulumi.Input<inputs.web.v20200901.LoginScopesArgs>;
    registration?: pulumi.Input<inputs.web.v20200901.ClientRegistrationArgs>;
    validation?: pulumi.Input<inputs.web.v20200901.AllowedAudiencesValidationArgs>;
}
...
export interface HostNameSslStateArgs {
     ...
     */
    hostType?: pulumi.Input<enums.web.v20200901.HostType>;
    /**
     * Hostname.
     */
    name?: pulumi.Input<string>;
     ...
     * SSL type.
     */
    sslState?: pulumi.Input<enums.web.v20200901.SslState>;
    /**
...
export interface HttpLogsConfigArgs {
     ...
     * Http logs to azure blob storage configuration.
     */
    azureBlobStorage?: pulumi.Input<inputs.web.v20200901.AzureBlobStorageHttpLogsConfigArgs>;
    /**
     * Http logs to file system configuration.
     */
    fileSystem?: pulumi.Input<inputs.web.v20200901.FileSystemHttpLogsConfigArgs>;
}

export interface HttpSettingsArgs {
    forwardProxy?: pulumi.Input<inputs.web.v20200901.ForwardProxyArgs>;
    /**
     * Kind of resource.
     */
    kind?: pulumi.Input<string>;
    requireHttps?: pulumi.Input<boolean>;
    routes?: pulumi.Input<inputs.web.v20200901.HttpSettingsRoutesArgs>;
}
...
export interface IdentityProvidersArgs {
    azureActiveDirectory?: pulumi.Input<inputs.web.v20200901.AzureActiveDirectoryArgs>;
    customOpenIdConnectProviders?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20200901.CustomOpenIdConnectProviderArgs>}>;
    facebook?: pulumi.Input<inputs.web.v20200901.FacebookArgs>;
    gitHub?: pulumi.Input<inputs.web.v20200901.GitHubArgs>;
    google?: pulumi.Input<inputs.web.v20200901.GoogleArgs>;
    /**
     * Kind of resource.
     */
    kind?: pulumi.Input<string>;
    twitter?: pulumi.Input<inputs.web.v20200901.TwitterArgs>;
}
...
export interface IpSecurityRestrictionArgs {
     ...
     */
    tag?: pulumi.Input<string | enums.web.v20200901.IpFilterTag>;
    /**
...
export interface LoginArgs {
    ...
    cookieExpiration?: pulumi.Input<inputs.web.v20200901.CookieExpirationArgs>;
    /**
     * Kind of resource.
     */
    kind?: pulumi.Input<string>;
    nonce?: pulumi.Input<inputs.web.v20200901.NonceArgs>;
    preserveUrlFragmentsForLogins?: pulumi.Input<boolean>;
    routes?: pulumi.Input<inputs.web.v20200901.LoginRoutesArgs>;
    tokenStore?: pulumi.Input<inputs.web.v20200901.TokenStoreArgs>;
}
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.web.v20200901.ManagedServiceIdentityType>;
    /**
...
export interface NetworkAccessControlEntryArgs {
     ...
     * Action object.
     */
    action?: pulumi.Input<enums.web.v20200901.AccessControlEntryAction>;
    /**
...
export interface OpenIdConnectClientCredentialArgs {
     ...
     */
    kind?: pulumi.Input<string>;
    method?: pulumi.Input<enums.web.v20200901.ClientCredentialMethod>;
}
...
export interface OpenIdConnectRegistrationArgs {
    clientCredential?: pulumi.Input<inputs.web.v20200901.OpenIdConnectClientCredentialArgs>;
    clientId?: pulumi.Input<string>;
    /**
     * Kind of resource.
     */
    kind?: pulumi.Input<string>;
    openIdConnectConfiguration?: pulumi.Input<inputs.web.v20200901.OpenIdConnectConfigArgs>;
}
...
export interface SiteConfigArgs {
     ...
     * Information about the formal API definition for the app.
     */
    apiDefinition?: pulumi.Input<inputs.web.v20200901.ApiDefinitionInfoArgs>;
    /**
     * Azure API management settings linked to the app.
     */
    apiManagementConfig?: pulumi.Input<inputs.web.v20200901.ApiManagementConfigArgs>;
    /**
     ...
     */
    appSettings?: pulumi.Input<pulumi.Input<inputs.web.v20200901.NameValuePairArgs>[]>;
    /**
     ...
     * Auto Heal rules.
     */
    autoHealRules?: pulumi.Input<inputs.web.v20200901.AutoHealRulesArgs>;
    /**
     * Auto-swap slot name.
     */
     ...
     * Connection strings.
     */
    connectionStrings?: pulumi.Input<pulumi.Input<inputs.web.v20200901.ConnStringInfoArgs>[]>;
    /**
     * Cross-Origin Resource Sharing (CORS) settings.
     */
    cors?: pulumi.Input<inputs.web.v20200901.CorsSettingsArgs>;
    /**
     * Default documents.
     */
     ...
     */
    experiments?: pulumi.Input<inputs.web.v20200901.ExperimentsArgs>;
    /**
     * State of FTP / FTPS service
     */
    ftpsState?: pulumi.Input<string | enums.web.v20200901.FtpsState>;
    /**
     * Handler mappings.
     */
    handlerMappings?: pulumi.Input<pulumi.Input<inputs.web.v20200901.HandlerMappingArgs>[]>;
    /**
     * Health check path
     */
     ...
     */
    ipSecurityRestrictions?: pulumi.Input<pulumi.Input<inputs.web.v20200901.IpSecurityRestrictionArgs>[]>;
    /**
     * Java container.
     */
     ...
     * Site limits.
     */
    limits?: pulumi.Input<inputs.web.v20200901.SiteLimitsArgs>;
    /**
     ...
     * Site load balancing.
     */
    loadBalancing?: pulumi.Input<enums.web.v20200901.SiteLoadBalancing>;
    /**
     ...
     */
    managedPipelineMode?: pulumi.Input<enums.web.v20200901.ManagedPipelineMode>;
    /**
     ...
     */
    minTlsVersion?: pulumi.Input<string | enums.web.v20200901.SupportedTlsVersions>;
    /**
     ...
     */
    push?: pulumi.Input<inputs.web.v20200901.PushSettingsArgs>;
    /**
     * Version of Python.
     */
     ...
     */
    scmIpSecurityRestrictions?: pulumi.Input<pulumi.Input<inputs.web.v20200901.IpSecurityRestrictionArgs>[]>;
    /**
     ...
     */
    scmMinTlsVersion?: pulumi.Input<string | enums.web.v20200901.SupportedTlsVersions>;
    /**
     * SCM type.
     */
    scmType?: pulumi.Input<string | enums.web.v20200901.ScmType>;
    /**
     * Tracing options.
     */
     ...
     */
    virtualApplications?: pulumi.Input<pulumi.Input<inputs.web.v20200901.VirtualApplicationArgs>[]>;
    /**
...
export interface SkuDescriptionArgs {
     ...
     */
    capabilities?: pulumi.Input<pulumi.Input<inputs.web.v20200901.CapabilityArgs>[]>;
    /**
     ...
     */
    skuCapacity?: pulumi.Input<inputs.web.v20200901.SkuCapacityArgs>;
    /**
...
export interface TokenStoreArgs {
    azureBlobStorage?: pulumi.Input<inputs.web.v20200901.BlobStorageTokenStoreArgs>;
    enabled?: pulumi.Input<boolean>;
    fileSystem?: pulumi.Input<inputs.web.v20200901.FileSystemTokenStoreArgs>;
    /**
     * Kind of resource.
     */
    kind?: pulumi.Input<string>;
...
export interface TwitterArgs {
     ...
     */
    kind?: pulumi.Input<string>;
    registration?: pulumi.Input<inputs.web.v20200901.TwitterRegistrationArgs>;
}
...
export interface VirtualApplicationArgs {
     ...
     */
    virtualDirectories?: pulumi.Input<pulumi.Input<inputs.web.v20200901.VirtualDirectoryArgs>[]>;
    /**
     * Virtual path.
     */
...
export interface WorkerPoolArgs {
     ...
     */
    computeMode?: pulumi.Input<enums.web.v20200901.ComputeModeOptions>;
    /**
