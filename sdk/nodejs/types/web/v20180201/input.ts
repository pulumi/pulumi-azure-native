...
export interface ApplicationLogsConfigArgs {
     ...
     */
    azureBlobStorage?: pulumi.Input<inputs.web.v20180201.AzureBlobStorageApplicationLogsConfigArgs>;
    /**
     * Application logs to azure table storage configuration.
     */
    azureTableStorage?: pulumi.Input<inputs.web.v20180201.AzureTableStorageApplicationLogsConfigArgs>;
    /**
     * Application logs to file system configuration.
     */
    fileSystem?: pulumi.Input<inputs.web.v20180201.FileSystemApplicationLogsConfigArgs>;
}
/**
...
export function applicationLogsConfigArgsProvideDefaults(val: ApplicationLogsConfigArgs): ApplicationLogsConfigArgs {
    return {
        ...val,
        fileSystem: (val.fileSystem ? pulumi.output(val.fileSystem).apply(inputs.web.v20180201.fileSystemApplicationLogsConfigArgsProvideDefaults) : undefined),
    };
}
...
export interface AutoHealActionsArgs {
     ...
     */
    actionType?: pulumi.Input<enums.web.v20180201.AutoHealActionType>;
    /**
     * Custom action to be taken.
     */
    customAction?: pulumi.Input<inputs.web.v20180201.AutoHealCustomActionArgs>;
    /**
...
export interface AutoHealRulesArgs {
     ...
     */
    actions?: pulumi.Input<inputs.web.v20180201.AutoHealActionsArgs>;
    /**
     * Conditions that describe when to execute the auto-heal actions.
     */
    triggers?: pulumi.Input<inputs.web.v20180201.AutoHealTriggersArgs>;
}
...
export interface AutoHealTriggersArgs {
     ...
     */
    requests?: pulumi.Input<inputs.web.v20180201.RequestsBasedTriggerArgs>;
    /**
     * A rule based on request execution time.
     */
    slowRequests?: pulumi.Input<inputs.web.v20180201.SlowRequestsBasedTriggerArgs>;
    /**
     * A rule based on status codes.
     */
    statusCodes?: pulumi.Input<pulumi.Input<inputs.web.v20180201.StatusCodesBasedTriggerArgs>[]>;
}
...
export interface AzureBlobStorageApplicationLogsConfigArgs {
     ...
     * Log level.
     */
    level?: pulumi.Input<enums.web.v20180201.LogLevel>;
    /**
     * Retention in days.
...
export interface AzureStorageInfoValueArgs {
     ...
     * Type of storage.
     */
    type?: pulumi.Input<enums.web.v20180201.AzureStorageType>;
}
...
export interface BackupSchedule {
     ...
     */
    frequencyUnit: enums.web.v20180201.FrequencyUnit;
    /**
...
export interface BackupScheduleArgs {
     ...
     * The unit of time for how often the backup should be executed (e.g. for weekly backup, this should be set to Day and FrequencyInterval should be set to 7)
     */
    frequencyUnit: pulumi.Input<enums.web.v20180201.FrequencyUnit>;
    /**
     * True if the retention policy should always keep at least one backup in the storage account, regardless how old it is; false otherwise.
     */
...
export interface ConnStringInfoArgs {
     ...
     * Type of database.
     */
    type?: pulumi.Input<enums.web.v20180201.ConnectionStringType>;
}
...
export interface DatabaseBackupSetting {
     ...
     */
    databaseType: string | enums.web.v20180201.DatabaseType;
    name?: string;
}
...
export interface DatabaseBackupSettingArgs {
     ...
     * Database type (e.g. SqlAzure / MySql).
     */
    databaseType: pulumi.Input<string | enums.web.v20180201.DatabaseType>;
    name?: pulumi.Input<string>;
}
...
export interface ExperimentsArgs {
     ...
     */
    rampUpRules?: pulumi.Input<pulumi.Input<inputs.web.v20180201.RampUpRuleArgs>[]>;
}
...
export interface HostNameSslStateArgs {
     ...
     */
    hostType?: pulumi.Input<enums.web.v20180201.HostType>;
    /**
     * Hostname.
     */
    name?: pulumi.Input<string>;
...
export interface HttpLogsConfigArgs {
     ...
     * Http logs to azure blob storage configuration.
     */
    azureBlobStorage?: pulumi.Input<inputs.web.v20180201.AzureBlobStorageHttpLogsConfigArgs>;
    /**
     * Http logs to file system configuration.
     */
    fileSystem?: pulumi.Input<inputs.web.v20180201.FileSystemHttpLogsConfigArgs>;
}
...
export interface IpSecurityRestrictionArgs {
     ...
     */
    tag?: pulumi.Input<enums.web.v20180201.IpFilterTag>;
    /**
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.web.v20180201.ManagedServiceIdentityType>;
    /**
...
export interface NetworkAccessControlEntryArgs {
     ...
     * Action object.
     */
    action?: pulumi.Input<enums.web.v20180201.AccessControlEntryAction>;
    /**
...
export interface SiteConfigArgs {
     ...
     * Information about the formal API definition for the app.
     */
    apiDefinition?: pulumi.Input<inputs.web.v20180201.ApiDefinitionInfoArgs>;
    /**
     ...
     */
    appSettings?: pulumi.Input<pulumi.Input<inputs.web.v20180201.NameValuePairArgs>[]>;
    /**
     ...
     * Auto Heal rules.
     */
    autoHealRules?: pulumi.Input<inputs.web.v20180201.AutoHealRulesArgs>;
    /**
     * Auto-swap slot name.
     */
     ...
     */
    azureStorageAccounts?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20180201.AzureStorageInfoValueArgs>}>;
    /**
     * Connection strings.
     */
    connectionStrings?: pulumi.Input<pulumi.Input<inputs.web.v20180201.ConnStringInfoArgs>[]>;
    /**
     * Cross-Origin Resource Sharing (CORS) settings.
     */
    cors?: pulumi.Input<inputs.web.v20180201.CorsSettingsArgs>;
    /**
     * Default documents.
     */
     ...
     */
    experiments?: pulumi.Input<inputs.web.v20180201.ExperimentsArgs>;
    /**
     * State of FTP / FTPS service
     */
    ftpsState?: pulumi.Input<string | enums.web.v20180201.FtpsState>;
    /**
     * Handler mappings.
     */
    handlerMappings?: pulumi.Input<pulumi.Input<inputs.web.v20180201.HandlerMappingArgs>[]>;
    /**
     ...
     */
    ipSecurityRestrictions?: pulumi.Input<pulumi.Input<inputs.web.v20180201.IpSecurityRestrictionArgs>[]>;
    /**
     * Java container.
     */
     ...
     * Site limits.
     */
    limits?: pulumi.Input<inputs.web.v20180201.SiteLimitsArgs>;
    /**
     ...
     * Site load balancing.
     */
    loadBalancing?: pulumi.Input<enums.web.v20180201.SiteLoadBalancing>;
    /**
     ...
     */
    managedPipelineMode?: pulumi.Input<enums.web.v20180201.ManagedPipelineMode>;
    /**
     ...
     */
    minTlsVersion?: pulumi.Input<string | enums.web.v20180201.SupportedTlsVersions>;
    /**
     ...
     */
    push?: pulumi.Input<inputs.web.v20180201.PushSettingsArgs>;
    /**
     * Version of Python.
     */
     ...
     */
    scmIpSecurityRestrictions?: pulumi.Input<pulumi.Input<inputs.web.v20180201.IpSecurityRestrictionArgs>[]>;
    /**
     ...
     * SCM type.
     */
    scmType?: pulumi.Input<string | enums.web.v20180201.ScmType>;
    /**
     * Tracing options.
     */
     ...
     */
    virtualApplications?: pulumi.Input<pulumi.Input<inputs.web.v20180201.VirtualApplicationArgs>[]>;
    /**
...
export interface SkuDescriptionArgs {
     ...
     */
    capabilities?: pulumi.Input<pulumi.Input<inputs.web.v20180201.CapabilityArgs>[]>;
    /**
     ...
     */
    skuCapacity?: pulumi.Input<inputs.web.v20180201.SkuCapacityArgs>;
    /**
...
export interface VirtualApplicationArgs {
     ...
     */
    virtualDirectories?: pulumi.Input<pulumi.Input<inputs.web.v20180201.VirtualDirectoryArgs>[]>;
    /**
     * Virtual path.
     */
...
export interface WorkerPoolArgs {
     ...
     */
    computeMode?: pulumi.Input<enums.web.v20180201.ComputeModeOptions>;
    /**
