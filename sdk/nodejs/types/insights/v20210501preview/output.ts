...
export interface AutoscaleNotificationResponse {
     ...
     */
    email?: outputs.insights.v20210501preview.EmailNotificationResponse;
    /**
     ...
     */
    webhooks?: outputs.insights.v20210501preview.WebhookNotificationResponse[];
}
/**
...
export function autoscaleNotificationResponseProvideDefaults(val: AutoscaleNotificationResponse): AutoscaleNotificationResponse {
    return {
        ...val,
        email: (val.email ? outputs.insights.v20210501preview.emailNotificationResponseProvideDefaults(val.email) : undefined),
    };
}
...
export interface AutoscaleProfileResponse {
     ...
     */
    capacity: outputs.insights.v20210501preview.ScaleCapacityResponse;
    /**
     * the specific date-time for the profile. This element is not used if the Recurrence element is used.
     */
    fixedDate?: outputs.insights.v20210501preview.TimeWindowResponse;
    /**
     ...
     */
    recurrence?: outputs.insights.v20210501preview.RecurrenceResponse;
    /**
     * the collection of rules that provide the triggers and parameters for the scaling action. A maximum of 10 rules can be specified.
     */
    rules: outputs.insights.v20210501preview.ScaleRuleResponse[];
}
...
export interface LogSettingsResponse {
     ...
     */
    retentionPolicy?: outputs.insights.v20210501preview.RetentionPolicyResponse;
}
...
export interface MetricTriggerResponse {
     ...
     */
    dimensions?: outputs.insights.v20210501preview.ScaleRuleMetricDimensionResponse[];
    /**
...
export interface RecurrenceResponse {
     ...
     */
    schedule: outputs.insights.v20210501preview.RecurrentScheduleResponse;
}
...
export interface ScaleRuleResponse {
     ...
     * the trigger that results in a scaling action.
     */
    metricTrigger: outputs.insights.v20210501preview.MetricTriggerResponse;
    /**
     * the parameters for the scaling action.
     */
    scaleAction: outputs.insights.v20210501preview.ScaleActionResponse;
}
/**
...
export function scaleRuleResponseProvideDefaults(val: ScaleRuleResponse): ScaleRuleResponse {
    return {
        ...val,
        scaleAction: outputs.insights.v20210501preview.scaleActionResponseProvideDefaults(val.scaleAction),
    };
}
