...
export interface ConditionResponse {
     ...
     */
    dimensions?: outputs.insights.v20210201preview.DimensionResponse[];
    /**
     * The minimum number of violations required within the selected lookback time window required to raise an alert. Relevant only for rules of the kind LogAlert.
     */
    failingPeriods?: outputs.insights.v20210201preview.ConditionResponseFailingPeriods;
    /**
...
export function conditionResponseProvideDefaults(val: ConditionResponse): ConditionResponse {
    return {
        ...val,
        failingPeriods: (val.failingPeriods ? outputs.insights.v20210201preview.conditionResponseFailingPeriodsProvideDefaults(val.failingPeriods) : undefined),
    };
}
...
export interface ScheduledQueryRuleCriteriaResponse {
     ...
     */
    allOf?: outputs.insights.v20210201preview.ConditionResponse[];
}
