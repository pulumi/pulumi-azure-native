...
export interface AutoscaleNotificationArgs {
     ...
     */
    email?: pulumi.Input<inputs.insights.v20221001.EmailNotificationArgs>;
    /**
     * the operation associated with the notification and its value must be "scale"
     */
    operation: pulumi.Input<enums.insights.v20221001.OperationType>;
    /**
     * the collection of webhook notifications.
     */
    webhooks?: pulumi.Input<pulumi.Input<inputs.insights.v20221001.WebhookNotificationArgs>[]>;
}
/**
...
export function autoscaleNotificationArgsProvideDefaults(val: AutoscaleNotificationArgs): AutoscaleNotificationArgs {
    return {
        ...val,
        email: (val.email ? pulumi.output(val.email).apply(inputs.insights.v20221001.emailNotificationArgsProvideDefaults) : undefined),
    };
}
...
export interface AutoscaleProfileArgs {
     ...
     */
    capacity: pulumi.Input<inputs.insights.v20221001.ScaleCapacityArgs>;
    /**
     * the specific date-time for the profile. This element is not used if the Recurrence element is used.
     */
    fixedDate?: pulumi.Input<inputs.insights.v20221001.TimeWindowArgs>;
    /**
     ...
     */
    recurrence?: pulumi.Input<inputs.insights.v20221001.RecurrenceArgs>;
    /**
     * the collection of rules that provide the triggers and parameters for the scaling action. A maximum of 10 rules can be specified.
     */
    rules: pulumi.Input<pulumi.Input<inputs.insights.v20221001.ScaleRuleArgs>[]>;
}
...
export interface MetricTriggerArgs {
     ...
     */
    dimensions?: pulumi.Input<pulumi.Input<inputs.insights.v20221001.ScaleRuleMetricDimensionArgs>[]>;
    /**
     ...
     */
    operator: pulumi.Input<enums.insights.v20221001.ComparisonOperationType>;
    /**
     * the metric statistic type. How the metrics from multiple instances are combined.
     */
    statistic: pulumi.Input<enums.insights.v20221001.MetricStatisticType>;
    /**
     ...
     */
    timeAggregation: pulumi.Input<enums.insights.v20221001.TimeAggregationType>;
    /**
...
export interface PredictiveAutoscalePolicyArgs {
     ...
     */
    scaleMode: pulumi.Input<enums.insights.v20221001.PredictiveAutoscalePolicyScaleMode>;
}
...
export interface RecurrenceArgs {
     ...
     */
    frequency: pulumi.Input<enums.insights.v20221001.RecurrenceFrequency>;
    /**
     * the scheduling constraints for when the profile begins.
     */
    schedule: pulumi.Input<inputs.insights.v20221001.RecurrentScheduleArgs>;
}
...
export interface ScaleActionArgs {
     ...
     */
    direction: pulumi.Input<enums.insights.v20221001.ScaleDirection>;
    /**
     * the type of action that should occur when the scale rule fires.
     */
    type: pulumi.Input<enums.insights.v20221001.ScaleType>;
    /**
...
export interface ScaleRuleArgs {
     ...
     * the trigger that results in a scaling action.
     */
    metricTrigger: pulumi.Input<inputs.insights.v20221001.MetricTriggerArgs>;
    /**
     * the parameters for the scaling action.
     */
    scaleAction: pulumi.Input<inputs.insights.v20221001.ScaleActionArgs>;
}
/**
...
export function scaleRuleArgsProvideDefaults(val: ScaleRuleArgs): ScaleRuleArgs {
    return {
        ...val,
        scaleAction: pulumi.output(val.scaleAction).apply(inputs.insights.v20221001.scaleActionArgsProvideDefaults),
    };
}
...
export interface ScaleRuleMetricDimensionArgs {
     ...
     */
    operator: pulumi.Input<string | enums.insights.v20221001.ScaleRuleMetricDimensionOperationType>;
    /**
