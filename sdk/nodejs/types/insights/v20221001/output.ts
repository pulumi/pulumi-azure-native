...
export interface AutoscaleNotificationResponse {
     ...
     */
    email?: outputs.insights.v20221001.EmailNotificationResponse;
    /**
     ...
     */
    webhooks?: outputs.insights.v20221001.WebhookNotificationResponse[];
}
/**
...
export function autoscaleNotificationResponseProvideDefaults(val: AutoscaleNotificationResponse): AutoscaleNotificationResponse {
    return {
        ...val,
        email: (val.email ? outputs.insights.v20221001.emailNotificationResponseProvideDefaults(val.email) : undefined),
    };
}
...
export interface AutoscaleProfileResponse {
     ...
     */
    capacity: outputs.insights.v20221001.ScaleCapacityResponse;
    /**
     * the specific date-time for the profile. This element is not used if the Recurrence element is used.
     */
    fixedDate?: outputs.insights.v20221001.TimeWindowResponse;
    /**
     ...
     */
    recurrence?: outputs.insights.v20221001.RecurrenceResponse;
    /**
     * the collection of rules that provide the triggers and parameters for the scaling action. A maximum of 10 rules can be specified.
     */
    rules: outputs.insights.v20221001.ScaleRuleResponse[];
}
...
export interface MetricTriggerResponse {
     ...
     */
    dimensions?: outputs.insights.v20221001.ScaleRuleMetricDimensionResponse[];
    /**
...
export interface RecurrenceResponse {
     ...
     */
    schedule: outputs.insights.v20221001.RecurrentScheduleResponse;
}
...
export interface ScaleRuleResponse {
     ...
     * the trigger that results in a scaling action.
     */
    metricTrigger: outputs.insights.v20221001.MetricTriggerResponse;
    /**
     * the parameters for the scaling action.
     */
    scaleAction: outputs.insights.v20221001.ScaleActionResponse;
}
/**
...
export function scaleRuleResponseProvideDefaults(val: ScaleRuleResponse): ScaleRuleResponse {
    return {
        ...val,
        scaleAction: outputs.insights.v20221001.scaleActionResponseProvideDefaults(val.scaleAction),
    };
}
