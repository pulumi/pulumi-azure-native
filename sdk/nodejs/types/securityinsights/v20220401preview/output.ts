...
export interface AlertsDataTypeOfDataConnectorResponse {
     ...
     */
    alerts: outputs.securityinsights.v20220401preview.DataConnectorDataTypeCommonResponse;
}
...
export interface AutomationRuleModifyPropertiesActionResponse {
    actionConfiguration?: outputs.securityinsights.v20220401preview.IncidentPropertiesActionResponse;
    /**
...
export interface AutomationRuleRunPlaybookActionResponse {
    actionConfiguration?: outputs.securityinsights.v20220401preview.PlaybookActionPropertiesResponse;
    /**
     * The type of the automation rule action
...
export interface AutomationRuleTriggeringLogicResponse {
     ...
     */
    conditions?: outputs.securityinsights.v20220401preview.PropertyConditionPropertiesResponse[];
    /**
...
export interface AwsCloudTrailDataConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20220401preview.AwsCloudTrailDataConnectorDataTypesResponseLogs;
}
...
export interface AwsS3DataConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20220401preview.AwsS3DataConnectorDataTypesResponseLogs;
}
...
export interface BookmarkEntityMappingsResponse {
     ...
     */
    fieldMappings?: outputs.securityinsights.v20220401preview.EntityFieldMappingResponse[];
}
...
export interface BookmarkTimelineItemResponse {
     ...
     */
    createdBy?: outputs.securityinsights.v20220401preview.UserInfoResponse;
    /**
...
export interface CodelessConnectorPollingConfigPropertiesResponse {
     ...
     */
    auth: outputs.securityinsights.v20220401preview.CodelessConnectorPollingAuthPropertiesResponse;
    /**
     ...
     */
    paging?: outputs.securityinsights.v20220401preview.CodelessConnectorPollingPagingPropertiesResponse;
    /**
     * Describe the poll request config parameters of the poller
     */
    request: outputs.securityinsights.v20220401preview.CodelessConnectorPollingRequestPropertiesResponse;
    /**
     * Describe the response config parameters of the poller
     */
    response?: outputs.securityinsights.v20220401preview.CodelessConnectorPollingResponsePropertiesResponse;
}
...
export interface CodelessUiConnectorConfigPropertiesResponse {
     ...
     * Connector Availability Status
     */
    availability: outputs.securityinsights.v20220401preview.AvailabilityResponse;
    /**
     * Define the way the connector check connectivity
     */
    connectivityCriteria: outputs.securityinsights.v20220401preview.CodelessUiConnectorConfigPropertiesResponseConnectivityCriteria[];
    /**
     ...
     */
    dataTypes: outputs.securityinsights.v20220401preview.CodelessUiConnectorConfigPropertiesResponseDataTypes[];
    /**
     ...
     */
    graphQueries: outputs.securityinsights.v20220401preview.CodelessUiConnectorConfigPropertiesResponseGraphQueries[];
    /**
     ...
     */
    instructionSteps: outputs.securityinsights.v20220401preview.CodelessUiConnectorConfigPropertiesResponseInstructionSteps[];
    /**
     * Permissions required for the connector
     */
    permissions: outputs.securityinsights.v20220401preview.PermissionsResponse;
    /**
     ...
     */
    sampleQueries: outputs.securityinsights.v20220401preview.CodelessUiConnectorConfigPropertiesResponseSampleQueries[];
    /**
...
export interface CodelessUiConnectorConfigPropertiesResponseInstructionSteps {
     ...
     */
    instructions?: outputs.securityinsights.v20220401preview.InstructionStepsResponseInstructions[];
    /**
...
export interface DeploymentInfoResponse {
     ...
     */
    deployment?: outputs.securityinsights.v20220401preview.DeploymentResponse;
    /**
...
export interface Dynamics365DataConnectorDataTypesResponse {
     ...
     */
    dynamics365CdsActivities: outputs.securityinsights.v20220401preview.Dynamics365DataConnectorDataTypesResponseDynamics365CdsActivities;
}
...
export interface EntityInsightItemResponse {
     ...
     */
    chartQueryResults?: outputs.securityinsights.v20220401preview.InsightsTableResultResponse[];
    /**
     ...
     */
    queryTimeInterval?: outputs.securityinsights.v20220401preview.EntityInsightItemResponseQueryTimeInterval;
    /**
     * Query results for table insights query.
     */
    tableQueryResults?: outputs.securityinsights.v20220401preview.InsightsTableResultResponse;
}
...
export interface EntityMappingResponse {
     ...
     */
    fieldMappings?: outputs.securityinsights.v20220401preview.FieldMappingResponse[];
}
...
export interface FusionSourceSettingsResponse {
     ...
     */
    sourceSubTypes?: outputs.securityinsights.v20220401preview.FusionSourceSubTypeSettingResponse[];
}
...
export interface FusionSourceSubTypeSettingResponse {
     ...
     */
    severityFilters: outputs.securityinsights.v20220401preview.FusionSubTypeSeverityFilterResponse;
    /**
...
export interface FusionSubTypeSeverityFilterResponse {
     ...
     */
    filters?: outputs.securityinsights.v20220401preview.FusionSubTypeSeverityFiltersItemResponse[];
    /**
...
export interface GetInsightsResultsMetadataResponse {
     ...
     */
    errors?: outputs.securityinsights.v20220401preview.GetInsightsErrorResponse[];
    /**
...
export interface IncidentConfigurationResponse {
     ...
     */
    groupingConfiguration?: outputs.securityinsights.v20220401preview.GroupingConfigurationResponse;
}
...
export interface IncidentPropertiesActionResponse {
     ...
     */
    labels?: outputs.securityinsights.v20220401preview.IncidentLabelResponse[];
    /**
     * Information on the user an incident is assigned to
     */
    owner?: outputs.securityinsights.v20220401preview.IncidentOwnerInfoResponse;
    /**
     * The severity of the incident
     */
    severity?: string;
...
export interface InsightsTableResultResponse {
     ...
     */
    columns?: outputs.securityinsights.v20220401preview.InsightsTableResultResponseColumns[];
    /**
...
export interface MCASDataConnectorDataTypesResponse {
     ...
     */
    discoveryLogs?: outputs.securityinsights.v20220401preview.DataConnectorDataTypeCommonResponse;
}
...
export interface MSTIDataConnectorDataTypesResponse {
     ...
     */
    bingSafetyPhishingURL: outputs.securityinsights.v20220401preview.MSTIDataConnectorDataTypesResponseBingSafetyPhishingURL;
    /**
     * Data type for Microsoft Threat Intelligence Platforms data connector.
     */
    microsoftEmergingThreatFeed: outputs.securityinsights.v20220401preview.MSTIDataConnectorDataTypesResponseMicrosoftEmergingThreatFeed;
}
...
export interface MTPDataConnectorDataTypesResponse {
     ...
     */
    incidents: outputs.securityinsights.v20220401preview.MTPDataConnectorDataTypesResponseIncidents;
}
...
export interface MetadataDependenciesResponse {
     ...
     */
    criteria?: outputs.securityinsights.v20220401preview.MetadataDependenciesResponse[];
    /**
...
export interface Office365ProjectConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20220401preview.Office365ProjectConnectorDataTypesResponseLogs;
}
...
export interface OfficeDataConnectorDataTypesResponse {
     ...
     */
    exchange: outputs.securityinsights.v20220401preview.OfficeDataConnectorDataTypesResponseExchange;
    /**
     * SharePoint data type connection.
     */
    sharePoint: outputs.securityinsights.v20220401preview.OfficeDataConnectorDataTypesResponseSharePoint;
    /**
     * Teams data type connection.
     */
    teams: outputs.securityinsights.v20220401preview.OfficeDataConnectorDataTypesResponseTeams;
}
...
export interface OfficePowerBIConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20220401preview.OfficePowerBIConnectorDataTypesResponseLogs;
}
...
export interface PermissionsResponse {
     ...
     */
    customs?: outputs.securityinsights.v20220401preview.PermissionsResponseCustoms[];
    /**
     * Resource provider permissions required for the connector
     */
    resourceProvider?: outputs.securityinsights.v20220401preview.PermissionsResponseResourceProvider[];
}
...
export interface PermissionsResponseResourceProvider {
     ...
     */
    requiredPermissions?: outputs.securityinsights.v20220401preview.RequiredPermissionsResponse;
    /**
...
export interface PropertyConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20220401preview.AutomationRulePropertyValuesConditionResponse;
    /**
     *
...
export interface RepositoryResourceInfoResponse {
     ...
     */
    azureDevOpsResourceInfo?: outputs.securityinsights.v20220401preview.AzureDevOpsResourceInfoResponse;
    /**
     * Resources created in GitHub for this source-control.
     */
    gitHubResourceInfo?: outputs.securityinsights.v20220401preview.GitHubResourceInfoResponse;
    /**
     * The webhook object created for the source-control.
     */
    webhook?: outputs.securityinsights.v20220401preview.WebhookResponse;
}
...
export interface RepositoryResponse {
     ...
     */
    pathMapping?: outputs.securityinsights.v20220401preview.ContentPathMapResponse[];
    /**
     * Url of repository.
     */
    url?: string;
...
export interface TIDataConnectorDataTypesResponse {
     ...
     */
    indicators: outputs.securityinsights.v20220401preview.TIDataConnectorDataTypesResponseIndicators;
}
...
export interface TiTaxiiDataConnectorDataTypesResponse {
     ...
     */
    taxiiClient: outputs.securityinsights.v20220401preview.TiTaxiiDataConnectorDataTypesResponseTaxiiClient;
}
...
export interface TimelineResultsMetadataResponse {
     ...
     */
    aggregations: outputs.securityinsights.v20220401preview.TimelineAggregationResponse[];
    /**
