...
export interface AlertsDataTypeOfDataConnectorArgs {
     ...
     */
    alerts: pulumi.Input<inputs.securityinsights.v20220101preview.DataConnectorDataTypeCommonArgs>;
}
...
export interface AutomationRuleModifyPropertiesActionArgs {
    actionConfiguration?: pulumi.Input<inputs.securityinsights.v20220101preview.IncidentPropertiesActionArgs>;
    /**
...
export interface AutomationRulePropertyValuesConditionArgs {
    operator?: pulumi.Input<string | enums.securityinsights.v20220101preview.AutomationRulePropertyConditionSupportedOperator>;
    /**
     * The property to evaluate in an automation rule property condition
     */
    propertyName?: pulumi.Input<string | enums.securityinsights.v20220101preview.AutomationRulePropertyConditionSupportedProperty>;
...
export interface AutomationRuleRunPlaybookActionArgs {
    actionConfiguration?: pulumi.Input<inputs.securityinsights.v20220101preview.PlaybookActionPropertiesArgs>;
    /**
     * The type of the automation rule action
...
export interface AutomationRuleTriggeringLogicArgs {
     ...
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.PropertyConditionPropertiesArgs>[]>;
    /**
    ...
    triggersOn: pulumi.Input<string | enums.securityinsights.v20220101preview.TriggersOn>;
    triggersWhen: pulumi.Input<string | enums.securityinsights.v20220101preview.TriggersWhen>;
}
...
export interface AwsCloudTrailDataConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20220101preview.AwsCloudTrailDataConnectorDataTypesLogsArgs>;
}
...
export interface AwsCloudTrailDataConnectorDataTypesLogsArgs {
     ...
     */
    state: pulumi.Input<string | enums.securityinsights.v20220101preview.DataTypeState>;
}
...
export interface AwsS3DataConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20220101preview.AwsS3DataConnectorDataTypesLogsArgs>;
}
...
export interface BookmarkEntityMappingsArgs {
     ...
     */
    fieldMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.EntityFieldMappingArgs>[]>;
}
...
export interface CodelessConnectorPollingConfigPropertiesArgs {
     ...
     */
    auth: pulumi.Input<inputs.securityinsights.v20220101preview.CodelessConnectorPollingAuthPropertiesArgs>;
    /**
     ...
     */
    paging?: pulumi.Input<inputs.securityinsights.v20220101preview.CodelessConnectorPollingPagingPropertiesArgs>;
    /**
     * Describe the poll request config parameters of the poller
     */
    request: pulumi.Input<inputs.securityinsights.v20220101preview.CodelessConnectorPollingRequestPropertiesArgs>;
    /**
     * Describe the response config parameters of the poller
     */
    response?: pulumi.Input<inputs.securityinsights.v20220101preview.CodelessConnectorPollingResponsePropertiesArgs>;
}
...
export interface CodelessUiConnectorConfigPropertiesArgs {
     ...
     * Connector Availability Status
     */
    availability: pulumi.Input<inputs.securityinsights.v20220101preview.AvailabilityArgs>;
    /**
     * Define the way the connector check connectivity
     */
    connectivityCriteria: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.CodelessUiConnectorConfigPropertiesConnectivityCriteriaArgs>[]>;
    /**
     ...
     */
    dataTypes: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.CodelessUiConnectorConfigPropertiesDataTypesArgs>[]>;
    /**
     ...
     */
    graphQueries: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.CodelessUiConnectorConfigPropertiesGraphQueriesArgs>[]>;
    /**
     ...
     */
    instructionSteps: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.CodelessUiConnectorConfigPropertiesInstructionStepsArgs>[]>;
    /**
     * Permissions required for the connector
     */
    permissions: pulumi.Input<inputs.securityinsights.v20220101preview.PermissionsArgs>;
    /**
     ...
     */
    sampleQueries: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.CodelessUiConnectorConfigPropertiesSampleQueriesArgs>[]>;
    /**
...
export interface CodelessUiConnectorConfigPropertiesConnectivityCriteriaArgs {
     ...
     */
    type?: pulumi.Input<string | enums.securityinsights.v20220101preview.ConnectivityType>;
    /**
...
export interface CodelessUiConnectorConfigPropertiesInstructionStepsArgs {
     ...
     */
    instructions?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.InstructionStepsInstructionsArgs>[]>;
    /**
...
export interface ContentPathMapArgs {
     ...
     * Content type.
     */
    contentType?: pulumi.Input<string | enums.securityinsights.v20220101preview.ContentType>;
    /**
...
export interface DeploymentArgs {
     ...
     */
    deploymentResult?: pulumi.Input<string | enums.securityinsights.v20220101preview.DeploymentResult>;
    /**
     * Current status of the deployment.
     */
    deploymentState?: pulumi.Input<string | enums.securityinsights.v20220101preview.DeploymentState>;
    /**
...
export interface DeploymentInfoArgs {
     ...
     */
    deployment?: pulumi.Input<inputs.securityinsights.v20220101preview.DeploymentArgs>;
    /**
     * Status while fetching the last deployment.
     */
    deploymentFetchStatus?: pulumi.Input<string | enums.securityinsights.v20220101preview.DeploymentFetchStatus>;
    /**
...
export interface Dynamics365DataConnectorDataTypesArgs {
     ...
     */
    dynamics365CdsActivities: pulumi.Input<inputs.securityinsights.v20220101preview.Dynamics365DataConnectorDataTypesDynamics365CdsActivitiesArgs>;
}
...
export interface EntityMappingArgs {
     ...
     */
    entityType?: pulumi.Input<string | enums.securityinsights.v20220101preview.EntityMappingType>;
    /**
     * array of field mappings for the given entity mapping
     */
    fieldMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.FieldMappingArgs>[]>;
}
...
export interface EventGroupingSettingsArgs {
     ...
     */
    aggregationKind?: pulumi.Input<string | enums.securityinsights.v20220101preview.EventGroupingAggregationKind>;
}
...
export interface FusionSourceSettingsArgs {
     ...
     */
    sourceSubTypes?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.FusionSourceSubTypeSettingArgs>[]>;
}
...
export interface FusionSourceSubTypeSettingArgs {
     ...
     */
    severityFilters: pulumi.Input<inputs.securityinsights.v20220101preview.FusionSubTypeSeverityFilterArgs>;
    /**
...
export interface FusionSubTypeSeverityFilterArgs {
     ...
     */
    filters?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.FusionSubTypeSeverityFiltersItemArgs>[]>;
}
...
export interface GroupingConfigurationArgs {
     ...
     */
    groupByAlertDetails?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20220101preview.AlertDetail>[]>;
    /**
     ...
     */
    groupByEntities?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20220101preview.EntityMappingType>[]>;
    /**
     ...
     */
    matchingMethod: pulumi.Input<string | enums.securityinsights.v20220101preview.MatchingMethod>;
    /**
...
export interface IncidentConfigurationArgs {
     ...
     */
    groupingConfiguration?: pulumi.Input<inputs.securityinsights.v20220101preview.GroupingConfigurationArgs>;
}
...
export interface InstructionStepsInstructionsArgs {
     ...
     */
    type: pulumi.Input<string | enums.securityinsights.v20220101preview.SettingType>;
}
...
export interface MCASDataConnectorDataTypesArgs {
     ...
     */
    discoveryLogs?: pulumi.Input<inputs.securityinsights.v20220101preview.DataConnectorDataTypeCommonArgs>;
}
...
export interface MSTIDataConnectorDataTypesArgs {
     ...
     */
    bingSafetyPhishingURL: pulumi.Input<inputs.securityinsights.v20220101preview.MSTIDataConnectorDataTypesBingSafetyPhishingURLArgs>;
    /**
     * Data type for Microsoft Threat Intelligence Platforms data connector.
     */
    microsoftEmergingThreatFeed: pulumi.Input<inputs.securityinsights.v20220101preview.MSTIDataConnectorDataTypesMicrosoftEmergingThreatFeedArgs>;
}
...
export interface MTPDataConnectorDataTypesArgs {
     ...
     */
    incidents: pulumi.Input<inputs.securityinsights.v20220101preview.MTPDataConnectorDataTypesIncidentsArgs>;
}
...
export interface MetadataDependenciesArgs {
     ...
     */
    criteria?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.MetadataDependenciesArgs>[]>;
    /**
     ...
     */
    operator?: pulumi.Input<string | enums.securityinsights.v20220101preview.Operator>;
    /**
...
export interface MetadataSourceArgs {
     ...
     */
    kind: pulumi.Input<string | enums.securityinsights.v20220101preview.SourceKind>;
    /**
...
export interface MetadataSupportArgs {
     ...
     */
    tier: pulumi.Input<string | enums.securityinsights.v20220101preview.SupportTier>;
}
...
export interface Office365ProjectConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20220101preview.Office365ProjectConnectorDataTypesLogsArgs>;
}
...
export interface OfficeDataConnectorDataTypesArgs {
     ...
     */
    exchange: pulumi.Input<inputs.securityinsights.v20220101preview.OfficeDataConnectorDataTypesExchangeArgs>;
    /**
     * SharePoint data type connection.
     */
    sharePoint: pulumi.Input<inputs.securityinsights.v20220101preview.OfficeDataConnectorDataTypesSharePointArgs>;
    /**
     * Teams data type connection.
     */
    teams: pulumi.Input<inputs.securityinsights.v20220101preview.OfficeDataConnectorDataTypesTeamsArgs>;
}
...
export interface OfficePowerBIConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20220101preview.OfficePowerBIConnectorDataTypesLogsArgs>;
}
...
export interface PermissionsArgs {
     ...
     */
    customs?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.PermissionsCustomsArgs>[]>;
    /**
     * Resource provider permissions required for the connector
     */
    resourceProvider?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.PermissionsResourceProviderArgs>[]>;
}
...
export interface PermissionsResourceProviderArgs {
     ...
     * Provider name
     */
    provider?: pulumi.Input<string | enums.securityinsights.v20220101preview.ProviderName>;
    /**
     ...
     */
    requiredPermissions?: pulumi.Input<inputs.securityinsights.v20220101preview.RequiredPermissionsArgs>;
    /**
     * Permission provider scope
     */
    scope?: pulumi.Input<string | enums.securityinsights.v20220101preview.PermissionProviderScope>;
}
...
export interface PropertyConditionPropertiesArgs {
    conditionProperties?: pulumi.Input<inputs.securityinsights.v20220101preview.AutomationRulePropertyValuesConditionArgs>;
    /**
     *
...
export interface RepositoryArgs {
     ...
     */
    pathMapping?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.ContentPathMapArgs>[]>;
    /**
     * Url of repository.
     */
...
export interface RepositoryResourceInfoArgs {
     ...
     */
    azureDevOpsResourceInfo?: pulumi.Input<inputs.securityinsights.v20220101preview.AzureDevOpsResourceInfoArgs>;
    /**
     * Resources created in GitHub for this source-control.
     */
    gitHubResourceInfo?: pulumi.Input<inputs.securityinsights.v20220101preview.GitHubResourceInfoArgs>;
    /**
     * The webhook object created for the source-control.
     */
    webhook?: pulumi.Input<inputs.securityinsights.v20220101preview.WebhookArgs>;
}
...
export interface TIDataConnectorDataTypesArgs {
     ...
     */
    indicators: pulumi.Input<inputs.securityinsights.v20220101preview.TIDataConnectorDataTypesIndicatorsArgs>;
}
...
export interface ThreatIntelligenceParsedPatternArgs {
     ...
     * Pattern type keys
     */
    patternTypeValues?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220101preview.ThreatIntelligenceParsedPatternTypeValueArgs>[]>;
}
...
export interface TiTaxiiDataConnectorDataTypesArgs {
     ...
     */
    taxiiClient: pulumi.Input<inputs.securityinsights.v20220101preview.TiTaxiiDataConnectorDataTypesTaxiiClientArgs>;
}
