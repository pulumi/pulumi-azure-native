...
export interface AlertsDataTypeOfDataConnectorResponse {
     ...
     */
    alerts: outputs.securityinsights.v20220901preview.DataConnectorDataTypeCommonResponse;
}
...
export interface AutomationRuleBooleanConditionResponse {
    innerConditions?: (outputs.securityinsights.v20220901preview.BooleanConditionPropertiesResponse | outputs.securityinsights.v20220901preview.PropertyArrayChangedConditionPropertiesResponse | outputs.securityinsights.v20220901preview.PropertyArrayConditionPropertiesResponse | outputs.securityinsights.v20220901preview.PropertyChangedConditionPropertiesResponse | outputs.securityinsights.v20220901preview.PropertyConditionPropertiesResponse)[];
    operator?: string;
}
...
export interface AutomationRuleModifyPropertiesActionResponse {
    actionConfiguration?: outputs.securityinsights.v20220901preview.IncidentPropertiesActionResponse;
    /**
...
export interface AutomationRulePropertyArrayValuesConditionResponse {
    ...
    arrayType?: string;
    itemConditions?: (outputs.securityinsights.v20220901preview.BooleanConditionPropertiesResponse | outputs.securityinsights.v20220901preview.PropertyArrayChangedConditionPropertiesResponse | outputs.securityinsights.v20220901preview.PropertyArrayConditionPropertiesResponse | outputs.securityinsights.v20220901preview.PropertyChangedConditionPropertiesResponse | outputs.securityinsights.v20220901preview.PropertyConditionPropertiesResponse)[];
}
...
export interface AutomationRuleRunPlaybookActionResponse {
    actionConfiguration?: outputs.securityinsights.v20220901preview.PlaybookActionPropertiesResponse;
    /**
     * The type of the automation rule action.
...
export interface AutomationRuleTriggeringLogicResponse {
     ...
     */
    conditions?: (outputs.securityinsights.v20220901preview.BooleanConditionPropertiesResponse | outputs.securityinsights.v20220901preview.PropertyArrayChangedConditionPropertiesResponse | outputs.securityinsights.v20220901preview.PropertyArrayConditionPropertiesResponse | outputs.securityinsights.v20220901preview.PropertyChangedConditionPropertiesResponse | outputs.securityinsights.v20220901preview.PropertyConditionPropertiesResponse)[];
    /**
...
export interface AwsCloudTrailDataConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20220901preview.AwsCloudTrailDataConnectorDataTypesResponseLogs;
}
...
export interface AwsS3DataConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20220901preview.AwsS3DataConnectorDataTypesResponseLogs;
}
...
export interface BookmarkEntityMappingsResponse {
     ...
     */
    fieldMappings?: outputs.securityinsights.v20220901preview.EntityFieldMappingResponse[];
}
...
export interface BookmarkTimelineItemResponse {
     ...
     */
    createdBy?: outputs.securityinsights.v20220901preview.UserInfoResponse;
    /**
...
export interface BooleanConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20220901preview.AutomationRuleBooleanConditionResponse;
    /**
     *
...
export interface CodelessConnectorPollingConfigPropertiesResponse {
     ...
     */
    auth: outputs.securityinsights.v20220901preview.CodelessConnectorPollingAuthPropertiesResponse;
    /**
     ...
     */
    paging?: outputs.securityinsights.v20220901preview.CodelessConnectorPollingPagingPropertiesResponse;
    /**
     * Describe the poll request config parameters of the poller
     */
    request: outputs.securityinsights.v20220901preview.CodelessConnectorPollingRequestPropertiesResponse;
    /**
     * Describe the response config parameters of the poller
     */
    response?: outputs.securityinsights.v20220901preview.CodelessConnectorPollingResponsePropertiesResponse;
}
...
export interface CodelessUiConnectorConfigPropertiesResponse {
     ...
     * Connector Availability Status
     */
    availability: outputs.securityinsights.v20220901preview.AvailabilityResponse;
    /**
     * Define the way the connector check connectivity
     */
    connectivityCriteria: outputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesResponseConnectivityCriteria[];
    /**
     ...
     */
    dataTypes: outputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesResponseDataTypes[];
    /**
     ...
     */
    graphQueries: outputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesResponseGraphQueries[];
    /**
     ...
     */
    instructionSteps: outputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesResponseInstructionSteps[];
    /**
     * Permissions required for the connector
     */
    permissions: outputs.securityinsights.v20220901preview.PermissionsResponse;
    /**
     ...
     */
    sampleQueries: outputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesResponseSampleQueries[];
    /**
...
export interface CodelessUiConnectorConfigPropertiesResponseInstructionSteps {
     ...
     */
    instructions?: outputs.securityinsights.v20220901preview.InstructionStepsResponseInstructions[];
    /**
...
export interface DeploymentInfoResponse {
     ...
     */
    deployment?: outputs.securityinsights.v20220901preview.DeploymentResponse;
    /**
...
export interface Dynamics365DataConnectorDataTypesResponse {
     ...
     */
    dynamics365CdsActivities: outputs.securityinsights.v20220901preview.Dynamics365DataConnectorDataTypesResponseDynamics365CdsActivities;
}
...
export interface EntityInsightItemResponse {
     ...
     */
    chartQueryResults?: outputs.securityinsights.v20220901preview.InsightsTableResultResponse[];
    /**
     ...
     */
    queryTimeInterval?: outputs.securityinsights.v20220901preview.EntityInsightItemResponseQueryTimeInterval;
    /**
     * Query results for table insights query.
     */
    tableQueryResults?: outputs.securityinsights.v20220901preview.InsightsTableResultResponse;
}
...
export interface EntityMappingResponse {
     ...
     */
    fieldMappings?: outputs.securityinsights.v20220901preview.FieldMappingResponse[];
}
...
export interface FusionSourceSettingsResponse {
     ...
     */
    sourceSubTypes?: outputs.securityinsights.v20220901preview.FusionSourceSubTypeSettingResponse[];
}
...
export interface FusionSourceSubTypeSettingResponse {
     ...
     */
    severityFilters: outputs.securityinsights.v20220901preview.FusionSubTypeSeverityFilterResponse;
    /**
...
export interface FusionSubTypeSeverityFilterResponse {
     ...
     */
    filters?: outputs.securityinsights.v20220901preview.FusionSubTypeSeverityFiltersItemResponse[];
    /**
...
export interface GetInsightsResultsMetadataResponse {
     ...
     */
    errors?: outputs.securityinsights.v20220901preview.GetInsightsErrorKindResponse[];
    /**
...
export interface IncidentConfigurationResponse {
     ...
     */
    groupingConfiguration?: outputs.securityinsights.v20220901preview.GroupingConfigurationResponse;
}
...
export interface IncidentPropertiesActionResponse {
     ...
     */
    labels?: outputs.securityinsights.v20220901preview.IncidentLabelResponse[];
    /**
     * Information on the user an incident is assigned to
     */
    owner?: outputs.securityinsights.v20220901preview.IncidentOwnerInfoResponse;
    /**
     * The severity of the incident
     */
    severity?: string;
...
export interface InsightsTableResultResponse {
     ...
     */
    columns?: outputs.securityinsights.v20220901preview.InsightsTableResultResponseColumns[];
    /**
...
export interface MCASDataConnectorDataTypesResponse {
     ...
     */
    discoveryLogs?: outputs.securityinsights.v20220901preview.DataConnectorDataTypeCommonResponse;
}
...
export interface MSTIDataConnectorDataTypesResponse {
     ...
     */
    bingSafetyPhishingURL: outputs.securityinsights.v20220901preview.MSTIDataConnectorDataTypesResponseBingSafetyPhishingURL;
    /**
     * Data type for Microsoft Threat Intelligence Platforms data connector.
     */
    microsoftEmergingThreatFeed: outputs.securityinsights.v20220901preview.MSTIDataConnectorDataTypesResponseMicrosoftEmergingThreatFeed;
}
...
export interface MTPDataConnectorDataTypesResponse {
     ...
     */
    incidents: outputs.securityinsights.v20220901preview.MTPDataConnectorDataTypesResponseIncidents;
}
...
export interface MetadataDependenciesResponse {
     ...
     */
    criteria?: outputs.securityinsights.v20220901preview.MetadataDependenciesResponse[];
    /**
...
export interface Office365ProjectConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20220901preview.Office365ProjectConnectorDataTypesResponseLogs;
}
...
export interface OfficeDataConnectorDataTypesResponse {
     ...
     */
    exchange: outputs.securityinsights.v20220901preview.OfficeDataConnectorDataTypesResponseExchange;
    /**
     * SharePoint data type connection.
     */
    sharePoint: outputs.securityinsights.v20220901preview.OfficeDataConnectorDataTypesResponseSharePoint;
    /**
     * Teams data type connection.
     */
    teams: outputs.securityinsights.v20220901preview.OfficeDataConnectorDataTypesResponseTeams;
}
...
export interface OfficePowerBIConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20220901preview.OfficePowerBIConnectorDataTypesResponseLogs;
}
...
export interface PermissionsResponse {
     ...
     */
    customs?: outputs.securityinsights.v20220901preview.PermissionsResponseCustoms[];
    /**
     * Resource provider permissions required for the connector
     */
    resourceProvider?: outputs.securityinsights.v20220901preview.PermissionsResponseResourceProvider[];
}
...
export interface PermissionsResponseResourceProvider {
     ...
     */
    requiredPermissions?: outputs.securityinsights.v20220901preview.RequiredPermissionsResponse;
    /**
...
export interface PropertyArrayChangedConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20220901preview.AutomationRulePropertyArrayChangedValuesConditionResponse;
    /**
     *
...
export interface PropertyArrayConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20220901preview.AutomationRulePropertyArrayValuesConditionResponse;
    /**
     *
...
export interface PropertyChangedConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20220901preview.AutomationRulePropertyValuesChangedConditionResponse;
    /**
     *
...
export interface PropertyConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20220901preview.AutomationRulePropertyValuesConditionResponse;
    /**
     *
...
export interface RepositoryResourceInfoResponse {
     ...
     */
    azureDevOpsResourceInfo?: outputs.securityinsights.v20220901preview.AzureDevOpsResourceInfoResponse;
    /**
     * Resources created in GitHub for this source-control.
     */
    gitHubResourceInfo?: outputs.securityinsights.v20220901preview.GitHubResourceInfoResponse;
    /**
     * The webhook object created for the source-control.
     */
    webhook?: outputs.securityinsights.v20220901preview.WebhookResponse;
}
...
export interface RepositoryResponse {
     ...
     */
    pathMapping?: outputs.securityinsights.v20220901preview.ContentPathMapResponse[];
    /**
     * Url of repository.
     */
    url?: string;
...
export interface TIDataConnectorDataTypesResponse {
     ...
     */
    indicators: outputs.securityinsights.v20220901preview.TIDataConnectorDataTypesResponseIndicators;
}
...
export interface TiTaxiiDataConnectorDataTypesResponse {
     ...
     */
    taxiiClient: outputs.securityinsights.v20220901preview.TiTaxiiDataConnectorDataTypesResponseTaxiiClient;
}
...
export interface TimelineResultsMetadataResponse {
     ...
     */
    aggregations: outputs.securityinsights.v20220901preview.TimelineAggregationResponse[];
    /**
     * information about the failure queries
     */
    errors?: outputs.securityinsights.v20220901preview.TimelineErrorResponse[];
    /**
