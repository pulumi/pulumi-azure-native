...
export interface AlertsDataTypeOfDataConnectorArgs {
     ...
     */
    alerts: pulumi.Input<inputs.securityinsights.v20220901preview.DataConnectorDataTypeCommonArgs>;
}

export interface AutomationRuleBooleanConditionArgs {
    innerConditions?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.BooleanConditionPropertiesArgs | inputs.securityinsights.v20220901preview.PropertyArrayChangedConditionPropertiesArgs | inputs.securityinsights.v20220901preview.PropertyArrayConditionPropertiesArgs | inputs.securityinsights.v20220901preview.PropertyChangedConditionPropertiesArgs | inputs.securityinsights.v20220901preview.PropertyConditionPropertiesArgs>[]>;
    operator?: pulumi.Input<string | enums.securityinsights.v20220901preview.AutomationRuleBooleanConditionSupportedOperator>;
}
...
export interface AutomationRuleModifyPropertiesActionArgs {
    actionConfiguration?: pulumi.Input<inputs.securityinsights.v20220901preview.IncidentPropertiesActionArgs>;
    /**
...
export interface AutomationRulePropertyArrayChangedValuesConditionArgs {
    arrayType?: pulumi.Input<string | enums.securityinsights.v20220901preview.AutomationRulePropertyArrayChangedConditionSupportedArrayType>;
    changeType?: pulumi.Input<string | enums.securityinsights.v20220901preview.AutomationRulePropertyArrayChangedConditionSupportedChangeType>;
}

export interface AutomationRulePropertyArrayValuesConditionArgs {
    arrayConditionType?: pulumi.Input<string | enums.securityinsights.v20220901preview.AutomationRulePropertyArrayConditionSupportedArrayConditionType>;
    arrayType?: pulumi.Input<string | enums.securityinsights.v20220901preview.AutomationRulePropertyArrayConditionSupportedArrayType>;
    itemConditions?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.BooleanConditionPropertiesArgs | inputs.securityinsights.v20220901preview.PropertyArrayChangedConditionPropertiesArgs | inputs.securityinsights.v20220901preview.PropertyArrayConditionPropertiesArgs | inputs.securityinsights.v20220901preview.PropertyChangedConditionPropertiesArgs | inputs.securityinsights.v20220901preview.PropertyConditionPropertiesArgs>[]>;
}

export interface AutomationRulePropertyValuesChangedConditionArgs {
    changeType?: pulumi.Input<string | enums.securityinsights.v20220901preview.AutomationRulePropertyChangedConditionSupportedChangedType>;
    operator?: pulumi.Input<string | enums.securityinsights.v20220901preview.AutomationRulePropertyConditionSupportedOperator>;
    propertyName?: pulumi.Input<string | enums.securityinsights.v20220901preview.AutomationRulePropertyChangedConditionSupportedPropertyType>;
...
export interface AutomationRulePropertyValuesConditionArgs {
     ...
     */
    propertyName?: pulumi.Input<string | enums.securityinsights.v20220901preview.AutomationRulePropertyConditionSupportedProperty>;
    propertyValues?: pulumi.Input<pulumi.Input<string>[]>;
}
...
export interface AutomationRuleRunPlaybookActionArgs {
    actionConfiguration?: pulumi.Input<inputs.securityinsights.v20220901preview.PlaybookActionPropertiesArgs>;
    /**
     * The type of the automation rule action.
...
export interface AutomationRuleTriggeringLogicArgs {
     ...
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.BooleanConditionPropertiesArgs | inputs.securityinsights.v20220901preview.PropertyArrayChangedConditionPropertiesArgs | inputs.securityinsights.v20220901preview.PropertyArrayConditionPropertiesArgs | inputs.securityinsights.v20220901preview.PropertyChangedConditionPropertiesArgs | inputs.securityinsights.v20220901preview.PropertyConditionPropertiesArgs>[]>;
    /**
    ...
    triggersOn: pulumi.Input<string | enums.securityinsights.v20220901preview.TriggersOn>;
    triggersWhen: pulumi.Input<string | enums.securityinsights.v20220901preview.TriggersWhen>;
}
...
export interface AwsCloudTrailDataConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20220901preview.AwsCloudTrailDataConnectorDataTypesLogsArgs>;
}
...
export interface AwsCloudTrailDataConnectorDataTypesLogsArgs {
     ...
     */
    state: pulumi.Input<string | enums.securityinsights.v20220901preview.DataTypeState>;
}
...
export interface AwsS3DataConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20220901preview.AwsS3DataConnectorDataTypesLogsArgs>;
}
...
export interface BookmarkEntityMappingsArgs {
     ...
     */
    fieldMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.EntityFieldMappingArgs>[]>;
}
...
export interface BooleanConditionPropertiesArgs {
    conditionProperties?: pulumi.Input<inputs.securityinsights.v20220901preview.AutomationRuleBooleanConditionArgs>;
    /**
     *
...
export interface CodelessConnectorPollingConfigPropertiesArgs {
     ...
     */
    auth: pulumi.Input<inputs.securityinsights.v20220901preview.CodelessConnectorPollingAuthPropertiesArgs>;
    /**
     ...
     */
    paging?: pulumi.Input<inputs.securityinsights.v20220901preview.CodelessConnectorPollingPagingPropertiesArgs>;
    /**
     * Describe the poll request config parameters of the poller
     */
    request: pulumi.Input<inputs.securityinsights.v20220901preview.CodelessConnectorPollingRequestPropertiesArgs>;
    /**
     * Describe the response config parameters of the poller
     */
    response?: pulumi.Input<inputs.securityinsights.v20220901preview.CodelessConnectorPollingResponsePropertiesArgs>;
}
...
export interface CodelessUiConnectorConfigPropertiesArgs {
     ...
     * Connector Availability Status
     */
    availability: pulumi.Input<inputs.securityinsights.v20220901preview.AvailabilityArgs>;
    /**
     * Define the way the connector check connectivity
     */
    connectivityCriteria: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesConnectivityCriteriaArgs>[]>;
    /**
     ...
     */
    dataTypes: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesDataTypesArgs>[]>;
    /**
     ...
     */
    graphQueries: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesGraphQueriesArgs>[]>;
    /**
     ...
     */
    instructionSteps: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesInstructionStepsArgs>[]>;
    /**
     * Permissions required for the connector
     */
    permissions: pulumi.Input<inputs.securityinsights.v20220901preview.PermissionsArgs>;
    /**
     ...
     */
    sampleQueries: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesSampleQueriesArgs>[]>;
    /**
...
export interface CodelessUiConnectorConfigPropertiesConnectivityCriteriaArgs {
     ...
     */
    type?: pulumi.Input<string | enums.securityinsights.v20220901preview.ConnectivityType>;
    /**
...
export interface CodelessUiConnectorConfigPropertiesInstructionStepsArgs {
     ...
     */
    instructions?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.InstructionStepsInstructionsArgs>[]>;
    /**
...
export interface ContentPathMapArgs {
     ...
     * Content type.
     */
    contentType?: pulumi.Input<string | enums.securityinsights.v20220901preview.ContentType>;
    /**
...
export interface DeploymentArgs {
     ...
     */
    deploymentResult?: pulumi.Input<string | enums.securityinsights.v20220901preview.DeploymentResult>;
    /**
     * Current status of the deployment.
     */
    deploymentState?: pulumi.Input<string | enums.securityinsights.v20220901preview.DeploymentState>;
    /**
...
export interface DeploymentInfoArgs {
     ...
     */
    deployment?: pulumi.Input<inputs.securityinsights.v20220901preview.DeploymentArgs>;
    /**
     * Status while fetching the last deployment.
     */
    deploymentFetchStatus?: pulumi.Input<string | enums.securityinsights.v20220901preview.DeploymentFetchStatus>;
    /**
...
export interface Dynamics365DataConnectorDataTypesArgs {
     ...
     */
    dynamics365CdsActivities: pulumi.Input<inputs.securityinsights.v20220901preview.Dynamics365DataConnectorDataTypesDynamics365CdsActivitiesArgs>;
}
...
export interface EntityMappingArgs {
     ...
     */
    entityType?: pulumi.Input<string | enums.securityinsights.v20220901preview.EntityMappingType>;
    /**
     * array of field mappings for the given entity mapping
     */
    fieldMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.FieldMappingArgs>[]>;
}
...
export interface EventGroupingSettingsArgs {
     ...
     */
    aggregationKind?: pulumi.Input<string | enums.securityinsights.v20220901preview.EventGroupingAggregationKind>;
}
...
export interface FileMetadataArgs {
     ...
     */
    fileFormat?: pulumi.Input<string | enums.securityinsights.v20220901preview.FileFormat>;
    /**
...
export interface FusionSourceSettingsArgs {
     ...
     */
    sourceSubTypes?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.FusionSourceSubTypeSettingArgs>[]>;
}
...
export interface FusionSourceSubTypeSettingArgs {
     ...
     */
    severityFilters: pulumi.Input<inputs.securityinsights.v20220901preview.FusionSubTypeSeverityFilterArgs>;
    /**
...
export interface FusionSubTypeSeverityFilterArgs {
     ...
     */
    filters?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.FusionSubTypeSeverityFiltersItemArgs>[]>;
}
...
export interface GroupingConfigurationArgs {
     ...
     */
    groupByAlertDetails?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20220901preview.AlertDetail>[]>;
    /**
     ...
     */
    groupByEntities?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20220901preview.EntityMappingType>[]>;
    /**
     ...
     */
    matchingMethod: pulumi.Input<string | enums.securityinsights.v20220901preview.MatchingMethod>;
    /**
...
export interface IncidentConfigurationArgs {
     ...
     */
    groupingConfiguration?: pulumi.Input<inputs.securityinsights.v20220901preview.GroupingConfigurationArgs>;
}
...
export interface IncidentInfoArgs {
     ...
     */
    severity?: pulumi.Input<string | enums.securityinsights.v20220901preview.IncidentSeverity>;
    /**
...
export interface IncidentOwnerInfoArgs {
     ...
     */
    ownerType?: pulumi.Input<string | enums.securityinsights.v20220901preview.OwnerType>;
    /**
...
export interface IncidentPropertiesActionArgs {
     ...
     */
    classification?: pulumi.Input<string | enums.securityinsights.v20220901preview.IncidentClassification>;
    /**
     ...
     */
    classificationReason?: pulumi.Input<string | enums.securityinsights.v20220901preview.IncidentClassificationReason>;
    /**
     * List of labels to add to the incident.
     */
    labels?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.IncidentLabelArgs>[]>;
    /**
     * Information on the user an incident is assigned to
     */
    owner?: pulumi.Input<inputs.securityinsights.v20220901preview.IncidentOwnerInfoArgs>;
    /**
     * The severity of the incident
     */
    severity?: pulumi.Input<string | enums.securityinsights.v20220901preview.IncidentSeverity>;
     ...
     */
    status?: pulumi.Input<string | enums.securityinsights.v20220901preview.IncidentStatus>;
}
...
export interface InstructionStepsInstructionsArgs {
     ...
     */
    type: pulumi.Input<string | enums.securityinsights.v20220901preview.SettingType>;
}
...
export interface MCASDataConnectorDataTypesArgs {
     ...
     */
    discoveryLogs?: pulumi.Input<inputs.securityinsights.v20220901preview.DataConnectorDataTypeCommonArgs>;
}
...
export interface MSTIDataConnectorDataTypesArgs {
     ...
     */
    bingSafetyPhishingURL: pulumi.Input<inputs.securityinsights.v20220901preview.MSTIDataConnectorDataTypesBingSafetyPhishingURLArgs>;
    /**
     * Data type for Microsoft Threat Intelligence Platforms data connector.
     */
    microsoftEmergingThreatFeed: pulumi.Input<inputs.securityinsights.v20220901preview.MSTIDataConnectorDataTypesMicrosoftEmergingThreatFeedArgs>;
}
...
export interface MTPDataConnectorDataTypesArgs {
     ...
     */
    incidents: pulumi.Input<inputs.securityinsights.v20220901preview.MTPDataConnectorDataTypesIncidentsArgs>;
}
...
export interface MetadataDependenciesArgs {
     ...
     */
    criteria?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.MetadataDependenciesArgs>[]>;
    /**
     ...
     */
    operator?: pulumi.Input<string | enums.securityinsights.v20220901preview.Operator>;
    /**
...
export interface MetadataSourceArgs {
     ...
     */
    kind: pulumi.Input<string | enums.securityinsights.v20220901preview.SourceKind>;
    /**
...
export interface MetadataSupportArgs {
     ...
     */
    tier: pulumi.Input<string | enums.securityinsights.v20220901preview.SupportTier>;
}
...
export interface Office365ProjectConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20220901preview.Office365ProjectConnectorDataTypesLogsArgs>;
}
...
export interface OfficeDataConnectorDataTypesArgs {
     ...
     */
    exchange: pulumi.Input<inputs.securityinsights.v20220901preview.OfficeDataConnectorDataTypesExchangeArgs>;
    /**
     * SharePoint data type connection.
     */
    sharePoint: pulumi.Input<inputs.securityinsights.v20220901preview.OfficeDataConnectorDataTypesSharePointArgs>;
    /**
     * Teams data type connection.
     */
    teams: pulumi.Input<inputs.securityinsights.v20220901preview.OfficeDataConnectorDataTypesTeamsArgs>;
}
...
export interface OfficePowerBIConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20220901preview.OfficePowerBIConnectorDataTypesLogsArgs>;
}
...
export interface PermissionsArgs {
     ...
     */
    customs?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.PermissionsCustomsArgs>[]>;
    /**
     * Resource provider permissions required for the connector
     */
    resourceProvider?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.PermissionsResourceProviderArgs>[]>;
}
...
export interface PermissionsResourceProviderArgs {
     ...
     * Provider name
     */
    provider?: pulumi.Input<string | enums.securityinsights.v20220901preview.ProviderName>;
    /**
     ...
     */
    requiredPermissions?: pulumi.Input<inputs.securityinsights.v20220901preview.RequiredPermissionsArgs>;
    /**
     * Permission provider scope
     */
    scope?: pulumi.Input<string | enums.securityinsights.v20220901preview.PermissionProviderScope>;
}
...
export interface PropertyArrayChangedConditionPropertiesArgs {
    conditionProperties?: pulumi.Input<inputs.securityinsights.v20220901preview.AutomationRulePropertyArrayChangedValuesConditionArgs>;
    /**
     *
...
export interface PropertyArrayConditionPropertiesArgs {
    conditionProperties?: pulumi.Input<inputs.securityinsights.v20220901preview.AutomationRulePropertyArrayValuesConditionArgs>;
    /**
     *
...
export interface PropertyChangedConditionPropertiesArgs {
    conditionProperties?: pulumi.Input<inputs.securityinsights.v20220901preview.AutomationRulePropertyValuesChangedConditionArgs>;
    /**
     *
...
export interface PropertyConditionPropertiesArgs {
    conditionProperties?: pulumi.Input<inputs.securityinsights.v20220901preview.AutomationRulePropertyValuesConditionArgs>;
    /**
     *
...
export interface RepositoryArgs {
     ...
     */
    pathMapping?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.ContentPathMapArgs>[]>;
    /**
     * Url of repository.
     */
...
export interface RepositoryResourceInfoArgs {
     ...
     */
    azureDevOpsResourceInfo?: pulumi.Input<inputs.securityinsights.v20220901preview.AzureDevOpsResourceInfoArgs>;
    /**
     * Resources created in GitHub for this source-control.
     */
    gitHubResourceInfo?: pulumi.Input<inputs.securityinsights.v20220901preview.GitHubResourceInfoArgs>;
    /**
     * The webhook object created for the source-control.
     */
    webhook?: pulumi.Input<inputs.securityinsights.v20220901preview.WebhookArgs>;
}
...
export interface TIDataConnectorDataTypesArgs {
     ...
     */
    indicators: pulumi.Input<inputs.securityinsights.v20220901preview.TIDataConnectorDataTypesIndicatorsArgs>;
}
...
export interface ThreatIntelligenceParsedPatternArgs {
     ...
     * Pattern type keys
     */
    patternTypeValues?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220901preview.ThreatIntelligenceParsedPatternTypeValueArgs>[]>;
}
...
export interface TiTaxiiDataConnectorDataTypesArgs {
     ...
     */
    taxiiClient: pulumi.Input<inputs.securityinsights.v20220901preview.TiTaxiiDataConnectorDataTypesTaxiiClientArgs>;
}
