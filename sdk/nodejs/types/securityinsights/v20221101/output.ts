...
export interface AlertsDataTypeOfDataConnectorResponse {
     ...
     */
    alerts?: outputs.securityinsights.v20221101.DataConnectorDataTypeCommonResponse;
}
...
export interface AutomationRuleModifyPropertiesActionResponse {
    actionConfiguration?: outputs.securityinsights.v20221101.IncidentPropertiesActionResponse;
    /**
...
export interface AutomationRuleRunPlaybookActionResponse {
    actionConfiguration?: outputs.securityinsights.v20221101.PlaybookActionPropertiesResponse;
    /**
     * The type of the automation rule action.
...
export interface AutomationRuleTriggeringLogicResponse {
     ...
     */
    conditions?: (outputs.securityinsights.v20221101.PropertyArrayChangedConditionPropertiesResponse | outputs.securityinsights.v20221101.PropertyChangedConditionPropertiesResponse | outputs.securityinsights.v20221101.PropertyConditionPropertiesResponse)[];
    /**
...
export interface AwsCloudTrailDataConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs?: outputs.securityinsights.v20221101.AwsCloudTrailDataConnectorDataTypesResponseLogs;
}
...
export interface EntityMappingResponse {
     ...
     */
    fieldMappings?: outputs.securityinsights.v20221101.FieldMappingResponse[];
}
...
export interface IncidentConfigurationResponse {
     ...
     */
    groupingConfiguration?: outputs.securityinsights.v20221101.GroupingConfigurationResponse;
}
...
export interface IncidentPropertiesActionResponse {
     ...
     */
    labels?: outputs.securityinsights.v20221101.IncidentLabelResponse[];
    /**
     * Information on the user an incident is assigned to
     */
    owner?: outputs.securityinsights.v20221101.IncidentOwnerInfoResponse;
    /**
     * The severity of the incident
     */
    severity?: string;
...
export interface MCASDataConnectorDataTypesResponse {
     ...
     */
    discoveryLogs?: outputs.securityinsights.v20221101.DataConnectorDataTypeCommonResponse;
}
...
export interface OfficeDataConnectorDataTypesResponse {
     ...
     */
    exchange?: outputs.securityinsights.v20221101.OfficeDataConnectorDataTypesResponseExchange;
    /**
     * SharePoint data type connection.
     */
    sharePoint?: outputs.securityinsights.v20221101.OfficeDataConnectorDataTypesResponseSharePoint;
    /**
     * Teams data type connection.
     */
    teams?: outputs.securityinsights.v20221101.OfficeDataConnectorDataTypesResponseTeams;
}
...
export interface PropertyArrayChangedConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20221101.AutomationRulePropertyArrayChangedValuesConditionResponse;
    /**
     *
...
export interface PropertyChangedConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20221101.AutomationRulePropertyValuesChangedConditionResponse;
    /**
     *
...
export interface PropertyConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20221101.AutomationRulePropertyValuesConditionResponse;
    /**
     *
...
export interface TIDataConnectorDataTypesResponse {
     ...
     */
    indicators?: outputs.securityinsights.v20221101.TIDataConnectorDataTypesResponseIndicators;
}
