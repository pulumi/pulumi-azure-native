...
export interface AlertsDataTypeOfDataConnectorResponse {
     ...
     */
    alerts: outputs.securityinsights.v20210901preview.DataConnectorDataTypeCommonResponse;
}
...
export interface AutomationRuleModifyPropertiesActionResponse {
     ...
     */
    actionConfiguration: outputs.securityinsights.v20210901preview.AutomationRuleModifyPropertiesActionResponseActionConfiguration;
    /**
...
export interface AutomationRuleModifyPropertiesActionResponseActionConfiguration {
     ...
     */
    labels?: outputs.securityinsights.v20210901preview.IncidentLabelResponse[];
    /**
     * Describes a user that the incident is assigned to
     */
    owner?: outputs.securityinsights.v20210901preview.IncidentOwnerInfoResponse;
    /**
...
export interface AutomationRulePropertyValuesConditionResponse {
     ...
     */
    conditionProperties: outputs.securityinsights.v20210901preview.AutomationRulePropertyValuesConditionResponseConditionProperties;
    /**
...
export interface AutomationRuleRunPlaybookActionResponse {
     ...
     */
    actionConfiguration: outputs.securityinsights.v20210901preview.AutomationRuleRunPlaybookActionResponseActionConfiguration;
    /**
     * The type of the automation rule action
...
export interface AutomationRuleTriggeringLogicResponse {
     ...
     */
    conditions?: outputs.securityinsights.v20210901preview.AutomationRulePropertyValuesConditionResponse[];
    /**
...
export interface AwsCloudTrailDataConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20210901preview.AwsCloudTrailDataConnectorDataTypesResponseLogs;
}
...
export interface AwsS3DataConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20210901preview.AwsS3DataConnectorDataTypesResponseLogs;
}
...
export interface BookmarkTimelineItemResponse {
     ...
     */
    createdBy?: outputs.securityinsights.v20210901preview.UserInfoResponse;
    /**
...
export interface CodelessConnectorPollingConfigPropertiesResponse {
     ...
     */
    auth: outputs.securityinsights.v20210901preview.CodelessConnectorPollingAuthPropertiesResponse;
    /**
     ...
     */
    paging?: outputs.securityinsights.v20210901preview.CodelessConnectorPollingPagingPropertiesResponse;
    /**
     * Describe the poll request config parameters of the poller
     */
    request: outputs.securityinsights.v20210901preview.CodelessConnectorPollingRequestPropertiesResponse;
    /**
     * Describe the response config parameters of the poller
     */
    response?: outputs.securityinsights.v20210901preview.CodelessConnectorPollingResponsePropertiesResponse;
}
...
export interface CodelessUiConnectorConfigPropertiesResponse {
     ...
     * Connector Availability Status
     */
    availability: outputs.securityinsights.v20210901preview.AvailabilityResponse;
    /**
     * Define the way the connector check connectivity
     */
    connectivityCriteria: outputs.securityinsights.v20210901preview.CodelessUiConnectorConfigPropertiesResponseConnectivityCriteria[];
    /**
     ...
     */
    dataTypes: outputs.securityinsights.v20210901preview.CodelessUiConnectorConfigPropertiesResponseDataTypes[];
    /**
     ...
     */
    graphQueries: outputs.securityinsights.v20210901preview.CodelessUiConnectorConfigPropertiesResponseGraphQueries[];
    /**
     ...
     */
    instructionSteps: outputs.securityinsights.v20210901preview.CodelessUiConnectorConfigPropertiesResponseInstructionSteps[];
    /**
     * Permissions required for the connector
     */
    permissions: outputs.securityinsights.v20210901preview.PermissionsResponse;
    /**
     ...
     */
    sampleQueries: outputs.securityinsights.v20210901preview.CodelessUiConnectorConfigPropertiesResponseSampleQueries[];
    /**
...
export interface CodelessUiConnectorConfigPropertiesResponseInstructionSteps {
     ...
     */
    instructions?: outputs.securityinsights.v20210901preview.InstructionStepsResponseInstructions[];
    /**
...
export interface Dynamics365DataConnectorDataTypesResponse {
     ...
     */
    dynamics365CdsActivities: outputs.securityinsights.v20210901preview.Dynamics365DataConnectorDataTypesResponseDynamics365CdsActivities;
}
...
export interface EntityInsightItemResponse {
     ...
     */
    chartQueryResults?: outputs.securityinsights.v20210901preview.InsightsTableResultResponse[];
    /**
     ...
     */
    queryTimeInterval?: outputs.securityinsights.v20210901preview.EntityInsightItemResponseQueryTimeInterval;
    /**
     * Query results for table insights query.
     */
    tableQueryResults?: outputs.securityinsights.v20210901preview.InsightsTableResultResponse;
}
...
export interface EntityMappingResponse {
     ...
     */
    fieldMappings?: outputs.securityinsights.v20210901preview.FieldMappingResponse[];
}
...
export interface GetInsightsResultsMetadataResponse {
     ...
     */
    errors?: outputs.securityinsights.v20210901preview.GetInsightsErrorResponse[];
    /**
...
export interface IncidentConfigurationResponse {
     ...
     */
    groupingConfiguration?: outputs.securityinsights.v20210901preview.GroupingConfigurationResponse;
}
...
export interface InsightsTableResultResponse {
     ...
     */
    columns?: outputs.securityinsights.v20210901preview.InsightsTableResultResponseColumns[];
    /**
...
export interface MCASDataConnectorDataTypesResponse {
     ...
     */
    discoveryLogs?: outputs.securityinsights.v20210901preview.DataConnectorDataTypeCommonResponse;
}
...
export interface MSTIDataConnectorDataTypesResponse {
     ...
     */
    bingSafetyPhishingURL: outputs.securityinsights.v20210901preview.MSTIDataConnectorDataTypesResponseBingSafetyPhishingURL;
    /**
     * Data type for Microsoft Threat Intelligence Platforms data connector.
     */
    microsoftEmergingThreatFeed: outputs.securityinsights.v20210901preview.MSTIDataConnectorDataTypesResponseMicrosoftEmergingThreatFeed;
}
...
export interface MTPDataConnectorDataTypesResponse {
     ...
     */
    incidents: outputs.securityinsights.v20210901preview.MTPDataConnectorDataTypesResponseIncidents;
}
...
export interface MetadataDependenciesResponse {
     ...
     */
    criteria?: outputs.securityinsights.v20210901preview.MetadataDependenciesResponse[];
    /**
...
export interface OfficeDataConnectorDataTypesResponse {
     ...
     */
    exchange: outputs.securityinsights.v20210901preview.OfficeDataConnectorDataTypesResponseExchange;
    /**
     * SharePoint data type connection.
     */
    sharePoint: outputs.securityinsights.v20210901preview.OfficeDataConnectorDataTypesResponseSharePoint;
    /**
     * Teams data type connection.
     */
    teams: outputs.securityinsights.v20210901preview.OfficeDataConnectorDataTypesResponseTeams;
}
...
export interface PermissionsResponse {
     ...
     */
    customs?: outputs.securityinsights.v20210901preview.PermissionsResponseCustoms[];
    /**
     * Resource provider permissions required for the connector
     */
    resourceProvider?: outputs.securityinsights.v20210901preview.PermissionsResponseResourceProvider[];
}
...
export interface PermissionsResponseResourceProvider {
     ...
     */
    requiredPermissions?: outputs.securityinsights.v20210901preview.RequiredPermissionsResponse;
    /**
...
export interface RepositoryResponse {
     ...
     */
    pathMapping?: outputs.securityinsights.v20210901preview.ContentPathMapResponse[];
    /**
     * Url of repository.
     */
    url?: string;
...
export interface TIDataConnectorDataTypesResponse {
     ...
     */
    indicators: outputs.securityinsights.v20210901preview.TIDataConnectorDataTypesResponseIndicators;
}
...
export interface TiTaxiiDataConnectorDataTypesResponse {
     ...
     */
    taxiiClient: outputs.securityinsights.v20210901preview.TiTaxiiDataConnectorDataTypesResponseTaxiiClient;
}
...
export interface TimelineResultsMetadataResponse {
     ...
     */
    aggregations: outputs.securityinsights.v20210901preview.TimelineAggregationResponse[];
    /**
     * information about the failure queries
     */
    errors?: outputs.securityinsights.v20210901preview.TimelineErrorResponse[];
    /**
