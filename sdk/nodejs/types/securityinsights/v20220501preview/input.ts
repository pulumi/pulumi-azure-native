...
export interface AlertsDataTypeOfDataConnectorArgs {
     ...
     */
    alerts: pulumi.Input<inputs.securityinsights.v20220501preview.DataConnectorDataTypeCommonArgs>;
}
...
export interface AutomationRuleModifyPropertiesActionArgs {
    actionConfiguration?: pulumi.Input<inputs.securityinsights.v20220501preview.IncidentPropertiesActionArgs>;
    /**
...
export interface AutomationRulePropertyArrayChangedValuesConditionArgs {
    arrayType?: pulumi.Input<string | enums.securityinsights.v20220501preview.AutomationRulePropertyArrayChangedConditionSupportedArrayType>;
    changeType?: pulumi.Input<string | enums.securityinsights.v20220501preview.AutomationRulePropertyArrayChangedConditionSupportedChangeType>;
}

export interface AutomationRulePropertyValuesChangedConditionArgs {
    changeType?: pulumi.Input<string | enums.securityinsights.v20220501preview.AutomationRulePropertyChangedConditionSupportedChangedType>;
    operator?: pulumi.Input<string | enums.securityinsights.v20220501preview.AutomationRulePropertyConditionSupportedOperator>;
    propertyName?: pulumi.Input<string | enums.securityinsights.v20220501preview.AutomationRulePropertyChangedConditionSupportedPropertyType>;
...
export interface AutomationRulePropertyValuesConditionArgs {
     ...
     */
    propertyName?: pulumi.Input<string | enums.securityinsights.v20220501preview.AutomationRulePropertyConditionSupportedProperty>;
    propertyValues?: pulumi.Input<pulumi.Input<string>[]>;
}
...
export interface AutomationRuleRunPlaybookActionArgs {
    actionConfiguration?: pulumi.Input<inputs.securityinsights.v20220501preview.PlaybookActionPropertiesArgs>;
    /**
     * The type of the automation rule action.
...
export interface AutomationRuleTriggeringLogicArgs {
     ...
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.PropertyArrayChangedConditionPropertiesArgs | inputs.securityinsights.v20220501preview.PropertyChangedConditionPropertiesArgs | inputs.securityinsights.v20220501preview.PropertyConditionPropertiesArgs>[]>;
    /**
    ...
    triggersOn: pulumi.Input<string | enums.securityinsights.v20220501preview.TriggersOn>;
    triggersWhen: pulumi.Input<string | enums.securityinsights.v20220501preview.TriggersWhen>;
}
...
export interface AwsCloudTrailDataConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20220501preview.AwsCloudTrailDataConnectorDataTypesLogsArgs>;
}
...
export interface AwsCloudTrailDataConnectorDataTypesLogsArgs {
     ...
     */
    state: pulumi.Input<string | enums.securityinsights.v20220501preview.DataTypeState>;
}
...
export interface AwsS3DataConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20220501preview.AwsS3DataConnectorDataTypesLogsArgs>;
}
...
export interface BookmarkEntityMappingsArgs {
     ...
     */
    fieldMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.EntityFieldMappingArgs>[]>;
}
...
export interface CodelessConnectorPollingConfigPropertiesArgs {
     ...
     */
    auth: pulumi.Input<inputs.securityinsights.v20220501preview.CodelessConnectorPollingAuthPropertiesArgs>;
    /**
     ...
     */
    paging?: pulumi.Input<inputs.securityinsights.v20220501preview.CodelessConnectorPollingPagingPropertiesArgs>;
    /**
     * Describe the poll request config parameters of the poller
     */
    request: pulumi.Input<inputs.securityinsights.v20220501preview.CodelessConnectorPollingRequestPropertiesArgs>;
    /**
     * Describe the response config parameters of the poller
     */
    response?: pulumi.Input<inputs.securityinsights.v20220501preview.CodelessConnectorPollingResponsePropertiesArgs>;
}
...
export interface CodelessUiConnectorConfigPropertiesArgs {
     ...
     * Connector Availability Status
     */
    availability: pulumi.Input<inputs.securityinsights.v20220501preview.AvailabilityArgs>;
    /**
     * Define the way the connector check connectivity
     */
    connectivityCriteria: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.CodelessUiConnectorConfigPropertiesConnectivityCriteriaArgs>[]>;
    /**
     ...
     */
    dataTypes: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.CodelessUiConnectorConfigPropertiesDataTypesArgs>[]>;
    /**
     ...
     */
    graphQueries: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.CodelessUiConnectorConfigPropertiesGraphQueriesArgs>[]>;
    /**
     ...
     */
    instructionSteps: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.CodelessUiConnectorConfigPropertiesInstructionStepsArgs>[]>;
    /**
     * Permissions required for the connector
     */
    permissions: pulumi.Input<inputs.securityinsights.v20220501preview.PermissionsArgs>;
    /**
     ...
     */
    sampleQueries: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.CodelessUiConnectorConfigPropertiesSampleQueriesArgs>[]>;
    /**
...
export interface CodelessUiConnectorConfigPropertiesConnectivityCriteriaArgs {
     ...
     */
    type?: pulumi.Input<string | enums.securityinsights.v20220501preview.ConnectivityType>;
    /**
...
export interface CodelessUiConnectorConfigPropertiesInstructionStepsArgs {
     ...
     */
    instructions?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.InstructionStepsInstructionsArgs>[]>;
    /**
...
export interface ContentPathMapArgs {
     ...
     * Content type.
     */
    contentType?: pulumi.Input<string | enums.securityinsights.v20220501preview.ContentType>;
    /**
...
export interface DeploymentArgs {
     ...
     */
    deploymentResult?: pulumi.Input<string | enums.securityinsights.v20220501preview.DeploymentResult>;
    /**
     * Current status of the deployment.
     */
    deploymentState?: pulumi.Input<string | enums.securityinsights.v20220501preview.DeploymentState>;
    /**
...
export interface DeploymentInfoArgs {
     ...
     */
    deployment?: pulumi.Input<inputs.securityinsights.v20220501preview.DeploymentArgs>;
    /**
     * Status while fetching the last deployment.
     */
    deploymentFetchStatus?: pulumi.Input<string | enums.securityinsights.v20220501preview.DeploymentFetchStatus>;
    /**
...
export interface Dynamics365DataConnectorDataTypesArgs {
     ...
     */
    dynamics365CdsActivities: pulumi.Input<inputs.securityinsights.v20220501preview.Dynamics365DataConnectorDataTypesDynamics365CdsActivitiesArgs>;
}
...
export interface EntityMappingArgs {
     ...
     */
    entityType?: pulumi.Input<string | enums.securityinsights.v20220501preview.EntityMappingType>;
    /**
     * array of field mappings for the given entity mapping
     */
    fieldMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.FieldMappingArgs>[]>;
}
...
export interface EventGroupingSettingsArgs {
     ...
     */
    aggregationKind?: pulumi.Input<string | enums.securityinsights.v20220501preview.EventGroupingAggregationKind>;
}
...
export interface FusionSourceSettingsArgs {
     ...
     */
    sourceSubTypes?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.FusionSourceSubTypeSettingArgs>[]>;
}
...
export interface FusionSourceSubTypeSettingArgs {
     ...
     */
    severityFilters: pulumi.Input<inputs.securityinsights.v20220501preview.FusionSubTypeSeverityFilterArgs>;
    /**
...
export interface FusionSubTypeSeverityFilterArgs {
     ...
     */
    filters?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.FusionSubTypeSeverityFiltersItemArgs>[]>;
}
...
export interface GroupingConfigurationArgs {
     ...
     */
    groupByAlertDetails?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20220501preview.AlertDetail>[]>;
    /**
     ...
     */
    groupByEntities?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20220501preview.EntityMappingType>[]>;
    /**
     ...
     */
    matchingMethod: pulumi.Input<string | enums.securityinsights.v20220501preview.MatchingMethod>;
    /**
...
export interface IncidentConfigurationArgs {
     ...
     */
    groupingConfiguration?: pulumi.Input<inputs.securityinsights.v20220501preview.GroupingConfigurationArgs>;
}
...
export interface IncidentOwnerInfoArgs {
     ...
     */
    ownerType?: pulumi.Input<string | enums.securityinsights.v20220501preview.OwnerType>;
    /**
...
export interface InstructionStepsInstructionsArgs {
     ...
     */
    type: pulumi.Input<string | enums.securityinsights.v20220501preview.SettingType>;
}
...
export interface MCASDataConnectorDataTypesArgs {
     ...
     */
    discoveryLogs?: pulumi.Input<inputs.securityinsights.v20220501preview.DataConnectorDataTypeCommonArgs>;
}
...
export interface MSTIDataConnectorDataTypesArgs {
     ...
     */
    bingSafetyPhishingURL: pulumi.Input<inputs.securityinsights.v20220501preview.MSTIDataConnectorDataTypesBingSafetyPhishingURLArgs>;
    /**
     * Data type for Microsoft Threat Intelligence Platforms data connector.
     */
    microsoftEmergingThreatFeed: pulumi.Input<inputs.securityinsights.v20220501preview.MSTIDataConnectorDataTypesMicrosoftEmergingThreatFeedArgs>;
}
...
export interface MTPDataConnectorDataTypesArgs {
     ...
     */
    incidents: pulumi.Input<inputs.securityinsights.v20220501preview.MTPDataConnectorDataTypesIncidentsArgs>;
}
...
export interface MetadataDependenciesArgs {
     ...
     */
    criteria?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.MetadataDependenciesArgs>[]>;
    /**
     ...
     */
    operator?: pulumi.Input<string | enums.securityinsights.v20220501preview.Operator>;
    /**
...
export interface MetadataSourceArgs {
     ...
     */
    kind: pulumi.Input<string | enums.securityinsights.v20220501preview.SourceKind>;
    /**
...
export interface MetadataSupportArgs {
     ...
     */
    tier: pulumi.Input<string | enums.securityinsights.v20220501preview.SupportTier>;
}
...
export interface Office365ProjectConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20220501preview.Office365ProjectConnectorDataTypesLogsArgs>;
}
...
export interface OfficeDataConnectorDataTypesArgs {
     ...
     */
    exchange: pulumi.Input<inputs.securityinsights.v20220501preview.OfficeDataConnectorDataTypesExchangeArgs>;
    /**
     * SharePoint data type connection.
     */
    sharePoint: pulumi.Input<inputs.securityinsights.v20220501preview.OfficeDataConnectorDataTypesSharePointArgs>;
    /**
     * Teams data type connection.
     */
    teams: pulumi.Input<inputs.securityinsights.v20220501preview.OfficeDataConnectorDataTypesTeamsArgs>;
}
...
export interface OfficePowerBIConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20220501preview.OfficePowerBIConnectorDataTypesLogsArgs>;
}
...
export interface PermissionsArgs {
     ...
     */
    customs?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.PermissionsCustomsArgs>[]>;
    /**
     * Resource provider permissions required for the connector
     */
    resourceProvider?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.PermissionsResourceProviderArgs>[]>;
}
...
export interface PermissionsResourceProviderArgs {
     ...
     * Provider name
     */
    provider?: pulumi.Input<string | enums.securityinsights.v20220501preview.ProviderName>;
    /**
     ...
     */
    requiredPermissions?: pulumi.Input<inputs.securityinsights.v20220501preview.RequiredPermissionsArgs>;
    /**
     * Permission provider scope
     */
    scope?: pulumi.Input<string | enums.securityinsights.v20220501preview.PermissionProviderScope>;
}
...
export interface PropertyArrayChangedConditionPropertiesArgs {
    conditionProperties?: pulumi.Input<inputs.securityinsights.v20220501preview.AutomationRulePropertyArrayChangedValuesConditionArgs>;
    /**
     *
...
export interface PropertyChangedConditionPropertiesArgs {
    conditionProperties?: pulumi.Input<inputs.securityinsights.v20220501preview.AutomationRulePropertyValuesChangedConditionArgs>;
    /**
     *
...
export interface PropertyConditionPropertiesArgs {
    conditionProperties?: pulumi.Input<inputs.securityinsights.v20220501preview.AutomationRulePropertyValuesConditionArgs>;
    /**
     *
...
export interface RepositoryArgs {
     ...
     */
    pathMapping?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.ContentPathMapArgs>[]>;
    /**
     * Url of repository.
     */
...
export interface RepositoryResourceInfoArgs {
     ...
     */
    azureDevOpsResourceInfo?: pulumi.Input<inputs.securityinsights.v20220501preview.AzureDevOpsResourceInfoArgs>;
    /**
     * Resources created in GitHub for this source-control.
     */
    gitHubResourceInfo?: pulumi.Input<inputs.securityinsights.v20220501preview.GitHubResourceInfoArgs>;
    /**
     * The webhook object created for the source-control.
     */
    webhook?: pulumi.Input<inputs.securityinsights.v20220501preview.WebhookArgs>;
}
...
export interface TIDataConnectorDataTypesArgs {
     ...
     */
    indicators: pulumi.Input<inputs.securityinsights.v20220501preview.TIDataConnectorDataTypesIndicatorsArgs>;
}
...
export interface ThreatIntelligenceParsedPatternArgs {
     ...
     * Pattern type keys
     */
    patternTypeValues?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.ThreatIntelligenceParsedPatternTypeValueArgs>[]>;
}
...
export interface TiTaxiiDataConnectorDataTypesArgs {
     ...
     */
    taxiiClient: pulumi.Input<inputs.securityinsights.v20220501preview.TiTaxiiDataConnectorDataTypesTaxiiClientArgs>;
}
