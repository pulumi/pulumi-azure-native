...
export interface AlertsDataTypeOfDataConnectorArgs {
     ...
     */
    alerts: pulumi.Input<inputs.securityinsights.v20211001preview.DataConnectorDataTypeCommonArgs>;
}
...
export interface AutomationRuleModifyPropertiesActionArgs {
    actionConfiguration?: pulumi.Input<inputs.securityinsights.v20211001preview.IncidentPropertiesActionArgs>;
    /**
...
export interface AutomationRulePropertyValuesConditionArgs {
    operator?: pulumi.Input<string | enums.securityinsights.v20211001preview.AutomationRulePropertyConditionSupportedOperator>;
    /**
     * The property to evaluate in an automation rule property condition
     */
    propertyName?: pulumi.Input<string | enums.securityinsights.v20211001preview.AutomationRulePropertyConditionSupportedProperty>;
...
export interface AutomationRuleRunPlaybookActionArgs {
    actionConfiguration?: pulumi.Input<inputs.securityinsights.v20211001preview.PlaybookActionPropertiesArgs>;
    /**
     * The type of the automation rule action
...
export interface AutomationRuleTriggeringLogicArgs {
     ...
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.PropertyConditionPropertiesArgs>[]>;
    /**
    ...
    triggersOn: pulumi.Input<string | enums.securityinsights.v20211001preview.TriggersOn>;
    triggersWhen: pulumi.Input<string | enums.securityinsights.v20211001preview.TriggersWhen>;
}
...
export interface AwsCloudTrailDataConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20211001preview.AwsCloudTrailDataConnectorDataTypesLogsArgs>;
}
...
export interface AwsCloudTrailDataConnectorDataTypesLogsArgs {
     ...
     */
    state: pulumi.Input<string | enums.securityinsights.v20211001preview.DataTypeState>;
}
...
export interface AwsS3DataConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20211001preview.AwsS3DataConnectorDataTypesLogsArgs>;
}
...
export interface BookmarkEntityMappingsArgs {
     ...
     */
    fieldMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.EntityFieldMappingArgs>[]>;
}
...
export interface CodelessConnectorPollingConfigPropertiesArgs {
     ...
     */
    auth: pulumi.Input<inputs.securityinsights.v20211001preview.CodelessConnectorPollingAuthPropertiesArgs>;
    /**
     ...
     */
    paging?: pulumi.Input<inputs.securityinsights.v20211001preview.CodelessConnectorPollingPagingPropertiesArgs>;
    /**
     * Describe the poll request config parameters of the poller
     */
    request: pulumi.Input<inputs.securityinsights.v20211001preview.CodelessConnectorPollingRequestPropertiesArgs>;
    /**
     * Describe the response config parameters of the poller
     */
    response?: pulumi.Input<inputs.securityinsights.v20211001preview.CodelessConnectorPollingResponsePropertiesArgs>;
}
...
export interface CodelessUiConnectorConfigPropertiesArgs {
     ...
     * Connector Availability Status
     */
    availability: pulumi.Input<inputs.securityinsights.v20211001preview.AvailabilityArgs>;
    /**
     * Define the way the connector check connectivity
     */
    connectivityCriteria: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.CodelessUiConnectorConfigPropertiesConnectivityCriteriaArgs>[]>;
    /**
     ...
     */
    dataTypes: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.CodelessUiConnectorConfigPropertiesDataTypesArgs>[]>;
    /**
     ...
     */
    graphQueries: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.CodelessUiConnectorConfigPropertiesGraphQueriesArgs>[]>;
    /**
     ...
     */
    instructionSteps: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.CodelessUiConnectorConfigPropertiesInstructionStepsArgs>[]>;
    /**
     * Permissions required for the connector
     */
    permissions: pulumi.Input<inputs.securityinsights.v20211001preview.PermissionsArgs>;
    /**
     ...
     */
    sampleQueries: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.CodelessUiConnectorConfigPropertiesSampleQueriesArgs>[]>;
    /**
...
export interface CodelessUiConnectorConfigPropertiesConnectivityCriteriaArgs {
     ...
     */
    type?: pulumi.Input<string | enums.securityinsights.v20211001preview.ConnectivityType>;
    /**
...
export interface CodelessUiConnectorConfigPropertiesInstructionStepsArgs {
     ...
     */
    instructions?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.InstructionStepsInstructionsArgs>[]>;
    /**
...
export interface ContentPathMapArgs {
     ...
     * Content type.
     */
    contentType?: pulumi.Input<string | enums.securityinsights.v20211001preview.ContentType>;
    /**
...
export interface Dynamics365DataConnectorDataTypesArgs {
     ...
     */
    dynamics365CdsActivities: pulumi.Input<inputs.securityinsights.v20211001preview.Dynamics365DataConnectorDataTypesDynamics365CdsActivitiesArgs>;
}
...
export interface EntityMappingArgs {
     ...
     */
    entityType?: pulumi.Input<string | enums.securityinsights.v20211001preview.EntityMappingType>;
    /**
     * array of field mappings for the given entity mapping
     */
    fieldMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.FieldMappingArgs>[]>;
}
...
export interface EventGroupingSettingsArgs {
     ...
     */
    aggregationKind?: pulumi.Input<string | enums.securityinsights.v20211001preview.EventGroupingAggregationKind>;
}
...
export interface FusionSourceSettingsArgs {
     ...
     */
    sourceSubTypes?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.FusionSourceSubTypeSettingArgs>[]>;
}
...
export interface FusionSourceSubTypeSettingArgs {
     ...
     */
    severityFilters: pulumi.Input<inputs.securityinsights.v20211001preview.FusionSubTypeSeverityFilterArgs>;
    /**
...
export interface FusionSubTypeSeverityFilterArgs {
     ...
     */
    filters?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.FusionSubTypeSeverityFiltersItemArgs>[]>;
}
...
export interface GroupingConfigurationArgs {
     ...
     */
    groupByAlertDetails?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20211001preview.AlertDetail>[]>;
    /**
     ...
     */
    groupByEntities?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20211001preview.EntityMappingType>[]>;
    /**
     ...
     */
    matchingMethod: pulumi.Input<string | enums.securityinsights.v20211001preview.MatchingMethod>;
    /**
...
export interface IncidentConfigurationArgs {
     ...
     */
    groupingConfiguration?: pulumi.Input<inputs.securityinsights.v20211001preview.GroupingConfigurationArgs>;
}
...
export interface InstructionStepsInstructionsArgs {
     ...
     */
    type: pulumi.Input<string | enums.securityinsights.v20211001preview.SettingType>;
}
...
export interface MCASDataConnectorDataTypesArgs {
     ...
     */
    discoveryLogs?: pulumi.Input<inputs.securityinsights.v20211001preview.DataConnectorDataTypeCommonArgs>;
}
...
export interface MSTIDataConnectorDataTypesArgs {
     ...
     */
    bingSafetyPhishingURL: pulumi.Input<inputs.securityinsights.v20211001preview.MSTIDataConnectorDataTypesBingSafetyPhishingURLArgs>;
    /**
     * Data type for Microsoft Threat Intelligence Platforms data connector.
     */
    microsoftEmergingThreatFeed: pulumi.Input<inputs.securityinsights.v20211001preview.MSTIDataConnectorDataTypesMicrosoftEmergingThreatFeedArgs>;
}
...
export interface MTPDataConnectorDataTypesArgs {
     ...
     */
    incidents: pulumi.Input<inputs.securityinsights.v20211001preview.MTPDataConnectorDataTypesIncidentsArgs>;
}
...
export interface MetadataDependenciesArgs {
     ...
     */
    criteria?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.MetadataDependenciesArgs>[]>;
    /**
     ...
     */
    operator?: pulumi.Input<string | enums.securityinsights.v20211001preview.Operator>;
    /**
...
export interface MetadataSourceArgs {
     ...
     */
    kind: pulumi.Input<string | enums.securityinsights.v20211001preview.SourceKind>;
    /**
...
export interface MetadataSupportArgs {
     ...
     */
    tier: pulumi.Input<string | enums.securityinsights.v20211001preview.SupportTier>;
}
...
export interface Office365ProjectConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20211001preview.Office365ProjectConnectorDataTypesLogsArgs>;
}
...
export interface OfficeDataConnectorDataTypesArgs {
     ...
     */
    exchange: pulumi.Input<inputs.securityinsights.v20211001preview.OfficeDataConnectorDataTypesExchangeArgs>;
    /**
     * SharePoint data type connection.
     */
    sharePoint: pulumi.Input<inputs.securityinsights.v20211001preview.OfficeDataConnectorDataTypesSharePointArgs>;
    /**
     * Teams data type connection.
     */
    teams: pulumi.Input<inputs.securityinsights.v20211001preview.OfficeDataConnectorDataTypesTeamsArgs>;
}
...
export interface OfficePowerBIConnectorDataTypesArgs {
     ...
     * Logs data type.
     */
    logs: pulumi.Input<inputs.securityinsights.v20211001preview.OfficePowerBIConnectorDataTypesLogsArgs>;
}
...
export interface PermissionsArgs {
     ...
     */
    customs?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.PermissionsCustomsArgs>[]>;
    /**
     * Resource provider permissions required for the connector
     */
    resourceProvider?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.PermissionsResourceProviderArgs>[]>;
}
...
export interface PermissionsResourceProviderArgs {
     ...
     * Provider name
     */
    provider?: pulumi.Input<string | enums.securityinsights.v20211001preview.ProviderName>;
    /**
     ...
     */
    requiredPermissions?: pulumi.Input<inputs.securityinsights.v20211001preview.RequiredPermissionsArgs>;
    /**
     * Permission provider scope
     */
    scope?: pulumi.Input<string | enums.securityinsights.v20211001preview.PermissionProviderScope>;
}
...
export interface PropertyConditionPropertiesArgs {
    conditionProperties?: pulumi.Input<inputs.securityinsights.v20211001preview.AutomationRulePropertyValuesConditionArgs>;
    /**
     *
...
export interface RepositoryArgs {
     ...
     */
    pathMapping?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.ContentPathMapArgs>[]>;
    /**
     * Url of repository.
     */
...
export interface TIDataConnectorDataTypesArgs {
     ...
     */
    indicators: pulumi.Input<inputs.securityinsights.v20211001preview.TIDataConnectorDataTypesIndicatorsArgs>;
}
...
export interface ThreatIntelligenceParsedPatternArgs {
     ...
     * Pattern type keys
     */
    patternTypeValues?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20211001preview.ThreatIntelligenceParsedPatternTypeValueArgs>[]>;
}
...
export interface TiTaxiiDataConnectorDataTypesArgs {
     ...
     */
    taxiiClient: pulumi.Input<inputs.securityinsights.v20211001preview.TiTaxiiDataConnectorDataTypesTaxiiClientArgs>;
}
