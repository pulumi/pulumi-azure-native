...
export interface AlertsDataTypeOfDataConnectorResponse {
     ...
     */
    alerts: outputs.securityinsights.v20211001preview.DataConnectorDataTypeCommonResponse;
}
...
export interface AutomationRuleModifyPropertiesActionResponse {
    actionConfiguration?: outputs.securityinsights.v20211001preview.IncidentPropertiesActionResponse;
    /**
...
export interface AutomationRuleRunPlaybookActionResponse {
    actionConfiguration?: outputs.securityinsights.v20211001preview.PlaybookActionPropertiesResponse;
    /**
     * The type of the automation rule action
...
export interface AutomationRuleTriggeringLogicResponse {
     ...
     */
    conditions?: outputs.securityinsights.v20211001preview.PropertyConditionPropertiesResponse[];
    /**
...
export interface AwsCloudTrailDataConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20211001preview.AwsCloudTrailDataConnectorDataTypesResponseLogs;
}
...
export interface AwsS3DataConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20211001preview.AwsS3DataConnectorDataTypesResponseLogs;
}
...
export interface BookmarkEntityMappingsResponse {
     ...
     */
    fieldMappings?: outputs.securityinsights.v20211001preview.EntityFieldMappingResponse[];
}
...
export interface BookmarkTimelineItemResponse {
     ...
     */
    createdBy?: outputs.securityinsights.v20211001preview.UserInfoResponse;
    /**
...
export interface CodelessConnectorPollingConfigPropertiesResponse {
     ...
     */
    auth: outputs.securityinsights.v20211001preview.CodelessConnectorPollingAuthPropertiesResponse;
    /**
     ...
     */
    paging?: outputs.securityinsights.v20211001preview.CodelessConnectorPollingPagingPropertiesResponse;
    /**
     * Describe the poll request config parameters of the poller
     */
    request: outputs.securityinsights.v20211001preview.CodelessConnectorPollingRequestPropertiesResponse;
    /**
     * Describe the response config parameters of the poller
     */
    response?: outputs.securityinsights.v20211001preview.CodelessConnectorPollingResponsePropertiesResponse;
}
...
export interface CodelessUiConnectorConfigPropertiesResponse {
     ...
     * Connector Availability Status
     */
    availability: outputs.securityinsights.v20211001preview.AvailabilityResponse;
    /**
     * Define the way the connector check connectivity
     */
    connectivityCriteria: outputs.securityinsights.v20211001preview.CodelessUiConnectorConfigPropertiesResponseConnectivityCriteria[];
    /**
     ...
     */
    dataTypes: outputs.securityinsights.v20211001preview.CodelessUiConnectorConfigPropertiesResponseDataTypes[];
    /**
     ...
     */
    graphQueries: outputs.securityinsights.v20211001preview.CodelessUiConnectorConfigPropertiesResponseGraphQueries[];
    /**
     ...
     */
    instructionSteps: outputs.securityinsights.v20211001preview.CodelessUiConnectorConfigPropertiesResponseInstructionSteps[];
    /**
     * Permissions required for the connector
     */
    permissions: outputs.securityinsights.v20211001preview.PermissionsResponse;
    /**
     ...
     */
    sampleQueries: outputs.securityinsights.v20211001preview.CodelessUiConnectorConfigPropertiesResponseSampleQueries[];
    /**
...
export interface CodelessUiConnectorConfigPropertiesResponseInstructionSteps {
     ...
     */
    instructions?: outputs.securityinsights.v20211001preview.InstructionStepsResponseInstructions[];
    /**
...
export interface Dynamics365DataConnectorDataTypesResponse {
     ...
     */
    dynamics365CdsActivities: outputs.securityinsights.v20211001preview.Dynamics365DataConnectorDataTypesResponseDynamics365CdsActivities;
}
...
export interface EntityInsightItemResponse {
     ...
     */
    chartQueryResults?: outputs.securityinsights.v20211001preview.InsightsTableResultResponse[];
    /**
     ...
     */
    queryTimeInterval?: outputs.securityinsights.v20211001preview.EntityInsightItemResponseQueryTimeInterval;
    /**
     * Query results for table insights query.
     */
    tableQueryResults?: outputs.securityinsights.v20211001preview.InsightsTableResultResponse;
}
...
export interface EntityMappingResponse {
     ...
     */
    fieldMappings?: outputs.securityinsights.v20211001preview.FieldMappingResponse[];
}
...
export interface FusionSourceSettingsResponse {
     ...
     */
    sourceSubTypes?: outputs.securityinsights.v20211001preview.FusionSourceSubTypeSettingResponse[];
}
...
export interface FusionSourceSubTypeSettingResponse {
     ...
     */
    severityFilters: outputs.securityinsights.v20211001preview.FusionSubTypeSeverityFilterResponse;
    /**
...
export interface FusionSubTypeSeverityFilterResponse {
     ...
     */
    filters?: outputs.securityinsights.v20211001preview.FusionSubTypeSeverityFiltersItemResponse[];
    /**
...
export interface GetInsightsResultsMetadataResponse {
     ...
     */
    errors?: outputs.securityinsights.v20211001preview.GetInsightsErrorResponse[];
    /**
...
export interface IncidentConfigurationResponse {
     ...
     */
    groupingConfiguration?: outputs.securityinsights.v20211001preview.GroupingConfigurationResponse;
}
...
export interface IncidentPropertiesActionResponse {
     ...
     */
    labels?: outputs.securityinsights.v20211001preview.IncidentLabelResponse[];
    /**
     * Information on the user an incident is assigned to
     */
    owner?: outputs.securityinsights.v20211001preview.IncidentOwnerInfoResponse;
    /**
     * The severity of the incident
     */
    severity?: string;
...
export interface InsightsTableResultResponse {
     ...
     */
    columns?: outputs.securityinsights.v20211001preview.InsightsTableResultResponseColumns[];
    /**
...
export interface MCASDataConnectorDataTypesResponse {
     ...
     */
    discoveryLogs?: outputs.securityinsights.v20211001preview.DataConnectorDataTypeCommonResponse;
}
...
export interface MSTIDataConnectorDataTypesResponse {
     ...
     */
    bingSafetyPhishingURL: outputs.securityinsights.v20211001preview.MSTIDataConnectorDataTypesResponseBingSafetyPhishingURL;
    /**
     * Data type for Microsoft Threat Intelligence Platforms data connector.
     */
    microsoftEmergingThreatFeed: outputs.securityinsights.v20211001preview.MSTIDataConnectorDataTypesResponseMicrosoftEmergingThreatFeed;
}
...
export interface MTPDataConnectorDataTypesResponse {
     ...
     */
    incidents: outputs.securityinsights.v20211001preview.MTPDataConnectorDataTypesResponseIncidents;
}
...
export interface MetadataDependenciesResponse {
     ...
     */
    criteria?: outputs.securityinsights.v20211001preview.MetadataDependenciesResponse[];
    /**
...
export interface Office365ProjectConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20211001preview.Office365ProjectConnectorDataTypesResponseLogs;
}
...
export interface OfficeDataConnectorDataTypesResponse {
     ...
     */
    exchange: outputs.securityinsights.v20211001preview.OfficeDataConnectorDataTypesResponseExchange;
    /**
     * SharePoint data type connection.
     */
    sharePoint: outputs.securityinsights.v20211001preview.OfficeDataConnectorDataTypesResponseSharePoint;
    /**
     * Teams data type connection.
     */
    teams: outputs.securityinsights.v20211001preview.OfficeDataConnectorDataTypesResponseTeams;
}
...
export interface OfficePowerBIConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20211001preview.OfficePowerBIConnectorDataTypesResponseLogs;
}
...
export interface PermissionsResponse {
     ...
     */
    customs?: outputs.securityinsights.v20211001preview.PermissionsResponseCustoms[];
    /**
     * Resource provider permissions required for the connector
     */
    resourceProvider?: outputs.securityinsights.v20211001preview.PermissionsResponseResourceProvider[];
}
...
export interface PermissionsResponseResourceProvider {
     ...
     */
    requiredPermissions?: outputs.securityinsights.v20211001preview.RequiredPermissionsResponse;
    /**
...
export interface PropertyConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20211001preview.AutomationRulePropertyValuesConditionResponse;
    /**
     *
...
export interface RepositoryResponse {
     ...
     */
    pathMapping?: outputs.securityinsights.v20211001preview.ContentPathMapResponse[];
    /**
     * Url of repository.
     */
    url?: string;
...
export interface TIDataConnectorDataTypesResponse {
     ...
     */
    indicators: outputs.securityinsights.v20211001preview.TIDataConnectorDataTypesResponseIndicators;
}
...
export interface TiTaxiiDataConnectorDataTypesResponse {
     ...
     */
    taxiiClient: outputs.securityinsights.v20211001preview.TiTaxiiDataConnectorDataTypesResponseTaxiiClient;
}
...
export interface TimelineResultsMetadataResponse {
     ...
     */
    aggregations: outputs.securityinsights.v20211001preview.TimelineAggregationResponse[];
    /**
     * information about the failure queries
     */
    errors?: outputs.securityinsights.v20211001preview.TimelineErrorResponse[];
    /**
