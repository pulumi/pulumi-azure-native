...
export interface AlertsDataTypeOfDataConnectorResponse {
     ...
     */
    alerts: outputs.securityinsights.v20220801preview.DataConnectorDataTypeCommonResponse;
}
...
export interface AutomationRuleModifyPropertiesActionResponse {
    actionConfiguration?: outputs.securityinsights.v20220801preview.IncidentPropertiesActionResponse;
    /**
...
export interface AutomationRuleRunPlaybookActionResponse {
    actionConfiguration?: outputs.securityinsights.v20220801preview.PlaybookActionPropertiesResponse;
    /**
     * The type of the automation rule action.
...
export interface AutomationRuleTriggeringLogicResponse {
     ...
     */
    conditions?: (outputs.securityinsights.v20220801preview.PropertyArrayChangedConditionPropertiesResponse | outputs.securityinsights.v20220801preview.PropertyChangedConditionPropertiesResponse | outputs.securityinsights.v20220801preview.PropertyConditionPropertiesResponse)[];
    /**
...
export interface AwsCloudTrailDataConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20220801preview.AwsCloudTrailDataConnectorDataTypesResponseLogs;
}
...
export interface AwsS3DataConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20220801preview.AwsS3DataConnectorDataTypesResponseLogs;
}
...
export interface BookmarkEntityMappingsResponse {
     ...
     */
    fieldMappings?: outputs.securityinsights.v20220801preview.EntityFieldMappingResponse[];
}
...
export interface BookmarkTimelineItemResponse {
     ...
     */
    createdBy?: outputs.securityinsights.v20220801preview.UserInfoResponse;
    /**
...
export interface CodelessConnectorPollingConfigPropertiesResponse {
     ...
     */
    auth: outputs.securityinsights.v20220801preview.CodelessConnectorPollingAuthPropertiesResponse;
    /**
     ...
     */
    paging?: outputs.securityinsights.v20220801preview.CodelessConnectorPollingPagingPropertiesResponse;
    /**
     * Describe the poll request config parameters of the poller
     */
    request: outputs.securityinsights.v20220801preview.CodelessConnectorPollingRequestPropertiesResponse;
    /**
     * Describe the response config parameters of the poller
     */
    response?: outputs.securityinsights.v20220801preview.CodelessConnectorPollingResponsePropertiesResponse;
}
...
export interface CodelessUiConnectorConfigPropertiesResponse {
     ...
     * Connector Availability Status
     */
    availability: outputs.securityinsights.v20220801preview.AvailabilityResponse;
    /**
     * Define the way the connector check connectivity
     */
    connectivityCriteria: outputs.securityinsights.v20220801preview.CodelessUiConnectorConfigPropertiesResponseConnectivityCriteria[];
    /**
     ...
     */
    dataTypes: outputs.securityinsights.v20220801preview.CodelessUiConnectorConfigPropertiesResponseDataTypes[];
    /**
     ...
     */
    graphQueries: outputs.securityinsights.v20220801preview.CodelessUiConnectorConfigPropertiesResponseGraphQueries[];
    /**
     ...
     */
    instructionSteps: outputs.securityinsights.v20220801preview.CodelessUiConnectorConfigPropertiesResponseInstructionSteps[];
    /**
     * Permissions required for the connector
     */
    permissions: outputs.securityinsights.v20220801preview.PermissionsResponse;
    /**
     ...
     */
    sampleQueries: outputs.securityinsights.v20220801preview.CodelessUiConnectorConfigPropertiesResponseSampleQueries[];
    /**
...
export interface CodelessUiConnectorConfigPropertiesResponseInstructionSteps {
     ...
     */
    instructions?: outputs.securityinsights.v20220801preview.InstructionStepsResponseInstructions[];
    /**
...
export interface DeploymentInfoResponse {
     ...
     */
    deployment?: outputs.securityinsights.v20220801preview.DeploymentResponse;
    /**
...
export interface Dynamics365DataConnectorDataTypesResponse {
     ...
     */
    dynamics365CdsActivities: outputs.securityinsights.v20220801preview.Dynamics365DataConnectorDataTypesResponseDynamics365CdsActivities;
}
...
export interface EntityInsightItemResponse {
     ...
     */
    chartQueryResults?: outputs.securityinsights.v20220801preview.InsightsTableResultResponse[];
    /**
     ...
     */
    queryTimeInterval?: outputs.securityinsights.v20220801preview.EntityInsightItemResponseQueryTimeInterval;
    /**
     * Query results for table insights query.
     */
    tableQueryResults?: outputs.securityinsights.v20220801preview.InsightsTableResultResponse;
}
...
export interface EntityMappingResponse {
     ...
     */
    fieldMappings?: outputs.securityinsights.v20220801preview.FieldMappingResponse[];
}
...
export interface FusionSourceSettingsResponse {
     ...
     */
    sourceSubTypes?: outputs.securityinsights.v20220801preview.FusionSourceSubTypeSettingResponse[];
}
...
export interface FusionSourceSubTypeSettingResponse {
     ...
     */
    severityFilters: outputs.securityinsights.v20220801preview.FusionSubTypeSeverityFilterResponse;
    /**
...
export interface FusionSubTypeSeverityFilterResponse {
     ...
     */
    filters?: outputs.securityinsights.v20220801preview.FusionSubTypeSeverityFiltersItemResponse[];
    /**
...
export interface GetInsightsResultsMetadataResponse {
     ...
     */
    errors?: outputs.securityinsights.v20220801preview.GetInsightsErrorKindResponse[];
    /**
...
export interface IncidentConfigurationResponse {
     ...
     */
    groupingConfiguration?: outputs.securityinsights.v20220801preview.GroupingConfigurationResponse;
}
...
export interface IncidentPropertiesActionResponse {
     ...
     */
    labels?: outputs.securityinsights.v20220801preview.IncidentLabelResponse[];
    /**
     * Information on the user an incident is assigned to
     */
    owner?: outputs.securityinsights.v20220801preview.IncidentOwnerInfoResponse;
    /**
     * The severity of the incident
     */
    severity?: string;
...
export interface InsightsTableResultResponse {
     ...
     */
    columns?: outputs.securityinsights.v20220801preview.InsightsTableResultResponseColumns[];
    /**
...
export interface MCASDataConnectorDataTypesResponse {
     ...
     */
    discoveryLogs?: outputs.securityinsights.v20220801preview.DataConnectorDataTypeCommonResponse;
}
...
export interface MSTIDataConnectorDataTypesResponse {
     ...
     */
    bingSafetyPhishingURL: outputs.securityinsights.v20220801preview.MSTIDataConnectorDataTypesResponseBingSafetyPhishingURL;
    /**
     * Data type for Microsoft Threat Intelligence Platforms data connector.
     */
    microsoftEmergingThreatFeed: outputs.securityinsights.v20220801preview.MSTIDataConnectorDataTypesResponseMicrosoftEmergingThreatFeed;
}
...
export interface MTPDataConnectorDataTypesResponse {
     ...
     */
    incidents: outputs.securityinsights.v20220801preview.MTPDataConnectorDataTypesResponseIncidents;
}
...
export interface MetadataDependenciesResponse {
     ...
     */
    criteria?: outputs.securityinsights.v20220801preview.MetadataDependenciesResponse[];
    /**
...
export interface Office365ProjectConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20220801preview.Office365ProjectConnectorDataTypesResponseLogs;
}
...
export interface OfficeDataConnectorDataTypesResponse {
     ...
     */
    exchange: outputs.securityinsights.v20220801preview.OfficeDataConnectorDataTypesResponseExchange;
    /**
     * SharePoint data type connection.
     */
    sharePoint: outputs.securityinsights.v20220801preview.OfficeDataConnectorDataTypesResponseSharePoint;
    /**
     * Teams data type connection.
     */
    teams: outputs.securityinsights.v20220801preview.OfficeDataConnectorDataTypesResponseTeams;
}
...
export interface OfficePowerBIConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs: outputs.securityinsights.v20220801preview.OfficePowerBIConnectorDataTypesResponseLogs;
}
...
export interface PermissionsResponse {
     ...
     */
    customs?: outputs.securityinsights.v20220801preview.PermissionsResponseCustoms[];
    /**
     * Resource provider permissions required for the connector
     */
    resourceProvider?: outputs.securityinsights.v20220801preview.PermissionsResponseResourceProvider[];
}
...
export interface PermissionsResponseResourceProvider {
     ...
     */
    requiredPermissions?: outputs.securityinsights.v20220801preview.RequiredPermissionsResponse;
    /**
...
export interface PropertyArrayChangedConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20220801preview.AutomationRulePropertyArrayChangedValuesConditionResponse;
    /**
     *
...
export interface PropertyChangedConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20220801preview.AutomationRulePropertyValuesChangedConditionResponse;
    /**
     *
...
export interface PropertyConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20220801preview.AutomationRulePropertyValuesConditionResponse;
    /**
     *
...
export interface RepositoryResourceInfoResponse {
     ...
     */
    azureDevOpsResourceInfo?: outputs.securityinsights.v20220801preview.AzureDevOpsResourceInfoResponse;
    /**
     * Resources created in GitHub for this source-control.
     */
    gitHubResourceInfo?: outputs.securityinsights.v20220801preview.GitHubResourceInfoResponse;
    /**
     * The webhook object created for the source-control.
     */
    webhook?: outputs.securityinsights.v20220801preview.WebhookResponse;
}
...
export interface RepositoryResponse {
     ...
     */
    pathMapping?: outputs.securityinsights.v20220801preview.ContentPathMapResponse[];
    /**
     * Url of repository.
     */
    url?: string;
...
export interface TIDataConnectorDataTypesResponse {
     ...
     */
    indicators: outputs.securityinsights.v20220801preview.TIDataConnectorDataTypesResponseIndicators;
}
...
export interface TiTaxiiDataConnectorDataTypesResponse {
     ...
     */
    taxiiClient: outputs.securityinsights.v20220801preview.TiTaxiiDataConnectorDataTypesResponseTaxiiClient;
}
...
export interface TimelineResultsMetadataResponse {
     ...
     */
    aggregations: outputs.securityinsights.v20220801preview.TimelineAggregationResponse[];
    /**
