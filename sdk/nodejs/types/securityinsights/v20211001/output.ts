...
export interface AlertsDataTypeOfDataConnectorResponse {
     ...
     */
    alerts?: outputs.securityinsights.v20211001.DataConnectorDataTypeCommonResponse;
}
...
export interface AutomationRuleModifyPropertiesActionResponse {
    actionConfiguration?: outputs.securityinsights.v20211001.IncidentPropertiesActionResponse;
    /**
...
export interface AutomationRuleRunPlaybookActionResponse {
    actionConfiguration?: outputs.securityinsights.v20211001.PlaybookActionPropertiesResponse;
    /**
     * The type of the automation rule action
...
export interface AutomationRuleTriggeringLogicResponse {
     ...
     */
    conditions?: outputs.securityinsights.v20211001.PropertyConditionPropertiesResponse[];
    /**
...
export interface AwsCloudTrailDataConnectorDataTypesResponse {
     ...
     * Logs data type.
     */
    logs?: outputs.securityinsights.v20211001.AwsCloudTrailDataConnectorDataTypesResponseLogs;
}
...
export interface EntityMappingResponse {
     ...
     */
    fieldMappings?: outputs.securityinsights.v20211001.FieldMappingResponse[];
}
...
export interface IncidentConfigurationResponse {
     ...
     */
    groupingConfiguration?: outputs.securityinsights.v20211001.GroupingConfigurationResponse;
}
...
export interface IncidentPropertiesActionResponse {
     ...
     */
    labels?: outputs.securityinsights.v20211001.IncidentLabelResponse[];
    /**
     * Information on the user an incident is assigned to
     */
    owner?: outputs.securityinsights.v20211001.IncidentOwnerInfoResponse;
    /**
     * The severity of the incident
     */
    severity?: string;
...
export interface MCASDataConnectorDataTypesResponse {
     ...
     */
    discoveryLogs?: outputs.securityinsights.v20211001.DataConnectorDataTypeCommonResponse;
}
...
export interface OfficeDataConnectorDataTypesResponse {
     ...
     */
    exchange?: outputs.securityinsights.v20211001.OfficeDataConnectorDataTypesResponseExchange;
    /**
     * SharePoint data type connection.
     */
    sharePoint?: outputs.securityinsights.v20211001.OfficeDataConnectorDataTypesResponseSharePoint;
    /**
     * Teams data type connection.
     */
    teams?: outputs.securityinsights.v20211001.OfficeDataConnectorDataTypesResponseTeams;
}
...
export interface PropertyConditionPropertiesResponse {
    conditionProperties?: outputs.securityinsights.v20211001.AutomationRulePropertyValuesConditionResponse;
    /**
     *
...
export interface TIDataConnectorDataTypesResponse {
     ...
     */
    indicators?: outputs.securityinsights.v20211001.TIDataConnectorDataTypesResponseIndicators;
}
