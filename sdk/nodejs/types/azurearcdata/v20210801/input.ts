...
export interface DataControllerPropertiesArgs {
     ...
     * Username and password for basic login authentication.
     */
    basicLoginInformation?: pulumi.Input<inputs.azurearcdata.v20210801.BasicLoginInformationArgs>;
    /**
     ...
     */
    infrastructure?: pulumi.Input<enums.azurearcdata.v20210801.Infrastructure>;
    /**
     ...
     */
    logAnalyticsWorkspaceConfig?: pulumi.Input<inputs.azurearcdata.v20210801.LogAnalyticsWorkspaceConfigArgs>;
    /**
     * Properties from the Kubernetes data controller
     */
    onPremiseProperty?: pulumi.Input<inputs.azurearcdata.v20210801.OnPremisePropertyArgs>;
    /**
     * Service principal for uploading billing, metrics and logs.
     */
    uploadServicePrincipal?: pulumi.Input<inputs.azurearcdata.v20210801.UploadServicePrincipalArgs>;
    /**
     * Properties on upload watermark.  Mostly timestamp for each upload data type
     */
    uploadWatermark?: pulumi.Input<inputs.azurearcdata.v20210801.UploadWatermarkArgs>;
}
/**
...
export interface ExtendedLocationArgs {
     ...
     */
    type?: pulumi.Input<string | enums.azurearcdata.v20210801.ExtendedLocationTypes>;
}
...
export interface K8sSchedulingArgs {
     ...
     */
    default?: pulumi.Input<inputs.azurearcdata.v20210801.K8sSchedulingOptionsArgs>;
}
...
export interface K8sSchedulingOptionsArgs {
     ...
     * The kubernetes resource limits and requests used to restrict or reserve resource usage.
     */
    resources?: pulumi.Input<inputs.azurearcdata.v20210801.K8sResourceRequirementsArgs>;
}
...
export interface SqlManagedInstanceK8sRawArgs {
     ...
     */
    spec?: pulumi.Input<inputs.azurearcdata.v20210801.SqlManagedInstanceK8sSpecArgs>;
}
...
export interface SqlManagedInstanceK8sSpecArgs {
     ...
     * The kubernetes scheduling information.
     */
    scheduling?: pulumi.Input<inputs.azurearcdata.v20210801.K8sSchedulingArgs>;
}
...
export interface SqlManagedInstancePropertiesArgs {
     ...
     * The raw kubernetes information
     */
    k8sRaw?: pulumi.Input<inputs.azurearcdata.v20210801.SqlManagedInstanceK8sRawArgs>;
    /**
     * Last uploaded date from Kubernetes cluster. Defaults to current date time
     */
    lastUploadedDate?: pulumi.Input<string>;
     ...
     */
    licenseType?: pulumi.Input<enums.azurearcdata.v20210801.ArcSqlManagedInstanceLicenseType>;
    /**
...
export interface SqlManagedInstanceSkuArgs {
     ...
     */
    tier?: pulumi.Input<enums.azurearcdata.v20210801.SqlManagedInstanceSkuTier>;
}
/**
...
export interface SqlServerInstancePropertiesArgs {
     ...
     */
    azureDefenderStatus?: pulumi.Input<string | enums.azurearcdata.v20210801.DefenderStatus>;
    /**
     ...
     * SQL Server edition.
     */
    edition?: pulumi.Input<string | enums.azurearcdata.v20210801.EditionType>;
    /**
     ...
     */
    licenseType?: pulumi.Input<string | enums.azurearcdata.v20210801.ArcSqlServerLicenseType>;
    /**
     ...
     */
    status: pulumi.Input<string | enums.azurearcdata.v20210801.ConnectionStatus>;
    /**
     ...
     * SQL Server version.
     */
    version?: pulumi.Input<string | enums.azurearcdata.v20210801.SqlVersion>;
}
