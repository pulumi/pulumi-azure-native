...
export interface EnvironmentStatusResponse {
     ...
     */
    ingress: outputs.timeseriesinsights.v20210630preview.IngressEnvironmentStatusResponse;
    /**
     * An object that represents the status of warm storage on an environment.
     */
    warmStorage: outputs.timeseriesinsights.v20210630preview.WarmStorageEnvironmentStatusResponse;
}
...
export interface IngressEnvironmentStatusResponse {
     ...
     * An object that contains the details about an environment's state.
     */
    stateDetails: outputs.timeseriesinsights.v20210630preview.EnvironmentStateDetailsResponse;
}
...
export interface LocalTimestampResponse {
     ...
     */
    timeZoneOffset?: outputs.timeseriesinsights.v20210630preview.LocalTimestampResponseTimeZoneOffset;
}
