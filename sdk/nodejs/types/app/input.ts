...
export interface AppLogsConfigurationArgs {
     ...
     */
    logAnalyticsConfiguration?: pulumi.Input<inputs.app.LogAnalyticsConfigurationArgs>;
}
...
export interface AppleArgs {
     ...
     */
    login?: pulumi.Input<inputs.app.LoginScopesArgs>;
    /**
     * The configuration settings of the Apple registration.
     */
    registration?: pulumi.Input<inputs.app.AppleRegistrationArgs>;
}
...
export interface AzureActiveDirectoryArgs {
     ...
     */
    login?: pulumi.Input<inputs.app.AzureActiveDirectoryLoginArgs>;
    /**
     * The configuration settings of the Azure Active Directory app registration.
     */
    registration?: pulumi.Input<inputs.app.AzureActiveDirectoryRegistrationArgs>;
    /**
     * The configuration settings of the Azure Active Directory token validation flow.
     */
    validation?: pulumi.Input<inputs.app.AzureActiveDirectoryValidationArgs>;
}
...
export interface AzureActiveDirectoryValidationArgs {
     ...
     */
    defaultAuthorizationPolicy?: pulumi.Input<inputs.app.DefaultAuthorizationPolicyArgs>;
    /**
     * The configuration settings of the checks that should be made while validating the JWT Claims.
     */
    jwtClaimChecks?: pulumi.Input<inputs.app.JwtClaimChecksArgs>;
}
...
export interface AzureFilePropertiesArgs {
     ...
     */
    accessMode?: pulumi.Input<string | enums.app.AccessMode>;
    /**
...
export interface AzureStaticWebAppsArgs {
     ...
     */
    registration?: pulumi.Input<inputs.app.AzureStaticWebAppsRegistrationArgs>;
}
...
export interface ConfigurationArgs {
     ...
     */
    activeRevisionsMode?: pulumi.Input<string | enums.app.ActiveRevisionsMode>;
    /**
     * Dapr configuration for the Container App.
     */
    dapr?: pulumi.Input<inputs.app.DaprArgs>;
    /**
     * Ingress configurations.
     */
    ingress?: pulumi.Input<inputs.app.IngressArgs>;
    /**
...
export interface ContainerArgs {
     ...
     */
    env?: pulumi.Input<pulumi.Input<inputs.app.EnvironmentVarArgs>[]>;
    /**
     * Container image tag.
     */
     ...
     */
    probes?: pulumi.Input<pulumi.Input<inputs.app.ContainerAppProbeArgs>[]>;
    /**
     ...
     */
    volumeMounts?: pulumi.Input<pulumi.Input<inputs.app.VolumeMountArgs>[]>;
}
...
export interface ContainerAppProbeArgs {
     ...
     */
    httpGet?: pulumi.Input<inputs.app.ContainerAppProbeHttpGetArgs>;
    /**
     ...
     */
    tcpSocket?: pulumi.Input<inputs.app.ContainerAppProbeTcpSocketArgs>;
    /**
     ...
     * The type of probe.
     */
    type?: pulumi.Input<string | enums.app.Type>;
}
...
export interface ContainerAppProbeHttpGetArgs {
     ...
     */
    httpHeaders?: pulumi.Input<pulumi.Input<inputs.app.ContainerAppProbeHttpHeadersArgs>[]>;
    /**
     ...
     */
    scheme?: pulumi.Input<string | enums.app.Scheme>;
}
...
export interface CookieExpirationArgs {
     ...
     */
    convention?: pulumi.Input<enums.app.CookieExpirationConvention>;
    /**
...
export interface CustomDomainArgs {
     ...
     */
    bindingType?: pulumi.Input<string | enums.app.BindingType>;
    /**
...
export interface CustomOpenIdConnectProviderArgs {
     ...
     */
    login?: pulumi.Input<inputs.app.OpenIdConnectLoginArgs>;
    /**
     * The configuration settings of the app registration for the custom Open ID Connect provider.
     */
    registration?: pulumi.Input<inputs.app.OpenIdConnectRegistrationArgs>;
}
...
export interface CustomScaleRuleArgs {
     ...
     */
    auth?: pulumi.Input<pulumi.Input<inputs.app.ScaleRuleAuthArgs>[]>;
    /**
...
export interface DaprArgs {
     ...
     */
    appProtocol?: pulumi.Input<string | enums.app.AppProtocol>;
    /**
...
export interface DefaultAuthorizationPolicyArgs {
     ...
     * The configuration settings of the Azure Active Directory allowed principals.
     */
    allowedPrincipals?: pulumi.Input<inputs.app.AllowedPrincipalsArgs>;
}
...
export interface FacebookArgs {
     ...
     */
    registration?: pulumi.Input<inputs.app.AppRegistrationArgs>;
}
...
export interface ForwardProxyArgs {
     ...
     */
    convention?: pulumi.Input<enums.app.ForwardProxyConvention>;
    /**
...
export interface GitHubArgs {
     ...
     */
    registration?: pulumi.Input<inputs.app.ClientRegistrationArgs>;
}
...
export interface GithubActionConfigurationArgs {
     ...
     */
    azureCredentials?: pulumi.Input<inputs.app.AzureCredentialsArgs>;
    /**
     * Context path
     */
     ...
     */
    registryInfo?: pulumi.Input<inputs.app.RegistryInfoArgs>;
    /**
     * Runtime stack
     */
...
export interface GlobalValidationArgs {
     ...
     */
    unauthenticatedClientAction?: pulumi.Input<enums.app.UnauthenticatedClientActionV2>;
}
...
export interface GoogleArgs {
     ...
     * The configuration settings of the Azure Active Directory token validation flow.
     */
    validation?: pulumi.Input<inputs.app.AllowedAudiencesValidationArgs>;
}
...
export interface HttpSettingsArgs {
     ...
     * The configuration settings of a forward proxy used to make the requests.
     */
    forwardProxy?: pulumi.Input<inputs.app.ForwardProxyArgs>;
    /**
     ...
     */
    routes?: pulumi.Input<inputs.app.HttpSettingsRoutesArgs>;
}
...
export interface IdentityProvidersArgs {
     ...
     * The configuration settings of the Apple provider.
     */
    apple?: pulumi.Input<inputs.app.AppleArgs>;
    /**
     * The configuration settings of the Azure Active directory provider.
     */
    azureActiveDirectory?: pulumi.Input<inputs.app.AzureActiveDirectoryArgs>;
    /**
     * The configuration settings of the Azure Static Web Apps provider.
     */
    azureStaticWebApps?: pulumi.Input<inputs.app.AzureStaticWebAppsArgs>;
    /**
     * The map of the name of the alias of each custom Open ID Connect provider to the
     * configuration settings of the custom Open ID Connect provider.
     */
    customOpenIdConnectProviders?: pulumi.Input<{[key: string]: pulumi.Input<inputs.app.CustomOpenIdConnectProviderArgs>}>;
    /**
     * The configuration settings of the Facebook provider.
     */
    facebook?: pulumi.Input<inputs.app.FacebookArgs>;
    /**
     * The configuration settings of the GitHub provider.
     */
    gitHub?: pulumi.Input<inputs.app.GitHubArgs>;
    /**
     * The configuration settings of the Google provider.
     */
    google?: pulumi.Input<inputs.app.GoogleArgs>;
    /**
     * The configuration settings of the Twitter provider.
     */
    twitter?: pulumi.Input<inputs.app.TwitterArgs>;
}
...
export interface IngressArgs {
     ...
     */
    customDomains?: pulumi.Input<pulumi.Input<inputs.app.CustomDomainArgs>[]>;
    /**
     ...
     */
    transport?: pulumi.Input<string | enums.app.IngressTransportMethod>;
}
/**
...
export interface LoginArgs {
     ...
     * The configuration settings of the session cookie's expiration.
     */
    cookieExpiration?: pulumi.Input<inputs.app.CookieExpirationArgs>;
    /**
     * The configuration settings of the nonce used in the login flow.
     */
    nonce?: pulumi.Input<inputs.app.NonceArgs>;
    /**
     ...
     */
    routes?: pulumi.Input<inputs.app.LoginRoutesArgs>;
}
...
export interface ManagedEnvironmentStoragePropertiesArgs {
     ...
     * Azure file properties
     */
    azureFile?: pulumi.Input<inputs.app.AzureFilePropertiesArgs>;
}
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type: pulumi.Input<string | enums.app.ManagedServiceIdentityType>;
    /**
...
export interface OpenIdConnectClientCredentialArgs {
     ...
     */
    method?: pulumi.Input<enums.app.ClientCredentialMethod>;
}
...
export interface OpenIdConnectRegistrationArgs {
     ...
     */
    clientCredential?: pulumi.Input<inputs.app.OpenIdConnectClientCredentialArgs>;
    /**
     ...
     * The configuration settings of the endpoints used for the custom Open ID Connect provider.
     */
    openIdConnectConfiguration?: pulumi.Input<inputs.app.OpenIdConnectConfigArgs>;
}
...
export interface ScaleRuleArgs {
     ...
     */
    azureQueue?: pulumi.Input<inputs.app.QueueScaleRuleArgs>;
    /**
     * Custom scale rule.
     */
    custom?: pulumi.Input<inputs.app.CustomScaleRuleArgs>;
    /**
     * HTTP requests based scaling.
     */
    http?: pulumi.Input<inputs.app.HttpScaleRuleArgs>;
    /**
     * Scale Rule Name
     */
    name?: pulumi.Input<string>;
...
export interface TemplateArgs {
     ...
     */
    containers?: pulumi.Input<pulumi.Input<inputs.app.ContainerArgs>[]>;
    /**
     ...
     */
    scale?: pulumi.Input<inputs.app.ScaleArgs>;
    /**
...
export interface TwitterArgs {
     ...
     */
    registration?: pulumi.Input<inputs.app.TwitterRegistrationArgs>;
}
...
export interface VolumeArgs {
     ...
     */
    storageType?: pulumi.Input<string | enums.app.StorageType>;
}
