...
export interface AppLogsConfigurationResponse {
     ...
     */
    logAnalyticsConfiguration?: outputs.app.v20220101preview.LogAnalyticsConfigurationResponse;
}
...
export interface AppleResponse {
     ...
     */
    login?: outputs.app.v20220101preview.LoginScopesResponse;
    /**
     * The configuration settings of the Apple registration.
     */
    registration?: outputs.app.v20220101preview.AppleRegistrationResponse;
}
...
export interface AzureActiveDirectoryResponse {
     ...
     * The configuration settings of the Azure Active Directory login flow.
     */
    login?: outputs.app.v20220101preview.AzureActiveDirectoryLoginResponse;
    /**
     * The configuration settings of the Azure Active Directory app registration.
     */
    registration?: outputs.app.v20220101preview.AzureActiveDirectoryRegistrationResponse;
    /**
     * The configuration settings of the Azure Active Directory token validation flow.
     */
    validation?: outputs.app.v20220101preview.AzureActiveDirectoryValidationResponse;
}
...
export interface AzureActiveDirectoryValidationResponse {
     ...
     */
    defaultAuthorizationPolicy?: outputs.app.v20220101preview.DefaultAuthorizationPolicyResponse;
    /**
     * The configuration settings of the checks that should be made while validating the JWT Claims.
     */
    jwtClaimChecks?: outputs.app.v20220101preview.JwtClaimChecksResponse;
}
...
export interface AzureStaticWebAppsResponse {
     ...
     */
    registration?: outputs.app.v20220101preview.AzureStaticWebAppsRegistrationResponse;
}
...
export interface ConfigurationResponse {
     ...
     */
    dapr?: outputs.app.v20220101preview.DaprResponse;
    /**
     * Ingress configurations.
     */
    ingress?: outputs.app.v20220101preview.IngressResponse;
    /**
     * Collection of private container registry credentials for containers used by the Container app
     */
    registries?: outputs.app.v20220101preview.RegistryCredentialsResponse[];
    /**
     * Collection of secrets used by a Container app
     */
    secrets?: outputs.app.v20220101preview.SecretResponse[];
}
/**
...
export function configurationResponseProvideDefaults(val: ConfigurationResponse): ConfigurationResponse {
    return {
        ...val,
        ingress: (val.ingress ? outputs.app.v20220101preview.ingressResponseProvideDefaults(val.ingress) : undefined),
    };
}
...
export interface ContainerAppProbeResponse {
     ...
     */
    httpGet?: outputs.app.v20220101preview.ContainerAppProbeResponseHttpGet;
    /**
     ...
     */
    tcpSocket?: outputs.app.v20220101preview.ContainerAppProbeResponseTcpSocket;
    /**
...
export interface ContainerAppProbeResponseHttpGet {
     ...
     */
    httpHeaders?: outputs.app.v20220101preview.ContainerAppProbeResponseHttpHeaders[];
    /**
...
export interface ContainerResponse {
     ...
     */
    env?: outputs.app.v20220101preview.EnvironmentVarResponse[];
    /**
     * Container image tag.
     */
    image?: string;
     ...
     */
    probes?: outputs.app.v20220101preview.ContainerAppProbeResponse[];
    /**
     * Container resource requirements.
     */
    resources?: outputs.app.v20220101preview.ContainerResourcesResponse;
    /**
     * Container volume mounts.
     */
    volumeMounts?: outputs.app.v20220101preview.VolumeMountResponse[];
}
...
export interface CustomHostnameAnalysisResultResponseCustomDomainVerificationFailureInfo {
     ...
     */
    details?: outputs.app.v20220101preview.CustomHostnameAnalysisResultResponseDetails[];
    /**
...
export interface CustomOpenIdConnectProviderResponse {
     ...
     */
    login?: outputs.app.v20220101preview.OpenIdConnectLoginResponse;
    /**
     * The configuration settings of the app registration for the custom Open ID Connect provider.
     */
    registration?: outputs.app.v20220101preview.OpenIdConnectRegistrationResponse;
}
...
export interface CustomScaleRuleResponse {
     ...
     */
    auth?: outputs.app.v20220101preview.ScaleRuleAuthResponse[];
    /**
...
export interface DefaultAuthorizationPolicyResponse {
     ...
     * The configuration settings of the Azure Active Directory allowed principals.
     */
    allowedPrincipals?: outputs.app.v20220101preview.AllowedPrincipalsResponse;
}
...
export interface FacebookResponse {
     ...
     */
    registration?: outputs.app.v20220101preview.AppRegistrationResponse;
}
...
export interface GitHubResponse {
     ...
     */
    registration?: outputs.app.v20220101preview.ClientRegistrationResponse;
}
...
export interface GithubActionConfigurationResponse {
     ...
     */
    azureCredentials?: outputs.app.v20220101preview.AzureCredentialsResponse;
    /**
     * Docker file path
     */
     ...
     */
    registryInfo?: outputs.app.v20220101preview.RegistryInfoResponse;
    /**
     * Runtime stack
     */
    runtimeStack?: string;
...
export interface GoogleResponse {
     ...
     * The configuration settings of the Azure Active Directory token validation flow.
     */
    validation?: outputs.app.v20220101preview.AllowedAudiencesValidationResponse;
}
...
export interface HttpSettingsResponse {
     ...
     * The configuration settings of a forward proxy used to make the requests.
     */
    forwardProxy?: outputs.app.v20220101preview.ForwardProxyResponse;
    /**
     ...
     */
    routes?: outputs.app.v20220101preview.HttpSettingsRoutesResponse;
}
...
export interface IdentityProvidersResponse {
     ...
     * The configuration settings of the Apple provider.
     */
    apple?: outputs.app.v20220101preview.AppleResponse;
    /**
     * The configuration settings of the Azure Active directory provider.
     */
    azureActiveDirectory?: outputs.app.v20220101preview.AzureActiveDirectoryResponse;
    /**
     * The configuration settings of the Azure Static Web Apps provider.
     */
    azureStaticWebApps?: outputs.app.v20220101preview.AzureStaticWebAppsResponse;
    /**
     * The map of the name of the alias of each custom Open ID Connect provider to the
     * configuration settings of the custom Open ID Connect provider.
     */
    customOpenIdConnectProviders?: {[key: string]: outputs.app.v20220101preview.CustomOpenIdConnectProviderResponse};
    /**
     * The configuration settings of the Facebook provider.
     */
    facebook?: outputs.app.v20220101preview.FacebookResponse;
    /**
     * The configuration settings of the GitHub provider.
     */
    gitHub?: outputs.app.v20220101preview.GitHubResponse;
    /**
     * The configuration settings of the Google provider.
     */
    google?: outputs.app.v20220101preview.GoogleResponse;
    /**
     * The configuration settings of the Twitter provider.
     */
    twitter?: outputs.app.v20220101preview.TwitterResponse;
}
...
export interface IngressResponse {
     ...
     */
    customDomains?: outputs.app.v20220101preview.CustomDomainResponse[];
    /**
     ...
     */
    traffic?: outputs.app.v20220101preview.TrafficWeightResponse[];
    /**
...
export interface LoginResponse {
     ...
     * The configuration settings of the session cookie's expiration.
     */
    cookieExpiration?: outputs.app.v20220101preview.CookieExpirationResponse;
    /**
     * The configuration settings of the nonce used in the login flow.
     */
    nonce?: outputs.app.v20220101preview.NonceResponse;
    /**
     ...
     */
    routes?: outputs.app.v20220101preview.LoginRoutesResponse;
}
...
export interface ManagedEnvironmentStorageResponseProperties {
     ...
     * Azure file properties
     */
    azureFile?: outputs.app.v20220101preview.AzureFilePropertiesResponse;
}
...
export interface ManagedServiceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.app.v20220101preview.UserAssignedIdentityResponse};
}
...
export interface OpenIdConnectRegistrationResponse {
     ...
     */
    clientCredential?: outputs.app.v20220101preview.OpenIdConnectClientCredentialResponse;
    /**
     ...
     * The configuration settings of the endpoints used for the custom Open ID Connect provider.
     */
    openIdConnectConfiguration?: outputs.app.v20220101preview.OpenIdConnectConfigResponse;
}
...
export interface ScaleResponse {
     ...
     * Scaling rules.
     */
    rules?: outputs.app.v20220101preview.ScaleRuleResponse[];
}
/**
...
export interface ScaleRuleResponse {
     ...
     */
    azureQueue?: outputs.app.v20220101preview.QueueScaleRuleResponse;
    /**
     * Custom scale rule.
     */
    custom?: outputs.app.v20220101preview.CustomScaleRuleResponse;
    /**
     * HTTP requests based scaling.
     */
    http?: outputs.app.v20220101preview.HttpScaleRuleResponse;
    /**
     * Scale Rule Name
     */
    name?: string;
...
export interface TemplateResponse {
     ...
     */
    containers?: outputs.app.v20220101preview.ContainerResponse[];
    /**
     ...
     */
    scale?: outputs.app.v20220101preview.ScaleResponse;
    /**
     * List of volume definitions for the Container App.
     */
    volumes?: outputs.app.v20220101preview.VolumeResponse[];
}
/**
...
export function templateResponseProvideDefaults(val: TemplateResponse): TemplateResponse {
    return {
        ...val,
        scale: (val.scale ? outputs.app.v20220101preview.scaleResponseProvideDefaults(val.scale) : undefined),
    };
}
...
export interface TwitterResponse {
     ...
     * The configuration settings of the app registration for the Twitter provider.
     */
    registration?: outputs.app.v20220101preview.TwitterRegistrationResponse;
}
