...
export interface AppLogsConfigurationArgs {
     ...
     */
    logAnalyticsConfiguration?: pulumi.Input<inputs.app.v20220101preview.LogAnalyticsConfigurationArgs>;
}
...
export interface AppleArgs {
     ...
     */
    login?: pulumi.Input<inputs.app.v20220101preview.LoginScopesArgs>;
    /**
     * The configuration settings of the Apple registration.
     */
    registration?: pulumi.Input<inputs.app.v20220101preview.AppleRegistrationArgs>;
}
...
export interface AzureActiveDirectoryArgs {
     ...
     */
    login?: pulumi.Input<inputs.app.v20220101preview.AzureActiveDirectoryLoginArgs>;
    /**
     * The configuration settings of the Azure Active Directory app registration.
     */
    registration?: pulumi.Input<inputs.app.v20220101preview.AzureActiveDirectoryRegistrationArgs>;
    /**
     * The configuration settings of the Azure Active Directory token validation flow.
     */
    validation?: pulumi.Input<inputs.app.v20220101preview.AzureActiveDirectoryValidationArgs>;
}
...
export interface AzureActiveDirectoryValidationArgs {
     ...
     */
    defaultAuthorizationPolicy?: pulumi.Input<inputs.app.v20220101preview.DefaultAuthorizationPolicyArgs>;
    /**
     * The configuration settings of the checks that should be made while validating the JWT Claims.
     */
    jwtClaimChecks?: pulumi.Input<inputs.app.v20220101preview.JwtClaimChecksArgs>;
}
...
export interface AzureFilePropertiesArgs {
     ...
     */
    accessMode?: pulumi.Input<string | enums.app.v20220101preview.AccessMode>;
    /**
...
export interface AzureStaticWebAppsArgs {
     ...
     */
    registration?: pulumi.Input<inputs.app.v20220101preview.AzureStaticWebAppsRegistrationArgs>;
}
...
export interface ConfigurationArgs {
     ...
     */
    activeRevisionsMode?: pulumi.Input<string | enums.app.v20220101preview.ActiveRevisionsMode>;
    /**
     * Dapr configuration for the Container App.
     */
    dapr?: pulumi.Input<inputs.app.v20220101preview.DaprArgs>;
    /**
     * Ingress configurations.
     */
    ingress?: pulumi.Input<inputs.app.v20220101preview.IngressArgs>;
    /**
     * Collection of private container registry credentials for containers used by the Container app
     */
    registries?: pulumi.Input<pulumi.Input<inputs.app.v20220101preview.RegistryCredentialsArgs>[]>;
    /**
...
export function configurationArgsProvideDefaults(val: ConfigurationArgs): ConfigurationArgs {
    return {
        ...val,
        ingress: (val.ingress ? pulumi.output(val.ingress).apply(inputs.app.v20220101preview.ingressArgsProvideDefaults) : undefined),
    };
}
...
export interface ContainerArgs {
     ...
     */
    env?: pulumi.Input<pulumi.Input<inputs.app.v20220101preview.EnvironmentVarArgs>[]>;
    /**
     * Container image tag.
     */
     ...
     */
    probes?: pulumi.Input<pulumi.Input<inputs.app.v20220101preview.ContainerAppProbeArgs>[]>;
    /**
     * Container resource requirements.
     */
    resources?: pulumi.Input<inputs.app.v20220101preview.ContainerResourcesArgs>;
    /**
     * Container volume mounts.
     */
    volumeMounts?: pulumi.Input<pulumi.Input<inputs.app.v20220101preview.VolumeMountArgs>[]>;
}
...
export interface ContainerAppProbeArgs {
     ...
     */
    httpGet?: pulumi.Input<inputs.app.v20220101preview.ContainerAppProbeHttpGetArgs>;
    /**
     ...
     */
    tcpSocket?: pulumi.Input<inputs.app.v20220101preview.ContainerAppProbeTcpSocketArgs>;
    /**
     ...
     * The type of probe.
     */
    type?: pulumi.Input<string | enums.app.v20220101preview.Type>;
}
...
export interface ContainerAppProbeHttpGetArgs {
     ...
     */
    httpHeaders?: pulumi.Input<pulumi.Input<inputs.app.v20220101preview.ContainerAppProbeHttpHeadersArgs>[]>;
    /**
     ...
     */
    scheme?: pulumi.Input<string | enums.app.v20220101preview.Scheme>;
}
...
export interface CookieExpirationArgs {
     ...
     */
    convention?: pulumi.Input<enums.app.v20220101preview.CookieExpirationConvention>;
    /**
...
export interface CustomDomainArgs {
     ...
     */
    bindingType?: pulumi.Input<string | enums.app.v20220101preview.BindingType>;
    /**
...
export interface CustomOpenIdConnectProviderArgs {
     ...
     */
    login?: pulumi.Input<inputs.app.v20220101preview.OpenIdConnectLoginArgs>;
    /**
     * The configuration settings of the app registration for the custom Open ID Connect provider.
     */
    registration?: pulumi.Input<inputs.app.v20220101preview.OpenIdConnectRegistrationArgs>;
}
...
export interface CustomScaleRuleArgs {
     ...
     */
    auth?: pulumi.Input<pulumi.Input<inputs.app.v20220101preview.ScaleRuleAuthArgs>[]>;
    /**
...
export interface DaprArgs {
     ...
     */
    appProtocol?: pulumi.Input<string | enums.app.v20220101preview.AppProtocol>;
    /**
...
export interface DefaultAuthorizationPolicyArgs {
     ...
     * The configuration settings of the Azure Active Directory allowed principals.
     */
    allowedPrincipals?: pulumi.Input<inputs.app.v20220101preview.AllowedPrincipalsArgs>;
}
...
export interface FacebookArgs {
     ...
     */
    registration?: pulumi.Input<inputs.app.v20220101preview.AppRegistrationArgs>;
}
...
export interface ForwardProxyArgs {
     ...
     */
    convention?: pulumi.Input<enums.app.v20220101preview.ForwardProxyConvention>;
    /**
...
export interface GitHubArgs {
     ...
     */
    registration?: pulumi.Input<inputs.app.v20220101preview.ClientRegistrationArgs>;
}
...
export interface GithubActionConfigurationArgs {
     ...
     */
    azureCredentials?: pulumi.Input<inputs.app.v20220101preview.AzureCredentialsArgs>;
    /**
     * Docker file path
     */
     ...
     */
    registryInfo?: pulumi.Input<inputs.app.v20220101preview.RegistryInfoArgs>;
    /**
     * Runtime stack
     */
...
export interface GlobalValidationArgs {
     ...
     */
    unauthenticatedClientAction?: pulumi.Input<enums.app.v20220101preview.UnauthenticatedClientActionV2>;
}
...
export interface GoogleArgs {
     ...
     * The configuration settings of the Azure Active Directory token validation flow.
     */
    validation?: pulumi.Input<inputs.app.v20220101preview.AllowedAudiencesValidationArgs>;
}
...
export interface HttpSettingsArgs {
     ...
     * The configuration settings of a forward proxy used to make the requests.
     */
    forwardProxy?: pulumi.Input<inputs.app.v20220101preview.ForwardProxyArgs>;
    /**
     ...
     */
    routes?: pulumi.Input<inputs.app.v20220101preview.HttpSettingsRoutesArgs>;
}
...
export interface IdentityProvidersArgs {
     ...
     * The configuration settings of the Apple provider.
     */
    apple?: pulumi.Input<inputs.app.v20220101preview.AppleArgs>;
    /**
     * The configuration settings of the Azure Active directory provider.
     */
    azureActiveDirectory?: pulumi.Input<inputs.app.v20220101preview.AzureActiveDirectoryArgs>;
    /**
     * The configuration settings of the Azure Static Web Apps provider.
     */
    azureStaticWebApps?: pulumi.Input<inputs.app.v20220101preview.AzureStaticWebAppsArgs>;
    /**
     * The map of the name of the alias of each custom Open ID Connect provider to the
     * configuration settings of the custom Open ID Connect provider.
     */
    customOpenIdConnectProviders?: pulumi.Input<{[key: string]: pulumi.Input<inputs.app.v20220101preview.CustomOpenIdConnectProviderArgs>}>;
    /**
     * The configuration settings of the Facebook provider.
     */
    facebook?: pulumi.Input<inputs.app.v20220101preview.FacebookArgs>;
    /**
     * The configuration settings of the GitHub provider.
     */
    gitHub?: pulumi.Input<inputs.app.v20220101preview.GitHubArgs>;
    /**
     * The configuration settings of the Google provider.
     */
    google?: pulumi.Input<inputs.app.v20220101preview.GoogleArgs>;
    /**
     * The configuration settings of the Twitter provider.
     */
    twitter?: pulumi.Input<inputs.app.v20220101preview.TwitterArgs>;
}
...
export interface IngressArgs {
     ...
     */
    customDomains?: pulumi.Input<pulumi.Input<inputs.app.v20220101preview.CustomDomainArgs>[]>;
    /**
     ...
     */
    traffic?: pulumi.Input<pulumi.Input<inputs.app.v20220101preview.TrafficWeightArgs>[]>;
    /**
     * Ingress transport protocol
     */
    transport?: pulumi.Input<string | enums.app.v20220101preview.IngressTransportMethod>;
}
/**
...
export interface LoginArgs {
     ...
     * The configuration settings of the session cookie's expiration.
     */
    cookieExpiration?: pulumi.Input<inputs.app.v20220101preview.CookieExpirationArgs>;
    /**
     * The configuration settings of the nonce used in the login flow.
     */
    nonce?: pulumi.Input<inputs.app.v20220101preview.NonceArgs>;
    /**
     ...
     */
    routes?: pulumi.Input<inputs.app.v20220101preview.LoginRoutesArgs>;
}
...
export interface ManagedEnvironmentStoragePropertiesArgs {
     ...
     * Azure file properties
     */
    azureFile?: pulumi.Input<inputs.app.v20220101preview.AzureFilePropertiesArgs>;
}
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type: pulumi.Input<string | enums.app.v20220101preview.ManagedServiceIdentityType>;
    /**
...
export interface OpenIdConnectClientCredentialArgs {
     ...
     */
    method?: pulumi.Input<enums.app.v20220101preview.ClientCredentialMethod>;
}
...
export interface OpenIdConnectRegistrationArgs {
     ...
     */
    clientCredential?: pulumi.Input<inputs.app.v20220101preview.OpenIdConnectClientCredentialArgs>;
    /**
     ...
     * The configuration settings of the endpoints used for the custom Open ID Connect provider.
     */
    openIdConnectConfiguration?: pulumi.Input<inputs.app.v20220101preview.OpenIdConnectConfigArgs>;
}
...
export interface ScaleArgs {
     ...
     * Scaling rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.app.v20220101preview.ScaleRuleArgs>[]>;
}
/**
...
export interface ScaleRuleArgs {
     ...
     */
    azureQueue?: pulumi.Input<inputs.app.v20220101preview.QueueScaleRuleArgs>;
    /**
     * Custom scale rule.
     */
    custom?: pulumi.Input<inputs.app.v20220101preview.CustomScaleRuleArgs>;
    /**
     * HTTP requests based scaling.
     */
    http?: pulumi.Input<inputs.app.v20220101preview.HttpScaleRuleArgs>;
    /**
     * Scale Rule Name
     */
    name?: pulumi.Input<string>;
...
export interface TemplateArgs {
     ...
     */
    containers?: pulumi.Input<pulumi.Input<inputs.app.v20220101preview.ContainerArgs>[]>;
    /**
     ...
     */
    scale?: pulumi.Input<inputs.app.v20220101preview.ScaleArgs>;
    /**
     * List of volume definitions for the Container App.
     */
    volumes?: pulumi.Input<pulumi.Input<inputs.app.v20220101preview.VolumeArgs>[]>;
}
/**
...
export function templateArgsProvideDefaults(val: TemplateArgs): TemplateArgs {
    return {
        ...val,
        scale: (val.scale ? pulumi.output(val.scale).apply(inputs.app.v20220101preview.scaleArgsProvideDefaults) : undefined),
    };
}
...
export interface TwitterArgs {
     ...
     */
    registration?: pulumi.Input<inputs.app.v20220101preview.TwitterRegistrationArgs>;
}
...
export interface VolumeArgs {
     ...
     */
    storageType?: pulumi.Input<string | enums.app.v20220101preview.StorageType>;
}
