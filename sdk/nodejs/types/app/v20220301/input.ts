...
export interface AppLogsConfigurationArgs {
     ...
     */
    logAnalyticsConfiguration?: pulumi.Input<inputs.app.v20220301.LogAnalyticsConfigurationArgs>;
}
...
export interface AppleArgs {
     ...
     */
    login?: pulumi.Input<inputs.app.v20220301.LoginScopesArgs>;
    /**
     * The configuration settings of the Apple registration.
     */
    registration?: pulumi.Input<inputs.app.v20220301.AppleRegistrationArgs>;
}
...
export interface AzureActiveDirectoryArgs {
     ...
     */
    login?: pulumi.Input<inputs.app.v20220301.AzureActiveDirectoryLoginArgs>;
    /**
     * The configuration settings of the Azure Active Directory app registration.
     */
    registration?: pulumi.Input<inputs.app.v20220301.AzureActiveDirectoryRegistrationArgs>;
    /**
     * The configuration settings of the Azure Active Directory token validation flow.
     */
    validation?: pulumi.Input<inputs.app.v20220301.AzureActiveDirectoryValidationArgs>;
}
...
export interface AzureActiveDirectoryValidationArgs {
     ...
     */
    defaultAuthorizationPolicy?: pulumi.Input<inputs.app.v20220301.DefaultAuthorizationPolicyArgs>;
    /**
     * The configuration settings of the checks that should be made while validating the JWT Claims.
     */
    jwtClaimChecks?: pulumi.Input<inputs.app.v20220301.JwtClaimChecksArgs>;
}
...
export interface AzureFilePropertiesArgs {
     ...
     */
    accessMode?: pulumi.Input<string | enums.app.v20220301.AccessMode>;
    /**
...
export interface AzureStaticWebAppsArgs {
     ...
     */
    registration?: pulumi.Input<inputs.app.v20220301.AzureStaticWebAppsRegistrationArgs>;
}
...
export interface ConfigurationArgs {
     ...
     */
    activeRevisionsMode?: pulumi.Input<string | enums.app.v20220301.ActiveRevisionsMode>;
    /**
     * Dapr configuration for the Container App.
     */
    dapr?: pulumi.Input<inputs.app.v20220301.DaprArgs>;
    /**
     * Ingress configurations.
     */
    ingress?: pulumi.Input<inputs.app.v20220301.IngressArgs>;
    /**
     * Collection of private container registry credentials for containers used by the Container app
     */
    registries?: pulumi.Input<pulumi.Input<inputs.app.v20220301.RegistryCredentialsArgs>[]>;
    /**
...
export function configurationArgsProvideDefaults(val: ConfigurationArgs): ConfigurationArgs {
    return {
        ...
        dapr: (val.dapr ? pulumi.output(val.dapr).apply(inputs.app.v20220301.daprArgsProvideDefaults) : undefined),
        ingress: (val.ingress ? pulumi.output(val.ingress).apply(inputs.app.v20220301.ingressArgsProvideDefaults) : undefined),
    };
}
...
export interface ContainerArgs {
     ...
     */
    env?: pulumi.Input<pulumi.Input<inputs.app.v20220301.EnvironmentVarArgs>[]>;
    /**
     * Container image tag.
     */
     ...
     */
    probes?: pulumi.Input<pulumi.Input<inputs.app.v20220301.ContainerAppProbeArgs>[]>;
    /**
     * Container resource requirements.
     */
    resources?: pulumi.Input<inputs.app.v20220301.ContainerResourcesArgs>;
    /**
     * Container volume mounts.
     */
    volumeMounts?: pulumi.Input<pulumi.Input<inputs.app.v20220301.VolumeMountArgs>[]>;
}
...
export interface ContainerAppProbeArgs {
     ...
     */
    httpGet?: pulumi.Input<inputs.app.v20220301.ContainerAppProbeHttpGetArgs>;
    /**
     ...
     */
    tcpSocket?: pulumi.Input<inputs.app.v20220301.ContainerAppProbeTcpSocketArgs>;
    /**
     ...
     * The type of probe.
     */
    type?: pulumi.Input<string | enums.app.v20220301.Type>;
}
...
export interface ContainerAppProbeHttpGetArgs {
     ...
     */
    httpHeaders?: pulumi.Input<pulumi.Input<inputs.app.v20220301.ContainerAppProbeHttpHeadersArgs>[]>;
    /**
     ...
     */
    scheme?: pulumi.Input<string | enums.app.v20220301.Scheme>;
}
...
export interface CookieExpirationArgs {
     ...
     */
    convention?: pulumi.Input<enums.app.v20220301.CookieExpirationConvention>;
    /**
...
export interface CustomDomainArgs {
     ...
     */
    bindingType?: pulumi.Input<string | enums.app.v20220301.BindingType>;
    /**
...
export interface CustomOpenIdConnectProviderArgs {
     ...
     */
    login?: pulumi.Input<inputs.app.v20220301.OpenIdConnectLoginArgs>;
    /**
     * The configuration settings of the app registration for the custom Open ID Connect provider.
     */
    registration?: pulumi.Input<inputs.app.v20220301.OpenIdConnectRegistrationArgs>;
}
...
export interface CustomScaleRuleArgs {
     ...
     */
    auth?: pulumi.Input<pulumi.Input<inputs.app.v20220301.ScaleRuleAuthArgs>[]>;
    /**
...
export interface DaprArgs {
     ...
     */
    appProtocol?: pulumi.Input<string | enums.app.v20220301.AppProtocol>;
    /**
...
export interface DefaultAuthorizationPolicyArgs {
     ...
     * The configuration settings of the Azure Active Directory allowed principals.
     */
    allowedPrincipals?: pulumi.Input<inputs.app.v20220301.AllowedPrincipalsArgs>;
}
...
export interface FacebookArgs {
     ...
     */
    registration?: pulumi.Input<inputs.app.v20220301.AppRegistrationArgs>;
}
...
export interface ForwardProxyArgs {
     ...
     */
    convention?: pulumi.Input<enums.app.v20220301.ForwardProxyConvention>;
    /**
...
export interface GitHubArgs {
     ...
     */
    registration?: pulumi.Input<inputs.app.v20220301.ClientRegistrationArgs>;
}
...
export interface GithubActionConfigurationArgs {
     ...
     */
    azureCredentials?: pulumi.Input<inputs.app.v20220301.AzureCredentialsArgs>;
    /**
     * Context path
     */
     ...
     */
    registryInfo?: pulumi.Input<inputs.app.v20220301.RegistryInfoArgs>;
    /**
     * Runtime stack
     */
...
export interface GlobalValidationArgs {
     ...
     */
    unauthenticatedClientAction?: pulumi.Input<enums.app.v20220301.UnauthenticatedClientActionV2>;
}
...
export interface GoogleArgs {
     ...
     * The configuration settings of the Azure Active Directory token validation flow.
     */
    validation?: pulumi.Input<inputs.app.v20220301.AllowedAudiencesValidationArgs>;
}
...
export interface HttpSettingsArgs {
     ...
     * The configuration settings of a forward proxy used to make the requests.
     */
    forwardProxy?: pulumi.Input<inputs.app.v20220301.ForwardProxyArgs>;
    /**
     ...
     */
    routes?: pulumi.Input<inputs.app.v20220301.HttpSettingsRoutesArgs>;
}
...
export interface IdentityProvidersArgs {
     ...
     * The configuration settings of the Apple provider.
     */
    apple?: pulumi.Input<inputs.app.v20220301.AppleArgs>;
    /**
     * The configuration settings of the Azure Active directory provider.
     */
    azureActiveDirectory?: pulumi.Input<inputs.app.v20220301.AzureActiveDirectoryArgs>;
    /**
     * The configuration settings of the Azure Static Web Apps provider.
     */
    azureStaticWebApps?: pulumi.Input<inputs.app.v20220301.AzureStaticWebAppsArgs>;
    /**
     * The map of the name of the alias of each custom Open ID Connect provider to the
     * configuration settings of the custom Open ID Connect provider.
     */
    customOpenIdConnectProviders?: pulumi.Input<{[key: string]: pulumi.Input<inputs.app.v20220301.CustomOpenIdConnectProviderArgs>}>;
    /**
     * The configuration settings of the Facebook provider.
     */
    facebook?: pulumi.Input<inputs.app.v20220301.FacebookArgs>;
    /**
     * The configuration settings of the GitHub provider.
     */
    gitHub?: pulumi.Input<inputs.app.v20220301.GitHubArgs>;
    /**
     * The configuration settings of the Google provider.
     */
    google?: pulumi.Input<inputs.app.v20220301.GoogleArgs>;
    /**
     * The configuration settings of the Twitter provider.
     */
    twitter?: pulumi.Input<inputs.app.v20220301.TwitterArgs>;
}
...
export interface IngressArgs {
     ...
     */
    customDomains?: pulumi.Input<pulumi.Input<inputs.app.v20220301.CustomDomainArgs>[]>;
    /**
     ...
     */
    traffic?: pulumi.Input<pulumi.Input<inputs.app.v20220301.TrafficWeightArgs>[]>;
    /**
     * Ingress transport protocol
     */
    transport?: pulumi.Input<string | enums.app.v20220301.IngressTransportMethod>;
}
/**
...
export interface LoginArgs {
     ...
     * The configuration settings of the session cookie's expiration.
     */
    cookieExpiration?: pulumi.Input<inputs.app.v20220301.CookieExpirationArgs>;
    /**
     * The configuration settings of the nonce used in the login flow.
     */
    nonce?: pulumi.Input<inputs.app.v20220301.NonceArgs>;
    /**
     ...
     */
    routes?: pulumi.Input<inputs.app.v20220301.LoginRoutesArgs>;
}
...
export interface ManagedEnvironmentStoragePropertiesArgs {
     ...
     * Azure file properties
     */
    azureFile?: pulumi.Input<inputs.app.v20220301.AzureFilePropertiesArgs>;
}
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type: pulumi.Input<string | enums.app.v20220301.ManagedServiceIdentityType>;
    /**
...
export interface OpenIdConnectClientCredentialArgs {
     ...
     */
    method?: pulumi.Input<enums.app.v20220301.ClientCredentialMethod>;
}
...
export interface OpenIdConnectRegistrationArgs {
     ...
     */
    clientCredential?: pulumi.Input<inputs.app.v20220301.OpenIdConnectClientCredentialArgs>;
    /**
     ...
     * The configuration settings of the endpoints used for the custom Open ID Connect provider.
     */
    openIdConnectConfiguration?: pulumi.Input<inputs.app.v20220301.OpenIdConnectConfigArgs>;
}
...
export interface ScaleArgs {
     ...
     * Scaling rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.app.v20220301.ScaleRuleArgs>[]>;
}
/**
...
export interface ScaleRuleArgs {
     ...
     */
    azureQueue?: pulumi.Input<inputs.app.v20220301.QueueScaleRuleArgs>;
    /**
     * Custom scale rule.
     */
    custom?: pulumi.Input<inputs.app.v20220301.CustomScaleRuleArgs>;
    /**
     * HTTP requests based scaling.
     */
    http?: pulumi.Input<inputs.app.v20220301.HttpScaleRuleArgs>;
    /**
     * Scale Rule Name
     */
    name?: pulumi.Input<string>;
...
export interface TemplateArgs {
     ...
     */
    containers?: pulumi.Input<pulumi.Input<inputs.app.v20220301.ContainerArgs>[]>;
    /**
     ...
     */
    scale?: pulumi.Input<inputs.app.v20220301.ScaleArgs>;
    /**
     * List of volume definitions for the Container App.
     */
    volumes?: pulumi.Input<pulumi.Input<inputs.app.v20220301.VolumeArgs>[]>;
}
/**
...
export function templateArgsProvideDefaults(val: TemplateArgs): TemplateArgs {
    return {
        ...val,
        scale: (val.scale ? pulumi.output(val.scale).apply(inputs.app.v20220301.scaleArgsProvideDefaults) : undefined),
    };
}
...
export interface TwitterArgs {
     ...
     */
    registration?: pulumi.Input<inputs.app.v20220301.TwitterRegistrationArgs>;
}
...
export interface VolumeArgs {
     ...
     */
    storageType?: pulumi.Input<string | enums.app.v20220301.StorageType>;
}
