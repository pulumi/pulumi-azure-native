...
export interface AppLogsConfigurationResponse {
     ...
     */
    logAnalyticsConfiguration?: outputs.app.v20220301.LogAnalyticsConfigurationResponse;
}
...
export interface AppleResponse {
     ...
     */
    login?: outputs.app.v20220301.LoginScopesResponse;
    /**
     * The configuration settings of the Apple registration.
     */
    registration?: outputs.app.v20220301.AppleRegistrationResponse;
}
...
export interface AzureActiveDirectoryResponse {
     ...
     * The configuration settings of the Azure Active Directory login flow.
     */
    login?: outputs.app.v20220301.AzureActiveDirectoryLoginResponse;
    /**
     * The configuration settings of the Azure Active Directory app registration.
     */
    registration?: outputs.app.v20220301.AzureActiveDirectoryRegistrationResponse;
    /**
     * The configuration settings of the Azure Active Directory token validation flow.
     */
    validation?: outputs.app.v20220301.AzureActiveDirectoryValidationResponse;
}
...
export interface AzureActiveDirectoryValidationResponse {
     ...
     */
    defaultAuthorizationPolicy?: outputs.app.v20220301.DefaultAuthorizationPolicyResponse;
    /**
     * The configuration settings of the checks that should be made while validating the JWT Claims.
     */
    jwtClaimChecks?: outputs.app.v20220301.JwtClaimChecksResponse;
}
...
export interface AzureStaticWebAppsResponse {
     ...
     */
    registration?: outputs.app.v20220301.AzureStaticWebAppsRegistrationResponse;
}
...
export interface ConfigurationResponse {
     ...
     */
    dapr?: outputs.app.v20220301.DaprResponse;
    /**
     * Ingress configurations.
     */
    ingress?: outputs.app.v20220301.IngressResponse;
    /**
     * Collection of private container registry credentials for containers used by the Container app
     */
    registries?: outputs.app.v20220301.RegistryCredentialsResponse[];
    /**
     * Collection of secrets used by a Container app
     */
    secrets?: outputs.app.v20220301.SecretResponse[];
}
/**
...
export function configurationResponseProvideDefaults(val: ConfigurationResponse): ConfigurationResponse {
    return {
        ...
        dapr: (val.dapr ? outputs.app.v20220301.daprResponseProvideDefaults(val.dapr) : undefined),
        ingress: (val.ingress ? outputs.app.v20220301.ingressResponseProvideDefaults(val.ingress) : undefined),
    };
}
...
export interface ContainerAppProbeResponse {
     ...
     */
    httpGet?: outputs.app.v20220301.ContainerAppProbeResponseHttpGet;
    /**
     ...
     */
    tcpSocket?: outputs.app.v20220301.ContainerAppProbeResponseTcpSocket;
    /**
...
export interface ContainerAppProbeResponseHttpGet {
     ...
     */
    httpHeaders?: outputs.app.v20220301.ContainerAppProbeResponseHttpHeaders[];
    /**
...
export interface ContainerResponse {
     ...
     */
    env?: outputs.app.v20220301.EnvironmentVarResponse[];
    /**
     * Container image tag.
     */
    image?: string;
     ...
     */
    probes?: outputs.app.v20220301.ContainerAppProbeResponse[];
    /**
     * Container resource requirements.
     */
    resources?: outputs.app.v20220301.ContainerResourcesResponse;
    /**
     * Container volume mounts.
     */
    volumeMounts?: outputs.app.v20220301.VolumeMountResponse[];
}
...
export interface CustomHostnameAnalysisResultResponseCustomDomainVerificationFailureInfo {
     ...
     */
    details?: outputs.app.v20220301.CustomHostnameAnalysisResultResponseDetails[];
    /**
...
export interface CustomOpenIdConnectProviderResponse {
     ...
     */
    login?: outputs.app.v20220301.OpenIdConnectLoginResponse;
    /**
     * The configuration settings of the app registration for the custom Open ID Connect provider.
     */
    registration?: outputs.app.v20220301.OpenIdConnectRegistrationResponse;
}
...
export interface CustomScaleRuleResponse {
     ...
     */
    auth?: outputs.app.v20220301.ScaleRuleAuthResponse[];
    /**
...
export interface DefaultAuthorizationPolicyResponse {
     ...
     * The configuration settings of the Azure Active Directory allowed principals.
     */
    allowedPrincipals?: outputs.app.v20220301.AllowedPrincipalsResponse;
}
...
export interface FacebookResponse {
     ...
     */
    registration?: outputs.app.v20220301.AppRegistrationResponse;
}
...
export interface GitHubResponse {
     ...
     */
    registration?: outputs.app.v20220301.ClientRegistrationResponse;
}
...
export interface GithubActionConfigurationResponse {
     ...
     */
    azureCredentials?: outputs.app.v20220301.AzureCredentialsResponse;
    /**
     * Context path
     */
    contextPath?: string;
     ...
     */
    registryInfo?: outputs.app.v20220301.RegistryInfoResponse;
    /**
     * Runtime stack
     */
    runtimeStack?: string;
...
export interface GoogleResponse {
     ...
     * The configuration settings of the Azure Active Directory token validation flow.
     */
    validation?: outputs.app.v20220301.AllowedAudiencesValidationResponse;
}
...
export interface HttpSettingsResponse {
     ...
     * The configuration settings of a forward proxy used to make the requests.
     */
    forwardProxy?: outputs.app.v20220301.ForwardProxyResponse;
    /**
     ...
     */
    routes?: outputs.app.v20220301.HttpSettingsRoutesResponse;
}
...
export interface IdentityProvidersResponse {
     ...
     * The configuration settings of the Apple provider.
     */
    apple?: outputs.app.v20220301.AppleResponse;
    /**
     * The configuration settings of the Azure Active directory provider.
     */
    azureActiveDirectory?: outputs.app.v20220301.AzureActiveDirectoryResponse;
    /**
     * The configuration settings of the Azure Static Web Apps provider.
     */
    azureStaticWebApps?: outputs.app.v20220301.AzureStaticWebAppsResponse;
    /**
     * The map of the name of the alias of each custom Open ID Connect provider to the
     * configuration settings of the custom Open ID Connect provider.
     */
    customOpenIdConnectProviders?: {[key: string]: outputs.app.v20220301.CustomOpenIdConnectProviderResponse};
    /**
     * The configuration settings of the Facebook provider.
     */
    facebook?: outputs.app.v20220301.FacebookResponse;
    /**
     * The configuration settings of the GitHub provider.
     */
    gitHub?: outputs.app.v20220301.GitHubResponse;
    /**
     * The configuration settings of the Google provider.
     */
    google?: outputs.app.v20220301.GoogleResponse;
    /**
     * The configuration settings of the Twitter provider.
     */
    twitter?: outputs.app.v20220301.TwitterResponse;
}
...
export interface IngressResponse {
     ...
     */
    customDomains?: outputs.app.v20220301.CustomDomainResponse[];
    /**
     ...
     */
    traffic?: outputs.app.v20220301.TrafficWeightResponse[];
    /**
...
export interface LoginResponse {
     ...
     * The configuration settings of the session cookie's expiration.
     */
    cookieExpiration?: outputs.app.v20220301.CookieExpirationResponse;
    /**
     * The configuration settings of the nonce used in the login flow.
     */
    nonce?: outputs.app.v20220301.NonceResponse;
    /**
     ...
     */
    routes?: outputs.app.v20220301.LoginRoutesResponse;
}
...
export interface ManagedEnvironmentStorageResponseProperties {
     ...
     * Azure file properties
     */
    azureFile?: outputs.app.v20220301.AzureFilePropertiesResponse;
}
...
export interface ManagedServiceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.app.v20220301.UserAssignedIdentityResponse};
}
...
export interface OpenIdConnectRegistrationResponse {
     ...
     */
    clientCredential?: outputs.app.v20220301.OpenIdConnectClientCredentialResponse;
    /**
     ...
     * The configuration settings of the endpoints used for the custom Open ID Connect provider.
     */
    openIdConnectConfiguration?: outputs.app.v20220301.OpenIdConnectConfigResponse;
}
...
export interface ScaleResponse {
     ...
     * Scaling rules.
     */
    rules?: outputs.app.v20220301.ScaleRuleResponse[];
}
/**
...
export interface ScaleRuleResponse {
     ...
     */
    azureQueue?: outputs.app.v20220301.QueueScaleRuleResponse;
    /**
     * Custom scale rule.
     */
    custom?: outputs.app.v20220301.CustomScaleRuleResponse;
    /**
     * HTTP requests based scaling.
     */
    http?: outputs.app.v20220301.HttpScaleRuleResponse;
    /**
     * Scale Rule Name
     */
    name?: string;
...
export interface TemplateResponse {
     ...
     */
    containers?: outputs.app.v20220301.ContainerResponse[];
    /**
     ...
     */
    scale?: outputs.app.v20220301.ScaleResponse;
    /**
     * List of volume definitions for the Container App.
     */
    volumes?: outputs.app.v20220301.VolumeResponse[];
}
/**
...
export function templateResponseProvideDefaults(val: TemplateResponse): TemplateResponse {
    return {
        ...val,
        scale: (val.scale ? outputs.app.v20220301.scaleResponseProvideDefaults(val.scale) : undefined),
    };
}
...
export interface TwitterResponse {
     ...
     * The configuration settings of the app registration for the Twitter provider.
     */
    registration?: outputs.app.v20220301.TwitterRegistrationResponse;
}
