...
export interface AutoUserSpecificationArgs {
     ...
     */
    elevationLevel?: pulumi.Input<enums.batch.v20200901.ElevationLevel>;
    /**
     * The default value is Pool. If the pool is running Windows a value of Task should be specified if stricter isolation between tasks is required. For example, if the task mutates the registry in a way which could impact other tasks, or if certificates have been specified on the pool which should not be accessible by normal tasks but should be accessible by start tasks.
     */
    scope?: pulumi.Input<enums.batch.v20200901.AutoUserScope>;
}
...
export interface BatchAccountIdentityArgs {
     ...
     */
    type: pulumi.Input<enums.batch.v20200901.ResourceIdentityType>;
}
...
export interface CertificateReferenceArgs {
     ...
     */
    storeLocation?: pulumi.Input<enums.batch.v20200901.CertificateStoreLocation>;
    /**
     * This property is applicable only for pools configured with Windows nodes (that is, created with cloudServiceConfiguration, or with virtualMachineConfiguration using a Windows image reference). Common store names include: My, Root, CA, Trust, Disallowed, TrustedPeople, TrustedPublisher, AuthRoot, AddressBook, but any custom store name can also be used. The default value is My.
     */
    storeName?: pulumi.Input<string>;
    visibility?: pulumi.Input<pulumi.Input<enums.batch.v20200901.CertificateVisibility>[]>;
}
...
export interface ContainerConfigurationArgs {
     ...
     */
    containerRegistries?: pulumi.Input<pulumi.Input<inputs.batch.v20200901.ContainerRegistryArgs>[]>;
    type: pulumi.Input<enums.batch.v20200901.ContainerType>;
}
...
export interface DataDiskArgs {
     ...
     */
    caching?: pulumi.Input<enums.batch.v20200901.CachingType>;
     ...
     */
    storageAccountType?: pulumi.Input<enums.batch.v20200901.StorageAccountType>;
}
...
export interface DeploymentConfigurationArgs {
     ...
     */
    cloudServiceConfiguration?: pulumi.Input<inputs.batch.v20200901.CloudServiceConfigurationArgs>;
    /**
     * This property and cloudServiceConfiguration are mutually exclusive and one of the properties must be specified.
     */
    virtualMachineConfiguration?: pulumi.Input<inputs.batch.v20200901.VirtualMachineConfigurationArgs>;
}
...
export interface DiskEncryptionConfigurationArgs {
     ...
     */
    targets?: pulumi.Input<pulumi.Input<enums.batch.v20200901.DiskEncryptionTarget>[]>;
}
...
export interface EncryptionPropertiesArgs {
     ...
     */
    keySource?: pulumi.Input<enums.batch.v20200901.KeySource>;
    /**
     * Additional details when using Microsoft.KeyVault
     */
    keyVaultProperties?: pulumi.Input<inputs.batch.v20200901.KeyVaultPropertiesArgs>;
}
...
export interface FixedScaleSettingsArgs {
     ...
     */
    nodeDeallocationOption?: pulumi.Input<enums.batch.v20200901.ComputeNodeDeallocationOption>;
    /**
...
export interface InboundNatPoolArgs {
     ...
     */
    networkSecurityGroupRules?: pulumi.Input<pulumi.Input<inputs.batch.v20200901.NetworkSecurityGroupRuleArgs>[]>;
    protocol: pulumi.Input<enums.batch.v20200901.InboundEndpointProtocol>;
}
...
export interface MountConfigurationArgs {
     ...
     */
    azureBlobFileSystemConfiguration?: pulumi.Input<inputs.batch.v20200901.AzureBlobFileSystemConfigurationArgs>;
    /**
     * This property is mutually exclusive with all other properties.
     */
    azureFileShareConfiguration?: pulumi.Input<inputs.batch.v20200901.AzureFileShareConfigurationArgs>;
    /**
     * This property is mutually exclusive with all other properties.
     */
    cifsMountConfiguration?: pulumi.Input<inputs.batch.v20200901.CIFSMountConfigurationArgs>;
    /**
     * This property is mutually exclusive with all other properties.
     */
    nfsMountConfiguration?: pulumi.Input<inputs.batch.v20200901.NFSMountConfigurationArgs>;
}
...
export interface NetworkConfigurationArgs {
     ...
     */
    endpointConfiguration?: pulumi.Input<inputs.batch.v20200901.PoolEndpointConfigurationArgs>;
    /**
     * This property is only supported on Pools with the virtualMachineConfiguration property.
     */
    publicIPAddressConfiguration?: pulumi.Input<inputs.batch.v20200901.PublicIPAddressConfigurationArgs>;
    /**
...
export interface NetworkSecurityGroupRuleArgs {
    access: pulumi.Input<enums.batch.v20200901.NetworkSecurityGroupRuleAccess>;
    /**
...
export interface PoolEndpointConfigurationArgs {
     ...
     */
    inboundNatPools: pulumi.Input<pulumi.Input<inputs.batch.v20200901.InboundNatPoolArgs>[]>;
}
...
export interface PublicIPAddressConfigurationArgs {
     ...
     */
    provision?: pulumi.Input<enums.batch.v20200901.IPAddressProvisioningType>;
}
...
export interface ScaleSettingsArgs {
     ...
     */
    autoScale?: pulumi.Input<inputs.batch.v20200901.AutoScaleSettingsArgs>;
    /**
     * This property and autoScale are mutually exclusive and one of the properties must be specified.
     */
    fixedScale?: pulumi.Input<inputs.batch.v20200901.FixedScaleSettingsArgs>;
}
...
export interface StartTaskArgs {
     ...
     */
    containerSettings?: pulumi.Input<inputs.batch.v20200901.TaskContainerSettingsArgs>;
    environmentSettings?: pulumi.Input<pulumi.Input<inputs.batch.v20200901.EnvironmentSettingArgs>[]>;
    /**
    ...
    resourceFiles?: pulumi.Input<pulumi.Input<inputs.batch.v20200901.ResourceFileArgs>[]>;
    /**
     * If omitted, the task runs as a non-administrative user unique to the task.
     */
    userIdentity?: pulumi.Input<inputs.batch.v20200901.UserIdentityArgs>;
    /**
...
export interface TaskContainerSettingsArgs {
     ...
     */
    registry?: pulumi.Input<inputs.batch.v20200901.ContainerRegistryArgs>;
    workingDirectory?: pulumi.Input<enums.batch.v20200901.ContainerWorkingDirectory>;
}

export interface TaskSchedulingPolicyArgs {
    nodeFillType: pulumi.Input<enums.batch.v20200901.ComputeNodeFillType>;
}
...
export interface UserAccountArgs {
     ...
     */
    linuxUserConfiguration?: pulumi.Input<inputs.batch.v20200901.LinuxUserConfigurationArgs>;
    name: pulumi.Input<string>;
    password: pulumi.Input<string>;
    /**
     * This property can only be specified if the user is on a Windows pool. If not specified and on a Windows pool, the user is created with the default options.
     */
    windowsUserConfiguration?: pulumi.Input<inputs.batch.v20200901.WindowsUserConfigurationArgs>;
}
...
export interface UserIdentityArgs {
     ...
     */
    autoUser?: pulumi.Input<inputs.batch.v20200901.AutoUserSpecificationArgs>;
    /**
     * The userName and autoUser properties are mutually exclusive; you must specify one but not both.
     */
    userName?: pulumi.Input<string>;
...
export interface VirtualMachineConfigurationArgs {
     ...
     */
    containerConfiguration?: pulumi.Input<inputs.batch.v20200901.ContainerConfigurationArgs>;
    /**
     * This property must be specified if the compute nodes in the pool need to have empty data disks attached to them.
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.batch.v20200901.DataDiskArgs>[]>;
    /**
     * If specified, encryption is performed on each node in the pool during node provisioning.
     */
    diskEncryptionConfiguration?: pulumi.Input<inputs.batch.v20200901.DiskEncryptionConfigurationArgs>;
    imageReference: pulumi.Input<inputs.batch.v20200901.ImageReferenceArgs>;
    /**
     ...
     */
    windowsConfiguration?: pulumi.Input<inputs.batch.v20200901.WindowsConfigurationArgs>;
}
...
export interface WindowsUserConfigurationArgs {
     ...
     */
    loginMode?: pulumi.Input<enums.batch.v20200901.LoginMode>;
}
