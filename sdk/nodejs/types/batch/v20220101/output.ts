...
export interface AutoScaleRunErrorResponse {
     ...
     */
    code: string;
    details?: outputs.batch.v20220101.AutoScaleRunErrorResponse[];
    /**
...
export interface AutoScaleRunResponse {
    error?: outputs.batch.v20220101.AutoScaleRunErrorResponse;
...
export interface AutoStoragePropertiesResponse {
     ...
     */
    nodeIdentityReference?: outputs.batch.v20220101.ComputeNodeIdentityReferenceResponse;
    /**
...
export interface AzureBlobFileSystemConfigurationResponse {
     ...
     */
    identityReference?: outputs.batch.v20220101.ComputeNodeIdentityReferenceResponse;
    /**
...
export interface BatchAccountIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.batch.v20220101.UserAssignedIdentitiesResponse};
}
...
export interface ContainerConfigurationResponse {
     ...
     */
    containerRegistries?: outputs.batch.v20220101.ContainerRegistryResponse[];
    type: string;
}
...
export interface DeleteCertificateErrorResponse {
     ...
     */
    details?: outputs.batch.v20220101.DeleteCertificateErrorResponse[];
    /**
     * A message describing the error, intended to be suitable for display in a user interface.
     */
    message: string;
...
export interface DeploymentConfigurationResponse {
     ...
     */
    cloudServiceConfiguration?: outputs.batch.v20220101.CloudServiceConfigurationResponse;
    /**
     * This property and cloudServiceConfiguration are mutually exclusive and one of the properties must be specified.
     */
    virtualMachineConfiguration?: outputs.batch.v20220101.VirtualMachineConfigurationResponse;
}
...
export interface EncryptionPropertiesResponse {
     ...
     */
    keyVaultProperties?: outputs.batch.v20220101.KeyVaultPropertiesResponse;
}
...
export interface InboundNatPoolResponse {
     ...
     */
    networkSecurityGroupRules?: outputs.batch.v20220101.NetworkSecurityGroupRuleResponse[];
    protocol: string;
}
...
export interface MountConfigurationResponse {
     ...
     */
    azureBlobFileSystemConfiguration?: outputs.batch.v20220101.AzureBlobFileSystemConfigurationResponse;
    /**
     * This property is mutually exclusive with all other properties.
     */
    azureFileShareConfiguration?: outputs.batch.v20220101.AzureFileShareConfigurationResponse;
    /**
     * This property is mutually exclusive with all other properties.
     */
    cifsMountConfiguration?: outputs.batch.v20220101.CIFSMountConfigurationResponse;
    /**
     * This property is mutually exclusive with all other properties.
     */
    nfsMountConfiguration?: outputs.batch.v20220101.NFSMountConfigurationResponse;
}
...
export interface NetworkConfigurationResponse {
     ...
     */
    endpointConfiguration?: outputs.batch.v20220101.PoolEndpointConfigurationResponse;
    /**
     * This property is only supported on Pools with the virtualMachineConfiguration property.
     */
    publicIPAddressConfiguration?: outputs.batch.v20220101.PublicIPAddressConfigurationResponse;
    /**
...
export interface OSDiskResponse {
    ephemeralOSDiskSettings?: outputs.batch.v20220101.DiffDiskSettingsResponse;
}
...
export interface PoolEndpointConfigurationResponse {
     ...
     */
    inboundNatPools: outputs.batch.v20220101.InboundNatPoolResponse[];
}
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.batch.v20220101.PrivateEndpointResponse;
    /**
     * The private link service connection state of the private endpoint connection
     */
    privateLinkServiceConnectionState?: outputs.batch.v20220101.PrivateLinkServiceConnectionStateResponse;
...
export interface ResizeErrorResponse {
     ...
     */
    code: string;
    details?: outputs.batch.v20220101.ResizeErrorResponse[];
    /**
     * A message describing the error, intended to be suitable for display in a user interface.
     */
    message: string;
...
export interface ResizeOperationStatusResponse {
     ...
     */
    errors?: outputs.batch.v20220101.ResizeErrorResponse[];
    /**
...
export interface ScaleSettingsResponse {
     ...
     */
    autoScale?: outputs.batch.v20220101.AutoScaleSettingsResponse;
    /**
     * This property and autoScale are mutually exclusive and one of the properties must be specified.
     */
    fixedScale?: outputs.batch.v20220101.FixedScaleSettingsResponse;
}
...
export interface StartTaskResponse {
     ...
     */
    containerSettings?: outputs.batch.v20220101.TaskContainerSettingsResponse;
    environmentSettings?: outputs.batch.v20220101.EnvironmentSettingResponse[];
    /**
    ...
    resourceFiles?: outputs.batch.v20220101.ResourceFileResponse[];
    /**
     * If omitted, the task runs as a non-administrative user unique to the task.
     */
    userIdentity?: outputs.batch.v20220101.UserIdentityResponse;
    /**
...
export interface TaskContainerSettingsResponse {
     ...
     */
    registry?: outputs.batch.v20220101.ContainerRegistryResponse;
...
export interface UserAccountResponse {
     ...
     */
    linuxUserConfiguration?: outputs.batch.v20220101.LinuxUserConfigurationResponse;
    name: string;
    password: string;
    /**
     * This property can only be specified if the user is on a Windows pool. If not specified and on a Windows pool, the user is created with the default options.
     */
    windowsUserConfiguration?: outputs.batch.v20220101.WindowsUserConfigurationResponse;
}
...
export interface UserIdentityResponse {
     ...
     */
    autoUser?: outputs.batch.v20220101.AutoUserSpecificationResponse;
    /**
     * The userName and autoUser properties are mutually exclusive; you must specify one but not both.
     */
    userName?: string;
...
export interface VirtualMachineConfigurationResponse {
     ...
     */
    containerConfiguration?: outputs.batch.v20220101.ContainerConfigurationResponse;
    /**
     * This property must be specified if the compute nodes in the pool need to have empty data disks attached to them.
     */
    dataDisks?: outputs.batch.v20220101.DataDiskResponse[];
    /**
     * If specified, encryption is performed on each node in the pool during node provisioning.
     */
    diskEncryptionConfiguration?: outputs.batch.v20220101.DiskEncryptionConfigurationResponse;
    /**
     * If specified, the extensions mentioned in this configuration will be installed on each node.
     */
    extensions?: outputs.batch.v20220101.VMExtensionResponse[];
    imageReference: outputs.batch.v20220101.ImageReferenceResponse;
    /**
     ...
     */
    nodePlacementConfiguration?: outputs.batch.v20220101.NodePlacementConfigurationResponse;
    /**
     * Contains configuration for ephemeral OSDisk settings.
     */
    osDisk?: outputs.batch.v20220101.OSDiskResponse;
    /**
     * This property must not be specified if the imageReference specifies a Linux OS image.
     */
    windowsConfiguration?: outputs.batch.v20220101.WindowsConfigurationResponse;
}
