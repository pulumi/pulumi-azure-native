...
export interface AutoUserSpecificationArgs {
     ...
     */
    elevationLevel?: pulumi.Input<enums.batch.v20181201.ElevationLevel>;
    /**
     * The default value is task.
     */
    scope?: pulumi.Input<enums.batch.v20181201.AutoUserScope>;
}
...
export interface CertificateReferenceArgs {
     ...
     */
    storeLocation?: pulumi.Input<enums.batch.v20181201.CertificateStoreLocation>;
    /**
     * This property is applicable only for pools configured with Windows nodes (that is, created with cloudServiceConfiguration, or with virtualMachineConfiguration using a Windows image reference). Common store names include: My, Root, CA, Trust, Disallowed, TrustedPeople, TrustedPublisher, AuthRoot, AddressBook, but any custom store name can also be used. The default value is My.
     */
    storeName?: pulumi.Input<string>;
    visibility?: pulumi.Input<pulumi.Input<enums.batch.v20181201.CertificateVisibility>[]>;
}
...
export interface ContainerConfigurationArgs {
     ...
     */
    containerRegistries?: pulumi.Input<pulumi.Input<inputs.batch.v20181201.ContainerRegistryArgs>[]>;
    type: pulumi.Input<enums.batch.v20181201.ContainerType>;
}
...
export interface DataDiskArgs {
     ...
     */
    caching?: pulumi.Input<enums.batch.v20181201.CachingType>;
     ...
     */
    storageAccountType?: pulumi.Input<enums.batch.v20181201.StorageAccountType>;
}
...
export interface DeploymentConfigurationArgs {
     ...
     */
    cloudServiceConfiguration?: pulumi.Input<inputs.batch.v20181201.CloudServiceConfigurationArgs>;
    /**
     * This property and cloudServiceConfiguration are mutually exclusive and one of the properties must be specified.
     */
    virtualMachineConfiguration?: pulumi.Input<inputs.batch.v20181201.VirtualMachineConfigurationArgs>;
}
...
export interface FixedScaleSettingsArgs {
     ...
     */
    nodeDeallocationOption?: pulumi.Input<enums.batch.v20181201.ComputeNodeDeallocationOption>;
    /**
...
export interface InboundNatPoolArgs {
     ...
     */
    networkSecurityGroupRules?: pulumi.Input<pulumi.Input<inputs.batch.v20181201.NetworkSecurityGroupRuleArgs>[]>;
    protocol: pulumi.Input<enums.batch.v20181201.InboundEndpointProtocol>;
}
...
export interface NetworkConfigurationArgs {
     ...
     */
    endpointConfiguration?: pulumi.Input<inputs.batch.v20181201.PoolEndpointConfigurationArgs>;
    /**
...
export interface NetworkSecurityGroupRuleArgs {
    access: pulumi.Input<enums.batch.v20181201.NetworkSecurityGroupRuleAccess>;
    /**
...
export interface PoolEndpointConfigurationArgs {
     ...
     */
    inboundNatPools: pulumi.Input<pulumi.Input<inputs.batch.v20181201.InboundNatPoolArgs>[]>;
}
...
export interface ScaleSettingsArgs {
     ...
     */
    autoScale?: pulumi.Input<inputs.batch.v20181201.AutoScaleSettingsArgs>;
    /**
     * This property and autoScale are mutually exclusive and one of the properties must be specified.
     */
    fixedScale?: pulumi.Input<inputs.batch.v20181201.FixedScaleSettingsArgs>;
}
...
export interface StartTaskArgs {
     ...
     */
    containerSettings?: pulumi.Input<inputs.batch.v20181201.TaskContainerSettingsArgs>;
    environmentSettings?: pulumi.Input<pulumi.Input<inputs.batch.v20181201.EnvironmentSettingArgs>[]>;
    /**
    ...
    resourceFiles?: pulumi.Input<pulumi.Input<inputs.batch.v20181201.ResourceFileArgs>[]>;
    /**
     * If omitted, the task runs as a non-administrative user unique to the task.
     */
    userIdentity?: pulumi.Input<inputs.batch.v20181201.UserIdentityArgs>;
    /**
...
export interface TaskContainerSettingsArgs {
     ...
     */
    registry?: pulumi.Input<inputs.batch.v20181201.ContainerRegistryArgs>;
}

export interface TaskSchedulingPolicyArgs {
    nodeFillType: pulumi.Input<enums.batch.v20181201.ComputeNodeFillType>;
}
...
export interface UserAccountArgs {
     ...
     */
    linuxUserConfiguration?: pulumi.Input<inputs.batch.v20181201.LinuxUserConfigurationArgs>;
    name: pulumi.Input<string>;
    password: pulumi.Input<string>;
    /**
     * This property can only be specified if the user is on a Windows pool. If not specified and on a Windows pool, the user is created with the default options.
     */
    windowsUserConfiguration?: pulumi.Input<inputs.batch.v20181201.WindowsUserConfigurationArgs>;
}
...
export interface UserIdentityArgs {
     ...
     */
    autoUser?: pulumi.Input<inputs.batch.v20181201.AutoUserSpecificationArgs>;
    /**
     * The userName and autoUser properties are mutually exclusive; you must specify one but not both.
     */
    userName?: pulumi.Input<string>;
...
export interface VirtualMachineConfigurationArgs {
     ...
     */
    containerConfiguration?: pulumi.Input<inputs.batch.v20181201.ContainerConfigurationArgs>;
    /**
     * This property must be specified if the compute nodes in the pool need to have empty data disks attached to them.
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.batch.v20181201.DataDiskArgs>[]>;
    imageReference: pulumi.Input<inputs.batch.v20181201.ImageReferenceArgs>;
    /**
     ...
     */
    windowsConfiguration?: pulumi.Input<inputs.batch.v20181201.WindowsConfigurationArgs>;
}
...
export interface WindowsUserConfigurationArgs {
     ...
     */
    loginMode?: pulumi.Input<enums.batch.v20181201.LoginMode>;
}
