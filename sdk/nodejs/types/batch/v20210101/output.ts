...
export interface AutoScaleRunErrorResponse {
     ...
     */
    code: string;
    details?: outputs.batch.v20210101.AutoScaleRunErrorResponse[];
    /**
...
export interface AutoScaleRunResponse {
    error?: outputs.batch.v20210101.AutoScaleRunErrorResponse;
...
export interface BatchAccountIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.batch.v20210101.BatchAccountIdentityResponseUserAssignedIdentities};
}
...
export interface BatchPoolIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.batch.v20210101.BatchPoolIdentityResponseUserAssignedIdentities};
}
...
export interface ContainerConfigurationResponse {
     ...
     */
    containerRegistries?: outputs.batch.v20210101.ContainerRegistryResponse[];
    type: string;
}
...
export interface DeleteCertificateErrorResponse {
     ...
     */
    details?: outputs.batch.v20210101.DeleteCertificateErrorResponse[];
    /**
     * A message describing the error, intended to be suitable for display in a user interface.
     */
    message: string;
...
export interface DeploymentConfigurationResponse {
     ...
     */
    cloudServiceConfiguration?: outputs.batch.v20210101.CloudServiceConfigurationResponse;
    /**
     * This property and cloudServiceConfiguration are mutually exclusive and one of the properties must be specified.
     */
    virtualMachineConfiguration?: outputs.batch.v20210101.VirtualMachineConfigurationResponse;
}
...
export interface EncryptionPropertiesResponse {
     ...
     */
    keyVaultProperties?: outputs.batch.v20210101.KeyVaultPropertiesResponse;
}
...
export interface InboundNatPoolResponse {
     ...
     */
    networkSecurityGroupRules?: outputs.batch.v20210101.NetworkSecurityGroupRuleResponse[];
    protocol: string;
}
...
export interface MountConfigurationResponse {
     ...
     */
    azureBlobFileSystemConfiguration?: outputs.batch.v20210101.AzureBlobFileSystemConfigurationResponse;
    /**
     * This property is mutually exclusive with all other properties.
     */
    azureFileShareConfiguration?: outputs.batch.v20210101.AzureFileShareConfigurationResponse;
    /**
     * This property is mutually exclusive with all other properties.
     */
    cifsMountConfiguration?: outputs.batch.v20210101.CIFSMountConfigurationResponse;
    /**
     * This property is mutually exclusive with all other properties.
     */
    nfsMountConfiguration?: outputs.batch.v20210101.NFSMountConfigurationResponse;
}
...
export interface NetworkConfigurationResponse {
     ...
     */
    endpointConfiguration?: outputs.batch.v20210101.PoolEndpointConfigurationResponse;
    /**
     * This property is only supported on Pools with the virtualMachineConfiguration property.
     */
    publicIPAddressConfiguration?: outputs.batch.v20210101.PublicIPAddressConfigurationResponse;
    /**
...
export interface PoolEndpointConfigurationResponse {
     ...
     */
    inboundNatPools: outputs.batch.v20210101.InboundNatPoolResponse[];
}
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.batch.v20210101.PrivateEndpointResponse;
    /**
     * The private link service connection state of the private endpoint connection
     */
    privateLinkServiceConnectionState?: outputs.batch.v20210101.PrivateLinkServiceConnectionStateResponse;
...
export interface ResizeErrorResponse {
     ...
     */
    code: string;
    details?: outputs.batch.v20210101.ResizeErrorResponse[];
    /**
     * A message describing the error, intended to be suitable for display in a user interface.
     */
    message: string;
...
export interface ResizeOperationStatusResponse {
     ...
     */
    errors?: outputs.batch.v20210101.ResizeErrorResponse[];
    /**
...
export interface ScaleSettingsResponse {
     ...
     */
    autoScale?: outputs.batch.v20210101.AutoScaleSettingsResponse;
    /**
     * This property and autoScale are mutually exclusive and one of the properties must be specified.
     */
    fixedScale?: outputs.batch.v20210101.FixedScaleSettingsResponse;
}
...
export interface StartTaskResponse {
     ...
     */
    containerSettings?: outputs.batch.v20210101.TaskContainerSettingsResponse;
    environmentSettings?: outputs.batch.v20210101.EnvironmentSettingResponse[];
    /**
     * The Batch service retries a task if its exit code is nonzero. Note that this value specifically controls the number of retries. The Batch service will try the task once, and may then retry up to this limit. For example, if the maximum retry count is 3, Batch tries the task up to 4 times (one initial try and 3 retries). If the maximum retry count is 0, the Batch service does not retry the task. If the maximum retry count is -1, the Batch service retries the task without limit.
     */
    maxTaskRetryCount?: number;
    resourceFiles?: outputs.batch.v20210101.ResourceFileResponse[];
    /**
     * If omitted, the task runs as a non-administrative user unique to the task.
     */
    userIdentity?: outputs.batch.v20210101.UserIdentityResponse;
    /**
...
export interface TaskContainerSettingsResponse {
     ...
     */
    registry?: outputs.batch.v20210101.ContainerRegistryResponse;
...
export interface UserAccountResponse {
     ...
     */
    linuxUserConfiguration?: outputs.batch.v20210101.LinuxUserConfigurationResponse;
    name: string;
    password: string;
    /**
     * This property can only be specified if the user is on a Windows pool. If not specified and on a Windows pool, the user is created with the default options.
     */
    windowsUserConfiguration?: outputs.batch.v20210101.WindowsUserConfigurationResponse;
}
...
export interface UserIdentityResponse {
     ...
     */
    autoUser?: outputs.batch.v20210101.AutoUserSpecificationResponse;
    /**
     * The userName and autoUser properties are mutually exclusive; you must specify one but not both.
     */
    userName?: string;
...
export interface VirtualMachineConfigurationResponse {
     ...
     */
    containerConfiguration?: outputs.batch.v20210101.ContainerConfigurationResponse;
    /**
     * This property must be specified if the compute nodes in the pool need to have empty data disks attached to them.
     */
    dataDisks?: outputs.batch.v20210101.DataDiskResponse[];
    /**
     * If specified, encryption is performed on each node in the pool during node provisioning.
     */
    diskEncryptionConfiguration?: outputs.batch.v20210101.DiskEncryptionConfigurationResponse;
    /**
     * If specified, the extensions mentioned in this configuration will be installed on each node.
     */
    extensions?: outputs.batch.v20210101.VMExtensionResponse[];
    imageReference: outputs.batch.v20210101.ImageReferenceResponse;
    /**
     ...
     */
    nodePlacementConfiguration?: outputs.batch.v20210101.NodePlacementConfigurationResponse;
    /**
     * This property must not be specified if the imageReference specifies a Linux OS image.
     */
    windowsConfiguration?: outputs.batch.v20210101.WindowsConfigurationResponse;
}
