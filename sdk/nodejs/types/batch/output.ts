...
export * as v20151201 from "./v20151201/output";
...
export interface BatchAccountIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.batch.BatchAccountIdentityResponseUserAssignedIdentities};
}

export interface BatchAccountIdentityResponseUserAssignedIdentities {
    /**
...
export interface BatchPoolIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.batch.BatchPoolIdentityResponseUserAssignedIdentities};
}

export interface BatchPoolIdentityResponseUserAssignedIdentities {
    /**
     * The client id of user assigned identity.
     */
    clientId: string;
...
export interface VirtualMachineConfigurationResponse {
     ...
     */
    nodePlacementConfiguration?: outputs.batch.NodePlacementConfigurationResponse;
    /**
