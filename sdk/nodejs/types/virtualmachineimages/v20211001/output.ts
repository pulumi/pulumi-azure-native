...
export interface ImageTemplateIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.virtualmachineimages.v20211001.ImageTemplateIdentityResponseUserAssignedIdentities};
}
...
export interface ImageTemplatePlatformImageSourceResponse {
     ...
     */
    planInfo?: outputs.virtualmachineimages.v20211001.PlatformImagePurchasePlanResponse;
    /**
...
export interface ImageTemplateVmProfileResponse {
     ...
     */
    vnetConfig?: outputs.virtualmachineimages.v20211001.VirtualNetworkConfigResponse;
}
/**
...
export function imageTemplateVmProfileResponseProvideDefaults(val: ImageTemplateVmProfileResponse): ImageTemplateVmProfileResponse {
    return {
        ...
        vmSize: (val.vmSize) ?? "",
        vnetConfig: (val.vnetConfig ? outputs.virtualmachineimages.v20211001.virtualNetworkConfigResponseProvideDefaults(val.vnetConfig) : undefined),
    };
}
