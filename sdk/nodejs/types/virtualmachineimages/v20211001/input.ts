...
export interface ImageTemplateIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.virtualmachineimages.v20211001.ResourceIdentityType>;
    /**
...
export interface ImageTemplatePlatformImageSourceArgs {
     ...
     */
    planInfo?: pulumi.Input<inputs.virtualmachineimages.v20211001.PlatformImagePurchasePlanArgs>;
    /**
...
export interface ImageTemplateSharedImageDistributorArgs {
     ...
     */
    storageAccountType?: pulumi.Input<string | enums.virtualmachineimages.v20211001.SharedImageStorageAccountType>;
    /**
     * Type of distribution.
...
export interface ImageTemplateVmProfileArgs {
     ...
     */
    vnetConfig?: pulumi.Input<inputs.virtualmachineimages.v20211001.VirtualNetworkConfigArgs>;
}
/**
...
export function imageTemplateVmProfileArgsProvideDefaults(val: ImageTemplateVmProfileArgs): ImageTemplateVmProfileArgs {
    return {
        ...
        vmSize: (val.vmSize) ?? "",
        vnetConfig: (val.vnetConfig ? pulumi.output(val.vnetConfig).apply(inputs.virtualmachineimages.v20211001.virtualNetworkConfigArgsProvideDefaults) : undefined),
    };
}
