...
export interface ImageTemplateIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.virtualmachineimages.v20220214.ImageTemplateIdentityResponseUserAssignedIdentities};
}
...
export interface ImageTemplatePlatformImageSourceResponse {
     ...
     */
    planInfo?: outputs.virtualmachineimages.v20220214.PlatformImagePurchasePlanResponse;
    /**
...
export interface ImageTemplatePropertiesResponseValidate {
     ...
     */
    inVMValidations?: (outputs.virtualmachineimages.v20220214.ImageTemplatePowerShellValidatorResponse | outputs.virtualmachineimages.v20220214.ImageTemplateShellValidatorResponse)[];
    /**
...
export interface ImageTemplateVmProfileResponse {
     ...
     */
    vnetConfig?: outputs.virtualmachineimages.v20220214.VirtualNetworkConfigResponse;
}
/**
...
export function imageTemplateVmProfileResponseProvideDefaults(val: ImageTemplateVmProfileResponse): ImageTemplateVmProfileResponse {
    return {
        ...
        vmSize: (val.vmSize) ?? "",
        vnetConfig: (val.vnetConfig ? outputs.virtualmachineimages.v20220214.virtualNetworkConfigResponseProvideDefaults(val.vnetConfig) : undefined),
    };
}
