...
export interface IPv4FirewallSettingsArgs {
     ...
     * An array of firewall rules.
     */
    firewallRules?: pulumi.Input<pulumi.Input<inputs.analysisservices.v20170801beta.IPv4FirewallRuleArgs>[]>;
}
...
export interface ResourceSkuArgs {
     ...
     */
    tier?: pulumi.Input<string | enums.analysisservices.v20170801beta.SkuTier>;
}
/**
