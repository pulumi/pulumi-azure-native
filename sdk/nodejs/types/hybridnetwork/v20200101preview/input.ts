...
export interface DataDiskArgs {
     ...
     */
    createOption?: pulumi.Input<string | enums.hybridnetwork.v20200101preview.DiskCreateOptionTypes>;
    /**
...
export interface LinuxConfigurationArgs {
     ...
     */
    ssh?: pulumi.Input<inputs.hybridnetwork.v20200101preview.SshConfigurationArgs>;
}
...
export interface NetworkFunctionRoleConfigurationArgs {
     ...
     * Specifies the custom settings for the virtual machine.
     */
    customProfile?: pulumi.Input<inputs.hybridnetwork.v20200101preview.CustomProfileArgs>;
    /**
     * The network interface configurations.
     */
    networkInterfaces?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.v20200101preview.NetworkInterfaceArgs>[]>;
    /**
     ...
     */
    osProfile?: pulumi.Input<inputs.hybridnetwork.v20200101preview.OsProfileArgs>;
    /**
     ...
     * Role type.
     */
    roleType?: pulumi.Input<string | enums.hybridnetwork.v20200101preview.NetworkFunctionRoleConfigurationType>;
    /**
     * Specifies the storage settings for the virtual machine disks.
     */
    storageProfile?: pulumi.Input<inputs.hybridnetwork.v20200101preview.StorageProfileArgs>;
    /**
     ...
     */
    virtualMachineSize?: pulumi.Input<string | enums.hybridnetwork.v20200101preview.VirtualMachineSizeTypes>;
}
/**
...
export function networkFunctionRoleConfigurationArgsProvideDefaults(val: NetworkFunctionRoleConfigurationArgs): NetworkFunctionRoleConfigurationArgs {
    return {
        ...val,
        osProfile: (val.osProfile ? pulumi.output(val.osProfile).apply(inputs.hybridnetwork.v20200101preview.osProfileArgsProvideDefaults) : undefined),
    };
}
...
export interface NetworkFunctionTemplateArgs {
     ...
     */
    networkFunctionRoleConfigurations?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.v20200101preview.NetworkFunctionRoleConfigurationArgs>[]>;
}
...
export interface NetworkFunctionUserConfigurationArgs {
     ...
     */
    osProfile?: pulumi.Input<inputs.hybridnetwork.v20200101preview.NetworkFunctionUserConfigurationOsProfileArgs>;
    /**
     * The name of the network function role.
     */
    roleName?: pulumi.Input<string>;
...
export interface NetworkInterfaceArgs {
     ...
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.v20200101preview.NetworkInterfaceIPConfigurationArgs>[]>;
    /**
     ...
     */
    vmSwitchType?: pulumi.Input<string | enums.hybridnetwork.v20200101preview.VMSwitchType>;
}
...
export interface NetworkInterfaceIPConfigurationArgs {
     ...
     */
    ipAllocationMethod?: pulumi.Input<string | enums.hybridnetwork.v20200101preview.IPAllocationMethod>;
    /**
     * IP address version.
     */
    ipVersion?: pulumi.Input<string | enums.hybridnetwork.v20200101preview.IPVersion>;
    /**
...
export interface OsDiskArgs {
     ...
     * The OS type.
     */
    osType?: pulumi.Input<string | enums.hybridnetwork.v20200101preview.OperatingSystemTypes>;
    /**
     * The virtual hard disk.
     */
    vhd?: pulumi.Input<inputs.hybridnetwork.v20200101preview.VirtualHardDiskArgs>;
}
...
export interface OsProfileArgs {
     ...
     */
    linuxConfiguration?: pulumi.Input<inputs.hybridnetwork.v20200101preview.LinuxConfigurationArgs>;
}
/**
...
export interface SshConfigurationArgs {
     ...
     */
    publicKeys?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.v20200101preview.SshPublicKeyArgs>[]>;
}
...
export interface StorageProfileArgs {
     ...
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.v20200101preview.DataDiskArgs>[]>;
    /**
     * The image reference properties.
     */
    imageReference?: pulumi.Input<inputs.hybridnetwork.v20200101preview.ImageReferenceArgs>;
    /**
     * Specifies information about the operating system disk used by the virtual machine.
     */
    osDisk?: pulumi.Input<inputs.hybridnetwork.v20200101preview.OsDiskArgs>;
}
