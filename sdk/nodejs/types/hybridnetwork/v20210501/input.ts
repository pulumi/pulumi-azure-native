...
export interface DataDiskArgs {
     ...
     */
    createOption?: pulumi.Input<string | enums.hybridnetwork.v20210501.DiskCreateOptionTypes>;
    /**
...
export interface LinuxConfigurationArgs {
     ...
     */
    ssh?: pulumi.Input<inputs.hybridnetwork.v20210501.SshConfigurationArgs>;
}
...
export interface NetworkFunctionRoleConfigurationArgs {
     ...
     * Specifies the custom settings for the virtual machine.
     */
    customProfile?: pulumi.Input<inputs.hybridnetwork.v20210501.CustomProfileArgs>;
    /**
     * The network interface configurations.
     */
    networkInterfaces?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.v20210501.NetworkInterfaceArgs>[]>;
    /**
     ...
     */
    osProfile?: pulumi.Input<inputs.hybridnetwork.v20210501.OsProfileArgs>;
    /**
     ...
     * Role type.
     */
    roleType?: pulumi.Input<string | enums.hybridnetwork.v20210501.NetworkFunctionRoleConfigurationType>;
    /**
     * Specifies the storage settings for the virtual machine disks.
     */
    storageProfile?: pulumi.Input<inputs.hybridnetwork.v20210501.StorageProfileArgs>;
    /**
     ...
     */
    virtualMachineSize?: pulumi.Input<string | enums.hybridnetwork.v20210501.VirtualMachineSizeTypes>;
}
/**
...
export function networkFunctionRoleConfigurationArgsProvideDefaults(val: NetworkFunctionRoleConfigurationArgs): NetworkFunctionRoleConfigurationArgs {
    return {
        ...val,
        osProfile: (val.osProfile ? pulumi.output(val.osProfile).apply(inputs.hybridnetwork.v20210501.osProfileArgsProvideDefaults) : undefined),
    };
}
...
export interface NetworkFunctionTemplateArgs {
     ...
     */
    networkFunctionRoleConfigurations?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.v20210501.NetworkFunctionRoleConfigurationArgs>[]>;
}
...
export interface NetworkFunctionUserConfigurationArgs {
     ...
     */
    osProfile?: pulumi.Input<inputs.hybridnetwork.v20210501.NetworkFunctionUserConfigurationOsProfileArgs>;
    /**
     * The name of the network function role.
     */
    roleName?: pulumi.Input<string>;
...
export interface NetworkInterfaceArgs {
     ...
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.v20210501.NetworkInterfaceIPConfigurationArgs>[]>;
    /**
     ...
     */
    vmSwitchType?: pulumi.Input<string | enums.hybridnetwork.v20210501.VMSwitchType>;
}
...
export interface NetworkInterfaceIPConfigurationArgs {
     ...
     */
    ipAllocationMethod?: pulumi.Input<string | enums.hybridnetwork.v20210501.IPAllocationMethod>;
    /**
     * IP address version.
     */
    ipVersion?: pulumi.Input<string | enums.hybridnetwork.v20210501.IPVersion>;
    /**
...
export interface OsDiskArgs {
     ...
     * The OS type.
     */
    osType?: pulumi.Input<string | enums.hybridnetwork.v20210501.OperatingSystemTypes>;
    /**
     * The virtual hard disk.
     */
    vhd?: pulumi.Input<inputs.hybridnetwork.v20210501.VirtualHardDiskArgs>;
}
...
export interface OsProfileArgs {
     ...
     */
    linuxConfiguration?: pulumi.Input<inputs.hybridnetwork.v20210501.LinuxConfigurationArgs>;
}
/**
...
export interface SshConfigurationArgs {
     ...
     */
    publicKeys?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.v20210501.SshPublicKeyArgs>[]>;
}
...
export interface StorageProfileArgs {
     ...
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.hybridnetwork.v20210501.DataDiskArgs>[]>;
    /**
     * The image reference properties.
     */
    imageReference?: pulumi.Input<inputs.hybridnetwork.v20210501.ImageReferenceArgs>;
    /**
     * Specifies information about the operating system disk used by the virtual machine.
     */
    osDisk?: pulumi.Input<inputs.hybridnetwork.v20210501.OsDiskArgs>;
}
