...
export interface ApplicationHealthPolicyArgs {
     ...
     */
    defaultServiceTypeHealthPolicy?: pulumi.Input<inputs.servicefabric.v20210701preview.ServiceTypeHealthPolicyArgs>;
    /**
     ...
     */
    serviceTypeHealthPolicyMap?: pulumi.Input<{[key: string]: pulumi.Input<inputs.servicefabric.v20210701preview.ServiceTypeHealthPolicyArgs>}>;
}
...
export interface ApplicationUpgradePolicyArgs {
     ...
     * Defines a health policy used to evaluate the health of an application or one of its children entities.
     */
    applicationHealthPolicy?: pulumi.Input<inputs.servicefabric.v20210701preview.ApplicationHealthPolicyArgs>;
    /**
     ...
     */
    rollingUpgradeMonitoringPolicy?: pulumi.Input<inputs.servicefabric.v20210701preview.RollingUpgradeMonitoringPolicyArgs>;
    /**
     * The mode used to monitor health during a rolling upgrade. The values are Monitored, and UnmonitoredAuto.
     */
    upgradeMode?: pulumi.Input<string | enums.servicefabric.v20210701preview.RollingUpgradeMode>;
    /**
...
export interface FrontendConfigurationArgs {
     ...
     */
    ipAddressType?: pulumi.Input<string | enums.servicefabric.v20210701preview.IPAddressType>;
    /**
...
export interface LoadBalancingRuleArgs {
     ...
     */
    probeProtocol: pulumi.Input<string | enums.servicefabric.v20210701preview.ProbeProtocol>;
    /**
     ...
     */
    protocol: pulumi.Input<string | enums.servicefabric.v20210701preview.Protocol>;
}
...
export interface ManagedIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.servicefabric.v20210701preview.ManagedIdentityType>;
    /**
...
export interface NetworkSecurityRuleArgs {
     ...
     */
    access: pulumi.Input<string | enums.servicefabric.v20210701preview.Access>;
    /**
     ...
     */
    direction: pulumi.Input<string | enums.servicefabric.v20210701preview.Direction>;
    /**
     ...
     */
    protocol: pulumi.Input<string | enums.servicefabric.v20210701preview.NsgProtocol>;
    /**
...
export interface RollingUpgradeMonitoringPolicyArgs {
     ...
     */
    failureAction: pulumi.Input<string | enums.servicefabric.v20210701preview.FailureAction>;
    /**
...
export interface ScalingPolicyArgs {
     ...
     */
    scalingMechanism: pulumi.Input<inputs.servicefabric.v20210701preview.AddRemoveIncrementalNamedPartitionScalingMechanismArgs | inputs.servicefabric.v20210701preview.PartitionInstanceCountScaleMechanismArgs>;
    /**
     * Specifies the trigger associated with this scaling policy.
     */
    scalingTrigger: pulumi.Input<inputs.servicefabric.v20210701preview.AveragePartitionLoadScalingTriggerArgs | inputs.servicefabric.v20210701preview.AverageServiceLoadScalingTriggerArgs>;
}
...
export interface ServiceCorrelationArgs {
     ...
     */
    scheme: pulumi.Input<string | enums.servicefabric.v20210701preview.ServiceCorrelationScheme>;
    /**
...
export interface ServiceLoadMetricArgs {
     ...
     */
    weight?: pulumi.Input<string | enums.servicefabric.v20210701preview.ServiceLoadMetricWeight>;
}
...
export interface SettingsSectionDescriptionArgs {
     ...
     */
    parameters: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210701preview.SettingsParameterDescriptionArgs>[]>;
}
...
export interface SkuArgs {
     ...
     * Sku Name.
     */
    name: pulumi.Input<string | enums.servicefabric.v20210701preview.SkuName>;
}
...
export interface StatefulServicePropertiesArgs {
     ...
     */
    correlationScheme?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210701preview.ServiceCorrelationArgs>[]>;
    /**
     * Specifies the move cost for the service.
     */
    defaultMoveCost?: pulumi.Input<string | enums.servicefabric.v20210701preview.MoveCost>;
    /**
     ...
     */
    partitionDescription: pulumi.Input<inputs.servicefabric.v20210701preview.NamedPartitionSchemeArgs | inputs.servicefabric.v20210701preview.SingletonPartitionSchemeArgs | inputs.servicefabric.v20210701preview.UniformInt64RangePartitionSchemeArgs>;
    /**
     ...
     */
    scalingPolicies?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210701preview.ScalingPolicyArgs>[]>;
    /**
     ...
     */
    serviceLoadMetrics?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210701preview.ServiceLoadMetricArgs>[]>;
    /**
     * The activation Mode of the service package
     */
    servicePackageActivationMode?: pulumi.Input<string | enums.servicefabric.v20210701preview.ServicePackageActivationMode>;
    /**
     * A list that describes the correlation of the service with other services.
     */
    servicePlacementPolicies?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210701preview.ServicePlacementInvalidDomainPolicyArgs | inputs.servicefabric.v20210701preview.ServicePlacementNonPartiallyPlaceServicePolicyArgs | inputs.servicefabric.v20210701preview.ServicePlacementPreferPrimaryDomainPolicyArgs | inputs.servicefabric.v20210701preview.ServicePlacementRequireDomainDistributionPolicyArgs | inputs.servicefabric.v20210701preview.ServicePlacementRequiredDomainPolicyArgs>[]>;
    /**
...
export interface VaultSecretGroupArgs {
     ...
     */
    sourceVault: pulumi.Input<inputs.servicefabric.v20210701preview.SubResourceArgs>;
    /**
     * The list of key vault references in SourceVault which contain certificates.
     */
    vaultCertificates: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210701preview.VaultCertificateArgs>[]>;
}
