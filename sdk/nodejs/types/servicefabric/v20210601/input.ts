...
export interface ApplicationDeltaHealthPolicyArgs {
     ...
     */
    defaultServiceTypeDeltaHealthPolicy?: pulumi.Input<inputs.servicefabric.v20210601.ServiceTypeDeltaHealthPolicyArgs>;
    /**
     * The map with service type delta health policy per service type name. The map is empty by default.
     */
    serviceTypeDeltaHealthPolicies?: pulumi.Input<{[key: string]: pulumi.Input<inputs.servicefabric.v20210601.ServiceTypeDeltaHealthPolicyArgs>}>;
}
/**
...
export function applicationDeltaHealthPolicyArgsProvideDefaults(val: ApplicationDeltaHealthPolicyArgs): ApplicationDeltaHealthPolicyArgs {
    return {
        ...val,
        defaultServiceTypeDeltaHealthPolicy: (val.defaultServiceTypeDeltaHealthPolicy ? pulumi.output(val.defaultServiceTypeDeltaHealthPolicy).apply(inputs.servicefabric.v20210601.serviceTypeDeltaHealthPolicyArgsProvideDefaults) : undefined),
    };
}
...
export interface ApplicationHealthPolicyArgs {
     ...
     */
    defaultServiceTypeHealthPolicy?: pulumi.Input<inputs.servicefabric.v20210601.ServiceTypeHealthPolicyArgs>;
    /**
     * The map with service type health policy per service type name. The map is empty by default.
     */
    serviceTypeHealthPolicies?: pulumi.Input<{[key: string]: pulumi.Input<inputs.servicefabric.v20210601.ServiceTypeHealthPolicyArgs>}>;
}
/**
...
export function applicationHealthPolicyArgsProvideDefaults(val: ApplicationHealthPolicyArgs): ApplicationHealthPolicyArgs {
    return {
        ...val,
        defaultServiceTypeHealthPolicy: (val.defaultServiceTypeHealthPolicy ? pulumi.output(val.defaultServiceTypeHealthPolicy).apply(inputs.servicefabric.v20210601.serviceTypeHealthPolicyArgsProvideDefaults) : undefined),
    };
}
...
export interface ApplicationUpgradePolicyArgs {
     ...
     * Defines a health policy used to evaluate the health of an application or one of its children entities.
     */
    applicationHealthPolicy?: pulumi.Input<inputs.servicefabric.v20210601.ArmApplicationHealthPolicyArgs>;
    /**
     ...
     */
    rollingUpgradeMonitoringPolicy?: pulumi.Input<inputs.servicefabric.v20210601.ArmRollingUpgradeMonitoringPolicyArgs>;
    /**
     * The mode used to monitor health during a rolling upgrade. The values are UnmonitoredAuto, UnmonitoredManual, and Monitored.
     */
    upgradeMode?: pulumi.Input<string | enums.servicefabric.v20210601.RollingUpgradeMode>;
    /**
...
export function applicationUpgradePolicyArgsProvideDefaults(val: ApplicationUpgradePolicyArgs): ApplicationUpgradePolicyArgs {
    return {
        ...val,
        applicationHealthPolicy: (val.applicationHealthPolicy ? pulumi.output(val.applicationHealthPolicy).apply(inputs.servicefabric.v20210601.armApplicationHealthPolicyArgsProvideDefaults) : undefined),
    };
}
...
export interface ArmApplicationHealthPolicyArgs {
     ...
     * The health policy used by default to evaluate the health of a service type.
     */
    defaultServiceTypeHealthPolicy?: pulumi.Input<inputs.servicefabric.v20210601.ArmServiceTypeHealthPolicyArgs>;
    /**
     ...
     * The map with service type health policy per service type name. The map is empty by default.
     */
    serviceTypeHealthPolicyMap?: pulumi.Input<{[key: string]: pulumi.Input<inputs.servicefabric.v20210601.ArmServiceTypeHealthPolicyArgs>}>;
}
/**
...
export function armApplicationHealthPolicyArgsProvideDefaults(val: ArmApplicationHealthPolicyArgs): ArmApplicationHealthPolicyArgs {
    return {
        ...
        defaultServiceTypeHealthPolicy: (val.defaultServiceTypeHealthPolicy ? pulumi.output(val.defaultServiceTypeHealthPolicy).apply(inputs.servicefabric.v20210601.armServiceTypeHealthPolicyArgsProvideDefaults) : undefined),
...
export interface ArmRollingUpgradeMonitoringPolicyArgs {
     ...
     */
    failureAction?: pulumi.Input<string | enums.servicefabric.v20210601.ArmUpgradeFailureAction>;
    /**
...
export interface ClusterHealthPolicyArgs {
     ...
     */
    applicationHealthPolicies?: pulumi.Input<{[key: string]: pulumi.Input<inputs.servicefabric.v20210601.ApplicationHealthPolicyArgs>}>;
    /**
...
export interface ClusterUpgradeDeltaHealthPolicyArgs {
     ...
     */
    applicationDeltaHealthPolicies?: pulumi.Input<{[key: string]: pulumi.Input<inputs.servicefabric.v20210601.ApplicationDeltaHealthPolicyArgs>}>;
    /**
...
export interface ClusterUpgradePolicyArgs {
     ...
     */
    deltaHealthPolicy?: pulumi.Input<inputs.servicefabric.v20210601.ClusterUpgradeDeltaHealthPolicyArgs>;
    /**
     * If true, then processes are forcefully restarted during upgrade even when the code version has not changed (the upgrade only changes configuration or data).
     */
    forceRestart?: pulumi.Input<boolean>;
     ...
     */
    healthPolicy: pulumi.Input<inputs.servicefabric.v20210601.ClusterHealthPolicyArgs>;
    /**
...
export function clusterUpgradePolicyArgsProvideDefaults(val: ClusterUpgradePolicyArgs): ClusterUpgradePolicyArgs {
    return {
        ...val,
        healthPolicy: pulumi.output(val.healthPolicy).apply(inputs.servicefabric.v20210601.clusterHealthPolicyArgsProvideDefaults),
    };
}
...
export interface ManagedIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.servicefabric.v20210601.ManagedIdentityType>;
    /**
...
export interface NodeTypeDescriptionArgs {
     ...
     */
    applicationPorts?: pulumi.Input<inputs.servicefabric.v20210601.EndpointRangeDescriptionArgs>;
    /**
     ...
     */
    ephemeralPorts?: pulumi.Input<inputs.servicefabric.v20210601.EndpointRangeDescriptionArgs>;
    /**
...
export interface NotificationArgs {
     ...
     */
    notificationCategory: pulumi.Input<string | enums.servicefabric.v20210601.NotificationCategory>;
    /**
     * The level of notification.
     */
    notificationLevel: pulumi.Input<string | enums.servicefabric.v20210601.NotificationLevel>;
    /**
     * List of targets that subscribe to the notification.
     */
    notificationTargets: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210601.NotificationTargetArgs>[]>;
}
...
export interface NotificationTargetArgs {
     ...
     */
    notificationChannel: pulumi.Input<string | enums.servicefabric.v20210601.NotificationChannel>;
    /**
     * List of targets that subscribe to the notification.
     */
...
export interface ServerCertificateCommonNamesArgs {
     ...
     */
    commonNames?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210601.ServerCertificateCommonNameArgs>[]>;
    /**
     * The local certificate store location.
     */
    x509StoreName?: pulumi.Input<string>;
...
export interface ServiceCorrelationDescriptionArgs {
     ...
     */
    scheme: pulumi.Input<string | enums.servicefabric.v20210601.ServiceCorrelationScheme>;
    /**
...
export interface ServiceLoadMetricDescriptionArgs {
     ...
     */
    weight?: pulumi.Input<string | enums.servicefabric.v20210601.ServiceLoadMetricWeight>;
}
...
export interface ServicePlacementPolicyDescriptionArgs {
     ...
     */
    type: pulumi.Input<string | enums.servicefabric.v20210601.ServicePlacementPolicyType>;
}
...
export interface SettingsSectionDescriptionArgs {
     ...
     */
    parameters: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210601.SettingsParameterDescriptionArgs>[]>;
}
