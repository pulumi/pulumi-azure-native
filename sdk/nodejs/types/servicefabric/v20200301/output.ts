...
export interface ApplicationDeltaHealthPolicyResponse {
     ...
     */
    defaultServiceTypeDeltaHealthPolicy?: outputs.servicefabric.v20200301.ServiceTypeDeltaHealthPolicyResponse;
    /**
     * The map with service type delta health policy per service type name. The map is empty by default.
     */
    serviceTypeDeltaHealthPolicies?: {[key: string]: outputs.servicefabric.v20200301.ServiceTypeDeltaHealthPolicyResponse};
}
/**
...
export function applicationDeltaHealthPolicyResponseProvideDefaults(val: ApplicationDeltaHealthPolicyResponse): ApplicationDeltaHealthPolicyResponse {
    return {
        ...val,
        defaultServiceTypeDeltaHealthPolicy: (val.defaultServiceTypeDeltaHealthPolicy ? outputs.servicefabric.v20200301.serviceTypeDeltaHealthPolicyResponseProvideDefaults(val.defaultServiceTypeDeltaHealthPolicy) : undefined),
    };
}
...
export interface ApplicationHealthPolicyResponse {
     ...
     */
    defaultServiceTypeHealthPolicy?: outputs.servicefabric.v20200301.ServiceTypeHealthPolicyResponse;
    /**
     * The map with service type health policy per service type name. The map is empty by default.
     */
    serviceTypeHealthPolicies?: {[key: string]: outputs.servicefabric.v20200301.ServiceTypeHealthPolicyResponse};
}
/**
...
export function applicationHealthPolicyResponseProvideDefaults(val: ApplicationHealthPolicyResponse): ApplicationHealthPolicyResponse {
    return {
        ...val,
        defaultServiceTypeHealthPolicy: (val.defaultServiceTypeHealthPolicy ? outputs.servicefabric.v20200301.serviceTypeHealthPolicyResponseProvideDefaults(val.defaultServiceTypeHealthPolicy) : undefined),
    };
}
...
export interface ApplicationUpgradePolicyResponse {
     ...
     * Defines a health policy used to evaluate the health of an application or one of its children entities.
     */
    applicationHealthPolicy?: outputs.servicefabric.v20200301.ArmApplicationHealthPolicyResponse;
    /**
     ...
     */
    rollingUpgradeMonitoringPolicy?: outputs.servicefabric.v20200301.ArmRollingUpgradeMonitoringPolicyResponse;
    /**
...
export function applicationUpgradePolicyResponseProvideDefaults(val: ApplicationUpgradePolicyResponse): ApplicationUpgradePolicyResponse {
    return {
        ...val,
        applicationHealthPolicy: (val.applicationHealthPolicy ? outputs.servicefabric.v20200301.armApplicationHealthPolicyResponseProvideDefaults(val.applicationHealthPolicy) : undefined),
    };
}
...
export interface ArmApplicationHealthPolicyResponse {
     ...
     * The health policy used by default to evaluate the health of a service type.
     */
    defaultServiceTypeHealthPolicy?: outputs.servicefabric.v20200301.ArmServiceTypeHealthPolicyResponse;
    /**
     ...
     * The map with service type health policy per service type name. The map is empty by default.
     */
    serviceTypeHealthPolicyMap?: {[key: string]: outputs.servicefabric.v20200301.ArmServiceTypeHealthPolicyResponse};
}
/**
...
export function armApplicationHealthPolicyResponseProvideDefaults(val: ArmApplicationHealthPolicyResponse): ArmApplicationHealthPolicyResponse {
    return {
        ...
        defaultServiceTypeHealthPolicy: (val.defaultServiceTypeHealthPolicy ? outputs.servicefabric.v20200301.armServiceTypeHealthPolicyResponseProvideDefaults(val.defaultServiceTypeHealthPolicy) : undefined),
...
export interface ClusterHealthPolicyResponse {
     ...
     */
    applicationHealthPolicies?: {[key: string]: outputs.servicefabric.v20200301.ApplicationHealthPolicyResponse};
    /**
...
export interface ClusterUpgradeDeltaHealthPolicyResponse {
     ...
     */
    applicationDeltaHealthPolicies?: {[key: string]: outputs.servicefabric.v20200301.ApplicationDeltaHealthPolicyResponse};
    /**
...
export interface ClusterUpgradePolicyResponse {
     ...
     */
    deltaHealthPolicy?: outputs.servicefabric.v20200301.ClusterUpgradeDeltaHealthPolicyResponse;
    /**
     * If true, then processes are forcefully restarted during upgrade even when the code version has not changed (the upgrade only changes configuration or data).
     */
    forceRestart?: boolean;
     ...
     */
    healthPolicy: outputs.servicefabric.v20200301.ClusterHealthPolicyResponse;
    /**
...
export function clusterUpgradePolicyResponseProvideDefaults(val: ClusterUpgradePolicyResponse): ClusterUpgradePolicyResponse {
    return {
        ...val,
        healthPolicy: outputs.servicefabric.v20200301.clusterHealthPolicyResponseProvideDefaults(val.healthPolicy),
    };
}
...
export interface ManagedIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.servicefabric.v20200301.UserAssignedIdentityResponse};
}
...
export interface NodeTypeDescriptionResponse {
     ...
     */
    applicationPorts?: outputs.servicefabric.v20200301.EndpointRangeDescriptionResponse;
    /**
     ...
     */
    ephemeralPorts?: outputs.servicefabric.v20200301.EndpointRangeDescriptionResponse;
    /**
...
export interface ServerCertificateCommonNamesResponse {
     ...
     */
    commonNames?: outputs.servicefabric.v20200301.ServerCertificateCommonNameResponse[];
    /**
     * The local certificate store location.
     */
    x509StoreName?: string;
...
export interface SettingsSectionDescriptionResponse {
     ...
     */
    parameters: outputs.servicefabric.v20200301.SettingsParameterDescriptionResponse[];
}
