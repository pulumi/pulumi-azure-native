...
export * as v20170701preview from "./v20170701preview/output";
...
export * as v20210901privatepreview from "./v20210901privatepreview/output";
...
export interface ApplicationDeltaHealthPolicyResponse {
     ...
     */
    defaultServiceTypeDeltaHealthPolicy?: outputs.servicefabric.ServiceTypeDeltaHealthPolicyResponse;
    /**
     * The map with service type delta health policy per service type name. The map is empty by default.
     */
    serviceTypeDeltaHealthPolicies?: {[key: string]: outputs.servicefabric.ServiceTypeDeltaHealthPolicyResponse};
}
/**
...
export function applicationDeltaHealthPolicyResponseProvideDefaults(val: ApplicationDeltaHealthPolicyResponse): ApplicationDeltaHealthPolicyResponse {
    return {
        ...val,
        defaultServiceTypeDeltaHealthPolicy: (val.defaultServiceTypeDeltaHealthPolicy ? outputs.servicefabric.serviceTypeDeltaHealthPolicyResponseProvideDefaults(val.defaultServiceTypeDeltaHealthPolicy) : undefined),
    };
}
...
export interface ApplicationHealthPolicyResponse {
     ...
     */
    defaultServiceTypeHealthPolicy?: outputs.servicefabric.ServiceTypeHealthPolicyResponse;
    /**
     * The map with service type health policy per service type name. The map is empty by default.
     */
    serviceTypeHealthPolicies?: {[key: string]: outputs.servicefabric.ServiceTypeHealthPolicyResponse};
}
/**
...
export function applicationHealthPolicyResponseProvideDefaults(val: ApplicationHealthPolicyResponse): ApplicationHealthPolicyResponse {
    return {
        ...val,
        defaultServiceTypeHealthPolicy: (val.defaultServiceTypeHealthPolicy ? outputs.servicefabric.serviceTypeHealthPolicyResponseProvideDefaults(val.defaultServiceTypeHealthPolicy) : undefined),
    };
}
...
export function applicationUpgradePolicyResponseProvideDefaults(val: ApplicationUpgradePolicyResponse): ApplicationUpgradePolicyResponse {
    return {
        ...val,
        applicationHealthPolicy: (val.applicationHealthPolicy ? outputs.servicefabric.armApplicationHealthPolicyResponseProvideDefaults(val.applicationHealthPolicy) : undefined),
    };
}
...
export interface ArmApplicationHealthPolicyResponse {
     ...
     * The map with service type health policy per service type name. The map is empty by default.
     */
    serviceTypeHealthPolicyMap?: {[key: string]: outputs.servicefabric.ArmServiceTypeHealthPolicyResponse};
}
/**
...
export function armApplicationHealthPolicyResponseProvideDefaults(val: ArmApplicationHealthPolicyResponse): ArmApplicationHealthPolicyResponse {
    return {
        ...
        defaultServiceTypeHealthPolicy: (val.defaultServiceTypeHealthPolicy ? outputs.servicefabric.armServiceTypeHealthPolicyResponseProvideDefaults(val.defaultServiceTypeHealthPolicy) : undefined),
...
export interface ClusterHealthPolicyResponse {
     ...
     */
    applicationHealthPolicies?: {[key: string]: outputs.servicefabric.ApplicationHealthPolicyResponse};
    /**
...
export interface ClusterUpgradeDeltaHealthPolicyResponse {
     ...
     */
    applicationDeltaHealthPolicies?: {[key: string]: outputs.servicefabric.ApplicationDeltaHealthPolicyResponse};
    /**
...
export function clusterUpgradePolicyResponseProvideDefaults(val: ClusterUpgradePolicyResponse): ClusterUpgradePolicyResponse {
    return {
        ...val,
        healthPolicy: outputs.servicefabric.clusterHealthPolicyResponseProvideDefaults(val.healthPolicy),
    };
}
...
export interface ManagedIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.servicefabric.UserAssignedIdentityResponse};
}
...
export interface VaultSecretGroupResponse {
     ...
     */
    sourceVault: outputs.servicefabric.SubResourceResponse;
    /**
     * The list of key vault references in SourceVault which contain certificates.
     */
    vaultCertificates: outputs.servicefabric.VaultCertificateResponse[];
}
