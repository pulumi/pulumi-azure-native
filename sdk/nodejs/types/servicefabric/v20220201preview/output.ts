...
export interface ApplicationHealthPolicyResponse {
     ...
     */
    defaultServiceTypeHealthPolicy?: outputs.servicefabric.v20220201preview.ServiceTypeHealthPolicyResponse;
    /**
     ...
     */
    serviceTypeHealthPolicyMap?: {[key: string]: outputs.servicefabric.v20220201preview.ServiceTypeHealthPolicyResponse};
}
...
export interface ApplicationUpgradePolicyResponse {
     ...
     * Defines a health policy used to evaluate the health of an application or one of its children entities.
     */
    applicationHealthPolicy?: outputs.servicefabric.v20220201preview.ApplicationHealthPolicyResponse;
    /**
     ...
     */
    rollingUpgradeMonitoringPolicy?: outputs.servicefabric.v20220201preview.RollingUpgradeMonitoringPolicyResponse;
    /**
...
export interface ManagedIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.servicefabric.v20220201preview.UserAssignedIdentityResponse};
}
...
export interface ScalingPolicyResponse {
     ...
     */
    scalingMechanism: outputs.servicefabric.v20220201preview.AddRemoveIncrementalNamedPartitionScalingMechanismResponse | outputs.servicefabric.v20220201preview.PartitionInstanceCountScaleMechanismResponse;
    /**
     * Specifies the trigger associated with this scaling policy.
     */
    scalingTrigger: outputs.servicefabric.v20220201preview.AveragePartitionLoadScalingTriggerResponse | outputs.servicefabric.v20220201preview.AverageServiceLoadScalingTriggerResponse;
}
...
export interface SettingsSectionDescriptionResponse {
     ...
     */
    parameters: outputs.servicefabric.v20220201preview.SettingsParameterDescriptionResponse[];
}
...
export interface StatefulServicePropertiesResponse {
     ...
     */
    correlationScheme?: outputs.servicefabric.v20220201preview.ServiceCorrelationResponse[];
    /**
     ...
     */
    partitionDescription: outputs.servicefabric.v20220201preview.NamedPartitionSchemeResponse | outputs.servicefabric.v20220201preview.SingletonPartitionSchemeResponse | outputs.servicefabric.v20220201preview.UniformInt64RangePartitionSchemeResponse;
    /**
     ...
     */
    scalingPolicies?: outputs.servicefabric.v20220201preview.ScalingPolicyResponse[];
    /**
     ...
     */
    serviceLoadMetrics?: outputs.servicefabric.v20220201preview.ServiceLoadMetricResponse[];
    /**
     ...
     * A list that describes the correlation of the service with other services.
     */
    servicePlacementPolicies?: (outputs.servicefabric.v20220201preview.ServicePlacementInvalidDomainPolicyResponse | outputs.servicefabric.v20220201preview.ServicePlacementNonPartiallyPlaceServicePolicyResponse | outputs.servicefabric.v20220201preview.ServicePlacementPreferPrimaryDomainPolicyResponse | outputs.servicefabric.v20220201preview.ServicePlacementRequireDomainDistributionPolicyResponse | outputs.servicefabric.v20220201preview.ServicePlacementRequiredDomainPolicyResponse)[];
    /**
...
export interface VaultSecretGroupResponse {
     ...
     */
    sourceVault: outputs.servicefabric.v20220201preview.SubResourceResponse;
    /**
     * The list of key vault references in SourceVault which contain certificates.
     */
    vaultCertificates: outputs.servicefabric.v20220201preview.VaultCertificateResponse[];
}
