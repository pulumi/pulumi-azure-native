...
export interface ApplicationHealthPolicyResponse {
     ...
     */
    defaultServiceTypeHealthPolicy?: outputs.servicefabric.v20210501.ServiceTypeHealthPolicyResponse;
    /**
     ...
     */
    serviceTypeHealthPolicyMap?: {[key: string]: outputs.servicefabric.v20210501.ServiceTypeHealthPolicyResponse};
}
...
export interface ApplicationUpgradePolicyResponse {
     ...
     * Defines a health policy used to evaluate the health of an application or one of its children entities.
     */
    applicationHealthPolicy?: outputs.servicefabric.v20210501.ApplicationHealthPolicyResponse;
    /**
     ...
     */
    rollingUpgradeMonitoringPolicy?: outputs.servicefabric.v20210501.RollingUpgradeMonitoringPolicyResponse;
    /**
...
export interface ManagedIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.servicefabric.v20210501.UserAssignedIdentityResponse};
}
...
export interface ScalingPolicyResponse {
     ...
     */
    scalingMechanism: outputs.servicefabric.v20210501.AddRemoveIncrementalNamedPartitionScalingMechanismResponse | outputs.servicefabric.v20210501.PartitionInstanceCountScaleMechanismResponse;
    /**
     * Specifies the trigger associated with this scaling policy.
     */
    scalingTrigger: outputs.servicefabric.v20210501.AveragePartitionLoadScalingTriggerResponse | outputs.servicefabric.v20210501.AverageServiceLoadScalingTriggerResponse;
}
...
export interface SettingsSectionDescriptionResponse {
     ...
     */
    parameters: outputs.servicefabric.v20210501.SettingsParameterDescriptionResponse[];
}
...
export interface StatefulServicePropertiesResponse {
     ...
     */
    correlationScheme?: outputs.servicefabric.v20210501.ServiceCorrelationResponse[];
    /**
     ...
     */
    partitionDescription: outputs.servicefabric.v20210501.NamedPartitionSchemeResponse | outputs.servicefabric.v20210501.SingletonPartitionSchemeResponse | outputs.servicefabric.v20210501.UniformInt64RangePartitionSchemeResponse;
    /**
     ...
     */
    scalingPolicies?: outputs.servicefabric.v20210501.ScalingPolicyResponse[];
    /**
     ...
     */
    serviceLoadMetrics?: outputs.servicefabric.v20210501.ServiceLoadMetricResponse[];
    /**
     ...
     * A list that describes the correlation of the service with other services.
     */
    servicePlacementPolicies?: (outputs.servicefabric.v20210501.ServicePlacementInvalidDomainPolicyResponse | outputs.servicefabric.v20210501.ServicePlacementNonPartiallyPlaceServicePolicyResponse | outputs.servicefabric.v20210501.ServicePlacementPreferPrimaryDomainPolicyResponse | outputs.servicefabric.v20210501.ServicePlacementRequireDomainDistributionPolicyResponse | outputs.servicefabric.v20210501.ServicePlacementRequiredDomainPolicyResponse)[];
    /**
...
export interface VaultSecretGroupResponse {
     ...
     */
    sourceVault: outputs.servicefabric.v20210501.SubResourceResponse;
    /**
     * The list of key vault references in SourceVault which contain certificates.
     */
    vaultCertificates: outputs.servicefabric.v20210501.VaultCertificateResponse[];
}
