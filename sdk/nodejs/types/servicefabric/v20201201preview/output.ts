...
export interface ApplicationDeltaHealthPolicyResponse {
     ...
     */
    defaultServiceTypeDeltaHealthPolicy?: outputs.servicefabric.v20201201preview.ServiceTypeDeltaHealthPolicyResponse;
    /**
     * The map with service type delta health policy per service type name. The map is empty by default.
     */
    serviceTypeDeltaHealthPolicies?: {[key: string]: outputs.servicefabric.v20201201preview.ServiceTypeDeltaHealthPolicyResponse};
}
/**
...
export function applicationDeltaHealthPolicyResponseProvideDefaults(val: ApplicationDeltaHealthPolicyResponse): ApplicationDeltaHealthPolicyResponse {
    return {
        ...val,
        defaultServiceTypeDeltaHealthPolicy: (val.defaultServiceTypeDeltaHealthPolicy ? outputs.servicefabric.v20201201preview.serviceTypeDeltaHealthPolicyResponseProvideDefaults(val.defaultServiceTypeDeltaHealthPolicy) : undefined),
    };
}
...
export interface ApplicationHealthPolicyResponse {
     ...
     */
    defaultServiceTypeHealthPolicy?: outputs.servicefabric.v20201201preview.ServiceTypeHealthPolicyResponse;
    /**
     * The map with service type health policy per service type name. The map is empty by default.
     */
    serviceTypeHealthPolicies?: {[key: string]: outputs.servicefabric.v20201201preview.ServiceTypeHealthPolicyResponse};
}
/**
...
export function applicationHealthPolicyResponseProvideDefaults(val: ApplicationHealthPolicyResponse): ApplicationHealthPolicyResponse {
    return {
        ...val,
        defaultServiceTypeHealthPolicy: (val.defaultServiceTypeHealthPolicy ? outputs.servicefabric.v20201201preview.serviceTypeHealthPolicyResponseProvideDefaults(val.defaultServiceTypeHealthPolicy) : undefined),
    };
}
...
export interface ApplicationUpgradePolicyResponse {
     ...
     * Defines a health policy used to evaluate the health of an application or one of its children entities.
     */
    applicationHealthPolicy?: outputs.servicefabric.v20201201preview.ArmApplicationHealthPolicyResponse;
    /**
     ...
     */
    rollingUpgradeMonitoringPolicy?: outputs.servicefabric.v20201201preview.ArmRollingUpgradeMonitoringPolicyResponse;
    /**
...
export function applicationUpgradePolicyResponseProvideDefaults(val: ApplicationUpgradePolicyResponse): ApplicationUpgradePolicyResponse {
    return {
        ...val,
        applicationHealthPolicy: (val.applicationHealthPolicy ? outputs.servicefabric.v20201201preview.armApplicationHealthPolicyResponseProvideDefaults(val.applicationHealthPolicy) : undefined),
    };
}
...
export interface ArmApplicationHealthPolicyResponse {
     ...
     * The health policy used by default to evaluate the health of a service type.
     */
    defaultServiceTypeHealthPolicy?: outputs.servicefabric.v20201201preview.ArmServiceTypeHealthPolicyResponse;
    /**
     ...
     * The map with service type health policy per service type name. The map is empty by default.
     */
    serviceTypeHealthPolicyMap?: {[key: string]: outputs.servicefabric.v20201201preview.ArmServiceTypeHealthPolicyResponse};
}
/**
...
export function armApplicationHealthPolicyResponseProvideDefaults(val: ArmApplicationHealthPolicyResponse): ArmApplicationHealthPolicyResponse {
    return {
        ...
        defaultServiceTypeHealthPolicy: (val.defaultServiceTypeHealthPolicy ? outputs.servicefabric.v20201201preview.armServiceTypeHealthPolicyResponseProvideDefaults(val.defaultServiceTypeHealthPolicy) : undefined),
...
export interface ClusterHealthPolicyResponse {
     ...
     */
    applicationHealthPolicies?: {[key: string]: outputs.servicefabric.v20201201preview.ApplicationHealthPolicyResponse};
    /**
...
export interface ClusterUpgradeDeltaHealthPolicyResponse {
     ...
     */
    applicationDeltaHealthPolicies?: {[key: string]: outputs.servicefabric.v20201201preview.ApplicationDeltaHealthPolicyResponse};
    /**
...
export interface ClusterUpgradePolicyResponse {
     ...
     */
    deltaHealthPolicy?: outputs.servicefabric.v20201201preview.ClusterUpgradeDeltaHealthPolicyResponse;
    /**
     * If true, then processes are forcefully restarted during upgrade even when the code version has not changed (the upgrade only changes configuration or data).
     */
    forceRestart?: boolean;
     ...
     */
    healthPolicy: outputs.servicefabric.v20201201preview.ClusterHealthPolicyResponse;
    /**
...
export function clusterUpgradePolicyResponseProvideDefaults(val: ClusterUpgradePolicyResponse): ClusterUpgradePolicyResponse {
    return {
        ...val,
        healthPolicy: outputs.servicefabric.v20201201preview.clusterHealthPolicyResponseProvideDefaults(val.healthPolicy),
    };
}
...
export interface ManagedIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.servicefabric.v20201201preview.UserAssignedIdentityResponse};
}
...
export interface NodeTypeDescriptionResponse {
     ...
     */
    applicationPorts?: outputs.servicefabric.v20201201preview.EndpointRangeDescriptionResponse;
    /**
     ...
     */
    ephemeralPorts?: outputs.servicefabric.v20201201preview.EndpointRangeDescriptionResponse;
    /**
...
export interface ServerCertificateCommonNamesResponse {
     ...
     */
    commonNames?: outputs.servicefabric.v20201201preview.ServerCertificateCommonNameResponse[];
    /**
     * The local certificate store location.
     */
    x509StoreName?: string;
...
export interface SettingsSectionDescriptionResponse {
     ...
     */
    parameters: outputs.servicefabric.v20201201preview.SettingsParameterDescriptionResponse[];
}
