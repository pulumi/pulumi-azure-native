...
export interface ApplicationHealthPolicyResponse {
     ...
     */
    defaultServiceTypeHealthPolicy?: outputs.servicefabric.v20220101.ServiceTypeHealthPolicyResponse;
    /**
     ...
     */
    serviceTypeHealthPolicyMap?: {[key: string]: outputs.servicefabric.v20220101.ServiceTypeHealthPolicyResponse};
}
...
export interface ApplicationUpgradePolicyResponse {
     ...
     * Defines a health policy used to evaluate the health of an application or one of its children entities.
     */
    applicationHealthPolicy?: outputs.servicefabric.v20220101.ApplicationHealthPolicyResponse;
    /**
     ...
     */
    rollingUpgradeMonitoringPolicy?: outputs.servicefabric.v20220101.RollingUpgradeMonitoringPolicyResponse;
    /**
...
export interface ManagedIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.servicefabric.v20220101.UserAssignedIdentityResponse};
}
...
export interface ScalingPolicyResponse {
     ...
     */
    scalingMechanism: outputs.servicefabric.v20220101.AddRemoveIncrementalNamedPartitionScalingMechanismResponse | outputs.servicefabric.v20220101.PartitionInstanceCountScaleMechanismResponse;
    /**
     * Specifies the trigger associated with this scaling policy.
     */
    scalingTrigger: outputs.servicefabric.v20220101.AveragePartitionLoadScalingTriggerResponse | outputs.servicefabric.v20220101.AverageServiceLoadScalingTriggerResponse;
}
...
export interface SettingsSectionDescriptionResponse {
     ...
     */
    parameters: outputs.servicefabric.v20220101.SettingsParameterDescriptionResponse[];
}
...
export interface StatefulServicePropertiesResponse {
     ...
     */
    correlationScheme?: outputs.servicefabric.v20220101.ServiceCorrelationResponse[];
    /**
     ...
     */
    partitionDescription: outputs.servicefabric.v20220101.NamedPartitionSchemeResponse | outputs.servicefabric.v20220101.SingletonPartitionSchemeResponse | outputs.servicefabric.v20220101.UniformInt64RangePartitionSchemeResponse;
    /**
     ...
     */
    scalingPolicies?: outputs.servicefabric.v20220101.ScalingPolicyResponse[];
    /**
     ...
     */
    serviceLoadMetrics?: outputs.servicefabric.v20220101.ServiceLoadMetricResponse[];
    /**
     ...
     * A list that describes the correlation of the service with other services.
     */
    servicePlacementPolicies?: (outputs.servicefabric.v20220101.ServicePlacementInvalidDomainPolicyResponse | outputs.servicefabric.v20220101.ServicePlacementNonPartiallyPlaceServicePolicyResponse | outputs.servicefabric.v20220101.ServicePlacementPreferPrimaryDomainPolicyResponse | outputs.servicefabric.v20220101.ServicePlacementRequireDomainDistributionPolicyResponse | outputs.servicefabric.v20220101.ServicePlacementRequiredDomainPolicyResponse)[];
    /**
...
export interface VaultSecretGroupResponse {
     ...
     */
    sourceVault: outputs.servicefabric.v20220101.SubResourceResponse;
    /**
     * The list of key vault references in SourceVault which contain certificates.
     */
    vaultCertificates: outputs.servicefabric.v20220101.VaultCertificateResponse[];
}
