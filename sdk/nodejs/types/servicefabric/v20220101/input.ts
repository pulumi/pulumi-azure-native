...
export interface ApplicationHealthPolicyArgs {
     ...
     */
    defaultServiceTypeHealthPolicy?: pulumi.Input<inputs.servicefabric.v20220101.ServiceTypeHealthPolicyArgs>;
    /**
     ...
     */
    serviceTypeHealthPolicyMap?: pulumi.Input<{[key: string]: pulumi.Input<inputs.servicefabric.v20220101.ServiceTypeHealthPolicyArgs>}>;
}
...
export interface ApplicationUpgradePolicyArgs {
     ...
     * Defines a health policy used to evaluate the health of an application or one of its children entities.
     */
    applicationHealthPolicy?: pulumi.Input<inputs.servicefabric.v20220101.ApplicationHealthPolicyArgs>;
    /**
     ...
     */
    rollingUpgradeMonitoringPolicy?: pulumi.Input<inputs.servicefabric.v20220101.RollingUpgradeMonitoringPolicyArgs>;
    /**
     * The mode used to monitor health during a rolling upgrade. The values are Monitored, and UnmonitoredAuto.
     */
    upgradeMode?: pulumi.Input<string | enums.servicefabric.v20220101.RollingUpgradeMode>;
    /**
...
export interface FrontendConfigurationArgs {
     ...
     */
    ipAddressType?: pulumi.Input<string | enums.servicefabric.v20220101.IPAddressType>;
    /**
...
export interface LoadBalancingRuleArgs {
     ...
     */
    probeProtocol: pulumi.Input<string | enums.servicefabric.v20220101.ProbeProtocol>;
    /**
     ...
     */
    protocol: pulumi.Input<string | enums.servicefabric.v20220101.Protocol>;
}
...
export interface ManagedIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.servicefabric.v20220101.ManagedIdentityType>;
    /**
...
export interface NetworkSecurityRuleArgs {
     ...
     */
    access: pulumi.Input<string | enums.servicefabric.v20220101.Access>;
    /**
     ...
     */
    direction: pulumi.Input<string | enums.servicefabric.v20220101.Direction>;
    /**
     ...
     */
    protocol: pulumi.Input<string | enums.servicefabric.v20220101.NsgProtocol>;
    /**
...
export interface RollingUpgradeMonitoringPolicyArgs {
     ...
     */
    failureAction: pulumi.Input<string | enums.servicefabric.v20220101.FailureAction>;
    /**
...
export interface ScalingPolicyArgs {
     ...
     */
    scalingMechanism: pulumi.Input<inputs.servicefabric.v20220101.AddRemoveIncrementalNamedPartitionScalingMechanismArgs | inputs.servicefabric.v20220101.PartitionInstanceCountScaleMechanismArgs>;
    /**
     * Specifies the trigger associated with this scaling policy.
     */
    scalingTrigger: pulumi.Input<inputs.servicefabric.v20220101.AveragePartitionLoadScalingTriggerArgs | inputs.servicefabric.v20220101.AverageServiceLoadScalingTriggerArgs>;
}
...
export interface ServiceCorrelationArgs {
     ...
     */
    scheme: pulumi.Input<string | enums.servicefabric.v20220101.ServiceCorrelationScheme>;
    /**
...
export interface ServiceLoadMetricArgs {
     ...
     */
    weight?: pulumi.Input<string | enums.servicefabric.v20220101.ServiceLoadMetricWeight>;
}
...
export interface SettingsSectionDescriptionArgs {
     ...
     */
    parameters: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220101.SettingsParameterDescriptionArgs>[]>;
}
...
export interface SkuArgs {
     ...
     * Sku Name.
     */
    name: pulumi.Input<string | enums.servicefabric.v20220101.SkuName>;
}
...
export interface StatefulServicePropertiesArgs {
     ...
     */
    correlationScheme?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220101.ServiceCorrelationArgs>[]>;
    /**
     * Specifies the move cost for the service.
     */
    defaultMoveCost?: pulumi.Input<string | enums.servicefabric.v20220101.MoveCost>;
    /**
     ...
     */
    partitionDescription: pulumi.Input<inputs.servicefabric.v20220101.NamedPartitionSchemeArgs | inputs.servicefabric.v20220101.SingletonPartitionSchemeArgs | inputs.servicefabric.v20220101.UniformInt64RangePartitionSchemeArgs>;
    /**
     ...
     */
    scalingPolicies?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220101.ScalingPolicyArgs>[]>;
    /**
     ...
     */
    serviceLoadMetrics?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220101.ServiceLoadMetricArgs>[]>;
    /**
     * The activation Mode of the service package
     */
    servicePackageActivationMode?: pulumi.Input<string | enums.servicefabric.v20220101.ServicePackageActivationMode>;
    /**
     * A list that describes the correlation of the service with other services.
     */
    servicePlacementPolicies?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220101.ServicePlacementInvalidDomainPolicyArgs | inputs.servicefabric.v20220101.ServicePlacementNonPartiallyPlaceServicePolicyArgs | inputs.servicefabric.v20220101.ServicePlacementPreferPrimaryDomainPolicyArgs | inputs.servicefabric.v20220101.ServicePlacementRequireDomainDistributionPolicyArgs | inputs.servicefabric.v20220101.ServicePlacementRequiredDomainPolicyArgs>[]>;
    /**
...
export interface SubnetArgs {
     ...
     */
    privateEndpointNetworkPolicies?: pulumi.Input<string | enums.servicefabric.v20220101.PrivateEndpointNetworkPolicies>;
    /**
     * Enable or Disable apply network policies on private link service in the subnet.
     */
    privateLinkServiceNetworkPolicies?: pulumi.Input<string | enums.servicefabric.v20220101.PrivateLinkServiceNetworkPolicies>;
}
...
export interface VaultSecretGroupArgs {
     ...
     */
    sourceVault: pulumi.Input<inputs.servicefabric.v20220101.SubResourceArgs>;
    /**
     * The list of key vault references in SourceVault which contain certificates.
     */
    vaultCertificates: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220101.VaultCertificateArgs>[]>;
}
...
export interface VmssDataDiskArgs {
     ...
     */
    diskType: pulumi.Input<string | enums.servicefabric.v20220101.DiskType>;
    /**
