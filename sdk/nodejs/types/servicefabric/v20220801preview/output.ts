...
export interface ApplicationHealthPolicyResponse {
     ...
     */
    defaultServiceTypeHealthPolicy?: outputs.servicefabric.v20220801preview.ServiceTypeHealthPolicyResponse;
    /**
     ...
     */
    serviceTypeHealthPolicyMap?: {[key: string]: outputs.servicefabric.v20220801preview.ServiceTypeHealthPolicyResponse};
}
...
export interface ApplicationUpgradePolicyResponse {
     ...
     * Defines a health policy used to evaluate the health of an application or one of its children entities.
     */
    applicationHealthPolicy?: outputs.servicefabric.v20220801preview.ApplicationHealthPolicyResponse;
    /**
     ...
     */
    rollingUpgradeMonitoringPolicy?: outputs.servicefabric.v20220801preview.RollingUpgradeMonitoringPolicyResponse;
    /**
...
export interface ManagedIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.servicefabric.v20220801preview.UserAssignedIdentityResponse};
}
...
export interface ScalingPolicyResponse {
     ...
     */
    scalingMechanism: outputs.servicefabric.v20220801preview.AddRemoveIncrementalNamedPartitionScalingMechanismResponse | outputs.servicefabric.v20220801preview.PartitionInstanceCountScaleMechanismResponse;
    /**
     * Specifies the trigger associated with this scaling policy.
     */
    scalingTrigger: outputs.servicefabric.v20220801preview.AveragePartitionLoadScalingTriggerResponse | outputs.servicefabric.v20220801preview.AverageServiceLoadScalingTriggerResponse;
}
...
export interface SettingsSectionDescriptionResponse {
     ...
     */
    parameters: outputs.servicefabric.v20220801preview.SettingsParameterDescriptionResponse[];
}
...
export interface StatefulServicePropertiesResponse {
     ...
     */
    correlationScheme?: outputs.servicefabric.v20220801preview.ServiceCorrelationResponse[];
    /**
     ...
     */
    partitionDescription: outputs.servicefabric.v20220801preview.NamedPartitionSchemeResponse | outputs.servicefabric.v20220801preview.SingletonPartitionSchemeResponse | outputs.servicefabric.v20220801preview.UniformInt64RangePartitionSchemeResponse;
    /**
     ...
     */
    scalingPolicies?: outputs.servicefabric.v20220801preview.ScalingPolicyResponse[];
    /**
     ...
     */
    serviceLoadMetrics?: outputs.servicefabric.v20220801preview.ServiceLoadMetricResponse[];
    /**
     ...
     * A list that describes the correlation of the service with other services.
     */
    servicePlacementPolicies?: (outputs.servicefabric.v20220801preview.ServicePlacementInvalidDomainPolicyResponse | outputs.servicefabric.v20220801preview.ServicePlacementNonPartiallyPlaceServicePolicyResponse | outputs.servicefabric.v20220801preview.ServicePlacementPreferPrimaryDomainPolicyResponse | outputs.servicefabric.v20220801preview.ServicePlacementRequireDomainDistributionPolicyResponse | outputs.servicefabric.v20220801preview.ServicePlacementRequiredDomainPolicyResponse)[];
    /**
...
export interface VaultSecretGroupResponse {
     ...
     */
    sourceVault: outputs.servicefabric.v20220801preview.SubResourceResponse;
    /**
     * The list of key vault references in SourceVault which contain certificates.
     */
    vaultCertificates: outputs.servicefabric.v20220801preview.VaultCertificateResponse[];
}
