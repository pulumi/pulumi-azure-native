...
export interface ApplicationHealthPolicyArgs {
     ...
     */
    defaultServiceTypeHealthPolicy?: pulumi.Input<inputs.servicefabric.v20220801preview.ServiceTypeHealthPolicyArgs>;
    /**
     ...
     */
    serviceTypeHealthPolicyMap?: pulumi.Input<{[key: string]: pulumi.Input<inputs.servicefabric.v20220801preview.ServiceTypeHealthPolicyArgs>}>;
}
...
export interface ApplicationUpgradePolicyArgs {
     ...
     * Defines a health policy used to evaluate the health of an application or one of its children entities.
     */
    applicationHealthPolicy?: pulumi.Input<inputs.servicefabric.v20220801preview.ApplicationHealthPolicyArgs>;
    /**
     ...
     */
    rollingUpgradeMonitoringPolicy?: pulumi.Input<inputs.servicefabric.v20220801preview.RollingUpgradeMonitoringPolicyArgs>;
    /**
     * The mode used to monitor health during a rolling upgrade. The values are Monitored, and UnmonitoredAuto.
     */
    upgradeMode?: pulumi.Input<string | enums.servicefabric.v20220801preview.RollingUpgradeMode>;
    /**
...
export interface FrontendConfigurationArgs {
     ...
     */
    ipAddressType?: pulumi.Input<string | enums.servicefabric.v20220801preview.IPAddressType>;
    /**
...
export interface LoadBalancingRuleArgs {
     ...
     */
    probeProtocol: pulumi.Input<string | enums.servicefabric.v20220801preview.ProbeProtocol>;
    /**
     ...
     */
    protocol: pulumi.Input<string | enums.servicefabric.v20220801preview.Protocol>;
}
...
export interface ManagedIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.servicefabric.v20220801preview.ManagedIdentityType>;
    /**
...
export interface NetworkSecurityRuleArgs {
     ...
     */
    access: pulumi.Input<string | enums.servicefabric.v20220801preview.Access>;
    /**
     ...
     */
    direction: pulumi.Input<string | enums.servicefabric.v20220801preview.Direction>;
    /**
     ...
     */
    protocol: pulumi.Input<string | enums.servicefabric.v20220801preview.NsgProtocol>;
    /**
...
export interface RollingUpgradeMonitoringPolicyArgs {
     ...
     */
    failureAction: pulumi.Input<string | enums.servicefabric.v20220801preview.FailureAction>;
    /**
...
export interface ScalingPolicyArgs {
     ...
     */
    scalingMechanism: pulumi.Input<inputs.servicefabric.v20220801preview.AddRemoveIncrementalNamedPartitionScalingMechanismArgs | inputs.servicefabric.v20220801preview.PartitionInstanceCountScaleMechanismArgs>;
    /**
     * Specifies the trigger associated with this scaling policy.
     */
    scalingTrigger: pulumi.Input<inputs.servicefabric.v20220801preview.AveragePartitionLoadScalingTriggerArgs | inputs.servicefabric.v20220801preview.AverageServiceLoadScalingTriggerArgs>;
}
...
export interface ServiceCorrelationArgs {
     ...
     */
    scheme: pulumi.Input<string | enums.servicefabric.v20220801preview.ServiceCorrelationScheme>;
    /**
...
export interface ServiceLoadMetricArgs {
     ...
     */
    weight?: pulumi.Input<string | enums.servicefabric.v20220801preview.ServiceLoadMetricWeight>;
}
...
export interface SettingsSectionDescriptionArgs {
     ...
     */
    parameters: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220801preview.SettingsParameterDescriptionArgs>[]>;
}
...
export interface SkuArgs {
     ...
     * Sku Name.
     */
    name: pulumi.Input<string | enums.servicefabric.v20220801preview.SkuName>;
}
...
export interface StatefulServicePropertiesArgs {
     ...
     */
    correlationScheme?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220801preview.ServiceCorrelationArgs>[]>;
    /**
     * Specifies the move cost for the service.
     */
    defaultMoveCost?: pulumi.Input<string | enums.servicefabric.v20220801preview.MoveCost>;
    /**
     ...
     */
    partitionDescription: pulumi.Input<inputs.servicefabric.v20220801preview.NamedPartitionSchemeArgs | inputs.servicefabric.v20220801preview.SingletonPartitionSchemeArgs | inputs.servicefabric.v20220801preview.UniformInt64RangePartitionSchemeArgs>;
    /**
     ...
     */
    scalingPolicies?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220801preview.ScalingPolicyArgs>[]>;
    /**
     ...
     */
    serviceLoadMetrics?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220801preview.ServiceLoadMetricArgs>[]>;
    /**
     * The activation Mode of the service package
     */
    servicePackageActivationMode?: pulumi.Input<string | enums.servicefabric.v20220801preview.ServicePackageActivationMode>;
    /**
     * A list that describes the correlation of the service with other services.
     */
    servicePlacementPolicies?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220801preview.ServicePlacementInvalidDomainPolicyArgs | inputs.servicefabric.v20220801preview.ServicePlacementNonPartiallyPlaceServicePolicyArgs | inputs.servicefabric.v20220801preview.ServicePlacementPreferPrimaryDomainPolicyArgs | inputs.servicefabric.v20220801preview.ServicePlacementRequireDomainDistributionPolicyArgs | inputs.servicefabric.v20220801preview.ServicePlacementRequiredDomainPolicyArgs>[]>;
    /**
...
export interface SubnetArgs {
     ...
     */
    privateEndpointNetworkPolicies?: pulumi.Input<string | enums.servicefabric.v20220801preview.PrivateEndpointNetworkPolicies>;
    /**
     * Enable or Disable apply network policies on private link service in the subnet.
     */
    privateLinkServiceNetworkPolicies?: pulumi.Input<string | enums.servicefabric.v20220801preview.PrivateLinkServiceNetworkPolicies>;
}
...
export interface VaultSecretGroupArgs {
     ...
     */
    sourceVault: pulumi.Input<inputs.servicefabric.v20220801preview.SubResourceArgs>;
    /**
     * The list of key vault references in SourceVault which contain certificates.
     */
    vaultCertificates: pulumi.Input<pulumi.Input<inputs.servicefabric.v20220801preview.VaultCertificateArgs>[]>;
}
...
export interface VmssDataDiskArgs {
     ...
     */
    diskType: pulumi.Input<string | enums.servicefabric.v20220801preview.DiskType>;
    /**
