...
export interface ApplicationHealthPolicyResponse {
     ...
     */
    defaultServiceTypeHealthPolicy?: outputs.servicefabric.v20220601preview.ServiceTypeHealthPolicyResponse;
    /**
     ...
     */
    serviceTypeHealthPolicyMap?: {[key: string]: outputs.servicefabric.v20220601preview.ServiceTypeHealthPolicyResponse};
}
...
export interface ApplicationUpgradePolicyResponse {
     ...
     * Defines a health policy used to evaluate the health of an application or one of its children entities.
     */
    applicationHealthPolicy?: outputs.servicefabric.v20220601preview.ApplicationHealthPolicyResponse;
    /**
     ...
     */
    rollingUpgradeMonitoringPolicy?: outputs.servicefabric.v20220601preview.RollingUpgradeMonitoringPolicyResponse;
    /**
...
export interface ManagedIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.servicefabric.v20220601preview.UserAssignedIdentityResponse};
}
...
export interface ScalingPolicyResponse {
     ...
     */
    scalingMechanism: outputs.servicefabric.v20220601preview.AddRemoveIncrementalNamedPartitionScalingMechanismResponse | outputs.servicefabric.v20220601preview.PartitionInstanceCountScaleMechanismResponse;
    /**
     * Specifies the trigger associated with this scaling policy.
     */
    scalingTrigger: outputs.servicefabric.v20220601preview.AveragePartitionLoadScalingTriggerResponse | outputs.servicefabric.v20220601preview.AverageServiceLoadScalingTriggerResponse;
}
...
export interface SettingsSectionDescriptionResponse {
     ...
     */
    parameters: outputs.servicefabric.v20220601preview.SettingsParameterDescriptionResponse[];
}
...
export interface StatefulServicePropertiesResponse {
     ...
     */
    correlationScheme?: outputs.servicefabric.v20220601preview.ServiceCorrelationResponse[];
    /**
     ...
     */
    partitionDescription: outputs.servicefabric.v20220601preview.NamedPartitionSchemeResponse | outputs.servicefabric.v20220601preview.SingletonPartitionSchemeResponse | outputs.servicefabric.v20220601preview.UniformInt64RangePartitionSchemeResponse;
    /**
     ...
     */
    scalingPolicies?: outputs.servicefabric.v20220601preview.ScalingPolicyResponse[];
    /**
     ...
     */
    serviceLoadMetrics?: outputs.servicefabric.v20220601preview.ServiceLoadMetricResponse[];
    /**
     ...
     * A list that describes the correlation of the service with other services.
     */
    servicePlacementPolicies?: (outputs.servicefabric.v20220601preview.ServicePlacementInvalidDomainPolicyResponse | outputs.servicefabric.v20220601preview.ServicePlacementNonPartiallyPlaceServicePolicyResponse | outputs.servicefabric.v20220601preview.ServicePlacementPreferPrimaryDomainPolicyResponse | outputs.servicefabric.v20220601preview.ServicePlacementRequireDomainDistributionPolicyResponse | outputs.servicefabric.v20220601preview.ServicePlacementRequiredDomainPolicyResponse)[];
    /**
...
export interface VaultSecretGroupResponse {
     ...
     */
    sourceVault: outputs.servicefabric.v20220601preview.SubResourceResponse;
    /**
     * The list of key vault references in SourceVault which contain certificates.
     */
    vaultCertificates: outputs.servicefabric.v20220601preview.VaultCertificateResponse[];
}
