...
export interface ApplicationHealthPolicyArgs {
     ...
     */
    defaultServiceTypeHealthPolicy?: pulumi.Input<inputs.servicefabric.v20210101preview.ServiceTypeHealthPolicyArgs>;
    /**
     ...
     */
    serviceTypeHealthPolicyMap?: pulumi.Input<{[key: string]: pulumi.Input<inputs.servicefabric.v20210101preview.ServiceTypeHealthPolicyArgs>}>;
}
...
export interface ApplicationUpgradePolicyArgs {
     ...
     * Defines a health policy used to evaluate the health of an application or one of its children entities.
     */
    applicationHealthPolicy?: pulumi.Input<inputs.servicefabric.v20210101preview.ApplicationHealthPolicyArgs>;
    /**
     ...
     */
    rollingUpgradeMonitoringPolicy?: pulumi.Input<inputs.servicefabric.v20210101preview.RollingUpgradeMonitoringPolicyArgs>;
    /**
     * The mode used to monitor health during a rolling upgrade. The values are Monitored, and UnmonitoredAuto.
     */
    upgradeMode?: pulumi.Input<string | enums.servicefabric.v20210101preview.RollingUpgradeMode>;
    /**
...
export interface LoadBalancingRuleArgs {
     ...
     */
    probeProtocol: pulumi.Input<string | enums.servicefabric.v20210101preview.ProbeProtocol>;
    /**
     ...
     */
    protocol: pulumi.Input<string | enums.servicefabric.v20210101preview.Protocol>;
}
...
export interface ManagedIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.servicefabric.v20210101preview.ManagedIdentityType>;
    /**
...
export interface NetworkSecurityRuleArgs {
     ...
     */
    access: pulumi.Input<string | enums.servicefabric.v20210101preview.Access>;
    /**
     ...
     */
    direction: pulumi.Input<string | enums.servicefabric.v20210101preview.Direction>;
    /**
     ...
     */
    protocol: pulumi.Input<string | enums.servicefabric.v20210101preview.NsgProtocol>;
    /**
...
export interface RollingUpgradeMonitoringPolicyArgs {
     ...
     */
    failureAction: pulumi.Input<string | enums.servicefabric.v20210101preview.FailureAction>;
    /**
...
export interface ScalingPolicyArgs {
     ...
     */
    scalingMechanism: pulumi.Input<inputs.servicefabric.v20210101preview.AddRemoveIncrementalNamedPartitionScalingMechanismArgs | inputs.servicefabric.v20210101preview.PartitionInstanceCountScaleMechanismArgs>;
    /**
     * Specifies the trigger associated with this scaling policy.
     */
    scalingTrigger: pulumi.Input<inputs.servicefabric.v20210101preview.AveragePartitionLoadScalingTriggerArgs | inputs.servicefabric.v20210101preview.AverageServiceLoadScalingTriggerArgs>;
}
...
export interface ServiceCorrelationArgs {
     ...
     */
    scheme: pulumi.Input<string | enums.servicefabric.v20210101preview.ServiceCorrelationScheme>;
    /**
...
export interface ServiceLoadMetricArgs {
     ...
     */
    weight?: pulumi.Input<string | enums.servicefabric.v20210101preview.ServiceLoadMetricWeight>;
}
...
export interface SettingsSectionDescriptionArgs {
     ...
     */
    parameters: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210101preview.SettingsParameterDescriptionArgs>[]>;
}
...
export interface StatefulServicePropertiesArgs {
     ...
     */
    correlationScheme?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210101preview.ServiceCorrelationArgs>[]>;
    /**
     * Specifies the move cost for the service.
     */
    defaultMoveCost?: pulumi.Input<string | enums.servicefabric.v20210101preview.MoveCost>;
    /**
     ...
     */
    partitionDescription: pulumi.Input<inputs.servicefabric.v20210101preview.NamedPartitionSchemeArgs | inputs.servicefabric.v20210101preview.SingletonPartitionSchemeArgs | inputs.servicefabric.v20210101preview.UniformInt64RangePartitionSchemeArgs>;
    /**
     ...
     */
    scalingPolicies?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210101preview.ScalingPolicyArgs>[]>;
    /**
     ...
     */
    serviceLoadMetrics?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210101preview.ServiceLoadMetricArgs>[]>;
    /**
     * The activation Mode of the service package
     */
    servicePackageActivationMode?: pulumi.Input<string | enums.servicefabric.v20210101preview.ServicePackageActivationMode>;
    /**
     * A list that describes the correlation of the service with other services.
     */
    servicePlacementPolicies?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210101preview.ServicePlacementInvalidDomainPolicyArgs | inputs.servicefabric.v20210101preview.ServicePlacementNonPartiallyPlaceServicePolicyArgs | inputs.servicefabric.v20210101preview.ServicePlacementPreferPrimaryDomainPolicyArgs | inputs.servicefabric.v20210101preview.ServicePlacementRequireDomainDistributionPolicyArgs | inputs.servicefabric.v20210101preview.ServicePlacementRequiredDomainPolicyArgs>[]>;
    /**
...
export interface VaultSecretGroupArgs {
     ...
     */
    sourceVault: pulumi.Input<inputs.servicefabric.v20210101preview.SubResourceArgs>;
    /**
     * The list of key vault references in SourceVault which contain certificates.
     */
    vaultCertificates: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210101preview.VaultCertificateArgs>[]>;
}
