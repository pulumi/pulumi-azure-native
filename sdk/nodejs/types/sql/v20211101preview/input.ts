...
export interface DatabaseIdentityArgs {
     ...
     * The identity type
     */
    type?: pulumi.Input<string | enums.sql.v20211101preview.DatabaseIdentityType>;
    /**
...
export interface FailoverGroupReadOnlyEndpointArgs {
     ...
     */
    failoverPolicy?: pulumi.Input<string | enums.sql.v20211101preview.ReadOnlyEndpointFailoverPolicy>;
}
...
export interface FailoverGroupReadWriteEndpointArgs {
     ...
     */
    failoverPolicy: pulumi.Input<string | enums.sql.v20211101preview.ReadWriteEndpointFailoverPolicy>;
    /**
...
export interface JobScheduleArgs {
     ...
     */
    type?: pulumi.Input<enums.sql.v20211101preview.JobScheduleType>;
}
/**
...
export interface JobStepActionArgs {
     ...
     */
    source?: pulumi.Input<string | enums.sql.v20211101preview.JobStepActionSource>;
    /**
     * Type of action being executed by the job step.
     */
    type?: pulumi.Input<string | enums.sql.v20211101preview.JobStepActionType>;
    /**
...
export interface JobStepOutputArgs {
     ...
     */
    type?: pulumi.Input<string | enums.sql.v20211101preview.JobStepOutputType>;
}
/**
...
export interface JobTargetArgs {
     ...
     */
    membershipType?: pulumi.Input<enums.sql.v20211101preview.JobTargetGroupMembershipType>;
    /**
     ...
     * The target type.
     */
    type: pulumi.Input<string | enums.sql.v20211101preview.JobTargetType>;
}
/**
...
export interface ManagedInstanceExternalAdministratorArgs {
     ...
     */
    principalType?: pulumi.Input<string | enums.sql.v20211101preview.PrincipalType>;
    /**
...
export interface PrivateLinkServiceConnectionStatePropertyArgs {
     ...
     * The private link service connection status.
     */
    status: pulumi.Input<string | enums.sql.v20211101preview.PrivateLinkServiceConnectionStateStatus>;
}
...
export interface ResourceIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.sql.v20211101preview.IdentityType>;
    /**
     * The resource ids of the user assigned identities to use
     */
    userAssignedIdentities?: pulumi.Input<{[key: string]: any}>;
...
export interface ServicePrincipalArgs {
     ...
     */
    type?: pulumi.Input<string | enums.sql.v20211101preview.ServicePrincipalType>;
}
...
export interface SyncGroupSchemaArgs {
     ...
     */
    tables?: pulumi.Input<pulumi.Input<inputs.sql.v20211101preview.SyncGroupSchemaTableArgs>[]>;
}
...
export interface SyncGroupSchemaTableArgs {
     ...
     */
    columns?: pulumi.Input<pulumi.Input<inputs.sql.v20211101preview.SyncGroupSchemaTableColumnArgs>[]>;
    /**
