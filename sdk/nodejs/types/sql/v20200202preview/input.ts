...
export interface FailoverGroupReadOnlyEndpointArgs {
     ...
     */
    failoverPolicy?: pulumi.Input<string | enums.sql.v20200202preview.ReadOnlyEndpointFailoverPolicy>;
}
...
export interface FailoverGroupReadWriteEndpointArgs {
     ...
     */
    failoverPolicy: pulumi.Input<string | enums.sql.v20200202preview.ReadWriteEndpointFailoverPolicy>;
    /**
...
export interface JobScheduleArgs {
     ...
     */
    type?: pulumi.Input<enums.sql.v20200202preview.JobScheduleType>;
}
/**
...
export interface JobStepActionArgs {
     ...
     */
    source?: pulumi.Input<string | enums.sql.v20200202preview.JobStepActionSource>;
    /**
     * Type of action being executed by the job step.
     */
    type?: pulumi.Input<string | enums.sql.v20200202preview.JobStepActionType>;
    /**
...
export interface JobStepOutputArgs {
     ...
     */
    type?: pulumi.Input<string | enums.sql.v20200202preview.JobStepOutputType>;
}
/**
...
export interface JobTargetArgs {
     ...
     */
    membershipType?: pulumi.Input<enums.sql.v20200202preview.JobTargetGroupMembershipType>;
    /**
     ...
     * The target type.
     */
    type: pulumi.Input<string | enums.sql.v20200202preview.JobTargetType>;
}
/**
...
export interface PrivateLinkServiceConnectionStatePropertyArgs {
     ...
     * The private link service connection status.
     */
    status: pulumi.Input<string | enums.sql.v20200202preview.PrivateLinkServiceConnectionStateStatus>;
}
...
export interface ResourceIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.sql.v20200202preview.IdentityType>;
}
...
export interface SyncGroupSchemaArgs {
     ...
     */
    tables?: pulumi.Input<pulumi.Input<inputs.sql.v20200202preview.SyncGroupSchemaTableArgs>[]>;
}
...
export interface SyncGroupSchemaTableArgs {
     ...
     */
    columns?: pulumi.Input<pulumi.Input<inputs.sql.v20200202preview.SyncGroupSchemaTableColumnArgs>[]>;
    /**
