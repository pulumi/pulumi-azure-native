...
export interface DatabaseIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.sql.v20210801preview.DatabaseUserIdentityResponse};
}
...
export interface ManagedInstancePecPropertyResponse {
     ...
     */
    properties: outputs.sql.v20210801preview.ManagedInstancePrivateEndpointConnectionPropertiesResponse;
}
...
export interface ManagedInstancePrivateEndpointConnectionPropertiesResponse {
     ...
     */
    privateEndpoint?: outputs.sql.v20210801preview.ManagedInstancePrivateEndpointPropertyResponse;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    privateLinkServiceConnectionState?: outputs.sql.v20210801preview.ManagedInstancePrivateLinkServiceConnectionStatePropertyResponse;
    /**
...
export interface PrivateEndpointConnectionPropertiesResponse {
     ...
     * Private endpoint which the connection belongs to.
     */
    privateEndpoint?: outputs.sql.v20210801preview.PrivateEndpointPropertyResponse;
    /**
     * Connection state of the private endpoint connection.
     */
    privateLinkServiceConnectionState?: outputs.sql.v20210801preview.PrivateLinkServiceConnectionStatePropertyResponse;
    /**
     * State of the private endpoint connection.
     */
    provisioningState: string;
...
export interface RecommendedActionResponse {
     ...
     */
    errorDetails: outputs.sql.v20210801preview.RecommendedActionErrorInfoResponse;
    /**
     * Gets the estimated impact info for this recommended action e.g., Estimated CPU gain, Estimated Disk Space change
     */
    estimatedImpact: outputs.sql.v20210801preview.RecommendedActionImpactRecordResponse[];
    /**
     ...
     */
    implementationDetails: outputs.sql.v20210801preview.RecommendedActionImplementationInfoResponse;
    /**
     ...
     */
    observedImpact: outputs.sql.v20210801preview.RecommendedActionImpactRecordResponse[];
    /**
     ...
     */
    state: outputs.sql.v20210801preview.RecommendedActionStateInfoResponse;
    /**
     * Gets the time series info of metrics for this recommended action e.g., CPU consumption time series
     */
    timeSeries: outputs.sql.v20210801preview.RecommendedActionMetricInfoResponse[];
    /**
     * Resource type.
     */
    type: string;
...
export interface ResourceIdentityResponse {
     ...
     * The resource ids of the user assigned identities to use
     */
    userAssignedIdentities?: {[key: string]: outputs.sql.v20210801preview.UserIdentityResponse};
}
...
export interface ServerPrivateEndpointConnectionResponse {
     ...
     * Private endpoint connection properties
     */
    properties: outputs.sql.v20210801preview.PrivateEndpointConnectionPropertiesResponse;
}
...
export interface SyncGroupSchemaResponse {
     ...
     */
    tables?: outputs.sql.v20210801preview.SyncGroupSchemaTableResponse[];
}
...
export interface SyncGroupSchemaTableResponse {
     ...
     */
    columns?: outputs.sql.v20210801preview.SyncGroupSchemaTableColumnResponse[];
    /**
