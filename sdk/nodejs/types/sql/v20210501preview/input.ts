...
export interface DatabaseIdentityArgs {
     ...
     * The identity type
     */
    type?: pulumi.Input<string | enums.sql.v20210501preview.DatabaseIdentityType>;
    /**
...
export interface FailoverGroupReadOnlyEndpointArgs {
     ...
     */
    failoverPolicy?: pulumi.Input<string | enums.sql.v20210501preview.ReadOnlyEndpointFailoverPolicy>;
}
...
export interface FailoverGroupReadWriteEndpointArgs {
     ...
     */
    failoverPolicy: pulumi.Input<string | enums.sql.v20210501preview.ReadWriteEndpointFailoverPolicy>;
    /**
...
export interface JobScheduleArgs {
     ...
     */
    type?: pulumi.Input<enums.sql.v20210501preview.JobScheduleType>;
}
/**
...
export interface JobStepActionArgs {
     ...
     */
    source?: pulumi.Input<string | enums.sql.v20210501preview.JobStepActionSource>;
    /**
     * Type of action being executed by the job step.
     */
    type?: pulumi.Input<string | enums.sql.v20210501preview.JobStepActionType>;
    /**
...
export interface JobStepOutputArgs {
     ...
     */
    type?: pulumi.Input<string | enums.sql.v20210501preview.JobStepOutputType>;
}
/**
...
export interface JobTargetArgs {
     ...
     */
    membershipType?: pulumi.Input<enums.sql.v20210501preview.JobTargetGroupMembershipType>;
    /**
     ...
     * The target type.
     */
    type: pulumi.Input<string | enums.sql.v20210501preview.JobTargetType>;
}
/**
...
export interface ManagedInstanceExternalAdministratorArgs {
     ...
     */
    principalType?: pulumi.Input<string | enums.sql.v20210501preview.PrincipalType>;
    /**
...
export interface PrivateLinkServiceConnectionStatePropertyArgs {
     ...
     * The private link service connection status.
     */
    status: pulumi.Input<string | enums.sql.v20210501preview.PrivateLinkServiceConnectionStateStatus>;
}
...
export interface ResourceIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.sql.v20210501preview.IdentityType>;
    /**
     * The resource ids of the user assigned identities to use
     */
    userAssignedIdentities?: pulumi.Input<{[key: string]: any}>;
...
export interface ServicePrincipalArgs {
     ...
     */
    type?: pulumi.Input<string | enums.sql.v20210501preview.ServicePrincipalType>;
}
...
export interface SyncGroupSchemaArgs {
     ...
     */
    tables?: pulumi.Input<pulumi.Input<inputs.sql.v20210501preview.SyncGroupSchemaTableArgs>[]>;
}
...
export interface SyncGroupSchemaTableArgs {
     ...
     */
    columns?: pulumi.Input<pulumi.Input<inputs.sql.v20210501preview.SyncGroupSchemaTableColumnArgs>[]>;
    /**
