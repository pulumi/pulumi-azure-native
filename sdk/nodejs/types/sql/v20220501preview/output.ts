...
export interface DatabaseIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.sql.v20220501preview.DatabaseUserIdentityResponse};
}
...
export interface ManagedInstancePecPropertyResponse {
     ...
     */
    properties: outputs.sql.v20220501preview.ManagedInstancePrivateEndpointConnectionPropertiesResponse;
}
...
export interface ManagedInstancePrivateEndpointConnectionPropertiesResponse {
     ...
     */
    privateEndpoint?: outputs.sql.v20220501preview.ManagedInstancePrivateEndpointPropertyResponse;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    privateLinkServiceConnectionState?: outputs.sql.v20220501preview.ManagedInstancePrivateLinkServiceConnectionStatePropertyResponse;
    /**
...
export interface PrivateEndpointConnectionPropertiesResponse {
     ...
     * Private endpoint which the connection belongs to.
     */
    privateEndpoint?: outputs.sql.v20220501preview.PrivateEndpointPropertyResponse;
    /**
     * Connection state of the private endpoint connection.
     */
    privateLinkServiceConnectionState?: outputs.sql.v20220501preview.PrivateLinkServiceConnectionStatePropertyResponse;
    /**
     * State of the private endpoint connection.
     */
    provisioningState: string;
...
export interface RecommendedActionResponse {
     ...
     */
    errorDetails: outputs.sql.v20220501preview.RecommendedActionErrorInfoResponse;
    /**
     * Gets the estimated impact info for this recommended action e.g., Estimated CPU gain, Estimated Disk Space change
     */
    estimatedImpact: outputs.sql.v20220501preview.RecommendedActionImpactRecordResponse[];
    /**
     ...
     */
    implementationDetails: outputs.sql.v20220501preview.RecommendedActionImplementationInfoResponse;
    /**
     ...
     */
    observedImpact: outputs.sql.v20220501preview.RecommendedActionImpactRecordResponse[];
    /**
     ...
     */
    state: outputs.sql.v20220501preview.RecommendedActionStateInfoResponse;
    /**
     * Gets the time series info of metrics for this recommended action e.g., CPU consumption time series
     */
    timeSeries: outputs.sql.v20220501preview.RecommendedActionMetricInfoResponse[];
    /**
     * Resource type.
     */
    type: string;
...
export interface ResourceIdentityResponse {
     ...
     * The resource ids of the user assigned identities to use
     */
    userAssignedIdentities?: {[key: string]: outputs.sql.v20220501preview.UserIdentityResponse};
}
...
export interface ServerPrivateEndpointConnectionResponse {
     ...
     * Private endpoint connection properties
     */
    properties: outputs.sql.v20220501preview.PrivateEndpointConnectionPropertiesResponse;
}
...
export interface SyncGroupSchemaResponse {
     ...
     */
    tables?: outputs.sql.v20220501preview.SyncGroupSchemaTableResponse[];
}
...
export interface SyncGroupSchemaTableResponse {
     ...
     */
    columns?: outputs.sql.v20220501preview.SyncGroupSchemaTableColumnResponse[];
    /**
