...
export interface ApplicationScopedVolumeResponse {
     ...
     */
    creationParameters: outputs.servicefabricmesh.ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskResponse;
    /**
...
export interface AutoScalingPolicyResponse {
     ...
     */
    mechanism: outputs.servicefabricmesh.AddRemoveReplicaScalingMechanismResponse;
    /**
     ...
     */
    trigger: outputs.servicefabricmesh.AverageLoadScalingTriggerResponse;
}
...
export interface AverageLoadScalingTriggerResponse {
     ...
     */
    metric: outputs.servicefabricmesh.AutoScalingResourceMetricResponse;
    /**
...
export interface ContainerCodePackagePropertiesResponse {
     ...
     */
    diagnostics?: outputs.servicefabricmesh.DiagnosticsRefResponse;
    /**
     * The endpoints exposed by this container.
     */
    endpoints?: outputs.servicefabricmesh.EndpointPropertiesResponse[];
    /**
     ...
     */
    environmentVariables?: outputs.servicefabricmesh.EnvironmentVariableResponse[];
    /**
     ...
     */
    imageRegistryCredential?: outputs.servicefabricmesh.ImageRegistryCredentialResponse;
    /**
     * Runtime information of a container instance.
     */
    instanceView: outputs.servicefabricmesh.ContainerInstanceViewResponse;
    /**
     * The labels to set in this container.
     */
    labels?: outputs.servicefabricmesh.ContainerLabelResponse[];
    /**
     ...
     */
    reliableCollectionsRefs?: outputs.servicefabricmesh.ReliableCollectionsRefResponse[];
    /**
     * The resources required by this container.
     */
    resources: outputs.servicefabricmesh.ResourceRequirementsResponse;
    /**
     * The settings to set in this container. The setting file path can be fetched from environment variable "Fabric_SettingPath". The path for Windows container is "C:\\secrets". The path for Linux container is "/var/secrets".
     */
    settings?: outputs.servicefabricmesh.SettingResponse[];
    /**
     * Volumes to be attached to the container. The lifetime of these volumes is independent of the application's lifetime.
     */
    volumeRefs?: outputs.servicefabricmesh.VolumeReferenceResponse[];
    /**
     * Volumes to be attached to the container. The lifetime of these volumes is scoped to the application's lifetime.
     */
    volumes?: outputs.servicefabricmesh.ApplicationScopedVolumeResponse[];
}
...
export interface ContainerInstanceViewResponse {
     ...
     */
    currentState?: outputs.servicefabricmesh.ContainerStateResponse;
    /**
     * The events of this container instance.
     */
    events?: outputs.servicefabricmesh.ContainerEventResponse[];
    /**
     * Previous container instance state.
     */
    previousState?: outputs.servicefabricmesh.ContainerStateResponse;
    /**
...
export interface DiagnosticsDescriptionResponse {
     ...
     */
    sinks?: outputs.servicefabricmesh.AzureInternalMonitoringPipelineSinkDescriptionResponse[];
}
...
export interface HttpConfigResponse {
     ...
     */
    hosts: outputs.servicefabricmesh.HttpHostConfigResponse[];
    /**
...
export interface HttpHostConfigResponse {
     ...
     */
    routes: outputs.servicefabricmesh.HttpRouteConfigResponse[];
}
...
export interface HttpRouteConfigResponse {
     ...
     * Describes destination endpoint for routing traffic.
     */
    destination: outputs.servicefabricmesh.GatewayDestinationResponse;
    /**
     * Describes a rule for http route matching.
     */
    match: outputs.servicefabricmesh.HttpRouteMatchRuleResponse;
    /**
     * http route name.
     */
    name: string;
...
export interface HttpRouteMatchRuleResponse {
     ...
     */
    headers?: outputs.servicefabricmesh.HttpRouteMatchHeaderResponse[];
    /**
     * Path to match for routing.
     */
    path: outputs.servicefabricmesh.HttpRouteMatchPathResponse;
}
...
export interface NetworkRefResponse {
     ...
     */
    endpointRefs?: outputs.servicefabricmesh.EndpointRefResponse[];
    /**
     * Name of the network
     */
    name?: string;
...
export interface ResourceRequirementsResponse {
     ...
     */
    limits?: outputs.servicefabricmesh.ResourceLimitsResponse;
    /**
     * Describes the requested resources for a given container.
     */
    requests: outputs.servicefabricmesh.ResourceRequestsResponse;
}
...
export interface ServiceResourceDescriptionResponse {
     ...
     */
    autoScalingPolicies?: outputs.servicefabricmesh.AutoScalingPolicyResponse[];
    /**
     * Describes the set of code packages that forms the service. A code package describes the container and the properties for running it. All the code packages are started together on the same host and share the same context (network, process etc.).
     */
    codePackages: outputs.servicefabricmesh.ContainerCodePackagePropertiesResponse[];
    /**
     ...
     */
    networkRefs?: outputs.servicefabricmesh.NetworkRefResponse[];
    /**
