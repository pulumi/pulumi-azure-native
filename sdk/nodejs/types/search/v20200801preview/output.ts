...
export interface NetworkRuleSetResponse {
     ...
     */
    ipRules?: outputs.search.v20200801preview.IpRuleResponse[];
}
...
export interface PrivateEndpointConnectionPropertiesResponse {
     ...
     */
    privateEndpoint?: outputs.search.v20200801preview.PrivateEndpointConnectionPropertiesResponsePrivateEndpoint;
    /**
     * Describes the current state of an existing Private Link Service connection to the Azure Private Endpoint.
     */
    privateLinkServiceConnectionState?: outputs.search.v20200801preview.PrivateEndpointConnectionPropertiesResponsePrivateLinkServiceConnectionState;
}
/**
...
export function privateEndpointConnectionPropertiesResponseProvideDefaults(val: PrivateEndpointConnectionPropertiesResponse): PrivateEndpointConnectionPropertiesResponse {
    return {
        ...val,
        privateLinkServiceConnectionState: (val.privateLinkServiceConnectionState ? outputs.search.v20200801preview.privateEndpointConnectionPropertiesResponsePrivateLinkServiceConnectionStateProvideDefaults(val.privateLinkServiceConnectionState) : undefined),
    };
}
...
export interface PrivateEndpointConnectionResponse {
     ...
     * Describes the properties of an existing Private Endpoint connection to the Azure Cognitive Search service.
     */
    properties?: outputs.search.v20200801preview.PrivateEndpointConnectionPropertiesResponse;
    /**
...
export function privateEndpointConnectionResponseProvideDefaults(val: PrivateEndpointConnectionResponse): PrivateEndpointConnectionResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.search.v20200801preview.privateEndpointConnectionPropertiesResponseProvideDefaults(val.properties) : undefined),
    };
}
...
export interface SharedPrivateLinkResourceResponse {
     ...
     */
    properties?: outputs.search.v20200801preview.SharedPrivateLinkResourcePropertiesResponse;
    /**
     * The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
     */
    type: string;
