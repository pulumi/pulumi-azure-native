...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type: pulumi.Input<enums.search.v20200801preview.IdentityType>;
}
...
export interface NetworkRuleSetArgs {
     ...
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.search.v20200801preview.IpRuleArgs>[]>;
}
...
export interface PrivateEndpointConnectionPropertiesArgs {
     ...
     */
    privateEndpoint?: pulumi.Input<inputs.search.v20200801preview.PrivateEndpointConnectionPropertiesPrivateEndpointArgs>;
    /**
     * Describes the current state of an existing Private Link Service connection to the Azure Private Endpoint.
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.search.v20200801preview.PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgs>;
}
/**
...
export function privateEndpointConnectionPropertiesArgsProvideDefaults(val: PrivateEndpointConnectionPropertiesArgs): PrivateEndpointConnectionPropertiesArgs {
    return {
        ...val,
        privateLinkServiceConnectionState: (val.privateLinkServiceConnectionState ? pulumi.output(val.privateLinkServiceConnectionState).apply(inputs.search.v20200801preview.privateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgsProvideDefaults) : undefined),
    };
}
...
export interface PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<enums.search.v20200801preview.PrivateLinkServiceConnectionStatus>;
}
/**
...
export interface SharedPrivateLinkResourcePropertiesArgs {
     ...
     */
    provisioningState?: pulumi.Input<enums.search.v20200801preview.SharedPrivateLinkResourceProvisioningState>;
    /**
     ...
     */
    status?: pulumi.Input<enums.search.v20200801preview.SharedPrivateLinkResourceStatus>;
}
...
export interface SkuArgs {
     ...
     */
    name?: pulumi.Input<enums.search.v20200801preview.SkuName>;
}
