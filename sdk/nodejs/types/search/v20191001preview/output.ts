...
export interface NetworkRuleSetResponse {
     ...
     */
    ipRules?: outputs.search.v20191001preview.IpRuleResponse[];
}
/**
...
export interface PrivateEndpointConnectionPropertiesResponse {
     ...
     */
    privateEndpoint?: outputs.search.v20191001preview.PrivateEndpointConnectionPropertiesResponsePrivateEndpoint;
    /**
     * Describes the current state of an existing Private Link Service connection to the Azure Private Endpoint.
     */
    privateLinkServiceConnectionState?: outputs.search.v20191001preview.PrivateEndpointConnectionPropertiesResponsePrivateLinkServiceConnectionState;
}
/**
...
export function privateEndpointConnectionPropertiesResponseProvideDefaults(val: PrivateEndpointConnectionPropertiesResponse): PrivateEndpointConnectionPropertiesResponse {
    return {
        ...val,
        privateLinkServiceConnectionState: (val.privateLinkServiceConnectionState ? outputs.search.v20191001preview.privateEndpointConnectionPropertiesResponsePrivateLinkServiceConnectionStateProvideDefaults(val.privateLinkServiceConnectionState) : undefined),
    };
}
...
export interface PrivateEndpointConnectionResponse {
     ...
     * Describes the properties of an existing Private Endpoint connection to the Azure Cognitive Search service.
     */
    properties?: outputs.search.v20191001preview.PrivateEndpointConnectionPropertiesResponse;
    /**
     * The resource type.
     */
    type: string;
...
export function privateEndpointConnectionResponseProvideDefaults(val: PrivateEndpointConnectionResponse): PrivateEndpointConnectionResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.search.v20191001preview.privateEndpointConnectionPropertiesResponseProvideDefaults(val.properties) : undefined),
    };
}
