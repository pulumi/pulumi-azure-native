...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type: pulumi.Input<enums.search.IdentityType>;
}
...
export interface NetworkRuleSetArgs {
     ...
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.search.IpRuleArgs>[]>;
}
...
export interface PrivateEndpointConnectionPropertiesArgs {
     ...
     */
    privateEndpoint?: pulumi.Input<inputs.search.PrivateEndpointConnectionPropertiesPrivateEndpointArgs>;
    /**
     * Describes the current state of an existing Private Link Service connection to the Azure Private Endpoint.
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.search.PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgs>;
}
/**
...
export function privateEndpointConnectionPropertiesArgsProvideDefaults(val: PrivateEndpointConnectionPropertiesArgs): PrivateEndpointConnectionPropertiesArgs {
    return {
        ...val,
        privateLinkServiceConnectionState: (val.privateLinkServiceConnectionState ? pulumi.output(val.privateLinkServiceConnectionState).apply(inputs.search.privateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgsProvideDefaults) : undefined),
    };
}
...
export interface PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<enums.search.PrivateLinkServiceConnectionStatus>;
}
/**
...
export interface SharedPrivateLinkResourcePropertiesArgs {
     ...
     */
    provisioningState?: pulumi.Input<enums.search.SharedPrivateLinkResourceProvisioningState>;
    /**
     ...
     */
    status?: pulumi.Input<enums.search.SharedPrivateLinkResourceStatus>;
}
...
export interface SkuArgs {
     ...
     */
    name?: pulumi.Input<enums.search.SkuName>;
}
