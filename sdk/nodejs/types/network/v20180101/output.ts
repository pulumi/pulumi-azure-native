...
export interface ApplicationGatewayBackendAddressPoolResponse {
     ...
     * Backend addresses
     */
    backendAddresses?: outputs.network.v20180101.ApplicationGatewayBackendAddressResponse[];
    /**
     * Collection of references to IPs defined in network interfaces.
     */
    backendIPConfigurations?: outputs.network.v20180101.NetworkInterfaceIPConfigurationResponse[];
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
...
export interface ApplicationGatewayBackendHttpSettingsResponse {
     ...
     */
    authenticationCertificates?: outputs.network.v20180101.SubResourceResponse[];
    /**
     * Connection draining of the backend http settings resource.
     */
    connectionDraining?: outputs.network.v20180101.ApplicationGatewayConnectionDrainingResponse;
    /**
     ...
     */
    probe?: outputs.network.v20180101.SubResourceResponse;
    /**
...
export interface ApplicationGatewayFrontendIPConfigurationResponse {
     ...
     */
    publicIPAddress?: outputs.network.v20180101.SubResourceResponse;
    /**
     * Reference of the subnet resource.
     */
    subnet?: outputs.network.v20180101.SubResourceResponse;
    /**
     * Type of the resource.
     */
    type?: string;
...
export interface ApplicationGatewayHttpListenerResponse {
     ...
     */
    frontendIPConfiguration?: outputs.network.v20180101.SubResourceResponse;
    /**
     * Frontend port resource of an application gateway.
     */
    frontendPort?: outputs.network.v20180101.SubResourceResponse;
    /**
     ...
     */
    sslCertificate?: outputs.network.v20180101.SubResourceResponse;
    /**
     * Type of the resource.
     */
    type?: string;
...
export interface ApplicationGatewayPathRuleResponse {
     ...
     */
    backendAddressPool?: outputs.network.v20180101.SubResourceResponse;
    /**
     * Backend http settings resource of URL path map path rule.
     */
    backendHttpSettings?: outputs.network.v20180101.SubResourceResponse;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
     ...
     */
    redirectConfiguration?: outputs.network.v20180101.SubResourceResponse;
    /**
     * Type of the resource.
     */
    type?: string;
...
export interface ApplicationGatewayProbeResponse {
     ...
     */
    match?: outputs.network.v20180101.ApplicationGatewayProbeHealthResponseMatchResponse;
    /**
...
export interface ApplicationGatewayRedirectConfigurationResponse {
     ...
     */
    pathRules?: outputs.network.v20180101.SubResourceResponse[];
    /**
     ...
     */
    requestRoutingRules?: outputs.network.v20180101.SubResourceResponse[];
    /**
     * Reference to a listener to redirect the request to.
     */
    targetListener?: outputs.network.v20180101.SubResourceResponse;
    /**
     ...
     */
    urlPathMaps?: outputs.network.v20180101.SubResourceResponse[];
}
...
export interface ApplicationGatewayRequestRoutingRuleResponse {
     ...
     */
    httpListener?: outputs.network.v20180101.SubResourceResponse;
    /**
     * Resource ID.
     */
    id?: string;
     ...
     */
    urlPathMap?: outputs.network.v20180101.SubResourceResponse;
}
...
export interface ApplicationGatewayUrlPathMapResponse {
     ...
     */
    defaultBackendAddressPool?: outputs.network.v20180101.SubResourceResponse;
    /**
     * Default backend http settings resource of URL path map.
     */
    defaultBackendHttpSettings?: outputs.network.v20180101.SubResourceResponse;
    /**
     * Default redirect configuration resource of URL path map.
     */
    defaultRedirectConfiguration?: outputs.network.v20180101.SubResourceResponse;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
     ...
     */
    pathRules?: outputs.network.v20180101.ApplicationGatewayPathRuleResponse[];
    /**
     * Provisioning state of the backend http settings resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
    provisioningState?: string;
...
export interface ApplicationGatewayWebApplicationFirewallConfigurationResponse {
     ...
     */
    disabledRuleGroups?: outputs.network.v20180101.ApplicationGatewayFirewallDisabledRuleGroupResponse[];
    /**
...
export interface BackendAddressPoolResponse {
     ...
     */
    loadBalancingRules: outputs.network.v20180101.SubResourceResponse[];
    /**
     ...
     */
    outboundNatRule: outputs.network.v20180101.SubResourceResponse;
    /**
...
export interface ExpressRouteCircuitPeeringResponse {
     ...
     */
    ipv6PeeringConfig?: outputs.network.v20180101.Ipv6ExpressRouteCircuitPeeringConfigResponse;
    /**
     ...
     */
    microsoftPeeringConfig?: outputs.network.v20180101.ExpressRouteCircuitPeeringConfigResponse;
    /**
     * Gets name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
    name?: string;
     ...
     */
    routeFilter?: outputs.network.v20180101.RouteFilterResponse;
    /**
     * The secondary port.
     */
     ...
     * Gets peering stats.
     */
    stats?: outputs.network.v20180101.ExpressRouteCircuitStatsResponse;
    /**
     * The VLAN ID.
     */
    vlanId?: number;
...
export interface FrontendIPConfigurationResponse {
     ...
     */
    inboundNatPools: outputs.network.v20180101.SubResourceResponse[];
    /**
     * Read only. Inbound rules URIs that use this frontend IP.
     */
    inboundNatRules: outputs.network.v20180101.SubResourceResponse[];
    /**
     ...
     */
    outboundNatRules: outputs.network.v20180101.SubResourceResponse[];
    /**
     ...
     */
    publicIPAddress?: outputs.network.v20180101.PublicIPAddressResponse;
    /**
     * The reference of the subnet resource.
     */
    subnet?: outputs.network.v20180101.SubnetResponse;
    /**
...
export interface InboundNatRuleResponse {
     ...
     */
    backendIPConfiguration: outputs.network.v20180101.NetworkInterfaceIPConfigurationResponse;
    /**
...
export interface LocalNetworkGatewayResponse {
     ...
     */
    bgpSettings?: outputs.network.v20180101.BgpSettingsResponse;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
     ...
     */
    localNetworkAddressSpace?: outputs.network.v20180101.AddressSpaceResponse;
    /**
     * Resource location.
     */
    location?: string;
...
export interface NetworkInterfaceIPConfigurationResponse {
     ...
     */
    applicationGatewayBackendAddressPools?: outputs.network.v20180101.ApplicationGatewayBackendAddressPoolResponse[];
    /**
     * Application security groups in which the IP configuration is included.
     */
    applicationSecurityGroups?: outputs.network.v20180101.ApplicationSecurityGroupResponse[];
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
     ...
     */
    loadBalancerBackendAddressPools?: outputs.network.v20180101.BackendAddressPoolResponse[];
    /**
     * A list of references of LoadBalancerInboundNatRules.
     */
    loadBalancerInboundNatRules?: outputs.network.v20180101.InboundNatRuleResponse[];
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
    name?: string;
...
export interface NetworkInterfaceResponse {
     ...
     */
    dnsSettings?: outputs.network.v20180101.NetworkInterfaceDnsSettingsResponse;
    /**
     ...
     */
    ipConfigurations?: outputs.network.v20180101.NetworkInterfaceIPConfigurationResponse[];
    /**
     * Resource location.
     */
    location?: string;
     ...
     */
    networkSecurityGroup?: outputs.network.v20180101.NetworkSecurityGroupResponse;
    /**
     ...
     */
    virtualMachine?: outputs.network.v20180101.SubResourceResponse;
}
...
export interface NetworkSecurityGroupResponse {
     ...
     */
    defaultSecurityRules?: outputs.network.v20180101.SecurityRuleResponse[];
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
     ...
     */
    networkInterfaces: outputs.network.v20180101.NetworkInterfaceResponse[];
    /**
     * The provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
    provisioningState?: string;
     ...
     */
    securityRules?: outputs.network.v20180101.SecurityRuleResponse[];
    /**
     * A collection of references to subnets.
     */
    subnets: outputs.network.v20180101.SubnetResponse[];
    /**
     * Resource tags.
     */
    tags?: {[key: string]: string};
...
export interface OutboundNatRuleResponse {
     ...
     */
    frontendIPConfigurations?: outputs.network.v20180101.SubResourceResponse[];
    /**
     * Resource ID.
     */
    id?: string;
...
export interface PublicIPAddressResponse {
     ...
     */
    dnsSettings?: outputs.network.v20180101.PublicIPAddressDnsSettingsResponse;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
     ...
     */
    ipConfiguration: outputs.network.v20180101.IPConfigurationResponse;
    /**
     * The list of tags associated with the public IP address.
     */
    ipTags?: outputs.network.v20180101.IpTagResponse[];
    /**
     * Resource location.
     */
    location?: string;
     ...
     */
    sku?: outputs.network.v20180101.PublicIPAddressSkuResponse;
    /**
     * Resource tags.
     */
    tags?: {[key: string]: string};
...
export interface RouteFilterResponse {
     ...
     */
    peerings?: outputs.network.v20180101.ExpressRouteCircuitPeeringResponse[];
    /**
     ...
     */
    rules?: outputs.network.v20180101.RouteFilterRuleResponse[];
    /**
     * Resource tags.
     */
    tags?: {[key: string]: string};
...
export interface RouteTableResponse {
     ...
     */
    routes?: outputs.network.v20180101.RouteResponse[];
    /**
     * A collection of references to subnets.
     */
    subnets: outputs.network.v20180101.SubnetResponse[];
...
export interface SecurityRuleResponse {
     ...
     */
    destinationApplicationSecurityGroups?: outputs.network.v20180101.ApplicationSecurityGroupResponse[];
    /**
     ...
     */
    sourceApplicationSecurityGroups?: outputs.network.v20180101.ApplicationSecurityGroupResponse[];
    /**
...
export interface SubnetResponse {
     ...
     */
    ipConfigurations: outputs.network.v20180101.IPConfigurationResponse[];
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
    name?: string;
     ...
     */
    resourceNavigationLinks?: outputs.network.v20180101.ResourceNavigationLinkResponse[];
    /**
     * The reference of the RouteTable resource.
     */
    routeTable?: outputs.network.v20180101.RouteTableResponse;
    /**
     * An array of service endpoints.
     */
    serviceEndpoints?: outputs.network.v20180101.ServiceEndpointPropertiesFormatResponse[];
}
...
export interface VirtualNetworkGatewayResponse {
     ...
     */
    gatewayDefaultSite?: outputs.network.v20180101.SubResourceResponse;
    /**
     ...
     */
    ipConfigurations?: outputs.network.v20180101.VirtualNetworkGatewayIPConfigurationResponse[];
    /**
     * Resource location.
     */
    location?: string;
     ...
     */
    sku?: outputs.network.v20180101.VirtualNetworkGatewaySkuResponse;
    /**
     * Resource tags.
     */
    tags?: {[key: string]: string};
     ...
     */
    vpnClientConfiguration?: outputs.network.v20180101.VpnClientConfigurationResponse;
    /**
...
export interface VirtualNetworkPeeringResponse {
     ...
     */
    remoteAddressSpace?: outputs.network.v20180101.AddressSpaceResponse;
    /**
     ...
     */
    remoteVirtualNetwork?: outputs.network.v20180101.SubResourceResponse;
    /**
...
export interface VpnClientConfigurationResponse {
     ...
     */
    vpnClientAddressPool?: outputs.network.v20180101.AddressSpaceResponse;
    /**
     ...
     */
    vpnClientRevokedCertificates?: outputs.network.v20180101.VpnClientRevokedCertificateResponse[];
    /**
     * VpnClientRootCertificate for virtual network gateway.
     */
    vpnClientRootCertificates?: outputs.network.v20180101.VpnClientRootCertificateResponse[];
}
