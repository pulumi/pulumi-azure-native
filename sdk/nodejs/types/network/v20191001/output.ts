...
export interface CustomRuleListResponse {
     ...
     * List of rules
     */
    rules?: outputs.network.v20191001.CustomRuleResponse[];
}
...
export interface CustomRuleResponse {
     ...
     */
    matchConditions: outputs.network.v20191001.FrontDoorMatchConditionResponse[];
    /**
...
export interface FrontDoorManagedRuleGroupOverrideResponse {
     ...
     */
    exclusions?: outputs.network.v20191001.ManagedRuleExclusionResponse[];
    /**
     ...
     */
    rules?: outputs.network.v20191001.FrontDoorManagedRuleOverrideResponse[];
}
...
export interface FrontDoorManagedRuleSetResponse {
     ...
     */
    ruleGroupOverrides?: outputs.network.v20191001.FrontDoorManagedRuleGroupOverrideResponse[];
    /**
...
export interface ManagedRuleSetListResponse {
     ...
     * List of rule sets.
     */
    managedRuleSets?: outputs.network.v20191001.FrontDoorManagedRuleSetResponse[];
}
