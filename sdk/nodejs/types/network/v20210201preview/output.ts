...
export interface ActiveConnectivityConfigurationResponse {
     ...
     */
    appliesToGroups?: outputs.network.v20210201preview.ConnectivityGroupItemResponse[];
    /**
     ...
     */
    configurationGroups?: outputs.network.v20210201preview.ConfigurationGroupResponse[];
    /**
     ...
     * List of hubItems
     */
    hubs?: outputs.network.v20210201preview.HubResponse[];
    /**
     * Resource ID.
     */
    id?: string;
...
export interface ActiveDefaultSecurityAdminRuleResponse {
     ...
     */
    destinations: outputs.network.v20210201preview.AddressPrefixItemResponse[];
    /**
     ...
     */
    ruleCollectionAppliesToGroups?: outputs.network.v20210201preview.NetworkManagerSecurityGroupItemResponse[];
    /**
     ...
     * Effective configuration groups.
     */
    ruleGroups?: outputs.network.v20210201preview.ConfigurationGroupResponse[];
    /**
     ...
     */
    sources: outputs.network.v20210201preview.AddressPrefixItemResponse[];
}
...
export interface ConfigurationGroupResponse {
     ...
     */
    groupMembers?: outputs.network.v20210201preview.GroupMembersItemResponse[];
    /**
     * Resource ID.
     */
    id?: string;
