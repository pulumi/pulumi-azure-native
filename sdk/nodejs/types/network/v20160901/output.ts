...
export interface ApplicationGatewayBackendAddressPoolResponse {
     ...
     * Backend addresses
     */
    backendAddresses?: outputs.network.v20160901.ApplicationGatewayBackendAddressResponse[];
    /**
     * Collection of references to IPs defined in network interfaces.
     */
    backendIPConfigurations?: outputs.network.v20160901.NetworkInterfaceIPConfigurationResponse[];
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
...
export interface ApplicationGatewayBackendHttpSettingsResponse {
     ...
     */
    authenticationCertificates?: outputs.network.v20160901.SubResourceResponse[];
    /**
     ...
     */
    probe?: outputs.network.v20160901.SubResourceResponse;
    /**
...
export interface ApplicationGatewayFrontendIPConfigurationResponse {
     ...
     */
    publicIPAddress?: outputs.network.v20160901.SubResourceResponse;
    /**
     * Reference of the subnet resource.
     */
    subnet?: outputs.network.v20160901.SubResourceResponse;
}
...
export interface ApplicationGatewayHttpListenerResponse {
     ...
     */
    frontendIPConfiguration?: outputs.network.v20160901.SubResourceResponse;
    /**
     * Frontend port resource of an application gateway.
     */
    frontendPort?: outputs.network.v20160901.SubResourceResponse;
    /**
     ...
     */
    sslCertificate?: outputs.network.v20160901.SubResourceResponse;
}
...
export interface ApplicationGatewayPathRuleResponse {
     ...
     */
    backendAddressPool?: outputs.network.v20160901.SubResourceResponse;
    /**
     * Backend http settings resource of URL path map.
     */
    backendHttpSettings?: outputs.network.v20160901.SubResourceResponse;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
...
export interface ApplicationGatewayRequestRoutingRuleResponse {
     ...
     */
    httpListener?: outputs.network.v20160901.SubResourceResponse;
    /**
     * Resource ID.
     */
    id?: string;
     ...
     */
    urlPathMap?: outputs.network.v20160901.SubResourceResponse;
}
...
export interface ApplicationGatewayUrlPathMapResponse {
     ...
     */
    defaultBackendAddressPool?: outputs.network.v20160901.SubResourceResponse;
    /**
     * Default backend http settings resource of URL path map.
     */
    defaultBackendHttpSettings?: outputs.network.v20160901.SubResourceResponse;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
     ...
     */
    pathRules?: outputs.network.v20160901.ApplicationGatewayPathRuleResponse[];
    /**
     * Provisioning state of the backend http settings resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
    provisioningState?: string;
...
export interface BackendAddressPoolResponse {
     ...
     */
    loadBalancingRules: outputs.network.v20160901.SubResourceResponse[];
    /**
     ...
     */
    outboundNatRule: outputs.network.v20160901.SubResourceResponse;
    /**
...
export interface ExpressRouteCircuitPeeringResponse {
     ...
     */
    microsoftPeeringConfig?: outputs.network.v20160901.ExpressRouteCircuitPeeringConfigResponse;
    /**
     * Gets name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
    name?: string;
     ...
     * Gets peering stats.
     */
    stats?: outputs.network.v20160901.ExpressRouteCircuitStatsResponse;
    /**
     * The VLAN ID.
     */
    vlanId?: number;
...
export interface FrontendIPConfigurationResponse {
     ...
     */
    inboundNatPools: outputs.network.v20160901.SubResourceResponse[];
    /**
     * Read only. Inbound rules URIs that use this frontend IP.
     */
    inboundNatRules: outputs.network.v20160901.SubResourceResponse[];
    /**
     ...
     */
    outboundNatRules: outputs.network.v20160901.SubResourceResponse[];
    /**
     ...
     */
    publicIPAddress?: outputs.network.v20160901.PublicIPAddressResponse;
    /**
     * The reference of the subnet resource.
     */
    subnet?: outputs.network.v20160901.SubnetResponse;
}
...
export interface InboundNatRuleResponse {
     ...
     */
    backendIPConfiguration: outputs.network.v20160901.NetworkInterfaceIPConfigurationResponse;
    /**
...
export interface LocalNetworkGatewayResponse {
     ...
     */
    bgpSettings?: outputs.network.v20160901.BgpSettingsResponse;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
     ...
     */
    localNetworkAddressSpace: outputs.network.v20160901.AddressSpaceResponse;
    /**
     * Resource location.
     */
    location?: string;
...
export interface NetworkInterfaceIPConfigurationResponse {
     ...
     */
    applicationGatewayBackendAddressPools?: outputs.network.v20160901.ApplicationGatewayBackendAddressPoolResponse[];
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
     ...
     */
    loadBalancerBackendAddressPools?: outputs.network.v20160901.BackendAddressPoolResponse[];
    /**
     * A list of references of LoadBalancerInboundNatRules.
     */
    loadBalancerInboundNatRules?: outputs.network.v20160901.InboundNatRuleResponse[];
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
    name?: string;
...
export interface NetworkInterfaceResponse {
     ...
     */
    dnsSettings?: outputs.network.v20160901.NetworkInterfaceDnsSettingsResponse;
    /**
     ...
     */
    ipConfigurations?: outputs.network.v20160901.NetworkInterfaceIPConfigurationResponse[];
    /**
     * Resource location.
     */
    location?: string;
     ...
     */
    networkSecurityGroup?: outputs.network.v20160901.NetworkSecurityGroupResponse;
    /**
     ...
     */
    virtualMachine?: outputs.network.v20160901.SubResourceResponse;
}
...
export interface NetworkSecurityGroupResponse {
     ...
     */
    defaultSecurityRules?: outputs.network.v20160901.SecurityRuleResponse[];
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
     ...
     */
    networkInterfaces: outputs.network.v20160901.NetworkInterfaceResponse[];
    /**
     * The provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
    provisioningState?: string;
     ...
     */
    securityRules?: outputs.network.v20160901.SecurityRuleResponse[];
    /**
     * A collection of references to subnets.
     */
    subnets: outputs.network.v20160901.SubnetResponse[];
    /**
     * Resource tags.
     */
    tags?: {[key: string]: string};
...
export interface OutboundNatRuleResponse {
     ...
     */
    frontendIPConfigurations?: outputs.network.v20160901.SubResourceResponse[];
    /**
     * Resource ID.
     */
    id?: string;
...
export interface PublicIPAddressResponse {
     ...
     */
    dnsSettings?: outputs.network.v20160901.PublicIPAddressDnsSettingsResponse;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
    etag?: string;
     ...
     * IPConfiguration
     */
    ipConfiguration: outputs.network.v20160901.IPConfigurationResponse;
    /**
     * Resource location.
     */
    location?: string;
...
export interface RouteTableResponse {
     ...
     */
    routes?: outputs.network.v20160901.RouteResponse[];
    /**
     * A collection of references to subnets.
     */
    subnets: outputs.network.v20160901.SubnetResponse[];
...
export interface SubnetResponse {
     ...
     */
    ipConfigurations: outputs.network.v20160901.IPConfigurationResponse[];
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
    name?: string;
     ...
     */
    resourceNavigationLinks?: outputs.network.v20160901.ResourceNavigationLinkResponse[];
    /**
     * The reference of the RouteTable resource.
     */
    routeTable?: outputs.network.v20160901.RouteTableResponse;
}
...
export interface VirtualNetworkGatewayResponse {
     ...
     */
    gatewayDefaultSite?: outputs.network.v20160901.SubResourceResponse;
    /**
     ...
     */
    ipConfigurations: outputs.network.v20160901.VirtualNetworkGatewayIPConfigurationResponse[];
    /**
     * Resource location.
     */
    location?: string;
     ...
     */
    sku?: outputs.network.v20160901.VirtualNetworkGatewaySkuResponse;
    /**
     * Resource tags.
     */
    tags?: {[key: string]: string};
     ...
     */
    vpnClientConfiguration?: outputs.network.v20160901.VpnClientConfigurationResponse;
    /**
...
export interface VirtualNetworkPeeringResponse {
     ...
     */
    remoteVirtualNetwork?: outputs.network.v20160901.SubResourceResponse;
    /**
...
export interface VpnClientConfigurationResponse {
     ...
     */
    vpnClientAddressPool?: outputs.network.v20160901.AddressSpaceResponse;
    /**
     * VpnClientRevokedCertificate for Virtual network gateway.
     */
    vpnClientRevokedCertificates?: outputs.network.v20160901.VpnClientRevokedCertificateResponse[];
    /**
     * VpnClientRootCertificate for virtual network gateway.
     */
    vpnClientRootCertificates?: outputs.network.v20160901.VpnClientRootCertificateResponse[];
}
