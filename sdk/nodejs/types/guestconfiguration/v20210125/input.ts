...
export interface ConfigurationSettingArgs {
     ...
     */
    actionAfterReboot?: pulumi.Input<string | enums.guestconfiguration.v20210125.ActionAfterReboot>;
    /**
     ...
     */
    configurationMode?: pulumi.Input<string | enums.guestconfiguration.v20210125.ConfigurationMode>;
    /**
...
export interface GuestConfigurationAssignmentPropertiesArgs {
     ...
     */
    guestConfiguration?: pulumi.Input<inputs.guestconfiguration.v20210125.GuestConfigurationNavigationArgs>;
}
/**
...
export function guestConfigurationAssignmentPropertiesArgsProvideDefaults(val: GuestConfigurationAssignmentPropertiesArgs): GuestConfigurationAssignmentPropertiesArgs {
    return {
        ...val,
        guestConfiguration: (val.guestConfiguration ? pulumi.output(val.guestConfiguration).apply(inputs.guestconfiguration.v20210125.guestConfigurationNavigationArgsProvideDefaults) : undefined),
    };
}
...
export interface GuestConfigurationNavigationArgs {
     ...
     */
    assignmentType?: pulumi.Input<string | enums.guestconfiguration.v20210125.AssignmentType>;
    /**
     * The configuration parameters for the guest configuration.
     */
    configurationParameter?: pulumi.Input<pulumi.Input<inputs.guestconfiguration.v20210125.ConfigurationParameterArgs>[]>;
    /**
     * The protected configuration parameters for the guest configuration.
     */
    configurationProtectedParameter?: pulumi.Input<pulumi.Input<inputs.guestconfiguration.v20210125.ConfigurationParameterArgs>[]>;
    /**
     * The configuration setting for the guest configuration.
     */
    configurationSetting?: pulumi.Input<inputs.guestconfiguration.v20210125.ConfigurationSettingArgs>;
    /**
     ...
     */
    kind?: pulumi.Input<string | enums.guestconfiguration.v20210125.Kind>;
    /**
...
export function guestConfigurationNavigationArgsProvideDefaults(val: GuestConfigurationNavigationArgs): GuestConfigurationNavigationArgs {
    return {
        ...val,
        configurationSetting: (val.configurationSetting ? pulumi.output(val.configurationSetting).apply(inputs.guestconfiguration.v20210125.configurationSettingArgsProvideDefaults) : undefined),
    };
}
