...
export interface GuestConfigurationAssignmentPropertiesResponse {
     ...
     */
    guestConfiguration?: outputs.guestconfiguration.v20181120.GuestConfigurationNavigationResponse;
    /**
     ...
     */
    vmssVMList?: outputs.guestconfiguration.v20181120.VMSSVMInfoResponse[];
}
/**
...
export function guestConfigurationAssignmentPropertiesResponseProvideDefaults(val: GuestConfigurationAssignmentPropertiesResponse): GuestConfigurationAssignmentPropertiesResponse {
    return {
        ...val,
        guestConfiguration: (val.guestConfiguration ? outputs.guestconfiguration.v20181120.guestConfigurationNavigationResponseProvideDefaults(val.guestConfiguration) : undefined),
    };
}
...
export interface GuestConfigurationNavigationResponse {
     ...
     */
    configurationParameter?: outputs.guestconfiguration.v20181120.ConfigurationParameterResponse[];
    /**
     * The protected configuration parameters for the guest configuration.
     */
    configurationProtectedParameter?: outputs.guestconfiguration.v20181120.ConfigurationParameterResponse[];
    /**
     * The configuration setting for the guest configuration.
     */
    configurationSetting?: outputs.guestconfiguration.v20181120.ConfigurationSettingResponse;
    /**
...
export function guestConfigurationNavigationResponseProvideDefaults(val: GuestConfigurationNavigationResponse): GuestConfigurationNavigationResponse {
    return {
        ...val,
        configurationSetting: (val.configurationSetting ? outputs.guestconfiguration.v20181120.configurationSettingResponseProvideDefaults(val.configurationSetting) : undefined),
    };
}
