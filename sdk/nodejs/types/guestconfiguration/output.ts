...
export * as v20180630preview from "./v20180630preview/output";
export * as v20181120 from "./v20181120/output";
export * as v20200625 from "./v20200625/output";
export * as v20210125 from "./v20210125/output";
export * as v20220125 from "./v20220125/output";
/**
...
export interface AssignmentInfoResponse {
     ...
     */
    configuration?: outputs.guestconfiguration.ConfigurationInfoResponse;
    /**
...
export interface AssignmentReportResourceResponse {
     ...
     */
    reasons?: outputs.guestconfiguration.AssignmentReportResourceComplianceReasonResponse[];
    /**
...
export interface AssignmentReportResponse {
     ...
     */
    assignment?: outputs.guestconfiguration.AssignmentInfoResponse;
    /**
     * A value indicating compliance status of the machine for the assigned guest configuration.
     */
    complianceStatus: string;
     ...
     */
    resources?: outputs.guestconfiguration.AssignmentReportResourceResponse[];
    /**
     ...
     */
    vm?: outputs.guestconfiguration.VMInfoResponse;
}
...
export interface GuestConfigurationAssignmentPropertiesResponse {
     ...
     */
    guestConfiguration?: outputs.guestconfiguration.GuestConfigurationNavigationResponse;
    /**
     ...
     */
    latestAssignmentReport?: outputs.guestconfiguration.AssignmentReportResponse;
    /**
     ...
     */
    vmssVMList?: outputs.guestconfiguration.VMSSVMInfoResponse[];
}
/**
...
export function guestConfigurationAssignmentPropertiesResponseProvideDefaults(val: GuestConfigurationAssignmentPropertiesResponse): GuestConfigurationAssignmentPropertiesResponse {
    return {
        ...val,
        guestConfiguration: (val.guestConfiguration ? outputs.guestconfiguration.guestConfigurationNavigationResponseProvideDefaults(val.guestConfiguration) : undefined),
    };
}
...
export interface GuestConfigurationNavigationResponse {
     ...
     */
    configurationParameter?: outputs.guestconfiguration.ConfigurationParameterResponse[];
    /**
     * The protected configuration parameters for the guest configuration.
     */
    configurationProtectedParameter?: outputs.guestconfiguration.ConfigurationParameterResponse[];
    /**
     * The configuration setting for the guest configuration.
     */
    configurationSetting?: outputs.guestconfiguration.ConfigurationSettingResponse;
    /**
...
export function guestConfigurationNavigationResponseProvideDefaults(val: GuestConfigurationNavigationResponse): GuestConfigurationNavigationResponse {
    return {
        ...val,
        configurationSetting: (val.configurationSetting ? outputs.guestconfiguration.configurationSettingResponseProvideDefaults(val.configurationSetting) : undefined),
    };
}
