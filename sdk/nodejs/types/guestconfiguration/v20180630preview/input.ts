...
export interface ConfigurationSettingArgs {
     ...
     */
    actionAfterReboot?: pulumi.Input<string | enums.guestconfiguration.v20180630preview.ActionAfterReboot>;
    /**
     ...
     */
    configurationMode?: pulumi.Input<string | enums.guestconfiguration.v20180630preview.ConfigurationMode>;
    /**
...
export interface GuestConfigurationAssignmentPropertiesArgs {
     ...
     */
    guestConfiguration?: pulumi.Input<inputs.guestconfiguration.v20180630preview.GuestConfigurationNavigationArgs>;
}
/**
...
export function guestConfigurationAssignmentPropertiesArgsProvideDefaults(val: GuestConfigurationAssignmentPropertiesArgs): GuestConfigurationAssignmentPropertiesArgs {
    return {
        ...val,
        guestConfiguration: (val.guestConfiguration ? pulumi.output(val.guestConfiguration).apply(inputs.guestconfiguration.v20180630preview.guestConfigurationNavigationArgsProvideDefaults) : undefined),
    };
}
...
export interface GuestConfigurationNavigationArgs {
     ...
     */
    configurationSetting?: pulumi.Input<inputs.guestconfiguration.v20180630preview.ConfigurationSettingArgs>;
    /**
     * Kind of the guest configuration. For example:DSC
     */
    kind?: pulumi.Input<string | enums.guestconfiguration.v20180630preview.Kind>;
    /**
...
export function guestConfigurationNavigationArgsProvideDefaults(val: GuestConfigurationNavigationArgs): GuestConfigurationNavigationArgs {
    return {
        ...val,
        configurationSetting: (val.configurationSetting ? pulumi.output(val.configurationSetting).apply(inputs.guestconfiguration.v20180630preview.configurationSettingArgsProvideDefaults) : undefined),
    };
}
