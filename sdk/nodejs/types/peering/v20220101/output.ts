...
export interface DirectConnectionResponse {
     ...
     */
    bgpSession?: outputs.peering.v20220101.BgpSessionResponse;
    /**
...
export interface PeeringPropertiesDirectResponse {
     ...
     */
    connections?: outputs.peering.v20220101.DirectConnectionResponse[];
    /**
     ...
     */
    peerAsn?: outputs.peering.v20220101.SubResourceResponse;
    /**
...
export interface PeeringPropertiesExchangeResponse {
     ...
     */
    connections?: outputs.peering.v20220101.ExchangeConnectionResponse[];
    /**
     * The reference of the peer ASN.
     */
    peerAsn?: outputs.peering.v20220101.SubResourceResponse;
