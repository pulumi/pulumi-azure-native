...
export interface ContactDetailArgs {
     ...
     */
    role?: pulumi.Input<string | enums.peering.v20210101.Role>;
}
...
export interface DirectConnectionArgs {
     ...
     */
    bgpSession?: pulumi.Input<inputs.peering.v20210101.BgpSessionArgs>;
    /**
     ...
     */
    sessionAddressProvider?: pulumi.Input<string | enums.peering.v20210101.SessionAddressProvider>;
    /**
...
export interface PeeringPropertiesDirectArgs {
     ...
     */
    connections?: pulumi.Input<pulumi.Input<inputs.peering.v20210101.DirectConnectionArgs>[]>;
    /**
     * The type of direct peering.
     */
    directPeeringType?: pulumi.Input<string | enums.peering.v20210101.DirectPeeringType>;
    /**
     * The reference of the peer ASN.
     */
    peerAsn?: pulumi.Input<inputs.peering.v20210101.SubResourceArgs>;
}
...
export interface PeeringPropertiesExchangeArgs {
     ...
     */
    connections?: pulumi.Input<pulumi.Input<inputs.peering.v20210101.ExchangeConnectionArgs>[]>;
    /**
     * The reference of the peer ASN.
     */
    peerAsn?: pulumi.Input<inputs.peering.v20210101.SubResourceArgs>;
...
export interface PeeringSkuArgs {
     ...
     */
    family?: pulumi.Input<string | enums.peering.v20210101.Family>;
    /**
     ...
     */
    size?: pulumi.Input<string | enums.peering.v20210101.Size>;
    /**
     * The tier of the peering SKU.
     */
    tier?: pulumi.Input<string | enums.peering.v20210101.Tier>;
}
