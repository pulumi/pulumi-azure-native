...
export interface ContactDetailArgs {
     ...
     */
    role?: pulumi.Input<string | enums.peering.v20210601.Role>;
}
...
export interface DirectConnectionArgs {
     ...
     */
    bgpSession?: pulumi.Input<inputs.peering.v20210601.BgpSessionArgs>;
    /**
     ...
     */
    sessionAddressProvider?: pulumi.Input<string | enums.peering.v20210601.SessionAddressProvider>;
    /**
...
export interface PeeringPropertiesDirectArgs {
     ...
     */
    connections?: pulumi.Input<pulumi.Input<inputs.peering.v20210601.DirectConnectionArgs>[]>;
    /**
     * The type of direct peering.
     */
    directPeeringType?: pulumi.Input<string | enums.peering.v20210601.DirectPeeringType>;
    /**
     * The reference of the peer ASN.
     */
    peerAsn?: pulumi.Input<inputs.peering.v20210601.SubResourceArgs>;
}
...
export interface PeeringPropertiesExchangeArgs {
     ...
     */
    connections?: pulumi.Input<pulumi.Input<inputs.peering.v20210601.ExchangeConnectionArgs>[]>;
    /**
     * The reference of the peer ASN.
     */
    peerAsn?: pulumi.Input<inputs.peering.v20210601.SubResourceArgs>;
