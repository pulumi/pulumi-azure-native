...
export interface InputPatchConfigurationArgs {
     ...
     */
    linuxParameters?: pulumi.Input<inputs.maintenance.v20210901preview.InputLinuxParametersArgs>;
    /**
     * [Not supported] List of post tasks. e.g. [{'source' :'runbook', 'taskScope': 'Resource', 'parameters': { 'arg1': 'value1'}}]
     */
    postTasks?: pulumi.Input<pulumi.Input<inputs.maintenance.v20210901preview.TaskPropertiesArgs>[]>;
    /**
     * [Not supported] List of pre tasks. e.g. [{'source' :'runbook', 'taskScope': 'Global', 'parameters': { 'arg1': 'value1'}}]
     */
    preTasks?: pulumi.Input<pulumi.Input<inputs.maintenance.v20210901preview.TaskPropertiesArgs>[]>;
    /**
     ...
     */
    rebootSetting?: pulumi.Input<string | enums.maintenance.v20210901preview.RebootOptions>;
    /**
     ...
     */
    windowsParameters?: pulumi.Input<inputs.maintenance.v20210901preview.InputWindowsParametersArgs>;
}
/**
...
export interface TaskPropertiesArgs {
     ...
     */
    taskScope?: pulumi.Input<string | enums.maintenance.v20210901preview.TaskScope>;
}
/**
