...
export interface InputPatchConfigurationResponse {
     ...
     */
    linuxParameters?: outputs.maintenance.v20220701preview.InputLinuxParametersResponse;
    /**
     * [Not supported] List of post tasks. e.g. [{'source' :'runbook', 'taskScope': 'Resource', 'parameters': { 'arg1': 'value1'}}]
     */
    postTasks?: outputs.maintenance.v20220701preview.TaskPropertiesResponse[];
    /**
     * [Not supported] List of pre tasks. e.g. [{'source' :'runbook', 'taskScope': 'Global', 'parameters': { 'arg1': 'value1'}}]
     */
    preTasks?: outputs.maintenance.v20220701preview.TaskPropertiesResponse[];
    /**
     ...
     */
    windowsParameters?: outputs.maintenance.v20220701preview.InputWindowsParametersResponse;
}
/**
