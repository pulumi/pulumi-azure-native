...
export interface ApiManagementServiceIdentityArgs {
     ...
     */
    type: pulumi.Input<string | enums.apimanagement.v20210801.ApimIdentityType>;
    /**
     ...
     */
    userAssignedIdentities?: pulumi.Input<{[key: string]: pulumi.Input<inputs.apimanagement.v20210801.UserIdentityPropertiesArgs>}>;
}
...
export interface ApiManagementServiceSkuPropertiesArgs {
     ...
     * Name of the Sku.
     */
    name: pulumi.Input<string | enums.apimanagement.v20210801.SkuType>;
}
...
export interface AuthenticationSettingsContractArgs {
     ...
     */
    oAuth2?: pulumi.Input<inputs.apimanagement.v20210801.OAuth2AuthenticationSettingsContractArgs>;
    /**
     * OpenID Connect Authentication Settings
     */
    openid?: pulumi.Input<inputs.apimanagement.v20210801.OpenIdAuthenticationSettingsContractArgs>;
}
...
export interface BackendCredentialsContractArgs {
     ...
     */
    authorization?: pulumi.Input<inputs.apimanagement.v20210801.BackendAuthorizationHeaderCredentialsArgs>;
    /**
...
export interface BackendPropertiesArgs {
     ...
     */
    serviceFabricCluster?: pulumi.Input<inputs.apimanagement.v20210801.BackendServiceFabricClusterPropertiesArgs>;
}
...
export interface BackendServiceFabricClusterPropertiesArgs {
     ...
     */
    serverX509Names?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210801.X509CertificateNameArgs>[]>;
}
...
export interface CertificateConfigurationArgs {
     ...
     */
    certificate?: pulumi.Input<inputs.apimanagement.v20210801.CertificateInformationArgs>;
    /**
...
export interface DataMaskingArgs {
     ...
     */
    headers?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210801.DataMaskingEntityArgs>[]>;
    /**
     * Masking settings for Url query parameters
     */
    queryParams?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210801.DataMaskingEntityArgs>[]>;
}
...
export interface DataMaskingEntityArgs {
     ...
     * Data masking mode.
     */
    mode?: pulumi.Input<string | enums.apimanagement.v20210801.DataMaskingMode>;
    /**
...
export interface HostnameConfigurationArgs {
     ...
     * Certificate Source.
     */
    certificateSource?: pulumi.Input<string | enums.apimanagement.v20210801.CertificateSource>;
    /**
     * Certificate Status.
     */
    certificateStatus?: pulumi.Input<string | enums.apimanagement.v20210801.CertificateStatus>;
    /**
     ...
     * Hostname type.
     */
    type: pulumi.Input<string | enums.apimanagement.v20210801.HostnameType>;
}
/**
...
export interface HttpMessageDiagnosticArgs {
     ...
     * Body logging settings.
     */
    body?: pulumi.Input<inputs.apimanagement.v20210801.BodyDiagnosticSettingsArgs>;
    /**
     * Data masking settings.
     */
    dataMasking?: pulumi.Input<inputs.apimanagement.v20210801.DataMaskingArgs>;
    /**
...
export interface OpenIdAuthenticationSettingsContractArgs {
     ...
     */
    bearerTokenSendingMethods?: pulumi.Input<pulumi.Input<string | enums.apimanagement.v20210801.BearerTokenSendingMethods>[]>;
    /**
     * OAuth authorization server identifier.
     */
...
export interface ParameterContractArgs {
     ...
     */
    examples?: pulumi.Input<{[key: string]: pulumi.Input<inputs.apimanagement.v20210801.ParameterExampleContractArgs>}>;
    /**
     * Parameter name.
     */
    name: pulumi.Input<string>;
...
export interface PipelineDiagnosticSettingsArgs {
     ...
     */
    request?: pulumi.Input<inputs.apimanagement.v20210801.HttpMessageDiagnosticArgs>;
    /**
     * Diagnostic settings for response.
     */
    response?: pulumi.Input<inputs.apimanagement.v20210801.HttpMessageDiagnosticArgs>;
}
...
export interface PrivateEndpointConnectionRequestPropertiesArgs {
     ...
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.apimanagement.v20210801.PrivateLinkServiceConnectionStateArgs>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.apimanagement.v20210801.PrivateEndpointServiceConnectionStatus>;
}
...
export interface RepresentationContractArgs {
     ...
     */
    formParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210801.ParameterContractArgs>[]>;
    /**
...
export interface RequestContractArgs {
     ...
     */
    headers?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210801.ParameterContractArgs>[]>;
    /**
     * Collection of operation request query parameters.
     */
    queryParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210801.ParameterContractArgs>[]>;
    /**
     * Collection of operation request representations.
     */
    representations?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210801.RepresentationContractArgs>[]>;
}
...
export interface SamplingSettingsArgs {
     ...
     * Sampling type.
     */
    samplingType?: pulumi.Input<string | enums.apimanagement.v20210801.SamplingType>;
}
