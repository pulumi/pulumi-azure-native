...
export interface AdditionalRegionArgs {
     ...
     */
    skuType: pulumi.Input<enums.apimanagement.v20161010.SkuType>;
    /**
...
export interface ApiManagementServiceSkuPropertiesArgs {
     ...
     * Name of the Sku.
     */
    name: pulumi.Input<enums.apimanagement.v20161010.SkuType>;
}
/**
...
export interface HostnameConfigurationArgs {
     ...
     */
    certificate: pulumi.Input<inputs.apimanagement.v20161010.CertificateInformationArgs>;
    /**
     * Hostname.
     */
     ...
     * Hostname type.
     */
    type: pulumi.Input<enums.apimanagement.v20161010.HostnameType>;
}
