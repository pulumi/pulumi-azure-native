...
export interface ApiManagementServiceIdentityArgs {
     ...
     */
    type: pulumi.Input<string | enums.apimanagement.v20220401preview.ApimIdentityType>;
    /**
     ...
     */
    userAssignedIdentities?: pulumi.Input<{[key: string]: pulumi.Input<inputs.apimanagement.v20220401preview.UserIdentityPropertiesArgs>}>;
}
...
export interface ApiManagementServiceSkuPropertiesArgs {
     ...
     * Name of the Sku.
     */
    name: pulumi.Input<string | enums.apimanagement.v20220401preview.SkuType>;
}
...
export interface ApiVersionSetContractDetailsArgs {
     ...
     */
    versioningScheme?: pulumi.Input<string | enums.apimanagement.v20220401preview.VersioningScheme>;
}
...
export interface AuthenticationSettingsContractArgs {
     ...
     */
    oAuth2?: pulumi.Input<inputs.apimanagement.v20220401preview.OAuth2AuthenticationSettingsContractArgs>;
    /**
     * Collection of OAuth2 authentication settings included into this API.
     */
    oAuth2AuthenticationSettings?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20220401preview.OAuth2AuthenticationSettingsContractArgs>[]>;
    /**
     * OpenID Connect Authentication Settings
     */
    openid?: pulumi.Input<inputs.apimanagement.v20220401preview.OpenIdAuthenticationSettingsContractArgs>;
    /**
     * Collection of Open ID Connect authentication settings included into this API.
     */
    openidAuthenticationSettings?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20220401preview.OpenIdAuthenticationSettingsContractArgs>[]>;
}
...
export interface AuthorizationProviderOAuth2SettingsArgs {
     ...
     * OAuth2 settings
     */
    grantTypes?: pulumi.Input<inputs.apimanagement.v20220401preview.AuthorizationProviderOAuth2GrantTypesArgs>;
    /**
...
export interface BackendCredentialsContractArgs {
     ...
     */
    authorization?: pulumi.Input<inputs.apimanagement.v20220401preview.BackendAuthorizationHeaderCredentialsArgs>;
    /**
...
export interface BackendPropertiesArgs {
     ...
     */
    serviceFabricCluster?: pulumi.Input<inputs.apimanagement.v20220401preview.BackendServiceFabricClusterPropertiesArgs>;
}
...
export interface BackendServiceFabricClusterPropertiesArgs {
     ...
     */
    serverX509Names?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20220401preview.X509CertificateNameArgs>[]>;
}
...
export interface CertificateConfigurationArgs {
     ...
     */
    certificate?: pulumi.Input<inputs.apimanagement.v20220401preview.CertificateInformationArgs>;
    /**
...
export interface DataMaskingArgs {
     ...
     */
    headers?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20220401preview.DataMaskingEntityArgs>[]>;
    /**
     * Masking settings for Url query parameters
     */
    queryParams?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20220401preview.DataMaskingEntityArgs>[]>;
}
...
export interface DataMaskingEntityArgs {
     ...
     * Data masking mode.
     */
    mode?: pulumi.Input<string | enums.apimanagement.v20220401preview.DataMaskingMode>;
    /**
...
export interface HostnameConfigurationArgs {
     ...
     * Certificate Source.
     */
    certificateSource?: pulumi.Input<string | enums.apimanagement.v20220401preview.CertificateSource>;
    /**
     * Certificate Status.
     */
    certificateStatus?: pulumi.Input<string | enums.apimanagement.v20220401preview.CertificateStatus>;
    /**
     ...
     * Hostname type.
     */
    type: pulumi.Input<string | enums.apimanagement.v20220401preview.HostnameType>;
}
/**
...
export interface HttpMessageDiagnosticArgs {
     ...
     * Body logging settings.
     */
    body?: pulumi.Input<inputs.apimanagement.v20220401preview.BodyDiagnosticSettingsArgs>;
    /**
     * Data masking settings.
     */
    dataMasking?: pulumi.Input<inputs.apimanagement.v20220401preview.DataMaskingArgs>;
    /**
...
export interface OpenIdAuthenticationSettingsContractArgs {
     ...
     */
    bearerTokenSendingMethods?: pulumi.Input<pulumi.Input<string | enums.apimanagement.v20220401preview.BearerTokenSendingMethods>[]>;
    /**
     * OAuth authorization server identifier.
     */
...
export interface ParameterContractArgs {
     ...
     */
    examples?: pulumi.Input<{[key: string]: pulumi.Input<inputs.apimanagement.v20220401preview.ParameterExampleContractArgs>}>;
    /**
     * Parameter name.
     */
    name: pulumi.Input<string>;
...
export interface PipelineDiagnosticSettingsArgs {
     ...
     */
    request?: pulumi.Input<inputs.apimanagement.v20220401preview.HttpMessageDiagnosticArgs>;
    /**
     * Diagnostic settings for response.
     */
    response?: pulumi.Input<inputs.apimanagement.v20220401preview.HttpMessageDiagnosticArgs>;
}
...
export interface PrivateEndpointConnectionRequestPropertiesArgs {
     ...
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.apimanagement.v20220401preview.PrivateLinkServiceConnectionStateArgs>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.apimanagement.v20220401preview.PrivateEndpointServiceConnectionStatus>;
}
...
export interface RepresentationContractArgs {
     ...
     */
    formParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20220401preview.ParameterContractArgs>[]>;
    /**
...
export interface RequestContractArgs {
     ...
     */
    headers?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20220401preview.ParameterContractArgs>[]>;
    /**
     * Collection of operation request query parameters.
     */
    queryParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20220401preview.ParameterContractArgs>[]>;
    /**
     * Collection of operation request representations.
     */
    representations?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20220401preview.RepresentationContractArgs>[]>;
}
...
export interface SamplingSettingsArgs {
     ...
     * Sampling type.
     */
    samplingType?: pulumi.Input<string | enums.apimanagement.v20220401preview.SamplingType>;
}
