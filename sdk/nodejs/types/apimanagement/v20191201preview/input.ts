...
export interface AdditionalLocationArgs {
     ...
     */
    sku: pulumi.Input<inputs.apimanagement.v20191201preview.ApiManagementServiceSkuPropertiesArgs>;
    /**
     * Virtual network configuration for the location.
     */
    virtualNetworkConfiguration?: pulumi.Input<inputs.apimanagement.v20191201preview.VirtualNetworkConfigurationArgs>;
}
/**
...
export interface ApiManagementServiceIdentityArgs {
     ...
     */
    type: pulumi.Input<string | enums.apimanagement.v20191201preview.ApimIdentityType>;
    /**
     ...
     */
    userAssignedIdentities?: pulumi.Input<{[key: string]: pulumi.Input<inputs.apimanagement.v20191201preview.UserIdentityPropertiesArgs>}>;
}
...
export interface ApiManagementServiceSkuPropertiesArgs {
     ...
     * Name of the Sku.
     */
    name: pulumi.Input<string | enums.apimanagement.v20191201preview.SkuType>;
}
...
export interface AuthenticationSettingsContractArgs {
     ...
     */
    oAuth2?: pulumi.Input<inputs.apimanagement.v20191201preview.OAuth2AuthenticationSettingsContractArgs>;
    /**
     * OpenID Connect Authentication Settings
     */
    openid?: pulumi.Input<inputs.apimanagement.v20191201preview.OpenIdAuthenticationSettingsContractArgs>;
}
...
export interface BackendCredentialsContractArgs {
     ...
     */
    authorization?: pulumi.Input<inputs.apimanagement.v20191201preview.BackendAuthorizationHeaderCredentialsArgs>;
    /**
...
export interface BackendPropertiesArgs {
     ...
     */
    serviceFabricCluster?: pulumi.Input<inputs.apimanagement.v20191201preview.BackendServiceFabricClusterPropertiesArgs>;
}
...
export interface BackendServiceFabricClusterPropertiesArgs {
     ...
     */
    serverX509Names?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20191201preview.X509CertificateNameArgs>[]>;
}
...
export interface CertificateConfigurationArgs {
     ...
     */
    certificate?: pulumi.Input<inputs.apimanagement.v20191201preview.CertificateInformationArgs>;
    /**
...
export interface HostnameConfigurationArgs {
     ...
     * Hostname type.
     */
    type: pulumi.Input<string | enums.apimanagement.v20191201preview.HostnameType>;
}
/**
...
export interface HttpMessageDiagnosticArgs {
     ...
     * Body logging settings.
     */
    body?: pulumi.Input<inputs.apimanagement.v20191201preview.BodyDiagnosticSettingsArgs>;
    /**
...
export interface OpenIdAuthenticationSettingsContractArgs {
     ...
     */
    bearerTokenSendingMethods?: pulumi.Input<pulumi.Input<string | enums.apimanagement.v20191201preview.BearerTokenSendingMethods>[]>;
    /**
     * OAuth authorization server identifier.
     */
...
export interface PipelineDiagnosticSettingsArgs {
     ...
     */
    request?: pulumi.Input<inputs.apimanagement.v20191201preview.HttpMessageDiagnosticArgs>;
    /**
     * Diagnostic settings for response.
     */
    response?: pulumi.Input<inputs.apimanagement.v20191201preview.HttpMessageDiagnosticArgs>;
}
...
export interface RepresentationContractArgs {
     ...
     */
    formParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20191201preview.ParameterContractArgs>[]>;
    /**
...
export interface RequestContractArgs {
     ...
     */
    headers?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20191201preview.ParameterContractArgs>[]>;
    /**
     * Collection of operation request query parameters.
     */
    queryParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20191201preview.ParameterContractArgs>[]>;
    /**
     * Collection of operation request representations.
     */
    representations?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20191201preview.RepresentationContractArgs>[]>;
}
...
export interface SamplingSettingsArgs {
     ...
     * Sampling type.
     */
    samplingType?: pulumi.Input<string | enums.apimanagement.v20191201preview.SamplingType>;
}
