...
export interface ApiManagementServiceIdentityArgs {
     ...
     */
    type: pulumi.Input<string | enums.apimanagement.v20210401preview.ApimIdentityType>;
    /**
     ...
     */
    userAssignedIdentities?: pulumi.Input<{[key: string]: pulumi.Input<inputs.apimanagement.v20210401preview.UserIdentityPropertiesArgs>}>;
}
...
export interface ApiManagementServiceSkuPropertiesArgs {
     ...
     * Name of the Sku.
     */
    name: pulumi.Input<string | enums.apimanagement.v20210401preview.SkuType>;
}
...
export interface AuthenticationSettingsContractArgs {
     ...
     */
    oAuth2?: pulumi.Input<inputs.apimanagement.v20210401preview.OAuth2AuthenticationSettingsContractArgs>;
    /**
     * OpenID Connect Authentication Settings
     */
    openid?: pulumi.Input<inputs.apimanagement.v20210401preview.OpenIdAuthenticationSettingsContractArgs>;
}
...
export interface BackendCredentialsContractArgs {
     ...
     */
    authorization?: pulumi.Input<inputs.apimanagement.v20210401preview.BackendAuthorizationHeaderCredentialsArgs>;
    /**
...
export interface BackendPropertiesArgs {
     ...
     */
    serviceFabricCluster?: pulumi.Input<inputs.apimanagement.v20210401preview.BackendServiceFabricClusterPropertiesArgs>;
}
...
export interface BackendServiceFabricClusterPropertiesArgs {
     ...
     */
    serverX509Names?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210401preview.X509CertificateNameArgs>[]>;
}
...
export interface CertificateConfigurationArgs {
     ...
     */
    certificate?: pulumi.Input<inputs.apimanagement.v20210401preview.CertificateInformationArgs>;
    /**
...
export interface DataMaskingArgs {
     ...
     */
    headers?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210401preview.DataMaskingEntityArgs>[]>;
    /**
     * Masking settings for Url query parameters
     */
    queryParams?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210401preview.DataMaskingEntityArgs>[]>;
}
...
export interface DataMaskingEntityArgs {
     ...
     * Data masking mode.
     */
    mode?: pulumi.Input<string | enums.apimanagement.v20210401preview.DataMaskingMode>;
    /**
...
export interface HostnameConfigurationArgs {
     ...
     * Certificate Source.
     */
    certificateSource?: pulumi.Input<string | enums.apimanagement.v20210401preview.CertificateSource>;
    /**
     * Certificate Status.
     */
    certificateStatus?: pulumi.Input<string | enums.apimanagement.v20210401preview.CertificateStatus>;
    /**
     ...
     * Hostname type.
     */
    type: pulumi.Input<string | enums.apimanagement.v20210401preview.HostnameType>;
}
/**
...
export interface HttpMessageDiagnosticArgs {
     ...
     * Body logging settings.
     */
    body?: pulumi.Input<inputs.apimanagement.v20210401preview.BodyDiagnosticSettingsArgs>;
    /**
     * Data masking settings.
     */
    dataMasking?: pulumi.Input<inputs.apimanagement.v20210401preview.DataMaskingArgs>;
    /**
...
export interface OpenIdAuthenticationSettingsContractArgs {
     ...
     */
    bearerTokenSendingMethods?: pulumi.Input<pulumi.Input<string | enums.apimanagement.v20210401preview.BearerTokenSendingMethods>[]>;
    /**
     * OAuth authorization server identifier.
     */
...
export interface ParameterContractArgs {
     ...
     */
    examples?: pulumi.Input<{[key: string]: pulumi.Input<inputs.apimanagement.v20210401preview.ParameterExampleContractArgs>}>;
    /**
     * Parameter name.
     */
    name: pulumi.Input<string>;
...
export interface PipelineDiagnosticSettingsArgs {
     ...
     */
    request?: pulumi.Input<inputs.apimanagement.v20210401preview.HttpMessageDiagnosticArgs>;
    /**
     * Diagnostic settings for response.
     */
    response?: pulumi.Input<inputs.apimanagement.v20210401preview.HttpMessageDiagnosticArgs>;
}
...
export interface PrivateEndpointConnectionRequestPropertiesArgs {
     ...
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.apimanagement.v20210401preview.PrivateLinkServiceConnectionStateArgs>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.apimanagement.v20210401preview.PrivateEndpointServiceConnectionStatus>;
}
...
export interface RepresentationContractArgs {
     ...
     */
    formParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210401preview.ParameterContractArgs>[]>;
    /**
...
export interface RequestContractArgs {
     ...
     */
    headers?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210401preview.ParameterContractArgs>[]>;
    /**
     * Collection of operation request query parameters.
     */
    queryParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210401preview.ParameterContractArgs>[]>;
    /**
     * Collection of operation request representations.
     */
    representations?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20210401preview.RepresentationContractArgs>[]>;
}
...
export interface SamplingSettingsArgs {
     ...
     * Sampling type.
     */
    samplingType?: pulumi.Input<string | enums.apimanagement.v20210401preview.SamplingType>;
}
