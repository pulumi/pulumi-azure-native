...
export interface ContainerServiceLinuxProfileArgs {
     ...
     */
    ssh: pulumi.Input<inputs.containerservice.v20200901.ContainerServiceSshConfigurationArgs>;
}
...
export interface ContainerServiceNetworkProfileArgs {
     ...
     */
    loadBalancerProfile?: pulumi.Input<inputs.containerservice.v20200901.ManagedClusterLoadBalancerProfileArgs>;
    /**
     * The load balancer sku for the managed cluster.
     */
    loadBalancerSku?: pulumi.Input<string | enums.containerservice.v20200901.LoadBalancerSku>;
    /**
     * Network mode used for building Kubernetes network.
     */
    networkMode?: pulumi.Input<string | enums.containerservice.v20200901.NetworkMode>;
    /**
     * Network plugin used for building Kubernetes network.
     */
    networkPlugin?: pulumi.Input<string | enums.containerservice.v20200901.NetworkPlugin>;
    /**
     * Network policy used for building Kubernetes network.
     */
    networkPolicy?: pulumi.Input<string | enums.containerservice.v20200901.NetworkPolicy>;
    /**
     * The outbound (egress) routing method.
     */
    outboundType?: pulumi.Input<string | enums.containerservice.v20200901.OutboundType>;
    /**
...
export function containerServiceNetworkProfileArgsProvideDefaults(val: ContainerServiceNetworkProfileArgs): ContainerServiceNetworkProfileArgs {
    return {
        ...
        loadBalancerProfile: (val.loadBalancerProfile ? pulumi.output(val.loadBalancerProfile).apply(inputs.containerservice.v20200901.managedClusterLoadBalancerProfileArgsProvideDefaults) : undefined),
...
export interface ContainerServiceSshConfigurationArgs {
     ...
     */
    publicKeys: pulumi.Input<pulumi.Input<inputs.containerservice.v20200901.ContainerServiceSshPublicKeyArgs>[]>;
}
...
export interface ManagedClusterAgentPoolProfileArgs {
     ...
     */
    mode?: pulumi.Input<string | enums.containerservice.v20200901.AgentPoolMode>;
    /**
     ...
     */
    osDiskType?: pulumi.Input<string | enums.containerservice.v20200901.OSDiskType>;
    /**
     * OsType to be used to specify os type. Choose from Linux and Windows. Default to Linux.
     */
    osType?: pulumi.Input<string | enums.containerservice.v20200901.OSType>;
    /**
     ...
     */
    scaleSetEvictionPolicy?: pulumi.Input<string | enums.containerservice.v20200901.ScaleSetEvictionPolicy>;
    /**
     * ScaleSetPriority to be used to specify virtual machine scale set priority. Default to regular.
     */
    scaleSetPriority?: pulumi.Input<string | enums.containerservice.v20200901.ScaleSetPriority>;
    /**
     ...
     */
    type?: pulumi.Input<string | enums.containerservice.v20200901.AgentPoolType>;
    /**
     * Settings for upgrading the agentpool
     */
    upgradeSettings?: pulumi.Input<inputs.containerservice.v20200901.AgentPoolUpgradeSettingsArgs>;
    /**
     * Size of agent VMs.
     */
    vmSize?: pulumi.Input<string | enums.containerservice.v20200901.ContainerServiceVMSizeTypes>;
    /**
...
export interface ManagedClusterIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.containerservice.v20200901.ResourceIdentityType>;
    /**
...
export interface ManagedClusterLoadBalancerProfileArgs {
     ...
     */
    effectiveOutboundIPs?: pulumi.Input<pulumi.Input<inputs.containerservice.v20200901.ResourceReferenceArgs>[]>;
    /**
     ...
     */
    managedOutboundIPs?: pulumi.Input<inputs.containerservice.v20200901.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs>;
    /**
     * Desired outbound IP Prefix resources for the cluster load balancer.
     */
    outboundIPPrefixes?: pulumi.Input<inputs.containerservice.v20200901.ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs>;
    /**
     * Desired outbound IP resources for the cluster load balancer.
     */
    outboundIPs?: pulumi.Input<inputs.containerservice.v20200901.ManagedClusterLoadBalancerProfileOutboundIPsArgs>;
}
/**
...
export function managedClusterLoadBalancerProfileArgsProvideDefaults(val: ManagedClusterLoadBalancerProfileArgs): ManagedClusterLoadBalancerProfileArgs {
    return {
        ...
        managedOutboundIPs: (val.managedOutboundIPs ? pulumi.output(val.managedOutboundIPs).apply(inputs.containerservice.v20200901.managedClusterLoadBalancerProfileManagedOutboundIPsArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs {
     ...
     */
    publicIPPrefixes?: pulumi.Input<pulumi.Input<inputs.containerservice.v20200901.ResourceReferenceArgs>[]>;
}
...
export interface ManagedClusterLoadBalancerProfileOutboundIPsArgs {
     ...
     */
    publicIPs?: pulumi.Input<pulumi.Input<inputs.containerservice.v20200901.ResourceReferenceArgs>[]>;
}
...
export interface ManagedClusterPropertiesAutoScalerProfileArgs {
    ...
    expander?: pulumi.Input<string | enums.containerservice.v20200901.Expander>;
...
export interface ManagedClusterSKUArgs {
     ...
     */
    name?: pulumi.Input<string | enums.containerservice.v20200901.ManagedClusterSKUName>;
    /**
     * Tier of a managed cluster SKU.
     */
    tier?: pulumi.Input<string | enums.containerservice.v20200901.ManagedClusterSKUTier>;
}
...
export interface ManagedClusterWindowsProfileArgs {
     ...
     */
    licenseType?: pulumi.Input<string | enums.containerservice.v20200901.LicenseType>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.containerservice.v20200901.ConnectionStatus>;
}
