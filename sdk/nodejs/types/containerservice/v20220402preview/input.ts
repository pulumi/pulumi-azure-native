...
export interface ContainerServiceLinuxProfileArgs {
     ...
     */
    ssh: pulumi.Input<inputs.containerservice.v20220402preview.ContainerServiceSshConfigurationArgs>;
}
...
export interface ContainerServiceNetworkProfileArgs {
     ...
     */
    ipFamilies?: pulumi.Input<pulumi.Input<string | enums.containerservice.v20220402preview.IpFamily>[]>;
    /**
     * Profile of the cluster load balancer.
     */
    loadBalancerProfile?: pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterLoadBalancerProfileArgs>;
    /**
     * The default is 'standard'. See [Azure Load Balancer SKUs](https://docs.microsoft.com/azure/load-balancer/skus) for more information about the differences between load balancer SKUs.
     */
    loadBalancerSku?: pulumi.Input<string | enums.containerservice.v20220402preview.LoadBalancerSku>;
    /**
     * Profile of the cluster NAT gateway.
     */
    natGatewayProfile?: pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterNATGatewayProfileArgs>;
    /**
     * This cannot be specified if networkPlugin is anything other than 'azure'.
     */
    networkMode?: pulumi.Input<string | enums.containerservice.v20220402preview.NetworkMode>;
    /**
     * Network plugin used for building the Kubernetes network.
     */
    networkPlugin?: pulumi.Input<string | enums.containerservice.v20220402preview.NetworkPlugin>;
    /**
     * Network plugin mode used for building the Kubernetes network.
     */
    networkPluginMode?: pulumi.Input<string | enums.containerservice.v20220402preview.NetworkPluginMode>;
    /**
     * Network policy used for building the Kubernetes network.
     */
    networkPolicy?: pulumi.Input<string | enums.containerservice.v20220402preview.NetworkPolicy>;
    /**
     * This can only be set at cluster creation time and cannot be changed later. For more information see [egress outbound type](https://docs.microsoft.com/azure/aks/egress-outboundtype).
     */
    outboundType?: pulumi.Input<string | enums.containerservice.v20220402preview.OutboundType>;
    /**
...
export function containerServiceNetworkProfileArgsProvideDefaults(val: ContainerServiceNetworkProfileArgs): ContainerServiceNetworkProfileArgs {
    return {
        ...
        loadBalancerProfile: (val.loadBalancerProfile ? pulumi.output(val.loadBalancerProfile).apply(inputs.containerservice.v20220402preview.managedClusterLoadBalancerProfileArgsProvideDefaults) : undefined),
        natGatewayProfile: (val.natGatewayProfile ? pulumi.output(val.natGatewayProfile).apply(inputs.containerservice.v20220402preview.managedClusterNATGatewayProfileArgsProvideDefaults) : undefined),
...
export interface ContainerServiceSshConfigurationArgs {
     ...
     */
    publicKeys: pulumi.Input<pulumi.Input<inputs.containerservice.v20220402preview.ContainerServiceSshPublicKeyArgs>[]>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerservice.v20220402preview.ExtendedLocationTypes>;
}
...
export interface LinuxOSConfigArgs {
     ...
     */
    sysctls?: pulumi.Input<inputs.containerservice.v20220402preview.SysctlConfigArgs>;
    /**
...
export interface ManagedClusterAutoUpgradeProfileArgs {
     ...
     */
    upgradeChannel?: pulumi.Input<string | enums.containerservice.v20220402preview.UpgradeChannel>;
}
...
export interface ManagedClusterIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.containerservice.v20220402preview.ResourceIdentityType>;
    /**
...
export interface ManagedClusterIngressProfileArgs {
     ...
     */
    webAppRouting?: pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterIngressProfileWebAppRoutingArgs>;
}
...
export interface ManagedClusterLoadBalancerProfileArgs {
     ...
     */
    effectiveOutboundIPs?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220402preview.ResourceReferenceArgs>[]>;
    /**
     ...
     */
    managedOutboundIPs?: pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs>;
    /**
     * Desired outbound IP Prefix resources for the cluster load balancer.
     */
    outboundIPPrefixes?: pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs>;
    /**
     * Desired outbound IP resources for the cluster load balancer.
     */
    outboundIPs?: pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterLoadBalancerProfileOutboundIPsArgs>;
}
/**
...
export function managedClusterLoadBalancerProfileArgsProvideDefaults(val: ManagedClusterLoadBalancerProfileArgs): ManagedClusterLoadBalancerProfileArgs {
    return {
        ...
        managedOutboundIPs: (val.managedOutboundIPs ? pulumi.output(val.managedOutboundIPs).apply(inputs.containerservice.v20220402preview.managedClusterLoadBalancerProfileManagedOutboundIPsArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs {
     ...
     */
    publicIPPrefixes?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220402preview.ResourceReferenceArgs>[]>;
}
...
export interface ManagedClusterLoadBalancerProfileOutboundIPsArgs {
     ...
     */
    publicIPs?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220402preview.ResourceReferenceArgs>[]>;
}
...
export interface ManagedClusterNATGatewayProfileArgs {
     ...
     */
    managedOutboundIPProfile?: pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterManagedOutboundIPProfileArgs>;
}
/**
...
export function managedClusterNATGatewayProfileArgsProvideDefaults(val: ManagedClusterNATGatewayProfileArgs): ManagedClusterNATGatewayProfileArgs {
    return {
        ...
        managedOutboundIPProfile: (val.managedOutboundIPProfile ? pulumi.output(val.managedOutboundIPProfile).apply(inputs.containerservice.v20220402preview.managedClusterManagedOutboundIPProfileArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterPodIdentityArgs {
     ...
     */
    identity: pulumi.Input<inputs.containerservice.v20220402preview.UserAssignedIdentityArgs>;
    /**
...
export interface ManagedClusterPodIdentityProfileArgs {
     ...
     */
    userAssignedIdentities?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterPodIdentityArgs>[]>;
    /**
     * The pod identity exceptions to allow.
     */
    userAssignedIdentityExceptions?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterPodIdentityExceptionArgs>[]>;
}
...
export interface ManagedClusterPropertiesAutoScalerProfileArgs {
     ...
     */
    expander?: pulumi.Input<string | enums.containerservice.v20220402preview.Expander>;
    /**
     * The default is 10.
     */
...
export interface ManagedClusterSKUArgs {
     ...
     */
    name?: pulumi.Input<string | enums.containerservice.v20220402preview.ManagedClusterSKUName>;
    /**
     * If not specified, the default is 'Free'. See [uptime SLA](https://docs.microsoft.com/azure/aks/uptime-sla) for more details.
     */
    tier?: pulumi.Input<string | enums.containerservice.v20220402preview.ManagedClusterSKUTier>;
}
...
export interface ManagedClusterSecurityProfileArgs {
     ...
     */
    azureDefender?: pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterSecurityProfileAzureDefenderArgs>;
    /**
     * Azure Key Vault [key management service](https://kubernetes.io/docs/tasks/administer-cluster/kms-provider/) settings for the security profile.
     */
    azureKeyVaultKms?: pulumi.Input<inputs.containerservice.v20220402preview.AzureKeyVaultKmsArgs>;
    /**
     * [Workload Identity](https://azure.github.io/azure-workload-identity/docs/) settings for the security profile.
     */
    workloadIdentity?: pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterSecurityProfileWorkloadIdentityArgs>;
}
...
export interface ManagedClusterStorageProfileArgs {
     ...
     */
    diskCSIDriver?: pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterStorageProfileDiskCSIDriverArgs>;
    /**
     * AzureFile CSI Driver settings for the storage profile.
     */
    fileCSIDriver?: pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterStorageProfileFileCSIDriverArgs>;
    /**
     * Snapshot Controller settings for the storage profile.
     */
    snapshotController?: pulumi.Input<inputs.containerservice.v20220402preview.ManagedClusterStorageProfileSnapshotControllerArgs>;
}
...
export interface ManagedClusterWindowsProfileArgs {
     ...
     */
    gmsaProfile?: pulumi.Input<inputs.containerservice.v20220402preview.WindowsGmsaProfileArgs>;
    /**
     * The license type to use for Windows VMs. See [Azure Hybrid User Benefits](https://azure.microsoft.com/pricing/hybrid-benefit/faq/) for more details.
     */
    licenseType?: pulumi.Input<string | enums.containerservice.v20220402preview.LicenseType>;
}
...
export interface PowerStateArgs {
     ...
     */
    code?: pulumi.Input<string | enums.containerservice.v20220402preview.Code>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.containerservice.v20220402preview.ConnectionStatus>;
}
...
export interface TimeInWeekArgs {
     ...
     * The day of the week.
     */
    day?: pulumi.Input<string | enums.containerservice.v20220402preview.WeekDay>;
    /**
