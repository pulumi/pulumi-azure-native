...
export interface AzureKeyVaultKmsArgs {
     ...
     */
    keyVaultNetworkAccess?: pulumi.Input<string | enums.containerservice.v20220701.KeyVaultNetworkAccessTypes>;
    /**
...
export interface ContainerServiceLinuxProfileArgs {
     ...
     */
    ssh: pulumi.Input<inputs.containerservice.v20220701.ContainerServiceSshConfigurationArgs>;
}
...
export interface ContainerServiceNetworkProfileArgs {
     ...
     */
    ipFamilies?: pulumi.Input<pulumi.Input<string | enums.containerservice.v20220701.IpFamily>[]>;
    /**
     * Profile of the cluster load balancer.
     */
    loadBalancerProfile?: pulumi.Input<inputs.containerservice.v20220701.ManagedClusterLoadBalancerProfileArgs>;
    /**
     * The default is 'standard'. See [Azure Load Balancer SKUs](https://docs.microsoft.com/azure/load-balancer/skus) for more information about the differences between load balancer SKUs.
     */
    loadBalancerSku?: pulumi.Input<string | enums.containerservice.v20220701.LoadBalancerSku>;
    /**
     * Profile of the cluster NAT gateway.
     */
    natGatewayProfile?: pulumi.Input<inputs.containerservice.v20220701.ManagedClusterNATGatewayProfileArgs>;
    /**
     * This cannot be specified if networkPlugin is anything other than 'azure'.
     */
    networkMode?: pulumi.Input<string | enums.containerservice.v20220701.NetworkMode>;
    /**
     * Network plugin used for building the Kubernetes network.
     */
    networkPlugin?: pulumi.Input<string | enums.containerservice.v20220701.NetworkPlugin>;
    /**
     * Network policy used for building the Kubernetes network.
     */
    networkPolicy?: pulumi.Input<string | enums.containerservice.v20220701.NetworkPolicy>;
    /**
     * This can only be set at cluster creation time and cannot be changed later. For more information see [egress outbound type](https://docs.microsoft.com/azure/aks/egress-outboundtype).
     */
    outboundType?: pulumi.Input<string | enums.containerservice.v20220701.OutboundType>;
    /**
...
export function containerServiceNetworkProfileArgsProvideDefaults(val: ContainerServiceNetworkProfileArgs): ContainerServiceNetworkProfileArgs {
    return {
        ...
        loadBalancerProfile: (val.loadBalancerProfile ? pulumi.output(val.loadBalancerProfile).apply(inputs.containerservice.v20220701.managedClusterLoadBalancerProfileArgsProvideDefaults) : undefined),
        natGatewayProfile: (val.natGatewayProfile ? pulumi.output(val.natGatewayProfile).apply(inputs.containerservice.v20220701.managedClusterNATGatewayProfileArgsProvideDefaults) : undefined),
...
export interface ContainerServiceSshConfigurationArgs {
     ...
     */
    publicKeys: pulumi.Input<pulumi.Input<inputs.containerservice.v20220701.ContainerServiceSshPublicKeyArgs>[]>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerservice.v20220701.ExtendedLocationTypes>;
}
...
export interface LinuxOSConfigArgs {
     ...
     */
    sysctls?: pulumi.Input<inputs.containerservice.v20220701.SysctlConfigArgs>;
    /**
...
export interface ManagedClusterAgentPoolProfileArgs {
     ...
     */
    gpuInstanceProfile?: pulumi.Input<string | enums.containerservice.v20220701.GPUInstanceProfile>;
    /**
     ...
     */
    kubeletConfig?: pulumi.Input<inputs.containerservice.v20220701.KubeletConfigArgs>;
    /**
     * Determines the placement of emptyDir volumes, container runtime data root, and Kubelet ephemeral storage.
     */
    kubeletDiskType?: pulumi.Input<string | enums.containerservice.v20220701.KubeletDiskType>;
    /**
     * The OS configuration of Linux agent nodes.
     */
    linuxOSConfig?: pulumi.Input<inputs.containerservice.v20220701.LinuxOSConfigArgs>;
    /**
     ...
     */
    mode?: pulumi.Input<string | enums.containerservice.v20220701.AgentPoolMode>;
    /**
     ...
     */
    osDiskType?: pulumi.Input<string | enums.containerservice.v20220701.OSDiskType>;
    /**
     * Specifies the OS SKU used by the agent pool. The default is Ubuntu if OSType is Linux. The default is Windows2019 when Kubernetes <= 1.24 or Windows2022 when Kubernetes >= 1.25 if OSType is Windows.
     */
    osSKU?: pulumi.Input<string | enums.containerservice.v20220701.OSSKU>;
    /**
     * The operating system type. The default is Linux.
     */
    osType?: pulumi.Input<string | enums.containerservice.v20220701.OSType>;
    /**
     ...
     */
    powerState?: pulumi.Input<inputs.containerservice.v20220701.PowerStateArgs>;
    /**
     ...
     */
    scaleDownMode?: pulumi.Input<string | enums.containerservice.v20220701.ScaleDownMode>;
    /**
     * This cannot be specified unless the scaleSetPriority is 'Spot'. If not specified, the default is 'Delete'.
     */
    scaleSetEvictionPolicy?: pulumi.Input<string | enums.containerservice.v20220701.ScaleSetEvictionPolicy>;
    /**
     * The Virtual Machine Scale Set priority. If not specified, the default is 'Regular'.
     */
    scaleSetPriority?: pulumi.Input<string | enums.containerservice.v20220701.ScaleSetPriority>;
    /**
     ...
     */
    type?: pulumi.Input<string | enums.containerservice.v20220701.AgentPoolType>;
    /**
     * Settings for upgrading the agentpool
     */
    upgradeSettings?: pulumi.Input<inputs.containerservice.v20220701.AgentPoolUpgradeSettingsArgs>;
    /**
     ...
     */
    workloadRuntime?: pulumi.Input<string | enums.containerservice.v20220701.WorkloadRuntime>;
}
...
export interface ManagedClusterAutoUpgradeProfileArgs {
     ...
     */
    upgradeChannel?: pulumi.Input<string | enums.containerservice.v20220701.UpgradeChannel>;
}
...
export interface ManagedClusterIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.containerservice.v20220701.ResourceIdentityType>;
    /**
...
export interface ManagedClusterLoadBalancerProfileArgs {
     ...
     */
    effectiveOutboundIPs?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220701.ResourceReferenceArgs>[]>;
    /**
     ...
     */
    managedOutboundIPs?: pulumi.Input<inputs.containerservice.v20220701.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs>;
    /**
     * Desired outbound IP Prefix resources for the cluster load balancer.
     */
    outboundIPPrefixes?: pulumi.Input<inputs.containerservice.v20220701.ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs>;
    /**
     * Desired outbound IP resources for the cluster load balancer.
     */
    outboundIPs?: pulumi.Input<inputs.containerservice.v20220701.ManagedClusterLoadBalancerProfileOutboundIPsArgs>;
}
/**
...
export function managedClusterLoadBalancerProfileArgsProvideDefaults(val: ManagedClusterLoadBalancerProfileArgs): ManagedClusterLoadBalancerProfileArgs {
    return {
        ...
        managedOutboundIPs: (val.managedOutboundIPs ? pulumi.output(val.managedOutboundIPs).apply(inputs.containerservice.v20220701.managedClusterLoadBalancerProfileManagedOutboundIPsArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs {
     ...
     */
    publicIPPrefixes?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220701.ResourceReferenceArgs>[]>;
}
...
export interface ManagedClusterLoadBalancerProfileOutboundIPsArgs {
     ...
     */
    publicIPs?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220701.ResourceReferenceArgs>[]>;
}
...
export interface ManagedClusterNATGatewayProfileArgs {
     ...
     */
    managedOutboundIPProfile?: pulumi.Input<inputs.containerservice.v20220701.ManagedClusterManagedOutboundIPProfileArgs>;
}
/**
...
export function managedClusterNATGatewayProfileArgsProvideDefaults(val: ManagedClusterNATGatewayProfileArgs): ManagedClusterNATGatewayProfileArgs {
    return {
        ...
        managedOutboundIPProfile: (val.managedOutboundIPProfile ? pulumi.output(val.managedOutboundIPProfile).apply(inputs.containerservice.v20220701.managedClusterManagedOutboundIPProfileArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterPodIdentityArgs {
     ...
     */
    identity: pulumi.Input<inputs.containerservice.v20220701.UserAssignedIdentityArgs>;
    /**
...
export interface ManagedClusterPodIdentityProfileArgs {
     ...
     */
    userAssignedIdentities?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220701.ManagedClusterPodIdentityArgs>[]>;
    /**
     * The pod identity exceptions to allow.
     */
    userAssignedIdentityExceptions?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220701.ManagedClusterPodIdentityExceptionArgs>[]>;
}
...
export interface ManagedClusterPropertiesAutoScalerProfileArgs {
     ...
     */
    expander?: pulumi.Input<string | enums.containerservice.v20220701.Expander>;
    /**
     * The default is 10.
     */
...
export interface ManagedClusterSKUArgs {
     ...
     */
    name?: pulumi.Input<string | enums.containerservice.v20220701.ManagedClusterSKUName>;
    /**
     * If not specified, the default is 'Free'. See [uptime SLA](https://docs.microsoft.com/azure/aks/uptime-sla) for more details.
     */
    tier?: pulumi.Input<string | enums.containerservice.v20220701.ManagedClusterSKUTier>;
}
...
export interface ManagedClusterSecurityProfileArgs {
     ...
     */
    azureKeyVaultKms?: pulumi.Input<inputs.containerservice.v20220701.AzureKeyVaultKmsArgs>;
    /**
     * Microsoft Defender settings for the security profile.
     */
    defender?: pulumi.Input<inputs.containerservice.v20220701.ManagedClusterSecurityProfileDefenderArgs>;
}
/**
...
export function managedClusterSecurityProfileArgsProvideDefaults(val: ManagedClusterSecurityProfileArgs): ManagedClusterSecurityProfileArgs {
    return {
        ...val,
        azureKeyVaultKms: (val.azureKeyVaultKms ? pulumi.output(val.azureKeyVaultKms).apply(inputs.containerservice.v20220701.azureKeyVaultKmsArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterSecurityProfileDefenderArgs {
     ...
     */
    securityMonitoring?: pulumi.Input<inputs.containerservice.v20220701.ManagedClusterSecurityProfileDefenderSecurityMonitoringArgs>;
}
...
export interface ManagedClusterStorageProfileArgs {
     ...
     */
    diskCSIDriver?: pulumi.Input<inputs.containerservice.v20220701.ManagedClusterStorageProfileDiskCSIDriverArgs>;
    /**
     * AzureFile CSI Driver settings for the storage profile.
     */
    fileCSIDriver?: pulumi.Input<inputs.containerservice.v20220701.ManagedClusterStorageProfileFileCSIDriverArgs>;
    /**
     * Snapshot Controller settings for the storage profile.
     */
    snapshotController?: pulumi.Input<inputs.containerservice.v20220701.ManagedClusterStorageProfileSnapshotControllerArgs>;
}
...
export interface ManagedClusterWindowsProfileArgs {
     ...
     */
    gmsaProfile?: pulumi.Input<inputs.containerservice.v20220701.WindowsGmsaProfileArgs>;
    /**
     * The license type to use for Windows VMs. See [Azure Hybrid User Benefits](https://azure.microsoft.com/pricing/hybrid-benefit/faq/) for more details.
     */
    licenseType?: pulumi.Input<string | enums.containerservice.v20220701.LicenseType>;
}
...
export interface PowerStateArgs {
     ...
     */
    code?: pulumi.Input<string | enums.containerservice.v20220701.Code>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.containerservice.v20220701.ConnectionStatus>;
}
...
export interface TimeInWeekArgs {
     ...
     * The day of the week.
     */
    day?: pulumi.Input<string | enums.containerservice.v20220701.WeekDay>;
    /**
