...
export interface ContainerServiceLinuxProfileArgs {
     ...
     */
    ssh: pulumi.Input<inputs.containerservice.v20220202preview.ContainerServiceSshConfigurationArgs>;
}
...
export interface ContainerServiceNetworkProfileArgs {
     ...
     */
    ipFamilies?: pulumi.Input<pulumi.Input<string | enums.containerservice.v20220202preview.IpFamily>[]>;
    /**
     * Profile of the cluster load balancer.
     */
    loadBalancerProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterLoadBalancerProfileArgs>;
    /**
     * The default is 'standard'. See [Azure Load Balancer SKUs](https://docs.microsoft.com/azure/load-balancer/skus) for more information about the differences between load balancer SKUs.
     */
    loadBalancerSku?: pulumi.Input<string | enums.containerservice.v20220202preview.LoadBalancerSku>;
    /**
     * Profile of the cluster NAT gateway.
     */
    natGatewayProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterNATGatewayProfileArgs>;
    /**
     * This cannot be specified if networkPlugin is anything other than 'azure'.
     */
    networkMode?: pulumi.Input<string | enums.containerservice.v20220202preview.NetworkMode>;
    /**
     * Network plugin used for building the Kubernetes network.
     */
    networkPlugin?: pulumi.Input<string | enums.containerservice.v20220202preview.NetworkPlugin>;
    /**
     * Network policy used for building the Kubernetes network.
     */
    networkPolicy?: pulumi.Input<string | enums.containerservice.v20220202preview.NetworkPolicy>;
    /**
     * This can only be set at cluster creation time and cannot be changed later. For more information see [egress outbound type](https://docs.microsoft.com/azure/aks/egress-outboundtype).
     */
    outboundType?: pulumi.Input<string | enums.containerservice.v20220202preview.OutboundType>;
    /**
...
export function containerServiceNetworkProfileArgsProvideDefaults(val: ContainerServiceNetworkProfileArgs): ContainerServiceNetworkProfileArgs {
    return {
        ...
        loadBalancerProfile: (val.loadBalancerProfile ? pulumi.output(val.loadBalancerProfile).apply(inputs.containerservice.v20220202preview.managedClusterLoadBalancerProfileArgsProvideDefaults) : undefined),
        natGatewayProfile: (val.natGatewayProfile ? pulumi.output(val.natGatewayProfile).apply(inputs.containerservice.v20220202preview.managedClusterNATGatewayProfileArgsProvideDefaults) : undefined),
...
export interface ContainerServiceSshConfigurationArgs {
     ...
     */
    publicKeys: pulumi.Input<pulumi.Input<inputs.containerservice.v20220202preview.ContainerServiceSshPublicKeyArgs>[]>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerservice.v20220202preview.ExtendedLocationTypes>;
}
...
export interface LinuxOSConfigArgs {
     ...
     */
    sysctls?: pulumi.Input<inputs.containerservice.v20220202preview.SysctlConfigArgs>;
    /**
...
export interface ManagedClusterAutoUpgradeProfileArgs {
     ...
     */
    upgradeChannel?: pulumi.Input<string | enums.containerservice.v20220202preview.UpgradeChannel>;
}
...
export interface ManagedClusterIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.containerservice.v20220202preview.ResourceIdentityType>;
    /**
...
export interface ManagedClusterLoadBalancerProfileArgs {
     ...
     */
    effectiveOutboundIPs?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220202preview.ResourceReferenceArgs>[]>;
    /**
     ...
     */
    managedOutboundIPs?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs>;
    /**
     * Desired outbound IP Prefix resources for the cluster load balancer.
     */
    outboundIPPrefixes?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs>;
    /**
     * Desired outbound IP resources for the cluster load balancer.
     */
    outboundIPs?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterLoadBalancerProfileOutboundIPsArgs>;
}
/**
...
export function managedClusterLoadBalancerProfileArgsProvideDefaults(val: ManagedClusterLoadBalancerProfileArgs): ManagedClusterLoadBalancerProfileArgs {
    return {
        ...
        managedOutboundIPs: (val.managedOutboundIPs ? pulumi.output(val.managedOutboundIPs).apply(inputs.containerservice.v20220202preview.managedClusterLoadBalancerProfileManagedOutboundIPsArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs {
     ...
     */
    publicIPPrefixes?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220202preview.ResourceReferenceArgs>[]>;
}
...
export interface ManagedClusterLoadBalancerProfileOutboundIPsArgs {
     ...
     */
    publicIPs?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220202preview.ResourceReferenceArgs>[]>;
}
...
export interface ManagedClusterNATGatewayProfileArgs {
     ...
     */
    managedOutboundIPProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterManagedOutboundIPProfileArgs>;
}
/**
...
export function managedClusterNATGatewayProfileArgsProvideDefaults(val: ManagedClusterNATGatewayProfileArgs): ManagedClusterNATGatewayProfileArgs {
    return {
        ...
        managedOutboundIPProfile: (val.managedOutboundIPProfile ? pulumi.output(val.managedOutboundIPProfile).apply(inputs.containerservice.v20220202preview.managedClusterManagedOutboundIPProfileArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterPodIdentityArgs {
     ...
     */
    identity: pulumi.Input<inputs.containerservice.v20220202preview.UserAssignedIdentityArgs>;
    /**
...
export interface ManagedClusterPodIdentityProfileArgs {
     ...
     */
    userAssignedIdentities?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterPodIdentityArgs>[]>;
    /**
     * The pod identity exceptions to allow.
     */
    userAssignedIdentityExceptions?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterPodIdentityExceptionArgs>[]>;
}
...
export interface ManagedClusterPropertiesAutoScalerProfileArgs {
     ...
     */
    expander?: pulumi.Input<string | enums.containerservice.v20220202preview.Expander>;
    /**
     * The default is 10.
     */
...
export interface ManagedClusterSKUArgs {
     ...
     */
    name?: pulumi.Input<string | enums.containerservice.v20220202preview.ManagedClusterSKUName>;
    /**
     * If not specified, the default is 'Free'. See [uptime SLA](https://docs.microsoft.com/azure/aks/uptime-sla) for more details.
     */
    tier?: pulumi.Input<string | enums.containerservice.v20220202preview.ManagedClusterSKUTier>;
}
...
export interface ManagedClusterSecurityProfileArgs {
     ...
     */
    azureDefender?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterSecurityProfileAzureDefenderArgs>;
    /**
     * Azure Key Vault [key management service](https://kubernetes.io/docs/tasks/administer-cluster/kms-provider/) settings for the security profile.
     */
    azureKeyVaultKms?: pulumi.Input<inputs.containerservice.v20220202preview.AzureKeyVaultKmsArgs>;
}
...
export interface ManagedClusterWindowsProfileArgs {
     ...
     */
    gmsaProfile?: pulumi.Input<inputs.containerservice.v20220202preview.WindowsGmsaProfileArgs>;
    /**
     * The license type to use for Windows VMs. See [Azure Hybrid User Benefits](https://azure.microsoft.com/pricing/hybrid-benefit/faq/) for more details.
     */
    licenseType?: pulumi.Input<string | enums.containerservice.v20220202preview.LicenseType>;
}
...
export interface PowerStateArgs {
     ...
     */
    code?: pulumi.Input<string | enums.containerservice.v20220202preview.Code>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.containerservice.v20220202preview.ConnectionStatus>;
}
...
export interface TimeInWeekArgs {
     ...
     * The day of the week.
     */
    day?: pulumi.Input<string | enums.containerservice.v20220202preview.WeekDay>;
    /**
