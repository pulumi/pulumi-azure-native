...
export interface ContainerServiceLinuxProfileResponse {
     ...
     */
    ssh: outputs.containerservice.v20220802preview.ContainerServiceSshConfigurationResponse;
}
...
export interface ContainerServiceNetworkProfileResponse {
     ...
     */
    kubeProxyConfig?: outputs.containerservice.v20220802preview.ContainerServiceNetworkProfileResponseKubeProxyConfig;
    /**
     * Profile of the cluster load balancer.
     */
    loadBalancerProfile?: outputs.containerservice.v20220802preview.ManagedClusterLoadBalancerProfileResponse;
    /**
     ...
     */
    natGatewayProfile?: outputs.containerservice.v20220802preview.ManagedClusterNATGatewayProfileResponse;
    /**
...
export function containerServiceNetworkProfileResponseProvideDefaults(val: ContainerServiceNetworkProfileResponse): ContainerServiceNetworkProfileResponse {
    return {
        ...
        loadBalancerProfile: (val.loadBalancerProfile ? outputs.containerservice.v20220802preview.managedClusterLoadBalancerProfileResponseProvideDefaults(val.loadBalancerProfile) : undefined),
        natGatewayProfile: (val.natGatewayProfile ? outputs.containerservice.v20220802preview.managedClusterNATGatewayProfileResponseProvideDefaults(val.natGatewayProfile) : undefined),
...
export interface ContainerServiceNetworkProfileResponseKubeProxyConfig {
     ...
     * Holds configuration customizations for IPVS. May only be specified if 'mode' is set to 'IPVS'.
     */
    ipvsConfig?: outputs.containerservice.v20220802preview.ContainerServiceNetworkProfileResponseIpvsConfig;
    /**
...
export interface ContainerServiceSshConfigurationResponse {
     ...
     */
    publicKeys: outputs.containerservice.v20220802preview.ContainerServiceSshPublicKeyResponse[];
}
...
export interface LinuxOSConfigResponse {
     ...
     */
    sysctls?: outputs.containerservice.v20220802preview.SysctlConfigResponse;
    /**
...
export interface ManagedClusterAddonProfileResponse {
     ...
     */
    identity: outputs.containerservice.v20220802preview.ManagedClusterAddonProfileResponseIdentity;
}
...
export interface ManagedClusterAgentPoolProfileResponse {
     ...
     */
    creationData?: outputs.containerservice.v20220802preview.CreationDataResponse;
    /**
     ...
     */
    kubeletConfig?: outputs.containerservice.v20220802preview.KubeletConfigResponse;
    /**
     ...
     */
    linuxOSConfig?: outputs.containerservice.v20220802preview.LinuxOSConfigResponse;
    /**
     ...
     */
    powerState?: outputs.containerservice.v20220802preview.PowerStateResponse;
    /**
     ...
     */
    upgradeSettings?: outputs.containerservice.v20220802preview.AgentPoolUpgradeSettingsResponse;
    /**
     ...
     * The Windows agent pool's specific profile.
     */
    windowsProfile?: outputs.containerservice.v20220802preview.AgentPoolWindowsProfileResponse;
    /**
...
export interface ManagedClusterAzureMonitorProfileMetricsResponse {
     ...
     * Kube State Metrics for prometheus addon profile for the container service cluster
     */
    kubeStateMetrics?: outputs.containerservice.v20220802preview.ManagedClusterAzureMonitorProfileKubeStateMetricsResponse;
}
...
export interface ManagedClusterAzureMonitorProfileResponse {
     ...
     * Metrics profile for the prometheus service addon
     */
    metrics?: outputs.containerservice.v20220802preview.ManagedClusterAzureMonitorProfileMetricsResponse;
}
...
export interface ManagedClusterIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.containerservice.v20220802preview.ManagedClusterIdentityResponseUserAssignedIdentities};
}
...
export interface ManagedClusterIngressProfileResponse {
     ...
     */
    webAppRouting?: outputs.containerservice.v20220802preview.ManagedClusterIngressProfileWebAppRoutingResponse;
}
...
export interface ManagedClusterLoadBalancerProfileResponse {
     ...
     */
    effectiveOutboundIPs?: outputs.containerservice.v20220802preview.ResourceReferenceResponse[];
    /**
     ...
     */
    managedOutboundIPs?: outputs.containerservice.v20220802preview.ManagedClusterLoadBalancerProfileResponseManagedOutboundIPs;
    /**
     * Desired outbound IP Prefix resources for the cluster load balancer.
     */
    outboundIPPrefixes?: outputs.containerservice.v20220802preview.ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixes;
    /**
     * Desired outbound IP resources for the cluster load balancer.
     */
    outboundIPs?: outputs.containerservice.v20220802preview.ManagedClusterLoadBalancerProfileResponseOutboundIPs;
}
/**
...
export function managedClusterLoadBalancerProfileResponseProvideDefaults(val: ManagedClusterLoadBalancerProfileResponse): ManagedClusterLoadBalancerProfileResponse {
    return {
        ...
        managedOutboundIPs: (val.managedOutboundIPs ? outputs.containerservice.v20220802preview.managedClusterLoadBalancerProfileResponseManagedOutboundIPsProvideDefaults(val.managedOutboundIPs) : undefined),
    };
}
...
export interface ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixes {
     ...
     */
    publicIPPrefixes?: outputs.containerservice.v20220802preview.ResourceReferenceResponse[];
}
...
export interface ManagedClusterLoadBalancerProfileResponseOutboundIPs {
     ...
     */
    publicIPs?: outputs.containerservice.v20220802preview.ResourceReferenceResponse[];
}
...
export interface ManagedClusterNATGatewayProfileResponse {
     ...
     */
    managedOutboundIPProfile?: outputs.containerservice.v20220802preview.ManagedClusterManagedOutboundIPProfileResponse;
}
/**
...
export function managedClusterNATGatewayProfileResponseProvideDefaults(val: ManagedClusterNATGatewayProfileResponse): ManagedClusterNATGatewayProfileResponse {
    return {
        ...
        managedOutboundIPProfile: (val.managedOutboundIPProfile ? outputs.containerservice.v20220802preview.managedClusterManagedOutboundIPProfileResponseProvideDefaults(val.managedOutboundIPProfile) : undefined),
    };
}
...
export interface ManagedClusterPodIdentityProfileResponse {
     ...
     */
    userAssignedIdentities?: outputs.containerservice.v20220802preview.ManagedClusterPodIdentityResponse[];
    /**
     * The pod identity exceptions to allow.
     */
    userAssignedIdentityExceptions?: outputs.containerservice.v20220802preview.ManagedClusterPodIdentityExceptionResponse[];
}
...
export interface ManagedClusterPodIdentityProvisioningErrorBodyResponse {
     ...
     */
    details?: outputs.containerservice.v20220802preview.ManagedClusterPodIdentityProvisioningErrorBodyResponse[];
    /**
...
export interface ManagedClusterPodIdentityProvisioningErrorResponse {
     ...
     */
    error?: outputs.containerservice.v20220802preview.ManagedClusterPodIdentityProvisioningErrorBodyResponse;
}
...
export interface ManagedClusterPodIdentityResponse {
     ...
     */
    identity: outputs.containerservice.v20220802preview.UserAssignedIdentityResponse;
    /**
     ...
     */
    namespace: string;
    provisioningInfo: outputs.containerservice.v20220802preview.ManagedClusterPodIdentityResponseProvisioningInfo;
    /**
...
export interface ManagedClusterPodIdentityResponseProvisioningInfo {
     ...
     */
    error?: outputs.containerservice.v20220802preview.ManagedClusterPodIdentityProvisioningErrorResponse;
}
...
export interface ManagedClusterPropertiesForSnapshotResponse {
     ...
     */
    networkProfile: outputs.containerservice.v20220802preview.NetworkProfileForSnapshotResponse;
    /**
     * The current managed cluster sku.
     */
    sku?: outputs.containerservice.v20220802preview.ManagedClusterSKUResponse;
}
...
export interface ManagedClusterSecurityProfileDefenderResponse {
     ...
     */
    securityMonitoring?: outputs.containerservice.v20220802preview.ManagedClusterSecurityProfileDefenderSecurityMonitoringResponse;
}
...
export interface ManagedClusterSecurityProfileResponse {
     ...
     */
    azureKeyVaultKms?: outputs.containerservice.v20220802preview.AzureKeyVaultKmsResponse;
    /**
     * Microsoft Defender settings for the security profile.
     */
    defender?: outputs.containerservice.v20220802preview.ManagedClusterSecurityProfileDefenderResponse;
    /**
     * ImageCleaner settings for the security profile.
     */
    imageCleaner?: outputs.containerservice.v20220802preview.ManagedClusterSecurityProfileImageCleanerResponse;
    /**
     ...
     */
    nodeRestriction?: outputs.containerservice.v20220802preview.ManagedClusterSecurityProfileNodeRestrictionResponse;
    /**
     * [Workload Identity](https://azure.github.io/azure-workload-identity/docs/) settings for the security profile.
     */
    workloadIdentity?: outputs.containerservice.v20220802preview.ManagedClusterSecurityProfileWorkloadIdentityResponse;
}
/**
...
export function managedClusterSecurityProfileResponseProvideDefaults(val: ManagedClusterSecurityProfileResponse): ManagedClusterSecurityProfileResponse {
    return {
        ...val,
        azureKeyVaultKms: (val.azureKeyVaultKms ? outputs.containerservice.v20220802preview.azureKeyVaultKmsResponseProvideDefaults(val.azureKeyVaultKms) : undefined),
    };
}
...
export interface ManagedClusterStorageProfileResponse {
     ...
     * AzureBlob CSI Driver settings for the storage profile.
     */
    blobCSIDriver?: outputs.containerservice.v20220802preview.ManagedClusterStorageProfileBlobCSIDriverResponse;
    /**
     * AzureDisk CSI Driver settings for the storage profile.
     */
    diskCSIDriver?: outputs.containerservice.v20220802preview.ManagedClusterStorageProfileDiskCSIDriverResponse;
    /**
     * AzureFile CSI Driver settings for the storage profile.
     */
    fileCSIDriver?: outputs.containerservice.v20220802preview.ManagedClusterStorageProfileFileCSIDriverResponse;
    /**
     * Snapshot Controller settings for the storage profile.
     */
    snapshotController?: outputs.containerservice.v20220802preview.ManagedClusterStorageProfileSnapshotControllerResponse;
}
...
export interface ManagedClusterWindowsProfileResponse {
     ...
     */
    gmsaProfile?: outputs.containerservice.v20220802preview.WindowsGmsaProfileResponse;
    /**
...
export interface ManagedClusterWorkloadAutoScalerProfileResponse {
     ...
     * KEDA (Kubernetes Event-driven Autoscaling) settings for the workload auto-scaler profile.
     */
    keda?: outputs.containerservice.v20220802preview.ManagedClusterWorkloadAutoScalerProfileKedaResponse;
    verticalPodAutoscaler?: outputs.containerservice.v20220802preview.ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponse;
}
/**
...
export function managedClusterWorkloadAutoScalerProfileResponseProvideDefaults(val: ManagedClusterWorkloadAutoScalerProfileResponse): ManagedClusterWorkloadAutoScalerProfileResponse {
    return {
        ...val,
        verticalPodAutoscaler: (val.verticalPodAutoscaler ? outputs.containerservice.v20220802preview.managedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponseProvideDefaults(val.verticalPodAutoscaler) : undefined),
    };
}
