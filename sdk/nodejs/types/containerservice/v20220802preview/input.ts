...
export interface AzureKeyVaultKmsArgs {
     ...
     */
    keyVaultNetworkAccess?: pulumi.Input<string | enums.containerservice.v20220802preview.KeyVaultNetworkAccessTypes>;
    /**
...
export interface ContainerServiceLinuxProfileArgs {
     ...
     */
    ssh: pulumi.Input<inputs.containerservice.v20220802preview.ContainerServiceSshConfigurationArgs>;
}
...
export interface ContainerServiceNetworkProfileArgs {
     ...
     */
    ipFamilies?: pulumi.Input<pulumi.Input<string | enums.containerservice.v20220802preview.IpFamily>[]>;
    /**
     ...
     */
    kubeProxyConfig?: pulumi.Input<inputs.containerservice.v20220802preview.ContainerServiceNetworkProfileKubeProxyConfigArgs>;
    /**
     * Profile of the cluster load balancer.
     */
    loadBalancerProfile?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterLoadBalancerProfileArgs>;
    /**
     * The default is 'standard'. See [Azure Load Balancer SKUs](https://docs.microsoft.com/azure/load-balancer/skus) for more information about the differences between load balancer SKUs.
     */
    loadBalancerSku?: pulumi.Input<string | enums.containerservice.v20220802preview.LoadBalancerSku>;
    /**
     * Profile of the cluster NAT gateway.
     */
    natGatewayProfile?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterNATGatewayProfileArgs>;
    /**
     * This cannot be specified if networkPlugin is anything other than 'azure'.
     */
    networkMode?: pulumi.Input<string | enums.containerservice.v20220802preview.NetworkMode>;
    /**
     * Network plugin used for building the Kubernetes network.
     */
    networkPlugin?: pulumi.Input<string | enums.containerservice.v20220802preview.NetworkPlugin>;
    /**
     * Network plugin mode used for building the Kubernetes network.
     */
    networkPluginMode?: pulumi.Input<string | enums.containerservice.v20220802preview.NetworkPluginMode>;
    /**
     * Network policy used for building the Kubernetes network.
     */
    networkPolicy?: pulumi.Input<string | enums.containerservice.v20220802preview.NetworkPolicy>;
    /**
     * This can only be set at cluster creation time and cannot be changed later. For more information see [egress outbound type](https://docs.microsoft.com/azure/aks/egress-outboundtype).
     */
    outboundType?: pulumi.Input<string | enums.containerservice.v20220802preview.OutboundType>;
    /**
...
export function containerServiceNetworkProfileArgsProvideDefaults(val: ContainerServiceNetworkProfileArgs): ContainerServiceNetworkProfileArgs {
    return {
        ...
        loadBalancerProfile: (val.loadBalancerProfile ? pulumi.output(val.loadBalancerProfile).apply(inputs.containerservice.v20220802preview.managedClusterLoadBalancerProfileArgsProvideDefaults) : undefined),
        natGatewayProfile: (val.natGatewayProfile ? pulumi.output(val.natGatewayProfile).apply(inputs.containerservice.v20220802preview.managedClusterNATGatewayProfileArgsProvideDefaults) : undefined),
...
export interface ContainerServiceNetworkProfileIpvsConfigArgs {
     ...
     */
    scheduler?: pulumi.Input<string | enums.containerservice.v20220802preview.IpvsScheduler>;
    /**
...
export interface ContainerServiceNetworkProfileKubeProxyConfigArgs {
     ...
     * Holds configuration customizations for IPVS. May only be specified if 'mode' is set to 'IPVS'.
     */
    ipvsConfig?: pulumi.Input<inputs.containerservice.v20220802preview.ContainerServiceNetworkProfileIpvsConfigArgs>;
    /**
     * Specify which proxy mode to use ('IPTABLES' or 'IPVS')
     */
    mode?: pulumi.Input<string | enums.containerservice.v20220802preview.Mode>;
}
...
export interface ContainerServiceSshConfigurationArgs {
     ...
     */
    publicKeys: pulumi.Input<pulumi.Input<inputs.containerservice.v20220802preview.ContainerServiceSshPublicKeyArgs>[]>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerservice.v20220802preview.ExtendedLocationTypes>;
}
...
export interface GuardrailsProfileArgs {
     ...
     */
    level: pulumi.Input<string | enums.containerservice.v20220802preview.Level>;
    /**
...
export interface LinuxOSConfigArgs {
     ...
     */
    sysctls?: pulumi.Input<inputs.containerservice.v20220802preview.SysctlConfigArgs>;
    /**
...
export interface ManagedClusterAutoUpgradeProfileArgs {
     ...
     */
    upgradeChannel?: pulumi.Input<string | enums.containerservice.v20220802preview.UpgradeChannel>;
}
...
export interface ManagedClusterAzureMonitorProfileArgs {
     ...
     */
    metrics?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterAzureMonitorProfileMetricsArgs>;
}
...
export interface ManagedClusterAzureMonitorProfileMetricsArgs {
     ...
     * Kube State Metrics for prometheus addon profile for the container service cluster
     */
    kubeStateMetrics?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterAzureMonitorProfileKubeStateMetricsArgs>;
}
...
export interface ManagedClusterIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.containerservice.v20220802preview.ResourceIdentityType>;
    /**
...
export interface ManagedClusterIngressProfileArgs {
     ...
     */
    webAppRouting?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterIngressProfileWebAppRoutingArgs>;
}
...
export interface ManagedClusterLoadBalancerProfileArgs {
     ...
     */
    backendPoolType?: pulumi.Input<string | enums.containerservice.v20220802preview.BackendPoolType>;
    /**
     * The effective outbound IP resources of the cluster load balancer.
     */
    effectiveOutboundIPs?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220802preview.ResourceReferenceArgs>[]>;
    /**
     ...
     */
    managedOutboundIPs?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs>;
    /**
     * Desired outbound IP Prefix resources for the cluster load balancer.
     */
    outboundIPPrefixes?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs>;
    /**
     * Desired outbound IP resources for the cluster load balancer.
     */
    outboundIPs?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterLoadBalancerProfileOutboundIPsArgs>;
}
/**
...
export function managedClusterLoadBalancerProfileArgsProvideDefaults(val: ManagedClusterLoadBalancerProfileArgs): ManagedClusterLoadBalancerProfileArgs {
    return {
        ...
        managedOutboundIPs: (val.managedOutboundIPs ? pulumi.output(val.managedOutboundIPs).apply(inputs.containerservice.v20220802preview.managedClusterLoadBalancerProfileManagedOutboundIPsArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs {
     ...
     */
    publicIPPrefixes?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220802preview.ResourceReferenceArgs>[]>;
}
...
export interface ManagedClusterLoadBalancerProfileOutboundIPsArgs {
     ...
     */
    publicIPs?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220802preview.ResourceReferenceArgs>[]>;
}
...
export interface ManagedClusterNATGatewayProfileArgs {
     ...
     */
    managedOutboundIPProfile?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterManagedOutboundIPProfileArgs>;
}
/**
...
export function managedClusterNATGatewayProfileArgsProvideDefaults(val: ManagedClusterNATGatewayProfileArgs): ManagedClusterNATGatewayProfileArgs {
    return {
        ...
        managedOutboundIPProfile: (val.managedOutboundIPProfile ? pulumi.output(val.managedOutboundIPProfile).apply(inputs.containerservice.v20220802preview.managedClusterManagedOutboundIPProfileArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterPodIdentityArgs {
     ...
     */
    identity: pulumi.Input<inputs.containerservice.v20220802preview.UserAssignedIdentityArgs>;
    /**
...
export interface ManagedClusterPodIdentityProfileArgs {
     ...
     */
    userAssignedIdentities?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterPodIdentityArgs>[]>;
    /**
     * The pod identity exceptions to allow.
     */
    userAssignedIdentityExceptions?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterPodIdentityExceptionArgs>[]>;
}
...
export interface ManagedClusterPropertiesAutoScalerProfileArgs {
     ...
     */
    expander?: pulumi.Input<string | enums.containerservice.v20220802preview.Expander>;
    /**
     * The default is 10.
     */
...
export interface ManagedClusterSKUArgs {
     ...
     */
    name?: pulumi.Input<string | enums.containerservice.v20220802preview.ManagedClusterSKUName>;
    /**
     * If not specified, the default is 'Free'. See [uptime SLA](https://docs.microsoft.com/azure/aks/uptime-sla) for more details.
     */
    tier?: pulumi.Input<string | enums.containerservice.v20220802preview.ManagedClusterSKUTier>;
}
...
export interface ManagedClusterSecurityProfileArgs {
     ...
     */
    azureKeyVaultKms?: pulumi.Input<inputs.containerservice.v20220802preview.AzureKeyVaultKmsArgs>;
    /**
     * Microsoft Defender settings for the security profile.
     */
    defender?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterSecurityProfileDefenderArgs>;
    /**
     * ImageCleaner settings for the security profile.
     */
    imageCleaner?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterSecurityProfileImageCleanerArgs>;
    /**
     ...
     */
    nodeRestriction?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterSecurityProfileNodeRestrictionArgs>;
    /**
     * [Workload Identity](https://azure.github.io/azure-workload-identity/docs/) settings for the security profile.
     */
    workloadIdentity?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterSecurityProfileWorkloadIdentityArgs>;
}
/**
...
export function managedClusterSecurityProfileArgsProvideDefaults(val: ManagedClusterSecurityProfileArgs): ManagedClusterSecurityProfileArgs {
    return {
        ...val,
        azureKeyVaultKms: (val.azureKeyVaultKms ? pulumi.output(val.azureKeyVaultKms).apply(inputs.containerservice.v20220802preview.azureKeyVaultKmsArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterSecurityProfileDefenderArgs {
     ...
     */
    securityMonitoring?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterSecurityProfileDefenderSecurityMonitoringArgs>;
}
...
export interface ManagedClusterStorageProfileArgs {
     ...
     */
    blobCSIDriver?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterStorageProfileBlobCSIDriverArgs>;
    /**
     * AzureDisk CSI Driver settings for the storage profile.
     */
    diskCSIDriver?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterStorageProfileDiskCSIDriverArgs>;
    /**
     * AzureFile CSI Driver settings for the storage profile.
     */
    fileCSIDriver?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterStorageProfileFileCSIDriverArgs>;
    /**
     * Snapshot Controller settings for the storage profile.
     */
    snapshotController?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterStorageProfileSnapshotControllerArgs>;
}
...
export interface ManagedClusterWindowsProfileArgs {
     ...
     */
    gmsaProfile?: pulumi.Input<inputs.containerservice.v20220802preview.WindowsGmsaProfileArgs>;
    /**
     * The license type to use for Windows VMs. See [Azure Hybrid User Benefits](https://azure.microsoft.com/pricing/hybrid-benefit/faq/) for more details.
     */
    licenseType?: pulumi.Input<string | enums.containerservice.v20220802preview.LicenseType>;
}
...
export interface ManagedClusterWorkloadAutoScalerProfileArgs {
     ...
     */
    keda?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterWorkloadAutoScalerProfileKedaArgs>;
    verticalPodAutoscaler?: pulumi.Input<inputs.containerservice.v20220802preview.ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerArgs>;
}
/**
...
export function managedClusterWorkloadAutoScalerProfileArgsProvideDefaults(val: ManagedClusterWorkloadAutoScalerProfileArgs): ManagedClusterWorkloadAutoScalerProfileArgs {
    return {
        ...val,
        verticalPodAutoscaler: (val.verticalPodAutoscaler ? pulumi.output(val.verticalPodAutoscaler).apply(inputs.containerservice.v20220802preview.managedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerArgs {
     ...
     */
    controlledValues: pulumi.Input<string | enums.containerservice.v20220802preview.ControlledValues>;
    /**
     ...
     */
    updateMode: pulumi.Input<string | enums.containerservice.v20220802preview.UpdateMode>;
}
/**
...
export interface PowerStateArgs {
     ...
     */
    code?: pulumi.Input<string | enums.containerservice.v20220802preview.Code>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.containerservice.v20220802preview.ConnectionStatus>;
}
...
export interface TimeInWeekArgs {
     ...
     * The day of the week.
     */
    day?: pulumi.Input<string | enums.containerservice.v20220802preview.WeekDay>;
    /**
