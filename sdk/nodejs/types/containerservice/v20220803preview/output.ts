...
export interface AgentPoolNetworkProfileResponse {
     ...
     */
    nodePublicIPTags?: outputs.containerservice.v20220803preview.IPTagResponse[];
}
...
export interface ContainerServiceLinuxProfileResponse {
     ...
     */
    ssh: outputs.containerservice.v20220803preview.ContainerServiceSshConfigurationResponse;
}
...
export interface ContainerServiceNetworkProfileResponse {
     ...
     */
    kubeProxyConfig?: outputs.containerservice.v20220803preview.ContainerServiceNetworkProfileResponseKubeProxyConfig;
    /**
     * Profile of the cluster load balancer.
     */
    loadBalancerProfile?: outputs.containerservice.v20220803preview.ManagedClusterLoadBalancerProfileResponse;
    /**
     ...
     */
    natGatewayProfile?: outputs.containerservice.v20220803preview.ManagedClusterNATGatewayProfileResponse;
    /**
...
export function containerServiceNetworkProfileResponseProvideDefaults(val: ContainerServiceNetworkProfileResponse): ContainerServiceNetworkProfileResponse {
    return {
        ...
        loadBalancerProfile: (val.loadBalancerProfile ? outputs.containerservice.v20220803preview.managedClusterLoadBalancerProfileResponseProvideDefaults(val.loadBalancerProfile) : undefined),
        natGatewayProfile: (val.natGatewayProfile ? outputs.containerservice.v20220803preview.managedClusterNATGatewayProfileResponseProvideDefaults(val.natGatewayProfile) : undefined),
...
export interface ContainerServiceNetworkProfileResponseKubeProxyConfig {
     ...
     * Holds configuration customizations for IPVS. May only be specified if 'mode' is set to 'IPVS'.
     */
    ipvsConfig?: outputs.containerservice.v20220803preview.ContainerServiceNetworkProfileResponseIpvsConfig;
    /**
...
export interface ContainerServiceSshConfigurationResponse {
     ...
     */
    publicKeys: outputs.containerservice.v20220803preview.ContainerServiceSshPublicKeyResponse[];
}
...
export interface LinuxOSConfigResponse {
     ...
     */
    sysctls?: outputs.containerservice.v20220803preview.SysctlConfigResponse;
    /**
...
export interface ManagedClusterAddonProfileResponse {
     ...
     */
    identity: outputs.containerservice.v20220803preview.ManagedClusterAddonProfileResponseIdentity;
}
...
export interface ManagedClusterAgentPoolProfileResponse {
     ...
     */
    creationData?: outputs.containerservice.v20220803preview.CreationDataResponse;
    /**
     ...
     */
    kubeletConfig?: outputs.containerservice.v20220803preview.KubeletConfigResponse;
    /**
     ...
     */
    linuxOSConfig?: outputs.containerservice.v20220803preview.LinuxOSConfigResponse;
    /**
     ...
     */
    networkProfile?: outputs.containerservice.v20220803preview.AgentPoolNetworkProfileResponse;
    /**
     ...
     */
    powerState?: outputs.containerservice.v20220803preview.PowerStateResponse;
    /**
     ...
     */
    upgradeSettings?: outputs.containerservice.v20220803preview.AgentPoolUpgradeSettingsResponse;
    /**
     ...
     * The Windows agent pool's specific profile.
     */
    windowsProfile?: outputs.containerservice.v20220803preview.AgentPoolWindowsProfileResponse;
    /**
...
export interface ManagedClusterAzureMonitorProfileMetricsResponse {
     ...
     * Kube State Metrics for prometheus addon profile for the container service cluster
     */
    kubeStateMetrics?: outputs.containerservice.v20220803preview.ManagedClusterAzureMonitorProfileKubeStateMetricsResponse;
}
...
export interface ManagedClusterAzureMonitorProfileResponse {
     ...
     * Metrics profile for the prometheus service addon
     */
    metrics?: outputs.containerservice.v20220803preview.ManagedClusterAzureMonitorProfileMetricsResponse;
}
...
export interface ManagedClusterIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.containerservice.v20220803preview.ManagedClusterIdentityResponseUserAssignedIdentities};
}
...
export interface ManagedClusterIngressProfileResponse {
     ...
     */
    webAppRouting?: outputs.containerservice.v20220803preview.ManagedClusterIngressProfileWebAppRoutingResponse;
}
...
export interface ManagedClusterLoadBalancerProfileResponse {
     ...
     */
    effectiveOutboundIPs?: outputs.containerservice.v20220803preview.ResourceReferenceResponse[];
    /**
     ...
     */
    managedOutboundIPs?: outputs.containerservice.v20220803preview.ManagedClusterLoadBalancerProfileResponseManagedOutboundIPs;
    /**
     * Desired outbound IP Prefix resources for the cluster load balancer.
     */
    outboundIPPrefixes?: outputs.containerservice.v20220803preview.ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixes;
    /**
     * Desired outbound IP resources for the cluster load balancer.
     */
    outboundIPs?: outputs.containerservice.v20220803preview.ManagedClusterLoadBalancerProfileResponseOutboundIPs;
}
/**
...
export function managedClusterLoadBalancerProfileResponseProvideDefaults(val: ManagedClusterLoadBalancerProfileResponse): ManagedClusterLoadBalancerProfileResponse {
    return {
        ...
        managedOutboundIPs: (val.managedOutboundIPs ? outputs.containerservice.v20220803preview.managedClusterLoadBalancerProfileResponseManagedOutboundIPsProvideDefaults(val.managedOutboundIPs) : undefined),
    };
}
...
export interface ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixes {
     ...
     */
    publicIPPrefixes?: outputs.containerservice.v20220803preview.ResourceReferenceResponse[];
}
...
export interface ManagedClusterLoadBalancerProfileResponseOutboundIPs {
     ...
     */
    publicIPs?: outputs.containerservice.v20220803preview.ResourceReferenceResponse[];
}
...
export interface ManagedClusterNATGatewayProfileResponse {
     ...
     */
    managedOutboundIPProfile?: outputs.containerservice.v20220803preview.ManagedClusterManagedOutboundIPProfileResponse;
}
/**
...
export function managedClusterNATGatewayProfileResponseProvideDefaults(val: ManagedClusterNATGatewayProfileResponse): ManagedClusterNATGatewayProfileResponse {
    return {
        ...
        managedOutboundIPProfile: (val.managedOutboundIPProfile ? outputs.containerservice.v20220803preview.managedClusterManagedOutboundIPProfileResponseProvideDefaults(val.managedOutboundIPProfile) : undefined),
    };
}
...
export interface ManagedClusterPodIdentityProfileResponse {
     ...
     */
    userAssignedIdentities?: outputs.containerservice.v20220803preview.ManagedClusterPodIdentityResponse[];
    /**
     * The pod identity exceptions to allow.
     */
    userAssignedIdentityExceptions?: outputs.containerservice.v20220803preview.ManagedClusterPodIdentityExceptionResponse[];
}
...
export interface ManagedClusterPodIdentityProvisioningErrorBodyResponse {
     ...
     */
    details?: outputs.containerservice.v20220803preview.ManagedClusterPodIdentityProvisioningErrorBodyResponse[];
    /**
...
export interface ManagedClusterPodIdentityProvisioningErrorResponse {
     ...
     */
    error?: outputs.containerservice.v20220803preview.ManagedClusterPodIdentityProvisioningErrorBodyResponse;
}
...
export interface ManagedClusterPodIdentityResponse {
     ...
     */
    identity: outputs.containerservice.v20220803preview.UserAssignedIdentityResponse;
    /**
     ...
     */
    namespace: string;
    provisioningInfo: outputs.containerservice.v20220803preview.ManagedClusterPodIdentityResponseProvisioningInfo;
    /**
...
export interface ManagedClusterPodIdentityResponseProvisioningInfo {
     ...
     */
    error?: outputs.containerservice.v20220803preview.ManagedClusterPodIdentityProvisioningErrorResponse;
}
...
export interface ManagedClusterPropertiesForSnapshotResponse {
     ...
     */
    networkProfile: outputs.containerservice.v20220803preview.NetworkProfileForSnapshotResponse;
    /**
     * The current managed cluster sku.
     */
    sku?: outputs.containerservice.v20220803preview.ManagedClusterSKUResponse;
}
...
export interface ManagedClusterSecurityProfileDefenderResponse {
     ...
     */
    securityMonitoring?: outputs.containerservice.v20220803preview.ManagedClusterSecurityProfileDefenderSecurityMonitoringResponse;
}
...
export interface ManagedClusterSecurityProfileResponse {
     ...
     */
    azureKeyVaultKms?: outputs.containerservice.v20220803preview.AzureKeyVaultKmsResponse;
    /**
     * Microsoft Defender settings for the security profile.
     */
    defender?: outputs.containerservice.v20220803preview.ManagedClusterSecurityProfileDefenderResponse;
    /**
     * ImageCleaner settings for the security profile.
     */
    imageCleaner?: outputs.containerservice.v20220803preview.ManagedClusterSecurityProfileImageCleanerResponse;
    /**
     ...
     */
    nodeRestriction?: outputs.containerservice.v20220803preview.ManagedClusterSecurityProfileNodeRestrictionResponse;
    /**
     * [Workload Identity](https://azure.github.io/azure-workload-identity/docs/) settings for the security profile.
     */
    workloadIdentity?: outputs.containerservice.v20220803preview.ManagedClusterSecurityProfileWorkloadIdentityResponse;
}
/**
...
export function managedClusterSecurityProfileResponseProvideDefaults(val: ManagedClusterSecurityProfileResponse): ManagedClusterSecurityProfileResponse {
    return {
        ...val,
        azureKeyVaultKms: (val.azureKeyVaultKms ? outputs.containerservice.v20220803preview.azureKeyVaultKmsResponseProvideDefaults(val.azureKeyVaultKms) : undefined),
    };
}
...
export interface ManagedClusterStorageProfileResponse {
     ...
     * AzureBlob CSI Driver settings for the storage profile.
     */
    blobCSIDriver?: outputs.containerservice.v20220803preview.ManagedClusterStorageProfileBlobCSIDriverResponse;
    /**
     * AzureDisk CSI Driver settings for the storage profile.
     */
    diskCSIDriver?: outputs.containerservice.v20220803preview.ManagedClusterStorageProfileDiskCSIDriverResponse;
    /**
     * AzureFile CSI Driver settings for the storage profile.
     */
    fileCSIDriver?: outputs.containerservice.v20220803preview.ManagedClusterStorageProfileFileCSIDriverResponse;
    /**
     * Snapshot Controller settings for the storage profile.
     */
    snapshotController?: outputs.containerservice.v20220803preview.ManagedClusterStorageProfileSnapshotControllerResponse;
}
...
export interface ManagedClusterWindowsProfileResponse {
     ...
     */
    gmsaProfile?: outputs.containerservice.v20220803preview.WindowsGmsaProfileResponse;
    /**
...
export interface ManagedClusterWorkloadAutoScalerProfileResponse {
     ...
     * KEDA (Kubernetes Event-driven Autoscaling) settings for the workload auto-scaler profile.
     */
    keda?: outputs.containerservice.v20220803preview.ManagedClusterWorkloadAutoScalerProfileKedaResponse;
    verticalPodAutoscaler?: outputs.containerservice.v20220803preview.ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponse;
}
/**
...
export function managedClusterWorkloadAutoScalerProfileResponseProvideDefaults(val: ManagedClusterWorkloadAutoScalerProfileResponse): ManagedClusterWorkloadAutoScalerProfileResponse {
    return {
        ...val,
        verticalPodAutoscaler: (val.verticalPodAutoscaler ? outputs.containerservice.v20220803preview.managedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponseProvideDefaults(val.verticalPodAutoscaler) : undefined),
    };
}
