...
export interface ContainerServiceLinuxProfileResponse {
     ...
     */
    ssh: outputs.containerservice.v20190801.ContainerServiceSshConfigurationResponse;
}
...
export interface ContainerServiceNetworkProfileResponse {
     ...
     */
    loadBalancerProfile?: outputs.containerservice.v20190801.ManagedClusterLoadBalancerProfileResponse;
    /**
...
export function containerServiceNetworkProfileResponseProvideDefaults(val: ContainerServiceNetworkProfileResponse): ContainerServiceNetworkProfileResponse {
    return {
        ...
        loadBalancerProfile: (val.loadBalancerProfile ? outputs.containerservice.v20190801.managedClusterLoadBalancerProfileResponseProvideDefaults(val.loadBalancerProfile) : undefined),
...
export interface ContainerServiceSshConfigurationResponse {
     ...
     */
    publicKeys: outputs.containerservice.v20190801.ContainerServiceSshPublicKeyResponse[];
}
...
export interface ManagedClusterLoadBalancerProfileResponse {
     ...
     */
    effectiveOutboundIPs?: outputs.containerservice.v20190801.ResourceReferenceResponse[];
    /**
     * Desired managed outbound IPs for the cluster load balancer.
     */
    managedOutboundIPs?: outputs.containerservice.v20190801.ManagedClusterLoadBalancerProfileResponseManagedOutboundIPs;
    /**
     * Desired outbound IP Prefix resources for the cluster load balancer.
     */
    outboundIPPrefixes?: outputs.containerservice.v20190801.ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixes;
    /**
     * Desired outbound IP resources for the cluster load balancer.
     */
    outboundIPs?: outputs.containerservice.v20190801.ManagedClusterLoadBalancerProfileResponseOutboundIPs;
}
/**
...
export function managedClusterLoadBalancerProfileResponseProvideDefaults(val: ManagedClusterLoadBalancerProfileResponse): ManagedClusterLoadBalancerProfileResponse {
    return {
        ...val,
        managedOutboundIPs: (val.managedOutboundIPs ? outputs.containerservice.v20190801.managedClusterLoadBalancerProfileResponseManagedOutboundIPsProvideDefaults(val.managedOutboundIPs) : undefined),
    };
}
...
export interface ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixes {
     ...
     */
    publicIPPrefixes?: outputs.containerservice.v20190801.ResourceReferenceResponse[];
}
...
export interface ManagedClusterLoadBalancerProfileResponseOutboundIPs {
     ...
     */
    publicIPs?: outputs.containerservice.v20190801.ResourceReferenceResponse[];
}
