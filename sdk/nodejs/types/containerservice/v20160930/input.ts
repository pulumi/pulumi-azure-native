...
export interface ContainerServiceAgentPoolProfileArgs {
     ...
     * Size of agent VMs.
     */
    vmSize: pulumi.Input<string | enums.containerservice.v20160930.ContainerServiceVMSizeTypes>;
}
/**
 ...
 */
export interface ContainerServiceCustomProfileArgs {
    /**
...
export interface ContainerServiceDiagnosticsProfileArgs {
     ...
     */
    vmDiagnostics: pulumi.Input<inputs.containerservice.v20160930.ContainerServiceVMDiagnosticsArgs>;
}
...
export interface ContainerServiceLinuxProfileArgs {
     ...
     */
    ssh: pulumi.Input<inputs.containerservice.v20160930.ContainerServiceSshConfigurationArgs>;
}
...
export interface ContainerServiceOrchestratorProfileArgs {
     ...
     */
    orchestratorType: pulumi.Input<enums.containerservice.v20160930.ContainerServiceOchestratorTypes>;
}
...
export interface ContainerServiceSshConfigurationArgs {
     ...
     */
    publicKeys: pulumi.Input<pulumi.Input<inputs.containerservice.v20160930.ContainerServiceSshPublicKeyArgs>[]>;
}
