...
export interface ContainerServiceLinuxProfileResponse {
     ...
     */
    ssh: outputs.containerservice.v20220602preview.ContainerServiceSshConfigurationResponse;
}
...
export interface ContainerServiceNetworkProfileResponse {
     ...
     */
    loadBalancerProfile?: outputs.containerservice.v20220602preview.ManagedClusterLoadBalancerProfileResponse;
    /**
     ...
     */
    natGatewayProfile?: outputs.containerservice.v20220602preview.ManagedClusterNATGatewayProfileResponse;
    /**
...
export function containerServiceNetworkProfileResponseProvideDefaults(val: ContainerServiceNetworkProfileResponse): ContainerServiceNetworkProfileResponse {
    return {
        ...
        loadBalancerProfile: (val.loadBalancerProfile ? outputs.containerservice.v20220602preview.managedClusterLoadBalancerProfileResponseProvideDefaults(val.loadBalancerProfile) : undefined),
        natGatewayProfile: (val.natGatewayProfile ? outputs.containerservice.v20220602preview.managedClusterNATGatewayProfileResponseProvideDefaults(val.natGatewayProfile) : undefined),
...
export interface ContainerServiceSshConfigurationResponse {
     ...
     */
    publicKeys: outputs.containerservice.v20220602preview.ContainerServiceSshPublicKeyResponse[];
}
...
export interface LinuxOSConfigResponse {
     ...
     */
    sysctls?: outputs.containerservice.v20220602preview.SysctlConfigResponse;
    /**
...
export interface ManagedClusterAddonProfileResponse {
     ...
     */
    identity: outputs.containerservice.v20220602preview.ManagedClusterAddonProfileResponseIdentity;
}
...
export interface ManagedClusterAgentPoolProfileResponse {
     ...
     */
    creationData?: outputs.containerservice.v20220602preview.CreationDataResponse;
    /**
     ...
     */
    kubeletConfig?: outputs.containerservice.v20220602preview.KubeletConfigResponse;
    /**
     ...
     */
    linuxOSConfig?: outputs.containerservice.v20220602preview.LinuxOSConfigResponse;
    /**
     ...
     */
    powerState?: outputs.containerservice.v20220602preview.PowerStateResponse;
    /**
     ...
     */
    upgradeSettings?: outputs.containerservice.v20220602preview.AgentPoolUpgradeSettingsResponse;
    /**
...
export interface ManagedClusterIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.containerservice.v20220602preview.ManagedClusterIdentityResponseUserAssignedIdentities};
}
...
export interface ManagedClusterIngressProfileResponse {
     ...
     */
    webAppRouting?: outputs.containerservice.v20220602preview.ManagedClusterIngressProfileWebAppRoutingResponse;
}
...
export interface ManagedClusterLoadBalancerProfileResponse {
     ...
     */
    effectiveOutboundIPs?: outputs.containerservice.v20220602preview.ResourceReferenceResponse[];
    /**
     ...
     */
    managedOutboundIPs?: outputs.containerservice.v20220602preview.ManagedClusterLoadBalancerProfileResponseManagedOutboundIPs;
    /**
     * Desired outbound IP Prefix resources for the cluster load balancer.
     */
    outboundIPPrefixes?: outputs.containerservice.v20220602preview.ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixes;
    /**
     * Desired outbound IP resources for the cluster load balancer.
     */
    outboundIPs?: outputs.containerservice.v20220602preview.ManagedClusterLoadBalancerProfileResponseOutboundIPs;
}
/**
...
export function managedClusterLoadBalancerProfileResponseProvideDefaults(val: ManagedClusterLoadBalancerProfileResponse): ManagedClusterLoadBalancerProfileResponse {
    return {
        ...
        managedOutboundIPs: (val.managedOutboundIPs ? outputs.containerservice.v20220602preview.managedClusterLoadBalancerProfileResponseManagedOutboundIPsProvideDefaults(val.managedOutboundIPs) : undefined),
    };
}
...
export interface ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixes {
     ...
     */
    publicIPPrefixes?: outputs.containerservice.v20220602preview.ResourceReferenceResponse[];
}
...
export interface ManagedClusterLoadBalancerProfileResponseOutboundIPs {
     ...
     */
    publicIPs?: outputs.containerservice.v20220602preview.ResourceReferenceResponse[];
}
...
export interface ManagedClusterNATGatewayProfileResponse {
     ...
     */
    managedOutboundIPProfile?: outputs.containerservice.v20220602preview.ManagedClusterManagedOutboundIPProfileResponse;
}
/**
...
export function managedClusterNATGatewayProfileResponseProvideDefaults(val: ManagedClusterNATGatewayProfileResponse): ManagedClusterNATGatewayProfileResponse {
    return {
        ...
        managedOutboundIPProfile: (val.managedOutboundIPProfile ? outputs.containerservice.v20220602preview.managedClusterManagedOutboundIPProfileResponseProvideDefaults(val.managedOutboundIPProfile) : undefined),
    };
}
...
export interface ManagedClusterPodIdentityProfileResponse {
     ...
     */
    userAssignedIdentities?: outputs.containerservice.v20220602preview.ManagedClusterPodIdentityResponse[];
    /**
     * The pod identity exceptions to allow.
     */
    userAssignedIdentityExceptions?: outputs.containerservice.v20220602preview.ManagedClusterPodIdentityExceptionResponse[];
}
...
export interface ManagedClusterPodIdentityProvisioningErrorBodyResponse {
     ...
     */
    details?: outputs.containerservice.v20220602preview.ManagedClusterPodIdentityProvisioningErrorBodyResponse[];
    /**
...
export interface ManagedClusterPodIdentityProvisioningErrorResponse {
     ...
     */
    error?: outputs.containerservice.v20220602preview.ManagedClusterPodIdentityProvisioningErrorBodyResponse;
}
...
export interface ManagedClusterPodIdentityResponse {
     ...
     */
    identity: outputs.containerservice.v20220602preview.UserAssignedIdentityResponse;
    /**
     ...
     */
    namespace: string;
    provisioningInfo: outputs.containerservice.v20220602preview.ManagedClusterPodIdentityResponseProvisioningInfo;
    /**
...
export interface ManagedClusterPodIdentityResponseProvisioningInfo {
     ...
     */
    error?: outputs.containerservice.v20220602preview.ManagedClusterPodIdentityProvisioningErrorResponse;
}
...
export interface ManagedClusterPropertiesForSnapshotResponse {
     ...
     */
    networkProfile: outputs.containerservice.v20220602preview.NetworkProfileForSnapshotResponse;
    /**
     * The current managed cluster sku.
     */
    sku?: outputs.containerservice.v20220602preview.ManagedClusterSKUResponse;
}
...
export interface ManagedClusterSecurityProfileDefenderResponse {
     ...
     */
    securityMonitoring?: outputs.containerservice.v20220602preview.ManagedClusterSecurityProfileDefenderSecurityMonitoringResponse;
}
...
export interface ManagedClusterSecurityProfileResponse {
     ...
     */
    azureKeyVaultKms?: outputs.containerservice.v20220602preview.AzureKeyVaultKmsResponse;
    /**
     * Microsoft Defender settings for the security profile.
     */
    defender?: outputs.containerservice.v20220602preview.ManagedClusterSecurityProfileDefenderResponse;
    /**
     ...
     */
    nodeRestriction?: outputs.containerservice.v20220602preview.ManagedClusterSecurityProfileNodeRestrictionResponse;
    /**
     * [Workload Identity](https://azure.github.io/azure-workload-identity/docs/) settings for the security profile.
     */
    workloadIdentity?: outputs.containerservice.v20220602preview.ManagedClusterSecurityProfileWorkloadIdentityResponse;
}
/**
...
export function managedClusterSecurityProfileResponseProvideDefaults(val: ManagedClusterSecurityProfileResponse): ManagedClusterSecurityProfileResponse {
    return {
        ...val,
        azureKeyVaultKms: (val.azureKeyVaultKms ? outputs.containerservice.v20220602preview.azureKeyVaultKmsResponseProvideDefaults(val.azureKeyVaultKms) : undefined),
    };
}
...
export interface ManagedClusterStorageProfileResponse {
     ...
     * AzureBlob CSI Driver settings for the storage profile.
     */
    blobCSIDriver?: outputs.containerservice.v20220602preview.ManagedClusterStorageProfileBlobCSIDriverResponse;
    /**
     * AzureDisk CSI Driver settings for the storage profile.
     */
    diskCSIDriver?: outputs.containerservice.v20220602preview.ManagedClusterStorageProfileDiskCSIDriverResponse;
    /**
     * AzureFile CSI Driver settings for the storage profile.
     */
    fileCSIDriver?: outputs.containerservice.v20220602preview.ManagedClusterStorageProfileFileCSIDriverResponse;
    /**
     * Snapshot Controller settings for the storage profile.
     */
    snapshotController?: outputs.containerservice.v20220602preview.ManagedClusterStorageProfileSnapshotControllerResponse;
}
...
export interface ManagedClusterWindowsProfileResponse {
     ...
     */
    gmsaProfile?: outputs.containerservice.v20220602preview.WindowsGmsaProfileResponse;
    /**
...
export interface ManagedClusterWorkloadAutoScalerProfileResponse {
     ...
     * KEDA (Kubernetes Event-driven Autoscaling) settings for the workload auto-scaler profile.
     */
    keda?: outputs.containerservice.v20220602preview.ManagedClusterWorkloadAutoScalerProfileKedaResponse;
}
