...
export interface ContainerServiceLinuxProfileArgs {
     ...
     */
    ssh: pulumi.Input<inputs.containerservice.v20220201.ContainerServiceSshConfigurationArgs>;
}
...
export interface ContainerServiceNetworkProfileArgs {
     ...
     */
    ipFamilies?: pulumi.Input<pulumi.Input<string | enums.containerservice.v20220201.IpFamily>[]>;
    /**
     * Profile of the cluster load balancer.
     */
    loadBalancerProfile?: pulumi.Input<inputs.containerservice.v20220201.ManagedClusterLoadBalancerProfileArgs>;
    /**
     * The default is 'standard'. See [Azure Load Balancer SKUs](https://docs.microsoft.com/azure/load-balancer/skus) for more information about the differences between load balancer SKUs.
     */
    loadBalancerSku?: pulumi.Input<string | enums.containerservice.v20220201.LoadBalancerSku>;
    /**
     * Profile of the cluster NAT gateway.
     */
    natGatewayProfile?: pulumi.Input<inputs.containerservice.v20220201.ManagedClusterNATGatewayProfileArgs>;
    /**
     * This cannot be specified if networkPlugin is anything other than 'azure'.
     */
    networkMode?: pulumi.Input<string | enums.containerservice.v20220201.NetworkMode>;
    /**
     * Network plugin used for building the Kubernetes network.
     */
    networkPlugin?: pulumi.Input<string | enums.containerservice.v20220201.NetworkPlugin>;
    /**
     * Network policy used for building the Kubernetes network.
     */
    networkPolicy?: pulumi.Input<string | enums.containerservice.v20220201.NetworkPolicy>;
    /**
     * This can only be set at cluster creation time and cannot be changed later. For more information see [egress outbound type](https://docs.microsoft.com/azure/aks/egress-outboundtype).
     */
    outboundType?: pulumi.Input<string | enums.containerservice.v20220201.OutboundType>;
    /**
...
export function containerServiceNetworkProfileArgsProvideDefaults(val: ContainerServiceNetworkProfileArgs): ContainerServiceNetworkProfileArgs {
    return {
        ...
        loadBalancerProfile: (val.loadBalancerProfile ? pulumi.output(val.loadBalancerProfile).apply(inputs.containerservice.v20220201.managedClusterLoadBalancerProfileArgsProvideDefaults) : undefined),
        natGatewayProfile: (val.natGatewayProfile ? pulumi.output(val.natGatewayProfile).apply(inputs.containerservice.v20220201.managedClusterNATGatewayProfileArgsProvideDefaults) : undefined),
...
export interface ContainerServiceSshConfigurationArgs {
     ...
     */
    publicKeys: pulumi.Input<pulumi.Input<inputs.containerservice.v20220201.ContainerServiceSshPublicKeyArgs>[]>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerservice.v20220201.ExtendedLocationTypes>;
}
...
export interface LinuxOSConfigArgs {
     ...
     */
    sysctls?: pulumi.Input<inputs.containerservice.v20220201.SysctlConfigArgs>;
    /**
...
export interface ManagedClusterAutoUpgradeProfileArgs {
     ...
     */
    upgradeChannel?: pulumi.Input<string | enums.containerservice.v20220201.UpgradeChannel>;
}
...
export interface ManagedClusterIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.containerservice.v20220201.ResourceIdentityType>;
    /**
...
export interface ManagedClusterLoadBalancerProfileArgs {
     ...
     */
    effectiveOutboundIPs?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220201.ResourceReferenceArgs>[]>;
    /**
     ...
     */
    managedOutboundIPs?: pulumi.Input<inputs.containerservice.v20220201.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs>;
    /**
     * Desired outbound IP Prefix resources for the cluster load balancer.
     */
    outboundIPPrefixes?: pulumi.Input<inputs.containerservice.v20220201.ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs>;
    /**
     * Desired outbound IP resources for the cluster load balancer.
     */
    outboundIPs?: pulumi.Input<inputs.containerservice.v20220201.ManagedClusterLoadBalancerProfileOutboundIPsArgs>;
}
/**
...
export function managedClusterLoadBalancerProfileArgsProvideDefaults(val: ManagedClusterLoadBalancerProfileArgs): ManagedClusterLoadBalancerProfileArgs {
    return {
        ...
        managedOutboundIPs: (val.managedOutboundIPs ? pulumi.output(val.managedOutboundIPs).apply(inputs.containerservice.v20220201.managedClusterLoadBalancerProfileManagedOutboundIPsArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs {
     ...
     */
    publicIPPrefixes?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220201.ResourceReferenceArgs>[]>;
}
...
export interface ManagedClusterLoadBalancerProfileOutboundIPsArgs {
     ...
     */
    publicIPs?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220201.ResourceReferenceArgs>[]>;
}
...
export interface ManagedClusterNATGatewayProfileArgs {
     ...
     */
    managedOutboundIPProfile?: pulumi.Input<inputs.containerservice.v20220201.ManagedClusterManagedOutboundIPProfileArgs>;
}
/**
...
export function managedClusterNATGatewayProfileArgsProvideDefaults(val: ManagedClusterNATGatewayProfileArgs): ManagedClusterNATGatewayProfileArgs {
    return {
        ...
        managedOutboundIPProfile: (val.managedOutboundIPProfile ? pulumi.output(val.managedOutboundIPProfile).apply(inputs.containerservice.v20220201.managedClusterManagedOutboundIPProfileArgsProvideDefaults) : undefined),
    };
}
...
export interface ManagedClusterPodIdentityArgs {
     ...
     */
    identity: pulumi.Input<inputs.containerservice.v20220201.UserAssignedIdentityArgs>;
    /**
...
export interface ManagedClusterPodIdentityProfileArgs {
     ...
     */
    userAssignedIdentities?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220201.ManagedClusterPodIdentityArgs>[]>;
    /**
     * The pod identity exceptions to allow.
     */
    userAssignedIdentityExceptions?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220201.ManagedClusterPodIdentityExceptionArgs>[]>;
}
...
export interface ManagedClusterPropertiesAutoScalerProfileArgs {
     ...
     */
    expander?: pulumi.Input<string | enums.containerservice.v20220201.Expander>;
    /**
     * The default is 10.
     */
...
export interface ManagedClusterSKUArgs {
     ...
     */
    name?: pulumi.Input<string | enums.containerservice.v20220201.ManagedClusterSKUName>;
    /**
     * If not specified, the default is 'Free'. See [uptime SLA](https://docs.microsoft.com/azure/aks/uptime-sla) for more details.
     */
    tier?: pulumi.Input<string | enums.containerservice.v20220201.ManagedClusterSKUTier>;
}
...
export interface ManagedClusterSecurityProfileArgs {
     ...
     */
    azureDefender?: pulumi.Input<inputs.containerservice.v20220201.ManagedClusterSecurityProfileAzureDefenderArgs>;
}
...
export interface ManagedClusterWindowsProfileArgs {
     ...
     */
    gmsaProfile?: pulumi.Input<inputs.containerservice.v20220201.WindowsGmsaProfileArgs>;
    /**
     * The license type to use for Windows VMs. See [Azure Hybrid User Benefits](https://azure.microsoft.com/pricing/hybrid-benefit/faq/) for more details.
     */
    licenseType?: pulumi.Input<string | enums.containerservice.v20220201.LicenseType>;
}
...
export interface PowerStateArgs {
     ...
     */
    code?: pulumi.Input<string | enums.containerservice.v20220201.Code>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.containerservice.v20220201.ConnectionStatus>;
}
...
export interface TimeInWeekArgs {
     ...
     * The day of the week.
     */
    day?: pulumi.Input<string | enums.containerservice.v20220201.WeekDay>;
    /**
