...
export interface ContainerServiceLinuxProfileResponse {
     ...
     */
    ssh: outputs.containerservice.v20220201.ContainerServiceSshConfigurationResponse;
}
...
export interface ContainerServiceNetworkProfileResponse {
     ...
     */
    loadBalancerProfile?: outputs.containerservice.v20220201.ManagedClusterLoadBalancerProfileResponse;
    /**
     ...
     */
    natGatewayProfile?: outputs.containerservice.v20220201.ManagedClusterNATGatewayProfileResponse;
    /**
...
export function containerServiceNetworkProfileResponseProvideDefaults(val: ContainerServiceNetworkProfileResponse): ContainerServiceNetworkProfileResponse {
    return {
        ...
        loadBalancerProfile: (val.loadBalancerProfile ? outputs.containerservice.v20220201.managedClusterLoadBalancerProfileResponseProvideDefaults(val.loadBalancerProfile) : undefined),
        natGatewayProfile: (val.natGatewayProfile ? outputs.containerservice.v20220201.managedClusterNATGatewayProfileResponseProvideDefaults(val.natGatewayProfile) : undefined),
...
export interface ContainerServiceSshConfigurationResponse {
     ...
     */
    publicKeys: outputs.containerservice.v20220201.ContainerServiceSshPublicKeyResponse[];
}
...
export interface LinuxOSConfigResponse {
     ...
     */
    sysctls?: outputs.containerservice.v20220201.SysctlConfigResponse;
    /**
...
export interface ManagedClusterAddonProfileResponse {
     ...
     */
    identity: outputs.containerservice.v20220201.ManagedClusterAddonProfileResponseIdentity;
}
...
export interface ManagedClusterAgentPoolProfileResponse {
     ...
     */
    creationData?: outputs.containerservice.v20220201.CreationDataResponse;
    /**
     ...
     */
    kubeletConfig?: outputs.containerservice.v20220201.KubeletConfigResponse;
    /**
     ...
     */
    linuxOSConfig?: outputs.containerservice.v20220201.LinuxOSConfigResponse;
    /**
     ...
     */
    powerState?: outputs.containerservice.v20220201.PowerStateResponse;
    /**
     ...
     */
    upgradeSettings?: outputs.containerservice.v20220201.AgentPoolUpgradeSettingsResponse;
    /**
...
export interface ManagedClusterIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.containerservice.v20220201.ManagedClusterIdentityResponseUserAssignedIdentities};
}
...
export interface ManagedClusterLoadBalancerProfileResponse {
     ...
     */
    effectiveOutboundIPs?: outputs.containerservice.v20220201.ResourceReferenceResponse[];
    /**
     ...
     */
    managedOutboundIPs?: outputs.containerservice.v20220201.ManagedClusterLoadBalancerProfileResponseManagedOutboundIPs;
    /**
     * Desired outbound IP Prefix resources for the cluster load balancer.
     */
    outboundIPPrefixes?: outputs.containerservice.v20220201.ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixes;
    /**
     * Desired outbound IP resources for the cluster load balancer.
     */
    outboundIPs?: outputs.containerservice.v20220201.ManagedClusterLoadBalancerProfileResponseOutboundIPs;
}
/**
...
export function managedClusterLoadBalancerProfileResponseProvideDefaults(val: ManagedClusterLoadBalancerProfileResponse): ManagedClusterLoadBalancerProfileResponse {
    return {
        ...
        managedOutboundIPs: (val.managedOutboundIPs ? outputs.containerservice.v20220201.managedClusterLoadBalancerProfileResponseManagedOutboundIPsProvideDefaults(val.managedOutboundIPs) : undefined),
    };
}
...
export interface ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixes {
     ...
     */
    publicIPPrefixes?: outputs.containerservice.v20220201.ResourceReferenceResponse[];
}
...
export interface ManagedClusterLoadBalancerProfileResponseOutboundIPs {
     ...
     */
    publicIPs?: outputs.containerservice.v20220201.ResourceReferenceResponse[];
}
...
export interface ManagedClusterNATGatewayProfileResponse {
     ...
     */
    managedOutboundIPProfile?: outputs.containerservice.v20220201.ManagedClusterManagedOutboundIPProfileResponse;
}
/**
...
export function managedClusterNATGatewayProfileResponseProvideDefaults(val: ManagedClusterNATGatewayProfileResponse): ManagedClusterNATGatewayProfileResponse {
    return {
        ...
        managedOutboundIPProfile: (val.managedOutboundIPProfile ? outputs.containerservice.v20220201.managedClusterManagedOutboundIPProfileResponseProvideDefaults(val.managedOutboundIPProfile) : undefined),
    };
}
...
export interface ManagedClusterPodIdentityProfileResponse {
     ...
     */
    userAssignedIdentities?: outputs.containerservice.v20220201.ManagedClusterPodIdentityResponse[];
    /**
     * The pod identity exceptions to allow.
     */
    userAssignedIdentityExceptions?: outputs.containerservice.v20220201.ManagedClusterPodIdentityExceptionResponse[];
}
...
export interface ManagedClusterPodIdentityProvisioningErrorBodyResponse {
     ...
     */
    details?: outputs.containerservice.v20220201.ManagedClusterPodIdentityProvisioningErrorBodyResponse[];
    /**
...
export interface ManagedClusterPodIdentityProvisioningErrorResponse {
     ...
     */
    error?: outputs.containerservice.v20220201.ManagedClusterPodIdentityProvisioningErrorBodyResponse;
}
...
export interface ManagedClusterPodIdentityResponse {
     ...
     */
    identity: outputs.containerservice.v20220201.UserAssignedIdentityResponse;
    /**
     ...
     */
    namespace: string;
    provisioningInfo: outputs.containerservice.v20220201.ManagedClusterPodIdentityResponseProvisioningInfo;
    /**
...
export interface ManagedClusterPodIdentityResponseProvisioningInfo {
     ...
     */
    error?: outputs.containerservice.v20220201.ManagedClusterPodIdentityProvisioningErrorResponse;
}
...
export interface ManagedClusterSecurityProfileResponse {
     ...
     * Azure Defender settings for the security profile.
     */
    azureDefender?: outputs.containerservice.v20220201.ManagedClusterSecurityProfileAzureDefenderResponse;
}
...
export interface ManagedClusterWindowsProfileResponse {
     ...
     */
    gmsaProfile?: outputs.containerservice.v20220201.WindowsGmsaProfileResponse;
    /**
