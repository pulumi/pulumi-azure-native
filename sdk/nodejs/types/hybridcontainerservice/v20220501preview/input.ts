...
export interface AgentPoolProvisioningStatusProvisioningStatusArgs {
    error?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.AgentPoolProvisioningStatusErrorArgs>;
...
export interface AgentPoolProvisioningStatusStatusArgs {
     ...
     * Contains Provisioning errors
     */
    provisioningStatus?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.AgentPoolProvisioningStatusProvisioningStatusArgs>;
    /**
...
export interface ArcAgentProfileArgs {
     ...
     */
    agentAutoUpgrade?: pulumi.Input<string | enums.hybridcontainerservice.v20220501preview.AutoUpgradeOptions>;
    /**
...
export interface CloudProviderProfileArgs {
     ...
     */
    infraNetworkProfile?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.CloudProviderProfileInfraNetworkProfileArgs>;
    /**
     * InfraStorageProfile - List of infra storage profiles for the provisioned cluster
     */
    infraStorageProfile?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.CloudProviderProfileInfraStorageProfileArgs>;
}
...
export interface ControlPlaneProfileArgs {
     ...
     * API server endpoint for the control plane
     */
    controlPlaneEndpoint?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.ControlPlaneEndpointProfileControlPlaneEndpointArgs>;
    /**
     ...
     */
    linuxProfile?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.LinuxProfilePropertiesArgs>;
    /**
...
export interface LinuxProfilePropertiesArgs {
     ...
     */
    ssh?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.LinuxProfilePropertiesSshArgs>;
}
...
export interface LinuxProfilePropertiesSshArgs {
     ...
     */
    publicKeys?: pulumi.Input<pulumi.Input<inputs.hybridcontainerservice.v20220501preview.LinuxProfilePropertiesPublicKeysArgs>[]>;
}
...
export interface NetworkProfileArgs {
     ...
     * LoadBalancerProfile - Profile of the cluster load balancer.
     */
    loadBalancerProfile?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.LoadBalancerProfileArgs>;
    /**
     ...
     */
    loadBalancerSku?: pulumi.Input<string | enums.hybridcontainerservice.v20220501preview.LoadBalancerSku>;
    /**
     ...
     */
    networkPolicy?: pulumi.Input<string | enums.hybridcontainerservice.v20220501preview.NetworkPolicy>;
    /**
...
export function networkProfileArgsProvideDefaults(val: NetworkProfileArgs): NetworkProfileArgs {
    return {
        ...val,
        loadBalancerProfile: (val.loadBalancerProfile ? pulumi.output(val.loadBalancerProfile).apply(inputs.hybridcontainerservice.v20220501preview.loadBalancerProfileArgsProvideDefaults) : undefined),
...
export interface ProvisionedClusterIdentityArgs {
     ...
     */
    type: pulumi.Input<enums.hybridcontainerservice.v20220501preview.ResourceIdentityType>;
}
...
export interface ProvisionedClustersAllPropertiesArgs {
     ...
     */
    aadProfile?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.AADProfileArgs>;
    /**
     * AddonProfiles - Profile of managed cluster add-on.
     */
    addonProfiles?: pulumi.Input<{[key: string]: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.AddonProfilesArgs>}>;
    /**
     * The agent pools of the cluster.
     */
    agentPoolProfiles?: pulumi.Input<pulumi.Input<inputs.hybridcontainerservice.v20220501preview.NamedAgentPoolProfileArgs>[]>;
    /**
     * The underlying cloud infra provider properties.
     */
    cloudProviderProfile?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.CloudProviderProfileArgs>;
     ...
     */
    controlPlane?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.ControlPlaneProfileArgs>;
    /**
     ...
     */
    features?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.ProvisionedClustersCommonPropertiesFeaturesArgs>;
    /**
     * HttpProxyConfig - Configurations for provisioning the cluster with HTTP proxy servers.
     */
    httpProxyConfig?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.HttpProxyConfigArgs>;
    /**
     ...
     * NetworkProfile - Profile of network configuration.
     */
    networkProfile?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.NetworkProfileArgs>;
    /**
     ...
     */
    windowsProfile?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.WindowsProfileArgs>;
}
/**
...
export function provisionedClustersAllPropertiesArgsProvideDefaults(val: ProvisionedClustersAllPropertiesArgs): ProvisionedClustersAllPropertiesArgs {
    return {
        ...val,
        controlPlane: (val.controlPlane ? pulumi.output(val.controlPlane).apply(inputs.hybridcontainerservice.v20220501preview.controlPlaneProfileArgsProvideDefaults) : undefined),
        features: (val.features ? pulumi.output(val.features).apply(inputs.hybridcontainerservice.v20220501preview.provisionedClustersCommonPropertiesFeaturesArgsProvideDefaults) : undefined),
        networkProfile: (val.networkProfile ? pulumi.output(val.networkProfile).apply(inputs.hybridcontainerservice.v20220501preview.networkProfileArgsProvideDefaults) : undefined),
    };
}
...
export interface ProvisionedClustersCommonPropertiesFeaturesArgs {
     ...
     */
    arcAgentProfile?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.ArcAgentProfileArgs>;
}
/**
...
export function provisionedClustersCommonPropertiesFeaturesArgsProvideDefaults(val: ProvisionedClustersCommonPropertiesFeaturesArgs): ProvisionedClustersCommonPropertiesFeaturesArgs {
    return {
        ...val,
        arcAgentProfile: (val.arcAgentProfile ? pulumi.output(val.arcAgentProfile).apply(inputs.hybridcontainerservice.v20220501preview.arcAgentProfileArgsProvideDefaults) : undefined),
    };
}
...
export interface StorageSpacesPropertiesArgs {
    hciStorageProfile?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.StorageSpacesPropertiesHciStorageProfileArgs>;
    /**
     * HybridAKSStorageStatus defines the observed state of HybridAKSStorage
     */
    status?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.StorageSpacesPropertiesStatusArgs>;
    vmwareStorageProfile?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.StorageSpacesPropertiesVmwareStorageProfileArgs>;
}
...
export interface StorageSpacesPropertiesProvisioningStatusArgs {
    error?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.StorageSpacesPropertiesErrorArgs>;
    operationId?: pulumi.Input<string>;
    /**
     * Phase represents the current phase of cluster actuation. E.g. Pending, Running, Terminating, Failed etc.
     */
...
export interface StorageSpacesPropertiesStatusArgs {
     ...
     * Contains Provisioning errors
     */
    provisioningStatus?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.StorageSpacesPropertiesProvisioningStatusArgs>;
}
...
export interface VirtualNetworksPropertiesArgs {
    infraVnetProfile?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.VirtualNetworksPropertiesInfraVnetProfileArgs>;
    /**
     * Virtual IP Pool for Kubernetes
     */
    vipPool?: pulumi.Input<pulumi.Input<inputs.hybridcontainerservice.v20220501preview.VirtualNetworksPropertiesVipPoolArgs>[]>;
    /**
     * IP Pool for Virtual Machines
     */
    vmipPool?: pulumi.Input<pulumi.Input<inputs.hybridcontainerservice.v20220501preview.VirtualNetworksPropertiesVmipPoolArgs>[]>;
}
...
export interface VirtualNetworksPropertiesInfraVnetProfileArgs {
     ...
     * Infra network profile for HCI platform
     */
    hci?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.VirtualNetworksPropertiesHciArgs>;
    /**
     * Infra network profile for KubeVirt platform
     */
    kubevirt?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.VirtualNetworksPropertiesKubevirtArgs>;
    /**
     * Infra network profile for VMware platform
     */
    vmware?: pulumi.Input<inputs.hybridcontainerservice.v20220501preview.VirtualNetworksPropertiesVmwareArgs>;
}
...
export interface WindowsProfileArgs {
     ...
     */
    licenseType?: pulumi.Input<string | enums.hybridcontainerservice.v20220501preview.LicenseType>;
}
