...
export interface AS2AgreementContentArgs {
     ...
     */
    receiveAgreement: pulumi.Input<inputs.logic.v20160601.AS2OneWayAgreementArgs>;
    /**
     * The AS2 one-way send agreement.
     */
    sendAgreement: pulumi.Input<inputs.logic.v20160601.AS2OneWayAgreementArgs>;
}
...
export interface AS2MdnSettingsArgs {
     ...
     */
    micHashingAlgorithm: pulumi.Input<enums.logic.v20160601.HashingAlgorithm>;
    /**
...
export interface AS2OneWayAgreementArgs {
     ...
     */
    protocolSettings: pulumi.Input<inputs.logic.v20160601.AS2ProtocolSettingsArgs>;
    /**
     * The receiver business identity
     */
    receiverBusinessIdentity: pulumi.Input<inputs.logic.v20160601.BusinessIdentityArgs>;
    /**
     * The sender business identity
     */
    senderBusinessIdentity: pulumi.Input<inputs.logic.v20160601.BusinessIdentityArgs>;
}
...
export interface AS2ProtocolSettingsArgs {
     ...
     */
    acknowledgementConnectionSettings: pulumi.Input<inputs.logic.v20160601.AS2AcknowledgementConnectionSettingsArgs>;
    /**
     * The envelope settings.
     */
    envelopeSettings: pulumi.Input<inputs.logic.v20160601.AS2EnvelopeSettingsArgs>;
    /**
     * The error settings.
     */
    errorSettings: pulumi.Input<inputs.logic.v20160601.AS2ErrorSettingsArgs>;
    /**
     * The MDN settings.
     */
    mdnSettings: pulumi.Input<inputs.logic.v20160601.AS2MdnSettingsArgs>;
    /**
     * The message connection settings.
     */
    messageConnectionSettings: pulumi.Input<inputs.logic.v20160601.AS2MessageConnectionSettingsArgs>;
    /**
     * The security settings.
     */
    securitySettings: pulumi.Input<inputs.logic.v20160601.AS2SecuritySettingsArgs>;
    /**
     * The validation settings.
     */
    validationSettings: pulumi.Input<inputs.logic.v20160601.AS2ValidationSettingsArgs>;
}
...
export interface AS2ValidationSettingsArgs {
     ...
     */
    encryptionAlgorithm: pulumi.Input<enums.logic.v20160601.EncryptionAlgorithm>;
    /**
     ...
     */
    signingAlgorithm?: pulumi.Input<string | enums.logic.v20160601.SigningAlgorithm>;
}
...
export interface AgreementContentArgs {
     ...
     */
    aS2?: pulumi.Input<inputs.logic.v20160601.AS2AgreementContentArgs>;
    /**
     * The EDIFACT agreement content.
     */
    edifact?: pulumi.Input<inputs.logic.v20160601.EdifactAgreementContentArgs>;
    /**
     * The X12 agreement content.
     */
    x12?: pulumi.Input<inputs.logic.v20160601.X12AgreementContentArgs>;
}
...
export interface AssemblyPropertiesArgs {
     ...
     * The content link.
     */
    contentLink?: pulumi.Input<inputs.logic.v20160601.ContentLinkArgs>;
    /**
     * The content type.
     */
...
export interface B2BPartnerContentArgs {
     ...
     */
    businessIdentities?: pulumi.Input<pulumi.Input<inputs.logic.v20160601.BusinessIdentityArgs>[]>;
}
...
export interface BatchConfigurationPropertiesArgs {
     ...
     */
    releaseCriteria: pulumi.Input<inputs.logic.v20160601.BatchReleaseCriteriaArgs>;
}
...
export interface BatchReleaseCriteriaArgs {
     ...
     * The recurrence.
     */
    recurrence?: pulumi.Input<inputs.logic.v20160601.WorkflowTriggerRecurrenceArgs>;
}
...
export interface ContentLinkArgs {
     ...
     * The content hash.
     */
    contentHash?: pulumi.Input<inputs.logic.v20160601.ContentHashArgs>;
    /**
     * The content size.
     */
...
export interface EdifactAgreementContentArgs {
     ...
     */
    receiveAgreement: pulumi.Input<inputs.logic.v20160601.EdifactOneWayAgreementArgs>;
    /**
     * The EDIFACT one-way send agreement.
     */
    sendAgreement: pulumi.Input<inputs.logic.v20160601.EdifactOneWayAgreementArgs>;
}
...
export interface EdifactDelimiterOverrideArgs {
     ...
     */
    decimalPointIndicator: pulumi.Input<enums.logic.v20160601.EdifactDecimalIndicator>;
    /**
     ...
     */
    segmentTerminatorSuffix: pulumi.Input<enums.logic.v20160601.SegmentTerminatorSuffix>;
    /**
...
export interface EdifactFramingSettingsArgs {
     ...
     */
    characterSet: pulumi.Input<enums.logic.v20160601.EdifactCharacterSet>;
    /**
     * The component separator.
     */
    componentSeparator: pulumi.Input<number>;
...
export interface EdifactMessageFilterArgs {
     ...
     */
    messageFilterType: pulumi.Input<enums.logic.v20160601.MessageFilterType>;
}
...
export interface EdifactOneWayAgreementArgs {
     ...
     */
    protocolSettings: pulumi.Input<inputs.logic.v20160601.EdifactProtocolSettingsArgs>;
    /**
     * The receiver business identity
     */
    receiverBusinessIdentity: pulumi.Input<inputs.logic.v20160601.BusinessIdentityArgs>;
...
export interface EdifactProtocolSettingsArgs {
     ...
     */
    acknowledgementSettings: pulumi.Input<inputs.logic.v20160601.EdifactAcknowledgementSettingsArgs>;
    /**
     * The EDIFACT delimiter override settings.
     */
    edifactDelimiterOverrides?: pulumi.Input<pulumi.Input<inputs.logic.v20160601.EdifactDelimiterOverrideArgs>[]>;
    /**
     * The EDIFACT envelope override settings.
     */
    envelopeOverrides?: pulumi.Input<pulumi.Input<inputs.logic.v20160601.EdifactEnvelopeOverrideArgs>[]>;
    /**
     * The EDIFACT envelope settings.
     */
    envelopeSettings: pulumi.Input<inputs.logic.v20160601.EdifactEnvelopeSettingsArgs>;
    /**
     * The EDIFACT framing settings.
     */
    framingSettings: pulumi.Input<inputs.logic.v20160601.EdifactFramingSettingsArgs>;
    /**
     * The EDIFACT message filter.
     */
    messageFilter: pulumi.Input<inputs.logic.v20160601.EdifactMessageFilterArgs>;
    /**
     * The EDIFACT message filter list.
     */
    messageFilterList?: pulumi.Input<pulumi.Input<inputs.logic.v20160601.EdifactMessageIdentifierArgs>[]>;
    /**
     * The EDIFACT processing Settings.
     */
    processingSettings: pulumi.Input<inputs.logic.v20160601.EdifactProcessingSettingsArgs>;
    /**
     * The EDIFACT schema references.
     */
    schemaReferences: pulumi.Input<pulumi.Input<inputs.logic.v20160601.EdifactSchemaReferenceArgs>[]>;
    /**
     * The EDIFACT validation override settings.
     */
    validationOverrides?: pulumi.Input<pulumi.Input<inputs.logic.v20160601.EdifactValidationOverrideArgs>[]>;
    /**
     * The EDIFACT validation settings.
     */
    validationSettings: pulumi.Input<inputs.logic.v20160601.EdifactValidationSettingsArgs>;
}
...
export interface EdifactValidationOverrideArgs {
     ...
     */
    trailingSeparatorPolicy: pulumi.Input<enums.logic.v20160601.TrailingSeparatorPolicy>;
    /**
...
export interface IntegrationAccountSkuArgs {
     ...
     * The sku name.
     */
    name: pulumi.Input<enums.logic.v20160601.IntegrationAccountSkuName>;
}
...
export interface KeyVaultKeyReferenceArgs {
     ...
     */
    keyVault: pulumi.Input<inputs.logic.v20160601.KeyVaultKeyReferenceKeyVaultArgs>;
    /**
...
export interface PartnerContentArgs {
     ...
     * The B2B partner content.
     */
    b2b?: pulumi.Input<inputs.logic.v20160601.B2BPartnerContentArgs>;
}
...
export interface RecurrenceScheduleArgs {
     ...
     */
    monthlyOccurrences?: pulumi.Input<pulumi.Input<inputs.logic.v20160601.RecurrenceScheduleOccurrenceArgs>[]>;
    /**
     * The days of the week.
     */
    weekDays?: pulumi.Input<pulumi.Input<enums.logic.v20160601.DaysOfWeek>[]>;
}
...
export interface RecurrenceScheduleOccurrenceArgs {
     ...
     * The day of the week.
     */
    day?: pulumi.Input<enums.logic.v20160601.DayOfWeek>;
    /**
     * The occurrence.
     */
...
export interface RosettaNetPipActivityBehaviorArgs {
     ...
     */
    actionType: pulumi.Input<enums.logic.v20160601.RosettaNetActionType>;
    /**
     ...
     */
    persistentConfidentialityScope: pulumi.Input<enums.logic.v20160601.RosettaNetPipConfidentialityScope>;
    /**
     * The value indicating whether the RosettaNet PIP communication is synchronous.
     */
    responseType: pulumi.Input<enums.logic.v20160601.RosettaNetResponseType>;
    /**
...
export interface RosettaNetPipActivitySettingsArgs {
     ...
     */
    acknowledgmentOfReceiptSettings: pulumi.Input<inputs.logic.v20160601.RosettaNetPipAcknowledgmentOfReceiptSettingsArgs>;
    /**
     * The RosettaNet ProcessConfiguration activity behavior.
     */
    activityBehavior: pulumi.Input<inputs.logic.v20160601.RosettaNetPipActivityBehaviorArgs>;
    /**
     * The RosettaNet ProcessConfiguration activity type.
     */
    activityType: pulumi.Input<enums.logic.v20160601.RosettaNetPipActivityType>;
}
...
export interface RosettaNetPipRoleSettingsArgs {
     ...
     */
    businessDocument: pulumi.Input<inputs.logic.v20160601.RosettaNetPipBusinessDocumentArgs>;
    /**
     * The description.
     */
    description?: pulumi.Input<string>;
     ...
     */
    roleType: pulumi.Input<enums.logic.v20160601.RosettaNetPipRoleType>;
    /**
     * The service name.
     */
...
export interface SkuArgs {
     ...
     * The name.
     */
    name: pulumi.Input<enums.logic.v20160601.SkuName>;
}
...
export interface WorkflowParameterArgs {
     ...
     * The type.
     */
    type?: pulumi.Input<enums.logic.v20160601.ParameterType>;
    /**
     * The value.
     */
    value?: any;
...
export interface WorkflowTriggerRecurrenceArgs {
     ...
     * The frequency.
     */
    frequency?: pulumi.Input<enums.logic.v20160601.RecurrenceFrequency>;
    /**
     * The interval.
     */
     ...
     * The recurrence schedule.
     */
    schedule?: pulumi.Input<inputs.logic.v20160601.RecurrenceScheduleArgs>;
    /**
     * The start time.
     */
...
export interface X12AgreementContentArgs {
     ...
     */
    receiveAgreement: pulumi.Input<inputs.logic.v20160601.X12OneWayAgreementArgs>;
    /**
     * The X12 one-way send agreement.
     */
    sendAgreement: pulumi.Input<inputs.logic.v20160601.X12OneWayAgreementArgs>;
}
...
export interface X12EnvelopeOverrideArgs {
     ...
     * The date format.
     */
    dateFormat: pulumi.Input<enums.logic.v20160601.X12DateFormat>;
    /**
     ...
     * The time format.
     */
    timeFormat: pulumi.Input<enums.logic.v20160601.X12TimeFormat>;
}
...
export interface X12EnvelopeSettingsArgs {
     ...
     */
    groupHeaderDateFormat: pulumi.Input<enums.logic.v20160601.X12DateFormat>;
    /**
     * The group header time format.
     */
    groupHeaderTimeFormat: pulumi.Input<enums.logic.v20160601.X12TimeFormat>;
    /**
     ...
     * The usage indicator.
     */
    usageIndicator: pulumi.Input<enums.logic.v20160601.UsageIndicator>;
    /**
...
export interface X12FramingSettingsArgs {
     ...
     */
    characterSet: pulumi.Input<enums.logic.v20160601.X12CharacterSet>;
    /**
     * The component separator.
     */
    componentSeparator: pulumi.Input<number>;
...
export interface X12OneWayAgreementArgs {
     ...
     */
    protocolSettings: pulumi.Input<inputs.logic.v20160601.X12ProtocolSettingsArgs>;
    /**
     * The receiver business identity
     */
    receiverBusinessIdentity: pulumi.Input<inputs.logic.v20160601.BusinessIdentityArgs>;
...
export interface X12ProtocolSettingsArgs {
     ...
     */
    acknowledgementSettings: pulumi.Input<inputs.logic.v20160601.X12AcknowledgementSettingsArgs>;
    /**
     * The X12 envelope override settings.
     */
    envelopeOverrides?: pulumi.Input<pulumi.Input<inputs.logic.v20160601.X12EnvelopeOverrideArgs>[]>;
    /**
     * The X12 envelope settings.
     */
    envelopeSettings: pulumi.Input<inputs.logic.v20160601.X12EnvelopeSettingsArgs>;
    /**
     * The X12 framing settings.
     */
    framingSettings: pulumi.Input<inputs.logic.v20160601.X12FramingSettingsArgs>;
    /**
     * The X12 message filter.
     */
    messageFilter: pulumi.Input<inputs.logic.v20160601.X12MessageFilterArgs>;
    /**
     * The X12 message filter list.
     */
    messageFilterList?: pulumi.Input<pulumi.Input<inputs.logic.v20160601.X12MessageIdentifierArgs>[]>;
    /**
     * The X12 processing settings.
     */
    processingSettings: pulumi.Input<inputs.logic.v20160601.X12ProcessingSettingsArgs>;
    /**
     * The X12 schema references.
     */
    schemaReferences: pulumi.Input<pulumi.Input<inputs.logic.v20160601.X12SchemaReferenceArgs>[]>;
    /**
     * The X12 security settings.
     */
    securitySettings: pulumi.Input<inputs.logic.v20160601.X12SecuritySettingsArgs>;
    /**
     * The X12 validation override settings.
     */
    validationOverrides?: pulumi.Input<pulumi.Input<inputs.logic.v20160601.X12ValidationOverrideArgs>[]>;
    /**
     * The X12 validation settings.
     */
    validationSettings: pulumi.Input<inputs.logic.v20160601.X12ValidationSettingsArgs>;
    /**
     * The X12 delimiter override settings.
     */
    x12DelimiterOverrides?: pulumi.Input<pulumi.Input<inputs.logic.v20160601.X12DelimiterOverridesArgs>[]>;
}
