...
export interface AS2AgreementContentResponse {
     ...
     */
    receiveAgreement: outputs.logic.v20160601.AS2OneWayAgreementResponse;
    /**
     * The AS2 one-way send agreement.
     */
    sendAgreement: outputs.logic.v20160601.AS2OneWayAgreementResponse;
}
...
export interface AS2OneWayAgreementResponse {
     ...
     */
    protocolSettings: outputs.logic.v20160601.AS2ProtocolSettingsResponse;
    /**
     * The receiver business identity
     */
    receiverBusinessIdentity: outputs.logic.v20160601.BusinessIdentityResponse;
    /**
     * The sender business identity
     */
    senderBusinessIdentity: outputs.logic.v20160601.BusinessIdentityResponse;
}
...
export interface AS2ProtocolSettingsResponse {
     ...
     */
    acknowledgementConnectionSettings: outputs.logic.v20160601.AS2AcknowledgementConnectionSettingsResponse;
    /**
     * The envelope settings.
     */
    envelopeSettings: outputs.logic.v20160601.AS2EnvelopeSettingsResponse;
    /**
     * The error settings.
     */
    errorSettings: outputs.logic.v20160601.AS2ErrorSettingsResponse;
    /**
     * The MDN settings.
     */
    mdnSettings: outputs.logic.v20160601.AS2MdnSettingsResponse;
    /**
     * The message connection settings.
     */
    messageConnectionSettings: outputs.logic.v20160601.AS2MessageConnectionSettingsResponse;
    /**
     * The security settings.
     */
    securitySettings: outputs.logic.v20160601.AS2SecuritySettingsResponse;
    /**
     * The validation settings.
     */
    validationSettings: outputs.logic.v20160601.AS2ValidationSettingsResponse;
}
...
export interface AgreementContentResponse {
     ...
     */
    aS2?: outputs.logic.v20160601.AS2AgreementContentResponse;
    /**
     * The EDIFACT agreement content.
     */
    edifact?: outputs.logic.v20160601.EdifactAgreementContentResponse;
    /**
     * The X12 agreement content.
     */
    x12?: outputs.logic.v20160601.X12AgreementContentResponse;
}
...
export interface AssemblyPropertiesResponse {
     ...
     * The content link.
     */
    contentLink?: outputs.logic.v20160601.ContentLinkResponse;
    /**
     * The content type.
     */
    contentType?: string;
...
export interface AzureResourceErrorInfoResponse {
     ...
     * The error details.
     */
    details?: outputs.logic.v20160601.AzureResourceErrorInfoResponse[];
    /**
     * The error message.
     */
    message: string;
...
export interface B2BPartnerContentResponse {
     ...
     */
    businessIdentities?: outputs.logic.v20160601.BusinessIdentityResponse[];
}
...
export interface BatchConfigurationPropertiesResponse {
     ...
     */
    releaseCriteria: outputs.logic.v20160601.BatchReleaseCriteriaResponse;
}
...
export interface BatchReleaseCriteriaResponse {
     ...
     * The recurrence.
     */
    recurrence?: outputs.logic.v20160601.WorkflowTriggerRecurrenceResponse;
}
...
export interface ContentLinkResponse {
     ...
     * The content hash.
     */
    contentHash?: outputs.logic.v20160601.ContentHashResponse;
    /**
     * The content size.
     */
    contentSize?: number;
...
export interface EdifactAgreementContentResponse {
     ...
     */
    receiveAgreement: outputs.logic.v20160601.EdifactOneWayAgreementResponse;
    /**
     * The EDIFACT one-way send agreement.
     */
    sendAgreement: outputs.logic.v20160601.EdifactOneWayAgreementResponse;
}
...
export interface EdifactOneWayAgreementResponse {
     ...
     */
    protocolSettings: outputs.logic.v20160601.EdifactProtocolSettingsResponse;
    /**
     * The receiver business identity
     */
    receiverBusinessIdentity: outputs.logic.v20160601.BusinessIdentityResponse;
...
export interface EdifactProtocolSettingsResponse {
     ...
     */
    acknowledgementSettings: outputs.logic.v20160601.EdifactAcknowledgementSettingsResponse;
    /**
     * The EDIFACT delimiter override settings.
     */
    edifactDelimiterOverrides?: outputs.logic.v20160601.EdifactDelimiterOverrideResponse[];
    /**
     * The EDIFACT envelope override settings.
     */
    envelopeOverrides?: outputs.logic.v20160601.EdifactEnvelopeOverrideResponse[];
    /**
     * The EDIFACT envelope settings.
     */
    envelopeSettings: outputs.logic.v20160601.EdifactEnvelopeSettingsResponse;
    /**
     * The EDIFACT framing settings.
     */
    framingSettings: outputs.logic.v20160601.EdifactFramingSettingsResponse;
    /**
     * The EDIFACT message filter.
     */
    messageFilter: outputs.logic.v20160601.EdifactMessageFilterResponse;
    /**
     * The EDIFACT message filter list.
     */
    messageFilterList?: outputs.logic.v20160601.EdifactMessageIdentifierResponse[];
    /**
     * The EDIFACT processing Settings.
     */
    processingSettings: outputs.logic.v20160601.EdifactProcessingSettingsResponse;
    /**
     * The EDIFACT schema references.
     */
    schemaReferences: outputs.logic.v20160601.EdifactSchemaReferenceResponse[];
    /**
     * The EDIFACT validation override settings.
     */
    validationOverrides?: outputs.logic.v20160601.EdifactValidationOverrideResponse[];
    /**
     * The EDIFACT validation settings.
     */
    validationSettings: outputs.logic.v20160601.EdifactValidationSettingsResponse;
}
...
export interface ExpressionResponse {
     ...
     * The azure resource error info.
     */
    error?: outputs.logic.v20160601.AzureResourceErrorInfoResponse;
    subexpressions?: outputs.logic.v20160601.ExpressionResponse[];
    text?: string;
    value?: any;
}
...
export interface KeyVaultKeyReferenceResponse {
     ...
     */
    keyVault: outputs.logic.v20160601.KeyVaultKeyReferenceResponseKeyVault;
    /**
...
export interface KeyVaultKeyResponse {
     ...
     * The key attributes.
     */
    attributes?: outputs.logic.v20160601.KeyVaultKeyResponseAttributes;
    /**
     * The key id.
     */
    kid?: string;
...
export interface PartnerContentResponse {
     ...
     * The B2B partner content.
     */
    b2b?: outputs.logic.v20160601.B2BPartnerContentResponse;
}
...
export interface RecurrenceScheduleResponse {
     ...
     */
    monthlyOccurrences?: outputs.logic.v20160601.RecurrenceScheduleOccurrenceResponse[];
    /**
...
export interface RosettaNetPipActivitySettingsResponse {
     ...
     */
    acknowledgmentOfReceiptSettings: outputs.logic.v20160601.RosettaNetPipAcknowledgmentOfReceiptSettingsResponse;
    /**
     * The RosettaNet ProcessConfiguration activity behavior.
     */
    activityBehavior: outputs.logic.v20160601.RosettaNetPipActivityBehaviorResponse;
    /**
...
export interface RosettaNetPipRoleSettingsResponse {
     ...
     */
    businessDocument: outputs.logic.v20160601.RosettaNetPipBusinessDocumentResponse;
    /**
     * The description.
     */
    description?: string;
...
export interface SkuResponse {
     ...
     */
    plan?: outputs.logic.v20160601.ResourceReferenceResponse;
}
...
export interface WorkflowTriggerRecurrenceResponse {
     ...
     * The recurrence schedule.
     */
    schedule?: outputs.logic.v20160601.RecurrenceScheduleResponse;
    /**
     * The start time.
     */
    startTime?: string;
...
export interface X12AgreementContentResponse {
     ...
     */
    receiveAgreement: outputs.logic.v20160601.X12OneWayAgreementResponse;
    /**
     * The X12 one-way send agreement.
     */
    sendAgreement: outputs.logic.v20160601.X12OneWayAgreementResponse;
}
...
export interface X12OneWayAgreementResponse {
     ...
     */
    protocolSettings: outputs.logic.v20160601.X12ProtocolSettingsResponse;
    /**
     * The receiver business identity
     */
    receiverBusinessIdentity: outputs.logic.v20160601.BusinessIdentityResponse;
...
export interface X12ProtocolSettingsResponse {
     ...
     */
    acknowledgementSettings: outputs.logic.v20160601.X12AcknowledgementSettingsResponse;
    /**
     * The X12 envelope override settings.
     */
    envelopeOverrides?: outputs.logic.v20160601.X12EnvelopeOverrideResponse[];
    /**
     * The X12 envelope settings.
     */
    envelopeSettings: outputs.logic.v20160601.X12EnvelopeSettingsResponse;
    /**
     * The X12 framing settings.
     */
    framingSettings: outputs.logic.v20160601.X12FramingSettingsResponse;
    /**
     * The X12 message filter.
     */
    messageFilter: outputs.logic.v20160601.X12MessageFilterResponse;
    /**
     * The X12 message filter list.
     */
    messageFilterList?: outputs.logic.v20160601.X12MessageIdentifierResponse[];
    /**
     * The X12 processing settings.
     */
    processingSettings: outputs.logic.v20160601.X12ProcessingSettingsResponse;
    /**
     * The X12 schema references.
     */
    schemaReferences: outputs.logic.v20160601.X12SchemaReferenceResponse[];
    /**
     * The X12 security settings.
     */
    securitySettings: outputs.logic.v20160601.X12SecuritySettingsResponse;
    /**
     * The X12 validation override settings.
     */
    validationOverrides?: outputs.logic.v20160601.X12ValidationOverrideResponse[];
    /**
     * The X12 validation settings.
     */
    validationSettings: outputs.logic.v20160601.X12ValidationSettingsResponse;
    /**
     * The X12 delimiter override settings.
     */
    x12DelimiterOverrides?: outputs.logic.v20160601.X12DelimiterOverridesResponse[];
}
