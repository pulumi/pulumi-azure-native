...
export * as v20150201preview from "./v20150201preview/output";
...
export interface IntegrationServiceEnvironmenEncryptionConfigurationResponse {
     ...
     */
    encryptionKeyReference?: outputs.logic.IntegrationServiceEnvironmenEncryptionKeyReferenceResponse;
}
...
export interface IntegrationServiceEnvironmenEncryptionKeyReferenceResponse {
     ...
     */
    keyVault?: outputs.logic.ResourceReferenceResponse;
    /**
...
export interface IntegrationServiceEnvironmentManagedApiDeploymentParametersResponse {
     ...
     */
    contentLinkDefinition?: outputs.logic.ContentLinkResponse;
}
...
export interface IntegrationServiceEnvironmentPropertiesResponse {
     ...
     */
    encryptionConfiguration?: outputs.logic.IntegrationServiceEnvironmenEncryptionConfigurationResponse;
    /**
     * The endpoints configuration.
     */
...
export interface KeyVaultKeyReferenceResponse {
     ...
     * The key vault reference.
     */
    keyVault: outputs.logic.KeyVaultKeyReferenceResponseKeyVault;
    /**
...
export interface KeyVaultKeyResponse {
     ...
     * The key attributes.
     */
    attributes?: outputs.logic.KeyVaultKeyResponseAttributes;
    /**
     * The key id.
     */
    kid?: string;
...
export interface ManagedServiceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.logic.UserAssignedIdentityResponse};
}
...
export interface OpenAuthenticationAccessPoliciesResponse {
     ...
     */
    policies?: {[key: string]: outputs.logic.OpenAuthenticationAccessPolicyResponse};
}
...
export interface OpenAuthenticationAccessPolicyResponse {
     ...
     */
    claims?: outputs.logic.OpenAuthenticationPolicyClaimResponse[];
    /**
...
export interface RosettaNetPipActivitySettingsResponse {
     ...
     */
    acknowledgmentOfReceiptSettings: outputs.logic.RosettaNetPipAcknowledgmentOfReceiptSettingsResponse;
    /**
     * The RosettaNet ProcessConfiguration activity behavior.
     */
    activityBehavior: outputs.logic.RosettaNetPipActivityBehaviorResponse;
    /**
...
export interface RosettaNetPipRoleSettingsResponse {
     ...
     */
    businessDocument: outputs.logic.RosettaNetPipBusinessDocumentResponse;
    /**
     * The description.
     */
    description?: string;
