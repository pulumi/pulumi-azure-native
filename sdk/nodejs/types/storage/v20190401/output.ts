...
export interface AzureFilesIdentityBasedAuthenticationResponse {
     ...
     */
    activeDirectoryProperties?: outputs.storage.v20190401.ActiveDirectoryPropertiesResponse;
    /**
...
export interface CorsRulesResponse {
     ...
     */
    corsRules?: outputs.storage.v20190401.CorsRuleResponse[];
}
...
export interface EncryptionResponse {
     ...
     */
    keyVaultProperties?: outputs.storage.v20190401.KeyVaultPropertiesResponse;
    /**
     * List of services which support encryption.
     */
    services?: outputs.storage.v20190401.EncryptionServicesResponse;
}
/**
...
export interface EncryptionServicesResponse {
     ...
     */
    blob?: outputs.storage.v20190401.EncryptionServiceResponse;
    /**
     * The encryption function of the file storage service.
     */
    file?: outputs.storage.v20190401.EncryptionServiceResponse;
    /**
     * The encryption function of the queue storage service.
     */
    queue: outputs.storage.v20190401.EncryptionServiceResponse;
    /**
     * The encryption function of the table storage service.
     */
    table: outputs.storage.v20190401.EncryptionServiceResponse;
}
...
export interface ImmutabilityPolicyPropertiesResponse {
     ...
     */
    updateHistory: outputs.storage.v20190401.UpdateHistoryPropertyResponse[];
}
...
export interface LegalHoldPropertiesResponse {
     ...
     */
    tags?: outputs.storage.v20190401.TagPropertyResponse[];
}
...
export interface ManagementPolicyActionResponse {
     ...
     */
    baseBlob?: outputs.storage.v20190401.ManagementPolicyBaseBlobResponse;
    /**
     * The management policy action for snapshot
     */
    snapshot?: outputs.storage.v20190401.ManagementPolicySnapShotResponse;
}
...
export interface ManagementPolicyBaseBlobResponse {
     ...
     */
    delete?: outputs.storage.v20190401.DateAfterModificationResponse;
    /**
     * The function to tier blobs to archive storage. Support blobs currently at Hot or Cool tier
     */
    tierToArchive?: outputs.storage.v20190401.DateAfterModificationResponse;
    /**
     * The function to tier blobs to cool storage. Support blobs currently at Hot tier
     */
    tierToCool?: outputs.storage.v20190401.DateAfterModificationResponse;
}
...
export interface ManagementPolicyDefinitionResponse {
     ...
     */
    actions: outputs.storage.v20190401.ManagementPolicyActionResponse;
    /**
     * An object that defines the filter set.
     */
    filters?: outputs.storage.v20190401.ManagementPolicyFilterResponse;
}
...
export interface ManagementPolicyRuleResponse {
     ...
     */
    definition: outputs.storage.v20190401.ManagementPolicyDefinitionResponse;
    /**
...
export interface ManagementPolicySchemaResponse {
     ...
     * The Storage Account ManagementPolicies Rules. See more details in: https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts.
     */
    rules: outputs.storage.v20190401.ManagementPolicyRuleResponse[];
}
...
export interface ManagementPolicySnapShotResponse {
     ...
     */
    delete?: outputs.storage.v20190401.DateAfterCreationResponse;
}
...
export interface NetworkRuleSetResponse {
     ...
     */
    ipRules?: outputs.storage.v20190401.IPRuleResponse[];
    /**
     * Sets the virtual network rules
     */
    virtualNetworkRules?: outputs.storage.v20190401.VirtualNetworkRuleResponse[];
}
/**
...
export interface SkuResponse {
     ...
     * The capability information in the specified SKU, including file encryption, network ACLs, change notification, etc.
     */
    capabilities: outputs.storage.v20190401.SKUCapabilityResponse[];
    /**
     ...
     */
    restrictions?: outputs.storage.v20190401.RestrictionResponse[];
    /**
