...
export interface EncryptionArgs {
     ...
     */
    keySource: pulumi.Input<string | enums.storage.v20171001.KeySource>;
    /**
     * Properties provided by key vault.
     */
    keyVaultProperties?: pulumi.Input<inputs.storage.v20171001.KeyVaultPropertiesArgs>;
    /**
     * List of services which support encryption.
     */
    services?: pulumi.Input<inputs.storage.v20171001.EncryptionServicesArgs>;
}
/**
...
export interface EncryptionServicesArgs {
     ...
     */
    blob?: pulumi.Input<inputs.storage.v20171001.EncryptionServiceArgs>;
    /**
     * The encryption function of the file storage service.
     */
    file?: pulumi.Input<inputs.storage.v20171001.EncryptionServiceArgs>;
}
...
export interface IPRuleArgs {
     ...
     */
    action?: pulumi.Input<enums.storage.v20171001.Action>;
    /**
...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type: pulumi.Input<enums.storage.v20171001.IdentityType>;
}
...
export interface NetworkRuleSetArgs {
     ...
     */
    bypass?: pulumi.Input<string | enums.storage.v20171001.Bypass>;
    /**
     * Specifies the default action of allow or deny when no other rules match.
     */
    defaultAction: pulumi.Input<enums.storage.v20171001.DefaultAction>;
    /**
     * Sets the IP ACL rules
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.storage.v20171001.IPRuleArgs>[]>;
    /**
     * Sets the virtual network rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.storage.v20171001.VirtualNetworkRuleArgs>[]>;
}
/**
...
export interface RestrictionArgs {
     ...
     */
    reasonCode?: pulumi.Input<string | enums.storage.v20171001.ReasonCode>;
}
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<enums.storage.v20171001.SkuName>;
    /**
     * The restrictions because of which SKU cannot be used. This is empty if there are no restrictions.
     */
    restrictions?: pulumi.Input<pulumi.Input<inputs.storage.v20171001.RestrictionArgs>[]>;
}
...
export interface VirtualNetworkRuleArgs {
     ...
     */
    state?: pulumi.Input<enums.storage.v20171001.State>;
    /**
