...
export interface EncryptionResponse {
     ...
     */
    keyVaultProperties?: outputs.storage.v20180201.KeyVaultPropertiesResponse;
    /**
     * List of services which support encryption.
     */
    services?: outputs.storage.v20180201.EncryptionServicesResponse;
}
/**
...
export interface EncryptionServicesResponse {
     ...
     */
    blob?: outputs.storage.v20180201.EncryptionServiceResponse;
    /**
     * The encryption function of the file storage service.
     */
    file?: outputs.storage.v20180201.EncryptionServiceResponse;
    /**
     * The encryption function of the queue storage service.
     */
    queue: outputs.storage.v20180201.EncryptionServiceResponse;
    /**
     * The encryption function of the table storage service.
     */
    table: outputs.storage.v20180201.EncryptionServiceResponse;
}
...
export interface ImmutabilityPolicyPropertiesResponse {
     ...
     */
    updateHistory: outputs.storage.v20180201.UpdateHistoryPropertyResponse[];
}
...
export interface LegalHoldPropertiesResponse {
     ...
     */
    tags?: outputs.storage.v20180201.TagPropertyResponse[];
}
...
export interface NetworkRuleSetResponse {
     ...
     */
    ipRules?: outputs.storage.v20180201.IPRuleResponse[];
    /**
     * Sets the virtual network rules
     */
    virtualNetworkRules?: outputs.storage.v20180201.VirtualNetworkRuleResponse[];
}
/**
...
export interface SkuResponse {
     ...
     * The capability information in the specified sku, including file encryption, network acls, change notification, etc.
     */
    capabilities: outputs.storage.v20180201.SKUCapabilityResponse[];
    /**
     ...
     */
    restrictions?: outputs.storage.v20180201.RestrictionResponse[];
    /**
