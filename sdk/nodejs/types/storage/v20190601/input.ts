...
export interface AzureFilesIdentityBasedAuthenticationArgs {
     ...
     */
    activeDirectoryProperties?: pulumi.Input<inputs.storage.v20190601.ActiveDirectoryPropertiesArgs>;
    /**
     * Indicates the directory service used.
     */
    directoryServiceOptions: pulumi.Input<string | enums.storage.v20190601.DirectoryServiceOptions>;
}
...
export interface BlobInventoryPolicyDefinitionArgs {
     ...
     */
    filters: pulumi.Input<inputs.storage.v20190601.BlobInventoryPolicyFilterArgs>;
}
...
export interface BlobInventoryPolicyRuleArgs {
     ...
     */
    definition: pulumi.Input<inputs.storage.v20190601.BlobInventoryPolicyDefinitionArgs>;
    /**
...
export interface BlobInventoryPolicySchemaArgs {
     ...
     */
    rules: pulumi.Input<pulumi.Input<inputs.storage.v20190601.BlobInventoryPolicyRuleArgs>[]>;
    /**
     * The valid value is Inventory
     */
    type: pulumi.Input<string | enums.storage.v20190601.InventoryRuleType>;
}
...
export interface CorsRulesArgs {
     ...
     */
    corsRules?: pulumi.Input<pulumi.Input<inputs.storage.v20190601.CorsRuleArgs>[]>;
}
...
export interface EncryptionArgs {
     ...
     */
    keySource: pulumi.Input<string | enums.storage.v20190601.KeySource>;
    /**
     * Properties provided by key vault.
     */
    keyVaultProperties?: pulumi.Input<inputs.storage.v20190601.KeyVaultPropertiesArgs>;
    /**
     ...
     */
    services?: pulumi.Input<inputs.storage.v20190601.EncryptionServicesArgs>;
}
/**
...
export interface EncryptionServiceArgs {
     ...
     */
    keyType?: pulumi.Input<string | enums.storage.v20190601.KeyType>;
}
...
export interface EncryptionServicesArgs {
     ...
     */
    blob?: pulumi.Input<inputs.storage.v20190601.EncryptionServiceArgs>;
    /**
     * The encryption function of the file storage service.
     */
    file?: pulumi.Input<inputs.storage.v20190601.EncryptionServiceArgs>;
    /**
     * The encryption function of the queue storage service.
     */
    queue?: pulumi.Input<inputs.storage.v20190601.EncryptionServiceArgs>;
    /**
     * The encryption function of the table storage service.
     */
    table?: pulumi.Input<inputs.storage.v20190601.EncryptionServiceArgs>;
}
...
export interface IPRuleArgs {
     ...
     */
    action?: pulumi.Input<enums.storage.v20190601.Action>;
    /**
...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type: pulumi.Input<enums.storage.v20190601.IdentityType>;
}
...
export interface LastAccessTimeTrackingPolicyArgs {
     ...
     */
    name?: pulumi.Input<string | enums.storage.v20190601.Name>;
    /**
...
export interface ManagementPolicyActionArgs {
     ...
     */
    baseBlob?: pulumi.Input<inputs.storage.v20190601.ManagementPolicyBaseBlobArgs>;
    /**
     * The management policy action for snapshot
     */
    snapshot?: pulumi.Input<inputs.storage.v20190601.ManagementPolicySnapShotArgs>;
    /**
     * The management policy action for version
     */
    version?: pulumi.Input<inputs.storage.v20190601.ManagementPolicyVersionArgs>;
}
...
export interface ManagementPolicyBaseBlobArgs {
     ...
     */
    delete?: pulumi.Input<inputs.storage.v20190601.DateAfterModificationArgs>;
    /**
     ...
     */
    tierToArchive?: pulumi.Input<inputs.storage.v20190601.DateAfterModificationArgs>;
    /**
     * The function to tier blobs to cool storage. Support blobs currently at Hot tier
     */
    tierToCool?: pulumi.Input<inputs.storage.v20190601.DateAfterModificationArgs>;
}
...
export interface ManagementPolicyDefinitionArgs {
     ...
     */
    actions: pulumi.Input<inputs.storage.v20190601.ManagementPolicyActionArgs>;
    /**
     * An object that defines the filter set.
     */
    filters?: pulumi.Input<inputs.storage.v20190601.ManagementPolicyFilterArgs>;
}
...
export interface ManagementPolicyFilterArgs {
     ...
     */
    blobIndexMatch?: pulumi.Input<pulumi.Input<inputs.storage.v20190601.TagFilterArgs>[]>;
    /**
...
export interface ManagementPolicyRuleArgs {
     ...
     */
    definition: pulumi.Input<inputs.storage.v20190601.ManagementPolicyDefinitionArgs>;
    /**
     ...
     */
    type: pulumi.Input<string | enums.storage.v20190601.RuleType>;
}
...
export interface ManagementPolicySchemaArgs {
     ...
     * The Storage Account ManagementPolicies Rules. See more details in: https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts.
     */
    rules: pulumi.Input<pulumi.Input<inputs.storage.v20190601.ManagementPolicyRuleArgs>[]>;
}
...
export interface ManagementPolicySnapShotArgs {
     ...
     */
    delete?: pulumi.Input<inputs.storage.v20190601.DateAfterCreationArgs>;
    /**
     * The function to tier blob snapshot to archive storage. Support blob snapshot currently at Hot or Cool tier
     */
    tierToArchive?: pulumi.Input<inputs.storage.v20190601.DateAfterCreationArgs>;
    /**
     * The function to tier blob snapshot to cool storage. Support blob snapshot currently at Hot tier
     */
    tierToCool?: pulumi.Input<inputs.storage.v20190601.DateAfterCreationArgs>;
}
...
export interface NetworkRuleSetArgs {
     ...
     */
    bypass?: pulumi.Input<string | enums.storage.v20190601.Bypass>;
    /**
     * Specifies the default action of allow or deny when no other rules match.
     */
    defaultAction: pulumi.Input<enums.storage.v20190601.DefaultAction>;
    /**
     * Sets the IP ACL rules
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.storage.v20190601.IPRuleArgs>[]>;
    /**
     * Sets the virtual network rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.storage.v20190601.VirtualNetworkRuleArgs>[]>;
}
/**
...
export interface ObjectReplicationPolicyRuleArgs {
     ...
     */
    filters?: pulumi.Input<inputs.storage.v20190601.ObjectReplicationPolicyFilterArgs>;
    /**
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.storage.v20190601.PrivateEndpointServiceConnectionStatus>;
}
...
export interface RoutingPreferenceArgs {
     ...
     */
    routingChoice?: pulumi.Input<string | enums.storage.v20190601.RoutingChoice>;
}
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<string | enums.storage.v20190601.SkuName>;
}
...
export interface VirtualNetworkRuleArgs {
     ...
     */
    state?: pulumi.Input<enums.storage.v20190601.State>;
    /**
