...
export interface CorsRulesResponse {
     ...
     */
    corsRules?: outputs.storage.v20180701.CorsRuleResponse[];
}
...
export interface EncryptionResponse {
     ...
     */
    keyVaultProperties?: outputs.storage.v20180701.KeyVaultPropertiesResponse;
    /**
     * List of services which support encryption.
     */
    services?: outputs.storage.v20180701.EncryptionServicesResponse;
}
/**
...
export interface EncryptionServicesResponse {
     ...
     */
    blob?: outputs.storage.v20180701.EncryptionServiceResponse;
    /**
     * The encryption function of the file storage service.
     */
    file?: outputs.storage.v20180701.EncryptionServiceResponse;
    /**
     * The encryption function of the queue storage service.
     */
    queue: outputs.storage.v20180701.EncryptionServiceResponse;
    /**
     * The encryption function of the table storage service.
     */
    table: outputs.storage.v20180701.EncryptionServiceResponse;
}
...
export interface ImmutabilityPolicyPropertiesResponse {
     ...
     */
    updateHistory: outputs.storage.v20180701.UpdateHistoryPropertyResponse[];
}
...
export interface LegalHoldPropertiesResponse {
     ...
     */
    tags?: outputs.storage.v20180701.TagPropertyResponse[];
}
...
export interface NetworkRuleSetResponse {
     ...
     */
    ipRules?: outputs.storage.v20180701.IPRuleResponse[];
    /**
     * Sets the virtual network rules
     */
    virtualNetworkRules?: outputs.storage.v20180701.VirtualNetworkRuleResponse[];
}
/**
...
export interface SkuResponse {
     ...
     * The capability information in the specified SKU, including file encryption, network ACLs, change notification, etc.
     */
    capabilities: outputs.storage.v20180701.SKUCapabilityResponse[];
    /**
     ...
     */
    restrictions?: outputs.storage.v20180701.RestrictionResponse[];
    /**
