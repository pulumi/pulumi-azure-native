...
export interface AzureFilesIdentityBasedAuthenticationArgs {
     ...
     */
    activeDirectoryProperties?: pulumi.Input<inputs.storage.v20200801preview.ActiveDirectoryPropertiesArgs>;
    /**
     * Indicates the directory service used.
     */
    directoryServiceOptions: pulumi.Input<string | enums.storage.v20200801preview.DirectoryServiceOptions>;
}
...
export interface BlobInventoryPolicyDefinitionArgs {
     ...
     */
    filters: pulumi.Input<inputs.storage.v20200801preview.BlobInventoryPolicyFilterArgs>;
}
...
export interface BlobInventoryPolicyRuleArgs {
     ...
     */
    definition: pulumi.Input<inputs.storage.v20200801preview.BlobInventoryPolicyDefinitionArgs>;
    /**
...
export interface BlobInventoryPolicySchemaArgs {
     ...
     */
    rules: pulumi.Input<pulumi.Input<inputs.storage.v20200801preview.BlobInventoryPolicyRuleArgs>[]>;
    /**
     * The valid value is Inventory
     */
    type: pulumi.Input<string | enums.storage.v20200801preview.InventoryRuleType>;
}
...
export interface CorsRulesArgs {
     ...
     */
    corsRules?: pulumi.Input<pulumi.Input<inputs.storage.v20200801preview.CorsRuleArgs>[]>;
}
...
export interface EncryptionArgs {
     ...
     */
    keySource: pulumi.Input<string | enums.storage.v20200801preview.KeySource>;
    /**
     * Properties provided by key vault.
     */
    keyVaultProperties?: pulumi.Input<inputs.storage.v20200801preview.KeyVaultPropertiesArgs>;
    /**
     ...
     */
    services?: pulumi.Input<inputs.storage.v20200801preview.EncryptionServicesArgs>;
}
/**
...
export interface EncryptionServiceArgs {
     ...
     */
    keyType?: pulumi.Input<string | enums.storage.v20200801preview.KeyType>;
}
...
export interface EncryptionServicesArgs {
     ...
     */
    blob?: pulumi.Input<inputs.storage.v20200801preview.EncryptionServiceArgs>;
    /**
     * The encryption function of the file storage service.
     */
    file?: pulumi.Input<inputs.storage.v20200801preview.EncryptionServiceArgs>;
    /**
     * The encryption function of the queue storage service.
     */
    queue?: pulumi.Input<inputs.storage.v20200801preview.EncryptionServiceArgs>;
    /**
     * The encryption function of the table storage service.
     */
    table?: pulumi.Input<inputs.storage.v20200801preview.EncryptionServiceArgs>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type?: pulumi.Input<string | enums.storage.v20200801preview.ExtendedLocationTypes>;
}
...
export interface IPRuleArgs {
     ...
     */
    action?: pulumi.Input<enums.storage.v20200801preview.Action>;
    /**
...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type: pulumi.Input<enums.storage.v20200801preview.IdentityType>;
}
...
export interface LastAccessTimeTrackingPolicyArgs {
     ...
     */
    name?: pulumi.Input<string | enums.storage.v20200801preview.Name>;
    /**
...
export interface ManagementPolicyActionArgs {
     ...
     */
    baseBlob?: pulumi.Input<inputs.storage.v20200801preview.ManagementPolicyBaseBlobArgs>;
    /**
     * The management policy action for snapshot
     */
    snapshot?: pulumi.Input<inputs.storage.v20200801preview.ManagementPolicySnapShotArgs>;
    /**
     * The management policy action for version
     */
    version?: pulumi.Input<inputs.storage.v20200801preview.ManagementPolicyVersionArgs>;
}
...
export interface ManagementPolicyBaseBlobArgs {
     ...
     */
    delete?: pulumi.Input<inputs.storage.v20200801preview.DateAfterModificationArgs>;
    /**
     ...
     */
    tierToArchive?: pulumi.Input<inputs.storage.v20200801preview.DateAfterModificationArgs>;
    /**
     * The function to tier blobs to cool storage. Support blobs currently at Hot tier
     */
    tierToCool?: pulumi.Input<inputs.storage.v20200801preview.DateAfterModificationArgs>;
}
...
export interface ManagementPolicyDefinitionArgs {
     ...
     */
    actions: pulumi.Input<inputs.storage.v20200801preview.ManagementPolicyActionArgs>;
    /**
     * An object that defines the filter set.
     */
    filters?: pulumi.Input<inputs.storage.v20200801preview.ManagementPolicyFilterArgs>;
}
...
export interface ManagementPolicyFilterArgs {
     ...
     */
    blobIndexMatch?: pulumi.Input<pulumi.Input<inputs.storage.v20200801preview.TagFilterArgs>[]>;
    /**
...
export interface ManagementPolicyRuleArgs {
     ...
     */
    definition: pulumi.Input<inputs.storage.v20200801preview.ManagementPolicyDefinitionArgs>;
    /**
     ...
     */
    type: pulumi.Input<string | enums.storage.v20200801preview.RuleType>;
}
...
export interface ManagementPolicySchemaArgs {
     ...
     * The Storage Account ManagementPolicies Rules. See more details in: https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts.
     */
    rules: pulumi.Input<pulumi.Input<inputs.storage.v20200801preview.ManagementPolicyRuleArgs>[]>;
}
...
export interface ManagementPolicySnapShotArgs {
     ...
     */
    delete?: pulumi.Input<inputs.storage.v20200801preview.DateAfterCreationArgs>;
    /**
     * The function to tier blob snapshot to archive storage. Support blob snapshot currently at Hot or Cool tier
     */
    tierToArchive?: pulumi.Input<inputs.storage.v20200801preview.DateAfterCreationArgs>;
    /**
     * The function to tier blob snapshot to cool storage. Support blob snapshot currently at Hot tier
     */
    tierToCool?: pulumi.Input<inputs.storage.v20200801preview.DateAfterCreationArgs>;
}
...
export interface NetworkRuleSetArgs {
     ...
     */
    bypass?: pulumi.Input<string | enums.storage.v20200801preview.Bypass>;
    /**
     * Specifies the default action of allow or deny when no other rules match.
     */
    defaultAction: pulumi.Input<enums.storage.v20200801preview.DefaultAction>;
    /**
     * Sets the IP ACL rules
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.storage.v20200801preview.IPRuleArgs>[]>;
    resourceAccessRules?: pulumi.Input<pulumi.Input<inputs.storage.v20200801preview.ResourceAccessRuleArgs>[]>;
    /**
     * Sets the virtual network rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.storage.v20200801preview.VirtualNetworkRuleArgs>[]>;
}
/**
...
export interface ObjectReplicationPolicyRuleArgs {
     ...
     */
    filters?: pulumi.Input<inputs.storage.v20200801preview.ObjectReplicationPolicyFilterArgs>;
    /**
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.storage.v20200801preview.PrivateEndpointServiceConnectionStatus>;
}
...
export interface ProtocolSettingsArgs {
     ...
     */
    smb?: pulumi.Input<inputs.storage.v20200801preview.SmbSettingArgs>;
}
...
export interface RoutingPreferenceArgs {
     ...
     */
    routingChoice?: pulumi.Input<string | enums.storage.v20200801preview.RoutingChoice>;
}
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<string | enums.storage.v20200801preview.SkuName>;
}
...
export interface SmbSettingArgs {
     ...
     * Multichannel setting. Applies to Premium FileStorage only.
     */
    multichannel?: pulumi.Input<inputs.storage.v20200801preview.MultichannelArgs>;
}
...
export interface VirtualNetworkRuleArgs {
     ...
     */
    state?: pulumi.Input<enums.storage.v20200801preview.State>;
    /**
