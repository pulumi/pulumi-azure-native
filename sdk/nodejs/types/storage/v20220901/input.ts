...
export interface AccountImmutabilityPolicyPropertiesArgs {
     ...
     */
    state?: pulumi.Input<string | enums.storage.v20220901.AccountImmutabilityPolicyState>;
}
...
export interface ActiveDirectoryPropertiesArgs {
     ...
     */
    accountType?: pulumi.Input<string | enums.storage.v20220901.AccountType>;
    /**
...
export interface AzureFilesIdentityBasedAuthenticationArgs {
     ...
     */
    activeDirectoryProperties?: pulumi.Input<inputs.storage.v20220901.ActiveDirectoryPropertiesArgs>;
    /**
     * Default share permission for users using Kerberos authentication if RBAC role is not assigned.
     */
    defaultSharePermission?: pulumi.Input<string | enums.storage.v20220901.DefaultSharePermission>;
    /**
     * Indicates the directory service used. Note that this enum may be extended in the future.
     */
    directoryServiceOptions: pulumi.Input<string | enums.storage.v20220901.DirectoryServiceOptions>;
}
...
export interface BlobInventoryPolicyDefinitionArgs {
     ...
     */
    filters?: pulumi.Input<inputs.storage.v20220901.BlobInventoryPolicyFilterArgs>;
    /**
     * This is a required field, it specifies the format for the inventory files.
     */
    format: pulumi.Input<string | enums.storage.v20220901.Format>;
    /**
     * This is a required field. This field specifies the scope of the inventory created either at the blob or container level.
     */
    objectType: pulumi.Input<string | enums.storage.v20220901.ObjectType>;
    /**
     * This is a required field. This field is used to schedule an inventory formation.
     */
    schedule: pulumi.Input<string | enums.storage.v20220901.Schedule>;
    /**
...
export interface BlobInventoryPolicyRuleArgs {
     ...
     */
    definition: pulumi.Input<inputs.storage.v20220901.BlobInventoryPolicyDefinitionArgs>;
    /**
...
export interface BlobInventoryPolicySchemaArgs {
     ...
     */
    rules: pulumi.Input<pulumi.Input<inputs.storage.v20220901.BlobInventoryPolicyRuleArgs>[]>;
    /**
     * The valid value is Inventory
     */
    type: pulumi.Input<string | enums.storage.v20220901.InventoryRuleType>;
}
...
export interface CorsRuleArgs {
     ...
     */
    allowedMethods: pulumi.Input<pulumi.Input<string | enums.storage.v20220901.AllowedMethods>[]>;
    /**
...
export interface CorsRulesArgs {
     ...
     */
    corsRules?: pulumi.Input<pulumi.Input<inputs.storage.v20220901.CorsRuleArgs>[]>;
}
...
export interface EncryptionArgs {
     ...
     */
    encryptionIdentity?: pulumi.Input<inputs.storage.v20220901.EncryptionIdentityArgs>;
    /**
     * The encryption keySource (provider). Possible values (case-insensitive):  Microsoft.Storage, Microsoft.Keyvault
     */
    keySource?: pulumi.Input<string | enums.storage.v20220901.KeySource>;
    /**
     * Properties provided by key vault.
     */
    keyVaultProperties?: pulumi.Input<inputs.storage.v20220901.KeyVaultPropertiesArgs>;
    /**
     ...
     */
    services?: pulumi.Input<inputs.storage.v20220901.EncryptionServicesArgs>;
}
/**
...
export interface EncryptionServiceArgs {
     ...
     */
    keyType?: pulumi.Input<string | enums.storage.v20220901.KeyType>;
}
...
export interface EncryptionServicesArgs {
     ...
     */
    blob?: pulumi.Input<inputs.storage.v20220901.EncryptionServiceArgs>;
    /**
     * The encryption function of the file storage service.
     */
    file?: pulumi.Input<inputs.storage.v20220901.EncryptionServiceArgs>;
    /**
     * The encryption function of the queue storage service.
     */
    queue?: pulumi.Input<inputs.storage.v20220901.EncryptionServiceArgs>;
    /**
     * The encryption function of the table storage service.
     */
    table?: pulumi.Input<inputs.storage.v20220901.EncryptionServiceArgs>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type?: pulumi.Input<string | enums.storage.v20220901.ExtendedLocationTypes>;
}
...
export interface IPRuleArgs {
     ...
     */
    action?: pulumi.Input<enums.storage.v20220901.Action>;
    /**
...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type: pulumi.Input<string | enums.storage.v20220901.IdentityType>;
    /**
...
export interface ImmutableStorageAccountArgs {
     ...
     */
    immutabilityPolicy?: pulumi.Input<inputs.storage.v20220901.AccountImmutabilityPolicyPropertiesArgs>;
}
...
export interface LastAccessTimeTrackingPolicyArgs {
     ...
     */
    name?: pulumi.Input<string | enums.storage.v20220901.Name>;
    /**
...
export interface ManagementPolicyActionArgs {
     ...
     */
    baseBlob?: pulumi.Input<inputs.storage.v20220901.ManagementPolicyBaseBlobArgs>;
    /**
     * The management policy action for snapshot
     */
    snapshot?: pulumi.Input<inputs.storage.v20220901.ManagementPolicySnapShotArgs>;
    /**
     * The management policy action for version
     */
    version?: pulumi.Input<inputs.storage.v20220901.ManagementPolicyVersionArgs>;
}
...
export interface ManagementPolicyBaseBlobArgs {
     ...
     */
    delete?: pulumi.Input<inputs.storage.v20220901.DateAfterModificationArgs>;
    /**
     ...
     */
    tierToArchive?: pulumi.Input<inputs.storage.v20220901.DateAfterModificationArgs>;
    /**
     * The function to tier blobs to cold storage.
     */
    tierToCold?: pulumi.Input<inputs.storage.v20220901.DateAfterModificationArgs>;
    /**
     * The function to tier blobs to cool storage.
     */
    tierToCool?: pulumi.Input<inputs.storage.v20220901.DateAfterModificationArgs>;
    /**
     * The function to tier blobs to hot storage. This action can only be used with Premium Block Blob Storage Accounts
     */
    tierToHot?: pulumi.Input<inputs.storage.v20220901.DateAfterModificationArgs>;
}
...
export interface ManagementPolicyDefinitionArgs {
     ...
     */
    actions: pulumi.Input<inputs.storage.v20220901.ManagementPolicyActionArgs>;
    /**
     * An object that defines the filter set.
     */
    filters?: pulumi.Input<inputs.storage.v20220901.ManagementPolicyFilterArgs>;
}
...
export interface ManagementPolicyFilterArgs {
     ...
     */
    blobIndexMatch?: pulumi.Input<pulumi.Input<inputs.storage.v20220901.TagFilterArgs>[]>;
    /**
...
export interface ManagementPolicyRuleArgs {
     ...
     */
    definition: pulumi.Input<inputs.storage.v20220901.ManagementPolicyDefinitionArgs>;
    /**
     ...
     */
    type: pulumi.Input<string | enums.storage.v20220901.RuleType>;
}
...
export interface ManagementPolicySchemaArgs {
     ...
     * The Storage Account ManagementPolicies Rules. See more details in: https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts.
     */
    rules: pulumi.Input<pulumi.Input<inputs.storage.v20220901.ManagementPolicyRuleArgs>[]>;
}
...
export interface ManagementPolicySnapShotArgs {
     ...
     */
    delete?: pulumi.Input<inputs.storage.v20220901.DateAfterCreationArgs>;
    /**
     * The function to tier blob snapshot to archive storage.
     */
    tierToArchive?: pulumi.Input<inputs.storage.v20220901.DateAfterCreationArgs>;
    /**
     * The function to tier blobs to cold storage.
     */
    tierToCold?: pulumi.Input<inputs.storage.v20220901.DateAfterCreationArgs>;
    /**
     * The function to tier blob snapshot to cool storage.
     */
    tierToCool?: pulumi.Input<inputs.storage.v20220901.DateAfterCreationArgs>;
    /**
     * The function to tier blobs to hot storage. This action can only be used with Premium Block Blob Storage Accounts
     */
    tierToHot?: pulumi.Input<inputs.storage.v20220901.DateAfterCreationArgs>;
}
...
export interface NetworkRuleSetArgs {
     ...
     */
    bypass?: pulumi.Input<string | enums.storage.v20220901.Bypass>;
    /**
     * Specifies the default action of allow or deny when no other rules match.
     */
    defaultAction: pulumi.Input<enums.storage.v20220901.DefaultAction>;
    /**
     * Sets the IP ACL rules
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.storage.v20220901.IPRuleArgs>[]>;
    /**
     * Sets the resource access rules
     */
    resourceAccessRules?: pulumi.Input<pulumi.Input<inputs.storage.v20220901.ResourceAccessRuleArgs>[]>;
    /**
     * Sets the virtual network rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.storage.v20220901.VirtualNetworkRuleArgs>[]>;
}
/**
...
export interface ObjectReplicationPolicyRuleArgs {
     ...
     */
    filters?: pulumi.Input<inputs.storage.v20220901.ObjectReplicationPolicyFilterArgs>;
    /**
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.storage.v20220901.PrivateEndpointServiceConnectionStatus>;
}
...
export interface ProtocolSettingsArgs {
     ...
     */
    smb?: pulumi.Input<inputs.storage.v20220901.SmbSettingArgs>;
}
...
export interface RoutingPreferenceArgs {
     ...
     */
    routingChoice?: pulumi.Input<string | enums.storage.v20220901.RoutingChoice>;
}
...
export interface SasPolicyArgs {
     ...
     */
    expirationAction: pulumi.Input<string | enums.storage.v20220901.ExpirationAction>;
    /**
...
export interface SignedIdentifierArgs {
     ...
     * Access policy
     */
    accessPolicy?: pulumi.Input<inputs.storage.v20220901.AccessPolicyArgs>;
    /**
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<string | enums.storage.v20220901.SkuName>;
}
...
export interface SmbSettingArgs {
     ...
     * Multichannel setting. Applies to Premium FileStorage only.
     */
    multichannel?: pulumi.Input<inputs.storage.v20220901.MultichannelArgs>;
    /**
...
export interface TableSignedIdentifierArgs {
     ...
     * Access policy
     */
    accessPolicy?: pulumi.Input<inputs.storage.v20220901.TableAccessPolicyArgs>;
    /**
...
export interface VirtualNetworkRuleArgs {
     ...
     */
    state?: pulumi.Input<string | enums.storage.v20220901.State>;
    /**
