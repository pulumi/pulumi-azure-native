...
export interface AzureFilesIdentityBasedAuthenticationResponse {
     ...
     */
    activeDirectoryProperties?: outputs.storage.v20210201.ActiveDirectoryPropertiesResponse;
    /**
...
export interface BlobInventoryPolicyDefinitionResponse {
     ...
     */
    filters: outputs.storage.v20210201.BlobInventoryPolicyFilterResponse;
}
...
export interface BlobInventoryPolicyRuleResponse {
     ...
     */
    definition: outputs.storage.v20210201.BlobInventoryPolicyDefinitionResponse;
    /**
...
export interface BlobInventoryPolicySchemaResponse {
     ...
     */
    rules: outputs.storage.v20210201.BlobInventoryPolicyRuleResponse[];
    /**
...
export interface BlobRestoreParametersResponse {
     ...
     */
    blobRanges: outputs.storage.v20210201.BlobRestoreRangeResponse[];
    /**
...
export interface BlobRestoreStatusResponse {
     ...
     */
    parameters: outputs.storage.v20210201.BlobRestoreParametersResponse;
    /**
...
export interface CorsRulesResponse {
     ...
     */
    corsRules?: outputs.storage.v20210201.CorsRuleResponse[];
}
...
export interface EncryptionResponse {
     ...
     */
    encryptionIdentity?: outputs.storage.v20210201.EncryptionIdentityResponse;
    /**
     ...
     */
    keyVaultProperties?: outputs.storage.v20210201.KeyVaultPropertiesResponse;
    /**
     ...
     */
    services?: outputs.storage.v20210201.EncryptionServicesResponse;
}
/**
...
export interface EncryptionServicesResponse {
     ...
     */
    blob?: outputs.storage.v20210201.EncryptionServiceResponse;
    /**
     * The encryption function of the file storage service.
     */
    file?: outputs.storage.v20210201.EncryptionServiceResponse;
    /**
     * The encryption function of the queue storage service.
     */
    queue?: outputs.storage.v20210201.EncryptionServiceResponse;
    /**
     * The encryption function of the table storage service.
     */
    table?: outputs.storage.v20210201.EncryptionServiceResponse;
}
...
export interface EndpointsResponse {
     ...
     */
    internetEndpoints?: outputs.storage.v20210201.StorageAccountInternetEndpointsResponse;
    /**
     * Gets the microsoft routing storage endpoints.
     */
    microsoftEndpoints?: outputs.storage.v20210201.StorageAccountMicrosoftEndpointsResponse;
    /**
...
export interface IdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.storage.v20210201.UserAssignedIdentityResponse};
}
...
export interface ImmutabilityPolicyPropertiesResponse {
     ...
     */
    updateHistory: outputs.storage.v20210201.UpdateHistoryPropertyResponse[];
}
...
export interface LegalHoldPropertiesResponse {
     ...
     */
    tags?: outputs.storage.v20210201.TagPropertyResponse[];
}
...
export interface ManagementPolicyActionResponse {
     ...
     */
    baseBlob?: outputs.storage.v20210201.ManagementPolicyBaseBlobResponse;
    /**
     * The management policy action for snapshot
     */
    snapshot?: outputs.storage.v20210201.ManagementPolicySnapShotResponse;
    /**
     * The management policy action for version
     */
    version?: outputs.storage.v20210201.ManagementPolicyVersionResponse;
}
...
export interface ManagementPolicyBaseBlobResponse {
     ...
     */
    delete?: outputs.storage.v20210201.DateAfterModificationResponse;
    /**
     ...
     */
    tierToArchive?: outputs.storage.v20210201.DateAfterModificationResponse;
    /**
     * The function to tier blobs to cool storage. Support blobs currently at Hot tier
     */
    tierToCool?: outputs.storage.v20210201.DateAfterModificationResponse;
}
...
export interface ManagementPolicyDefinitionResponse {
     ...
     */
    actions: outputs.storage.v20210201.ManagementPolicyActionResponse;
    /**
     * An object that defines the filter set.
     */
    filters?: outputs.storage.v20210201.ManagementPolicyFilterResponse;
}
...
export interface ManagementPolicyFilterResponse {
     ...
     */
    blobIndexMatch?: outputs.storage.v20210201.TagFilterResponse[];
    /**
...
export interface ManagementPolicyRuleResponse {
     ...
     */
    definition: outputs.storage.v20210201.ManagementPolicyDefinitionResponse;
    /**
...
export interface ManagementPolicySchemaResponse {
     ...
     * The Storage Account ManagementPolicies Rules. See more details in: https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts.
     */
    rules: outputs.storage.v20210201.ManagementPolicyRuleResponse[];
}
...
export interface NetworkRuleSetResponse {
     ...
     */
    ipRules?: outputs.storage.v20210201.IPRuleResponse[];
    /**
     * Sets the resource access rules
     */
    resourceAccessRules?: outputs.storage.v20210201.ResourceAccessRuleResponse[];
    /**
     * Sets the virtual network rules
     */
    virtualNetworkRules?: outputs.storage.v20210201.VirtualNetworkRuleResponse[];
}
/**
...
export interface ObjectReplicationPolicyRuleResponse {
     ...
     */
    filters?: outputs.storage.v20210201.ObjectReplicationPolicyFilterResponse;
    /**
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.storage.v20210201.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: outputs.storage.v20210201.PrivateLinkServiceConnectionStateResponse;
    /**
...
export interface ProtocolSettingsResponse {
     ...
     */
    smb?: outputs.storage.v20210201.SmbSettingResponse;
}
...
export interface SmbSettingResponse {
     ...
     * Multichannel setting. Applies to Premium FileStorage only.
     */
    multichannel?: outputs.storage.v20210201.MultichannelResponse;
    /**
