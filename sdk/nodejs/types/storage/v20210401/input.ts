...
export interface AzureFilesIdentityBasedAuthenticationArgs {
     ...
     */
    activeDirectoryProperties?: pulumi.Input<inputs.storage.v20210401.ActiveDirectoryPropertiesArgs>;
    /**
     * Default share permission for users using Kerberos authentication if RBAC role is not assigned.
     */
    defaultSharePermission?: pulumi.Input<string | enums.storage.v20210401.DefaultSharePermission>;
    /**
     * Indicates the directory service used.
     */
    directoryServiceOptions: pulumi.Input<string | enums.storage.v20210401.DirectoryServiceOptions>;
}
...
export interface BlobInventoryPolicyDefinitionArgs {
     ...
     */
    filters?: pulumi.Input<inputs.storage.v20210401.BlobInventoryPolicyFilterArgs>;
    /**
     * This is a required field, it specifies the format for the inventory files.
     */
    format: pulumi.Input<string | enums.storage.v20210401.Format>;
    /**
     * This is a required field. This field specifies the scope of the inventory created either at the blob or container level.
     */
    objectType: pulumi.Input<string | enums.storage.v20210401.ObjectType>;
    /**
     * This is a required field. This field is used to schedule an inventory formation.
     */
    schedule: pulumi.Input<string | enums.storage.v20210401.Schedule>;
    /**
...
export interface BlobInventoryPolicyRuleArgs {
     ...
     */
    definition: pulumi.Input<inputs.storage.v20210401.BlobInventoryPolicyDefinitionArgs>;
    /**
...
export interface BlobInventoryPolicySchemaArgs {
     ...
     */
    rules: pulumi.Input<pulumi.Input<inputs.storage.v20210401.BlobInventoryPolicyRuleArgs>[]>;
    /**
     * The valid value is Inventory
     */
    type: pulumi.Input<string | enums.storage.v20210401.InventoryRuleType>;
}
...
export interface CorsRulesArgs {
     ...
     */
    corsRules?: pulumi.Input<pulumi.Input<inputs.storage.v20210401.CorsRuleArgs>[]>;
}
...
export interface EncryptionArgs {
     ...
     */
    encryptionIdentity?: pulumi.Input<inputs.storage.v20210401.EncryptionIdentityArgs>;
    /**
     * The encryption keySource (provider). Possible values (case-insensitive):  Microsoft.Storage, Microsoft.Keyvault
     */
    keySource: pulumi.Input<string | enums.storage.v20210401.KeySource>;
    /**
     * Properties provided by key vault.
     */
    keyVaultProperties?: pulumi.Input<inputs.storage.v20210401.KeyVaultPropertiesArgs>;
    /**
     ...
     */
    services?: pulumi.Input<inputs.storage.v20210401.EncryptionServicesArgs>;
}
/**
...
export interface EncryptionServiceArgs {
     ...
     */
    keyType?: pulumi.Input<string | enums.storage.v20210401.KeyType>;
}
...
export interface EncryptionServicesArgs {
     ...
     */
    blob?: pulumi.Input<inputs.storage.v20210401.EncryptionServiceArgs>;
    /**
     * The encryption function of the file storage service.
     */
    file?: pulumi.Input<inputs.storage.v20210401.EncryptionServiceArgs>;
    /**
     * The encryption function of the queue storage service.
     */
    queue?: pulumi.Input<inputs.storage.v20210401.EncryptionServiceArgs>;
    /**
     * The encryption function of the table storage service.
     */
    table?: pulumi.Input<inputs.storage.v20210401.EncryptionServiceArgs>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type?: pulumi.Input<string | enums.storage.v20210401.ExtendedLocationTypes>;
}
...
export interface IPRuleArgs {
     ...
     */
    action?: pulumi.Input<enums.storage.v20210401.Action>;
    /**
...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type: pulumi.Input<string | enums.storage.v20210401.IdentityType>;
    /**
...
export interface LastAccessTimeTrackingPolicyArgs {
     ...
     */
    name?: pulumi.Input<string | enums.storage.v20210401.Name>;
    /**
...
export interface ManagementPolicyActionArgs {
     ...
     */
    baseBlob?: pulumi.Input<inputs.storage.v20210401.ManagementPolicyBaseBlobArgs>;
    /**
     * The management policy action for snapshot
     */
    snapshot?: pulumi.Input<inputs.storage.v20210401.ManagementPolicySnapShotArgs>;
    /**
     * The management policy action for version
     */
    version?: pulumi.Input<inputs.storage.v20210401.ManagementPolicyVersionArgs>;
}
...
export interface ManagementPolicyBaseBlobArgs {
     ...
     */
    delete?: pulumi.Input<inputs.storage.v20210401.DateAfterModificationArgs>;
    /**
     ...
     */
    tierToArchive?: pulumi.Input<inputs.storage.v20210401.DateAfterModificationArgs>;
    /**
     * The function to tier blobs to cool storage. Support blobs currently at Hot tier
     */
    tierToCool?: pulumi.Input<inputs.storage.v20210401.DateAfterModificationArgs>;
}
...
export interface ManagementPolicyDefinitionArgs {
     ...
     */
    actions: pulumi.Input<inputs.storage.v20210401.ManagementPolicyActionArgs>;
    /**
     * An object that defines the filter set.
     */
    filters?: pulumi.Input<inputs.storage.v20210401.ManagementPolicyFilterArgs>;
}
...
export interface ManagementPolicyFilterArgs {
     ...
     */
    blobIndexMatch?: pulumi.Input<pulumi.Input<inputs.storage.v20210401.TagFilterArgs>[]>;
    /**
...
export interface ManagementPolicyRuleArgs {
     ...
     */
    definition: pulumi.Input<inputs.storage.v20210401.ManagementPolicyDefinitionArgs>;
    /**
     ...
     */
    type: pulumi.Input<string | enums.storage.v20210401.RuleType>;
}
...
export interface ManagementPolicySchemaArgs {
     ...
     * The Storage Account ManagementPolicies Rules. See more details in: https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts.
     */
    rules: pulumi.Input<pulumi.Input<inputs.storage.v20210401.ManagementPolicyRuleArgs>[]>;
}
...
export interface ManagementPolicySnapShotArgs {
     ...
     */
    delete?: pulumi.Input<inputs.storage.v20210401.DateAfterCreationArgs>;
    /**
     * The function to tier blob snapshot to archive storage. Support blob snapshot currently at Hot or Cool tier
     */
    tierToArchive?: pulumi.Input<inputs.storage.v20210401.DateAfterCreationArgs>;
    /**
     * The function to tier blob snapshot to cool storage. Support blob snapshot currently at Hot tier
     */
    tierToCool?: pulumi.Input<inputs.storage.v20210401.DateAfterCreationArgs>;
}
...
export interface NetworkRuleSetArgs {
     ...
     */
    bypass?: pulumi.Input<string | enums.storage.v20210401.Bypass>;
    /**
     * Specifies the default action of allow or deny when no other rules match.
     */
    defaultAction: pulumi.Input<enums.storage.v20210401.DefaultAction>;
    /**
     * Sets the IP ACL rules
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.storage.v20210401.IPRuleArgs>[]>;
    /**
     * Sets the resource access rules
     */
    resourceAccessRules?: pulumi.Input<pulumi.Input<inputs.storage.v20210401.ResourceAccessRuleArgs>[]>;
    /**
     * Sets the virtual network rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.storage.v20210401.VirtualNetworkRuleArgs>[]>;
}
/**
...
export interface ObjectReplicationPolicyRuleArgs {
     ...
     */
    filters?: pulumi.Input<inputs.storage.v20210401.ObjectReplicationPolicyFilterArgs>;
    /**
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.storage.v20210401.PrivateEndpointServiceConnectionStatus>;
}
...
export interface ProtocolSettingsArgs {
     ...
     */
    smb?: pulumi.Input<inputs.storage.v20210401.SmbSettingArgs>;
}
...
export interface RoutingPreferenceArgs {
     ...
     */
    routingChoice?: pulumi.Input<string | enums.storage.v20210401.RoutingChoice>;
}
...
export interface SasPolicyArgs {
     ...
     */
    expirationAction: pulumi.Input<string | enums.storage.v20210401.ExpirationAction>;
    /**
...
export interface SignedIdentifierArgs {
     ...
     * Access policy
     */
    accessPolicy?: pulumi.Input<inputs.storage.v20210401.AccessPolicyArgs>;
    /**
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<string | enums.storage.v20210401.SkuName>;
}
...
export interface SmbSettingArgs {
     ...
     * Multichannel setting. Applies to Premium FileStorage only.
     */
    multichannel?: pulumi.Input<inputs.storage.v20210401.MultichannelArgs>;
    /**
...
export interface VirtualNetworkRuleArgs {
     ...
     */
    state?: pulumi.Input<string | enums.storage.v20210401.State>;
    /**
