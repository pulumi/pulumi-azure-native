...
export interface EncryptionResponse {
     ...
     */
    keyVaultProperties?: outputs.storage.v20170601.KeyVaultPropertiesResponse;
    /**
     * List of services which support encryption.
     */
    services?: outputs.storage.v20170601.EncryptionServicesResponse;
}
/**
...
export interface EncryptionServicesResponse {
     ...
     */
    blob?: outputs.storage.v20170601.EncryptionServiceResponse;
    /**
     * The encryption function of the file storage service.
     */
    file?: outputs.storage.v20170601.EncryptionServiceResponse;
    /**
     * The encryption function of the queue storage service.
     */
    queue: outputs.storage.v20170601.EncryptionServiceResponse;
    /**
     * The encryption function of the table storage service.
     */
    table: outputs.storage.v20170601.EncryptionServiceResponse;
}
...
export interface NetworkRuleSetResponse {
     ...
     */
    ipRules?: outputs.storage.v20170601.IPRuleResponse[];
    /**
     * Sets the virtual network rules
     */
    virtualNetworkRules?: outputs.storage.v20170601.VirtualNetworkRuleResponse[];
}
/**
...
export interface SkuResponse {
     ...
     * The capability information in the specified sku, including file encryption, network acls, change notification, etc.
     */
    capabilities: outputs.storage.v20170601.SKUCapabilityResponse[];
    /**
     ...
     */
    restrictions?: outputs.storage.v20170601.RestrictionResponse[];
    /**
