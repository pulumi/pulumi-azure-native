...
export interface EncryptionArgs {
     ...
     */
    keySource: pulumi.Input<string | enums.storage.v20170601.KeySource>;
    /**
     * Properties provided by key vault.
     */
    keyVaultProperties?: pulumi.Input<inputs.storage.v20170601.KeyVaultPropertiesArgs>;
    /**
     * List of services which support encryption.
     */
    services?: pulumi.Input<inputs.storage.v20170601.EncryptionServicesArgs>;
}
/**
...
export interface EncryptionServicesArgs {
     ...
     */
    blob?: pulumi.Input<inputs.storage.v20170601.EncryptionServiceArgs>;
    /**
     * The encryption function of the file storage service.
     */
    file?: pulumi.Input<inputs.storage.v20170601.EncryptionServiceArgs>;
}
...
export interface IPRuleArgs {
     ...
     */
    action?: pulumi.Input<enums.storage.v20170601.Action>;
    /**
...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type: pulumi.Input<enums.storage.v20170601.IdentityType>;
}
...
export interface NetworkRuleSetArgs {
     ...
     */
    bypass?: pulumi.Input<string | enums.storage.v20170601.Bypass>;
    /**
     * Specifies the default action of allow or deny when no other rules match.
     */
    defaultAction: pulumi.Input<enums.storage.v20170601.DefaultAction>;
    /**
     * Sets the IP ACL rules
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.storage.v20170601.IPRuleArgs>[]>;
    /**
     * Sets the virtual network rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.storage.v20170601.VirtualNetworkRuleArgs>[]>;
}
/**
...
export interface RestrictionArgs {
     ...
     */
    reasonCode?: pulumi.Input<string | enums.storage.v20170601.ReasonCode>;
}
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<enums.storage.v20170601.SkuName>;
    /**
     * The restrictions because of which SKU cannot be used. This is empty if there are no restrictions.
     */
    restrictions?: pulumi.Input<pulumi.Input<inputs.storage.v20170601.RestrictionArgs>[]>;
}
...
export interface VirtualNetworkRuleArgs {
     ...
     */
    state?: pulumi.Input<enums.storage.v20170601.State>;
    /**
