...
export interface CorsRulesArgs {
     ...
     */
    corsRules?: pulumi.Input<pulumi.Input<inputs.storage.v20181101.CorsRuleArgs>[]>;
}
...
export interface EncryptionArgs {
     ...
     */
    keySource: pulumi.Input<string | enums.storage.v20181101.KeySource>;
    /**
     * Properties provided by key vault.
     */
    keyVaultProperties?: pulumi.Input<inputs.storage.v20181101.KeyVaultPropertiesArgs>;
    /**
     * List of services which support encryption.
     */
    services?: pulumi.Input<inputs.storage.v20181101.EncryptionServicesArgs>;
}
/**
...
export interface EncryptionServicesArgs {
     ...
     */
    blob?: pulumi.Input<inputs.storage.v20181101.EncryptionServiceArgs>;
    /**
     * The encryption function of the file storage service.
     */
    file?: pulumi.Input<inputs.storage.v20181101.EncryptionServiceArgs>;
}
...
export interface IPRuleArgs {
     ...
     */
    action?: pulumi.Input<enums.storage.v20181101.Action>;
    /**
...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type: pulumi.Input<enums.storage.v20181101.IdentityType>;
}
...
export interface ManagementPolicyActionArgs {
     ...
     */
    baseBlob?: pulumi.Input<inputs.storage.v20181101.ManagementPolicyBaseBlobArgs>;
    /**
     * The management policy action for snapshot
     */
    snapshot?: pulumi.Input<inputs.storage.v20181101.ManagementPolicySnapShotArgs>;
}
...
export interface ManagementPolicyBaseBlobArgs {
     ...
     */
    delete?: pulumi.Input<inputs.storage.v20181101.DateAfterModificationArgs>;
    /**
     * The function to tier blobs to archive storage. Support blobs currently at Hot or Cool tier
     */
    tierToArchive?: pulumi.Input<inputs.storage.v20181101.DateAfterModificationArgs>;
    /**
     * The function to tier blobs to cool storage. Support blobs currently at Hot tier
     */
    tierToCool?: pulumi.Input<inputs.storage.v20181101.DateAfterModificationArgs>;
}
...
export interface ManagementPolicyDefinitionArgs {
     ...
     */
    actions: pulumi.Input<inputs.storage.v20181101.ManagementPolicyActionArgs>;
    /**
     * An object that defines the filter set.
     */
    filters?: pulumi.Input<inputs.storage.v20181101.ManagementPolicyFilterArgs>;
}
...
export interface ManagementPolicyRuleArgs {
     ...
     */
    definition: pulumi.Input<inputs.storage.v20181101.ManagementPolicyDefinitionArgs>;
    /**
     ...
     */
    type: pulumi.Input<string | enums.storage.v20181101.RuleType>;
}
...
export interface ManagementPolicySchemaArgs {
     ...
     * The Storage Account ManagementPolicies Rules. See more details in: https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts.
     */
    rules: pulumi.Input<pulumi.Input<inputs.storage.v20181101.ManagementPolicyRuleArgs>[]>;
}
...
export interface ManagementPolicySnapShotArgs {
     ...
     */
    delete?: pulumi.Input<inputs.storage.v20181101.DateAfterCreationArgs>;
}
...
export interface NetworkRuleSetArgs {
     ...
     */
    bypass?: pulumi.Input<string | enums.storage.v20181101.Bypass>;
    /**
     * Specifies the default action of allow or deny when no other rules match.
     */
    defaultAction: pulumi.Input<enums.storage.v20181101.DefaultAction>;
    /**
     * Sets the IP ACL rules
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.storage.v20181101.IPRuleArgs>[]>;
    /**
     * Sets the virtual network rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.storage.v20181101.VirtualNetworkRuleArgs>[]>;
}
/**
...
export interface RestrictionArgs {
     ...
     */
    reasonCode?: pulumi.Input<string | enums.storage.v20181101.ReasonCode>;
}
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<enums.storage.v20181101.SkuName>;
    /**
     * The restrictions because of which SKU cannot be used. This is empty if there are no restrictions.
     */
    restrictions?: pulumi.Input<pulumi.Input<inputs.storage.v20181101.RestrictionArgs>[]>;
}
...
export interface VirtualNetworkRuleArgs {
     ...
     */
    state?: pulumi.Input<enums.storage.v20181101.State>;
    /**
