...
export interface AccountCredentialDetailsResponse {
     ...
     */
    shareCredentialDetails: outputs.databox.v20210801preview.ShareCredentialDetailsResponse[];
}
...
export interface CloudErrorResponse {
     ...
     */
    additionalInfo: outputs.databox.v20210801preview.AdditionalErrorInfoResponse[];
    /**
     * Cloud error code.
     */
    code?: string;
     ...
     * Cloud error details.
     */
    details: outputs.databox.v20210801preview.CloudErrorResponse[];
    /**
     * Cloud error message.
     */
    message?: string;
...
export interface ContactDetailsResponse {
     ...
     */
    notificationPreference?: outputs.databox.v20210801preview.NotificationPreferenceResponse[];
    /**
...
export interface CustomerDiskJobSecretsResponse {
     ...
     */
    dcAccessSecurityCode: outputs.databox.v20210801preview.DcAccessSecurityCodeResponse;
    /**
     * Contains the list of secrets object for that device.
     */
    diskSecrets: outputs.databox.v20210801preview.DiskSecretResponse[];
    /**
     * Error while fetching the secrets.
     */
    error: outputs.databox.v20210801preview.CloudErrorResponse;
    /**
...
export interface DataBoxCustomerDiskJobDetailsResponse {
     ...
     */
    contactDetails: outputs.databox.v20210801preview.ContactDetailsResponse;
    /**
     * List of copy log details.
     */
    copyLogDetails: (outputs.databox.v20210801preview.DataBoxAccountCopyLogDetailsResponse | outputs.databox.v20210801preview.DataBoxCustomerDiskCopyLogDetailsResponse | outputs.databox.v20210801preview.DataBoxDiskCopyLogDetailsResponse | outputs.databox.v20210801preview.DataBoxHeavyAccountCopyLogDetailsResponse)[];
    /**
     * Copy progress per disk.
     */
    copyProgress: outputs.databox.v20210801preview.DataBoxCustomerDiskCopyProgressResponse[];
    /**
     * DataCenter code.
     */
     ...
     */
    dataExportDetails?: outputs.databox.v20210801preview.DataExportDetailsResponse[];
    /**
     * Details of the data to be imported into azure.
     */
    dataImportDetails?: outputs.databox.v20210801preview.DataImportDetailsResponse[];
    /**
     * Datacenter address to ship to, for the given sku and storage location.
     */
    datacenterAddress: outputs.databox.v20210801preview.DatacenterAddressInstructionResponseResponse | outputs.databox.v20210801preview.DatacenterAddressLocationResponseResponse;
    /**
     * Delivery package shipping details.
     */
    deliverToDcPackageDetails: outputs.databox.v20210801preview.PackageCarrierInfoResponse;
    /**
     * Delivery package shipping details.
     */
    deliveryPackage: outputs.databox.v20210801preview.PackageShippingDetailsResponse;
    /**
     ...
     */
    exportDiskDetailsCollection: {[key: string]: outputs.databox.v20210801preview.ExportDiskDetailsResponse};
    /**
     * Contains the map of disk serial number to the disk details for import jobs.
     */
    importDiskDetailsCollection?: {[key: string]: outputs.databox.v20210801preview.ImportDiskDetailsResponse};
    /**
     * Indicates the type of job details.
     * Expected value is 'DataBoxCustomerDisk'.
     */
     ...
     */
    jobStages: outputs.databox.v20210801preview.JobStagesResponse[];
    /**
     * Details about which key encryption type is being used.
     */
    keyEncryptionKey?: outputs.databox.v20210801preview.KeyEncryptionKeyResponse;
    /**
     * Last mitigation action performed on the job.
     */
    lastMitigationActionOnJob: outputs.databox.v20210801preview.LastMitigationActionOnJobResponse;
    /**
     * Preferences for the order.
     */
    preferences?: outputs.databox.v20210801preview.PreferencesResponse;
    /**
     * Return package shipping details.
     */
    returnPackage: outputs.databox.v20210801preview.PackageShippingDetailsResponse;
    /**
     * Return package shipping details.
     */
    returnToCustomerPackageDetails: outputs.databox.v20210801preview.PackageCarrierDetailsResponse;
    /**
     ...
     */
    shippingAddress?: outputs.databox.v20210801preview.ShippingAddressResponse;
}
/**
...
export function dataBoxCustomerDiskJobDetailsResponseProvideDefaults(val: DataBoxCustomerDiskJobDetailsResponse): DataBoxCustomerDiskJobDetailsResponse {
    return {
        ...
        keyEncryptionKey: (val.keyEncryptionKey ? outputs.databox.v20210801preview.keyEncryptionKeyResponseProvideDefaults(val.keyEncryptionKey) : undefined),
        preferences: (val.preferences ? outputs.databox.v20210801preview.preferencesResponseProvideDefaults(val.preferences) : undefined),
        shippingAddress: (val.shippingAddress ? outputs.databox.v20210801preview.shippingAddressResponseProvideDefaults(val.shippingAddress) : undefined),
    };
}
...
export interface DataBoxDiskJobDetailsResponse {
     ...
     * Copy progress per disk.
     */
    copyProgress: outputs.databox.v20210801preview.DataBoxDiskCopyProgressResponse[];
    /**
     * DataCenter code.
     */
    dataCenterCode: string;
...
export interface DataBoxHeavyJobDetailsResponse {
     ...
     */
    copyProgress: outputs.databox.v20210801preview.CopyProgressResponse[];
    /**
     * DataCenter code.
     */
    dataCenterCode: string;
...
export interface DataBoxHeavyJobSecretsResponse {
     ...
     */
    cabinetPodSecrets: outputs.databox.v20210801preview.DataBoxHeavySecretResponse[];
    /**
     * Dc Access Security Code for Customer Managed Shipping
     */
    dcAccessSecurityCode: outputs.databox.v20210801preview.DcAccessSecurityCodeResponse;
...
export interface DataBoxHeavySecretResponse {
     ...
     */
    accountCredentialDetails: outputs.databox.v20210801preview.AccountCredentialDetailsResponse[];
    /**
     ...
     */
    networkConfigurations: outputs.databox.v20210801preview.ApplianceNetworkConfigurationResponse[];
}
...
export interface DataExportDetailsResponse {
     ...
     */
    accountDetails: outputs.databox.v20210801preview.ManagedDiskDetailsResponse | outputs.databox.v20210801preview.StorageAccountDetailsResponse;
    /**
     ...
     */
    transferConfiguration: outputs.databox.v20210801preview.TransferConfigurationResponse;
}
/**
...
export function dataExportDetailsResponseProvideDefaults(val: DataExportDetailsResponse): DataExportDetailsResponse {
    return {
        ...
        transferConfiguration: outputs.databox.v20210801preview.transferConfigurationResponseProvideDefaults(val.transferConfiguration),
    };
}
...
export interface DataboxJobSecretsResponse {
     ...
     */
    podSecrets?: outputs.databox.v20210801preview.DataBoxSecretResponse[];
}
...
export interface IdentityPropertiesResponse {
     ...
     */
    userAssigned?: outputs.databox.v20210801preview.UserAssignedPropertiesResponse;
}
...
export interface KeyEncryptionKeyResponse {
     ...
     */
    identityProperties?: outputs.databox.v20210801preview.IdentityPropertiesResponse;
    /**
...
export interface PreferencesResponse {
     ...
     * Preferences related to the Encryption.
     */
    encryptionPreferences?: outputs.databox.v20210801preview.EncryptionPreferencesResponse;
    /**
     ...
     */
    transportPreferences?: outputs.databox.v20210801preview.TransportPreferencesResponse;
}
/**
...
export function preferencesResponseProvideDefaults(val: PreferencesResponse): PreferencesResponse {
    return {
        ...val,
        encryptionPreferences: (val.encryptionPreferences ? outputs.databox.v20210801preview.encryptionPreferencesResponseProvideDefaults(val.encryptionPreferences) : undefined),
    };
}
...
export interface ResourceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.databox.v20210801preview.UserAssignedIdentityResponse};
}
/**
...
export interface TransferConfigurationResponse {
     ...
     */
    transferAllDetails?: outputs.databox.v20210801preview.TransferConfigurationResponseTransferAllDetails;
    /**
     ...
     */
    transferFilterDetails?: outputs.databox.v20210801preview.TransferConfigurationResponseTransferFilterDetails;
}
/**
...
export function transferConfigurationResponseProvideDefaults(val: TransferConfigurationResponse): TransferConfigurationResponse {
    return {
        ...val,
        transferAllDetails: (val.transferAllDetails ? outputs.databox.v20210801preview.transferConfigurationResponseTransferAllDetailsProvideDefaults(val.transferAllDetails) : undefined),
        transferFilterDetails: (val.transferFilterDetails ? outputs.databox.v20210801preview.transferConfigurationResponseTransferFilterDetailsProvideDefaults(val.transferFilterDetails) : undefined),
    };
}
...
export interface TransferConfigurationResponseTransferAllDetails {
     ...
     * Details to transfer all data.
     */
    include?: outputs.databox.v20210801preview.TransferAllDetailsResponse;
}
/**
...
export function transferConfigurationResponseTransferAllDetailsProvideDefaults(val: TransferConfigurationResponseTransferAllDetails): TransferConfigurationResponseTransferAllDetails {
    return {
        ...val,
        include: (val.include ? outputs.databox.v20210801preview.transferAllDetailsResponseProvideDefaults(val.include) : undefined),
    };
}
...
export interface TransferConfigurationResponseTransferFilterDetails {
     ...
     */
    include?: outputs.databox.v20210801preview.TransferFilterDetailsResponse;
}
/**
...
export function transferConfigurationResponseTransferFilterDetailsProvideDefaults(val: TransferConfigurationResponseTransferFilterDetails): TransferConfigurationResponseTransferFilterDetails {
    return {
        ...val,
        include: (val.include ? outputs.databox.v20210801preview.transferFilterDetailsResponseProvideDefaults(val.include) : undefined),
    };
}
...
export interface TransferFilterDetailsResponse {
     ...
     * Filter details to transfer Azure files.
     */
    azureFileFilterDetails?: outputs.databox.v20210801preview.AzureFileFilterDetailsResponse;
    /**
     * Filter details to transfer blobs.
     */
    blobFilterDetails?: outputs.databox.v20210801preview.BlobFilterDetailsResponse;
    /**
     * Type of the account of data.
     */
    dataAccountType: string;
     ...
     * Details of the filter files to be used for data transfer.
     */
    filterFileDetails?: outputs.databox.v20210801preview.FilterFileDetailsResponse[];
}
/**
...
export interface UnencryptedCredentialsResponse {
     ...
     */
    jobSecrets: outputs.databox.v20210801preview.CustomerDiskJobSecretsResponse | outputs.databox.v20210801preview.DataBoxDiskJobSecretsResponse | outputs.databox.v20210801preview.DataBoxHeavyJobSecretsResponse | outputs.databox.v20210801preview.DataboxJobSecretsResponse;
}
