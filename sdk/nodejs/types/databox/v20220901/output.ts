...
export interface AccountCredentialDetailsResponse {
     ...
     */
    shareCredentialDetails: outputs.databox.v20220901.ShareCredentialDetailsResponse[];
}
...
export interface CloudErrorResponse {
     ...
     */
    additionalInfo: outputs.databox.v20220901.AdditionalErrorInfoResponse[];
    /**
     * Error code.
     */
    code?: string;
     ...
     */
    details: outputs.databox.v20220901.CloudErrorResponse[];
    /**
...
export interface ContactDetailsResponse {
     ...
     */
    notificationPreference?: outputs.databox.v20220901.NotificationPreferenceResponse[];
    /**
...
export interface CustomerDiskJobSecretsResponse {
     ...
     */
    dcAccessSecurityCode: outputs.databox.v20220901.DcAccessSecurityCodeResponse;
    /**
     * Contains the list of secrets object for that device.
     */
    diskSecrets: outputs.databox.v20220901.DiskSecretResponse[];
    /**
     * Error while fetching the secrets.
     */
    error: outputs.databox.v20220901.CloudErrorResponse;
    /**
...
export interface DataBoxCustomerDiskJobDetailsResponse {
     ...
     */
    contactDetails: outputs.databox.v20220901.ContactDetailsResponse;
    /**
     * List of copy log details.
     */
    copyLogDetails: (outputs.databox.v20220901.DataBoxAccountCopyLogDetailsResponse | outputs.databox.v20220901.DataBoxCustomerDiskCopyLogDetailsResponse | outputs.databox.v20220901.DataBoxDiskCopyLogDetailsResponse | outputs.databox.v20220901.DataBoxHeavyAccountCopyLogDetailsResponse)[];
    /**
     * Copy progress per disk.
     */
    copyProgress: outputs.databox.v20220901.DataBoxCustomerDiskCopyProgressResponse[];
    /**
     * DataCenter code.
     */
     ...
     */
    dataExportDetails?: outputs.databox.v20220901.DataExportDetailsResponse[];
    /**
     * Details of the data to be imported into azure.
     */
    dataImportDetails?: outputs.databox.v20220901.DataImportDetailsResponse[];
    /**
     * Datacenter address to ship to, for the given sku and storage location.
     */
    datacenterAddress: outputs.databox.v20220901.DatacenterAddressInstructionResponseResponse | outputs.databox.v20220901.DatacenterAddressLocationResponseResponse;
    /**
     * Delivery package shipping details.
     */
    deliverToDcPackageDetails: outputs.databox.v20220901.PackageCarrierInfoResponse;
    /**
     * Delivery package shipping details.
     */
    deliveryPackage: outputs.databox.v20220901.PackageShippingDetailsResponse;
    /**
     * Holds device data erasure details
     */
    deviceErasureDetails: outputs.databox.v20220901.DeviceErasureDetailsResponse;
    /**
     ...
     */
    exportDiskDetailsCollection: {[key: string]: outputs.databox.v20220901.ExportDiskDetailsResponse};
    /**
     * Contains the map of disk serial number to the disk details for import jobs.
     */
    importDiskDetailsCollection?: {[key: string]: outputs.databox.v20220901.ImportDiskDetailsResponse};
    /**
     * Indicates the type of job details.
     * Expected value is 'DataBoxCustomerDisk'.
     */
     ...
     */
    jobStages: outputs.databox.v20220901.JobStagesResponse[];
    /**
     * Details about which key encryption type is being used.
     */
    keyEncryptionKey?: outputs.databox.v20220901.KeyEncryptionKeyResponse;
    /**
     * Last mitigation action performed on the job.
     */
    lastMitigationActionOnJob: outputs.databox.v20220901.LastMitigationActionOnJobResponse;
    /**
     * Preferences for the order.
     */
    preferences?: outputs.databox.v20220901.PreferencesResponse;
    /**
     * Return package shipping details.
     */
    returnPackage: outputs.databox.v20220901.PackageShippingDetailsResponse;
    /**
     * Return package shipping details.
     */
    returnToCustomerPackageDetails: outputs.databox.v20220901.PackageCarrierDetailsResponse;
    /**
     ...
     */
    reverseShippingDetails?: outputs.databox.v20220901.ReverseShippingDetailsResponse;
    /**
...
export function dataBoxCustomerDiskJobDetailsResponseProvideDefaults(val: DataBoxCustomerDiskJobDetailsResponse): DataBoxCustomerDiskJobDetailsResponse {
    return {
        ...
        keyEncryptionKey: (val.keyEncryptionKey ? outputs.databox.v20220901.keyEncryptionKeyResponseProvideDefaults(val.keyEncryptionKey) : undefined),
        preferences: (val.preferences ? outputs.databox.v20220901.preferencesResponseProvideDefaults(val.preferences) : undefined),
        reverseShippingDetails: (val.reverseShippingDetails ? outputs.databox.v20220901.reverseShippingDetailsResponseProvideDefaults(val.reverseShippingDetails) : undefined),
...
export interface DataBoxDiskJobDetailsResponse {
     ...
     * Copy progress per disk.
     */
    copyProgress: outputs.databox.v20220901.DataBoxDiskCopyProgressResponse[];
    /**
     * DataCenter code.
     */
    dataCenterCode: string;
     ...
     * Copy progress per disk.
     */
    granularCopyLogDetails: outputs.databox.v20220901.DataBoxDiskGranularCopyLogDetailsResponse[];
    /**
     * Copy progress per disk.
     */
    granularCopyProgress: outputs.databox.v20220901.DataBoxDiskGranularCopyProgressResponse[];
    /**
     * Indicates the type of job details.
     * Expected value is 'DataBoxDisk'.
     */
...
export interface DataBoxHeavyJobDetailsResponse {
     ...
     */
    copyProgress: outputs.databox.v20220901.CopyProgressResponse[];
    /**
     * DataCenter code.
     */
    dataCenterCode: string;
...
export interface DataBoxHeavyJobSecretsResponse {
     ...
     */
    cabinetPodSecrets: outputs.databox.v20220901.DataBoxHeavySecretResponse[];
    /**
     * Dc Access Security Code for Customer Managed Shipping
     */
    dcAccessSecurityCode: outputs.databox.v20220901.DcAccessSecurityCodeResponse;
...
export interface DataBoxHeavySecretResponse {
     ...
     */
    accountCredentialDetails: outputs.databox.v20220901.AccountCredentialDetailsResponse[];
    /**
     ...
     */
    networkConfigurations: outputs.databox.v20220901.ApplianceNetworkConfigurationResponse[];
}
...
export interface DataExportDetailsResponse {
     ...
     */
    accountDetails: outputs.databox.v20220901.ManagedDiskDetailsResponse | outputs.databox.v20220901.StorageAccountDetailsResponse;
    /**
     ...
     */
    transferConfiguration: outputs.databox.v20220901.TransferConfigurationResponse;
}
/**
...
export function dataExportDetailsResponseProvideDefaults(val: DataExportDetailsResponse): DataExportDetailsResponse {
    return {
        ...
        transferConfiguration: outputs.databox.v20220901.transferConfigurationResponseProvideDefaults(val.transferConfiguration),
    };
}
...
export interface DataboxJobSecretsResponse {
     ...
     */
    podSecrets?: outputs.databox.v20220901.DataBoxSecretResponse[];
}
...
export interface IdentityPropertiesResponse {
     ...
     */
    userAssigned?: outputs.databox.v20220901.UserAssignedPropertiesResponse;
}
...
export interface KeyEncryptionKeyResponse {
     ...
     */
    identityProperties?: outputs.databox.v20220901.IdentityPropertiesResponse;
    /**
...
export interface PreferencesResponse {
     ...
     * Preferences related to the Encryption.
     */
    encryptionPreferences?: outputs.databox.v20220901.EncryptionPreferencesResponse;
    /**
     ...
     */
    reverseTransportPreferences?: outputs.databox.v20220901.TransportPreferencesResponse;
    /**
     ...
     */
    transportPreferences?: outputs.databox.v20220901.TransportPreferencesResponse;
}
/**
...
export function preferencesResponseProvideDefaults(val: PreferencesResponse): PreferencesResponse {
    return {
        ...val,
        encryptionPreferences: (val.encryptionPreferences ? outputs.databox.v20220901.encryptionPreferencesResponseProvideDefaults(val.encryptionPreferences) : undefined),
    };
}
...
export interface ResourceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.databox.v20220901.UserAssignedIdentityResponse};
}
/**
...
export interface TransferConfigurationResponse {
     ...
     */
    transferAllDetails?: outputs.databox.v20220901.TransferConfigurationResponseTransferAllDetails;
    /**
     ...
     */
    transferFilterDetails?: outputs.databox.v20220901.TransferConfigurationResponseTransferFilterDetails;
}
/**
...
export function transferConfigurationResponseProvideDefaults(val: TransferConfigurationResponse): TransferConfigurationResponse {
    return {
        ...val,
        transferAllDetails: (val.transferAllDetails ? outputs.databox.v20220901.transferConfigurationResponseTransferAllDetailsProvideDefaults(val.transferAllDetails) : undefined),
        transferFilterDetails: (val.transferFilterDetails ? outputs.databox.v20220901.transferConfigurationResponseTransferFilterDetailsProvideDefaults(val.transferFilterDetails) : undefined),
    };
}
...
export interface TransferConfigurationResponseTransferAllDetails {
     ...
     * Details to transfer all data.
     */
    include?: outputs.databox.v20220901.TransferAllDetailsResponse;
}
/**
...
export function transferConfigurationResponseTransferAllDetailsProvideDefaults(val: TransferConfigurationResponseTransferAllDetails): TransferConfigurationResponseTransferAllDetails {
    return {
        ...val,
        include: (val.include ? outputs.databox.v20220901.transferAllDetailsResponseProvideDefaults(val.include) : undefined),
    };
}
...
export interface TransferConfigurationResponseTransferFilterDetails {
     ...
     */
    include?: outputs.databox.v20220901.TransferFilterDetailsResponse;
}
/**
...
export function transferConfigurationResponseTransferFilterDetailsProvideDefaults(val: TransferConfigurationResponseTransferFilterDetails): TransferConfigurationResponseTransferFilterDetails {
    return {
        ...val,
        include: (val.include ? outputs.databox.v20220901.transferFilterDetailsResponseProvideDefaults(val.include) : undefined),
    };
}
...
export interface TransferFilterDetailsResponse {
     ...
     * Filter details to transfer Azure files.
     */
    azureFileFilterDetails?: outputs.databox.v20220901.AzureFileFilterDetailsResponse;
    /**
     * Filter details to transfer blobs.
     */
    blobFilterDetails?: outputs.databox.v20220901.BlobFilterDetailsResponse;
    /**
     * Type of the account of data.
     */
    dataAccountType: string;
     ...
     * Details of the filter files to be used for data transfer.
     */
    filterFileDetails?: outputs.databox.v20220901.FilterFileDetailsResponse[];
}
/**
...
export interface UnencryptedCredentialsResponse {
     ...
     */
    jobSecrets: outputs.databox.v20220901.CustomerDiskJobSecretsResponse | outputs.databox.v20220901.DataBoxDiskJobSecretsResponse | outputs.databox.v20220901.DataBoxHeavyJobSecretsResponse | outputs.databox.v20220901.DataboxJobSecretsResponse;
}
