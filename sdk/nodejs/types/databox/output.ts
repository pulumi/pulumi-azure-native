...
export interface AccountCredentialDetailsResponse {
     ...
     */
    shareCredentialDetails: outputs.databox.ShareCredentialDetailsResponse[];
}
...
export interface CloudErrorResponse {
     ...
     */
    additionalInfo: outputs.databox.AdditionalErrorInfoResponse[];
    /**
     * Cloud error code.
     */
    code?: string;
     ...
     * Cloud error details.
     */
    details: outputs.databox.CloudErrorResponse[];
    /**
     * Cloud error message.
     */
    message?: string;
...
export interface DataBoxDiskJobDetailsResponse {
     ...
     */
    copyLogDetails: (outputs.databox.DataBoxAccountCopyLogDetailsResponse | outputs.databox.DataBoxDiskCopyLogDetailsResponse | outputs.databox.DataBoxHeavyAccountCopyLogDetailsResponse)[];
    /**
     * Copy progress per disk.
     */
    copyProgress: outputs.databox.DataBoxDiskCopyProgressResponse[];
    /**
     * Details of the data to be exported from azure.
     */
    dataExportDetails?: outputs.databox.DataExportDetailsResponse[];
    /**
     * Details of the data to be imported into azure.
     */
    dataImportDetails?: outputs.databox.DataImportDetailsResponse[];
    /**
     ...
     */
    keyEncryptionKey?: outputs.databox.KeyEncryptionKeyResponse;
    /**
...
export function dataBoxDiskJobDetailsResponseProvideDefaults(val: DataBoxDiskJobDetailsResponse): DataBoxDiskJobDetailsResponse {
    return {
        ...val,
        keyEncryptionKey: (val.keyEncryptionKey ? outputs.databox.keyEncryptionKeyResponseProvideDefaults(val.keyEncryptionKey) : undefined),
        preferences: (val.preferences ? outputs.databox.preferencesResponseProvideDefaults(val.preferences) : undefined),
        shippingAddress: (val.shippingAddress ? outputs.databox.shippingAddressResponseProvideDefaults(val.shippingAddress) : undefined),
    };
}
...
export interface DataBoxDiskJobSecretsResponse {
     ...
     */
    diskSecrets: outputs.databox.DiskSecretResponse[];
    /**
     * Error while fetching the secrets.
     */
    error: outputs.databox.CloudErrorResponse;
    /**
...
export interface DataBoxHeavyJobDetailsResponse {
     ...
     */
    copyProgress: outputs.databox.CopyProgressResponse[];
    /**
     * Details of the data to be exported from azure.
     */
    dataExportDetails?: outputs.databox.DataExportDetailsResponse[];
...
export interface DataBoxHeavyJobSecretsResponse {
     ...
     */
    cabinetPodSecrets: outputs.databox.DataBoxHeavySecretResponse[];
    /**
     * Dc Access Security Code for Customer Managed Shipping
     */
    dcAccessSecurityCode: outputs.databox.DcAccessSecurityCodeResponse;
...
export interface DataBoxHeavySecretResponse {
     ...
     */
    accountCredentialDetails: outputs.databox.AccountCredentialDetailsResponse[];
    /**
     ...
     */
    networkConfigurations: outputs.databox.ApplianceNetworkConfigurationResponse[];
}
...
export interface DataExportDetailsResponse {
     ...
     */
    accountDetails: outputs.databox.ManagedDiskDetailsResponse | outputs.databox.StorageAccountDetailsResponse;
    /**
     ...
     */
    transferConfiguration: outputs.databox.TransferConfigurationResponse;
}
/**
...
export function dataExportDetailsResponseProvideDefaults(val: DataExportDetailsResponse): DataExportDetailsResponse {
    return {
        ...
        transferConfiguration: outputs.databox.transferConfigurationResponseProvideDefaults(val.transferConfiguration),
    };
}
...
export interface DataboxJobSecretsResponse {
     ...
     */
    podSecrets?: outputs.databox.DataBoxSecretResponse[];
}
...
export interface IdentityPropertiesResponse {
     ...
     */
    userAssigned?: outputs.databox.UserAssignedPropertiesResponse;
}
...
export interface KeyEncryptionKeyResponse {
     ...
     */
    identityProperties?: outputs.databox.IdentityPropertiesResponse;
    /**
...
export interface PreferencesResponse {
     ...
     * Preferences related to the Encryption.
     */
    encryptionPreferences?: outputs.databox.EncryptionPreferencesResponse;
    /**
...
export function preferencesResponseProvideDefaults(val: PreferencesResponse): PreferencesResponse {
    return {
        ...val,
        encryptionPreferences: (val.encryptionPreferences ? outputs.databox.encryptionPreferencesResponseProvideDefaults(val.encryptionPreferences) : undefined),
    };
}
...
export interface ResourceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.databox.UserAssignedIdentityResponse};
}
/**
...
export interface TransferConfigurationResponse {
     ...
     */
    transferAllDetails?: outputs.databox.TransferConfigurationResponseTransferAllDetails;
    /**
     ...
     */
    transferFilterDetails?: outputs.databox.TransferConfigurationResponseTransferFilterDetails;
}
/**
...
export function transferConfigurationResponseProvideDefaults(val: TransferConfigurationResponse): TransferConfigurationResponse {
    return {
        ...val,
        transferAllDetails: (val.transferAllDetails ? outputs.databox.transferConfigurationResponseTransferAllDetailsProvideDefaults(val.transferAllDetails) : undefined),
        transferFilterDetails: (val.transferFilterDetails ? outputs.databox.transferConfigurationResponseTransferFilterDetailsProvideDefaults(val.transferFilterDetails) : undefined),
    };
}
...
export interface TransferConfigurationResponseTransferAllDetails {
     ...
     * Details to transfer all data.
     */
    include?: outputs.databox.TransferAllDetailsResponse;
}
/**
...
export function transferConfigurationResponseTransferAllDetailsProvideDefaults(val: TransferConfigurationResponseTransferAllDetails): TransferConfigurationResponseTransferAllDetails {
    return {
        ...val,
        include: (val.include ? outputs.databox.transferAllDetailsResponseProvideDefaults(val.include) : undefined),
    };
}
...
export interface TransferConfigurationResponseTransferFilterDetails {
     ...
     */
    include?: outputs.databox.TransferFilterDetailsResponse;
}
/**
...
export function transferConfigurationResponseTransferFilterDetailsProvideDefaults(val: TransferConfigurationResponseTransferFilterDetails): TransferConfigurationResponseTransferFilterDetails {
    return {
        ...val,
        include: (val.include ? outputs.databox.transferFilterDetailsResponseProvideDefaults(val.include) : undefined),
    };
}
...
export interface TransferFilterDetailsResponse {
     ...
     * Filter details to transfer Azure files.
     */
    azureFileFilterDetails?: outputs.databox.AzureFileFilterDetailsResponse;
    /**
     * Filter details to transfer blobs.
     */
    blobFilterDetails?: outputs.databox.BlobFilterDetailsResponse;
    /**
     * Type of the account of data.
     */
    dataAccountType: string;
...
export interface UnencryptedCredentialsResponse {
     ...
     */
    jobSecrets: outputs.databox.DataBoxDiskJobSecretsResponse | outputs.databox.DataBoxHeavyJobSecretsResponse | outputs.databox.DataboxJobSecretsResponse;
}
