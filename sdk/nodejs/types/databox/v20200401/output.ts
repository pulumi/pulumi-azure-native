...
export interface AccountCredentialDetailsResponse {
     ...
     */
    shareCredentialDetails: outputs.databox.v20200401.ShareCredentialDetailsResponse[];
}
...
export interface CloudErrorResponse {
     ...
     */
    additionalInfo: outputs.databox.v20200401.AdditionalErrorInfoResponse[];
    /**
     * Cloud error code.
     */
    code?: string;
     ...
     * Cloud error details.
     */
    details: outputs.databox.v20200401.CloudErrorResponse[];
    /**
     * Cloud error message.
     */
    message?: string;
...
export interface ContactDetailsResponse {
     ...
     */
    notificationPreference?: outputs.databox.v20200401.NotificationPreferenceResponse[];
    /**
...
export interface DataBoxDiskJobDetailsResponse {
     ...
     */
    contactDetails: outputs.databox.v20200401.ContactDetailsResponse;
    /**
     * List of copy log details.
     */
    copyLogDetails: (outputs.databox.v20200401.DataBoxAccountCopyLogDetailsResponse | outputs.databox.v20200401.DataBoxDiskCopyLogDetailsResponse | outputs.databox.v20200401.DataBoxHeavyAccountCopyLogDetailsResponse)[];
    /**
     * Copy progress per disk.
     */
    copyProgress: outputs.databox.v20200401.DataBoxDiskCopyProgressResponse[];
    /**
     * Details of the data to be exported from azure.
     */
    dataExportDetails?: outputs.databox.v20200401.DataExportDetailsResponse[];
    /**
     * Details of the data to be imported into azure.
     */
    dataImportDetails?: outputs.databox.v20200401.DataImportDetailsResponse[];
    /**
     * Delivery package shipping details.
     */
    deliveryPackage: outputs.databox.v20200401.PackageShippingDetailsResponse;
    /**
     ...
     */
    jobStages: outputs.databox.v20200401.JobStagesResponse[];
    /**
     * Details about which key encryption type is being used.
     */
    keyEncryptionKey: outputs.databox.v20200401.KeyEncryptionKeyResponse;
    /**
     ...
     */
    preferences?: outputs.databox.v20200401.PreferencesResponse;
    /**
     ...
     */
    returnPackage: outputs.databox.v20200401.PackageShippingDetailsResponse;
    /**
     ...
     */
    shippingAddress?: outputs.databox.v20200401.ShippingAddressResponse;
}
/**
...
export function dataBoxDiskJobDetailsResponseProvideDefaults(val: DataBoxDiskJobDetailsResponse): DataBoxDiskJobDetailsResponse {
    return {
        ...val,
        keyEncryptionKey: outputs.databox.v20200401.keyEncryptionKeyResponseProvideDefaults(val.keyEncryptionKey),
        shippingAddress: (val.shippingAddress ? outputs.databox.v20200401.shippingAddressResponseProvideDefaults(val.shippingAddress) : undefined),
    };
}
...
export interface DataBoxDiskJobSecretsResponse {
     ...
     */
    dcAccessSecurityCode: outputs.databox.v20200401.DcAccessSecurityCodeResponse;
    /**
     * Contains the list of secrets object for that device.
     */
    diskSecrets: outputs.databox.v20200401.DiskSecretResponse[];
    /**
     * Error while fetching the secrets.
     */
    error: outputs.databox.v20200401.CloudErrorResponse;
    /**
...
export interface DataBoxHeavyJobDetailsResponse {
     ...
     */
    copyProgress: outputs.databox.v20200401.CopyProgressResponse[];
    /**
     * Details of the data to be exported from azure.
     */
    dataExportDetails?: outputs.databox.v20200401.DataExportDetailsResponse[];
...
export interface DataBoxHeavyJobSecretsResponse {
     ...
     */
    cabinetPodSecrets: outputs.databox.v20200401.DataBoxHeavySecretResponse[];
    /**
     * Dc Access Security Code for Customer Managed Shipping
     */
    dcAccessSecurityCode: outputs.databox.v20200401.DcAccessSecurityCodeResponse;
...
export interface DataBoxHeavySecretResponse {
     ...
     */
    accountCredentialDetails: outputs.databox.v20200401.AccountCredentialDetailsResponse[];
    /**
     ...
     */
    networkConfigurations: outputs.databox.v20200401.ApplianceNetworkConfigurationResponse[];
}
...
export interface DataExportDetailsResponse {
     ...
     */
    accountDetails: outputs.databox.v20200401.ManagedDiskDetailsResponse | outputs.databox.v20200401.StorageAccountDetailsResponse;
    /**
     ...
     */
    transferConfiguration: outputs.databox.v20200401.TransferConfigurationResponse;
}
/**
...
export function dataExportDetailsResponseProvideDefaults(val: DataExportDetailsResponse): DataExportDetailsResponse {
    return {
        ...
        transferConfiguration: outputs.databox.v20200401.transferConfigurationResponseProvideDefaults(val.transferConfiguration),
    };
}
...
export interface DataboxJobSecretsResponse {
     ...
     */
    podSecrets?: outputs.databox.v20200401.DataBoxSecretResponse[];
}
...
export interface PreferencesResponse {
     ...
     */
    transportPreferences?: outputs.databox.v20200401.TransportPreferencesResponse;
}
...
export interface TransferConfigurationResponse {
     ...
     */
    transferAllDetails?: outputs.databox.v20200401.TransferConfigurationResponseTransferAllDetails;
    /**
     ...
     */
    transferFilterDetails?: outputs.databox.v20200401.TransferConfigurationResponseTransferFilterDetails;
}
/**
...
export function transferConfigurationResponseProvideDefaults(val: TransferConfigurationResponse): TransferConfigurationResponse {
    return {
        ...val,
        transferAllDetails: (val.transferAllDetails ? outputs.databox.v20200401.transferConfigurationResponseTransferAllDetailsProvideDefaults(val.transferAllDetails) : undefined),
        transferFilterDetails: (val.transferFilterDetails ? outputs.databox.v20200401.transferConfigurationResponseTransferFilterDetailsProvideDefaults(val.transferFilterDetails) : undefined),
    };
}
...
export interface TransferConfigurationResponseTransferAllDetails {
     ...
     * Details to transfer all data.
     */
    include?: outputs.databox.v20200401.TransferAllDetailsResponse;
}
/**
...
export function transferConfigurationResponseTransferAllDetailsProvideDefaults(val: TransferConfigurationResponseTransferAllDetails): TransferConfigurationResponseTransferAllDetails {
    return {
        ...val,
        include: (val.include ? outputs.databox.v20200401.transferAllDetailsResponseProvideDefaults(val.include) : undefined),
    };
}
...
export interface TransferConfigurationResponseTransferFilterDetails {
     ...
     */
    include?: outputs.databox.v20200401.TransferFilterDetailsResponse;
}
/**
...
export function transferConfigurationResponseTransferFilterDetailsProvideDefaults(val: TransferConfigurationResponseTransferFilterDetails): TransferConfigurationResponseTransferFilterDetails {
    return {
        ...val,
        include: (val.include ? outputs.databox.v20200401.transferFilterDetailsResponseProvideDefaults(val.include) : undefined),
    };
}
...
export interface TransferFilterDetailsResponse {
     ...
     * Filter details to transfer Azure files.
     */
    azureFileFilterDetails?: outputs.databox.v20200401.AzureFileFilterDetailsResponse;
    /**
     * Filter details to transfer blobs.
     */
    blobFilterDetails?: outputs.databox.v20200401.BlobFilterDetailsResponse;
    /**
     * Type of the account of data.
     */
    dataAccountType: string;
     ...
     * Details of the filter files to be used for data transfer.
     */
    filterFileDetails?: outputs.databox.v20200401.FilterFileDetailsResponse[];
}
/**
...
export interface UnencryptedCredentialsResponse {
     ...
     */
    jobSecrets: outputs.databox.v20200401.DataBoxDiskJobSecretsResponse | outputs.databox.v20200401.DataBoxHeavyJobSecretsResponse | outputs.databox.v20200401.DataboxJobSecretsResponse;
}
