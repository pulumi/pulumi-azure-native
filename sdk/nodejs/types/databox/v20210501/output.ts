...
export interface AccountCredentialDetailsResponse {
     ...
     */
    shareCredentialDetails: outputs.databox.v20210501.ShareCredentialDetailsResponse[];
}
...
export interface CloudErrorResponse {
     ...
     */
    additionalInfo: outputs.databox.v20210501.AdditionalErrorInfoResponse[];
    /**
     * Cloud error code.
     */
    code?: string;
     ...
     * Cloud error details.
     */
    details: outputs.databox.v20210501.CloudErrorResponse[];
    /**
     * Cloud error message.
     */
    message?: string;
...
export interface ContactDetailsResponse {
     ...
     */
    notificationPreference?: outputs.databox.v20210501.NotificationPreferenceResponse[];
    /**
...
export interface DataBoxDiskJobDetailsResponse {
     ...
     */
    contactDetails: outputs.databox.v20210501.ContactDetailsResponse;
    /**
     * List of copy log details.
     */
    copyLogDetails: (outputs.databox.v20210501.DataBoxAccountCopyLogDetailsResponse | outputs.databox.v20210501.DataBoxDiskCopyLogDetailsResponse | outputs.databox.v20210501.DataBoxHeavyAccountCopyLogDetailsResponse)[];
    /**
     * Copy progress per disk.
     */
    copyProgress: outputs.databox.v20210501.DataBoxDiskCopyProgressResponse[];
    /**
     * Details of the data to be exported from azure.
     */
    dataExportDetails?: outputs.databox.v20210501.DataExportDetailsResponse[];
    /**
     * Details of the data to be imported into azure.
     */
    dataImportDetails?: outputs.databox.v20210501.DataImportDetailsResponse[];
    /**
     * Delivery package shipping details.
     */
    deliveryPackage: outputs.databox.v20210501.PackageShippingDetailsResponse;
    /**
     ...
     */
    jobStages: outputs.databox.v20210501.JobStagesResponse[];
    /**
     * Details about which key encryption type is being used.
     */
    keyEncryptionKey?: outputs.databox.v20210501.KeyEncryptionKeyResponse;
    /**
     * Last mitigation action performed on the job.
     */
    lastMitigationActionOnJob: outputs.databox.v20210501.LastMitigationActionOnJobResponse;
    /**
     ...
     */
    preferences?: outputs.databox.v20210501.PreferencesResponse;
    /**
     ...
     */
    returnPackage: outputs.databox.v20210501.PackageShippingDetailsResponse;
    /**
     ...
     */
    shippingAddress?: outputs.databox.v20210501.ShippingAddressResponse;
}
/**
...
export function dataBoxDiskJobDetailsResponseProvideDefaults(val: DataBoxDiskJobDetailsResponse): DataBoxDiskJobDetailsResponse {
    return {
        ...val,
        keyEncryptionKey: (val.keyEncryptionKey ? outputs.databox.v20210501.keyEncryptionKeyResponseProvideDefaults(val.keyEncryptionKey) : undefined),
        preferences: (val.preferences ? outputs.databox.v20210501.preferencesResponseProvideDefaults(val.preferences) : undefined),
        shippingAddress: (val.shippingAddress ? outputs.databox.v20210501.shippingAddressResponseProvideDefaults(val.shippingAddress) : undefined),
    };
}
...
export interface DataBoxDiskJobSecretsResponse {
     ...
     */
    dcAccessSecurityCode: outputs.databox.v20210501.DcAccessSecurityCodeResponse;
    /**
     * Contains the list of secrets object for that device.
     */
    diskSecrets: outputs.databox.v20210501.DiskSecretResponse[];
    /**
     * Error while fetching the secrets.
     */
    error: outputs.databox.v20210501.CloudErrorResponse;
    /**
...
export interface DataBoxHeavyJobDetailsResponse {
     ...
     */
    copyProgress: outputs.databox.v20210501.CopyProgressResponse[];
    /**
     * Details of the data to be exported from azure.
     */
    dataExportDetails?: outputs.databox.v20210501.DataExportDetailsResponse[];
...
export interface DataBoxHeavyJobSecretsResponse {
     ...
     */
    cabinetPodSecrets: outputs.databox.v20210501.DataBoxHeavySecretResponse[];
    /**
     * Dc Access Security Code for Customer Managed Shipping
     */
    dcAccessSecurityCode: outputs.databox.v20210501.DcAccessSecurityCodeResponse;
...
export interface DataBoxHeavySecretResponse {
     ...
     */
    accountCredentialDetails: outputs.databox.v20210501.AccountCredentialDetailsResponse[];
    /**
     ...
     */
    networkConfigurations: outputs.databox.v20210501.ApplianceNetworkConfigurationResponse[];
}
...
export interface DataExportDetailsResponse {
     ...
     */
    accountDetails: outputs.databox.v20210501.ManagedDiskDetailsResponse | outputs.databox.v20210501.StorageAccountDetailsResponse;
    /**
     ...
     */
    transferConfiguration: outputs.databox.v20210501.TransferConfigurationResponse;
}
/**
...
export function dataExportDetailsResponseProvideDefaults(val: DataExportDetailsResponse): DataExportDetailsResponse {
    return {
        ...
        transferConfiguration: outputs.databox.v20210501.transferConfigurationResponseProvideDefaults(val.transferConfiguration),
    };
}
...
export interface DataboxJobSecretsResponse {
     ...
     */
    podSecrets?: outputs.databox.v20210501.DataBoxSecretResponse[];
}
...
export interface IdentityPropertiesResponse {
     ...
     */
    userAssigned?: outputs.databox.v20210501.UserAssignedPropertiesResponse;
}
...
export interface KeyEncryptionKeyResponse {
     ...
     */
    identityProperties?: outputs.databox.v20210501.IdentityPropertiesResponse;
    /**
...
export interface PreferencesResponse {
     ...
     * Preferences related to the Encryption.
     */
    encryptionPreferences?: outputs.databox.v20210501.EncryptionPreferencesResponse;
    /**
     ...
     */
    transportPreferences?: outputs.databox.v20210501.TransportPreferencesResponse;
}
/**
...
export function preferencesResponseProvideDefaults(val: PreferencesResponse): PreferencesResponse {
    return {
        ...val,
        encryptionPreferences: (val.encryptionPreferences ? outputs.databox.v20210501.encryptionPreferencesResponseProvideDefaults(val.encryptionPreferences) : undefined),
    };
}
...
export interface ResourceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.databox.v20210501.UserAssignedIdentityResponse};
}
/**
...
export interface TransferConfigurationResponse {
     ...
     */
    transferAllDetails?: outputs.databox.v20210501.TransferConfigurationResponseTransferAllDetails;
    /**
     ...
     */
    transferFilterDetails?: outputs.databox.v20210501.TransferConfigurationResponseTransferFilterDetails;
}
/**
...
export function transferConfigurationResponseProvideDefaults(val: TransferConfigurationResponse): TransferConfigurationResponse {
    return {
        ...val,
        transferAllDetails: (val.transferAllDetails ? outputs.databox.v20210501.transferConfigurationResponseTransferAllDetailsProvideDefaults(val.transferAllDetails) : undefined),
        transferFilterDetails: (val.transferFilterDetails ? outputs.databox.v20210501.transferConfigurationResponseTransferFilterDetailsProvideDefaults(val.transferFilterDetails) : undefined),
    };
}
...
export interface TransferConfigurationResponseTransferAllDetails {
     ...
     * Details to transfer all data.
     */
    include?: outputs.databox.v20210501.TransferAllDetailsResponse;
}
/**
...
export function transferConfigurationResponseTransferAllDetailsProvideDefaults(val: TransferConfigurationResponseTransferAllDetails): TransferConfigurationResponseTransferAllDetails {
    return {
        ...val,
        include: (val.include ? outputs.databox.v20210501.transferAllDetailsResponseProvideDefaults(val.include) : undefined),
    };
}
...
export interface TransferConfigurationResponseTransferFilterDetails {
     ...
     */
    include?: outputs.databox.v20210501.TransferFilterDetailsResponse;
}
/**
...
export function transferConfigurationResponseTransferFilterDetailsProvideDefaults(val: TransferConfigurationResponseTransferFilterDetails): TransferConfigurationResponseTransferFilterDetails {
    return {
        ...val,
        include: (val.include ? outputs.databox.v20210501.transferFilterDetailsResponseProvideDefaults(val.include) : undefined),
    };
}
...
export interface TransferFilterDetailsResponse {
     ...
     * Filter details to transfer Azure files.
     */
    azureFileFilterDetails?: outputs.databox.v20210501.AzureFileFilterDetailsResponse;
    /**
     * Filter details to transfer blobs.
     */
    blobFilterDetails?: outputs.databox.v20210501.BlobFilterDetailsResponse;
    /**
     * Type of the account of data.
     */
    dataAccountType: string;
     ...
     * Details of the filter files to be used for data transfer.
     */
    filterFileDetails?: outputs.databox.v20210501.FilterFileDetailsResponse[];
}
/**
...
export interface UnencryptedCredentialsResponse {
     ...
     */
    jobSecrets: outputs.databox.v20210501.DataBoxDiskJobSecretsResponse | outputs.databox.v20210501.DataBoxHeavyJobSecretsResponse | outputs.databox.v20210501.DataboxJobSecretsResponse;
}
