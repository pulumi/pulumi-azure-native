...
export interface ContactDetailsArgs {
     ...
     */
    notificationPreference?: pulumi.Input<pulumi.Input<inputs.databox.v20180101.NotificationPreferenceArgs>[]>;
    /**
...
export interface DataBoxDiskJobDetailsArgs {
     ...
     */
    contactDetails: pulumi.Input<inputs.databox.v20180101.ContactDetailsArgs>;
    /**
     * Destination account details.
     */
    destinationAccountDetails: pulumi.Input<pulumi.Input<inputs.databox.v20180101.DestinationManagedDiskDetailsArgs | inputs.databox.v20180101.DestinationStorageAccountDetailsArgs>[]>;
    /**
     ...
     */
    preferences?: pulumi.Input<inputs.databox.v20180101.PreferencesArgs>;
    /**
     ...
     */
    shippingAddress: pulumi.Input<inputs.databox.v20180101.ShippingAddressArgs>;
}
/**
...
export function dataBoxDiskJobDetailsArgsProvideDefaults(val: DataBoxDiskJobDetailsArgs): DataBoxDiskJobDetailsArgs {
    return {
        ...val,
        shippingAddress: pulumi.output(val.shippingAddress).apply(inputs.databox.v20180101.shippingAddressArgsProvideDefaults),
    };
}
...
export interface NotificationPreferenceArgs {
     ...
     * Name of the stage.
     */
    stageName: pulumi.Input<string | enums.databox.v20180101.NotificationStageName>;
}
/**
...
export interface ShippingAddressArgs {
     ...
     * Type of address.
     */
    addressType?: pulumi.Input<string | enums.databox.v20180101.AddressType>;
    /**
     * Name of the City.
     */
...
export interface SkuArgs {
     ...
     * The sku name.
     */
    name: pulumi.Input<string | enums.databox.v20180101.SkuName>;
}
