...
export interface AccountCredentialDetailsResponse {
     ...
     */
    shareCredentialDetails: outputs.databox.v20211201.ShareCredentialDetailsResponse[];
}
...
export interface CloudErrorResponse {
     ...
     */
    additionalInfo: outputs.databox.v20211201.AdditionalErrorInfoResponse[];
    /**
     * Error code.
     */
    code?: string;
     ...
     */
    details: outputs.databox.v20211201.CloudErrorResponse[];
    /**
...
export interface ContactDetailsResponse {
     ...
     */
    notificationPreference?: outputs.databox.v20211201.NotificationPreferenceResponse[];
    /**
...
export interface CustomerDiskJobSecretsResponse {
     ...
     */
    dcAccessSecurityCode: outputs.databox.v20211201.DcAccessSecurityCodeResponse;
    /**
     * Contains the list of secrets object for that device.
     */
    diskSecrets: outputs.databox.v20211201.DiskSecretResponse[];
    /**
     * Error while fetching the secrets.
     */
    error: outputs.databox.v20211201.CloudErrorResponse;
    /**
...
export interface DataBoxCustomerDiskJobDetailsResponse {
     ...
     */
    contactDetails: outputs.databox.v20211201.ContactDetailsResponse;
    /**
     * List of copy log details.
     */
    copyLogDetails: (outputs.databox.v20211201.DataBoxAccountCopyLogDetailsResponse | outputs.databox.v20211201.DataBoxCustomerDiskCopyLogDetailsResponse | outputs.databox.v20211201.DataBoxDiskCopyLogDetailsResponse | outputs.databox.v20211201.DataBoxHeavyAccountCopyLogDetailsResponse)[];
    /**
     * Copy progress per disk.
     */
    copyProgress: outputs.databox.v20211201.DataBoxCustomerDiskCopyProgressResponse[];
    /**
     * DataCenter code.
     */
     ...
     */
    dataExportDetails?: outputs.databox.v20211201.DataExportDetailsResponse[];
    /**
     * Details of the data to be imported into azure.
     */
    dataImportDetails?: outputs.databox.v20211201.DataImportDetailsResponse[];
    /**
     * Datacenter address to ship to, for the given sku and storage location.
     */
    datacenterAddress: outputs.databox.v20211201.DatacenterAddressInstructionResponseResponse | outputs.databox.v20211201.DatacenterAddressLocationResponseResponse;
    /**
     * Delivery package shipping details.
     */
    deliverToDcPackageDetails: outputs.databox.v20211201.PackageCarrierInfoResponse;
    /**
     * Delivery package shipping details.
     */
    deliveryPackage: outputs.databox.v20211201.PackageShippingDetailsResponse;
    /**
     ...
     */
    exportDiskDetailsCollection: {[key: string]: outputs.databox.v20211201.ExportDiskDetailsResponse};
    /**
     * Contains the map of disk serial number to the disk details for import jobs.
     */
    importDiskDetailsCollection?: {[key: string]: outputs.databox.v20211201.ImportDiskDetailsResponse};
    /**
     * Indicates the type of job details.
     * Expected value is 'DataBoxCustomerDisk'.
     */
     ...
     */
    jobStages: outputs.databox.v20211201.JobStagesResponse[];
    /**
     * Details about which key encryption type is being used.
     */
    keyEncryptionKey?: outputs.databox.v20211201.KeyEncryptionKeyResponse;
    /**
     * Last mitigation action performed on the job.
     */
    lastMitigationActionOnJob: outputs.databox.v20211201.LastMitigationActionOnJobResponse;
    /**
     * Preferences for the order.
     */
    preferences?: outputs.databox.v20211201.PreferencesResponse;
    /**
     * Return package shipping details.
     */
    returnPackage: outputs.databox.v20211201.PackageShippingDetailsResponse;
    /**
     * Return package shipping details.
     */
    returnToCustomerPackageDetails: outputs.databox.v20211201.PackageCarrierDetailsResponse;
    /**
     ...
     */
    shippingAddress?: outputs.databox.v20211201.ShippingAddressResponse;
}
/**
...
export function dataBoxCustomerDiskJobDetailsResponseProvideDefaults(val: DataBoxCustomerDiskJobDetailsResponse): DataBoxCustomerDiskJobDetailsResponse {
    return {
        ...
        keyEncryptionKey: (val.keyEncryptionKey ? outputs.databox.v20211201.keyEncryptionKeyResponseProvideDefaults(val.keyEncryptionKey) : undefined),
        preferences: (val.preferences ? outputs.databox.v20211201.preferencesResponseProvideDefaults(val.preferences) : undefined),
        shippingAddress: (val.shippingAddress ? outputs.databox.v20211201.shippingAddressResponseProvideDefaults(val.shippingAddress) : undefined),
    };
}
...
export interface DataBoxDiskJobDetailsResponse {
     ...
     * Copy progress per disk.
     */
    copyProgress: outputs.databox.v20211201.DataBoxDiskCopyProgressResponse[];
    /**
     * DataCenter code.
     */
    dataCenterCode: string;
     ...
     * Copy progress per disk.
     */
    granularCopyProgress: outputs.databox.v20211201.DataBoxDiskGranularCopyProgressResponse[];
    /**
     * Indicates the type of job details.
     * Expected value is 'DataBoxDisk'.
     */
...
export interface DataBoxHeavyJobDetailsResponse {
     ...
     */
    copyProgress: outputs.databox.v20211201.CopyProgressResponse[];
    /**
     * DataCenter code.
     */
    dataCenterCode: string;
...
export interface DataBoxHeavyJobSecretsResponse {
     ...
     */
    cabinetPodSecrets: outputs.databox.v20211201.DataBoxHeavySecretResponse[];
    /**
     * Dc Access Security Code for Customer Managed Shipping
     */
    dcAccessSecurityCode: outputs.databox.v20211201.DcAccessSecurityCodeResponse;
...
export interface DataBoxHeavySecretResponse {
     ...
     */
    accountCredentialDetails: outputs.databox.v20211201.AccountCredentialDetailsResponse[];
    /**
     ...
     */
    networkConfigurations: outputs.databox.v20211201.ApplianceNetworkConfigurationResponse[];
}
...
export interface DataExportDetailsResponse {
     ...
     */
    accountDetails: outputs.databox.v20211201.ManagedDiskDetailsResponse | outputs.databox.v20211201.StorageAccountDetailsResponse;
    /**
     ...
     */
    transferConfiguration: outputs.databox.v20211201.TransferConfigurationResponse;
}
/**
...
export function dataExportDetailsResponseProvideDefaults(val: DataExportDetailsResponse): DataExportDetailsResponse {
    return {
        ...
        transferConfiguration: outputs.databox.v20211201.transferConfigurationResponseProvideDefaults(val.transferConfiguration),
    };
}
...
export interface DataboxJobSecretsResponse {
     ...
     */
    podSecrets?: outputs.databox.v20211201.DataBoxSecretResponse[];
}
...
export interface IdentityPropertiesResponse {
     ...
     */
    userAssigned?: outputs.databox.v20211201.UserAssignedPropertiesResponse;
}
...
export interface KeyEncryptionKeyResponse {
     ...
     */
    identityProperties?: outputs.databox.v20211201.IdentityPropertiesResponse;
    /**
...
export interface PreferencesResponse {
     ...
     * Preferences related to the Encryption.
     */
    encryptionPreferences?: outputs.databox.v20211201.EncryptionPreferencesResponse;
    /**
     ...
     */
    transportPreferences?: outputs.databox.v20211201.TransportPreferencesResponse;
}
/**
...
export function preferencesResponseProvideDefaults(val: PreferencesResponse): PreferencesResponse {
    return {
        ...val,
        encryptionPreferences: (val.encryptionPreferences ? outputs.databox.v20211201.encryptionPreferencesResponseProvideDefaults(val.encryptionPreferences) : undefined),
    };
}
...
export interface ResourceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.databox.v20211201.UserAssignedIdentityResponse};
}
/**
...
export interface TransferConfigurationResponse {
     ...
     */
    transferAllDetails?: outputs.databox.v20211201.TransferConfigurationResponseTransferAllDetails;
    /**
     ...
     */
    transferFilterDetails?: outputs.databox.v20211201.TransferConfigurationResponseTransferFilterDetails;
}
/**
...
export function transferConfigurationResponseProvideDefaults(val: TransferConfigurationResponse): TransferConfigurationResponse {
    return {
        ...val,
        transferAllDetails: (val.transferAllDetails ? outputs.databox.v20211201.transferConfigurationResponseTransferAllDetailsProvideDefaults(val.transferAllDetails) : undefined),
        transferFilterDetails: (val.transferFilterDetails ? outputs.databox.v20211201.transferConfigurationResponseTransferFilterDetailsProvideDefaults(val.transferFilterDetails) : undefined),
    };
}
...
export interface TransferConfigurationResponseTransferAllDetails {
     ...
     * Details to transfer all data.
     */
    include?: outputs.databox.v20211201.TransferAllDetailsResponse;
}
/**
...
export function transferConfigurationResponseTransferAllDetailsProvideDefaults(val: TransferConfigurationResponseTransferAllDetails): TransferConfigurationResponseTransferAllDetails {
    return {
        ...val,
        include: (val.include ? outputs.databox.v20211201.transferAllDetailsResponseProvideDefaults(val.include) : undefined),
    };
}
...
export interface TransferConfigurationResponseTransferFilterDetails {
     ...
     */
    include?: outputs.databox.v20211201.TransferFilterDetailsResponse;
}
/**
...
export function transferConfigurationResponseTransferFilterDetailsProvideDefaults(val: TransferConfigurationResponseTransferFilterDetails): TransferConfigurationResponseTransferFilterDetails {
    return {
        ...val,
        include: (val.include ? outputs.databox.v20211201.transferFilterDetailsResponseProvideDefaults(val.include) : undefined),
    };
}
...
export interface TransferFilterDetailsResponse {
     ...
     * Filter details to transfer Azure files.
     */
    azureFileFilterDetails?: outputs.databox.v20211201.AzureFileFilterDetailsResponse;
    /**
     * Filter details to transfer blobs.
     */
    blobFilterDetails?: outputs.databox.v20211201.BlobFilterDetailsResponse;
    /**
     * Type of the account of data.
     */
    dataAccountType: string;
     ...
     * Details of the filter files to be used for data transfer.
     */
    filterFileDetails?: outputs.databox.v20211201.FilterFileDetailsResponse[];
}
/**
...
export interface UnencryptedCredentialsResponse {
     ...
     */
    jobSecrets: outputs.databox.v20211201.CustomerDiskJobSecretsResponse | outputs.databox.v20211201.DataBoxDiskJobSecretsResponse | outputs.databox.v20211201.DataBoxHeavyJobSecretsResponse | outputs.databox.v20211201.DataboxJobSecretsResponse;
}
