...
export interface ContactDetailsArgs {
     ...
     */
    notificationPreference?: pulumi.Input<pulumi.Input<inputs.databox.v20211201.NotificationPreferenceArgs>[]>;
    /**
...
export interface DataBoxCustomerDiskJobDetailsArgs {
     ...
     */
    contactDetails: pulumi.Input<inputs.databox.v20211201.ContactDetailsArgs>;
    /**
     * Details of the data to be exported from azure.
     */
    dataExportDetails?: pulumi.Input<pulumi.Input<inputs.databox.v20211201.DataExportDetailsArgs>[]>;
    /**
     * Details of the data to be imported into azure.
     */
    dataImportDetails?: pulumi.Input<pulumi.Input<inputs.databox.v20211201.DataImportDetailsArgs>[]>;
    /**
     ...
     */
    importDiskDetailsCollection?: pulumi.Input<{[key: string]: pulumi.Input<inputs.databox.v20211201.ImportDiskDetailsArgs>}>;
    /**
     ...
     */
    keyEncryptionKey?: pulumi.Input<inputs.databox.v20211201.KeyEncryptionKeyArgs>;
    /**
     * Preferences for the order.
     */
    preferences?: pulumi.Input<inputs.databox.v20211201.PreferencesArgs>;
    /**
     * Return package shipping details.
     */
    returnToCustomerPackageDetails: pulumi.Input<inputs.databox.v20211201.PackageCarrierDetailsArgs>;
    /**
     * Shipping address of the customer.
     */
    shippingAddress?: pulumi.Input<inputs.databox.v20211201.ShippingAddressArgs>;
}
/**
...
export function dataBoxCustomerDiskJobDetailsArgsProvideDefaults(val: DataBoxCustomerDiskJobDetailsArgs): DataBoxCustomerDiskJobDetailsArgs {
    return {
        ...
        keyEncryptionKey: (val.keyEncryptionKey ? pulumi.output(val.keyEncryptionKey).apply(inputs.databox.v20211201.keyEncryptionKeyArgsProvideDefaults) : undefined),
        preferences: (val.preferences ? pulumi.output(val.preferences).apply(inputs.databox.v20211201.preferencesArgsProvideDefaults) : undefined),
        shippingAddress: (val.shippingAddress ? pulumi.output(val.shippingAddress).apply(inputs.databox.v20211201.shippingAddressArgsProvideDefaults) : undefined),
    };
}
...
export interface DataExportDetailsArgs {
     ...
     */
    accountDetails: pulumi.Input<inputs.databox.v20211201.ManagedDiskDetailsArgs | inputs.databox.v20211201.StorageAccountDetailsArgs>;
    /**
     * Level of the logs to be collected.
     */
    logCollectionLevel?: pulumi.Input<string | enums.databox.v20211201.LogCollectionLevel>;
    /**
     * Configuration for the data transfer.
     */
    transferConfiguration: pulumi.Input<inputs.databox.v20211201.TransferConfigurationArgs>;
}
/**
...
export function dataExportDetailsArgsProvideDefaults(val: DataExportDetailsArgs): DataExportDetailsArgs {
    return {
        ...
        transferConfiguration: pulumi.output(val.transferConfiguration).apply(inputs.databox.v20211201.transferConfigurationArgsProvideDefaults),
    };
}
...
export interface EncryptionPreferencesArgs {
     ...
     */
    doubleEncryption?: pulumi.Input<string | enums.databox.v20211201.DoubleEncryption>;
}
/**
...
export interface FilterFileDetailsArgs {
     ...
     */
    filterFileType: pulumi.Input<string | enums.databox.v20211201.FilterFileType>;
}
...
export interface IdentityPropertiesArgs {
     ...
     */
    userAssigned?: pulumi.Input<inputs.databox.v20211201.UserAssignedPropertiesArgs>;
}
...
export interface KeyEncryptionKeyArgs {
     ...
     */
    identityProperties?: pulumi.Input<inputs.databox.v20211201.IdentityPropertiesArgs>;
    /**
     * Type of encryption key used for key encryption.
     */
    kekType: pulumi.Input<string | enums.databox.v20211201.KekType>;
    /**
...
export interface NotificationPreferenceArgs {
     ...
     * Name of the stage.
     */
    stageName: pulumi.Input<string | enums.databox.v20211201.NotificationStageName>;
}
/**
...
export interface PreferencesArgs {
     ...
     * Preferences related to the Encryption.
     */
    encryptionPreferences?: pulumi.Input<inputs.databox.v20211201.EncryptionPreferencesArgs>;
    /**
     ...
     */
    storageAccountAccessTierPreferences?: pulumi.Input<pulumi.Input<string | enums.databox.v20211201.StorageAccountAccessTier>[]>;
    /**
     * Preferences related to the shipment logistics of the sku.
     */
    transportPreferences?: pulumi.Input<inputs.databox.v20211201.TransportPreferencesArgs>;
}
/**
...
export function preferencesArgsProvideDefaults(val: PreferencesArgs): PreferencesArgs {
    return {
        ...val,
        encryptionPreferences: (val.encryptionPreferences ? pulumi.output(val.encryptionPreferences).apply(inputs.databox.v20211201.encryptionPreferencesArgsProvideDefaults) : undefined),
    };
}
...
export interface ShippingAddressArgs {
     ...
     * Type of address.
     */
    addressType?: pulumi.Input<string | enums.databox.v20211201.AddressType>;
    /**
     * Name of the City.
     */
...
export interface SkuArgs {
     ...
     * The sku name.
     */
    name: pulumi.Input<string | enums.databox.v20211201.SkuName>;
}
...
export interface TransferAllDetailsArgs {
     ...
     */
    dataAccountType: pulumi.Input<string | enums.databox.v20211201.DataAccountType>;
    /**
...
export interface TransferConfigurationArgs {
     ...
     */
    transferAllDetails?: pulumi.Input<inputs.databox.v20211201.TransferConfigurationTransferAllDetailsArgs>;
    /**
     * Type of the configuration for transfer.
     */
    transferConfigurationType: pulumi.Input<string | enums.databox.v20211201.TransferConfigurationType>;
    /**
     * Map of filter type and the details to filter. This field is required only if the TransferConfigurationType is given as TransferUsingFilter.
     */
    transferFilterDetails?: pulumi.Input<inputs.databox.v20211201.TransferConfigurationTransferFilterDetailsArgs>;
}
/**
...
export function transferConfigurationArgsProvideDefaults(val: TransferConfigurationArgs): TransferConfigurationArgs {
    return {
        ...val,
        transferAllDetails: (val.transferAllDetails ? pulumi.output(val.transferAllDetails).apply(inputs.databox.v20211201.transferConfigurationTransferAllDetailsArgsProvideDefaults) : undefined),
        transferFilterDetails: (val.transferFilterDetails ? pulumi.output(val.transferFilterDetails).apply(inputs.databox.v20211201.transferConfigurationTransferFilterDetailsArgsProvideDefaults) : undefined),
    };
}
...
export interface TransferConfigurationTransferAllDetailsArgs {
     ...
     * Details to transfer all data.
     */
    include?: pulumi.Input<inputs.databox.v20211201.TransferAllDetailsArgs>;
}
/**
...
export function transferConfigurationTransferAllDetailsArgsProvideDefaults(val: TransferConfigurationTransferAllDetailsArgs): TransferConfigurationTransferAllDetailsArgs {
    return {
        ...val,
        include: (val.include ? pulumi.output(val.include).apply(inputs.databox.v20211201.transferAllDetailsArgsProvideDefaults) : undefined),
    };
}
...
export interface TransferConfigurationTransferFilterDetailsArgs {
     ...
     */
    include?: pulumi.Input<inputs.databox.v20211201.TransferFilterDetailsArgs>;
}
/**
...
export function transferConfigurationTransferFilterDetailsArgsProvideDefaults(val: TransferConfigurationTransferFilterDetailsArgs): TransferConfigurationTransferFilterDetailsArgs {
    return {
        ...val,
        include: (val.include ? pulumi.output(val.include).apply(inputs.databox.v20211201.transferFilterDetailsArgsProvideDefaults) : undefined),
    };
}
...
export interface TransferFilterDetailsArgs {
     ...
     * Filter details to transfer Azure files.
     */
    azureFileFilterDetails?: pulumi.Input<inputs.databox.v20211201.AzureFileFilterDetailsArgs>;
    /**
     * Filter details to transfer blobs.
     */
    blobFilterDetails?: pulumi.Input<inputs.databox.v20211201.BlobFilterDetailsArgs>;
    /**
     * Type of the account of data.
     */
    dataAccountType: pulumi.Input<string | enums.databox.v20211201.DataAccountType>;
     ...
     * Details of the filter files to be used for data transfer.
     */
    filterFileDetails?: pulumi.Input<pulumi.Input<inputs.databox.v20211201.FilterFileDetailsArgs>[]>;
}
/**
...
export interface TransportPreferencesArgs {
     ...
     */
    preferredShipmentType: pulumi.Input<string | enums.databox.v20211201.TransportShipmentTypes>;
}
