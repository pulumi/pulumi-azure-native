...
export interface ContactDetailsArgs {
     ...
     */
    notificationPreference?: pulumi.Input<pulumi.Input<inputs.databox.v20210301.NotificationPreferenceArgs>[]>;
    /**
...
export interface DataBoxDiskJobDetailsArgs {
     ...
     */
    contactDetails: pulumi.Input<inputs.databox.v20210301.ContactDetailsArgs>;
    /**
     * Details of the data to be exported from azure.
     */
    dataExportDetails?: pulumi.Input<pulumi.Input<inputs.databox.v20210301.DataExportDetailsArgs>[]>;
    /**
     * Details of the data to be imported into azure.
     */
    dataImportDetails?: pulumi.Input<pulumi.Input<inputs.databox.v20210301.DataImportDetailsArgs>[]>;
    /**
     ...
     */
    keyEncryptionKey?: pulumi.Input<inputs.databox.v20210301.KeyEncryptionKeyArgs>;
    /**
     ...
     */
    preferences?: pulumi.Input<inputs.databox.v20210301.PreferencesArgs>;
    /**
     ...
     */
    shippingAddress?: pulumi.Input<inputs.databox.v20210301.ShippingAddressArgs>;
}
/**
...
export function dataBoxDiskJobDetailsArgsProvideDefaults(val: DataBoxDiskJobDetailsArgs): DataBoxDiskJobDetailsArgs {
    return {
        ...val,
        keyEncryptionKey: (val.keyEncryptionKey ? pulumi.output(val.keyEncryptionKey).apply(inputs.databox.v20210301.keyEncryptionKeyArgsProvideDefaults) : undefined),
        preferences: (val.preferences ? pulumi.output(val.preferences).apply(inputs.databox.v20210301.preferencesArgsProvideDefaults) : undefined),
        shippingAddress: (val.shippingAddress ? pulumi.output(val.shippingAddress).apply(inputs.databox.v20210301.shippingAddressArgsProvideDefaults) : undefined),
    };
}
...
export interface DataExportDetailsArgs {
     ...
     */
    accountDetails: pulumi.Input<inputs.databox.v20210301.ManagedDiskDetailsArgs | inputs.databox.v20210301.StorageAccountDetailsArgs>;
    /**
     * Level of the logs to be collected.
     */
    logCollectionLevel?: pulumi.Input<string | enums.databox.v20210301.LogCollectionLevel>;
    /**
     * Configuration for the data transfer.
     */
    transferConfiguration: pulumi.Input<inputs.databox.v20210301.TransferConfigurationArgs>;
}
/**
...
export function dataExportDetailsArgsProvideDefaults(val: DataExportDetailsArgs): DataExportDetailsArgs {
    return {
        ...
        transferConfiguration: pulumi.output(val.transferConfiguration).apply(inputs.databox.v20210301.transferConfigurationArgsProvideDefaults),
    };
}
...
export interface EncryptionPreferencesArgs {
     ...
     */
    doubleEncryption?: pulumi.Input<string | enums.databox.v20210301.DoubleEncryption>;
}
/**
...
export interface FilterFileDetailsArgs {
     ...
     */
    filterFileType: pulumi.Input<string | enums.databox.v20210301.FilterFileType>;
}
...
export interface IdentityPropertiesArgs {
     ...
     */
    userAssigned?: pulumi.Input<inputs.databox.v20210301.UserAssignedPropertiesArgs>;
}
...
export interface KeyEncryptionKeyArgs {
     ...
     */
    identityProperties?: pulumi.Input<inputs.databox.v20210301.IdentityPropertiesArgs>;
    /**
     * Type of encryption key used for key encryption.
     */
    kekType: pulumi.Input<string | enums.databox.v20210301.KekType>;
    /**
...
export interface NotificationPreferenceArgs {
     ...
     * Name of the stage.
     */
    stageName: pulumi.Input<string | enums.databox.v20210301.NotificationStageName>;
}
/**
...
export interface PreferencesArgs {
     ...
     * Preferences related to the Encryption.
     */
    encryptionPreferences?: pulumi.Input<inputs.databox.v20210301.EncryptionPreferencesArgs>;
    /**
     ...
     */
    transportPreferences?: pulumi.Input<inputs.databox.v20210301.TransportPreferencesArgs>;
}
/**
...
export function preferencesArgsProvideDefaults(val: PreferencesArgs): PreferencesArgs {
    return {
        ...val,
        encryptionPreferences: (val.encryptionPreferences ? pulumi.output(val.encryptionPreferences).apply(inputs.databox.v20210301.encryptionPreferencesArgsProvideDefaults) : undefined),
    };
}
...
export interface ShippingAddressArgs {
     ...
     * Type of address.
     */
    addressType?: pulumi.Input<string | enums.databox.v20210301.AddressType>;
    /**
     * Name of the City.
     */
...
export interface SkuArgs {
     ...
     * The sku name.
     */
    name: pulumi.Input<string | enums.databox.v20210301.SkuName>;
}
...
export interface TransferAllDetailsArgs {
     ...
     */
    dataAccountType: pulumi.Input<string | enums.databox.v20210301.DataAccountType>;
    /**
...
export interface TransferConfigurationArgs {
     ...
     */
    transferAllDetails?: pulumi.Input<inputs.databox.v20210301.TransferConfigurationTransferAllDetailsArgs>;
    /**
     * Type of the configuration for transfer.
     */
    transferConfigurationType: pulumi.Input<string | enums.databox.v20210301.TransferConfigurationType>;
    /**
     * Map of filter type and the details to filter. This field is required only if the TransferConfigurationType is given as TransferUsingFilter.
     */
    transferFilterDetails?: pulumi.Input<inputs.databox.v20210301.TransferConfigurationTransferFilterDetailsArgs>;
}
/**
...
export function transferConfigurationArgsProvideDefaults(val: TransferConfigurationArgs): TransferConfigurationArgs {
    return {
        ...val,
        transferAllDetails: (val.transferAllDetails ? pulumi.output(val.transferAllDetails).apply(inputs.databox.v20210301.transferConfigurationTransferAllDetailsArgsProvideDefaults) : undefined),
        transferFilterDetails: (val.transferFilterDetails ? pulumi.output(val.transferFilterDetails).apply(inputs.databox.v20210301.transferConfigurationTransferFilterDetailsArgsProvideDefaults) : undefined),
    };
}
...
export interface TransferConfigurationTransferAllDetailsArgs {
     ...
     * Details to transfer all data.
     */
    include?: pulumi.Input<inputs.databox.v20210301.TransferAllDetailsArgs>;
}
/**
...
export function transferConfigurationTransferAllDetailsArgsProvideDefaults(val: TransferConfigurationTransferAllDetailsArgs): TransferConfigurationTransferAllDetailsArgs {
    return {
        ...val,
        include: (val.include ? pulumi.output(val.include).apply(inputs.databox.v20210301.transferAllDetailsArgsProvideDefaults) : undefined),
    };
}
...
export interface TransferConfigurationTransferFilterDetailsArgs {
     ...
     */
    include?: pulumi.Input<inputs.databox.v20210301.TransferFilterDetailsArgs>;
}
/**
...
export function transferConfigurationTransferFilterDetailsArgsProvideDefaults(val: TransferConfigurationTransferFilterDetailsArgs): TransferConfigurationTransferFilterDetailsArgs {
    return {
        ...val,
        include: (val.include ? pulumi.output(val.include).apply(inputs.databox.v20210301.transferFilterDetailsArgsProvideDefaults) : undefined),
    };
}
...
export interface TransferFilterDetailsArgs {
     ...
     * Filter details to transfer Azure files.
     */
    azureFileFilterDetails?: pulumi.Input<inputs.databox.v20210301.AzureFileFilterDetailsArgs>;
    /**
     * Filter details to transfer blobs.
     */
    blobFilterDetails?: pulumi.Input<inputs.databox.v20210301.BlobFilterDetailsArgs>;
    /**
     * Type of the account of data.
     */
    dataAccountType: pulumi.Input<string | enums.databox.v20210301.DataAccountType>;
     ...
     * Details of the filter files to be used for data transfer.
     */
    filterFileDetails?: pulumi.Input<pulumi.Input<inputs.databox.v20210301.FilterFileDetailsArgs>[]>;
}
/**
...
export interface TransportPreferencesArgs {
     ...
     */
    preferredShipmentType: pulumi.Input<string | enums.databox.v20210301.TransportShipmentTypes>;
}
