...
export interface ExportPolicyRuleArgs {
     ...
     */
    chownMode?: pulumi.Input<string | enums.netapp.ChownMode>;
    /**
...
export interface ReplicationObjectArgs {
     ...
     */
    endpointType?: pulumi.Input<string | enums.netapp.EndpointType>;
    /**
     ...
     * Schedule
     */
    replicationSchedule?: pulumi.Input<string | enums.netapp.ReplicationSchedule>;
}
...
export interface VolumeGroupMetaDataArgs {
     ...
     * Application Type
     */
    applicationType?: pulumi.Input<string | enums.netapp.ApplicationType>;
    /**
     ...
     */
    globalPlacementRules?: pulumi.Input<pulumi.Input<inputs.netapp.PlacementKeyValuePairsArgs>[]>;
    /**
     * Group Description
     */
...
export interface VolumePropertiesDataProtectionArgs {
     ...
     * Backup Properties
     */
    backup?: pulumi.Input<inputs.netapp.VolumeBackupPropertiesArgs>;
    /**
     * Replication properties
     */
    replication?: pulumi.Input<inputs.netapp.ReplicationObjectArgs>;
    /**
     * Snapshot properties.
     */
    snapshot?: pulumi.Input<inputs.netapp.VolumeSnapshotPropertiesArgs>;
}
...
export interface VolumePropertiesExportPolicyArgs {
     ...
     * Export policy rule
     */
    rules?: pulumi.Input<pulumi.Input<inputs.netapp.ExportPolicyRuleArgs>[]>;
}
