...
export interface ReplicationObjectArgs {
     ...
     */
    endpointType?: pulumi.Input<string | enums.netapp.v20200201.EndpointType>;
    /**
     ...
     * Schedule
     */
    replicationSchedule: pulumi.Input<string | enums.netapp.v20200201.ReplicationSchedule>;
}
...
export interface VolumePropertiesDataProtectionArgs {
     ...
     * Replication properties
     */
    replication?: pulumi.Input<inputs.netapp.v20200201.ReplicationObjectArgs>;
    /**
     * Snapshot properties.
     */
    snapshot?: pulumi.Input<inputs.netapp.v20200201.VolumeSnapshotPropertiesArgs>;
}
...
export interface VolumePropertiesExportPolicyArgs {
     ...
     * Export policy rule
     */
    rules?: pulumi.Input<pulumi.Input<inputs.netapp.v20200201.ExportPolicyRuleArgs>[]>;
}
