...
export function exportPolicyRuleResponseProvideDefaults(val: ExportPolicyRuleResponse): ExportPolicyRuleResponse {
    return {
        ...
        unixReadOnly: (val.unixReadOnly) ?? false,
    };
}
...
export interface VolumePropertiesResponseDataProtection {
     ...
     * Backup Properties
     */
    backup?: outputs.netapp.v20200601.VolumeBackupPropertiesResponse;
    /**
     * Replication properties
     */
    replication?: outputs.netapp.v20200601.ReplicationObjectResponse;
    /**
     * Snapshot properties.
     */
    snapshot?: outputs.netapp.v20200601.VolumeSnapshotPropertiesResponse;
}
...
export interface VolumePropertiesResponseExportPolicy {
     ...
     * Export policy rule
     */
    rules?: outputs.netapp.v20200601.ExportPolicyRuleResponse[];
}
