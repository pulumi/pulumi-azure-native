...
export interface ReplicationObjectArgs {
     ...
     */
    endpointType?: pulumi.Input<string | enums.netapp.v20191101.EndpointType>;
    /**
     ...
     * Schedule
     */
    replicationSchedule: pulumi.Input<string | enums.netapp.v20191101.ReplicationSchedule>;
}
...
export interface VolumePropertiesDataProtectionArgs {
     ...
     * Replication properties
     */
    replication?: pulumi.Input<inputs.netapp.v20191101.ReplicationObjectArgs>;
}
...
export interface VolumePropertiesExportPolicyArgs {
     ...
     * Export policy rule
     */
    rules?: pulumi.Input<pulumi.Input<inputs.netapp.v20191101.ExportPolicyRuleArgs>[]>;
}
