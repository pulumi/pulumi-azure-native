...
export interface ConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.eventgrid.v20200401preview.PersistedConnectionStatus>;
}
...
export interface DeadLetterWithResourceIdentityArgs {
     ...
     */
    identity?: pulumi.Input<inputs.eventgrid.v20200401preview.EventSubscriptionIdentityArgs>;
}
...
export interface EventChannelFilterArgs {
     ...
     */
    advancedFilters?: pulumi.Input<pulumi.Input<inputs.eventgrid.v20200401preview.BoolEqualsAdvancedFilterArgs | inputs.eventgrid.v20200401preview.NumberGreaterThanAdvancedFilterArgs | inputs.eventgrid.v20200401preview.NumberGreaterThanOrEqualsAdvancedFilterArgs | inputs.eventgrid.v20200401preview.NumberInAdvancedFilterArgs | inputs.eventgrid.v20200401preview.NumberLessThanAdvancedFilterArgs | inputs.eventgrid.v20200401preview.NumberLessThanOrEqualsAdvancedFilterArgs | inputs.eventgrid.v20200401preview.NumberNotInAdvancedFilterArgs | inputs.eventgrid.v20200401preview.StringBeginsWithAdvancedFilterArgs | inputs.eventgrid.v20200401preview.StringContainsAdvancedFilterArgs | inputs.eventgrid.v20200401preview.StringEndsWithAdvancedFilterArgs | inputs.eventgrid.v20200401preview.StringInAdvancedFilterArgs | inputs.eventgrid.v20200401preview.StringNotInAdvancedFilterArgs>[]>;
}
...
export interface EventSubscriptionIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.eventgrid.v20200401preview.EventSubscriptionIdentityType>;
    /**
...
export interface IdentityInfoArgs {
     ...
     * The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove any identity.
     */
    type?: pulumi.Input<string | enums.eventgrid.v20200401preview.IdentityType>;
    /**
     * The list of user identities associated with the resource. The user identity dictionary key references will be ARM resource ids in the form:
     * '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
     * This property is currently not used and reserved for future usage.
     */
    userAssignedIdentities?: pulumi.Input<{[key: string]: pulumi.Input<inputs.eventgrid.v20200401preview.UserIdentityPropertiesArgs>}>;
}
...
export interface InboundIpRuleArgs {
     ...
     */
    action?: pulumi.Input<string | enums.eventgrid.v20200401preview.IpActionType>;
    /**
...
export interface JsonInputSchemaMappingArgs {
     ...
     */
    dataVersion?: pulumi.Input<inputs.eventgrid.v20200401preview.JsonFieldWithDefaultArgs>;
    /**
     * The mapping information for the EventTime property of the Event Grid Event.
     */
    eventTime?: pulumi.Input<inputs.eventgrid.v20200401preview.JsonFieldArgs>;
    /**
     * The mapping information for the EventType property of the Event Grid Event.
     */
    eventType?: pulumi.Input<inputs.eventgrid.v20200401preview.JsonFieldWithDefaultArgs>;
    /**
     * The mapping information for the Id property of the Event Grid Event.
     */
    id?: pulumi.Input<inputs.eventgrid.v20200401preview.JsonFieldArgs>;
    /**
     ...
     */
    subject?: pulumi.Input<inputs.eventgrid.v20200401preview.JsonFieldWithDefaultArgs>;
    /**
     * The mapping information for the Topic property of the Event Grid Event.
     */
    topic?: pulumi.Input<inputs.eventgrid.v20200401preview.JsonFieldArgs>;
}
...
export interface PrivateEndpointConnectionArgs {
     ...
     */
    privateEndpoint?: pulumi.Input<inputs.eventgrid.v20200401preview.PrivateEndpointArgs>;
    /**
     * Details about the state of the connection.
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.eventgrid.v20200401preview.ConnectionStateArgs>;
    /**
     * Provisioning state of the Private Endpoint Connection.
     */
    provisioningState?: pulumi.Input<string | enums.eventgrid.v20200401preview.ResourceProvisioningState>;
}
...
export interface ResourceSkuArgs {
     ...
     */
    name?: pulumi.Input<string | enums.eventgrid.v20200401preview.Sku>;
}
