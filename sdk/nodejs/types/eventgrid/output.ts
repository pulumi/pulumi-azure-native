...
export * as v20170615preview from "./v20170615preview/output";
export * as v20170915preview from "./v20170915preview/output";
export * as v20180101 from "./v20180101/output";
export * as v20180501preview from "./v20180501preview/output";
export * as v20180915preview from "./v20180915preview/output";
...
export * as v20201015preview from "./v20201015preview/output";
...
export interface AzureFunctionEventSubscriptionDestinationResponse {
     ...
     */
    deliveryAttributeMappings?: (outputs.eventgrid.DynamicDeliveryAttributeMappingResponse | outputs.eventgrid.StaticDeliveryAttributeMappingResponse)[];
    /**
...
export interface DeadLetterWithResourceIdentityResponse {
     ...
     */
    deadLetterDestination?: outputs.eventgrid.StorageBlobDeadLetterDestinationResponse;
    /**
     * The identity to use when dead-lettering events.
     */
    identity?: outputs.eventgrid.EventSubscriptionIdentityResponse;
}
...
export interface DeliveryWithResourceIdentityResponse {
     ...
     */
    destination?: outputs.eventgrid.AzureFunctionEventSubscriptionDestinationResponse | outputs.eventgrid.EventHubEventSubscriptionDestinationResponse | outputs.eventgrid.HybridConnectionEventSubscriptionDestinationResponse | outputs.eventgrid.PartnerEventSubscriptionDestinationResponse | outputs.eventgrid.ServiceBusQueueEventSubscriptionDestinationResponse | outputs.eventgrid.ServiceBusTopicEventSubscriptionDestinationResponse | outputs.eventgrid.StorageQueueEventSubscriptionDestinationResponse | outputs.eventgrid.WebHookEventSubscriptionDestinationResponse;
    /**
...
export interface EventChannelFilterResponse {
     ...
     */
    advancedFilters?: (outputs.eventgrid.BoolEqualsAdvancedFilterResponse | outputs.eventgrid.IsNotNullAdvancedFilterResponse | outputs.eventgrid.IsNullOrUndefinedAdvancedFilterResponse | outputs.eventgrid.NumberGreaterThanAdvancedFilterResponse | outputs.eventgrid.NumberGreaterThanOrEqualsAdvancedFilterResponse | outputs.eventgrid.NumberInAdvancedFilterResponse | outputs.eventgrid.NumberInRangeAdvancedFilterResponse | outputs.eventgrid.NumberLessThanAdvancedFilterResponse | outputs.eventgrid.NumberLessThanOrEqualsAdvancedFilterResponse | outputs.eventgrid.NumberNotInAdvancedFilterResponse | outputs.eventgrid.NumberNotInRangeAdvancedFilterResponse | outputs.eventgrid.StringBeginsWithAdvancedFilterResponse | outputs.eventgrid.StringContainsAdvancedFilterResponse | outputs.eventgrid.StringEndsWithAdvancedFilterResponse | outputs.eventgrid.StringInAdvancedFilterResponse | outputs.eventgrid.StringNotBeginsWithAdvancedFilterResponse | outputs.eventgrid.StringNotContainsAdvancedFilterResponse | outputs.eventgrid.StringNotEndsWithAdvancedFilterResponse | outputs.eventgrid.StringNotInAdvancedFilterResponse)[];
    /**
...
export interface EventTypeInfoResponse {
     ...
     */
    inlineEventTypes?: {[key: string]: outputs.eventgrid.InlineEventPropertiesResponse};
    /**
...
export interface IdentityInfoResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.eventgrid.UserIdentityPropertiesResponse};
}
...
export interface JsonInputSchemaMappingResponse {
     ...
     */
    dataVersion?: outputs.eventgrid.JsonFieldWithDefaultResponse;
    /**
     * The mapping information for the EventTime property of the Event Grid Event.
     */
    eventTime?: outputs.eventgrid.JsonFieldResponse;
    /**
     * The mapping information for the EventType property of the Event Grid Event.
     */
    eventType?: outputs.eventgrid.JsonFieldWithDefaultResponse;
    /**
     * The mapping information for the Id property of the Event Grid Event.
     */
    id?: outputs.eventgrid.JsonFieldResponse;
    /**
     ...
     */
    subject?: outputs.eventgrid.JsonFieldWithDefaultResponse;
    /**
     * The mapping information for the Topic property of the Event Grid Event.
     */
    topic?: outputs.eventgrid.JsonFieldResponse;
}
...
export interface PartnerAuthorizationResponse {
     ...
     */
    authorizedPartnersList?: outputs.eventgrid.PartnerResponse[];
    /**
...
export interface WebhookPartnerDestinationInfoResponse {
     ...
     */
    clientAuthentication?: outputs.eventgrid.AzureADPartnerClientAuthenticationResponse;
    /**
     ...
     */
    resourceMoveChangeHistory?: outputs.eventgrid.ResourceMoveChangeHistoryResponse[];
}
/**
...
export function webhookPartnerDestinationInfoResponseProvideDefaults(val: WebhookPartnerDestinationInfoResponse): WebhookPartnerDestinationInfoResponse {
    return {
        ...val,
        clientAuthentication: (val.clientAuthentication ? outputs.eventgrid.azureADPartnerClientAuthenticationResponseProvideDefaults(val.clientAuthentication) : undefined),
