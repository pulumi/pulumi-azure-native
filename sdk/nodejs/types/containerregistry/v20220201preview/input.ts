...
export interface AzureADAuthenticationAsArmPolicyArgs {
     ...
     */
    status?: pulumi.Input<string | enums.containerregistry.v20220201preview.AzureADAuthenticationAsArmPolicyStatus>;
}
/**
...
export interface EncryptionPropertyArgs {
     ...
     */
    keyVaultProperties?: pulumi.Input<inputs.containerregistry.v20220201preview.KeyVaultPropertiesArgs>;
    /**
     * Indicates whether or not the encryption is enabled for container registry.
     */
    status?: pulumi.Input<string | enums.containerregistry.v20220201preview.EncryptionStatus>;
}
...
export interface ExportPolicyArgs {
     ...
     * The value that indicates whether the policy is enabled or not.
     */
    status?: pulumi.Input<string | enums.containerregistry.v20220201preview.ExportPolicyStatus>;
}
/**
...
export interface IPRuleArgs {
     ...
     */
    action?: pulumi.Input<string | enums.containerregistry.v20220201preview.Action>;
    /**
...
export interface IdentityPropertiesArgs {
     ...
     * The identity type.
     */
    type?: pulumi.Input<enums.containerregistry.v20220201preview.ResourceIdentityType>;
    /**
     ...
     */
    userAssignedIdentities?: pulumi.Input<{[key: string]: pulumi.Input<inputs.containerregistry.v20220201preview.UserIdentityPropertiesArgs>}>;
}
...
export interface ImportPipelineSourcePropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerregistry.v20220201preview.PipelineSourceType>;
    /**
...
export interface LoggingPropertiesArgs {
     ...
     */
    auditLogStatus?: pulumi.Input<string | enums.containerregistry.v20220201preview.AuditLogStatus>;
    /**
     * The verbosity of logs persisted on the connected registry.
     */
    logLevel?: pulumi.Input<string | enums.containerregistry.v20220201preview.LogLevel>;
}
/**
...
export interface NetworkRuleSetArgs {
     ...
     */
    defaultAction: pulumi.Input<string | enums.containerregistry.v20220201preview.DefaultAction>;
    /**
     * The IP ACL rules.
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.containerregistry.v20220201preview.IPRuleArgs>[]>;
}
/**
...
export interface ParentPropertiesArgs {
     ...
     */
    syncProperties: pulumi.Input<inputs.containerregistry.v20220201preview.SyncPropertiesArgs>;
}
...
export interface PipelineRunRequestArgs {
     ...
     */
    source?: pulumi.Input<inputs.containerregistry.v20220201preview.PipelineRunSourcePropertiesArgs>;
    /**
     * The target properties of the pipeline run.
     */
    target?: pulumi.Input<inputs.containerregistry.v20220201preview.PipelineRunTargetPropertiesArgs>;
}
/**
...
export function pipelineRunRequestArgsProvideDefaults(val: PipelineRunRequestArgs): PipelineRunRequestArgs {
    return {
        ...val,
        source: (val.source ? pulumi.output(val.source).apply(inputs.containerregistry.v20220201preview.pipelineRunSourcePropertiesArgsProvideDefaults) : undefined),
        target: (val.target ? pulumi.output(val.target).apply(inputs.containerregistry.v20220201preview.pipelineRunTargetPropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface PipelineRunSourcePropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerregistry.v20220201preview.PipelineRunSourceType>;
}
/**
...
export interface PipelineRunTargetPropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerregistry.v20220201preview.PipelineRunTargetType>;
}
/**
...
export interface PipelineSourceTriggerPropertiesArgs {
     ...
     */
    status: pulumi.Input<string | enums.containerregistry.v20220201preview.TriggerStatus>;
}
/**
...
export interface PipelineTriggerPropertiesArgs {
     ...
     */
    sourceTrigger?: pulumi.Input<inputs.containerregistry.v20220201preview.PipelineSourceTriggerPropertiesArgs>;
}
/**
...
export function pipelineTriggerPropertiesArgsProvideDefaults(val: PipelineTriggerPropertiesArgs): PipelineTriggerPropertiesArgs {
    return {
        ...val,
        sourceTrigger: (val.sourceTrigger ? pulumi.output(val.sourceTrigger).apply(inputs.containerregistry.v20220201preview.pipelineSourceTriggerPropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface PoliciesArgs {
     ...
     * The policy for using ARM audience token for a container registry.
     */
    azureADAuthenticationAsArmPolicy?: pulumi.Input<inputs.containerregistry.v20220201preview.AzureADAuthenticationAsArmPolicyArgs>;
    /**
     * The export policy for a container registry.
     */
    exportPolicy?: pulumi.Input<inputs.containerregistry.v20220201preview.ExportPolicyArgs>;
    /**
     * The quarantine policy for a container registry.
     */
    quarantinePolicy?: pulumi.Input<inputs.containerregistry.v20220201preview.QuarantinePolicyArgs>;
    /**
     * The retention policy for a container registry.
     */
    retentionPolicy?: pulumi.Input<inputs.containerregistry.v20220201preview.RetentionPolicyArgs>;
    /**
     * The soft delete policy for a container registry.
     */
    softDeletePolicy?: pulumi.Input<inputs.containerregistry.v20220201preview.SoftDeletePolicyArgs>;
    /**
     * The content trust policy for a container registry.
     */
    trustPolicy?: pulumi.Input<inputs.containerregistry.v20220201preview.TrustPolicyArgs>;
}
/**
...
export function policiesArgsProvideDefaults(val: PoliciesArgs): PoliciesArgs {
    return {
        ...val,
        azureADAuthenticationAsArmPolicy: (val.azureADAuthenticationAsArmPolicy ? pulumi.output(val.azureADAuthenticationAsArmPolicy).apply(inputs.containerregistry.v20220201preview.azureADAuthenticationAsArmPolicyArgsProvideDefaults) : undefined),
        exportPolicy: (val.exportPolicy ? pulumi.output(val.exportPolicy).apply(inputs.containerregistry.v20220201preview.exportPolicyArgsProvideDefaults) : undefined),
        quarantinePolicy: (val.quarantinePolicy ? pulumi.output(val.quarantinePolicy).apply(inputs.containerregistry.v20220201preview.quarantinePolicyArgsProvideDefaults) : undefined),
        retentionPolicy: (val.retentionPolicy ? pulumi.output(val.retentionPolicy).apply(inputs.containerregistry.v20220201preview.retentionPolicyArgsProvideDefaults) : undefined),
        softDeletePolicy: (val.softDeletePolicy ? pulumi.output(val.softDeletePolicy).apply(inputs.containerregistry.v20220201preview.softDeletePolicyArgsProvideDefaults) : undefined),
        trustPolicy: (val.trustPolicy ? pulumi.output(val.trustPolicy).apply(inputs.containerregistry.v20220201preview.trustPolicyArgsProvideDefaults) : undefined),
    };
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    actionsRequired?: pulumi.Input<string | enums.containerregistry.v20220201preview.ActionsRequired>;
    /**
     ...
     */
    status?: pulumi.Input<string | enums.containerregistry.v20220201preview.ConnectionStatus>;
}
...
export interface QuarantinePolicyArgs {
     ...
     * The value that indicates whether the policy is enabled or not.
     */
    status?: pulumi.Input<string | enums.containerregistry.v20220201preview.PolicyStatus>;
}
/**
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<string | enums.containerregistry.v20220201preview.SkuName>;
}
...
export interface TokenCertificateArgs {
    ...
    name?: pulumi.Input<string | enums.containerregistry.v20220201preview.TokenCertificateName>;
    /**
...
export interface TokenCredentialsPropertiesArgs {
    certificates?: pulumi.Input<pulumi.Input<inputs.containerregistry.v20220201preview.TokenCertificateArgs>[]>;
    passwords?: pulumi.Input<pulumi.Input<inputs.containerregistry.v20220201preview.TokenPasswordArgs>[]>;
}
...
export interface TokenPasswordArgs {
     ...
     */
    name?: pulumi.Input<string | enums.containerregistry.v20220201preview.TokenPasswordName>;
}
...
export interface TrustPolicyArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerregistry.v20220201preview.TrustPolicyType>;
}
/**
