...
export interface EncryptionPropertyArgs {
     ...
     */
    keyVaultProperties?: pulumi.Input<inputs.containerregistry.v20210601preview.KeyVaultPropertiesArgs>;
    /**
     * Indicates whether or not the encryption is enabled for container registry.
     */
    status?: pulumi.Input<string | enums.containerregistry.v20210601preview.EncryptionStatus>;
}
...
export interface ExportPolicyArgs {
     ...
     */
    status?: pulumi.Input<string | enums.containerregistry.v20210601preview.ExportPolicyStatus>;
}
/**
...
export interface IPRuleArgs {
     ...
     */
    action?: pulumi.Input<string | enums.containerregistry.v20210601preview.Action>;
    /**
...
export interface IdentityPropertiesArgs {
     ...
     * The identity type.
     */
    type?: pulumi.Input<enums.containerregistry.v20210601preview.ResourceIdentityType>;
    /**
     ...
     */
    userAssignedIdentities?: pulumi.Input<{[key: string]: pulumi.Input<inputs.containerregistry.v20210601preview.UserIdentityPropertiesArgs>}>;
}
...
export interface ImportPipelineSourcePropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerregistry.v20210601preview.PipelineSourceType>;
    /**
...
export interface LoggingPropertiesArgs {
     ...
     */
    auditLogStatus?: pulumi.Input<string | enums.containerregistry.v20210601preview.AuditLogStatus>;
    /**
     * The verbosity of logs persisted on the connected registry.
     */
    logLevel?: pulumi.Input<string | enums.containerregistry.v20210601preview.LogLevel>;
}
/**
...
export interface NetworkRuleSetArgs {
     ...
     */
    defaultAction: pulumi.Input<string | enums.containerregistry.v20210601preview.DefaultAction>;
    /**
     * The IP ACL rules.
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.containerregistry.v20210601preview.IPRuleArgs>[]>;
    /**
     * The virtual network rules.
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.containerregistry.v20210601preview.VirtualNetworkRuleArgs>[]>;
}
/**
...
export interface ParentPropertiesArgs {
     ...
     */
    syncProperties: pulumi.Input<inputs.containerregistry.v20210601preview.SyncPropertiesArgs>;
}
...
export interface PipelineRunRequestArgs {
     ...
     */
    source?: pulumi.Input<inputs.containerregistry.v20210601preview.PipelineRunSourcePropertiesArgs>;
    /**
     * The target properties of the pipeline run.
     */
    target?: pulumi.Input<inputs.containerregistry.v20210601preview.PipelineRunTargetPropertiesArgs>;
}
/**
...
export function pipelineRunRequestArgsProvideDefaults(val: PipelineRunRequestArgs): PipelineRunRequestArgs {
    return {
        ...val,
        source: (val.source ? pulumi.output(val.source).apply(inputs.containerregistry.v20210601preview.pipelineRunSourcePropertiesArgsProvideDefaults) : undefined),
        target: (val.target ? pulumi.output(val.target).apply(inputs.containerregistry.v20210601preview.pipelineRunTargetPropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface PipelineRunSourcePropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerregistry.v20210601preview.PipelineRunSourceType>;
}
/**
...
export interface PipelineRunTargetPropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerregistry.v20210601preview.PipelineRunTargetType>;
}
/**
...
export interface PipelineSourceTriggerPropertiesArgs {
     ...
     */
    status: pulumi.Input<string | enums.containerregistry.v20210601preview.TriggerStatus>;
}
/**
...
export interface PipelineTriggerPropertiesArgs {
     ...
     */
    sourceTrigger?: pulumi.Input<inputs.containerregistry.v20210601preview.PipelineSourceTriggerPropertiesArgs>;
}
/**
...
export function pipelineTriggerPropertiesArgsProvideDefaults(val: PipelineTriggerPropertiesArgs): PipelineTriggerPropertiesArgs {
    return {
        ...val,
        sourceTrigger: (val.sourceTrigger ? pulumi.output(val.sourceTrigger).apply(inputs.containerregistry.v20210601preview.pipelineSourceTriggerPropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface PoliciesArgs {
     ...
     * The export policy for a container registry.
     */
    exportPolicy?: pulumi.Input<inputs.containerregistry.v20210601preview.ExportPolicyArgs>;
    /**
     * The quarantine policy for a container registry.
     */
    quarantinePolicy?: pulumi.Input<inputs.containerregistry.v20210601preview.QuarantinePolicyArgs>;
    /**
     * The retention policy for a container registry.
     */
    retentionPolicy?: pulumi.Input<inputs.containerregistry.v20210601preview.RetentionPolicyArgs>;
    /**
     * The content trust policy for a container registry.
     */
    trustPolicy?: pulumi.Input<inputs.containerregistry.v20210601preview.TrustPolicyArgs>;
}
/**
...
export function policiesArgsProvideDefaults(val: PoliciesArgs): PoliciesArgs {
    return {
        ...val,
        exportPolicy: (val.exportPolicy ? pulumi.output(val.exportPolicy).apply(inputs.containerregistry.v20210601preview.exportPolicyArgsProvideDefaults) : undefined),
        quarantinePolicy: (val.quarantinePolicy ? pulumi.output(val.quarantinePolicy).apply(inputs.containerregistry.v20210601preview.quarantinePolicyArgsProvideDefaults) : undefined),
        retentionPolicy: (val.retentionPolicy ? pulumi.output(val.retentionPolicy).apply(inputs.containerregistry.v20210601preview.retentionPolicyArgsProvideDefaults) : undefined),
        trustPolicy: (val.trustPolicy ? pulumi.output(val.trustPolicy).apply(inputs.containerregistry.v20210601preview.trustPolicyArgsProvideDefaults) : undefined),
    };
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    actionsRequired?: pulumi.Input<string | enums.containerregistry.v20210601preview.ActionsRequired>;
    /**
     ...
     */
    status?: pulumi.Input<string | enums.containerregistry.v20210601preview.ConnectionStatus>;
}
...
export interface QuarantinePolicyArgs {
     ...
     * The value that indicates whether the policy is enabled or not.
     */
    status?: pulumi.Input<string | enums.containerregistry.v20210601preview.PolicyStatus>;
}
/**
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<string | enums.containerregistry.v20210601preview.SkuName>;
}
...
export interface TokenCertificateArgs {
    ...
    name?: pulumi.Input<string | enums.containerregistry.v20210601preview.TokenCertificateName>;
    /**
...
export interface TokenCredentialsPropertiesArgs {
    certificates?: pulumi.Input<pulumi.Input<inputs.containerregistry.v20210601preview.TokenCertificateArgs>[]>;
    passwords?: pulumi.Input<pulumi.Input<inputs.containerregistry.v20210601preview.TokenPasswordArgs>[]>;
}
...
export interface TokenPasswordArgs {
     ...
     */
    name?: pulumi.Input<string | enums.containerregistry.v20210601preview.TokenPasswordName>;
}
...
export interface TrustPolicyArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerregistry.v20210601preview.TrustPolicyType>;
}
/**
