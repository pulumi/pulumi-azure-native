...
export interface EncryptionPropertyResponse {
     ...
     */
    keyVaultProperties?: outputs.containerregistry.v20191201preview.KeyVaultPropertiesResponse;
    /**
...
export interface EventContentResponse {
     ...
     * The agent that initiated the event. For most situations, this could be from the authorization context of the request.
     */
    actor?: outputs.containerregistry.v20191201preview.ActorResponse;
    /**
     * The event ID.
     */
    id?: string;
     ...
     */
    request?: outputs.containerregistry.v20191201preview.RequestResponse;
    /**
     * The registry node that generated the event. Put differently, while the actor initiates the event, the source generates it.
     */
    source?: outputs.containerregistry.v20191201preview.SourceResponse;
    /**
     * The target of the event.
     */
    target?: outputs.containerregistry.v20191201preview.TargetResponse;
    /**
...
export interface EventRequestMessageResponse {
     ...
     * The content of the event request message.
     */
    content?: outputs.containerregistry.v20191201preview.EventContentResponse;
    /**
...
export interface EventResponse {
     ...
     * The event request message sent to the service URI.
     */
    eventRequestMessage?: outputs.containerregistry.v20191201preview.EventRequestMessageResponse;
    /**
     * The event response message received from the service URI.
     */
    eventResponseMessage?: outputs.containerregistry.v20191201preview.EventResponseMessageResponse;
    /**
     * The event ID.
     */
    id?: string;
...
export interface IdentityPropertiesResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.containerregistry.v20191201preview.UserIdentityPropertiesResponse};
}
...
export interface NetworkRuleSetResponse {
     ...
     * The IP ACL rules.
     */
    ipRules?: outputs.containerregistry.v20191201preview.IPRuleResponse[];
    /**
     * The virtual network rules.
     */
    virtualNetworkRules?: outputs.containerregistry.v20191201preview.VirtualNetworkRuleResponse[];
}
/**
...
export interface PipelineRunRequestResponse {
     ...
     */
    source?: outputs.containerregistry.v20191201preview.PipelineRunSourcePropertiesResponse;
    /**
     * The target properties of the pipeline run.
     */
    target?: outputs.containerregistry.v20191201preview.PipelineRunTargetPropertiesResponse;
}
/**
...
export function pipelineRunRequestResponseProvideDefaults(val: PipelineRunRequestResponse): PipelineRunRequestResponse {
    return {
        ...val,
        source: (val.source ? outputs.containerregistry.v20191201preview.pipelineRunSourcePropertiesResponseProvideDefaults(val.source) : undefined),
        target: (val.target ? outputs.containerregistry.v20191201preview.pipelineRunTargetPropertiesResponseProvideDefaults(val.target) : undefined),
    };
}
...
export interface PipelineRunResponseResponse {
     ...
     */
    progress?: outputs.containerregistry.v20191201preview.ProgressPropertiesResponse;
    /**
     * The source of the pipeline run.
     */
    source?: outputs.containerregistry.v20191201preview.ImportPipelineSourcePropertiesResponse;
    /**
     ...
     */
    target?: outputs.containerregistry.v20191201preview.ExportPipelineTargetPropertiesResponse;
    /**
     * The trigger that caused the pipeline run.
     */
    trigger?: outputs.containerregistry.v20191201preview.PipelineTriggerDescriptorResponse;
}
/**
...
export function pipelineRunResponseResponseProvideDefaults(val: PipelineRunResponseResponse): PipelineRunResponseResponse {
    return {
        ...val,
        source: (val.source ? outputs.containerregistry.v20191201preview.importPipelineSourcePropertiesResponseProvideDefaults(val.source) : undefined),
    };
}
...
export interface PipelineTriggerDescriptorResponse {
     ...
     */
    sourceTrigger?: outputs.containerregistry.v20191201preview.PipelineSourceTriggerDescriptorResponse;
}
...
export interface PipelineTriggerPropertiesResponse {
     ...
     */
    sourceTrigger?: outputs.containerregistry.v20191201preview.PipelineSourceTriggerPropertiesResponse;
}
/**
...
export function pipelineTriggerPropertiesResponseProvideDefaults(val: PipelineTriggerPropertiesResponse): PipelineTriggerPropertiesResponse {
    return {
        ...val,
        sourceTrigger: (val.sourceTrigger ? outputs.containerregistry.v20191201preview.pipelineSourceTriggerPropertiesResponseProvideDefaults(val.sourceTrigger) : undefined),
    };
}
...
export interface PoliciesResponse {
     ...
     */
    quarantinePolicy?: outputs.containerregistry.v20191201preview.QuarantinePolicyResponse;
    /**
     * The retention policy for a container registry.
     */
    retentionPolicy?: outputs.containerregistry.v20191201preview.RetentionPolicyResponse;
    /**
     * The content trust policy for a container registry.
     */
    trustPolicy?: outputs.containerregistry.v20191201preview.TrustPolicyResponse;
}
/**
...
export function policiesResponseProvideDefaults(val: PoliciesResponse): PoliciesResponse {
    return {
        ...val,
        quarantinePolicy: (val.quarantinePolicy ? outputs.containerregistry.v20191201preview.quarantinePolicyResponseProvideDefaults(val.quarantinePolicy) : undefined),
        retentionPolicy: (val.retentionPolicy ? outputs.containerregistry.v20191201preview.retentionPolicyResponseProvideDefaults(val.retentionPolicy) : undefined),
        trustPolicy: (val.trustPolicy ? outputs.containerregistry.v20191201preview.trustPolicyResponseProvideDefaults(val.trustPolicy) : undefined),
    };
}
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.containerregistry.v20191201preview.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState?: outputs.containerregistry.v20191201preview.PrivateLinkServiceConnectionStateResponse;
    /**
     ...
     */
    systemData: outputs.containerregistry.v20191201preview.SystemDataResponse;
    /**
