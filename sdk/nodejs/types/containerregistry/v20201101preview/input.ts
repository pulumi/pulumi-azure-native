...
export interface EncryptionPropertyArgs {
     ...
     */
    keyVaultProperties?: pulumi.Input<inputs.containerregistry.v20201101preview.KeyVaultPropertiesArgs>;
    /**
     * Indicates whether or not the encryption is enabled for container registry.
     */
    status?: pulumi.Input<string | enums.containerregistry.v20201101preview.EncryptionStatus>;
}
...
export interface IPRuleArgs {
     ...
     */
    action?: pulumi.Input<string | enums.containerregistry.v20201101preview.Action>;
    /**
...
export interface IdentityPropertiesArgs {
     ...
     * The identity type.
     */
    type?: pulumi.Input<enums.containerregistry.v20201101preview.ResourceIdentityType>;
    /**
     ...
     */
    userAssignedIdentities?: pulumi.Input<{[key: string]: pulumi.Input<inputs.containerregistry.v20201101preview.UserIdentityPropertiesArgs>}>;
}
...
export interface ImportPipelineSourcePropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerregistry.v20201101preview.PipelineSourceType>;
    /**
...
export interface LoggingPropertiesArgs {
     ...
     */
    auditLogStatus?: pulumi.Input<string | enums.containerregistry.v20201101preview.AuditLogStatus>;
    /**
     * The verbosity of logs persisted on the connected registry.
     */
    logLevel?: pulumi.Input<string | enums.containerregistry.v20201101preview.LogLevel>;
}
/**
...
export interface NetworkRuleSetArgs {
     ...
     */
    defaultAction: pulumi.Input<string | enums.containerregistry.v20201101preview.DefaultAction>;
    /**
     * The IP ACL rules.
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.containerregistry.v20201101preview.IPRuleArgs>[]>;
    /**
     * The virtual network rules.
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.containerregistry.v20201101preview.VirtualNetworkRuleArgs>[]>;
}
/**
...
export interface ParentPropertiesArgs {
     ...
     */
    syncProperties: pulumi.Input<inputs.containerregistry.v20201101preview.SyncPropertiesArgs>;
}
...
export interface PipelineRunRequestArgs {
     ...
     */
    source?: pulumi.Input<inputs.containerregistry.v20201101preview.PipelineRunSourcePropertiesArgs>;
    /**
     * The target properties of the pipeline run.
     */
    target?: pulumi.Input<inputs.containerregistry.v20201101preview.PipelineRunTargetPropertiesArgs>;
}
/**
...
export function pipelineRunRequestArgsProvideDefaults(val: PipelineRunRequestArgs): PipelineRunRequestArgs {
    return {
        ...val,
        source: (val.source ? pulumi.output(val.source).apply(inputs.containerregistry.v20201101preview.pipelineRunSourcePropertiesArgsProvideDefaults) : undefined),
        target: (val.target ? pulumi.output(val.target).apply(inputs.containerregistry.v20201101preview.pipelineRunTargetPropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface PipelineRunSourcePropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerregistry.v20201101preview.PipelineRunSourceType>;
}
/**
...
export interface PipelineRunTargetPropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerregistry.v20201101preview.PipelineRunTargetType>;
}
/**
...
export interface PipelineSourceTriggerPropertiesArgs {
     ...
     */
    status: pulumi.Input<string | enums.containerregistry.v20201101preview.TriggerStatus>;
}
/**
...
export interface PipelineTriggerPropertiesArgs {
     ...
     */
    sourceTrigger?: pulumi.Input<inputs.containerregistry.v20201101preview.PipelineSourceTriggerPropertiesArgs>;
}
/**
...
export function pipelineTriggerPropertiesArgsProvideDefaults(val: PipelineTriggerPropertiesArgs): PipelineTriggerPropertiesArgs {
    return {
        ...val,
        sourceTrigger: (val.sourceTrigger ? pulumi.output(val.sourceTrigger).apply(inputs.containerregistry.v20201101preview.pipelineSourceTriggerPropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface PoliciesArgs {
     ...
     */
    quarantinePolicy?: pulumi.Input<inputs.containerregistry.v20201101preview.QuarantinePolicyArgs>;
    /**
     * The retention policy for a container registry.
     */
    retentionPolicy?: pulumi.Input<inputs.containerregistry.v20201101preview.RetentionPolicyArgs>;
    /**
     * The content trust policy for a container registry.
     */
    trustPolicy?: pulumi.Input<inputs.containerregistry.v20201101preview.TrustPolicyArgs>;
}
/**
...
export function policiesArgsProvideDefaults(val: PoliciesArgs): PoliciesArgs {
    return {
        ...val,
        quarantinePolicy: (val.quarantinePolicy ? pulumi.output(val.quarantinePolicy).apply(inputs.containerregistry.v20201101preview.quarantinePolicyArgsProvideDefaults) : undefined),
        retentionPolicy: (val.retentionPolicy ? pulumi.output(val.retentionPolicy).apply(inputs.containerregistry.v20201101preview.retentionPolicyArgsProvideDefaults) : undefined),
        trustPolicy: (val.trustPolicy ? pulumi.output(val.trustPolicy).apply(inputs.containerregistry.v20201101preview.trustPolicyArgsProvideDefaults) : undefined),
    };
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    actionsRequired?: pulumi.Input<string | enums.containerregistry.v20201101preview.ActionsRequired>;
    /**
     ...
     */
    status?: pulumi.Input<string | enums.containerregistry.v20201101preview.ConnectionStatus>;
}
...
export interface QuarantinePolicyArgs {
     ...
     */
    status?: pulumi.Input<string | enums.containerregistry.v20201101preview.PolicyStatus>;
}
/**
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<string | enums.containerregistry.v20201101preview.SkuName>;
}
...
export interface TokenCertificateArgs {
    ...
    name?: pulumi.Input<string | enums.containerregistry.v20201101preview.TokenCertificateName>;
    /**
...
export interface TokenCredentialsPropertiesArgs {
    certificates?: pulumi.Input<pulumi.Input<inputs.containerregistry.v20201101preview.TokenCertificateArgs>[]>;
    passwords?: pulumi.Input<pulumi.Input<inputs.containerregistry.v20201101preview.TokenPasswordArgs>[]>;
}
...
export interface TokenPasswordArgs {
     ...
     */
    name?: pulumi.Input<string | enums.containerregistry.v20201101preview.TokenPasswordName>;
}
...
export interface TrustPolicyArgs {
     ...
     */
    type?: pulumi.Input<string | enums.containerregistry.v20201101preview.TrustPolicyType>;
}
/**
