...
export interface AwsEnvironmentDataResponse {
     ...
     */
    organizationalData?: outputs.security.v20220801preview.AwsOrganizationalDataMasterResponse | outputs.security.v20220801preview.AwsOrganizationalDataMemberResponse;
}
...
export interface CspmMonitorAwsOfferingResponse {
     ...
     */
    nativeCloudConnection?: outputs.security.v20220801preview.CspmMonitorAwsOfferingResponseNativeCloudConnection;
    /**
...
export interface CspmMonitorGcpOfferingResponse {
     ...
     * The native cloud connection configuration
     */
    nativeCloudConnection?: outputs.security.v20220801preview.CspmMonitorGcpOfferingResponseNativeCloudConnection;
    /**
     * The type of the security offering.
...
export interface DefenderCspmAwsOfferingResponse {
     ...
     */
    vmScanners?: outputs.security.v20220801preview.DefenderCspmAwsOfferingResponseVmScanners;
}
...
export interface DefenderCspmAwsOfferingResponseVmScanners {
     ...
     * configuration for Microsoft Defender for Server VM scanning
     */
    configuration?: outputs.security.v20220801preview.DefenderCspmAwsOfferingResponseConfiguration;
    /**
...
export interface DefenderFoDatabasesAwsOfferingResponse {
     ...
     */
    arcAutoProvisioning?: outputs.security.v20220801preview.DefenderFoDatabasesAwsOfferingResponseArcAutoProvisioning;
    /**
     * The offering description.
     */
    description: string;
     ...
     */
    rds?: outputs.security.v20220801preview.DefenderFoDatabasesAwsOfferingResponseRds;
}
...
export interface DefenderForContainersAwsOfferingResponse {
     ...
     */
    cloudWatchToKinesis?: outputs.security.v20220801preview.DefenderForContainersAwsOfferingResponseCloudWatchToKinesis;
    /**
     * The container vulnerability assessment configuration
     */
    containerVulnerabilityAssessment?: outputs.security.v20220801preview.DefenderForContainersAwsOfferingResponseContainerVulnerabilityAssessment;
    /**
     * The container vulnerability assessment task configuration
     */
    containerVulnerabilityAssessmentTask?: outputs.security.v20220801preview.DefenderForContainersAwsOfferingResponseContainerVulnerabilityAssessmentTask;
    /**
     * The offering description.
     */
    description: string;
     ...
     */
    kinesisToS3?: outputs.security.v20220801preview.DefenderForContainersAwsOfferingResponseKinesisToS3;
    /**
     ...
     */
    kubernetesScubaReader?: outputs.security.v20220801preview.DefenderForContainersAwsOfferingResponseKubernetesScubaReader;
    /**
     * The kubernetes service connection configuration
     */
    kubernetesService?: outputs.security.v20220801preview.DefenderForContainersAwsOfferingResponseKubernetesService;
    /**
     * The type of the security offering.
...
export interface DefenderForContainersGcpOfferingResponse {
     ...
     * The native cloud connection configuration
     */
    dataPipelineNativeCloudConnection?: outputs.security.v20220801preview.DefenderForContainersGcpOfferingResponseDataPipelineNativeCloudConnection;
    /**
     ...
     * The native cloud connection configuration
     */
    nativeCloudConnection?: outputs.security.v20220801preview.DefenderForContainersGcpOfferingResponseNativeCloudConnection;
    /**
     * The type of the security offering.
...
export interface DefenderForDatabasesGcpOfferingResponse {
     ...
     * The ARC autoprovisioning configuration
     */
    arcAutoProvisioning?: outputs.security.v20220801preview.DefenderForDatabasesGcpOfferingResponseArcAutoProvisioning;
    /**
     * The native cloud connection configuration
     */
    defenderForDatabasesArcAutoProvisioning?: outputs.security.v20220801preview.DefenderForDatabasesGcpOfferingResponseDefenderForDatabasesArcAutoProvisioning;
    /**
     * The offering description.
     */
    description: string;
...
export interface DefenderForServersAwsOfferingResponse {
     ...
     * The ARC autoprovisioning configuration
     */
    arcAutoProvisioning?: outputs.security.v20220801preview.DefenderForServersAwsOfferingResponseArcAutoProvisioning;
    /**
     * The Defender for servers connection configuration
     */
    defenderForServers?: outputs.security.v20220801preview.DefenderForServersAwsOfferingResponseDefenderForServers;
    /**
     * The offering description.
     */
    description: string;
     ...
     */
    mdeAutoProvisioning?: outputs.security.v20220801preview.DefenderForServersAwsOfferingResponseMdeAutoProvisioning;
    /**
     * The type of the security offering.
     ...
     */
    subPlan?: outputs.security.v20220801preview.DefenderForServersAwsOfferingResponseSubPlan;
    /**
     * The Vulnerability Assessment autoprovisioning configuration
     */
    vaAutoProvisioning?: outputs.security.v20220801preview.DefenderForServersAwsOfferingResponseVaAutoProvisioning;
    /**
     * The Microsoft Defender for Server VM scanning configuration
     */
    vmScanners?: outputs.security.v20220801preview.DefenderForServersAwsOfferingResponseVmScanners;
}
...
export interface DefenderForServersAwsOfferingResponseVaAutoProvisioning {
     ...
     * configuration for Vulnerability Assessment autoprovisioning
     */
    configuration?: outputs.security.v20220801preview.DefenderForServersAwsOfferingResponseConfiguration;
    /**
...
export interface DefenderForServersAwsOfferingResponseVmScanners {
     ...
     * configuration for Microsoft Defender for Server VM scanning
     */
    configuration?: outputs.security.v20220801preview.DefenderForServersAwsOfferingResponseConfigurationConfiguration;
    /**
     * Is Microsoft Defender for Server VM scanning enabled
     */
    enabled?: boolean;
...
export interface DefenderForServersGcpOfferingResponse {
     ...
     * The ARC autoprovisioning configuration
     */
    arcAutoProvisioning?: outputs.security.v20220801preview.DefenderForServersGcpOfferingResponseArcAutoProvisioning;
    /**
     * The Defender for servers connection configuration
     */
    defenderForServers?: outputs.security.v20220801preview.DefenderForServersGcpOfferingResponseDefenderForServers;
    /**
     * The offering description.
     */
    description: string;
     ...
     * The Microsoft Defender for Endpoint autoprovisioning configuration
     */
    mdeAutoProvisioning?: outputs.security.v20220801preview.DefenderForServersGcpOfferingResponseMdeAutoProvisioning;
    /**
     * The type of the security offering.
     ...
     * configuration for the servers offering subPlan
     */
    subPlan?: outputs.security.v20220801preview.DefenderForServersGcpOfferingResponseSubPlan;
    /**
     * The Vulnerability Assessment autoprovisioning configuration
     */
    vaAutoProvisioning?: outputs.security.v20220801preview.DefenderForServersGcpOfferingResponseVaAutoProvisioning;
}
...
export interface DefenderForServersGcpOfferingResponseVaAutoProvisioning {
     ...
     * configuration for Vulnerability Assessment autoprovisioning
     */
    configuration?: outputs.security.v20220801preview.DefenderForServersGcpOfferingResponseConfiguration;
    /**
     * Is Vulnerability Assessment auto provisioning enabled
     */
    enabled?: boolean;
...
export interface GcpProjectEnvironmentDataResponse {
     ...
     */
    organizationalData?: outputs.security.v20220801preview.GcpOrganizationalDataMemberResponse | outputs.security.v20220801preview.GcpOrganizationalDataOrganizationResponse;
    /**
     * The Gcp project's details
     */
    projectDetails?: outputs.security.v20220801preview.GcpProjectDetailsResponse;
}
...
export interface InformationProtectionAwsOfferingResponse {
     ...
     * The native cloud connection configuration
     */
    informationProtection?: outputs.security.v20220801preview.InformationProtectionAwsOfferingResponseInformationProtection;
    /**
     * The type of the security offering.
