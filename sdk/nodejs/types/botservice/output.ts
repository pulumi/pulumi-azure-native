...
export * as v20180712 from "./v20180712/output";
export * as v20200602 from "./v20200602/output";
export * as v20210301 from "./v20210301/output";
export * as v20210501preview from "./v20210501preview/output";
export * as v20220615preview from "./v20220615preview/output";
/**
...
export interface AlexaChannelResponse {
     ...
     */
    properties?: outputs.botservice.AlexaChannelPropertiesResponse;
    /**
...
export interface ChannelSettingsResponse {
     ...
     * The list of sites
     */
    sites?: outputs.botservice.SiteResponse[];
}
...
export interface DirectLineChannelPropertiesResponse {
     ...
     */
    sites?: outputs.botservice.DirectLineSiteResponse[];
}
...
export interface DirectLineChannelResponse {
     ...
     */
    properties?: outputs.botservice.DirectLineChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface DirectLineSpeechChannelResponse {
     ...
     */
    properties?: outputs.botservice.DirectLineSpeechChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface EmailChannelResponse {
     ...
     */
    properties?: outputs.botservice.EmailChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface EnterpriseChannelPropertiesResponse {
     ...
     */
    nodes: outputs.botservice.EnterpriseChannelNodeResponse[];
    /**
...
export interface FacebookChannelPropertiesResponse {
     ...
     */
    pages?: outputs.botservice.FacebookPageResponse[];
    /**
...
export interface FacebookChannelResponse {
     ...
     */
    properties?: outputs.botservice.FacebookChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface KikChannelResponse {
     ...
     */
    properties?: outputs.botservice.KikChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface LineChannelPropertiesResponse {
     ...
     */
    lineRegistrations: outputs.botservice.LineRegistrationResponse[];
}
...
export interface LineChannelResponse {
     ...
     */
    properties?: outputs.botservice.LineChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface MsTeamsChannelResponse {
     ...
     */
    properties?: outputs.botservice.MsTeamsChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export function msTeamsChannelResponseProvideDefaults(val: MsTeamsChannelResponse): MsTeamsChannelResponse {
    return {
        ...val,
        location: (val.location) ?? "global",
        properties: (val.properties ? outputs.botservice.msTeamsChannelPropertiesResponseProvideDefaults(val.properties) : undefined),
    };
}
...
export interface ServiceProviderParameterResponse {
     ...
     */
    metadata: outputs.botservice.ServiceProviderParameterResponseMetadata;
    /**
...
export interface ServiceProviderParameterResponseMetadata {
     ...
     * the constraints of the bot meta data.
     */
    constraints?: outputs.botservice.ServiceProviderParameterResponseConstraints;
}
...
export interface SkypeChannelResponse {
     ...
     */
    properties?: outputs.botservice.SkypeChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface SlackChannelResponse {
     ...
     */
    properties?: outputs.botservice.SlackChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface SmsChannelResponse {
     ...
     */
    properties?: outputs.botservice.SmsChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface TelegramChannelResponse {
     ...
     */
    properties?: outputs.botservice.TelegramChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface WebChatChannelPropertiesResponse {
     ...
     */
    sites?: outputs.botservice.WebChatSiteResponse[];
    /**
...
export interface WebChatChannelResponse {
     ...
     */
    properties?: outputs.botservice.WebChatChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
