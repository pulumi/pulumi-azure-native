...
export interface AlexaChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.AlexaChannelPropertiesArgs>;
}
/**
...
export interface BotPropertiesArgs {
     ...
     */
    msaAppType?: pulumi.Input<string | enums.botservice.v20220615preview.MsaAppType>;
    /**
     ...
     */
    publicNetworkAccess?: pulumi.Input<string | enums.botservice.v20220615preview.PublicNetworkAccess>;
    /**
...
export interface ConnectionSettingPropertiesArgs {
     ...
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.botservice.v20220615preview.ConnectionSettingParameterArgs>[]>;
    /**
...
export interface DirectLineChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.DirectLineChannelPropertiesArgs>;
}
/**
...
export interface DirectLineChannelPropertiesArgs {
     ...
     */
    sites?: pulumi.Input<pulumi.Input<inputs.botservice.v20220615preview.DirectLineSiteArgs>[]>;
}
...
export interface DirectLineSpeechChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.DirectLineSpeechChannelPropertiesArgs>;
}
/**
...
export interface EmailChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.EmailChannelPropertiesArgs>;
}
/**
...
export interface FacebookChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.FacebookChannelPropertiesArgs>;
}
/**
...
export interface FacebookChannelPropertiesArgs {
     ...
     */
    pages?: pulumi.Input<pulumi.Input<inputs.botservice.v20220615preview.FacebookPageArgs>[]>;
}
...
export interface KikChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.KikChannelPropertiesArgs>;
}
/**
...
export interface LineChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.LineChannelPropertiesArgs>;
}
/**
...
export interface LineChannelPropertiesArgs {
     ...
     */
    lineRegistrations: pulumi.Input<pulumi.Input<inputs.botservice.v20220615preview.LineRegistrationArgs>[]>;
}
...
export interface MsTeamsChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.MsTeamsChannelPropertiesArgs>;
}
/**
...
export function msTeamsChannelArgsProvideDefaults(val: MsTeamsChannelArgs): MsTeamsChannelArgs {
    return {
        ...val,
        location: (val.location) ?? "global",
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.botservice.v20220615preview.msTeamsChannelPropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.botservice.v20220615preview.PrivateEndpointServiceConnectionStatus>;
}
...
export interface SkuArgs {
     ...
     * The sku name
     */
    name: pulumi.Input<string | enums.botservice.v20220615preview.SkuName>;
}
...
export interface SkypeChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.SkypeChannelPropertiesArgs>;
}
/**
...
export function skypeChannelArgsProvideDefaults(val: SkypeChannelArgs): SkypeChannelArgs {
    return {
        ...val,
        location: (val.location) ?? "global",
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.botservice.v20220615preview.skypeChannelPropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface SlackChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.SlackChannelPropertiesArgs>;
}
/**
...
export interface SmsChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.SmsChannelPropertiesArgs>;
}
/**
...
export interface TelegramChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.TelegramChannelPropertiesArgs>;
}
/**
...
export interface WebChatChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20220615preview.WebChatChannelPropertiesArgs>;
}
/**
...
export interface WebChatChannelPropertiesArgs {
     ...
     */
    sites?: pulumi.Input<pulumi.Input<inputs.botservice.v20220615preview.WebChatSiteArgs>[]>;
}
