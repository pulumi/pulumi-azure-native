...
export interface AlexaChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.AlexaChannelPropertiesArgs>;
}
/**
...
export interface BotPropertiesArgs {
     ...
     */
    msaAppType?: pulumi.Input<string | enums.botservice.v20210301.MsaAppType>;
    /**
     ...
     */
    publicNetworkAccess?: pulumi.Input<string | enums.botservice.v20210301.PublicNetworkAccess>;
    /**
...
export interface ConnectionSettingPropertiesArgs {
     ...
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.botservice.v20210301.ConnectionSettingParameterArgs>[]>;
    /**
...
export interface DirectLineChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.DirectLineChannelPropertiesArgs>;
}
/**
...
export interface DirectLineChannelPropertiesArgs {
     ...
     */
    sites?: pulumi.Input<pulumi.Input<inputs.botservice.v20210301.DirectLineSiteArgs>[]>;
}
...
export interface DirectLineSpeechChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.DirectLineSpeechChannelPropertiesArgs>;
}
/**
...
export interface EmailChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.EmailChannelPropertiesArgs>;
}
/**
...
export interface FacebookChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.FacebookChannelPropertiesArgs>;
}
/**
...
export interface FacebookChannelPropertiesArgs {
     ...
     */
    pages?: pulumi.Input<pulumi.Input<inputs.botservice.v20210301.FacebookPageArgs>[]>;
}
...
export interface KikChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.KikChannelPropertiesArgs>;
}
/**
...
export interface LineChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.LineChannelPropertiesArgs>;
}
/**
...
export interface LineChannelPropertiesArgs {
     ...
     */
    lineRegistrations: pulumi.Input<pulumi.Input<inputs.botservice.v20210301.LineRegistrationArgs>[]>;
}
...
export interface MsTeamsChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.MsTeamsChannelPropertiesArgs>;
}
/**
...
export function msTeamsChannelArgsProvideDefaults(val: MsTeamsChannelArgs): MsTeamsChannelArgs {
    return {
        ...val,
        location: (val.location) ?? "global",
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.botservice.v20210301.msTeamsChannelPropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface SkuArgs {
     ...
     * The sku name
     */
    name: pulumi.Input<string | enums.botservice.v20210301.SkuName>;
}
...
export interface SkypeChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.SkypeChannelPropertiesArgs>;
}
/**
...
export interface SlackChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.SlackChannelPropertiesArgs>;
}
/**
...
export interface SmsChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.SmsChannelPropertiesArgs>;
}
/**
...
export interface TelegramChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.TelegramChannelPropertiesArgs>;
}
/**
...
export interface WebChatChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20210301.WebChatChannelPropertiesArgs>;
}
/**
...
export interface WebChatChannelPropertiesArgs {
     ...
     */
    sites?: pulumi.Input<pulumi.Input<inputs.botservice.v20210301.WebChatSiteArgs>[]>;
}
