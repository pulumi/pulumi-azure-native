...
export interface ConnectionSettingPropertiesArgs {
     ...
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.botservice.v20180712.ConnectionSettingParameterArgs>[]>;
    /**
...
export interface DirectLineChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20180712.DirectLineChannelPropertiesArgs>;
}
...
export interface DirectLineChannelPropertiesArgs {
     ...
     */
    sites?: pulumi.Input<pulumi.Input<inputs.botservice.v20180712.DirectLineSiteArgs>[]>;
}
...
export interface EmailChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20180712.EmailChannelPropertiesArgs>;
}
...
export interface EnterpriseChannelNodeArgs {
     ...
     */
    state?: pulumi.Input<string | enums.botservice.v20180712.EnterpriseChannelNodeState>;
}
...
export interface EnterpriseChannelPropertiesArgs {
     ...
     */
    nodes: pulumi.Input<pulumi.Input<inputs.botservice.v20180712.EnterpriseChannelNodeArgs>[]>;
    /**
     * The current state of the Enterprise Channel.
     */
    state?: pulumi.Input<string | enums.botservice.v20180712.EnterpriseChannelState>;
}
...
export interface FacebookChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20180712.FacebookChannelPropertiesArgs>;
}
...
export interface FacebookChannelPropertiesArgs {
     ...
     */
    pages?: pulumi.Input<pulumi.Input<inputs.botservice.v20180712.FacebookPageArgs>[]>;
}
...
export interface KikChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20180712.KikChannelPropertiesArgs>;
}
...
export interface MsTeamsChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20180712.MsTeamsChannelPropertiesArgs>;
}
...
export interface SkuArgs {
     ...
     * The sku name
     */
    name: pulumi.Input<string | enums.botservice.v20180712.SkuName>;
}
...
export interface SkypeChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20180712.SkypeChannelPropertiesArgs>;
}
...
export interface SlackChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20180712.SlackChannelPropertiesArgs>;
}
...
export interface SmsChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20180712.SmsChannelPropertiesArgs>;
}
...
export interface TelegramChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20180712.TelegramChannelPropertiesArgs>;
}
...
export interface WebChatChannelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.botservice.v20180712.WebChatChannelPropertiesArgs>;
}
...
export interface WebChatChannelPropertiesArgs {
     ...
     */
    sites?: pulumi.Input<pulumi.Input<inputs.botservice.v20180712.WebChatSiteArgs>[]>;
}
...
export interface WebChatSiteArgs {
     ...
     */
    enablePreview: pulumi.Input<boolean>;
    /**
     * Whether this site is enabled for DirectLine channel
     */
    isEnabled: pulumi.Input<boolean>;
