...
export interface AlexaChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.AlexaChannelPropertiesResponse;
    /**
...
export interface BotPropertiesResponse {
     ...
     */
    privateEndpointConnections: outputs.botservice.v20210501preview.PrivateEndpointConnectionResponse[];
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface ChannelSettingsResponse {
     ...
     * The list of sites
     */
    sites?: outputs.botservice.v20210501preview.SiteResponse[];
}
...
export interface ConnectionSettingPropertiesResponse {
     ...
     */
    parameters?: outputs.botservice.v20210501preview.ConnectionSettingParameterResponse[];
    /**
     * Provisioning state of the resource
     */
    provisioningState?: string;
...
export interface DirectLineChannelPropertiesResponse {
     ...
     */
    sites?: outputs.botservice.v20210501preview.DirectLineSiteResponse[];
}
...
export interface DirectLineChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.DirectLineChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface DirectLineSpeechChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.DirectLineSpeechChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface EmailChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.EmailChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface FacebookChannelPropertiesResponse {
     ...
     */
    pages?: outputs.botservice.v20210501preview.FacebookPageResponse[];
    /**
...
export interface FacebookChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.FacebookChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface KikChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.KikChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface LineChannelPropertiesResponse {
     ...
     */
    lineRegistrations: outputs.botservice.v20210501preview.LineRegistrationResponse[];
}
...
export interface LineChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.LineChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface MsTeamsChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.MsTeamsChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.botservice.v20210501preview.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: outputs.botservice.v20210501preview.PrivateLinkServiceConnectionStateResponse;
    /**
...
export interface ServiceProviderParameterResponse {
     ...
     */
    metadata: outputs.botservice.v20210501preview.ServiceProviderParameterResponseMetadata;
    /**
...
export interface ServiceProviderParameterResponseMetadata {
     ...
     * the constraints of the bot meta data.
     */
    constraints?: outputs.botservice.v20210501preview.ServiceProviderParameterResponseConstraints;
}
...
export interface ServiceProviderPropertiesResponse {
     ...
     */
    parameters?: outputs.botservice.v20210501preview.ServiceProviderParameterResponse[];
    /**
     * Display Name of the Service Provider
     */
...
export interface ServiceProviderResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.ServiceProviderPropertiesResponse;
}
...
export interface SkypeChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.SkypeChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface SlackChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.SlackChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface SmsChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.SmsChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface TelegramChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.TelegramChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
...
export interface WebChatChannelPropertiesResponse {
     ...
     */
    sites?: outputs.botservice.v20210501preview.WebChatSiteResponse[];
    /**
...
export interface WebChatChannelResponse {
     ...
     */
    properties?: outputs.botservice.v20210501preview.WebChatChannelPropertiesResponse;
    /**
     * Provisioning state of the resource
     */
    provisioningState: string;
