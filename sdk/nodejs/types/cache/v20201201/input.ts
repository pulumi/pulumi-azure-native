...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.cache.v20201201.PrivateEndpointServiceConnectionStatus>;
}
...
export interface ScheduleEntryArgs {
     ...
     */
    dayOfWeek: pulumi.Input<enums.cache.v20201201.DayOfWeek>;
    /**
...
/**
 * scheduleEntryArgsProvideDefaults sets the appropriate defaults for ScheduleEntryArgs
 */
export function scheduleEntryArgsProvideDefaults(val: ScheduleEntryArgs): ScheduleEntryArgs {
    return {
        ...val,
        maintenanceWindow: (val.maintenanceWindow) ?? "PT5H",
    };
}
...
export interface SkuArgs {
     ...
     */
    family: pulumi.Input<string | enums.cache.v20201201.SkuFamily>;
    /**
     * The type of Redis cache to deploy. Valid values: (Basic, Standard, Premium)
     */
    name: pulumi.Input<string | enums.cache.v20201201.SkuName>;
}
