...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.cache.v20201201.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: outputs.cache.v20201201.PrivateLinkServiceConnectionStateResponse;
    /**
...
/**
 * scheduleEntryResponseProvideDefaults sets the appropriate defaults for ScheduleEntryResponse
 */
export function scheduleEntryResponseProvideDefaults(val: ScheduleEntryResponse): ScheduleEntryResponse {
    return {
        ...val,
