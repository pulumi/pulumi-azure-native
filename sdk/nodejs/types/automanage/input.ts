...
export interface AccountIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.automanage.ResourceIdentityType>;
}
...
export interface ConfigurationProfileAssignmentPropertiesArgs {
     ...
     */
    configurationProfile?: pulumi.Input<string | enums.automanage.ConfigurationProfile>;
    /**
...
export interface ConfigurationProfilePreferenceAntiMalwareArgs {
     ...
     */
    enableRealTimeProtection?: pulumi.Input<string | enums.automanage.EnableRealTimeProtection>;
    /**
     ...
     */
    runScheduledScan?: pulumi.Input<string | enums.automanage.RunScheduledScan>;
    /**
     ...
     */
    scanType?: pulumi.Input<string | enums.automanage.ScanType>;
}
...
export interface ConfigurationProfilePreferencePropertiesArgs {
     ...
     */
    antiMalware?: pulumi.Input<inputs.automanage.ConfigurationProfilePreferenceAntiMalwareArgs>;
    /**
     * The custom preferences for Azure VM Backup.
     */
    vmBackup?: pulumi.Input<inputs.automanage.ConfigurationProfilePreferenceVmBackupArgs>;
}
