...
export interface DatadogHostMetadataResponse {
     ...
     */
    agentVersion?: string;
    installMethod?: outputs.datadog.DatadogInstallMethodResponse;
    logsAgent?: outputs.datadog.DatadogLogsAgentResponse;
}
...
export interface DatadogHostResponse {
     ...
     */
    apps?: string[];
    meta?: outputs.datadog.DatadogHostMetadataResponse;
    /**
...
export interface MonitorPropertiesResponse {
     ...
     * Datadog organization properties
     */
    datadogOrganizationProperties?: outputs.datadog.DatadogOrganizationPropertiesResponse;
     ...
     * User info
     */
    userInfo?: outputs.datadog.UserInfoResponse;
}
