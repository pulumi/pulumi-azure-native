...
export interface ApplicationPropertiesArgs {
     ...
     */
    computeProfile?: pulumi.Input<inputs.hdinsight.ComputeProfileArgs>;
    /**
     * The list of errors.
     */
    errors?: pulumi.Input<pulumi.Input<inputs.hdinsight.ErrorsArgs>[]>;
    /**
     * The list of application HTTPS endpoints.
     */
    httpsEndpoints?: pulumi.Input<pulumi.Input<inputs.hdinsight.ApplicationGetHttpsEndpointArgs>[]>;
    /**
     * The list of install script actions.
     */
    installScriptActions?: pulumi.Input<pulumi.Input<inputs.hdinsight.RuntimeScriptActionArgs>[]>;
    /**
     * The list of application SSH endpoints.
     */
    sshEndpoints?: pulumi.Input<pulumi.Input<inputs.hdinsight.ApplicationGetEndpointArgs>[]>;
    /**
     * The list of uninstall script actions.
     */
    uninstallScriptActions?: pulumi.Input<pulumi.Input<inputs.hdinsight.RuntimeScriptActionArgs>[]>;
}
...
export interface AutoscaleArgs {
     ...
     */
    capacity?: pulumi.Input<inputs.hdinsight.AutoscaleCapacityArgs>;
    /**
     * Parameters for schedule-based autoscale
     */
    recurrence?: pulumi.Input<inputs.hdinsight.AutoscaleRecurrenceArgs>;
}
...
export interface AutoscaleRecurrenceArgs {
     ...
     */
    schedule?: pulumi.Input<pulumi.Input<inputs.hdinsight.AutoscaleScheduleArgs>[]>;
    /**
...
export interface AutoscaleScheduleArgs {
     ...
     */
    days?: pulumi.Input<pulumi.Input<enums.hdinsight.DaysOfWeek>[]>;
    /**
     * Time and capacity for a schedule-based autoscale rule
     */
    timeAndCapacity?: pulumi.Input<inputs.hdinsight.AutoscaleTimeAndCapacityArgs>;
}
...
export interface ClusterCreatePropertiesArgs {
     ...
     */
    clusterDefinition?: pulumi.Input<inputs.hdinsight.ClusterDefinitionArgs>;
    /**
     ...
     */
    computeIsolationProperties?: pulumi.Input<inputs.hdinsight.ComputeIsolationPropertiesArgs>;
    /**
     * The compute profile.
     */
    computeProfile?: pulumi.Input<inputs.hdinsight.ComputeProfileArgs>;
     ...
     */
    diskEncryptionProperties?: pulumi.Input<inputs.hdinsight.DiskEncryptionPropertiesArgs>;
    /**
     * The encryption-in-transit properties.
     */
    encryptionInTransitProperties?: pulumi.Input<inputs.hdinsight.EncryptionInTransitPropertiesArgs>;
    /**
     * The cluster kafka rest proxy configuration.
     */
    kafkaRestProperties?: pulumi.Input<inputs.hdinsight.KafkaRestPropertiesArgs>;
    /**
     ...
     */
    networkProperties?: pulumi.Input<inputs.hdinsight.NetworkPropertiesArgs>;
    /**
     * The type of operating system.
     */
    osType?: pulumi.Input<enums.hdinsight.OSType>;
    /**
     * The security profile.
     */
    securityProfile?: pulumi.Input<inputs.hdinsight.SecurityProfileArgs>;
    /**
     * The storage profile.
     */
    storageProfile?: pulumi.Input<inputs.hdinsight.StorageProfileArgs>;
    /**
     * The cluster tier.
     */
    tier?: pulumi.Input<enums.hdinsight.Tier>;
}
/**
...
export function clusterCreatePropertiesArgsProvideDefaults(val: ClusterCreatePropertiesArgs): ClusterCreatePropertiesArgs {
    return {
        ...val,
        computeIsolationProperties: (val.computeIsolationProperties ? pulumi.output(val.computeIsolationProperties).apply(inputs.hdinsight.computeIsolationPropertiesArgsProvideDefaults) : undefined),
        diskEncryptionProperties: (val.diskEncryptionProperties ? pulumi.output(val.diskEncryptionProperties).apply(inputs.hdinsight.diskEncryptionPropertiesArgsProvideDefaults) : undefined),
        encryptionInTransitProperties: (val.encryptionInTransitProperties ? pulumi.output(val.encryptionInTransitProperties).apply(inputs.hdinsight.encryptionInTransitPropertiesArgsProvideDefaults) : undefined),
...
export interface ClusterIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.hdinsight.ResourceIdentityType>;
    /**
     * The list of user identities associated with the cluster. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
     */
    userAssignedIdentities?: pulumi.Input<{[key: string]: pulumi.Input<inputs.hdinsight.ClusterIdentityUserAssignedIdentitiesArgs>}>;
}
...
export interface ComputeProfileArgs {
     ...
     * The list of roles in the cluster.
     */
    roles?: pulumi.Input<pulumi.Input<inputs.hdinsight.RoleArgs>[]>;
}
...
export interface DiskEncryptionPropertiesArgs {
     ...
     */
    encryptionAlgorithm?: pulumi.Input<string | enums.hdinsight.JsonWebKeyEncryptionAlgorithm>;
    /**
...
export interface KafkaRestPropertiesArgs {
     ...
     * The information of AAD security group.
     */
    clientGroupInfo?: pulumi.Input<inputs.hdinsight.ClientGroupInfoArgs>;
    /**
...
export interface LinuxOperatingSystemProfileArgs {
     ...
     * The SSH profile.
     */
    sshProfile?: pulumi.Input<inputs.hdinsight.SshProfileArgs>;
    /**
     * The username.
     */
...
export interface NetworkPropertiesArgs {
     ...
     */
    privateLink?: pulumi.Input<string | enums.hdinsight.PrivateLink>;
    /**
     * The direction for the resource provider connection.
     */
    resourceProviderConnection?: pulumi.Input<string | enums.hdinsight.ResourceProviderConnection>;
}
...
export interface OsProfileArgs {
     ...
     */
    linuxOperatingSystemProfile?: pulumi.Input<inputs.hdinsight.LinuxOperatingSystemProfileArgs>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status: pulumi.Input<string | enums.hdinsight.PrivateLinkServiceConnectionStatus>;
}
...
export interface RoleArgs {
     ...
     */
    autoscaleConfiguration?: pulumi.Input<inputs.hdinsight.AutoscaleArgs>;
    /**
     * The data disks groups for the role.
     */
    dataDisksGroups?: pulumi.Input<pulumi.Input<inputs.hdinsight.DataDisksGroupsArgs>[]>;
    /**
     ...
     * The hardware profile.
     */
    hardwareProfile?: pulumi.Input<inputs.hdinsight.HardwareProfileArgs>;
    /**
     * The minimum instance count of the cluster.
     */
    minInstanceCount?: pulumi.Input<number>;
     ...
     */
    osProfile?: pulumi.Input<inputs.hdinsight.OsProfileArgs>;
    /**
     * The list of script actions on the role.
     */
    scriptActions?: pulumi.Input<pulumi.Input<inputs.hdinsight.ScriptActionArgs>[]>;
    /**
     ...
     */
    virtualNetworkProfile?: pulumi.Input<inputs.hdinsight.VirtualNetworkProfileArgs>;
}
/**
...
export interface SecurityProfileArgs {
     ...
     * The directory type.
     */
    directoryType?: pulumi.Input<enums.hdinsight.DirectoryType>;
    /**
...
export interface SshProfileArgs {
     ...
     * The list of SSH public keys.
     */
    publicKeys?: pulumi.Input<pulumi.Input<inputs.hdinsight.SshPublicKeyArgs>[]>;
}
...
export interface StorageProfileArgs {
     ...
     */
    storageaccounts?: pulumi.Input<pulumi.Input<inputs.hdinsight.StorageAccountArgs>[]>;
}
