...
export * as v20150301preview from "./v20150301preview/output";
...
export interface ClusterGetPropertiesResponse {
     ...
     */
    computeIsolationProperties?: outputs.hdinsight.ComputeIsolationPropertiesResponse;
    /**
     * The compute profile.
     */
    computeProfile?: outputs.hdinsight.ComputeProfileResponse;
     ...
     */
    excludedServicesConfig?: outputs.hdinsight.ExcludedServicesConfigResponse;
    /**
     ...
     */
    networkProperties?: outputs.hdinsight.NetworkPropertiesResponse;
    /**
     ...
     * The storage profile.
     */
    storageProfile?: outputs.hdinsight.StorageProfileResponse;
    /**
     * The cluster tier.
     */
    tier?: string;
...
export function clusterGetPropertiesResponseProvideDefaults(val: ClusterGetPropertiesResponse): ClusterGetPropertiesResponse {
    return {
        ...val,
        computeIsolationProperties: (val.computeIsolationProperties ? outputs.hdinsight.computeIsolationPropertiesResponseProvideDefaults(val.computeIsolationProperties) : undefined),
        diskEncryptionProperties: (val.diskEncryptionProperties ? outputs.hdinsight.diskEncryptionPropertiesResponseProvideDefaults(val.diskEncryptionProperties) : undefined),
        encryptionInTransitProperties: (val.encryptionInTransitProperties ? outputs.hdinsight.encryptionInTransitPropertiesResponseProvideDefaults(val.encryptionInTransitProperties) : undefined),
    };
}
...
export interface ClusterIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.hdinsight.ClusterIdentityResponseUserAssignedIdentities};
}

export interface ClusterIdentityResponseUserAssignedIdentities {
    /**
...
export interface RoleResponse {
     ...
     */
    autoscaleConfiguration?: outputs.hdinsight.AutoscaleResponse;
    /**
     * The data disks groups for the role.
     */
