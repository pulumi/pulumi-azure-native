...
export interface NetworkProfileArgs {
     ...
     */
    networkInterfaces?: pulumi.Input<pulumi.Input<inputs.hanaonazure.v20171103preview.IpAddressArgs>[]>;
}
...
export interface StorageProfileArgs {
     ...
     */
    hanaSids?: pulumi.Input<pulumi.Input<inputs.hanaonazure.v20171103preview.SAPSystemIDArgs>[]>;
    /**
     * Specifies information about the operating system disk used by the hana instance.
     */
    osDisks?: pulumi.Input<pulumi.Input<inputs.hanaonazure.v20171103preview.DiskArgs>[]>;
}
