...
export interface LogRulesResponse {
     ...
     */
    filteringTags?: outputs.logz.v20220101preview.FilteringTagResponse[];
    /**
...
export interface MetricsTagRulesPropertiesResponse {
    metricRules?: outputs.logz.v20220101preview.MetricRulesResponse[];
    /**
     ...
     */
    systemData: outputs.logz.v20220101preview.SystemDataResponse;
}
...
export interface MonitorPropertiesResponse {
    ...
    logzOrganizationProperties?: outputs.logz.v20220101preview.LogzOrganizationPropertiesResponse;
    /**
    ...
    planData?: outputs.logz.v20220101preview.PlanDataResponse;
    /**
     * Flag specifying if the resource provisioning state as tracked by ARM.
     */
    provisioningState: string;
    userInfo?: outputs.logz.v20220101preview.UserInfoResponse;
}
...
export interface MonitoringTagRulesPropertiesResponse {
     ...
     * Set of rules for sending logs for the Monitor resource.
     */
    logRules?: outputs.logz.v20220101preview.LogRulesResponse;
    /**
     * Flag specifying if the resource provisioning state as tracked by ARM.
     */
    provisioningState: string;
