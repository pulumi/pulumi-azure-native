...
export interface FilteringTagArgs {
     ...
     */
    action?: pulumi.Input<string | enums.logz.v20220101preview.TagAction>;
    /**
...
export interface IdentityPropertiesArgs {
    type?: pulumi.Input<string | enums.logz.v20220101preview.ManagedIdentityTypes>;
}
...
export interface LogRulesArgs {
     ...
     */
    filteringTags?: pulumi.Input<pulumi.Input<inputs.logz.v20220101preview.FilteringTagArgs>[]>;
    /**
...
export interface MetricsTagRulesPropertiesArgs {
    metricRules?: pulumi.Input<pulumi.Input<inputs.logz.v20220101preview.MetricRulesArgs>[]>;
    /**
...
export interface MonitorPropertiesArgs {
    logzOrganizationProperties?: pulumi.Input<inputs.logz.v20220101preview.LogzOrganizationPropertiesArgs>;
    /**
     * Flag specifying the Marketplace Subscription Status of the resource. If payment is not made in time, the resource will go in Suspended state.
     */
    marketplaceSubscriptionStatus?: pulumi.Input<string | enums.logz.v20220101preview.MarketplaceSubscriptionStatus>;
    /**
     * Flag specifying if the resource monitoring is enabled or disabled.
     */
    monitoringStatus?: pulumi.Input<string | enums.logz.v20220101preview.MonitoringStatus>;
    planData?: pulumi.Input<inputs.logz.v20220101preview.PlanDataArgs>;
    userInfo?: pulumi.Input<inputs.logz.v20220101preview.UserInfoArgs>;
}
...
export interface MonitoringTagRulesPropertiesArgs {
     ...
     * Set of rules for sending logs for the Monitor resource.
     */
    logRules?: pulumi.Input<inputs.logz.v20220101preview.LogRulesArgs>;
}
