...
export interface FilteringTagArgs {
     ...
     */
    action?: pulumi.Input<string | enums.logz.v20201001.TagAction>;
    /**
...
export interface IdentityPropertiesArgs {
    type?: pulumi.Input<string | enums.logz.v20201001.ManagedIdentityTypes>;
}
...
export interface LogRulesArgs {
     ...
     */
    filteringTags?: pulumi.Input<pulumi.Input<inputs.logz.v20201001.FilteringTagArgs>[]>;
    /**
...
export interface MonitorPropertiesArgs {
    logzOrganizationProperties?: pulumi.Input<inputs.logz.v20201001.LogzOrganizationPropertiesArgs>;
    /**
     * Flag specifying the Marketplace Subscription Status of the resource. If payment is not made in time, the resource will go in Suspended state.
     */
    marketplaceSubscriptionStatus?: pulumi.Input<string | enums.logz.v20201001.MarketplaceSubscriptionStatus>;
    /**
     * Flag specifying if the resource monitoring is enabled or disabled.
     */
    monitoringStatus?: pulumi.Input<string | enums.logz.v20201001.MonitoringStatus>;
    planData?: pulumi.Input<inputs.logz.v20201001.PlanDataArgs>;
    userInfo?: pulumi.Input<inputs.logz.v20201001.UserInfoArgs>;
}
...
export interface MonitoringTagRulesPropertiesArgs {
     ...
     * Set of rules for sending logs for the Monitor resource.
     */
    logRules?: pulumi.Input<inputs.logz.v20201001.LogRulesArgs>;
}
