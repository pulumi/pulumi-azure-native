...
export interface CacheActiveDirectorySettingsArgs {
     ...
     */
    credentials?: pulumi.Input<inputs.storagecache.v20201001.CacheActiveDirectorySettingsCredentialsArgs>;
    /**
...
export interface CacheDirectorySettingsArgs {
     ...
     */
    activeDirectory?: pulumi.Input<inputs.storagecache.v20201001.CacheActiveDirectorySettingsArgs>;
    /**
     * Specifies settings for Extended Groups. Extended Groups allows users to be members of more than 16 groups.
     */
    usernameDownload?: pulumi.Input<inputs.storagecache.v20201001.CacheUsernameDownloadSettingsArgs>;
}
/**
...
export function cacheDirectorySettingsArgsProvideDefaults(val: CacheDirectorySettingsArgs): CacheDirectorySettingsArgs {
    return {
        ...val,
        usernameDownload: (val.usernameDownload ? pulumi.output(val.usernameDownload).apply(inputs.storagecache.v20201001.cacheUsernameDownloadSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface CacheEncryptionSettingsArgs {
     ...
     */
    keyEncryptionKey?: pulumi.Input<inputs.storagecache.v20201001.KeyVaultKeyReferenceArgs>;
}
...
export interface CacheIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.storagecache.v20201001.CacheIdentityType>;
}
...
export interface CacheSecuritySettingsArgs {
     ...
     */
    accessPolicies?: pulumi.Input<pulumi.Input<inputs.storagecache.v20201001.NfsAccessPolicyArgs>[]>;
}
...
export interface CacheUsernameDownloadSettingsArgs {
     ...
     */
    credentials?: pulumi.Input<inputs.storagecache.v20201001.CacheUsernameDownloadSettingsCredentialsArgs>;
    /**
     ...
     */
    usernameSource?: pulumi.Input<string | enums.storagecache.v20201001.UsernameSource>;
}
/**
...
export interface KeyVaultKeyReferenceArgs {
     ...
     */
    sourceVault: pulumi.Input<inputs.storagecache.v20201001.KeyVaultKeyReferenceSourceVaultArgs>;
}
...
export interface NfsAccessPolicyArgs {
     ...
     */
    accessRules: pulumi.Input<pulumi.Input<inputs.storagecache.v20201001.NfsAccessRuleArgs>[]>;
    /**
...
export interface NfsAccessRuleArgs {
     ...
     */
    access: pulumi.Input<string | enums.storagecache.v20201001.NfsAccessRuleAccess>;
    /**
     ...
     */
    scope: pulumi.Input<string | enums.storagecache.v20201001.NfsAccessRuleScope>;
    /**
...
/**
 * nfsAccessRuleArgsProvideDefaults sets the appropriate defaults for NfsAccessRuleArgs
 */
export function nfsAccessRuleArgsProvideDefaults(val: NfsAccessRuleArgs): NfsAccessRuleArgs {
    return {
        ...val,
