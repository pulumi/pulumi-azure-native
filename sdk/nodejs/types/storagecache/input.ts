...
export interface CacheActiveDirectorySettingsArgs {
     ...
     */
    credentials?: pulumi.Input<inputs.storagecache.CacheActiveDirectorySettingsCredentialsArgs>;
    /**
...
export interface CacheDirectorySettingsArgs {
     ...
     */
    activeDirectory?: pulumi.Input<inputs.storagecache.CacheActiveDirectorySettingsArgs>;
    /**
     * Specifies settings for Extended Groups. Extended Groups allows users to be members of more than 16 groups.
     */
    usernameDownload?: pulumi.Input<inputs.storagecache.CacheUsernameDownloadSettingsArgs>;
}
/**
...
export function cacheDirectorySettingsArgsProvideDefaults(val: CacheDirectorySettingsArgs): CacheDirectorySettingsArgs {
    return {
        ...val,
        usernameDownload: (val.usernameDownload ? pulumi.output(val.usernameDownload).apply(inputs.storagecache.cacheUsernameDownloadSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface CacheEncryptionSettingsArgs {
     ...
     */
    keyEncryptionKey?: pulumi.Input<inputs.storagecache.KeyVaultKeyReferenceArgs>;
}
...
export interface CacheIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.storagecache.CacheIdentityType>;
}
...
export interface CacheSecuritySettingsArgs {
     ...
     */
    accessPolicies?: pulumi.Input<pulumi.Input<inputs.storagecache.NfsAccessPolicyArgs>[]>;
}
...
export interface CacheUsernameDownloadSettingsArgs {
     ...
     */
    credentials?: pulumi.Input<inputs.storagecache.CacheUsernameDownloadSettingsCredentialsArgs>;
    /**
     ...
     */
    usernameSource?: pulumi.Input<string | enums.storagecache.UsernameSource>;
}
/**
...
export interface KeyVaultKeyReferenceArgs {
     ...
     */
    sourceVault: pulumi.Input<inputs.storagecache.KeyVaultKeyReferenceSourceVaultArgs>;
}
...
export interface NfsAccessPolicyArgs {
     ...
     */
    accessRules: pulumi.Input<pulumi.Input<inputs.storagecache.NfsAccessRuleArgs>[]>;
    /**
...
export interface NfsAccessRuleArgs {
     ...
     */
    access: pulumi.Input<string | enums.storagecache.NfsAccessRuleAccess>;
    /**
     ...
     */
    scope: pulumi.Input<string | enums.storagecache.NfsAccessRuleScope>;
    /**
