...
export interface AdhocBasedTaggingCriteriaResponse {
     ...
     */
    tagInfo?: outputs.dataprotection.v20221001preview.RetentionTagResponse;
}
...
export interface AdhocBasedTriggerContextResponse {
     ...
     */
    taggingCriteria: outputs.dataprotection.v20221001preview.AdhocBasedTaggingCriteriaResponse;
}
...
export interface AzureBackupRuleResponse {
     ...
     */
    backupParameters?: outputs.dataprotection.v20221001preview.AzureBackupParamsResponse;
    /**
     * DataStoreInfo base
     */
    dataStore: outputs.dataprotection.v20221001preview.DataStoreInfoBaseResponse;
    name: string;
    /**
     *
     ...
     * Trigger context
     */
    trigger: outputs.dataprotection.v20221001preview.AdhocBasedTriggerContextResponse | outputs.dataprotection.v20221001preview.ScheduleBasedTriggerContextResponse;
}
...
export interface AzureRetentionRuleResponse {
    isDefault?: boolean;
    lifecycles: outputs.dataprotection.v20221001preview.SourceLifeCycleResponse[];
    name: string;
    /**
     *
...
export interface BackupInstanceResponse {
     ...
     */
    dataSourceInfo: outputs.dataprotection.v20221001preview.DatasourceResponse;
    /**
     * Gets or sets the data source set information.
     */
    dataSourceSetInfo?: outputs.dataprotection.v20221001preview.DatasourceSetResponse;
    /**
     * Credentials to use to authenticate with data source provider.
     */
    datasourceAuthCredentials?: outputs.dataprotection.v20221001preview.SecretStoreBasedAuthCredentialsResponse;
    /**
     ...
     */
    policyInfo: outputs.dataprotection.v20221001preview.PolicyInfoResponse;
    /**
     * Specifies the protection error of the resource
     */
    protectionErrorDetails: outputs.dataprotection.v20221001preview.UserFacingErrorResponse;
    /**
     * Specifies the protection status of the resource
     */
    protectionStatus: outputs.dataprotection.v20221001preview.ProtectionStatusDetailsResponse;
    /**
...
export interface BackupPolicyResponse {
     ...
     */
    policyRules: (outputs.dataprotection.v20221001preview.AzureBackupRuleResponse | outputs.dataprotection.v20221001preview.AzureRetentionRuleResponse)[];
}
...
export interface BackupVaultResponse {
     ...
     * Monitoring Settings
     */
    monitoringSettings?: outputs.dataprotection.v20221001preview.MonitoringSettingsResponse;
    /**
     ...
     */
    resourceMoveDetails: outputs.dataprotection.v20221001preview.ResourceMoveDetailsResponse;
    /**
     ...
     * Security Settings
     */
    securitySettings?: outputs.dataprotection.v20221001preview.SecuritySettingsResponse;
    /**
     * Storage Settings
     */
    storageSettings: outputs.dataprotection.v20221001preview.StorageSettingResponse[];
}
...
export interface InnerErrorResponse {
     ...
     */
    embeddedInnerError?: outputs.dataprotection.v20221001preview.InnerErrorResponse;
}
...
export interface MonitoringSettingsResponse {
     ...
     * Settings for Azure Monitor based alerts
     */
    azureMonitorAlertSettings?: outputs.dataprotection.v20221001preview.AzureMonitorAlertSettingsResponse;
}
...
export interface PolicyInfoResponse {
     ...
     */
    policyParameters?: outputs.dataprotection.v20221001preview.PolicyParametersResponse;
...
export interface PolicyParametersResponse {
     ...
     */
    backupDatasourceParametersList?: outputs.dataprotection.v20221001preview.KubernetesClusterBackupDatasourceParametersResponse[];
    /**
     * Gets or sets the DataStore Parameters
     */
    dataStoreParametersList?: outputs.dataprotection.v20221001preview.AzureOperationalStoreParametersResponse[];
}
...
export interface ProtectionStatusDetailsResponse {
     ...
     */
    errorDetails?: outputs.dataprotection.v20221001preview.UserFacingErrorResponse;
    /**
     * Specifies the protection status of the resource
     */
    status?: string;
...
export interface ResourceGuardProxyBaseResponse {
    ...
    resourceGuardOperationDetails?: outputs.dataprotection.v20221001preview.ResourceGuardOperationDetailResponse[];
...
export interface ResourceGuardResponse {
     ...
     */
    resourceGuardOperations: outputs.dataprotection.v20221001preview.ResourceGuardOperationResponse[];
    /**
...
export interface ScheduleBasedBackupCriteriaResponse {
     ...
     */
    daysOfMonth?: outputs.dataprotection.v20221001preview.DayResponse[];
    /**
...
export interface ScheduleBasedTriggerContextResponse {
     ...
     */
    schedule: outputs.dataprotection.v20221001preview.BackupScheduleResponse;
    /**
     * List of tags that can be applicable for given schedule.
     */
    taggingCriteria: outputs.dataprotection.v20221001preview.TaggingCriteriaResponse[];
}
...
export interface SecretStoreBasedAuthCredentialsResponse {
     ...
     */
    secretStoreResource?: outputs.dataprotection.v20221001preview.SecretStoreResourceResponse;
}
...
export interface SecuritySettingsResponse {
     ...
     * Immutability Settings at vault level
     */
    immutabilitySettings?: outputs.dataprotection.v20221001preview.ImmutabilitySettingsResponse;
    /**
     * Soft delete related settings
     */
    softDeleteSettings?: outputs.dataprotection.v20221001preview.SoftDeleteSettingsResponse;
}
...
export interface SourceLifeCycleResponse {
     ...
     * Delete Option
     */
    deleteAfter: outputs.dataprotection.v20221001preview.AbsoluteDeleteOptionResponse;
    /**
     * DataStoreInfo base
     */
    sourceDataStore: outputs.dataprotection.v20221001preview.DataStoreInfoBaseResponse;
    targetDataStoreCopySettings?: outputs.dataprotection.v20221001preview.TargetCopySettingResponse[];
}
...
export interface TaggingCriteriaResponse {
     ...
     */
    criteria?: outputs.dataprotection.v20221001preview.ScheduleBasedBackupCriteriaResponse[];
    /**
...
export interface TargetCopySettingResponse {
     ...
     */
    copyAfter: outputs.dataprotection.v20221001preview.CopyOnExpiryOptionResponse | outputs.dataprotection.v20221001preview.CustomCopyOptionResponse | outputs.dataprotection.v20221001preview.ImmediateCopyOptionResponse;
    /**
...
export interface UserFacingErrorResponse {
     ...
     */
    details?: outputs.dataprotection.v20221001preview.UserFacingErrorResponse[];
    /**
     * Inner Error
     */
    innerError?: outputs.dataprotection.v20221001preview.InnerErrorResponse;
    /**
