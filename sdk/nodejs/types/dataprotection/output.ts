...
export * as v20220331preview from "./v20220331preview/output";
...
export interface AdhocBasedTaggingCriteriaResponse {
     ...
     */
    tagInfo?: outputs.dataprotection.RetentionTagResponse;
}
...
export interface AdhocBasedTriggerContextResponse {
     ...
     */
    taggingCriteria: outputs.dataprotection.AdhocBasedTaggingCriteriaResponse;
}
...
export interface AzureBackupRuleResponse {
     ...
     */
    backupParameters?: outputs.dataprotection.AzureBackupParamsResponse;
    /**
     * DataStoreInfo base
     */
     ...
     * Trigger context
     */
    trigger: outputs.dataprotection.AdhocBasedTriggerContextResponse | outputs.dataprotection.ScheduleBasedTriggerContextResponse;
}
...
export interface BackupInstanceResponse {
     ...
     */
    dataSourceInfo: outputs.dataprotection.DatasourceResponse;
    /**
     * Gets or sets the data source set information.
     */
    dataSourceSetInfo?: outputs.dataprotection.DatasourceSetResponse;
    /**
     ...
     */
    policyInfo: outputs.dataprotection.PolicyInfoResponse;
    /**
     * Specifies the protection error of the resource
     */
    protectionErrorDetails: outputs.dataprotection.UserFacingErrorResponse;
    /**
     * Specifies the protection status of the resource
     */
    protectionStatus: outputs.dataprotection.ProtectionStatusDetailsResponse;
    /**
...
export interface BackupPolicyResponse {
     ...
     */
    policyRules: (outputs.dataprotection.AzureBackupRuleResponse | outputs.dataprotection.AzureRetentionRuleResponse)[];
}
...
export interface BackupVaultResponse {
     ...
     * Storage Settings
     */
    storageSettings: outputs.dataprotection.StorageSettingResponse[];
}
...
export interface InnerErrorResponse {
     ...
     */
    embeddedInnerError?: outputs.dataprotection.InnerErrorResponse;
}
...
export interface PolicyInfoResponse {
     ...
     */
    policyParameters?: outputs.dataprotection.PolicyParametersResponse;
...
export interface PolicyParametersResponse {
     ...
     */
    dataStoreParametersList?: outputs.dataprotection.AzureOperationalStoreParametersResponse[];
}
...
export interface ProtectionStatusDetailsResponse {
     ...
     */
    errorDetails?: outputs.dataprotection.UserFacingErrorResponse;
    /**
     * Specifies the protection status of the resource
     */
    status?: string;
...
export interface ResourceGuardResponse {
     ...
     */
    resourceGuardOperations: outputs.dataprotection.ResourceGuardOperationResponse[];
    /**
...
export interface ScheduleBasedBackupCriteriaResponse {
     ...
     */
    daysOfMonth?: outputs.dataprotection.DayResponse[];
    /**
...
export interface ScheduleBasedTriggerContextResponse {
     ...
     */
    schedule: outputs.dataprotection.BackupScheduleResponse;
    /**
     * List of tags that can be applicable for given schedule.
     */
    taggingCriteria: outputs.dataprotection.TaggingCriteriaResponse[];
}
...
export interface SourceLifeCycleResponse {
     ...
     * Delete Option
     */
    deleteAfter: outputs.dataprotection.AbsoluteDeleteOptionResponse;
    /**
     * DataStoreInfo base
     */
    sourceDataStore: outputs.dataprotection.DataStoreInfoBaseResponse;
    targetDataStoreCopySettings?: outputs.dataprotection.TargetCopySettingResponse[];
}
...
export interface TaggingCriteriaResponse {
     ...
     */
    criteria?: outputs.dataprotection.ScheduleBasedBackupCriteriaResponse[];
    /**
...
export interface TargetCopySettingResponse {
     ...
     */
    copyAfter: outputs.dataprotection.CopyOnExpiryOptionResponse | outputs.dataprotection.CustomCopyOptionResponse | outputs.dataprotection.ImmediateCopyOptionResponse;
    /**
...
export interface UserFacingErrorResponse {
     ...
     */
    details?: outputs.dataprotection.UserFacingErrorResponse[];
    /**
     * Inner Error
     */
    innerError?: outputs.dataprotection.InnerErrorResponse;
    /**
