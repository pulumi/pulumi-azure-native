...
export interface AppResourcePropertiesResponse {
     ...
     */
    persistentDisk?: outputs.appplatform.v20201101preview.PersistentDiskResponse;
    /**
     ...
     */
    temporaryDisk?: outputs.appplatform.v20201101preview.TemporaryDiskResponse;
    /**
     * URL of the App
     */
    url: string;
...
export function appResourcePropertiesResponseProvideDefaults(val: AppResourcePropertiesResponse): AppResourcePropertiesResponse {
    return {
        ...
        temporaryDisk: (val.temporaryDisk ? outputs.appplatform.v20201101preview.temporaryDiskResponseProvideDefaults(val.temporaryDisk) : undefined),
    };
}
...
export interface ClusterResourcePropertiesResponse {
     ...
     */
    networkProfile?: outputs.appplatform.v20201101preview.NetworkProfileResponse;
    /**
...
export interface ConfigServerGitPropertyResponse {
     ...
     * Repositories of git.
     */
    repositories?: outputs.appplatform.v20201101preview.GitPatternRepositoryResponse[];
    /**
...
export interface ConfigServerPropertiesResponse {
     ...
     */
    configServer?: outputs.appplatform.v20201101preview.ConfigServerSettingsResponse;
    /**
     * Error when apply config server settings.
     */
    error?: outputs.appplatform.v20201101preview.ErrorResponse;
    /**
...
export interface ConfigServerSettingsResponse {
     ...
     */
    gitProperty?: outputs.appplatform.v20201101preview.ConfigServerGitPropertyResponse;
}
...
export interface DeploymentResourcePropertiesResponse {
     ...
     */
    deploymentSettings?: outputs.appplatform.v20201101preview.DeploymentSettingsResponse;
    /**
     * Collection of instances belong to the Deployment
     */
    instances: outputs.appplatform.v20201101preview.DeploymentInstanceResponse[];
    /**
     ...
     */
    source?: outputs.appplatform.v20201101preview.UserSourceInfoResponse;
    /**
...
export function deploymentResourcePropertiesResponseProvideDefaults(val: DeploymentResourcePropertiesResponse): DeploymentResourcePropertiesResponse {
    return {
        ...val,
        deploymentSettings: (val.deploymentSettings ? outputs.appplatform.v20201101preview.deploymentSettingsResponseProvideDefaults(val.deploymentSettings) : undefined),
    };
}
...
export interface MonitoringSettingPropertiesResponse {
     ...
     */
    appInsightsAgentVersions?: outputs.appplatform.v20201101preview.ApplicationInsightsAgentVersionsResponse;
    /**
...
export interface NetworkProfileResponse {
     ...
     */
    outboundIPs: outputs.appplatform.v20201101preview.NetworkProfileResponseOutboundIPs;
    /**
     * Required inbound or outbound traffics for Azure Spring Cloud instance.
     */
    requiredTraffics: outputs.appplatform.v20201101preview.RequiredTrafficResponse[];
    /**
