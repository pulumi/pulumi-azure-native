...
export interface ApiPortalPropertiesResponse {
     ...
     */
    instances: outputs.appplatform.v20220901preview.ApiPortalInstanceResponse[];
    /**
     ...
     */
    resourceRequests: outputs.appplatform.v20220901preview.ApiPortalResourceRequestsResponse;
    /**
     ...
     */
    ssoProperties?: outputs.appplatform.v20220901preview.SsoPropertiesResponse;
    /**
...
export interface AppResourcePropertiesResponse {
     ...
     */
    customPersistentDisks?: outputs.appplatform.v20220901preview.CustomPersistentDiskResourceResponse[];
    /**
     ...
     */
    ingressSettings?: outputs.appplatform.v20220901preview.IngressSettingsResponse;
    /**
     * Collection of loaded certificates
     */
    loadedCertificates?: outputs.appplatform.v20220901preview.LoadedCertificateResponse[];
    /**
     * Persistent disk settings
     */
    persistentDisk?: outputs.appplatform.v20220901preview.PersistentDiskResponse;
    /**
     ...
     */
    temporaryDisk?: outputs.appplatform.v20220901preview.TemporaryDiskResponse;
    /**
     * URL of the App
     */
    url: string;
     ...
     */
    vnetAddons?: outputs.appplatform.v20220901preview.AppVNetAddonsResponse;
}
/**
...
export function appResourcePropertiesResponseProvideDefaults(val: AppResourcePropertiesResponse): AppResourcePropertiesResponse {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        temporaryDisk: (val.temporaryDisk ? outputs.appplatform.v20220901preview.temporaryDiskResponseProvideDefaults(val.temporaryDisk) : undefined),
        vnetAddons: (val.vnetAddons ? outputs.appplatform.v20220901preview.appVNetAddonsResponseProvideDefaults(val.vnetAddons) : undefined),
    };
}
...
export interface BuildServiceAgentPoolPropertiesResponse {
     ...
     */
    poolSize?: outputs.appplatform.v20220901preview.BuildServiceAgentPoolSizePropertiesResponse;
    /**
...
export interface BuilderPropertiesResponse {
     ...
     */
    buildpackGroups?: outputs.appplatform.v20220901preview.BuildpacksGroupPropertiesResponse[];
    /**
     ...
     */
    stack?: outputs.appplatform.v20220901preview.StackPropertiesResponse;
}
...
export interface BuildpackBindingPropertiesResponse {
     ...
     */
    launchProperties?: outputs.appplatform.v20220901preview.BuildpackBindingLaunchPropertiesResponse;
    /**
...
export interface BuildpacksGroupPropertiesResponse {
     ...
     */
    buildpacks?: outputs.appplatform.v20220901preview.BuildpackPropertiesResponse[];
    /**
...
export interface ClusterResourcePropertiesResponse {
     ...
     */
    marketplaceResource?: outputs.appplatform.v20220901preview.MarketplaceResourceResponse;
    /**
     * Network profile of the Service
     */
    networkProfile?: outputs.appplatform.v20220901preview.NetworkProfileResponse;
    /**
     ...
     */
    vnetAddons?: outputs.appplatform.v20220901preview.ServiceVNetAddonsResponse;
...
export function clusterResourcePropertiesResponseProvideDefaults(val: ClusterResourcePropertiesResponse): ClusterResourcePropertiesResponse {
    return {
        ...val,
        vnetAddons: (val.vnetAddons ? outputs.appplatform.v20220901preview.serviceVNetAddonsResponseProvideDefaults(val.vnetAddons) : undefined),
...
export interface ConfigServerGitPropertyResponse {
     ...
     * Repositories of git.
     */
    repositories?: outputs.appplatform.v20220901preview.GitPatternRepositoryResponse[];
    /**
...
export interface ConfigServerPropertiesResponse {
     ...
     */
    configServer?: outputs.appplatform.v20220901preview.ConfigServerSettingsResponse;
    /**
     * Error when apply config server settings.
     */
    error?: outputs.appplatform.v20220901preview.ErrorResponse;
    /**
...
export interface ConfigServerSettingsResponse {
     ...
     */
    gitProperty?: outputs.appplatform.v20220901preview.ConfigServerGitPropertyResponse;
}
...
export interface ConfigurationServiceGitPropertyResponse {
     ...
     */
    repositories?: outputs.appplatform.v20220901preview.ConfigurationServiceGitRepositoryResponse[];
}
...
export interface ConfigurationServicePropertiesResponse {
     ...
     */
    instances: outputs.appplatform.v20220901preview.ConfigurationServiceInstanceResponse[];
    /**
     ...
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests: outputs.appplatform.v20220901preview.ConfigurationServiceResourceRequestsResponse;
    /**
     * The settings of Application Configuration Service.
     */
    settings?: outputs.appplatform.v20220901preview.ConfigurationServiceSettingsResponse;
}
...
export interface ConfigurationServiceSettingsResponse {
     ...
     * Property of git environment.
     */
    gitProperty?: outputs.appplatform.v20220901preview.ConfigurationServiceGitPropertyResponse;
}
...
export interface CustomContainerResponse {
     ...
     */
    imageRegistryCredential?: outputs.appplatform.v20220901preview.ImageRegistryCredentialResponse;
    /**
...
export interface CustomContainerUserSourceInfoResponse {
     ...
     * Custom container payload
     */
    customContainer?: outputs.appplatform.v20220901preview.CustomContainerResponse;
    /**
     * Type of the source uploaded
...
export interface CustomPersistentDiskResourceResponse {
     ...
     */
    customPersistentDiskProperties?: outputs.appplatform.v20220901preview.AzureFileVolumeResponse;
    /**
...
export interface DeploymentResourcePropertiesResponse {
     ...
     */
    deploymentSettings?: outputs.appplatform.v20220901preview.DeploymentSettingsResponse;
    /**
     * Collection of instances belong to the Deployment
     */
    instances: outputs.appplatform.v20220901preview.DeploymentInstanceResponse[];
    /**
     ...
     */
    source?: outputs.appplatform.v20220901preview.BuildResultUserSourceInfoResponse | outputs.appplatform.v20220901preview.CustomContainerUserSourceInfoResponse | outputs.appplatform.v20220901preview.JarUploadedUserSourceInfoResponse | outputs.appplatform.v20220901preview.NetCoreZipUploadedUserSourceInfoResponse | outputs.appplatform.v20220901preview.SourceUploadedUserSourceInfoResponse | outputs.appplatform.v20220901preview.UploadedUserSourceInfoResponse;
    /**
...
export function deploymentResourcePropertiesResponseProvideDefaults(val: DeploymentResourcePropertiesResponse): DeploymentResourcePropertiesResponse {
    return {
        ...val,
        deploymentSettings: (val.deploymentSettings ? outputs.appplatform.v20220901preview.deploymentSettingsResponseProvideDefaults(val.deploymentSettings) : undefined),
    };
}
...
export interface DeploymentSettingsResponse {
     ...
     * Container liveness and readiness probe settings
     */
    containerProbeSettings?: outputs.appplatform.v20220901preview.ContainerProbeSettingsResponse;
    /**
     ...
     */
    livenessProbe?: outputs.appplatform.v20220901preview.ProbeResponse;
    /**
     ...
     */
    readinessProbe?: outputs.appplatform.v20220901preview.ProbeResponse;
    /**
     ...
     */
    resourceRequests?: outputs.appplatform.v20220901preview.ResourceRequestsResponse;
    /**
     ...
     */
    startupProbe?: outputs.appplatform.v20220901preview.ProbeResponse;
    /**
...
export function deploymentSettingsResponseProvideDefaults(val: DeploymentSettingsResponse): DeploymentSettingsResponse {
    return {
        ...val,
        livenessProbe: (val.livenessProbe ? outputs.appplatform.v20220901preview.probeResponseProvideDefaults(val.livenessProbe) : undefined),
        readinessProbe: (val.readinessProbe ? outputs.appplatform.v20220901preview.probeResponseProvideDefaults(val.readinessProbe) : undefined),
        startupProbe: (val.startupProbe ? outputs.appplatform.v20220901preview.probeResponseProvideDefaults(val.startupProbe) : undefined),
...
export interface GatewayOperatorPropertiesResponse {
     ...
     */
    instances: outputs.appplatform.v20220901preview.GatewayInstanceResponse[];
    /**
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests: outputs.appplatform.v20220901preview.GatewayOperatorResourceRequestsResponse;
}
...
export interface GatewayPropertiesResponse {
     ...
     * API metadata property for Spring Cloud Gateway
     */
    apiMetadataProperties?: outputs.appplatform.v20220901preview.GatewayApiMetadataPropertiesResponse;
    /**
     * Cross-Origin Resource Sharing property
     */
    corsProperties?: outputs.appplatform.v20220901preview.GatewayCorsPropertiesResponse;
    /**
     * Indicate if only https is allowed.
     */
    httpsOnly?: boolean;
     ...
     * Properties of the Spring Cloud Gateway Operator.
     */
    operatorProperties: outputs.appplatform.v20220901preview.GatewayOperatorPropertiesResponse;
    /**
     ...
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests?: outputs.appplatform.v20220901preview.GatewayResourceRequestsResponse;
    /**
     * Single sign-on related configuration
     */
    ssoProperties?: outputs.appplatform.v20220901preview.SsoPropertiesResponse;
...
export function gatewayPropertiesResponseProvideDefaults(val: GatewayPropertiesResponse): GatewayPropertiesResponse {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        public: (val.public) ?? false,
        resourceRequests: (val.resourceRequests ? outputs.appplatform.v20220901preview.gatewayResourceRequestsResponseProvideDefaults(val.resourceRequests) : undefined),
    };
}
...
export interface GatewayRouteConfigPropertiesResponse {
     ...
     * OpenAPI properties of Spring Cloud Gateway route config.
     */
    openApi?: outputs.appplatform.v20220901preview.GatewayRouteConfigOpenApiPropertiesResponse;
    /**
     ...
     */
    routes?: outputs.appplatform.v20220901preview.GatewayApiRouteResponse[];
}
/**
...
export interface IngressSettingsResponse {
     ...
     */
    clientAuth?: outputs.appplatform.v20220901preview.IngressSettingsResponseClientAuth;
    /**
     * Ingress read time out in seconds.
     */
    readTimeoutInSeconds?: number;
...
export interface ManagedIdentityPropertiesResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.appplatform.v20220901preview.UserAssignedManagedIdentityResponse};
}
...
export interface MonitoringSettingPropertiesResponse {
     ...
     */
    appInsightsAgentVersions?: outputs.appplatform.v20220901preview.ApplicationInsightsAgentVersionsResponse;
    /**
...
export interface NetworkProfileResponse {
     ...
     * Ingress configuration payload for Azure Spring Apps resource.
     */
    ingressConfig?: outputs.appplatform.v20220901preview.IngressConfigResponse;
    /**
     * Desired outbound IP resources for Azure Spring Apps resource.
     */
    outboundIPs: outputs.appplatform.v20220901preview.NetworkProfileResponseOutboundIPs;
    /**
     ...
     */
    requiredTraffics: outputs.appplatform.v20220901preview.RequiredTrafficResponse[];
    /**
...
export interface ProbeResponse {
     ...
     */
    probeAction?: outputs.appplatform.v20220901preview.ExecActionResponse | outputs.appplatform.v20220901preview.HTTPGetActionResponse | outputs.appplatform.v20220901preview.TCPSocketActionResponse;
    /**
...
export interface ServiceRegistryPropertiesResponse {
     ...
     */
    instances: outputs.appplatform.v20220901preview.ServiceRegistryInstanceResponse[];
    /**
     ...
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests: outputs.appplatform.v20220901preview.ServiceRegistryResourceRequestsResponse;
}
