...
export interface ApiPortalPropertiesArgs {
     ...
     */
    ssoProperties?: pulumi.Input<inputs.appplatform.v20220901preview.SsoPropertiesArgs>;
}
/**
...
export interface AppResourcePropertiesArgs {
     ...
     */
    customPersistentDisks?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220901preview.CustomPersistentDiskResourceArgs>[]>;
    /**
     ...
     */
    ingressSettings?: pulumi.Input<inputs.appplatform.v20220901preview.IngressSettingsArgs>;
    /**
     * Collection of loaded certificates
     */
    loadedCertificates?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220901preview.LoadedCertificateArgs>[]>;
    /**
     * Persistent disk settings
     */
    persistentDisk?: pulumi.Input<inputs.appplatform.v20220901preview.PersistentDiskArgs>;
    /**
     ...
     */
    temporaryDisk?: pulumi.Input<inputs.appplatform.v20220901preview.TemporaryDiskArgs>;
    /**
     * Additional App settings in vnet injection instance
     */
    vnetAddons?: pulumi.Input<inputs.appplatform.v20220901preview.AppVNetAddonsArgs>;
}
/**
...
export function appResourcePropertiesArgsProvideDefaults(val: AppResourcePropertiesArgs): AppResourcePropertiesArgs {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        temporaryDisk: (val.temporaryDisk ? pulumi.output(val.temporaryDisk).apply(inputs.appplatform.v20220901preview.temporaryDiskArgsProvideDefaults) : undefined),
        vnetAddons: (val.vnetAddons ? pulumi.output(val.vnetAddons).apply(inputs.appplatform.v20220901preview.appVNetAddonsArgsProvideDefaults) : undefined),
    };
}
...
export interface BuildServiceAgentPoolPropertiesArgs {
     ...
     */
    poolSize?: pulumi.Input<inputs.appplatform.v20220901preview.BuildServiceAgentPoolSizePropertiesArgs>;
}
...
export interface BuilderPropertiesArgs {
     ...
     */
    buildpackGroups?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220901preview.BuildpacksGroupPropertiesArgs>[]>;
    /**
     * Builder cluster stack property.
     */
    stack?: pulumi.Input<inputs.appplatform.v20220901preview.StackPropertiesArgs>;
}
...
export interface BuildpackBindingPropertiesArgs {
     ...
     */
    bindingType?: pulumi.Input<string | enums.appplatform.v20220901preview.BindingType>;
    /**
     * The object describes the buildpack binding launch properties
     */
    launchProperties?: pulumi.Input<inputs.appplatform.v20220901preview.BuildpackBindingLaunchPropertiesArgs>;
}
...
export interface BuildpacksGroupPropertiesArgs {
     ...
     */
    buildpacks?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220901preview.BuildpackPropertiesArgs>[]>;
    /**
...
export interface ClusterResourcePropertiesArgs {
     ...
     */
    marketplaceResource?: pulumi.Input<inputs.appplatform.v20220901preview.MarketplaceResourceArgs>;
    /**
     * Network profile of the Service
     */
    networkProfile?: pulumi.Input<inputs.appplatform.v20220901preview.NetworkProfileArgs>;
    /**
     * Additional Service settings in vnet injection instance
     */
    vnetAddons?: pulumi.Input<inputs.appplatform.v20220901preview.ServiceVNetAddonsArgs>;
...
export function clusterResourcePropertiesArgsProvideDefaults(val: ClusterResourcePropertiesArgs): ClusterResourcePropertiesArgs {
    return {
        ...val,
        vnetAddons: (val.vnetAddons ? pulumi.output(val.vnetAddons).apply(inputs.appplatform.v20220901preview.serviceVNetAddonsArgsProvideDefaults) : undefined),
...
export interface ConfigServerGitPropertyArgs {
     ...
     * Repositories of git.
     */
    repositories?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220901preview.GitPatternRepositoryArgs>[]>;
    /**
...
export interface ConfigServerPropertiesArgs {
     ...
     */
    configServer?: pulumi.Input<inputs.appplatform.v20220901preview.ConfigServerSettingsArgs>;
    /**
     * Error when apply config server settings.
     */
    error?: pulumi.Input<inputs.appplatform.v20220901preview.ErrorArgs>;
}
...
export interface ConfigServerSettingsArgs {
     ...
     */
    gitProperty?: pulumi.Input<inputs.appplatform.v20220901preview.ConfigServerGitPropertyArgs>;
}
...
export interface ConfigurationServiceGitPropertyArgs {
     ...
     */
    repositories?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220901preview.ConfigurationServiceGitRepositoryArgs>[]>;
}
...
export interface ConfigurationServicePropertiesArgs {
     ...
     */
    settings?: pulumi.Input<inputs.appplatform.v20220901preview.ConfigurationServiceSettingsArgs>;
}
...
export interface ConfigurationServiceSettingsArgs {
     ...
     * Property of git environment.
     */
    gitProperty?: pulumi.Input<inputs.appplatform.v20220901preview.ConfigurationServiceGitPropertyArgs>;
}
...
export interface CustomContainerArgs {
     ...
     */
    imageRegistryCredential?: pulumi.Input<inputs.appplatform.v20220901preview.ImageRegistryCredentialArgs>;
    /**
...
export interface CustomContainerUserSourceInfoArgs {
     ...
     * Custom container payload
     */
    customContainer?: pulumi.Input<inputs.appplatform.v20220901preview.CustomContainerArgs>;
    /**
     * Type of the source uploaded
...
export interface CustomPersistentDiskResourceArgs {
     ...
     */
    customPersistentDiskProperties?: pulumi.Input<inputs.appplatform.v20220901preview.AzureFileVolumeArgs>;
    /**
...
export interface DeploymentResourcePropertiesArgs {
     ...
     */
    deploymentSettings?: pulumi.Input<inputs.appplatform.v20220901preview.DeploymentSettingsArgs>;
    /**
     * Uploaded source information of the deployment.
     */
    source?: pulumi.Input<inputs.appplatform.v20220901preview.BuildResultUserSourceInfoArgs | inputs.appplatform.v20220901preview.CustomContainerUserSourceInfoArgs | inputs.appplatform.v20220901preview.JarUploadedUserSourceInfoArgs | inputs.appplatform.v20220901preview.NetCoreZipUploadedUserSourceInfoArgs | inputs.appplatform.v20220901preview.SourceUploadedUserSourceInfoArgs | inputs.appplatform.v20220901preview.UploadedUserSourceInfoArgs>;
}
/**
...
export function deploymentResourcePropertiesArgsProvideDefaults(val: DeploymentResourcePropertiesArgs): DeploymentResourcePropertiesArgs {
    return {
        ...val,
        deploymentSettings: (val.deploymentSettings ? pulumi.output(val.deploymentSettings).apply(inputs.appplatform.v20220901preview.deploymentSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface DeploymentSettingsArgs {
     ...
     * Container liveness and readiness probe settings
     */
    containerProbeSettings?: pulumi.Input<inputs.appplatform.v20220901preview.ContainerProbeSettingsArgs>;
    /**
     ...
     */
    livenessProbe?: pulumi.Input<inputs.appplatform.v20220901preview.ProbeArgs>;
    /**
     ...
     */
    readinessProbe?: pulumi.Input<inputs.appplatform.v20220901preview.ProbeArgs>;
    /**
     ...
     */
    resourceRequests?: pulumi.Input<inputs.appplatform.v20220901preview.ResourceRequestsArgs>;
    /**
     ...
     */
    startupProbe?: pulumi.Input<inputs.appplatform.v20220901preview.ProbeArgs>;
    /**
...
export function deploymentSettingsArgsProvideDefaults(val: DeploymentSettingsArgs): DeploymentSettingsArgs {
    return {
        ...val,
        livenessProbe: (val.livenessProbe ? pulumi.output(val.livenessProbe).apply(inputs.appplatform.v20220901preview.probeArgsProvideDefaults) : undefined),
        readinessProbe: (val.readinessProbe ? pulumi.output(val.readinessProbe).apply(inputs.appplatform.v20220901preview.probeArgsProvideDefaults) : undefined),
        startupProbe: (val.startupProbe ? pulumi.output(val.startupProbe).apply(inputs.appplatform.v20220901preview.probeArgsProvideDefaults) : undefined),
...
export interface GatewayPropertiesArgs {
     ...
     * API metadata property for Spring Cloud Gateway
     */
    apiMetadataProperties?: pulumi.Input<inputs.appplatform.v20220901preview.GatewayApiMetadataPropertiesArgs>;
    /**
     * Cross-Origin Resource Sharing property
     */
    corsProperties?: pulumi.Input<inputs.appplatform.v20220901preview.GatewayCorsPropertiesArgs>;
    /**
     * Indicate if only https is allowed.
     */
    httpsOnly?: pulumi.Input<boolean>;
     ...
     */
    resourceRequests?: pulumi.Input<inputs.appplatform.v20220901preview.GatewayResourceRequestsArgs>;
    /**
     * Single sign-on related configuration
     */
    ssoProperties?: pulumi.Input<inputs.appplatform.v20220901preview.SsoPropertiesArgs>;
...
export function gatewayPropertiesArgsProvideDefaults(val: GatewayPropertiesArgs): GatewayPropertiesArgs {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        public: (val.public) ?? false,
        resourceRequests: (val.resourceRequests ? pulumi.output(val.resourceRequests).apply(inputs.appplatform.v20220901preview.gatewayResourceRequestsArgsProvideDefaults) : undefined),
    };
}
...
export interface GatewayRouteConfigPropertiesArgs {
     ...
     * OpenAPI properties of Spring Cloud Gateway route config.
     */
    openApi?: pulumi.Input<inputs.appplatform.v20220901preview.GatewayRouteConfigOpenApiPropertiesArgs>;
    /**
     * Protocol of routed Azure Spring Apps applications.
     */
    protocol?: pulumi.Input<string | enums.appplatform.v20220901preview.GatewayRouteConfigProtocol>;
    /**
     * Array of API routes, each route contains properties such as `title`, `uri`, `ssoEnabled`, `predicates`, `filters`.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220901preview.GatewayApiRouteArgs>[]>;
}
/**
...
export interface HTTPGetActionArgs {
     ...
     */
    scheme?: pulumi.Input<string | enums.appplatform.v20220901preview.HTTPSchemeType>;
    /**
     * The type of the action to take to perform the health check.
...
export interface IngressSettingsArgs {
     ...
     */
    backendProtocol?: pulumi.Input<string | enums.appplatform.v20220901preview.BackendProtocol>;
    /**
     * Client-Certification Authentication.
     */
    clientAuth?: pulumi.Input<inputs.appplatform.v20220901preview.IngressSettingsClientAuthArgs>;
    /**
     * Ingress read time out in seconds.
     */
    readTimeoutInSeconds?: pulumi.Input<number>;
     ...
     */
    sessionAffinity?: pulumi.Input<string | enums.appplatform.v20220901preview.SessionAffinity>;
    /**
...
export interface ManagedIdentityPropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.appplatform.v20220901preview.ManagedIdentityType>;
    /**
...
export interface NetworkProfileArgs {
     ...
     * Ingress configuration payload for Azure Spring Apps resource.
     */
    ingressConfig?: pulumi.Input<inputs.appplatform.v20220901preview.IngressConfigArgs>;
    /**
...
export interface ProbeArgs {
     ...
     */
    probeAction?: pulumi.Input<inputs.appplatform.v20220901preview.ExecActionArgs | inputs.appplatform.v20220901preview.HTTPGetActionArgs | inputs.appplatform.v20220901preview.TCPSocketActionArgs>;
    /**
