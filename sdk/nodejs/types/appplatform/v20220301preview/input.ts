...
export interface ApiPortalPropertiesArgs {
     ...
     */
    ssoProperties?: pulumi.Input<inputs.appplatform.v20220301preview.SsoPropertiesArgs>;
}
/**
...
export interface AppResourcePropertiesArgs {
     ...
     */
    customPersistentDisks?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220301preview.CustomPersistentDiskResourceArgs>[]>;
    /**
     ...
     */
    loadedCertificates?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220301preview.LoadedCertificateArgs>[]>;
    /**
     * Persistent disk settings
     */
    persistentDisk?: pulumi.Input<inputs.appplatform.v20220301preview.PersistentDiskArgs>;
    /**
     ...
     */
    temporaryDisk?: pulumi.Input<inputs.appplatform.v20220301preview.TemporaryDiskArgs>;
}
/**
...
export function appResourcePropertiesArgsProvideDefaults(val: AppResourcePropertiesArgs): AppResourcePropertiesArgs {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        temporaryDisk: (val.temporaryDisk ? pulumi.output(val.temporaryDisk).apply(inputs.appplatform.v20220301preview.temporaryDiskArgsProvideDefaults) : undefined),
    };
}
...
export interface BuildServiceAgentPoolPropertiesArgs {
     ...
     */
    poolSize?: pulumi.Input<inputs.appplatform.v20220301preview.BuildServiceAgentPoolSizePropertiesArgs>;
}
...
export interface BuilderPropertiesArgs {
     ...
     */
    buildpackGroups?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220301preview.BuildpacksGroupPropertiesArgs>[]>;
    /**
     * Builder cluster stack property.
     */
    stack?: pulumi.Input<inputs.appplatform.v20220301preview.StackPropertiesArgs>;
}
...
export interface BuildpackBindingPropertiesArgs {
     ...
     */
    bindingType?: pulumi.Input<string | enums.appplatform.v20220301preview.BindingType>;
    /**
     * The object describes the buildpack binding launch properties
     */
    launchProperties?: pulumi.Input<inputs.appplatform.v20220301preview.BuildpackBindingLaunchPropertiesArgs>;
}
...
export interface BuildpacksGroupPropertiesArgs {
     ...
     */
    buildpacks?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220301preview.BuildpackPropertiesArgs>[]>;
    /**
...
export interface ClusterResourcePropertiesArgs {
     ...
     */
    networkProfile?: pulumi.Input<inputs.appplatform.v20220301preview.NetworkProfileArgs>;
...
export interface ConfigServerGitPropertyArgs {
     ...
     * Repositories of git.
     */
    repositories?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220301preview.GitPatternRepositoryArgs>[]>;
    /**
...
export interface ConfigServerPropertiesArgs {
     ...
     */
    configServer?: pulumi.Input<inputs.appplatform.v20220301preview.ConfigServerSettingsArgs>;
    /**
     * Error when apply config server settings.
     */
    error?: pulumi.Input<inputs.appplatform.v20220301preview.ErrorArgs>;
}
...
export interface ConfigServerSettingsArgs {
     ...
     */
    gitProperty?: pulumi.Input<inputs.appplatform.v20220301preview.ConfigServerGitPropertyArgs>;
}
...
export interface ConfigurationServiceGitPropertyArgs {
     ...
     */
    repositories?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220301preview.ConfigurationServiceGitRepositoryArgs>[]>;
}
...
export interface ConfigurationServicePropertiesArgs {
     ...
     */
    settings?: pulumi.Input<inputs.appplatform.v20220301preview.ConfigurationServiceSettingsArgs>;
}
...
export interface ConfigurationServiceSettingsArgs {
     ...
     * Property of git environment.
     */
    gitProperty?: pulumi.Input<inputs.appplatform.v20220301preview.ConfigurationServiceGitPropertyArgs>;
}
...
export interface CustomContainerArgs {
     ...
     */
    imageRegistryCredential?: pulumi.Input<inputs.appplatform.v20220301preview.ImageRegistryCredentialArgs>;
    /**
...
export interface CustomContainerUserSourceInfoArgs {
     ...
     * Custom container payload
     */
    customContainer?: pulumi.Input<inputs.appplatform.v20220301preview.CustomContainerArgs>;
    /**
     * Type of the source uploaded
...
export interface CustomPersistentDiskResourceArgs {
     ...
     */
    customPersistentDiskProperties?: pulumi.Input<inputs.appplatform.v20220301preview.AzureFileVolumeArgs>;
    /**
...
export interface DeploymentResourcePropertiesArgs {
     ...
     */
    deploymentSettings?: pulumi.Input<inputs.appplatform.v20220301preview.DeploymentSettingsArgs>;
    /**
     * Uploaded source information of the deployment.
     */
    source?: pulumi.Input<inputs.appplatform.v20220301preview.BuildResultUserSourceInfoArgs | inputs.appplatform.v20220301preview.CustomContainerUserSourceInfoArgs | inputs.appplatform.v20220301preview.JarUploadedUserSourceInfoArgs | inputs.appplatform.v20220301preview.NetCoreZipUploadedUserSourceInfoArgs | inputs.appplatform.v20220301preview.SourceUploadedUserSourceInfoArgs | inputs.appplatform.v20220301preview.UploadedUserSourceInfoArgs>;
}
...
export interface DeploymentSettingsArgs {
     ...
     * Container liveness and readiness probe settings
     */
    containerProbeSettings?: pulumi.Input<inputs.appplatform.v20220301preview.ContainerProbeSettingsArgs>;
    /**
     ...
     */
    resourceRequests?: pulumi.Input<inputs.appplatform.v20220301preview.ResourceRequestsArgs>;
}
...
export interface GatewayPropertiesArgs {
     ...
     * API metadata property for Spring Cloud Gateway
     */
    apiMetadataProperties?: pulumi.Input<inputs.appplatform.v20220301preview.GatewayApiMetadataPropertiesArgs>;
    /**
     * Cross-Origin Resource Sharing property
     */
    corsProperties?: pulumi.Input<inputs.appplatform.v20220301preview.GatewayCorsPropertiesArgs>;
    /**
     * Indicate if only https is allowed.
     */
    httpsOnly?: pulumi.Input<boolean>;
     ...
     */
    resourceRequests?: pulumi.Input<inputs.appplatform.v20220301preview.GatewayResourceRequestsArgs>;
    /**
     * Single sign-on related configuration
     */
    ssoProperties?: pulumi.Input<inputs.appplatform.v20220301preview.SsoPropertiesArgs>;
...
export function gatewayPropertiesArgsProvideDefaults(val: GatewayPropertiesArgs): GatewayPropertiesArgs {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        public: (val.public) ?? false,
        resourceRequests: (val.resourceRequests ? pulumi.output(val.resourceRequests).apply(inputs.appplatform.v20220301preview.gatewayResourceRequestsArgsProvideDefaults) : undefined),
    };
}
...
export interface GatewayRouteConfigPropertiesArgs {
     ...
     */
    routes?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220301preview.GatewayApiRouteArgs>[]>;
}
...
export interface ManagedIdentityPropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.appplatform.v20220301preview.ManagedIdentityType>;
    /**
