...
export interface ApiPortalPropertiesArgs {
     ...
     */
    ssoProperties?: pulumi.Input<inputs.appplatform.v20221201.SsoPropertiesArgs>;
}
/**
...
export interface AppResourcePropertiesArgs {
     ...
     */
    customPersistentDisks?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221201.CustomPersistentDiskResourceArgs>[]>;
    /**
     ...
     */
    ingressSettings?: pulumi.Input<inputs.appplatform.v20221201.IngressSettingsArgs>;
    /**
     * Collection of loaded certificates
     */
    loadedCertificates?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221201.LoadedCertificateArgs>[]>;
    /**
     * Persistent disk settings
     */
    persistentDisk?: pulumi.Input<inputs.appplatform.v20221201.PersistentDiskArgs>;
    /**
     ...
     */
    temporaryDisk?: pulumi.Input<inputs.appplatform.v20221201.TemporaryDiskArgs>;
    /**
     * Additional App settings in vnet injection instance
     */
    vnetAddons?: pulumi.Input<inputs.appplatform.v20221201.AppVNetAddonsArgs>;
}
/**
...
export function appResourcePropertiesArgsProvideDefaults(val: AppResourcePropertiesArgs): AppResourcePropertiesArgs {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        temporaryDisk: (val.temporaryDisk ? pulumi.output(val.temporaryDisk).apply(inputs.appplatform.v20221201.temporaryDiskArgsProvideDefaults) : undefined),
        vnetAddons: (val.vnetAddons ? pulumi.output(val.vnetAddons).apply(inputs.appplatform.v20221201.appVNetAddonsArgsProvideDefaults) : undefined),
    };
}
...
export interface BuildServiceAgentPoolPropertiesArgs {
     ...
     */
    poolSize?: pulumi.Input<inputs.appplatform.v20221201.BuildServiceAgentPoolSizePropertiesArgs>;
}
...
export interface BuilderPropertiesArgs {
     ...
     */
    buildpackGroups?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221201.BuildpacksGroupPropertiesArgs>[]>;
    /**
     * Builder cluster stack property.
     */
    stack?: pulumi.Input<inputs.appplatform.v20221201.StackPropertiesArgs>;
}
...
export interface BuildpackBindingPropertiesArgs {
     ...
     */
    bindingType?: pulumi.Input<string | enums.appplatform.v20221201.BindingType>;
    /**
     * The object describes the buildpack binding launch properties
     */
    launchProperties?: pulumi.Input<inputs.appplatform.v20221201.BuildpackBindingLaunchPropertiesArgs>;
}
...
export interface BuildpacksGroupPropertiesArgs {
     ...
     */
    buildpacks?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221201.BuildpackPropertiesArgs>[]>;
    /**
...
export interface ClusterResourcePropertiesArgs {
     ...
     */
    networkProfile?: pulumi.Input<inputs.appplatform.v20221201.NetworkProfileArgs>;
    /**
     * Additional Service settings in vnet injection instance
     */
    vnetAddons?: pulumi.Input<inputs.appplatform.v20221201.ServiceVNetAddonsArgs>;
...
export function clusterResourcePropertiesArgsProvideDefaults(val: ClusterResourcePropertiesArgs): ClusterResourcePropertiesArgs {
    return {
        ...val,
        vnetAddons: (val.vnetAddons ? pulumi.output(val.vnetAddons).apply(inputs.appplatform.v20221201.serviceVNetAddonsArgsProvideDefaults) : undefined),
...
export interface ConfigServerGitPropertyArgs {
     ...
     * Repositories of git.
     */
    repositories?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221201.GitPatternRepositoryArgs>[]>;
    /**
...
export interface ConfigServerPropertiesArgs {
     ...
     */
    configServer?: pulumi.Input<inputs.appplatform.v20221201.ConfigServerSettingsArgs>;
    /**
     * Error when apply config server settings.
     */
    error?: pulumi.Input<inputs.appplatform.v20221201.ErrorArgs>;
}
...
export interface ConfigServerSettingsArgs {
     ...
     */
    gitProperty?: pulumi.Input<inputs.appplatform.v20221201.ConfigServerGitPropertyArgs>;
}
...
export interface ConfigurationServiceGitPropertyArgs {
     ...
     */
    repositories?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221201.ConfigurationServiceGitRepositoryArgs>[]>;
}
...
export interface ConfigurationServicePropertiesArgs {
     ...
     */
    settings?: pulumi.Input<inputs.appplatform.v20221201.ConfigurationServiceSettingsArgs>;
}
...
export interface ConfigurationServiceSettingsArgs {
     ...
     * Property of git environment.
     */
    gitProperty?: pulumi.Input<inputs.appplatform.v20221201.ConfigurationServiceGitPropertyArgs>;
}
...
export interface CustomContainerArgs {
     ...
     */
    imageRegistryCredential?: pulumi.Input<inputs.appplatform.v20221201.ImageRegistryCredentialArgs>;
    /**
...
export interface CustomContainerUserSourceInfoArgs {
     ...
     * Custom container payload
     */
    customContainer?: pulumi.Input<inputs.appplatform.v20221201.CustomContainerArgs>;
    /**
     * Type of the source uploaded
...
export interface CustomPersistentDiskResourceArgs {
     ...
     */
    customPersistentDiskProperties?: pulumi.Input<inputs.appplatform.v20221201.AzureFileVolumeArgs>;
    /**
...
export interface DeploymentResourcePropertiesArgs {
     ...
     */
    deploymentSettings?: pulumi.Input<inputs.appplatform.v20221201.DeploymentSettingsArgs>;
    /**
     * Uploaded source information of the deployment.
     */
    source?: pulumi.Input<inputs.appplatform.v20221201.BuildResultUserSourceInfoArgs | inputs.appplatform.v20221201.CustomContainerUserSourceInfoArgs | inputs.appplatform.v20221201.JarUploadedUserSourceInfoArgs | inputs.appplatform.v20221201.NetCoreZipUploadedUserSourceInfoArgs | inputs.appplatform.v20221201.SourceUploadedUserSourceInfoArgs | inputs.appplatform.v20221201.UploadedUserSourceInfoArgs>;
}
/**
...
export function deploymentResourcePropertiesArgsProvideDefaults(val: DeploymentResourcePropertiesArgs): DeploymentResourcePropertiesArgs {
    return {
        ...val,
        deploymentSettings: (val.deploymentSettings ? pulumi.output(val.deploymentSettings).apply(inputs.appplatform.v20221201.deploymentSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface DeploymentSettingsArgs {
     ...
     * Container liveness and readiness probe settings
     */
    containerProbeSettings?: pulumi.Input<inputs.appplatform.v20221201.ContainerProbeSettingsArgs>;
    /**
     ...
     */
    livenessProbe?: pulumi.Input<inputs.appplatform.v20221201.ProbeArgs>;
    /**
     ...
     */
    readinessProbe?: pulumi.Input<inputs.appplatform.v20221201.ProbeArgs>;
    /**
     ...
     */
    resourceRequests?: pulumi.Input<inputs.appplatform.v20221201.ResourceRequestsArgs>;
    /**
     ...
     */
    startupProbe?: pulumi.Input<inputs.appplatform.v20221201.ProbeArgs>;
    /**
...
export function deploymentSettingsArgsProvideDefaults(val: DeploymentSettingsArgs): DeploymentSettingsArgs {
    return {
        ...val,
        livenessProbe: (val.livenessProbe ? pulumi.output(val.livenessProbe).apply(inputs.appplatform.v20221201.probeArgsProvideDefaults) : undefined),
        readinessProbe: (val.readinessProbe ? pulumi.output(val.readinessProbe).apply(inputs.appplatform.v20221201.probeArgsProvideDefaults) : undefined),
        startupProbe: (val.startupProbe ? pulumi.output(val.startupProbe).apply(inputs.appplatform.v20221201.probeArgsProvideDefaults) : undefined),
...
export interface GatewayPropertiesArgs {
     ...
     * API metadata property for Spring Cloud Gateway
     */
    apiMetadataProperties?: pulumi.Input<inputs.appplatform.v20221201.GatewayApiMetadataPropertiesArgs>;
    /**
     * Cross-Origin Resource Sharing property
     */
    corsProperties?: pulumi.Input<inputs.appplatform.v20221201.GatewayCorsPropertiesArgs>;
    /**
     * Indicate if only https is allowed.
     */
    httpsOnly?: pulumi.Input<boolean>;
     ...
     */
    resourceRequests?: pulumi.Input<inputs.appplatform.v20221201.GatewayResourceRequestsArgs>;
    /**
     * Single sign-on related configuration
     */
    ssoProperties?: pulumi.Input<inputs.appplatform.v20221201.SsoPropertiesArgs>;
...
export function gatewayPropertiesArgsProvideDefaults(val: GatewayPropertiesArgs): GatewayPropertiesArgs {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        public: (val.public) ?? false,
        resourceRequests: (val.resourceRequests ? pulumi.output(val.resourceRequests).apply(inputs.appplatform.v20221201.gatewayResourceRequestsArgsProvideDefaults) : undefined),
    };
}
...
export interface GatewayRouteConfigPropertiesArgs {
     ...
     * OpenAPI properties of Spring Cloud Gateway route config.
     */
    openApi?: pulumi.Input<inputs.appplatform.v20221201.GatewayRouteConfigOpenApiPropertiesArgs>;
    /**
     * Protocol of routed Azure Spring Apps applications.
     */
    protocol?: pulumi.Input<string | enums.appplatform.v20221201.GatewayRouteConfigProtocol>;
    /**
     * Array of API routes, each route contains properties such as `title`, `uri`, `ssoEnabled`, `predicates`, `filters`.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221201.GatewayApiRouteArgs>[]>;
}
/**
...
export interface HTTPGetActionArgs {
     ...
     */
    scheme?: pulumi.Input<string | enums.appplatform.v20221201.HTTPSchemeType>;
    /**
     * The type of the action to take to perform the health check.
...
export interface IngressSettingsArgs {
     ...
     */
    backendProtocol?: pulumi.Input<string | enums.appplatform.v20221201.BackendProtocol>;
    /**
     * Client-Certification Authentication.
     */
    clientAuth?: pulumi.Input<inputs.appplatform.v20221201.IngressSettingsClientAuthArgs>;
    /**
     * Ingress read time out in seconds.
     */
    readTimeoutInSeconds?: pulumi.Input<number>;
     ...
     */
    sessionAffinity?: pulumi.Input<string | enums.appplatform.v20221201.SessionAffinity>;
    /**
...
export interface ManagedIdentityPropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.appplatform.v20221201.ManagedIdentityType>;
    /**
...
export interface NetworkProfileArgs {
     ...
     * Ingress configuration payload for Azure Spring Apps resource.
     */
    ingressConfig?: pulumi.Input<inputs.appplatform.v20221201.IngressConfigArgs>;
    /**
...
export interface ProbeArgs {
     ...
     */
    probeAction?: pulumi.Input<inputs.appplatform.v20221201.ExecActionArgs | inputs.appplatform.v20221201.HTTPGetActionArgs | inputs.appplatform.v20221201.TCPSocketActionArgs>;
    /**
