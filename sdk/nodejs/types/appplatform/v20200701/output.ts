...
export interface AppResourcePropertiesResponse {
     ...
     */
    persistentDisk?: outputs.appplatform.v20200701.PersistentDiskResponse;
    /**
     ...
     */
    temporaryDisk?: outputs.appplatform.v20200701.TemporaryDiskResponse;
    /**
     * URL of the App
     */
    url: string;
...
export function appResourcePropertiesResponseProvideDefaults(val: AppResourcePropertiesResponse): AppResourcePropertiesResponse {
    return {
        ...
        temporaryDisk: (val.temporaryDisk ? outputs.appplatform.v20200701.temporaryDiskResponseProvideDefaults(val.temporaryDisk) : undefined),
    };
}
...
export interface ClusterResourcePropertiesResponse {
     ...
     */
    networkProfile?: outputs.appplatform.v20200701.NetworkProfileResponse;
    /**
...
export interface ConfigServerGitPropertyResponse {
     ...
     * Repositories of git.
     */
    repositories?: outputs.appplatform.v20200701.GitPatternRepositoryResponse[];
    /**
...
export interface ConfigServerPropertiesResponse {
     ...
     */
    configServer?: outputs.appplatform.v20200701.ConfigServerSettingsResponse;
    /**
     * Error when apply config server settings.
     */
    error?: outputs.appplatform.v20200701.ErrorResponse;
    /**
...
export interface ConfigServerSettingsResponse {
     ...
     */
    gitProperty?: outputs.appplatform.v20200701.ConfigServerGitPropertyResponse;
}
...
export interface DeploymentResourcePropertiesResponse {
     ...
     */
    deploymentSettings?: outputs.appplatform.v20200701.DeploymentSettingsResponse;
    /**
     * Collection of instances belong to the Deployment
     */
    instances: outputs.appplatform.v20200701.DeploymentInstanceResponse[];
    /**
     ...
     */
    source?: outputs.appplatform.v20200701.UserSourceInfoResponse;
    /**
...
export function deploymentResourcePropertiesResponseProvideDefaults(val: DeploymentResourcePropertiesResponse): DeploymentResourcePropertiesResponse {
    return {
        ...val,
        deploymentSettings: (val.deploymentSettings ? outputs.appplatform.v20200701.deploymentSettingsResponseProvideDefaults(val.deploymentSettings) : undefined),
    };
}
...
export interface NetworkProfileResponse {
     ...
     */
    outboundIPs: outputs.appplatform.v20200701.NetworkProfileResponseOutboundIPs;
    /**
     * Required inbound or outbound traffics for Azure Spring Cloud instance.
     */
    requiredTraffics: outputs.appplatform.v20200701.RequiredTrafficResponse[];
    /**
