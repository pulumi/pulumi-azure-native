...
export interface ApiPortalPropertiesArgs {
     ...
     */
    ssoProperties?: pulumi.Input<inputs.appplatform.v20220101preview.SsoPropertiesArgs>;
}
/**
...
export interface AppResourcePropertiesArgs {
     ...
     */
    customPersistentDisks?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220101preview.CustomPersistentDiskResourceArgs>[]>;
    /**
     ...
     */
    loadedCertificates?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220101preview.LoadedCertificateArgs>[]>;
    /**
     * Persistent disk settings
     */
    persistentDisk?: pulumi.Input<inputs.appplatform.v20220101preview.PersistentDiskArgs>;
    /**
     ...
     */
    temporaryDisk?: pulumi.Input<inputs.appplatform.v20220101preview.TemporaryDiskArgs>;
}
/**
...
export function appResourcePropertiesArgsProvideDefaults(val: AppResourcePropertiesArgs): AppResourcePropertiesArgs {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        temporaryDisk: (val.temporaryDisk ? pulumi.output(val.temporaryDisk).apply(inputs.appplatform.v20220101preview.temporaryDiskArgsProvideDefaults) : undefined),
    };
}
...
export interface BuildServiceAgentPoolPropertiesArgs {
     ...
     */
    poolSize?: pulumi.Input<inputs.appplatform.v20220101preview.BuildServiceAgentPoolSizePropertiesArgs>;
}
...
export interface BuilderPropertiesArgs {
     ...
     */
    buildpackGroups?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220101preview.BuildpacksGroupPropertiesArgs>[]>;
    /**
     * Builder cluster stack property.
     */
    stack?: pulumi.Input<inputs.appplatform.v20220101preview.StackPropertiesArgs>;
}
...
export interface BuildpackBindingPropertiesArgs {
     ...
     */
    bindingType?: pulumi.Input<string | enums.appplatform.v20220101preview.BindingType>;
    /**
     * The object describes the buildpack binding launch properties
     */
    launchProperties?: pulumi.Input<inputs.appplatform.v20220101preview.BuildpackBindingLaunchPropertiesArgs>;
}
...
export interface BuildpacksGroupPropertiesArgs {
     ...
     */
    buildpacks?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220101preview.BuildpackPropertiesArgs>[]>;
    /**
...
export interface ClusterResourcePropertiesArgs {
     ...
     */
    networkProfile?: pulumi.Input<inputs.appplatform.v20220101preview.NetworkProfileArgs>;
...
export interface ConfigServerGitPropertyArgs {
     ...
     * Repositories of git.
     */
    repositories?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220101preview.GitPatternRepositoryArgs>[]>;
    /**
...
export interface ConfigServerPropertiesArgs {
     ...
     */
    configServer?: pulumi.Input<inputs.appplatform.v20220101preview.ConfigServerSettingsArgs>;
    /**
     * Error when apply config server settings.
     */
    error?: pulumi.Input<inputs.appplatform.v20220101preview.ErrorArgs>;
}
...
export interface ConfigServerSettingsArgs {
     ...
     */
    gitProperty?: pulumi.Input<inputs.appplatform.v20220101preview.ConfigServerGitPropertyArgs>;
}
...
export interface ConfigurationServiceGitPropertyArgs {
     ...
     */
    repositories?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220101preview.ConfigurationServiceGitRepositoryArgs>[]>;
}
...
export interface ConfigurationServicePropertiesArgs {
     ...
     */
    settings?: pulumi.Input<inputs.appplatform.v20220101preview.ConfigurationServiceSettingsArgs>;
}
...
export interface ConfigurationServiceSettingsArgs {
     ...
     * Property of git environment.
     */
    gitProperty?: pulumi.Input<inputs.appplatform.v20220101preview.ConfigurationServiceGitPropertyArgs>;
}
...
export interface CustomContainerArgs {
     ...
     */
    imageRegistryCredential?: pulumi.Input<inputs.appplatform.v20220101preview.ImageRegistryCredentialArgs>;
    /**
...
export interface CustomContainerUserSourceInfoArgs {
     ...
     * Custom container payload
     */
    customContainer?: pulumi.Input<inputs.appplatform.v20220101preview.CustomContainerArgs>;
    /**
     * Type of the source uploaded
...
export interface CustomPersistentDiskResourceArgs {
     ...
     */
    customPersistentDiskProperties?: pulumi.Input<inputs.appplatform.v20220101preview.AzureFileVolumeArgs>;
    /**
...
export interface DeploymentResourcePropertiesArgs {
     ...
     */
    deploymentSettings?: pulumi.Input<inputs.appplatform.v20220101preview.DeploymentSettingsArgs>;
    /**
     * Uploaded source information of the deployment.
     */
    source?: pulumi.Input<inputs.appplatform.v20220101preview.BuildResultUserSourceInfoArgs | inputs.appplatform.v20220101preview.CustomContainerUserSourceInfoArgs | inputs.appplatform.v20220101preview.JarUploadedUserSourceInfoArgs | inputs.appplatform.v20220101preview.NetCoreZipUploadedUserSourceInfoArgs | inputs.appplatform.v20220101preview.SourceUploadedUserSourceInfoArgs | inputs.appplatform.v20220101preview.UploadedUserSourceInfoArgs>;
}
...
export interface DeploymentSettingsArgs {
     ...
     * Container liveness and readiness probe settings
     */
    containerProbeSettings?: pulumi.Input<inputs.appplatform.v20220101preview.ContainerProbeSettingsArgs>;
    /**
     ...
     */
    resourceRequests?: pulumi.Input<inputs.appplatform.v20220101preview.ResourceRequestsArgs>;
}
...
export interface GatewayPropertiesArgs {
     ...
     * API metadata property for Spring Cloud Gateway
     */
    apiMetadataProperties?: pulumi.Input<inputs.appplatform.v20220101preview.GatewayApiMetadataPropertiesArgs>;
    /**
     * Cross-Origin Resource Sharing property
     */
    corsProperties?: pulumi.Input<inputs.appplatform.v20220101preview.GatewayCorsPropertiesArgs>;
    /**
     * Indicate if only https is allowed.
     */
    httpsOnly?: pulumi.Input<boolean>;
     ...
     */
    resourceRequests?: pulumi.Input<inputs.appplatform.v20220101preview.GatewayResourceRequestsArgs>;
    /**
     * Single sign-on related configuration
     */
    ssoProperties?: pulumi.Input<inputs.appplatform.v20220101preview.SsoPropertiesArgs>;
...
export function gatewayPropertiesArgsProvideDefaults(val: GatewayPropertiesArgs): GatewayPropertiesArgs {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        public: (val.public) ?? false,
        resourceRequests: (val.resourceRequests ? pulumi.output(val.resourceRequests).apply(inputs.appplatform.v20220101preview.gatewayResourceRequestsArgsProvideDefaults) : undefined),
    };
}
...
export interface GatewayRouteConfigPropertiesArgs {
     ...
     */
    routes?: pulumi.Input<pulumi.Input<inputs.appplatform.v20220101preview.GatewayApiRouteArgs>[]>;
}
...
export interface ManagedIdentityPropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.appplatform.v20220101preview.ManagedIdentityType>;
}
