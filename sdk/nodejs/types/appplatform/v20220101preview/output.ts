...
export interface ApiPortalPropertiesResponse {
     ...
     */
    instances: outputs.appplatform.v20220101preview.ApiPortalInstanceResponse[];
    /**
     ...
     */
    resourceRequests: outputs.appplatform.v20220101preview.ApiPortalResourceRequestsResponse;
    /**
     ...
     */
    ssoProperties?: outputs.appplatform.v20220101preview.SsoPropertiesResponse;
    /**
...
export interface AppResourcePropertiesResponse {
     ...
     */
    customPersistentDisks?: outputs.appplatform.v20220101preview.CustomPersistentDiskResourceResponse[];
    /**
     ...
     */
    loadedCertificates?: outputs.appplatform.v20220101preview.LoadedCertificateResponse[];
    /**
     * Persistent disk settings
     */
    persistentDisk?: outputs.appplatform.v20220101preview.PersistentDiskResponse;
    /**
     ...
     */
    temporaryDisk?: outputs.appplatform.v20220101preview.TemporaryDiskResponse;
    /**
     * URL of the App
     */
    url: string;
...
export function appResourcePropertiesResponseProvideDefaults(val: AppResourcePropertiesResponse): AppResourcePropertiesResponse {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        temporaryDisk: (val.temporaryDisk ? outputs.appplatform.v20220101preview.temporaryDiskResponseProvideDefaults(val.temporaryDisk) : undefined),
    };
}
...
export interface BuildServiceAgentPoolPropertiesResponse {
     ...
     */
    poolSize?: outputs.appplatform.v20220101preview.BuildServiceAgentPoolSizePropertiesResponse;
    /**
...
export interface BuilderPropertiesResponse {
     ...
     */
    buildpackGroups?: outputs.appplatform.v20220101preview.BuildpacksGroupPropertiesResponse[];
    /**
     ...
     */
    stack?: outputs.appplatform.v20220101preview.StackPropertiesResponse;
}
...
export interface BuildpackBindingPropertiesResponse {
     ...
     */
    launchProperties?: outputs.appplatform.v20220101preview.BuildpackBindingLaunchPropertiesResponse;
    /**
...
export interface BuildpacksGroupPropertiesResponse {
     ...
     */
    buildpacks?: outputs.appplatform.v20220101preview.BuildpackPropertiesResponse[];
    /**
...
export interface ClusterResourcePropertiesResponse {
     ...
     */
    networkProfile?: outputs.appplatform.v20220101preview.NetworkProfileResponse;
    /**
...
export interface ConfigServerGitPropertyResponse {
     ...
     * Repositories of git.
     */
    repositories?: outputs.appplatform.v20220101preview.GitPatternRepositoryResponse[];
    /**
...
export interface ConfigServerPropertiesResponse {
     ...
     */
    configServer?: outputs.appplatform.v20220101preview.ConfigServerSettingsResponse;
    /**
     * Error when apply config server settings.
     */
    error?: outputs.appplatform.v20220101preview.ErrorResponse;
    /**
...
export interface ConfigServerSettingsResponse {
     ...
     */
    gitProperty?: outputs.appplatform.v20220101preview.ConfigServerGitPropertyResponse;
}
...
export interface ConfigurationServiceGitPropertyResponse {
     ...
     */
    repositories?: outputs.appplatform.v20220101preview.ConfigurationServiceGitRepositoryResponse[];
}
...
export interface ConfigurationServicePropertiesResponse {
     ...
     */
    instances: outputs.appplatform.v20220101preview.ConfigurationServiceInstanceResponse[];
    /**
     ...
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests: outputs.appplatform.v20220101preview.ConfigurationServiceResourceRequestsResponse;
    /**
     * The settings of Application Configuration Service.
     */
    settings?: outputs.appplatform.v20220101preview.ConfigurationServiceSettingsResponse;
}
...
export interface ConfigurationServiceSettingsResponse {
     ...
     * Property of git environment.
     */
    gitProperty?: outputs.appplatform.v20220101preview.ConfigurationServiceGitPropertyResponse;
}
...
export interface CustomContainerResponse {
     ...
     */
    imageRegistryCredential?: outputs.appplatform.v20220101preview.ImageRegistryCredentialResponse;
    /**
...
export interface CustomContainerUserSourceInfoResponse {
     ...
     * Custom container payload
     */
    customContainer?: outputs.appplatform.v20220101preview.CustomContainerResponse;
    /**
     * Type of the source uploaded
...
export interface CustomPersistentDiskResourceResponse {
     ...
     */
    customPersistentDiskProperties?: outputs.appplatform.v20220101preview.AzureFileVolumeResponse;
    /**
...
export interface DeploymentResourcePropertiesResponse {
     ...
     */
    deploymentSettings?: outputs.appplatform.v20220101preview.DeploymentSettingsResponse;
    /**
     * Collection of instances belong to the Deployment
     */
    instances: outputs.appplatform.v20220101preview.DeploymentInstanceResponse[];
    /**
     ...
     */
    source?: outputs.appplatform.v20220101preview.BuildResultUserSourceInfoResponse | outputs.appplatform.v20220101preview.CustomContainerUserSourceInfoResponse | outputs.appplatform.v20220101preview.JarUploadedUserSourceInfoResponse | outputs.appplatform.v20220101preview.NetCoreZipUploadedUserSourceInfoResponse | outputs.appplatform.v20220101preview.SourceUploadedUserSourceInfoResponse | outputs.appplatform.v20220101preview.UploadedUserSourceInfoResponse;
    /**
...
export interface DeploymentSettingsResponse {
     ...
     * Container liveness and readiness probe settings
     */
    containerProbeSettings?: outputs.appplatform.v20220101preview.ContainerProbeSettingsResponse;
    /**
     ...
     */
    resourceRequests?: outputs.appplatform.v20220101preview.ResourceRequestsResponse;
}
...
export interface GatewayOperatorPropertiesResponse {
     ...
     */
    instances: outputs.appplatform.v20220101preview.GatewayInstanceResponse[];
    /**
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests: outputs.appplatform.v20220101preview.GatewayOperatorResourceRequestsResponse;
}
...
export interface GatewayPropertiesResponse {
     ...
     * API metadata property for Spring Cloud Gateway
     */
    apiMetadataProperties?: outputs.appplatform.v20220101preview.GatewayApiMetadataPropertiesResponse;
    /**
     * Cross-Origin Resource Sharing property
     */
    corsProperties?: outputs.appplatform.v20220101preview.GatewayCorsPropertiesResponse;
    /**
     * Indicate if only https is allowed.
     */
    httpsOnly?: boolean;
     ...
     * Properties of the Spring Cloud Gateway Operator.
     */
    operatorProperties: outputs.appplatform.v20220101preview.GatewayOperatorPropertiesResponse;
    /**
     ...
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests?: outputs.appplatform.v20220101preview.GatewayResourceRequestsResponse;
    /**
     * Single sign-on related configuration
     */
    ssoProperties?: outputs.appplatform.v20220101preview.SsoPropertiesResponse;
...
export function gatewayPropertiesResponseProvideDefaults(val: GatewayPropertiesResponse): GatewayPropertiesResponse {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        public: (val.public) ?? false,
        resourceRequests: (val.resourceRequests ? outputs.appplatform.v20220101preview.gatewayResourceRequestsResponseProvideDefaults(val.resourceRequests) : undefined),
    };
}
...
export interface GatewayRouteConfigPropertiesResponse {
     ...
     */
    routes?: outputs.appplatform.v20220101preview.GatewayApiRouteResponse[];
}
...
export interface MonitoringSettingPropertiesResponse {
     ...
     */
    appInsightsAgentVersions?: outputs.appplatform.v20220101preview.ApplicationInsightsAgentVersionsResponse;
    /**
...
export interface NetworkProfileResponse {
     ...
     */
    outboundIPs: outputs.appplatform.v20220101preview.NetworkProfileResponseOutboundIPs;
    /**
     * Required inbound or outbound traffics for Azure Spring Cloud instance.
     */
    requiredTraffics: outputs.appplatform.v20220101preview.RequiredTrafficResponse[];
    /**
...
export interface ServiceRegistryPropertiesResponse {
     ...
     */
    instances: outputs.appplatform.v20220101preview.ServiceRegistryInstanceResponse[];
    /**
     ...
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests: outputs.appplatform.v20220101preview.ServiceRegistryResourceRequestsResponse;
}
