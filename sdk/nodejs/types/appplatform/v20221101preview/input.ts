...
export interface AcceleratorGitRepositoryArgs {
     ...
     */
    authSetting: pulumi.Input<inputs.appplatform.v20221101preview.AcceleratorBasicAuthSettingArgs | inputs.appplatform.v20221101preview.AcceleratorPublicSettingArgs | inputs.appplatform.v20221101preview.AcceleratorSshSettingArgs>;
    /**
...
export interface ApiPortalPropertiesArgs {
     ...
     */
    ssoProperties?: pulumi.Input<inputs.appplatform.v20221101preview.SsoPropertiesArgs>;
}
/**
...
export interface AppResourcePropertiesArgs {
     ...
     */
    customPersistentDisks?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221101preview.CustomPersistentDiskResourceArgs>[]>;
    /**
     ...
     */
    ingressSettings?: pulumi.Input<inputs.appplatform.v20221101preview.IngressSettingsArgs>;
    /**
     * Collection of loaded certificates
     */
    loadedCertificates?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221101preview.LoadedCertificateArgs>[]>;
    /**
     * Persistent disk settings
     */
    persistentDisk?: pulumi.Input<inputs.appplatform.v20221101preview.PersistentDiskArgs>;
    /**
     ...
     */
    temporaryDisk?: pulumi.Input<inputs.appplatform.v20221101preview.TemporaryDiskArgs>;
    /**
     * Additional App settings in vnet injection instance
     */
    vnetAddons?: pulumi.Input<inputs.appplatform.v20221101preview.AppVNetAddonsArgs>;
}
/**
...
export function appResourcePropertiesArgsProvideDefaults(val: AppResourcePropertiesArgs): AppResourcePropertiesArgs {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        temporaryDisk: (val.temporaryDisk ? pulumi.output(val.temporaryDisk).apply(inputs.appplatform.v20221101preview.temporaryDiskArgsProvideDefaults) : undefined),
        vnetAddons: (val.vnetAddons ? pulumi.output(val.vnetAddons).apply(inputs.appplatform.v20221101preview.appVNetAddonsArgsProvideDefaults) : undefined),
    };
}
...
export interface BuildServiceAgentPoolPropertiesArgs {
     ...
     */
    poolSize?: pulumi.Input<inputs.appplatform.v20221101preview.BuildServiceAgentPoolSizePropertiesArgs>;
}
...
export interface BuilderPropertiesArgs {
     ...
     */
    buildpackGroups?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221101preview.BuildpacksGroupPropertiesArgs>[]>;
    /**
     * Builder cluster stack property.
     */
    stack?: pulumi.Input<inputs.appplatform.v20221101preview.StackPropertiesArgs>;
}
...
export interface BuildpackBindingPropertiesArgs {
     ...
     */
    bindingType?: pulumi.Input<string | enums.appplatform.v20221101preview.BindingType>;
    /**
     * The object describes the buildpack binding launch properties
     */
    launchProperties?: pulumi.Input<inputs.appplatform.v20221101preview.BuildpackBindingLaunchPropertiesArgs>;
}
...
export interface BuildpacksGroupPropertiesArgs {
     ...
     */
    buildpacks?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221101preview.BuildpackPropertiesArgs>[]>;
    /**
...
export interface ClusterResourcePropertiesArgs {
     ...
     */
    marketplaceResource?: pulumi.Input<inputs.appplatform.v20221101preview.MarketplaceResourceArgs>;
    /**
     * Network profile of the Service
     */
    networkProfile?: pulumi.Input<inputs.appplatform.v20221101preview.NetworkProfileArgs>;
    /**
     * Additional Service settings in vnet injection instance
     */
    vnetAddons?: pulumi.Input<inputs.appplatform.v20221101preview.ServiceVNetAddonsArgs>;
...
export function clusterResourcePropertiesArgsProvideDefaults(val: ClusterResourcePropertiesArgs): ClusterResourcePropertiesArgs {
    return {
        ...val,
        vnetAddons: (val.vnetAddons ? pulumi.output(val.vnetAddons).apply(inputs.appplatform.v20221101preview.serviceVNetAddonsArgsProvideDefaults) : undefined),
...
export interface ConfigServerGitPropertyArgs {
     ...
     * Repositories of git.
     */
    repositories?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221101preview.GitPatternRepositoryArgs>[]>;
    /**
...
export interface ConfigServerPropertiesArgs {
     ...
     */
    configServer?: pulumi.Input<inputs.appplatform.v20221101preview.ConfigServerSettingsArgs>;
    /**
     * Error when apply config server settings.
     */
    error?: pulumi.Input<inputs.appplatform.v20221101preview.ErrorArgs>;
}
...
export interface ConfigServerSettingsArgs {
     ...
     */
    gitProperty?: pulumi.Input<inputs.appplatform.v20221101preview.ConfigServerGitPropertyArgs>;
}
...
export interface ConfigurationServiceGitPropertyArgs {
     ...
     */
    repositories?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221101preview.ConfigurationServiceGitRepositoryArgs>[]>;
}
...
export interface ConfigurationServicePropertiesArgs {
     ...
     */
    settings?: pulumi.Input<inputs.appplatform.v20221101preview.ConfigurationServiceSettingsArgs>;
}
...
export interface ConfigurationServiceSettingsArgs {
     ...
     * Property of git environment.
     */
    gitProperty?: pulumi.Input<inputs.appplatform.v20221101preview.ConfigurationServiceGitPropertyArgs>;
}
...
export interface CustomContainerArgs {
     ...
     */
    imageRegistryCredential?: pulumi.Input<inputs.appplatform.v20221101preview.ImageRegistryCredentialArgs>;
    /**
...
export interface CustomContainerUserSourceInfoArgs {
     ...
     * Custom container payload
     */
    customContainer?: pulumi.Input<inputs.appplatform.v20221101preview.CustomContainerArgs>;
    /**
     * Type of the source uploaded
...
export interface CustomPersistentDiskResourceArgs {
     ...
     */
    customPersistentDiskProperties?: pulumi.Input<inputs.appplatform.v20221101preview.AzureFileVolumeArgs>;
    /**
...
export interface CustomizedAcceleratorPropertiesArgs {
    ...
    gitRepository: pulumi.Input<inputs.appplatform.v20221101preview.AcceleratorGitRepositoryArgs>;
...
export interface DeploymentResourcePropertiesArgs {
     ...
     */
    deploymentSettings?: pulumi.Input<inputs.appplatform.v20221101preview.DeploymentSettingsArgs>;
    /**
     * Uploaded source information of the deployment.
     */
    source?: pulumi.Input<inputs.appplatform.v20221101preview.BuildResultUserSourceInfoArgs | inputs.appplatform.v20221101preview.CustomContainerUserSourceInfoArgs | inputs.appplatform.v20221101preview.JarUploadedUserSourceInfoArgs | inputs.appplatform.v20221101preview.NetCoreZipUploadedUserSourceInfoArgs | inputs.appplatform.v20221101preview.SourceUploadedUserSourceInfoArgs | inputs.appplatform.v20221101preview.UploadedUserSourceInfoArgs>;
}
/**
...
export function deploymentResourcePropertiesArgsProvideDefaults(val: DeploymentResourcePropertiesArgs): DeploymentResourcePropertiesArgs {
    return {
        ...val,
        deploymentSettings: (val.deploymentSettings ? pulumi.output(val.deploymentSettings).apply(inputs.appplatform.v20221101preview.deploymentSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface DeploymentSettingsArgs {
     ...
     * Container liveness and readiness probe settings
     */
    containerProbeSettings?: pulumi.Input<inputs.appplatform.v20221101preview.ContainerProbeSettingsArgs>;
    /**
     ...
     */
    livenessProbe?: pulumi.Input<inputs.appplatform.v20221101preview.ProbeArgs>;
    /**
     ...
     */
    readinessProbe?: pulumi.Input<inputs.appplatform.v20221101preview.ProbeArgs>;
    /**
     ...
     */
    resourceRequests?: pulumi.Input<inputs.appplatform.v20221101preview.ResourceRequestsArgs>;
    /**
     ...
     */
    startupProbe?: pulumi.Input<inputs.appplatform.v20221101preview.ProbeArgs>;
    /**
...
export function deploymentSettingsArgsProvideDefaults(val: DeploymentSettingsArgs): DeploymentSettingsArgs {
    return {
        ...val,
        livenessProbe: (val.livenessProbe ? pulumi.output(val.livenessProbe).apply(inputs.appplatform.v20221101preview.probeArgsProvideDefaults) : undefined),
        readinessProbe: (val.readinessProbe ? pulumi.output(val.readinessProbe).apply(inputs.appplatform.v20221101preview.probeArgsProvideDefaults) : undefined),
        startupProbe: (val.startupProbe ? pulumi.output(val.startupProbe).apply(inputs.appplatform.v20221101preview.probeArgsProvideDefaults) : undefined),
...
export interface DevToolPortalFeatureDetailArgs {
     ...
     * State of the plugin
     */
    state?: pulumi.Input<string | enums.appplatform.v20221101preview.DevToolPortalFeatureState>;
}
/**
...
export interface DevToolPortalFeatureSettingsArgs {
     ...
     */
    applicationAccelerator?: pulumi.Input<inputs.appplatform.v20221101preview.DevToolPortalFeatureDetailArgs>;
    /**
     * Detail of App Live View plugin
     */
    applicationLiveView?: pulumi.Input<inputs.appplatform.v20221101preview.DevToolPortalFeatureDetailArgs>;
}
/**
...
export function devToolPortalFeatureSettingsArgsProvideDefaults(val: DevToolPortalFeatureSettingsArgs): DevToolPortalFeatureSettingsArgs {
    return {
        ...val,
        applicationAccelerator: (val.applicationAccelerator ? pulumi.output(val.applicationAccelerator).apply(inputs.appplatform.v20221101preview.devToolPortalFeatureDetailArgsProvideDefaults) : undefined),
        applicationLiveView: (val.applicationLiveView ? pulumi.output(val.applicationLiveView).apply(inputs.appplatform.v20221101preview.devToolPortalFeatureDetailArgsProvideDefaults) : undefined),
    };
}
...
export interface DevToolPortalPropertiesArgs {
     ...
     * Settings for Dev Tool Portal
     */
    features?: pulumi.Input<inputs.appplatform.v20221101preview.DevToolPortalFeatureSettingsArgs>;
    /**
     ...
     * Single sign-on related configuration
     */
    ssoProperties?: pulumi.Input<inputs.appplatform.v20221101preview.DevToolPortalSsoPropertiesArgs>;
}
/**
...
export function devToolPortalPropertiesArgsProvideDefaults(val: DevToolPortalPropertiesArgs): DevToolPortalPropertiesArgs {
    return {
        ...val,
        features: (val.features ? pulumi.output(val.features).apply(inputs.appplatform.v20221101preview.devToolPortalFeatureSettingsArgsProvideDefaults) : undefined),
        public: (val.public) ?? false,
    };
}
...
export interface GatewayPropertiesArgs {
     ...
     * API metadata property for Spring Cloud Gateway
     */
    apiMetadataProperties?: pulumi.Input<inputs.appplatform.v20221101preview.GatewayApiMetadataPropertiesArgs>;
    /**
     * Collection of APM type used in Spring Cloud Gateway
     */
    apmTypes?: pulumi.Input<pulumi.Input<string | enums.appplatform.v20221101preview.ApmType>[]>;
    /**
     * Cross-Origin Resource Sharing property
     */
    corsProperties?: pulumi.Input<inputs.appplatform.v20221101preview.GatewayCorsPropertiesArgs>;
    /**
     * Environment variables of Spring Cloud Gateway
     */
    environmentVariables?: pulumi.Input<inputs.appplatform.v20221101preview.GatewayPropertiesEnvironmentVariablesArgs>;
    /**
     * Indicate if only https is allowed.
     */
    httpsOnly?: pulumi.Input<boolean>;
     ...
     */
    resourceRequests?: pulumi.Input<inputs.appplatform.v20221101preview.GatewayResourceRequestsArgs>;
    /**
     * Single sign-on related configuration
     */
    ssoProperties?: pulumi.Input<inputs.appplatform.v20221101preview.SsoPropertiesArgs>;
...
export function gatewayPropertiesArgsProvideDefaults(val: GatewayPropertiesArgs): GatewayPropertiesArgs {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        public: (val.public) ?? false,
        resourceRequests: (val.resourceRequests ? pulumi.output(val.resourceRequests).apply(inputs.appplatform.v20221101preview.gatewayResourceRequestsArgsProvideDefaults) : undefined),
    };
}
...
export interface GatewayRouteConfigPropertiesArgs {
     ...
     * OpenAPI properties of Spring Cloud Gateway route config.
     */
    openApi?: pulumi.Input<inputs.appplatform.v20221101preview.GatewayRouteConfigOpenApiPropertiesArgs>;
    /**
     ...
     */
    protocol?: pulumi.Input<string | enums.appplatform.v20221101preview.GatewayRouteConfigProtocol>;
    /**
     * Array of API routes, each route contains properties such as `title`, `uri`, `ssoEnabled`, `predicates`, `filters`.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.appplatform.v20221101preview.GatewayApiRouteArgs>[]>;
    /**
...
export interface HTTPGetActionArgs {
     ...
     */
    scheme?: pulumi.Input<string | enums.appplatform.v20221101preview.HTTPSchemeType>;
    /**
     * The type of the action to take to perform the health check.
...
export interface IngressSettingsArgs {
     ...
     */
    backendProtocol?: pulumi.Input<string | enums.appplatform.v20221101preview.BackendProtocol>;
    /**
     * Client-Certification Authentication.
     */
    clientAuth?: pulumi.Input<inputs.appplatform.v20221101preview.IngressSettingsClientAuthArgs>;
    /**
     * Ingress read time out in seconds.
     */
    readTimeoutInSeconds?: pulumi.Input<number>;
     ...
     */
    sessionAffinity?: pulumi.Input<string | enums.appplatform.v20221101preview.SessionAffinity>;
    /**
...
export interface ManagedIdentityPropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.appplatform.v20221101preview.ManagedIdentityType>;
    /**
...
export interface NetworkProfileArgs {
     ...
     * Ingress configuration payload for Azure Spring Apps resource.
     */
    ingressConfig?: pulumi.Input<inputs.appplatform.v20221101preview.IngressConfigArgs>;
    /**
...
export interface ProbeArgs {
     ...
     */
    probeAction?: pulumi.Input<inputs.appplatform.v20221101preview.ExecActionArgs | inputs.appplatform.v20221101preview.HTTPGetActionArgs | inputs.appplatform.v20221101preview.TCPSocketActionArgs>;
    /**
