...
export interface AcceleratorGitRepositoryResponse {
     ...
     */
    authSetting: outputs.appplatform.v20221101preview.AcceleratorBasicAuthSettingResponse | outputs.appplatform.v20221101preview.AcceleratorPublicSettingResponse | outputs.appplatform.v20221101preview.AcceleratorSshSettingResponse;
    /**
...
export interface ApiPortalPropertiesResponse {
     ...
     */
    instances: outputs.appplatform.v20221101preview.ApiPortalInstanceResponse[];
    /**
     ...
     */
    resourceRequests: outputs.appplatform.v20221101preview.ApiPortalResourceRequestsResponse;
    /**
     ...
     */
    ssoProperties?: outputs.appplatform.v20221101preview.SsoPropertiesResponse;
    /**
...
export interface AppResourcePropertiesResponse {
     ...
     */
    customPersistentDisks?: outputs.appplatform.v20221101preview.CustomPersistentDiskResourceResponse[];
    /**
     ...
     */
    ingressSettings?: outputs.appplatform.v20221101preview.IngressSettingsResponse;
    /**
     * Collection of loaded certificates
     */
    loadedCertificates?: outputs.appplatform.v20221101preview.LoadedCertificateResponse[];
    /**
     * Persistent disk settings
     */
    persistentDisk?: outputs.appplatform.v20221101preview.PersistentDiskResponse;
    /**
     ...
     */
    temporaryDisk?: outputs.appplatform.v20221101preview.TemporaryDiskResponse;
    /**
     * URL of the App
     */
    url: string;
     ...
     */
    vnetAddons?: outputs.appplatform.v20221101preview.AppVNetAddonsResponse;
}
/**
...
export function appResourcePropertiesResponseProvideDefaults(val: AppResourcePropertiesResponse): AppResourcePropertiesResponse {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        temporaryDisk: (val.temporaryDisk ? outputs.appplatform.v20221101preview.temporaryDiskResponseProvideDefaults(val.temporaryDisk) : undefined),
        vnetAddons: (val.vnetAddons ? outputs.appplatform.v20221101preview.appVNetAddonsResponseProvideDefaults(val.vnetAddons) : undefined),
    };
}
...
export interface ApplicationAcceleratorComponentResponse {
    instances: outputs.appplatform.v20221101preview.ApplicationAcceleratorInstanceResponse[];
    name: string;
    resourceRequests?: outputs.appplatform.v20221101preview.ApplicationAcceleratorResourceRequestsResponse;
}
...
export interface ApplicationAcceleratorPropertiesResponse {
     ...
     */
    components: outputs.appplatform.v20221101preview.ApplicationAcceleratorComponentResponse[];
    /**
...
export interface ApplicationLiveViewComponentResponse {
     ...
     */
    instances: outputs.appplatform.v20221101preview.ApplicationLiveViewInstanceResponse[];
    /**
     ...
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests: outputs.appplatform.v20221101preview.ApplicationLiveViewResourceRequestsResponse;
}
...
export interface ApplicationLiveViewPropertiesResponse {
     ...
     */
    components: outputs.appplatform.v20221101preview.ApplicationLiveViewComponentResponse[];
    /**
...
export interface BuildServiceAgentPoolPropertiesResponse {
     ...
     */
    poolSize?: outputs.appplatform.v20221101preview.BuildServiceAgentPoolSizePropertiesResponse;
    /**
...
export interface BuilderPropertiesResponse {
     ...
     */
    buildpackGroups?: outputs.appplatform.v20221101preview.BuildpacksGroupPropertiesResponse[];
    /**
     ...
     */
    stack?: outputs.appplatform.v20221101preview.StackPropertiesResponse;
}
...
export interface BuildpackBindingPropertiesResponse {
     ...
     */
    launchProperties?: outputs.appplatform.v20221101preview.BuildpackBindingLaunchPropertiesResponse;
    /**
...
export interface BuildpacksGroupPropertiesResponse {
     ...
     */
    buildpacks?: outputs.appplatform.v20221101preview.BuildpackPropertiesResponse[];
    /**
...
export interface ClusterResourcePropertiesResponse {
     ...
     */
    marketplaceResource?: outputs.appplatform.v20221101preview.MarketplaceResourceResponse;
    /**
     * Network profile of the Service
     */
    networkProfile?: outputs.appplatform.v20221101preview.NetworkProfileResponse;
    /**
     ...
     */
    vnetAddons?: outputs.appplatform.v20221101preview.ServiceVNetAddonsResponse;
...
export function clusterResourcePropertiesResponseProvideDefaults(val: ClusterResourcePropertiesResponse): ClusterResourcePropertiesResponse {
    return {
        ...val,
        vnetAddons: (val.vnetAddons ? outputs.appplatform.v20221101preview.serviceVNetAddonsResponseProvideDefaults(val.vnetAddons) : undefined),
...
export interface ConfigServerGitPropertyResponse {
     ...
     * Repositories of git.
     */
    repositories?: outputs.appplatform.v20221101preview.GitPatternRepositoryResponse[];
    /**
...
export interface ConfigServerPropertiesResponse {
     ...
     */
    configServer?: outputs.appplatform.v20221101preview.ConfigServerSettingsResponse;
    /**
     * Error when apply config server settings.
     */
    error?: outputs.appplatform.v20221101preview.ErrorResponse;
    /**
...
export interface ConfigServerSettingsResponse {
     ...
     */
    gitProperty?: outputs.appplatform.v20221101preview.ConfigServerGitPropertyResponse;
}
...
export interface ConfigurationServiceGitPropertyResponse {
     ...
     */
    repositories?: outputs.appplatform.v20221101preview.ConfigurationServiceGitRepositoryResponse[];
}
...
export interface ConfigurationServicePropertiesResponse {
     ...
     */
    instances: outputs.appplatform.v20221101preview.ConfigurationServiceInstanceResponse[];
    /**
     ...
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests: outputs.appplatform.v20221101preview.ConfigurationServiceResourceRequestsResponse;
    /**
     * The settings of Application Configuration Service.
     */
    settings?: outputs.appplatform.v20221101preview.ConfigurationServiceSettingsResponse;
}
...
export interface ConfigurationServiceSettingsResponse {
     ...
     * Property of git environment.
     */
    gitProperty?: outputs.appplatform.v20221101preview.ConfigurationServiceGitPropertyResponse;
}
...
export interface CustomContainerResponse {
     ...
     */
    imageRegistryCredential?: outputs.appplatform.v20221101preview.ImageRegistryCredentialResponse;
    /**
...
export interface CustomContainerUserSourceInfoResponse {
     ...
     * Custom container payload
     */
    customContainer?: outputs.appplatform.v20221101preview.CustomContainerResponse;
    /**
     * Type of the source uploaded
...
export interface CustomPersistentDiskResourceResponse {
     ...
     */
    customPersistentDiskProperties?: outputs.appplatform.v20221101preview.AzureFileVolumeResponse;
    /**
...
export interface CustomizedAcceleratorPropertiesResponse {
    ...
    description?: string;
    displayName?: string;
    gitRepository: outputs.appplatform.v20221101preview.AcceleratorGitRepositoryResponse;
    iconUrl?: string;
    /**
...
export interface DeploymentResourcePropertiesResponse {
     ...
     */
    deploymentSettings?: outputs.appplatform.v20221101preview.DeploymentSettingsResponse;
    /**
     * Collection of instances belong to the Deployment
     */
    instances: outputs.appplatform.v20221101preview.DeploymentInstanceResponse[];
    /**
     ...
     */
    source?: outputs.appplatform.v20221101preview.BuildResultUserSourceInfoResponse | outputs.appplatform.v20221101preview.CustomContainerUserSourceInfoResponse | outputs.appplatform.v20221101preview.JarUploadedUserSourceInfoResponse | outputs.appplatform.v20221101preview.NetCoreZipUploadedUserSourceInfoResponse | outputs.appplatform.v20221101preview.SourceUploadedUserSourceInfoResponse | outputs.appplatform.v20221101preview.UploadedUserSourceInfoResponse;
    /**
...
export function deploymentResourcePropertiesResponseProvideDefaults(val: DeploymentResourcePropertiesResponse): DeploymentResourcePropertiesResponse {
    return {
        ...val,
        deploymentSettings: (val.deploymentSettings ? outputs.appplatform.v20221101preview.deploymentSettingsResponseProvideDefaults(val.deploymentSettings) : undefined),
    };
}
...
export interface DeploymentSettingsResponse {
     ...
     * Container liveness and readiness probe settings
     */
    containerProbeSettings?: outputs.appplatform.v20221101preview.ContainerProbeSettingsResponse;
    /**
     ...
     */
    livenessProbe?: outputs.appplatform.v20221101preview.ProbeResponse;
    /**
     ...
     */
    readinessProbe?: outputs.appplatform.v20221101preview.ProbeResponse;
    /**
     ...
     */
    resourceRequests?: outputs.appplatform.v20221101preview.ResourceRequestsResponse;
    /**
     ...
     */
    startupProbe?: outputs.appplatform.v20221101preview.ProbeResponse;
    /**
...
export function deploymentSettingsResponseProvideDefaults(val: DeploymentSettingsResponse): DeploymentSettingsResponse {
    return {
        ...val,
        livenessProbe: (val.livenessProbe ? outputs.appplatform.v20221101preview.probeResponseProvideDefaults(val.livenessProbe) : undefined),
        readinessProbe: (val.readinessProbe ? outputs.appplatform.v20221101preview.probeResponseProvideDefaults(val.readinessProbe) : undefined),
        startupProbe: (val.startupProbe ? outputs.appplatform.v20221101preview.probeResponseProvideDefaults(val.startupProbe) : undefined),
...
export interface DevToolPortalFeatureSettingsResponse {
     ...
     */
    applicationAccelerator?: outputs.appplatform.v20221101preview.DevToolPortalFeatureDetailResponse;
    /**
     * Detail of App Live View plugin
     */
    applicationLiveView?: outputs.appplatform.v20221101preview.DevToolPortalFeatureDetailResponse;
}
/**
...
export function devToolPortalFeatureSettingsResponseProvideDefaults(val: DevToolPortalFeatureSettingsResponse): DevToolPortalFeatureSettingsResponse {
    return {
        ...val,
        applicationAccelerator: (val.applicationAccelerator ? outputs.appplatform.v20221101preview.devToolPortalFeatureDetailResponseProvideDefaults(val.applicationAccelerator) : undefined),
        applicationLiveView: (val.applicationLiveView ? outputs.appplatform.v20221101preview.devToolPortalFeatureDetailResponseProvideDefaults(val.applicationLiveView) : undefined),
    };
}
...
export interface DevToolPortalPropertiesResponse {
     ...
     * Settings for Dev Tool Portal
     */
    features?: outputs.appplatform.v20221101preview.DevToolPortalFeatureSettingsResponse;
    /**
     * Collection of instances belong to Dev Tool Portal.
     */
    instances: outputs.appplatform.v20221101preview.DevToolPortalInstanceResponse[];
    /**
     ...
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests: outputs.appplatform.v20221101preview.DevToolPortalResourceRequestsResponse;
    /**
     * Single sign-on related configuration
     */
    ssoProperties?: outputs.appplatform.v20221101preview.DevToolPortalSsoPropertiesResponse;
    /**
...
export function devToolPortalPropertiesResponseProvideDefaults(val: DevToolPortalPropertiesResponse): DevToolPortalPropertiesResponse {
    return {
        ...val,
        features: (val.features ? outputs.appplatform.v20221101preview.devToolPortalFeatureSettingsResponseProvideDefaults(val.features) : undefined),
        public: (val.public) ?? false,
    };
}
...
export interface GatewayOperatorPropertiesResponse {
     ...
     */
    instances: outputs.appplatform.v20221101preview.GatewayInstanceResponse[];
    /**
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests: outputs.appplatform.v20221101preview.GatewayOperatorResourceRequestsResponse;
}
...
export interface GatewayPropertiesResponse {
     ...
     * API metadata property for Spring Cloud Gateway
     */
    apiMetadataProperties?: outputs.appplatform.v20221101preview.GatewayApiMetadataPropertiesResponse;
    /**
     ...
     * Cross-Origin Resource Sharing property
     */
    corsProperties?: outputs.appplatform.v20221101preview.GatewayCorsPropertiesResponse;
    /**
     * Environment variables of Spring Cloud Gateway
     */
    environmentVariables?: outputs.appplatform.v20221101preview.GatewayPropertiesResponseEnvironmentVariables;
    /**
     * Indicate if only https is allowed.
     */
    httpsOnly?: boolean;
     ...
     * Properties of the Spring Cloud Gateway Operator.
     */
    operatorProperties: outputs.appplatform.v20221101preview.GatewayOperatorPropertiesResponse;
    /**
     ...
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests?: outputs.appplatform.v20221101preview.GatewayResourceRequestsResponse;
    /**
     * Single sign-on related configuration
     */
    ssoProperties?: outputs.appplatform.v20221101preview.SsoPropertiesResponse;
...
export function gatewayPropertiesResponseProvideDefaults(val: GatewayPropertiesResponse): GatewayPropertiesResponse {
    return {
        ...
        httpsOnly: (val.httpsOnly) ?? false,
        public: (val.public) ?? false,
        resourceRequests: (val.resourceRequests ? outputs.appplatform.v20221101preview.gatewayResourceRequestsResponseProvideDefaults(val.resourceRequests) : undefined),
    };
}
...
export interface GatewayRouteConfigPropertiesResponse {
     ...
     * OpenAPI properties of Spring Cloud Gateway route config.
     */
    openApi?: outputs.appplatform.v20221101preview.GatewayRouteConfigOpenApiPropertiesResponse;
    /**
     ...
     */
    routes?: outputs.appplatform.v20221101preview.GatewayApiRouteResponse[];
    /**
...
export interface IngressSettingsResponse {
     ...
     */
    clientAuth?: outputs.appplatform.v20221101preview.IngressSettingsResponseClientAuth;
    /**
     * Ingress read time out in seconds.
     */
    readTimeoutInSeconds?: number;
...
export interface ManagedIdentityPropertiesResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.appplatform.v20221101preview.UserAssignedManagedIdentityResponse};
}
...
export interface MonitoringSettingPropertiesResponse {
     ...
     */
    appInsightsAgentVersions?: outputs.appplatform.v20221101preview.ApplicationInsightsAgentVersionsResponse;
    /**
...
export interface NetworkProfileResponse {
     ...
     * Ingress configuration payload for Azure Spring Apps resource.
     */
    ingressConfig?: outputs.appplatform.v20221101preview.IngressConfigResponse;
    /**
     * Desired outbound IP resources for Azure Spring Apps resource.
     */
    outboundIPs: outputs.appplatform.v20221101preview.NetworkProfileResponseOutboundIPs;
    /**
     ...
     */
    requiredTraffics: outputs.appplatform.v20221101preview.RequiredTrafficResponse[];
    /**
...
export interface ProbeResponse {
     ...
     */
    probeAction?: outputs.appplatform.v20221101preview.ExecActionResponse | outputs.appplatform.v20221101preview.HTTPGetActionResponse | outputs.appplatform.v20221101preview.TCPSocketActionResponse;
    /**
...
export interface ServiceRegistryPropertiesResponse {
     ...
     */
    instances: outputs.appplatform.v20221101preview.ServiceRegistryInstanceResponse[];
    /**
     ...
     * The requested resource quantity for required CPU and Memory.
     */
    resourceRequests: outputs.appplatform.v20221101preview.ServiceRegistryResourceRequestsResponse;
}
