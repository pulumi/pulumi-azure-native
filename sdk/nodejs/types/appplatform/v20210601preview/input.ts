...
export interface AppResourcePropertiesArgs {
     ...
     */
    persistentDisk?: pulumi.Input<inputs.appplatform.v20210601preview.PersistentDiskArgs>;
    /**
     ...
     */
    temporaryDisk?: pulumi.Input<inputs.appplatform.v20210601preview.TemporaryDiskArgs>;
}
/**
...
export function appResourcePropertiesArgsProvideDefaults(val: AppResourcePropertiesArgs): AppResourcePropertiesArgs {
    return {
        ...
        temporaryDisk: (val.temporaryDisk ? pulumi.output(val.temporaryDisk).apply(inputs.appplatform.v20210601preview.temporaryDiskArgsProvideDefaults) : undefined),
    };
}
...
export interface ClusterResourcePropertiesArgs {
     ...
     */
    networkProfile?: pulumi.Input<inputs.appplatform.v20210601preview.NetworkProfileArgs>;
}
...
export interface ConfigServerGitPropertyArgs {
     ...
     * Repositories of git.
     */
    repositories?: pulumi.Input<pulumi.Input<inputs.appplatform.v20210601preview.GitPatternRepositoryArgs>[]>;
    /**
...
export interface ConfigServerPropertiesArgs {
     ...
     */
    configServer?: pulumi.Input<inputs.appplatform.v20210601preview.ConfigServerSettingsArgs>;
    /**
     * Error when apply config server settings.
     */
    error?: pulumi.Input<inputs.appplatform.v20210601preview.ErrorArgs>;
}
...
export interface ConfigServerSettingsArgs {
     ...
     */
    gitProperty?: pulumi.Input<inputs.appplatform.v20210601preview.ConfigServerGitPropertyArgs>;
}
...
export interface CustomContainerArgs {
     ...
     */
    imageRegistryCredential?: pulumi.Input<inputs.appplatform.v20210601preview.ImageRegistryCredentialArgs>;
    /**
...
export interface DeploymentResourcePropertiesArgs {
     ...
     */
    deploymentSettings?: pulumi.Input<inputs.appplatform.v20210601preview.DeploymentSettingsArgs>;
    /**
     * Uploaded source information of the deployment.
     */
    source?: pulumi.Input<inputs.appplatform.v20210601preview.UserSourceInfoArgs>;
}
/**
...
export function deploymentResourcePropertiesArgsProvideDefaults(val: DeploymentResourcePropertiesArgs): DeploymentResourcePropertiesArgs {
    return {
        ...val,
        deploymentSettings: (val.deploymentSettings ? pulumi.output(val.deploymentSettings).apply(inputs.appplatform.v20210601preview.deploymentSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface DeploymentSettingsArgs {
     ...
     */
    resourceRequests?: pulumi.Input<inputs.appplatform.v20210601preview.ResourceRequestsArgs>;
    /**
     * Runtime version
     */
    runtimeVersion?: pulumi.Input<string | enums.appplatform.v20210601preview.RuntimeVersion>;
}
/**
...
export interface ManagedIdentityPropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.appplatform.v20210601preview.ManagedIdentityType>;
}
...
export interface UserSourceInfoArgs {
     ...
     * Custom container payload
     */
    customContainer?: pulumi.Input<inputs.appplatform.v20210601preview.CustomContainerArgs>;
    /**
     ...
     */
    type?: pulumi.Input<string | enums.appplatform.v20210601preview.UserSourceType>;
    /**
