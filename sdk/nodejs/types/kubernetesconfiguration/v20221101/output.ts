...
export interface AzureBlobDefinitionResponse {
     ...
     */
    managedIdentity?: outputs.kubernetesconfiguration.v20221101.ManagedIdentityDefinitionResponse;
    /**
     ...
     */
    servicePrincipal?: outputs.kubernetesconfiguration.v20221101.ServicePrincipalDefinitionResponse;
    /**
...
export function azureBlobDefinitionResponseProvideDefaults(val: AzureBlobDefinitionResponse): AzureBlobDefinitionResponse {
    return {
        ...val,
        servicePrincipal: (val.servicePrincipal ? outputs.kubernetesconfiguration.v20221101.servicePrincipalDefinitionResponseProvideDefaults(val.servicePrincipal) : undefined),
...
export interface ErrorDetailResponse {
     ...
     */
    additionalInfo: outputs.kubernetesconfiguration.v20221101.ErrorAdditionalInfoResponse[];
    /**
     * The error code.
     */
    code: string;
     ...
     * The error details.
     */
    details: outputs.kubernetesconfiguration.v20221101.ErrorDetailResponse[];
    /**
     * The error message.
     */
    message: string;
...
export interface GitRepositoryDefinitionResponse {
     ...
     */
    repositoryRef?: outputs.kubernetesconfiguration.v20221101.RepositoryRefDefinitionResponse;
    /**
...
export interface HelmReleasePropertiesDefinitionResponse {
     ...
     */
    helmChartRef?: outputs.kubernetesconfiguration.v20221101.ObjectReferenceDefinitionResponse;
    /**
...
export interface ObjectStatusDefinitionResponse {
     ...
     */
    appliedBy?: outputs.kubernetesconfiguration.v20221101.ObjectReferenceDefinitionResponse;
    /**
     ...
     */
    helmReleaseProperties?: outputs.kubernetesconfiguration.v20221101.HelmReleasePropertiesDefinitionResponse;
    /**
     ...
     */
    statusConditions?: outputs.kubernetesconfiguration.v20221101.ObjectStatusConditionDefinitionResponse[];
}
...
export interface ScopeResponse {
     ...
     * Specifies that the scope of the extension is Cluster
     */
    cluster?: outputs.kubernetesconfiguration.v20221101.ScopeClusterResponse;
    /**
     * Specifies that the scope of the extension is Namespace
     */
    namespace?: outputs.kubernetesconfiguration.v20221101.ScopeNamespaceResponse;
}
