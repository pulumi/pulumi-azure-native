...
export interface IdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.migrate.v20210101.ResourceIdentityType>;
}
...
export interface LBFrontendIPConfigurationResourceSettingsArgs {
     ...
     */
    subnet?: pulumi.Input<inputs.migrate.v20210101.SubnetReferenceArgs>;
    /**
...
export interface LoadBalancerResourceSettingsArgs {
     ...
     */
    backendAddressPools?: pulumi.Input<pulumi.Input<inputs.migrate.v20210101.LBBackendAddressPoolResourceSettingsArgs>[]>;
    /**
     * Gets or sets the frontend IP configurations of the load balancer.
     */
    frontendIPConfigurations?: pulumi.Input<pulumi.Input<inputs.migrate.v20210101.LBFrontendIPConfigurationResourceSettingsArgs>[]>;
    /**
     * The resource type. For example, the value can be Microsoft.Compute/virtualMachines.
...
export interface MoveResourcePropertiesArgs {
     ...
     */
    dependsOnOverrides?: pulumi.Input<pulumi.Input<inputs.migrate.v20210101.MoveResourceDependencyOverrideArgs>[]>;
    /**
     ...
     */
    resourceSettings?: pulumi.Input<inputs.migrate.v20210101.AvailabilitySetResourceSettingsArgs | inputs.migrate.v20210101.DiskEncryptionSetResourceSettingsArgs | inputs.migrate.v20210101.KeyVaultResourceSettingsArgs | inputs.migrate.v20210101.LoadBalancerResourceSettingsArgs | inputs.migrate.v20210101.NetworkInterfaceResourceSettingsArgs | inputs.migrate.v20210101.NetworkSecurityGroupResourceSettingsArgs | inputs.migrate.v20210101.PublicIPAddressResourceSettingsArgs | inputs.migrate.v20210101.ResourceGroupResourceSettingsArgs | inputs.migrate.v20210101.SqlDatabaseResourceSettingsArgs | inputs.migrate.v20210101.SqlElasticPoolResourceSettingsArgs | inputs.migrate.v20210101.SqlServerResourceSettingsArgs | inputs.migrate.v20210101.VirtualMachineResourceSettingsArgs | inputs.migrate.v20210101.VirtualNetworkResourceSettingsArgs>;
    /**
...
export interface NetworkInterfaceResourceSettingsArgs {
     ...
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.migrate.v20210101.NicIpConfigurationResourceSettingsArgs>[]>;
    /**
     * The resource type. For example, the value can be Microsoft.Compute/virtualMachines.
...
export interface NetworkSecurityGroupResourceSettingsArgs {
     ...
     */
    securityRules?: pulumi.Input<pulumi.Input<inputs.migrate.v20210101.NsgSecurityRuleArgs>[]>;
    /**
     * Gets or sets the target Resource name.
     */
    targetResourceName: pulumi.Input<string>;
...
export interface NicIpConfigurationResourceSettingsArgs {
     ...
     */
    loadBalancerBackendAddressPools?: pulumi.Input<pulumi.Input<inputs.migrate.v20210101.LoadBalancerBackendAddressPoolReferenceArgs>[]>;
    /**
     * Gets or sets the references of the load balancer NAT rules.
     */
    loadBalancerNatRules?: pulumi.Input<pulumi.Input<inputs.migrate.v20210101.LoadBalancerNatRuleReferenceArgs>[]>;
    /**
     ...
     */
    publicIp?: pulumi.Input<inputs.migrate.v20210101.PublicIpReferenceArgs>;
    /**
     * Defines reference to subnet.
     */
    subnet?: pulumi.Input<inputs.migrate.v20210101.SubnetReferenceArgs>;
...
export interface SqlDatabaseResourceSettingsArgs {
     ...
     */
    zoneRedundant?: pulumi.Input<string | enums.migrate.v20210101.ZoneRedundant>;
}
...
export interface SubnetResourceSettingsArgs {
     ...
     * Defines reference to NSG.
     */
    networkSecurityGroup?: pulumi.Input<inputs.migrate.v20210101.NsgReferenceArgs>;
}
...
export interface VirtualMachineResourceSettingsArgs {
     ...
     */
    targetAvailabilityZone?: pulumi.Input<string | enums.migrate.v20210101.TargetAvailabilityZone>;
    /**
     * Gets or sets the target Resource name.
     */
    targetResourceName: pulumi.Input<string>;
...
export interface VirtualNetworkResourceSettingsArgs {
     ...
     */
    subnets?: pulumi.Input<pulumi.Input<inputs.migrate.v20210101.SubnetResourceSettingsArgs>[]>;
    /**
     * Gets or sets the target Resource name.
     */
    targetResourceName: pulumi.Input<string>;
