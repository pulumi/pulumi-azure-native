...
export interface IdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.migrate.v20210801.ResourceIdentityType>;
}
...
export interface LBFrontendIPConfigurationResourceSettingsArgs {
     ...
     */
    subnet?: pulumi.Input<inputs.migrate.v20210801.SubnetReferenceArgs>;
    /**
...
export interface LoadBalancerResourceSettingsArgs {
     ...
     */
    backendAddressPools?: pulumi.Input<pulumi.Input<inputs.migrate.v20210801.LBBackendAddressPoolResourceSettingsArgs>[]>;
    /**
     * Gets or sets the frontend IP configurations of the load balancer.
     */
    frontendIPConfigurations?: pulumi.Input<pulumi.Input<inputs.migrate.v20210801.LBFrontendIPConfigurationResourceSettingsArgs>[]>;
    /**
     * The resource type. For example, the value can be Microsoft.Compute/virtualMachines.
...
export interface MoveResourcePropertiesArgs {
     ...
     */
    dependsOnOverrides?: pulumi.Input<pulumi.Input<inputs.migrate.v20210801.MoveResourceDependencyOverrideArgs>[]>;
    /**
     ...
     */
    resourceSettings?: pulumi.Input<inputs.migrate.v20210801.AvailabilitySetResourceSettingsArgs | inputs.migrate.v20210801.DiskEncryptionSetResourceSettingsArgs | inputs.migrate.v20210801.KeyVaultResourceSettingsArgs | inputs.migrate.v20210801.LoadBalancerResourceSettingsArgs | inputs.migrate.v20210801.NetworkInterfaceResourceSettingsArgs | inputs.migrate.v20210801.NetworkSecurityGroupResourceSettingsArgs | inputs.migrate.v20210801.PublicIPAddressResourceSettingsArgs | inputs.migrate.v20210801.ResourceGroupResourceSettingsArgs | inputs.migrate.v20210801.SqlDatabaseResourceSettingsArgs | inputs.migrate.v20210801.SqlElasticPoolResourceSettingsArgs | inputs.migrate.v20210801.SqlServerResourceSettingsArgs | inputs.migrate.v20210801.VirtualMachineResourceSettingsArgs | inputs.migrate.v20210801.VirtualNetworkResourceSettingsArgs>;
    /**
...
export interface NetworkInterfaceResourceSettingsArgs {
     ...
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.migrate.v20210801.NicIpConfigurationResourceSettingsArgs>[]>;
    /**
     * The resource type. For example, the value can be Microsoft.Compute/virtualMachines.
...
export interface NetworkSecurityGroupResourceSettingsArgs {
     ...
     */
    securityRules?: pulumi.Input<pulumi.Input<inputs.migrate.v20210801.NsgSecurityRuleArgs>[]>;
    /**
     * Gets or sets the Resource tags.
     */
    tags?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
...
export interface NicIpConfigurationResourceSettingsArgs {
     ...
     */
    loadBalancerBackendAddressPools?: pulumi.Input<pulumi.Input<inputs.migrate.v20210801.LoadBalancerBackendAddressPoolReferenceArgs>[]>;
    /**
     * Gets or sets the references of the load balancer NAT rules.
     */
    loadBalancerNatRules?: pulumi.Input<pulumi.Input<inputs.migrate.v20210801.LoadBalancerNatRuleReferenceArgs>[]>;
    /**
     ...
     */
    publicIp?: pulumi.Input<inputs.migrate.v20210801.PublicIpReferenceArgs>;
    /**
     * Defines reference to subnet.
     */
    subnet?: pulumi.Input<inputs.migrate.v20210801.SubnetReferenceArgs>;
...
export interface SqlDatabaseResourceSettingsArgs {
     ...
     */
    zoneRedundant?: pulumi.Input<string | enums.migrate.v20210801.ZoneRedundant>;
}
...
export interface SubnetResourceSettingsArgs {
     ...
     * Defines reference to NSG.
     */
    networkSecurityGroup?: pulumi.Input<inputs.migrate.v20210801.NsgReferenceArgs>;
}
...
export interface VirtualMachineResourceSettingsArgs {
     ...
     */
    targetAvailabilityZone?: pulumi.Input<string | enums.migrate.v20210801.TargetAvailabilityZone>;
    /**
     * Gets or sets the target Resource name.
     */
    targetResourceName: pulumi.Input<string>;
...
export interface VirtualNetworkResourceSettingsArgs {
     ...
     */
    subnets?: pulumi.Input<pulumi.Input<inputs.migrate.v20210801.SubnetResourceSettingsArgs>[]>;
    /**
     * Gets or sets the Resource tags.
     */
    tags?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
