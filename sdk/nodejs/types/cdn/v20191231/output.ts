...
export interface CdnManagedHttpsParametersResponse {
     ...
     * Defines the certificate source parameters using CDN managed certificate for enabling SSL.
     */
    certificateSourceParameters: outputs.cdn.v20191231.CdnCertificateSourceParametersResponse;
    /**
...
export interface DeepCreatedOriginGroupResponse {
     ...
     */
    healthProbeSettings?: outputs.cdn.v20191231.HealthProbeParametersResponse;
    /**
     ...
     */
    origins: outputs.cdn.v20191231.ResourceReferenceResponse[];
    /**
     * The JSON object that contains the properties to determine origin health using real requests/responses.This property is currently not supported.
     */
    responseBasedOriginErrorDetectionSettings?: outputs.cdn.v20191231.ResponseBasedOriginErrorDetectionParametersResponse;
    /**
...
export interface DeliveryRuleCacheExpirationActionResponse {
     ...
     */
    parameters: outputs.cdn.v20191231.CacheExpirationActionParametersResponse;
}
...
export interface DeliveryRuleCacheKeyQueryStringActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20191231.CacheKeyQueryStringActionParametersResponse;
}
...
export interface DeliveryRuleCookiesConditionResponse {
     ...
     */
    parameters: outputs.cdn.v20191231.CookiesMatchConditionParametersResponse;
}
...
export interface DeliveryRuleHttpVersionConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.HttpVersionMatchConditionParametersResponse;
}
...
export interface DeliveryRuleIsDeviceConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.IsDeviceMatchConditionParametersResponse;
}
...
export interface DeliveryRulePostArgsConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.PostArgsMatchConditionParametersResponse;
}
...
export interface DeliveryRuleQueryStringConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.QueryStringMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRemoteAddressConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.RemoteAddressMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestBodyConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.RequestBodyMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestHeaderActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20191231.HeaderActionParametersResponse;
}
...
export interface DeliveryRuleRequestHeaderConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.RequestHeaderMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestMethodConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.RequestMethodMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestSchemeConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.RequestSchemeMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestUriConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.RequestUriMatchConditionParametersResponse;
}
...
export interface DeliveryRuleResponse {
     ...
     */
    actions: (outputs.cdn.v20191231.DeliveryRuleCacheExpirationActionResponse | outputs.cdn.v20191231.DeliveryRuleCacheKeyQueryStringActionResponse | outputs.cdn.v20191231.DeliveryRuleRequestHeaderActionResponse | outputs.cdn.v20191231.DeliveryRuleResponseHeaderActionResponse | outputs.cdn.v20191231.OriginGroupOverrideActionResponse | outputs.cdn.v20191231.UrlRedirectActionResponse | outputs.cdn.v20191231.UrlRewriteActionResponse)[];
    /**
     * A list of conditions that must be matched for the actions to be executed
     */
    conditions?: (outputs.cdn.v20191231.DeliveryRuleCookiesConditionResponse | outputs.cdn.v20191231.DeliveryRuleHttpVersionConditionResponse | outputs.cdn.v20191231.DeliveryRuleIsDeviceConditionResponse | outputs.cdn.v20191231.DeliveryRulePostArgsConditionResponse | outputs.cdn.v20191231.DeliveryRuleQueryStringConditionResponse | outputs.cdn.v20191231.DeliveryRuleRemoteAddressConditionResponse | outputs.cdn.v20191231.DeliveryRuleRequestBodyConditionResponse | outputs.cdn.v20191231.DeliveryRuleRequestHeaderConditionResponse | outputs.cdn.v20191231.DeliveryRuleRequestMethodConditionResponse | outputs.cdn.v20191231.DeliveryRuleRequestSchemeConditionResponse | outputs.cdn.v20191231.DeliveryRuleRequestUriConditionResponse | outputs.cdn.v20191231.DeliveryRuleUrlFileExtensionConditionResponse | outputs.cdn.v20191231.DeliveryRuleUrlFileNameConditionResponse | outputs.cdn.v20191231.DeliveryRuleUrlPathConditionResponse)[];
    /**
     * Name of the rule
     */
    name?: string;
...
export interface DeliveryRuleUrlFileExtensionConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.UrlFileExtensionMatchConditionParametersResponse;
}
...
export interface DeliveryRuleUrlFileNameConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.UrlFileNameMatchConditionParametersResponse;
}
...
export interface DeliveryRuleUrlPathConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20191231.UrlPathMatchConditionParametersResponse;
}
...
export interface EndpointPropertiesUpdateParametersResponseDeliveryPolicy {
     ...
     */
    rules: outputs.cdn.v20191231.DeliveryRuleResponse[];
}
...
export interface OriginGroupOverrideActionParametersResponse {
     ...
     */
    originGroup: outputs.cdn.v20191231.ResourceReferenceResponse;
}
...
export interface OriginGroupOverrideActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20191231.OriginGroupOverrideActionParametersResponse;
}
...
export interface ResponseBasedOriginErrorDetectionParametersResponse {
     ...
     */
    httpErrorRanges?: outputs.cdn.v20191231.HttpErrorRangeParametersResponse[];
    /**
...
export interface UrlRedirectActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20191231.UrlRedirectActionParametersResponse;
}
...
export interface UrlRewriteActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20191231.UrlRewriteActionParametersResponse;
}
...
export interface UserManagedHttpsParametersResponse {
     ...
     * Defines the certificate source parameters using user's keyvault certificate for enabling SSL.
     */
    certificateSourceParameters: outputs.cdn.v20191231.KeyVaultCertificateSourceParametersResponse;
    /**
     * TLS protocol version that will be used for Https
     */
    minimumTlsVersion?: string;
