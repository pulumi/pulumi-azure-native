...
export interface CdnManagedHttpsParametersResponse {
     ...
     * Defines the certificate source parameters using CDN managed certificate for enabling SSL.
     */
    certificateSourceParameters: outputs.cdn.v20200331.CdnCertificateSourceParametersResponse;
    /**
...
export interface CustomRuleListResponse {
     ...
     * List of rules
     */
    rules?: outputs.cdn.v20200331.CustomRuleResponse[];
}
...
export interface CustomRuleResponse {
     ...
     */
    matchConditions: outputs.cdn.v20200331.MatchConditionResponse[];
    /**
...
export interface DeepCreatedOriginGroupResponse {
     ...
     */
    healthProbeSettings?: outputs.cdn.v20200331.HealthProbeParametersResponse;
    /**
     ...
     */
    origins: outputs.cdn.v20200331.ResourceReferenceResponse[];
    /**
     * The JSON object that contains the properties to determine origin health using real requests/responses.This property is currently not supported.
     */
    responseBasedOriginErrorDetectionSettings?: outputs.cdn.v20200331.ResponseBasedOriginErrorDetectionParametersResponse;
    /**
...
export interface DeliveryRuleCacheExpirationActionResponse {
     ...
     */
    parameters: outputs.cdn.v20200331.CacheExpirationActionParametersResponse;
}
...
export interface DeliveryRuleCacheKeyQueryStringActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20200331.CacheKeyQueryStringActionParametersResponse;
}
...
export interface DeliveryRuleCookiesConditionResponse {
     ...
     */
    parameters: outputs.cdn.v20200331.CookiesMatchConditionParametersResponse;
}
...
export interface DeliveryRuleHttpVersionConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.HttpVersionMatchConditionParametersResponse;
}
...
export interface DeliveryRuleIsDeviceConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.IsDeviceMatchConditionParametersResponse;
}
...
export interface DeliveryRulePostArgsConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.PostArgsMatchConditionParametersResponse;
}
...
export interface DeliveryRuleQueryStringConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.QueryStringMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRemoteAddressConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.RemoteAddressMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestBodyConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.RequestBodyMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestHeaderActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20200331.HeaderActionParametersResponse;
}
...
export interface DeliveryRuleRequestHeaderConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.RequestHeaderMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestMethodConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.RequestMethodMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestSchemeConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.RequestSchemeMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestUriConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.RequestUriMatchConditionParametersResponse;
}
...
export interface DeliveryRuleResponse {
     ...
     */
    actions: (outputs.cdn.v20200331.DeliveryRuleCacheExpirationActionResponse | outputs.cdn.v20200331.DeliveryRuleCacheKeyQueryStringActionResponse | outputs.cdn.v20200331.DeliveryRuleRequestHeaderActionResponse | outputs.cdn.v20200331.DeliveryRuleResponseHeaderActionResponse | outputs.cdn.v20200331.UrlRedirectActionResponse | outputs.cdn.v20200331.UrlRewriteActionResponse | outputs.cdn.v20200331.UrlSigningActionResponse)[];
    /**
     * A list of conditions that must be matched for the actions to be executed
     */
    conditions?: (outputs.cdn.v20200331.DeliveryRuleCookiesConditionResponse | outputs.cdn.v20200331.DeliveryRuleHttpVersionConditionResponse | outputs.cdn.v20200331.DeliveryRuleIsDeviceConditionResponse | outputs.cdn.v20200331.DeliveryRulePostArgsConditionResponse | outputs.cdn.v20200331.DeliveryRuleQueryStringConditionResponse | outputs.cdn.v20200331.DeliveryRuleRemoteAddressConditionResponse | outputs.cdn.v20200331.DeliveryRuleRequestBodyConditionResponse | outputs.cdn.v20200331.DeliveryRuleRequestHeaderConditionResponse | outputs.cdn.v20200331.DeliveryRuleRequestMethodConditionResponse | outputs.cdn.v20200331.DeliveryRuleRequestSchemeConditionResponse | outputs.cdn.v20200331.DeliveryRuleRequestUriConditionResponse | outputs.cdn.v20200331.DeliveryRuleUrlFileExtensionConditionResponse | outputs.cdn.v20200331.DeliveryRuleUrlFileNameConditionResponse | outputs.cdn.v20200331.DeliveryRuleUrlPathConditionResponse)[];
    /**
     * Name of the rule
     */
    name?: string;
...
export interface DeliveryRuleUrlFileExtensionConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.UrlFileExtensionMatchConditionParametersResponse;
}
...
export interface DeliveryRuleUrlFileNameConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.UrlFileNameMatchConditionParametersResponse;
}
...
export interface DeliveryRuleUrlPathConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20200331.UrlPathMatchConditionParametersResponse;
}
...
export interface EndpointPropertiesUpdateParametersResponseDeliveryPolicy {
     ...
     */
    rules: outputs.cdn.v20200331.DeliveryRuleResponse[];
}
...
export interface ManagedRuleGroupOverrideResponse {
     ...
     */
    rules?: outputs.cdn.v20200331.ManagedRuleOverrideResponse[];
}
...
export interface ManagedRuleSetListResponse {
     ...
     * List of rule sets.
     */
    managedRuleSets?: outputs.cdn.v20200331.ManagedRuleSetResponse[];
}
...
export interface ManagedRuleSetResponse {
     ...
     */
    ruleGroupOverrides?: outputs.cdn.v20200331.ManagedRuleGroupOverrideResponse[];
    /**
...
export interface RateLimitRuleListResponse {
     ...
     * List of rules
     */
    rules?: outputs.cdn.v20200331.RateLimitRuleResponse[];
}
...
export interface ResponseBasedOriginErrorDetectionParametersResponse {
     ...
     */
    httpErrorRanges?: outputs.cdn.v20200331.HttpErrorRangeParametersResponse[];
    /**
...
export interface UrlRedirectActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20200331.UrlRedirectActionParametersResponse;
}
...
export interface UrlRewriteActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20200331.UrlRewriteActionParametersResponse;
}
...
export interface UrlSigningActionParametersResponse {
     ...
     */
    parameterNameOverride?: outputs.cdn.v20200331.UrlSigningParamIdentifierResponse[];
}
...
export interface UrlSigningActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20200331.UrlSigningActionParametersResponse;
}
...
export interface UrlSigningKeyResponse {
     ...
     */
    keySourceParameters: outputs.cdn.v20200331.KeyVaultSigningKeyParametersResponse;
}
...
export interface UserManagedHttpsParametersResponse {
     ...
     * Defines the certificate source parameters using user's keyvault certificate for enabling SSL.
     */
    certificateSourceParameters: outputs.cdn.v20200331.KeyVaultCertificateSourceParametersResponse;
    /**
     * TLS protocol version that will be used for Https
     */
    minimumTlsVersion?: string;
