...
export interface AFDDomainHttpsParametersArgs {
     ...
     */
    certificateType: pulumi.Input<string | enums.cdn.v20200901.AfdCertificateType>;
    /**
     * TLS protocol version that will be used for Https
     */
    minimumTlsVersion?: pulumi.Input<enums.cdn.v20200901.AfdMinimumTlsVersion>;
    /**
     * Resource reference to the secret. ie. subs/rg/profile/secret
     */
    secret?: pulumi.Input<inputs.cdn.v20200901.ResourceReferenceArgs>;
}
...
export interface CacheExpirationActionParametersArgs {
     ...
     */
    cacheBehavior: pulumi.Input<string | enums.cdn.v20200901.CacheBehavior>;
    /**
     ...
     */
    cacheType: pulumi.Input<string | enums.cdn.v20200901.CacheType>;
...
export interface CacheKeyQueryStringActionParametersArgs {
     ...
     * Caching behavior for the requests
     */
    queryStringBehavior: pulumi.Input<string | enums.cdn.v20200901.QueryStringBehavior>;
}
...
export interface CookiesMatchConditionParametersArgs {
     ...
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.CookiesOperator>;
    /**
     ...
     * List of transforms
     */
    transforms?: pulumi.Input<pulumi.Input<string | enums.cdn.v20200901.Transform>[]>;
}
...
export interface CustomRuleArgs {
     ...
     */
    action: pulumi.Input<string | enums.cdn.v20200901.ActionType>;
    /**
     * Describes if the custom rule is in enabled or disabled state. Defaults to Enabled if not specified.
     */
    enabledState?: pulumi.Input<string | enums.cdn.v20200901.CustomRuleEnabledState>;
    /**
     * List of match conditions.
     */
    matchConditions: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.MatchConditionArgs>[]>;
    /**
...
export interface CustomRuleListArgs {
     ...
     * List of rules
     */
    rules?: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.CustomRuleArgs>[]>;
}
...
export interface CustomerCertificateParametersArgs {
     ...
     */
    secretSource: pulumi.Input<inputs.cdn.v20200901.ResourceReferenceArgs>;
    /**
...
export interface DeepCreatedOriginGroupArgs {
     ...
     */
    origins: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.ResourceReferenceArgs>[]>;
    /**
     * The JSON object that contains the properties to determine origin health using real requests/responses.This property is currently not supported.
     */
    responseBasedOriginErrorDetectionSettings?: pulumi.Input<inputs.cdn.v20200901.ResponseBasedOriginErrorDetectionParametersArgs>;
    /**
...
export interface DeliveryRuleCacheExpirationActionArgs {
     ...
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.CacheExpirationActionParametersArgs>;
}
...
export interface DeliveryRuleCacheKeyQueryStringActionArgs {
     ...
     * Defines the parameters for the action.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.CacheKeyQueryStringActionParametersArgs>;
}
...
export interface DeliveryRuleCookiesConditionArgs {
     ...
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.CookiesMatchConditionParametersArgs>;
}
...
export interface DeliveryRuleHttpVersionConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.HttpVersionMatchConditionParametersArgs>;
}
...
export interface DeliveryRuleIsDeviceConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.IsDeviceMatchConditionParametersArgs>;
}
...
export interface DeliveryRulePostArgsConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.PostArgsMatchConditionParametersArgs>;
}
...
export interface DeliveryRuleQueryStringConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.QueryStringMatchConditionParametersArgs>;
}
...
export interface DeliveryRuleRemoteAddressConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.RemoteAddressMatchConditionParametersArgs>;
}
...
export interface DeliveryRuleRequestBodyConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.RequestBodyMatchConditionParametersArgs>;
}
...
export interface DeliveryRuleRequestHeaderActionArgs {
     ...
     * Defines the parameters for the action.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.HeaderActionParametersArgs>;
}
...
export interface DeliveryRuleRequestHeaderConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.RequestHeaderMatchConditionParametersArgs>;
}
...
export interface DeliveryRuleRequestMethodConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.RequestMethodMatchConditionParametersArgs>;
}
...
export interface DeliveryRuleRequestSchemeConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.RequestSchemeMatchConditionParametersArgs>;
}
...
export interface DeliveryRuleRequestUriConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.RequestUriMatchConditionParametersArgs>;
}
...
export interface DeliveryRuleUrlFileExtensionConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.UrlFileExtensionMatchConditionParametersArgs>;
}
...
export interface DeliveryRuleUrlFileNameConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.UrlFileNameMatchConditionParametersArgs>;
}
...
export interface DeliveryRuleUrlPathConditionArgs {
     ...
     * Defines the parameters for the condition.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.UrlPathMatchConditionParametersArgs>;
}
...
export interface EndpointPropertiesUpdateParametersDeliveryPolicyArgs {
     ...
     */
    rules: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.DeliveryRuleArgs>[]>;
}
...
export interface GeoFilterArgs {
     ...
     */
    action: pulumi.Input<enums.cdn.v20200901.GeoFilterActions>;
    /**
...
export interface HeaderActionParametersArgs {
     ...
     * Action to perform
     */
    headerAction: pulumi.Input<string | enums.cdn.v20200901.HeaderAction>;
    /**
...
export interface HealthProbeParametersArgs {
     ...
     */
    probeProtocol?: pulumi.Input<enums.cdn.v20200901.ProbeProtocol>;
    /**
     * The type of health probe request that is made.
     */
    probeRequestType?: pulumi.Input<enums.cdn.v20200901.HealthProbeRequestType>;
}
...
export interface HttpVersionMatchConditionParametersArgs {
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.HttpVersionOperator>;
}
...
export interface IsDeviceMatchConditionParametersArgs {
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.IsDeviceOperator>;
    /**
     * List of transforms
     */
    transforms?: pulumi.Input<pulumi.Input<string | enums.cdn.v20200901.Transform>[]>;
...
export interface ManagedRuleGroupOverrideArgs {
     ...
     */
    rules?: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.ManagedRuleOverrideArgs>[]>;
}
...
export interface ManagedRuleOverrideArgs {
     ...
     */
    enabledState?: pulumi.Input<string | enums.cdn.v20200901.ManagedRuleEnabledState>;
    /**
...
export interface ManagedRuleSetArgs {
     ...
     */
    ruleGroupOverrides?: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.ManagedRuleGroupOverrideArgs>[]>;
    /**
...
export interface ManagedRuleSetListArgs {
     ...
     * List of rule sets.
     */
    managedRuleSets?: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.ManagedRuleSetArgs>[]>;
}
...
export interface MatchConditionArgs {
     ...
     */
    matchVariable: pulumi.Input<string | enums.cdn.v20200901.MatchVariable>;
    /**
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.Operator>;
    /**
     ...
     * List of transforms.
     */
    transforms?: pulumi.Input<pulumi.Input<string | enums.cdn.v20200901.TransformType>[]>;
}
...
export interface OriginGroupOverrideActionArgs {
     ...
     * Defines the parameters for the action.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.OriginGroupOverrideActionParametersArgs>;
}
...
export interface PolicySettingsArgs {
     ...
     */
    enabledState?: pulumi.Input<string | enums.cdn.v20200901.PolicyEnabledState>;
    /**
     * Describes if it is in detection mode or prevention mode at policy level.
     */
    mode?: pulumi.Input<string | enums.cdn.v20200901.PolicyMode>;
}
...
export interface PostArgsMatchConditionParametersArgs {
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.PostArgsOperator>;
    /**
...
export interface QueryStringMatchConditionParametersArgs {
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.QueryStringOperator>;
    /**
     * List of transforms
     */
    transforms?: pulumi.Input<pulumi.Input<string | enums.cdn.v20200901.Transform>[]>;
...
export interface RateLimitRuleListArgs {
     ...
     * List of rules
     */
    rules?: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.RateLimitRuleArgs>[]>;
}
...
export interface RemoteAddressMatchConditionParametersArgs {
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.RemoteAddressOperator>;
    /**
     * List of transforms
     */
    transforms?: pulumi.Input<pulumi.Input<string | enums.cdn.v20200901.Transform>[]>;
...
export interface RequestBodyMatchConditionParametersArgs {
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.RequestBodyOperator>;
    /**
     * List of transforms
     */
    transforms?: pulumi.Input<pulumi.Input<string | enums.cdn.v20200901.Transform>[]>;
...
export interface RequestHeaderMatchConditionParametersArgs {
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.RequestHeaderOperator>;
    /**
...
export interface RequestMethodMatchConditionParametersArgs {
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.RequestMethodOperator>;
}
...
export interface RequestUriMatchConditionParametersArgs {
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.RequestUriOperator>;
    /**
     * List of transforms
     */
    transforms?: pulumi.Input<pulumi.Input<string | enums.cdn.v20200901.Transform>[]>;
...
export interface ResponseBasedOriginErrorDetectionParametersArgs {
     ...
     */
    httpErrorRanges?: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.HttpErrorRangeParametersArgs>[]>;
    /**
     * Type of response errors for real user requests for which origin will be deemed unhealthy
     */
    responseBasedDetectedErrorTypes?: pulumi.Input<enums.cdn.v20200901.ResponseBasedDetectedErrorTypes>;
    /**
...
export interface SecurityPolicyWebApplicationFirewallAssociationArgs {
     ...
     * List of domains.
     */
    domains?: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.ResourceReferenceArgs>[]>;
    /**
     * List of paths
     */
...
export interface SecurityPolicyWebApplicationFirewallParametersArgs {
     ...
     * Waf associations
     */
    associations?: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.SecurityPolicyWebApplicationFirewallAssociationArgs>[]>;
    /**
     ...
     * Resource ID.
     */
    wafPolicy?: pulumi.Input<inputs.cdn.v20200901.ResourceReferenceArgs>;
}
...
export interface SharedPrivateLinkResourcePropertiesArgs {
     ...
     */
    privateLink?: pulumi.Input<inputs.cdn.v20200901.ResourceReferenceArgs>;
    /**
     ...
     */
    status?: pulumi.Input<enums.cdn.v20200901.SharedPrivateLinkResourceStatus>;
}
...
export interface SkuArgs {
     ...
     */
    name?: pulumi.Input<string | enums.cdn.v20200901.SkuName>;
}
...
export interface UrlFileExtensionMatchConditionParametersArgs {
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.UrlFileExtensionOperator>;
    /**
     * List of transforms
     */
    transforms?: pulumi.Input<pulumi.Input<string | enums.cdn.v20200901.Transform>[]>;
...
export interface UrlFileNameMatchConditionParametersArgs {
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.UrlFileNameOperator>;
    /**
     * List of transforms
     */
    transforms?: pulumi.Input<pulumi.Input<string | enums.cdn.v20200901.Transform>[]>;
...
export interface UrlPathMatchConditionParametersArgs {
     ...
     * Describes operator to be matched
     */
    operator: pulumi.Input<string | enums.cdn.v20200901.UrlPathOperator>;
    /**
     * List of transforms
     */
    transforms?: pulumi.Input<pulumi.Input<string | enums.cdn.v20200901.Transform>[]>;
...
export interface UrlRedirectActionArgs {
     ...
     * Defines the parameters for the action.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.UrlRedirectActionParametersArgs>;
}
...
export interface UrlRedirectActionParametersArgs {
     ...
     */
    destinationProtocol?: pulumi.Input<string | enums.cdn.v20200901.DestinationProtocol>;
    odataType: pulumi.Input<string>;
    /**
     * The redirect type the rule will use when redirecting traffic.
     */
    redirectType: pulumi.Input<string | enums.cdn.v20200901.RedirectType>;
}
...
export interface UrlRewriteActionArgs {
     ...
     * Defines the parameters for the action.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.UrlRewriteActionParametersArgs>;
}
...
export interface UrlSigningActionArgs {
     ...
     * Defines the parameters for the action.
     */
    parameters: pulumi.Input<inputs.cdn.v20200901.UrlSigningActionParametersArgs>;
}
...
export interface UrlSigningActionParametersArgs {
     ...
     */
    algorithm?: pulumi.Input<string | enums.cdn.v20200901.Algorithm>;
    odataType: pulumi.Input<string>;
    /**
     * Defines which query string parameters in the url to be considered for expires, key id etc. 
     */
    parameterNameOverride?: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.UrlSigningParamIdentifierArgs>[]>;
}
...
export interface UrlSigningKeyArgs {
     ...
     */
    keySourceParameters: pulumi.Input<inputs.cdn.v20200901.KeyVaultSigningKeyParametersArgs>;
}
...
export interface UrlSigningParamIdentifierArgs {
     ...
     */
    paramIndicator: pulumi.Input<string | enums.cdn.v20200901.ParamIndicator>;
    /**
     * Parameter name
     */
