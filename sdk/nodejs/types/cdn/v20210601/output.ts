...
export interface AFDDomainHttpsParametersResponse {
     ...
     */
    secret?: outputs.cdn.v20210601.ResourceReferenceResponse;
}
...
export interface AfdRouteCacheConfigurationResponse {
     ...
     */
    compressionSettings?: outputs.cdn.v20210601.CompressionSettingsResponse;
    /**
...
export interface CdnManagedHttpsParametersResponse {
     ...
     * Defines the certificate source parameters using CDN managed certificate for enabling SSL.
     */
    certificateSourceParameters: outputs.cdn.v20210601.CdnCertificateSourceParametersResponse;
    /**
     * TLS protocol version that will be used for Https
     */
    minimumTlsVersion?: string;
...
export interface CustomRuleListResponse {
     ...
     * List of rules
     */
    rules?: outputs.cdn.v20210601.CustomRuleResponse[];
}
...
export interface CustomRuleResponse {
     ...
     */
    matchConditions: outputs.cdn.v20210601.MatchConditionResponse[];
    /**
...
export interface CustomerCertificateParametersResponse {
     ...
     */
    secretSource: outputs.cdn.v20210601.ResourceReferenceResponse;
    /**
...
export interface DeepCreatedOriginGroupResponse {
     ...
     */
    healthProbeSettings?: outputs.cdn.v20210601.HealthProbeParametersResponse;
    /**
     ...
     */
    origins: outputs.cdn.v20210601.ResourceReferenceResponse[];
    /**
     * The JSON object that contains the properties to determine origin health using real requests/responses.This property is currently not supported.
     */
    responseBasedOriginErrorDetectionSettings?: outputs.cdn.v20210601.ResponseBasedOriginErrorDetectionParametersResponse;
    /**
...
export interface DeliveryRuleCacheExpirationActionResponse {
     ...
     */
    parameters: outputs.cdn.v20210601.CacheExpirationActionParametersResponse;
}
...
export interface DeliveryRuleCacheKeyQueryStringActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20210601.CacheKeyQueryStringActionParametersResponse;
}
...
export interface DeliveryRuleClientPortConditionResponse {
     ...
     */
    parameters: outputs.cdn.v20210601.ClientPortMatchConditionParametersResponse;
}
...
export interface DeliveryRuleCookiesConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.CookiesMatchConditionParametersResponse;
}
...
export interface DeliveryRuleHostNameConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.HostNameMatchConditionParametersResponse;
}
...
export interface DeliveryRuleHttpVersionConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.HttpVersionMatchConditionParametersResponse;
}
...
export interface DeliveryRuleIsDeviceConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.IsDeviceMatchConditionParametersResponse;
}
...
export interface DeliveryRulePostArgsConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.PostArgsMatchConditionParametersResponse;
}
...
export interface DeliveryRuleQueryStringConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.QueryStringMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRemoteAddressConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.RemoteAddressMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestBodyConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.RequestBodyMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestHeaderActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20210601.HeaderActionParametersResponse;
}
...
export interface DeliveryRuleRequestHeaderConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.RequestHeaderMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestMethodConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.RequestMethodMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestSchemeConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.RequestSchemeMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestUriConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.RequestUriMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRouteConfigurationOverrideActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20210601.RouteConfigurationOverrideActionParametersResponse;
}
...
export interface DeliveryRuleServerPortConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.ServerPortMatchConditionParametersResponse;
}
...
export interface DeliveryRuleSocketAddrConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.SocketAddrMatchConditionParametersResponse;
}
...
export interface DeliveryRuleSslProtocolConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.SslProtocolMatchConditionParametersResponse;
}
...
export interface DeliveryRuleUrlFileExtensionConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.UrlFileExtensionMatchConditionParametersResponse;
}
...
export interface DeliveryRuleUrlFileNameConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.UrlFileNameMatchConditionParametersResponse;
}
...
export interface DeliveryRuleUrlPathConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.v20210601.UrlPathMatchConditionParametersResponse;
}
...
export interface EndpointPropertiesUpdateParametersResponseDeliveryPolicy {
     ...
     */
    rules: outputs.cdn.v20210601.DeliveryRuleResponse[];
}
...
export interface ManagedRuleGroupOverrideResponse {
     ...
     */
    rules?: outputs.cdn.v20210601.ManagedRuleOverrideResponse[];
}
...
export interface ManagedRuleSetListResponse {
     ...
     * List of rule sets.
     */
    managedRuleSets?: outputs.cdn.v20210601.ManagedRuleSetResponse[];
}
...
export interface ManagedRuleSetResponse {
     ...
     */
    ruleGroupOverrides?: outputs.cdn.v20210601.ManagedRuleGroupOverrideResponse[];
    /**
...
export interface OriginGroupOverrideActionParametersResponse {
     ...
     */
    originGroup: outputs.cdn.v20210601.ResourceReferenceResponse;
    typeName: string;
}
...
export interface OriginGroupOverrideActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20210601.OriginGroupOverrideActionParametersResponse;
}
...
export interface RateLimitRuleListResponse {
     ...
     * List of rules
     */
    rules?: outputs.cdn.v20210601.RateLimitRuleResponse[];
}
...
export interface ResponseBasedOriginErrorDetectionParametersResponse {
     ...
     */
    httpErrorRanges?: outputs.cdn.v20210601.HttpErrorRangeParametersResponse[];
    /**
...
export interface RouteConfigurationOverrideActionParametersResponse {
     ...
     */
    cacheConfiguration?: outputs.cdn.v20210601.CacheConfigurationResponse;
    /**
     * A reference to the origin group override configuration. Leave empty to use the default origin group on route.
     */
    originGroupOverride?: outputs.cdn.v20210601.OriginGroupOverrideResponse;
    typeName: string;
}
...
export interface SecurityPolicyWebApplicationFirewallAssociationResponse {
     ...
     * List of domains.
     */
    domains?: outputs.cdn.v20210601.ActivatedResourceReferenceResponse[];
    /**
     * List of paths
     */
...
export interface SecurityPolicyWebApplicationFirewallParametersResponse {
     ...
     * Waf associations
     */
    associations?: outputs.cdn.v20210601.SecurityPolicyWebApplicationFirewallAssociationResponse[];
    /**
     ...
     * Resource ID.
     */
    wafPolicy?: outputs.cdn.v20210601.ResourceReferenceResponse;
}
...
export interface SharedPrivateLinkResourcePropertiesResponse {
     ...
     */
    privateLink?: outputs.cdn.v20210601.ResourceReferenceResponse;
    /**
...
export interface UrlRedirectActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20210601.UrlRedirectActionParametersResponse;
}
...
export interface UrlRewriteActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20210601.UrlRewriteActionParametersResponse;
}
...
export interface UrlSigningActionParametersResponse {
     ...
     */
    parameterNameOverride?: outputs.cdn.v20210601.UrlSigningParamIdentifierResponse[];
    typeName: string;
}
...
export interface UrlSigningActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.v20210601.UrlSigningActionParametersResponse;
}
...
export interface UrlSigningKeyResponse {
     ...
     */
    keySourceParameters: outputs.cdn.v20210601.KeyVaultSigningKeyParametersResponse;
}
...
export interface UserManagedHttpsParametersResponse {
     ...
     * Defines the certificate source parameters using user's keyvault certificate for enabling SSL.
     */
    certificateSourceParameters: outputs.cdn.v20210601.KeyVaultCertificateSourceParametersResponse;
    /**
     * TLS protocol version that will be used for Https
     */
    minimumTlsVersion?: string;
