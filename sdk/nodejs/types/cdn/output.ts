...
export * as v20150601 from "./v20150601/output";
export * as v20160402 from "./v20160402/output";
export * as v20161002 from "./v20161002/output";
export * as v20170402 from "./v20170402/output";
export * as v20171012 from "./v20171012/output";
export * as v20190415 from "./v20190415/output";
export * as v20190615 from "./v20190615/output";
export * as v20190615preview from "./v20190615preview/output";
export * as v20191231 from "./v20191231/output";
export * as v20200331 from "./v20200331/output";
export * as v20200415 from "./v20200415/output";
...
export interface AFDDomainHttpsParametersResponse {
     ...
     */
    secret?: outputs.cdn.ResourceReferenceResponse;
}
...
export interface CdnManagedHttpsParametersResponse {
     ...
     * Defines the certificate source parameters using CDN managed certificate for enabling SSL.
     */
    certificateSourceParameters: outputs.cdn.CdnCertificateSourceParametersResponse;
    /**
     * TLS protocol version that will be used for Https
     */
    minimumTlsVersion?: string;
...
export interface DeliveryRuleCacheExpirationActionResponse {
     ...
     */
    parameters: outputs.cdn.CacheExpirationActionParametersResponse;
}
...
export interface DeliveryRuleCacheKeyQueryStringActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.CacheKeyQueryStringActionParametersResponse;
}
...
export interface DeliveryRuleCookiesConditionResponse {
     ...
     */
    parameters: outputs.cdn.CookiesMatchConditionParametersResponse;
}
...
export interface DeliveryRuleHttpVersionConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.HttpVersionMatchConditionParametersResponse;
}
...
export interface DeliveryRuleIsDeviceConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.IsDeviceMatchConditionParametersResponse;
}
...
export interface DeliveryRulePostArgsConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.PostArgsMatchConditionParametersResponse;
}
...
export interface DeliveryRuleQueryStringConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.QueryStringMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRemoteAddressConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.RemoteAddressMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestBodyConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.RequestBodyMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestHeaderActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.HeaderActionParametersResponse;
}
...
export interface DeliveryRuleRequestHeaderConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.RequestHeaderMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestMethodConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.RequestMethodMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestSchemeConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.RequestSchemeMatchConditionParametersResponse;
}
...
export interface DeliveryRuleRequestUriConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.RequestUriMatchConditionParametersResponse;
}
...
export interface DeliveryRuleUrlFileExtensionConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.UrlFileExtensionMatchConditionParametersResponse;
}
...
export interface DeliveryRuleUrlFileNameConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.UrlFileNameMatchConditionParametersResponse;
}
...
export interface DeliveryRuleUrlPathConditionResponse {
     ...
     * Defines the parameters for the condition.
     */
    parameters: outputs.cdn.UrlPathMatchConditionParametersResponse;
}
...
export interface OriginGroupOverrideActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.OriginGroupOverrideActionParametersResponse;
}
...
export interface SecurityPolicyWebApplicationFirewallAssociationResponse {
     ...
     * List of domains.
     */
    domains?: outputs.cdn.ResourceReferenceResponse[];
    /**
     * List of paths
     */
...
export interface SecurityPolicyWebApplicationFirewallParametersResponse {
     ...
     * Waf associations
     */
    associations?: outputs.cdn.SecurityPolicyWebApplicationFirewallAssociationResponse[];
    /**
     ...
     * Resource ID.
     */
    wafPolicy?: outputs.cdn.ResourceReferenceResponse;
}
...
export interface SharedPrivateLinkResourcePropertiesResponse {
     ...
     */
    privateLink?: outputs.cdn.ResourceReferenceResponse;
    /**
...
export interface UrlRedirectActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.UrlRedirectActionParametersResponse;
}
...
export interface UrlRewriteActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.UrlRewriteActionParametersResponse;
}
...
export interface UrlSigningActionResponse {
     ...
     * Defines the parameters for the action.
     */
    parameters: outputs.cdn.UrlSigningActionParametersResponse;
}
...
export interface UserManagedHttpsParametersResponse {
     ...
     * Defines the certificate source parameters using user's keyvault certificate for enabling SSL.
     */
    certificateSourceParameters: outputs.cdn.KeyVaultCertificateSourceParametersResponse;
    /**
     * TLS protocol version that will be used for Https
     */
    minimumTlsVersion?: string;
