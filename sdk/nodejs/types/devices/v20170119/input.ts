...
export interface CloudToDevicePropertiesArgs {
     ...
     */
    feedback?: pulumi.Input<inputs.devices.v20170119.FeedbackPropertiesArgs>;
    /**
...
export interface FallbackRoutePropertiesArgs {
     ...
     */
    source: pulumi.Input<string | enums.devices.v20170119.RoutingSource>;
}
...
export interface IotHubPropertiesArgs {
     ...
     */
    authorizationPolicies?: pulumi.Input<pulumi.Input<inputs.devices.v20170119.SharedAccessSignatureAuthorizationRuleArgs>[]>;
    /**
     * The IoT hub cloud-to-device messaging properties.
     */
    cloudToDevice?: pulumi.Input<inputs.devices.v20170119.CloudToDevicePropertiesArgs>;
    /**
     * Comments.
     */
     ...
     */
    eventHubEndpoints?: pulumi.Input<{[key: string]: pulumi.Input<inputs.devices.v20170119.EventHubPropertiesArgs>}>;
    /**
     * The capabilities and features enabled for the IoT hub.
     */
    features?: pulumi.Input<string | enums.devices.v20170119.Capabilities>;
    /**
     * The IP filter rules.
     */
    ipFilterRules?: pulumi.Input<pulumi.Input<inputs.devices.v20170119.IpFilterRuleArgs>[]>;
    /**
     * The messaging endpoint properties for the file upload notification queue.
     */
    messagingEndpoints?: pulumi.Input<{[key: string]: pulumi.Input<inputs.devices.v20170119.MessagingEndpointPropertiesArgs>}>;
    /**
     ...
     */
    operationsMonitoringProperties?: pulumi.Input<inputs.devices.v20170119.OperationsMonitoringPropertiesArgs>;
    /**
     * The routing related properties of the IoT hub. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging
     */
    routing?: pulumi.Input<inputs.devices.v20170119.RoutingPropertiesArgs>;
    /**
     * The list of Azure Storage endpoints where you can upload files. Currently you can configure only one Azure Storage account and that MUST have its key as $default. Specifying more than one storage account causes an error to be thrown. Not specifying a value for this property when the enableFileUploadNotifications property is set to True, causes an error to be thrown.
     */
    storageEndpoints?: pulumi.Input<{[key: string]: pulumi.Input<inputs.devices.v20170119.StorageEndpointPropertiesArgs>}>;
}
...
export interface IotHubSkuInfoArgs {
     ...
     * The name of the SKU.
     */
    name: pulumi.Input<string | enums.devices.v20170119.IotHubSku>;
}
...
export interface IpFilterRuleArgs {
     ...
     */
    action: pulumi.Input<enums.devices.v20170119.IpFilterActionType>;
    /**
...
export interface OperationsMonitoringPropertiesArgs {
    events?: pulumi.Input<{[key: string]: pulumi.Input<string | enums.devices.v20170119.OperationMonitoringLevel>}>;
}
...
export interface RoutingEndpointsArgs {
     ...
     */
    eventHubs?: pulumi.Input<pulumi.Input<inputs.devices.v20170119.RoutingEventHubPropertiesArgs>[]>;
    /**
     * The list of Service Bus queue endpoints that IoT hub routes the messages to, based on the routing rules.
     */
    serviceBusQueues?: pulumi.Input<pulumi.Input<inputs.devices.v20170119.RoutingServiceBusQueueEndpointPropertiesArgs>[]>;
    /**
     * The list of Service Bus topic endpoints that the IoT hub routes the messages to, based on the routing rules.
     */
    serviceBusTopics?: pulumi.Input<pulumi.Input<inputs.devices.v20170119.RoutingServiceBusTopicEndpointPropertiesArgs>[]>;
}
...
export interface RoutingPropertiesArgs {
     ...
     * The properties related to the custom endpoints to which your IoT hub routes messages based on the routing rules. A maximum of 10 custom endpoints are allowed across all endpoint types for paid hubs and only 1 custom endpoint is allowed across all endpoint types for free hubs.
     */
    endpoints?: pulumi.Input<inputs.devices.v20170119.RoutingEndpointsArgs>;
    /**
     * The properties of the route that is used as a fall-back route when none of the conditions specified in the 'routes' section are met. This is an optional parameter. When this property is not set, the messages which do not meet any of the conditions specified in the 'routes' section get routed to the built-in eventhub endpoint.
     */
    fallbackRoute?: pulumi.Input<inputs.devices.v20170119.FallbackRoutePropertiesArgs>;
    /**
     * The list of user-provided routing rules that the IoT hub uses to route messages to built-in and custom endpoints. A maximum of 100 routing rules are allowed for paid hubs and a maximum of 5 routing rules are allowed for free hubs.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.devices.v20170119.RoutePropertiesArgs>[]>;
}
...
export interface SharedAccessSignatureAuthorizationRuleArgs {
     ...
     */
    rights: pulumi.Input<enums.devices.v20170119.AccessRights>;
    /**
     * The secondary key.
     */
