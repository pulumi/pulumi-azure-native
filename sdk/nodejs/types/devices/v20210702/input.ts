...
export interface ArmIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.devices.v20210702.ResourceIdentityType>;
...
export interface CloudToDevicePropertiesArgs {
     ...
     */
    feedback?: pulumi.Input<inputs.devices.v20210702.FeedbackPropertiesArgs>;
    /**
...
export interface FallbackRoutePropertiesArgs {
     ...
     */
    source: pulumi.Input<string | enums.devices.v20210702.RoutingSource>;
}
...
export interface IotHubPropertiesArgs {
     ...
     */
    authorizationPolicies?: pulumi.Input<pulumi.Input<inputs.devices.v20210702.SharedAccessSignatureAuthorizationRuleArgs>[]>;
    /**
     * The IoT hub cloud-to-device messaging properties.
     */
    cloudToDevice?: pulumi.Input<inputs.devices.v20210702.CloudToDevicePropertiesArgs>;
    /**
     * IoT hub comments.
     */
     ...
     */
    eventHubEndpoints?: pulumi.Input<{[key: string]: pulumi.Input<inputs.devices.v20210702.EventHubPropertiesArgs>}>;
    /**
     * The capabilities and features enabled for the IoT hub.
     */
    features?: pulumi.Input<string | enums.devices.v20210702.Capabilities>;
    /**
     * The IP filter rules.
     */
    ipFilterRules?: pulumi.Input<pulumi.Input<inputs.devices.v20210702.IpFilterRuleArgs>[]>;
    /**
     * The messaging endpoint properties for the file upload notification queue.
     */
    messagingEndpoints?: pulumi.Input<{[key: string]: pulumi.Input<inputs.devices.v20210702.MessagingEndpointPropertiesArgs>}>;
    /**
     ...
     */
    networkRuleSets?: pulumi.Input<inputs.devices.v20210702.NetworkRuleSetPropertiesArgs>;
    /**
     * Private endpoint connections created on this IotHub
     */
    privateEndpointConnections?: pulumi.Input<pulumi.Input<inputs.devices.v20210702.PrivateEndpointConnectionArgs>[]>;
    /**
     * Whether requests from Public Network are allowed
     */
    publicNetworkAccess?: pulumi.Input<string | enums.devices.v20210702.PublicNetworkAccess>;
    /**
     ...
     */
    routing?: pulumi.Input<inputs.devices.v20210702.RoutingPropertiesArgs>;
    /**
     * The list of Azure Storage endpoints where you can upload files. Currently you can configure only one Azure Storage account and that MUST have its key as $default. Specifying more than one storage account causes an error to be thrown. Not specifying a value for this property when the enableFileUploadNotifications property is set to True, causes an error to be thrown.
     */
    storageEndpoints?: pulumi.Input<{[key: string]: pulumi.Input<inputs.devices.v20210702.StorageEndpointPropertiesArgs>}>;
}
/**
...
export function iotHubPropertiesArgsProvideDefaults(val: IotHubPropertiesArgs): IotHubPropertiesArgs {
    return {
        ...val,
        networkRuleSets: (val.networkRuleSets ? pulumi.output(val.networkRuleSets).apply(inputs.devices.v20210702.networkRuleSetPropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface IotHubSkuInfoArgs {
     ...
     * The name of the SKU.
     */
    name: pulumi.Input<string | enums.devices.v20210702.IotHubSku>;
}
...
export interface IpFilterRuleArgs {
     ...
     */
    action: pulumi.Input<enums.devices.v20210702.IpFilterActionType>;
    /**
...
export interface NetworkRuleSetIpRuleArgs {
     ...
     * IP Filter Action
     */
    action?: pulumi.Input<string | enums.devices.v20210702.NetworkRuleIPAction>;
    /**
...
export interface NetworkRuleSetPropertiesArgs {
     ...
     */
    defaultAction?: pulumi.Input<string | enums.devices.v20210702.DefaultAction>;
    /**
     * List of IP Rules
     */
    ipRules: pulumi.Input<pulumi.Input<inputs.devices.v20210702.NetworkRuleSetIpRuleArgs>[]>;
}
/**
...
export interface PrivateEndpointConnectionPropertiesArgs {
     ...
     */
    privateLinkServiceConnectionState: pulumi.Input<inputs.devices.v20210702.PrivateLinkServiceConnectionStateArgs>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status: pulumi.Input<string | enums.devices.v20210702.PrivateLinkServiceConnectionStatus>;
}
...
export interface RoutingEndpointsArgs {
     ...
     */
    eventHubs?: pulumi.Input<pulumi.Input<inputs.devices.v20210702.RoutingEventHubPropertiesArgs>[]>;
    /**
     * The list of Service Bus queue endpoints that IoT hub routes the messages to, based on the routing rules.
     */
    serviceBusQueues?: pulumi.Input<pulumi.Input<inputs.devices.v20210702.RoutingServiceBusQueueEndpointPropertiesArgs>[]>;
    /**
     * The list of Service Bus topic endpoints that the IoT hub routes the messages to, based on the routing rules.
     */
    serviceBusTopics?: pulumi.Input<pulumi.Input<inputs.devices.v20210702.RoutingServiceBusTopicEndpointPropertiesArgs>[]>;
    /**
     * The list of storage container endpoints that IoT hub routes messages to, based on the routing rules.
     */
    storageContainers?: pulumi.Input<pulumi.Input<inputs.devices.v20210702.RoutingStorageContainerPropertiesArgs>[]>;
}
...
export interface RoutingEventHubPropertiesArgs {
     ...
     */
    authenticationType?: pulumi.Input<string | enums.devices.v20210702.AuthenticationType>;
    /**
     ...
     */
    identity?: pulumi.Input<inputs.devices.v20210702.ManagedIdentityArgs>;
    /**
...
export interface RoutingPropertiesArgs {
     ...
     * The properties related to the custom endpoints to which your IoT hub routes messages based on the routing rules. A maximum of 10 custom endpoints are allowed across all endpoint types for paid hubs and only 1 custom endpoint is allowed across all endpoint types for free hubs.
     */
    endpoints?: pulumi.Input<inputs.devices.v20210702.RoutingEndpointsArgs>;
    /**
     * The list of user-provided enrichments that the IoT hub applies to messages to be delivered to built-in and custom endpoints. See: https://aka.ms/telemetryoneventgrid
     */
    enrichments?: pulumi.Input<pulumi.Input<inputs.devices.v20210702.EnrichmentPropertiesArgs>[]>;
    /**
     * The properties of the route that is used as a fall-back route when none of the conditions specified in the 'routes' section are met. This is an optional parameter. When this property is not set, the messages which do not meet any of the conditions specified in the 'routes' section get routed to the built-in eventhub endpoint.
     */
    fallbackRoute?: pulumi.Input<inputs.devices.v20210702.FallbackRoutePropertiesArgs>;
    /**
     * The list of user-provided routing rules that the IoT hub uses to route messages to built-in and custom endpoints. A maximum of 100 routing rules are allowed for paid hubs and a maximum of 5 routing rules are allowed for free hubs.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.devices.v20210702.RoutePropertiesArgs>[]>;
}
...
export interface SharedAccessSignatureAuthorizationRuleArgs {
     ...
     */
    rights: pulumi.Input<enums.devices.v20210702.AccessRights>;
    /**
     * The secondary key.
     */
