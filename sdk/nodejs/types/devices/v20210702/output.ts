...
export interface ArmIdentityResponse {
     ...
     */
    type?: string;
    userAssignedIdentities?: {[key: string]: outputs.devices.v20210702.ArmUserIdentityResponse};
}
...
export interface CloudToDevicePropertiesResponse {
     ...
     */
    feedback?: outputs.devices.v20210702.FeedbackPropertiesResponse;
    /**
...
export interface IotHubPropertiesResponse {
     ...
     */
    authorizationPolicies?: outputs.devices.v20210702.SharedAccessSignatureAuthorizationRuleResponse[];
    /**
     * The IoT hub cloud-to-device messaging properties.
     */
    cloudToDevice?: outputs.devices.v20210702.CloudToDevicePropertiesResponse;
    /**
     * IoT hub comments.
     */
    comments?: string;
     ...
     */
    eventHubEndpoints?: {[key: string]: outputs.devices.v20210702.EventHubPropertiesResponse};
    /**
     ...
     * The IP filter rules.
     */
    ipFilterRules?: outputs.devices.v20210702.IpFilterRuleResponse[];
    /**
     * Primary and secondary location for iot hub
     */
    locations: outputs.devices.v20210702.IotHubLocationDescriptionResponse[];
    /**
     * The messaging endpoint properties for the file upload notification queue.
     */
    messagingEndpoints?: {[key: string]: outputs.devices.v20210702.MessagingEndpointPropertiesResponse};
    /**
     ...
     */
    networkRuleSets?: outputs.devices.v20210702.NetworkRuleSetPropertiesResponse;
    /**
     * Private endpoint connections created on this IotHub
     */
    privateEndpointConnections?: outputs.devices.v20210702.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    routing?: outputs.devices.v20210702.RoutingPropertiesResponse;
    /**
     * The hub state.
     */
    state: string;
     ...
     */
    storageEndpoints?: {[key: string]: outputs.devices.v20210702.StorageEndpointPropertiesResponse};
}
/**
...
export function iotHubPropertiesResponseProvideDefaults(val: IotHubPropertiesResponse): IotHubPropertiesResponse {
    return {
        ...val,
        networkRuleSets: (val.networkRuleSets ? outputs.devices.v20210702.networkRuleSetPropertiesResponseProvideDefaults(val.networkRuleSets) : undefined),
    };
}
...
export interface NetworkRuleSetPropertiesResponse {
     ...
     * List of IP Rules
     */
    ipRules: outputs.devices.v20210702.NetworkRuleSetIpRuleResponse[];
}
/**
...
export interface PrivateEndpointConnectionPropertiesResponse {
     ...
     */
    privateEndpoint?: outputs.devices.v20210702.PrivateEndpointResponse;
    /**
     * The current state of a private endpoint connection
     */
    privateLinkServiceConnectionState: outputs.devices.v20210702.PrivateLinkServiceConnectionStateResponse;
}
...
export interface PrivateEndpointConnectionResponse {
     ...
     * The properties of a private endpoint connection
     */
    properties: outputs.devices.v20210702.PrivateEndpointConnectionPropertiesResponse;
    /**
     * The resource type.
     */
    type: string;
...
export interface RoutingEndpointsResponse {
     ...
     */
    eventHubs?: outputs.devices.v20210702.RoutingEventHubPropertiesResponse[];
    /**
     * The list of Service Bus queue endpoints that IoT hub routes the messages to, based on the routing rules.
     */
    serviceBusQueues?: outputs.devices.v20210702.RoutingServiceBusQueueEndpointPropertiesResponse[];
    /**
     * The list of Service Bus topic endpoints that the IoT hub routes the messages to, based on the routing rules.
     */
    serviceBusTopics?: outputs.devices.v20210702.RoutingServiceBusTopicEndpointPropertiesResponse[];
    /**
     * The list of storage container endpoints that IoT hub routes messages to, based on the routing rules.
     */
    storageContainers?: outputs.devices.v20210702.RoutingStorageContainerPropertiesResponse[];
}
...
export interface RoutingEventHubPropertiesResponse {
     ...
     */
    identity?: outputs.devices.v20210702.ManagedIdentityResponse;
    /**
...
export interface RoutingPropertiesResponse {
     ...
     * The properties related to the custom endpoints to which your IoT hub routes messages based on the routing rules. A maximum of 10 custom endpoints are allowed across all endpoint types for paid hubs and only 1 custom endpoint is allowed across all endpoint types for free hubs.
     */
    endpoints?: outputs.devices.v20210702.RoutingEndpointsResponse;
    /**
     * The list of user-provided enrichments that the IoT hub applies to messages to be delivered to built-in and custom endpoints. See: https://aka.ms/telemetryoneventgrid
     */
    enrichments?: outputs.devices.v20210702.EnrichmentPropertiesResponse[];
    /**
     * The properties of the route that is used as a fall-back route when none of the conditions specified in the 'routes' section are met. This is an optional parameter. When this property is not set, the messages which do not meet any of the conditions specified in the 'routes' section get routed to the built-in eventhub endpoint.
     */
    fallbackRoute?: outputs.devices.v20210702.FallbackRoutePropertiesResponse;
    /**
     * The list of user-provided routing rules that the IoT hub uses to route messages to built-in and custom endpoints. A maximum of 100 routing rules are allowed for paid hubs and a maximum of 5 routing rules are allowed for free hubs.
     */
    routes?: outputs.devices.v20210702.RoutePropertiesResponse[];
}
