...
export interface IotHubPropertiesArgs {
     ...
     */
    eventHubEndpoints?: pulumi.Input<{[key: string]: pulumi.Input<inputs.devices.v20220430preview.EventHubPropertiesArgs>}>;
    /**
     ...
     */
    messagingEndpoints?: pulumi.Input<{[key: string]: pulumi.Input<inputs.devices.v20220430preview.MessagingEndpointPropertiesArgs>}>;
    /**
     ...
     */
    storageEndpoints?: pulumi.Input<{[key: string]: pulumi.Input<inputs.devices.v20220430preview.StorageEndpointPropertiesArgs>}>;
}
/**
...
export function iotHubPropertiesArgsProvideDefaults(val: IotHubPropertiesArgs): IotHubPropertiesArgs {
    return {
        ...val,
        networkRuleSets: (val.networkRuleSets ? pulumi.output(val.networkRuleSets).apply(inputs.devices.v20220430preview.networkRuleSetPropertiesArgsProvideDefaults) : undefined),
    };
}
