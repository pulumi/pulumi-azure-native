...
export interface ArmIdentityResponse {
     ...
     */
    tenantId: string;
    userAssignedIdentities?: {[key: string]: outputs.devices.v20200831preview.ArmUserIdentityResponse};
}
...
export interface CloudToDevicePropertiesResponse {
     ...
     */
    feedback?: outputs.devices.v20200831preview.FeedbackPropertiesResponse;
    /**
...
export interface EncryptionPropertiesDescriptionResponse {
     ...
     */
    keyVaultProperties?: outputs.devices.v20200831preview.KeyVaultKeyPropertiesResponse[];
}
...
export interface IotHubPropertiesResponse {
     ...
     */
    authorizationPolicies?: outputs.devices.v20200831preview.SharedAccessSignatureAuthorizationRuleResponse[];
    /**
     * The IoT hub cloud-to-device messaging properties.
     */
    cloudToDevice?: outputs.devices.v20200831preview.CloudToDevicePropertiesResponse;
    /**
     * IoT hub comments.
     */
    comments?: string;
     ...
     */
    deviceStreams?: outputs.devices.v20200831preview.IotHubPropertiesResponseDeviceStreams;
    /**
     ...
     * The encryption properties for the IoT hub.
     */
    encryption?: outputs.devices.v20200831preview.EncryptionPropertiesDescriptionResponse;
    /**
     * The Event Hub-compatible endpoint properties. The only possible keys to this dictionary is events. This key has to be present in the dictionary while making create or update calls for the IoT hub.
     */
    eventHubEndpoints?: {[key: string]: outputs.devices.v20200831preview.EventHubPropertiesResponse};
    /**
     ...
     * The IP filter rules.
     */
    ipFilterRules?: outputs.devices.v20200831preview.IpFilterRuleResponse[];
    /**
     * Primary and secondary location for iot hub
     */
    locations: outputs.devices.v20200831preview.IotHubLocationDescriptionResponse[];
    /**
     * The messaging endpoint properties for the file upload notification queue.
     */
    messagingEndpoints?: {[key: string]: outputs.devices.v20200831preview.MessagingEndpointPropertiesResponse};
    /**
     ...
     */
    networkRuleSets?: outputs.devices.v20200831preview.NetworkRuleSetPropertiesResponse;
    /**
     * Private endpoint connections created on this IotHub
     */
    privateEndpointConnections?: outputs.devices.v20200831preview.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    routing?: outputs.devices.v20200831preview.RoutingPropertiesResponse;
    /**
     * The hub state.
     */
    state: string;
     ...
     */
    storageEndpoints?: {[key: string]: outputs.devices.v20200831preview.StorageEndpointPropertiesResponse};
}
/**
...
export function iotHubPropertiesResponseProvideDefaults(val: IotHubPropertiesResponse): IotHubPropertiesResponse {
    return {
        ...val,
        networkRuleSets: (val.networkRuleSets ? outputs.devices.v20200831preview.networkRuleSetPropertiesResponseProvideDefaults(val.networkRuleSets) : undefined),
    };
}
...
export interface KeyVaultKeyPropertiesResponse {
     ...
     * The identity.
     */
    identity?: outputs.devices.v20200831preview.KEKIdentityResponse;
    /**
...
export interface NetworkRuleSetPropertiesResponse {
     ...
     * List of IP Rules
     */
    ipRules: outputs.devices.v20200831preview.NetworkRuleSetIpRuleResponse[];
}
/**
...
export interface PrivateEndpointConnectionPropertiesResponse {
     ...
     */
    privateEndpoint?: outputs.devices.v20200831preview.PrivateEndpointResponse;
    /**
     * The current state of a private endpoint connection
     */
    privateLinkServiceConnectionState: outputs.devices.v20200831preview.PrivateLinkServiceConnectionStateResponse;
}
...
export interface PrivateEndpointConnectionResponse {
     ...
     * The properties of a private endpoint connection
     */
    properties: outputs.devices.v20200831preview.PrivateEndpointConnectionPropertiesResponse;
    /**
     * The resource type.
     */
    type: string;
...
export interface RoutingEndpointsResponse {
     ...
     */
    eventHubs?: outputs.devices.v20200831preview.RoutingEventHubPropertiesResponse[];
    /**
     * The list of Service Bus queue endpoints that IoT hub routes the messages to, based on the routing rules.
     */
    serviceBusQueues?: outputs.devices.v20200831preview.RoutingServiceBusQueueEndpointPropertiesResponse[];
    /**
     * The list of Service Bus topic endpoints that the IoT hub routes the messages to, based on the routing rules.
     */
    serviceBusTopics?: outputs.devices.v20200831preview.RoutingServiceBusTopicEndpointPropertiesResponse[];
    /**
     * The list of storage container endpoints that IoT hub routes messages to, based on the routing rules.
     */
    storageContainers?: outputs.devices.v20200831preview.RoutingStorageContainerPropertiesResponse[];
}
...
export interface RoutingPropertiesResponse {
     ...
     * The properties related to the custom endpoints to which your IoT hub routes messages based on the routing rules. A maximum of 10 custom endpoints are allowed across all endpoint types for paid hubs and only 1 custom endpoint is allowed across all endpoint types for free hubs.
     */
    endpoints?: outputs.devices.v20200831preview.RoutingEndpointsResponse;
    /**
     * The list of user-provided enrichments that the IoT hub applies to messages to be delivered to built-in and custom endpoints. See: https://aka.ms/telemetryoneventgrid
     */
    enrichments?: outputs.devices.v20200831preview.EnrichmentPropertiesResponse[];
    /**
     * The properties of the route that is used as a fall-back route when none of the conditions specified in the 'routes' section are met. This is an optional parameter. When this property is not set, the messages which do not meet any of the conditions specified in the 'routes' section get routed to the built-in eventhub endpoint.
     */
    fallbackRoute?: outputs.devices.v20200831preview.FallbackRoutePropertiesResponse;
    /**
     * The list of user-provided routing rules that the IoT hub uses to route messages to built-in and custom endpoints. A maximum of 100 routing rules are allowed for paid hubs and a maximum of 5 routing rules are allowed for free hubs.
     */
    routes?: outputs.devices.v20200831preview.RoutePropertiesResponse[];
}
