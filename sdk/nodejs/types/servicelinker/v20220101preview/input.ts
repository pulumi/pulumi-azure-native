...
export interface AzureResourceArgs {
     ...
     */
    resourceProperties?: pulumi.Input<inputs.servicelinker.v20220101preview.AzureKeyVaultPropertiesArgs>;
    /**
...
export interface SecretAuthInfoArgs {
     ...
     */
    secretInfo?: pulumi.Input<inputs.servicelinker.v20220101preview.KeyVaultSecretReferenceSecretInfoArgs | inputs.servicelinker.v20220101preview.KeyVaultSecretUriSecretInfoArgs | inputs.servicelinker.v20220101preview.ValueSecretInfoArgs>;
}
...
export interface VNetSolutionArgs {
     ...
     */
    type?: pulumi.Input<string | enums.servicelinker.v20220101preview.VNetSolutionType>;
}
