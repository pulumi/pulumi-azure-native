...
export interface AzureBackupServerContainerResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20221001.DPMContainerExtendedInfoResponse;
    /**
...
export interface AzureFileShareProtectionPolicyResponse {
     ...
     */
    retentionPolicy?: outputs.recoveryservices.v20221001.LongTermRetentionPolicyResponse | outputs.recoveryservices.v20221001.SimpleRetentionPolicyResponse;
    /**
     * Backup schedule specified as part of backup policy.
     */
    schedulePolicy?: outputs.recoveryservices.v20221001.LogSchedulePolicyResponse | outputs.recoveryservices.v20221001.LongTermSchedulePolicyResponse | outputs.recoveryservices.v20221001.SimpleSchedulePolicyResponse | outputs.recoveryservices.v20221001.SimpleSchedulePolicyV2Response;
    /**
...
export interface AzureFileshareProtectedItemResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20221001.AzureFileshareProtectedItemExtendedInfoResponse;
    /**
     ...
     */
    kpisHealths?: {[key: string]: outputs.recoveryservices.v20221001.KPIResourceHealthDetailsResponse};
    /**
...
export interface AzureIaaSClassicComputeVMProtectedItemResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20221001.AzureIaaSVMProtectedItemExtendedInfoResponse;
    /**
     * Extended Properties for Azure IaasVM Backup.
     */
    extendedProperties?: outputs.recoveryservices.v20221001.ExtendedPropertiesResponse;
    /**
     ...
     */
    healthDetails?: outputs.recoveryservices.v20221001.AzureIaaSVMHealthDetailsResponse[];
    /**
...
export interface AzureIaaSVMProtectionPolicyResponse {
    ...
    instantRPDetails?: outputs.recoveryservices.v20221001.InstantRPAdditionalDetailsResponse;
    /**
     ...
     */
    tieringPolicy?: {[key: string]: outputs.recoveryservices.v20221001.TieringPolicyResponse};
    /**
     * TimeZone optional input as string. For example: TimeZone = "Pacific Standard Time".
     */
    timeZone?: string;
...
export interface AzureSQLAGWorkloadContainerProtectionContainerResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20221001.AzureWorkloadContainerExtendedInfoResponse;
    /**
     * Friendly name of the container.
     */
    friendlyName?: string;
...
export interface AzureSqlProtectedItemResponse {
     ...
     * Additional information for this backup item.
     */
    extendedInfo?: outputs.recoveryservices.v20221001.AzureSqlProtectedItemExtendedInfoResponse;
    /**
     * Flag to identify whether datasource is protected in archive
     */
    isArchiveEnabled?: boolean;
...
export interface AzureVmWorkloadProtectedItemResponse {
     ...
     * Additional information for this backup item.
     */
    extendedInfo?: outputs.recoveryservices.v20221001.AzureVmWorkloadProtectedItemExtendedInfoResponse;
    /**
     ...
     */
    lastBackupErrorDetail?: outputs.recoveryservices.v20221001.ErrorDetailResponse;
    /**
     * Last backup operation status. Possible values: Healthy, Unhealthy.
     */
    lastBackupStatus?: string;
...
export interface AzureVmWorkloadProtectionPolicyResponse {
     ...
     */
    settings?: outputs.recoveryservices.v20221001.SettingsResponse;
    /**
     * List of sub-protection policies which includes schedule and retention
     */
    subProtectionPolicy?: outputs.recoveryservices.v20221001.SubProtectionPolicyResponse[];
    /**
     * Type of workload for the backup management
     */
    workLoadType?: string;
...
export interface AzureWorkloadContainerExtendedInfoResponse {
     ...
     */
    inquiryInfo?: outputs.recoveryservices.v20221001.InquiryInfoResponse;
    /**
     * List of the nodes in case of distributed container.
     */
    nodesList?: outputs.recoveryservices.v20221001.DistributedNodesInfoResponse[];
}
...
export interface DPMProtectedItemResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20221001.DPMProtectedItemExtendedInfoResponse;
    /**
...
export interface DailyRetentionFormatResponse {
     ...
     */
    daysOfTheMonth?: outputs.recoveryservices.v20221001.DayResponse[];
}
...
export interface DailyRetentionScheduleResponse {
     ...
     */
    retentionDuration?: outputs.recoveryservices.v20221001.RetentionDurationResponse;
    /**
...
export interface DistributedNodesInfoResponse {
     ...
     */
    errorDetail?: outputs.recoveryservices.v20221001.ErrorDetailResponse;
    /**
...
export interface ExtendedPropertiesResponse {
     ...
     */
    diskExclusionProperties?: outputs.recoveryservices.v20221001.DiskExclusionPropertiesResponse;
    /**
     * Linux VM name
     */
...
export interface GenericContainerExtendedInfoResponse {
     ...
     * Container identity information
     */
    containerIdentityInfo?: outputs.recoveryservices.v20221001.ContainerIdentityInfoResponse;
    /**
...
export interface GenericContainerResponse {
     ...
     */
    extendedInformation?: outputs.recoveryservices.v20221001.GenericContainerExtendedInfoResponse;
    /**
...
export interface InquiryInfoResponse {
     ...
     */
    inquiryDetails?: outputs.recoveryservices.v20221001.WorkloadInquiryDetailsResponse[];
    /**
...
export interface KPIResourceHealthDetailsResponse {
     ...
     */
    resourceHealthDetails?: outputs.recoveryservices.v20221001.ResourceHealthDetailsResponse[];
    /**
     * Resource Health Status
     */
...
export interface LongTermRetentionPolicyResponse {
     ...
     */
    dailySchedule?: outputs.recoveryservices.v20221001.DailyRetentionScheduleResponse;
    /**
     * Monthly retention schedule of the protection policy.
     */
    monthlySchedule?: outputs.recoveryservices.v20221001.MonthlyRetentionScheduleResponse;
    /**
     * This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
     ...
     */
    weeklySchedule?: outputs.recoveryservices.v20221001.WeeklyRetentionScheduleResponse;
    /**
     * Yearly retention schedule of the protection policy.
     */
    yearlySchedule?: outputs.recoveryservices.v20221001.YearlyRetentionScheduleResponse;
}
...
export interface MabContainerResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20221001.MabContainerExtendedInfoResponse;
    /**
     * Friendly name of the container.
     */
    friendlyName?: string;
     ...
     */
    mabContainerHealthDetails?: outputs.recoveryservices.v20221001.MABContainerHealthDetailsResponse[];
    /**
     * Type of the protectable object associated with this container
     */
    protectableObjectType?: string;
...
export interface MabFileFolderProtectedItemResponse {
     ...
     * Additional information with this backup item.
     */
    extendedInfo?: outputs.recoveryservices.v20221001.MabFileFolderProtectedItemExtendedInfoResponse;
    /**
...
export interface MonthlyRetentionScheduleResponse {
     ...
     */
    retentionScheduleDaily?: outputs.recoveryservices.v20221001.DailyRetentionFormatResponse;
    /**
     ...
     */
    retentionScheduleWeekly?: outputs.recoveryservices.v20221001.WeeklyRetentionFormatResponse;
    /**
     * Retention times of retention policy.
     */
    retentionTimes?: string[];
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateLinkServiceConnectionState?: outputs.recoveryservices.v20221001.PrivateLinkServiceConnectionStateResponse;
    /**
...
export interface ResourceGuardProxyBaseResponse {
    description?: string;
    lastUpdatedTime?: string;
    resourceGuardOperationDetails?: outputs.recoveryservices.v20221001.ResourceGuardOperationDetailResponse[];
...
export interface SimpleSchedulePolicyResponse {
     ...
     */
    hourlySchedule?: outputs.recoveryservices.v20221001.HourlyScheduleResponse;
    /**
     * This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
...
export interface SimpleSchedulePolicyV2Response {
     ...
     */
    dailySchedule?: outputs.recoveryservices.v20221001.DailyScheduleResponse;
    /**
     * hourly schedule of this policy
     */
    hourlySchedule?: outputs.recoveryservices.v20221001.HourlyScheduleResponse;
     ...
     */
    weeklySchedule?: outputs.recoveryservices.v20221001.WeeklyScheduleResponse;
}
...
export interface WorkloadInquiryDetailsResponse {
     ...
     */
    inquiryValidation?: outputs.recoveryservices.v20221001.InquiryValidationResponse;
    /**
