...
export interface AzureBackupServerContainerResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20210101.DPMContainerExtendedInfoResponse;
    /**
...
export interface AzureFileShareProtectionPolicyResponse {
     ...
     */
    retentionPolicy?: outputs.recoveryservices.v20210101.LongTermRetentionPolicyResponse | outputs.recoveryservices.v20210101.SimpleRetentionPolicyResponse;
    /**
     * Backup schedule specified as part of backup policy.
     */
    schedulePolicy?: outputs.recoveryservices.v20210101.LogSchedulePolicyResponse | outputs.recoveryservices.v20210101.LongTermSchedulePolicyResponse | outputs.recoveryservices.v20210101.SimpleSchedulePolicyResponse;
    /**
...
export interface AzureFileshareProtectedItemResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20210101.AzureFileshareProtectedItemExtendedInfoResponse;
    /**
     ...
     */
    kpisHealths?: {[key: string]: outputs.recoveryservices.v20210101.KPIResourceHealthDetailsResponse};
    /**
...
export interface AzureIaaSClassicComputeVMProtectedItemResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20210101.AzureIaaSVMProtectedItemExtendedInfoResponse;
    /**
     * Extended Properties for Azure IaasVM Backup.
     */
    extendedProperties?: outputs.recoveryservices.v20210101.ExtendedPropertiesResponse;
    /**
     ...
     */
    healthDetails?: outputs.recoveryservices.v20210101.AzureIaaSVMHealthDetailsResponse[];
    /**
...
export interface AzureIaaSVMProtectionPolicyResponse {
    ...
    instantRPDetails?: outputs.recoveryservices.v20210101.InstantRPAdditionalDetailsResponse;
    /**
...
export interface AzureSQLAGWorkloadContainerProtectionContainerResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20210101.AzureWorkloadContainerExtendedInfoResponse;
    /**
     * Friendly name of the container.
     */
    friendlyName?: string;
...
export interface AzureSqlProtectedItemResponse {
     ...
     * Additional information for this backup item.
     */
    extendedInfo?: outputs.recoveryservices.v20210101.AzureSqlProtectedItemExtendedInfoResponse;
    /**
     * Flag to identify whether the deferred deleted DS is to be purged soon
     */
    isDeferredDeleteScheduleUpcoming?: boolean;
...
export interface AzureVmWorkloadProtectedItemResponse {
     ...
     * Additional information for this backup item.
     */
    extendedInfo?: outputs.recoveryservices.v20210101.AzureVmWorkloadProtectedItemExtendedInfoResponse;
    /**
     ...
     */
    lastBackupErrorDetail?: outputs.recoveryservices.v20210101.ErrorDetailResponse;
    /**
     * Last backup operation status. Possible values: Healthy, Unhealthy.
     */
    lastBackupStatus?: string;
...
export interface AzureVmWorkloadProtectionPolicyResponse {
     ...
     */
    settings?: outputs.recoveryservices.v20210101.SettingsResponse;
    /**
     * List of sub-protection policies which includes schedule and retention
     */
    subProtectionPolicy?: outputs.recoveryservices.v20210101.SubProtectionPolicyResponse[];
    /**
     * Type of workload for the backup management
     */
    workLoadType?: string;
...
export interface AzureWorkloadContainerExtendedInfoResponse {
     ...
     */
    inquiryInfo?: outputs.recoveryservices.v20210101.InquiryInfoResponse;
    /**
     * List of the nodes in case of distributed container.
     */
    nodesList?: outputs.recoveryservices.v20210101.DistributedNodesInfoResponse[];
}
...
export interface DPMProtectedItemResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20210101.DPMProtectedItemExtendedInfoResponse;
    /**
...
export interface DailyRetentionFormatResponse {
     ...
     */
    daysOfTheMonth?: outputs.recoveryservices.v20210101.DayResponse[];
}
...
export interface DailyRetentionScheduleResponse {
     ...
     */
    retentionDuration?: outputs.recoveryservices.v20210101.RetentionDurationResponse;
    /**
...
export interface DistributedNodesInfoResponse {
     ...
     */
    errorDetail?: outputs.recoveryservices.v20210101.ErrorDetailResponse;
    /**
...
export interface ExtendedPropertiesResponse {
     ...
     */
    diskExclusionProperties?: outputs.recoveryservices.v20210101.DiskExclusionPropertiesResponse;
}
...
export interface GenericContainerExtendedInfoResponse {
     ...
     * Container identity information
     */
    containerIdentityInfo?: outputs.recoveryservices.v20210101.ContainerIdentityInfoResponse;
    /**
...
export interface GenericContainerResponse {
     ...
     */
    extendedInformation?: outputs.recoveryservices.v20210101.GenericContainerExtendedInfoResponse;
    /**
...
export interface IdentityDataResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.recoveryservices.v20210101.UserIdentityResponse};
}
...
export interface InquiryInfoResponse {
     ...
     */
    inquiryDetails?: outputs.recoveryservices.v20210101.WorkloadInquiryDetailsResponse[];
    /**
...
export interface KPIResourceHealthDetailsResponse {
     ...
     */
    resourceHealthDetails?: outputs.recoveryservices.v20210101.ResourceHealthDetailsResponse[];
    /**
     * Resource Health Status
     */
...
export interface LongTermRetentionPolicyResponse {
     ...
     */
    dailySchedule?: outputs.recoveryservices.v20210101.DailyRetentionScheduleResponse;
    /**
     * Monthly retention schedule of the protection policy.
     */
    monthlySchedule?: outputs.recoveryservices.v20210101.MonthlyRetentionScheduleResponse;
    /**
     * This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
     ...
     */
    weeklySchedule?: outputs.recoveryservices.v20210101.WeeklyRetentionScheduleResponse;
    /**
     * Yearly retention schedule of the protection policy.
     */
    yearlySchedule?: outputs.recoveryservices.v20210101.YearlyRetentionScheduleResponse;
}
...
export interface MabContainerResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20210101.MabContainerExtendedInfoResponse;
    /**
     * Friendly name of the container.
     */
    friendlyName?: string;
     ...
     */
    mabContainerHealthDetails?: outputs.recoveryservices.v20210101.MABContainerHealthDetailsResponse[];
    /**
     * Number of items backed up in this container.
     */
    protectedItemCount?: number;
...
export interface MabFileFolderProtectedItemResponse {
     ...
     * Additional information with this backup item.
     */
    extendedInfo?: outputs.recoveryservices.v20210101.MabFileFolderProtectedItemExtendedInfoResponse;
    /**
...
export interface MonthlyRetentionScheduleResponse {
     ...
     */
    retentionScheduleDaily?: outputs.recoveryservices.v20210101.DailyRetentionFormatResponse;
    /**
     ...
     */
    retentionScheduleWeekly?: outputs.recoveryservices.v20210101.WeeklyRetentionFormatResponse;
    /**
     * Retention times of retention policy.
     */
    retentionTimes?: string[];
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.recoveryservices.v20210101.PrivateEndpointResponse;
    /**
     * Gets or sets private link service connection state
     */
    privateLinkServiceConnectionState?: outputs.recoveryservices.v20210101.PrivateLinkServiceConnectionStateResponse;
    /**
...
export interface PrivateEndpointConnectionVaultPropertiesResponse {
     ...
     * Private Endpoint Connection Response Properties.
     */
    properties: outputs.recoveryservices.v20210101.VaultPrivateEndpointConnectionResponse;
}
...
export interface VaultPrivateEndpointConnectionResponse {
     ...
     * Gets or sets private link service connection state.
     */
    privateLinkServiceConnectionState: outputs.recoveryservices.v20210101.VaultPrivateLinkServiceConnectionStateResponse;
    /**
     * Gets or sets provisioning state of the private endpoint connection.
     */
    provisioningState: string;
...
export interface VaultPropertiesResponse {
     ...
     */
    encryption?: outputs.recoveryservices.v20210101.VaultPropertiesResponseEncryption;
    /**
     * List of private endpoint connection.
     */
    privateEndpointConnections: outputs.recoveryservices.v20210101.PrivateEndpointConnectionVaultPropertiesResponse[];
    /**
     ...
     * Details for upgrading vault.
     */
    upgradeDetails?: outputs.recoveryservices.v20210101.UpgradeDetailsResponse;
}
...
export interface VaultPropertiesResponseEncryption {
     ...
     * The details of the identity used for CMK
     */
    kekIdentity?: outputs.recoveryservices.v20210101.CmkKekIdentityResponse;
    /**
     * The properties of the Key Vault which hosts CMK
     */
    keyVaultProperties?: outputs.recoveryservices.v20210101.CmkKeyVaultPropertiesResponse;
}
...
export interface WorkloadInquiryDetailsResponse {
     ...
     */
    inquiryValidation?: outputs.recoveryservices.v20210101.InquiryValidationResponse;
    /**
