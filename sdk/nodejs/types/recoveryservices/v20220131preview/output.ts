...
export interface IdentityDataResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.recoveryservices.v20220131preview.UserIdentityResponse};
}
...
export interface PrivateEndpointConnectionVaultPropertiesResponse {
     ...
     */
    properties: outputs.recoveryservices.v20220131preview.VaultPrivateEndpointConnectionResponse;
    /**
...
export interface VaultPrivateEndpointConnectionResponse {
     ...
     * The Private Endpoint network resource that is linked to the Private Endpoint connection.
     */
    privateEndpoint: outputs.recoveryservices.v20220131preview.PrivateEndpointResponse;
    /**
     * Gets or sets private link service connection state.
     */
    privateLinkServiceConnectionState: outputs.recoveryservices.v20220131preview.VaultPrivateLinkServiceConnectionStateResponse;
    /**
...
export interface VaultPropertiesResponse {
     ...
     */
    encryption?: outputs.recoveryservices.v20220131preview.VaultPropertiesResponseEncryption;
    /**
     * The details of the latest move operation performed on the Azure Resource
     */
    moveDetails?: outputs.recoveryservices.v20220131preview.VaultPropertiesResponseMoveDetails;
    /**
     ...
     */
    privateEndpointConnections: outputs.recoveryservices.v20220131preview.PrivateEndpointConnectionVaultPropertiesResponse[];
    /**
     ...
     * Details for upgrading vault.
     */
    upgradeDetails?: outputs.recoveryservices.v20220131preview.UpgradeDetailsResponse;
}
...
export interface VaultPropertiesResponseEncryption {
     ...
     * The details of the identity used for CMK
     */
    kekIdentity?: outputs.recoveryservices.v20220131preview.CmkKekIdentityResponse;
    /**
     * The properties of the Key Vault which hosts CMK
     */
    keyVaultProperties?: outputs.recoveryservices.v20220131preview.CmkKeyVaultPropertiesResponse;
}
