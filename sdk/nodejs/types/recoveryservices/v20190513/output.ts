...
export interface AzureFileshareProtectedItemResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20190513.AzureFileshareProtectedItemExtendedInfoResponse;
    /**
...
export interface AzureIaaSClassicComputeVMProtectedItemResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20190513.AzureIaaSVMProtectedItemExtendedInfoResponse;
    /**
     * Extended Properties for Azure IaasVM Backup.
     */
    extendedProperties?: outputs.recoveryservices.v20190513.ExtendedPropertiesResponse;
    /**
     ...
     */
    healthDetails?: outputs.recoveryservices.v20190513.AzureIaaSVMHealthDetailsResponse[];
    /**
...
export interface AzureSqlProtectedItemResponse {
     ...
     * Additional information for this backup item.
     */
    extendedInfo?: outputs.recoveryservices.v20190513.AzureSqlProtectedItemExtendedInfoResponse;
    /**
     * Flag to identify whether the deferred deleted DS is to be purged soon
     */
    isDeferredDeleteScheduleUpcoming?: boolean;
...
export interface AzureVmWorkloadProtectedItemResponse {
     ...
     * Additional information for this backup item.
     */
    extendedInfo?: outputs.recoveryservices.v20190513.AzureVmWorkloadProtectedItemExtendedInfoResponse;
    /**
     ...
     */
    lastBackupErrorDetail?: outputs.recoveryservices.v20190513.ErrorDetailResponse;
    /**
     * Last backup operation status. Possible values: Healthy, Unhealthy.
     */
    lastBackupStatus?: string;
...
export interface DPMProtectedItemResponse {
     ...
     */
    extendedInfo?: outputs.recoveryservices.v20190513.DPMProtectedItemExtendedInfoResponse;
    /**
...
export interface ExtendedPropertiesResponse {
     ...
     */
    diskExclusionProperties?: outputs.recoveryservices.v20190513.DiskExclusionPropertiesResponse;
}
...
export interface MabFileFolderProtectedItemResponse {
     ...
     * Additional information with this backup item.
     */
    extendedInfo?: outputs.recoveryservices.v20190513.MabFileFolderProtectedItemExtendedInfoResponse;
    /**
