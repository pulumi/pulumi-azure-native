...
export interface A2AContainerMappingInputArgs {
     ...
     */
    agentAutoUpdateStatus?: pulumi.Input<string | enums.recoveryservices.v20180710.AgentAutoUpdateStatus>;
    /**
...
export interface A2AEnableProtectionInputArgs {
     ...
     */
    diskEncryptionInfo?: pulumi.Input<inputs.recoveryservices.v20180710.DiskEncryptionInfoArgs>;
    /**
     ...
     */
    vmDisks?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20180710.A2AVmDiskInputDetailsArgs>[]>;
    /**
     * The list of vm managed disk details.
     */
    vmManagedDisks?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20180710.A2AVmManagedDiskInputDetailsArgs>[]>;
}
...
export interface A2APolicyCreationInputArgs {
     ...
     */
    multiVmSyncStatus: pulumi.Input<string | enums.recoveryservices.v20180710.SetMultiVmSyncStatus>;
    /**
...
export interface AddRecoveryServicesProviderInputPropertiesArgs {
     ...
     */
    authenticationIdentityInput: pulumi.Input<inputs.recoveryservices.v20180710.IdentityProviderInputArgs>;
    /**
     * The identity provider input for data plane authentication.
     */
    dataPlaneAuthenticationIdentityInput?: pulumi.Input<inputs.recoveryservices.v20180710.IdentityProviderInputArgs>;
    /**
     ...
     */
    resourceAccessIdentityInput: pulumi.Input<inputs.recoveryservices.v20180710.IdentityProviderInputArgs>;
}
...
export interface CreateNetworkMappingInputPropertiesArgs {
     ...
     */
    fabricSpecificDetails?: pulumi.Input<inputs.recoveryservices.v20180710.AzureToAzureCreateNetworkMappingInputArgs | inputs.recoveryservices.v20180710.VmmToAzureCreateNetworkMappingInputArgs | inputs.recoveryservices.v20180710.VmmToVmmCreateNetworkMappingInputArgs>;
    /**
...
export interface CreatePolicyInputPropertiesArgs {
     ...
     */
    providerSpecificInput?: pulumi.Input<inputs.recoveryservices.v20180710.A2APolicyCreationInputArgs | inputs.recoveryservices.v20180710.HyperVReplicaAzurePolicyInputArgs | inputs.recoveryservices.v20180710.HyperVReplicaBluePolicyInputArgs | inputs.recoveryservices.v20180710.HyperVReplicaPolicyInputArgs | inputs.recoveryservices.v20180710.InMageAzureV2PolicyInputArgs | inputs.recoveryservices.v20180710.InMagePolicyInputArgs | inputs.recoveryservices.v20180710.InMageRcmPolicyCreationInputArgs | inputs.recoveryservices.v20180710.VMwareCbtPolicyCreationInputArgs>;
}
...
export interface CreateProtectionContainerMappingInputPropertiesArgs {
     ...
     */
    providerSpecificInput?: pulumi.Input<inputs.recoveryservices.v20180710.A2AContainerMappingInputArgs | inputs.recoveryservices.v20180710.VMwareCbtContainerMappingInputArgs>;
    /**
...
export interface CreateRecoveryPlanInputPropertiesArgs {
     ...
     */
    failoverDeploymentModel?: pulumi.Input<string | enums.recoveryservices.v20180710.FailoverDeploymentModel>;
    /**
     * The recovery plan groups.
     */
    groups: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20180710.RecoveryPlanGroupArgs>[]>;
    /**
     ...
     */
    providerSpecificInput?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20180710.RecoveryPlanA2AInputArgs>[]>;
    /**
...
export interface DiskEncryptionInfoArgs {
     ...
     */
    diskEncryptionKeyInfo?: pulumi.Input<inputs.recoveryservices.v20180710.DiskEncryptionKeyInfoArgs>;
    /**
     * The recovery KeyVault reference for key.
     */
    keyEncryptionKeyInfo?: pulumi.Input<inputs.recoveryservices.v20180710.KeyEncryptionKeyInfoArgs>;
}
...
export interface EnableMigrationInputPropertiesArgs {
     ...
     */
    providerSpecificDetails: pulumi.Input<inputs.recoveryservices.v20180710.VMwareCbtEnableMigrationInputArgs>;
}
...
export interface EnableProtectionInputPropertiesArgs {
     ...
     */
    providerSpecificDetails?: pulumi.Input<inputs.recoveryservices.v20180710.A2AEnableProtectionInputArgs | inputs.recoveryservices.v20180710.HyperVReplicaAzureEnableProtectionInputArgs | inputs.recoveryservices.v20180710.InMageAzureV2EnableProtectionInputArgs | inputs.recoveryservices.v20180710.InMageEnableProtectionInputArgs | inputs.recoveryservices.v20180710.InMageRcmEnableProtectionInputArgs | inputs.recoveryservices.v20180710.SanEnableProtectionInputArgs>;
}
...
export interface FabricCreationInputPropertiesArgs {
     ...
     */
    customDetails?: pulumi.Input<inputs.recoveryservices.v20180710.AzureFabricCreationInputArgs | inputs.recoveryservices.v20180710.InMageRcmFabricCreationInputArgs | inputs.recoveryservices.v20180710.VMwareV2FabricCreationInputArgs>;
}
...
export interface InMageAzureV2DiskInputDetailsArgs {
     ...
     * The DiskType.
     */
    diskType?: pulumi.Input<string | enums.recoveryservices.v20180710.DiskAccountType>;
    /**
...
export interface InMageAzureV2EnableProtectionInputArgs {
     ...
     */
    disksToInclude?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20180710.InMageAzureV2DiskInputDetailsArgs>[]>;
    /**
     * The selected option to enable RDP\SSH on target vm after failover. String value of {SrsDataContract.EnableRDPOnTargetOption} enum.
     */
    enableRdpOnTargetOption?: pulumi.Input<string>;
...
export interface InMageDiskExclusionInputArgs {
     ...
     */
    diskSignatureOptions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20180710.InMageDiskSignatureExclusionOptionsArgs>[]>;
    /**
     * The volume label based option for disk exclusion.
     */
    volumeOptions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20180710.InMageVolumeExclusionOptionsArgs>[]>;
}
...
export interface InMageEnableProtectionInputArgs {
     ...
     */
    diskExclusionInput?: pulumi.Input<inputs.recoveryservices.v20180710.InMageDiskExclusionInputArgs>;
    /**
     * The disks to include list.
     */
    disksToInclude?: pulumi.Input<pulumi.Input<string>[]>;
...
export interface InMageRcmEnableProtectionInputArgs {
     ...
     */
    disksDefault?: pulumi.Input<inputs.recoveryservices.v20180710.InMageRcmDisksDefaultInputArgs>;
    /**
     * The disks to include list.
     */
    disksToInclude?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20180710.InMageRcmDiskInputArgs>[]>;
    /**
     ...
     * The license type.
     */
    licenseType?: pulumi.Input<string | enums.recoveryservices.v20180710.LicenseType>;
    /**
     * The multi VM group name.
     */
    multiVmGroupName?: pulumi.Input<string>;
...
export interface InMageRcmFabricCreationInputArgs {
     ...
     */
    authCertificate?: pulumi.Input<string>;
    /**
     * Gets the class type.
     * Expected value is 'InMageRcm'.
     */
     ...
     */
    sourceAgentIdentity?: pulumi.Input<inputs.recoveryservices.v20180710.IdentityProviderInputArgs>;
    /**
...
export interface RecoveryPlanActionArgs {
     ...
     */
    failoverDirections: pulumi.Input<pulumi.Input<string | enums.recoveryservices.v20180710.PossibleOperationsDirections>[]>;
    /**
     * The list of failover types.
     */
    failoverTypes: pulumi.Input<pulumi.Input<string | enums.recoveryservices.v20180710.ReplicationProtectedItemOperation>[]>;
}
...
export interface RecoveryPlanGroupArgs {
     ...
     */
    endGroupActions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20180710.RecoveryPlanActionArgs>[]>;
    /**
     * The group type.
     */
    groupType: pulumi.Input<string | enums.recoveryservices.v20180710.RecoveryPlanGroupType>;
    /**
     * The list of protected items.
     */
    replicationProtectedItems?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20180710.RecoveryPlanProtectedItemArgs>[]>;
    /**
     * The start group actions.
     */
    startGroupActions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20180710.RecoveryPlanActionArgs>[]>;
}
...
export interface VMwareCbtEnableMigrationInputArgs {
     ...
     * The disks to include list.
     */
    disksToInclude: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20180710.VMwareCbtDiskInputArgs>[]>;
    /**
     * The class type.
     * Expected value is 'VMwareCbt'.
     */
