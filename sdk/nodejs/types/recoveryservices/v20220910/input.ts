...
export interface A2AContainerMappingInputArgs {
     ...
     */
    agentAutoUpdateStatus?: pulumi.Input<string | enums.recoveryservices.v20220910.AgentAutoUpdateStatus>;
    /**
     ...
     */
    automationAccountAuthenticationType?: pulumi.Input<string | enums.recoveryservices.v20220910.AutomationAccountAuthenticationType>;
    /**
     * The class type.
...
export interface A2AEnableProtectionInputArgs {
     ...
     */
    diskEncryptionInfo?: pulumi.Input<inputs.recoveryservices.v20220910.DiskEncryptionInfoArgs>;
    /**
     * The fabric specific object Id of the virtual machine.
     */
    fabricObjectId: pulumi.Input<string>;
     ...
     */
    recoveryExtendedLocation?: pulumi.Input<inputs.recoveryservices.v20220910.ExtendedLocationArgs>;
    /**
     ...
     */
    vmDisks?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.A2AVmDiskInputDetailsArgs>[]>;
    /**
     * The list of vm managed disk details.
     */
    vmManagedDisks?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.A2AVmManagedDiskInputDetailsArgs>[]>;
}
...
export interface A2APolicyCreationInputArgs {
     ...
     */
    multiVmSyncStatus: pulumi.Input<string | enums.recoveryservices.v20220910.SetMultiVmSyncStatus>;
    /**
...
export interface AddRecoveryServicesProviderInputPropertiesArgs {
     ...
     */
    authenticationIdentityInput: pulumi.Input<inputs.recoveryservices.v20220910.IdentityProviderInputArgs>;
    /**
     ...
     */
    dataPlaneAuthenticationIdentityInput?: pulumi.Input<inputs.recoveryservices.v20220910.IdentityProviderInputArgs>;
    /**
     ...
     */
    resourceAccessIdentityInput: pulumi.Input<inputs.recoveryservices.v20220910.IdentityProviderInputArgs>;
}
...
export interface AzureMonitorAlertSettingsArgs {
    alertsForAllJobFailures?: pulumi.Input<string | enums.recoveryservices.v20220910.AlertsState>;
}
...
export interface ClassicAlertSettingsArgs {
    alertsForCriticalOperations?: pulumi.Input<string | enums.recoveryservices.v20220910.AlertsState>;
}
...
export interface CreateNetworkMappingInputPropertiesArgs {
     ...
     */
    fabricSpecificDetails?: pulumi.Input<inputs.recoveryservices.v20220910.AzureToAzureCreateNetworkMappingInputArgs | inputs.recoveryservices.v20220910.VmmToAzureCreateNetworkMappingInputArgs | inputs.recoveryservices.v20220910.VmmToVmmCreateNetworkMappingInputArgs>;
    /**
...
export interface CreatePolicyInputPropertiesArgs {
     ...
     */
    providerSpecificInput?: pulumi.Input<inputs.recoveryservices.v20220910.A2ACrossClusterMigrationPolicyCreationInputArgs | inputs.recoveryservices.v20220910.A2APolicyCreationInputArgs | inputs.recoveryservices.v20220910.HyperVReplicaAzurePolicyInputArgs | inputs.recoveryservices.v20220910.HyperVReplicaBluePolicyInputArgs | inputs.recoveryservices.v20220910.HyperVReplicaPolicyInputArgs | inputs.recoveryservices.v20220910.InMageAzureV2PolicyInputArgs | inputs.recoveryservices.v20220910.InMagePolicyInputArgs | inputs.recoveryservices.v20220910.InMageRcmFailbackPolicyCreationInputArgs | inputs.recoveryservices.v20220910.InMageRcmPolicyCreationInputArgs | inputs.recoveryservices.v20220910.VMwareCbtPolicyCreationInputArgs>;
}
...
export interface CreateProtectionContainerMappingInputPropertiesArgs {
     ...
     */
    providerSpecificInput?: pulumi.Input<inputs.recoveryservices.v20220910.A2AContainerMappingInputArgs | inputs.recoveryservices.v20220910.VMwareCbtContainerMappingInputArgs>;
    /**
...
export interface CreateRecoveryPlanInputPropertiesArgs {
     ...
     */
    failoverDeploymentModel?: pulumi.Input<string | enums.recoveryservices.v20220910.FailoverDeploymentModel>;
    /**
     * The recovery plan groups.
     */
    groups: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.RecoveryPlanGroupArgs>[]>;
    /**
     ...
     */
    providerSpecificInput?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.RecoveryPlanA2AInputArgs>[]>;
    /**
...
export interface DiskEncryptionInfoArgs {
     ...
     */
    diskEncryptionKeyInfo?: pulumi.Input<inputs.recoveryservices.v20220910.DiskEncryptionKeyInfoArgs>;
    /**
     * The recovery KeyVault reference for key.
     */
    keyEncryptionKeyInfo?: pulumi.Input<inputs.recoveryservices.v20220910.KeyEncryptionKeyInfoArgs>;
}
...
export interface EnableMigrationInputPropertiesArgs {
     ...
     */
    providerSpecificDetails: pulumi.Input<inputs.recoveryservices.v20220910.VMwareCbtEnableMigrationInputArgs>;
}
...
export interface EnableProtectionInputPropertiesArgs {
     ...
     */
    providerSpecificDetails?: pulumi.Input<inputs.recoveryservices.v20220910.A2ACrossClusterMigrationEnableProtectionInputArgs | inputs.recoveryservices.v20220910.A2AEnableProtectionInputArgs | inputs.recoveryservices.v20220910.HyperVReplicaAzureEnableProtectionInputArgs | inputs.recoveryservices.v20220910.InMageAzureV2EnableProtectionInputArgs | inputs.recoveryservices.v20220910.InMageEnableProtectionInputArgs | inputs.recoveryservices.v20220910.InMageRcmEnableProtectionInputArgs>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type: pulumi.Input<string | enums.recoveryservices.v20220910.ExtendedLocationType>;
}
...
export interface FabricCreationInputPropertiesArgs {
     ...
     */
    customDetails?: pulumi.Input<inputs.recoveryservices.v20220910.AzureFabricCreationInputArgs | inputs.recoveryservices.v20220910.InMageRcmFabricCreationInputArgs | inputs.recoveryservices.v20220910.VMwareV2FabricCreationInputArgs>;
}
...
export interface HyperVReplicaAzureDiskInputDetailsArgs {
     ...
     * The DiskType.
     */
    diskType?: pulumi.Input<string | enums.recoveryservices.v20220910.DiskAccountType>;
    /**
...
export interface HyperVReplicaAzureEnableProtectionInputArgs {
     ...
     */
    disksToIncludeForManagedDisks?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.HyperVReplicaAzureDiskInputDetailsArgs>[]>;
    /**
     ...
     * License type.
     */
    licenseType?: pulumi.Input<string | enums.recoveryservices.v20220910.LicenseType>;
    /**
     ...
     */
    sqlServerLicenseType?: pulumi.Input<string | enums.recoveryservices.v20220910.SqlServerLicenseType>;
    /**
...
export interface IdentityDataArgs {
     ...
     */
    type: pulumi.Input<string | enums.recoveryservices.v20220910.ResourceIdentityType>;
    /**
...
export interface ImmutabilitySettingsArgs {
    state?: pulumi.Input<string | enums.recoveryservices.v20220910.ImmutabilityState>;
}
...
export interface InMageAzureV2EnableProtectionInputArgs {
     ...
     */
    disksToInclude?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.InMageAzureV2DiskInputDetailsArgs>[]>;
    /**
     * The selected option to enable RDP\SSH on target VM after failover. String value of SrsDataContract.EnableRDPOnTargetOption enum.
     */
    enableRdpOnTargetOption?: pulumi.Input<string>;
...
export interface InMageDiskExclusionInputArgs {
     ...
     */
    diskSignatureOptions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.InMageDiskSignatureExclusionOptionsArgs>[]>;
    /**
     * The volume label based option for disk exclusion.
     */
    volumeOptions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.InMageVolumeExclusionOptionsArgs>[]>;
}
...
export interface InMageEnableProtectionInputArgs {
     ...
     */
    diskExclusionInput?: pulumi.Input<inputs.recoveryservices.v20220910.InMageDiskExclusionInputArgs>;
    /**
     * The disks to include list.
     */
    disksToInclude?: pulumi.Input<pulumi.Input<string>[]>;
...
export interface InMageRcmEnableProtectionInputArgs {
     ...
     */
    disksDefault?: pulumi.Input<inputs.recoveryservices.v20220910.InMageRcmDisksDefaultInputArgs>;
    /**
     * The disks to include list.
     */
    disksToInclude?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.InMageRcmDiskInputArgs>[]>;
    /**
...
export interface InMageRcmFabricCreationInputArgs {
     ...
     */
    sourceAgentIdentity: pulumi.Input<inputs.recoveryservices.v20220910.IdentityProviderInputArgs>;
    /**
...
export interface MonitoringSettingsArgs {
     ...
     * Settings for Azure Monitor based alerts
     */
    azureMonitorAlertSettings?: pulumi.Input<inputs.recoveryservices.v20220910.AzureMonitorAlertSettingsArgs>;
    /**
     * Settings for classic alerts
     */
    classicAlertSettings?: pulumi.Input<inputs.recoveryservices.v20220910.ClassicAlertSettingsArgs>;
}
...
export interface RecoveryPlanA2AInputArgs {
     ...
     */
    primaryExtendedLocation?: pulumi.Input<inputs.recoveryservices.v20220910.ExtendedLocationArgs>;
    /**
     * The primary zone.
     */
...
export interface RecoveryPlanActionArgs {
     ...
     * The custom details.
     */
    customDetails: pulumi.Input<inputs.recoveryservices.v20220910.RecoveryPlanAutomationRunbookActionDetailsArgs | inputs.recoveryservices.v20220910.RecoveryPlanManualActionDetailsArgs | inputs.recoveryservices.v20220910.RecoveryPlanScriptActionDetailsArgs>;
    /**
     * The list of failover directions.
     */
    failoverDirections: pulumi.Input<pulumi.Input<string | enums.recoveryservices.v20220910.PossibleOperationsDirections>[]>;
    /**
     * The list of failover types.
     */
    failoverTypes: pulumi.Input<pulumi.Input<string | enums.recoveryservices.v20220910.ReplicationProtectedItemOperation>[]>;
}
...
export interface RecoveryPlanAutomationRunbookActionDetailsArgs {
     ...
     * The fabric location.
     */
    fabricLocation: pulumi.Input<string | enums.recoveryservices.v20220910.RecoveryPlanActionLocation>;
    /**
...
export interface RecoveryPlanGroupArgs {
     ...
     */
    endGroupActions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.RecoveryPlanActionArgs>[]>;
    /**
     * The group type.
     */
    groupType: pulumi.Input<string | enums.recoveryservices.v20220910.RecoveryPlanGroupType>;
    /**
     * The list of protected items.
     */
    replicationProtectedItems?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.RecoveryPlanProtectedItemArgs>[]>;
    /**
     * The start group actions.
     */
    startGroupActions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.RecoveryPlanActionArgs>[]>;
}
...
export interface SecuritySettingsArgs {
     ...
     */
    immutabilitySettings?: pulumi.Input<inputs.recoveryservices.v20220910.ImmutabilitySettingsArgs>;
}
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<string | enums.recoveryservices.v20220910.SkuName>;
    /**
     * The sku size
     */
...
export interface VMwareCbtEnableMigrationInputArgs {
     ...
     * The disks to include list.
     */
    disksToInclude: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220910.VMwareCbtDiskInputArgs>[]>;
    /**
     * The class type.
     * Expected value is 'VMwareCbt'.
     */
...
export interface VaultPropertiesArgs {
     ...
     */
    encryption?: pulumi.Input<inputs.recoveryservices.v20220910.VaultPropertiesEncryptionArgs>;
    /**
     * Monitoring Settings of the vault
     */
    monitoringSettings?: pulumi.Input<inputs.recoveryservices.v20220910.MonitoringSettingsArgs>;
    /**
     * Security Settings of the vault
     */
    securitySettings?: pulumi.Input<inputs.recoveryservices.v20220910.SecuritySettingsArgs>;
}
...
export interface VaultPropertiesEncryptionArgs {
     ...
     */
    infrastructureEncryption?: pulumi.Input<string | enums.recoveryservices.v20220910.InfrastructureEncryptionState>;
    /**
     * The details of the identity used for CMK
     */
    kekIdentity?: pulumi.Input<inputs.recoveryservices.v20220910.CmkKekIdentityArgs>;
    /**
     * The properties of the Key Vault which hosts CMK
     */
    keyVaultProperties?: pulumi.Input<inputs.recoveryservices.v20220910.CmkKeyVaultPropertiesArgs>;
}
