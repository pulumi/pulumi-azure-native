...
export interface A2AContainerMappingInputArgs {
     ...
     */
    agentAutoUpdateStatus?: pulumi.Input<string | enums.recoveryservices.v20220501.AgentAutoUpdateStatus>;
    /**
     ...
     */
    automationAccountAuthenticationType?: pulumi.Input<string | enums.recoveryservices.v20220501.AutomationAccountAuthenticationType>;
    /**
     * The class type.
...
export interface A2AEnableProtectionInputArgs {
     ...
     */
    diskEncryptionInfo?: pulumi.Input<inputs.recoveryservices.v20220501.DiskEncryptionInfoArgs>;
    /**
     * The fabric specific object Id of the virtual machine.
     */
    fabricObjectId: pulumi.Input<string>;
     ...
     */
    recoveryExtendedLocation?: pulumi.Input<inputs.recoveryservices.v20220501.ExtendedLocationArgs>;
    /**
     ...
     */
    vmDisks?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.A2AVmDiskInputDetailsArgs>[]>;
    /**
     * The list of vm managed disk details.
     */
    vmManagedDisks?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.A2AVmManagedDiskInputDetailsArgs>[]>;
}
...
export interface A2APolicyCreationInputArgs {
     ...
     */
    multiVmSyncStatus: pulumi.Input<string | enums.recoveryservices.v20220501.SetMultiVmSyncStatus>;
    /**
...
export interface AddRecoveryServicesProviderInputPropertiesArgs {
     ...
     */
    authenticationIdentityInput: pulumi.Input<inputs.recoveryservices.v20220501.IdentityProviderInputArgs>;
    /**
     ...
     */
    dataPlaneAuthenticationIdentityInput?: pulumi.Input<inputs.recoveryservices.v20220501.IdentityProviderInputArgs>;
    /**
     ...
     */
    resourceAccessIdentityInput: pulumi.Input<inputs.recoveryservices.v20220501.IdentityProviderInputArgs>;
}
...
export interface AzureMonitorAlertSettingsArgs {
    alertsForAllJobFailures?: pulumi.Input<string | enums.recoveryservices.v20220501.AlertsState>;
}
...
export interface ClassicAlertSettingsArgs {
    alertsForCriticalOperations?: pulumi.Input<string | enums.recoveryservices.v20220501.AlertsState>;
}
...
export interface CreateNetworkMappingInputPropertiesArgs {
     ...
     */
    fabricSpecificDetails?: pulumi.Input<inputs.recoveryservices.v20220501.AzureToAzureCreateNetworkMappingInputArgs | inputs.recoveryservices.v20220501.VmmToAzureCreateNetworkMappingInputArgs | inputs.recoveryservices.v20220501.VmmToVmmCreateNetworkMappingInputArgs>;
    /**
...
export interface CreatePolicyInputPropertiesArgs {
     ...
     */
    providerSpecificInput?: pulumi.Input<inputs.recoveryservices.v20220501.A2ACrossClusterMigrationPolicyCreationInputArgs | inputs.recoveryservices.v20220501.A2APolicyCreationInputArgs | inputs.recoveryservices.v20220501.HyperVReplicaAzurePolicyInputArgs | inputs.recoveryservices.v20220501.HyperVReplicaBluePolicyInputArgs | inputs.recoveryservices.v20220501.HyperVReplicaPolicyInputArgs | inputs.recoveryservices.v20220501.InMageAzureV2PolicyInputArgs | inputs.recoveryservices.v20220501.InMagePolicyInputArgs | inputs.recoveryservices.v20220501.InMageRcmFailbackPolicyCreationInputArgs | inputs.recoveryservices.v20220501.InMageRcmPolicyCreationInputArgs | inputs.recoveryservices.v20220501.VMwareCbtPolicyCreationInputArgs>;
}
...
export interface CreateProtectionContainerMappingInputPropertiesArgs {
     ...
     */
    providerSpecificInput?: pulumi.Input<inputs.recoveryservices.v20220501.A2AContainerMappingInputArgs | inputs.recoveryservices.v20220501.VMwareCbtContainerMappingInputArgs>;
    /**
...
export interface CreateRecoveryPlanInputPropertiesArgs {
     ...
     */
    failoverDeploymentModel?: pulumi.Input<string | enums.recoveryservices.v20220501.FailoverDeploymentModel>;
    /**
     * The recovery plan groups.
     */
    groups: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.RecoveryPlanGroupArgs>[]>;
    /**
     ...
     */
    providerSpecificInput?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.RecoveryPlanA2AInputArgs>[]>;
    /**
...
export interface DiskEncryptionInfoArgs {
     ...
     */
    diskEncryptionKeyInfo?: pulumi.Input<inputs.recoveryservices.v20220501.DiskEncryptionKeyInfoArgs>;
    /**
     * The recovery KeyVault reference for key.
     */
    keyEncryptionKeyInfo?: pulumi.Input<inputs.recoveryservices.v20220501.KeyEncryptionKeyInfoArgs>;
}
...
export interface EnableMigrationInputPropertiesArgs {
     ...
     */
    providerSpecificDetails: pulumi.Input<inputs.recoveryservices.v20220501.VMwareCbtEnableMigrationInputArgs>;
}
...
export interface EnableProtectionInputPropertiesArgs {
     ...
     */
    providerSpecificDetails?: pulumi.Input<inputs.recoveryservices.v20220501.A2ACrossClusterMigrationEnableProtectionInputArgs | inputs.recoveryservices.v20220501.A2AEnableProtectionInputArgs | inputs.recoveryservices.v20220501.HyperVReplicaAzureEnableProtectionInputArgs | inputs.recoveryservices.v20220501.InMageAzureV2EnableProtectionInputArgs | inputs.recoveryservices.v20220501.InMageEnableProtectionInputArgs | inputs.recoveryservices.v20220501.InMageRcmEnableProtectionInputArgs>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type: pulumi.Input<string | enums.recoveryservices.v20220501.ExtendedLocationType>;
}
...
export interface FabricCreationInputPropertiesArgs {
     ...
     */
    customDetails?: pulumi.Input<inputs.recoveryservices.v20220501.AzureFabricCreationInputArgs | inputs.recoveryservices.v20220501.InMageRcmFabricCreationInputArgs | inputs.recoveryservices.v20220501.VMwareV2FabricCreationInputArgs>;
}
...
export interface HyperVReplicaAzureDiskInputDetailsArgs {
     ...
     * The DiskType.
     */
    diskType?: pulumi.Input<string | enums.recoveryservices.v20220501.DiskAccountType>;
    /**
...
export interface HyperVReplicaAzureEnableProtectionInputArgs {
     ...
     */
    disksToIncludeForManagedDisks?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.HyperVReplicaAzureDiskInputDetailsArgs>[]>;
    /**
     ...
     * License type.
     */
    licenseType?: pulumi.Input<string | enums.recoveryservices.v20220501.LicenseType>;
    /**
     ...
     */
    sqlServerLicenseType?: pulumi.Input<string | enums.recoveryservices.v20220501.SqlServerLicenseType>;
    /**
...
export interface IdentityDataArgs {
     ...
     */
    type: pulumi.Input<string | enums.recoveryservices.v20220501.ResourceIdentityType>;
    /**
...
export interface InMageAzureV2EnableProtectionInputArgs {
     ...
     */
    disksToInclude?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.InMageAzureV2DiskInputDetailsArgs>[]>;
    /**
     * The selected option to enable RDP\SSH on target VM after failover. String value of SrsDataContract.EnableRDPOnTargetOption enum.
     */
    enableRdpOnTargetOption?: pulumi.Input<string>;
...
export interface InMageDiskExclusionInputArgs {
     ...
     */
    diskSignatureOptions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.InMageDiskSignatureExclusionOptionsArgs>[]>;
    /**
     * The volume label based option for disk exclusion.
     */
    volumeOptions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.InMageVolumeExclusionOptionsArgs>[]>;
}
...
export interface InMageEnableProtectionInputArgs {
     ...
     */
    diskExclusionInput?: pulumi.Input<inputs.recoveryservices.v20220501.InMageDiskExclusionInputArgs>;
    /**
     * The disks to include list.
     */
    disksToInclude?: pulumi.Input<pulumi.Input<string>[]>;
...
export interface InMageRcmEnableProtectionInputArgs {
     ...
     */
    disksDefault?: pulumi.Input<inputs.recoveryservices.v20220501.InMageRcmDisksDefaultInputArgs>;
    /**
     * The disks to include list.
     */
    disksToInclude?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.InMageRcmDiskInputArgs>[]>;
    /**
...
export interface InMageRcmFabricCreationInputArgs {
     ...
     */
    sourceAgentIdentity: pulumi.Input<inputs.recoveryservices.v20220501.IdentityProviderInputArgs>;
    /**
...
export interface MonitoringSettingsArgs {
     ...
     * Settings for Azure Monitor based alerts
     */
    azureMonitorAlertSettings?: pulumi.Input<inputs.recoveryservices.v20220501.AzureMonitorAlertSettingsArgs>;
    /**
     * Settings for classic alerts
     */
    classicAlertSettings?: pulumi.Input<inputs.recoveryservices.v20220501.ClassicAlertSettingsArgs>;
}
...
export interface RecoveryPlanA2AInputArgs {
     ...
     */
    primaryExtendedLocation?: pulumi.Input<inputs.recoveryservices.v20220501.ExtendedLocationArgs>;
    /**
     * The primary zone.
     */
...
export interface RecoveryPlanActionArgs {
     ...
     * The custom details.
     */
    customDetails: pulumi.Input<inputs.recoveryservices.v20220501.RecoveryPlanAutomationRunbookActionDetailsArgs | inputs.recoveryservices.v20220501.RecoveryPlanManualActionDetailsArgs | inputs.recoveryservices.v20220501.RecoveryPlanScriptActionDetailsArgs>;
    /**
     * The list of failover directions.
     */
    failoverDirections: pulumi.Input<pulumi.Input<string | enums.recoveryservices.v20220501.PossibleOperationsDirections>[]>;
    /**
     * The list of failover types.
     */
    failoverTypes: pulumi.Input<pulumi.Input<string | enums.recoveryservices.v20220501.ReplicationProtectedItemOperation>[]>;
}
...
export interface RecoveryPlanAutomationRunbookActionDetailsArgs {
     ...
     * The fabric location.
     */
    fabricLocation: pulumi.Input<string | enums.recoveryservices.v20220501.RecoveryPlanActionLocation>;
    /**
...
export interface RecoveryPlanGroupArgs {
     ...
     */
    endGroupActions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.RecoveryPlanActionArgs>[]>;
    /**
     * The group type.
     */
    groupType: pulumi.Input<string | enums.recoveryservices.v20220501.RecoveryPlanGroupType>;
    /**
     * The list of protected items.
     */
    replicationProtectedItems?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.RecoveryPlanProtectedItemArgs>[]>;
    /**
     * The start group actions.
     */
    startGroupActions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.RecoveryPlanActionArgs>[]>;
}
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<string | enums.recoveryservices.v20220501.SkuName>;
    /**
     * The sku size
     */
...
export interface VMwareCbtEnableMigrationInputArgs {
     ...
     * The disks to include list.
     */
    disksToInclude: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220501.VMwareCbtDiskInputArgs>[]>;
    /**
     * The class type.
     * Expected value is 'VMwareCbt'.
     */
...
export interface VaultPropertiesArgs {
     ...
     */
    encryption?: pulumi.Input<inputs.recoveryservices.v20220501.VaultPropertiesEncryptionArgs>;
    /**
     * Monitoring Settings of the vault
     */
    monitoringSettings?: pulumi.Input<inputs.recoveryservices.v20220501.MonitoringSettingsArgs>;
}
...
export interface VaultPropertiesEncryptionArgs {
     ...
     */
    infrastructureEncryption?: pulumi.Input<string | enums.recoveryservices.v20220501.InfrastructureEncryptionState>;
    /**
     * The details of the identity used for CMK
     */
    kekIdentity?: pulumi.Input<inputs.recoveryservices.v20220501.CmkKekIdentityArgs>;
    /**
     * The properties of the Key Vault which hosts CMK
     */
    keyVaultProperties?: pulumi.Input<inputs.recoveryservices.v20220501.CmkKeyVaultPropertiesArgs>;
}
