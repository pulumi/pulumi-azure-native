...
export interface A2AContainerMappingInputArgs {
     ...
     */
    agentAutoUpdateStatus?: pulumi.Input<string | enums.recoveryservices.v20220801.AgentAutoUpdateStatus>;
    /**
     ...
     */
    automationAccountAuthenticationType?: pulumi.Input<string | enums.recoveryservices.v20220801.AutomationAccountAuthenticationType>;
    /**
     * The class type.
...
export interface A2AEnableProtectionInputArgs {
     ...
     */
    diskEncryptionInfo?: pulumi.Input<inputs.recoveryservices.v20220801.DiskEncryptionInfoArgs>;
    /**
     * The fabric specific object Id of the virtual machine.
     */
    fabricObjectId: pulumi.Input<string>;
     ...
     */
    recoveryExtendedLocation?: pulumi.Input<inputs.recoveryservices.v20220801.ExtendedLocationArgs>;
    /**
     ...
     */
    vmDisks?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.A2AVmDiskInputDetailsArgs>[]>;
    /**
     * The list of vm managed disk details.
     */
    vmManagedDisks?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.A2AVmManagedDiskInputDetailsArgs>[]>;
}
...
export interface A2APolicyCreationInputArgs {
     ...
     */
    multiVmSyncStatus: pulumi.Input<string | enums.recoveryservices.v20220801.SetMultiVmSyncStatus>;
    /**
...
export interface AddRecoveryServicesProviderInputPropertiesArgs {
     ...
     */
    authenticationIdentityInput: pulumi.Input<inputs.recoveryservices.v20220801.IdentityProviderInputArgs>;
    /**
     ...
     */
    dataPlaneAuthenticationIdentityInput?: pulumi.Input<inputs.recoveryservices.v20220801.IdentityProviderInputArgs>;
    /**
     ...
     */
    resourceAccessIdentityInput: pulumi.Input<inputs.recoveryservices.v20220801.IdentityProviderInputArgs>;
}
...
export interface AzureMonitorAlertSettingsArgs {
    alertsForAllJobFailures?: pulumi.Input<string | enums.recoveryservices.v20220801.AlertsState>;
}
...
export interface ClassicAlertSettingsArgs {
    alertsForCriticalOperations?: pulumi.Input<string | enums.recoveryservices.v20220801.AlertsState>;
}
...
export interface CreateNetworkMappingInputPropertiesArgs {
     ...
     */
    fabricSpecificDetails?: pulumi.Input<inputs.recoveryservices.v20220801.AzureToAzureCreateNetworkMappingInputArgs | inputs.recoveryservices.v20220801.VmmToAzureCreateNetworkMappingInputArgs | inputs.recoveryservices.v20220801.VmmToVmmCreateNetworkMappingInputArgs>;
    /**
...
export interface CreatePolicyInputPropertiesArgs {
     ...
     */
    providerSpecificInput?: pulumi.Input<inputs.recoveryservices.v20220801.A2ACrossClusterMigrationPolicyCreationInputArgs | inputs.recoveryservices.v20220801.A2APolicyCreationInputArgs | inputs.recoveryservices.v20220801.HyperVReplicaAzurePolicyInputArgs | inputs.recoveryservices.v20220801.HyperVReplicaBluePolicyInputArgs | inputs.recoveryservices.v20220801.HyperVReplicaPolicyInputArgs | inputs.recoveryservices.v20220801.InMageAzureV2PolicyInputArgs | inputs.recoveryservices.v20220801.InMagePolicyInputArgs | inputs.recoveryservices.v20220801.InMageRcmFailbackPolicyCreationInputArgs | inputs.recoveryservices.v20220801.InMageRcmPolicyCreationInputArgs | inputs.recoveryservices.v20220801.VMwareCbtPolicyCreationInputArgs>;
}
...
export interface CreateProtectionContainerMappingInputPropertiesArgs {
     ...
     */
    providerSpecificInput?: pulumi.Input<inputs.recoveryservices.v20220801.A2AContainerMappingInputArgs | inputs.recoveryservices.v20220801.VMwareCbtContainerMappingInputArgs>;
    /**
...
export interface CreateRecoveryPlanInputPropertiesArgs {
     ...
     */
    failoverDeploymentModel?: pulumi.Input<string | enums.recoveryservices.v20220801.FailoverDeploymentModel>;
    /**
     * The recovery plan groups.
     */
    groups: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.RecoveryPlanGroupArgs>[]>;
    /**
     ...
     */
    providerSpecificInput?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.RecoveryPlanA2AInputArgs>[]>;
    /**
...
export interface DiskEncryptionInfoArgs {
     ...
     */
    diskEncryptionKeyInfo?: pulumi.Input<inputs.recoveryservices.v20220801.DiskEncryptionKeyInfoArgs>;
    /**
     * The recovery KeyVault reference for key.
     */
    keyEncryptionKeyInfo?: pulumi.Input<inputs.recoveryservices.v20220801.KeyEncryptionKeyInfoArgs>;
}
...
export interface EnableMigrationInputPropertiesArgs {
     ...
     */
    providerSpecificDetails: pulumi.Input<inputs.recoveryservices.v20220801.VMwareCbtEnableMigrationInputArgs>;
}
...
export interface EnableProtectionInputPropertiesArgs {
     ...
     */
    providerSpecificDetails?: pulumi.Input<inputs.recoveryservices.v20220801.A2ACrossClusterMigrationEnableProtectionInputArgs | inputs.recoveryservices.v20220801.A2AEnableProtectionInputArgs | inputs.recoveryservices.v20220801.HyperVReplicaAzureEnableProtectionInputArgs | inputs.recoveryservices.v20220801.InMageAzureV2EnableProtectionInputArgs | inputs.recoveryservices.v20220801.InMageEnableProtectionInputArgs | inputs.recoveryservices.v20220801.InMageRcmEnableProtectionInputArgs>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type: pulumi.Input<string | enums.recoveryservices.v20220801.ExtendedLocationType>;
}
...
export interface FabricCreationInputPropertiesArgs {
     ...
     */
    customDetails?: pulumi.Input<inputs.recoveryservices.v20220801.AzureFabricCreationInputArgs | inputs.recoveryservices.v20220801.InMageRcmFabricCreationInputArgs | inputs.recoveryservices.v20220801.VMwareV2FabricCreationInputArgs>;
}
...
export interface HyperVReplicaAzureDiskInputDetailsArgs {
     ...
     * The DiskType.
     */
    diskType?: pulumi.Input<string | enums.recoveryservices.v20220801.DiskAccountType>;
    /**
...
export interface HyperVReplicaAzureEnableProtectionInputArgs {
     ...
     */
    disksToIncludeForManagedDisks?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.HyperVReplicaAzureDiskInputDetailsArgs>[]>;
    /**
     ...
     * License type.
     */
    licenseType?: pulumi.Input<string | enums.recoveryservices.v20220801.LicenseType>;
    /**
     ...
     */
    sqlServerLicenseType?: pulumi.Input<string | enums.recoveryservices.v20220801.SqlServerLicenseType>;
    /**
...
export interface IdentityDataArgs {
     ...
     */
    type: pulumi.Input<string | enums.recoveryservices.v20220801.ResourceIdentityType>;
    /**
...
export interface ImmutabilitySettingsArgs {
    state?: pulumi.Input<string | enums.recoveryservices.v20220801.ImmutabilityState>;
}
...
export interface InMageAzureV2EnableProtectionInputArgs {
     ...
     */
    disksToInclude?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.InMageAzureV2DiskInputDetailsArgs>[]>;
    /**
     * The selected option to enable RDP\SSH on target VM after failover. String value of SrsDataContract.EnableRDPOnTargetOption enum.
     */
    enableRdpOnTargetOption?: pulumi.Input<string>;
...
export interface InMageDiskExclusionInputArgs {
     ...
     */
    diskSignatureOptions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.InMageDiskSignatureExclusionOptionsArgs>[]>;
    /**
     * The volume label based option for disk exclusion.
     */
    volumeOptions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.InMageVolumeExclusionOptionsArgs>[]>;
}
...
export interface InMageEnableProtectionInputArgs {
     ...
     */
    diskExclusionInput?: pulumi.Input<inputs.recoveryservices.v20220801.InMageDiskExclusionInputArgs>;
    /**
     * The disks to include list.
     */
    disksToInclude?: pulumi.Input<pulumi.Input<string>[]>;
...
export interface InMageRcmEnableProtectionInputArgs {
     ...
     */
    disksDefault?: pulumi.Input<inputs.recoveryservices.v20220801.InMageRcmDisksDefaultInputArgs>;
    /**
     * The disks to include list.
     */
    disksToInclude?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.InMageRcmDiskInputArgs>[]>;
    /**
...
export interface InMageRcmFabricCreationInputArgs {
     ...
     */
    sourceAgentIdentity: pulumi.Input<inputs.recoveryservices.v20220801.IdentityProviderInputArgs>;
    /**
...
export interface MonitoringSettingsArgs {
     ...
     * Settings for Azure Monitor based alerts
     */
    azureMonitorAlertSettings?: pulumi.Input<inputs.recoveryservices.v20220801.AzureMonitorAlertSettingsArgs>;
    /**
     * Settings for classic alerts
     */
    classicAlertSettings?: pulumi.Input<inputs.recoveryservices.v20220801.ClassicAlertSettingsArgs>;
}
...
export interface RecoveryPlanA2AInputArgs {
     ...
     */
    primaryExtendedLocation?: pulumi.Input<inputs.recoveryservices.v20220801.ExtendedLocationArgs>;
    /**
     * The primary zone.
     */
...
export interface RecoveryPlanActionArgs {
     ...
     * The custom details.
     */
    customDetails: pulumi.Input<inputs.recoveryservices.v20220801.RecoveryPlanAutomationRunbookActionDetailsArgs | inputs.recoveryservices.v20220801.RecoveryPlanManualActionDetailsArgs | inputs.recoveryservices.v20220801.RecoveryPlanScriptActionDetailsArgs>;
    /**
     * The list of failover directions.
     */
    failoverDirections: pulumi.Input<pulumi.Input<string | enums.recoveryservices.v20220801.PossibleOperationsDirections>[]>;
    /**
     * The list of failover types.
     */
    failoverTypes: pulumi.Input<pulumi.Input<string | enums.recoveryservices.v20220801.ReplicationProtectedItemOperation>[]>;
}
...
export interface RecoveryPlanAutomationRunbookActionDetailsArgs {
     ...
     * The fabric location.
     */
    fabricLocation: pulumi.Input<string | enums.recoveryservices.v20220801.RecoveryPlanActionLocation>;
    /**
...
export interface RecoveryPlanGroupArgs {
     ...
     */
    endGroupActions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.RecoveryPlanActionArgs>[]>;
    /**
     * The group type.
     */
    groupType: pulumi.Input<string | enums.recoveryservices.v20220801.RecoveryPlanGroupType>;
    /**
     * The list of protected items.
     */
    replicationProtectedItems?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.RecoveryPlanProtectedItemArgs>[]>;
    /**
     * The start group actions.
     */
    startGroupActions?: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.RecoveryPlanActionArgs>[]>;
}
...
export interface SecuritySettingsArgs {
     ...
     */
    immutabilitySettings?: pulumi.Input<inputs.recoveryservices.v20220801.ImmutabilitySettingsArgs>;
}
...
export interface SkuArgs {
     ...
     */
    name: pulumi.Input<string | enums.recoveryservices.v20220801.SkuName>;
    /**
     * The sku size
     */
...
export interface VMwareCbtEnableMigrationInputArgs {
     ...
     * The disks to include list.
     */
    disksToInclude: pulumi.Input<pulumi.Input<inputs.recoveryservices.v20220801.VMwareCbtDiskInputArgs>[]>;
    /**
     * The class type.
     * Expected value is 'VMwareCbt'.
     */
...
export interface VaultPropertiesArgs {
     ...
     */
    encryption?: pulumi.Input<inputs.recoveryservices.v20220801.VaultPropertiesEncryptionArgs>;
    /**
     * Monitoring Settings of the vault
     */
    monitoringSettings?: pulumi.Input<inputs.recoveryservices.v20220801.MonitoringSettingsArgs>;
    /**
     * Security Settings of the vault
     */
    securitySettings?: pulumi.Input<inputs.recoveryservices.v20220801.SecuritySettingsArgs>;
}
...
export interface VaultPropertiesEncryptionArgs {
     ...
     */
    infrastructureEncryption?: pulumi.Input<string | enums.recoveryservices.v20220801.InfrastructureEncryptionState>;
    /**
     * The details of the identity used for CMK
     */
    kekIdentity?: pulumi.Input<inputs.recoveryservices.v20220801.CmkKekIdentityArgs>;
    /**
     * The properties of the Key Vault which hosts CMK
     */
    keyVaultProperties?: pulumi.Input<inputs.recoveryservices.v20220801.CmkKeyVaultPropertiesArgs>;
}
