...
export interface TargetPortalGroupCreateArgs {
     ...
     * Access Control List (ACL) for an iSCSI target portal group.
     */
    acls: pulumi.Input<pulumi.Input<inputs.storagepool.v20200315preview.AclArgs>[]>;
    /**
     * Attributes of an iSCSI target portal group.
     */
    attributes: pulumi.Input<inputs.storagepool.v20200315preview.AttributesArgs>;
    /**
     * List of LUNs to be exposed through the iSCSI target portal group.
     */
    luns: pulumi.Input<pulumi.Input<inputs.storagepool.v20200315preview.IscsiLunArgs>[]>;
}
