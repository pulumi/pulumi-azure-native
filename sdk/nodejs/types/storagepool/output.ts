...
export * as v20200315preview from "./v20200315preview/output";
...
export interface TargetPortalGroupResponse {
     ...
     * Access Control List (ACL) for an iSCSI target portal group.
     */
    acls: outputs.storagepool.AclResponse[];
    /**
     * Attributes of an iSCSI target portal group.
     */
    attributes: outputs.storagepool.AttributesResponse;
    /**
     ...
     */
    luns: outputs.storagepool.IscsiLunResponse[];
    /**
