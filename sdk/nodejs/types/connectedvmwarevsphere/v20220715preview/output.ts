...
export interface ErrorDetailResponse {
     ...
     */
    additionalInfo: outputs.connectedvmwarevsphere.v20220715preview.ErrorAdditionalInfoResponse[];
    /**
     * The error code.
     */
    code: string;
     ...
     * The error details.
     */
    details: outputs.connectedvmwarevsphere.v20220715preview.ErrorDetailResponse[];
    /**
     * The error message.
     */
    message: string;
...
export interface GuestAgentProfileResponse {
     ...
     */
    errorDetails: outputs.connectedvmwarevsphere.v20220715preview.ErrorDetailResponse[];
    /**
...
export interface MachineExtensionPropertiesResponseInstanceView {
     ...
     * Instance view status.
     */
    status?: outputs.connectedvmwarevsphere.v20220715preview.MachineExtensionInstanceViewResponseStatus;
    /**
...
export interface NetworkInterfaceResponse {
     ...
     */
    ipSettings?: outputs.connectedvmwarevsphere.v20220715preview.NicIPSettingsResponse;
    /**
...
export interface NetworkProfileResponse {
     ...
     */
    networkInterfaces?: outputs.connectedvmwarevsphere.v20220715preview.NetworkInterfaceResponse[];
}
...
export interface NicIPSettingsResponse {
     ...
     */
    ipAddressInfo: outputs.connectedvmwarevsphere.v20220715preview.NicIPAddressSettingsResponse[];
    /**
...
export interface OsProfileResponse {
     ...
     */
    linuxConfiguration?: outputs.connectedvmwarevsphere.v20220715preview.OsProfileResponseLinuxConfiguration;
    /**
     ...
     */
    windowsConfiguration?: outputs.connectedvmwarevsphere.v20220715preview.OsProfileResponseWindowsConfiguration;
}
...
export interface SecurityProfileResponse {
     ...
     */
    uefiSettings?: outputs.connectedvmwarevsphere.v20220715preview.UefiSettingsResponse;
}
...
export interface StorageProfileResponse {
     ...
     */
    disks?: outputs.connectedvmwarevsphere.v20220715preview.VirtualDiskResponse[];
    /**
     * Gets or sets the list of virtual SCSI controllers associated with the virtual machine.
     */
    scsiControllers: outputs.connectedvmwarevsphere.v20220715preview.VirtualSCSIControllerResponse[];
}
