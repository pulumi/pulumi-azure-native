...
export interface HttpRequestResponse {
     ...
     */
    authentication?: outputs.scheduler.v20160101.HttpAuthenticationResponse;
    /**
...
export interface JobActionResponse {
     ...
     */
    errorAction?: outputs.scheduler.v20160101.JobErrorActionResponse;
    /**
     * Gets or sets the storage queue message.
     */
    queueMessage?: outputs.scheduler.v20160101.StorageQueueMessageResponse;
    /**
     * Gets or sets the http requests.
     */
    request?: outputs.scheduler.v20160101.HttpRequestResponse;
    /**
     * Gets or sets the retry policy.
     */
    retryPolicy?: outputs.scheduler.v20160101.RetryPolicyResponse;
    /**
     * Gets or sets the service bus queue message.
     */
    serviceBusQueueMessage?: outputs.scheduler.v20160101.ServiceBusQueueMessageResponse;
    /**
     * Gets or sets the service bus topic message.
     */
    serviceBusTopicMessage?: outputs.scheduler.v20160101.ServiceBusTopicMessageResponse;
    /**
...
export interface JobCollectionPropertiesResponse {
     ...
     */
    quota?: outputs.scheduler.v20160101.JobCollectionQuotaResponse;
    /**
     * Gets or sets the SKU.
     */
    sku?: outputs.scheduler.v20160101.SkuResponse;
    /**
...
export interface JobCollectionQuotaResponse {
     ...
     */
    maxRecurrence?: outputs.scheduler.v20160101.JobMaxRecurrenceResponse;
}
...
export interface JobPropertiesResponse {
     ...
     */
    action?: outputs.scheduler.v20160101.JobActionResponse;
    /**
     * Gets or sets the job recurrence.
     */
    recurrence?: outputs.scheduler.v20160101.JobRecurrenceResponse;
    /**
     ...
     * Gets the job status.
     */
    status: outputs.scheduler.v20160101.JobStatusResponse;
}
...
export interface JobRecurrenceResponse {
     ...
     */
    interval?: number;
    schedule?: outputs.scheduler.v20160101.JobRecurrenceScheduleResponse;
}
...
export interface JobRecurrenceScheduleResponse {
     ...
     */
    monthlyOccurrences?: outputs.scheduler.v20160101.JobRecurrenceScheduleMonthlyOccurrenceResponse[];
    /**
...
export interface ServiceBusQueueMessageResponse {
     ...
     */
    authentication?: outputs.scheduler.v20160101.ServiceBusAuthenticationResponse;
    /**
     * Gets or sets the brokered message properties.
     */
    brokeredMessageProperties?: outputs.scheduler.v20160101.ServiceBusBrokeredMessagePropertiesResponse;
    /**
