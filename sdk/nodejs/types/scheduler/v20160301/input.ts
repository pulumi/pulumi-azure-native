...
export interface HttpRequestArgs {
     ...
     */
    authentication?: pulumi.Input<inputs.scheduler.v20160301.BasicAuthenticationArgs | inputs.scheduler.v20160301.ClientCertAuthenticationArgs | inputs.scheduler.v20160301.OAuthAuthenticationArgs>;
    /**
...
export interface JobActionArgs {
     ...
     */
    errorAction?: pulumi.Input<inputs.scheduler.v20160301.JobErrorActionArgs>;
    /**
     * Gets or sets the storage queue message.
     */
    queueMessage?: pulumi.Input<inputs.scheduler.v20160301.StorageQueueMessageArgs>;
    /**
     * Gets or sets the http requests.
     */
    request?: pulumi.Input<inputs.scheduler.v20160301.HttpRequestArgs>;
    /**
     * Gets or sets the retry policy.
     */
    retryPolicy?: pulumi.Input<inputs.scheduler.v20160301.RetryPolicyArgs>;
    /**
     * Gets or sets the service bus queue message.
     */
    serviceBusQueueMessage?: pulumi.Input<inputs.scheduler.v20160301.ServiceBusQueueMessageArgs>;
    /**
     * Gets or sets the service bus topic message.
     */
    serviceBusTopicMessage?: pulumi.Input<inputs.scheduler.v20160301.ServiceBusTopicMessageArgs>;
    /**
     * Gets or sets the job action type.
     */
    type?: pulumi.Input<enums.scheduler.v20160301.JobActionType>;
}
...
export interface JobCollectionPropertiesArgs {
     ...
     */
    quota?: pulumi.Input<inputs.scheduler.v20160301.JobCollectionQuotaArgs>;
    /**
     * Gets or sets the SKU.
     */
    sku?: pulumi.Input<inputs.scheduler.v20160301.SkuArgs>;
    /**
     * Gets or sets the state.
     */
    state?: pulumi.Input<enums.scheduler.v20160301.JobCollectionState>;
}
...
export interface JobCollectionQuotaArgs {
     ...
     */
    maxRecurrence?: pulumi.Input<inputs.scheduler.v20160301.JobMaxRecurrenceArgs>;
}
...
export interface JobMaxRecurrenceArgs {
     ...
     */
    frequency?: pulumi.Input<enums.scheduler.v20160301.RecurrenceFrequency>;
    /**
...
export interface JobPropertiesArgs {
     ...
     */
    action?: pulumi.Input<inputs.scheduler.v20160301.JobActionArgs>;
    /**
     * Gets or sets the job recurrence.
     */
    recurrence?: pulumi.Input<inputs.scheduler.v20160301.JobRecurrenceArgs>;
    /**
     ...
     */
    state?: pulumi.Input<enums.scheduler.v20160301.JobState>;
}
...
export interface JobRecurrenceArgs {
     ...
     */
    interval?: pulumi.Input<number>;
    schedule?: pulumi.Input<inputs.scheduler.v20160301.JobRecurrenceScheduleArgs>;
}
...
export interface JobRecurrenceScheduleArgs {
     ...
     */
    monthlyOccurrences?: pulumi.Input<pulumi.Input<inputs.scheduler.v20160301.JobRecurrenceScheduleMonthlyOccurrenceArgs>[]>;
    /**
     * Gets or sets the days of the week that the job should execute on.
     */
    weekDays?: pulumi.Input<pulumi.Input<enums.scheduler.v20160301.DayOfWeek>[]>;
}
...
export interface JobRecurrenceScheduleMonthlyOccurrenceArgs {
     ...
     */
    day?: pulumi.Input<enums.scheduler.v20160301.JobScheduleDay>;
    /**
...
export interface RetryPolicyArgs {
     ...
     */
    retryType?: pulumi.Input<enums.scheduler.v20160301.RetryType>;
}
...
export interface ServiceBusAuthenticationArgs {
     ...
     */
    type?: pulumi.Input<enums.scheduler.v20160301.ServiceBusAuthenticationType>;
}
...
export interface ServiceBusQueueMessageArgs {
     ...
     */
    authentication?: pulumi.Input<inputs.scheduler.v20160301.ServiceBusAuthenticationArgs>;
    /**
     * Gets or sets the brokered message properties.
     */
    brokeredMessageProperties?: pulumi.Input<inputs.scheduler.v20160301.ServiceBusBrokeredMessagePropertiesArgs>;
    /**
     ...
     */
    transportType?: pulumi.Input<enums.scheduler.v20160301.ServiceBusTransportType>;
}
...
export interface SkuArgs {
     ...
     * Gets or set the SKU.
     */
    name?: pulumi.Input<enums.scheduler.v20160301.SkuDefinition>;
}
