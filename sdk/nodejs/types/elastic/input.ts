...
export interface FilteringTagArgs {
     ...
     */
    action?: pulumi.Input<string | enums.elastic.TagAction>;
    /**
...
export interface IdentityPropertiesArgs {
     ...
     */
    type?: pulumi.Input<string | enums.elastic.ManagedIdentityTypes>;
}
...
export interface LogRulesArgs {
     ...
     */
    filteringTags?: pulumi.Input<pulumi.Input<inputs.elastic.FilteringTagArgs>[]>;
    /**
...
export interface MonitorPropertiesArgs {
     ...
     */
    monitoringStatus?: pulumi.Input<string | enums.elastic.MonitoringStatus>;
    /**
     * Provisioning state of the monitor resource.
     */
    provisioningState?: pulumi.Input<string | enums.elastic.ProvisioningState>;
    /**
     * User information.
     */
    userInfo?: pulumi.Input<inputs.elastic.UserInfoArgs>;
}
...
export interface MonitoringTagRulesPropertiesArgs {
     ...
     */
    logRules?: pulumi.Input<inputs.elastic.LogRulesArgs>;
    /**
...
export interface UserInfoArgs {
     ...
     * Company information of the user to be passed to partners.
     */
    companyInfo?: pulumi.Input<inputs.elastic.CompanyInfoArgs>;
    /**
