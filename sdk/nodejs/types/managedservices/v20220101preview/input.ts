...
export interface EligibleAuthorizationArgs {
     ...
     */
    justInTimeAccessPolicy?: pulumi.Input<inputs.managedservices.v20220101preview.JustInTimeAccessPolicyArgs>;
    /**
     * The identifier of the Azure Active Directory principal.
     */
    principalId: pulumi.Input<string>;
...
export function eligibleAuthorizationArgsProvideDefaults(val: EligibleAuthorizationArgs): EligibleAuthorizationArgs {
    return {
        ...val,
        justInTimeAccessPolicy: (val.justInTimeAccessPolicy ? pulumi.output(val.justInTimeAccessPolicy).apply(inputs.managedservices.v20220101preview.justInTimeAccessPolicyArgsProvideDefaults) : undefined),
    };
}
...
export interface JustInTimeAccessPolicyArgs {
     ...
     */
    managedByTenantApprovers?: pulumi.Input<pulumi.Input<inputs.managedservices.v20220101preview.EligibleApproverArgs>[]>;
    /**
     ...
     */
    multiFactorAuthProvider: pulumi.Input<string | enums.managedservices.v20220101preview.MultiFactorAuthProvider>;
}
/**
...
export interface RegistrationDefinitionPropertiesArgs {
     ...
     */
    authorizations: pulumi.Input<pulumi.Input<inputs.managedservices.v20220101preview.AuthorizationArgs>[]>;
    /**
     ...
     */
    eligibleAuthorizations?: pulumi.Input<pulumi.Input<inputs.managedservices.v20220101preview.EligibleAuthorizationArgs>[]>;
    /**
