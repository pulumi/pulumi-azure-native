...
export interface EligibleAuthorizationResponse {
     ...
     */
    justInTimeAccessPolicy?: outputs.managedservices.v20220101preview.JustInTimeAccessPolicyResponse;
    /**
     * The identifier of the Azure Active Directory principal.
     */
    principalId: string;
...
export function eligibleAuthorizationResponseProvideDefaults(val: EligibleAuthorizationResponse): EligibleAuthorizationResponse {
    return {
        ...val,
        justInTimeAccessPolicy: (val.justInTimeAccessPolicy ? outputs.managedservices.v20220101preview.justInTimeAccessPolicyResponseProvideDefaults(val.justInTimeAccessPolicy) : undefined),
    };
}
...
export interface JustInTimeAccessPolicyResponse {
     ...
     */
    managedByTenantApprovers?: outputs.managedservices.v20220101preview.EligibleApproverResponse[];
    /**
...
export interface RegistrationAssignmentPropertiesResponse {
     ...
     */
    registrationDefinition: outputs.managedservices.v20220101preview.RegistrationAssignmentPropertiesResponseRegistrationDefinition;
    /**
...
export interface RegistrationAssignmentPropertiesResponseProperties {
     ...
     */
    authorizations?: outputs.managedservices.v20220101preview.AuthorizationResponse[];
    /**
     ...
     */
    eligibleAuthorizations?: outputs.managedservices.v20220101preview.EligibleAuthorizationResponse[];
    /**
...
export interface RegistrationAssignmentPropertiesResponseRegistrationDefinition {
     ...
     * The details for the Managed Services offer’s plan in Azure Marketplace.
     */
    plan?: outputs.managedservices.v20220101preview.PlanResponse;
    /**
     * The properties of the registration definition associated with the registration assignment.
     */
    properties?: outputs.managedservices.v20220101preview.RegistrationAssignmentPropertiesResponseProperties;
    /**
     * The metadata for the registration definition resource.
     */
    systemData: outputs.managedservices.v20220101preview.SystemDataResponse;
    /**
