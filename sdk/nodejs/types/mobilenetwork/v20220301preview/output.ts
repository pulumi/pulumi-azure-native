...
export interface DataNetworkConfigurationResponse {
     ...
     */
    allowedServices: outputs.mobilenetwork.v20220301preview.ServiceResourceIdResponse[];
    /**
     * A reference to the Data Network that these settings apply to
     */
    dataNetwork: outputs.mobilenetwork.v20220301preview.DataNetworkResourceIdResponse;
    /**
     ...
     */
    sessionAmbr: outputs.mobilenetwork.v20220301preview.AmbrResponse;
}
/**
...
export interface NaptConfigurationResponse {
     ...
     */
    pinholeTimeouts?: outputs.mobilenetwork.v20220301preview.PinholeTimeoutsResponse;
    /**
     ...
     */
    portRange?: outputs.mobilenetwork.v20220301preview.PortRangeResponse;
    /**
     ...
     */
    portReuseHoldTime?: outputs.mobilenetwork.v20220301preview.PortReuseHoldTimesResponse;
}
/**
...
export function naptConfigurationResponseProvideDefaults(val: NaptConfigurationResponse): NaptConfigurationResponse {
    return {
        ...
        pinholeTimeouts: (val.pinholeTimeouts ? outputs.mobilenetwork.v20220301preview.pinholeTimeoutsResponseProvideDefaults(val.pinholeTimeouts) : undefined),
        portRange: (val.portRange ? outputs.mobilenetwork.v20220301preview.portRangeResponseProvideDefaults(val.portRange) : undefined),
        portReuseHoldTime: (val.portReuseHoldTime ? outputs.mobilenetwork.v20220301preview.portReuseHoldTimesResponseProvideDefaults(val.portReuseHoldTime) : undefined),
    };
}
...
export interface PccRuleConfigurationResponse {
     ...
     */
    ruleQosPolicy?: outputs.mobilenetwork.v20220301preview.PccRuleQosPolicyResponse;
    /**
     * The set of service data flow templates to use for this PCC Rule.
     */
    serviceDataFlowTemplates: outputs.mobilenetwork.v20220301preview.ServiceDataFlowTemplateResponse[];
    /**
...
export function pccRuleConfigurationResponseProvideDefaults(val: PccRuleConfigurationResponse): PccRuleConfigurationResponse {
    return {
        ...val,
        ruleQosPolicy: (val.ruleQosPolicy ? outputs.mobilenetwork.v20220301preview.pccRuleQosPolicyResponseProvideDefaults(val.ruleQosPolicy) : undefined),
...
export interface PccRuleQosPolicyResponse {
     ...
     */
    guaranteedBitRate?: outputs.mobilenetwork.v20220301preview.AmbrResponse;
    /**
     * The Maximum Bit Rate (MBR) for all service data flows that use this PCC Rule or Service.
     */
    maximumBitRate: outputs.mobilenetwork.v20220301preview.AmbrResponse;
    /**
...
export interface SimStaticIpPropertiesResponse {
     ...
     */
    attachedDataNetwork?: outputs.mobilenetwork.v20220301preview.AttachedDataNetworkResourceIdResponse;
    /**
     ...
     */
    slice?: outputs.mobilenetwork.v20220301preview.SliceResourceIdResponse;
    /**
     * The static IP configuration for the sim to use at the defined network scope.
     */
    staticIp?: outputs.mobilenetwork.v20220301preview.SimStaticIpPropertiesResponseStaticIp;
}
...
export interface SliceConfigurationResponse {
     ...
     */
    dataNetworkConfigurations: outputs.mobilenetwork.v20220301preview.DataNetworkConfigurationResponse[];
    /**
     ...
     */
    defaultDataNetwork: outputs.mobilenetwork.v20220301preview.DataNetworkResourceIdResponse;
    /**
