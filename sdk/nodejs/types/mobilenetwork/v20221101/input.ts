...
export interface DataNetworkConfigurationArgs {
     ...
     */
    additionalAllowedSessionTypes?: pulumi.Input<pulumi.Input<string | enums.mobilenetwork.v20221101.PduSessionType>[]>;
    /**
     ...
     */
    allowedServices: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20221101.ServiceResourceIdArgs>[]>;
    /**
     ...
     */
    dataNetwork: pulumi.Input<inputs.mobilenetwork.v20221101.DataNetworkResourceIdArgs>;
    /**
     * The default PDU session type, which is used if the UE does not request a specific session type.
     */
    defaultSessionType?: pulumi.Input<string | enums.mobilenetwork.v20221101.PduSessionType>;
    /**
     ...
     */
    preemptionCapability?: pulumi.Input<string | enums.mobilenetwork.v20221101.PreemptionCapability>;
    /**
     ...
     */
    preemptionVulnerability?: pulumi.Input<string | enums.mobilenetwork.v20221101.PreemptionVulnerability>;
    /**
     ...
     */
    sessionAmbr: pulumi.Input<inputs.mobilenetwork.v20221101.AmbrArgs>;
}
/**
...
export interface LocalDiagnosticsAccessConfigurationArgs {
     ...
     */
    authenticationType: pulumi.Input<string | enums.mobilenetwork.v20221101.AuthenticationType>;
    /**
     * The HTTPS server TLS certificate used to secure local access to diagnostics.
     */
    httpsServerCertificate?: pulumi.Input<inputs.mobilenetwork.v20221101.HttpsServerCertificateArgs>;
}
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type: pulumi.Input<string | enums.mobilenetwork.v20221101.ManagedServiceIdentityType>;
    /**
...
export interface NaptConfigurationArgs {
     ...
     */
    enabled?: pulumi.Input<string | enums.mobilenetwork.v20221101.NaptEnabled>;
    /**
     ...
     */
    pinholeTimeouts?: pulumi.Input<inputs.mobilenetwork.v20221101.PinholeTimeoutsArgs>;
    /**
     ...
     */
    portRange?: pulumi.Input<inputs.mobilenetwork.v20221101.PortRangeArgs>;
    /**
     ...
     */
    portReuseHoldTime?: pulumi.Input<inputs.mobilenetwork.v20221101.PortReuseHoldTimesArgs>;
}
/**
...
export function naptConfigurationArgsProvideDefaults(val: NaptConfigurationArgs): NaptConfigurationArgs {
    return {
        ...
        pinholeTimeouts: (val.pinholeTimeouts ? pulumi.output(val.pinholeTimeouts).apply(inputs.mobilenetwork.v20221101.pinholeTimeoutsArgsProvideDefaults) : undefined),
        portRange: (val.portRange ? pulumi.output(val.portRange).apply(inputs.mobilenetwork.v20221101.portRangeArgsProvideDefaults) : undefined),
        portReuseHoldTime: (val.portReuseHoldTime ? pulumi.output(val.portReuseHoldTime).apply(inputs.mobilenetwork.v20221101.portReuseHoldTimesArgsProvideDefaults) : undefined),
    };
}
...
export interface PccRuleConfigurationArgs {
     ...
     */
    ruleQosPolicy?: pulumi.Input<inputs.mobilenetwork.v20221101.PccRuleQosPolicyArgs>;
    /**
     * The set of data flow templates to use for this data flow policy rule.
     */
    serviceDataFlowTemplates: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20221101.ServiceDataFlowTemplateArgs>[]>;
    /**
     * Determines whether flows that match this data flow policy rule are permitted.
     */
    trafficControl?: pulumi.Input<string | enums.mobilenetwork.v20221101.TrafficControlPermission>;
}
/**
...
export function pccRuleConfigurationArgsProvideDefaults(val: PccRuleConfigurationArgs): PccRuleConfigurationArgs {
    return {
        ...val,
        ruleQosPolicy: (val.ruleQosPolicy ? pulumi.output(val.ruleQosPolicy).apply(inputs.mobilenetwork.v20221101.pccRuleQosPolicyArgsProvideDefaults) : undefined),
...
export interface PccRuleQosPolicyArgs {
     ...
     */
    guaranteedBitRate?: pulumi.Input<inputs.mobilenetwork.v20221101.AmbrArgs>;
    /**
     * The maximum bit rate (MBR) for all service data flows that use this data flow policy rule or service.
     */
    maximumBitRate: pulumi.Input<inputs.mobilenetwork.v20221101.AmbrArgs>;
    /**
...
export interface PlatformConfigurationArgs {
     ...
     */
    azureStackEdgeDevice?: pulumi.Input<inputs.mobilenetwork.v20221101.AzureStackEdgeDeviceResourceIdArgs>;
    /**
     * The Azure Stack HCI cluster where the packet core is deployed.
     */
    azureStackHciCluster?: pulumi.Input<inputs.mobilenetwork.v20221101.AzureStackHCIClusterResourceIdArgs>;
    /**
     * Azure Arc connected cluster where the packet core is deployed.
     */
    connectedCluster?: pulumi.Input<inputs.mobilenetwork.v20221101.ConnectedClusterResourceIdArgs>;
    /**
     * Azure Arc custom location where the packet core is deployed.
     */
    customLocation?: pulumi.Input<inputs.mobilenetwork.v20221101.CustomLocationResourceIdArgs>;
    /**
     * The platform type where packet core is deployed.
     */
    type: pulumi.Input<string | enums.mobilenetwork.v20221101.PlatformType>;
}
...
export interface ServiceDataFlowTemplateArgs {
     ...
     */
    direction: pulumi.Input<string | enums.mobilenetwork.v20221101.SdfDirection>;
    /**
...
export interface SimStaticIpPropertiesArgs {
     ...
     */
    attachedDataNetwork?: pulumi.Input<inputs.mobilenetwork.v20221101.AttachedDataNetworkResourceIdArgs>;
    /**
     ...
     */
    slice?: pulumi.Input<inputs.mobilenetwork.v20221101.SliceResourceIdArgs>;
    /**
     * The static IP configuration for the SIM to use at the defined network scope.
     */
    staticIp?: pulumi.Input<inputs.mobilenetwork.v20221101.SimStaticIpPropertiesStaticIpArgs>;
}
...
export interface SliceConfigurationArgs {
     ...
     */
    dataNetworkConfigurations: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20221101.DataNetworkConfigurationArgs>[]>;
    /**
     ...
     */
    defaultDataNetwork: pulumi.Input<inputs.mobilenetwork.v20221101.DataNetworkResourceIdArgs>;
    /**
