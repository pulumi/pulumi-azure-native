...
export interface DataNetworkConfigurationResponse {
     ...
     */
    allowedServices: outputs.mobilenetwork.v20221101.ServiceResourceIdResponse[];
    /**
     ...
     */
    dataNetwork: outputs.mobilenetwork.v20221101.DataNetworkResourceIdResponse;
    /**
     ...
     */
    sessionAmbr: outputs.mobilenetwork.v20221101.AmbrResponse;
}
/**
...
export interface HttpsServerCertificateResponse {
     ...
     */
    provisioning: outputs.mobilenetwork.v20221101.CertificateProvisioningResponse;
}
...
export interface InstallationResponse {
     ...
     */
    operation?: outputs.mobilenetwork.v20221101.AsyncOperationIdResponse;
    /**
     * Installation state
     */
    state?: string;
...
export interface LocalDiagnosticsAccessConfigurationResponse {
     ...
     */
    httpsServerCertificate?: outputs.mobilenetwork.v20221101.HttpsServerCertificateResponse;
}
...
export interface ManagedServiceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.mobilenetwork.v20221101.UserAssignedIdentityResponse};
}
...
export interface NaptConfigurationResponse {
     ...
     */
    pinholeTimeouts?: outputs.mobilenetwork.v20221101.PinholeTimeoutsResponse;
    /**
     ...
     */
    portRange?: outputs.mobilenetwork.v20221101.PortRangeResponse;
    /**
     ...
     */
    portReuseHoldTime?: outputs.mobilenetwork.v20221101.PortReuseHoldTimesResponse;
}
/**
...
export function naptConfigurationResponseProvideDefaults(val: NaptConfigurationResponse): NaptConfigurationResponse {
    return {
        ...
        pinholeTimeouts: (val.pinholeTimeouts ? outputs.mobilenetwork.v20221101.pinholeTimeoutsResponseProvideDefaults(val.pinholeTimeouts) : undefined),
        portRange: (val.portRange ? outputs.mobilenetwork.v20221101.portRangeResponseProvideDefaults(val.portRange) : undefined),
        portReuseHoldTime: (val.portReuseHoldTime ? outputs.mobilenetwork.v20221101.portReuseHoldTimesResponseProvideDefaults(val.portReuseHoldTime) : undefined),
    };
}
...
export interface PccRuleConfigurationResponse {
     ...
     */
    ruleQosPolicy?: outputs.mobilenetwork.v20221101.PccRuleQosPolicyResponse;
    /**
     * The set of data flow templates to use for this data flow policy rule.
     */
    serviceDataFlowTemplates: outputs.mobilenetwork.v20221101.ServiceDataFlowTemplateResponse[];
    /**
...
export function pccRuleConfigurationResponseProvideDefaults(val: PccRuleConfigurationResponse): PccRuleConfigurationResponse {
    return {
        ...val,
        ruleQosPolicy: (val.ruleQosPolicy ? outputs.mobilenetwork.v20221101.pccRuleQosPolicyResponseProvideDefaults(val.ruleQosPolicy) : undefined),
...
export interface PccRuleQosPolicyResponse {
     ...
     */
    guaranteedBitRate?: outputs.mobilenetwork.v20221101.AmbrResponse;
    /**
     * The maximum bit rate (MBR) for all service data flows that use this data flow policy rule or service.
     */
    maximumBitRate: outputs.mobilenetwork.v20221101.AmbrResponse;
    /**
...
export interface PlatformConfigurationResponse {
     ...
     */
    azureStackEdgeDevice?: outputs.mobilenetwork.v20221101.AzureStackEdgeDeviceResourceIdResponse;
    /**
     ...
     */
    azureStackEdgeDevices: outputs.mobilenetwork.v20221101.AzureStackEdgeDeviceResourceIdResponse[];
    /**
     * The Azure Stack HCI cluster where the packet core is deployed.
     */
    azureStackHciCluster?: outputs.mobilenetwork.v20221101.AzureStackHCIClusterResourceIdResponse;
    /**
     * Azure Arc connected cluster where the packet core is deployed.
     */
    connectedCluster?: outputs.mobilenetwork.v20221101.ConnectedClusterResourceIdResponse;
    /**
     * Azure Arc custom location where the packet core is deployed.
     */
    customLocation?: outputs.mobilenetwork.v20221101.CustomLocationResourceIdResponse;
    /**
...
export interface SimStaticIpPropertiesResponse {
     ...
     */
    attachedDataNetwork?: outputs.mobilenetwork.v20221101.AttachedDataNetworkResourceIdResponse;
    /**
     ...
     */
    slice?: outputs.mobilenetwork.v20221101.SliceResourceIdResponse;
    /**
     * The static IP configuration for the SIM to use at the defined network scope.
     */
    staticIp?: outputs.mobilenetwork.v20221101.SimStaticIpPropertiesResponseStaticIp;
}
...
export interface SliceConfigurationResponse {
     ...
     */
    dataNetworkConfigurations: outputs.mobilenetwork.v20221101.DataNetworkConfigurationResponse[];
    /**
     ...
     */
    defaultDataNetwork: outputs.mobilenetwork.v20221101.DataNetworkResourceIdResponse;
    /**
