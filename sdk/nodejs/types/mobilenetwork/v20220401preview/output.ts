...
export interface DataNetworkConfigurationResponse {
     ...
     */
    allowedServices: outputs.mobilenetwork.v20220401preview.ServiceResourceIdResponse[];
    /**
     * A reference to the data network that these settings apply to
     */
    dataNetwork: outputs.mobilenetwork.v20220401preview.DataNetworkResourceIdResponse;
    /**
     ...
     */
    sessionAmbr: outputs.mobilenetwork.v20220401preview.AmbrResponse;
}
/**
...
export interface LocalDiagnosticsAccessConfigurationResponse {
     ...
     */
    httpsServerCertificate?: outputs.mobilenetwork.v20220401preview.KeyVaultCertificateResponse;
}
...
export interface ManagedServiceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.mobilenetwork.v20220401preview.UserAssignedIdentityResponse};
}
...
export interface NaptConfigurationResponse {
     ...
     */
    pinholeTimeouts?: outputs.mobilenetwork.v20220401preview.PinholeTimeoutsResponse;
    /**
     ...
     */
    portRange?: outputs.mobilenetwork.v20220401preview.PortRangeResponse;
    /**
     ...
     */
    portReuseHoldTime?: outputs.mobilenetwork.v20220401preview.PortReuseHoldTimesResponse;
}
/**
...
export function naptConfigurationResponseProvideDefaults(val: NaptConfigurationResponse): NaptConfigurationResponse {
    return {
        ...
        pinholeTimeouts: (val.pinholeTimeouts ? outputs.mobilenetwork.v20220401preview.pinholeTimeoutsResponseProvideDefaults(val.pinholeTimeouts) : undefined),
        portRange: (val.portRange ? outputs.mobilenetwork.v20220401preview.portRangeResponseProvideDefaults(val.portRange) : undefined),
        portReuseHoldTime: (val.portReuseHoldTime ? outputs.mobilenetwork.v20220401preview.portReuseHoldTimesResponseProvideDefaults(val.portReuseHoldTime) : undefined),
    };
}
...
export interface PccRuleConfigurationResponse {
     ...
     */
    ruleQosPolicy?: outputs.mobilenetwork.v20220401preview.PccRuleQosPolicyResponse;
    /**
     * The set of data flow templates to use for this data flow policy rule.
     */
    serviceDataFlowTemplates: outputs.mobilenetwork.v20220401preview.ServiceDataFlowTemplateResponse[];
    /**
...
export function pccRuleConfigurationResponseProvideDefaults(val: PccRuleConfigurationResponse): PccRuleConfigurationResponse {
    return {
        ...val,
        ruleQosPolicy: (val.ruleQosPolicy ? outputs.mobilenetwork.v20220401preview.pccRuleQosPolicyResponseProvideDefaults(val.ruleQosPolicy) : undefined),
...
export interface PccRuleQosPolicyResponse {
     ...
     */
    guaranteedBitRate?: outputs.mobilenetwork.v20220401preview.AmbrResponse;
    /**
     * The maximum bit rate (MBR) for all service data flows that use this data flow policy rule or service.
     */
    maximumBitRate: outputs.mobilenetwork.v20220401preview.AmbrResponse;
    /**
...
export interface PlatformConfigurationResponse {
     ...
     */
    azureStackEdgeDevice?: outputs.mobilenetwork.v20220401preview.AzureStackEdgeDeviceResourceIdResponse;
    /**
     * Azure Arc connected cluster where the packet core is deployed.
     */
    connectedCluster?: outputs.mobilenetwork.v20220401preview.ConnectedClusterResourceIdResponse;
    /**
     * Azure Arc custom location where the packet core is deployed.
     */
    customLocation?: outputs.mobilenetwork.v20220401preview.CustomLocationResourceIdResponse;
    /**
...
export interface SimStaticIpPropertiesResponse {
     ...
     */
    attachedDataNetwork?: outputs.mobilenetwork.v20220401preview.AttachedDataNetworkResourceIdResponse;
    /**
     ...
     */
    slice?: outputs.mobilenetwork.v20220401preview.SliceResourceIdResponse;
    /**
     * The static IP configuration for the SIM to use at the defined network scope.
     */
    staticIp?: outputs.mobilenetwork.v20220401preview.SimStaticIpPropertiesResponseStaticIp;
}
...
export interface SliceConfigurationResponse {
     ...
     */
    dataNetworkConfigurations: outputs.mobilenetwork.v20220401preview.DataNetworkConfigurationResponse[];
    /**
     ...
     */
    defaultDataNetwork: outputs.mobilenetwork.v20220401preview.DataNetworkResourceIdResponse;
    /**
