...
export interface DataNetworkConfigurationArgs {
     ...
     */
    additionalAllowedSessionTypes?: pulumi.Input<pulumi.Input<string | enums.mobilenetwork.v20220401preview.PduSessionType>[]>;
    /**
     ...
     */
    allowedServices: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20220401preview.ServiceResourceIdArgs>[]>;
    /**
     * A reference to the data network that these settings apply to
     */
    dataNetwork: pulumi.Input<inputs.mobilenetwork.v20220401preview.DataNetworkResourceIdArgs>;
    /**
     * The default PDU session type, which is used if the UE does not request a specific session type.
     */
    defaultSessionType?: pulumi.Input<string | enums.mobilenetwork.v20220401preview.PduSessionType>;
    /**
     ...
     */
    preemptionCapability?: pulumi.Input<string | enums.mobilenetwork.v20220401preview.PreemptionCapability>;
    /**
     ...
     */
    preemptionVulnerability?: pulumi.Input<string | enums.mobilenetwork.v20220401preview.PreemptionVulnerability>;
    /**
     ...
     */
    sessionAmbr: pulumi.Input<inputs.mobilenetwork.v20220401preview.AmbrArgs>;
}
/**
...
export interface LocalDiagnosticsAccessConfigurationArgs {
     ...
     */
    httpsServerCertificate?: pulumi.Input<inputs.mobilenetwork.v20220401preview.KeyVaultCertificateArgs>;
}
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type: pulumi.Input<string | enums.mobilenetwork.v20220401preview.ManagedServiceIdentityType>;
    /**
...
export interface NaptConfigurationArgs {
     ...
     */
    enabled?: pulumi.Input<string | enums.mobilenetwork.v20220401preview.NaptEnabled>;
    /**
     ...
     */
    pinholeTimeouts?: pulumi.Input<inputs.mobilenetwork.v20220401preview.PinholeTimeoutsArgs>;
    /**
     ...
     */
    portRange?: pulumi.Input<inputs.mobilenetwork.v20220401preview.PortRangeArgs>;
    /**
     ...
     */
    portReuseHoldTime?: pulumi.Input<inputs.mobilenetwork.v20220401preview.PortReuseHoldTimesArgs>;
}
/**
...
export function naptConfigurationArgsProvideDefaults(val: NaptConfigurationArgs): NaptConfigurationArgs {
    return {
        ...
        pinholeTimeouts: (val.pinholeTimeouts ? pulumi.output(val.pinholeTimeouts).apply(inputs.mobilenetwork.v20220401preview.pinholeTimeoutsArgsProvideDefaults) : undefined),
        portRange: (val.portRange ? pulumi.output(val.portRange).apply(inputs.mobilenetwork.v20220401preview.portRangeArgsProvideDefaults) : undefined),
        portReuseHoldTime: (val.portReuseHoldTime ? pulumi.output(val.portReuseHoldTime).apply(inputs.mobilenetwork.v20220401preview.portReuseHoldTimesArgsProvideDefaults) : undefined),
    };
}
...
export interface PccRuleConfigurationArgs {
     ...
     */
    ruleQosPolicy?: pulumi.Input<inputs.mobilenetwork.v20220401preview.PccRuleQosPolicyArgs>;
    /**
     * The set of data flow templates to use for this data flow policy rule.
     */
    serviceDataFlowTemplates: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20220401preview.ServiceDataFlowTemplateArgs>[]>;
    /**
     * Determines whether flows that match this data flow policy rule are permitted.
     */
    trafficControl?: pulumi.Input<string | enums.mobilenetwork.v20220401preview.TrafficControlPermission>;
}
/**
...
export function pccRuleConfigurationArgsProvideDefaults(val: PccRuleConfigurationArgs): PccRuleConfigurationArgs {
    return {
        ...val,
        ruleQosPolicy: (val.ruleQosPolicy ? pulumi.output(val.ruleQosPolicy).apply(inputs.mobilenetwork.v20220401preview.pccRuleQosPolicyArgsProvideDefaults) : undefined),
...
export interface PccRuleQosPolicyArgs {
     ...
     */
    guaranteedBitRate?: pulumi.Input<inputs.mobilenetwork.v20220401preview.AmbrArgs>;
    /**
     * The maximum bit rate (MBR) for all service data flows that use this data flow policy rule or service.
     */
    maximumBitRate: pulumi.Input<inputs.mobilenetwork.v20220401preview.AmbrArgs>;
    /**
...
export interface PlatformConfigurationArgs {
     ...
     */
    azureStackEdgeDevice?: pulumi.Input<inputs.mobilenetwork.v20220401preview.AzureStackEdgeDeviceResourceIdArgs>;
    /**
     * Azure Arc connected cluster where the packet core is deployed.
     */
    connectedCluster?: pulumi.Input<inputs.mobilenetwork.v20220401preview.ConnectedClusterResourceIdArgs>;
    /**
     * Azure Arc custom location where the packet core is deployed.
     */
    customLocation?: pulumi.Input<inputs.mobilenetwork.v20220401preview.CustomLocationResourceIdArgs>;
    /**
     * The platform type where packet core is deployed.
     */
    type: pulumi.Input<string | enums.mobilenetwork.v20220401preview.PlatformType>;
}
...
export interface ServiceDataFlowTemplateArgs {
     ...
     */
    direction: pulumi.Input<string | enums.mobilenetwork.v20220401preview.SdfDirection>;
    /**
...
export interface SimStaticIpPropertiesArgs {
     ...
     */
    attachedDataNetwork?: pulumi.Input<inputs.mobilenetwork.v20220401preview.AttachedDataNetworkResourceIdArgs>;
    /**
     ...
     */
    slice?: pulumi.Input<inputs.mobilenetwork.v20220401preview.SliceResourceIdArgs>;
    /**
     * The static IP configuration for the SIM to use at the defined network scope.
     */
    staticIp?: pulumi.Input<inputs.mobilenetwork.v20220401preview.SimStaticIpPropertiesStaticIpArgs>;
}
...
export interface SliceConfigurationArgs {
     ...
     */
    dataNetworkConfigurations: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20220401preview.DataNetworkConfigurationArgs>[]>;
    /**
     ...
     */
    defaultDataNetwork: pulumi.Input<inputs.mobilenetwork.v20220401preview.DataNetworkResourceIdArgs>;
    /**
