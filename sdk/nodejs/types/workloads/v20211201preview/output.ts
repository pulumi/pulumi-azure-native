...
export interface ApplicationServerConfigurationResponse {
     ...
     */
    virtualMachineConfiguration: outputs.workloads.v20211201preview.VirtualMachineConfigurationResponse;
}
...
export interface CentralServerVmDetailsResponse {
     ...
     */
    storageDetails: outputs.workloads.v20211201preview.StorageInformationResponse[];
    /**
...
export interface DatabaseConfigurationResponse {
     ...
     */
    diskConfiguration?: outputs.workloads.v20211201preview.DiskConfigurationResponse;
    /**
...
export interface DeploymentConfigurationResponse {
     ...
     */
    infrastructureConfiguration?: outputs.workloads.v20211201preview.SingleServerConfigurationResponse | outputs.workloads.v20211201preview.ThreeTierConfigurationResponse;
    /**
     * The software configuration.
     */
    softwareConfiguration?: outputs.workloads.v20211201preview.ExternalInstallationSoftwareConfigurationResponse | outputs.workloads.v20211201preview.SAPInstallWithoutOSConfigSoftwareConfigurationResponse | outputs.workloads.v20211201preview.ServiceInitiatedSoftwareConfigurationResponse;
}
...
export interface DeploymentWithOSConfigurationResponse {
     ...
     */
    osSapConfiguration?: outputs.workloads.v20211201preview.OsSapConfigurationResponse;
    /**
     * The software configuration.
     */
    softwareConfiguration?: outputs.workloads.v20211201preview.ExternalInstallationSoftwareConfigurationResponse | outputs.workloads.v20211201preview.SAPInstallWithoutOSConfigSoftwareConfigurationResponse | outputs.workloads.v20211201preview.ServiceInitiatedSoftwareConfigurationResponse;
...
export interface DiskConfigurationResponse {
     ...
     */
    diskVolumeConfigurations?: {[key: string]: outputs.workloads.v20211201preview.DiskVolumeConfigurationResponse};
}
...
export interface DiskVolumeConfigurationResponse {
     ...
     */
    sku?: outputs.workloads.v20211201preview.DiskSkuResponse;
}
...
export interface ErrorDefinitionResponse {
     ...
     */
    details: outputs.workloads.v20211201preview.ErrorDefinitionResponse[];
    /**
...
export interface ErrorResponse {
     ...
     */
    details: outputs.workloads.v20211201preview.ErrorResponse[];
    /**
     * Object containing more specific information than  the current object about the error.
     */
    innerError: outputs.workloads.v20211201preview.ErrorResponseInnerError;
    /**
...
export interface ErrorResponseInnerError {
     ...
     * Standard error object.
     */
    innerError?: outputs.workloads.v20211201preview.ErrorResponse;
}
...
export interface LinuxConfigurationResponse {
     ...
     */
    ssh?: outputs.workloads.v20211201preview.SshConfigurationResponse;
    /**
     * The SSH Key-pair used to authenticate with the VM's.
     */
    sshKeyPair?: outputs.workloads.v20211201preview.SshKeyPairResponse;
}
...
export interface NodeProfileResponse {
     ...
     */
    dataDisks?: outputs.workloads.v20211201preview.DiskInfoResponse[];
    /**
     * VM or VMSS name
     */
    name?: string;
     ...
     * OS disk details
     */
    osDisk: outputs.workloads.v20211201preview.DiskInfoResponse;
    /**
     * OS image used for creating the nodes
     */
    osImage: outputs.workloads.v20211201preview.OsImageProfileResponse;
}
...
export interface OSProfileResponse {
     ...
     */
    osConfiguration?: outputs.workloads.v20211201preview.LinuxConfigurationResponse | outputs.workloads.v20211201preview.WindowsConfigurationResponse;
}
...
export interface OsSapConfigurationResponse {
     ...
     */
    deployerVmPackages?: outputs.workloads.v20211201preview.DeployerVmPackagesResponse;
    /**
...
export interface PhpWorkloadResourceResponseIdentity {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.workloads.v20211201preview.UserAssignedIdentityResponse};
}
...
export interface SAPInstallWithoutOSConfigSoftwareConfigurationResponse {
     ...
     * Gets or sets the HA software configuration.
     */
    highAvailabilitySoftwareConfiguration?: outputs.workloads.v20211201preview.HighAvailabilitySoftwareConfigurationResponse;
    /**
...
export interface SAPVirtualInstanceErrorResponse {
     ...
     */
    properties?: outputs.workloads.v20211201preview.ErrorDefinitionResponse;
}
...
export interface SingleServerConfigurationResponse {
     ...
     * Gets or sets the disk configuration.
     */
    dbDiskConfiguration?: outputs.workloads.v20211201preview.DiskConfigurationResponse;
    /**
     ...
     */
    networkConfiguration?: outputs.workloads.v20211201preview.NetworkConfigurationResponse;
    /**
     * The subnet id.
     */
    subnetId: string;
...
export function singleServerConfigurationResponseProvideDefaults(val: SingleServerConfigurationResponse): SingleServerConfigurationResponse {
    return {
        ...val,
        networkConfiguration: (val.networkConfiguration ? outputs.workloads.v20211201preview.networkConfigurationResponseProvideDefaults(val.networkConfiguration) : undefined),
    };
}
...
export interface SshConfigurationResponse {
     ...
     */
    publicKeys?: outputs.workloads.v20211201preview.SshPublicKeyResponse[];
}
...
export interface StorageConfigurationResponse {
     ...
     */
    transportFileShareConfiguration?: outputs.workloads.v20211201preview.CreateAndMountFileShareConfigurationResponse | outputs.workloads.v20211201preview.MountFileShareConfigurationResponse | outputs.workloads.v20211201preview.SkipFileShareConfigurationResponse;
}
...
export interface ThreeTierConfigurationResponse {
     ...
     */
    applicationServer: outputs.workloads.v20211201preview.ApplicationServerConfigurationResponse;
    /**
     * The central server configuration.
     */
    centralServer: outputs.workloads.v20211201preview.CentralServerConfigurationResponse;
    /**
     * The database configuration.
     */
    databaseServer: outputs.workloads.v20211201preview.DatabaseConfigurationResponse;
    /**
     * The type of SAP deployment, single server or Three tier.
     ...
     */
    highAvailabilityConfig?: outputs.workloads.v20211201preview.HighAvailabilityConfigurationResponse;
    /**
     ...
     */
    storageConfiguration?: outputs.workloads.v20211201preview.StorageConfigurationResponse;
}
/**
...
export interface VirtualMachineConfigurationResponse {
     ...
     * The image reference.
     */
    imageReference: outputs.workloads.v20211201preview.ImageReferenceResponse;
    /**
     * The OS profile.
     */
    osProfile: outputs.workloads.v20211201preview.OSProfileResponse;
    /**
