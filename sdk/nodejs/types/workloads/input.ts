...
export interface ApplicationServerConfigurationArgs {
     ...
     */
    virtualMachineConfiguration: pulumi.Input<inputs.workloads.VirtualMachineConfigurationArgs>;
}
...
export interface BackupProfileArgs {
     ...
     */
    backupEnabled: pulumi.Input<string | enums.workloads.EnableBackup>;
}
...
export interface CacheProfileArgs {
     ...
     * Cache family
     */
    family: pulumi.Input<string | enums.workloads.RedisCacheFamily>;
    /**
     * Cache name
     */
...
export interface DB2ProviderInstancePropertiesArgs {
     ...
     */
    sslPreference?: pulumi.Input<string | enums.workloads.SslPreference>;
}
...
export interface DatabaseConfigurationArgs {
     ...
     */
    diskConfiguration?: pulumi.Input<inputs.workloads.DiskConfigurationArgs>;
    /**
...
export interface DatabaseProfileArgs {
     ...
     */
    haEnabled?: pulumi.Input<string | enums.workloads.HAEnabled>;
    /**
     ...
     */
    sslEnforcementEnabled?: pulumi.Input<string | enums.workloads.EnableSslEnforcement>;
    /**
     ...
     */
    tier: pulumi.Input<enums.workloads.DatabaseTier>;
    /**
     * Database type
     */
    type: pulumi.Input<string | enums.workloads.DatabaseType>;
    /**
     * Database version
     */
...
export interface DeploymentConfigurationArgs {
     ...
     */
    infrastructureConfiguration?: pulumi.Input<inputs.workloads.SingleServerConfigurationArgs | inputs.workloads.ThreeTierConfigurationArgs>;
    /**
     * The software configuration.
     */
    softwareConfiguration?: pulumi.Input<inputs.workloads.ExternalInstallationSoftwareConfigurationArgs | inputs.workloads.SAPInstallWithoutOSConfigSoftwareConfigurationArgs | inputs.workloads.ServiceInitiatedSoftwareConfigurationArgs>;
}
...
export interface DeploymentWithOSConfigurationArgs {
     ...
     */
    osSapConfiguration?: pulumi.Input<inputs.workloads.OsSapConfigurationArgs>;
    /**
     * The software configuration.
     */
    softwareConfiguration?: pulumi.Input<inputs.workloads.ExternalInstallationSoftwareConfigurationArgs | inputs.workloads.SAPInstallWithoutOSConfigSoftwareConfigurationArgs | inputs.workloads.ServiceInitiatedSoftwareConfigurationArgs>;
...
export interface DiskConfigurationArgs {
     ...
     */
    diskVolumeConfigurations?: pulumi.Input<{[key: string]: pulumi.Input<inputs.workloads.DiskVolumeConfigurationArgs>}>;
}
...
export interface DiskInfoArgs {
     ...
     * Storage type
     */
    storageType: pulumi.Input<enums.workloads.DiskStorageType>;
}
...
export interface DiskSkuArgs {
     ...
     */
    name?: pulumi.Input<string | enums.workloads.DiskSkuName>;
}
...
export interface DiskVolumeConfigurationArgs {
     ...
     */
    sku?: pulumi.Input<inputs.workloads.DiskSkuArgs>;
}
...
export interface FileshareProfileArgs {
     ...
     * Share type
     */
    shareType: pulumi.Input<string | enums.workloads.FileShareType>;
    /**
     * File share backing storage type
     */
    storageType: pulumi.Input<string | enums.workloads.FileShareStorageType>;
}
...
export interface LinuxConfigurationArgs {
     ...
     */
    ssh?: pulumi.Input<inputs.workloads.SshConfigurationArgs>;
    /**
     * The SSH Key-pair used to authenticate with the VM's.
     */
    sshKeyPair?: pulumi.Input<inputs.workloads.SshKeyPairArgs>;
}
...
export interface NetworkProfileArgs {
     ...
     */
    azureFrontDoorEnabled?: pulumi.Input<string | enums.workloads.AzureFrontDoorEnabled>;
    /**
     ...
     * Load balancer type
     */
    loadBalancerType: pulumi.Input<string | enums.workloads.LoadBalancerType>;
}
...
export interface NodeProfileArgs {
     ...
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.workloads.DiskInfoArgs>[]>;
    /**
     * VM or VMSS name
     */
    name?: pulumi.Input<string>;
     ...
     * OS disk details
     */
    osDisk: pulumi.Input<inputs.workloads.DiskInfoArgs>;
    /**
     * OS image used for creating the nodes
     */
    osImage: pulumi.Input<inputs.workloads.OsImageProfileArgs>;
}
...
export interface OSProfileArgs {
     ...
     */
    osConfiguration?: pulumi.Input<inputs.workloads.LinuxConfigurationArgs | inputs.workloads.WindowsConfigurationArgs>;
}
...
export interface OsImageProfileArgs {
     ...
     * OS image offer
     */
    offer?: pulumi.Input<string | enums.workloads.OSImageOffer>;
    /**
     * OS image publisher
     */
    publisher?: pulumi.Input<string | enums.workloads.OSImagePublisher>;
    /**
     * OS image sku
     */
    sku?: pulumi.Input<string | enums.workloads.OSImageSku>;
    /**
     * OS image version
     */
    version?: pulumi.Input<string | enums.workloads.OSImageVersion>;
}
...
export interface OsSapConfigurationArgs {
     ...
     */
    deployerVmPackages?: pulumi.Input<inputs.workloads.DeployerVmPackagesArgs>;
    /**
...
export interface PhpProfileArgs {
     ...
     * PHP version
     */
    version: pulumi.Input<string | enums.workloads.PHPVersion>;
}
...
export interface PhpWorkloadResourceIdentityArgs {
     ...
     */
    type: pulumi.Input<string | enums.workloads.ManagedServiceIdentityType>;
    /**
...
export interface SAPInstallWithoutOSConfigSoftwareConfigurationArgs {
     ...
     * Gets or sets the HA software configuration.
     */
    highAvailabilitySoftwareConfiguration?: pulumi.Input<inputs.workloads.HighAvailabilitySoftwareConfigurationArgs>;
    /**
...
export interface SearchProfileArgs {
     ...
     * Search type
     */
    searchType: pulumi.Input<string | enums.workloads.SearchType>;
}
...
export interface SingleServerConfigurationArgs {
     ...
     * Gets or sets the disk configuration.
     */
    dbDiskConfiguration?: pulumi.Input<inputs.workloads.DiskConfigurationArgs>;
    /**
     ...
     */
    networkConfiguration?: pulumi.Input<inputs.workloads.NetworkConfigurationArgs>;
    /**
     * The subnet id.
     */
    subnetId: pulumi.Input<string>;
...
export function singleServerConfigurationArgsProvideDefaults(val: SingleServerConfigurationArgs): SingleServerConfigurationArgs {
    return {
        ...val,
        networkConfiguration: (val.networkConfiguration ? pulumi.output(val.networkConfiguration).apply(inputs.workloads.networkConfigurationArgsProvideDefaults) : undefined),
    };
}
...
export interface SkuArgs {
     ...
     */
    tier?: pulumi.Input<enums.workloads.SkuTier>;
}
...
export interface SshConfigurationArgs {
     ...
     */
    publicKeys?: pulumi.Input<pulumi.Input<inputs.workloads.SshPublicKeyArgs>[]>;
}
...
export interface StorageConfigurationArgs {
     ...
     */
    transportFileShareConfiguration?: pulumi.Input<inputs.workloads.CreateAndMountFileShareConfigurationArgs | inputs.workloads.MountFileShareConfigurationArgs | inputs.workloads.SkipFileShareConfigurationArgs>;
}
...
export interface ThreeTierConfigurationArgs {
     ...
     */
    applicationServer: pulumi.Input<inputs.workloads.ApplicationServerConfigurationArgs>;
    /**
     * The central server configuration.
     */
    centralServer: pulumi.Input<inputs.workloads.CentralServerConfigurationArgs>;
    /**
     * The database configuration.
     */
    databaseServer: pulumi.Input<inputs.workloads.DatabaseConfigurationArgs>;
    /**
     * The type of SAP deployment, single server or Three tier.
     ...
     */
    highAvailabilityConfig?: pulumi.Input<inputs.workloads.HighAvailabilityConfigurationArgs>;
    /**
     ...
     */
    storageConfiguration?: pulumi.Input<inputs.workloads.StorageConfigurationArgs>;
}
/**
...
export interface VirtualMachineConfigurationArgs {
     ...
     * The image reference.
     */
    imageReference: pulumi.Input<inputs.workloads.ImageReferenceArgs>;
    /**
     * The OS profile.
     */
    osProfile: pulumi.Input<inputs.workloads.OSProfileArgs>;
    /**
