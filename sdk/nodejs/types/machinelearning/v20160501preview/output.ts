...
export interface AssetItemResponse {
     ...
     */
    inputPorts?: {[key: string]: outputs.machinelearning.v20160501preview.InputPortResponse};
    /**
     * Access information for the asset.
     */
    locationInfo: outputs.machinelearning.v20160501preview.AssetLocationResponse;
    /**
     ...
     */
    outputPorts?: {[key: string]: outputs.machinelearning.v20160501preview.OutputPortResponse};
    /**
     * If the asset is a custom module, this holds the module's parameters.
     */
    parameters?: outputs.machinelearning.v20160501preview.ModuleAssetParameterResponse[];
    /**
     * Asset's type.
     */
    type: string;
...
export interface CommitmentPlanPropertiesResponse {
     ...
     */
    includedQuantities: {[key: string]: outputs.machinelearning.v20160501preview.PlanQuantityResponse};
    /**
...
export interface GraphPackageResponse {
     ...
     */
    edges?: outputs.machinelearning.v20160501preview.GraphEdgeResponse[];
    /**
     ...
     */
    graphParameters?: {[key: string]: outputs.machinelearning.v20160501preview.GraphParameterResponse};
    /**
     * The set of nodes making up the graph, provided as a nodeId to GraphNode map
     */
    nodes?: {[key: string]: outputs.machinelearning.v20160501preview.GraphNodeResponse};
}
...
export interface GraphParameterResponse {
     ...
     */
    links: outputs.machinelearning.v20160501preview.GraphParameterLinkResponse[];
    /**
...
export interface ModuleAssetParameterResponse {
     ...
     */
    modeValuesInfo?: {[key: string]: outputs.machinelearning.v20160501preview.ModeValueInfoResponse};
    /**
     * Parameter name.
     */
    name?: string;
...
export interface ServiceInputOutputSpecificationResponse {
     ...
     */
    properties: {[key: string]: outputs.machinelearning.v20160501preview.TableSpecificationResponse};
    /**
...
export interface TableSpecificationResponse {
     ...
     */
    properties?: {[key: string]: outputs.machinelearning.v20160501preview.ColumnSpecificationResponse};
    /**
...
export interface WebServicePropertiesForGraphResponse {
     ...
     */
    assets?: {[key: string]: outputs.machinelearning.v20160501preview.AssetItemResponse};
    /**
     ...
     */
    commitmentPlan?: outputs.machinelearning.v20160501preview.CommitmentPlanResponse;
    /**
     ...
     */
    diagnostics?: outputs.machinelearning.v20160501preview.DiagnosticsConfigurationResponse;
    /**
     * Defines sample input data for one or more of the service's inputs.
     */
    exampleRequest?: outputs.machinelearning.v20160501preview.ExampleRequestResponse;
    /**
     ...
     */
    input?: outputs.machinelearning.v20160501preview.ServiceInputOutputSpecificationResponse;
    /**
     ...
     */
    keys?: outputs.machinelearning.v20160501preview.WebServiceKeysResponse;
    /**
     * Specifies the Machine Learning workspace containing the experiment that is source for the web service.
     */
    machineLearningWorkspace?: outputs.machinelearning.v20160501preview.MachineLearningWorkspaceResponse;
    /**
     ...
     */
    output?: outputs.machinelearning.v20160501preview.ServiceInputOutputSpecificationResponse;
    /**
     * The definition of the graph package making up this web service.
     */
    package?: outputs.machinelearning.v20160501preview.GraphPackageResponse;
    /**
     ...
     */
    realtimeConfiguration?: outputs.machinelearning.v20160501preview.RealtimeConfigurationResponse;
    /**
     ...
     */
    storageAccount?: outputs.machinelearning.v20160501preview.StorageAccountResponse;
    /**
...
export function webServicePropertiesForGraphResponseProvideDefaults(val: WebServicePropertiesForGraphResponse): WebServicePropertiesForGraphResponse {
    return {
        ...val,
        input: (val.input ? outputs.machinelearning.v20160501preview.serviceInputOutputSpecificationResponseProvideDefaults(val.input) : undefined),
        output: (val.output ? outputs.machinelearning.v20160501preview.serviceInputOutputSpecificationResponseProvideDefaults(val.output) : undefined),
    };
}
