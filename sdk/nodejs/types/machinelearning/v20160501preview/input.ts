...
export interface AssetItemArgs {
     ...
     */
    inputPorts?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.v20160501preview.InputPortArgs>}>;
    /**
     * Access information for the asset.
     */
    locationInfo: pulumi.Input<inputs.machinelearning.v20160501preview.AssetLocationArgs>;
    /**
     ...
     */
    outputPorts?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.v20160501preview.OutputPortArgs>}>;
    /**
     * If the asset is a custom module, this holds the module's parameters.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.machinelearning.v20160501preview.ModuleAssetParameterArgs>[]>;
    /**
     * Asset's type.
     */
    type: pulumi.Input<string | enums.machinelearning.v20160501preview.AssetType>;
}
...
export interface ColumnSpecificationArgs {
     ...
     */
    format?: pulumi.Input<string | enums.machinelearning.v20160501preview.ColumnFormat>;
    /**
     * Data type of the column.
     */
    type: pulumi.Input<string | enums.machinelearning.v20160501preview.ColumnType>;
    /**
...
export interface DiagnosticsConfigurationArgs {
     ...
     */
    level: pulumi.Input<string | enums.machinelearning.v20160501preview.DiagnosticsLevel>;
}
...
export interface GraphPackageArgs {
     ...
     */
    edges?: pulumi.Input<pulumi.Input<inputs.machinelearning.v20160501preview.GraphEdgeArgs>[]>;
    /**
     ...
     */
    graphParameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.v20160501preview.GraphParameterArgs>}>;
    /**
     * The set of nodes making up the graph, provided as a nodeId to GraphNode map
     */
    nodes?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.v20160501preview.GraphNodeArgs>}>;
}
...
export interface GraphParameterArgs {
     ...
     */
    links: pulumi.Input<pulumi.Input<inputs.machinelearning.v20160501preview.GraphParameterLinkArgs>[]>;
    /**
     * Graph parameter's type.
     */
    type: pulumi.Input<string | enums.machinelearning.v20160501preview.ParameterType>;
}
...
export interface InputPortArgs {
     ...
     * Port data type.
     */
    type?: pulumi.Input<string | enums.machinelearning.v20160501preview.InputPortType>;
}
/**
...
export interface ModuleAssetParameterArgs {
     ...
     */
    modeValuesInfo?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.v20160501preview.ModeValueInfoArgs>}>;
    /**
     * Parameter name.
     */
    name?: pulumi.Input<string>;
...
export interface OutputPortArgs {
     ...
     * Port data type.
     */
    type?: pulumi.Input<string | enums.machinelearning.v20160501preview.OutputPortType>;
}
/**
...
export interface ServiceInputOutputSpecificationArgs {
     ...
     */
    properties: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.v20160501preview.TableSpecificationArgs>}>;
    /**
...
export interface TableSpecificationArgs {
     ...
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.v20160501preview.ColumnSpecificationArgs>}>;
    /**
...
export interface WebServicePropertiesForGraphArgs {
     ...
     */
    assets?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.v20160501preview.AssetItemArgs>}>;
    /**
     ...
     */
    commitmentPlan?: pulumi.Input<inputs.machinelearning.v20160501preview.CommitmentPlanArgs>;
    /**
     ...
     */
    diagnostics?: pulumi.Input<inputs.machinelearning.v20160501preview.DiagnosticsConfigurationArgs>;
    /**
     * Defines sample input data for one or more of the service's inputs.
     */
    exampleRequest?: pulumi.Input<inputs.machinelearning.v20160501preview.ExampleRequestArgs>;
    /**
     ...
     */
    input?: pulumi.Input<inputs.machinelearning.v20160501preview.ServiceInputOutputSpecificationArgs>;
    /**
     ...
     */
    keys?: pulumi.Input<inputs.machinelearning.v20160501preview.WebServiceKeysArgs>;
    /**
     * Specifies the Machine Learning workspace containing the experiment that is source for the web service.
     */
    machineLearningWorkspace?: pulumi.Input<inputs.machinelearning.v20160501preview.MachineLearningWorkspaceArgs>;
    /**
     ...
     */
    output?: pulumi.Input<inputs.machinelearning.v20160501preview.ServiceInputOutputSpecificationArgs>;
    /**
     * The definition of the graph package making up this web service.
     */
    package?: pulumi.Input<inputs.machinelearning.v20160501preview.GraphPackageArgs>;
    /**
     ...
     */
    realtimeConfiguration?: pulumi.Input<inputs.machinelearning.v20160501preview.RealtimeConfigurationArgs>;
    /**
     ...
     */
    storageAccount?: pulumi.Input<inputs.machinelearning.v20160501preview.StorageAccountArgs>;
    /**
...
export function webServicePropertiesForGraphArgsProvideDefaults(val: WebServicePropertiesForGraphArgs): WebServicePropertiesForGraphArgs {
    return {
        ...val,
        input: (val.input ? pulumi.output(val.input).apply(inputs.machinelearning.v20160501preview.serviceInputOutputSpecificationArgsProvideDefaults) : undefined),
        output: (val.output ? pulumi.output(val.output).apply(inputs.machinelearning.v20160501preview.serviceInputOutputSpecificationArgsProvideDefaults) : undefined),
    };
}
