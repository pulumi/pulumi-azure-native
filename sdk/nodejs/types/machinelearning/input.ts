...
export interface AssetItemArgs {
     ...
     */
    inputPorts?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.InputPortArgs>}>;
    /**
     * Access information for the asset.
     */
    locationInfo: pulumi.Input<inputs.machinelearning.BlobLocationArgs>;
    /**
     ...
     */
    outputPorts?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.OutputPortArgs>}>;
    /**
     * If the asset is a custom module, this holds the module's parameters.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.machinelearning.ModuleAssetParameterArgs>[]>;
    /**
     * Asset's type.
     */
    type: pulumi.Input<string | enums.machinelearning.AssetType>;
}
...
export interface ColumnSpecificationArgs {
     ...
     */
    format?: pulumi.Input<string | enums.machinelearning.ColumnFormat>;
    /**
     * Data type of the column.
     */
    type: pulumi.Input<string | enums.machinelearning.ColumnType>;
    /**
...
export interface DiagnosticsConfigurationArgs {
     ...
     */
    level: pulumi.Input<string | enums.machinelearning.DiagnosticsLevel>;
}
...
export interface GraphNodeArgs {
     ...
     */
    parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.WebServiceParameterArgs>}>;
}
...
export interface GraphPackageArgs {
     ...
     */
    edges?: pulumi.Input<pulumi.Input<inputs.machinelearning.GraphEdgeArgs>[]>;
    /**
     ...
     */
    graphParameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.GraphParameterArgs>}>;
    /**
     * The set of nodes making up the graph, provided as a nodeId to GraphNode map
     */
    nodes?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.GraphNodeArgs>}>;
}
...
export interface GraphParameterArgs {
     ...
     */
    links: pulumi.Input<pulumi.Input<inputs.machinelearning.GraphParameterLinkArgs>[]>;
    /**
     * Graph parameter's type.
     */
    type: pulumi.Input<string | enums.machinelearning.ParameterType>;
}
...
export interface InputPortArgs {
     ...
     * Port data type.
     */
    type?: pulumi.Input<string | enums.machinelearning.InputPortType>;
}
/**
...
export interface ModuleAssetParameterArgs {
     ...
     */
    modeValuesInfo?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.ModeValueInfoArgs>}>;
    /**
     * Parameter name.
     */
    name?: pulumi.Input<string>;
...
export interface OutputPortArgs {
     ...
     * Port data type.
     */
    type?: pulumi.Input<string | enums.machinelearning.OutputPortType>;
}
/**
...
export interface ServiceInputOutputSpecificationArgs {
     ...
     */
    properties: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.TableSpecificationArgs>}>;
    /**
...
export interface TableSpecificationArgs {
     ...
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.ColumnSpecificationArgs>}>;
    /**
...
export interface WebServicePropertiesForGraphArgs {
     ...
     */
    assets?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearning.AssetItemArgs>}>;
    /**
     ...
     */
    commitmentPlan?: pulumi.Input<inputs.machinelearning.CommitmentPlanArgs>;
    /**
     ...
     */
    diagnostics?: pulumi.Input<inputs.machinelearning.DiagnosticsConfigurationArgs>;
    /**
     * Defines sample input data for one or more of the service's inputs.
     */
    exampleRequest?: pulumi.Input<inputs.machinelearning.ExampleRequestArgs>;
    /**
     ...
     */
    input?: pulumi.Input<inputs.machinelearning.ServiceInputOutputSpecificationArgs>;
    /**
     ...
     */
    keys?: pulumi.Input<inputs.machinelearning.WebServiceKeysArgs>;
    /**
     * Specifies the Machine Learning workspace containing the experiment that is source for the web service.
     */
    machineLearningWorkspace?: pulumi.Input<inputs.machinelearning.MachineLearningWorkspaceArgs>;
    /**
     ...
     */
    output?: pulumi.Input<inputs.machinelearning.ServiceInputOutputSpecificationArgs>;
    /**
     * The definition of the graph package making up this web service.
     */
    package?: pulumi.Input<inputs.machinelearning.GraphPackageArgs>;
    /**
     ...
     */
    payloadsLocation?: pulumi.Input<inputs.machinelearning.BlobLocationArgs>;
    /**
     ...
     */
    realtimeConfiguration?: pulumi.Input<inputs.machinelearning.RealtimeConfigurationArgs>;
    /**
     ...
     */
    storageAccount?: pulumi.Input<inputs.machinelearning.StorageAccountArgs>;
    /**
...
export function webServicePropertiesForGraphArgsProvideDefaults(val: WebServicePropertiesForGraphArgs): WebServicePropertiesForGraphArgs {
    return {
        ...val,
        input: (val.input ? pulumi.output(val.input).apply(inputs.machinelearning.serviceInputOutputSpecificationArgsProvideDefaults) : undefined),
        output: (val.output ? pulumi.output(val.output).apply(inputs.machinelearning.serviceInputOutputSpecificationArgsProvideDefaults) : undefined),
    };
}
