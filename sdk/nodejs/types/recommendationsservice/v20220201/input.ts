...
export interface AccountResourcePropertiesArgs {
     ...
     */
    configuration?: pulumi.Input<string | enums.recommendationsservice.v20220201.AccountConfiguration>;
    /**
     * The list of CORS details.
     */
    cors?: pulumi.Input<pulumi.Input<inputs.recommendationsservice.v20220201.CorsRuleArgs>[]>;
    /**
     * The list of service endpoints authentication details.
     */
    endpointAuthentications?: pulumi.Input<pulumi.Input<inputs.recommendationsservice.v20220201.EndpointAuthenticationArgs>[]>;
    /**
...
export interface EndpointAuthenticationArgs {
     ...
     * AAD principal type.
     */
    principalType?: pulumi.Input<string | enums.recommendationsservice.v20220201.PrincipalType>;
}
...
export interface ModelingResourcePropertiesArgs {
     ...
     */
    features?: pulumi.Input<string | enums.recommendationsservice.v20220201.ModelingFeatures>;
    /**
     * Modeling frequency controls the modeling compute frequency.
     */
    frequency?: pulumi.Input<string | enums.recommendationsservice.v20220201.ModelingFrequency>;
    /**
     * The configuration to raw CDM data to be used as Modeling resource input.
     */
    inputData?: pulumi.Input<inputs.recommendationsservice.v20220201.ModelingInputDataArgs>;
    /**
     * Modeling size controls the maximum supported input data size.
     */
    size?: pulumi.Input<string | enums.recommendationsservice.v20220201.ModelingSize>;
}
