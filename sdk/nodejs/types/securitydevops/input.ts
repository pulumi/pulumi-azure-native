...
export interface AzureDevOpsConnectorPropertiesArgs {
    authorization?: pulumi.Input<inputs.securitydevops.AuthorizationInfoArgs>;
    /**
     * Gets or sets org onboarding information.
     */
    orgs?: pulumi.Input<pulumi.Input<inputs.securitydevops.AzureDevOpsOrgMetadataArgs>[]>;
    provisioningState?: pulumi.Input<string | enums.securitydevops.ProvisioningState>;
}
...
export interface AzureDevOpsOrgMetadataArgs {
    autoDiscovery?: pulumi.Input<string | enums.securitydevops.AutoDiscovery>;
    /**
     * Gets or sets name of the AzureDevOps Org.
     */
    name?: pulumi.Input<string>;
    projects?: pulumi.Input<pulumi.Input<inputs.securitydevops.AzureDevOpsProjectMetadataArgs>[]>;
}
