...
export interface DriveStatusArgs {
     ...
     */
    state?: pulumi.Input<string | enums.importexport.v20161101.DriveState>;
    /**
...
export interface EncryptionKeyDetailsArgs {
     ...
     */
    kekType?: pulumi.Input<string | enums.importexport.v20161101.EncryptionKekType>;
    /**
...
export interface JobDetailsArgs {
     ...
     */
    deliveryPackage?: pulumi.Input<inputs.importexport.v20161101.DeliveryPackageInformationArgs>;
    /**
     ...
     */
    driveList?: pulumi.Input<pulumi.Input<inputs.importexport.v20161101.DriveStatusArgs>[]>;
    /**
     * Contains information about the encryption key.
     */
    encryptionKey?: pulumi.Input<inputs.importexport.v20161101.EncryptionKeyDetailsArgs>;
    /**
     * A property containing information about the blobs to be exported for an export job. This property is included for export jobs only.
     */
    export?: pulumi.Input<inputs.importexport.v20161101.ExportArgs>;
    /**
     ...
     */
    returnAddress?: pulumi.Input<inputs.importexport.v20161101.ReturnAddressArgs>;
    /**
     * Contains information about the package being shipped from the Microsoft data center to the customer to return the drives. The format is the same as the deliveryPackage property above. This property is not included if the drives have not yet been returned. 
     */
    returnPackage?: pulumi.Input<inputs.importexport.v20161101.PackageInfomationArgs>;
    /**
     * Specifies the return carrier and customer's account with the carrier. 
     */
    returnShipping?: pulumi.Input<inputs.importexport.v20161101.ReturnShippingArgs>;
    /**
     * Contains information about the Microsoft datacenter to which the drives should be shipped. 
     */
    shippingInformation?: pulumi.Input<inputs.importexport.v20161101.ShippingInformationArgs>;
    /**
...
export function jobDetailsArgsProvideDefaults(val: JobDetailsArgs): JobDetailsArgs {
    return {
        ...
        encryptionKey: (val.encryptionKey ? pulumi.output(val.encryptionKey).apply(inputs.importexport.v20161101.encryptionKeyDetailsArgsProvideDefaults) : undefined),
 ...
 * Contains information about the package being shipped by the customer to the Microsoft data center.
 */
export interface PackageInfomationArgs {
    /**
     * The name of the carrier that is used to ship the import or export drives.
     */
    carrierName: pulumi.Input<string>;
