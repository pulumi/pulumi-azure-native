...
export interface CmdkeySetupResponse {
     ...
     */
    password: outputs.synapse.v20210501.SecureStringResponse;
    /**
...
export interface ComponentSetupResponse {
     ...
     */
    licenseKey?: outputs.synapse.v20210501.SecureStringResponse;
    /**
     * The type of custom setup.
...
export interface CustomerManagedKeyDetailsResponse {
     ...
     * Key encryption key
     */
    kekIdentity?: outputs.synapse.v20210501.KekIdentityPropertiesResponse;
    /**
     * The key object of the workspace
     */
    key?: outputs.synapse.v20210501.WorkspaceKeyDetailsResponse;
    /**
...
export interface EncryptionDetailsResponse {
     ...
     */
    cmk?: outputs.synapse.v20210501.CustomerManagedKeyDetailsResponse;
    /**
...
export interface IntegrationRuntimeComputePropertiesResponse {
     ...
     */
    dataFlowProperties?: outputs.synapse.v20210501.IntegrationRuntimeDataFlowPropertiesResponse;
    /**
     ...
     */
    vNetProperties?: outputs.synapse.v20210501.IntegrationRuntimeVNetPropertiesResponse;
}
...
export interface IntegrationRuntimeCustomSetupScriptPropertiesResponse {
     ...
     */
    sasToken?: outputs.synapse.v20210501.SecureStringResponse;
}
...
export interface IntegrationRuntimeDataProxyPropertiesResponse {
     ...
     */
    connectVia?: outputs.synapse.v20210501.EntityReferenceResponse;
    /**
     ...
     */
    stagingLinkedService?: outputs.synapse.v20210501.EntityReferenceResponse;
}
...
export interface IntegrationRuntimeSsisCatalogInfoResponse {
     ...
     */
    catalogAdminPassword?: outputs.synapse.v20210501.SecureStringResponse;
    /**
...
export interface IntegrationRuntimeSsisPropertiesResponse {
     ...
     * Catalog information for managed dedicated integration runtime.
     */
    catalogInfo?: outputs.synapse.v20210501.IntegrationRuntimeSsisCatalogInfoResponse;
    /**
     * Custom setup script properties for a managed dedicated integration runtime.
     */
    customSetupScriptProperties?: outputs.synapse.v20210501.IntegrationRuntimeCustomSetupScriptPropertiesResponse;
    /**
     * Data proxy properties for a managed dedicated integration runtime.
     */
    dataProxyProperties?: outputs.synapse.v20210501.IntegrationRuntimeDataProxyPropertiesResponse;
    /**
     ...
     */
    expressCustomSetupProperties?: (outputs.synapse.v20210501.CmdkeySetupResponse | outputs.synapse.v20210501.ComponentSetupResponse | outputs.synapse.v20210501.EnvironmentVariableSetupResponse)[];
    /**
...
export interface LinkedIntegrationRuntimeKeyAuthorizationResponse {
     ...
     */
    key: outputs.synapse.v20210501.SecureStringResponse;
}
...
export interface ManagedIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.synapse.v20210501.UserAssignedManagedIdentityResponse};
}
...
export interface ManagedIntegrationRuntimeNodeResponse {
     ...
     */
    errors?: outputs.synapse.v20210501.ManagedIntegrationRuntimeErrorResponse[];
    /**
...
export interface ManagedIntegrationRuntimeResponse {
     ...
     */
    computeProperties?: outputs.synapse.v20210501.IntegrationRuntimeComputePropertiesResponse;
    /**
     ...
     * SSIS properties for managed integration runtime.
     */
    ssisProperties?: outputs.synapse.v20210501.IntegrationRuntimeSsisPropertiesResponse;
    /**
...
export interface ManagedIntegrationRuntimeStatusResponse {
     ...
     */
    lastOperation: outputs.synapse.v20210501.ManagedIntegrationRuntimeOperationResultResponse;
    /**
     * The list of nodes for managed integration runtime.
     */
    nodes: outputs.synapse.v20210501.ManagedIntegrationRuntimeNodeResponse[];
    /**
     * The errors that occurred on this integration runtime.
     */
    otherErrors: outputs.synapse.v20210501.ManagedIntegrationRuntimeErrorResponse[];
    /**
...
export interface PrivateEndpointConnectionForPrivateLinkHubBasicResponse {
     ...
     */
    privateEndpoint?: outputs.synapse.v20210501.PrivateEndpointResponse;
    /**
     * Connection state of the private endpoint connection.
     */
    privateLinkServiceConnectionState?: outputs.synapse.v20210501.PrivateLinkServiceConnectionStateResponse;
    /**
...
export interface SelfHostedIntegrationRuntimeResponse {
     ...
     */
    linkedInfo?: outputs.synapse.v20210501.LinkedIntegrationRuntimeKeyAuthorizationResponse | outputs.synapse.v20210501.LinkedIntegrationRuntimeRbacAuthorizationResponse;
    /**
     * The type of integration runtime.
...
export interface SelfHostedIntegrationRuntimeStatusResponse {
     ...
     */
    links?: outputs.synapse.v20210501.LinkedIntegrationRuntimeResponse[];
    /**
     ...
     */
    nodes?: outputs.synapse.v20210501.SelfHostedIntegrationRuntimeNodeResponse[];
    /**
...
export interface SsisEnvironmentResponse {
     ...
     */
    variables?: outputs.synapse.v20210501.SsisVariableResponse[];
}
...
export interface SsisPackageResponse {
     ...
     */
    parameters?: outputs.synapse.v20210501.SsisParameterResponse[];
    /**
...
export interface SsisProjectResponse {
     ...
     */
    environmentRefs?: outputs.synapse.v20210501.SsisEnvironmentReferenceResponse[];
    /**
