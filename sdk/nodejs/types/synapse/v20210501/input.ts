...
export interface CmdkeySetupArgs {
     ...
     */
    password: pulumi.Input<inputs.synapse.v20210501.SecureStringArgs>;
    /**
...
export interface ComponentSetupArgs {
     ...
     */
    licenseKey?: pulumi.Input<inputs.synapse.v20210501.SecureStringArgs>;
    /**
     * The type of custom setup.
...
export interface CustomerManagedKeyDetailsArgs {
     ...
     * Key encryption key
     */
    kekIdentity?: pulumi.Input<inputs.synapse.v20210501.KekIdentityPropertiesArgs>;
    /**
     * The key object of the workspace
     */
    key?: pulumi.Input<inputs.synapse.v20210501.WorkspaceKeyDetailsArgs>;
}
...
export interface EncryptionDetailsArgs {
     ...
     */
    cmk?: pulumi.Input<inputs.synapse.v20210501.CustomerManagedKeyDetailsArgs>;
}
...
export interface EntityReferenceArgs {
     ...
     */
    type?: pulumi.Input<string | enums.synapse.v20210501.IntegrationRuntimeEntityReferenceType>;
}
...
export interface IntegrationRuntimeComputePropertiesArgs {
     ...
     */
    dataFlowProperties?: pulumi.Input<inputs.synapse.v20210501.IntegrationRuntimeDataFlowPropertiesArgs>;
    /**
     ...
     */
    vNetProperties?: pulumi.Input<inputs.synapse.v20210501.IntegrationRuntimeVNetPropertiesArgs>;
}
...
export interface IntegrationRuntimeCustomSetupScriptPropertiesArgs {
     ...
     */
    sasToken?: pulumi.Input<inputs.synapse.v20210501.SecureStringArgs>;
}
...
export interface IntegrationRuntimeDataFlowPropertiesArgs {
     ...
     */
    computeType?: pulumi.Input<string | enums.synapse.v20210501.DataFlowComputeType>;
    /**
...
export interface IntegrationRuntimeDataProxyPropertiesArgs {
     ...
     */
    connectVia?: pulumi.Input<inputs.synapse.v20210501.EntityReferenceArgs>;
    /**
     ...
     */
    stagingLinkedService?: pulumi.Input<inputs.synapse.v20210501.EntityReferenceArgs>;
}
...
export interface IntegrationRuntimeSsisCatalogInfoArgs {
     ...
     */
    catalogAdminPassword?: pulumi.Input<inputs.synapse.v20210501.SecureStringArgs>;
    /**
     ...
     */
    catalogPricingTier?: pulumi.Input<string | enums.synapse.v20210501.IntegrationRuntimeSsisCatalogPricingTier>;
    /**
...
export interface IntegrationRuntimeSsisPropertiesArgs {
     ...
     * Catalog information for managed dedicated integration runtime.
     */
    catalogInfo?: pulumi.Input<inputs.synapse.v20210501.IntegrationRuntimeSsisCatalogInfoArgs>;
    /**
     * Custom setup script properties for a managed dedicated integration runtime.
     */
    customSetupScriptProperties?: pulumi.Input<inputs.synapse.v20210501.IntegrationRuntimeCustomSetupScriptPropertiesArgs>;
    /**
     * Data proxy properties for a managed dedicated integration runtime.
     */
    dataProxyProperties?: pulumi.Input<inputs.synapse.v20210501.IntegrationRuntimeDataProxyPropertiesArgs>;
    /**
     * The edition for the SSIS Integration Runtime
     */
    edition?: pulumi.Input<string | enums.synapse.v20210501.IntegrationRuntimeEdition>;
    /**
     * Custom setup without script properties for a SSIS integration runtime.
     */
    expressCustomSetupProperties?: pulumi.Input<pulumi.Input<inputs.synapse.v20210501.CmdkeySetupArgs | inputs.synapse.v20210501.ComponentSetupArgs | inputs.synapse.v20210501.EnvironmentVariableSetupArgs>[]>;
    /**
     * License type for bringing your own license scenario.
     */
    licenseType?: pulumi.Input<string | enums.synapse.v20210501.IntegrationRuntimeLicenseType>;
}
...
export interface LinkedIntegrationRuntimeKeyAuthorizationArgs {
     ...
     */
    key: pulumi.Input<inputs.synapse.v20210501.SecureStringArgs>;
}
...
export interface ManagedIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.synapse.v20210501.ResourceIdentityType>;
    /**
...
export interface ManagedIntegrationRuntimeArgs {
     ...
     */
    computeProperties?: pulumi.Input<inputs.synapse.v20210501.IntegrationRuntimeComputePropertiesArgs>;
    /**
     ...
     * SSIS properties for managed integration runtime.
     */
    ssisProperties?: pulumi.Input<inputs.synapse.v20210501.IntegrationRuntimeSsisPropertiesArgs>;
    /**
...
export interface SelfHostedIntegrationRuntimeArgs {
     ...
     */
    linkedInfo?: pulumi.Input<inputs.synapse.v20210501.LinkedIntegrationRuntimeKeyAuthorizationArgs | inputs.synapse.v20210501.LinkedIntegrationRuntimeRbacAuthorizationArgs>;
    /**
     * The type of integration runtime.
