...
export interface CmdkeySetupArgs {
     ...
     */
    password: pulumi.Input<inputs.synapse.v20210301.SecureStringArgs>;
    /**
...
export interface ComponentSetupArgs {
     ...
     */
    licenseKey?: pulumi.Input<inputs.synapse.v20210301.SecureStringArgs>;
    /**
     * The type of custom setup.
...
export interface CustomerManagedKeyDetailsArgs {
     ...
     */
    key?: pulumi.Input<inputs.synapse.v20210301.WorkspaceKeyDetailsArgs>;
}
...
export interface EncryptionDetailsArgs {
     ...
     */
    cmk?: pulumi.Input<inputs.synapse.v20210301.CustomerManagedKeyDetailsArgs>;
}
...
export interface EntityReferenceArgs {
     ...
     */
    type?: pulumi.Input<string | enums.synapse.v20210301.IntegrationRuntimeEntityReferenceType>;
}
...
export interface IntegrationRuntimeComputePropertiesArgs {
     ...
     */
    dataFlowProperties?: pulumi.Input<inputs.synapse.v20210301.IntegrationRuntimeDataFlowPropertiesArgs>;
    /**
     ...
     */
    vNetProperties?: pulumi.Input<inputs.synapse.v20210301.IntegrationRuntimeVNetPropertiesArgs>;
}
...
export interface IntegrationRuntimeCustomSetupScriptPropertiesArgs {
     ...
     */
    sasToken?: pulumi.Input<inputs.synapse.v20210301.SecureStringArgs>;
}
...
export interface IntegrationRuntimeDataFlowPropertiesArgs {
     ...
     */
    computeType?: pulumi.Input<string | enums.synapse.v20210301.DataFlowComputeType>;
    /**
...
export interface IntegrationRuntimeDataProxyPropertiesArgs {
     ...
     */
    connectVia?: pulumi.Input<inputs.synapse.v20210301.EntityReferenceArgs>;
    /**
     ...
     */
    stagingLinkedService?: pulumi.Input<inputs.synapse.v20210301.EntityReferenceArgs>;
}
...
export interface IntegrationRuntimeSsisCatalogInfoArgs {
     ...
     */
    catalogAdminPassword?: pulumi.Input<inputs.synapse.v20210301.SecureStringArgs>;
    /**
     ...
     */
    catalogPricingTier?: pulumi.Input<string | enums.synapse.v20210301.IntegrationRuntimeSsisCatalogPricingTier>;
    /**
...
export interface IntegrationRuntimeSsisPropertiesArgs {
     ...
     * Catalog information for managed dedicated integration runtime.
     */
    catalogInfo?: pulumi.Input<inputs.synapse.v20210301.IntegrationRuntimeSsisCatalogInfoArgs>;
    /**
     * Custom setup script properties for a managed dedicated integration runtime.
     */
    customSetupScriptProperties?: pulumi.Input<inputs.synapse.v20210301.IntegrationRuntimeCustomSetupScriptPropertiesArgs>;
    /**
     * Data proxy properties for a managed dedicated integration runtime.
     */
    dataProxyProperties?: pulumi.Input<inputs.synapse.v20210301.IntegrationRuntimeDataProxyPropertiesArgs>;
    /**
     * The edition for the SSIS Integration Runtime
     */
    edition?: pulumi.Input<string | enums.synapse.v20210301.IntegrationRuntimeEdition>;
    /**
     * Custom setup without script properties for a SSIS integration runtime.
     */
    expressCustomSetupProperties?: pulumi.Input<pulumi.Input<inputs.synapse.v20210301.CmdkeySetupArgs | inputs.synapse.v20210301.ComponentSetupArgs | inputs.synapse.v20210301.EnvironmentVariableSetupArgs>[]>;
    /**
     * License type for bringing your own license scenario.
     */
    licenseType?: pulumi.Input<string | enums.synapse.v20210301.IntegrationRuntimeLicenseType>;
}
...
export interface LinkedIntegrationRuntimeKeyAuthorizationArgs {
     ...
     */
    key: pulumi.Input<inputs.synapse.v20210301.SecureStringArgs>;
}
...
export interface ManagedIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.synapse.v20210301.ResourceIdentityType>;
}
...
export interface ManagedIntegrationRuntimeArgs {
     ...
     */
    computeProperties?: pulumi.Input<inputs.synapse.v20210301.IntegrationRuntimeComputePropertiesArgs>;
    /**
     ...
     * SSIS properties for managed integration runtime.
     */
    ssisProperties?: pulumi.Input<inputs.synapse.v20210301.IntegrationRuntimeSsisPropertiesArgs>;
    /**
...
export interface SelfHostedIntegrationRuntimeArgs {
     ...
     */
    linkedInfo?: pulumi.Input<inputs.synapse.v20210301.LinkedIntegrationRuntimeKeyAuthorizationArgs | inputs.synapse.v20210301.LinkedIntegrationRuntimeRbacAuthorizationArgs>;
    /**
     * The type of integration runtime.
