...
export interface CmdkeySetupResponse {
     ...
     */
    password: outputs.synapse.v20210401preview.SecureStringResponse;
    /**
...
export interface ComponentSetupResponse {
     ...
     */
    licenseKey?: outputs.synapse.v20210401preview.SecureStringResponse;
    /**
     * The type of custom setup.
...
export interface CustomerManagedKeyDetailsResponse {
     ...
     */
    key?: outputs.synapse.v20210401preview.WorkspaceKeyDetailsResponse;
    /**
...
export interface EncryptionDetailsResponse {
     ...
     */
    cmk?: outputs.synapse.v20210401preview.CustomerManagedKeyDetailsResponse;
    /**
...
export interface IntegrationRuntimeComputePropertiesResponse {
     ...
     */
    dataFlowProperties?: outputs.synapse.v20210401preview.IntegrationRuntimeDataFlowPropertiesResponse;
    /**
     ...
     */
    vNetProperties?: outputs.synapse.v20210401preview.IntegrationRuntimeVNetPropertiesResponse;
}
...
export interface IntegrationRuntimeCustomSetupScriptPropertiesResponse {
     ...
     */
    sasToken?: outputs.synapse.v20210401preview.SecureStringResponse;
}
...
export interface IntegrationRuntimeDataProxyPropertiesResponse {
     ...
     */
    connectVia?: outputs.synapse.v20210401preview.EntityReferenceResponse;
    /**
     ...
     */
    stagingLinkedService?: outputs.synapse.v20210401preview.EntityReferenceResponse;
}
...
export interface IntegrationRuntimeSsisCatalogInfoResponse {
     ...
     */
    catalogAdminPassword?: outputs.synapse.v20210401preview.SecureStringResponse;
    /**
...
export interface IntegrationRuntimeSsisPropertiesResponse {
     ...
     * Catalog information for managed dedicated integration runtime.
     */
    catalogInfo?: outputs.synapse.v20210401preview.IntegrationRuntimeSsisCatalogInfoResponse;
    /**
     * Custom setup script properties for a managed dedicated integration runtime.
     */
    customSetupScriptProperties?: outputs.synapse.v20210401preview.IntegrationRuntimeCustomSetupScriptPropertiesResponse;
    /**
     * Data proxy properties for a managed dedicated integration runtime.
     */
    dataProxyProperties?: outputs.synapse.v20210401preview.IntegrationRuntimeDataProxyPropertiesResponse;
    /**
     ...
     */
    expressCustomSetupProperties?: (outputs.synapse.v20210401preview.CmdkeySetupResponse | outputs.synapse.v20210401preview.ComponentSetupResponse | outputs.synapse.v20210401preview.EnvironmentVariableSetupResponse)[];
    /**
...
export interface LinkedIntegrationRuntimeKeyAuthorizationResponse {
     ...
     */
    key: outputs.synapse.v20210401preview.SecureStringResponse;
}
...
export interface ManagedIntegrationRuntimeNodeResponse {
     ...
     */
    errors?: outputs.synapse.v20210401preview.ManagedIntegrationRuntimeErrorResponse[];
    /**
...
export interface ManagedIntegrationRuntimeResponse {
     ...
     */
    computeProperties?: outputs.synapse.v20210401preview.IntegrationRuntimeComputePropertiesResponse;
    /**
     ...
     * SSIS properties for managed integration runtime.
     */
    ssisProperties?: outputs.synapse.v20210401preview.IntegrationRuntimeSsisPropertiesResponse;
    /**
...
export interface ManagedIntegrationRuntimeStatusResponse {
     ...
     */
    lastOperation: outputs.synapse.v20210401preview.ManagedIntegrationRuntimeOperationResultResponse;
    /**
     * The list of nodes for managed integration runtime.
     */
    nodes: outputs.synapse.v20210401preview.ManagedIntegrationRuntimeNodeResponse[];
    /**
     * The errors that occurred on this integration runtime.
     */
    otherErrors: outputs.synapse.v20210401preview.ManagedIntegrationRuntimeErrorResponse[];
    /**
...
export interface PrivateEndpointConnectionForPrivateLinkHubBasicResponse {
     ...
     */
    privateEndpoint?: outputs.synapse.v20210401preview.PrivateEndpointResponse;
    /**
     * Connection state of the private endpoint connection.
     */
    privateLinkServiceConnectionState?: outputs.synapse.v20210401preview.PrivateLinkServiceConnectionStateResponse;
    /**
...
export interface SelfHostedIntegrationRuntimeResponse {
     ...
     */
    linkedInfo?: outputs.synapse.v20210401preview.LinkedIntegrationRuntimeKeyAuthorizationResponse | outputs.synapse.v20210401preview.LinkedIntegrationRuntimeRbacAuthorizationResponse;
    /**
     * The type of integration runtime.
...
export interface SelfHostedIntegrationRuntimeStatusResponse {
     ...
     */
    links?: outputs.synapse.v20210401preview.LinkedIntegrationRuntimeResponse[];
    /**
     ...
     */
    nodes?: outputs.synapse.v20210401preview.SelfHostedIntegrationRuntimeNodeResponse[];
    /**
...
export interface SsisEnvironmentResponse {
     ...
     */
    variables?: outputs.synapse.v20210401preview.SsisVariableResponse[];
}
...
export interface SsisPackageResponse {
     ...
     */
    parameters?: outputs.synapse.v20210401preview.SsisParameterResponse[];
    /**
...
export interface SsisProjectResponse {
     ...
     */
    environmentRefs?: outputs.synapse.v20210401preview.SsisEnvironmentReferenceResponse[];
    /**
