...
export interface CmdkeySetupArgs {
     ...
     */
    password: pulumi.Input<inputs.synapse.v20210601.SecureStringArgs>;
    /**
...
export interface ComponentSetupArgs {
     ...
     */
    licenseKey?: pulumi.Input<inputs.synapse.v20210601.SecureStringArgs>;
    /**
     * The type of custom setup.
...
export interface CustomerManagedKeyDetailsArgs {
     ...
     * Key encryption key
     */
    kekIdentity?: pulumi.Input<inputs.synapse.v20210601.KekIdentityPropertiesArgs>;
    /**
     * The key object of the workspace
     */
    key?: pulumi.Input<inputs.synapse.v20210601.WorkspaceKeyDetailsArgs>;
}
...
export interface EncryptionDetailsArgs {
     ...
     */
    cmk?: pulumi.Input<inputs.synapse.v20210601.CustomerManagedKeyDetailsArgs>;
}
...
export interface EntityReferenceArgs {
     ...
     */
    type?: pulumi.Input<string | enums.synapse.v20210601.IntegrationRuntimeEntityReferenceType>;
}
...
export interface IntegrationRuntimeComputePropertiesArgs {
     ...
     */
    dataFlowProperties?: pulumi.Input<inputs.synapse.v20210601.IntegrationRuntimeDataFlowPropertiesArgs>;
    /**
     ...
     */
    vNetProperties?: pulumi.Input<inputs.synapse.v20210601.IntegrationRuntimeVNetPropertiesArgs>;
}
...
export interface IntegrationRuntimeCustomSetupScriptPropertiesArgs {
     ...
     */
    sasToken?: pulumi.Input<inputs.synapse.v20210601.SecureStringArgs>;
}
...
export interface IntegrationRuntimeDataFlowPropertiesArgs {
     ...
     */
    computeType?: pulumi.Input<string | enums.synapse.v20210601.DataFlowComputeType>;
    /**
...
export interface IntegrationRuntimeDataProxyPropertiesArgs {
     ...
     */
    connectVia?: pulumi.Input<inputs.synapse.v20210601.EntityReferenceArgs>;
    /**
     ...
     */
    stagingLinkedService?: pulumi.Input<inputs.synapse.v20210601.EntityReferenceArgs>;
}
...
export interface IntegrationRuntimeSsisCatalogInfoArgs {
     ...
     */
    catalogAdminPassword?: pulumi.Input<inputs.synapse.v20210601.SecureStringArgs>;
    /**
     ...
     */
    catalogPricingTier?: pulumi.Input<string | enums.synapse.v20210601.IntegrationRuntimeSsisCatalogPricingTier>;
    /**
...
export interface IntegrationRuntimeSsisPropertiesArgs {
     ...
     * Catalog information for managed dedicated integration runtime.
     */
    catalogInfo?: pulumi.Input<inputs.synapse.v20210601.IntegrationRuntimeSsisCatalogInfoArgs>;
    /**
     * Custom setup script properties for a managed dedicated integration runtime.
     */
    customSetupScriptProperties?: pulumi.Input<inputs.synapse.v20210601.IntegrationRuntimeCustomSetupScriptPropertiesArgs>;
    /**
     * Data proxy properties for a managed dedicated integration runtime.
     */
    dataProxyProperties?: pulumi.Input<inputs.synapse.v20210601.IntegrationRuntimeDataProxyPropertiesArgs>;
    /**
     * The edition for the SSIS Integration Runtime
     */
    edition?: pulumi.Input<string | enums.synapse.v20210601.IntegrationRuntimeEdition>;
    /**
     * Custom setup without script properties for a SSIS integration runtime.
     */
    expressCustomSetupProperties?: pulumi.Input<pulumi.Input<inputs.synapse.v20210601.CmdkeySetupArgs | inputs.synapse.v20210601.ComponentSetupArgs | inputs.synapse.v20210601.EnvironmentVariableSetupArgs>[]>;
    /**
     * License type for bringing your own license scenario.
     */
    licenseType?: pulumi.Input<string | enums.synapse.v20210601.IntegrationRuntimeLicenseType>;
}
...
export interface LinkedIntegrationRuntimeKeyAuthorizationArgs {
     ...
     */
    key: pulumi.Input<inputs.synapse.v20210601.SecureStringArgs>;
}
...
export interface ManagedIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.synapse.v20210601.ResourceIdentityType>;
    /**
...
export interface ManagedIntegrationRuntimeArgs {
     ...
     */
    computeProperties?: pulumi.Input<inputs.synapse.v20210601.IntegrationRuntimeComputePropertiesArgs>;
    /**
     * The name of virtual network to which Azure-SSIS integration runtime will join
     */
    customerVirtualNetwork?: pulumi.Input<inputs.synapse.v20210601.IntegrationRuntimeCustomerVirtualNetworkArgs>;
    /**
     ...
     * SSIS properties for managed integration runtime.
     */
    ssisProperties?: pulumi.Input<inputs.synapse.v20210601.IntegrationRuntimeSsisPropertiesArgs>;
    /**
...
export interface SelfHostedIntegrationRuntimeArgs {
     ...
     */
    linkedInfo?: pulumi.Input<inputs.synapse.v20210601.LinkedIntegrationRuntimeKeyAuthorizationArgs | inputs.synapse.v20210601.LinkedIntegrationRuntimeRbacAuthorizationArgs>;
    /**
     * The type of integration runtime.
...
export interface SparkConfigPropertiesArgs {
     ...
     */
    configurationType?: pulumi.Input<string | enums.synapse.v20210601.ConfigurationType>;
    /**
