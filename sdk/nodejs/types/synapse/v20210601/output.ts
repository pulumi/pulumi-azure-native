...
export interface CmdkeySetupResponse {
     ...
     */
    password: outputs.synapse.v20210601.SecureStringResponse;
    /**
...
export interface ComponentSetupResponse {
     ...
     */
    licenseKey?: outputs.synapse.v20210601.SecureStringResponse;
    /**
     * The type of custom setup.
...
export interface CustomerManagedKeyDetailsResponse {
     ...
     * Key encryption key
     */
    kekIdentity?: outputs.synapse.v20210601.KekIdentityPropertiesResponse;
    /**
     * The key object of the workspace
     */
    key?: outputs.synapse.v20210601.WorkspaceKeyDetailsResponse;
    /**
...
export interface EncryptionDetailsResponse {
     ...
     */
    cmk?: outputs.synapse.v20210601.CustomerManagedKeyDetailsResponse;
    /**
...
export interface IntegrationRuntimeComputePropertiesResponse {
     ...
     */
    dataFlowProperties?: outputs.synapse.v20210601.IntegrationRuntimeDataFlowPropertiesResponse;
    /**
     ...
     */
    vNetProperties?: outputs.synapse.v20210601.IntegrationRuntimeVNetPropertiesResponse;
}
...
export interface IntegrationRuntimeCustomSetupScriptPropertiesResponse {
     ...
     */
    sasToken?: outputs.synapse.v20210601.SecureStringResponse;
}
...
export interface IntegrationRuntimeDataProxyPropertiesResponse {
     ...
     */
    connectVia?: outputs.synapse.v20210601.EntityReferenceResponse;
    /**
     ...
     */
    stagingLinkedService?: outputs.synapse.v20210601.EntityReferenceResponse;
}
...
export interface IntegrationRuntimeSsisCatalogInfoResponse {
     ...
     */
    catalogAdminPassword?: outputs.synapse.v20210601.SecureStringResponse;
    /**
...
export interface IntegrationRuntimeSsisPropertiesResponse {
     ...
     * Catalog information for managed dedicated integration runtime.
     */
    catalogInfo?: outputs.synapse.v20210601.IntegrationRuntimeSsisCatalogInfoResponse;
    /**
     * Custom setup script properties for a managed dedicated integration runtime.
     */
    customSetupScriptProperties?: outputs.synapse.v20210601.IntegrationRuntimeCustomSetupScriptPropertiesResponse;
    /**
     * Data proxy properties for a managed dedicated integration runtime.
     */
    dataProxyProperties?: outputs.synapse.v20210601.IntegrationRuntimeDataProxyPropertiesResponse;
    /**
     ...
     */
    expressCustomSetupProperties?: (outputs.synapse.v20210601.CmdkeySetupResponse | outputs.synapse.v20210601.ComponentSetupResponse | outputs.synapse.v20210601.EnvironmentVariableSetupResponse)[];
    /**
...
export interface LinkedIntegrationRuntimeKeyAuthorizationResponse {
     ...
     */
    key: outputs.synapse.v20210601.SecureStringResponse;
}
...
export interface ManagedIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.synapse.v20210601.UserAssignedManagedIdentityResponse};
}
...
export interface ManagedIntegrationRuntimeNodeResponse {
     ...
     */
    errors?: outputs.synapse.v20210601.ManagedIntegrationRuntimeErrorResponse[];
    /**
...
export interface ManagedIntegrationRuntimeResponse {
     ...
     */
    computeProperties?: outputs.synapse.v20210601.IntegrationRuntimeComputePropertiesResponse;
    /**
     * The name of virtual network to which Azure-SSIS integration runtime will join
     */
    customerVirtualNetwork?: outputs.synapse.v20210601.IntegrationRuntimeCustomerVirtualNetworkResponse;
    /**
     ...
     * SSIS properties for managed integration runtime.
     */
    ssisProperties?: outputs.synapse.v20210601.IntegrationRuntimeSsisPropertiesResponse;
    /**
...
export interface ManagedIntegrationRuntimeStatusResponse {
     ...
     */
    lastOperation: outputs.synapse.v20210601.ManagedIntegrationRuntimeOperationResultResponse;
    /**
     * The list of nodes for managed integration runtime.
     */
    nodes: outputs.synapse.v20210601.ManagedIntegrationRuntimeNodeResponse[];
    /**
     * The errors that occurred on this integration runtime.
     */
    otherErrors: outputs.synapse.v20210601.ManagedIntegrationRuntimeErrorResponse[];
    /**
...
export interface PrivateEndpointConnectionForPrivateLinkHubBasicResponse {
     ...
     */
    privateEndpoint?: outputs.synapse.v20210601.PrivateEndpointResponse;
    /**
     * Connection state of the private endpoint connection.
     */
    privateLinkServiceConnectionState?: outputs.synapse.v20210601.PrivateLinkServiceConnectionStateResponse;
    /**
...
export interface SelfHostedIntegrationRuntimeResponse {
     ...
     */
    linkedInfo?: outputs.synapse.v20210601.LinkedIntegrationRuntimeKeyAuthorizationResponse | outputs.synapse.v20210601.LinkedIntegrationRuntimeRbacAuthorizationResponse;
    /**
     * The type of integration runtime.
...
export interface SelfHostedIntegrationRuntimeStatusResponse {
     ...
     */
    links?: outputs.synapse.v20210601.LinkedIntegrationRuntimeResponse[];
    /**
     ...
     */
    nodes?: outputs.synapse.v20210601.SelfHostedIntegrationRuntimeNodeResponse[];
    /**
...
export interface SsisEnvironmentResponse {
     ...
     */
    variables?: outputs.synapse.v20210601.SsisVariableResponse[];
}
...
export interface SsisPackageResponse {
     ...
     */
    parameters?: outputs.synapse.v20210601.SsisParameterResponse[];
    /**
...
export interface SsisProjectResponse {
     ...
     */
    environmentRefs?: outputs.synapse.v20210601.SsisEnvironmentReferenceResponse[];
    /**
