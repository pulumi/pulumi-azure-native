...
export interface AzureSkuArgs {
     ...
     * SKU name.
     */
    name: pulumi.Input<string | enums.synapse.v20210601preview.SkuName>;
    /**
     * SKU size.
     */
    size: pulumi.Input<string | enums.synapse.v20210601preview.SkuSize>;
}
...
export interface CmdkeySetupArgs {
     ...
     */
    password: pulumi.Input<inputs.synapse.v20210601preview.SecureStringArgs>;
    /**
...
export interface ComponentSetupArgs {
     ...
     */
    licenseKey?: pulumi.Input<inputs.synapse.v20210601preview.SecureStringArgs>;
    /**
     * The type of custom setup.
...
export interface CustomerManagedKeyDetailsArgs {
     ...
     * Key encryption key
     */
    kekIdentity?: pulumi.Input<inputs.synapse.v20210601preview.KekIdentityPropertiesArgs>;
    /**
     * The key object of the workspace
     */
    key?: pulumi.Input<inputs.synapse.v20210601preview.WorkspaceKeyDetailsArgs>;
}
...
export interface EncryptionDetailsArgs {
     ...
     */
    cmk?: pulumi.Input<inputs.synapse.v20210601preview.CustomerManagedKeyDetailsArgs>;
}
...
export interface EntityReferenceArgs {
     ...
     */
    type?: pulumi.Input<string | enums.synapse.v20210601preview.IntegrationRuntimeEntityReferenceType>;
}
...
export interface IntegrationRuntimeComputePropertiesArgs {
     ...
     */
    dataFlowProperties?: pulumi.Input<inputs.synapse.v20210601preview.IntegrationRuntimeDataFlowPropertiesArgs>;
    /**
     ...
     */
    vNetProperties?: pulumi.Input<inputs.synapse.v20210601preview.IntegrationRuntimeVNetPropertiesArgs>;
}
...
export interface IntegrationRuntimeCustomSetupScriptPropertiesArgs {
     ...
     */
    sasToken?: pulumi.Input<inputs.synapse.v20210601preview.SecureStringArgs>;
}
...
export interface IntegrationRuntimeDataFlowPropertiesArgs {
     ...
     */
    computeType?: pulumi.Input<string | enums.synapse.v20210601preview.DataFlowComputeType>;
    /**
...
export interface IntegrationRuntimeDataProxyPropertiesArgs {
     ...
     */
    connectVia?: pulumi.Input<inputs.synapse.v20210601preview.EntityReferenceArgs>;
    /**
     ...
     */
    stagingLinkedService?: pulumi.Input<inputs.synapse.v20210601preview.EntityReferenceArgs>;
}
...
export interface IntegrationRuntimeSsisCatalogInfoArgs {
     ...
     */
    catalogAdminPassword?: pulumi.Input<inputs.synapse.v20210601preview.SecureStringArgs>;
    /**
     ...
     */
    catalogPricingTier?: pulumi.Input<string | enums.synapse.v20210601preview.IntegrationRuntimeSsisCatalogPricingTier>;
    /**
...
export interface IntegrationRuntimeSsisPropertiesArgs {
     ...
     * Catalog information for managed dedicated integration runtime.
     */
    catalogInfo?: pulumi.Input<inputs.synapse.v20210601preview.IntegrationRuntimeSsisCatalogInfoArgs>;
    /**
     * Custom setup script properties for a managed dedicated integration runtime.
     */
    customSetupScriptProperties?: pulumi.Input<inputs.synapse.v20210601preview.IntegrationRuntimeCustomSetupScriptPropertiesArgs>;
    /**
     * Data proxy properties for a managed dedicated integration runtime.
     */
    dataProxyProperties?: pulumi.Input<inputs.synapse.v20210601preview.IntegrationRuntimeDataProxyPropertiesArgs>;
    /**
     * The edition for the SSIS Integration Runtime
     */
    edition?: pulumi.Input<string | enums.synapse.v20210601preview.IntegrationRuntimeEdition>;
    /**
     * Custom setup without script properties for a SSIS integration runtime.
     */
    expressCustomSetupProperties?: pulumi.Input<pulumi.Input<inputs.synapse.v20210601preview.CmdkeySetupArgs | inputs.synapse.v20210601preview.ComponentSetupArgs | inputs.synapse.v20210601preview.EnvironmentVariableSetupArgs>[]>;
    /**
     * License type for bringing your own license scenario.
     */
    licenseType?: pulumi.Input<string | enums.synapse.v20210601preview.IntegrationRuntimeLicenseType>;
}
...
export interface LinkedIntegrationRuntimeKeyAuthorizationArgs {
     ...
     */
    key: pulumi.Input<inputs.synapse.v20210601preview.SecureStringArgs>;
}
...
export interface ManagedIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.synapse.v20210601preview.ResourceIdentityType>;
    /**
...
export interface ManagedIntegrationRuntimeArgs {
     ...
     */
    computeProperties?: pulumi.Input<inputs.synapse.v20210601preview.IntegrationRuntimeComputePropertiesArgs>;
    /**
     ...
     * SSIS properties for managed integration runtime.
     */
    ssisProperties?: pulumi.Input<inputs.synapse.v20210601preview.IntegrationRuntimeSsisPropertiesArgs>;
    /**
...
export interface SelfHostedIntegrationRuntimeArgs {
     ...
     */
    linkedInfo?: pulumi.Input<inputs.synapse.v20210601preview.LinkedIntegrationRuntimeKeyAuthorizationArgs | inputs.synapse.v20210601preview.LinkedIntegrationRuntimeRbacAuthorizationArgs>;
    /**
     * The type of integration runtime.
...
export interface SparkConfigPropertiesArgs {
     ...
     */
    configurationType?: pulumi.Input<string | enums.synapse.v20210601preview.ConfigurationType>;
    /**
