...
export interface CmdkeySetupResponse {
     ...
     */
    password: outputs.synapse.SecureStringResponse;
    /**
...
export interface ComponentSetupResponse {
     ...
     */
    licenseKey?: outputs.synapse.SecureStringResponse;
    /**
     * The type of custom setup.
...
export interface CustomerManagedKeyDetailsResponse {
     ...
     */
    key?: outputs.synapse.WorkspaceKeyDetailsResponse;
    /**
...
export interface EncryptionDetailsResponse {
     ...
     */
    cmk?: outputs.synapse.CustomerManagedKeyDetailsResponse;
    /**
...
export interface IntegrationRuntimeComputePropertiesResponse {
     ...
     */
    dataFlowProperties?: outputs.synapse.IntegrationRuntimeDataFlowPropertiesResponse;
    /**
     ...
     */
    vNetProperties?: outputs.synapse.IntegrationRuntimeVNetPropertiesResponse;
}
...
export interface IntegrationRuntimeCustomSetupScriptPropertiesResponse {
     ...
     */
    sasToken?: outputs.synapse.SecureStringResponse;
}
...
export interface IntegrationRuntimeDataProxyPropertiesResponse {
     ...
     */
    connectVia?: outputs.synapse.EntityReferenceResponse;
    /**
     ...
     */
    stagingLinkedService?: outputs.synapse.EntityReferenceResponse;
}
...
export interface IntegrationRuntimeSsisCatalogInfoResponse {
     ...
     */
    catalogAdminPassword?: outputs.synapse.SecureStringResponse;
    /**
...
export interface IntegrationRuntimeSsisPropertiesResponse {
     ...
     * Catalog information for managed dedicated integration runtime.
     */
    catalogInfo?: outputs.synapse.IntegrationRuntimeSsisCatalogInfoResponse;
    /**
     * Custom setup script properties for a managed dedicated integration runtime.
     */
    customSetupScriptProperties?: outputs.synapse.IntegrationRuntimeCustomSetupScriptPropertiesResponse;
    /**
     * Data proxy properties for a managed dedicated integration runtime.
     */
    dataProxyProperties?: outputs.synapse.IntegrationRuntimeDataProxyPropertiesResponse;
    /**
     ...
     */
    expressCustomSetupProperties?: (outputs.synapse.CmdkeySetupResponse | outputs.synapse.ComponentSetupResponse | outputs.synapse.EnvironmentVariableSetupResponse)[];
    /**
...
export interface LinkedIntegrationRuntimeKeyAuthorizationResponse {
     ...
     */
    key: outputs.synapse.SecureStringResponse;
}
...
export interface ManagedIntegrationRuntimeNodeResponse {
     ...
     */
    errors?: outputs.synapse.ManagedIntegrationRuntimeErrorResponse[];
    /**
...
export interface ManagedIntegrationRuntimeResponse {
     ...
     */
    computeProperties?: outputs.synapse.IntegrationRuntimeComputePropertiesResponse;
    /**
     ...
     * SSIS properties for managed integration runtime.
     */
    ssisProperties?: outputs.synapse.IntegrationRuntimeSsisPropertiesResponse;
    /**
...
export interface ManagedIntegrationRuntimeStatusResponse {
     ...
     */
    lastOperation: outputs.synapse.ManagedIntegrationRuntimeOperationResultResponse;
    /**
     * The list of nodes for managed integration runtime.
     */
    nodes: outputs.synapse.ManagedIntegrationRuntimeNodeResponse[];
    /**
     * The errors that occurred on this integration runtime.
     */
    otherErrors: outputs.synapse.ManagedIntegrationRuntimeErrorResponse[];
    /**
...
export interface PrivateEndpointConnectionForPrivateLinkHubBasicResponse {
     ...
     */
    privateEndpoint?: outputs.synapse.PrivateEndpointResponse;
    /**
     * Connection state of the private endpoint connection.
     */
    privateLinkServiceConnectionState?: outputs.synapse.PrivateLinkServiceConnectionStateResponse;
    /**
...
export interface SelfHostedIntegrationRuntimeResponse {
     ...
     */
    linkedInfo?: outputs.synapse.LinkedIntegrationRuntimeKeyAuthorizationResponse | outputs.synapse.LinkedIntegrationRuntimeRbacAuthorizationResponse;
    /**
     * The type of integration runtime.
...
export interface SelfHostedIntegrationRuntimeStatusResponse {
     ...
     */
    links?: outputs.synapse.LinkedIntegrationRuntimeResponse[];
    /**
     ...
     */
    nodes?: outputs.synapse.SelfHostedIntegrationRuntimeNodeResponse[];
    /**
...
export interface SsisEnvironmentResponse {
     ...
     */
    variables?: outputs.synapse.SsisVariableResponse[];
}
...
export interface SsisPackageResponse {
     ...
     */
    parameters?: outputs.synapse.SsisParameterResponse[];
    /**
...
export interface SsisProjectResponse {
     ...
     */
    environmentRefs?: outputs.synapse.SsisEnvironmentReferenceResponse[];
    /**
