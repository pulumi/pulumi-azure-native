...
export interface CollectorPolicyResponse {
     ...
     * Emission policies.
     */
    emissionPolicies?: outputs.networkfunction.v20210901preview.EmissionPoliciesPropertiesFormatResponse[];
    /**
     ...
     * Ingestion policies.
     */
    ingestionPolicy?: outputs.networkfunction.v20210901preview.IngestionPolicyPropertiesFormatResponse;
    /**
     * Azure resource name
     */
    name: string;
     ...
     */
    systemData: outputs.networkfunction.v20210901preview.CollectorPolicyResponseSystemData;
    /**
     * Azure resource type
     */
    type: string;
...
export interface EmissionPoliciesPropertiesFormatResponse {
     ...
     */
    emissionDestinations?: outputs.networkfunction.v20210901preview.EmissionPolicyDestinationResponse[];
    /**
...
export interface IngestionPolicyPropertiesFormatResponse {
     ...
     * Ingestion Sources.
     */
    ingestionSources?: outputs.networkfunction.v20210901preview.IngestionSourcesPropertiesFormatResponse[];
    /**
     * The ingestion type.
     */
