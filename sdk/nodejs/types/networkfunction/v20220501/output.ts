...
export interface CollectorPolicyResponse {
     ...
     * Emission policies.
     */
    emissionPolicies?: outputs.networkfunction.v20220501.EmissionPoliciesPropertiesFormatResponse[];
    /**
     ...
     * Ingestion policies.
     */
    ingestionPolicy?: outputs.networkfunction.v20220501.IngestionPolicyPropertiesFormatResponse;
    /**
     * Azure resource name
     */
    name: string;
     ...
     */
    systemData: outputs.networkfunction.v20220501.CollectorPolicyResponseSystemData;
    /**
     * Azure resource type
     */
    type: string;
...
export interface EmissionPoliciesPropertiesFormatResponse {
     ...
     */
    emissionDestinations?: outputs.networkfunction.v20220501.EmissionPolicyDestinationResponse[];
    /**
...
export interface IngestionPolicyPropertiesFormatResponse {
     ...
     * Ingestion Sources.
     */
    ingestionSources?: outputs.networkfunction.v20220501.IngestionSourcesPropertiesFormatResponse[];
    /**
     * The ingestion type.
     */
