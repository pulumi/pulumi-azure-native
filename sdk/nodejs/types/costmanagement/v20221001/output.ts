...
export interface CommonExportPropertiesResponse {
     ...
     */
    definition: outputs.costmanagement.v20221001.ExportDefinitionResponse;
    /**
     * Has delivery information for the export.
     */
    deliveryInfo: outputs.costmanagement.v20221001.ExportDeliveryInfoResponse;
    /**
     ...
     */
    runHistory?: outputs.costmanagement.v20221001.ExportExecutionListResultResponse;
}
...
export interface ExportDatasetResponse {
     ...
     */
    configuration?: outputs.costmanagement.v20221001.ExportDatasetConfigurationResponse;
    /**
...
export interface ExportDefinitionResponse {
     ...
     * The definition for data in the export.
     */
    dataSet?: outputs.costmanagement.v20221001.ExportDatasetResponse;
    /**
     * Has time period for pulling data for the export.
     */
    timePeriod?: outputs.costmanagement.v20221001.ExportTimePeriodResponse;
    /**
...
export interface ExportDeliveryInfoResponse {
     ...
     */
    destination: outputs.costmanagement.v20221001.ExportDeliveryDestinationResponse;
}
...
export interface ExportExecutionListResultResponse {
     ...
     */
    value: outputs.costmanagement.v20221001.ExportRunResponse[];
}
...
export interface ExportRunResponse {
     ...
     */
    error?: outputs.costmanagement.v20221001.ErrorDetailsResponse;
    /**
     ...
     */
    runSettings?: outputs.costmanagement.v20221001.CommonExportPropertiesResponse;
    /**
...
export interface ExportScheduleResponse {
     ...
     */
    recurrencePeriod?: outputs.costmanagement.v20221001.ExportRecurrencePeriodResponse;
    /**
...
export interface ReportConfigDatasetResponse {
     ...
     */
    aggregation?: {[key: string]: outputs.costmanagement.v20221001.ReportConfigAggregationResponse};
    /**
     * Has configuration information for the data in the report. The configuration will be ignored if aggregation and grouping are provided.
     */
    configuration?: outputs.costmanagement.v20221001.ReportConfigDatasetConfigurationResponse;
    /**
     * Has filter expression to use in the report.
     */
    filter?: outputs.costmanagement.v20221001.ReportConfigFilterResponse;
    /**
     ...
     */
    grouping?: outputs.costmanagement.v20221001.ReportConfigGroupingResponse[];
    /**
     * Array of order by expression to use in the report.
     */
    sorting?: outputs.costmanagement.v20221001.ReportConfigSortingResponse[];
}
...
export interface ReportConfigFilterResponse {
     ...
     */
    and?: outputs.costmanagement.v20221001.ReportConfigFilterResponse[];
    /**
     ...
     */
    or?: outputs.costmanagement.v20221001.ReportConfigFilterResponse[];
    /**
     * Has comparison expression for a tag
     */
    tags?: outputs.costmanagement.v20221001.ReportConfigComparisonExpressionResponse;
}
