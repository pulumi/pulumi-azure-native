...
export interface AutoScaleVCoreSkuArgs {
     ...
     */
    tier?: pulumi.Input<string | enums.powerbidedicated.VCoreSkuTier>;
}
...
export interface CapacitySkuArgs {
     ...
     * The name of the Azure pricing tier to which the SKU applies.
     */
    tier?: pulumi.Input<string | enums.powerbidedicated.CapacitySkuTier>;
}
...
export interface SystemDataArgs {
     ...
     */
    createdByType?: pulumi.Input<string | enums.powerbidedicated.IdentityType>;
    /**
     ...
     */
    lastModifiedByType?: pulumi.Input<string | enums.powerbidedicated.IdentityType>;
}
