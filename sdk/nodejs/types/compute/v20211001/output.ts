...
export interface EncryptionImagesResponse {
     ...
     */
    dataDiskImages?: outputs.compute.v20211001.DataDiskImageEncryptionResponse[];
    /**
     * Contains encryption settings for an OS disk image.
     */
    osDiskImage?: outputs.compute.v20211001.OSDiskImageEncryptionResponse;
}
...
export interface GalleryApplicationVersionPublishingProfileResponse {
    ...
    manageActions?: outputs.compute.v20211001.UserArtifactManageResponse;
    /**
     ...
     */
    source: outputs.compute.v20211001.UserArtifactSourceResponse;
    /**
     ...
     */
    targetExtendedLocations?: outputs.compute.v20211001.GalleryTargetExtendedLocationResponse[];
    /**
     * The target regions where the Image Version is going to be replicated to. This property is updatable.
     */
    targetRegions?: outputs.compute.v20211001.TargetRegionResponse[];
}
...
export interface GalleryDataDiskImageResponse {
     ...
     * The gallery artifact version source.
     */
    source?: outputs.compute.v20211001.GalleryArtifactVersionSourceResponse;
}
...
export interface GalleryImageVersionStorageProfileResponse {
     ...
     */
    dataDiskImages?: outputs.compute.v20211001.GalleryDataDiskImageResponse[];
    /**
     * This is the OS disk image.
     */
    osDiskImage?: outputs.compute.v20211001.GalleryOSDiskImageResponse;
    /**
     * The gallery artifact version source.
     */
    source?: outputs.compute.v20211001.GalleryArtifactVersionSourceResponse;
...
export interface GalleryTargetExtendedLocationResponse {
     ...
     * Optional. Allows users to provide customer managed keys for encrypting the OS and data disks in the gallery artifact.
     */
    encryption?: outputs.compute.v20211001.EncryptionImagesResponse;
    /**
     * The name of the extended location.
     */
    extendedLocation?: outputs.compute.v20211001.GalleryExtendedLocationResponse;
    /**
...
export interface OSDiskImageEncryptionResponse {
     ...
     */
    securityProfile?: outputs.compute.v20211001.OSDiskImageSecurityProfileResponse;
}
...
export interface RecommendedMachineConfigurationResponse {
     ...
     */
    memory?: outputs.compute.v20211001.ResourceRangeResponse;
    /**
     * Describes the resource range.
     */
    vCPUs?: outputs.compute.v20211001.ResourceRangeResponse;
}
...
export interface ReplicationStatusResponse {
     ...
     */
    summary: outputs.compute.v20211001.RegionalReplicationStatusResponse[];
}
...
export interface SharingProfileResponse {
     ...
     * Information of community gallery if current gallery is shared to community.
     */
    communityGalleryInfo?: outputs.compute.v20211001.CommunityGalleryInfoResponse;
    /**
     * A list of sharing profile groups.
     */
    groups: outputs.compute.v20211001.SharingProfileGroupResponse[];
    /**
...
export interface SharingStatusResponse {
     ...
     */
    summary?: outputs.compute.v20211001.RegionalSharingStatusResponse[];
}
