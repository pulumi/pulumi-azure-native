...
export interface BootDiagnosticsInstanceViewResponse {
     ...
     */
    status: outputs.compute.v20180601.InstanceViewStatusResponse;
}
...
export interface CreationDataResponse {
     ...
     */
    imageReference?: outputs.compute.v20180601.ImageDiskReferenceResponse;
    /**
...
export interface DataDiskResponse {
     ...
     */
    image?: outputs.compute.v20180601.VirtualHardDiskResponse;
    /**
     ...
     */
    managedDisk?: outputs.compute.v20180601.ManagedDiskParametersResponse;
    /**
     * The disk name.
     */
    name?: string;
     ...
     */
    vhd?: outputs.compute.v20180601.VirtualHardDiskResponse;
    /**
...
export interface DiagnosticsProfileResponse {
     ...
     * Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. <br><br> You can easily view the output of your console log. <br><br> Azure also enables you to see a screenshot of the VM from the hypervisor.
     */
    bootDiagnostics?: outputs.compute.v20180601.BootDiagnosticsResponse;
}
...
export interface DiskEncryptionSettingsResponse {
     ...
     */
    diskEncryptionKey?: outputs.compute.v20180601.KeyVaultSecretReferenceResponse;
    /**
     ...
     */
    keyEncryptionKey?: outputs.compute.v20180601.KeyVaultKeyReferenceResponse;
}
...
export interface DiskInstanceViewResponse {
     ...
     */
    encryptionSettings?: outputs.compute.v20180601.DiskEncryptionSettingsResponse[];
    /**
     * The disk name.
     */
    name?: string;
     ...
     */
    statuses?: outputs.compute.v20180601.InstanceViewStatusResponse[];
}
...
export interface EncryptionSettingsResponse {
     ...
     */
    diskEncryptionKey?: outputs.compute.v20180601.KeyVaultAndSecretReferenceResponse;
    /**
     ...
     */
    keyEncryptionKey?: outputs.compute.v20180601.KeyVaultAndKeyReferenceResponse;
}
...
export interface GalleryArtifactSourceResponse {
     ...
     */
    managedImage: outputs.compute.v20180601.ManagedArtifactResponse;
}
...
export interface GalleryImageVersionPublishingProfileResponse {
     ...
     * The source image from which the Image Version is going to be created.
     */
    source: outputs.compute.v20180601.GalleryArtifactSourceResponse;
    /**
     * The target regions where the Image Version is going to be replicated to. This property is updatable.
     */
    targetRegions?: outputs.compute.v20180601.TargetRegionResponse[];
}
...
export interface GalleryImageVersionStorageProfileResponse {
     ...
     */
    dataDiskImages: outputs.compute.v20180601.GalleryDataDiskImageResponse[];
    /**
     * This is the OS disk image.
     */
    osDiskImage: outputs.compute.v20180601.GalleryOSDiskImageResponse;
}
...
export interface ImageDataDiskResponse {
     ...
     * The managedDisk.
     */
    managedDisk?: outputs.compute.v20180601.SubResourceResponse;
    /**
     * The snapshot.
     */
    snapshot?: outputs.compute.v20180601.SubResourceResponse;
    /**
...
export interface ImageStorageProfileResponse {
     ...
     */
    dataDisks?: outputs.compute.v20180601.ImageDataDiskResponse[];
    /**
     * Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    osDisk?: outputs.compute.v20180601.ImageOSDiskResponse;
    /**
...
export interface KeyVaultAndKeyReferenceResponse {
     ...
     */
    sourceVault: outputs.compute.v20180601.SourceVaultResponse;
}
...
export interface KeyVaultKeyReferenceResponse {
     ...
     */
    sourceVault: outputs.compute.v20180601.SubResourceResponse;
}
...
export interface LinuxConfigurationResponse {
     ...
     */
    ssh?: outputs.compute.v20180601.SshConfigurationResponse;
}
...
export interface NetworkProfileResponse {
     ...
     */
    networkInterfaces?: outputs.compute.v20180601.NetworkInterfaceReferenceResponse[];
}
...
export interface OSDiskResponse {
     ...
     */
    diffDiskSettings?: outputs.compute.v20180601.DiffDiskSettingsResponse;
    /**
     * Specifies the size of an empty data disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual machine image. <br><br> This value cannot be larger than 1023 GB
     */
    diskSizeGB?: number;
...
export interface OSProfileResponse {
     ...
     * Specifies the Linux operating system settings on the virtual machine. <br><br>For a list of supported Linux distributions, see [Linux on Azure-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-endorsed-distros?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) <br><br> For running non-endorsed distributions, see [Information for Non-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-create-upload-generic?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
     */
    linuxConfiguration?: outputs.compute.v20180601.LinuxConfigurationResponse;
    /**
     * Specifies set of certificates that should be installed onto the virtual machine.
     */
    secrets?: outputs.compute.v20180601.VaultSecretGroupResponse[];
    /**
     * Specifies Windows operating system settings on the virtual machine.
     */
    windowsConfiguration?: outputs.compute.v20180601.WindowsConfigurationResponse;
}
...
export interface RecommendedMachineConfigurationResponse {
     ...
     */
    memory?: outputs.compute.v20180601.ResourceRangeResponse;
    /**
     * Describes the resource range.
     */
    vCPUs?: outputs.compute.v20180601.ResourceRangeResponse;
}
...
export interface ReplicationStatusResponse {
     ...
     */
    summary: outputs.compute.v20180601.RegionalReplicationStatusResponse[];
}
...
export interface SshConfigurationResponse {
     ...
     */
    publicKeys?: outputs.compute.v20180601.SshPublicKeyResponse[];
}
...
export interface StorageProfileResponse {
     ...
     * Specifies the parameters that are used to add a data disk to a virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    dataDisks?: outputs.compute.v20180601.DataDiskResponse[];
    /**
     * Specifies information about the image to use. You can specify information about platform images, marketplace images, or virtual machine images. This element is required when you want to use a platform image, marketplace image, or virtual machine image, but is not used in other creation operations.
     */
    imageReference?: outputs.compute.v20180601.ImageReferenceResponse;
    /**
     * Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    osDisk?: outputs.compute.v20180601.OSDiskResponse;
}
...
export interface UpgradePolicyResponse {
     ...
     */
    autoOSUpgradePolicy?: outputs.compute.v20180601.AutoOSUpgradePolicyResponse;
    /**
     ...
     * The configuration parameters used while performing a rolling upgrade.
     */
    rollingUpgradePolicy?: outputs.compute.v20180601.RollingUpgradePolicyResponse;
}
...
export interface VaultSecretGroupResponse {
     ...
     */
    vaultCertificates?: outputs.compute.v20180601.VaultCertificateResponse[];
}
...
export interface VirtualMachineAgentInstanceViewResponse {
     ...
     */
    extensionHandlers?: outputs.compute.v20180601.VirtualMachineExtensionHandlerInstanceViewResponse[];
    /**
     * The resource status information.
     */
    statuses?: outputs.compute.v20180601.InstanceViewStatusResponse[];
...
export interface VirtualMachineExtensionInstanceViewResponse {
     ...
     * The resource status information.
     */
    substatuses?: outputs.compute.v20180601.InstanceViewStatusResponse[];
    /**
     * Specifies the type of the extension; an example is "CustomScriptExtension".
     */
    type?: string;
...
export interface VirtualMachineExtensionResponse {
     ...
     */
    instanceView?: outputs.compute.v20180601.VirtualMachineExtensionInstanceViewResponse;
    /**
     * Resource location
     */
    location: string;
...
export interface VirtualMachineIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.compute.v20180601.VirtualMachineIdentityResponseUserAssignedIdentities};
}
...
export interface VirtualMachineInstanceViewResponse {
     ...
     * Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. <br><br> You can easily view the output of your console log. <br><br> Azure also enables you to see a screenshot of the VM from the hypervisor.
     */
    bootDiagnostics?: outputs.compute.v20180601.BootDiagnosticsInstanceViewResponse;
    /**
     ...
     */
    disks?: outputs.compute.v20180601.DiskInstanceViewResponse[];
    /**
     * The extensions information.
     */
    extensions?: outputs.compute.v20180601.VirtualMachineExtensionInstanceViewResponse[];
    /**
     * The Maintenance Operation status on the virtual machine.
     */
    maintenanceRedeployStatus?: outputs.compute.v20180601.MaintenanceRedeployStatusResponse;
    /**
     ...
     */
    vmAgent?: outputs.compute.v20180601.VirtualMachineAgentInstanceViewResponse;
}
...
export interface VirtualMachineScaleSetDataDiskResponse {
     ...
     * The managed disk parameters.
     */
    managedDisk?: outputs.compute.v20180601.VirtualMachineScaleSetManagedDiskParametersResponse;
    /**
     * The disk name.
     */
    name?: string;
...
export interface VirtualMachineScaleSetExtensionProfileResponse {
     ...
     */
    extensions?: outputs.compute.v20180601.VirtualMachineScaleSetExtensionResponse[];
}
...
export interface VirtualMachineScaleSetIPConfigurationResponse {
     ...
     */
    applicationGatewayBackendAddressPools?: outputs.compute.v20180601.SubResourceResponse[];
    /**
     * Specifies an array of references to application security group.
     */
    applicationSecurityGroups?: outputs.compute.v20180601.SubResourceResponse[];
    /**
     * Resource Id
     */
    id?: string;
     ...
     */
    loadBalancerBackendAddressPools?: outputs.compute.v20180601.SubResourceResponse[];
    /**
     ...
     */
    loadBalancerInboundNatPools?: outputs.compute.v20180601.SubResourceResponse[];
    /**
     ...
     */
    publicIPAddressConfiguration?: outputs.compute.v20180601.VirtualMachineScaleSetPublicIPAddressConfigurationResponse;
    /**
     * Specifies the identifier of the subnet.
     */
    subnet?: outputs.compute.v20180601.ApiEntityReferenceResponse;
}
...
export interface VirtualMachineScaleSetIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.compute.v20180601.VirtualMachineScaleSetIdentityResponseUserAssignedIdentities};
}
...
export interface VirtualMachineScaleSetNetworkConfigurationResponse {
     ...
     */
    dnsSettings?: outputs.compute.v20180601.VirtualMachineScaleSetNetworkConfigurationDnsSettingsResponse;
    /**
     ...
     */
    ipConfigurations: outputs.compute.v20180601.VirtualMachineScaleSetIPConfigurationResponse[];
    /**
     ...
     */
    networkSecurityGroup?: outputs.compute.v20180601.SubResourceResponse;
    /**
     * Specifies the primary network interface in case the virtual machine has more than 1 network interface.
     */
    primary?: boolean;
...
export interface VirtualMachineScaleSetNetworkProfileResponse {
     ...
     */
    healthProbe?: outputs.compute.v20180601.ApiEntityReferenceResponse;
    /**
     * The list of network configurations.
     */
    networkInterfaceConfigurations?: outputs.compute.v20180601.VirtualMachineScaleSetNetworkConfigurationResponse[];
}
...
export interface VirtualMachineScaleSetPublicIPAddressConfigurationResponse {
     ...
     */
    dnsSettings?: outputs.compute.v20180601.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettingsResponse;
    /**
     ...
     */
    ipTags?: outputs.compute.v20180601.VirtualMachineScaleSetIpTagResponse[];
    /**
     ...
     */
    publicIPPrefix?: outputs.compute.v20180601.SubResourceResponse;
}
...
export interface VirtualMachineScaleSetStorageProfileResponse {
     ...
     */
    dataDisks?: outputs.compute.v20180601.VirtualMachineScaleSetDataDiskResponse[];
    /**
     * Specifies information about the image to use. You can specify information about platform images, marketplace images, or virtual machine images. This element is required when you want to use a platform image, marketplace image, or virtual machine image, but is not used in other creation operations.
     */
    imageReference?: outputs.compute.v20180601.ImageReferenceResponse;
     ...
     */
    osDisk?: outputs.compute.v20180601.VirtualMachineScaleSetOSDiskResponse;
}
...
export interface VirtualMachineScaleSetVMInstanceViewResponse {
     ...
     */
    vmHealth: outputs.compute.v20180601.VirtualMachineHealthStatusResponse;
}
...
export interface VirtualMachineScaleSetVMProfileResponse {
     ...
     */
    additionalCapabilities?: outputs.compute.v20180601.AdditionalCapabilitiesResponse;
    /**
     * Specifies the boot diagnostic settings state. <br><br>Minimum api-version: 2015-06-15.
     */
    diagnosticsProfile?: outputs.compute.v20180601.DiagnosticsProfileResponse;
    /**
     ...
     */
    extensionProfile?: outputs.compute.v20180601.VirtualMachineScaleSetExtensionProfileResponse;
    /**
     ...
     */
    networkProfile?: outputs.compute.v20180601.VirtualMachineScaleSetNetworkProfileResponse;
    /**
     * Specifies the operating system settings for the virtual machines in the scale set.
     */
    osProfile?: outputs.compute.v20180601.VirtualMachineScaleSetOSProfileResponse;
    /**
     ...
     * Specifies the storage settings for the virtual machine disks.
     */
    storageProfile?: outputs.compute.v20180601.VirtualMachineScaleSetStorageProfileResponse;
}
...
export interface WinRMConfigurationResponse {
     ...
     */
    listeners?: outputs.compute.v20180601.WinRMListenerResponse[];
}
...
export interface WindowsConfigurationResponse {
     ...
     */
    additionalUnattendContent?: outputs.compute.v20180601.AdditionalUnattendContentResponse[];
    /**
     ...
     */
    winRM?: outputs.compute.v20180601.WinRMConfigurationResponse;
}
