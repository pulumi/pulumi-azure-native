...
export interface AdditionalUnattendContentArgs {
     ...
     */
    componentName?: pulumi.Input<enums.compute.ComponentNames>;
    /**
     ...
     */
    passName?: pulumi.Input<enums.compute.PassNames>;
    /**
     * Specifies the name of the setting to which the content applies. Possible values are: FirstLogonCommands and AutoLogon.
     */
    settingName?: pulumi.Input<enums.compute.SettingNames>;
}
...
export interface CreationDataArgs {
     ...
     */
    createOption: pulumi.Input<string | enums.compute.DiskCreateOption>;
    /**
     * Required if creating from a Gallery Image. The id of the ImageDiskReference will be the ARM id of the shared galley image version from which to create a disk.
     */
    galleryImageReference?: pulumi.Input<inputs.compute.ImageDiskReferenceArgs>;
    /**
     * Disk source information.
     */
    imageReference?: pulumi.Input<inputs.compute.ImageDiskReferenceArgs>;
    /**
...
export interface DataDiskArgs {
     ...
     */
    caching?: pulumi.Input<enums.compute.CachingTypes>;
    /**
     * Specifies how the virtual machine should be created.<br><br> Possible values are:<br><br> **Attach** \u2013 This value is used when you are using a specialized disk to create the virtual machine.<br><br> **FromImage** \u2013 This value is used when you are using an image to create the virtual machine. If you are using a platform image, you also use the imageReference element described above. If you are using a marketplace image, you  also use the plan element previously described.
     */
    createOption: pulumi.Input<string | enums.compute.DiskCreateOptionTypes>;
    /**
     ...
     */
    deleteOption?: pulumi.Input<string | enums.compute.DiskDeleteOptionTypes>;
    /**
     ...
     */
    detachOption?: pulumi.Input<string | enums.compute.DiskDetachOptionTypes>;
    /**
     ...
     */
    image?: pulumi.Input<inputs.compute.VirtualHardDiskArgs>;
    /**
     ...
     */
    managedDisk?: pulumi.Input<inputs.compute.ManagedDiskParametersArgs>;
    /**
     * The disk name.
     */
    name?: pulumi.Input<string>;
     ...
     */
    vhd?: pulumi.Input<inputs.compute.VirtualHardDiskArgs>;
    /**
...
export interface DiagnosticsProfileArgs {
     ...
     * Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. <br><br> You can easily view the output of your console log. <br><br> Azure also enables you to see a screenshot of the VM from the hypervisor.
     */
    bootDiagnostics?: pulumi.Input<inputs.compute.BootDiagnosticsArgs>;
}
...
export interface DiffDiskSettingsArgs {
     ...
     */
    option?: pulumi.Input<string | enums.compute.DiffDiskOptions>;
    /**
     * Specifies the ephemeral disk placement for operating system disk.<br><br> Possible values are: <br><br> **CacheDisk** <br><br> **ResourceDisk** <br><br> Default: **CacheDisk** if one is configured for the VM size otherwise **ResourceDisk** is used.<br><br> Refer to VM size documentation for Windows VM at https://docs.microsoft.com/azure/virtual-machines/windows/sizes and Linux VM at https://docs.microsoft.com/azure/virtual-machines/linux/sizes to check which VM sizes exposes a cache disk.
     */
    placement?: pulumi.Input<string | enums.compute.DiffDiskPlacement>;
}
...
export interface DiskEncryptionSettingsArgs {
     ...
     */
    diskEncryptionKey?: pulumi.Input<inputs.compute.KeyVaultSecretReferenceArgs>;
    /**
     ...
     */
    keyEncryptionKey?: pulumi.Input<inputs.compute.KeyVaultKeyReferenceArgs>;
}
...
export interface DiskSecurityProfileArgs {
     ...
     */
    securityType?: pulumi.Input<string | enums.compute.DiskSecurityTypes>;
}
...
export interface DiskSkuArgs {
     ...
     * The sku name.
     */
    name?: pulumi.Input<string | enums.compute.DiskStorageAccountTypes>;
}
...
export interface EncryptionArgs {
     ...
     */
    type?: pulumi.Input<string | enums.compute.EncryptionType>;
}
...
export interface EncryptionImagesArgs {
     ...
     */
    dataDiskImages?: pulumi.Input<pulumi.Input<inputs.compute.DataDiskImageEncryptionArgs>[]>;
    /**
     * Contains encryption settings for an OS disk image.
     */
    osDiskImage?: pulumi.Input<inputs.compute.OSDiskImageEncryptionArgs>;
}
...
export interface EncryptionSetIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.compute.DiskEncryptionSetIdentityType>;
}
...
export interface EncryptionSettingsCollectionArgs {
     ...
     */
    encryptionSettings?: pulumi.Input<pulumi.Input<inputs.compute.EncryptionSettingsElementArgs>[]>;
    /**
...
export interface EncryptionSettingsElementArgs {
     ...
     */
    diskEncryptionKey?: pulumi.Input<inputs.compute.KeyVaultAndSecretReferenceArgs>;
    /**
     * Key Vault Key Url and vault id of the key encryption key. KeyEncryptionKey is optional and when provided is used to unwrap the disk encryption key.
     */
    keyEncryptionKey?: pulumi.Input<inputs.compute.KeyVaultAndKeyReferenceArgs>;
}
...
export interface GalleryApplicationVersionPublishingProfileArgs {
    ...
    manageActions?: pulumi.Input<inputs.compute.UserArtifactManageArgs>;
    /**
     ...
     */
    source: pulumi.Input<inputs.compute.UserArtifactSourceArgs>;
    /**
     * Specifies the storage account type to be used to store the image. This property is not updatable.
     */
    storageAccountType?: pulumi.Input<string | enums.compute.StorageAccountType>;
    /**
     * The target regions where the Image Version is going to be replicated to. This property is updatable.
     */
    targetRegions?: pulumi.Input<pulumi.Input<inputs.compute.TargetRegionArgs>[]>;
}
...
export interface GalleryDataDiskImageArgs {
     ...
     */
    hostCaching?: pulumi.Input<enums.compute.HostCaching>;
    /**
     * This property specifies the logical unit number of the data disk. This value is used to identify data disks within the Virtual Machine and therefore must be unique for each data disk attached to the Virtual Machine.
     */
    lun: pulumi.Input<number>;
     ...
     * The gallery artifact version source.
     */
    source?: pulumi.Input<inputs.compute.GalleryArtifactVersionSourceArgs>;
}
...
export interface GalleryImageVersionStorageProfileArgs {
     ...
     */
    dataDiskImages?: pulumi.Input<pulumi.Input<inputs.compute.GalleryDataDiskImageArgs>[]>;
    /**
     * This is the OS disk image.
     */
    osDiskImage?: pulumi.Input<inputs.compute.GalleryOSDiskImageArgs>;
    /**
     * The gallery artifact version source.
     */
    source?: pulumi.Input<inputs.compute.GalleryArtifactVersionSourceArgs>;
...
export interface HardwareProfileArgs {
     ...
     */
    vmSize?: pulumi.Input<string | enums.compute.VirtualMachineSizeTypes>;
}
...
export interface ImageDataDiskArgs {
     ...
     */
    diskEncryptionSet?: pulumi.Input<inputs.compute.DiskEncryptionSetParametersArgs>;
    /**
     ...
     * The managedDisk.
     */
    managedDisk?: pulumi.Input<inputs.compute.SubResourceArgs>;
    /**
     * The snapshot.
     */
    snapshot?: pulumi.Input<inputs.compute.SubResourceArgs>;
    /**
     * Specifies the storage account type for the managed disk. NOTE: UltraSSD_LRS can only be used with data disks, it cannot be used with OS Disk.
     */
    storageAccountType?: pulumi.Input<string | enums.compute.StorageAccountTypes>;
}
...
export interface ImageStorageProfileArgs {
     ...
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.compute.ImageDataDiskArgs>[]>;
    /**
     * Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    osDisk?: pulumi.Input<inputs.compute.ImageOSDiskArgs>;
    /**
...
export interface InstanceViewStatusArgs {
     ...
     * The level code.
     */
    level?: pulumi.Input<enums.compute.StatusLevelTypes>;
    /**
...
export interface KeyForDiskEncryptionSetArgs {
     ...
     */
    sourceVault?: pulumi.Input<inputs.compute.SourceVaultArgs>;
}
...
export interface LinuxConfigurationArgs {
     ...
     */
    patchSettings?: pulumi.Input<inputs.compute.LinuxPatchSettingsArgs>;
    /**
     ...
     */
    ssh?: pulumi.Input<inputs.compute.SshConfigurationArgs>;
}
...
export interface LinuxPatchSettingsArgs {
     ...
     */
    assessmentMode?: pulumi.Input<string | enums.compute.LinuxPatchAssessmentMode>;
    /**
     * Specifies the mode of VM Guest Patching to IaaS virtual machine or virtual machines associated to virtual machine scale set with OrchestrationMode as Flexible.<br /><br /> Possible values are:<br /><br /> **ImageDefault** - The virtual machine's default patching configuration is used. <br /><br /> **AutomaticByPlatform** - The virtual machine will be automatically updated by the platform. The property provisionVMAgent must be true
     */
    patchMode?: pulumi.Input<string | enums.compute.LinuxVMGuestPatchMode>;
}
...
export interface NetworkInterfaceReferenceArgs {
     ...
     */
    deleteOption?: pulumi.Input<string | enums.compute.DeleteOptions>;
    /**
     * Resource Id
     */
    id?: pulumi.Input<string>;
...
export interface NetworkProfileArgs {
     ...
     */
    networkApiVersion?: pulumi.Input<string | enums.compute.NetworkApiVersion>;
    /**
     * Specifies the networking configurations that will be used to create the virtual machine networking resources.
     */
    networkInterfaceConfigurations?: pulumi.Input<pulumi.Input<inputs.compute.VirtualMachineNetworkInterfaceConfigurationArgs>[]>;
    /**
     * Specifies the list of resource Ids for the network interfaces associated with the virtual machine.
     */
    networkInterfaces?: pulumi.Input<pulumi.Input<inputs.compute.NetworkInterfaceReferenceArgs>[]>;
}
...
export interface OSDiskArgs {
     ...
     */
    diffDiskSettings?: pulumi.Input<inputs.compute.DiffDiskSettingsArgs>;
    /**
     * Specifies the size of an empty data disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual machine image. <br><br> This value cannot be larger than 1023 GB
     */
    diskSizeGB?: pulumi.Input<number>;
     ...
     */
    encryptionSettings?: pulumi.Input<inputs.compute.DiskEncryptionSettingsArgs>;
    /**
     * The source user image virtual hard disk. The virtual hard disk will be copied before being attached to the virtual machine. If SourceImage is provided, the destination virtual hard drive must not exist.
     */
    image?: pulumi.Input<inputs.compute.VirtualHardDiskArgs>;
...
export interface OSProfileArgs {
     ...
     * Specifies the Linux operating system settings on the virtual machine. <br><br>For a list of supported Linux distributions, see [Linux on Azure-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/linux/endorsed-distros).
     */
    linuxConfiguration?: pulumi.Input<inputs.compute.LinuxConfigurationArgs>;
    /**
     ...
     */
    secrets?: pulumi.Input<pulumi.Input<inputs.compute.VaultSecretGroupArgs>[]>;
    /**
     * Specifies Windows operating system settings on the virtual machine.
     */
    windowsConfiguration?: pulumi.Input<inputs.compute.WindowsConfigurationArgs>;
}
...
export interface PatchSettingsArgs {
     ...
     * Specifies the mode of VM Guest patch assessment for the IaaS virtual machine.<br /><br /> Possible values are:<br /><br /> **ImageDefault** - You control the timing of patch assessments on a virtual machine.<br /><br /> **AutomaticByPlatform** - The platform will trigger periodic patch assessments. The property provisionVMAgent must be true. 
     */
    assessmentMode?: pulumi.Input<string | enums.compute.WindowsPatchAssessmentMode>;
    /**
     ...
     */
    patchMode?: pulumi.Input<string | enums.compute.WindowsVMGuestPatchMode>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.compute.PrivateEndpointServiceConnectionStatus>;
}
...
export interface PublicIPAddressSkuArgs {
     ...
     */
    name?: pulumi.Input<string | enums.compute.PublicIPAddressSkuName>;
    /**
     * Specify public IP sku tier
     */
    tier?: pulumi.Input<string | enums.compute.PublicIPAddressSkuTier>;
}
...
export interface RecommendedMachineConfigurationArgs {
     ...
     */
    memory?: pulumi.Input<inputs.compute.ResourceRangeArgs>;
    /**
     * Describes the resource range.
     */
    vCPUs?: pulumi.Input<inputs.compute.ResourceRangeArgs>;
}
...
export interface ScaleInPolicyArgs {
     ...
     */
    rules?: pulumi.Input<pulumi.Input<string | enums.compute.VirtualMachineScaleSetScaleInRules>[]>;
}
...
export interface ScheduledEventsProfileArgs {
     ...
     */
    terminateNotificationProfile?: pulumi.Input<inputs.compute.TerminateNotificationProfileArgs>;
}
...
export interface SecurityProfileArgs {
     ...
     */
    uefiSettings?: pulumi.Input<inputs.compute.UefiSettingsArgs>;
}
...
export interface SharingProfileArgs {
     ...
     */
    permissions?: pulumi.Input<string | enums.compute.GallerySharingPermissionTypes>;
}
...
export interface SnapshotSkuArgs {
     ...
     * The sku name.
     */
    name?: pulumi.Input<string | enums.compute.SnapshotStorageAccountTypes>;
}
...
export interface SshConfigurationArgs {
     ...
     */
    publicKeys?: pulumi.Input<pulumi.Input<inputs.compute.SshPublicKeyArgs>[]>;
}
...
export interface StorageProfileArgs {
     ...
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.compute.DataDiskArgs>[]>;
    /**
     * Specifies information about the image to use. You can specify information about platform images, marketplace images, or virtual machine images. This element is required when you want to use a platform image, marketplace image, or virtual machine image, but is not used in other creation operations.
     */
    imageReference?: pulumi.Input<inputs.compute.ImageReferenceArgs>;
    /**
     * Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview).
     */
    osDisk?: pulumi.Input<inputs.compute.OSDiskArgs>;
}
...
export interface TargetRegionArgs {
     ...
     * Optional. Allows users to provide customer managed keys for encrypting the OS and data disks in the gallery artifact.
     */
    encryption?: pulumi.Input<inputs.compute.EncryptionImagesArgs>;
    /**
...
export interface UpgradePolicyArgs {
     ...
     */
    automaticOSUpgradePolicy?: pulumi.Input<inputs.compute.AutomaticOSUpgradePolicyArgs>;
    /**
     * Specifies the mode of an upgrade to virtual machines in the scale set.<br /><br /> Possible values are:<br /><br /> **Manual** - You  control the application of updates to virtual machines in the scale set. You do this by using the manualUpgrade action.<br /><br /> **Automatic** - All virtual machines in the scale set are  automatically updated at the same time.
     */
    mode?: pulumi.Input<enums.compute.UpgradeMode>;
    /**
     * The configuration parameters used while performing a rolling upgrade.
     */
    rollingUpgradePolicy?: pulumi.Input<inputs.compute.RollingUpgradePolicyArgs>;
}
...
export interface VaultSecretGroupArgs {
     ...
     * The list of key vault references in SourceVault which contain certificates.
     */
    vaultCertificates?: pulumi.Input<pulumi.Input<inputs.compute.VaultCertificateArgs>[]>;
}
...
export interface VirtualMachineExtensionInstanceViewArgs {
     ...
     */
    statuses?: pulumi.Input<pulumi.Input<inputs.compute.InstanceViewStatusArgs>[]>;
    /**
     * The resource status information.
     */
    substatuses?: pulumi.Input<pulumi.Input<inputs.compute.InstanceViewStatusArgs>[]>;
    /**
...
export interface VirtualMachineIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.compute.ResourceIdentityType>;
    /**
...
export interface VirtualMachineNetworkInterfaceConfigurationArgs {
     ...
     */
    dnsSettings?: pulumi.Input<inputs.compute.VirtualMachineNetworkInterfaceDnsSettingsConfigurationArgs>;
    dscpConfiguration?: pulumi.Input<inputs.compute.SubResourceArgs>;
    /**
     ...
     */
    ipConfigurations: pulumi.Input<pulumi.Input<inputs.compute.VirtualMachineNetworkInterfaceIPConfigurationArgs>[]>;
    /**
     ...
     */
    networkSecurityGroup?: pulumi.Input<inputs.compute.SubResourceArgs>;
    /**
     * Specifies the primary network interface in case the virtual machine has more than 1 network interface.
     */
    primary?: pulumi.Input<boolean>;
...
export interface VirtualMachineNetworkInterfaceIPConfigurationArgs {
     ...
     */
    applicationGatewayBackendAddressPools?: pulumi.Input<pulumi.Input<inputs.compute.SubResourceArgs>[]>;
    /**
     * Specifies an array of references to application security group.
     */
    applicationSecurityGroups?: pulumi.Input<pulumi.Input<inputs.compute.SubResourceArgs>[]>;
    /**
     * Specifies an array of references to backend address pools of load balancers. A virtual machine can reference backend address pools of one public and one internal load balancer. [Multiple virtual machines cannot use the same basic sku load balancer].
     */
    loadBalancerBackendAddressPools?: pulumi.Input<pulumi.Input<inputs.compute.SubResourceArgs>[]>;
    /**
     ...
     */
    privateIPAddressVersion?: pulumi.Input<string | enums.compute.IPVersions>;
    /**
     * The publicIPAddressConfiguration.
     */
    publicIPAddressConfiguration?: pulumi.Input<inputs.compute.VirtualMachinePublicIPAddressConfigurationArgs>;
    /**
...
export interface VirtualMachinePublicIPAddressConfigurationArgs {
     ...
     */
    dnsSettings?: pulumi.Input<inputs.compute.VirtualMachinePublicIPAddressDnsSettingsConfigurationArgs>;
    /**
     ...
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.compute.VirtualMachineIpTagArgs>[]>;
    /**
     ...
     */
    publicIPAddressVersion?: pulumi.Input<string | enums.compute.IPVersions>;
    /**
     * Specify the public IP allocation type
     */
    publicIPAllocationMethod?: pulumi.Input<string | enums.compute.PublicIPAllocationMethod>;
    /**
     * The PublicIPPrefix from which to allocate publicIP addresses.
     */
    publicIPPrefix?: pulumi.Input<inputs.compute.SubResourceArgs>;
    /**
     * Describes the public IP Sku
     */
    sku?: pulumi.Input<inputs.compute.PublicIPAddressSkuArgs>;
}
...
export interface VirtualMachineScaleSetDataDiskArgs {
     ...
     * The managed disk parameters.
     */
    managedDisk?: pulumi.Input<inputs.compute.VirtualMachineScaleSetManagedDiskParametersArgs>;
    /**
     * The disk name.
     */
    name?: pulumi.Input<string>;
...
export interface VirtualMachineScaleSetExtensionProfileArgs {
     ...
     */
    extensions?: pulumi.Input<pulumi.Input<inputs.compute.VirtualMachineScaleSetExtensionArgs>[]>;
    /**
...
export interface VirtualMachineScaleSetIPConfigurationArgs {
     ...
     */
    loadBalancerInboundNatPools?: pulumi.Input<pulumi.Input<inputs.compute.SubResourceArgs>[]>;
    /**
     * The IP configuration name.
     */
    name: pulumi.Input<string>;
     ...
     * Available from Api-Version 2017-03-30 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4.  Possible values are: 'IPv4' and 'IPv6'.
     */
    privateIPAddressVersion?: pulumi.Input<string | enums.compute.IPVersion>;
    /**
     * The publicIPAddressConfiguration.
     */
    publicIPAddressConfiguration?: pulumi.Input<inputs.compute.VirtualMachineScaleSetPublicIPAddressConfigurationArgs>;
    /**
     * Specifies the identifier of the subnet.
     */
    subnet?: pulumi.Input<inputs.compute.ApiEntityReferenceArgs>;
}
...
export interface VirtualMachineScaleSetNetworkConfigurationArgs {
     ...
     * The dns settings to be applied on the network interfaces.
     */
    dnsSettings?: pulumi.Input<inputs.compute.VirtualMachineScaleSetNetworkConfigurationDnsSettingsArgs>;
    /**
     * Specifies whether the network interface is accelerated networking-enabled.
     */
    enableAcceleratedNetworking?: pulumi.Input<boolean>;
     ...
     * Specifies the IP configurations of the network interface.
     */
    ipConfigurations: pulumi.Input<pulumi.Input<inputs.compute.VirtualMachineScaleSetIPConfigurationArgs>[]>;
    /**
...
export interface VirtualMachineScaleSetNetworkProfileArgs {
     ...
     */
    healthProbe?: pulumi.Input<inputs.compute.ApiEntityReferenceArgs>;
    /**
     ...
     */
    networkInterfaceConfigurations?: pulumi.Input<pulumi.Input<inputs.compute.VirtualMachineScaleSetNetworkConfigurationArgs>[]>;
}
...
export interface VirtualMachineScaleSetPublicIPAddressConfigurationArgs {
     ...
     * The dns settings to be applied on the publicIP addresses .
     */
    dnsSettings?: pulumi.Input<inputs.compute.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettingsArgs>;
    /**
     * The idle timeout of the public IP address.
     */
    idleTimeoutInMinutes?: pulumi.Input<number>;
     ...
     * The list of IP tags associated with the public IP address.
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.compute.VirtualMachineScaleSetIpTagArgs>[]>;
    /**
     * The publicIP address configuration name.
     */
    name: pulumi.Input<string>;
     ...
     * Available from Api-Version 2019-07-01 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4. Possible values are: 'IPv4' and 'IPv6'.
     */
    publicIPAddressVersion?: pulumi.Input<string | enums.compute.IPVersion>;
    /**
     * The PublicIPPrefix from which to allocate publicIP addresses.
     */
    publicIPPrefix?: pulumi.Input<inputs.compute.SubResourceArgs>;
...
export interface VirtualMachineScaleSetStorageProfileArgs {
     ...
     */
    osDisk?: pulumi.Input<inputs.compute.VirtualMachineScaleSetOSDiskArgs>;
}
...
export interface VirtualMachineScaleSetVMProfileArgs {
     ...
     */
    extensionProfile?: pulumi.Input<inputs.compute.VirtualMachineScaleSetExtensionProfileArgs>;
    /**
     ...
     */
    networkProfile?: pulumi.Input<inputs.compute.VirtualMachineScaleSetNetworkProfileArgs>;
    /**
     * Specifies the operating system settings for the virtual machines in the scale set.
     */
    osProfile?: pulumi.Input<inputs.compute.VirtualMachineScaleSetOSProfileArgs>;
    /**
     ...
     * Specifies the storage settings for the virtual machine disks.
     */
    storageProfile?: pulumi.Input<inputs.compute.VirtualMachineScaleSetStorageProfileArgs>;
    /**
...
export interface WinRMConfigurationArgs {
     ...
     */
    listeners?: pulumi.Input<pulumi.Input<inputs.compute.WinRMListenerArgs>[]>;
}
...
export interface WinRMListenerArgs {
     ...
     */
    protocol?: pulumi.Input<enums.compute.ProtocolTypes>;
}
...
export interface WindowsConfigurationArgs {
     ...
     */
    additionalUnattendContent?: pulumi.Input<pulumi.Input<inputs.compute.AdditionalUnattendContentArgs>[]>;
    /**
     ...
     */
    patchSettings?: pulumi.Input<inputs.compute.PatchSettingsArgs>;
    /**
     * Indicates whether virtual machine agent should be provisioned on the virtual machine. <br><br> When this property is not specified in the request body, default behavior is to set it to true.  This will ensure that VM Agent is installed on the VM so that extensions can be added to the VM later.
     */
    provisionVMAgent?: pulumi.Input<boolean>;
     ...
     */
    winRM?: pulumi.Input<inputs.compute.WinRMConfigurationArgs>;
}
