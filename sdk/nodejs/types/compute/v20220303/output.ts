...
export interface EncryptionImagesResponse {
     ...
     */
    dataDiskImages?: outputs.compute.v20220303.DataDiskImageEncryptionResponse[];
    /**
     * Contains encryption settings for an OS disk image.
     */
    osDiskImage?: outputs.compute.v20220303.OSDiskImageEncryptionResponse;
}
...
export interface GalleryApplicationCustomActionResponse {
     ...
     */
    parameters?: outputs.compute.v20220303.GalleryApplicationCustomActionParameterResponse[];
    /**
...
export interface GalleryApplicationVersionPublishingProfileResponse {
     ...
     */
    customActions?: outputs.compute.v20220303.GalleryApplicationCustomActionResponse[];
    /**
    ...
    manageActions?: outputs.compute.v20220303.UserArtifactManageResponse;
    /**
     ...
     */
    settings?: outputs.compute.v20220303.UserArtifactSettingsResponse;
    /**
     * The source image from which the Image Version is going to be created.
     */
    source: outputs.compute.v20220303.UserArtifactSourceResponse;
    /**
     ...
     */
    targetExtendedLocations?: outputs.compute.v20220303.GalleryTargetExtendedLocationResponse[];
    /**
     * The target regions where the Image Version is going to be replicated to. This property is updatable.
     */
    targetRegions?: outputs.compute.v20220303.TargetRegionResponse[];
}
...
export interface GalleryDataDiskImageResponse {
     ...
     */
    source?: outputs.compute.v20220303.GalleryDiskImageSourceResponse;
}
...
export interface GalleryImageVersionSafetyProfileResponse {
     ...
     */
    policyViolations: outputs.compute.v20220303.PolicyViolationResponse[];
    /**
...
export interface GalleryImageVersionStorageProfileResponse {
     ...
     */
    dataDiskImages?: outputs.compute.v20220303.GalleryDataDiskImageResponse[];
    /**
     * This is the OS disk image.
     */
    osDiskImage?: outputs.compute.v20220303.GalleryOSDiskImageResponse;
    /**
     * The source of the gallery artifact version.
     */
    source?: outputs.compute.v20220303.GalleryArtifactVersionFullSourceResponse;
}
...
export interface GalleryTargetExtendedLocationResponse {
     ...
     * Optional. Allows users to provide customer managed keys for encrypting the OS and data disks in the gallery artifact.
     */
    encryption?: outputs.compute.v20220303.EncryptionImagesResponse;
    /**
     * The name of the extended location.
     */
    extendedLocation?: outputs.compute.v20220303.GalleryExtendedLocationResponse;
    /**
...
export interface OSDiskImageEncryptionResponse {
     ...
     */
    securityProfile?: outputs.compute.v20220303.OSDiskImageSecurityProfileResponse;
}
...
export interface RecommendedMachineConfigurationResponse {
     ...
     */
    memory?: outputs.compute.v20220303.ResourceRangeResponse;
    /**
     * Describes the resource range.
     */
    vCPUs?: outputs.compute.v20220303.ResourceRangeResponse;
}
...
export interface ReplicationStatusResponse {
     ...
     */
    summary: outputs.compute.v20220303.RegionalReplicationStatusResponse[];
}
...
export interface SharingProfileResponse {
     ...
     * Information of community gallery if current gallery is shared to community.
     */
    communityGalleryInfo?: outputs.compute.v20220303.CommunityGalleryInfoResponse;
    /**
     * A list of sharing profile groups.
     */
    groups: outputs.compute.v20220303.SharingProfileGroupResponse[];
    /**
...
export interface SharingStatusResponse {
     ...
     */
    summary?: outputs.compute.v20220303.RegionalSharingStatusResponse[];
}
