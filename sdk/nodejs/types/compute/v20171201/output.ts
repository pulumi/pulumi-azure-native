...
export interface ApiErrorResponse {
     ...
     */
    details?: outputs.compute.v20171201.ApiErrorBaseResponse[];
    /**
     * The Api inner error
     */
    innererror?: outputs.compute.v20171201.InnerErrorResponse;
    /**
     * The error message.
     */
    message?: string;
 ...
 */
export interface AutoOSUpgradePolicyResponse {
    /**
...
export interface DataDiskResponse {
     ...
     */
    image?: outputs.compute.v20171201.VirtualHardDiskResponse;
    /**
     ...
     */
    managedDisk?: outputs.compute.v20171201.ManagedDiskParametersResponse;
    /**
     * The disk name.
     */
    name?: string;
     ...
     */
    vhd?: outputs.compute.v20171201.VirtualHardDiskResponse;
    /**
...
export interface DiagnosticsProfileResponse {
     ...
     * Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. <br><br> You can easily view the output of your console log. <br><br> Azure also enables you to see a screenshot of the VM from the hypervisor.
     */
    bootDiagnostics?: outputs.compute.v20171201.BootDiagnosticsResponse;
}
...
export interface DiskEncryptionSettingsResponse {
     ...
     */
    diskEncryptionKey?: outputs.compute.v20171201.KeyVaultSecretReferenceResponse;
    /**
     ...
     */
    keyEncryptionKey?: outputs.compute.v20171201.KeyVaultKeyReferenceResponse;
}
...
export interface DiskInstanceViewResponse {
     ...
     */
    encryptionSettings?: outputs.compute.v20171201.DiskEncryptionSettingsResponse[];
    /**
     * The disk name.
     */
    name?: string;
     ...
     */
    statuses?: outputs.compute.v20171201.InstanceViewStatusResponse[];
}
...
export interface ImageDataDiskResponse {
     ...
     * The managedDisk.
     */
    managedDisk?: outputs.compute.v20171201.SubResourceResponse;
    /**
     * The snapshot.
     */
    snapshot?: outputs.compute.v20171201.SubResourceResponse;
    /**
...
export interface ImageStorageProfileResponse {
     ...
     */
    dataDisks?: outputs.compute.v20171201.ImageDataDiskResponse[];
    /**
     * Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    osDisk?: outputs.compute.v20171201.ImageOSDiskResponse;
    /**
...
export interface KeyVaultKeyReferenceResponse {
     ...
     */
    sourceVault: outputs.compute.v20171201.SubResourceResponse;
}
...
export interface LinuxConfigurationResponse {
     ...
     */
    ssh?: outputs.compute.v20171201.SshConfigurationResponse;
}
...
export interface NetworkProfileResponse {
     ...
     */
    networkInterfaces?: outputs.compute.v20171201.NetworkInterfaceReferenceResponse[];
}
...
export interface OSProfileResponse {
     ...
     * Specifies the Linux operating system settings on the virtual machine. <br><br>For a list of supported Linux distributions, see [Linux on Azure-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-endorsed-distros?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) <br><br> For running non-endorsed distributions, see [Information for Non-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-create-upload-generic?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
     */
    linuxConfiguration?: outputs.compute.v20171201.LinuxConfigurationResponse;
    /**
     * Specifies set of certificates that should be installed onto the virtual machine.
     */
    secrets?: outputs.compute.v20171201.VaultSecretGroupResponse[];
    /**
     * Specifies Windows operating system settings on the virtual machine.
     */
    windowsConfiguration?: outputs.compute.v20171201.WindowsConfigurationResponse;
}
...
export interface SshConfigurationResponse {
     ...
     */
    publicKeys?: outputs.compute.v20171201.SshPublicKeyResponse[];
}
...
export interface StorageProfileResponse {
     ...
     * Specifies the parameters that are used to add a data disk to a virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    dataDisks?: outputs.compute.v20171201.DataDiskResponse[];
    /**
     * Specifies information about the image to use. You can specify information about platform images, marketplace images, or virtual machine images. This element is required when you want to use a platform image, marketplace image, or virtual machine image, but is not used in other creation operations.
     */
    imageReference?: outputs.compute.v20171201.ImageReferenceResponse;
    /**
     * Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    osDisk?: outputs.compute.v20171201.OSDiskResponse;
}
...
export interface UpgradePolicyResponse {
     ...
     */
    autoOSUpgradePolicy?: outputs.compute.v20171201.AutoOSUpgradePolicyResponse;
    /**
     ...
     * The configuration parameters used while performing a rolling upgrade.
     */
    rollingUpgradePolicy?: outputs.compute.v20171201.RollingUpgradePolicyResponse;
}
...
export interface VaultSecretGroupResponse {
     ...
     */
    vaultCertificates?: outputs.compute.v20171201.VaultCertificateResponse[];
}
...
export interface VirtualMachineAgentInstanceViewResponse {
     ...
     */
    extensionHandlers?: outputs.compute.v20171201.VirtualMachineExtensionHandlerInstanceViewResponse[];
    /**
     * The resource status information.
     */
    statuses?: outputs.compute.v20171201.InstanceViewStatusResponse[];
...
export interface VirtualMachineExtensionHandlerInstanceViewResponse {
     ...
     */
    status?: outputs.compute.v20171201.InstanceViewStatusResponse;
    /**
...
export interface VirtualMachineExtensionInstanceViewResponse {
     ...
     * The resource status information.
     */
    substatuses?: outputs.compute.v20171201.InstanceViewStatusResponse[];
    /**
     * Specifies the type of the extension; an example is "CustomScriptExtension".
     */
    type?: string;
...
export interface VirtualMachineExtensionResponse {
     ...
     */
    instanceView?: outputs.compute.v20171201.VirtualMachineExtensionInstanceViewResponse;
    /**
     * Resource location
     */
    location: string;
...
export interface VirtualMachineInstanceViewResponse {
     ...
     * Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. <br><br> You can easily view the output of your console log. <br><br> Azure also enables you to see a screenshot of the VM from the hypervisor.
     */
    bootDiagnostics?: outputs.compute.v20171201.BootDiagnosticsInstanceViewResponse;
    /**
     ...
     */
    disks?: outputs.compute.v20171201.DiskInstanceViewResponse[];
    /**
     * The extensions information.
     */
    extensions?: outputs.compute.v20171201.VirtualMachineExtensionInstanceViewResponse[];
    /**
     * The Maintenance Operation status on the virtual machine.
     */
    maintenanceRedeployStatus?: outputs.compute.v20171201.MaintenanceRedeployStatusResponse;
    /**
     ...
     */
    vmAgent?: outputs.compute.v20171201.VirtualMachineAgentInstanceViewResponse;
}
...
export interface VirtualMachineScaleSetDataDiskResponse {
     ...
     * The managed disk parameters.
     */
    managedDisk?: outputs.compute.v20171201.VirtualMachineScaleSetManagedDiskParametersResponse;
    /**
     * The disk name.
     */
    name?: string;
...
export interface VirtualMachineScaleSetExtensionProfileResponse {
     ...
     */
    extensions?: outputs.compute.v20171201.VirtualMachineScaleSetExtensionResponse[];
}
...
export interface VirtualMachineScaleSetIPConfigurationResponse {
     ...
     */
    applicationGatewayBackendAddressPools?: outputs.compute.v20171201.SubResourceResponse[];
    /**
     * Resource Id
     */
    id?: string;
     ...
     */
    loadBalancerBackendAddressPools?: outputs.compute.v20171201.SubResourceResponse[];
    /**
     ...
     */
    loadBalancerInboundNatPools?: outputs.compute.v20171201.SubResourceResponse[];
    /**
     ...
     */
    publicIPAddressConfiguration?: outputs.compute.v20171201.VirtualMachineScaleSetPublicIPAddressConfigurationResponse;
    /**
     * Specifies the identifier of the subnet.
     */
    subnet?: outputs.compute.v20171201.ApiEntityReferenceResponse;
}
...
export interface VirtualMachineScaleSetNetworkConfigurationResponse {
     ...
     */
    dnsSettings?: outputs.compute.v20171201.VirtualMachineScaleSetNetworkConfigurationDnsSettingsResponse;
    /**
     ...
     */
    ipConfigurations: outputs.compute.v20171201.VirtualMachineScaleSetIPConfigurationResponse[];
    /**
     ...
     */
    networkSecurityGroup?: outputs.compute.v20171201.SubResourceResponse;
    /**
     * Specifies the primary network interface in case the virtual machine has more than 1 network interface.
     */
    primary?: boolean;
...
export interface VirtualMachineScaleSetNetworkProfileResponse {
     ...
     */
    healthProbe?: outputs.compute.v20171201.ApiEntityReferenceResponse;
    /**
     * The list of network configurations.
     */
    networkInterfaceConfigurations?: outputs.compute.v20171201.VirtualMachineScaleSetNetworkConfigurationResponse[];
}
...
export interface VirtualMachineScaleSetPublicIPAddressConfigurationResponse {
     ...
     */
    dnsSettings?: outputs.compute.v20171201.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettingsResponse;
    /**
...
export interface VirtualMachineScaleSetStorageProfileResponse {
     ...
     */
    dataDisks?: outputs.compute.v20171201.VirtualMachineScaleSetDataDiskResponse[];
    /**
     * Specifies information about the image to use. You can specify information about platform images, marketplace images, or virtual machine images. This element is required when you want to use a platform image, marketplace image, or virtual machine image, but is not used in other creation operations.
     */
    imageReference?: outputs.compute.v20171201.ImageReferenceResponse;
     ...
     */
    osDisk?: outputs.compute.v20171201.VirtualMachineScaleSetOSDiskResponse;
}
...
export interface VirtualMachineScaleSetVMInstanceViewResponse {
     ...
     */
    vmHealth: outputs.compute.v20171201.VirtualMachineHealthStatusResponse;
}
...
export interface VirtualMachineScaleSetVMProfileResponse {
     ...
     * Specifies the boot diagnostic settings state. <br><br>Minimum api-version: 2015-06-15.
     */
    diagnosticsProfile?: outputs.compute.v20171201.DiagnosticsProfileResponse;
    /**
     ...
     */
    extensionProfile?: outputs.compute.v20171201.VirtualMachineScaleSetExtensionProfileResponse;
    /**
     ...
     */
    networkProfile?: outputs.compute.v20171201.VirtualMachineScaleSetNetworkProfileResponse;
    /**
     * Specifies the operating system settings for the virtual machines in the scale set.
     */
    osProfile?: outputs.compute.v20171201.VirtualMachineScaleSetOSProfileResponse;
    /**
     ...
     * Specifies the storage settings for the virtual machine disks.
     */
    storageProfile?: outputs.compute.v20171201.VirtualMachineScaleSetStorageProfileResponse;
}
...
export interface WinRMConfigurationResponse {
     ...
     */
    listeners?: outputs.compute.v20171201.WinRMListenerResponse[];
}
...
export interface WindowsConfigurationResponse {
     ...
     */
    additionalUnattendContent?: outputs.compute.v20171201.AdditionalUnattendContentResponse[];
    /**
     ...
     */
    winRM?: outputs.compute.v20171201.WinRMConfigurationResponse;
}
