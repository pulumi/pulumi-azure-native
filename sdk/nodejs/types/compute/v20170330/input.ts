...
export interface AdditionalUnattendContentArgs {
     ...
     */
    componentName?: pulumi.Input<enums.compute.v20170330.ComponentNames>;
    /**
     ...
     */
    passName?: pulumi.Input<enums.compute.v20170330.PassNames>;
    /**
     * Specifies the name of the setting to which the content applies. Possible values are: FirstLogonCommands and AutoLogon.
     */
    settingName?: pulumi.Input<enums.compute.v20170330.SettingNames>;
}
...
export interface CreationDataArgs {
     ...
     */
    createOption: pulumi.Input<enums.compute.v20170330.DiskCreateOption>;
    /**
     * Disk source information.
     */
    imageReference?: pulumi.Input<inputs.compute.v20170330.ImageDiskReferenceArgs>;
    /**
...
export interface DataDiskArgs {
     ...
     */
    caching?: pulumi.Input<enums.compute.v20170330.CachingTypes>;
    /**
     * Specifies how the virtual machine should be created.<br><br> Possible values are:<br><br> **Attach** \u2013 This value is used when you are using a specialized disk to create the virtual machine.<br><br> **FromImage** \u2013 This value is used when you are using an image to create the virtual machine. If you are using a platform image, you also use the imageReference element described above. If you are using a marketplace image, you  also use the plan element previously described.
     */
    createOption: pulumi.Input<enums.compute.v20170330.DiskCreateOptionTypes>;
    /**
     ...
     */
    image?: pulumi.Input<inputs.compute.v20170330.VirtualHardDiskArgs>;
    /**
     ...
     */
    managedDisk?: pulumi.Input<inputs.compute.v20170330.ManagedDiskParametersArgs>;
    /**
     * The disk name.
     */
     ...
     */
    vhd?: pulumi.Input<inputs.compute.v20170330.VirtualHardDiskArgs>;
}
...
export interface DiagnosticsProfileArgs {
     ...
     * Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. <br><br> You can easily view the output of your console log. <br><br> Azure also enables you to see a screenshot of the VM from the hypervisor.
     */
    bootDiagnostics?: pulumi.Input<inputs.compute.v20170330.BootDiagnosticsArgs>;
}
...
export interface DiskEncryptionSettingsArgs {
     ...
     */
    diskEncryptionKey?: pulumi.Input<inputs.compute.v20170330.KeyVaultSecretReferenceArgs>;
    /**
     ...
     */
    keyEncryptionKey?: pulumi.Input<inputs.compute.v20170330.KeyVaultKeyReferenceArgs>;
}
...
export interface DiskSkuArgs {
     ...
     * The sku name.
     */
    name?: pulumi.Input<string | enums.compute.v20170330.StorageAccountTypes>;
}
...
export interface EncryptionSettingsArgs {
     ...
     */
    diskEncryptionKey?: pulumi.Input<inputs.compute.v20170330.KeyVaultAndSecretReferenceArgs>;
    /**
     ...
     */
    keyEncryptionKey?: pulumi.Input<inputs.compute.v20170330.KeyVaultAndKeyReferenceArgs>;
}
...
export interface HardwareProfileArgs {
     ...
     */
    vmSize?: pulumi.Input<string | enums.compute.v20170330.VirtualMachineSizeTypes>;
}
...
export interface ImageDataDiskArgs {
     ...
     * The managedDisk.
     */
    managedDisk?: pulumi.Input<inputs.compute.v20170330.SubResourceArgs>;
    /**
     * The snapshot.
     */
    snapshot?: pulumi.Input<inputs.compute.v20170330.SubResourceArgs>;
    /**
     * Specifies the storage account type for the managed disk. Possible values are: Standard_LRS or Premium_LRS.
     */
    storageAccountType?: pulumi.Input<string | enums.compute.v20170330.StorageAccountTypes>;
}
...
export interface ImageOSDiskArgs {
     ...
     * The OS State.
     */
    osState: pulumi.Input<enums.compute.v20170330.OperatingSystemStateTypes>;
    /**
...
export interface ImageStorageProfileArgs {
     ...
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.ImageDataDiskArgs>[]>;
    /**
     * Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    osDisk: pulumi.Input<inputs.compute.v20170330.ImageOSDiskArgs>;
}
...
export interface InstanceViewStatusArgs {
     ...
     * The level code.
     */
    level?: pulumi.Input<enums.compute.v20170330.StatusLevelTypes>;
    /**
...
export interface KeyVaultAndKeyReferenceArgs {
     ...
     */
    sourceVault: pulumi.Input<inputs.compute.v20170330.SourceVaultArgs>;
}
...
export interface KeyVaultKeyReferenceArgs {
     ...
     */
    sourceVault: pulumi.Input<inputs.compute.v20170330.SubResourceArgs>;
}
...
export interface LinuxConfigurationArgs {
     ...
     */
    ssh?: pulumi.Input<inputs.compute.v20170330.SshConfigurationArgs>;
}
...
export interface NetworkProfileArgs {
     ...
     */
    networkInterfaces?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.NetworkInterfaceReferenceArgs>[]>;
}
...
export interface OSDiskArgs {
     ...
     */
    encryptionSettings?: pulumi.Input<inputs.compute.v20170330.DiskEncryptionSettingsArgs>;
    /**
     * The source user image virtual hard disk. The virtual hard disk will be copied before being attached to the virtual machine. If SourceImage is provided, the destination virtual hard drive must not exist.
     */
    image?: pulumi.Input<inputs.compute.v20170330.VirtualHardDiskArgs>;
...
export interface OSProfileArgs {
     ...
     * Specifies the Linux operating system settings on the virtual machine. <br><br>For a list of supported Linux distributions, see [Linux on Azure-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-endorsed-distros?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) <br><br> For running non-endorsed distributions, see [Information for Non-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-create-upload-generic?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
     */
    linuxConfiguration?: pulumi.Input<inputs.compute.v20170330.LinuxConfigurationArgs>;
    /**
     * Specifies set of certificates that should be installed onto the virtual machine.
     */
    secrets?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.VaultSecretGroupArgs>[]>;
    /**
     * Specifies Windows operating system settings on the virtual machine.
     */
    windowsConfiguration?: pulumi.Input<inputs.compute.v20170330.WindowsConfigurationArgs>;
}
...
export interface SshConfigurationArgs {
     ...
     */
    publicKeys?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.SshPublicKeyArgs>[]>;
}
...
export interface StorageProfileArgs {
     ...
     * Specifies the parameters that are used to add a data disk to a virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.DataDiskArgs>[]>;
    /**
     * Specifies information about the image to use. You can specify information about platform images, marketplace images, or virtual machine images. This element is required when you want to use a platform image, marketplace image, or virtual machine image, but is not used in other creation operations.
     */
    imageReference?: pulumi.Input<inputs.compute.v20170330.ImageReferenceArgs>;
    /**
     * Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    osDisk?: pulumi.Input<inputs.compute.v20170330.OSDiskArgs>;
}
...
export interface UpgradePolicyArgs {
     ...
     */
    mode?: pulumi.Input<enums.compute.v20170330.UpgradeMode>;
    /**
     * The configuration parameters used while performing a rolling upgrade.
     */
    rollingUpgradePolicy?: pulumi.Input<inputs.compute.v20170330.RollingUpgradePolicyArgs>;
}
...
export interface VaultSecretGroupArgs {
     ...
     */
    vaultCertificates?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.VaultCertificateArgs>[]>;
}
...
export interface VirtualMachineExtensionInstanceViewArgs {
     ...
     */
    statuses?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.InstanceViewStatusArgs>[]>;
    /**
     * The resource status information.
     */
    substatuses?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.InstanceViewStatusArgs>[]>;
    /**
...
export interface VirtualMachineIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.compute.v20170330.ResourceIdentityType>;
}
...
export interface VirtualMachineScaleSetDataDiskArgs {
     ...
     * The managed disk parameters.
     */
    managedDisk?: pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetManagedDiskParametersArgs>;
    /**
     * The disk name.
     */
    name?: pulumi.Input<string>;
...
export interface VirtualMachineScaleSetExtensionProfileArgs {
     ...
     */
    extensions?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetExtensionArgs>[]>;
}
...
export interface VirtualMachineScaleSetIPConfigurationArgs {
     ...
     */
    applicationGatewayBackendAddressPools?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.SubResourceArgs>[]>;
    /**
     * Resource Id
     */
    id?: pulumi.Input<string>;
     ...
     */
    loadBalancerBackendAddressPools?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.SubResourceArgs>[]>;
    /**
     ...
     */
    loadBalancerInboundNatPools?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.SubResourceArgs>[]>;
    /**
     ...
     */
    privateIPAddressVersion?: pulumi.Input<string | enums.compute.v20170330.IPVersion>;
    /**
     * The publicIPAddressConfiguration.
     */
    publicIPAddressConfiguration?: pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetPublicIPAddressConfigurationArgs>;
    /**
     * Specifies the identifier of the subnet.
     */
    subnet?: pulumi.Input<inputs.compute.v20170330.ApiEntityReferenceArgs>;
}
...
export interface VirtualMachineScaleSetNetworkConfigurationArgs {
     ...
     */
    dnsSettings?: pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetNetworkConfigurationDnsSettingsArgs>;
    /**
     ...
     */
    ipConfigurations: pulumi.Input<pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetIPConfigurationArgs>[]>;
    /**
     ...
     */
    networkSecurityGroup?: pulumi.Input<inputs.compute.v20170330.SubResourceArgs>;
    /**
     * Specifies the primary network interface in case the virtual machine has more than 1 network interface.
     */
    primary?: pulumi.Input<boolean>;
...
export interface VirtualMachineScaleSetNetworkProfileArgs {
     ...
     */
    healthProbe?: pulumi.Input<inputs.compute.v20170330.ApiEntityReferenceArgs>;
    /**
     * The list of network configurations.
     */
    networkInterfaceConfigurations?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetNetworkConfigurationArgs>[]>;
}
...
export interface VirtualMachineScaleSetPublicIPAddressConfigurationArgs {
     ...
     */
    dnsSettings?: pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettingsArgs>;
    /**
...
export interface VirtualMachineScaleSetStorageProfileArgs {
     ...
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetDataDiskArgs>[]>;
    /**
     * Specifies information about the image to use. You can specify information about platform images, marketplace images, or virtual machine images. This element is required when you want to use a platform image, marketplace image, or virtual machine image, but is not used in other creation operations.
     */
    imageReference?: pulumi.Input<inputs.compute.v20170330.ImageReferenceArgs>;
     ...
     */
    osDisk?: pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetOSDiskArgs>;
}
...
export interface VirtualMachineScaleSetVMProfileArgs {
     ...
     */
    extensionProfile?: pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetExtensionProfileArgs>;
    /**
     ...
     */
    networkProfile?: pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetNetworkProfileArgs>;
    /**
     * Specifies the operating system settings for the virtual machines in the scale set.
     */
    osProfile?: pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetOSProfileArgs>;
    /**
     * Specifies the storage settings for the virtual machine disks.
     */
    storageProfile?: pulumi.Input<inputs.compute.v20170330.VirtualMachineScaleSetStorageProfileArgs>;
}
...
export interface WinRMConfigurationArgs {
     ...
     */
    listeners?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.WinRMListenerArgs>[]>;
}
...
export interface WinRMListenerArgs {
     ...
     */
    protocol?: pulumi.Input<enums.compute.v20170330.ProtocolTypes>;
}
...
export interface WindowsConfigurationArgs {
     ...
     */
    additionalUnattendContent?: pulumi.Input<pulumi.Input<inputs.compute.v20170330.AdditionalUnattendContentArgs>[]>;
    /**
     ...
     */
    winRM?: pulumi.Input<inputs.compute.v20170330.WinRMConfigurationArgs>;
}
