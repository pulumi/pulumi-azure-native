...
export interface AdditionalUnattendContentArgs {
     ...
     */
    componentName?: pulumi.Input<enums.compute.v20211101.ComponentNames>;
    /**
     ...
     */
    passName?: pulumi.Input<enums.compute.v20211101.PassNames>;
    /**
     * Specifies the name of the setting to which the content applies. Possible values are: FirstLogonCommands and AutoLogon.
     */
    settingName?: pulumi.Input<enums.compute.v20211101.SettingNames>;
}
...
export interface ApplicationProfileArgs {
     ...
     */
    galleryApplications?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.VMGalleryApplicationArgs>[]>;
}
...
export interface AutomaticRepairsPolicyArgs {
     ...
     */
    repairAction?: pulumi.Input<string | enums.compute.v20211101.RepairAction>;
}
...
export interface CapacityReservationProfileArgs {
     ...
     */
    capacityReservationGroup?: pulumi.Input<inputs.compute.v20211101.SubResourceArgs>;
}
...
export interface DataDiskArgs {
     ...
     */
    caching?: pulumi.Input<enums.compute.v20211101.CachingTypes>;
    /**
     * Specifies how the virtual machine should be created.<br><br> Possible values are:<br><br> **Attach** \u2013 This value is used when you are using a specialized disk to create the virtual machine.<br><br> **FromImage** \u2013 This value is used when you are using an image to create the virtual machine. If you are using a platform image, you also use the imageReference element described above. If you are using a marketplace image, you  also use the plan element previously described.
     */
    createOption: pulumi.Input<string | enums.compute.v20211101.DiskCreateOptionTypes>;
    /**
     ...
     */
    deleteOption?: pulumi.Input<string | enums.compute.v20211101.DiskDeleteOptionTypes>;
    /**
     ...
     */
    detachOption?: pulumi.Input<string | enums.compute.v20211101.DiskDetachOptionTypes>;
    /**
     ...
     */
    image?: pulumi.Input<inputs.compute.v20211101.VirtualHardDiskArgs>;
    /**
     ...
     */
    managedDisk?: pulumi.Input<inputs.compute.v20211101.ManagedDiskParametersArgs>;
    /**
     * The disk name.
     */
     ...
     */
    vhd?: pulumi.Input<inputs.compute.v20211101.VirtualHardDiskArgs>;
    /**
...
export interface DiagnosticsProfileArgs {
     ...
     */
    bootDiagnostics?: pulumi.Input<inputs.compute.v20211101.BootDiagnosticsArgs>;
}
...
export interface DiffDiskSettingsArgs {
     ...
     */
    option?: pulumi.Input<string | enums.compute.v20211101.DiffDiskOptions>;
    /**
     * Specifies the ephemeral disk placement for operating system disk.<br><br> Possible values are: <br><br> **CacheDisk** <br><br> **ResourceDisk** <br><br> Default: **CacheDisk** if one is configured for the VM size otherwise **ResourceDisk** is used.<br><br> Refer to VM size documentation for Windows VM at https://docs.microsoft.com/azure/virtual-machines/windows/sizes and Linux VM at https://docs.microsoft.com/azure/virtual-machines/linux/sizes to check which VM sizes exposes a cache disk.
     */
    placement?: pulumi.Input<string | enums.compute.v20211101.DiffDiskPlacement>;
}
...
export interface DiskEncryptionSettingsArgs {
     ...
     */
    diskEncryptionKey?: pulumi.Input<inputs.compute.v20211101.KeyVaultSecretReferenceArgs>;
    /**
     ...
     */
    keyEncryptionKey?: pulumi.Input<inputs.compute.v20211101.KeyVaultKeyReferenceArgs>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type?: pulumi.Input<string | enums.compute.v20211101.ExtendedLocationTypes>;
}
...
export interface HardwareProfileArgs {
     ...
     */
    vmSize?: pulumi.Input<string | enums.compute.v20211101.VirtualMachineSizeTypes>;
    /**
     ...
     */
    vmSizeProperties?: pulumi.Input<inputs.compute.v20211101.VMSizePropertiesArgs>;
}
...
export interface ImageDataDiskArgs {
     ...
     */
    diskEncryptionSet?: pulumi.Input<inputs.compute.v20211101.DiskEncryptionSetParametersArgs>;
    /**
     ...
     * The managedDisk.
     */
    managedDisk?: pulumi.Input<inputs.compute.v20211101.SubResourceArgs>;
    /**
     * The snapshot.
     */
    snapshot?: pulumi.Input<inputs.compute.v20211101.SubResourceArgs>;
    /**
     * Specifies the storage account type for the managed disk. NOTE: UltraSSD_LRS can only be used with data disks, it cannot be used with OS Disk.
     */
    storageAccountType?: pulumi.Input<string | enums.compute.v20211101.StorageAccountTypes>;
}
...
export interface ImageOSDiskArgs {
     ...
     * The OS State.
     */
    osState: pulumi.Input<enums.compute.v20211101.OperatingSystemStateTypes>;
    /**
     * This property allows you to specify the type of the OS that is included in the disk if creating a VM from a custom image. <br><br> Possible values are: <br><br> **Windows** <br><br> **Linux**
     */
    osType: pulumi.Input<enums.compute.v20211101.OperatingSystemTypes>;
    /**
     * The snapshot.
     */
    snapshot?: pulumi.Input<inputs.compute.v20211101.SubResourceArgs>;
...
export interface ImageStorageProfileArgs {
     ...
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.ImageDataDiskArgs>[]>;
    /**
     * Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview).
     */
    osDisk?: pulumi.Input<inputs.compute.v20211101.ImageOSDiskArgs>;
    /**
...
export interface InstanceViewStatusArgs {
     ...
     * The level code.
     */
    level?: pulumi.Input<enums.compute.v20211101.StatusLevelTypes>;
    /**
...
export interface KeyVaultKeyReferenceArgs {
     ...
     */
    sourceVault: pulumi.Input<inputs.compute.v20211101.SubResourceArgs>;
}
...
export interface LinuxConfigurationArgs {
     ...
     */
    patchSettings?: pulumi.Input<inputs.compute.v20211101.LinuxPatchSettingsArgs>;
    /**
     ...
     */
    ssh?: pulumi.Input<inputs.compute.v20211101.SshConfigurationArgs>;
}
...
export interface LinuxPatchSettingsArgs {
     ...
     */
    assessmentMode?: pulumi.Input<string | enums.compute.v20211101.LinuxPatchAssessmentMode>;
    /**
     * Specifies the mode of VM Guest Patching to IaaS virtual machine or virtual machines associated to virtual machine scale set with OrchestrationMode as Flexible.<br /><br /> Possible values are:<br /><br /> **ImageDefault** - The virtual machine's default patching configuration is used. <br /><br /> **AutomaticByPlatform** - The virtual machine will be automatically updated by the platform. The property provisionVMAgent must be true
     */
    patchMode?: pulumi.Input<string | enums.compute.v20211101.LinuxVMGuestPatchMode>;
}
...
export interface ManagedDiskParametersArgs {
     ...
     */
    securityProfile?: pulumi.Input<inputs.compute.v20211101.VMDiskSecurityProfileArgs>;
    /**
     * Specifies the storage account type for the managed disk. NOTE: UltraSSD_LRS can only be used with data disks, it cannot be used with OS Disk.
     */
    storageAccountType?: pulumi.Input<string | enums.compute.v20211101.StorageAccountTypes>;
...
export interface NetworkInterfaceReferenceArgs {
     ...
     */
    deleteOption?: pulumi.Input<string | enums.compute.v20211101.DeleteOptions>;
    /**
     * Resource Id
     */
    id?: pulumi.Input<string>;
...
export interface NetworkProfileArgs {
     ...
     */
    networkApiVersion?: pulumi.Input<string | enums.compute.v20211101.NetworkApiVersion>;
    /**
     * Specifies the networking configurations that will be used to create the virtual machine networking resources.
     */
    networkInterfaceConfigurations?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.VirtualMachineNetworkInterfaceConfigurationArgs>[]>;
    /**
     * Specifies the list of resource Ids for the network interfaces associated with the virtual machine.
     */
    networkInterfaces?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.NetworkInterfaceReferenceArgs>[]>;
}
...
export interface OSDiskArgs {
     ...
     */
    diffDiskSettings?: pulumi.Input<inputs.compute.v20211101.DiffDiskSettingsArgs>;
    /**
     * Specifies the size of an empty data disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual machine image. <br><br> This value cannot be larger than 1023 GB
     */
    diskSizeGB?: pulumi.Input<number>;
     ...
     */
    encryptionSettings?: pulumi.Input<inputs.compute.v20211101.DiskEncryptionSettingsArgs>;
    /**
     * The source user image virtual hard disk. The virtual hard disk will be copied before being attached to the virtual machine. If SourceImage is provided, the destination virtual hard drive must not exist.
     */
    image?: pulumi.Input<inputs.compute.v20211101.VirtualHardDiskArgs>;
...
export interface OSProfileArgs {
     ...
     * Specifies the Linux operating system settings on the virtual machine. <br><br>For a list of supported Linux distributions, see [Linux on Azure-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/linux/endorsed-distros).
     */
    linuxConfiguration?: pulumi.Input<inputs.compute.v20211101.LinuxConfigurationArgs>;
    /**
     ...
     */
    secrets?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.VaultSecretGroupArgs>[]>;
    /**
     * Specifies Windows operating system settings on the virtual machine.
     */
    windowsConfiguration?: pulumi.Input<inputs.compute.v20211101.WindowsConfigurationArgs>;
}
...
export interface PatchSettingsArgs {
     ...
     * Specifies the mode of VM Guest patch assessment for the IaaS virtual machine.<br /><br /> Possible values are:<br /><br /> **ImageDefault** - You control the timing of patch assessments on a virtual machine.<br /><br /> **AutomaticByPlatform** - The platform will trigger periodic patch assessments. The property provisionVMAgent must be true. 
     */
    assessmentMode?: pulumi.Input<string | enums.compute.v20211101.WindowsPatchAssessmentMode>;
    /**
     ...
     */
    patchMode?: pulumi.Input<string | enums.compute.v20211101.WindowsVMGuestPatchMode>;
}
...
export interface PublicIPAddressSkuArgs {
     ...
     */
    name?: pulumi.Input<string | enums.compute.v20211101.PublicIPAddressSkuName>;
    /**
     * Specify public IP sku tier
     */
    tier?: pulumi.Input<string | enums.compute.v20211101.PublicIPAddressSkuTier>;
}
...
export interface ScaleInPolicyArgs {
     ...
     */
    rules?: pulumi.Input<pulumi.Input<string | enums.compute.v20211101.VirtualMachineScaleSetScaleInRules>[]>;
}
...
export interface ScheduledEventsProfileArgs {
     ...
     */
    terminateNotificationProfile?: pulumi.Input<inputs.compute.v20211101.TerminateNotificationProfileArgs>;
}
...
export interface SecurityProfileArgs {
     ...
     */
    securityType?: pulumi.Input<string | enums.compute.v20211101.SecurityTypes>;
    /**
     ...
     */
    uefiSettings?: pulumi.Input<inputs.compute.v20211101.UefiSettingsArgs>;
}
...
export interface SshConfigurationArgs {
     ...
     */
    publicKeys?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.SshPublicKeyArgs>[]>;
}
...
export interface StorageProfileArgs {
     ...
     * Specifies the parameters that are used to add a data disk to a virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview).
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.DataDiskArgs>[]>;
    /**
     * Specifies information about the image to use. You can specify information about platform images, marketplace images, or virtual machine images. This element is required when you want to use a platform image, marketplace image, or virtual machine image, but is not used in other creation operations.
     */
    imageReference?: pulumi.Input<inputs.compute.v20211101.ImageReferenceArgs>;
    /**
     * Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview).
     */
    osDisk?: pulumi.Input<inputs.compute.v20211101.OSDiskArgs>;
}
...
export interface UpgradePolicyArgs {
     ...
     */
    automaticOSUpgradePolicy?: pulumi.Input<inputs.compute.v20211101.AutomaticOSUpgradePolicyArgs>;
    /**
     * Specifies the mode of an upgrade to virtual machines in the scale set.<br /><br /> Possible values are:<br /><br /> **Manual** - You  control the application of updates to virtual machines in the scale set. You do this by using the manualUpgrade action.<br /><br /> **Automatic** - All virtual machines in the scale set are  automatically updated at the same time.
     */
    mode?: pulumi.Input<enums.compute.v20211101.UpgradeMode>;
    /**
     * The configuration parameters used while performing a rolling upgrade.
     */
    rollingUpgradePolicy?: pulumi.Input<inputs.compute.v20211101.RollingUpgradePolicyArgs>;
}
...
export interface VMDiskSecurityProfileArgs {
     ...
     */
    securityEncryptionType?: pulumi.Input<string | enums.compute.v20211101.SecurityEncryptionTypes>;
}
...
export interface VaultSecretGroupArgs {
     ...
     */
    vaultCertificates?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.VaultCertificateArgs>[]>;
}
...
export interface VirtualMachineExtensionInstanceViewArgs {
     ...
     */
    statuses?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.InstanceViewStatusArgs>[]>;
    /**
     * The resource status information.
     */
    substatuses?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.InstanceViewStatusArgs>[]>;
    /**
...
export interface VirtualMachineIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.compute.v20211101.ResourceIdentityType>;
    /**
...
export interface VirtualMachineNetworkInterfaceConfigurationArgs {
     ...
     */
    dnsSettings?: pulumi.Input<inputs.compute.v20211101.VirtualMachineNetworkInterfaceDnsSettingsConfigurationArgs>;
    dscpConfiguration?: pulumi.Input<inputs.compute.v20211101.SubResourceArgs>;
    /**
     ...
     */
    ipConfigurations: pulumi.Input<pulumi.Input<inputs.compute.v20211101.VirtualMachineNetworkInterfaceIPConfigurationArgs>[]>;
    /**
     ...
     */
    networkSecurityGroup?: pulumi.Input<inputs.compute.v20211101.SubResourceArgs>;
    /**
     * Specifies the primary network interface in case the virtual machine has more than 1 network interface.
     */
    primary?: pulumi.Input<boolean>;
...
export interface VirtualMachineNetworkInterfaceIPConfigurationArgs {
     ...
     */
    applicationGatewayBackendAddressPools?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.SubResourceArgs>[]>;
    /**
     * Specifies an array of references to application security group.
     */
    applicationSecurityGroups?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.SubResourceArgs>[]>;
    /**
     * Specifies an array of references to backend address pools of load balancers. A virtual machine can reference backend address pools of one public and one internal load balancer. [Multiple virtual machines cannot use the same basic sku load balancer].
     */
    loadBalancerBackendAddressPools?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.SubResourceArgs>[]>;
    /**
     ...
     */
    privateIPAddressVersion?: pulumi.Input<string | enums.compute.v20211101.IPVersions>;
    /**
     * The publicIPAddressConfiguration.
     */
    publicIPAddressConfiguration?: pulumi.Input<inputs.compute.v20211101.VirtualMachinePublicIPAddressConfigurationArgs>;
    /**
     * Specifies the identifier of the subnet.
     */
    subnet?: pulumi.Input<inputs.compute.v20211101.SubResourceArgs>;
}
...
export interface VirtualMachinePublicIPAddressConfigurationArgs {
     ...
     */
    dnsSettings?: pulumi.Input<inputs.compute.v20211101.VirtualMachinePublicIPAddressDnsSettingsConfigurationArgs>;
    /**
     ...
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.VirtualMachineIpTagArgs>[]>;
    /**
     ...
     */
    publicIPAddressVersion?: pulumi.Input<string | enums.compute.v20211101.IPVersions>;
    /**
     * Specify the public IP allocation type
     */
    publicIPAllocationMethod?: pulumi.Input<string | enums.compute.v20211101.PublicIPAllocationMethod>;
    /**
     * The PublicIPPrefix from which to allocate publicIP addresses.
     */
    publicIPPrefix?: pulumi.Input<inputs.compute.v20211101.SubResourceArgs>;
    /**
     * Describes the public IP Sku. It can only be set with OrchestrationMode as Flexible.
     */
    sku?: pulumi.Input<inputs.compute.v20211101.PublicIPAddressSkuArgs>;
}
...
export interface VirtualMachineScaleSetDataDiskArgs {
     ...
     * The managed disk parameters.
     */
    managedDisk?: pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetManagedDiskParametersArgs>;
    /**
     * The disk name.
     */
    name?: pulumi.Input<string>;
...
export interface VirtualMachineScaleSetExtensionProfileArgs {
     ...
     */
    extensions?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetExtensionArgs>[]>;
    /**
...
export interface VirtualMachineScaleSetIPConfigurationArgs {
     ...
     */
    loadBalancerInboundNatPools?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.SubResourceArgs>[]>;
    /**
     * The IP configuration name.
     */
    name: pulumi.Input<string>;
     ...
     * Available from Api-Version 2017-03-30 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4.  Possible values are: 'IPv4' and 'IPv6'.
     */
    privateIPAddressVersion?: pulumi.Input<string | enums.compute.v20211101.IPVersion>;
    /**
     * The publicIPAddressConfiguration.
     */
    publicIPAddressConfiguration?: pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetPublicIPAddressConfigurationArgs>;
    /**
     * Specifies the identifier of the subnet.
     */
    subnet?: pulumi.Input<inputs.compute.v20211101.ApiEntityReferenceArgs>;
}
...
export interface VirtualMachineScaleSetNetworkConfigurationArgs {
     ...
     * The dns settings to be applied on the network interfaces.
     */
    dnsSettings?: pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetNetworkConfigurationDnsSettingsArgs>;
    /**
     * Specifies whether the network interface is accelerated networking-enabled.
     */
    enableAcceleratedNetworking?: pulumi.Input<boolean>;
     ...
     * Specifies the IP configurations of the network interface.
     */
    ipConfigurations: pulumi.Input<pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetIPConfigurationArgs>[]>;
    /**
...
export interface VirtualMachineScaleSetNetworkProfileArgs {
     ...
     */
    healthProbe?: pulumi.Input<inputs.compute.v20211101.ApiEntityReferenceArgs>;
    /**
     ...
     */
    networkInterfaceConfigurations?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetNetworkConfigurationArgs>[]>;
}
...
export interface VirtualMachineScaleSetPublicIPAddressConfigurationArgs {
     ...
     * The dns settings to be applied on the publicIP addresses .
     */
    dnsSettings?: pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettingsArgs>;
    /**
     * The idle timeout of the public IP address.
     */
    idleTimeoutInMinutes?: pulumi.Input<number>;
     ...
     * The list of IP tags associated with the public IP address.
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetIpTagArgs>[]>;
    /**
     * The publicIP address configuration name.
     */
    name: pulumi.Input<string>;
     ...
     * Available from Api-Version 2019-07-01 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4. Possible values are: 'IPv4' and 'IPv6'.
     */
    publicIPAddressVersion?: pulumi.Input<string | enums.compute.v20211101.IPVersion>;
    /**
     * The PublicIPPrefix from which to allocate publicIP addresses.
     */
    publicIPPrefix?: pulumi.Input<inputs.compute.v20211101.SubResourceArgs>;
...
export interface VirtualMachineScaleSetStorageProfileArgs {
     ...
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetDataDiskArgs>[]>;
    /**
     * Specifies information about the image to use. You can specify information about platform images, marketplace images, or virtual machine images. This element is required when you want to use a platform image, marketplace image, or virtual machine image, but is not used in other creation operations.
     */
    imageReference?: pulumi.Input<inputs.compute.v20211101.ImageReferenceArgs>;
     ...
     */
    osDisk?: pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetOSDiskArgs>;
}
...
export interface VirtualMachineScaleSetVMProfileArgs {
     ...
     */
    extensionProfile?: pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetExtensionProfileArgs>;
    /**
     * Specifies the hardware profile related details of a scale set. <br><br>Minimum api-version: 2021-11-01.
     */
    hardwareProfile?: pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetHardwareProfileArgs>;
    /**
     ...
     */
    networkProfile?: pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetNetworkProfileArgs>;
    /**
     * Specifies the operating system settings for the virtual machines in the scale set.
     */
    osProfile?: pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetOSProfileArgs>;
    /**
     ...
     * Specifies the storage settings for the virtual machine disks.
     */
    storageProfile?: pulumi.Input<inputs.compute.v20211101.VirtualMachineScaleSetStorageProfileArgs>;
    /**
...
export interface WinRMConfigurationArgs {
     ...
     */
    listeners?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.WinRMListenerArgs>[]>;
}
...
export interface WinRMListenerArgs {
     ...
     */
    protocol?: pulumi.Input<enums.compute.v20211101.ProtocolTypes>;
}
...
export interface WindowsConfigurationArgs {
     ...
     */
    additionalUnattendContent?: pulumi.Input<pulumi.Input<inputs.compute.v20211101.AdditionalUnattendContentArgs>[]>;
    /**
     ...
     */
    patchSettings?: pulumi.Input<inputs.compute.v20211101.PatchSettingsArgs>;
    /**
     * Indicates whether virtual machine agent should be provisioned on the virtual machine. <br><br> When this property is not specified in the request body, default behavior is to set it to true.  This will ensure that VM Agent is installed on the VM so that extensions can be added to the VM later.
     */
    provisionVMAgent?: pulumi.Input<boolean>;
     ...
     */
    winRM?: pulumi.Input<inputs.compute.v20211101.WinRMConfigurationArgs>;
}
