...
export interface AdditionalUnattendContentArgs {
     ...
     */
    componentName?: pulumi.Input<enums.compute.v20201201.ComponentNames>;
    /**
     ...
     */
    passName?: pulumi.Input<enums.compute.v20201201.PassNames>;
    /**
     * Specifies the name of the setting to which the content applies. Possible values are: FirstLogonCommands and AutoLogon.
     */
    settingName?: pulumi.Input<enums.compute.v20201201.SettingNames>;
}
...
export interface CreationDataArgs {
     ...
     */
    createOption: pulumi.Input<string | enums.compute.v20201201.DiskCreateOption>;
    /**
     * Required if creating from a Gallery Image. The id of the ImageDiskReference will be the ARM id of the shared galley image version from which to create a disk.
     */
    galleryImageReference?: pulumi.Input<inputs.compute.v20201201.ImageDiskReferenceArgs>;
    /**
     * Disk source information.
     */
    imageReference?: pulumi.Input<inputs.compute.v20201201.ImageDiskReferenceArgs>;
    /**
...
export interface DataDiskArgs {
     ...
     */
    caching?: pulumi.Input<enums.compute.v20201201.CachingTypes>;
    /**
     * Specifies how the virtual machine should be created.<br><br> Possible values are:<br><br> **Attach** \u2013 This value is used when you are using a specialized disk to create the virtual machine.<br><br> **FromImage** \u2013 This value is used when you are using an image to create the virtual machine. If you are using a platform image, you also use the imageReference element described above. If you are using a marketplace image, you  also use the plan element previously described.
     */
    createOption: pulumi.Input<string | enums.compute.v20201201.DiskCreateOptionTypes>;
    /**
     ...
     */
    detachOption?: pulumi.Input<string | enums.compute.v20201201.DiskDetachOptionTypes>;
    /**
     ...
     */
    image?: pulumi.Input<inputs.compute.v20201201.VirtualHardDiskArgs>;
    /**
     ...
     */
    managedDisk?: pulumi.Input<inputs.compute.v20201201.ManagedDiskParametersArgs>;
    /**
     * The disk name.
     */
     ...
     */
    vhd?: pulumi.Input<inputs.compute.v20201201.VirtualHardDiskArgs>;
    /**
...
export interface DiagnosticsProfileArgs {
     ...
     * Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. <br><br> You can easily view the output of your console log. <br><br> Azure also enables you to see a screenshot of the VM from the hypervisor.
     */
    bootDiagnostics?: pulumi.Input<inputs.compute.v20201201.BootDiagnosticsArgs>;
}
...
export interface DiffDiskSettingsArgs {
     ...
     */
    option?: pulumi.Input<string | enums.compute.v20201201.DiffDiskOptions>;
    /**
     * Specifies the ephemeral disk placement for operating system disk.<br><br> Possible values are: <br><br> **CacheDisk** <br><br> **ResourceDisk** <br><br> Default: **CacheDisk** if one is configured for the VM size otherwise **ResourceDisk** is used.<br><br> Refer to VM size documentation for Windows VM at https://docs.microsoft.com/en-us/azure/virtual-machines/windows/sizes and Linux VM at https://docs.microsoft.com/en-us/azure/virtual-machines/linux/sizes to check which VM sizes exposes a cache disk.
     */
    placement?: pulumi.Input<string | enums.compute.v20201201.DiffDiskPlacement>;
}
...
export interface DiskEncryptionSettingsArgs {
     ...
     */
    diskEncryptionKey?: pulumi.Input<inputs.compute.v20201201.KeyVaultSecretReferenceArgs>;
    /**
     ...
     */
    keyEncryptionKey?: pulumi.Input<inputs.compute.v20201201.KeyVaultKeyReferenceArgs>;
}
...
export interface DiskSecurityProfileArgs {
     ...
     */
    securityType?: pulumi.Input<string | enums.compute.v20201201.DiskSecurityTypes>;
}
...
export interface DiskSkuArgs {
     ...
     * The sku name.
     */
    name?: pulumi.Input<string | enums.compute.v20201201.DiskStorageAccountTypes>;
}
...
export interface EncryptionArgs {
     ...
     */
    type?: pulumi.Input<string | enums.compute.v20201201.EncryptionType>;
}
...
export interface EncryptionSetIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.compute.v20201201.DiskEncryptionSetIdentityType>;
}
...
export interface EncryptionSettingsCollectionArgs {
     ...
     */
    encryptionSettings?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.EncryptionSettingsElementArgs>[]>;
    /**
...
export interface EncryptionSettingsElementArgs {
     ...
     */
    diskEncryptionKey?: pulumi.Input<inputs.compute.v20201201.KeyVaultAndSecretReferenceArgs>;
    /**
     * Key Vault Key Url and vault id of the key encryption key. KeyEncryptionKey is optional and when provided is used to unwrap the disk encryption key.
     */
    keyEncryptionKey?: pulumi.Input<inputs.compute.v20201201.KeyVaultAndKeyReferenceArgs>;
}
...
export interface ExtendedLocationArgs {
     ...
     */
    type?: pulumi.Input<string | enums.compute.v20201201.ExtendedLocationTypes>;
}
...
export interface HardwareProfileArgs {
     ...
     */
    vmSize?: pulumi.Input<string | enums.compute.v20201201.VirtualMachineSizeTypes>;
}
...
export interface ImageDataDiskArgs {
     ...
     */
    diskEncryptionSet?: pulumi.Input<inputs.compute.v20201201.DiskEncryptionSetParametersArgs>;
    /**
     ...
     * The managedDisk.
     */
    managedDisk?: pulumi.Input<inputs.compute.v20201201.SubResourceArgs>;
    /**
     * The snapshot.
     */
    snapshot?: pulumi.Input<inputs.compute.v20201201.SubResourceArgs>;
    /**
     * Specifies the storage account type for the managed disk. NOTE: UltraSSD_LRS can only be used with data disks, it cannot be used with OS Disk.
     */
    storageAccountType?: pulumi.Input<string | enums.compute.v20201201.StorageAccountTypes>;
}
...
export interface ImageOSDiskArgs {
     ...
     * The OS State.
     */
    osState: pulumi.Input<enums.compute.v20201201.OperatingSystemStateTypes>;
    /**
...
export interface ImageStorageProfileArgs {
     ...
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.ImageDataDiskArgs>[]>;
    /**
     * Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    osDisk?: pulumi.Input<inputs.compute.v20201201.ImageOSDiskArgs>;
    /**
...
export interface InstanceViewStatusArgs {
     ...
     * The level code.
     */
    level?: pulumi.Input<enums.compute.v20201201.StatusLevelTypes>;
    /**
...
export interface KeyForDiskEncryptionSetArgs {
     ...
     */
    sourceVault?: pulumi.Input<inputs.compute.v20201201.SourceVaultArgs>;
}
...
export interface KeyVaultKeyReferenceArgs {
     ...
     */
    sourceVault: pulumi.Input<inputs.compute.v20201201.SubResourceArgs>;
}
...
export interface LinuxConfigurationArgs {
     ...
     */
    patchSettings?: pulumi.Input<inputs.compute.v20201201.LinuxPatchSettingsArgs>;
    /**
     ...
     */
    ssh?: pulumi.Input<inputs.compute.v20201201.SshConfigurationArgs>;
}
...
export interface LinuxPatchSettingsArgs {
     ...
     */
    patchMode?: pulumi.Input<string | enums.compute.v20201201.LinuxVMGuestPatchMode>;
}
...
export interface NetworkProfileArgs {
     ...
     */
    networkInterfaces?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.NetworkInterfaceReferenceArgs>[]>;
}
...
export interface OSDiskArgs {
     ...
     */
    diffDiskSettings?: pulumi.Input<inputs.compute.v20201201.DiffDiskSettingsArgs>;
    /**
     * Specifies the size of an empty data disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual machine image. <br><br> This value cannot be larger than 1023 GB
     */
    diskSizeGB?: pulumi.Input<number>;
     ...
     */
    encryptionSettings?: pulumi.Input<inputs.compute.v20201201.DiskEncryptionSettingsArgs>;
    /**
     * The source user image virtual hard disk. The virtual hard disk will be copied before being attached to the virtual machine. If SourceImage is provided, the destination virtual hard drive must not exist.
     */
    image?: pulumi.Input<inputs.compute.v20201201.VirtualHardDiskArgs>;
...
export interface OSProfileArgs {
     ...
     * Specifies the Linux operating system settings on the virtual machine. <br><br>For a list of supported Linux distributions, see [Linux on Azure-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-endorsed-distros?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) <br><br> For running non-endorsed distributions, see [Information for Non-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-create-upload-generic?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
     */
    linuxConfiguration?: pulumi.Input<inputs.compute.v20201201.LinuxConfigurationArgs>;
    /**
     ...
     */
    secrets?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.VaultSecretGroupArgs>[]>;
    /**
     * Specifies Windows operating system settings on the virtual machine.
     */
    windowsConfiguration?: pulumi.Input<inputs.compute.v20201201.WindowsConfigurationArgs>;
}
...
export interface PatchSettingsArgs {
     ...
     */
    patchMode?: pulumi.Input<string | enums.compute.v20201201.WindowsVMGuestPatchMode>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.compute.v20201201.PrivateEndpointServiceConnectionStatus>;
}
...
export interface ScaleInPolicyArgs {
     ...
     */
    rules?: pulumi.Input<pulumi.Input<string | enums.compute.v20201201.VirtualMachineScaleSetScaleInRules>[]>;
}
...
export interface ScheduledEventsProfileArgs {
     ...
     */
    terminateNotificationProfile?: pulumi.Input<inputs.compute.v20201201.TerminateNotificationProfileArgs>;
}
...
export interface SecurityProfileArgs {
     ...
     */
    securityType?: pulumi.Input<string | enums.compute.v20201201.SecurityTypes>;
    /**
     ...
     */
    uefiSettings?: pulumi.Input<inputs.compute.v20201201.UefiSettingsArgs>;
}
...
export interface SnapshotSkuArgs {
     ...
     * The sku name.
     */
    name?: pulumi.Input<string | enums.compute.v20201201.SnapshotStorageAccountTypes>;
}
...
export interface SshConfigurationArgs {
     ...
     */
    publicKeys?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.SshPublicKeyArgs>[]>;
}
...
export interface StorageProfileArgs {
     ...
     * Specifies the parameters that are used to add a data disk to a virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.DataDiskArgs>[]>;
    /**
     * Specifies information about the image to use. You can specify information about platform images, marketplace images, or virtual machine images. This element is required when you want to use a platform image, marketplace image, or virtual machine image, but is not used in other creation operations.
     */
    imageReference?: pulumi.Input<inputs.compute.v20201201.ImageReferenceArgs>;
    /**
     * Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
     */
    osDisk?: pulumi.Input<inputs.compute.v20201201.OSDiskArgs>;
}
...
export interface UpgradePolicyArgs {
     ...
     */
    automaticOSUpgradePolicy?: pulumi.Input<inputs.compute.v20201201.AutomaticOSUpgradePolicyArgs>;
    /**
     * Specifies the mode of an upgrade to virtual machines in the scale set.<br /><br /> Possible values are:<br /><br /> **Manual** - You  control the application of updates to virtual machines in the scale set. You do this by using the manualUpgrade action.<br /><br /> **Automatic** - All virtual machines in the scale set are  automatically updated at the same time.
     */
    mode?: pulumi.Input<enums.compute.v20201201.UpgradeMode>;
    /**
     * The configuration parameters used while performing a rolling upgrade.
     */
    rollingUpgradePolicy?: pulumi.Input<inputs.compute.v20201201.RollingUpgradePolicyArgs>;
}
...
export interface VaultSecretGroupArgs {
     ...
     */
    vaultCertificates?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.VaultCertificateArgs>[]>;
}
...
export interface VirtualMachineExtensionInstanceViewArgs {
     ...
     */
    statuses?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.InstanceViewStatusArgs>[]>;
    /**
     * The resource status information.
     */
    substatuses?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.InstanceViewStatusArgs>[]>;
    /**
...
export interface VirtualMachineIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.compute.v20201201.ResourceIdentityType>;
    /**
...
export interface VirtualMachineScaleSetDataDiskArgs {
     ...
     * The managed disk parameters.
     */
    managedDisk?: pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetManagedDiskParametersArgs>;
    /**
     * The disk name.
     */
    name?: pulumi.Input<string>;
...
export interface VirtualMachineScaleSetExtensionProfileArgs {
     ...
     */
    extensions?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetExtensionArgs>[]>;
    /**
...
export interface VirtualMachineScaleSetIPConfigurationArgs {
     ...
     */
    applicationGatewayBackendAddressPools?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.SubResourceArgs>[]>;
    /**
     * Specifies an array of references to application security group.
     */
    applicationSecurityGroups?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.SubResourceArgs>[]>;
    /**
     * Resource Id
     */
    id?: pulumi.Input<string>;
     ...
     */
    loadBalancerBackendAddressPools?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.SubResourceArgs>[]>;
    /**
     * Specifies an array of references to inbound Nat pools of the load balancers. A scale set can reference inbound nat pools of one public and one internal load balancer. Multiple scale sets cannot use the same basic sku load balancer.
     */
    loadBalancerInboundNatPools?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.SubResourceArgs>[]>;
    /**
     ...
     */
    privateIPAddressVersion?: pulumi.Input<string | enums.compute.v20201201.IPVersion>;
    /**
     * The publicIPAddressConfiguration.
     */
    publicIPAddressConfiguration?: pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetPublicIPAddressConfigurationArgs>;
    /**
     * Specifies the identifier of the subnet.
     */
    subnet?: pulumi.Input<inputs.compute.v20201201.ApiEntityReferenceArgs>;
}
...
export interface VirtualMachineScaleSetNetworkConfigurationArgs {
     ...
     */
    dnsSettings?: pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetNetworkConfigurationDnsSettingsArgs>;
    /**
     ...
     */
    ipConfigurations: pulumi.Input<pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetIPConfigurationArgs>[]>;
    /**
     ...
     */
    networkSecurityGroup?: pulumi.Input<inputs.compute.v20201201.SubResourceArgs>;
    /**
     * Specifies the primary network interface in case the virtual machine has more than 1 network interface.
     */
    primary?: pulumi.Input<boolean>;
...
export interface VirtualMachineScaleSetNetworkProfileArgs {
     ...
     */
    healthProbe?: pulumi.Input<inputs.compute.v20201201.ApiEntityReferenceArgs>;
    /**
     * The list of network configurations.
     */
    networkInterfaceConfigurations?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetNetworkConfigurationArgs>[]>;
}
...
export interface VirtualMachineScaleSetPublicIPAddressConfigurationArgs {
     ...
     */
    dnsSettings?: pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettingsArgs>;
    /**
     ...
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetIpTagArgs>[]>;
    /**
     ...
     */
    publicIPAddressVersion?: pulumi.Input<string | enums.compute.v20201201.IPVersion>;
    /**
     * The PublicIPPrefix from which to allocate publicIP addresses.
     */
    publicIPPrefix?: pulumi.Input<inputs.compute.v20201201.SubResourceArgs>;
}
...
export interface VirtualMachineScaleSetStorageProfileArgs {
     ...
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetDataDiskArgs>[]>;
    /**
     * Specifies information about the image to use. You can specify information about platform images, marketplace images, or virtual machine images. This element is required when you want to use a platform image, marketplace image, or virtual machine image, but is not used in other creation operations.
     */
    imageReference?: pulumi.Input<inputs.compute.v20201201.ImageReferenceArgs>;
     ...
     */
    osDisk?: pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetOSDiskArgs>;
}
...
export interface VirtualMachineScaleSetVMProfileArgs {
     ...
     */
    extensionProfile?: pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetExtensionProfileArgs>;
    /**
     ...
     */
    networkProfile?: pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetNetworkProfileArgs>;
    /**
     * Specifies the operating system settings for the virtual machines in the scale set.
     */
    osProfile?: pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetOSProfileArgs>;
    /**
     ...
     */
    scheduledEventsProfile?: pulumi.Input<inputs.compute.v20201201.ScheduledEventsProfileArgs>;
    /**
     ...
     * Specifies the storage settings for the virtual machine disks.
     */
    storageProfile?: pulumi.Input<inputs.compute.v20201201.VirtualMachineScaleSetStorageProfileArgs>;
}
...
export interface WinRMConfigurationArgs {
     ...
     */
    listeners?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.WinRMListenerArgs>[]>;
}
...
export interface WinRMListenerArgs {
     ...
     */
    protocol?: pulumi.Input<enums.compute.v20201201.ProtocolTypes>;
}
...
export interface WindowsConfigurationArgs {
     ...
     */
    additionalUnattendContent?: pulumi.Input<pulumi.Input<inputs.compute.v20201201.AdditionalUnattendContentArgs>[]>;
    /**
     ...
     */
    patchSettings?: pulumi.Input<inputs.compute.v20201201.PatchSettingsArgs>;
    /**
     * Indicates whether virtual machine agent should be provisioned on the virtual machine. <br><br> When this property is not specified in the request body, default behavior is to set it to true.  This will ensure that VM Agent is installed on the VM so that extensions can be added to the VM later.
     */
    provisionVMAgent?: pulumi.Input<boolean>;
     ...
     */
    winRM?: pulumi.Input<inputs.compute.v20201201.WinRMConfigurationArgs>;
}
