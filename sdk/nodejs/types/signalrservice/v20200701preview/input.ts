...
export interface ManagedIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.signalrservice.v20200701preview.ManagedIdentityType>;
    /**
...
export interface NetworkACLArgs {
     ...
     */
    allow?: pulumi.Input<pulumi.Input<string | enums.signalrservice.v20200701preview.SignalRRequestType>[]>;
    /**
     * Denied request types. The value can be one or more of: ClientConnection, ServerConnection, RESTAPI.
     */
    deny?: pulumi.Input<pulumi.Input<string | enums.signalrservice.v20200701preview.SignalRRequestType>[]>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.signalrservice.v20200701preview.PrivateLinkServiceConnectionStatus>;
}
...
export interface ResourceSkuArgs {
     ...
     */
    tier?: pulumi.Input<string | enums.signalrservice.v20200701preview.SignalRSkuTier>;
}
...
export interface ServerlessUpstreamSettingsArgs {
     ...
     */
    templates?: pulumi.Input<pulumi.Input<inputs.signalrservice.v20200701preview.UpstreamTemplateArgs>[]>;
}
...
export interface SignalRFeatureArgs {
     ...
     */
    flag: pulumi.Input<string | enums.signalrservice.v20200701preview.FeatureFlags>;
    /**
...
export interface SignalRNetworkACLsArgs {
     ...
     */
    defaultAction?: pulumi.Input<string | enums.signalrservice.v20200701preview.ACLAction>;
    /**
     * ACLs for requests from private endpoints
     */
    privateEndpoints?: pulumi.Input<pulumi.Input<inputs.signalrservice.v20200701preview.PrivateEndpointACLArgs>[]>;
    /**
     * ACL for requests from public network
     */
    publicNetwork?: pulumi.Input<inputs.signalrservice.v20200701preview.NetworkACLArgs>;
}
/**
...
export interface UpstreamAuthSettingsArgs {
     ...
     */
    managedIdentity?: pulumi.Input<inputs.signalrservice.v20200701preview.ManagedIdentitySettingsArgs>;
    /**
     * Gets or sets the type of auth. None or ManagedIdentity is supported now.
     */
    type?: pulumi.Input<string | enums.signalrservice.v20200701preview.UpstreamAuthType>;
}
...
export interface UpstreamTemplateArgs {
     ...
     */
    auth?: pulumi.Input<inputs.signalrservice.v20200701preview.UpstreamAuthSettingsArgs>;
    /**
