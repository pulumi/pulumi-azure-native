...
export interface ManagedIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.signalrservice.v20210601preview.ManagedIdentityType>;
    /**
...
export interface NetworkACLArgs {
     ...
     */
    allow?: pulumi.Input<pulumi.Input<string | enums.signalrservice.v20210601preview.SignalRRequestType>[]>;
    /**
     * Denied request types. The value can be one or more of: ClientConnection, ServerConnection, RESTAPI.
     */
    deny?: pulumi.Input<pulumi.Input<string | enums.signalrservice.v20210601preview.SignalRRequestType>[]>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.signalrservice.v20210601preview.PrivateLinkServiceConnectionStatus>;
}
...
export interface ResourceSkuArgs {
     ...
     */
    tier?: pulumi.Input<string | enums.signalrservice.v20210601preview.SignalRSkuTier>;
}
...
export interface ServerlessUpstreamSettingsArgs {
     ...
     */
    templates?: pulumi.Input<pulumi.Input<inputs.signalrservice.v20210601preview.UpstreamTemplateArgs>[]>;
}
...
export interface SignalRFeatureArgs {
     ...
     */
    flag: pulumi.Input<string | enums.signalrservice.v20210601preview.FeatureFlags>;
    /**
...
export interface SignalRNetworkACLsArgs {
     ...
     */
    defaultAction?: pulumi.Input<string | enums.signalrservice.v20210601preview.ACLAction>;
    /**
     * ACLs for requests from private endpoints
     */
    privateEndpoints?: pulumi.Input<pulumi.Input<inputs.signalrservice.v20210601preview.PrivateEndpointACLArgs>[]>;
    /**
     * ACL for requests from public network
     */
    publicNetwork?: pulumi.Input<inputs.signalrservice.v20210601preview.NetworkACLArgs>;
}
/**
...
export interface UpstreamAuthSettingsArgs {
     ...
     */
    managedIdentity?: pulumi.Input<inputs.signalrservice.v20210601preview.ManagedIdentitySettingsArgs>;
    /**
     * Gets or sets the type of auth. None or ManagedIdentity is supported now.
     */
    type?: pulumi.Input<string | enums.signalrservice.v20210601preview.UpstreamAuthType>;
}
...
export interface UpstreamTemplateArgs {
     ...
     */
    auth?: pulumi.Input<inputs.signalrservice.v20210601preview.UpstreamAuthSettingsArgs>;
    /**
