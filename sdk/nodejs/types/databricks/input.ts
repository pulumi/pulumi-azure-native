...
export interface EncryptionArgs {
     ...
     */
    keySource?: pulumi.Input<string | enums.databricks.KeySource>;
    /**
     * The Uri of KeyVault.
     */
...
export interface IdentityDataArgs {
     ...
     * The identity type.
     */
    type: pulumi.Input<string | enums.databricks.IdentityType>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status: pulumi.Input<string | enums.databricks.PrivateLinkServiceConnectionStatus>;
}
...
export interface WorkspaceCustomParametersArgs {
     ...
     */
    enableNoPublicIp?: pulumi.Input<inputs.databricks.WorkspaceCustomBooleanParameterArgs>;
    /**
...
export function workspaceCustomParametersArgsProvideDefaults(val: WorkspaceCustomParametersArgs): WorkspaceCustomParametersArgs {
    return {
        ...val,
        encryption: (val.encryption ? pulumi.output(val.encryption).apply(inputs.databricks.workspaceEncryptionParameterArgsProvideDefaults) : undefined),
    };
}
...
export interface WorkspaceEncryptionParameterArgs {
     ...
     * The value which should be used for this field.
     */
    value?: pulumi.Input<inputs.databricks.EncryptionArgs>;
}
/**
...
export function workspaceEncryptionParameterArgsProvideDefaults(val: WorkspaceEncryptionParameterArgs): WorkspaceEncryptionParameterArgs {
    return {
        ...val,
        value: (val.value ? pulumi.output(val.value).apply(inputs.databricks.encryptionArgsProvideDefaults) : undefined),
    };
}
