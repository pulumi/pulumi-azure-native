...
export interface AcsClusterPropertiesArgs {
     ...
     */
    agentVmSize?: pulumi.Input<string | enums.machinelearningcompute.v20170601preview.AgentVMSizeTypes>;
    /**
     * Orchestrator specific properties
     */
    orchestratorProperties: pulumi.Input<inputs.machinelearningcompute.v20170601preview.KubernetesClusterPropertiesArgs>;
    /**
     * Type of orchestrator. It cannot be changed once the cluster is created.
     */
    orchestratorType: pulumi.Input<string | enums.machinelearningcompute.v20170601preview.Orchestrator>;
    /**
     * The system services deployed to the cluster
     */
    systemServices?: pulumi.Input<pulumi.Input<string | enums.machinelearningcompute.v20170601preview.SystemServices>[]>;
}
/**
 ...
 */
export interface AppInsightsCredentialsArgs {
    /**
...
export interface AutoScaleConfigurationArgs {
     ...
     */
    status?: pulumi.Input<string | enums.machinelearningcompute.v20170601preview.Status>;
    /**
...
export interface GlobalServiceConfigurationArgs {
     ...
     */
    autoScale?: pulumi.Input<inputs.machinelearningcompute.v20170601preview.AutoScaleConfigurationArgs>;
    /**
     ...
     */
    serviceAuth?: pulumi.Input<inputs.machinelearningcompute.v20170601preview.ServiceAuthConfigurationArgs>;
    /**
     * The SSL configuration properties
     */
    ssl?: pulumi.Input<inputs.machinelearningcompute.v20170601preview.SslConfigurationArgs>;
}
/**
...
export function globalServiceConfigurationArgsProvideDefaults(val: GlobalServiceConfigurationArgs): GlobalServiceConfigurationArgs {
    return {
        ...val,
        autoScale: (val.autoScale ? pulumi.output(val.autoScale).apply(inputs.machinelearningcompute.v20170601preview.autoScaleConfigurationArgsProvideDefaults) : undefined),
        ssl: (val.ssl ? pulumi.output(val.ssl).apply(inputs.machinelearningcompute.v20170601preview.sslConfigurationArgsProvideDefaults) : undefined),
    };
}
...
export interface KubernetesClusterPropertiesArgs {
     ...
     */
    servicePrincipal: pulumi.Input<inputs.machinelearningcompute.v20170601preview.ServicePrincipalPropertiesArgs>;
}
