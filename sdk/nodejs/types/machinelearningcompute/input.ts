...
export interface AcsClusterPropertiesArgs {
     ...
     */
    agentVmSize?: pulumi.Input<string | enums.machinelearningcompute.AgentVMSizeTypes>;
    /**
     ...
     */
    orchestratorProperties?: pulumi.Input<inputs.machinelearningcompute.KubernetesClusterPropertiesArgs>;
    /**
     * Type of orchestrator. It cannot be changed once the cluster is created.
     */
    orchestratorType: pulumi.Input<string | enums.machinelearningcompute.OrchestratorType>;
    /**
     * The system services deployed to the cluster
     */
    systemServices?: pulumi.Input<pulumi.Input<inputs.machinelearningcompute.SystemServiceArgs>[]>;
}
/**
...
export interface AutoScaleConfigurationArgs {
     ...
     */
    status?: pulumi.Input<string | enums.machinelearningcompute.Status>;
    /**
...
export interface GlobalServiceConfigurationArgs {
     ...
     */
    autoScale?: pulumi.Input<inputs.machinelearningcompute.AutoScaleConfigurationArgs>;
    /**
     ...
     */
    serviceAuth?: pulumi.Input<inputs.machinelearningcompute.ServiceAuthConfigurationArgs>;
    /**
     * The SSL configuration properties
     */
    ssl?: pulumi.Input<inputs.machinelearningcompute.SslConfigurationArgs>;
}
/**
...
export function globalServiceConfigurationArgsProvideDefaults(val: GlobalServiceConfigurationArgs): GlobalServiceConfigurationArgs {
    return {
        ...val,
        autoScale: (val.autoScale ? pulumi.output(val.autoScale).apply(inputs.machinelearningcompute.autoScaleConfigurationArgsProvideDefaults) : undefined),
        ssl: (val.ssl ? pulumi.output(val.ssl).apply(inputs.machinelearningcompute.sslConfigurationArgsProvideDefaults) : undefined),
    };
}
...
export interface KubernetesClusterPropertiesArgs {
     ...
     */
    servicePrincipal?: pulumi.Input<inputs.machinelearningcompute.ServicePrincipalPropertiesArgs>;
}
...
export interface SystemServiceArgs {
     ...
     */
    systemServiceType: pulumi.Input<string | enums.machinelearningcompute.SystemServiceType>;
}
