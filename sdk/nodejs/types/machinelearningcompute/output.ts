...
export interface AcsClusterPropertiesResponse {
     ...
     */
    orchestratorProperties?: outputs.machinelearningcompute.KubernetesClusterPropertiesResponse;
    /**
     ...
     */
    systemServices?: outputs.machinelearningcompute.SystemServiceResponse[];
}
/**
...
export interface ContainerServiceCredentialsResponse {
     ...
     */
    servicePrincipalConfiguration: outputs.machinelearningcompute.ServicePrincipalPropertiesResponse;
}
...
export interface ErrorResponseResponse {
     ...
     */
    details?: outputs.machinelearningcompute.ErrorDetailResponse[];
    /**
     * Error message.
     */
    message: string;
...
export interface ErrorResponseWrapperResponse {
     ...
     * The error response.
     */
    error?: outputs.machinelearningcompute.ErrorResponseResponse;
}
...
export interface GlobalServiceConfigurationResponse {
     ...
     */
    autoScale?: outputs.machinelearningcompute.AutoScaleConfigurationResponse;
    /**
     ...
     */
    serviceAuth?: outputs.machinelearningcompute.ServiceAuthConfigurationResponse;
    /**
     * The SSL configuration properties
     */
    ssl?: outputs.machinelearningcompute.SslConfigurationResponse;
}
/**
...
export function globalServiceConfigurationResponseProvideDefaults(val: GlobalServiceConfigurationResponse): GlobalServiceConfigurationResponse {
    return {
        ...val,
        autoScale: (val.autoScale ? outputs.machinelearningcompute.autoScaleConfigurationResponseProvideDefaults(val.autoScale) : undefined),
        ssl: (val.ssl ? outputs.machinelearningcompute.sslConfigurationResponseProvideDefaults(val.ssl) : undefined),
    };
}
...
export interface KubernetesClusterPropertiesResponse {
     ...
     */
    servicePrincipal?: outputs.machinelearningcompute.ServicePrincipalPropertiesResponse;
}
