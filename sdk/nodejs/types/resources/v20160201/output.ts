...
export interface AliasTypeResponse {
     ...
     */
    paths?: outputs.resources.v20160201.AliasPathTypeResponse[];
}
...
export interface DependencyResponse {
     ...
     */
    dependsOn?: outputs.resources.v20160201.BasicDependencyResponse[];
    /**
     * The ID of the dependency.
     */
    id?: string;
...
export interface DeploymentPropertiesExtendedResponse {
     ...
     */
    dependencies?: outputs.resources.v20160201.DependencyResponse[];
    /**
     * The deployment error.
     */
    error: outputs.resources.v20160201.ErrorResponseResponse;
    /**
     * The deployment mode.
     */
    mode?: string;
     ...
     */
    parametersLink?: outputs.resources.v20160201.ParametersLinkResponse;
    /**
     * The list of resource providers needed for the deployment.
     */
    providers?: outputs.resources.v20160201.ProviderResponse[];
    /**
     ...
     */
    templateLink?: outputs.resources.v20160201.TemplateLinkResponse;
    /**
...
export interface ErrorResponseResponse {
     ...
     */
    additionalInfo: outputs.resources.v20160201.ErrorAdditionalInfoResponse[];
    /**
     * The error code.
     */
    code: string;
     ...
     * The error details.
     */
    details: outputs.resources.v20160201.ErrorResponseResponse[];
    /**
     * The error message.
     */
    message: string;
...
export interface ProviderResourceTypeResponse {
     ...
     */
    aliases?: outputs.resources.v20160201.AliasTypeResponse[];
    /**
     * The api version.
     */
    apiVersions?: string[];
...
export interface ProviderResponse {
     ...
     */
    resourceTypes?: outputs.resources.v20160201.ProviderResourceTypeResponse[];
}
