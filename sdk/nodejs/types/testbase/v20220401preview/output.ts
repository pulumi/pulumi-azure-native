...
export interface BillingHubPackageUsageResponse {
    ...
    usageEntriesGroupedByUpdateType?: outputs.testbase.v20220401preview.BillingHubUsageGroupedByUpdateTypeResponse[];
}

export interface BillingHubUsageGroupResponse {
    executionUsageDetails?: outputs.testbase.v20220401preview.BillingHubExecutionUsageDetailResponse[];
    osBuild?: string;
...
export interface BillingHubUsageGroupedByUpdateTypeResponse {
    ...
    totalUsedFreeHours?: number;
    updateType?: string;
    usageGroups?: outputs.testbase.v20220401preview.BillingHubUsageGroupResponse[];
}
...
export interface NotificationEventReceiverResponse {
     ...
     */
    receiverValue?: outputs.testbase.v20220401preview.NotificationReceiverValueResponse;
}
...
export interface NotificationReceiverValueResponse {
     ...
     * The user object receiver value.
     */
    distributionGroupListReceiverValue?: outputs.testbase.v20220401preview.DistributionGroupListReceiverValueResponse;
    /**
     * The user object receiver value.
     */
    subscriptionReceiverValue?: outputs.testbase.v20220401preview.SubscriptionReceiverValueResponse;
    /**
     * The user object receiver value.
     */
    userObjectReceiverValue?: outputs.testbase.v20220401preview.UserObjectReceiverValueResponse;
}
...
export interface TestBaseAccountSKUResponse {
     ...
     */
    capabilities: outputs.testbase.v20220401preview.TestBaseAccountSKUCapabilityResponse[];
    /**
...
export interface TestResponse {
     ...
     */
    commands: outputs.testbase.v20220401preview.CommandResponse[];
    /**
