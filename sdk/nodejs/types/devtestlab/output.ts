...
export * as v20150521preview from "./v20150521preview/output";
export * as v20160515 from "./v20160515/output";
export * as v20180915 from "./v20180915/output";
/**
...
export function applicableScheduleResponseProvideDefaults(val: ApplicableScheduleResponse): ApplicableScheduleResponse {
    return {
        ...val,
        labVmsShutdown: (val.labVmsShutdown ? outputs.devtestlab.scheduleResponseProvideDefaults(val.labVmsShutdown) : undefined),
        labVmsStartup: (val.labVmsStartup ? outputs.devtestlab.scheduleResponseProvideDefaults(val.labVmsStartup) : undefined),
    };
}
...
export function scheduleCreationParameterResponseProvideDefaults(val: ScheduleCreationParameterResponse): ScheduleCreationParameterResponse {
    return {
        ...val,
        notificationSettings: (val.notificationSettings ? outputs.devtestlab.notificationSettingsResponseProvideDefaults(val.notificationSettings) : undefined),
        status: (val.status) ?? "Disabled",
    };
}
