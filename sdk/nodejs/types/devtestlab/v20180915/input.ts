...
export interface ArtifactInstallPropertiesArgs {
     ...
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.devtestlab.v20180915.ArtifactParameterPropertiesArgs>[]>;
    /**
...
export interface CustomImagePropertiesCustomArgs {
     ...
     */
    osType: pulumi.Input<string | enums.devtestlab.v20180915.CustomImageOsType>;
    /**
...
export interface CustomImagePropertiesFromVmArgs {
     ...
     */
    linuxOsInfo?: pulumi.Input<inputs.devtestlab.v20180915.LinuxOsInfoArgs>;
    /**
     ...
     */
    windowsOsInfo?: pulumi.Input<inputs.devtestlab.v20180915.WindowsOsInfoArgs>;
}
...
export interface DataDiskPropertiesArgs {
     ...
     */
    attachNewDataDiskOptions?: pulumi.Input<inputs.devtestlab.v20180915.AttachNewDataDiskOptionsArgs>;
    /**
     ...
     */
    hostCaching?: pulumi.Input<string | enums.devtestlab.v20180915.HostCachingOptions>;
}
...
export interface DataDiskStorageTypeInfoArgs {
     ...
     * Disk Storage Type
     */
    storageType?: pulumi.Input<string | enums.devtestlab.v20180915.StorageType>;
}
...
export interface EnvironmentDeploymentPropertiesArgs {
     ...
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.devtestlab.v20180915.ArmTemplateParameterPropertiesArgs>[]>;
}
...
export interface EventArgs {
     ...
     */
    eventName?: pulumi.Input<string | enums.devtestlab.v20180915.NotificationChannelEventType>;
}
...
export interface IdentityPropertiesArgs {
     ...
     * Managed identity.
     */
    type?: pulumi.Input<string | enums.devtestlab.v20180915.ManagedIdentityType>;
}
...
export interface InboundNatRuleArgs {
     ...
     */
    transportProtocol?: pulumi.Input<string | enums.devtestlab.v20180915.TransportProtocol>;
}
...
export interface LabAnnouncementPropertiesArgs {
     ...
     */
    enabled?: pulumi.Input<string | enums.devtestlab.v20180915.EnableStatus>;
    /**
...
export interface LabVirtualMachineCreationParameterArgs {
     ...
     */
    artifacts?: pulumi.Input<pulumi.Input<inputs.devtestlab.v20180915.ArtifactInstallPropertiesArgs>[]>;
    /**
     * The number of virtual machine instances to create.
     */
    bulkCreationParameters?: pulumi.Input<inputs.devtestlab.v20180915.BulkCreationParametersArgs>;
    /**
     ...
     */
    dataDiskParameters?: pulumi.Input<pulumi.Input<inputs.devtestlab.v20180915.DataDiskPropertiesArgs>[]>;
    /**
     ...
     */
    galleryImageReference?: pulumi.Input<inputs.devtestlab.v20180915.GalleryImageReferenceArgs>;
    /**
     ...
     */
    networkInterface?: pulumi.Input<inputs.devtestlab.v20180915.NetworkInterfacePropertiesArgs>;
    /**
     ...
     */
    scheduleParameters?: pulumi.Input<pulumi.Input<inputs.devtestlab.v20180915.ScheduleCreationParameterArgs>[]>;
    /**
...
export interface LinuxOsInfoArgs {
     ...
     */
    linuxOsState?: pulumi.Input<string | enums.devtestlab.v20180915.LinuxOsState>;
}
...
export interface NetworkInterfacePropertiesArgs {
     ...
     */
    sharedPublicIpAddressConfiguration?: pulumi.Input<inputs.devtestlab.v20180915.SharedPublicIpAddressConfigurationArgs>;
    /**
...
export function scheduleCreationParameterArgsProvideDefaults(val: ScheduleCreationParameterArgs): ScheduleCreationParameterArgs {
    return {
        ...val,
        notificationSettings: (val.notificationSettings ? pulumi.output(val.notificationSettings).apply(inputs.devtestlab.v20180915.notificationSettingsArgsProvideDefaults) : undefined),
        status: (val.status) ?? "Disabled",
    };
}
...
export interface SharedPublicIpAddressConfigurationArgs {
     ...
     */
    inboundNatRules?: pulumi.Input<pulumi.Input<inputs.devtestlab.v20180915.InboundNatRuleArgs>[]>;
}
...
export interface SubnetArgs {
     ...
     */
    allowPublicIp?: pulumi.Input<string | enums.devtestlab.v20180915.UsagePermissionType>;
    /**
...
export interface SubnetOverrideArgs {
     ...
     */
    sharedPublicIpAddressConfiguration?: pulumi.Input<inputs.devtestlab.v20180915.SubnetSharedPublicIpAddressConfigurationArgs>;
    /**
     * Indicates whether this subnet can be used during virtual machine creation (i.e. Allow, Deny).
     */
    useInVmCreationPermission?: pulumi.Input<string | enums.devtestlab.v20180915.UsagePermissionType>;
    /**
     * Indicates whether public IP addresses can be assigned to virtual machines on this subnet (i.e. Allow, Deny).
     */
    usePublicIpAddressPermission?: pulumi.Input<string | enums.devtestlab.v20180915.UsagePermissionType>;
    /**
...
export interface SubnetSharedPublicIpAddressConfigurationArgs {
     ...
     */
    allowedPorts?: pulumi.Input<pulumi.Input<inputs.devtestlab.v20180915.PortArgs>[]>;
}
...
export interface WindowsOsInfoArgs {
     ...
     */
    windowsOsState?: pulumi.Input<string | enums.devtestlab.v20180915.WindowsOsState>;
}
