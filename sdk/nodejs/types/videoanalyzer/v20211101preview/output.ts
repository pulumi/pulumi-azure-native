...
export interface AccountEncryptionResponse {
     ...
     */
    identity?: outputs.videoanalyzer.v20211101preview.ResourceIdentityResponse;
    /**
     * The properties of the key used to encrypt the account.
     */
    keyVaultProperties?: outputs.videoanalyzer.v20211101preview.KeyVaultPropertiesResponse;
    /**
...
export interface EncoderCustomPresetResponse {
     ...
     */
    audioEncoder?: outputs.videoanalyzer.v20211101preview.AudioEncoderAacResponse;
    /**
     * The discriminator for derived types.
     ...
     */
    videoEncoder?: outputs.videoanalyzer.v20211101preview.VideoEncoderH264Response;
}
...
export interface EncoderProcessorResponse {
     ...
     */
    inputs: outputs.videoanalyzer.v20211101preview.NodeInputResponse[];
    /**
     ...
     */
    preset: outputs.videoanalyzer.v20211101preview.EncoderCustomPresetResponse | outputs.videoanalyzer.v20211101preview.EncoderSystemPresetResponse;
    /**
     * The discriminator for derived types.
...
export interface JwtAuthenticationResponse {
     ...
     */
    claims?: outputs.videoanalyzer.v20211101preview.TokenClaimResponse[];
    /**
     ...
     */
    keys?: (outputs.videoanalyzer.v20211101preview.EccTokenKeyResponse | outputs.videoanalyzer.v20211101preview.RsaTokenKeyResponse)[];
    /**
     * The discriminator for derived types.
...
export interface NetworkAccessControlResponse {
     ...
     */
    consumption?: outputs.videoanalyzer.v20211101preview.GroupLevelAccessControlResponse;
    /**
     * Public network access for ingestion group.
     */
    ingestion?: outputs.videoanalyzer.v20211101preview.GroupLevelAccessControlResponse;
    /**
     * Public network access for integration group.
     */
    integration?: outputs.videoanalyzer.v20211101preview.GroupLevelAccessControlResponse;
}
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.videoanalyzer.v20211101preview.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: outputs.videoanalyzer.v20211101preview.PrivateLinkServiceConnectionStateResponse;
    /**
     ...
     */
    systemData: outputs.videoanalyzer.v20211101preview.SystemDataResponse;
    /**
...
export interface RtspSourceResponse {
     ...
     */
    endpoint: outputs.videoanalyzer.v20211101preview.TlsEndpointResponse | outputs.videoanalyzer.v20211101preview.UnsecuredEndpointResponse;
    /**
     * Node name. Must be unique within the topology.
     */
    name: string;
...
export interface TlsEndpointResponse {
     ...
     */
    credentials: outputs.videoanalyzer.v20211101preview.UsernamePasswordCredentialsResponse;
    /**
     * List of trusted certificate authorities when authenticating a TLS connection. A null list designates that Azure Video Analyzer's list of trusted authorities should be used.
     */
    trustedCertificates?: outputs.videoanalyzer.v20211101preview.PemCertificateListResponse;
    /**
     * Describes the tunnel through which Video Analyzer can connect to the endpoint URL. This is an optional property, typically used when the endpoint is behind a firewall.
     */
    tunnel?: outputs.videoanalyzer.v20211101preview.SecureIotDeviceRemoteTunnelResponse;
    /**
     * The discriminator for derived types.
     ...
     */
    validationOptions?: outputs.videoanalyzer.v20211101preview.TlsValidationOptionsResponse;
}
...
export interface VideoAnalyzerIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.videoanalyzer.v20211101preview.UserAssignedManagedIdentityResponse};
}
...
export interface VideoContentUrlsResponse {
     ...
     */
    previewImageUrls?: outputs.videoanalyzer.v20211101preview.VideoPreviewImageUrlsResponse;
    /**
...
export interface VideoEncoderH264Response {
     ...
     */
    scale?: outputs.videoanalyzer.v20211101preview.VideoScaleResponse;
    /**
     * The discriminator for derived types.
...
export interface VideoSinkResponse {
     ...
     */
    videoCreationProperties?: outputs.videoanalyzer.v20211101preview.VideoCreationPropertiesResponse;
    /**
     ...
     */
    videoPublishingOptions?: outputs.videoanalyzer.v20211101preview.VideoPublishingOptionsResponse;
}
...
export interface VideoSourceResponse {
     ...
     */
    timeSequences: outputs.videoanalyzer.v20211101preview.VideoSequenceAbsoluteTimeMarkersResponse;
    /**
     * The discriminator for derived types.
