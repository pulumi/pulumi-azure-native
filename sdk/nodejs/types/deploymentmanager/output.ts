...
export interface CloudErrorBodyResponse {
     ...
     */
    details?: outputs.deploymentmanager.CloudErrorBodyResponse[];
    /**
...
export interface HealthCheckStepPropertiesResponse {
     ...
     */
    attributes: outputs.deploymentmanager.RestHealthCheckStepAttributesResponse;
    /**
     * The type of step.
...
export interface RestHealthCheckResponse {
     ...
     */
    request: outputs.deploymentmanager.RestRequestResponse;
    /**
     ...
     */
    response?: outputs.deploymentmanager.RestResponseResponse;
}
...
export interface RestHealthCheckStepAttributesResponse {
     ...
     */
    healthChecks: outputs.deploymentmanager.RestHealthCheckResponse[];
    /**
...
export interface RestRequestResponse {
     ...
     */
    authentication: outputs.deploymentmanager.ApiKeyAuthenticationResponse | outputs.deploymentmanager.RolloutIdentityAuthenticationResponse;
    /**
...
export interface RestResponseResponse {
     ...
     */
    regex?: outputs.deploymentmanager.RestResponseResponseRegex;
    /**
...
export interface RolloutOperationInfoResponse {
     ...
     */
    error: outputs.deploymentmanager.CloudErrorBodyResponse;
    /**
...
export interface RolloutStepResponse {
     ...
     */
    messages: outputs.deploymentmanager.MessageResponse[];
    /**
     * Name of the step.
     */
    name: string;
     ...
     */
    operationInfo: outputs.deploymentmanager.StepOperationInfoResponse;
    /**
     * Set of resource operations that were performed, if any, on an Azure resource.
     */
    resourceOperations: outputs.deploymentmanager.ResourceOperationResponse[];
    /**
...
export interface ServiceResponse {
     ...
     */
    serviceUnits?: outputs.deploymentmanager.ServiceUnitResponse[];
    /**
...
export interface ServiceUnitResponse {
     ...
     */
    artifacts?: outputs.deploymentmanager.ServiceUnitArtifactsResponse;
    /**
     ...
     */
    steps?: outputs.deploymentmanager.RolloutStepResponse[];
    /**
...
export interface StepGroupResponse {
     ...
     */
    postDeploymentSteps?: outputs.deploymentmanager.PrePostStepResponse[];
    /**
     * The list of steps to be run before deploying the target.
     */
    preDeploymentSteps?: outputs.deploymentmanager.PrePostStepResponse[];
}
...
export interface WaitStepPropertiesResponse {
     ...
     * The Wait attributes
     */
    attributes: outputs.deploymentmanager.WaitStepAttributesResponse;
    /**
     * The type of step.
