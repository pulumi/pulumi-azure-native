...
export interface ApiKeyAuthenticationArgs {
     ...
     */
    in: pulumi.Input<enums.deploymentmanager.v20191101preview.RestAuthLocation>;
    /**
...
export interface HealthCheckStepPropertiesArgs {
     ...
     */
    attributes: pulumi.Input<inputs.deploymentmanager.v20191101preview.RestHealthCheckStepAttributesArgs>;
    /**
     * The type of step.
...
export interface RestHealthCheckArgs {
     ...
     */
    request: pulumi.Input<inputs.deploymentmanager.v20191101preview.RestRequestArgs>;
    /**
     ...
     */
    response?: pulumi.Input<inputs.deploymentmanager.v20191101preview.RestResponseArgs>;
}
...
export interface RestHealthCheckStepAttributesArgs {
     ...
     */
    healthChecks: pulumi.Input<pulumi.Input<inputs.deploymentmanager.v20191101preview.RestHealthCheckArgs>[]>;
    /**
...
export interface RestRequestArgs {
     ...
     */
    authentication: pulumi.Input<inputs.deploymentmanager.v20191101preview.ApiKeyAuthenticationArgs | inputs.deploymentmanager.v20191101preview.RolloutIdentityAuthenticationArgs>;
    /**
     * The HTTP method to use for the request.
     */
    method: pulumi.Input<enums.deploymentmanager.v20191101preview.RestRequestMethod>;
    /**
...
export interface RestResponseArgs {
     ...
     */
    regex?: pulumi.Input<inputs.deploymentmanager.v20191101preview.RestResponseRegexArgs>;
    /**
...
export interface RestResponseRegexArgs {
     ...
     */
    matchQuantifier?: pulumi.Input<enums.deploymentmanager.v20191101preview.RestMatchQuantifier>;
    /**
...
export interface StepGroupArgs {
     ...
     */
    postDeploymentSteps?: pulumi.Input<pulumi.Input<inputs.deploymentmanager.v20191101preview.PrePostStepArgs>[]>;
    /**
     * The list of steps to be run before deploying the target.
     */
    preDeploymentSteps?: pulumi.Input<pulumi.Input<inputs.deploymentmanager.v20191101preview.PrePostStepArgs>[]>;
}
...
export interface WaitStepPropertiesArgs {
     ...
     * The Wait attributes
     */
    attributes: pulumi.Input<inputs.deploymentmanager.v20191101preview.WaitStepAttributesArgs>;
    /**
     * The type of step.
