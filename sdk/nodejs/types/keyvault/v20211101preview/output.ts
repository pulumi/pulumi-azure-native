...
export interface AccessPolicyEntryResponse {
     ...
     */
    permissions: outputs.keyvault.v20211101preview.PermissionsResponse;
    /**
...
export interface LifetimeActionResponse {
     ...
     */
    action?: outputs.keyvault.v20211101preview.ActionResponse;
    /**
     * The trigger of key rotation policy lifetimeAction.
     */
    trigger?: outputs.keyvault.v20211101preview.TriggerResponse;
}
...
export interface MHSMNetworkRuleSetResponse {
     ...
     */
    ipRules?: outputs.keyvault.v20211101preview.MHSMIPRuleResponse[];
    /**
     * The list of virtual network rules.
     */
    virtualNetworkRules?: outputs.keyvault.v20211101preview.MHSMVirtualNetworkRuleResponse[];
}
...
export interface MHSMPrivateEndpointConnectionItemResponse {
     ...
     */
    privateEndpoint?: outputs.keyvault.v20211101preview.MHSMPrivateEndpointResponse;
    /**
     * Approval state of the private link connection.
     */
    privateLinkServiceConnectionState?: outputs.keyvault.v20211101preview.MHSMPrivateLinkServiceConnectionStateResponse;
    /**
...
export interface ManagedHsmPropertiesResponse {
     ...
     */
    networkAcls?: outputs.keyvault.v20211101preview.MHSMNetworkRuleSetResponse;
    /**
     * List of private endpoint connections associated with the managed hsm pool.
     */
    privateEndpointConnections: outputs.keyvault.v20211101preview.MHSMPrivateEndpointConnectionItemResponse[];
    /**
     * Provisioning state.
     */
    provisioningState: string;
...
export interface NetworkRuleSetResponse {
     ...
     * The list of IP address rules.
     */
    ipRules?: outputs.keyvault.v20211101preview.IPRuleResponse[];
    /**
     * The list of virtual network rules.
     */
    virtualNetworkRules?: outputs.keyvault.v20211101preview.VirtualNetworkRuleResponse[];
}
...
export interface PrivateEndpointConnectionItemResponse {
     ...
     * Properties of the private endpoint object.
     */
    privateEndpoint?: outputs.keyvault.v20211101preview.PrivateEndpointResponse;
    /**
     * Approval state of the private link connection.
     */
    privateLinkServiceConnectionState?: outputs.keyvault.v20211101preview.PrivateLinkServiceConnectionStateResponse;
    /**
     * Provisioning state of the private endpoint connection.
     */
    provisioningState: string;
...
export interface RotationPolicyResponse {
     ...
     */
    attributes?: outputs.keyvault.v20211101preview.KeyRotationPolicyAttributesResponse;
    /**
     * The lifetimeActions for key rotation action.
     */
    lifetimeActions?: outputs.keyvault.v20211101preview.LifetimeActionResponse[];
}
...
export interface SecretPropertiesResponse {
     ...
     */
    attributes?: outputs.keyvault.v20211101preview.SecretAttributesResponse;
    /**
...
export interface VaultPropertiesResponse {
     ...
     */
    accessPolicies?: outputs.keyvault.v20211101preview.AccessPolicyEntryResponse[];
    /**
     ...
     * Rules governing the accessibility of the key vault from specific network locations.
     */
    networkAcls?: outputs.keyvault.v20211101preview.NetworkRuleSetResponse;
    /**
     * List of private endpoint connections associated with the key vault.
     */
    privateEndpointConnections: outputs.keyvault.v20211101preview.PrivateEndpointConnectionItemResponse[];
    /**
     ...
     * SKU details
     */
    sku: outputs.keyvault.v20211101preview.SkuResponse;
    /**
     * softDelete data retention days. It accepts >=7 and <=90.
     */
    softDeleteRetentionInDays?: number;
