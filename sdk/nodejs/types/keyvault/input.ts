...
export interface AccessPolicyEntryArgs {
     ...
     */
    permissions: pulumi.Input<inputs.keyvault.PermissionsArgs>;
    /**
...
export interface KeyPropertiesArgs {
     ...
     * The attributes of the key.
     */
    attributes?: pulumi.Input<inputs.keyvault.KeyAttributesArgs>;
    /**
     * The elliptic curve name. For valid values, see JsonWebKeyCurveName.
     */
    curveName?: pulumi.Input<string | enums.keyvault.JsonWebKeyCurveName>;
    keyOps?: pulumi.Input<pulumi.Input<string | enums.keyvault.JsonWebKeyOperation>[]>;
    /**
     ...
     */
    kty?: pulumi.Input<string | enums.keyvault.JsonWebKeyType>;
}
...
export interface MHSMNetworkRuleSetArgs {
     ...
     */
    bypass?: pulumi.Input<string | enums.keyvault.NetworkRuleBypassOptions>;
    /**
     * The default action when no rule from ipRules and from virtualNetworkRules match. This is only used after the bypass property has been evaluated.
     */
    defaultAction?: pulumi.Input<string | enums.keyvault.NetworkRuleAction>;
    /**
     * The list of IP address rules.
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.keyvault.MHSMIPRuleArgs>[]>;
    /**
     * The list of virtual network rules.
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.keyvault.MHSMVirtualNetworkRuleArgs>[]>;
}
...
export interface MHSMPrivateLinkServiceConnectionStateArgs {
     ...
     */
    actionsRequired?: pulumi.Input<string | enums.keyvault.ActionsRequired>;
    /**
     ...
     */
    status?: pulumi.Input<string | enums.keyvault.PrivateEndpointServiceConnectionStatus>;
}
...
export interface ManagedHsmPropertiesArgs {
     ...
     */
    createMode?: pulumi.Input<enums.keyvault.CreateMode>;
    /**
     ...
     */
    networkAcls?: pulumi.Input<inputs.keyvault.MHSMNetworkRuleSetArgs>;
    /**
     * Control permission for data plane traffic coming from public networks while private endpoint is enabled.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.keyvault.PublicNetworkAccess>;
    /**
...
export interface ManagedHsmSkuArgs {
     ...
     */
    family: pulumi.Input<string | enums.keyvault.ManagedHsmSkuFamily>;
    /**
     * SKU of the managed HSM Pool
     */
    name: pulumi.Input<enums.keyvault.ManagedHsmSkuName>;
}
...
export interface NetworkRuleSetArgs {
     ...
     * The list of IP address rules.
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.keyvault.IPRuleArgs>[]>;
    /**
     * The list of virtual network rules.
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.keyvault.VirtualNetworkRuleArgs>[]>;
}
...
export interface PermissionsArgs {
     ...
     */
    certificates?: pulumi.Input<pulumi.Input<string | enums.keyvault.CertificatePermissions>[]>;
    /**
     * Permissions to keys
     */
    keys?: pulumi.Input<pulumi.Input<string | enums.keyvault.KeyPermissions>[]>;
    /**
     * Permissions to secrets
     */
    secrets?: pulumi.Input<pulumi.Input<string | enums.keyvault.SecretPermissions>[]>;
    /**
     * Permissions to storage accounts
     */
    storage?: pulumi.Input<pulumi.Input<string | enums.keyvault.StoragePermissions>[]>;
}
...
export interface SecretPropertiesArgs {
     ...
     */
    attributes?: pulumi.Input<inputs.keyvault.SecretAttributesArgs>;
    /**
...
export interface SkuArgs {
     ...
     * SKU family name
     */
    family: pulumi.Input<string | enums.keyvault.SkuFamily>;
    /**
     * SKU name to specify whether the key vault is a standard vault or a premium vault.
     */
    name: pulumi.Input<enums.keyvault.SkuName>;
}
...
export interface VaultPropertiesArgs {
     ...
     */
    accessPolicies?: pulumi.Input<pulumi.Input<inputs.keyvault.AccessPolicyEntryArgs>[]>;
    /**
     ...
     * Rules governing the accessibility of the key vault from specific network locations.
     */
    networkAcls?: pulumi.Input<inputs.keyvault.NetworkRuleSetArgs>;
    /**
     * Provisioning state of the vault.
     */
    provisioningState?: pulumi.Input<string | enums.keyvault.VaultProvisioningState>;
    /**
     * SKU details
     */
    sku: pulumi.Input<inputs.keyvault.SkuArgs>;
    /**
     * softDelete data retention days. It accepts >=7 and <=90.
     */
    softDeleteRetentionInDays?: pulumi.Input<number>;
