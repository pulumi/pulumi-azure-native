...
export interface AccessPolicyEntryResponse {
     ...
     */
    permissions: outputs.keyvault.v20210601preview.PermissionsResponse;
    /**
...
export interface LifetimeActionResponse {
     ...
     */
    action?: outputs.keyvault.v20210601preview.ActionResponse;
    /**
     * The trigger of key rotation policy lifetimeAction.
     */
    trigger?: outputs.keyvault.v20210601preview.TriggerResponse;
}
...
export interface MHSMNetworkRuleSetResponse {
     ...
     */
    ipRules?: outputs.keyvault.v20210601preview.MHSMIPRuleResponse[];
    /**
     * The list of virtual network rules.
     */
    virtualNetworkRules?: outputs.keyvault.v20210601preview.MHSMVirtualNetworkRuleResponse[];
}
...
export interface MHSMPrivateEndpointConnectionItemResponse {
     ...
     */
    privateEndpoint?: outputs.keyvault.v20210601preview.MHSMPrivateEndpointResponse;
    /**
     * Approval state of the private link connection.
     */
    privateLinkServiceConnectionState?: outputs.keyvault.v20210601preview.MHSMPrivateLinkServiceConnectionStateResponse;
    /**
...
export interface ManagedHsmPropertiesResponse {
     ...
     */
    networkAcls?: outputs.keyvault.v20210601preview.MHSMNetworkRuleSetResponse;
    /**
     * List of private endpoint connections associated with the managed hsm pool.
     */
    privateEndpointConnections: outputs.keyvault.v20210601preview.MHSMPrivateEndpointConnectionItemResponse[];
    /**
     * Provisioning state.
     */
    provisioningState: string;
...
export interface NetworkRuleSetResponse {
     ...
     * The list of IP address rules.
     */
    ipRules?: outputs.keyvault.v20210601preview.IPRuleResponse[];
    /**
     * The list of virtual network rules.
     */
    virtualNetworkRules?: outputs.keyvault.v20210601preview.VirtualNetworkRuleResponse[];
}
...
export interface PrivateEndpointConnectionItemResponse {
     ...
     * Properties of the private endpoint object.
     */
    privateEndpoint?: outputs.keyvault.v20210601preview.PrivateEndpointResponse;
    /**
     * Approval state of the private link connection.
     */
    privateLinkServiceConnectionState?: outputs.keyvault.v20210601preview.PrivateLinkServiceConnectionStateResponse;
    /**
     * Provisioning state of the private endpoint connection.
     */
    provisioningState: string;
...
export interface RotationPolicyResponse {
     ...
     */
    attributes?: outputs.keyvault.v20210601preview.KeyRotationPolicyAttributesResponse;
    /**
     * The lifetimeActions for key rotation action.
     */
    lifetimeActions?: outputs.keyvault.v20210601preview.LifetimeActionResponse[];
}
...
export interface SecretPropertiesResponse {
     ...
     */
    attributes?: outputs.keyvault.v20210601preview.SecretAttributesResponse;
    /**
...
export interface VaultPropertiesResponse {
     ...
     */
    accessPolicies?: outputs.keyvault.v20210601preview.AccessPolicyEntryResponse[];
    /**
     ...
     * Rules governing the accessibility of the key vault from specific network locations.
     */
    networkAcls?: outputs.keyvault.v20210601preview.NetworkRuleSetResponse;
    /**
     * List of private endpoint connections associated with the key vault.
     */
    privateEndpointConnections: outputs.keyvault.v20210601preview.PrivateEndpointConnectionItemResponse[];
    /**
     ...
     * SKU details
     */
    sku: outputs.keyvault.v20210601preview.SkuResponse;
    /**
     * softDelete data retention days. It accepts >=7 and <=90.
     */
    softDeleteRetentionInDays?: number;
