...
export interface AccessPolicyEntryResponse {
     ...
     */
    permissions: outputs.keyvault.v20220701.PermissionsResponse;
    /**
...
export interface LifetimeActionResponse {
     ...
     */
    action?: outputs.keyvault.v20220701.ActionResponse;
    /**
     * The trigger of key rotation policy lifetimeAction.
     */
    trigger?: outputs.keyvault.v20220701.TriggerResponse;
}
...
export interface MHSMNetworkRuleSetResponse {
     ...
     */
    ipRules?: outputs.keyvault.v20220701.MHSMIPRuleResponse[];
    /**
     * The list of virtual network rules.
     */
    virtualNetworkRules?: outputs.keyvault.v20220701.MHSMVirtualNetworkRuleResponse[];
}
...
export interface MHSMPrivateEndpointConnectionItemResponse {
     ...
     */
    privateEndpoint?: outputs.keyvault.v20220701.MHSMPrivateEndpointResponse;
    /**
     * Approval state of the private link connection.
     */
    privateLinkServiceConnectionState?: outputs.keyvault.v20220701.MHSMPrivateLinkServiceConnectionStateResponse;
    /**
...
export interface ManagedHsmPropertiesResponse {
     ...
     */
    networkAcls?: outputs.keyvault.v20220701.MHSMNetworkRuleSetResponse;
    /**
     * List of private endpoint connections associated with the managed hsm pool.
     */
    privateEndpointConnections: outputs.keyvault.v20220701.MHSMPrivateEndpointConnectionItemResponse[];
    /**
     * Provisioning state.
     */
    provisioningState: string;
...
export interface NetworkRuleSetResponse {
     ...
     * The list of IP address rules.
     */
    ipRules?: outputs.keyvault.v20220701.IPRuleResponse[];
    /**
     * The list of virtual network rules.
     */
    virtualNetworkRules?: outputs.keyvault.v20220701.VirtualNetworkRuleResponse[];
}
...
export interface PrivateEndpointConnectionItemResponse {
     ...
     * Properties of the private endpoint object.
     */
    privateEndpoint?: outputs.keyvault.v20220701.PrivateEndpointResponse;
    /**
     * Approval state of the private link connection.
     */
    privateLinkServiceConnectionState?: outputs.keyvault.v20220701.PrivateLinkServiceConnectionStateResponse;
    /**
     * Provisioning state of the private endpoint connection.
     */
    provisioningState: string;
...
export interface RotationPolicyResponse {
     ...
     */
    attributes?: outputs.keyvault.v20220701.KeyRotationPolicyAttributesResponse;
    /**
     * The lifetimeActions for key rotation action.
     */
    lifetimeActions?: outputs.keyvault.v20220701.LifetimeActionResponse[];
}
...
export interface SecretPropertiesResponse {
     ...
     */
    attributes?: outputs.keyvault.v20220701.SecretAttributesResponse;
    /**
...
export interface VaultPropertiesResponse {
     ...
     */
    accessPolicies?: outputs.keyvault.v20220701.AccessPolicyEntryResponse[];
    /**
     ...
     * Rules governing the accessibility of the key vault from specific network locations.
     */
    networkAcls?: outputs.keyvault.v20220701.NetworkRuleSetResponse;
    /**
     * List of private endpoint connections associated with the key vault.
     */
    privateEndpointConnections: outputs.keyvault.v20220701.PrivateEndpointConnectionItemResponse[];
    /**
     ...
     * SKU details
     */
    sku: outputs.keyvault.v20220701.SkuResponse;
    /**
     * softDelete data retention days. It accepts >=7 and <=90.
     */
    softDeleteRetentionInDays?: number;
