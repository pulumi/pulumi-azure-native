...
export interface AccessPolicyEntryResponse {
     ...
     */
    permissions: outputs.keyvault.v20211001.PermissionsResponse;
    /**
...
export interface MHSMNetworkRuleSetResponse {
     ...
     */
    ipRules?: outputs.keyvault.v20211001.MHSMIPRuleResponse[];
    /**
     * The list of virtual network rules.
     */
    virtualNetworkRules?: outputs.keyvault.v20211001.MHSMVirtualNetworkRuleResponse[];
}
...
export interface MHSMPrivateEndpointConnectionItemResponse {
     ...
     */
    privateEndpoint?: outputs.keyvault.v20211001.MHSMPrivateEndpointResponse;
    /**
     * Approval state of the private link connection.
     */
    privateLinkServiceConnectionState?: outputs.keyvault.v20211001.MHSMPrivateLinkServiceConnectionStateResponse;
    /**
...
export interface ManagedHsmPropertiesResponse {
     ...
     */
    networkAcls?: outputs.keyvault.v20211001.MHSMNetworkRuleSetResponse;
    /**
     * List of private endpoint connections associated with the managed hsm pool.
     */
    privateEndpointConnections: outputs.keyvault.v20211001.MHSMPrivateEndpointConnectionItemResponse[];
    /**
     * Provisioning state.
     */
    provisioningState: string;
...
export interface NetworkRuleSetResponse {
     ...
     * The list of IP address rules.
     */
    ipRules?: outputs.keyvault.v20211001.IPRuleResponse[];
    /**
     * The list of virtual network rules.
     */
    virtualNetworkRules?: outputs.keyvault.v20211001.VirtualNetworkRuleResponse[];
}
...
export interface PrivateEndpointConnectionItemResponse {
     ...
     * Properties of the private endpoint object.
     */
    privateEndpoint?: outputs.keyvault.v20211001.PrivateEndpointResponse;
    /**
     * Approval state of the private link connection.
     */
    privateLinkServiceConnectionState?: outputs.keyvault.v20211001.PrivateLinkServiceConnectionStateResponse;
    /**
     * Provisioning state of the private endpoint connection.
     */
    provisioningState: string;
...
export interface SecretPropertiesResponse {
     ...
     */
    attributes?: outputs.keyvault.v20211001.SecretAttributesResponse;
    /**
...
export interface VaultPropertiesResponse {
     ...
     */
    accessPolicies?: outputs.keyvault.v20211001.AccessPolicyEntryResponse[];
    /**
     ...
     * Rules governing the accessibility of the key vault from specific network locations.
     */
    networkAcls?: outputs.keyvault.v20211001.NetworkRuleSetResponse;
    /**
     * List of private endpoint connections associated with the key vault.
     */
    privateEndpointConnections: outputs.keyvault.v20211001.PrivateEndpointConnectionItemResponse[];
    /**
     ...
     * SKU details
     */
    sku: outputs.keyvault.v20211001.SkuResponse;
    /**
     * softDelete data retention days. It accepts >=7 and <=90.
     */
    softDeleteRetentionInDays?: number;
