...
export interface AccessPolicyEntryResponse {
     ...
     */
    permissions: outputs.keyvault.v20161001.PermissionsResponse;
    /**
...
export interface SecretPropertiesResponse {
     ...
     */
    attributes?: outputs.keyvault.v20161001.SecretAttributesResponse;
    /**
...
export interface VaultPropertiesResponse {
     ...
     */
    accessPolicies?: outputs.keyvault.v20161001.AccessPolicyEntryResponse[];
    /**
     ...
     * SKU details
     */
    sku: outputs.keyvault.v20161001.SkuResponse;
    /**
     * The Azure Active Directory tenant ID that should be used for authenticating requests to the key vault.
     */
    tenantId: string;
