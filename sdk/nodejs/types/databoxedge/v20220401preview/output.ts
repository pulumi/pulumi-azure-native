...
export interface AuthenticationResponse {
     ...
     */
    symmetricKey?: outputs.databoxedge.v20220401preview.SymmetricKeyResponse;
}
...
export interface EdgeProfileResponse {
     ...
     */
    subscription?: outputs.databoxedge.v20220401preview.EdgeProfileSubscriptionResponse;
}
...
export interface EdgeProfileSubscriptionResponse {
    ...
    quotaId?: string;
    registeredFeatures?: outputs.databoxedge.v20220401preview.SubscriptionRegisteredFeaturesResponse[];
...
export interface ImageRepositoryCredentialResponse {
     ...
     */
    password?: outputs.databoxedge.v20220401preview.AsymmetricEncryptedSecretResponse;
    /**
...
export interface IoTDeviceInfoResponse {
     ...
     */
    authentication?: outputs.databoxedge.v20220401preview.AuthenticationResponse;
    /**
...
export interface IoTEdgeAgentInfoResponse {
     ...
     */
    imageRepository?: outputs.databoxedge.v20220401preview.ImageRepositoryCredentialResponse;
    /**
     * Image Tag.
     */
    tag: string;
...
export interface KubernetesClusterInfoResponse {
     ...
     * Etcd configuration
     */
    etcdInfo: outputs.databoxedge.v20220401preview.EtcdInfoResponse;
    /**
     * Kubernetes cluster nodes
     */
    nodes: outputs.databoxedge.v20220401preview.NodeInfoResponse[];
    /**
...
export interface KubernetesRoleNetworkResponse {
     ...
     * Cni configuration
     */
    cniConfig: outputs.databoxedge.v20220401preview.CniConfigResponse;
    /**
     * Load balancer configuration
     */
    loadBalancerConfig: outputs.databoxedge.v20220401preview.LoadBalancerConfigResponse;
}
...
export interface KubernetesRoleResourcesResponse {
     ...
     * Kubernetes role compute resource
     */
    compute: outputs.databoxedge.v20220401preview.KubernetesRoleComputeResponse;
    /**
     * Kubernetes role network resource
     */
    network: outputs.databoxedge.v20220401preview.KubernetesRoleNetworkResponse;
    /**
     * Kubernetes role storage resource
     */
    storage?: outputs.databoxedge.v20220401preview.KubernetesRoleStorageResponse;
}
...
export interface KubernetesRoleStorageResponse {
     ...
     */
    endpoints?: outputs.databoxedge.v20220401preview.MountPointMapResponse[];
    /**
     * Kubernetes storage class info.
     */
    storageClasses: outputs.databoxedge.v20220401preview.KubernetesRoleStorageClassInfoResponse[];
}
...
export interface MetricConfigurationResponse {
     ...
     * Host name for the IoT hub associated to the device.
     */
    counterSets: outputs.databoxedge.v20220401preview.MetricCounterSetResponse[];
    /**
...
export interface MetricCounterResponse {
     ...
     */
    additionalDimensions?: outputs.databoxedge.v20220401preview.MetricDimensionResponse[];
    /**
     * The dimension filter.
     */
    dimensionFilter?: outputs.databoxedge.v20220401preview.MetricDimensionResponse[];
    /**
...
export interface MetricCounterSetResponse {
     ...
     */
    counters: outputs.databoxedge.v20220401preview.MetricCounterResponse[];
}
...
export interface NodeInfoResponse {
     ...
     */
    ipConfiguration?: outputs.databoxedge.v20220401preview.KubernetesIPConfigurationResponse[];
    /**
     * Node name.
     */
    name: string;
...
export interface OrderStatusResponse {
     ...
     */
    trackingInformation: outputs.databoxedge.v20220401preview.TrackingInfoResponse;
    /**
...
export interface SymmetricKeyResponse {
     ...
     */
    connectionString?: outputs.databoxedge.v20220401preview.AsymmetricEncryptedSecretResponse;
}
