...
export interface AsymmetricEncryptedSecretArgs {
     ...
     */
    encryptionAlgorithm: pulumi.Input<string | enums.databoxedge.v20220401preview.EncryptionAlgorithm>;
    /**
...
export interface AuthenticationArgs {
     ...
     */
    symmetricKey?: pulumi.Input<inputs.databoxedge.v20220401preview.SymmetricKeyArgs>;
}
...
export interface ClientAccessRightArgs {
     ...
     */
    accessPermission: pulumi.Input<string | enums.databoxedge.v20220401preview.ClientPermissionType>;
    /**
     * IP of the client.
     */
...
export interface DataResidencyArgs {
     ...
     */
    type?: pulumi.Input<string | enums.databoxedge.v20220401preview.DataResidencyType>;
}
...
export interface ImageRepositoryCredentialArgs {
     ...
     */
    password?: pulumi.Input<inputs.databoxedge.v20220401preview.AsymmetricEncryptedSecretArgs>;
    /**
...
export interface IoTDeviceInfoArgs {
     ...
     */
    authentication?: pulumi.Input<inputs.databoxedge.v20220401preview.AuthenticationArgs>;
    /**
...
export interface IoTEdgeAgentInfoArgs {
     ...
     */
    imageRepository?: pulumi.Input<inputs.databoxedge.v20220401preview.ImageRepositoryCredentialArgs>;
    /**
     * Image Tag.
     */
...
export interface KubernetesRoleResourcesArgs {
     ...
     * Kubernetes role compute resource
     */
    compute: pulumi.Input<inputs.databoxedge.v20220401preview.KubernetesRoleComputeArgs>;
    /**
     * Kubernetes role storage resource
     */
    storage?: pulumi.Input<inputs.databoxedge.v20220401preview.KubernetesRoleStorageArgs>;
}
...
export interface KubernetesRoleStorageArgs {
     ...
     */
    endpoints?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20220401preview.MountPointMapArgs>[]>;
}
...
export interface MetricConfigurationArgs {
     ...
     * Host name for the IoT hub associated to the device.
     */
    counterSets: pulumi.Input<pulumi.Input<inputs.databoxedge.v20220401preview.MetricCounterSetArgs>[]>;
    /**
...
export interface MetricCounterArgs {
     ...
     */
    additionalDimensions?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20220401preview.MetricDimensionArgs>[]>;
    /**
     * The dimension filter.
     */
    dimensionFilter?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20220401preview.MetricDimensionArgs>[]>;
    /**
...
export interface MetricCounterSetArgs {
     ...
     */
    counters: pulumi.Input<pulumi.Input<inputs.databoxedge.v20220401preview.MetricCounterArgs>[]>;
}
...
export interface SkuArgs {
     ...
     * SKU name.
     */
    name?: pulumi.Input<string | enums.databoxedge.v20220401preview.SkuName>;
    /**
     * The SKU tier. This is based on the SKU name.
     */
    tier?: pulumi.Input<string | enums.databoxedge.v20220401preview.SkuTier>;
}
...
export interface UserAccessRightArgs {
     ...
     */
    accessType: pulumi.Input<string | enums.databoxedge.v20220401preview.ShareAccessType>;
    /**
