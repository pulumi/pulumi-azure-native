...
export interface AsymmetricEncryptedSecretArgs {
     ...
     */
    encryptionAlgorithm: pulumi.Input<string | enums.databoxedge.v20220301.EncryptionAlgorithm>;
    /**
...
export interface AuthenticationArgs {
     ...
     */
    symmetricKey?: pulumi.Input<inputs.databoxedge.v20220301.SymmetricKeyArgs>;
}
...
export interface ClientAccessRightArgs {
     ...
     */
    accessPermission: pulumi.Input<string | enums.databoxedge.v20220301.ClientPermissionType>;
    /**
     * IP of the client.
     */
...
export interface DataResidencyArgs {
     ...
     */
    type?: pulumi.Input<string | enums.databoxedge.v20220301.DataResidencyType>;
}
...
export interface ImageRepositoryCredentialArgs {
     ...
     */
    password?: pulumi.Input<inputs.databoxedge.v20220301.AsymmetricEncryptedSecretArgs>;
    /**
...
export interface IoTDeviceInfoArgs {
     ...
     */
    authentication?: pulumi.Input<inputs.databoxedge.v20220301.AuthenticationArgs>;
    /**
...
export interface IoTEdgeAgentInfoArgs {
     ...
     */
    imageRepository?: pulumi.Input<inputs.databoxedge.v20220301.ImageRepositoryCredentialArgs>;
    /**
     * Image Tag.
     */
...
export interface KubernetesRoleResourcesArgs {
     ...
     * Kubernetes role compute resource
     */
    compute: pulumi.Input<inputs.databoxedge.v20220301.KubernetesRoleComputeArgs>;
    /**
     * Kubernetes role storage resource
     */
    storage?: pulumi.Input<inputs.databoxedge.v20220301.KubernetesRoleStorageArgs>;
}
...
export interface KubernetesRoleStorageArgs {
     ...
     */
    endpoints?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20220301.MountPointMapArgs>[]>;
}
...
export interface MetricConfigurationArgs {
     ...
     * Host name for the IoT hub associated to the device.
     */
    counterSets: pulumi.Input<pulumi.Input<inputs.databoxedge.v20220301.MetricCounterSetArgs>[]>;
    /**
...
export interface MetricCounterArgs {
     ...
     */
    additionalDimensions?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20220301.MetricDimensionArgs>[]>;
    /**
     * The dimension filter.
     */
    dimensionFilter?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20220301.MetricDimensionArgs>[]>;
    /**
...
export interface MetricCounterSetArgs {
     ...
     */
    counters: pulumi.Input<pulumi.Input<inputs.databoxedge.v20220301.MetricCounterArgs>[]>;
}
...
export interface ResourceIdentityArgs {
     ...
     * Identity type
     */
    type?: pulumi.Input<string | enums.databoxedge.v20220301.MsiIdentityType>;
}
...
export interface SkuArgs {
     ...
     * SKU name.
     */
    name?: pulumi.Input<string | enums.databoxedge.v20220301.SkuName>;
    /**
     * The SKU tier. This is based on the SKU name.
     */
    tier?: pulumi.Input<string | enums.databoxedge.v20220301.SkuTier>;
}
...
export interface UserAccessRightArgs {
     ...
     */
    accessType: pulumi.Input<string | enums.databoxedge.v20220301.ShareAccessType>;
    /**
