...
export interface AuthenticationResponse {
     ...
     */
    symmetricKey?: outputs.databoxedge.v20220301.SymmetricKeyResponse;
}
...
export interface EdgeProfileResponse {
     ...
     */
    subscription?: outputs.databoxedge.v20220301.EdgeProfileSubscriptionResponse;
}
...
export interface EdgeProfileSubscriptionResponse {
    ...
    quotaId?: string;
    registeredFeatures?: outputs.databoxedge.v20220301.SubscriptionRegisteredFeaturesResponse[];
...
export interface ImageRepositoryCredentialResponse {
     ...
     */
    password?: outputs.databoxedge.v20220301.AsymmetricEncryptedSecretResponse;
    /**
...
export interface IoTDeviceInfoResponse {
     ...
     */
    authentication?: outputs.databoxedge.v20220301.AuthenticationResponse;
    /**
...
export interface IoTEdgeAgentInfoResponse {
     ...
     */
    imageRepository?: outputs.databoxedge.v20220301.ImageRepositoryCredentialResponse;
    /**
     * Image Tag.
     */
    tag: string;
...
export interface KubernetesClusterInfoResponse {
     ...
     * Etcd configuration
     */
    etcdInfo: outputs.databoxedge.v20220301.EtcdInfoResponse;
    /**
     * Kubernetes cluster nodes
     */
    nodes: outputs.databoxedge.v20220301.NodeInfoResponse[];
    /**
...
export interface KubernetesRoleNetworkResponse {
     ...
     * Cni configuration
     */
    cniConfig: outputs.databoxedge.v20220301.CniConfigResponse;
    /**
     * Load balancer configuration
     */
    loadBalancerConfig: outputs.databoxedge.v20220301.LoadBalancerConfigResponse;
}
...
export interface KubernetesRoleResourcesResponse {
     ...
     * Kubernetes role compute resource
     */
    compute: outputs.databoxedge.v20220301.KubernetesRoleComputeResponse;
    /**
     * Kubernetes role network resource
     */
    network: outputs.databoxedge.v20220301.KubernetesRoleNetworkResponse;
    /**
     * Kubernetes role storage resource
     */
    storage?: outputs.databoxedge.v20220301.KubernetesRoleStorageResponse;
}
...
export interface KubernetesRoleStorageResponse {
     ...
     */
    endpoints?: outputs.databoxedge.v20220301.MountPointMapResponse[];
    /**
     * Kubernetes storage class info.
     */
    storageClasses: outputs.databoxedge.v20220301.KubernetesRoleStorageClassInfoResponse[];
}
...
export interface MetricConfigurationResponse {
     ...
     * Host name for the IoT hub associated to the device.
     */
    counterSets: outputs.databoxedge.v20220301.MetricCounterSetResponse[];
    /**
...
export interface MetricCounterResponse {
     ...
     */
    additionalDimensions?: outputs.databoxedge.v20220301.MetricDimensionResponse[];
    /**
     * The dimension filter.
     */
    dimensionFilter?: outputs.databoxedge.v20220301.MetricDimensionResponse[];
    /**
...
export interface MetricCounterSetResponse {
     ...
     */
    counters: outputs.databoxedge.v20220301.MetricCounterResponse[];
}
...
export interface NodeInfoResponse {
     ...
     */
    ipConfiguration?: outputs.databoxedge.v20220301.KubernetesIPConfigurationResponse[];
    /**
     * Node name.
     */
    name: string;
...
export interface OrderStatusResponse {
     ...
     */
    trackingInformation: outputs.databoxedge.v20220301.TrackingInfoResponse;
    /**
...
export interface SymmetricKeyResponse {
     ...
     */
    connectionString?: outputs.databoxedge.v20220301.AsymmetricEncryptedSecretResponse;
}
