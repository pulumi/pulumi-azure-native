...
export interface AsymmetricEncryptedSecretArgs {
     ...
     */
    encryptionAlgorithm: pulumi.Input<string | enums.databoxedge.v20200901.EncryptionAlgorithm>;
    /**
...
export interface AuthenticationArgs {
     ...
     */
    symmetricKey?: pulumi.Input<inputs.databoxedge.v20200901.SymmetricKeyArgs>;
}
...
export interface ClientAccessRightArgs {
     ...
     */
    accessPermission: pulumi.Input<string | enums.databoxedge.v20200901.ClientPermissionType>;
    /**
     * IP of the client.
     */
...
export interface ImageRepositoryCredentialArgs {
     ...
     */
    password?: pulumi.Input<inputs.databoxedge.v20200901.AsymmetricEncryptedSecretArgs>;
    /**
...
export interface IoTDeviceInfoArgs {
     ...
     */
    authentication?: pulumi.Input<inputs.databoxedge.v20200901.AuthenticationArgs>;
    /**
...
export interface IoTEdgeAgentInfoArgs {
     ...
     */
    imageRepository?: pulumi.Input<inputs.databoxedge.v20200901.ImageRepositoryCredentialArgs>;
    /**
     * Image Tag.
     */
...
export interface KubernetesRoleResourcesArgs {
     ...
     * Kubernetes role compute resource
     */
    compute: pulumi.Input<inputs.databoxedge.v20200901.KubernetesRoleComputeArgs>;
    /**
     * Kubernetes role storage resource
     */
    storage?: pulumi.Input<inputs.databoxedge.v20200901.KubernetesRoleStorageArgs>;
}
...
export interface KubernetesRoleStorageArgs {
     ...
     */
    endpoints?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20200901.MountPointMapArgs>[]>;
}
...
export interface MetricConfigurationArgs {
     ...
     * Host name for the IoT hub associated to the device.
     */
    counterSets: pulumi.Input<pulumi.Input<inputs.databoxedge.v20200901.MetricCounterSetArgs>[]>;
    /**
...
export interface MetricCounterArgs {
     ...
     */
    additionalDimensions?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20200901.MetricDimensionArgs>[]>;
    /**
     * The dimension filter.
     */
    dimensionFilter?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20200901.MetricDimensionArgs>[]>;
    /**
...
export interface MetricCounterSetArgs {
     ...
     */
    counters: pulumi.Input<pulumi.Input<inputs.databoxedge.v20200901.MetricCounterArgs>[]>;
}
...
export interface ResourceIdentityArgs {
     ...
     * Identity type
     */
    type?: pulumi.Input<string | enums.databoxedge.v20200901.MsiIdentityType>;
}
...
export interface SkuArgs {
     ...
     * SKU name.
     */
    name?: pulumi.Input<string | enums.databoxedge.v20200901.SkuName>;
    /**
     * The SKU tier. This is based on the SKU name.
     */
    tier?: pulumi.Input<string | enums.databoxedge.v20200901.SkuTier>;
}
...
export interface SymmetricKeyArgs {
     ...
     */
    connectionString?: pulumi.Input<inputs.databoxedge.v20200901.AsymmetricEncryptedSecretArgs>;
}
...
export interface UserAccessRightArgs {
     ...
     */
    accessType: pulumi.Input<string | enums.databoxedge.v20200901.ShareAccessType>;
    /**
