...
export interface AuthenticationResponse {
     ...
     */
    symmetricKey?: outputs.databoxedge.v20210201.SymmetricKeyResponse;
}
...
export interface EdgeProfileResponse {
     ...
     */
    subscription?: outputs.databoxedge.v20210201.EdgeProfileSubscriptionResponse;
}
...
export interface EdgeProfileSubscriptionResponse {
    ...
    quotaId?: string;
    registeredFeatures?: outputs.databoxedge.v20210201.SubscriptionRegisteredFeaturesResponse[];
...
export interface ImageRepositoryCredentialResponse {
     ...
     */
    password?: outputs.databoxedge.v20210201.AsymmetricEncryptedSecretResponse;
    /**
...
export interface IoTDeviceInfoResponse {
     ...
     */
    authentication?: outputs.databoxedge.v20210201.AuthenticationResponse;
    /**
...
export interface IoTEdgeAgentInfoResponse {
     ...
     */
    imageRepository?: outputs.databoxedge.v20210201.ImageRepositoryCredentialResponse;
    /**
     * Image Tag.
     */
    tag: string;
...
export interface KubernetesClusterInfoResponse {
     ...
     * Etcd configuration
     */
    etcdInfo: outputs.databoxedge.v20210201.EtcdInfoResponse;
    /**
     * Kubernetes cluster nodes
     */
    nodes: outputs.databoxedge.v20210201.NodeInfoResponse[];
    /**
...
export interface KubernetesRoleNetworkResponse {
     ...
     * Cni configuration
     */
    cniConfig: outputs.databoxedge.v20210201.CniConfigResponse;
    /**
     * Load balancer configuration
     */
    loadBalancerConfig: outputs.databoxedge.v20210201.LoadBalancerConfigResponse;
}
...
export interface KubernetesRoleResourcesResponse {
     ...
     * Kubernetes role compute resource
     */
    compute: outputs.databoxedge.v20210201.KubernetesRoleComputeResponse;
    /**
     * Kubernetes role network resource
     */
    network: outputs.databoxedge.v20210201.KubernetesRoleNetworkResponse;
    /**
     * Kubernetes role storage resource
     */
    storage?: outputs.databoxedge.v20210201.KubernetesRoleStorageResponse;
}
...
export interface KubernetesRoleStorageResponse {
     ...
     */
    endpoints?: outputs.databoxedge.v20210201.MountPointMapResponse[];
    /**
     * Kubernetes storage class info.
     */
    storageClasses: outputs.databoxedge.v20210201.KubernetesRoleStorageClassInfoResponse[];
}
...
export interface MetricConfigurationResponse {
     ...
     * Host name for the IoT hub associated to the device.
     */
    counterSets: outputs.databoxedge.v20210201.MetricCounterSetResponse[];
    /**
...
export interface MetricCounterResponse {
     ...
     */
    additionalDimensions?: outputs.databoxedge.v20210201.MetricDimensionResponse[];
    /**
     * The dimension filter.
     */
    dimensionFilter?: outputs.databoxedge.v20210201.MetricDimensionResponse[];
    /**
...
export interface MetricCounterSetResponse {
     ...
     */
    counters: outputs.databoxedge.v20210201.MetricCounterResponse[];
}
...
export interface NodeInfoResponse {
     ...
     */
    ipConfiguration?: outputs.databoxedge.v20210201.KubernetesIPConfigurationResponse[];
    /**
     * Node name.
     */
    name: string;
...
export interface OrderStatusResponse {
     ...
     */
    trackingInformation: outputs.databoxedge.v20210201.TrackingInfoResponse;
    /**
...
export interface SecretResponse {
     ...
     */
    encryptedSecret?: outputs.databoxedge.v20210201.AsymmetricEncryptedSecretResponse;
    /**
...
export interface SymmetricKeyResponse {
     ...
     */
    connectionString?: outputs.databoxedge.v20210201.AsymmetricEncryptedSecretResponse;
}
