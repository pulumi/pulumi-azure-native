...
export interface AuthenticationResponse {
     ...
     */
    symmetricKey?: outputs.databoxedge.SymmetricKeyResponse;
}
...
export interface DeviceSecretsResponse {
     ...
     */
    bmcDefaultUserPassword?: outputs.databoxedge.SecretResponse;
    /**
     * Keyvault Id of HcsDataVolumeBitLockerExternalKey
     */
    hcsDataVolumeBitLockerExternalKey?: outputs.databoxedge.SecretResponse;
    /**
     * Keyvault Id of HcsInternalVolumeBitLockerExternalKey
     */
    hcsInternalVolumeBitLockerExternalKey?: outputs.databoxedge.SecretResponse;
    /**
     * Keyvault Id of RotateKeyForDataVolumeBitlocker
     */
    rotateKeyForDataVolumeBitlocker?: outputs.databoxedge.SecretResponse;
    /**
     * Keyvault Id of RotateKeysForSedDrivesSerialized
     */
    rotateKeysForSedDrivesSerialized?: outputs.databoxedge.SecretResponse;
    /**
     * Keyvault Id of SEDEncryptionExternalKey
     */
    sedEncryptionExternalKey?: outputs.databoxedge.SecretResponse;
    /**
     * Keyvault Id of SEDEncryptionExternalKeyId
     */
    sedEncryptionExternalKeyId?: outputs.databoxedge.SecretResponse;
    /**
     * Keyvault Id of SystemVolumeBitLockerRecoveryKey
     */
    systemVolumeBitLockerRecoveryKey?: outputs.databoxedge.SecretResponse;
}
...
export interface EdgeProfileResponse {
     ...
     */
    subscription?: outputs.databoxedge.EdgeProfileSubscriptionResponse;
}
...
export interface EdgeProfileSubscriptionResponse {
    ...
    quotaId?: string;
    registeredFeatures?: outputs.databoxedge.SubscriptionRegisteredFeaturesResponse[];
...
export interface ImageRepositoryCredentialResponse {
     ...
     */
    password?: outputs.databoxedge.AsymmetricEncryptedSecretResponse;
    /**
...
export interface IoTDeviceInfoResponse {
     ...
     */
    authentication?: outputs.databoxedge.AuthenticationResponse;
    /**
...
export interface IoTEdgeAgentInfoResponse {
     ...
     */
    imageRepository?: outputs.databoxedge.ImageRepositoryCredentialResponse;
    /**
     * Image Tag.
     */
    tag: string;
...
export interface KubernetesClusterInfoResponse {
     ...
     * Etcd configuration
     */
    etcdInfo: outputs.databoxedge.EtcdInfoResponse;
    /**
     * Kubernetes cluster nodes
     */
    nodes: outputs.databoxedge.NodeInfoResponse[];
    /**
...
export interface KubernetesRoleNetworkResponse {
     ...
     * Cni configuration
     */
    cniConfig: outputs.databoxedge.CniConfigResponse;
    /**
     * Load balancer configuration
     */
    loadBalancerConfig: outputs.databoxedge.LoadBalancerConfigResponse;
}
...
export interface KubernetesRoleResourcesResponse {
     ...
     * Kubernetes role compute resource
     */
    compute: outputs.databoxedge.KubernetesRoleComputeResponse;
    /**
     * Kubernetes role network resource
     */
    network: outputs.databoxedge.KubernetesRoleNetworkResponse;
    /**
     * Kubernetes role storage resource
     */
    storage?: outputs.databoxedge.KubernetesRoleStorageResponse;
}
...
export interface KubernetesRoleStorageResponse {
     ...
     */
    endpoints?: outputs.databoxedge.MountPointMapResponse[];
    /**
     * Kubernetes storage class info.
     */
    storageClasses: outputs.databoxedge.KubernetesRoleStorageClassInfoResponse[];
}
...
export interface MetricConfigurationResponse {
     ...
     * Host name for the IoT hub associated to the device.
     */
    counterSets: outputs.databoxedge.MetricCounterSetResponse[];
    /**
...
export interface MetricCounterResponse {
     ...
     */
    additionalDimensions?: outputs.databoxedge.MetricDimensionResponse[];
    /**
     * The dimension filter.
     */
    dimensionFilter?: outputs.databoxedge.MetricDimensionResponse[];
    /**
...
export interface MetricCounterSetResponse {
     ...
     */
    counters: outputs.databoxedge.MetricCounterResponse[];
}
...
export interface NodeInfoResponse {
     ...
     */
    ipConfiguration?: outputs.databoxedge.KubernetesIPConfigurationResponse[];
    /**
     * Node name.
     */
    name: string;
...
export interface OrderStatusResponse {
     ...
     */
    trackingInformation: outputs.databoxedge.TrackingInfoResponse;
    /**
...
export interface SecretResponse {
     ...
     */
    encryptedSecret?: outputs.databoxedge.AsymmetricEncryptedSecretResponse;
    /**
...
export interface SymmetricKeyResponse {
     ...
     */
    connectionString?: outputs.databoxedge.AsymmetricEncryptedSecretResponse;
}
