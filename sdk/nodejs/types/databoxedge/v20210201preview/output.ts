...
export interface AuthenticationResponse {
     ...
     */
    symmetricKey?: outputs.databoxedge.v20210201preview.SymmetricKeyResponse;
}
...
export interface EdgeProfileResponse {
     ...
     */
    subscription?: outputs.databoxedge.v20210201preview.EdgeProfileSubscriptionResponse;
}
...
export interface EdgeProfileSubscriptionResponse {
    ...
    quotaId?: string;
    registeredFeatures?: outputs.databoxedge.v20210201preview.SubscriptionRegisteredFeaturesResponse[];
...
export interface ImageRepositoryCredentialResponse {
     ...
     */
    password?: outputs.databoxedge.v20210201preview.AsymmetricEncryptedSecretResponse;
    /**
...
export interface IoTDeviceInfoResponse {
     ...
     */
    authentication?: outputs.databoxedge.v20210201preview.AuthenticationResponse;
    /**
...
export interface IoTEdgeAgentInfoResponse {
     ...
     */
    imageRepository?: outputs.databoxedge.v20210201preview.ImageRepositoryCredentialResponse;
    /**
     * Image Tag.
     */
    tag: string;
...
export interface KubernetesClusterInfoResponse {
     ...
     * Etcd configuration
     */
    etcdInfo: outputs.databoxedge.v20210201preview.EtcdInfoResponse;
    /**
     * Kubernetes cluster nodes
     */
    nodes: outputs.databoxedge.v20210201preview.NodeInfoResponse[];
    /**
...
export interface KubernetesRoleNetworkResponse {
     ...
     * Cni configuration
     */
    cniConfig: outputs.databoxedge.v20210201preview.CniConfigResponse;
    /**
     * Load balancer configuration
     */
    loadBalancerConfig: outputs.databoxedge.v20210201preview.LoadBalancerConfigResponse;
}
...
export interface KubernetesRoleResourcesResponse {
     ...
     * Kubernetes role compute resource
     */
    compute: outputs.databoxedge.v20210201preview.KubernetesRoleComputeResponse;
    /**
     * Kubernetes role network resource
     */
    network: outputs.databoxedge.v20210201preview.KubernetesRoleNetworkResponse;
    /**
     * Kubernetes role storage resource
     */
    storage?: outputs.databoxedge.v20210201preview.KubernetesRoleStorageResponse;
}
...
export interface KubernetesRoleStorageResponse {
     ...
     */
    endpoints?: outputs.databoxedge.v20210201preview.MountPointMapResponse[];
    /**
     * Kubernetes storage class info.
     */
    storageClasses: outputs.databoxedge.v20210201preview.KubernetesRoleStorageClassInfoResponse[];
}
...
export interface MetricConfigurationResponse {
     ...
     * Host name for the IoT hub associated to the device.
     */
    counterSets: outputs.databoxedge.v20210201preview.MetricCounterSetResponse[];
    /**
...
export interface MetricCounterResponse {
     ...
     */
    additionalDimensions?: outputs.databoxedge.v20210201preview.MetricDimensionResponse[];
    /**
     * The dimension filter.
     */
    dimensionFilter?: outputs.databoxedge.v20210201preview.MetricDimensionResponse[];
    /**
...
export interface MetricCounterSetResponse {
     ...
     */
    counters: outputs.databoxedge.v20210201preview.MetricCounterResponse[];
}
...
export interface NodeInfoResponse {
     ...
     */
    ipConfiguration?: outputs.databoxedge.v20210201preview.KubernetesIPConfigurationResponse[];
    /**
     * Node name.
     */
    name: string;
...
export interface OrderStatusResponse {
     ...
     */
    trackingInformation: outputs.databoxedge.v20210201preview.TrackingInfoResponse;
    /**
...
export interface SecretResponse {
     ...
     */
    encryptedSecret?: outputs.databoxedge.v20210201preview.AsymmetricEncryptedSecretResponse;
    /**
...
export interface SymmetricKeyResponse {
     ...
     */
    connectionString?: outputs.databoxedge.v20210201preview.AsymmetricEncryptedSecretResponse;
}
