...
export interface AsymmetricEncryptedSecretArgs {
     ...
     */
    encryptionAlgorithm: pulumi.Input<string | enums.databoxedge.v20201201.EncryptionAlgorithm>;
    /**
...
export interface AuthenticationArgs {
     ...
     */
    symmetricKey?: pulumi.Input<inputs.databoxedge.v20201201.SymmetricKeyArgs>;
}
...
export interface AzureContainerInfoArgs {
     ...
     */
    dataFormat: pulumi.Input<string | enums.databoxedge.v20201201.AzureContainerDataFormat>;
    /**
...
export interface ClientAccessRightArgs {
     ...
     */
    accessPermission: pulumi.Input<string | enums.databoxedge.v20201201.ClientPermissionType>;
    /**
     * IP of the client.
     */
...
export interface ImageRepositoryCredentialArgs {
     ...
     */
    password?: pulumi.Input<inputs.databoxedge.v20201201.AsymmetricEncryptedSecretArgs>;
    /**
...
export interface IoTDeviceInfoArgs {
     ...
     */
    authentication?: pulumi.Input<inputs.databoxedge.v20201201.AuthenticationArgs>;
    /**
...
export interface IoTEdgeAgentInfoArgs {
     ...
     */
    imageRepository?: pulumi.Input<inputs.databoxedge.v20201201.ImageRepositoryCredentialArgs>;
    /**
     * Image Tag.
     */
...
export interface KubernetesRoleResourcesArgs {
     ...
     * Kubernetes role compute resource
     */
    compute: pulumi.Input<inputs.databoxedge.v20201201.KubernetesRoleComputeArgs>;
    /**
     * Kubernetes role storage resource
     */
    storage?: pulumi.Input<inputs.databoxedge.v20201201.KubernetesRoleStorageArgs>;
}
...
export interface KubernetesRoleStorageArgs {
     ...
     */
    endpoints?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20201201.MountPointMapArgs>[]>;
}
...
export interface MetricConfigurationArgs {
     ...
     * Host name for the IoT hub associated to the device.
     */
    counterSets: pulumi.Input<pulumi.Input<inputs.databoxedge.v20201201.MetricCounterSetArgs>[]>;
    /**
...
export interface MetricCounterArgs {
     ...
     */
    additionalDimensions?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20201201.MetricDimensionArgs>[]>;
    /**
     * The dimension filter.
     */
    dimensionFilter?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20201201.MetricDimensionArgs>[]>;
    /**
...
export interface MetricCounterSetArgs {
     ...
     */
    counters: pulumi.Input<pulumi.Input<inputs.databoxedge.v20201201.MetricCounterArgs>[]>;
}
...
export interface ResourceIdentityArgs {
     ...
     * Identity type
     */
    type?: pulumi.Input<string | enums.databoxedge.v20201201.MsiIdentityType>;
}
...
export interface SkuArgs {
     ...
     * SKU name.
     */
    name?: pulumi.Input<string | enums.databoxedge.v20201201.SkuName>;
    /**
     * The SKU tier. This is based on the SKU name.
     */
    tier?: pulumi.Input<string | enums.databoxedge.v20201201.SkuTier>;
}
...
export interface SymmetricKeyArgs {
     ...
     */
    connectionString?: pulumi.Input<inputs.databoxedge.v20201201.AsymmetricEncryptedSecretArgs>;
}
...
export interface UserAccessRightArgs {
     ...
     */
    accessType: pulumi.Input<string | enums.databoxedge.v20201201.ShareAccessType>;
    /**
