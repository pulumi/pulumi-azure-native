...
export interface CassandraSchemaResponse {
     ...
     * List of cluster key.
     */
    clusterKeys?: outputs.documentdb.v20150401.ClusterKeyResponse[];
    /**
     * List of Cassandra table columns.
     */
    columns?: outputs.documentdb.v20150401.ColumnResponse[];
    /**
     * List of partition key.
     */
    partitionKeys?: outputs.documentdb.v20150401.CassandraPartitionKeyResponse[];
}
...
export interface IncludedPathResponse {
     ...
     */
    indexes?: outputs.documentdb.v20150401.IndexesResponse[];
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: string;
...
export interface IndexingPolicyResponse {
     ...
     */
    excludedPaths?: outputs.documentdb.v20150401.ExcludedPathResponse[];
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: outputs.documentdb.v20150401.IncludedPathResponse[];
    /**
...
export interface MongoIndexResponse {
     ...
     */
    key?: outputs.documentdb.v20150401.MongoIndexKeysResponse;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: outputs.documentdb.v20150401.MongoIndexOptionsResponse;
}
...
export interface UniqueKeyPolicyResponse {
     ...
     */
    uniqueKeys?: outputs.documentdb.v20150401.UniqueKeyResponse[];
}
