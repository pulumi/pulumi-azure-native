...
export interface AnalyticalStorageConfigurationArgs {
     ...
     */
    schemaType?: pulumi.Input<string | enums.documentdb.v20220815.AnalyticalStorageSchemaType>;
}
...
export interface ApiPropertiesArgs {
     ...
     */
    serverVersion?: pulumi.Input<string | enums.documentdb.v20220815.ServerVersion>;
}
...
export interface BackupPolicyMigrationStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.documentdb.v20220815.BackupPolicyMigrationStatus>;
    /**
     * Describes the target backup policy type of the backup policy migration.
     */
    targetType?: pulumi.Input<string | enums.documentdb.v20220815.BackupPolicyType>;
}
...
export interface CassandraSchemaArgs {
     ...
     * List of cluster key.
     */
    clusterKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.ClusterKeyArgs>[]>;
    /**
     * List of Cassandra table columns.
     */
    columns?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.ColumnArgs>[]>;
    /**
     * List of partition key.
     */
    partitionKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.CassandraPartitionKeyArgs>[]>;
}
...
export interface CassandraTableResourceArgs {
     ...
     */
    schema?: pulumi.Input<inputs.documentdb.v20220815.CassandraSchemaArgs>;
}
...
export interface ClusterResourcePropertiesArgs {
     ...
     */
    authenticationMethod?: pulumi.Input<string | enums.documentdb.v20220815.AuthenticationMethod>;
    /**
     ...
     */
    clientCertificates?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.CertificateArgs>[]>;
    /**
     ...
     */
    externalGossipCertificates?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.CertificateArgs>[]>;
    /**
     * List of IP addresses of seed nodes in unmanaged data centers. These will be added to the seed node lists of all managed nodes.
     */
    externalSeedNodes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.SeedNodeArgs>[]>;
    /**
     ...
     */
    prometheusEndpoint?: pulumi.Input<inputs.documentdb.v20220815.SeedNodeArgs>;
    /**
     * The status of the resource at the time the operation was called.
     */
    provisioningState?: pulumi.Input<string | enums.documentdb.v20220815.ManagedCassandraProvisioningState>;
    /**
...
export interface CompositePathArgs {
     ...
     */
    order?: pulumi.Input<string | enums.documentdb.v20220815.CompositePathSortOrder>;
    /**
...
export interface ConflictResolutionPolicyArgs {
     ...
     */
    mode?: pulumi.Input<string | enums.documentdb.v20220815.ConflictResolutionMode>;
}
/**
...
export interface ConsistencyPolicyArgs {
     ...
     */
    defaultConsistencyLevel: pulumi.Input<enums.documentdb.v20220815.DefaultConsistencyLevel>;
    /**
...
export interface ContainerPartitionKeyArgs {
     ...
     */
    kind?: pulumi.Input<string | enums.documentdb.v20220815.PartitionKind>;
    /**
...
export interface ContinuousModeBackupPolicyArgs {
     ...
     * The object representing the state of the migration between the backup policies.
     */
    migrationState?: pulumi.Input<inputs.documentdb.v20220815.BackupPolicyMigrationStateArgs>;
    /**
...
export interface CreateUpdateOptionsArgs {
     ...
     */
    autoscaleSettings?: pulumi.Input<inputs.documentdb.v20220815.AutoscaleSettingsArgs>;
    /**
...
export interface GremlinGraphResourceArgs {
     ...
     */
    conflictResolutionPolicy?: pulumi.Input<inputs.documentdb.v20220815.ConflictResolutionPolicyArgs>;
    /**
     ...
     */
    indexingPolicy?: pulumi.Input<inputs.documentdb.v20220815.IndexingPolicyArgs>;
    /**
     * The configuration of the partition key to be used for partitioning data into multiple partitions
     */
    partitionKey?: pulumi.Input<inputs.documentdb.v20220815.ContainerPartitionKeyArgs>;
    /**
     * The unique key policy configuration for specifying uniqueness constraints on documents in the collection in the Azure Cosmos DB service.
     */
    uniqueKeyPolicy?: pulumi.Input<inputs.documentdb.v20220815.UniqueKeyPolicyArgs>;
}
/**
...
export function gremlinGraphResourceArgsProvideDefaults(val: GremlinGraphResourceArgs): GremlinGraphResourceArgs {
    return {
        ...val,
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? pulumi.output(val.conflictResolutionPolicy).apply(inputs.documentdb.v20220815.conflictResolutionPolicyArgsProvideDefaults) : undefined),
        indexingPolicy: (val.indexingPolicy ? pulumi.output(val.indexingPolicy).apply(inputs.documentdb.v20220815.indexingPolicyArgsProvideDefaults) : undefined),
        partitionKey: (val.partitionKey ? pulumi.output(val.partitionKey).apply(inputs.documentdb.v20220815.containerPartitionKeyArgsProvideDefaults) : undefined),
    };
}
...
export interface IncludedPathArgs {
     ...
     */
    indexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.IndexesArgs>[]>;
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: pulumi.Input<string>;
...
export interface IndexesArgs {
     ...
     */
    dataType?: pulumi.Input<string | enums.documentdb.v20220815.DataType>;
    /**
     * Indicates the type of index.
     */
    kind?: pulumi.Input<string | enums.documentdb.v20220815.IndexKind>;
    /**
...
export interface IndexingPolicyArgs {
     ...
     */
    compositeIndexes?: pulumi.Input<pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.CompositePathArgs>[]>[]>;
    /**
     * List of paths to exclude from indexing
     */
    excludedPaths?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.ExcludedPathArgs>[]>;
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.IncludedPathArgs>[]>;
    /**
     * Indicates the indexing mode.
     */
    indexingMode?: pulumi.Input<string | enums.documentdb.v20220815.IndexingMode>;
    /**
     * List of spatial specifics
     */
    spatialIndexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.SpatialSpecArgs>[]>;
}
/**
...
export interface ManagedCassandraManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.documentdb.v20220815.ManagedCassandraResourceIdentityType>;
}
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20220815.ResourceIdentityType>;
    /**
...
export interface MongoDBCollectionResourceArgs {
     ...
     * List of index keys
     */
    indexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.MongoIndexArgs>[]>;
    /**
...
export interface MongoIndexArgs {
     ...
     */
    key?: pulumi.Input<inputs.documentdb.v20220815.MongoIndexKeysArgs>;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: pulumi.Input<inputs.documentdb.v20220815.MongoIndexOptionsArgs>;
}
...
export interface PeriodicModeBackupPolicyArgs {
     ...
     */
    periodicModeProperties?: pulumi.Input<inputs.documentdb.v20220815.PeriodicModePropertiesArgs>;
    /**
     * Describes the mode of backups.
...
export interface PeriodicModePropertiesArgs {
     ...
     */
    backupStorageRedundancy?: pulumi.Input<string | enums.documentdb.v20220815.BackupStorageRedundancy>;
}
...
export interface PrivilegeArgs {
     ...
     */
    resource?: pulumi.Input<inputs.documentdb.v20220815.PrivilegeResourceArgs>;
}
...
export interface RestoreParametersArgs {
     ...
     */
    databasesToRestore?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.DatabaseRestoreResourceArgs>[]>;
    /**
     * Describes the mode of the restore.
     */
    restoreMode?: pulumi.Input<string | enums.documentdb.v20220815.RestoreMode>;
    /**
...
export interface SpatialSpecArgs {
     ...
     */
    types?: pulumi.Input<pulumi.Input<string | enums.documentdb.v20220815.SpatialType>[]>;
}
...
export interface SqlTriggerResourceArgs {
     ...
     */
    triggerOperation?: pulumi.Input<string | enums.documentdb.v20220815.TriggerOperation>;
    /**
     * Type of the Trigger
     */
    triggerType?: pulumi.Input<string | enums.documentdb.v20220815.TriggerType>;
}
...
export interface UniqueKeyPolicyArgs {
     ...
     */
    uniqueKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.UniqueKeyArgs>[]>;
}
