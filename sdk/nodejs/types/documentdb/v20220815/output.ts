...
export interface CassandraKeyspaceGetPropertiesResponseOptions {
     ...
     */
    autoscaleSettings?: outputs.documentdb.v20220815.AutoscaleSettingsResponse;
    /**
...
export interface CassandraSchemaResponse {
     ...
     * List of cluster key.
     */
    clusterKeys?: outputs.documentdb.v20220815.ClusterKeyResponse[];
    /**
     * List of Cassandra table columns.
     */
    columns?: outputs.documentdb.v20220815.ColumnResponse[];
    /**
     * List of partition key.
     */
    partitionKeys?: outputs.documentdb.v20220815.CassandraPartitionKeyResponse[];
}
...
export interface CassandraTableGetPropertiesResponseResource {
     ...
     */
    schema?: outputs.documentdb.v20220815.CassandraSchemaResponse;
    /**
     * A system generated property that denotes the last updated timestamp of the resource.
     */
    ts: number;
...
export interface ClusterResourceResponseProperties {
     ...
     */
    clientCertificates?: outputs.documentdb.v20220815.CertificateResponse[];
    /**
     ...
     */
    externalGossipCertificates?: outputs.documentdb.v20220815.CertificateResponse[];
    /**
     * List of IP addresses of seed nodes in unmanaged data centers. These will be added to the seed node lists of all managed nodes.
     */
    externalSeedNodes?: outputs.documentdb.v20220815.SeedNodeResponse[];
    /**
     ...
     */
    gossipCertificates: outputs.documentdb.v20220815.CertificateResponse[];
    /**
     ...
     */
    prometheusEndpoint?: outputs.documentdb.v20220815.SeedNodeResponse;
    /**
     ...
     */
    seedNodes: outputs.documentdb.v20220815.SeedNodeResponse[];
}
...
export interface ContinuousModeBackupPolicyResponse {
     ...
     * The object representing the state of the migration between the backup policies.
     */
    migrationState?: outputs.documentdb.v20220815.BackupPolicyMigrationStateResponse;
    /**
...
export interface DataTransferServiceResourcePropertiesResponse {
     ...
     */
    locations: outputs.documentdb.v20220815.DataTransferRegionalServiceResourceResponse[];
    /**
...
export interface DatabaseAccountKeysMetadataResponse {
     ...
     */
    primaryMasterKey: outputs.documentdb.v20220815.AccountKeyMetadataResponse;
    /**
     * The metadata related to the Primary Read-Only Key for the given Cosmos DB database account.
     */
    primaryReadonlyMasterKey: outputs.documentdb.v20220815.AccountKeyMetadataResponse;
    /**
     * The metadata related to the Secondary Read-Write Key for the given Cosmos DB database account.
     */
    secondaryMasterKey: outputs.documentdb.v20220815.AccountKeyMetadataResponse;
    /**
     * The metadata related to the Secondary Read-Only Key for the given Cosmos DB database account.
     */
    secondaryReadonlyMasterKey: outputs.documentdb.v20220815.AccountKeyMetadataResponse;
}
...
export interface GraphAPIComputeServiceResourcePropertiesResponse {
     ...
     * An array that contains all of the locations for the service.
     */
    locations: outputs.documentdb.v20220815.GraphAPIComputeRegionalServiceResourceResponse[];
    /**
     * ServiceType for the service.
...
export interface GremlinGraphGetPropertiesResponseResource {
     ...
     */
    conflictResolutionPolicy?: outputs.documentdb.v20220815.ConflictResolutionPolicyResponse;
    /**
     ...
     */
    indexingPolicy?: outputs.documentdb.v20220815.IndexingPolicyResponse;
    /**
     * The configuration of the partition key to be used for partitioning data into multiple partitions
     */
    partitionKey?: outputs.documentdb.v20220815.ContainerPartitionKeyResponse;
    /**
     * A system generated property. A unique identifier.
     */
    rid: string;
     ...
     */
    uniqueKeyPolicy?: outputs.documentdb.v20220815.UniqueKeyPolicyResponse;
}
/**
...
export function gremlinGraphGetPropertiesResponseResourceProvideDefaults(val: GremlinGraphGetPropertiesResponseResource): GremlinGraphGetPropertiesResponseResource {
    return {
        ...val,
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? outputs.documentdb.v20220815.conflictResolutionPolicyResponseProvideDefaults(val.conflictResolutionPolicy) : undefined),
        indexingPolicy: (val.indexingPolicy ? outputs.documentdb.v20220815.indexingPolicyResponseProvideDefaults(val.indexingPolicy) : undefined),
        partitionKey: (val.partitionKey ? outputs.documentdb.v20220815.containerPartitionKeyResponseProvideDefaults(val.partitionKey) : undefined),
    };
}
...
export interface IncludedPathResponse {
     ...
     */
    indexes?: outputs.documentdb.v20220815.IndexesResponse[];
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: string;
...
export interface IndexingPolicyResponse {
     ...
     */
    compositeIndexes?: outputs.documentdb.v20220815.CompositePathResponse[][];
    /**
     * List of paths to exclude from indexing
     */
    excludedPaths?: outputs.documentdb.v20220815.ExcludedPathResponse[];
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: outputs.documentdb.v20220815.IncludedPathResponse[];
    /**
     ...
     */
    spatialIndexes?: outputs.documentdb.v20220815.SpatialSpecResponse[];
}
/**
...
export interface ManagedServiceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.documentdb.v20220815.ManagedServiceIdentityResponseUserAssignedIdentities};
}
...
export interface MaterializedViewsBuilderServiceResourcePropertiesResponse {
     ...
     * An array that contains all of the locations for the service.
     */
    locations: outputs.documentdb.v20220815.MaterializedViewsBuilderRegionalServiceResourceResponse[];
    /**
     * ServiceType for the service.
...
export interface MongoDBCollectionGetPropertiesResponseResource {
     ...
     * List of index keys
     */
    indexes?: outputs.documentdb.v20220815.MongoIndexResponse[];
    /**
     * A system generated property. A unique identifier.
     */
    rid: string;
...
export interface MongoIndexResponse {
     ...
     */
    key?: outputs.documentdb.v20220815.MongoIndexKeysResponse;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: outputs.documentdb.v20220815.MongoIndexOptionsResponse;
}
...
export interface PeriodicModeBackupPolicyResponse {
     ...
     */
    periodicModeProperties?: outputs.documentdb.v20220815.PeriodicModePropertiesResponse;
    /**
     * Describes the mode of backups.
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.documentdb.v20220815.PrivateEndpointPropertyResponse;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    privateLinkServiceConnectionState?: outputs.documentdb.v20220815.PrivateLinkServiceConnectionStatePropertyResponse;
    /**
...
export interface PrivilegeResponse {
     ...
     */
    resource?: outputs.documentdb.v20220815.PrivilegeResponseResource;
}
...
export interface RestoreParametersResponse {
     ...
     */
    databasesToRestore?: outputs.documentdb.v20220815.DatabaseRestoreResourceResponse[];
    /**
...
export interface SqlDedicatedGatewayServiceResourcePropertiesResponse {
     ...
     * An array that contains all of the locations for the service.
     */
    locations: outputs.documentdb.v20220815.SqlDedicatedGatewayRegionalServiceResourceResponse[];
    /**
     * ServiceType for the service.
...
export interface UniqueKeyPolicyResponse {
     ...
     */
    uniqueKeys?: outputs.documentdb.v20220815.UniqueKeyResponse[];
}
