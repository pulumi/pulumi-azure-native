...
export interface CassandraSchemaResponse {
     ...
     * List of cluster key.
     */
    clusterKeys?: outputs.documentdb.v20150408.ClusterKeyResponse[];
    /**
     * List of Cassandra table columns.
     */
    columns?: outputs.documentdb.v20150408.ColumnResponse[];
    /**
     * List of partition key.
     */
    partitionKeys?: outputs.documentdb.v20150408.CassandraPartitionKeyResponse[];
}
...
export interface IncludedPathResponse {
     ...
     */
    indexes?: outputs.documentdb.v20150408.IndexesResponse[];
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: string;
...
export interface IndexingPolicyResponse {
     ...
     */
    excludedPaths?: outputs.documentdb.v20150408.ExcludedPathResponse[];
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: outputs.documentdb.v20150408.IncludedPathResponse[];
    /**
...
export interface MongoIndexResponse {
     ...
     */
    key?: outputs.documentdb.v20150408.MongoIndexKeysResponse;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: outputs.documentdb.v20150408.MongoIndexOptionsResponse;
}
...
export interface UniqueKeyPolicyResponse {
     ...
     */
    uniqueKeys?: outputs.documentdb.v20150408.UniqueKeyResponse[];
}
