...
export interface CassandraSchemaArgs {
     ...
     * List of cluster key.
     */
    clusterKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20150408.ClusterKeyArgs>[]>;
    /**
     * List of Cassandra table columns.
     */
    columns?: pulumi.Input<pulumi.Input<inputs.documentdb.v20150408.ColumnArgs>[]>;
    /**
     * List of partition key.
     */
    partitionKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20150408.CassandraPartitionKeyArgs>[]>;
}
...
export interface CassandraTableResourceArgs {
     ...
     */
    schema?: pulumi.Input<inputs.documentdb.v20150408.CassandraSchemaArgs>;
}
...
export interface ConflictResolutionPolicyArgs {
     ...
     */
    mode?: pulumi.Input<string | enums.documentdb.v20150408.ConflictResolutionMode>;
}
/**
...
export interface ConsistencyPolicyArgs {
     ...
     */
    defaultConsistencyLevel: pulumi.Input<enums.documentdb.v20150408.DefaultConsistencyLevel>;
    /**
...
export interface ContainerPartitionKeyArgs {
     ...
     */
    kind?: pulumi.Input<string | enums.documentdb.v20150408.PartitionKind>;
    /**
...
export interface GremlinGraphResourceArgs {
     ...
     */
    conflictResolutionPolicy?: pulumi.Input<inputs.documentdb.v20150408.ConflictResolutionPolicyArgs>;
    /**
     ...
     */
    indexingPolicy?: pulumi.Input<inputs.documentdb.v20150408.IndexingPolicyArgs>;
    /**
     * The configuration of the partition key to be used for partitioning data into multiple partitions
     */
    partitionKey?: pulumi.Input<inputs.documentdb.v20150408.ContainerPartitionKeyArgs>;
    /**
     * The unique key policy configuration for specifying uniqueness constraints on documents in the collection in the Azure Cosmos DB service.
     */
    uniqueKeyPolicy?: pulumi.Input<inputs.documentdb.v20150408.UniqueKeyPolicyArgs>;
}
/**
...
export function gremlinGraphResourceArgsProvideDefaults(val: GremlinGraphResourceArgs): GremlinGraphResourceArgs {
    return {
        ...val,
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? pulumi.output(val.conflictResolutionPolicy).apply(inputs.documentdb.v20150408.conflictResolutionPolicyArgsProvideDefaults) : undefined),
        indexingPolicy: (val.indexingPolicy ? pulumi.output(val.indexingPolicy).apply(inputs.documentdb.v20150408.indexingPolicyArgsProvideDefaults) : undefined),
        partitionKey: (val.partitionKey ? pulumi.output(val.partitionKey).apply(inputs.documentdb.v20150408.containerPartitionKeyArgsProvideDefaults) : undefined),
    };
}
...
export interface IncludedPathArgs {
     ...
     */
    indexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20150408.IndexesArgs>[]>;
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: pulumi.Input<string>;
...
export interface IndexesArgs {
     ...
     */
    dataType?: pulumi.Input<string | enums.documentdb.v20150408.DataType>;
    /**
     * Indicates the type of index.
     */
    kind?: pulumi.Input<string | enums.documentdb.v20150408.IndexKind>;
    /**
...
export interface IndexingPolicyArgs {
     ...
     */
    excludedPaths?: pulumi.Input<pulumi.Input<inputs.documentdb.v20150408.ExcludedPathArgs>[]>;
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: pulumi.Input<pulumi.Input<inputs.documentdb.v20150408.IncludedPathArgs>[]>;
    /**
     * Indicates the indexing mode.
     */
    indexingMode?: pulumi.Input<string | enums.documentdb.v20150408.IndexingMode>;
}
/**
...
export interface MongoDBCollectionResourceArgs {
     ...
     * List of index keys
     */
    indexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20150408.MongoIndexArgs>[]>;
    /**
...
export interface MongoIndexArgs {
     ...
     */
    key?: pulumi.Input<inputs.documentdb.v20150408.MongoIndexKeysArgs>;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: pulumi.Input<inputs.documentdb.v20150408.MongoIndexOptionsArgs>;
}
...
export interface UniqueKeyPolicyArgs {
     ...
     */
    uniqueKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20150408.UniqueKeyArgs>[]>;
}
