...
export interface AnalyticalStorageConfigurationArgs {
     ...
     */
    schemaType?: pulumi.Input<string | enums.documentdb.v20220515.AnalyticalStorageSchemaType>;
}
...
export interface ApiPropertiesArgs {
     ...
     */
    serverVersion?: pulumi.Input<string | enums.documentdb.v20220515.ServerVersion>;
}
...
export interface BackupPolicyMigrationStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.documentdb.v20220515.BackupPolicyMigrationStatus>;
    /**
     * Describes the target backup policy type of the backup policy migration.
     */
    targetType?: pulumi.Input<string | enums.documentdb.v20220515.BackupPolicyType>;
}
...
export interface CassandraSchemaArgs {
     ...
     * List of cluster key.
     */
    clusterKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.ClusterKeyArgs>[]>;
    /**
     * List of Cassandra table columns.
     */
    columns?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.ColumnArgs>[]>;
    /**
     * List of partition key.
     */
    partitionKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.CassandraPartitionKeyArgs>[]>;
}
...
export interface CassandraTableResourceArgs {
     ...
     */
    schema?: pulumi.Input<inputs.documentdb.v20220515.CassandraSchemaArgs>;
}
...
export interface ClusterResourcePropertiesArgs {
     ...
     */
    authenticationMethod?: pulumi.Input<string | enums.documentdb.v20220515.AuthenticationMethod>;
    /**
     ...
     */
    clientCertificates?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.CertificateArgs>[]>;
    /**
     ...
     */
    externalGossipCertificates?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.CertificateArgs>[]>;
    /**
     * List of IP addresses of seed nodes in unmanaged data centers. These will be added to the seed node lists of all managed nodes.
     */
    externalSeedNodes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.SeedNodeArgs>[]>;
    /**
     ...
     */
    prometheusEndpoint?: pulumi.Input<inputs.documentdb.v20220515.SeedNodeArgs>;
    /**
     * The status of the resource at the time the operation was called.
     */
    provisioningState?: pulumi.Input<string | enums.documentdb.v20220515.ManagedCassandraProvisioningState>;
    /**
...
export interface CompositePathArgs {
     ...
     */
    order?: pulumi.Input<string | enums.documentdb.v20220515.CompositePathSortOrder>;
    /**
...
export interface ConflictResolutionPolicyArgs {
     ...
     */
    mode?: pulumi.Input<string | enums.documentdb.v20220515.ConflictResolutionMode>;
}
/**
...
export interface ConsistencyPolicyArgs {
     ...
     */
    defaultConsistencyLevel: pulumi.Input<enums.documentdb.v20220515.DefaultConsistencyLevel>;
    /**
...
export interface ContainerPartitionKeyArgs {
     ...
     */
    kind?: pulumi.Input<string | enums.documentdb.v20220515.PartitionKind>;
    /**
...
export interface ContinuousModeBackupPolicyArgs {
     ...
     * The object representing the state of the migration between the backup policies.
     */
    migrationState?: pulumi.Input<inputs.documentdb.v20220515.BackupPolicyMigrationStateArgs>;
    /**
...
export interface CreateUpdateOptionsArgs {
     ...
     */
    autoscaleSettings?: pulumi.Input<inputs.documentdb.v20220515.AutoscaleSettingsArgs>;
    /**
...
export interface GremlinGraphResourceArgs {
     ...
     */
    conflictResolutionPolicy?: pulumi.Input<inputs.documentdb.v20220515.ConflictResolutionPolicyArgs>;
    /**
     ...
     */
    indexingPolicy?: pulumi.Input<inputs.documentdb.v20220515.IndexingPolicyArgs>;
    /**
     * The configuration of the partition key to be used for partitioning data into multiple partitions
     */
    partitionKey?: pulumi.Input<inputs.documentdb.v20220515.ContainerPartitionKeyArgs>;
    /**
     * The unique key policy configuration for specifying uniqueness constraints on documents in the collection in the Azure Cosmos DB service.
     */
    uniqueKeyPolicy?: pulumi.Input<inputs.documentdb.v20220515.UniqueKeyPolicyArgs>;
}
/**
...
export function gremlinGraphResourceArgsProvideDefaults(val: GremlinGraphResourceArgs): GremlinGraphResourceArgs {
    return {
        ...val,
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? pulumi.output(val.conflictResolutionPolicy).apply(inputs.documentdb.v20220515.conflictResolutionPolicyArgsProvideDefaults) : undefined),
        indexingPolicy: (val.indexingPolicy ? pulumi.output(val.indexingPolicy).apply(inputs.documentdb.v20220515.indexingPolicyArgsProvideDefaults) : undefined),
        partitionKey: (val.partitionKey ? pulumi.output(val.partitionKey).apply(inputs.documentdb.v20220515.containerPartitionKeyArgsProvideDefaults) : undefined),
    };
}
...
export interface IncludedPathArgs {
     ...
     */
    indexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.IndexesArgs>[]>;
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: pulumi.Input<string>;
...
export interface IndexesArgs {
     ...
     */
    dataType?: pulumi.Input<string | enums.documentdb.v20220515.DataType>;
    /**
     * Indicates the type of index.
     */
    kind?: pulumi.Input<string | enums.documentdb.v20220515.IndexKind>;
    /**
...
export interface IndexingPolicyArgs {
     ...
     */
    compositeIndexes?: pulumi.Input<pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.CompositePathArgs>[]>[]>;
    /**
     * List of paths to exclude from indexing
     */
    excludedPaths?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.ExcludedPathArgs>[]>;
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.IncludedPathArgs>[]>;
    /**
     * Indicates the indexing mode.
     */
    indexingMode?: pulumi.Input<string | enums.documentdb.v20220515.IndexingMode>;
    /**
     * List of spatial specifics
     */
    spatialIndexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.SpatialSpecArgs>[]>;
}
/**
...
export interface ManagedCassandraManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.documentdb.v20220515.ManagedCassandraResourceIdentityType>;
}
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20220515.ResourceIdentityType>;
    /**
...
export interface MongoDBCollectionResourceArgs {
     ...
     * List of index keys
     */
    indexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.MongoIndexArgs>[]>;
    /**
...
export interface MongoIndexArgs {
     ...
     */
    key?: pulumi.Input<inputs.documentdb.v20220515.MongoIndexKeysArgs>;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: pulumi.Input<inputs.documentdb.v20220515.MongoIndexOptionsArgs>;
}
...
export interface PeriodicModeBackupPolicyArgs {
     ...
     */
    periodicModeProperties?: pulumi.Input<inputs.documentdb.v20220515.PeriodicModePropertiesArgs>;
    /**
     * Describes the mode of backups.
...
export interface PeriodicModePropertiesArgs {
     ...
     */
    backupStorageRedundancy?: pulumi.Input<string | enums.documentdb.v20220515.BackupStorageRedundancy>;
}
...
export interface RestoreParametersArgs {
     ...
     */
    databasesToRestore?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.DatabaseRestoreResourceArgs>[]>;
    /**
     * Describes the mode of the restore.
     */
    restoreMode?: pulumi.Input<string | enums.documentdb.v20220515.RestoreMode>;
    /**
...
export interface SpatialSpecArgs {
     ...
     */
    types?: pulumi.Input<pulumi.Input<string | enums.documentdb.v20220515.SpatialType>[]>;
}
...
export interface SqlTriggerResourceArgs {
     ...
     */
    triggerOperation?: pulumi.Input<string | enums.documentdb.v20220515.TriggerOperation>;
    /**
     * Type of the Trigger
     */
    triggerType?: pulumi.Input<string | enums.documentdb.v20220515.TriggerType>;
}
...
export interface UniqueKeyPolicyArgs {
     ...
     */
    uniqueKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515.UniqueKeyArgs>[]>;
}
