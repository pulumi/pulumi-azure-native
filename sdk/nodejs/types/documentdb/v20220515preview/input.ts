...
export interface AnalyticalStorageConfigurationArgs {
     ...
     */
    schemaType?: pulumi.Input<string | enums.documentdb.v20220515preview.AnalyticalStorageSchemaType>;
}
...
export interface ApiPropertiesArgs {
     ...
     */
    serverVersion?: pulumi.Input<string | enums.documentdb.v20220515preview.ServerVersion>;
}
...
export interface AuthenticationMethodLdapPropertiesArgs {
    ...
    serverCertificates?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.CertificateArgs>[]>;
    /**
...
export interface BackupPolicyMigrationStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.documentdb.v20220515preview.BackupPolicyMigrationStatus>;
    /**
     * Describes the target backup policy type of the backup policy migration.
     */
    targetType?: pulumi.Input<string | enums.documentdb.v20220515preview.BackupPolicyType>;
}
...
export interface CassandraSchemaArgs {
     ...
     * List of cluster key.
     */
    clusterKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.ClusterKeyArgs>[]>;
    /**
     * List of Cassandra table columns.
     */
    columns?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.ColumnArgs>[]>;
    /**
     * List of partition key.
     */
    partitionKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.CassandraPartitionKeyArgs>[]>;
}
...
export interface CassandraTableResourceArgs {
     ...
     */
    schema?: pulumi.Input<inputs.documentdb.v20220515preview.CassandraSchemaArgs>;
}
...
export interface ClientEncryptionPolicyArgs {
     ...
     */
    includedPaths: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.ClientEncryptionIncludedPathArgs>[]>;
    /**
...
export interface ClusterResourcePropertiesArgs {
     ...
     */
    authenticationMethod?: pulumi.Input<string | enums.documentdb.v20220515preview.AuthenticationMethod>;
    /**
     ...
     */
    clientCertificates?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.CertificateArgs>[]>;
    /**
     ...
     */
    externalGossipCertificates?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.CertificateArgs>[]>;
    /**
     * List of IP addresses of seed nodes in unmanaged data centers. These will be added to the seed node lists of all managed nodes.
     */
    externalSeedNodes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.SeedNodeArgs>[]>;
    /**
     ...
     */
    prometheusEndpoint?: pulumi.Input<inputs.documentdb.v20220515preview.SeedNodeArgs>;
    /**
     * The status of the resource at the time the operation was called.
     */
    provisioningState?: pulumi.Input<string | enums.documentdb.v20220515preview.ManagedCassandraProvisioningState>;
    /**
...
export interface CompositePathArgs {
     ...
     */
    order?: pulumi.Input<string | enums.documentdb.v20220515preview.CompositePathSortOrder>;
    /**
...
export interface ConflictResolutionPolicyArgs {
     ...
     */
    mode?: pulumi.Input<string | enums.documentdb.v20220515preview.ConflictResolutionMode>;
}
/**
...
export interface ConsistencyPolicyArgs {
     ...
     */
    defaultConsistencyLevel: pulumi.Input<enums.documentdb.v20220515preview.DefaultConsistencyLevel>;
    /**
...
export interface ContainerPartitionKeyArgs {
     ...
     */
    kind?: pulumi.Input<string | enums.documentdb.v20220515preview.PartitionKind>;
    /**
...
export interface ContinuousModeBackupPolicyArgs {
     ...
     */
    continuousModeProperties?: pulumi.Input<inputs.documentdb.v20220515preview.ContinuousModePropertiesArgs>;
    /**
     * The object representing the state of the migration between the backup policies.
     */
    migrationState?: pulumi.Input<inputs.documentdb.v20220515preview.BackupPolicyMigrationStateArgs>;
    /**
...
export interface ContinuousModePropertiesArgs {
     ...
     */
    tier?: pulumi.Input<string | enums.documentdb.v20220515preview.ContinuousTier>;
}
...
export interface CreateUpdateOptionsArgs {
     ...
     */
    autoscaleSettings?: pulumi.Input<inputs.documentdb.v20220515preview.AutoscaleSettingsArgs>;
    /**
...
export interface DataCenterResourcePropertiesArgs {
     ...
     * Ldap authentication method properties. This feature is in preview.
     */
    authenticationMethodLdapProperties?: pulumi.Input<inputs.documentdb.v20220515preview.AuthenticationMethodLdapPropertiesArgs>;
    /**
...
export interface DiagnosticLogSettingsArgs {
     ...
     */
    enableFullTextQuery?: pulumi.Input<enums.documentdb.v20220515preview.EnableFullTextQuery>;
}
...
export interface GremlinGraphResourceArgs {
     ...
     */
    conflictResolutionPolicy?: pulumi.Input<inputs.documentdb.v20220515preview.ConflictResolutionPolicyArgs>;
    /**
     ...
     */
    indexingPolicy?: pulumi.Input<inputs.documentdb.v20220515preview.IndexingPolicyArgs>;
    /**
     * The configuration of the partition key to be used for partitioning data into multiple partitions
     */
    partitionKey?: pulumi.Input<inputs.documentdb.v20220515preview.ContainerPartitionKeyArgs>;
    /**
     * The unique key policy configuration for specifying uniqueness constraints on documents in the collection in the Azure Cosmos DB service.
     */
    uniqueKeyPolicy?: pulumi.Input<inputs.documentdb.v20220515preview.UniqueKeyPolicyArgs>;
}
/**
...
export function gremlinGraphResourceArgsProvideDefaults(val: GremlinGraphResourceArgs): GremlinGraphResourceArgs {
    return {
        ...val,
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? pulumi.output(val.conflictResolutionPolicy).apply(inputs.documentdb.v20220515preview.conflictResolutionPolicyArgsProvideDefaults) : undefined),
        indexingPolicy: (val.indexingPolicy ? pulumi.output(val.indexingPolicy).apply(inputs.documentdb.v20220515preview.indexingPolicyArgsProvideDefaults) : undefined),
        partitionKey: (val.partitionKey ? pulumi.output(val.partitionKey).apply(inputs.documentdb.v20220515preview.containerPartitionKeyArgsProvideDefaults) : undefined),
    };
}
...
export interface IncludedPathArgs {
     ...
     */
    indexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.IndexesArgs>[]>;
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: pulumi.Input<string>;
...
export interface IndexesArgs {
     ...
     */
    dataType?: pulumi.Input<string | enums.documentdb.v20220515preview.DataType>;
    /**
     * Indicates the type of index.
     */
    kind?: pulumi.Input<string | enums.documentdb.v20220515preview.IndexKind>;
    /**
...
export interface IndexingPolicyArgs {
     ...
     */
    compositeIndexes?: pulumi.Input<pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.CompositePathArgs>[]>[]>;
    /**
     * List of paths to exclude from indexing
     */
    excludedPaths?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.ExcludedPathArgs>[]>;
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.IncludedPathArgs>[]>;
    /**
     * Indicates the indexing mode.
     */
    indexingMode?: pulumi.Input<string | enums.documentdb.v20220515preview.IndexingMode>;
    /**
     * List of spatial specifics
     */
    spatialIndexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.SpatialSpecArgs>[]>;
}
/**
...
export interface ManagedCassandraManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.documentdb.v20220515preview.ManagedCassandraResourceIdentityType>;
}
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20220515preview.ResourceIdentityType>;
    /**
...
export interface MongoDBCollectionResourceArgs {
     ...
     * List of index keys
     */
    indexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.MongoIndexArgs>[]>;
    /**
...
export interface MongoIndexArgs {
     ...
     */
    key?: pulumi.Input<inputs.documentdb.v20220515preview.MongoIndexKeysArgs>;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: pulumi.Input<inputs.documentdb.v20220515preview.MongoIndexOptionsArgs>;
}
...
export interface PeriodicModeBackupPolicyArgs {
     ...
     * Configuration values for periodic mode backup
     */
    periodicModeProperties?: pulumi.Input<inputs.documentdb.v20220515preview.PeriodicModePropertiesArgs>;
    /**
     * Describes the mode of backups.
...
export interface PeriodicModePropertiesArgs {
     ...
     */
    backupStorageRedundancy?: pulumi.Input<string | enums.documentdb.v20220515preview.BackupStorageRedundancy>;
}
...
export interface PrivilegeArgs {
     ...
     */
    resource?: pulumi.Input<inputs.documentdb.v20220515preview.PrivilegeResourceArgs>;
}
...
export interface RestoreParametersArgs {
     ...
     */
    databasesToRestore?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.DatabaseRestoreResourceArgs>[]>;
    /**
     * List of specific gremlin databases available for restore.
     */
    gremlinDatabasesToRestore?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.GremlinDatabaseRestoreResourceArgs>[]>;
    /**
     * Describes the mode of the restore.
     */
    restoreMode?: pulumi.Input<string | enums.documentdb.v20220515preview.RestoreMode>;
    /**
...
export interface SpatialSpecArgs {
     ...
     */
    types?: pulumi.Input<pulumi.Input<string | enums.documentdb.v20220515preview.SpatialType>[]>;
}
...
export interface SqlContainerResourceArgs {
     ...
     */
    clientEncryptionPolicy?: pulumi.Input<inputs.documentdb.v20220515preview.ClientEncryptionPolicyArgs>;
    /**
     * The conflict resolution policy for the container.
     */
    conflictResolutionPolicy?: pulumi.Input<inputs.documentdb.v20220515preview.ConflictResolutionPolicyArgs>;
...
export function sqlContainerResourceArgsProvideDefaults(val: SqlContainerResourceArgs): SqlContainerResourceArgs {
    return {
        ...val,
        clientEncryptionPolicy: (val.clientEncryptionPolicy ? pulumi.output(val.clientEncryptionPolicy).apply(inputs.documentdb.v20220515preview.clientEncryptionPolicyArgsProvideDefaults) : undefined),
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? pulumi.output(val.conflictResolutionPolicy).apply(inputs.documentdb.v20220515preview.conflictResolutionPolicyArgsProvideDefaults) : undefined),
        indexingPolicy: (val.indexingPolicy ? pulumi.output(val.indexingPolicy).apply(inputs.documentdb.v20220515preview.indexingPolicyArgsProvideDefaults) : undefined),
        partitionKey: (val.partitionKey ? pulumi.output(val.partitionKey).apply(inputs.documentdb.v20220515preview.containerPartitionKeyArgsProvideDefaults) : undefined),
    };
...
export interface SqlTriggerResourceArgs {
     ...
     */
    triggerOperation?: pulumi.Input<string | enums.documentdb.v20220515preview.TriggerOperation>;
    /**
     * Type of the Trigger
     */
    triggerType?: pulumi.Input<string | enums.documentdb.v20220515preview.TriggerType>;
}
...
export interface UniqueKeyPolicyArgs {
     ...
     */
    uniqueKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.UniqueKeyArgs>[]>;
}
