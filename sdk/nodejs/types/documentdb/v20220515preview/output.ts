...
export interface AuthenticationMethodLdapPropertiesResponse {
    ...
    serverCertificates?: outputs.documentdb.v20220515preview.CertificateResponse[];
    /**
...
export interface CassandraKeyspaceGetPropertiesResponseOptions {
     ...
     */
    autoscaleSettings?: outputs.documentdb.v20220515preview.AutoscaleSettingsResponse;
    /**
...
export interface CassandraSchemaResponse {
     ...
     * List of cluster key.
     */
    clusterKeys?: outputs.documentdb.v20220515preview.ClusterKeyResponse[];
    /**
     * List of Cassandra table columns.
     */
    columns?: outputs.documentdb.v20220515preview.ColumnResponse[];
    /**
     * List of partition key.
     */
    partitionKeys?: outputs.documentdb.v20220515preview.CassandraPartitionKeyResponse[];
}
...
export interface CassandraTableGetPropertiesResponseResource {
     ...
     */
    schema?: outputs.documentdb.v20220515preview.CassandraSchemaResponse;
    /**
     * A system generated property that denotes the last updated timestamp of the resource.
     */
    ts: number;
...
export interface ClientEncryptionPolicyResponse {
     ...
     */
    includedPaths: outputs.documentdb.v20220515preview.ClientEncryptionIncludedPathResponse[];
    /**
...
export interface ClusterResourceResponseProperties {
     ...
     */
    clientCertificates?: outputs.documentdb.v20220515preview.CertificateResponse[];
    /**
     ...
     */
    externalGossipCertificates?: outputs.documentdb.v20220515preview.CertificateResponse[];
    /**
     * List of IP addresses of seed nodes in unmanaged data centers. These will be added to the seed node lists of all managed nodes.
     */
    externalSeedNodes?: outputs.documentdb.v20220515preview.SeedNodeResponse[];
    /**
     ...
     */
    gossipCertificates: outputs.documentdb.v20220515preview.CertificateResponse[];
    /**
     ...
     */
    prometheusEndpoint?: outputs.documentdb.v20220515preview.SeedNodeResponse;
    /**
     ...
     */
    seedNodes: outputs.documentdb.v20220515preview.SeedNodeResponse[];
}
...
export interface ContinuousModeBackupPolicyResponse {
     ...
     */
    continuousModeProperties?: outputs.documentdb.v20220515preview.ContinuousModePropertiesResponse;
    /**
     * The object representing the state of the migration between the backup policies.
     */
    migrationState?: outputs.documentdb.v20220515preview.BackupPolicyMigrationStateResponse;
    /**
...
export interface DataCenterResourceResponseProperties {
     ...
     * Ldap authentication method properties. This feature is in preview.
     */
    authenticationMethodLdapProperties?: outputs.documentdb.v20220515preview.AuthenticationMethodLdapPropertiesResponse;
    /**
...
export interface DataTransferServiceResourcePropertiesResponse {
     ...
     */
    locations: outputs.documentdb.v20220515preview.DataTransferRegionalServiceResourceResponse[];
    /**
...
export interface DatabaseAccountKeysMetadataResponse {
     ...
     */
    primaryMasterKey?: outputs.documentdb.v20220515preview.AccountKeyMetadataResponse;
    /**
     * The metadata related to the Primary Read-Only Key for the given Cosmos DB database account.
     */
    primaryReadonlyMasterKey?: outputs.documentdb.v20220515preview.AccountKeyMetadataResponse;
    /**
     * The metadata related to the Secondary Read-Write Key for the given Cosmos DB database account.
     */
    secondaryMasterKey?: outputs.documentdb.v20220515preview.AccountKeyMetadataResponse;
    /**
     * The metadata related to the Secondary Read-Only Key for the given Cosmos DB database account.
     */
    secondaryReadonlyMasterKey?: outputs.documentdb.v20220515preview.AccountKeyMetadataResponse;
}
...
export interface GraphAPIComputeServiceResourcePropertiesResponse {
     ...
     * An array that contains all of the locations for the service.
     */
    locations: outputs.documentdb.v20220515preview.GraphAPIComputeRegionalServiceResourceResponse[];
    /**
     * ServiceType for the service.
...
export interface GremlinGraphGetPropertiesResponseResource {
     ...
     */
    conflictResolutionPolicy?: outputs.documentdb.v20220515preview.ConflictResolutionPolicyResponse;
    /**
     ...
     */
    indexingPolicy?: outputs.documentdb.v20220515preview.IndexingPolicyResponse;
    /**
     * The configuration of the partition key to be used for partitioning data into multiple partitions
     */
    partitionKey?: outputs.documentdb.v20220515preview.ContainerPartitionKeyResponse;
    /**
     * A system generated property. A unique identifier.
     */
    rid: string;
     ...
     */
    uniqueKeyPolicy?: outputs.documentdb.v20220515preview.UniqueKeyPolicyResponse;
}
/**
...
export function gremlinGraphGetPropertiesResponseResourceProvideDefaults(val: GremlinGraphGetPropertiesResponseResource): GremlinGraphGetPropertiesResponseResource {
    return {
        ...val,
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? outputs.documentdb.v20220515preview.conflictResolutionPolicyResponseProvideDefaults(val.conflictResolutionPolicy) : undefined),
        indexingPolicy: (val.indexingPolicy ? outputs.documentdb.v20220515preview.indexingPolicyResponseProvideDefaults(val.indexingPolicy) : undefined),
        partitionKey: (val.partitionKey ? outputs.documentdb.v20220515preview.containerPartitionKeyResponseProvideDefaults(val.partitionKey) : undefined),
    };
}
...
export interface IncludedPathResponse {
     ...
     */
    indexes?: outputs.documentdb.v20220515preview.IndexesResponse[];
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: string;
...
export interface IndexingPolicyResponse {
     ...
     */
    compositeIndexes?: outputs.documentdb.v20220515preview.CompositePathResponse[][];
    /**
     * List of paths to exclude from indexing
     */
    excludedPaths?: outputs.documentdb.v20220515preview.ExcludedPathResponse[];
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: outputs.documentdb.v20220515preview.IncludedPathResponse[];
    /**
     ...
     */
    spatialIndexes?: outputs.documentdb.v20220515preview.SpatialSpecResponse[];
}
/**
...
export interface ManagedServiceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.documentdb.v20220515preview.ManagedServiceIdentityResponseUserAssignedIdentities};
}
...
export interface MaterializedViewsBuilderServiceResourcePropertiesResponse {
     ...
     * An array that contains all of the locations for the service.
     */
    locations: outputs.documentdb.v20220515preview.MaterializedViewsBuilderRegionalServiceResourceResponse[];
    /**
     * ServiceType for the service.
...
export interface MongoDBCollectionGetPropertiesResponseResource {
     ...
     * List of index keys
     */
    indexes?: outputs.documentdb.v20220515preview.MongoIndexResponse[];
    /**
     * A system generated property. A unique identifier.
     */
    rid: string;
...
export interface MongoIndexResponse {
     ...
     */
    key?: outputs.documentdb.v20220515preview.MongoIndexKeysResponse;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: outputs.documentdb.v20220515preview.MongoIndexOptionsResponse;
}
...
export interface PeriodicModeBackupPolicyResponse {
     ...
     * Configuration values for periodic mode backup
     */
    periodicModeProperties?: outputs.documentdb.v20220515preview.PeriodicModePropertiesResponse;
    /**
     * Describes the mode of backups.
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.documentdb.v20220515preview.PrivateEndpointPropertyResponse;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    privateLinkServiceConnectionState?: outputs.documentdb.v20220515preview.PrivateLinkServiceConnectionStatePropertyResponse;
    /**
...
export interface PrivilegeResponse {
     ...
     */
    resource?: outputs.documentdb.v20220515preview.PrivilegeResponseResource;
}
...
export interface RestoreParametersResponse {
     ...
     */
    databasesToRestore?: outputs.documentdb.v20220515preview.DatabaseRestoreResourceResponse[];
    /**
     * List of specific gremlin databases available for restore.
     */
    gremlinDatabasesToRestore?: outputs.documentdb.v20220515preview.GremlinDatabaseRestoreResourceResponse[];
    /**
...
export interface SqlContainerGetPropertiesResponseResource {
     ...
     */
    clientEncryptionPolicy?: outputs.documentdb.v20220515preview.ClientEncryptionPolicyResponse;
    /**
     * The conflict resolution policy for the container.
     */
    conflictResolutionPolicy?: outputs.documentdb.v20220515preview.ConflictResolutionPolicyResponse;
...
export function sqlContainerGetPropertiesResponseResourceProvideDefaults(val: SqlContainerGetPropertiesResponseResource): SqlContainerGetPropertiesResponseResource {
    return {
        ...val,
        clientEncryptionPolicy: (val.clientEncryptionPolicy ? outputs.documentdb.v20220515preview.clientEncryptionPolicyResponseProvideDefaults(val.clientEncryptionPolicy) : undefined),
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? outputs.documentdb.v20220515preview.conflictResolutionPolicyResponseProvideDefaults(val.conflictResolutionPolicy) : undefined),
        indexingPolicy: (val.indexingPolicy ? outputs.documentdb.v20220515preview.indexingPolicyResponseProvideDefaults(val.indexingPolicy) : undefined),
        partitionKey: (val.partitionKey ? outputs.documentdb.v20220515preview.containerPartitionKeyResponseProvideDefaults(val.partitionKey) : undefined),
    };
...
export interface SqlDedicatedGatewayServiceResourcePropertiesResponse {
     ...
     * An array that contains all of the locations for the service.
     */
    locations: outputs.documentdb.v20220515preview.SqlDedicatedGatewayRegionalServiceResourceResponse[];
    /**
     * ServiceType for the service.
...
export interface UniqueKeyPolicyResponse {
     ...
     */
    uniqueKeys?: outputs.documentdb.v20220515preview.UniqueKeyResponse[];
}
