...
export interface CassandraSchemaResponse {
     ...
     * List of cluster key.
     */
    clusterKeys?: outputs.documentdb.v20160319.ClusterKeyResponse[];
    /**
     * List of Cassandra table columns.
     */
    columns?: outputs.documentdb.v20160319.ColumnResponse[];
    /**
     * List of partition key.
     */
    partitionKeys?: outputs.documentdb.v20160319.CassandraPartitionKeyResponse[];
}
...
export interface IncludedPathResponse {
     ...
     */
    indexes?: outputs.documentdb.v20160319.IndexesResponse[];
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: string;
...
export interface IndexingPolicyResponse {
     ...
     */
    excludedPaths?: outputs.documentdb.v20160319.ExcludedPathResponse[];
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: outputs.documentdb.v20160319.IncludedPathResponse[];
    /**
...
export interface MongoIndexResponse {
     ...
     */
    key?: outputs.documentdb.v20160319.MongoIndexKeysResponse;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: outputs.documentdb.v20160319.MongoIndexOptionsResponse;
}
...
export interface UniqueKeyPolicyResponse {
     ...
     */
    uniqueKeys?: outputs.documentdb.v20160319.UniqueKeyResponse[];
}
