...
export interface ApiPropertiesArgs {
     ...
     */
    serverVersion?: pulumi.Input<string | enums.documentdb.v20210401preview.ServerVersion>;
}
...
export interface CassandraSchemaArgs {
     ...
     * List of cluster key.
     */
    clusterKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.ClusterKeyArgs>[]>;
    /**
     * List of Cassandra table columns.
     */
    columns?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.ColumnArgs>[]>;
    /**
     * List of partition key.
     */
    partitionKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.CassandraPartitionKeyArgs>[]>;
}
...
export interface CassandraTableResourceArgs {
     ...
     */
    schema?: pulumi.Input<inputs.documentdb.v20210401preview.CassandraSchemaArgs>;
}
...
export interface ClusterResourcePropertiesArgs {
     ...
     */
    authenticationMethod?: pulumi.Input<string | enums.documentdb.v20210401preview.AuthenticationMethod>;
    /**
     ...
     */
    clientCertificates?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.CertificateArgs>[]>;
    /**
     ...
     */
    externalGossipCertificates?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.CertificateArgs>[]>;
    /**
     * List of IP addresses of seed nodes in unmanaged data centers. These will be added to the seed node lists of all managed nodes.
     */
    externalSeedNodes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.SeedNodeArgs>[]>;
    /**
     ...
     */
    prometheusEndpoint?: pulumi.Input<inputs.documentdb.v20210401preview.SeedNodeArgs>;
    /**
     * The status of the resource at the time the operation was called.
     */
    provisioningState?: pulumi.Input<string | enums.documentdb.v20210401preview.ManagedCassandraProvisioningState>;
    /**
...
export interface CompositePathArgs {
     ...
     */
    order?: pulumi.Input<string | enums.documentdb.v20210401preview.CompositePathSortOrder>;
    /**
...
export interface ConflictResolutionPolicyArgs {
     ...
     */
    mode?: pulumi.Input<string | enums.documentdb.v20210401preview.ConflictResolutionMode>;
}
/**
...
export interface ConsistencyPolicyArgs {
     ...
     */
    defaultConsistencyLevel: pulumi.Input<enums.documentdb.v20210401preview.DefaultConsistencyLevel>;
    /**
...
export interface ContainerPartitionKeyArgs {
     ...
     */
    kind?: pulumi.Input<string | enums.documentdb.v20210401preview.PartitionKind>;
    /**
...
export interface CreateUpdateOptionsArgs {
     ...
     */
    autoscaleSettings?: pulumi.Input<inputs.documentdb.v20210401preview.AutoscaleSettingsArgs>;
    /**
...
export interface DefaultRequestDatabaseAccountCreateUpdatePropertiesArgs {
     ...
     */
    apiProperties?: pulumi.Input<inputs.documentdb.v20210401preview.ApiPropertiesArgs>;
    /**
     * The object representing the policy for taking backups on an account.
     */
    backupPolicy?: pulumi.Input<inputs.documentdb.v20210401preview.ContinuousModeBackupPolicyArgs | inputs.documentdb.v20210401preview.PeriodicModeBackupPolicyArgs>;
    /**
     * List of Cosmos DB capabilities for the account
     */
    capabilities?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.CapabilityArgs>[]>;
    /**
     * The cassandra connector offer type for the Cosmos DB database C* account.
     */
    connectorOffer?: pulumi.Input<string | enums.documentdb.v20210401preview.ConnectorOffer>;
    /**
     * The consistency policy for the Cosmos DB account.
     */
    consistencyPolicy?: pulumi.Input<inputs.documentdb.v20210401preview.ConsistencyPolicyArgs>;
    /**
     * The CORS policy for the Cosmos DB database account.
     */
    cors?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.CorsPolicyArgs>[]>;
    /**
     ...
     */
    databaseAccountOfferType: pulumi.Input<enums.documentdb.v20210401preview.DatabaseAccountOfferType>;
    /**
     ...
     * List of IpRules.
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.IpAddressOrRangeArgs>[]>;
    /**
     ...
     */
    locations: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.LocationArgs>[]>;
    /**
     * Indicates what services are allowed to bypass firewall checks.
     */
    networkAclBypass?: pulumi.Input<enums.documentdb.v20210401preview.NetworkAclBypass>;
    /**
     ...
     */
    publicNetworkAccess?: pulumi.Input<string | enums.documentdb.v20210401preview.PublicNetworkAccess>;
    /**
     * List of Virtual Network ACL rules configured for the Cosmos DB account.
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.VirtualNetworkRuleArgs>[]>;
}
/**
...
export interface GremlinGraphResourceArgs {
     ...
     */
    conflictResolutionPolicy?: pulumi.Input<inputs.documentdb.v20210401preview.ConflictResolutionPolicyArgs>;
    /**
     ...
     */
    indexingPolicy?: pulumi.Input<inputs.documentdb.v20210401preview.IndexingPolicyArgs>;
    /**
     * The configuration of the partition key to be used for partitioning data into multiple partitions
     */
    partitionKey?: pulumi.Input<inputs.documentdb.v20210401preview.ContainerPartitionKeyArgs>;
    /**
     * The unique key policy configuration for specifying uniqueness constraints on documents in the collection in the Azure Cosmos DB service.
     */
    uniqueKeyPolicy?: pulumi.Input<inputs.documentdb.v20210401preview.UniqueKeyPolicyArgs>;
}
/**
...
export function gremlinGraphResourceArgsProvideDefaults(val: GremlinGraphResourceArgs): GremlinGraphResourceArgs {
    return {
        ...val,
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? pulumi.output(val.conflictResolutionPolicy).apply(inputs.documentdb.v20210401preview.conflictResolutionPolicyArgsProvideDefaults) : undefined),
        indexingPolicy: (val.indexingPolicy ? pulumi.output(val.indexingPolicy).apply(inputs.documentdb.v20210401preview.indexingPolicyArgsProvideDefaults) : undefined),
        partitionKey: (val.partitionKey ? pulumi.output(val.partitionKey).apply(inputs.documentdb.v20210401preview.containerPartitionKeyArgsProvideDefaults) : undefined),
    };
}
...
export interface IncludedPathArgs {
     ...
     */
    indexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.IndexesArgs>[]>;
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: pulumi.Input<string>;
...
export interface IndexesArgs {
     ...
     */
    dataType?: pulumi.Input<string | enums.documentdb.v20210401preview.DataType>;
    /**
     * Indicates the type of index.
     */
    kind?: pulumi.Input<string | enums.documentdb.v20210401preview.IndexKind>;
    /**
...
export interface IndexingPolicyArgs {
     ...
     */
    compositeIndexes?: pulumi.Input<pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.CompositePathArgs>[]>[]>;
    /**
     * List of paths to exclude from indexing
     */
    excludedPaths?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.ExcludedPathArgs>[]>;
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.IncludedPathArgs>[]>;
    /**
     * Indicates the indexing mode.
     */
    indexingMode?: pulumi.Input<string | enums.documentdb.v20210401preview.IndexingMode>;
    /**
     * List of spatial specifics
     */
    spatialIndexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.SpatialSpecArgs>[]>;
}
/**
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20210401preview.ResourceIdentityType>;
    /**
...
export interface MongoDBCollectionResourceArgs {
     ...
     * List of index keys
     */
    indexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.MongoIndexArgs>[]>;
    /**
...
export interface MongoIndexArgs {
     ...
     */
    key?: pulumi.Input<inputs.documentdb.v20210401preview.MongoIndexKeysArgs>;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: pulumi.Input<inputs.documentdb.v20210401preview.MongoIndexOptionsArgs>;
}
...
export interface PeriodicModeBackupPolicyArgs {
     ...
     */
    periodicModeProperties?: pulumi.Input<inputs.documentdb.v20210401preview.PeriodicModePropertiesArgs>;
    /**
     * Describes the mode of backups.
...
export interface PeriodicModePropertiesArgs {
     ...
     */
    backupStorageRedundancy?: pulumi.Input<string | enums.documentdb.v20210401preview.BackupStorageRedundancy>;
}
...
export interface RestoreParametersArgs {
     ...
     */
    databasesToRestore?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.DatabaseRestoreResourceArgs>[]>;
    /**
     * Describes the mode of the restore.
     */
    restoreMode?: pulumi.Input<string | enums.documentdb.v20210401preview.RestoreMode>;
    /**
...
export interface RestoreReqeustDatabaseAccountCreateUpdatePropertiesArgs {
     ...
     * Parameters to indicate the information about the restore.
     */
    restoreParameters?: pulumi.Input<inputs.documentdb.v20210401preview.RestoreParametersArgs>;
    /**
     * List of Virtual Network ACL rules configured for the Cosmos DB account.
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.VirtualNetworkRuleArgs>[]>;
...
export interface SpatialSpecArgs {
     ...
     */
    types?: pulumi.Input<pulumi.Input<string | enums.documentdb.v20210401preview.SpatialType>[]>;
}
...
export interface SqlTriggerResourceArgs {
     ...
     */
    triggerOperation?: pulumi.Input<string | enums.documentdb.v20210401preview.TriggerOperation>;
    /**
     * Type of the Trigger
     */
    triggerType?: pulumi.Input<string | enums.documentdb.v20210401preview.TriggerType>;
}
...
export interface UniqueKeyPolicyArgs {
     ...
     */
    uniqueKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.UniqueKeyArgs>[]>;
}
