...
export interface AnalyticalStorageConfigurationArgs {
     ...
     */
    schemaType?: pulumi.Input<string | enums.documentdb.v20211015preview.AnalyticalStorageSchemaType>;
}
...
export interface ApiPropertiesArgs {
     ...
     */
    serverVersion?: pulumi.Input<string | enums.documentdb.v20211015preview.ServerVersion>;
}
...
export interface AuthenticationMethodLdapPropertiesArgs {
    ...
    serverCertificates?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.CertificateArgs>[]>;
    /**
...
export interface BackupPolicyMigrationStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.documentdb.v20211015preview.BackupPolicyMigrationStatus>;
    /**
     * Describes the target backup policy type of the backup policy migration.
     */
    targetType?: pulumi.Input<string | enums.documentdb.v20211015preview.BackupPolicyType>;
}
...
export interface CassandraSchemaArgs {
     ...
     * List of cluster key.
     */
    clusterKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.ClusterKeyArgs>[]>;
    /**
     * List of Cassandra table columns.
     */
    columns?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.ColumnArgs>[]>;
    /**
     * List of partition key.
     */
    partitionKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.CassandraPartitionKeyArgs>[]>;
}
...
export interface CassandraTableResourceArgs {
     ...
     */
    schema?: pulumi.Input<inputs.documentdb.v20211015preview.CassandraSchemaArgs>;
}
...
export interface ClusterResourcePropertiesArgs {
     ...
     */
    authenticationMethod?: pulumi.Input<string | enums.documentdb.v20211015preview.AuthenticationMethod>;
    /**
     ...
     */
    clientCertificates?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.CertificateArgs>[]>;
    /**
     ...
     */
    externalGossipCertificates?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.CertificateArgs>[]>;
    /**
     * List of IP addresses of seed nodes in unmanaged data centers. These will be added to the seed node lists of all managed nodes.
     */
    externalSeedNodes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.SeedNodeArgs>[]>;
    /**
     ...
     */
    prometheusEndpoint?: pulumi.Input<inputs.documentdb.v20211015preview.SeedNodeArgs>;
    /**
     * The status of the resource at the time the operation was called.
     */
    provisioningState?: pulumi.Input<string | enums.documentdb.v20211015preview.ManagedCassandraProvisioningState>;
    /**
...
export interface CompositePathArgs {
     ...
     */
    order?: pulumi.Input<string | enums.documentdb.v20211015preview.CompositePathSortOrder>;
    /**
...
export interface ConflictResolutionPolicyArgs {
     ...
     */
    mode?: pulumi.Input<string | enums.documentdb.v20211015preview.ConflictResolutionMode>;
}
/**
...
export interface ConsistencyPolicyArgs {
     ...
     */
    defaultConsistencyLevel: pulumi.Input<enums.documentdb.v20211015preview.DefaultConsistencyLevel>;
    /**
...
export interface ContainerPartitionKeyArgs {
     ...
     */
    kind?: pulumi.Input<string | enums.documentdb.v20211015preview.PartitionKind>;
    /**
...
export interface ContinuousModeBackupPolicyArgs {
     ...
     * The object representing the state of the migration between the backup policies.
     */
    migrationState?: pulumi.Input<inputs.documentdb.v20211015preview.BackupPolicyMigrationStateArgs>;
    /**
...
export interface CreateUpdateOptionsArgs {
     ...
     */
    autoscaleSettings?: pulumi.Input<inputs.documentdb.v20211015preview.AutoscaleSettingsArgs>;
    /**
...
export interface DataCenterResourcePropertiesArgs {
     ...
     * Ldap authentication method properties. This feature is in preview.
     */
    authenticationMethodLdapProperties?: pulumi.Input<inputs.documentdb.v20211015preview.AuthenticationMethodLdapPropertiesArgs>;
    /**
...
export interface DiagnosticLogSettingsArgs {
     ...
     */
    enableFullTextQuery?: pulumi.Input<enums.documentdb.v20211015preview.EnableFullTextQuery>;
}
...
export interface GremlinGraphResourceArgs {
     ...
     */
    conflictResolutionPolicy?: pulumi.Input<inputs.documentdb.v20211015preview.ConflictResolutionPolicyArgs>;
    /**
     ...
     */
    indexingPolicy?: pulumi.Input<inputs.documentdb.v20211015preview.IndexingPolicyArgs>;
    /**
     * The configuration of the partition key to be used for partitioning data into multiple partitions
     */
    partitionKey?: pulumi.Input<inputs.documentdb.v20211015preview.ContainerPartitionKeyArgs>;
    /**
     * The unique key policy configuration for specifying uniqueness constraints on documents in the collection in the Azure Cosmos DB service.
     */
    uniqueKeyPolicy?: pulumi.Input<inputs.documentdb.v20211015preview.UniqueKeyPolicyArgs>;
}
/**
...
export function gremlinGraphResourceArgsProvideDefaults(val: GremlinGraphResourceArgs): GremlinGraphResourceArgs {
    return {
        ...val,
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? pulumi.output(val.conflictResolutionPolicy).apply(inputs.documentdb.v20211015preview.conflictResolutionPolicyArgsProvideDefaults) : undefined),
        indexingPolicy: (val.indexingPolicy ? pulumi.output(val.indexingPolicy).apply(inputs.documentdb.v20211015preview.indexingPolicyArgsProvideDefaults) : undefined),
        partitionKey: (val.partitionKey ? pulumi.output(val.partitionKey).apply(inputs.documentdb.v20211015preview.containerPartitionKeyArgsProvideDefaults) : undefined),
    };
}
...
export interface IncludedPathArgs {
     ...
     */
    indexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.IndexesArgs>[]>;
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: pulumi.Input<string>;
...
export interface IndexesArgs {
     ...
     */
    dataType?: pulumi.Input<string | enums.documentdb.v20211015preview.DataType>;
    /**
     * Indicates the type of index.
     */
    kind?: pulumi.Input<string | enums.documentdb.v20211015preview.IndexKind>;
    /**
...
export interface IndexingPolicyArgs {
     ...
     */
    compositeIndexes?: pulumi.Input<pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.CompositePathArgs>[]>[]>;
    /**
     * List of paths to exclude from indexing
     */
    excludedPaths?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.ExcludedPathArgs>[]>;
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.IncludedPathArgs>[]>;
    /**
     * Indicates the indexing mode.
     */
    indexingMode?: pulumi.Input<string | enums.documentdb.v20211015preview.IndexingMode>;
    /**
     * List of spatial specifics
     */
    spatialIndexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.SpatialSpecArgs>[]>;
}
/**
...
export interface ManagedCassandraManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.documentdb.v20211015preview.ManagedCassandraResourceIdentityType>;
}
...
export interface ManagedServiceIdentityArgs {
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20211015preview.ResourceIdentityType>;
    /**
...
export interface MongoDBCollectionResourceArgs {
     ...
     * List of index keys
     */
    indexes?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.MongoIndexArgs>[]>;
    /**
...
export interface MongoIndexArgs {
     ...
     */
    key?: pulumi.Input<inputs.documentdb.v20211015preview.MongoIndexKeysArgs>;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: pulumi.Input<inputs.documentdb.v20211015preview.MongoIndexOptionsArgs>;
}
...
export interface PeriodicModeBackupPolicyArgs {
     ...
     */
    periodicModeProperties?: pulumi.Input<inputs.documentdb.v20211015preview.PeriodicModePropertiesArgs>;
    /**
     * Describes the mode of backups.
...
export interface PeriodicModePropertiesArgs {
     ...
     */
    backupStorageRedundancy?: pulumi.Input<string | enums.documentdb.v20211015preview.BackupStorageRedundancy>;
}
...
export interface PrivilegeArgs {
     ...
     */
    resource?: pulumi.Input<inputs.documentdb.v20211015preview.PrivilegeResourceArgs>;
}
...
export interface RestoreParametersArgs {
     ...
     */
    databasesToRestore?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.DatabaseRestoreResourceArgs>[]>;
    /**
     * Describes the mode of the restore.
     */
    restoreMode?: pulumi.Input<string | enums.documentdb.v20211015preview.RestoreMode>;
    /**
...
export interface SpatialSpecArgs {
     ...
     */
    types?: pulumi.Input<pulumi.Input<string | enums.documentdb.v20211015preview.SpatialType>[]>;
}
...
export interface SqlTriggerResourceArgs {
     ...
     */
    triggerOperation?: pulumi.Input<string | enums.documentdb.v20211015preview.TriggerOperation>;
    /**
     * Type of the Trigger
     */
    triggerType?: pulumi.Input<string | enums.documentdb.v20211015preview.TriggerType>;
}
...
export interface UniqueKeyPolicyArgs {
     ...
     */
    uniqueKeys?: pulumi.Input<pulumi.Input<inputs.documentdb.v20211015preview.UniqueKeyArgs>[]>;
}
