...
export interface CassandraKeyspaceGetPropertiesResponseOptions {
     ...
     */
    autoscaleSettings?: outputs.documentdb.v20210701preview.AutoscaleSettingsResponse;
    /**
...
export interface CassandraSchemaResponse {
     ...
     * List of cluster key.
     */
    clusterKeys?: outputs.documentdb.v20210701preview.ClusterKeyResponse[];
    /**
     * List of Cassandra table columns.
     */
    columns?: outputs.documentdb.v20210701preview.ColumnResponse[];
    /**
     * List of partition key.
     */
    partitionKeys?: outputs.documentdb.v20210701preview.CassandraPartitionKeyResponse[];
}
...
export interface CassandraTableGetPropertiesResponseResource {
     ...
     */
    schema?: outputs.documentdb.v20210701preview.CassandraSchemaResponse;
    /**
     * A system generated property that denotes the last updated timestamp of the resource.
     */
    ts: number;
...
export interface ClusterResourceResponseProperties {
     ...
     */
    clientCertificates?: outputs.documentdb.v20210701preview.CertificateResponse[];
    /**
     ...
     */
    externalGossipCertificates?: outputs.documentdb.v20210701preview.CertificateResponse[];
    /**
     * List of IP addresses of seed nodes in unmanaged data centers. These will be added to the seed node lists of all managed nodes.
     */
    externalSeedNodes?: outputs.documentdb.v20210701preview.SeedNodeResponse[];
    /**
     ...
     */
    gossipCertificates: outputs.documentdb.v20210701preview.CertificateResponse[];
    /**
     ...
     */
    prometheusEndpoint?: outputs.documentdb.v20210701preview.SeedNodeResponse;
    /**
     ...
     */
    seedNodes: outputs.documentdb.v20210701preview.SeedNodeResponse[];
}
...
export interface ContinuousModeBackupPolicyResponse {
     ...
     * The object representing the state of the migration between the backup policies.
     */
    migrationState?: outputs.documentdb.v20210701preview.BackupPolicyMigrationStateResponse;
    /**
...
export interface DataTransferServiceResourcePropertiesResponse {
     ...
     */
    locations: outputs.documentdb.v20210701preview.DataTransferRegionalServiceResourceResponse[];
    /**
...
export interface GraphAPIComputeServiceResourcePropertiesResponse {
     ...
     * An array that contains all of the locations for the service.
     */
    locations: outputs.documentdb.v20210701preview.GraphAPIComputeRegionalServiceResourceResponse[];
    /**
     * ServiceType for the service.
...
export interface GremlinGraphGetPropertiesResponseResource {
     ...
     */
    conflictResolutionPolicy?: outputs.documentdb.v20210701preview.ConflictResolutionPolicyResponse;
    /**
     ...
     */
    indexingPolicy?: outputs.documentdb.v20210701preview.IndexingPolicyResponse;
    /**
     * The configuration of the partition key to be used for partitioning data into multiple partitions
     */
    partitionKey?: outputs.documentdb.v20210701preview.ContainerPartitionKeyResponse;
    /**
     * A system generated property. A unique identifier.
     */
    rid: string;
     ...
     */
    uniqueKeyPolicy?: outputs.documentdb.v20210701preview.UniqueKeyPolicyResponse;
}
/**
...
export function gremlinGraphGetPropertiesResponseResourceProvideDefaults(val: GremlinGraphGetPropertiesResponseResource): GremlinGraphGetPropertiesResponseResource {
    return {
        ...val,
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? outputs.documentdb.v20210701preview.conflictResolutionPolicyResponseProvideDefaults(val.conflictResolutionPolicy) : undefined),
        indexingPolicy: (val.indexingPolicy ? outputs.documentdb.v20210701preview.indexingPolicyResponseProvideDefaults(val.indexingPolicy) : undefined),
        partitionKey: (val.partitionKey ? outputs.documentdb.v20210701preview.containerPartitionKeyResponseProvideDefaults(val.partitionKey) : undefined),
    };
}
...
export interface IncludedPathResponse {
     ...
     */
    indexes?: outputs.documentdb.v20210701preview.IndexesResponse[];
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: string;
...
export interface IndexingPolicyResponse {
     ...
     */
    compositeIndexes?: outputs.documentdb.v20210701preview.CompositePathResponse[][];
    /**
     * List of paths to exclude from indexing
     */
    excludedPaths?: outputs.documentdb.v20210701preview.ExcludedPathResponse[];
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: outputs.documentdb.v20210701preview.IncludedPathResponse[];
    /**
     ...
     */
    spatialIndexes?: outputs.documentdb.v20210701preview.SpatialSpecResponse[];
}
/**
...
export interface ManagedServiceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.documentdb.v20210701preview.ManagedServiceIdentityResponseUserAssignedIdentities};
}
...
export interface MongoDBCollectionGetPropertiesResponseResource {
     ...
     * List of index keys
     */
    indexes?: outputs.documentdb.v20210701preview.MongoIndexResponse[];
    /**
     * A system generated property. A unique identifier.
     */
    rid: string;
...
export interface MongoIndexResponse {
     ...
     */
    key?: outputs.documentdb.v20210701preview.MongoIndexKeysResponse;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: outputs.documentdb.v20210701preview.MongoIndexOptionsResponse;
}
...
export interface PeriodicModeBackupPolicyResponse {
     ...
     */
    periodicModeProperties?: outputs.documentdb.v20210701preview.PeriodicModePropertiesResponse;
    /**
     * Describes the mode of backups.
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.documentdb.v20210701preview.PrivateEndpointPropertyResponse;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    privateLinkServiceConnectionState?: outputs.documentdb.v20210701preview.PrivateLinkServiceConnectionStatePropertyResponse;
    /**
...
export interface RestoreParametersResponse {
     ...
     */
    databasesToRestore?: outputs.documentdb.v20210701preview.DatabaseRestoreResourceResponse[];
    /**
...
export interface SqlDedicatedGatewayServiceResourcePropertiesResponse {
     ...
     * An array that contains all of the locations for the service.
     */
    locations: outputs.documentdb.v20210701preview.SqlDedicatedGatewayRegionalServiceResourceResponse[];
    /**
     * ServiceType for the service.
...
export interface UniqueKeyPolicyResponse {
     ...
     */
    uniqueKeys?: outputs.documentdb.v20210701preview.UniqueKeyResponse[];
}
