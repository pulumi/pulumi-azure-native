...
export interface CassandraKeyspaceGetPropertiesResponseOptions {
     ...
     */
    autoscaleSettings?: outputs.documentdb.v20210315.AutoscaleSettingsResponse;
    /**
...
export interface CassandraSchemaResponse {
     ...
     * List of cluster key.
     */
    clusterKeys?: outputs.documentdb.v20210315.ClusterKeyResponse[];
    /**
     * List of Cassandra table columns.
     */
    columns?: outputs.documentdb.v20210315.ColumnResponse[];
    /**
     * List of partition key.
     */
    partitionKeys?: outputs.documentdb.v20210315.CassandraPartitionKeyResponse[];
}
...
export interface CassandraTableGetPropertiesResponseResource {
     ...
     */
    schema?: outputs.documentdb.v20210315.CassandraSchemaResponse;
    /**
     * A system generated property that denotes the last updated timestamp of the resource.
     */
    ts: number;
...
export interface GremlinGraphGetPropertiesResponseResource {
     ...
     */
    conflictResolutionPolicy?: outputs.documentdb.v20210315.ConflictResolutionPolicyResponse;
    /**
     ...
     */
    indexingPolicy?: outputs.documentdb.v20210315.IndexingPolicyResponse;
    /**
     * The configuration of the partition key to be used for partitioning data into multiple partitions
     */
    partitionKey?: outputs.documentdb.v20210315.ContainerPartitionKeyResponse;
    /**
     * A system generated property. A unique identifier.
     */
    rid: string;
     ...
     */
    uniqueKeyPolicy?: outputs.documentdb.v20210315.UniqueKeyPolicyResponse;
}
/**
...
export function gremlinGraphGetPropertiesResponseResourceProvideDefaults(val: GremlinGraphGetPropertiesResponseResource): GremlinGraphGetPropertiesResponseResource {
    return {
        ...val,
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? outputs.documentdb.v20210315.conflictResolutionPolicyResponseProvideDefaults(val.conflictResolutionPolicy) : undefined),
        indexingPolicy: (val.indexingPolicy ? outputs.documentdb.v20210315.indexingPolicyResponseProvideDefaults(val.indexingPolicy) : undefined),
        partitionKey: (val.partitionKey ? outputs.documentdb.v20210315.containerPartitionKeyResponseProvideDefaults(val.partitionKey) : undefined),
    };
}
...
export interface IncludedPathResponse {
     ...
     */
    indexes?: outputs.documentdb.v20210315.IndexesResponse[];
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: string;
...
export interface IndexingPolicyResponse {
     ...
     */
    compositeIndexes?: outputs.documentdb.v20210315.CompositePathResponse[][];
    /**
     * List of paths to exclude from indexing
     */
    excludedPaths?: outputs.documentdb.v20210315.ExcludedPathResponse[];
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: outputs.documentdb.v20210315.IncludedPathResponse[];
    /**
     ...
     */
    spatialIndexes?: outputs.documentdb.v20210315.SpatialSpecResponse[];
}
/**
...
export interface ManagedServiceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.documentdb.v20210315.ManagedServiceIdentityResponseUserAssignedIdentities};
}
...
export interface MongoDBCollectionGetPropertiesResponseResource {
     ...
     * List of index keys
     */
    indexes?: outputs.documentdb.v20210315.MongoIndexResponse[];
    /**
     * A system generated property. A unique identifier.
     */
    rid: string;
...
export interface MongoIndexResponse {
     ...
     */
    key?: outputs.documentdb.v20210315.MongoIndexKeysResponse;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: outputs.documentdb.v20210315.MongoIndexOptionsResponse;
}
...
export interface PeriodicModeBackupPolicyResponse {
     ...
     */
    periodicModeProperties?: outputs.documentdb.v20210315.PeriodicModePropertiesResponse;
    /**
     * Describes the mode of backups.
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.documentdb.v20210315.PrivateEndpointPropertyResponse;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    privateLinkServiceConnectionState?: outputs.documentdb.v20210315.PrivateLinkServiceConnectionStatePropertyResponse;
    /**
...
export interface UniqueKeyPolicyResponse {
     ...
     */
    uniqueKeys?: outputs.documentdb.v20210315.UniqueKeyResponse[];
}
