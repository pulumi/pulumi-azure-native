...
export interface AuthenticationMethodLdapPropertiesResponse {
    ...
    serverCertificates?: outputs.documentdb.v20220815preview.CertificateResponse[];
    /**
...
export interface CassandraKeyspaceGetPropertiesResponseOptions {
     ...
     */
    autoscaleSettings?: outputs.documentdb.v20220815preview.AutoscaleSettingsResponse;
    /**
...
export interface CassandraSchemaResponse {
     ...
     * List of cluster key.
     */
    clusterKeys?: outputs.documentdb.v20220815preview.ClusterKeyResponse[];
    /**
     * List of Cassandra table columns.
     */
    columns?: outputs.documentdb.v20220815preview.ColumnResponse[];
    /**
     * List of partition key.
     */
    partitionKeys?: outputs.documentdb.v20220815preview.CassandraPartitionKeyResponse[];
}
...
export interface CassandraTableGetPropertiesResponseResource {
     ...
     */
    schema?: outputs.documentdb.v20220815preview.CassandraSchemaResponse;
    /**
     * A system generated property that denotes the last updated timestamp of the resource.
     */
    ts: number;
...
export interface ClientEncryptionPolicyResponse {
     ...
     */
    includedPaths: outputs.documentdb.v20220815preview.ClientEncryptionIncludedPathResponse[];
    /**
...
/**
 * clientEncryptionPolicyResponseProvideDefaults sets the appropriate defaults for ClientEncryptionPolicyResponse
 */
export function clientEncryptionPolicyResponseProvideDefaults(val: ClientEncryptionPolicyResponse): ClientEncryptionPolicyResponse {
    return {
        ...val,
...
export interface ClusterResourceResponseProperties {
     ...
     */
    clientCertificates?: outputs.documentdb.v20220815preview.CertificateResponse[];
    /**
     ...
     */
    externalGossipCertificates?: outputs.documentdb.v20220815preview.CertificateResponse[];
    /**
     * List of IP addresses of seed nodes in unmanaged data centers. These will be added to the seed node lists of all managed nodes.
     */
    externalSeedNodes?: outputs.documentdb.v20220815preview.SeedNodeResponse[];
    /**
     ...
     */
    gossipCertificates: outputs.documentdb.v20220815preview.CertificateResponse[];
    /**
     ...
     */
    prometheusEndpoint?: outputs.documentdb.v20220815preview.SeedNodeResponse;
    /**
     ...
     */
    seedNodes: outputs.documentdb.v20220815preview.SeedNodeResponse[];
}
...
export interface ContinuousModeBackupPolicyResponse {
     ...
     */
    continuousModeProperties?: outputs.documentdb.v20220815preview.ContinuousModePropertiesResponse;
    /**
     * The object representing the state of the migration between the backup policies.
     */
    migrationState?: outputs.documentdb.v20220815preview.BackupPolicyMigrationStateResponse;
    /**
...
export interface DataCenterResourceResponseProperties {
     ...
     * Ldap authentication method properties. This feature is in preview.
     */
    authenticationMethodLdapProperties?: outputs.documentdb.v20220815preview.AuthenticationMethodLdapPropertiesResponse;
    /**
...
export interface DataTransferServiceResourcePropertiesResponse {
     ...
     */
    locations: outputs.documentdb.v20220815preview.DataTransferRegionalServiceResourceResponse[];
    /**
...
export interface DatabaseAccountKeysMetadataResponse {
     ...
     */
    primaryMasterKey: outputs.documentdb.v20220815preview.AccountKeyMetadataResponse;
    /**
     * The metadata related to the Primary Read-Only Key for the given Cosmos DB database account.
     */
    primaryReadonlyMasterKey: outputs.documentdb.v20220815preview.AccountKeyMetadataResponse;
    /**
     * The metadata related to the Secondary Read-Write Key for the given Cosmos DB database account.
     */
    secondaryMasterKey: outputs.documentdb.v20220815preview.AccountKeyMetadataResponse;
    /**
     * The metadata related to the Secondary Read-Only Key for the given Cosmos DB database account.
     */
    secondaryReadonlyMasterKey: outputs.documentdb.v20220815preview.AccountKeyMetadataResponse;
}
...
export interface GraphAPIComputeServiceResourcePropertiesResponse {
     ...
     * An array that contains all of the locations for the service.
     */
    locations: outputs.documentdb.v20220815preview.GraphAPIComputeRegionalServiceResourceResponse[];
    /**
     * ServiceType for the service.
...
export interface GremlinGraphGetPropertiesResponseResource {
     ...
     */
    conflictResolutionPolicy?: outputs.documentdb.v20220815preview.ConflictResolutionPolicyResponse;
    /**
     ...
     */
    indexingPolicy?: outputs.documentdb.v20220815preview.IndexingPolicyResponse;
    /**
     * The configuration of the partition key to be used for partitioning data into multiple partitions
     */
    partitionKey?: outputs.documentdb.v20220815preview.ContainerPartitionKeyResponse;
    /**
     * A system generated property. A unique identifier.
     */
    rid: string;
     ...
     */
    uniqueKeyPolicy?: outputs.documentdb.v20220815preview.UniqueKeyPolicyResponse;
}
/**
...
export function gremlinGraphGetPropertiesResponseResourceProvideDefaults(val: GremlinGraphGetPropertiesResponseResource): GremlinGraphGetPropertiesResponseResource {
    return {
        ...val,
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? outputs.documentdb.v20220815preview.conflictResolutionPolicyResponseProvideDefaults(val.conflictResolutionPolicy) : undefined),
        indexingPolicy: (val.indexingPolicy ? outputs.documentdb.v20220815preview.indexingPolicyResponseProvideDefaults(val.indexingPolicy) : undefined),
        partitionKey: (val.partitionKey ? outputs.documentdb.v20220815preview.containerPartitionKeyResponseProvideDefaults(val.partitionKey) : undefined),
    };
}
...
export interface IncludedPathResponse {
     ...
     */
    indexes?: outputs.documentdb.v20220815preview.IndexesResponse[];
    /**
     * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
     */
    path?: string;
...
export interface IndexingPolicyResponse {
     ...
     */
    compositeIndexes?: outputs.documentdb.v20220815preview.CompositePathResponse[][];
    /**
     * List of paths to exclude from indexing
     */
    excludedPaths?: outputs.documentdb.v20220815preview.ExcludedPathResponse[];
    /**
     * List of paths to include in the indexing
     */
    includedPaths?: outputs.documentdb.v20220815preview.IncludedPathResponse[];
    /**
     ...
     */
    spatialIndexes?: outputs.documentdb.v20220815preview.SpatialSpecResponse[];
}
/**
...
export interface ManagedServiceIdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.documentdb.v20220815preview.ManagedServiceIdentityResponseUserAssignedIdentities};
}
...
export interface MaterializedViewsBuilderServiceResourcePropertiesResponse {
     ...
     * An array that contains all of the locations for the service.
     */
    locations: outputs.documentdb.v20220815preview.MaterializedViewsBuilderRegionalServiceResourceResponse[];
    /**
     * ServiceType for the service.
...
export interface MongoDBCollectionGetPropertiesResponseResource {
     ...
     * List of index keys
     */
    indexes?: outputs.documentdb.v20220815preview.MongoIndexResponse[];
    /**
     * Parameters to indicate the information about the restore
     */
    restoreParameters?: outputs.documentdb.v20220815preview.ResourceRestoreParametersResponse;
    /**
     * A system generated property. A unique identifier.
     */
    rid: string;
...
export interface MongoIndexResponse {
     ...
     */
    key?: outputs.documentdb.v20220815preview.MongoIndexKeysResponse;
    /**
     * Cosmos DB MongoDB collection index key options
     */
    options?: outputs.documentdb.v20220815preview.MongoIndexOptionsResponse;
}
...
export interface PeriodicModeBackupPolicyResponse {
     ...
     * Configuration values for periodic mode backup
     */
    periodicModeProperties?: outputs.documentdb.v20220815preview.PeriodicModePropertiesResponse;
    /**
     * Describes the mode of backups.
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    privateEndpoint?: outputs.documentdb.v20220815preview.PrivateEndpointPropertyResponse;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    privateLinkServiceConnectionState?: outputs.documentdb.v20220815preview.PrivateLinkServiceConnectionStatePropertyResponse;
    /**
...
export interface PrivilegeResponse {
     ...
     */
    resource?: outputs.documentdb.v20220815preview.PrivilegeResponseResource;
}
...
export interface RestoreParametersResponse {
     ...
     */
    databasesToRestore?: outputs.documentdb.v20220815preview.DatabaseRestoreResourceResponse[];
    /**
     * List of specific gremlin databases available for restore.
     */
    gremlinDatabasesToRestore?: outputs.documentdb.v20220815preview.GremlinDatabaseRestoreResourceResponse[];
    /**
...
export interface SqlContainerGetPropertiesResponseResource {
     ...
     */
    clientEncryptionPolicy?: outputs.documentdb.v20220815preview.ClientEncryptionPolicyResponse;
    /**
     * The conflict resolution policy for the container.
     */
    conflictResolutionPolicy?: outputs.documentdb.v20220815preview.ConflictResolutionPolicyResponse;
...
export function sqlContainerGetPropertiesResponseResourceProvideDefaults(val: SqlContainerGetPropertiesResponseResource): SqlContainerGetPropertiesResponseResource {
    return {
        ...val,
        clientEncryptionPolicy: (val.clientEncryptionPolicy ? outputs.documentdb.v20220815preview.clientEncryptionPolicyResponseProvideDefaults(val.clientEncryptionPolicy) : undefined),
        conflictResolutionPolicy: (val.conflictResolutionPolicy ? outputs.documentdb.v20220815preview.conflictResolutionPolicyResponseProvideDefaults(val.conflictResolutionPolicy) : undefined),
        indexingPolicy: (val.indexingPolicy ? outputs.documentdb.v20220815preview.indexingPolicyResponseProvideDefaults(val.indexingPolicy) : undefined),
        partitionKey: (val.partitionKey ? outputs.documentdb.v20220815preview.containerPartitionKeyResponseProvideDefaults(val.partitionKey) : undefined),
    };
...
export interface SqlDedicatedGatewayServiceResourcePropertiesResponse {
     ...
     * An array that contains all of the locations for the service.
     */
    locations: outputs.documentdb.v20220815preview.SqlDedicatedGatewayRegionalServiceResourceResponse[];
    /**
     * ServiceType for the service.
...
export interface UniqueKeyPolicyResponse {
     ...
     */
    uniqueKeys?: outputs.documentdb.v20220815preview.UniqueKeyResponse[];
}
