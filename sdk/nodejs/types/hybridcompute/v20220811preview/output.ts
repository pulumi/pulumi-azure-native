...
export interface AgentConfigurationResponse {
     ...
     */
    extensionsAllowList: outputs.hybridcompute.v20220811preview.ConfigurationExtensionResponse[];
    /**
     * Array of extensions that are blocked (cannot be installed or updated)
     */
    extensionsBlockList: outputs.hybridcompute.v20220811preview.ConfigurationExtensionResponse[];
    /**
...
export interface ErrorDetailResponse {
     ...
     */
    additionalInfo: outputs.hybridcompute.v20220811preview.ErrorAdditionalInfoResponse[];
    /**
     * The error code.
     */
    code: string;
     ...
     * The error details.
     */
    details: outputs.hybridcompute.v20220811preview.ErrorDetailResponse[];
    /**
     * The error message.
     */
    message: string;
...
export interface HybridComputePrivateLinkScopePropertiesResponse {
     ...
     */
    privateEndpointConnections: outputs.hybridcompute.v20220811preview.PrivateEndpointConnectionDataModelResponse[];
    /**
...
export interface MachineExtensionInstanceViewResponse {
     ...
     */
    status?: outputs.hybridcompute.v20220811preview.MachineExtensionInstanceViewResponseStatus;
    /**
...
export interface MachineExtensionResponse {
     ...
     */
    instanceView?: outputs.hybridcompute.v20220811preview.MachineExtensionInstanceViewResponse;
    /**
     ...
     */
    systemData: outputs.hybridcompute.v20220811preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export interface OSProfileResponse {
     ...
     */
    linuxConfiguration?: outputs.hybridcompute.v20220811preview.OSProfileResponseLinuxConfiguration;
    /**
     * Specifies the windows configuration for update management.
     */
    windowsConfiguration?: outputs.hybridcompute.v20220811preview.OSProfileResponseWindowsConfiguration;
}
...
export interface PrivateEndpointConnectionDataModelResponse {
     ...
     */
    properties?: outputs.hybridcompute.v20220811preview.PrivateEndpointConnectionPropertiesResponse;
    /**
     * Azure resource type
     */
    type: string;
...
export interface PrivateEndpointConnectionPropertiesResponse {
     ...
     */
    privateEndpoint?: outputs.hybridcompute.v20220811preview.PrivateEndpointPropertyResponse;
    /**
     * Connection state of the private endpoint connection.
     */
    privateLinkServiceConnectionState?: outputs.hybridcompute.v20220811preview.PrivateLinkServiceConnectionStatePropertyResponse;
    /**
...
export interface ServiceStatusesResponse {
     ...
     */
    extensionService?: outputs.hybridcompute.v20220811preview.ServiceStatusResponse;
    /**
     * The state of the guest configuration service on the Arc-enabled machine.
     */
    guestConfigurationService?: outputs.hybridcompute.v20220811preview.ServiceStatusResponse;
}
