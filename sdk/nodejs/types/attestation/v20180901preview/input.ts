...
export interface AttestationServiceCreationSpecificParamsArgs {
     ...
     */
    attestationPolicy?: pulumi.Input<string>;
    /**
     ...
     */
    policySigningCertificates?: pulumi.Input<inputs.attestation.v20180901preview.JSONWebKeySetArgs>;
}
...
export interface JSONWebKeySetArgs {
     ...
     * desired.
     */
    keys?: pulumi.Input<pulumi.Input<inputs.attestation.v20180901preview.JSONWebKeyArgs>[]>;
}
