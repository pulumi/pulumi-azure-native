...
export interface AggregateFunctionPropertiesResponse {
     ...
     */
    binding?: outputs.streamanalytics.v20170401preview.AzureMachineLearningServiceFunctionBindingResponse | outputs.streamanalytics.v20170401preview.AzureMachineLearningStudioFunctionBindingResponse | outputs.streamanalytics.v20170401preview.CSharpFunctionBindingResponse | outputs.streamanalytics.v20170401preview.JavaScriptFunctionBindingResponse;
    /**
     * The current entity tag for the function. This is an opaque string. You can use it to detect whether the resource has changed between requests. You can also use it in the If-Match or If-None-Match headers for write operations for optimistic concurrency.
     */
    etag: string;
    inputs?: outputs.streamanalytics.v20170401preview.FunctionInputResponse[];
    /**
     * Describes the output of a function.
     */
    output?: outputs.streamanalytics.v20170401preview.FunctionOutputResponse;
    /**
...
export interface AzureMachineLearningServiceFunctionBindingResponse {
     ...
     */
    inputs?: outputs.streamanalytics.v20170401preview.AzureMachineLearningServiceInputColumnResponse[];
    /**
     ...
     */
    outputs?: outputs.streamanalytics.v20170401preview.AzureMachineLearningServiceOutputColumnResponse[];
    /**
...
export interface AzureMachineLearningStudioFunctionBindingResponse {
     ...
     */
    inputs?: outputs.streamanalytics.v20170401preview.AzureMachineLearningStudioInputsResponse;
    /**
     * A list of outputs from the Azure Machine Learning Studio endpoint execution.
     */
    outputs?: outputs.streamanalytics.v20170401preview.AzureMachineLearningStudioOutputColumnResponse[];
    /**
     * Indicates the function binding type.
...
export interface AzureMachineLearningStudioInputsResponse {
     ...
     */
    columnNames?: outputs.streamanalytics.v20170401preview.AzureMachineLearningStudioInputColumnResponse[];
    /**
...
export interface AzureSqlReferenceInputDataSourceResponse {
     ...
     * Describes Azure SQL database reference input data source properties.
     */
    properties?: outputs.streamanalytics.v20170401preview.AzureSqlReferenceInputDataSourcePropertiesResponse;
    /**
...
export interface BlobOutputDataSourceResponse {
     ...
     */
    storageAccounts?: outputs.streamanalytics.v20170401preview.StorageAccountResponse[];
    /**
...
export interface DiagnosticsResponse {
     ...
     */
    conditions: outputs.streamanalytics.v20170401preview.DiagnosticConditionResponse[];
}
...
export interface ExternalResponse {
     ...
     */
    storageAccount?: outputs.streamanalytics.v20170401preview.StorageAccountResponse;
}
...
export interface FunctionResponse {
     ...
     */
    properties?: outputs.streamanalytics.v20170401preview.AggregateFunctionPropertiesResponse | outputs.streamanalytics.v20170401preview.ScalarFunctionPropertiesResponse;
    /**
     * Resource type
     */
    type: string;
...
export interface InputResponse {
     ...
     */
    properties?: outputs.streamanalytics.v20170401preview.ReferenceInputPropertiesResponse | outputs.streamanalytics.v20170401preview.StreamInputPropertiesResponse;
    /**
     * Resource type
     */
    type: string;
...
export interface OutputResponse {
     ...
     * Describes conditions applicable to the Input, Output, or the job overall, that warrant customer attention.
     */
    diagnostics: outputs.streamanalytics.v20170401preview.DiagnosticsResponse;
    /**
     ...
     */
    serialization?: outputs.streamanalytics.v20170401preview.AvroSerializationResponse | outputs.streamanalytics.v20170401preview.CsvSerializationResponse | outputs.streamanalytics.v20170401preview.CustomClrSerializationResponse | outputs.streamanalytics.v20170401preview.JsonSerializationResponse | outputs.streamanalytics.v20170401preview.ParquetSerializationResponse;
    /**
...
export interface ReferenceInputPropertiesResponse {
     ...
     * Describes how input data is compressed
     */
    compression?: outputs.streamanalytics.v20170401preview.CompressionResponse;
    /**
     * Describes an input data source that contains reference data. Required on PUT (CreateOrReplace) requests.
     */
    datasource?: outputs.streamanalytics.v20170401preview.AzureSqlReferenceInputDataSourceResponse | outputs.streamanalytics.v20170401preview.BlobReferenceInputDataSourceResponse | outputs.streamanalytics.v20170401preview.RawReferenceInputDataSourceResponse;
    /**
     * Describes conditions applicable to the Input, Output, or the job overall, that warrant customer attention.
     */
    diagnostics: outputs.streamanalytics.v20170401preview.DiagnosticsResponse;
...
export interface StreamInputPropertiesResponse {
     ...
     */
    datasource?: outputs.streamanalytics.v20170401preview.BlobStreamInputDataSourceResponse | outputs.streamanalytics.v20170401preview.EventHubStreamInputDataSourceResponse | outputs.streamanalytics.v20170401preview.EventHubV2StreamInputDataSourceResponse | outputs.streamanalytics.v20170401preview.IoTHubStreamInputDataSourceResponse | outputs.streamanalytics.v20170401preview.RawStreamInputDataSourceResponse;
    /**
     * Describes conditions applicable to the Input, Output, or the job overall, that warrant customer attention.
     */
    diagnostics: outputs.streamanalytics.v20170401preview.DiagnosticsResponse;
