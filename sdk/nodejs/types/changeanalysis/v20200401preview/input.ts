...
export interface AzureMonitorWorkspacePropertiesArgs {
     ...
     */
    includeChangeDetails?: pulumi.Input<string | enums.changeanalysis.v20200401preview.ChangeDetailsMode>;
    /**
...
export interface ConfigurationProfileResourcePropertiesArgs {
     ...
     */
    notifications?: pulumi.Input<inputs.changeanalysis.v20200401preview.NotificationSettingsArgs>;
}
...
export interface NotificationSettingsArgs {
     ...
     */
    activationState?: pulumi.Input<string | enums.changeanalysis.v20200401preview.NotificationsState>;
    /**
     * Configuration properties of an Azure Monitor workspace that receives change notifications.
     */
    azureMonitorWorkspaceProperties?: pulumi.Input<inputs.changeanalysis.v20200401preview.AzureMonitorWorkspacePropertiesArgs>;
}
...
export interface ResourceIdentityArgs {
     ...
     */
    type?: pulumi.Input<string | enums.changeanalysis.v20200401preview.ManagedIdentityTypes>;
}
