...
export interface AutoShutdownProfileArgs {
     ...
     */
    shutdownOnDisconnect?: pulumi.Input<enums.labservices.v20211001preview.EnableState>;
    /**
     * Whether a VM will get shutdown when it has idled for a period of time.
     */
    shutdownOnIdle?: pulumi.Input<enums.labservices.v20211001preview.ShutdownOnIdleMode>;
    /**
     * Whether a VM will get shutdown when it hasn't been connected to after a period of time.
     */
    shutdownWhenNotConnected?: pulumi.Input<enums.labservices.v20211001preview.EnableState>;
}
/**
...
export interface ConnectionProfileArgs {
     ...
     */
    clientRdpAccess?: pulumi.Input<enums.labservices.v20211001preview.ConnectionType>;
    /**
     * The enabled access level for Client Access over SSH.
     */
    clientSshAccess?: pulumi.Input<enums.labservices.v20211001preview.ConnectionType>;
    /**
     * The enabled access level for Web Access over RDP.
     */
    webRdpAccess?: pulumi.Input<enums.labservices.v20211001preview.ConnectionType>;
    /**
     * The enabled access level for Web Access over SSH.
     */
    webSshAccess?: pulumi.Input<enums.labservices.v20211001preview.ConnectionType>;
}
/**
...
export interface RecurrencePatternArgs {
     ...
     */
    frequency: pulumi.Input<enums.labservices.v20211001preview.RecurrenceFrequency>;
    /**
     ...
     */
    weekDays?: pulumi.Input<pulumi.Input<enums.labservices.v20211001preview.WeekDay>[]>;
}
...
export interface SecurityProfileArgs {
     ...
     */
    openAccess?: pulumi.Input<enums.labservices.v20211001preview.EnableState>;
}
...
export interface SkuArgs {
     ...
     */
    tier?: pulumi.Input<enums.labservices.v20211001preview.SkuTier>;
}
...
export interface VirtualMachineAdditionalCapabilitiesArgs {
     ...
     */
    installGpuDrivers?: pulumi.Input<enums.labservices.v20211001preview.EnableState>;
}
/**
...
export interface VirtualMachineProfileArgs {
     ...
     */
    additionalCapabilities?: pulumi.Input<inputs.labservices.v20211001preview.VirtualMachineAdditionalCapabilitiesArgs>;
    /**
     * Credentials for the admin user on the VM.
     */
    adminUser: pulumi.Input<inputs.labservices.v20211001preview.CredentialsArgs>;
    /**
     * Indicates what lab virtual machines are created from.
     */
    createOption: pulumi.Input<enums.labservices.v20211001preview.CreateOption>;
    /**
     * The image configuration for lab virtual machines.
     */
    imageReference: pulumi.Input<inputs.labservices.v20211001preview.ImageReferenceArgs>;
    /**
     * Credentials for the non-admin user on the VM, if one exists.
     */
    nonAdminUser?: pulumi.Input<inputs.labservices.v20211001preview.CredentialsArgs>;
    /**
     * The SKU for the lab. Defines the type of virtual machines used in the lab.
     */
    sku: pulumi.Input<inputs.labservices.v20211001preview.SkuArgs>;
    /**
     ...
     */
    useSharedPassword?: pulumi.Input<enums.labservices.v20211001preview.EnableState>;
}
/**
...
export function virtualMachineProfileArgsProvideDefaults(val: VirtualMachineProfileArgs): VirtualMachineProfileArgs {
    return {
        ...val,
        additionalCapabilities: (val.additionalCapabilities ? pulumi.output(val.additionalCapabilities).apply(inputs.labservices.v20211001preview.virtualMachineAdditionalCapabilitiesArgsProvideDefaults) : undefined),
