...
export interface VirtualMachineProfileResponse {
     ...
     */
    additionalCapabilities?: outputs.labservices.v20220801.VirtualMachineAdditionalCapabilitiesResponse;
    /**
     * Credentials for the admin user on the VM.
     */
    adminUser: outputs.labservices.v20220801.CredentialsResponse;
    /**
     ...
     */
    imageReference: outputs.labservices.v20220801.ImageReferenceResponse;
    /**
     * Credentials for the non-admin user on the VM, if one exists.
     */
    nonAdminUser?: outputs.labservices.v20220801.CredentialsResponse;
    /**
     ...
     */
    sku: outputs.labservices.v20220801.SkuResponse;
    /**
...
export function virtualMachineProfileResponseProvideDefaults(val: VirtualMachineProfileResponse): VirtualMachineProfileResponse {
    return {
        ...val,
        additionalCapabilities: (val.additionalCapabilities ? outputs.labservices.v20220801.virtualMachineAdditionalCapabilitiesResponseProvideDefaults(val.additionalCapabilities) : undefined),
