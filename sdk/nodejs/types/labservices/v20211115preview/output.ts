...
export interface VirtualMachineProfileResponse {
     ...
     */
    additionalCapabilities?: outputs.labservices.v20211115preview.VirtualMachineAdditionalCapabilitiesResponse;
    /**
     * Credentials for the admin user on the VM.
     */
    adminUser: outputs.labservices.v20211115preview.CredentialsResponse;
    /**
     ...
     */
    imageReference: outputs.labservices.v20211115preview.ImageReferenceResponse;
    /**
     * Credentials for the non-admin user on the VM, if one exists.
     */
    nonAdminUser?: outputs.labservices.v20211115preview.CredentialsResponse;
    /**
     ...
     */
    sku: outputs.labservices.v20211115preview.SkuResponse;
    /**
...
export function virtualMachineProfileResponseProvideDefaults(val: VirtualMachineProfileResponse): VirtualMachineProfileResponse {
    return {
        ...val,
        additionalCapabilities: (val.additionalCapabilities ? outputs.labservices.v20211115preview.virtualMachineAdditionalCapabilitiesResponseProvideDefaults(val.additionalCapabilities) : undefined),
