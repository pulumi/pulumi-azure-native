...
export interface BackupSetInfoResponse {
     ...
     */
    listOfBackupFiles?: outputs.datamigration.v20220130preview.BackupFileInfoResponse[];
}
...
export interface ConnectToMongoDbTaskPropertiesResponse {
     ...
     */
    commands: (outputs.datamigration.v20220130preview.MigrateMISyncCompleteCommandPropertiesResponse | outputs.datamigration.v20220130preview.MigrateSyncCompleteCommandPropertiesResponse)[];
    /**
     * Array of errors. This is ignored if submitted.
     */
    errors: outputs.datamigration.v20220130preview.ODataErrorResponse[];
    /**
     * Describes a connection to a MongoDB data source
     */
    input?: outputs.datamigration.v20220130preview.MongoDbConnectionInfoResponse;
    /**
     * An array containing a single MongoDbClusterInfo object
     */
    output: outputs.datamigration.v20220130preview.MongoDbClusterInfoResponse[];
    /**
...
export function connectToMongoDbTaskPropertiesResponseProvideDefaults(val: ConnectToMongoDbTaskPropertiesResponse): ConnectToMongoDbTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.mongoDbConnectionInfoResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToSourceMySqlTaskInputResponse {
     ...
     */
    sourceConnectionInfo: outputs.datamigration.v20220130preview.MySqlConnectionInfoResponse;
    /**
...
export function connectToSourceMySqlTaskInputResponseProvideDefaults(val: ConnectToSourceMySqlTaskInputResponse): ConnectToSourceMySqlTaskInputResponse {
    return {
        ...
        sourceConnectionInfo: outputs.datamigration.v20220130preview.mySqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
    };
}
...
export interface ConnectToSourceMySqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ConnectToSourceMySqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ConnectToSourceNonSqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToSourceMySqlTaskPropertiesResponseProvideDefaults(val: ConnectToSourceMySqlTaskPropertiesResponse): ConnectToSourceMySqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.connectToSourceMySqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToSourceNonSqlTaskOutputResponse {
     ...
     * Server properties
     */
    serverProperties: outputs.datamigration.v20220130preview.ServerPropertiesResponse;
    /**
     ...
     */
    validationErrors: outputs.datamigration.v20220130preview.ReportableExceptionResponse[];
}
...
export interface ConnectToSourceOracleSyncTaskInputResponse {
     ...
     */
    sourceConnectionInfo: outputs.datamigration.v20220130preview.OracleConnectionInfoResponse;
}
...
export interface ConnectToSourceOracleSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ConnectToSourceOracleSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ConnectToSourceOracleSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface ConnectToSourcePostgreSqlSyncTaskInputResponse {
     ...
     */
    sourceConnectionInfo: outputs.datamigration.v20220130preview.PostgreSqlConnectionInfoResponse;
}
/**
...
export function connectToSourcePostgreSqlSyncTaskInputResponseProvideDefaults(val: ConnectToSourcePostgreSqlSyncTaskInputResponse): ConnectToSourcePostgreSqlSyncTaskInputResponse {
    return {
        ...val,
        sourceConnectionInfo: outputs.datamigration.v20220130preview.postgreSqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
    };
}
...
export interface ConnectToSourcePostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ConnectToSourcePostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ConnectToSourcePostgreSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToSourcePostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: ConnectToSourcePostgreSqlSyncTaskPropertiesResponse): ConnectToSourcePostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.connectToSourcePostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToSourceSqlServerSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ConnectToSourceSqlServerTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20220130preview.ConnectToSourceSqlServerTaskOutputAgentJobLevelResponse | outputs.datamigration.v20220130preview.ConnectToSourceSqlServerTaskOutputDatabaseLevelResponse | outputs.datamigration.v20220130preview.ConnectToSourceSqlServerTaskOutputLoginLevelResponse | outputs.datamigration.v20220130preview.ConnectToSourceSqlServerTaskOutputTaskLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToSourceSqlServerSyncTaskPropertiesResponseProvideDefaults(val: ConnectToSourceSqlServerSyncTaskPropertiesResponse): ConnectToSourceSqlServerSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.connectToSourceSqlServerTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToSourceSqlServerTaskInputResponse {
     ...
     */
    sourceConnectionInfo: outputs.datamigration.v20220130preview.SqlConnectionInfoResponse;
    /**
...
export function connectToSourceSqlServerTaskInputResponseProvideDefaults(val: ConnectToSourceSqlServerTaskInputResponse): ConnectToSourceSqlServerTaskInputResponse {
    return {
        ...
        sourceConnectionInfo: outputs.datamigration.v20220130preview.sqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
...
export interface ConnectToSourceSqlServerTaskOutputAgentJobLevelResponse {
     ...
     */
    migrationEligibility: outputs.datamigration.v20220130preview.MigrationEligibilityInfoResponse;
    /**
     * Agent Job name
     */
    name: string;
...
export interface ConnectToSourceSqlServerTaskOutputDatabaseLevelResponse {
     ...
     */
    databaseFiles: outputs.datamigration.v20220130preview.DatabaseFileInfoResponse[];
    /**
...
export interface ConnectToTargetAzureDbForMySqlTaskInputResponse {
     ...
     */
    targetConnectionInfo: outputs.datamigration.v20220130preview.MySqlConnectionInfoResponse;
}
/**
...
export function connectToTargetAzureDbForMySqlTaskInputResponseProvideDefaults(val: ConnectToTargetAzureDbForMySqlTaskInputResponse): ConnectToTargetAzureDbForMySqlTaskInputResponse {
    return {
        ...
        isOfflineMigration: (val.isOfflineMigration) ?? false,
        sourceConnectionInfo: outputs.datamigration.v20220130preview.mySqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
        targetConnectionInfo: outputs.datamigration.v20220130preview.mySqlConnectionInfoResponseProvideDefaults(val.targetConnectionInfo),
    };
}
...
export interface ConnectToTargetAzureDbForMySqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ConnectToTargetAzureDbForMySqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ConnectToTargetAzureDbForMySqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetAzureDbForMySqlTaskPropertiesResponseProvideDefaults(val: ConnectToTargetAzureDbForMySqlTaskPropertiesResponse): ConnectToTargetAzureDbForMySqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.connectToTargetAzureDbForMySqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse {
     ...
     */
    targetConnectionInfo: outputs.datamigration.v20220130preview.PostgreSqlConnectionInfoResponse;
}
/**
...
export function connectToTargetAzureDbForPostgreSqlSyncTaskInputResponseProvideDefaults(val: ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse): ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse {
    return {
        ...val,
        sourceConnectionInfo: outputs.datamigration.v20220130preview.postgreSqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
        targetConnectionInfo: outputs.datamigration.v20220130preview.postgreSqlConnectionInfoResponseProvideDefaults(val.targetConnectionInfo),
    };
}
...
export interface ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ConnectToTargetAzureDbForPostgreSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse): ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.connectToTargetAzureDbForPostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutputResponse {
     ...
     */
    databaseSchemaMap?: outputs.datamigration.v20220130preview.ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutputResponseDatabaseSchemaMap[];
    /**
     * List of databases on target server
     */
    databases: string[];
...
export interface ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetOracleAzureDbForPostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse): ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.connectToTargetOracleAzureDbForPostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetSqlDbTaskInputResponse {
     ...
     */
    targetConnectionInfo: outputs.datamigration.v20220130preview.SqlConnectionInfoResponse;
}
/**
...
export function connectToTargetSqlDbTaskInputResponseProvideDefaults(val: ConnectToTargetSqlDbTaskInputResponse): ConnectToTargetSqlDbTaskInputResponse {
    return {
        ...val,
        targetConnectionInfo: outputs.datamigration.v20220130preview.sqlConnectionInfoResponseProvideDefaults(val.targetConnectionInfo),
    };
}
...
export interface ConnectToTargetSqlDbTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ConnectToTargetSqlDbTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ConnectToTargetSqlDbTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetSqlDbTaskPropertiesResponseProvideDefaults(val: ConnectToTargetSqlDbTaskPropertiesResponse): ConnectToTargetSqlDbTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.connectToTargetSqlDbTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetSqlMISyncTaskInputResponse {
     ...
     */
    azureApp: outputs.datamigration.v20220130preview.AzureActiveDirectoryAppResponse;
    /**
     * Connection information for Azure SQL Database Managed Instance
     */
    targetConnectionInfo: outputs.datamigration.v20220130preview.MiSqlConnectionInfoResponse;
}
...
export interface ConnectToTargetSqlMISyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ConnectToTargetSqlMISyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ConnectToTargetSqlMISyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface ConnectToTargetSqlMITaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ConnectToTargetSqlMITaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ConnectToTargetSqlMITaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetSqlMITaskPropertiesResponseProvideDefaults(val: ConnectToTargetSqlMITaskPropertiesResponse): ConnectToTargetSqlMITaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.connectToTargetSqlMITaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ConnectToTargetSqlSqlDbSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ConnectToTargetSqlDbTaskOutputResponse[];
...
export function connectToTargetSqlSqlDbSyncTaskPropertiesResponseProvideDefaults(val: ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse): ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.connectToTargetSqlSqlDbSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface DataIntegrityValidationResultResponse {
     ...
     */
    validationErrors?: outputs.datamigration.v20220130preview.ValidationErrorResponse;
}
...
export interface ExecutionStatisticsResponse {
     ...
     */
    waitStats?: {[key: string]: outputs.datamigration.v20220130preview.WaitStatisticsResponse};
}
...
export interface GetTdeCertificatesSqlTaskInputResponse {
     ...
     */
    backupFileShare: outputs.datamigration.v20220130preview.FileShareResponse;
    /**
     * Connection information for SQL Server
     */
    connectionInfo: outputs.datamigration.v20220130preview.SqlConnectionInfoResponse;
    /**
     * List containing certificate names and corresponding password to use for encrypting the exported certificate.
     */
    selectedCertificates: outputs.datamigration.v20220130preview.SelectedCertificateInputResponse[];
}
/**
...
export function getTdeCertificatesSqlTaskInputResponseProvideDefaults(val: GetTdeCertificatesSqlTaskInputResponse): GetTdeCertificatesSqlTaskInputResponse {
    return {
        ...val,
        connectionInfo: outputs.datamigration.v20220130preview.sqlConnectionInfoResponseProvideDefaults(val.connectionInfo),
    };
}
...
export interface GetTdeCertificatesSqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.GetTdeCertificatesSqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.GetTdeCertificatesSqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getTdeCertificatesSqlTaskPropertiesResponseProvideDefaults(val: GetTdeCertificatesSqlTaskPropertiesResponse): GetTdeCertificatesSqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.getTdeCertificatesSqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface GetUserTablesMySqlTaskInputResponse {
     ...
     * Connection information for SQL Server
     */
    connectionInfo: outputs.datamigration.v20220130preview.MySqlConnectionInfoResponse;
    /**
...
export function getUserTablesMySqlTaskInputResponseProvideDefaults(val: GetUserTablesMySqlTaskInputResponse): GetUserTablesMySqlTaskInputResponse {
    return {
        ...val,
        connectionInfo: outputs.datamigration.v20220130preview.mySqlConnectionInfoResponseProvideDefaults(val.connectionInfo),
    };
}
...
export interface GetUserTablesMySqlTaskOutputResponse {
     ...
     */
    databasesToTables: {[key: string]: outputs.datamigration.v20220130preview.DatabaseTableResponse[]};
    /**
     * Result identifier
     */
    id: string;
...
export interface GetUserTablesMySqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.GetUserTablesMySqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.GetUserTablesMySqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getUserTablesMySqlTaskPropertiesResponseProvideDefaults(val: GetUserTablesMySqlTaskPropertiesResponse): GetUserTablesMySqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.getUserTablesMySqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface GetUserTablesOracleTaskInputResponse {
     ...
     * Information for connecting to Oracle source
     */
    connectionInfo: outputs.datamigration.v20220130preview.OracleConnectionInfoResponse;
    /**
...
export interface GetUserTablesOracleTaskOutputResponse {
     ...
     */
    tables: outputs.datamigration.v20220130preview.DatabaseTableResponse[];
    /**
     * Validation errors associated with the task
     */
    validationErrors: outputs.datamigration.v20220130preview.ReportableExceptionResponse[];
...
export interface GetUserTablesOracleTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.GetUserTablesOracleTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.GetUserTablesOracleTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface GetUserTablesPostgreSqlTaskInputResponse {
     ...
     */
    connectionInfo: outputs.datamigration.v20220130preview.PostgreSqlConnectionInfoResponse;
    /**
...
export function getUserTablesPostgreSqlTaskInputResponseProvideDefaults(val: GetUserTablesPostgreSqlTaskInputResponse): GetUserTablesPostgreSqlTaskInputResponse {
    return {
        ...val,
        connectionInfo: outputs.datamigration.v20220130preview.postgreSqlConnectionInfoResponseProvideDefaults(val.connectionInfo),
    };
}
...
export interface GetUserTablesPostgreSqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.GetUserTablesPostgreSqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.GetUserTablesPostgreSqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getUserTablesPostgreSqlTaskPropertiesResponseProvideDefaults(val: GetUserTablesPostgreSqlTaskPropertiesResponse): GetUserTablesPostgreSqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.getUserTablesPostgreSqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface GetUserTablesSqlSyncTaskOutputResponse {
     ...
     */
    databasesToSourceTables: {[key: string]: outputs.datamigration.v20220130preview.DatabaseTableResponse[]};
    /**
     * Mapping from database name to list of target tables
     */
    databasesToTargetTables: {[key: string]: outputs.datamigration.v20220130preview.DatabaseTableResponse[]};
    /**
...
export interface GetUserTablesSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.GetUserTablesSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.GetUserTablesSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getUserTablesSqlSyncTaskPropertiesResponseProvideDefaults(val: GetUserTablesSqlSyncTaskPropertiesResponse): GetUserTablesSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.getUserTablesSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface GetUserTablesSqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.GetUserTablesSqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.GetUserTablesSqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getUserTablesSqlTaskPropertiesResponseProvideDefaults(val: GetUserTablesSqlTaskPropertiesResponse): GetUserTablesSqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.getUserTablesSqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateMISyncCompleteCommandOutputResponse {
     ...
     */
    errors?: outputs.datamigration.v20220130preview.ReportableExceptionResponse[];
}
...
export interface MigrateMISyncCompleteCommandPropertiesResponse {
     ...
     * Command input
     */
    input?: outputs.datamigration.v20220130preview.MigrateMISyncCompleteCommandInputResponse;
    /**
     * Command output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.MigrateMISyncCompleteCommandOutputResponse;
    /**
...
export interface MigrateMongoDbTaskPropertiesResponse {
     ...
     */
    input?: outputs.datamigration.v20220130preview.MongoDbMigrationSettingsResponse;
    output: (outputs.datamigration.v20220130preview.MongoDbCollectionProgressResponse | outputs.datamigration.v20220130preview.MongoDbDatabaseProgressResponse | outputs.datamigration.v20220130preview.MongoDbMigrationProgressResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateMongoDbTaskPropertiesResponseProvideDefaults(val: MigrateMongoDbTaskPropertiesResponse): MigrateMongoDbTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.mongoDbMigrationSettingsResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskInputResponse {
     ...
     */
    selectedDatabases: outputs.datamigration.v20220130preview.MigrateMySqlAzureDbForMySqlOfflineDatabaseInputResponse[];
    /**
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskOutputDatabaseLevelResponse {
     ...
     */
    exceptionsAndWarnings: outputs.datamigration.v20220130preview.ReportableExceptionResponse[];
    /**
     * Result identifier
     */
    id: string;
     ...
     */
    objectSummary: {[key: string]: outputs.datamigration.v20220130preview.DataItemMigrationSummaryResultResponse};
    /**
     * Wildcard string prefix to use for querying all sub-tem results of the item
     */
    resultPrefix: string;
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskOutputErrorResponse {
     ...
     * Migration error
     */
    error: outputs.datamigration.v20220130preview.ReportableExceptionResponse;
    /**
     * Result identifier
     */
    id: string;
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskOutputMigrationLevelResponse {
     ...
     * Summary of database results in the migration
     */
    databaseSummary: {[key: string]: outputs.datamigration.v20220130preview.DatabaseSummaryResultResponse};
    /**
     ...
     */
    migrationReportResult?: outputs.datamigration.v20220130preview.MigrationReportResultResponse;
    /**
     * Result type
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.MigrateMySqlAzureDbForMySqlOfflineTaskInputResponse;
    /**
...
export function migrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponseProvideDefaults(val: MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse): MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.migrateMySqlAzureDbForMySqlOfflineTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateMySqlAzureDbForMySqlSyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20220130preview.MigrateMySqlAzureDbForMySqlSyncDatabaseInputResponse[];
    /**
     * Connection information for source MySQL
     */
    sourceConnectionInfo: outputs.datamigration.v20220130preview.MySqlConnectionInfoResponse;
...
export interface MigrateMySqlAzureDbForMySqlSyncTaskOutputDatabaseErrorResponse {
     ...
     */
    events?: outputs.datamigration.v20220130preview.SyncMigrationDatabaseErrorEventResponse[];
    /**
     * Result identifier
     */
    id: string;
...
export function migrateMySqlAzureDbForMySqlSyncTaskPropertiesResponseProvideDefaults(val: MigrateMySqlAzureDbForMySqlSyncTaskPropertiesResponse): MigrateMySqlAzureDbForMySqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.migrateMySqlAzureDbForMySqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export function migrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse): MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.migrateOracleAzureDbPostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateOracleAzureDbPostgreSqlSyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20220130preview.MigrateOracleAzureDbPostgreSqlSyncDatabaseInputResponse[];
    /**
...
export interface MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputResponse {
     ...
     */
    selectedTables?: outputs.datamigration.v20220130preview.MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInputResponse[];
    /**
     * Source settings to tune source endpoint migration behavior
     */
    sourceSetting?: {[key: string]: string};
...
export interface MigratePostgreSqlAzureDbForPostgreSqlSyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20220130preview.MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputResponse[];
    /**
...
export interface MigratePostgreSqlAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskInputResponse;
    /**
     * whether the task can be cloned or not
     */
    isCloneable?: boolean;
     ...
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20220130preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputDatabaseErrorResponse | outputs.datamigration.v20220130preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputDatabaseLevelResponse | outputs.datamigration.v20220130preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputErrorResponse | outputs.datamigration.v20220130preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevelResponse | outputs.datamigration.v20220130preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputTableLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migratePostgreSqlAzureDbForPostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: MigratePostgreSqlAzureDbForPostgreSqlSyncTaskPropertiesResponse): MigratePostgreSqlAzureDbForPostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.migratePostgreSqlAzureDbForPostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSqlServerSqlDbSyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20220130preview.MigrateSqlServerSqlDbSyncDatabaseInputResponse[];
    /**
     ...
     * Validation options
     */
    validationOptions?: outputs.datamigration.v20220130preview.MigrationValidationOptionsResponse;
}
/**
...
export interface MigrateSqlServerSqlDbSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.MigrateSqlServerSqlDbSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
...
export function migrateSqlServerSqlDbSyncTaskPropertiesResponseProvideDefaults(val: MigrateSqlServerSqlDbSyncTaskPropertiesResponse): MigrateSqlServerSqlDbSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.migrateSqlServerSqlDbSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSqlServerSqlDbTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20220130preview.MigrateSqlServerSqlDbDatabaseInputResponse[];
    /**
     * Information for connecting to source
     */
    sourceConnectionInfo: outputs.datamigration.v20220130preview.SqlConnectionInfoResponse;
...
export interface MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResultResponse {
     ...
     */
    dataIntegrityValidationResult: outputs.datamigration.v20220130preview.DataIntegrityValidationResultResponse;
    /**
     * Validation end time
     */
    endedOn: string;
     ...
     */
    queryAnalysisValidationResult: outputs.datamigration.v20220130preview.QueryAnalysisValidationResultResponse;
    /**
     * Result type
     ...
     */
    schemaValidationResult: outputs.datamigration.v20220130preview.SchemaComparisonValidationResultResponse;
    /**
...
export interface MigrateSqlServerSqlDbTaskOutputMigrationLevelResponse {
     ...
     */
    migrationValidationResult?: outputs.datamigration.v20220130preview.MigrationValidationResultResponse;
    /**
     * Result type
     * Expected value is 'MigrationLevelOutput'.
     */
...
export interface MigrateSqlServerSqlDbTaskOutputValidationResultResponse {
     ...
     */
    summaryResults?: {[key: string]: outputs.datamigration.v20220130preview.MigrationValidationDatabaseSummaryResultResponse};
}
...
export interface MigrateSqlServerSqlDbTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.MigrateSqlServerSqlDbTaskInputResponse;
    /**
     * whether the task can be cloned or not
     */
    isCloneable?: boolean;
...
export function migrateSqlServerSqlDbTaskPropertiesResponseProvideDefaults(val: MigrateSqlServerSqlDbTaskPropertiesResponse): MigrateSqlServerSqlDbTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.migrateSqlServerSqlDbTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSqlServerSqlMISyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20220130preview.MigrateSqlServerSqlMIDatabaseInputResponse[];
    /**
     * Connection information for source SQL Server
     */
    sourceConnectionInfo: outputs.datamigration.v20220130preview.SqlConnectionInfoResponse;
...
export interface MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse {
     ...
     */
    activeBackupSets: outputs.datamigration.v20220130preview.BackupSetInfoResponse[];
    /**
     ...
     */
    fullBackupSetInfo: outputs.datamigration.v20220130preview.BackupSetInfoResponse;
    /**
     * Result identifier
     */
    id: string;
     ...
     */
    lastRestoredBackupSetInfo: outputs.datamigration.v20220130preview.BackupSetInfoResponse;
    /**
...
export interface MigrateSqlServerSqlMISyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.MigrateSqlServerSqlMISyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20220130preview.MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse | outputs.datamigration.v20220130preview.MigrateSqlServerSqlMISyncTaskOutputErrorResponse | outputs.datamigration.v20220130preview.MigrateSqlServerSqlMISyncTaskOutputMigrationLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateSqlServerSqlMISyncTaskPropertiesResponseProvideDefaults(val: MigrateSqlServerSqlMISyncTaskPropertiesResponse): MigrateSqlServerSqlMISyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.migrateSqlServerSqlMISyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSqlServerSqlMITaskInputResponse {
     ...
     */
    backupBlobShare: outputs.datamigration.v20220130preview.BlobShareResponse;
    /**
     * Backup file share information for all selected databases.
     */
    backupFileShare?: outputs.datamigration.v20220130preview.FileShareResponse;
...
export interface MigrateSqlServerSqlMITaskOutputMigrationLevelResponse {
     ...
     */
    orphanedUsersInfo: outputs.datamigration.v20220130preview.OrphanedUserInfoResponse[];
    /**
     * Result type
     * Expected value is 'MigrationLevelOutput'.
     */
     ...
     */
    serverRoleResults: {[key: string]: outputs.datamigration.v20220130preview.StartMigrationScenarioServerRoleResultResponse};
    /**
     * Source server brand version
     */
    sourceServerBrandVersion: string;
...
export interface MigrateSqlServerSqlMITaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.MigrateSqlServerSqlMITaskInputResponse;
    /**
     * whether the task can be cloned or not
     */
    isCloneable?: boolean;
     ...
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20220130preview.MigrateSqlServerSqlMITaskOutputAgentJobLevelResponse | outputs.datamigration.v20220130preview.MigrateSqlServerSqlMITaskOutputDatabaseLevelResponse | outputs.datamigration.v20220130preview.MigrateSqlServerSqlMITaskOutputErrorResponse | outputs.datamigration.v20220130preview.MigrateSqlServerSqlMITaskOutputLoginLevelResponse | outputs.datamigration.v20220130preview.MigrateSqlServerSqlMITaskOutputMigrationLevelResponse)[];
    /**
     * parent task id
     */
    parentTaskId?: string;
...
export function migrateSqlServerSqlMITaskPropertiesResponseProvideDefaults(val: MigrateSqlServerSqlMITaskPropertiesResponse): MigrateSqlServerSqlMITaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.migrateSqlServerSqlMITaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSsisTaskInputResponse {
     ...
     */
    ssisMigrationInfo: outputs.datamigration.v20220130preview.SsisMigrationInfoResponse;
    /**
     * Information for connecting to target
     */
    targetConnectionInfo: outputs.datamigration.v20220130preview.SqlConnectionInfoResponse;
...
export interface MigrateSsisTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.MigrateSsisTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20220130preview.MigrateSsisTaskOutputMigrationLevelResponse | outputs.datamigration.v20220130preview.MigrateSsisTaskOutputProjectLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateSsisTaskPropertiesResponseProvideDefaults(val: MigrateSsisTaskPropertiesResponse): MigrateSsisTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.migrateSsisTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSyncCompleteCommandPropertiesResponse {
     ...
     * Command input
     */
    input?: outputs.datamigration.v20220130preview.MigrateSyncCompleteCommandInputResponse;
    /**
     * Command output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.MigrateSyncCompleteCommandOutputResponse;
    /**
     * The state of the command. This is ignored if submitted.
     */
    state: string;
...
export interface MongoDbClusterInfoResponse {
     ...
     */
    databases: outputs.datamigration.v20220130preview.MongoDbDatabaseInfoResponse[];
    /**
...
export interface MongoDbCollectionInfoResponse {
     ...
     */
    shardKey?: outputs.datamigration.v20220130preview.MongoDbShardKeyInfoResponse;
    /**
...
export interface MongoDbCollectionProgressResponse {
     ...
     */
    errors: {[key: string]: outputs.datamigration.v20220130preview.MongoDbErrorResponse};
    /**
...
export interface MongoDbCollectionSettingsResponse {
     ...
     */
    shardKey?: outputs.datamigration.v20220130preview.MongoDbShardKeySettingResponse;
    /**
...
export interface MongoDbDatabaseInfoResponse {
     ...
     */
    collections: outputs.datamigration.v20220130preview.MongoDbCollectionInfoResponse[];
    /**
     * The estimated total data size, in bytes, or -1 if the size is unknown.
     */
    dataSize: number;
...
export interface MongoDbDatabaseProgressResponse {
     ...
     */
    collections?: {[key: string]: outputs.datamigration.v20220130preview.MongoDbCollectionProgressResponse};
    /**
     * The number of documents copied during the Copying stage
     */
    documentsCopied: number;
...
export interface MongoDbDatabaseSettingsResponse {
     ...
     */
    collections: {[key: string]: outputs.datamigration.v20220130preview.MongoDbCollectionSettingsResponse};
    /**
...
export interface MongoDbMigrationProgressResponse {
     ...
     */
    databases?: {[key: string]: outputs.datamigration.v20220130preview.MongoDbDatabaseProgressResponse};
    /**
     * The number of documents copied during the Copying stage
     */
    documentsCopied: number;
...
export interface MongoDbMigrationSettingsResponse {
     ...
     */
    databases: {[key: string]: outputs.datamigration.v20220130preview.MongoDbDatabaseSettingsResponse};
    /**
     ...
     */
    source: outputs.datamigration.v20220130preview.MongoDbConnectionInfoResponse;
    /**
     * Settings used to connect to the target cluster
     */
    target: outputs.datamigration.v20220130preview.MongoDbConnectionInfoResponse;
    /**
     * Settings used to limit the resource usage of the migration
     */
    throttling?: outputs.datamigration.v20220130preview.MongoDbThrottlingSettingsResponse;
}
/**
...
export function mongoDbMigrationSettingsResponseProvideDefaults(val: MongoDbMigrationSettingsResponse): MongoDbMigrationSettingsResponse {
    return {
        ...val,
        source: outputs.datamigration.v20220130preview.mongoDbConnectionInfoResponseProvideDefaults(val.source),
        target: outputs.datamigration.v20220130preview.mongoDbConnectionInfoResponseProvideDefaults(val.target),
    };
}
...
export interface MongoDbShardKeyInfoResponse {
     ...
     */
    fields: outputs.datamigration.v20220130preview.MongoDbShardKeyFieldResponse[];
    /**
...
export interface ODataErrorResponse {
     ...
     */
    details?: outputs.datamigration.v20220130preview.ODataErrorResponse[];
    /**
...
export interface QueryAnalysisValidationResultResponse {
     ...
     */
    queryResults?: outputs.datamigration.v20220130preview.QueryExecutionResultResponse;
    /**
...
export interface QueryExecutionResultResponse {
     ...
     */
    sourceResult?: outputs.datamigration.v20220130preview.ExecutionStatisticsResponse;
    /**
     ...
     */
    targetResult?: outputs.datamigration.v20220130preview.ExecutionStatisticsResponse;
}
...
export interface SchemaComparisonValidationResultResponse {
     ...
     */
    schemaDifferences?: outputs.datamigration.v20220130preview.SchemaComparisonValidationResultTypeResponse;
    /**
...
export interface ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ValidateSyncMigrationInputSqlServerTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ValidateSyncMigrationInputSqlServerTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function validateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponseProvideDefaults(val: ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse): ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.validateSyncMigrationInputSqlServerTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ValidateMigrationInputSqlServerSqlMISyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ValidateMigrationInputSqlServerSqlMISyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function validateMigrationInputSqlServerSqlMISyncTaskPropertiesResponseProvideDefaults(val: ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse): ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.validateMigrationInputSqlServerSqlMISyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ValidateMigrationInputSqlServerSqlMITaskOutputResponse {
     ...
     */
    backupFolderErrors: outputs.datamigration.v20220130preview.ReportableExceptionResponse[];
    /**
     * Errors associated with backup share user name and password credentials
     */
    backupShareCredentialsErrors: outputs.datamigration.v20220130preview.ReportableExceptionResponse[];
    /**
     * Errors associated with the storage account provided.
     */
    backupStorageAccountErrors: outputs.datamigration.v20220130preview.ReportableExceptionResponse[];
    /**
     * Information about backup files when existing backup mode is used.
     */
    databaseBackupInfo?: outputs.datamigration.v20220130preview.DatabaseBackupInfoResponse;
    /**
     * Errors associated with existing backup files.
     */
    existingBackupErrors: outputs.datamigration.v20220130preview.ReportableExceptionResponse[];
    /**
     * Result identifier
     */
    id: string;
     ...
     */
    restoreDatabaseNameErrors: outputs.datamigration.v20220130preview.ReportableExceptionResponse[];
}
...
export interface ValidateMigrationInputSqlServerSqlMITaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20220130preview.ValidateMigrationInputSqlServerSqlMITaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20220130preview.ValidateMigrationInputSqlServerSqlMITaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function validateMigrationInputSqlServerSqlMITaskPropertiesResponseProvideDefaults(val: ValidateMigrationInputSqlServerSqlMITaskPropertiesResponse): ValidateMigrationInputSqlServerSqlMITaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20220130preview.validateMigrationInputSqlServerSqlMITaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ValidateMongoDbTaskPropertiesResponse {
     ...
     */
    output: outputs.datamigration.v20220130preview.MongoDbMigrationProgressResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface ValidateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     */
    output: outputs.datamigration.v20220130preview.ValidateOracleAzureDbPostgreSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
