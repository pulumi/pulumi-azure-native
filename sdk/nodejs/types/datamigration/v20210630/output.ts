...
export interface BackupSetInfoResponse {
     ...
     */
    listOfBackupFiles?: outputs.datamigration.v20210630.BackupFileInfoResponse[];
}
...
export interface ConnectToMongoDbTaskPropertiesResponse {
     ...
     */
    commands: (outputs.datamigration.v20210630.MigrateMISyncCompleteCommandPropertiesResponse | outputs.datamigration.v20210630.MigrateSyncCompleteCommandPropertiesResponse)[];
    /**
     * Array of errors. This is ignored if submitted.
     */
    errors: outputs.datamigration.v20210630.ODataErrorResponse[];
    /**
     * Describes a connection to a MongoDB data source
     */
    input?: outputs.datamigration.v20210630.MongoDbConnectionInfoResponse;
    /**
     * An array containing a single MongoDbClusterInfo object
     */
    output: outputs.datamigration.v20210630.MongoDbClusterInfoResponse[];
    /**
...
export interface ConnectToSourceMySqlTaskInputResponse {
     ...
     */
    sourceConnectionInfo: outputs.datamigration.v20210630.MySqlConnectionInfoResponse;
    /**
...
export function connectToSourceMySqlTaskInputResponseProvideDefaults(val: ConnectToSourceMySqlTaskInputResponse): ConnectToSourceMySqlTaskInputResponse {
    return {
        ...
        sourceConnectionInfo: outputs.datamigration.v20210630.mySqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
    };
}
...
export interface ConnectToSourceMySqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ConnectToSourceMySqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ConnectToSourceNonSqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToSourceMySqlTaskPropertiesResponseProvideDefaults(val: ConnectToSourceMySqlTaskPropertiesResponse): ConnectToSourceMySqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.connectToSourceMySqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToSourceNonSqlTaskOutputResponse {
     ...
     * Server properties
     */
    serverProperties: outputs.datamigration.v20210630.ServerPropertiesResponse;
    /**
     ...
     */
    validationErrors: outputs.datamigration.v20210630.ReportableExceptionResponse[];
}
...
export interface ConnectToSourceOracleSyncTaskInputResponse {
     ...
     */
    sourceConnectionInfo: outputs.datamigration.v20210630.OracleConnectionInfoResponse;
}
...
export interface ConnectToSourceOracleSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ConnectToSourceOracleSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ConnectToSourceOracleSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface ConnectToSourcePostgreSqlSyncTaskInputResponse {
     ...
     */
    sourceConnectionInfo: outputs.datamigration.v20210630.PostgreSqlConnectionInfoResponse;
}
/**
...
export function connectToSourcePostgreSqlSyncTaskInputResponseProvideDefaults(val: ConnectToSourcePostgreSqlSyncTaskInputResponse): ConnectToSourcePostgreSqlSyncTaskInputResponse {
    return {
        ...val,
        sourceConnectionInfo: outputs.datamigration.v20210630.postgreSqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
    };
}
...
export interface ConnectToSourcePostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ConnectToSourcePostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ConnectToSourcePostgreSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToSourcePostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: ConnectToSourcePostgreSqlSyncTaskPropertiesResponse): ConnectToSourcePostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.connectToSourcePostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToSourceSqlServerSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ConnectToSourceSqlServerTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20210630.ConnectToSourceSqlServerTaskOutputAgentJobLevelResponse | outputs.datamigration.v20210630.ConnectToSourceSqlServerTaskOutputDatabaseLevelResponse | outputs.datamigration.v20210630.ConnectToSourceSqlServerTaskOutputLoginLevelResponse | outputs.datamigration.v20210630.ConnectToSourceSqlServerTaskOutputTaskLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToSourceSqlServerSyncTaskPropertiesResponseProvideDefaults(val: ConnectToSourceSqlServerSyncTaskPropertiesResponse): ConnectToSourceSqlServerSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.connectToSourceSqlServerTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToSourceSqlServerTaskInputResponse {
     ...
     */
    sourceConnectionInfo: outputs.datamigration.v20210630.SqlConnectionInfoResponse;
    /**
...
export function connectToSourceSqlServerTaskInputResponseProvideDefaults(val: ConnectToSourceSqlServerTaskInputResponse): ConnectToSourceSqlServerTaskInputResponse {
    return {
        ...
        sourceConnectionInfo: outputs.datamigration.v20210630.sqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
...
export interface ConnectToSourceSqlServerTaskOutputAgentJobLevelResponse {
     ...
     */
    migrationEligibility: outputs.datamigration.v20210630.MigrationEligibilityInfoResponse;
    /**
     * Agent Job name
     */
    name: string;
...
export interface ConnectToSourceSqlServerTaskOutputDatabaseLevelResponse {
     ...
     */
    databaseFiles: outputs.datamigration.v20210630.DatabaseFileInfoResponse[];
    /**
...
export interface ConnectToTargetAzureDbForMySqlTaskInputResponse {
     ...
     */
    targetConnectionInfo: outputs.datamigration.v20210630.MySqlConnectionInfoResponse;
}
/**
...
export function connectToTargetAzureDbForMySqlTaskInputResponseProvideDefaults(val: ConnectToTargetAzureDbForMySqlTaskInputResponse): ConnectToTargetAzureDbForMySqlTaskInputResponse {
    return {
        ...
        isOfflineMigration: (val.isOfflineMigration) ?? false,
        sourceConnectionInfo: outputs.datamigration.v20210630.mySqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
        targetConnectionInfo: outputs.datamigration.v20210630.mySqlConnectionInfoResponseProvideDefaults(val.targetConnectionInfo),
    };
}
...
export interface ConnectToTargetAzureDbForMySqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ConnectToTargetAzureDbForMySqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ConnectToTargetAzureDbForMySqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetAzureDbForMySqlTaskPropertiesResponseProvideDefaults(val: ConnectToTargetAzureDbForMySqlTaskPropertiesResponse): ConnectToTargetAzureDbForMySqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.connectToTargetAzureDbForMySqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse {
     ...
     */
    targetConnectionInfo: outputs.datamigration.v20210630.PostgreSqlConnectionInfoResponse;
}
/**
...
export function connectToTargetAzureDbForPostgreSqlSyncTaskInputResponseProvideDefaults(val: ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse): ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse {
    return {
        ...val,
        sourceConnectionInfo: outputs.datamigration.v20210630.postgreSqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
        targetConnectionInfo: outputs.datamigration.v20210630.postgreSqlConnectionInfoResponseProvideDefaults(val.targetConnectionInfo),
    };
}
...
export interface ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ConnectToTargetAzureDbForPostgreSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse): ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.connectToTargetAzureDbForPostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutputResponse {
     ...
     */
    databaseSchemaMap?: outputs.datamigration.v20210630.ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutputResponseDatabaseSchemaMap[];
    /**
     * List of databases on target server
     */
    databases: string[];
...
export interface ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetOracleAzureDbForPostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse): ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.connectToTargetOracleAzureDbForPostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetSqlDbTaskInputResponse {
     ...
     */
    targetConnectionInfo: outputs.datamigration.v20210630.SqlConnectionInfoResponse;
}
/**
...
export function connectToTargetSqlDbTaskInputResponseProvideDefaults(val: ConnectToTargetSqlDbTaskInputResponse): ConnectToTargetSqlDbTaskInputResponse {
    return {
        ...val,
        targetConnectionInfo: outputs.datamigration.v20210630.sqlConnectionInfoResponseProvideDefaults(val.targetConnectionInfo),
    };
}
...
export interface ConnectToTargetSqlDbTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ConnectToTargetSqlDbTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ConnectToTargetSqlDbTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetSqlDbTaskPropertiesResponseProvideDefaults(val: ConnectToTargetSqlDbTaskPropertiesResponse): ConnectToTargetSqlDbTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.connectToTargetSqlDbTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetSqlMISyncTaskInputResponse {
     ...
     */
    azureApp: outputs.datamigration.v20210630.AzureActiveDirectoryAppResponse;
    /**
     * Connection information for Azure SQL Database Managed Instance
     */
    targetConnectionInfo: outputs.datamigration.v20210630.MiSqlConnectionInfoResponse;
}
...
export interface ConnectToTargetSqlMISyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ConnectToTargetSqlMISyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ConnectToTargetSqlMISyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface ConnectToTargetSqlMITaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ConnectToTargetSqlMITaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ConnectToTargetSqlMITaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetSqlMITaskPropertiesResponseProvideDefaults(val: ConnectToTargetSqlMITaskPropertiesResponse): ConnectToTargetSqlMITaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.connectToTargetSqlMITaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ConnectToTargetSqlSqlDbSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ConnectToTargetSqlDbTaskOutputResponse[];
...
export function connectToTargetSqlSqlDbSyncTaskPropertiesResponseProvideDefaults(val: ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse): ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.connectToTargetSqlSqlDbSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface DataIntegrityValidationResultResponse {
     ...
     */
    validationErrors?: outputs.datamigration.v20210630.ValidationErrorResponse;
}
...
export interface ExecutionStatisticsResponse {
     ...
     */
    waitStats?: {[key: string]: outputs.datamigration.v20210630.WaitStatisticsResponse};
}
...
export interface GetTdeCertificatesSqlTaskInputResponse {
     ...
     */
    backupFileShare: outputs.datamigration.v20210630.FileShareResponse;
    /**
     * Connection information for SQL Server
     */
    connectionInfo: outputs.datamigration.v20210630.SqlConnectionInfoResponse;
    /**
     * List containing certificate names and corresponding password to use for encrypting the exported certificate.
     */
    selectedCertificates: outputs.datamigration.v20210630.SelectedCertificateInputResponse[];
}
/**
...
export function getTdeCertificatesSqlTaskInputResponseProvideDefaults(val: GetTdeCertificatesSqlTaskInputResponse): GetTdeCertificatesSqlTaskInputResponse {
    return {
        ...val,
        connectionInfo: outputs.datamigration.v20210630.sqlConnectionInfoResponseProvideDefaults(val.connectionInfo),
    };
}
...
export interface GetTdeCertificatesSqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.GetTdeCertificatesSqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.GetTdeCertificatesSqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getTdeCertificatesSqlTaskPropertiesResponseProvideDefaults(val: GetTdeCertificatesSqlTaskPropertiesResponse): GetTdeCertificatesSqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.getTdeCertificatesSqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface GetUserTablesMySqlTaskInputResponse {
     ...
     * Connection information for SQL Server
     */
    connectionInfo: outputs.datamigration.v20210630.MySqlConnectionInfoResponse;
    /**
...
export function getUserTablesMySqlTaskInputResponseProvideDefaults(val: GetUserTablesMySqlTaskInputResponse): GetUserTablesMySqlTaskInputResponse {
    return {
        ...val,
        connectionInfo: outputs.datamigration.v20210630.mySqlConnectionInfoResponseProvideDefaults(val.connectionInfo),
    };
}
...
export interface GetUserTablesMySqlTaskOutputResponse {
     ...
     */
    databasesToTables: {[key: string]: outputs.datamigration.v20210630.DatabaseTableResponse[]};
    /**
     * Result identifier
     */
    id: string;
...
export interface GetUserTablesMySqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.GetUserTablesMySqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.GetUserTablesMySqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getUserTablesMySqlTaskPropertiesResponseProvideDefaults(val: GetUserTablesMySqlTaskPropertiesResponse): GetUserTablesMySqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.getUserTablesMySqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface GetUserTablesOracleTaskInputResponse {
     ...
     * Information for connecting to Oracle source
     */
    connectionInfo: outputs.datamigration.v20210630.OracleConnectionInfoResponse;
    /**
...
export interface GetUserTablesOracleTaskOutputResponse {
     ...
     */
    tables: outputs.datamigration.v20210630.DatabaseTableResponse[];
    /**
     * Validation errors associated with the task
     */
    validationErrors: outputs.datamigration.v20210630.ReportableExceptionResponse[];
...
export interface GetUserTablesOracleTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.GetUserTablesOracleTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.GetUserTablesOracleTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface GetUserTablesPostgreSqlTaskInputResponse {
     ...
     */
    connectionInfo: outputs.datamigration.v20210630.PostgreSqlConnectionInfoResponse;
    /**
...
export function getUserTablesPostgreSqlTaskInputResponseProvideDefaults(val: GetUserTablesPostgreSqlTaskInputResponse): GetUserTablesPostgreSqlTaskInputResponse {
    return {
        ...val,
        connectionInfo: outputs.datamigration.v20210630.postgreSqlConnectionInfoResponseProvideDefaults(val.connectionInfo),
    };
}
...
export interface GetUserTablesPostgreSqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.GetUserTablesPostgreSqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.GetUserTablesPostgreSqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getUserTablesPostgreSqlTaskPropertiesResponseProvideDefaults(val: GetUserTablesPostgreSqlTaskPropertiesResponse): GetUserTablesPostgreSqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.getUserTablesPostgreSqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface GetUserTablesSqlSyncTaskOutputResponse {
     ...
     */
    databasesToSourceTables: {[key: string]: outputs.datamigration.v20210630.DatabaseTableResponse[]};
    /**
     * Mapping from database name to list of target tables
     */
    databasesToTargetTables: {[key: string]: outputs.datamigration.v20210630.DatabaseTableResponse[]};
    /**
...
export interface GetUserTablesSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.GetUserTablesSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.GetUserTablesSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getUserTablesSqlSyncTaskPropertiesResponseProvideDefaults(val: GetUserTablesSqlSyncTaskPropertiesResponse): GetUserTablesSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.getUserTablesSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface GetUserTablesSqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.GetUserTablesSqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.GetUserTablesSqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getUserTablesSqlTaskPropertiesResponseProvideDefaults(val: GetUserTablesSqlTaskPropertiesResponse): GetUserTablesSqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.getUserTablesSqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateMISyncCompleteCommandOutputResponse {
     ...
     */
    errors?: outputs.datamigration.v20210630.ReportableExceptionResponse[];
}
...
export interface MigrateMISyncCompleteCommandPropertiesResponse {
     ...
     * Command input
     */
    input?: outputs.datamigration.v20210630.MigrateMISyncCompleteCommandInputResponse;
    /**
     * Command output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.MigrateMISyncCompleteCommandOutputResponse;
    /**
...
export interface MigrateMongoDbTaskPropertiesResponse {
     ...
     */
    input?: outputs.datamigration.v20210630.MongoDbMigrationSettingsResponse;
    output: (outputs.datamigration.v20210630.MongoDbCollectionProgressResponse | outputs.datamigration.v20210630.MongoDbDatabaseProgressResponse | outputs.datamigration.v20210630.MongoDbMigrationProgressResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskInputResponse {
     ...
     */
    selectedDatabases: outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlOfflineDatabaseInputResponse[];
    /**
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskOutputDatabaseLevelResponse {
     ...
     */
    exceptionsAndWarnings: outputs.datamigration.v20210630.ReportableExceptionResponse[];
    /**
     * Result identifier
     */
    id: string;
     ...
     */
    objectSummary: {[key: string]: outputs.datamigration.v20210630.DataItemMigrationSummaryResultResponse};
    /**
     * Wildcard string prefix to use for querying all sub-tem results of the item
     */
    resultPrefix: string;
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskOutputErrorResponse {
     ...
     * Migration error
     */
    error: outputs.datamigration.v20210630.ReportableExceptionResponse;
    /**
     * Result identifier
     */
    id: string;
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskOutputMigrationLevelResponse {
     ...
     * Summary of database results in the migration
     */
    databaseSummary: {[key: string]: outputs.datamigration.v20210630.DatabaseSummaryResultResponse};
    /**
     ...
     */
    migrationReportResult?: outputs.datamigration.v20210630.MigrationReportResultResponse;
    /**
     * Result type
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlOfflineTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlOfflineTaskOutputDatabaseLevelResponse | outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlOfflineTaskOutputErrorResponse | outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlOfflineTaskOutputMigrationLevelResponse | outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlOfflineTaskOutputTableLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponseProvideDefaults(val: MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse): MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.migrateMySqlAzureDbForMySqlOfflineTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateMySqlAzureDbForMySqlSyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlSyncDatabaseInputResponse[];
    /**
     * Connection information for source MySQL
     */
    sourceConnectionInfo: outputs.datamigration.v20210630.MySqlConnectionInfoResponse;
...
export interface MigrateMySqlAzureDbForMySqlSyncTaskOutputDatabaseErrorResponse {
     ...
     */
    events?: outputs.datamigration.v20210630.SyncMigrationDatabaseErrorEventResponse[];
    /**
     * Result identifier
     */
    id: string;
...
export interface MigrateMySqlAzureDbForMySqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlSyncTaskOutputDatabaseErrorResponse | outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlSyncTaskOutputDatabaseLevelResponse | outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlSyncTaskOutputErrorResponse | outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlSyncTaskOutputMigrationLevelResponse | outputs.datamigration.v20210630.MigrateMySqlAzureDbForMySqlSyncTaskOutputTableLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateMySqlAzureDbForMySqlSyncTaskPropertiesResponseProvideDefaults(val: MigrateMySqlAzureDbForMySqlSyncTaskPropertiesResponse): MigrateMySqlAzureDbForMySqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.migrateMySqlAzureDbForMySqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.MigrateOracleAzureDbPostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20210630.MigrateOracleAzureDbPostgreSqlSyncTaskOutputDatabaseErrorResponse | outputs.datamigration.v20210630.MigrateOracleAzureDbPostgreSqlSyncTaskOutputDatabaseLevelResponse | outputs.datamigration.v20210630.MigrateOracleAzureDbPostgreSqlSyncTaskOutputErrorResponse | outputs.datamigration.v20210630.MigrateOracleAzureDbPostgreSqlSyncTaskOutputMigrationLevelResponse | outputs.datamigration.v20210630.MigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse): MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.migrateOracleAzureDbPostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateOracleAzureDbPostgreSqlSyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20210630.MigrateOracleAzureDbPostgreSqlSyncDatabaseInputResponse[];
    /**
...
export interface MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputResponse {
     ...
     */
    selectedTables?: outputs.datamigration.v20210630.MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInputResponse[];
    /**
     * Source settings to tune source endpoint migration behavior
     */
    sourceSetting?: {[key: string]: string};
...
export interface MigratePostgreSqlAzureDbForPostgreSqlSyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20210630.MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputResponse[];
    /**
...
export interface MigratePostgreSqlAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20210630.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputDatabaseErrorResponse | outputs.datamigration.v20210630.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputDatabaseLevelResponse | outputs.datamigration.v20210630.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputErrorResponse | outputs.datamigration.v20210630.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevelResponse | outputs.datamigration.v20210630.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputTableLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migratePostgreSqlAzureDbForPostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: MigratePostgreSqlAzureDbForPostgreSqlSyncTaskPropertiesResponse): MigratePostgreSqlAzureDbForPostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.migratePostgreSqlAzureDbForPostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSqlServerSqlDbSyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20210630.MigrateSqlServerSqlDbSyncDatabaseInputResponse[];
    /**
     ...
     * Validation options
     */
    validationOptions?: outputs.datamigration.v20210630.MigrationValidationOptionsResponse;
}
/**
...
export interface MigrateSqlServerSqlDbSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.MigrateSqlServerSqlDbSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20210630.MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlDbSyncTaskOutputDatabaseLevelResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlDbSyncTaskOutputErrorResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlDbSyncTaskOutputMigrationLevelResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlDbSyncTaskOutputTableLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateSqlServerSqlDbSyncTaskPropertiesResponseProvideDefaults(val: MigrateSqlServerSqlDbSyncTaskPropertiesResponse): MigrateSqlServerSqlDbSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.migrateSqlServerSqlDbSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSqlServerSqlDbTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20210630.MigrateSqlServerSqlDbDatabaseInputResponse[];
    /**
     * Information for connecting to source
     */
    sourceConnectionInfo: outputs.datamigration.v20210630.SqlConnectionInfoResponse;
...
export interface MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResultResponse {
     ...
     */
    dataIntegrityValidationResult: outputs.datamigration.v20210630.DataIntegrityValidationResultResponse;
    /**
     * Validation end time
     */
    endedOn: string;
     ...
     */
    queryAnalysisValidationResult: outputs.datamigration.v20210630.QueryAnalysisValidationResultResponse;
    /**
     * Result type
     ...
     */
    schemaValidationResult: outputs.datamigration.v20210630.SchemaComparisonValidationResultResponse;
    /**
...
export interface MigrateSqlServerSqlDbTaskOutputMigrationLevelResponse {
     ...
     */
    migrationValidationResult?: outputs.datamigration.v20210630.MigrationValidationResultResponse;
    /**
     * Result type
     * Expected value is 'MigrationLevelOutput'.
     */
...
export interface MigrateSqlServerSqlDbTaskOutputValidationResultResponse {
     ...
     */
    summaryResults?: {[key: string]: outputs.datamigration.v20210630.MigrationValidationDatabaseSummaryResultResponse};
}
...
export interface MigrateSqlServerSqlDbTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.MigrateSqlServerSqlDbTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20210630.MigrateSqlServerSqlDbTaskOutputDatabaseLevelResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResultResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlDbTaskOutputErrorResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlDbTaskOutputMigrationLevelResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlDbTaskOutputTableLevelResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlDbTaskOutputValidationResultResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateSqlServerSqlDbTaskPropertiesResponseProvideDefaults(val: MigrateSqlServerSqlDbTaskPropertiesResponse): MigrateSqlServerSqlDbTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.migrateSqlServerSqlDbTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSqlServerSqlMISyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20210630.MigrateSqlServerSqlMIDatabaseInputResponse[];
    /**
     * Connection information for source SQL Server
     */
    sourceConnectionInfo: outputs.datamigration.v20210630.SqlConnectionInfoResponse;
...
export interface MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse {
     ...
     */
    activeBackupSets: outputs.datamigration.v20210630.BackupSetInfoResponse[];
    /**
     ...
     */
    fullBackupSetInfo: outputs.datamigration.v20210630.BackupSetInfoResponse;
    /**
     * Result identifier
     */
    id: string;
     ...
     */
    lastRestoredBackupSetInfo: outputs.datamigration.v20210630.BackupSetInfoResponse;
    /**
...
export interface MigrateSqlServerSqlMISyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.MigrateSqlServerSqlMISyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20210630.MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlMISyncTaskOutputErrorResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlMISyncTaskOutputMigrationLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateSqlServerSqlMISyncTaskPropertiesResponseProvideDefaults(val: MigrateSqlServerSqlMISyncTaskPropertiesResponse): MigrateSqlServerSqlMISyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.migrateSqlServerSqlMISyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSqlServerSqlMITaskInputResponse {
     ...
     */
    backupBlobShare: outputs.datamigration.v20210630.BlobShareResponse;
    /**
     * Backup file share information for all selected databases.
     */
    backupFileShare?: outputs.datamigration.v20210630.FileShareResponse;
...
export interface MigrateSqlServerSqlMITaskOutputMigrationLevelResponse {
     ...
     */
    orphanedUsersInfo: outputs.datamigration.v20210630.OrphanedUserInfoResponse[];
    /**
     * Result type
     * Expected value is 'MigrationLevelOutput'.
     */
     ...
     */
    serverRoleResults: {[key: string]: outputs.datamigration.v20210630.StartMigrationScenarioServerRoleResultResponse};
    /**
     * Source server brand version
     */
    sourceServerBrandVersion: string;
...
export interface MigrateSqlServerSqlMITaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.MigrateSqlServerSqlMITaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20210630.MigrateSqlServerSqlMITaskOutputAgentJobLevelResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlMITaskOutputDatabaseLevelResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlMITaskOutputErrorResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlMITaskOutputLoginLevelResponse | outputs.datamigration.v20210630.MigrateSqlServerSqlMITaskOutputMigrationLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateSqlServerSqlMITaskPropertiesResponseProvideDefaults(val: MigrateSqlServerSqlMITaskPropertiesResponse): MigrateSqlServerSqlMITaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.migrateSqlServerSqlMITaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSsisTaskInputResponse {
     ...
     */
    ssisMigrationInfo: outputs.datamigration.v20210630.SsisMigrationInfoResponse;
    /**
     * Information for connecting to target
     */
    targetConnectionInfo: outputs.datamigration.v20210630.SqlConnectionInfoResponse;
...
export interface MigrateSsisTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.MigrateSsisTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20210630.MigrateSsisTaskOutputMigrationLevelResponse | outputs.datamigration.v20210630.MigrateSsisTaskOutputProjectLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateSsisTaskPropertiesResponseProvideDefaults(val: MigrateSsisTaskPropertiesResponse): MigrateSsisTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.migrateSsisTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSyncCompleteCommandPropertiesResponse {
     ...
     * Command input
     */
    input?: outputs.datamigration.v20210630.MigrateSyncCompleteCommandInputResponse;
    /**
     * Command output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.MigrateSyncCompleteCommandOutputResponse;
    /**
     * The state of the command. This is ignored if submitted.
     */
    state: string;
...
export interface MongoDbClusterInfoResponse {
     ...
     */
    databases: outputs.datamigration.v20210630.MongoDbDatabaseInfoResponse[];
    /**
...
export interface MongoDbCollectionInfoResponse {
     ...
     */
    shardKey?: outputs.datamigration.v20210630.MongoDbShardKeyInfoResponse;
    /**
...
export interface MongoDbCollectionProgressResponse {
     ...
     */
    errors: {[key: string]: outputs.datamigration.v20210630.MongoDbErrorResponse};
    /**
...
export interface MongoDbCollectionSettingsResponse {
     ...
     */
    shardKey?: outputs.datamigration.v20210630.MongoDbShardKeySettingResponse;
    /**
...
export interface MongoDbDatabaseInfoResponse {
     ...
     */
    collections: outputs.datamigration.v20210630.MongoDbCollectionInfoResponse[];
    /**
     * The estimated total data size, in bytes, or -1 if the size is unknown.
     */
    dataSize: number;
...
export interface MongoDbDatabaseProgressResponse {
     ...
     */
    collections?: {[key: string]: outputs.datamigration.v20210630.MongoDbCollectionProgressResponse};
    /**
     * The number of documents copied during the Copying stage
     */
    documentsCopied: number;
...
export interface MongoDbDatabaseSettingsResponse {
     ...
     */
    collections: {[key: string]: outputs.datamigration.v20210630.MongoDbCollectionSettingsResponse};
    /**
...
export interface MongoDbMigrationProgressResponse {
     ...
     */
    databases?: {[key: string]: outputs.datamigration.v20210630.MongoDbDatabaseProgressResponse};
    /**
     * The number of documents copied during the Copying stage
     */
    documentsCopied: number;
...
export interface MongoDbMigrationSettingsResponse {
     ...
     */
    databases: {[key: string]: outputs.datamigration.v20210630.MongoDbDatabaseSettingsResponse};
    /**
     ...
     */
    source: outputs.datamigration.v20210630.MongoDbConnectionInfoResponse;
    /**
     * Settings used to connect to the target cluster
     */
    target: outputs.datamigration.v20210630.MongoDbConnectionInfoResponse;
    /**
     * Settings used to limit the resource usage of the migration
     */
    throttling?: outputs.datamigration.v20210630.MongoDbThrottlingSettingsResponse;
}
...
export interface MongoDbShardKeyInfoResponse {
     ...
     */
    fields: outputs.datamigration.v20210630.MongoDbShardKeyFieldResponse[];
    /**
...
export interface ODataErrorResponse {
     ...
     */
    details?: outputs.datamigration.v20210630.ODataErrorResponse[];
    /**
...
export interface QueryAnalysisValidationResultResponse {
     ...
     */
    queryResults?: outputs.datamigration.v20210630.QueryExecutionResultResponse;
    /**
...
export interface QueryExecutionResultResponse {
     ...
     */
    sourceResult?: outputs.datamigration.v20210630.ExecutionStatisticsResponse;
    /**
     ...
     */
    targetResult?: outputs.datamigration.v20210630.ExecutionStatisticsResponse;
}
...
export interface SchemaComparisonValidationResultResponse {
     ...
     */
    schemaDifferences?: outputs.datamigration.v20210630.SchemaComparisonValidationResultTypeResponse;
    /**
...
export interface ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ValidateSyncMigrationInputSqlServerTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ValidateSyncMigrationInputSqlServerTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function validateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponseProvideDefaults(val: ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse): ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.validateSyncMigrationInputSqlServerTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ValidateMigrationInputSqlServerSqlMISyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ValidateMigrationInputSqlServerSqlMISyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function validateMigrationInputSqlServerSqlMISyncTaskPropertiesResponseProvideDefaults(val: ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse): ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.validateMigrationInputSqlServerSqlMISyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ValidateMigrationInputSqlServerSqlMITaskOutputResponse {
     ...
     */
    backupFolderErrors: outputs.datamigration.v20210630.ReportableExceptionResponse[];
    /**
     * Errors associated with backup share user name and password credentials
     */
    backupShareCredentialsErrors: outputs.datamigration.v20210630.ReportableExceptionResponse[];
    /**
     * Errors associated with the storage account provided.
     */
    backupStorageAccountErrors: outputs.datamigration.v20210630.ReportableExceptionResponse[];
    /**
     * Information about backup files when existing backup mode is used.
     */
    databaseBackupInfo?: outputs.datamigration.v20210630.DatabaseBackupInfoResponse;
    /**
     * Errors associated with existing backup files.
     */
    existingBackupErrors: outputs.datamigration.v20210630.ReportableExceptionResponse[];
    /**
     * Result identifier
     */
    id: string;
     ...
     */
    restoreDatabaseNameErrors: outputs.datamigration.v20210630.ReportableExceptionResponse[];
}
...
export interface ValidateMigrationInputSqlServerSqlMITaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20210630.ValidateMigrationInputSqlServerSqlMITaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20210630.ValidateMigrationInputSqlServerSqlMITaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function validateMigrationInputSqlServerSqlMITaskPropertiesResponseProvideDefaults(val: ValidateMigrationInputSqlServerSqlMITaskPropertiesResponse): ValidateMigrationInputSqlServerSqlMITaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20210630.validateMigrationInputSqlServerSqlMITaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ValidateMongoDbTaskPropertiesResponse {
     ...
     */
    output: outputs.datamigration.v20210630.MongoDbMigrationProgressResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface ValidateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     */
    output: outputs.datamigration.v20210630.ValidateOracleAzureDbPostgreSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
