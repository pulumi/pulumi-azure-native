...
export interface BackupSetInfoResponse {
     ...
     */
    listOfBackupFiles?: outputs.datamigration.v20211030preview.BackupFileInfoResponse[];
}
...
export interface ConnectToMongoDbTaskPropertiesResponse {
     ...
     */
    commands: (outputs.datamigration.v20211030preview.MigrateMISyncCompleteCommandPropertiesResponse | outputs.datamigration.v20211030preview.MigrateSyncCompleteCommandPropertiesResponse)[];
    /**
     * Array of errors. This is ignored if submitted.
     */
    errors: outputs.datamigration.v20211030preview.ODataErrorResponse[];
    /**
     * Describes a connection to a MongoDB data source
     */
    input?: outputs.datamigration.v20211030preview.MongoDbConnectionInfoResponse;
    /**
     * An array containing a single MongoDbClusterInfo object
     */
    output: outputs.datamigration.v20211030preview.MongoDbClusterInfoResponse[];
    /**
...
export interface ConnectToSourceMySqlTaskInputResponse {
     ...
     */
    sourceConnectionInfo: outputs.datamigration.v20211030preview.MySqlConnectionInfoResponse;
    /**
...
export function connectToSourceMySqlTaskInputResponseProvideDefaults(val: ConnectToSourceMySqlTaskInputResponse): ConnectToSourceMySqlTaskInputResponse {
    return {
        ...
        sourceConnectionInfo: outputs.datamigration.v20211030preview.mySqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
    };
}
...
export interface ConnectToSourceMySqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ConnectToSourceMySqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ConnectToSourceNonSqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToSourceMySqlTaskPropertiesResponseProvideDefaults(val: ConnectToSourceMySqlTaskPropertiesResponse): ConnectToSourceMySqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.connectToSourceMySqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToSourceNonSqlTaskOutputResponse {
     ...
     * Server properties
     */
    serverProperties: outputs.datamigration.v20211030preview.ServerPropertiesResponse;
    /**
     ...
     */
    validationErrors: outputs.datamigration.v20211030preview.ReportableExceptionResponse[];
}
...
export interface ConnectToSourceOracleSyncTaskInputResponse {
     ...
     */
    sourceConnectionInfo: outputs.datamigration.v20211030preview.OracleConnectionInfoResponse;
}
...
export interface ConnectToSourceOracleSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ConnectToSourceOracleSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ConnectToSourceOracleSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface ConnectToSourcePostgreSqlSyncTaskInputResponse {
     ...
     */
    sourceConnectionInfo: outputs.datamigration.v20211030preview.PostgreSqlConnectionInfoResponse;
}
/**
...
export function connectToSourcePostgreSqlSyncTaskInputResponseProvideDefaults(val: ConnectToSourcePostgreSqlSyncTaskInputResponse): ConnectToSourcePostgreSqlSyncTaskInputResponse {
    return {
        ...val,
        sourceConnectionInfo: outputs.datamigration.v20211030preview.postgreSqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
    };
}
...
export interface ConnectToSourcePostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ConnectToSourcePostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ConnectToSourcePostgreSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToSourcePostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: ConnectToSourcePostgreSqlSyncTaskPropertiesResponse): ConnectToSourcePostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.connectToSourcePostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToSourceSqlServerSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ConnectToSourceSqlServerTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20211030preview.ConnectToSourceSqlServerTaskOutputAgentJobLevelResponse | outputs.datamigration.v20211030preview.ConnectToSourceSqlServerTaskOutputDatabaseLevelResponse | outputs.datamigration.v20211030preview.ConnectToSourceSqlServerTaskOutputLoginLevelResponse | outputs.datamigration.v20211030preview.ConnectToSourceSqlServerTaskOutputTaskLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToSourceSqlServerSyncTaskPropertiesResponseProvideDefaults(val: ConnectToSourceSqlServerSyncTaskPropertiesResponse): ConnectToSourceSqlServerSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.connectToSourceSqlServerTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToSourceSqlServerTaskInputResponse {
     ...
     */
    sourceConnectionInfo: outputs.datamigration.v20211030preview.SqlConnectionInfoResponse;
    /**
...
export function connectToSourceSqlServerTaskInputResponseProvideDefaults(val: ConnectToSourceSqlServerTaskInputResponse): ConnectToSourceSqlServerTaskInputResponse {
    return {
        ...
        sourceConnectionInfo: outputs.datamigration.v20211030preview.sqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
...
export interface ConnectToSourceSqlServerTaskOutputAgentJobLevelResponse {
     ...
     */
    migrationEligibility: outputs.datamigration.v20211030preview.MigrationEligibilityInfoResponse;
    /**
     * Agent Job name
     */
    name: string;
...
export interface ConnectToSourceSqlServerTaskOutputDatabaseLevelResponse {
     ...
     */
    databaseFiles: outputs.datamigration.v20211030preview.DatabaseFileInfoResponse[];
    /**
...
export interface ConnectToTargetAzureDbForMySqlTaskInputResponse {
     ...
     */
    targetConnectionInfo: outputs.datamigration.v20211030preview.MySqlConnectionInfoResponse;
}
/**
...
export function connectToTargetAzureDbForMySqlTaskInputResponseProvideDefaults(val: ConnectToTargetAzureDbForMySqlTaskInputResponse): ConnectToTargetAzureDbForMySqlTaskInputResponse {
    return {
        ...
        isOfflineMigration: (val.isOfflineMigration) ?? false,
        sourceConnectionInfo: outputs.datamigration.v20211030preview.mySqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
        targetConnectionInfo: outputs.datamigration.v20211030preview.mySqlConnectionInfoResponseProvideDefaults(val.targetConnectionInfo),
    };
}
...
export interface ConnectToTargetAzureDbForMySqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ConnectToTargetAzureDbForMySqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ConnectToTargetAzureDbForMySqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetAzureDbForMySqlTaskPropertiesResponseProvideDefaults(val: ConnectToTargetAzureDbForMySqlTaskPropertiesResponse): ConnectToTargetAzureDbForMySqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.connectToTargetAzureDbForMySqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse {
     ...
     */
    targetConnectionInfo: outputs.datamigration.v20211030preview.PostgreSqlConnectionInfoResponse;
}
/**
...
export function connectToTargetAzureDbForPostgreSqlSyncTaskInputResponseProvideDefaults(val: ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse): ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse {
    return {
        ...val,
        sourceConnectionInfo: outputs.datamigration.v20211030preview.postgreSqlConnectionInfoResponseProvideDefaults(val.sourceConnectionInfo),
        targetConnectionInfo: outputs.datamigration.v20211030preview.postgreSqlConnectionInfoResponseProvideDefaults(val.targetConnectionInfo),
    };
}
...
export interface ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ConnectToTargetAzureDbForPostgreSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse): ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.connectToTargetAzureDbForPostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutputResponse {
     ...
     */
    databaseSchemaMap?: outputs.datamigration.v20211030preview.ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutputResponseDatabaseSchemaMap[];
    /**
     * List of databases on target server
     */
    databases: string[];
...
export interface ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetOracleAzureDbForPostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse): ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.connectToTargetOracleAzureDbForPostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetSqlDbTaskInputResponse {
     ...
     */
    targetConnectionInfo: outputs.datamigration.v20211030preview.SqlConnectionInfoResponse;
}
/**
...
export function connectToTargetSqlDbTaskInputResponseProvideDefaults(val: ConnectToTargetSqlDbTaskInputResponse): ConnectToTargetSqlDbTaskInputResponse {
    return {
        ...val,
        targetConnectionInfo: outputs.datamigration.v20211030preview.sqlConnectionInfoResponseProvideDefaults(val.targetConnectionInfo),
    };
}
...
export interface ConnectToTargetSqlDbTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ConnectToTargetSqlDbTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ConnectToTargetSqlDbTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetSqlDbTaskPropertiesResponseProvideDefaults(val: ConnectToTargetSqlDbTaskPropertiesResponse): ConnectToTargetSqlDbTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.connectToTargetSqlDbTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetSqlMISyncTaskInputResponse {
     ...
     */
    azureApp: outputs.datamigration.v20211030preview.AzureActiveDirectoryAppResponse;
    /**
     * Connection information for Azure SQL Database Managed Instance
     */
    targetConnectionInfo: outputs.datamigration.v20211030preview.MiSqlConnectionInfoResponse;
}
...
export interface ConnectToTargetSqlMISyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ConnectToTargetSqlMISyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ConnectToTargetSqlMISyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface ConnectToTargetSqlMITaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ConnectToTargetSqlMITaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ConnectToTargetSqlMITaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function connectToTargetSqlMITaskPropertiesResponseProvideDefaults(val: ConnectToTargetSqlMITaskPropertiesResponse): ConnectToTargetSqlMITaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.connectToTargetSqlMITaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ConnectToTargetSqlSqlDbSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ConnectToTargetSqlDbTaskOutputResponse[];
...
export function connectToTargetSqlSqlDbSyncTaskPropertiesResponseProvideDefaults(val: ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse): ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.connectToTargetSqlSqlDbSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface DataIntegrityValidationResultResponse {
     ...
     */
    validationErrors?: outputs.datamigration.v20211030preview.ValidationErrorResponse;
}
...
export interface ExecutionStatisticsResponse {
     ...
     */
    waitStats?: {[key: string]: outputs.datamigration.v20211030preview.WaitStatisticsResponse};
}
...
export interface GetTdeCertificatesSqlTaskInputResponse {
     ...
     */
    backupFileShare: outputs.datamigration.v20211030preview.FileShareResponse;
    /**
     * Connection information for SQL Server
     */
    connectionInfo: outputs.datamigration.v20211030preview.SqlConnectionInfoResponse;
    /**
     * List containing certificate names and corresponding password to use for encrypting the exported certificate.
     */
    selectedCertificates: outputs.datamigration.v20211030preview.SelectedCertificateInputResponse[];
}
/**
...
export function getTdeCertificatesSqlTaskInputResponseProvideDefaults(val: GetTdeCertificatesSqlTaskInputResponse): GetTdeCertificatesSqlTaskInputResponse {
    return {
        ...val,
        connectionInfo: outputs.datamigration.v20211030preview.sqlConnectionInfoResponseProvideDefaults(val.connectionInfo),
    };
}
...
export interface GetTdeCertificatesSqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.GetTdeCertificatesSqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.GetTdeCertificatesSqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getTdeCertificatesSqlTaskPropertiesResponseProvideDefaults(val: GetTdeCertificatesSqlTaskPropertiesResponse): GetTdeCertificatesSqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.getTdeCertificatesSqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface GetUserTablesMySqlTaskInputResponse {
     ...
     * Connection information for SQL Server
     */
    connectionInfo: outputs.datamigration.v20211030preview.MySqlConnectionInfoResponse;
    /**
...
export function getUserTablesMySqlTaskInputResponseProvideDefaults(val: GetUserTablesMySqlTaskInputResponse): GetUserTablesMySqlTaskInputResponse {
    return {
        ...val,
        connectionInfo: outputs.datamigration.v20211030preview.mySqlConnectionInfoResponseProvideDefaults(val.connectionInfo),
    };
}
...
export interface GetUserTablesMySqlTaskOutputResponse {
     ...
     */
    databasesToTables: {[key: string]: outputs.datamigration.v20211030preview.DatabaseTableResponse[]};
    /**
     * Result identifier
     */
    id: string;
...
export interface GetUserTablesMySqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.GetUserTablesMySqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.GetUserTablesMySqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getUserTablesMySqlTaskPropertiesResponseProvideDefaults(val: GetUserTablesMySqlTaskPropertiesResponse): GetUserTablesMySqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.getUserTablesMySqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface GetUserTablesOracleTaskInputResponse {
     ...
     * Information for connecting to Oracle source
     */
    connectionInfo: outputs.datamigration.v20211030preview.OracleConnectionInfoResponse;
    /**
...
export interface GetUserTablesOracleTaskOutputResponse {
     ...
     */
    tables: outputs.datamigration.v20211030preview.DatabaseTableResponse[];
    /**
     * Validation errors associated with the task
     */
    validationErrors: outputs.datamigration.v20211030preview.ReportableExceptionResponse[];
...
export interface GetUserTablesOracleTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.GetUserTablesOracleTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.GetUserTablesOracleTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface GetUserTablesPostgreSqlTaskInputResponse {
     ...
     */
    connectionInfo: outputs.datamigration.v20211030preview.PostgreSqlConnectionInfoResponse;
    /**
...
export function getUserTablesPostgreSqlTaskInputResponseProvideDefaults(val: GetUserTablesPostgreSqlTaskInputResponse): GetUserTablesPostgreSqlTaskInputResponse {
    return {
        ...val,
        connectionInfo: outputs.datamigration.v20211030preview.postgreSqlConnectionInfoResponseProvideDefaults(val.connectionInfo),
    };
}
...
export interface GetUserTablesPostgreSqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.GetUserTablesPostgreSqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.GetUserTablesPostgreSqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getUserTablesPostgreSqlTaskPropertiesResponseProvideDefaults(val: GetUserTablesPostgreSqlTaskPropertiesResponse): GetUserTablesPostgreSqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.getUserTablesPostgreSqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface GetUserTablesSqlSyncTaskOutputResponse {
     ...
     */
    databasesToSourceTables: {[key: string]: outputs.datamigration.v20211030preview.DatabaseTableResponse[]};
    /**
     * Mapping from database name to list of target tables
     */
    databasesToTargetTables: {[key: string]: outputs.datamigration.v20211030preview.DatabaseTableResponse[]};
    /**
...
export interface GetUserTablesSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.GetUserTablesSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.GetUserTablesSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getUserTablesSqlSyncTaskPropertiesResponseProvideDefaults(val: GetUserTablesSqlSyncTaskPropertiesResponse): GetUserTablesSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.getUserTablesSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface GetUserTablesSqlTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.GetUserTablesSqlTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.GetUserTablesSqlTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function getUserTablesSqlTaskPropertiesResponseProvideDefaults(val: GetUserTablesSqlTaskPropertiesResponse): GetUserTablesSqlTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.getUserTablesSqlTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateMISyncCompleteCommandOutputResponse {
     ...
     */
    errors?: outputs.datamigration.v20211030preview.ReportableExceptionResponse[];
}
...
export interface MigrateMISyncCompleteCommandPropertiesResponse {
     ...
     * Command input
     */
    input?: outputs.datamigration.v20211030preview.MigrateMISyncCompleteCommandInputResponse;
    /**
     * Command output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.MigrateMISyncCompleteCommandOutputResponse;
    /**
...
export interface MigrateMongoDbTaskPropertiesResponse {
     ...
     */
    input?: outputs.datamigration.v20211030preview.MongoDbMigrationSettingsResponse;
    output: (outputs.datamigration.v20211030preview.MongoDbCollectionProgressResponse | outputs.datamigration.v20211030preview.MongoDbDatabaseProgressResponse | outputs.datamigration.v20211030preview.MongoDbMigrationProgressResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskInputResponse {
     ...
     */
    selectedDatabases: outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlOfflineDatabaseInputResponse[];
    /**
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskOutputDatabaseLevelResponse {
     ...
     */
    exceptionsAndWarnings: outputs.datamigration.v20211030preview.ReportableExceptionResponse[];
    /**
     * Result identifier
     */
    id: string;
     ...
     */
    objectSummary: {[key: string]: outputs.datamigration.v20211030preview.DataItemMigrationSummaryResultResponse};
    /**
     * Wildcard string prefix to use for querying all sub-tem results of the item
     */
    resultPrefix: string;
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskOutputErrorResponse {
     ...
     * Migration error
     */
    error: outputs.datamigration.v20211030preview.ReportableExceptionResponse;
    /**
     * Result identifier
     */
    id: string;
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskOutputMigrationLevelResponse {
     ...
     * Summary of database results in the migration
     */
    databaseSummary: {[key: string]: outputs.datamigration.v20211030preview.DatabaseSummaryResultResponse};
    /**
     ...
     */
    migrationReportResult?: outputs.datamigration.v20211030preview.MigrationReportResultResponse;
    /**
     * Result type
...
export interface MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlOfflineTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlOfflineTaskOutputDatabaseLevelResponse | outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlOfflineTaskOutputErrorResponse | outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlOfflineTaskOutputMigrationLevelResponse | outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlOfflineTaskOutputTableLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponseProvideDefaults(val: MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse): MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.migrateMySqlAzureDbForMySqlOfflineTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateMySqlAzureDbForMySqlSyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlSyncDatabaseInputResponse[];
    /**
     * Connection information for source MySQL
     */
    sourceConnectionInfo: outputs.datamigration.v20211030preview.MySqlConnectionInfoResponse;
...
export interface MigrateMySqlAzureDbForMySqlSyncTaskOutputDatabaseErrorResponse {
     ...
     */
    events?: outputs.datamigration.v20211030preview.SyncMigrationDatabaseErrorEventResponse[];
    /**
     * Result identifier
     */
    id: string;
...
export interface MigrateMySqlAzureDbForMySqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlSyncTaskOutputDatabaseErrorResponse | outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlSyncTaskOutputDatabaseLevelResponse | outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlSyncTaskOutputErrorResponse | outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlSyncTaskOutputMigrationLevelResponse | outputs.datamigration.v20211030preview.MigrateMySqlAzureDbForMySqlSyncTaskOutputTableLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateMySqlAzureDbForMySqlSyncTaskPropertiesResponseProvideDefaults(val: MigrateMySqlAzureDbForMySqlSyncTaskPropertiesResponse): MigrateMySqlAzureDbForMySqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.migrateMySqlAzureDbForMySqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.MigrateOracleAzureDbPostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20211030preview.MigrateOracleAzureDbPostgreSqlSyncTaskOutputDatabaseErrorResponse | outputs.datamigration.v20211030preview.MigrateOracleAzureDbPostgreSqlSyncTaskOutputDatabaseLevelResponse | outputs.datamigration.v20211030preview.MigrateOracleAzureDbPostgreSqlSyncTaskOutputErrorResponse | outputs.datamigration.v20211030preview.MigrateOracleAzureDbPostgreSqlSyncTaskOutputMigrationLevelResponse | outputs.datamigration.v20211030preview.MigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse): MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.migrateOracleAzureDbPostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateOracleAzureDbPostgreSqlSyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20211030preview.MigrateOracleAzureDbPostgreSqlSyncDatabaseInputResponse[];
    /**
...
export interface MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputResponse {
     ...
     */
    selectedTables?: outputs.datamigration.v20211030preview.MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInputResponse[];
    /**
     * Source settings to tune source endpoint migration behavior
     */
    sourceSetting?: {[key: string]: string};
...
export interface MigratePostgreSqlAzureDbForPostgreSqlSyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20211030preview.MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputResponse[];
    /**
...
export interface MigratePostgreSqlAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20211030preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputDatabaseErrorResponse | outputs.datamigration.v20211030preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputDatabaseLevelResponse | outputs.datamigration.v20211030preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputErrorResponse | outputs.datamigration.v20211030preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevelResponse | outputs.datamigration.v20211030preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputTableLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migratePostgreSqlAzureDbForPostgreSqlSyncTaskPropertiesResponseProvideDefaults(val: MigratePostgreSqlAzureDbForPostgreSqlSyncTaskPropertiesResponse): MigratePostgreSqlAzureDbForPostgreSqlSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.migratePostgreSqlAzureDbForPostgreSqlSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSqlServerSqlDbSyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbSyncDatabaseInputResponse[];
    /**
     ...
     * Validation options
     */
    validationOptions?: outputs.datamigration.v20211030preview.MigrationValidationOptionsResponse;
}
/**
...
export interface MigrateSqlServerSqlDbSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbSyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbSyncTaskOutputDatabaseLevelResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbSyncTaskOutputErrorResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbSyncTaskOutputMigrationLevelResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbSyncTaskOutputTableLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateSqlServerSqlDbSyncTaskPropertiesResponseProvideDefaults(val: MigrateSqlServerSqlDbSyncTaskPropertiesResponse): MigrateSqlServerSqlDbSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.migrateSqlServerSqlDbSyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSqlServerSqlDbTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbDatabaseInputResponse[];
    /**
     * Information for connecting to source
     */
    sourceConnectionInfo: outputs.datamigration.v20211030preview.SqlConnectionInfoResponse;
...
export interface MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResultResponse {
     ...
     */
    dataIntegrityValidationResult: outputs.datamigration.v20211030preview.DataIntegrityValidationResultResponse;
    /**
     * Validation end time
     */
    endedOn: string;
     ...
     */
    queryAnalysisValidationResult: outputs.datamigration.v20211030preview.QueryAnalysisValidationResultResponse;
    /**
     * Result type
     ...
     */
    schemaValidationResult: outputs.datamigration.v20211030preview.SchemaComparisonValidationResultResponse;
    /**
...
export interface MigrateSqlServerSqlDbTaskOutputMigrationLevelResponse {
     ...
     */
    migrationValidationResult?: outputs.datamigration.v20211030preview.MigrationValidationResultResponse;
    /**
     * Result type
     * Expected value is 'MigrationLevelOutput'.
     */
...
export interface MigrateSqlServerSqlDbTaskOutputValidationResultResponse {
     ...
     */
    summaryResults?: {[key: string]: outputs.datamigration.v20211030preview.MigrationValidationDatabaseSummaryResultResponse};
}
...
export interface MigrateSqlServerSqlDbTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbTaskInputResponse;
    /**
     ...
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbTaskOutputDatabaseLevelResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResultResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbTaskOutputErrorResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbTaskOutputMigrationLevelResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbTaskOutputTableLevelResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlDbTaskOutputValidationResultResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateSqlServerSqlDbTaskPropertiesResponseProvideDefaults(val: MigrateSqlServerSqlDbTaskPropertiesResponse): MigrateSqlServerSqlDbTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.migrateSqlServerSqlDbTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSqlServerSqlMISyncTaskInputResponse {
     ...
     * Databases to migrate
     */
    selectedDatabases: outputs.datamigration.v20211030preview.MigrateSqlServerSqlMIDatabaseInputResponse[];
    /**
     * Connection information for source SQL Server
     */
    sourceConnectionInfo: outputs.datamigration.v20211030preview.SqlConnectionInfoResponse;
...
export interface MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse {
     ...
     */
    activeBackupSets: outputs.datamigration.v20211030preview.BackupSetInfoResponse[];
    /**
     ...
     */
    fullBackupSetInfo: outputs.datamigration.v20211030preview.BackupSetInfoResponse;
    /**
     * Result identifier
     */
    id: string;
     ...
     */
    lastRestoredBackupSetInfo: outputs.datamigration.v20211030preview.BackupSetInfoResponse;
    /**
...
export interface MigrateSqlServerSqlMISyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.MigrateSqlServerSqlMISyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20211030preview.MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlMISyncTaskOutputErrorResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlMISyncTaskOutputMigrationLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateSqlServerSqlMISyncTaskPropertiesResponseProvideDefaults(val: MigrateSqlServerSqlMISyncTaskPropertiesResponse): MigrateSqlServerSqlMISyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.migrateSqlServerSqlMISyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSqlServerSqlMITaskInputResponse {
     ...
     */
    backupBlobShare: outputs.datamigration.v20211030preview.BlobShareResponse;
    /**
     * Backup file share information for all selected databases.
     */
    backupFileShare?: outputs.datamigration.v20211030preview.FileShareResponse;
...
export interface MigrateSqlServerSqlMITaskOutputMigrationLevelResponse {
     ...
     */
    orphanedUsersInfo: outputs.datamigration.v20211030preview.OrphanedUserInfoResponse[];
    /**
     * Result type
     * Expected value is 'MigrationLevelOutput'.
     */
     ...
     */
    serverRoleResults: {[key: string]: outputs.datamigration.v20211030preview.StartMigrationScenarioServerRoleResultResponse};
    /**
     * Source server brand version
     */
    sourceServerBrandVersion: string;
...
export interface MigrateSqlServerSqlMITaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.MigrateSqlServerSqlMITaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20211030preview.MigrateSqlServerSqlMITaskOutputAgentJobLevelResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlMITaskOutputDatabaseLevelResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlMITaskOutputErrorResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlMITaskOutputLoginLevelResponse | outputs.datamigration.v20211030preview.MigrateSqlServerSqlMITaskOutputMigrationLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateSqlServerSqlMITaskPropertiesResponseProvideDefaults(val: MigrateSqlServerSqlMITaskPropertiesResponse): MigrateSqlServerSqlMITaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.migrateSqlServerSqlMITaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSsisTaskInputResponse {
     ...
     */
    ssisMigrationInfo: outputs.datamigration.v20211030preview.SsisMigrationInfoResponse;
    /**
     * Information for connecting to target
     */
    targetConnectionInfo: outputs.datamigration.v20211030preview.SqlConnectionInfoResponse;
...
export interface MigrateSsisTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.MigrateSsisTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: (outputs.datamigration.v20211030preview.MigrateSsisTaskOutputMigrationLevelResponse | outputs.datamigration.v20211030preview.MigrateSsisTaskOutputProjectLevelResponse)[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function migrateSsisTaskPropertiesResponseProvideDefaults(val: MigrateSsisTaskPropertiesResponse): MigrateSsisTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.migrateSsisTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface MigrateSyncCompleteCommandPropertiesResponse {
     ...
     * Command input
     */
    input?: outputs.datamigration.v20211030preview.MigrateSyncCompleteCommandInputResponse;
    /**
     * Command output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.MigrateSyncCompleteCommandOutputResponse;
    /**
     * The state of the command. This is ignored if submitted.
     */
    state: string;
...
export interface MongoDbClusterInfoResponse {
     ...
     */
    databases: outputs.datamigration.v20211030preview.MongoDbDatabaseInfoResponse[];
    /**
...
export interface MongoDbCollectionInfoResponse {
     ...
     */
    shardKey?: outputs.datamigration.v20211030preview.MongoDbShardKeyInfoResponse;
    /**
...
export interface MongoDbCollectionProgressResponse {
     ...
     */
    errors: {[key: string]: outputs.datamigration.v20211030preview.MongoDbErrorResponse};
    /**
...
export interface MongoDbCollectionSettingsResponse {
     ...
     */
    shardKey?: outputs.datamigration.v20211030preview.MongoDbShardKeySettingResponse;
    /**
...
export interface MongoDbDatabaseInfoResponse {
     ...
     */
    collections: outputs.datamigration.v20211030preview.MongoDbCollectionInfoResponse[];
    /**
     * The estimated total data size, in bytes, or -1 if the size is unknown.
     */
    dataSize: number;
...
export interface MongoDbDatabaseProgressResponse {
     ...
     */
    collections?: {[key: string]: outputs.datamigration.v20211030preview.MongoDbCollectionProgressResponse};
    /**
     * The number of documents copied during the Copying stage
     */
    documentsCopied: number;
...
export interface MongoDbDatabaseSettingsResponse {
     ...
     */
    collections: {[key: string]: outputs.datamigration.v20211030preview.MongoDbCollectionSettingsResponse};
    /**
...
export interface MongoDbMigrationProgressResponse {
     ...
     */
    databases?: {[key: string]: outputs.datamigration.v20211030preview.MongoDbDatabaseProgressResponse};
    /**
     * The number of documents copied during the Copying stage
     */
    documentsCopied: number;
...
export interface MongoDbMigrationSettingsResponse {
     ...
     */
    databases: {[key: string]: outputs.datamigration.v20211030preview.MongoDbDatabaseSettingsResponse};
    /**
     ...
     */
    source: outputs.datamigration.v20211030preview.MongoDbConnectionInfoResponse;
    /**
     * Settings used to connect to the target cluster
     */
    target: outputs.datamigration.v20211030preview.MongoDbConnectionInfoResponse;
    /**
     * Settings used to limit the resource usage of the migration
     */
    throttling?: outputs.datamigration.v20211030preview.MongoDbThrottlingSettingsResponse;
}
...
export interface MongoDbShardKeyInfoResponse {
     ...
     */
    fields: outputs.datamigration.v20211030preview.MongoDbShardKeyFieldResponse[];
    /**
...
export interface ODataErrorResponse {
     ...
     */
    details?: outputs.datamigration.v20211030preview.ODataErrorResponse[];
    /**
...
export interface QueryAnalysisValidationResultResponse {
     ...
     */
    queryResults?: outputs.datamigration.v20211030preview.QueryExecutionResultResponse;
    /**
...
export interface QueryExecutionResultResponse {
     ...
     */
    sourceResult?: outputs.datamigration.v20211030preview.ExecutionStatisticsResponse;
    /**
     ...
     */
    targetResult?: outputs.datamigration.v20211030preview.ExecutionStatisticsResponse;
}
...
export interface SchemaComparisonValidationResultResponse {
     ...
     */
    schemaDifferences?: outputs.datamigration.v20211030preview.SchemaComparisonValidationResultTypeResponse;
    /**
...
export interface ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ValidateSyncMigrationInputSqlServerTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ValidateSyncMigrationInputSqlServerTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function validateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponseProvideDefaults(val: ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse): ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.validateSyncMigrationInputSqlServerTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ValidateMigrationInputSqlServerSqlMISyncTaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ValidateMigrationInputSqlServerSqlMISyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function validateMigrationInputSqlServerSqlMISyncTaskPropertiesResponseProvideDefaults(val: ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse): ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.validateMigrationInputSqlServerSqlMISyncTaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ValidateMigrationInputSqlServerSqlMITaskOutputResponse {
     ...
     */
    backupFolderErrors: outputs.datamigration.v20211030preview.ReportableExceptionResponse[];
    /**
     * Errors associated with backup share user name and password credentials
     */
    backupShareCredentialsErrors: outputs.datamigration.v20211030preview.ReportableExceptionResponse[];
    /**
     * Errors associated with the storage account provided.
     */
    backupStorageAccountErrors: outputs.datamigration.v20211030preview.ReportableExceptionResponse[];
    /**
     * Information about backup files when existing backup mode is used.
     */
    databaseBackupInfo?: outputs.datamigration.v20211030preview.DatabaseBackupInfoResponse;
    /**
     * Errors associated with existing backup files.
     */
    existingBackupErrors: outputs.datamigration.v20211030preview.ReportableExceptionResponse[];
    /**
     * Result identifier
     */
    id: string;
     ...
     */
    restoreDatabaseNameErrors: outputs.datamigration.v20211030preview.ReportableExceptionResponse[];
}
...
export interface ValidateMigrationInputSqlServerSqlMITaskPropertiesResponse {
     ...
     * Task input
     */
    input?: outputs.datamigration.v20211030preview.ValidateMigrationInputSqlServerSqlMITaskInputResponse;
    /**
     * Task output. This is ignored if submitted.
     */
    output: outputs.datamigration.v20211030preview.ValidateMigrationInputSqlServerSqlMITaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export function validateMigrationInputSqlServerSqlMITaskPropertiesResponseProvideDefaults(val: ValidateMigrationInputSqlServerSqlMITaskPropertiesResponse): ValidateMigrationInputSqlServerSqlMITaskPropertiesResponse {
    return {
        ...val,
        input: (val.input ? outputs.datamigration.v20211030preview.validateMigrationInputSqlServerSqlMITaskInputResponseProvideDefaults(val.input) : undefined),
    };
}
...
export interface ValidateMongoDbTaskPropertiesResponse {
     ...
     */
    output: outputs.datamigration.v20211030preview.MongoDbMigrationProgressResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
...
export interface ValidateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
     ...
     */
    output: outputs.datamigration.v20211030preview.ValidateOracleAzureDbPostgreSqlSyncTaskOutputResponse[];
    /**
     * The state of the task. This is ignored if submitted.
     */
    state: string;
