...
export interface AKSArgs {
     ...
     * AKS properties
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20200801.AKSPropertiesArgs>;
    /**
...
export interface AKSPropertiesArgs {
     ...
     */
    aksNetworkingConfiguration?: pulumi.Input<inputs.machinelearningservices.v20200801.AksNetworkingConfigurationArgs>;
    /**
     ...
     * SSL configuration
     */
    sslConfiguration?: pulumi.Input<inputs.machinelearningservices.v20200801.SslConfigurationArgs>;
}
...
export interface AmlComputeArgs {
     ...
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20200801.AmlComputePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export function amlComputeArgsProvideDefaults(val: AmlComputeArgs): AmlComputeArgs {
    return {
        ...val,
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.machinelearningservices.v20200801.amlComputePropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface AmlComputePropertiesArgs {
     ...
     * Compute OS Type
     */
    osType?: pulumi.Input<string | enums.machinelearningservices.v20200801.OsType>;
    /**
     * State of the public SSH port. Possible values are: Disabled - Indicates that the public ssh port is closed on all nodes of the cluster. Enabled - Indicates that the public ssh port is open on all nodes of the cluster. NotSpecified - Indicates that the public ssh port is closed on all nodes of the cluster if VNet is defined, else is open all public nodes. It can be default only during cluster creation time, after creation it will be either enabled or disabled.
     */
    remoteLoginPortPublicAccess?: pulumi.Input<string | enums.machinelearningservices.v20200801.RemoteLoginPortPublicAccess>;
    /**
     * Scale settings for AML Compute
     */
    scaleSettings?: pulumi.Input<inputs.machinelearningservices.v20200801.ScaleSettingsArgs>;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: pulumi.Input<inputs.machinelearningservices.v20200801.ResourceIdArgs>;
    /**
     * Credentials for an administrator user account that will be created on each compute node.
     */
    userAccountCredentials?: pulumi.Input<inputs.machinelearningservices.v20200801.UserAccountCredentialsArgs>;
    /**
     * Virtual Machine priority
     */
    vmPriority?: pulumi.Input<string | enums.machinelearningservices.v20200801.VmPriority>;
    /**
...
export function amlComputePropertiesArgsProvideDefaults(val: AmlComputePropertiesArgs): AmlComputePropertiesArgs {
    return {
        ...
        scaleSettings: (val.scaleSettings ? pulumi.output(val.scaleSettings).apply(inputs.machinelearningservices.v20200801.scaleSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface ComputeInstanceArgs {
     ...
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20200801.ComputeInstancePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export function computeInstanceArgsProvideDefaults(val: ComputeInstanceArgs): ComputeInstanceArgs {
    return {
        ...val,
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.machinelearningservices.v20200801.computeInstancePropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface ComputeInstancePropertiesArgs {
     ...
     */
    applicationSharingPolicy?: pulumi.Input<string | enums.machinelearningservices.v20200801.ApplicationSharingPolicy>;
    /**
     * The Compute Instance Authorization type. Available values are personal (default).
     */
    computeInstanceAuthorizationType?: pulumi.Input<string | enums.machinelearningservices.v20200801.ComputeInstanceAuthorizationType>;
    /**
     * Settings for a personal compute instance.
     */
    personalComputeInstanceSettings?: pulumi.Input<inputs.machinelearningservices.v20200801.PersonalComputeInstanceSettingsArgs>;
    /**
     * Specifies policy and settings for SSH access.
     */
    sshSettings?: pulumi.Input<inputs.machinelearningservices.v20200801.ComputeInstanceSshSettingsArgs>;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: pulumi.Input<inputs.machinelearningservices.v20200801.ResourceIdArgs>;
...
export function computeInstancePropertiesArgsProvideDefaults(val: ComputeInstancePropertiesArgs): ComputeInstancePropertiesArgs {
    return {
        ...
        sshSettings: (val.sshSettings ? pulumi.output(val.sshSettings).apply(inputs.machinelearningservices.v20200801.computeInstanceSshSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface ComputeInstanceSshSettingsArgs {
     ...
     */
    sshPublicAccess?: pulumi.Input<string | enums.machinelearningservices.v20200801.SshPublicAccess>;
}
/**
...
export interface DataLakeAnalyticsArgs {
     ...
     */
    description?: pulumi.Input<string>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20200801.DataLakeAnalyticsPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface DatabricksArgs {
     ...
     */
    description?: pulumi.Input<string>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20200801.DatabricksPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface EncryptionPropertyArgs {
     ...
     */
    keyVaultProperties: pulumi.Input<inputs.machinelearningservices.v20200801.KeyVaultPropertiesArgs>;
    /**
     * Indicates whether or not the encryption is enabled for the workspace.
     */
    status: pulumi.Input<string | enums.machinelearningservices.v20200801.EncryptionStatus>;
}
...
export interface HDInsightArgs {
     ...
     */
    description?: pulumi.Input<string>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20200801.HDInsightPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface HDInsightPropertiesArgs {
     ...
     */
    administratorAccount?: pulumi.Input<inputs.machinelearningservices.v20200801.VirtualMachineSshCredentialsArgs>;
    /**
...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type: pulumi.Input<enums.machinelearningservices.v20200801.ResourceIdentityType>;
    /**
...
export interface PersonalComputeInstanceSettingsArgs {
     ...
     */
    assignedUser?: pulumi.Input<inputs.machinelearningservices.v20200801.AssignedUserArgs>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.machinelearningservices.v20200801.PrivateEndpointServiceConnectionStatus>;
}
...
export interface VirtualMachineArgs {
     ...
     */
    description?: pulumi.Input<string>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20200801.VirtualMachinePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
