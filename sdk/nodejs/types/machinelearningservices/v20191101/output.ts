...
export interface AKSResponse {
     ...
     * AKS properties
     */
    properties?: outputs.machinelearningservices.v20191101.AKSResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20191101.MachineLearningServiceErrorResponse[];
    /**
...
export interface AKSResponseProperties {
     ...
     */
    aksNetworkingConfiguration?: outputs.machinelearningservices.v20191101.AksNetworkingConfigurationResponse;
    /**
     ...
     * SSL configuration
     */
    sslConfiguration?: outputs.machinelearningservices.v20191101.SslConfigurationResponse;
    /**
     * System services
     */
    systemServices: outputs.machinelearningservices.v20191101.SystemServiceResponse[];
}
...
export interface AmlComputeResponse {
     ...
     */
    properties?: outputs.machinelearningservices.v20191101.AmlComputeResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20191101.MachineLearningServiceErrorResponse[];
...
export function amlComputeResponseProvideDefaults(val: AmlComputeResponse): AmlComputeResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.machinelearningservices.v20191101.amlComputeResponsePropertiesProvideDefaults(val.properties) : undefined),
    };
}
...
export interface AmlComputeResponseProperties {
     ...
     */
    errors: outputs.machinelearningservices.v20191101.MachineLearningServiceErrorResponse[];
    /**
     * Counts of various node states on the compute.
     */
    nodeStateCounts: outputs.machinelearningservices.v20191101.NodeStateCountsResponse;
    /**
     ...
     */
    scaleSettings?: outputs.machinelearningservices.v20191101.ScaleSettingsResponse;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: outputs.machinelearningservices.v20191101.ResourceIdResponse;
    /**
     ...
     */
    userAccountCredentials?: outputs.machinelearningservices.v20191101.UserAccountCredentialsResponse;
    /**
...
export function amlComputeResponsePropertiesProvideDefaults(val: AmlComputeResponseProperties): AmlComputeResponseProperties {
    return {
        ...
        scaleSettings: (val.scaleSettings ? outputs.machinelearningservices.v20191101.scaleSettingsResponseProvideDefaults(val.scaleSettings) : undefined),
    };
}
...
export interface DataLakeAnalyticsResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20191101.DataLakeAnalyticsResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20191101.MachineLearningServiceErrorResponse[];
...
export interface DatabricksResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20191101.DatabricksResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20191101.MachineLearningServiceErrorResponse[];
...
export interface ErrorResponseResponse {
     ...
     */
    details: outputs.machinelearningservices.v20191101.ErrorDetailResponse[];
    /**
     * Error message.
     */
    message: string;
...
export interface HDInsightResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20191101.HDInsightResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20191101.MachineLearningServiceErrorResponse[];
...
export interface HDInsightResponseProperties {
     ...
     */
    administratorAccount?: outputs.machinelearningservices.v20191101.VirtualMachineSshCredentialsResponse;
    /**
...
export interface MachineLearningServiceErrorResponse {
     ...
     * The error response.
     */
    error: outputs.machinelearningservices.v20191101.ErrorResponseResponse;
}
...
export interface RegistryListCredentialsResultResponse {
    location: string;
    passwords?: outputs.machinelearningservices.v20191101.PasswordResponse[];
    username: string;
}
...
export interface VirtualMachineResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20191101.VirtualMachineResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20191101.MachineLearningServiceErrorResponse[];
