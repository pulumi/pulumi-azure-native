...
export interface AKSResponse {
     ...
     * AKS properties
     */
    properties?: outputs.machinelearningservices.v20200401.AKSResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20200401.MachineLearningServiceErrorResponse[];
    /**
...
export function aksresponseProvideDefaults(val: AKSResponse): AKSResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.machinelearningservices.v20200401.aksresponsePropertiesProvideDefaults(val.properties) : undefined),
    };
}
...
export interface AKSResponseProperties {
     ...
     */
    aksNetworkingConfiguration?: outputs.machinelearningservices.v20200401.AksNetworkingConfigurationResponse;
    /**
     ...
     * SSL configuration
     */
    sslConfiguration?: outputs.machinelearningservices.v20200401.SslConfigurationResponse;
    /**
     * System services
     */
    systemServices: outputs.machinelearningservices.v20200401.SystemServiceResponse[];
}
/**
...
export function aksresponsePropertiesProvideDefaults(val: AKSResponseProperties): AKSResponseProperties {
    return {
        ...val,
        sslConfiguration: (val.sslConfiguration ? outputs.machinelearningservices.v20200401.sslConfigurationResponseProvideDefaults(val.sslConfiguration) : undefined),
    };
}
...
export interface AmlComputeResponse {
     ...
     */
    properties?: outputs.machinelearningservices.v20200401.AmlComputeResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20200401.MachineLearningServiceErrorResponse[];
...
export function amlComputeResponseProvideDefaults(val: AmlComputeResponse): AmlComputeResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.machinelearningservices.v20200401.amlComputeResponsePropertiesProvideDefaults(val.properties) : undefined),
    };
}
...
export interface AmlComputeResponseProperties {
     ...
     */
    errors: outputs.machinelearningservices.v20200401.MachineLearningServiceErrorResponse[];
    /**
     * Counts of various node states on the compute.
     */
    nodeStateCounts: outputs.machinelearningservices.v20200401.NodeStateCountsResponse;
    /**
     ...
     */
    scaleSettings?: outputs.machinelearningservices.v20200401.ScaleSettingsResponse;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: outputs.machinelearningservices.v20200401.ResourceIdResponse;
    /**
     ...
     */
    userAccountCredentials?: outputs.machinelearningservices.v20200401.UserAccountCredentialsResponse;
    /**
...
export function amlComputeResponsePropertiesProvideDefaults(val: AmlComputeResponseProperties): AmlComputeResponseProperties {
    return {
        ...
        scaleSettings: (val.scaleSettings ? outputs.machinelearningservices.v20200401.scaleSettingsResponseProvideDefaults(val.scaleSettings) : undefined),
    };
}
...
export interface DataLakeAnalyticsResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20200401.DataLakeAnalyticsResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20200401.MachineLearningServiceErrorResponse[];
...
export interface DatabricksResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20200401.DatabricksResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20200401.MachineLearningServiceErrorResponse[];
...
export interface EncryptionPropertyResponse {
     ...
     */
    keyVaultProperties: outputs.machinelearningservices.v20200401.KeyVaultPropertiesResponse;
    /**
...
export interface ErrorResponseResponse {
     ...
     */
    details: outputs.machinelearningservices.v20200401.ErrorDetailResponse[];
    /**
     * Error message.
     */
    message: string;
...
export interface HDInsightResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20200401.HDInsightResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20200401.MachineLearningServiceErrorResponse[];
...
export interface HDInsightResponseProperties {
     ...
     */
    administratorAccount?: outputs.machinelearningservices.v20200401.VirtualMachineSshCredentialsResponse;
    /**
...
export interface IdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.machinelearningservices.v20200401.IdentityResponseUserAssignedIdentities};
}
...
export interface MachineLearningServiceErrorResponse {
     ...
     * The error response.
     */
    error: outputs.machinelearningservices.v20200401.ErrorResponseResponse;
}
...
export interface NotebookResourceInfoResponse {
     ...
     */
    notebookPreparationError?: outputs.machinelearningservices.v20200401.NotebookPreparationErrorResponse;
    /**
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    identity?: outputs.machinelearningservices.v20200401.IdentityResponse;
    /**
     ...
     */
    privateEndpoint?: outputs.machinelearningservices.v20200401.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: outputs.machinelearningservices.v20200401.PrivateLinkServiceConnectionStateResponse;
    /**
     ...
     */
    sku?: outputs.machinelearningservices.v20200401.SkuResponse;
    /**
...
export interface RegistryListCredentialsResultResponse {
    location: string;
    passwords?: outputs.machinelearningservices.v20200401.PasswordResponse[];
    username: string;
}
...
export interface VirtualMachineResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20200401.VirtualMachineResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20200401.MachineLearningServiceErrorResponse[];
