...
export interface AKSResponse {
     ...
     * AKS properties
     */
    properties?: outputs.machinelearningservices.v20190501.AKSResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20190501.MachineLearningServiceErrorResponse[];
    /**
...
export interface AKSResponseProperties {
     ...
     */
    aksNetworkingConfiguration?: outputs.machinelearningservices.v20190501.AksNetworkingConfigurationResponse;
    /**
     ...
     * SSL configuration
     */
    sslConfiguration?: outputs.machinelearningservices.v20190501.SslConfigurationResponse;
    /**
     * System services
     */
    systemServices: outputs.machinelearningservices.v20190501.SystemServiceResponse[];
}
...
export interface AmlComputeResponse {
     ...
     */
    properties?: outputs.machinelearningservices.v20190501.AmlComputeResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20190501.MachineLearningServiceErrorResponse[];
...
export function amlComputeResponseProvideDefaults(val: AmlComputeResponse): AmlComputeResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.machinelearningservices.v20190501.amlComputeResponsePropertiesProvideDefaults(val.properties) : undefined),
    };
}
...
export interface AmlComputeResponseProperties {
     ...
     */
    errors: outputs.machinelearningservices.v20190501.MachineLearningServiceErrorResponse[];
    /**
     * Counts of various node states on the compute.
     */
    nodeStateCounts: outputs.machinelearningservices.v20190501.NodeStateCountsResponse;
    /**
     * Scale settings for AML Compute
     */
    scaleSettings?: outputs.machinelearningservices.v20190501.ScaleSettingsResponse;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: outputs.machinelearningservices.v20190501.ResourceIdResponse;
    /**
     ...
     */
    userAccountCredentials?: outputs.machinelearningservices.v20190501.UserAccountCredentialsResponse;
    /**
...
export function amlComputeResponsePropertiesProvideDefaults(val: AmlComputeResponseProperties): AmlComputeResponseProperties {
    return {
        ...val,
        scaleSettings: (val.scaleSettings ? outputs.machinelearningservices.v20190501.scaleSettingsResponseProvideDefaults(val.scaleSettings) : undefined),
    };
}
...
export interface DataLakeAnalyticsResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20190501.DataLakeAnalyticsResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20190501.MachineLearningServiceErrorResponse[];
...
export interface DatabricksResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20190501.DatabricksResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20190501.MachineLearningServiceErrorResponse[];
...
export interface ErrorResponseResponse {
     ...
     */
    details: outputs.machinelearningservices.v20190501.ErrorDetailResponse[];
    /**
     * Error message.
     */
    message: string;
...
export interface HDInsightResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20190501.HDInsightResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20190501.MachineLearningServiceErrorResponse[];
...
export interface HDInsightResponseProperties {
     ...
     */
    administratorAccount?: outputs.machinelearningservices.v20190501.VirtualMachineSshCredentialsResponse;
    /**
...
export interface MachineLearningServiceErrorResponse {
     ...
     * The error response.
     */
    error: outputs.machinelearningservices.v20190501.ErrorResponseResponse;
}
...
export interface RegistryListCredentialsResultResponse {
    location: string;
    passwords?: outputs.machinelearningservices.v20190501.PasswordResponse[];
    username: string;
}
...
export interface VirtualMachineResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20190501.VirtualMachineResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20190501.MachineLearningServiceErrorResponse[];
