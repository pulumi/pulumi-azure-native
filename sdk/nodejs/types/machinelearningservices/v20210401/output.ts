...
export interface ACIServiceResponseResponse {
     ...
     */
    containerResourceRequirements?: outputs.machinelearningservices.v20210401.ContainerResourceRequirementsResponse;
    /**
     * Details of the data collection options specified.
     */
    dataCollection?: outputs.machinelearningservices.v20210401.ACIServiceResponseResponseDataCollection;
    /**
     ...
     */
    encryptionProperties?: outputs.machinelearningservices.v20210401.ACIServiceResponseResponseEncryptionProperties;
    /**
     * The Environment, models and assets used for inferencing.
     */
    environmentImageRequest?: outputs.machinelearningservices.v20210401.ACIServiceResponseResponseEnvironmentImageRequest;
    /**
     * The error details.
     */
    error: outputs.machinelearningservices.v20210401.ServiceResponseBaseResponseError;
    /**
     ...
     * The list of models.
     */
    models?: outputs.machinelearningservices.v20210401.ModelResponse[];
    /**
     ...
     */
    vnetConfiguration?: outputs.machinelearningservices.v20210401.ACIServiceResponseResponseVnetConfiguration;
}
...
export interface ACIServiceResponseResponseEnvironmentImageRequest {
     ...
     * The list of assets.
     */
    assets?: outputs.machinelearningservices.v20210401.ImageAssetResponse[];
    /**
     ...
     */
    environment?: outputs.machinelearningservices.v20210401.EnvironmentImageResponseResponseEnvironment;
    /**
     * The unique identifying details of the AZURE ML environment.
     */
    environmentReference?: outputs.machinelearningservices.v20210401.EnvironmentImageResponseResponseEnvironmentReference;
    /**
...
export interface AKSReplicaStatusResponseError {
     ...
     * The error response.
     */
    error: outputs.machinelearningservices.v20210401.ErrorResponseResponse;
}
...
export interface AKSResponse {
     ...
     * AKS properties
     */
    properties?: outputs.machinelearningservices.v20210401.AKSResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20210401.MachineLearningServiceErrorResponse[];
    /**
...
export function aksresponseProvideDefaults(val: AKSResponse): AKSResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.machinelearningservices.v20210401.aksresponsePropertiesProvideDefaults(val.properties) : undefined),
    };
}
...
export interface AKSResponseProperties {
     ...
     */
    aksNetworkingConfiguration?: outputs.machinelearningservices.v20210401.AksNetworkingConfigurationResponse;
    /**
     ...
     * SSL configuration
     */
    sslConfiguration?: outputs.machinelearningservices.v20210401.SslConfigurationResponse;
    /**
     * System services
     */
    systemServices: outputs.machinelearningservices.v20210401.SystemServiceResponse[];
}
/**
...
export interface AKSServiceResponseResponse {
     ...
     */
    autoScaler?: outputs.machinelearningservices.v20210401.AKSServiceResponseResponseAutoScaler;
    /**
     ...
     * Details of the data collection options specified.
     */
    dataCollection?: outputs.machinelearningservices.v20210401.AKSServiceResponseResponseDataCollection;
    /**
     * The deployment status.
     */
    deploymentStatus: outputs.machinelearningservices.v20210401.AKSServiceResponseResponseDeploymentStatus;
    /**
     * The deployment type for the service.
     */
    deploymentType?: string;
     ...
     * The Environment, models and assets used for inferencing.
     */
    environmentImageRequest?: outputs.machinelearningservices.v20210401.AKSServiceResponseResponseEnvironmentImageRequest;
    /**
     * The error details.
     */
    error: outputs.machinelearningservices.v20210401.ServiceResponseBaseResponseError;
     ...
     */
    livenessProbeRequirements?: outputs.machinelearningservices.v20210401.AKSServiceResponseResponseLivenessProbeRequirements;
    /**
...
export interface AKSServiceResponseResponseDeploymentStatus {
     ...
     * The error details.
     */
    error?: outputs.machinelearningservices.v20210401.AKSReplicaStatusResponseError;
    /**
...
export interface AmlComputeResponse {
     ...
     */
    properties?: outputs.machinelearningservices.v20210401.AmlComputeResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20210401.MachineLearningServiceErrorResponse[];
...
export function amlComputeResponseProvideDefaults(val: AmlComputeResponse): AmlComputeResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.machinelearningservices.v20210401.amlComputeResponsePropertiesProvideDefaults(val.properties) : undefined),
    };
}
...
export interface AmlComputeResponseProperties {
     ...
     */
    errors: outputs.machinelearningservices.v20210401.MachineLearningServiceErrorResponse[];
    /**
     ...
     */
    nodeStateCounts: outputs.machinelearningservices.v20210401.NodeStateCountsResponse;
    /**
     * Compute OS Type
     */
    osType?: string;
     ...
     */
    scaleSettings?: outputs.machinelearningservices.v20210401.ScaleSettingsResponse;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: outputs.machinelearningservices.v20210401.ResourceIdResponse;
    /**
     ...
     */
    userAccountCredentials?: outputs.machinelearningservices.v20210401.UserAccountCredentialsResponse;
    /**
     * Virtual Machine image for AML Compute - windows only
     */
    virtualMachineImage?: outputs.machinelearningservices.v20210401.VirtualMachineImageResponse;
    /**
...
export function amlComputeResponsePropertiesProvideDefaults(val: AmlComputeResponseProperties): AmlComputeResponseProperties {
    return {
        ...
        scaleSettings: (val.scaleSettings ? outputs.machinelearningservices.v20210401.scaleSettingsResponseProvideDefaults(val.scaleSettings) : undefined),
    };
}
...
export interface ComputeInstanceResponse {
     ...
     */
    properties?: outputs.machinelearningservices.v20210401.ComputeInstanceResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20210401.MachineLearningServiceErrorResponse[];
...
export function computeInstanceResponseProvideDefaults(val: ComputeInstanceResponse): ComputeInstanceResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.machinelearningservices.v20210401.computeInstanceResponsePropertiesProvideDefaults(val.properties) : undefined),
    };
}
...
export interface ComputeInstanceResponseProperties {
     ...
     */
    applications: outputs.machinelearningservices.v20210401.ComputeInstanceApplicationResponse[];
    /**
     ...
     */
    connectivityEndpoints: outputs.machinelearningservices.v20210401.ComputeInstanceConnectivityEndpointsResponse;
    /**
     * Describes information on user who created this ComputeInstance.
     */
    createdBy: outputs.machinelearningservices.v20210401.ComputeInstanceCreatedByResponse;
    /**
     ...
     * The last operation on ComputeInstance.
     */
    lastOperation: outputs.machinelearningservices.v20210401.ComputeInstanceLastOperationResponse;
    /**
     * Settings for a personal compute instance.
     */
    personalComputeInstanceSettings?: outputs.machinelearningservices.v20210401.PersonalComputeInstanceSettingsResponse;
    /**
     * Details of customized scripts to execute for setting up the cluster.
     */
    setupScripts?: outputs.machinelearningservices.v20210401.SetupScriptsResponse;
    /**
     * Specifies policy and settings for SSH access.
     */
    sshSettings?: outputs.machinelearningservices.v20210401.ComputeInstanceSshSettingsResponse;
    /**
...
export function computeInstanceResponsePropertiesProvideDefaults(val: ComputeInstanceResponseProperties): ComputeInstanceResponseProperties {
    return {
        ...
        sshSettings: (val.sshSettings ? outputs.machinelearningservices.v20210401.computeInstanceSshSettingsResponseProvideDefaults(val.sshSettings) : undefined),
    };
}
...
export interface DataLakeAnalyticsResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20210401.DataLakeAnalyticsResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20210401.MachineLearningServiceErrorResponse[];
...
export interface DatabricksResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20210401.DatabricksResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20210401.MachineLearningServiceErrorResponse[];
...
export interface EncryptionPropertyResponse {
     ...
     */
    identity?: outputs.machinelearningservices.v20210401.IdentityForCmkResponse;
    /**
     * Customer Key vault properties.
     */
    keyVaultProperties: outputs.machinelearningservices.v20210401.KeyVaultPropertiesResponse;
    /**
...
export interface EnvironmentImageResponseResponseEnvironment {
     ...
     */
    docker?: outputs.machinelearningservices.v20210401.ModelEnvironmentDefinitionResponseResponseDocker;
    /**
     ...
     */
    python?: outputs.machinelearningservices.v20210401.ModelEnvironmentDefinitionResponseResponsePython;
    /**
     * Settings for a R environment.
     */
    r?: outputs.machinelearningservices.v20210401.ModelEnvironmentDefinitionResponseResponseR;
    /**
     * The configuration for a Spark environment.
     */
    spark?: outputs.machinelearningservices.v20210401.ModelEnvironmentDefinitionResponseResponseSpark;
    /**
...
export interface ErrorResponseResponse {
     ...
     */
    details: outputs.machinelearningservices.v20210401.ErrorDetailResponse[];
    /**
     * Error message.
     */
    message: string;
...
export interface HDInsightResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20210401.HDInsightResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20210401.MachineLearningServiceErrorResponse[];
...
export interface HDInsightResponseProperties {
     ...
     */
    administratorAccount?: outputs.machinelearningservices.v20210401.VirtualMachineSshCredentialsResponse;
    /**
...
export interface IdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.machinelearningservices.v20210401.UserAssignedIdentityResponse};
}
...
export interface ModelEnvironmentDefinitionResponseResponseDocker {
     ...
     * Image registry that contains the base image.
     */
    baseImageRegistry?: outputs.machinelearningservices.v20210401.ModelDockerSectionResponseResponseBaseImageRegistry;
}
...
export interface ModelEnvironmentDefinitionResponseResponseR {
     ...
     */
    cranPackages?: outputs.machinelearningservices.v20210401.RCranPackageResponse[];
    /**
     ...
     */
    gitHubPackages?: outputs.machinelearningservices.v20210401.RGitHubPackageResponseResponse[];
    /**
...
export interface ModelEnvironmentDefinitionResponseResponseSpark {
     ...
     */
    packages?: outputs.machinelearningservices.v20210401.SparkMavenPackageResponse[];
    /**
...
export interface ModelResponse {
     ...
     */
    datasets?: outputs.machinelearningservices.v20210401.DatasetReferenceResponse[];
    /**
     ...
     */
    resourceRequirements?: outputs.machinelearningservices.v20210401.ContainerResourceRequirementsResponse;
    /**
...
export interface NotebookResourceInfoResponse {
     ...
     */
    notebookPreparationError?: outputs.machinelearningservices.v20210401.NotebookPreparationErrorResponse;
    /**
...
export interface PersonalComputeInstanceSettingsResponse {
     ...
     */
    assignedUser?: outputs.machinelearningservices.v20210401.AssignedUserResponse;
}
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    identity?: outputs.machinelearningservices.v20210401.IdentityResponse;
    /**
     ...
     */
    privateEndpoint?: outputs.machinelearningservices.v20210401.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: outputs.machinelearningservices.v20210401.PrivateLinkServiceConnectionStateResponse;
    /**
     ...
     */
    sku?: outputs.machinelearningservices.v20210401.SkuResponse;
    /**
     * Read only system data
     */
    systemData: outputs.machinelearningservices.v20210401.SystemDataResponse;
    /**
...
export interface RegistryListCredentialsResultResponse {
    location: string;
    passwords?: outputs.machinelearningservices.v20210401.PasswordResponse[];
    username: string;
}
...
export interface ScriptsToExecuteResponse {
     ...
     */
    creationScript?: outputs.machinelearningservices.v20210401.ScriptReferenceResponse;
    /**
     * Script that's run every time the machine starts.
     */
    startupScript?: outputs.machinelearningservices.v20210401.ScriptReferenceResponse;
}
...
export interface ServiceManagedResourcesSettingsResponse {
     ...
     */
    cosmosDb?: outputs.machinelearningservices.v20210401.CosmosDbSettingsResponse;
}
...
export interface SetupScriptsResponse {
     ...
     * Customized setup scripts
     */
    scripts?: outputs.machinelearningservices.v20210401.ScriptsToExecuteResponse;
}
...
export interface SynapseSparkPoolPropertiesResponseProperties {
     ...
     * Auto pause properties.
     */
    autoPauseProperties?: outputs.machinelearningservices.v20210401.AutoPausePropertiesResponse;
    /**
     * Auto scale properties.
     */
    autoScaleProperties?: outputs.machinelearningservices.v20210401.AutoScalePropertiesResponse;
    /**
     * The number of compute nodes currently assigned to the compute.
     */
    nodeCount?: number;
...
export interface SynapseSparkResponse {
     ...
     * AKS properties
     */
    properties?: outputs.machinelearningservices.v20210401.SynapseSparkPoolPropertiesResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20210401.MachineLearningServiceErrorResponse[];
...
export interface VirtualMachineResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20210401.VirtualMachineResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20210401.MachineLearningServiceErrorResponse[];
