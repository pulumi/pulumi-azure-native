...
export interface AKSArgs {
     ...
     * AKS properties
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20210401.AKSPropertiesArgs>;
    /**
...
export function aksargsProvideDefaults(val: AKSArgs): AKSArgs {
    return {
        ...val,
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.machinelearningservices.v20210401.akspropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface AKSPropertiesArgs {
     ...
     */
    aksNetworkingConfiguration?: pulumi.Input<inputs.machinelearningservices.v20210401.AksNetworkingConfigurationArgs>;
    /**
     ...
     */
    clusterPurpose?: pulumi.Input<string | enums.machinelearningservices.v20210401.ClusterPurpose>;
    /**
     ...
     * Load Balancer Type
     */
    loadBalancerType?: pulumi.Input<string | enums.machinelearningservices.v20210401.LoadBalancerType>;
    /**
     * SSL configuration
     */
    sslConfiguration?: pulumi.Input<inputs.machinelearningservices.v20210401.SslConfigurationArgs>;
}
/**
...
export interface AmlComputeArgs {
     ...
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20210401.AmlComputePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export function amlComputeArgsProvideDefaults(val: AmlComputeArgs): AmlComputeArgs {
    return {
        ...val,
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.machinelearningservices.v20210401.amlComputePropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface AmlComputePropertiesArgs {
     ...
     * Compute OS Type
     */
    osType?: pulumi.Input<string | enums.machinelearningservices.v20210401.OsType>;
    /**
     * State of the public SSH port. Possible values are: Disabled - Indicates that the public ssh port is closed on all nodes of the cluster. Enabled - Indicates that the public ssh port is open on all nodes of the cluster. NotSpecified - Indicates that the public ssh port is closed on all nodes of the cluster if VNet is defined, else is open all public nodes. It can be default only during cluster creation time, after creation it will be either enabled or disabled.
     */
    remoteLoginPortPublicAccess?: pulumi.Input<string | enums.machinelearningservices.v20210401.RemoteLoginPortPublicAccess>;
    /**
     * Scale settings for AML Compute
     */
    scaleSettings?: pulumi.Input<inputs.machinelearningservices.v20210401.ScaleSettingsArgs>;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: pulumi.Input<inputs.machinelearningservices.v20210401.ResourceIdArgs>;
    /**
     * Credentials for an administrator user account that will be created on each compute node.
     */
    userAccountCredentials?: pulumi.Input<inputs.machinelearningservices.v20210401.UserAccountCredentialsArgs>;
    /**
     * Virtual Machine image for AML Compute - windows only
     */
    virtualMachineImage?: pulumi.Input<inputs.machinelearningservices.v20210401.VirtualMachineImageArgs>;
    /**
     * Virtual Machine priority
     */
    vmPriority?: pulumi.Input<string | enums.machinelearningservices.v20210401.VmPriority>;
    /**
...
export function amlComputePropertiesArgsProvideDefaults(val: AmlComputePropertiesArgs): AmlComputePropertiesArgs {
    return {
        ...
        scaleSettings: (val.scaleSettings ? pulumi.output(val.scaleSettings).apply(inputs.machinelearningservices.v20210401.scaleSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface ComputeInstanceArgs {
     ...
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20210401.ComputeInstancePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export function computeInstanceArgsProvideDefaults(val: ComputeInstanceArgs): ComputeInstanceArgs {
    return {
        ...val,
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.machinelearningservices.v20210401.computeInstancePropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface ComputeInstancePropertiesArgs {
     ...
     */
    applicationSharingPolicy?: pulumi.Input<string | enums.machinelearningservices.v20210401.ApplicationSharingPolicy>;
    /**
     * The Compute Instance Authorization type. Available values are personal (default).
     */
    computeInstanceAuthorizationType?: pulumi.Input<string | enums.machinelearningservices.v20210401.ComputeInstanceAuthorizationType>;
    /**
     * Settings for a personal compute instance.
     */
    personalComputeInstanceSettings?: pulumi.Input<inputs.machinelearningservices.v20210401.PersonalComputeInstanceSettingsArgs>;
    /**
     * Details of customized scripts to execute for setting up the cluster.
     */
    setupScripts?: pulumi.Input<inputs.machinelearningservices.v20210401.SetupScriptsArgs>;
    /**
     * Specifies policy and settings for SSH access.
     */
    sshSettings?: pulumi.Input<inputs.machinelearningservices.v20210401.ComputeInstanceSshSettingsArgs>;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: pulumi.Input<inputs.machinelearningservices.v20210401.ResourceIdArgs>;
...
export function computeInstancePropertiesArgsProvideDefaults(val: ComputeInstancePropertiesArgs): ComputeInstancePropertiesArgs {
    return {
        ...
        sshSettings: (val.sshSettings ? pulumi.output(val.sshSettings).apply(inputs.machinelearningservices.v20210401.computeInstanceSshSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface ComputeInstanceSshSettingsArgs {
     ...
     */
    sshPublicAccess?: pulumi.Input<string | enums.machinelearningservices.v20210401.SshPublicAccess>;
}
/**
...
export interface CreateServiceRequestEnvironmentImageRequestArgs {
     ...
     * The list of assets.
     */
    assets?: pulumi.Input<pulumi.Input<inputs.machinelearningservices.v20210401.ImageAssetArgs>[]>;
    /**
     ...
     */
    environment?: pulumi.Input<inputs.machinelearningservices.v20210401.EnvironmentImageRequestEnvironmentArgs>;
    /**
     * The unique identifying details of the AZURE ML environment.
     */
    environmentReference?: pulumi.Input<inputs.machinelearningservices.v20210401.EnvironmentImageRequestEnvironmentReferenceArgs>;
    /**
     ...
     * The list of models.
     */
    models?: pulumi.Input<pulumi.Input<inputs.machinelearningservices.v20210401.ModelArgs>[]>;
}
...
export interface DataLakeAnalyticsArgs {
     ...
     */
    disableLocalAuth?: pulumi.Input<boolean>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20210401.DataLakeAnalyticsPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface DatabricksArgs {
     ...
     */
    disableLocalAuth?: pulumi.Input<boolean>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20210401.DatabricksPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface EncryptionPropertyArgs {
     ...
     */
    identity?: pulumi.Input<inputs.machinelearningservices.v20210401.IdentityForCmkArgs>;
    /**
     * Customer Key vault properties.
     */
    keyVaultProperties: pulumi.Input<inputs.machinelearningservices.v20210401.KeyVaultPropertiesArgs>;
    /**
     * Indicates whether or not the encryption is enabled for the workspace.
     */
    status: pulumi.Input<string | enums.machinelearningservices.v20210401.EncryptionStatus>;
}
...
export interface EnvironmentImageRequestEnvironmentArgs {
     ...
     */
    docker?: pulumi.Input<inputs.machinelearningservices.v20210401.ModelEnvironmentDefinitionDockerArgs>;
    /**
     ...
     */
    python?: pulumi.Input<inputs.machinelearningservices.v20210401.ModelEnvironmentDefinitionPythonArgs>;
    /**
     * Settings for a R environment.
     */
    r?: pulumi.Input<inputs.machinelearningservices.v20210401.ModelEnvironmentDefinitionRArgs>;
    /**
     * The configuration for a Spark environment.
     */
    spark?: pulumi.Input<inputs.machinelearningservices.v20210401.ModelEnvironmentDefinitionSparkArgs>;
    /**
...
export interface HDInsightArgs {
     ...
     */
    disableLocalAuth?: pulumi.Input<boolean>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20210401.HDInsightPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface HDInsightPropertiesArgs {
     ...
     */
    administratorAccount?: pulumi.Input<inputs.machinelearningservices.v20210401.VirtualMachineSshCredentialsArgs>;
    /**
...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type?: pulumi.Input<enums.machinelearningservices.v20210401.ResourceIdentityType>;
    /**
...
export interface ModelArgs {
     ...
     */
    datasets?: pulumi.Input<pulumi.Input<inputs.machinelearningservices.v20210401.DatasetReferenceArgs>[]>;
    /**
     ...
     */
    resourceRequirements?: pulumi.Input<inputs.machinelearningservices.v20210401.ContainerResourceRequirementsArgs>;
    /**
...
export interface ModelEnvironmentDefinitionDockerArgs {
     ...
     * Image registry that contains the base image.
     */
    baseImageRegistry?: pulumi.Input<inputs.machinelearningservices.v20210401.ModelDockerSectionBaseImageRegistryArgs>;
}
...
export interface ModelEnvironmentDefinitionRArgs {
     ...
     */
    cranPackages?: pulumi.Input<pulumi.Input<inputs.machinelearningservices.v20210401.RCranPackageArgs>[]>;
    /**
     ...
     */
    gitHubPackages?: pulumi.Input<pulumi.Input<inputs.machinelearningservices.v20210401.RGitHubPackageArgs>[]>;
    /**
...
export interface ModelEnvironmentDefinitionSparkArgs {
     ...
     */
    packages?: pulumi.Input<pulumi.Input<inputs.machinelearningservices.v20210401.SparkMavenPackageArgs>[]>;
    /**
...
export interface PersonalComputeInstanceSettingsArgs {
     ...
     */
    assignedUser?: pulumi.Input<inputs.machinelearningservices.v20210401.AssignedUserArgs>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.machinelearningservices.v20210401.PrivateEndpointServiceConnectionStatus>;
}
...
export interface ScriptsToExecuteArgs {
     ...
     */
    creationScript?: pulumi.Input<inputs.machinelearningservices.v20210401.ScriptReferenceArgs>;
    /**
     * Script that's run every time the machine starts.
     */
    startupScript?: pulumi.Input<inputs.machinelearningservices.v20210401.ScriptReferenceArgs>;
}
...
export interface ServiceManagedResourcesSettingsArgs {
     ...
     */
    cosmosDb?: pulumi.Input<inputs.machinelearningservices.v20210401.CosmosDbSettingsArgs>;
}
...
export interface SetupScriptsArgs {
     ...
     * Customized setup scripts
     */
    scripts?: pulumi.Input<inputs.machinelearningservices.v20210401.ScriptsToExecuteArgs>;
}
...
export interface SynapseSparkArgs {
     ...
     * AKS properties
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20210401.SynapseSparkPoolPropertiesPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface SynapseSparkPoolPropertiesPropertiesArgs {
     ...
     * Auto pause properties.
     */
    autoPauseProperties?: pulumi.Input<inputs.machinelearningservices.v20210401.AutoPausePropertiesArgs>;
    /**
     * Auto scale properties.
     */
    autoScaleProperties?: pulumi.Input<inputs.machinelearningservices.v20210401.AutoScalePropertiesArgs>;
    /**
...
export interface VirtualMachineArgs {
     ...
     */
    disableLocalAuth?: pulumi.Input<boolean>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20210401.VirtualMachinePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
