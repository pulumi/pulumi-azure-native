...
export interface AKSResponse {
     ...
     * AKS properties
     */
    properties?: outputs.machinelearningservices.v20190601.AKSResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20190601.MachineLearningServiceErrorResponse[];
    /**
...
export interface AKSResponseProperties {
     ...
     */
    aksNetworkingConfiguration?: outputs.machinelearningservices.v20190601.AksNetworkingConfigurationResponse;
    /**
     ...
     * SSL configuration
     */
    sslConfiguration?: outputs.machinelearningservices.v20190601.SslConfigurationResponse;
    /**
     * System services
     */
    systemServices: outputs.machinelearningservices.v20190601.SystemServiceResponse[];
}
...
export interface AmlComputeResponse {
     ...
     */
    properties?: outputs.machinelearningservices.v20190601.AmlComputeResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20190601.MachineLearningServiceErrorResponse[];
...
export function amlComputeResponseProvideDefaults(val: AmlComputeResponse): AmlComputeResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.machinelearningservices.v20190601.amlComputeResponsePropertiesProvideDefaults(val.properties) : undefined),
    };
}
...
export interface AmlComputeResponseProperties {
     ...
     */
    errors: outputs.machinelearningservices.v20190601.MachineLearningServiceErrorResponse[];
    /**
     * Counts of various node states on the compute.
     */
    nodeStateCounts: outputs.machinelearningservices.v20190601.NodeStateCountsResponse;
    /**
     ...
     */
    scaleSettings?: outputs.machinelearningservices.v20190601.ScaleSettingsResponse;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: outputs.machinelearningservices.v20190601.ResourceIdResponse;
    /**
     ...
     */
    userAccountCredentials?: outputs.machinelearningservices.v20190601.UserAccountCredentialsResponse;
    /**
...
export function amlComputeResponsePropertiesProvideDefaults(val: AmlComputeResponseProperties): AmlComputeResponseProperties {
    return {
        ...
        scaleSettings: (val.scaleSettings ? outputs.machinelearningservices.v20190601.scaleSettingsResponseProvideDefaults(val.scaleSettings) : undefined),
    };
}
...
export interface DataLakeAnalyticsResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20190601.DataLakeAnalyticsResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20190601.MachineLearningServiceErrorResponse[];
...
export interface DatabricksResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20190601.DatabricksResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20190601.MachineLearningServiceErrorResponse[];
...
export interface ErrorResponseResponse {
     ...
     */
    details: outputs.machinelearningservices.v20190601.ErrorDetailResponse[];
    /**
     * Error message.
     */
    message: string;
...
export interface HDInsightResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20190601.HDInsightResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20190601.MachineLearningServiceErrorResponse[];
...
export interface HDInsightResponseProperties {
     ...
     */
    administratorAccount?: outputs.machinelearningservices.v20190601.VirtualMachineSshCredentialsResponse;
    /**
...
export interface MachineLearningServiceErrorResponse {
     ...
     * The error response.
     */
    error: outputs.machinelearningservices.v20190601.ErrorResponseResponse;
}
...
export interface RegistryListCredentialsResultResponse {
    location: string;
    passwords?: outputs.machinelearningservices.v20190601.PasswordResponse[];
    username: string;
}
...
export interface VirtualMachineResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20190601.VirtualMachineResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20190601.MachineLearningServiceErrorResponse[];
