...
export interface AKSArgs {
     ...
     * AKS properties
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20190601.AKSPropertiesArgs>;
    /**
...
export interface AKSPropertiesArgs {
     ...
     */
    aksNetworkingConfiguration?: pulumi.Input<inputs.machinelearningservices.v20190601.AksNetworkingConfigurationArgs>;
    /**
     ...
     * SSL configuration
     */
    sslConfiguration?: pulumi.Input<inputs.machinelearningservices.v20190601.SslConfigurationArgs>;
}
...
export interface AmlComputeArgs {
     ...
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20190601.AmlComputePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export function amlComputeArgsProvideDefaults(val: AmlComputeArgs): AmlComputeArgs {
    return {
        ...val,
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.machinelearningservices.v20190601.amlComputePropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface AmlComputePropertiesArgs {
     ...
     */
    remoteLoginPortPublicAccess?: pulumi.Input<string | enums.machinelearningservices.v20190601.RemoteLoginPortPublicAccess>;
    /**
     * Scale settings for AML Compute
     */
    scaleSettings?: pulumi.Input<inputs.machinelearningservices.v20190601.ScaleSettingsArgs>;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: pulumi.Input<inputs.machinelearningservices.v20190601.ResourceIdArgs>;
    /**
     * Credentials for an administrator user account that will be created on each compute node.
     */
    userAccountCredentials?: pulumi.Input<inputs.machinelearningservices.v20190601.UserAccountCredentialsArgs>;
    /**
     * Virtual Machine priority
     */
    vmPriority?: pulumi.Input<string | enums.machinelearningservices.v20190601.VmPriority>;
    /**
...
export function amlComputePropertiesArgsProvideDefaults(val: AmlComputePropertiesArgs): AmlComputePropertiesArgs {
    return {
        ...
        scaleSettings: (val.scaleSettings ? pulumi.output(val.scaleSettings).apply(inputs.machinelearningservices.v20190601.scaleSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface DataLakeAnalyticsArgs {
     ...
     */
    description?: pulumi.Input<string>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20190601.DataLakeAnalyticsPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface DatabricksArgs {
     ...
     */
    description?: pulumi.Input<string>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20190601.DatabricksPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface HDInsightArgs {
     ...
     */
    description?: pulumi.Input<string>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20190601.HDInsightPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface HDInsightPropertiesArgs {
     ...
     */
    administratorAccount?: pulumi.Input<inputs.machinelearningservices.v20190601.VirtualMachineSshCredentialsArgs>;
    /**
...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type?: pulumi.Input<enums.machinelearningservices.v20190601.ResourceIdentityType>;
}
...
export interface VirtualMachineArgs {
     ...
     */
    description?: pulumi.Input<string>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20190601.VirtualMachinePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
