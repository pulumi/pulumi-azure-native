...
export interface AKSResponse {
     ...
     * AKS properties
     */
    properties?: outputs.machinelearningservices.v20220101preview.AKSResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20220101preview.ErrorResponseResponse[];
    /**
...
export function aksresponseProvideDefaults(val: AKSResponse): AKSResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.machinelearningservices.v20220101preview.aksresponsePropertiesProvideDefaults(val.properties) : undefined),
    };
}
...
export interface AKSResponseProperties {
     ...
     */
    aksNetworkingConfiguration?: outputs.machinelearningservices.v20220101preview.AksNetworkingConfigurationResponse;
    /**
     ...
     * SSL configuration
     */
    sslConfiguration?: outputs.machinelearningservices.v20220101preview.SslConfigurationResponse;
    /**
     * System services
     */
    systemServices: outputs.machinelearningservices.v20220101preview.SystemServiceResponse[];
}
/**
...
export interface AmlComputePropertiesResponse {
     ...
     */
    errors: outputs.machinelearningservices.v20220101preview.ErrorResponseResponse[];
    /**
     ...
     */
    nodeStateCounts: outputs.machinelearningservices.v20220101preview.NodeStateCountsResponse;
    /**
     * Compute OS Type
     */
    osType?: string;
     ...
     */
    scaleSettings?: outputs.machinelearningservices.v20220101preview.ScaleSettingsResponse;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: outputs.machinelearningservices.v20220101preview.ResourceIdResponse;
    /**
     ...
     */
    userAccountCredentials?: outputs.machinelearningservices.v20220101preview.UserAccountCredentialsResponse;
    /**
     * Virtual Machine image for AML Compute - windows only
     */
    virtualMachineImage?: outputs.machinelearningservices.v20220101preview.VirtualMachineImageResponse;
    /**
...
export function amlComputePropertiesResponseProvideDefaults(val: AmlComputePropertiesResponse): AmlComputePropertiesResponse {
    return {
        ...
        scaleSettings: (val.scaleSettings ? outputs.machinelearningservices.v20220101preview.scaleSettingsResponseProvideDefaults(val.scaleSettings) : undefined),
    };
}
...
export interface AmlComputeResponse {
     ...
     */
    properties?: outputs.machinelearningservices.v20220101preview.AmlComputePropertiesResponse;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20220101preview.ErrorResponseResponse[];
...
export function amlComputeResponseProvideDefaults(val: AmlComputeResponse): AmlComputeResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.machinelearningservices.v20220101preview.amlComputePropertiesResponseProvideDefaults(val.properties) : undefined),
    };
}
...
export interface ComputeInstancePropertiesResponse {
     ...
     */
    applications: outputs.machinelearningservices.v20220101preview.ComputeInstanceApplicationResponse[];
    /**
     ...
     */
    connectivityEndpoints: outputs.machinelearningservices.v20220101preview.ComputeInstanceConnectivityEndpointsResponse;
    /**
     * Describes information on user who created this ComputeInstance.
     */
    createdBy: outputs.machinelearningservices.v20220101preview.ComputeInstanceCreatedByResponse;
    /**
     ...
     * The last operation on ComputeInstance.
     */
    lastOperation: outputs.machinelearningservices.v20220101preview.ComputeInstanceLastOperationResponse;
    /**
     * Settings for a personal compute instance.
     */
    personalComputeInstanceSettings?: outputs.machinelearningservices.v20220101preview.PersonalComputeInstanceSettingsResponse;
    /**
     * Details of customized scripts to execute for setting up the cluster.
     */
    setupScripts?: outputs.machinelearningservices.v20220101preview.SetupScriptsResponse;
    /**
     * Specifies policy and settings for SSH access.
     */
    sshSettings?: outputs.machinelearningservices.v20220101preview.ComputeInstanceSshSettingsResponse;
    /**
...
export function computeInstancePropertiesResponseProvideDefaults(val: ComputeInstancePropertiesResponse): ComputeInstancePropertiesResponse {
    return {
        ...
        sshSettings: (val.sshSettings ? outputs.machinelearningservices.v20220101preview.computeInstanceSshSettingsResponseProvideDefaults(val.sshSettings) : undefined),
    };
}
...
export interface ComputeInstanceResponse {
     ...
     */
    properties?: outputs.machinelearningservices.v20220101preview.ComputeInstancePropertiesResponse;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20220101preview.ErrorResponseResponse[];
...
export function computeInstanceResponseProvideDefaults(val: ComputeInstanceResponse): ComputeInstanceResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.machinelearningservices.v20220101preview.computeInstancePropertiesResponseProvideDefaults(val.properties) : undefined),
    };
}
...
export interface DataLakeAnalyticsResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20220101preview.DataLakeAnalyticsResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20220101preview.ErrorResponseResponse[];
...
export interface DatabricksResponse {
     ...
     * Properties of Databricks
     */
    properties?: outputs.machinelearningservices.v20220101preview.DatabricksPropertiesResponse;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20220101preview.ErrorResponseResponse[];
...
export interface EncryptionPropertyResponse {
     ...
     */
    identity?: outputs.machinelearningservices.v20220101preview.IdentityForCmkResponse;
    /**
     * Customer Key vault properties.
     */
    keyVaultProperties: outputs.machinelearningservices.v20220101preview.KeyVaultPropertiesResponse;
    /**
...
export interface ErrorDetailResponse {
     ...
     */
    additionalInfo: outputs.machinelearningservices.v20220101preview.ErrorAdditionalInfoResponse[];
    /**
     * The error code.
     */
    code: string;
     ...
     * The error details.
     */
    details: outputs.machinelearningservices.v20220101preview.ErrorDetailResponse[];
    /**
     * The error message.
     */
    message: string;
...
export interface ErrorResponseResponse {
     ...
     * The error object.
     */
    error?: outputs.machinelearningservices.v20220101preview.ErrorDetailResponse;
}
...
export interface HDInsightPropertiesResponse {
     ...
     */
    administratorAccount?: outputs.machinelearningservices.v20220101preview.VirtualMachineSshCredentialsResponse;
    /**
...
export interface HDInsightResponse {
     ...
     * HDInsight compute properties
     */
    properties?: outputs.machinelearningservices.v20220101preview.HDInsightPropertiesResponse;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20220101preview.ErrorResponseResponse[];
...
export interface IdentityResponse {
     ...
     */
    userAssignedIdentities?: {[key: string]: outputs.machinelearningservices.v20220101preview.UserAssignedIdentityResponse};
}
...
export interface InstanceTypeSchemaResponse {
     ...
     */
    resources?: outputs.machinelearningservices.v20220101preview.InstanceTypeSchemaResponseResources;
}
...
export interface KubernetesPropertiesResponse {
     ...
     * Instance Type Schema
     */
    instanceTypes?: {[key: string]: outputs.machinelearningservices.v20220101preview.InstanceTypeSchemaResponse};
    /**
     * Compute namespace
     */
    namespace?: string;
...
export interface KubernetesResponse {
     ...
     */
    properties?: outputs.machinelearningservices.v20220101preview.KubernetesPropertiesResponse;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20220101preview.ErrorResponseResponse[];
...
export function kubernetesResponseProvideDefaults(val: KubernetesResponse): KubernetesResponse {
    return {
        ...val,
        properties: (val.properties ? outputs.machinelearningservices.v20220101preview.kubernetesPropertiesResponseProvideDefaults(val.properties) : undefined),
    };
}
...
export interface NotebookResourceInfoResponse {
     ...
     */
    notebookPreparationError?: outputs.machinelearningservices.v20220101preview.NotebookPreparationErrorResponse;
    /**
...
export interface PersonalComputeInstanceSettingsResponse {
     ...
     */
    assignedUser?: outputs.machinelearningservices.v20220101preview.AssignedUserResponse;
}
...
export interface PrivateEndpointConnectionResponse {
     ...
     */
    identity?: outputs.machinelearningservices.v20220101preview.IdentityResponse;
    /**
     ...
     */
    privateEndpoint?: outputs.machinelearningservices.v20220101preview.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: outputs.machinelearningservices.v20220101preview.PrivateLinkServiceConnectionStateResponse;
    /**
     ...
     */
    sku?: outputs.machinelearningservices.v20220101preview.SkuResponse;
    /**
     * System data
     */
    systemData: outputs.machinelearningservices.v20220101preview.SystemDataResponse;
    /**
...
export interface RegistryListCredentialsResultResponse {
    location: string;
    passwords?: outputs.machinelearningservices.v20220101preview.PasswordResponse[];
    username: string;
}
...
export interface ScriptsToExecuteResponse {
     ...
     */
    creationScript?: outputs.machinelearningservices.v20220101preview.ScriptReferenceResponse;
    /**
     * Script that's run every time the machine starts.
     */
    startupScript?: outputs.machinelearningservices.v20220101preview.ScriptReferenceResponse;
}
...
export interface ServiceManagedResourcesSettingsResponse {
     ...
     */
    cosmosDb?: outputs.machinelearningservices.v20220101preview.CosmosDbSettingsResponse;
}
...
export interface SetupScriptsResponse {
     ...
     * Customized setup scripts
     */
    scripts?: outputs.machinelearningservices.v20220101preview.ScriptsToExecuteResponse;
}
...
export interface SynapseSparkResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20220101preview.SynapseSparkResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20220101preview.ErrorResponseResponse[];
...
export interface SynapseSparkResponseProperties {
     ...
     * Auto pause properties.
     */
    autoPauseProperties?: outputs.machinelearningservices.v20220101preview.AutoPausePropertiesResponse;
    /**
     * Auto scale properties.
     */
    autoScaleProperties?: outputs.machinelearningservices.v20220101preview.AutoScalePropertiesResponse;
    /**
     * The number of compute nodes currently assigned to the compute.
     */
    nodeCount?: number;
...
export interface VirtualMachineResponse {
     ...
     */
    modifiedOn: string;
    properties?: outputs.machinelearningservices.v20220101preview.VirtualMachineResponseProperties;
    /**
     * Errors during provisioning
     */
    provisioningErrors: outputs.machinelearningservices.v20220101preview.ErrorResponseResponse[];
