...
export interface AKSArgs {
     ...
     * AKS properties
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20200601.AKSPropertiesArgs>;
    /**
...
export interface AKSPropertiesArgs {
     ...
     */
    aksNetworkingConfiguration?: pulumi.Input<inputs.machinelearningservices.v20200601.AksNetworkingConfigurationArgs>;
    /**
     ...
     * SSL configuration
     */
    sslConfiguration?: pulumi.Input<inputs.machinelearningservices.v20200601.SslConfigurationArgs>;
}
...
export interface AmlComputeArgs {
     ...
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20200601.AmlComputePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export function amlComputeArgsProvideDefaults(val: AmlComputeArgs): AmlComputeArgs {
    return {
        ...val,
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.machinelearningservices.v20200601.amlComputePropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface AmlComputePropertiesArgs {
     ...
     */
    remoteLoginPortPublicAccess?: pulumi.Input<string | enums.machinelearningservices.v20200601.RemoteLoginPortPublicAccess>;
    /**
     * Scale settings for AML Compute
     */
    scaleSettings?: pulumi.Input<inputs.machinelearningservices.v20200601.ScaleSettingsArgs>;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: pulumi.Input<inputs.machinelearningservices.v20200601.ResourceIdArgs>;
    /**
     * Credentials for an administrator user account that will be created on each compute node.
     */
    userAccountCredentials?: pulumi.Input<inputs.machinelearningservices.v20200601.UserAccountCredentialsArgs>;
    /**
     * Virtual Machine priority
     */
    vmPriority?: pulumi.Input<string | enums.machinelearningservices.v20200601.VmPriority>;
    /**
...
export function amlComputePropertiesArgsProvideDefaults(val: AmlComputePropertiesArgs): AmlComputePropertiesArgs {
    return {
        ...
        scaleSettings: (val.scaleSettings ? pulumi.output(val.scaleSettings).apply(inputs.machinelearningservices.v20200601.scaleSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface ComputeInstanceArgs {
     ...
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20200601.ComputeInstancePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export function computeInstanceArgsProvideDefaults(val: ComputeInstanceArgs): ComputeInstanceArgs {
    return {
        ...val,
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.machinelearningservices.v20200601.computeInstancePropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface ComputeInstancePropertiesArgs {
     ...
     */
    applicationSharingPolicy?: pulumi.Input<string | enums.machinelearningservices.v20200601.ApplicationSharingPolicy>;
    /**
     * Specifies policy and settings for SSH access.
     */
    sshSettings?: pulumi.Input<inputs.machinelearningservices.v20200601.ComputeInstanceSshSettingsArgs>;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: pulumi.Input<inputs.machinelearningservices.v20200601.ResourceIdArgs>;
...
export function computeInstancePropertiesArgsProvideDefaults(val: ComputeInstancePropertiesArgs): ComputeInstancePropertiesArgs {
    return {
        ...
        sshSettings: (val.sshSettings ? pulumi.output(val.sshSettings).apply(inputs.machinelearningservices.v20200601.computeInstanceSshSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface ComputeInstanceSshSettingsArgs {
     ...
     */
    sshPublicAccess?: pulumi.Input<string | enums.machinelearningservices.v20200601.SshPublicAccess>;
}
/**
...
export interface DataLakeAnalyticsArgs {
     ...
     */
    description?: pulumi.Input<string>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20200601.DataLakeAnalyticsPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface DatabricksArgs {
     ...
     */
    description?: pulumi.Input<string>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20200601.DatabricksPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface EncryptionPropertyArgs {
     ...
     */
    keyVaultProperties: pulumi.Input<inputs.machinelearningservices.v20200601.KeyVaultPropertiesArgs>;
    /**
     * Indicates whether or not the encryption is enabled for the workspace.
     */
    status: pulumi.Input<string | enums.machinelearningservices.v20200601.EncryptionStatus>;
}
...
export interface HDInsightArgs {
     ...
     */
    description?: pulumi.Input<string>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20200601.HDInsightPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface HDInsightPropertiesArgs {
     ...
     */
    administratorAccount?: pulumi.Input<inputs.machinelearningservices.v20200601.VirtualMachineSshCredentialsArgs>;
    /**
...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type: pulumi.Input<enums.machinelearningservices.v20200601.ResourceIdentityType>;
    /**
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.machinelearningservices.v20200601.PrivateEndpointServiceConnectionStatus>;
}
...
export interface VirtualMachineArgs {
     ...
     */
    description?: pulumi.Input<string>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20200601.VirtualMachinePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
