...
export interface AKSArgs {
     ...
     * AKS properties
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20210701.AKSPropertiesArgs>;
    /**
...
export function aksargsProvideDefaults(val: AKSArgs): AKSArgs {
    return {
        ...val,
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.machinelearningservices.v20210701.akspropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface AKSPropertiesArgs {
     ...
     */
    aksNetworkingConfiguration?: pulumi.Input<inputs.machinelearningservices.v20210701.AksNetworkingConfigurationArgs>;
    /**
     ...
     */
    clusterPurpose?: pulumi.Input<string | enums.machinelearningservices.v20210701.ClusterPurpose>;
    /**
     ...
     * Load Balancer Type
     */
    loadBalancerType?: pulumi.Input<string | enums.machinelearningservices.v20210701.LoadBalancerType>;
    /**
     * SSL configuration
     */
    sslConfiguration?: pulumi.Input<inputs.machinelearningservices.v20210701.SslConfigurationArgs>;
}
/**
...
export interface AmlComputeArgs {
     ...
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20210701.AmlComputePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export function amlComputeArgsProvideDefaults(val: AmlComputeArgs): AmlComputeArgs {
    return {
        ...val,
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.machinelearningservices.v20210701.amlComputePropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface AmlComputePropertiesArgs {
     ...
     * Compute OS Type
     */
    osType?: pulumi.Input<string | enums.machinelearningservices.v20210701.OsType>;
    /**
     * State of the public SSH port. Possible values are: Disabled - Indicates that the public ssh port is closed on all nodes of the cluster. Enabled - Indicates that the public ssh port is open on all nodes of the cluster. NotSpecified - Indicates that the public ssh port is closed on all nodes of the cluster if VNet is defined, else is open all public nodes. It can be default only during cluster creation time, after creation it will be either enabled or disabled.
     */
    remoteLoginPortPublicAccess?: pulumi.Input<string | enums.machinelearningservices.v20210701.RemoteLoginPortPublicAccess>;
    /**
     * Scale settings for AML Compute
     */
    scaleSettings?: pulumi.Input<inputs.machinelearningservices.v20210701.ScaleSettingsArgs>;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: pulumi.Input<inputs.machinelearningservices.v20210701.ResourceIdArgs>;
    /**
     * Credentials for an administrator user account that will be created on each compute node.
     */
    userAccountCredentials?: pulumi.Input<inputs.machinelearningservices.v20210701.UserAccountCredentialsArgs>;
    /**
     * Virtual Machine image for AML Compute - windows only
     */
    virtualMachineImage?: pulumi.Input<inputs.machinelearningservices.v20210701.VirtualMachineImageArgs>;
    /**
     * Virtual Machine priority
     */
    vmPriority?: pulumi.Input<string | enums.machinelearningservices.v20210701.VmPriority>;
    /**
...
export function amlComputePropertiesArgsProvideDefaults(val: AmlComputePropertiesArgs): AmlComputePropertiesArgs {
    return {
        ...
        scaleSettings: (val.scaleSettings ? pulumi.output(val.scaleSettings).apply(inputs.machinelearningservices.v20210701.scaleSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface ComputeInstanceArgs {
     ...
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20210701.ComputeInstancePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export function computeInstanceArgsProvideDefaults(val: ComputeInstanceArgs): ComputeInstanceArgs {
    return {
        ...val,
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.machinelearningservices.v20210701.computeInstancePropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface ComputeInstancePropertiesArgs {
     ...
     */
    applicationSharingPolicy?: pulumi.Input<string | enums.machinelearningservices.v20210701.ApplicationSharingPolicy>;
    /**
     * The Compute Instance Authorization type. Available values are personal (default).
     */
    computeInstanceAuthorizationType?: pulumi.Input<string | enums.machinelearningservices.v20210701.ComputeInstanceAuthorizationType>;
    /**
     * Settings for a personal compute instance.
     */
    personalComputeInstanceSettings?: pulumi.Input<inputs.machinelearningservices.v20210701.PersonalComputeInstanceSettingsArgs>;
    /**
     * Details of customized scripts to execute for setting up the cluster.
     */
    setupScripts?: pulumi.Input<inputs.machinelearningservices.v20210701.SetupScriptsArgs>;
    /**
     * Specifies policy and settings for SSH access.
     */
    sshSettings?: pulumi.Input<inputs.machinelearningservices.v20210701.ComputeInstanceSshSettingsArgs>;
    /**
     * Virtual network subnet resource ID the compute nodes belong to.
     */
    subnet?: pulumi.Input<inputs.machinelearningservices.v20210701.ResourceIdArgs>;
...
export function computeInstancePropertiesArgsProvideDefaults(val: ComputeInstancePropertiesArgs): ComputeInstancePropertiesArgs {
    return {
        ...
        sshSettings: (val.sshSettings ? pulumi.output(val.sshSettings).apply(inputs.machinelearningservices.v20210701.computeInstanceSshSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface ComputeInstanceSshSettingsArgs {
     ...
     */
    sshPublicAccess?: pulumi.Input<string | enums.machinelearningservices.v20210701.SshPublicAccess>;
}
/**
...
export interface DataLakeAnalyticsArgs {
     ...
     */
    disableLocalAuth?: pulumi.Input<boolean>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20210701.DataLakeAnalyticsPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface DatabricksArgs {
     ...
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20210701.DatabricksPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface EncryptionPropertyArgs {
     ...
     */
    identity?: pulumi.Input<inputs.machinelearningservices.v20210701.IdentityForCmkArgs>;
    /**
     * Customer Key vault properties.
     */
    keyVaultProperties: pulumi.Input<inputs.machinelearningservices.v20210701.KeyVaultPropertiesArgs>;
    /**
     * Indicates whether or not the encryption is enabled for the workspace.
     */
    status: pulumi.Input<string | enums.machinelearningservices.v20210701.EncryptionStatus>;
}
...
export interface HDInsightArgs {
     ...
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20210701.HDInsightPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface HDInsightPropertiesArgs {
     ...
     */
    administratorAccount?: pulumi.Input<inputs.machinelearningservices.v20210701.VirtualMachineSshCredentialsArgs>;
    /**
...
export interface IdentityArgs {
     ...
     * The identity type.
     */
    type?: pulumi.Input<enums.machinelearningservices.v20210701.ResourceIdentityType>;
    /**
...
export interface InstanceTypeSchemaArgs {
     ...
     */
    resources?: pulumi.Input<inputs.machinelearningservices.v20210701.InstanceTypeSchemaResourcesArgs>;
}
...
export interface KubernetesArgs {
     ...
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20210701.KubernetesPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export function kubernetesArgsProvideDefaults(val: KubernetesArgs): KubernetesArgs {
    return {
        ...val,
        properties: (val.properties ? pulumi.output(val.properties).apply(inputs.machinelearningservices.v20210701.kubernetesPropertiesArgsProvideDefaults) : undefined),
    };
}
...
export interface KubernetesPropertiesArgs {
     ...
     * Instance Type Schema
     */
    instanceTypes?: pulumi.Input<{[key: string]: pulumi.Input<inputs.machinelearningservices.v20210701.InstanceTypeSchemaArgs>}>;
    /**
     * Compute namespace
     */
...
export interface PersonalComputeInstanceSettingsArgs {
     ...
     */
    assignedUser?: pulumi.Input<inputs.machinelearningservices.v20210701.AssignedUserArgs>;
}
...
export interface PrivateLinkServiceConnectionStateArgs {
     ...
     */
    status?: pulumi.Input<string | enums.machinelearningservices.v20210701.PrivateEndpointServiceConnectionStatus>;
}
...
export interface ScriptsToExecuteArgs {
     ...
     */
    creationScript?: pulumi.Input<inputs.machinelearningservices.v20210701.ScriptReferenceArgs>;
    /**
     * Script that's run every time the machine starts.
     */
    startupScript?: pulumi.Input<inputs.machinelearningservices.v20210701.ScriptReferenceArgs>;
}
...
export interface ServiceManagedResourcesSettingsArgs {
     ...
     */
    cosmosDb?: pulumi.Input<inputs.machinelearningservices.v20210701.CosmosDbSettingsArgs>;
}
...
export interface SetupScriptsArgs {
     ...
     * Customized setup scripts
     */
    scripts?: pulumi.Input<inputs.machinelearningservices.v20210701.ScriptsToExecuteArgs>;
}
...
export interface SynapseSparkArgs {
     ...
     */
    disableLocalAuth?: pulumi.Input<boolean>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20210701.SynapseSparkPropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
...
export interface SynapseSparkPropertiesArgs {
     ...
     * Auto pause properties.
     */
    autoPauseProperties?: pulumi.Input<inputs.machinelearningservices.v20210701.AutoPausePropertiesArgs>;
    /**
     * Auto scale properties.
     */
    autoScaleProperties?: pulumi.Input<inputs.machinelearningservices.v20210701.AutoScalePropertiesArgs>;
    /**
...
export interface VirtualMachineArgs {
     ...
     */
    disableLocalAuth?: pulumi.Input<boolean>;
    properties?: pulumi.Input<inputs.machinelearningservices.v20210701.VirtualMachinePropertiesArgs>;
    /**
     * ARM resource id of the underlying compute
     */
    resourceId?: pulumi.Input<string>;
