...
export function getManagedCluster(args: GetManagedClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedClusterResult> {
    ...
    return pulumi.runtime.invoke("azurerm:containerservice/v20190801:getManagedCluster", {
        "name": args.name,
...
export interface GetManagedClusterResult {
     ...
     */
    readonly properties: outputs.containerservice.v20190801.ManagedClusterPropertiesResponse;
    /**
     * Resource tags
     */
