...
export function getManagedCluster(args: GetManagedClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedClusterResult> {
    pulumi.log.warn("getManagedCluster is deprecated: azure-native:containerservice/v20190801:ManagedCluster is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20210501:ManagedCluster to guarantee forwards compatibility.")
