...
export class ManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20190801:ManagedCluster';
     ...
     */
    public readonly aadProfile!: pulumi.Output<outputs.containerservice.v20190801.ManagedClusterAADProfileResponse | undefined>;
    /**
     * Profile of managed cluster add-on.
     */
    public readonly addonProfiles!: pulumi.Output<{[key: string]: outputs.containerservice.v20190801.ManagedClusterAddonProfileResponse} | undefined>;
    /**
     * Properties of the agent pool.
     */
    public readonly agentPoolProfiles!: pulumi.Output<outputs.containerservice.v20190801.ManagedClusterAgentPoolProfileResponse[] | undefined>;
    /**
     * Access profile for managed cluster API server.
     */
    public readonly apiServerAccessProfile!: pulumi.Output<outputs.containerservice.v20190801.ManagedClusterAPIServerAccessProfileResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.containerservice.v20190801.ManagedClusterIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly linuxProfile!: pulumi.Output<outputs.containerservice.v20190801.ContainerServiceLinuxProfileResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.containerservice.v20190801.ContainerServiceNetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly servicePrincipalProfile!: pulumi.Output<outputs.containerservice.v20190801.ManagedClusterServicePrincipalProfileResponse | undefined>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly windowsProfile!: pulumi.Output<outputs.containerservice.v20190801.ManagedClusterWindowsProfileResponse | undefined>;
    ...
    constructor(name: string, args: ManagedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkProfile"] = args ? (args.networkProfile ? pulumi.output(args.networkProfile).apply(inputs.containerservice.v20190801.containerServiceNetworkProfileArgsProvideDefaults) : undefined) : undefined;
...
export interface ManagedClusterArgs {
     ...
     * Profile of Azure Active Directory configuration.
     */
    aadProfile?: pulumi.Input<inputs.containerservice.v20190801.ManagedClusterAADProfileArgs>;
    /**
     * Profile of managed cluster add-on.
     */
    addonProfiles?: pulumi.Input<{[key: string]: pulumi.Input<inputs.containerservice.v20190801.ManagedClusterAddonProfileArgs>}>;
    /**
     * Properties of the agent pool.
     */
    agentPoolProfiles?: pulumi.Input<pulumi.Input<inputs.containerservice.v20190801.ManagedClusterAgentPoolProfileArgs>[]>;
    /**
     * Access profile for managed cluster API server.
     */
    apiServerAccessProfile?: pulumi.Input<inputs.containerservice.v20190801.ManagedClusterAPIServerAccessProfileArgs>;
    /**
     * DNS prefix specified when creating the managed cluster.
     */
     ...
     * The identity of the managed cluster, if configured.
     */
    identity?: pulumi.Input<inputs.containerservice.v20190801.ManagedClusterIdentityArgs>;
    /**
     * Version of Kubernetes specified when creating the managed cluster.
     */
     ...
     * Profile for Linux VMs in the container service cluster.
     */
    linuxProfile?: pulumi.Input<inputs.containerservice.v20190801.ContainerServiceLinuxProfileArgs>;
    /**
     * Resource location
     */
     ...
     * Profile of network configuration.
     */
    networkProfile?: pulumi.Input<inputs.containerservice.v20190801.ContainerServiceNetworkProfileArgs>;
    /**
     * Name of the resource group containing agent pool nodes.
     */
     ...
     * Information about a service principal identity for the cluster to use for manipulating Azure APIs.
     */
    servicePrincipalProfile?: pulumi.Input<inputs.containerservice.v20190801.ManagedClusterServicePrincipalProfileArgs>;
    /**
     * Resource tags
     */
     ...
     * Profile for Windows VMs in the container service cluster.
     */
    windowsProfile?: pulumi.Input<inputs.containerservice.v20190801.ManagedClusterWindowsProfileArgs>;
}
