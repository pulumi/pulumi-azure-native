...
export class MeshMembership extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MeshMembership {
        return new MeshMembership(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice:MeshMembership';

    /**
     * Returns true if the given object is an instance of MeshMembership.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MeshMembership {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MeshMembership.__pulumiType;
    }
     ...
     */
    public readonly properties!: pulumi.Output<outputs.containerservice.MeshMembershipPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: MeshMembershipArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["meshMembershipName"] = args ? args.meshMembershipName : undefined;
