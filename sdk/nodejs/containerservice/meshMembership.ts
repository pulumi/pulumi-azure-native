...
export class MeshMembership extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.containerservice.MeshMembershipPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: MeshMembershipArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["meshMembershipName"] = args?.meshMembershipName;
