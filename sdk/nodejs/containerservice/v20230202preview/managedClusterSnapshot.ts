 ...
 *
 * const managedClusterSnapshot = new azure_native.containerservice.v20230202preview.ManagedClusterSnapshot("managedClusterSnapshot", {
 *     creationData: {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:containerservice/v20230202preview:ManagedClusterSnapshot snapshot1 /subscriptions/subid1/resourcegroups/rg1/providers/Microsoft.ContainerService/managedclustersnapshots/snapshot1 
 * ```
 */
