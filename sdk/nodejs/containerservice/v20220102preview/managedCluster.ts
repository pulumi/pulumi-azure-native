 ...
 * Managed cluster.
 *
 * @deprecated azure-native:containerservice/v20220102preview:ManagedCluster is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:ManagedCluster to guarantee forwards compatibility.
 */
export class ManagedCluster extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedCluster {
        pulumi.log.warn("ManagedCluster is deprecated: azure-native:containerservice/v20220102preview:ManagedCluster is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:ManagedCluster to guarantee forwards compatibility.")
