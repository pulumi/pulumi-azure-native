 ...
 *
 * @deprecated azure-native:containerservice/v20220402preview:ManagedClusterSnapshot is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:ManagedClusterSnapshot to guarantee forwards compatibility.
 */
export class ManagedClusterSnapshot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20220402preview:ManagedClusterSnapshot';
     ...
     */
    public /*out*/ readonly managedClusterPropertiesReadOnly!: pulumi.Output<outputs.containerservice.v20220402preview.ManagedClusterPropertiesForSnapshotResponse>;
    /**
...
export interface ManagedClusterSnapshotArgs {
     ...
     * The type of a snapshot. The default is NodePool.
     */
    snapshotType?: pulumi.Input<string | enums.containerservice.v20220402preview.SnapshotType>;
    /**
     * Resource tags.
     */
