 ...
 *
 * @deprecated azure-native:containerservice/v20220802preview:ManagedClusterSnapshot is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:ManagedClusterSnapshot to guarantee forwards compatibility.
 */
export class ManagedClusterSnapshot extends pulumi.CustomResource {
     ...
     */
    public readonly creationData!: pulumi.Output<outputs.containerservice.v20220802preview.CreationDataResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly managedClusterPropertiesReadOnly!: pulumi.Output<outputs.containerservice.v20220802preview.ManagedClusterPropertiesForSnapshotResponse>;
    /**
...
export interface ManagedClusterSnapshotArgs {
     ...
     * CreationData to be used to specify the source resource ID to create this snapshot.
     */
    creationData?: pulumi.Input<inputs.containerservice.v20220802preview.CreationDataArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The type of a snapshot. The default is NodePool.
     */
    snapshotType?: pulumi.Input<string | enums.containerservice.v20220802preview.SnapshotType>;
    /**
     * Resource tags.
     */
