...
export class AgentPool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AgentPool {
        pulumi.log.warn("AgentPool is deprecated: azure-native:containerservice/v20220302preview:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20220402preview:AgentPool to guarantee forwards compatibility.")
        return new AgentPool(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20220302preview:AgentPool';
     ...
     */
    public readonly creationData!: pulumi.Output<outputs.containerservice.v20220302preview.CreationDataResponse | undefined>;
    /**
     ...
     */
    public readonly kubeletConfig!: pulumi.Output<outputs.containerservice.v20220302preview.KubeletConfigResponse | undefined>;
    /**
     ...
     */
    public readonly linuxOSConfig!: pulumi.Output<outputs.containerservice.v20220302preview.LinuxOSConfigResponse | undefined>;
    /**
     ...
     */
    public readonly powerState!: pulumi.Output<outputs.containerservice.v20220302preview.PowerStateResponse | undefined>;
    /**
     ...
     */
    public readonly upgradeSettings!: pulumi.Output<outputs.containerservice.v20220302preview.AgentPoolUpgradeSettingsResponse | undefined>;
    /**
