...
export class OpenShiftManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20180930preview:OpenShiftManagedCluster';
