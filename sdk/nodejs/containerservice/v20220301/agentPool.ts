...
export class AgentPool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AgentPool {
        pulumi.log.warn("AgentPool is deprecated: azure-native:containerservice/v20220301:AgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20220402preview:AgentPool to guarantee forwards compatibility.")
