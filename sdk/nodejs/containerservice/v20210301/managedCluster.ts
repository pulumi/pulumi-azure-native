 ...
 *
 * const managedCluster = new azure_native.containerservice.v20210301.ManagedCluster("managedCluster", {
 *     addonProfiles: {
 ...
 *     enableRBAC: true,
 *     identity: {
 *         type: azure_native.containerservice.v20210301.ResourceIdentityType.UserAssigned,
 ...
 *
 * ```sh
 * $ pulumi import azure-native:containerservice/v20210301:ManagedCluster clustername1 /subscriptions/subid1/resourcegroups/rg1/providers/Microsoft.ContainerService/managedClusters/clustername1 
 * ```
 */
export class ManagedCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkProfile"] = args ? (args.networkProfile ? pulumi.output(args.networkProfile).apply(inputs.containerservice.v20210301.containerServiceNetworkProfileArgsProvideDefaults) : undefined) : undefined;
