...
export class MaintenanceConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MaintenanceConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerservice/v20210301:MaintenanceConfiguration" }, { type: "azure-native:containerservice:MaintenanceConfiguration" }, { type: "azure-nextgen:containerservice:MaintenanceConfiguration" }, { type: "azure-native:containerservice/v20201201:MaintenanceConfiguration" }, { type: "azure-nextgen:containerservice/v20201201:MaintenanceConfiguration" }, { type: "azure-native:containerservice/v20210201:MaintenanceConfiguration" }, { type: "azure-nextgen:containerservice/v20210201:MaintenanceConfiguration" }] };
...
export interface MaintenanceConfigurationArgs {
     ...
     * Time slots on which upgrade is not allowed.
     */
    readonly notAllowedTime?: pulumi.Input<pulumi.Input<inputs.containerservice.v20210301.TimeSpanArgs>[]>;
    /**
     ...
     * Weekday time slots allowed to upgrade.
     */
    readonly timeInWeek?: pulumi.Input<pulumi.Input<inputs.containerservice.v20210301.TimeInWeekArgs>[]>;
}
