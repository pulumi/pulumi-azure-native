...
// Export enums:
export * from "../../types/enums/containerservice/v20200101";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:containerservice/v20200101:AgentPool":
                return new AgentPool(name, <any>undefined, { urn })
            case "azure-nextgen:containerservice/v20200101:ManagedCluster":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "containerservice/v20200101", _module)
