 ...
 * Agent Pool.
 *
 * @deprecated azure-native:containerservice/v20200101:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20200601:AgentPool to guarantee forwards compatibility.
 */
export class AgentPool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AgentPool {
        pulumi.log.warn("AgentPool is deprecated: azure-native:containerservice/v20200101:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20200601:AgentPool to guarantee forwards compatibility.")
        return new AgentPool(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20200101:AgentPool';
...
export interface AgentPoolArgs {
     ...
     * OsType to be used to specify os type. Choose from Linux and Windows. Default to Linux.
     */
    osType?: pulumi.Input<string | enums.containerservice.v20200101.OSType>;
    /**
     ...
     * ScaleSetEvictionPolicy to be used to specify eviction policy for low priority virtual machine scale set. Default to Delete.
     */
    scaleSetEvictionPolicy?: pulumi.Input<string | enums.containerservice.v20200101.ScaleSetEvictionPolicy>;
    /**
     * ScaleSetPriority to be used to specify virtual machine scale set priority. Default to regular.
     */
    scaleSetPriority?: pulumi.Input<string | enums.containerservice.v20200101.ScaleSetPriority>;
    /**
     * Agent pool tags to be persisted on the agent pool virtual machine scale set.
     */
     ...
     * AgentPoolType represents types of an agent pool
     */
    type?: pulumi.Input<string | enums.containerservice.v20200101.AgentPoolType>;
    /**
     * Size of agent VMs.
     */
    vmSize?: pulumi.Input<string | enums.containerservice.v20200101.ContainerServiceVMSizeTypes>;
    /**
     * VNet SubnetID specifies the VNet's subnet identifier.
     */
