...
export interface GetManagedClusterSnapshotResult {
     ...
     */
    readonly managedClusterPropertiesReadOnly: outputs.containerservice.v20220502preview.ManagedClusterPropertiesForSnapshotResponse;
    /**
...
export function getManagedClusterSnapshotOutput(args: GetManagedClusterSnapshotOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedClusterSnapshotResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerservice/v20220502preview:getManagedClusterSnapshot", {
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
}
