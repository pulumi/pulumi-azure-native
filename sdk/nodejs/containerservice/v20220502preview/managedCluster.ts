...
export class ManagedCluster extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedCluster {
        pulumi.log.warn("ManagedCluster is deprecated: azure-native:containerservice/v20220502preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:ManagedCluster to guarantee forwards compatibility.")
