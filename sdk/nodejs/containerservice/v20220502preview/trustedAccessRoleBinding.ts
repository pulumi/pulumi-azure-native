 ...
 *
 * @deprecated azure-native:containerservice/v20220502preview:TrustedAccessRoleBinding is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:TrustedAccessRoleBinding to guarantee forwards compatibility.
 */
export class TrustedAccessRoleBinding extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TrustedAccessRoleBinding {
        pulumi.log.warn("TrustedAccessRoleBinding is deprecated: azure-native:containerservice/v20220502preview:TrustedAccessRoleBinding is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:TrustedAccessRoleBinding to guarantee forwards compatibility.")
        return new TrustedAccessRoleBinding(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20220502preview:TrustedAccessRoleBinding';
