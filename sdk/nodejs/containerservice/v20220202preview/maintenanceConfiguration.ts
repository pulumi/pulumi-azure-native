 ...
 *
 * @deprecated azure-native:containerservice/v20220202preview:MaintenanceConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:MaintenanceConfiguration to guarantee forwards compatibility.
 */
export class MaintenanceConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly notAllowedTime!: pulumi.Output<outputs.containerservice.v20220202preview.TimeSpanResponse[] | undefined>;
    /**
     ...
     */
    public readonly timeInWeek!: pulumi.Output<outputs.containerservice.v20220202preview.TimeInWeekResponse[] | undefined>;
    /**
     * Resource type
     */
