 ...
 * Managed cluster.
 *
 * @deprecated azure-native:containerservice/v20220202preview:ManagedCluster is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:ManagedCluster to guarantee forwards compatibility.
 */
export class ManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20220202preview:ManagedCluster';
     ...
     */
    public readonly aadProfile!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterAADProfileResponse | undefined>;
    /**
     * The profile of managed cluster add-on.
     */
    public readonly addonProfiles!: pulumi.Output<{[key: string]: outputs.containerservice.v20220202preview.ManagedClusterAddonProfileResponse} | undefined>;
    /**
     * The agent pool properties.
     */
    public readonly agentPoolProfiles!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterAgentPoolProfileResponse[] | undefined>;
    /**
     * The access profile for managed cluster API server.
     */
    public readonly apiServerAccessProfile!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterAPIServerAccessProfileResponse | undefined>;
    /**
     * Parameters to be applied to the cluster-autoscaler when enabled
     */
    public readonly autoScalerProfile!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterPropertiesResponseAutoScalerProfile | undefined>;
    /**
     * The auto upgrade configuration.
     */
    public readonly autoUpgradeProfile!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterAutoUpgradeProfileResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.containerservice.v20220202preview.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly httpProxyConfig!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterHTTPProxyConfigResponse | undefined>;
    /**
     * The identity of the managed cluster, if configured.
     */
    public readonly identity!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterIdentityResponse | undefined>;
    /**
     * Identities associated with the cluster.
     */
    public readonly identityProfile!: pulumi.Output<{[key: string]: outputs.containerservice.v20220202preview.UserAssignedIdentityResponse} | undefined>;
    /**
     ...
     */
    public readonly linuxProfile!: pulumi.Output<outputs.containerservice.v20220202preview.ContainerServiceLinuxProfileResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.containerservice.v20220202preview.ContainerServiceNetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly oidcIssuerProfile!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterOIDCIssuerProfileResponse | undefined>;
    /**
     * See [use AAD pod identity](https://docs.microsoft.com/azure/aks/use-azure-ad-pod-identity) for more details on AAD pod identity integration.
     */
    public readonly podIdentityProfile!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterPodIdentityProfileResponse | undefined>;
    /**
     * The Power State of the cluster.
     */
    public /*out*/ readonly powerState!: pulumi.Output<outputs.containerservice.v20220202preview.PowerStateResponse>;
    /**
     ...
     */
    public readonly privateLinkResources!: pulumi.Output<outputs.containerservice.v20220202preview.PrivateLinkResourceResponse[] | undefined>;
    /**
     ...
     */
    public readonly securityProfile!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterSecurityProfileResponse | undefined>;
    /**
     * Information about a service principal identity for the cluster to use for manipulating Azure APIs.
     */
    public readonly servicePrincipalProfile!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterServicePrincipalProfileResponse | undefined>;
    /**
     * The managed cluster SKU.
     */
    public readonly sku!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterSKUResponse | undefined>;
    /**
     ...
     */
    public readonly windowsProfile!: pulumi.Output<outputs.containerservice.v20220202preview.ManagedClusterWindowsProfileResponse | undefined>;
    ...
    constructor(name: string, args: ManagedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkProfile"] = args ? (args.networkProfile ? pulumi.output(args.networkProfile).apply(inputs.containerservice.v20220202preview.containerServiceNetworkProfileArgsProvideDefaults) : undefined) : undefined;
...
export interface ManagedClusterArgs {
     ...
     * The Azure Active Directory configuration.
     */
    aadProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterAADProfileArgs>;
    /**
     * The profile of managed cluster add-on.
     */
    addonProfiles?: pulumi.Input<{[key: string]: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterAddonProfileArgs>}>;
    /**
     * The agent pool properties.
     */
    agentPoolProfiles?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterAgentPoolProfileArgs>[]>;
    /**
     * The access profile for managed cluster API server.
     */
    apiServerAccessProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterAPIServerAccessProfileArgs>;
    /**
     * Parameters to be applied to the cluster-autoscaler when enabled
     */
    autoScalerProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterPropertiesAutoScalerProfileArgs>;
    /**
     * The auto upgrade configuration.
     */
    autoUpgradeProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterAutoUpgradeProfileArgs>;
    /**
     * If set to true, getting static credentials will be disabled for this cluster. This must only be used on Managed Clusters that are AAD enabled. For more details see [disable local accounts](https://docs.microsoft.com/azure/aks/managed-aad#disable-local-accounts-preview).
     */
     ...
     * The extended location of the Virtual Machine.
     */
    extendedLocation?: pulumi.Input<inputs.containerservice.v20220202preview.ExtendedLocationArgs>;
    /**
     * This cannot be updated once the Managed Cluster has been created.
     */
     ...
     * Configurations for provisioning the cluster with HTTP proxy servers.
     */
    httpProxyConfig?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterHTTPProxyConfigArgs>;
    /**
     * The identity of the managed cluster, if configured.
     */
    identity?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterIdentityArgs>;
    /**
     * Identities associated with the cluster.
     */
    identityProfile?: pulumi.Input<{[key: string]: pulumi.Input<inputs.containerservice.v20220202preview.UserAssignedIdentityArgs>}>;
    /**
     * When you upgrade a supported AKS cluster, Kubernetes minor versions cannot be skipped. All upgrades must be performed sequentially by major version number. For example, upgrades between 1.14.x -> 1.15.x or 1.15.x -> 1.16.x are allowed, however 1.14.x -> 1.16.x is not allowed. See [upgrading an AKS cluster](https://docs.microsoft.com/azure/aks/upgrade-cluster) for more details.
     */
     ...
     * The profile for Linux VMs in the Managed Cluster.
     */
    linuxProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ContainerServiceLinuxProfileArgs>;
    /**
     * Resource location
     */
     ...
     * The network configuration profile.
     */
    networkProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ContainerServiceNetworkProfileArgs>;
    /**
     * The name of the resource group containing agent pool nodes.
     */
     ...
     * The OIDC issuer profile of the Managed Cluster.
     */
    oidcIssuerProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterOIDCIssuerProfileArgs>;
    /**
     * See [use AAD pod identity](https://docs.microsoft.com/azure/aks/use-azure-ad-pod-identity) for more details on AAD pod identity integration.
     */
    podIdentityProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterPodIdentityProfileArgs>;
    /**
     * Private link resources associated with the cluster.
     */
    privateLinkResources?: pulumi.Input<pulumi.Input<inputs.containerservice.v20220202preview.PrivateLinkResourceArgs>[]>;
    /**
     * Allow or deny public network access for AKS
     */
    publicNetworkAccess?: pulumi.Input<string | enums.containerservice.v20220202preview.PublicNetworkAccess>;
    /**
     ...
     * Security profile for the managed cluster.
     */
    securityProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterSecurityProfileArgs>;
    /**
     * Information about a service principal identity for the cluster to use for manipulating Azure APIs.
     */
    servicePrincipalProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterServicePrincipalProfileArgs>;
    /**
     * The managed cluster SKU.
     */
    sku?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterSKUArgs>;
    /**
     * Resource tags
     */
     ...
     * The profile for Windows VMs in the Managed Cluster.
     */
    windowsProfile?: pulumi.Input<inputs.containerservice.v20220202preview.ManagedClusterWindowsProfileArgs>;
}
