...
export function getManagedClusterSnapshot(args: GetManagedClusterSnapshotArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedClusterSnapshotResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20241002preview:getManagedClusterSnapshot", {
...
export interface GetManagedClusterSnapshotResult {
     ...
     */
    readonly managedClusterPropertiesReadOnly: outputs.containerservice.v20241002preview.ManagedClusterPropertiesForSnapshotResponse;
    /**
...
export function getManagedClusterSnapshotOutput(args: GetManagedClusterSnapshotOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedClusterSnapshotResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerservice/v20241002preview:getManagedClusterSnapshot", {
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
}
