...
export class ManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerservice:ManagedCluster';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.containerservice.ManagedClusterPropertiesResponse>;
    /**
...
export interface ManagedClusterArgs {
     ...
     * Properties of a managed cluster.
     */
    readonly properties?: pulumi.Input<inputs.containerservice.ManagedClusterProperties>;
    /**
