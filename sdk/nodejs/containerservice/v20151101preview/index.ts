...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:containerservice/v20151101preview:ContainerService":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "containerservice/v20151101preview", _module)
