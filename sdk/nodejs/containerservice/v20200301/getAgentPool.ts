 ...
 */
/** @deprecated azure-native:containerservice/v20200301:AgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20200601:AgentPool to guarantee forwards compatibility. */
export function getAgentPool(args: GetAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentPoolResult> {
    pulumi.log.warn("getAgentPool is deprecated: azure-native:containerservice/v20200301:AgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20200601:AgentPool to guarantee forwards compatibility.")
