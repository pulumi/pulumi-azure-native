 ...
 *
 * @deprecated azure-native:containerservice/v20221102preview:ManagedClusterSnapshot is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:ManagedClusterSnapshot to guarantee forwards compatibility.
 */
export class ManagedClusterSnapshot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedClusterSnapshot {
        pulumi.log.warn("ManagedClusterSnapshot is deprecated: azure-native:containerservice/v20221102preview:ManagedClusterSnapshot is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:ManagedClusterSnapshot to guarantee forwards compatibility.")
