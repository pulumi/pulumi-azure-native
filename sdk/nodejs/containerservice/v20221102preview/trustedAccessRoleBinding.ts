...
export class TrustedAccessRoleBinding extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TrustedAccessRoleBinding {
        pulumi.log.warn("TrustedAccessRoleBinding is deprecated: azure-native:containerservice/v20221102preview:TrustedAccessRoleBinding is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:TrustedAccessRoleBinding to guarantee forwards compatibility.")
