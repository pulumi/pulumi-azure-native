...
export interface GetManagedClusterSnapshotResult {
     ...
     */
    readonly creationData?: outputs.containerservice.v20230902preview.CreationDataResponse;
    /**
     ...
     */
    readonly managedClusterPropertiesReadOnly: outputs.containerservice.v20230902preview.ManagedClusterPropertiesForSnapshotResponse;
    /**
...
export function getManagedClusterSnapshotOutput(args: GetManagedClusterSnapshotOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedClusterSnapshotResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerservice/v20230902preview:getManagedClusterSnapshot", {
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
}
