 ...
 *
 * @deprecated azure-native:containerservice/v20220602preview:FleetMember is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20220902preview:FleetMember to guarantee forwards compatibility.
 */
export class FleetMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20220602preview:FleetMember';
    ...
    constructor(name: string, args: FleetMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice/v20220702preview:FleetMember" }, { type: "azure-native:containerservice/v20220902preview:FleetMember" }] };
