...
export interface GetMaintenanceConfigurationResult {
     ...
     */
    readonly notAllowedTime?: outputs.containerservice.v20220602preview.TimeSpanResponse[];
    /**
     ...
     */
    readonly timeInWeek?: outputs.containerservice.v20220602preview.TimeInWeekResponse[];
    /**
     * Resource type
     */
...
export function getMaintenanceConfigurationOutput(args: GetMaintenanceConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaintenanceConfigurationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerservice/v20220602preview:getMaintenanceConfiguration", {
        "configName": args.configName,
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
