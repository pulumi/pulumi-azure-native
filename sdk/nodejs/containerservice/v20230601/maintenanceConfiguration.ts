...
export class MaintenanceConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly maintenanceWindow!: pulumi.Output<outputs.containerservice.v20230601.MaintenanceWindowResponse | undefined>;
    /**
     ...
     */
    public readonly notAllowedTime!: pulumi.Output<outputs.containerservice.v20230601.TimeSpanResponse[] | undefined>;
    /**
     * The system metadata relating to this resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.containerservice.v20230601.SystemDataResponse>;
    /**
     * If two array entries specify the same day of the week, the applied configuration is the union of times in both entries.
     */
    public readonly timeInWeek!: pulumi.Output<outputs.containerservice.v20230601.TimeInWeekResponse[] | undefined>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: MaintenanceConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["maintenanceWindow"] = args ? (args.maintenanceWindow ? pulumi.output(args.maintenanceWindow).apply(inputs.containerservice.v20230601.maintenanceWindowArgsProvideDefaults) : undefined) : undefined;
...
export interface MaintenanceConfigurationArgs {
     ...
     * Maintenance window for the maintenance configuration.
     */
    maintenanceWindow?: pulumi.Input<inputs.containerservice.v20230601.MaintenanceWindowArgs>;
    /**
     * Time slots on which upgrade is not allowed.
     */
    notAllowedTime?: pulumi.Input<pulumi.Input<inputs.containerservice.v20230601.TimeSpanArgs>[]>;
    /**
     ...
     * If two array entries specify the same day of the week, the applied configuration is the union of times in both entries.
     */
    timeInWeek?: pulumi.Input<pulumi.Input<inputs.containerservice.v20230601.TimeInWeekArgs>[]>;
}
