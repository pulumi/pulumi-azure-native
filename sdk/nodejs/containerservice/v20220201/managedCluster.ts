 ...
 * Managed cluster.
 *
 * @deprecated azure-native:containerservice/v20220201:ManagedCluster is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:ManagedCluster to guarantee forwards compatibility.
 */
export class ManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20220201:ManagedCluster';
     ...
     */
    public readonly aadProfile!: pulumi.Output<outputs.containerservice.v20220201.ManagedClusterAADProfileResponse | undefined>;
    /**
     * The profile of managed cluster add-on.
     */
    public readonly addonProfiles!: pulumi.Output<{[key: string]: outputs.containerservice.v20220201.ManagedClusterAddonProfileResponse} | undefined>;
    /**
     * The agent pool properties.
     */
    public readonly agentPoolProfiles!: pulumi.Output<outputs.containerservice.v20220201.ManagedClusterAgentPoolProfileResponse[] | undefined>;
    /**
     * The access profile for managed cluster API server.
     */
    public readonly apiServerAccessProfile!: pulumi.Output<outputs.containerservice.v20220201.ManagedClusterAPIServerAccessProfileResponse | undefined>;
    /**
     * Parameters to be applied to the cluster-autoscaler when enabled
     */
    public readonly autoScalerProfile!: pulumi.Output<outputs.containerservice.v20220201.ManagedClusterPropertiesResponseAutoScalerProfile | undefined>;
    /**
     * The auto upgrade configuration.
     */
    public readonly autoUpgradeProfile!: pulumi.Output<outputs.containerservice.v20220201.ManagedClusterAutoUpgradeProfileResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.containerservice.v20220201.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly httpProxyConfig!: pulumi.Output<outputs.containerservice.v20220201.ManagedClusterHTTPProxyConfigResponse | undefined>;
    /**
     * The identity of the managed cluster, if configured.
     */
    public readonly identity!: pulumi.Output<outputs.containerservice.v20220201.ManagedClusterIdentityResponse | undefined>;
    /**
     * Identities associated with the cluster.
     */
    public readonly identityProfile!: pulumi.Output<{[key: string]: outputs.containerservice.v20220201.UserAssignedIdentityResponse} | undefined>;
    /**
     ...
     */
    public readonly linuxProfile!: pulumi.Output<outputs.containerservice.v20220201.ContainerServiceLinuxProfileResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.containerservice.v20220201.ContainerServiceNetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly podIdentityProfile!: pulumi.Output<outputs.containerservice.v20220201.ManagedClusterPodIdentityProfileResponse | undefined>;
    /**
     * The Power State of the cluster.
     */
    public /*out*/ readonly powerState!: pulumi.Output<outputs.containerservice.v20220201.PowerStateResponse>;
    /**
     ...
     */
    public readonly privateLinkResources!: pulumi.Output<outputs.containerservice.v20220201.PrivateLinkResourceResponse[] | undefined>;
    /**
     ...
     */
    public readonly securityProfile!: pulumi.Output<outputs.containerservice.v20220201.ManagedClusterSecurityProfileResponse | undefined>;
    /**
     * Information about a service principal identity for the cluster to use for manipulating Azure APIs.
     */
    public readonly servicePrincipalProfile!: pulumi.Output<outputs.containerservice.v20220201.ManagedClusterServicePrincipalProfileResponse | undefined>;
    /**
     * The managed cluster SKU.
     */
    public readonly sku!: pulumi.Output<outputs.containerservice.v20220201.ManagedClusterSKUResponse | undefined>;
    /**
     ...
     */
    public readonly windowsProfile!: pulumi.Output<outputs.containerservice.v20220201.ManagedClusterWindowsProfileResponse | undefined>;
    ...
    constructor(name: string, args: ManagedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkProfile"] = args ? (args.networkProfile ? pulumi.output(args.networkProfile).apply(inputs.containerservice.v20220201.containerServiceNetworkProfileArgsProvideDefaults) : undefined) : undefined;
...
export interface ManagedClusterArgs {
     ...
     * The profile of managed cluster add-on.
     */
    addonProfiles?: pulumi.Input<{[key: string]: pulumi.Input<inputs.containerservice.v20220201.ManagedClusterAddonProfileArgs>}>;
    /**
     * The agent pool properties.
     */
     ...
     * Identities associated with the cluster.
     */
    identityProfile?: pulumi.Input<{[key: string]: pulumi.Input<inputs.containerservice.v20220201.UserAssignedIdentityArgs>}>;
    /**
     * When you upgrade a supported AKS cluster, Kubernetes minor versions cannot be skipped. All upgrades must be performed sequentially by major version number. For example, upgrades between 1.14.x -> 1.15.x or 1.15.x -> 1.16.x are allowed, however 1.14.x -> 1.16.x is not allowed. See [upgrading an AKS cluster](https://docs.microsoft.com/azure/aks/upgrade-cluster) for more details.
     */
