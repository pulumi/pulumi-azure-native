...
export class ContainerService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20160930:ContainerService';
    ...
    constructor(name: string, args: ContainerServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerservice/v20160930:ContainerService" }, { type: "azure-native:containerservice:ContainerService" }, { type: "azure-nextgen:containerservice:ContainerService" }, { type: "azure-native:containerservice/latest:ContainerService" }, { type: "azure-nextgen:containerservice/latest:ContainerService" }, { type: "azure-native:containerservice/v20151101preview:ContainerService" }, { type: "azure-nextgen:containerservice/v20151101preview:ContainerService" }, { type: "azure-native:containerservice/v20160330:ContainerService" }, { type: "azure-nextgen:containerservice/v20160330:ContainerService" }, { type: "azure-native:containerservice/v20170131:ContainerService" }, { type: "azure-nextgen:containerservice/v20170131:ContainerService" }] };
