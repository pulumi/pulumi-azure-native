...
export function getContainerService(args: GetContainerServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerServiceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:containerservice/v20160930:getContainerService", {
        "name": args.name,
...
export interface GetContainerServiceResult {
     ...
     */
    readonly properties: outputs.containerservice.v20160930.ContainerServicePropertiesResponse;
    /**
     * Resource tags
     */
