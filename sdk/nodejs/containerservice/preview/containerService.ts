...
export class ContainerService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerservice/preview:ContainerService';
     ...
     */
    public readonly agentPoolProfiles!: pulumi.Output<outputs.containerservice.preview.ContainerServiceAgentPoolProfileResponse[] | undefined>;
    /**
     * Properties to configure a custom container service cluster.
     */
    public readonly customProfile!: pulumi.Output<outputs.containerservice.preview.ContainerServiceCustomProfileResponse | undefined>;
    /**
     * Profile for diagnostics in the container service cluster.
     */
    public readonly diagnosticsProfile!: pulumi.Output<outputs.containerservice.preview.ContainerServiceDiagnosticsProfileResponse | undefined>;
    /**
     * Profile for Linux VMs in the container service cluster.
     */
    public readonly linuxProfile!: pulumi.Output<outputs.containerservice.preview.ContainerServiceLinuxProfileResponse>;
    /**
     * Resource location
     */
     ...
     */
    public readonly masterProfile!: pulumi.Output<outputs.containerservice.preview.ContainerServiceMasterProfileResponse>;
    /**
     * Resource name
     */
     ...
     */
    public readonly orchestratorProfile!: pulumi.Output<outputs.containerservice.preview.ContainerServiceOrchestratorProfileResponse>;
    /**
     ...
     */
    public readonly servicePrincipalProfile!: pulumi.Output<outputs.containerservice.preview.ContainerServiceServicePrincipalProfileResponse | undefined>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly windowsProfile!: pulumi.Output<outputs.containerservice.preview.ContainerServiceWindowsProfileResponse | undefined>;
    ...
    constructor(name: string, args: ContainerServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerservice/latest:ContainerService" }, { type: "azurerm:containerservice/v20151101preview:ContainerService" }, { type: "azurerm:containerservice/v20160330:ContainerService" }, { type: "azurerm:containerservice/v20160930:ContainerService" }, { type: "azurerm:containerservice/v20170131:ContainerService" }, { type: "azurerm:containerservice/v20170701:ContainerService" }] };
...
export interface ContainerServiceArgs {
     ...
     * Properties of the agent pool.
     */
    readonly agentPoolProfiles?: pulumi.Input<pulumi.Input<inputs.containerservice.preview.ContainerServiceAgentPoolProfile>[]>;
    /**
     ...
     * Properties to configure a custom container service cluster.
     */
    readonly customProfile?: pulumi.Input<inputs.containerservice.preview.ContainerServiceCustomProfile>;
    /**
     * Profile for diagnostics in the container service cluster.
     */
    readonly diagnosticsProfile?: pulumi.Input<inputs.containerservice.preview.ContainerServiceDiagnosticsProfile>;
    /**
     * Profile for Linux VMs in the container service cluster.
     */
     ...
     * Profile for the container service master.
     */
    readonly masterProfile: pulumi.Input<inputs.containerservice.preview.ContainerServiceMasterProfile>;
    /**
     * Profile for the container service orchestrator.
     */
    readonly orchestratorProfile: pulumi.Input<inputs.containerservice.preview.ContainerServiceOrchestratorProfile>;
    /**
     ...
     * Information about a service principal identity for the cluster to use for manipulating Azure APIs. Exact one of secret or keyVaultSecretRef need to be specified.
     */
    readonly servicePrincipalProfile?: pulumi.Input<inputs.containerservice.preview.ContainerServiceServicePrincipalProfile>;
    /**
     * Resource tags
     */
     ...
     * Profile for Windows VMs in the container service cluster.
     */
    readonly windowsProfile?: pulumi.Input<inputs.containerservice.preview.ContainerServiceWindowsProfile>;
}
