...
export class AgentPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerservice/preview:AgentPool';
     ...
     */
    public readonly upgradeSettings!: pulumi.Output<outputs.containerservice.preview.AgentPoolUpgradeSettingsResponse | undefined>;
    /**
     * Size of agent VMs.
     */
...
export interface AgentPoolArgs {
     ...
     * Settings for upgrading the agentpool
     */
    readonly upgradeSettings?: pulumi.Input<inputs.containerservice.preview.AgentPoolUpgradeSettings>;
    /**
     * Size of agent VMs.
     */
