...
export function getAgentPool(args: GetAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentPoolResult> {
    ...
    return pulumi.runtime.invoke("azurerm:containerservice/preview:getAgentPool", {
...
export interface GetAgentPoolResult {
     ...
     */
    readonly upgradeSettings?: outputs.containerservice.preview.AgentPoolUpgradeSettingsResponse;
    /**
     * Size of agent VMs.
     */
