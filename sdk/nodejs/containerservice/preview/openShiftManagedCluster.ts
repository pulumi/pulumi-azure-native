...
export class OpenShiftManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerservice/preview:OpenShiftManagedCluster';
     ...
     */
    public readonly agentPoolProfiles!: pulumi.Output<outputs.containerservice.preview.OpenShiftManagedClusterAgentPoolProfileResponse[] | undefined>;
    /**
     * Configures OpenShift authentication.
     */
    public readonly authProfile!: pulumi.Output<outputs.containerservice.preview.OpenShiftManagedClusterAuthProfileResponse | undefined>;
    /**
     ...
     */
    public readonly masterPoolProfile!: pulumi.Output<outputs.containerservice.preview.OpenShiftManagedClusterMasterPoolProfileResponse | undefined>;
    /**
     * Configures Log Analytics integration.
     */
    public readonly monitorProfile!: pulumi.Output<outputs.containerservice.preview.OpenShiftManagedClusterMonitorProfileResponse | undefined>;
    /**
     * Resource name
     */
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.containerservice.preview.NetworkProfileResponse | undefined>;
    /**
     * Version of OpenShift specified when creating the cluster.
     */
     ...
     */
    public readonly plan!: pulumi.Output<outputs.containerservice.preview.PurchasePlanResponse | undefined>;
    /**
     ...
     */
    public readonly routerProfiles!: pulumi.Output<outputs.containerservice.preview.OpenShiftRouterProfileResponse[] | undefined>;
    /**
     * Resource tags
     */
...
export interface OpenShiftManagedClusterArgs {
     ...
     * Configuration of OpenShift cluster VMs.
     */
    readonly agentPoolProfiles?: pulumi.Input<pulumi.Input<inputs.containerservice.preview.OpenShiftManagedClusterAgentPoolProfile>[]>;
    /**
     * Configures OpenShift authentication.
     */
    readonly authProfile?: pulumi.Input<inputs.containerservice.preview.OpenShiftManagedClusterAuthProfile>;
    /**
     * Resource location
     */
     ...
     * Configuration for OpenShift master VMs.
     */
    readonly masterPoolProfile?: pulumi.Input<inputs.containerservice.preview.OpenShiftManagedClusterMasterPoolProfile>;
    /**
     * Configures Log Analytics integration.
     */
    readonly monitorProfile?: pulumi.Input<inputs.containerservice.preview.OpenShiftManagedClusterMonitorProfile>;
    /**
     * Configuration for OpenShift networking.
     */
    readonly networkProfile?: pulumi.Input<inputs.containerservice.preview.NetworkProfile>;
    /**
     * Version of OpenShift specified when creating the cluster.
     */
     ...
     * Define the resource plan as required by ARM for billing purposes
     */
    readonly plan?: pulumi.Input<inputs.containerservice.preview.PurchasePlan>;
    /**
     * Allows node rotation
     */
     ...
     * Configuration for OpenShift router(s).
     */
    readonly routerProfiles?: pulumi.Input<pulumi.Input<inputs.containerservice.preview.OpenShiftRouterProfile>[]>;
    /**
     * Resource tags
     */
