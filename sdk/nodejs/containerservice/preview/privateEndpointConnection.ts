...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerservice/preview:PrivateEndpointConnection';
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.containerservice.preview.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.containerservice.preview.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerservice/latest:PrivateEndpointConnection" }, { type: "azurerm:containerservice/v20200601:PrivateEndpointConnection" }, { type: "azurerm:containerservice/v20200701:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * The resource of private endpoint.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.containerservice.preview.PrivateEndpoint>;
    /**
     * The name of the private endpoint connection.
     */
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Input<inputs.containerservice.preview.PrivateLinkServiceConnectionState>;
    /**
