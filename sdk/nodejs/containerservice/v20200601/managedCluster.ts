...
export interface ManagedClusterArgs {
     ...
     * Profile of managed cluster add-on.
     */
    readonly addonProfiles?: pulumi.Input<{[key: string]: pulumi.Input<inputs.containerservice.v20200601.ManagedClusterAddonProfileArgs>}>;
    /**
     * Properties of the agent pool.
     */
     ...
     * Identities associated with the cluster.
     */
    readonly identityProfile?: pulumi.Input<{[key: string]: pulumi.Input<inputs.containerservice.v20200601.ManagedClusterPropertiesIdentityProfileArgs>}>;
    /**
     * Version of Kubernetes specified when creating the managed cluster.
     */
