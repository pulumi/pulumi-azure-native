 ...
 *
 * const managedCluster = new azurerm.containerservice.v20200601.ManagedCluster("managedCluster", {
 *     addonProfiles: {},
 *     agentPoolProfiles: [{
 *         count: 3,
