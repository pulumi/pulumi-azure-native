 ...
 *
 * const managedCluster = new azurerm.containerservice.v20200701.ManagedCluster("managedCluster", {
 *     addonProfiles: {},
 *     agentPoolProfiles: [{
 *         count: 3,
...
export class ManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerservice/v20200701:ManagedCluster';
