...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerservice/latest:PrivateEndpointConnection" }, { type: "azurerm:containerservice/preview:PrivateEndpointConnection" }, { type: "azurerm:containerservice/v20200601:PrivateEndpointConnection" }] };
