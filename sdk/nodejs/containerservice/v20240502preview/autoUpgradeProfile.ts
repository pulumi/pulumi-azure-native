...
export class AutoUpgradeProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20240502preview:AutoUpgradeProfile';
     ...
     */
    public readonly nodeImageSelection!: pulumi.Output<outputs.containerservice.v20240502preview.AutoUpgradeNodeImageSelectionResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AutoUpgradeProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice:AutoUpgradeProfile" }] };
...
export interface AutoUpgradeProfileArgs {
     ...
     * Configures how auto-upgrade will be run.
     */
    channel: pulumi.Input<string | enums.containerservice.v20240502preview.UpgradeChannel>;
    /**
     * If set to False: the auto upgrade has effect - target managed clusters will be upgraded on schedule.
     * If set to True: the auto upgrade has no effect - no upgrade will be run on the target managed clusters.
     * This is a boolean and not an enum because enabled/disabled are all available states of the auto upgrade profile.
     ...
     * The node image upgrade to be applied to the target clusters in auto upgrade.
     */
    nodeImageSelection?: pulumi.Input<inputs.containerservice.v20240502preview.AutoUpgradeNodeImageSelectionArgs>;
    /**
