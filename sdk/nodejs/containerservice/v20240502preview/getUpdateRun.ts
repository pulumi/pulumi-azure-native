...
export function getUpdateRun(args: GetUpdateRunArgs, opts?: pulumi.InvokeOptions): Promise<GetUpdateRunResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20240502preview:getUpdateRun", {
...
export interface GetUpdateRunResult {
     ...
     */
    readonly managedClusterUpdate: outputs.containerservice.v20240502preview.ManagedClusterUpdateResponse;
    /**
     ...
     */
    readonly status: outputs.containerservice.v20240502preview.UpdateRunStatusResponse;
    /**
...
export function getUpdateRunOutput(args: GetUpdateRunOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetUpdateRunResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerservice/v20240502preview:getUpdateRun", {
        "fleetName": args.fleetName,
        "resourceGroupName": args.resourceGroupName,
        "updateRunName": args.updateRunName,
    }, opts);
