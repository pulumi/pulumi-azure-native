...
export class UpdateRun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20240502preview:UpdateRun';
     ...
     */
    public readonly managedClusterUpdate!: pulumi.Output<outputs.containerservice.v20240502preview.ManagedClusterUpdateResponse>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.containerservice.v20240502preview.UpdateRunStatusResponse>;
    /**
     * The strategy defines the order in which the clusters will be updated.
     * If not set, all members will be updated sequentially. The UpdateRun status will show a single UpdateStage and a single UpdateGroup targeting all members.
     * The strategy of the UpdateRun can be modified until the run is started.
     */
    public readonly strategy!: pulumi.Output<outputs.containerservice.v20240502preview.UpdateRunStrategyResponse | undefined>;
    /**
