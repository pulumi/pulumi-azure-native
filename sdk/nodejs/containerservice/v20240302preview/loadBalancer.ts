...
export class LoadBalancer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20240302preview:LoadBalancer';
     ...
     */
    public readonly nodeSelector!: pulumi.Output<outputs.containerservice.v20240302preview.LabelSelectorResponse | undefined>;
    /**
     ...
     */
    public readonly serviceLabelSelector!: pulumi.Output<outputs.containerservice.v20240302preview.LabelSelectorResponse | undefined>;
    /**
     * Services created in namespaces that match the selector can be placed on this load balancer.
     */
    public readonly serviceNamespaceSelector!: pulumi.Output<outputs.containerservice.v20240302preview.LabelSelectorResponse | undefined>;
    /**
    ...
    constructor(name: string, args: LoadBalancerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice/v20240402preview:LoadBalancer" }, { type: "azure-native:containerservice/v20240502preview:LoadBalancer" }, { type: "azure-native:containerservice/v20240602preview:LoadBalancer" }, { type: "azure-native:containerservice/v20240702preview:LoadBalancer" }, { type: "azure-native:containerservice/v20240902preview:LoadBalancer" }, { type: "azure-native:containerservice/v20241002preview:LoadBalancer" }, { type: "azure-native:containerservice/v20250102preview:LoadBalancer" }, { type: "azure-native:containerservice:LoadBalancer" }] };
