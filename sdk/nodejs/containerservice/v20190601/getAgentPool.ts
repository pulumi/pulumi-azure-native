 ...
 */
/** @deprecated azure-native:containerservice/v20190601:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20200601:AgentPool to guarantee forwards compatibility. */
export function getAgentPool(args: GetAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentPoolResult> {
    pulumi.log.warn("getAgentPool is deprecated: azure-native:containerservice/v20190601:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20200601:AgentPool to guarantee forwards compatibility.")
