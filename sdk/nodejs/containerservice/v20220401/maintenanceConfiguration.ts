...
export class MaintenanceConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MaintenanceConfiguration {
        pulumi.log.warn("MaintenanceConfiguration is deprecated: azure-native:containerservice/v20220401:MaintenanceConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:MaintenanceConfiguration to guarantee forwards compatibility.")
