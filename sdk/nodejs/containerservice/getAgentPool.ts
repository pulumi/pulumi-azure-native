...
export function getAgentPool(args: GetAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentPoolResult> {
    ...
    return pulumi.runtime.invoke("azurerm:containerservice:getAgentPool", {
        "name": args.name,
...
export interface GetAgentPoolResult {
     ...
     */
    readonly properties: outputs.containerservice.ManagedClusterAgentPoolProfilePropertiesResponse;
    /**
     * Resource type
     */
