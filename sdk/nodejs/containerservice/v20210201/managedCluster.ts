...
export class ManagedCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkProfile"] = args ? (args.networkProfile ? pulumi.output(args.networkProfile).apply(inputs.containerservice.v20210201.containerServiceNetworkProfileArgsProvideDefaults) : undefined) : undefined;
