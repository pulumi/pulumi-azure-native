...
export class ManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20210201:ManagedCluster';
     ...
     */
    public readonly aadProfile!: pulumi.Output<outputs.containerservice.v20210201.ManagedClusterAADProfileResponse | undefined>;
    /**
     * Profile of managed cluster add-on.
     */
    public readonly addonProfiles!: pulumi.Output<{[key: string]: outputs.containerservice.v20210201.ManagedClusterAddonProfileResponse} | undefined>;
    /**
     * Properties of the agent pool.
     */
    public readonly agentPoolProfiles!: pulumi.Output<outputs.containerservice.v20210201.ManagedClusterAgentPoolProfileResponse[] | undefined>;
    /**
     * Access profile for managed cluster API server.
     */
    public readonly apiServerAccessProfile!: pulumi.Output<outputs.containerservice.v20210201.ManagedClusterAPIServerAccessProfileResponse | undefined>;
    /**
     * Parameters to be applied to the cluster-autoscaler when enabled
     */
    public readonly autoScalerProfile!: pulumi.Output<outputs.containerservice.v20210201.ManagedClusterPropertiesResponseAutoScalerProfile | undefined>;
    /**
     * Profile of auto upgrade configuration.
     */
    public readonly autoUpgradeProfile!: pulumi.Output<outputs.containerservice.v20210201.ManagedClusterAutoUpgradeProfileResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.containerservice.v20210201.ManagedClusterIdentityResponse | undefined>;
    /**
     * Identities associated with the cluster.
     */
    public readonly identityProfile!: pulumi.Output<{[key: string]: outputs.containerservice.v20210201.ManagedClusterPropertiesResponseIdentityProfile} | undefined>;
    /**
     ...
     */
    public readonly linuxProfile!: pulumi.Output<outputs.containerservice.v20210201.ContainerServiceLinuxProfileResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.containerservice.v20210201.ContainerServiceNetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly podIdentityProfile!: pulumi.Output<outputs.containerservice.v20210201.ManagedClusterPodIdentityProfileResponse | undefined>;
    /**
     ...
     */
    public readonly servicePrincipalProfile!: pulumi.Output<outputs.containerservice.v20210201.ManagedClusterServicePrincipalProfileResponse | undefined>;
    /**
     * The managed cluster SKU.
     */
    public readonly sku!: pulumi.Output<outputs.containerservice.v20210201.ManagedClusterSKUResponse | undefined>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly windowsProfile!: pulumi.Output<outputs.containerservice.v20210201.ManagedClusterWindowsProfileResponse | undefined>;
...
export interface ManagedClusterArgs {
     ...
     * Profile of Azure Active Directory configuration.
     */
    aadProfile?: pulumi.Input<inputs.containerservice.v20210201.ManagedClusterAADProfileArgs>;
    /**
     * Profile of managed cluster add-on.
     */
    addonProfiles?: pulumi.Input<{[key: string]: pulumi.Input<inputs.containerservice.v20210201.ManagedClusterAddonProfileArgs>}>;
    /**
     * Properties of the agent pool.
     */
    agentPoolProfiles?: pulumi.Input<pulumi.Input<inputs.containerservice.v20210201.ManagedClusterAgentPoolProfileArgs>[]>;
    /**
     * Access profile for managed cluster API server.
     */
    apiServerAccessProfile?: pulumi.Input<inputs.containerservice.v20210201.ManagedClusterAPIServerAccessProfileArgs>;
    /**
     * Parameters to be applied to the cluster-autoscaler when enabled
     */
    autoScalerProfile?: pulumi.Input<inputs.containerservice.v20210201.ManagedClusterPropertiesAutoScalerProfileArgs>;
    /**
     * Profile of auto upgrade configuration.
     */
    autoUpgradeProfile?: pulumi.Input<inputs.containerservice.v20210201.ManagedClusterAutoUpgradeProfileArgs>;
    /**
     * ResourceId of the disk encryption set to use for enabling encryption at rest.
     */
     ...
     * The identity of the managed cluster, if configured.
     */
    identity?: pulumi.Input<inputs.containerservice.v20210201.ManagedClusterIdentityArgs>;
    /**
     * Identities associated with the cluster.
     */
    identityProfile?: pulumi.Input<{[key: string]: pulumi.Input<inputs.containerservice.v20210201.ManagedClusterPropertiesIdentityProfileArgs>}>;
    /**
     * Version of Kubernetes specified when creating the managed cluster.
     */
     ...
     * Profile for Linux VMs in the container service cluster.
     */
    linuxProfile?: pulumi.Input<inputs.containerservice.v20210201.ContainerServiceLinuxProfileArgs>;
    /**
     * Resource location
     */
     ...
     * Profile of network configuration.
     */
    networkProfile?: pulumi.Input<inputs.containerservice.v20210201.ContainerServiceNetworkProfileArgs>;
    /**
     * Name of the resource group containing agent pool nodes.
     */
     ...
     * Profile of managed cluster pod identity.
     */
    podIdentityProfile?: pulumi.Input<inputs.containerservice.v20210201.ManagedClusterPodIdentityProfileArgs>;
    /**
     ...
     * Information about a service principal identity for the cluster to use for manipulating Azure APIs.
     */
    servicePrincipalProfile?: pulumi.Input<inputs.containerservice.v20210201.ManagedClusterServicePrincipalProfileArgs>;
    /**
     * The managed cluster SKU.
     */
    sku?: pulumi.Input<inputs.containerservice.v20210201.ManagedClusterSKUArgs>;
    /**
     * Resource tags
     */
     ...
     * Profile for Windows VMs in the container service cluster.
     */
    windowsProfile?: pulumi.Input<inputs.containerservice.v20210201.ManagedClusterWindowsProfileArgs>;
}
