 ...
 */
/** @deprecated azure-native:containerservice/v20220702preview:Fleet is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20220902preview:Fleet to guarantee forwards compatibility. */
export function getFleet(args: GetFleetArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetResult> {
    pulumi.log.warn("getFleet is deprecated: azure-native:containerservice/v20220702preview:Fleet is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20220902preview:Fleet to guarantee forwards compatibility.")
