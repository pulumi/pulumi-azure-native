 ...
 * Agent Pool.
 */
/** @deprecated azure-native:containerservice/v20220702preview:AgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:AgentPool to guarantee forwards compatibility. */
export function getAgentPool(args: GetAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentPoolResult> {
    pulumi.log.warn("getAgentPool is deprecated: azure-native:containerservice/v20220702preview:AgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:AgentPool to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:containerservice/v20220702preview:getAgentPool", {
...
export interface GetAgentPoolResult {
     ...
     */
    readonly kubeletConfig?: outputs.containerservice.v20220702preview.KubeletConfigResponse;
    /**
     ...
     */
    readonly linuxOSConfig?: outputs.containerservice.v20220702preview.LinuxOSConfigResponse;
    /**
     ...
     */
    readonly powerState?: outputs.containerservice.v20220702preview.PowerStateResponse;
    /**
     ...
     */
    readonly upgradeSettings?: outputs.containerservice.v20220702preview.AgentPoolUpgradeSettingsResponse;
    /**
