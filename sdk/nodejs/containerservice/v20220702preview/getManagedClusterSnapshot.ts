 ...
 */
/** @deprecated azure-native:containerservice/v20220702preview:ManagedClusterSnapshot is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:ManagedClusterSnapshot to guarantee forwards compatibility. */
export function getManagedClusterSnapshot(args: GetManagedClusterSnapshotArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedClusterSnapshotResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20220702preview:getManagedClusterSnapshot", {
...
export interface GetManagedClusterSnapshotResult {
     ...
     */
    readonly creationData?: outputs.containerservice.v20220702preview.CreationDataResponse;
    /**
     ...
     */
    readonly managedClusterPropertiesReadOnly: outputs.containerservice.v20220702preview.ManagedClusterPropertiesForSnapshotResponse;
    /**
