...
export class FleetMember extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.containerservice.v20220702preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: FleetMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice/v20220602preview:FleetMember" }, { type: "azure-native:containerservice/v20220902preview:FleetMember" }] };
