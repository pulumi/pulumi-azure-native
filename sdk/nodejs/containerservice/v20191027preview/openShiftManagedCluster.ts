...
export class OpenShiftManagedCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OpenShiftManagedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerservice/v20191027preview:OpenShiftManagedCluster" }, { type: "azure-native:containerservice:OpenShiftManagedCluster" }, { type: "azure-nextgen:containerservice:OpenShiftManagedCluster" }, { type: "azure-native:containerservice/v20180930preview:OpenShiftManagedCluster" }, { type: "azure-nextgen:containerservice/v20180930preview:OpenShiftManagedCluster" }, { type: "azure-native:containerservice/v20190430:OpenShiftManagedCluster" }, { type: "azure-nextgen:containerservice/v20190430:OpenShiftManagedCluster" }, { type: "azure-native:containerservice/v20190930preview:OpenShiftManagedCluster" }, { type: "azure-nextgen:containerservice/v20190930preview:OpenShiftManagedCluster" }] };
...
export interface OpenShiftManagedClusterArgs {
     ...
     * Configuration of OpenShift cluster VMs.
     */
    agentPoolProfiles?: pulumi.Input<pulumi.Input<inputs.containerservice.v20191027preview.OpenShiftManagedClusterAgentPoolProfileArgs>[]>;
    /**
     * Configures OpenShift authentication.
     */
    authProfile?: pulumi.Input<inputs.containerservice.v20191027preview.OpenShiftManagedClusterAuthProfileArgs>;
    /**
     * Resource location
     */
     ...
     * Configuration for OpenShift master VMs.
     */
    masterPoolProfile?: pulumi.Input<inputs.containerservice.v20191027preview.OpenShiftManagedClusterMasterPoolProfileArgs>;
    /**
     * Configures Log Analytics integration.
     */
    monitorProfile?: pulumi.Input<inputs.containerservice.v20191027preview.OpenShiftManagedClusterMonitorProfileArgs>;
    /**
     * Configuration for OpenShift networking.
     */
    networkProfile?: pulumi.Input<inputs.containerservice.v20191027preview.NetworkProfileArgs>;
    /**
     * Version of OpenShift specified when creating the cluster.
     */
     ...
     * Define the resource plan as required by ARM for billing purposes
     */
    plan?: pulumi.Input<inputs.containerservice.v20191027preview.PurchasePlanArgs>;
    /**
     * Allows node rotation
     */
     ...
     * Configuration for OpenShift router(s).
     */
    routerProfiles?: pulumi.Input<pulumi.Input<inputs.containerservice.v20191027preview.OpenShiftRouterProfileArgs>[]>;
    /**
     * Resource tags
     */
