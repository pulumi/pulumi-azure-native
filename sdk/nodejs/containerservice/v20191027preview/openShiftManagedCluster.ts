...
export class OpenShiftManagedCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OpenShiftManagedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerservice/latest:OpenShiftManagedCluster" }, { type: "azurerm:containerservice/preview:OpenShiftManagedCluster" }, { type: "azurerm:containerservice/v20180930preview:OpenShiftManagedCluster" }, { type: "azurerm:containerservice/v20190430:OpenShiftManagedCluster" }, { type: "azurerm:containerservice/v20190930preview:OpenShiftManagedCluster" }] };
