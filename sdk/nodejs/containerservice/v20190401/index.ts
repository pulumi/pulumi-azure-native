...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:containerservice/v20190401:AgentPool":
                return new AgentPool(name, <any>undefined, { urn })
            case "azure-nextgen:containerservice/v20190401:ManagedCluster":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "containerservice/v20190401", _module)
