 ...
 *
 * @deprecated azure-native:containerservice/v20221002preview:PrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:PrivateEndpointConnection to guarantee forwards compatibility.
 */
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateEndpointConnection {
        pulumi.log.warn("PrivateEndpointConnection is deprecated: azure-native:containerservice/v20221002preview:PrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:PrivateEndpointConnection to guarantee forwards compatibility.")
        return new PrivateEndpointConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20221002preview:PrivateEndpointConnection';
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.containerservice.v20221002preview.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.containerservice.v20221002preview.PrivateLinkServiceConnectionStateResponse>;
    /**
...
export interface PrivateEndpointConnectionArgs {
     ...
     * The resource of private endpoint.
     */
    privateEndpoint?: pulumi.Input<inputs.containerservice.v20221002preview.PrivateEndpointArgs>;
    /**
     * The name of the private endpoint connection.
     */
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: pulumi.Input<inputs.containerservice.v20221002preview.PrivateLinkServiceConnectionStateArgs>;
    /**
