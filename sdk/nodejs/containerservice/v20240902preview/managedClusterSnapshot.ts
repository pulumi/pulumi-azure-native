...
export class ManagedClusterSnapshot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20240902preview:ManagedClusterSnapshot';
     ...
     */
    public readonly creationData!: pulumi.Output<outputs.containerservice.v20240902preview.CreationDataResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly managedClusterPropertiesReadOnly!: pulumi.Output<outputs.containerservice.v20240902preview.ManagedClusterPropertiesForSnapshotResponse>;
    /**
...
export interface ManagedClusterSnapshotArgs {
     ...
     * CreationData to be used to specify the source resource ID to create this snapshot.
     */
    creationData?: pulumi.Input<inputs.containerservice.v20240902preview.CreationDataArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The type of a snapshot. The default is NodePool.
     */
    snapshotType?: pulumi.Input<string | enums.containerservice.v20240902preview.SnapshotType>;
    /**
     * Resource tags.
     */
