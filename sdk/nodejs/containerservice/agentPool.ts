...
export class AgentPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerservice:AgentPool';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.containerservice.ManagedClusterAgentPoolProfilePropertiesResponse>;
    /**
     * Resource type
     */
...
export interface AgentPoolArgs {
     ...
     * Properties of an agent pool.
     */
    readonly properties?: pulumi.Input<inputs.containerservice.ManagedClusterAgentPoolProfileProperties>;
    /**
