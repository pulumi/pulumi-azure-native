 ...
 *
 * const managedCluster = new azurerm.containerservice.v20180331.ManagedCluster("managedCluster", {
 *     addonProfiles: {},
 *     agentPoolProfiles: [{
 *         count: 3,
 *         name: "nodepool1",
...
export class ManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerservice/v20180331:ManagedCluster';
