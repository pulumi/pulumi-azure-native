...
export class ManagedCluster extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.containerservice.v20180331.ManagedClusterPropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface ManagedClusterArgs {
     ...
     * Properties of a managed cluster.
     */
    readonly properties?: pulumi.Input<inputs.containerservice.v20180331.ManagedClusterProperties>;
    /**
