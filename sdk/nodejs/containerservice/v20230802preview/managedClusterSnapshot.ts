...
export class ManagedClusterSnapshot extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly managedClusterPropertiesReadOnly!: pulumi.Output<outputs.containerservice.v20230802preview.ManagedClusterPropertiesForSnapshotResponse>;
    /**
...
export interface ManagedClusterSnapshotArgs {
     ...
     * The type of a snapshot. The default is NodePool.
     */
    snapshotType?: pulumi.Input<string | enums.containerservice.v20230802preview.SnapshotType>;
    /**
     * Resource tags.
     */
