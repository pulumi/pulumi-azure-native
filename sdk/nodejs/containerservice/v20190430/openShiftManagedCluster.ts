...
export class OpenShiftManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20190430:OpenShiftManagedCluster';
    ...
    constructor(name: string, args: OpenShiftManagedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerservice/v20190430:OpenShiftManagedCluster" }, { type: "azure-native:containerservice:OpenShiftManagedCluster" }, { type: "azure-nextgen:containerservice:OpenShiftManagedCluster" }, { type: "azure-native:containerservice/v20180930preview:OpenShiftManagedCluster" }, { type: "azure-nextgen:containerservice/v20180930preview:OpenShiftManagedCluster" }, { type: "azure-native:containerservice/v20190930preview:OpenShiftManagedCluster" }, { type: "azure-nextgen:containerservice/v20190930preview:OpenShiftManagedCluster" }, { type: "azure-native:containerservice/v20191027preview:OpenShiftManagedCluster" }, { type: "azure-nextgen:containerservice/v20191027preview:OpenShiftManagedCluster" }] };
...
export interface OpenShiftManagedClusterArgs {
     ...
     * Configuration of OpenShift cluster VMs.
     */
    readonly agentPoolProfiles?: pulumi.Input<pulumi.Input<inputs.containerservice.v20190430.OpenShiftManagedClusterAgentPoolProfileArgs>[]>;
    /**
     * Configures OpenShift authentication.
     */
    readonly authProfile?: pulumi.Input<inputs.containerservice.v20190430.OpenShiftManagedClusterAuthProfileArgs>;
    /**
     * Resource location
     */
     ...
     * Configuration for OpenShift master VMs.
     */
    readonly masterPoolProfile?: pulumi.Input<inputs.containerservice.v20190430.OpenShiftManagedClusterMasterPoolProfileArgs>;
    /**
     * Configuration for OpenShift networking.
     */
    readonly networkProfile?: pulumi.Input<inputs.containerservice.v20190430.NetworkProfileArgs>;
    /**
     * Version of OpenShift specified when creating the cluster.
     */
     ...
     * Define the resource plan as required by ARM for billing purposes
     */
    readonly plan?: pulumi.Input<inputs.containerservice.v20190430.PurchasePlanArgs>;
    /**
     ...
     * Configuration for OpenShift router(s).
     */
    readonly routerProfiles?: pulumi.Input<pulumi.Input<inputs.containerservice.v20190430.OpenShiftRouterProfileArgs>[]>;
    /**
     * Resource tags
     */
