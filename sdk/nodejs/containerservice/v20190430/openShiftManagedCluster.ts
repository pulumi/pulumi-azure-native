...
export class OpenShiftManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerservice/v20190430:OpenShiftManagedCluster';
    ...
    constructor(name: string, args: OpenShiftManagedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerservice/latest:OpenShiftManagedCluster" }, { type: "azurerm:containerservice/preview:OpenShiftManagedCluster" }, { type: "azurerm:containerservice/v20180930preview:OpenShiftManagedCluster" }, { type: "azurerm:containerservice/v20190930preview:OpenShiftManagedCluster" }, { type: "azurerm:containerservice/v20191027preview:OpenShiftManagedCluster" }] };
