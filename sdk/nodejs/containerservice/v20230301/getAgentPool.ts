...
export function getAgentPool(args: GetAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20230301:getAgentPool", {
...
export interface GetAgentPoolResult {
     ...
     */
    readonly kubeletConfig?: outputs.containerservice.v20230301.KubeletConfigResponse;
    /**
     ...
     */
    readonly linuxOSConfig?: outputs.containerservice.v20230301.LinuxOSConfigResponse;
    /**
     ...
     */
    readonly upgradeSettings?: outputs.containerservice.v20230301.AgentPoolUpgradeSettingsResponse;
    /**
...
export function getAgentPoolOutput(args: GetAgentPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAgentPoolResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerservice/v20230301:getAgentPool", {
        "agentPoolName": args.agentPoolName,
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
