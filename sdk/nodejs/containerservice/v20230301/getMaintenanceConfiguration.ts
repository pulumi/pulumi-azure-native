...
export function getMaintenanceConfiguration(args: GetMaintenanceConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetMaintenanceConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20230301:getMaintenanceConfiguration", {
...
export interface GetMaintenanceConfigurationResult {
     ...
     */
    readonly notAllowedTime?: outputs.containerservice.v20230301.TimeSpanResponse[];
    /**
     * The system metadata relating to this resource.
     */
    readonly systemData: outputs.containerservice.v20230301.SystemDataResponse;
    /**
     * If two array entries specify the same day of the week, the applied configuration is the union of times in both entries.
     */
    readonly timeInWeek?: outputs.containerservice.v20230301.TimeInWeekResponse[];
    /**
     * Resource type
     */
...
export function getMaintenanceConfigurationOutput(args: GetMaintenanceConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaintenanceConfigurationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerservice/v20230301:getMaintenanceConfiguration", {
        "configName": args.configName,
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
