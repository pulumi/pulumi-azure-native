...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/latest:PrivateEndpointConnection';
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.containerservice.latest.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.containerservice.latest.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerservice/latest:PrivateEndpointConnection" }, { type: "azure-native:containerservice:PrivateEndpointConnection" }, { type: "azure-nextgen:containerservice:PrivateEndpointConnection" }, { type: "azure-native:containerservice/v20200601:PrivateEndpointConnection" }, { type: "azure-nextgen:containerservice/v20200601:PrivateEndpointConnection" }, { type: "azure-native:containerservice/v20200701:PrivateEndpointConnection" }, { type: "azure-nextgen:containerservice/v20200701:PrivateEndpointConnection" }, { type: "azure-native:containerservice/v20200901:PrivateEndpointConnection" }, { type: "azure-nextgen:containerservice/v20200901:PrivateEndpointConnection" }, { type: "azure-native:containerservice/v20201101:PrivateEndpointConnection" }, { type: "azure-nextgen:containerservice/v20201101:PrivateEndpointConnection" }, { type: "azure-native:containerservice/v20201201:PrivateEndpointConnection" }, { type: "azure-nextgen:containerservice/v20201201:PrivateEndpointConnection" }, { type: "azure-native:containerservice/v20210201:PrivateEndpointConnection" }, { type: "azure-nextgen:containerservice/v20210201:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * The resource of private endpoint.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.containerservice.latest.PrivateEndpoint>;
    /**
     * The name of the private endpoint connection.
     */
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Input<inputs.containerservice.latest.PrivateLinkServiceConnectionState>;
    /**
