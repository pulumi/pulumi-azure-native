...
export class ContainerService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerservice/latest:ContainerService';
    ...
    constructor(name: string, args: ContainerServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerservice/preview:ContainerService" }, { type: "azurerm:containerservice/v20151101preview:ContainerService" }, { type: "azurerm:containerservice/v20160330:ContainerService" }, { type: "azurerm:containerservice/v20160930:ContainerService" }, { type: "azurerm:containerservice/v20170131:ContainerService" }, { type: "azurerm:containerservice/v20170701:ContainerService" }] };
