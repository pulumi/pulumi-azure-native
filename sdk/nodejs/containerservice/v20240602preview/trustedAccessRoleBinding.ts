...
export class TrustedAccessRoleBinding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20240602preview:TrustedAccessRoleBinding';
