...
export function getLoadBalancer(args: GetLoadBalancerArgs, opts?: pulumi.InvokeOptions): Promise<GetLoadBalancerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20240602preview:getLoadBalancer", {
...
export interface GetLoadBalancerResult {
     ...
     */
    readonly nodeSelector?: outputs.containerservice.v20240602preview.LabelSelectorResponse;
    /**
     ...
     */
    readonly serviceLabelSelector?: outputs.containerservice.v20240602preview.LabelSelectorResponse;
    /**
     * Services created in namespaces that match the selector can be placed on this load balancer.
     */
    readonly serviceNamespaceSelector?: outputs.containerservice.v20240602preview.LabelSelectorResponse;
    /**
...
export function getLoadBalancerOutput(args: GetLoadBalancerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLoadBalancerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerservice/v20240602preview:getLoadBalancer", {
        "loadBalancerName": args.loadBalancerName,
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
