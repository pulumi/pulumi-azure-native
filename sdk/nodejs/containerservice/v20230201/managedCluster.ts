 ...
 *
 * const managedCluster = new azure_native.containerservice.v20230201.ManagedCluster("managedCluster", {
 *     addonProfiles: {},
 *     agentPoolProfiles: [{
 *         count: 3,
 *         creationData: {
 ...
 *     enableRBAC: true,
 *     identity: {
 *         type: azure_native.containerservice.v20230201.ResourceIdentityType.UserAssigned,
 ...
 *
 * ```sh
 * $ pulumi import azure-native:containerservice/v20230201:ManagedCluster clustername1 /subscriptions/subid1/resourcegroups/rg1/providers/Microsoft.ContainerService/managedClusters/clustername1 
 * ```
 */
