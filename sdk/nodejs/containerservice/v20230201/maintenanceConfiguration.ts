 ...
 *
 * const maintenanceConfiguration = new azure_native.containerservice.v20230201.MaintenanceConfiguration("maintenanceConfiguration", {
 *     configName: "default",
 *     notAllowedTime: [{
 ...
 *
 * ```sh
 * $ pulumi import azure-native:containerservice/v20230201:MaintenanceConfiguration default /subscriptions/subid1/resourcegroups/rg1/providers/Microsoft.ContainerService/managedClusters/clustername1/maintenanceConfigurations/default 
 * ```
 */
export class MaintenanceConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20230201:MaintenanceConfiguration';
     ...
     */
    public readonly notAllowedTime!: pulumi.Output<outputs.containerservice.v20230201.TimeSpanResponse[] | undefined>;
    /**
     ...
     */
    public readonly timeInWeek!: pulumi.Output<outputs.containerservice.v20230201.TimeInWeekResponse[] | undefined>;
    /**
     * Resource type
     */
...
export interface MaintenanceConfigurationArgs {
     ...
     * Time slots on which upgrade is not allowed.
     */
    notAllowedTime?: pulumi.Input<pulumi.Input<inputs.containerservice.v20230201.TimeSpanArgs>[]>;
    /**
     ...
     * If two array entries specify the same day of the week, the applied configuration is the union of times in both entries.
     */
    timeInWeek?: pulumi.Input<pulumi.Input<inputs.containerservice.v20230201.TimeInWeekArgs>[]>;
}
