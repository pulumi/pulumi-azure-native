...
export class LoadBalancer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20250102preview:LoadBalancer';
     ...
     */
    public readonly nodeSelector!: pulumi.Output<outputs.containerservice.v20250102preview.LabelSelectorResponse | undefined>;
    /**
     ...
     */
    public readonly serviceLabelSelector!: pulumi.Output<outputs.containerservice.v20250102preview.LabelSelectorResponse | undefined>;
    /**
     * Services created in namespaces that match the selector can be placed on this load balancer.
     */
    public readonly serviceNamespaceSelector!: pulumi.Output<outputs.containerservice.v20250102preview.LabelSelectorResponse | undefined>;
    /**
    ...
    constructor(name: string, args: LoadBalancerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice/v20240302preview:LoadBalancer" }, { type: "azure-native:containerservice/v20240402preview:LoadBalancer" }, { type: "azure-native:containerservice/v20240502preview:LoadBalancer" }, { type: "azure-native:containerservice/v20240602preview:LoadBalancer" }, { type: "azure-native:containerservice/v20240702preview:LoadBalancer" }, { type: "azure-native:containerservice/v20240902preview:LoadBalancer" }, { type: "azure-native:containerservice/v20241002preview:LoadBalancer" }, { type: "azure-native:containerservice:LoadBalancer" }] };
...
export interface LoadBalancerArgs {
     ...
     * Nodes that match this selector will be possible members of this load balancer.
     */
    nodeSelector?: pulumi.Input<inputs.containerservice.v20250102preview.LabelSelectorArgs>;
    /**
     * Required field. A string value that must specify the ID of an existing agent pool. All nodes in the given pool will always be added to this load balancer. This agent pool must have at least one node and minCount>=1 for autoscaling operations. An agent pool can only be the primary pool for a single load balancer.
     */
     ...
     * Only services that must match this selector can be placed on this load balancer.
     */
    serviceLabelSelector?: pulumi.Input<inputs.containerservice.v20250102preview.LabelSelectorArgs>;
    /**
     * Services created in namespaces that match the selector can be placed on this load balancer.
     */
    serviceNamespaceSelector?: pulumi.Input<inputs.containerservice.v20250102preview.LabelSelectorArgs>;
}
