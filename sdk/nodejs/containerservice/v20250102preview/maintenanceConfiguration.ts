...
export class MaintenanceConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20250102preview:MaintenanceConfiguration';
     ...
     */
    public readonly maintenanceWindow!: pulumi.Output<outputs.containerservice.v20250102preview.MaintenanceWindowResponse | undefined>;
    /**
     ...
     */
    public readonly notAllowedTime!: pulumi.Output<outputs.containerservice.v20250102preview.TimeSpanResponse[] | undefined>;
    /**
     ...
     */
    public readonly timeInWeek!: pulumi.Output<outputs.containerservice.v20250102preview.TimeInWeekResponse[] | undefined>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: MaintenanceConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["maintenanceWindow"] = args ? (args.maintenanceWindow ? pulumi.output(args.maintenanceWindow).apply(inputs.containerservice.v20250102preview.maintenanceWindowArgsProvideDefaults) : undefined) : undefined;
...
export interface MaintenanceConfigurationArgs {
     ...
     * Maintenance window for the maintenance configuration.
     */
    maintenanceWindow?: pulumi.Input<inputs.containerservice.v20250102preview.MaintenanceWindowArgs>;
    /**
     * Time slots on which upgrade is not allowed.
     */
    notAllowedTime?: pulumi.Input<pulumi.Input<inputs.containerservice.v20250102preview.TimeSpanArgs>[]>;
    /**
     ...
     * If two array entries specify the same day of the week, the applied configuration is the union of times in both entries.
     */
    timeInWeek?: pulumi.Input<pulumi.Input<inputs.containerservice.v20250102preview.TimeInWeekArgs>[]>;
}
