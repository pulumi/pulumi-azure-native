...
export class FleetUpdateStrategy extends pulumi.CustomResource {
     ...
     */
    public readonly strategy!: pulumi.Output<outputs.containerservice.v20240202preview.UpdateRunStrategyResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.containerservice.v20240202preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: FleetUpdateStrategyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice:FleetUpdateStrategy" }, { type: "azure-native:containerservice/v20230815preview:FleetUpdateStrategy" }, { type: "azure-native:containerservice/v20231015:FleetUpdateStrategy" }, { type: "azure-native:containerservice/v20240401:FleetUpdateStrategy" }, { type: "azure-native:containerservice/v20240502preview:FleetUpdateStrategy" }] };
...
export interface FleetUpdateStrategyArgs {
     ...
     * Defines the update sequence of the clusters.
     */
    strategy: pulumi.Input<inputs.containerservice.v20240202preview.UpdateRunStrategyArgs>;
    /**
