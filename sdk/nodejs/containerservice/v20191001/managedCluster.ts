 ...
 *
 * const managedCluster = new azurerm.containerservice.v20191001.ManagedCluster("managedCluster", {
 *     addonProfiles: {},
 *     agentPoolProfiles: [{
 *         availabilityZones: [
 *             "1",
...
export class ManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerservice/v20191001:ManagedCluster';
