...
export class ManagedNamespace extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedNamespaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice/v20250302preview:ManagedNamespace" }, { type: "azure-native:containerservice/v20250402preview:ManagedNamespace" }] };
