 ...
 * Agent Pool.
 *
 * @deprecated azure-native:containerservice/v20220101:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20220402preview:AgentPool to guarantee forwards compatibility.
 */
export class AgentPool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AgentPool {
        pulumi.log.warn("AgentPool is deprecated: azure-native:containerservice/v20220101:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20220402preview:AgentPool to guarantee forwards compatibility.")
