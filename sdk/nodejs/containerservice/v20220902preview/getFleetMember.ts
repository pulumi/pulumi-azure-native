...
export function getFleetMember(args: GetFleetMemberArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetMemberResult> {
    pulumi.log.warn("getFleetMember is deprecated: azure-native:containerservice/v20220902preview:FleetMember is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230315preview:FleetMember to guarantee forwards compatibility.")
