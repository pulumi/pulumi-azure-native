...
export class FleetMember extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FleetMember {
        pulumi.log.warn("FleetMember is deprecated: azure-native:containerservice/v20220902preview:FleetMember is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230315preview:FleetMember to guarantee forwards compatibility.")
