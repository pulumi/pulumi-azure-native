...
export class UpdateRun extends pulumi.CustomResource {
     ...
     */
    public readonly managedClusterUpdate!: pulumi.Output<outputs.containerservice.v20230615preview.ManagedClusterUpdateResponse>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.containerservice.v20230615preview.UpdateRunStatusResponse>;
    /**
     * The strategy defines the order in which the clusters will be updated. 
     * If not set, all members will be updated sequentially. The UpdateRun status will show a single UpdateStage and a single UpdateGroup targeting all members.
     * The strategy of the UpdateRun can be modified until the run is started.
     */
    public readonly strategy!: pulumi.Output<outputs.containerservice.v20230615preview.UpdateRunStrategyResponse | undefined>;
    /**
...
export interface UpdateRunArgs {
     ...
     * The update to be applied to all clusters in the UpdateRun. The managedClusterUpdate can be modified until the run is started.
     */
    managedClusterUpdate: pulumi.Input<inputs.containerservice.v20230615preview.ManagedClusterUpdateArgs>;
    /**
     ...
     * The strategy of the UpdateRun can be modified until the run is started.
     */
    strategy?: pulumi.Input<inputs.containerservice.v20230615preview.UpdateRunStrategyArgs>;
    /**
