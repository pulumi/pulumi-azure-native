...
export class FleetMember extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FleetMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice/v20220902preview:FleetMember" }, { type: "azure-native:containerservice/v20230315preview:FleetMember" }] };
