...
export class FleetUpdateStrategy extends pulumi.CustomResource {
     ...
     */
    declare public readonly strategy: pulumi.Output<outputs.containerservice.UpdateRunStrategyResponse>;
    /**
