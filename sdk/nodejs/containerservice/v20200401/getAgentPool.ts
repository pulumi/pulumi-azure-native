...
export function getAgentPool(args: GetAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:containerservice/v20200401:getAgentPool", {
...
export interface GetAgentPoolResult {
     ...
     */
    readonly upgradeSettings?: outputs.containerservice.v20200401.AgentPoolUpgradeSettingsInvokeResponse;
    /**
     * Size of agent VMs.
     */
