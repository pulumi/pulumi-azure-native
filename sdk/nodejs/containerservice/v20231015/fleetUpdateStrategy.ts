...
export class FleetUpdateStrategy extends pulumi.CustomResource {
     ...
     */
    public readonly strategy!: pulumi.Output<outputs.containerservice.v20231015.UpdateRunStrategyResponse>;
    /**
    ...
    constructor(name: string, args: FleetUpdateStrategyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice:FleetUpdateStrategy" }, { type: "azure-native:containerservice/v20230815preview:FleetUpdateStrategy" }, { type: "azure-native:containerservice/v20240202preview:FleetUpdateStrategy" }, { type: "azure-native:containerservice/v20240401:FleetUpdateStrategy" }] };
