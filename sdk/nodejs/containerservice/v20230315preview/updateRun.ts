...
export class UpdateRun extends pulumi.CustomResource {
     ...
     */
    public readonly managedClusterUpdate!: pulumi.Output<outputs.containerservice.v20230315preview.ManagedClusterUpdateResponse>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.containerservice.v20230315preview.UpdateRunStatusResponse>;
    /**
     * The strategy defines the order in which the clusters will be updated.
     * If not set, all members will be updated sequentially. The UpdateRun status will show a single UpdateStage and a single UpdateGroup targeting all members.
     * The strategy of the UpdateRun can be modified until the run is started.
     */
    public readonly strategy!: pulumi.Output<outputs.containerservice.v20230315preview.UpdateRunStrategyResponse | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.containerservice.v20230315preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: UpdateRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice/v20230615preview:UpdateRun" }, { type: "azure-native:containerservice/v20230815preview:UpdateRun" }, { type: "azure-native:containerservice/v20231015:UpdateRun" }, { type: "azure-native:containerservice/v20240202preview:UpdateRun" }, { type: "azure-native:containerservice/v20240401:UpdateRun" }, { type: "azure-native:containerservice/v20240502preview:UpdateRun" }, { type: "azure-native:containerservice:UpdateRun" }] };
...
export interface UpdateRunArgs {
     ...
     * The update to be applied to all clusters in the UpdateRun. The managedClusterUpdate can be modified until the run is started.
     */
    managedClusterUpdate: pulumi.Input<inputs.containerservice.v20230315preview.ManagedClusterUpdateArgs>;
    /**
     ...
     * The strategy of the UpdateRun can be modified until the run is started.
     */
    strategy?: pulumi.Input<inputs.containerservice.v20230315preview.UpdateRunStrategyArgs>;
    /**
