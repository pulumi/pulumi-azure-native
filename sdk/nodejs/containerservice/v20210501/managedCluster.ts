 ...
 *
 * const managedCluster = new azure_native.containerservice.v20210501.ManagedCluster("managedCluster", {
 *     addonProfiles: {
 ...
 *     enableRBAC: true,
 *     identity: {
 *         type: azure_native.containerservice.v20210501.ResourceIdentityType.UserAssigned,
