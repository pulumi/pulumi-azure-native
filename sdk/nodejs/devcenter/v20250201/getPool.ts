...
export function getPool(args: GetPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20250201:getPool", {
...
export interface GetPoolResult {
     ...
     */
    readonly devBoxDefinition?: outputs.devcenter.v20250201.PoolDevBoxDefinitionResponse;
    /**
     ...
     */
    readonly devBoxDefinitionType?: string;
    /**
     ...
     */
    readonly healthStatusDetails: outputs.devcenter.v20250201.HealthStatusDetailResponse[];
    /**
     ...
     */
    readonly stopOnDisconnect?: outputs.devcenter.v20250201.StopOnDisconnectConfigurationResponse;
    /**
     * Stop on no connect configuration settings for Dev Boxes created in this pool.
     */
    readonly stopOnNoConnect?: outputs.devcenter.v20250201.StopOnNoConnectConfigurationResponse;
    /**
...
export function getPoolOutput(args: GetPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPoolResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20250201:getPool", {
        "poolName": args.poolName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
