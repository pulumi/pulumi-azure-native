...
export class ProjectPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20250201:ProjectPolicy';
     ...
     */
    public readonly resourcePolicies!: pulumi.Output<outputs.devcenter.v20250201.ResourcePolicyResponse[] | undefined>;
    /**
...
export interface ProjectPolicyArgs {
     ...
     * Resource policies that are a part of this project policy.
     */
    resourcePolicies?: pulumi.Input<pulumi.Input<inputs.devcenter.v20250201.ResourcePolicyArgs>[]>;
    /**
     * Resources that have access to the shared resources that are a part of this project policy.
     */
