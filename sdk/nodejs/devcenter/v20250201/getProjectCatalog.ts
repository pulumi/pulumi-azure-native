...
export function getProjectCatalog(args: GetProjectCatalogArgs, opts?: pulumi.InvokeOptions): Promise<GetProjectCatalogResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20250201:getProjectCatalog", {
...
export interface GetProjectCatalogResult {
     ...
     */
    readonly adoGit?: outputs.devcenter.v20250201.GitCatalogResponse;
    /**
     ...
     */
    readonly gitHub?: outputs.devcenter.v20250201.GitCatalogResponse;
    /**
     ...
     */
    readonly lastSyncStats: outputs.devcenter.v20250201.SyncStatsResponse;
    /**
...
export function getProjectCatalogOutput(args: GetProjectCatalogOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProjectCatalogResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20250201:getProjectCatalog", {
        "catalogName": args.catalogName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
