...
export class AttachedNetworkByDevCenter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20240501preview:AttachedNetworkByDevCenter';
