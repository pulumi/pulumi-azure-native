...
export function getProjectEnvironmentType(args: GetProjectEnvironmentTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetProjectEnvironmentTypeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20240501preview:getProjectEnvironmentType", {
...
export interface GetProjectEnvironmentTypeResult {
     ...
     */
    readonly creatorRoleAssignment?: outputs.devcenter.v20240501preview.ProjectEnvironmentTypeUpdatePropertiesResponseCreatorRoleAssignment;
    /**
     ...
     */
    readonly userRoleAssignments?: {[key: string]: outputs.devcenter.v20240501preview.UserRoleAssignmentResponse};
}
/**
 * Gets a project environment type.
 */
export function getProjectEnvironmentTypeOutput(args: GetProjectEnvironmentTypeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProjectEnvironmentTypeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20240501preview:getProjectEnvironmentType", {
        "environmentTypeName": args.environmentTypeName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
