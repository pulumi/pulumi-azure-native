...
export function getPool(args: GetPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20240501preview:getPool", {
...
export interface GetPoolResult {
     ...
     */
    readonly healthStatusDetails: outputs.devcenter.v20240501preview.HealthStatusDetailResponse[];
    /**
     ...
     */
    readonly stopOnDisconnect?: outputs.devcenter.v20240501preview.StopOnDisconnectConfigurationResponse;
    /**
...
export function getPoolOutput(args: GetPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPoolResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20240501preview:getPool", {
        "poolName": args.poolName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
