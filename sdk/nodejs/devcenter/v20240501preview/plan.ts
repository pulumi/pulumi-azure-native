...
export class Plan extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:Plan" }, { type: "azure-native:devcenter/v20240601preview:Plan" }, { type: "azure-native:devcenter/v20240701preview:Plan" }, { type: "azure-native:devcenter/v20240801preview:Plan" }] };
