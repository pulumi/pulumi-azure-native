...
export interface GetDevCenterResult {
     ...
     */
    readonly encryption?: outputs.devcenter.v20230801preview.EncryptionResponse;
    /**
     ...
     */
    readonly identity?: outputs.devcenter.v20230801preview.ManagedServiceIdentityResponse;
    /**
...
export function getDevCenterOutput(args: GetDevCenterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDevCenterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20230801preview:getDevCenter", {
        "devCenterName": args.devCenterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
