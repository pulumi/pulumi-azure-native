...
export class ProjectCatalog extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ProjectCatalogArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter/v20240201:ProjectCatalog" }, { type: "azure-native:devcenter/v20240501preview:ProjectCatalog" }, { type: "azure-native:devcenter/v20240601preview:ProjectCatalog" }, { type: "azure-native:devcenter/v20240701preview:ProjectCatalog" }, { type: "azure-native:devcenter/v20240801preview:ProjectCatalog" }, { type: "azure-native:devcenter/v20241001preview:ProjectCatalog" }, { type: "azure-native_devcenter_v20240201:devcenter:ProjectCatalog" }, { type: "azure-native_devcenter_v20240501preview:devcenter:ProjectCatalog" }, { type: "azure-native_devcenter_v20240601preview:devcenter:ProjectCatalog" }, { type: "azure-native_devcenter_v20240701preview:devcenter:ProjectCatalog" }, { type: "azure-native_devcenter_v20240801preview:devcenter:ProjectCatalog" }, { type: "azure-native_devcenter_v20241001preview:devcenter:ProjectCatalog" }, { type: "azure-native_devcenter_v20250201:devcenter:ProjectCatalog" }] };
