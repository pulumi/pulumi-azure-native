 ...
 *
 * @deprecated azure-native:devcenter/v20220801preview:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:Pool to guarantee forwards compatibility.
 */
export class Pool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Pool {
        pulumi.log.warn("Pool is deprecated: azure-native:devcenter/v20220801preview:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:Pool to guarantee forwards compatibility.")
