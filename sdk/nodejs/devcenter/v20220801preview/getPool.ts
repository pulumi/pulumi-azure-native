...
export function getPool(args: GetPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetPoolResult> {
    pulumi.log.warn("getPool is deprecated: azure-native:devcenter/v20220801preview:Pool is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:Pool to guarantee forwards compatibility.")
