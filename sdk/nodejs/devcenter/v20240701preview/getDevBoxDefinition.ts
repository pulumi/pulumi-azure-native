...
export function getDevBoxDefinition(args: GetDevBoxDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetDevBoxDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20240701preview:getDevBoxDefinition", {
...
export interface GetDevBoxDefinitionResult {
     ...
     */
    readonly activeImageReference: outputs.devcenter.v20240701preview.ImageReferenceResponse;
    /**
     ...
     */
    readonly imageValidationErrorDetails: outputs.devcenter.v20240701preview.ImageValidationErrorDetailsResponse;
    /**
     ...
     */
    readonly sku: outputs.devcenter.v20240701preview.SkuResponse;
    /**
...
export function getDevBoxDefinitionOutput(args: GetDevBoxDefinitionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDevBoxDefinitionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20240701preview:getDevBoxDefinition", {
        "devBoxDefinitionName": args.devBoxDefinitionName,
        "devCenterName": args.devCenterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
