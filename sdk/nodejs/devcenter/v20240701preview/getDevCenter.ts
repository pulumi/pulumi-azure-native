...
export function getDevCenter(args: GetDevCenterArgs, opts?: pulumi.InvokeOptions): Promise<GetDevCenterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20240701preview:getDevCenter", {
...
export interface GetDevCenterResult {
     ...
     */
    readonly devBoxProvisioningSettings?: outputs.devcenter.v20240701preview.DevBoxProvisioningSettingsResponse;
    /**
     ...
     */
    readonly encryption?: outputs.devcenter.v20240701preview.EncryptionResponse;
    /**
     ...
     */
    readonly networkSettings?: outputs.devcenter.v20240701preview.DevCenterNetworkSettingsResponse;
    /**
     ...
     */
    readonly projectCatalogSettings?: outputs.devcenter.v20240701preview.DevCenterProjectCatalogSettingsResponse;
    /**
...
export function getDevCenterOutput(args: GetDevCenterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDevCenterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20240701preview:getDevCenter", {
        "devCenterName": args.devCenterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
