...
export class DevBoxDefinition extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly activeImageReference!: pulumi.Output<outputs.devcenter.v20231001preview.ImageReferenceResponse>;
    /**
     ...
     */
    public readonly imageReference!: pulumi.Output<outputs.devcenter.v20231001preview.ImageReferenceResponse>;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    public /*out*/ readonly imageValidationErrorDetails!: pulumi.Output<outputs.devcenter.v20231001preview.ImageValidationErrorDetailsResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.devcenter.v20231001preview.SkuResponse>;
    /**
...
export interface DevBoxDefinitionArgs {
     ...
     * Indicates whether Dev Boxes created with this definition are capable of hibernation. Not all images are capable of supporting hibernation. To find out more see https://aka.ms/devbox/hibernate
     */
    hibernateSupport?: pulumi.Input<string | enums.devcenter.v20231001preview.HibernateSupport>;
    /**
     * Image reference information.
     */
    imageReference: pulumi.Input<inputs.devcenter.v20231001preview.ImageReferenceArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The SKU for Dev Boxes created using this definition.
     */
    sku: pulumi.Input<inputs.devcenter.v20231001preview.SkuArgs>;
    /**
     * Resource tags.
     */
