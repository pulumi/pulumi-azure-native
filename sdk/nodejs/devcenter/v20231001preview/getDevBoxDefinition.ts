...
export interface GetDevBoxDefinitionResult {
     ...
     */
    readonly activeImageReference: outputs.devcenter.v20231001preview.ImageReferenceResponse;
    /**
     ...
     */
    readonly imageReference: outputs.devcenter.v20231001preview.ImageReferenceResponse;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    readonly imageValidationErrorDetails: outputs.devcenter.v20231001preview.ImageValidationErrorDetailsResponse;
    /**
     ...
     */
    readonly sku: outputs.devcenter.v20231001preview.SkuResponse;
    /**
...
export function getDevBoxDefinitionOutput(args: GetDevBoxDefinitionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDevBoxDefinitionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20231001preview:getDevBoxDefinition", {
        "devBoxDefinitionName": args.devBoxDefinitionName,
        "devCenterName": args.devCenterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
