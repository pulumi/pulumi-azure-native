...
export interface GetCatalogResult {
     ...
     */
    readonly adoGit?: outputs.devcenter.v20231001preview.GitCatalogResponse;
    /**
     ...
     */
    readonly gitHub?: outputs.devcenter.v20231001preview.GitCatalogResponse;
    /**
     ...
     */
    readonly lastSyncStats: outputs.devcenter.v20231001preview.SyncStatsResponse;
    /**
...
export function getCatalogOutput(args: GetCatalogOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCatalogResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20231001preview:getCatalog", {
        "catalogName": args.catalogName,
        "devCenterName": args.devCenterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
