...
export class Pool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20231001preview:Pool';
     ...
     */
    public /*out*/ readonly healthStatusDetails!: pulumi.Output<outputs.devcenter.v20231001preview.HealthStatusDetailResponse[]>;
    /**
     ...
     */
    public readonly stopOnDisconnect!: pulumi.Output<outputs.devcenter.v20231001preview.StopOnDisconnectConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:Pool" }, { type: "azure-native:devcenter/v20220801preview:Pool" }, { type: "azure-native:devcenter/v20220901preview:Pool" }, { type: "azure-native:devcenter/v20221012preview:Pool" }, { type: "azure-native:devcenter/v20221111preview:Pool" }, { type: "azure-native:devcenter/v20230101preview:Pool" }, { type: "azure-native:devcenter/v20230401:Pool" }, { type: "azure-native:devcenter/v20230801preview:Pool" }, { type: "azure-native:devcenter/v20240201:Pool" }] };
...
export interface PoolArgs {
     ...
     * Specifies the license type indicating the caller has already acquired licenses for the Dev Boxes that will be created.
     */
    licenseType: pulumi.Input<string | enums.devcenter.v20231001preview.LicenseType>;
    /**
     * Indicates whether owners of Dev Boxes in this pool are added as local administrators on the Dev Box.
     */
    localAdministrator: pulumi.Input<string | enums.devcenter.v20231001preview.LocalAdminStatus>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Indicates whether Dev Boxes in this pool are created with single sign on enabled. The also requires that single sign on be enabled on the tenant.
     */
    singleSignOnStatus?: pulumi.Input<string | enums.devcenter.v20231001preview.SingleSignOnStatus>;
    /**
     * Stop on disconnect configuration settings for Dev Boxes created in this pool.
     */
    stopOnDisconnect?: pulumi.Input<inputs.devcenter.v20231001preview.StopOnDisconnectConfigurationArgs>;
    /**
     * Resource tags.
     */
     ...
     * Indicates whether the pool uses a Virtual Network managed by Microsoft or a customer provided network.
     */
    virtualNetworkType?: pulumi.Input<string | enums.devcenter.v20231001preview.VirtualNetworkType>;
}
