...
export function getPool(args: GetPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20231001preview:getPool", {
...
export interface GetPoolResult {
     ...
     */
    readonly healthStatusDetails: outputs.devcenter.v20231001preview.HealthStatusDetailResponse[];
    /**
     ...
     */
    readonly stopOnDisconnect?: outputs.devcenter.v20231001preview.StopOnDisconnectConfigurationResponse;
    /**
...
export function getPoolOutput(args: GetPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPoolResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20231001preview:getPool", {
        "poolName": args.poolName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
