...
export class CurationProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20241001preview:CurationProfile';
     ...
     */
    public readonly resourcePolicies!: pulumi.Output<outputs.devcenter.v20241001preview.ResourcePolicyResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: CurationProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter/v20240801preview:CurationProfile" }, { type: "azure-native:devcenter:CurationProfile" }] };
...
export interface CurationProfileArgs {
     ...
     * Resource policies that are a part of this curation profile.
     */
    resourcePolicies?: pulumi.Input<pulumi.Input<inputs.devcenter.v20241001preview.ResourcePolicyArgs>[]>;
    /**
     * Resources that have access to the shared resources that are a part of this curation profile.
     */
