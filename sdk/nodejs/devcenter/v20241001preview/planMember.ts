...
export class PlanMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20241001preview:PlanMember';
     ...
     */
    public /*out*/ readonly syncStatus!: pulumi.Output<outputs.devcenter.v20241001preview.PlanMemberSyncStatusResponse>;
    /**
    ...
    constructor(name: string, args: PlanMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:PlanMember" }, { type: "azure-native:devcenter/v20240501preview:PlanMember" }, { type: "azure-native:devcenter/v20240601preview:PlanMember" }, { type: "azure-native:devcenter/v20240701preview:PlanMember" }, { type: "azure-native:devcenter/v20240801preview:PlanMember" }] };
...
export interface PlanMemberArgs {
     ...
     * The type of the member (user, group)
     */
    memberType?: pulumi.Input<string | enums.devcenter.v20241001preview.PlanMemberType>;
    /**
