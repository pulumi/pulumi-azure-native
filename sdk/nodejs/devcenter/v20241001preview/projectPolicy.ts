...
export class ProjectPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20241001preview:ProjectPolicy';
    ...
    constructor(name: string, args: ProjectPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter/v20250201:ProjectPolicy" }, { type: "azure-native:devcenter:ProjectPolicy" }] };
