...
export function getPlanMember(args: GetPlanMemberArgs, opts?: pulumi.InvokeOptions): Promise<GetPlanMemberResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20241001preview:getPlanMember", {
...
export interface GetPlanMemberResult {
     ...
     */
    readonly syncStatus: outputs.devcenter.v20241001preview.PlanMemberSyncStatusResponse;
    /**
