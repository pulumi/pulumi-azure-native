...
export class Pool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20241001preview:Pool';
     ...
     */
    public readonly devBoxDefinition!: pulumi.Output<outputs.devcenter.v20241001preview.PoolDevBoxDefinitionResponse | undefined>;
    /**
     ...
     */
    public readonly devBoxDefinitionType!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly healthStatusDetails!: pulumi.Output<outputs.devcenter.v20241001preview.HealthStatusDetailResponse[]>;
    /**
     ...
     */
    public readonly stopOnDisconnect!: pulumi.Output<outputs.devcenter.v20241001preview.StopOnDisconnectConfigurationResponse | undefined>;
    /**
     * Stop on no connect configuration settings for Dev Boxes created in this pool.
     */
    public readonly stopOnNoConnect!: pulumi.Output<outputs.devcenter.v20241001preview.StopOnNoConnectConfigurationResponse | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.devcenter.v20241001preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: PoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["devBoxDefinition"] = args ? args.devBoxDefinition : undefined;
            resourceInputs["devBoxDefinitionName"] = args ? args.devBoxDefinitionName : undefined;
            resourceInputs["devBoxDefinitionType"] = args ? args.devBoxDefinitionType : undefined;
            ...
            resourceInputs["stopOnNoConnect"] = args ? args.stopOnNoConnect : undefined;
            ...
            resourceInputs["devBoxCount"] = undefined /*out*/;
            resourceInputs["devBoxDefinition"] = undefined /*out*/;
            resourceInputs["devBoxDefinitionName"] = undefined /*out*/;
            resourceInputs["devBoxDefinitionType"] = undefined /*out*/;
            ...
            resourceInputs["stopOnNoConnect"] = undefined /*out*/;
            resourceInputs["systemData"] = undefined /*out*/;
...
export interface PoolArgs {
     ...
     * A definition of the machines that are created from this Pool. Will be ignored if devBoxDefinitionType is Reference or not provided.
     */
    devBoxDefinition?: pulumi.Input<inputs.devcenter.v20241001preview.PoolDevBoxDefinitionArgs>;
    /**
     * Name of a Dev Box definition in parent Project of this Pool. Will be ignored if devBoxDefinitionType is Value.
     */
     ...
     * Indicates if the pool is created from an existing Dev Box Definition or if one is provided directly.
     */
    devBoxDefinitionType?: pulumi.Input<string | enums.devcenter.v20241001preview.PoolDevBoxDefinitionType>;
    /**
     * The display name of the pool.
     */
     ...
     * Specifies the license type indicating the caller has already acquired licenses for the Dev Boxes that will be created.
     */
    licenseType: pulumi.Input<string | enums.devcenter.v20241001preview.LicenseType>;
    /**
     * Indicates whether owners of Dev Boxes in this pool are added as local administrators on the Dev Box.
     */
    localAdministrator: pulumi.Input<string | enums.devcenter.v20241001preview.LocalAdminStatus>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Indicates whether Dev Boxes in this pool are created with single sign on enabled. The also requires that single sign on be enabled on the tenant.
     */
    singleSignOnStatus?: pulumi.Input<string | enums.devcenter.v20241001preview.SingleSignOnStatus>;
    /**
     * Stop on disconnect configuration settings for Dev Boxes created in this pool.
     */
    stopOnDisconnect?: pulumi.Input<inputs.devcenter.v20241001preview.StopOnDisconnectConfigurationArgs>;
    /**
     * Stop on no connect configuration settings for Dev Boxes created in this pool.
     */
    stopOnNoConnect?: pulumi.Input<inputs.devcenter.v20241001preview.StopOnNoConnectConfigurationArgs>;
    /**
     * Resource tags.
     */
     ...
     * Indicates whether the pool uses a Virtual Network managed by Microsoft or a customer provided network.
     */
    virtualNetworkType?: pulumi.Input<string | enums.devcenter.v20241001preview.VirtualNetworkType>;
}
