...
export class ProjectEnvironmentType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20241001preview:ProjectEnvironmentType';
     ...
     */
    public readonly creatorRoleAssignment!: pulumi.Output<outputs.devcenter.v20241001preview.ProjectEnvironmentTypeUpdatePropertiesResponseCreatorRoleAssignment | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.devcenter.v20241001preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly userRoleAssignments!: pulumi.Output<{[key: string]: outputs.devcenter.v20241001preview.UserRoleAssignmentResponse} | undefined>;
...
export interface ProjectEnvironmentTypeArgs {
     ...
     * The role definition assigned to the environment creator on backing resources.
     */
    creatorRoleAssignment?: pulumi.Input<inputs.devcenter.v20241001preview.ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignmentArgs>;
    /**
     * Id of a subscription that the environment type will be mapped to. The environment's resources will be deployed into this subscription.
     */
     ...
     * Managed identity properties
     */
    identity?: pulumi.Input<inputs.devcenter.v20241001preview.ManagedServiceIdentityArgs>;
    /**
     * The geo-location for the environment type
     */
     ...
     * Defines whether this Environment Type can be used in this Project.
     */
    status?: pulumi.Input<string | enums.devcenter.v20241001preview.EnvironmentTypeEnableStatus>;
    /**
     * Resource tags.
     */
     ...
     * Role Assignments created on environment backing resources. This is a mapping from a user object ID to an object of role definition IDs.
     */
    userRoleAssignments?: pulumi.Input<{[key: string]: pulumi.Input<inputs.devcenter.v20241001preview.UserRoleAssignmentArgs>}>;
}
