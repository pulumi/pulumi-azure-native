...
// Export enums:
export * from "../../types/enums/devcenter/v20241001preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:devcenter/v20241001preview:AttachedNetworkByDevCenter":
                return new AttachedNetworkByDevCenter(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:Catalog":
                return new Catalog(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:CurationProfile":
                return new CurationProfile(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:DevBoxDefinition":
                return new DevBoxDefinition(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:DevCenter":
                return new DevCenter(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:EncryptionSet":
                return new EncryptionSet(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:EnvironmentType":
                return new EnvironmentType(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:Gallery":
                return new Gallery(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:NetworkConnection":
                return new NetworkConnection(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:Plan":
                return new Plan(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:PlanMember":
                return new PlanMember(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:Pool":
                return new Pool(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:Project":
                return new Project(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:ProjectCatalog":
                return new ProjectCatalog(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:ProjectEnvironmentType":
                return new ProjectEnvironmentType(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:ProjectPolicy":
                return new ProjectPolicy(name, <any>undefined, { urn })
            case "azure-native:devcenter/v20241001preview:Schedule":
...
pulumi.runtime.registerResourceModule("azure-native", "devcenter/v20241001preview", _module)
