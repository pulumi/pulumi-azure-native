...
export function getDevBoxDefinition(args: GetDevBoxDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetDevBoxDefinitionResult> {
    pulumi.log.warn("getDevBoxDefinition is deprecated: azure-native:devcenter/v20220901preview:DevBoxDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:DevBoxDefinition to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:devcenter/v20220901preview:getDevBoxDefinition", {
...
export interface GetDevBoxDefinitionResult {
     ...
     */
    readonly activeImageReference: outputs.devcenter.v20220901preview.ImageReferenceResponse;
    /**
     ...
     */
    readonly imageReference: outputs.devcenter.v20220901preview.ImageReferenceResponse;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    readonly imageValidationErrorDetails: outputs.devcenter.v20220901preview.ImageValidationErrorDetailsResponse;
    /**
     ...
     */
    readonly sku: outputs.devcenter.v20220901preview.SkuResponse;
    /**
