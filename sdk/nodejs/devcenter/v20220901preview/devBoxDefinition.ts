...
export class DevBoxDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DevBoxDefinition {
        pulumi.log.warn("DevBoxDefinition is deprecated: azure-native:devcenter/v20220901preview:DevBoxDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:DevBoxDefinition to guarantee forwards compatibility.")
        return new DevBoxDefinition(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20220901preview:DevBoxDefinition';
     ...
     */
    public /*out*/ readonly activeImageReference!: pulumi.Output<outputs.devcenter.v20220901preview.ImageReferenceResponse>;
    /**
     * Image reference information.
     */
    public readonly imageReference!: pulumi.Output<outputs.devcenter.v20220901preview.ImageReferenceResponse>;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    public /*out*/ readonly imageValidationErrorDetails!: pulumi.Output<outputs.devcenter.v20220901preview.ImageValidationErrorDetailsResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.devcenter.v20220901preview.SkuResponse>;
    /**
    ...
    constructor(name: string, args: DevBoxDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:DevBoxDefinition" }, { type: "azure-native:devcenter/v20220801preview:DevBoxDefinition" }, { type: "azure-native:devcenter/v20221012preview:DevBoxDefinition" }, { type: "azure-native:devcenter/v20221111preview:DevBoxDefinition" }] };
...
export interface DevBoxDefinitionArgs {
     ...
     * Image reference information.
     */
    imageReference: pulumi.Input<inputs.devcenter.v20220901preview.ImageReferenceArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The SKU for Dev Boxes created using this definition.
     */
    sku: pulumi.Input<inputs.devcenter.v20220901preview.SkuArgs>;
    /**
     * Resource tags.
     */
