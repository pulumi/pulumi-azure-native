...
export function getGallery(args: GetGalleryArgs, opts?: pulumi.InvokeOptions): Promise<GetGalleryResult> {
    pulumi.log.warn("getGallery is deprecated: azure-native:devcenter/v20220901preview:Gallery is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:Gallery to guarantee forwards compatibility.")
