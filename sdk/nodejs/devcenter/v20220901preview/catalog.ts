 ...
 *
 * const catalog = new azure_native.devcenter.v20220901preview.Catalog("catalog", {
 *     adoGit: {
 *         branch: "main",
 *         path: "/templates",
...
export class Catalog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20220901preview:Catalog';
     ...
     */
    public readonly adoGit!: pulumi.Output<outputs.devcenter.v20220901preview.GitCatalogResponse | undefined>;
    /**
     * Properties for a GitHub catalog type.
     */
    public readonly gitHub!: pulumi.Output<outputs.devcenter.v20220901preview.GitCatalogResponse | undefined>;
    /**
    ...
    constructor(name: string, args: CatalogArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:Catalog" }, { type: "azure-native:devcenter/v20220801preview:Catalog" }, { type: "azure-native:devcenter/v20221012preview:Catalog" }, { type: "azure-native:devcenter/v20221111preview:Catalog" }, { type: "azure-native:devcenter/v20230101preview:Catalog" }] };
...
export interface CatalogArgs {
     ...
     * Properties for an Azure DevOps catalog type.
     */
    adoGit?: pulumi.Input<inputs.devcenter.v20220901preview.GitCatalogArgs>;
    /**
     ...
     * Properties for a GitHub catalog type.
     */
    gitHub?: pulumi.Input<inputs.devcenter.v20220901preview.GitCatalogArgs>;
    /**
