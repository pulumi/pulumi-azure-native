...
export class ProjectEnvironmentType extends pulumi.CustomResource {
     ...
     */
    public readonly creatorRoleAssignment!: pulumi.Output<outputs.devcenter.v20230401.ProjectEnvironmentTypeUpdatePropertiesResponseCreatorRoleAssignment | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.devcenter.v20230401.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly userRoleAssignments!: pulumi.Output<{[key: string]: outputs.devcenter.v20230401.UserRoleAssignmentResponse} | undefined>;
    ...
    constructor(name: string, args: ProjectEnvironmentTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:ProjectEnvironmentType" }, { type: "azure-native:devcenter/v20220901preview:ProjectEnvironmentType" }, { type: "azure-native:devcenter/v20221111preview:ProjectEnvironmentType" }, { type: "azure-native:devcenter/v20230101preview:ProjectEnvironmentType" }] };
...
export interface ProjectEnvironmentTypeArgs {
     ...
     * The role definition assigned to the environment creator on backing resources.
     */
    creatorRoleAssignment?: pulumi.Input<inputs.devcenter.v20230401.ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignmentArgs>;
    /**
     * Id of a subscription that the environment type will be mapped to. The environment's resources will be deployed into this subscription.
     */
     ...
     * Managed identity properties
     */
    identity?: pulumi.Input<inputs.devcenter.v20230401.ManagedServiceIdentityArgs>;
    /**
     * The geo-location for the environment type
     */
     ...
     * Defines whether this Environment Type can be used in this Project.
     */
    status?: pulumi.Input<string | enums.devcenter.v20230401.EnvironmentTypeEnableStatus>;
    /**
     * Resource tags.
     */
     ...
     * Role Assignments created on environment backing resources. This is a mapping from a user object ID to an object of role definition IDs.
     */
    userRoleAssignments?: pulumi.Input<{[key: string]: pulumi.Input<inputs.devcenter.v20230401.UserRoleAssignmentArgs>}>;
}
