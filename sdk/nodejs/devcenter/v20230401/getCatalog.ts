...
export function getCatalog(args: GetCatalogArgs, opts?: pulumi.InvokeOptions): Promise<GetCatalogResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20230401:getCatalog", {
...
export interface GetCatalogResult {
     ...
     */
    readonly adoGit?: outputs.devcenter.v20230401.GitCatalogResponse;
    /**
     * Properties for a GitHub catalog type.
     */
    readonly gitHub?: outputs.devcenter.v20230401.GitCatalogResponse;
    /**
...
export function getCatalogOutput(args: GetCatalogOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCatalogResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20230401:getCatalog", {
        "catalogName": args.catalogName,
        "devCenterName": args.devCenterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
