...
export class DevBoxDefinition extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly activeImageReference!: pulumi.Output<outputs.devcenter.v20230401.ImageReferenceResponse>;
    /**
     ...
     */
    public readonly imageReference!: pulumi.Output<outputs.devcenter.v20230401.ImageReferenceResponse>;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    public /*out*/ readonly imageValidationErrorDetails!: pulumi.Output<outputs.devcenter.v20230401.ImageValidationErrorDetailsResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.devcenter.v20230401.SkuResponse>;
    /**
    ...
    constructor(name: string, args: DevBoxDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:DevBoxDefinition" }, { type: "azure-native:devcenter/v20220901preview:DevBoxDefinition" }, { type: "azure-native:devcenter/v20221111preview:DevBoxDefinition" }, { type: "azure-native:devcenter/v20230101preview:DevBoxDefinition" }] };
