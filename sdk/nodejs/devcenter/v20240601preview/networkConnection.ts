...
export class NetworkConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20240601preview:NetworkConnection';
...
export interface NetworkConnectionArgs {
     ...
     * AAD Join type.
     */
    domainJoinType: pulumi.Input<string | enums.devcenter.v20240601preview.DomainJoinType>;
    /**
     * Active Directory domain name
     */
