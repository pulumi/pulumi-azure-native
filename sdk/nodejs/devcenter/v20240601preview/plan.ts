...
export class Plan extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:Plan" }, { type: "azure-native:devcenter/v20240501preview:Plan" }, { type: "azure-native:devcenter/v20240701preview:Plan" }] };
