...
export class Plan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20240601preview:Plan';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.devcenter.v20240601preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter/v20240501preview:Plan" }, { type: "azure-native:devcenter/v20240701preview:Plan" }, { type: "azure-native:devcenter/v20240801preview:Plan" }, { type: "azure-native:devcenter/v20241001preview:Plan" }, { type: "azure-native:devcenter:Plan" }] };
