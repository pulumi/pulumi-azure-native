...
export class Pool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20240601preview:Pool';
     ...
     */
    public readonly devBoxDefinition!: pulumi.Output<outputs.devcenter.v20240601preview.PoolDevBoxDefinitionResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly healthStatusDetails!: pulumi.Output<outputs.devcenter.v20240601preview.HealthStatusDetailResponse[]>;
    /**
     ...
     */
    public readonly stopOnDisconnect!: pulumi.Output<outputs.devcenter.v20240601preview.StopOnDisconnectConfigurationResponse | undefined>;
    /**
...
export interface PoolArgs {
     ...
     * A definition of the machines that are created from this Pool. Will be ignored if devBoxDefinitionType is Reference or not provided.
     */
    devBoxDefinition?: pulumi.Input<inputs.devcenter.v20240601preview.PoolDevBoxDefinitionArgs>;
    /**
     * Name of a Dev Box definition in parent Project of this Pool. Will be ignored if devBoxDefinitionType is Value.
     */
     ...
     * Indicates if the pool is created from an existing Dev Box Definition or if one is provided directly.
     */
    devBoxDefinitionType?: pulumi.Input<string | enums.devcenter.v20240601preview.PoolDevBoxDefinitionType>;
    /**
     * The display name of the pool.
     */
     ...
     * Specifies the license type indicating the caller has already acquired licenses for the Dev Boxes that will be created.
     */
    licenseType: pulumi.Input<string | enums.devcenter.v20240601preview.LicenseType>;
    /**
     * Indicates whether owners of Dev Boxes in this pool are added as local administrators on the Dev Box.
     */
    localAdministrator: pulumi.Input<string | enums.devcenter.v20240601preview.LocalAdminStatus>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Indicates whether Dev Boxes in this pool are created with single sign on enabled. The also requires that single sign on be enabled on the tenant.
     */
    singleSignOnStatus?: pulumi.Input<string | enums.devcenter.v20240601preview.SingleSignOnStatus>;
    /**
     * Stop on disconnect configuration settings for Dev Boxes created in this pool.
     */
    stopOnDisconnect?: pulumi.Input<inputs.devcenter.v20240601preview.StopOnDisconnectConfigurationArgs>;
    /**
     * Resource tags.
     */
     ...
     * Indicates whether the pool uses a Virtual Network managed by Microsoft or a customer provided network.
     */
    virtualNetworkType?: pulumi.Input<string | enums.devcenter.v20240601preview.VirtualNetworkType>;
}
