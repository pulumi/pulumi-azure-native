...
export function getProjectEnvironmentType(args: GetProjectEnvironmentTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetProjectEnvironmentTypeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20240601preview:getProjectEnvironmentType", {
...
export interface GetProjectEnvironmentTypeResult {
     ...
     */
    readonly creatorRoleAssignment?: outputs.devcenter.v20240601preview.ProjectEnvironmentTypeUpdatePropertiesResponseCreatorRoleAssignment;
    /**
     ...
     */
    readonly identity?: outputs.devcenter.v20240601preview.ManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly systemData: outputs.devcenter.v20240601preview.SystemDataResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly userRoleAssignments?: {[key: string]: outputs.devcenter.v20240601preview.UserRoleAssignmentResponse};
}
/**
 * Gets a project environment type.
 */
export function getProjectEnvironmentTypeOutput(args: GetProjectEnvironmentTypeOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetProjectEnvironmentTypeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20240601preview:getProjectEnvironmentType", {
        "environmentTypeName": args.environmentTypeName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
