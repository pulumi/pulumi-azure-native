...
export class DevCenter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20240601preview:DevCenter';
     ...
     */
    public readonly devBoxProvisioningSettings!: pulumi.Output<outputs.devcenter.v20240601preview.DevBoxProvisioningSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.devcenter.v20240601preview.EncryptionResponse | undefined>;
    /**
     ...
     */
    public readonly networkSettings!: pulumi.Output<outputs.devcenter.v20240601preview.DevCenterNetworkSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly projectCatalogSettings!: pulumi.Output<outputs.devcenter.v20240601preview.DevCenterProjectCatalogSettingsResponse | undefined>;
    /**
...
export interface DevCenterArgs {
     ...
     * Settings to be used in the provisioning of all Dev Boxes that belong to this dev center.
     */
    devBoxProvisioningSettings?: pulumi.Input<inputs.devcenter.v20240601preview.DevBoxProvisioningSettingsArgs>;
    /**
     ...
     * Encryption settings to be used for server-side encryption for proprietary content (such as catalogs, logs, customizations).
     */
    encryption?: pulumi.Input<inputs.devcenter.v20240601preview.EncryptionArgs>;
    /**
     * Managed identity properties
     */
     ...
     * Network settings that will be enforced on network resources associated with the Dev Center.
     */
    networkSettings?: pulumi.Input<inputs.devcenter.v20240601preview.DevCenterNetworkSettingsArgs>;
    /**
     * Resource Id of an associated Plan
     */
     ...
     * Dev Center settings to be used when associating a project with a catalog.
     */
    projectCatalogSettings?: pulumi.Input<inputs.devcenter.v20240601preview.DevCenterProjectCatalogSettingsArgs>;
    /**
