...
export class EncryptionSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20240601preview:EncryptionSet';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.devcenter.v20240601preview.ManagedServiceIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: EncryptionSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:EncryptionSet" }, { type: "azure-native:devcenter/v20240501preview:EncryptionSet" }, { type: "azure-native:devcenter/v20240701preview:EncryptionSet" }, { type: "azure-native:devcenter/v20240801preview:EncryptionSet" }, { type: "azure-native:devcenter/v20241001preview:EncryptionSet" }] };
...
export interface EncryptionSetArgs {
     ...
     * Devbox disk encryption enable or disable status. Indicates if Devbox disks encryption using DevCenter CMK is enabled or not.
     */
    devboxDisksEncryptionEnableStatus?: pulumi.Input<string | enums.devcenter.v20240601preview.DevboxDisksEncryptionEnableStatus>;
    /**
     ...
     * Managed identity properties
     */
    identity?: pulumi.Input<inputs.devcenter.v20240601preview.ManagedServiceIdentityArgs>;
    /**
     * Key encryption key Url, versioned or non-versioned. Ex: https://contosovault.vault.azure.net/keys/contosokek/562a4bb76b524a1493a6afe8e536ee78 or https://contosovault.vault.azure.net/keys/contosokek.
     */
