...
export function getDevBoxDefinition(args: GetDevBoxDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetDevBoxDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20240801preview:getDevBoxDefinition", {
...
export interface GetDevBoxDefinitionResult {
     ...
     */
    readonly activeImageReference: outputs.devcenter.v20240801preview.ImageReferenceResponse;
    /**
     ...
     */
    readonly imageReference: outputs.devcenter.v20240801preview.ImageReferenceResponse;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    readonly imageValidationErrorDetails: outputs.devcenter.v20240801preview.ImageValidationErrorDetailsResponse;
    /**
     ...
     */
    readonly sku: outputs.devcenter.v20240801preview.SkuResponse;
    /**
