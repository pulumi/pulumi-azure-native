...
export class EncryptionSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20240801preview:EncryptionSet';
    ...
    constructor(name: string, args: EncryptionSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:EncryptionSet" }, { type: "azure-native:devcenter/v20240501preview:EncryptionSet" }, { type: "azure-native:devcenter/v20240601preview:EncryptionSet" }, { type: "azure-native:devcenter/v20240701preview:EncryptionSet" }] };
...
export interface EncryptionSetArgs {
     ...
     * Devbox disk encryption enable or disable status. Indicates if Devbox disks encryption using DevCenter CMK is enabled or not.
     */
    devboxDisksEncryptionEnableStatus?: pulumi.Input<string | enums.devcenter.v20240801preview.DevboxDisksEncryptionEnableStatus>;
    /**
