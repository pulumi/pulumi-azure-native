...
export class PlanMember extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PlanMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter/v20240501preview:PlanMember" }, { type: "azure-native:devcenter/v20240601preview:PlanMember" }, { type: "azure-native:devcenter/v20240701preview:PlanMember" }, { type: "azure-native:devcenter/v20241001preview:PlanMember" }, { type: "azure-native:devcenter:PlanMember" }] };
