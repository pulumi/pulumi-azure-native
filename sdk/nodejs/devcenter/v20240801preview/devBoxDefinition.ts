...
export class DevBoxDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20240801preview:DevBoxDefinition';
     ...
     */
    public /*out*/ readonly activeImageReference!: pulumi.Output<outputs.devcenter.v20240801preview.ImageReferenceResponse>;
    /**
     ...
     */
    public readonly imageReference!: pulumi.Output<outputs.devcenter.v20240801preview.ImageReferenceResponse>;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    public /*out*/ readonly imageValidationErrorDetails!: pulumi.Output<outputs.devcenter.v20240801preview.ImageValidationErrorDetailsResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.devcenter.v20240801preview.SkuResponse>;
    /**
...
export interface DevBoxDefinitionArgs {
     ...
     * Indicates whether Dev Boxes created with this definition are capable of hibernation. Not all images are capable of supporting hibernation. To find out more see https://aka.ms/devbox/hibernate
     */
    hibernateSupport?: pulumi.Input<string | enums.devcenter.v20240801preview.HibernateSupport>;
    /**
     * Image reference information.
     */
