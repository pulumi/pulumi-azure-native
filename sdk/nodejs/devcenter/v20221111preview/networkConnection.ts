 ...
 *
 * @deprecated azure-native:devcenter/v20221111preview:NetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:NetworkConnection to guarantee forwards compatibility.
 */
export class NetworkConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20221111preview:NetworkConnection';
    ...
    constructor(name: string, args: NetworkConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:NetworkConnection" }, { type: "azure-native:devcenter/v20220801preview:NetworkConnection" }, { type: "azure-native:devcenter/v20220901preview:NetworkConnection" }, { type: "azure-native:devcenter/v20221012preview:NetworkConnection" }] };
...
export interface NetworkConnectionArgs {
     ...
     * AAD Join type.
     */
    domainJoinType: pulumi.Input<string | enums.devcenter.v20221111preview.DomainJoinType>;
    /**
     * Active Directory domain name
     */
