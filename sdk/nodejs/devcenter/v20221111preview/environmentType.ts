...
export class EnvironmentType extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnvironmentType {
        pulumi.log.warn("EnvironmentType is deprecated: azure-native:devcenter/v20221111preview:EnvironmentType is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:EnvironmentType to guarantee forwards compatibility.")
        return new EnvironmentType(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20221111preview:EnvironmentType';
    ...
    constructor(name: string, args: EnvironmentTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:EnvironmentType" }, { type: "azure-native:devcenter/v20220801preview:EnvironmentType" }, { type: "azure-native:devcenter/v20220901preview:EnvironmentType" }, { type: "azure-native:devcenter/v20221012preview:EnvironmentType" }] };
