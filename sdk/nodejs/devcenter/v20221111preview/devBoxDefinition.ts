 ...
 *
 * const devBoxDefinition = new azure_native.devcenter.v20221111preview.DevBoxDefinition("devBoxDefinition", {
...
export class DevBoxDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DevBoxDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:DevBoxDefinition" }, { type: "azure-native:devcenter/v20220801preview:DevBoxDefinition" }, { type: "azure-native:devcenter/v20220901preview:DevBoxDefinition" }, { type: "azure-native:devcenter/v20221012preview:DevBoxDefinition" }, { type: "azure-native:devcenter/v20230101preview:DevBoxDefinition" }] };
