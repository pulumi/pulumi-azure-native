...
export class ProjectEnvironmentType extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProjectEnvironmentType {
        pulumi.log.warn("ProjectEnvironmentType is deprecated: azure-native:devcenter/v20221012preview:ProjectEnvironmentType is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:ProjectEnvironmentType to guarantee forwards compatibility.")
