...
export class DevBoxDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20221012preview:DevBoxDefinition';
     ...
     */
    public /*out*/ readonly activeImageReference!: pulumi.Output<outputs.devcenter.v20221012preview.ImageReferenceResponse>;
    /**
     * Image reference information.
     */
    public readonly imageReference!: pulumi.Output<outputs.devcenter.v20221012preview.ImageReferenceResponse>;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    public /*out*/ readonly imageValidationErrorDetails!: pulumi.Output<outputs.devcenter.v20221012preview.ImageValidationErrorDetailsResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.devcenter.v20221012preview.SkuResponse>;
    /**
    ...
    constructor(name: string, args: DevBoxDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:DevBoxDefinition" }, { type: "azure-native:devcenter/v20220801preview:DevBoxDefinition" }, { type: "azure-native:devcenter/v20220901preview:DevBoxDefinition" }, { type: "azure-native:devcenter/v20221111preview:DevBoxDefinition" }] };
...
export interface DevBoxDefinitionArgs {
     ...
     * Image reference information.
     */
    imageReference: pulumi.Input<inputs.devcenter.v20221012preview.ImageReferenceArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The SKU for Dev Boxes created using this definition.
     */
    sku: pulumi.Input<inputs.devcenter.v20221012preview.SkuArgs>;
    /**
     * Resource tags.
     */
