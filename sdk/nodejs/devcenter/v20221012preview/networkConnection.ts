...
export class NetworkConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkConnection {
        pulumi.log.warn("NetworkConnection is deprecated: azure-native:devcenter/v20221012preview:NetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:NetworkConnection to guarantee forwards compatibility.")
        return new NetworkConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20221012preview:NetworkConnection';
    ...
    constructor(name: string, args: NetworkConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:NetworkConnection" }, { type: "azure-native:devcenter/v20220801preview:NetworkConnection" }, { type: "azure-native:devcenter/v20220901preview:NetworkConnection" }, { type: "azure-native:devcenter/v20221111preview:NetworkConnection" }] };
...
export interface NetworkConnectionArgs {
     ...
     * AAD Join type.
     */
    domainJoinType: pulumi.Input<string | enums.devcenter.v20221012preview.DomainJoinType>;
    /**
     * Active Directory domain name
     */
