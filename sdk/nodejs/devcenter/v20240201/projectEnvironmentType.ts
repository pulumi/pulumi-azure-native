...
export class ProjectEnvironmentType extends pulumi.CustomResource {
     ...
     */
    public readonly creatorRoleAssignment!: pulumi.Output<outputs.devcenter.v20240201.ProjectEnvironmentTypeUpdatePropertiesResponseCreatorRoleAssignment | undefined>;
    /**
     ...
     */
    public readonly userRoleAssignments!: pulumi.Output<{[key: string]: outputs.devcenter.v20240201.UserRoleAssignmentResponse} | undefined>;
...
export interface ProjectEnvironmentTypeArgs {
     ...
     * Role Assignments created on environment backing resources. This is a mapping from a user object ID to an object of role definition IDs.
     */
    userRoleAssignments?: pulumi.Input<{[key: string]: pulumi.Input<inputs.devcenter.v20240201.UserRoleAssignmentArgs>}>;
}
