...
export interface GetDevCenterResult {
     ...
     */
    readonly encryption?: outputs.devcenter.v20240201.EncryptionResponse;
    /**
     ...
     */
    readonly identity?: outputs.devcenter.v20240201.ManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly projectCatalogSettings?: outputs.devcenter.v20240201.DevCenterProjectCatalogSettingsResponse;
    /**
...
export function getDevCenterOutput(args: GetDevCenterOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDevCenterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20240201:getDevCenter", {
        "devCenterName": args.devCenterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
