...
export function getDevBoxDefinition(args: GetDevBoxDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetDevBoxDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20230101preview:getDevBoxDefinition", {
...
export interface GetDevBoxDefinitionResult {
     ...
     */
    readonly activeImageReference: outputs.devcenter.v20230101preview.ImageReferenceResponse;
    /**
     ...
     */
    readonly imageReference: outputs.devcenter.v20230101preview.ImageReferenceResponse;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    readonly imageValidationErrorDetails: outputs.devcenter.v20230101preview.ImageValidationErrorDetailsResponse;
    /**
     ...
     */
    readonly sku: outputs.devcenter.v20230101preview.SkuResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.devcenter.v20230101preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getDevBoxDefinitionOutput(args: GetDevBoxDefinitionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDevBoxDefinitionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devcenter/v20230101preview:getDevBoxDefinition", {
        "devBoxDefinitionName": args.devBoxDefinitionName,
        "devCenterName": args.devCenterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
