...
export class NetworkConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20230101preview:NetworkConnection';
    ...
    constructor(name: string, args: NetworkConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:NetworkConnection" }, { type: "azure-native:devcenter/v20220901preview:NetworkConnection" }, { type: "azure-native:devcenter/v20221111preview:NetworkConnection" }, { type: "azure-native:devcenter/v20230401:NetworkConnection" }] };
...
export interface NetworkConnectionArgs {
     ...
     * AAD Join type.
     */
    domainJoinType: pulumi.Input<string | enums.devcenter.v20230101preview.DomainJoinType>;
    /**
     * Active Directory domain name
     */
