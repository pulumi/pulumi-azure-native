...
// Export enums:
export * from "../../types/enums/notificationhubs/v20230101preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:notificationhubs/v20230101preview:Namespace":
                return new Namespace(name, <any>undefined, { urn })
            case "azure-native:notificationhubs/v20230101preview:NamespaceAuthorizationRule":
                return new NamespaceAuthorizationRule(name, <any>undefined, { urn })
            case "azure-native:notificationhubs/v20230101preview:NotificationHub":
                return new NotificationHub(name, <any>undefined, { urn })
            case "azure-native:notificationhubs/v20230101preview:NotificationHubAuthorizationRule":
                return new NotificationHubAuthorizationRule(name, <any>undefined, { urn })
            case "azure-native:notificationhubs/v20230101preview:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "notificationhubs/v20230101preview", _module)
