...
export function listNamespaceKeys(args: ListNamespaceKeysArgs, opts?: pulumi.InvokeOptions): Promise<ListNamespaceKeysResult> {
    ...
    return pulumi.runtime.invoke("azurerm:notificationhubs/preview:listNamespaceKeys", {
...
export interface ListNamespaceKeysResult {
     ...
     */
    readonly value?: outputs.notificationhubs.preview.SharedAccessAuthorizationRuleResourceResponse[];
}
