...
export class NotificationHub extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: NotificationHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:notificationhubs/preview:NotificationHub" }, { type: "azurerm:notificationhubs/v20140901:NotificationHub" }, { type: "azurerm:notificationhubs/v20160301:NotificationHub" }, { type: "azurerm:notificationhubs/v20170401:NotificationHub" }] };
