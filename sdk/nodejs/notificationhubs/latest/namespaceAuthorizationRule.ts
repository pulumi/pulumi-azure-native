...
export class NamespaceAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:notificationhubs/latest:NamespaceAuthorizationRule';
    ...
    constructor(name: string, argsOrState?: NamespaceAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:notificationhubs/preview:NamespaceAuthorizationRule" }, { type: "azurerm:notificationhubs/v20160301:NamespaceAuthorizationRule" }, { type: "azurerm:notificationhubs/v20170401:NamespaceAuthorizationRule" }] };
