...
export class NamespaceAuthorizationRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NamespaceAuthorizationRule {
        pulumi.log.warn("NamespaceAuthorizationRule is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:notificationhubs:NamespaceAuthorizationRule'.")
        return new NamespaceAuthorizationRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:notificationhubs/latest:NamespaceAuthorizationRule';
     ...
     */
    public /*out*/ readonly sku!: pulumi.Output<outputs.notificationhubs.latest.SkuResponse | undefined>;
    /**
     * Resource tags
     */
...
export interface NamespaceAuthorizationRuleArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.notificationhubs.latest.SharedAccessAuthorizationRuleProperties>;
    /**
