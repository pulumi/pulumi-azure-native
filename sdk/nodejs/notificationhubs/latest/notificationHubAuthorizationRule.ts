...
export class NotificationHubAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:notificationhubs/latest:NotificationHubAuthorizationRule';
    ...
    constructor(name: string, args: NotificationHubAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:notificationhubs/preview:NotificationHubAuthorizationRule" }, { type: "azurerm:notificationhubs/v20160301:NotificationHubAuthorizationRule" }, { type: "azurerm:notificationhubs/v20170401:NotificationHubAuthorizationRule" }] };
