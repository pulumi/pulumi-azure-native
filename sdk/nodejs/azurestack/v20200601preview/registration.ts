...
export class Registration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:azurestack/v20200601preview:Registration';
    ...
    constructor(name: string, args: RegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:azurestack:Registration" }, { type: "azure-nextgen:azurestack/latest:Registration" }, { type: "azure-nextgen:azurestack/v20160101:Registration" }, { type: "azure-nextgen:azurestack/v20170601:Registration" }] };
