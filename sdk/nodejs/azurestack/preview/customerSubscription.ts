...
export class CustomerSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:azurestack/preview:CustomerSubscription';
    ...
    constructor(name: string, argsOrState?: CustomerSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:azurestack/latest:CustomerSubscription" }, { type: "azurerm:azurestack/v20170601:CustomerSubscription" }] };
