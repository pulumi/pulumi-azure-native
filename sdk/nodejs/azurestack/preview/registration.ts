...
export class Registration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:azurestack/preview:Registration';
    ...
    constructor(name: string, argsOrState?: RegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:azurestack/latest:Registration" }, { type: "azurerm:azurestack/v20170601:Registration" }] };
