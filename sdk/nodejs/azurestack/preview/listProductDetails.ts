...
export function listProductDetails(args: ListProductDetailsArgs, opts?: pulumi.InvokeOptions): Promise<ListProductDetailsResult> {
    ...
    return pulumi.runtime.invoke("azurerm:azurestack/preview:listProductDetails", {
...
export interface ListProductDetailsResult {
     ...
     */
    readonly dataDiskImages: outputs.azurestack.preview.DataDiskImageResponse[];
    /**
     ...
     */
    readonly osDiskImage: outputs.azurestack.preview.OsDiskImageResponse;
    /**
