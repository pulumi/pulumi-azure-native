...
export class ServiceConfiguration extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.hybridconnectivity.v20230315.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: ServiceConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridconnectivity/v20241201:ServiceConfiguration" }, { type: "azure-native:hybridconnectivity:ServiceConfiguration" }] };
