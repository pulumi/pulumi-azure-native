...
export class PublicCloudConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridconnectivity/v20241201:PublicCloudConnector';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.hybridconnectivity.v20241201.PublicCloudConnectorPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: PublicCloudConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.hybridconnectivity.v20241201.publicCloudConnectorPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridconnectivity:PublicCloudConnector" }] };
