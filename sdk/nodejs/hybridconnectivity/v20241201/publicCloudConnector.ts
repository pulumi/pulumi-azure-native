...
export class PublicCloudConnector extends pulumi.CustomResource {
     ...
     */
    public readonly awsCloudProfile!: pulumi.Output<outputs.hybridconnectivity.v20241201.AwsCloudProfileResponse>;
    /**
    ...
    constructor(name: string, args: PublicCloudConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["awsCloudProfile"] = args ? (args.awsCloudProfile ? pulumi.output(args.awsCloudProfile).apply(inputs.hybridconnectivity.v20241201.awsCloudProfileArgsProvideDefaults) : undefined) : undefined;
