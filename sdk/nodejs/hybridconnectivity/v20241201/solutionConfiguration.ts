...
export class SolutionConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridconnectivity/v20241201:SolutionConfiguration';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.hybridconnectivity.v20241201.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: SolutionConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridconnectivity:SolutionConfiguration" }] };
