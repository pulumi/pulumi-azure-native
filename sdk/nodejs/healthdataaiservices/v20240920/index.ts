...
// Export enums:
export * from "../../types/enums/healthdataaiservices/v20240920";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:healthdataaiservices/v20240920:DeidService":
                return new DeidService(name, <any>undefined, { urn })
            case "azure-native:healthdataaiservices/v20240920:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "healthdataaiservices/v20240920", _module)
