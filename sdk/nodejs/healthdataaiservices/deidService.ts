...
export class DeidService extends pulumi.CustomResource {
     ...
     */
    declare public readonly identity: pulumi.Output<outputs.healthdataaiservices.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.healthdataaiservices.DeidServicePropertiesResponse>;
    /**
