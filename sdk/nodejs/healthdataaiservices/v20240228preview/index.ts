...
// Export enums:
export * from "../../types/enums/healthdataaiservices/v20240228preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:healthdataaiservices/v20240228preview:DeidService":
                return new DeidService(name, <any>undefined, { urn })
            case "azure-native:healthdataaiservices/v20240228preview:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "healthdataaiservices/v20240228preview", _module)
