...
export class Secret extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SecretArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn:Secret" }, { type: "azure-native:cdn/latest:Secret" }, { type: "azure-nextgen:cdn/latest:Secret" }, { type: "azure-native:cdn/v20200901:Secret" }, { type: "azure-nextgen:cdn/v20200901:Secret" }] };
...
export interface SecretArgs {
     ...
     * object which contains secret parameters
     */
    readonly parameters?: pulumi.Input<inputs.cdn.CustomerCertificateParameters | inputs.cdn.ManagedCertificateParameters | inputs.cdn.UrlSigningKeyParameters>;
    /**
