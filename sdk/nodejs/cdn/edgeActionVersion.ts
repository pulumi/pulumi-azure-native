...
export class EdgeActionVersion extends pulumi.CustomResource {
     ...
     * The active state
     */
    declare public readonly isDefaultVersion: pulumi.Output<string>;
    /**
     * The last update time in UTC for package update
     */
    declare public /*out*/ readonly lastPackageUpdateTime: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, args: EdgeActionVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.isDefaultVersion === undefined && !opts.urn) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn/v20240722preview:EdgeActionVersion" }, { type: "azure-native:cdn/v20250901preview:EdgeActionVersion" }, { type: "azure-native:cdn/v20251201preview:EdgeActionVersion" }] };
