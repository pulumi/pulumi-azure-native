...
export class Origin extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cdn.v20191231.OriginPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface OriginArgs {
     ...
     * The JSON object that contains the properties of the origin.
     */
    readonly properties?: pulumi.Input<inputs.cdn.v20191231.OriginProperties>;
    /**
