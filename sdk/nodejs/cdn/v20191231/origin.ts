...
export class Origin extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: OriginArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cdn/latest:Origin" }, { type: "azurerm:cdn/preview:Origin" }, { type: "azurerm:cdn/v20150601:Origin" }, { type: "azurerm:cdn/v20160402:Origin" }, { type: "azurerm:cdn/v20200331:Origin" }, { type: "azurerm:cdn/v20200415:Origin" }] };
