 ...
 *
 * const originGroup = new azurerm.cdn.v20191231.OriginGroup("originGroup", {
...
export class OriginGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OriginGroup {
        return new OriginGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:cdn/v20191231:OriginGroup';
     ...
     */
    public readonly healthProbeSettings!: pulumi.Output<outputs.cdn.v20191231.HealthProbeParametersResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly origins!: pulumi.Output<outputs.cdn.v20191231.ResourceReferenceResponse[]>;
    /**
     ...
     */
    public readonly responseBasedOriginErrorDetectionSettings!: pulumi.Output<outputs.cdn.v20191231.ResponseBasedOriginErrorDetectionParametersResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: OriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface OriginGroupArgs {
     ...
     * Health probe settings to the origin that is used to determine the health of the origin.
     */
    readonly healthProbeSettings?: pulumi.Input<inputs.cdn.v20191231.HealthProbeParameters>;
    /**
     ...
     * The source of the content being delivered via CDN within given origin group.
     */
    readonly origins: pulumi.Input<pulumi.Input<inputs.cdn.v20191231.ResourceReference>[]>;
    /**
     ...
     * The JSON object that contains the properties to determine origin health using real requests/responses. This property is currently not supported.
     */
    readonly responseBasedOriginErrorDetectionSettings?: pulumi.Input<inputs.cdn.v20191231.ResponseBasedOriginErrorDetectionParameters>;
    /**
     * Time in minutes to shift the traffic to the endpoint gradually when an unhealthy endpoint comes healthy or a new endpoint is added. Default is 10 mins. This property is currently not supported.
     */
