...
export class OriginGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cdn.v20191231.OriginGroupPropertiesResponse>;
    /**
     * Resource type.
     */
...
export interface OriginGroupArgs {
     ...
     * The JSON object that contains the properties of the origin group.
     */
    readonly properties?: pulumi.Input<inputs.cdn.v20191231.OriginGroupProperties>;
    /**
