...
export class Endpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: EndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cdn/v20160402:Endpoint" }, { type: "azurerm:cdn/v20161002:Endpoint" }, { type: "azurerm:cdn/v20170402:Endpoint" }, { type: "azurerm:cdn/v20171012:Endpoint" }, { type: "azurerm:cdn/v20190415:Endpoint" }, { type: "azurerm:cdn/v20190615:Endpoint" }, { type: "azurerm:cdn/v20191231:Endpoint" }, { type: "azurerm:cdn/v20200331:Endpoint" }, { type: "azurerm:cdn/v20200415:Endpoint" }] };
