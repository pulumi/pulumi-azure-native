 ...
 *
 * @deprecated azure-native:cdn/v20210601:AFDCustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDCustomDomain to guarantee forwards compatibility.
 */
export class AFDCustomDomain extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AFDCustomDomain {
        pulumi.log.warn("AFDCustomDomain is deprecated: azure-native:cdn/v20210601:AFDCustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDCustomDomain to guarantee forwards compatibility.")
        return new AFDCustomDomain(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20210601:AFDCustomDomain';
     ...
     */
    public readonly azureDnsZone!: pulumi.Output<outputs.cdn.v20210601.ResourceReferenceResponse | undefined>;
     ...
     */
    public readonly preValidatedCustomDomainResourceId!: pulumi.Output<outputs.cdn.v20210601.ResourceReferenceResponse | undefined>;
    /**
     ...
     */
    public readonly tlsSettings!: pulumi.Output<outputs.cdn.v20210601.AFDDomainHttpsParametersResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly validationProperties!: pulumi.Output<outputs.cdn.v20210601.DomainValidationPropertiesResponse>;
    ...
    constructor(name: string, args: AFDCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:AFDCustomDomain" }, { type: "azure-native:cdn/v20200901:AFDCustomDomain" }, { type: "azure-native:cdn/v20220501preview:AFDCustomDomain" }, { type: "azure-native:cdn/v20221101preview:AFDCustomDomain" }] };
