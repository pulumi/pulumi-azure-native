...
export class AFDOrigin extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AFDOrigin {
        pulumi.log.warn("AFDOrigin is deprecated: azure-native:cdn/v20210601:AFDOrigin is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:AFDOrigin to guarantee forwards compatibility.")
