 ...
 */
/** @deprecated azure-native:cdn/v20210601:RuleSet is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:RuleSet to guarantee forwards compatibility. */
export function getRuleSet(args: GetRuleSetArgs, opts?: pulumi.InvokeOptions): Promise<GetRuleSetResult> {
    pulumi.log.warn("getRuleSet is deprecated: azure-native:cdn/v20210601:RuleSet is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:RuleSet to guarantee forwards compatibility.")
