...
export class AFDOriginGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AFDOriginGroup {
        pulumi.log.warn("AFDOriginGroup is deprecated: azure-native:cdn/v20210601:AFDOriginGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:AFDOriginGroup to guarantee forwards compatibility.")
        return new AFDOriginGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20210601:AFDOriginGroup';
     ...
     */
    public readonly healthProbeSettings!: pulumi.Output<outputs.cdn.v20210601.HealthProbeParametersResponse | undefined>;
    /**
     * Load balancing settings for a backend pool
     */
    public readonly loadBalancingSettings!: pulumi.Output<outputs.cdn.v20210601.LoadBalancingSettingsParametersResponse | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: AFDOriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:AFDOriginGroup" }, { type: "azure-native:cdn/v20200901:AFDOriginGroup" }, { type: "azure-native:cdn/v20220501preview:AFDOriginGroup" }, { type: "azure-native:cdn/v20221101preview:AFDOriginGroup" }] };
