...
export function getAFDEndpoint(args: GetAFDEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetAFDEndpointResult> {
    pulumi.log.warn("getAFDEndpoint is deprecated: azure-native:cdn/v20210601:AFDEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDEndpoint to guarantee forwards compatibility.")
