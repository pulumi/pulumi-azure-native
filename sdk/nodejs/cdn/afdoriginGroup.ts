...
export class AFDOriginGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:cdn:AFDOriginGroup';
    ...
    constructor(name: string, args: AFDOriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn/latest:AFDOriginGroup" }, { type: "azure-nextgen:cdn/v20200901:AFDOriginGroup" }] };
