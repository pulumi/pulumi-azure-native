...
export class AFDOriginGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AFDOriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn:AFDOriginGroup" }, { type: "azure-native:cdn/latest:AFDOriginGroup" }, { type: "azure-nextgen:cdn/latest:AFDOriginGroup" }, { type: "azure-native:cdn/v20200901:AFDOriginGroup" }, { type: "azure-nextgen:cdn/v20200901:AFDOriginGroup" }] };
...
export interface AFDOriginGroupArgs {
     ...
     * Load balancing settings for a backend pool
     */
    readonly loadBalancingSettings?: pulumi.Input<inputs.cdn.LoadBalancingSettingsParameters>;
    /**
     ...
     * The JSON object that contains the properties to determine origin health using real requests/responses. This property is currently not supported.
     */
    readonly responseBasedAfdOriginErrorDetectionSettings?: pulumi.Input<inputs.cdn.ResponseBasedOriginErrorDetectionParameters>;
    /**
     * Whether to allow session affinity on this host. Valid options are 'Enabled' or 'Disabled'
     */
