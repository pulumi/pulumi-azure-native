 ...
 *
 * const policy = new azurerm.cdn.v20190615.Policy("policy", {
 *     customRules: {
 *         rules: [{
 *             action: "Block",
...
export class Policy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cdn/latest:Policy" }, { type: "azurerm:cdn/v20190615preview:Policy" }, { type: "azurerm:cdn/v20200331:Policy" }, { type: "azurerm:cdn/v20200415:Policy" }] };
