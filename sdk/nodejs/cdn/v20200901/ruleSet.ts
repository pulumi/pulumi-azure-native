...
export class RuleSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RuleSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn/v20200901:RuleSet" }, { type: "azure-native:cdn:RuleSet" }, { type: "azure-nextgen:cdn:RuleSet" }, { type: "azure-native:cdn/latest:RuleSet" }, { type: "azure-nextgen:cdn/latest:RuleSet" }] };
