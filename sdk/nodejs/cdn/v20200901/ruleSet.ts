...
export class RuleSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RuleSet {
        pulumi.log.warn("RuleSet is deprecated: azure-native:cdn/v20200901:RuleSet is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:RuleSet to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: RuleSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:RuleSet" }, { type: "azure-native:cdn/v20210601:RuleSet" }, { type: "azure-native:cdn/v20220501preview:RuleSet" }, { type: "azure-native:cdn/v20221101preview:RuleSet" }] };
