 ...
 *
 * const afdCustomDomain = new azure_native.cdn.v20200901.AFDCustomDomain("afdCustomDomain", {
 *     azureDnsZone: {
 *         id: "",
 *     },
 ...
 *         minimumTlsVersion: azure_native.cdn.v20200901.AfdMinimumTlsVersion.TLS12,
 *     },
 * });
 *
 * ```
 ...
 *
 * ```sh
 * $ pulumi import azure-native:cdn/v20200901:AFDCustomDomain domain1 /subscriptions/subid/resourcegroups/RG/providers/Microsoft.Cdn/profiles/profile1/domains/domain1 
 * ```
 */
export class AFDCustomDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AFDCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:AFDCustomDomain" }, { type: "azure-native:cdn/v20210601:AFDCustomDomain" }, { type: "azure-native:cdn/v20220501preview:AFDCustomDomain" }, { type: "azure-native:cdn/v20221101preview:AFDCustomDomain" }] };
...
export interface AFDCustomDomainArgs {
     ...
     * Resource reference to the Azure DNS zone
     */
    azureDnsZone?: pulumi.Input<inputs.cdn.v20200901.ResourceReferenceArgs>;
    /**
     ...
     * The configuration specifying how to enable HTTPS for the domain - using AzureFrontDoor managed certificate or user's own certificate. If not specified, enabling ssl uses AzureFrontDoor managed certificate by default.
     */
    tlsSettings?: pulumi.Input<inputs.cdn.v20200901.AFDDomainHttpsParametersArgs>;
}
