...
export class AFDCustomDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AFDCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn/v20200901:AFDCustomDomain" }, { type: "azure-native:cdn:AFDCustomDomain" }, { type: "azure-nextgen:cdn:AFDCustomDomain" }, { type: "azure-native:cdn/latest:AFDCustomDomain" }, { type: "azure-nextgen:cdn/latest:AFDCustomDomain" }] };
