...
export class SecurityPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SecurityPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:SecurityPolicy" }, { type: "azure-nextgen:cdn:SecurityPolicy" }, { type: "azure-native:cdn/latest:SecurityPolicy" }, { type: "azure-nextgen:cdn/latest:SecurityPolicy" }] };
