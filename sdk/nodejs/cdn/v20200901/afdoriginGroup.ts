 ...
 *
 * const afdOriginGroup = new azure_native.cdn.v20200901.AFDOriginGroup("afdOriginGroup", {
 *     healthProbeSettings: {
 *         probeIntervalInSeconds: 10,
 *         probePath: "/path2",
 *         probeProtocol: azure_native.cdn.v20200901.ProbeProtocol.NotSet,
 *         probeRequestType: azure_native.cdn.v20200901.HealthProbeRequestType.NotSet,
 *     },
...
export class AFDOriginGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AFDOriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:AFDOriginGroup" }, { type: "azure-native:cdn/v20210601:AFDOriginGroup" }, { type: "azure-native:cdn/v20220501preview:AFDOriginGroup" }, { type: "azure-native:cdn/v20221101preview:AFDOriginGroup" }] };
