...
export function getOriginGroup(args: GetOriginGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetOriginGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:cdn/v20200901:getOriginGroup", {
...
export interface GetOriginGroupResult {
     ...
     */
    readonly origins: outputs.cdn.v20200901.ResourceReferenceInvokeResponse[];
    /**
     ...
     */
    readonly responseBasedOriginErrorDetectionSettings?: outputs.cdn.v20200901.ResponseBasedOriginErrorDetectionParametersInvokeResponse;
    /**
