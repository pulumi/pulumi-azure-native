...
export class AFDOrigin extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AFDOriginArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn/v20200901:AFDOrigin" }, { type: "azure-native:cdn:AFDOrigin" }, { type: "azure-nextgen:cdn:AFDOrigin" }, { type: "azure-native:cdn/latest:AFDOrigin" }, { type: "azure-nextgen:cdn/latest:AFDOrigin" }] };
