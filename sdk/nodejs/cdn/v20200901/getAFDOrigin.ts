...
export function getAFDOrigin(args: GetAFDOriginArgs, opts?: pulumi.InvokeOptions): Promise<GetAFDOriginResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:cdn/v20200901:getAFDOrigin", {
...
export interface GetAFDOriginResult {
     ...
     */
    readonly azureOrigin?: outputs.cdn.v20200901.ResourceReferenceInvokeResponse;
     ...
     */
    readonly sharedPrivateLinkResource?: outputs.cdn.v20200901.SharedPrivateLinkResourcePropertiesInvokeResponse[];
    /**
