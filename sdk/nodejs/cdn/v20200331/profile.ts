...
azure-native:cdn/v20200331:Profile is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20200901:Profile to guarantee forwards compatibility.
 */
export class Profile extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Profile {
        pulumi.log.warn("Profile is deprecated: Version 2020-03-31 will be removed in v2 of the provider.\nazure-native:cdn/v20200331:Profile is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20200901:Profile to guarantee forwards compatibility.")
