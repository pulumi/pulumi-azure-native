...
export class Origin extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OriginArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn/latest:Origin" }, { type: "azure-nextgen:cdn/v20150601:Origin" }, { type: "azure-nextgen:cdn/v20160402:Origin" }, { type: "azure-nextgen:cdn/v20191231:Origin" }, { type: "azure-nextgen:cdn/v20200415:Origin" }, { type: "azure-nextgen:cdn/v20200901:Origin" }] };
