 ...
 *
 * const originGroup = new azurerm.cdn.v20200331.OriginGroup("originGroup", {
...
export class OriginGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:cdn/v20200331:OriginGroup';
    ...
    constructor(name: string, args: OriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cdn/latest:OriginGroup" }, { type: "azurerm:cdn/v20191231:OriginGroup" }, { type: "azurerm:cdn/v20200415:OriginGroup" }] };
