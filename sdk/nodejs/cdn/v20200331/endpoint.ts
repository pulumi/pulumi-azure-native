...
export class Endpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20200331:Endpoint';
    ...
    constructor(name: string, args: EndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn/v20200331:Endpoint" }, { type: "azure-native:cdn:Endpoint" }, { type: "azure-nextgen:cdn:Endpoint" }, { type: "azure-native:cdn/latest:Endpoint" }, { type: "azure-nextgen:cdn/latest:Endpoint" }, { type: "azure-native:cdn/v20150601:Endpoint" }, { type: "azure-nextgen:cdn/v20150601:Endpoint" }, { type: "azure-native:cdn/v20160402:Endpoint" }, { type: "azure-nextgen:cdn/v20160402:Endpoint" }, { type: "azure-native:cdn/v20161002:Endpoint" }, { type: "azure-nextgen:cdn/v20161002:Endpoint" }, { type: "azure-native:cdn/v20170402:Endpoint" }, { type: "azure-nextgen:cdn/v20170402:Endpoint" }, { type: "azure-native:cdn/v20171012:Endpoint" }, { type: "azure-nextgen:cdn/v20171012:Endpoint" }, { type: "azure-native:cdn/v20190415:Endpoint" }, { type: "azure-nextgen:cdn/v20190415:Endpoint" }, { type: "azure-native:cdn/v20190615:Endpoint" }, { type: "azure-nextgen:cdn/v20190615:Endpoint" }, { type: "azure-native:cdn/v20190615preview:Endpoint" }, { type: "azure-nextgen:cdn/v20190615preview:Endpoint" }, { type: "azure-native:cdn/v20191231:Endpoint" }, { type: "azure-nextgen:cdn/v20191231:Endpoint" }, { type: "azure-native:cdn/v20200415:Endpoint" }, { type: "azure-nextgen:cdn/v20200415:Endpoint" }, { type: "azure-native:cdn/v20200901:Endpoint" }, { type: "azure-nextgen:cdn/v20200901:Endpoint" }] };
...
export interface EndpointArgs {
     ...
     * A reference to the origin group.
     */
    readonly defaultOriginGroup?: pulumi.Input<inputs.cdn.v20200331.ResourceReference>;
    /**
     * A policy that specifies the delivery rules to be used for an endpoint.
     */
     ...
     * List of rules defining the user's geo access within a CDN endpoint. Each geo filter defines an access rule to a specified path or content, e.g. block APAC for path /pictures/
     */
    readonly geoFilters?: pulumi.Input<pulumi.Input<inputs.cdn.v20200331.GeoFilter>[]>;
    /**
     * Indicates whether content compression is enabled on CDN. Default value is false. If compression is enabled, content will be served as compressed if user requests for a compressed version. Content won't be compressed on CDN when requested content is smaller than 1 byte or larger than 1 MB.
     */
     ...
     * The origin groups comprising of origins that are used for load balancing the traffic based on availability.
     */
    readonly originGroups?: pulumi.Input<pulumi.Input<inputs.cdn.v20200331.DeepCreatedOriginGroup>[]>;
    /**
     * The host header value sent to the origin with each request. This property at Endpoint is only allowed when endpoint uses single origin and can be overridden by the same property specified at origin.If you leave this blank, the request hostname determines this value. Azure CDN origins, such as Web Apps, Blob Storage, and Cloud Services require this host header value to match the origin hostname by default.
     */
     ...
     * The source of the content being delivered via CDN.
     */
    readonly origins: pulumi.Input<pulumi.Input<inputs.cdn.v20200331.DeepCreatedOrigin>[]>;
    /**
     * Path to a file hosted on the origin which helps accelerate delivery of the dynamic content and calculate the most optimal routes for the CDN. This is relative to the origin path. This property is only relevant when using a single origin.
     */
     ...
     * List of keys used to validate the signed URL hashes.
     */
    readonly urlSigningKeys?: pulumi.Input<pulumi.Input<inputs.cdn.v20200331.UrlSigningKey>[]>;
    /**
     * Defines the Web Application Firewall policy for the endpoint (if applicable)
     */
