 ...
 *
 * const route = new azure_native.cdn.v20221101preview.Route("route", {
 *     cacheConfiguration: {
 *         compressionSettings: {
...
export class Route extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RouteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:Route" }, { type: "azure-native:cdn/v20200901:Route" }, { type: "azure-native:cdn/v20210601:Route" }, { type: "azure-native:cdn/v20220501preview:Route" }] };
