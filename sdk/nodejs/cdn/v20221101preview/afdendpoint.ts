 ...
 *
 * const afdEndpoint = new azure_native.cdn.v20221101preview.AFDEndpoint("afdEndpoint", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:cdn/v20221101preview:AFDEndpoint endpoint1 /subscriptions/subid/resourcegroups/RG/providers/Microsoft.Cdn/profiles/profile1/afdendpoints/endpoint1 
 * ```
 */
export class AFDEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20221101preview:AFDEndpoint';
    ...
    constructor(name: string, args: AFDEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:AFDEndpoint" }, { type: "azure-native:cdn/v20200901:AFDEndpoint" }, { type: "azure-native:cdn/v20210601:AFDEndpoint" }, { type: "azure-native:cdn/v20220501preview:AFDEndpoint" }] };
...
export interface AFDEndpointArgs {
     ...
     * Indicates the endpoint name reuse scope. The default value is TenantReuse.
     */
    autoGeneratedDomainNameLabelScope?: pulumi.Input<string | enums.cdn.v20221101preview.AutoGeneratedDomainNameLabelScope>;
    /**
     * Whether to enable use of this rule. Permitted values are 'Enabled' or 'Disabled'
     */
