 ...
 *
 * const securityPolicy = new azure_native.cdn.v20221101preview.SecurityPolicy("securityPolicy", {
 *     parameters: {
 *         associations: [{
 *             domains: [
 *                 {
...
export class SecurityPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SecurityPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:SecurityPolicy" }, { type: "azure-native:cdn/v20200901:SecurityPolicy" }, { type: "azure-native:cdn/v20210601:SecurityPolicy" }, { type: "azure-native:cdn/v20220501preview:SecurityPolicy" }] };
