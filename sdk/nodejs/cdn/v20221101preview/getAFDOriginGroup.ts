...
export function getAFDOriginGroup(args: GetAFDOriginGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetAFDOriginGroupResult> {
    pulumi.log.warn("getAFDOriginGroup is deprecated: azure-native:cdn/v20221101preview:AFDOriginGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:AFDOriginGroup to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:cdn/v20221101preview:getAFDOriginGroup", {
...
export interface GetAFDOriginGroupResult {
     ...
     */
    readonly loadBalancingSettings?: outputs.cdn.v20221101preview.LoadBalancingSettingsParametersResponse;
    /**
     * Resource name.
     */
