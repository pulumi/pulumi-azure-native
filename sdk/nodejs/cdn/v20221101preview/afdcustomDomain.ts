 ...
 *
 * const afdCustomDomain = new azure_native.cdn.v20221101preview.AFDCustomDomain("afdCustomDomain", {
 *     azureDnsZone: {
 *         id: "",
 *     },
 ...
 *         minimumTlsVersion: azure_native.cdn.v20221101preview.AfdMinimumTlsVersion.TLS12,
 *     },
 * });
 *
 * ```
 ...
 *
 * ```sh
 * $ pulumi import azure-native:cdn/v20221101preview:AFDCustomDomain domain1 /subscriptions/subid/resourcegroups/RG/providers/Microsoft.Cdn/profiles/profile1/customdomains/domain1 
 * ```
 */
export class AFDCustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20221101preview:AFDCustomDomain';
     ...
     */
    public readonly azureDnsZone!: pulumi.Output<outputs.cdn.v20221101preview.ResourceReferenceResponse | undefined>;
     ...
     */
    public readonly preValidatedCustomDomainResourceId!: pulumi.Output<outputs.cdn.v20221101preview.ResourceReferenceResponse | undefined>;
    /**
     ...
     */
    public readonly tlsSettings!: pulumi.Output<outputs.cdn.v20221101preview.AFDDomainHttpsParametersResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly validationProperties!: pulumi.Output<outputs.cdn.v20221101preview.DomainValidationPropertiesResponse>;
    ...
    constructor(name: string, args: AFDCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:AFDCustomDomain" }, { type: "azure-native:cdn/v20200901:AFDCustomDomain" }, { type: "azure-native:cdn/v20210601:AFDCustomDomain" }, { type: "azure-native:cdn/v20220501preview:AFDCustomDomain" }] };
...
export interface AFDCustomDomainArgs {
     ...
     * Resource reference to the Azure DNS zone
     */
    azureDnsZone?: pulumi.Input<inputs.cdn.v20221101preview.ResourceReferenceArgs>;
    /**
     ...
     * Resource reference to the Azure resource where custom domain ownership was prevalidated
     */
    preValidatedCustomDomainResourceId?: pulumi.Input<inputs.cdn.v20221101preview.ResourceReferenceArgs>;
    /**
     ...
     * The configuration specifying how to enable HTTPS for the domain - using AzureFrontDoor managed certificate or user's own certificate. If not specified, enabling ssl uses AzureFrontDoor managed certificate by default.
     */
    tlsSettings?: pulumi.Input<inputs.cdn.v20221101preview.AFDDomainHttpsParametersArgs>;
}
