 ...
 *
 * const afdOrigin = new azure_native.cdn.v20221101preview.AFDOrigin("afdOrigin", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:cdn/v20221101preview:AFDOrigin origin1 /subscriptions/subid/resourcegroups/RG/providers/Microsoft.Cdn/profiles/profile1/origingroups/origingroup1/origins/origin1 
 * ```
 */
export class AFDOrigin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20221101preview:AFDOrigin';
     ...
     */
    public readonly azureOrigin!: pulumi.Output<outputs.cdn.v20221101preview.ResourceReferenceResponse | undefined>;
     ...
     */
    public readonly sharedPrivateLinkResource!: pulumi.Output<outputs.cdn.v20221101preview.SharedPrivateLinkResourcePropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AFDOriginArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:AFDOrigin" }, { type: "azure-native:cdn/v20200901:AFDOrigin" }, { type: "azure-native:cdn/v20210601:AFDOrigin" }, { type: "azure-native:cdn/v20220501preview:AFDOrigin" }] };
...
export interface AFDOriginArgs {
     ...
     * Resource reference to the Azure origin resource.
     */
    azureOrigin?: pulumi.Input<inputs.cdn.v20221101preview.ResourceReferenceArgs>;
    /**
     * Whether to enable health probes to be made against backends defined under backendPools. Health probes can only be disabled if there is a single enabled backend in single enabled backend pool.
     */
    enabledState?: pulumi.Input<string | enums.cdn.v20221101preview.EnabledState>;
    /**
     * Whether to enable certificate name check at origin level
     */
     ...
     * The properties of the private link resource for private origin.
     */
    sharedPrivateLinkResource?: pulumi.Input<inputs.cdn.v20221101preview.SharedPrivateLinkResourcePropertiesArgs>;
    /**
     * Weight of the origin in given origin group for load balancing. Must be between 1 and 1000
     */
