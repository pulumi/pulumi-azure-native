...
export interface GetAFDCustomDomainResult {
     ...
     */
    readonly azureDnsZone?: outputs.cdn.v20240201.ResourceReferenceResponse;
     ...
     */
    readonly preValidatedCustomDomainResourceId?: outputs.cdn.v20240201.ResourceReferenceResponse;
    /**
     ...
     */
    readonly tlsSettings?: outputs.cdn.v20240201.AFDDomainHttpsParametersResponse;
    /**
     * Resource type.
     */
     ...
     */
    readonly validationProperties: outputs.cdn.v20240201.DomainValidationPropertiesResponse;
}
/**
 * Gets an existing AzureFrontDoor domain with the specified domain name under the specified subscription, resource group and profile.
 */
export function getAFDCustomDomainOutput(args: GetAFDCustomDomainOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAFDCustomDomainResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cdn/v20240201:getAFDCustomDomain", {
        "customDomainName": args.customDomainName,
        "profileName": args.profileName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
