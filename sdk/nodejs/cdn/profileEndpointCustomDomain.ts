...
export class ProfileEndpointCustomDomain extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProfileEndpointCustomDomain {
        return new ProfileEndpointCustomDomain(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: ProfileEndpointCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
