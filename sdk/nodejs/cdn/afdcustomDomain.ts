...
export class AFDCustomDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AFDCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn:AFDCustomDomain" }, { type: "azure-native:cdn/latest:AFDCustomDomain" }, { type: "azure-nextgen:cdn/latest:AFDCustomDomain" }, { type: "azure-native:cdn/v20200901:AFDCustomDomain" }, { type: "azure-nextgen:cdn/v20200901:AFDCustomDomain" }] };
...
export interface AFDCustomDomainArgs {
     ...
     * Resource reference to the Azure DNS zone
     */
    readonly azureDnsZone?: pulumi.Input<inputs.cdn.ResourceReference>;
    /**
     ...
     * The configuration specifying how to enable HTTPS for the domain - using AzureFrontDoor managed certificate or user's own certificate. If not specified, enabling ssl uses AzureFrontDoor managed certificate by default.
     */
    readonly tlsSettings?: pulumi.Input<inputs.cdn.AFDDomainHttpsParameters>;
}
