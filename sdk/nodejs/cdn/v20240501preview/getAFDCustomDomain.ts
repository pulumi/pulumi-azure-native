...
export function getAFDCustomDomain(args: GetAFDCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetAFDCustomDomainResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cdn/v20240501preview:getAFDCustomDomain", {
...
export interface GetAFDCustomDomainResult {
     ...
     */
    readonly azureDnsZone?: outputs.cdn.v20240501preview.ResourceReferenceResponse;
     ...
     */
    readonly mtlsSettings?: outputs.cdn.v20240501preview.AFDDomainMtlsParametersResponse;
    /**
     * Resource name.
     */
     ...
     */
    readonly preValidatedCustomDomainResourceId?: outputs.cdn.v20240501preview.ResourceReferenceResponse;
    /**
     ...
     */
    readonly referencedRoutePaths: outputs.cdn.v20240501preview.AFDDomainReferencedRoutePathResponse[];
    /**
     ...
     */
    readonly tlsSettings?: outputs.cdn.v20240501preview.AFDDomainHttpsParametersResponse;
    /**
     * Resource type.
     */
     ...
     */
    readonly validationProperties: outputs.cdn.v20240501preview.DomainValidationPropertiesResponse;
}
/**
 * Gets an existing AzureFrontDoor domain with the specified domain name under the specified subscription, resource group and profile.
 */
export function getAFDCustomDomainOutput(args: GetAFDCustomDomainOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAFDCustomDomainResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cdn/v20240501preview:getAFDCustomDomain", {
        "customDomainName": args.customDomainName,
        "profileName": args.profileName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
