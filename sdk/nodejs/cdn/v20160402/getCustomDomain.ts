...
azure-native:cdn/v20160402:CustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20161002:CustomDomain to guarantee forwards compatibility. */
export function getCustomDomain(args: GetCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomDomainResult> {
    pulumi.log.warn("getCustomDomain is deprecated: Version 2016-04-02 will be removed in v2 of the provider.\nazure-native:cdn/v20160402:CustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20161002:CustomDomain to guarantee forwards compatibility.")
