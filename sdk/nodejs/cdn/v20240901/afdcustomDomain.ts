...
export class AFDCustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20240901:AFDCustomDomain';
     ...
     */
    public readonly azureDnsZone!: pulumi.Output<outputs.cdn.v20240901.ResourceReferenceResponse | undefined>;
     ...
     */
    public readonly preValidatedCustomDomainResourceId!: pulumi.Output<outputs.cdn.v20240901.ResourceReferenceResponse | undefined>;
    /**
     ...
     */
    public readonly tlsSettings!: pulumi.Output<outputs.cdn.v20240901.AFDDomainHttpsParametersResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly validationProperties!: pulumi.Output<outputs.cdn.v20240901.DomainValidationPropertiesResponse>;
    ...
    constructor(name: string, args: AFDCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn/v20200901:AFDCustomDomain" }, { type: "azure-native:cdn/v20210601:AFDCustomDomain" }, { type: "azure-native:cdn/v20220501preview:AFDCustomDomain" }, { type: "azure-native:cdn/v20221101preview:AFDCustomDomain" }, { type: "azure-native:cdn/v20230501:AFDCustomDomain" }, { type: "azure-native:cdn/v20230701preview:AFDCustomDomain" }, { type: "azure-native:cdn/v20240201:AFDCustomDomain" }, { type: "azure-native:cdn/v20240501preview:AFDCustomDomain" }, { type: "azure-native:cdn/v20240601preview:AFDCustomDomain" }, { type: "azure-native:cdn/v20250415:AFDCustomDomain" }, { type: "azure-native:cdn:AFDCustomDomain" }] };
...
export interface AFDCustomDomainArgs {
     ...
     * Resource reference to the Azure DNS zone
     */
    azureDnsZone?: pulumi.Input<inputs.cdn.v20240901.ResourceReferenceArgs>;
    /**
     ...
     * Resource reference to the Azure resource where custom domain ownership was prevalidated
     */
    preValidatedCustomDomainResourceId?: pulumi.Input<inputs.cdn.v20240901.ResourceReferenceArgs>;
    /**
     ...
     * The configuration specifying how to enable HTTPS for the domain - using AzureFrontDoor managed certificate or user's own certificate. If not specified, enabling ssl uses AzureFrontDoor managed certificate by default.
     */
    tlsSettings?: pulumi.Input<inputs.cdn.v20240901.AFDDomainHttpsParametersArgs>;
}
