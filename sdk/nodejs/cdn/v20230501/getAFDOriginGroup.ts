...
export interface GetAFDOriginGroupResult {
     ...
     */
    readonly healthProbeSettings?: outputs.cdn.v20230501.HealthProbeParametersResponse;
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly loadBalancingSettings?: outputs.cdn.v20230501.LoadBalancingSettingsParametersResponse;
    /**
     * Resource name.
     */
...
export function getAFDOriginGroupOutput(args: GetAFDOriginGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAFDOriginGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cdn/v20230501:getAFDOriginGroup", {
        "originGroupName": args.originGroupName,
        "profileName": args.profileName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
