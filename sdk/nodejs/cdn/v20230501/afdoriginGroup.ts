...
export class AFDOriginGroup extends pulumi.CustomResource {
     ...
     */
    public readonly healthProbeSettings!: pulumi.Output<outputs.cdn.v20230501.HealthProbeParametersResponse | undefined>;
    /**
     * Load balancing settings for a backend pool
     */
    public readonly loadBalancingSettings!: pulumi.Output<outputs.cdn.v20230501.LoadBalancingSettingsParametersResponse | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: AFDOriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn/v20200901:AFDOriginGroup" }, { type: "azure-native:cdn/v20210601:AFDOriginGroup" }, { type: "azure-native:cdn/v20220501preview:AFDOriginGroup" }, { type: "azure-native:cdn/v20221101preview:AFDOriginGroup" }, { type: "azure-native:cdn/v20230701preview:AFDOriginGroup" }, { type: "azure-native:cdn/v20240201:AFDOriginGroup" }, { type: "azure-native:cdn/v20240501preview:AFDOriginGroup" }, { type: "azure-native:cdn/v20240601preview:AFDOriginGroup" }, { type: "azure-native:cdn/v20240901:AFDOriginGroup" }, { type: "azure-native:cdn:AFDOriginGroup" }] };
...
export interface AFDOriginGroupArgs {
     ...
     * Health probe settings to the origin that is used to determine the health of the origin.
     */
    healthProbeSettings?: pulumi.Input<inputs.cdn.v20230501.HealthProbeParametersArgs>;
    /**
     * Load balancing settings for a backend pool
     */
    loadBalancingSettings?: pulumi.Input<inputs.cdn.v20230501.LoadBalancingSettingsParametersArgs>;
    /**
     ...
     * Whether to allow session affinity on this host. Valid options are 'Enabled' or 'Disabled'
     */
    sessionAffinityState?: pulumi.Input<string | enums.cdn.v20230501.EnabledState>;
    /**
     * Time in minutes to shift the traffic to the endpoint gradually when an unhealthy endpoint comes healthy or a new endpoint is added. Default is 10 mins. This property is currently not supported.
     */
