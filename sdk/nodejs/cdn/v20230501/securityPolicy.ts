...
export class SecurityPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.cdn.v20230501.SecurityPolicyWebApplicationFirewallParametersResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SecurityPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn/v20200901:SecurityPolicy" }, { type: "azure-native:cdn/v20210601:SecurityPolicy" }, { type: "azure-native:cdn/v20220501preview:SecurityPolicy" }, { type: "azure-native:cdn/v20221101preview:SecurityPolicy" }, { type: "azure-native:cdn/v20230701preview:SecurityPolicy" }, { type: "azure-native:cdn/v20240201:SecurityPolicy" }, { type: "azure-native:cdn/v20240501preview:SecurityPolicy" }, { type: "azure-native:cdn/v20240601preview:SecurityPolicy" }, { type: "azure-native:cdn/v20240901:SecurityPolicy" }, { type: "azure-native:cdn/v20250415:SecurityPolicy" }, { type: "azure-native:cdn:SecurityPolicy" }] };
...
export interface SecurityPolicyArgs {
     ...
     * object which contains security policy parameters
     */
    parameters?: pulumi.Input<inputs.cdn.v20230501.SecurityPolicyWebApplicationFirewallParametersArgs>;
    /**
