...
export function getProfile(args: GetProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetProfileResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cdn/v20230501:getProfile", {
...
export interface GetProfileResult {
     ...
     */
    readonly identity?: outputs.cdn.v20230501.ManagedServiceIdentityResponse;
    /**
...
export function getProfileOutput(args: GetProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProfileResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cdn/v20230501:getProfile", {
        "profileName": args.profileName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
