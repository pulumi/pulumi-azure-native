...
export class OriginGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:cdn/preview:OriginGroup';
     ...
     */
    public readonly healthProbeSettings!: pulumi.Output<outputs.cdn.preview.HealthProbeParametersResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly origins!: pulumi.Output<outputs.cdn.preview.ResourceReferenceResponse[]>;
    /**
     ...
     */
    public readonly responseBasedOriginErrorDetectionSettings!: pulumi.Output<outputs.cdn.preview.ResponseBasedOriginErrorDetectionParametersResponse | undefined>;
    /**
    ...
    constructor(name: string, args: OriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cdn/latest:OriginGroup" }, { type: "azurerm:cdn/v20191231:OriginGroup" }, { type: "azurerm:cdn/v20200331:OriginGroup" }, { type: "azurerm:cdn/v20200415:OriginGroup" }] };
...
export interface OriginGroupArgs {
     ...
     * Health probe settings to the origin that is used to determine the health of the origin.
     */
    readonly healthProbeSettings?: pulumi.Input<inputs.cdn.preview.HealthProbeParameters>;
    /**
     ...
     * The source of the content being delivered via CDN within given origin group.
     */
    readonly origins: pulumi.Input<pulumi.Input<inputs.cdn.preview.ResourceReference>[]>;
    /**
     ...
     * The JSON object that contains the properties to determine origin health using real requests/responses. This property is currently not supported.
     */
    readonly responseBasedOriginErrorDetectionSettings?: pulumi.Input<inputs.cdn.preview.ResponseBasedOriginErrorDetectionParameters>;
    /**
     * Time in minutes to shift the traffic to the endpoint gradually when an unhealthy endpoint comes healthy or a new endpoint is added. Default is 10 mins. This property is currently not supported.
     */
