...
export class TunnelPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20240601preview:TunnelPolicy';
     ...
     */
    public readonly domains!: pulumi.Output<outputs.cdn.v20240601preview.ActivatedResourceReferenceResponse[]>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly targetGroups!: pulumi.Output<outputs.cdn.v20240601preview.ResourceReferenceResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: TunnelPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:TunnelPolicy" }] };
