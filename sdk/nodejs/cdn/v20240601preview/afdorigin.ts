...
export class AFDOrigin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20240601preview:AFDOrigin';
     ...
     */
    public readonly azureOrigin!: pulumi.Output<outputs.cdn.v20240601preview.ResourceReferenceResponse | undefined>;
     ...
     */
    public readonly sharedPrivateLinkResource!: pulumi.Output<outputs.cdn.v20240601preview.SharedPrivateLinkResourcePropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AFDOriginArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn/v20200901:AFDOrigin" }, { type: "azure-native:cdn/v20210601:AFDOrigin" }, { type: "azure-native:cdn/v20220501preview:AFDOrigin" }, { type: "azure-native:cdn/v20221101preview:AFDOrigin" }, { type: "azure-native:cdn/v20230501:AFDOrigin" }, { type: "azure-native:cdn/v20230701preview:AFDOrigin" }, { type: "azure-native:cdn/v20240201:AFDOrigin" }, { type: "azure-native:cdn/v20240501preview:AFDOrigin" }, { type: "azure-native:cdn/v20240901:AFDOrigin" }, { type: "azure-native:cdn/v20250415:AFDOrigin" }, { type: "azure-native:cdn:AFDOrigin" }] };
...
export interface AFDOriginArgs {
     ...
     * Resource reference to the Azure origin resource.
     */
    azureOrigin?: pulumi.Input<inputs.cdn.v20240601preview.ResourceReferenceArgs>;
    /**
     * Whether to enable health probes to be made against backends defined under backendPools. Health probes can only be disabled if there is a single enabled backend in single enabled backend pool.
     */
     ...
     * The properties of the private link resource for private origin.
     */
    sharedPrivateLinkResource?: pulumi.Input<inputs.cdn.v20240601preview.SharedPrivateLinkResourcePropertiesArgs>;
    /**
     * Weight of the origin in given origin group for load balancing. Must be between 1 and 1000
     */
