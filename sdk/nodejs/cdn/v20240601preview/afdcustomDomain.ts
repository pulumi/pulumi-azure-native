...
export class AFDCustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20240601preview:AFDCustomDomain';
     ...
     */
    public readonly azureDnsZone!: pulumi.Output<outputs.cdn.v20240601preview.ResourceReferenceResponse | undefined>;
     ...
     */
    public readonly mtlsSettings!: pulumi.Output<outputs.cdn.v20240601preview.AFDDomainMtlsParametersResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly preValidatedCustomDomainResourceId!: pulumi.Output<outputs.cdn.v20240601preview.ResourceReferenceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly referencedRoutePaths!: pulumi.Output<outputs.cdn.v20240601preview.AFDDomainReferencedRoutePathResponse[]>;
    /**
     ...
     */
    public readonly tlsSettings!: pulumi.Output<outputs.cdn.v20240601preview.AFDDomainHttpsParametersResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly validationProperties!: pulumi.Output<outputs.cdn.v20240601preview.DomainValidationPropertiesResponse>;
    ...
    constructor(name: string, args: AFDCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn/v20200901:AFDCustomDomain" }, { type: "azure-native:cdn/v20210601:AFDCustomDomain" }, { type: "azure-native:cdn/v20220501preview:AFDCustomDomain" }, { type: "azure-native:cdn/v20221101preview:AFDCustomDomain" }, { type: "azure-native:cdn/v20230501:AFDCustomDomain" }, { type: "azure-native:cdn/v20230701preview:AFDCustomDomain" }, { type: "azure-native:cdn/v20240201:AFDCustomDomain" }, { type: "azure-native:cdn/v20240501preview:AFDCustomDomain" }, { type: "azure-native:cdn/v20240901:AFDCustomDomain" }, { type: "azure-native:cdn/v20250415:AFDCustomDomain" }, { type: "azure-native:cdn:AFDCustomDomain" }] };
...
export interface AFDCustomDomainArgs {
     ...
     * Resource reference to the Azure DNS zone
     */
    azureDnsZone?: pulumi.Input<inputs.cdn.v20240601preview.ResourceReferenceArgs>;
    /**
     ...
     * The configuration specifying how to enable mutual TLS for the domain, including specifying allowed FQDN and which server certificate(s) to use.
     */
    mtlsSettings?: pulumi.Input<inputs.cdn.v20240601preview.AFDDomainMtlsParametersArgs>;
    /**
     * Resource reference to the Azure resource where custom domain ownership was prevalidated
     */
    preValidatedCustomDomainResourceId?: pulumi.Input<inputs.cdn.v20240601preview.ResourceReferenceArgs>;
    /**
     ...
     * The configuration specifying how to enable HTTPS for the domain - using AzureFrontDoor managed certificate or user's own certificate. If not specified, enabling ssl uses AzureFrontDoor managed certificate by default.
     */
    tlsSettings?: pulumi.Input<inputs.cdn.v20240601preview.AFDDomainHttpsParametersArgs>;
}
