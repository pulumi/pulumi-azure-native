...
export class AFDTargetGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20240601preview:AFDTargetGroup';
     ...
     */
    public readonly targetEndpoints!: pulumi.Output<outputs.cdn.v20240601preview.TargetEndpointResponse[]>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: AFDTargetGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:AFDTargetGroup" }] };
...
export interface AFDTargetGroupArgs {
     ...
     * TargetEndpoint list referenced by this target group.
     */
    targetEndpoints: pulumi.Input<pulumi.Input<inputs.cdn.v20240601preview.TargetEndpointArgs>[]>;
    /**
