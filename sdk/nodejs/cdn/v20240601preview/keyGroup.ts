...
export class KeyGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20240601preview:KeyGroup';
     ...
     */
    public readonly keyReferences!: pulumi.Output<outputs.cdn.v20240601preview.ResourceReferenceResponse[] | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: KeyGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:KeyGroup" }, { type: "azure-native:cdn/v20230701preview:KeyGroup" }, { type: "azure-native:cdn/v20240501preview:KeyGroup" }] };
