...
export class AFDOriginGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20220501preview:AFDOriginGroup';
     ...
     */
    public readonly loadBalancingSettings!: pulumi.Output<outputs.cdn.v20220501preview.LoadBalancingSettingsParametersResponse | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: AFDOriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:AFDOriginGroup" }, { type: "azure-native:cdn/v20200901:AFDOriginGroup" }, { type: "azure-native:cdn/v20210601:AFDOriginGroup" }, { type: "azure-native:cdn/v20221101preview:AFDOriginGroup" }, { type: "azure-native:cdn/v20230501:AFDOriginGroup" }, { type: "azure-native:cdn/v20230701preview:AFDOriginGroup" }, { type: "azure-native:cdn/v20240201:AFDOriginGroup" }, { type: "azure-native:cdn/v20240501preview:AFDOriginGroup" }, { type: "azure-native:cdn/v20240601preview:AFDOriginGroup" }, { type: "azure-native:cdn/v20240901:AFDOriginGroup" }] };
...
export interface AFDOriginGroupArgs {
     ...
     * Load balancing settings for a backend pool
     */
    loadBalancingSettings?: pulumi.Input<inputs.cdn.v20220501preview.LoadBalancingSettingsParametersArgs>;
    /**
     ...
     * Whether to allow session affinity on this host. Valid options are 'Enabled' or 'Disabled'
     */
    sessionAffinityState?: pulumi.Input<string | enums.cdn.v20220501preview.EnabledState>;
    /**
     * Time in minutes to shift the traffic to the endpoint gradually when an unhealthy endpoint comes healthy or a new endpoint is added. Default is 10 mins. This property is currently not supported.
     */
