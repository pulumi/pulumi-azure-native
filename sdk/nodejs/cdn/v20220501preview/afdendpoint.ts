...
export class AFDEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AFDEndpoint {
        pulumi.log.warn("AFDEndpoint is deprecated: azure-native:cdn/v20220501preview:AFDEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDEndpoint to guarantee forwards compatibility.")
