...
export class AFDEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AFDEndpoint {
        pulumi.log.warn("AFDEndpoint is deprecated: azure-native:cdn/v20220501preview:AFDEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:AFDEndpoint to guarantee forwards compatibility.")
