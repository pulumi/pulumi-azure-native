...
export function getAFDEndpoint(args: GetAFDEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetAFDEndpointResult> {
    pulumi.log.warn("getAFDEndpoint is deprecated: azure-native:cdn/v20220501preview:AFDEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:AFDEndpoint to guarantee forwards compatibility.")
