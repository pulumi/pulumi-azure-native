 ...
 */
/** @deprecated azure-native:cdn/v20220501preview:AFDEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDEndpoint to guarantee forwards compatibility. */
export function getAFDEndpoint(args: GetAFDEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetAFDEndpointResult> {
    pulumi.log.warn("getAFDEndpoint is deprecated: azure-native:cdn/v20220501preview:AFDEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDEndpoint to guarantee forwards compatibility.")
