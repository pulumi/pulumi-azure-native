...
export function getSecurityPolicy(args: GetSecurityPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityPolicyResult> {
    pulumi.log.warn("getSecurityPolicy is deprecated: azure-native:cdn/v20220501preview:SecurityPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:SecurityPolicy to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:cdn/v20220501preview:getSecurityPolicy", {
...
export interface GetSecurityPolicyResult {
     ...
     */
    readonly parameters?: outputs.cdn.v20220501preview.SecurityPolicyWebApplicationFirewallParametersResponse;
    /**
