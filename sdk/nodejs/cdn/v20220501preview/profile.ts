...
export class Profile extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Profile {
        pulumi.log.warn("Profile is deprecated: azure-native:cdn/v20220501preview:Profile is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:Profile to guarantee forwards compatibility.")
