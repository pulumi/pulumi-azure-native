 ...
 *
 * @deprecated azure-native:cdn/v20220501preview:OriginGroup is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:OriginGroup to guarantee forwards compatibility.
 */
export class OriginGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OriginGroup {
        pulumi.log.warn("OriginGroup is deprecated: azure-native:cdn/v20220501preview:OriginGroup is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:OriginGroup to guarantee forwards compatibility.")
        return new OriginGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20220501preview:OriginGroup';
     ...
     */
    public readonly healthProbeSettings!: pulumi.Output<outputs.cdn.v20220501preview.HealthProbeParametersResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly origins!: pulumi.Output<outputs.cdn.v20220501preview.ResourceReferenceResponse[]>;
    /**
     ...
     */
    public readonly responseBasedOriginErrorDetectionSettings!: pulumi.Output<outputs.cdn.v20220501preview.ResponseBasedOriginErrorDetectionParametersResponse | undefined>;
    /**
    ...
    constructor(name: string, args: OriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:OriginGroup" }, { type: "azure-native:cdn/v20191231:OriginGroup" }, { type: "azure-native:cdn/v20200331:OriginGroup" }, { type: "azure-native:cdn/v20200415:OriginGroup" }, { type: "azure-native:cdn/v20200901:OriginGroup" }, { type: "azure-native:cdn/v20210601:OriginGroup" }, { type: "azure-native:cdn/v20221101preview:OriginGroup" }] };
...
export interface OriginGroupArgs {
     ...
     * Health probe settings to the origin that is used to determine the health of the origin.
     */
    healthProbeSettings?: pulumi.Input<inputs.cdn.v20220501preview.HealthProbeParametersArgs>;
    /**
     ...
     * The source of the content being delivered via CDN within given origin group.
     */
    origins: pulumi.Input<pulumi.Input<inputs.cdn.v20220501preview.ResourceReferenceArgs>[]>;
    /**
     ...
     * The JSON object that contains the properties to determine origin health using real requests/responses. This property is currently not supported.
     */
    responseBasedOriginErrorDetectionSettings?: pulumi.Input<inputs.cdn.v20220501preview.ResponseBasedOriginErrorDetectionParametersArgs>;
    /**
     * Time in minutes to shift the traffic to the endpoint gradually when an unhealthy endpoint comes healthy or a new endpoint is added. Default is 10 mins. This property is currently not supported.
     */
