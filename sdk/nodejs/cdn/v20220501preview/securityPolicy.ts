...
export class SecurityPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityPolicy {
        pulumi.log.warn("SecurityPolicy is deprecated: azure-native:cdn/v20220501preview:SecurityPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:SecurityPolicy to guarantee forwards compatibility.")
