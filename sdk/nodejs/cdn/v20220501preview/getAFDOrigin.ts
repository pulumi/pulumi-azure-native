...
export function getAFDOrigin(args: GetAFDOriginArgs, opts?: pulumi.InvokeOptions): Promise<GetAFDOriginResult> {
    pulumi.log.warn("getAFDOrigin is deprecated: azure-native:cdn/v20220501preview:AFDOrigin is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDOrigin to guarantee forwards compatibility.")
...
export interface GetAFDOriginResult {
     ...
     */
    readonly azureOrigin?: outputs.cdn.v20220501preview.ResourceReferenceResponse;
     ...
     */
    readonly sharedPrivateLinkResource?: outputs.cdn.v20220501preview.SharedPrivateLinkResourcePropertiesResponse;
    /**
