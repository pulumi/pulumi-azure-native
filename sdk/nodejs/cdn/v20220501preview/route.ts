...
export class Route extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20220501preview:Route';
     ...
     */
    public readonly cacheConfiguration!: pulumi.Output<outputs.cdn.v20220501preview.AfdRouteCacheConfigurationResponse | undefined>;
    /**
     * Domains referenced by this endpoint.
     */
    public readonly customDomains!: pulumi.Output<outputs.cdn.v20220501preview.ActivatedResourceReferenceResponse[] | undefined>;
     ...
     */
    public readonly originGroup!: pulumi.Output<outputs.cdn.v20220501preview.ResourceReferenceResponse>;
    /**
     ...
     */
    public readonly ruleSets!: pulumi.Output<outputs.cdn.v20220501preview.ResourceReferenceResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: RouteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:Route" }, { type: "azure-native:cdn/v20200901:Route" }, { type: "azure-native:cdn/v20210601:Route" }, { type: "azure-native:cdn/v20221101preview:Route" }, { type: "azure-native:cdn/v20230501:Route" }, { type: "azure-native:cdn/v20230701preview:Route" }, { type: "azure-native:cdn/v20240201:Route" }, { type: "azure-native:cdn/v20240501preview:Route" }, { type: "azure-native:cdn/v20240601preview:Route" }, { type: "azure-native:cdn/v20240901:Route" }] };
...
export interface RouteArgs {
     ...
     * The caching configuration for this route. To disable caching, do not provide a cacheConfiguration object.
     */
    cacheConfiguration?: pulumi.Input<inputs.cdn.v20220501preview.AfdRouteCacheConfigurationArgs>;
    /**
     * Domains referenced by this endpoint.
     */
    customDomains?: pulumi.Input<pulumi.Input<inputs.cdn.v20220501preview.ActivatedResourceReferenceArgs>[]>;
    /**
     * Whether to enable use of this rule. Permitted values are 'Enabled' or 'Disabled'
     */
     ...
     * Protocol this rule will use when forwarding traffic to backends.
     */
    forwardingProtocol?: pulumi.Input<string | enums.cdn.v20220501preview.ForwardingProtocol>;
    /**
     * Whether to automatically redirect HTTP traffic to HTTPS traffic. Note that this is a easy way to set up this rule and it will be the first rule that gets executed.
     */
    httpsRedirect?: pulumi.Input<string | enums.cdn.v20220501preview.HttpsRedirect>;
    /**
     * whether this route will be linked to the default endpoint domain.
     */
    linkToDefaultDomain?: pulumi.Input<string | enums.cdn.v20220501preview.LinkToDefaultDomain>;
    /**
     * A reference to the origin group.
     */
    originGroup: pulumi.Input<inputs.cdn.v20220501preview.ResourceReferenceArgs>;
    /**
     * A directory path on the origin that AzureFrontDoor can use to retrieve content from, e.g. contoso.cloudapp.net/originpath.
     */
     ...
     * rule sets referenced by this endpoint.
     */
    ruleSets?: pulumi.Input<pulumi.Input<inputs.cdn.v20220501preview.ResourceReferenceArgs>[]>;
    /**
     * List of supported protocols for this route.
     */
    supportedProtocols?: pulumi.Input<pulumi.Input<string | enums.cdn.v20220501preview.AFDEndpointProtocols>[]>;
}
