 ...
 *
 * @deprecated azure-native:cdn/v20220501preview:AFDOrigin is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDOrigin to guarantee forwards compatibility.
 */
export class AFDOrigin extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AFDOrigin {
        pulumi.log.warn("AFDOrigin is deprecated: azure-native:cdn/v20220501preview:AFDOrigin is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDOrigin to guarantee forwards compatibility.")
        return new AFDOrigin(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20220501preview:AFDOrigin';
     ...
     */
    public readonly azureOrigin!: pulumi.Output<outputs.cdn.v20220501preview.ResourceReferenceResponse | undefined>;
     ...
     */
    public readonly sharedPrivateLinkResource!: pulumi.Output<outputs.cdn.v20220501preview.SharedPrivateLinkResourcePropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AFDOriginArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:AFDOrigin" }, { type: "azure-native:cdn/v20200901:AFDOrigin" }, { type: "azure-native:cdn/v20210601:AFDOrigin" }, { type: "azure-native:cdn/v20221101preview:AFDOrigin" }] };
...
export interface AFDOriginArgs {
     ...
     * Resource reference to the Azure origin resource.
     */
    azureOrigin?: pulumi.Input<inputs.cdn.v20220501preview.ResourceReferenceArgs>;
    /**
     * Whether to enable health probes to be made against backends defined under backendPools. Health probes can only be disabled if there is a single enabled backend in single enabled backend pool.
     */
    enabledState?: pulumi.Input<string | enums.cdn.v20220501preview.EnabledState>;
    /**
     * Whether to enable certificate name check at origin level
     */
     ...
     * The properties of the private link resource for private origin.
     */
    sharedPrivateLinkResource?: pulumi.Input<inputs.cdn.v20220501preview.SharedPrivateLinkResourcePropertiesArgs>;
    /**
     * Weight of the origin in given origin group for load balancing. Must be between 1 and 1000
     */
