...
export function getRuleSet(args: GetRuleSetArgs, opts?: pulumi.InvokeOptions): Promise<GetRuleSetResult> {
    pulumi.log.warn("getRuleSet is deprecated: azure-native:cdn/v20220501preview:RuleSet is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:RuleSet to guarantee forwards compatibility.")
