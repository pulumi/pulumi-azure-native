...
export class Origin extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: OriginArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cdn/v20150601:Origin" }, { type: "azurerm:cdn/v20160402:Origin" }, { type: "azurerm:cdn/v20161002:Origin" }, { type: "azurerm:cdn/v20170402:Origin" }, { type: "azurerm:cdn/v20171012:Origin" }, { type: "azurerm:cdn/v20190415:Origin" }, { type: "azurerm:cdn/v20190615:Origin" }, { type: "azurerm:cdn/v20191231:Origin" }, { type: "azurerm:cdn/v20200331:Origin" }] };
