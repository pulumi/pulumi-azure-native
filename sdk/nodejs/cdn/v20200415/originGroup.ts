...
export class OriginGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn/latest:OriginGroup" }, { type: "azure-nextgen:cdn/v20191231:OriginGroup" }, { type: "azure-nextgen:cdn/v20200331:OriginGroup" }, { type: "azure-nextgen:cdn/v20200901:OriginGroup" }] };
