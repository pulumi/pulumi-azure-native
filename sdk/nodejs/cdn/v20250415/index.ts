...
// Export enums:
export * from "../../types/enums/cdn/v20250415";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cdn/v20250415:AFDCustomDomain":
                return new AFDCustomDomain(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:AFDEndpoint":
                return new AFDEndpoint(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:AFDOrigin":
                return new AFDOrigin(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:AFDOriginGroup":
                return new AFDOriginGroup(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:CustomDomain":
                return new CustomDomain(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:Endpoint":
                return new Endpoint(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:Origin":
                return new Origin(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:OriginGroup":
                return new OriginGroup(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:Policy":
                return new Policy(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:Profile":
                return new Profile(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:Route":
                return new Route(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:Rule":
                return new Rule(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:RuleSet":
                return new RuleSet(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:Secret":
                return new Secret(name, <any>undefined, { urn })
            case "azure-native:cdn/v20250415:SecurityPolicy":
...
pulumi.runtime.registerResourceModule("azure-native", "cdn/v20250415", _module)
