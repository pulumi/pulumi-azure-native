...
export class OriginGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20250415:OriginGroup';
     ...
     */
    public readonly healthProbeSettings!: pulumi.Output<outputs.cdn.v20250415.HealthProbeParametersResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly origins!: pulumi.Output<outputs.cdn.v20250415.ResourceReferenceResponse[]>;
    /**
     ...
     */
    public readonly responseBasedOriginErrorDetectionSettings!: pulumi.Output<outputs.cdn.v20250415.ResponseBasedOriginErrorDetectionParametersResponse | undefined>;
    /**
    ...
    constructor(name: string, args: OriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn/v20191231:OriginGroup" }, { type: "azure-native:cdn/v20200331:OriginGroup" }, { type: "azure-native:cdn/v20200415:OriginGroup" }, { type: "azure-native:cdn/v20200901:OriginGroup" }, { type: "azure-native:cdn/v20210601:OriginGroup" }, { type: "azure-native:cdn/v20220501preview:OriginGroup" }, { type: "azure-native:cdn/v20221101preview:OriginGroup" }, { type: "azure-native:cdn/v20230501:OriginGroup" }, { type: "azure-native:cdn/v20230701preview:OriginGroup" }, { type: "azure-native:cdn/v20240201:OriginGroup" }, { type: "azure-native:cdn/v20240501preview:OriginGroup" }, { type: "azure-native:cdn/v20240601preview:OriginGroup" }, { type: "azure-native:cdn/v20240901:OriginGroup" }, { type: "azure-native:cdn:OriginGroup" }] };
...
export interface OriginGroupArgs {
     ...
     * Health probe settings to the origin that is used to determine the health of the origin.
     */
    healthProbeSettings?: pulumi.Input<inputs.cdn.v20250415.HealthProbeParametersArgs>;
    /**
     ...
     * The source of the content being delivered via CDN within given origin group.
     */
    origins: pulumi.Input<pulumi.Input<inputs.cdn.v20250415.ResourceReferenceArgs>[]>;
    /**
     ...
     * The JSON object that contains the properties to determine origin health using real requests/responses. This property is currently not supported.
     */
    responseBasedOriginErrorDetectionSettings?: pulumi.Input<inputs.cdn.v20250415.ResponseBasedOriginErrorDetectionParametersArgs>;
    /**
     * Time in minutes to shift the traffic to the endpoint gradually when an unhealthy endpoint comes healthy or a new endpoint is added. Default is 10 mins. This property is currently not supported.
     */
