...
export class AFDOrigin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20250415:AFDOrigin';
     ...
     */
    public readonly azureOrigin!: pulumi.Output<outputs.cdn.v20250415.ResourceReferenceResponse | undefined>;
     ...
     */
    public readonly sharedPrivateLinkResource!: pulumi.Output<outputs.cdn.v20250415.SharedPrivateLinkResourcePropertiesResponse | undefined>;
    /**
...
export interface AFDOriginArgs {
     ...
     * Resource reference to the Azure origin resource.
     */
    azureOrigin?: pulumi.Input<inputs.cdn.v20250415.ResourceReferenceArgs>;
    /**
     * Whether to enable health probes to be made against backends defined under backendPools. Health probes can only be disabled if there is a single enabled backend in single enabled backend pool.
     */
    enabledState?: pulumi.Input<string | enums.cdn.v20250415.EnabledState>;
    /**
     * Whether to enable certificate name check at origin level
     */
     ...
     * The properties of the private link resource for private origin.
     */
    sharedPrivateLinkResource?: pulumi.Input<inputs.cdn.v20250415.SharedPrivateLinkResourcePropertiesArgs>;
    /**
     * Weight of the origin in given origin group for load balancing. Must be between 1 and 1000
     */
