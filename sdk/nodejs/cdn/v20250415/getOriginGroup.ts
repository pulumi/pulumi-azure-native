...
export function getOriginGroup(args: GetOriginGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetOriginGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cdn/v20250415:getOriginGroup", {
...
export interface GetOriginGroupResult {
     ...
     */
    readonly healthProbeSettings?: outputs.cdn.v20250415.HealthProbeParametersResponse;
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly origins: outputs.cdn.v20250415.ResourceReferenceResponse[];
    /**
     ...
     */
    readonly responseBasedOriginErrorDetectionSettings?: outputs.cdn.v20250415.ResponseBasedOriginErrorDetectionParametersResponse;
    /**
...
export function getOriginGroupOutput(args: GetOriginGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOriginGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cdn/v20250415:getOriginGroup", {
        "endpointName": args.endpointName,
        "originGroupName": args.originGroupName,
        "profileName": args.profileName,
        "resourceGroupName": args.resourceGroupName,
