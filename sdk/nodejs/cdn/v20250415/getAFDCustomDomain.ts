...
export function getAFDCustomDomain(args: GetAFDCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetAFDCustomDomainResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cdn/v20250415:getAFDCustomDomain", {
...
export interface GetAFDCustomDomainResult {
     ...
     */
    readonly azureDnsZone?: outputs.cdn.v20250415.ResourceReferenceResponse;
     ...
     */
    readonly preValidatedCustomDomainResourceId?: outputs.cdn.v20250415.ResourceReferenceResponse;
    /**
     ...
     */
    readonly tlsSettings?: outputs.cdn.v20250415.AFDDomainHttpsParametersResponse;
    /**
     * Resource type.
     */
     ...
     */
    readonly validationProperties: outputs.cdn.v20250415.DomainValidationPropertiesResponse;
}
/**
 * Gets an existing AzureFrontDoor domain with the specified domain name under the specified subscription, resource group and profile.
 */
export function getAFDCustomDomainOutput(args: GetAFDCustomDomainOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAFDCustomDomainResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cdn/v20250415:getAFDCustomDomain", {
        "customDomainName": args.customDomainName,
        "profileName": args.profileName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
