...
export function getCustomDomain(args: GetCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomDomainResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cdn/v20250415:getCustomDomain", {
...
export interface GetCustomDomainResult {
     ...
     */
    readonly customHttpsParameters?: outputs.cdn.v20250415.CdnManagedHttpsParametersResponse | outputs.cdn.v20250415.UserManagedHttpsParametersResponse;
    /**
...
export function getCustomDomainOutput(args: GetCustomDomainOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCustomDomainResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cdn/v20250415:getCustomDomain", {
        "customDomainName": args.customDomainName,
        "endpointName": args.endpointName,
        "profileName": args.profileName,
        "resourceGroupName": args.resourceGroupName,
