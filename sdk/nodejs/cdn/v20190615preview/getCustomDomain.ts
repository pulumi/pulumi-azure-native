...
export function getCustomDomain(args: GetCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomDomainResult> {
    ...
    return pulumi.runtime.invoke("azurerm:cdn/v20190615preview:getCustomDomain", {
...
export interface GetCustomDomainResult {
     ...
     */
    readonly customHttpsParameters?: outputs.cdn.v20190615preview.CustomDomainHttpsParametersResponse;
    /**
