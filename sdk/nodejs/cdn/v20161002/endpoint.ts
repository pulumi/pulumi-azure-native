...
export class Endpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20161002:Endpoint';
     ...
     */
    public readonly geoFilters!: pulumi.Output<outputs.cdn.v20161002.GeoFilterResponse[] | undefined>;
    /**
     ...
     */
    public readonly origins!: pulumi.Output<outputs.cdn.v20161002.DeepCreatedOriginResponse[]>;
    /**
    ...
    constructor(name: string, args: EndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn/v20161002:Endpoint" }, { type: "azure-native:cdn:Endpoint" }, { type: "azure-nextgen:cdn:Endpoint" }, { type: "azure-native:cdn/v20150601:Endpoint" }, { type: "azure-nextgen:cdn/v20150601:Endpoint" }, { type: "azure-native:cdn/v20160402:Endpoint" }, { type: "azure-nextgen:cdn/v20160402:Endpoint" }, { type: "azure-native:cdn/v20170402:Endpoint" }, { type: "azure-nextgen:cdn/v20170402:Endpoint" }, { type: "azure-native:cdn/v20171012:Endpoint" }, { type: "azure-nextgen:cdn/v20171012:Endpoint" }, { type: "azure-native:cdn/v20190415:Endpoint" }, { type: "azure-nextgen:cdn/v20190415:Endpoint" }, { type: "azure-native:cdn/v20190615:Endpoint" }, { type: "azure-nextgen:cdn/v20190615:Endpoint" }, { type: "azure-native:cdn/v20190615preview:Endpoint" }, { type: "azure-nextgen:cdn/v20190615preview:Endpoint" }, { type: "azure-native:cdn/v20191231:Endpoint" }, { type: "azure-nextgen:cdn/v20191231:Endpoint" }, { type: "azure-native:cdn/v20200331:Endpoint" }, { type: "azure-nextgen:cdn/v20200331:Endpoint" }, { type: "azure-native:cdn/v20200415:Endpoint" }, { type: "azure-nextgen:cdn/v20200415:Endpoint" }, { type: "azure-native:cdn/v20200901:Endpoint" }, { type: "azure-nextgen:cdn/v20200901:Endpoint" }] };
...
export interface EndpointArgs {
     ...
     * List of rules defining user geo access within a CDN endpoint. Each geo filter defines an access rule to a specified path or content, e.g. block APAC for path /pictures/
     */
    readonly geoFilters?: pulumi.Input<pulumi.Input<inputs.cdn.v20161002.GeoFilterArgs>[]>;
    /**
     * Indicates whether content compression is enabled on CDN. Default value is false. If compression is enabled, content will be served as compressed if user requests for a compressed version. Content won't be compressed on CDN when requested content is smaller than 1 byte or larger than 1 MB.
     */
     ...
     * Customer can specify what scenario they want this CDN endpoint to optimize, e.g. Download, Media services. With this information we can apply scenario driven optimization.
     */
    readonly optimizationType?: pulumi.Input<string | enums.cdn.v20161002.OptimizationType>;
    /**
     * The host header CDN sends along with content requests to origin. The default value is the host name of the origin.
     */
     ...
     * The source of the content being delivered via CDN.
     */
    readonly origins: pulumi.Input<pulumi.Input<inputs.cdn.v20161002.DeepCreatedOriginArgs>[]>;
    /**
     ...
     * Defines the query string caching behavior
     */
    readonly queryStringCachingBehavior?: pulumi.Input<enums.cdn.v20161002.QueryStringCachingBehavior>;
    /**
