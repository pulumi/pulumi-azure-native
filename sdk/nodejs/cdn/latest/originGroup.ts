...
export class OriginGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: OriginGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cdn/preview:OriginGroup" }, { type: "azurerm:cdn/v20191231:OriginGroup" }, { type: "azurerm:cdn/v20200331:OriginGroup" }, { type: "azurerm:cdn/v20200415:OriginGroup" }] };
