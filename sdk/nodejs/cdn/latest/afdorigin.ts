...
export class AFDOrigin extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AFDOrigin {
        pulumi.log.warn("AFDOrigin is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:cdn:AFDOrigin'.")
        return new AFDOrigin(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/latest:AFDOrigin';
    ...
    constructor(name: string, args: AFDOriginArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn/latest:AFDOrigin" }, { type: "azure-native:cdn:AFDOrigin" }, { type: "azure-nextgen:cdn:AFDOrigin" }, { type: "azure-native:cdn/v20200901:AFDOrigin" }, { type: "azure-nextgen:cdn/v20200901:AFDOrigin" }] };
