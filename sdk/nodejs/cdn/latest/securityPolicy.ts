...
export class SecurityPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SecurityPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cdn/latest:SecurityPolicy" }, { type: "azure-native:cdn:SecurityPolicy" }, { type: "azure-nextgen:cdn:SecurityPolicy" }, { type: "azure-native:cdn/v20200901:SecurityPolicy" }, { type: "azure-nextgen:cdn/v20200901:SecurityPolicy" }] };
