...
export class EdgeActionVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20240722preview:EdgeActionVersion';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.cdn.v20240722preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface EdgeActionVersionArgs {
     ...
     * The deployment type
     */
    deploymentType: pulumi.Input<string | enums.cdn.v20240722preview.EdgeActionVersionDeploymentType>;
    /**
     ...
     * The active state
     */
    isDefaultVersion: pulumi.Input<string | enums.cdn.v20240722preview.EdgeActionIsDefaultVersion>;
    /**
     * The geo-location where the resource lives
     */
