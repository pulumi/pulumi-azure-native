...
export class Monitor extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MonitorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:logz:Monitor" }, { type: "azure-native:logz/v20201001preview:Monitor" }, { type: "azure-nextgen:logz/v20201001preview:Monitor" }] };
