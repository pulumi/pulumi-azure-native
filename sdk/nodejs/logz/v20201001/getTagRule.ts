...
export function getTagRule(args: GetTagRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetTagRuleResult> {
    pulumi.log.warn("getTagRule is deprecated: azure-native:logz/v20201001:TagRule is being removed in the next major version of this provider. Upgrade to at least azure-native:logz/v20220101preview:TagRule to guarantee forwards compatibility.")
