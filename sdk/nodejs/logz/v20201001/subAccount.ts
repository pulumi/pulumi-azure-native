...
export class SubAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SubAccount {
        pulumi.log.warn("SubAccount is deprecated: Version 2020-10-01 will be removed in v2 of the provider.")
        return new SubAccount(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:logz/v20201001:SubAccount';
    ...
    constructor(name: string, args: SubAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:logz:SubAccount" }, { type: "azure-native:logz/v20201001preview:SubAccount" }, { type: "azure-native:logz/v20220101preview:SubAccount" }] };
