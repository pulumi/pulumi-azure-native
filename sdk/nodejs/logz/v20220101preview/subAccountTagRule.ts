...
export class SubAccountTagRule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.logz.v20220101preview.MonitoringTagRulesPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SubAccountTagRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:logz/v20201001:SubAccountTagRule" }, { type: "azure-native:logz/v20201001preview:SubAccountTagRule" }, { type: "azure-native:logz:SubAccountTagRule" }] };
