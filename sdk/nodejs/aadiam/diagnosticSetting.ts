...
export class DiagnosticSetting extends pulumi.CustomResource {
     ...
     */
    public readonly logs!: pulumi.Output<outputs.aadiam.LogSettingsResponse[] | undefined>;
    /**
     * Azure resource name
     */
    ...
    constructor(name: string, args?: DiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:aadiam:DiagnosticSetting" }, { type: "azure-native:aadiam/latest:DiagnosticSetting" }, { type: "azure-nextgen:aadiam/latest:DiagnosticSetting" }, { type: "azure-native:aadiam/v20170401:DiagnosticSetting" }, { type: "azure-nextgen:aadiam/v20170401:DiagnosticSetting" }] };
...
export interface DiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    readonly logs?: pulumi.Input<pulumi.Input<inputs.aadiam.LogSettings>[]>;
    /**
