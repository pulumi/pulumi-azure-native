...
export class DiagnosticSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:aadiam:DiagnosticSetting';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.aadiam.DiagnosticSettingsResponse>;
    /**
     * Azure resource type
     */
...
export interface DiagnosticSettingArgs {
     ...
     * Properties of a Diagnostic Settings Resource.
     */
    readonly properties?: pulumi.Input<inputs.aadiam.DiagnosticSettings>;
}
