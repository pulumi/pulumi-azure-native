...
export class AzureADMetric extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:aadiam:azureADMetric';
    ...
    public /*out*/ readonly properties!: pulumi.Output<outputs.aadiam.AzureADMetricsPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: AzureADMetricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:aadiam/v20200701preview:azureADMetric" }] };
