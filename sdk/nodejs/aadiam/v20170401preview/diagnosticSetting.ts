...
export class DiagnosticSetting extends pulumi.CustomResource {
     ...
     */
    public readonly logs!: pulumi.Output<outputs.aadiam.v20170401preview.LogSettingsResponse[] | undefined>;
    /**
     * Azure resource name
     */
    ...
    constructor(name: string, args?: DiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:aadiam/v20170401preview:DiagnosticSetting" }, { type: "azure-native:aadiam:DiagnosticSetting" }, { type: "azure-nextgen:aadiam:DiagnosticSetting" }, { type: "azure-native:aadiam/v20170401:DiagnosticSetting" }, { type: "azure-nextgen:aadiam/v20170401:DiagnosticSetting" }] };
