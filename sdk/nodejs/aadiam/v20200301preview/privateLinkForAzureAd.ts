...
export class PrivateLinkForAzureAd extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:aadiam/v20200301preview:privateLinkForAzureAd';
    ...
    constructor(name: string, argsOrState?: PrivateLinkForAzureAdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:aadiam/preview:privateLinkForAzureAd" }] };
