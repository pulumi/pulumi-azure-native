...
export class PrivateLinkForAzureAd extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateLinkForAzureAdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:aadiam/v20200301preview:privateLinkForAzureAd" }, { type: "azure-native:aadiam:privateLinkForAzureAd" }, { type: "azure-nextgen:aadiam:privateLinkForAzureAd" }] };
