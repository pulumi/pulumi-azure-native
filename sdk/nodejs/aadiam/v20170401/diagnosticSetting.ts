...
export class DiagnosticSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:aadiam/v20170401:DiagnosticSetting';
    ...
    constructor(name: string, argsOrState?: DiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:aadiam/latest:DiagnosticSetting" }, { type: "azurerm:aadiam/preview:DiagnosticSetting" }] };
