...
export function getDiagnosticSetting(args: GetDiagnosticSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetDiagnosticSettingResult> {
    pulumi.log.warn("getDiagnosticSetting is deprecated: azure-native:aadiam/v20170401:DiagnosticSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:aadiam/v20170401preview:DiagnosticSetting to guarantee forwards compatibility.")
