...
export class DiagnosticSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:aadiam/preview:DiagnosticSetting';
     ...
     */
    public readonly logs!: pulumi.Output<outputs.aadiam.preview.LogSettingsResponse[] | undefined>;
    /**
     * Azure resource name
     */
    ...
    constructor(name: string, args: DiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:aadiam/latest:DiagnosticSetting" }, { type: "azurerm:aadiam/v20170401:DiagnosticSetting" }] };
...
export interface DiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    readonly logs?: pulumi.Input<pulumi.Input<inputs.aadiam.preview.LogSettings>[]>;
    /**
