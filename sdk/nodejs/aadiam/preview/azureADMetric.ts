...
export class AzureADMetric extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AzureADMetric {
        return new AzureADMetric(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:aadiam/preview:azureADMetric';
    ...
    public /*out*/ readonly properties!: pulumi.Output<outputs.aadiam.preview.AzureADMetricsPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: AzureADMetricArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as AzureADMetricArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:aadiam/v20200701preview:azureADMetric" }] };
