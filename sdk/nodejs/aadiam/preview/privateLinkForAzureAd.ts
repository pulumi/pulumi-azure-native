...
export class PrivateLinkForAzureAd extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateLinkForAzureAd {
        return new PrivateLinkForAzureAd(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:aadiam/preview:privateLinkForAzureAd';
    ...
    constructor(name: string, argsOrState?: PrivateLinkForAzureAdArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as PrivateLinkForAzureAdArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:aadiam/v20200301preview:privateLinkForAzureAd" }] };
