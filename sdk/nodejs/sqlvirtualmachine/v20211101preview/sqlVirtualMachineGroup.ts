...
export class SqlVirtualMachineGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlVirtualMachineGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sqlvirtualmachine:SqlVirtualMachineGroup" }, { type: "azure-native:sqlvirtualmachine/v20170301preview:SqlVirtualMachineGroup" }, { type: "azure-native:sqlvirtualmachine/v20220201:SqlVirtualMachineGroup" }] };
