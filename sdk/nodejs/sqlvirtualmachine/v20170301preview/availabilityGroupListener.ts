...
export class AvailabilityGroupListener extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AvailabilityGroupListener {
        pulumi.log.warn("AvailabilityGroupListener is deprecated: azure-native:sqlvirtualmachine/v20170301preview:AvailabilityGroupListener is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:AvailabilityGroupListener to guarantee forwards compatibility.")
        return new AvailabilityGroupListener(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sqlvirtualmachine/v20170301preview:AvailabilityGroupListener';
...
export interface AvailabilityGroupListenerArgs {
     ...
     * List of load balancer configurations for an availability group listener.
     */
    loadBalancerConfigurations?: pulumi.Input<pulumi.Input<inputs.sqlvirtualmachine.v20170301preview.LoadBalancerConfigurationArgs>[]>;
    /**
     * Listener port.
     */
