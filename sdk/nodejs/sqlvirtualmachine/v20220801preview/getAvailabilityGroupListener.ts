...
export function getAvailabilityGroupListener(args: GetAvailabilityGroupListenerArgs, opts?: pulumi.InvokeOptions): Promise<GetAvailabilityGroupListenerResult> {
    pulumi.log.warn("getAvailabilityGroupListener is deprecated: azure-native:sqlvirtualmachine/v20220801preview:AvailabilityGroupListener is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:AvailabilityGroupListener to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:sqlvirtualmachine/v20220801preview:getAvailabilityGroupListener", {
...
export interface GetAvailabilityGroupListenerResult {
     ...
     */
    readonly availabilityGroupConfiguration?: outputs.sqlvirtualmachine.v20220801preview.AgConfigurationResponse;
    /**
     ...
     */
    readonly loadBalancerConfigurations?: outputs.sqlvirtualmachine.v20220801preview.LoadBalancerConfigurationResponse[];
    /**
     * List of multi subnet IP configurations for an AG listener.
     */
    readonly multiSubnetIpConfigurations?: outputs.sqlvirtualmachine.v20220801preview.MultiSubnetIpConfigurationResponse[];
    /**
     * Resource name.
     */
