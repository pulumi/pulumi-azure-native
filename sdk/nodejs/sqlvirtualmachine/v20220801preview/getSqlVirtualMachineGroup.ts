...
export function getSqlVirtualMachineGroup(args: GetSqlVirtualMachineGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlVirtualMachineGroupResult> {
    pulumi.log.warn("getSqlVirtualMachineGroup is deprecated: azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachineGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachineGroup to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:sqlvirtualmachine/v20220801preview:getSqlVirtualMachineGroup", {
...
export interface GetSqlVirtualMachineGroupResult {
     ...
     */
    readonly systemData: outputs.sqlvirtualmachine.v20220801preview.SystemDataResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly wsfcDomainProfile?: outputs.sqlvirtualmachine.v20220801preview.WsfcDomainProfileResponse;
}
/**
 * Gets a SQL virtual machine group.
 */
