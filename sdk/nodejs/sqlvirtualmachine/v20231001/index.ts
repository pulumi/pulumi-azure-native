...
// Export enums:
export * from "../../types/enums/sqlvirtualmachine/v20231001";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:sqlvirtualmachine/v20231001:AvailabilityGroupListener":
                return new AvailabilityGroupListener(name, <any>undefined, { urn })
            case "azure-native:sqlvirtualmachine/v20231001:SqlVirtualMachine":
                return new SqlVirtualMachine(name, <any>undefined, { urn })
            case "azure-native:sqlvirtualmachine/v20231001:SqlVirtualMachineGroup":
...
pulumi.runtime.registerResourceModule("azure-native", "sqlvirtualmachine/v20231001", _module)
