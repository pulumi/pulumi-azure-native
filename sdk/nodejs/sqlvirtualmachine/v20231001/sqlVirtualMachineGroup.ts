...
export class SqlVirtualMachineGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sqlvirtualmachine/v20231001:SqlVirtualMachineGroup';
     ...
     */
    public readonly wsfcDomainProfile!: pulumi.Output<outputs.sqlvirtualmachine.v20231001.WsfcDomainProfileResponse | undefined>;
...
export interface SqlVirtualMachineGroupArgs {
     ...
     * SQL image sku.
     */
    sqlImageSku?: pulumi.Input<string | enums.sqlvirtualmachine.v20231001.SqlVmGroupImageSku>;
    /**
     ...
     * Cluster Active Directory domain profile.
     */
    wsfcDomainProfile?: pulumi.Input<inputs.sqlvirtualmachine.v20231001.WsfcDomainProfileArgs>;
}
