...
export class SqlVirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sqlvirtualmachine/v20231001:SqlVirtualMachine';
     ...
     */
    public readonly assessmentSettings!: pulumi.Output<outputs.sqlvirtualmachine.v20231001.AssessmentSettingsResponse | undefined>;
    /**
     * Auto backup settings for SQL Server.
     */
    public readonly autoBackupSettings!: pulumi.Output<outputs.sqlvirtualmachine.v20231001.AutoBackupSettingsResponse | undefined>;
    /**
     * Auto patching settings for applying critical security updates to SQL virtual machine.
     */
    public readonly autoPatchingSettings!: pulumi.Output<outputs.sqlvirtualmachine.v20231001.AutoPatchingSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.sqlvirtualmachine.v20231001.ResourceIdentityResponse | undefined>;
    /**
     * Key vault credential settings.
     */
    public readonly keyVaultCredentialSettings!: pulumi.Output<outputs.sqlvirtualmachine.v20231001.KeyVaultCredentialSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly serverConfigurationsManagementSettings!: pulumi.Output<outputs.sqlvirtualmachine.v20231001.ServerConfigurationsManagementSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly storageConfigurationSettings!: pulumi.Output<outputs.sqlvirtualmachine.v20231001.StorageConfigurationSettingsResponse | undefined>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.sqlvirtualmachine.v20231001.SystemDataResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    public /*out*/ readonly troubleshootingStatus!: pulumi.Output<outputs.sqlvirtualmachine.v20231001.TroubleshootingStatusResponse>;
    /**
     * Resource type.
     */
     ...
     */
    public readonly virtualMachineIdentitySettings!: pulumi.Output<outputs.sqlvirtualmachine.v20231001.VirtualMachineIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly wsfcDomainCredentials!: pulumi.Output<outputs.sqlvirtualmachine.v20231001.WsfcDomainCredentialsResponse | undefined>;
    /**
     * Domain credentials for setting up Windows Server Failover Cluster for SQL availability group.
     */
    ...
    constructor(name: string, args: SqlVirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["autoPatchingSettings"] = args ? (args.autoPatchingSettings ? pulumi.output(args.autoPatchingSettings).apply(inputs.sqlvirtualmachine.v20231001.autoPatchingSettingsArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["storageConfigurationSettings"] = args ? (args.storageConfigurationSettings ? pulumi.output(args.storageConfigurationSettings).apply(inputs.sqlvirtualmachine.v20231001.storageConfigurationSettingsArgsProvideDefaults) : undefined) : undefined;
...
export interface SqlVirtualMachineArgs {
     ...
     * SQL best practices Assessment Settings.
     */
    assessmentSettings?: pulumi.Input<inputs.sqlvirtualmachine.v20231001.AssessmentSettingsArgs>;
    /**
     * Auto backup settings for SQL Server.
     */
    autoBackupSettings?: pulumi.Input<inputs.sqlvirtualmachine.v20231001.AutoBackupSettingsArgs>;
    /**
     * Auto patching settings for applying critical security updates to SQL virtual machine.
     */
    autoPatchingSettings?: pulumi.Input<inputs.sqlvirtualmachine.v20231001.AutoPatchingSettingsArgs>;
    /**
     * Enable automatic upgrade of Sql IaaS extension Agent.
     */
     ...
     * DO NOT USE. This value will be deprecated. Azure Active Directory identity of the server.
     */
    identity?: pulumi.Input<inputs.sqlvirtualmachine.v20231001.ResourceIdentityArgs>;
    /**
     * Key vault credential settings.
     */
    keyVaultCredentialSettings?: pulumi.Input<inputs.sqlvirtualmachine.v20231001.KeyVaultCredentialSettingsArgs>;
    /**
     * SQL IaaS Agent least privilege mode.
     */
    leastPrivilegeMode?: pulumi.Input<string | enums.sqlvirtualmachine.v20231001.LeastPrivilegeMode>;
    /**
     * Resource location.
     */
     ...
     * SQL Server configuration management settings.
     */
    serverConfigurationsManagementSettings?: pulumi.Input<inputs.sqlvirtualmachine.v20231001.ServerConfigurationsManagementSettingsArgs>;
    /**
     * SQL image offer. Examples include SQL2016-WS2016, SQL2017-WS2016.
     */
     ...
     * SQL Server edition type.
     */
    sqlImageSku?: pulumi.Input<string | enums.sqlvirtualmachine.v20231001.SqlImageSku>;
    /**
     * SQL Server Management type. NOTE: This parameter is not used anymore. API will automatically detect the Sql Management, refrain from using it.
     */
    sqlManagement?: pulumi.Input<string | enums.sqlvirtualmachine.v20231001.SqlManagementMode>;
    /**
     * SQL Server license type.
     */
    sqlServerLicenseType?: pulumi.Input<string | enums.sqlvirtualmachine.v20231001.SqlServerLicenseType>;
    /**
     * ARM resource id of the SQL virtual machine group this SQL virtual machine is or will be part of.
     */
     ...
     * Storage Configuration Settings.
     */
    storageConfigurationSettings?: pulumi.Input<inputs.sqlvirtualmachine.v20231001.StorageConfigurationSettingsArgs>;
    /**
     * Resource tags.
     */
     ...
     * Virtual Machine Identity details used for Sql IaaS extension configurations.
     */
    virtualMachineIdentitySettings?: pulumi.Input<inputs.sqlvirtualmachine.v20231001.VirtualMachineIdentityArgs>;
    /**
     * ARM Resource id of underlying virtual machine created from SQL marketplace image.
     */
     ...
     * Domain credentials for setting up Windows Server Failover Cluster for SQL availability group.
     */
    wsfcDomainCredentials?: pulumi.Input<inputs.sqlvirtualmachine.v20231001.WsfcDomainCredentialsArgs>;
    /**
     * Domain credentials for setting up Windows Server Failover Cluster for SQL availability group.
     */
