...
export function getSqlVirtualMachineGroup(args: GetSqlVirtualMachineGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlVirtualMachineGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sqlvirtualmachine/v20231001:getSqlVirtualMachineGroup", {
...
export interface GetSqlVirtualMachineGroupResult {
     ...
     */
    readonly systemData: outputs.sqlvirtualmachine.v20231001.SystemDataResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly wsfcDomainProfile?: outputs.sqlvirtualmachine.v20231001.WsfcDomainProfileResponse;
}
/**
 * Gets a SQL virtual machine group.
 */
