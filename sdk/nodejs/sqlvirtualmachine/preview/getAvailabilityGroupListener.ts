...
export function getAvailabilityGroupListener(args: GetAvailabilityGroupListenerArgs, opts?: pulumi.InvokeOptions): Promise<GetAvailabilityGroupListenerResult> {
    ...
    return pulumi.runtime.invoke("azurerm:sqlvirtualmachine/preview:getAvailabilityGroupListener", {
...
export interface GetAvailabilityGroupListenerResult {
     ...
     */
    readonly loadBalancerConfigurations?: outputs.sqlvirtualmachine.preview.LoadBalancerConfigurationResponse[];
    /**
     * Resource name.
     */
