...
export class SqlVirtualMachineGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sqlvirtualmachine/preview:SqlVirtualMachineGroup';
     ...
     */
    public readonly wsfcDomainProfile!: pulumi.Output<outputs.sqlvirtualmachine.preview.WsfcDomainProfileResponse | undefined>;
    ...
    constructor(name: string, argsOrState?: SqlVirtualMachineGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sqlvirtualmachine/v20170301preview:SqlVirtualMachineGroup" }] };
...
export interface SqlVirtualMachineGroupArgs {
     ...
     * Cluster Active Directory domain profile.
     */
    readonly wsfcDomainProfile?: pulumi.Input<inputs.sqlvirtualmachine.preview.WsfcDomainProfile>;
}
