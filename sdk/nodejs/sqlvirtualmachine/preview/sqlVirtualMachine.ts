...
export class SqlVirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sqlvirtualmachine/preview:SqlVirtualMachine';
     ...
     */
    public readonly autoBackupSettings!: pulumi.Output<outputs.sqlvirtualmachine.preview.AutoBackupSettingsResponse | undefined>;
    /**
     * Auto patching settings for applying critical security updates to SQL virtual machine.
     */
    public readonly autoPatchingSettings!: pulumi.Output<outputs.sqlvirtualmachine.preview.AutoPatchingSettingsResponse | undefined>;
    /**
     * Azure Active Directory identity of the server.
     */
    public readonly identity!: pulumi.Output<outputs.sqlvirtualmachine.preview.ResourceIdentityResponse | undefined>;
    /**
     * Key vault credential settings.
     */
    public readonly keyVaultCredentialSettings!: pulumi.Output<outputs.sqlvirtualmachine.preview.KeyVaultCredentialSettingsResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly serverConfigurationsManagementSettings!: pulumi.Output<outputs.sqlvirtualmachine.preview.ServerConfigurationsManagementSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly storageConfigurationSettings!: pulumi.Output<outputs.sqlvirtualmachine.preview.StorageConfigurationSettingsResponse | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly wsfcDomainCredentials!: pulumi.Output<outputs.sqlvirtualmachine.preview.WsfcDomainCredentialsResponse | undefined>;
    ...
    constructor(name: string, argsOrState?: SqlVirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sqlvirtualmachine/v20170301preview:SqlVirtualMachine" }] };
...
export interface SqlVirtualMachineArgs {
     ...
     * Auto backup settings for SQL Server.
     */
    readonly autoBackupSettings?: pulumi.Input<inputs.sqlvirtualmachine.preview.AutoBackupSettings>;
    /**
     * Auto patching settings for applying critical security updates to SQL virtual machine.
     */
    readonly autoPatchingSettings?: pulumi.Input<inputs.sqlvirtualmachine.preview.AutoPatchingSettings>;
    /**
     * Azure Active Directory identity of the server.
     */
    readonly identity?: pulumi.Input<inputs.sqlvirtualmachine.preview.ResourceIdentity>;
    /**
     * Key vault credential settings.
     */
    readonly keyVaultCredentialSettings?: pulumi.Input<inputs.sqlvirtualmachine.preview.KeyVaultCredentialSettings>;
    /**
     * Resource location.
     */
     ...
     * SQL Server configuration management settings.
     */
    readonly serverConfigurationsManagementSettings?: pulumi.Input<inputs.sqlvirtualmachine.preview.ServerConfigurationsManagementSettings>;
    /**
     * SQL image offer. Examples include SQL2016-WS2016, SQL2017-WS2016.
     */
     ...
     * Storage Configuration Settings.
     */
    readonly storageConfigurationSettings?: pulumi.Input<inputs.sqlvirtualmachine.preview.StorageConfigurationSettings>;
    /**
     * Resource tags.
     */
     ...
     * Domain credentials for setting up Windows Server Failover Cluster for SQL availability group.
     */
    readonly wsfcDomainCredentials?: pulumi.Input<inputs.sqlvirtualmachine.preview.WsfcDomainCredentials>;
}
