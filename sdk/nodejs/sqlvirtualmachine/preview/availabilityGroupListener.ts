...
export class AvailabilityGroupListener extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sqlvirtualmachine/preview:AvailabilityGroupListener';
     ...
     */
    public readonly loadBalancerConfigurations!: pulumi.Output<outputs.sqlvirtualmachine.preview.LoadBalancerConfigurationResponse[] | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, argsOrState?: AvailabilityGroupListenerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sqlvirtualmachine/v20170301preview:AvailabilityGroupListener" }] };
...
export interface AvailabilityGroupListenerArgs {
     ...
     * List of load balancer configurations for an availability group listener.
     */
    readonly loadBalancerConfigurations?: pulumi.Input<pulumi.Input<inputs.sqlvirtualmachine.preview.LoadBalancerConfiguration>[]>;
    /**
     * Listener port.
     */
