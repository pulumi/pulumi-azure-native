...
export class SqlVirtualMachineGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sqlvirtualmachine/v20220201preview:SqlVirtualMachineGroup';
     ...
     */
    public readonly wsfcDomainProfile!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.WsfcDomainProfileResponse | undefined>;
...
export interface SqlVirtualMachineGroupArgs {
     ...
     * SQL image sku.
     */
    sqlImageSku?: pulumi.Input<string | enums.sqlvirtualmachine.v20220201preview.SqlVmGroupImageSku>;
    /**
     ...
     * Cluster Active Directory domain profile.
     */
    wsfcDomainProfile?: pulumi.Input<inputs.sqlvirtualmachine.v20220201preview.WsfcDomainProfileArgs>;
}
