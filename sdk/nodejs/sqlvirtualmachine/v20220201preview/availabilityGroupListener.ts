 ...
 *
 * @deprecated azure-native:sqlvirtualmachine/v20220201preview:AvailabilityGroupListener is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:AvailabilityGroupListener to guarantee forwards compatibility.
 */
export class AvailabilityGroupListener extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sqlvirtualmachine/v20220201preview:AvailabilityGroupListener';
     ...
     */
    public readonly availabilityGroupConfiguration!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.AgConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly loadBalancerConfigurations!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.LoadBalancerConfigurationResponse[] | undefined>;
    /**
     * List of multi subnet IP configurations for an AG listener.
     */
    public readonly multiSubnetIpConfigurations!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.MultiSubnetIpConfigurationResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.SystemDataResponse>;
    /**
     * Resource type.
     */
...
export interface AvailabilityGroupListenerArgs {
     ...
     * Availability Group configuration.
     */
    availabilityGroupConfiguration?: pulumi.Input<inputs.sqlvirtualmachine.v20220201preview.AgConfigurationArgs>;
    /**
     ...
     * List of load balancer configurations for an availability group listener.
     */
    loadBalancerConfigurations?: pulumi.Input<pulumi.Input<inputs.sqlvirtualmachine.v20220201preview.LoadBalancerConfigurationArgs>[]>;
    /**
     * List of multi subnet IP configurations for an AG listener.
     */
    multiSubnetIpConfigurations?: pulumi.Input<pulumi.Input<inputs.sqlvirtualmachine.v20220201preview.MultiSubnetIpConfigurationArgs>[]>;
    /**
     * Listener port.
     */
