...
export class SqlVirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sqlvirtualmachine/v20220201preview:SqlVirtualMachine';
     ...
     * Assessment Settings.
     */
    public readonly assessmentSettings!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.AssessmentSettingsResponse | undefined>;
    /**
     * Auto backup settings for SQL Server.
     */
    public readonly autoBackupSettings!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.AutoBackupSettingsResponse | undefined>;
    /**
     * Auto patching settings for applying critical security updates to SQL virtual machine.
     */
    public readonly autoPatchingSettings!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.AutoPatchingSettingsResponse | undefined>;
    /**
     * Azure Active Directory identity of the server.
     */
    public readonly identity!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.ResourceIdentityResponse | undefined>;
    /**
     * Key vault credential settings.
     */
    public readonly keyVaultCredentialSettings!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.KeyVaultCredentialSettingsResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly serverConfigurationsManagementSettings!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.ServerConfigurationsManagementSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly storageConfigurationSettings!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.StorageConfigurationSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly wsfcDomainCredentials!: pulumi.Output<outputs.sqlvirtualmachine.v20220201preview.WsfcDomainCredentialsResponse | undefined>;
    /**
     * Domain credentials for setting up Windows Server Failover Cluster for SQL availability group.
     */
    ...
    constructor(name: string, args: SqlVirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sqlvirtualmachine:SqlVirtualMachine" }, { type: "azure-native:sqlvirtualmachine/v20170301preview:SqlVirtualMachine" }, { type: "azure-native:sqlvirtualmachine/v20211101preview:SqlVirtualMachine" }, { type: "azure-native:sqlvirtualmachine/v20220201:SqlVirtualMachine" }] };
...
export interface SqlVirtualMachineArgs {
     ...
     * Assessment Settings.
     */
    assessmentSettings?: pulumi.Input<inputs.sqlvirtualmachine.v20220201preview.AssessmentSettingsArgs>;
    /**
     * Auto backup settings for SQL Server.
     */
    autoBackupSettings?: pulumi.Input<inputs.sqlvirtualmachine.v20220201preview.AutoBackupSettingsArgs>;
    /**
     * Auto patching settings for applying critical security updates to SQL virtual machine.
     */
    autoPatchingSettings?: pulumi.Input<inputs.sqlvirtualmachine.v20220201preview.AutoPatchingSettingsArgs>;
    /**
     * Azure Active Directory identity of the server.
     */
    identity?: pulumi.Input<inputs.sqlvirtualmachine.v20220201preview.ResourceIdentityArgs>;
    /**
     * Key vault credential settings.
     */
    keyVaultCredentialSettings?: pulumi.Input<inputs.sqlvirtualmachine.v20220201preview.KeyVaultCredentialSettingsArgs>;
    /**
     * Resource location.
     */
     ...
     * SQL Server configuration management settings.
     */
    serverConfigurationsManagementSettings?: pulumi.Input<inputs.sqlvirtualmachine.v20220201preview.ServerConfigurationsManagementSettingsArgs>;
    /**
     * SQL image offer. Examples include SQL2016-WS2016, SQL2017-WS2016.
     */
     ...
     * SQL Server edition type.
     */
    sqlImageSku?: pulumi.Input<string | enums.sqlvirtualmachine.v20220201preview.SqlImageSku>;
    /**
     * SQL Server Management type.
     */
    sqlManagement?: pulumi.Input<string | enums.sqlvirtualmachine.v20220201preview.SqlManagementMode>;
    /**
     * SQL Server license type.
     */
    sqlServerLicenseType?: pulumi.Input<string | enums.sqlvirtualmachine.v20220201preview.SqlServerLicenseType>;
    /**
     * ARM resource id of the SQL virtual machine group this SQL virtual machine is or will be part of.
     */
     ...
     * Storage Configuration Settings.
     */
    storageConfigurationSettings?: pulumi.Input<inputs.sqlvirtualmachine.v20220201preview.StorageConfigurationSettingsArgs>;
    /**
     * Resource tags.
     */
     ...
     * Domain credentials for setting up Windows Server Failover Cluster for SQL availability group.
     */
    wsfcDomainCredentials?: pulumi.Input<inputs.sqlvirtualmachine.v20220201preview.WsfcDomainCredentialsArgs>;
    /**
     * Domain credentials for setting up Windows Server Failover Cluster for SQL availability group.
     */
