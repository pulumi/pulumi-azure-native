...
export class SqlVirtualMachineGroup extends pulumi.CustomResource {
     ...
     */
    public readonly wsfcDomainProfile!: pulumi.Output<outputs.sqlvirtualmachine.v20220201.WsfcDomainProfileResponse | undefined>;
    ...
    constructor(name: string, args: SqlVirtualMachineGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sqlvirtualmachine:SqlVirtualMachineGroup" }, { type: "azure-native:sqlvirtualmachine/v20170301preview:SqlVirtualMachineGroup" }, { type: "azure-native:sqlvirtualmachine/v20211101preview:SqlVirtualMachineGroup" }] };
