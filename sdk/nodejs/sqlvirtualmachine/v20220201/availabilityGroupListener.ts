...
export class AvailabilityGroupListener extends pulumi.CustomResource {
     ...
     */
    public readonly availabilityGroupConfiguration!: pulumi.Output<outputs.sqlvirtualmachine.v20220201.AgConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly loadBalancerConfigurations!: pulumi.Output<outputs.sqlvirtualmachine.v20220201.LoadBalancerConfigurationResponse[] | undefined>;
    /**
     * List of multi subnet IP configurations for an AG listener.
     */
    public readonly multiSubnetIpConfigurations!: pulumi.Output<outputs.sqlvirtualmachine.v20220201.MultiSubnetIpConfigurationResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.sqlvirtualmachine.v20220201.SystemDataResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: AvailabilityGroupListenerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sqlvirtualmachine/v20170301preview:AvailabilityGroupListener" }, { type: "azure-native:sqlvirtualmachine/v20211101preview:AvailabilityGroupListener" }, { type: "azure-native:sqlvirtualmachine/v20220201preview:AvailabilityGroupListener" }, { type: "azure-native:sqlvirtualmachine/v20220701preview:AvailabilityGroupListener" }, { type: "azure-native:sqlvirtualmachine/v20220801preview:AvailabilityGroupListener" }, { type: "azure-native:sqlvirtualmachine/v20230101preview:AvailabilityGroupListener" }, { type: "azure-native:sqlvirtualmachine/v20231001:AvailabilityGroupListener" }, { type: "azure-native:sqlvirtualmachine:AvailabilityGroupListener" }] };
...
export interface AvailabilityGroupListenerArgs {
     ...
     * Availability Group configuration.
     */
    availabilityGroupConfiguration?: pulumi.Input<inputs.sqlvirtualmachine.v20220201.AgConfigurationArgs>;
    /**
     ...
     * List of load balancer configurations for an availability group listener.
     */
    loadBalancerConfigurations?: pulumi.Input<pulumi.Input<inputs.sqlvirtualmachine.v20220201.LoadBalancerConfigurationArgs>[]>;
    /**
     * List of multi subnet IP configurations for an AG listener.
     */
    multiSubnetIpConfigurations?: pulumi.Input<pulumi.Input<inputs.sqlvirtualmachine.v20220201.MultiSubnetIpConfigurationArgs>[]>;
    /**
     * Listener port.
     */
