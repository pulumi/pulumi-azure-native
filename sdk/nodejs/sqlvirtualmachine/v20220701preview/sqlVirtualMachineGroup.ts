...
export class SqlVirtualMachineGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlVirtualMachineGroup {
        pulumi.log.warn("SqlVirtualMachineGroup is deprecated: azure-native:sqlvirtualmachine/v20220701preview:SqlVirtualMachineGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachineGroup to guarantee forwards compatibility.")
        return new SqlVirtualMachineGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sqlvirtualmachine/v20220701preview:SqlVirtualMachineGroup';
     ...
     */
    public readonly wsfcDomainProfile!: pulumi.Output<outputs.sqlvirtualmachine.v20220701preview.WsfcDomainProfileResponse | undefined>;
...
export interface SqlVirtualMachineGroupArgs {
     ...
     * SQL image sku.
     */
    sqlImageSku?: pulumi.Input<string | enums.sqlvirtualmachine.v20220701preview.SqlVmGroupImageSku>;
    /**
     ...
     * Cluster Active Directory domain profile.
     */
    wsfcDomainProfile?: pulumi.Input<inputs.sqlvirtualmachine.v20220701preview.WsfcDomainProfileArgs>;
}
