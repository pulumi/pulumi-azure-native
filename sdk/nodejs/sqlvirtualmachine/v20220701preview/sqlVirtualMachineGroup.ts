...
export class SqlVirtualMachineGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlVirtualMachineGroup {
        pulumi.log.warn("SqlVirtualMachineGroup is deprecated: azure-native:sqlvirtualmachine/v20220701preview:SqlVirtualMachineGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachineGroup to guarantee forwards compatibility.")
