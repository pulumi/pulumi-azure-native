...
export class AvailabilityGroupListener extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AvailabilityGroupListenerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sqlvirtualmachine:AvailabilityGroupListener" }, { type: "azure-native:sqlvirtualmachine/v20170301preview:AvailabilityGroupListener" }, { type: "azure-nextgen:sqlvirtualmachine/v20170301preview:AvailabilityGroupListener" }] };
...
export interface AvailabilityGroupListenerArgs {
     ...
     * List of load balancer configurations for an availability group listener.
     */
    readonly loadBalancerConfigurations?: pulumi.Input<pulumi.Input<inputs.sqlvirtualmachine.LoadBalancerConfiguration>[]>;
    /**
     * Listener port.
     */
