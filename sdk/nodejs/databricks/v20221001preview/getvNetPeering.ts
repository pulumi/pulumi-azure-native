...
export function getvNetPeering(args: GetvNetPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetvNetPeeringResult> {
    ...
    return pulumi.runtime.invoke("azure-native:databricks/v20221001preview:getvNetPeering", {
...
export interface GetvNetPeeringResult {
     ...
     */
    readonly databricksAddressSpace?: outputs.databricks.v20221001preview.AddressSpaceResponse;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly databricksVirtualNetwork?: outputs.databricks.v20221001preview.VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetwork;
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly remoteAddressSpace?: outputs.databricks.v20221001preview.AddressSpaceResponse;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly remoteVirtualNetwork: outputs.databricks.v20221001preview.VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetwork;
    /**
