...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:databricks/v20221001preview:AccessConnector":
                return new AccessConnector(name, <any>undefined, { urn })
            case "azure-native:databricks/v20221001preview:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:databricks/v20221001preview:Workspace":
                return new Workspace(name, <any>undefined, { urn })
            case "azure-native:databricks/v20221001preview:vNetPeering":
...
pulumi.runtime.registerResourceModule("azure-native", "databricks/v20221001preview", _module)
