 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:databricks:vNetPeering'.
 */
export class VNetPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databricks/latest:vNetPeering';
     ...
     */
    public readonly databricksAddressSpace!: pulumi.Output<outputs.databricks.latest.AddressSpaceResponse | undefined>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    public readonly databricksVirtualNetwork!: pulumi.Output<outputs.databricks.latest.VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetwork | undefined>;
    /**
     ...
     */
    public readonly remoteAddressSpace!: pulumi.Output<outputs.databricks.latest.AddressSpaceResponse | undefined>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<outputs.databricks.latest.VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetwork>;
    /**
    ...
    constructor(name: string, args: VNetPeeringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databricks/latest:vNetPeering" }, { type: "azure-native:databricks:vNetPeering" }, { type: "azure-nextgen:databricks:vNetPeering" }, { type: "azure-native:databricks/v20180401:vNetPeering" }, { type: "azure-nextgen:databricks/v20180401:vNetPeering" }] };
...
export interface VNetPeeringArgs {
     ...
     * The reference to the databricks virtual network address space.
     */
    readonly databricksAddressSpace?: pulumi.Input<inputs.databricks.latest.AddressSpace>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly databricksVirtualNetwork?: pulumi.Input<inputs.databricks.latest.VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetwork>;
    /**
     ...
     * The reference to the remote virtual network address space.
     */
    readonly remoteAddressSpace?: pulumi.Input<inputs.databricks.latest.AddressSpace>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly remoteVirtualNetwork: pulumi.Input<inputs.databricks.latest.VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetwork>;
    /**
