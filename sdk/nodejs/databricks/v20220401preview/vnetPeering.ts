...
export class VNetPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databricks/v20220401preview:VNetPeering';
     ...
     */
    public readonly databricksAddressSpace!: pulumi.Output<outputs.databricks.v20220401preview.AddressSpaceResponse | undefined>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    public readonly databricksVirtualNetwork!: pulumi.Output<outputs.databricks.v20220401preview.VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetwork | undefined>;
    /**
     ...
     */
    public readonly remoteAddressSpace!: pulumi.Output<outputs.databricks.v20220401preview.AddressSpaceResponse | undefined>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<outputs.databricks.v20220401preview.VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetwork>;
    /**
    ...
    constructor(name: string, args: VNetPeeringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databricks/v20220401preview:vNetPeering" }, { type: "azure-native:databricks:VNetPeering" }, { type: "azure-native:databricks:vNetPeering" }, { type: "azure-native:databricks/v20180401:VNetPeering" }, { type: "azure-native:databricks/v20180401:vNetPeering" }, { type: "azure-native:databricks/v20210401preview:VNetPeering" }, { type: "azure-native:databricks/v20210401preview:vNetPeering" }, { type: "azure-native:databricks/v20230201:VNetPeering" }, { type: "azure-native:databricks/v20230201:vNetPeering" }] };
...
export interface VNetPeeringArgs {
     ...
     * The reference to the databricks virtual network address space.
     */
    databricksAddressSpace?: pulumi.Input<inputs.databricks.v20220401preview.AddressSpaceArgs>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    databricksVirtualNetwork?: pulumi.Input<inputs.databricks.v20220401preview.VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkArgs>;
    /**
     ...
     * The reference to the remote virtual network address space.
     */
    remoteAddressSpace?: pulumi.Input<inputs.databricks.v20220401preview.AddressSpaceArgs>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    remoteVirtualNetwork: pulumi.Input<inputs.databricks.v20220401preview.VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgs>;
    /**
