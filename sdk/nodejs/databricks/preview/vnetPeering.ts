...
export class VNetPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databricks/preview:vNetPeering';
     ...
     */
    public readonly databricksAddressSpace!: pulumi.Output<outputs.databricks.preview.AddressSpaceResponse | undefined>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    public readonly databricksVirtualNetwork!: pulumi.Output<outputs.databricks.preview.VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetwork | undefined>;
    /**
     ...
     */
    public readonly remoteAddressSpace!: pulumi.Output<outputs.databricks.preview.AddressSpaceResponse | undefined>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<outputs.databricks.preview.VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetwork>;
    /**
    ...
    constructor(name: string, argsOrState?: VNetPeeringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databricks/latest:vNetPeering" }, { type: "azurerm:databricks/v20180401:vNetPeering" }] };
...
export interface VNetPeeringArgs {
     ...
     * The reference to the databricks virtual network address space.
     */
    readonly databricksAddressSpace?: pulumi.Input<inputs.databricks.preview.AddressSpace>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly databricksVirtualNetwork?: pulumi.Input<inputs.databricks.preview.VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetwork>;
    /**
     ...
     * The reference to the remote virtual network address space.
     */
    readonly remoteAddressSpace?: pulumi.Input<inputs.databricks.preview.AddressSpace>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly remoteVirtualNetwork: pulumi.Input<inputs.databricks.preview.VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetwork>;
    /**
