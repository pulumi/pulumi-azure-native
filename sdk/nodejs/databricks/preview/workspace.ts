...
export class Workspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databricks/preview:Workspace';
     ...
     */
    public readonly authorizations!: pulumi.Output<outputs.databricks.preview.WorkspaceProviderAuthorizationResponse[] | undefined>;
    /**
     * Indicates the Object ID, PUID and Application ID of entity that created the workspace.
     */
    public /*out*/ readonly createdBy!: pulumi.Output<outputs.databricks.preview.CreatedByResponse | undefined>;
    /**
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.databricks.preview.WorkspaceCustomParametersResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.databricks.preview.SkuResponse | undefined>;
    /**
     * The details of Managed Identity of Storage Account
     */
    public /*out*/ readonly storageAccountIdentity!: pulumi.Output<outputs.databricks.preview.ManagedIdentityConfigurationResponse | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public /*out*/ readonly updatedBy!: pulumi.Output<outputs.databricks.preview.CreatedByResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: WorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databricks/latest:Workspace" }, { type: "azurerm:databricks/v20180401:Workspace" }] };
...
export interface WorkspaceArgs {
     ...
     * The workspace provider authorizations.
     */
    readonly authorizations?: pulumi.Input<pulumi.Input<inputs.databricks.preview.WorkspaceProviderAuthorization>[]>;
    /**
     * Specifies the date and time when the workspace is created.
     */
     ...
     * The workspace's custom parameters.
     */
    readonly parameters?: pulumi.Input<inputs.databricks.preview.WorkspaceCustomParameters>;
    /**
     ...
     * The SKU of the resource.
     */
    readonly sku?: pulumi.Input<inputs.databricks.preview.Sku>;
    /**
     * Resource tags.
     */
