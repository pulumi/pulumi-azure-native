...
export function getVNetPeering(args: GetVNetPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetVNetPeeringResult> {
    ...
    return pulumi.runtime.invoke("azure-native:databricks/v20240201preview:getVNetPeering", {
...
export interface GetVNetPeeringResult {
     ...
     */
    readonly databricksAddressSpace?: outputs.databricks.v20240201preview.AddressSpaceResponse;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly databricksVirtualNetwork?: outputs.databricks.v20240201preview.VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetwork;
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly remoteAddressSpace?: outputs.databricks.v20240201preview.AddressSpaceResponse;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly remoteVirtualNetwork: outputs.databricks.v20240201preview.VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetwork;
    /**
