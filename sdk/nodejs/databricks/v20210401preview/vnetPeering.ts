...
export class VNetPeering extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.databricks.v20210401preview.VirtualNetworkPeeringPropertiesFormatResponse>;
    /**
...
export interface VNetPeeringArgs {
     ...
     * List of properties for vNet Peering
     */
    properties: pulumi.Input<inputs.databricks.v20210401preview.VirtualNetworkPeeringPropertiesFormatArgs>;
    /**
