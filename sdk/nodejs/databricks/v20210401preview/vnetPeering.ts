...
export class VNetPeering extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VNetPeering {
        pulumi.log.warn("VNetPeering is deprecated: azure-native:databricks/v20210401preview:vNetPeering is being removed in the next major version of this provider. Please upgrade to azure-native:databricks/v20230201:vNetPeering to guarantee forwards compatibility.")
