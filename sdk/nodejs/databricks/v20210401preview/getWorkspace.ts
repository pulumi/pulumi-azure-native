 ...
 * Gets the workspace.
 */
/** @deprecated azure-native:databricks/v20210401preview:Workspace is being removed in the next major version of this provider. Please upgrade to azure-native:databricks/v20230201:Workspace to guarantee forwards compatibility. */
export function getWorkspace(args: GetWorkspaceArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceResult> {
    pulumi.log.warn("getWorkspace is deprecated: azure-native:databricks/v20210401preview:Workspace is being removed in the next major version of this provider. Please upgrade to azure-native:databricks/v20230201:Workspace to guarantee forwards compatibility.")
