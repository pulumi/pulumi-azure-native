...
export class VNetPeering extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VNetPeeringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databricks:vNetPeering" }, { type: "azure-nextgen:databricks:vNetPeering" }, { type: "azure-native:databricks/latest:vNetPeering" }, { type: "azure-nextgen:databricks/latest:vNetPeering" }] };
