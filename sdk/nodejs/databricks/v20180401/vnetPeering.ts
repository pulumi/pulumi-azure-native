...
export class VNetPeering extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VNetPeering {
        pulumi.log.warn("VNetPeering is deprecated: Version 2018-04-01 will be removed in v2 of the provider.")
    ...
    constructor(name: string, args: VNetPeeringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databricks:vNetPeering" }, { type: "azure-native:databricks/v20210401preview:vNetPeering" }, { type: "azure-native:databricks/v20220401preview:vNetPeering" }, { type: "azure-native:databricks/v20230201:vNetPeering" }] };
