...
export class Workspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Workspace {
        pulumi.log.warn("Workspace is deprecated: azure-native:databricks/v20180401:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:databricks/v20230201:Workspace to guarantee forwards compatibility.")
        return new Workspace(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:databricks/v20180401:Workspace';
    ...
    constructor(name: string, args: WorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["parameters"] = args ? (args.parameters ? pulumi.output(args.parameters).apply(inputs.databricks.v20180401.workspaceCustomParametersArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databricks:Workspace" }, { type: "azure-native:databricks/v20210401preview:Workspace" }, { type: "azure-native:databricks/v20220401preview:Workspace" }, { type: "azure-native:databricks/v20230201:Workspace" }] };
...
export interface WorkspaceArgs {
     ...
     * The workspace provider authorizations.
     */
    authorizations?: pulumi.Input<pulumi.Input<inputs.databricks.v20180401.WorkspaceProviderAuthorizationArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The workspace's custom parameters.
     */
    parameters?: pulumi.Input<inputs.databricks.v20180401.WorkspaceCustomParametersArgs>;
    /**
     ...
     * The SKU of the resource.
     */
    sku?: pulumi.Input<inputs.databricks.v20180401.SkuArgs>;
    /**
     * Resource tags.
     */
