...
export function getConfigurationStore(args: GetConfigurationStoreArgs, opts?: pulumi.InvokeOptions): Promise<GetConfigurationStoreResult> {
    pulumi.log.warn("getConfigurationStore is deprecated: azure-native:appconfiguration/v20220301preview:ConfigurationStore is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:ConfigurationStore to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:appconfiguration/v20220301preview:getConfigurationStore", {
...
export interface GetConfigurationStoreResult {
     ...
     */
    readonly encryption?: outputs.appconfiguration.v20220301preview.EncryptionPropertiesResponse;
    /**
     ...
     */
    readonly identity?: outputs.appconfiguration.v20220301preview.ResourceIdentityResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.appconfiguration.v20220301preview.PrivateEndpointConnectionReferenceResponse[];
    /**
     ...
     */
    readonly sku: outputs.appconfiguration.v20220301preview.SkuResponse;
    /**
