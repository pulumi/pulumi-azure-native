 ...
 *
 * @deprecated azure-native:appconfiguration/v20220301preview:KeyValue is being removed in the next major version of this provider. Please upgrade to azure-native:appconfiguration/v20230301:KeyValue to guarantee forwards compatibility.
 */
export class KeyValue extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KeyValue {
        pulumi.log.warn("KeyValue is deprecated: azure-native:appconfiguration/v20220301preview:KeyValue is being removed in the next major version of this provider. Please upgrade to azure-native:appconfiguration/v20230301:KeyValue to guarantee forwards compatibility.")
        return new KeyValue(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:appconfiguration/v20220301preview:KeyValue';
