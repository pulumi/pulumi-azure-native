...
export class Replica extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Replica {
        pulumi.log.warn("Replica is deprecated: azure-native:appconfiguration/v20220301preview:Replica is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:Replica to guarantee forwards compatibility.")
        return new Replica(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:appconfiguration/v20220301preview:Replica';
    ...
    constructor(name: string, args: ReplicaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appconfiguration/v20230301:Replica" }] };
