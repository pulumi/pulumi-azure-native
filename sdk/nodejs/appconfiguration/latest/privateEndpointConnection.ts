 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:appconfiguration:PrivateEndpointConnection'.
 */
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:appconfiguration/latest:PrivateEndpointConnection';
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.appconfiguration.latest.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.appconfiguration.latest.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:appconfiguration:PrivateEndpointConnection" }, { type: "azure-nextgen:appconfiguration/v20191101preview:PrivateEndpointConnection" }, { type: "azure-nextgen:appconfiguration/v20200601:PrivateEndpointConnection" }, { type: "azure-nextgen:appconfiguration/v20200701preview:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * The resource of private endpoint.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.appconfiguration.latest.PrivateEndpoint>;
    /**
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Input<inputs.appconfiguration.latest.PrivateLinkServiceConnectionState>;
    /**
