...
export class ConfigurationStore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:appconfiguration/preview:ConfigurationStore';
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.appconfiguration.preview.EncryptionPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.appconfiguration.preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.appconfiguration.preview.PrivateEndpointConnectionReferenceResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.appconfiguration.preview.SkuResponse>;
    /**
    ...
    constructor(name: string, args: ConfigurationStoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appconfiguration/latest:ConfigurationStore" }, { type: "azurerm:appconfiguration/v20190201preview:ConfigurationStore" }, { type: "azurerm:appconfiguration/v20191001:ConfigurationStore" }, { type: "azurerm:appconfiguration/v20191101preview:ConfigurationStore" }, { type: "azurerm:appconfiguration/v20200601:ConfigurationStore" }] };
...
export interface ConfigurationStoreArgs {
     ...
     * The encryption settings of the configuration store.
     */
    readonly encryption?: pulumi.Input<inputs.appconfiguration.preview.EncryptionProperties>;
    /**
     * The managed identity information, if configured.
     */
    readonly identity?: pulumi.Input<inputs.appconfiguration.preview.ResourceIdentity>;
    /**
     * The location of the resource. This cannot be changed after the resource is created.
     */
     ...
     * The sku of the configuration store.
     */
    readonly sku: pulumi.Input<inputs.appconfiguration.preview.Sku>;
    /**
     * The tags of the resource.
     */
