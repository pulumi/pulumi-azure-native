 ...
 *
 * const configurationStore = new azure_native.appconfiguration.v20230301.ConfigurationStore("configurationStore", {
...
export class ConfigurationStore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appconfiguration/v20230301:ConfigurationStore';
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.appconfiguration.v20230301.EncryptionPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.appconfiguration.v20230301.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.appconfiguration.v20230301.PrivateEndpointConnectionReferenceResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.appconfiguration.v20230301.SkuResponse>;
    /**
...
export interface ConfigurationStoreArgs {
     ...
     */
    createMode?: pulumi.Input<enums.appconfiguration.v20230301.CreateMode>;
    /**
     * Disables all authentication methods other than AAD authentication.
     */
     ...
     * The encryption settings of the configuration store.
     */
    encryption?: pulumi.Input<inputs.appconfiguration.v20230301.EncryptionPropertiesArgs>;
    /**
     * The managed identity information, if configured.
     */
    identity?: pulumi.Input<inputs.appconfiguration.v20230301.ResourceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Control permission for data plane traffic coming from public networks while private endpoint is enabled.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.appconfiguration.v20230301.PublicNetworkAccess>;
    /**
     ...
     * The sku of the configuration store.
     */
    sku: pulumi.Input<inputs.appconfiguration.v20230301.SkuArgs>;
    /**
     * The amount of time in days that the configuration store will be retained when it is soft deleted.
     */
