...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:appconfiguration/latest:PrivateEndpointConnection" }, { type: "azure-nextgen:appconfiguration/v20200601:PrivateEndpointConnection" }] };
