 ...
 *
 * const privateEndpointConnection = new azurerm.appconfiguration.v20191101preview.PrivateEndpointConnection("privateEndpointConnection", {
...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:appconfiguration/v20191101preview:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appconfiguration/latest:PrivateEndpointConnection" }, { type: "azurerm:appconfiguration/v20200601:PrivateEndpointConnection" }] };
