...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appconfiguration/latest:PrivateEndpointConnection" }, { type: "azurerm:appconfiguration/preview:PrivateEndpointConnection" }, { type: "azurerm:appconfiguration/v20200601:PrivateEndpointConnection" }] };
