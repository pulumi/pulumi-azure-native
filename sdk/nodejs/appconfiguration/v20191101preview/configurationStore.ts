...
export class ConfigurationStore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:appconfiguration/v20191101preview:ConfigurationStore';
    ...
    constructor(name: string, args: ConfigurationStoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:appconfiguration:ConfigurationStore" }, { type: "azure-nextgen:appconfiguration/latest:ConfigurationStore" }, { type: "azure-nextgen:appconfiguration/v20190201preview:ConfigurationStore" }, { type: "azure-nextgen:appconfiguration/v20191001:ConfigurationStore" }, { type: "azure-nextgen:appconfiguration/v20200601:ConfigurationStore" }, { type: "azure-nextgen:appconfiguration/v20200701preview:ConfigurationStore" }] };
...
export interface ConfigurationStoreArgs {
     ...
     * The encryption settings of the configuration store.
     */
    readonly encryption?: pulumi.Input<inputs.appconfiguration.v20191101preview.EncryptionProperties>;
    /**
     * The managed identity information, if configured.
     */
    readonly identity?: pulumi.Input<inputs.appconfiguration.v20191101preview.ResourceIdentity>;
    /**
     * The location of the resource. This cannot be changed after the resource is created.
     */
     ...
     * The sku of the configuration store.
     */
    readonly sku: pulumi.Input<inputs.appconfiguration.v20191101preview.Sku>;
    /**
     * The tags of the resource.
     */
