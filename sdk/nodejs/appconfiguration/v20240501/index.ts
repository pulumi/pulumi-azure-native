...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:appconfiguration/v20240501:ConfigurationStore":
                return new ConfigurationStore(name, <any>undefined, { urn })
            case "azure-native:appconfiguration/v20240501:KeyValue":
                return new KeyValue(name, <any>undefined, { urn })
            case "azure-native:appconfiguration/v20240501:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:appconfiguration/v20240501:Replica":
...
pulumi.runtime.registerResourceModule("azure-native", "appconfiguration/v20240501", _module)
