...
export class ConfigurationStore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appconfiguration/v20240501:ConfigurationStore';
     ...
     */
    public readonly dataPlaneProxy!: pulumi.Output<outputs.appconfiguration.v20240501.DataPlaneProxyPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.appconfiguration.v20240501.EncryptionPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.appconfiguration.v20240501.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.appconfiguration.v20240501.PrivateEndpointConnectionReferenceResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.appconfiguration.v20240501.SkuResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.appconfiguration.v20240501.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ConfigurationStoreArgs {
     ...
     */
    createMode?: pulumi.Input<enums.appconfiguration.v20240501.CreateMode>;
    /**
     * Property specifying the configuration of data plane proxy for Azure Resource Manager (ARM).
     */
    dataPlaneProxy?: pulumi.Input<inputs.appconfiguration.v20240501.DataPlaneProxyPropertiesArgs>;
    /**
     * Disables all authentication methods other than AAD authentication.
     */
     ...
     * The encryption settings of the configuration store.
     */
    encryption?: pulumi.Input<inputs.appconfiguration.v20240501.EncryptionPropertiesArgs>;
    /**
     * The managed identity information, if configured.
     */
    identity?: pulumi.Input<inputs.appconfiguration.v20240501.ResourceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Control permission for data plane traffic coming from public networks while private endpoint is enabled.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.appconfiguration.v20240501.PublicNetworkAccess>;
    /**
     ...
     * The sku of the configuration store.
     */
    sku: pulumi.Input<inputs.appconfiguration.v20240501.SkuArgs>;
    /**
     * The amount of time in days that the configuration store will be retained when it is soft deleted.
     */
