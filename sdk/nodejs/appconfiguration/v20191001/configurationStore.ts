...
export class ConfigurationStore extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ConfigurationStoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:appconfiguration/latest:ConfigurationStore" }, { type: "azurerm:appconfiguration/v20190201preview:ConfigurationStore" }, { type: "azurerm:appconfiguration/v20191101preview:ConfigurationStore" }, { type: "azurerm:appconfiguration/v20200601:ConfigurationStore" }] };
