...
export class RoleEligibilityScheduleInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization:RoleEligibilityScheduleInstance';
     ...
     */
    public /*out*/ readonly expandedProperties!: pulumi.Output<outputs.authorization.ExpandedPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: RoleEligibilityScheduleInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization/v20201001:RoleEligibilityScheduleInstance" }, { type: "azure-native:authorization/v20201001preview:RoleEligibilityScheduleInstance" }] };
