...
export class PimRoleEligibilitySchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20240201preview:PimRoleEligibilitySchedule';
