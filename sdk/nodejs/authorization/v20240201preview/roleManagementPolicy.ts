...
export class RoleManagementPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20240201preview:RoleManagementPolicy';
     ...
     */
    public /*out*/ readonly lastModifiedBy!: pulumi.Output<outputs.authorization.v20240201preview.PrincipalResponse>;
    /**
     ...
     */
    public /*out*/ readonly policyProperties!: pulumi.Output<outputs.authorization.v20240201preview.PolicyPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RoleManagementPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization:RoleManagementPolicy" }, { type: "azure-native:authorization/v20201001:RoleManagementPolicy" }, { type: "azure-native:authorization/v20201001preview:RoleManagementPolicy" }, { type: "azure-native:authorization/v20240901preview:RoleManagementPolicy" }] };
