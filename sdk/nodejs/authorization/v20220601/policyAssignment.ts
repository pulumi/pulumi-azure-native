 ...
 *
 * const policyAssignment = new azure_native.authorization.v20220601.PolicyAssignment("policyAssignment", {
 ...
 *     identity: {
 *         type: azure_native.authorization.v20220601.ResourceIdentityType.SystemAssigned,
 *     },
 *     location: "eastus",
 *     metadata: {
 *         assignedBy: "Foo Bar",
 ...
 *     enforcementMode: "Default",
 *     identity: {
 *         type: azure_native.authorization.v20220601.ResourceIdentityType.UserAssigned,
...
export class PolicyAssignment extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.authorization.v20220601.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly nonComplianceMessages!: pulumi.Output<outputs.authorization.v20220601.NonComplianceMessageResponse[] | undefined>;
    /**
     ...
     */
    public readonly overrides!: pulumi.Output<outputs.authorization.v20220601.OverrideResponse[] | undefined>;
    /**
     * The parameter values for the assigned policy rule. The keys are the parameter names.
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.authorization.v20220601.ParameterValuesValueResponse} | undefined>;
    /**
     ...
     */
    public readonly resourceSelectors!: pulumi.Output<outputs.authorization.v20220601.ResourceSelectorResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.authorization.v20220601.SystemDataResponse>;
    /**
...
export interface PolicyAssignmentArgs {
     ...
     * The policy assignment enforcement mode. Possible values are Default and DoNotEnforce.
     */
    enforcementMode?: pulumi.Input<string | enums.authorization.v20220601.EnforcementMode>;
    /**
     * The managed identity associated with the policy assignment.
     */
    identity?: pulumi.Input<inputs.authorization.v20220601.IdentityArgs>;
    /**
     * The location of the policy assignment. Only required when utilizing managed identity.
     */
     ...
     * The messages that describe why a resource is non-compliant with the policy.
     */
    nonComplianceMessages?: pulumi.Input<pulumi.Input<inputs.authorization.v20220601.NonComplianceMessageArgs>[]>;
    /**
     * The policy's excluded scopes.
     */
     ...
     * The policy property value override.
     */
    overrides?: pulumi.Input<pulumi.Input<inputs.authorization.v20220601.OverrideArgs>[]>;
    /**
     * The parameter values for the assigned policy rule. The keys are the parameter names.
     */
    parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.authorization.v20220601.ParameterValuesValueArgs>}>;
    /**
     * The name of the policy assignment.
     */
     ...
     * The resource selector list to filter policies by resource properties.
     */
    resourceSelectors?: pulumi.Input<pulumi.Input<inputs.authorization.v20220601.ResourceSelectorArgs>[]>;
    /**
