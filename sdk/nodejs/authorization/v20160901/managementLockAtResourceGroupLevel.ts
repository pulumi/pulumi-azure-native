...
export class ManagementLockAtResourceGroupLevel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagementLockAtResourceGroupLevel {
        return new ManagementLockAtResourceGroupLevel(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/v20160901:ManagementLockAtResourceGroupLevel';
    ...
    constructor(name: string, argsOrState?: ManagementLockAtResourceGroupLevelArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ManagementLockAtResourceGroupLevelArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/latest:ManagementLockAtResourceGroupLevel" }, { type: "azurerm:authorization/preview:ManagementLockAtResourceGroupLevel" }, { type: "azurerm:authorization/v20150101:ManagementLockAtResourceGroupLevel" }] };
