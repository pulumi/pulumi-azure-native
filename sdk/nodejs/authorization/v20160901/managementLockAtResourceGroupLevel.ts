...
export class ManagementLockAtResourceGroupLevel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:authorization/v20160901:ManagementLockAtResourceGroupLevel';
    ...
    constructor(name: string, args: ManagementLockAtResourceGroupLevelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:authorization:ManagementLockAtResourceGroupLevel" }, { type: "azure-nextgen:authorization/latest:ManagementLockAtResourceGroupLevel" }, { type: "azure-nextgen:authorization/v20150101:ManagementLockAtResourceGroupLevel" }] };
