...
export class ManagementLockAtResourceLevel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagementLockAtResourceLevel {
        pulumi.log.warn("ManagementLockAtResourceLevel is deprecated: Version 2016-09-01 will be removed in v2 of the provider.")
    ...
    constructor(name: string, args: ManagementLockAtResourceLevelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization:ManagementLockAtResourceLevel" }, { type: "azure-native:authorization/v20170401:ManagementLockAtResourceLevel" }, { type: "azure-native:authorization/v20200501:ManagementLockAtResourceLevel" }] };
...
export interface ManagementLockAtResourceLevelArgs {
     ...
     * The properties of the lock.
     */
    properties: pulumi.Input<inputs.authorization.v20160901.ManagementLockPropertiesArgs>;
    /**
