...
export class ManagementLockByScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20160901:ManagementLockByScope';
    ...
    constructor(name: string, args: ManagementLockByScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:authorization/v20160901:ManagementLockByScope" }, { type: "azure-native:authorization:ManagementLockByScope" }, { type: "azure-nextgen:authorization:ManagementLockByScope" }, { type: "azure-native:authorization/v20170401:ManagementLockByScope" }, { type: "azure-nextgen:authorization/v20170401:ManagementLockByScope" }, { type: "azure-native:authorization/v20200501:ManagementLockByScope" }, { type: "azure-nextgen:authorization/v20200501:ManagementLockByScope" }] };
