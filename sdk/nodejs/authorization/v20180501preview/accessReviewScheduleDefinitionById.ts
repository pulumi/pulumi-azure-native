 ...
 *
 * @deprecated azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById to guarantee forwards compatibility.
 */
export class AccessReviewScheduleDefinitionById extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AccessReviewScheduleDefinitionById {
        pulumi.log.warn("AccessReviewScheduleDefinitionById is deprecated: azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById to guarantee forwards compatibility.")
        return new AccessReviewScheduleDefinitionById(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById';
     ...
     */
    public readonly instances!: pulumi.Output<outputs.authorization.v20180501preview.AccessReviewInstanceResponse[] | undefined>;
    /**
     ...
     */
    public readonly reviewers!: pulumi.Output<outputs.authorization.v20180501preview.AccessReviewReviewerResponse[] | undefined>;
    /**
...
export interface AccessReviewScheduleDefinitionByIdArgs {
     ...
     * This specifies the behavior for the autoReview feature when an access review completes.
     */
    defaultDecision?: pulumi.Input<string | enums.authorization.v20180501preview.DefaultDecisionType>;
    /**
     * Flag to indicate whether reviewers are required to provide a justification when reviewing access.
     */
     ...
     * This is the collection of instances returned when one does an expand on it.
     */
    instances?: pulumi.Input<pulumi.Input<inputs.authorization.v20180501preview.AccessReviewInstanceArgs>[]>;
    /**
     * The interval for recurrence. For a quarterly review, the interval is 3 for type : absoluteMonthly.
     */
     ...
     * This is the collection of reviewers.
     */
    reviewers?: pulumi.Input<pulumi.Input<inputs.authorization.v20180501preview.AccessReviewReviewerArgs>[]>;
    /**
     ...
     */
    type?: pulumi.Input<string | enums.authorization.v20180501preview.AccessReviewRecurrenceRangeType>;
}
