 ...
 *
 * @deprecated azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById to guarantee forwards compatibility.
 */
export class AccessReviewScheduleDefinitionById extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AccessReviewScheduleDefinitionById {
        pulumi.log.warn("AccessReviewScheduleDefinitionById is deprecated: azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById to guarantee forwards compatibility.")
