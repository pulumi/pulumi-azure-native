...
export function getPolicyDefinition(args: GetPolicyDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:authorization/preview:getPolicyDefinition", {
...
export interface GetPolicyDefinitionResult {
     ...
     */
    readonly parameters?: {[key: string]: outputs.authorization.preview.ParameterDefinitionsValueResponse};
    /**
     * The policy rule.
     */
