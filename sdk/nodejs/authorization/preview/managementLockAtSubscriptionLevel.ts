...
export class ManagementLockAtSubscriptionLevel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/preview:ManagementLockAtSubscriptionLevel';
     ...
     */
    public readonly owners!: pulumi.Output<outputs.authorization.preview.ManagementLockOwnerResponse[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagementLockAtSubscriptionLevelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/latest:ManagementLockAtSubscriptionLevel" }, { type: "azurerm:authorization/v20150101:ManagementLockAtSubscriptionLevel" }, { type: "azurerm:authorization/v20160901:ManagementLockAtSubscriptionLevel" }] };
...
export interface ManagementLockAtSubscriptionLevelArgs {
     ...
     * The owners of the lock.
     */
    readonly owners?: pulumi.Input<pulumi.Input<inputs.authorization.preview.ManagementLockOwner>[]>;
}
