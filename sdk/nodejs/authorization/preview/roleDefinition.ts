...
export class RoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/preview:RoleDefinition';
     ...
     */
    public readonly permissions!: pulumi.Output<outputs.authorization.preview.PermissionResponse[] | undefined>;
    /**
     * The role name.
     */
    ...
    constructor(name: string, args: RoleDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/latest:RoleDefinition" }, { type: "azurerm:authorization/v20150701:RoleDefinition" }, { type: "azurerm:authorization/v20180101preview:RoleDefinition" }] };
...
export interface RoleDefinitionArgs {
     ...
     * Role definition permissions.
     */
    readonly permissions?: pulumi.Input<pulumi.Input<inputs.authorization.preview.Permission>[]>;
    /**
