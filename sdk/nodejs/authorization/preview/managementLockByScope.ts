...
export class ManagementLockByScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/preview:ManagementLockByScope';
    ...
    constructor(name: string, argsOrState?: ManagementLockByScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/latest:ManagementLockByScope" }, { type: "azurerm:authorization/v20160901:ManagementLockByScope" }] };
