...
export class PolicySetDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/preview:PolicySetDefinition';
     ...
     */
    public readonly policyDefinitionGroups!: pulumi.Output<outputs.authorization.preview.PolicyDefinitionGroupResponse[] | undefined>;
    /**
     * An array of policy definition references.
     */
    public readonly policyDefinitions!: pulumi.Output<outputs.authorization.preview.PolicyDefinitionReferenceResponse[]>;
    /**
    ...
    constructor(name: string, args: PolicySetDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/latest:PolicySetDefinition" }, { type: "azurerm:authorization/v20170601preview:PolicySetDefinition" }, { type: "azurerm:authorization/v20180301:PolicySetDefinition" }, { type: "azurerm:authorization/v20180501:PolicySetDefinition" }, { type: "azurerm:authorization/v20190101:PolicySetDefinition" }, { type: "azurerm:authorization/v20190601:PolicySetDefinition" }, { type: "azurerm:authorization/v20190901:PolicySetDefinition" }, { type: "azurerm:authorization/v20200301:PolicySetDefinition" }] };
...
export interface PolicySetDefinitionArgs {
     ...
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    readonly policyDefinitionGroups?: pulumi.Input<pulumi.Input<inputs.authorization.preview.PolicyDefinitionGroup>[]>;
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: pulumi.Input<pulumi.Input<inputs.authorization.preview.PolicyDefinitionReference>[]>;
    /**
