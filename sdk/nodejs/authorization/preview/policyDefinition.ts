...
export class PolicyDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/preview:PolicyDefinition';
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.authorization.preview.ParameterDefinitionsValueResponse} | undefined>;
    /**
     * The policy rule.
     */
    ...
    constructor(name: string, argsOrState?: PolicyDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/latest:PolicyDefinition" }, { type: "azurerm:authorization/v20151001preview:PolicyDefinition" }, { type: "azurerm:authorization/v20151101:PolicyDefinition" }, { type: "azurerm:authorization/v20160401:PolicyDefinition" }, { type: "azurerm:authorization/v20161201:PolicyDefinition" }, { type: "azurerm:authorization/v20180301:PolicyDefinition" }, { type: "azurerm:authorization/v20180501:PolicyDefinition" }, { type: "azurerm:authorization/v20190101:PolicyDefinition" }, { type: "azurerm:authorization/v20190601:PolicyDefinition" }, { type: "azurerm:authorization/v20190901:PolicyDefinition" }, { type: "azurerm:authorization/v20200301:PolicyDefinition" }] };
...
export interface PolicyDefinitionArgs {
     ...
     * The parameter definitions for parameters used in the policy rule. The keys are the parameter names.
     */
    readonly parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.authorization.preview.ParameterDefinitionsValue>}>;
    /**
