...
export class PolicyExemption extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/preview:PolicyExemption';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.authorization.preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: PolicyExemptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/v20200701preview:PolicyExemption" }] };
