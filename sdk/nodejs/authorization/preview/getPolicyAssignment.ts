...
export function getPolicyAssignment(args: GetPolicyAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyAssignmentResult> {
    ...
    return pulumi.runtime.invoke("azurerm:authorization/preview:getPolicyAssignment", {
...
export interface GetPolicyAssignmentResult {
     ...
     */
    readonly identity?: outputs.authorization.preview.IdentityResponse;
    /**
     ...
     */
    readonly parameters?: {[key: string]: outputs.authorization.preview.ParameterValuesValueResponse};
    /**
     ...
     */
    readonly sku?: outputs.authorization.preview.PolicySkuResponse;
    /**
