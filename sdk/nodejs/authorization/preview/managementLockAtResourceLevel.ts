...
export class ManagementLockAtResourceLevel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/preview:ManagementLockAtResourceLevel';
    ...
    constructor(name: string, argsOrState?: ManagementLockAtResourceLevelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/latest:ManagementLockAtResourceLevel" }, { type: "azurerm:authorization/v20160901:ManagementLockAtResourceLevel" }] };
