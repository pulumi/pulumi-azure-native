...
export class PolicyAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/preview:PolicyAssignment';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.authorization.preview.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.authorization.preview.ParameterValuesValueResponse} | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.authorization.preview.PolicySkuResponse | undefined>;
    /**
...
export interface PolicyAssignmentArgs {
     ...
     * The managed identity associated with the policy assignment.
     */
    readonly identity?: pulumi.Input<inputs.authorization.preview.Identity>;
    /**
     * The location of the policy assignment. Only required when utilizing managed identity.
     */
     ...
     * The parameter values for the assigned policy rule. The keys are the parameter names.
     */
    readonly parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.authorization.preview.ParameterValuesValue>}>;
    /**
     * The name of the policy assignment.
     */
     ...
     * The policy sku. This property is optional, obsolete, and will be ignored.
     */
    readonly sku?: pulumi.Input<inputs.authorization.preview.PolicySku>;
}
