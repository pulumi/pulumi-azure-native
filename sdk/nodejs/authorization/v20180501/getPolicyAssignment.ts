...
export function getPolicyAssignment(args: GetPolicyAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyAssignmentResult> {
    ...
    return pulumi.runtime.invoke("azurerm:authorization/v20180501:getPolicyAssignment", {
        "name": args.name,
        "scope": args.scope,
    }, opts);
}
...
export interface GetPolicyAssignmentResult {
     ...
     */
    readonly properties: outputs.authorization.v20180501.PolicyAssignmentPropertiesResponse;
    /**
