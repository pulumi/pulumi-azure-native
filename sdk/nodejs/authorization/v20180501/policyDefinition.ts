...
export class PolicyDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly mode!: pulumi.Output<policyMode | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PolicyDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/v20161201:PolicyDefinition" }, { type: "azurerm:authorization/v20180301:PolicyDefinition" }, { type: "azurerm:authorization/v20190101:PolicyDefinition" }, { type: "azurerm:authorization/v20190601:PolicyDefinition" }, { type: "azurerm:authorization/v20190901:PolicyDefinition" }] };
...
export interface PolicyDefinitionArgs {
     ...
     * The policy definition mode. Possible values are NotSpecified, Indexed, and All.
     */
    readonly mode?: pulumi.Input<policyMode>;
    /**
     * Required if a parameter is used in policy rule.
     */
