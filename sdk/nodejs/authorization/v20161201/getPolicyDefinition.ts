...
export function getPolicyDefinition(args: GetPolicyDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:authorization/v20161201:getPolicyDefinition", {
        "name": args.name,
    }, opts);
}
...
export interface GetPolicyDefinitionResult {
     ...
     */
    readonly properties: outputs.authorization.v20161201.PolicyDefinitionPropertiesResponse;
}
