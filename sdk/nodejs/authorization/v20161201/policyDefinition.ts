...
export class PolicyDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.authorization.v20161201.PolicyDefinitionPropertiesResponse>;
...
export interface PolicyDefinitionArgs {
     ...
     * The policy definition properties.
     */
    readonly properties?: pulumi.Input<inputs.authorization.v20161201.PolicyDefinitionProperties>;
}
