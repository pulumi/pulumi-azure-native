...
export class PolicyDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization:PolicyDefinition';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.authorization.PolicyDefinitionPropertiesResponse>;
    /**
...
export interface PolicyDefinitionState {
     ...
     * The policy definition properties.
     */
    readonly properties: pulumi.Input<inputs.authorization.PolicyDefinitionPropertiesResponse>;
    /**
     * The type of the resource (Microsoft.Authorization/policyDefinitions).
     */
...
export interface PolicyDefinitionArgs {
     ...
     * The policy definition properties.
     */
    readonly properties?: pulumi.Input<inputs.authorization.PolicyDefinitionProperties>;
}
