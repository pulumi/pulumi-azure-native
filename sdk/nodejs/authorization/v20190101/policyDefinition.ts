...
export class PolicyDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PolicyDefinition {
        pulumi.log.warn("PolicyDefinition is deprecated: azure-native:authorization/v20190101:PolicyDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20190601:PolicyDefinition to guarantee forwards compatibility.")
