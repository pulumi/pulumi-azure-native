...
export class PolicyDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.authorization.v20190101.PolicyDefinitionPropertiesResponse>;
    /**
...
export interface PolicyDefinitionArgs {
     ...
     * The policy definition properties.
     */
    readonly properties?: pulumi.Input<inputs.authorization.v20190101.PolicyDefinitionProperties>;
}
