...
export function getPolicyDefinitionAtManagementGroup(args: GetPolicyDefinitionAtManagementGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyDefinitionAtManagementGroupResult> {
    pulumi.log.warn("getPolicyDefinitionAtManagementGroup is deprecated: azure-native:authorization/v20190101:PolicyDefinitionAtManagementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20190601:PolicyDefinitionAtManagementGroup to guarantee forwards compatibility.")
