 ...
 *
 * @deprecated azure-native:authorization/v20190101:PolicySetDefinitionAtManagementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20190601:PolicySetDefinitionAtManagementGroup to guarantee forwards compatibility.
 */
export class PolicySetDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20190101:PolicySetDefinitionAtManagementGroup';
...
export interface PolicySetDefinitionAtManagementGroupArgs {
     ...
     * An array of policy definition references.
     */
    policyDefinitions: pulumi.Input<pulumi.Input<inputs.authorization.v20190101.PolicyDefinitionReferenceArgs>[]>;
    /**
