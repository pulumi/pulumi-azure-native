...
export interface PolicySetDefinitionAtManagementGroupArgs {
     ...
     * An array of policy definition references.
     */
    readonly policyDefinitions: pulumi.Input<pulumi.Input<inputs.authorization.v20190101.PolicyDefinitionReferenceArgs>[]>;
    /**
