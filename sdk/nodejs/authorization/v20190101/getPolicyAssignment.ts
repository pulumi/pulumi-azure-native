...
export function getPolicyAssignment(args: GetPolicyAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyAssignmentResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:authorization/v20190101:getPolicyAssignment", {
...
export interface GetPolicyAssignmentResult {
     ...
     */
    readonly identity?: outputs.authorization.v20190101.IdentityInvokeResponse;
    /**
     ...
     */
    readonly sku?: outputs.authorization.v20190101.PolicySkuInvokeResponse;
    /**
