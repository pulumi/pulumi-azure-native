...
export class RoleAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/latest:RoleAssignment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.authorization.latest.RoleAssignmentPropertiesWithScopeResponse>;
    /**
    ...
    constructor(name: string, args: RoleAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/preview:RoleAssignment" }, { type: "azurerm:authorization/v20150701:RoleAssignment" }, { type: "azurerm:authorization/v20171001preview:RoleAssignment" }, { type: "azurerm:authorization/v20180101preview:RoleAssignment" }, { type: "azurerm:authorization/v20180901preview:RoleAssignment" }, { type: "azurerm:authorization/v20200401preview:RoleAssignment" }] };
...
export interface RoleAssignmentArgs {
     ...
     * Role assignment properties.
     */
    readonly properties: pulumi.Input<inputs.authorization.latest.RoleAssignmentProperties>;
    /**
