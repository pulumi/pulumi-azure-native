...
export class ManagementLockAtResourceLevel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/latest:ManagementLockAtResourceLevel';
    ...
    constructor(name: string, argsOrState?: ManagementLockAtResourceLevelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/preview:ManagementLockAtResourceLevel" }, { type: "azurerm:authorization/v20160901:ManagementLockAtResourceLevel" }] };
