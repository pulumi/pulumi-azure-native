 ...
 *
 * const roleAssignment = new azurerm.authorization.v20180101preview.RoleAssignment("roleAssignment", {
 *     canDelegate: false,
...
export class RoleAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/v20180101preview:RoleAssignment';
    ...
    constructor(name: string, args: RoleAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/latest:RoleAssignment" }, { type: "azurerm:authorization/v20150701:RoleAssignment" }, { type: "azurerm:authorization/v20171001preview:RoleAssignment" }, { type: "azurerm:authorization/v20180901preview:RoleAssignment" }, { type: "azurerm:authorization/v20200401preview:RoleAssignment" }] };
