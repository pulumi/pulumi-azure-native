...
export function getRoleDefinition(args: GetRoleDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetRoleDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:authorization/v20180101preview:getRoleDefinition", {
...
export interface GetRoleDefinitionResult {
     ...
     */
    readonly permissions?: outputs.authorization.v20180101preview.PermissionInvokeResponse[];
    /**
     * The role name.
     */
