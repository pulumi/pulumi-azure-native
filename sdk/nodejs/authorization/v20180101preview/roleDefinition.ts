...
export class RoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/v20180101preview:RoleDefinition';
    ...
    constructor(name: string, argsOrState?: RoleDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/latest:RoleDefinition" }, { type: "azurerm:authorization/preview:RoleDefinition" }, { type: "azurerm:authorization/v20150701:RoleDefinition" }] };
