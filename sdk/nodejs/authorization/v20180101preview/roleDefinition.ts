...
export class RoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:authorization/v20180101preview:RoleDefinition';
    ...
    constructor(name: string, args: RoleDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:authorization:RoleDefinition" }, { type: "azure-nextgen:authorization/latest:RoleDefinition" }, { type: "azure-nextgen:authorization/v20150701:RoleDefinition" }, { type: "azure-nextgen:authorization/v20200301preview:RoleDefinition" }] };
