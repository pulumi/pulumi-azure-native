...
export class RoleDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RoleDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/latest:RoleDefinition" }, { type: "azurerm:authorization/preview:RoleDefinition" }, { type: "azurerm:authorization/v20180101preview:RoleDefinition" }] };
