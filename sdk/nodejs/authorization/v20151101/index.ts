...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:authorization/v20151101:PolicyAssignment":
                return new PolicyAssignment(name, <any>undefined, { urn })
            case "azure-nextgen:authorization/v20151101:PolicyDefinition":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "authorization/v20151101", _module)
