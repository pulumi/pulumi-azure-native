...
export class PolicyDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20250301:PolicyDefinitionAtManagementGroup';
     ...
     */
    public readonly externalEvaluationEnforcementSettings!: pulumi.Output<outputs.authorization.v20250301.ExternalEvaluationEnforcementSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.authorization.v20250301.ParameterDefinitionsValueResponse} | undefined>;
    /**
     * The policy rule.
     */
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.authorization.v20250301.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: PolicyDefinitionAtManagementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["externalEvaluationEnforcementSettings"] = args ? args.externalEvaluationEnforcementSettings : undefined;
            ...
            resourceInputs["externalEvaluationEnforcementSettings"] = undefined /*out*/;
...
export interface PolicyDefinitionAtManagementGroupArgs {
     ...
     * The details of the source of external evaluation results required by the policy during enforcement evaluation.
     */
    externalEvaluationEnforcementSettings?: pulumi.Input<inputs.authorization.v20250301.ExternalEvaluationEnforcementSettingsArgs>;
    /**
     ...
     * The parameter definitions for parameters used in the policy rule. The keys are the parameter names.
     */
    parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.authorization.v20250301.ParameterDefinitionsValueArgs>}>;
    /**
     ...
     * The type of policy definition. Possible values are NotSpecified, BuiltIn, Custom, and Static.
     */
    policyType?: pulumi.Input<string | enums.authorization.v20250301.PolicyType>;
    /**
     * The policy definition version in #.#.# format.
     */
