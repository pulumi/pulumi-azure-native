...
export class PolicyAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20250301:PolicyAssignment';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.authorization.v20250301.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly nonComplianceMessages!: pulumi.Output<outputs.authorization.v20250301.NonComplianceMessageResponse[] | undefined>;
    /**
     ...
     */
    public readonly overrides!: pulumi.Output<outputs.authorization.v20250301.OverrideResponse[] | undefined>;
    /**
     * The parameter values for the assigned policy rule. The keys are the parameter names.
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.authorization.v20250301.ParameterValuesValueResponse} | undefined>;
    /**
     ...
     */
    public readonly resourceSelectors!: pulumi.Output<outputs.authorization.v20250301.ResourceSelectorResponse[] | undefined>;
    /**
...
export interface PolicyAssignmentArgs {
     ...
     * The type of policy assignment. Possible values are NotSpecified, System, SystemHidden, and Custom. Immutable.
     */
    assignmentType?: pulumi.Input<string | enums.authorization.v20250301.AssignmentType>;
    /**
     * The version of the policy definition to use.
     */
     ...
     * The policy assignment enforcement mode. Possible values are Default, DoNotEnforce, and Enroll
     */
    enforcementMode?: pulumi.Input<string | enums.authorization.v20250301.EnforcementMode>;
    /**
     * The managed identity associated with the policy assignment.
     */
    identity?: pulumi.Input<inputs.authorization.v20250301.IdentityArgs>;
    /**
     * The location of the policy assignment. Only required when utilizing managed identity.
     */
     ...
     * The messages that describe why a resource is non-compliant with the policy.
     */
    nonComplianceMessages?: pulumi.Input<pulumi.Input<inputs.authorization.v20250301.NonComplianceMessageArgs>[]>;
    /**
     * The policy's excluded scopes.
     */
     ...
     * The policy property value override.
     */
    overrides?: pulumi.Input<pulumi.Input<inputs.authorization.v20250301.OverrideArgs>[]>;
    /**
     * The parameter values for the assigned policy rule. The keys are the parameter names.
     */
    parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.authorization.v20250301.ParameterValuesValueArgs>}>;
    /**
     * The name of the policy assignment.
     */
     ...
     * The resource selector list to filter policies by resource properties.
     */
    resourceSelectors?: pulumi.Input<pulumi.Input<inputs.authorization.v20250301.ResourceSelectorArgs>[]>;
    /**
