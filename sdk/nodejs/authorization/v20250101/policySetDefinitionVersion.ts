...
export class PolicySetDefinitionVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20250101:PolicySetDefinitionVersion';
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.authorization.v20250101.ParameterDefinitionsValueResponse} | undefined>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    public readonly policyDefinitionGroups!: pulumi.Output<outputs.authorization.v20250101.PolicyDefinitionGroupResponse[] | undefined>;
    /**
     * An array of policy definition references.
     */
    public readonly policyDefinitions!: pulumi.Output<outputs.authorization.v20250101.PolicyDefinitionReferenceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.authorization.v20250101.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: PolicySetDefinitionVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization/v20230401:PolicySetDefinitionVersion" }, { type: "azure-native:authorization/v20240501:PolicySetDefinitionVersion" }, { type: "azure-native:authorization/v20250301:PolicySetDefinitionVersion" }, { type: "azure-native:authorization:PolicySetDefinitionVersion" }] };
...
export interface PolicySetDefinitionVersionArgs {
     ...
     * The policy set definition parameters that can be used in policy definition references.
     */
    parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.authorization.v20250101.ParameterDefinitionsValueArgs>}>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    policyDefinitionGroups?: pulumi.Input<pulumi.Input<inputs.authorization.v20250101.PolicyDefinitionGroupArgs>[]>;
    /**
     ...
     * An array of policy definition references.
     */
    policyDefinitions: pulumi.Input<pulumi.Input<inputs.authorization.v20250101.PolicyDefinitionReferenceArgs>[]>;
    /**
     ...
     * The type of policy definition. Possible values are NotSpecified, BuiltIn, Custom, and Static.
     */
    policyType?: pulumi.Input<string | enums.authorization.v20250101.PolicyType>;
    /**
     * The policy set definition version in #.#.# format.
     */
