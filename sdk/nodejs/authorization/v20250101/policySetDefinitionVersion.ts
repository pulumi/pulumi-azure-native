...
export class PolicySetDefinitionVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PolicySetDefinitionVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization:PolicySetDefinitionVersion" }, { type: "azure-native:authorization/v20230401:PolicySetDefinitionVersion" }, { type: "azure-native:authorization/v20240501:PolicySetDefinitionVersion" }] };
