...
export function getPolicySetDefinitionVersion(args: GetPolicySetDefinitionVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicySetDefinitionVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:authorization/v20250101:getPolicySetDefinitionVersion", {
        "expand": args.expand,
...
export interface GetPolicySetDefinitionVersionResult {
     ...
     */
    readonly parameters?: {[key: string]: outputs.authorization.v20250101.ParameterDefinitionsValueResponse};
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    readonly policyDefinitionGroups?: outputs.authorization.v20250101.PolicyDefinitionGroupResponse[];
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: outputs.authorization.v20250101.PolicyDefinitionReferenceResponse[];
    /**
     ...
     */
    readonly systemData: outputs.authorization.v20250101.SystemDataResponse;
    /**
