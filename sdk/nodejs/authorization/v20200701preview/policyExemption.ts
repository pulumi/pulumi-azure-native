...
export class PolicyExemption extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PolicyExemptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:authorization/v20200701preview:PolicyExemption" }, { type: "azure-native:authorization:PolicyExemption" }, { type: "azure-nextgen:authorization:PolicyExemption" }, { type: "azure-native:authorization/v20210701:PolicyExemption" }, { type: "azure-nextgen:authorization/v20210701:PolicyExemption" }] };
