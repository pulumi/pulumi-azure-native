...
export class PolicyExemption extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PolicyExemption {
        pulumi.log.warn("PolicyExemption is deprecated: azure-native:authorization/v20200701preview:PolicyExemption is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20220701preview:PolicyExemption to guarantee forwards compatibility.")
