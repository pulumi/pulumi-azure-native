...
export class PimRoleEligibilitySchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20220401preview:PimRoleEligibilitySchedule';
     ...
     */
    public /*out*/ readonly expandedProperties!: pulumi.Output<outputs.authorization.v20220401preview.ExpandedPropertiesResponse>;
    /**
     ...
     */
    public readonly scheduleInfo!: pulumi.Output<outputs.authorization.v20220401preview.RoleEligibilityScheduleRequestPropertiesResponseScheduleInfo | undefined>;
    /**
     ...
     */
    public readonly ticketInfo!: pulumi.Output<outputs.authorization.v20220401preview.RoleEligibilityScheduleRequestPropertiesResponseTicketInfo | undefined>;
    /**
...
export interface PimRoleEligibilityScheduleArgs {
     ...
     * The type of the role assignment schedule request. Eg: SelfActivate, AdminAssign etc
     */
    requestType: pulumi.Input<string | enums.authorization.v20220401preview.RequestType>;
    /**
     * The role definition ID.
     */
     ...
     * Schedule info of the role eligibility schedule
     */
    scheduleInfo?: pulumi.Input<inputs.authorization.v20220401preview.RoleEligibilityScheduleRequestPropertiesScheduleInfoArgs>;
    /**
     ...
     * Ticket Info of the role eligibility
     */
    ticketInfo?: pulumi.Input<inputs.authorization.v20220401preview.RoleEligibilityScheduleRequestPropertiesTicketInfoArgs>;
}
