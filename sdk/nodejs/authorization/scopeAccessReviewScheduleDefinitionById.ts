...
export class ScopeAccessReviewScheduleDefinitionById extends pulumi.CustomResource {
     ...
     */
    public readonly scope!: pulumi.Output<outputs.authorization.AccessReviewScopeResponse>;
    /**
    ...
    constructor(name: string, args: ScopeAccessReviewScheduleDefinitionByIdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization/v20211201preview:ScopeAccessReviewScheduleDefinitionById" }, { type: "azure-native_authorization_v20211201preview:authorization:ScopeAccessReviewScheduleDefinitionById" }] };
