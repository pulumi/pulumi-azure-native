...
export class ResourceManagementPrivateLink extends pulumi.CustomResource {
    ...
    public /*out*/ readonly properties!: pulumi.Output<outputs.authorization.v20200501.ResourceManagementPrivateLinkEndpointConnectionsResponse>;
    /**
     * The operation type.
     */
    ...
    constructor(name: string, args: ResourceManagementPrivateLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["rmplName"] = args ? args.rmplName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:authorization/v20200501:ResourceManagementPrivateLink" }, { type: "azure-native:authorization:ResourceManagementPrivateLink" }, { type: "azure-nextgen:authorization:ResourceManagementPrivateLink" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(ResourceManagementPrivateLink.__pulumiType, name, inputs, opts);
    }
}
