...
export class AccessReviewScheduleDefinitionById extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: AccessReviewScheduleDefinitionByIdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById" }, { type: "azure-nextgen:authorization/v20180501preview:AccessReviewScheduleDefinitionById" }, { type: "azure-native:authorization/v20210301preview:AccessReviewScheduleDefinitionById" }, { type: "azure-nextgen:authorization/v20210301preview:AccessReviewScheduleDefinitionById" }] };
