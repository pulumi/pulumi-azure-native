...
export class AccessReviewScheduleDefinitionById extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: AccessReviewScheduleDefinitionByIdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization/v20210301preview:AccessReviewScheduleDefinitionById" }, { type: "azure-native:authorization/v20211116preview:AccessReviewScheduleDefinitionById" }, { type: "azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById" }] };
