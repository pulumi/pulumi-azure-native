...
export class RoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization:RoleDefinition';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.authorization.RoleDefinitionPropertiesResponse>;
    /**
...
export interface RoleDefinitionArgs {
     ...
     * Role definition properties.
     */
    readonly properties?: pulumi.Input<inputs.authorization.RoleDefinitionProperties>;
    /**
