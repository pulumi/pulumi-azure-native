...
export class RoleDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RoleDefinition {
        pulumi.log.warn("RoleDefinition is deprecated: azure-native:authorization/v20220401:RoleDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20220501preview:RoleDefinition to guarantee forwards compatibility.")
        return new RoleDefinition(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20220401:RoleDefinition';
     ...
     */
    public readonly permissions!: pulumi.Output<outputs.authorization.v20220401.PermissionResponse[] | undefined>;
    /**
     * The role name.
     */
...
export interface RoleDefinitionArgs {
     ...
     * Role definition permissions.
     */
    permissions?: pulumi.Input<pulumi.Input<inputs.authorization.v20220401.PermissionArgs>[]>;
    /**
