...
export class Lock extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Lock {
        return new Lock(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization:Lock';
    ...
    constructor(name: string, argsOrState?: LockArgs, opts?: pulumi.CustomResourceOptions) {
