...
export function getRoleDefinition(args: GetRoleDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetRoleDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:authorization/v20200301preview:getRoleDefinition", {
...
export interface GetRoleDefinitionResult {
     ...
     */
    readonly permissions?: outputs.authorization.v20200301preview.PermissionResponse[];
    /**
     * The role name.
     */
