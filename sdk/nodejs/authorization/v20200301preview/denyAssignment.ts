...
export class DenyAssignment extends pulumi.CustomResource {
     ...
     */
    public readonly excludePrincipals!: pulumi.Output<outputs.authorization.v20200301preview.PrincipalResponse[] | undefined>;
    /**
     ...
     */
    public readonly permissions!: pulumi.Output<outputs.authorization.v20200301preview.PermissionResponse[]>;
    /**
     * Array of principals to which the deny assignment applies.
     */
    public readonly principals!: pulumi.Output<outputs.authorization.v20200301preview.PrincipalResponse[]>;
    /**
    ...
    constructor(name: string, args: DenyAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:authorization/v20200301preview:DenyAssignment" }, { type: "azure-native:authorization:DenyAssignment" }, { type: "azure-nextgen:authorization:DenyAssignment" }] };
...
export interface DenyAssignmentArgs {
     ...
     * Array of principals to which the deny assignment does not apply.
     */
    readonly excludePrincipals?: pulumi.Input<pulumi.Input<inputs.authorization.v20200301preview.Principal>[]>;
    /**
     * Specifies whether this deny assignment was created by Azure and cannot be edited or deleted.
     */
     ...
     * Array of principals to which the deny assignment applies.
     */
    readonly principals: pulumi.Input<pulumi.Input<inputs.authorization.v20200301preview.Principal>[]>;
    /**
     * The deny assignment scope.
     */
