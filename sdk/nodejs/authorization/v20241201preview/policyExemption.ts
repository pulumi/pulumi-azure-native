...
export class PolicyExemption extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20241201preview:PolicyExemption';
     ...
     */
    public readonly resourceSelectors!: pulumi.Output<outputs.authorization.v20241201preview.ResourceSelectorResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: PolicyExemptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization/v20200701preview:PolicyExemption" }, { type: "azure-native:authorization/v20220701preview:PolicyExemption" }, { type: "azure-native:authorization:PolicyExemption" }] };
