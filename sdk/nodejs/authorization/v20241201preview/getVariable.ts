...
export function getVariable(args: GetVariableArgs, opts?: pulumi.InvokeOptions): Promise<GetVariableResult> {
    ...
    return pulumi.runtime.invoke("azure-native:authorization/v20241201preview:getVariable", {
...
export interface GetVariableResult {
     ...
     */
    readonly columns: outputs.authorization.v20241201preview.PolicyVariableColumnResponse[];
    /**
     ...
     */
    readonly systemData: outputs.authorization.v20241201preview.SystemDataResponse;
    /**
...
export function getVariableOutput(args: GetVariableOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVariableResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:authorization/v20241201preview:getVariable", {
        "variableName": args.variableName,
    }, opts);
}
