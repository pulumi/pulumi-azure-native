...
export class VariableValue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20241201preview:VariableValue';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.authorization.v20241201preview.SystemDataResponse>;
    /**
     ...
     */
    public readonly values!: pulumi.Output<outputs.authorization.v20241201preview.PolicyVariableValueColumnValueResponse[]>;
    ...
    constructor(name: string, args: VariableValueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization/v20220801preview:VariableValue" }, { type: "azure-native:authorization:VariableValue" }] };
...
export interface VariableValueArgs {
     ...
     * Variable value column value array.
     */
    values: pulumi.Input<pulumi.Input<inputs.authorization.v20241201preview.PolicyVariableValueColumnValueArgs>[]>;
    /**
