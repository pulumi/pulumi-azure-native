...
export class PolicyDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PolicyDefinitionAtManagementGroup {
        pulumi.log.warn("PolicyDefinitionAtManagementGroup is deprecated: azure-native:authorization/v20180301:PolicyDefinitionAtManagementGroup is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20180501:PolicyDefinitionAtManagementGroup to guarantee forwards compatibility.")
