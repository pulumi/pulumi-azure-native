...
export class PolicyDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PolicyDefinitionAtManagementGroup {
        pulumi.log.warn("PolicyDefinitionAtManagementGroup is deprecated: azure-native:authorization/v20180301:PolicyDefinitionAtManagementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20180501:PolicyDefinitionAtManagementGroup to guarantee forwards compatibility.")
        return new PolicyDefinitionAtManagementGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20180301:PolicyDefinitionAtManagementGroup';
...
export interface PolicyDefinitionAtManagementGroupArgs {
     ...
     * The policy definition mode. Possible values are NotSpecified, Indexed, and All.
     */
    mode?: pulumi.Input<string | enums.authorization.v20180301.PolicyMode>;
    /**
     * Required if a parameter is used in policy rule.
     */
    parameters?: any;
