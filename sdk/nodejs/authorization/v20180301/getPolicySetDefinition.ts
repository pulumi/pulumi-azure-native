...
export function getPolicySetDefinition(args: GetPolicySetDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicySetDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:authorization/v20180301:getPolicySetDefinition", {
...
export interface GetPolicySetDefinitionResult {
     ...
     */
    readonly policyDefinitions: outputs.authorization.v20180301.PolicyDefinitionReferenceInvokeResponse[];
    /**
