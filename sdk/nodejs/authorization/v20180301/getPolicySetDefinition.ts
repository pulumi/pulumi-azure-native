...
export function getPolicySetDefinition(args: GetPolicySetDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicySetDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:authorization/v20180301:getPolicySetDefinition", {
        "name": args.name,
    }, opts);
}
...
export interface GetPolicySetDefinitionResult {
     ...
     */
    readonly properties: outputs.authorization.v20180301.PolicySetDefinitionPropertiesResponse;
    /**
