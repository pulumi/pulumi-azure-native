 ...
 *
 * const policyExemption = new azure_native.authorization.v20220701preview.PolicyExemption("policyExemption", {
...
export class PolicyExemption extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PolicyExemptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization/v20200701preview:PolicyExemption" }] };
