...
export class PolicyExemption extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20220701preview:PolicyExemption';
     ...
     */
    public readonly resourceSelectors!: pulumi.Output<outputs.authorization.v20220701preview.ResourceSelectorResponse[] | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.authorization.v20220701preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: PolicyExemptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization/v20200701preview:PolicyExemption" }, { type: "azure-native:authorization/v20241201preview:PolicyExemption" }, { type: "azure-native:authorization:PolicyExemption" }] };
...
export interface PolicyExemptionArgs {
     ...
     * The option whether validate the exemption is at or under the assignment scope.
     */
    assignmentScopeValidation?: pulumi.Input<string | enums.authorization.v20220701preview.AssignmentScopeValidation>;
    /**
     * The description of the policy exemption.
     */
     ...
     * The policy exemption category. Possible values are Waiver and Mitigated.
     */
    exemptionCategory: pulumi.Input<string | enums.authorization.v20220701preview.ExemptionCategory>;
    /**
     * The expiration date and time (in UTC ISO 8601 format yyyy-MM-ddTHH:mm:ssZ) of the policy exemption.
     */
     ...
     * The resource selector list to filter policies by resource properties.
     */
    resourceSelectors?: pulumi.Input<pulumi.Input<inputs.authorization.v20220701preview.ResourceSelectorArgs>[]>;
    /**
