...
export function getPolicyAssignment(args: GetPolicyAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyAssignmentResult> {
    ...
    return pulumi.runtime.invoke("azurerm:authorization:getPolicyAssignment", {
        "name": args.name,
        "scope": args.scope,
    }, opts);
}
...
export interface GetPolicyAssignmentResult {
     ...
     */
    readonly properties: outputs.authorization.PolicyAssignmentPropertiesResponse;
    /**
     * The policy sku. This property is optional, obsolete, and will be ignored.
     */
    readonly sku?: outputs.authorization.PolicySkuResponse;
    /**
