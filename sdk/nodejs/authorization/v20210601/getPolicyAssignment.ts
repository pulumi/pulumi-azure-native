...
export function getPolicyAssignment(args: GetPolicyAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyAssignmentResult> {
    pulumi.log.warn("getPolicyAssignment is deprecated: azure-native:authorization/v20210601:PolicyAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20220601:PolicyAssignment to guarantee forwards compatibility.")
...
export interface GetPolicyAssignmentResult {
     ...
     */
    readonly parameters?: {[key: string]: outputs.authorization.v20210601.ParameterValuesValueResponse};
    /**
