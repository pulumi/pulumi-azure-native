 ...
 *
 * @deprecated azure-native:authorization/v20210601:PolicyAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20220601:PolicyAssignment to guarantee forwards compatibility.
 */
export class PolicyAssignment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PolicyAssignment {
        pulumi.log.warn("PolicyAssignment is deprecated: azure-native:authorization/v20210601:PolicyAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20220601:PolicyAssignment to guarantee forwards compatibility.")
        return new PolicyAssignment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20210601:PolicyAssignment';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.authorization.v20210601.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly nonComplianceMessages!: pulumi.Output<outputs.authorization.v20210601.NonComplianceMessageResponse[] | undefined>;
    /**
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.authorization.v20210601.ParameterValuesValueResponse} | undefined>;
    /**
...
export interface PolicyAssignmentArgs {
     ...
     * The policy assignment enforcement mode. Possible values are Default and DoNotEnforce.
     */
    enforcementMode?: pulumi.Input<string | enums.authorization.v20210601.EnforcementMode>;
    /**
     * The managed identity associated with the policy assignment.
     */
    identity?: pulumi.Input<inputs.authorization.v20210601.IdentityArgs>;
    /**
     * The location of the policy assignment. Only required when utilizing managed identity.
     */
     ...
     * The messages that describe why a resource is non-compliant with the policy.
     */
    nonComplianceMessages?: pulumi.Input<pulumi.Input<inputs.authorization.v20210601.NonComplianceMessageArgs>[]>;
    /**
     * The policy's excluded scopes.
     */
     ...
     * The parameter values for the assigned policy rule. The keys are the parameter names.
     */
    parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.authorization.v20210601.ParameterValuesValueArgs>}>;
    /**
     * The name of the policy assignment.
     */
