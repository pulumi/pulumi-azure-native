...
export function getPolicySetDefinition(args: GetPolicySetDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicySetDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:authorization/v20170601preview:getPolicySetDefinition", {
...
export interface GetPolicySetDefinitionResult {
     ...
     */
    readonly policyDefinitions: outputs.authorization.v20170601preview.PolicyDefinitionReferenceInvokeResponse[];
    /**
