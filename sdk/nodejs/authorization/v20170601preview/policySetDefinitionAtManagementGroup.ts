 ...
 *
 * @deprecated azure-native:authorization/v20170601preview:PolicySetDefinitionAtManagementGroup is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20190601:PolicySetDefinitionAtManagementGroup to guarantee forwards compatibility.
 */
export class PolicySetDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PolicySetDefinitionAtManagementGroup {
        pulumi.log.warn("PolicySetDefinitionAtManagementGroup is deprecated: azure-native:authorization/v20170601preview:PolicySetDefinitionAtManagementGroup is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20190601:PolicySetDefinitionAtManagementGroup to guarantee forwards compatibility.")
        return new PolicySetDefinitionAtManagementGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20170601preview:PolicySetDefinitionAtManagementGroup';
     ...
     */
    public readonly policyDefinitions!: pulumi.Output<outputs.authorization.v20170601preview.PolicyDefinitionReferenceResponse[]>;
    /**
