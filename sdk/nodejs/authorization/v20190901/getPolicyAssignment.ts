 ...
 */
/** @deprecated azure-native:authorization/v20190901:PolicyAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20200301:PolicyAssignment to guarantee forwards compatibility. */
export function getPolicyAssignment(args: GetPolicyAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyAssignmentResult> {
    pulumi.log.warn("getPolicyAssignment is deprecated: azure-native:authorization/v20190901:PolicyAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20200301:PolicyAssignment to guarantee forwards compatibility.")
