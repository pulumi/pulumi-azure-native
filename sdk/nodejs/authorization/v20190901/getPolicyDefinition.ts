...
export function getPolicyDefinition(args: GetPolicyDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:authorization/v20190901:getPolicyDefinition", {
...
export interface GetPolicyDefinitionResult {
     ...
     */
    readonly parameters?: {[key: string]: outputs.authorization.v20190901.ParameterDefinitionsValueInvokeResponse};
    /**
     * The policy rule.
     */
