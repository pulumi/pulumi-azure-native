...
export function getPolicySetDefinition(args: GetPolicySetDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicySetDefinitionResult> {
    pulumi.log.warn("getPolicySetDefinition is deprecated: azure-native:authorization/v20190901:PolicySetDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20210601:PolicySetDefinition to guarantee forwards compatibility.")
