...
export class PolicyExemption extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20210701:PolicyExemption';
    ...
    constructor(name: string, args: PolicyExemptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:authorization/v20210701:PolicyExemption" }, { type: "azure-native:authorization:PolicyExemption" }, { type: "azure-nextgen:authorization:PolicyExemption" }, { type: "azure-native:authorization/v20200701preview:PolicyExemption" }, { type: "azure-nextgen:authorization/v20200701preview:PolicyExemption" }] };
...
export interface PolicyExemptionArgs {
     ...
     * The policy exemption category. Possible values are Waiver and Mitigated.
     */
    exemptionCategory: pulumi.Input<string | enums.authorization.v20210701.ExemptionCategory>;
    /**
     * The expiration date and time (in UTC ISO 8601 format yyyy-MM-ddTHH:mm:ssZ) of the policy exemption.
     */
