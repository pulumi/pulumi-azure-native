...
export class ManagementLockAtResourceGroupLevel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:authorization/v20150101:ManagementLockAtResourceGroupLevel';
    ...
    constructor(name: string, argsOrState?: ManagementLockAtResourceGroupLevelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/latest:ManagementLockAtResourceGroupLevel" }, { type: "azurerm:authorization/preview:ManagementLockAtResourceGroupLevel" }, { type: "azurerm:authorization/v20160901:ManagementLockAtResourceGroupLevel" }] };
