...
export class AccessReviewHistoryDefinitionById extends pulumi.CustomResource {
     ...
     */
    public readonly range!: pulumi.Output<outputs.authorization.v20211201preview.AccessReviewRecurrenceRangeResponse | undefined>;
    /**
    ...
    constructor(name: string, args?: AccessReviewHistoryDefinitionByIdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization/v20211116preview:AccessReviewHistoryDefinitionById" }, { type: "azure-native:authorization:AccessReviewHistoryDefinitionById" }] };
...
export interface AccessReviewHistoryDefinitionByIdArgs {
     ...
     * Access Review History Definition recurrence settings.
     */
    range?: pulumi.Input<inputs.authorization.v20211201preview.AccessReviewRecurrenceRangeArgs>;
    /**
     * A collection of scopes used when selecting review history data
     */
     ...
     */
    type?: pulumi.Input<string | enums.authorization.v20211201preview.AccessReviewRecurrencePatternType>;
}
