...
export class PolicyDefinitionVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PolicyDefinitionVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization:PolicyDefinitionVersion" }, { type: "azure-native:authorization/v20240501:PolicyDefinitionVersion" }, { type: "azure-native:authorization/v20250101:PolicyDefinitionVersion" }] };
