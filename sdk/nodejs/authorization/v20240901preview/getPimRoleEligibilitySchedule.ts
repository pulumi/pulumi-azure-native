...
export function getPimRoleEligibilitySchedule(args: GetPimRoleEligibilityScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetPimRoleEligibilityScheduleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:authorization/v20240901preview:getPimRoleEligibilitySchedule", {
...
export interface GetPimRoleEligibilityScheduleResult {
     ...
     */
    readonly expandedProperties: outputs.authorization.v20240901preview.ExpandedPropertiesResponse;
    /**
     ...
     */
    readonly scheduleInfo?: outputs.authorization.v20240901preview.RoleEligibilityScheduleRequestPropertiesResponseScheduleInfo;
    /**
     ...
     */
    readonly ticketInfo?: outputs.authorization.v20240901preview.RoleEligibilityScheduleRequestPropertiesResponseTicketInfo;
    /**
...
export function getPimRoleEligibilityScheduleOutput(args: GetPimRoleEligibilityScheduleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPimRoleEligibilityScheduleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:authorization/v20240901preview:getPimRoleEligibilitySchedule", {
        "roleEligibilityScheduleRequestName": args.roleEligibilityScheduleRequestName,
        "scope": args.scope,
    }, opts);
}
