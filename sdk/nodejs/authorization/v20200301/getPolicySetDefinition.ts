...
export function getPolicySetDefinition(args: GetPolicySetDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicySetDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:authorization/v20200301:getPolicySetDefinition", {
...
export interface GetPolicySetDefinitionResult {
     ...
     */
    readonly policyDefinitionGroups?: outputs.authorization.v20200301.PolicyDefinitionGroupInvokeResponse[];
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: outputs.authorization.v20200301.PolicyDefinitionReferenceInvokeResponse[];
    /**
