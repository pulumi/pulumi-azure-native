...
export function getPolicyDefinition(args: GetPolicyDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyDefinitionResult> {
    pulumi.log.warn("getPolicyDefinition is deprecated: azure-native:authorization/v20200301:PolicyDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20210601:PolicyDefinition to guarantee forwards compatibility.")
