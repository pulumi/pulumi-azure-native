...
export class AccessReviewScheduleDefinitionById extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20210301preview:AccessReviewScheduleDefinitionById';
     ...
     */
    public readonly backupReviewers!: pulumi.Output<outputs.authorization.v20210301preview.AccessReviewReviewerResponse[] | undefined>;
    /**
     ...
     */
    public readonly instances!: pulumi.Output<outputs.authorization.v20210301preview.AccessReviewInstanceResponse[] | undefined>;
    /**
     ...
     */
    public readonly range!: pulumi.Output<outputs.authorization.v20210301preview.AccessReviewRecurrenceRangeResponse | undefined>;
    /**
     ...
     */
    public readonly reviewers!: pulumi.Output<outputs.authorization.v20210301preview.AccessReviewReviewerResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly scope!: pulumi.Output<outputs.authorization.v20210301preview.AccessReviewScopeResponse>;
    /**
    ...
    constructor(name: string, args?: AccessReviewScheduleDefinitionByIdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization:AccessReviewScheduleDefinitionById" }, { type: "azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById" }, { type: "azure-native:authorization/v20210701preview:AccessReviewScheduleDefinitionById" }, { type: "azure-native:authorization/v20211116preview:AccessReviewScheduleDefinitionById" }, { type: "azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById" }] };
...
export interface AccessReviewScheduleDefinitionByIdArgs {
     ...
     * Access Review schedule definition recurrence range.
     */
    range?: pulumi.Input<inputs.authorization.v20210301preview.AccessReviewRecurrenceRangeArgs>;
    /**
     * Flag to indicate whether showing recommendations to reviewers is enabled.
     */
     ...
     */
    type?: pulumi.Input<string | enums.authorization.v20210301preview.AccessReviewRecurrencePatternType>;
}
