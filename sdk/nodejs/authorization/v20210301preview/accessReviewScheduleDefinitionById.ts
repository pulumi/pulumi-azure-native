...
export class AccessReviewScheduleDefinitionById extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: AccessReviewScheduleDefinitionByIdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization:AccessReviewScheduleDefinitionById" }, { type: "azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById" }, { type: "azure-native:authorization/v20210701preview:AccessReviewScheduleDefinitionById" }] };
