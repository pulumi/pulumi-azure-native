...
export class AccessReviewScheduleDefinitionById extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20210701preview:AccessReviewScheduleDefinitionById';
     ...
     */
    public readonly backupReviewers!: pulumi.Output<outputs.authorization.v20210701preview.AccessReviewReviewerResponse[] | undefined>;
    /**
     ...
     */
    public readonly instances!: pulumi.Output<outputs.authorization.v20210701preview.AccessReviewInstanceResponse[] | undefined>;
    /**
     ...
     */
    public readonly reviewers!: pulumi.Output<outputs.authorization.v20210701preview.AccessReviewReviewerResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args?: AccessReviewScheduleDefinitionByIdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["expandNestedMemberships"] = args ? args.expandNestedMemberships : undefined;
            ...
            inputs["recommendationLookBackDuration"] = args ? args.recommendationLookBackDuration : undefined;
            ...
            inputs["expandNestedMemberships"] = undefined /*out*/;
            ...
            inputs["principalName"] = undefined /*out*/;
            inputs["principalType"] = undefined /*out*/;
            inputs["recommendationLookBackDuration"] = undefined /*out*/;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:authorization/v20210701preview:AccessReviewScheduleDefinitionById" }, { type: "azure-native:authorization:AccessReviewScheduleDefinitionById" }, { type: "azure-nextgen:authorization:AccessReviewScheduleDefinitionById" }, { type: "azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById" }, { type: "azure-nextgen:authorization/v20180501preview:AccessReviewScheduleDefinitionById" }, { type: "azure-native:authorization/v20210301preview:AccessReviewScheduleDefinitionById" }, { type: "azure-nextgen:authorization/v20210301preview:AccessReviewScheduleDefinitionById" }] };
...
export interface AccessReviewScheduleDefinitionByIdArgs {
     ...
     * This specifies the behavior for the autoReview feature when an access review completes.
     */
    defaultDecision?: pulumi.Input<string | enums.authorization.v20210701preview.DefaultDecisionType>;
    /**
     * Flag to indicate whether reviewers are required to provide a justification when reviewing access.
     */
     ...
     * This is the collection of instances returned when one does an expand on it.
     */
    instances?: pulumi.Input<pulumi.Input<inputs.authorization.v20210701preview.AccessReviewInstanceArgs>[]>;
    /**
     * The interval for recurrence. For a quarterly review, the interval is 3 for type : absoluteMonthly.
     */
     ...
     */
    type?: pulumi.Input<string | enums.authorization.v20210701preview.AccessReviewRecurrenceRangeType>;
}
