...
export function getPolicySetDefinition(args: GetPolicySetDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicySetDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:authorization/v20190601:getPolicySetDefinition", {
        "name": args.name,
    }, opts);
}
...
export interface GetPolicySetDefinitionResult {
     ...
     */
    readonly properties: outputs.authorization.v20190601.PolicySetDefinitionPropertiesResponse;
    /**
