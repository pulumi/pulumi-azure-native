...
export class PolicySetDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: PolicySetDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/v20180301:PolicySetDefinition" }, { type: "azurerm:authorization/v20180501:PolicySetDefinition" }, { type: "azurerm:authorization/v20190101:PolicySetDefinition" }, { type: "azurerm:authorization/v20190901:PolicySetDefinition" }] };
