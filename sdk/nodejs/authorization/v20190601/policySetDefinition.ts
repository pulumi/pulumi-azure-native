 ...
 *
 * const policySetDefinition = new azurerm.authorization.v20190601.PolicySetDefinition("policySetDefinition", {
...
export class PolicySetDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PolicySetDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:authorization/latest:PolicySetDefinition" }, { type: "azurerm:authorization/v20170601preview:PolicySetDefinition" }, { type: "azurerm:authorization/v20180301:PolicySetDefinition" }, { type: "azurerm:authorization/v20180501:PolicySetDefinition" }, { type: "azurerm:authorization/v20190101:PolicySetDefinition" }, { type: "azurerm:authorization/v20190901:PolicySetDefinition" }, { type: "azurerm:authorization/v20200301:PolicySetDefinition" }] };
