...
export class PolicySetDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.authorization.v20190601.PolicySetDefinitionPropertiesResponse>;
    /**
...
export interface PolicySetDefinitionArgs {
     ...
     * The policy definition properties.
     */
    readonly properties?: pulumi.Input<inputs.authorization.v20190601.PolicySetDefinitionProperties>;
}
