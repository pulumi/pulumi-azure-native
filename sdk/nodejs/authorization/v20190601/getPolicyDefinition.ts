...
export function getPolicyDefinition(args: GetPolicyDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:authorization/v20190601:getPolicyDefinition", {
        "name": args.name,
    }, opts);
}
...
export interface GetPolicyDefinitionResult {
     ...
     */
    readonly properties: outputs.authorization.v20190601.PolicyDefinitionPropertiesResponse;
    /**
