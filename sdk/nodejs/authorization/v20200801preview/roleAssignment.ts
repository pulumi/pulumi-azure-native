...
export interface RoleAssignmentArgs {
     ...
     * The principal type of the assigned principal ID.
     */
    readonly principalType?: pulumi.Input<string | enums.authorization.v20200801preview.PrincipalType>;
    /**
