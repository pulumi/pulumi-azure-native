...
export class RoleAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RoleAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.authorization.v20200801preview.roleAssignmentPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface RoleAssignmentArgs {
     ...
     */
    properties: pulumi.Input<inputs.authorization.v20200801preview.RoleAssignmentPropertiesArgs>;
    /**
