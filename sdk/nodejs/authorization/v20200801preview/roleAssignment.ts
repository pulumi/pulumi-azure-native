 ...
 * Role Assignments
 *
 * @deprecated azure-native:authorization/v20200801preview:RoleAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20220401:RoleAssignment to guarantee forwards compatibility.
 */
export class RoleAssignment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RoleAssignment {
        pulumi.log.warn("RoleAssignment is deprecated: azure-native:authorization/v20200801preview:RoleAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20220401:RoleAssignment to guarantee forwards compatibility.")
        return new RoleAssignment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20200801preview:RoleAssignment';
...
export interface RoleAssignmentArgs {
     ...
     * The principal type of the assigned principal ID.
     */
    principalType?: pulumi.Input<string | enums.authorization.v20200801preview.PrincipalType>;
    /**
