...
export class PolicySetDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20240501:PolicySetDefinitionAtManagementGroup';
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.authorization.v20240501.ParameterDefinitionsValueResponse} | undefined>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    public readonly policyDefinitionGroups!: pulumi.Output<outputs.authorization.v20240501.PolicyDefinitionGroupResponse[] | undefined>;
    /**
     * An array of policy definition references.
     */
    public readonly policyDefinitions!: pulumi.Output<outputs.authorization.v20240501.PolicyDefinitionReferenceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.authorization.v20240501.SystemDataResponse>;
    /**
...
export interface PolicySetDefinitionAtManagementGroupArgs {
     ...
     * The policy set definition parameters that can be used in policy definition references.
     */
    parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.authorization.v20240501.ParameterDefinitionsValueArgs>}>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    policyDefinitionGroups?: pulumi.Input<pulumi.Input<inputs.authorization.v20240501.PolicyDefinitionGroupArgs>[]>;
    /**
     * An array of policy definition references.
     */
    policyDefinitions: pulumi.Input<pulumi.Input<inputs.authorization.v20240501.PolicyDefinitionReferenceArgs>[]>;
    /**
     ...
     * The type of policy set definition. Possible values are NotSpecified, BuiltIn, Custom, and Static.
     */
    policyType?: pulumi.Input<string | enums.authorization.v20240501.PolicyType>;
    /**
     * The policy set definition version in #.#.# format.
     */
