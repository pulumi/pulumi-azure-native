 ...
 */
export class RoleEligibilityScheduleRequest extends pulumi.CustomResource {
    /**
     * Get an existing RoleEligibilityScheduleRequest resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RoleEligibilityScheduleRequest {
        return new RoleEligibilityScheduleRequest(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20201001preview:RoleEligibilityScheduleRequest';

    /**
     * Returns true if the given object is an instance of RoleEligibilityScheduleRequest.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RoleEligibilityScheduleRequest {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RoleEligibilityScheduleRequest.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly expandedProperties!: pulumi.Output<outputs.authorization.v20201001preview.ExpandedPropertiesResponse>;
    /**
     ...
     */
    public readonly scheduleInfo!: pulumi.Output<outputs.authorization.v20201001preview.RoleEligibilityScheduleRequestPropertiesResponseScheduleInfo | undefined>;
    /**
     ...
     */
    public readonly ticketInfo!: pulumi.Output<outputs.authorization.v20201001preview.RoleEligibilityScheduleRequestPropertiesResponseTicketInfo | undefined>;
    /**
    ...
    /**
     * Create a RoleEligibilityScheduleRequest resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RoleEligibilityScheduleRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["roleEligibilityScheduleRequestName"] = args ? args.roleEligibilityScheduleRequestName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization/v20201001:RoleEligibilityScheduleRequest" }, { type: "azure-native:authorization/v20220401preview:RoleEligibilityScheduleRequest" }, { type: "azure-native:authorization/v20240201preview:RoleEligibilityScheduleRequest" }, { type: "azure-native:authorization/v20240901preview:RoleEligibilityScheduleRequest" }, { type: "azure-native:authorization:RoleEligibilityScheduleRequest" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(RoleEligibilityScheduleRequest.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * The set of arguments for constructing a RoleEligibilityScheduleRequest resource.
 */
export interface RoleEligibilityScheduleRequestArgs {
    /**
     * The conditions on the role assignment. This limits the resources it can be assigned to. e.g.: @Resource[Microsoft.Storage/storageAccounts/blobServices/containers:ContainerName] StringEqualsIgnoreCase 'foo_storage_container'
     */
     ...
     * The type of the role assignment schedule request. Eg: SelfActivate, AdminAssign etc
     */
    requestType: pulumi.Input<string | enums.authorization.v20201001preview.RequestType>;
    /**
     * The role definition ID.
     */
     ...
     * Schedule info of the role eligibility schedule
     */
    scheduleInfo?: pulumi.Input<inputs.authorization.v20201001preview.RoleEligibilityScheduleRequestPropertiesScheduleInfoArgs>;
    /**
     ...
     * Ticket Info of the role eligibility
     */
    ticketInfo?: pulumi.Input<inputs.authorization.v20201001preview.RoleEligibilityScheduleRequestPropertiesTicketInfoArgs>;
}
