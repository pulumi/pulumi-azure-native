...
export class RoleManagementPolicyAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RoleManagementPolicyAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization:RoleManagementPolicyAssignment" }, { type: "azure-native:authorization/v20201001:RoleManagementPolicyAssignment" }, { type: "azure-native:authorization/v20240201preview:RoleManagementPolicyAssignment" }] };
