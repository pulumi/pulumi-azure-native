...
export class HybridConnectionAuthorizationRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HybridConnectionAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:relay:HybridConnectionAuthorizationRule" }, { type: "azure-nextgen:relay:HybridConnectionAuthorizationRule" }, { type: "azure-native:relay/latest:HybridConnectionAuthorizationRule" }, { type: "azure-nextgen:relay/latest:HybridConnectionAuthorizationRule" }, { type: "azure-native:relay/v20170401:HybridConnectionAuthorizationRule" }, { type: "azure-nextgen:relay/v20170401:HybridConnectionAuthorizationRule" }] };
