 ...
 *
 * const wcfRelayAuthorizationRule = new azurerm.relay.v20160701.WCFRelayAuthorizationRule("wcfRelayAuthorizationRule", {
...
export class WCFRelayAuthorizationRule extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WCFRelayAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:relay/latest:WCFRelayAuthorizationRule" }, { type: "azurerm:relay/v20170401:WCFRelayAuthorizationRule" }] };
