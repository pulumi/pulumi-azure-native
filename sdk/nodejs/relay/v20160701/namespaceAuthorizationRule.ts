 ...
 *
 * const namespaceAuthorizationRule = new azurerm.relay.v20160701.NamespaceAuthorizationRule("namespaceAuthorizationRule", {
...
export class NamespaceAuthorizationRule extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: NamespaceAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:relay/latest:NamespaceAuthorizationRule" }, { type: "azurerm:relay/v20170401:NamespaceAuthorizationRule" }] };
