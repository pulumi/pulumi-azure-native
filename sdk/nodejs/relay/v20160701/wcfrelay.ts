 ...
 *
 * const wcfRelay = new azurerm.relay.v20160701.WCFRelay("wcfRelay", {
...
export class WCFRelay extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:relay/v20160701:WCFRelay';
    ...
    constructor(name: string, args: WCFRelayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:relay/latest:WCFRelay" }, { type: "azurerm:relay/v20170401:WCFRelay" }] };
