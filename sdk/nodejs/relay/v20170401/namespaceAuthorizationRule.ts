...
export class NamespaceAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:relay/v20170401:NamespaceAuthorizationRule';
    ...
    constructor(name: string, argsOrState?: NamespaceAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:relay/latest:NamespaceAuthorizationRule" }, { type: "azurerm:relay/preview:NamespaceAuthorizationRule" }, { type: "azurerm:relay/v20160701:NamespaceAuthorizationRule" }] };
