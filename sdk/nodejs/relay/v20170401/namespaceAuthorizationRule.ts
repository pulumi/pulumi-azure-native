...
export class NamespaceAuthorizationRule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.relay.v20170401.AuthorizationRuleResponseProperties>;
    /**
     * Resource type.
     */
...
export interface NamespaceAuthorizationRuleArgs {
     ...
     * Authorization rule properties.
     */
    readonly properties: pulumi.Input<inputs.relay.v20170401.AuthorizationRuleProperties>;
    /**
