...
export function getHybridConnectionAuthorizationRule(args: GetHybridConnectionAuthorizationRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetHybridConnectionAuthorizationRuleResult> {
    pulumi.log.warn("getHybridConnectionAuthorizationRule is deprecated: Version v20170401 will be removed in the next major version of the provider. Upgrade to version v20211101 or later.")
    if (!opts) {
        opts = {}
    }
