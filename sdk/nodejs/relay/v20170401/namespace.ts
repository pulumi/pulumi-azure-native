 ...
 *
 * const namespace = new azurerm.relay.v20170401.Namespace("namespace", {
 *     location: "West US",
...
export class Namespace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:relay/v20170401:Namespace';
    ...
    constructor(name: string, args: NamespaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:relay/latest:Namespace" }, { type: "azurerm:relay/v20160701:Namespace" }, { type: "azurerm:relay/v20180101preview:Namespace" }] };
