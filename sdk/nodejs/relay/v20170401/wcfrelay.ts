 ...
 *
 * const wcfRelay = new azure_native.relay.v20170401.WCFRelay("wcfRelay", {
 *     namespaceName: "example-RelayNamespace-9953",
 *     relayName: "example-Relay-Wcf-1194",
 *     relayType: azure_native.relay.v20170401.Relaytype.NetTcp,
...
export class WCFRelay extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WCFRelayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:relay:WCFRelay" }, { type: "azure-native:relay/v20160701:WCFRelay" }, { type: "azure-native:relay/v20211101:WCFRelay" }] };
