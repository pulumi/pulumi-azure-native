...
export class WCFRelay extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:relay/v20170401:WCFRelay';
    ...
    constructor(name: string, args: WCFRelayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:relay:WCFRelay" }, { type: "azure-nextgen:relay/latest:WCFRelay" }, { type: "azure-nextgen:relay/v20160701:WCFRelay" }] };
