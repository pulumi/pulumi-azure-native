...
export class HybridConnectionAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:relay/v20170401:HybridConnectionAuthorizationRule';
    ...
    constructor(name: string, argsOrState?: HybridConnectionAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:relay/latest:HybridConnectionAuthorizationRule" }, { type: "azurerm:relay/preview:HybridConnectionAuthorizationRule" }, { type: "azurerm:relay/v20160701:HybridConnectionAuthorizationRule" }] };
