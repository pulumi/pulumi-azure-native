...
export class WCFRelay extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:relay/preview:WCFRelay';
    ...
    constructor(name: string, argsOrState?: WCFRelayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:relay/latest:WCFRelay" }, { type: "azurerm:relay/v20160701:WCFRelay" }, { type: "azurerm:relay/v20170401:WCFRelay" }] };
