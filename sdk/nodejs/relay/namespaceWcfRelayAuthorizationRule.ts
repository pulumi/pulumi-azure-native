 ...
 */
export class NamespaceWcfRelayAuthorizationRule extends pulumi.CustomResource {
    /**
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:relay:NamespaceWcfRelayAuthorizationRule';

    /**
     * Returns true if the given object is an instance of NamespaceWcfRelayAuthorizationRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NamespaceWcfRelayAuthorizationRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NamespaceWcfRelayAuthorizationRule.__pulumiType;
    }
    ...
    /**
     * Create a NamespaceWcfRelayAuthorizationRule resource with the given unique name, arguments, and options.
     *
 ...
 */
export interface NamespaceWcfRelayAuthorizationRuleArgs {
    /**
