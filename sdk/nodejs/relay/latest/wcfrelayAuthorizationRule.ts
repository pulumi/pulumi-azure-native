...
export class WCFRelayAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:relay/latest:WCFRelayAuthorizationRule';
    ...
    constructor(name: string, args: WCFRelayAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:relay/preview:WCFRelayAuthorizationRule" }, { type: "azurerm:relay/v20160701:WCFRelayAuthorizationRule" }, { type: "azurerm:relay/v20170401:WCFRelayAuthorizationRule" }] };
