...
export class WCFRelayAuthorizationRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WCFRelayAuthorizationRule {
        pulumi.log.warn("WCFRelayAuthorizationRule is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:relay:WCFRelayAuthorizationRule'.")
        return new WCFRelayAuthorizationRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:relay/latest:WCFRelayAuthorizationRule';
    ...
    constructor(name: string, args: WCFRelayAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:relay/latest:WCFRelayAuthorizationRule" }, { type: "azure-native:relay:WCFRelayAuthorizationRule" }, { type: "azure-nextgen:relay:WCFRelayAuthorizationRule" }, { type: "azure-native:relay/v20160701:WCFRelayAuthorizationRule" }, { type: "azure-nextgen:relay/v20160701:WCFRelayAuthorizationRule" }, { type: "azure-native:relay/v20170401:WCFRelayAuthorizationRule" }, { type: "azure-nextgen:relay/v20170401:WCFRelayAuthorizationRule" }] };
