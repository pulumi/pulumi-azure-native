...
export class WCFRelay extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:relay/latest:WCFRelay';
    ...
    constructor(name: string, args: WCFRelayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:relay/latest:WCFRelay" }, { type: "azure-native:relay:WCFRelay" }, { type: "azure-nextgen:relay:WCFRelay" }, { type: "azure-native:relay/v20160701:WCFRelay" }, { type: "azure-nextgen:relay/v20160701:WCFRelay" }, { type: "azure-native:relay/v20170401:WCFRelay" }, { type: "azure-nextgen:relay/v20170401:WCFRelay" }] };
