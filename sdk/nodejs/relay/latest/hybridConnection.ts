...
export class HybridConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:relay/latest:HybridConnection';
    ...
    constructor(name: string, args: HybridConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:relay/preview:HybridConnection" }, { type: "azurerm:relay/v20160701:HybridConnection" }, { type: "azurerm:relay/v20170401:HybridConnection" }] };
