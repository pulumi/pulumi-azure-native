...
export class HybridConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:relay/latest:HybridConnection';
    ...
    constructor(name: string, args: HybridConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:relay/latest:HybridConnection" }, { type: "azure-native:relay:HybridConnection" }, { type: "azure-nextgen:relay:HybridConnection" }, { type: "azure-native:relay/v20160701:HybridConnection" }, { type: "azure-nextgen:relay/v20160701:HybridConnection" }, { type: "azure-native:relay/v20170401:HybridConnection" }, { type: "azure-nextgen:relay/v20170401:HybridConnection" }] };
