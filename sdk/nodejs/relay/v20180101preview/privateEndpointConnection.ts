...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:relay/v20180101preview:PrivateEndpointConnection" }, { type: "azure-native:relay:PrivateEndpointConnection" }, { type: "azure-nextgen:relay:PrivateEndpointConnection" }] };
