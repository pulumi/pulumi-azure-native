...
export class HybridConnectionAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:relay/v20240101:HybridConnectionAuthorizationRule';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.relay.v20240101.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: HybridConnectionAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:relay:HybridConnectionAuthorizationRule" }, { type: "azure-native:relay/v20160701:HybridConnectionAuthorizationRule" }, { type: "azure-native:relay/v20170401:HybridConnectionAuthorizationRule" }, { type: "azure-native:relay/v20211101:HybridConnectionAuthorizationRule" }] };
...
export interface HybridConnectionAuthorizationRuleArgs {
     ...
     * The rights associated with the rule.
     */
    rights: pulumi.Input<pulumi.Input<string | enums.relay.v20240101.AccessRights>[]>;
}
