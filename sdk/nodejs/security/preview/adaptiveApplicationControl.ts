...
export class AdaptiveApplicationControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/preview:AdaptiveApplicationControl';
    ...
    public /*out*/ readonly issues!: pulumi.Output<outputs.security.preview.AdaptiveApplicationControlIssueSummaryResponse[]>;
    /**
    ...
    public readonly pathRecommendations!: pulumi.Output<outputs.security.preview.PathRecommendationResponse[] | undefined>;
    /**
     * The protection mode of the collection/file types. Exe/Msi/Script are used for Windows, Executable is used for Linux.
     */
    public readonly protectionMode!: pulumi.Output<outputs.security.preview.ProtectionModeResponse | undefined>;
    /**
    ...
    public readonly vmRecommendations!: pulumi.Output<outputs.security.preview.VmRecommendationResponse[] | undefined>;
    ...
    constructor(name: string, argsOrState?: AdaptiveApplicationControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:AdaptiveApplicationControl" }, { type: "azurerm:security/v20150601preview:AdaptiveApplicationControl" }, { type: "azurerm:security/v20200101:AdaptiveApplicationControl" }] };
...
export interface AdaptiveApplicationControlArgs {
    ...
    readonly pathRecommendations?: pulumi.Input<pulumi.Input<inputs.security.preview.PathRecommendation>[]>;
    /**
     * The protection mode of the collection/file types. Exe/Msi/Script are used for Windows, Executable is used for Linux.
     */
    readonly protectionMode?: pulumi.Input<inputs.security.preview.ProtectionMode>;
    readonly vmRecommendations?: pulumi.Input<pulumi.Input<inputs.security.preview.VmRecommendation>[]>;
}
