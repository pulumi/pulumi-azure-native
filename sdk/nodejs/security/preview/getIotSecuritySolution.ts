...
export function getIotSecuritySolution(args: GetIotSecuritySolutionArgs, opts?: pulumi.InvokeOptions): Promise<GetIotSecuritySolutionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:security/preview:getIotSecuritySolution", {
...
export interface GetIotSecuritySolutionResult {
     ...
     */
    readonly recommendationsConfiguration?: outputs.security.preview.RecommendationConfigurationPropertiesResponse[];
    /**
     ...
     */
    readonly userDefinedResources?: outputs.security.preview.UserDefinedResourcesPropertiesResponse;
    /**
