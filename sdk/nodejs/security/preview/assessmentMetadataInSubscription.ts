...
export class AssessmentMetadataInSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/preview:AssessmentMetadataInSubscription';
     ...
     */
    public readonly partnerData!: pulumi.Output<outputs.security.preview.SecurityAssessmentMetadataPartnerDataResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AssessmentMetadataInSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:AssessmentMetadataInSubscription" }, { type: "azurerm:security/v20190101preview:AssessmentMetadataInSubscription" }, { type: "azurerm:security/v20200101:AssessmentMetadataInSubscription" }] };
...
export interface AssessmentMetadataInSubscriptionArgs {
     ...
     * Describes the partner that created the assessment
     */
    readonly partnerData?: pulumi.Input<inputs.security.preview.SecurityAssessmentMetadataPartnerData>;
    /**
     * True if this assessment is in preview release status
     */
