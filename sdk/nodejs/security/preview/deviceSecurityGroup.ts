...
export class DeviceSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/preview:DeviceSecurityGroup';
     ...
     */
    public readonly allowlistRules!: pulumi.Output<outputs.security.preview.AllowlistCustomAlertRuleResponse[] | undefined>;
    /**
     * The deny-list custom alert rules.
     */
    public readonly denylistRules!: pulumi.Output<outputs.security.preview.DenylistCustomAlertRuleResponse[] | undefined>;
    /**
     * Resource name
     */
     ...
     */
    public readonly thresholdRules!: pulumi.Output<outputs.security.preview.ThresholdCustomAlertRuleResponse[] | undefined>;
    /**
     * The list of custom alert time-window rules.
     */
    public readonly timeWindowRules!: pulumi.Output<outputs.security.preview.TimeWindowCustomAlertRuleResponse[] | undefined>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, argsOrState?: DeviceSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:DeviceSecurityGroup" }, { type: "azurerm:security/v20170801preview:DeviceSecurityGroup" }, { type: "azurerm:security/v20190801:DeviceSecurityGroup" }] };
...
export interface DeviceSecurityGroupArgs {
     ...
     * The allow-list custom alert rules.
     */
    readonly allowlistRules?: pulumi.Input<pulumi.Input<inputs.security.preview.AllowlistCustomAlertRule>[]>;
    /**
     * The deny-list custom alert rules.
     */
    readonly denylistRules?: pulumi.Input<pulumi.Input<inputs.security.preview.DenylistCustomAlertRule>[]>;
    /**
     ...
     * The list of custom alert threshold rules.
     */
    readonly thresholdRules?: pulumi.Input<pulumi.Input<inputs.security.preview.ThresholdCustomAlertRule>[]>;
    /**
     * The list of custom alert time-window rules.
     */
    readonly timeWindowRules?: pulumi.Input<pulumi.Input<inputs.security.preview.TimeWindowCustomAlertRule>[]>;
}
