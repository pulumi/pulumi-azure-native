...
export class IotDefenderSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/preview:IotDefenderSetting';
    ...
    constructor(name: string, args?: IotDefenderSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/v20200806preview:IotDefenderSetting" }] };
