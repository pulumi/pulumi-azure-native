...
export class AlertsSuppressionRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/preview:AlertsSuppressionRule';
     ...
     */
    public readonly suppressionAlertsScope!: pulumi.Output<outputs.security.preview.SuppressionAlertsScopeResponse | undefined>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: AlertsSuppressionRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/v20190101preview:AlertsSuppressionRule" }] };
...
export interface AlertsSuppressionRuleArgs {
     ...
     * The suppression conditions
     */
    readonly suppressionAlertsScope?: pulumi.Input<inputs.security.preview.SuppressionAlertsScope>;
}
