...
export function getJitNetworkAccessPolicy(args: GetJitNetworkAccessPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetJitNetworkAccessPolicyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:security/preview:getJitNetworkAccessPolicy", {
...
export interface GetJitNetworkAccessPolicyResult {
    ...
    readonly requests?: outputs.security.preview.JitNetworkAccessRequestResponse[];
    /**
     * Resource type
     */
     ...
     */
    readonly virtualMachines: outputs.security.preview.JitNetworkAccessPolicyVirtualMachineResponse[];
}
