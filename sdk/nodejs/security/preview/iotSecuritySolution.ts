...
export class IotSecuritySolution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/preview:IotSecuritySolution';
     ...
     */
    public readonly recommendationsConfiguration!: pulumi.Output<outputs.security.preview.RecommendationConfigurationPropertiesResponse[] | undefined>;
    /**
     ...
     */
    public readonly userDefinedResources!: pulumi.Output<outputs.security.preview.UserDefinedResourcesPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: IotSecuritySolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:IotSecuritySolution" }, { type: "azurerm:security/v20170801preview:IotSecuritySolution" }, { type: "azurerm:security/v20190801:IotSecuritySolution" }] };
...
export interface IotSecuritySolutionArgs {
     ...
     * List of the configuration status for each recommendation type.
     */
    readonly recommendationsConfiguration?: pulumi.Input<pulumi.Input<inputs.security.preview.RecommendationConfigurationProperties>[]>;
    /**
     ...
     * Properties of the IoT Security solution's user defined resources.
     */
    readonly userDefinedResources?: pulumi.Input<inputs.security.preview.UserDefinedResourcesProperties>;
    /**
     * Workspace resource ID
     */
