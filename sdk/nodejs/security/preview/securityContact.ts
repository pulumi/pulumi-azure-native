...
export class SecurityContact extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/preview:SecurityContact';
     ...
     */
    public /*out*/ readonly alertNotifications!: pulumi.Output<outputs.security.preview.SecurityContactPropertiesResponseAlertNotifications | undefined>;
    /**
     ...
     */
    public /*out*/ readonly notificationsByRole!: pulumi.Output<outputs.security.preview.SecurityContactPropertiesResponseNotificationsByRole | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SecurityContactArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/v20170801preview:SecurityContact" }, { type: "azurerm:security/v20200101preview:SecurityContact" }] };
