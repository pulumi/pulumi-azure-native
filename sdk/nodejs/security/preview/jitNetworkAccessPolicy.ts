...
export class JitNetworkAccessPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/preview:JitNetworkAccessPolicy';
    ...
    public readonly requests!: pulumi.Output<outputs.security.preview.JitNetworkAccessRequestResponse[] | undefined>;
    /**
     * Resource type
     */
     ...
     */
    public readonly virtualMachines!: pulumi.Output<outputs.security.preview.JitNetworkAccessPolicyVirtualMachineResponse[]>;
    ...
    constructor(name: string, args: JitNetworkAccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:JitNetworkAccessPolicy" }, { type: "azurerm:security/v20150601preview:JitNetworkAccessPolicy" }, { type: "azurerm:security/v20200101:JitNetworkAccessPolicy" }] };
...
export interface JitNetworkAccessPolicyArgs {
    ...
    readonly requests?: pulumi.Input<pulumi.Input<inputs.security.preview.JitNetworkAccessRequest>[]>;
    /**
     ...
     * Configurations for Microsoft.Compute/virtualMachines resource type.
     */
    readonly virtualMachines: pulumi.Input<pulumi.Input<inputs.security.preview.JitNetworkAccessPolicyVirtualMachine>[]>;
}
