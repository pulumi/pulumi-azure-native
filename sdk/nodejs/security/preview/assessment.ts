...
export class Assessment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/preview:Assessment';
     ...
     */
    public /*out*/ readonly links!: pulumi.Output<outputs.security.preview.AssessmentLinksResponse | undefined>;
    /**
     * Describes properties of an assessment metadata.
     */
    public readonly metadata!: pulumi.Output<outputs.security.preview.SecurityAssessmentMetadataPropertiesResponse | undefined>;
    /**
     * Resource name
     */
     ...
     */
    public readonly partnersData!: pulumi.Output<outputs.security.preview.SecurityAssessmentPartnerDataResponse | undefined>;
    /**
     * Details of the resource that was assessed
     */
    public readonly resourceDetails!: pulumi.Output<outputs.security.preview.AzureResourceDetailsResponse | outputs.security.preview.OnPremiseResourceDetailsResponse>;
    /**
     * The result of the assessment
     */
    public readonly status!: pulumi.Output<outputs.security.preview.AssessmentStatusResponse>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: AssessmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:Assessment" }, { type: "azurerm:security/v20190101preview:Assessment" }, { type: "azurerm:security/v20200101:Assessment" }] };
...
export interface AssessmentArgs {
     ...
     * Describes properties of an assessment metadata.
     */
    readonly metadata?: pulumi.Input<inputs.security.preview.SecurityAssessmentMetadataProperties>;
    /**
     * Data regarding 3rd party partner integration
     */
    readonly partnersData?: pulumi.Input<inputs.security.preview.SecurityAssessmentPartnerData>;
    /**
     * Details of the resource that was assessed
     */
    readonly resourceDetails: pulumi.Input<inputs.security.preview.AzureResourceDetails | inputs.security.preview.OnPremiseResourceDetails>;
    /**
     ...
     * The result of the assessment
     */
    readonly status: pulumi.Input<inputs.security.preview.AssessmentStatus>;
}
