...
export class Assessment extends pulumi.CustomResource {
     ...
     */
    public readonly resourceDetails!: pulumi.Output<outputs.security.preview.ResourceDetailsResponse>;
    /**
...
export interface AssessmentArgs {
     ...
     * Details of the resource that was assessed
     */
    readonly resourceDetails: pulumi.Input<inputs.security.preview.ResourceDetails>;
    /**
