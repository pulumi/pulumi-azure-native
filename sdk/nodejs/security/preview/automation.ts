...
export class Automation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/preview:Automation';
     ...
     */
    public readonly actions!: pulumi.Output<outputs.security.preview.AutomationActionEventHubResponse | outputs.security.preview.AutomationActionLogicAppResponse | outputs.security.preview.AutomationActionWorkspaceResponse[] | undefined>;
    /**
     ...
     */
    public readonly scopes!: pulumi.Output<outputs.security.preview.AutomationScopeResponse[] | undefined>;
    /**
     * A collection of the source event types which evaluate the security automation set of rules.
     */
    public readonly sources!: pulumi.Output<outputs.security.preview.AutomationSourceResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: AutomationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/v20190101preview:Automation" }] };
...
export interface AutomationArgs {
     ...
     * A collection of the actions which are triggered if all the configured rules evaluations, within at least one rule set, are true.
     */
    readonly actions?: pulumi.Input<pulumi.Input<inputs.security.preview.AutomationActionEventHub | inputs.security.preview.AutomationActionLogicApp | inputs.security.preview.AutomationActionWorkspace>[]>;
    /**
     ...
     * A collection of scopes on which the security automations logic is applied. Supported scopes are the subscription itself or a resource group under that subscription. The automation will only apply on defined scopes.
     */
    readonly scopes?: pulumi.Input<pulumi.Input<inputs.security.preview.AutomationScope>[]>;
    /**
     * A collection of the source event types which evaluate the security automation set of rules.
     */
    readonly sources?: pulumi.Input<pulumi.Input<inputs.security.preview.AutomationSource>[]>;
    /**
     * A list of key value pairs that describe the resource.
     */
