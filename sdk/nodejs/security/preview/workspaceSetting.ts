...
export class WorkspaceSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/preview:WorkspaceSetting';
    ...
    constructor(name: string, argsOrState?: WorkspaceSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/v20170801preview:WorkspaceSetting" }] };
