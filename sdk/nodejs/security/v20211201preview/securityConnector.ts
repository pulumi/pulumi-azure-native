...
export class SecurityConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:security/v20211201preview:SecurityConnector';
     ...
     */
    public readonly environmentData!: pulumi.Output<outputs.security.v20211201preview.AWSEnvironmentDataResponse | outputs.security.v20211201preview.GcpProjectEnvironmentDataResponse | outputs.security.v20211201preview.GithubScopeEnvironmentDataResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.security.v20211201preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: SecurityConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security:SecurityConnector" }, { type: "azure-native:security/v20210701preview:SecurityConnector" }, { type: "azure-native:security/v20220501preview:SecurityConnector" }, { type: "azure-native:security/v20220801preview:SecurityConnector" }] };
