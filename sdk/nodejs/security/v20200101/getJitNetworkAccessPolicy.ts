...
export function getJitNetworkAccessPolicy(args: GetJitNetworkAccessPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetJitNetworkAccessPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:security/v20200101:getJitNetworkAccessPolicy", {
...
export interface GetJitNetworkAccessPolicyResult {
    ...
    readonly requests?: outputs.security.v20200101.JitNetworkAccessRequestInvokeResponse[];
    /**
     * Resource type
     */
     ...
     */
    readonly virtualMachines: outputs.security.v20200101.JitNetworkAccessPolicyVirtualMachineInvokeResponse[];
}
