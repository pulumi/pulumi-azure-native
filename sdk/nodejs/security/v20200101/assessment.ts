...
export class Assessment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:security/v20200101:Assessment';
     ...
     */
    public readonly resourceDetails!: pulumi.Output<outputs.security.v20200101.AzureResourceDetailsResponse | outputs.security.v20200101.OnPremiseResourceDetailsResponse | outputs.security.v20200101.OnPremiseSqlResourceDetailsResponse>;
    /**
    ...
    constructor(name: string, args: AssessmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security/v20200101:Assessment" }, { type: "azure-native:security:Assessment" }, { type: "azure-nextgen:security:Assessment" }, { type: "azure-native:security/v20190101preview:Assessment" }, { type: "azure-nextgen:security/v20190101preview:Assessment" }] };
...
export interface AssessmentArgs {
     ...
     * Details of the resource that was assessed
     */
    readonly resourceDetails: pulumi.Input<inputs.security.v20200101.AzureResourceDetails | inputs.security.v20200101.OnPremiseResourceDetails | inputs.security.v20200101.OnPremiseSqlResourceDetails>;
    /**
