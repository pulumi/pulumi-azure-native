...
export class Assessment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AssessmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:Assessment" }, { type: "azurerm:security/preview:Assessment" }, { type: "azurerm:security/v20190101preview:Assessment" }] };
