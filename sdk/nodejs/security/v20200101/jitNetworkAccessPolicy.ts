...
export class JitNetworkAccessPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: JitNetworkAccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:JitNetworkAccessPolicy" }, { type: "azurerm:security/preview:JitNetworkAccessPolicy" }, { type: "azurerm:security/v20150601preview:JitNetworkAccessPolicy" }] };
