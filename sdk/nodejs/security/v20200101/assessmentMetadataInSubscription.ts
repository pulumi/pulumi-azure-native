...
export class AssessmentMetadataInSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/v20200101:AssessmentMetadataInSubscription';
    ...
    constructor(name: string, argsOrState?: AssessmentMetadataInSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:AssessmentMetadataInSubscription" }, { type: "azurerm:security/preview:AssessmentMetadataInSubscription" }, { type: "azurerm:security/v20190101preview:AssessmentMetadataInSubscription" }] };
