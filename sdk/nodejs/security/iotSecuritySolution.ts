...
export class IotSecuritySolution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:security:IotSecuritySolution';
    ...
    constructor(name: string, args: IotSecuritySolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security/latest:IotSecuritySolution" }, { type: "azure-nextgen:security/v20170801preview:IotSecuritySolution" }, { type: "azure-nextgen:security/v20190801:IotSecuritySolution" }] };
...
export interface IotSecuritySolutionArgs {
     ...
     * List of additional workspaces
     */
    readonly additionalWorkspaces?: pulumi.Input<pulumi.Input<inputs.security.AdditionalWorkspacesProperties>[]>;
    /**
     * Disabled data sources. Disabling these data sources compromises the system.
     */
    readonly disabledDataSources?: pulumi.Input<pulumi.Input<string | enums.security.DataSource>[]>;
    /**
     * Resource display name.
     */
     ...
     * List of additional options for exporting to workspace data.
     */
    readonly export?: pulumi.Input<pulumi.Input<string | enums.security.ExportData>[]>;
    /**
     * IoT Hub resource IDs
     */
     ...
     * List of the configuration status for each recommendation type.
     */
    readonly recommendationsConfiguration?: pulumi.Input<pulumi.Input<inputs.security.RecommendationConfigurationProperties>[]>;
    /**
     ...
     * Status of the IoT Security solution.
     */
    readonly status?: pulumi.Input<string | enums.security.SecuritySolutionStatus>;
    /**
     * Resource tags
     */
     ...
     * Unmasked IP address logging status
     */
    readonly unmaskedIpLoggingStatus?: pulumi.Input<string | enums.security.UnmaskedIpLoggingStatus>;
    /**
     * Properties of the IoT Security solution's user defined resources.
     */
    readonly userDefinedResources?: pulumi.Input<inputs.security.UserDefinedResourcesProperties>;
    /**
     * Workspace resource ID
     */
