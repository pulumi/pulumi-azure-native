...
export class AssessmentMetadataInSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security:AssessmentMetadataInSubscription';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.security.SecurityAssessmentMetadataPropertiesResponse>;
    /**
     * Resource type
     */
...
export interface AssessmentMetadataInSubscriptionArgs {
     ...
     * Describes properties of an assessment metadata.
     */
    readonly properties?: pulumi.Input<inputs.security.SecurityAssessmentMetadataProperties>;
}
