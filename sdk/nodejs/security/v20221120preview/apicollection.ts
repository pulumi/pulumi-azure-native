 ...
 *
 * const apiCollection = new azure_native.security.v20221120preview.APICollection("apiCollection", {
...
export class APICollection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: APICollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security:APICollection" }] };
