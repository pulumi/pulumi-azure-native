...
export class AdaptiveApplicationControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security:AdaptiveApplicationControl';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.security.AppWhitelistingGroupDataResponse>;
    /**
     * Resource type
     */
...
export interface AdaptiveApplicationControlArgs {
     ...
     * Represents a VM/server group and set of rules to be allowed running on a machine
     */
    readonly properties: pulumi.Input<inputs.security.AppWhitelistingGroupData>;
}
