...
export class JitNetworkAccessPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/latest:JitNetworkAccessPolicy';
    ...
    constructor(name: string, args: JitNetworkAccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/preview:JitNetworkAccessPolicy" }, { type: "azurerm:security/v20150601preview:JitNetworkAccessPolicy" }, { type: "azurerm:security/v20200101:JitNetworkAccessPolicy" }] };
