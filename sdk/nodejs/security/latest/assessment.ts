...
export class Assessment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/latest:Assessment';
     ...
     */
    public /*out*/ readonly links!: pulumi.Output<outputs.security.latest.AssessmentLinksResponse | undefined>;
    /**
     ...
     */
    public readonly resourceDetails!: pulumi.Output<outputs.security.latest.ResourceDetailsResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: AssessmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/preview:Assessment" }, { type: "azurerm:security/v20190101preview:Assessment" }, { type: "azurerm:security/v20200101:Assessment" }] };
...
export interface AssessmentArgs {
     ...
     * Details of the resource that was assessed
     */
    readonly resourceDetails: pulumi.Input<inputs.security.latest.ResourceDetails>;
    /**
