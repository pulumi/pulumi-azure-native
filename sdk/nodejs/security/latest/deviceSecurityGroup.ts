...
export class DeviceSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/latest:DeviceSecurityGroup';
     ...
     */
    public readonly allowlistRules!: pulumi.Output<outputs.security.latest.AllowlistCustomAlertRuleResponse[] | undefined>;
    /**
     * The deny-list custom alert rules.
     */
    public readonly denylistRules!: pulumi.Output<outputs.security.latest.DenylistCustomAlertRuleResponse[] | undefined>;
    /**
     * Resource name
     */
     ...
     */
    public readonly thresholdRules!: pulumi.Output<outputs.security.latest.ThresholdCustomAlertRuleResponse[] | undefined>;
    /**
     * The list of custom alert time-window rules.
     */
    public readonly timeWindowRules!: pulumi.Output<outputs.security.latest.TimeWindowCustomAlertRuleResponse[] | undefined>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: DeviceSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/preview:DeviceSecurityGroup" }, { type: "azurerm:security/v20170801preview:DeviceSecurityGroup" }, { type: "azurerm:security/v20190801:DeviceSecurityGroup" }] };
...
export interface DeviceSecurityGroupArgs {
     ...
     * The allow-list custom alert rules.
     */
    readonly allowlistRules?: pulumi.Input<pulumi.Input<inputs.security.latest.AllowlistCustomAlertRule>[]>;
    /**
     * The deny-list custom alert rules.
     */
    readonly denylistRules?: pulumi.Input<pulumi.Input<inputs.security.latest.DenylistCustomAlertRule>[]>;
    /**
     ...
     * The list of custom alert threshold rules.
     */
    readonly thresholdRules?: pulumi.Input<pulumi.Input<inputs.security.latest.ThresholdCustomAlertRule>[]>;
    /**
     * The list of custom alert time-window rules.
     */
    readonly timeWindowRules?: pulumi.Input<pulumi.Input<inputs.security.latest.TimeWindowCustomAlertRule>[]>;
}
