...
export class AdaptiveApplicationControl extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AdaptiveApplicationControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/preview:AdaptiveApplicationControl" }, { type: "azurerm:security/v20150601preview:AdaptiveApplicationControl" }, { type: "azurerm:security/v20200101:AdaptiveApplicationControl" }] };
