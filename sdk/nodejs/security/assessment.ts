...
export class Assessment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security:Assessment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.security.SecurityAssessmentPropertiesResponse>;
    /**
     * Resource type
     */
...
export interface AssessmentArgs {
     ...
     * Describes properties of an assessment.
     */
    readonly properties?: pulumi.Input<inputs.security.SecurityAssessmentProperties>;
    /**
