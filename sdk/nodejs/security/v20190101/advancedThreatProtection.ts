...
export class AdvancedThreatProtection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AdvancedThreatProtectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security/v20190101:AdvancedThreatProtection" }, { type: "azure-native:security:AdvancedThreatProtection" }, { type: "azure-nextgen:security:AdvancedThreatProtection" }, { type: "azure-native:security/v20170801preview:AdvancedThreatProtection" }, { type: "azure-nextgen:security/v20170801preview:AdvancedThreatProtection" }] };
