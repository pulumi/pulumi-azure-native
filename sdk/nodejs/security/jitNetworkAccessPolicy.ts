...
export class JitNetworkAccessPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:security:JitNetworkAccessPolicy';
    ...
    public readonly requests!: pulumi.Output<outputs.security.JitNetworkAccessRequestResponse[] | undefined>;
    /**
     * Resource type
     */
     ...
     */
    public readonly virtualMachines!: pulumi.Output<outputs.security.JitNetworkAccessPolicyVirtualMachineResponse[]>;
    ...
    constructor(name: string, args: JitNetworkAccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security/latest:JitNetworkAccessPolicy" }, { type: "azure-nextgen:security/v20150601preview:JitNetworkAccessPolicy" }, { type: "azure-nextgen:security/v20200101:JitNetworkAccessPolicy" }] };
