...
export class DefenderForStorage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:security/v20241001preview:DefenderForStorage';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.security.v20241001preview.DefenderForStorageSettingPropertiesResponse>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: DefenderForStorageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security/v20221201preview:DefenderForStorage" }, { type: "azure-native:security:DefenderForStorage" }] };
