...
export class AlertsSuppressionRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AlertsSuppressionRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security:AlertsSuppressionRule" }, { type: "azure-native:security/v20190101preview:AlertsSuppressionRule" }, { type: "azure-nextgen:security/v20190101preview:AlertsSuppressionRule" }] };
...
export interface AlertsSuppressionRuleArgs {
     ...
     * Possible states of the rule
     */
    readonly state: pulumi.Input<string | enums.security.RuleState>;
    /**
     * The suppression conditions
     */
    readonly suppressionAlertsScope?: pulumi.Input<inputs.security.SuppressionAlertsScopeArgs>;
}
