...
export class CustomRecommendation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CustomRecommendationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if (args?.customRecommendationName === undefined && !opts.urn) {
                throw new Error("Missing required property 'customRecommendationName'");
            }
...
export interface CustomRecommendationArgs {
     ...
     * List of all standard supported clouds.
     */
    cloudProviders?: pulumi.Input<pulumi.Input<string | enums.security.RecommendationSupportedClouds>[] | undefined>;
    /**
     ...
     * The severity to relate to the assessments generated by this Recommendation.
     */
    securityIssue?: pulumi.Input<string | enums.security.SecurityIssue | undefined>;
    /**
     * The severity to relate to the assessments generated by this Recommendation.
     */
    severity?: pulumi.Input<string | enums.security.SeverityEnum | undefined>;
}
