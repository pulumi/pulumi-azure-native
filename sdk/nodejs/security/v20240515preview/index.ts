...
// Export enums:
export * from "../../types/enums/security/v20240515preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:security/v20240515preview:DevOpsConfiguration":
                return new DevOpsConfiguration(name, <any>undefined, { urn })
            case "azure-native:security/v20240515preview:DevOpsPolicyAssignment":
...
pulumi.runtime.registerResourceModule("azure-native", "security/v20240515preview", _module)
