...
export class DevOpsConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DevOpsConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security:DevOpsConfiguration" }, { type: "azure-native:security/v20230901preview:DevOpsConfiguration" }, { type: "azure-native:security/v20240401:DevOpsConfiguration" }] };
