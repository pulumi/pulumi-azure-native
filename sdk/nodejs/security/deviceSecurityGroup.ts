...
export class DeviceSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security:DeviceSecurityGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.security.DeviceSecurityGroupPropertiesResponse>;
    /**
     * Resource type
     */
...
export interface DeviceSecurityGroupArgs {
     ...
     * Device Security group data
     */
    readonly properties?: pulumi.Input<inputs.security.DeviceSecurityGroupProperties>;
    /**
