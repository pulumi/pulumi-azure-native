...
export class DeviceSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:security:DeviceSecurityGroup';
    ...
    constructor(name: string, args: DeviceSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security/latest:DeviceSecurityGroup" }, { type: "azure-nextgen:security/v20170801preview:DeviceSecurityGroup" }, { type: "azure-nextgen:security/v20190801:DeviceSecurityGroup" }] };
...
export interface DeviceSecurityGroupArgs {
     ...
     * The allow-list custom alert rules.
     */
    readonly allowlistRules?: pulumi.Input<pulumi.Input<inputs.security.AllowlistCustomAlertRule>[]>;
    /**
     * The deny-list custom alert rules.
     */
    readonly denylistRules?: pulumi.Input<pulumi.Input<inputs.security.DenylistCustomAlertRule>[]>;
    /**
     ...
     * The list of custom alert threshold rules.
     */
    readonly thresholdRules?: pulumi.Input<pulumi.Input<inputs.security.ThresholdCustomAlertRule>[]>;
    /**
     * The list of custom alert time-window rules.
     */
    readonly timeWindowRules?: pulumi.Input<pulumi.Input<inputs.security.TimeWindowCustomAlertRule>[]>;
}
