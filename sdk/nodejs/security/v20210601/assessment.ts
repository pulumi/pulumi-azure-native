...
export class Assessment extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly links!: pulumi.Output<outputs.security.v20210601.AssessmentLinksResponse>;
    /**
     * Describes properties of an assessment metadata.
     */
    public readonly metadata!: pulumi.Output<outputs.security.v20210601.SecurityAssessmentMetadataPropertiesResponse | undefined>;
    /**
     * Resource name
     */
     ...
     */
    public readonly partnersData!: pulumi.Output<outputs.security.v20210601.SecurityAssessmentPartnerDataResponse | undefined>;
    /**
     * Details of the resource that was assessed
     */
    public readonly resourceDetails!: pulumi.Output<outputs.security.v20210601.AzureResourceDetailsResponse | outputs.security.v20210601.OnPremiseResourceDetailsResponse | outputs.security.v20210601.OnPremiseSqlResourceDetailsResponse>;
    /**
     * The result of the assessment
     */
    public readonly status!: pulumi.Output<outputs.security.v20210601.AssessmentStatusResponseResponse>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: AssessmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security/v20190101preview:Assessment" }, { type: "azure-native:security/v20200101:Assessment" }, { type: "azure-native:security:Assessment" }] };
...
export interface AssessmentArgs {
     ...
     * Describes properties of an assessment metadata.
     */
    metadata?: pulumi.Input<inputs.security.v20210601.SecurityAssessmentMetadataPropertiesArgs>;
    /**
     * Data regarding 3rd party partner integration
     */
    partnersData?: pulumi.Input<inputs.security.v20210601.SecurityAssessmentPartnerDataArgs>;
    /**
     * Details of the resource that was assessed
     */
    resourceDetails: pulumi.Input<inputs.security.v20210601.AzureResourceDetailsArgs | inputs.security.v20210601.OnPremiseResourceDetailsArgs | inputs.security.v20210601.OnPremiseSqlResourceDetailsArgs>;
    /**
     ...
     * The result of the assessment
     */
    status: pulumi.Input<inputs.security.v20210601.AssessmentStatusArgs>;
}
