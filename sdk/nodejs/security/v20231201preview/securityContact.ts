...
export class SecurityContact extends pulumi.CustomResource {
     ...
     */
    public readonly notificationsByRole!: pulumi.Output<outputs.security.v20231201preview.SecurityContactPropertiesResponseNotificationsByRole | undefined>;
    /**
     * A collection of sources types which evaluate the email notification.
     */
    public readonly notificationsSources!: pulumi.Output<(outputs.security.v20231201preview.NotificationsSourceAlertResponse | outputs.security.v20231201preview.NotificationsSourceAttackPathResponse)[] | undefined>;
    /**
    ...
    constructor(name: string, args?: SecurityContactArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security/v20170801preview:SecurityContact" }, { type: "azure-native:security/v20200101preview:SecurityContact" }, { type: "azure-native:security:SecurityContact" }] };
...
export interface SecurityContactArgs {
     ...
     * Defines whether to send email notifications from Microsoft Defender for Cloud to persons with specific RBAC roles on the subscription.
     */
    notificationsByRole?: pulumi.Input<inputs.security.v20231201preview.SecurityContactPropertiesNotificationsByRoleArgs>;
    /**
     * A collection of sources types which evaluate the email notification.
     */
    notificationsSources?: pulumi.Input<pulumi.Input<inputs.security.v20231201preview.NotificationsSourceAlertArgs | inputs.security.v20231201preview.NotificationsSourceAttackPathArgs>[]>;
    /**
     * The security contact's phone number
     */
