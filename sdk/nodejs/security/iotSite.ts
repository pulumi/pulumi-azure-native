...
export class IotSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:security:IotSite';
    ...
    constructor(name: string, args: IotSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security:IotSite" }, { type: "azure-native:security/v20200806preview:IotSite" }, { type: "azure-nextgen:security/v20200806preview:IotSite" }] };
