...
export class CustomRecommendation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:security/v20240801:CustomRecommendation';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.security.v20240801.SystemDataResponse>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: CustomRecommendationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security:CustomRecommendation" }] };
...
export interface CustomRecommendationArgs {
     ...
     * List of all standard supported clouds.
     */
    cloudProviders?: pulumi.Input<pulumi.Input<string | enums.security.v20240801.RecommendationSupportedClouds>[]>;
    /**
     ...
     * The severity to relate to the assessments generated by this Recommendation.
     */
    securityIssue?: pulumi.Input<string | enums.security.v20240801.SecurityIssue>;
    /**
     * The severity to relate to the assessments generated by this Recommendation.
     */
    severity?: pulumi.Input<string | enums.security.v20240801.SeverityEnum>;
}
