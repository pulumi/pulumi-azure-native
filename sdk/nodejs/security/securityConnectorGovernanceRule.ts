 ...
 */
export class SecurityConnectorGovernanceRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityConnectorGovernanceRule {
        return new SecurityConnectorGovernanceRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:security:SecurityConnectorGovernanceRule';

    /**
     * Returns true if the given object is an instance of SecurityConnectorGovernanceRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SecurityConnectorGovernanceRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SecurityConnectorGovernanceRule.__pulumiType;
    }

    /**
     * The governance rule conditionSets - see examples
     */
    public readonly conditionSets!: pulumi.Output<outputs.security.ConditionResponse[][][]>;
    /**
     ...
     */
    constructor(name: string, args: SecurityConnectorGovernanceRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security/v20220101preview:SecurityConnectorGovernanceRule" }] };
...
export interface SecurityConnectorGovernanceRuleArgs {
     ...
     * The governance rule conditionSets - see examples
     */
    conditionSets: pulumi.Input<pulumi.Input<pulumi.Input<pulumi.Input<inputs.security.ConditionArgs>[]>[]>[]>;
    /**
     * description of the governanceRule
     */
