 ...
 */
export class ManagementGroupGovernanceRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagementGroupGovernanceRule {
        return new ManagementGroupGovernanceRule(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    public static isInstance(obj: any): obj is ManagementGroupGovernanceRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ManagementGroupGovernanceRule.__pulumiType;
    }
    ...
    /**
     * Create a ManagementGroupGovernanceRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ManagementGroupGovernanceRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ManagementGroupGovernanceRule.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ManagementGroupGovernanceRuleArgs {
    /**
     * Description of the governance rule
     */
