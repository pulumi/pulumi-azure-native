...
export class DeviceSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/v20190801:DeviceSecurityGroup';
    ...
    constructor(name: string, argsOrState?: DeviceSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:DeviceSecurityGroup" }, { type: "azurerm:security/preview:DeviceSecurityGroup" }, { type: "azurerm:security/v20170801preview:DeviceSecurityGroup" }] };
