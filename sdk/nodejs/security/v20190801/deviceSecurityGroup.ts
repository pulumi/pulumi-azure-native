...
export class DeviceSecurityGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DeviceSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security/v20190801:DeviceSecurityGroup" }, { type: "azure-native:security:DeviceSecurityGroup" }, { type: "azure-nextgen:security:DeviceSecurityGroup" }, { type: "azure-native:security/v20170801preview:DeviceSecurityGroup" }, { type: "azure-nextgen:security/v20170801preview:DeviceSecurityGroup" }] };
...
export interface DeviceSecurityGroupArgs {
     ...
     * The allow-list custom alert rules.
     */
    readonly allowlistRules?: pulumi.Input<pulumi.Input<inputs.security.v20190801.AllowlistCustomAlertRuleArgs>[]>;
    /**
     * The deny-list custom alert rules.
     */
    readonly denylistRules?: pulumi.Input<pulumi.Input<inputs.security.v20190801.DenylistCustomAlertRuleArgs>[]>;
    /**
     ...
     * The list of custom alert threshold rules.
     */
    readonly thresholdRules?: pulumi.Input<pulumi.Input<inputs.security.v20190801.ThresholdCustomAlertRuleArgs>[]>;
    /**
     * The list of custom alert time-window rules.
     */
    readonly timeWindowRules?: pulumi.Input<pulumi.Input<inputs.security.v20190801.TimeWindowCustomAlertRuleArgs>[]>;
}
