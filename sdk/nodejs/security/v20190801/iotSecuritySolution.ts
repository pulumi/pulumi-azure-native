...
export class IotSecuritySolution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:security/v20190801:IotSecuritySolution';
     ...
     */
    public readonly additionalWorkspaces!: pulumi.Output<outputs.security.v20190801.AdditionalWorkspacesPropertiesResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.security.v20190801.SystemDataResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: IotSecuritySolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security:IotSecuritySolution" }, { type: "azure-nextgen:security/latest:IotSecuritySolution" }, { type: "azure-nextgen:security/v20170801preview:IotSecuritySolution" }] };
...
export interface IotSecuritySolutionArgs {
     ...
     * List of additional workspaces
     */
    readonly additionalWorkspaces?: pulumi.Input<pulumi.Input<inputs.security.v20190801.AdditionalWorkspacesProperties>[]>;
    /**
     * Disabled data sources. Disabling these data sources compromises the system.
     */
