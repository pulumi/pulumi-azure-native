...
export class JitNetworkAccessPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JitNetworkAccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security:JitNetworkAccessPolicy" }, { type: "azure-nextgen:security/latest:JitNetworkAccessPolicy" }, { type: "azure-nextgen:security/v20200101:JitNetworkAccessPolicy" }] };
...
export interface JitNetworkAccessPolicyArgs {
    ...
    readonly requests?: pulumi.Input<pulumi.Input<inputs.security.v20150601preview.JitNetworkAccessRequest>[]>;
    /**
     ...
     * Configurations for Microsoft.Compute/virtualMachines resource type.
     */
    readonly virtualMachines: pulumi.Input<pulumi.Input<inputs.security.v20150601preview.JitNetworkAccessPolicyVirtualMachine>[]>;
}
