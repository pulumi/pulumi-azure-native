 ...
 *
 * const adaptiveApplicationControl = new azurerm.security.v20150601preview.AdaptiveApplicationControl("adaptiveApplicationControl", {
...
export class AdaptiveApplicationControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/v20150601preview:AdaptiveApplicationControl';
    ...
    constructor(name: string, args: AdaptiveApplicationControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:AdaptiveApplicationControl" }, { type: "azurerm:security/v20200101:AdaptiveApplicationControl" }] };
