...
export class IotSensor extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IotSensorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security:IotSensor" }, { type: "azure-native:security/v20200806preview:IotSensor" }, { type: "azure-nextgen:security/v20200806preview:IotSensor" }] };
...
export interface IotSensorArgs {
     ...
     * Type of sensor
     */
    sensorType?: pulumi.Input<string | enums.security.SensorType>;
    /**
     * TI Automatic mode status of the IoT sensor
     */
