...
export class CustomAssessmentAutomation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CustomAssessmentAutomationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security:CustomAssessmentAutomation" }, { type: "azure-native:security/v20210701preview:CustomAssessmentAutomation" }, { type: "azure-nextgen:security/v20210701preview:CustomAssessmentAutomation" }] };
...
export interface CustomAssessmentAutomationArgs {
     ...
     * The implementation effort to relate to the assessments generated by this assessment automation.
     */
    implementationEffort?: pulumi.Input<string | enums.security.ImplementationEffortEnum>;
    /**
     * The remediation description to relate to the assessments generated by this assessment automation.
     */
     ...
     * The user impact to relate to the assessments generated by this assessment automation.
     */
    userImpact?: pulumi.Input<string | enums.security.UserImpactEnum>;
}
