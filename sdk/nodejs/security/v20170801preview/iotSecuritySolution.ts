 ...
 *
 * const iotSecuritySolution = new azurerm.security.v20170801preview.IotSecuritySolution("iotSecuritySolution", {
 *     disabledDataSources: [],
...
export class IotSecuritySolution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/v20170801preview:IotSecuritySolution';
    ...
    constructor(name: string, args: IotSecuritySolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:IotSecuritySolution" }, { type: "azurerm:security/v20190801:IotSecuritySolution" }] };
