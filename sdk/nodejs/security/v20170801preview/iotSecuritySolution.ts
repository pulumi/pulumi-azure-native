...
export class IotSecuritySolution extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IotSecuritySolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:IotSecuritySolution" }, { type: "azurerm:security/preview:IotSecuritySolution" }, { type: "azurerm:security/v20190801:IotSecuritySolution" }] };
