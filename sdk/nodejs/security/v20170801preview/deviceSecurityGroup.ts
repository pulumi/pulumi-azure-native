...
export class DeviceSecurityGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DeviceSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/latest:DeviceSecurityGroup" }, { type: "azurerm:security/preview:DeviceSecurityGroup" }, { type: "azurerm:security/v20190801:DeviceSecurityGroup" }] };
