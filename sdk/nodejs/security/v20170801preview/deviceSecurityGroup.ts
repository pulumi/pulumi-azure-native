...
export class DeviceSecurityGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DeviceSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security:DeviceSecurityGroup" }, { type: "azure-nextgen:security/latest:DeviceSecurityGroup" }, { type: "azure-nextgen:security/v20190801:DeviceSecurityGroup" }] };
