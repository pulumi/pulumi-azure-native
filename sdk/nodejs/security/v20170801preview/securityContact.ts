...
export class SecurityContact extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:security/v20170801preview:SecurityContact';
    ...
    constructor(name: string, args: SecurityContactArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/preview:SecurityContact" }, { type: "azurerm:security/v20200101preview:SecurityContact" }] };
