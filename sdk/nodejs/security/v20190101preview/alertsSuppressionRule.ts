...
export class AlertsSuppressionRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AlertsSuppressionRule {
        return new AlertsSuppressionRule(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: AlertsSuppressionRuleArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as AlertsSuppressionRuleArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:security/preview:AlertsSuppressionRule" }] };
