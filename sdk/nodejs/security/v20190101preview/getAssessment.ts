...
export function getAssessment(args: GetAssessmentArgs, opts?: pulumi.InvokeOptions): Promise<GetAssessmentResult> {
    ...
    return pulumi.runtime.invoke("azurerm:security/v20190101preview:getAssessment", {
...
export interface GetAssessmentResult {
     ...
     */
    readonly resourceDetails: outputs.security.v20190101preview.ResourceDetailsResponse;
    /**
