...
export class AssessmentsMetadataSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AssessmentsMetadataSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security/v20190101preview:AssessmentsMetadataSubscription" }, { type: "azure-native:security:AssessmentsMetadataSubscription" }, { type: "azure-nextgen:security:AssessmentsMetadataSubscription" }, { type: "azure-native:security/v20200101:AssessmentsMetadataSubscription" }, { type: "azure-nextgen:security/v20200101:AssessmentsMetadataSubscription" }, { type: "azure-native:security/v20210601:AssessmentsMetadataSubscription" }, { type: "azure-nextgen:security/v20210601:AssessmentsMetadataSubscription" }] };
...
export interface AssessmentsMetadataSubscriptionArgs {
     ...
     * BuiltIn if the assessment based on built-in Azure Policy definition, Custom if the assessment based on custom Azure Policy definition
     */
    assessmentType: pulumi.Input<string | enums.security.v20190101preview.AssessmentType>;
    categories?: pulumi.Input<pulumi.Input<string | enums.security.v20190101preview.Categories>[]>;
    /**
     * Human readable description of the assessment
     */
     ...
     * The implementation effort required to remediate this assessment
     */
    implementationEffort?: pulumi.Input<string | enums.security.v20190101preview.ImplementationEffort>;
    /**
     * True if this assessment is in preview release status
     */
     ...
     * The severity level of the assessment
     */
    severity: pulumi.Input<string | enums.security.v20190101preview.Severity>;
    threats?: pulumi.Input<pulumi.Input<string | enums.security.v20190101preview.Threats>[]>;
    /**
     * The user impact of the assessment
     */
    userImpact?: pulumi.Input<string | enums.security.v20190101preview.UserImpact>;
}
