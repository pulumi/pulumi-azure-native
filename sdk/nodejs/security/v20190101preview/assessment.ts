...
export class Assessment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AssessmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security:Assessment" }, { type: "azure-nextgen:security/latest:Assessment" }, { type: "azure-nextgen:security/v20200101:Assessment" }] };
