...
export class Ec2KeyPair extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.awsconnector.Ec2KeyPairPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: Ec2KeyPairArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? pulumi.output(args.properties).apply(v => v === undefined ? undefined : inputs.awsconnector.ec2KeyPairPropertiesArgsProvideDefaults(v)) : undefined;
...
export interface Ec2KeyPairArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.Ec2KeyPairPropertiesArgs | undefined>;
    /**
