...
export class Ec2Vpc extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ec2Vpc {
        return new Ec2Vpc(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:Ec2Vpc';
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.awsconnector.Ec2VpcPropertiesResponse>;
    /**
...
export interface Ec2VpcArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.Ec2VpcPropertiesArgs | undefined>;
    /**
