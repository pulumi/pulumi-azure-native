...
export class Ec2Volume extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.Ec2VolumePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: Ec2VolumeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:Ec2Volume" }, { type: "azure-native_awsconnector_v20241201:awsconnector:Ec2Volume" }] };
