...
export class ElasticBeanstalkEnvironment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ElasticBeanstalkEnvironment {
        return new ElasticBeanstalkEnvironment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:ElasticBeanstalkEnvironment';
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.awsconnector.ElasticBeanstalkEnvironmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ElasticBeanstalkEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:ElasticBeanstalkEnvironment" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(ElasticBeanstalkEnvironment.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface ElasticBeanstalkEnvironmentArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.ElasticBeanstalkEnvironmentPropertiesArgs | undefined>;
    /**
