...
export class SsmParameter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:SsmParameter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.SsmParameterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SsmParameterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:SsmParameter" }] };
...
export interface SsmParameterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.SsmParameterPropertiesArgs>;
    /**
