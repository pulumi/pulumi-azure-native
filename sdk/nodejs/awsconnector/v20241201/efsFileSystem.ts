...
export class EfsFileSystem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:EfsFileSystem';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.EfsFileSystemPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EfsFileSystemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:EfsFileSystem" }] };
...
export interface EfsFileSystemArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.EfsFileSystemPropertiesArgs>;
    /**
