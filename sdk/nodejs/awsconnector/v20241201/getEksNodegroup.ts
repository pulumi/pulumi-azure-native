...
export function getEksNodegroup(args: GetEksNodegroupArgs, opts?: pulumi.InvokeOptions): Promise<GetEksNodegroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:awsconnector/v20241201:getEksNodegroup", {
        "name": args.name,
...
export interface GetEksNodegroupResult {
     ...
     */
    readonly properties: outputs.awsconnector.v20241201.EksNodegroupPropertiesResponse;
    /**
