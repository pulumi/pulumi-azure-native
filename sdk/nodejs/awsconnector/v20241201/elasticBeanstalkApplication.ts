...
export class ElasticBeanstalkApplication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:ElasticBeanstalkApplication';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.ElasticBeanstalkApplicationPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ElasticBeanstalkApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:ElasticBeanstalkApplication" }] };
