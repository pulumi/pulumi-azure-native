...
export class LogsLogGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:LogsLogGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.LogsLogGroupPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LogsLogGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.awsconnector.v20241201.logsLogGroupPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:LogsLogGroup" }] };
