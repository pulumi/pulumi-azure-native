...
export function getS3AccessControlPolicy(args: GetS3AccessControlPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetS3AccessControlPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-native:awsconnector/v20241201:getS3AccessControlPolicy", {
        "name": args.name,
...
export function getS3AccessControlPolicyOutput(args: GetS3AccessControlPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetS3AccessControlPolicyResult> {
    return pulumi.output(args).apply((a: any) => getS3AccessControlPolicy(a, opts))
}
