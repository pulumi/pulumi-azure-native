...
export class IamVirtualMfaDevice extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:IamVirtualMfaDevice';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.IamVirtualMFADevicePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: IamVirtualMfaDeviceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:IamVirtualMfaDevice" }] };
...
export interface IamVirtualMfaDeviceArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.IamVirtualMFADevicePropertiesArgs>;
    /**
