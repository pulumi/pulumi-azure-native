...
export class RdsExportTask extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:RdsExportTask';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.RdsExportTaskPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RdsExportTaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:RdsExportTask" }] };
...
export interface RdsExportTaskArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.RdsExportTaskPropertiesArgs>;
    /**
