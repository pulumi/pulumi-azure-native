...
export class ElasticBeanstalkConfigurationTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:ElasticBeanstalkConfigurationTemplate';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.ElasticBeanstalkConfigurationTemplatePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ElasticBeanstalkConfigurationTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:ElasticBeanstalkConfigurationTemplate" }] };
