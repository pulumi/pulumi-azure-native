...
export interface GetEcrImageDetailArgs {
    /**
 ...
 */
export interface GetEcrImageDetailResult {
    /**
     ...
     */
    readonly properties: outputs.awsconnector.v20241201.EcrImageDetailPropertiesResponse;
    /**
