...
export class Ec2SecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:Ec2SecurityGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.Ec2SecurityGroupPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: Ec2SecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:Ec2SecurityGroup" }] };
...
export interface Ec2SecurityGroupArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.Ec2SecurityGroupPropertiesArgs>;
    /**
