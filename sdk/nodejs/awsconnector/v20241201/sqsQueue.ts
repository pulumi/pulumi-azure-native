...
export class SqsQueue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:SqsQueue';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.SqsQueuePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SqsQueueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:SqsQueue" }] };
...
export interface SqsQueueArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.SqsQueuePropertiesArgs>;
    /**
