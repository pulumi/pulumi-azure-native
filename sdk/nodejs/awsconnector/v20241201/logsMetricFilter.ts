...
export class LogsMetricFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:LogsMetricFilter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.LogsMetricFilterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LogsMetricFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:LogsMetricFilter" }] };
...
export interface LogsMetricFilterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.LogsMetricFilterPropertiesArgs>;
    /**
