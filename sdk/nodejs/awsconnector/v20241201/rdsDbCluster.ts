...
export class RdsDbCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:RdsDbCluster';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.RdsDBClusterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RdsDbClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.awsconnector.v20241201.rdsDBClusterPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:RdsDbCluster" }] };
...
export interface RdsDbClusterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.RdsDBClusterPropertiesArgs>;
    /**
