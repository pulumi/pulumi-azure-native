...
export class Ec2Subnet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ec2Subnet {
        return new Ec2Subnet(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:Ec2Subnet';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.Ec2SubnetPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: Ec2SubnetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:Ec2Subnet" }] };
...
export interface Ec2SubnetArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.Ec2SubnetPropertiesArgs>;
    /**
