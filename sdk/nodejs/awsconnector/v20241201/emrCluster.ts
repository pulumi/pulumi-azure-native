...
export class EmrCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:EmrCluster';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.EmrClusterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EmrClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:EmrCluster" }] };
...
export interface EmrClusterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.EmrClusterPropertiesArgs>;
    /**
