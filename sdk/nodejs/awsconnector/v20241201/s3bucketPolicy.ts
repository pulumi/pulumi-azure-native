...
export class S3BucketPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:S3BucketPolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.S3BucketPolicyPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: S3BucketPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:S3BucketPolicy" }] };
...
export interface S3BucketPolicyArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.S3BucketPolicyPropertiesArgs>;
    /**
