...
export class EcsCluster extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EcsCluster {
        return new EcsCluster(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:EcsCluster';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.EcsClusterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EcsClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:EcsCluster" }] };
...
export interface EcsClusterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.EcsClusterPropertiesArgs>;
    /**
