...
export class CodeBuildProject extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:CodeBuildProject';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.CodeBuildProjectPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CodeBuildProjectArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:CodeBuildProject" }] };
...
export interface CodeBuildProjectArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.CodeBuildProjectPropertiesArgs>;
    /**
