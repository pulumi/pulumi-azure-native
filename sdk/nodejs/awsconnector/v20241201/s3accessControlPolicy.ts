...
export class S3AccessControlPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:S3AccessControlPolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.S3AccessControlPolicyPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: S3AccessControlPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:S3AccessControlPolicy" }] };
...
export interface S3AccessControlPolicyArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.S3AccessControlPolicyPropertiesArgs>;
    /**
