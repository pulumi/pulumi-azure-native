...
export function getGuardDutyDetector(args: GetGuardDutyDetectorArgs, opts?: pulumi.InvokeOptions): Promise<GetGuardDutyDetectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:awsconnector/v20241201:getGuardDutyDetector", {
        "name": args.name,
...
export interface GetGuardDutyDetectorResult {
     ...
     */
    readonly properties: outputs.awsconnector.v20241201.GuardDutyDetectorPropertiesResponse;
    /**
