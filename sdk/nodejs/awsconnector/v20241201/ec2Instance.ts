...
export class Ec2Instance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:Ec2Instance';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.Ec2InstancePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: Ec2InstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.awsconnector.v20241201.ec2InstancePropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:Ec2Instance" }] };
...
export interface Ec2InstanceArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.Ec2InstancePropertiesArgs>;
    /**
