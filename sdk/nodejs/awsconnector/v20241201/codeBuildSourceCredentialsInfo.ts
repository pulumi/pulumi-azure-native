...
export class CodeBuildSourceCredentialsInfo extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:CodeBuildSourceCredentialsInfo';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.CodeBuildSourceCredentialsInfoPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CodeBuildSourceCredentialsInfoArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:CodeBuildSourceCredentialsInfo" }] };
