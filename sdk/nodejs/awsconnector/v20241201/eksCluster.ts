...
export class EksCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector/v20241201:EksCluster';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.v20241201.EksClusterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EksClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector:EksCluster" }] };
...
export interface EksClusterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.v20241201.EksClusterPropertiesArgs>;
    /**
