...
export class S3BucketPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.S3BucketPolicyPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: S3BucketPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:S3BucketPolicy" }, { type: "azure-native_awsconnector_v20241201:awsconnector:S3BucketPolicy" }] };
