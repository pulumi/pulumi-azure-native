...
export class LogsLogGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.awsconnector.LogsLogGroupPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LogsLogGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? pulumi.output(args.properties).apply(v => v === undefined ? undefined : inputs.awsconnector.logsLogGroupPropertiesArgsProvideDefaults(v)) : undefined;
...
export interface LogsLogGroupArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.LogsLogGroupPropertiesArgs | undefined>;
    /**
