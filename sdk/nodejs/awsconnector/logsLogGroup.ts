...
export class LogsLogGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.LogsLogGroupPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LogsLogGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:LogsLogGroup" }, { type: "azure-native_awsconnector_v20241201:awsconnector:LogsLogGroup" }] };
