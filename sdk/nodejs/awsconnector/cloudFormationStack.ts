...
export class CloudFormationStack extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.CloudFormationStackPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CloudFormationStackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:CloudFormationStack" }, { type: "azure-native_awsconnector_v20241201:awsconnector:CloudFormationStack" }] };
