...
export class RdsDbInstance extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.awsconnector.RdsDBInstancePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RdsDbInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? pulumi.output(args.properties).apply(v => v === undefined ? undefined : inputs.awsconnector.rdsDBInstancePropertiesArgsProvideDefaults(v)) : undefined;
...
export interface RdsDbInstanceArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.RdsDBInstancePropertiesArgs | undefined>;
    /**
