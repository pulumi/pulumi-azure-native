...
export class IamRole extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.awsconnector.IamRolePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: IamRoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? pulumi.output(args.properties).apply(v => v === undefined ? undefined : inputs.awsconnector.iamRolePropertiesArgsProvideDefaults(v)) : undefined;
...
export interface IamRoleArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.IamRolePropertiesArgs | undefined>;
    /**
