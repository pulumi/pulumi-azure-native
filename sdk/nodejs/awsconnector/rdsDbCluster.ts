...
export class RdsDbCluster extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.awsconnector.RdsDBClusterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RdsDbClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:RdsDbCluster" }, { type: "azure-native_awsconnector_v20241201:awsconnector:RdsDbCluster" }] };
