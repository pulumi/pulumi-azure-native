...
export class RdsDbCluster extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.awsconnector.RdsDBClusterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RdsDbClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? pulumi.output(args.properties).apply(v => v === undefined ? undefined : inputs.awsconnector.rdsDBClusterPropertiesArgsProvideDefaults(v)) : undefined;
...
export interface RdsDbClusterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.awsconnector.RdsDBClusterPropertiesArgs | undefined>;
    /**
