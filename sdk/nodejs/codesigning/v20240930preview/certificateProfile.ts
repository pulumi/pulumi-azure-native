...
export class CertificateProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:codesigning/v20240930preview:CertificateProfile';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.codesigning.v20240930preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: CertificateProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:codesigning/v20240205preview:CertificateProfile" }, { type: "azure-native:codesigning:CertificateProfile" }] };
...
export interface CertificateProfileArgs {
     ...
     * Profile type of the certificate.
     */
    profileType: pulumi.Input<string | enums.codesigning.v20240930preview.ProfileType>;
    /**
