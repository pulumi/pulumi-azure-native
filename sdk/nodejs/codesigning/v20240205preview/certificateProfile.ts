...
export class CertificateProfile extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.codesigning.v20240205preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: CertificateProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:codesigning:CertificateProfile" }, { type: "azure-native:codesigning/v20240930preview:CertificateProfile" }] };
