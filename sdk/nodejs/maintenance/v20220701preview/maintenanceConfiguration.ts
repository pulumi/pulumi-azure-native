...
export class MaintenanceConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:maintenance/v20220701preview:MaintenanceConfiguration';
     ...
     */
    public readonly installPatches!: pulumi.Output<outputs.maintenance.v20220701preview.InputPatchConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.maintenance.v20220701preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: MaintenanceConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["installPatches"] = args ? (args.installPatches ? pulumi.output(args.installPatches).apply(inputs.maintenance.v20220701preview.inputPatchConfigurationArgsProvideDefaults) : undefined) : undefined;
...
export interface MaintenanceConfigurationArgs {
     ...
     * The input parameters to be passed to the patch run operation. This property only applies to Guest (InGuestPatch) scope.
     */
    installPatches?: pulumi.Input<inputs.maintenance.v20220701preview.InputPatchConfigurationArgs>;
    /**
     * Gets or sets location of the resource
     */
     ...
     * Gets or sets maintenanceScope of the configuration
     */
    maintenanceScope?: pulumi.Input<string | enums.maintenance.v20220701preview.MaintenanceScope>;
    /**
     * Gets or sets namespace of the resource
     */
     ...
     * Gets or sets the visibility of the configuration. The default value is 'Custom'
     */
    visibility?: pulumi.Input<string | enums.maintenance.v20220701preview.Visibility>;
}
