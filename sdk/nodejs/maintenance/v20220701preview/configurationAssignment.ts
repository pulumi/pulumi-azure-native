...
export class ConfigurationAssignment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationAssignment {
        pulumi.log.warn("ConfigurationAssignment is deprecated: azure-native:maintenance/v20220701preview:ConfigurationAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:maintenance/v20221101preview:ConfigurationAssignment to guarantee forwards compatibility.")
        return new ConfigurationAssignment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:maintenance/v20220701preview:ConfigurationAssignment';
    ...
    constructor(name: string, args: ConfigurationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:maintenance:ConfigurationAssignment" }, { type: "azure-native:maintenance/v20210401preview:ConfigurationAssignment" }, { type: "azure-native:maintenance/v20210901preview:ConfigurationAssignment" }, { type: "azure-native:maintenance/v20221101preview:ConfigurationAssignment" }] };
