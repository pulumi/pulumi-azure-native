...
export class ConfigurationAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConfigurationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:maintenance/v20210401preview:ConfigurationAssignment" }, { type: "azure-native:maintenance:ConfigurationAssignment" }, { type: "azure-nextgen:maintenance:ConfigurationAssignment" }] };
