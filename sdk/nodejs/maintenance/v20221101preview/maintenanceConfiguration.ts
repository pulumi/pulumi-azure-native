...
export class MaintenanceConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly installPatches!: pulumi.Output<outputs.maintenance.v20221101preview.InputPatchConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly overrides!: pulumi.Output<outputs.maintenance.v20221101preview.MaintenanceOverridePropertiesResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.maintenance.v20221101preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: MaintenanceConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["installPatches"] = args ? (args.installPatches ? pulumi.output(args.installPatches).apply(inputs.maintenance.v20221101preview.inputPatchConfigurationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:maintenance:MaintenanceConfiguration" }, { type: "azure-native:maintenance/v20200401:MaintenanceConfiguration" }, { type: "azure-native:maintenance/v20210401preview:MaintenanceConfiguration" }] };
...
export interface MaintenanceConfigurationArgs {
     ...
     * The input parameters to be passed to the patch run operation.
     */
    installPatches?: pulumi.Input<inputs.maintenance.v20221101preview.InputPatchConfigurationArgs>;
    /**
     * Gets or sets location of the resource
     */
     ...
     * Gets or sets maintenanceScope of the configuration
     */
    maintenanceScope?: pulumi.Input<string | enums.maintenance.v20221101preview.MaintenanceScope>;
    /**
     * Gets or sets namespace of the resource
     */
     ...
     * Override Properties for the maintenance Configuration.
     */
    overrides?: pulumi.Input<pulumi.Input<inputs.maintenance.v20221101preview.MaintenanceOverridePropertiesArgs>[]>;
    /**
     * Rate at which a Maintenance window is expected to recur. The rate can be expressed as daily, weekly, or monthly schedules. Daily schedule are formatted as recurEvery: [Frequency as integer]['Day(s)']. If no frequency is provided, the default frequency is 1. Daily schedule examples are recurEvery: Day, recurEvery: 3Days.  Weekly schedule are formatted as recurEvery: [Frequency as integer]['Week(s)'] [Optional comma separated list of weekdays Monday-Sunday]. Weekly schedule examples are recurEvery: 3Weeks, recurEvery: Week Saturday,Sunday. Monthly schedules are formatted as [Frequency as integer]['Month(s)'] [Comma separated list of month days] or [Frequency as integer]['Month(s)'] [Week of Month (First, Second, Third, Fourth, Last)] [Weekday Monday-Sunday] [Optional Offset(No. of days)]. Offset value must be between -6 to 6 inclusive. Monthly schedule examples are recurEvery: Month, recurEvery: 2Months, recurEvery: Month day23,day24, recurEvery: Month Last Sunday, recurEvery: Month Fourth Monday, recurEvery: Month Last Sunday Offset-3, recurEvery: Month Third Sunday Offset6.
     */
     ...
     * Gets or sets the visibility of the configuration. The default value is 'Custom'
     */
    visibility?: pulumi.Input<string | enums.maintenance.v20221101preview.Visibility>;
}
