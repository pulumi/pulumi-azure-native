...
export class MaintenanceConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MaintenanceConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["installPatches"] = args ? pulumi.output(args.installPatches).apply(v => v === undefined ? undefined : inputs.maintenance.inputPatchConfigurationArgsProvideDefaults(v)) : undefined;
...
export interface MaintenanceConfigurationArgs {
     ...
     * The input parameters to be passed to the patch run operation.
     */
    installPatches?: pulumi.Input<inputs.maintenance.InputPatchConfigurationArgs | undefined>;
    /**
     * Gets or sets location of the resource
     */
     ...
     * Gets or sets maintenanceScope of the configuration
     */
    maintenanceScope?: pulumi.Input<string | enums.maintenance.MaintenanceScope | undefined>;
    /**
     * Gets or sets namespace of the resource
     */
     ...
     * Gets or sets the visibility of the configuration. The default value is 'Custom'
     */
    visibility?: pulumi.Input<string | enums.maintenance.Visibility | undefined>;
}
