...
export class ConfigurationAssignmentsForSubscription extends pulumi.CustomResource {
     ...
     */
    public readonly filter!: pulumi.Output<outputs.maintenance.v20230401.ConfigurationAssignmentFilterPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.maintenance.v20230401.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args?: ConfigurationAssignmentsForSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:maintenance/v20230901preview:ConfigurationAssignmentsForSubscription" }, { type: "azure-native:maintenance/v20231001preview:ConfigurationAssignmentsForSubscription" }, { type: "azure-native:maintenance:ConfigurationAssignmentsForSubscription" }] };
...
export interface ConfigurationAssignmentsForSubscriptionArgs {
     ...
     * Properties of the configuration assignment
     */
    filter?: pulumi.Input<inputs.maintenance.v20230401.ConfigurationAssignmentFilterPropertiesArgs>;
    /**
     * Location of the resource
     */
