...
export function listBitLockerKey(args: ListBitLockerKeyArgs, opts?: pulumi.InvokeOptions): Promise<ListBitLockerKeyResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:importexport/v20161101:listBitLockerKey", {
...
export interface ListBitLockerKeyResult {
     ...
     * drive status
     */
    readonly value?: outputs.importexport.v20161101.DriveBitLockerKeyInvokeResponse[];
}
