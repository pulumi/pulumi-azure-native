...
export class CommunityEndpoint extends pulumi.CustomResource {
     ...
     */
    declare public readonly ruleCollection: pulumi.Output<outputs.mission.CommunityEndpointDestinationRuleResponse[]>;
    /**
    ...
    constructor(name: string, args: CommunityEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mission/v20240601preview:CommunityEndpoint" }, { type: "azure-native:mission/v20241201preview:CommunityEndpoint" }, { type: "azure-native:mission/v20250501preview:CommunityEndpoint" }, { type: "azure-native:mission/v20251101preview:CommunityEndpoint" }, { type: "azure-native:mission/v20260301preview:CommunityEndpoint" }] };
