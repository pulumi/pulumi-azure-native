...
export class Approval extends pulumi.CustomResource {
     ...
     */
    public readonly parent1!: pulumi.Output<string | undefined>;
    /**
     * Parameter for optimizing query results
     */
    public readonly parent2!: pulumi.Output<string | undefined>;
    /**
     * Provisioning State.
     */
    ...
    constructor(name: string, args: ApprovalArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["parent1"] = args ? args.parent1 : undefined;
            resourceInputs["parent2"] = args ? args.parent2 : undefined;
            ...
            resourceInputs["name"] = undefined /*out*/;
            resourceInputs["parent1"] = undefined /*out*/;
            resourceInputs["parent2"] = undefined /*out*/;
            resourceInputs["provisioningState"] = undefined /*out*/;
...
export interface ApprovalArgs {
     ...
     * Parameter for optimizing query results
     */
    parent1?: pulumi.Input<string>;
    /**
     * Parameter for optimizing query results
     */
    parent2?: pulumi.Input<string>;
    /**
     * Request metadata for the approval request.
     */
