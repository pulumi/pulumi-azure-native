 ...
 * 
 */
public final class InformixSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InformixSourceArgs(InformixSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InformixSourceArgs();
        }

        public Builder(InformixSourceArgs defaults) {
            $ = new InformixSourceArgs(Objects.requireNonNull(defaults));
        }
