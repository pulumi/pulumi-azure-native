 ...
 * 
 */
public final class ExcelSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ExcelSourceArgs(ExcelSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(ExcelSourceArgs defaults) {
            $ = new ExcelSourceArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param storeSettings Excel store settings.
         * 
         * @return builder
         * 
         */
