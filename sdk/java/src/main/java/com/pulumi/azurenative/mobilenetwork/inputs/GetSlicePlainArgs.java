...
public final class GetSlicePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSlicePlainArgs Empty = new GetSlicePlainArgs();
    ...
    private GetSlicePlainArgs() {}

    private GetSlicePlainArgs(GetSlicePlainArgs $) {
    ...
    public static Builder builder(GetSlicePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSlicePlainArgs();
        }

        public Builder(GetSlicePlainArgs defaults) {
            $ = new GetSlicePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSlicePlainArgs build() {
