...
public final class CosmosDbMongoDbApiCollectionDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CosmosDbMongoDbApiCollectionDatasetArgs(CosmosDbMongoDbApiCollectionDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CosmosDbMongoDbApiCollectionDatasetArgs();
        }

        public Builder(CosmosDbMongoDbApiCollectionDatasetArgs defaults) {
            $ = new CosmosDbMongoDbApiCollectionDatasetArgs(Objects.requireNonNull(defaults));
        }
