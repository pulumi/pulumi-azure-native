...
public final class GetSqlMigrationServicePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSqlMigrationServicePlainArgs Empty = new GetSqlMigrationServicePlainArgs();
    ...
    private GetSqlMigrationServicePlainArgs() {}

    private GetSqlMigrationServicePlainArgs(GetSqlMigrationServicePlainArgs $) {
    ...
    public static Builder builder(GetSqlMigrationServicePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSqlMigrationServicePlainArgs();
        }

        public Builder(GetSqlMigrationServicePlainArgs defaults) {
            $ = new GetSqlMigrationServicePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSqlMigrationServicePlainArgs build() {
