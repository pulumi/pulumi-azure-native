...
public final class GetIntegrationAccountAssemblyPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetIntegrationAccountAssemblyPlainArgs Empty = new GetIntegrationAccountAssemblyPlainArgs();
    ...
    private GetIntegrationAccountAssemblyPlainArgs() {}

    private GetIntegrationAccountAssemblyPlainArgs(GetIntegrationAccountAssemblyPlainArgs $) {
    ...
    public static Builder builder(GetIntegrationAccountAssemblyPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetIntegrationAccountAssemblyPlainArgs();
        }

        public Builder(GetIntegrationAccountAssemblyPlainArgs defaults) {
            $ = new GetIntegrationAccountAssemblyPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetIntegrationAccountAssemblyPlainArgs build() {
