...
public final class GetAssetEncryptionKeyArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetAssetEncryptionKeyArgs(GetAssetEncryptionKeyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAssetEncryptionKeyArgs();
        }

        public Builder(GetAssetEncryptionKeyArgs defaults) {
            $ = new GetAssetEncryptionKeyArgs(Objects.requireNonNull(defaults));
        }
