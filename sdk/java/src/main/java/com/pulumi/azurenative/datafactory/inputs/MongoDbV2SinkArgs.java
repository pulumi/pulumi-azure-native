 ...
 * 
 */
public final class MongoDbV2SinkArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MongoDbV2SinkArgs(MongoDbV2SinkArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MongoDbV2SinkArgs();
        }

        public Builder(MongoDbV2SinkArgs defaults) {
            $ = new MongoDbV2SinkArgs(Objects.requireNonNull(defaults));
        }
