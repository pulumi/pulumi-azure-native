 ...
 * 
 */
public final class StringNotContainsAdvancedFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private StringNotContainsAdvancedFilterArgs(StringNotContainsAdvancedFilterArgs $) {
        this.key = $.key;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StringNotContainsAdvancedFilterArgs();
        }

        public Builder(StringNotContainsAdvancedFilterArgs defaults) {
            $ = new StringNotContainsAdvancedFilterArgs(Objects.requireNonNull(defaults));
        }
