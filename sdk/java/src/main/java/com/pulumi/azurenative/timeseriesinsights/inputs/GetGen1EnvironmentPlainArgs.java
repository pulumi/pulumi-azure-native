...
public final class GetGen1EnvironmentPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetGen1EnvironmentPlainArgs Empty = new GetGen1EnvironmentPlainArgs();
    ...
    private GetGen1EnvironmentPlainArgs() {}

    private GetGen1EnvironmentPlainArgs(GetGen1EnvironmentPlainArgs $) {
    ...
    public static Builder builder(GetGen1EnvironmentPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGen1EnvironmentPlainArgs();
        }

        public Builder(GetGen1EnvironmentPlainArgs defaults) {
            $ = new GetGen1EnvironmentPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGen1EnvironmentPlainArgs build() {
