...
public final class HiveLinkedServiceResponse {
    ...
    public static final class Builder {
        ...
        public HiveLinkedServiceResponse build() {
            final var o = new HiveLinkedServiceResponse();
