...
public final class GetGremlinResourceGremlinGraphResult {
    ...
    public Optional<GremlinGraphGetPropertiesResponseOptions> options() {
        return Optional.ofNullable(this.options);
    }
    public Optional<GremlinGraphGetPropertiesResponseResource> resource() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder options(@Nullable GremlinGraphGetPropertiesResponseOptions options) {
            this.options = options;
            return this;
        }
        @CustomType.Setter
        public Builder resource(@Nullable GremlinGraphGetPropertiesResponseResource resource) {
        ...
        public GetGremlinResourceGremlinGraphResult build() {
            final var o = new GetGremlinResourceGremlinGraphResult();
            o.id = id;
            o.location = location;
            o.name = name;
            o.options = options;
