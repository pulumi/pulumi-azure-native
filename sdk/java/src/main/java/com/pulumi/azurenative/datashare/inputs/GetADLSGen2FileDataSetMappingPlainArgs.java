...
public final class GetADLSGen2FileDataSetMappingPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetADLSGen2FileDataSetMappingPlainArgs Empty = new GetADLSGen2FileDataSetMappingPlainArgs();
    ...
    private GetADLSGen2FileDataSetMappingPlainArgs() {}

    private GetADLSGen2FileDataSetMappingPlainArgs(GetADLSGen2FileDataSetMappingPlainArgs $) {
    ...
    public static Builder builder(GetADLSGen2FileDataSetMappingPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetADLSGen2FileDataSetMappingPlainArgs();
        }

        public Builder(GetADLSGen2FileDataSetMappingPlainArgs defaults) {
            $ = new GetADLSGen2FileDataSetMappingPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetADLSGen2FileDataSetMappingPlainArgs build() {
