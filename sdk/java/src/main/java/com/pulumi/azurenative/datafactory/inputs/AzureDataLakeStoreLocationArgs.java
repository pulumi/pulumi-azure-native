...
public final class AzureDataLakeStoreLocationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureDataLakeStoreLocationArgs(AzureDataLakeStoreLocationArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureDataLakeStoreLocationArgs();
        }

        public Builder(AzureDataLakeStoreLocationArgs defaults) {
            $ = new AzureDataLakeStoreLocationArgs(Objects.requireNonNull(defaults));
        }
