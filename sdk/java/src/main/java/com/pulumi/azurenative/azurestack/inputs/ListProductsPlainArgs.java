...
public final class ListProductsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final ListProductsPlainArgs Empty = new ListProductsPlainArgs();
    ...
    private ListProductsPlainArgs() {}

    private ListProductsPlainArgs(ListProductsPlainArgs $) {
    ...
    public static Builder builder(ListProductsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListProductsPlainArgs();
        }

        public Builder(ListProductsPlainArgs defaults) {
            $ = new ListProductsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ListProductsPlainArgs build() {
