...
public class ADLSGen1FileDataSet extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ADLSGen1FileDataSet(String name) {
        this(name, ADLSGen1FileDataSetArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ADLSGen1FileDataSet(String name, ADLSGen1FileDataSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:datashare:ADLSGen1FileDataSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ADLSGen1FileDataSet(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:datashare/v20181101preview:ADLSGen1FileDataSet").build()),
                Output.of(Alias.builder().type("azure-native:datashare/v20191101:ADLSGen1FileDataSet").build()),
                Output.of(Alias.builder().type("azure-native:datashare/v20200901:ADLSGen1FileDataSet").build()),
                Output.of(Alias.builder().type("azure-native:datashare/v20201001preview:ADLSGen1FileDataSet").build()),
                Output.of(Alias.builder().type("azure-native:datashare/v20210801:ADLSGen1FileDataSet").build())
            ))
            .build();
     ...
     */
    public static ADLSGen1FileDataSet get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
