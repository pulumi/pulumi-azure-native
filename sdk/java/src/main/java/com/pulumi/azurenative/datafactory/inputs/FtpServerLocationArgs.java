 ...
 * 
 */
public final class FtpServerLocationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FtpServerLocationArgs(FtpServerLocationArgs $) {
