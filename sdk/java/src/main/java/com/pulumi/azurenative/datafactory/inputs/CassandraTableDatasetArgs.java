 ...
 * 
 */
public final class CassandraTableDatasetArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<Object>> keyspace() {
    ...
    private CassandraTableDatasetArgs(CassandraTableDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CassandraTableDatasetArgs();
        }

        public Builder(CassandraTableDatasetArgs defaults) {
            $ = new CassandraTableDatasetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder keyspace(Object keyspace) {
            return keyspace(Output.of(keyspace));
        }
