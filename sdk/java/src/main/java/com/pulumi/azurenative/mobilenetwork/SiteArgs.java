...
import com.pulumi.azurenative.mobilenetwork.inputs.SubResourceArgs;
...
public final class SiteArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="networkFunctions")
    private @Nullable Output<List<SubResourceArgs>> networkFunctions;

    /**
     * @return An array of ids of the network functions deployed on the site, maintained by the user.
     * 
     */
    public Optional<Output<List<SubResourceArgs>>> networkFunctions() {
        return Optional.ofNullable(this.networkFunctions);
    }
    ...
    public static final class Builder {
        ...
        /**
         * @param networkFunctions An array of ids of the network functions deployed on the site, maintained by the user.
         * 
         * @return builder
         * 
         */
        public Builder networkFunctions(@Nullable Output<List<SubResourceArgs>> networkFunctions) {
         ...
         * 
         */
        public Builder networkFunctions(List<SubResourceArgs> networkFunctions) {
            return networkFunctions(Output.of(networkFunctions));
        }
         ...
         * 
         */
        public Builder networkFunctions(SubResourceArgs... networkFunctions) {
