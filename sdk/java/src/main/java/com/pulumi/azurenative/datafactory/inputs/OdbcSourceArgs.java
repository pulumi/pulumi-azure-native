 ...
 * 
 */
public final class OdbcSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final OdbcSourceArgs Empty = new OdbcSourceArgs();
    ...
    private OdbcSourceArgs() {}

    private OdbcSourceArgs(OdbcSourceArgs $) {
    ...
    public static Builder builder(OdbcSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(OdbcSourceArgs defaults) {
            $ = new OdbcSourceArgs(Objects.requireNonNull(defaults));
        }
