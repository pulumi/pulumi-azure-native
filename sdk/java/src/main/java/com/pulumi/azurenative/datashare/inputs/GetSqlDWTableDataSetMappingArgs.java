...
public final class GetSqlDWTableDataSetMappingArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSqlDWTableDataSetMappingArgs Empty = new GetSqlDWTableDataSetMappingArgs();
    ...
    private GetSqlDWTableDataSetMappingArgs() {}

    private GetSqlDWTableDataSetMappingArgs(GetSqlDWTableDataSetMappingArgs $) {
    ...
    public static Builder builder(GetSqlDWTableDataSetMappingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSqlDWTableDataSetMappingArgs();
        }

        public Builder(GetSqlDWTableDataSetMappingArgs defaults) {
            $ = new GetSqlDWTableDataSetMappingArgs(Objects.requireNonNull(defaults));
        }
