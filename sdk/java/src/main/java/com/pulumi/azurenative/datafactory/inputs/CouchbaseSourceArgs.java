 ...
 * 
 */
public final class CouchbaseSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CouchbaseSourceArgs(CouchbaseSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CouchbaseSourceArgs();
        }

        public Builder(CouchbaseSourceArgs defaults) {
            $ = new CouchbaseSourceArgs(Objects.requireNonNull(defaults));
        }
