...
public final class GetKustoClusterDataSetMappingArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetKustoClusterDataSetMappingArgs Empty = new GetKustoClusterDataSetMappingArgs();
    ...
    private GetKustoClusterDataSetMappingArgs() {}

    private GetKustoClusterDataSetMappingArgs(GetKustoClusterDataSetMappingArgs $) {
    ...
    public static Builder builder(GetKustoClusterDataSetMappingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKustoClusterDataSetMappingArgs();
        }

        public Builder(GetKustoClusterDataSetMappingArgs defaults) {
            $ = new GetKustoClusterDataSetMappingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetKustoClusterDataSetMappingArgs build() {
