 ...
 * 
 */
public final class DatabaseConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseConfigurationArgs Empty = new DatabaseConfigurationArgs();
    ...
    private DatabaseConfigurationArgs() {}

    private DatabaseConfigurationArgs(DatabaseConfigurationArgs $) {
    ...
    public static Builder builder(DatabaseConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseConfigurationArgs();
        }

        public Builder(DatabaseConfigurationArgs defaults) {
            $ = new DatabaseConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param instanceCount The number of database VMs.
         * 
         * @return builder
         * 
         */
        ...
        public DatabaseConfigurationArgs build() {
