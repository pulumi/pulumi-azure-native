...
public final class WebAppPrivateEndpointConnectionSlotArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAppPrivateEndpointConnectionSlotArgs(WebAppPrivateEndpointConnectionSlotArgs $) {
        this.kind = $.kind;
        this.name = $.name;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAppPrivateEndpointConnectionSlotArgs();
        }

        public Builder(WebAppPrivateEndpointConnectionSlotArgs defaults) {
            $ = new WebAppPrivateEndpointConnectionSlotArgs(Objects.requireNonNull(defaults));
        }
