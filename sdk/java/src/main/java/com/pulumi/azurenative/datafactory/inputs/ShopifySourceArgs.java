 ...
 * 
 */
public final class ShopifySourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ShopifySourceArgs(ShopifySourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ShopifySourceArgs();
        }

        public Builder(ShopifySourceArgs defaults) {
            $ = new ShopifySourceArgs(Objects.requireNonNull(defaults));
        }
