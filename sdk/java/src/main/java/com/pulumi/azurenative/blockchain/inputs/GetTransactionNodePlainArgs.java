...
public final class GetTransactionNodePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetTransactionNodePlainArgs Empty = new GetTransactionNodePlainArgs();
    ...
    private GetTransactionNodePlainArgs() {}

    private GetTransactionNodePlainArgs(GetTransactionNodePlainArgs $) {
    ...
    public static Builder builder(GetTransactionNodePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTransactionNodePlainArgs();
        }

        public Builder(GetTransactionNodePlainArgs defaults) {
            $ = new GetTransactionNodePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetTransactionNodePlainArgs build() {
