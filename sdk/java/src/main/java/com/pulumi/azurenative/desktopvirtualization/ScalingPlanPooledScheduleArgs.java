...
import com.pulumi.azurenative.desktopvirtualization.enums.DayOfWeek;
...
public final class ScalingPlanPooledScheduleArgs extends com.pulumi.resources.ResourceArgs {

    public static final ScalingPlanPooledScheduleArgs Empty = new ScalingPlanPooledScheduleArgs();
    ...
    private @Nullable Output<List<Either<String,DayOfWeek>>> daysOfWeek;

    /**
     * @return Set of days of the week on which this schedule is active.
     * 
     */
    public Optional<Output<List<Either<String,DayOfWeek>>>> daysOfWeek() {
    ...
    private @Nullable Output<TimeArgs> offPeakStartTime;

    /**
     * @return Starting time for off-peak period.
     * 
     */
    public Optional<Output<TimeArgs>> offPeakStartTime() {
    ...
    private @Nullable Output<TimeArgs> peakStartTime;

    /**
     * @return Starting time for peak period.
     * 
     */
    public Optional<Output<TimeArgs>> peakStartTime() {
    ...
    private @Nullable Output<TimeArgs> rampDownStartTime;

    /**
     * @return Starting time for ramp down period.
     * 
     */
    public Optional<Output<TimeArgs>> rampDownStartTime() {
    ...
    private @Nullable Output<TimeArgs> rampUpStartTime;

    /**
     * @return Starting time for ramp up period.
     * 
     */
    public Optional<Output<TimeArgs>> rampUpStartTime() {
     ...
     * 
     */
    @Import(name="scalingPlanScheduleName")
    private @Nullable Output<String> scalingPlanScheduleName;

    /**
     * @return The name of the ScalingPlanSchedule
     * 
     */
    public Optional<Output<String>> scalingPlanScheduleName() {
        return Optional.ofNullable(this.scalingPlanScheduleName);
    }

    private ScalingPlanPooledScheduleArgs() {}

    private ScalingPlanPooledScheduleArgs(ScalingPlanPooledScheduleArgs $) {
    ...
    public static Builder builder(ScalingPlanPooledScheduleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ScalingPlanPooledScheduleArgs();
        }

        public Builder(ScalingPlanPooledScheduleArgs defaults) {
            $ = new ScalingPlanPooledScheduleArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder daysOfWeek(@Nullable Output<List<Either<String,DayOfWeek>>> daysOfWeek) {
         ...
         * 
         */
        public Builder daysOfWeek(List<Either<String,DayOfWeek>> daysOfWeek) {
         ...
         * 
         */
        public Builder daysOfWeek(Either<String,DayOfWeek>... daysOfWeek) {
         ...
         * 
         */
        public Builder offPeakStartTime(@Nullable Output<TimeArgs> offPeakStartTime) {
         ...
         * 
         */
        public Builder offPeakStartTime(TimeArgs offPeakStartTime) {
         ...
         * 
         */
        public Builder peakStartTime(@Nullable Output<TimeArgs> peakStartTime) {
         ...
         * 
         */
        public Builder peakStartTime(TimeArgs peakStartTime) {
         ...
         * 
         */
        public Builder rampDownStartTime(@Nullable Output<TimeArgs> rampDownStartTime) {
         ...
         * 
         */
        public Builder rampDownStartTime(TimeArgs rampDownStartTime) {
         ...
         * 
         */
        public Builder rampUpStartTime(@Nullable Output<TimeArgs> rampUpStartTime) {
         ...
         * 
         */
        public Builder rampUpStartTime(TimeArgs rampUpStartTime) {
         ...
         * 
         */
        public Builder scalingPlanScheduleName(@Nullable Output<String> scalingPlanScheduleName) {
        ...
        public ScalingPlanPooledScheduleArgs build() {
