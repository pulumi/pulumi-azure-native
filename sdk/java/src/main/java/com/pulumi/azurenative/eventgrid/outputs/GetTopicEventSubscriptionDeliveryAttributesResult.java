...
@CustomType
public final class GetTopicEventSubscriptionDeliveryAttributesResult {
    /**
    ...
    private GetTopicEventSubscriptionDeliveryAttributesResult() {}
    /**
     * @return A collection of DeliveryAttributeMapping
     * 
     */
    ...
    public static Builder builder(GetTopicEventSubscriptionDeliveryAttributesResult defaults) {
    ...
    public static final class Builder {
        private @Nullable List<Either<DynamicDeliveryAttributeMappingResponse,StaticDeliveryAttributeMappingResponse>> value;
        public Builder() {}
        public Builder(GetTopicEventSubscriptionDeliveryAttributesResult defaults) {
        ...
        public GetTopicEventSubscriptionDeliveryAttributesResult build() {
            final var o = new GetTopicEventSubscriptionDeliveryAttributesResult();
            o.value = value;
            return o;
        }
    }
