...
public final class GetSAPVirtualInstanceArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSAPVirtualInstanceArgs Empty = new GetSAPVirtualInstanceArgs();
    ...
    private GetSAPVirtualInstanceArgs() {}

    private GetSAPVirtualInstanceArgs(GetSAPVirtualInstanceArgs $) {
    ...
    public static Builder builder(GetSAPVirtualInstanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSAPVirtualInstanceArgs();
        }

        public Builder(GetSAPVirtualInstanceArgs defaults) {
            $ = new GetSAPVirtualInstanceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSAPVirtualInstanceArgs build() {
