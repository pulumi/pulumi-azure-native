...
public final class AmazonS3ReadSettingsResponse {
    ...
    private String type;
    /**
     * @return AmazonS3 wildcardFileName. Type: string (or Expression with resultType string).
     * 
     */
    private @Nullable Object wildcardFileName;
    /**
     * @return AmazonS3 wildcardFolderPath. Type: string (or Expression with resultType string).
     * 
     */
    ...
    public static final class Builder {
        ...
        public AmazonS3ReadSettingsResponse build() {
            final var o = new AmazonS3ReadSettingsResponse();
