...
public final class GetSqlResourceSqlContainerResult {
    ...
    public Optional<SqlContainerGetPropertiesResponseOptions> options() {
        return Optional.ofNullable(this.options);
    }
    public Optional<SqlContainerGetPropertiesResponseResource> resource() {
    ...
    public static final class Builder {
        ...
        public GetSqlResourceSqlContainerResult build() {
            final var o = new GetSqlResourceSqlContainerResult();
            o.id = id;
            o.location = location;
            o.name = name;
            o.options = options;
