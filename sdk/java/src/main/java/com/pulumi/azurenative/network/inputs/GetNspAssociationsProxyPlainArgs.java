...
public final class GetNspAssociationsProxyPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetNspAssociationsProxyPlainArgs Empty = new GetNspAssociationsProxyPlainArgs();
    ...
    private GetNspAssociationsProxyPlainArgs() {}

    private GetNspAssociationsProxyPlainArgs(GetNspAssociationsProxyPlainArgs $) {
    ...
    public static Builder builder(GetNspAssociationsProxyPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNspAssociationsProxyPlainArgs();
        }

        public Builder(GetNspAssociationsProxyPlainArgs defaults) {
            $ = new GetNspAssociationsProxyPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetNspAssociationsProxyPlainArgs build() {
