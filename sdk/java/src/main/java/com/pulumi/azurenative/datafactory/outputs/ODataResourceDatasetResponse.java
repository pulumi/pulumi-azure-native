...
@CustomType
public final class ODataResourceDatasetResponse {
    /**
    ...
    /**
     * @return The OData resource path. Type: string (or Expression with resultType string).
     * 
     */
    ...
    public static final class Builder {
        ...
        public ODataResourceDatasetResponse build() {
            final var o = new ODataResourceDatasetResponse();
