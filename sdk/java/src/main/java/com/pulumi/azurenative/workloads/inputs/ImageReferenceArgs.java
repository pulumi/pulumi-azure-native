...
public final class ImageReferenceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<String> sharedGalleryImageId;
     ...
     * 
     */
    public Optional<Output<String>> sharedGalleryImageId() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder sharedGalleryImageId(@Nullable Output<String> sharedGalleryImageId) {
