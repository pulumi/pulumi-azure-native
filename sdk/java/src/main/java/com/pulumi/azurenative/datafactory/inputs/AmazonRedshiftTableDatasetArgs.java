 ...
 * 
 */
public final class AmazonRedshiftTableDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AmazonRedshiftTableDatasetArgs(AmazonRedshiftTableDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AmazonRedshiftTableDatasetArgs();
        }

        public Builder(AmazonRedshiftTableDatasetArgs defaults) {
            $ = new AmazonRedshiftTableDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param table The Amazon Redshift table name. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
