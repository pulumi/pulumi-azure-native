...
public final class IngressArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<CustomDomainArgs>> customDomains;

    /**
     * @return custom domain bindings for Container Apps&#39; hostnames.
     * 
     */
    public Optional<Output<List<CustomDomainArgs>>> customDomains() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder customDomains(@Nullable Output<List<CustomDomainArgs>> customDomains) {
         ...
         * 
         */
        public Builder customDomains(List<CustomDomainArgs> customDomains) {
