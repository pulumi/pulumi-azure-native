...
public final class ListDnsForwardingRulesetByVirtualNetworkArgs extends com.pulumi.resources.InvokeArgs {

    public static final ListDnsForwardingRulesetByVirtualNetworkArgs Empty = new ListDnsForwardingRulesetByVirtualNetworkArgs();
    ...
    private ListDnsForwardingRulesetByVirtualNetworkArgs() {}

    private ListDnsForwardingRulesetByVirtualNetworkArgs(ListDnsForwardingRulesetByVirtualNetworkArgs $) {
    ...
    public static Builder builder(ListDnsForwardingRulesetByVirtualNetworkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListDnsForwardingRulesetByVirtualNetworkArgs();
        }

        public Builder(ListDnsForwardingRulesetByVirtualNetworkArgs defaults) {
            $ = new ListDnsForwardingRulesetByVirtualNetworkArgs(Objects.requireNonNull(defaults));
        }
