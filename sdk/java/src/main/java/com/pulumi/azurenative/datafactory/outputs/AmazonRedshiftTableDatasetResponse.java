...
@CustomType
public final class AmazonRedshiftTableDatasetResponse {
    /**
    ...
    /**
     * @return The Amazon Redshift table name. Type: string (or Expression with resultType string).
     * 
     */
    ...
    public static final class Builder {
        ...
        public AmazonRedshiftTableDatasetResponse build() {
            final var o = new AmazonRedshiftTableDatasetResponse();
