 ...
 * 
 */
public final class NatRuleConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private NatRuleConditionArgs(NatRuleConditionArgs $) {
