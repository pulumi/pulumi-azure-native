...
@CustomType
public final class XeroSourceResponse {
    /**
    ...
    public static Builder builder(XeroSourceResponse defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(XeroSourceResponse defaults) {
        ...
        public XeroSourceResponse build() {
            final var o = new XeroSourceResponse();
