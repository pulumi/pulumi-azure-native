 ...
 * 
 */
public final class ImpalaSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ImpalaSourceArgs(ImpalaSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ImpalaSourceArgs();
        }

        public Builder(ImpalaSourceArgs defaults) {
            $ = new ImpalaSourceArgs(Objects.requireNonNull(defaults));
        }
