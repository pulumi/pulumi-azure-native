...
public class WebAppSwiftVirtualNetworkConnection extends com.pulumi.resources.CustomResource {
    /**
     * Kind of resource.
     * 
     */
     ...
     */
    public WebAppSwiftVirtualNetworkConnection(String name, WebAppSwiftVirtualNetworkConnectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private WebAppSwiftVirtualNetworkConnection(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("azure-native:web/v20220301:WebAppSwiftVirtualNetworkConnection").build())
            ))
            .build();
     ...
     */
    public static WebAppSwiftVirtualNetworkConnection get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
