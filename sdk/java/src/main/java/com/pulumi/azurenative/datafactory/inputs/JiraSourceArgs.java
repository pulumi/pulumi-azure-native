 ...
 * 
 */
public final class JiraSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final JiraSourceArgs Empty = new JiraSourceArgs();
    ...
    private JiraSourceArgs() {}

    private JiraSourceArgs(JiraSourceArgs $) {
    ...
    public static Builder builder(JiraSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(JiraSourceArgs defaults) {
            $ = new JiraSourceArgs(Objects.requireNonNull(defaults));
        }
