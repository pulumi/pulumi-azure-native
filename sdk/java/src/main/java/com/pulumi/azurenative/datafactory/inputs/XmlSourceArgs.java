 ...
 * 
 */
public final class XmlSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<XmlReadSettingsArgs> formatSettings;

    /**
     * @return Xml format settings.
     * 
     */
    public Optional<Output<XmlReadSettingsArgs>> formatSettings() {
    ...
    private XmlSourceArgs(XmlSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(XmlSourceArgs defaults) {
            $ = new XmlSourceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder formatSettings(@Nullable Output<XmlReadSettingsArgs> formatSettings) {
         ...
         * 
         */
        public Builder formatSettings(XmlReadSettingsArgs formatSettings) {
