...
public final class GetDomainEventSubscriptionFullUrlArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainEventSubscriptionFullUrlArgs Empty = new GetDomainEventSubscriptionFullUrlArgs();
    ...
    private GetDomainEventSubscriptionFullUrlArgs() {}

    private GetDomainEventSubscriptionFullUrlArgs(GetDomainEventSubscriptionFullUrlArgs $) {
    ...
    public static Builder builder(GetDomainEventSubscriptionFullUrlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainEventSubscriptionFullUrlArgs();
        }

        public Builder(GetDomainEventSubscriptionFullUrlArgs defaults) {
            $ = new GetDomainEventSubscriptionFullUrlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDomainEventSubscriptionFullUrlArgs build() {
