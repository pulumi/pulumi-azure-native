...
public class NspAssociation extends com.pulumi.resources.CustomResource {
     ...
     */
    public NspAssociation(String name) {
     ...
     */
    public NspAssociation(String name, NspAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:network:NspAssociation", name, args == null ? NspAssociationArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private NspAssociation(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:network:NspAssociation", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static NspAssociation get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
