...
public final class GetScalingPlanPooledScheduleResult {
     ...
     * 
     */
    public Optional<TimeResponse> offPeakStartTime() {
     ...
     * 
     */
    public Optional<TimeResponse> peakStartTime() {
     ...
     * 
     */
    public Optional<TimeResponse> rampDownStartTime() {
     ...
     * 
     */
    public Optional<TimeResponse> rampUpStartTime() {
    ...
    public static final class Builder {
        ...
        public GetScalingPlanPooledScheduleResult build() {
            final var o = new GetScalingPlanPooledScheduleResult();
