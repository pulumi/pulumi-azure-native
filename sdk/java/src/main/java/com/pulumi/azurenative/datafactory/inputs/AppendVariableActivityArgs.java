 ...
 * 
 */
public final class AppendVariableActivityArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AppendVariableActivityArgs(AppendVariableActivityArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppendVariableActivityArgs();
        }

        public Builder(AppendVariableActivityArgs defaults) {
            $ = new AppendVariableActivityArgs(Objects.requireNonNull(defaults));
        }
