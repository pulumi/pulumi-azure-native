 ...
 * 
 */
public final class NodeProfileArgs extends com.pulumi.resources.ResourceArgs {

    public static final NodeProfileArgs Empty = new NodeProfileArgs();
    ...
    private NodeProfileArgs() {}

    private NodeProfileArgs(NodeProfileArgs $) {
    ...
    public static Builder builder(NodeProfileArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(NodeProfileArgs defaults) {
            $ = new NodeProfileArgs(Objects.requireNonNull(defaults));
        }
