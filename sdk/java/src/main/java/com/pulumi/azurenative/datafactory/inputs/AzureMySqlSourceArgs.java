 ...
 * 
 */
public final class AzureMySqlSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureMySqlSourceArgs() {}

    private AzureMySqlSourceArgs(AzureMySqlSourceArgs $) {
    ...
    public static Builder builder(AzureMySqlSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureMySqlSourceArgs();
        }

        public Builder(AzureMySqlSourceArgs defaults) {
            $ = new AzureMySqlSourceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureMySqlSourceArgs build() {
