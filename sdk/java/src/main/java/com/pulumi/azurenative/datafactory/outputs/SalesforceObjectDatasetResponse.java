...
@CustomType
public final class SalesforceObjectDatasetResponse {
    /**
    ...
    /**
     * @return The Salesforce object API name. Type: string (or Expression with resultType string).
     * 
     */
    ...
    public static final class Builder {
        ...
        public SalesforceObjectDatasetResponse build() {
            final var o = new SalesforceObjectDatasetResponse();
