...
public final class SapOdpLinkedServiceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<Object> subscriberName;

    /**
     * @return The subscriber name. Type: string (or Expression with resultType string).
     * 
     */
    public Optional<Output<Object>> subscriberName() {
    ...
    private @Nullable Output<Object> x509CertificatePath;

    /**
     * @return SNC X509 certificate file path. Type: string (or Expression with resultType string).
     * 
     */
    public Optional<Output<Object>> x509CertificatePath() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder subscriberName(@Nullable Output<Object> subscriberName) {
         ...
         * 
         */
        public Builder x509CertificatePath(@Nullable Output<Object> x509CertificatePath) {
