...
public final class AmazonS3CompatibleReadSettingsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AmazonS3CompatibleReadSettingsArgs(AmazonS3CompatibleReadSettingsArgs $) {
    ...
    public static Builder builder(AmazonS3CompatibleReadSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AmazonS3CompatibleReadSettingsArgs();
        }

        public Builder(AmazonS3CompatibleReadSettingsArgs defaults) {
            $ = new AmazonS3CompatibleReadSettingsArgs(Objects.requireNonNull(defaults));
        }
