...
public final class ListWebAppAzureStorageAccountsSlotArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private ListWebAppAzureStorageAccountsSlotArgs(ListWebAppAzureStorageAccountsSlotArgs $) {
        this.name = $.name;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListWebAppAzureStorageAccountsSlotArgs();
        }

        public Builder(ListWebAppAzureStorageAccountsSlotArgs defaults) {
            $ = new ListWebAppAzureStorageAccountsSlotArgs(Objects.requireNonNull(defaults));
        }
