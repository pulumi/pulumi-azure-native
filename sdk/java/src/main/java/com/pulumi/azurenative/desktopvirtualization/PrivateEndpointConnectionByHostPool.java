...
public class PrivateEndpointConnectionByHostPool extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public PrivateEndpointConnectionByHostPool(String name, PrivateEndpointConnectionByHostPoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private PrivateEndpointConnectionByHostPool(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("azure-native:desktopvirtualization/v20220401preview:PrivateEndpointConnectionByHostPool").build())
            ))
            .build();
     ...
     */
    public static PrivateEndpointConnectionByHostPool get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
