 ...
 * 
 */
public final class StringEndsWithAdvancedFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private StringEndsWithAdvancedFilterArgs() {}

    private StringEndsWithAdvancedFilterArgs(StringEndsWithAdvancedFilterArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(StringEndsWithAdvancedFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StringEndsWithAdvancedFilterArgs();
        }

        public Builder(StringEndsWithAdvancedFilterArgs defaults) {
            $ = new StringEndsWithAdvancedFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StringEndsWithAdvancedFilterArgs build() {
