...
public final class LoadBalancerNatRuleReferenceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private LoadBalancerNatRuleReferenceArgs(LoadBalancerNatRuleReferenceArgs $) {
        this.name = $.name;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoadBalancerNatRuleReferenceArgs();
        }

        public Builder(LoadBalancerNatRuleReferenceArgs defaults) {
            $ = new LoadBalancerNatRuleReferenceArgs(Objects.requireNonNull(defaults));
        }
