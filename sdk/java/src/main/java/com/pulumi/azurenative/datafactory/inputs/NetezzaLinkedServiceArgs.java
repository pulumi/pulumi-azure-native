 ...
 * 
 */
public final class NetezzaLinkedServiceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private NetezzaLinkedServiceArgs(NetezzaLinkedServiceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetezzaLinkedServiceArgs();
        }

        public Builder(NetezzaLinkedServiceArgs defaults) {
            $ = new NetezzaLinkedServiceArgs(Objects.requireNonNull(defaults));
        }
