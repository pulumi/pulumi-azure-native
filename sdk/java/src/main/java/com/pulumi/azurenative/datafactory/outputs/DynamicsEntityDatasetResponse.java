...
@CustomType
public final class DynamicsEntityDatasetResponse {
    /**
    ...
    /**
     * @return The logical name of the entity. Type: string (or Expression with resultType string).
     * 
     */
    private @Nullable Object entityName;
    /**
     ...
     * 
     */
    public Optional<Object> entityName() {
    ...
    public static Builder builder(DynamicsEntityDatasetResponse defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(DynamicsEntityDatasetResponse defaults) {
        ...
        public DynamicsEntityDatasetResponse build() {
            final var o = new DynamicsEntityDatasetResponse();
