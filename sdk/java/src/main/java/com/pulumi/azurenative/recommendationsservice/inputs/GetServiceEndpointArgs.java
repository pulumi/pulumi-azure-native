...
public final class GetServiceEndpointArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetServiceEndpointArgs Empty = new GetServiceEndpointArgs();
    ...
    private GetServiceEndpointArgs() {}

    private GetServiceEndpointArgs(GetServiceEndpointArgs $) {
    ...
    public static Builder builder(GetServiceEndpointArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceEndpointArgs();
        }

        public Builder(GetServiceEndpointArgs defaults) {
            $ = new GetServiceEndpointArgs(Objects.requireNonNull(defaults));
        }
