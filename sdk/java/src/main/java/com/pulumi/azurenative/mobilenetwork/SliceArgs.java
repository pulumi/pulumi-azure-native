...
public final class SliceArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="sliceName")
    private @Nullable Output<String> sliceName;

    /**
     * @return The name of the mobile network slice.
     * 
     */
    public Optional<Output<String>> sliceName() {
        return Optional.ofNullable(this.sliceName);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder sliceName(@Nullable Output<String> sliceName) {
            $.sliceName = sliceName;
            return this;
        }
        ...
        /**
         * @param snssai The S-NSSAI (single network slice selection assistance information). Unique at the scope of a MobileNetwork.
         * 
         * @return builder
         * 
         */
        public Builder snssai(Output<SnssaiArgs> snssai) {
            $.snssai = snssai;
            return this;
        }
         ...
         * 
         */
        public Builder snssai(SnssaiArgs snssai) {
            return snssai(Output.of(snssai));
        }
        ...
        public SliceArgs build() {
            ...
            $.snssai = Objects.requireNonNull($.snssai, "expected parameter 'snssai' to be non-null");
            return $;
        }
    }
