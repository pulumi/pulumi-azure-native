 ...
 * 
 */
public final class DynamicsCrmSinkArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DynamicsCrmSinkArgs(DynamicsCrmSinkArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DynamicsCrmSinkArgs();
        }

        public Builder(DynamicsCrmSinkArgs defaults) {
            $ = new DynamicsCrmSinkArgs(Objects.requireNonNull(defaults));
        }
