...
public final class GetSubAccountTagRulePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSubAccountTagRulePlainArgs Empty = new GetSubAccountTagRulePlainArgs();
    ...
    private GetSubAccountTagRulePlainArgs() {}

    private GetSubAccountTagRulePlainArgs(GetSubAccountTagRulePlainArgs $) {
    ...
    public static Builder builder(GetSubAccountTagRulePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSubAccountTagRulePlainArgs();
        }

        public Builder(GetSubAccountTagRulePlainArgs defaults) {
            $ = new GetSubAccountTagRulePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSubAccountTagRulePlainArgs build() {
