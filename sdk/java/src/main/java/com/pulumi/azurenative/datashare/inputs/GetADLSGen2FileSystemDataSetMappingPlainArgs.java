...
public final class GetADLSGen2FileSystemDataSetMappingPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetADLSGen2FileSystemDataSetMappingPlainArgs Empty = new GetADLSGen2FileSystemDataSetMappingPlainArgs();
    ...
    private GetADLSGen2FileSystemDataSetMappingPlainArgs() {}

    private GetADLSGen2FileSystemDataSetMappingPlainArgs(GetADLSGen2FileSystemDataSetMappingPlainArgs $) {
    ...
    public static Builder builder(GetADLSGen2FileSystemDataSetMappingPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetADLSGen2FileSystemDataSetMappingPlainArgs();
        }

        public Builder(GetADLSGen2FileSystemDataSetMappingPlainArgs defaults) {
            $ = new GetADLSGen2FileSystemDataSetMappingPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetADLSGen2FileSystemDataSetMappingPlainArgs build() {
