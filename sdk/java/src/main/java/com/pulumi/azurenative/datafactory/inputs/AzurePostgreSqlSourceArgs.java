 ...
 * 
 */
public final class AzurePostgreSqlSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzurePostgreSqlSourceArgs(AzurePostgreSqlSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzurePostgreSqlSourceArgs();
        }

        public Builder(AzurePostgreSqlSourceArgs defaults) {
            $ = new AzurePostgreSqlSourceArgs(Objects.requireNonNull(defaults));
        }
