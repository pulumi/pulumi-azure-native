 ...
 * 
 */
public final class MarketoObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MarketoObjectDatasetArgs(MarketoObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MarketoObjectDatasetArgs();
        }

        public Builder(MarketoObjectDatasetArgs defaults) {
            $ = new MarketoObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
