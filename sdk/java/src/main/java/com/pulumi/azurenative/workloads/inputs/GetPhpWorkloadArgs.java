...
public final class GetPhpWorkloadArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetPhpWorkloadArgs Empty = new GetPhpWorkloadArgs();
    ...
    private GetPhpWorkloadArgs() {}

    private GetPhpWorkloadArgs(GetPhpWorkloadArgs $) {
    ...
    public static Builder builder(GetPhpWorkloadArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPhpWorkloadArgs();
        }

        public Builder(GetPhpWorkloadArgs defaults) {
            $ = new GetPhpWorkloadArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPhpWorkloadArgs build() {
