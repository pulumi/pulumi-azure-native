 ...
 * 
 */
public final class PhoenixSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final PhoenixSourceArgs Empty = new PhoenixSourceArgs();
    ...
    private PhoenixSourceArgs() {}

    private PhoenixSourceArgs(PhoenixSourceArgs $) {
    ...
    public static Builder builder(PhoenixSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PhoenixSourceArgs();
        }

        public Builder(PhoenixSourceArgs defaults) {
            $ = new PhoenixSourceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PhoenixSourceArgs build() {
