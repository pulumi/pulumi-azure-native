 ...
 * 
 */
public final class ZohoSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZohoSourceArgs Empty = new ZohoSourceArgs();
    ...
    private ZohoSourceArgs() {}

    private ZohoSourceArgs(ZohoSourceArgs $) {
    ...
    public static Builder builder(ZohoSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ZohoSourceArgs defaults) {
            $ = new ZohoSourceArgs(Objects.requireNonNull(defaults));
        }
