...
public final class GetSolutionConfigPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSolutionConfigPlainArgs Empty = new GetSolutionConfigPlainArgs();
    ...
    private GetSolutionConfigPlainArgs() {}

    private GetSolutionConfigPlainArgs(GetSolutionConfigPlainArgs $) {
    ...
    public static Builder builder(GetSolutionConfigPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSolutionConfigPlainArgs();
        }

        public Builder(GetSolutionConfigPlainArgs defaults) {
            $ = new GetSolutionConfigPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSolutionConfigPlainArgs build() {
