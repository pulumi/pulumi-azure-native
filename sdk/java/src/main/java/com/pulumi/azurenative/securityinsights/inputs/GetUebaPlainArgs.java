...
public final class GetUebaPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetUebaPlainArgs Empty = new GetUebaPlainArgs();
    ...
    private GetUebaPlainArgs() {}

    private GetUebaPlainArgs(GetUebaPlainArgs $) {
    ...
    public static Builder builder(GetUebaPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetUebaPlainArgs();
        }

        public Builder(GetUebaPlainArgs defaults) {
            $ = new GetUebaPlainArgs(Objects.requireNonNull(defaults));
        }
