...
public final class GoogleCloudStorageLocationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GoogleCloudStorageLocationArgs(GoogleCloudStorageLocationArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudStorageLocationArgs();
        }

        public Builder(GoogleCloudStorageLocationArgs defaults) {
            $ = new GoogleCloudStorageLocationArgs(Objects.requireNonNull(defaults));
        }
