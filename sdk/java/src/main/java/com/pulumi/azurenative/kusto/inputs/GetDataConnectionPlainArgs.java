...
public final class GetDataConnectionPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDataConnectionPlainArgs Empty = new GetDataConnectionPlainArgs();
    ...
    private GetDataConnectionPlainArgs() {}

    private GetDataConnectionPlainArgs(GetDataConnectionPlainArgs $) {
    ...
    public static Builder builder(GetDataConnectionPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDataConnectionPlainArgs();
        }

        public Builder(GetDataConnectionPlainArgs defaults) {
            $ = new GetDataConnectionPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDataConnectionPlainArgs build() {
