...
@CustomType
public final class GetDomainTopicEventSubscriptionDeliveryAttributesResult {
    /**
    ...
    private GetDomainTopicEventSubscriptionDeliveryAttributesResult() {}
    /**
     * @return A collection of DeliveryAttributeMapping
     * 
     */
    ...
    public static Builder builder(GetDomainTopicEventSubscriptionDeliveryAttributesResult defaults) {
    ...
    public static final class Builder {
        private @Nullable List<Either<DynamicDeliveryAttributeMappingResponse,StaticDeliveryAttributeMappingResponse>> value;
        public Builder() {}
        public Builder(GetDomainTopicEventSubscriptionDeliveryAttributesResult defaults) {
        ...
        public GetDomainTopicEventSubscriptionDeliveryAttributesResult build() {
            final var o = new GetDomainTopicEventSubscriptionDeliveryAttributesResult();
            o.value = value;
            return o;
        }
    }
