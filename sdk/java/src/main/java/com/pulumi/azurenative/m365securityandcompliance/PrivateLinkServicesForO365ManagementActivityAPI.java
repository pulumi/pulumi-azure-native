...
public class PrivateLinkServicesForO365ManagementActivityAPI extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public PrivateLinkServicesForO365ManagementActivityAPI(String name, PrivateLinkServicesForO365ManagementActivityAPIArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:m365securityandcompliance:privateLinkServicesForO365ManagementActivityAPI", name, args == null ? PrivateLinkServicesForO365ManagementActivityAPIArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private PrivateLinkServicesForO365ManagementActivityAPI(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static PrivateLinkServicesForO365ManagementActivityAPI get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
