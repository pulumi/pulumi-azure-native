...
import com.pulumi.azurenative.web.WebAppAuthSettingsV2Args;
...
public class WebAppAuthSettingsV2 extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public WebAppAuthSettingsV2(String name, WebAppAuthSettingsV2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private WebAppAuthSettingsV2(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WebAppAuthSettingsV2 get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
