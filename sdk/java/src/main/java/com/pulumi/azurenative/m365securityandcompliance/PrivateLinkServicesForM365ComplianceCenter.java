...
public class PrivateLinkServicesForM365ComplianceCenter extends com.pulumi.resources.CustomResource {
     ...
     */
    public PrivateLinkServicesForM365ComplianceCenter(String name, PrivateLinkServicesForM365ComplianceCenterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:m365securityandcompliance:privateLinkServicesForM365ComplianceCenter", name, args == null ? PrivateLinkServicesForM365ComplianceCenterArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private PrivateLinkServicesForM365ComplianceCenter(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:m365securityandcompliance/v20210325preview:privateLinkServicesForM365ComplianceCenter").build())
            ))
            .build();
     ...
     */
    public static PrivateLinkServicesForM365ComplianceCenter get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
