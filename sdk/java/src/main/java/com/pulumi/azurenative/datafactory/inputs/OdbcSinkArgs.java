 ...
 * 
 */
public final class OdbcSinkArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OdbcSinkArgs(OdbcSinkArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(OdbcSinkArgs defaults) {
            $ = new OdbcSinkArgs(Objects.requireNonNull(defaults));
        }
