 ...
 * 
 */
public final class SalesforceObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SalesforceObjectDatasetArgs(SalesforceObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SalesforceObjectDatasetArgs();
        }

        public Builder(SalesforceObjectDatasetArgs defaults) {
            $ = new SalesforceObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param objectApiName The Salesforce object API name. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
