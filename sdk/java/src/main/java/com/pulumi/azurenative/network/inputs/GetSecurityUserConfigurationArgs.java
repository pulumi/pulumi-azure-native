...
public final class GetSecurityUserConfigurationArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetSecurityUserConfigurationArgs(GetSecurityUserConfigurationArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSecurityUserConfigurationArgs();
        }

        public Builder(GetSecurityUserConfigurationArgs defaults) {
            $ = new GetSecurityUserConfigurationArgs(Objects.requireNonNull(defaults));
        }
