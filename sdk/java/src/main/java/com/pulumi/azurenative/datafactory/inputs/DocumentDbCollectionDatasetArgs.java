...
public final class DocumentDbCollectionDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Document Database collection name. Type: string (or Expression with resultType string).
     * 
     */
    public Output<Object> collectionName() {
    ...
    private DocumentDbCollectionDatasetArgs(DocumentDbCollectionDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DocumentDbCollectionDatasetArgs();
        }

        public Builder(DocumentDbCollectionDatasetArgs defaults) {
            $ = new DocumentDbCollectionDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param collectionName Document Database collection name. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
