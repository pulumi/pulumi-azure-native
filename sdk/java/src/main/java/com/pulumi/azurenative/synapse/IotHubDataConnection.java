...
public class IotHubDataConnection extends com.pulumi.resources.CustomResource {
    ...
    public IotHubDataConnection(String name, IotHubDataConnectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:synapse:IotHubDataConnection", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:synapse/v20210401preview:IotHubDataConnection").build()),
                Output.of(Alias.builder().type("azure-native:synapse/v20210601preview:IotHubDataConnection").build())
            ))
            .build();
