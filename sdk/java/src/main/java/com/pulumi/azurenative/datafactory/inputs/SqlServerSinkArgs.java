 ...
 * 
 */
public final class SqlServerSinkArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SqlServerSinkArgs(SqlServerSinkArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SqlServerSinkArgs();
        }

        public Builder(SqlServerSinkArgs defaults) {
            $ = new SqlServerSinkArgs(Objects.requireNonNull(defaults));
        }
