...
public class ExtendedDatabaseBlobAuditingPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ExtendedDatabaseBlobAuditingPolicy(String name, ExtendedDatabaseBlobAuditingPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:sql:ExtendedDatabaseBlobAuditingPolicy", name, args == null ? ExtendedDatabaseBlobAuditingPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ExtendedDatabaseBlobAuditingPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ExtendedDatabaseBlobAuditingPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
