...
public final class ListStreamingLocatorPathsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final ListStreamingLocatorPathsPlainArgs Empty = new ListStreamingLocatorPathsPlainArgs();
    ...
    private ListStreamingLocatorPathsPlainArgs() {}

    private ListStreamingLocatorPathsPlainArgs(ListStreamingLocatorPathsPlainArgs $) {
    ...
    public static Builder builder(ListStreamingLocatorPathsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListStreamingLocatorPathsPlainArgs();
        }

        public Builder(ListStreamingLocatorPathsPlainArgs defaults) {
            $ = new ListStreamingLocatorPathsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ListStreamingLocatorPathsPlainArgs build() {
