...
public final class AzureVmWorkloadProtectedItemArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureVmWorkloadProtectedItemArgs(AzureVmWorkloadProtectedItemArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureVmWorkloadProtectedItemArgs();
        }

        public Builder(AzureVmWorkloadProtectedItemArgs defaults) {
            $ = new AzureVmWorkloadProtectedItemArgs(Objects.requireNonNull(defaults));
        }
