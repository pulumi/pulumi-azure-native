...
public final class GetServiceFabricArgs extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return Specify the $expand query. Example: &#39;properties($expand=applicableSchedule)&#39;
     * 
     */
    ...
    private GetServiceFabricArgs(GetServiceFabricArgs $) {
        this.expand = $.expand;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceFabricArgs();
        }

        public Builder(GetServiceFabricArgs defaults) {
            $ = new GetServiceFabricArgs(Objects.requireNonNull(defaults));
        }
