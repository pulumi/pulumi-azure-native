...
import com.pulumi.azurenative.kubernetesconfiguration.inputs.KubernetesConfigurationPrivateLinkScopePropertiesArgs;
...
public final class PrivateLinkScopeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<KubernetesConfigurationPrivateLinkScopePropertiesArgs> properties;

    /**
     * @return Properties that define a Azure Arc PrivateLinkScope resource.
     * 
     */
    public Optional<Output<KubernetesConfigurationPrivateLinkScopePropertiesArgs>> properties() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder properties(@Nullable Output<KubernetesConfigurationPrivateLinkScopePropertiesArgs> properties) {
         ...
         * 
         */
        public Builder properties(KubernetesConfigurationPrivateLinkScopePropertiesArgs properties) {
