 ...
 * 
 */
public final class MagentoSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MagentoSourceArgs(MagentoSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagentoSourceArgs();
        }

        public Builder(MagentoSourceArgs defaults) {
            $ = new MagentoSourceArgs(Objects.requireNonNull(defaults));
        }
