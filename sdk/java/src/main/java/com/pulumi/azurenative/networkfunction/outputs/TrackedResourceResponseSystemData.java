...
@CustomType
public final class TrackedResourceResponseSystemData {
    /**
    ...
    public static Builder builder(TrackedResourceResponseSystemData defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String lastModifiedByType;
        public Builder() {}
        public Builder(TrackedResourceResponseSystemData defaults) {
        ...
        public TrackedResourceResponseSystemData build() {
            final var o = new TrackedResourceResponseSystemData();
