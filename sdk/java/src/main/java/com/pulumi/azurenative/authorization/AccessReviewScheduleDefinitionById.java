...
public class AccessReviewScheduleDefinitionById extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public AccessReviewScheduleDefinitionById(String name, @Nullable AccessReviewScheduleDefinitionByIdArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private AccessReviewScheduleDefinitionById(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById").build())
            ))
            .build();
     ...
     */
    public static AccessReviewScheduleDefinitionById get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
