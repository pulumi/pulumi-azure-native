...
public class ManagementConfiguration extends com.pulumi.resources.CustomResource {
    /**
     * Resource location
     * 
     */
     ...
     */
    public ManagementConfiguration(String name, ManagementConfigurationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private ManagementConfiguration(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ManagementConfiguration get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
