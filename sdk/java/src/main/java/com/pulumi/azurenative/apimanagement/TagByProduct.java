...
public class TagByProduct extends com.pulumi.resources.CustomResource {
    /**
     * Tag name.
     * 
     */
     ...
     */
    public TagByProduct(String name, TagByProductArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private TagByProduct(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TagByProduct get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
