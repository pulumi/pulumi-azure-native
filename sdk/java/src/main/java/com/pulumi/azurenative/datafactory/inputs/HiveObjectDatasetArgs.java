 ...
 * 
 */
public final class HiveObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {

    public static final HiveObjectDatasetArgs Empty = new HiveObjectDatasetArgs();
    ...
    /**
     * @return The table name of the Hive. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private HiveObjectDatasetArgs() {}

    private HiveObjectDatasetArgs(HiveObjectDatasetArgs $) {
    ...
    public static Builder builder(HiveObjectDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HiveObjectDatasetArgs();
        }

        public Builder(HiveObjectDatasetArgs defaults) {
            $ = new HiveObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HiveObjectDatasetArgs build() {
