...
import com.pulumi.azurenative.app.inputs.VolumeMountArgs;
...
public final class ContainerArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="probes")
    private @Nullable Output<List<ContainerAppProbeArgs>> probes;

    /**
     * @return List of probes for the container.
     * 
     */
    public Optional<Output<List<ContainerAppProbeArgs>>> probes() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder probes(@Nullable Output<List<ContainerAppProbeArgs>> probes) {
            $.probes = probes;
            return this;
        }
         ...
         * 
         */
        public Builder probes(List<ContainerAppProbeArgs> probes) {
         ...
         * 
         */
        public Builder probes(ContainerAppProbeArgs... probes) {
        ...
        /**
         * @param volumeMounts Container volume mounts.
         * 
         * @return builder
         * 
         */
