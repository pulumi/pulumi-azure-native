...
public class NetworkInterfaceTapConfiguration extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public NetworkInterfaceTapConfiguration(String name, NetworkInterfaceTapConfigurationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:network:NetworkInterfaceTapConfiguration", name, args == null ? NetworkInterfaceTapConfigurationArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private NetworkInterfaceTapConfiguration(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("azure-native:network/v20220101:NetworkInterfaceTapConfiguration").build())
            ))
            .build();
     ...
     */
    public static NetworkInterfaceTapConfiguration get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
