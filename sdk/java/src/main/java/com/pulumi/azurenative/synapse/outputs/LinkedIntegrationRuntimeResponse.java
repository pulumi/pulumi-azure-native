...
public final class LinkedIntegrationRuntimeResponse {
    ...
    /**
     * @return The location of the workspace for which the linked integration runtime belong to.
     * 
     */
    private String dataFactoryLocation;
    /**
     * @return The name of the workspace for which the linked integration runtime belong to.
     * 
     */
