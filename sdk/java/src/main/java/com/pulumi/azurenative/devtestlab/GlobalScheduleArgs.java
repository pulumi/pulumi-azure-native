...
public final class GlobalScheduleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GlobalScheduleArgs(GlobalScheduleArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GlobalScheduleArgs();
        }

        public Builder(GlobalScheduleArgs defaults) {
            $ = new GlobalScheduleArgs(Objects.requireNonNull(defaults));
        }
