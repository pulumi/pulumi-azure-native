...
public final class ListProductsArgs extends com.pulumi.resources.InvokeArgs {

    public static final ListProductsArgs Empty = new ListProductsArgs();
    ...
    private ListProductsArgs() {}

    private ListProductsArgs(ListProductsArgs $) {
    ...
    public static Builder builder(ListProductsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListProductsArgs();
        }

        public Builder(ListProductsArgs defaults) {
            $ = new ListProductsArgs(Objects.requireNonNull(defaults));
        }
