...
public final class ServerBlobAuditingPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServerBlobAuditingPolicyArgs(ServerBlobAuditingPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServerBlobAuditingPolicyArgs();
        }

        public Builder(ServerBlobAuditingPolicyArgs defaults) {
            $ = new ServerBlobAuditingPolicyArgs(Objects.requireNonNull(defaults));
        }
