 ...
 * 
 */
public final class StringNotInAdvancedFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final StringNotInAdvancedFilterArgs Empty = new StringNotInAdvancedFilterArgs();
    ...
    private StringNotInAdvancedFilterArgs() {}

    private StringNotInAdvancedFilterArgs(StringNotInAdvancedFilterArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(StringNotInAdvancedFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StringNotInAdvancedFilterArgs();
        }

        public Builder(StringNotInAdvancedFilterArgs defaults) {
            $ = new StringNotInAdvancedFilterArgs(Objects.requireNonNull(defaults));
        }
