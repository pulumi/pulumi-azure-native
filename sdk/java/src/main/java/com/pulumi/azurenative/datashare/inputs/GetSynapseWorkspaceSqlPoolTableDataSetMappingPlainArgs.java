...
public final class GetSynapseWorkspaceSqlPoolTableDataSetMappingPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSynapseWorkspaceSqlPoolTableDataSetMappingPlainArgs Empty = new GetSynapseWorkspaceSqlPoolTableDataSetMappingPlainArgs();
    ...
    private GetSynapseWorkspaceSqlPoolTableDataSetMappingPlainArgs() {}

    private GetSynapseWorkspaceSqlPoolTableDataSetMappingPlainArgs(GetSynapseWorkspaceSqlPoolTableDataSetMappingPlainArgs $) {
    ...
    public static Builder builder(GetSynapseWorkspaceSqlPoolTableDataSetMappingPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSynapseWorkspaceSqlPoolTableDataSetMappingPlainArgs();
        }

        public Builder(GetSynapseWorkspaceSqlPoolTableDataSetMappingPlainArgs defaults) {
            $ = new GetSynapseWorkspaceSqlPoolTableDataSetMappingPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSynapseWorkspaceSqlPoolTableDataSetMappingPlainArgs build() {
