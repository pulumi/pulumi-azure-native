...
import com.pulumi.azurenative.app.inputs.DefaultAuthorizationPolicyArgs;
import com.pulumi.azurenative.app.inputs.JwtClaimChecksArgs;
...
public final class AzureActiveDirectoryValidationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<DefaultAuthorizationPolicyArgs> defaultAuthorizationPolicy;

    /**
     * @return The configuration settings of the default authorization policy.
     * 
     */
    public Optional<Output<DefaultAuthorizationPolicyArgs>> defaultAuthorizationPolicy() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder defaultAuthorizationPolicy(@Nullable Output<DefaultAuthorizationPolicyArgs> defaultAuthorizationPolicy) {
