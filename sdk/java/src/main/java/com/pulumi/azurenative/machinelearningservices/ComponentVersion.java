...
import com.pulumi.azurenative.machinelearningservices.outputs.ComponentVersionResponse;
 ...
 * 
 */
@ResourceType(type="azure-native:machinelearningservices:ComponentVersion")
public class ComponentVersion extends com.pulumi.resources.CustomResource {
    /**
     * [Required] Additional attributes of the entity.
     * 
     */
    @Export(name="componentVersionDetails", type=ComponentVersionResponse.class, parameters={})
    private Output<ComponentVersionResponse> componentVersionDetails;

    /**
     * @return [Required] Additional attributes of the entity.
     * 
     */
    public Output<ComponentVersionResponse> componentVersionDetails() {
     ...
     */
    public ComponentVersion(String name, ComponentVersionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:machinelearningservices:ComponentVersion", name, args == null ? ComponentVersionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ComponentVersion(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:machinelearningservices:ComponentVersion", name, null, makeResourceOptions(options, id));
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:machinelearningservices/v20220201preview:ComponentVersion").build()),
                Output.of(Alias.builder().type("azure-native:machinelearningservices/v20220501:ComponentVersion").build())
            ))
            .build();
