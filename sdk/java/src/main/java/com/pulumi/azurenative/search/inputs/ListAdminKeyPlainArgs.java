...
public final class ListAdminKeyPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final ListAdminKeyPlainArgs Empty = new ListAdminKeyPlainArgs();
    ...
    private ListAdminKeyPlainArgs() {}

    private ListAdminKeyPlainArgs(ListAdminKeyPlainArgs $) {
    ...
    public static Builder builder(ListAdminKeyPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListAdminKeyPlainArgs();
        }

        public Builder(ListAdminKeyPlainArgs defaults) {
            $ = new ListAdminKeyPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ListAdminKeyPlainArgs build() {
