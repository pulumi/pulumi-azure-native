...
@CustomType
public final class GreenplumTableDatasetResponse {
    /**
    ...
    /**
     * @return The table name of Greenplum. Type: string (or Expression with resultType string).
     * 
     */
    ...
    public static Builder builder(GreenplumTableDatasetResponse defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GreenplumTableDatasetResponse defaults) {
        ...
        public GreenplumTableDatasetResponse build() {
            final var o = new GreenplumTableDatasetResponse();
