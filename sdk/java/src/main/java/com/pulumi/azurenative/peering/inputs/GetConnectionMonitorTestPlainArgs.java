...
public final class GetConnectionMonitorTestPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetConnectionMonitorTestPlainArgs Empty = new GetConnectionMonitorTestPlainArgs();
    ...
    private GetConnectionMonitorTestPlainArgs() {}

    private GetConnectionMonitorTestPlainArgs(GetConnectionMonitorTestPlainArgs $) {
    ...
    public static Builder builder(GetConnectionMonitorTestPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetConnectionMonitorTestPlainArgs();
        }

        public Builder(GetConnectionMonitorTestPlainArgs defaults) {
            $ = new GetConnectionMonitorTestPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetConnectionMonitorTestPlainArgs build() {
