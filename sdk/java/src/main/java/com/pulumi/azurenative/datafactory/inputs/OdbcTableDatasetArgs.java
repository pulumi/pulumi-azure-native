 ...
 * 
 */
public final class OdbcTableDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OdbcTableDatasetArgs(OdbcTableDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OdbcTableDatasetArgs();
        }

        public Builder(OdbcTableDatasetArgs defaults) {
            $ = new OdbcTableDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param tableName The ODBC table name. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
