...
import com.pulumi.azurenative.web.WebAppDeploymentSlotArgs;
...
public class WebAppDeploymentSlot extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public WebAppDeploymentSlot(String name, WebAppDeploymentSlotArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private WebAppDeploymentSlot(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("azure-native:web/v20220301:WebAppDeploymentSlot").build())
            ))
            .build();
     ...
     */
    public static WebAppDeploymentSlot get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
