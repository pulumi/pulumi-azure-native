...
public final class ListSqlMigrationServiceAuthKeysPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final ListSqlMigrationServiceAuthKeysPlainArgs Empty = new ListSqlMigrationServiceAuthKeysPlainArgs();
    ...
    private ListSqlMigrationServiceAuthKeysPlainArgs() {}

    private ListSqlMigrationServiceAuthKeysPlainArgs(ListSqlMigrationServiceAuthKeysPlainArgs $) {
    ...
    public static Builder builder(ListSqlMigrationServiceAuthKeysPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListSqlMigrationServiceAuthKeysPlainArgs();
        }

        public Builder(ListSqlMigrationServiceAuthKeysPlainArgs defaults) {
            $ = new ListSqlMigrationServiceAuthKeysPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ListSqlMigrationServiceAuthKeysPlainArgs build() {
