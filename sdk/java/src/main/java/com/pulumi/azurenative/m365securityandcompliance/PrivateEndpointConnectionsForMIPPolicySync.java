 ...
 * 
 */
@ResourceType(type="azure-native:m365securityandcompliance:PrivateEndpointConnectionsForMIPPolicySync")
public class PrivateEndpointConnectionsForMIPPolicySync extends com.pulumi.resources.CustomResource {
    ...
    public PrivateEndpointConnectionsForMIPPolicySync(String name, PrivateEndpointConnectionsForMIPPolicySyncArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:m365securityandcompliance:PrivateEndpointConnectionsForMIPPolicySync", name, args == null ? PrivateEndpointConnectionsForMIPPolicySyncArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private PrivateEndpointConnectionsForMIPPolicySync(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:m365securityandcompliance:PrivateEndpointConnectionsForMIPPolicySync", name, null, makeResourceOptions(options, id));
    }
