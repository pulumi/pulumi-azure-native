...
public final class ListTaskRunDetailsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final ListTaskRunDetailsPlainArgs Empty = new ListTaskRunDetailsPlainArgs();
    ...
    private ListTaskRunDetailsPlainArgs() {}

    private ListTaskRunDetailsPlainArgs(ListTaskRunDetailsPlainArgs $) {
    ...
    public static Builder builder(ListTaskRunDetailsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListTaskRunDetailsPlainArgs();
        }

        public Builder(ListTaskRunDetailsPlainArgs defaults) {
            $ = new ListTaskRunDetailsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ListTaskRunDetailsPlainArgs build() {
