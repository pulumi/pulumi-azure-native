...
public final class GetGremlinResourceGremlinDatabaseResult {
    ...
    public Optional<GremlinDatabaseGetPropertiesResponseOptions> options() {
        return Optional.ofNullable(this.options);
    }
    public Optional<GremlinDatabaseGetPropertiesResponseResource> resource() {
    ...
    public static final class Builder {
        ...
        public GetGremlinResourceGremlinDatabaseResult build() {
            final var o = new GetGremlinResourceGremlinDatabaseResult();
            o.id = id;
            o.location = location;
            o.name = name;
            o.options = options;
