...
public final class ListSubAccountVMHostsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private ListSubAccountVMHostsArgs(ListSubAccountVMHostsArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListSubAccountVMHostsArgs();
        }

        public Builder(ListSubAccountVMHostsArgs defaults) {
            $ = new ListSubAccountVMHostsArgs(Objects.requireNonNull(defaults));
        }
