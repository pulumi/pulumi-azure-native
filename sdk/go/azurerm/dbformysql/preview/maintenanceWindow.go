...
func NewMaintenanceWindow(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:dbformysql/v20200701privatepreview:MaintenanceWindow"),
		},
	})
	opts = append(opts, aliases)
	var resource MaintenanceWindow
	err := ctx.RegisterResource("azurerm:dbformysql/preview:MaintenanceWindow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMaintenanceWindow(ctx *pulumi.Context,
	...
	var resource MaintenanceWindow
	err := ctx.ReadResource("azurerm:dbformysql/preview:MaintenanceWindow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
