...
func NewServerAdministrator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:dbformysql/preview:ServerAdministrator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerAdministrator(ctx *pulumi.Context,
	...
	var resource ServerAdministrator
	err := ctx.ReadResource("azurerm:dbformysql/preview:ServerAdministrator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
