...
func NewGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:servicefabricmesh/latest:Gateway"),
		},
	})
...
func GetGateway(ctx *pulumi.Context,
	...
	var resource Gateway
	err := ctx.ReadResource("azurerm:servicefabricmesh/v20180901preview:Gateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
