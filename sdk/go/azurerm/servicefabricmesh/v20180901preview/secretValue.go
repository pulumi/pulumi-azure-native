...
func NewSecretValue(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:servicefabricmesh/preview:SecretValue"),
		},
	})
	opts = append(opts, aliases)
	var resource SecretValue
	err := ctx.RegisterResource("azurerm:servicefabricmesh/v20180901preview:SecretValue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretValue(ctx *pulumi.Context,
	...
	var resource SecretValue
	err := ctx.ReadResource("azurerm:servicefabricmesh/v20180901preview:SecretValue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
