...
// 			},
// 			Description:       pulumi.String("File share backed by Azure Files storage."),
// 			Location:          pulumi.String("eastus"),
// 			Provider:          pulumi.String("SFAzureFile"),
// 			ResourceGroupName: pulumi.String("sbz_demo"),
// 			VolumeName:        pulumi.String("sbzDemoVolume"),
// 		})
// 		if err != nil {
// 			return err
// 		}
...
func NewVolume(ctx *pulumi.Context,
	...
	var resource Volume
	err := ctx.RegisterResource("azurerm:servicefabricmesh/v20180701preview:Volume", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolume(ctx *pulumi.Context,
	...
	var resource Volume
	err := ctx.ReadResource("azurerm:servicefabricmesh/v20180701preview:Volume", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
