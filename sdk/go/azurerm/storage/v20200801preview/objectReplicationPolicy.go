...
func NewObjectReplicationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storage/v20200801preview:ObjectReplicationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetObjectReplicationPolicy(ctx *pulumi.Context,
	...
	var resource ObjectReplicationPolicy
	err := ctx.ReadResource("azurerm:storage/v20200801preview:ObjectReplicationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
