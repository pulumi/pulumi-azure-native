...
func NewStorageAccountManagementPolicies(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:storage/latest:StorageAccountManagementPolicies"),
		},
		{
			Type: pulumi.String("azurerm:storage/v20181101:StorageAccountManagementPolicies"),
		},
		{
			Type: pulumi.String("azurerm:storage/v20190401:StorageAccountManagementPolicies"),
		},
		{
			Type: pulumi.String("azurerm:storage/v20190601:StorageAccountManagementPolicies"),
		},
		{
			Type: pulumi.String("azurerm:storage/v20200801preview:StorageAccountManagementPolicies"),
		},
	})
	opts = append(opts, aliases)
	var resource StorageAccountManagementPolicies
	err := ctx.RegisterResource("azurerm:storage/v20180301preview:StorageAccountManagementPolicies", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageAccountManagementPolicies(ctx *pulumi.Context,
	...
	var resource StorageAccountManagementPolicies
	err := ctx.ReadResource("azurerm:storage/v20180301preview:StorageAccountManagementPolicies", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
