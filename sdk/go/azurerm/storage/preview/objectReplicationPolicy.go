...
func NewObjectReplicationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storage/preview:ObjectReplicationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetObjectReplicationPolicy(ctx *pulumi.Context,
	...
	var resource ObjectReplicationPolicy
	err := ctx.ReadResource("azurerm:storage/preview:ObjectReplicationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
