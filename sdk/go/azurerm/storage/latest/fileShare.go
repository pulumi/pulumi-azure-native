...
func NewFileShare(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storage/latest:FileShare", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileShare(ctx *pulumi.Context,
	...
	var resource FileShare
	err := ctx.ReadResource("azurerm:storage/latest:FileShare", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
