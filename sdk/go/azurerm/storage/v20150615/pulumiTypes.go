...
// The sku name. Required for account creation; optional for update. Note that in older versions, sku name was called accountType.
func (o StorageAccountPropertiesCreateParametersOutput) AccountType() pulumi.StringOutput {
	return o.ApplyT(func(v StorageAccountPropertiesCreateParameters) string { return v.AccountType }).(pulumi.StringOutput)
}
...
// The sku name. Required for account creation; optional for update. Note that in older versions, sku name was called accountType.
func (o StorageAccountPropertiesCreateParametersPtrOutput) AccountType() pulumi.StringPtrOutput {
