...
func NewBlobContainerImmutabilityPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storage/v20180701:BlobContainerImmutabilityPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobContainerImmutabilityPolicy(ctx *pulumi.Context,
	...
	var resource BlobContainerImmutabilityPolicy
	err := ctx.ReadResource("azurerm:storage/v20180701:BlobContainerImmutabilityPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
