...
func NewBlobContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storage/v20180201:BlobContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobContainer(ctx *pulumi.Context,
	...
	var resource BlobContainer
	err := ctx.ReadResource("azurerm:storage/v20180201:BlobContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
