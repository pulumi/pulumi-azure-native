...
// 										DaysAfterModificationGreaterThan: pulumi.Int(1000),
// 									},
// 									TierToArchive: &storage.DateAfterModificationArgs{
// 										DaysAfterModificationGreaterThan: pulumi.Int(90),
// 									},
// 									TierToCool: &storage.DateAfterModificationArgs{
// 										DaysAfterModificationGreaterThan: pulumi.Int(30),
// 									},
// 								},
// 								Snapshot: &storage.ManagementPolicySnapShotArgs{
// 									Delete: &storage.DateAfterCreationArgs{
// 										DaysAfterCreationGreaterThan: pulumi.Int(30),
// 									},
// 								},
// 							},
...
func NewManagementPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storage/v20181101:ManagementPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementPolicy(ctx *pulumi.Context,
	...
	var resource ManagementPolicy
	err := ctx.ReadResource("azurerm:storage/v20181101:ManagementPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
