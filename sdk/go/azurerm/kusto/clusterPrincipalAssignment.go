...
func NewClusterPrincipalAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:kusto:ClusterPrincipalAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterPrincipalAssignment(ctx *pulumi.Context,
	...
	var resource ClusterPrincipalAssignment
	err := ctx.ReadResource("azurerm:kusto:ClusterPrincipalAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
