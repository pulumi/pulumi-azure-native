...
//
// import (
// 	kusto "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/kusto/v20190907"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
// 				KeyVaultUri: pulumi.String("https://dummy.keyvault.com"),
// 				KeyVersion:  pulumi.String("keyVersion"),
// 			},
...
func NewCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:kusto/latest:Cluster"),
		},
		{
			Type: pulumi.String("azurerm:kusto/v20170907privatepreview:Cluster"),
		},
		{
			Type: pulumi.String("azurerm:kusto/v20180907preview:Cluster"),
		},
		{
			Type: pulumi.String("azurerm:kusto/v20190121:Cluster"),
		},
		{
			Type: pulumi.String("azurerm:kusto/v20190515:Cluster"),
		},
		{
			Type: pulumi.String("azurerm:kusto/v20191109:Cluster"),
		},
		{
			Type: pulumi.String("azurerm:kusto/v20200215:Cluster"),
		},
		{
			Type: pulumi.String("azurerm:kusto/v20200614:Cluster"),
		},
	})
	opts = append(opts, aliases)
	var resource Cluster
	err := ctx.RegisterResource("azurerm:kusto/v20190907:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("azurerm:kusto/v20190907:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
