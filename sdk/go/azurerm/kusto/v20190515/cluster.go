...
//
// import (
// 	kusto "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/kusto/v20190515"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:kusto/v20190907:Cluster"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:kusto/v20190515:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("azurerm:kusto/v20190515:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
