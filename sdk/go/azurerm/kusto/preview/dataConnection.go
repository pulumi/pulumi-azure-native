...
func NewDataConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:kusto/preview:DataConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataConnection(ctx *pulumi.Context,
	...
	var resource DataConnection
	err := ctx.ReadResource("azurerm:kusto/preview:DataConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
