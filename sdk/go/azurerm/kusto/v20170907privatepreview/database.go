...
//
// import (
// 	kusto "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/kusto/v20170907privatepreview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
// 			SoftDeletePeriodInDays: pulumi.Int(1),
// 		})
// 		if err != nil {
// 			return err
// 		}
...
func NewDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:kusto/v20170907privatepreview:Database", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabase(ctx *pulumi.Context,
	...
	var resource Database
	err := ctx.ReadResource("azurerm:kusto/v20170907privatepreview:Database", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
