...
func NewEventHubConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:kusto/latest:EventHubConnection"),
		},
		{
			Type: pulumi.String("azurerm:kusto/v20170907privatepreview:EventHubConnection"),
		},
	})
	opts = append(opts, aliases)
	var resource EventHubConnection
	err := ctx.RegisterResource("azurerm:kusto/v20180907preview:EventHubConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHubConnection(ctx *pulumi.Context,
	...
	var resource EventHubConnection
	err := ctx.ReadResource("azurerm:kusto/v20180907preview:EventHubConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
