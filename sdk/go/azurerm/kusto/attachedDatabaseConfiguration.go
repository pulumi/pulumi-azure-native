...
func NewAttachedDatabaseConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:kusto:AttachedDatabaseConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttachedDatabaseConfiguration(ctx *pulumi.Context,
	...
	var resource AttachedDatabaseConfiguration
	err := ctx.ReadResource("azurerm:kusto:AttachedDatabaseConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
