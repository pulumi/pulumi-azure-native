...
//
// import (
// 	network "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200101"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewFrontDoor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20200101:FrontDoor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFrontDoor(ctx *pulumi.Context,
	...
	var resource FrontDoor
	err := ctx.ReadResource("azurerm:network/v20200101:FrontDoor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
