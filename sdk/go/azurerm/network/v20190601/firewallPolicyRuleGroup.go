...
func NewFirewallPolicyRuleGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190601:FirewallPolicyRuleGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicyRuleGroup(ctx *pulumi.Context,
	...
	var resource FirewallPolicyRuleGroup
	err := ctx.ReadResource("azurerm:network/v20190601:FirewallPolicyRuleGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type firewallPolicyRuleGroupArgs struct {
	...
	Name string `pulumi:"name"`
	// The properties of the firewall policy rule group.
	Properties *FirewallPolicyRuleGroupProperties `pulumi:"properties"`
...
type FirewallPolicyRuleGroupArgs struct {
	...
	// The properties of the firewall policy rule group.
	Properties FirewallPolicyRuleGroupPropertiesPtrInput
	// The name of the resource group.
