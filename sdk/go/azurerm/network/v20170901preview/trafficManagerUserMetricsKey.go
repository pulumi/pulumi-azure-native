...
//
// import (
// 	network "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20170901preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewTrafficManagerUserMetricsKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20170901preview:TrafficManagerUserMetricsKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrafficManagerUserMetricsKey(ctx *pulumi.Context,
	...
	var resource TrafficManagerUserMetricsKey
	err := ctx.ReadResource("azurerm:network/v20170901preview:TrafficManagerUserMetricsKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
