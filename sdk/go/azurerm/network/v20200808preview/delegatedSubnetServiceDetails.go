...
func NewDelegatedSubnetServiceDetails(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:network/latest:DelegatedSubnetServiceDetails"),
		},
	})
...
func GetDelegatedSubnetServiceDetails(ctx *pulumi.Context,
	...
	var resource DelegatedSubnetServiceDetails
	err := ctx.ReadResource("azurerm:network/v20200808preview:DelegatedSubnetServiceDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
