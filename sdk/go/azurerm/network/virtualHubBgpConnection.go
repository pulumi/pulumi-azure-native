...
func NewVirtualHubBgpConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network:VirtualHubBgpConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHubBgpConnection(ctx *pulumi.Context,
	...
	var resource VirtualHubBgpConnection
	err := ctx.ReadResource("azurerm:network:VirtualHubBgpConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
