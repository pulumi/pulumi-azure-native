...
func NewServiceEndpointPolicyDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:network/latest:ServiceEndpointPolicyDefinition"),
		},
		{
			Type: pulumi.String("azurerm:network/preview:ServiceEndpointPolicyDefinition"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:network/v20181001:ServiceEndpointPolicyDefinition"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:network/v20200601:ServiceEndpointPolicyDefinition"),
		},
	})
	opts = append(opts, aliases)
	var resource ServiceEndpointPolicyDefinition
	err := ctx.RegisterResource("azurerm:network/v20181101:ServiceEndpointPolicyDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEndpointPolicyDefinition(ctx *pulumi.Context,
	...
	var resource ServiceEndpointPolicyDefinition
	err := ctx.ReadResource("azurerm:network/v20181101:ServiceEndpointPolicyDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
