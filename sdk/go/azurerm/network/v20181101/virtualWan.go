...
func NewVirtualWan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20181101:VirtualWan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualWan(ctx *pulumi.Context,
	...
	var resource VirtualWan
	err := ctx.ReadResource("azurerm:network/v20181101:VirtualWan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
