...
func NewDdosCustomPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:network/v20181201:DdosCustomPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:network/v20200601:DdosCustomPolicy"),
		},
	})
	opts = append(opts, aliases)
	var resource DdosCustomPolicy
	err := ctx.RegisterResource("azurerm:network/v20190401:DdosCustomPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDdosCustomPolicy(ctx *pulumi.Context,
	...
	var resource DdosCustomPolicy
	err := ctx.ReadResource("azurerm:network/v20190401:DdosCustomPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
