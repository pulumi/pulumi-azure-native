...
func NewExpressRouteCrossConnectionPeering(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:network/v20200301:ExpressRouteCrossConnectionPeering"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:network/v20190401:ExpressRouteCrossConnectionPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCrossConnectionPeering(ctx *pulumi.Context,
	...
	var resource ExpressRouteCrossConnectionPeering
	err := ctx.ReadResource("azurerm:network/v20190401:ExpressRouteCrossConnectionPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
