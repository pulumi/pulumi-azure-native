...
func NewWebApplicationFirewallPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:network/latest:WebApplicationFirewallPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:network/v20190901:WebApplicationFirewallPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:network/v20190401:WebApplicationFirewallPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebApplicationFirewallPolicy(ctx *pulumi.Context,
	...
	var resource WebApplicationFirewallPolicy
	err := ctx.ReadResource("azurerm:network/v20190401:WebApplicationFirewallPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
