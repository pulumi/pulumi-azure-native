...
func NewFrontDoor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190401:FrontDoor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFrontDoor(ctx *pulumi.Context,
	...
	var resource FrontDoor
	err := ctx.ReadResource("azurerm:network/v20190401:FrontDoor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
