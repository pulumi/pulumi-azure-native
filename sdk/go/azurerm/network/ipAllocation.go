...
func NewIpAllocation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network:IpAllocation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpAllocation(ctx *pulumi.Context,
	...
	var resource IpAllocation
	err := ctx.ReadResource("azurerm:network:IpAllocation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
