...
func NewVirtualNetworkPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190201:VirtualNetworkPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkPeering(ctx *pulumi.Context,
	...
	var resource VirtualNetworkPeering
	err := ctx.ReadResource("azurerm:network/v20190201:VirtualNetworkPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
