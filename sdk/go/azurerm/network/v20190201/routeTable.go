...
func NewRouteTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190201:RouteTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteTable(ctx *pulumi.Context,
	...
	var resource RouteTable
	err := ctx.ReadResource("azurerm:network/v20190201:RouteTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
