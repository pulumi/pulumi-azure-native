...
func NewVirtualNetworkGatewayConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190701:VirtualNetworkGatewayConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkGatewayConnection(ctx *pulumi.Context,
	...
	var resource VirtualNetworkGatewayConnection
	err := ctx.ReadResource("azurerm:network/v20190701:VirtualNetworkGatewayConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
