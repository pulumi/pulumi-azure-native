...
func NewServiceEndpointPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190701:ServiceEndpointPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEndpointPolicy(ctx *pulumi.Context,
	...
	var resource ServiceEndpointPolicy
	err := ctx.ReadResource("azurerm:network/v20190701:ServiceEndpointPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
