...
func NewPrivateLinkService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:network/v20190901:PrivateLinkService"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:network/v20200601:PrivateLinkService"),
		},
	})
	opts = append(opts, aliases)
	var resource PrivateLinkService
	err := ctx.RegisterResource("azurerm:network/v20190701:PrivateLinkService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkService(ctx *pulumi.Context,
	...
	var resource PrivateLinkService
	err := ctx.ReadResource("azurerm:network/v20190701:PrivateLinkService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
