...
func NewExpressRoutePort(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network:ExpressRoutePort", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRoutePort(ctx *pulumi.Context,
	...
	var resource ExpressRoutePort
	err := ctx.ReadResource("azurerm:network:ExpressRoutePort", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
