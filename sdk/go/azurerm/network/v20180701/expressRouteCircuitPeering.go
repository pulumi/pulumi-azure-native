...
func NewExpressRouteCircuitPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20180701:ExpressRouteCircuitPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuitPeering(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuitPeering
	err := ctx.ReadResource("azurerm:network/v20180701:ExpressRouteCircuitPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
