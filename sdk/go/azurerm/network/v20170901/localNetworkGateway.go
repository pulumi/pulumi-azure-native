...
func NewLocalNetworkGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20170901:LocalNetworkGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLocalNetworkGateway(ctx *pulumi.Context,
	...
	var resource LocalNetworkGateway
	err := ctx.ReadResource("azurerm:network/v20170901:LocalNetworkGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
