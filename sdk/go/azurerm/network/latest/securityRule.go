...
func NewSecurityRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/latest:SecurityRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityRule(ctx *pulumi.Context,
	...
	var resource SecurityRule
	err := ctx.ReadResource("azurerm:network/latest:SecurityRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
