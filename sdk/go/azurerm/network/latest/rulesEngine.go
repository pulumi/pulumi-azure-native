...
func NewRulesEngine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/latest:RulesEngine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRulesEngine(ctx *pulumi.Context,
	...
	var resource RulesEngine
	err := ctx.ReadResource("azurerm:network/latest:RulesEngine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
