...
func NewLoadBalancerBackendAddressPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/latest:LoadBalancerBackendAddressPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoadBalancerBackendAddressPool(ctx *pulumi.Context,
	...
	var resource LoadBalancerBackendAddressPool
	err := ctx.ReadResource("azurerm:network/latest:LoadBalancerBackendAddressPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
