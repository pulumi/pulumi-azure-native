...
func NewApplicationGatewayPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/latest:ApplicationGatewayPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationGatewayPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource ApplicationGatewayPrivateEndpointConnection
	err := ctx.ReadResource("azurerm:network/latest:ApplicationGatewayPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
