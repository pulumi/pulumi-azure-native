...
func NewPrivateLinkServicePrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/latest:PrivateLinkServicePrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkServicePrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateLinkServicePrivateEndpointConnection
	err := ctx.ReadResource("azurerm:network/latest:PrivateLinkServicePrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
