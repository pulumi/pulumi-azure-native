...
func NewP2sVpnServerConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/latest:P2sVpnServerConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetP2sVpnServerConfiguration(ctx *pulumi.Context,
	...
	var resource P2sVpnServerConfiguration
	err := ctx.ReadResource("azurerm:network/latest:P2sVpnServerConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
