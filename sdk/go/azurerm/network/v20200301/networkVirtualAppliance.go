...
func NewNetworkVirtualAppliance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20200301:NetworkVirtualAppliance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkVirtualAppliance(ctx *pulumi.Context,
	...
	var resource NetworkVirtualAppliance
	err := ctx.ReadResource("azurerm:network/v20200301:NetworkVirtualAppliance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
