...
func NewPrivateEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20200301:PrivateEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpoint(ctx *pulumi.Context,
	...
	var resource PrivateEndpoint
	err := ctx.ReadResource("azurerm:network/v20200301:PrivateEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
