...
func NewP2sVpnGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:network/v20191201:P2sVpnGateway"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:network/v20200301:P2sVpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetP2sVpnGateway(ctx *pulumi.Context,
	...
	var resource P2sVpnGateway
	err := ctx.ReadResource("azurerm:network/v20200301:P2sVpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
