...
func NewExpressRouteConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20200301:ExpressRouteConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteConnection(ctx *pulumi.Context,
	...
	var resource ExpressRouteConnection
	err := ctx.ReadResource("azurerm:network/v20200301:ExpressRouteConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
