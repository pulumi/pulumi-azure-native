...
func NewServiceEndpointPolicyDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20200301:ServiceEndpointPolicyDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEndpointPolicyDefinition(ctx *pulumi.Context,
	...
	var resource ServiceEndpointPolicyDefinition
	err := ctx.ReadResource("azurerm:network/v20200301:ServiceEndpointPolicyDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
