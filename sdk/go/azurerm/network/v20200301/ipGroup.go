...
func NewIpGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:network/v20200501:IpGroup"),
		},
		{
			Type: pulumi.String("azurerm:network/v20200601:IpGroup"),
		},
	})
	opts = append(opts, aliases)
	var resource IpGroup
	err := ctx.RegisterResource("azurerm:network/v20200301:IpGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpGroup(ctx *pulumi.Context,
	...
	var resource IpGroup
	err := ctx.ReadResource("azurerm:network/v20200301:IpGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
