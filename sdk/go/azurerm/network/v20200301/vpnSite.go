...
func NewVpnSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20200301:VpnSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnSite(ctx *pulumi.Context,
	...
	var resource VpnSite
	err := ctx.ReadResource("azurerm:network/v20200301:VpnSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
