...
func NewVirtualNetworkTap(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:network/v20191101:VirtualNetworkTap"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:network/v20200601:VirtualNetworkTap"),
		},
	})
	opts = append(opts, aliases)
	var resource VirtualNetworkTap
	err := ctx.RegisterResource("azurerm:network/v20200301:VirtualNetworkTap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkTap(ctx *pulumi.Context,
	...
	var resource VirtualNetworkTap
	err := ctx.ReadResource("azurerm:network/v20200301:VirtualNetworkTap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
