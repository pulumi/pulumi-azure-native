...
func NewNetworkProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:network/v20190801:NetworkProfile"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:network/v20200601:NetworkProfile"),
		},
	})
	opts = append(opts, aliases)
	var resource NetworkProfile
	err := ctx.RegisterResource("azurerm:network/v20181201:NetworkProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkProfile(ctx *pulumi.Context,
	...
	var resource NetworkProfile
	err := ctx.ReadResource("azurerm:network/v20181201:NetworkProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
