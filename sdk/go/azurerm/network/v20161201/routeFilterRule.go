...
func NewRouteFilterRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:network/latest:RouteFilterRule"),
		},
		{
			Type: pulumi.String("azurerm:network/preview:RouteFilterRule"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:network/v20180401:RouteFilterRule"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:network/v20200601:RouteFilterRule"),
		},
	})
	opts = append(opts, aliases)
	var resource RouteFilterRule
	err := ctx.RegisterResource("azurerm:network/v20161201:RouteFilterRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteFilterRule(ctx *pulumi.Context,
	...
	var resource RouteFilterRule
	err := ctx.ReadResource("azurerm:network/v20161201:RouteFilterRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
