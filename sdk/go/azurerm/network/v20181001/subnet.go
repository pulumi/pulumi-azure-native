...
func NewSubnet(ctx *pulumi.Context,
	...
	var resource Subnet
	err := ctx.RegisterResource("azurerm:network/v20181001:Subnet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubnet(ctx *pulumi.Context,
	...
	var resource Subnet
	err := ctx.ReadResource("azurerm:network/v20181001:Subnet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
