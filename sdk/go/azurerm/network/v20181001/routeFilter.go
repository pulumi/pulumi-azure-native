...
func NewRouteFilter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20181001:RouteFilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteFilter(ctx *pulumi.Context,
	...
	var resource RouteFilter
	err := ctx.ReadResource("azurerm:network/v20181001:RouteFilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
