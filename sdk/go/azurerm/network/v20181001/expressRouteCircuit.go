...
func NewExpressRouteCircuit(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:network/latest:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azurerm:network/preview:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azurerm:network/v20150501preview:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azurerm:network/v20150615:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azurerm:network/v20160330:ExpressRouteCircuit"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:network/v20200601:ExpressRouteCircuit"),
		},
	})
	opts = append(opts, aliases)
	var resource ExpressRouteCircuit
	err := ctx.RegisterResource("azurerm:network/v20181001:ExpressRouteCircuit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuit(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuit
	err := ctx.ReadResource("azurerm:network/v20181001:ExpressRouteCircuit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
