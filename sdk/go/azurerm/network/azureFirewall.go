...
func NewAzureFirewall(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network:AzureFirewall", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureFirewall(ctx *pulumi.Context,
	...
	var resource AzureFirewall
	err := ctx.ReadResource("azurerm:network:AzureFirewall", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
