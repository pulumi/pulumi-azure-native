...
func NewVirtualWAN(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20180401:VirtualWAN", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualWAN(ctx *pulumi.Context,
	...
	var resource VirtualWAN
	err := ctx.ReadResource("azurerm:network/v20180401:VirtualWAN", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
