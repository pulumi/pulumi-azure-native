...
func NewLoadBalancer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20180401:LoadBalancer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoadBalancer(ctx *pulumi.Context,
	...
	var resource LoadBalancer
	err := ctx.ReadResource("azurerm:network/v20180401:LoadBalancer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
