...
func NewApplicationGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20180401:ApplicationGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationGateway(ctx *pulumi.Context,
	...
	var resource ApplicationGateway
	err := ctx.ReadResource("azurerm:network/v20180401:ApplicationGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
