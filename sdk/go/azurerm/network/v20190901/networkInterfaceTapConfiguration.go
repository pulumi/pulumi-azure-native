...
func NewNetworkInterfaceTapConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190901:NetworkInterfaceTapConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkInterfaceTapConfiguration(ctx *pulumi.Context,
	...
	var resource NetworkInterfaceTapConfiguration
	err := ctx.ReadResource("azurerm:network/v20190901:NetworkInterfaceTapConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
