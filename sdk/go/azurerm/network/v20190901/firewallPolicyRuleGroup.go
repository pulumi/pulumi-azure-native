...
func NewFirewallPolicyRuleGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190901:FirewallPolicyRuleGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicyRuleGroup(ctx *pulumi.Context,
	...
	var resource FirewallPolicyRuleGroup
	err := ctx.ReadResource("azurerm:network/v20190901:FirewallPolicyRuleGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
