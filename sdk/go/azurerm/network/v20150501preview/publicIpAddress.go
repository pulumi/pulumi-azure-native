...
func NewPublicIpAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20150501preview:PublicIpAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicIpAddress(ctx *pulumi.Context,
	...
	var resource PublicIpAddress
	err := ctx.ReadResource("azurerm:network/v20150501preview:PublicIpAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
