...
func NewExpressRouteCircuitAuthorization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20150501preview:ExpressRouteCircuitAuthorization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuitAuthorization(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuitAuthorization
	err := ctx.ReadResource("azurerm:network/v20150501preview:ExpressRouteCircuitAuthorization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
