...
func NewRecordSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20160401:RecordSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRecordSet(ctx *pulumi.Context,
	...
	var resource RecordSet
	err := ctx.ReadResource("azurerm:network/v20160401:RecordSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
