...
// PrivateZonePropertiesInput is an input type that accepts PrivateZonePropertiesArgs and PrivateZonePropertiesOutput values.
// You can construct a concrete instance of `PrivateZonePropertiesInput` via:
//
//          PrivateZonePropertiesArgs{...}
type PrivateZonePropertiesInput interface {
	pulumi.Input

	ToPrivateZonePropertiesOutput() PrivateZonePropertiesOutput
	ToPrivateZonePropertiesOutputWithContext(context.Context) PrivateZonePropertiesOutput
}

// Represents the properties of the Private DNS zone.
type PrivateZonePropertiesArgs struct {
}

func (PrivateZonePropertiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateZoneProperties)(nil)).Elem()
}

func (i PrivateZonePropertiesArgs) ToPrivateZonePropertiesOutput() PrivateZonePropertiesOutput {
	return i.ToPrivateZonePropertiesOutputWithContext(context.Background())
}

func (i PrivateZonePropertiesArgs) ToPrivateZonePropertiesOutputWithContext(ctx context.Context) PrivateZonePropertiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrivateZonePropertiesOutput)
}

func (i PrivateZonePropertiesArgs) ToPrivateZonePropertiesPtrOutput() PrivateZonePropertiesPtrOutput {
	return i.ToPrivateZonePropertiesPtrOutputWithContext(context.Background())
}

func (i PrivateZonePropertiesArgs) ToPrivateZonePropertiesPtrOutputWithContext(ctx context.Context) PrivateZonePropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrivateZonePropertiesOutput).ToPrivateZonePropertiesPtrOutputWithContext(ctx)
}

// PrivateZonePropertiesPtrInput is an input type that accepts PrivateZonePropertiesArgs, PrivateZonePropertiesPtr and PrivateZonePropertiesPtrOutput values.
// You can construct a concrete instance of `PrivateZonePropertiesPtrInput` via:
//
//          PrivateZonePropertiesArgs{...}
//
//  or:
//
//          nil
type PrivateZonePropertiesPtrInput interface {
	pulumi.Input

	ToPrivateZonePropertiesPtrOutput() PrivateZonePropertiesPtrOutput
	ToPrivateZonePropertiesPtrOutputWithContext(context.Context) PrivateZonePropertiesPtrOutput
}

type privateZonePropertiesPtrType PrivateZonePropertiesArgs

func PrivateZonePropertiesPtr(v *PrivateZonePropertiesArgs) PrivateZonePropertiesPtrInput {
	return (*privateZonePropertiesPtrType)(v)
}

func (*privateZonePropertiesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**PrivateZoneProperties)(nil)).Elem()
}

func (i *privateZonePropertiesPtrType) ToPrivateZonePropertiesPtrOutput() PrivateZonePropertiesPtrOutput {
	return i.ToPrivateZonePropertiesPtrOutputWithContext(context.Background())
}

func (i *privateZonePropertiesPtrType) ToPrivateZonePropertiesPtrOutputWithContext(ctx context.Context) PrivateZonePropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrivateZonePropertiesPtrOutput)
}

// Represents the properties of the Private DNS zone.
type PrivateZonePropertiesOutput struct{ *pulumi.OutputState }

func (PrivateZonePropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateZoneProperties)(nil)).Elem()
}

func (o PrivateZonePropertiesOutput) ToPrivateZonePropertiesOutput() PrivateZonePropertiesOutput {
	return o
}

func (o PrivateZonePropertiesOutput) ToPrivateZonePropertiesOutputWithContext(ctx context.Context) PrivateZonePropertiesOutput {
	return o
}

func (o PrivateZonePropertiesOutput) ToPrivateZonePropertiesPtrOutput() PrivateZonePropertiesPtrOutput {
	return o.ToPrivateZonePropertiesPtrOutputWithContext(context.Background())
}

func (o PrivateZonePropertiesOutput) ToPrivateZonePropertiesPtrOutputWithContext(ctx context.Context) PrivateZonePropertiesPtrOutput {
	return o.ApplyT(func(v PrivateZoneProperties) *PrivateZoneProperties {
		return &v
	}).(PrivateZonePropertiesPtrOutput)
}

type PrivateZonePropertiesPtrOutput struct{ *pulumi.OutputState }

func (PrivateZonePropertiesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PrivateZoneProperties)(nil)).Elem()
}

func (o PrivateZonePropertiesPtrOutput) ToPrivateZonePropertiesPtrOutput() PrivateZonePropertiesPtrOutput {
	return o
}

func (o PrivateZonePropertiesPtrOutput) ToPrivateZonePropertiesPtrOutputWithContext(ctx context.Context) PrivateZonePropertiesPtrOutput {
	return o
}

func (o PrivateZonePropertiesPtrOutput) Elem() PrivateZonePropertiesOutput {
	return o.ApplyT(func(v *PrivateZoneProperties) PrivateZoneProperties { return *v }).(PrivateZonePropertiesOutput)
}
...
// PrivateZonePropertiesResponseInput is an input type that accepts PrivateZonePropertiesResponseArgs and PrivateZonePropertiesResponseOutput values.
// You can construct a concrete instance of `PrivateZonePropertiesResponseInput` via:
//
//          PrivateZonePropertiesResponseArgs{...}
type PrivateZonePropertiesResponseInput interface {
	pulumi.Input

	ToPrivateZonePropertiesResponseOutput() PrivateZonePropertiesResponseOutput
	ToPrivateZonePropertiesResponseOutputWithContext(context.Context) PrivateZonePropertiesResponseOutput
}

// Represents the properties of the Private DNS zone.
type PrivateZonePropertiesResponseArgs struct {
	// The maximum number of record sets that can be created in this Private DNS zone. This is a read-only property and any attempt to set this value will be ignored.
	...
	// The current number of virtual networks that are linked to this Private DNS zone. This is a read-only property and any attempt to set this value will be ignored.
	NumberOfVirtualNetworkLinks pulumi.IntInput `pulumi:"numberOfVirtualNetworkLinks"`
	// The current number of virtual networks that are linked to this Private DNS zone with registration enabled. This is a read-only property and any attempt to set this value will be ignored.
	NumberOfVirtualNetworkLinksWithRegistration pulumi.IntInput `pulumi:"numberOfVirtualNetworkLinksWithRegistration"`
	// The provisioning state of the resource. This is a read-only property and any attempt to set this value will be ignored.
	ProvisioningState pulumi.StringInput `pulumi:"provisioningState"`
}

func (PrivateZonePropertiesResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateZonePropertiesResponse)(nil)).Elem()
}

func (i PrivateZonePropertiesResponseArgs) ToPrivateZonePropertiesResponseOutput() PrivateZonePropertiesResponseOutput {
	return i.ToPrivateZonePropertiesResponseOutputWithContext(context.Background())
}

func (i PrivateZonePropertiesResponseArgs) ToPrivateZonePropertiesResponseOutputWithContext(ctx context.Context) PrivateZonePropertiesResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrivateZonePropertiesResponseOutput)
}

func (i PrivateZonePropertiesResponseArgs) ToPrivateZonePropertiesResponsePtrOutput() PrivateZonePropertiesResponsePtrOutput {
	return i.ToPrivateZonePropertiesResponsePtrOutputWithContext(context.Background())
}

func (i PrivateZonePropertiesResponseArgs) ToPrivateZonePropertiesResponsePtrOutputWithContext(ctx context.Context) PrivateZonePropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrivateZonePropertiesResponseOutput).ToPrivateZonePropertiesResponsePtrOutputWithContext(ctx)
}

// PrivateZonePropertiesResponsePtrInput is an input type that accepts PrivateZonePropertiesResponseArgs, PrivateZonePropertiesResponsePtr and PrivateZonePropertiesResponsePtrOutput values.
// You can construct a concrete instance of `PrivateZonePropertiesResponsePtrInput` via:
//
//          PrivateZonePropertiesResponseArgs{...}
//
//  or:
//
//          nil
type PrivateZonePropertiesResponsePtrInput interface {
	pulumi.Input

	ToPrivateZonePropertiesResponsePtrOutput() PrivateZonePropertiesResponsePtrOutput
	ToPrivateZonePropertiesResponsePtrOutputWithContext(context.Context) PrivateZonePropertiesResponsePtrOutput
}

type privateZonePropertiesResponsePtrType PrivateZonePropertiesResponseArgs

func PrivateZonePropertiesResponsePtr(v *PrivateZonePropertiesResponseArgs) PrivateZonePropertiesResponsePtrInput {
	return (*privateZonePropertiesResponsePtrType)(v)
}

func (*privateZonePropertiesResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**PrivateZonePropertiesResponse)(nil)).Elem()
}

func (i *privateZonePropertiesResponsePtrType) ToPrivateZonePropertiesResponsePtrOutput() PrivateZonePropertiesResponsePtrOutput {
	return i.ToPrivateZonePropertiesResponsePtrOutputWithContext(context.Background())
}

func (i *privateZonePropertiesResponsePtrType) ToPrivateZonePropertiesResponsePtrOutputWithContext(ctx context.Context) PrivateZonePropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrivateZonePropertiesResponsePtrOutput)
}

// Represents the properties of the Private DNS zone.
type PrivateZonePropertiesResponseOutput struct{ *pulumi.OutputState }

func (PrivateZonePropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateZonePropertiesResponse)(nil)).Elem()
}

func (o PrivateZonePropertiesResponseOutput) ToPrivateZonePropertiesResponseOutput() PrivateZonePropertiesResponseOutput {
	return o
}

func (o PrivateZonePropertiesResponseOutput) ToPrivateZonePropertiesResponseOutputWithContext(ctx context.Context) PrivateZonePropertiesResponseOutput {
	return o
}

func (o PrivateZonePropertiesResponseOutput) ToPrivateZonePropertiesResponsePtrOutput() PrivateZonePropertiesResponsePtrOutput {
	return o.ToPrivateZonePropertiesResponsePtrOutputWithContext(context.Background())
}

func (o PrivateZonePropertiesResponseOutput) ToPrivateZonePropertiesResponsePtrOutputWithContext(ctx context.Context) PrivateZonePropertiesResponsePtrOutput {
	return o.ApplyT(func(v PrivateZonePropertiesResponse) *PrivateZonePropertiesResponse {
		return &v
	}).(PrivateZonePropertiesResponsePtrOutput)
}

// The maximum number of record sets that can be created in this Private DNS zone. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponseOutput) MaxNumberOfRecordSets() pulumi.IntOutput {
	return o.ApplyT(func(v PrivateZonePropertiesResponse) int { return v.MaxNumberOfRecordSets }).(pulumi.IntOutput)
}

// The maximum number of virtual networks that can be linked to this Private DNS zone. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponseOutput) MaxNumberOfVirtualNetworkLinks() pulumi.IntOutput {
	return o.ApplyT(func(v PrivateZonePropertiesResponse) int { return v.MaxNumberOfVirtualNetworkLinks }).(pulumi.IntOutput)
}

// The maximum number of virtual networks that can be linked to this Private DNS zone with registration enabled. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponseOutput) MaxNumberOfVirtualNetworkLinksWithRegistration() pulumi.IntOutput {
	return o.ApplyT(func(v PrivateZonePropertiesResponse) int { return v.MaxNumberOfVirtualNetworkLinksWithRegistration }).(pulumi.IntOutput)
}

// The current number of record sets in this Private DNS zone. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponseOutput) NumberOfRecordSets() pulumi.IntOutput {
	return o.ApplyT(func(v PrivateZonePropertiesResponse) int { return v.NumberOfRecordSets }).(pulumi.IntOutput)
}

// The current number of virtual networks that are linked to this Private DNS zone. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponseOutput) NumberOfVirtualNetworkLinks() pulumi.IntOutput {
	return o.ApplyT(func(v PrivateZonePropertiesResponse) int { return v.NumberOfVirtualNetworkLinks }).(pulumi.IntOutput)
}

// The current number of virtual networks that are linked to this Private DNS zone with registration enabled. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponseOutput) NumberOfVirtualNetworkLinksWithRegistration() pulumi.IntOutput {
	return o.ApplyT(func(v PrivateZonePropertiesResponse) int { return v.NumberOfVirtualNetworkLinksWithRegistration }).(pulumi.IntOutput)
}

// The provisioning state of the resource. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponseOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v PrivateZonePropertiesResponse) string { return v.ProvisioningState }).(pulumi.StringOutput)
}

type PrivateZonePropertiesResponsePtrOutput struct{ *pulumi.OutputState }

func (PrivateZonePropertiesResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PrivateZonePropertiesResponse)(nil)).Elem()
}

func (o PrivateZonePropertiesResponsePtrOutput) ToPrivateZonePropertiesResponsePtrOutput() PrivateZonePropertiesResponsePtrOutput {
	return o
}

func (o PrivateZonePropertiesResponsePtrOutput) ToPrivateZonePropertiesResponsePtrOutputWithContext(ctx context.Context) PrivateZonePropertiesResponsePtrOutput {
	return o
}

func (o PrivateZonePropertiesResponsePtrOutput) Elem() PrivateZonePropertiesResponseOutput {
	return o.ApplyT(func(v *PrivateZonePropertiesResponse) PrivateZonePropertiesResponse { return *v }).(PrivateZonePropertiesResponseOutput)
}

// The maximum number of record sets that can be created in this Private DNS zone. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponsePtrOutput) MaxNumberOfRecordSets() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *PrivateZonePropertiesResponse) *int {
		if v == nil {
			return nil
		}
...
// The maximum number of virtual networks that can be linked to this Private DNS zone. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponsePtrOutput) MaxNumberOfVirtualNetworkLinks() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *PrivateZonePropertiesResponse) *int {
		if v == nil {
			return nil
		}
		return &v.MaxNumberOfVirtualNetworkLinks
	}).(pulumi.IntPtrOutput)
}

// The maximum number of virtual networks that can be linked to this Private DNS zone with registration enabled. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponsePtrOutput) MaxNumberOfVirtualNetworkLinksWithRegistration() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *PrivateZonePropertiesResponse) *int {
		if v == nil {
			return nil
		}
		return &v.MaxNumberOfVirtualNetworkLinksWithRegistration
	}).(pulumi.IntPtrOutput)
}

// The current number of record sets in this Private DNS zone. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponsePtrOutput) NumberOfRecordSets() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *PrivateZonePropertiesResponse) *int {
		if v == nil {
			return nil
		}
...
// The current number of virtual networks that are linked to this Private DNS zone. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponsePtrOutput) NumberOfVirtualNetworkLinks() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *PrivateZonePropertiesResponse) *int {
		if v == nil {
			return nil
		}
		return &v.NumberOfVirtualNetworkLinks
	}).(pulumi.IntPtrOutput)
}

// The current number of virtual networks that are linked to this Private DNS zone with registration enabled. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponsePtrOutput) NumberOfVirtualNetworkLinksWithRegistration() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *PrivateZonePropertiesResponse) *int {
		if v == nil {
			return nil
		}
		return &v.NumberOfVirtualNetworkLinksWithRegistration
	}).(pulumi.IntPtrOutput)
}

// The provisioning state of the resource. This is a read-only property and any attempt to set this value will be ignored.
func (o PrivateZonePropertiesResponsePtrOutput) ProvisioningState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrivateZonePropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
type RecordSetPropertiesResponseArgs struct {
	...
	// Is the record set auto-registered in the Private DNS zone through a virtual network link?
	IsAutoRegistered pulumi.BoolInput `pulumi:"isAutoRegistered"`
	// The metadata attached to the record set.
	Metadata pulumi.StringMapInput `pulumi:"metadata"`
	// The list of MX records in the record set.
...
// Is the record set auto-registered in the Private DNS zone through a virtual network link?
func (o RecordSetPropertiesResponseOutput) IsAutoRegistered() pulumi.BoolOutput {
	return o.ApplyT(func(v RecordSetPropertiesResponse) bool { return v.IsAutoRegistered }).(pulumi.BoolOutput)
}
...
// Is the record set auto-registered in the Private DNS zone through a virtual network link?
func (o RecordSetPropertiesResponsePtrOutput) IsAutoRegistered() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RecordSetPropertiesResponse) *bool {
		if v == nil {
			return nil
		}
		return &v.IsAutoRegistered
...
// VirtualNetworkLinkPropertiesInput is an input type that accepts VirtualNetworkLinkPropertiesArgs and VirtualNetworkLinkPropertiesOutput values.
// You can construct a concrete instance of `VirtualNetworkLinkPropertiesInput` via:
//
//          VirtualNetworkLinkPropertiesArgs{...}
type VirtualNetworkLinkPropertiesInput interface {
	pulumi.Input

	ToVirtualNetworkLinkPropertiesOutput() VirtualNetworkLinkPropertiesOutput
	ToVirtualNetworkLinkPropertiesOutputWithContext(context.Context) VirtualNetworkLinkPropertiesOutput
}

// Represents the properties of the Private DNS zone.
type VirtualNetworkLinkPropertiesArgs struct {
	// Is auto-registration of virtual machine records in the virtual network in the Private DNS zone enabled?
	RegistrationEnabled pulumi.BoolPtrInput `pulumi:"registrationEnabled"`
	// The reference of the virtual network.
	VirtualNetwork SubResourcePtrInput `pulumi:"virtualNetwork"`
}

func (VirtualNetworkLinkPropertiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*VirtualNetworkLinkProperties)(nil)).Elem()
}

func (i VirtualNetworkLinkPropertiesArgs) ToVirtualNetworkLinkPropertiesOutput() VirtualNetworkLinkPropertiesOutput {
	return i.ToVirtualNetworkLinkPropertiesOutputWithContext(context.Background())
}

func (i VirtualNetworkLinkPropertiesArgs) ToVirtualNetworkLinkPropertiesOutputWithContext(ctx context.Context) VirtualNetworkLinkPropertiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VirtualNetworkLinkPropertiesOutput)
}

func (i VirtualNetworkLinkPropertiesArgs) ToVirtualNetworkLinkPropertiesPtrOutput() VirtualNetworkLinkPropertiesPtrOutput {
	return i.ToVirtualNetworkLinkPropertiesPtrOutputWithContext(context.Background())
}

func (i VirtualNetworkLinkPropertiesArgs) ToVirtualNetworkLinkPropertiesPtrOutputWithContext(ctx context.Context) VirtualNetworkLinkPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VirtualNetworkLinkPropertiesOutput).ToVirtualNetworkLinkPropertiesPtrOutputWithContext(ctx)
}

// VirtualNetworkLinkPropertiesPtrInput is an input type that accepts VirtualNetworkLinkPropertiesArgs, VirtualNetworkLinkPropertiesPtr and VirtualNetworkLinkPropertiesPtrOutput values.
// You can construct a concrete instance of `VirtualNetworkLinkPropertiesPtrInput` via:
//
//          VirtualNetworkLinkPropertiesArgs{...}
//
//  or:
//
//          nil
type VirtualNetworkLinkPropertiesPtrInput interface {
	pulumi.Input

	ToVirtualNetworkLinkPropertiesPtrOutput() VirtualNetworkLinkPropertiesPtrOutput
	ToVirtualNetworkLinkPropertiesPtrOutputWithContext(context.Context) VirtualNetworkLinkPropertiesPtrOutput
}

type virtualNetworkLinkPropertiesPtrType VirtualNetworkLinkPropertiesArgs

func VirtualNetworkLinkPropertiesPtr(v *VirtualNetworkLinkPropertiesArgs) VirtualNetworkLinkPropertiesPtrInput {
	return (*virtualNetworkLinkPropertiesPtrType)(v)
}

func (*virtualNetworkLinkPropertiesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**VirtualNetworkLinkProperties)(nil)).Elem()
}

func (i *virtualNetworkLinkPropertiesPtrType) ToVirtualNetworkLinkPropertiesPtrOutput() VirtualNetworkLinkPropertiesPtrOutput {
	return i.ToVirtualNetworkLinkPropertiesPtrOutputWithContext(context.Background())
}

func (i *virtualNetworkLinkPropertiesPtrType) ToVirtualNetworkLinkPropertiesPtrOutputWithContext(ctx context.Context) VirtualNetworkLinkPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VirtualNetworkLinkPropertiesPtrOutput)
}

// Represents the properties of the Private DNS zone.
type VirtualNetworkLinkPropertiesOutput struct{ *pulumi.OutputState }

func (VirtualNetworkLinkPropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VirtualNetworkLinkProperties)(nil)).Elem()
}

func (o VirtualNetworkLinkPropertiesOutput) ToVirtualNetworkLinkPropertiesOutput() VirtualNetworkLinkPropertiesOutput {
	return o
}

func (o VirtualNetworkLinkPropertiesOutput) ToVirtualNetworkLinkPropertiesOutputWithContext(ctx context.Context) VirtualNetworkLinkPropertiesOutput {
	return o
}

func (o VirtualNetworkLinkPropertiesOutput) ToVirtualNetworkLinkPropertiesPtrOutput() VirtualNetworkLinkPropertiesPtrOutput {
	return o.ToVirtualNetworkLinkPropertiesPtrOutputWithContext(context.Background())
}

func (o VirtualNetworkLinkPropertiesOutput) ToVirtualNetworkLinkPropertiesPtrOutputWithContext(ctx context.Context) VirtualNetworkLinkPropertiesPtrOutput {
	return o.ApplyT(func(v VirtualNetworkLinkProperties) *VirtualNetworkLinkProperties {
		return &v
	}).(VirtualNetworkLinkPropertiesPtrOutput)
}

// Is auto-registration of virtual machine records in the virtual network in the Private DNS zone enabled?
func (o VirtualNetworkLinkPropertiesOutput) RegistrationEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v VirtualNetworkLinkProperties) *bool { return v.RegistrationEnabled }).(pulumi.BoolPtrOutput)
}

// The reference of the virtual network.
func (o VirtualNetworkLinkPropertiesOutput) VirtualNetwork() SubResourcePtrOutput {
	return o.ApplyT(func(v VirtualNetworkLinkProperties) *SubResource { return v.VirtualNetwork }).(SubResourcePtrOutput)
}

type VirtualNetworkLinkPropertiesPtrOutput struct{ *pulumi.OutputState }

func (VirtualNetworkLinkPropertiesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**VirtualNetworkLinkProperties)(nil)).Elem()
}

func (o VirtualNetworkLinkPropertiesPtrOutput) ToVirtualNetworkLinkPropertiesPtrOutput() VirtualNetworkLinkPropertiesPtrOutput {
	return o
}

func (o VirtualNetworkLinkPropertiesPtrOutput) ToVirtualNetworkLinkPropertiesPtrOutputWithContext(ctx context.Context) VirtualNetworkLinkPropertiesPtrOutput {
	return o
}

func (o VirtualNetworkLinkPropertiesPtrOutput) Elem() VirtualNetworkLinkPropertiesOutput {
	return o.ApplyT(func(v *VirtualNetworkLinkProperties) VirtualNetworkLinkProperties { return *v }).(VirtualNetworkLinkPropertiesOutput)
}

// Is auto-registration of virtual machine records in the virtual network in the Private DNS zone enabled?
func (o VirtualNetworkLinkPropertiesPtrOutput) RegistrationEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *VirtualNetworkLinkProperties) *bool {
		if v == nil {
			return nil
		}
		return v.RegistrationEnabled
	}).(pulumi.BoolPtrOutput)
}

// The reference of the virtual network.
func (o VirtualNetworkLinkPropertiesPtrOutput) VirtualNetwork() SubResourcePtrOutput {
	return o.ApplyT(func(v *VirtualNetworkLinkProperties) *SubResource {
		if v == nil {
			return nil
		}
...
// VirtualNetworkLinkPropertiesResponseInput is an input type that accepts VirtualNetworkLinkPropertiesResponseArgs and VirtualNetworkLinkPropertiesResponseOutput values.
// You can construct a concrete instance of `VirtualNetworkLinkPropertiesResponseInput` via:
//
//          VirtualNetworkLinkPropertiesResponseArgs{...}
type VirtualNetworkLinkPropertiesResponseInput interface {
	pulumi.Input

	ToVirtualNetworkLinkPropertiesResponseOutput() VirtualNetworkLinkPropertiesResponseOutput
	ToVirtualNetworkLinkPropertiesResponseOutputWithContext(context.Context) VirtualNetworkLinkPropertiesResponseOutput
}

// Represents the properties of the Private DNS zone.
type VirtualNetworkLinkPropertiesResponseArgs struct {
	// The provisioning state of the resource. This is a read-only property and any attempt to set this value will be ignored.
	ProvisioningState pulumi.StringInput `pulumi:"provisioningState"`
	// Is auto-registration of virtual machine records in the virtual network in the Private DNS zone enabled?
	RegistrationEnabled pulumi.BoolPtrInput `pulumi:"registrationEnabled"`
	...
	// The status of the virtual network link to the Private DNS zone. Possible values are 'InProgress' and 'Done'. This is a read-only property and any attempt to set this value will be ignored.
	VirtualNetworkLinkState pulumi.StringInput `pulumi:"virtualNetworkLinkState"`
}

func (VirtualNetworkLinkPropertiesResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*VirtualNetworkLinkPropertiesResponse)(nil)).Elem()
}

func (i VirtualNetworkLinkPropertiesResponseArgs) ToVirtualNetworkLinkPropertiesResponseOutput() VirtualNetworkLinkPropertiesResponseOutput {
	return i.ToVirtualNetworkLinkPropertiesResponseOutputWithContext(context.Background())
}

func (i VirtualNetworkLinkPropertiesResponseArgs) ToVirtualNetworkLinkPropertiesResponseOutputWithContext(ctx context.Context) VirtualNetworkLinkPropertiesResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VirtualNetworkLinkPropertiesResponseOutput)
}

func (i VirtualNetworkLinkPropertiesResponseArgs) ToVirtualNetworkLinkPropertiesResponsePtrOutput() VirtualNetworkLinkPropertiesResponsePtrOutput {
	return i.ToVirtualNetworkLinkPropertiesResponsePtrOutputWithContext(context.Background())
}

func (i VirtualNetworkLinkPropertiesResponseArgs) ToVirtualNetworkLinkPropertiesResponsePtrOutputWithContext(ctx context.Context) VirtualNetworkLinkPropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VirtualNetworkLinkPropertiesResponseOutput).ToVirtualNetworkLinkPropertiesResponsePtrOutputWithContext(ctx)
}

// VirtualNetworkLinkPropertiesResponsePtrInput is an input type that accepts VirtualNetworkLinkPropertiesResponseArgs, VirtualNetworkLinkPropertiesResponsePtr and VirtualNetworkLinkPropertiesResponsePtrOutput values.
// You can construct a concrete instance of `VirtualNetworkLinkPropertiesResponsePtrInput` via:
//
//          VirtualNetworkLinkPropertiesResponseArgs{...}
//
//  or:
//
//          nil
type VirtualNetworkLinkPropertiesResponsePtrInput interface {
	pulumi.Input

	ToVirtualNetworkLinkPropertiesResponsePtrOutput() VirtualNetworkLinkPropertiesResponsePtrOutput
	ToVirtualNetworkLinkPropertiesResponsePtrOutputWithContext(context.Context) VirtualNetworkLinkPropertiesResponsePtrOutput
}

type virtualNetworkLinkPropertiesResponsePtrType VirtualNetworkLinkPropertiesResponseArgs

func VirtualNetworkLinkPropertiesResponsePtr(v *VirtualNetworkLinkPropertiesResponseArgs) VirtualNetworkLinkPropertiesResponsePtrInput {
	return (*virtualNetworkLinkPropertiesResponsePtrType)(v)
}

func (*virtualNetworkLinkPropertiesResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**VirtualNetworkLinkPropertiesResponse)(nil)).Elem()
}

func (i *virtualNetworkLinkPropertiesResponsePtrType) ToVirtualNetworkLinkPropertiesResponsePtrOutput() VirtualNetworkLinkPropertiesResponsePtrOutput {
	return i.ToVirtualNetworkLinkPropertiesResponsePtrOutputWithContext(context.Background())
}

func (i *virtualNetworkLinkPropertiesResponsePtrType) ToVirtualNetworkLinkPropertiesResponsePtrOutputWithContext(ctx context.Context) VirtualNetworkLinkPropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VirtualNetworkLinkPropertiesResponsePtrOutput)
}

// Represents the properties of the Private DNS zone.
type VirtualNetworkLinkPropertiesResponseOutput struct{ *pulumi.OutputState }

func (VirtualNetworkLinkPropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VirtualNetworkLinkPropertiesResponse)(nil)).Elem()
}

func (o VirtualNetworkLinkPropertiesResponseOutput) ToVirtualNetworkLinkPropertiesResponseOutput() VirtualNetworkLinkPropertiesResponseOutput {
	return o
}

func (o VirtualNetworkLinkPropertiesResponseOutput) ToVirtualNetworkLinkPropertiesResponseOutputWithContext(ctx context.Context) VirtualNetworkLinkPropertiesResponseOutput {
	return o
}

func (o VirtualNetworkLinkPropertiesResponseOutput) ToVirtualNetworkLinkPropertiesResponsePtrOutput() VirtualNetworkLinkPropertiesResponsePtrOutput {
	return o.ToVirtualNetworkLinkPropertiesResponsePtrOutputWithContext(context.Background())
}

func (o VirtualNetworkLinkPropertiesResponseOutput) ToVirtualNetworkLinkPropertiesResponsePtrOutputWithContext(ctx context.Context) VirtualNetworkLinkPropertiesResponsePtrOutput {
	return o.ApplyT(func(v VirtualNetworkLinkPropertiesResponse) *VirtualNetworkLinkPropertiesResponse {
		return &v
	}).(VirtualNetworkLinkPropertiesResponsePtrOutput)
}

// The provisioning state of the resource. This is a read-only property and any attempt to set this value will be ignored.
func (o VirtualNetworkLinkPropertiesResponseOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v VirtualNetworkLinkPropertiesResponse) string { return v.ProvisioningState }).(pulumi.StringOutput)
}

// Is auto-registration of virtual machine records in the virtual network in the Private DNS zone enabled?
func (o VirtualNetworkLinkPropertiesResponseOutput) RegistrationEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v VirtualNetworkLinkPropertiesResponse) *bool { return v.RegistrationEnabled }).(pulumi.BoolPtrOutput)
}

// The reference of the virtual network.
func (o VirtualNetworkLinkPropertiesResponseOutput) VirtualNetwork() SubResourceResponsePtrOutput {
	return o.ApplyT(func(v VirtualNetworkLinkPropertiesResponse) *SubResourceResponse { return v.VirtualNetwork }).(SubResourceResponsePtrOutput)
}

// The status of the virtual network link to the Private DNS zone. Possible values are 'InProgress' and 'Done'. This is a read-only property and any attempt to set this value will be ignored.
func (o VirtualNetworkLinkPropertiesResponseOutput) VirtualNetworkLinkState() pulumi.StringOutput {
	return o.ApplyT(func(v VirtualNetworkLinkPropertiesResponse) string { return v.VirtualNetworkLinkState }).(pulumi.StringOutput)
}

type VirtualNetworkLinkPropertiesResponsePtrOutput struct{ *pulumi.OutputState }

func (VirtualNetworkLinkPropertiesResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**VirtualNetworkLinkPropertiesResponse)(nil)).Elem()
}

func (o VirtualNetworkLinkPropertiesResponsePtrOutput) ToVirtualNetworkLinkPropertiesResponsePtrOutput() VirtualNetworkLinkPropertiesResponsePtrOutput {
	return o
}

func (o VirtualNetworkLinkPropertiesResponsePtrOutput) ToVirtualNetworkLinkPropertiesResponsePtrOutputWithContext(ctx context.Context) VirtualNetworkLinkPropertiesResponsePtrOutput {
	return o
}

func (o VirtualNetworkLinkPropertiesResponsePtrOutput) Elem() VirtualNetworkLinkPropertiesResponseOutput {
	return o.ApplyT(func(v *VirtualNetworkLinkPropertiesResponse) VirtualNetworkLinkPropertiesResponse { return *v }).(VirtualNetworkLinkPropertiesResponseOutput)
}

// The provisioning state of the resource. This is a read-only property and any attempt to set this value will be ignored.
func (o VirtualNetworkLinkPropertiesResponsePtrOutput) ProvisioningState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VirtualNetworkLinkPropertiesResponse) *string {
		if v == nil {
			return nil
		}
		return &v.ProvisioningState
...
// Is auto-registration of virtual machine records in the virtual network in the Private DNS zone enabled?
func (o VirtualNetworkLinkPropertiesResponsePtrOutput) RegistrationEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *VirtualNetworkLinkPropertiesResponse) *bool {
		if v == nil {
			return nil
		}
		return v.RegistrationEnabled
...
// The reference of the virtual network.
func (o VirtualNetworkLinkPropertiesResponsePtrOutput) VirtualNetwork() SubResourceResponsePtrOutput {
	return o.ApplyT(func(v *VirtualNetworkLinkPropertiesResponse) *SubResourceResponse {
		if v == nil {
			return nil
		}
		return v.VirtualNetwork
...
// The status of the virtual network link to the Private DNS zone. Possible values are 'InProgress' and 'Done'. This is a read-only property and any attempt to set this value will be ignored.
func (o VirtualNetworkLinkPropertiesResponsePtrOutput) VirtualNetworkLinkState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VirtualNetworkLinkPropertiesResponse) *string {
		if v == nil {
			return nil
		}
		return &v.VirtualNetworkLinkState
	}).(pulumi.StringPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(PrivateZonePropertiesOutput{})
	pulumi.RegisterOutputType(PrivateZonePropertiesPtrOutput{})
	...
	pulumi.RegisterOutputType(VirtualNetworkLinkPropertiesOutput{})
	pulumi.RegisterOutputType(VirtualNetworkLinkPropertiesPtrOutput{})
