...
func NewNetworkSecurityGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20180801:NetworkSecurityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkSecurityGroup(ctx *pulumi.Context,
	...
	var resource NetworkSecurityGroup
	err := ctx.ReadResource("azurerm:network/v20180801:NetworkSecurityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
