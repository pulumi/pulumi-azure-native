...
func NewInterfaceEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20180801:InterfaceEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfaceEndpoint(ctx *pulumi.Context,
	...
	var resource InterfaceEndpoint
	err := ctx.ReadResource("azurerm:network/v20180801:InterfaceEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
