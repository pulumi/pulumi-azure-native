...
func NewHubRouteTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network:HubRouteTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHubRouteTable(ctx *pulumi.Context,
	...
	var resource HubRouteTable
	err := ctx.ReadResource("azurerm:network:HubRouteTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
