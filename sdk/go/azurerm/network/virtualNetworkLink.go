...
func NewVirtualNetworkLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network:VirtualNetworkLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkLink(ctx *pulumi.Context,
	...
	var resource VirtualNetworkLink
	err := ctx.ReadResource("azurerm:network:VirtualNetworkLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
