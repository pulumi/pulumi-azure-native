...
func NewVirtualWan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190801:VirtualWan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualWan(ctx *pulumi.Context,
	...
	var resource VirtualWan
	err := ctx.ReadResource("azurerm:network/v20190801:VirtualWan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
