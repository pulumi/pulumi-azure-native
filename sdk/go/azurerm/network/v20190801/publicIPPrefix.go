...
func NewPublicIPPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190801:PublicIPPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicIPPrefix(ctx *pulumi.Context,
	...
	var resource PublicIPPrefix
	err := ctx.ReadResource("azurerm:network/v20190801:PublicIPPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
