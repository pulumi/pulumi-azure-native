...
func NewVirtualRouterPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190801:VirtualRouterPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualRouterPeering(ctx *pulumi.Context,
	...
	var resource VirtualRouterPeering
	err := ctx.ReadResource("azurerm:network/v20190801:VirtualRouterPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
