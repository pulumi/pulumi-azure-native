...
func NewVirtualRouter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190801:VirtualRouter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualRouter(ctx *pulumi.Context,
	...
	var resource VirtualRouter
	err := ctx.ReadResource("azurerm:network/v20190801:VirtualRouter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
