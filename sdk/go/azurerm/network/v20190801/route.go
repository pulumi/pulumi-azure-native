...
func NewRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.RegisterResource("azurerm:network/v20190801:Route", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.ReadResource("azurerm:network/v20190801:Route", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
