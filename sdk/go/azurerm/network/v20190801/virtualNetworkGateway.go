...
func NewVirtualNetworkGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20190801:VirtualNetworkGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkGateway(ctx *pulumi.Context,
	...
	var resource VirtualNetworkGateway
	err := ctx.ReadResource("azurerm:network/v20190801:VirtualNetworkGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
