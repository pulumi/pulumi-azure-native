...
func NewPrivateZone(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network:PrivateZone", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateZone(ctx *pulumi.Context,
	...
	var resource PrivateZone
	err := ctx.ReadResource("azurerm:network:PrivateZone", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
