...
func NewVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20200501:VpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnGateway(ctx *pulumi.Context,
	...
	var resource VpnGateway
	err := ctx.ReadResource("azurerm:network/v20200501:VpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
