...
func NewWebApplicationFirewallPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20200501:WebApplicationFirewallPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebApplicationFirewallPolicy(ctx *pulumi.Context,
	...
	var resource WebApplicationFirewallPolicy
	err := ctx.ReadResource("azurerm:network/v20200501:WebApplicationFirewallPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
