...
func NewRulesEngine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20200501:RulesEngine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRulesEngine(ctx *pulumi.Context,
	...
	var resource RulesEngine
	err := ctx.ReadResource("azurerm:network/v20200501:RulesEngine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
