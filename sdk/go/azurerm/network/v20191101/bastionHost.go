...
func NewBastionHost(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20191101:BastionHost", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBastionHost(ctx *pulumi.Context,
	...
	var resource BastionHost
	err := ctx.ReadResource("azurerm:network/v20191101:BastionHost", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
