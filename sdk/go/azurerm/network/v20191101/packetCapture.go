...
func NewPacketCapture(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20191101:PacketCapture", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPacketCapture(ctx *pulumi.Context,
	...
	var resource PacketCapture
	err := ctx.ReadResource("azurerm:network/v20191101:PacketCapture", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
