...
func NewNetworkWatcher(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20200401:NetworkWatcher", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkWatcher(ctx *pulumi.Context,
	...
	var resource NetworkWatcher
	err := ctx.ReadResource("azurerm:network/v20200401:NetworkWatcher", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
