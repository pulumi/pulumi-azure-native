...
func NewSecurityPartnerProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/v20200401:SecurityPartnerProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityPartnerProvider(ctx *pulumi.Context,
	...
	var resource SecurityPartnerProvider
	err := ctx.ReadResource("azurerm:network/v20200401:SecurityPartnerProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
