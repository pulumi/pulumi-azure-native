...
func NewVirtualNetworkPeering(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:network/latest:VirtualNetworkPeering"),
		},
		{
			Type: pulumi.String("azurerm:network/preview:VirtualNetworkPeering"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:network/v20180401:VirtualNetworkPeering"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:network/v20200601:VirtualNetworkPeering"),
		},
	})
	opts = append(opts, aliases)
	var resource VirtualNetworkPeering
	err := ctx.RegisterResource("azurerm:network/v20200401:VirtualNetworkPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkPeering(ctx *pulumi.Context,
	...
	var resource VirtualNetworkPeering
	err := ctx.ReadResource("azurerm:network/v20200401:VirtualNetworkPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
