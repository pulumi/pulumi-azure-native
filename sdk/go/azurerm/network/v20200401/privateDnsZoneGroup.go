...
func NewPrivateDnsZoneGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:network/preview:PrivateDnsZoneGroup"),
		},
		{
...
func GetPrivateDnsZoneGroup(ctx *pulumi.Context,
	...
	var resource PrivateDnsZoneGroup
	err := ctx.ReadResource("azurerm:network/v20200401:PrivateDnsZoneGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
