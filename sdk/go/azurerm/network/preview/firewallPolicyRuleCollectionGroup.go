...
func NewFirewallPolicyRuleCollectionGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:FirewallPolicyRuleCollectionGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicyRuleCollectionGroup(ctx *pulumi.Context,
	...
	var resource FirewallPolicyRuleCollectionGroup
	err := ctx.ReadResource("azurerm:network/preview:FirewallPolicyRuleCollectionGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
