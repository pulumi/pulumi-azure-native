...
func NewFlowLog(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:FlowLog", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFlowLog(ctx *pulumi.Context,
	...
	var resource FlowLog
	err := ctx.ReadResource("azurerm:network/preview:FlowLog", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
