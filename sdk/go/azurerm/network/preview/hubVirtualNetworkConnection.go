...
func NewHubVirtualNetworkConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:HubVirtualNetworkConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHubVirtualNetworkConnection(ctx *pulumi.Context,
	...
	var resource HubVirtualNetworkConnection
	err := ctx.ReadResource("azurerm:network/preview:HubVirtualNetworkConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
