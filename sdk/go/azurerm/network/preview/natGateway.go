...
func NewNatGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:NatGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNatGateway(ctx *pulumi.Context,
	...
	var resource NatGateway
	err := ctx.ReadResource("azurerm:network/preview:NatGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
