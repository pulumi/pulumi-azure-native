...
func NewVirtualHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:VirtualHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHub(ctx *pulumi.Context,
	...
	var resource VirtualHub
	err := ctx.ReadResource("azurerm:network/preview:VirtualHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
