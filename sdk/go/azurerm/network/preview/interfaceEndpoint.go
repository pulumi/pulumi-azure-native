...
func NewInterfaceEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:network/v20181101:InterfaceEndpoint"),
		},
		{
			Type: pulumi.String("azurerm:network/v20181201:InterfaceEndpoint"),
		},
		{
			Type: pulumi.String("azurerm:network/v20190201:InterfaceEndpoint"),
		},
	})
	opts = append(opts, aliases)
	var resource InterfaceEndpoint
	err := ctx.RegisterResource("azurerm:network/preview:InterfaceEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfaceEndpoint(ctx *pulumi.Context,
	...
	var resource InterfaceEndpoint
	err := ctx.ReadResource("azurerm:network/preview:InterfaceEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
