...
func NewPrivateDnsZoneGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:network/latest:PrivateDnsZoneGroup"),
		},
		{
			Type: pulumi.String("azurerm:network/v20200301:PrivateDnsZoneGroup"),
		},
		{
			Type: pulumi.String("azurerm:network/v20200401:PrivateDnsZoneGroup"),
		},
		{
			Type: pulumi.String("azurerm:network/v20200501:PrivateDnsZoneGroup"),
		},
		{
			Type: pulumi.String("azurerm:network/v20200601:PrivateDnsZoneGroup"),
		},
	})
	opts = append(opts, aliases)
	var resource PrivateDnsZoneGroup
	err := ctx.RegisterResource("azurerm:network/preview:PrivateDnsZoneGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateDnsZoneGroup(ctx *pulumi.Context,
	...
	var resource PrivateDnsZoneGroup
	err := ctx.ReadResource("azurerm:network/preview:PrivateDnsZoneGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
