...
func NewProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:network/latest:Profile"),
		},
		{
			Type: pulumi.String("azurerm:network/v20151101:Profile"),
		},
		{
			Type: pulumi.String("azurerm:network/v20170301:Profile"),
		},
		{
			Type: pulumi.String("azurerm:network/v20170501:Profile"),
		},
		{
			Type: pulumi.String("azurerm:network/v20180201:Profile"),
		},
		{
			Type: pulumi.String("azurerm:network/v20180301:Profile"),
		},
		{
			Type: pulumi.String("azurerm:network/v20180401:Profile"),
		},
	})
	opts = append(opts, aliases)
	var resource Profile
	err := ctx.RegisterResource("azurerm:network/preview:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("azurerm:network/preview:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
