...
func NewVirtualHubIpConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:VirtualHubIpConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHubIpConfiguration(ctx *pulumi.Context,
	...
	var resource VirtualHubIpConfiguration
	err := ctx.ReadResource("azurerm:network/preview:VirtualHubIpConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
