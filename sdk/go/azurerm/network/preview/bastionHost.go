...
func NewBastionHost(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:BastionHost", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBastionHost(ctx *pulumi.Context,
	...
	var resource BastionHost
	err := ctx.ReadResource("azurerm:network/preview:BastionHost", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
