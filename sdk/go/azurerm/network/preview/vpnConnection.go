...
func NewVpnConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:VpnConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnConnection(ctx *pulumi.Context,
	...
	var resource VpnConnection
	err := ctx.ReadResource("azurerm:network/preview:VpnConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
