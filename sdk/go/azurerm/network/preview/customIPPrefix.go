...
func NewCustomIPPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:CustomIPPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomIPPrefix(ctx *pulumi.Context,
	...
	var resource CustomIPPrefix
	err := ctx.ReadResource("azurerm:network/preview:CustomIPPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
