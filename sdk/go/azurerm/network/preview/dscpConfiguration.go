...
func NewDscpConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:DscpConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDscpConfiguration(ctx *pulumi.Context,
	...
	var resource DscpConfiguration
	err := ctx.ReadResource("azurerm:network/preview:DscpConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
