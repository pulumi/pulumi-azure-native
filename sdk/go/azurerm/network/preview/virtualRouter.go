...
func NewVirtualRouter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:VirtualRouter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualRouter(ctx *pulumi.Context,
	...
	var resource VirtualRouter
	err := ctx.ReadResource("azurerm:network/preview:VirtualRouter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
