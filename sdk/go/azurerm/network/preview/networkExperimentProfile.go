...
func NewNetworkExperimentProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:NetworkExperimentProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkExperimentProfile(ctx *pulumi.Context,
	...
	var resource NetworkExperimentProfile
	err := ctx.ReadResource("azurerm:network/preview:NetworkExperimentProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
