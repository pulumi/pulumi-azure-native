...
func NewDelegatedSubnetServiceDetails(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:network/v20200808preview:DelegatedSubnetServiceDetails"),
		},
	})
	opts = append(opts, aliases)
	var resource DelegatedSubnetServiceDetails
	err := ctx.RegisterResource("azurerm:network/preview:DelegatedSubnetServiceDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDelegatedSubnetServiceDetails(ctx *pulumi.Context,
	...
	var resource DelegatedSubnetServiceDetails
	err := ctx.ReadResource("azurerm:network/preview:DelegatedSubnetServiceDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
