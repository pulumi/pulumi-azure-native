...
func NewSecurityPartnerProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:network/preview:SecurityPartnerProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityPartnerProvider(ctx *pulumi.Context,
	...
	var resource SecurityPartnerProvider
	err := ctx.ReadResource("azurerm:network/preview:SecurityPartnerProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
