...
//
// import (
// 	mixedreality "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/mixedreality/v20190228preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
// 			SpatialAnchorsAccountName: pulumi.String("MyAccount"),
// 		})
// 		if err != nil {
// 			return err
// 		}
...
func NewSpatialAnchorsAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:mixedreality/v20190228preview:SpatialAnchorsAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpatialAnchorsAccount(ctx *pulumi.Context,
	...
	var resource SpatialAnchorsAccount
	err := ctx.ReadResource("azurerm:mixedreality/v20190228preview:SpatialAnchorsAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
