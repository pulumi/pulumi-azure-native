...
//
// import (
// 	mixedreality "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/mixedreality/v20200406preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewRemoteRenderingAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:mixedreality/v20191202preview:RemoteRenderingAccount"),
		},
	})
	opts = append(opts, aliases)
	var resource RemoteRenderingAccount
	err := ctx.RegisterResource("azurerm:mixedreality/v20200406preview:RemoteRenderingAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemoteRenderingAccount(ctx *pulumi.Context,
	...
	var resource RemoteRenderingAccount
	err := ctx.ReadResource("azurerm:mixedreality/v20200406preview:RemoteRenderingAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
