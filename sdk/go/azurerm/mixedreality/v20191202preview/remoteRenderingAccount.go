...
func NewRemoteRenderingAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:mixedreality/v20191202preview:RemoteRenderingAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemoteRenderingAccount(ctx *pulumi.Context,
	...
	var resource RemoteRenderingAccount
	err := ctx.ReadResource("azurerm:mixedreality/v20191202preview:RemoteRenderingAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
