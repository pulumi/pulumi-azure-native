...
func NewSpatialAnchorsAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:mixedreality:SpatialAnchorsAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpatialAnchorsAccount(ctx *pulumi.Context,
	...
	var resource SpatialAnchorsAccount
	err := ctx.ReadResource("azurerm:mixedreality:SpatialAnchorsAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
