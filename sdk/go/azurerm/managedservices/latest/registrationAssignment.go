...
func NewRegistrationAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:managedservices/latest:RegistrationAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistrationAssignment(ctx *pulumi.Context,
	...
	var resource RegistrationAssignment
	err := ctx.ReadResource("azurerm:managedservices/latest:RegistrationAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
