...
func NewRegistrationDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:managedservices/v20180601preview:RegistrationDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistrationDefinition(ctx *pulumi.Context,
	...
	var resource RegistrationDefinition
	err := ctx.ReadResource("azurerm:managedservices/v20180601preview:RegistrationDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
