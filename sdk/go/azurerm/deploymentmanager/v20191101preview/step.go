...
func NewStep(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:deploymentmanager/preview:Step"),
		},
		{
	...
	var resource Step
	err := ctx.RegisterResource("azurerm:deploymentmanager/v20191101preview:Step", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStep(ctx *pulumi.Context,
	...
	var resource Step
	err := ctx.ReadResource("azurerm:deploymentmanager/v20191101preview:Step", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
