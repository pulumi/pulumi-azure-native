...
func NewServiceUnit(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:deploymentmanager/preview:ServiceUnit"),
		},
		{
			Type: pulumi.String("azurerm:deploymentmanager/v20180901preview:ServiceUnit"),
		},
	})
	opts = append(opts, aliases)
	var resource ServiceUnit
	err := ctx.RegisterResource("azurerm:deploymentmanager/v20191101preview:ServiceUnit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceUnit(ctx *pulumi.Context,
	...
	var resource ServiceUnit
	err := ctx.ReadResource("azurerm:deploymentmanager/v20191101preview:ServiceUnit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
