...
func NewStep(ctx *pulumi.Context,
	...
	var resource Step
	err := ctx.RegisterResource("azurerm:deploymentmanager/preview:Step", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStep(ctx *pulumi.Context,
	...
	var resource Step
	err := ctx.ReadResource("azurerm:deploymentmanager/preview:Step", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
