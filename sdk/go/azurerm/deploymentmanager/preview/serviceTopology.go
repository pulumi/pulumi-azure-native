...
func NewServiceTopology(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:deploymentmanager/v20191101preview:ServiceTopology"),
		},
	})
	opts = append(opts, aliases)
	var resource ServiceTopology
	err := ctx.RegisterResource("azurerm:deploymentmanager/preview:ServiceTopology", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceTopology(ctx *pulumi.Context,
	...
	var resource ServiceTopology
	err := ctx.ReadResource("azurerm:deploymentmanager/preview:ServiceTopology", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
