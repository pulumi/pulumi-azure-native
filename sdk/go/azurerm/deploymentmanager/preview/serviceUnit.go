...
func NewServiceUnit(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:deploymentmanager/preview:ServiceUnit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceUnit(ctx *pulumi.Context,
	...
	var resource ServiceUnit
	err := ctx.ReadResource("azurerm:deploymentmanager/preview:ServiceUnit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
