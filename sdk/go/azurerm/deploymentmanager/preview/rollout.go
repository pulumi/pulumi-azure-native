...
func NewRollout(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:deploymentmanager/preview:Rollout", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRollout(ctx *pulumi.Context,
	...
	var resource Rollout
	err := ctx.ReadResource("azurerm:deploymentmanager/preview:Rollout", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
