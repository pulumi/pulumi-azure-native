...
func NewServiceTopology(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:deploymentmanager/latest:ServiceTopology"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:deploymentmanager/v20180901preview:ServiceTopology", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceTopology(ctx *pulumi.Context,
	...
	var resource ServiceTopology
	err := ctx.ReadResource("azurerm:deploymentmanager/v20180901preview:ServiceTopology", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
