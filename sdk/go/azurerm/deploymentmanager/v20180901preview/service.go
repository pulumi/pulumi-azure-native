...
func NewService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:deploymentmanager/v20180901preview:Service", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetService(ctx *pulumi.Context,
	...
	var resource Service
	err := ctx.ReadResource("azurerm:deploymentmanager/v20180901preview:Service", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
