...
func NewCache(ctx *pulumi.Context,
	...
	var resource Cache
	err := ctx.RegisterResource("azurerm:storagecache/v20190801preview:Cache", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCache(ctx *pulumi.Context,
	...
	var resource Cache
	err := ctx.ReadResource("azurerm:storagecache/v20190801preview:Cache", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
