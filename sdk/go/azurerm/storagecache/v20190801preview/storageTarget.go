...
func NewStorageTarget(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storagecache/v20190801preview:StorageTarget", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageTarget(ctx *pulumi.Context,
	...
	var resource StorageTarget
	err := ctx.ReadResource("azurerm:storagecache/v20190801preview:StorageTarget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
