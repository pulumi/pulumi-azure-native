...
func NewApiManagementService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/preview:ApiManagementService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiManagementService(ctx *pulumi.Context,
	...
	var resource ApiManagementService
	err := ctx.ReadResource("azurerm:apimanagement/preview:ApiManagementService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
