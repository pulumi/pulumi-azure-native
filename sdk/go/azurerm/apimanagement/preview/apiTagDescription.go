...
func NewApiTagDescription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/preview:ApiTagDescription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiTagDescription(ctx *pulumi.Context,
	...
	var resource ApiTagDescription
	err := ctx.ReadResource("azurerm:apimanagement/preview:ApiTagDescription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
