...
func NewContentItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement:ContentItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentItem(ctx *pulumi.Context,
	...
	var resource ContentItem
	err := ctx.ReadResource("azurerm:apimanagement:ContentItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
