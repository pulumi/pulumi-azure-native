...
func NewOpenIdConnectProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20190101:OpenIdConnectProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOpenIdConnectProvider(ctx *pulumi.Context,
	...
	var resource OpenIdConnectProvider
	err := ctx.ReadResource("azurerm:apimanagement/v20190101:OpenIdConnectProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
