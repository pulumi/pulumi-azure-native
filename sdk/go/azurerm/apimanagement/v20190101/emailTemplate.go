...
func NewEmailTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20190101:EmailTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEmailTemplate(ctx *pulumi.Context,
	...
	var resource EmailTemplate
	err := ctx.ReadResource("azurerm:apimanagement/v20190101:EmailTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
