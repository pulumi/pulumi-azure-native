...
func NewTagByApi(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20190101:TagByApi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagByApi(ctx *pulumi.Context,
	...
	var resource TagByApi
	err := ctx.ReadResource("azurerm:apimanagement/v20190101:TagByApi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
