...
func NewApiVersionSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement:ApiVersionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiVersionSet(ctx *pulumi.Context,
	...
	var resource ApiVersionSet
	err := ctx.ReadResource("azurerm:apimanagement:ApiVersionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
