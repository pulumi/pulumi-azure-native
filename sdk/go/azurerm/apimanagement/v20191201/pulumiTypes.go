...
type ApiManagementServicePropertiesResponseArgs struct {
	...
	// Control Plane Apis version constraint for the API Management service.
	ApiVersionConstraint ApiVersionConstraintResponsePtrInput `pulumi:"apiVersionConstraint"`
	// List of Certificates that need to be installed in the API Management service. Max supported certificates that can be installed is 10.
...
// Control Plane Apis version constraint for the API Management service.
func (o ApiManagementServicePropertiesResponseOutput) ApiVersionConstraint() ApiVersionConstraintResponsePtrOutput {
	return o.ApplyT(func(v ApiManagementServicePropertiesResponse) *ApiVersionConstraintResponse {
		return v.ApiVersionConstraint
...
// Property only valid for an Api Management service deployed in multiple locations. This can be used to disable the gateway in master region.
func (o ApiManagementServicePropertiesResponseOutput) DisableGateway() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v ApiManagementServicePropertiesResponse) *bool { return v.DisableGateway }).(pulumi.BoolPtrOutput)
}
...
// Control Plane Apis version constraint for the API Management service.
func (o ApiManagementServicePropertiesResponsePtrOutput) ApiVersionConstraint() ApiVersionConstraintResponsePtrOutput {
	return o.ApplyT(func(v *ApiManagementServicePropertiesResponse) *ApiVersionConstraintResponse {
		if v == nil {
			return nil
		}
...
// Property only valid for an Api Management service deployed in multiple locations. This can be used to disable the gateway in master region.
func (o ApiManagementServicePropertiesResponsePtrOutput) DisableGateway() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *ApiManagementServicePropertiesResponse) *bool {
		if v == nil {
			return nil
		}
		return v.DisableGateway
	}).(pulumi.BoolPtrOutput)
}
...
type DiagnosticContractPropertiesResponseArgs struct {
	...
	// Log the ClientIP. Default is false.
	LogClientIp pulumi.BoolPtrInput `pulumi:"logClientIp"`
	// Resource Id of a target logger.
...
// Log the ClientIP. Default is false.
func (o DiagnosticContractPropertiesResponseOutput) LogClientIp() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v DiagnosticContractPropertiesResponse) *bool { return v.LogClientIp }).(pulumi.BoolPtrOutput)
}
...
// Log the ClientIP. Default is false.
func (o DiagnosticContractPropertiesResponsePtrOutput) LogClientIp() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *DiagnosticContractPropertiesResponse) *bool {
		if v == nil {
			return nil
		}
		return v.LogClientIp
	}).(pulumi.BoolPtrOutput)
}
...
type GatewayContractPropertiesResponse struct {
	// Gateway description
	Description *string `pulumi:"description"`
	// Gateway location.
...
// GatewayContractPropertiesResponseInput is an input type that accepts GatewayContractPropertiesResponseArgs and GatewayContractPropertiesResponseOutput values.
// You can construct a concrete instance of `GatewayContractPropertiesResponseInput` via:
//
//          GatewayContractPropertiesResponseArgs{...}
type GatewayContractPropertiesResponseInput interface {
	pulumi.Input

	ToGatewayContractPropertiesResponseOutput() GatewayContractPropertiesResponseOutput
	ToGatewayContractPropertiesResponseOutputWithContext(context.Context) GatewayContractPropertiesResponseOutput
}

// Properties of the Gateway contract.
type GatewayContractPropertiesResponseArgs struct {
	// Gateway description
	Description pulumi.StringPtrInput `pulumi:"description"`
	// Gateway location.
	LocationData ResourceLocationDataContractResponsePtrInput `pulumi:"locationData"`
}

func (GatewayContractPropertiesResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GatewayContractPropertiesResponse)(nil)).Elem()
}

func (i GatewayContractPropertiesResponseArgs) ToGatewayContractPropertiesResponseOutput() GatewayContractPropertiesResponseOutput {
	return i.ToGatewayContractPropertiesResponseOutputWithContext(context.Background())
}

func (i GatewayContractPropertiesResponseArgs) ToGatewayContractPropertiesResponseOutputWithContext(ctx context.Context) GatewayContractPropertiesResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GatewayContractPropertiesResponseOutput)
}

func (i GatewayContractPropertiesResponseArgs) ToGatewayContractPropertiesResponsePtrOutput() GatewayContractPropertiesResponsePtrOutput {
	return i.ToGatewayContractPropertiesResponsePtrOutputWithContext(context.Background())
}

func (i GatewayContractPropertiesResponseArgs) ToGatewayContractPropertiesResponsePtrOutputWithContext(ctx context.Context) GatewayContractPropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GatewayContractPropertiesResponseOutput).ToGatewayContractPropertiesResponsePtrOutputWithContext(ctx)
}

// GatewayContractPropertiesResponsePtrInput is an input type that accepts GatewayContractPropertiesResponseArgs, GatewayContractPropertiesResponsePtr and GatewayContractPropertiesResponsePtrOutput values.
// You can construct a concrete instance of `GatewayContractPropertiesResponsePtrInput` via:
//
//          GatewayContractPropertiesResponseArgs{...}
//
//  or:
//
//          nil
type GatewayContractPropertiesResponsePtrInput interface {
	pulumi.Input

	ToGatewayContractPropertiesResponsePtrOutput() GatewayContractPropertiesResponsePtrOutput
	ToGatewayContractPropertiesResponsePtrOutputWithContext(context.Context) GatewayContractPropertiesResponsePtrOutput
}

type gatewayContractPropertiesResponsePtrType GatewayContractPropertiesResponseArgs

func GatewayContractPropertiesResponsePtr(v *GatewayContractPropertiesResponseArgs) GatewayContractPropertiesResponsePtrInput {
	return (*gatewayContractPropertiesResponsePtrType)(v)
}

func (*gatewayContractPropertiesResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**GatewayContractPropertiesResponse)(nil)).Elem()
}

func (i *gatewayContractPropertiesResponsePtrType) ToGatewayContractPropertiesResponsePtrOutput() GatewayContractPropertiesResponsePtrOutput {
	return i.ToGatewayContractPropertiesResponsePtrOutputWithContext(context.Background())
}

func (i *gatewayContractPropertiesResponsePtrType) ToGatewayContractPropertiesResponsePtrOutputWithContext(ctx context.Context) GatewayContractPropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GatewayContractPropertiesResponsePtrOutput)
}

// Properties of the Gateway contract.
type GatewayContractPropertiesResponseOutput struct{ *pulumi.OutputState }

func (GatewayContractPropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GatewayContractPropertiesResponse)(nil)).Elem()
}

func (o GatewayContractPropertiesResponseOutput) ToGatewayContractPropertiesResponseOutput() GatewayContractPropertiesResponseOutput {
	return o
}

func (o GatewayContractPropertiesResponseOutput) ToGatewayContractPropertiesResponseOutputWithContext(ctx context.Context) GatewayContractPropertiesResponseOutput {
	return o
}

func (o GatewayContractPropertiesResponseOutput) ToGatewayContractPropertiesResponsePtrOutput() GatewayContractPropertiesResponsePtrOutput {
	return o.ToGatewayContractPropertiesResponsePtrOutputWithContext(context.Background())
}

func (o GatewayContractPropertiesResponseOutput) ToGatewayContractPropertiesResponsePtrOutputWithContext(ctx context.Context) GatewayContractPropertiesResponsePtrOutput {
	return o.ApplyT(func(v GatewayContractPropertiesResponse) *GatewayContractPropertiesResponse {
		return &v
	}).(GatewayContractPropertiesResponsePtrOutput)
}

// Gateway description
func (o GatewayContractPropertiesResponseOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GatewayContractPropertiesResponse) *string { return v.Description }).(pulumi.StringPtrOutput)
}

// Gateway location.
func (o GatewayContractPropertiesResponseOutput) LocationData() ResourceLocationDataContractResponsePtrOutput {
	return o.ApplyT(func(v GatewayContractPropertiesResponse) *ResourceLocationDataContractResponse { return v.LocationData }).(ResourceLocationDataContractResponsePtrOutput)
}

type GatewayContractPropertiesResponsePtrOutput struct{ *pulumi.OutputState }

func (GatewayContractPropertiesResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**GatewayContractPropertiesResponse)(nil)).Elem()
}

func (o GatewayContractPropertiesResponsePtrOutput) ToGatewayContractPropertiesResponsePtrOutput() GatewayContractPropertiesResponsePtrOutput {
	return o
}

func (o GatewayContractPropertiesResponsePtrOutput) ToGatewayContractPropertiesResponsePtrOutputWithContext(ctx context.Context) GatewayContractPropertiesResponsePtrOutput {
	return o
}

func (o GatewayContractPropertiesResponsePtrOutput) Elem() GatewayContractPropertiesResponseOutput {
	return o.ApplyT(func(v *GatewayContractPropertiesResponse) GatewayContractPropertiesResponse { return *v }).(GatewayContractPropertiesResponseOutput)
}

// Gateway description
func (o GatewayContractPropertiesResponsePtrOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GatewayContractPropertiesResponse) *string {
		if v == nil {
			return nil
		}
		return v.Description
...
// Gateway location.
func (o GatewayContractPropertiesResponsePtrOutput) LocationData() ResourceLocationDataContractResponsePtrOutput {
	return o.ApplyT(func(v *GatewayContractPropertiesResponse) *ResourceLocationDataContractResponse {
		if v == nil {
			return nil
		}
...
// Gateway hostname configuration details.
type GatewayHostnameConfigurationContractPropertiesResponse struct {
...
// GatewayHostnameConfigurationContractPropertiesResponseInput is an input type that accepts GatewayHostnameConfigurationContractPropertiesResponseArgs and GatewayHostnameConfigurationContractPropertiesResponseOutput values.
// You can construct a concrete instance of `GatewayHostnameConfigurationContractPropertiesResponseInput` via:
//
//          GatewayHostnameConfigurationContractPropertiesResponseArgs{...}
type GatewayHostnameConfigurationContractPropertiesResponseInput interface {
	pulumi.Input

	ToGatewayHostnameConfigurationContractPropertiesResponseOutput() GatewayHostnameConfigurationContractPropertiesResponseOutput
	ToGatewayHostnameConfigurationContractPropertiesResponseOutputWithContext(context.Context) GatewayHostnameConfigurationContractPropertiesResponseOutput
}

// Gateway hostname configuration details.
type GatewayHostnameConfigurationContractPropertiesResponseArgs struct {
	// Identifier of Certificate entity that will be used for TLS connection establishment
...
func (GatewayHostnameConfigurationContractPropertiesResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GatewayHostnameConfigurationContractPropertiesResponse)(nil)).Elem()
}

func (i GatewayHostnameConfigurationContractPropertiesResponseArgs) ToGatewayHostnameConfigurationContractPropertiesResponseOutput() GatewayHostnameConfigurationContractPropertiesResponseOutput {
	return i.ToGatewayHostnameConfigurationContractPropertiesResponseOutputWithContext(context.Background())
}

func (i GatewayHostnameConfigurationContractPropertiesResponseArgs) ToGatewayHostnameConfigurationContractPropertiesResponseOutputWithContext(ctx context.Context) GatewayHostnameConfigurationContractPropertiesResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GatewayHostnameConfigurationContractPropertiesResponseOutput)
}

func (i GatewayHostnameConfigurationContractPropertiesResponseArgs) ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutput() GatewayHostnameConfigurationContractPropertiesResponsePtrOutput {
	return i.ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutputWithContext(context.Background())
}

func (i GatewayHostnameConfigurationContractPropertiesResponseArgs) ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutputWithContext(ctx context.Context) GatewayHostnameConfigurationContractPropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GatewayHostnameConfigurationContractPropertiesResponseOutput).ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutputWithContext(ctx)
}

// GatewayHostnameConfigurationContractPropertiesResponsePtrInput is an input type that accepts GatewayHostnameConfigurationContractPropertiesResponseArgs, GatewayHostnameConfigurationContractPropertiesResponsePtr and GatewayHostnameConfigurationContractPropertiesResponsePtrOutput values.
// You can construct a concrete instance of `GatewayHostnameConfigurationContractPropertiesResponsePtrInput` via:
//
//          GatewayHostnameConfigurationContractPropertiesResponseArgs{...}
//
//  or:
//
//          nil
type GatewayHostnameConfigurationContractPropertiesResponsePtrInput interface {
	pulumi.Input

	ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutput() GatewayHostnameConfigurationContractPropertiesResponsePtrOutput
	ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutputWithContext(context.Context) GatewayHostnameConfigurationContractPropertiesResponsePtrOutput
}

type gatewayHostnameConfigurationContractPropertiesResponsePtrType GatewayHostnameConfigurationContractPropertiesResponseArgs

func GatewayHostnameConfigurationContractPropertiesResponsePtr(v *GatewayHostnameConfigurationContractPropertiesResponseArgs) GatewayHostnameConfigurationContractPropertiesResponsePtrInput {
	return (*gatewayHostnameConfigurationContractPropertiesResponsePtrType)(v)
}

func (*gatewayHostnameConfigurationContractPropertiesResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**GatewayHostnameConfigurationContractPropertiesResponse)(nil)).Elem()
}

func (i *gatewayHostnameConfigurationContractPropertiesResponsePtrType) ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutput() GatewayHostnameConfigurationContractPropertiesResponsePtrOutput {
	return i.ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutputWithContext(context.Background())
}

func (i *gatewayHostnameConfigurationContractPropertiesResponsePtrType) ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutputWithContext(ctx context.Context) GatewayHostnameConfigurationContractPropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GatewayHostnameConfigurationContractPropertiesResponsePtrOutput)
}

// Gateway hostname configuration details.
type GatewayHostnameConfigurationContractPropertiesResponseOutput struct{ *pulumi.OutputState }

func (GatewayHostnameConfigurationContractPropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GatewayHostnameConfigurationContractPropertiesResponse)(nil)).Elem()
}

func (o GatewayHostnameConfigurationContractPropertiesResponseOutput) ToGatewayHostnameConfigurationContractPropertiesResponseOutput() GatewayHostnameConfigurationContractPropertiesResponseOutput {
	return o
}

func (o GatewayHostnameConfigurationContractPropertiesResponseOutput) ToGatewayHostnameConfigurationContractPropertiesResponseOutputWithContext(ctx context.Context) GatewayHostnameConfigurationContractPropertiesResponseOutput {
	return o
}

func (o GatewayHostnameConfigurationContractPropertiesResponseOutput) ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutput() GatewayHostnameConfigurationContractPropertiesResponsePtrOutput {
	return o.ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutputWithContext(context.Background())
}

func (o GatewayHostnameConfigurationContractPropertiesResponseOutput) ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutputWithContext(ctx context.Context) GatewayHostnameConfigurationContractPropertiesResponsePtrOutput {
	return o.ApplyT(func(v GatewayHostnameConfigurationContractPropertiesResponse) *GatewayHostnameConfigurationContractPropertiesResponse {
		return &v
	}).(GatewayHostnameConfigurationContractPropertiesResponsePtrOutput)
}

// Identifier of Certificate entity that will be used for TLS connection establishment
func (o GatewayHostnameConfigurationContractPropertiesResponseOutput) CertificateId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GatewayHostnameConfigurationContractPropertiesResponse) *string { return v.CertificateId }).(pulumi.StringPtrOutput)
}

// Hostname value. Supports valid domain name, partial or full wildcard
func (o GatewayHostnameConfigurationContractPropertiesResponseOutput) Hostname() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GatewayHostnameConfigurationContractPropertiesResponse) *string { return v.Hostname }).(pulumi.StringPtrOutput)
}

// Determines whether gateway requests client certificate
func (o GatewayHostnameConfigurationContractPropertiesResponseOutput) NegotiateClientCertificate() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GatewayHostnameConfigurationContractPropertiesResponse) *bool {
		return v.NegotiateClientCertificate
	}).(pulumi.BoolPtrOutput)
}

type GatewayHostnameConfigurationContractPropertiesResponsePtrOutput struct{ *pulumi.OutputState }

func (GatewayHostnameConfigurationContractPropertiesResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**GatewayHostnameConfigurationContractPropertiesResponse)(nil)).Elem()
}

func (o GatewayHostnameConfigurationContractPropertiesResponsePtrOutput) ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutput() GatewayHostnameConfigurationContractPropertiesResponsePtrOutput {
	return o
}

func (o GatewayHostnameConfigurationContractPropertiesResponsePtrOutput) ToGatewayHostnameConfigurationContractPropertiesResponsePtrOutputWithContext(ctx context.Context) GatewayHostnameConfigurationContractPropertiesResponsePtrOutput {
	return o
}

func (o GatewayHostnameConfigurationContractPropertiesResponsePtrOutput) Elem() GatewayHostnameConfigurationContractPropertiesResponseOutput {
	return o.ApplyT(func(v *GatewayHostnameConfigurationContractPropertiesResponse) GatewayHostnameConfigurationContractPropertiesResponse {
		return *v
	}).(GatewayHostnameConfigurationContractPropertiesResponseOutput)
}
...
// Identifier of Certificate entity that will be used for TLS connection establishment
func (o GatewayHostnameConfigurationContractPropertiesResponsePtrOutput) CertificateId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GatewayHostnameConfigurationContractPropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
// Hostname value. Supports valid domain name, partial or full wildcard
func (o GatewayHostnameConfigurationContractPropertiesResponsePtrOutput) Hostname() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GatewayHostnameConfigurationContractPropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
// Determines whether gateway requests client certificate
func (o GatewayHostnameConfigurationContractPropertiesResponsePtrOutput) NegotiateClientCertificate() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *GatewayHostnameConfigurationContractPropertiesResponse) *bool {
		if v == nil {
			return nil
		}
...
// Client secret of the Application in external Identity Provider, used to authenticate login request. For example, it is App Secret for Facebook login, API Key for Google login, Public Key for Microsoft. This property will not be filled on 'GET' operations! Use '/listSecrets' POST request to get the value.
func (o IdentityProviderContractPropertiesResponseOutput) ClientSecret() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IdentityProviderContractPropertiesResponse) *string { return v.ClientSecret }).(pulumi.StringPtrOutput)
}
...
type NamedValueContractPropertiesResponse struct {
...
// NamedValueContractPropertiesResponseInput is an input type that accepts NamedValueContractPropertiesResponseArgs and NamedValueContractPropertiesResponseOutput values.
// You can construct a concrete instance of `NamedValueContractPropertiesResponseInput` via:
//
//          NamedValueContractPropertiesResponseArgs{...}
type NamedValueContractPropertiesResponseInput interface {
	pulumi.Input

	ToNamedValueContractPropertiesResponseOutput() NamedValueContractPropertiesResponseOutput
	ToNamedValueContractPropertiesResponseOutputWithContext(context.Context) NamedValueContractPropertiesResponseOutput
}

// NamedValue Contract properties.
type NamedValueContractPropertiesResponseArgs struct {
	// Unique name of NamedValue. It may contain only letters, digits, period, dash, and underscore characters.
	DisplayName pulumi.StringInput `pulumi:"displayName"`
	// Determines whether the value is a secret and should be encrypted or not. Default value is false.
...
func (NamedValueContractPropertiesResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*NamedValueContractPropertiesResponse)(nil)).Elem()
}

func (i NamedValueContractPropertiesResponseArgs) ToNamedValueContractPropertiesResponseOutput() NamedValueContractPropertiesResponseOutput {
	return i.ToNamedValueContractPropertiesResponseOutputWithContext(context.Background())
}

func (i NamedValueContractPropertiesResponseArgs) ToNamedValueContractPropertiesResponseOutputWithContext(ctx context.Context) NamedValueContractPropertiesResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NamedValueContractPropertiesResponseOutput)
}

func (i NamedValueContractPropertiesResponseArgs) ToNamedValueContractPropertiesResponsePtrOutput() NamedValueContractPropertiesResponsePtrOutput {
	return i.ToNamedValueContractPropertiesResponsePtrOutputWithContext(context.Background())
}

func (i NamedValueContractPropertiesResponseArgs) ToNamedValueContractPropertiesResponsePtrOutputWithContext(ctx context.Context) NamedValueContractPropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NamedValueContractPropertiesResponseOutput).ToNamedValueContractPropertiesResponsePtrOutputWithContext(ctx)
}

// NamedValueContractPropertiesResponsePtrInput is an input type that accepts NamedValueContractPropertiesResponseArgs, NamedValueContractPropertiesResponsePtr and NamedValueContractPropertiesResponsePtrOutput values.
// You can construct a concrete instance of `NamedValueContractPropertiesResponsePtrInput` via:
//
//          NamedValueContractPropertiesResponseArgs{...}
//
//  or:
//
//          nil
type NamedValueContractPropertiesResponsePtrInput interface {
	pulumi.Input

	ToNamedValueContractPropertiesResponsePtrOutput() NamedValueContractPropertiesResponsePtrOutput
	ToNamedValueContractPropertiesResponsePtrOutputWithContext(context.Context) NamedValueContractPropertiesResponsePtrOutput
}

type namedValueContractPropertiesResponsePtrType NamedValueContractPropertiesResponseArgs

func NamedValueContractPropertiesResponsePtr(v *NamedValueContractPropertiesResponseArgs) NamedValueContractPropertiesResponsePtrInput {
	return (*namedValueContractPropertiesResponsePtrType)(v)
}

func (*namedValueContractPropertiesResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**NamedValueContractPropertiesResponse)(nil)).Elem()
}

func (i *namedValueContractPropertiesResponsePtrType) ToNamedValueContractPropertiesResponsePtrOutput() NamedValueContractPropertiesResponsePtrOutput {
	return i.ToNamedValueContractPropertiesResponsePtrOutputWithContext(context.Background())
}

func (i *namedValueContractPropertiesResponsePtrType) ToNamedValueContractPropertiesResponsePtrOutputWithContext(ctx context.Context) NamedValueContractPropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NamedValueContractPropertiesResponsePtrOutput)
}

// NamedValue Contract properties.
type NamedValueContractPropertiesResponseOutput struct{ *pulumi.OutputState }

func (NamedValueContractPropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*NamedValueContractPropertiesResponse)(nil)).Elem()
}

func (o NamedValueContractPropertiesResponseOutput) ToNamedValueContractPropertiesResponseOutput() NamedValueContractPropertiesResponseOutput {
	return o
}

func (o NamedValueContractPropertiesResponseOutput) ToNamedValueContractPropertiesResponseOutputWithContext(ctx context.Context) NamedValueContractPropertiesResponseOutput {
	return o
}

func (o NamedValueContractPropertiesResponseOutput) ToNamedValueContractPropertiesResponsePtrOutput() NamedValueContractPropertiesResponsePtrOutput {
	return o.ToNamedValueContractPropertiesResponsePtrOutputWithContext(context.Background())
}

func (o NamedValueContractPropertiesResponseOutput) ToNamedValueContractPropertiesResponsePtrOutputWithContext(ctx context.Context) NamedValueContractPropertiesResponsePtrOutput {
	return o.ApplyT(func(v NamedValueContractPropertiesResponse) *NamedValueContractPropertiesResponse {
		return &v
	}).(NamedValueContractPropertiesResponsePtrOutput)
}

// Unique name of NamedValue. It may contain only letters, digits, period, dash, and underscore characters.
func (o NamedValueContractPropertiesResponseOutput) DisplayName() pulumi.StringOutput {
	return o.ApplyT(func(v NamedValueContractPropertiesResponse) string { return v.DisplayName }).(pulumi.StringOutput)
}

// Determines whether the value is a secret and should be encrypted or not. Default value is false.
func (o NamedValueContractPropertiesResponseOutput) Secret() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v NamedValueContractPropertiesResponse) *bool { return v.Secret }).(pulumi.BoolPtrOutput)
}

// Optional tags that when provided can be used to filter the NamedValue list.
func (o NamedValueContractPropertiesResponseOutput) Tags() pulumi.StringArrayOutput {
	return o.ApplyT(func(v NamedValueContractPropertiesResponse) []string { return v.Tags }).(pulumi.StringArrayOutput)
}

// Value of the NamedValue. Can contain policy expressions. It may not be empty or consist only of whitespace. This property will not be filled on 'GET' operations! Use '/listSecrets' POST request to get the value.
func (o NamedValueContractPropertiesResponseOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v NamedValueContractPropertiesResponse) *string { return v.Value }).(pulumi.StringPtrOutput)
}

type NamedValueContractPropertiesResponsePtrOutput struct{ *pulumi.OutputState }

func (NamedValueContractPropertiesResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**NamedValueContractPropertiesResponse)(nil)).Elem()
}

func (o NamedValueContractPropertiesResponsePtrOutput) ToNamedValueContractPropertiesResponsePtrOutput() NamedValueContractPropertiesResponsePtrOutput {
	return o
}

func (o NamedValueContractPropertiesResponsePtrOutput) ToNamedValueContractPropertiesResponsePtrOutputWithContext(ctx context.Context) NamedValueContractPropertiesResponsePtrOutput {
	return o
}

func (o NamedValueContractPropertiesResponsePtrOutput) Elem() NamedValueContractPropertiesResponseOutput {
	return o.ApplyT(func(v *NamedValueContractPropertiesResponse) NamedValueContractPropertiesResponse { return *v }).(NamedValueContractPropertiesResponseOutput)
}

// Unique name of NamedValue. It may contain only letters, digits, period, dash, and underscore characters.
func (o NamedValueContractPropertiesResponsePtrOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NamedValueContractPropertiesResponse) *string {
		if v == nil {
			return nil
		}
		return &v.DisplayName
...
// Determines whether the value is a secret and should be encrypted or not. Default value is false.
func (o NamedValueContractPropertiesResponsePtrOutput) Secret() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *NamedValueContractPropertiesResponse) *bool {
		if v == nil {
			return nil
		}
		return v.Secret
...
// Optional tags that when provided can be used to filter the NamedValue list.
func (o NamedValueContractPropertiesResponsePtrOutput) Tags() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *NamedValueContractPropertiesResponse) []string {
		if v == nil {
			return nil
		}
...
// Value of the NamedValue. Can contain policy expressions. It may not be empty or consist only of whitespace. This property will not be filled on 'GET' operations! Use '/listSecrets' POST request to get the value.
func (o NamedValueContractPropertiesResponsePtrOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NamedValueContractPropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
// Subscription primary key. This property will not be filled on 'GET' operations! Use '/listSecrets' POST request to get the value.
func (o SubscriptionContractPropertiesResponseOutput) PrimaryKey() pulumi.StringPtrOutput {
	return o.ApplyT(func(v SubscriptionContractPropertiesResponse) *string { return v.PrimaryKey }).(pulumi.StringPtrOutput)
}
...
// Subscription secondary key. This property will not be filled on 'GET' operations! Use '/listSecrets' POST request to get the value.
func (o SubscriptionContractPropertiesResponseOutput) SecondaryKey() pulumi.StringPtrOutput {
	return o.ApplyT(func(v SubscriptionContractPropertiesResponse) *string { return v.SecondaryKey }).(pulumi.StringPtrOutput)
}
...
// Identifier of the tag in the form of /tags/{tagId}
func (o TagDescriptionContractPropertiesResponseOutput) TagId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v TagDescriptionContractPropertiesResponse) *string { return v.TagId }).(pulumi.StringPtrOutput)
}
...
// Identifier of the tag in the form of /tags/{tagId}
func (o TagDescriptionContractPropertiesResponsePtrOutput) TagId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *TagDescriptionContractPropertiesResponse) *string {
		if v == nil {
			return nil
		}
