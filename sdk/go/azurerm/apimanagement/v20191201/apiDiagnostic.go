...
func NewApiDiagnostic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20191201:ApiDiagnostic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiDiagnostic(ctx *pulumi.Context,
	...
	var resource ApiDiagnostic
	err := ctx.ReadResource("azurerm:apimanagement/v20191201:ApiDiagnostic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
