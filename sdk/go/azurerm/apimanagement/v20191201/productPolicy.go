...
func NewProductPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:apimanagement/preview:ProductPolicy"),
		},
		{
			Type: pulumi.String("azurerm:apimanagement/v20170301:ProductPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20191201:ProductPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductPolicy(ctx *pulumi.Context,
	...
	var resource ProductPolicy
	err := ctx.ReadResource("azurerm:apimanagement/v20191201:ProductPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
