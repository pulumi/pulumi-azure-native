...
func NewApiOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20191201:ApiOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiOperation(ctx *pulumi.Context,
	...
	var resource ApiOperation
	err := ctx.ReadResource("azurerm:apimanagement/v20191201:ApiOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
