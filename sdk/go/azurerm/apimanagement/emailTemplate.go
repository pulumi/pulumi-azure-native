...
func NewEmailTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement:EmailTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEmailTemplate(ctx *pulumi.Context,
	...
	var resource EmailTemplate
	err := ctx.ReadResource("azurerm:apimanagement:EmailTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
