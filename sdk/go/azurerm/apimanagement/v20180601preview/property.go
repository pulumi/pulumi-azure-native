...
func NewProperty(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:apimanagement/v20161010:Property"),
		},
		{
			Type: pulumi.String("azurerm:apimanagement/v20170301:Property"),
		},
		{
			Type: pulumi.String("azurerm:apimanagement/v20180101:Property"),
		},
		{
			Type: pulumi.String("azurerm:apimanagement/v20190101:Property"),
		},
	})
	opts = append(opts, aliases)
	var resource Property
	err := ctx.RegisterResource("azurerm:apimanagement/v20180601preview:Property", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProperty(ctx *pulumi.Context,
	...
	var resource Property
	err := ctx.ReadResource("azurerm:apimanagement/v20180601preview:Property", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
