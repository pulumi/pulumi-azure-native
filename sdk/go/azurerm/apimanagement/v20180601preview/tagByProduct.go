...
func NewTagByProduct(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:apimanagement/v20190101:TagByProduct"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20180601preview:TagByProduct", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagByProduct(ctx *pulumi.Context,
	...
	var resource TagByProduct
	err := ctx.ReadResource("azurerm:apimanagement/v20180601preview:TagByProduct", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
