...
// 			ContentFormat: pulumi.String("xml"),
// 			PolicyContent: pulumi.String("<policies>\n  <inbound>\n    <rate-limit calls=\"{{call-count}}\" renewal-period=\"15\"></rate-limit>\n    <log-to-eventhub logger-id=\"16\">\n                      @( string.Join(\",\", DateTime.UtcNow, context.Deployment.ServiceName, context.RequestId, context.Request.IpAddress, context.Operation.Name) ) \n                  </log-to-eventhub>\n    <quota-by-key calls=\"40\" counter-key=\"cc\" renewal-period=\"3600\" increment-count=\"@(context.Request.Method == &quot;POST&quot; ? 1:2)\" />\n    <base />\n  </inbound>\n  <backend>\n    <base />\n  </backend>\n  <outbound>\n    <base />\n  </outbound>\n</policies>"),
...
func NewProductPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20180601preview:ProductPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductPolicy(ctx *pulumi.Context,
	...
	var resource ProductPolicy
	err := ctx.ReadResource("azurerm:apimanagement/v20180601preview:ProductPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
