...
func NewLogger(ctx *pulumi.Context,
	...
	var resource Logger
	err := ctx.RegisterResource("azurerm:apimanagement/v20180601preview:Logger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogger(ctx *pulumi.Context,
	...
	var resource Logger
	err := ctx.ReadResource("azurerm:apimanagement/v20180601preview:Logger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
