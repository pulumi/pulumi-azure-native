...
func NewTagDescription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:apimanagement/preview:TagDescription"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20180601preview:TagDescription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagDescription(ctx *pulumi.Context,
	...
	var resource TagDescription
	err := ctx.ReadResource("azurerm:apimanagement/v20180601preview:TagDescription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
