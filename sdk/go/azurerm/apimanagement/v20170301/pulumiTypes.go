...
type ApiContractPropertiesResponseArgs struct {
	...
	// Api Version Set Contract details.
	ApiVersionSet ApiVersionSetContractResponsePtrInput `pulumi:"apiVersionSet"`
	// A resource identifier for the related ApiVersionSet.
...
// Api Version Set Contract details.
func (o ApiContractPropertiesResponseOutput) ApiVersionSet() ApiVersionSetContractResponsePtrOutput {
	return o.ApplyT(func(v ApiContractPropertiesResponse) *ApiVersionSetContractResponse { return v.ApiVersionSet }).(ApiVersionSetContractResponsePtrOutput)
}
...
// Api Version Set Contract details.
func (o ApiContractPropertiesResponsePtrOutput) ApiVersionSet() ApiVersionSetContractResponsePtrOutput {
	return o.ApplyT(func(v *ApiContractPropertiesResponse) *ApiVersionSetContractResponse {
		if v == nil {
			return nil
		}
...
type ApiVersionSetContractResponseArgs struct {
	...
	Name pulumi.StringInput `pulumi:"name"`
	// Properties of an API Version Set.
	Properties ApiVersionSetContractPropertiesResponsePtrInput `pulumi:"properties"`
	// Resource type for API Management resource.
	Type pulumi.StringInput `pulumi:"type"`
}
...
// Properties of an API Version Set.
func (o ApiVersionSetContractResponseOutput) Properties() ApiVersionSetContractPropertiesResponsePtrOutput {
	return o.ApplyT(func(v ApiVersionSetContractResponse) *ApiVersionSetContractPropertiesResponse { return v.Properties }).(ApiVersionSetContractPropertiesResponsePtrOutput)
}
...
// Properties of an API Version Set.
func (o ApiVersionSetContractResponsePtrOutput) Properties() ApiVersionSetContractPropertiesResponsePtrOutput {
	return o.ApplyT(func(v *ApiVersionSetContractResponse) *ApiVersionSetContractPropertiesResponse {
		if v == nil {
			return nil
		}
		return v.Properties
...
type GroupContractResponseArgs struct {
	...
	Name pulumi.StringInput `pulumi:"name"`
	// Group entity contract properties.
	Properties GroupContractPropertiesResponsePtrInput `pulumi:"properties"`
	// Resource type for API Management resource.
	Type pulumi.StringInput `pulumi:"type"`
}
...
// Group entity contract properties.
func (o GroupContractResponseOutput) Properties() GroupContractPropertiesResponsePtrOutput {
	return o.ApplyT(func(v GroupContractResponse) *GroupContractPropertiesResponse { return v.Properties }).(GroupContractPropertiesResponsePtrOutput)
}
...
type LoggerContractPropertiesResponseArgs struct {
	...
	// Sampling settings for an ApplicationInsights logger.
	Sampling LoggerSamplingContractResponsePtrInput `pulumi:"sampling"`
}
...
// Sampling settings for an ApplicationInsights logger.
func (o LoggerContractPropertiesResponseOutput) Sampling() LoggerSamplingContractResponsePtrOutput {
	return o.ApplyT(func(v LoggerContractPropertiesResponse) *LoggerSamplingContractResponse { return v.Sampling }).(LoggerSamplingContractResponsePtrOutput)
}
...
// Sampling settings for an ApplicationInsights logger.
func (o LoggerContractPropertiesResponsePtrOutput) Sampling() LoggerSamplingContractResponsePtrOutput {
	return o.ApplyT(func(v *LoggerContractPropertiesResponse) *LoggerSamplingContractResponse {
		if v == nil {
			return nil
		}
		return v.Sampling
...
type LoggerSamplingContractResponse struct {
	...
	Properties *LoggerSamplingPropertiesResponse `pulumi:"properties"`
}
...
type LoggerSamplingContractResponseArgs struct {
	// Sampling settings entity contract properties.
	Properties LoggerSamplingPropertiesResponsePtrInput `pulumi:"properties"`
}
...
// Sampling settings entity contract properties.
func (o LoggerSamplingContractResponseOutput) Properties() LoggerSamplingPropertiesResponsePtrOutput {
	return o.ApplyT(func(v LoggerSamplingContractResponse) *LoggerSamplingPropertiesResponse { return v.Properties }).(LoggerSamplingPropertiesResponsePtrOutput)
}
...
// Sampling settings entity contract properties.
func (o LoggerSamplingContractResponsePtrOutput) Properties() LoggerSamplingPropertiesResponsePtrOutput {
	return o.ApplyT(func(v *LoggerSamplingContractResponse) *LoggerSamplingPropertiesResponse {
		if v == nil {
			return nil
		}
		return v.Properties
	}).(LoggerSamplingPropertiesResponsePtrOutput)
}

// Sampling settings for an ApplicationInsights logger.
type LoggerSamplingPropertiesResponse struct {
	// Rate re-evaluation interval in ISO8601 format.
	EvaluationInterval *string `pulumi:"evaluationInterval"`
	// Initial sampling rate.
	InitialPercentage *float64 `pulumi:"initialPercentage"`
...
// LoggerSamplingPropertiesResponseInput is an input type that accepts LoggerSamplingPropertiesResponseArgs and LoggerSamplingPropertiesResponseOutput values.
// You can construct a concrete instance of `LoggerSamplingPropertiesResponseInput` via:
//
//          LoggerSamplingPropertiesResponseArgs{...}
type LoggerSamplingPropertiesResponseInput interface {
	pulumi.Input

	ToLoggerSamplingPropertiesResponseOutput() LoggerSamplingPropertiesResponseOutput
	ToLoggerSamplingPropertiesResponseOutputWithContext(context.Context) LoggerSamplingPropertiesResponseOutput
}

// Sampling settings for an ApplicationInsights logger.
type LoggerSamplingPropertiesResponseArgs struct {
	// Rate re-evaluation interval in ISO8601 format.
	EvaluationInterval pulumi.StringPtrInput `pulumi:"evaluationInterval"`
	// Initial sampling rate.
	InitialPercentage pulumi.Float64PtrInput `pulumi:"initialPercentage"`
...
func (LoggerSamplingPropertiesResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LoggerSamplingPropertiesResponse)(nil)).Elem()
}

func (i LoggerSamplingPropertiesResponseArgs) ToLoggerSamplingPropertiesResponseOutput() LoggerSamplingPropertiesResponseOutput {
	return i.ToLoggerSamplingPropertiesResponseOutputWithContext(context.Background())
}

func (i LoggerSamplingPropertiesResponseArgs) ToLoggerSamplingPropertiesResponseOutputWithContext(ctx context.Context) LoggerSamplingPropertiesResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LoggerSamplingPropertiesResponseOutput)
}

func (i LoggerSamplingPropertiesResponseArgs) ToLoggerSamplingPropertiesResponsePtrOutput() LoggerSamplingPropertiesResponsePtrOutput {
	return i.ToLoggerSamplingPropertiesResponsePtrOutputWithContext(context.Background())
}

func (i LoggerSamplingPropertiesResponseArgs) ToLoggerSamplingPropertiesResponsePtrOutputWithContext(ctx context.Context) LoggerSamplingPropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LoggerSamplingPropertiesResponseOutput).ToLoggerSamplingPropertiesResponsePtrOutputWithContext(ctx)
}

// LoggerSamplingPropertiesResponsePtrInput is an input type that accepts LoggerSamplingPropertiesResponseArgs, LoggerSamplingPropertiesResponsePtr and LoggerSamplingPropertiesResponsePtrOutput values.
// You can construct a concrete instance of `LoggerSamplingPropertiesResponsePtrInput` via:
//
//          LoggerSamplingPropertiesResponseArgs{...}
//
//  or:
//
//          nil
type LoggerSamplingPropertiesResponsePtrInput interface {
	pulumi.Input

	ToLoggerSamplingPropertiesResponsePtrOutput() LoggerSamplingPropertiesResponsePtrOutput
	ToLoggerSamplingPropertiesResponsePtrOutputWithContext(context.Context) LoggerSamplingPropertiesResponsePtrOutput
}

type loggerSamplingPropertiesResponsePtrType LoggerSamplingPropertiesResponseArgs

func LoggerSamplingPropertiesResponsePtr(v *LoggerSamplingPropertiesResponseArgs) LoggerSamplingPropertiesResponsePtrInput {
	return (*loggerSamplingPropertiesResponsePtrType)(v)
}

func (*loggerSamplingPropertiesResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**LoggerSamplingPropertiesResponse)(nil)).Elem()
}

func (i *loggerSamplingPropertiesResponsePtrType) ToLoggerSamplingPropertiesResponsePtrOutput() LoggerSamplingPropertiesResponsePtrOutput {
	return i.ToLoggerSamplingPropertiesResponsePtrOutputWithContext(context.Background())
}

func (i *loggerSamplingPropertiesResponsePtrType) ToLoggerSamplingPropertiesResponsePtrOutputWithContext(ctx context.Context) LoggerSamplingPropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LoggerSamplingPropertiesResponsePtrOutput)
}

// Sampling settings for an ApplicationInsights logger.
type LoggerSamplingPropertiesResponseOutput struct{ *pulumi.OutputState }

func (LoggerSamplingPropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LoggerSamplingPropertiesResponse)(nil)).Elem()
}

func (o LoggerSamplingPropertiesResponseOutput) ToLoggerSamplingPropertiesResponseOutput() LoggerSamplingPropertiesResponseOutput {
	return o
}

func (o LoggerSamplingPropertiesResponseOutput) ToLoggerSamplingPropertiesResponseOutputWithContext(ctx context.Context) LoggerSamplingPropertiesResponseOutput {
	return o
}

func (o LoggerSamplingPropertiesResponseOutput) ToLoggerSamplingPropertiesResponsePtrOutput() LoggerSamplingPropertiesResponsePtrOutput {
	return o.ToLoggerSamplingPropertiesResponsePtrOutputWithContext(context.Background())
}

func (o LoggerSamplingPropertiesResponseOutput) ToLoggerSamplingPropertiesResponsePtrOutputWithContext(ctx context.Context) LoggerSamplingPropertiesResponsePtrOutput {
	return o.ApplyT(func(v LoggerSamplingPropertiesResponse) *LoggerSamplingPropertiesResponse {
		return &v
	}).(LoggerSamplingPropertiesResponsePtrOutput)
}

// Rate re-evaluation interval in ISO8601 format.
func (o LoggerSamplingPropertiesResponseOutput) EvaluationInterval() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LoggerSamplingPropertiesResponse) *string { return v.EvaluationInterval }).(pulumi.StringPtrOutput)
}

// Initial sampling rate.
func (o LoggerSamplingPropertiesResponseOutput) InitialPercentage() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v LoggerSamplingPropertiesResponse) *float64 { return v.InitialPercentage }).(pulumi.Float64PtrOutput)
}

// Maximum allowed rate of sampling.
func (o LoggerSamplingPropertiesResponseOutput) MaxPercentage() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v LoggerSamplingPropertiesResponse) *float64 { return v.MaxPercentage }).(pulumi.Float64PtrOutput)
}

// Target rate of telemetry items per second.
func (o LoggerSamplingPropertiesResponseOutput) MaxTelemetryItemsPerSecond() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LoggerSamplingPropertiesResponse) *int { return v.MaxTelemetryItemsPerSecond }).(pulumi.IntPtrOutput)
}

// Minimum allowed rate of sampling.
func (o LoggerSamplingPropertiesResponseOutput) MinPercentage() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v LoggerSamplingPropertiesResponse) *float64 { return v.MinPercentage }).(pulumi.Float64PtrOutput)
}

// Moving average ration assigned to most recent value.
func (o LoggerSamplingPropertiesResponseOutput) MovingAverageRatio() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v LoggerSamplingPropertiesResponse) *float64 { return v.MovingAverageRatio }).(pulumi.Float64PtrOutput)
}

// Rate of sampling for fixed-rate sampling.
func (o LoggerSamplingPropertiesResponseOutput) Percentage() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v LoggerSamplingPropertiesResponse) *float64 { return v.Percentage }).(pulumi.Float64PtrOutput)
}

// Duration in ISO8601 format after which it's allowed to lower the sampling rate.
func (o LoggerSamplingPropertiesResponseOutput) PercentageDecreaseTimeout() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LoggerSamplingPropertiesResponse) *string { return v.PercentageDecreaseTimeout }).(pulumi.StringPtrOutput)
}

// Duration in ISO8601 format after which it's allowed to increase the sampling rate.
func (o LoggerSamplingPropertiesResponseOutput) PercentageIncreaseTimeout() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LoggerSamplingPropertiesResponse) *string { return v.PercentageIncreaseTimeout }).(pulumi.StringPtrOutput)
}

// Sampling type.
func (o LoggerSamplingPropertiesResponseOutput) SamplingType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LoggerSamplingPropertiesResponse) *string { return v.SamplingType }).(pulumi.StringPtrOutput)
}

type LoggerSamplingPropertiesResponsePtrOutput struct{ *pulumi.OutputState }

func (LoggerSamplingPropertiesResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**LoggerSamplingPropertiesResponse)(nil)).Elem()
}

func (o LoggerSamplingPropertiesResponsePtrOutput) ToLoggerSamplingPropertiesResponsePtrOutput() LoggerSamplingPropertiesResponsePtrOutput {
	return o
}

func (o LoggerSamplingPropertiesResponsePtrOutput) ToLoggerSamplingPropertiesResponsePtrOutputWithContext(ctx context.Context) LoggerSamplingPropertiesResponsePtrOutput {
	return o
}

func (o LoggerSamplingPropertiesResponsePtrOutput) Elem() LoggerSamplingPropertiesResponseOutput {
	return o.ApplyT(func(v *LoggerSamplingPropertiesResponse) LoggerSamplingPropertiesResponse { return *v }).(LoggerSamplingPropertiesResponseOutput)
}

// Rate re-evaluation interval in ISO8601 format.
func (o LoggerSamplingPropertiesResponsePtrOutput) EvaluationInterval() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LoggerSamplingPropertiesResponse) *string {
		if v == nil {
			return nil
		}
		return v.EvaluationInterval
...
// Initial sampling rate.
func (o LoggerSamplingPropertiesResponsePtrOutput) InitialPercentage() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *LoggerSamplingPropertiesResponse) *float64 {
		if v == nil {
			return nil
		}
		return v.InitialPercentage
...
// Maximum allowed rate of sampling.
func (o LoggerSamplingPropertiesResponsePtrOutput) MaxPercentage() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *LoggerSamplingPropertiesResponse) *float64 {
		if v == nil {
			return nil
		}
...
// Target rate of telemetry items per second.
func (o LoggerSamplingPropertiesResponsePtrOutput) MaxTelemetryItemsPerSecond() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *LoggerSamplingPropertiesResponse) *int {
		if v == nil {
			return nil
		}
		return v.MaxTelemetryItemsPerSecond
...
// Minimum allowed rate of sampling.
func (o LoggerSamplingPropertiesResponsePtrOutput) MinPercentage() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *LoggerSamplingPropertiesResponse) *float64 {
		if v == nil {
			return nil
		}
...
// Moving average ration assigned to most recent value.
func (o LoggerSamplingPropertiesResponsePtrOutput) MovingAverageRatio() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *LoggerSamplingPropertiesResponse) *float64 {
		if v == nil {
			return nil
		}
...
// Rate of sampling for fixed-rate sampling.
func (o LoggerSamplingPropertiesResponsePtrOutput) Percentage() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *LoggerSamplingPropertiesResponse) *float64 {
		if v == nil {
			return nil
		}
...
// Duration in ISO8601 format after which it's allowed to lower the sampling rate.
func (o LoggerSamplingPropertiesResponsePtrOutput) PercentageDecreaseTimeout() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LoggerSamplingPropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
// Duration in ISO8601 format after which it's allowed to increase the sampling rate.
func (o LoggerSamplingPropertiesResponsePtrOutput) PercentageIncreaseTimeout() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LoggerSamplingPropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
// Sampling type.
func (o LoggerSamplingPropertiesResponsePtrOutput) SamplingType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LoggerSamplingPropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
type UserContractPropertiesResponseArgs struct {
	...
	// Collection of groups user is part of.
	Groups GroupContractResponseArrayInput `pulumi:"groups"`
	// Collection of user identities.
...
// Collection of groups user is part of.
func (o UserContractPropertiesResponseOutput) Groups() GroupContractResponseArrayOutput {
	return o.ApplyT(func(v UserContractPropertiesResponse) []GroupContractResponse { return v.Groups }).(GroupContractResponseArrayOutput)
}
...
// Collection of groups user is part of.
func (o UserContractPropertiesResponsePtrOutput) Groups() GroupContractResponseArrayOutput {
	return o.ApplyT(func(v *UserContractPropertiesResponse) []GroupContractResponse {
		if v == nil {
			return nil
		}
		return v.Groups
	}).(GroupContractResponseArrayOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(LoggerSamplingPropertiesResponseOutput{})
	pulumi.RegisterOutputType(LoggerSamplingPropertiesResponsePtrOutput{})
