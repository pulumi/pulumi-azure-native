...
func NewApiVersionSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20170301:ApiVersionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiVersionSet(ctx *pulumi.Context,
	...
	var resource ApiVersionSet
	err := ctx.ReadResource("azurerm:apimanagement/v20170301:ApiVersionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
