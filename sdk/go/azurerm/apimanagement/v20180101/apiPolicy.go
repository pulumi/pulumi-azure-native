...
// 		_, err := apimanagement.NewApiPolicy(ctx, "apiPolicy", &apimanagement.ApiPolicyArgs{
// 			ApiId:         pulumi.String("5600b57e7e8880006a040001"),
// 			ContentFormat: pulumi.String("rawxml"),
...
func NewApiPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20180101:ApiPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiPolicy(ctx *pulumi.Context,
	...
	var resource ApiPolicy
	err := ctx.ReadResource("azurerm:apimanagement/v20180101:ApiPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
