...
func NewTag(ctx *pulumi.Context,
	...
	var resource Tag
	err := ctx.RegisterResource("azurerm:apimanagement/v20180101:Tag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTag(ctx *pulumi.Context,
	...
	var resource Tag
	err := ctx.ReadResource("azurerm:apimanagement/v20180101:Tag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
