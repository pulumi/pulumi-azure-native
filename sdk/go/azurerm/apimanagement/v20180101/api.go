...
// 	pulumi.Run(func(ctx *pulumi.Context) error {
// 		_, err := apimanagement.NewApi(ctx, "api", &apimanagement.ApiArgs{
// 			ApiId:                  pulumi.String("echo-api;rev=4"),
// 			ApiRevisionDescription: pulumi.String("moved to swagger petstore backend"),
...
// 			DisplayName:            pulumi.String("Echo API"),
...
// 			ResourceGroupName: pulumi.String("rg1"),
// 			ServiceName:       pulumi.String("apimService1"),
// 			ServiceUrl:        pulumi.String("http://petstore.swagger.io/v5"),
// 			SubscriptionKeyParameterNames: &apimanagement.SubscriptionKeyParameterNamesContractArgs{
...
func NewApi(ctx *pulumi.Context,
	...
	var resource Api
	err := ctx.RegisterResource("azurerm:apimanagement/v20180101:Api", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApi(ctx *pulumi.Context,
	...
	var resource Api
	err := ctx.ReadResource("azurerm:apimanagement/v20180101:Api", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
