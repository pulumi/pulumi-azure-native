...
// Indicates if API revision is current api revision.
func (o ApiContractPropertiesResponseOutput) IsCurrent() pulumi.BoolOutput {
	return o.ApplyT(func(v ApiContractPropertiesResponse) bool { return v.IsCurrent }).(pulumi.BoolOutput)
}
...
// Indicates whether a diagnostic should receive data or not.
func (o DiagnosticContractPropertiesResponseOutput) Enabled() pulumi.BoolOutput {
	return o.ApplyT(func(v DiagnosticContractPropertiesResponse) bool { return v.Enabled }).(pulumi.BoolOutput)
}
...
// Indicates whether a diagnostic should receive data or not.
func (o DiagnosticContractPropertiesResponsePtrOutput) Enabled() pulumi.BoolPtrOutput {
...
type PolicyContractPropertiesResponseArgs struct {
	// Format of the policyContent.
	ContentFormat pulumi.StringPtrInput `pulumi:"contentFormat"`
	// Json escaped Xml Encoded contents of the Policy.
	PolicyContent pulumi.StringInput `pulumi:"policyContent"`
}
...
// Format of the policyContent.
func (o PolicyContractPropertiesResponseOutput) ContentFormat() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PolicyContractPropertiesResponse) *string { return v.ContentFormat }).(pulumi.StringPtrOutput)
}

// Json escaped Xml Encoded contents of the Policy.
func (o PolicyContractPropertiesResponseOutput) PolicyContent() pulumi.StringOutput {
	return o.ApplyT(func(v PolicyContractPropertiesResponse) string { return v.PolicyContent }).(pulumi.StringOutput)
}
...
// Format of the policyContent.
func (o PolicyContractPropertiesResponsePtrOutput) ContentFormat() pulumi.StringPtrOutput {
...
// Json escaped Xml Encoded contents of the Policy.
func (o PolicyContractPropertiesResponsePtrOutput) PolicyContent() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PolicyContractPropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
type SchemaContractPropertiesResponse struct {
	...
	Document *SchemaDocumentPropertiesResponse `pulumi:"document"`
}
...
type SchemaContractPropertiesResponseArgs struct {
	...
	ContentType pulumi.StringInput `pulumi:"contentType"`
	// Properties of the Schema Document.
	Document SchemaDocumentPropertiesResponsePtrInput `pulumi:"document"`
}
...
// Properties of the Schema Document.
func (o SchemaContractPropertiesResponseOutput) Document() SchemaDocumentPropertiesResponsePtrOutput {
	return o.ApplyT(func(v SchemaContractPropertiesResponse) *SchemaDocumentPropertiesResponse { return v.Document }).(SchemaDocumentPropertiesResponsePtrOutput)
}
...
// Properties of the Schema Document.
func (o SchemaContractPropertiesResponsePtrOutput) Document() SchemaDocumentPropertiesResponsePtrOutput {
	return o.ApplyT(func(v *SchemaContractPropertiesResponse) *SchemaDocumentPropertiesResponse {
		if v == nil {
			return nil
		}
		return v.Document
	}).(SchemaDocumentPropertiesResponsePtrOutput)
}
...
// SchemaDocumentPropertiesResponseInput is an input type that accepts SchemaDocumentPropertiesResponseArgs and SchemaDocumentPropertiesResponseOutput values.
// You can construct a concrete instance of `SchemaDocumentPropertiesResponseInput` via:
//
//          SchemaDocumentPropertiesResponseArgs{...}
type SchemaDocumentPropertiesResponseInput interface {
	pulumi.Input

	ToSchemaDocumentPropertiesResponseOutput() SchemaDocumentPropertiesResponseOutput
	ToSchemaDocumentPropertiesResponseOutputWithContext(context.Context) SchemaDocumentPropertiesResponseOutput
}
...
func (SchemaDocumentPropertiesResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*SchemaDocumentPropertiesResponse)(nil)).Elem()
}

func (i SchemaDocumentPropertiesResponseArgs) ToSchemaDocumentPropertiesResponseOutput() SchemaDocumentPropertiesResponseOutput {
	return i.ToSchemaDocumentPropertiesResponseOutputWithContext(context.Background())
}

func (i SchemaDocumentPropertiesResponseArgs) ToSchemaDocumentPropertiesResponseOutputWithContext(ctx context.Context) SchemaDocumentPropertiesResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SchemaDocumentPropertiesResponseOutput)
}

func (i SchemaDocumentPropertiesResponseArgs) ToSchemaDocumentPropertiesResponsePtrOutput() SchemaDocumentPropertiesResponsePtrOutput {
	return i.ToSchemaDocumentPropertiesResponsePtrOutputWithContext(context.Background())
}

func (i SchemaDocumentPropertiesResponseArgs) ToSchemaDocumentPropertiesResponsePtrOutputWithContext(ctx context.Context) SchemaDocumentPropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SchemaDocumentPropertiesResponseOutput).ToSchemaDocumentPropertiesResponsePtrOutputWithContext(ctx)
}

// SchemaDocumentPropertiesResponsePtrInput is an input type that accepts SchemaDocumentPropertiesResponseArgs, SchemaDocumentPropertiesResponsePtr and SchemaDocumentPropertiesResponsePtrOutput values.
// You can construct a concrete instance of `SchemaDocumentPropertiesResponsePtrInput` via:
//
//          SchemaDocumentPropertiesResponseArgs{...}
//
//  or:
//
//          nil
type SchemaDocumentPropertiesResponsePtrInput interface {
	pulumi.Input

	ToSchemaDocumentPropertiesResponsePtrOutput() SchemaDocumentPropertiesResponsePtrOutput
	ToSchemaDocumentPropertiesResponsePtrOutputWithContext(context.Context) SchemaDocumentPropertiesResponsePtrOutput
}

type schemaDocumentPropertiesResponsePtrType SchemaDocumentPropertiesResponseArgs

func SchemaDocumentPropertiesResponsePtr(v *SchemaDocumentPropertiesResponseArgs) SchemaDocumentPropertiesResponsePtrInput {
	return (*schemaDocumentPropertiesResponsePtrType)(v)
}

func (*schemaDocumentPropertiesResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**SchemaDocumentPropertiesResponse)(nil)).Elem()
}

func (i *schemaDocumentPropertiesResponsePtrType) ToSchemaDocumentPropertiesResponsePtrOutput() SchemaDocumentPropertiesResponsePtrOutput {
	return i.ToSchemaDocumentPropertiesResponsePtrOutputWithContext(context.Background())
}

func (i *schemaDocumentPropertiesResponsePtrType) ToSchemaDocumentPropertiesResponsePtrOutputWithContext(ctx context.Context) SchemaDocumentPropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SchemaDocumentPropertiesResponsePtrOutput)
}

// Schema Document Properties.
type SchemaDocumentPropertiesResponseOutput struct{ *pulumi.OutputState }

func (SchemaDocumentPropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*SchemaDocumentPropertiesResponse)(nil)).Elem()
}

func (o SchemaDocumentPropertiesResponseOutput) ToSchemaDocumentPropertiesResponseOutput() SchemaDocumentPropertiesResponseOutput {
	return o
}

func (o SchemaDocumentPropertiesResponseOutput) ToSchemaDocumentPropertiesResponseOutputWithContext(ctx context.Context) SchemaDocumentPropertiesResponseOutput {
	return o
}

func (o SchemaDocumentPropertiesResponseOutput) ToSchemaDocumentPropertiesResponsePtrOutput() SchemaDocumentPropertiesResponsePtrOutput {
	return o.ToSchemaDocumentPropertiesResponsePtrOutputWithContext(context.Background())
}

func (o SchemaDocumentPropertiesResponseOutput) ToSchemaDocumentPropertiesResponsePtrOutputWithContext(ctx context.Context) SchemaDocumentPropertiesResponsePtrOutput {
	return o.ApplyT(func(v SchemaDocumentPropertiesResponse) *SchemaDocumentPropertiesResponse {
		return &v
	}).(SchemaDocumentPropertiesResponsePtrOutput)
}

// Json escaped string defining the document representing the Schema.
func (o SchemaDocumentPropertiesResponseOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v SchemaDocumentPropertiesResponse) *string { return v.Value }).(pulumi.StringPtrOutput)
}

type SchemaDocumentPropertiesResponsePtrOutput struct{ *pulumi.OutputState }

func (SchemaDocumentPropertiesResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**SchemaDocumentPropertiesResponse)(nil)).Elem()
}

func (o SchemaDocumentPropertiesResponsePtrOutput) ToSchemaDocumentPropertiesResponsePtrOutput() SchemaDocumentPropertiesResponsePtrOutput {
	return o
}

func (o SchemaDocumentPropertiesResponsePtrOutput) ToSchemaDocumentPropertiesResponsePtrOutputWithContext(ctx context.Context) SchemaDocumentPropertiesResponsePtrOutput {
	return o
}

func (o SchemaDocumentPropertiesResponsePtrOutput) Elem() SchemaDocumentPropertiesResponseOutput {
	return o.ApplyT(func(v *SchemaDocumentPropertiesResponse) SchemaDocumentPropertiesResponse { return *v }).(SchemaDocumentPropertiesResponseOutput)
}

// Json escaped string defining the document representing the Schema.
func (o SchemaDocumentPropertiesResponsePtrOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SchemaDocumentPropertiesResponse) *string {
		if v == nil {
			return nil
		}
		return v.Value
...
// The product resource identifier of the subscribed product. The value is a valid relative URL in the format of /products/{productId} where {productId} is a product identifier.
func (o SubscriptionContractPropertiesResponseOutput) ProductId() pulumi.StringOutput {
	return o.ApplyT(func(v SubscriptionContractPropertiesResponse) string { return v.ProductId }).(pulumi.StringOutput)
}
...
// The user resource identifier of the subscription owner. The value is a valid relative URL in the format of /users/{uid} where {uid} is a user identifier.
func (o SubscriptionContractPropertiesResponseOutput) UserId() pulumi.StringOutput {
	return o.ApplyT(func(v SubscriptionContractPropertiesResponse) string { return v.UserId }).(pulumi.StringOutput)
}
...
// The product resource identifier of the subscribed product. The value is a valid relative URL in the format of /products/{productId} where {productId} is a product identifier.
func (o SubscriptionContractPropertiesResponsePtrOutput) ProductId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SubscriptionContractPropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
// The user resource identifier of the subscription owner. The value is a valid relative URL in the format of /users/{uid} where {uid} is a user identifier.
func (o SubscriptionContractPropertiesResponsePtrOutput) UserId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SubscriptionContractPropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
// Contract details.
type TagDescriptionType struct {
	// Resource name.
	Name string `pulumi:"name"`
...
// TagDescriptionTypeInput is an input type that accepts TagDescriptionTypeArgs and TagDescriptionTypeOutput values.
// You can construct a concrete instance of `TagDescriptionTypeInput` via:
//
//          TagDescriptionTypeArgs{...}
type TagDescriptionTypeInput interface {
	pulumi.Input

	ToTagDescriptionTypeOutput() TagDescriptionTypeOutput
	ToTagDescriptionTypeOutputWithContext(context.Context) TagDescriptionTypeOutput
}

// Contract details.
type TagDescriptionTypeArgs struct {
	// Resource name.
	Name pulumi.StringInput `pulumi:"name"`
	// TagDescription entity contract properties.
...
func (TagDescriptionTypeArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*TagDescriptionType)(nil)).Elem()
}

func (i TagDescriptionTypeArgs) ToTagDescriptionTypeOutput() TagDescriptionTypeOutput {
	return i.ToTagDescriptionTypeOutputWithContext(context.Background())
}

func (i TagDescriptionTypeArgs) ToTagDescriptionTypeOutputWithContext(ctx context.Context) TagDescriptionTypeOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TagDescriptionTypeOutput)
}

// Contract details.
type TagDescriptionTypeOutput struct{ *pulumi.OutputState }

func (TagDescriptionTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*TagDescriptionType)(nil)).Elem()
}

func (o TagDescriptionTypeOutput) ToTagDescriptionTypeOutput() TagDescriptionTypeOutput {
	return o
}

func (o TagDescriptionTypeOutput) ToTagDescriptionTypeOutputWithContext(ctx context.Context) TagDescriptionTypeOutput {
	return o
}

// Resource name.
func (o TagDescriptionTypeOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v TagDescriptionType) string { return v.Name }).(pulumi.StringOutput)
}

// TagDescription entity contract properties.
func (o TagDescriptionTypeOutput) Properties() TagDescriptionContractPropertiesResponseOutput {
	return o.ApplyT(func(v TagDescriptionType) TagDescriptionContractPropertiesResponse { return v.Properties }).(TagDescriptionContractPropertiesResponseOutput)
}

// Resource type for API Management resource.
func (o TagDescriptionTypeOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v TagDescriptionType) string { return v.Type }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(TagDescriptionTypeOutput{})
