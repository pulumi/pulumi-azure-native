...
func NewProperty(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20180101:Property", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProperty(ctx *pulumi.Context,
	...
	var resource Property
	err := ctx.ReadResource("azurerm:apimanagement/v20180101:Property", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
