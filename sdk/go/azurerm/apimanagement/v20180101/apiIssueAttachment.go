...
func NewApiIssueAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20180101:ApiIssueAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIssueAttachment(ctx *pulumi.Context,
	...
	var resource ApiIssueAttachment
	err := ctx.ReadResource("azurerm:apimanagement/v20180101:ApiIssueAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
