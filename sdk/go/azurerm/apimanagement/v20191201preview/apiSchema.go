...
func NewApiSchema(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20191201preview:ApiSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiSchema(ctx *pulumi.Context,
	...
	var resource ApiSchema
	err := ctx.ReadResource("azurerm:apimanagement/v20191201preview:ApiSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
