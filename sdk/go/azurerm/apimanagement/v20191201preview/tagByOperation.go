...
func NewTagByOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20191201preview:TagByOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagByOperation(ctx *pulumi.Context,
	...
	var resource TagByOperation
	err := ctx.ReadResource("azurerm:apimanagement/v20191201preview:TagByOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
