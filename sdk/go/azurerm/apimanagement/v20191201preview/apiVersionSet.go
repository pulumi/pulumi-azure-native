...
func NewApiVersionSet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:apimanagement/v20180101:ApiVersionSet"),
		},
		{
			Type: pulumi.String("azurerm:apimanagement/v20180601preview:ApiVersionSet"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20191201preview:ApiVersionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiVersionSet(ctx *pulumi.Context,
	...
	var resource ApiVersionSet
	err := ctx.ReadResource("azurerm:apimanagement/v20191201preview:ApiVersionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
