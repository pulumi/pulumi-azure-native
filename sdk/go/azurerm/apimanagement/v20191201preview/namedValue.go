...
func NewNamedValue(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/v20191201preview:NamedValue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamedValue(ctx *pulumi.Context,
	...
	var resource NamedValue
	err := ctx.ReadResource("azurerm:apimanagement/v20191201preview:NamedValue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
