...
func NewIdentityProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/latest:IdentityProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentityProvider(ctx *pulumi.Context,
	...
	var resource IdentityProvider
	err := ctx.ReadResource("azurerm:apimanagement/latest:IdentityProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
