...
func NewBackend(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/latest:Backend", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackend(ctx *pulumi.Context,
	...
	var resource Backend
	err := ctx.ReadResource("azurerm:apimanagement/latest:Backend", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
