...
func NewEmailTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/latest:EmailTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEmailTemplate(ctx *pulumi.Context,
	...
	var resource EmailTemplate
	err := ctx.ReadResource("azurerm:apimanagement/latest:EmailTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
