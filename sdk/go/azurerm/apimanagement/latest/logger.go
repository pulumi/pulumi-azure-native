...
func NewLogger(ctx *pulumi.Context,
	...
	var resource Logger
	err := ctx.RegisterResource("azurerm:apimanagement/latest:Logger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogger(ctx *pulumi.Context,
	...
	var resource Logger
	err := ctx.ReadResource("azurerm:apimanagement/latest:Logger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
