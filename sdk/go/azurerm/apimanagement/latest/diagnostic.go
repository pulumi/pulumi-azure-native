...
func NewDiagnostic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/latest:Diagnostic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiagnostic(ctx *pulumi.Context,
	...
	var resource Diagnostic
	err := ctx.ReadResource("azurerm:apimanagement/latest:Diagnostic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
