...
func NewProduct(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/latest:Product", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProduct(ctx *pulumi.Context,
	...
	var resource Product
	err := ctx.ReadResource("azurerm:apimanagement/latest:Product", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
