...
func NewApiOperationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/latest:ApiOperationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiOperationPolicy(ctx *pulumi.Context,
	...
	var resource ApiOperationPolicy
	err := ctx.ReadResource("azurerm:apimanagement/latest:ApiOperationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
