...
func NewContentType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:apimanagement/latest:ContentType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentType(ctx *pulumi.Context,
	...
	var resource ContentType
	err := ctx.ReadResource("azurerm:apimanagement/latest:ContentType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
