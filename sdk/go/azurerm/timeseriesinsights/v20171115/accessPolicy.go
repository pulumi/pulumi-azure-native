...
func NewAccessPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:timeseriesinsights/v20171115:AccessPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessPolicy(ctx *pulumi.Context,
	...
	var resource AccessPolicy
	err := ctx.ReadResource("azurerm:timeseriesinsights/v20171115:AccessPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
