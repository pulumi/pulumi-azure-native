...
func NewReferenceDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:timeseriesinsights/v20200515:ReferenceDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReferenceDataSet(ctx *pulumi.Context,
	...
	var resource ReferenceDataSet
	err := ctx.ReadResource("azurerm:timeseriesinsights/v20200515:ReferenceDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
