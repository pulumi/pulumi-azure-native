...
func NewEventSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:timeseriesinsights/v20180815preview:EventSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventSource(ctx *pulumi.Context,
	...
	var resource EventSource
	err := ctx.ReadResource("azurerm:timeseriesinsights/v20180815preview:EventSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
