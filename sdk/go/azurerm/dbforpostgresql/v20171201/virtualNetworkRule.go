...
//
// import (
// 	dbforpostgresql "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/dbforpostgresql/v20171201"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewVirtualNetworkRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:dbforpostgresql/latest:VirtualNetworkRule"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:dbforpostgresql/v20171201:VirtualNetworkRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkRule(ctx *pulumi.Context,
	...
	var resource VirtualNetworkRule
	err := ctx.ReadResource("azurerm:dbforpostgresql/v20171201:VirtualNetworkRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
