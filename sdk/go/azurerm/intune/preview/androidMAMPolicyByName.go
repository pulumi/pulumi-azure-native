...
func NewAndroidMAMPolicyByName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:intune/preview:AndroidMAMPolicyByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAndroidMAMPolicyByName(ctx *pulumi.Context,
	...
	var resource AndroidMAMPolicyByName
	err := ctx.ReadResource("azurerm:intune/preview:AndroidMAMPolicyByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
