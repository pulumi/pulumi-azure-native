...
func NewIoMAMPolicyByName(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:intune/latest:IoMAMPolicyByName"),
		},
		{
			Type: pulumi.String("azurerm:intune/v20150114privatepreview:IoMAMPolicyByName"),
		},
	})
	opts = append(opts, aliases)
	var resource IoMAMPolicyByName
	err := ctx.RegisterResource("azurerm:intune/v20150114preview:IoMAMPolicyByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIoMAMPolicyByName(ctx *pulumi.Context,
	...
	var resource IoMAMPolicyByName
	err := ctx.ReadResource("azurerm:intune/v20150114preview:IoMAMPolicyByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
