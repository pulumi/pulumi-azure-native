...
func NewIoMAMPolicyByName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:intune/v20150114privatepreview:IoMAMPolicyByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIoMAMPolicyByName(ctx *pulumi.Context,
	...
	var resource IoMAMPolicyByName
	err := ctx.ReadResource("azurerm:intune/v20150114privatepreview:IoMAMPolicyByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
