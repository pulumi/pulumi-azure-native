...
func NewAndroidMAMPolicyByName(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:intune/preview:AndroidMAMPolicyByName"),
		},
		{
			Type: pulumi.String("azurerm:intune/v20150114preview:AndroidMAMPolicyByName"),
		},
	})
	opts = append(opts, aliases)
	var resource AndroidMAMPolicyByName
	err := ctx.RegisterResource("azurerm:intune/v20150114privatepreview:AndroidMAMPolicyByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAndroidMAMPolicyByName(ctx *pulumi.Context,
	...
	var resource AndroidMAMPolicyByName
	err := ctx.ReadResource("azurerm:intune/v20150114privatepreview:AndroidMAMPolicyByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
