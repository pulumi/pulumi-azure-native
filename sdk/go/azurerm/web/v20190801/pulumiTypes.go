...
// CNAME of the certificate to be issued via free certificate
func (o CertificateResponsePropertiesOutput) CanonicalName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CertificateResponseProperties) *string { return v.CanonicalName }).(pulumi.StringPtrOutput)
}
...
// CNAME of the certificate to be issued via free certificate
func (o CertificateResponsePropertiesPtrOutput) CanonicalName() pulumi.StringPtrOutput {
...
// StaticSiteResponseInput is an input type that accepts StaticSiteResponseArgs and StaticSiteResponseOutput values.
// You can construct a concrete instance of `StaticSiteResponseInput` via:
//
//          StaticSiteResponseArgs{...}
type StaticSiteResponseInput interface {
	pulumi.Input

	ToStaticSiteResponseOutput() StaticSiteResponseOutput
	ToStaticSiteResponseOutputWithContext(context.Context) StaticSiteResponseOutput
}

// A static site.
type StaticSiteResponseArgs struct {
	// The target branch in the repository.
	Branch pulumi.StringPtrInput `pulumi:"branch"`
	// Build properties to configure on the repository.
	BuildProperties StaticSiteBuildPropertiesResponsePtrInput `pulumi:"buildProperties"`
	// The custom domains associated with this static site.
	CustomDomains pulumi.StringArrayInput `pulumi:"customDomains"`
	// The default autogenerated hostname for the static site.
	DefaultHostname pulumi.StringInput `pulumi:"defaultHostname"`
	// A user's github repository token. This is used to setup the Github Actions workflow file and API secrets.
	RepositoryToken pulumi.StringPtrInput `pulumi:"repositoryToken"`
	// URL for the repository of the static site.
	RepositoryUrl pulumi.StringPtrInput `pulumi:"repositoryUrl"`
}

func (StaticSiteResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*StaticSiteResponse)(nil)).Elem()
}

func (i StaticSiteResponseArgs) ToStaticSiteResponseOutput() StaticSiteResponseOutput {
	return i.ToStaticSiteResponseOutputWithContext(context.Background())
}

func (i StaticSiteResponseArgs) ToStaticSiteResponseOutputWithContext(ctx context.Context) StaticSiteResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StaticSiteResponseOutput)
}

func (i StaticSiteResponseArgs) ToStaticSiteResponsePtrOutput() StaticSiteResponsePtrOutput {
	return i.ToStaticSiteResponsePtrOutputWithContext(context.Background())
}

func (i StaticSiteResponseArgs) ToStaticSiteResponsePtrOutputWithContext(ctx context.Context) StaticSiteResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StaticSiteResponseOutput).ToStaticSiteResponsePtrOutputWithContext(ctx)
}

// StaticSiteResponsePtrInput is an input type that accepts StaticSiteResponseArgs, StaticSiteResponsePtr and StaticSiteResponsePtrOutput values.
// You can construct a concrete instance of `StaticSiteResponsePtrInput` via:
//
//          StaticSiteResponseArgs{...}
//
//  or:
//
//          nil
type StaticSiteResponsePtrInput interface {
	pulumi.Input

	ToStaticSiteResponsePtrOutput() StaticSiteResponsePtrOutput
	ToStaticSiteResponsePtrOutputWithContext(context.Context) StaticSiteResponsePtrOutput
}

type staticSiteResponsePtrType StaticSiteResponseArgs

func StaticSiteResponsePtr(v *StaticSiteResponseArgs) StaticSiteResponsePtrInput {
	return (*staticSiteResponsePtrType)(v)
}

func (*staticSiteResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**StaticSiteResponse)(nil)).Elem()
}

func (i *staticSiteResponsePtrType) ToStaticSiteResponsePtrOutput() StaticSiteResponsePtrOutput {
	return i.ToStaticSiteResponsePtrOutputWithContext(context.Background())
}

func (i *staticSiteResponsePtrType) ToStaticSiteResponsePtrOutputWithContext(ctx context.Context) StaticSiteResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StaticSiteResponsePtrOutput)
}

// A static site.
type StaticSiteResponseOutput struct{ *pulumi.OutputState }

func (StaticSiteResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*StaticSiteResponse)(nil)).Elem()
}

func (o StaticSiteResponseOutput) ToStaticSiteResponseOutput() StaticSiteResponseOutput {
	return o
}

func (o StaticSiteResponseOutput) ToStaticSiteResponseOutputWithContext(ctx context.Context) StaticSiteResponseOutput {
	return o
}

func (o StaticSiteResponseOutput) ToStaticSiteResponsePtrOutput() StaticSiteResponsePtrOutput {
	return o.ToStaticSiteResponsePtrOutputWithContext(context.Background())
}

func (o StaticSiteResponseOutput) ToStaticSiteResponsePtrOutputWithContext(ctx context.Context) StaticSiteResponsePtrOutput {
	return o.ApplyT(func(v StaticSiteResponse) *StaticSiteResponse {
		return &v
	}).(StaticSiteResponsePtrOutput)
}

// The target branch in the repository.
func (o StaticSiteResponseOutput) Branch() pulumi.StringPtrOutput {
	return o.ApplyT(func(v StaticSiteResponse) *string { return v.Branch }).(pulumi.StringPtrOutput)
}

// Build properties to configure on the repository.
func (o StaticSiteResponseOutput) BuildProperties() StaticSiteBuildPropertiesResponsePtrOutput {
	return o.ApplyT(func(v StaticSiteResponse) *StaticSiteBuildPropertiesResponse { return v.BuildProperties }).(StaticSiteBuildPropertiesResponsePtrOutput)
}

// The custom domains associated with this static site.
func (o StaticSiteResponseOutput) CustomDomains() pulumi.StringArrayOutput {
	return o.ApplyT(func(v StaticSiteResponse) []string { return v.CustomDomains }).(pulumi.StringArrayOutput)
}

// The default autogenerated hostname for the static site.
func (o StaticSiteResponseOutput) DefaultHostname() pulumi.StringOutput {
	return o.ApplyT(func(v StaticSiteResponse) string { return v.DefaultHostname }).(pulumi.StringOutput)
}

// A user's github repository token. This is used to setup the Github Actions workflow file and API secrets.
func (o StaticSiteResponseOutput) RepositoryToken() pulumi.StringPtrOutput {
	return o.ApplyT(func(v StaticSiteResponse) *string { return v.RepositoryToken }).(pulumi.StringPtrOutput)
}

// URL for the repository of the static site.
func (o StaticSiteResponseOutput) RepositoryUrl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v StaticSiteResponse) *string { return v.RepositoryUrl }).(pulumi.StringPtrOutput)
}

type StaticSiteResponsePtrOutput struct{ *pulumi.OutputState }

func (StaticSiteResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**StaticSiteResponse)(nil)).Elem()
}

func (o StaticSiteResponsePtrOutput) ToStaticSiteResponsePtrOutput() StaticSiteResponsePtrOutput {
	return o
}

func (o StaticSiteResponsePtrOutput) ToStaticSiteResponsePtrOutputWithContext(ctx context.Context) StaticSiteResponsePtrOutput {
	return o
}

func (o StaticSiteResponsePtrOutput) Elem() StaticSiteResponseOutput {
	return o.ApplyT(func(v *StaticSiteResponse) StaticSiteResponse { return *v }).(StaticSiteResponseOutput)
}

// The target branch in the repository.
func (o StaticSiteResponsePtrOutput) Branch() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StaticSiteResponse) *string {
		if v == nil {
			return nil
		}
		return v.Branch
...
// Build properties to configure on the repository.
func (o StaticSiteResponsePtrOutput) BuildProperties() StaticSiteBuildPropertiesResponsePtrOutput {
	return o.ApplyT(func(v *StaticSiteResponse) *StaticSiteBuildPropertiesResponse {
		if v == nil {
			return nil
		}
		return v.BuildProperties
	}).(StaticSiteBuildPropertiesResponsePtrOutput)
}

// The custom domains associated with this static site.
func (o StaticSiteResponsePtrOutput) CustomDomains() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *StaticSiteResponse) []string {
		if v == nil {
			return nil
		}
...
// The default autogenerated hostname for the static site.
func (o StaticSiteResponsePtrOutput) DefaultHostname() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StaticSiteResponse) *string {
		if v == nil {
			return nil
		}
...
// A user's github repository token. This is used to setup the Github Actions workflow file and API secrets.
func (o StaticSiteResponsePtrOutput) RepositoryToken() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StaticSiteResponse) *string {
		if v == nil {
			return nil
		}
		return v.RepositoryToken
	}).(pulumi.StringPtrOutput)
}

// URL for the repository of the static site.
func (o StaticSiteResponsePtrOutput) RepositoryUrl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StaticSiteResponse) *string {
		if v == nil {
			return nil
		}
