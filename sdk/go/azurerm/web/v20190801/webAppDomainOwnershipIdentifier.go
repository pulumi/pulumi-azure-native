...
func NewWebAppDomainOwnershipIdentifier(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:web/v20181101:WebAppDomainOwnershipIdentifier"),
		},
		{
			Type: pulumi.String("azurerm:web/v20200601:WebAppDomainOwnershipIdentifier"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppDomainOwnershipIdentifier
	err := ctx.RegisterResource("azurerm:web/v20190801:WebAppDomainOwnershipIdentifier", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDomainOwnershipIdentifier(ctx *pulumi.Context,
	...
	var resource WebAppDomainOwnershipIdentifier
	err := ctx.ReadResource("azurerm:web/v20190801:WebAppDomainOwnershipIdentifier", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
