...
func NewWebAppHostNameBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/v20190801:WebAppHostNameBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHostNameBinding(ctx *pulumi.Context,
	...
	var resource WebAppHostNameBinding
	err := ctx.ReadResource("azurerm:web/v20190801:WebAppHostNameBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
