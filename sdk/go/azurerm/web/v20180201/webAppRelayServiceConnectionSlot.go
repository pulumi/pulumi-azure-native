...
func NewWebAppRelayServiceConnectionSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:web/latest:WebAppRelayServiceConnectionSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/preview:WebAppRelayServiceConnectionSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20150801:WebAppRelayServiceConnectionSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20160801:WebAppRelayServiceConnectionSlot"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:web/v20180201:WebAppRelayServiceConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppRelayServiceConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppRelayServiceConnectionSlot
	err := ctx.ReadResource("azurerm:web/v20180201:WebAppRelayServiceConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
