...
func NewWebAppSwiftVirtualNetworkConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:web/v20181101:WebAppSwiftVirtualNetworkConnection"),
		},
		{
			Type: pulumi.String("azurerm:web/v20190801:WebAppSwiftVirtualNetworkConnection"),
		},
		{
			Type: pulumi.String("azurerm:web/v20200601:WebAppSwiftVirtualNetworkConnection"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppSwiftVirtualNetworkConnection
	err := ctx.RegisterResource("azurerm:web/v20180201:WebAppSwiftVirtualNetworkConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSwiftVirtualNetworkConnection(ctx *pulumi.Context,
	...
	var resource WebAppSwiftVirtualNetworkConnection
	err := ctx.ReadResource("azurerm:web/v20180201:WebAppSwiftVirtualNetworkConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
