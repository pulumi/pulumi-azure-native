...
//
// import (
// 	web "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/web/v20180201"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func GetAppServicePlan(ctx *pulumi.Context,
	...
	var resource AppServicePlan
	err := ctx.ReadResource("azurerm:web/v20180201:AppServicePlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
