...
func NewWebAppHybridConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:web/preview:WebAppHybridConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:web/v20190801:WebAppHybridConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:web/v20180201:WebAppHybridConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHybridConnection(ctx *pulumi.Context,
	...
	var resource WebAppHybridConnection
	err := ctx.ReadResource("azurerm:web/v20180201:WebAppHybridConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
