...
func NewWebAppSourceControl(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:web/v20181101:WebAppSourceControl"),
		},
		{
			Type: pulumi.String("azurerm:web/v20190801:WebAppSourceControl"),
		},
		{
			Type: pulumi.String("azurerm:web/v20200601:WebAppSourceControl"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppSourceControl
	err := ctx.RegisterResource("azurerm:web/v20180201:WebAppSourceControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSourceControl(ctx *pulumi.Context,
	...
	var resource WebAppSourceControl
	err := ctx.ReadResource("azurerm:web/v20180201:WebAppSourceControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
