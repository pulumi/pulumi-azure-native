...
func NewSiteHostNameBindingSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:web/v20200601:SiteHostNameBindingSlot"),
		},
	})
...
func GetSiteHostNameBindingSlot(ctx *pulumi.Context,
	...
	var resource SiteHostNameBindingSlot
	err := ctx.ReadResource("azurerm:web/v20150801:SiteHostNameBindingSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
