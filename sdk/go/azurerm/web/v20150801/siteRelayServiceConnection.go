...
func NewSiteRelayServiceConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:web/latest:SiteRelayServiceConnection"),
		},
		{
			Type: pulumi.String("azurerm:web/preview:SiteRelayServiceConnection"),
		},
		{
...
func GetSiteRelayServiceConnection(ctx *pulumi.Context,
	...
	var resource SiteRelayServiceConnection
	err := ctx.ReadResource("azurerm:web/v20150801:SiteRelayServiceConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
