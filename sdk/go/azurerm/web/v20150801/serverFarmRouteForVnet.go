...
func NewServerFarmRouteForVnet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:web/v20200601:ServerFarmRouteForVnet"),
		},
	})
...
func GetServerFarmRouteForVnet(ctx *pulumi.Context,
	...
	var resource ServerFarmRouteForVnet
	err := ctx.ReadResource("azurerm:web/v20150801:ServerFarmRouteForVnet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
