...
func NewWebAppPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web:WebAppPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource WebAppPrivateEndpointConnection
	err := ctx.ReadResource("azurerm:web:WebAppPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
