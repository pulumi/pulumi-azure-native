...
func NewWebAppDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/preview:WebAppDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDeployment(ctx *pulumi.Context,
	...
	var resource WebAppDeployment
	err := ctx.ReadResource("azurerm:web/preview:WebAppDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
