...
func NewSiteInstanceDeployment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:web/v20150801:SiteInstanceDeployment"),
		},
	})
	opts = append(opts, aliases)
	var resource SiteInstanceDeployment
	err := ctx.RegisterResource("azurerm:web/preview:SiteInstanceDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSiteInstanceDeployment(ctx *pulumi.Context,
	...
	var resource SiteInstanceDeployment
	err := ctx.ReadResource("azurerm:web/preview:SiteInstanceDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
