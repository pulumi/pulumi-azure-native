...
func NewWebAppFunction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/preview:WebAppFunction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppFunction(ctx *pulumi.Context,
	...
	var resource WebAppFunction
	err := ctx.ReadResource("azurerm:web/preview:WebAppFunction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
