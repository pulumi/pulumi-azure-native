...
func NewWebAppInstanceFunctionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/preview:WebAppInstanceFunctionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppInstanceFunctionSlot(ctx *pulumi.Context,
	...
	var resource WebAppInstanceFunctionSlot
	err := ctx.ReadResource("azurerm:web/preview:WebAppInstanceFunctionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
