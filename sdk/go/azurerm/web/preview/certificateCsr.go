...
func NewCertificateCsr(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/preview:CertificateCsr", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateCsr(ctx *pulumi.Context,
	...
	var resource CertificateCsr
	err := ctx.ReadResource("azurerm:web/preview:CertificateCsr", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
