...
func NewStaticSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/preview:StaticSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSite(ctx *pulumi.Context,
	...
	var resource StaticSite
	err := ctx.ReadResource("azurerm:web/preview:StaticSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
