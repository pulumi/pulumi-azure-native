...
func NewSiteInstanceDeploymentSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/preview:SiteInstanceDeploymentSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSiteInstanceDeploymentSlot(ctx *pulumi.Context,
	...
	var resource SiteInstanceDeploymentSlot
	err := ctx.ReadResource("azurerm:web/preview:SiteInstanceDeploymentSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
