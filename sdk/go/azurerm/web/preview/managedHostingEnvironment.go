...
func NewManagedHostingEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/preview:ManagedHostingEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedHostingEnvironment(ctx *pulumi.Context,
	...
	var resource ManagedHostingEnvironment
	err := ctx.ReadResource("azurerm:web/preview:ManagedHostingEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
