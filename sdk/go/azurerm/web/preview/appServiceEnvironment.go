...
func NewAppServiceEnvironment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:web/latest:AppServiceEnvironment"),
		},
		{
			Type: pulumi.String("azurerm:web/v20150801:AppServiceEnvironment"),
		},
		{
			Type: pulumi.String("azurerm:web/v20160901:AppServiceEnvironment"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:web/preview:AppServiceEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceEnvironment(ctx *pulumi.Context,
	...
	var resource AppServiceEnvironment
	err := ctx.ReadResource("azurerm:web/preview:AppServiceEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
