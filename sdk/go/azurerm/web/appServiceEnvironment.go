...
func NewAppServiceEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web:AppServiceEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceEnvironment(ctx *pulumi.Context,
	...
	var resource AppServiceEnvironment
	err := ctx.ReadResource("azurerm:web:AppServiceEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
