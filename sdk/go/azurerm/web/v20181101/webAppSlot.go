...
func NewWebAppSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:web/v20180201:WebAppSlot"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:web/v20181101:WebAppSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSlot(ctx *pulumi.Context,
	...
	var resource WebAppSlot
	err := ctx.ReadResource("azurerm:web/v20181101:WebAppSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
