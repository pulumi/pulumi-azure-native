...
func NewWebAppVnetConnectionSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:web/latest:WebAppVnetConnectionSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/preview:WebAppVnetConnectionSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20150801:WebAppVnetConnectionSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20160801:WebAppVnetConnectionSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20180201:WebAppVnetConnectionSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20190801:WebAppVnetConnectionSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20200601:WebAppVnetConnectionSlot"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppVnetConnectionSlot
	err := ctx.RegisterResource("azurerm:web/v20181101:WebAppVnetConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppVnetConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppVnetConnectionSlot
	err := ctx.ReadResource("azurerm:web/v20181101:WebAppVnetConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
