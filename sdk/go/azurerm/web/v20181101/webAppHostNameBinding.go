...
func NewWebAppHostNameBinding(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:web/latest:WebAppHostNameBinding"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:web/v20180201:WebAppHostNameBinding"),
		},
		{
			Type: pulumi.String("azurerm:web/v20190801:WebAppHostNameBinding"),
		},
		{
			Type: pulumi.String("azurerm:web/v20200601:WebAppHostNameBinding"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppHostNameBinding
	err := ctx.RegisterResource("azurerm:web/v20181101:WebAppHostNameBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHostNameBinding(ctx *pulumi.Context,
	...
	var resource WebAppHostNameBinding
	err := ctx.ReadResource("azurerm:web/v20181101:WebAppHostNameBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
