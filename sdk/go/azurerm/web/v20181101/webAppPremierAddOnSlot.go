...
func NewWebAppPremierAddOnSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:web/latest:WebAppPremierAddOnSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/preview:WebAppPremierAddOnSlot"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:web/v20180201:WebAppPremierAddOnSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20190801:WebAppPremierAddOnSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20200601:WebAppPremierAddOnSlot"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppPremierAddOnSlot
	err := ctx.RegisterResource("azurerm:web/v20181101:WebAppPremierAddOnSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPremierAddOnSlot(ctx *pulumi.Context,
	...
	var resource WebAppPremierAddOnSlot
	err := ctx.ReadResource("azurerm:web/v20181101:WebAppPremierAddOnSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
