...
type AppServiceEnvironmentDefinitionArgs struct {
	...
	// Description of the Virtual Network.
	VirtualNetwork VirtualNetworkProfileInput `pulumi:"virtualNetwork"`
	// Name of the Virtual Network for the App Service Environment.
...
// AppServicePlanPropertiesInput is an input type that accepts AppServicePlanPropertiesArgs and AppServicePlanPropertiesOutput values.
// You can construct a concrete instance of `AppServicePlanPropertiesInput` via:
//
//          AppServicePlanPropertiesArgs{...}
type AppServicePlanPropertiesInput interface {
	pulumi.Input

	ToAppServicePlanPropertiesOutput() AppServicePlanPropertiesOutput
	ToAppServicePlanPropertiesOutputWithContext(context.Context) AppServicePlanPropertiesOutput
}

// AppServicePlan resource specific properties
type AppServicePlanPropertiesArgs struct {
	// App Service plan administration site.
...
func (AppServicePlanPropertiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*AppServicePlanProperties)(nil)).Elem()
}

func (i AppServicePlanPropertiesArgs) ToAppServicePlanPropertiesOutput() AppServicePlanPropertiesOutput {
	return i.ToAppServicePlanPropertiesOutputWithContext(context.Background())
}

func (i AppServicePlanPropertiesArgs) ToAppServicePlanPropertiesOutputWithContext(ctx context.Context) AppServicePlanPropertiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AppServicePlanPropertiesOutput)
}

func (i AppServicePlanPropertiesArgs) ToAppServicePlanPropertiesPtrOutput() AppServicePlanPropertiesPtrOutput {
	return i.ToAppServicePlanPropertiesPtrOutputWithContext(context.Background())
}

func (i AppServicePlanPropertiesArgs) ToAppServicePlanPropertiesPtrOutputWithContext(ctx context.Context) AppServicePlanPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AppServicePlanPropertiesOutput).ToAppServicePlanPropertiesPtrOutputWithContext(ctx)
}

// AppServicePlanPropertiesPtrInput is an input type that accepts AppServicePlanPropertiesArgs, AppServicePlanPropertiesPtr and AppServicePlanPropertiesPtrOutput values.
// You can construct a concrete instance of `AppServicePlanPropertiesPtrInput` via:
//
//          AppServicePlanPropertiesArgs{...}
//
//  or:
//
//          nil
type AppServicePlanPropertiesPtrInput interface {
	pulumi.Input

	ToAppServicePlanPropertiesPtrOutput() AppServicePlanPropertiesPtrOutput
	ToAppServicePlanPropertiesPtrOutputWithContext(context.Context) AppServicePlanPropertiesPtrOutput
}

type appServicePlanPropertiesPtrType AppServicePlanPropertiesArgs

func AppServicePlanPropertiesPtr(v *AppServicePlanPropertiesArgs) AppServicePlanPropertiesPtrInput {
	return (*appServicePlanPropertiesPtrType)(v)
}

func (*appServicePlanPropertiesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**AppServicePlanProperties)(nil)).Elem()
}

func (i *appServicePlanPropertiesPtrType) ToAppServicePlanPropertiesPtrOutput() AppServicePlanPropertiesPtrOutput {
	return i.ToAppServicePlanPropertiesPtrOutputWithContext(context.Background())
}

func (i *appServicePlanPropertiesPtrType) ToAppServicePlanPropertiesPtrOutputWithContext(ctx context.Context) AppServicePlanPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AppServicePlanPropertiesPtrOutput)
}

// AppServicePlan resource specific properties
type AppServicePlanPropertiesOutput struct{ *pulumi.OutputState }

func (AppServicePlanPropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*AppServicePlanProperties)(nil)).Elem()
}

func (o AppServicePlanPropertiesOutput) ToAppServicePlanPropertiesOutput() AppServicePlanPropertiesOutput {
	return o
}

func (o AppServicePlanPropertiesOutput) ToAppServicePlanPropertiesOutputWithContext(ctx context.Context) AppServicePlanPropertiesOutput {
	return o
}

func (o AppServicePlanPropertiesOutput) ToAppServicePlanPropertiesPtrOutput() AppServicePlanPropertiesPtrOutput {
	return o.ToAppServicePlanPropertiesPtrOutputWithContext(context.Background())
}

func (o AppServicePlanPropertiesOutput) ToAppServicePlanPropertiesPtrOutputWithContext(ctx context.Context) AppServicePlanPropertiesPtrOutput {
	return o.ApplyT(func(v AppServicePlanProperties) *AppServicePlanProperties {
		return &v
	}).(AppServicePlanPropertiesPtrOutput)
}

// App Service plan administration site.
func (o AppServicePlanPropertiesOutput) AdminSiteName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AppServicePlanProperties) *string { return v.AdminSiteName }).(pulumi.StringPtrOutput)
}

// Specification for the App Service Environment to use for the App Service plan.
func (o AppServicePlanPropertiesOutput) HostingEnvironmentProfile() HostingEnvironmentProfilePtrOutput {
	return o.ApplyT(func(v AppServicePlanProperties) *HostingEnvironmentProfile { return v.HostingEnvironmentProfile }).(HostingEnvironmentProfilePtrOutput)
}

// If <code>true</code>, this App Service Plan owns spot instances.
func (o AppServicePlanPropertiesOutput) IsSpot() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v AppServicePlanProperties) *bool { return v.IsSpot }).(pulumi.BoolPtrOutput)
}

// Name for the App Service plan.
func (o AppServicePlanPropertiesOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v AppServicePlanProperties) string { return v.Name }).(pulumi.StringOutput)
}

// If <code>true</code>, apps assigned to this App Service plan can be scaled independently.
// If <code>false</code>, apps assigned to this App Service plan will scale to all instances of the plan.
func (o AppServicePlanPropertiesOutput) PerSiteScaling() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v AppServicePlanProperties) *bool { return v.PerSiteScaling }).(pulumi.BoolPtrOutput)
}

// If Linux app service plan <code>true</code>, <code>false</code> otherwise.
func (o AppServicePlanPropertiesOutput) Reserved() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v AppServicePlanProperties) *bool { return v.Reserved }).(pulumi.BoolPtrOutput)
}

// The time when the server farm expires. Valid only if it is a spot server farm.
func (o AppServicePlanPropertiesOutput) SpotExpirationTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AppServicePlanProperties) *string { return v.SpotExpirationTime }).(pulumi.StringPtrOutput)
}

// Scaling worker count.
func (o AppServicePlanPropertiesOutput) TargetWorkerCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v AppServicePlanProperties) *int { return v.TargetWorkerCount }).(pulumi.IntPtrOutput)
}

// Scaling worker size ID.
func (o AppServicePlanPropertiesOutput) TargetWorkerSizeId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v AppServicePlanProperties) *int { return v.TargetWorkerSizeId }).(pulumi.IntPtrOutput)
}

// Target worker tier assigned to the App Service plan.
func (o AppServicePlanPropertiesOutput) WorkerTierName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AppServicePlanProperties) *string { return v.WorkerTierName }).(pulumi.StringPtrOutput)
}

type AppServicePlanPropertiesPtrOutput struct{ *pulumi.OutputState }

func (AppServicePlanPropertiesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**AppServicePlanProperties)(nil)).Elem()
}

func (o AppServicePlanPropertiesPtrOutput) ToAppServicePlanPropertiesPtrOutput() AppServicePlanPropertiesPtrOutput {
	return o
}

func (o AppServicePlanPropertiesPtrOutput) ToAppServicePlanPropertiesPtrOutputWithContext(ctx context.Context) AppServicePlanPropertiesPtrOutput {
	return o
}

func (o AppServicePlanPropertiesPtrOutput) Elem() AppServicePlanPropertiesOutput {
	return o.ApplyT(func(v *AppServicePlanProperties) AppServicePlanProperties { return *v }).(AppServicePlanPropertiesOutput)
}

// App Service plan administration site.
func (o AppServicePlanPropertiesPtrOutput) AdminSiteName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AppServicePlanProperties) *string {
		if v == nil {
			return nil
		}
...
// Specification for the App Service Environment to use for the App Service plan.
func (o AppServicePlanPropertiesPtrOutput) HostingEnvironmentProfile() HostingEnvironmentProfilePtrOutput {
	return o.ApplyT(func(v *AppServicePlanProperties) *HostingEnvironmentProfile {
		if v == nil {
			return nil
		}
...
// If <code>true</code>, this App Service Plan owns spot instances.
func (o AppServicePlanPropertiesPtrOutput) IsSpot() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *AppServicePlanProperties) *bool {
		if v == nil {
			return nil
		}
		return v.IsSpot
...
// Name for the App Service plan.
func (o AppServicePlanPropertiesPtrOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AppServicePlanProperties) *string {
		if v == nil {
			return nil
		}
...
// If <code>true</code>, apps assigned to this App Service plan can be scaled independently.
// If <code>false</code>, apps assigned to this App Service plan will scale to all instances of the plan.
func (o AppServicePlanPropertiesPtrOutput) PerSiteScaling() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *AppServicePlanProperties) *bool {
		if v == nil {
			return nil
		}
...
// If Linux app service plan <code>true</code>, <code>false</code> otherwise.
func (o AppServicePlanPropertiesPtrOutput) Reserved() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *AppServicePlanProperties) *bool {
		if v == nil {
			return nil
		}
...
// The time when the server farm expires. Valid only if it is a spot server farm.
func (o AppServicePlanPropertiesPtrOutput) SpotExpirationTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AppServicePlanProperties) *string {
		if v == nil {
			return nil
		}
...
// Scaling worker count.
func (o AppServicePlanPropertiesPtrOutput) TargetWorkerCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *AppServicePlanProperties) *int {
		if v == nil {
			return nil
		}
...
// Scaling worker size ID.
func (o AppServicePlanPropertiesPtrOutput) TargetWorkerSizeId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *AppServicePlanProperties) *int {
		if v == nil {
			return nil
		}
...
// Target worker tier assigned to the App Service plan.
func (o AppServicePlanPropertiesPtrOutput) WorkerTierName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AppServicePlanProperties) *string {
		if v == nil {
			return nil
		}
