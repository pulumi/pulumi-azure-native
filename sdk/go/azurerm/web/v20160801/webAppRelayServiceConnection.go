...
func NewWebAppRelayServiceConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:web/v20190801:WebAppRelayServiceConnection"),
		},
		{
			Type: pulumi.String("azurerm:web/v20200601:WebAppRelayServiceConnection"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppRelayServiceConnection
	err := ctx.RegisterResource("azurerm:web/v20160801:WebAppRelayServiceConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppRelayServiceConnection(ctx *pulumi.Context,
	...
	var resource WebAppRelayServiceConnection
	err := ctx.ReadResource("azurerm:web/v20160801:WebAppRelayServiceConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
