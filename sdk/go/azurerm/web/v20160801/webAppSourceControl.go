...
func NewWebAppSourceControl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/v20160801:WebAppSourceControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSourceControl(ctx *pulumi.Context,
	...
	var resource WebAppSourceControl
	err := ctx.ReadResource("azurerm:web/v20160801:WebAppSourceControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
