...
func NewWebAppHostNameBindingSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:web/latest:WebAppHostNameBindingSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/preview:WebAppHostNameBindingSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20150801:WebAppHostNameBindingSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20180201:WebAppHostNameBindingSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20181101:WebAppHostNameBindingSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20190801:WebAppHostNameBindingSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20200601:WebAppHostNameBindingSlot"),
		},
	})
