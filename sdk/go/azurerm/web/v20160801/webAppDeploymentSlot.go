...
func NewWebAppDeploymentSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:web/v20180201:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20181101:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20190801:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azurerm:web/v20200601:WebAppDeploymentSlot"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppDeploymentSlot
	err := ctx.RegisterResource("azurerm:web/v20160801:WebAppDeploymentSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDeploymentSlot(ctx *pulumi.Context,
	...
	var resource WebAppDeploymentSlot
	err := ctx.ReadResource("azurerm:web/v20160801:WebAppDeploymentSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
