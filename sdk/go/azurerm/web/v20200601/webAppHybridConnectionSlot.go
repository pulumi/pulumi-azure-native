...
func NewWebAppHybridConnectionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/v20200601:WebAppHybridConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHybridConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppHybridConnectionSlot
	err := ctx.ReadResource("azurerm:web/v20200601:WebAppHybridConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
