...
func NewWebAppPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:web/latest:WebAppPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azurerm:web/preview:WebAppPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azurerm:web/v20190801:WebAppPrivateEndpointConnection"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppPrivateEndpointConnection
	err := ctx.RegisterResource("azurerm:web/v20200601:WebAppPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource WebAppPrivateEndpointConnection
	err := ctx.ReadResource("azurerm:web/v20200601:WebAppPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
