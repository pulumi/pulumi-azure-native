...
func NewWebAppHostNameBindingSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web:WebAppHostNameBindingSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHostNameBindingSlot(ctx *pulumi.Context,
	...
	var resource WebAppHostNameBindingSlot
	err := ctx.ReadResource("azurerm:web:WebAppHostNameBindingSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
