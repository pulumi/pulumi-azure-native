...
func NewWebAppHybridConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web:WebAppHybridConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHybridConnection(ctx *pulumi.Context,
	...
	var resource WebAppHybridConnection
	err := ctx.ReadResource("azurerm:web:WebAppHybridConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
