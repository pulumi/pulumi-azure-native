...
func NewConnectionGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/v20160601:ConnectionGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionGateway(ctx *pulumi.Context,
	...
	var resource ConnectionGateway
	err := ctx.ReadResource("azurerm:web/v20160601:ConnectionGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
