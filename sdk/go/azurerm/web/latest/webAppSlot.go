...
func NewWebAppSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/latest:WebAppSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSlot(ctx *pulumi.Context,
	...
	var resource WebAppSlot
	err := ctx.ReadResource("azurerm:web/latest:WebAppSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
