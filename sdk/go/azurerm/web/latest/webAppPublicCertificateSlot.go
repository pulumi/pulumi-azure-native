...
func NewWebAppPublicCertificateSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/latest:WebAppPublicCertificateSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPublicCertificateSlot(ctx *pulumi.Context,
	...
	var resource WebAppPublicCertificateSlot
	err := ctx.ReadResource("azurerm:web/latest:WebAppPublicCertificateSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
