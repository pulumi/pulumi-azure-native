...
func NewWebAppSwiftVirtualNetworkConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/latest:WebAppSwiftVirtualNetworkConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSwiftVirtualNetworkConnection(ctx *pulumi.Context,
	...
	var resource WebAppSwiftVirtualNetworkConnection
	err := ctx.ReadResource("azurerm:web/latest:WebAppSwiftVirtualNetworkConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
