...
func NewCertificateCsr(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:web/preview:CertificateCsr"),
		},
		{
			Type: pulumi.String("azurerm:web/v20150801:CertificateCsr"),
		},
	})
	opts = append(opts, aliases)
	var resource CertificateCsr
	err := ctx.RegisterResource("azurerm:web/latest:CertificateCsr", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateCsr(ctx *pulumi.Context,
	...
	var resource CertificateCsr
	err := ctx.ReadResource("azurerm:web/latest:CertificateCsr", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
