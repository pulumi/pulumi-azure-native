...
func NewWebAppRelayServiceConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/latest:WebAppRelayServiceConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppRelayServiceConnection(ctx *pulumi.Context,
	...
	var resource WebAppRelayServiceConnection
	err := ctx.ReadResource("azurerm:web/latest:WebAppRelayServiceConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
