...
func NewAppServicePlanRouteForVnet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/latest:AppServicePlanRouteForVnet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServicePlanRouteForVnet(ctx *pulumi.Context,
	...
	var resource AppServicePlanRouteForVnet
	err := ctx.ReadResource("azurerm:web/latest:AppServicePlanRouteForVnet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
