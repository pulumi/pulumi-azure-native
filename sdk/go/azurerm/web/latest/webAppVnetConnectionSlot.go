...
func NewWebAppVnetConnectionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:web/latest:WebAppVnetConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppVnetConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppVnetConnectionSlot
	err := ctx.ReadResource("azurerm:web/latest:WebAppVnetConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
