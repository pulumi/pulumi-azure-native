...
//
// import (
// 	resourcegraph "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/resourcegraph/v20200401preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewGraphQuery(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:resourcegraph/v20200401preview:GraphQuery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGraphQuery(ctx *pulumi.Context,
	...
	var resource GraphQuery
	err := ctx.ReadResource("azurerm:resourcegraph/v20200401preview:GraphQuery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
