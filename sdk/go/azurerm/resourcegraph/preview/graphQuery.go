...
func NewGraphQuery(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:resourcegraph/v20180901preview:GraphQuery"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:resourcegraph/preview:GraphQuery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGraphQuery(ctx *pulumi.Context,
	...
	var resource GraphQuery
	err := ctx.ReadResource("azurerm:resourcegraph/preview:GraphQuery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
