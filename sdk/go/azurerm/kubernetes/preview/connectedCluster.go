...
func NewConnectedCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:kubernetes/v20200101preview:ConnectedCluster"),
		},
	})
	opts = append(opts, aliases)
	var resource ConnectedCluster
	err := ctx.RegisterResource("azurerm:kubernetes/preview:ConnectedCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectedCluster(ctx *pulumi.Context,
	...
	var resource ConnectedCluster
	err := ctx.ReadResource("azurerm:kubernetes/preview:ConnectedCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
