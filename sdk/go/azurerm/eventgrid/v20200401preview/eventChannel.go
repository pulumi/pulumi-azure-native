...
func NewEventChannel(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:eventgrid/latest:EventChannel"),
		},
	})
...
func GetEventChannel(ctx *pulumi.Context,
	...
	var resource EventChannel
	err := ctx.ReadResource("azurerm:eventgrid/v20200401preview:EventChannel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
