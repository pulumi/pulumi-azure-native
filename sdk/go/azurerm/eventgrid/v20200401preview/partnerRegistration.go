...
func NewPartnerRegistration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:eventgrid/latest:PartnerRegistration"),
		},
	})
...
func GetPartnerRegistration(ctx *pulumi.Context,
	...
	var resource PartnerRegistration
	err := ctx.ReadResource("azurerm:eventgrid/v20200401preview:PartnerRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
