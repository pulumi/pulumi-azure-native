...
func NewSystemTopicEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:eventgrid/latest:SystemTopicEventSubscription"),
		},
	})
...
func GetSystemTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource SystemTopicEventSubscription
	err := ctx.ReadResource("azurerm:eventgrid/v20200401preview:SystemTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
