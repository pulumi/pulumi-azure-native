...
func NewPartnerTopicEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:eventgrid/latest:PartnerTopicEventSubscription"),
		},
	})
...
func GetPartnerTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource PartnerTopicEventSubscription
	err := ctx.ReadResource("azurerm:eventgrid/v20200401preview:PartnerTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
