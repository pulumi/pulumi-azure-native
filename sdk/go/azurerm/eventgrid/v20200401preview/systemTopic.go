...
func NewSystemTopic(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:eventgrid/latest:SystemTopic"),
		},
	})
...
func GetSystemTopic(ctx *pulumi.Context,
	...
	var resource SystemTopic
	err := ctx.ReadResource("azurerm:eventgrid/v20200401preview:SystemTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
