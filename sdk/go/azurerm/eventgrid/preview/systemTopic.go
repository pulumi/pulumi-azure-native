...
func NewSystemTopic(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:eventgrid/v20200401preview:SystemTopic"),
		},
	})
	opts = append(opts, aliases)
	var resource SystemTopic
	err := ctx.RegisterResource("azurerm:eventgrid/preview:SystemTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSystemTopic(ctx *pulumi.Context,
	...
	var resource SystemTopic
	err := ctx.ReadResource("azurerm:eventgrid/preview:SystemTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
