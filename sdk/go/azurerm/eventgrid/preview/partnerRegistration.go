...
func NewPartnerRegistration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:eventgrid/v20200401preview:PartnerRegistration"),
		},
	})
	opts = append(opts, aliases)
	var resource PartnerRegistration
	err := ctx.RegisterResource("azurerm:eventgrid/preview:PartnerRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartnerRegistration(ctx *pulumi.Context,
	...
	var resource PartnerRegistration
	err := ctx.ReadResource("azurerm:eventgrid/preview:PartnerRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
