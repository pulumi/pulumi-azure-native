...
func NewSystemTopicEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:eventgrid/v20200401preview:SystemTopicEventSubscription"),
		},
	})
	opts = append(opts, aliases)
	var resource SystemTopicEventSubscription
	err := ctx.RegisterResource("azurerm:eventgrid/preview:SystemTopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSystemTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource SystemTopicEventSubscription
	err := ctx.ReadResource("azurerm:eventgrid/preview:SystemTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
