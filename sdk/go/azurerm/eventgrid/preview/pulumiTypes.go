...
// Information about the destination where events have to be delivered for the event subscription.
// Uses the managed identity setup on the parent resource (namely, topic or domain) to acquire the authentication tokens being used during delivery / dead-lettering.
func (o DeadLetterWithResourceIdentityOutput) DeadLetterDestination() DeadLetterDestinationPtrOutput {
	return o.ApplyT(func(v DeadLetterWithResourceIdentity) *DeadLetterDestination { return v.DeadLetterDestination }).(DeadLetterDestinationPtrOutput)
}
...
// Information about the destination where events have to be delivered for the event subscription.
// Uses the managed identity setup on the parent resource (namely, topic or domain) to acquire the authentication tokens being used during delivery / dead-lettering.
func (o DeadLetterWithResourceIdentityPtrOutput) DeadLetterDestination() DeadLetterDestinationPtrOutput {
	return o.ApplyT(func(v *DeadLetterWithResourceIdentity) *DeadLetterDestination {
		if v == nil {
			return nil
		}
...
// Information about the destination where events have to be delivered for the event subscription.
// Uses the managed identity setup on the parent resource (namely, topic or domain) to acquire the authentication tokens being used during delivery / dead-lettering.
func (o DeadLetterWithResourceIdentityResponseOutput) DeadLetterDestination() DeadLetterDestinationResponsePtrOutput {
	return o.ApplyT(func(v DeadLetterWithResourceIdentityResponse) *DeadLetterDestinationResponse {
		return v.DeadLetterDestination
	}).(DeadLetterDestinationResponsePtrOutput)
}
...
// Information about the destination where events have to be delivered for the event subscription.
// Uses the managed identity setup on the parent resource (namely, topic or domain) to acquire the authentication tokens being used during delivery / dead-lettering.
func (o DeadLetterWithResourceIdentityResponsePtrOutput) DeadLetterDestination() DeadLetterDestinationResponsePtrOutput {
	return o.ApplyT(func(v *DeadLetterWithResourceIdentityResponse) *DeadLetterDestinationResponse {
		if v == nil {
			return nil
		}
...
// Information about the destination where events have to be delivered for the event subscription.
// Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery / dead-lettering.
func (o DeliveryWithResourceIdentityOutput) Destination() EventSubscriptionDestinationPtrOutput {
	return o.ApplyT(func(v DeliveryWithResourceIdentity) *EventSubscriptionDestination { return v.Destination }).(EventSubscriptionDestinationPtrOutput)
}
...
// Information about the destination where events have to be delivered for the event subscription.
// Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery / dead-lettering.
func (o DeliveryWithResourceIdentityPtrOutput) Destination() EventSubscriptionDestinationPtrOutput {
	return o.ApplyT(func(v *DeliveryWithResourceIdentity) *EventSubscriptionDestination {
		if v == nil {
			return nil
		}
...
// Information about the destination where events have to be delivered for the event subscription.
// Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery / dead-lettering.
func (o DeliveryWithResourceIdentityResponseOutput) Destination() EventSubscriptionDestinationResponsePtrOutput {
	return o.ApplyT(func(v DeliveryWithResourceIdentityResponse) *EventSubscriptionDestinationResponse {
		return v.Destination
...
// Information about the destination where events have to be delivered for the event subscription.
// Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery / dead-lettering.
func (o DeliveryWithResourceIdentityResponsePtrOutput) Destination() EventSubscriptionDestinationResponsePtrOutput {
	return o.ApplyT(func(v *DeliveryWithResourceIdentityResponse) *EventSubscriptionDestinationResponse {
		if v == nil {
			return nil
		}
...
// An array of advanced filters that are used for filtering event channels.
func (o EventChannelFilterOutput) AdvancedFilters() AdvancedFilterArrayOutput {
	return o.ApplyT(func(v EventChannelFilter) []AdvancedFilter { return v.AdvancedFilters }).(AdvancedFilterArrayOutput)
}
...
// An array of advanced filters that are used for filtering event channels.
func (o EventChannelFilterPtrOutput) AdvancedFilters() AdvancedFilterArrayOutput {
	return o.ApplyT(func(v *EventChannelFilter) []AdvancedFilter {
		if v == nil {
			return nil
		}
...
// An array of advanced filters that are used for filtering event channels.
func (o EventChannelFilterResponseOutput) AdvancedFilters() AdvancedFilterResponseArrayOutput {
	return o.ApplyT(func(v EventChannelFilterResponse) []AdvancedFilterResponse { return v.AdvancedFilters }).(AdvancedFilterResponseArrayOutput)
}
...
// An array of advanced filters that are used for filtering event channels.
func (o EventChannelFilterResponsePtrOutput) AdvancedFilters() AdvancedFilterResponseArrayOutput {
	return o.ApplyT(func(v *EventChannelFilterResponse) []AdvancedFilterResponse {
		if v == nil {
			return nil
		}
		return v.AdvancedFilters
