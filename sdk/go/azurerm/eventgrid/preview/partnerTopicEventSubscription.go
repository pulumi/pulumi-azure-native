...
func NewPartnerTopicEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:eventgrid/v20200401preview:PartnerTopicEventSubscription"),
		},
	})
	opts = append(opts, aliases)
	var resource PartnerTopicEventSubscription
	err := ctx.RegisterResource("azurerm:eventgrid/preview:PartnerTopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartnerTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource PartnerTopicEventSubscription
	err := ctx.ReadResource("azurerm:eventgrid/preview:PartnerTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
