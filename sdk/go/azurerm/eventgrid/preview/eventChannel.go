...
func NewEventChannel(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:eventgrid/v20200401preview:EventChannel"),
		},
	})
	opts = append(opts, aliases)
	var resource EventChannel
	err := ctx.RegisterResource("azurerm:eventgrid/preview:EventChannel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventChannel(ctx *pulumi.Context,
	...
	var resource EventChannel
	err := ctx.ReadResource("azurerm:eventgrid/preview:EventChannel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
