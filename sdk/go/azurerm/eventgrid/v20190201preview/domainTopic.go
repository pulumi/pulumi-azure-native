...
func NewDomainTopic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:eventgrid/v20190201preview:DomainTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainTopic(ctx *pulumi.Context,
	...
	var resource DomainTopic
	err := ctx.ReadResource("azurerm:eventgrid/v20190201preview:DomainTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
