...
func NewLabAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:labservices/latest:LabAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLabAccount(ctx *pulumi.Context,
	...
	var resource LabAccount
	err := ctx.ReadResource("azurerm:labservices/latest:LabAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
