...
func NewLabAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:labservices/v20181015:LabAccount"),
		},
	})
	opts = append(opts, aliases)
	var resource LabAccount
	err := ctx.RegisterResource("azurerm:labservices/preview:LabAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLabAccount(ctx *pulumi.Context,
	...
	var resource LabAccount
	err := ctx.ReadResource("azurerm:labservices/preview:LabAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
