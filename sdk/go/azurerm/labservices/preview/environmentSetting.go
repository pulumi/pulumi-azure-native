...
func NewEnvironmentSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:labservices/preview:EnvironmentSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironmentSetting(ctx *pulumi.Context,
	...
	var resource EnvironmentSetting
	err := ctx.ReadResource("azurerm:labservices/preview:EnvironmentSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
