...
func NewJobCollection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:scheduler/v20140801preview:JobCollection"),
		},
		{
			Type: pulumi.String("azurerm:scheduler/v20160101:JobCollection"),
		},
		{
			Type: pulumi.String("azurerm:scheduler/v20160301:JobCollection"),
		},
	})
	opts = append(opts, aliases)
	var resource JobCollection
	err := ctx.RegisterResource("azurerm:scheduler/preview:JobCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobCollection(ctx *pulumi.Context,
	...
	var resource JobCollection
	err := ctx.ReadResource("azurerm:scheduler/preview:JobCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
