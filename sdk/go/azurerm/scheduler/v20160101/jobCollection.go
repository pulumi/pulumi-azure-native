...
func NewJobCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:scheduler/v20160101:JobCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobCollection(ctx *pulumi.Context,
	...
	var resource JobCollection
	err := ctx.ReadResource("azurerm:scheduler/v20160101:JobCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
