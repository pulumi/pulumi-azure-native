...
func NewNotificationHubAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:notificationhubs:NotificationHubAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationHubAuthorizationRule(ctx *pulumi.Context,
	...
	var resource NotificationHubAuthorizationRule
	err := ctx.ReadResource("azurerm:notificationhubs:NotificationHubAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
