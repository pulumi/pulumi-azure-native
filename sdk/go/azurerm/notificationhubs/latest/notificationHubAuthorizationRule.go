...
func NewNotificationHubAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:notificationhubs/latest:NotificationHubAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationHubAuthorizationRule(ctx *pulumi.Context,
	...
	var resource NotificationHubAuthorizationRule
	err := ctx.ReadResource("azurerm:notificationhubs/latest:NotificationHubAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
