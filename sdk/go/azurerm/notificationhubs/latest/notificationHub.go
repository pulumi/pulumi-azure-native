...
func NewNotificationHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:notificationhubs/latest:NotificationHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationHub(ctx *pulumi.Context,
	...
	var resource NotificationHub
	err := ctx.ReadResource("azurerm:notificationhubs/latest:NotificationHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
