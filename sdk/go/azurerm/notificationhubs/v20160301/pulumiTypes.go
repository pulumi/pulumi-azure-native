...
// Resource location
func (o NamespaceAuthorizationRuleTypeOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v NamespaceAuthorizationRuleType) string { return v.Location }).(pulumi.StringOutput)
}
...
// Resource location
func (o NotificationHubTypeOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v NotificationHubType) string { return v.Location }).(pulumi.StringOutput)
}
...
// Resource location
func (o NotificationHubAuthorizationRuleTypeOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v NotificationHubAuthorizationRuleType) string { return v.Location }).(pulumi.StringOutput)
}
