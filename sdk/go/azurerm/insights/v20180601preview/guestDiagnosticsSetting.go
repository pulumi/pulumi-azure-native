...
// 	"fmt"
//
// 	insights "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/insights/v20180601preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func GetGuestDiagnosticsSetting(ctx *pulumi.Context,
	...
	var resource GuestDiagnosticsSetting
	err := ctx.ReadResource("azurerm:insights/v20180601preview:guestDiagnosticsSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
