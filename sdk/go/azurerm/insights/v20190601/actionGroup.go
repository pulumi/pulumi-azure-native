...
// 	"fmt"
//
// 	insights "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/insights/v20190601"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewActionGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:insights/v20190601:ActionGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActionGroup(ctx *pulumi.Context,
	...
	var resource ActionGroup
	err := ctx.ReadResource("azurerm:insights/v20190601:ActionGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
