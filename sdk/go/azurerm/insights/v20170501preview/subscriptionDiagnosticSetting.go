...
func NewSubscriptionDiagnosticSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:insights/preview:SubscriptionDiagnosticSetting"),
		},
	})
...
func GetSubscriptionDiagnosticSetting(ctx *pulumi.Context,
	...
	var resource SubscriptionDiagnosticSetting
	err := ctx.ReadResource("azurerm:insights/v20170501preview:SubscriptionDiagnosticSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
