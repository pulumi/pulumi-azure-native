...
func NewActionGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:insights:ActionGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActionGroup(ctx *pulumi.Context,
	...
	var resource ActionGroup
	err := ctx.ReadResource("azurerm:insights:ActionGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
