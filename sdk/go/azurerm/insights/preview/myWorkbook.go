...
func NewMyWorkbook(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:insights/v20150501:MyWorkbook"),
		},
	})
	opts = append(opts, aliases)
	var resource MyWorkbook
	err := ctx.RegisterResource("azurerm:insights/preview:MyWorkbook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMyWorkbook(ctx *pulumi.Context,
	...
	var resource MyWorkbook
	err := ctx.ReadResource("azurerm:insights/preview:MyWorkbook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
