...
func NewDataCollectionRuleAssociation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:insights/v20191101preview:DataCollectionRuleAssociation"),
		},
	})
	opts = append(opts, aliases)
	var resource DataCollectionRuleAssociation
	err := ctx.RegisterResource("azurerm:insights/preview:DataCollectionRuleAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCollectionRuleAssociation(ctx *pulumi.Context,
	...
	var resource DataCollectionRuleAssociation
	err := ctx.ReadResource("azurerm:insights/preview:DataCollectionRuleAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
