...
func NewAutoscaleSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:insights/preview:AutoscaleSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutoscaleSetting(ctx *pulumi.Context,
	...
	var resource AutoscaleSetting
	err := ctx.ReadResource("azurerm:insights/preview:AutoscaleSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
