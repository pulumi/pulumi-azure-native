...
func NewFavorite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:insights/preview:Favorite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFavorite(ctx *pulumi.Context,
	...
	var resource Favorite
	err := ctx.ReadResource("azurerm:insights/preview:Favorite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
