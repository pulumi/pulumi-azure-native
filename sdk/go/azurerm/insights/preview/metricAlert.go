...
func NewMetricAlert(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:insights/preview:MetricAlert", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetricAlert(ctx *pulumi.Context,
	...
	var resource MetricAlert
	err := ctx.ReadResource("azurerm:insights/preview:MetricAlert", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
