...
func NewWorkbookTemplate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:insights/v20191017preview:WorkbookTemplate"),
		},
	})
	opts = append(opts, aliases)
	var resource WorkbookTemplate
	err := ctx.RegisterResource("azurerm:insights/preview:WorkbookTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkbookTemplate(ctx *pulumi.Context,
	...
	var resource WorkbookTemplate
	err := ctx.ReadResource("azurerm:insights/preview:WorkbookTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
