...
func NewAnalyticsItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:insights/preview:AnalyticsItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAnalyticsItem(ctx *pulumi.Context,
	...
	var resource AnalyticsItem
	err := ctx.ReadResource("azurerm:insights/preview:AnalyticsItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
