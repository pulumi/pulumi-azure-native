...
func NewSubscriptionDiagnosticSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:insights/v20170501preview:SubscriptionDiagnosticSetting"),
		},
	})
	opts = append(opts, aliases)
	var resource SubscriptionDiagnosticSetting
	err := ctx.RegisterResource("azurerm:insights/preview:SubscriptionDiagnosticSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscriptionDiagnosticSetting(ctx *pulumi.Context,
	...
	var resource SubscriptionDiagnosticSetting
	err := ctx.ReadResource("azurerm:insights/preview:SubscriptionDiagnosticSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
