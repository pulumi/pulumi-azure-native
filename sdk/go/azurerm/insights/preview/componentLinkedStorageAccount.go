...
func NewComponentLinkedStorageAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:insights/v20200301preview:ComponentLinkedStorageAccount"),
		},
	})
	opts = append(opts, aliases)
	var resource ComponentLinkedStorageAccount
	err := ctx.RegisterResource("azurerm:insights/preview:ComponentLinkedStorageAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComponentLinkedStorageAccount(ctx *pulumi.Context,
	...
	var resource ComponentLinkedStorageAccount
	err := ctx.ReadResource("azurerm:insights/preview:ComponentLinkedStorageAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
