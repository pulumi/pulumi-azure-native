...
func NewGuestDiagnosticsSettingsAssociation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:insights/v20180601preview:GuestDiagnosticsSettingsAssociation"),
		},
	})
	opts = append(opts, aliases)
	var resource GuestDiagnosticsSettingsAssociation
	err := ctx.RegisterResource("azurerm:insights/preview:GuestDiagnosticsSettingsAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestDiagnosticsSettingsAssociation(ctx *pulumi.Context,
	...
	var resource GuestDiagnosticsSettingsAssociation
	err := ctx.ReadResource("azurerm:insights/preview:GuestDiagnosticsSettingsAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
