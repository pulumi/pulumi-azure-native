...
func NewDataCollectionRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:insights/v20191101preview:DataCollectionRule"),
		},
	})
	opts = append(opts, aliases)
	var resource DataCollectionRule
	err := ctx.RegisterResource("azurerm:insights/preview:DataCollectionRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCollectionRule(ctx *pulumi.Context,
	...
	var resource DataCollectionRule
	err := ctx.ReadResource("azurerm:insights/preview:DataCollectionRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
