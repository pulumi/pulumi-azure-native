...
func NewGuestDiagnosticsSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:insights/v20180601preview:guestDiagnosticsSetting"),
		},
	})
	opts = append(opts, aliases)
	var resource GuestDiagnosticsSetting
	err := ctx.RegisterResource("azurerm:insights/preview:guestDiagnosticsSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestDiagnosticsSetting(ctx *pulumi.Context,
	...
	var resource GuestDiagnosticsSetting
	err := ctx.ReadResource("azurerm:insights/preview:guestDiagnosticsSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
