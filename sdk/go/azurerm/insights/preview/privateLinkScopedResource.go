...
func NewPrivateLinkScopedResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:insights/v20191017preview:PrivateLinkScopedResource"),
		},
	})
	opts = append(opts, aliases)
	var resource PrivateLinkScopedResource
	err := ctx.RegisterResource("azurerm:insights/preview:PrivateLinkScopedResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkScopedResource(ctx *pulumi.Context,
	...
	var resource PrivateLinkScopedResource
	err := ctx.ReadResource("azurerm:insights/preview:PrivateLinkScopedResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
