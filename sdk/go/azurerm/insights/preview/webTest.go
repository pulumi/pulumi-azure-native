...
func NewWebTest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:insights/preview:WebTest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebTest(ctx *pulumi.Context,
	...
	var resource WebTest
	err := ctx.ReadResource("azurerm:insights/preview:WebTest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
