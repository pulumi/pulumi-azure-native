...
func NewQuery(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:insights/v20190901preview:Query"),
		},
	})
	opts = append(opts, aliases)
	var resource Query
	err := ctx.RegisterResource("azurerm:insights/preview:Query", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQuery(ctx *pulumi.Context,
	...
	var resource Query
	err := ctx.ReadResource("azurerm:insights/preview:Query", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
