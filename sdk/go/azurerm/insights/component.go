...
func NewComponent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:insights:Component", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComponent(ctx *pulumi.Context,
	...
	var resource Component
	err := ctx.ReadResource("azurerm:insights:Component", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
