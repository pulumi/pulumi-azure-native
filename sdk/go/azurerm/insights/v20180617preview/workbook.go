...
//
// import (
// 	insights "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/insights/v20180617preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewWorkbook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:insights/v20180617preview:Workbook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkbook(ctx *pulumi.Context,
	...
	var resource Workbook
	err := ctx.ReadResource("azurerm:insights/v20180617preview:Workbook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
