...
func NewMyWorkbook(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:insights/latest:MyWorkbook"),
		},
		{
			Type: pulumi.String("azurerm:insights/preview:MyWorkbook"),
		},
	})
	opts = append(opts, aliases)
	var resource MyWorkbook
	err := ctx.RegisterResource("azurerm:insights/v20150501:MyWorkbook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMyWorkbook(ctx *pulumi.Context,
	...
	var resource MyWorkbook
	err := ctx.ReadResource("azurerm:insights/v20150501:MyWorkbook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
