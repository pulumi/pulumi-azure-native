...
func LookupComponentExportconfiguration(ctx *pulumi.Context, args *LookupComponentExportconfigurationArgs, opts ...pulumi.InvokeOption) (*LookupComponentExportconfigurationResult, error) {
	var rv LookupComponentExportconfigurationResult
	err := ctx.Invoke("azurerm:insights:getComponentExportconfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupComponentExportconfigurationArgs struct {
...
type LookupComponentExportconfigurationResult struct {
