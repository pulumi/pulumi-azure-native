...
func NewComponentLinkedStorageAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:insights/latest:ComponentLinkedStorageAccount"),
		},
	})
...
func GetComponentLinkedStorageAccount(ctx *pulumi.Context,
	...
	var resource ComponentLinkedStorageAccount
	err := ctx.ReadResource("azurerm:insights/v20200301preview:ComponentLinkedStorageAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
