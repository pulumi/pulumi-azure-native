...
func NewExportConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:insights/latest:ExportConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExportConfiguration(ctx *pulumi.Context,
	...
	var resource ExportConfiguration
	err := ctx.ReadResource("azurerm:insights/latest:ExportConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
