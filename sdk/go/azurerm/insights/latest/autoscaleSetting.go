...
func NewAutoscaleSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:insights/latest:AutoscaleSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutoscaleSetting(ctx *pulumi.Context,
	...
	var resource AutoscaleSetting
	err := ctx.ReadResource("azurerm:insights/latest:AutoscaleSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
