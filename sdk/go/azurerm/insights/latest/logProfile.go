...
func NewLogProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:insights/latest:LogProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogProfile(ctx *pulumi.Context,
	...
	var resource LogProfile
	err := ctx.ReadResource("azurerm:insights/latest:LogProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
