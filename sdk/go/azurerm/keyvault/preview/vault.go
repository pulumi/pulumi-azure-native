...
func NewVault(ctx *pulumi.Context,
	...
	var resource Vault
	err := ctx.RegisterResource("azurerm:keyvault/preview:Vault", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVault(ctx *pulumi.Context,
	...
	var resource Vault
	err := ctx.ReadResource("azurerm:keyvault/preview:Vault", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
