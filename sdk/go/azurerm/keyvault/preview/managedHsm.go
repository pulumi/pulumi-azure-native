...
func NewManagedHsm(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:keyvault/v20200401preview:ManagedHsm"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagedHsm
	err := ctx.RegisterResource("azurerm:keyvault/preview:ManagedHsm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedHsm(ctx *pulumi.Context,
	...
	var resource ManagedHsm
	err := ctx.ReadResource("azurerm:keyvault/preview:ManagedHsm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
