...
// PrivateEndpointConnectionItemInput is an input type that accepts PrivateEndpointConnectionItemArgs and PrivateEndpointConnectionItemOutput values.
// You can construct a concrete instance of `PrivateEndpointConnectionItemInput` via:
//
//          PrivateEndpointConnectionItemArgs{...}
type PrivateEndpointConnectionItemInput interface {
	pulumi.Input

	ToPrivateEndpointConnectionItemOutput() PrivateEndpointConnectionItemOutput
	ToPrivateEndpointConnectionItemOutputWithContext(context.Context) PrivateEndpointConnectionItemOutput
}

// Private endpoint connection item.
type PrivateEndpointConnectionItemArgs struct {
	// Private endpoint connection properties.
	Properties PrivateEndpointConnectionPropertiesPtrInput `pulumi:"properties"`
}

func (PrivateEndpointConnectionItemArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateEndpointConnectionItem)(nil)).Elem()
}

func (i PrivateEndpointConnectionItemArgs) ToPrivateEndpointConnectionItemOutput() PrivateEndpointConnectionItemOutput {
	return i.ToPrivateEndpointConnectionItemOutputWithContext(context.Background())
}

func (i PrivateEndpointConnectionItemArgs) ToPrivateEndpointConnectionItemOutputWithContext(ctx context.Context) PrivateEndpointConnectionItemOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrivateEndpointConnectionItemOutput)
}

// Private endpoint connection item.
type PrivateEndpointConnectionItemOutput struct{ *pulumi.OutputState }

func (PrivateEndpointConnectionItemOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateEndpointConnectionItem)(nil)).Elem()
}

func (o PrivateEndpointConnectionItemOutput) ToPrivateEndpointConnectionItemOutput() PrivateEndpointConnectionItemOutput {
	return o
}

func (o PrivateEndpointConnectionItemOutput) ToPrivateEndpointConnectionItemOutputWithContext(ctx context.Context) PrivateEndpointConnectionItemOutput {
	return o
}

// Private endpoint connection properties.
func (o PrivateEndpointConnectionItemOutput) Properties() PrivateEndpointConnectionPropertiesPtrOutput {
	return o.ApplyT(func(v PrivateEndpointConnectionItem) *PrivateEndpointConnectionProperties { return v.Properties }).(PrivateEndpointConnectionPropertiesPtrOutput)
}
...
// Private endpoint connection properties.
func (o PrivateEndpointConnectionItemResponseOutput) Properties() PrivateEndpointConnectionPropertiesResponsePtrOutput {
	return o.ApplyT(func(v PrivateEndpointConnectionItemResponse) *PrivateEndpointConnectionPropertiesResponse {
		return v.Properties
...
// Azure location of the key vault resource.
func (o VaultTypeOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VaultType) *string { return v.Location }).(pulumi.StringPtrOutput)
}
