...
func NewAssessmentMetadataInSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:security/v20200101:AssessmentMetadataInSubscription"),
		},
	})
	opts = append(opts, aliases)
	var resource AssessmentMetadataInSubscription
	err := ctx.RegisterResource("azurerm:security/latest:AssessmentMetadataInSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssessmentMetadataInSubscription(ctx *pulumi.Context,
	...
	var resource AssessmentMetadataInSubscription
	err := ctx.ReadResource("azurerm:security/latest:AssessmentMetadataInSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
