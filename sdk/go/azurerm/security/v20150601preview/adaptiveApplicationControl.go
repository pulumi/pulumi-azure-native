...
// 	"fmt"
//
// 	security "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20150601preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
// 					RecommendationAction: pulumi.String("Recommended"),
// 					ResourceId:           pulumi.String("/subscriptions/3eeab341-f466-499c-a8be-85427e154baf/resourcegroups/erelh-stable/providers/microsoft.compute/virtualmachines/erelh-16090"),
// 				},
// 				&security.VmRecommendationArgs{
// 					ConfigurationStatus:  pulumi.String("Configured"),
// 					EnforcementSupport:   pulumi.String("Supported"),
// 					RecommendationAction: pulumi.String("Recommended"),
// 					ResourceId:           pulumi.String("/subscriptions/3eeab341-f466-499c-a8be-85427e154baf/resourcegroups/matanvs/providers/microsoft.compute/virtualmachines/matanvs19"),
// 				},
// 			},
// 		})
// 		if err != nil {
...
func NewAdaptiveApplicationControl(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:security/v20200101:AdaptiveApplicationControl"),
		},
	})
	opts = append(opts, aliases)
	var resource AdaptiveApplicationControl
	err := ctx.RegisterResource("azurerm:security/v20150601preview:AdaptiveApplicationControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdaptiveApplicationControl(ctx *pulumi.Context,
	...
	var resource AdaptiveApplicationControl
	err := ctx.ReadResource("azurerm:security/v20150601preview:AdaptiveApplicationControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
