...
func NewSecurityContact(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:security/v20170801preview:SecurityContact", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityContact(ctx *pulumi.Context,
	...
	var resource SecurityContact
	err := ctx.ReadResource("azurerm:security/v20170801preview:SecurityContact", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
