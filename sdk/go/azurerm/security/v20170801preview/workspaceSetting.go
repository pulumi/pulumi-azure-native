...
func NewWorkspaceSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:security/latest:WorkspaceSetting"),
		},
	})
...
func GetWorkspaceSetting(ctx *pulumi.Context,
	...
	var resource WorkspaceSetting
	err := ctx.ReadResource("azurerm:security/v20170801preview:WorkspaceSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
