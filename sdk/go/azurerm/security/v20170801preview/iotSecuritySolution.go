...
func NewIotSecuritySolution(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:security/v20170801preview:IotSecuritySolution", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotSecuritySolution(ctx *pulumi.Context,
	...
	var resource IotSecuritySolution
	err := ctx.ReadResource("azurerm:security/v20170801preview:IotSecuritySolution", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
