...
func NewSecurityContact(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:security/preview:SecurityContact"),
		},
		{
			Type: pulumi.String("azurerm:security/v20170801preview:SecurityContact"),
		},
	})
	opts = append(opts, aliases)
	var resource SecurityContact
	err := ctx.RegisterResource("azurerm:security/v20200101preview:SecurityContact", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityContact(ctx *pulumi.Context,
	...
	var resource SecurityContact
	err := ctx.ReadResource("azurerm:security/v20200101preview:SecurityContact", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
