...
func NewAssessmentsMetadataSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:security/v20190101preview:AssessmentsMetadataSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssessmentsMetadataSubscription(ctx *pulumi.Context,
	...
	var resource AssessmentsMetadataSubscription
	err := ctx.ReadResource("azurerm:security/v20190101preview:AssessmentsMetadataSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
