...
func NewAutomation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:security/v20190101preview:Automation"),
		},
	})
	opts = append(opts, aliases)
	var resource Automation
	err := ctx.RegisterResource("azurerm:security/preview:Automation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutomation(ctx *pulumi.Context,
	...
	var resource Automation
	err := ctx.ReadResource("azurerm:security/preview:Automation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
