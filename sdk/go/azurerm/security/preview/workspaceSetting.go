...
func NewWorkspaceSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:security/v20170801preview:WorkspaceSetting"),
		},
	})
	opts = append(opts, aliases)
	var resource WorkspaceSetting
	err := ctx.RegisterResource("azurerm:security/preview:WorkspaceSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceSetting(ctx *pulumi.Context,
	...
	var resource WorkspaceSetting
	err := ctx.ReadResource("azurerm:security/preview:WorkspaceSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
