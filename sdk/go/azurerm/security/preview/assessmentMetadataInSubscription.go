...
func NewAssessmentMetadataInSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:security/preview:AssessmentMetadataInSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssessmentMetadataInSubscription(ctx *pulumi.Context,
	...
	var resource AssessmentMetadataInSubscription
	err := ctx.ReadResource("azurerm:security/preview:AssessmentMetadataInSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
