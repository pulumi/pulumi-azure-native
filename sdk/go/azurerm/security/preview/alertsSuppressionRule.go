...
func NewAlertsSuppressionRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:security/v20190101preview:AlertsSuppressionRule"),
		},
	})
	opts = append(opts, aliases)
	var resource AlertsSuppressionRule
	err := ctx.RegisterResource("azurerm:security/preview:AlertsSuppressionRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertsSuppressionRule(ctx *pulumi.Context,
	...
	var resource AlertsSuppressionRule
	err := ctx.ReadResource("azurerm:security/preview:AlertsSuppressionRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
