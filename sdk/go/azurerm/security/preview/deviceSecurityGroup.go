...
func NewDeviceSecurityGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:security/preview:DeviceSecurityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceSecurityGroup(ctx *pulumi.Context,
	...
	var resource DeviceSecurityGroup
	err := ctx.ReadResource("azurerm:security/preview:DeviceSecurityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
