...
func NewIotSensor(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:security/v20200806preview:IotSensor"),
		},
	})
	opts = append(opts, aliases)
	var resource IotSensor
	err := ctx.RegisterResource("azurerm:security/preview:IotSensor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotSensor(ctx *pulumi.Context,
	...
	var resource IotSensor
	err := ctx.ReadResource("azurerm:security/preview:IotSensor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
