...
func NewIotDefenderSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:security/v20200806preview:IotDefenderSetting"),
		},
	})
	opts = append(opts, aliases)
	var resource IotDefenderSetting
	err := ctx.RegisterResource("azurerm:security/preview:IotDefenderSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotDefenderSetting(ctx *pulumi.Context,
	...
	var resource IotDefenderSetting
	err := ctx.ReadResource("azurerm:security/preview:IotDefenderSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
