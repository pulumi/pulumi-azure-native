...
func NewJitNetworkAccessPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:security/preview:JitNetworkAccessPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJitNetworkAccessPolicy(ctx *pulumi.Context,
	...
	var resource JitNetworkAccessPolicy
	err := ctx.ReadResource("azurerm:security/preview:JitNetworkAccessPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
