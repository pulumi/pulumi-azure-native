...
func NewAdaptiveApplicationControl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:security/preview:AdaptiveApplicationControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdaptiveApplicationControl(ctx *pulumi.Context,
	...
	var resource AdaptiveApplicationControl
	err := ctx.ReadResource("azurerm:security/preview:AdaptiveApplicationControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
