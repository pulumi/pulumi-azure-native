...
func NewIotDefenderSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:security/latest:IotDefenderSetting"),
		},
	})
...
func GetIotDefenderSetting(ctx *pulumi.Context,
	...
	var resource IotDefenderSetting
	err := ctx.ReadResource("azurerm:security/v20200806preview:IotDefenderSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
