...
func NewJitNetworkAccessPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:security:JitNetworkAccessPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJitNetworkAccessPolicy(ctx *pulumi.Context,
	...
	var resource JitNetworkAccessPolicy
	err := ctx.ReadResource("azurerm:security:JitNetworkAccessPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
