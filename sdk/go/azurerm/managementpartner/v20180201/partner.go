...
func NewPartner(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:managementpartner/v20180201:Partner", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartner(ctx *pulumi.Context,
	...
	var resource Partner
	err := ctx.ReadResource("azurerm:managementpartner/v20180201:Partner", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
