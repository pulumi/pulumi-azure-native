...
func NewPartner(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:managementpartner/latest:Partner", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartner(ctx *pulumi.Context,
	...
	var resource Partner
	err := ctx.ReadResource("azurerm:managementpartner/latest:Partner", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
