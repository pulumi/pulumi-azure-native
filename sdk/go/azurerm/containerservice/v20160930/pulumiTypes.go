...
type ContainerServicePropertiesArgs struct {
	...
	// Properties of the orchestrator.
	OrchestratorProfile ContainerServiceOrchestratorProfilePtrInput `pulumi:"orchestratorProfile"`
	// Properties for cluster service principals.
...
// Properties of the orchestrator.
func (o ContainerServicePropertiesOutput) OrchestratorProfile() ContainerServiceOrchestratorProfilePtrOutput {
	return o.ApplyT(func(v ContainerServiceProperties) *ContainerServiceOrchestratorProfile { return v.OrchestratorProfile }).(ContainerServiceOrchestratorProfilePtrOutput)
}
...
type ContainerServicePropertiesResponseArgs struct {
	...
	// Properties of the orchestrator.
	OrchestratorProfile ContainerServiceOrchestratorProfileResponsePtrInput `pulumi:"orchestratorProfile"`
	// the current deployment or provisioning state, which only appears in the response.
...
// Properties of the orchestrator.
func (o ContainerServicePropertiesResponseOutput) OrchestratorProfile() ContainerServiceOrchestratorProfileResponsePtrOutput {
