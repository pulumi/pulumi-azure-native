...
//
// import (
// 	containerservice "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/containerservice/v20200301"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewAgentPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:containerservice/v20200301:AgentPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentPool(ctx *pulumi.Context,
	...
	var resource AgentPool
	err := ctx.ReadResource("azurerm:containerservice/v20200301:AgentPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
