...
func NewContainerService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:containerservice/preview:ContainerService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerService(ctx *pulumi.Context,
	...
	var resource ContainerService
	err := ctx.ReadResource("azurerm:containerservice/preview:ContainerService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
