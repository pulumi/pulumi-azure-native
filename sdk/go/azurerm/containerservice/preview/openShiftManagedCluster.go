...
func NewOpenShiftManagedCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:containerservice/preview:OpenShiftManagedCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOpenShiftManagedCluster(ctx *pulumi.Context,
	...
	var resource OpenShiftManagedCluster
	err := ctx.ReadResource("azurerm:containerservice/preview:OpenShiftManagedCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
