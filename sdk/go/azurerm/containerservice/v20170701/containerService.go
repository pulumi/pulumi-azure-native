...
//
// import (
// 	containerservice "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/containerservice/v20170701"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewContainerService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:containerservice/v20170701:ContainerService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerService(ctx *pulumi.Context,
	...
	var resource ContainerService
	err := ctx.ReadResource("azurerm:containerservice/v20170701:ContainerService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
