...
// 					NodeImageVersion:          pulumi.String("AKSUbuntu:1604:2020.03.11"),
...
func NewManagedCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:containerservice/v20200601:ManagedCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedCluster(ctx *pulumi.Context,
	...
	var resource ManagedCluster
	err := ctx.ReadResource("azurerm:containerservice/v20200601:ManagedCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
