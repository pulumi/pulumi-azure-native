...
func NewSqlVirtualMachine(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sqlvirtualmachine/v20170301preview:SqlVirtualMachine"),
		},
	})
	opts = append(opts, aliases)
	var resource SqlVirtualMachine
	err := ctx.RegisterResource("azurerm:sqlvirtualmachine/preview:SqlVirtualMachine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlVirtualMachine(ctx *pulumi.Context,
	...
	var resource SqlVirtualMachine
	err := ctx.ReadResource("azurerm:sqlvirtualmachine/preview:SqlVirtualMachine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
