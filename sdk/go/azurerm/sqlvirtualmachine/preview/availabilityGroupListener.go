...
func NewAvailabilityGroupListener(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sqlvirtualmachine/v20170301preview:AvailabilityGroupListener"),
		},
	})
	opts = append(opts, aliases)
	var resource AvailabilityGroupListener
	err := ctx.RegisterResource("azurerm:sqlvirtualmachine/preview:AvailabilityGroupListener", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAvailabilityGroupListener(ctx *pulumi.Context,
	...
	var resource AvailabilityGroupListener
	err := ctx.ReadResource("azurerm:sqlvirtualmachine/preview:AvailabilityGroupListener", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
