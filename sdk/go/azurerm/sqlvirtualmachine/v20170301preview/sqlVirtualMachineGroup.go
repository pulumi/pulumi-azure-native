...
func NewSqlVirtualMachineGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sqlvirtualmachine/preview:SqlVirtualMachineGroup"),
		},
	})
	opts = append(opts, aliases)
	var resource SqlVirtualMachineGroup
	err := ctx.RegisterResource("azurerm:sqlvirtualmachine/v20170301preview:SqlVirtualMachineGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlVirtualMachineGroup(ctx *pulumi.Context,
	...
	var resource SqlVirtualMachineGroup
	err := ctx.ReadResource("azurerm:sqlvirtualmachine/v20170301preview:SqlVirtualMachineGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
