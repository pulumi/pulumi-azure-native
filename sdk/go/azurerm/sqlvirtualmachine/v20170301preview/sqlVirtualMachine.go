...
func NewSqlVirtualMachine(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sqlvirtualmachine/latest:SqlVirtualMachine"),
		},
	})
...
func GetSqlVirtualMachine(ctx *pulumi.Context,
	...
	var resource SqlVirtualMachine
	err := ctx.ReadResource("azurerm:sqlvirtualmachine/v20170301preview:SqlVirtualMachine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
