...
func NewVMwareCollector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:migrate:VMwareCollector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVMwareCollector(ctx *pulumi.Context,
	...
	var resource VMwareCollector
	err := ctx.ReadResource("azurerm:migrate:VMwareCollector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
