...
func NewMoveCollection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:migrate/preview:MoveCollection"),
		},
	})
...
func GetMoveCollection(ctx *pulumi.Context,
	...
	var resource MoveCollection
	err := ctx.ReadResource("azurerm:migrate/v20191001preview:MoveCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
