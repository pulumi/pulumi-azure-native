...
// 			CustomerWorkspaceLocation: pulumi.String("West Us"),
...
func NewProject(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:migrate/v20171111preview:Project"),
		},
	})
	opts = append(opts, aliases)
	var resource Project
	err := ctx.RegisterResource("azurerm:migrate/v20180202:Project", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProject(ctx *pulumi.Context,
	...
	var resource Project
	err := ctx.ReadResource("azurerm:migrate/v20180202:Project", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
