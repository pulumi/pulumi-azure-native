...
func NewMigrateProject(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:migrate/preview:MigrateProject"),
		},
	})
...
func GetMigrateProject(ctx *pulumi.Context,
	...
	var resource MigrateProject
	err := ctx.ReadResource("azurerm:migrate/v20180901preview:MigrateProject", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
