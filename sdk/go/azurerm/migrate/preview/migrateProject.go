...
func NewMigrateProject(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:migrate/v20180901preview:MigrateProject"),
		},
	})
	opts = append(opts, aliases)
	var resource MigrateProject
	err := ctx.RegisterResource("azurerm:migrate/preview:MigrateProject", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMigrateProject(ctx *pulumi.Context,
	...
	var resource MigrateProject
	err := ctx.ReadResource("azurerm:migrate/preview:MigrateProject", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
