...
func NewMoveCollection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:migrate/v20191001preview:MoveCollection"),
		},
	})
	opts = append(opts, aliases)
	var resource MoveCollection
	err := ctx.RegisterResource("azurerm:migrate/preview:MoveCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMoveCollection(ctx *pulumi.Context,
	...
	var resource MoveCollection
	err := ctx.ReadResource("azurerm:migrate/preview:MoveCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
