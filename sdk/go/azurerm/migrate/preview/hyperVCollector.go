...
func NewHyperVCollector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:migrate/preview:HyperVCollector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHyperVCollector(ctx *pulumi.Context,
	...
	var resource HyperVCollector
	err := ctx.ReadResource("azurerm:migrate/preview:HyperVCollector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
