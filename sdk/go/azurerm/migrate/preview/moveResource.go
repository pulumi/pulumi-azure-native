...
func NewMoveResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:migrate/v20191001preview:MoveResource"),
		},
	})
	opts = append(opts, aliases)
	var resource MoveResource
	err := ctx.RegisterResource("azurerm:migrate/preview:MoveResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMoveResource(ctx *pulumi.Context,
	...
	var resource MoveResource
	err := ctx.ReadResource("azurerm:migrate/preview:MoveResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
