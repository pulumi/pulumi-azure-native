...
func NewHyperVCollector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:migrate:HyperVCollector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHyperVCollector(ctx *pulumi.Context,
	...
	var resource HyperVCollector
	err := ctx.ReadResource("azurerm:migrate:HyperVCollector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
