...
func NewAssessment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:migrate:Assessment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssessment(ctx *pulumi.Context,
	...
	var resource Assessment
	err := ctx.ReadResource("azurerm:migrate:Assessment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
