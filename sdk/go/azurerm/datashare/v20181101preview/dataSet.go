...
func NewDataSet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:datashare/v20191101:DataSet"),
		},
	})
	opts = append(opts, aliases)
	var resource DataSet
	err := ctx.RegisterResource("azurerm:datashare/v20181101preview:DataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataSet(ctx *pulumi.Context,
	...
	var resource DataSet
	err := ctx.ReadResource("azurerm:datashare/v20181101preview:DataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
