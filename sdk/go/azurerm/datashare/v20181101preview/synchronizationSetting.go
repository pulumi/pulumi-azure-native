...
func NewSynchronizationSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datashare/v20181101preview:SynchronizationSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSynchronizationSetting(ctx *pulumi.Context,
	...
	var resource SynchronizationSetting
	err := ctx.ReadResource("azurerm:datashare/v20181101preview:SynchronizationSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
