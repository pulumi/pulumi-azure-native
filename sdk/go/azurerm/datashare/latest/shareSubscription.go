...
func NewShareSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datashare/latest:ShareSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetShareSubscription(ctx *pulumi.Context,
	...
	var resource ShareSubscription
	err := ctx.ReadResource("azurerm:datashare/latest:ShareSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
