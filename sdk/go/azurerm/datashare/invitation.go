...
func NewInvitation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datashare:Invitation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInvitation(ctx *pulumi.Context,
	...
	var resource Invitation
	err := ctx.ReadResource("azurerm:datashare:Invitation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
