...
func NewDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datashare:DataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataSetMapping(ctx *pulumi.Context,
	...
	var resource DataSetMapping
	err := ctx.ReadResource("azurerm:datashare:DataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
