...
func NewSynchronizationSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:datashare/v20191101:SynchronizationSetting"),
		},
	})
	opts = append(opts, aliases)
	var resource SynchronizationSetting
	err := ctx.RegisterResource("azurerm:datashare/preview:SynchronizationSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSynchronizationSetting(ctx *pulumi.Context,
	...
	var resource SynchronizationSetting
	err := ctx.ReadResource("azurerm:datashare/preview:SynchronizationSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
