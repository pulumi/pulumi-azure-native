...
//
// import (
// 	batchai "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/batchai/v20170901preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewFileServer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:batchai/v20180301:FileServer"),
		},
	})
	opts = append(opts, aliases)
	var resource FileServer
	err := ctx.RegisterResource("azurerm:batchai/v20170901preview:FileServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileServer(ctx *pulumi.Context,
	...
	var resource FileServer
	err := ctx.ReadResource("azurerm:batchai/v20170901preview:FileServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
