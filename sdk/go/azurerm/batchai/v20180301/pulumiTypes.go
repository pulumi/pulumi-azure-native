...
// The file size.
func (o FilePropertiesResponseOutput) ContentLength() pulumi.IntPtrOutput {
	return o.ApplyT(func(v FilePropertiesResponse) *int { return v.ContentLength }).(pulumi.IntPtrOutput)
}

// The time at which the file was last modified.
func (o FilePropertiesResponseOutput) LastModified() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FilePropertiesResponse) *string { return v.LastModified }).(pulumi.StringPtrOutput)
}
...
func (o FileResponseOutput) DownloadUrl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FileResponse) *string { return v.DownloadUrl }).(pulumi.StringPtrOutput)
}

// Indicates if the file is a directory.
func (o FileResponseOutput) IsDirectory() pulumi.BoolOutput {
	return o.ApplyT(func(v FileResponse) bool { return v.IsDirectory }).(pulumi.BoolOutput)
}
...
// The location of the resource
func (o FileServerTypeOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v FileServerType) string { return v.Location }).(pulumi.StringOutput)
}
...
// The tags of the resource
func (o FileServerTypeOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v FileServerType) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
// Describe the experiment information of the job
func (o JobBasePropertiesOutput) ExperimentName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v JobBaseProperties) *string { return v.ExperimentName }).(pulumi.StringPtrOutput)
}
...
// Priority associated with the job. Priority values can range from -1000 to 1000, with -1000 being the lowest priority and 1000 being the highest priority. The default value is 0.
func (o JobBasePropertiesOutput) Priority() pulumi.IntPtrOutput {
	return o.ApplyT(func(v JobBaseProperties) *int { return v.Priority }).(pulumi.IntPtrOutput)
}
...
// Describe the experiment information of the job
func (o JobBasePropertiesPtrOutput) ExperimentName() pulumi.StringPtrOutput {
...
// Priority associated with the job. Priority values can range from -1000 to 1000, with -1000 being the lowest priority and 1000 being the highest priority. The default value is 0.
func (o JobBasePropertiesPtrOutput) Priority() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *JobBaseProperties) *int {
		if v == nil {
			return nil
		}
...
type JobPropertiesResponseArgs struct {
	...
	// Batch AI creates job's output directories under an unique path to avoid conflicts between jobs. This value contains a path segment generated by Batch AI to make the path unique and can be used to find the output directory on the node or mounted filesystem.
	JobOutputDirectoryPathSegment pulumi.StringPtrInput `pulumi:"jobOutputDirectoryPathSegment"`
	// The specified actions will run on all the nodes that are part of the job
...
// The current state of the job. Possible values are: queued - The job is queued and able to run. A job enters this state when it is created, or when it is awaiting a retry after a failed run. running - The job is running on a compute cluster. This includes job-level preparation such as downloading resource files or set up container specified on the job - it does not necessarily mean that the job command line has started executing. terminating - The job is terminated by the user, the terminate operation is in progress. succeeded - The job has completed running successfully and exited with exit code 0. failed - The job has finished unsuccessfully (failed with a non-zero exit code) and has exhausted its retry limit. A job is also marked as failed if an error occurred launching the job.
func (o JobPropertiesResponseOutput) ExecutionState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v JobPropertiesResponse) *string { return v.ExecutionState }).(pulumi.StringPtrOutput)
}
...
// Describe the experiment information of the job
func (o JobPropertiesResponseOutput) ExperimentName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v JobPropertiesResponse) *string { return v.ExperimentName }).(pulumi.StringPtrOutput)
}
...
// Batch AI creates job's output directories under an unique path to avoid conflicts between jobs. This value contains a path segment generated by Batch AI to make the path unique and can be used to find the output directory on the node or mounted filesystem.
func (o JobPropertiesResponseOutput) JobOutputDirectoryPathSegment() pulumi.StringPtrOutput {
	return o.ApplyT(func(v JobPropertiesResponse) *string { return v.JobOutputDirectoryPathSegment }).(pulumi.StringPtrOutput)
}
...
// Priority associated with the job. Priority values can range from -1000 to 1000, with -1000 being the lowest priority and 1000 being the highest priority. The default value is 0.
func (o JobPropertiesResponseOutput) Priority() pulumi.IntPtrOutput {
	return o.ApplyT(func(v JobPropertiesResponse) *int { return v.Priority }).(pulumi.IntPtrOutput)
}
...
// Describe the experiment information of the job
func (o JobPropertiesResponsePtrOutput) ExperimentName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *JobPropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
// Priority associated with the job. Priority values can range from -1000 to 1000, with -1000 being the lowest priority and 1000 being the highest priority. The default value is 0.
func (o JobPropertiesResponsePtrOutput) Priority() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *JobPropertiesResponse) *int {
		if v == nil {
			return nil
		}
