...
//
// import (
// 	addons "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/addons/v20170515"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewSupportPlanType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:addons/v20170515:SupportPlanType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSupportPlanType(ctx *pulumi.Context,
	...
	var resource SupportPlanType
	err := ctx.ReadResource("azurerm:addons/v20170515:SupportPlanType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
