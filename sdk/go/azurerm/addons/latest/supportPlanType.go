...
func NewSupportPlanType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:addons/latest:SupportPlanType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSupportPlanType(ctx *pulumi.Context,
	...
	var resource SupportPlanType
	err := ctx.ReadResource("azurerm:addons/latest:SupportPlanType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
