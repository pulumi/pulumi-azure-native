...
func NewSupportPlanType(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:addons/v20180301:SupportPlanType"),
		},
	})
	opts = append(opts, aliases)
	var resource SupportPlanType
	err := ctx.RegisterResource("azurerm:addons/preview:SupportPlanType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSupportPlanType(ctx *pulumi.Context,
	...
	var resource SupportPlanType
	err := ctx.ReadResource("azurerm:addons/preview:SupportPlanType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
