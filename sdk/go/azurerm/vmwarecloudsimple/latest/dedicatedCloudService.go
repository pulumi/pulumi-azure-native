...
func NewDedicatedCloudService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:vmwarecloudsimple/preview:DedicatedCloudService"),
		},
		{
			Type: pulumi.String("azurerm:vmwarecloudsimple/v20190401:DedicatedCloudService"),
		},
	})
	opts = append(opts, aliases)
	var resource DedicatedCloudService
	err := ctx.RegisterResource("azurerm:vmwarecloudsimple/latest:DedicatedCloudService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDedicatedCloudService(ctx *pulumi.Context,
	...
	var resource DedicatedCloudService
	err := ctx.ReadResource("azurerm:vmwarecloudsimple/latest:DedicatedCloudService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
