...
func NewDedicatedCloudNode(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:vmwarecloudsimple/latest:DedicatedCloudNode", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDedicatedCloudNode(ctx *pulumi.Context,
	...
	var resource DedicatedCloudNode
	err := ctx.ReadResource("azurerm:vmwarecloudsimple/latest:DedicatedCloudNode", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
