...
type DedicatedCloudNode struct {
	...
	Created pulumi.MapOutput `pulumi:"created"`
	// Azure region
...
func NewDedicatedCloudNode(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:vmwarecloudsimple/v20190401:DedicatedCloudNode"),
		},
	})
	opts = append(opts, aliases)
	var resource DedicatedCloudNode
	err := ctx.RegisterResource("azurerm:vmwarecloudsimple/preview:DedicatedCloudNode", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDedicatedCloudNode(ctx *pulumi.Context,
	...
	var resource DedicatedCloudNode
	err := ctx.ReadResource("azurerm:vmwarecloudsimple/preview:DedicatedCloudNode", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
