...
func NewController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devspaces/preview:Controller", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetController(ctx *pulumi.Context,
	...
	var resource Controller
	err := ctx.ReadResource("azurerm:devspaces/preview:Controller", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
