...
//
// import (
// 	devspaces "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devspaces/latest"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devspaces/latest:Controller", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetController(ctx *pulumi.Context,
	...
	var resource Controller
	err := ctx.ReadResource("azurerm:devspaces/latest:Controller", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
