...
func NewMachineExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:hybridcompute/v20190802preview:MachineExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineExtension(ctx *pulumi.Context,
	...
	var resource MachineExtension
	err := ctx.ReadResource("azurerm:hybridcompute/v20190802preview:MachineExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
