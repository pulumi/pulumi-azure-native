...
func NewMasterSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:offazure/latest:MasterSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMasterSite(ctx *pulumi.Context,
	...
	var resource MasterSite
	err := ctx.ReadResource("azurerm:offazure/latest:MasterSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
