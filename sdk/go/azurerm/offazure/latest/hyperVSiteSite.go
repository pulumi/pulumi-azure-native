...
func NewHyperVSiteSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:offazure/latest:HyperVSiteSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHyperVSiteSite(ctx *pulumi.Context,
	...
	var resource HyperVSiteSite
	err := ctx.ReadResource("azurerm:offazure/latest:HyperVSiteSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
