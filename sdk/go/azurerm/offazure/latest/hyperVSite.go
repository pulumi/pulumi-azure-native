...
func NewHyperVSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:offazure/latest:HyperVSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHyperVSite(ctx *pulumi.Context,
	...
	var resource HyperVSite
	err := ctx.ReadResource("azurerm:offazure/latest:HyperVSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
