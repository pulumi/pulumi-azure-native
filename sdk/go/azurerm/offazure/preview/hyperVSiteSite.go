...
func NewHyperVSiteSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:offazure/preview:HyperVSiteSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHyperVSiteSite(ctx *pulumi.Context,
	...
	var resource HyperVSiteSite
	err := ctx.ReadResource("azurerm:offazure/preview:HyperVSiteSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
