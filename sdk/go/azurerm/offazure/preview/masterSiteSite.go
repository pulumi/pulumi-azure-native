...
func NewMasterSiteSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:offazure/preview:MasterSiteSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMasterSiteSite(ctx *pulumi.Context,
	...
	var resource MasterSiteSite
	err := ctx.ReadResource("azurerm:offazure/preview:MasterSiteSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
