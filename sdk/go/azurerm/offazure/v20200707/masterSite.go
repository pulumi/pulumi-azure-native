...
func NewMasterSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:offazure/latest:MasterSite"),
		},
		{
			Type: pulumi.String("azurerm:offazure/preview:MasterSite"),
		},
	})
	opts = append(opts, aliases)
	var resource MasterSite
	err := ctx.RegisterResource("azurerm:offazure/v20200707:MasterSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMasterSite(ctx *pulumi.Context,
	...
	var resource MasterSite
	err := ctx.ReadResource("azurerm:offazure/v20200707:MasterSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
