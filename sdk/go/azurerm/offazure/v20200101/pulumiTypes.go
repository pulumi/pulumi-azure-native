...
// HealthErrorDetailsInput is an input type that accepts HealthErrorDetailsArgs and HealthErrorDetailsOutput values.
// You can construct a concrete instance of `HealthErrorDetailsInput` via:
//
//          HealthErrorDetailsArgs{...}
type HealthErrorDetailsInput interface {
	pulumi.Input

	ToHealthErrorDetailsOutput() HealthErrorDetailsOutput
	ToHealthErrorDetailsOutputWithContext(context.Context) HealthErrorDetailsOutput
}

// Error contract returned when some exception occurs in Rest API.
type HealthErrorDetailsArgs struct {
}

func (HealthErrorDetailsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*HealthErrorDetails)(nil)).Elem()
}

func (i HealthErrorDetailsArgs) ToHealthErrorDetailsOutput() HealthErrorDetailsOutput {
	return i.ToHealthErrorDetailsOutputWithContext(context.Background())
}

func (i HealthErrorDetailsArgs) ToHealthErrorDetailsOutputWithContext(ctx context.Context) HealthErrorDetailsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HealthErrorDetailsOutput)
}

// Error contract returned when some exception occurs in Rest API.
type HealthErrorDetailsOutput struct{ *pulumi.OutputState }

func (HealthErrorDetailsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HealthErrorDetails)(nil)).Elem()
}

func (o HealthErrorDetailsOutput) ToHealthErrorDetailsOutput() HealthErrorDetailsOutput {
	return o
}

func (o HealthErrorDetailsOutput) ToHealthErrorDetailsOutputWithContext(ctx context.Context) HealthErrorDetailsOutput {
	return o
}
