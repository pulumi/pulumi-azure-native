...
func NewHyperVSiteSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:offazure/latest:HyperVSiteSite"),
		},
		{
			Type: pulumi.String("azurerm:offazure/preview:HyperVSiteSite"),
		},
		{
...
func GetHyperVSiteSite(ctx *pulumi.Context,
	...
	var resource HyperVSiteSite
	err := ctx.ReadResource("azurerm:offazure/v20200101:HyperVSiteSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
