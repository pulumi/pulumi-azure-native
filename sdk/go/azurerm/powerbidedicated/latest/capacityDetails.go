...
func NewCapacityDetails(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:powerbidedicated/v20171001:CapacityDetails"),
		},
	})
	opts = append(opts, aliases)
	var resource CapacityDetails
	err := ctx.RegisterResource("azurerm:powerbidedicated/latest:CapacityDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCapacityDetails(ctx *pulumi.Context,
	...
	var resource CapacityDetails
	err := ctx.ReadResource("azurerm:powerbidedicated/latest:CapacityDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
