...
func NewBudgetByResourceGroupName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:consumption/preview:BudgetByResourceGroupName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBudgetByResourceGroupName(ctx *pulumi.Context,
	...
	var resource BudgetByResourceGroupName
	err := ctx.ReadResource("azurerm:consumption/preview:BudgetByResourceGroupName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
