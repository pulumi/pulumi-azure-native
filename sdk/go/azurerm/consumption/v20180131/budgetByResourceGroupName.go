...
func NewBudgetByResourceGroupName(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:consumption/v20180331:BudgetByResourceGroupName"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:consumption/v20180131:BudgetByResourceGroupName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBudgetByResourceGroupName(ctx *pulumi.Context,
	...
	var resource BudgetByResourceGroupName
	err := ctx.ReadResource("azurerm:consumption/v20180131:BudgetByResourceGroupName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
