...
func NewBudget(ctx *pulumi.Context,
	...
	var resource Budget
	err := ctx.RegisterResource("azurerm:consumption/latest:Budget", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBudget(ctx *pulumi.Context,
	...
	var resource Budget
	err := ctx.ReadResource("azurerm:consumption/latest:Budget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
