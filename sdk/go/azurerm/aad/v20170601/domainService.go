...
// 			SubnetId:          pulumi.String("/subscriptions/1639790a-76a2-4ac4-98d9-8562f5dfcb4d/resourceGroups/Default-Networking/providers/Microsoft.Network/virtualNetworks/DCIaasTmpWusNet/subnets/Subnet-1"),
// 		})
// 		if err != nil {
// 			return err
// 		}
...
func NewDomainService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:aad/v20170601:DomainService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainService(ctx *pulumi.Context,
	...
	var resource DomainService
	err := ctx.ReadResource("azurerm:aad/v20170601:DomainService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
