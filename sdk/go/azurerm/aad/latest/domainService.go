...
func NewDomainService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:aad/latest:DomainService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainService(ctx *pulumi.Context,
	...
	var resource DomainService
	err := ctx.ReadResource("azurerm:aad/latest:DomainService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
