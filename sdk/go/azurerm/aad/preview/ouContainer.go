...
func NewOuContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:aad/preview:OuContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOuContainer(ctx *pulumi.Context,
	...
	var resource OuContainer
	err := ctx.ReadResource("azurerm:aad/preview:OuContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
