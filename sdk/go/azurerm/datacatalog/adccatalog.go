...
func NewADCCatalog(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datacatalog:ADCCatalog", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADCCatalog(ctx *pulumi.Context,
	...
	var resource ADCCatalog
	err := ctx.ReadResource("azurerm:datacatalog:ADCCatalog", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
