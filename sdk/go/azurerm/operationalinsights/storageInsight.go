...
func NewStorageInsight(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:operationalinsights:StorageInsight", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageInsight(ctx *pulumi.Context,
	...
	var resource StorageInsight
	err := ctx.ReadResource("azurerm:operationalinsights:StorageInsight", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
