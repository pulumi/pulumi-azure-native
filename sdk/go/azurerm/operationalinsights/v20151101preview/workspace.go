...
// 			Sku: &operationalinsights.SkuArgs{
// 				Name: pulumi.String("PerNode"),
// 			},
...
func NewWorkspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:operationalinsights/v20200801:Workspace"),
		},
	})
	opts = append(opts, aliases)
	var resource Workspace
	err := ctx.RegisterResource("azurerm:operationalinsights/v20151101preview:Workspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspace(ctx *pulumi.Context,
	...
	var resource Workspace
	err := ctx.ReadResource("azurerm:operationalinsights/v20151101preview:Workspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
