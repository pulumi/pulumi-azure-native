...
func NewBookmark(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:operationalinsights:Bookmark", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBookmark(ctx *pulumi.Context,
	...
	var resource Bookmark
	err := ctx.ReadResource("azurerm:operationalinsights:Bookmark", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
