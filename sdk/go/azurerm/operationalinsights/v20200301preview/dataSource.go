...
func NewDataSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:operationalinsights/v20200301preview:DataSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataSource(ctx *pulumi.Context,
	...
	var resource DataSource
	err := ctx.ReadResource("azurerm:operationalinsights/v20200301preview:DataSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
