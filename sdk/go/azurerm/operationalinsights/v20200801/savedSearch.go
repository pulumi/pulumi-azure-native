...
func NewSavedSearch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:operationalinsights/v20200801:SavedSearch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSavedSearch(ctx *pulumi.Context,
	...
	var resource SavedSearch
	err := ctx.ReadResource("azurerm:operationalinsights/v20200801:SavedSearch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
