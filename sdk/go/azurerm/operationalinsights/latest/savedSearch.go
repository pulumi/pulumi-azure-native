...
func NewSavedSearch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:operationalinsights/latest:SavedSearch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSavedSearch(ctx *pulumi.Context,
	...
	var resource SavedSearch
	err := ctx.ReadResource("azurerm:operationalinsights/latest:SavedSearch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
