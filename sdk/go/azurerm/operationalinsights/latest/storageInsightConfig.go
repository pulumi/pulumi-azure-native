...
func NewStorageInsightConfig(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:operationalinsights/preview:StorageInsightConfig"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:operationalinsights/latest:StorageInsightConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageInsightConfig(ctx *pulumi.Context,
	...
	var resource StorageInsightConfig
	err := ctx.ReadResource("azurerm:operationalinsights/latest:StorageInsightConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
