...
func NewLinkedStorageAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:operationalinsights/preview:LinkedStorageAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedStorageAccount(ctx *pulumi.Context,
	...
	var resource LinkedStorageAccount
	err := ctx.ReadResource("azurerm:operationalinsights/preview:LinkedStorageAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
