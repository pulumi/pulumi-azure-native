...
func NewMachineGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:operationalinsights/v20151101preview:MachineGroup"),
		},
	})
	opts = append(opts, aliases)
	var resource MachineGroup
	err := ctx.RegisterResource("azurerm:operationalinsights/preview:MachineGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineGroup(ctx *pulumi.Context,
	...
	var resource MachineGroup
	err := ctx.ReadResource("azurerm:operationalinsights/preview:MachineGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
