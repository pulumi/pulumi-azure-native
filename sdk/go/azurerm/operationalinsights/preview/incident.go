...
func NewIncident(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:operationalinsights/preview:Incident", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIncident(ctx *pulumi.Context,
	...
	var resource Incident
	err := ctx.ReadResource("azurerm:operationalinsights/preview:Incident", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
