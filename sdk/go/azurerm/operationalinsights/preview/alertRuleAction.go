...
func NewAlertRuleAction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:operationalinsights/preview:AlertRuleAction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertRuleAction(ctx *pulumi.Context,
	...
	var resource AlertRuleAction
	err := ctx.ReadResource("azurerm:operationalinsights/preview:AlertRuleAction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
