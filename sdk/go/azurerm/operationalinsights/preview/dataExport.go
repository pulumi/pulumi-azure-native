...
func NewDataExport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:operationalinsights/preview:DataExport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataExport(ctx *pulumi.Context,
	...
	var resource DataExport
	err := ctx.ReadResource("azurerm:operationalinsights/preview:DataExport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
