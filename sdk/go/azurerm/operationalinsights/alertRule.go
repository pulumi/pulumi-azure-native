...
func NewAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:operationalinsights:AlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertRule(ctx *pulumi.Context,
	...
	var resource AlertRule
	err := ctx.ReadResource("azurerm:operationalinsights:AlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
