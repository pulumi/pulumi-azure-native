...
func NewComputePolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datalakeanalytics/latest:ComputePolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputePolicy(ctx *pulumi.Context,
	...
	var resource ComputePolicy
	err := ctx.ReadResource("azurerm:datalakeanalytics/latest:ComputePolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
