...
func NewDatabaseAccountCassandraKeyspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:documentdb/v20160319:DatabaseAccountCassandraKeyspace"),
		},
	})
	opts = append(opts, aliases)
	var resource DatabaseAccountCassandraKeyspace
	err := ctx.RegisterResource("azurerm:documentdb/v20160331:DatabaseAccountCassandraKeyspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountCassandraKeyspace(ctx *pulumi.Context,
	...
	var resource DatabaseAccountCassandraKeyspace
	err := ctx.ReadResource("azurerm:documentdb/v20160331:DatabaseAccountCassandraKeyspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
