...
// A key-value pair of shard keys to be applied for the request.
func (o MongoDBCollectionPropertiesResponseOutput) ShardKey() pulumi.StringMapOutput {
	return o.ApplyT(func(v MongoDBCollectionPropertiesResponse) map[string]string { return v.ShardKey }).(pulumi.StringMapOutput)
}
...
// A key-value pair of shard keys to be applied for the request.
func (o MongoDBCollectionPropertiesResponsePtrOutput) ShardKey() pulumi.StringMapOutput {
	return o.ApplyT(func(v *MongoDBCollectionPropertiesResponse) map[string]string {
		if v == nil {
			return nil
		}
		return v.ShardKey
