...
// 		_, err := documentdb.NewDatabaseAccountGremlinDatabase(ctx, "databaseAccountGremlinDatabase", &documentdb.DatabaseAccountGremlinDatabaseArgs{
...
func NewDatabaseAccountGremlinDatabase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:documentdb/v20150408:DatabaseAccountGremlinDatabase"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:documentdb/v20150401:DatabaseAccountGremlinDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountGremlinDatabase(ctx *pulumi.Context,
	...
	var resource DatabaseAccountGremlinDatabase
	err := ctx.ReadResource("azurerm:documentdb/v20150401:DatabaseAccountGremlinDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
