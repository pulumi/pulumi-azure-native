...
func NewDatabaseAccountCassandraKeyspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb:DatabaseAccountCassandraKeyspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountCassandraKeyspace(ctx *pulumi.Context,
	...
	var resource DatabaseAccountCassandraKeyspace
	err := ctx.ReadResource("azurerm:documentdb:DatabaseAccountCassandraKeyspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
