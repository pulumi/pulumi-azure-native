...
func NewDatabaseAccountGremlinGraph(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb/v20151106:DatabaseAccountGremlinGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountGremlinGraph(ctx *pulumi.Context,
	...
	var resource DatabaseAccountGremlinGraph
	err := ctx.ReadResource("azurerm:documentdb/v20151106:DatabaseAccountGremlinGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
