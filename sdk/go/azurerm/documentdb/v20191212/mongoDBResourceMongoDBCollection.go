...
func NewMongoDBResourceMongoDBCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb/v20191212:MongoDBResourceMongoDBCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoDBResourceMongoDBCollection(ctx *pulumi.Context,
	...
	var resource MongoDBResourceMongoDBCollection
	err := ctx.ReadResource("azurerm:documentdb/v20191212:MongoDBResourceMongoDBCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
