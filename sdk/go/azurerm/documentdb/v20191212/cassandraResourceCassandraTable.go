...
func NewCassandraResourceCassandraTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb/v20191212:CassandraResourceCassandraTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCassandraResourceCassandraTable(ctx *pulumi.Context,
	...
	var resource CassandraResourceCassandraTable
	err := ctx.ReadResource("azurerm:documentdb/v20191212:CassandraResourceCassandraTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
