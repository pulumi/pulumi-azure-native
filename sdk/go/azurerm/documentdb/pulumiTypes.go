...
type DatabaseAccountCreateUpdatePropertiesArgs struct {
	...
	// List of IpRules.
	IpRules IPRulesPtrInput `pulumi:"ipRules"`
	// Flag to indicate whether to enable/disable Virtual Network ACL rules.
...
// List of IpRules.
func (o DatabaseAccountCreateUpdatePropertiesOutput) IpRules() IPRulesPtrOutput {
	return o.ApplyT(func(v DatabaseAccountCreateUpdateProperties) *IPRules { return v.IpRules }).(IPRulesPtrOutput)
}
...
// List of IpRules.
func (o DatabaseAccountCreateUpdatePropertiesPtrOutput) IpRules() IPRulesPtrOutput {
	return o.ApplyT(func(v *DatabaseAccountCreateUpdateProperties) *IPRules {
		if v == nil {
			return nil
		}
		return v.IpRules
...
type DatabaseAccountGetPropertiesResponseArgs struct {
	...
	// List of IpRules.
	IpRules IPRulesResponsePtrInput `pulumi:"ipRules"`
	// Flag to indicate whether to enable/disable Virtual Network ACL rules.
	IsVirtualNetworkFilterEnabled pulumi.BoolPtrInput `pulumi:"isVirtualNetworkFilterEnabled"`
	// The URI of the key vault
	KeyVaultKeyUri pulumi.StringPtrInput `pulumi:"keyVaultKeyUri"`
...
// API specific properties.
func (o DatabaseAccountGetPropertiesResponseOutput) ApiProperties() ApiPropertiesResponsePtrOutput {
	return o.ApplyT(func(v DatabaseAccountGetPropertiesResponse) *ApiPropertiesResponse { return v.ApiProperties }).(ApiPropertiesResponsePtrOutput)
}
...
// Flag to indicate whether to enable storage analytics.
func (o DatabaseAccountGetPropertiesResponseOutput) EnableAnalyticalStorage() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v DatabaseAccountGetPropertiesResponse) *bool { return v.EnableAnalyticalStorage }).(pulumi.BoolPtrOutput)
}
...
// Flag to indicate whether Free Tier is enabled.
func (o DatabaseAccountGetPropertiesResponseOutput) EnableFreeTier() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v DatabaseAccountGetPropertiesResponse) *bool { return v.EnableFreeTier }).(pulumi.BoolPtrOutput)
}
...
// List of IpRules.
func (o DatabaseAccountGetPropertiesResponseOutput) IpRules() IPRulesResponsePtrOutput {
	return o.ApplyT(func(v DatabaseAccountGetPropertiesResponse) *IPRulesResponse { return v.IpRules }).(IPRulesResponsePtrOutput)
}
...
// API specific properties.
func (o DatabaseAccountGetPropertiesResponsePtrOutput) ApiProperties() ApiPropertiesResponsePtrOutput {
	return o.ApplyT(func(v *DatabaseAccountGetPropertiesResponse) *ApiPropertiesResponse {
		if v == nil {
			return nil
		}
		return v.ApiProperties
...
// Flag to indicate whether to enable storage analytics.
func (o DatabaseAccountGetPropertiesResponsePtrOutput) EnableAnalyticalStorage() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *DatabaseAccountGetPropertiesResponse) *bool {
		if v == nil {
			return nil
		}
...
// Flag to indicate whether Free Tier is enabled.
func (o DatabaseAccountGetPropertiesResponsePtrOutput) EnableFreeTier() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *DatabaseAccountGetPropertiesResponse) *bool {
		if v == nil {
			return nil
		}
...
// List of IpRules.
func (o DatabaseAccountGetPropertiesResponsePtrOutput) IpRules() IPRulesResponsePtrOutput {
	return o.ApplyT(func(v *DatabaseAccountGetPropertiesResponse) *IPRulesResponse {
		if v == nil {
			return nil
		}
		return v.IpRules
	}).(IPRulesResponsePtrOutput)
}
...
func (i IPRulesArgs) ToIPRulesPtrOutput() IPRulesPtrOutput {
	return i.ToIPRulesPtrOutputWithContext(context.Background())
}

func (i IPRulesArgs) ToIPRulesPtrOutputWithContext(ctx context.Context) IPRulesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IPRulesOutput).ToIPRulesPtrOutputWithContext(ctx)
}

// IPRulesPtrInput is an input type that accepts IPRulesArgs, IPRulesPtr and IPRulesPtrOutput values.
// You can construct a concrete instance of `IPRulesPtrInput` via:
//
//          IPRulesArgs{...}
//
//  or:
//
//          nil
type IPRulesPtrInput interface {
	pulumi.Input

	ToIPRulesPtrOutput() IPRulesPtrOutput
	ToIPRulesPtrOutputWithContext(context.Context) IPRulesPtrOutput
}

type iprulesPtrType IPRulesArgs

func IPRulesPtr(v *IPRulesArgs) IPRulesPtrInput {
	return (*iprulesPtrType)(v)
}

func (*iprulesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**IPRules)(nil)).Elem()
}

func (i *iprulesPtrType) ToIPRulesPtrOutput() IPRulesPtrOutput {
	return i.ToIPRulesPtrOutputWithContext(context.Background())
}

func (i *iprulesPtrType) ToIPRulesPtrOutputWithContext(ctx context.Context) IPRulesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IPRulesPtrOutput)
}
...
func (o IPRulesOutput) ToIPRulesPtrOutput() IPRulesPtrOutput {
	return o.ToIPRulesPtrOutputWithContext(context.Background())
}

func (o IPRulesOutput) ToIPRulesPtrOutputWithContext(ctx context.Context) IPRulesPtrOutput {
	return o.ApplyT(func(v IPRules) *IPRules {
		return &v
	}).(IPRulesPtrOutput)
}

type IPRulesPtrOutput struct{ *pulumi.OutputState }

func (IPRulesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**IPRules)(nil)).Elem()
}

func (o IPRulesPtrOutput) ToIPRulesPtrOutput() IPRulesPtrOutput {
	return o
}

func (o IPRulesPtrOutput) ToIPRulesPtrOutputWithContext(ctx context.Context) IPRulesPtrOutput {
	return o
}

func (o IPRulesPtrOutput) Elem() IPRulesOutput {
	return o.ApplyT(func(v *IPRules) IPRules { return *v }).(IPRulesOutput)
}
...
// IPRulesResponseInput is an input type that accepts IPRulesResponseArgs and IPRulesResponseOutput values.
// You can construct a concrete instance of `IPRulesResponseInput` via:
//
//          IPRulesResponseArgs{...}
type IPRulesResponseInput interface {
	pulumi.Input

	ToIPRulesResponseOutput() IPRulesResponseOutput
	ToIPRulesResponseOutputWithContext(context.Context) IPRulesResponseOutput
}

// Array of IpAddressOrRange objects.
type IPRulesResponseArgs struct {
}

func (IPRulesResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*IPRulesResponse)(nil)).Elem()
}

func (i IPRulesResponseArgs) ToIPRulesResponseOutput() IPRulesResponseOutput {
	return i.ToIPRulesResponseOutputWithContext(context.Background())
}

func (i IPRulesResponseArgs) ToIPRulesResponseOutputWithContext(ctx context.Context) IPRulesResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IPRulesResponseOutput)
}

func (i IPRulesResponseArgs) ToIPRulesResponsePtrOutput() IPRulesResponsePtrOutput {
	return i.ToIPRulesResponsePtrOutputWithContext(context.Background())
}

func (i IPRulesResponseArgs) ToIPRulesResponsePtrOutputWithContext(ctx context.Context) IPRulesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IPRulesResponseOutput).ToIPRulesResponsePtrOutputWithContext(ctx)
}

// IPRulesResponsePtrInput is an input type that accepts IPRulesResponseArgs, IPRulesResponsePtr and IPRulesResponsePtrOutput values.
// You can construct a concrete instance of `IPRulesResponsePtrInput` via:
//
//          IPRulesResponseArgs{...}
//
//  or:
//
//          nil
type IPRulesResponsePtrInput interface {
	pulumi.Input

	ToIPRulesResponsePtrOutput() IPRulesResponsePtrOutput
	ToIPRulesResponsePtrOutputWithContext(context.Context) IPRulesResponsePtrOutput
}

type iprulesResponsePtrType IPRulesResponseArgs

func IPRulesResponsePtr(v *IPRulesResponseArgs) IPRulesResponsePtrInput {
	return (*iprulesResponsePtrType)(v)
}

func (*iprulesResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**IPRulesResponse)(nil)).Elem()
}

func (i *iprulesResponsePtrType) ToIPRulesResponsePtrOutput() IPRulesResponsePtrOutput {
	return i.ToIPRulesResponsePtrOutputWithContext(context.Background())
}

func (i *iprulesResponsePtrType) ToIPRulesResponsePtrOutputWithContext(ctx context.Context) IPRulesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IPRulesResponsePtrOutput)
}
...
func (o IPRulesResponseOutput) ToIPRulesResponsePtrOutput() IPRulesResponsePtrOutput {
	return o.ToIPRulesResponsePtrOutputWithContext(context.Background())
}

func (o IPRulesResponseOutput) ToIPRulesResponsePtrOutputWithContext(ctx context.Context) IPRulesResponsePtrOutput {
	return o.ApplyT(func(v IPRulesResponse) *IPRulesResponse {
		return &v
	}).(IPRulesResponsePtrOutput)
}

type IPRulesResponsePtrOutput struct{ *pulumi.OutputState }

func (IPRulesResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**IPRulesResponse)(nil)).Elem()
}

func (o IPRulesResponsePtrOutput) ToIPRulesResponsePtrOutput() IPRulesResponsePtrOutput {
	return o
}

func (o IPRulesResponsePtrOutput) ToIPRulesResponsePtrOutputWithContext(ctx context.Context) IPRulesResponsePtrOutput {
	return o
}

func (o IPRulesResponsePtrOutput) Elem() IPRulesResponseOutput {
	return o.ApplyT(func(v *IPRulesResponse) IPRulesResponse { return *v }).(IPRulesResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(IPRulesResponsePtrOutput{})
