...
func NewSqlResourceSqlTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb/v20190801:SqlResourceSqlTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlTrigger(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlTrigger
	err := ctx.ReadResource("azurerm:documentdb/v20190801:SqlResourceSqlTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
