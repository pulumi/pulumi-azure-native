...
func NewCassandraResourceCassandraKeyspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb:CassandraResourceCassandraKeyspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCassandraResourceCassandraKeyspace(ctx *pulumi.Context,
	...
	var resource CassandraResourceCassandraKeyspace
	err := ctx.ReadResource("azurerm:documentdb:CassandraResourceCassandraKeyspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
