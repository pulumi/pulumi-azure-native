...
func NewSqlResourceSqlUserDefinedFunction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb/preview:SqlResourceSqlUserDefinedFunction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlUserDefinedFunction(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlUserDefinedFunction
	err := ctx.ReadResource("azurerm:documentdb/preview:SqlResourceSqlUserDefinedFunction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
