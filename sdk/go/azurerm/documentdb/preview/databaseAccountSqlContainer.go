...
func NewDatabaseAccountSqlContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb/preview:DatabaseAccountSqlContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountSqlContainer(ctx *pulumi.Context,
	...
	var resource DatabaseAccountSqlContainer
	err := ctx.ReadResource("azurerm:documentdb/preview:DatabaseAccountSqlContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
