...
func NewDatabaseAccountMongoDBDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb/preview:DatabaseAccountMongoDBDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountMongoDBDatabase(ctx *pulumi.Context,
	...
	var resource DatabaseAccountMongoDBDatabase
	err := ctx.ReadResource("azurerm:documentdb/preview:DatabaseAccountMongoDBDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
