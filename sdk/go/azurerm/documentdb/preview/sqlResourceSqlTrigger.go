...
func NewSqlResourceSqlTrigger(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:documentdb/v20200401:SqlResourceSqlTrigger"),
		},
		{
			Type: pulumi.String("azurerm:documentdb/v20200601preview:SqlResourceSqlTrigger"),
		},
	})
	opts = append(opts, aliases)
	var resource SqlResourceSqlTrigger
	err := ctx.RegisterResource("azurerm:documentdb/preview:SqlResourceSqlTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlTrigger(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlTrigger
	err := ctx.ReadResource("azurerm:documentdb/preview:SqlResourceSqlTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
