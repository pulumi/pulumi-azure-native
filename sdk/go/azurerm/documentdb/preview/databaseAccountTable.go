...
func NewDatabaseAccountTable(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:documentdb/v20151106:DatabaseAccountTable"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:documentdb/preview:DatabaseAccountTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountTable(ctx *pulumi.Context,
	...
	var resource DatabaseAccountTable
	err := ctx.ReadResource("azurerm:documentdb/preview:DatabaseAccountTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
