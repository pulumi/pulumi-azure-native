...
func NewDatabaseAccountCassandraTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb/preview:DatabaseAccountCassandraTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountCassandraTable(ctx *pulumi.Context,
	...
	var resource DatabaseAccountCassandraTable
	err := ctx.ReadResource("azurerm:documentdb/preview:DatabaseAccountCassandraTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
