...
func NewSqlResourceSqlDatabase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:documentdb/v20200401:SqlResourceSqlDatabase"),
		},
	})
	opts = append(opts, aliases)
	var resource SqlResourceSqlDatabase
	err := ctx.RegisterResource("azurerm:documentdb/v20200601preview:SqlResourceSqlDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlDatabase(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlDatabase
	err := ctx.ReadResource("azurerm:documentdb/v20200601preview:SqlResourceSqlDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
