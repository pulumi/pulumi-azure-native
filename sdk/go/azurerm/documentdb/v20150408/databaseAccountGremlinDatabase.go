...
//
// import (
// 	documentdb "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20150408"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func GetDatabaseAccountGremlinDatabase(ctx *pulumi.Context,
	...
	var resource DatabaseAccountGremlinDatabase
	err := ctx.ReadResource("azurerm:documentdb/v20150408:DatabaseAccountGremlinDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
