...
type DatabaseAccountGetPropertiesResponseArgs struct {
	...
	// List of IpRules.
	IpRules IpAddressOrRangeResponseArrayInput `pulumi:"ipRules"`
	// Flag to indicate whether to enable/disable Virtual Network ACL rules.
...
// List of IpRules.
func (o DatabaseAccountGetPropertiesResponseOutput) IpRules() IpAddressOrRangeResponseArrayOutput {
	return o.ApplyT(func(v DatabaseAccountGetPropertiesResponse) []IpAddressOrRangeResponse { return v.IpRules }).(IpAddressOrRangeResponseArrayOutput)
}
...
// List of IpRules.
func (o DatabaseAccountGetPropertiesResponsePtrOutput) IpRules() IpAddressOrRangeResponseArrayOutput {
	return o.ApplyT(func(v *DatabaseAccountGetPropertiesResponse) []IpAddressOrRangeResponse {
		if v == nil {
			return nil
		}
		return v.IpRules
	}).(IpAddressOrRangeResponseArrayOutput)
}
