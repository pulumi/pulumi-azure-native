...
func NewGremlinResourceGremlinGraph(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb/latest:GremlinResourceGremlinGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGremlinResourceGremlinGraph(ctx *pulumi.Context,
	...
	var resource GremlinResourceGremlinGraph
	err := ctx.ReadResource("azurerm:documentdb/latest:GremlinResourceGremlinGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
