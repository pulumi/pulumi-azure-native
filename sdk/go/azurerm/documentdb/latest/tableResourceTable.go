...
func NewTableResourceTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb/latest:TableResourceTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableResourceTable(ctx *pulumi.Context,
	...
	var resource TableResourceTable
	err := ctx.ReadResource("azurerm:documentdb/latest:TableResourceTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
