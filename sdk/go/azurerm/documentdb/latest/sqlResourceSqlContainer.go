...
func NewSqlResourceSqlContainer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:documentdb/v20200601preview:SqlResourceSqlContainer"),
		},
	})
	opts = append(opts, aliases)
	var resource SqlResourceSqlContainer
	err := ctx.RegisterResource("azurerm:documentdb/latest:SqlResourceSqlContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlContainer(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlContainer
	err := ctx.ReadResource("azurerm:documentdb/latest:SqlResourceSqlContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
