...
func NewNotebookWorkspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:documentdb:NotebookWorkspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotebookWorkspace(ctx *pulumi.Context,
	...
	var resource NotebookWorkspace
	err := ctx.ReadResource("azurerm:documentdb:NotebookWorkspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
