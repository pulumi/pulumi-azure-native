...
//
// import (
// 	management "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/management/v20170601preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
// 			ManagementGroupId: pulumi.String("mgid"),
...
func NewPolicySetDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:management/v20180501:PolicySetDefinitionAtManagementGroup"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:management/v20170601preview:PolicySetDefinitionAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	var resource PolicySetDefinitionAtManagementGroup
	err := ctx.ReadResource("azurerm:management/v20170601preview:PolicySetDefinitionAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
