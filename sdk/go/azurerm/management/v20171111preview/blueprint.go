...
func NewBlueprint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:management/preview:Blueprint"),
		},
	})
	opts = append(opts, aliases)
	var resource Blueprint
	err := ctx.RegisterResource("azurerm:management/v20171111preview:Blueprint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlueprint(ctx *pulumi.Context,
	...
	var resource Blueprint
	err := ctx.ReadResource("azurerm:management/v20171111preview:Blueprint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
