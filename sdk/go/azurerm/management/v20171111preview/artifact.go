...
func NewArtifact(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:management/preview:Artifact"),
		},
	})
	opts = append(opts, aliases)
	var resource Artifact
	err := ctx.RegisterResource("azurerm:management/v20171111preview:Artifact", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArtifact(ctx *pulumi.Context,
	...
	var resource Artifact
	err := ctx.ReadResource("azurerm:management/v20171111preview:Artifact", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
