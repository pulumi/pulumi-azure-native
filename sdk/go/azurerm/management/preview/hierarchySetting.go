...
func NewHierarchySetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:management/preview:HierarchySetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHierarchySetting(ctx *pulumi.Context,
	...
	var resource HierarchySetting
	err := ctx.ReadResource("azurerm:management/preview:HierarchySetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
