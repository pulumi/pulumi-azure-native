...
func NewPolicyDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:management/preview:PolicyDefinitionAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	var resource PolicyDefinitionAtManagementGroup
	err := ctx.ReadResource("azurerm:management/preview:PolicyDefinitionAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
