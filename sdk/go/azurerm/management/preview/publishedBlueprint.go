...
func NewPublishedBlueprint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:management/v20171111preview:PublishedBlueprint"),
		},
	})
	opts = append(opts, aliases)
	var resource PublishedBlueprint
	err := ctx.RegisterResource("azurerm:management/preview:PublishedBlueprint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublishedBlueprint(ctx *pulumi.Context,
	...
	var resource PublishedBlueprint
	err := ctx.ReadResource("azurerm:management/preview:PublishedBlueprint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
