...
func NewManagementGroupSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:management/latest:ManagementGroupSubscription"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:management/preview:ManagementGroupSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementGroupSubscription(ctx *pulumi.Context,
	...
	var resource ManagementGroupSubscription
	err := ctx.ReadResource("azurerm:management/preview:ManagementGroupSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
