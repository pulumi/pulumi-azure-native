...
func NewManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:management/preview:ManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementGroup(ctx *pulumi.Context,
	...
	var resource ManagementGroup
	err := ctx.ReadResource("azurerm:management/preview:ManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
