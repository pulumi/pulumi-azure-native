...
func NewManagementGroupDiagnosticSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:management/v20200101preview:ManagementGroupDiagnosticSetting"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagementGroupDiagnosticSetting
	err := ctx.RegisterResource("azurerm:management/preview:ManagementGroupDiagnosticSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementGroupDiagnosticSetting(ctx *pulumi.Context,
	...
	var resource ManagementGroupDiagnosticSetting
	err := ctx.ReadResource("azurerm:management/preview:ManagementGroupDiagnosticSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
