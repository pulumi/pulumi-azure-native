...
//
// import (
// 	management "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/management/v20200501"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewHierarchySetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:management/v20200501:HierarchySetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHierarchySetting(ctx *pulumi.Context,
	...
	var resource HierarchySetting
	err := ctx.ReadResource("azurerm:management/v20200501:HierarchySetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
