...
func NewManagementGroupSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:management/latest:ManagementGroupSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementGroupSubscription(ctx *pulumi.Context,
	...
	var resource ManagementGroupSubscription
	err := ctx.ReadResource("azurerm:management/latest:ManagementGroupSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
