...
func NewDeploymentAtManagementGroupScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:management/v20200601:DeploymentAtManagementGroupScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtManagementGroupScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtManagementGroupScope
	err := ctx.ReadResource("azurerm:management/v20200601:DeploymentAtManagementGroupScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
