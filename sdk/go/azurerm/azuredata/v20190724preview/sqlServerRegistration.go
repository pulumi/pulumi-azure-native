...
func NewSqlServerRegistration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:azuredata/latest:SqlServerRegistration"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:azuredata/v20190724preview:SqlServerRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServerRegistration(ctx *pulumi.Context,
	...
	var resource SqlServerRegistration
	err := ctx.ReadResource("azurerm:azuredata/v20190724preview:SqlServerRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
