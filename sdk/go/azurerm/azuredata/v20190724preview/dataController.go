...
func NewDataController(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:azuredata/latest:DataController"),
		},
	})
...
func GetDataController(ctx *pulumi.Context,
	...
	var resource DataController
	err := ctx.ReadResource("azurerm:azuredata/v20190724preview:DataController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
