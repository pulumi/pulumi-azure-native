...
func NewSqlServerRegistration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:azuredata/v20190724preview:SqlServerRegistration"),
		},
	})
	opts = append(opts, aliases)
	var resource SqlServerRegistration
	err := ctx.RegisterResource("azurerm:azuredata/preview:SqlServerRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServerRegistration(ctx *pulumi.Context,
	...
	var resource SqlServerRegistration
	err := ctx.ReadResource("azurerm:azuredata/preview:SqlServerRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
