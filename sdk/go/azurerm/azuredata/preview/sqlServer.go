...
func NewSqlServer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:azuredata/v20170301preview:SqlServer"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:azuredata/preview:SqlServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServer(ctx *pulumi.Context,
	...
	var resource SqlServer
	err := ctx.ReadResource("azurerm:azuredata/preview:SqlServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
