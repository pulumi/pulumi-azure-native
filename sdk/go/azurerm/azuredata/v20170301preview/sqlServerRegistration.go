...
func NewSqlServerRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:azuredata/v20170301preview:SqlServerRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServerRegistration(ctx *pulumi.Context,
	...
	var resource SqlServerRegistration
	err := ctx.ReadResource("azurerm:azuredata/v20170301preview:SqlServerRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
