...
func NewJitRequest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:solutions:JitRequest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJitRequest(ctx *pulumi.Context,
	...
	var resource JitRequest
	err := ctx.ReadResource("azurerm:solutions:JitRequest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
