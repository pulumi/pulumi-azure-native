...
func NewApplianceDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:solutions/v20160901preview:ApplianceDefinition"),
		},
	})
	opts = append(opts, aliases)
	var resource ApplianceDefinition
	err := ctx.RegisterResource("azurerm:solutions/preview:ApplianceDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplianceDefinition(ctx *pulumi.Context,
	...
	var resource ApplianceDefinition
	err := ctx.ReadResource("azurerm:solutions/preview:ApplianceDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
