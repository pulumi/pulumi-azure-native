...
func NewAppliance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:solutions/v20160901preview:Appliance"),
		},
	})
	opts = append(opts, aliases)
	var resource Appliance
	err := ctx.RegisterResource("azurerm:solutions/preview:Appliance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppliance(ctx *pulumi.Context,
	...
	var resource Appliance
	err := ctx.ReadResource("azurerm:solutions/preview:Appliance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
