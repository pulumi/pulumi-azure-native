...
func NewApplicationDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:solutions/preview:ApplicationDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationDefinition(ctx *pulumi.Context,
	...
	var resource ApplicationDefinition
	err := ctx.ReadResource("azurerm:solutions/preview:ApplicationDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
