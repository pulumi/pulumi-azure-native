...
func NewSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devtestlab/latest:Schedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchedule(ctx *pulumi.Context,
	...
	var resource Schedule
	err := ctx.ReadResource("azurerm:devtestlab/latest:Schedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
