...
func NewGlobalSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devtestlab/latest:GlobalSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalSchedule(ctx *pulumi.Context,
	...
	var resource GlobalSchedule
	err := ctx.ReadResource("azurerm:devtestlab/latest:GlobalSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
