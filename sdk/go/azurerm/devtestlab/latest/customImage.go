...
func NewCustomImage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:devtestlab/preview:CustomImage"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:devtestlab/latest:CustomImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomImage(ctx *pulumi.Context,
	...
	var resource CustomImage
	err := ctx.ReadResource("azurerm:devtestlab/latest:CustomImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
