...
func NewServiceFabric(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:devtestlab/v20180915:ServiceFabric"),
		},
	})
	opts = append(opts, aliases)
	var resource ServiceFabric
	err := ctx.RegisterResource("azurerm:devtestlab/latest:ServiceFabric", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceFabric(ctx *pulumi.Context,
	...
	var resource ServiceFabric
	err := ctx.ReadResource("azurerm:devtestlab/latest:ServiceFabric", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
