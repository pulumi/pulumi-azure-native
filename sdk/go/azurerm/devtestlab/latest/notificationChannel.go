...
func NewNotificationChannel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devtestlab/latest:NotificationChannel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationChannel(ctx *pulumi.Context,
	...
	var resource NotificationChannel
	err := ctx.ReadResource("azurerm:devtestlab/latest:NotificationChannel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
