...
func NewArtifactSource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:devtestlab/preview:ArtifactSource"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/v20150521preview:ArtifactSource"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/v20160515:ArtifactSource"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:devtestlab/latest:ArtifactSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArtifactSource(ctx *pulumi.Context,
	...
	var resource ArtifactSource
	err := ctx.ReadResource("azurerm:devtestlab/latest:ArtifactSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
