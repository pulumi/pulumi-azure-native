...
func NewVirtualNetwork(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:devtestlab/preview:VirtualNetwork"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/v20150521preview:VirtualNetwork"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/v20160515:VirtualNetwork"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/v20180915:VirtualNetwork"),
		},
	})
	opts = append(opts, aliases)
	var resource VirtualNetwork
	err := ctx.RegisterResource("azurerm:devtestlab/latest:VirtualNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetwork(ctx *pulumi.Context,
	...
	var resource VirtualNetwork
	err := ctx.ReadResource("azurerm:devtestlab/latest:VirtualNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
