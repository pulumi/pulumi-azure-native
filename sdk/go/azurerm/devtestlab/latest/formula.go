...
func NewFormula(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:devtestlab/v20180915:Formula"),
		},
	})
	opts = append(opts, aliases)
	var resource Formula
	err := ctx.RegisterResource("azurerm:devtestlab/latest:Formula", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFormula(ctx *pulumi.Context,
	...
	var resource Formula
	err := ctx.ReadResource("azurerm:devtestlab/latest:Formula", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
