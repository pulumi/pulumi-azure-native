...
func NewArtifactSource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:devtestlab/latest:ArtifactSource"),
		},
		{
...
func GetArtifactSource(ctx *pulumi.Context,
	...
	var resource ArtifactSource
	err := ctx.ReadResource("azurerm:devtestlab/v20160515:ArtifactSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
