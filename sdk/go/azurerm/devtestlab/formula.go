...
func NewFormula(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devtestlab:Formula", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFormula(ctx *pulumi.Context,
	...
	var resource Formula
	err := ctx.ReadResource("azurerm:devtestlab:Formula", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
