...
func NewCustomImage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devtestlab/v20180915:CustomImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomImage(ctx *pulumi.Context,
	...
	var resource CustomImage
	err := ctx.ReadResource("azurerm:devtestlab/v20180915:CustomImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
