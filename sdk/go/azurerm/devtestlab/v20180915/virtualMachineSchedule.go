...
func NewVirtualMachineSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devtestlab/v20180915:VirtualMachineSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineSchedule(ctx *pulumi.Context,
	...
	var resource VirtualMachineSchedule
	err := ctx.ReadResource("azurerm:devtestlab/v20180915:VirtualMachineSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
