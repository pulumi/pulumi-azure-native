...
func NewVirtualMachineResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:devtestlab/latest:VirtualMachineResource"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/preview:VirtualMachineResource"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/v20160515:VirtualMachineResource"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/v20180915:VirtualMachineResource"),
		},
	})
	opts = append(opts, aliases)
	var resource VirtualMachineResource
	err := ctx.RegisterResource("azurerm:devtestlab/v20150521preview:VirtualMachineResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineResource(ctx *pulumi.Context,
	...
	var resource VirtualMachineResource
	err := ctx.ReadResource("azurerm:devtestlab/v20150521preview:VirtualMachineResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
