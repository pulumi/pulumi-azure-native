...
func NewCustomImageResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:devtestlab/v20180915:CustomImageResource"),
		},
	})
	opts = append(opts, aliases)
	var resource CustomImageResource
	err := ctx.RegisterResource("azurerm:devtestlab/v20150521preview:CustomImageResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomImageResource(ctx *pulumi.Context,
	...
	var resource CustomImageResource
	err := ctx.ReadResource("azurerm:devtestlab/v20150521preview:CustomImageResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
