...
func NewVirtualNetworkResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:devtestlab/latest:VirtualNetworkResource"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/preview:VirtualNetworkResource"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/v20160515:VirtualNetworkResource"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/v20180915:VirtualNetworkResource"),
		},
	})
	opts = append(opts, aliases)
	var resource VirtualNetworkResource
	err := ctx.RegisterResource("azurerm:devtestlab/v20150521preview:VirtualNetworkResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkResource(ctx *pulumi.Context,
	...
	var resource VirtualNetworkResource
	err := ctx.ReadResource("azurerm:devtestlab/v20150521preview:VirtualNetworkResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
