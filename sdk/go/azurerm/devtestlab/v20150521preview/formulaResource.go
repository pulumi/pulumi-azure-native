...
func NewFormulaResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:devtestlab/v20180915:FormulaResource"),
		},
	})
	opts = append(opts, aliases)
	var resource FormulaResource
	err := ctx.RegisterResource("azurerm:devtestlab/v20150521preview:FormulaResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFormulaResource(ctx *pulumi.Context,
	...
	var resource FormulaResource
	err := ctx.ReadResource("azurerm:devtestlab/v20150521preview:FormulaResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
