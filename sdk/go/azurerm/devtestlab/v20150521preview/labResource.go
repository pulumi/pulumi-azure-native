...
func NewLabResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:devtestlab/v20180915:LabResource"),
		},
	})
	opts = append(opts, aliases)
	var resource LabResource
	err := ctx.RegisterResource("azurerm:devtestlab/v20150521preview:LabResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLabResource(ctx *pulumi.Context,
	...
	var resource LabResource
	err := ctx.ReadResource("azurerm:devtestlab/v20150521preview:LabResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
