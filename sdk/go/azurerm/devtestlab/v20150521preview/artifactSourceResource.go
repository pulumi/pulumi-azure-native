...
func NewArtifactSourceResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:devtestlab/v20180915:ArtifactSourceResource"),
		},
	})
	opts = append(opts, aliases)
	var resource ArtifactSourceResource
	err := ctx.RegisterResource("azurerm:devtestlab/v20150521preview:ArtifactSourceResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArtifactSourceResource(ctx *pulumi.Context,
	...
	var resource ArtifactSourceResource
	err := ctx.ReadResource("azurerm:devtestlab/v20150521preview:ArtifactSourceResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
