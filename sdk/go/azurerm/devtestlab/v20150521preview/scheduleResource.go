...
func NewScheduleResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:devtestlab/latest:ScheduleResource"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/preview:ScheduleResource"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/v20160515:ScheduleResource"),
		},
		{
			Type: pulumi.String("azurerm:devtestlab/v20180915:ScheduleResource"),
		},
	})
	opts = append(opts, aliases)
	var resource ScheduleResource
	err := ctx.RegisterResource("azurerm:devtestlab/v20150521preview:ScheduleResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduleResource(ctx *pulumi.Context,
	...
	var resource ScheduleResource
	err := ctx.ReadResource("azurerm:devtestlab/v20150521preview:ScheduleResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
