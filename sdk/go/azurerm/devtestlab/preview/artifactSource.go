...
func NewArtifactSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devtestlab/preview:ArtifactSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArtifactSource(ctx *pulumi.Context,
	...
	var resource ArtifactSource
	err := ctx.ReadResource("azurerm:devtestlab/preview:ArtifactSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
