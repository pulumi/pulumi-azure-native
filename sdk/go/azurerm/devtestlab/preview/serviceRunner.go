...
func NewServiceRunner(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devtestlab/preview:ServiceRunner", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceRunner(ctx *pulumi.Context,
	...
	var resource ServiceRunner
	err := ctx.ReadResource("azurerm:devtestlab/preview:ServiceRunner", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
