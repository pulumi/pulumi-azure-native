...
func NewServiceFabric(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devtestlab/preview:ServiceFabric", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceFabric(ctx *pulumi.Context,
	...
	var resource ServiceFabric
	err := ctx.ReadResource("azurerm:devtestlab/preview:ServiceFabric", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
