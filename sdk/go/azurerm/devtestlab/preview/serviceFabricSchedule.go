...
func NewServiceFabricSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devtestlab/preview:ServiceFabricSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceFabricSchedule(ctx *pulumi.Context,
	...
	var resource ServiceFabricSchedule
	err := ctx.ReadResource("azurerm:devtestlab/preview:ServiceFabricSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
