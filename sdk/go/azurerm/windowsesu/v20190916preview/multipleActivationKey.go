...
func NewMultipleActivationKey(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:windowsesu/preview:MultipleActivationKey"),
		},
	})
...
func GetMultipleActivationKey(ctx *pulumi.Context,
	...
	var resource MultipleActivationKey
	err := ctx.ReadResource("azurerm:windowsesu/v20190916preview:MultipleActivationKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
