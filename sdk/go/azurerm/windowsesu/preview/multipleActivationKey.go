...
func NewMultipleActivationKey(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:windowsesu/v20190916preview:MultipleActivationKey"),
		},
	})
	opts = append(opts, aliases)
	var resource MultipleActivationKey
	err := ctx.RegisterResource("azurerm:windowsesu/preview:MultipleActivationKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMultipleActivationKey(ctx *pulumi.Context,
	...
	var resource MultipleActivationKey
	err := ctx.ReadResource("azurerm:windowsesu/preview:MultipleActivationKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
