...
func NewRelationship(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:customerinsights:Relationship", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRelationship(ctx *pulumi.Context,
	...
	var resource Relationship
	err := ctx.ReadResource("azurerm:customerinsights:Relationship", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
