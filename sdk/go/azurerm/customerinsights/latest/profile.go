...
func NewProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:customerinsights/latest:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("azurerm:customerinsights/latest:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
