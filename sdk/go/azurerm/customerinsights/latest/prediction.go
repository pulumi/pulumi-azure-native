...
func NewPrediction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:customerinsights/latest:Prediction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrediction(ctx *pulumi.Context,
	...
	var resource Prediction
	err := ctx.ReadResource("azurerm:customerinsights/latest:Prediction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
