...
func NewConnectorMapping(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:customerinsights/v20170101:ConnectorMapping"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:customerinsights/latest:ConnectorMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectorMapping(ctx *pulumi.Context,
	...
	var resource ConnectorMapping
	err := ctx.ReadResource("azurerm:customerinsights/latest:ConnectorMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
