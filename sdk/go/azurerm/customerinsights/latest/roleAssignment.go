...
func NewRoleAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:customerinsights/latest:RoleAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoleAssignment(ctx *pulumi.Context,
	...
	var resource RoleAssignment
	err := ctx.ReadResource("azurerm:customerinsights/latest:RoleAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
