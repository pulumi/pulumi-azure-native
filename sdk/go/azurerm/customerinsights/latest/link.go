...
func NewLink(ctx *pulumi.Context,
	...
	var resource Link
	err := ctx.RegisterResource("azurerm:customerinsights/latest:Link", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLink(ctx *pulumi.Context,
	...
	var resource Link
	err := ctx.ReadResource("azurerm:customerinsights/latest:Link", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
