...
func NewRelationshipLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:customerinsights/v20170101:RelationshipLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRelationshipLink(ctx *pulumi.Context,
	...
	var resource RelationshipLink
	err := ctx.ReadResource("azurerm:customerinsights/v20170101:RelationshipLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
