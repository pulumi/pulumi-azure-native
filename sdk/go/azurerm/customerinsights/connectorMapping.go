...
func NewConnectorMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:customerinsights:ConnectorMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectorMapping(ctx *pulumi.Context,
	...
	var resource ConnectorMapping
	err := ctx.ReadResource("azurerm:customerinsights:ConnectorMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
