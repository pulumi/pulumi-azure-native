...
func NewPrediction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:customerinsights:Prediction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrediction(ctx *pulumi.Context,
	...
	var resource Prediction
	err := ctx.ReadResource("azurerm:customerinsights:Prediction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
