...
type DataSourcePrecedence struct {
	// Data Source is a way for us to know the source of instances. A single type can have data coming in from multiple places. In activities we use this to determine precedence rules.
	DataSource *DataSource `pulumi:"dataSource"`
...
type DataSourcePrecedenceArgs struct {
	// Data Source is a way for us to know the source of instances. A single type can have data coming in from multiple places. In activities we use this to determine precedence rules.
	DataSource DataSourcePtrInput `pulumi:"dataSource"`
	// the precedence value.
...
// Data Source is a way for us to know the source of instances. A single type can have data coming in from multiple places. In activities we use this to determine precedence rules.
func (o DataSourcePrecedenceOutput) DataSource() DataSourcePtrOutput {
	return o.ApplyT(func(v DataSourcePrecedence) *DataSource { return v.DataSource }).(DataSourcePtrOutput)
}
...
// HubPropertiesFormatInput is an input type that accepts HubPropertiesFormatArgs and HubPropertiesFormatOutput values.
// You can construct a concrete instance of `HubPropertiesFormatInput` via:
//
//          HubPropertiesFormatArgs{...}
type HubPropertiesFormatInput interface {
	pulumi.Input

	ToHubPropertiesFormatOutput() HubPropertiesFormatOutput
	ToHubPropertiesFormatOutputWithContext(context.Context) HubPropertiesFormatOutput
}

// Properties of hub.
type HubPropertiesFormatArgs struct {
	// Billing settings of the hub.
	HubBillingInfo HubBillingInfoFormatPtrInput `pulumi:"hubBillingInfo"`
	// The bit flags for enabled hub features. Bit 0 is set to 1 indicates graph is enabled, or disabled if set to 0. Bit 1 is set to 1 indicates the hub is disabled, or enabled if set to 0.
	TenantFeatures pulumi.IntPtrInput `pulumi:"tenantFeatures"`
}

func (HubPropertiesFormatArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*HubPropertiesFormat)(nil)).Elem()
}

func (i HubPropertiesFormatArgs) ToHubPropertiesFormatOutput() HubPropertiesFormatOutput {
	return i.ToHubPropertiesFormatOutputWithContext(context.Background())
}

func (i HubPropertiesFormatArgs) ToHubPropertiesFormatOutputWithContext(ctx context.Context) HubPropertiesFormatOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HubPropertiesFormatOutput)
}

func (i HubPropertiesFormatArgs) ToHubPropertiesFormatPtrOutput() HubPropertiesFormatPtrOutput {
	return i.ToHubPropertiesFormatPtrOutputWithContext(context.Background())
}

func (i HubPropertiesFormatArgs) ToHubPropertiesFormatPtrOutputWithContext(ctx context.Context) HubPropertiesFormatPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HubPropertiesFormatOutput).ToHubPropertiesFormatPtrOutputWithContext(ctx)
}

// HubPropertiesFormatPtrInput is an input type that accepts HubPropertiesFormatArgs, HubPropertiesFormatPtr and HubPropertiesFormatPtrOutput values.
// You can construct a concrete instance of `HubPropertiesFormatPtrInput` via:
//
//          HubPropertiesFormatArgs{...}
//
//  or:
//
//          nil
type HubPropertiesFormatPtrInput interface {
	pulumi.Input

	ToHubPropertiesFormatPtrOutput() HubPropertiesFormatPtrOutput
	ToHubPropertiesFormatPtrOutputWithContext(context.Context) HubPropertiesFormatPtrOutput
}

type hubPropertiesFormatPtrType HubPropertiesFormatArgs

func HubPropertiesFormatPtr(v *HubPropertiesFormatArgs) HubPropertiesFormatPtrInput {
	return (*hubPropertiesFormatPtrType)(v)
}

func (*hubPropertiesFormatPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**HubPropertiesFormat)(nil)).Elem()
}

func (i *hubPropertiesFormatPtrType) ToHubPropertiesFormatPtrOutput() HubPropertiesFormatPtrOutput {
	return i.ToHubPropertiesFormatPtrOutputWithContext(context.Background())
}

func (i *hubPropertiesFormatPtrType) ToHubPropertiesFormatPtrOutputWithContext(ctx context.Context) HubPropertiesFormatPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HubPropertiesFormatPtrOutput)
}

// Properties of hub.
type HubPropertiesFormatOutput struct{ *pulumi.OutputState }

func (HubPropertiesFormatOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HubPropertiesFormat)(nil)).Elem()
}

func (o HubPropertiesFormatOutput) ToHubPropertiesFormatOutput() HubPropertiesFormatOutput {
	return o
}

func (o HubPropertiesFormatOutput) ToHubPropertiesFormatOutputWithContext(ctx context.Context) HubPropertiesFormatOutput {
	return o
}

func (o HubPropertiesFormatOutput) ToHubPropertiesFormatPtrOutput() HubPropertiesFormatPtrOutput {
	return o.ToHubPropertiesFormatPtrOutputWithContext(context.Background())
}

func (o HubPropertiesFormatOutput) ToHubPropertiesFormatPtrOutputWithContext(ctx context.Context) HubPropertiesFormatPtrOutput {
	return o.ApplyT(func(v HubPropertiesFormat) *HubPropertiesFormat {
		return &v
	}).(HubPropertiesFormatPtrOutput)
}

// Billing settings of the hub.
func (o HubPropertiesFormatOutput) HubBillingInfo() HubBillingInfoFormatPtrOutput {
	return o.ApplyT(func(v HubPropertiesFormat) *HubBillingInfoFormat { return v.HubBillingInfo }).(HubBillingInfoFormatPtrOutput)
}

// The bit flags for enabled hub features. Bit 0 is set to 1 indicates graph is enabled, or disabled if set to 0. Bit 1 is set to 1 indicates the hub is disabled, or enabled if set to 0.
func (o HubPropertiesFormatOutput) TenantFeatures() pulumi.IntPtrOutput {
	return o.ApplyT(func(v HubPropertiesFormat) *int { return v.TenantFeatures }).(pulumi.IntPtrOutput)
}

type HubPropertiesFormatPtrOutput struct{ *pulumi.OutputState }

func (HubPropertiesFormatPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**HubPropertiesFormat)(nil)).Elem()
}

func (o HubPropertiesFormatPtrOutput) ToHubPropertiesFormatPtrOutput() HubPropertiesFormatPtrOutput {
	return o
}

func (o HubPropertiesFormatPtrOutput) ToHubPropertiesFormatPtrOutputWithContext(ctx context.Context) HubPropertiesFormatPtrOutput {
	return o
}

func (o HubPropertiesFormatPtrOutput) Elem() HubPropertiesFormatOutput {
	return o.ApplyT(func(v *HubPropertiesFormat) HubPropertiesFormat { return *v }).(HubPropertiesFormatOutput)
}

// Billing settings of the hub.
func (o HubPropertiesFormatPtrOutput) HubBillingInfo() HubBillingInfoFormatPtrOutput {
	return o.ApplyT(func(v *HubPropertiesFormat) *HubBillingInfoFormat {
		if v == nil {
			return nil
		}
...
// The bit flags for enabled hub features. Bit 0 is set to 1 indicates graph is enabled, or disabled if set to 0. Bit 1 is set to 1 indicates the hub is disabled, or enabled if set to 0.
func (o HubPropertiesFormatPtrOutput) TenantFeatures() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *HubPropertiesFormat) *int {
		if v == nil {
			return nil
		}
...
// KpiDefinitionInput is an input type that accepts KpiDefinitionArgs and KpiDefinitionOutput values.
// You can construct a concrete instance of `KpiDefinitionInput` via:
//
//          KpiDefinitionArgs{...}
type KpiDefinitionInput interface {
	pulumi.Input

	ToKpiDefinitionOutput() KpiDefinitionOutput
	ToKpiDefinitionOutputWithContext(context.Context) KpiDefinitionOutput
}

// Defines the KPI Threshold limits.
type KpiDefinitionArgs struct {
	// The aliases.
	Aliases KpiAliasArrayInput `pulumi:"aliases"`
	// The calculation window.
	...
	Expression pulumi.StringInput `pulumi:"expression"`
	// The KPI extracts.
	Extracts KpiExtractArrayInput `pulumi:"extracts"`
	// The filter expression for the KPI.
	...
	// The KPI thresholds.
	ThresHolds KpiThresholdsPtrInput `pulumi:"thresHolds"`
	// The unit of measurement for the KPI.
	Unit pulumi.StringPtrInput `pulumi:"unit"`
}

func (KpiDefinitionArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*KpiDefinition)(nil)).Elem()
}

func (i KpiDefinitionArgs) ToKpiDefinitionOutput() KpiDefinitionOutput {
	return i.ToKpiDefinitionOutputWithContext(context.Background())
}

func (i KpiDefinitionArgs) ToKpiDefinitionOutputWithContext(ctx context.Context) KpiDefinitionOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KpiDefinitionOutput)
}

func (i KpiDefinitionArgs) ToKpiDefinitionPtrOutput() KpiDefinitionPtrOutput {
	return i.ToKpiDefinitionPtrOutputWithContext(context.Background())
}

func (i KpiDefinitionArgs) ToKpiDefinitionPtrOutputWithContext(ctx context.Context) KpiDefinitionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KpiDefinitionOutput).ToKpiDefinitionPtrOutputWithContext(ctx)
}

// KpiDefinitionPtrInput is an input type that accepts KpiDefinitionArgs, KpiDefinitionPtr and KpiDefinitionPtrOutput values.
// You can construct a concrete instance of `KpiDefinitionPtrInput` via:
//
//          KpiDefinitionArgs{...}
//
//  or:
//
//          nil
type KpiDefinitionPtrInput interface {
	pulumi.Input

	ToKpiDefinitionPtrOutput() KpiDefinitionPtrOutput
	ToKpiDefinitionPtrOutputWithContext(context.Context) KpiDefinitionPtrOutput
}

type kpiDefinitionPtrType KpiDefinitionArgs

func KpiDefinitionPtr(v *KpiDefinitionArgs) KpiDefinitionPtrInput {
	return (*kpiDefinitionPtrType)(v)
}

func (*kpiDefinitionPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**KpiDefinition)(nil)).Elem()
}

func (i *kpiDefinitionPtrType) ToKpiDefinitionPtrOutput() KpiDefinitionPtrOutput {
	return i.ToKpiDefinitionPtrOutputWithContext(context.Background())
}

func (i *kpiDefinitionPtrType) ToKpiDefinitionPtrOutputWithContext(ctx context.Context) KpiDefinitionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KpiDefinitionPtrOutput)
}

// Defines the KPI Threshold limits.
type KpiDefinitionOutput struct{ *pulumi.OutputState }

func (KpiDefinitionOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*KpiDefinition)(nil)).Elem()
}

func (o KpiDefinitionOutput) ToKpiDefinitionOutput() KpiDefinitionOutput {
	return o
}

func (o KpiDefinitionOutput) ToKpiDefinitionOutputWithContext(ctx context.Context) KpiDefinitionOutput {
	return o
}

func (o KpiDefinitionOutput) ToKpiDefinitionPtrOutput() KpiDefinitionPtrOutput {
	return o.ToKpiDefinitionPtrOutputWithContext(context.Background())
}

func (o KpiDefinitionOutput) ToKpiDefinitionPtrOutputWithContext(ctx context.Context) KpiDefinitionPtrOutput {
	return o.ApplyT(func(v KpiDefinition) *KpiDefinition {
		return &v
	}).(KpiDefinitionPtrOutput)
}

// The aliases.
func (o KpiDefinitionOutput) Aliases() KpiAliasArrayOutput {
	return o.ApplyT(func(v KpiDefinition) []KpiAlias { return v.Aliases }).(KpiAliasArrayOutput)
}

// The calculation window.
func (o KpiDefinitionOutput) CalculationWindow() pulumi.StringOutput {
	return o.ApplyT(func(v KpiDefinition) string { return v.CalculationWindow }).(pulumi.StringOutput)
}

// Name of calculation window field.
func (o KpiDefinitionOutput) CalculationWindowFieldName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KpiDefinition) *string { return v.CalculationWindowFieldName }).(pulumi.StringPtrOutput)
}

// Localized description for the KPI.
func (o KpiDefinitionOutput) Description() pulumi.StringMapOutput {
	return o.ApplyT(func(v KpiDefinition) map[string]string { return v.Description }).(pulumi.StringMapOutput)
}

// Localized display name for the KPI.
func (o KpiDefinitionOutput) DisplayName() pulumi.StringMapOutput {
	return o.ApplyT(func(v KpiDefinition) map[string]string { return v.DisplayName }).(pulumi.StringMapOutput)
}

// The mapping entity type.
func (o KpiDefinitionOutput) EntityType() pulumi.StringOutput {
	return o.ApplyT(func(v KpiDefinition) string { return v.EntityType }).(pulumi.StringOutput)
}

// The mapping entity name.
func (o KpiDefinitionOutput) EntityTypeName() pulumi.StringOutput {
	return o.ApplyT(func(v KpiDefinition) string { return v.EntityTypeName }).(pulumi.StringOutput)
}

// The computation expression for the KPI.
func (o KpiDefinitionOutput) Expression() pulumi.StringOutput {
	return o.ApplyT(func(v KpiDefinition) string { return v.Expression }).(pulumi.StringOutput)
}

// The KPI extracts.
func (o KpiDefinitionOutput) Extracts() KpiExtractArrayOutput {
	return o.ApplyT(func(v KpiDefinition) []KpiExtract { return v.Extracts }).(KpiExtractArrayOutput)
}

// The filter expression for the KPI.
func (o KpiDefinitionOutput) Filter() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KpiDefinition) *string { return v.Filter }).(pulumi.StringPtrOutput)
}

// The computation function for the KPI.
func (o KpiDefinitionOutput) Function() pulumi.StringOutput {
	return o.ApplyT(func(v KpiDefinition) string { return v.Function }).(pulumi.StringOutput)
}

// the group by properties for the KPI.
func (o KpiDefinitionOutput) GroupBy() pulumi.StringArrayOutput {
	return o.ApplyT(func(v KpiDefinition) []string { return v.GroupBy }).(pulumi.StringArrayOutput)
}

// The KPI thresholds.
func (o KpiDefinitionOutput) ThresHolds() KpiThresholdsPtrOutput {
	return o.ApplyT(func(v KpiDefinition) *KpiThresholds { return v.ThresHolds }).(KpiThresholdsPtrOutput)
}

// The unit of measurement for the KPI.
func (o KpiDefinitionOutput) Unit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KpiDefinition) *string { return v.Unit }).(pulumi.StringPtrOutput)
}

type KpiDefinitionPtrOutput struct{ *pulumi.OutputState }

func (KpiDefinitionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**KpiDefinition)(nil)).Elem()
}

func (o KpiDefinitionPtrOutput) ToKpiDefinitionPtrOutput() KpiDefinitionPtrOutput {
	return o
}

func (o KpiDefinitionPtrOutput) ToKpiDefinitionPtrOutputWithContext(ctx context.Context) KpiDefinitionPtrOutput {
	return o
}

func (o KpiDefinitionPtrOutput) Elem() KpiDefinitionOutput {
	return o.ApplyT(func(v *KpiDefinition) KpiDefinition { return *v }).(KpiDefinitionOutput)
}

// The aliases.
func (o KpiDefinitionPtrOutput) Aliases() KpiAliasArrayOutput {
	return o.ApplyT(func(v *KpiDefinition) []KpiAlias {
		if v == nil {
			return nil
		}
		return v.Aliases
...
// The calculation window.
func (o KpiDefinitionPtrOutput) CalculationWindow() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KpiDefinition) *string {
		if v == nil {
			return nil
		}
...
// Name of calculation window field.
func (o KpiDefinitionPtrOutput) CalculationWindowFieldName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KpiDefinition) *string {
		if v == nil {
			return nil
		}
...
// Localized description for the KPI.
func (o KpiDefinitionPtrOutput) Description() pulumi.StringMapOutput {
	return o.ApplyT(func(v *KpiDefinition) map[string]string {
		if v == nil {
			return nil
		}
		return v.Description
...
// Localized display name for the KPI.
func (o KpiDefinitionPtrOutput) DisplayName() pulumi.StringMapOutput {
	return o.ApplyT(func(v *KpiDefinition) map[string]string {
		if v == nil {
			return nil
		}
...
// The mapping entity type.
func (o KpiDefinitionPtrOutput) EntityType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KpiDefinition) *string {
		if v == nil {
			return nil
		}
...
// The mapping entity name.
func (o KpiDefinitionPtrOutput) EntityTypeName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KpiDefinition) *string {
		if v == nil {
			return nil
		}
...
// The computation expression for the KPI.
func (o KpiDefinitionPtrOutput) Expression() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KpiDefinition) *string {
		if v == nil {
			return nil
		}
...
// The KPI extracts.
func (o KpiDefinitionPtrOutput) Extracts() KpiExtractArrayOutput {
	return o.ApplyT(func(v *KpiDefinition) []KpiExtract {
		if v == nil {
			return nil
		}
		return v.Extracts
	}).(KpiExtractArrayOutput)
}

// The filter expression for the KPI.
func (o KpiDefinitionPtrOutput) Filter() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KpiDefinition) *string {
		if v == nil {
			return nil
		}
...
// The computation function for the KPI.
func (o KpiDefinitionPtrOutput) Function() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KpiDefinition) *string {
		if v == nil {
			return nil
		}
...
// the group by properties for the KPI.
func (o KpiDefinitionPtrOutput) GroupBy() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *KpiDefinition) []string {
		if v == nil {
			return nil
		}
...
// The KPI thresholds.
func (o KpiDefinitionPtrOutput) ThresHolds() KpiThresholdsPtrOutput {
	return o.ApplyT(func(v *KpiDefinition) *KpiThresholds {
		if v == nil {
			return nil
		}
		return v.ThresHolds
...
// The unit of measurement for the KPI.
func (o KpiDefinitionPtrOutput) Unit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KpiDefinition) *string {
		if v == nil {
			return nil
		}
...
// LinkDefinitionInput is an input type that accepts LinkDefinitionArgs and LinkDefinitionOutput values.
// You can construct a concrete instance of `LinkDefinitionInput` via:
//
//          LinkDefinitionArgs{...}
type LinkDefinitionInput interface {
	...
	ToLinkDefinitionOutputWithContext(context.Context) LinkDefinitionOutput
}
...
type LinkDefinitionArgs struct {
	...
	DisplayName pulumi.StringMapInput `pulumi:"displayName"`
	// The set of properties mappings between the source and target Types.
	Mappings TypePropertiesMappingArrayInput `pulumi:"mappings"`
	// Determines whether this link is supposed to create or delete instances if Link is NOT Reference Only.
	OperationType pulumi.StringPtrInput `pulumi:"operationType"`
	// The properties that represent the participating profile.
	ParticipantPropertyReferences ParticipantPropertyReferenceArrayInput `pulumi:"participantPropertyReferences"`
	// Indicating whether the link is reference only link. This flag is ignored if the Mappings are defined. If the mappings are not defined and it is set to true, links processing will not create or update profiles.
...
func (i LinkDefinitionArgs) ToLinkDefinitionOutput() LinkDefinitionOutput {
	return i.ToLinkDefinitionOutputWithContext(context.Background())
}

func (i LinkDefinitionArgs) ToLinkDefinitionOutputWithContext(ctx context.Context) LinkDefinitionOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LinkDefinitionOutput)
}

func (i LinkDefinitionArgs) ToLinkDefinitionPtrOutput() LinkDefinitionPtrOutput {
	return i.ToLinkDefinitionPtrOutputWithContext(context.Background())
}

func (i LinkDefinitionArgs) ToLinkDefinitionPtrOutputWithContext(ctx context.Context) LinkDefinitionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LinkDefinitionOutput).ToLinkDefinitionPtrOutputWithContext(ctx)
}

// LinkDefinitionPtrInput is an input type that accepts LinkDefinitionArgs, LinkDefinitionPtr and LinkDefinitionPtrOutput values.
// You can construct a concrete instance of `LinkDefinitionPtrInput` via:
//
//          LinkDefinitionArgs{...}
//
//  or:
...
type LinkDefinitionPtrInput interface {
	...
	ToLinkDefinitionPtrOutputWithContext(context.Context) LinkDefinitionPtrOutput
}

type linkDefinitionPtrType LinkDefinitionArgs

func LinkDefinitionPtr(v *LinkDefinitionArgs) LinkDefinitionPtrInput {
	return (*linkDefinitionPtrType)(v)
}
...
// Localized descriptions for the Link.
func (o LinkDefinitionOutput) Description() pulumi.StringMapOutput {
	return o.ApplyT(func(v LinkDefinition) map[string]string { return v.Description }).(pulumi.StringMapOutput)
}

// Localized display name for the Link.
func (o LinkDefinitionOutput) DisplayName() pulumi.StringMapOutput {
	return o.ApplyT(func(v LinkDefinition) map[string]string { return v.DisplayName }).(pulumi.StringMapOutput)
}

// The set of properties mappings between the source and target Types.
func (o LinkDefinitionOutput) Mappings() TypePropertiesMappingArrayOutput {
	return o.ApplyT(func(v LinkDefinition) []TypePropertiesMapping { return v.Mappings }).(TypePropertiesMappingArrayOutput)
}

// Determines whether this link is supposed to create or delete instances if Link is NOT Reference Only.
func (o LinkDefinitionOutput) OperationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LinkDefinition) *string { return v.OperationType }).(pulumi.StringPtrOutput)
}

// The properties that represent the participating profile.
func (o LinkDefinitionOutput) ParticipantPropertyReferences() ParticipantPropertyReferenceArrayOutput {
	return o.ApplyT(func(v LinkDefinition) []ParticipantPropertyReference { return v.ParticipantPropertyReferences }).(ParticipantPropertyReferenceArrayOutput)
}

// Indicating whether the link is reference only link. This flag is ignored if the Mappings are defined. If the mappings are not defined and it is set to true, links processing will not create or update profiles.
func (o LinkDefinitionOutput) ReferenceOnly() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LinkDefinition) *bool { return v.ReferenceOnly }).(pulumi.BoolPtrOutput)
}

// Type of source entity.
func (o LinkDefinitionOutput) SourceEntityType() pulumi.StringOutput {
	return o.ApplyT(func(v LinkDefinition) string { return v.SourceEntityType }).(pulumi.StringOutput)
}

// Name of the source Entity Type.
func (o LinkDefinitionOutput) SourceEntityTypeName() pulumi.StringOutput {
	return o.ApplyT(func(v LinkDefinition) string { return v.SourceEntityTypeName }).(pulumi.StringOutput)
}

// Type of target entity.
func (o LinkDefinitionOutput) TargetEntityType() pulumi.StringOutput {
	return o.ApplyT(func(v LinkDefinition) string { return v.TargetEntityType }).(pulumi.StringOutput)
}

// Name of the target Entity Type.
func (o LinkDefinitionOutput) TargetEntityTypeName() pulumi.StringOutput {
	return o.ApplyT(func(v LinkDefinition) string { return v.TargetEntityTypeName }).(pulumi.StringOutput)
}
...
func (o LinkDefinitionPtrOutput) Elem() LinkDefinitionOutput {
	return o.ApplyT(func(v *LinkDefinition) LinkDefinition { return *v }).(LinkDefinitionOutput)
}

// Localized descriptions for the Link.
func (o LinkDefinitionPtrOutput) Description() pulumi.StringMapOutput {
	return o.ApplyT(func(v *LinkDefinition) map[string]string {
		if v == nil {
			return nil
		}
		return v.Description
...
// Localized display name for the Link.
func (o LinkDefinitionPtrOutput) DisplayName() pulumi.StringMapOutput {
	return o.ApplyT(func(v *LinkDefinition) map[string]string {
		if v == nil {
			return nil
		}
...
// The set of properties mappings between the source and target Types.
func (o LinkDefinitionPtrOutput) Mappings() TypePropertiesMappingArrayOutput {
	return o.ApplyT(func(v *LinkDefinition) []TypePropertiesMapping {
		if v == nil {
			return nil
		}
		return v.Mappings
	}).(TypePropertiesMappingArrayOutput)
}

// Determines whether this link is supposed to create or delete instances if Link is NOT Reference Only.
func (o LinkDefinitionPtrOutput) OperationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LinkDefinition) *string {
		if v == nil {
			return nil
		}
...
// The properties that represent the participating profile.
func (o LinkDefinitionPtrOutput) ParticipantPropertyReferences() ParticipantPropertyReferenceArrayOutput {
	return o.ApplyT(func(v *LinkDefinition) []ParticipantPropertyReference {
		if v == nil {
			return nil
		}
		return v.ParticipantPropertyReferences
	}).(ParticipantPropertyReferenceArrayOutput)
}

// Indicating whether the link is reference only link. This flag is ignored if the Mappings are defined. If the mappings are not defined and it is set to true, links processing will not create or update profiles.
func (o LinkDefinitionPtrOutput) ReferenceOnly() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *LinkDefinition) *bool {
		if v == nil {
			return nil
		}
...
// Type of source entity.
func (o LinkDefinitionPtrOutput) SourceEntityType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LinkDefinition) *string {
		if v == nil {
			return nil
		}
...
// Name of the source Entity Type.
func (o LinkDefinitionPtrOutput) SourceEntityTypeName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LinkDefinition) *string {
		if v == nil {
			return nil
		}
...
// Type of target entity.
func (o LinkDefinitionPtrOutput) TargetEntityType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LinkDefinition) *string {
		if v == nil {
			return nil
		}
...
// Name of the target Entity Type.
func (o LinkDefinitionPtrOutput) TargetEntityTypeName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LinkDefinition) *string {
		if v == nil {
			return nil
		}
...
type PredictionArgs struct {
	...
	DisplayName pulumi.StringMapInput `pulumi:"displayName"`
	// The prediction grades.
	Grades PredictionPropertiesArrayInput `pulumi:"grades"`
	// Interaction types involved in the prediction.
	...
	// Definition of the link mapping of prediction.
	Mappings PredictionPropertiesInput `pulumi:"mappings"`
	// Negative outcome expression.
...
func (o PredictionPtrOutput) Grades() PredictionPropertiesArrayOutput {
	return o.ApplyT(func(v *Prediction) []PredictionProperties {
		...
		return v.Grades
	}).(PredictionPropertiesArrayOutput)
}
...
// ProfileTypeDefinitionInput is an input type that accepts ProfileTypeDefinitionArgs and ProfileTypeDefinitionOutput values.
// You can construct a concrete instance of `ProfileTypeDefinitionInput` via:
//
//          ProfileTypeDefinitionArgs{...}
type ProfileTypeDefinitionInput interface {
	pulumi.Input

	ToProfileTypeDefinitionOutput() ProfileTypeDefinitionOutput
	ToProfileTypeDefinitionOutputWithContext(context.Context) ProfileTypeDefinitionOutput
}

// The profile type definition.
type ProfileTypeDefinitionArgs struct {
	// The api entity set name. This becomes the odata entity set name for the entity Type being referred in this object.
	...
	// The properties of the Profile.
	Fields PropertyDefinitionArrayInput `pulumi:"fields"`
	// The instance count.
	...
	// The strong IDs.
	StrongIds StrongIdArrayInput `pulumi:"strongIds"`
	// The timestamp property name. Represents the time when the interaction or profile update happened.
...
func (ProfileTypeDefinitionArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ProfileTypeDefinition)(nil)).Elem()
}

func (i ProfileTypeDefinitionArgs) ToProfileTypeDefinitionOutput() ProfileTypeDefinitionOutput {
	return i.ToProfileTypeDefinitionOutputWithContext(context.Background())
}

func (i ProfileTypeDefinitionArgs) ToProfileTypeDefinitionOutputWithContext(ctx context.Context) ProfileTypeDefinitionOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ProfileTypeDefinitionOutput)
}

func (i ProfileTypeDefinitionArgs) ToProfileTypeDefinitionPtrOutput() ProfileTypeDefinitionPtrOutput {
	return i.ToProfileTypeDefinitionPtrOutputWithContext(context.Background())
}

func (i ProfileTypeDefinitionArgs) ToProfileTypeDefinitionPtrOutputWithContext(ctx context.Context) ProfileTypeDefinitionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ProfileTypeDefinitionOutput).ToProfileTypeDefinitionPtrOutputWithContext(ctx)
}

// ProfileTypeDefinitionPtrInput is an input type that accepts ProfileTypeDefinitionArgs, ProfileTypeDefinitionPtr and ProfileTypeDefinitionPtrOutput values.
// You can construct a concrete instance of `ProfileTypeDefinitionPtrInput` via:
//
//          ProfileTypeDefinitionArgs{...}
//
//  or:
//
//          nil
type ProfileTypeDefinitionPtrInput interface {
	pulumi.Input

	ToProfileTypeDefinitionPtrOutput() ProfileTypeDefinitionPtrOutput
	ToProfileTypeDefinitionPtrOutputWithContext(context.Context) ProfileTypeDefinitionPtrOutput
}

type profileTypeDefinitionPtrType ProfileTypeDefinitionArgs

func ProfileTypeDefinitionPtr(v *ProfileTypeDefinitionArgs) ProfileTypeDefinitionPtrInput {
	return (*profileTypeDefinitionPtrType)(v)
}

func (*profileTypeDefinitionPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ProfileTypeDefinition)(nil)).Elem()
}

func (i *profileTypeDefinitionPtrType) ToProfileTypeDefinitionPtrOutput() ProfileTypeDefinitionPtrOutput {
	return i.ToProfileTypeDefinitionPtrOutputWithContext(context.Background())
}

func (i *profileTypeDefinitionPtrType) ToProfileTypeDefinitionPtrOutputWithContext(ctx context.Context) ProfileTypeDefinitionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ProfileTypeDefinitionPtrOutput)
}

// The profile type definition.
type ProfileTypeDefinitionOutput struct{ *pulumi.OutputState }

func (ProfileTypeDefinitionOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ProfileTypeDefinition)(nil)).Elem()
}

func (o ProfileTypeDefinitionOutput) ToProfileTypeDefinitionOutput() ProfileTypeDefinitionOutput {
	return o
}

func (o ProfileTypeDefinitionOutput) ToProfileTypeDefinitionOutputWithContext(ctx context.Context) ProfileTypeDefinitionOutput {
	return o
}

func (o ProfileTypeDefinitionOutput) ToProfileTypeDefinitionPtrOutput() ProfileTypeDefinitionPtrOutput {
	return o.ToProfileTypeDefinitionPtrOutputWithContext(context.Background())
}

func (o ProfileTypeDefinitionOutput) ToProfileTypeDefinitionPtrOutputWithContext(ctx context.Context) ProfileTypeDefinitionPtrOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) *ProfileTypeDefinition {
		return &v
	}).(ProfileTypeDefinitionPtrOutput)
}

// The api entity set name. This becomes the odata entity set name for the entity Type being referred in this object.
func (o ProfileTypeDefinitionOutput) ApiEntitySetName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) *string { return v.ApiEntitySetName }).(pulumi.StringPtrOutput)
}
...
// Localized descriptions for the property.
func (o ProfileTypeDefinitionOutput) Description() pulumi.StringMapOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) map[string]string { return v.Description }).(pulumi.StringMapOutput)
}

// Localized display names for the property.
func (o ProfileTypeDefinitionOutput) DisplayName() pulumi.StringMapOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) map[string]string { return v.DisplayName }).(pulumi.StringMapOutput)
}

// Type of entity.
func (o ProfileTypeDefinitionOutput) EntityType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) *string { return v.EntityType }).(pulumi.StringPtrOutput)
}

// The properties of the Profile.
func (o ProfileTypeDefinitionOutput) Fields() PropertyDefinitionArrayOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) []PropertyDefinition { return v.Fields }).(PropertyDefinitionArrayOutput)
}

// The instance count.
func (o ProfileTypeDefinitionOutput) InstancesCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) *int { return v.InstancesCount }).(pulumi.IntPtrOutput)
}

// Large Image associated with the Property or EntityType.
func (o ProfileTypeDefinitionOutput) LargeImage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) *string { return v.LargeImage }).(pulumi.StringPtrOutput)
}
...
// Medium Image associated with the Property or EntityType.
func (o ProfileTypeDefinitionOutput) MediumImage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) *string { return v.MediumImage }).(pulumi.StringPtrOutput)
}

// The schema org link. This helps ACI identify and suggest semantic models.
func (o ProfileTypeDefinitionOutput) SchemaItemTypeLink() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) *string { return v.SchemaItemTypeLink }).(pulumi.StringPtrOutput)
}

// Small Image associated with the Property or EntityType.
func (o ProfileTypeDefinitionOutput) SmallImage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) *string { return v.SmallImage }).(pulumi.StringPtrOutput)
}

// The strong IDs.
func (o ProfileTypeDefinitionOutput) StrongIds() StrongIdArrayOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) []StrongId { return v.StrongIds }).(StrongIdArrayOutput)
}

// The timestamp property name. Represents the time when the interaction or profile update happened.
func (o ProfileTypeDefinitionOutput) TimestampFieldName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) *string { return v.TimestampFieldName }).(pulumi.StringPtrOutput)
}

// The name of the entity.
func (o ProfileTypeDefinitionOutput) TypeName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProfileTypeDefinition) *string { return v.TypeName }).(pulumi.StringPtrOutput)
}

type ProfileTypeDefinitionPtrOutput struct{ *pulumi.OutputState }

func (ProfileTypeDefinitionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ProfileTypeDefinition)(nil)).Elem()
}

func (o ProfileTypeDefinitionPtrOutput) ToProfileTypeDefinitionPtrOutput() ProfileTypeDefinitionPtrOutput {
	return o
}

func (o ProfileTypeDefinitionPtrOutput) ToProfileTypeDefinitionPtrOutputWithContext(ctx context.Context) ProfileTypeDefinitionPtrOutput {
	return o
}

func (o ProfileTypeDefinitionPtrOutput) Elem() ProfileTypeDefinitionOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) ProfileTypeDefinition { return *v }).(ProfileTypeDefinitionOutput)
}

// The api entity set name. This becomes the odata entity set name for the entity Type being referred in this object.
func (o ProfileTypeDefinitionPtrOutput) ApiEntitySetName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) *string {
		if v == nil {
			return nil
		}
...
// Localized descriptions for the property.
func (o ProfileTypeDefinitionPtrOutput) Description() pulumi.StringMapOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) map[string]string {
		if v == nil {
			return nil
		}
...
// Localized display names for the property.
func (o ProfileTypeDefinitionPtrOutput) DisplayName() pulumi.StringMapOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) map[string]string {
		if v == nil {
			return nil
		}
...
// Type of entity.
func (o ProfileTypeDefinitionPtrOutput) EntityType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) *string {
		if v == nil {
			return nil
		}
...
// The properties of the Profile.
func (o ProfileTypeDefinitionPtrOutput) Fields() PropertyDefinitionArrayOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) []PropertyDefinition {
		if v == nil {
			return nil
		}
		return v.Fields
	}).(PropertyDefinitionArrayOutput)
}

// The instance count.
func (o ProfileTypeDefinitionPtrOutput) InstancesCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) *int {
		if v == nil {
			return nil
		}
...
// Large Image associated with the Property or EntityType.
func (o ProfileTypeDefinitionPtrOutput) LargeImage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) *string {
		if v == nil {
			return nil
		}
...
// Medium Image associated with the Property or EntityType.
func (o ProfileTypeDefinitionPtrOutput) MediumImage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) *string {
		if v == nil {
			return nil
		}
...
// The schema org link. This helps ACI identify and suggest semantic models.
func (o ProfileTypeDefinitionPtrOutput) SchemaItemTypeLink() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) *string {
		if v == nil {
			return nil
		}
...
// Small Image associated with the Property or EntityType.
func (o ProfileTypeDefinitionPtrOutput) SmallImage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) *string {
		if v == nil {
			return nil
		}
...
// The strong IDs.
func (o ProfileTypeDefinitionPtrOutput) StrongIds() StrongIdArrayOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) []StrongId {
		if v == nil {
			return nil
		}
		return v.StrongIds
...
// The timestamp property name. Represents the time when the interaction or profile update happened.
func (o ProfileTypeDefinitionPtrOutput) TimestampFieldName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) *string {
		if v == nil {
			return nil
		}
...
// The name of the entity.
func (o ProfileTypeDefinitionPtrOutput) TypeName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProfileTypeDefinition) *string {
		if v == nil {
			return nil
		}
...
// RelationshipDefinitionInput is an input type that accepts RelationshipDefinitionArgs and RelationshipDefinitionOutput values.
// You can construct a concrete instance of `RelationshipDefinitionInput` via:
//
//          RelationshipDefinitionArgs{...}
type RelationshipDefinitionInput interface {
	pulumi.Input

	ToRelationshipDefinitionOutput() RelationshipDefinitionOutput
	ToRelationshipDefinitionOutputWithContext(context.Context) RelationshipDefinitionOutput
}

// The definition of Relationship.
type RelationshipDefinitionArgs struct {
	// The Relationship Cardinality.
	...
	Fields PropertyDefinitionArrayInput `pulumi:"fields"`
	// Optional property to be used to map fields in profile to their strong ids in related profile.
	LookupMappings RelationshipTypeMappingArrayInput `pulumi:"lookupMappings"`
	// Profile type.
...
func (RelationshipDefinitionArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*RelationshipDefinition)(nil)).Elem()
}

func (i RelationshipDefinitionArgs) ToRelationshipDefinitionOutput() RelationshipDefinitionOutput {
	return i.ToRelationshipDefinitionOutputWithContext(context.Background())
}

func (i RelationshipDefinitionArgs) ToRelationshipDefinitionOutputWithContext(ctx context.Context) RelationshipDefinitionOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RelationshipDefinitionOutput)
}

func (i RelationshipDefinitionArgs) ToRelationshipDefinitionPtrOutput() RelationshipDefinitionPtrOutput {
	return i.ToRelationshipDefinitionPtrOutputWithContext(context.Background())
}

func (i RelationshipDefinitionArgs) ToRelationshipDefinitionPtrOutputWithContext(ctx context.Context) RelationshipDefinitionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RelationshipDefinitionOutput).ToRelationshipDefinitionPtrOutputWithContext(ctx)
}

// RelationshipDefinitionPtrInput is an input type that accepts RelationshipDefinitionArgs, RelationshipDefinitionPtr and RelationshipDefinitionPtrOutput values.
// You can construct a concrete instance of `RelationshipDefinitionPtrInput` via:
//
//          RelationshipDefinitionArgs{...}
//
//  or:
//
//          nil
type RelationshipDefinitionPtrInput interface {
	pulumi.Input

	ToRelationshipDefinitionPtrOutput() RelationshipDefinitionPtrOutput
	ToRelationshipDefinitionPtrOutputWithContext(context.Context) RelationshipDefinitionPtrOutput
}

type relationshipDefinitionPtrType RelationshipDefinitionArgs

func RelationshipDefinitionPtr(v *RelationshipDefinitionArgs) RelationshipDefinitionPtrInput {
	return (*relationshipDefinitionPtrType)(v)
}

func (*relationshipDefinitionPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**RelationshipDefinition)(nil)).Elem()
}

func (i *relationshipDefinitionPtrType) ToRelationshipDefinitionPtrOutput() RelationshipDefinitionPtrOutput {
	return i.ToRelationshipDefinitionPtrOutputWithContext(context.Background())
}

func (i *relationshipDefinitionPtrType) ToRelationshipDefinitionPtrOutputWithContext(ctx context.Context) RelationshipDefinitionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RelationshipDefinitionPtrOutput)
}

// The definition of Relationship.
type RelationshipDefinitionOutput struct{ *pulumi.OutputState }

func (RelationshipDefinitionOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*RelationshipDefinition)(nil)).Elem()
}

func (o RelationshipDefinitionOutput) ToRelationshipDefinitionOutput() RelationshipDefinitionOutput {
	return o
}

func (o RelationshipDefinitionOutput) ToRelationshipDefinitionOutputWithContext(ctx context.Context) RelationshipDefinitionOutput {
	return o
}

func (o RelationshipDefinitionOutput) ToRelationshipDefinitionPtrOutput() RelationshipDefinitionPtrOutput {
	return o.ToRelationshipDefinitionPtrOutputWithContext(context.Background())
}

func (o RelationshipDefinitionOutput) ToRelationshipDefinitionPtrOutputWithContext(ctx context.Context) RelationshipDefinitionPtrOutput {
	return o.ApplyT(func(v RelationshipDefinition) *RelationshipDefinition {
		return &v
	}).(RelationshipDefinitionPtrOutput)
}

// The Relationship Cardinality.
func (o RelationshipDefinitionOutput) Cardinality() pulumi.StringPtrOutput {
	return o.ApplyT(func(v RelationshipDefinition) *string { return v.Cardinality }).(pulumi.StringPtrOutput)
}

// Localized descriptions for the Relationship.
func (o RelationshipDefinitionOutput) Description() pulumi.StringMapOutput {
	return o.ApplyT(func(v RelationshipDefinition) map[string]string { return v.Description }).(pulumi.StringMapOutput)
}

// Localized display name for the Relationship.
func (o RelationshipDefinitionOutput) DisplayName() pulumi.StringMapOutput {
	return o.ApplyT(func(v RelationshipDefinition) map[string]string { return v.DisplayName }).(pulumi.StringMapOutput)
}

// The expiry date time in UTC.
func (o RelationshipDefinitionOutput) ExpiryDateTimeUtc() pulumi.StringPtrOutput {
	return o.ApplyT(func(v RelationshipDefinition) *string { return v.ExpiryDateTimeUtc }).(pulumi.StringPtrOutput)
}

// The properties of the Relationship.
func (o RelationshipDefinitionOutput) Fields() PropertyDefinitionArrayOutput {
	return o.ApplyT(func(v RelationshipDefinition) []PropertyDefinition { return v.Fields }).(PropertyDefinitionArrayOutput)
}

// Optional property to be used to map fields in profile to their strong ids in related profile.
func (o RelationshipDefinitionOutput) LookupMappings() RelationshipTypeMappingArrayOutput {
	return o.ApplyT(func(v RelationshipDefinition) []RelationshipTypeMapping { return v.LookupMappings }).(RelationshipTypeMappingArrayOutput)
}

// Profile type.
func (o RelationshipDefinitionOutput) ProfileType() pulumi.StringOutput {
	return o.ApplyT(func(v RelationshipDefinition) string { return v.ProfileType }).(pulumi.StringOutput)
}

// Related profile being referenced.
func (o RelationshipDefinitionOutput) RelatedProfileType() pulumi.StringOutput {
	return o.ApplyT(func(v RelationshipDefinition) string { return v.RelatedProfileType }).(pulumi.StringOutput)
}

type RelationshipDefinitionPtrOutput struct{ *pulumi.OutputState }

func (RelationshipDefinitionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**RelationshipDefinition)(nil)).Elem()
}

func (o RelationshipDefinitionPtrOutput) ToRelationshipDefinitionPtrOutput() RelationshipDefinitionPtrOutput {
	return o
}

func (o RelationshipDefinitionPtrOutput) ToRelationshipDefinitionPtrOutputWithContext(ctx context.Context) RelationshipDefinitionPtrOutput {
	return o
}

func (o RelationshipDefinitionPtrOutput) Elem() RelationshipDefinitionOutput {
	return o.ApplyT(func(v *RelationshipDefinition) RelationshipDefinition { return *v }).(RelationshipDefinitionOutput)
}

// The Relationship Cardinality.
func (o RelationshipDefinitionPtrOutput) Cardinality() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RelationshipDefinition) *string {
		if v == nil {
			return nil
		}
...
// Localized descriptions for the Relationship.
func (o RelationshipDefinitionPtrOutput) Description() pulumi.StringMapOutput {
	return o.ApplyT(func(v *RelationshipDefinition) map[string]string {
		if v == nil {
			return nil
		}
		return v.Description
...
// Localized display name for the Relationship.
func (o RelationshipDefinitionPtrOutput) DisplayName() pulumi.StringMapOutput {
	return o.ApplyT(func(v *RelationshipDefinition) map[string]string {
		if v == nil {
			return nil
		}
...
// The expiry date time in UTC.
func (o RelationshipDefinitionPtrOutput) ExpiryDateTimeUtc() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RelationshipDefinition) *string {
		if v == nil {
			return nil
		}
...
// The properties of the Relationship.
func (o RelationshipDefinitionPtrOutput) Fields() PropertyDefinitionArrayOutput {
	return o.ApplyT(func(v *RelationshipDefinition) []PropertyDefinition {
		if v == nil {
			return nil
		}
		return v.Fields
...
// Optional property to be used to map fields in profile to their strong ids in related profile.
func (o RelationshipDefinitionPtrOutput) LookupMappings() RelationshipTypeMappingArrayOutput {
	return o.ApplyT(func(v *RelationshipDefinition) []RelationshipTypeMapping {
		if v == nil {
			return nil
		}
		return v.LookupMappings
	}).(RelationshipTypeMappingArrayOutput)
}

// Profile type.
func (o RelationshipDefinitionPtrOutput) ProfileType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RelationshipDefinition) *string {
		if v == nil {
			return nil
		}
...
// Related profile being referenced.
func (o RelationshipDefinitionPtrOutput) RelatedProfileType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RelationshipDefinition) *string {
		if v == nil {
			return nil
		}
...
// RelationshipLinkDefinitionInput is an input type that accepts RelationshipLinkDefinitionArgs and RelationshipLinkDefinitionOutput values.
// You can construct a concrete instance of `RelationshipLinkDefinitionInput` via:
//
//          RelationshipLinkDefinitionArgs{...}
type RelationshipLinkDefinitionInput interface {
	pulumi.Input

	ToRelationshipLinkDefinitionOutput() RelationshipLinkDefinitionOutput
	ToRelationshipLinkDefinitionOutputWithContext(context.Context) RelationshipLinkDefinitionOutput
}

// The definition of relationship link.
type RelationshipLinkDefinitionArgs struct {
	// Localized descriptions for the Relationship Link.
	Description pulumi.StringMapInput `pulumi:"description"`
	// Localized display name for the Relationship Link.
	DisplayName pulumi.StringMapInput `pulumi:"displayName"`
	...
	// The mappings between Interaction and Relationship fields.
	Mappings RelationshipLinkFieldMappingArrayInput `pulumi:"mappings"`
	// The property references for the Profile of the Relationship.
	ProfilePropertyReferences ParticipantProfilePropertyReferenceArrayInput `pulumi:"profilePropertyReferences"`
	// The property references for the Related Profile of the Relationship.
	RelatedProfilePropertyReferences ParticipantProfilePropertyReferenceArrayInput `pulumi:"relatedProfilePropertyReferences"`
	// The Relationship associated with the Link.
	RelationshipName pulumi.StringInput `pulumi:"relationshipName"`
}

func (RelationshipLinkDefinitionArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*RelationshipLinkDefinition)(nil)).Elem()
}

func (i RelationshipLinkDefinitionArgs) ToRelationshipLinkDefinitionOutput() RelationshipLinkDefinitionOutput {
	return i.ToRelationshipLinkDefinitionOutputWithContext(context.Background())
}

func (i RelationshipLinkDefinitionArgs) ToRelationshipLinkDefinitionOutputWithContext(ctx context.Context) RelationshipLinkDefinitionOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RelationshipLinkDefinitionOutput)
}

func (i RelationshipLinkDefinitionArgs) ToRelationshipLinkDefinitionPtrOutput() RelationshipLinkDefinitionPtrOutput {
	return i.ToRelationshipLinkDefinitionPtrOutputWithContext(context.Background())
}

func (i RelationshipLinkDefinitionArgs) ToRelationshipLinkDefinitionPtrOutputWithContext(ctx context.Context) RelationshipLinkDefinitionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RelationshipLinkDefinitionOutput).ToRelationshipLinkDefinitionPtrOutputWithContext(ctx)
}

// RelationshipLinkDefinitionPtrInput is an input type that accepts RelationshipLinkDefinitionArgs, RelationshipLinkDefinitionPtr and RelationshipLinkDefinitionPtrOutput values.
// You can construct a concrete instance of `RelationshipLinkDefinitionPtrInput` via:
//
//          RelationshipLinkDefinitionArgs{...}
//
//  or:
//
//          nil
type RelationshipLinkDefinitionPtrInput interface {
	pulumi.Input

	ToRelationshipLinkDefinitionPtrOutput() RelationshipLinkDefinitionPtrOutput
	ToRelationshipLinkDefinitionPtrOutputWithContext(context.Context) RelationshipLinkDefinitionPtrOutput
}

type relationshipLinkDefinitionPtrType RelationshipLinkDefinitionArgs

func RelationshipLinkDefinitionPtr(v *RelationshipLinkDefinitionArgs) RelationshipLinkDefinitionPtrInput {
	return (*relationshipLinkDefinitionPtrType)(v)
}

func (*relationshipLinkDefinitionPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**RelationshipLinkDefinition)(nil)).Elem()
}

func (i *relationshipLinkDefinitionPtrType) ToRelationshipLinkDefinitionPtrOutput() RelationshipLinkDefinitionPtrOutput {
	return i.ToRelationshipLinkDefinitionPtrOutputWithContext(context.Background())
}

func (i *relationshipLinkDefinitionPtrType) ToRelationshipLinkDefinitionPtrOutputWithContext(ctx context.Context) RelationshipLinkDefinitionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RelationshipLinkDefinitionPtrOutput)
}

// The definition of relationship link.
type RelationshipLinkDefinitionOutput struct{ *pulumi.OutputState }

func (RelationshipLinkDefinitionOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*RelationshipLinkDefinition)(nil)).Elem()
}

func (o RelationshipLinkDefinitionOutput) ToRelationshipLinkDefinitionOutput() RelationshipLinkDefinitionOutput {
	return o
}

func (o RelationshipLinkDefinitionOutput) ToRelationshipLinkDefinitionOutputWithContext(ctx context.Context) RelationshipLinkDefinitionOutput {
	return o
}

func (o RelationshipLinkDefinitionOutput) ToRelationshipLinkDefinitionPtrOutput() RelationshipLinkDefinitionPtrOutput {
	return o.ToRelationshipLinkDefinitionPtrOutputWithContext(context.Background())
}

func (o RelationshipLinkDefinitionOutput) ToRelationshipLinkDefinitionPtrOutputWithContext(ctx context.Context) RelationshipLinkDefinitionPtrOutput {
	return o.ApplyT(func(v RelationshipLinkDefinition) *RelationshipLinkDefinition {
		return &v
	}).(RelationshipLinkDefinitionPtrOutput)
}

// Localized descriptions for the Relationship Link.
func (o RelationshipLinkDefinitionOutput) Description() pulumi.StringMapOutput {
	return o.ApplyT(func(v RelationshipLinkDefinition) map[string]string { return v.Description }).(pulumi.StringMapOutput)
}

// Localized display name for the Relationship Link.
func (o RelationshipLinkDefinitionOutput) DisplayName() pulumi.StringMapOutput {
	return o.ApplyT(func(v RelationshipLinkDefinition) map[string]string { return v.DisplayName }).(pulumi.StringMapOutput)
}

// The InteractionType associated with the Relationship Link.
func (o RelationshipLinkDefinitionOutput) InteractionType() pulumi.StringOutput {
	return o.ApplyT(func(v RelationshipLinkDefinition) string { return v.InteractionType }).(pulumi.StringOutput)
}

// The mappings between Interaction and Relationship fields.
func (o RelationshipLinkDefinitionOutput) Mappings() RelationshipLinkFieldMappingArrayOutput {
	return o.ApplyT(func(v RelationshipLinkDefinition) []RelationshipLinkFieldMapping { return v.Mappings }).(RelationshipLinkFieldMappingArrayOutput)
}

// The property references for the Profile of the Relationship.
func (o RelationshipLinkDefinitionOutput) ProfilePropertyReferences() ParticipantProfilePropertyReferenceArrayOutput {
	return o.ApplyT(func(v RelationshipLinkDefinition) []ParticipantProfilePropertyReference {
		return v.ProfilePropertyReferences
	}).(ParticipantProfilePropertyReferenceArrayOutput)
}

// The property references for the Related Profile of the Relationship.
func (o RelationshipLinkDefinitionOutput) RelatedProfilePropertyReferences() ParticipantProfilePropertyReferenceArrayOutput {
	return o.ApplyT(func(v RelationshipLinkDefinition) []ParticipantProfilePropertyReference {
...
// The Relationship associated with the Link.
func (o RelationshipLinkDefinitionOutput) RelationshipName() pulumi.StringOutput {
	return o.ApplyT(func(v RelationshipLinkDefinition) string { return v.RelationshipName }).(pulumi.StringOutput)
}

type RelationshipLinkDefinitionPtrOutput struct{ *pulumi.OutputState }

func (RelationshipLinkDefinitionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**RelationshipLinkDefinition)(nil)).Elem()
}

func (o RelationshipLinkDefinitionPtrOutput) ToRelationshipLinkDefinitionPtrOutput() RelationshipLinkDefinitionPtrOutput {
	return o
}

func (o RelationshipLinkDefinitionPtrOutput) ToRelationshipLinkDefinitionPtrOutputWithContext(ctx context.Context) RelationshipLinkDefinitionPtrOutput {
	return o
}

func (o RelationshipLinkDefinitionPtrOutput) Elem() RelationshipLinkDefinitionOutput {
	return o.ApplyT(func(v *RelationshipLinkDefinition) RelationshipLinkDefinition { return *v }).(RelationshipLinkDefinitionOutput)
}

// Localized descriptions for the Relationship Link.
func (o RelationshipLinkDefinitionPtrOutput) Description() pulumi.StringMapOutput {
	return o.ApplyT(func(v *RelationshipLinkDefinition) map[string]string {
		if v == nil {
			return nil
		}
		return v.Description
...
// Localized display name for the Relationship Link.
func (o RelationshipLinkDefinitionPtrOutput) DisplayName() pulumi.StringMapOutput {
	return o.ApplyT(func(v *RelationshipLinkDefinition) map[string]string {
		if v == nil {
			return nil
		}
...
// The InteractionType associated with the Relationship Link.
func (o RelationshipLinkDefinitionPtrOutput) InteractionType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RelationshipLinkDefinition) *string {
		if v == nil {
			return nil
		}
...
// The mappings between Interaction and Relationship fields.
func (o RelationshipLinkDefinitionPtrOutput) Mappings() RelationshipLinkFieldMappingArrayOutput {
	return o.ApplyT(func(v *RelationshipLinkDefinition) []RelationshipLinkFieldMapping {
		if v == nil {
			return nil
		}
		return v.Mappings
	}).(RelationshipLinkFieldMappingArrayOutput)
}

// The property references for the Profile of the Relationship.
func (o RelationshipLinkDefinitionPtrOutput) ProfilePropertyReferences() ParticipantProfilePropertyReferenceArrayOutput {
	return o.ApplyT(func(v *RelationshipLinkDefinition) []ParticipantProfilePropertyReference {
		if v == nil {
			return nil
		}
...
// The property references for the Related Profile of the Relationship.
func (o RelationshipLinkDefinitionPtrOutput) RelatedProfilePropertyReferences() ParticipantProfilePropertyReferenceArrayOutput {
	return o.ApplyT(func(v *RelationshipLinkDefinition) []ParticipantProfilePropertyReference {
		if v == nil {
			return nil
		}
...
// The Relationship associated with the Link.
func (o RelationshipLinkDefinitionPtrOutput) RelationshipName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RelationshipLinkDefinition) *string {
		if v == nil {
			return nil
		}
...
type RoleAssignmentArgs struct {
	...
	// Connectors set for the assignment.
	Connectors ResourceSetDescriptionPtrInput `pulumi:"connectors"`
	// Localized description for the metadata.
	Description pulumi.StringMapInput `pulumi:"description"`
	// Localized display names for the metadata.
	DisplayName pulumi.StringMapInput `pulumi:"displayName"`
	// Interactions set for the assignment.
	Interactions ResourceSetDescriptionPtrInput `pulumi:"interactions"`
	// Kpis set for the assignment.
	Kpis ResourceSetDescriptionPtrInput `pulumi:"kpis"`
	// Links set for the assignment.
	Links ResourceSetDescriptionPtrInput `pulumi:"links"`
	// The principals being assigned to.
	Principals AssignmentPrincipalArrayInput `pulumi:"principals"`
	// Profiles set for the assignment.
	Profiles ResourceSetDescriptionPtrInput `pulumi:"profiles"`
	// The Role assignments set for the relationship links.
	RelationshipLinks ResourceSetDescriptionPtrInput `pulumi:"relationshipLinks"`
	// The Role assignments set for the relationships.
	Relationships ResourceSetDescriptionPtrInput `pulumi:"relationships"`
	// Type of roles.
	Role pulumi.StringInput `pulumi:"role"`
	// The Role assignments set for the assignment.
	RoleAssignments ResourceSetDescriptionPtrInput `pulumi:"roleAssignments"`
	// Sas Policies set for the assignment.
	SasPolicies ResourceSetDescriptionPtrInput `pulumi:"sasPolicies"`
	// The Role assignments set for the assignment.
	Segments ResourceSetDescriptionPtrInput `pulumi:"segments"`
	// Views set for the assignment.
	Views ResourceSetDescriptionPtrInput `pulumi:"views"`
	// Widget types set for the assignment.
...
func (o RoleAssignmentPtrOutput) Principals() AssignmentPrincipalArrayOutput {
	return o.ApplyT(func(v *RoleAssignment) []AssignmentPrincipal {
		...
		return v.Principals
	}).(AssignmentPrincipalArrayOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(KpiDefinitionOutput{})
	pulumi.RegisterOutputType(KpiDefinitionPtrOutput{})
	...
	pulumi.RegisterOutputType(ProfileTypeDefinitionOutput{})
	pulumi.RegisterOutputType(ProfileTypeDefinitionPtrOutput{})
