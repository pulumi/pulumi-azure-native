...
func NewConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:customerinsights/preview:Connector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnector(ctx *pulumi.Context,
	...
	var resource Connector
	err := ctx.ReadResource("azurerm:customerinsights/preview:Connector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
