...
func NewRelationshipLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:customerinsights/latest:RelationshipLink"),
		},
		{
			Type: pulumi.String("azurerm:customerinsights/v20170101:RelationshipLink"),
		},
		{
			Type: pulumi.String("azurerm:customerinsights/v20170426:RelationshipLink"),
		},
	})
	opts = append(opts, aliases)
	var resource RelationshipLink
	err := ctx.RegisterResource("azurerm:customerinsights/preview:RelationshipLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRelationshipLink(ctx *pulumi.Context,
	...
	var resource RelationshipLink
	err := ctx.ReadResource("azurerm:customerinsights/preview:RelationshipLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
