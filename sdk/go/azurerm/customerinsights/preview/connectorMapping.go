...
func NewConnectorMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:customerinsights/preview:ConnectorMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectorMapping(ctx *pulumi.Context,
	...
	var resource ConnectorMapping
	err := ctx.ReadResource("azurerm:customerinsights/preview:ConnectorMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
