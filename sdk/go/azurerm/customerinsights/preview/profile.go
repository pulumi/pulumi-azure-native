...
func NewProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:customerinsights/latest:Profile"),
		},
		{
			Type: pulumi.String("azurerm:customerinsights/v20170101:Profile"),
		},
		{
			Type: pulumi.String("azurerm:customerinsights/v20170426:Profile"),
		},
	})
	opts = append(opts, aliases)
	var resource Profile
	err := ctx.RegisterResource("azurerm:customerinsights/preview:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("azurerm:customerinsights/preview:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
