...
func NewRelationship(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:customerinsights/preview:Relationship", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRelationship(ctx *pulumi.Context,
	...
	var resource Relationship
	err := ctx.ReadResource("azurerm:customerinsights/preview:Relationship", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
