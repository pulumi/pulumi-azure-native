...
func NewKpi(ctx *pulumi.Context,
	...
	var resource Kpi
	err := ctx.RegisterResource("azurerm:customerinsights/preview:Kpi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKpi(ctx *pulumi.Context,
	...
	var resource Kpi
	err := ctx.ReadResource("azurerm:customerinsights/preview:Kpi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
