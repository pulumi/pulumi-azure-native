...
func NewPrivateLinkForAzureAd(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:aadiam/latest:privateLinkForAzureAd"),
		},
	})
...
func GetPrivateLinkForAzureAd(ctx *pulumi.Context,
	...
	var resource PrivateLinkForAzureAd
	err := ctx.ReadResource("azurerm:aadiam/v20200301preview:privateLinkForAzureAd", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
