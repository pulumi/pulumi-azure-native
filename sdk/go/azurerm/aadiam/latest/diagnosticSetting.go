...
func NewDiagnosticSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:aadiam/latest:DiagnosticSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiagnosticSetting(ctx *pulumi.Context,
	...
	var resource DiagnosticSetting
	err := ctx.ReadResource("azurerm:aadiam/latest:DiagnosticSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
