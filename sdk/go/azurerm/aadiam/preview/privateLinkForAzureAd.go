...
func NewPrivateLinkForAzureAd(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:aadiam/v20200301preview:privateLinkForAzureAd"),
		},
	})
	opts = append(opts, aliases)
	var resource PrivateLinkForAzureAd
	err := ctx.RegisterResource("azurerm:aadiam/preview:privateLinkForAzureAd", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkForAzureAd(ctx *pulumi.Context,
	...
	var resource PrivateLinkForAzureAd
	err := ctx.ReadResource("azurerm:aadiam/preview:privateLinkForAzureAd", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
