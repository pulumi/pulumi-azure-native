...
func NewAzureADMetric(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:aadiam/v20200701preview:azureADMetric"),
		},
	})
	opts = append(opts, aliases)
	var resource AzureADMetric
	err := ctx.RegisterResource("azurerm:aadiam/preview:azureADMetric", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureADMetric(ctx *pulumi.Context,
	...
	var resource AzureADMetric
	err := ctx.ReadResource("azurerm:aadiam/preview:azureADMetric", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
