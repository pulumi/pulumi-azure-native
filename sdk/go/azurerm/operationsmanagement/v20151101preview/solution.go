...
func NewSolution(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:operationsmanagement/preview:Solution"),
		},
	})
...
func GetSolution(ctx *pulumi.Context,
	...
	var resource Solution
	err := ctx.ReadResource("azurerm:operationsmanagement/v20151101preview:Solution", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
