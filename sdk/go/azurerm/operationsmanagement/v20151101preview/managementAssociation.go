...
func NewManagementAssociation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:operationsmanagement/latest:ManagementAssociation"),
		},
	})
...
func GetManagementAssociation(ctx *pulumi.Context,
	...
	var resource ManagementAssociation
	err := ctx.ReadResource("azurerm:operationsmanagement/v20151101preview:ManagementAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
