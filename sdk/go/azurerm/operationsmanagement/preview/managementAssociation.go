...
func NewManagementAssociation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:operationsmanagement/v20151101preview:ManagementAssociation"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagementAssociation
	err := ctx.RegisterResource("azurerm:operationsmanagement/preview:ManagementAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementAssociation(ctx *pulumi.Context,
	...
	var resource ManagementAssociation
	err := ctx.ReadResource("azurerm:operationsmanagement/preview:ManagementAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
