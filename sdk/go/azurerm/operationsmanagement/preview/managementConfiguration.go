...
func NewManagementConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:operationsmanagement/v20151101preview:ManagementConfiguration"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagementConfiguration
	err := ctx.RegisterResource("azurerm:operationsmanagement/preview:ManagementConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementConfiguration(ctx *pulumi.Context,
	...
	var resource ManagementConfiguration
	err := ctx.ReadResource("azurerm:operationsmanagement/preview:ManagementConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
