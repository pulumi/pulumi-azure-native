...
//
// import (
// 	batch "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/batch/v20190801"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewApplicationPackage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:batch/v20200301:ApplicationPackage"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:batch/v20190801:ApplicationPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationPackage(ctx *pulumi.Context,
	...
	var resource ApplicationPackage
	err := ctx.ReadResource("azurerm:batch/v20190801:ApplicationPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
