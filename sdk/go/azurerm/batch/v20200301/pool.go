...
func NewPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:batch/latest:Pool"),
		},
		{
			Type: pulumi.String("azurerm:batch/preview:Pool"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:batch/v20190401:Pool"),
		},
		{
	...
	var resource Pool
	err := ctx.RegisterResource("azurerm:batch/v20200301:Pool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.ReadResource("azurerm:batch/v20200301:Pool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
