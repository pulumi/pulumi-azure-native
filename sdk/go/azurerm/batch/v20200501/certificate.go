...
func NewCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:batch/latest:Certificate"),
		},
		{
			Type: pulumi.String("azurerm:batch/preview:Certificate"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:batch/v20200501:Certificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificate(ctx *pulumi.Context,
	...
	var resource Certificate
	err := ctx.ReadResource("azurerm:batch/v20200501:Certificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
