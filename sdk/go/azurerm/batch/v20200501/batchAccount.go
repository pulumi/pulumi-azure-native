...
func NewBatchAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:batch/v20200501:BatchAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBatchAccount(ctx *pulumi.Context,
	...
	var resource BatchAccount
	err := ctx.ReadResource("azurerm:batch/v20200501:BatchAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
