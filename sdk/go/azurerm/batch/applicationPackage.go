...
func NewApplicationPackage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:batch:ApplicationPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationPackage(ctx *pulumi.Context,
	...
	var resource ApplicationPackage
	err := ctx.ReadResource("azurerm:batch:ApplicationPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
