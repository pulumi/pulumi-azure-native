...
// 					Id: pulumi.String("/subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/providers/Microsoft.Peering/peerAsns/myAsn1"),
// 				},
// 			},
...
func NewPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:peering/v20200101preview:Peering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeering(ctx *pulumi.Context,
	...
	var resource Peering
	err := ctx.ReadResource("azurerm:peering/v20200101preview:Peering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
