...
func NewRegisteredAsn(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:peering/v20200101preview:RegisteredAsn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegisteredAsn(ctx *pulumi.Context,
	...
	var resource RegisteredAsn
	err := ctx.ReadResource("azurerm:peering/v20200101preview:RegisteredAsn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
