...
func NewPrefix(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:peering/v20200401:Prefix"),
		},
	})
	opts = append(opts, aliases)
	var resource Prefix
	err := ctx.RegisterResource("azurerm:peering/v20200101preview:Prefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrefix(ctx *pulumi.Context,
	...
	var resource Prefix
	err := ctx.ReadResource("azurerm:peering/v20200101preview:Prefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
