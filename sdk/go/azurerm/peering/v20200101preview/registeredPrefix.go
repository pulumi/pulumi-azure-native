...
func NewRegisteredPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:peering/v20200101preview:RegisteredPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegisteredPrefix(ctx *pulumi.Context,
	...
	var resource RegisteredPrefix
	err := ctx.ReadResource("azurerm:peering/v20200101preview:RegisteredPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
