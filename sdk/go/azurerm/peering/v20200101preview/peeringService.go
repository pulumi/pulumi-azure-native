...
//
// import (
// 	peering "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/peering/v20200101preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewPeeringService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:peering/v20200101preview:PeeringService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeeringService(ctx *pulumi.Context,
	...
	var resource PeeringService
	err := ctx.ReadResource("azurerm:peering/v20200101preview:PeeringService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
