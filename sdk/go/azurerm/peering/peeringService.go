...
func NewPeeringService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:peering:PeeringService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeeringService(ctx *pulumi.Context,
	...
	var resource PeeringService
	err := ctx.ReadResource("azurerm:peering:PeeringService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
