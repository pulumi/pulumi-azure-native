...
//
// import (
// 	peering "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/peering/v20190801preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
// 							MaxPrefixesAdvertisedV6: pulumi.Int(100),
// 							Md5AuthenticationKey:    pulumi.String("test-md5-auth-key"),
// 							SessionPrefixV4:         pulumi.String("192.168.1.0/31"),
// 							SessionPrefixV6:         pulumi.String("fd00::2/127"),
// 						},
...
// 			PeeringName:       pulumi.String("MyPeering"),
...
func NewPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:peering/v20190801preview:Peering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeering(ctx *pulumi.Context,
	...
	var resource Peering
	err := ctx.ReadResource("azurerm:peering/v20190801preview:Peering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
