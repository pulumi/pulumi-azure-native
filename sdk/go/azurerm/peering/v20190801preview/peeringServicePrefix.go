...
// 		_, err := peering.NewPeeringServicePrefix(ctx, "peeringServicePrefix", &peering.PeeringServicePrefixArgs{
...
func NewPeeringServicePrefix(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:peering/latest:PeeringServicePrefix"),
		},
		{
			Type: pulumi.String("azurerm:peering/v20190901preview:PeeringServicePrefix"),
		},
		{
			Type: pulumi.String("azurerm:peering/v20200101preview:PeeringServicePrefix"),
		},
		{
			Type: pulumi.String("azurerm:peering/v20200401:PeeringServicePrefix"),
		},
	})
	opts = append(opts, aliases)
	var resource PeeringServicePrefix
	err := ctx.RegisterResource("azurerm:peering/v20190801preview:PeeringServicePrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeeringServicePrefix(ctx *pulumi.Context,
	...
	var resource PeeringServicePrefix
	err := ctx.ReadResource("azurerm:peering/v20190801preview:PeeringServicePrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
