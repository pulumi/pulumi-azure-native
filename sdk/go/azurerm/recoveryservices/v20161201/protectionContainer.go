...
//
// import (
// 	recoveryservices "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/recoveryservices/v20161201"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func GetProtectionContainer(ctx *pulumi.Context,
	...
	var resource ProtectionContainer
	err := ctx.ReadResource("azurerm:recoveryservices/v20161201:ProtectionContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
