...
func NewReplicationStorageClassificationMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices:ReplicationStorageClassificationMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationStorageClassificationMapping(ctx *pulumi.Context,
	...
	var resource ReplicationStorageClassificationMapping
	err := ctx.ReadResource("azurerm:recoveryservices:ReplicationStorageClassificationMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
