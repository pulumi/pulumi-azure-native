...
type ProtectionPolicy struct {
	...
	Properties ProtectionPolicyResponseOutput `pulumi:"properties"`
	// Resource tags.
...
func NewProtectionPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/latest:ProtectionPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionPolicy(ctx *pulumi.Context,
	...
	var resource ProtectionPolicy
	err := ctx.ReadResource("azurerm:recoveryservices/latest:ProtectionPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ProtectionPolicyState struct {
	...
	// The base class for a backup policy. Workload-specific backup policies are derived from this class.
	Properties ProtectionPolicyResponsePtrInput
	// Resource tags.
