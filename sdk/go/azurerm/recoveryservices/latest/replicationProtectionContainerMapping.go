...
func NewReplicationProtectionContainerMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/latest:ReplicationProtectionContainerMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationProtectionContainerMapping(ctx *pulumi.Context,
	...
	var resource ReplicationProtectionContainerMapping
	err := ctx.ReadResource("azurerm:recoveryservices/latest:ReplicationProtectionContainerMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
