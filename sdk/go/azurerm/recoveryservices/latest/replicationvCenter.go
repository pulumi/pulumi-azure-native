...
func NewReplicationvCenter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/latest:ReplicationvCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationvCenter(ctx *pulumi.Context,
	...
	var resource ReplicationvCenter
	err := ctx.ReadResource("azurerm:recoveryservices/latest:ReplicationvCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
