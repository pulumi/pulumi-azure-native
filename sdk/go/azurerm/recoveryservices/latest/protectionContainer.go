...
func NewProtectionContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/latest:ProtectionContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionContainer(ctx *pulumi.Context,
	...
	var resource ProtectionContainer
	err := ctx.ReadResource("azurerm:recoveryservices/latest:ProtectionContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
