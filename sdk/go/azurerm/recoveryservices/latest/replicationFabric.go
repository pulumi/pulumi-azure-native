...
func NewReplicationFabric(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/latest:ReplicationFabric", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationFabric(ctx *pulumi.Context,
	...
	var resource ReplicationFabric
	err := ctx.ReadResource("azurerm:recoveryservices/latest:ReplicationFabric", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
