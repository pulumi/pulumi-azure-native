...
// backup item type.
func (o ProtectedItemTypeOutput) ProtectedItemType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProtectedItemType) *string { return v.ProtectedItemType }).(pulumi.StringPtrOutput)
}
