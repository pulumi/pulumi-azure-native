...
func NewReplicationPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:recoveryservices/latest:ReplicationPolicy"),
		},
		{
			Type: pulumi.String("azurerm:recoveryservices/preview:ReplicationPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/v20180710:ReplicationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationPolicy(ctx *pulumi.Context,
	...
	var resource ReplicationPolicy
	err := ctx.ReadResource("azurerm:recoveryservices/v20180710:ReplicationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
