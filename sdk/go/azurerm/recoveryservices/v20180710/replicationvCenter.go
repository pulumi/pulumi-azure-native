...
func NewReplicationvCenter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/v20180710:ReplicationvCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationvCenter(ctx *pulumi.Context,
	...
	var resource ReplicationvCenter
	err := ctx.ReadResource("azurerm:recoveryservices/v20180710:ReplicationvCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
