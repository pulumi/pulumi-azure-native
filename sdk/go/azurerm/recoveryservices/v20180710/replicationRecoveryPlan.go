...
func NewReplicationRecoveryPlan(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:recoveryservices/v20180110:ReplicationRecoveryPlan"),
		},
	})
	opts = append(opts, aliases)
	var resource ReplicationRecoveryPlan
	err := ctx.RegisterResource("azurerm:recoveryservices/v20180710:ReplicationRecoveryPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationRecoveryPlan(ctx *pulumi.Context,
	...
	var resource ReplicationRecoveryPlan
	err := ctx.ReadResource("azurerm:recoveryservices/v20180710:ReplicationRecoveryPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
