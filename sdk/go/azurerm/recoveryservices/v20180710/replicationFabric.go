...
func NewReplicationFabric(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/v20180710:ReplicationFabric", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationFabric(ctx *pulumi.Context,
	...
	var resource ReplicationFabric
	err := ctx.ReadResource("azurerm:recoveryservices/v20180710:ReplicationFabric", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
