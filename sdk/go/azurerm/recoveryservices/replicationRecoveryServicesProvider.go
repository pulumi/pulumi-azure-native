...
func NewReplicationRecoveryServicesProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices:ReplicationRecoveryServicesProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationRecoveryServicesProvider(ctx *pulumi.Context,
	...
	var resource ReplicationRecoveryServicesProvider
	err := ctx.ReadResource("azurerm:recoveryservices:ReplicationRecoveryServicesProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
