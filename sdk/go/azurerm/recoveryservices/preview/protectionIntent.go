...
func NewProtectionIntent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/preview:ProtectionIntent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionIntent(ctx *pulumi.Context,
	...
	var resource ProtectionIntent
	err := ctx.ReadResource("azurerm:recoveryservices/preview:ProtectionIntent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
