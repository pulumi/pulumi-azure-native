...
type ProtectionContainer struct {
	...
	Properties ProtectionContainerResponseOutput `pulumi:"properties"`
	// Resource tags.
...
func NewProtectionContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/preview:ProtectionContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionContainer(ctx *pulumi.Context,
	...
	var resource ProtectionContainer
	err := ctx.ReadResource("azurerm:recoveryservices/preview:ProtectionContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ProtectionContainerState struct {
	...
	// ProtectionContainerResource properties
	Properties ProtectionContainerResponsePtrInput
	// Resource tags.
