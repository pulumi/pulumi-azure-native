...
func NewReplicationNetworkMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/preview:ReplicationNetworkMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationNetworkMapping(ctx *pulumi.Context,
	...
	var resource ReplicationNetworkMapping
	err := ctx.ReadResource("azurerm:recoveryservices/preview:ReplicationNetworkMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
