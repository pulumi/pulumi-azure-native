...
func NewReplicationMigrationItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/preview:ReplicationMigrationItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationMigrationItem(ctx *pulumi.Context,
	...
	var resource ReplicationMigrationItem
	err := ctx.ReadResource("azurerm:recoveryservices/preview:ReplicationMigrationItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
