...
//
// import (
// 	recoveryservices "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/recoveryservices/v20190615"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewProtectedItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/v20190615:ProtectedItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectedItem(ctx *pulumi.Context,
	...
	var resource ProtectedItem
	err := ctx.ReadResource("azurerm:recoveryservices/v20190615:ProtectedItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
