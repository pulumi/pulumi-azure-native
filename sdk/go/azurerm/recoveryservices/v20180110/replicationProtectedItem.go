...
func NewReplicationProtectedItem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:recoveryservices/v20180710:ReplicationProtectedItem"),
		},
	})
	opts = append(opts, aliases)
	var resource ReplicationProtectedItem
	err := ctx.RegisterResource("azurerm:recoveryservices/v20180110:ReplicationProtectedItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationProtectedItem(ctx *pulumi.Context,
	...
	var resource ReplicationProtectedItem
	err := ctx.ReadResource("azurerm:recoveryservices/v20180110:ReplicationProtectedItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
