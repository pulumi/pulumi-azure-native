...
func NewReplicationNetworkMapping(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:recoveryservices/v20180710:ReplicationNetworkMapping"),
		},
	})
	opts = append(opts, aliases)
	var resource ReplicationNetworkMapping
	err := ctx.RegisterResource("azurerm:recoveryservices/v20180110:ReplicationNetworkMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationNetworkMapping(ctx *pulumi.Context,
	...
	var resource ReplicationNetworkMapping
	err := ctx.ReadResource("azurerm:recoveryservices/v20180110:ReplicationNetworkMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
