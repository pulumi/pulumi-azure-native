...
type ProtectionIntent struct {
	...
	Properties ProtectionIntentResponseOutput `pulumi:"properties"`
	// Resource tags.
...
func GetProtectionIntent(ctx *pulumi.Context,
	...
	var resource ProtectionIntent
	err := ctx.ReadResource("azurerm:recoveryservices/v20170701:ProtectionIntent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ProtectionIntentState struct {
	...
	// ProtectionIntentResource properties
	Properties ProtectionIntentResponsePtrInput
	// Resource tags.
