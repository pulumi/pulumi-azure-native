...
func NewReplicationMigrationItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices:ReplicationMigrationItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationMigrationItem(ctx *pulumi.Context,
	...
	var resource ReplicationMigrationItem
	err := ctx.ReadResource("azurerm:recoveryservices:ReplicationMigrationItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
