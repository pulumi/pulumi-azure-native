...
func NewReplicationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:recoveryservices/v20160810:ReplicationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationPolicy(ctx *pulumi.Context,
	...
	var resource ReplicationPolicy
	err := ctx.ReadResource("azurerm:recoveryservices/v20160810:ReplicationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
