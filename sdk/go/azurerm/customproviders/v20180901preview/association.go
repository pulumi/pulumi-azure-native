...
func NewAssociation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:customproviders/latest:Association"),
		},
	})
...
func GetAssociation(ctx *pulumi.Context,
	...
	var resource Association
	err := ctx.ReadResource("azurerm:customproviders/v20180901preview:Association", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
