...
func NewCustomResourceProvider(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:customproviders/preview:CustomResourceProvider"),
		},
	})
...
func GetCustomResourceProvider(ctx *pulumi.Context,
	...
	var resource CustomResourceProvider
	err := ctx.ReadResource("azurerm:customproviders/v20180901preview:CustomResourceProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
