...
func NewAssociation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:customproviders/v20180901preview:Association"),
		},
	})
	opts = append(opts, aliases)
	var resource Association
	err := ctx.RegisterResource("azurerm:customproviders/preview:Association", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssociation(ctx *pulumi.Context,
	...
	var resource Association
	err := ctx.ReadResource("azurerm:customproviders/preview:Association", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
