...
func NewCustomResourceProvider(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:customproviders/v20180901preview:CustomResourceProvider"),
		},
	})
	opts = append(opts, aliases)
	var resource CustomResourceProvider
	err := ctx.RegisterResource("azurerm:customproviders/preview:CustomResourceProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomResourceProvider(ctx *pulumi.Context,
	...
	var resource CustomResourceProvider
	err := ctx.ReadResource("azurerm:customproviders/preview:CustomResourceProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
