...
func NewControllerDetails(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:delegatednetwork/v20200808preview:ControllerDetails"),
		},
	})
	opts = append(opts, aliases)
	var resource ControllerDetails
	err := ctx.RegisterResource("azurerm:delegatednetwork/preview:ControllerDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetControllerDetails(ctx *pulumi.Context,
	...
	var resource ControllerDetails
	err := ctx.ReadResource("azurerm:delegatednetwork/preview:ControllerDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
