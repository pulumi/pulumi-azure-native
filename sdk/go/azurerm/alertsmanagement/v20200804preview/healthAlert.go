...
func NewHealthAlert(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:alertsmanagement/latest:HealthAlert"),
		},
	})
...
func GetHealthAlert(ctx *pulumi.Context,
	...
	var resource HealthAlert
	err := ctx.ReadResource("azurerm:alertsmanagement/v20200804preview:HealthAlert", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
