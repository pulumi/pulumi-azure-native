...
type AlertRulePropertiesArgs struct {
	// The alert rule actions.
	ActionGroups ActionGroupsInformationInput `pulumi:"actionGroups"`
	// The alert rule description.
	Description pulumi.StringPtrInput `pulumi:"description"`
	// The alert rule's detector.
	Detector DetectorInput `pulumi:"detector"`
	// The alert rule frequency in ISO8601 format. The time granularity must be in minutes and minimum value is 5 minutes.
	...
	// The alert rule throttling information.
	Throttling ThrottlingInformationPtrInput `pulumi:"throttling"`
}
...
// The alert rule actions.
func (o AlertRulePropertiesOutput) ActionGroups() ActionGroupsInformationOutput {
	return o.ApplyT(func(v AlertRuleProperties) ActionGroupsInformation { return v.ActionGroups }).(ActionGroupsInformationOutput)
}

// The alert rule description.
func (o AlertRulePropertiesOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AlertRuleProperties) *string { return v.Description }).(pulumi.StringPtrOutput)
}

// The alert rule's detector.
func (o AlertRulePropertiesOutput) Detector() DetectorOutput {
	return o.ApplyT(func(v AlertRuleProperties) Detector { return v.Detector }).(DetectorOutput)
}

// The alert rule frequency in ISO8601 format. The time granularity must be in minutes and minimum value is 5 minutes.
func (o AlertRulePropertiesOutput) Frequency() pulumi.StringOutput {
	return o.ApplyT(func(v AlertRuleProperties) string { return v.Frequency }).(pulumi.StringOutput)
}

// The alert rule resources scope.
func (o AlertRulePropertiesOutput) Scope() pulumi.StringArrayOutput {
	return o.ApplyT(func(v AlertRuleProperties) []string { return v.Scope }).(pulumi.StringArrayOutput)
}

// The alert rule severity.
func (o AlertRulePropertiesOutput) Severity() pulumi.StringOutput {
	return o.ApplyT(func(v AlertRuleProperties) string { return v.Severity }).(pulumi.StringOutput)
}

// The alert rule state.
func (o AlertRulePropertiesOutput) State() pulumi.StringOutput {
	return o.ApplyT(func(v AlertRuleProperties) string { return v.State }).(pulumi.StringOutput)
}

// The alert rule throttling information.
func (o AlertRulePropertiesOutput) Throttling() ThrottlingInformationPtrOutput {
	return o.ApplyT(func(v AlertRuleProperties) *ThrottlingInformation { return v.Throttling }).(ThrottlingInformationPtrOutput)
}
...
func (o AlertRulePropertiesPtrOutput) Elem() AlertRulePropertiesOutput {
	return o.ApplyT(func(v *AlertRuleProperties) AlertRuleProperties { return *v }).(AlertRulePropertiesOutput)
}

// The alert rule actions.
func (o AlertRulePropertiesPtrOutput) ActionGroups() ActionGroupsInformationPtrOutput {
	return o.ApplyT(func(v *AlertRuleProperties) *ActionGroupsInformation {
		if v == nil {
			return nil
		}
...
// The alert rule description.
func (o AlertRulePropertiesPtrOutput) Description() pulumi.StringPtrOutput {
...
// The alert rule's detector.
func (o AlertRulePropertiesPtrOutput) Detector() DetectorPtrOutput {
	return o.ApplyT(func(v *AlertRuleProperties) *Detector {
		if v == nil {
			return nil
		}
		return &v.Detector
...
// The alert rule frequency in ISO8601 format. The time granularity must be in minutes and minimum value is 5 minutes.
func (o AlertRulePropertiesPtrOutput) Frequency() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AlertRuleProperties) *string {
		if v == nil {
			return nil
		}
...
// The alert rule resources scope.
func (o AlertRulePropertiesPtrOutput) Scope() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *AlertRuleProperties) []string {
		if v == nil {
			return nil
		}
...
// The alert rule severity.
func (o AlertRulePropertiesPtrOutput) Severity() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AlertRuleProperties) *string {
		if v == nil {
			return nil
		}
...
// The alert rule state.
func (o AlertRulePropertiesPtrOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AlertRuleProperties) *string {
		if v == nil {
			return nil
		}
...
// The alert rule throttling information.
func (o AlertRulePropertiesPtrOutput) Throttling() ThrottlingInformationPtrOutput {
	return o.ApplyT(func(v *AlertRuleProperties) *ThrottlingInformation {
		if v == nil {
			return nil
		}
		return v.Throttling
...
// AlertRulePropertiesResponseInput is an input type that accepts AlertRulePropertiesResponseArgs and AlertRulePropertiesResponseOutput values.
// You can construct a concrete instance of `AlertRulePropertiesResponseInput` via:
//
//          AlertRulePropertiesResponseArgs{...}
type AlertRulePropertiesResponseInput interface {
	pulumi.Input

	ToAlertRulePropertiesResponseOutput() AlertRulePropertiesResponseOutput
	ToAlertRulePropertiesResponseOutputWithContext(context.Context) AlertRulePropertiesResponseOutput
}

// The alert rule properties.
type AlertRulePropertiesResponseArgs struct {
	// The alert rule actions.
	ActionGroups ActionGroupsInformationResponseInput `pulumi:"actionGroups"`
	// The alert rule description.
	Description pulumi.StringPtrInput `pulumi:"description"`
	// The alert rule's detector.
	Detector DetectorResponseInput `pulumi:"detector"`
	// The alert rule frequency in ISO8601 format. The time granularity must be in minutes and minimum value is 5 minutes.
	Frequency pulumi.StringInput `pulumi:"frequency"`
	// The alert rule resources scope.
	Scope pulumi.StringArrayInput `pulumi:"scope"`
	...
	State pulumi.StringInput `pulumi:"state"`
	// The alert rule throttling information.
	Throttling ThrottlingInformationResponsePtrInput `pulumi:"throttling"`
}

func (AlertRulePropertiesResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*AlertRulePropertiesResponse)(nil)).Elem()
}

func (i AlertRulePropertiesResponseArgs) ToAlertRulePropertiesResponseOutput() AlertRulePropertiesResponseOutput {
	return i.ToAlertRulePropertiesResponseOutputWithContext(context.Background())
}

func (i AlertRulePropertiesResponseArgs) ToAlertRulePropertiesResponseOutputWithContext(ctx context.Context) AlertRulePropertiesResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AlertRulePropertiesResponseOutput)
}

func (i AlertRulePropertiesResponseArgs) ToAlertRulePropertiesResponsePtrOutput() AlertRulePropertiesResponsePtrOutput {
	return i.ToAlertRulePropertiesResponsePtrOutputWithContext(context.Background())
}

func (i AlertRulePropertiesResponseArgs) ToAlertRulePropertiesResponsePtrOutputWithContext(ctx context.Context) AlertRulePropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AlertRulePropertiesResponseOutput).ToAlertRulePropertiesResponsePtrOutputWithContext(ctx)
}

// AlertRulePropertiesResponsePtrInput is an input type that accepts AlertRulePropertiesResponseArgs, AlertRulePropertiesResponsePtr and AlertRulePropertiesResponsePtrOutput values.
// You can construct a concrete instance of `AlertRulePropertiesResponsePtrInput` via:
//
//          AlertRulePropertiesResponseArgs{...}
//
//  or:
//
//          nil
type AlertRulePropertiesResponsePtrInput interface {
	pulumi.Input

	ToAlertRulePropertiesResponsePtrOutput() AlertRulePropertiesResponsePtrOutput
	ToAlertRulePropertiesResponsePtrOutputWithContext(context.Context) AlertRulePropertiesResponsePtrOutput
}

type alertRulePropertiesResponsePtrType AlertRulePropertiesResponseArgs

func AlertRulePropertiesResponsePtr(v *AlertRulePropertiesResponseArgs) AlertRulePropertiesResponsePtrInput {
	return (*alertRulePropertiesResponsePtrType)(v)
}

func (*alertRulePropertiesResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**AlertRulePropertiesResponse)(nil)).Elem()
}

func (i *alertRulePropertiesResponsePtrType) ToAlertRulePropertiesResponsePtrOutput() AlertRulePropertiesResponsePtrOutput {
	return i.ToAlertRulePropertiesResponsePtrOutputWithContext(context.Background())
}

func (i *alertRulePropertiesResponsePtrType) ToAlertRulePropertiesResponsePtrOutputWithContext(ctx context.Context) AlertRulePropertiesResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AlertRulePropertiesResponsePtrOutput)
}
...
func (o AlertRulePropertiesResponseOutput) ToAlertRulePropertiesResponsePtrOutput() AlertRulePropertiesResponsePtrOutput {
	return o.ToAlertRulePropertiesResponsePtrOutputWithContext(context.Background())
}

func (o AlertRulePropertiesResponseOutput) ToAlertRulePropertiesResponsePtrOutputWithContext(ctx context.Context) AlertRulePropertiesResponsePtrOutput {
	return o.ApplyT(func(v AlertRulePropertiesResponse) *AlertRulePropertiesResponse {
		return &v
	}).(AlertRulePropertiesResponsePtrOutput)
}

// The alert rule actions.
func (o AlertRulePropertiesResponseOutput) ActionGroups() ActionGroupsInformationResponseOutput {
	return o.ApplyT(func(v AlertRulePropertiesResponse) ActionGroupsInformationResponse { return v.ActionGroups }).(ActionGroupsInformationResponseOutput)
}

// The alert rule description.
func (o AlertRulePropertiesResponseOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AlertRulePropertiesResponse) *string { return v.Description }).(pulumi.StringPtrOutput)
}

// The alert rule's detector.
func (o AlertRulePropertiesResponseOutput) Detector() DetectorResponseOutput {
	return o.ApplyT(func(v AlertRulePropertiesResponse) DetectorResponse { return v.Detector }).(DetectorResponseOutput)
}

// The alert rule frequency in ISO8601 format. The time granularity must be in minutes and minimum value is 5 minutes.
func (o AlertRulePropertiesResponseOutput) Frequency() pulumi.StringOutput {
	return o.ApplyT(func(v AlertRulePropertiesResponse) string { return v.Frequency }).(pulumi.StringOutput)
}

// The alert rule resources scope.
func (o AlertRulePropertiesResponseOutput) Scope() pulumi.StringArrayOutput {
	return o.ApplyT(func(v AlertRulePropertiesResponse) []string { return v.Scope }).(pulumi.StringArrayOutput)
}

// The alert rule severity.
func (o AlertRulePropertiesResponseOutput) Severity() pulumi.StringOutput {
	return o.ApplyT(func(v AlertRulePropertiesResponse) string { return v.Severity }).(pulumi.StringOutput)
}

// The alert rule state.
func (o AlertRulePropertiesResponseOutput) State() pulumi.StringOutput {
	return o.ApplyT(func(v AlertRulePropertiesResponse) string { return v.State }).(pulumi.StringOutput)
}

// The alert rule throttling information.
func (o AlertRulePropertiesResponseOutput) Throttling() ThrottlingInformationResponsePtrOutput {
	return o.ApplyT(func(v AlertRulePropertiesResponse) *ThrottlingInformationResponse { return v.Throttling }).(ThrottlingInformationResponsePtrOutput)
}
...
func (o AlertRulePropertiesResponsePtrOutput) Elem() AlertRulePropertiesResponseOutput {
	return o.ApplyT(func(v *AlertRulePropertiesResponse) AlertRulePropertiesResponse { return *v }).(AlertRulePropertiesResponseOutput)
}

// The alert rule actions.
func (o AlertRulePropertiesResponsePtrOutput) ActionGroups() ActionGroupsInformationResponsePtrOutput {
	return o.ApplyT(func(v *AlertRulePropertiesResponse) *ActionGroupsInformationResponse {
		if v == nil {
			return nil
		}
		return &v.ActionGroups
...
// The alert rule description.
func (o AlertRulePropertiesResponsePtrOutput) Description() pulumi.StringPtrOutput {
...
// The alert rule's detector.
func (o AlertRulePropertiesResponsePtrOutput) Detector() DetectorResponsePtrOutput {
	return o.ApplyT(func(v *AlertRulePropertiesResponse) *DetectorResponse {
		if v == nil {
			return nil
		}
		return &v.Detector
...
// The alert rule frequency in ISO8601 format. The time granularity must be in minutes and minimum value is 5 minutes.
func (o AlertRulePropertiesResponsePtrOutput) Frequency() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AlertRulePropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
// The alert rule resources scope.
func (o AlertRulePropertiesResponsePtrOutput) Scope() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *AlertRulePropertiesResponse) []string {
		if v == nil {
			return nil
		}
...
// The alert rule severity.
func (o AlertRulePropertiesResponsePtrOutput) Severity() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AlertRulePropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
// The alert rule state.
func (o AlertRulePropertiesResponsePtrOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AlertRulePropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
// The alert rule throttling information.
func (o AlertRulePropertiesResponsePtrOutput) Throttling() ThrottlingInformationResponsePtrOutput {
	return o.ApplyT(func(v *AlertRulePropertiesResponse) *ThrottlingInformationResponse {
		if v == nil {
			return nil
		}
		return v.Throttling
