...
//
// import (
// 	alertsmanagement "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/alertsmanagement/v20190505preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewActionRuleByName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:alertsmanagement/v20190505preview:ActionRuleByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActionRuleByName(ctx *pulumi.Context,
	...
	var resource ActionRuleByName
	err := ctx.ReadResource("azurerm:alertsmanagement/v20190505preview:ActionRuleByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
