...
// The resource location.
func (o SmartDetectorAlertRuleTypeOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v SmartDetectorAlertRuleType) *string { return v.Location }).(pulumi.StringPtrOutput)
}
...
// The resource tags.
func (o SmartDetectorAlertRuleTypeOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v SmartDetectorAlertRuleType) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
