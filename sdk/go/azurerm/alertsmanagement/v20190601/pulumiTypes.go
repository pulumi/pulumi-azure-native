...
// The resource tags.
func (o SmartDetectorAlertRuleTypeOutput) Tags() pulumi.MapOutput {
	return o.ApplyT(func(v SmartDetectorAlertRuleType) map[string]interface{} { return v.Tags }).(pulumi.MapOutput)
}
