...
func NewSmartDetectorAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:alertsmanagement/latest:SmartDetectorAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSmartDetectorAlertRule(ctx *pulumi.Context,
	...
	var resource SmartDetectorAlertRule
	err := ctx.ReadResource("azurerm:alertsmanagement/latest:SmartDetectorAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
