...
func NewActionRuleByName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:alertsmanagement/v20181102privatepreview:ActionRuleByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActionRuleByName(ctx *pulumi.Context,
	...
	var resource ActionRuleByName
	err := ctx.ReadResource("azurerm:alertsmanagement/v20181102privatepreview:ActionRuleByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
