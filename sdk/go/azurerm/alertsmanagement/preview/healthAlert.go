...
func NewHealthAlert(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:alertsmanagement/v20200804preview:HealthAlert"),
		},
	})
	opts = append(opts, aliases)
	var resource HealthAlert
	err := ctx.RegisterResource("azurerm:alertsmanagement/preview:HealthAlert", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHealthAlert(ctx *pulumi.Context,
	...
	var resource HealthAlert
	err := ctx.ReadResource("azurerm:alertsmanagement/preview:HealthAlert", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
