...
func NewActionRuleByName(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:alertsmanagement/v20190505preview:ActionRuleByName"),
		},
	})
	opts = append(opts, aliases)
	var resource ActionRuleByName
	err := ctx.RegisterResource("azurerm:alertsmanagement/preview:ActionRuleByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActionRuleByName(ctx *pulumi.Context,
	...
	var resource ActionRuleByName
	err := ctx.ReadResource("azurerm:alertsmanagement/preview:ActionRuleByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
