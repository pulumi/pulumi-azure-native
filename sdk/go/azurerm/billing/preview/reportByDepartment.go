...
func NewReportByDepartment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:billing/v20180801preview:ReportByDepartment"),
		},
	})
	opts = append(opts, aliases)
	var resource ReportByDepartment
	err := ctx.RegisterResource("azurerm:billing/preview:ReportByDepartment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReportByDepartment(ctx *pulumi.Context,
	...
	var resource ReportByDepartment
	err := ctx.ReadResource("azurerm:billing/preview:ReportByDepartment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
