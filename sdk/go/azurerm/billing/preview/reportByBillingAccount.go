...
func NewReportByBillingAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:billing/v20180801preview:ReportByBillingAccount"),
		},
	})
	opts = append(opts, aliases)
	var resource ReportByBillingAccount
	err := ctx.RegisterResource("azurerm:billing/preview:ReportByBillingAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReportByBillingAccount(ctx *pulumi.Context,
	...
	var resource ReportByBillingAccount
	err := ctx.ReadResource("azurerm:billing/preview:ReportByBillingAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
