...
func NewCostAllocationRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:billing/v20200301preview:CostAllocationRule"),
		},
	})
	opts = append(opts, aliases)
	var resource CostAllocationRule
	err := ctx.RegisterResource("azurerm:billing/preview:CostAllocationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCostAllocationRule(ctx *pulumi.Context,
	...
	var resource CostAllocationRule
	err := ctx.ReadResource("azurerm:billing/preview:CostAllocationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
