...
func NewBillingRoleAssignmentByBillingAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:billing/v20191001preview:BillingRoleAssignmentByBillingAccount"),
		},
	})
	opts = append(opts, aliases)
	var resource BillingRoleAssignmentByBillingAccount
	err := ctx.RegisterResource("azurerm:billing/preview:BillingRoleAssignmentByBillingAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingRoleAssignmentByBillingAccount(ctx *pulumi.Context,
	...
	var resource BillingRoleAssignmentByBillingAccount
	err := ctx.ReadResource("azurerm:billing/preview:BillingRoleAssignmentByBillingAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
