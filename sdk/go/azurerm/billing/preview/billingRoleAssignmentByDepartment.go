...
func NewBillingRoleAssignmentByDepartment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:billing/v20191001preview:BillingRoleAssignmentByDepartment"),
		},
	})
	opts = append(opts, aliases)
	var resource BillingRoleAssignmentByDepartment
	err := ctx.RegisterResource("azurerm:billing/preview:BillingRoleAssignmentByDepartment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingRoleAssignmentByDepartment(ctx *pulumi.Context,
	...
	var resource BillingRoleAssignmentByDepartment
	err := ctx.ReadResource("azurerm:billing/preview:BillingRoleAssignmentByDepartment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
