...
func NewBillingRoleAssignmentByEnrollmentAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:billing/v20191001preview:BillingRoleAssignmentByEnrollmentAccount"),
		},
	})
	opts = append(opts, aliases)
	var resource BillingRoleAssignmentByEnrollmentAccount
	err := ctx.RegisterResource("azurerm:billing/preview:BillingRoleAssignmentByEnrollmentAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingRoleAssignmentByEnrollmentAccount(ctx *pulumi.Context,
	...
	var resource BillingRoleAssignmentByEnrollmentAccount
	err := ctx.ReadResource("azurerm:billing/preview:BillingRoleAssignmentByEnrollmentAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
