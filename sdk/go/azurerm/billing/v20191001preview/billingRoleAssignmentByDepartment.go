...
func NewBillingRoleAssignmentByDepartment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:billing/latest:BillingRoleAssignmentByDepartment"),
		},
	})
...
func GetBillingRoleAssignmentByDepartment(ctx *pulumi.Context,
	...
	var resource BillingRoleAssignmentByDepartment
	err := ctx.ReadResource("azurerm:billing/v20191001preview:BillingRoleAssignmentByDepartment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
