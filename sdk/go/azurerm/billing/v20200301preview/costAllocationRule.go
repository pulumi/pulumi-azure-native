...
func NewCostAllocationRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:billing/latest:CostAllocationRule"),
		},
	})
...
func GetCostAllocationRule(ctx *pulumi.Context,
	...
	var resource CostAllocationRule
	err := ctx.ReadResource("azurerm:billing/v20200301preview:CostAllocationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
