...
//
// import (
// 	appconfiguration "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/appconfiguration/v20191001"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewConfigurationStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:appconfiguration/v20191001:ConfigurationStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationStore(ctx *pulumi.Context,
	...
	var resource ConfigurationStore
	err := ctx.ReadResource("azurerm:appconfiguration/v20191001:ConfigurationStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
