...
func NewPolicyExemption(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:authorization/v20200701preview:PolicyExemption"),
		},
	})
	opts = append(opts, aliases)
	var resource PolicyExemption
	err := ctx.RegisterResource("azurerm:authorization/preview:PolicyExemption", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyExemption(ctx *pulumi.Context,
	...
	var resource PolicyExemption
	err := ctx.ReadResource("azurerm:authorization/preview:PolicyExemption", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
