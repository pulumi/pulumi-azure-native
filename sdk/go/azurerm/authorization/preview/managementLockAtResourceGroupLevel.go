...
func NewManagementLockAtResourceGroupLevel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:authorization/preview:ManagementLockAtResourceGroupLevel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementLockAtResourceGroupLevel(ctx *pulumi.Context,
	...
	var resource ManagementLockAtResourceGroupLevel
	err := ctx.ReadResource("azurerm:authorization/preview:ManagementLockAtResourceGroupLevel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
