...
func NewPolicySetDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:authorization/preview:PolicySetDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetDefinition(ctx *pulumi.Context,
	...
	var resource PolicySetDefinition
	err := ctx.ReadResource("azurerm:authorization/preview:PolicySetDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
