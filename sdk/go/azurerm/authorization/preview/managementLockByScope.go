...
func NewManagementLockByScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:authorization/preview:ManagementLockByScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementLockByScope(ctx *pulumi.Context,
	...
	var resource ManagementLockByScope
	err := ctx.ReadResource("azurerm:authorization/preview:ManagementLockByScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
