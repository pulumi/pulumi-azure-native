...
func NewManagementLockAtSubscriptionLevel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:authorization/preview:ManagementLockAtSubscriptionLevel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementLockAtSubscriptionLevel(ctx *pulumi.Context,
	...
	var resource ManagementLockAtSubscriptionLevel
	err := ctx.ReadResource("azurerm:authorization/preview:ManagementLockAtSubscriptionLevel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
