...
//
// import (
// 	authorization "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/authorization/v20180301"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewPolicyDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:authorization/v20180301:PolicyDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyDefinition(ctx *pulumi.Context,
	...
	var resource PolicyDefinition
	err := ctx.ReadResource("azurerm:authorization/v20180301:PolicyDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
