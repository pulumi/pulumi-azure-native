...
func NewPolicySetDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:authorization/v20180301:PolicySetDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetDefinition(ctx *pulumi.Context,
	...
	var resource PolicySetDefinition
	err := ctx.ReadResource("azurerm:authorization/v20180301:PolicySetDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
