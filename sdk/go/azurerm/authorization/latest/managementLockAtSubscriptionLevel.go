...
func NewManagementLockAtSubscriptionLevel(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:authorization/v20160901:ManagementLockAtSubscriptionLevel"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagementLockAtSubscriptionLevel
	err := ctx.RegisterResource("azurerm:authorization/latest:ManagementLockAtSubscriptionLevel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementLockAtSubscriptionLevel(ctx *pulumi.Context,
	...
	var resource ManagementLockAtSubscriptionLevel
	err := ctx.ReadResource("azurerm:authorization/latest:ManagementLockAtSubscriptionLevel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
