...
func NewPolicySetDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:authorization/preview:PolicySetDefinition"),
		},
		{
			Type: pulumi.String("azurerm:authorization/v20170601preview:PolicySetDefinition"),
		},
		{
			Type: pulumi.String("azurerm:authorization/v20180301:PolicySetDefinition"),
		},
		{
			Type: pulumi.String("azurerm:authorization/v20180501:PolicySetDefinition"),
		},
		{
			Type: pulumi.String("azurerm:authorization/v20190101:PolicySetDefinition"),
		},
		{
			Type: pulumi.String("azurerm:authorization/v20190601:PolicySetDefinition"),
		},
		{
			Type: pulumi.String("azurerm:authorization/v20190901:PolicySetDefinition"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:authorization/latest:PolicySetDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetDefinition(ctx *pulumi.Context,
	...
	var resource PolicySetDefinition
	err := ctx.ReadResource("azurerm:authorization/latest:PolicySetDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
