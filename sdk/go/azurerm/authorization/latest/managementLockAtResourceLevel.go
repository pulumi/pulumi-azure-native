...
func NewManagementLockAtResourceLevel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:authorization/latest:ManagementLockAtResourceLevel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementLockAtResourceLevel(ctx *pulumi.Context,
	...
	var resource ManagementLockAtResourceLevel
	err := ctx.ReadResource("azurerm:authorization/latest:ManagementLockAtResourceLevel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
