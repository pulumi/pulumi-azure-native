...
func NewPolicyExemption(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:authorization/latest:PolicyExemption"),
		},
	})
...
func GetPolicyExemption(ctx *pulumi.Context,
	...
	var resource PolicyExemption
	err := ctx.ReadResource("azurerm:authorization/v20200701preview:PolicyExemption", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
