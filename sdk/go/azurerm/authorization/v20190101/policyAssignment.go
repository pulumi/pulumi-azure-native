...
// 				"assignedBy": pulumi.String("Special Someone"),
// 			},
...
// 			Metadata: pulumi.StringMap{
// 				"assignedBy": pulumi.String("Foo Bar"),
// 			},
// 			Parameters: pulumi.StringMapMap{
// 				"prefix": pulumi.StringMap{
// 					"value": pulumi.String("DeptA"),
...
func NewPolicyAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:authorization/v20190101:PolicyAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyAssignment(ctx *pulumi.Context,
	...
	var resource PolicyAssignment
	err := ctx.ReadResource("azurerm:authorization/v20190101:PolicyAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
