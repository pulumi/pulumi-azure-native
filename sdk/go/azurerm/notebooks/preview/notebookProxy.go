...
func NewNotebookProxy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:notebooks/v20191011preview:NotebookProxy"),
		},
	})
	opts = append(opts, aliases)
	var resource NotebookProxy
	err := ctx.RegisterResource("azurerm:notebooks/preview:NotebookProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotebookProxy(ctx *pulumi.Context,
	...
	var resource NotebookProxy
	err := ctx.ReadResource("azurerm:notebooks/preview:NotebookProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
