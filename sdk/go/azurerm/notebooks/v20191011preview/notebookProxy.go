...
func NewNotebookProxy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:notebooks/latest:NotebookProxy"),
		},
	})
...
func GetNotebookProxy(ctx *pulumi.Context,
	...
	var resource NotebookProxy
	err := ctx.ReadResource("azurerm:notebooks/v20191011preview:NotebookProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
