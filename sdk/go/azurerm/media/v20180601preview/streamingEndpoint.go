...
func NewStreamingEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:media/v20180601preview:StreamingEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStreamingEndpoint(ctx *pulumi.Context,
	...
	var resource StreamingEndpoint
	err := ctx.ReadResource("azurerm:media/v20180601preview:StreamingEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
