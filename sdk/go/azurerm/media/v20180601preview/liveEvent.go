...
// 				KeyFrameIntervalDuration: pulumi.String("PT2S"),
...
func NewLiveEvent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:media/v20180601preview:LiveEvent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLiveEvent(ctx *pulumi.Context,
	...
	var resource LiveEvent
	err := ctx.ReadResource("azurerm:media/v20180601preview:LiveEvent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
