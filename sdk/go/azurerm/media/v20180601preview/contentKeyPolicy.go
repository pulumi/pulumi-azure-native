...
func NewContentKeyPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:media/v20180601preview:ContentKeyPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentKeyPolicy(ctx *pulumi.Context,
	...
	var resource ContentKeyPolicy
	err := ctx.ReadResource("azurerm:media/v20180601preview:ContentKeyPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
