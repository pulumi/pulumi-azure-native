...
func NewTransform(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:media/preview:Transform"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:media/v20180601preview:Transform", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransform(ctx *pulumi.Context,
	...
	var resource Transform
	err := ctx.ReadResource("azurerm:media/v20180601preview:Transform", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
