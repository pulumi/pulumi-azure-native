...
func NewTransform(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:media/preview:Transform", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransform(ctx *pulumi.Context,
	...
	var resource Transform
	err := ctx.ReadResource("azurerm:media/preview:Transform", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
