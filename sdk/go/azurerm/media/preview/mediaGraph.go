...
func NewMediaGraph(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:media/preview:MediaGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMediaGraph(ctx *pulumi.Context,
	...
	var resource MediaGraph
	err := ctx.ReadResource("azurerm:media/preview:MediaGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
