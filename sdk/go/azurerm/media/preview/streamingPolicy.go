...
func NewStreamingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:media/preview:StreamingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStreamingPolicy(ctx *pulumi.Context,
	...
	var resource StreamingPolicy
	err := ctx.ReadResource("azurerm:media/preview:StreamingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
