...
func NewMediaService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:media/v20180330preview:MediaService"),
		},
		{
			Type: pulumi.String("azurerm:media/v20180601preview:MediaService"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:media/preview:MediaService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMediaService(ctx *pulumi.Context,
	...
	var resource MediaService
	err := ctx.ReadResource("azurerm:media/preview:MediaService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
