...
func NewLiveEvent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:media/preview:LiveEvent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLiveEvent(ctx *pulumi.Context,
	...
	var resource LiveEvent
	err := ctx.ReadResource("azurerm:media/preview:LiveEvent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
