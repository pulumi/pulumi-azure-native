...
func NewAccountFilter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:media:AccountFilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccountFilter(ctx *pulumi.Context,
	...
	var resource AccountFilter
	err := ctx.ReadResource("azurerm:media:AccountFilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
