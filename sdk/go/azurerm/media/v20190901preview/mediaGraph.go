...
func NewMediaGraph(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:media/v20200201preview:MediaGraph"),
		},
	})
	opts = append(opts, aliases)
	var resource MediaGraph
	err := ctx.RegisterResource("azurerm:media/v20190901preview:MediaGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMediaGraph(ctx *pulumi.Context,
	...
	var resource MediaGraph
	err := ctx.ReadResource("azurerm:media/v20190901preview:MediaGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
