...
func NewAsset(ctx *pulumi.Context,
	...
	var resource Asset
	err := ctx.RegisterResource("azurerm:media/v20180330preview:Asset", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAsset(ctx *pulumi.Context,
	...
	var resource Asset
	err := ctx.ReadResource("azurerm:media/v20180330preview:Asset", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
