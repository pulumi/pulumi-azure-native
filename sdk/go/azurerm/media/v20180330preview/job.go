...
func NewJob(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:media/preview:Job"),
		},
		{
			Type: pulumi.String("azurerm:media/v20180601preview:Job"),
		},
		{
	...
	var resource Job
	err := ctx.RegisterResource("azurerm:media/v20180330preview:Job", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJob(ctx *pulumi.Context,
	...
	var resource Job
	err := ctx.ReadResource("azurerm:media/v20180330preview:Job", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
