...
// 					},
// 				},
// 				CustomLicenseAcquisitionUrlTemplate: pulumi.String("https://contoso.com/{AssetAlternativeId}/envelope/{ContentKeyId}"),
// 				EnabledProtocols: &media.EnabledProtocolsArgs{
// 					Dash:            pulumi.Bool(true),
// 					Hls:             pulumi.Bool(true),
// 					SmoothStreaming: pulumi.Bool(true),
...
func NewStreamingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:media/v20180330preview:StreamingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStreamingPolicy(ctx *pulumi.Context,
	...
	var resource StreamingPolicy
	err := ctx.ReadResource("azurerm:media/v20180330preview:StreamingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
