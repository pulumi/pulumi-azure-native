...
//
// import (
// 	media "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewLiveEvent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:media/v20190501preview:LiveEvent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLiveEvent(ctx *pulumi.Context,
	...
	var resource LiveEvent
	err := ctx.ReadResource("azurerm:media/v20190501preview:LiveEvent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
