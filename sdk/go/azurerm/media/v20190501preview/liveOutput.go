...
func NewLiveOutput(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:media/v20190501preview:LiveOutput", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLiveOutput(ctx *pulumi.Context,
	...
	var resource LiveOutput
	err := ctx.ReadResource("azurerm:media/v20190501preview:LiveOutput", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
