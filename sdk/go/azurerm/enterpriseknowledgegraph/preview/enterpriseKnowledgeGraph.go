...
func NewEnterpriseKnowledgeGraph(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:enterpriseknowledgegraph/v20181203:EnterpriseKnowledgeGraph"),
		},
	})
	opts = append(opts, aliases)
	var resource EnterpriseKnowledgeGraph
	err := ctx.RegisterResource("azurerm:enterpriseknowledgegraph/preview:EnterpriseKnowledgeGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnterpriseKnowledgeGraph(ctx *pulumi.Context,
	...
	var resource EnterpriseKnowledgeGraph
	err := ctx.ReadResource("azurerm:enterpriseknowledgegraph/preview:EnterpriseKnowledgeGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
