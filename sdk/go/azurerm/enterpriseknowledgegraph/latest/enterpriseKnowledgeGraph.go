...
func NewEnterpriseKnowledgeGraph(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:enterpriseknowledgegraph/latest:EnterpriseKnowledgeGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnterpriseKnowledgeGraph(ctx *pulumi.Context,
	...
	var resource EnterpriseKnowledgeGraph
	err := ctx.ReadResource("azurerm:enterpriseknowledgegraph/latest:EnterpriseKnowledgeGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
