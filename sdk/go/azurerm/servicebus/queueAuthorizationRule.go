...
func NewQueueAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:servicebus:QueueAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueueAuthorizationRule(ctx *pulumi.Context,
	...
	var resource QueueAuthorizationRule
	err := ctx.ReadResource("azurerm:servicebus:QueueAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
