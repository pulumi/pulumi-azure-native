...
func NewTopicAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:servicebus/v20140901:TopicAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopicAuthorizationRule(ctx *pulumi.Context,
	...
	var resource TopicAuthorizationRule
	err := ctx.ReadResource("azurerm:servicebus/v20140901:TopicAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
