...
// 			AuthorizationRuleName: pulumi.String("sdk-Authrules5067"),
// 			NamespaceName:         pulumi.String("sdk-Namespace8408"),
// 			ResourceGroupName:     pulumi.String("Default-ServiceBus-WestUS"),
// 			Rights: pulumi.StringArray{
// 				pulumi.String("Listen"),
// 				pulumi.String("Send"),
// 			},
// 			TopicName: pulumi.String("sdk-Topics2075"),
// 		})
// 		if err != nil {
// 			return err
// 		}
...
func GetTopicAuthorizationRule(ctx *pulumi.Context,
	...
	var resource TopicAuthorizationRule
	err := ctx.ReadResource("azurerm:servicebus/v20150801:TopicAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
