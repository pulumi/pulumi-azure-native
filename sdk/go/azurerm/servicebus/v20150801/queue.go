...
// 			NamespaceName:      pulumi.String("sdk-Namespace3082"),
// 			QueueName:          pulumi.String("sdk-Queues8544"),
...
func NewQueue(ctx *pulumi.Context,
	...
	var resource Queue
	err := ctx.RegisterResource("azurerm:servicebus/v20150801:Queue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueue(ctx *pulumi.Context,
	...
	var resource Queue
	err := ctx.ReadResource("azurerm:servicebus/v20150801:Queue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
