...
func NewNamespaceVirtualNetworkRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:servicebus/v20180101preview:NamespaceVirtualNetworkRule"),
		},
	})
	opts = append(opts, aliases)
	var resource NamespaceVirtualNetworkRule
	err := ctx.RegisterResource("azurerm:servicebus/preview:NamespaceVirtualNetworkRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceVirtualNetworkRule(ctx *pulumi.Context,
	...
	var resource NamespaceVirtualNetworkRule
	err := ctx.ReadResource("azurerm:servicebus/preview:NamespaceVirtualNetworkRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
