...
func NewQueue(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:servicebus/v20150801:Queue"),
		},
		{
			Type: pulumi.String("azurerm:servicebus/v20170401:Queue"),
		},
	})
	opts = append(opts, aliases)
	var resource Queue
	err := ctx.RegisterResource("azurerm:servicebus/preview:Queue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueue(ctx *pulumi.Context,
	...
	var resource Queue
	err := ctx.ReadResource("azurerm:servicebus/preview:Queue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
