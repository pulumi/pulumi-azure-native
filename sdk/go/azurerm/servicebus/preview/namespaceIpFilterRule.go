...
func NewNamespaceIpFilterRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:servicebus/v20180101preview:NamespaceIpFilterRule"),
		},
	})
	opts = append(opts, aliases)
	var resource NamespaceIpFilterRule
	err := ctx.RegisterResource("azurerm:servicebus/preview:NamespaceIpFilterRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceIpFilterRule(ctx *pulumi.Context,
	...
	var resource NamespaceIpFilterRule
	err := ctx.ReadResource("azurerm:servicebus/preview:NamespaceIpFilterRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
