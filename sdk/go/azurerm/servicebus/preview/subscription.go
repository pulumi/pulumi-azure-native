...
func NewSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:servicebus/preview:Subscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscription(ctx *pulumi.Context,
	...
	var resource Subscription
	err := ctx.ReadResource("azurerm:servicebus/preview:Subscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
