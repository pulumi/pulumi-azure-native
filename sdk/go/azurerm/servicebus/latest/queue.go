...
func NewQueue(ctx *pulumi.Context,
	...
	var resource Queue
	err := ctx.RegisterResource("azurerm:servicebus/latest:Queue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueue(ctx *pulumi.Context,
	...
	var resource Queue
	err := ctx.ReadResource("azurerm:servicebus/latest:Queue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
