...
func NewTrustedIdProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datalakestore/preview:TrustedIdProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrustedIdProvider(ctx *pulumi.Context,
	...
	var resource TrustedIdProvider
	err := ctx.ReadResource("azurerm:datalakestore/preview:TrustedIdProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
