...
func NewCustomerSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:azurestack/latest:CustomerSubscription"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:azurestack/v20170601:CustomerSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomerSubscription(ctx *pulumi.Context,
	...
	var resource CustomerSubscription
	err := ctx.ReadResource("azurerm:azurestack/v20170601:CustomerSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
