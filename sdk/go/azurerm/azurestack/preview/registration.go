...
func NewRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:azurestack/preview:Registration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistration(ctx *pulumi.Context,
	...
	var resource Registration
	err := ctx.ReadResource("azurerm:azurestack/preview:Registration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
