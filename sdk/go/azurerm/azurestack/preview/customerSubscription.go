...
func NewCustomerSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:azurestack/preview:CustomerSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomerSubscription(ctx *pulumi.Context,
	...
	var resource CustomerSubscription
	err := ctx.ReadResource("azurerm:azurestack/preview:CustomerSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
