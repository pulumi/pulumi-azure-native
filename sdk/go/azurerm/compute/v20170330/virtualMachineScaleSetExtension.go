...
func NewVirtualMachineScaleSetExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute/v20170330:VirtualMachineScaleSetExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetExtension(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetExtension
	err := ctx.ReadResource("azurerm:compute/v20170330:VirtualMachineScaleSetExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
