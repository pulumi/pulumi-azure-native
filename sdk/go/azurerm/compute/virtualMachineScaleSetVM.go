...
func NewVirtualMachineScaleSetVM(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute:VirtualMachineScaleSetVM", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetVM(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetVM
	err := ctx.ReadResource("azurerm:compute:VirtualMachineScaleSetVM", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
