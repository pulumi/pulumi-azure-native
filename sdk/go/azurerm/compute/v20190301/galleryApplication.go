...
func NewGalleryApplication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:compute/latest:GalleryApplication"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20190701:GalleryApplication"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20191201:GalleryApplication"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20200930:GalleryApplication"),
		},
	})
	opts = append(opts, aliases)
	var resource GalleryApplication
	err := ctx.RegisterResource("azurerm:compute/v20190301:GalleryApplication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryApplication(ctx *pulumi.Context,
	...
	var resource GalleryApplication
	err := ctx.ReadResource("azurerm:compute/v20190301:GalleryApplication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
