...
// GalleryArtifactSourcePtrInput is an input type that accepts GalleryArtifactSourceArgs, GalleryArtifactSourcePtr and GalleryArtifactSourcePtrOutput values.
// You can construct a concrete instance of `GalleryArtifactSourcePtrInput` via:
//
//          GalleryArtifactSourceArgs{...}
//
//  or:
...
func (o GalleryArtifactSourceResponsePtrOutput) Elem() GalleryArtifactSourceResponseOutput {
	return o.ApplyT(func(v *GalleryArtifactSourceResponse) GalleryArtifactSourceResponse { return *v }).(GalleryArtifactSourceResponseOutput)
}
...
// ManagedArtifactPtrInput is an input type that accepts ManagedArtifactArgs, ManagedArtifactPtr and ManagedArtifactPtrOutput values.
// You can construct a concrete instance of `ManagedArtifactPtrInput` via:
//
//          ManagedArtifactArgs{...}
//
//  or:
...
func (o ManagedArtifactResponsePtrOutput) Elem() ManagedArtifactResponseOutput {
	return o.ApplyT(func(v *ManagedArtifactResponse) ManagedArtifactResponse { return *v }).(ManagedArtifactResponseOutput)
}
