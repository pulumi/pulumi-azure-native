...
func NewProximityPlacementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute/v20191201:ProximityPlacementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProximityPlacementGroup(ctx *pulumi.Context,
	...
	var resource ProximityPlacementGroup
	err := ctx.ReadResource("azurerm:compute/v20191201:ProximityPlacementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
