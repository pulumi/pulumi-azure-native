...
func NewDedicatedHost(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute/v20191201:DedicatedHost", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDedicatedHost(ctx *pulumi.Context,
	...
	var resource DedicatedHost
	err := ctx.ReadResource("azurerm:compute/v20191201:DedicatedHost", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
