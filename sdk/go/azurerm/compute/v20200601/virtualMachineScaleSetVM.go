...
func NewVirtualMachineScaleSetVM(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:compute/preview:VirtualMachineScaleSetVM"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20171201:VirtualMachineScaleSetVM"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20180401:VirtualMachineScaleSetVM"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20180601:VirtualMachineScaleSetVM"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20181001:VirtualMachineScaleSetVM"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20190301:VirtualMachineScaleSetVM"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20190701:VirtualMachineScaleSetVM"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20191201:VirtualMachineScaleSetVM"),
		},
	})
	opts = append(opts, aliases)
	var resource VirtualMachineScaleSetVM
	err := ctx.RegisterResource("azurerm:compute/v20200601:VirtualMachineScaleSetVM", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetVM(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetVM
	err := ctx.ReadResource("azurerm:compute/v20200601:VirtualMachineScaleSetVM", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
