...
func NewVirtualMachineExtension(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:compute/v20160430preview:VirtualMachineExtension"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20170330:VirtualMachineExtension"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20171201:VirtualMachineExtension"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:compute/v20200601:VirtualMachineExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineExtension(ctx *pulumi.Context,
	...
	var resource VirtualMachineExtension
	err := ctx.ReadResource("azurerm:compute/v20200601:VirtualMachineExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
