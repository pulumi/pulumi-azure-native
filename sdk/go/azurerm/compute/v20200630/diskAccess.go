...
func NewDiskAccess(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute/v20200630:DiskAccess", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiskAccess(ctx *pulumi.Context,
	...
	var resource DiskAccess
	err := ctx.ReadResource("azurerm:compute/v20200630:DiskAccess", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
