...
func NewGalleryApplication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:compute/v20190301:GalleryApplication"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:compute/latest:GalleryApplication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryApplication(ctx *pulumi.Context,
	...
	var resource GalleryApplication
	err := ctx.ReadResource("azurerm:compute/latest:GalleryApplication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
