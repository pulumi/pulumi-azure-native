...
func NewProximityPlacementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute/latest:ProximityPlacementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProximityPlacementGroup(ctx *pulumi.Context,
	...
	var resource ProximityPlacementGroup
	err := ctx.ReadResource("azurerm:compute/latest:ProximityPlacementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
