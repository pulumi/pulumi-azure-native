...
func NewDedicatedHost(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:compute/v20190701:DedicatedHost"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20191201:DedicatedHost"),
		},
		{
			Type: pulumi.String("azurerm:compute/v20200601:DedicatedHost"),
		},
	})
	opts = append(opts, aliases)
	var resource DedicatedHost
	err := ctx.RegisterResource("azurerm:compute/latest:DedicatedHost", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDedicatedHost(ctx *pulumi.Context,
	...
	var resource DedicatedHost
	err := ctx.ReadResource("azurerm:compute/latest:DedicatedHost", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
