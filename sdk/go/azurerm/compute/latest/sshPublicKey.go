...
func NewSshPublicKey(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:compute/v20200601:SshPublicKey"),
		},
	})
	opts = append(opts, aliases)
	var resource SshPublicKey
	err := ctx.RegisterResource("azurerm:compute/latest:SshPublicKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSshPublicKey(ctx *pulumi.Context,
	...
	var resource SshPublicKey
	err := ctx.ReadResource("azurerm:compute/latest:SshPublicKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
