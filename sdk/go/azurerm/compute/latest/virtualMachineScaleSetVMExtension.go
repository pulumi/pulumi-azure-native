...
func NewVirtualMachineScaleSetVMExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute/latest:VirtualMachineScaleSetVMExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetVMExtension(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetVMExtension
	err := ctx.ReadResource("azurerm:compute/latest:VirtualMachineScaleSetVMExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
