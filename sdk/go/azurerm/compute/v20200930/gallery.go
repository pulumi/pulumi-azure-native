...
func NewGallery(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute/v20200930:Gallery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGallery(ctx *pulumi.Context,
	...
	var resource Gallery
	err := ctx.ReadResource("azurerm:compute/v20200930:Gallery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
