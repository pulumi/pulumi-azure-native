...
func NewDedicatedHost(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute:DedicatedHost", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDedicatedHost(ctx *pulumi.Context,
	...
	var resource DedicatedHost
	err := ctx.ReadResource("azurerm:compute:DedicatedHost", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
