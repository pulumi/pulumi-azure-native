...
func NewDiskEncryptionSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute/preview:DiskEncryptionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiskEncryptionSet(ctx *pulumi.Context,
	...
	var resource DiskEncryptionSet
	err := ctx.ReadResource("azurerm:compute/preview:DiskEncryptionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
