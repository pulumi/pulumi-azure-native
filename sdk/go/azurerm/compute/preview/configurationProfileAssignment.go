...
func NewConfigurationProfileAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:compute/v20200630preview:ConfigurationProfileAssignment"),
		},
	})
	opts = append(opts, aliases)
	var resource ConfigurationProfileAssignment
	err := ctx.RegisterResource("azurerm:compute/preview:ConfigurationProfileAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationProfileAssignment(ctx *pulumi.Context,
	...
	var resource ConfigurationProfileAssignment
	err := ctx.ReadResource("azurerm:compute/preview:ConfigurationProfileAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
