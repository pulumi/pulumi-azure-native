...
func NewGalleryImageVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute/preview:GalleryImageVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryImageVersion(ctx *pulumi.Context,
	...
	var resource GalleryImageVersion
	err := ctx.ReadResource("azurerm:compute/preview:GalleryImageVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
