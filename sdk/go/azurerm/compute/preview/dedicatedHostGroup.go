...
func NewDedicatedHostGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute/preview:DedicatedHostGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDedicatedHostGroup(ctx *pulumi.Context,
	...
	var resource DedicatedHostGroup
	err := ctx.ReadResource("azurerm:compute/preview:DedicatedHostGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
