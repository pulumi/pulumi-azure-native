...
func NewGalleryApplicationVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute/preview:GalleryApplicationVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryApplicationVersion(ctx *pulumi.Context,
	...
	var resource GalleryApplicationVersion
	err := ctx.ReadResource("azurerm:compute/preview:GalleryApplicationVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
