...
func NewSshPublicKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute:SshPublicKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSshPublicKey(ctx *pulumi.Context,
	...
	var resource SshPublicKey
	err := ctx.ReadResource("azurerm:compute:SshPublicKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
