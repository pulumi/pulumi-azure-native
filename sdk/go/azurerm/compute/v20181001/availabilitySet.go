...
func NewAvailabilitySet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute/v20181001:AvailabilitySet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAvailabilitySet(ctx *pulumi.Context,
	...
	var resource AvailabilitySet
	err := ctx.ReadResource("azurerm:compute/v20181001:AvailabilitySet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
