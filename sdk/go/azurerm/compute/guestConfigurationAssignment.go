...
func NewGuestConfigurationAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:compute:GuestConfigurationAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestConfigurationAssignment(ctx *pulumi.Context,
	...
	var resource GuestConfigurationAssignment
	err := ctx.ReadResource("azurerm:compute:GuestConfigurationAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
