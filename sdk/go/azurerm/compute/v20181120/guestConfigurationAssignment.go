...
//
// import (
// 	compute "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20181120"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func GetGuestConfigurationAssignment(ctx *pulumi.Context,
	...
	var resource GuestConfigurationAssignment
	err := ctx.ReadResource("azurerm:compute/v20181120:GuestConfigurationAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
