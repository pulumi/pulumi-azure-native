...
func NewCloudConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:costmanagement/latest:CloudConnector"),
		},
	})
...
func GetCloudConnector(ctx *pulumi.Context,
	...
	var resource CloudConnector
	err := ctx.ReadResource("azurerm:costmanagement/v20190301preview:CloudConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
