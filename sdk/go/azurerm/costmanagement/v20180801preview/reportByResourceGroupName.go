...
func NewReportByResourceGroupName(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:costmanagement/latest:ReportByResourceGroupName"),
		},
	})
...
func GetReportByResourceGroupName(ctx *pulumi.Context,
	...
	var resource ReportByResourceGroupName
	err := ctx.ReadResource("azurerm:costmanagement/v20180801preview:ReportByResourceGroupName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
