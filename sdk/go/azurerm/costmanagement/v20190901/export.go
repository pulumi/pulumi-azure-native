...
func NewExport(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:costmanagement/v20191101:Export"),
		},
		{
	...
	var resource Export
	err := ctx.RegisterResource("azurerm:costmanagement/v20190901:Export", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExport(ctx *pulumi.Context,
	...
	var resource Export
	err := ctx.ReadResource("azurerm:costmanagement/v20190901:Export", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
