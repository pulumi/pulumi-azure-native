...
func NewExport(ctx *pulumi.Context,
	...
	var resource Export
	err := ctx.RegisterResource("azurerm:costmanagement/latest:Export", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExport(ctx *pulumi.Context,
	...
	var resource Export
	err := ctx.ReadResource("azurerm:costmanagement/latest:Export", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
