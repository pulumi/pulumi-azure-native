...
func NewReport(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:costmanagement/v20180801preview:Report"),
		},
	})
	opts = append(opts, aliases)
	var resource Report
	err := ctx.RegisterResource("azurerm:costmanagement/preview:Report", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReport(ctx *pulumi.Context,
	...
	var resource Report
	err := ctx.ReadResource("azurerm:costmanagement/preview:Report", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
