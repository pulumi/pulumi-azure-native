...
func NewCloudConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:costmanagement/v20190301preview:CloudConnector"),
		},
	})
	opts = append(opts, aliases)
	var resource CloudConnector
	err := ctx.RegisterResource("azurerm:costmanagement/preview:CloudConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudConnector(ctx *pulumi.Context,
	...
	var resource CloudConnector
	err := ctx.ReadResource("azurerm:costmanagement/preview:CloudConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
