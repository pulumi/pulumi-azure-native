...
func NewReportConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:costmanagement/preview:ReportConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReportConfig(ctx *pulumi.Context,
	...
	var resource ReportConfig
	err := ctx.ReadResource("azurerm:costmanagement/preview:ReportConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
