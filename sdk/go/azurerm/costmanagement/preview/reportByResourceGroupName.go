...
func NewReportByResourceGroupName(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:costmanagement/v20180801preview:ReportByResourceGroupName"),
		},
	})
	opts = append(opts, aliases)
	var resource ReportByResourceGroupName
	err := ctx.RegisterResource("azurerm:costmanagement/preview:ReportByResourceGroupName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReportByResourceGroupName(ctx *pulumi.Context,
	...
	var resource ReportByResourceGroupName
	err := ctx.ReadResource("azurerm:costmanagement/preview:ReportByResourceGroupName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
