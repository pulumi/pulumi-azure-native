...
func NewReportConfigByResourceGroupName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:costmanagement/preview:ReportConfigByResourceGroupName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReportConfigByResourceGroupName(ctx *pulumi.Context,
	...
	var resource ReportConfigByResourceGroupName
	err := ctx.ReadResource("azurerm:costmanagement/preview:ReportConfigByResourceGroupName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
