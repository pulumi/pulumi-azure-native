...
func NewViewByScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:costmanagement/preview:ViewByScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetViewByScope(ctx *pulumi.Context,
	...
	var resource ViewByScope
	err := ctx.ReadResource("azurerm:costmanagement/preview:ViewByScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
