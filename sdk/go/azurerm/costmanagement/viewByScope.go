...
func NewViewByScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:costmanagement:ViewByScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetViewByScope(ctx *pulumi.Context,
	...
	var resource ViewByScope
	err := ctx.ReadResource("azurerm:costmanagement:ViewByScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
