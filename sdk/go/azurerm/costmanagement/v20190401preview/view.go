...
func NewView(ctx *pulumi.Context,
	...
	var resource View
	err := ctx.RegisterResource("azurerm:costmanagement/v20190401preview:View", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetView(ctx *pulumi.Context,
	...
	var resource View
	err := ctx.ReadResource("azurerm:costmanagement/v20190401preview:View", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
