...
func NewSapMonitor(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:hanaonazure/latest:SapMonitor"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:hanaonazure/v20200207preview:SapMonitor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSapMonitor(ctx *pulumi.Context,
	...
	var resource SapMonitor
	err := ctx.ReadResource("azurerm:hanaonazure/v20200207preview:SapMonitor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
