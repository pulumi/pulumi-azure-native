...
func NewHanaInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:hanaonazure/v20171103preview:HanaInstance"),
		},
	})
	opts = append(opts, aliases)
	var resource HanaInstance
	err := ctx.RegisterResource("azurerm:hanaonazure/preview:HanaInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHanaInstance(ctx *pulumi.Context,
	...
	var resource HanaInstance
	err := ctx.ReadResource("azurerm:hanaonazure/preview:HanaInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
