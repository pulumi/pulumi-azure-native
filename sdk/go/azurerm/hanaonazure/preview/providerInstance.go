...
func NewProviderInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:hanaonazure/v20200207preview:ProviderInstance"),
		},
	})
	opts = append(opts, aliases)
	var resource ProviderInstance
	err := ctx.RegisterResource("azurerm:hanaonazure/preview:ProviderInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProviderInstance(ctx *pulumi.Context,
	...
	var resource ProviderInstance
	err := ctx.ReadResource("azurerm:hanaonazure/preview:ProviderInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
