...
func NewSapMonitor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:hanaonazure/preview:SapMonitor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSapMonitor(ctx *pulumi.Context,
	...
	var resource SapMonitor
	err := ctx.ReadResource("azurerm:hanaonazure/preview:SapMonitor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
