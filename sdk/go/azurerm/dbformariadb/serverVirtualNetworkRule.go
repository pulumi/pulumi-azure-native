...
func NewServerVirtualNetworkRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:dbformariadb:ServerVirtualNetworkRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerVirtualNetworkRule(ctx *pulumi.Context,
	...
	var resource ServerVirtualNetworkRule
	err := ctx.ReadResource("azurerm:dbformariadb:ServerVirtualNetworkRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
