...
func NewServerFirewallRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:dbformariadb:ServerFirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerFirewallRule(ctx *pulumi.Context,
	...
	var resource ServerFirewallRule
	err := ctx.ReadResource("azurerm:dbformariadb:ServerFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
