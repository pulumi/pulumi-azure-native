...
func NewDomain(ctx *pulumi.Context,
	...
	var resource Domain
	err := ctx.RegisterResource("azurerm:domainregistration/preview:Domain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomain(ctx *pulumi.Context,
	...
	var resource Domain
	err := ctx.ReadResource("azurerm:domainregistration/preview:Domain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
