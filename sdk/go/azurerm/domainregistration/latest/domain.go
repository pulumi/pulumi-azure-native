...
func NewDomain(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:domainregistration/v20150801:Domain"),
		},
		{
			Type: pulumi.String("azurerm:domainregistration/v20180201:Domain"),
		},
		{
			Type: pulumi.String("azurerm:domainregistration/v20190801:Domain"),
		},
		{
			Type: pulumi.String("azurerm:domainregistration/v20200601:Domain"),
		},
	})
	opts = append(opts, aliases)
	var resource Domain
	err := ctx.RegisterResource("azurerm:domainregistration/latest:Domain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomain(ctx *pulumi.Context,
	...
	var resource Domain
	err := ctx.ReadResource("azurerm:domainregistration/latest:Domain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
