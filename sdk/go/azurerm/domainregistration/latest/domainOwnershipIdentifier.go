...
func NewDomainOwnershipIdentifier(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:domainregistration/v20180201:DomainOwnershipIdentifier"),
		},
		{
			Type: pulumi.String("azurerm:domainregistration/v20190801:DomainOwnershipIdentifier"),
		},
		{
			Type: pulumi.String("azurerm:domainregistration/v20200601:DomainOwnershipIdentifier"),
		},
	})
	opts = append(opts, aliases)
	var resource DomainOwnershipIdentifier
	err := ctx.RegisterResource("azurerm:domainregistration/latest:DomainOwnershipIdentifier", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainOwnershipIdentifier(ctx *pulumi.Context,
	...
	var resource DomainOwnershipIdentifier
	err := ctx.ReadResource("azurerm:domainregistration/latest:DomainOwnershipIdentifier", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
