...
func NewScopeAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:managednetwork/v20190601preview:ScopeAssignment"),
		},
	})
	opts = append(opts, aliases)
	var resource ScopeAssignment
	err := ctx.RegisterResource("azurerm:managednetwork/preview:ScopeAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopeAssignment(ctx *pulumi.Context,
	...
	var resource ScopeAssignment
	err := ctx.ReadResource("azurerm:managednetwork/preview:ScopeAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
