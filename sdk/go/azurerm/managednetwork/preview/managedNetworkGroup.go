...
func NewManagedNetworkGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:managednetwork/v20190601preview:ManagedNetworkGroup"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagedNetworkGroup
	err := ctx.RegisterResource("azurerm:managednetwork/preview:ManagedNetworkGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedNetworkGroup(ctx *pulumi.Context,
	...
	var resource ManagedNetworkGroup
	err := ctx.ReadResource("azurerm:managednetwork/preview:ManagedNetworkGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
