...
func NewManagedNetworkPeeringPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:managednetwork/v20190601preview:ManagedNetworkPeeringPolicy"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagedNetworkPeeringPolicy
	err := ctx.RegisterResource("azurerm:managednetwork/preview:ManagedNetworkPeeringPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedNetworkPeeringPolicy(ctx *pulumi.Context,
	...
	var resource ManagedNetworkPeeringPolicy
	err := ctx.ReadResource("azurerm:managednetwork/preview:ManagedNetworkPeeringPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
