...
func NewManagedNetwork(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:managednetwork/v20190601preview:ManagedNetwork"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagedNetwork
	err := ctx.RegisterResource("azurerm:managednetwork/preview:ManagedNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedNetwork(ctx *pulumi.Context,
	...
	var resource ManagedNetwork
	err := ctx.ReadResource("azurerm:managednetwork/preview:ManagedNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
