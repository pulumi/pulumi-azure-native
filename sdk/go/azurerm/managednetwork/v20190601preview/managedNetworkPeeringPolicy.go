...
func NewManagedNetworkPeeringPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:managednetwork/preview:ManagedNetworkPeeringPolicy"),
		},
	})
...
func GetManagedNetworkPeeringPolicy(ctx *pulumi.Context,
	...
	var resource ManagedNetworkPeeringPolicy
	err := ctx.ReadResource("azurerm:managednetwork/v20190601preview:ManagedNetworkPeeringPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
