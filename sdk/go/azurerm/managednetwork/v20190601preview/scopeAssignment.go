...
func NewScopeAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:managednetwork/latest:ScopeAssignment"),
		},
	})
...
func GetScopeAssignment(ctx *pulumi.Context,
	...
	var resource ScopeAssignment
	err := ctx.ReadResource("azurerm:managednetwork/v20190601preview:ScopeAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
