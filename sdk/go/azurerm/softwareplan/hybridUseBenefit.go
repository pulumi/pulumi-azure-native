...
func NewHybridUseBenefit(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:softwareplan:HybridUseBenefit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridUseBenefit(ctx *pulumi.Context,
	...
	var resource HybridUseBenefit
	err := ctx.ReadResource("azurerm:softwareplan:HybridUseBenefit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
