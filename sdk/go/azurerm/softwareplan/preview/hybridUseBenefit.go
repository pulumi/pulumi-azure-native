...
func NewHybridUseBenefit(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:softwareplan/v20190601preview:HybridUseBenefit"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:softwareplan/preview:HybridUseBenefit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridUseBenefit(ctx *pulumi.Context,
	...
	var resource HybridUseBenefit
	err := ctx.ReadResource("azurerm:softwareplan/preview:HybridUseBenefit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
