...
func NewConfigurationProfilePreference(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:automanage/v20200630preview:ConfigurationProfilePreference"),
		},
	})
	opts = append(opts, aliases)
	var resource ConfigurationProfilePreference
	err := ctx.RegisterResource("azurerm:automanage/preview:ConfigurationProfilePreference", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationProfilePreference(ctx *pulumi.Context,
	...
	var resource ConfigurationProfilePreference
	err := ctx.ReadResource("azurerm:automanage/preview:ConfigurationProfilePreference", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
