...
func NewSourceControlConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:kubernetesconfiguration/v20191101preview:SourceControlConfiguration"),
		},
	})
	opts = append(opts, aliases)
	var resource SourceControlConfiguration
	err := ctx.RegisterResource("azurerm:kubernetesconfiguration/preview:SourceControlConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSourceControlConfiguration(ctx *pulumi.Context,
	...
	var resource SourceControlConfiguration
	err := ctx.ReadResource("azurerm:kubernetesconfiguration/preview:SourceControlConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
