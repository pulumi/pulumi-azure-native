...
//
// import (
// 	datamigration "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/datamigration/v20171115preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:datamigration/v20180419:Service"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:datamigration/v20171115preview:Service", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetService(ctx *pulumi.Context,
	...
	var resource Service
	err := ctx.ReadResource("azurerm:datamigration/v20171115preview:Service", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
