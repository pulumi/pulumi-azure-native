...
func NewServiceTask(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:datamigration/v20180715preview:ServiceTask"),
		},
	})
	opts = append(opts, aliases)
	var resource ServiceTask
	err := ctx.RegisterResource("azurerm:datamigration/preview:ServiceTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceTask(ctx *pulumi.Context,
	...
	var resource ServiceTask
	err := ctx.ReadResource("azurerm:datamigration/preview:ServiceTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
