...
func NewFile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:datamigration/v20180715preview:File"),
		},
	})
	opts = append(opts, aliases)
	var resource File
	err := ctx.RegisterResource("azurerm:datamigration/preview:File", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFile(ctx *pulumi.Context,
	...
	var resource File
	err := ctx.ReadResource("azurerm:datamigration/preview:File", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
