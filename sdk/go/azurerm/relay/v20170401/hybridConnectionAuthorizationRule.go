...
func NewHybridConnectionAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:relay/v20170401:HybridConnectionAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridConnectionAuthorizationRule(ctx *pulumi.Context,
	...
	var resource HybridConnectionAuthorizationRule
	err := ctx.ReadResource("azurerm:relay/v20170401:HybridConnectionAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
