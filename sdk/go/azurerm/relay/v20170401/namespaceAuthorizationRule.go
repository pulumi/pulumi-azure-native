...
func NewNamespaceAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:relay/v20170401:NamespaceAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceAuthorizationRule(ctx *pulumi.Context,
	...
	var resource NamespaceAuthorizationRule
	err := ctx.ReadResource("azurerm:relay/v20170401:NamespaceAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
