...
func NewWCFRelayAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:relay/preview:WCFRelayAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWCFRelayAuthorizationRule(ctx *pulumi.Context,
	...
	var resource WCFRelayAuthorizationRule
	err := ctx.ReadResource("azurerm:relay/preview:WCFRelayAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
