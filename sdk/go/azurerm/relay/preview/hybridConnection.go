...
func NewHybridConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:relay/preview:HybridConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridConnection(ctx *pulumi.Context,
	...
	var resource HybridConnection
	err := ctx.ReadResource("azurerm:relay/preview:HybridConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
