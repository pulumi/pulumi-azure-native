...
func NewNamespace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:relay/preview:Namespace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespace(ctx *pulumi.Context,
	...
	var resource Namespace
	err := ctx.ReadResource("azurerm:relay/preview:Namespace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
