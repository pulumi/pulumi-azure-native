...
func NewWebService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:machinelearning/v20160501preview:WebService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebService(ctx *pulumi.Context,
	...
	var resource WebService
	err := ctx.ReadResource("azurerm:machinelearning/v20160501preview:WebService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
