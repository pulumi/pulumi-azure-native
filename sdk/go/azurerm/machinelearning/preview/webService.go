...
func NewWebService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:machinelearning/v20170101:WebService"),
		},
	})
	opts = append(opts, aliases)
	var resource WebService
	err := ctx.RegisterResource("azurerm:machinelearning/preview:WebService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebService(ctx *pulumi.Context,
	...
	var resource WebService
	err := ctx.ReadResource("azurerm:machinelearning/preview:WebService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
