...
func NewCommitmentPlan(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:machinelearning/v20160501preview:CommitmentPlan"),
		},
	})
	opts = append(opts, aliases)
	var resource CommitmentPlan
	err := ctx.RegisterResource("azurerm:machinelearning/preview:CommitmentPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCommitmentPlan(ctx *pulumi.Context,
	...
	var resource CommitmentPlan
	err := ctx.ReadResource("azurerm:machinelearning/preview:CommitmentPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
