...
func NewVNetPeering(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:databricks/preview:vNetPeering"),
		},
		{
			Type: pulumi.String("azurerm:databricks/v20180401:vNetPeering"),
		},
	})
	opts = append(opts, aliases)
	var resource VNetPeering
	err := ctx.RegisterResource("azurerm:databricks/latest:vNetPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVNetPeering(ctx *pulumi.Context,
	...
	var resource VNetPeering
	err := ctx.ReadResource("azurerm:databricks/latest:vNetPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
