...
type VirtualNetworkPeeringPropertiesFormatArgs struct {
	...
	// The reference to the databricks virtual network address space.
	DatabricksAddressSpace AddressSpacePtrInput `pulumi:"databricksAddressSpace"`
	//  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
	DatabricksVirtualNetwork VirtualNetworkPeeringPropertiesFormatPropertiesPtrInput `pulumi:"databricksVirtualNetwork"`
	// The reference to the remote virtual network address space.
	RemoteAddressSpace AddressSpacePtrInput `pulumi:"remoteAddressSpace"`
	//  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
	RemoteVirtualNetwork VirtualNetworkPeeringPropertiesFormatPropertiesInput `pulumi:"remoteVirtualNetwork"`
	// If remote gateways can be used on this virtual network. If the flag is set to true, and allowGatewayTransit on remote peering is also true, virtual network will use gateways of remote virtual network for transit. Only one peering can have this flag set to true. This flag cannot be set if virtual network already has a gateway.
...
// The reference to the databricks virtual network address space.
func (o VirtualNetworkPeeringPropertiesFormatOutput) DatabricksAddressSpace() AddressSpacePtrOutput {
	return o.ApplyT(func(v VirtualNetworkPeeringPropertiesFormat) *AddressSpace { return v.DatabricksAddressSpace }).(AddressSpacePtrOutput)
}

//  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
func (o VirtualNetworkPeeringPropertiesFormatOutput) DatabricksVirtualNetwork() VirtualNetworkPeeringPropertiesFormatPropertiesPtrOutput {
	return o.ApplyT(func(v VirtualNetworkPeeringPropertiesFormat) *VirtualNetworkPeeringPropertiesFormatProperties {
...
//  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
func (o VirtualNetworkPeeringPropertiesFormatOutput) RemoteVirtualNetwork() VirtualNetworkPeeringPropertiesFormatPropertiesOutput {
	return o.ApplyT(func(v VirtualNetworkPeeringPropertiesFormat) VirtualNetworkPeeringPropertiesFormatProperties {
...
// The reference to the databricks virtual network address space.
func (o VirtualNetworkPeeringPropertiesFormatPtrOutput) DatabricksAddressSpace() AddressSpacePtrOutput {
...
//  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
func (o VirtualNetworkPeeringPropertiesFormatPtrOutput) DatabricksVirtualNetwork() VirtualNetworkPeeringPropertiesFormatPropertiesPtrOutput {
	return o.ApplyT(func(v *VirtualNetworkPeeringPropertiesFormat) *VirtualNetworkPeeringPropertiesFormatProperties {
		if v == nil {
			return nil
		}
...
//  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
func (o VirtualNetworkPeeringPropertiesFormatPtrOutput) RemoteVirtualNetwork() VirtualNetworkPeeringPropertiesFormatPropertiesPtrOutput {
	return o.ApplyT(func(v *VirtualNetworkPeeringPropertiesFormat) *VirtualNetworkPeeringPropertiesFormatProperties {
		if v == nil {
			return nil
		}
...
type WorkspacePropertiesArgs struct {
	// The workspace provider authorizations.
	Authorizations WorkspaceProviderAuthorizationArrayInput `pulumi:"authorizations"`
	// Indicates the Object ID, PUID and Application ID of entity that created the workspace.
	CreatedBy CreatedByPtrInput `pulumi:"createdBy"`
	// Specifies the date and time when the workspace is created.
	...
	// The workspace's custom parameters.
	Parameters WorkspaceCustomParametersPtrInput `pulumi:"parameters"`
	// The details of Managed Identity of Storage Account
	StorageAccountIdentity ManagedIdentityConfigurationPtrInput `pulumi:"storageAccountIdentity"`
	// The blob URI where the UI definition file is located.
	UiDefinitionUri pulumi.StringPtrInput `pulumi:"uiDefinitionUri"`
	// Indicates the Object ID, PUID and Application ID of entity that last updated the workspace.
	UpdatedBy CreatedByPtrInput `pulumi:"updatedBy"`
}
...
// The workspace provider authorizations.
func (o WorkspacePropertiesOutput) Authorizations() WorkspaceProviderAuthorizationArrayOutput {
	return o.ApplyT(func(v WorkspaceProperties) []WorkspaceProviderAuthorization { return v.Authorizations }).(WorkspaceProviderAuthorizationArrayOutput)
}

// Indicates the Object ID, PUID and Application ID of entity that created the workspace.
func (o WorkspacePropertiesOutput) CreatedBy() CreatedByPtrOutput {
	return o.ApplyT(func(v WorkspaceProperties) *CreatedBy { return v.CreatedBy }).(CreatedByPtrOutput)
}

// Specifies the date and time when the workspace is created.
func (o WorkspacePropertiesOutput) CreatedDateTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v WorkspaceProperties) *string { return v.CreatedDateTime }).(pulumi.StringPtrOutput)
}

// The managed resource group Id.
func (o WorkspacePropertiesOutput) ManagedResourceGroupId() pulumi.StringOutput {
	return o.ApplyT(func(v WorkspaceProperties) string { return v.ManagedResourceGroupId }).(pulumi.StringOutput)
}

// The workspace's custom parameters.
func (o WorkspacePropertiesOutput) Parameters() WorkspaceCustomParametersPtrOutput {
	return o.ApplyT(func(v WorkspaceProperties) *WorkspaceCustomParameters { return v.Parameters }).(WorkspaceCustomParametersPtrOutput)
}

// The details of Managed Identity of Storage Account
func (o WorkspacePropertiesOutput) StorageAccountIdentity() ManagedIdentityConfigurationPtrOutput {
	return o.ApplyT(func(v WorkspaceProperties) *ManagedIdentityConfiguration { return v.StorageAccountIdentity }).(ManagedIdentityConfigurationPtrOutput)
}

// The blob URI where the UI definition file is located.
func (o WorkspacePropertiesOutput) UiDefinitionUri() pulumi.StringPtrOutput {
	return o.ApplyT(func(v WorkspaceProperties) *string { return v.UiDefinitionUri }).(pulumi.StringPtrOutput)
}

// Indicates the Object ID, PUID and Application ID of entity that last updated the workspace.
func (o WorkspacePropertiesOutput) UpdatedBy() CreatedByPtrOutput {
	return o.ApplyT(func(v WorkspaceProperties) *CreatedBy { return v.UpdatedBy }).(CreatedByPtrOutput)
}
...
// The workspace provider authorizations.
func (o WorkspacePropertiesPtrOutput) Authorizations() WorkspaceProviderAuthorizationArrayOutput {
	return o.ApplyT(func(v *WorkspaceProperties) []WorkspaceProviderAuthorization {
		if v == nil {
			return nil
		}
		return v.Authorizations
	}).(WorkspaceProviderAuthorizationArrayOutput)
}

// Indicates the Object ID, PUID and Application ID of entity that created the workspace.
func (o WorkspacePropertiesPtrOutput) CreatedBy() CreatedByPtrOutput {
	return o.ApplyT(func(v *WorkspaceProperties) *CreatedBy {
		if v == nil {
			return nil
		}
		return v.CreatedBy
...
// Specifies the date and time when the workspace is created.
func (o WorkspacePropertiesPtrOutput) CreatedDateTime() pulumi.StringPtrOutput {
...
// The managed resource group Id.
func (o WorkspacePropertiesPtrOutput) ManagedResourceGroupId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WorkspaceProperties) *string {
		if v == nil {
			return nil
		}
...
// The workspace's custom parameters.
func (o WorkspacePropertiesPtrOutput) Parameters() WorkspaceCustomParametersPtrOutput {
	return o.ApplyT(func(v *WorkspaceProperties) *WorkspaceCustomParameters {
		if v == nil {
			return nil
		}
		return v.Parameters
...
// The details of Managed Identity of Storage Account
func (o WorkspacePropertiesPtrOutput) StorageAccountIdentity() ManagedIdentityConfigurationPtrOutput {
	return o.ApplyT(func(v *WorkspaceProperties) *ManagedIdentityConfiguration {
		if v == nil {
			return nil
		}
...
// The blob URI where the UI definition file is located.
func (o WorkspacePropertiesPtrOutput) UiDefinitionUri() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WorkspaceProperties) *string {
		if v == nil {
			return nil
		}
...
// Indicates the Object ID, PUID and Application ID of entity that last updated the workspace.
func (o WorkspacePropertiesPtrOutput) UpdatedBy() CreatedByPtrOutput {
	return o.ApplyT(func(v *WorkspaceProperties) *CreatedBy {
		if v == nil {
			return nil
		}
