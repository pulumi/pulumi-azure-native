...
func NewCreator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:maps/v20200201preview:Creator"),
		},
	})
	opts = append(opts, aliases)
	var resource Creator
	err := ctx.RegisterResource("azurerm:maps/preview:Creator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCreator(ctx *pulumi.Context,
	...
	var resource Creator
	err := ctx.ReadResource("azurerm:maps/preview:Creator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
