...
func NewPrivateAtlase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:maps/v20200201preview:PrivateAtlase"),
		},
	})
	opts = append(opts, aliases)
	var resource PrivateAtlase
	err := ctx.RegisterResource("azurerm:maps/preview:PrivateAtlase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateAtlase(ctx *pulumi.Context,
	...
	var resource PrivateAtlase
	err := ctx.ReadResource("azurerm:maps/preview:PrivateAtlase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
