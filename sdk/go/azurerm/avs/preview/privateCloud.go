...
func NewPrivateCloud(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:avs/preview:PrivateCloud", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateCloud(ctx *pulumi.Context,
	...
	var resource PrivateCloud
	err := ctx.ReadResource("azurerm:avs/preview:PrivateCloud", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
