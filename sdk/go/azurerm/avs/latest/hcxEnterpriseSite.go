...
func NewHcxEnterpriseSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:avs/latest:HcxEnterpriseSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHcxEnterpriseSite(ctx *pulumi.Context,
	...
	var resource HcxEnterpriseSite
	err := ctx.ReadResource("azurerm:avs/latest:HcxEnterpriseSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
