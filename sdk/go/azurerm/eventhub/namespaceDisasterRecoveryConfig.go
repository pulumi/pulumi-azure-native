...
func NewNamespaceDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:eventhub:NamespaceDisasterRecoveryConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	var resource NamespaceDisasterRecoveryConfig
	err := ctx.ReadResource("azurerm:eventhub:NamespaceDisasterRecoveryConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
