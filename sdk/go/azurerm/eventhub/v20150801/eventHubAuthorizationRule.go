...
// 			AuthorizationRuleName: pulumi.String("sdk-Authrules9261"),
// 			EventHubName:          pulumi.String("sdk-EventHub8887"),
// 			NamespaceName:         pulumi.String("sdk-Namespace2290"),
...
func NewEventHubAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:eventhub/v20150801:EventHubAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHubAuthorizationRule(ctx *pulumi.Context,
	...
	var resource EventHubAuthorizationRule
	err := ctx.ReadResource("azurerm:eventhub/v20150801:EventHubAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
