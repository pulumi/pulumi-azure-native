...
func NewConsumerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:eventhub/preview:ConsumerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsumerGroup(ctx *pulumi.Context,
	...
	var resource ConsumerGroup
	err := ctx.ReadResource("azurerm:eventhub/preview:ConsumerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
