...
func NewNamespaceIpFilterRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:eventhub/latest:NamespaceIpFilterRule"),
		},
	})
...
func GetNamespaceIpFilterRule(ctx *pulumi.Context,
	...
	var resource NamespaceIpFilterRule
	err := ctx.ReadResource("azurerm:eventhub/v20180101preview:NamespaceIpFilterRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
