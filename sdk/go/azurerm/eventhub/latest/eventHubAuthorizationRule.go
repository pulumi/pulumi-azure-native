...
func NewEventHubAuthorizationRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:eventhub/v20170401:EventHubAuthorizationRule"),
		},
	})
	opts = append(opts, aliases)
	var resource EventHubAuthorizationRule
	err := ctx.RegisterResource("azurerm:eventhub/latest:EventHubAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHubAuthorizationRule(ctx *pulumi.Context,
	...
	var resource EventHubAuthorizationRule
	err := ctx.ReadResource("azurerm:eventhub/latest:EventHubAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
