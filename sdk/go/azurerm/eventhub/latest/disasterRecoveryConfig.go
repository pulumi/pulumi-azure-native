...
func NewDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:eventhub/latest:DisasterRecoveryConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	var resource DisasterRecoveryConfig
	err := ctx.ReadResource("azurerm:eventhub/latest:DisasterRecoveryConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
