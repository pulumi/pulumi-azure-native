...
func NewRegisteredServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storagesync/v20190201:RegisteredServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegisteredServer(ctx *pulumi.Context,
	...
	var resource RegisteredServer
	err := ctx.ReadResource("azurerm:storagesync/v20190201:RegisteredServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
