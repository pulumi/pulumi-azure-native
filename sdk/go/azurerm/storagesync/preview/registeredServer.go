...
func NewRegisteredServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storagesync/preview:RegisteredServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegisteredServer(ctx *pulumi.Context,
	...
	var resource RegisteredServer
	err := ctx.ReadResource("azurerm:storagesync/preview:RegisteredServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
