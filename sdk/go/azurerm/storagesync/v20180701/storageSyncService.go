...
func NewStorageSyncService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storagesync/v20180701:StorageSyncService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageSyncService(ctx *pulumi.Context,
	...
	var resource StorageSyncService
	err := ctx.ReadResource("azurerm:storagesync/v20180701:StorageSyncService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
