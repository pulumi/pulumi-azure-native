...
func NewCloudEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storagesync:CloudEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudEndpoint(ctx *pulumi.Context,
	...
	var resource CloudEndpoint
	err := ctx.ReadResource("azurerm:storagesync:CloudEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
