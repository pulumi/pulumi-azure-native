...
func NewPipelineRun(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:containerregistry/v20191201preview:PipelineRun"),
		},
	})
	opts = append(opts, aliases)
	var resource PipelineRun
	err := ctx.RegisterResource("azurerm:containerregistry/preview:PipelineRun", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPipelineRun(ctx *pulumi.Context,
	...
	var resource PipelineRun
	err := ctx.ReadResource("azurerm:containerregistry/preview:PipelineRun", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
