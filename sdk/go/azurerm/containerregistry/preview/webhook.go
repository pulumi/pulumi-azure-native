...
func NewWebhook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:containerregistry/preview:Webhook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebhook(ctx *pulumi.Context,
	...
	var resource Webhook
	err := ctx.ReadResource("azurerm:containerregistry/preview:Webhook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
