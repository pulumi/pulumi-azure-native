...
func NewBuildStep(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:containerregistry/v20180201preview:BuildStep"),
		},
	})
	opts = append(opts, aliases)
	var resource BuildStep
	err := ctx.RegisterResource("azurerm:containerregistry/preview:BuildStep", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildStep(ctx *pulumi.Context,
	...
	var resource BuildStep
	err := ctx.ReadResource("azurerm:containerregistry/preview:BuildStep", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
