...
func NewBuildTask(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:containerregistry/v20180201preview:BuildTask"),
		},
	})
	opts = append(opts, aliases)
	var resource BuildTask
	err := ctx.RegisterResource("azurerm:containerregistry/preview:BuildTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildTask(ctx *pulumi.Context,
	...
	var resource BuildTask
	err := ctx.ReadResource("azurerm:containerregistry/preview:BuildTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
