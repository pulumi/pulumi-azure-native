...
func NewExportPipeline(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:containerregistry/v20191201preview:ExportPipeline"),
		},
	})
	opts = append(opts, aliases)
	var resource ExportPipeline
	err := ctx.RegisterResource("azurerm:containerregistry/preview:ExportPipeline", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExportPipeline(ctx *pulumi.Context,
	...
	var resource ExportPipeline
	err := ctx.ReadResource("azurerm:containerregistry/preview:ExportPipeline", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
