...
func NewScopeMap(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:containerregistry/v20190501preview:ScopeMap"),
		},
	})
	opts = append(opts, aliases)
	var resource ScopeMap
	err := ctx.RegisterResource("azurerm:containerregistry/preview:ScopeMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopeMap(ctx *pulumi.Context,
	...
	var resource ScopeMap
	err := ctx.ReadResource("azurerm:containerregistry/preview:ScopeMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
