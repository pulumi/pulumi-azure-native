...
func NewTask(ctx *pulumi.Context,
	...
	var resource Task
	err := ctx.RegisterResource("azurerm:containerregistry/preview:Task", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTask(ctx *pulumi.Context,
	...
	var resource Task
	err := ctx.ReadResource("azurerm:containerregistry/preview:Task", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
