...
func NewImportPipeline(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:containerregistry/v20191201preview:ImportPipeline"),
		},
	})
	opts = append(opts, aliases)
	var resource ImportPipeline
	err := ctx.RegisterResource("azurerm:containerregistry/preview:ImportPipeline", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImportPipeline(ctx *pulumi.Context,
	...
	var resource ImportPipeline
	err := ctx.ReadResource("azurerm:containerregistry/preview:ImportPipeline", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
