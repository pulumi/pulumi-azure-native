...
func NewTaskRun(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:containerregistry/preview:TaskRun"),
		},
	})
	opts = append(opts, aliases)
	var resource TaskRun
	err := ctx.RegisterResource("azurerm:containerregistry/v20190601preview:TaskRun", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTaskRun(ctx *pulumi.Context,
	...
	var resource TaskRun
	err := ctx.ReadResource("azurerm:containerregistry/v20190601preview:TaskRun", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
