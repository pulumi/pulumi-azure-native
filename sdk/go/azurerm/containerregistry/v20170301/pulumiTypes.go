...
// RegistryPropertiesCreateParametersInput is an input type that accepts RegistryPropertiesCreateParametersArgs and RegistryPropertiesCreateParametersOutput values.
// You can construct a concrete instance of `RegistryPropertiesCreateParametersInput` via:
//
//          RegistryPropertiesCreateParametersArgs{...}
type RegistryPropertiesCreateParametersInput interface {
	pulumi.Input

	ToRegistryPropertiesCreateParametersOutput() RegistryPropertiesCreateParametersOutput
	ToRegistryPropertiesCreateParametersOutputWithContext(context.Context) RegistryPropertiesCreateParametersOutput
}

// The parameters for creating the properties of a container registry.
type RegistryPropertiesCreateParametersArgs struct {
	// The value that indicates whether the admin user is enabled.
	AdminUserEnabled pulumi.BoolPtrInput `pulumi:"adminUserEnabled"`
	// The parameters of a storage account for the container registry. If specified, the storage account must be in the same physical location as the container registry.
	StorageAccount StorageAccountParametersInput `pulumi:"storageAccount"`
}

func (RegistryPropertiesCreateParametersArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*RegistryPropertiesCreateParameters)(nil)).Elem()
}

func (i RegistryPropertiesCreateParametersArgs) ToRegistryPropertiesCreateParametersOutput() RegistryPropertiesCreateParametersOutput {
	return i.ToRegistryPropertiesCreateParametersOutputWithContext(context.Background())
}

func (i RegistryPropertiesCreateParametersArgs) ToRegistryPropertiesCreateParametersOutputWithContext(ctx context.Context) RegistryPropertiesCreateParametersOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RegistryPropertiesCreateParametersOutput)
}

func (i RegistryPropertiesCreateParametersArgs) ToRegistryPropertiesCreateParametersPtrOutput() RegistryPropertiesCreateParametersPtrOutput {
	return i.ToRegistryPropertiesCreateParametersPtrOutputWithContext(context.Background())
}

func (i RegistryPropertiesCreateParametersArgs) ToRegistryPropertiesCreateParametersPtrOutputWithContext(ctx context.Context) RegistryPropertiesCreateParametersPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RegistryPropertiesCreateParametersOutput).ToRegistryPropertiesCreateParametersPtrOutputWithContext(ctx)
}

// RegistryPropertiesCreateParametersPtrInput is an input type that accepts RegistryPropertiesCreateParametersArgs, RegistryPropertiesCreateParametersPtr and RegistryPropertiesCreateParametersPtrOutput values.
// You can construct a concrete instance of `RegistryPropertiesCreateParametersPtrInput` via:
//
//          RegistryPropertiesCreateParametersArgs{...}
//
//  or:
//
//          nil
type RegistryPropertiesCreateParametersPtrInput interface {
	pulumi.Input

	ToRegistryPropertiesCreateParametersPtrOutput() RegistryPropertiesCreateParametersPtrOutput
	ToRegistryPropertiesCreateParametersPtrOutputWithContext(context.Context) RegistryPropertiesCreateParametersPtrOutput
}

type registryPropertiesCreateParametersPtrType RegistryPropertiesCreateParametersArgs

func RegistryPropertiesCreateParametersPtr(v *RegistryPropertiesCreateParametersArgs) RegistryPropertiesCreateParametersPtrInput {
	return (*registryPropertiesCreateParametersPtrType)(v)
}

func (*registryPropertiesCreateParametersPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**RegistryPropertiesCreateParameters)(nil)).Elem()
}

func (i *registryPropertiesCreateParametersPtrType) ToRegistryPropertiesCreateParametersPtrOutput() RegistryPropertiesCreateParametersPtrOutput {
	return i.ToRegistryPropertiesCreateParametersPtrOutputWithContext(context.Background())
}

func (i *registryPropertiesCreateParametersPtrType) ToRegistryPropertiesCreateParametersPtrOutputWithContext(ctx context.Context) RegistryPropertiesCreateParametersPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RegistryPropertiesCreateParametersPtrOutput)
}

// The parameters for creating the properties of a container registry.
type RegistryPropertiesCreateParametersOutput struct{ *pulumi.OutputState }

func (RegistryPropertiesCreateParametersOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*RegistryPropertiesCreateParameters)(nil)).Elem()
}

func (o RegistryPropertiesCreateParametersOutput) ToRegistryPropertiesCreateParametersOutput() RegistryPropertiesCreateParametersOutput {
	return o
}

func (o RegistryPropertiesCreateParametersOutput) ToRegistryPropertiesCreateParametersOutputWithContext(ctx context.Context) RegistryPropertiesCreateParametersOutput {
	return o
}

func (o RegistryPropertiesCreateParametersOutput) ToRegistryPropertiesCreateParametersPtrOutput() RegistryPropertiesCreateParametersPtrOutput {
	return o.ToRegistryPropertiesCreateParametersPtrOutputWithContext(context.Background())
}

func (o RegistryPropertiesCreateParametersOutput) ToRegistryPropertiesCreateParametersPtrOutputWithContext(ctx context.Context) RegistryPropertiesCreateParametersPtrOutput {
	return o.ApplyT(func(v RegistryPropertiesCreateParameters) *RegistryPropertiesCreateParameters {
		return &v
	}).(RegistryPropertiesCreateParametersPtrOutput)
}

// The value that indicates whether the admin user is enabled.
func (o RegistryPropertiesCreateParametersOutput) AdminUserEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v RegistryPropertiesCreateParameters) *bool { return v.AdminUserEnabled }).(pulumi.BoolPtrOutput)
}

// The parameters of a storage account for the container registry. If specified, the storage account must be in the same physical location as the container registry.
func (o RegistryPropertiesCreateParametersOutput) StorageAccount() StorageAccountParametersOutput {
	return o.ApplyT(func(v RegistryPropertiesCreateParameters) StorageAccountParameters { return v.StorageAccount }).(StorageAccountParametersOutput)
}

type RegistryPropertiesCreateParametersPtrOutput struct{ *pulumi.OutputState }

func (RegistryPropertiesCreateParametersPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**RegistryPropertiesCreateParameters)(nil)).Elem()
}

func (o RegistryPropertiesCreateParametersPtrOutput) ToRegistryPropertiesCreateParametersPtrOutput() RegistryPropertiesCreateParametersPtrOutput {
	return o
}

func (o RegistryPropertiesCreateParametersPtrOutput) ToRegistryPropertiesCreateParametersPtrOutputWithContext(ctx context.Context) RegistryPropertiesCreateParametersPtrOutput {
	return o
}

func (o RegistryPropertiesCreateParametersPtrOutput) Elem() RegistryPropertiesCreateParametersOutput {
	return o.ApplyT(func(v *RegistryPropertiesCreateParameters) RegistryPropertiesCreateParameters { return *v }).(RegistryPropertiesCreateParametersOutput)
}

// The value that indicates whether the admin user is enabled.
func (o RegistryPropertiesCreateParametersPtrOutput) AdminUserEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RegistryPropertiesCreateParameters) *bool {
		if v == nil {
			return nil
		}
...
// The parameters of a storage account for the container registry. If specified, the storage account must be in the same physical location as the container registry.
func (o RegistryPropertiesCreateParametersPtrOutput) StorageAccount() StorageAccountParametersPtrOutput {
	return o.ApplyT(func(v *RegistryPropertiesCreateParameters) *StorageAccountParameters {
		if v == nil {
			return nil
		}
...
func init() {
	...
	pulumi.RegisterOutputType(RegistryPropertiesCreateParametersOutput{})
	pulumi.RegisterOutputType(RegistryPropertiesCreateParametersPtrOutput{})
