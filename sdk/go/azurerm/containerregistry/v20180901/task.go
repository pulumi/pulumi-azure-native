...
//
// import (
// 	containerregistry "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/containerregistry/v20180901"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
// 				ContextPath: pulumi.String("dockerfiles"),
// 			},
...
func NewTask(ctx *pulumi.Context,
	...
	var resource Task
	err := ctx.RegisterResource("azurerm:containerregistry/v20180901:Task", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTask(ctx *pulumi.Context,
	...
	var resource Task
	err := ctx.ReadResource("azurerm:containerregistry/v20180901:Task", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
