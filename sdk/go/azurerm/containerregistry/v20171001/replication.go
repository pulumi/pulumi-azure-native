...
//
// import (
// 	containerregistry "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/containerregistry/v20171001"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewReplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:containerregistry/v20171001:Replication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplication(ctx *pulumi.Context,
	...
	var resource Replication
	err := ctx.ReadResource("azurerm:containerregistry/v20171001:Replication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
