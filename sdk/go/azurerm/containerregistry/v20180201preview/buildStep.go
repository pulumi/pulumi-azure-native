...
func NewBuildStep(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:containerregistry/preview:BuildStep"),
		},
	})
...
func GetBuildStep(ctx *pulumi.Context,
	...
	var resource BuildStep
	err := ctx.ReadResource("azurerm:containerregistry/v20180201preview:BuildStep", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
