...
func NewBuildTask(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:containerregistry/preview:BuildTask"),
		},
	})
	opts = append(opts, aliases)
	var resource BuildTask
	err := ctx.RegisterResource("azurerm:containerregistry/v20180201preview:BuildTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildTask(ctx *pulumi.Context,
	...
	var resource BuildTask
	err := ctx.ReadResource("azurerm:containerregistry/v20180201preview:BuildTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
