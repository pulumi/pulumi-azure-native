...
func NewWebhook(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:containerregistry/v20190501:Webhook"),
		},
		{
			Type: pulumi.String("azurerm:containerregistry/v20191201preview:Webhook"),
		},
	})
	opts = append(opts, aliases)
	var resource Webhook
	err := ctx.RegisterResource("azurerm:containerregistry/latest:Webhook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebhook(ctx *pulumi.Context,
	...
	var resource Webhook
	err := ctx.ReadResource("azurerm:containerregistry/latest:Webhook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
