...
func NewReplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:containerregistry/latest:Replication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplication(ctx *pulumi.Context,
	...
	var resource Replication
	err := ctx.ReadResource("azurerm:containerregistry/latest:Replication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
