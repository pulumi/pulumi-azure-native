...
func NewRegistry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:containerregistry/latest:Registry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistry(ctx *pulumi.Context,
	...
	var resource Registry
	err := ctx.ReadResource("azurerm:containerregistry/latest:Registry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
