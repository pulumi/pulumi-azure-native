...
func NewImportPipeline(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:containerregistry/latest:ImportPipeline"),
		},
	})
...
func GetImportPipeline(ctx *pulumi.Context,
	...
	var resource ImportPipeline
	err := ctx.ReadResource("azurerm:containerregistry/v20191201preview:ImportPipeline", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
