...
func NewPipelineRun(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:containerregistry/latest:PipelineRun"),
		},
	})
...
func GetPipelineRun(ctx *pulumi.Context,
	...
	var resource PipelineRun
	err := ctx.ReadResource("azurerm:containerregistry/v20191201preview:PipelineRun", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
