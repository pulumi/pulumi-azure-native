...
func NewScopeMap(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:containerregistry/latest:ScopeMap"),
		},
	})
...
func GetScopeMap(ctx *pulumi.Context,
	...
	var resource ScopeMap
	err := ctx.ReadResource("azurerm:containerregistry/v20190501preview:ScopeMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
