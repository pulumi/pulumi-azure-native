...
func NewCognitiveServicesAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:cognitiveservices/latest:CognitiveServicesAccount"),
		},
		{
			Type: pulumi.String("azurerm:cognitiveservices/preview:CognitiveServicesAccount"),
		},
		{
			Type: pulumi.String("azurerm:cognitiveservices/v20170418:CognitiveServicesAccount"),
		},
	})
	opts = append(opts, aliases)
	var resource CognitiveServicesAccount
	err := ctx.RegisterResource("azurerm:cognitiveservices/v20160201preview:CognitiveServicesAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCognitiveServicesAccount(ctx *pulumi.Context,
	...
	var resource CognitiveServicesAccount
	err := ctx.ReadResource("azurerm:cognitiveservices/v20160201preview:CognitiveServicesAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
