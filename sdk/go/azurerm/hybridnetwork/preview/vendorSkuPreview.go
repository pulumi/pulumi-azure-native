...
func NewVendorSkuPreview(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:hybridnetwork/v20200101preview:VendorSkuPreview"),
		},
	})
	opts = append(opts, aliases)
	var resource VendorSkuPreview
	err := ctx.RegisterResource("azurerm:hybridnetwork/preview:VendorSkuPreview", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVendorSkuPreview(ctx *pulumi.Context,
	...
	var resource VendorSkuPreview
	err := ctx.ReadResource("azurerm:hybridnetwork/preview:VendorSkuPreview", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
