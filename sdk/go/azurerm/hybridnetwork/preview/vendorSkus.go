...
func NewVendorSkus(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:hybridnetwork/v20200101preview:VendorSkus"),
		},
	})
	opts = append(opts, aliases)
	var resource VendorSkus
	err := ctx.RegisterResource("azurerm:hybridnetwork/preview:VendorSkus", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVendorSkus(ctx *pulumi.Context,
	...
	var resource VendorSkus
	err := ctx.ReadResource("azurerm:hybridnetwork/preview:VendorSkus", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
