...
func NewVendor(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:hybridnetwork/v20200101preview:Vendor"),
		},
	})
	opts = append(opts, aliases)
	var resource Vendor
	err := ctx.RegisterResource("azurerm:hybridnetwork/preview:Vendor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVendor(ctx *pulumi.Context,
	...
	var resource Vendor
	err := ctx.ReadResource("azurerm:hybridnetwork/preview:Vendor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
