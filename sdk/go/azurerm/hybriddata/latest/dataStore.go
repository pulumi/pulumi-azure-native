...
func NewDataStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:hybriddata/latest:DataStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataStore(ctx *pulumi.Context,
	...
	var resource DataStore
	err := ctx.ReadResource("azurerm:hybriddata/latest:DataStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
