...
func NewDataManager(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:hybriddata/latest:DataManager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataManager(ctx *pulumi.Context,
	...
	var resource DataManager
	err := ctx.ReadResource("azurerm:hybriddata/latest:DataManager", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
