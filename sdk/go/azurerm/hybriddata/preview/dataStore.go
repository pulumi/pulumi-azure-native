...
func NewDataStore(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:hybriddata/v20190601:DataStore"),
		},
	})
	opts = append(opts, aliases)
	var resource DataStore
	err := ctx.RegisterResource("azurerm:hybriddata/preview:DataStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataStore(ctx *pulumi.Context,
	...
	var resource DataStore
	err := ctx.ReadResource("azurerm:hybriddata/preview:DataStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
