...
func NewDataManager(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:hybriddata/v20190601:DataManager"),
		},
	})
	opts = append(opts, aliases)
	var resource DataManager
	err := ctx.RegisterResource("azurerm:hybriddata/preview:DataManager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataManager(ctx *pulumi.Context,
	...
	var resource DataManager
	err := ctx.ReadResource("azurerm:hybriddata/preview:DataManager", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
