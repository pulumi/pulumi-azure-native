...
// 				"DeviceName":       pulumi.String("dmsdatasource"),
...
func GetJobDefinition(ctx *pulumi.Context,
	...
	var resource JobDefinition
	err := ctx.ReadResource("azurerm:hybriddata/v20160601:JobDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
