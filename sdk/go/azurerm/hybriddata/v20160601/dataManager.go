...
//
// import (
// 	hybriddata "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/hybriddata/v20160601"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewDataManager(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:hybriddata/v20160601:DataManager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataManager(ctx *pulumi.Context,
	...
	var resource DataManager
	err := ctx.ReadResource("azurerm:hybriddata/v20160601:DataManager", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
