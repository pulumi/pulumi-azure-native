...
func NewOutput(ctx *pulumi.Context,
	...
	var resource Output
	err := ctx.RegisterResource("azurerm:streamanalytics/v20170401preview:Output", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOutput(ctx *pulumi.Context,
	...
	var resource Output
	err := ctx.ReadResource("azurerm:streamanalytics/v20170401preview:Output", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
