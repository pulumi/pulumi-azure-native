...
func NewStreamingJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:streamanalytics/latest:StreamingJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStreamingJob(ctx *pulumi.Context,
	...
	var resource StreamingJob
	err := ctx.ReadResource("azurerm:streamanalytics/latest:StreamingJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
