...
func NewInput(ctx *pulumi.Context,
	...
	var resource Input
	err := ctx.RegisterResource("azurerm:streamanalytics/latest:Input", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInput(ctx *pulumi.Context,
	...
	var resource Input
	err := ctx.ReadResource("azurerm:streamanalytics/latest:Input", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
