...
func NewStreamingJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:streamanalytics/preview:StreamingJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStreamingJob(ctx *pulumi.Context,
	...
	var resource StreamingJob
	err := ctx.ReadResource("azurerm:streamanalytics/preview:StreamingJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
