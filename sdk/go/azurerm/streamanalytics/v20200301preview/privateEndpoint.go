...
func NewPrivateEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:streamanalytics/v20200301preview:PrivateEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpoint(ctx *pulumi.Context,
	...
	var resource PrivateEndpoint
	err := ctx.ReadResource("azurerm:streamanalytics/v20200301preview:PrivateEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
