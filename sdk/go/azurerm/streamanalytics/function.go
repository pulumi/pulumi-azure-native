...
func NewFunction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:streamanalytics:Function", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunction(ctx *pulumi.Context,
	...
	var resource Function
	err := ctx.ReadResource("azurerm:streamanalytics:Function", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
