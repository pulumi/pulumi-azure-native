...
func NewUserAssignedIdentity(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:managedidentity:UserAssignedIdentity", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserAssignedIdentity(ctx *pulumi.Context,
	...
	var resource UserAssignedIdentity
	err := ctx.ReadResource("azurerm:managedidentity:UserAssignedIdentity", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
