...
//
// import (
// 	managedidentity "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedidentity/latest"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewUserAssignedIdentity(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:managedidentity/latest:UserAssignedIdentity", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserAssignedIdentity(ctx *pulumi.Context,
	...
	var resource UserAssignedIdentity
	err := ctx.ReadResource("azurerm:managedidentity/latest:UserAssignedIdentity", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
