...
func NewUserAssignedIdentity(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:managedidentity/v20150831preview:UserAssignedIdentity", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserAssignedIdentity(ctx *pulumi.Context,
	...
	var resource UserAssignedIdentity
	err := ctx.ReadResource("azurerm:managedidentity/v20150831preview:UserAssignedIdentity", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type UserAssignedIdentityState struct {
	...
	//  The ManagedServiceIdentity DataPlane URL that can be queried to obtain the identity credentials.
	ClientSecretUrl pulumi.StringPtrInput
	// The geo-location where the resource lives
