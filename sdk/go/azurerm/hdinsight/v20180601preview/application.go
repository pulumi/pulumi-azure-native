...
//
// import (
// 	hdinsight "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/hdinsight/v20180601preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewApplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:hdinsight/v20180601preview:Application", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplication(ctx *pulumi.Context,
	...
	var resource Application
	err := ctx.ReadResource("azurerm:hdinsight/v20180601preview:Application", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
