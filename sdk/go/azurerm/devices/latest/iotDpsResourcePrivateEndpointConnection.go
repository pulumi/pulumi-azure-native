...
func NewIotDpsResourcePrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devices/latest:IotDpsResourcePrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotDpsResourcePrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource IotDpsResourcePrivateEndpointConnection
	err := ctx.ReadResource("azurerm:devices/latest:IotDpsResourcePrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
