...
// IotHubLocationDescriptionInput is an input type that accepts IotHubLocationDescriptionArgs and IotHubLocationDescriptionOutput values.
// You can construct a concrete instance of `IotHubLocationDescriptionInput` via:
//
//          IotHubLocationDescriptionArgs{...}
type IotHubLocationDescriptionInput interface {
	pulumi.Input

	ToIotHubLocationDescriptionOutput() IotHubLocationDescriptionOutput
	ToIotHubLocationDescriptionOutputWithContext(context.Context) IotHubLocationDescriptionOutput
}

// Public representation of one of the locations where a resource is provisioned.
type IotHubLocationDescriptionArgs struct {
	// Azure Geo Regions
...
func (IotHubLocationDescriptionArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*IotHubLocationDescription)(nil)).Elem()
}

func (i IotHubLocationDescriptionArgs) ToIotHubLocationDescriptionOutput() IotHubLocationDescriptionOutput {
	return i.ToIotHubLocationDescriptionOutputWithContext(context.Background())
}

func (i IotHubLocationDescriptionArgs) ToIotHubLocationDescriptionOutputWithContext(ctx context.Context) IotHubLocationDescriptionOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IotHubLocationDescriptionOutput)
}

// IotHubLocationDescriptionArrayInput is an input type that accepts IotHubLocationDescriptionArray and IotHubLocationDescriptionArrayOutput values.
// You can construct a concrete instance of `IotHubLocationDescriptionArrayInput` via:
//
//          IotHubLocationDescriptionArray{ IotHubLocationDescriptionArgs{...} }
type IotHubLocationDescriptionArrayInput interface {
	pulumi.Input

	ToIotHubLocationDescriptionArrayOutput() IotHubLocationDescriptionArrayOutput
	ToIotHubLocationDescriptionArrayOutputWithContext(context.Context) IotHubLocationDescriptionArrayOutput
}

type IotHubLocationDescriptionArray []IotHubLocationDescriptionInput

func (IotHubLocationDescriptionArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]IotHubLocationDescription)(nil)).Elem()
}

func (i IotHubLocationDescriptionArray) ToIotHubLocationDescriptionArrayOutput() IotHubLocationDescriptionArrayOutput {
	return i.ToIotHubLocationDescriptionArrayOutputWithContext(context.Background())
}

func (i IotHubLocationDescriptionArray) ToIotHubLocationDescriptionArrayOutputWithContext(ctx context.Context) IotHubLocationDescriptionArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IotHubLocationDescriptionArrayOutput)
}

// Public representation of one of the locations where a resource is provisioned.
type IotHubLocationDescriptionOutput struct{ *pulumi.OutputState }

func (IotHubLocationDescriptionOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*IotHubLocationDescription)(nil)).Elem()
}

func (o IotHubLocationDescriptionOutput) ToIotHubLocationDescriptionOutput() IotHubLocationDescriptionOutput {
	return o
}

func (o IotHubLocationDescriptionOutput) ToIotHubLocationDescriptionOutputWithContext(ctx context.Context) IotHubLocationDescriptionOutput {
	return o
}

// Azure Geo Regions
func (o IotHubLocationDescriptionOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IotHubLocationDescription) *string { return v.Location }).(pulumi.StringPtrOutput)
}

// Specific Role assigned to this location
func (o IotHubLocationDescriptionOutput) Role() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IotHubLocationDescription) *string { return v.Role }).(pulumi.StringPtrOutput)
}

type IotHubLocationDescriptionArrayOutput struct{ *pulumi.OutputState }

func (IotHubLocationDescriptionArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]IotHubLocationDescription)(nil)).Elem()
}

func (o IotHubLocationDescriptionArrayOutput) ToIotHubLocationDescriptionArrayOutput() IotHubLocationDescriptionArrayOutput {
	return o
}

func (o IotHubLocationDescriptionArrayOutput) ToIotHubLocationDescriptionArrayOutputWithContext(ctx context.Context) IotHubLocationDescriptionArrayOutput {
	return o
}

func (o IotHubLocationDescriptionArrayOutput) Index(i pulumi.IntInput) IotHubLocationDescriptionOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) IotHubLocationDescription {
		return vs[0].([]IotHubLocationDescription)[vs[1].(int)]
	}).(IotHubLocationDescriptionOutput)
}
...
type IotHubProperties struct {
	...
	Locations []IotHubLocationDescription `pulumi:"locations"`
...
type IotHubPropertiesArgs struct {
	...
	// Primary and secondary location for iot hub
	Locations IotHubLocationDescriptionArrayInput `pulumi:"locations"`
	// The messaging endpoint properties for the file upload notification queue.
...
// Primary and secondary location for iot hub
func (o IotHubPropertiesOutput) Locations() IotHubLocationDescriptionArrayOutput {
	return o.ApplyT(func(v IotHubProperties) []IotHubLocationDescription { return v.Locations }).(IotHubLocationDescriptionArrayOutput)
}
...
// Primary and secondary location for iot hub
func (o IotHubPropertiesPtrOutput) Locations() IotHubLocationDescriptionArrayOutput {
	return o.ApplyT(func(v *IotHubProperties) []IotHubLocationDescription {
		if v == nil {
			return nil
		}
		return v.Locations
	}).(IotHubLocationDescriptionArrayOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(IotHubLocationDescriptionOutput{})
	pulumi.RegisterOutputType(IotHubLocationDescriptionArrayOutput{})
