...
// The name of the resource group that contains the IoT hub. A resource group name uniquely identifies the resource group within the subscription.
func (o IotHubResourceTypeOutput) Resourcegroup() pulumi.StringOutput {
	return o.ApplyT(func(v IotHubResourceType) string { return v.Resourcegroup }).(pulumi.StringOutput)
}
...
// The subscription identifier.
func (o IotHubResourceTypeOutput) Subscriptionid() pulumi.StringOutput {
	return o.ApplyT(func(v IotHubResourceType) string { return v.Subscriptionid }).(pulumi.StringOutput)
}
...
// The Event Hub-compatible consumer group name.
func (o IotHubResourceEventHubConsumerGroupTypeOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IotHubResourceEventHubConsumerGroupType) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// The tags.
func (o IotHubResourceEventHubConsumerGroupTypeOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v IotHubResourceEventHubConsumerGroupType) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
