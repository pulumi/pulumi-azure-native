...
func NewIotDpsResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devices/preview:IotDpsResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotDpsResource(ctx *pulumi.Context,
	...
	var resource IotDpsResource
	err := ctx.ReadResource("azurerm:devices/preview:IotDpsResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
