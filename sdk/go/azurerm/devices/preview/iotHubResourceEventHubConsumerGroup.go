...
func NewIotHubResourceEventHubConsumerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devices/preview:IotHubResourceEventHubConsumerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotHubResourceEventHubConsumerGroup(ctx *pulumi.Context,
	...
	var resource IotHubResourceEventHubConsumerGroup
	err := ctx.ReadResource("azurerm:devices/preview:IotHubResourceEventHubConsumerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
