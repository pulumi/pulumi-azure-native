...
func NewDpsCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:devices/preview:DpsCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDpsCertificate(ctx *pulumi.Context,
	...
	var resource DpsCertificate
	err := ctx.ReadResource("azurerm:devices/preview:DpsCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
