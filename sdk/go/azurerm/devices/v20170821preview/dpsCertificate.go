...
func NewDpsCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:devices/v20200101:DpsCertificate"),
		},
		{
			Type: pulumi.String("azurerm:devices/v20200301:DpsCertificate"),
		},
		{
			Type: pulumi.String("azurerm:devices/v20200901preview:DpsCertificate"),
		},
	})
	opts = append(opts, aliases)
	var resource DpsCertificate
	err := ctx.RegisterResource("azurerm:devices/v20170821preview:DpsCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDpsCertificate(ctx *pulumi.Context,
	...
	var resource DpsCertificate
	err := ctx.ReadResource("azurerm:devices/v20170821preview:DpsCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
