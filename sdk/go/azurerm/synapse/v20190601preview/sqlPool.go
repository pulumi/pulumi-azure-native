...
func NewSqlPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:synapse/latest:SqlPool"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:synapse/v20190601preview:SqlPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlPool(ctx *pulumi.Context,
	...
	var resource SqlPool
	err := ctx.ReadResource("azurerm:synapse/v20190601preview:SqlPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
