...
func NewWorkspaceAadAdmin(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:synapse/latest:WorkspaceAadAdmin"),
		},
	})
...
func GetWorkspaceAadAdmin(ctx *pulumi.Context,
	...
	var resource WorkspaceAadAdmin
	err := ctx.ReadResource("azurerm:synapse/v20190601preview:WorkspaceAadAdmin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
