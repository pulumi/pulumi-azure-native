...
func NewIpFirewallRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:synapse/preview:IpFirewallRule"),
		},
	})
...
func GetIpFirewallRule(ctx *pulumi.Context,
	...
	var resource IpFirewallRule
	err := ctx.ReadResource("azurerm:synapse/v20190601preview:IpFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
