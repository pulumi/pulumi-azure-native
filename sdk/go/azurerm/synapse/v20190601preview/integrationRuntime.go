...
func NewIntegrationRuntime(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:synapse/latest:IntegrationRuntime"),
		},
	})
...
func GetIntegrationRuntime(ctx *pulumi.Context,
	...
	var resource IntegrationRuntime
	err := ctx.ReadResource("azurerm:synapse/v20190601preview:IntegrationRuntime", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
