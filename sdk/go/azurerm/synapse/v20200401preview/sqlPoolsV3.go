...
func NewSqlPoolsV3(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:synapse/preview:SqlPoolsV3"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:synapse/v20200401preview:SqlPoolsV3", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlPoolsV3(ctx *pulumi.Context,
	...
	var resource SqlPoolsV3
	err := ctx.ReadResource("azurerm:synapse/v20200401preview:SqlPoolsV3", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
