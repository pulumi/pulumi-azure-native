...
func NewBigDataPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:synapse/v20190601preview:BigDataPool"),
		},
	})
	opts = append(opts, aliases)
	var resource BigDataPool
	err := ctx.RegisterResource("azurerm:synapse/preview:BigDataPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigDataPool(ctx *pulumi.Context,
	...
	var resource BigDataPool
	err := ctx.ReadResource("azurerm:synapse/preview:BigDataPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
