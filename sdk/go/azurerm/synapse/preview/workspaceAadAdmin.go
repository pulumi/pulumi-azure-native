...
func NewWorkspaceAadAdmin(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:synapse/v20190601preview:WorkspaceAadAdmin"),
		},
	})
	opts = append(opts, aliases)
	var resource WorkspaceAadAdmin
	err := ctx.RegisterResource("azurerm:synapse/preview:WorkspaceAadAdmin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceAadAdmin(ctx *pulumi.Context,
	...
	var resource WorkspaceAadAdmin
	err := ctx.ReadResource("azurerm:synapse/preview:WorkspaceAadAdmin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
