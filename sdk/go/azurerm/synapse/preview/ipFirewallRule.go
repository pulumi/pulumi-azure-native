...
func NewIpFirewallRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:synapse/v20190601preview:IpFirewallRule"),
		},
	})
	opts = append(opts, aliases)
	var resource IpFirewallRule
	err := ctx.RegisterResource("azurerm:synapse/preview:IpFirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpFirewallRule(ctx *pulumi.Context,
	...
	var resource IpFirewallRule
	err := ctx.ReadResource("azurerm:synapse/preview:IpFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
