...
func NewSqlDatabase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:synapse/v20200401preview:SqlDatabase"),
		},
	})
	opts = append(opts, aliases)
	var resource SqlDatabase
	err := ctx.RegisterResource("azurerm:synapse/preview:SqlDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlDatabase(ctx *pulumi.Context,
	...
	var resource SqlDatabase
	err := ctx.ReadResource("azurerm:synapse/preview:SqlDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
