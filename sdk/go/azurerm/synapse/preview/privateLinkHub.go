...
func NewPrivateLinkHub(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:synapse/v20190601preview:PrivateLinkHub"),
		},
	})
	opts = append(opts, aliases)
	var resource PrivateLinkHub
	err := ctx.RegisterResource("azurerm:synapse/preview:PrivateLinkHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkHub(ctx *pulumi.Context,
	...
	var resource PrivateLinkHub
	err := ctx.ReadResource("azurerm:synapse/preview:PrivateLinkHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
