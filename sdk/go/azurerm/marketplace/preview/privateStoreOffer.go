...
func NewPrivateStoreOffer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:marketplace/preview:PrivateStoreOffer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateStoreOffer(ctx *pulumi.Context,
	...
	var resource PrivateStoreOffer
	err := ctx.ReadResource("azurerm:marketplace/preview:PrivateStoreOffer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
