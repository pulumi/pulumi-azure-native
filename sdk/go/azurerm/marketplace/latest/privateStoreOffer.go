...
//
// import (
// 	marketplace "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/marketplace/latest"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewPrivateStoreOffer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:marketplace/latest:PrivateStoreOffer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateStoreOffer(ctx *pulumi.Context,
	...
	var resource PrivateStoreOffer
	err := ctx.ReadResource("azurerm:marketplace/latest:PrivateStoreOffer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
