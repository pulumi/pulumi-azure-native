...
func NewWorkloadGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20190601preview:WorkloadGroup"),
		},
	})
	opts = append(opts, aliases)
	var resource WorkloadGroup
	err := ctx.RegisterResource("azurerm:sql/preview:WorkloadGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadGroup(ctx *pulumi.Context,
	...
	var resource WorkloadGroup
	err := ctx.ReadResource("azurerm:sql/preview:WorkloadGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
