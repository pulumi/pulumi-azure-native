...
func NewManagedInstanceAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20200202preview:ManagedInstanceAzureADOnlyAuthentication"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagedInstanceAzureADOnlyAuthentication
	err := ctx.RegisterResource("azurerm:sql/preview:ManagedInstanceAzureADOnlyAuthentication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstanceAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	var resource ManagedInstanceAzureADOnlyAuthentication
	err := ctx.ReadResource("azurerm:sql/preview:ManagedInstanceAzureADOnlyAuthentication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
