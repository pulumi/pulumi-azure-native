...
func NewInstancePool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20180601preview:InstancePool"),
		},
	})
	opts = append(opts, aliases)
	var resource InstancePool
	err := ctx.RegisterResource("azurerm:sql/preview:InstancePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstancePool(ctx *pulumi.Context,
	...
	var resource InstancePool
	err := ctx.ReadResource("azurerm:sql/preview:InstancePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
