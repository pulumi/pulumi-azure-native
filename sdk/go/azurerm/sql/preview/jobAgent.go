...
func NewJobAgent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20170301preview:JobAgent"),
		},
	})
	opts = append(opts, aliases)
	var resource JobAgent
	err := ctx.RegisterResource("azurerm:sql/preview:JobAgent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobAgent(ctx *pulumi.Context,
	...
	var resource JobAgent
	err := ctx.ReadResource("azurerm:sql/preview:JobAgent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
