...
func NewInstanceFailoverGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20171001preview:InstanceFailoverGroup"),
		},
	})
	opts = append(opts, aliases)
	var resource InstanceFailoverGroup
	err := ctx.RegisterResource("azurerm:sql/preview:InstanceFailoverGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceFailoverGroup(ctx *pulumi.Context,
	...
	var resource InstanceFailoverGroup
	err := ctx.ReadResource("azurerm:sql/preview:InstanceFailoverGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
