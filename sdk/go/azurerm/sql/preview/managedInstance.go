...
func NewManagedInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20150501preview:ManagedInstance"),
		},
		{
			Type: pulumi.String("azurerm:sql/v20180601preview:ManagedInstance"),
		},
		{
			Type: pulumi.String("azurerm:sql/v20200202preview:ManagedInstance"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagedInstance
	err := ctx.RegisterResource("azurerm:sql/preview:ManagedInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstance(ctx *pulumi.Context,
	...
	var resource ManagedInstance
	err := ctx.ReadResource("azurerm:sql/preview:ManagedInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
