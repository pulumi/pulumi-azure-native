...
func NewJobCredential(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20170301preview:JobCredential"),
		},
	})
	opts = append(opts, aliases)
	var resource JobCredential
	err := ctx.RegisterResource("azurerm:sql/preview:JobCredential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobCredential(ctx *pulumi.Context,
	...
	var resource JobCredential
	err := ctx.ReadResource("azurerm:sql/preview:JobCredential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
