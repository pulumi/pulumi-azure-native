...
func NewJobStep(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20170301preview:JobStep"),
		},
	})
	opts = append(opts, aliases)
	var resource JobStep
	err := ctx.RegisterResource("azurerm:sql/preview:JobStep", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobStep(ctx *pulumi.Context,
	...
	var resource JobStep
	err := ctx.ReadResource("azurerm:sql/preview:JobStep", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
