...
func NewFailoverGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20150501preview:FailoverGroup"),
		},
	})
	opts = append(opts, aliases)
	var resource FailoverGroup
	err := ctx.RegisterResource("azurerm:sql/preview:FailoverGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFailoverGroup(ctx *pulumi.Context,
	...
	var resource FailoverGroup
	err := ctx.ReadResource("azurerm:sql/preview:FailoverGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
