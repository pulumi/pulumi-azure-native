...
func NewServerDnsAlias(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20170301preview:ServerDnsAlias"),
		},
	})
	opts = append(opts, aliases)
	var resource ServerDnsAlias
	err := ctx.RegisterResource("azurerm:sql/preview:ServerDnsAlias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerDnsAlias(ctx *pulumi.Context,
	...
	var resource ServerDnsAlias
	err := ctx.ReadResource("azurerm:sql/preview:ServerDnsAlias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
