...
func NewManagedDatabaseSensitivityLabel(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20180601preview:ManagedDatabaseSensitivityLabel"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagedDatabaseSensitivityLabel
	err := ctx.RegisterResource("azurerm:sql/preview:ManagedDatabaseSensitivityLabel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedDatabaseSensitivityLabel(ctx *pulumi.Context,
	...
	var resource ManagedDatabaseSensitivityLabel
	err := ctx.ReadResource("azurerm:sql/preview:ManagedDatabaseSensitivityLabel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
