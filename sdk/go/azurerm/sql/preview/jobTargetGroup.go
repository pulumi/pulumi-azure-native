...
func NewJobTargetGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20170301preview:JobTargetGroup"),
		},
	})
	opts = append(opts, aliases)
	var resource JobTargetGroup
	err := ctx.RegisterResource("azurerm:sql/preview:JobTargetGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobTargetGroup(ctx *pulumi.Context,
	...
	var resource JobTargetGroup
	err := ctx.ReadResource("azurerm:sql/preview:JobTargetGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
