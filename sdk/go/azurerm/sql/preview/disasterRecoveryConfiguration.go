...
func NewDisasterRecoveryConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/latest:DisasterRecoveryConfiguration"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:sql/preview:DisasterRecoveryConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisasterRecoveryConfiguration(ctx *pulumi.Context,
	...
	var resource DisasterRecoveryConfiguration
	err := ctx.ReadResource("azurerm:sql/preview:DisasterRecoveryConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
