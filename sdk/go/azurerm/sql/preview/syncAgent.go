...
func NewSyncAgent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20150501preview:SyncAgent"),
		},
	})
	opts = append(opts, aliases)
	var resource SyncAgent
	err := ctx.RegisterResource("azurerm:sql/preview:SyncAgent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncAgent(ctx *pulumi.Context,
	...
	var resource SyncAgent
	err := ctx.ReadResource("azurerm:sql/preview:SyncAgent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
