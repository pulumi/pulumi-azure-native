...
func NewServerAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/v20200202preview:ServerAzureADOnlyAuthentication"),
		},
	})
	opts = append(opts, aliases)
	var resource ServerAzureADOnlyAuthentication
	err := ctx.RegisterResource("azurerm:sql/preview:ServerAzureADOnlyAuthentication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	var resource ServerAzureADOnlyAuthentication
	err := ctx.ReadResource("azurerm:sql/preview:ServerAzureADOnlyAuthentication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
