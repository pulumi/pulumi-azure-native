...
func NewDisasterRecoveryConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:sql:DisasterRecoveryConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisasterRecoveryConfiguration(ctx *pulumi.Context,
	...
	var resource DisasterRecoveryConfiguration
	err := ctx.ReadResource("azurerm:sql:DisasterRecoveryConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
