...
func NewManagedInstanceKey(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/latest:ManagedInstanceKey"),
		},
	})
...
func GetManagedInstanceKey(ctx *pulumi.Context,
	...
	var resource ManagedInstanceKey
	err := ctx.ReadResource("azurerm:sql/v20171001preview:ManagedInstanceKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
