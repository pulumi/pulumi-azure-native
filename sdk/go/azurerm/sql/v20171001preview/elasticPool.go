...
func NewElasticPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:sql/v20171001preview:ElasticPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetElasticPool(ctx *pulumi.Context,
	...
	var resource ElasticPool
	err := ctx.ReadResource("azurerm:sql/v20171001preview:ElasticPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
