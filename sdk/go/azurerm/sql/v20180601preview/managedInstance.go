...
func NewManagedInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:sql/v20180601preview:ManagedInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstance(ctx *pulumi.Context,
	...
	var resource ManagedInstance
	err := ctx.ReadResource("azurerm:sql/v20180601preview:ManagedInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
