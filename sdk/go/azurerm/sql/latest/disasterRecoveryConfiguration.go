...
func NewDisasterRecoveryConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/preview:DisasterRecoveryConfiguration"),
		},
		{
			Type: pulumi.String("azurerm:sql/v20140401:DisasterRecoveryConfiguration"),
		},
	})
	opts = append(opts, aliases)
	var resource DisasterRecoveryConfiguration
	err := ctx.RegisterResource("azurerm:sql/latest:DisasterRecoveryConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisasterRecoveryConfiguration(ctx *pulumi.Context,
	...
	var resource DisasterRecoveryConfiguration
	err := ctx.ReadResource("azurerm:sql/latest:DisasterRecoveryConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
