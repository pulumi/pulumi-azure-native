...
func NewManagedInstanceAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/latest:ManagedInstanceAzureADOnlyAuthentication"),
		},
	})
...
func GetManagedInstanceAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	var resource ManagedInstanceAzureADOnlyAuthentication
	err := ctx.ReadResource("azurerm:sql/v20200202preview:ManagedInstanceAzureADOnlyAuthentication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
