...
func NewServerAzureADAdministrator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:sql/v20190601preview:ServerAzureADAdministrator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerAzureADAdministrator(ctx *pulumi.Context,
	...
	var resource ServerAzureADAdministrator
	err := ctx.ReadResource("azurerm:sql/v20190601preview:ServerAzureADAdministrator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
