...
func NewSyncMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:sql/v20190601preview:SyncMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncMember(ctx *pulumi.Context,
	...
	var resource SyncMember
	err := ctx.ReadResource("azurerm:sql/v20190601preview:SyncMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
