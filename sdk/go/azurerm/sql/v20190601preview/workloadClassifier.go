...
func NewWorkloadClassifier(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/preview:WorkloadClassifier"),
		},
	})
	opts = append(opts, aliases)
	var resource WorkloadClassifier
	err := ctx.RegisterResource("azurerm:sql/v20190601preview:WorkloadClassifier", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadClassifier(ctx *pulumi.Context,
	...
	var resource WorkloadClassifier
	err := ctx.ReadResource("azurerm:sql/v20190601preview:WorkloadClassifier", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
