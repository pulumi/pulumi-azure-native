...
// 			Location:                          pulumi.String("southeastasia"),
// 			LongTermRetentionBackupResourceId: pulumi.String("/subscriptions/00000000-1111-2222-3333-444444444444/providers/Microsoft.Sql/locations/southeastasia/longTermRetentionManagedInstances/testInstance/databases/testDatabase/longTermRetentionManagedInstanceBackups/00000000-1111-2222-3333-444444444444;131637960820000000"),
...
func NewManagedDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:sql/v20170301preview:ManagedDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedDatabase(ctx *pulumi.Context,
	...
	var resource ManagedDatabase
	err := ctx.ReadResource("azurerm:sql/v20170301preview:ManagedDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
