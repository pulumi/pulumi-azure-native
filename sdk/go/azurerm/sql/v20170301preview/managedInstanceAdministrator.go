...
func NewManagedInstanceAdministrator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:sql/preview:ManagedInstanceAdministrator"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagedInstanceAdministrator
	err := ctx.RegisterResource("azurerm:sql/v20170301preview:ManagedInstanceAdministrator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstanceAdministrator(ctx *pulumi.Context,
	...
	var resource ManagedInstanceAdministrator
	err := ctx.ReadResource("azurerm:sql/v20170301preview:ManagedInstanceAdministrator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
