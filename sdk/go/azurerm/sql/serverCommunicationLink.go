...
func NewServerCommunicationLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:sql:ServerCommunicationLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerCommunicationLink(ctx *pulumi.Context,
	...
	var resource ServerCommunicationLink
	err := ctx.ReadResource("azurerm:sql:ServerCommunicationLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
