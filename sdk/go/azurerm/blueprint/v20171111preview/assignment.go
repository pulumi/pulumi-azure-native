...
func NewAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:blueprint/v20171111preview:Assignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssignment(ctx *pulumi.Context,
	...
	var resource Assignment
	err := ctx.ReadResource("azurerm:blueprint/v20171111preview:Assignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
