...
func NewConfigurationProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:changeanalysis/latest:ConfigurationProfile"),
		},
	})
...
func GetConfigurationProfile(ctx *pulumi.Context,
	...
	var resource ConfigurationProfile
	err := ctx.ReadResource("azurerm:changeanalysis/v20200401preview:ConfigurationProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
