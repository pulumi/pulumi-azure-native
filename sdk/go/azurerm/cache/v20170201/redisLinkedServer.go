...
// 		_, err := cache.NewRedisLinkedServer(ctx, "redisLinkedServer", &cache.RedisLinkedServerArgs{
...
func GetRedisLinkedServer(ctx *pulumi.Context,
	...
	var resource RedisLinkedServer
	err := ctx.ReadResource("azurerm:cache/v20170201:RedisLinkedServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
