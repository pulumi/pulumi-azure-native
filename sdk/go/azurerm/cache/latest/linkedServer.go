...
func NewLinkedServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:cache/latest:LinkedServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedServer(ctx *pulumi.Context,
	...
	var resource LinkedServer
	err := ctx.ReadResource("azurerm:cache/latest:LinkedServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
