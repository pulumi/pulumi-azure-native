...
// RedisPropertiesInput is an input type that accepts RedisPropertiesArgs and RedisPropertiesOutput values.
// You can construct a concrete instance of `RedisPropertiesInput` via:
//
//          RedisPropertiesArgs{...}
type RedisPropertiesInput interface {
	pulumi.Input

	ToRedisPropertiesOutput() RedisPropertiesOutput
	ToRedisPropertiesOutputWithContext(context.Context) RedisPropertiesOutput
}

// Parameters supplied to CreateOrUpdate Redis operation.
type RedisPropertiesArgs struct {
	// If the value is true, then the non-SLL Redis server port (6379) will be enabled.
...
func (RedisPropertiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*RedisProperties)(nil)).Elem()
}

func (i RedisPropertiesArgs) ToRedisPropertiesOutput() RedisPropertiesOutput {
	return i.ToRedisPropertiesOutputWithContext(context.Background())
}

func (i RedisPropertiesArgs) ToRedisPropertiesOutputWithContext(ctx context.Context) RedisPropertiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RedisPropertiesOutput)
}

func (i RedisPropertiesArgs) ToRedisPropertiesPtrOutput() RedisPropertiesPtrOutput {
	return i.ToRedisPropertiesPtrOutputWithContext(context.Background())
}

func (i RedisPropertiesArgs) ToRedisPropertiesPtrOutputWithContext(ctx context.Context) RedisPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RedisPropertiesOutput).ToRedisPropertiesPtrOutputWithContext(ctx)
}

// RedisPropertiesPtrInput is an input type that accepts RedisPropertiesArgs, RedisPropertiesPtr and RedisPropertiesPtrOutput values.
// You can construct a concrete instance of `RedisPropertiesPtrInput` via:
//
//          RedisPropertiesArgs{...}
//
//  or:
//
//          nil
type RedisPropertiesPtrInput interface {
	pulumi.Input

	ToRedisPropertiesPtrOutput() RedisPropertiesPtrOutput
	ToRedisPropertiesPtrOutputWithContext(context.Context) RedisPropertiesPtrOutput
}

type redisPropertiesPtrType RedisPropertiesArgs

func RedisPropertiesPtr(v *RedisPropertiesArgs) RedisPropertiesPtrInput {
	return (*redisPropertiesPtrType)(v)
}

func (*redisPropertiesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**RedisProperties)(nil)).Elem()
}

func (i *redisPropertiesPtrType) ToRedisPropertiesPtrOutput() RedisPropertiesPtrOutput {
	return i.ToRedisPropertiesPtrOutputWithContext(context.Background())
}

func (i *redisPropertiesPtrType) ToRedisPropertiesPtrOutputWithContext(ctx context.Context) RedisPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RedisPropertiesPtrOutput)
}

// Parameters supplied to CreateOrUpdate Redis operation.
type RedisPropertiesOutput struct{ *pulumi.OutputState }

func (RedisPropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*RedisProperties)(nil)).Elem()
}

func (o RedisPropertiesOutput) ToRedisPropertiesOutput() RedisPropertiesOutput {
	return o
}

func (o RedisPropertiesOutput) ToRedisPropertiesOutputWithContext(ctx context.Context) RedisPropertiesOutput {
	return o
}

func (o RedisPropertiesOutput) ToRedisPropertiesPtrOutput() RedisPropertiesPtrOutput {
	return o.ToRedisPropertiesPtrOutputWithContext(context.Background())
}

func (o RedisPropertiesOutput) ToRedisPropertiesPtrOutputWithContext(ctx context.Context) RedisPropertiesPtrOutput {
	return o.ApplyT(func(v RedisProperties) *RedisProperties {
		return &v
	}).(RedisPropertiesPtrOutput)
}

// If the value is true, then the non-SLL Redis server port (6379) will be enabled.
func (o RedisPropertiesOutput) EnableNonSslPort() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v RedisProperties) *bool { return v.EnableNonSslPort }).(pulumi.BoolPtrOutput)
}

// All Redis Settings. Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.
func (o RedisPropertiesOutput) RedisConfiguration() pulumi.StringMapOutput {
	return o.ApplyT(func(v RedisProperties) map[string]string { return v.RedisConfiguration }).(pulumi.StringMapOutput)
}

// RedisVersion parameter has been deprecated. As such, it is no longer necessary to provide this parameter and any value specified is ignored.
func (o RedisPropertiesOutput) RedisVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v RedisProperties) *string { return v.RedisVersion }).(pulumi.StringPtrOutput)
}

// The number of shards to be created on a Premium Cluster Cache.
func (o RedisPropertiesOutput) ShardCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v RedisProperties) *int { return v.ShardCount }).(pulumi.IntPtrOutput)
}

// What SKU of Redis cache to deploy.
func (o RedisPropertiesOutput) Sku() SkuOutput {
	return o.ApplyT(func(v RedisProperties) Sku { return v.Sku }).(SkuOutput)
}

// Required when deploying a Redis cache inside an existing Azure Virtual Network.
func (o RedisPropertiesOutput) StaticIP() pulumi.StringPtrOutput {
	return o.ApplyT(func(v RedisProperties) *string { return v.StaticIP }).(pulumi.StringPtrOutput)
}

// Required when deploying a Redis cache inside an existing Azure Virtual Network.
func (o RedisPropertiesOutput) Subnet() pulumi.StringPtrOutput {
	return o.ApplyT(func(v RedisProperties) *string { return v.Subnet }).(pulumi.StringPtrOutput)
}

// tenantSettings
func (o RedisPropertiesOutput) TenantSettings() pulumi.StringMapOutput {
	return o.ApplyT(func(v RedisProperties) map[string]string { return v.TenantSettings }).(pulumi.StringMapOutput)
}

// The exact ARM resource ID of the virtual network to deploy the Redis cache in. Example format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/Microsoft.ClassicNetwork/VirtualNetworks/vnet1
func (o RedisPropertiesOutput) VirtualNetwork() pulumi.StringPtrOutput {
	return o.ApplyT(func(v RedisProperties) *string { return v.VirtualNetwork }).(pulumi.StringPtrOutput)
}

type RedisPropertiesPtrOutput struct{ *pulumi.OutputState }

func (RedisPropertiesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**RedisProperties)(nil)).Elem()
}

func (o RedisPropertiesPtrOutput) ToRedisPropertiesPtrOutput() RedisPropertiesPtrOutput {
	return o
}

func (o RedisPropertiesPtrOutput) ToRedisPropertiesPtrOutputWithContext(ctx context.Context) RedisPropertiesPtrOutput {
	return o
}

func (o RedisPropertiesPtrOutput) Elem() RedisPropertiesOutput {
	return o.ApplyT(func(v *RedisProperties) RedisProperties { return *v }).(RedisPropertiesOutput)
}

// If the value is true, then the non-SLL Redis server port (6379) will be enabled.
func (o RedisPropertiesPtrOutput) EnableNonSslPort() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RedisProperties) *bool {
		if v == nil {
			return nil
		}
...
// All Redis Settings. Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.
func (o RedisPropertiesPtrOutput) RedisConfiguration() pulumi.StringMapOutput {
	return o.ApplyT(func(v *RedisProperties) map[string]string {
		if v == nil {
			return nil
		}
...
// RedisVersion parameter has been deprecated. As such, it is no longer necessary to provide this parameter and any value specified is ignored.
func (o RedisPropertiesPtrOutput) RedisVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RedisProperties) *string {
		if v == nil {
			return nil
		}
...
// The number of shards to be created on a Premium Cluster Cache.
func (o RedisPropertiesPtrOutput) ShardCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *RedisProperties) *int {
		if v == nil {
			return nil
		}
		return v.ShardCount
...
// What SKU of Redis cache to deploy.
func (o RedisPropertiesPtrOutput) Sku() SkuPtrOutput {
	return o.ApplyT(func(v *RedisProperties) *Sku {
		if v == nil {
			return nil
		}
		return &v.Sku
...
// Required when deploying a Redis cache inside an existing Azure Virtual Network.
func (o RedisPropertiesPtrOutput) StaticIP() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RedisProperties) *string {
		if v == nil {
			return nil
		}
...
// Required when deploying a Redis cache inside an existing Azure Virtual Network.
func (o RedisPropertiesPtrOutput) Subnet() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RedisProperties) *string {
		if v == nil {
			return nil
		}
...
// tenantSettings
func (o RedisPropertiesPtrOutput) TenantSettings() pulumi.StringMapOutput {
	return o.ApplyT(func(v *RedisProperties) map[string]string {
		if v == nil {
			return nil
		}
...
// The exact ARM resource ID of the virtual network to deploy the Redis cache in. Example format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/Microsoft.ClassicNetwork/VirtualNetworks/vnet1
func (o RedisPropertiesPtrOutput) VirtualNetwork() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RedisProperties) *string {
		if v == nil {
			return nil
		}
...
func init() {
	...
	pulumi.RegisterOutputType(RedisPropertiesOutput{})
	pulumi.RegisterOutputType(RedisPropertiesPtrOutput{})
