...
// 		_, err := cache.NewRedisFirewallRule(ctx, "redisFirewallRule", &cache.RedisFirewallRuleArgs{
...
func NewRedisFirewallRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:cache/v20190701:RedisFirewallRule"),
		},
	})
...
func GetRedisFirewallRule(ctx *pulumi.Context,
	...
	var resource RedisFirewallRule
	err := ctx.ReadResource("azurerm:cache/v20160401:RedisFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
