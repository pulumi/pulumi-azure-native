...
func NewPatchSchedule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:cache/v20170201:PatchSchedule"),
		},
	})
	opts = append(opts, aliases)
	var resource PatchSchedule
	err := ctx.RegisterResource("azurerm:cache/v20160401:PatchSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPatchSchedule(ctx *pulumi.Context,
	...
	var resource PatchSchedule
	err := ctx.ReadResource("azurerm:cache/v20160401:PatchSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
