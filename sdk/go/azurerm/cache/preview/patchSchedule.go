...
func NewPatchSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:cache/preview:PatchSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPatchSchedule(ctx *pulumi.Context,
	...
	var resource PatchSchedule
	err := ctx.ReadResource("azurerm:cache/preview:PatchSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
