...
func NewRedis(ctx *pulumi.Context,
	...
	var resource Redis
	err := ctx.RegisterResource("azurerm:cache/v20171001:Redis", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedis(ctx *pulumi.Context,
	...
	var resource Redis
	err := ctx.ReadResource("azurerm:cache/v20171001:Redis", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
