...
func NewLinkedServer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:cache/v20190701:LinkedServer"),
		},
	})
	opts = append(opts, aliases)
	var resource LinkedServer
	err := ctx.RegisterResource("azurerm:cache/v20171001:LinkedServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedServer(ctx *pulumi.Context,
	...
	var resource LinkedServer
	err := ctx.ReadResource("azurerm:cache/v20171001:LinkedServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
