...
func NewSuppression(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:advisor/preview:Suppression", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSuppression(ctx *pulumi.Context,
	...
	var resource Suppression
	err := ctx.ReadResource("azurerm:advisor/preview:Suppression", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
