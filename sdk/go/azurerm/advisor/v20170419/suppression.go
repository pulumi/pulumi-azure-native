...
//
// import (
// 	advisor "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/advisor/v20170419"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewSuppression(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:advisor/v20170419:Suppression", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSuppression(ctx *pulumi.Context,
	...
	var resource Suppression
	err := ctx.ReadResource("azurerm:advisor/v20170419:Suppression", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
