...
//
// import (
// 	containerinstance "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/containerinstance/v20171201preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewContainerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:containerinstance/v20171201preview:ContainerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerGroup(ctx *pulumi.Context,
	...
	var resource ContainerGroup
	err := ctx.ReadResource("azurerm:containerinstance/v20171201preview:ContainerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
