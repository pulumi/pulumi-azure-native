...
func NewResourceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:index:ResourceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceGroup(ctx *pulumi.Context,
	...
	var resource ResourceGroup
	err := ctx.ReadResource("azurerm:index:ResourceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
