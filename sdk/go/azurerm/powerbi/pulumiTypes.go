...
type WorkspaceCollectionType struct {
	// Azure location
...
// WorkspaceCollectionTypeInput is an input type that accepts WorkspaceCollectionTypeArgs and WorkspaceCollectionTypeOutput values.
// You can construct a concrete instance of `WorkspaceCollectionTypeInput` via:
//
//          WorkspaceCollectionTypeArgs{...}
type WorkspaceCollectionTypeInput interface {
	pulumi.Input

	ToWorkspaceCollectionTypeOutput() WorkspaceCollectionTypeOutput
	ToWorkspaceCollectionTypeOutputWithContext(context.Context) WorkspaceCollectionTypeOutput
}

type WorkspaceCollectionTypeArgs struct {
	// Azure location
...
func (WorkspaceCollectionTypeArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*WorkspaceCollectionType)(nil)).Elem()
}

func (i WorkspaceCollectionTypeArgs) ToWorkspaceCollectionTypeOutput() WorkspaceCollectionTypeOutput {
	return i.ToWorkspaceCollectionTypeOutputWithContext(context.Background())
}

func (i WorkspaceCollectionTypeArgs) ToWorkspaceCollectionTypeOutputWithContext(ctx context.Context) WorkspaceCollectionTypeOutput {
	return pulumi.ToOutputWithContext(ctx, i).(WorkspaceCollectionTypeOutput)
}

type WorkspaceCollectionTypeOutput struct{ *pulumi.OutputState }

func (WorkspaceCollectionTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*WorkspaceCollectionType)(nil)).Elem()
}

func (o WorkspaceCollectionTypeOutput) ToWorkspaceCollectionTypeOutput() WorkspaceCollectionTypeOutput {
	return o
}

func (o WorkspaceCollectionTypeOutput) ToWorkspaceCollectionTypeOutputWithContext(ctx context.Context) WorkspaceCollectionTypeOutput {
	return o
}

// Azure location
func (o WorkspaceCollectionTypeOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v WorkspaceCollectionType) *string { return v.Location }).(pulumi.StringPtrOutput)
}

// Workspace collection name
func (o WorkspaceCollectionTypeOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v WorkspaceCollectionType) *string { return v.Name }).(pulumi.StringPtrOutput)
}
...
func (o WorkspaceCollectionTypeOutput) Sku() AzureSkuResponsePtrOutput {
	return o.ApplyT(func(v WorkspaceCollectionType) *AzureSkuResponse { return v.Sku }).(AzureSkuResponsePtrOutput)
}

func (o WorkspaceCollectionTypeOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v WorkspaceCollectionType) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}

// Resource type
func (o WorkspaceCollectionTypeOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v WorkspaceCollectionType) *string { return v.Type }).(pulumi.StringPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(WorkspaceCollectionTypeOutput{})
}
