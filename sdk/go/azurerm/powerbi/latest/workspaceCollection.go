...
func NewWorkspaceCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:powerbi/latest:WorkspaceCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceCollection(ctx *pulumi.Context,
	...
	var resource WorkspaceCollection
	err := ctx.ReadResource("azurerm:powerbi/latest:WorkspaceCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
