...
func NewAlias(ctx *pulumi.Context,
	...
	var resource Alias
	err := ctx.RegisterResource("azurerm:subscription/preview:Alias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlias(ctx *pulumi.Context,
	...
	var resource Alias
	err := ctx.ReadResource("azurerm:subscription/preview:Alias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
