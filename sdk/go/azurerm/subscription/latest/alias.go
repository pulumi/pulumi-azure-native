...
//
// import (
// 	subscription "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/subscription/latest"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewAlias(ctx *pulumi.Context,
	...
	var resource Alias
	err := ctx.RegisterResource("azurerm:subscription/latest:Alias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlias(ctx *pulumi.Context,
	...
	var resource Alias
	err := ctx.ReadResource("azurerm:subscription/latest:Alias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
