...
func NewDeploymentScript(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:resources/latest:DeploymentScript"),
		},
	})
...
func GetDeploymentScript(ctx *pulumi.Context,
	...
	var resource DeploymentScript
	err := ctx.ReadResource("azurerm:resources/v20191001preview:DeploymentScript", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
