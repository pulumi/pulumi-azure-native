...
func NewDeploymentAtSubscriptionScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:resources/v20190701:DeploymentAtSubscriptionScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtSubscriptionScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtSubscriptionScope
	err := ctx.ReadResource("azurerm:resources/v20190701:DeploymentAtSubscriptionScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
