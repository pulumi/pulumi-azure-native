...
func NewTemplateSpecVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:resources/preview:TemplateSpecVersion"),
		},
	})
...
func GetTemplateSpecVersion(ctx *pulumi.Context,
	...
	var resource TemplateSpecVersion
	err := ctx.ReadResource("azurerm:resources/v20190601preview:TemplateSpecVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
