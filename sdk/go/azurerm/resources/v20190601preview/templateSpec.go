...
func NewTemplateSpec(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:resources/latest:TemplateSpec"),
		},
	})
...
func GetTemplateSpec(ctx *pulumi.Context,
	...
	var resource TemplateSpec
	err := ctx.ReadResource("azurerm:resources/v20190601preview:TemplateSpec", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
