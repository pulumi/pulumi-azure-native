...
func NewDeploymentAtScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:resources/latest:DeploymentAtScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtScope
	err := ctx.ReadResource("azurerm:resources/latest:DeploymentAtScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
