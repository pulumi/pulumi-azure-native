...
func NewTemplateSpec(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:resources/v20190601preview:TemplateSpec"),
		},
	})
	opts = append(opts, aliases)
	var resource TemplateSpec
	err := ctx.RegisterResource("azurerm:resources/preview:TemplateSpec", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTemplateSpec(ctx *pulumi.Context,
	...
	var resource TemplateSpec
	err := ctx.ReadResource("azurerm:resources/preview:TemplateSpec", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
