...
func NewDeploymentAtScope(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:resources/latest:DeploymentAtScope"),
		},
		{
			Type: pulumi.String("azurerm:resources/v20190701:DeploymentAtScope"),
		},
		{
			Type: pulumi.String("azurerm:resources/v20190801:DeploymentAtScope"),
		},
		{
			Type: pulumi.String("azurerm:resources/v20191001:DeploymentAtScope"),
		},
		{
			Type: pulumi.String("azurerm:resources/v20200601:DeploymentAtScope"),
		},
	})
	opts = append(opts, aliases)
	var resource DeploymentAtScope
	err := ctx.RegisterResource("azurerm:resources/preview:DeploymentAtScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtScope
	err := ctx.ReadResource("azurerm:resources/preview:DeploymentAtScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
