...
func NewTemplateSpecVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:resources/v20190601preview:TemplateSpecVersion"),
		},
	})
	opts = append(opts, aliases)
	var resource TemplateSpecVersion
	err := ctx.RegisterResource("azurerm:resources/preview:TemplateSpecVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTemplateSpecVersion(ctx *pulumi.Context,
	...
	var resource TemplateSpecVersion
	err := ctx.ReadResource("azurerm:resources/preview:TemplateSpecVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
