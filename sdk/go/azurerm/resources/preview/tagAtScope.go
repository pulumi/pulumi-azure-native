...
func NewTagAtScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:resources/preview:TagAtScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagAtScope(ctx *pulumi.Context,
	...
	var resource TagAtScope
	err := ctx.ReadResource("azurerm:resources/preview:TagAtScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
