...
func NewDeploymentScript(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:resources/v20191001preview:DeploymentScript"),
		},
	})
	opts = append(opts, aliases)
	var resource DeploymentScript
	err := ctx.RegisterResource("azurerm:resources/preview:DeploymentScript", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentScript(ctx *pulumi.Context,
	...
	var resource DeploymentScript
	err := ctx.ReadResource("azurerm:resources/preview:DeploymentScript", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
