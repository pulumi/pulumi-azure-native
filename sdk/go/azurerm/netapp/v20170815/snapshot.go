...
//
// import (
// 	netapp "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/netapp/v20170815"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:netapp/v20170815:Snapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshot(ctx *pulumi.Context,
	...
	var resource Snapshot
	err := ctx.ReadResource("azurerm:netapp/v20170815:Snapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
