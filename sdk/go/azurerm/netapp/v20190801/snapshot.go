...
//
// import (
// 	netapp "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/netapp/v20190801"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewSnapshot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:netapp/v20190601:Snapshot"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:netapp/v20200201:Snapshot"),
		},
		{
			Type: pulumi.String("azurerm:netapp/v20200601:Snapshot"),
		},
	})
	opts = append(opts, aliases)
	var resource Snapshot
	err := ctx.RegisterResource("azurerm:netapp/v20190801:Snapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshot(ctx *pulumi.Context,
	...
	var resource Snapshot
	err := ctx.ReadResource("azurerm:netapp/v20190801:Snapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
