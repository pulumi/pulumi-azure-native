...
func NewBackupPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:netapp/preview:backupPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupPolicy(ctx *pulumi.Context,
	...
	var resource BackupPolicy
	err := ctx.ReadResource("azurerm:netapp/preview:backupPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
