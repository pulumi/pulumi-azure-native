...
func NewBackupPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:netapp/preview:backupPolicy"),
		},
		{
			Type: pulumi.String("azurerm:netapp/v20200601:backupPolicy"),
		},
	})
	opts = append(opts, aliases)
	var resource BackupPolicy
	err := ctx.RegisterResource("azurerm:netapp/latest:backupPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupPolicy(ctx *pulumi.Context,
	...
	var resource BackupPolicy
	err := ctx.ReadResource("azurerm:netapp/latest:backupPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
