...
func NewBackupSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storsimple:BackupSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupSchedule(ctx *pulumi.Context,
	...
	var resource BackupSchedule
	err := ctx.ReadResource("azurerm:storsimple:BackupSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
