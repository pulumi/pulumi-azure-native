...
func NewChapSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storsimple/preview:ChapSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetChapSetting(ctx *pulumi.Context,
	...
	var resource ChapSetting
	err := ctx.ReadResource("azurerm:storsimple/preview:ChapSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
