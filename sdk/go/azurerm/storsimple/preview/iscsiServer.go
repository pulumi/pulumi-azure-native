...
func NewIscsiServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storsimple/preview:IscsiServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIscsiServer(ctx *pulumi.Context,
	...
	var resource IscsiServer
	err := ctx.ReadResource("azurerm:storsimple/preview:IscsiServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
