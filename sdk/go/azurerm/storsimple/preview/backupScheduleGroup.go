...
func NewBackupScheduleGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:storsimple/v20161001:BackupScheduleGroup"),
		},
	})
	opts = append(opts, aliases)
	var resource BackupScheduleGroup
	err := ctx.RegisterResource("azurerm:storsimple/preview:BackupScheduleGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupScheduleGroup(ctx *pulumi.Context,
	...
	var resource BackupScheduleGroup
	err := ctx.ReadResource("azurerm:storsimple/preview:BackupScheduleGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
