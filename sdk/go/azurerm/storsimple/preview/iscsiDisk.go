...
func NewIscsiDisk(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storsimple/preview:IscsiDisk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIscsiDisk(ctx *pulumi.Context,
	...
	var resource IscsiDisk
	err := ctx.ReadResource("azurerm:storsimple/preview:IscsiDisk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
