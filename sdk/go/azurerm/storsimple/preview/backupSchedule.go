...
func NewBackupSchedule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:storsimple/v20170601:BackupSchedule"),
		},
	})
	opts = append(opts, aliases)
	var resource BackupSchedule
	err := ctx.RegisterResource("azurerm:storsimple/preview:BackupSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupSchedule(ctx *pulumi.Context,
	...
	var resource BackupSchedule
	err := ctx.ReadResource("azurerm:storsimple/preview:BackupSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
