...
func NewStorageDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storsimple/preview:StorageDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageDomain(ctx *pulumi.Context,
	...
	var resource StorageDomain
	err := ctx.ReadResource("azurerm:storsimple/preview:StorageDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
