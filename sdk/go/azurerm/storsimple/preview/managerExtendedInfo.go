...
func NewManagerExtendedInfo(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:storsimple/v20161001:ManagerExtendedInfo"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:storsimple/preview:ManagerExtendedInfo", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagerExtendedInfo(ctx *pulumi.Context,
	...
	var resource ManagerExtendedInfo
	err := ctx.ReadResource("azurerm:storsimple/preview:ManagerExtendedInfo", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
