...
// 			AccessControlRecordName: pulumi.String("AcrForSDKTest"),
...
func NewAccessControlRecord(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storsimple/v20161001:AccessControlRecord", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessControlRecord(ctx *pulumi.Context,
	...
	var resource AccessControlRecord
	err := ctx.ReadResource("azurerm:storsimple/v20161001:AccessControlRecord", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
