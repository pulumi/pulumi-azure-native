...
func NewManager(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storsimple/latest:Manager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManager(ctx *pulumi.Context,
	...
	var resource Manager
	err := ctx.ReadResource("azurerm:storsimple/latest:Manager", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
