...
func NewBackupScheduleGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storsimple/latest:BackupScheduleGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupScheduleGroup(ctx *pulumi.Context,
	...
	var resource BackupScheduleGroup
	err := ctx.ReadResource("azurerm:storsimple/latest:BackupScheduleGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
