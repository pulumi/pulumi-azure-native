...
func NewVolumeContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storsimple/latest:VolumeContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolumeContainer(ctx *pulumi.Context,
	...
	var resource VolumeContainer
	err := ctx.ReadResource("azurerm:storsimple/latest:VolumeContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
