...
func NewBandwidthSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storsimple/latest:BandwidthSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBandwidthSetting(ctx *pulumi.Context,
	...
	var resource BandwidthSetting
	err := ctx.ReadResource("azurerm:storsimple/latest:BandwidthSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
