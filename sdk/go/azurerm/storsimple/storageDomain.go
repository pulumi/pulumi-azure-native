...
func NewStorageDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storsimple:StorageDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageDomain(ctx *pulumi.Context,
	...
	var resource StorageDomain
	err := ctx.ReadResource("azurerm:storsimple:StorageDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
