...
func NewFileServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:storsimple:FileServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileServer(ctx *pulumi.Context,
	...
	var resource FileServer
	err := ctx.ReadResource("azurerm:storsimple:FileServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
