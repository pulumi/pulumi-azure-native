...
func NewConsole(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:portal/latest:Console", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsole(ctx *pulumi.Context,
	...
	var resource Console
	err := ctx.ReadResource("azurerm:portal/latest:Console", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
