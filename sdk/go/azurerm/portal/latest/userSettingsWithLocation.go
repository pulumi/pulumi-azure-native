...
func NewUserSettingsWithLocation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:portal/v20181001:UserSettingsWithLocation"),
		},
	})
	opts = append(opts, aliases)
	var resource UserSettingsWithLocation
	err := ctx.RegisterResource("azurerm:portal/latest:UserSettingsWithLocation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserSettingsWithLocation(ctx *pulumi.Context,
	...
	var resource UserSettingsWithLocation
	err := ctx.ReadResource("azurerm:portal/latest:UserSettingsWithLocation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
