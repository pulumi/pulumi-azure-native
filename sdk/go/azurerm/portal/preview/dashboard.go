...
func NewDashboard(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:portal/v20150801preview:Dashboard"),
		},
		{
			Type: pulumi.String("azurerm:portal/v20181001preview:Dashboard"),
		},
		{
			Type: pulumi.String("azurerm:portal/v20190101preview:Dashboard"),
		},
	})
	opts = append(opts, aliases)
	var resource Dashboard
	err := ctx.RegisterResource("azurerm:portal/preview:Dashboard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDashboard(ctx *pulumi.Context,
	...
	var resource Dashboard
	err := ctx.ReadResource("azurerm:portal/preview:Dashboard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
