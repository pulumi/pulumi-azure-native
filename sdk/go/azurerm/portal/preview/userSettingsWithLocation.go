...
func NewUserSettingsWithLocation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:portal/preview:UserSettingsWithLocation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserSettingsWithLocation(ctx *pulumi.Context,
	...
	var resource UserSettingsWithLocation
	err := ctx.ReadResource("azurerm:portal/preview:UserSettingsWithLocation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
