...
func NewConsoleWithLocation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:portal/v20181001:ConsoleWithLocation"),
		},
	})
	opts = append(opts, aliases)
	var resource ConsoleWithLocation
	err := ctx.RegisterResource("azurerm:portal/preview:ConsoleWithLocation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsoleWithLocation(ctx *pulumi.Context,
	...
	var resource ConsoleWithLocation
	err := ctx.ReadResource("azurerm:portal/preview:ConsoleWithLocation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
