...
func NewConsoleWithLocation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:portal:ConsoleWithLocation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsoleWithLocation(ctx *pulumi.Context,
	...
	var resource ConsoleWithLocation
	err := ctx.ReadResource("azurerm:portal:ConsoleWithLocation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
