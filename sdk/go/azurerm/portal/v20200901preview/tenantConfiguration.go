...
func NewTenantConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:portal/v20200901preview:TenantConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTenantConfiguration(ctx *pulumi.Context,
	...
	var resource TenantConfiguration
	err := ctx.ReadResource("azurerm:portal/v20200901preview:TenantConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
