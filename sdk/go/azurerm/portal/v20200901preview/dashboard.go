...
type Dashboard struct {
	...
	Lenses pulumi.MapArrayOutput `pulumi:"lenses"`
	// Resource location
...
func NewDashboard(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:portal/v20200901preview:Dashboard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDashboard(ctx *pulumi.Context,
	...
	var resource Dashboard
	err := ctx.ReadResource("azurerm:portal/v20200901preview:Dashboard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
