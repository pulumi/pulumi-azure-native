...
//
// import (
// 	portal "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/portal/v20190101preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func GetTenantConfiguration(ctx *pulumi.Context,
	...
	var resource TenantConfiguration
	err := ctx.ReadResource("azurerm:portal/v20190101preview:TenantConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
