...
// BandwidthSchedulePropertiesInput is an input type that accepts BandwidthSchedulePropertiesArgs and BandwidthSchedulePropertiesOutput values.
// You can construct a concrete instance of `BandwidthSchedulePropertiesInput` via:
//
//          BandwidthSchedulePropertiesArgs{...}
type BandwidthSchedulePropertiesInput interface {
	pulumi.Input

	ToBandwidthSchedulePropertiesOutput() BandwidthSchedulePropertiesOutput
	ToBandwidthSchedulePropertiesOutputWithContext(context.Context) BandwidthSchedulePropertiesOutput
}

// The properties of the bandwidth schedule.
type BandwidthSchedulePropertiesArgs struct {
	// The days of the week when this schedule is applicable.
...
func (BandwidthSchedulePropertiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*BandwidthScheduleProperties)(nil)).Elem()
}

func (i BandwidthSchedulePropertiesArgs) ToBandwidthSchedulePropertiesOutput() BandwidthSchedulePropertiesOutput {
	return i.ToBandwidthSchedulePropertiesOutputWithContext(context.Background())
}

func (i BandwidthSchedulePropertiesArgs) ToBandwidthSchedulePropertiesOutputWithContext(ctx context.Context) BandwidthSchedulePropertiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BandwidthSchedulePropertiesOutput)
}

func (i BandwidthSchedulePropertiesArgs) ToBandwidthSchedulePropertiesPtrOutput() BandwidthSchedulePropertiesPtrOutput {
	return i.ToBandwidthSchedulePropertiesPtrOutputWithContext(context.Background())
}

func (i BandwidthSchedulePropertiesArgs) ToBandwidthSchedulePropertiesPtrOutputWithContext(ctx context.Context) BandwidthSchedulePropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BandwidthSchedulePropertiesOutput).ToBandwidthSchedulePropertiesPtrOutputWithContext(ctx)
}

// BandwidthSchedulePropertiesPtrInput is an input type that accepts BandwidthSchedulePropertiesArgs, BandwidthSchedulePropertiesPtr and BandwidthSchedulePropertiesPtrOutput values.
// You can construct a concrete instance of `BandwidthSchedulePropertiesPtrInput` via:
//
//          BandwidthSchedulePropertiesArgs{...}
//
//  or:
//
//          nil
type BandwidthSchedulePropertiesPtrInput interface {
	pulumi.Input

	ToBandwidthSchedulePropertiesPtrOutput() BandwidthSchedulePropertiesPtrOutput
	ToBandwidthSchedulePropertiesPtrOutputWithContext(context.Context) BandwidthSchedulePropertiesPtrOutput
}

type bandwidthSchedulePropertiesPtrType BandwidthSchedulePropertiesArgs

func BandwidthSchedulePropertiesPtr(v *BandwidthSchedulePropertiesArgs) BandwidthSchedulePropertiesPtrInput {
	return (*bandwidthSchedulePropertiesPtrType)(v)
}

func (*bandwidthSchedulePropertiesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**BandwidthScheduleProperties)(nil)).Elem()
}

func (i *bandwidthSchedulePropertiesPtrType) ToBandwidthSchedulePropertiesPtrOutput() BandwidthSchedulePropertiesPtrOutput {
	return i.ToBandwidthSchedulePropertiesPtrOutputWithContext(context.Background())
}

func (i *bandwidthSchedulePropertiesPtrType) ToBandwidthSchedulePropertiesPtrOutputWithContext(ctx context.Context) BandwidthSchedulePropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BandwidthSchedulePropertiesPtrOutput)
}

// The properties of the bandwidth schedule.
type BandwidthSchedulePropertiesOutput struct{ *pulumi.OutputState }

func (BandwidthSchedulePropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*BandwidthScheduleProperties)(nil)).Elem()
}

func (o BandwidthSchedulePropertiesOutput) ToBandwidthSchedulePropertiesOutput() BandwidthSchedulePropertiesOutput {
	return o
}

func (o BandwidthSchedulePropertiesOutput) ToBandwidthSchedulePropertiesOutputWithContext(ctx context.Context) BandwidthSchedulePropertiesOutput {
	return o
}

func (o BandwidthSchedulePropertiesOutput) ToBandwidthSchedulePropertiesPtrOutput() BandwidthSchedulePropertiesPtrOutput {
	return o.ToBandwidthSchedulePropertiesPtrOutputWithContext(context.Background())
}

func (o BandwidthSchedulePropertiesOutput) ToBandwidthSchedulePropertiesPtrOutputWithContext(ctx context.Context) BandwidthSchedulePropertiesPtrOutput {
	return o.ApplyT(func(v BandwidthScheduleProperties) *BandwidthScheduleProperties {
		return &v
	}).(BandwidthSchedulePropertiesPtrOutput)
}

// The days of the week when this schedule is applicable.
func (o BandwidthSchedulePropertiesOutput) Days() pulumi.StringArrayOutput {
	return o.ApplyT(func(v BandwidthScheduleProperties) []string { return v.Days }).(pulumi.StringArrayOutput)
}

// The bandwidth rate in Mbps.
func (o BandwidthSchedulePropertiesOutput) RateInMbps() pulumi.IntOutput {
	return o.ApplyT(func(v BandwidthScheduleProperties) int { return v.RateInMbps }).(pulumi.IntOutput)
}

// The start time of the schedule in UTC.
func (o BandwidthSchedulePropertiesOutput) Start() pulumi.StringOutput {
	return o.ApplyT(func(v BandwidthScheduleProperties) string { return v.Start }).(pulumi.StringOutput)
}

// The stop time of the schedule in UTC.
func (o BandwidthSchedulePropertiesOutput) Stop() pulumi.StringOutput {
	return o.ApplyT(func(v BandwidthScheduleProperties) string { return v.Stop }).(pulumi.StringOutput)
}

type BandwidthSchedulePropertiesPtrOutput struct{ *pulumi.OutputState }

func (BandwidthSchedulePropertiesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**BandwidthScheduleProperties)(nil)).Elem()
}

func (o BandwidthSchedulePropertiesPtrOutput) ToBandwidthSchedulePropertiesPtrOutput() BandwidthSchedulePropertiesPtrOutput {
	return o
}

func (o BandwidthSchedulePropertiesPtrOutput) ToBandwidthSchedulePropertiesPtrOutputWithContext(ctx context.Context) BandwidthSchedulePropertiesPtrOutput {
	return o
}

func (o BandwidthSchedulePropertiesPtrOutput) Elem() BandwidthSchedulePropertiesOutput {
	return o.ApplyT(func(v *BandwidthScheduleProperties) BandwidthScheduleProperties { return *v }).(BandwidthSchedulePropertiesOutput)
}

// The days of the week when this schedule is applicable.
func (o BandwidthSchedulePropertiesPtrOutput) Days() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *BandwidthScheduleProperties) []string {
		if v == nil {
			return nil
		}
		return v.Days
...
// The bandwidth rate in Mbps.
func (o BandwidthSchedulePropertiesPtrOutput) RateInMbps() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *BandwidthScheduleProperties) *int {
		if v == nil {
			return nil
		}
		return &v.RateInMbps
...
// The start time of the schedule in UTC.
func (o BandwidthSchedulePropertiesPtrOutput) Start() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *BandwidthScheduleProperties) *string {
		if v == nil {
			return nil
		}
...
// The stop time of the schedule in UTC.
func (o BandwidthSchedulePropertiesPtrOutput) Stop() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *BandwidthScheduleProperties) *string {
		if v == nil {
			return nil
		}
...
// DataBoxEdgeDevicePropertiesInput is an input type that accepts DataBoxEdgeDevicePropertiesArgs and DataBoxEdgeDevicePropertiesOutput values.
// You can construct a concrete instance of `DataBoxEdgeDevicePropertiesInput` via:
//
//          DataBoxEdgeDevicePropertiesArgs{...}
type DataBoxEdgeDevicePropertiesInput interface {
	pulumi.Input

	ToDataBoxEdgeDevicePropertiesOutput() DataBoxEdgeDevicePropertiesOutput
	ToDataBoxEdgeDevicePropertiesOutputWithContext(context.Context) DataBoxEdgeDevicePropertiesOutput
}

// The properties of the Data Box Edge/Gateway device.
type DataBoxEdgeDevicePropertiesArgs struct {
	// The status of the Data Box Edge/Gateway device.
...
func (DataBoxEdgeDevicePropertiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*DataBoxEdgeDeviceProperties)(nil)).Elem()
}

func (i DataBoxEdgeDevicePropertiesArgs) ToDataBoxEdgeDevicePropertiesOutput() DataBoxEdgeDevicePropertiesOutput {
	return i.ToDataBoxEdgeDevicePropertiesOutputWithContext(context.Background())
}

func (i DataBoxEdgeDevicePropertiesArgs) ToDataBoxEdgeDevicePropertiesOutputWithContext(ctx context.Context) DataBoxEdgeDevicePropertiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataBoxEdgeDevicePropertiesOutput)
}

func (i DataBoxEdgeDevicePropertiesArgs) ToDataBoxEdgeDevicePropertiesPtrOutput() DataBoxEdgeDevicePropertiesPtrOutput {
	return i.ToDataBoxEdgeDevicePropertiesPtrOutputWithContext(context.Background())
}

func (i DataBoxEdgeDevicePropertiesArgs) ToDataBoxEdgeDevicePropertiesPtrOutputWithContext(ctx context.Context) DataBoxEdgeDevicePropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataBoxEdgeDevicePropertiesOutput).ToDataBoxEdgeDevicePropertiesPtrOutputWithContext(ctx)
}

// DataBoxEdgeDevicePropertiesPtrInput is an input type that accepts DataBoxEdgeDevicePropertiesArgs, DataBoxEdgeDevicePropertiesPtr and DataBoxEdgeDevicePropertiesPtrOutput values.
// You can construct a concrete instance of `DataBoxEdgeDevicePropertiesPtrInput` via:
//
//          DataBoxEdgeDevicePropertiesArgs{...}
//
//  or:
//
//          nil
type DataBoxEdgeDevicePropertiesPtrInput interface {
	pulumi.Input

	ToDataBoxEdgeDevicePropertiesPtrOutput() DataBoxEdgeDevicePropertiesPtrOutput
	ToDataBoxEdgeDevicePropertiesPtrOutputWithContext(context.Context) DataBoxEdgeDevicePropertiesPtrOutput
}

type dataBoxEdgeDevicePropertiesPtrType DataBoxEdgeDevicePropertiesArgs

func DataBoxEdgeDevicePropertiesPtr(v *DataBoxEdgeDevicePropertiesArgs) DataBoxEdgeDevicePropertiesPtrInput {
	return (*dataBoxEdgeDevicePropertiesPtrType)(v)
}

func (*dataBoxEdgeDevicePropertiesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**DataBoxEdgeDeviceProperties)(nil)).Elem()
}

func (i *dataBoxEdgeDevicePropertiesPtrType) ToDataBoxEdgeDevicePropertiesPtrOutput() DataBoxEdgeDevicePropertiesPtrOutput {
	return i.ToDataBoxEdgeDevicePropertiesPtrOutputWithContext(context.Background())
}

func (i *dataBoxEdgeDevicePropertiesPtrType) ToDataBoxEdgeDevicePropertiesPtrOutputWithContext(ctx context.Context) DataBoxEdgeDevicePropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataBoxEdgeDevicePropertiesPtrOutput)
}

// The properties of the Data Box Edge/Gateway device.
type DataBoxEdgeDevicePropertiesOutput struct{ *pulumi.OutputState }

func (DataBoxEdgeDevicePropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DataBoxEdgeDeviceProperties)(nil)).Elem()
}

func (o DataBoxEdgeDevicePropertiesOutput) ToDataBoxEdgeDevicePropertiesOutput() DataBoxEdgeDevicePropertiesOutput {
	return o
}

func (o DataBoxEdgeDevicePropertiesOutput) ToDataBoxEdgeDevicePropertiesOutputWithContext(ctx context.Context) DataBoxEdgeDevicePropertiesOutput {
	return o
}

func (o DataBoxEdgeDevicePropertiesOutput) ToDataBoxEdgeDevicePropertiesPtrOutput() DataBoxEdgeDevicePropertiesPtrOutput {
	return o.ToDataBoxEdgeDevicePropertiesPtrOutputWithContext(context.Background())
}

func (o DataBoxEdgeDevicePropertiesOutput) ToDataBoxEdgeDevicePropertiesPtrOutputWithContext(ctx context.Context) DataBoxEdgeDevicePropertiesPtrOutput {
	return o.ApplyT(func(v DataBoxEdgeDeviceProperties) *DataBoxEdgeDeviceProperties {
		return &v
	}).(DataBoxEdgeDevicePropertiesPtrOutput)
}

// The status of the Data Box Edge/Gateway device.
func (o DataBoxEdgeDevicePropertiesOutput) DataBoxEdgeDeviceStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DataBoxEdgeDeviceProperties) *string { return v.DataBoxEdgeDeviceStatus }).(pulumi.StringPtrOutput)
}

// The Description of the Data Box Edge/Gateway device.
func (o DataBoxEdgeDevicePropertiesOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DataBoxEdgeDeviceProperties) *string { return v.Description }).(pulumi.StringPtrOutput)
}

// The Data Box Edge/Gateway device name.
func (o DataBoxEdgeDevicePropertiesOutput) FriendlyName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DataBoxEdgeDeviceProperties) *string { return v.FriendlyName }).(pulumi.StringPtrOutput)
}

// The description of the Data Box Edge/Gateway device model.
func (o DataBoxEdgeDevicePropertiesOutput) ModelDescription() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DataBoxEdgeDeviceProperties) *string { return v.ModelDescription }).(pulumi.StringPtrOutput)
}

type DataBoxEdgeDevicePropertiesPtrOutput struct{ *pulumi.OutputState }

func (DataBoxEdgeDevicePropertiesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DataBoxEdgeDeviceProperties)(nil)).Elem()
}

func (o DataBoxEdgeDevicePropertiesPtrOutput) ToDataBoxEdgeDevicePropertiesPtrOutput() DataBoxEdgeDevicePropertiesPtrOutput {
	return o
}

func (o DataBoxEdgeDevicePropertiesPtrOutput) ToDataBoxEdgeDevicePropertiesPtrOutputWithContext(ctx context.Context) DataBoxEdgeDevicePropertiesPtrOutput {
	return o
}

func (o DataBoxEdgeDevicePropertiesPtrOutput) Elem() DataBoxEdgeDevicePropertiesOutput {
	return o.ApplyT(func(v *DataBoxEdgeDeviceProperties) DataBoxEdgeDeviceProperties { return *v }).(DataBoxEdgeDevicePropertiesOutput)
}

// The status of the Data Box Edge/Gateway device.
func (o DataBoxEdgeDevicePropertiesPtrOutput) DataBoxEdgeDeviceStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DataBoxEdgeDeviceProperties) *string {
		if v == nil {
			return nil
		}
...
// The Description of the Data Box Edge/Gateway device.
func (o DataBoxEdgeDevicePropertiesPtrOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DataBoxEdgeDeviceProperties) *string {
		if v == nil {
			return nil
		}
...
// The Data Box Edge/Gateway device name.
func (o DataBoxEdgeDevicePropertiesPtrOutput) FriendlyName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DataBoxEdgeDeviceProperties) *string {
		if v == nil {
			return nil
		}
...
// The description of the Data Box Edge/Gateway device model.
func (o DataBoxEdgeDevicePropertiesPtrOutput) ModelDescription() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DataBoxEdgeDeviceProperties) *string {
		if v == nil {
			return nil
		}
...
// OrderPropertiesInput is an input type that accepts OrderPropertiesArgs and OrderPropertiesOutput values.
// You can construct a concrete instance of `OrderPropertiesInput` via:
//
//          OrderPropertiesArgs{...}
type OrderPropertiesInput interface {
	pulumi.Input

	ToOrderPropertiesOutput() OrderPropertiesOutput
	ToOrderPropertiesOutputWithContext(context.Context) OrderPropertiesOutput
}

// Order properties.
type OrderPropertiesArgs struct {
	// The contact details.
	ContactInformation ContactDetailsInput `pulumi:"contactInformation"`
	// Current status of the order.
	CurrentStatus OrderStatusPtrInput `pulumi:"currentStatus"`
	// The shipping address.
	ShippingAddress AddressInput `pulumi:"shippingAddress"`
}

func (OrderPropertiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*OrderProperties)(nil)).Elem()
}

func (i OrderPropertiesArgs) ToOrderPropertiesOutput() OrderPropertiesOutput {
	return i.ToOrderPropertiesOutputWithContext(context.Background())
}

func (i OrderPropertiesArgs) ToOrderPropertiesOutputWithContext(ctx context.Context) OrderPropertiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OrderPropertiesOutput)
}

func (i OrderPropertiesArgs) ToOrderPropertiesPtrOutput() OrderPropertiesPtrOutput {
	return i.ToOrderPropertiesPtrOutputWithContext(context.Background())
}

func (i OrderPropertiesArgs) ToOrderPropertiesPtrOutputWithContext(ctx context.Context) OrderPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OrderPropertiesOutput).ToOrderPropertiesPtrOutputWithContext(ctx)
}

// OrderPropertiesPtrInput is an input type that accepts OrderPropertiesArgs, OrderPropertiesPtr and OrderPropertiesPtrOutput values.
// You can construct a concrete instance of `OrderPropertiesPtrInput` via:
//
//          OrderPropertiesArgs{...}
//
//  or:
//
//          nil
type OrderPropertiesPtrInput interface {
	pulumi.Input

	ToOrderPropertiesPtrOutput() OrderPropertiesPtrOutput
	ToOrderPropertiesPtrOutputWithContext(context.Context) OrderPropertiesPtrOutput
}

type orderPropertiesPtrType OrderPropertiesArgs

func OrderPropertiesPtr(v *OrderPropertiesArgs) OrderPropertiesPtrInput {
	return (*orderPropertiesPtrType)(v)
}

func (*orderPropertiesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**OrderProperties)(nil)).Elem()
}

func (i *orderPropertiesPtrType) ToOrderPropertiesPtrOutput() OrderPropertiesPtrOutput {
	return i.ToOrderPropertiesPtrOutputWithContext(context.Background())
}

func (i *orderPropertiesPtrType) ToOrderPropertiesPtrOutputWithContext(ctx context.Context) OrderPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OrderPropertiesPtrOutput)
}

// Order properties.
type OrderPropertiesOutput struct{ *pulumi.OutputState }

func (OrderPropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*OrderProperties)(nil)).Elem()
}

func (o OrderPropertiesOutput) ToOrderPropertiesOutput() OrderPropertiesOutput {
	return o
}

func (o OrderPropertiesOutput) ToOrderPropertiesOutputWithContext(ctx context.Context) OrderPropertiesOutput {
	return o
}

func (o OrderPropertiesOutput) ToOrderPropertiesPtrOutput() OrderPropertiesPtrOutput {
	return o.ToOrderPropertiesPtrOutputWithContext(context.Background())
}

func (o OrderPropertiesOutput) ToOrderPropertiesPtrOutputWithContext(ctx context.Context) OrderPropertiesPtrOutput {
	return o.ApplyT(func(v OrderProperties) *OrderProperties {
		return &v
	}).(OrderPropertiesPtrOutput)
}

// The contact details.
func (o OrderPropertiesOutput) ContactInformation() ContactDetailsOutput {
	return o.ApplyT(func(v OrderProperties) ContactDetails { return v.ContactInformation }).(ContactDetailsOutput)
}

// Current status of the order.
func (o OrderPropertiesOutput) CurrentStatus() OrderStatusPtrOutput {
	return o.ApplyT(func(v OrderProperties) *OrderStatus { return v.CurrentStatus }).(OrderStatusPtrOutput)
}

// The shipping address.
func (o OrderPropertiesOutput) ShippingAddress() AddressOutput {
	return o.ApplyT(func(v OrderProperties) Address { return v.ShippingAddress }).(AddressOutput)
}

type OrderPropertiesPtrOutput struct{ *pulumi.OutputState }

func (OrderPropertiesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**OrderProperties)(nil)).Elem()
}

func (o OrderPropertiesPtrOutput) ToOrderPropertiesPtrOutput() OrderPropertiesPtrOutput {
	return o
}

func (o OrderPropertiesPtrOutput) ToOrderPropertiesPtrOutputWithContext(ctx context.Context) OrderPropertiesPtrOutput {
	return o
}

func (o OrderPropertiesPtrOutput) Elem() OrderPropertiesOutput {
	return o.ApplyT(func(v *OrderProperties) OrderProperties { return *v }).(OrderPropertiesOutput)
}

// The contact details.
func (o OrderPropertiesPtrOutput) ContactInformation() ContactDetailsPtrOutput {
	return o.ApplyT(func(v *OrderProperties) *ContactDetails {
		if v == nil {
			return nil
		}
...
// Current status of the order.
func (o OrderPropertiesPtrOutput) CurrentStatus() OrderStatusPtrOutput {
	return o.ApplyT(func(v *OrderProperties) *OrderStatus {
		if v == nil {
			return nil
		}
...
// The shipping address.
func (o OrderPropertiesPtrOutput) ShippingAddress() AddressPtrOutput {
	return o.ApplyT(func(v *OrderProperties) *Address {
		if v == nil {
			return nil
		}
...
type SharePropertiesArgs struct {
	...
	// Azure container mapping for the share.
	AzureContainerInfo AzureContainerInfoPtrInput `pulumi:"azureContainerInfo"`
	// List of IP addresses and corresponding access rights on the share(required for NFS protocol).
	ClientAccessRights ClientAccessRightArrayInput `pulumi:"clientAccessRights"`
	// Data policy of the share.
	...
	// Details of the refresh job on this share.
	RefreshDetails RefreshDetailsPtrInput `pulumi:"refreshDetails"`
	// Current status of the share.
	ShareStatus pulumi.StringInput `pulumi:"shareStatus"`
	// Mapping of users and corresponding access rights on the share (required for SMB protocol).
	UserAccessRights UserAccessRightArrayInput `pulumi:"userAccessRights"`
}
...
// Access protocol to be used by the share.
func (o SharePropertiesOutput) AccessProtocol() pulumi.StringOutput {
	return o.ApplyT(func(v ShareProperties) string { return v.AccessProtocol }).(pulumi.StringOutput)
}

// Azure container mapping for the share.
func (o SharePropertiesOutput) AzureContainerInfo() AzureContainerInfoPtrOutput {
	return o.ApplyT(func(v ShareProperties) *AzureContainerInfo { return v.AzureContainerInfo }).(AzureContainerInfoPtrOutput)
}

// List of IP addresses and corresponding access rights on the share(required for NFS protocol).
func (o SharePropertiesOutput) ClientAccessRights() ClientAccessRightArrayOutput {
	return o.ApplyT(func(v ShareProperties) []ClientAccessRight { return v.ClientAccessRights }).(ClientAccessRightArrayOutput)
}

// Data policy of the share.
func (o SharePropertiesOutput) DataPolicy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ShareProperties) *string { return v.DataPolicy }).(pulumi.StringPtrOutput)
}
...
// Current monitoring status of the share.
func (o SharePropertiesOutput) MonitoringStatus() pulumi.StringOutput {
	return o.ApplyT(func(v ShareProperties) string { return v.MonitoringStatus }).(pulumi.StringOutput)
}

// Details of the refresh job on this share.
func (o SharePropertiesOutput) RefreshDetails() RefreshDetailsPtrOutput {
	return o.ApplyT(func(v ShareProperties) *RefreshDetails { return v.RefreshDetails }).(RefreshDetailsPtrOutput)
}

// Current status of the share.
func (o SharePropertiesOutput) ShareStatus() pulumi.StringOutput {
	return o.ApplyT(func(v ShareProperties) string { return v.ShareStatus }).(pulumi.StringOutput)
}

// Mapping of users and corresponding access rights on the share (required for SMB protocol).
func (o SharePropertiesOutput) UserAccessRights() UserAccessRightArrayOutput {
	return o.ApplyT(func(v ShareProperties) []UserAccessRight { return v.UserAccessRights }).(UserAccessRightArrayOutput)
}
...
// Access protocol to be used by the share.
func (o SharePropertiesPtrOutput) AccessProtocol() pulumi.StringPtrOutput {
...
// Azure container mapping for the share.
func (o SharePropertiesPtrOutput) AzureContainerInfo() AzureContainerInfoPtrOutput {
	return o.ApplyT(func(v *ShareProperties) *AzureContainerInfo {
		if v == nil {
			return nil
		}
...
// List of IP addresses and corresponding access rights on the share(required for NFS protocol).
func (o SharePropertiesPtrOutput) ClientAccessRights() ClientAccessRightArrayOutput {
	return o.ApplyT(func(v *ShareProperties) []ClientAccessRight {
		if v == nil {
			return nil
		}
		return v.ClientAccessRights
	}).(ClientAccessRightArrayOutput)
}

// Data policy of the share.
func (o SharePropertiesPtrOutput) DataPolicy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ShareProperties) *string {
		if v == nil {
			return nil
		}
...
// Current monitoring status of the share.
func (o SharePropertiesPtrOutput) MonitoringStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ShareProperties) *string {
		if v == nil {
			return nil
		}
...
// Details of the refresh job on this share.
func (o SharePropertiesPtrOutput) RefreshDetails() RefreshDetailsPtrOutput {
	return o.ApplyT(func(v *ShareProperties) *RefreshDetails {
		if v == nil {
			return nil
		}
...
// Current status of the share.
func (o SharePropertiesPtrOutput) ShareStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ShareProperties) *string {
		if v == nil {
			return nil
		}
...
// Mapping of users and corresponding access rights on the share (required for SMB protocol).
func (o SharePropertiesPtrOutput) UserAccessRights() UserAccessRightArrayOutput {
	return o.ApplyT(func(v *ShareProperties) []UserAccessRight {
		if v == nil {
			return nil
		}
		return v.UserAccessRights
	}).(UserAccessRightArrayOutput)
}
...
type StorageAccountCredentialPropertiesArgs struct {
	// Encrypted storage key.
	AccountKey AsymmetricEncryptedSecretPtrInput `pulumi:"accountKey"`
	// Type of storage accessed on the storage account.
...
// Encrypted storage key.
func (o StorageAccountCredentialPropertiesOutput) AccountKey() AsymmetricEncryptedSecretPtrOutput {
	return o.ApplyT(func(v StorageAccountCredentialProperties) *AsymmetricEncryptedSecret { return v.AccountKey }).(AsymmetricEncryptedSecretPtrOutput)
}

// Type of storage accessed on the storage account.
func (o StorageAccountCredentialPropertiesOutput) AccountType() pulumi.StringOutput {
	return o.ApplyT(func(v StorageAccountCredentialProperties) string { return v.AccountType }).(pulumi.StringOutput)
}

// Alias for the storage account.
func (o StorageAccountCredentialPropertiesOutput) Alias() pulumi.StringOutput {
	return o.ApplyT(func(v StorageAccountCredentialProperties) string { return v.Alias }).(pulumi.StringOutput)
}

// Blob end point for private clouds.
func (o StorageAccountCredentialPropertiesOutput) BlobDomainName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v StorageAccountCredentialProperties) *string { return v.BlobDomainName }).(pulumi.StringPtrOutput)
}

// Connection string for the storage account. Use this string if username and account key are not specified.
func (o StorageAccountCredentialPropertiesOutput) ConnectionString() pulumi.StringPtrOutput {
	return o.ApplyT(func(v StorageAccountCredentialProperties) *string { return v.ConnectionString }).(pulumi.StringPtrOutput)
}
...
// Username for the storage account.
func (o StorageAccountCredentialPropertiesOutput) UserName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v StorageAccountCredentialProperties) *string { return v.UserName }).(pulumi.StringPtrOutput)
}
...
// Encrypted storage key.
func (o StorageAccountCredentialPropertiesPtrOutput) AccountKey() AsymmetricEncryptedSecretPtrOutput {
...
// Type of storage accessed on the storage account.
func (o StorageAccountCredentialPropertiesPtrOutput) AccountType() pulumi.StringPtrOutput {
...
// Alias for the storage account.
func (o StorageAccountCredentialPropertiesPtrOutput) Alias() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StorageAccountCredentialProperties) *string {
		if v == nil {
			return nil
		}
...
// Blob end point for private clouds.
func (o StorageAccountCredentialPropertiesPtrOutput) BlobDomainName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StorageAccountCredentialProperties) *string {
		if v == nil {
			return nil
		}
...
// Connection string for the storage account. Use this string if username and account key are not specified.
func (o StorageAccountCredentialPropertiesPtrOutput) ConnectionString() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StorageAccountCredentialProperties) *string {
		if v == nil {
			return nil
		}
...
// Username for the storage account.
func (o StorageAccountCredentialPropertiesPtrOutput) UserName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StorageAccountCredentialProperties) *string {
		if v == nil {
			return nil
		}
...
type UserPropertiesArgs struct {
	// The password details.
	EncryptedPassword AsymmetricEncryptedSecretPtrInput `pulumi:"encryptedPassword"`
	// List of shares that the user has rights on. This field should not be specified during user creation.
	ShareAccessRights ShareAccessRightArrayInput `pulumi:"shareAccessRights"`
}
...
// The password details.
func (o UserPropertiesOutput) EncryptedPassword() AsymmetricEncryptedSecretPtrOutput {
	return o.ApplyT(func(v UserProperties) *AsymmetricEncryptedSecret { return v.EncryptedPassword }).(AsymmetricEncryptedSecretPtrOutput)
}

// List of shares that the user has rights on. This field should not be specified during user creation.
func (o UserPropertiesOutput) ShareAccessRights() ShareAccessRightArrayOutput {
	return o.ApplyT(func(v UserProperties) []ShareAccessRight { return v.ShareAccessRights }).(ShareAccessRightArrayOutput)
}
...
// The password details.
func (o UserPropertiesPtrOutput) EncryptedPassword() AsymmetricEncryptedSecretPtrOutput {
	return o.ApplyT(func(v *UserProperties) *AsymmetricEncryptedSecret {
		if v == nil {
			return nil
		}
...
// List of shares that the user has rights on. This field should not be specified during user creation.
func (o UserPropertiesPtrOutput) ShareAccessRights() ShareAccessRightArrayOutput {
	return o.ApplyT(func(v *UserProperties) []ShareAccessRight {
		if v == nil {
			return nil
		}
		return v.ShareAccessRights
	}).(ShareAccessRightArrayOutput)
}
