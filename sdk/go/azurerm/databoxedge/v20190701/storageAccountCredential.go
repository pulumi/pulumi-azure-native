...
func NewStorageAccountCredential(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:databoxedge/v20190701:StorageAccountCredential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageAccountCredential(ctx *pulumi.Context,
	...
	var resource StorageAccountCredential
	err := ctx.ReadResource("azurerm:databoxedge/v20190701:StorageAccountCredential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
