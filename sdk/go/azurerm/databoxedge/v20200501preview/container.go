...
func NewContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:databoxedge/v20200501preview:Container", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainer(ctx *pulumi.Context,
	...
	var resource Container
	err := ctx.ReadResource("azurerm:databoxedge/v20200501preview:Container", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
