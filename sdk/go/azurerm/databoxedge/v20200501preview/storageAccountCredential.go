...
func NewStorageAccountCredential(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:databoxedge/v20200501preview:StorageAccountCredential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageAccountCredential(ctx *pulumi.Context,
	...
	var resource StorageAccountCredential
	err := ctx.ReadResource("azurerm:databoxedge/v20200501preview:StorageAccountCredential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
