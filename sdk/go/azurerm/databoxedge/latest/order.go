...
func NewOrder(ctx *pulumi.Context,
	...
	var resource Order
	err := ctx.RegisterResource("azurerm:databoxedge/latest:Order", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrder(ctx *pulumi.Context,
	...
	var resource Order
	err := ctx.ReadResource("azurerm:databoxedge/latest:Order", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
