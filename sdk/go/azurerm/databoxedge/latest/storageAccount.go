...
func NewStorageAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:databoxedge/latest:StorageAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageAccount(ctx *pulumi.Context,
	...
	var resource StorageAccount
	err := ctx.ReadResource("azurerm:databoxedge/latest:StorageAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
