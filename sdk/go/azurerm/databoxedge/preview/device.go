...
func NewDevice(ctx *pulumi.Context,
	...
	var resource Device
	err := ctx.RegisterResource("azurerm:databoxedge/preview:Device", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevice(ctx *pulumi.Context,
	...
	var resource Device
	err := ctx.ReadResource("azurerm:databoxedge/preview:Device", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
