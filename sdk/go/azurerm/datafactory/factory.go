...
func NewFactory(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datafactory:Factory", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFactory(ctx *pulumi.Context,
	...
	var resource Factory
	err := ctx.ReadResource("azurerm:datafactory:Factory", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
