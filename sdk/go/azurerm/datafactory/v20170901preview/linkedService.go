...
func NewLinkedService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datafactory/v20170901preview:LinkedService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedService(ctx *pulumi.Context,
	...
	var resource LinkedService
	err := ctx.ReadResource("azurerm:datafactory/v20170901preview:LinkedService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
