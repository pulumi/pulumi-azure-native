...
func NewIntegrationRuntime(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datafactory:IntegrationRuntime", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationRuntime(ctx *pulumi.Context,
	...
	var resource IntegrationRuntime
	err := ctx.ReadResource("azurerm:datafactory:IntegrationRuntime", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
