...
// FactoryPropertiesInput is an input type that accepts FactoryPropertiesArgs and FactoryPropertiesOutput values.
// You can construct a concrete instance of `FactoryPropertiesInput` via:
//
//          FactoryPropertiesArgs{...}
type FactoryPropertiesInput interface {
	pulumi.Input

	ToFactoryPropertiesOutput() FactoryPropertiesOutput
	ToFactoryPropertiesOutputWithContext(context.Context) FactoryPropertiesOutput
}

// Factory resource properties.
type FactoryPropertiesArgs struct {
	// List of parameters for factory.
	GlobalParameters GlobalParameterDefinitionSpecificationPtrInput `pulumi:"globalParameters"`
	// Git repo information of the factory.
	RepoConfiguration FactoryRepoConfigurationPtrInput `pulumi:"repoConfiguration"`
}

func (FactoryPropertiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*FactoryProperties)(nil)).Elem()
}

func (i FactoryPropertiesArgs) ToFactoryPropertiesOutput() FactoryPropertiesOutput {
	return i.ToFactoryPropertiesOutputWithContext(context.Background())
}

func (i FactoryPropertiesArgs) ToFactoryPropertiesOutputWithContext(ctx context.Context) FactoryPropertiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FactoryPropertiesOutput)
}

func (i FactoryPropertiesArgs) ToFactoryPropertiesPtrOutput() FactoryPropertiesPtrOutput {
	return i.ToFactoryPropertiesPtrOutputWithContext(context.Background())
}

func (i FactoryPropertiesArgs) ToFactoryPropertiesPtrOutputWithContext(ctx context.Context) FactoryPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FactoryPropertiesOutput).ToFactoryPropertiesPtrOutputWithContext(ctx)
}

// FactoryPropertiesPtrInput is an input type that accepts FactoryPropertiesArgs, FactoryPropertiesPtr and FactoryPropertiesPtrOutput values.
// You can construct a concrete instance of `FactoryPropertiesPtrInput` via:
//
//          FactoryPropertiesArgs{...}
//
//  or:
//
//          nil
type FactoryPropertiesPtrInput interface {
	pulumi.Input

	ToFactoryPropertiesPtrOutput() FactoryPropertiesPtrOutput
	ToFactoryPropertiesPtrOutputWithContext(context.Context) FactoryPropertiesPtrOutput
}

type factoryPropertiesPtrType FactoryPropertiesArgs

func FactoryPropertiesPtr(v *FactoryPropertiesArgs) FactoryPropertiesPtrInput {
	return (*factoryPropertiesPtrType)(v)
}

func (*factoryPropertiesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**FactoryProperties)(nil)).Elem()
}

func (i *factoryPropertiesPtrType) ToFactoryPropertiesPtrOutput() FactoryPropertiesPtrOutput {
	return i.ToFactoryPropertiesPtrOutputWithContext(context.Background())
}

func (i *factoryPropertiesPtrType) ToFactoryPropertiesPtrOutputWithContext(ctx context.Context) FactoryPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FactoryPropertiesPtrOutput)
}

// Factory resource properties.
type FactoryPropertiesOutput struct{ *pulumi.OutputState }

func (FactoryPropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*FactoryProperties)(nil)).Elem()
}

func (o FactoryPropertiesOutput) ToFactoryPropertiesOutput() FactoryPropertiesOutput {
	return o
}

func (o FactoryPropertiesOutput) ToFactoryPropertiesOutputWithContext(ctx context.Context) FactoryPropertiesOutput {
	return o
}

func (o FactoryPropertiesOutput) ToFactoryPropertiesPtrOutput() FactoryPropertiesPtrOutput {
	return o.ToFactoryPropertiesPtrOutputWithContext(context.Background())
}

func (o FactoryPropertiesOutput) ToFactoryPropertiesPtrOutputWithContext(ctx context.Context) FactoryPropertiesPtrOutput {
	return o.ApplyT(func(v FactoryProperties) *FactoryProperties {
		return &v
	}).(FactoryPropertiesPtrOutput)
}

// List of parameters for factory.
func (o FactoryPropertiesOutput) GlobalParameters() GlobalParameterDefinitionSpecificationPtrOutput {
	return o.ApplyT(func(v FactoryProperties) *GlobalParameterDefinitionSpecification { return v.GlobalParameters }).(GlobalParameterDefinitionSpecificationPtrOutput)
}

// Git repo information of the factory.
func (o FactoryPropertiesOutput) RepoConfiguration() FactoryRepoConfigurationPtrOutput {
	return o.ApplyT(func(v FactoryProperties) *FactoryRepoConfiguration { return v.RepoConfiguration }).(FactoryRepoConfigurationPtrOutput)
}

type FactoryPropertiesPtrOutput struct{ *pulumi.OutputState }

func (FactoryPropertiesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**FactoryProperties)(nil)).Elem()
}

func (o FactoryPropertiesPtrOutput) ToFactoryPropertiesPtrOutput() FactoryPropertiesPtrOutput {
	return o
}

func (o FactoryPropertiesPtrOutput) ToFactoryPropertiesPtrOutputWithContext(ctx context.Context) FactoryPropertiesPtrOutput {
	return o
}

func (o FactoryPropertiesPtrOutput) Elem() FactoryPropertiesOutput {
	return o.ApplyT(func(v *FactoryProperties) FactoryProperties { return *v }).(FactoryPropertiesOutput)
}

// List of parameters for factory.
func (o FactoryPropertiesPtrOutput) GlobalParameters() GlobalParameterDefinitionSpecificationPtrOutput {
	return o.ApplyT(func(v *FactoryProperties) *GlobalParameterDefinitionSpecification {
		if v == nil {
			return nil
		}
...
// Git repo information of the factory.
func (o FactoryPropertiesPtrOutput) RepoConfiguration() FactoryRepoConfigurationPtrOutput {
	return o.ApplyT(func(v *FactoryProperties) *FactoryRepoConfiguration {
		if v == nil {
			return nil
		}
...
type PipelineDefinitionArgs struct {
	...
	Description pulumi.StringPtrInput `pulumi:"description"`
	// The folder that this Pipeline is in. If not specified, Pipeline will appear at the root level.
	Folder PipelinePropertiesPtrInput `pulumi:"folder"`
	// List of parameters for pipeline.
	Parameters ParameterDefinitionSpecificationPtrInput `pulumi:"parameters"`
	// Dimensions emitted by Pipeline.
