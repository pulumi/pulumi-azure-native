...
func NewTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datafactory:Trigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrigger(ctx *pulumi.Context,
	...
	var resource Trigger
	err := ctx.ReadResource("azurerm:datafactory:Trigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
