...
func NewManagedPrivateEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datafactory/latest:ManagedPrivateEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedPrivateEndpoint(ctx *pulumi.Context,
	...
	var resource ManagedPrivateEndpoint
	err := ctx.ReadResource("azurerm:datafactory/latest:ManagedPrivateEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
