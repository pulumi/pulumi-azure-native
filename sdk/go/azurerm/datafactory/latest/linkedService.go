...
func NewLinkedService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datafactory/latest:LinkedService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedService(ctx *pulumi.Context,
	...
	var resource LinkedService
	err := ctx.ReadResource("azurerm:datafactory/latest:LinkedService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
