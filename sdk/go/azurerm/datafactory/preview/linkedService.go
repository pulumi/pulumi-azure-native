...
func NewLinkedService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:datafactory/preview:LinkedService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedService(ctx *pulumi.Context,
	...
	var resource LinkedService
	err := ctx.ReadResource("azurerm:datafactory/preview:LinkedService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
