...
func NewChannel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:botservice/latest:Channel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetChannel(ctx *pulumi.Context,
	...
	var resource Channel
	err := ctx.ReadResource("azurerm:botservice/latest:Channel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
