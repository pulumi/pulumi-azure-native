...
func NewEnterpriseChannel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:botservice/v20180712:EnterpriseChannel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnterpriseChannel(ctx *pulumi.Context,
	...
	var resource EnterpriseChannel
	err := ctx.ReadResource("azurerm:botservice/v20180712:EnterpriseChannel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
