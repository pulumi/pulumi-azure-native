...
func NewBot(ctx *pulumi.Context,
	...
	var resource Bot
	err := ctx.RegisterResource("azurerm:botservice/preview:Bot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBot(ctx *pulumi.Context,
	...
	var resource Bot
	err := ctx.ReadResource("azurerm:botservice/preview:Bot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
