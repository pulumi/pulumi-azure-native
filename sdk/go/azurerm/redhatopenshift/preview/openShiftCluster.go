...
func NewOpenShiftCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:redhatopenshift/latest:OpenShiftCluster"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:redhatopenshift/preview:OpenShiftCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOpenShiftCluster(ctx *pulumi.Context,
	...
	var resource OpenShiftCluster
	err := ctx.ReadResource("azurerm:redhatopenshift/preview:OpenShiftCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
