...
func NewOpenShiftCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:redhatopenshift/latest:OpenShiftCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOpenShiftCluster(ctx *pulumi.Context,
	...
	var resource OpenShiftCluster
	err := ctx.ReadResource("azurerm:redhatopenshift/latest:OpenShiftCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
