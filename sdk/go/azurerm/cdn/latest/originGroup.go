...
func NewOriginGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:cdn/latest:OriginGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOriginGroup(ctx *pulumi.Context,
	...
	var resource OriginGroup
	err := ctx.ReadResource("azurerm:cdn/latest:OriginGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
