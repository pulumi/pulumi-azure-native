...
func NewOrigin(ctx *pulumi.Context,
	...
	var resource Origin
	err := ctx.RegisterResource("azurerm:cdn/v20150601:Origin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrigin(ctx *pulumi.Context,
	...
	var resource Origin
	err := ctx.ReadResource("azurerm:cdn/v20150601:Origin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
