...
func NewCustomDomain(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:cdn/v20160402:CustomDomain"),
		},
		{
		...
		{
			Type: pulumi.String("azurerm:cdn/v20190615preview:CustomDomain"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:cdn/v20200415:CustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomDomain(ctx *pulumi.Context,
	...
	var resource CustomDomain
	err := ctx.ReadResource("azurerm:cdn/v20200415:CustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
