...
func NewPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:cdn/latest:Policy"),
		},
		{
			Type: pulumi.String("azurerm:cdn/preview:Policy"),
		},
		{
	...
	var resource Policy
	err := ctx.RegisterResource("azurerm:cdn/v20200415:Policy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicy(ctx *pulumi.Context,
	...
	var resource Policy
	err := ctx.ReadResource("azurerm:cdn/v20200415:Policy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
