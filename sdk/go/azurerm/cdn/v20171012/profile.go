...
func NewProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:cdn/v20171012:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("azurerm:cdn/v20171012:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
