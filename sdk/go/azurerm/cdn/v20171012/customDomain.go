...
func NewCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:cdn/v20171012:CustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomDomain(ctx *pulumi.Context,
	...
	var resource CustomDomain
	err := ctx.ReadResource("azurerm:cdn/v20171012:CustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
