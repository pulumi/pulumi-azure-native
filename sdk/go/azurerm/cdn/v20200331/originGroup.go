...
//
// import (
// 	cdn "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20200331"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
// 				ProbeRequestType:       pulumi.String("GET"),
// 			},
...
// 				ResponseBasedDetectedErrorTypes:          pulumi.String("TcpErrorsOnly"),
...
func NewOriginGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:cdn/v20200331:OriginGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOriginGroup(ctx *pulumi.Context,
	...
	var resource OriginGroup
	err := ctx.ReadResource("azurerm:cdn/v20200331:OriginGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
