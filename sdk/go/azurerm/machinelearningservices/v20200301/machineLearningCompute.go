...
//
// import (
// 	machinelearningservices "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/machinelearningservices/v20200301"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewMachineLearningCompute(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:machinelearningservices/v20200301:MachineLearningCompute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineLearningCompute(ctx *pulumi.Context,
	...
	var resource MachineLearningCompute
	err := ctx.ReadResource("azurerm:machinelearningservices/v20200301:MachineLearningCompute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
