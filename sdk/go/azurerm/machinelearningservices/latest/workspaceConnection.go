...
func NewWorkspaceConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:machinelearningservices/latest:WorkspaceConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceConnection(ctx *pulumi.Context,
	...
	var resource WorkspaceConnection
	err := ctx.ReadResource("azurerm:machinelearningservices/latest:WorkspaceConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
