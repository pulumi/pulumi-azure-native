...
func NewLinkedWorkspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:machinelearningservices/v20200301:LinkedWorkspace"),
		},
	})
	opts = append(opts, aliases)
	var resource LinkedWorkspace
	err := ctx.RegisterResource("azurerm:machinelearningservices/latest:LinkedWorkspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedWorkspace(ctx *pulumi.Context,
	...
	var resource LinkedWorkspace
	err := ctx.ReadResource("azurerm:machinelearningservices/latest:LinkedWorkspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
