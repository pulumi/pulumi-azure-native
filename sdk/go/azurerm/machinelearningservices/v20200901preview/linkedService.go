...
func NewLinkedService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:machinelearningservices/latest:LinkedService"),
		},
	})
...
func GetLinkedService(ctx *pulumi.Context,
	...
	var resource LinkedService
	err := ctx.ReadResource("azurerm:machinelearningservices/v20200901preview:LinkedService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
