...
func NewMachineLearningService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:machinelearningservices/latest:MachineLearningService"),
		},
		{
			Type: pulumi.String("azurerm:machinelearningservices/v20200501preview:MachineLearningService"),
		},
		{
			Type: pulumi.String("azurerm:machinelearningservices/v20200515preview:MachineLearningService"),
		},
	})
	opts = append(opts, aliases)
	var resource MachineLearningService
	err := ctx.RegisterResource("azurerm:machinelearningservices/v20200901preview:MachineLearningService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineLearningService(ctx *pulumi.Context,
	...
	var resource MachineLearningService
	err := ctx.ReadResource("azurerm:machinelearningservices/v20200901preview:MachineLearningService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
