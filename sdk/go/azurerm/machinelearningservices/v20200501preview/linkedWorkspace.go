...
func NewLinkedWorkspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:machinelearningservices/preview:LinkedWorkspace"),
		},
		{
			Type: pulumi.String("azurerm:machinelearningservices/v20200515preview:LinkedWorkspace"),
		},
	})
	opts = append(opts, aliases)
	var resource LinkedWorkspace
	err := ctx.RegisterResource("azurerm:machinelearningservices/v20200501preview:LinkedWorkspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedWorkspace(ctx *pulumi.Context,
	...
	var resource LinkedWorkspace
	err := ctx.ReadResource("azurerm:machinelearningservices/v20200501preview:LinkedWorkspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
