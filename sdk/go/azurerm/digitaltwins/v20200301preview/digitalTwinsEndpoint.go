...
func NewDigitalTwinsEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:digitaltwins/preview:DigitalTwinsEndpoint"),
		},
	})
...
func GetDigitalTwinsEndpoint(ctx *pulumi.Context,
	...
	var resource DigitalTwinsEndpoint
	err := ctx.ReadResource("azurerm:digitaltwins/v20200301preview:DigitalTwinsEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
