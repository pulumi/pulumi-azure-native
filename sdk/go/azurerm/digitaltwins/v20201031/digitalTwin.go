...
func NewDigitalTwin(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:digitaltwins/v20201031:DigitalTwin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDigitalTwin(ctx *pulumi.Context,
	...
	var resource DigitalTwin
	err := ctx.ReadResource("azurerm:digitaltwins/v20201031:DigitalTwin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
