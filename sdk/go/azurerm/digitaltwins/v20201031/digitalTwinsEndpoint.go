...
func NewDigitalTwinsEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:digitaltwins/v20200301preview:DigitalTwinsEndpoint"),
		},
	})
	opts = append(opts, aliases)
	var resource DigitalTwinsEndpoint
	err := ctx.RegisterResource("azurerm:digitaltwins/v20201031:DigitalTwinsEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDigitalTwinsEndpoint(ctx *pulumi.Context,
	...
	var resource DigitalTwinsEndpoint
	err := ctx.ReadResource("azurerm:digitaltwins/v20201031:DigitalTwinsEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
