...
func NewDigitalTwin(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:digitaltwins/v20200301preview:DigitalTwin"),
		},
		{
			Type: pulumi.String("azurerm:digitaltwins/v20201031:DigitalTwin"),
		},
	})
	opts = append(opts, aliases)
	var resource DigitalTwin
	err := ctx.RegisterResource("azurerm:digitaltwins/latest:DigitalTwin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDigitalTwin(ctx *pulumi.Context,
	...
	var resource DigitalTwin
	err := ctx.ReadResource("azurerm:digitaltwins/latest:DigitalTwin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
