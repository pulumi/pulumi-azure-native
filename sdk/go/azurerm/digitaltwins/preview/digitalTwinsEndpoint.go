...
func NewDigitalTwinsEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:digitaltwins/preview:DigitalTwinsEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDigitalTwinsEndpoint(ctx *pulumi.Context,
	...
	var resource DigitalTwinsEndpoint
	err := ctx.ReadResource("azurerm:digitaltwins/preview:DigitalTwinsEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
