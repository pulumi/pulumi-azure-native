...
func NewBlockchainMember(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:blockchain/v20180601preview:BlockchainMember"),
		},
	})
	opts = append(opts, aliases)
	var resource BlockchainMember
	err := ctx.RegisterResource("azurerm:blockchain/preview:BlockchainMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlockchainMember(ctx *pulumi.Context,
	...
	var resource BlockchainMember
	err := ctx.ReadResource("azurerm:blockchain/preview:BlockchainMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
