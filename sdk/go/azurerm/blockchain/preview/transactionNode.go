...
func NewTransactionNode(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:blockchain/v20180601preview:TransactionNode"),
		},
	})
	opts = append(opts, aliases)
	var resource TransactionNode
	err := ctx.RegisterResource("azurerm:blockchain/preview:TransactionNode", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransactionNode(ctx *pulumi.Context,
	...
	var resource TransactionNode
	err := ctx.ReadResource("azurerm:blockchain/preview:TransactionNode", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
