...
func NewTransactionNode(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:blockchain/latest:TransactionNode"),
		},
	})
...
func GetTransactionNode(ctx *pulumi.Context,
	...
	var resource TransactionNode
	err := ctx.ReadResource("azurerm:blockchain/v20180601preview:TransactionNode", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
