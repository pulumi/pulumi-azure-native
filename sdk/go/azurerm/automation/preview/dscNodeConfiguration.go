...
func NewDscNodeConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:automation/preview:DscNodeConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDscNodeConfiguration(ctx *pulumi.Context,
	...
	var resource DscNodeConfiguration
	err := ctx.ReadResource("azurerm:automation/preview:DscNodeConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
