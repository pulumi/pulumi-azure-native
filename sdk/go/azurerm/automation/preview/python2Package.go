...
func NewPython2Package(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:automation/preview:Python2Package", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPython2Package(ctx *pulumi.Context,
	...
	var resource Python2Package
	err := ctx.ReadResource("azurerm:automation/preview:Python2Package", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
