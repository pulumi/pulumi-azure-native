...
func NewJobSchedule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:automation/latest:JobSchedule"),
		},
		{
			Type: pulumi.String("azurerm:automation/v20151031:JobSchedule"),
		},
	})
	opts = append(opts, aliases)
	var resource JobSchedule
	err := ctx.RegisterResource("azurerm:automation/preview:JobSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobSchedule(ctx *pulumi.Context,
	...
	var resource JobSchedule
	err := ctx.ReadResource("azurerm:automation/preview:JobSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
