...
func NewSoftwareUpdateConfigurationByName(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:automation/v20170515preview:SoftwareUpdateConfigurationByName"),
		},
	})
	opts = append(opts, aliases)
	var resource SoftwareUpdateConfigurationByName
	err := ctx.RegisterResource("azurerm:automation/preview:SoftwareUpdateConfigurationByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSoftwareUpdateConfigurationByName(ctx *pulumi.Context,
	...
	var resource SoftwareUpdateConfigurationByName
	err := ctx.ReadResource("azurerm:automation/preview:SoftwareUpdateConfigurationByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
