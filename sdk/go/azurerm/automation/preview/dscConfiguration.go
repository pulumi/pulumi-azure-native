...
func NewDscConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:automation/preview:DscConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDscConfiguration(ctx *pulumi.Context,
	...
	var resource DscConfiguration
	err := ctx.ReadResource("azurerm:automation/preview:DscConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
