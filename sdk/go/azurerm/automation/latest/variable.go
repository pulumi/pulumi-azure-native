...
func NewVariable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:automation/latest:Variable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVariable(ctx *pulumi.Context,
	...
	var resource Variable
	err := ctx.ReadResource("azurerm:automation/latest:Variable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
