...
func NewAutomationAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:automation/latest:AutomationAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutomationAccount(ctx *pulumi.Context,
	...
	var resource AutomationAccount
	err := ctx.ReadResource("azurerm:automation/latest:AutomationAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
