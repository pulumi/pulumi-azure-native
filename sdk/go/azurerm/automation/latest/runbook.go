...
func NewRunbook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:automation/latest:Runbook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRunbook(ctx *pulumi.Context,
	...
	var resource Runbook
	err := ctx.ReadResource("azurerm:automation/latest:Runbook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
