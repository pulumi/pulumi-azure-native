...
func NewCredential(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:automation/latest:Credential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCredential(ctx *pulumi.Context,
	...
	var resource Credential
	err := ctx.ReadResource("azurerm:automation/latest:Credential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
