...
func NewJobSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:automation/latest:JobSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobSchedule(ctx *pulumi.Context,
	...
	var resource JobSchedule
	err := ctx.ReadResource("azurerm:automation/latest:JobSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
