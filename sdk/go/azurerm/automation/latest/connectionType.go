...
func NewConnectionType(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:automation/v20151031:ConnectionType"),
		},
	})
	opts = append(opts, aliases)
	var resource ConnectionType
	err := ctx.RegisterResource("azurerm:automation/latest:ConnectionType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionType(ctx *pulumi.Context,
	...
	var resource ConnectionType
	err := ctx.ReadResource("azurerm:automation/latest:ConnectionType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
