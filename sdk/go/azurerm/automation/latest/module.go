...
func NewModule(ctx *pulumi.Context,
	...
	var resource Module
	err := ctx.RegisterResource("azurerm:automation/latest:Module", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModule(ctx *pulumi.Context,
	...
	var resource Module
	err := ctx.ReadResource("azurerm:automation/latest:Module", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
