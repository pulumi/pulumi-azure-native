...
func NewDscConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:automation:DscConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDscConfiguration(ctx *pulumi.Context,
	...
	var resource DscConfiguration
	err := ctx.ReadResource("azurerm:automation:DscConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
