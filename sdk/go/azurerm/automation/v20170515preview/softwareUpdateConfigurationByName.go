...
func NewSoftwareUpdateConfigurationByName(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:automation/preview:SoftwareUpdateConfigurationByName"),
		},
	})
...
func GetSoftwareUpdateConfigurationByName(ctx *pulumi.Context,
	...
	var resource SoftwareUpdateConfigurationByName
	err := ctx.ReadResource("azurerm:automation/v20170515preview:SoftwareUpdateConfigurationByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
