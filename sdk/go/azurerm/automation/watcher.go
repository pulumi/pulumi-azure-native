...
func NewWatcher(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:automation:Watcher", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWatcher(ctx *pulumi.Context,
	...
	var resource Watcher
	err := ctx.ReadResource("azurerm:automation:Watcher", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
