...
func NewIntegrationAccountAssembly(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic/v20190501:IntegrationAccountAssembly", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountAssembly(ctx *pulumi.Context,
	...
	var resource IntegrationAccountAssembly
	err := ctx.ReadResource("azurerm:logic/v20190501:IntegrationAccountAssembly", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
