...
func NewIntegrationAccountSession(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:logic/preview:IntegrationAccountSession"),
		},
		{
...
func GetIntegrationAccountSession(ctx *pulumi.Context,
	...
	var resource IntegrationAccountSession
	err := ctx.ReadResource("azurerm:logic/v20190501:IntegrationAccountSession", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
