...
func NewIntegrationAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic/latest:IntegrationAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccount(ctx *pulumi.Context,
	...
	var resource IntegrationAccount
	err := ctx.ReadResource("azurerm:logic/latest:IntegrationAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
