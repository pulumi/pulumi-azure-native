...
func NewIntegrationAccountMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic/latest:IntegrationAccountMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountMap(ctx *pulumi.Context,
	...
	var resource IntegrationAccountMap
	err := ctx.ReadResource("azurerm:logic/latest:IntegrationAccountMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
