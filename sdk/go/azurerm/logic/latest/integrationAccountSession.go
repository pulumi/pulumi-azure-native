...
func NewIntegrationAccountSession(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic/latest:IntegrationAccountSession", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountSession(ctx *pulumi.Context,
	...
	var resource IntegrationAccountSession
	err := ctx.ReadResource("azurerm:logic/latest:IntegrationAccountSession", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
