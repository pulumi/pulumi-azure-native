...
func NewIntegrationAccountAssembly(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic/latest:IntegrationAccountAssembly", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountAssembly(ctx *pulumi.Context,
	...
	var resource IntegrationAccountAssembly
	err := ctx.ReadResource("azurerm:logic/latest:IntegrationAccountAssembly", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
