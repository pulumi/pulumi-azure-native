...
func NewIntegrationAccountPartner(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic/latest:IntegrationAccountPartner", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountPartner(ctx *pulumi.Context,
	...
	var resource IntegrationAccountPartner
	err := ctx.ReadResource("azurerm:logic/latest:IntegrationAccountPartner", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
