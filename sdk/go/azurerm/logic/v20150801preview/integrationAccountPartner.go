...
func NewIntegrationAccountPartner(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:logic/v20180701preview:IntegrationAccountPartner"),
		},
		{
			Type: pulumi.String("azurerm:logic/v20190501:IntegrationAccountPartner"),
		},
	})
	opts = append(opts, aliases)
	var resource IntegrationAccountPartner
	err := ctx.RegisterResource("azurerm:logic/v20150801preview:IntegrationAccountPartner", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountPartner(ctx *pulumi.Context,
	...
	var resource IntegrationAccountPartner
	err := ctx.ReadResource("azurerm:logic/v20150801preview:IntegrationAccountPartner", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
