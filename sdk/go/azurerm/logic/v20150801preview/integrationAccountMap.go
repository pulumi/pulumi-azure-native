...
func NewIntegrationAccountMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic/v20150801preview:IntegrationAccountMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountMap(ctx *pulumi.Context,
	...
	var resource IntegrationAccountMap
	err := ctx.ReadResource("azurerm:logic/v20150801preview:IntegrationAccountMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
