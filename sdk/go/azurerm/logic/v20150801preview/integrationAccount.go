...
func NewIntegrationAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:logic/preview:IntegrationAccount"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:logic/v20150801preview:IntegrationAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccount(ctx *pulumi.Context,
	...
	var resource IntegrationAccount
	err := ctx.ReadResource("azurerm:logic/v20150801preview:IntegrationAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
