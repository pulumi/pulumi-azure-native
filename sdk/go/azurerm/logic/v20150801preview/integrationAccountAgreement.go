...
func NewIntegrationAccountAgreement(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic/v20150801preview:IntegrationAccountAgreement", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountAgreement(ctx *pulumi.Context,
	...
	var resource IntegrationAccountAgreement
	err := ctx.ReadResource("azurerm:logic/v20150801preview:IntegrationAccountAgreement", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
