...
func NewIntegrationServiceEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic:IntegrationServiceEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationServiceEnvironment(ctx *pulumi.Context,
	...
	var resource IntegrationServiceEnvironment
	err := ctx.ReadResource("azurerm:logic:IntegrationServiceEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
