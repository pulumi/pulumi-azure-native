...
func NewIntegrationAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic/v20180701preview:IntegrationAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccount(ctx *pulumi.Context,
	...
	var resource IntegrationAccount
	err := ctx.ReadResource("azurerm:logic/v20180701preview:IntegrationAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
