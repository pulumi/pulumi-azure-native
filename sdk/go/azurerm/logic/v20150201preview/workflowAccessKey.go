...
func NewWorkflowAccessKey(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:logic/preview:WorkflowAccessKey"),
		},
	})
...
func GetWorkflowAccessKey(ctx *pulumi.Context,
	...
	var resource WorkflowAccessKey
	err := ctx.ReadResource("azurerm:logic/v20150201preview:WorkflowAccessKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
