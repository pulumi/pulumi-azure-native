...
func NewIntegrationAccountCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic:IntegrationAccountCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountCertificate(ctx *pulumi.Context,
	...
	var resource IntegrationAccountCertificate
	err := ctx.ReadResource("azurerm:logic:IntegrationAccountCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
