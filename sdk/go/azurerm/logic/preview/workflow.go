...
func NewWorkflow(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic/preview:Workflow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkflow(ctx *pulumi.Context,
	...
	var resource Workflow
	err := ctx.ReadResource("azurerm:logic/preview:Workflow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
