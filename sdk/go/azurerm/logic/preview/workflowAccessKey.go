...
func NewWorkflowAccessKey(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:logic/v20150201preview:WorkflowAccessKey"),
		},
	})
	opts = append(opts, aliases)
	var resource WorkflowAccessKey
	err := ctx.RegisterResource("azurerm:logic/preview:WorkflowAccessKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkflowAccessKey(ctx *pulumi.Context,
	...
	var resource WorkflowAccessKey
	err := ctx.ReadResource("azurerm:logic/preview:WorkflowAccessKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
