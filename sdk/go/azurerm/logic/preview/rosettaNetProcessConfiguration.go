...
func NewRosettaNetProcessConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic/preview:RosettaNetProcessConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRosettaNetProcessConfiguration(ctx *pulumi.Context,
	...
	var resource RosettaNetProcessConfiguration
	err := ctx.ReadResource("azurerm:logic/preview:RosettaNetProcessConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
