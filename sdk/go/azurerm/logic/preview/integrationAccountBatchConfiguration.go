...
func NewIntegrationAccountBatchConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:logic/preview:IntegrationAccountBatchConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountBatchConfiguration(ctx *pulumi.Context,
	...
	var resource IntegrationAccountBatchConfiguration
	err := ctx.ReadResource("azurerm:logic/preview:IntegrationAccountBatchConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
