...
//
// import (
// 	machinelearningcompute "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/machinelearningcompute/v20170601preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewOperationalizationCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:machinelearningcompute/v20170601preview:OperationalizationCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOperationalizationCluster(ctx *pulumi.Context,
	...
	var resource OperationalizationCluster
	err := ctx.ReadResource("azurerm:machinelearningcompute/v20170601preview:OperationalizationCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
