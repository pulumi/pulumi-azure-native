...
func NewOperationalizationCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:machinelearningcompute/preview:OperationalizationCluster"),
		},
		{
			Type: pulumi.String("azurerm:machinelearningcompute/v20170601preview:OperationalizationCluster"),
		},
	})
	opts = append(opts, aliases)
	var resource OperationalizationCluster
	err := ctx.RegisterResource("azurerm:machinelearningcompute/v20170801preview:OperationalizationCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOperationalizationCluster(ctx *pulumi.Context,
	...
	var resource OperationalizationCluster
	err := ctx.ReadResource("azurerm:machinelearningcompute/v20170801preview:OperationalizationCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
