...
// 			HostPoolType:                  pulumi.String("Shared"),
...
// 				ExpirationTime:             pulumi.String("2008-09-22T14:01:54.9571247Z"),
...
func NewHostPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:desktopvirtualization/v20190123preview:HostPool"),
		},
		{
			Type: pulumi.String("azurerm:desktopvirtualization/v20191210preview:HostPool"),
		},
	})
	opts = append(opts, aliases)
	var resource HostPool
	err := ctx.RegisterResource("azurerm:desktopvirtualization/v20190924preview:HostPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHostPool(ctx *pulumi.Context,
	...
	var resource HostPool
	err := ctx.ReadResource("azurerm:desktopvirtualization/v20190924preview:HostPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
