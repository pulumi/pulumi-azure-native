...
func NewApplicationGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:desktopvirtualization/v20190924preview:ApplicationGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationGroup(ctx *pulumi.Context,
	...
	var resource ApplicationGroup
	err := ctx.ReadResource("azurerm:desktopvirtualization/v20190924preview:ApplicationGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
