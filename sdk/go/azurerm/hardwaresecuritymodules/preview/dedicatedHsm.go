...
func NewDedicatedHsm(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:hardwaresecuritymodules/v20181031preview:DedicatedHsm"),
		},
	})
	opts = append(opts, aliases)
	var resource DedicatedHsm
	err := ctx.RegisterResource("azurerm:hardwaresecuritymodules/preview:DedicatedHsm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDedicatedHsm(ctx *pulumi.Context,
	...
	var resource DedicatedHsm
	err := ctx.ReadResource("azurerm:hardwaresecuritymodules/preview:DedicatedHsm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
