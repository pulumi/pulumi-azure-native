...
//
// import (
// 	hardwaresecuritymodules "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/hardwaresecuritymodules/v20181031preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func GetDedicatedHsm(ctx *pulumi.Context,
	...
	var resource DedicatedHsm
	err := ctx.ReadResource("azurerm:hardwaresecuritymodules/v20181031preview:DedicatedHsm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
