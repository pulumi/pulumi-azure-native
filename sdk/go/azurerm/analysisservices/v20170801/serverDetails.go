...
//
// import (
// 	analysisservices "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/analysisservices/v20170801"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewServerDetails(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:analysisservices/v20170801:ServerDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerDetails(ctx *pulumi.Context,
	...
	var resource ServerDetails
	err := ctx.ReadResource("azurerm:analysisservices/v20170801:ServerDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
