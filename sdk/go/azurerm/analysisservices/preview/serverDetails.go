...
func NewServerDetails(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:analysisservices/preview:ServerDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerDetails(ctx *pulumi.Context,
	...
	var resource ServerDetails
	err := ctx.ReadResource("azurerm:analysisservices/preview:ServerDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
