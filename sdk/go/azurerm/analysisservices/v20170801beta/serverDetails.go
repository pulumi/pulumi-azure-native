...
func NewServerDetails(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:analysisservices/preview:ServerDetails"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:analysisservices/v20170801beta:ServerDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerDetails(ctx *pulumi.Context,
	...
	var resource ServerDetails
	err := ctx.ReadResource("azurerm:analysisservices/v20170801beta:ServerDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
