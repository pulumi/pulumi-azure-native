...
func NewIoTSpace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:iotspaces/v20171001preview:IoTSpace"),
		},
	})
	opts = append(opts, aliases)
	var resource IoTSpace
	err := ctx.RegisterResource("azurerm:iotspaces/preview:IoTSpace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIoTSpace(ctx *pulumi.Context,
	...
	var resource IoTSpace
	err := ctx.ReadResource("azurerm:iotspaces/preview:IoTSpace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
