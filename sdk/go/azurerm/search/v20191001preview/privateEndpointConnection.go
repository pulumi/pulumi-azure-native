...
//
// import (
// 	search "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/search/v20191001preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
// 			Id:                            pulumi.String("/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Search/searchServices/mysearchservice/privateEndpointConnections/testEndpoint.50bf4fbe-d7c1-4b48-a642-4f5892642546"),
...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:search/latest:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azurerm:search/v20200313:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azurerm:search/v20200801:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azurerm:search/v20200801preview:PrivateEndpointConnection"),
		},
	})
	opts = append(opts, aliases)
	var resource PrivateEndpointConnection
	err := ctx.RegisterResource("azurerm:search/v20191001preview:PrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnection
	err := ctx.ReadResource("azurerm:search/v20191001preview:PrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
