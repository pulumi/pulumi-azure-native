...
func NewApplicationType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:servicefabric/v20190301preview:ApplicationType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationType(ctx *pulumi.Context,
	...
	var resource ApplicationType
	err := ctx.ReadResource("azurerm:servicefabric/v20190301preview:ApplicationType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
