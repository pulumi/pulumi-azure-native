...
// 				},
// 			},
// 			ClusterCodeVersion: pulumi.String("6.0.219.9494"),
...
// 			ReverseProxyCertificate: &servicefabric.CertificateDescriptionArgs{
// 				Thumbprint:          pulumi.String("5F3660C715EBBDA31DB1FFDCF508302348DE8E7A"),
// 				ThumbprintSecondary: pulumi.String("361A93445450CC8F2FF747F74500E8044942DAFD"),
// 				X509StoreName:       pulumi.String("My"),
// 			},
...
// 				UpgradeTimeout:                pulumi.String("00:15:00"),
// 			},
...
func NewCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:servicefabric/v20170701preview:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("azurerm:servicefabric/v20170701preview:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
