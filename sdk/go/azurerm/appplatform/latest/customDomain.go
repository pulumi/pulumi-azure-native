...
func NewCustomDomain(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:appplatform/preview:CustomDomain"),
		},
		{
			Type: pulumi.String("azurerm:appplatform/v20190501preview:CustomDomain"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:appplatform/latest:CustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomDomain(ctx *pulumi.Context,
	...
	var resource CustomDomain
	err := ctx.ReadResource("azurerm:appplatform/latest:CustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
