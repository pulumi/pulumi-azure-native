...
func NewThreatIntelligenceIndicator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/v20190101preview:ThreatIntelligenceIndicator"),
		},
	})
	opts = append(opts, aliases)
	var resource ThreatIntelligenceIndicator
	err := ctx.RegisterResource("azurerm:securityinsights/preview:ThreatIntelligenceIndicator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetThreatIntelligenceIndicator(ctx *pulumi.Context,
	...
	var resource ThreatIntelligenceIndicator
	err := ctx.ReadResource("azurerm:securityinsights/preview:ThreatIntelligenceIndicator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
