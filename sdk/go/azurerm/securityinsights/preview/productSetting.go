...
func NewProductSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/v20190101preview:ProductSetting"),
		},
	})
	opts = append(opts, aliases)
	var resource ProductSetting
	err := ctx.RegisterResource("azurerm:securityinsights/preview:ProductSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductSetting(ctx *pulumi.Context,
	...
	var resource ProductSetting
	err := ctx.ReadResource("azurerm:securityinsights/preview:ProductSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
