...
func NewCase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/v20190101preview:Case"),
		},
	})
	opts = append(opts, aliases)
	var resource Case
	err := ctx.RegisterResource("azurerm:securityinsights/preview:Case", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCase(ctx *pulumi.Context,
	...
	var resource Case
	err := ctx.ReadResource("azurerm:securityinsights/preview:Case", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
