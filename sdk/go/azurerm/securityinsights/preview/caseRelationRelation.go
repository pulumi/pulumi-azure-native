...
func NewCaseRelationRelation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/v20190101preview:CaseRelationRelation"),
		},
	})
	opts = append(opts, aliases)
	var resource CaseRelationRelation
	err := ctx.RegisterResource("azurerm:securityinsights/preview:CaseRelationRelation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCaseRelationRelation(ctx *pulumi.Context,
	...
	var resource CaseRelationRelation
	err := ctx.ReadResource("azurerm:securityinsights/preview:CaseRelationRelation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
