...
func NewBookmarkRelationRelation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/v20190101preview:BookmarkRelationRelation"),
		},
	})
	opts = append(opts, aliases)
	var resource BookmarkRelationRelation
	err := ctx.RegisterResource("azurerm:securityinsights/preview:BookmarkRelationRelation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBookmarkRelationRelation(ctx *pulumi.Context,
	...
	var resource BookmarkRelationRelation
	err := ctx.ReadResource("azurerm:securityinsights/preview:BookmarkRelationRelation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
