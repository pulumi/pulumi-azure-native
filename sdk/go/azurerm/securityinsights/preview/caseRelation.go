...
func NewCaseRelation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/v20190101preview:CaseRelation"),
		},
	})
	opts = append(opts, aliases)
	var resource CaseRelation
	err := ctx.RegisterResource("azurerm:securityinsights/preview:CaseRelation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCaseRelation(ctx *pulumi.Context,
	...
	var resource CaseRelation
	err := ctx.ReadResource("azurerm:securityinsights/preview:CaseRelation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
