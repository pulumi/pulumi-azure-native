...
func NewWatchlist(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/v20190101preview:Watchlist"),
		},
	})
	opts = append(opts, aliases)
	var resource Watchlist
	err := ctx.RegisterResource("azurerm:securityinsights/preview:Watchlist", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWatchlist(ctx *pulumi.Context,
	...
	var resource Watchlist
	err := ctx.ReadResource("azurerm:securityinsights/preview:Watchlist", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
