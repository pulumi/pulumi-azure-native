...
func NewIncidentRelation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/v20190101preview:IncidentRelation"),
		},
	})
	opts = append(opts, aliases)
	var resource IncidentRelation
	err := ctx.RegisterResource("azurerm:securityinsights/preview:IncidentRelation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIncidentRelation(ctx *pulumi.Context,
	...
	var resource IncidentRelation
	err := ctx.ReadResource("azurerm:securityinsights/preview:IncidentRelation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
