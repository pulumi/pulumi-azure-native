...
func NewAlertRuleAction(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/preview:AlertRuleAction"),
		},
	})
	opts = append(opts, aliases)
	var resource AlertRuleAction
	err := ctx.RegisterResource("azurerm:securityinsights/v20190101preview:AlertRuleAction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertRuleAction(ctx *pulumi.Context,
	...
	var resource AlertRuleAction
	err := ctx.ReadResource("azurerm:securityinsights/v20190101preview:AlertRuleAction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
