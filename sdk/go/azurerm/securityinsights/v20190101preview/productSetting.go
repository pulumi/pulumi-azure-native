...
func NewProductSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/preview:ProductSetting"),
		},
	})
...
func GetProductSetting(ctx *pulumi.Context,
	...
	var resource ProductSetting
	err := ctx.ReadResource("azurerm:securityinsights/v20190101preview:ProductSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
