...
func NewCase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/preview:Case"),
		},
	})
...
func GetCase(ctx *pulumi.Context,
	...
	var resource Case
	err := ctx.ReadResource("azurerm:securityinsights/v20190101preview:Case", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
