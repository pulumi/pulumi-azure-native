...
func NewThreatIntelligenceIndicator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/preview:ThreatIntelligenceIndicator"),
		},
	})
...
func GetThreatIntelligenceIndicator(ctx *pulumi.Context,
	...
	var resource ThreatIntelligenceIndicator
	err := ctx.ReadResource("azurerm:securityinsights/v20190101preview:ThreatIntelligenceIndicator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
