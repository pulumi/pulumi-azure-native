...
func NewCaseRelation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/latest:CaseRelation"),
		},
	})
...
func GetCaseRelation(ctx *pulumi.Context,
	...
	var resource CaseRelation
	err := ctx.ReadResource("azurerm:securityinsights/v20190101preview:CaseRelation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
