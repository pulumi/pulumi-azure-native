...
func NewDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:securityinsights/latest:DataConnector"),
		},
	})
...
func GetDataConnector(ctx *pulumi.Context,
	...
	var resource DataConnector
	err := ctx.ReadResource("azurerm:securityinsights/v20190101preview:DataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
