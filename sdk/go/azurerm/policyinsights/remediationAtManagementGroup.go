...
func NewRemediationAtManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:policyinsights:RemediationAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemediationAtManagementGroup(ctx *pulumi.Context,
	...
	var resource RemediationAtManagementGroup
	err := ctx.ReadResource("azurerm:policyinsights:RemediationAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
