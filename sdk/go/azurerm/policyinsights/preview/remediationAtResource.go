...
func NewRemediationAtResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:policyinsights/v20180701preview:RemediationAtResource"),
		},
		{
	...
	err := ctx.RegisterResource("azurerm:policyinsights/preview:RemediationAtResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemediationAtResource(ctx *pulumi.Context,
	...
	var resource RemediationAtResource
	err := ctx.ReadResource("azurerm:policyinsights/preview:RemediationAtResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
