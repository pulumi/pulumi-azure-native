...
// 			ResourceId:         pulumi.String("subscriptions/35ee058e-5fa0-414c-8145-3ebb8d09b6e2/resourcegroups/rg1/providers/microsoft.storage/storageaccounts/storAc1"),
// 		})
// 		if err != nil {
// 			return err
// 		}
...
func NewRemediationAtResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:policyinsights/v20180701preview:RemediationAtResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemediationAtResource(ctx *pulumi.Context,
	...
	var resource RemediationAtResource
	err := ctx.ReadResource("azurerm:policyinsights/v20180701preview:RemediationAtResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
