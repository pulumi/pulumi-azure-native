...
func NewRemediationAtSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:policyinsights/latest:RemediationAtSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemediationAtSubscription(ctx *pulumi.Context,
	...
	var resource RemediationAtSubscription
	err := ctx.ReadResource("azurerm:policyinsights/latest:RemediationAtSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
