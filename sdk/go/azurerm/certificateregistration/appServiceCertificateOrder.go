...
func NewAppServiceCertificateOrder(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:certificateregistration:AppServiceCertificateOrder", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceCertificateOrder(ctx *pulumi.Context,
	...
	var resource AppServiceCertificateOrder
	err := ctx.ReadResource("azurerm:certificateregistration:AppServiceCertificateOrder", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
