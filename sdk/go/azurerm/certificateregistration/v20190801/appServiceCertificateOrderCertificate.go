...
func NewAppServiceCertificateOrderCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azurerm:certificateregistration/v20200601:AppServiceCertificateOrderCertificate"),
		},
	})
	opts = append(opts, aliases)
	var resource AppServiceCertificateOrderCertificate
	err := ctx.RegisterResource("azurerm:certificateregistration/v20190801:AppServiceCertificateOrderCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceCertificateOrderCertificate(ctx *pulumi.Context,
	...
	var resource AppServiceCertificateOrderCertificate
	err := ctx.ReadResource("azurerm:certificateregistration/v20190801:AppServiceCertificateOrderCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
