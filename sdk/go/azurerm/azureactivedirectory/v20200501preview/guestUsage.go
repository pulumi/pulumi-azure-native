...
func NewGuestUsage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:azureactivedirectory/latest:GuestUsage"),
		},
	})
...
func GetGuestUsage(ctx *pulumi.Context,
	...
	var resource GuestUsage
	err := ctx.ReadResource("azurerm:azureactivedirectory/v20200501preview:GuestUsage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
