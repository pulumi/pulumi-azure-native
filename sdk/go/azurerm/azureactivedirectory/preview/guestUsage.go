...
func NewGuestUsage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azurerm:azureactivedirectory/v20200501preview:GuestUsage"),
		},
	})
	opts = append(opts, aliases)
	var resource GuestUsage
	err := ctx.RegisterResource("azurerm:azureactivedirectory/preview:GuestUsage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestUsage(ctx *pulumi.Context,
	...
	var resource GuestUsage
	err := ctx.ReadResource("azurerm:azureactivedirectory/preview:GuestUsage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
