...
//
// import (
// 	signalrservice "github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/signalrservice/v20200701preview"
// 	"github.com/pulumi/pulumi/sdk/v2/go/pulumi"
// )
//
// func main() {
...
func NewSignalR(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:signalrservice/v20200701preview:SignalR", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalR(ctx *pulumi.Context,
	...
	var resource SignalR
	err := ctx.ReadResource("azurerm:signalrservice/v20200701preview:SignalR", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
