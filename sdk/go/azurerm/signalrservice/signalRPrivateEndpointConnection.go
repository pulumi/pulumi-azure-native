...
func NewSignalRPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:signalrservice:SignalRPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalRPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource SignalRPrivateEndpointConnection
	err := ctx.ReadResource("azurerm:signalrservice:SignalRPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
