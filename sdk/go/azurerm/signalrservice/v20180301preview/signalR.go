...
func NewSignalR(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:signalrservice/v20180301preview:SignalR", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalR(ctx *pulumi.Context,
	...
	var resource SignalR
	err := ctx.ReadResource("azurerm:signalrservice/v20180301preview:SignalR", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
