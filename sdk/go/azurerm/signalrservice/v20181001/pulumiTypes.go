...
// Version of the SignalR resource. Probably you need the same or higher version of client SDKs.
func (o SignalRPropertiesResponseOutput) Version() pulumi.StringPtrOutput {
	return o.ApplyT(func(v SignalRPropertiesResponse) *string { return v.Version }).(pulumi.StringPtrOutput)
}
