...
func NewSignalR(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azurerm:signalrservice/latest:SignalR", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalR(ctx *pulumi.Context,
	...
	var resource SignalR
	err := ctx.ReadResource("azurerm:signalrservice/latest:SignalR", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
