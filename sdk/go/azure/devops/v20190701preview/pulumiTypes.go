...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OrganizationReferenceInput)(nil)).Elem(), OrganizationReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OrganizationReferencePtrInput)(nil)).Elem(), OrganizationReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OrganizationReferenceResponseInput)(nil)).Elem(), OrganizationReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OrganizationReferenceResponsePtrInput)(nil)).Elem(), OrganizationReferenceResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ProjectReferenceInput)(nil)).Elem(), ProjectReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProjectReferencePtrInput)(nil)).Elem(), ProjectReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProjectReferenceResponseInput)(nil)).Elem(), ProjectReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProjectReferenceResponsePtrInput)(nil)).Elem(), ProjectReferenceResponseArgs{})
