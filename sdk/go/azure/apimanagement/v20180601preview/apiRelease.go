...
func NewApiRelease(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement/v20180601preview:ApiRelease", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiRelease(ctx *pulumi.Context,
	...
	var resource ApiRelease
	err := ctx.ReadResource("azure-nextgen:apimanagement/v20180601preview:ApiRelease", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
