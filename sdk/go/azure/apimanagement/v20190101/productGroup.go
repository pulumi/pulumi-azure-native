...
func NewProductGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement/v20190101:ProductGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductGroup(ctx *pulumi.Context,
	...
	var resource ProductGroup
	err := ctx.ReadResource("azure-nextgen:apimanagement/v20190101:ProductGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
