...
func NewGatewayCertificateAuthority(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20210401preview:GatewayCertificateAuthority", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayCertificateAuthority(ctx *pulumi.Context,
	...
	var resource GatewayCertificateAuthority
	err := ctx.ReadResource("azure-native:apimanagement/v20210401preview:GatewayCertificateAuthority", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
