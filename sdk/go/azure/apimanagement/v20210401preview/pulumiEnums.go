...
// CertificateSourceInput is an input type that accepts CertificateSourceArgs and CertificateSourceOutput values.
// You can construct a concrete instance of `CertificateSourceInput` via:
//
//          CertificateSourceArgs{...}
