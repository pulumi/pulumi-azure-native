...
func NewGatewayHostnameConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement:GatewayHostnameConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayHostnameConfiguration(ctx *pulumi.Context,
	...
	var resource GatewayHostnameConfiguration
	err := ctx.ReadResource("azure-nextgen:apimanagement:GatewayHostnameConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
