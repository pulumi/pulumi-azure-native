...
// Property only valid for an Api Management service deployed in multiple locations. This can be used to disable the gateway in this additional location.
func (o AdditionalLocationInvokeResponseOutput) DisableGateway() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v AdditionalLocationInvokeResponse) *bool { return v.DisableGateway }).(pulumi.BoolPtrOutput)
}
...
// A list of availability zones denoting where the resource needs to come from.
func (o AdditionalLocationInvokeResponseOutput) Zones() pulumi.StringArrayOutput {
	return o.ApplyT(func(v AdditionalLocationInvokeResponse) []string { return v.Zones }).(pulumi.StringArrayOutput)
}
...
// '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/
//     providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
func (o ApiManagementServiceIdentityInvokeResponseOutput) UserAssignedIdentities() UserIdentityPropertiesInvokeResponseMapOutput {
	return o.ApplyT(func(v ApiManagementServiceIdentityInvokeResponse) map[string]UserIdentityPropertiesInvokeResponse {
		return v.UserAssignedIdentities
...
// Capacity of the SKU (number of deployed units of the SKU). For Consumption SKU capacity must be specified as 0.
func (o ApiManagementServiceSkuPropertiesInvokeResponseOutput) Capacity() pulumi.IntOutput {
	return o.ApplyT(func(v ApiManagementServiceSkuPropertiesInvokeResponse) int { return v.Capacity }).(pulumi.IntOutput)
}
...
// Control Plane Apis version constraint for the API Management service.
type ApiVersionConstraintInvokeResponse struct {
	// Limit control plane API calls to API Management service with version equal to or newer than this value.
	MinApiVersion *string `pulumi:"minApiVersion"`
}

// ApiVersionConstraintInvokeResponseInput is an input type that accepts ApiVersionConstraintInvokeResponseArgs and ApiVersionConstraintInvokeResponseOutput values.
// You can construct a concrete instance of `ApiVersionConstraintInvokeResponseInput` via:
//
//          ApiVersionConstraintInvokeResponseArgs{...}
type ApiVersionConstraintInvokeResponseInput interface {
	pulumi.Input

	ToApiVersionConstraintInvokeResponseOutput() ApiVersionConstraintInvokeResponseOutput
	ToApiVersionConstraintInvokeResponseOutputWithContext(context.Context) ApiVersionConstraintInvokeResponseOutput
}

// Control Plane Apis version constraint for the API Management service.
type ApiVersionConstraintInvokeResponseArgs struct {
	// Limit control plane API calls to API Management service with version equal to or newer than this value.
	MinApiVersion pulumi.StringPtrInput `pulumi:"minApiVersion"`
}

func (ApiVersionConstraintInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ApiVersionConstraintInvokeResponse)(nil)).Elem()
}

func (i ApiVersionConstraintInvokeResponseArgs) ToApiVersionConstraintInvokeResponseOutput() ApiVersionConstraintInvokeResponseOutput {
	return i.ToApiVersionConstraintInvokeResponseOutputWithContext(context.Background())
}

func (i ApiVersionConstraintInvokeResponseArgs) ToApiVersionConstraintInvokeResponseOutputWithContext(ctx context.Context) ApiVersionConstraintInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ApiVersionConstraintInvokeResponseOutput)
}

// Control Plane Apis version constraint for the API Management service.
type ApiVersionConstraintInvokeResponseOutput struct{ *pulumi.OutputState }

func (ApiVersionConstraintInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ApiVersionConstraintInvokeResponse)(nil)).Elem()
}

func (o ApiVersionConstraintInvokeResponseOutput) ToApiVersionConstraintInvokeResponseOutput() ApiVersionConstraintInvokeResponseOutput {
	return o
}

func (o ApiVersionConstraintInvokeResponseOutput) ToApiVersionConstraintInvokeResponseOutputWithContext(ctx context.Context) ApiVersionConstraintInvokeResponseOutput {
	return o
}

// Limit control plane API calls to API Management service with version equal to or newer than this value.
func (o ApiVersionConstraintInvokeResponseOutput) MinApiVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ApiVersionConstraintInvokeResponse) *string { return v.MinApiVersion }).(pulumi.StringPtrOutput)
}
...
// List of Client Certificate Ids.
func (o BackendCredentialsContractInvokeResponseOutput) CertificateIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v BackendCredentialsContractInvokeResponse) []string { return v.CertificateIds }).(pulumi.StringArrayOutput)
}
...
// The client certificate id for the management endpoint.
func (o BackendServiceFabricClusterPropertiesInvokeResponseOutput) ClientCertificateId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v BackendServiceFabricClusterPropertiesInvokeResponse) *string { return v.ClientCertificateId }).(pulumi.StringPtrOutput)
}

// The client certificate thumbprint for the management endpoint. Will be ignored if certificatesIds are provided
func (o BackendServiceFabricClusterPropertiesInvokeResponseOutput) ClientCertificatethumbprint() pulumi.StringPtrOutput {
...
// The client certificate id for the management endpoint.
func (o BackendServiceFabricClusterPropertiesInvokeResponsePtrOutput) ClientCertificateId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *BackendServiceFabricClusterPropertiesInvokeResponse) *string {
		if v == nil {
			return nil
		}
...
type DataMaskingEntityInvokeResponse struct {
	// Data masking mode.
	Mode *string `pulumi:"mode"`
	// The name of an entity to mask (e.g. a name of a header or a query parameter).
	Value *string `pulumi:"value"`
...
// DataMaskingEntityInvokeResponseInput is an input type that accepts DataMaskingEntityInvokeResponseArgs and DataMaskingEntityInvokeResponseOutput values.
// You can construct a concrete instance of `DataMaskingEntityInvokeResponseInput` via:
//
//          DataMaskingEntityInvokeResponseArgs{...}
type DataMaskingEntityInvokeResponseInput interface {
	pulumi.Input

	ToDataMaskingEntityInvokeResponseOutput() DataMaskingEntityInvokeResponseOutput
	ToDataMaskingEntityInvokeResponseOutputWithContext(context.Context) DataMaskingEntityInvokeResponseOutput
}

type DataMaskingEntityInvokeResponseArgs struct {
	// Data masking mode.
	Mode pulumi.StringPtrInput `pulumi:"mode"`
	// The name of an entity to mask (e.g. a name of a header or a query parameter).
	Value pulumi.StringPtrInput `pulumi:"value"`
...
func (DataMaskingEntityInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*DataMaskingEntityInvokeResponse)(nil)).Elem()
}

func (i DataMaskingEntityInvokeResponseArgs) ToDataMaskingEntityInvokeResponseOutput() DataMaskingEntityInvokeResponseOutput {
	return i.ToDataMaskingEntityInvokeResponseOutputWithContext(context.Background())
}

func (i DataMaskingEntityInvokeResponseArgs) ToDataMaskingEntityInvokeResponseOutputWithContext(ctx context.Context) DataMaskingEntityInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataMaskingEntityInvokeResponseOutput)
}

// DataMaskingEntityInvokeResponseArrayInput is an input type that accepts DataMaskingEntityInvokeResponseArray and DataMaskingEntityInvokeResponseArrayOutput values.
// You can construct a concrete instance of `DataMaskingEntityInvokeResponseArrayInput` via:
//
//          DataMaskingEntityInvokeResponseArray{ DataMaskingEntityInvokeResponseArgs{...} }
type DataMaskingEntityInvokeResponseArrayInput interface {
	pulumi.Input

	ToDataMaskingEntityInvokeResponseArrayOutput() DataMaskingEntityInvokeResponseArrayOutput
	ToDataMaskingEntityInvokeResponseArrayOutputWithContext(context.Context) DataMaskingEntityInvokeResponseArrayOutput
}

type DataMaskingEntityInvokeResponseArray []DataMaskingEntityInvokeResponseInput

func (DataMaskingEntityInvokeResponseArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]DataMaskingEntityInvokeResponse)(nil)).Elem()
}

func (i DataMaskingEntityInvokeResponseArray) ToDataMaskingEntityInvokeResponseArrayOutput() DataMaskingEntityInvokeResponseArrayOutput {
	return i.ToDataMaskingEntityInvokeResponseArrayOutputWithContext(context.Background())
}

func (i DataMaskingEntityInvokeResponseArray) ToDataMaskingEntityInvokeResponseArrayOutputWithContext(ctx context.Context) DataMaskingEntityInvokeResponseArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataMaskingEntityInvokeResponseArrayOutput)
}

type DataMaskingEntityInvokeResponseOutput struct{ *pulumi.OutputState }

func (DataMaskingEntityInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DataMaskingEntityInvokeResponse)(nil)).Elem()
}

func (o DataMaskingEntityInvokeResponseOutput) ToDataMaskingEntityInvokeResponseOutput() DataMaskingEntityInvokeResponseOutput {
	return o
}

func (o DataMaskingEntityInvokeResponseOutput) ToDataMaskingEntityInvokeResponseOutputWithContext(ctx context.Context) DataMaskingEntityInvokeResponseOutput {
	return o
}

// Data masking mode.
func (o DataMaskingEntityInvokeResponseOutput) Mode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DataMaskingEntityInvokeResponse) *string { return v.Mode }).(pulumi.StringPtrOutput)
}

// The name of an entity to mask (e.g. a name of a header or a query parameter).
func (o DataMaskingEntityInvokeResponseOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DataMaskingEntityInvokeResponse) *string { return v.Value }).(pulumi.StringPtrOutput)
}

type DataMaskingEntityInvokeResponseArrayOutput struct{ *pulumi.OutputState }

func (DataMaskingEntityInvokeResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]DataMaskingEntityInvokeResponse)(nil)).Elem()
}

func (o DataMaskingEntityInvokeResponseArrayOutput) ToDataMaskingEntityInvokeResponseArrayOutput() DataMaskingEntityInvokeResponseArrayOutput {
	return o
}

func (o DataMaskingEntityInvokeResponseArrayOutput) ToDataMaskingEntityInvokeResponseArrayOutputWithContext(ctx context.Context) DataMaskingEntityInvokeResponseArrayOutput {
	return o
}

func (o DataMaskingEntityInvokeResponseArrayOutput) Index(i pulumi.IntInput) DataMaskingEntityInvokeResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) DataMaskingEntityInvokeResponse {
		return vs[0].([]DataMaskingEntityInvokeResponse)[vs[1].(int)]
	}).(DataMaskingEntityInvokeResponseOutput)
}
...
type DataMaskingInvokeResponse struct {
	// Masking settings for headers
	Headers []DataMaskingEntityInvokeResponse `pulumi:"headers"`
	// Masking settings for Url query parameters
	QueryParams []DataMaskingEntityInvokeResponse `pulumi:"queryParams"`
}

// DataMaskingInvokeResponseInput is an input type that accepts DataMaskingInvokeResponseArgs and DataMaskingInvokeResponseOutput values.
// You can construct a concrete instance of `DataMaskingInvokeResponseInput` via:
//
//          DataMaskingInvokeResponseArgs{...}
type DataMaskingInvokeResponseInput interface {
	pulumi.Input

	ToDataMaskingInvokeResponseOutput() DataMaskingInvokeResponseOutput
	ToDataMaskingInvokeResponseOutputWithContext(context.Context) DataMaskingInvokeResponseOutput
}

type DataMaskingInvokeResponseArgs struct {
	// Masking settings for headers
	Headers DataMaskingEntityInvokeResponseArrayInput `pulumi:"headers"`
	// Masking settings for Url query parameters
	QueryParams DataMaskingEntityInvokeResponseArrayInput `pulumi:"queryParams"`
}

func (DataMaskingInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*DataMaskingInvokeResponse)(nil)).Elem()
}

func (i DataMaskingInvokeResponseArgs) ToDataMaskingInvokeResponseOutput() DataMaskingInvokeResponseOutput {
	return i.ToDataMaskingInvokeResponseOutputWithContext(context.Background())
}

func (i DataMaskingInvokeResponseArgs) ToDataMaskingInvokeResponseOutputWithContext(ctx context.Context) DataMaskingInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataMaskingInvokeResponseOutput)
}

func (i DataMaskingInvokeResponseArgs) ToDataMaskingInvokeResponsePtrOutput() DataMaskingInvokeResponsePtrOutput {
	return i.ToDataMaskingInvokeResponsePtrOutputWithContext(context.Background())
}

func (i DataMaskingInvokeResponseArgs) ToDataMaskingInvokeResponsePtrOutputWithContext(ctx context.Context) DataMaskingInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataMaskingInvokeResponseOutput).ToDataMaskingInvokeResponsePtrOutputWithContext(ctx)
}

// DataMaskingInvokeResponsePtrInput is an input type that accepts DataMaskingInvokeResponseArgs, DataMaskingInvokeResponsePtr and DataMaskingInvokeResponsePtrOutput values.
// You can construct a concrete instance of `DataMaskingInvokeResponsePtrInput` via:
//
//          DataMaskingInvokeResponseArgs{...}
//
//  or:
//
//          nil
type DataMaskingInvokeResponsePtrInput interface {
	pulumi.Input

	ToDataMaskingInvokeResponsePtrOutput() DataMaskingInvokeResponsePtrOutput
	ToDataMaskingInvokeResponsePtrOutputWithContext(context.Context) DataMaskingInvokeResponsePtrOutput
}

type dataMaskingInvokeResponsePtrType DataMaskingInvokeResponseArgs

func DataMaskingInvokeResponsePtr(v *DataMaskingInvokeResponseArgs) DataMaskingInvokeResponsePtrInput {
	return (*dataMaskingInvokeResponsePtrType)(v)
}

func (*dataMaskingInvokeResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**DataMaskingInvokeResponse)(nil)).Elem()
}

func (i *dataMaskingInvokeResponsePtrType) ToDataMaskingInvokeResponsePtrOutput() DataMaskingInvokeResponsePtrOutput {
	return i.ToDataMaskingInvokeResponsePtrOutputWithContext(context.Background())
}

func (i *dataMaskingInvokeResponsePtrType) ToDataMaskingInvokeResponsePtrOutputWithContext(ctx context.Context) DataMaskingInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataMaskingInvokeResponsePtrOutput)
}

type DataMaskingInvokeResponseOutput struct{ *pulumi.OutputState }

func (DataMaskingInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DataMaskingInvokeResponse)(nil)).Elem()
}

func (o DataMaskingInvokeResponseOutput) ToDataMaskingInvokeResponseOutput() DataMaskingInvokeResponseOutput {
	return o
}

func (o DataMaskingInvokeResponseOutput) ToDataMaskingInvokeResponseOutputWithContext(ctx context.Context) DataMaskingInvokeResponseOutput {
	return o
}

func (o DataMaskingInvokeResponseOutput) ToDataMaskingInvokeResponsePtrOutput() DataMaskingInvokeResponsePtrOutput {
	return o.ToDataMaskingInvokeResponsePtrOutputWithContext(context.Background())
}

func (o DataMaskingInvokeResponseOutput) ToDataMaskingInvokeResponsePtrOutputWithContext(ctx context.Context) DataMaskingInvokeResponsePtrOutput {
	return o.ApplyT(func(v DataMaskingInvokeResponse) *DataMaskingInvokeResponse {
		return &v
	}).(DataMaskingInvokeResponsePtrOutput)
}

// Masking settings for headers
func (o DataMaskingInvokeResponseOutput) Headers() DataMaskingEntityInvokeResponseArrayOutput {
	return o.ApplyT(func(v DataMaskingInvokeResponse) []DataMaskingEntityInvokeResponse { return v.Headers }).(DataMaskingEntityInvokeResponseArrayOutput)
}

// Masking settings for Url query parameters
func (o DataMaskingInvokeResponseOutput) QueryParams() DataMaskingEntityInvokeResponseArrayOutput {
	return o.ApplyT(func(v DataMaskingInvokeResponse) []DataMaskingEntityInvokeResponse { return v.QueryParams }).(DataMaskingEntityInvokeResponseArrayOutput)
}

type DataMaskingInvokeResponsePtrOutput struct{ *pulumi.OutputState }

func (DataMaskingInvokeResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DataMaskingInvokeResponse)(nil)).Elem()
}

func (o DataMaskingInvokeResponsePtrOutput) ToDataMaskingInvokeResponsePtrOutput() DataMaskingInvokeResponsePtrOutput {
	return o
}

func (o DataMaskingInvokeResponsePtrOutput) ToDataMaskingInvokeResponsePtrOutputWithContext(ctx context.Context) DataMaskingInvokeResponsePtrOutput {
	return o
}

func (o DataMaskingInvokeResponsePtrOutput) Elem() DataMaskingInvokeResponseOutput {
	return o.ApplyT(func(v *DataMaskingInvokeResponse) DataMaskingInvokeResponse { return *v }).(DataMaskingInvokeResponseOutput)
}

// Masking settings for headers
func (o DataMaskingInvokeResponsePtrOutput) Headers() DataMaskingEntityInvokeResponseArrayOutput {
	return o.ApplyT(func(v *DataMaskingInvokeResponse) []DataMaskingEntityInvokeResponse {
		if v == nil {
			return nil
		}
		return v.Headers
	}).(DataMaskingEntityInvokeResponseArrayOutput)
}

// Masking settings for Url query parameters
func (o DataMaskingInvokeResponsePtrOutput) QueryParams() DataMaskingEntityInvokeResponseArrayOutput {
	return o.ApplyT(func(v *DataMaskingInvokeResponse) []DataMaskingEntityInvokeResponse {
		if v == nil {
			return nil
		}
...
// System or User Assigned Managed identity clientId as generated by Azure AD, which has GET access to the keyVault containing the SSL certificate.
func (o HostnameConfigurationInvokeResponseOutput) IdentityClientId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v HostnameConfigurationInvokeResponse) *string { return v.IdentityClientId }).(pulumi.StringPtrOutput)
}
...
type HttpMessageDiagnosticInvokeResponse struct {
	...
	// Data masking settings.
	DataMasking *DataMaskingInvokeResponse `pulumi:"dataMasking"`
	// Array of HTTP Headers to log.
	Headers []string `pulumi:"headers"`
}
...
type HttpMessageDiagnosticInvokeResponseArgs struct {
	...
	// Data masking settings.
	DataMasking DataMaskingInvokeResponsePtrInput `pulumi:"dataMasking"`
	// Array of HTTP Headers to log.
	Headers pulumi.StringArrayInput `pulumi:"headers"`
}
...
// Data masking settings.
func (o HttpMessageDiagnosticInvokeResponseOutput) DataMasking() DataMaskingInvokeResponsePtrOutput {
	return o.ApplyT(func(v HttpMessageDiagnosticInvokeResponse) *DataMaskingInvokeResponse { return v.DataMasking }).(DataMaskingInvokeResponsePtrOutput)
}
...
// Data masking settings.
func (o HttpMessageDiagnosticInvokeResponsePtrOutput) DataMasking() DataMaskingInvokeResponsePtrOutput {
	return o.ApplyT(func(v *HttpMessageDiagnosticInvokeResponse) *DataMaskingInvokeResponse {
		if v == nil {
			return nil
		}
		return v.DataMasking
...
type KeyVaultContractPropertiesInvokeResponse struct {
	// SystemAssignedIdentity or UserAssignedIdentity Client Id which will be used to access key vault secret.
	IdentityClientId *string `pulumi:"identityClientId"`
	// Last time sync and refresh status of secret from key vault.
	LastStatus *KeyVaultLastAccessStatusContractPropertiesInvokeResponse `pulumi:"lastStatus"`
	// Key vault secret identifier for fetching secret. Providing a versioned secret will prevent auto-refresh. This requires Api Management service to be configured with aka.ms/apimmsi
	SecretIdentifier *string `pulumi:"secretIdentifier"`
}

// KeyVaultContractPropertiesInvokeResponseInput is an input type that accepts KeyVaultContractPropertiesInvokeResponseArgs and KeyVaultContractPropertiesInvokeResponseOutput values.
// You can construct a concrete instance of `KeyVaultContractPropertiesInvokeResponseInput` via:
//
//          KeyVaultContractPropertiesInvokeResponseArgs{...}
type KeyVaultContractPropertiesInvokeResponseInput interface {
	pulumi.Input

	ToKeyVaultContractPropertiesInvokeResponseOutput() KeyVaultContractPropertiesInvokeResponseOutput
	ToKeyVaultContractPropertiesInvokeResponseOutputWithContext(context.Context) KeyVaultContractPropertiesInvokeResponseOutput
}

// KeyVault contract details.
type KeyVaultContractPropertiesInvokeResponseArgs struct {
	// SystemAssignedIdentity or UserAssignedIdentity Client Id which will be used to access key vault secret.
	IdentityClientId pulumi.StringPtrInput `pulumi:"identityClientId"`
	// Last time sync and refresh status of secret from key vault.
	LastStatus KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrInput `pulumi:"lastStatus"`
	// Key vault secret identifier for fetching secret. Providing a versioned secret will prevent auto-refresh. This requires Api Management service to be configured with aka.ms/apimmsi
	SecretIdentifier pulumi.StringPtrInput `pulumi:"secretIdentifier"`
}

func (KeyVaultContractPropertiesInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*KeyVaultContractPropertiesInvokeResponse)(nil)).Elem()
}

func (i KeyVaultContractPropertiesInvokeResponseArgs) ToKeyVaultContractPropertiesInvokeResponseOutput() KeyVaultContractPropertiesInvokeResponseOutput {
	return i.ToKeyVaultContractPropertiesInvokeResponseOutputWithContext(context.Background())
}

func (i KeyVaultContractPropertiesInvokeResponseArgs) ToKeyVaultContractPropertiesInvokeResponseOutputWithContext(ctx context.Context) KeyVaultContractPropertiesInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KeyVaultContractPropertiesInvokeResponseOutput)
}

// KeyVault contract details.
type KeyVaultContractPropertiesInvokeResponseOutput struct{ *pulumi.OutputState }

func (KeyVaultContractPropertiesInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*KeyVaultContractPropertiesInvokeResponse)(nil)).Elem()
}

func (o KeyVaultContractPropertiesInvokeResponseOutput) ToKeyVaultContractPropertiesInvokeResponseOutput() KeyVaultContractPropertiesInvokeResponseOutput {
	return o
}

func (o KeyVaultContractPropertiesInvokeResponseOutput) ToKeyVaultContractPropertiesInvokeResponseOutputWithContext(ctx context.Context) KeyVaultContractPropertiesInvokeResponseOutput {
	return o
}

// SystemAssignedIdentity or UserAssignedIdentity Client Id which will be used to access key vault secret.
func (o KeyVaultContractPropertiesInvokeResponseOutput) IdentityClientId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KeyVaultContractPropertiesInvokeResponse) *string { return v.IdentityClientId }).(pulumi.StringPtrOutput)
}

// Last time sync and refresh status of secret from key vault.
func (o KeyVaultContractPropertiesInvokeResponseOutput) LastStatus() KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput {
	return o.ApplyT(func(v KeyVaultContractPropertiesInvokeResponse) *KeyVaultLastAccessStatusContractPropertiesInvokeResponse {
		return v.LastStatus
	}).(KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput)
}

// Key vault secret identifier for fetching secret. Providing a versioned secret will prevent auto-refresh. This requires Api Management service to be configured with aka.ms/apimmsi
func (o KeyVaultContractPropertiesInvokeResponseOutput) SecretIdentifier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KeyVaultContractPropertiesInvokeResponse) *string { return v.SecretIdentifier }).(pulumi.StringPtrOutput)
}
...
type KeyVaultLastAccessStatusContractPropertiesInvokeResponse struct {
...
// KeyVaultLastAccessStatusContractPropertiesInvokeResponseInput is an input type that accepts KeyVaultLastAccessStatusContractPropertiesInvokeResponseArgs and KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput values.
// You can construct a concrete instance of `KeyVaultLastAccessStatusContractPropertiesInvokeResponseInput` via:
//
//          KeyVaultLastAccessStatusContractPropertiesInvokeResponseArgs{...}
type KeyVaultLastAccessStatusContractPropertiesInvokeResponseInput interface {
	pulumi.Input

	ToKeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput() KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput
	ToKeyVaultLastAccessStatusContractPropertiesInvokeResponseOutputWithContext(context.Context) KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput
}

// Issue contract Update Properties.
type KeyVaultLastAccessStatusContractPropertiesInvokeResponseArgs struct {
	// Last status code for sync and refresh of secret from key vault.
...
func (KeyVaultLastAccessStatusContractPropertiesInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*KeyVaultLastAccessStatusContractPropertiesInvokeResponse)(nil)).Elem()
}

func (i KeyVaultLastAccessStatusContractPropertiesInvokeResponseArgs) ToKeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput() KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput {
	return i.ToKeyVaultLastAccessStatusContractPropertiesInvokeResponseOutputWithContext(context.Background())
}

func (i KeyVaultLastAccessStatusContractPropertiesInvokeResponseArgs) ToKeyVaultLastAccessStatusContractPropertiesInvokeResponseOutputWithContext(ctx context.Context) KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput)
}

func (i KeyVaultLastAccessStatusContractPropertiesInvokeResponseArgs) ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput() KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput {
	return i.ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutputWithContext(context.Background())
}

func (i KeyVaultLastAccessStatusContractPropertiesInvokeResponseArgs) ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutputWithContext(ctx context.Context) KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput).ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutputWithContext(ctx)
}

// KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrInput is an input type that accepts KeyVaultLastAccessStatusContractPropertiesInvokeResponseArgs, KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtr and KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput values.
// You can construct a concrete instance of `KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrInput` via:
//
//          KeyVaultLastAccessStatusContractPropertiesInvokeResponseArgs{...}
//
//  or:
//
//          nil
type KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrInput interface {
	pulumi.Input

	ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput() KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput
	ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutputWithContext(context.Context) KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput
}

type keyVaultLastAccessStatusContractPropertiesInvokeResponsePtrType KeyVaultLastAccessStatusContractPropertiesInvokeResponseArgs

func KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtr(v *KeyVaultLastAccessStatusContractPropertiesInvokeResponseArgs) KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrInput {
	return (*keyVaultLastAccessStatusContractPropertiesInvokeResponsePtrType)(v)
}

func (*keyVaultLastAccessStatusContractPropertiesInvokeResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**KeyVaultLastAccessStatusContractPropertiesInvokeResponse)(nil)).Elem()
}

func (i *keyVaultLastAccessStatusContractPropertiesInvokeResponsePtrType) ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput() KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput {
	return i.ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutputWithContext(context.Background())
}

func (i *keyVaultLastAccessStatusContractPropertiesInvokeResponsePtrType) ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutputWithContext(ctx context.Context) KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput)
}

// Issue contract Update Properties.
type KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput struct{ *pulumi.OutputState }

func (KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*KeyVaultLastAccessStatusContractPropertiesInvokeResponse)(nil)).Elem()
}

func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput) ToKeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput() KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput {
	return o
}

func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput) ToKeyVaultLastAccessStatusContractPropertiesInvokeResponseOutputWithContext(ctx context.Context) KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput {
	return o
}

func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput) ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput() KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput {
	return o.ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutputWithContext(context.Background())
}

func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput) ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutputWithContext(ctx context.Context) KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput {
	return o.ApplyT(func(v KeyVaultLastAccessStatusContractPropertiesInvokeResponse) *KeyVaultLastAccessStatusContractPropertiesInvokeResponse {
		return &v
	}).(KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput)
}

// Last status code for sync and refresh of secret from key vault.
func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput) Code() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KeyVaultLastAccessStatusContractPropertiesInvokeResponse) *string { return v.Code }).(pulumi.StringPtrOutput)
}

// Details of the error else empty.
func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput) Message() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KeyVaultLastAccessStatusContractPropertiesInvokeResponse) *string { return v.Message }).(pulumi.StringPtrOutput)
}

// Last time secret was accessed. The date conforms to the following format: `yyyy-MM-ddTHH:mm:ssZ` as specified by the ISO 8601 standard.
func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput) TimeStampUtc() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KeyVaultLastAccessStatusContractPropertiesInvokeResponse) *string { return v.TimeStampUtc }).(pulumi.StringPtrOutput)
}

type KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput struct{ *pulumi.OutputState }

func (KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**KeyVaultLastAccessStatusContractPropertiesInvokeResponse)(nil)).Elem()
}

func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput) ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput() KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput {
	return o
}

func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput) ToKeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutputWithContext(ctx context.Context) KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput {
	return o
}

func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput) Elem() KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput {
	return o.ApplyT(func(v *KeyVaultLastAccessStatusContractPropertiesInvokeResponse) KeyVaultLastAccessStatusContractPropertiesInvokeResponse {
		return *v
	}).(KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput)
}

// Last status code for sync and refresh of secret from key vault.
func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput) Code() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KeyVaultLastAccessStatusContractPropertiesInvokeResponse) *string {
		if v == nil {
			return nil
		}
		return v.Code
...
// Details of the error else empty.
func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput) Message() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KeyVaultLastAccessStatusContractPropertiesInvokeResponse) *string {
		if v == nil {
			return nil
		}
...
// Last time secret was accessed. The date conforms to the following format: `yyyy-MM-ddTHH:mm:ssZ` as specified by the ISO 8601 standard.
func (o KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput) TimeStampUtc() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KeyVaultLastAccessStatusContractPropertiesInvokeResponse) *string {
		if v == nil {
			return nil
		}
...
// Resource location data properties.
type ResourceLocationDataContractInvokeResponse struct {
	// The city or locality where the resource is located.
	City *string `pulumi:"city"`
	// The country or region where the resource is located.
	CountryOrRegion *string `pulumi:"countryOrRegion"`
...
// ResourceLocationDataContractInvokeResponseInput is an input type that accepts ResourceLocationDataContractInvokeResponseArgs and ResourceLocationDataContractInvokeResponseOutput values.
// You can construct a concrete instance of `ResourceLocationDataContractInvokeResponseInput` via:
//
//          ResourceLocationDataContractInvokeResponseArgs{...}
type ResourceLocationDataContractInvokeResponseInput interface {
	pulumi.Input

	ToResourceLocationDataContractInvokeResponseOutput() ResourceLocationDataContractInvokeResponseOutput
	ToResourceLocationDataContractInvokeResponseOutputWithContext(context.Context) ResourceLocationDataContractInvokeResponseOutput
}

// Resource location data properties.
type ResourceLocationDataContractInvokeResponseArgs struct {
	// The city or locality where the resource is located.
	City pulumi.StringPtrInput `pulumi:"city"`
	// The country or region where the resource is located.
	CountryOrRegion pulumi.StringPtrInput `pulumi:"countryOrRegion"`
...
func (ResourceLocationDataContractInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ResourceLocationDataContractInvokeResponse)(nil)).Elem()
}

func (i ResourceLocationDataContractInvokeResponseArgs) ToResourceLocationDataContractInvokeResponseOutput() ResourceLocationDataContractInvokeResponseOutput {
	return i.ToResourceLocationDataContractInvokeResponseOutputWithContext(context.Background())
}

func (i ResourceLocationDataContractInvokeResponseArgs) ToResourceLocationDataContractInvokeResponseOutputWithContext(ctx context.Context) ResourceLocationDataContractInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ResourceLocationDataContractInvokeResponseOutput)
}

// Resource location data properties.
type ResourceLocationDataContractInvokeResponseOutput struct{ *pulumi.OutputState }

func (ResourceLocationDataContractInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ResourceLocationDataContractInvokeResponse)(nil)).Elem()
}

func (o ResourceLocationDataContractInvokeResponseOutput) ToResourceLocationDataContractInvokeResponseOutput() ResourceLocationDataContractInvokeResponseOutput {
	return o
}

func (o ResourceLocationDataContractInvokeResponseOutput) ToResourceLocationDataContractInvokeResponseOutputWithContext(ctx context.Context) ResourceLocationDataContractInvokeResponseOutput {
	return o
}

// The city or locality where the resource is located.
func (o ResourceLocationDataContractInvokeResponseOutput) City() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ResourceLocationDataContractInvokeResponse) *string { return v.City }).(pulumi.StringPtrOutput)
}

// The country or region where the resource is located.
func (o ResourceLocationDataContractInvokeResponseOutput) CountryOrRegion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ResourceLocationDataContractInvokeResponse) *string { return v.CountryOrRegion }).(pulumi.StringPtrOutput)
}

// The district, state, or province where the resource is located.
func (o ResourceLocationDataContractInvokeResponseOutput) District() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ResourceLocationDataContractInvokeResponse) *string { return v.District }).(pulumi.StringPtrOutput)
}

// A canonical name for the geographic or physical location.
func (o ResourceLocationDataContractInvokeResponseOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v ResourceLocationDataContractInvokeResponse) string { return v.Name }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ApiVersionConstraintInvokeResponseOutput{})
	...
	pulumi.RegisterOutputType(DataMaskingEntityInvokeResponseOutput{})
	pulumi.RegisterOutputType(DataMaskingEntityInvokeResponseArrayOutput{})
	pulumi.RegisterOutputType(DataMaskingEntityResponseOutput{})
	pulumi.RegisterOutputType(DataMaskingEntityResponseArrayOutput{})
	pulumi.RegisterOutputType(DataMaskingInvokeResponseOutput{})
	pulumi.RegisterOutputType(DataMaskingInvokeResponsePtrOutput{})
	...
	pulumi.RegisterOutputType(KeyVaultContractPropertiesInvokeResponseOutput{})
	...
	pulumi.RegisterOutputType(KeyVaultLastAccessStatusContractPropertiesInvokeResponseOutput{})
	pulumi.RegisterOutputType(KeyVaultLastAccessStatusContractPropertiesInvokeResponsePtrOutput{})
	...
	pulumi.RegisterOutputType(ResourceLocationDataContractInvokeResponseOutput{})
