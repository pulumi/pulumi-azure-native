...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AdditionalRegionInput)(nil)).Elem(), AdditionalRegionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdditionalRegionArrayInput)(nil)).Elem(), AdditionalRegionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdditionalRegionResponseInput)(nil)).Elem(), AdditionalRegionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdditionalRegionResponseArrayInput)(nil)).Elem(), AdditionalRegionResponseArray{})
