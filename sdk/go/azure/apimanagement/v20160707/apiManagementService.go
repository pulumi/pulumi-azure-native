...
func NewApiManagementService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20160707:ApiManagementService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiManagementService(ctx *pulumi.Context,
	...
	var resource ApiManagementService
	err := ctx.ReadResource("azure-native:apimanagement/v20160707:ApiManagementService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o ApiManagementServiceOutput) Etag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ApiManagementService) pulumi.StringPtrOutput { return v.Etag }).(pulumi.StringPtrOutput)
}
