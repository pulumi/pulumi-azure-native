...
func NewBackend(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement:Backend", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackend(ctx *pulumi.Context,
	...
	var resource Backend
	err := ctx.ReadResource("azure-nextgen:apimanagement:Backend", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
