...
func NewApiDiagnosticLogger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement:ApiDiagnosticLogger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiDiagnosticLogger(ctx *pulumi.Context,
	...
	var resource ApiDiagnosticLogger
	err := ctx.ReadResource("azure-nextgen:apimanagement:ApiDiagnosticLogger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
