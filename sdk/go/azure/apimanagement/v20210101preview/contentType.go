...
func NewContentType(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:apimanagement/v20210801:ContentType"),
		},
	})
	opts = append(opts, aliases)
	var resource ContentType
	err := ctx.RegisterResource("azure-native:apimanagement/v20210101preview:ContentType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentType(ctx *pulumi.Context,
	...
	var resource ContentType
	err := ctx.ReadResource("azure-native:apimanagement/v20210101preview:ContentType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ContentTypeInput)(nil)).Elem(), &ContentType{})
