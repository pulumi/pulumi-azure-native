...
func NewGroupUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement/latest:GroupUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupUser(ctx *pulumi.Context,
	...
	var resource GroupUser
	err := ctx.ReadResource("azure-nextgen:apimanagement/latest:GroupUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
