...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:apimanagement:GatewayCertificateAuthority'.
...
func NewGatewayCertificateAuthority(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/latest:GatewayCertificateAuthority", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayCertificateAuthority(ctx *pulumi.Context,
	...
	var resource GatewayCertificateAuthority
	err := ctx.ReadResource("azure-native:apimanagement/latest:GatewayCertificateAuthority", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
