...
func NewPrivateEndpointConnectionByName(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:apimanagement/v20210801:PrivateEndpointConnectionByName"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20210801:PrivateEndpointConnectionByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionByName(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionByName
	err := ctx.ReadResource("azure-native:apimanagement/v20210801:PrivateEndpointConnectionByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateEndpointConnectionByNameInput)(nil)).Elem(), &PrivateEndpointConnectionByName{})
