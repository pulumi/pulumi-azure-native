...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AlwaysLogInput)(nil)).Elem(), AlwaysLog("allErrors"))
	pulumi.RegisterInputType(reflect.TypeOf((*AlwaysLogPtrInput)(nil)).Elem(), AlwaysLog("allErrors"))
	pulumi.RegisterInputType(reflect.TypeOf((*ApiTypeInput)(nil)).Elem(), ApiType("http"))
	pulumi.RegisterInputType(reflect.TypeOf((*ApiTypePtrInput)(nil)).Elem(), ApiType("http"))
	pulumi.RegisterInputType(reflect.TypeOf((*ApimIdentityTypeInput)(nil)).Elem(), ApimIdentityType("SystemAssigned"))
	pulumi.RegisterInputType(reflect.TypeOf((*ApimIdentityTypePtrInput)(nil)).Elem(), ApimIdentityType("SystemAssigned"))
	pulumi.RegisterInputType(reflect.TypeOf((*AppTypeInput)(nil)).Elem(), AppType("portal"))
	pulumi.RegisterInputType(reflect.TypeOf((*AppTypePtrInput)(nil)).Elem(), AppType("portal"))
	pulumi.RegisterInputType(reflect.TypeOf((*AuthorizationMethodInput)(nil)).Elem(), AuthorizationMethod("HEAD"))
	pulumi.RegisterInputType(reflect.TypeOf((*AuthorizationMethodPtrInput)(nil)).Elem(), AuthorizationMethod("HEAD"))
	pulumi.RegisterInputType(reflect.TypeOf((*AuthorizationMethodArrayInput)(nil)).Elem(), AuthorizationMethodArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackendProtocolInput)(nil)).Elem(), BackendProtocol("http"))
	pulumi.RegisterInputType(reflect.TypeOf((*BackendProtocolPtrInput)(nil)).Elem(), BackendProtocol("http"))
	pulumi.RegisterInputType(reflect.TypeOf((*BearerTokenSendingMethodInput)(nil)).Elem(), BearerTokenSendingMethod("authorizationHeader"))
	pulumi.RegisterInputType(reflect.TypeOf((*BearerTokenSendingMethodPtrInput)(nil)).Elem(), BearerTokenSendingMethod("authorizationHeader"))
	pulumi.RegisterInputType(reflect.TypeOf((*BearerTokenSendingMethodsInput)(nil)).Elem(), BearerTokenSendingMethods("authorizationHeader"))
	pulumi.RegisterInputType(reflect.TypeOf((*BearerTokenSendingMethodsPtrInput)(nil)).Elem(), BearerTokenSendingMethods("authorizationHeader"))
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateSourceInput)(nil)).Elem(), CertificateSource("Managed"))
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateSourcePtrInput)(nil)).Elem(), CertificateSource("Managed"))
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateStatusInput)(nil)).Elem(), CertificateStatus("Completed"))
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateStatusPtrInput)(nil)).Elem(), CertificateStatus("Completed"))
	pulumi.RegisterInputType(reflect.TypeOf((*ClientAuthenticationMethodInput)(nil)).Elem(), ClientAuthenticationMethod("Basic"))
	pulumi.RegisterInputType(reflect.TypeOf((*ClientAuthenticationMethodPtrInput)(nil)).Elem(), ClientAuthenticationMethod("Basic"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConfirmationInput)(nil)).Elem(), Confirmation("signup"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConfirmationPtrInput)(nil)).Elem(), Confirmation("signup"))
	pulumi.RegisterInputType(reflect.TypeOf((*ContentFormatInput)(nil)).Elem(), ContentFormat("wadl-xml"))
	pulumi.RegisterInputType(reflect.TypeOf((*ContentFormatPtrInput)(nil)).Elem(), ContentFormat("wadl-xml"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataMaskingModeInput)(nil)).Elem(), DataMaskingMode("Mask"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataMaskingModePtrInput)(nil)).Elem(), DataMaskingMode("Mask"))
	pulumi.RegisterInputType(reflect.TypeOf((*GrantTypeInput)(nil)).Elem(), GrantType("authorizationCode"))
	pulumi.RegisterInputType(reflect.TypeOf((*GrantTypePtrInput)(nil)).Elem(), GrantType("authorizationCode"))
	pulumi.RegisterInputType(reflect.TypeOf((*GroupTypeInput)(nil)).Elem(), GroupType("custom"))
	pulumi.RegisterInputType(reflect.TypeOf((*GroupTypePtrInput)(nil)).Elem(), GroupType("custom"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HttpCorrelationProtocolInput)(nil)).Elem(), HttpCorrelationProtocol("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*HttpCorrelationProtocolPtrInput)(nil)).Elem(), HttpCorrelationProtocol("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*IdentityProviderTypeInput)(nil)).Elem(), IdentityProviderType("facebook"))
	pulumi.RegisterInputType(reflect.TypeOf((*IdentityProviderTypePtrInput)(nil)).Elem(), IdentityProviderType("facebook"))
	pulumi.RegisterInputType(reflect.TypeOf((*KeyTypeInput)(nil)).Elem(), KeyType("primary"))
	pulumi.RegisterInputType(reflect.TypeOf((*KeyTypePtrInput)(nil)).Elem(), KeyType("primary"))
	pulumi.RegisterInputType(reflect.TypeOf((*LoggerTypeInput)(nil)).Elem(), LoggerType("azureEventHub"))
	pulumi.RegisterInputType(reflect.TypeOf((*LoggerTypePtrInput)(nil)).Elem(), LoggerType("azureEventHub"))
	pulumi.RegisterInputType(reflect.TypeOf((*OperationNameFormatInput)(nil)).Elem(), OperationNameFormat("Name"))
	pulumi.RegisterInputType(reflect.TypeOf((*OperationNameFormatPtrInput)(nil)).Elem(), OperationNameFormat("Name"))
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyContentFormatInput)(nil)).Elem(), PolicyContentFormat("xml"))
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyContentFormatPtrInput)(nil)).Elem(), PolicyContentFormat("xml"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ProductStateEnumInput)(nil)).Elem(), ProductStateEnum("notPublished"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProductStateEnumPtrInput)(nil)).Elem(), ProductStateEnum("notPublished"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProtocolInput)(nil)).Elem(), Protocol("http"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProtocolPtrInput)(nil)).Elem(), Protocol("http"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProvisioningStateInput)(nil)).Elem(), ProvisioningState("created"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProvisioningStatePtrInput)(nil)).Elem(), ProvisioningState("created"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SamplingTypeInput)(nil)).Elem(), SamplingType("fixed"))
	pulumi.RegisterInputType(reflect.TypeOf((*SamplingTypePtrInput)(nil)).Elem(), SamplingType("fixed"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SoapApiTypeInput)(nil)).Elem(), SoapApiType("http"))
	pulumi.RegisterInputType(reflect.TypeOf((*SoapApiTypePtrInput)(nil)).Elem(), SoapApiType("http"))
	pulumi.RegisterInputType(reflect.TypeOf((*StateInput)(nil)).Elem(), State("proposed"))
	pulumi.RegisterInputType(reflect.TypeOf((*StatePtrInput)(nil)).Elem(), State("proposed"))
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionStateEnumInput)(nil)).Elem(), SubscriptionStateEnum("suspended"))
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionStateEnumPtrInput)(nil)).Elem(), SubscriptionStateEnum("suspended"))
	pulumi.RegisterInputType(reflect.TypeOf((*UserStateEnumInput)(nil)).Elem(), UserStateEnum("active"))
	pulumi.RegisterInputType(reflect.TypeOf((*UserStateEnumPtrInput)(nil)).Elem(), UserStateEnum("active"))
	pulumi.RegisterInputType(reflect.TypeOf((*VerbosityInput)(nil)).Elem(), Verbosity("verbose"))
	pulumi.RegisterInputType(reflect.TypeOf((*VerbosityPtrInput)(nil)).Elem(), Verbosity("verbose"))
	pulumi.RegisterInputType(reflect.TypeOf((*VersioningSchemeInput)(nil)).Elem(), VersioningScheme("Segment"))
	pulumi.RegisterInputType(reflect.TypeOf((*VersioningSchemePtrInput)(nil)).Elem(), VersioningScheme("Segment"))
