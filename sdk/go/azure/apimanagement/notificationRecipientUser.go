...
func NewNotificationRecipientUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement:NotificationRecipientUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationRecipientUser(ctx *pulumi.Context,
	...
	var resource NotificationRecipientUser
	err := ctx.ReadResource("azure-nextgen:apimanagement:NotificationRecipientUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
