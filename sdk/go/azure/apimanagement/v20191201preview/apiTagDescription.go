...
func NewApiTagDescription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement/v20191201preview:ApiTagDescription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiTagDescription(ctx *pulumi.Context,
	...
	var resource ApiTagDescription
	err := ctx.ReadResource("azure-nextgen:apimanagement/v20191201preview:ApiTagDescription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
