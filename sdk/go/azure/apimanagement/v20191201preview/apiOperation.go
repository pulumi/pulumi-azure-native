...
func NewApiOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement/v20191201preview:ApiOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiOperation(ctx *pulumi.Context,
	...
	var resource ApiOperation
	err := ctx.ReadResource("azure-nextgen:apimanagement/v20191201preview:ApiOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
