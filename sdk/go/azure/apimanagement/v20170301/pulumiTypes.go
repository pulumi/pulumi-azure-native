...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ApiVersionSetContractInput)(nil)).Elem(), ApiVersionSetContractArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiVersionSetContractPtrInput)(nil)).Elem(), ApiVersionSetContractArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiVersionSetContractResponseInput)(nil)).Elem(), ApiVersionSetContractResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiVersionSetContractResponsePtrInput)(nil)).Elem(), ApiVersionSetContractResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GroupContractResponseInput)(nil)).Elem(), GroupContractResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GroupContractResponseArrayInput)(nil)).Elem(), GroupContractResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LoggerSamplingContractInput)(nil)).Elem(), LoggerSamplingContractArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoggerSamplingContractPtrInput)(nil)).Elem(), LoggerSamplingContractArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoggerSamplingContractResponseInput)(nil)).Elem(), LoggerSamplingContractResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoggerSamplingContractResponsePtrInput)(nil)).Elem(), LoggerSamplingContractResponseArgs{})
