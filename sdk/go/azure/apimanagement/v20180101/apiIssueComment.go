...
func NewApiIssueComment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement/v20180101:ApiIssueComment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIssueComment(ctx *pulumi.Context,
	...
	var resource ApiIssueComment
	err := ctx.ReadResource("azure-nextgen:apimanagement/v20180101:ApiIssueComment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
