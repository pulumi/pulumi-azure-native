...
func NewBackend(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement/v20180101:Backend", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackend(ctx *pulumi.Context,
	...
	var resource Backend
	err := ctx.ReadResource("azure-nextgen:apimanagement/v20180101:Backend", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
