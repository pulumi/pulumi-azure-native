...
func NewApiOperationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement/v20180101:ApiOperationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiOperationPolicy(ctx *pulumi.Context,
	...
	var resource ApiOperationPolicy
	err := ctx.ReadResource("azure-nextgen:apimanagement/v20180101:ApiOperationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
