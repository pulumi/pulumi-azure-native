...
func NewAuthorizationServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:apimanagement/v20180101:AuthorizationServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationServer(ctx *pulumi.Context,
	...
	var resource AuthorizationServer
	err := ctx.ReadResource("azure-nextgen:apimanagement/v20180101:AuthorizationServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
