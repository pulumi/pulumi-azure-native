...
// Replica Set Definition
type ReplicaSetInvokeResponse struct {
...
// ReplicaSetInvokeResponseInput is an input type that accepts ReplicaSetInvokeResponseArgs and ReplicaSetInvokeResponseOutput values.
// You can construct a concrete instance of `ReplicaSetInvokeResponseInput` via:
//
//          ReplicaSetInvokeResponseArgs{...}
type ReplicaSetInvokeResponseInput interface {
	pulumi.Input

	ToReplicaSetInvokeResponseOutput() ReplicaSetInvokeResponseOutput
	ToReplicaSetInvokeResponseOutputWithContext(context.Context) ReplicaSetInvokeResponseOutput
}

// Replica Set Definition
type ReplicaSetInvokeResponseArgs struct {
	// List of Domain Controller IP Address
	...
	// List of Domain Health Alerts
	HealthAlerts HealthAlertInvokeResponseArrayInput `pulumi:"healthAlerts"`
	// Last domain evaluation run DateTime
	HealthLastEvaluated pulumi.StringInput `pulumi:"healthLastEvaluated"`
	// List of Domain Health Monitors
	HealthMonitors HealthMonitorInvokeResponseArrayInput `pulumi:"healthMonitors"`
	// Virtual network location
	Location pulumi.StringPtrInput `pulumi:"location"`
	// ReplicaSet Id
...
func (ReplicaSetInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ReplicaSetInvokeResponse)(nil)).Elem()
}

func (i ReplicaSetInvokeResponseArgs) ToReplicaSetInvokeResponseOutput() ReplicaSetInvokeResponseOutput {
	return i.ToReplicaSetInvokeResponseOutputWithContext(context.Background())
}

func (i ReplicaSetInvokeResponseArgs) ToReplicaSetInvokeResponseOutputWithContext(ctx context.Context) ReplicaSetInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ReplicaSetInvokeResponseOutput)
}

// ReplicaSetInvokeResponseArrayInput is an input type that accepts ReplicaSetInvokeResponseArray and ReplicaSetInvokeResponseArrayOutput values.
// You can construct a concrete instance of `ReplicaSetInvokeResponseArrayInput` via:
//
//          ReplicaSetInvokeResponseArray{ ReplicaSetInvokeResponseArgs{...} }
type ReplicaSetInvokeResponseArrayInput interface {
	pulumi.Input

	ToReplicaSetInvokeResponseArrayOutput() ReplicaSetInvokeResponseArrayOutput
	ToReplicaSetInvokeResponseArrayOutputWithContext(context.Context) ReplicaSetInvokeResponseArrayOutput
}

type ReplicaSetInvokeResponseArray []ReplicaSetInvokeResponseInput

func (ReplicaSetInvokeResponseArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ReplicaSetInvokeResponse)(nil)).Elem()
}

func (i ReplicaSetInvokeResponseArray) ToReplicaSetInvokeResponseArrayOutput() ReplicaSetInvokeResponseArrayOutput {
	return i.ToReplicaSetInvokeResponseArrayOutputWithContext(context.Background())
}

func (i ReplicaSetInvokeResponseArray) ToReplicaSetInvokeResponseArrayOutputWithContext(ctx context.Context) ReplicaSetInvokeResponseArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ReplicaSetInvokeResponseArrayOutput)
}

// Replica Set Definition
type ReplicaSetInvokeResponseOutput struct{ *pulumi.OutputState }

func (ReplicaSetInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ReplicaSetInvokeResponse)(nil)).Elem()
}

func (o ReplicaSetInvokeResponseOutput) ToReplicaSetInvokeResponseOutput() ReplicaSetInvokeResponseOutput {
	return o
}

func (o ReplicaSetInvokeResponseOutput) ToReplicaSetInvokeResponseOutputWithContext(ctx context.Context) ReplicaSetInvokeResponseOutput {
	return o
}

// List of Domain Controller IP Address
func (o ReplicaSetInvokeResponseOutput) DomainControllerIpAddress() pulumi.StringArrayOutput {
	return o.ApplyT(func(v ReplicaSetInvokeResponse) []string { return v.DomainControllerIpAddress }).(pulumi.StringArrayOutput)
}

// External access ip address.
func (o ReplicaSetInvokeResponseOutput) ExternalAccessIpAddress() pulumi.StringOutput {
	return o.ApplyT(func(v ReplicaSetInvokeResponse) string { return v.ExternalAccessIpAddress }).(pulumi.StringOutput)
}

// List of Domain Health Alerts
func (o ReplicaSetInvokeResponseOutput) HealthAlerts() HealthAlertInvokeResponseArrayOutput {
	return o.ApplyT(func(v ReplicaSetInvokeResponse) []HealthAlertInvokeResponse { return v.HealthAlerts }).(HealthAlertInvokeResponseArrayOutput)
}

// Last domain evaluation run DateTime
func (o ReplicaSetInvokeResponseOutput) HealthLastEvaluated() pulumi.StringOutput {
	return o.ApplyT(func(v ReplicaSetInvokeResponse) string { return v.HealthLastEvaluated }).(pulumi.StringOutput)
}

// List of Domain Health Monitors
func (o ReplicaSetInvokeResponseOutput) HealthMonitors() HealthMonitorInvokeResponseArrayOutput {
	return o.ApplyT(func(v ReplicaSetInvokeResponse) []HealthMonitorInvokeResponse { return v.HealthMonitors }).(HealthMonitorInvokeResponseArrayOutput)
}

// Virtual network location
func (o ReplicaSetInvokeResponseOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ReplicaSetInvokeResponse) *string { return v.Location }).(pulumi.StringPtrOutput)
}

// ReplicaSet Id
func (o ReplicaSetInvokeResponseOutput) ReplicaSetId() pulumi.StringOutput {
	return o.ApplyT(func(v ReplicaSetInvokeResponse) string { return v.ReplicaSetId }).(pulumi.StringOutput)
}

// Status of Domain Service instance
func (o ReplicaSetInvokeResponseOutput) ServiceStatus() pulumi.StringOutput {
	return o.ApplyT(func(v ReplicaSetInvokeResponse) string { return v.ServiceStatus }).(pulumi.StringOutput)
}

// The name of the virtual network that Domain Services will be deployed on. The id of the subnet that Domain Services will be deployed on. /virtualNetwork/vnetName/subnets/subnetName.
func (o ReplicaSetInvokeResponseOutput) SubnetId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ReplicaSetInvokeResponse) *string { return v.SubnetId }).(pulumi.StringPtrOutput)
}

// Virtual network site id
func (o ReplicaSetInvokeResponseOutput) VnetSiteId() pulumi.StringOutput {
	return o.ApplyT(func(v ReplicaSetInvokeResponse) string { return v.VnetSiteId }).(pulumi.StringOutput)
}

type ReplicaSetInvokeResponseArrayOutput struct{ *pulumi.OutputState }

func (ReplicaSetInvokeResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ReplicaSetInvokeResponse)(nil)).Elem()
}

func (o ReplicaSetInvokeResponseArrayOutput) ToReplicaSetInvokeResponseArrayOutput() ReplicaSetInvokeResponseArrayOutput {
	return o
}

func (o ReplicaSetInvokeResponseArrayOutput) ToReplicaSetInvokeResponseArrayOutputWithContext(ctx context.Context) ReplicaSetInvokeResponseArrayOutput {
	return o
}

func (o ReplicaSetInvokeResponseArrayOutput) Index(i pulumi.IntInput) ReplicaSetInvokeResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) ReplicaSetInvokeResponse {
		return vs[0].([]ReplicaSetInvokeResponse)[vs[1].(int)]
	}).(ReplicaSetInvokeResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ReplicaSetInvokeResponseOutput{})
	pulumi.RegisterOutputType(ReplicaSetInvokeResponseArrayOutput{})
