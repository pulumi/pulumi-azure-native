...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerAccountResponseInput)(nil)).Elem(), ContainerAccountResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerAccountResponseArrayInput)(nil)).Elem(), ContainerAccountResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ForestTrustInput)(nil)).Elem(), ForestTrustArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ForestTrustArrayInput)(nil)).Elem(), ForestTrustArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ForestTrustResponseInput)(nil)).Elem(), ForestTrustResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ForestTrustResponseArrayInput)(nil)).Elem(), ForestTrustResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationProgressResponseInput)(nil)).Elem(), MigrationProgressResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationProgressResponsePtrInput)(nil)).Elem(), MigrationProgressResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationPropertiesResponseInput)(nil)).Elem(), MigrationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationPropertiesResponsePtrInput)(nil)).Elem(), MigrationPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicaSetInput)(nil)).Elem(), ReplicaSetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicaSetArrayInput)(nil)).Elem(), ReplicaSetArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicaSetResponseInput)(nil)).Elem(), ReplicaSetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicaSetResponseArrayInput)(nil)).Elem(), ReplicaSetResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceForestSettingsInput)(nil)).Elem(), ResourceForestSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceForestSettingsPtrInput)(nil)).Elem(), ResourceForestSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceForestSettingsResponseInput)(nil)).Elem(), ResourceForestSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceForestSettingsResponsePtrInput)(nil)).Elem(), ResourceForestSettingsResponseArgs{})
