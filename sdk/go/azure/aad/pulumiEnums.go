...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KerberosArmoringInput)(nil)).Elem(), KerberosArmoring("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*KerberosArmoringPtrInput)(nil)).Elem(), KerberosArmoring("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*KerberosRc4EncryptionInput)(nil)).Elem(), KerberosRc4Encryption("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*KerberosRc4EncryptionPtrInput)(nil)).Elem(), KerberosRc4Encryption("Enabled"))
