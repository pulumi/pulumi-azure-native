...
// ExternalAccessInput is an input type that accepts ExternalAccessArgs and ExternalAccessOutput values.
// You can construct a concrete instance of `ExternalAccessInput` via:
//
//          ExternalAccessArgs{...}
...
// FilteredSyncInput is an input type that accepts FilteredSyncArgs and FilteredSyncOutput values.
// You can construct a concrete instance of `FilteredSyncInput` via:
//
//          FilteredSyncArgs{...}
...
// LdapsInput is an input type that accepts LdapsArgs and LdapsOutput values.
// You can construct a concrete instance of `LdapsInput` via:
//
//          LdapsArgs{...}
...
// NotifyDcAdminsInput is an input type that accepts NotifyDcAdminsArgs and NotifyDcAdminsOutput values.
// You can construct a concrete instance of `NotifyDcAdminsInput` via:
//
//          NotifyDcAdminsArgs{...}
...
// NotifyGlobalAdminsInput is an input type that accepts NotifyGlobalAdminsArgs and NotifyGlobalAdminsOutput values.
// You can construct a concrete instance of `NotifyGlobalAdminsInput` via:
//
...
// NtlmV1Input is an input type that accepts NtlmV1Args and NtlmV1Output values.
// You can construct a concrete instance of `NtlmV1Input` via:
//
//          NtlmV1Args{...}
...
// SyncKerberosPasswordsInput is an input type that accepts SyncKerberosPasswordsArgs and SyncKerberosPasswordsOutput values.
// You can construct a concrete instance of `SyncKerberosPasswordsInput` via:
//
...
// SyncNtlmPasswordsInput is an input type that accepts SyncNtlmPasswordsArgs and SyncNtlmPasswordsOutput values.
// You can construct a concrete instance of `SyncNtlmPasswordsInput` via:
//
...
// SyncOnPremPasswordsInput is an input type that accepts SyncOnPremPasswordsArgs and SyncOnPremPasswordsOutput values.
// You can construct a concrete instance of `SyncOnPremPasswordsInput` via:
//
...
// TlsV1Input is an input type that accepts TlsV1Args and TlsV1Output values.
// You can construct a concrete instance of `TlsV1Input` via:
//
//          TlsV1Args{...}
