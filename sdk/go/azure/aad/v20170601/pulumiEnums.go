...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ExternalAccessInput)(nil)).Elem(), ExternalAccess("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ExternalAccessPtrInput)(nil)).Elem(), ExternalAccess("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*FilteredSyncInput)(nil)).Elem(), FilteredSync("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*FilteredSyncPtrInput)(nil)).Elem(), FilteredSync("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*LdapsInput)(nil)).Elem(), Ldaps("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*LdapsPtrInput)(nil)).Elem(), Ldaps("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*NotifyDcAdminsInput)(nil)).Elem(), NotifyDcAdmins("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*NotifyDcAdminsPtrInput)(nil)).Elem(), NotifyDcAdmins("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*NotifyGlobalAdminsInput)(nil)).Elem(), NotifyGlobalAdmins("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*NotifyGlobalAdminsPtrInput)(nil)).Elem(), NotifyGlobalAdmins("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*NtlmV1Input)(nil)).Elem(), NtlmV1("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*NtlmV1PtrInput)(nil)).Elem(), NtlmV1("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SyncKerberosPasswordsInput)(nil)).Elem(), SyncKerberosPasswords("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SyncKerberosPasswordsPtrInput)(nil)).Elem(), SyncKerberosPasswords("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SyncNtlmPasswordsInput)(nil)).Elem(), SyncNtlmPasswords("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SyncNtlmPasswordsPtrInput)(nil)).Elem(), SyncNtlmPasswords("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SyncOnPremPasswordsInput)(nil)).Elem(), SyncOnPremPasswords("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SyncOnPremPasswordsPtrInput)(nil)).Elem(), SyncOnPremPasswords("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*TlsV1Input)(nil)).Elem(), TlsV1("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*TlsV1PtrInput)(nil)).Elem(), TlsV1("Enabled"))
