...
func NewDomainService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:aad/v20220901:DomainService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainService(ctx *pulumi.Context,
	...
	var resource DomainService
	err := ctx.ReadResource("azure-native:aad/v20220901:DomainService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
