...
func NewAlias(ctx *pulumi.Context,
	...
	var resource Alias
	err := ctx.RegisterResource("azure-nextgen:subscription:Alias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlias(ctx *pulumi.Context,
	...
	var resource Alias
	err := ctx.ReadResource("azure-nextgen:subscription:Alias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
