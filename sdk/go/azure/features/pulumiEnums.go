...
// SubscriptionFeatureRegistrationStateEnumInput is an input type that accepts SubscriptionFeatureRegistrationStateEnumArgs and SubscriptionFeatureRegistrationStateEnumOutput values.
// You can construct a concrete instance of `SubscriptionFeatureRegistrationStateEnumInput` via:
//
//          SubscriptionFeatureRegistrationStateEnumArgs{...}
