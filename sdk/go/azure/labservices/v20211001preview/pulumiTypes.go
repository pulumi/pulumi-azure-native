...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AutoShutdownProfileInput)(nil)).Elem(), AutoShutdownProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoShutdownProfilePtrInput)(nil)).Elem(), AutoShutdownProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoShutdownProfileResponseInput)(nil)).Elem(), AutoShutdownProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoShutdownProfileResponsePtrInput)(nil)).Elem(), AutoShutdownProfileResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionProfileResponseInput)(nil)).Elem(), ConnectionProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionProfileResponsePtrInput)(nil)).Elem(), ConnectionProfileResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LabNetworkProfileInput)(nil)).Elem(), LabNetworkProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabNetworkProfilePtrInput)(nil)).Elem(), LabNetworkProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabNetworkProfileResponseInput)(nil)).Elem(), LabNetworkProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabNetworkProfileResponsePtrInput)(nil)).Elem(), LabNetworkProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabPlanNetworkProfileInput)(nil)).Elem(), LabPlanNetworkProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabPlanNetworkProfilePtrInput)(nil)).Elem(), LabPlanNetworkProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabPlanNetworkProfileResponseInput)(nil)).Elem(), LabPlanNetworkProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabPlanNetworkProfileResponsePtrInput)(nil)).Elem(), LabPlanNetworkProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrencePatternInput)(nil)).Elem(), RecurrencePatternArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrencePatternPtrInput)(nil)).Elem(), RecurrencePatternArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrencePatternResponseInput)(nil)).Elem(), RecurrencePatternResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrencePatternResponsePtrInput)(nil)).Elem(), RecurrencePatternResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RosterProfileInput)(nil)).Elem(), RosterProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RosterProfilePtrInput)(nil)).Elem(), RosterProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RosterProfileResponseInput)(nil)).Elem(), RosterProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RosterProfileResponsePtrInput)(nil)).Elem(), RosterProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityProfileInput)(nil)).Elem(), SecurityProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityProfilePtrInput)(nil)).Elem(), SecurityProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityProfileResponseInput)(nil)).Elem(), SecurityProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityProfileResponsePtrInput)(nil)).Elem(), SecurityProfileResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SupportInfoInput)(nil)).Elem(), SupportInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SupportInfoPtrInput)(nil)).Elem(), SupportInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SupportInfoResponseInput)(nil)).Elem(), SupportInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SupportInfoResponsePtrInput)(nil)).Elem(), SupportInfoResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineAdditionalCapabilitiesInput)(nil)).Elem(), VirtualMachineAdditionalCapabilitiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineAdditionalCapabilitiesPtrInput)(nil)).Elem(), VirtualMachineAdditionalCapabilitiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineAdditionalCapabilitiesResponseInput)(nil)).Elem(), VirtualMachineAdditionalCapabilitiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineAdditionalCapabilitiesResponsePtrInput)(nil)).Elem(), VirtualMachineAdditionalCapabilitiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineProfileInput)(nil)).Elem(), VirtualMachineProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineProfilePtrInput)(nil)).Elem(), VirtualMachineProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineProfileResponseInput)(nil)).Elem(), VirtualMachineProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineProfileResponsePtrInput)(nil)).Elem(), VirtualMachineProfileResponseArgs{})
