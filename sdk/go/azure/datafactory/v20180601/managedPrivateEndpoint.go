...
func NewManagedPrivateEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:datafactory/v20180601:ManagedPrivateEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedPrivateEndpoint(ctx *pulumi.Context,
	...
	var resource ManagedPrivateEndpoint
	err := ctx.ReadResource("azure-nextgen:datafactory/v20180601:ManagedPrivateEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
