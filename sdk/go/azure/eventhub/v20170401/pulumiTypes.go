...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CaptureDescriptionInput)(nil)).Elem(), CaptureDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CaptureDescriptionPtrInput)(nil)).Elem(), CaptureDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CaptureDescriptionResponseInput)(nil)).Elem(), CaptureDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CaptureDescriptionResponsePtrInput)(nil)).Elem(), CaptureDescriptionResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NWRuleSetIpRulesInput)(nil)).Elem(), NWRuleSetIpRulesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NWRuleSetIpRulesArrayInput)(nil)).Elem(), NWRuleSetIpRulesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NWRuleSetIpRulesResponseInput)(nil)).Elem(), NWRuleSetIpRulesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NWRuleSetIpRulesResponseArrayInput)(nil)).Elem(), NWRuleSetIpRulesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NWRuleSetVirtualNetworkRulesInput)(nil)).Elem(), NWRuleSetVirtualNetworkRulesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NWRuleSetVirtualNetworkRulesArrayInput)(nil)).Elem(), NWRuleSetVirtualNetworkRulesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NWRuleSetVirtualNetworkRulesResponseInput)(nil)).Elem(), NWRuleSetVirtualNetworkRulesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NWRuleSetVirtualNetworkRulesResponseArrayInput)(nil)).Elem(), NWRuleSetVirtualNetworkRulesResponseArray{})
