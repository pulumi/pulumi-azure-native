...
func NewEventHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:eventhub/v20170401:EventHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHub(ctx *pulumi.Context,
	...
	var resource EventHub
	err := ctx.ReadResource("azure-nextgen:eventhub/v20170401:EventHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
