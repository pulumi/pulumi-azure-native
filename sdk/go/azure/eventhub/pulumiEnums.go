...
// ClusterSkuNameInput is an input type that accepts ClusterSkuNameArgs and ClusterSkuNameOutput values.
// You can construct a concrete instance of `ClusterSkuNameInput` via:
//
//          ClusterSkuNameArgs{...}
