...
func NewDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:eventhub/v20210101preview:DisasterRecoveryConfig"),
		},
		{
			Type: pulumi.String("azure-native:eventhub/v20210601preview:DisasterRecoveryConfig"),
		},
		{
			Type: pulumi.String("azure-nextgen:eventhub/v20210601preview:DisasterRecoveryConfig"),
		},
		{
			Type: pulumi.String("azure-native:eventhub/v20211101:DisasterRecoveryConfig"),
		},
		{
			Type: pulumi.String("azure-nextgen:eventhub/v20211101:DisasterRecoveryConfig"),
		},
	})
	opts = append(opts, aliases)
	var resource DisasterRecoveryConfig
	err := ctx.RegisterResource("azure-native:eventhub/v20180101preview:DisasterRecoveryConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	var resource DisasterRecoveryConfig
	err := ctx.ReadResource("azure-native:eventhub/v20180101preview:DisasterRecoveryConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
