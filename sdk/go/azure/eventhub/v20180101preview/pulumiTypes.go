...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultPropertiesArrayInput)(nil)).Elem(), KeyVaultPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultPropertiesResponseInput)(nil)).Elem(), KeyVaultPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultPropertiesResponseArrayInput)(nil)).Elem(), KeyVaultPropertiesResponseArray{})
