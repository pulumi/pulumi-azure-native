...
func NewEventHubAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:eventhub/v20140901:EventHubAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHubAuthorizationRule(ctx *pulumi.Context,
	...
	var resource EventHubAuthorizationRule
	err := ctx.ReadResource("azure-nextgen:eventhub/v20140901:EventHubAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
