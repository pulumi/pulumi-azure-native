...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterSkuNameInput)(nil)).Elem(), ClusterSkuName("Dedicated"))
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterSkuNamePtrInput)(nil)).Elem(), ClusterSkuName("Dedicated"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SchemaTypeInput)(nil)).Elem(), SchemaType("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*SchemaTypePtrInput)(nil)).Elem(), SchemaType("Unknown"))
