...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UserAssignedIdentityPropertiesInput)(nil)).Elem(), UserAssignedIdentityPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserAssignedIdentityPropertiesPtrInput)(nil)).Elem(), UserAssignedIdentityPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserAssignedIdentityPropertiesResponseInput)(nil)).Elem(), UserAssignedIdentityPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserAssignedIdentityPropertiesResponsePtrInput)(nil)).Elem(), UserAssignedIdentityPropertiesResponseArgs{})
