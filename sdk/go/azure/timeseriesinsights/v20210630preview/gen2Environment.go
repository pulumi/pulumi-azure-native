...
func NewGen2Environment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:timeseriesinsights/v20210630preview:Gen2Environment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGen2Environment(ctx *pulumi.Context,
	...
	var resource Gen2Environment
	err := ctx.ReadResource("azure-native:timeseriesinsights/v20210630preview:Gen2Environment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
