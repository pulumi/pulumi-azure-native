...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*Gen2StorageConfigurationInputInput)(nil)).Elem(), Gen2StorageConfigurationInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*Gen2StorageConfigurationInputPtrInput)(nil)).Elem(), Gen2StorageConfigurationInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*Gen2StorageConfigurationOutputResponseInput)(nil)).Elem(), Gen2StorageConfigurationOutputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*Gen2StorageConfigurationOutputResponsePtrInput)(nil)).Elem(), Gen2StorageConfigurationOutputResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LocalTimestampInput)(nil)).Elem(), LocalTimestampArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LocalTimestampPtrInput)(nil)).Elem(), LocalTimestampArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LocalTimestampResponseInput)(nil)).Elem(), LocalTimestampResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LocalTimestampResponsePtrInput)(nil)).Elem(), LocalTimestampResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LocalTimestampResponseTimeZoneOffsetInput)(nil)).Elem(), LocalTimestampResponseTimeZoneOffsetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LocalTimestampResponseTimeZoneOffsetPtrInput)(nil)).Elem(), LocalTimestampResponseTimeZoneOffsetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LocalTimestampTimeZoneOffsetInput)(nil)).Elem(), LocalTimestampTimeZoneOffsetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LocalTimestampTimeZoneOffsetPtrInput)(nil)).Elem(), LocalTimestampTimeZoneOffsetArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TimeSeriesIdPropertyInput)(nil)).Elem(), TimeSeriesIdPropertyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TimeSeriesIdPropertyArrayInput)(nil)).Elem(), TimeSeriesIdPropertyArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TimeSeriesIdPropertyResponseInput)(nil)).Elem(), TimeSeriesIdPropertyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TimeSeriesIdPropertyResponseArrayInput)(nil)).Elem(), TimeSeriesIdPropertyResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*WarmStorageEnvironmentStatusResponseInput)(nil)).Elem(), WarmStorageEnvironmentStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WarmStorageEnvironmentStatusResponsePtrInput)(nil)).Elem(), WarmStorageEnvironmentStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WarmStoreConfigurationPropertiesInput)(nil)).Elem(), WarmStoreConfigurationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WarmStoreConfigurationPropertiesPtrInput)(nil)).Elem(), WarmStoreConfigurationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WarmStoreConfigurationPropertiesResponseInput)(nil)).Elem(), WarmStoreConfigurationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WarmStoreConfigurationPropertiesResponsePtrInput)(nil)).Elem(), WarmStoreConfigurationPropertiesResponseArgs{})
