...
func NewEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:timeseriesinsights/v20200515:Environment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironment(ctx *pulumi.Context,
	...
	var resource Environment
	err := ctx.ReadResource("azure-native:timeseriesinsights/v20200515:Environment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o EnvironmentOutput) Sku() SkuResponseOutput {
	return o.ApplyT(func(v *Environment) SkuResponseOutput { return v.Sku }).(SkuResponseOutput)
}
