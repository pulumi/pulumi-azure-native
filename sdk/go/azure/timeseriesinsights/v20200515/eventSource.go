...
func NewEventSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:timeseriesinsights/v20200515:EventSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventSource(ctx *pulumi.Context,
	...
	var resource EventSource
	err := ctx.ReadResource("azure-nextgen:timeseriesinsights/v20200515:EventSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
