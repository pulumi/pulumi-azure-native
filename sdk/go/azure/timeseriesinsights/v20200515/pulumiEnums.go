...
// EnvironmentKindInput is an input type that accepts EnvironmentKindArgs and EnvironmentKindOutput values.
// You can construct a concrete instance of `EnvironmentKindInput` via:
//
//          EnvironmentKindArgs{...}
...
// EventSourceKindInput is an input type that accepts EventSourceKindArgs and EventSourceKindOutput values.
// You can construct a concrete instance of `EventSourceKindInput` via:
//
//          EventSourceKindArgs{...}
...
// IngressStartAtTypeInput is an input type that accepts IngressStartAtTypeArgs and IngressStartAtTypeOutput values.
// You can construct a concrete instance of `IngressStartAtTypeInput` via:
//
//          IngressStartAtTypeArgs{...}
