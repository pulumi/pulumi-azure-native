...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleDownModeInput)(nil)).Elem(), ScaleDownMode("Delete"))
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleDownModePtrInput)(nil)).Elem(), ScaleDownMode("Delete"))
