...
type AgentPool struct {
	...
	CurrentOrchestratorVersion pulumi.StringPtrOutput                    `pulumi:"currentOrchestratorVersion"`
...
func NewAgentPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20220302preview:AgentPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentPool(ctx *pulumi.Context,
	...
	var resource AgentPool
	err := ctx.ReadResource("azure-native:containerservice/v20220302preview:AgentPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type AgentPoolArgs struct {
	...
	CurrentOrchestratorVersion pulumi.StringPtrInput
...
func (o AgentPoolOutput) CurrentOrchestratorVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AgentPool) pulumi.StringPtrOutput { return v.CurrentOrchestratorVersion }).(pulumi.StringPtrOutput)
}
