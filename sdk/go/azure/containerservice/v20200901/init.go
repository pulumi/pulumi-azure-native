...
func (m *module) Construct(ctx *pulumi.Context, name, typ, urn string) (r pulumi.Resource, err error) {
	switch typ {
	case "azure-nextgen:containerservice/v20200901:AgentPool":
		r, err = NewAgentPool(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:containerservice/v20200901:ManagedCluster":
		r, err = NewManagedCluster(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:containerservice/v20200901:PrivateEndpointConnection":
