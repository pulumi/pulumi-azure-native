...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceOchestratorTypesInput)(nil)).Elem(), ContainerServiceOchestratorTypes("Mesos"))
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceOchestratorTypesPtrInput)(nil)).Elem(), ContainerServiceOchestratorTypes("Mesos"))
