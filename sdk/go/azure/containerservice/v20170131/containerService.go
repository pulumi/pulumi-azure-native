...
func NewContainerService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:containerservice/v20170131:ContainerService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerService(ctx *pulumi.Context,
	...
	var resource ContainerService
	err := ctx.ReadResource("azure-nextgen:containerservice/v20170131:ContainerService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
