...
// Version of node image
func (o ManagedClusterAgentPoolProfileInvokeResponseOutput) NodeImageVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ManagedClusterAgentPoolProfileInvokeResponse) *string { return v.NodeImageVersion }).(pulumi.StringPtrOutput)
}
