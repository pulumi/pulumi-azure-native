...
// OpenShiftAgentPoolProfileRoleInput is an input type that accepts OpenShiftAgentPoolProfileRoleArgs and OpenShiftAgentPoolProfileRoleOutput values.
// You can construct a concrete instance of `OpenShiftAgentPoolProfileRoleInput` via:
//
//          OpenShiftAgentPoolProfileRoleArgs{...}
...
// OpenShiftContainerServiceVMSizeInput is an input type that accepts OpenShiftContainerServiceVMSizeArgs and OpenShiftContainerServiceVMSizeOutput values.
// You can construct a concrete instance of `OpenShiftContainerServiceVMSizeInput` via:
//
//          OpenShiftContainerServiceVMSizeArgs{...}
