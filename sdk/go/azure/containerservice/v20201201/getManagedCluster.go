...
func LookupManagedCluster(ctx *pulumi.Context, args *LookupManagedClusterArgs, opts ...pulumi.InvokeOption) (*LookupManagedClusterResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:containerservice/v20201201:getManagedCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupManagedClusterResult struct {
	...
	AutoUpgradeProfile *ManagedClusterAutoUpgradeProfileInvokeResponse `pulumi:"autoUpgradeProfile"`
	...
	PodIdentityProfile *ManagedClusterPodIdentityProfileInvokeResponse `pulumi:"podIdentityProfile"`
