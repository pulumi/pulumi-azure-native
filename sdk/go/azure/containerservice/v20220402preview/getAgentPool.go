...
func LookupAgentPool(ctx *pulumi.Context, args *LookupAgentPoolArgs, opts ...pulumi.InvokeOption) (*LookupAgentPoolResult, error) {
	...
	err := ctx.Invoke("azure-native:containerservice/v20220402preview:getAgentPool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupAgentPoolResultOutput) CurrentOrchestratorVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupAgentPoolResult) *string { return v.CurrentOrchestratorVersion }).(pulumi.StringPtrOutput)
}
