...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleSetPriorityInput)(nil)).Elem(), ScaleSetPriority("Low"))
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleSetPriorityPtrInput)(nil)).Elem(), ScaleSetPriority("Low"))
