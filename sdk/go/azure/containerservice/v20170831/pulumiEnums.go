...
// ContainerServiceStorageProfileTypesInput is an input type that accepts ContainerServiceStorageProfileTypesArgs and ContainerServiceStorageProfileTypesOutput values.
// You can construct a concrete instance of `ContainerServiceStorageProfileTypesInput` via:
//
//          ContainerServiceStorageProfileTypesArgs{...}
