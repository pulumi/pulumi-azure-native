...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultSecretRefInput)(nil)).Elem(), KeyVaultSecretRefArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultSecretRefPtrInput)(nil)).Elem(), KeyVaultSecretRefArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultSecretRefResponseInput)(nil)).Elem(), KeyVaultSecretRefResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultSecretRefResponsePtrInput)(nil)).Elem(), KeyVaultSecretRefResponseArgs{})
