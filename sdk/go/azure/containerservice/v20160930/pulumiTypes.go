...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceAgentPoolProfileInput)(nil)).Elem(), ContainerServiceAgentPoolProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceAgentPoolProfileArrayInput)(nil)).Elem(), ContainerServiceAgentPoolProfileArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceAgentPoolProfileResponseInput)(nil)).Elem(), ContainerServiceAgentPoolProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceAgentPoolProfileResponseArrayInput)(nil)).Elem(), ContainerServiceAgentPoolProfileResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceCustomProfileInput)(nil)).Elem(), ContainerServiceCustomProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceCustomProfilePtrInput)(nil)).Elem(), ContainerServiceCustomProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceCustomProfileResponseInput)(nil)).Elem(), ContainerServiceCustomProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceCustomProfileResponsePtrInput)(nil)).Elem(), ContainerServiceCustomProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceDiagnosticsProfileInput)(nil)).Elem(), ContainerServiceDiagnosticsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceDiagnosticsProfilePtrInput)(nil)).Elem(), ContainerServiceDiagnosticsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceDiagnosticsProfileResponseInput)(nil)).Elem(), ContainerServiceDiagnosticsProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceDiagnosticsProfileResponsePtrInput)(nil)).Elem(), ContainerServiceDiagnosticsProfileResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceMasterProfileInput)(nil)).Elem(), ContainerServiceMasterProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceMasterProfilePtrInput)(nil)).Elem(), ContainerServiceMasterProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceMasterProfileResponseInput)(nil)).Elem(), ContainerServiceMasterProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceMasterProfileResponsePtrInput)(nil)).Elem(), ContainerServiceMasterProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceOrchestratorProfileInput)(nil)).Elem(), ContainerServiceOrchestratorProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceOrchestratorProfilePtrInput)(nil)).Elem(), ContainerServiceOrchestratorProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceOrchestratorProfileResponseInput)(nil)).Elem(), ContainerServiceOrchestratorProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceOrchestratorProfileResponsePtrInput)(nil)).Elem(), ContainerServiceOrchestratorProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceServicePrincipalProfileInput)(nil)).Elem(), ContainerServiceServicePrincipalProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceServicePrincipalProfilePtrInput)(nil)).Elem(), ContainerServiceServicePrincipalProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceServicePrincipalProfileResponseInput)(nil)).Elem(), ContainerServiceServicePrincipalProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceServicePrincipalProfileResponsePtrInput)(nil)).Elem(), ContainerServiceServicePrincipalProfileResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceVMDiagnosticsInput)(nil)).Elem(), ContainerServiceVMDiagnosticsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceVMDiagnosticsPtrInput)(nil)).Elem(), ContainerServiceVMDiagnosticsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceVMDiagnosticsResponseInput)(nil)).Elem(), ContainerServiceVMDiagnosticsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceVMDiagnosticsResponsePtrInput)(nil)).Elem(), ContainerServiceVMDiagnosticsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceWindowsProfileInput)(nil)).Elem(), ContainerServiceWindowsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceWindowsProfilePtrInput)(nil)).Elem(), ContainerServiceWindowsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceWindowsProfileResponseInput)(nil)).Elem(), ContainerServiceWindowsProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceWindowsProfileResponsePtrInput)(nil)).Elem(), ContainerServiceWindowsProfileResponseArgs{})
