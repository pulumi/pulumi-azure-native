...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterAADIdentityProviderInput)(nil)).Elem(), OpenShiftManagedClusterAADIdentityProviderArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterAADIdentityProviderPtrInput)(nil)).Elem(), OpenShiftManagedClusterAADIdentityProviderArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterAADIdentityProviderResponseInput)(nil)).Elem(), OpenShiftManagedClusterAADIdentityProviderResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterAADIdentityProviderResponsePtrInput)(nil)).Elem(), OpenShiftManagedClusterAADIdentityProviderResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterAgentPoolProfileInput)(nil)).Elem(), OpenShiftManagedClusterAgentPoolProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterAgentPoolProfileArrayInput)(nil)).Elem(), OpenShiftManagedClusterAgentPoolProfileArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterAgentPoolProfileResponseInput)(nil)).Elem(), OpenShiftManagedClusterAgentPoolProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterAgentPoolProfileResponseArrayInput)(nil)).Elem(), OpenShiftManagedClusterAgentPoolProfileResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterAuthProfileInput)(nil)).Elem(), OpenShiftManagedClusterAuthProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterAuthProfilePtrInput)(nil)).Elem(), OpenShiftManagedClusterAuthProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterAuthProfileResponseInput)(nil)).Elem(), OpenShiftManagedClusterAuthProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterAuthProfileResponsePtrInput)(nil)).Elem(), OpenShiftManagedClusterAuthProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterIdentityProviderInput)(nil)).Elem(), OpenShiftManagedClusterIdentityProviderArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterIdentityProviderArrayInput)(nil)).Elem(), OpenShiftManagedClusterIdentityProviderArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterIdentityProviderResponseInput)(nil)).Elem(), OpenShiftManagedClusterIdentityProviderResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterIdentityProviderResponseArrayInput)(nil)).Elem(), OpenShiftManagedClusterIdentityProviderResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterMasterPoolProfileInput)(nil)).Elem(), OpenShiftManagedClusterMasterPoolProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterMasterPoolProfilePtrInput)(nil)).Elem(), OpenShiftManagedClusterMasterPoolProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterMasterPoolProfileResponseInput)(nil)).Elem(), OpenShiftManagedClusterMasterPoolProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterMasterPoolProfileResponsePtrInput)(nil)).Elem(), OpenShiftManagedClusterMasterPoolProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftRouterProfileInput)(nil)).Elem(), OpenShiftRouterProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftRouterProfileArrayInput)(nil)).Elem(), OpenShiftRouterProfileArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftRouterProfileResponseInput)(nil)).Elem(), OpenShiftRouterProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftRouterProfileResponseArrayInput)(nil)).Elem(), OpenShiftRouterProfileResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PurchasePlanInput)(nil)).Elem(), PurchasePlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PurchasePlanPtrInput)(nil)).Elem(), PurchasePlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PurchasePlanResponseInput)(nil)).Elem(), PurchasePlanResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PurchasePlanResponsePtrInput)(nil)).Elem(), PurchasePlanResponseArgs{})
