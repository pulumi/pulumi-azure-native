...
// DNS subdomain for OpenShift router.
func (o OpenShiftRouterProfileInvokeResponseOutput) PublicSubdomain() pulumi.StringPtrOutput {
	return o.ApplyT(func(v OpenShiftRouterProfileInvokeResponse) *string { return v.PublicSubdomain }).(pulumi.StringPtrOutput)
}
