...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CodeInput)(nil)).Elem(), Code("Running"))
	pulumi.RegisterInputType(reflect.TypeOf((*CodePtrInput)(nil)).Elem(), Code("Running"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WorkloadRuntimeInput)(nil)).Elem(), WorkloadRuntime("OCIContainer"))
	pulumi.RegisterInputType(reflect.TypeOf((*WorkloadRuntimePtrInput)(nil)).Elem(), WorkloadRuntime("OCIContainer"))
