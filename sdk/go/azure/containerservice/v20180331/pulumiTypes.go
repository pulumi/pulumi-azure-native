...
// Storage profile specifies what kind of storage used. Defaults to ManagedDisks.
func (o ManagedClusterAgentPoolProfileInvokeResponseOutput) StorageProfile() pulumi.StringOutput {
	return o.ApplyT(func(v ManagedClusterAgentPoolProfileInvokeResponse) string { return v.StorageProfile }).(pulumi.StringOutput)
}
