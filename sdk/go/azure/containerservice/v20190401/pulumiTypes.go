...
// Number of agents (VMs) to host docker containers. Allowed values must be in the range of 1 to 100 (inclusive). The default value is 1.
func (o ManagedClusterAgentPoolProfileInvokeResponseOutput) Count() pulumi.IntOutput {
	return o.ApplyT(func(v ManagedClusterAgentPoolProfileInvokeResponse) int { return v.Count }).(pulumi.IntOutput)
}
...
// Size of agent VMs.
func (o ManagedClusterAgentPoolProfileInvokeResponseOutput) VmSize() pulumi.StringOutput {
	return o.ApplyT(func(v ManagedClusterAgentPoolProfileInvokeResponse) string { return v.VmSize }).(pulumi.StringOutput)
}
