...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceLinuxProfileInput)(nil)).Elem(), ContainerServiceLinuxProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceLinuxProfilePtrInput)(nil)).Elem(), ContainerServiceLinuxProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceLinuxProfileResponseInput)(nil)).Elem(), ContainerServiceLinuxProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceLinuxProfileResponsePtrInput)(nil)).Elem(), ContainerServiceLinuxProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceNetworkProfileInput)(nil)).Elem(), ContainerServiceNetworkProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceNetworkProfilePtrInput)(nil)).Elem(), ContainerServiceNetworkProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceNetworkProfileResponseInput)(nil)).Elem(), ContainerServiceNetworkProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceNetworkProfileResponsePtrInput)(nil)).Elem(), ContainerServiceNetworkProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceSshConfigurationInput)(nil)).Elem(), ContainerServiceSshConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceSshConfigurationPtrInput)(nil)).Elem(), ContainerServiceSshConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceSshConfigurationResponseInput)(nil)).Elem(), ContainerServiceSshConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceSshConfigurationResponsePtrInput)(nil)).Elem(), ContainerServiceSshConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceSshPublicKeyInput)(nil)).Elem(), ContainerServiceSshPublicKeyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceSshPublicKeyArrayInput)(nil)).Elem(), ContainerServiceSshPublicKeyArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceSshPublicKeyResponseInput)(nil)).Elem(), ContainerServiceSshPublicKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceSshPublicKeyResponseArrayInput)(nil)).Elem(), ContainerServiceSshPublicKeyResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAADProfileInput)(nil)).Elem(), ManagedClusterAADProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAADProfilePtrInput)(nil)).Elem(), ManagedClusterAADProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAADProfileResponseInput)(nil)).Elem(), ManagedClusterAADProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAADProfileResponsePtrInput)(nil)).Elem(), ManagedClusterAADProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAPIServerAccessProfileInput)(nil)).Elem(), ManagedClusterAPIServerAccessProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAPIServerAccessProfilePtrInput)(nil)).Elem(), ManagedClusterAPIServerAccessProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAPIServerAccessProfileResponseInput)(nil)).Elem(), ManagedClusterAPIServerAccessProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAPIServerAccessProfileResponsePtrInput)(nil)).Elem(), ManagedClusterAPIServerAccessProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAddonProfileInput)(nil)).Elem(), ManagedClusterAddonProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAddonProfileMapInput)(nil)).Elem(), ManagedClusterAddonProfileMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAddonProfileResponseInput)(nil)).Elem(), ManagedClusterAddonProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAddonProfileResponseMapInput)(nil)).Elem(), ManagedClusterAddonProfileResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAddonProfileResponseIdentityInput)(nil)).Elem(), ManagedClusterAddonProfileResponseIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAgentPoolProfileInput)(nil)).Elem(), ManagedClusterAgentPoolProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAgentPoolProfileArrayInput)(nil)).Elem(), ManagedClusterAgentPoolProfileArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAgentPoolProfileResponseInput)(nil)).Elem(), ManagedClusterAgentPoolProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterAgentPoolProfileResponseArrayInput)(nil)).Elem(), ManagedClusterAgentPoolProfileResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterIdentityInput)(nil)).Elem(), ManagedClusterIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterIdentityPtrInput)(nil)).Elem(), ManagedClusterIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterIdentityResponseInput)(nil)).Elem(), ManagedClusterIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterIdentityResponsePtrInput)(nil)).Elem(), ManagedClusterIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfilePtrInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileManagedOutboundIPsInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileManagedOutboundIPsPtrInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileOutboundIPPrefixesInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileOutboundIPPrefixesPtrInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileOutboundIPPrefixesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileOutboundIPsInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileOutboundIPsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileOutboundIPsPtrInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileOutboundIPsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileResponseInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileResponsePtrInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileResponseManagedOutboundIPsInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileResponseManagedOutboundIPsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileResponseManagedOutboundIPsPtrInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileResponseManagedOutboundIPsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixesInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixesPtrInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileResponseOutboundIPsInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileResponseOutboundIPsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterLoadBalancerProfileResponseOutboundIPsPtrInput)(nil)).Elem(), ManagedClusterLoadBalancerProfileResponseOutboundIPsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterPropertiesIdentityProfileInput)(nil)).Elem(), ManagedClusterPropertiesIdentityProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterPropertiesIdentityProfileMapInput)(nil)).Elem(), ManagedClusterPropertiesIdentityProfileMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterPropertiesResponseIdentityProfileInput)(nil)).Elem(), ManagedClusterPropertiesResponseIdentityProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterPropertiesResponseIdentityProfileMapInput)(nil)).Elem(), ManagedClusterPropertiesResponseIdentityProfileMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterServicePrincipalProfileInput)(nil)).Elem(), ManagedClusterServicePrincipalProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterServicePrincipalProfilePtrInput)(nil)).Elem(), ManagedClusterServicePrincipalProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterServicePrincipalProfileResponseInput)(nil)).Elem(), ManagedClusterServicePrincipalProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterServicePrincipalProfileResponsePtrInput)(nil)).Elem(), ManagedClusterServicePrincipalProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterWindowsProfileInput)(nil)).Elem(), ManagedClusterWindowsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterWindowsProfilePtrInput)(nil)).Elem(), ManagedClusterWindowsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterWindowsProfileResponseInput)(nil)).Elem(), ManagedClusterWindowsProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedClusterWindowsProfileResponsePtrInput)(nil)).Elem(), ManagedClusterWindowsProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceReferenceInput)(nil)).Elem(), ResourceReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceReferenceArrayInput)(nil)).Elem(), ResourceReferenceArray{})
