...
func (o OpenShiftAPIPropertiesResponseOutput) ToOpenShiftAPIPropertiesResponsePtrOutputWithContext(ctx context.Context) OpenShiftAPIPropertiesResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v OpenShiftAPIPropertiesResponse) *OpenShiftAPIPropertiesResponse {
		return &v
...
func (o OpenShiftManagedClusterMonitorProfileResponseOutput) ToOpenShiftManagedClusterMonitorProfileResponsePtrOutputWithContext(ctx context.Context) OpenShiftManagedClusterMonitorProfileResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v OpenShiftManagedClusterMonitorProfileResponse) *OpenShiftManagedClusterMonitorProfileResponse {
		return &v
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftAPIPropertiesInput)(nil)).Elem(), OpenShiftAPIPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftAPIPropertiesPtrInput)(nil)).Elem(), OpenShiftAPIPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftAPIPropertiesResponseInput)(nil)).Elem(), OpenShiftAPIPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftAPIPropertiesResponsePtrInput)(nil)).Elem(), OpenShiftAPIPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterMonitorProfileInput)(nil)).Elem(), OpenShiftManagedClusterMonitorProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterMonitorProfilePtrInput)(nil)).Elem(), OpenShiftManagedClusterMonitorProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterMonitorProfileResponseInput)(nil)).Elem(), OpenShiftManagedClusterMonitorProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OpenShiftManagedClusterMonitorProfileResponsePtrInput)(nil)).Elem(), OpenShiftManagedClusterMonitorProfileResponseArgs{})
