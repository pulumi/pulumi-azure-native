...
// CIDR of subnet used to create PLS needed for management of the cluster
func (o NetworkProfileInvokeResponseOutput) ManagementSubnetCidr() pulumi.StringPtrOutput {
	return o.ApplyT(func(v NetworkProfileInvokeResponse) *string { return v.ManagementSubnetCidr }).(pulumi.StringPtrOutput)
}
...
// Defines further properties on the API.
type OpenShiftAPIPropertiesInvokeResponse struct {
	// Specifies if API server is public or private.
	PrivateApiServer *bool `pulumi:"privateApiServer"`
}

// OpenShiftAPIPropertiesInvokeResponseInput is an input type that accepts OpenShiftAPIPropertiesInvokeResponseArgs and OpenShiftAPIPropertiesInvokeResponseOutput values.
// You can construct a concrete instance of `OpenShiftAPIPropertiesInvokeResponseInput` via:
//
//          OpenShiftAPIPropertiesInvokeResponseArgs{...}
type OpenShiftAPIPropertiesInvokeResponseInput interface {
	pulumi.Input

	ToOpenShiftAPIPropertiesInvokeResponseOutput() OpenShiftAPIPropertiesInvokeResponseOutput
	ToOpenShiftAPIPropertiesInvokeResponseOutputWithContext(context.Context) OpenShiftAPIPropertiesInvokeResponseOutput
}

// Defines further properties on the API.
type OpenShiftAPIPropertiesInvokeResponseArgs struct {
	// Specifies if API server is public or private.
	PrivateApiServer pulumi.BoolPtrInput `pulumi:"privateApiServer"`
}

func (OpenShiftAPIPropertiesInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*OpenShiftAPIPropertiesInvokeResponse)(nil)).Elem()
}

func (i OpenShiftAPIPropertiesInvokeResponseArgs) ToOpenShiftAPIPropertiesInvokeResponseOutput() OpenShiftAPIPropertiesInvokeResponseOutput {
	return i.ToOpenShiftAPIPropertiesInvokeResponseOutputWithContext(context.Background())
}

func (i OpenShiftAPIPropertiesInvokeResponseArgs) ToOpenShiftAPIPropertiesInvokeResponseOutputWithContext(ctx context.Context) OpenShiftAPIPropertiesInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OpenShiftAPIPropertiesInvokeResponseOutput)
}

func (i OpenShiftAPIPropertiesInvokeResponseArgs) ToOpenShiftAPIPropertiesInvokeResponsePtrOutput() OpenShiftAPIPropertiesInvokeResponsePtrOutput {
	return i.ToOpenShiftAPIPropertiesInvokeResponsePtrOutputWithContext(context.Background())
}

func (i OpenShiftAPIPropertiesInvokeResponseArgs) ToOpenShiftAPIPropertiesInvokeResponsePtrOutputWithContext(ctx context.Context) OpenShiftAPIPropertiesInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OpenShiftAPIPropertiesInvokeResponseOutput).ToOpenShiftAPIPropertiesInvokeResponsePtrOutputWithContext(ctx)
}

// OpenShiftAPIPropertiesInvokeResponsePtrInput is an input type that accepts OpenShiftAPIPropertiesInvokeResponseArgs, OpenShiftAPIPropertiesInvokeResponsePtr and OpenShiftAPIPropertiesInvokeResponsePtrOutput values.
// You can construct a concrete instance of `OpenShiftAPIPropertiesInvokeResponsePtrInput` via:
//
//          OpenShiftAPIPropertiesInvokeResponseArgs{...}
//
//  or:
//
//          nil
type OpenShiftAPIPropertiesInvokeResponsePtrInput interface {
	pulumi.Input

	ToOpenShiftAPIPropertiesInvokeResponsePtrOutput() OpenShiftAPIPropertiesInvokeResponsePtrOutput
	ToOpenShiftAPIPropertiesInvokeResponsePtrOutputWithContext(context.Context) OpenShiftAPIPropertiesInvokeResponsePtrOutput
}

type openShiftAPIPropertiesInvokeResponsePtrType OpenShiftAPIPropertiesInvokeResponseArgs

func OpenShiftAPIPropertiesInvokeResponsePtr(v *OpenShiftAPIPropertiesInvokeResponseArgs) OpenShiftAPIPropertiesInvokeResponsePtrInput {
	return (*openShiftAPIPropertiesInvokeResponsePtrType)(v)
}

func (*openShiftAPIPropertiesInvokeResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**OpenShiftAPIPropertiesInvokeResponse)(nil)).Elem()
}

func (i *openShiftAPIPropertiesInvokeResponsePtrType) ToOpenShiftAPIPropertiesInvokeResponsePtrOutput() OpenShiftAPIPropertiesInvokeResponsePtrOutput {
	return i.ToOpenShiftAPIPropertiesInvokeResponsePtrOutputWithContext(context.Background())
}

func (i *openShiftAPIPropertiesInvokeResponsePtrType) ToOpenShiftAPIPropertiesInvokeResponsePtrOutputWithContext(ctx context.Context) OpenShiftAPIPropertiesInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OpenShiftAPIPropertiesInvokeResponsePtrOutput)
}

// Defines further properties on the API.
type OpenShiftAPIPropertiesInvokeResponseOutput struct{ *pulumi.OutputState }

func (OpenShiftAPIPropertiesInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*OpenShiftAPIPropertiesInvokeResponse)(nil)).Elem()
}

func (o OpenShiftAPIPropertiesInvokeResponseOutput) ToOpenShiftAPIPropertiesInvokeResponseOutput() OpenShiftAPIPropertiesInvokeResponseOutput {
	return o
}

func (o OpenShiftAPIPropertiesInvokeResponseOutput) ToOpenShiftAPIPropertiesInvokeResponseOutputWithContext(ctx context.Context) OpenShiftAPIPropertiesInvokeResponseOutput {
	return o
}

func (o OpenShiftAPIPropertiesInvokeResponseOutput) ToOpenShiftAPIPropertiesInvokeResponsePtrOutput() OpenShiftAPIPropertiesInvokeResponsePtrOutput {
	return o.ToOpenShiftAPIPropertiesInvokeResponsePtrOutputWithContext(context.Background())
}

func (o OpenShiftAPIPropertiesInvokeResponseOutput) ToOpenShiftAPIPropertiesInvokeResponsePtrOutputWithContext(ctx context.Context) OpenShiftAPIPropertiesInvokeResponsePtrOutput {
	return o.ApplyT(func(v OpenShiftAPIPropertiesInvokeResponse) *OpenShiftAPIPropertiesInvokeResponse {
		return &v
	}).(OpenShiftAPIPropertiesInvokeResponsePtrOutput)
}

// Specifies if API server is public or private.
func (o OpenShiftAPIPropertiesInvokeResponseOutput) PrivateApiServer() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v OpenShiftAPIPropertiesInvokeResponse) *bool { return v.PrivateApiServer }).(pulumi.BoolPtrOutput)
}

type OpenShiftAPIPropertiesInvokeResponsePtrOutput struct{ *pulumi.OutputState }

func (OpenShiftAPIPropertiesInvokeResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**OpenShiftAPIPropertiesInvokeResponse)(nil)).Elem()
}

func (o OpenShiftAPIPropertiesInvokeResponsePtrOutput) ToOpenShiftAPIPropertiesInvokeResponsePtrOutput() OpenShiftAPIPropertiesInvokeResponsePtrOutput {
	return o
}

func (o OpenShiftAPIPropertiesInvokeResponsePtrOutput) ToOpenShiftAPIPropertiesInvokeResponsePtrOutputWithContext(ctx context.Context) OpenShiftAPIPropertiesInvokeResponsePtrOutput {
	return o
}

func (o OpenShiftAPIPropertiesInvokeResponsePtrOutput) Elem() OpenShiftAPIPropertiesInvokeResponseOutput {
	return o.ApplyT(func(v *OpenShiftAPIPropertiesInvokeResponse) OpenShiftAPIPropertiesInvokeResponse { return *v }).(OpenShiftAPIPropertiesInvokeResponseOutput)
}

// Specifies if API server is public or private.
func (o OpenShiftAPIPropertiesInvokeResponsePtrOutput) PrivateApiServer() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *OpenShiftAPIPropertiesInvokeResponse) *bool {
		if v == nil {
			return nil
		}
		return v.PrivateApiServer
...
type OpenShiftManagedClusterMasterPoolProfileInvokeResponse struct {
	// Defines further properties on the API.
	ApiProperties *OpenShiftAPIPropertiesInvokeResponse `pulumi:"apiProperties"`
	// Number of masters (VMs) to host docker containers. The default value is 3.
	Count int `pulumi:"count"`
	// Subnet CIDR for the peering.
	SubnetCidr *string `pulumi:"subnetCidr"`
...
type OpenShiftManagedClusterMasterPoolProfileInvokeResponseArgs struct {
	// Defines further properties on the API.
	ApiProperties OpenShiftAPIPropertiesInvokeResponsePtrInput `pulumi:"apiProperties"`
	// Number of masters (VMs) to host docker containers. The default value is 3.
	Count pulumi.IntInput `pulumi:"count"`
	// Subnet CIDR for the peering.
	SubnetCidr pulumi.StringPtrInput `pulumi:"subnetCidr"`
...
// Defines further properties on the API.
func (o OpenShiftManagedClusterMasterPoolProfileInvokeResponseOutput) ApiProperties() OpenShiftAPIPropertiesInvokeResponsePtrOutput {
	return o.ApplyT(func(v OpenShiftManagedClusterMasterPoolProfileInvokeResponse) *OpenShiftAPIPropertiesInvokeResponse {
		return v.ApiProperties
	}).(OpenShiftAPIPropertiesInvokeResponsePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(OpenShiftAPIPropertiesInvokeResponseOutput{})
	pulumi.RegisterOutputType(OpenShiftAPIPropertiesInvokeResponsePtrOutput{})
