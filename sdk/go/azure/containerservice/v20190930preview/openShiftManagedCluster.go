...
func NewOpenShiftManagedCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:containerservice/v20190930preview:OpenShiftManagedCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOpenShiftManagedCluster(ctx *pulumi.Context,
	...
	var resource OpenShiftManagedCluster
	err := ctx.ReadResource("azure-nextgen:containerservice/v20190930preview:OpenShiftManagedCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
