...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SnapshotTypeInput)(nil)).Elem(), SnapshotType("NodePool"))
	pulumi.RegisterInputType(reflect.TypeOf((*SnapshotTypePtrInput)(nil)).Elem(), SnapshotType("NodePool"))
