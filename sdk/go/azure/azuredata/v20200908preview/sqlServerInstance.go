...
func NewSqlServerInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:azuredata/v20200908preview:SqlServerInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServerInstance(ctx *pulumi.Context,
	...
	var resource SqlServerInstance
	err := ctx.ReadResource("azure-nextgen:azuredata/v20200908preview:SqlServerInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
