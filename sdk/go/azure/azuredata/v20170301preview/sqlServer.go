...
func NewSqlServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:azuredata/v20170301preview:SqlServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServer(ctx *pulumi.Context,
	...
	var resource SqlServer
	err := ctx.ReadResource("azure-nextgen:azuredata/v20170301preview:SqlServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
