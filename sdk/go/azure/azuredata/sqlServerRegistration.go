...
func NewSqlServerRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:azuredata:SqlServerRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServerRegistration(ctx *pulumi.Context,
	...
	var resource SqlServerRegistration
	err := ctx.ReadResource("azure-nextgen:azuredata:SqlServerRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
