...
func NewPostgresInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:azuredata/v20190724preview:PostgresInstance"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:azuredata:PostgresInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPostgresInstance(ctx *pulumi.Context,
	...
	var resource PostgresInstance
	err := ctx.ReadResource("azure-native:azuredata:PostgresInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
