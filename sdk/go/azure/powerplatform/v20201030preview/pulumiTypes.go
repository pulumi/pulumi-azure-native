...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*EnterprisePolicyIdentityInput)(nil)).Elem(), EnterprisePolicyIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnterprisePolicyIdentityPtrInput)(nil)).Elem(), EnterprisePolicyIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnterprisePolicyIdentityResponseInput)(nil)).Elem(), EnterprisePolicyIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnterprisePolicyIdentityResponsePtrInput)(nil)).Elem(), EnterprisePolicyIdentityResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeyPropertiesResponseInput)(nil)).Elem(), KeyPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyPropertiesResponsePtrInput)(nil)).Elem(), KeyPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PropertiesEncryptionInput)(nil)).Elem(), PropertiesEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertiesEncryptionPtrInput)(nil)).Elem(), PropertiesEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertiesLockboxInput)(nil)).Elem(), PropertiesLockboxArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertiesLockboxPtrInput)(nil)).Elem(), PropertiesLockboxArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertiesNetworkInjectionInput)(nil)).Elem(), PropertiesNetworkInjectionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertiesNetworkInjectionPtrInput)(nil)).Elem(), PropertiesNetworkInjectionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertiesResponseEncryptionInput)(nil)).Elem(), PropertiesResponseEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertiesResponseEncryptionPtrInput)(nil)).Elem(), PropertiesResponseEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertiesResponseLockboxInput)(nil)).Elem(), PropertiesResponseLockboxArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertiesResponseLockboxPtrInput)(nil)).Elem(), PropertiesResponseLockboxArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertiesResponseNetworkInjectionInput)(nil)).Elem(), PropertiesResponseNetworkInjectionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertiesResponseNetworkInjectionPtrInput)(nil)).Elem(), PropertiesResponseNetworkInjectionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetPropertiesInput)(nil)).Elem(), SubnetPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetPropertiesPtrInput)(nil)).Elem(), SubnetPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetPropertiesResponseInput)(nil)).Elem(), SubnetPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetPropertiesResponsePtrInput)(nil)).Elem(), SubnetPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPropertiesInput)(nil)).Elem(), VirtualNetworkPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPropertiesArrayInput)(nil)).Elem(), VirtualNetworkPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPropertiesListInput)(nil)).Elem(), VirtualNetworkPropertiesListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPropertiesListPtrInput)(nil)).Elem(), VirtualNetworkPropertiesListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPropertiesListResponseInput)(nil)).Elem(), VirtualNetworkPropertiesListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPropertiesListResponsePtrInput)(nil)).Elem(), VirtualNetworkPropertiesListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPropertiesResponseInput)(nil)).Elem(), VirtualNetworkPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPropertiesResponseArrayInput)(nil)).Elem(), VirtualNetworkPropertiesResponseArray{})
