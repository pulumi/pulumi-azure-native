...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AvroSerializationInput)(nil)).Elem(), AvroSerializationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AvroSerializationResponseInput)(nil)).Elem(), AvroSerializationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureDataLakeStoreOutputDataSourceInput)(nil)).Elem(), AzureDataLakeStoreOutputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureDataLakeStoreOutputDataSourceResponseInput)(nil)).Elem(), AzureDataLakeStoreOutputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceFunctionBindingInput)(nil)).Elem(), AzureMachineLearningWebServiceFunctionBindingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceFunctionBindingResponseInput)(nil)).Elem(), AzureMachineLearningWebServiceFunctionBindingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceInputColumnInput)(nil)).Elem(), AzureMachineLearningWebServiceInputColumnArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceInputColumnArrayInput)(nil)).Elem(), AzureMachineLearningWebServiceInputColumnArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceInputColumnResponseInput)(nil)).Elem(), AzureMachineLearningWebServiceInputColumnResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceInputColumnResponseArrayInput)(nil)).Elem(), AzureMachineLearningWebServiceInputColumnResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceInputsInput)(nil)).Elem(), AzureMachineLearningWebServiceInputsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceInputsPtrInput)(nil)).Elem(), AzureMachineLearningWebServiceInputsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceInputsResponseInput)(nil)).Elem(), AzureMachineLearningWebServiceInputsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceInputsResponsePtrInput)(nil)).Elem(), AzureMachineLearningWebServiceInputsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceOutputColumnInput)(nil)).Elem(), AzureMachineLearningWebServiceOutputColumnArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceOutputColumnArrayInput)(nil)).Elem(), AzureMachineLearningWebServiceOutputColumnArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceOutputColumnResponseInput)(nil)).Elem(), AzureMachineLearningWebServiceOutputColumnResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningWebServiceOutputColumnResponseArrayInput)(nil)).Elem(), AzureMachineLearningWebServiceOutputColumnResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureSqlDatabaseOutputDataSourceInput)(nil)).Elem(), AzureSqlDatabaseOutputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureSqlDatabaseOutputDataSourceResponseInput)(nil)).Elem(), AzureSqlDatabaseOutputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureTableOutputDataSourceInput)(nil)).Elem(), AzureTableOutputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureTableOutputDataSourceResponseInput)(nil)).Elem(), AzureTableOutputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobOutputDataSourceInput)(nil)).Elem(), BlobOutputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobOutputDataSourceResponseInput)(nil)).Elem(), BlobOutputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobReferenceInputDataSourceInput)(nil)).Elem(), BlobReferenceInputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobReferenceInputDataSourcePtrInput)(nil)).Elem(), BlobReferenceInputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobReferenceInputDataSourceResponseInput)(nil)).Elem(), BlobReferenceInputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobReferenceInputDataSourceResponsePtrInput)(nil)).Elem(), BlobReferenceInputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobStreamInputDataSourceInput)(nil)).Elem(), BlobStreamInputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobStreamInputDataSourceResponseInput)(nil)).Elem(), BlobStreamInputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterJobResponseInput)(nil)).Elem(), ClusterJobResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterJobResponseArrayInput)(nil)).Elem(), ClusterJobResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterPropertiesResponseInput)(nil)).Elem(), ClusterPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterPropertiesResponsePtrInput)(nil)).Elem(), ClusterPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CsvSerializationInput)(nil)).Elem(), CsvSerializationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CsvSerializationResponseInput)(nil)).Elem(), CsvSerializationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticConditionResponseInput)(nil)).Elem(), DiagnosticConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticConditionResponseArrayInput)(nil)).Elem(), DiagnosticConditionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticsResponseInput)(nil)).Elem(), DiagnosticsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticsResponsePtrInput)(nil)).Elem(), DiagnosticsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DocumentDbOutputDataSourceInput)(nil)).Elem(), DocumentDbOutputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DocumentDbOutputDataSourceResponseInput)(nil)).Elem(), DocumentDbOutputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventHubOutputDataSourceInput)(nil)).Elem(), EventHubOutputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventHubOutputDataSourceResponseInput)(nil)).Elem(), EventHubOutputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventHubStreamInputDataSourceInput)(nil)).Elem(), EventHubStreamInputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventHubStreamInputDataSourceResponseInput)(nil)).Elem(), EventHubStreamInputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionTypeInput)(nil)).Elem(), FunctionTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionTypeArrayInput)(nil)).Elem(), FunctionTypeArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionInputTypeInput)(nil)).Elem(), FunctionInputTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionInputTypeArrayInput)(nil)).Elem(), FunctionInputTypeArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionInputResponseInput)(nil)).Elem(), FunctionInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionInputResponseArrayInput)(nil)).Elem(), FunctionInputResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionOutputTypeInput)(nil)).Elem(), FunctionOutputTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionOutputTypePtrInput)(nil)).Elem(), FunctionOutputTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionOutputResponseInput)(nil)).Elem(), FunctionOutputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionOutputResponsePtrInput)(nil)).Elem(), FunctionOutputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionResponseInput)(nil)).Elem(), FunctionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionResponseArrayInput)(nil)).Elem(), FunctionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*InputTypeInput)(nil)).Elem(), InputTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InputTypeArrayInput)(nil)).Elem(), InputTypeArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IoTHubStreamInputDataSourceInput)(nil)).Elem(), IoTHubStreamInputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IoTHubStreamInputDataSourceResponseInput)(nil)).Elem(), IoTHubStreamInputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JavaScriptFunctionBindingInput)(nil)).Elem(), JavaScriptFunctionBindingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JavaScriptFunctionBindingResponseInput)(nil)).Elem(), JavaScriptFunctionBindingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JsonSerializationInput)(nil)).Elem(), JsonSerializationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JsonSerializationResponseInput)(nil)).Elem(), JsonSerializationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OutputTypeInput)(nil)).Elem(), OutputTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OutputTypeArrayInput)(nil)).Elem(), OutputTypeArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*OutputResponseInput)(nil)).Elem(), OutputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OutputResponseArrayInput)(nil)).Elem(), OutputResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PowerBIOutputDataSourceInput)(nil)).Elem(), PowerBIOutputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PowerBIOutputDataSourceResponseInput)(nil)).Elem(), PowerBIOutputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateEndpointPropertiesInput)(nil)).Elem(), PrivateEndpointPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateEndpointPropertiesPtrInput)(nil)).Elem(), PrivateEndpointPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateEndpointPropertiesResponseInput)(nil)).Elem(), PrivateEndpointPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateEndpointPropertiesResponsePtrInput)(nil)).Elem(), PrivateEndpointPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkConnectionStateResponseInput)(nil)).Elem(), PrivateLinkConnectionStateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkConnectionStateResponsePtrInput)(nil)).Elem(), PrivateLinkConnectionStateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkServiceConnectionInput)(nil)).Elem(), PrivateLinkServiceConnectionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkServiceConnectionArrayInput)(nil)).Elem(), PrivateLinkServiceConnectionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkServiceConnectionResponseInput)(nil)).Elem(), PrivateLinkServiceConnectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkServiceConnectionResponseArrayInput)(nil)).Elem(), PrivateLinkServiceConnectionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReferenceInputPropertiesInput)(nil)).Elem(), ReferenceInputPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReferenceInputPropertiesResponseInput)(nil)).Elem(), ReferenceInputPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalarFunctionPropertiesInput)(nil)).Elem(), ScalarFunctionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalarFunctionPropertiesPtrInput)(nil)).Elem(), ScalarFunctionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalarFunctionPropertiesResponseInput)(nil)).Elem(), ScalarFunctionPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalarFunctionPropertiesResponsePtrInput)(nil)).Elem(), ScalarFunctionPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusQueueOutputDataSourceInput)(nil)).Elem(), ServiceBusQueueOutputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusQueueOutputDataSourceResponseInput)(nil)).Elem(), ServiceBusQueueOutputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusTopicOutputDataSourceInput)(nil)).Elem(), ServiceBusTopicOutputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusTopicOutputDataSourceResponseInput)(nil)).Elem(), ServiceBusTopicOutputDataSourceResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StreamInputPropertiesInput)(nil)).Elem(), StreamInputPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StreamInputPropertiesResponseInput)(nil)).Elem(), StreamInputPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransformationInput)(nil)).Elem(), TransformationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransformationPtrInput)(nil)).Elem(), TransformationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransformationResponseInput)(nil)).Elem(), TransformationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransformationResponsePtrInput)(nil)).Elem(), TransformationResponseArgs{})
