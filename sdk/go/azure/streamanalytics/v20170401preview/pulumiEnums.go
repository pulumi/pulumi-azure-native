...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AuthenticationModeInput)(nil)).Elem(), AuthenticationMode("Msi"))
	pulumi.RegisterInputType(reflect.TypeOf((*AuthenticationModePtrInput)(nil)).Elem(), AuthenticationMode("Msi"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ContentStoragePolicyInput)(nil)).Elem(), ContentStoragePolicy("SystemAccount"))
	pulumi.RegisterInputType(reflect.TypeOf((*ContentStoragePolicyPtrInput)(nil)).Elem(), ContentStoragePolicy("SystemAccount"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*JobTypeInput)(nil)).Elem(), JobType("Cloud"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobTypePtrInput)(nil)).Elem(), JobType("Cloud"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StreamingJobSkuNameInput)(nil)).Elem(), StreamingJobSkuName("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*StreamingJobSkuNamePtrInput)(nil)).Elem(), StreamingJobSkuName("Standard"))
