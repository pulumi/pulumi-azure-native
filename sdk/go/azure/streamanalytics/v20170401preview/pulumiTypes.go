...
func (o AzureSqlReferenceInputDataSourcePropertiesResponseOutput) ToAzureSqlReferenceInputDataSourcePropertiesResponsePtrOutputWithContext(ctx context.Context) AzureSqlReferenceInputDataSourcePropertiesResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v AzureSqlReferenceInputDataSourcePropertiesResponse) *AzureSqlReferenceInputDataSourcePropertiesResponse {
		return &v
...
func (o StreamingJobSkuResponseOutput) ToStreamingJobSkuResponsePtrOutputWithContext(ctx context.Context) StreamingJobSkuResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v StreamingJobSkuResponse) *StreamingJobSkuResponse {
		return &v
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AggregateFunctionPropertiesInput)(nil)).Elem(), AggregateFunctionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AggregateFunctionPropertiesResponseInput)(nil)).Elem(), AggregateFunctionPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFunctionOutputDataSourceInput)(nil)).Elem(), AzureFunctionOutputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFunctionOutputDataSourceResponseInput)(nil)).Elem(), AzureFunctionOutputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningServiceFunctionBindingInput)(nil)).Elem(), AzureMachineLearningServiceFunctionBindingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningServiceFunctionBindingResponseInput)(nil)).Elem(), AzureMachineLearningServiceFunctionBindingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningServiceInputColumnInput)(nil)).Elem(), AzureMachineLearningServiceInputColumnArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningServiceInputColumnArrayInput)(nil)).Elem(), AzureMachineLearningServiceInputColumnArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningServiceInputColumnResponseInput)(nil)).Elem(), AzureMachineLearningServiceInputColumnResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningServiceInputColumnResponseArrayInput)(nil)).Elem(), AzureMachineLearningServiceInputColumnResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningServiceOutputColumnInput)(nil)).Elem(), AzureMachineLearningServiceOutputColumnArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningServiceOutputColumnArrayInput)(nil)).Elem(), AzureMachineLearningServiceOutputColumnArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningServiceOutputColumnResponseInput)(nil)).Elem(), AzureMachineLearningServiceOutputColumnResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningServiceOutputColumnResponseArrayInput)(nil)).Elem(), AzureMachineLearningServiceOutputColumnResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioFunctionBindingInput)(nil)).Elem(), AzureMachineLearningStudioFunctionBindingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioFunctionBindingResponseInput)(nil)).Elem(), AzureMachineLearningStudioFunctionBindingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioInputColumnInput)(nil)).Elem(), AzureMachineLearningStudioInputColumnArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioInputColumnArrayInput)(nil)).Elem(), AzureMachineLearningStudioInputColumnArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioInputColumnResponseInput)(nil)).Elem(), AzureMachineLearningStudioInputColumnResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioInputColumnResponseArrayInput)(nil)).Elem(), AzureMachineLearningStudioInputColumnResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioInputsInput)(nil)).Elem(), AzureMachineLearningStudioInputsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioInputsPtrInput)(nil)).Elem(), AzureMachineLearningStudioInputsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioInputsResponseInput)(nil)).Elem(), AzureMachineLearningStudioInputsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioInputsResponsePtrInput)(nil)).Elem(), AzureMachineLearningStudioInputsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioOutputColumnInput)(nil)).Elem(), AzureMachineLearningStudioOutputColumnArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioOutputColumnArrayInput)(nil)).Elem(), AzureMachineLearningStudioOutputColumnArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioOutputColumnResponseInput)(nil)).Elem(), AzureMachineLearningStudioOutputColumnResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMachineLearningStudioOutputColumnResponseArrayInput)(nil)).Elem(), AzureMachineLearningStudioOutputColumnResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AzureSqlReferenceInputDataSourcePropertiesInput)(nil)).Elem(), AzureSqlReferenceInputDataSourcePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureSqlReferenceInputDataSourcePropertiesPtrInput)(nil)).Elem(), AzureSqlReferenceInputDataSourcePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureSqlReferenceInputDataSourcePropertiesResponseInput)(nil)).Elem(), AzureSqlReferenceInputDataSourcePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureSqlReferenceInputDataSourcePropertiesResponsePtrInput)(nil)).Elem(), AzureSqlReferenceInputDataSourcePropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CSharpFunctionBindingInput)(nil)).Elem(), CSharpFunctionBindingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CSharpFunctionBindingResponseInput)(nil)).Elem(), CSharpFunctionBindingResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CustomClrSerializationInput)(nil)).Elem(), CustomClrSerializationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomClrSerializationResponseInput)(nil)).Elem(), CustomClrSerializationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ExternalInput)(nil)).Elem(), ExternalArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExternalPtrInput)(nil)).Elem(), ExternalArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExternalResponseInput)(nil)).Elem(), ExternalResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExternalResponsePtrInput)(nil)).Elem(), ExternalResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RawOutputDatasourceInput)(nil)).Elem(), RawOutputDatasourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RawOutputDatasourceResponseInput)(nil)).Elem(), RawOutputDatasourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RawReferenceInputDataSourceInput)(nil)).Elem(), RawReferenceInputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RawReferenceInputDataSourceResponseInput)(nil)).Elem(), RawReferenceInputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RawStreamInputDataSourceInput)(nil)).Elem(), RawStreamInputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RawStreamInputDataSourceResponseInput)(nil)).Elem(), RawStreamInputDataSourceResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StreamingJobSkuInput)(nil)).Elem(), StreamingJobSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StreamingJobSkuPtrInput)(nil)).Elem(), StreamingJobSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StreamingJobSkuResponseInput)(nil)).Elem(), StreamingJobSkuResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StreamingJobSkuResponsePtrInput)(nil)).Elem(), StreamingJobSkuResponseArgs{})
