...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AzureSqlReferenceInputDataSourceInput)(nil)).Elem(), AzureSqlReferenceInputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureSqlReferenceInputDataSourceResponseInput)(nil)).Elem(), AzureSqlReferenceInputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureSynapseOutputDataSourceInput)(nil)).Elem(), AzureSynapseOutputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureSynapseOutputDataSourceResponseInput)(nil)).Elem(), AzureSynapseOutputDataSourceResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterInfoInput)(nil)).Elem(), ClusterInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterInfoPtrInput)(nil)).Elem(), ClusterInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterInfoResponseInput)(nil)).Elem(), ClusterInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterInfoResponsePtrInput)(nil)).Elem(), ClusterInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CompressionInput)(nil)).Elem(), CompressionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CompressionPtrInput)(nil)).Elem(), CompressionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CompressionResponseInput)(nil)).Elem(), CompressionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CompressionResponsePtrInput)(nil)).Elem(), CompressionResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EventHubV2OutputDataSourceInput)(nil)).Elem(), EventHubV2OutputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventHubV2OutputDataSourceResponseInput)(nil)).Elem(), EventHubV2OutputDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventHubV2StreamInputDataSourceInput)(nil)).Elem(), EventHubV2StreamInputDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventHubV2StreamInputDataSourceResponseInput)(nil)).Elem(), EventHubV2StreamInputDataSourceResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*JobStorageAccountInput)(nil)).Elem(), JobStorageAccountArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobStorageAccountPtrInput)(nil)).Elem(), JobStorageAccountArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobStorageAccountResponseInput)(nil)).Elem(), JobStorageAccountResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobStorageAccountResponsePtrInput)(nil)).Elem(), JobStorageAccountResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ParquetSerializationInput)(nil)).Elem(), ParquetSerializationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParquetSerializationResponseInput)(nil)).Elem(), ParquetSerializationResponseArgs{})
