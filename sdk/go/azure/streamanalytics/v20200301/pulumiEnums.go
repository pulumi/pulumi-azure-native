...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CompressionTypeInput)(nil)).Elem(), CompressionType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*CompressionTypePtrInput)(nil)).Elem(), CompressionType("None"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RefreshTypeInput)(nil)).Elem(), RefreshType("Static"))
	pulumi.RegisterInputType(reflect.TypeOf((*RefreshTypePtrInput)(nil)).Elem(), RefreshType("Static"))
