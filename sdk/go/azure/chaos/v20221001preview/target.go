...
func NewTarget(ctx *pulumi.Context,
	...
	var resource Target
	err := ctx.RegisterResource("azure-native:chaos/v20221001preview:Target", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTarget(ctx *pulumi.Context,
	...
	var resource Target
	err := ctx.ReadResource("azure-native:chaos/v20221001preview:Target", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
