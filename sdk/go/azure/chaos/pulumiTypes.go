...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*BranchInput)(nil)).Elem(), BranchArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BranchArrayInput)(nil)).Elem(), BranchArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*BranchResponseInput)(nil)).Elem(), BranchResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BranchResponseArrayInput)(nil)).Elem(), BranchResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CapabilityPropertiesResponseInput)(nil)).Elem(), CapabilityPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CapabilityPropertiesResponsePtrInput)(nil)).Elem(), CapabilityPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContinuousActionInput)(nil)).Elem(), ContinuousActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContinuousActionResponseInput)(nil)).Elem(), ContinuousActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DelayActionInput)(nil)).Elem(), DelayActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DelayActionResponseInput)(nil)).Elem(), DelayActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiscreteActionInput)(nil)).Elem(), DiscreteActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiscreteActionResponseInput)(nil)).Elem(), DiscreteActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExperimentPropertiesInput)(nil)).Elem(), ExperimentPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExperimentPropertiesPtrInput)(nil)).Elem(), ExperimentPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExperimentPropertiesResponseInput)(nil)).Elem(), ExperimentPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExperimentPropertiesResponsePtrInput)(nil)).Elem(), ExperimentPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeyValuePairResponseInput)(nil)).Elem(), KeyValuePairResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyValuePairResponseArrayInput)(nil)).Elem(), KeyValuePairResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SelectorInput)(nil)).Elem(), SelectorArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SelectorArrayInput)(nil)).Elem(), SelectorArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SelectorResponseInput)(nil)).Elem(), SelectorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SelectorResponseArrayInput)(nil)).Elem(), SelectorResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TargetReferenceInput)(nil)).Elem(), TargetReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetReferenceArrayInput)(nil)).Elem(), TargetReferenceArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetReferenceResponseInput)(nil)).Elem(), TargetReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetReferenceResponseArrayInput)(nil)).Elem(), TargetReferenceResponseArray{})
