...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ExtensionAksAssignedIdentityInput)(nil)).Elem(), ExtensionAksAssignedIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExtensionAksAssignedIdentityPtrInput)(nil)).Elem(), ExtensionAksAssignedIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExtensionResponseAksAssignedIdentityInput)(nil)).Elem(), ExtensionResponseAksAssignedIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExtensionResponseAksAssignedIdentityPtrInput)(nil)).Elem(), ExtensionResponseAksAssignedIdentityArgs{})
