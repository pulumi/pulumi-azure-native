...
func NewFluxConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kubernetesconfiguration/v20211101preview:FluxConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFluxConfiguration(ctx *pulumi.Context,
	...
	var resource FluxConfiguration
	err := ctx.ReadResource("azure-native:kubernetesconfiguration/v20211101preview:FluxConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
