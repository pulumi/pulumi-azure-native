...
type BucketDefinitionResponseInput interface {
	pulumi.Input

	ToBucketDefinitionResponseOutput() BucketDefinitionResponseOutput
	ToBucketDefinitionResponseOutputWithContext(context.Context) BucketDefinitionResponseOutput
}

type BucketDefinitionResponseArgs struct {
	AccessKey             pulumi.StringPtrInput  `pulumi:"accessKey"`
	BucketName            pulumi.StringPtrInput  `pulumi:"bucketName"`
	Insecure              pulumi.BoolPtrInput    `pulumi:"insecure"`
	LocalAuthRef          pulumi.StringPtrInput  `pulumi:"localAuthRef"`
...
func (BucketDefinitionResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*BucketDefinitionResponse)(nil)).Elem()
}

func (i BucketDefinitionResponseArgs) ToBucketDefinitionResponseOutput() BucketDefinitionResponseOutput {
	return i.ToBucketDefinitionResponseOutputWithContext(context.Background())
}

func (i BucketDefinitionResponseArgs) ToBucketDefinitionResponseOutputWithContext(ctx context.Context) BucketDefinitionResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BucketDefinitionResponseOutput)
}

func (i BucketDefinitionResponseArgs) ToBucketDefinitionResponsePtrOutput() BucketDefinitionResponsePtrOutput {
	return i.ToBucketDefinitionResponsePtrOutputWithContext(context.Background())
}

func (i BucketDefinitionResponseArgs) ToBucketDefinitionResponsePtrOutputWithContext(ctx context.Context) BucketDefinitionResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BucketDefinitionResponseOutput).ToBucketDefinitionResponsePtrOutputWithContext(ctx)
}
...
type BucketDefinitionResponsePtrInput interface {
	pulumi.Input

	ToBucketDefinitionResponsePtrOutput() BucketDefinitionResponsePtrOutput
	ToBucketDefinitionResponsePtrOutputWithContext(context.Context) BucketDefinitionResponsePtrOutput
}

type bucketDefinitionResponsePtrType BucketDefinitionResponseArgs

func BucketDefinitionResponsePtr(v *BucketDefinitionResponseArgs) BucketDefinitionResponsePtrInput {
	return (*bucketDefinitionResponsePtrType)(v)
}

func (*bucketDefinitionResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**BucketDefinitionResponse)(nil)).Elem()
}

func (i *bucketDefinitionResponsePtrType) ToBucketDefinitionResponsePtrOutput() BucketDefinitionResponsePtrOutput {
	return i.ToBucketDefinitionResponsePtrOutputWithContext(context.Background())
}

func (i *bucketDefinitionResponsePtrType) ToBucketDefinitionResponsePtrOutputWithContext(ctx context.Context) BucketDefinitionResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BucketDefinitionResponsePtrOutput)
}
...
func (o BucketDefinitionResponseOutput) ToBucketDefinitionResponsePtrOutput() BucketDefinitionResponsePtrOutput {
	return o.ToBucketDefinitionResponsePtrOutputWithContext(context.Background())
}

func (o BucketDefinitionResponseOutput) ToBucketDefinitionResponsePtrOutputWithContext(ctx context.Context) BucketDefinitionResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v BucketDefinitionResponse) *BucketDefinitionResponse {
		return &v
	}).(BucketDefinitionResponsePtrOutput)
}
