...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigurationIdentityInput)(nil)).Elem(), ConfigurationIdentityArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ScopeClusterPtrInput)(nil)).Elem(), ScopeClusterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScopeClusterResponseInput)(nil)).Elem(), ScopeClusterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScopeClusterResponsePtrInput)(nil)).Elem(), ScopeClusterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScopeNamespaceInput)(nil)).Elem(), ScopeNamespaceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScopeNamespacePtrInput)(nil)).Elem(), ScopeNamespaceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScopeNamespaceResponseInput)(nil)).Elem(), ScopeNamespaceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScopeNamespaceResponsePtrInput)(nil)).Elem(), ScopeNamespaceResponseArgs{})
