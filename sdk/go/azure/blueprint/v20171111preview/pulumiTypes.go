...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterValueBaseInput)(nil)).Elem(), ParameterValueBaseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterValueBaseMapInput)(nil)).Elem(), ParameterValueBaseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterValueBaseResponseInput)(nil)).Elem(), ParameterValueBaseResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterValueBaseResponseMapInput)(nil)).Elem(), ParameterValueBaseResponseMap{})
