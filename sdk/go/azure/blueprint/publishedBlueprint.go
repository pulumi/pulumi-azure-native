...
func NewPublishedBlueprint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:blueprint:PublishedBlueprint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublishedBlueprint(ctx *pulumi.Context,
	...
	var resource PublishedBlueprint
	err := ctx.ReadResource("azure-nextgen:blueprint:PublishedBlueprint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
