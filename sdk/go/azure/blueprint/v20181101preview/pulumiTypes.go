...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AssignmentLockSettingsInput)(nil)).Elem(), AssignmentLockSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AssignmentLockSettingsPtrInput)(nil)).Elem(), AssignmentLockSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AssignmentLockSettingsResponseInput)(nil)).Elem(), AssignmentLockSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AssignmentLockSettingsResponsePtrInput)(nil)).Elem(), AssignmentLockSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AssignmentStatusResponseInput)(nil)).Elem(), AssignmentStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AssignmentStatusResponsePtrInput)(nil)).Elem(), AssignmentStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlueprintStatusResponseInput)(nil)).Elem(), BlueprintStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlueprintStatusResponsePtrInput)(nil)).Elem(), BlueprintStatusResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterDefinitionMapInput)(nil)).Elem(), ParameterDefinitionMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterDefinitionResponseInput)(nil)).Elem(), ParameterDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterDefinitionResponseMapInput)(nil)).Elem(), ParameterDefinitionResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterValueInput)(nil)).Elem(), ParameterValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterValueMapInput)(nil)).Elem(), ParameterValueMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterValueResponseInput)(nil)).Elem(), ParameterValueResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterValueResponseMapInput)(nil)).Elem(), ParameterValueResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceGroupDefinitionInput)(nil)).Elem(), ResourceGroupDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceGroupDefinitionMapInput)(nil)).Elem(), ResourceGroupDefinitionMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceGroupDefinitionResponseInput)(nil)).Elem(), ResourceGroupDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceGroupDefinitionResponseMapInput)(nil)).Elem(), ResourceGroupDefinitionResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceGroupValueInput)(nil)).Elem(), ResourceGroupValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceGroupValueMapInput)(nil)).Elem(), ResourceGroupValueMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceGroupValueResponseInput)(nil)).Elem(), ResourceGroupValueResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceGroupValueResponseMapInput)(nil)).Elem(), ResourceGroupValueResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretValueReferenceInput)(nil)).Elem(), SecretValueReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretValueReferencePtrInput)(nil)).Elem(), SecretValueReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretValueReferenceResponseInput)(nil)).Elem(), SecretValueReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretValueReferenceResponsePtrInput)(nil)).Elem(), SecretValueReferenceResponseArgs{})
