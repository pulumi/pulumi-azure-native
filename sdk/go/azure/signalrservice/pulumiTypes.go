...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServerlessUpstreamSettingsInput)(nil)).Elem(), ServerlessUpstreamSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerlessUpstreamSettingsPtrInput)(nil)).Elem(), ServerlessUpstreamSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerlessUpstreamSettingsResponseInput)(nil)).Elem(), ServerlessUpstreamSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerlessUpstreamSettingsResponsePtrInput)(nil)).Elem(), ServerlessUpstreamSettingsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SignalRNetworkACLsInput)(nil)).Elem(), SignalRNetworkACLsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SignalRNetworkACLsPtrInput)(nil)).Elem(), SignalRNetworkACLsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SignalRNetworkACLsResponseInput)(nil)).Elem(), SignalRNetworkACLsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SignalRNetworkACLsResponsePtrInput)(nil)).Elem(), SignalRNetworkACLsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UpstreamTemplateInput)(nil)).Elem(), UpstreamTemplateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UpstreamTemplateArrayInput)(nil)).Elem(), UpstreamTemplateArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*UpstreamTemplateResponseInput)(nil)).Elem(), UpstreamTemplateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UpstreamTemplateResponseArrayInput)(nil)).Elem(), UpstreamTemplateResponseArray{})
