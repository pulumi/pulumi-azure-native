...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SignalRTlsSettingsInput)(nil)).Elem(), SignalRTlsSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SignalRTlsSettingsPtrInput)(nil)).Elem(), SignalRTlsSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SignalRTlsSettingsResponseInput)(nil)).Elem(), SignalRTlsSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SignalRTlsSettingsResponsePtrInput)(nil)).Elem(), SignalRTlsSettingsResponseArgs{})
