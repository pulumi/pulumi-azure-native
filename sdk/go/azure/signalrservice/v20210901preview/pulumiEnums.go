...
// UpstreamAuthTypeInput is an input type that accepts UpstreamAuthTypeArgs and UpstreamAuthTypeOutput values.
// You can construct a concrete instance of `UpstreamAuthTypeInput` via:
//
