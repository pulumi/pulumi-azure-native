...
func NewSignalR(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:signalrservice:SignalR", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalR(ctx *pulumi.Context,
	...
	var resource SignalR
	err := ctx.ReadResource("azure-nextgen:signalrservice:SignalR", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
