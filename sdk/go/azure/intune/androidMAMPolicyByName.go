...
func NewAndroidMAMPolicyByName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:intune:AndroidMAMPolicyByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAndroidMAMPolicyByName(ctx *pulumi.Context,
	...
	var resource AndroidMAMPolicyByName
	err := ctx.ReadResource("azure-nextgen:intune:AndroidMAMPolicyByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
