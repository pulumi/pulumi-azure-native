...
func NewRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestack/v20160101:Registration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistration(ctx *pulumi.Context,
	...
	var resource Registration
	err := ctx.ReadResource("azure-native:azurestack/v20160101:Registration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
