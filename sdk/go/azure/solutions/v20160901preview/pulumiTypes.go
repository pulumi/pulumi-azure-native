...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ApplianceArtifactInput)(nil)).Elem(), ApplianceArtifactArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplianceArtifactArrayInput)(nil)).Elem(), ApplianceArtifactArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplianceArtifactResponseInput)(nil)).Elem(), ApplianceArtifactResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplianceArtifactResponseArrayInput)(nil)).Elem(), ApplianceArtifactResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplianceProviderAuthorizationInput)(nil)).Elem(), ApplianceProviderAuthorizationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplianceProviderAuthorizationArrayInput)(nil)).Elem(), ApplianceProviderAuthorizationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplianceProviderAuthorizationResponseInput)(nil)).Elem(), ApplianceProviderAuthorizationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplianceProviderAuthorizationResponseArrayInput)(nil)).Elem(), ApplianceProviderAuthorizationResponseArray{})
