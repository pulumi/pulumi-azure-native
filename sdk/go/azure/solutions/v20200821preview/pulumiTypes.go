...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationAuthorizationInput)(nil)).Elem(), ApplicationAuthorizationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationAuthorizationArrayInput)(nil)).Elem(), ApplicationAuthorizationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationAuthorizationResponseInput)(nil)).Elem(), ApplicationAuthorizationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationAuthorizationResponseArrayInput)(nil)).Elem(), ApplicationAuthorizationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationBillingDetailsDefinitionResponseInput)(nil)).Elem(), ApplicationBillingDetailsDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationBillingDetailsDefinitionResponsePtrInput)(nil)).Elem(), ApplicationBillingDetailsDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationClientDetailsResponseInput)(nil)).Elem(), ApplicationClientDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationClientDetailsResponsePtrInput)(nil)).Elem(), ApplicationClientDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationDefinitionArtifactInput)(nil)).Elem(), ApplicationDefinitionArtifactArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationDefinitionArtifactArrayInput)(nil)).Elem(), ApplicationDefinitionArtifactArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationDefinitionArtifactResponseInput)(nil)).Elem(), ApplicationDefinitionArtifactResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationDefinitionArtifactResponseArrayInput)(nil)).Elem(), ApplicationDefinitionArtifactResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationDeploymentPolicyInput)(nil)).Elem(), ApplicationDeploymentPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationDeploymentPolicyPtrInput)(nil)).Elem(), ApplicationDeploymentPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationDeploymentPolicyResponseInput)(nil)).Elem(), ApplicationDeploymentPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationDeploymentPolicyResponsePtrInput)(nil)).Elem(), ApplicationDeploymentPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationJitAccessPolicyInput)(nil)).Elem(), ApplicationJitAccessPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationJitAccessPolicyPtrInput)(nil)).Elem(), ApplicationJitAccessPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationJitAccessPolicyResponseInput)(nil)).Elem(), ApplicationJitAccessPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationJitAccessPolicyResponsePtrInput)(nil)).Elem(), ApplicationJitAccessPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationManagementPolicyInput)(nil)).Elem(), ApplicationManagementPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationManagementPolicyPtrInput)(nil)).Elem(), ApplicationManagementPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationManagementPolicyResponseInput)(nil)).Elem(), ApplicationManagementPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationManagementPolicyResponsePtrInput)(nil)).Elem(), ApplicationManagementPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationNotificationEndpointInput)(nil)).Elem(), ApplicationNotificationEndpointArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationNotificationEndpointArrayInput)(nil)).Elem(), ApplicationNotificationEndpointArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationNotificationEndpointResponseInput)(nil)).Elem(), ApplicationNotificationEndpointResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationNotificationEndpointResponseArrayInput)(nil)).Elem(), ApplicationNotificationEndpointResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationNotificationPolicyInput)(nil)).Elem(), ApplicationNotificationPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationNotificationPolicyPtrInput)(nil)).Elem(), ApplicationNotificationPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationNotificationPolicyResponseInput)(nil)).Elem(), ApplicationNotificationPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationNotificationPolicyResponsePtrInput)(nil)).Elem(), ApplicationNotificationPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPackageContactResponseInput)(nil)).Elem(), ApplicationPackageContactResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPackageContactResponsePtrInput)(nil)).Elem(), ApplicationPackageContactResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPackageLockingPolicyDefinitionInput)(nil)).Elem(), ApplicationPackageLockingPolicyDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPackageLockingPolicyDefinitionPtrInput)(nil)).Elem(), ApplicationPackageLockingPolicyDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPackageLockingPolicyDefinitionResponseInput)(nil)).Elem(), ApplicationPackageLockingPolicyDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPackageLockingPolicyDefinitionResponsePtrInput)(nil)).Elem(), ApplicationPackageLockingPolicyDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPackageSupportUrlsResponseInput)(nil)).Elem(), ApplicationPackageSupportUrlsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPackageSupportUrlsResponsePtrInput)(nil)).Elem(), ApplicationPackageSupportUrlsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPolicyInput)(nil)).Elem(), ApplicationPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPolicyArrayInput)(nil)).Elem(), ApplicationPolicyArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPolicyResponseInput)(nil)).Elem(), ApplicationPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPolicyResponseArrayInput)(nil)).Elem(), ApplicationPolicyResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*JitApproverDefinitionInput)(nil)).Elem(), JitApproverDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JitApproverDefinitionArrayInput)(nil)).Elem(), JitApproverDefinitionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*JitApproverDefinitionResponseInput)(nil)).Elem(), JitApproverDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JitApproverDefinitionResponseArrayInput)(nil)).Elem(), JitApproverDefinitionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*JitAuthorizationPoliciesInput)(nil)).Elem(), JitAuthorizationPoliciesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JitAuthorizationPoliciesArrayInput)(nil)).Elem(), JitAuthorizationPoliciesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*JitAuthorizationPoliciesResponseInput)(nil)).Elem(), JitAuthorizationPoliciesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JitAuthorizationPoliciesResponseArrayInput)(nil)).Elem(), JitAuthorizationPoliciesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*JitSchedulingPolicyInput)(nil)).Elem(), JitSchedulingPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JitSchedulingPolicyPtrInput)(nil)).Elem(), JitSchedulingPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JitSchedulingPolicyResponseInput)(nil)).Elem(), JitSchedulingPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JitSchedulingPolicyResponsePtrInput)(nil)).Elem(), JitSchedulingPolicyResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UserAssignedResourceIdentityResponseInput)(nil)).Elem(), UserAssignedResourceIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserAssignedResourceIdentityResponseMapInput)(nil)).Elem(), UserAssignedResourceIdentityResponseMap{})
