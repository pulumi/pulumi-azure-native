...
func NewGetLab(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:education:GetLab"),
		},
	})
	opts = append(opts, aliases)
	var resource GetLab
	err := ctx.RegisterResource("azure-native:education/v20211201preview:GetLab", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGetLab(ctx *pulumi.Context,
	...
	var resource GetLab
	err := ctx.ReadResource("azure-native:education/v20211201preview:GetLab", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
