...
func NewHybridUseBenefit(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:softwareplan/latest:HybridUseBenefit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridUseBenefit(ctx *pulumi.Context,
	...
	var resource HybridUseBenefit
	err := ctx.ReadResource("azure-native:softwareplan/latest:HybridUseBenefit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
