...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*DelegatedSubnetArgumentsInput)(nil)).Elem(), DelegatedSubnetArgumentsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DelegatedSubnetArgumentsPtrInput)(nil)).Elem(), DelegatedSubnetArgumentsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DelegatedSubnetArgumentsResponseInput)(nil)).Elem(), DelegatedSubnetArgumentsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DelegatedSubnetArgumentsResponsePtrInput)(nil)).Elem(), DelegatedSubnetArgumentsResponseArgs{})
