...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*InfrastructureEncryptionInput)(nil)).Elem(), InfrastructureEncryption("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*InfrastructureEncryptionPtrInput)(nil)).Elem(), InfrastructureEncryption("Enabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PublicNetworkAccessEnumInput)(nil)).Elem(), PublicNetworkAccessEnum("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*PublicNetworkAccessEnumPtrInput)(nil)).Elem(), PublicNetworkAccessEnum("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServerVersionInput)(nil)).Elem(), ServerVersion("5.6"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServerVersionPtrInput)(nil)).Elem(), ServerVersion("5.6"))
