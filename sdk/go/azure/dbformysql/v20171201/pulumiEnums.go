...
// InfrastructureEncryptionInput is an input type that accepts InfrastructureEncryptionArgs and InfrastructureEncryptionOutput values.
// You can construct a concrete instance of `InfrastructureEncryptionInput` via:
//
//          InfrastructureEncryptionArgs{...}
...
// PublicNetworkAccessEnumInput is an input type that accepts PublicNetworkAccessEnumArgs and PublicNetworkAccessEnumOutput values.
// You can construct a concrete instance of `PublicNetworkAccessEnumInput` via:
//
