...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*BackupInput)(nil)).Elem(), BackupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPtrInput)(nil)).Elem(), BackupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupResponseInput)(nil)).Elem(), BackupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupResponsePtrInput)(nil)).Elem(), BackupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HighAvailabilityInput)(nil)).Elem(), HighAvailabilityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HighAvailabilityPtrInput)(nil)).Elem(), HighAvailabilityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HighAvailabilityResponseInput)(nil)).Elem(), HighAvailabilityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HighAvailabilityResponsePtrInput)(nil)).Elem(), HighAvailabilityResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StorageResponseInput)(nil)).Elem(), StorageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageResponsePtrInput)(nil)).Elem(), StorageResponseArgs{})
