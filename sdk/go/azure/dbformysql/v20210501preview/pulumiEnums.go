...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HighAvailabilityModeInput)(nil)).Elem(), HighAvailabilityMode("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*HighAvailabilityModePtrInput)(nil)).Elem(), HighAvailabilityMode("Enabled"))
