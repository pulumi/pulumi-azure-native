...
// InfrastructureEncryptionEnumInput is an input type that accepts InfrastructureEncryptionEnumArgs and InfrastructureEncryptionEnumOutput values.
// You can construct a concrete instance of `InfrastructureEncryptionEnumInput` via:
//
//          InfrastructureEncryptionEnumArgs{...}
