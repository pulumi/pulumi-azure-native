...
func NewGlobalReachConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:avs/v20211201:GlobalReachConnection"),
		},
	})
	opts = append(opts, aliases)
	var resource GlobalReachConnection
	err := ctx.RegisterResource("azure-native:avs/v20210101preview:GlobalReachConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalReachConnection(ctx *pulumi.Context,
	...
	var resource GlobalReachConnection
	err := ctx.ReadResource("azure-native:avs/v20210101preview:GlobalReachConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
