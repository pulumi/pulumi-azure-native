...
func NewHcxEnterpriseSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:avs/v20210101preview:HcxEnterpriseSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHcxEnterpriseSite(ctx *pulumi.Context,
	...
	var resource HcxEnterpriseSite
	err := ctx.ReadResource("azure-nextgen:avs/v20210101preview:HcxEnterpriseSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
