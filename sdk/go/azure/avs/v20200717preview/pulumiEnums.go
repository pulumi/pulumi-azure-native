...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DhcpTypeEnumInput)(nil)).Elem(), DhcpTypeEnum("SERVER, RELAY"))
	pulumi.RegisterInputType(reflect.TypeOf((*DhcpTypeEnumPtrInput)(nil)).Elem(), DhcpTypeEnum("SERVER, RELAY"))
