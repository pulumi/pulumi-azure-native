...
func GetWorkloadNetworkDnsZone(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkDnsZone
	err := ctx.ReadResource("azure-nextgen:avs/v20200717preview:WorkloadNetworkDnsZone", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (WorkloadNetworkDnsZoneOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*WorkloadNetworkDnsZoneOutput)(nil)).Elem()
}
