...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AffinityTypeInput)(nil)).Elem(), AffinityType("Affinity"))
	pulumi.RegisterInputType(reflect.TypeOf((*AffinityTypePtrInput)(nil)).Elem(), AffinityType("Affinity"))
	pulumi.RegisterInputType(reflect.TypeOf((*AvailabilityStrategyInput)(nil)).Elem(), AvailabilityStrategy("SingleZone"))
	pulumi.RegisterInputType(reflect.TypeOf((*AvailabilityStrategyPtrInput)(nil)).Elem(), AvailabilityStrategy("SingleZone"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PlacementPolicyStateEnumInput)(nil)).Elem(), PlacementPolicyStateEnum("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*PlacementPolicyStateEnumPtrInput)(nil)).Elem(), PlacementPolicyStateEnum("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*PlacementPolicyTypeInput)(nil)).Elem(), PlacementPolicyType("VmVm"))
	pulumi.RegisterInputType(reflect.TypeOf((*PlacementPolicyTypePtrInput)(nil)).Elem(), PlacementPolicyType("VmVm"))
	pulumi.RegisterInputType(reflect.TypeOf((*PortMirroringDirectionEnumInput)(nil)).Elem(), PortMirroringDirectionEnum("INGRESS"))
	pulumi.RegisterInputType(reflect.TypeOf((*PortMirroringDirectionEnumPtrInput)(nil)).Elem(), PortMirroringDirectionEnum("INGRESS"))
