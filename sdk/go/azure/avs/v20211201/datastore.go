...
func NewDatastore(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:avs/v20211201:Datastore"),
		},
		{
		...
		{
			Type: pulumi.String("azure-nextgen:avs/v20210601:Datastore"),
		},
	})
	opts = append(opts, aliases)
	var resource Datastore
	err := ctx.RegisterResource("azure-native:avs/v20211201:Datastore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatastore(ctx *pulumi.Context,
	...
	var resource Datastore
	err := ctx.ReadResource("azure-native:avs/v20211201:Datastore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
