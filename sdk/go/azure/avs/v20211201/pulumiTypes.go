...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AvailabilityPropertiesInput)(nil)).Elem(), AvailabilityPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AvailabilityPropertiesPtrInput)(nil)).Elem(), AvailabilityPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AvailabilityPropertiesResponseInput)(nil)).Elem(), AvailabilityPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AvailabilityPropertiesResponsePtrInput)(nil)).Elem(), AvailabilityPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionKeyVaultPropertiesInput)(nil)).Elem(), EncryptionKeyVaultPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionKeyVaultPropertiesPtrInput)(nil)).Elem(), EncryptionKeyVaultPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionKeyVaultPropertiesResponseInput)(nil)).Elem(), EncryptionKeyVaultPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionKeyVaultPropertiesResponsePtrInput)(nil)).Elem(), EncryptionKeyVaultPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateCloudIdentityInput)(nil)).Elem(), PrivateCloudIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateCloudIdentityPtrInput)(nil)).Elem(), PrivateCloudIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateCloudIdentityResponseInput)(nil)).Elem(), PrivateCloudIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateCloudIdentityResponsePtrInput)(nil)).Elem(), PrivateCloudIdentityResponseArgs{})
