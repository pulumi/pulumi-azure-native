...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AddonHcxPropertiesInput)(nil)).Elem(), AddonHcxPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AddonHcxPropertiesResponseInput)(nil)).Elem(), AddonHcxPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AddonSrmPropertiesInput)(nil)).Elem(), AddonSrmPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AddonSrmPropertiesResponseInput)(nil)).Elem(), AddonSrmPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AddonVrPropertiesInput)(nil)).Elem(), AddonVrPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AddonVrPropertiesResponseInput)(nil)).Elem(), AddonVrPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DiskPoolVolumeInput)(nil)).Elem(), DiskPoolVolumeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiskPoolVolumePtrInput)(nil)).Elem(), DiskPoolVolumeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiskPoolVolumeResponseInput)(nil)).Elem(), DiskPoolVolumeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiskPoolVolumeResponsePtrInput)(nil)).Elem(), DiskPoolVolumeResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NetAppVolumeInput)(nil)).Elem(), NetAppVolumeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetAppVolumePtrInput)(nil)).Elem(), NetAppVolumeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetAppVolumeResponseInput)(nil)).Elem(), NetAppVolumeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetAppVolumeResponsePtrInput)(nil)).Elem(), NetAppVolumeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PSCredentialExecutionParameterInput)(nil)).Elem(), PSCredentialExecutionParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PSCredentialExecutionParameterResponseInput)(nil)).Elem(), PSCredentialExecutionParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScriptSecureStringExecutionParameterInput)(nil)).Elem(), ScriptSecureStringExecutionParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScriptSecureStringExecutionParameterResponseInput)(nil)).Elem(), ScriptSecureStringExecutionParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScriptStringExecutionParameterInput)(nil)).Elem(), ScriptStringExecutionParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScriptStringExecutionParameterResponseInput)(nil)).Elem(), ScriptStringExecutionParameterResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WorkloadNetworkDhcpRelayInput)(nil)).Elem(), WorkloadNetworkDhcpRelayArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkloadNetworkDhcpRelayResponseInput)(nil)).Elem(), WorkloadNetworkDhcpRelayResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkloadNetworkDhcpServerInput)(nil)).Elem(), WorkloadNetworkDhcpServerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkloadNetworkDhcpServerResponseInput)(nil)).Elem(), WorkloadNetworkDhcpServerResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WorkloadNetworkSegmentSubnetPtrInput)(nil)).Elem(), WorkloadNetworkSegmentSubnetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkloadNetworkSegmentSubnetResponseInput)(nil)).Elem(), WorkloadNetworkSegmentSubnetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkloadNetworkSegmentSubnetResponsePtrInput)(nil)).Elem(), WorkloadNetworkSegmentSubnetResponseArgs{})
