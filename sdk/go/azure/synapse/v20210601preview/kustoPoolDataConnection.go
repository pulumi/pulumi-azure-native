...
func NewKustoPoolDataConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:synapse/v20210601preview:KustoPoolDataConnection"),
		},
		{
			Type: pulumi.String("azure-native:synapse:KustoPoolDataConnection"),
		},
		{
			Type: pulumi.String("azure-nextgen:synapse:KustoPoolDataConnection"),
		},
		{
			Type: pulumi.String("azure-native:synapse/v20210401preview:KustoPoolDataConnection"),
		},
		{
			Type: pulumi.String("azure-nextgen:synapse/v20210401preview:KustoPoolDataConnection"),
		},
	})
