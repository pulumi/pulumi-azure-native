...
func NewPrivateLinkHub(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:synapse/v20210601preview:PrivateLinkHub"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210601preview:PrivateLinkHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkHub(ctx *pulumi.Context,
	...
	var resource PrivateLinkHub
	err := ctx.ReadResource("azure-native:synapse/v20210601preview:PrivateLinkHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
