...
func NewSqlPoolWorkloadGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210601preview:SqlPoolWorkloadGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlPoolWorkloadGroup(ctx *pulumi.Context,
	...
	var resource SqlPoolWorkloadGroup
	err := ctx.ReadResource("azure-native:synapse/v20210601preview:SqlPoolWorkloadGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
