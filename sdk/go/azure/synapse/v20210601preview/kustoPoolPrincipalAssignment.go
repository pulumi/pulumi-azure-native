...
func NewKustoPoolPrincipalAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210601preview:KustoPoolPrincipalAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustoPoolPrincipalAssignment(ctx *pulumi.Context,
	...
	var resource KustoPoolPrincipalAssignment
	err := ctx.ReadResource("azure-native:synapse/v20210601preview:KustoPoolPrincipalAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
