...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigurationTypeInput)(nil)).Elem(), ConfigurationType("File"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigurationTypePtrInput)(nil)).Elem(), ConfigurationType("File"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SkuNameInput)(nil)).Elem(), SkuName("Compute optimized"))
	pulumi.RegisterInputType(reflect.TypeOf((*SkuNamePtrInput)(nil)).Elem(), SkuName("Compute optimized"))
	pulumi.RegisterInputType(reflect.TypeOf((*SkuSizeInput)(nil)).Elem(), SkuSize("Extra small"))
	pulumi.RegisterInputType(reflect.TypeOf((*SkuSizePtrInput)(nil)).Elem(), SkuSize("Extra small"))
