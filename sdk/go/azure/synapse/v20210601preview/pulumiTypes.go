...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SparkConfigPropertiesInput)(nil)).Elem(), SparkConfigPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SparkConfigPropertiesPtrInput)(nil)).Elem(), SparkConfigPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SparkConfigPropertiesResponseInput)(nil)).Elem(), SparkConfigPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SparkConfigPropertiesResponsePtrInput)(nil)).Elem(), SparkConfigPropertiesResponseArgs{})
