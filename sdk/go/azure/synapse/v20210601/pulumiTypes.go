...
func (o IntegrationRuntimeCustomerVirtualNetworkResponseOutput) ToIntegrationRuntimeCustomerVirtualNetworkResponsePtrOutputWithContext(ctx context.Context) IntegrationRuntimeCustomerVirtualNetworkResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v IntegrationRuntimeCustomerVirtualNetworkResponse) *IntegrationRuntimeCustomerVirtualNetworkResponse {
		return &v
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeCustomerVirtualNetworkInput)(nil)).Elem(), IntegrationRuntimeCustomerVirtualNetworkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeCustomerVirtualNetworkPtrInput)(nil)).Elem(), IntegrationRuntimeCustomerVirtualNetworkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeCustomerVirtualNetworkResponseInput)(nil)).Elem(), IntegrationRuntimeCustomerVirtualNetworkResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeCustomerVirtualNetworkResponsePtrInput)(nil)).Elem(), IntegrationRuntimeCustomerVirtualNetworkResponseArgs{})
