...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspacePublicNetworkAccessInput)(nil)).Elem(), WorkspacePublicNetworkAccess("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspacePublicNetworkAccessPtrInput)(nil)).Elem(), WorkspacePublicNetworkAccess("Enabled"))
