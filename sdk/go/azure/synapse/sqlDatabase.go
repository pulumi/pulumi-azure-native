...
func NewSqlDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse:SqlDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlDatabase(ctx *pulumi.Context,
	...
	var resource SqlDatabase
	err := ctx.ReadResource("azure-native:synapse:SqlDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
