...
func NewSqlPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:synapse/v20201201:SqlPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlPool(ctx *pulumi.Context,
	...
	var resource SqlPool
	err := ctx.ReadResource("azure-nextgen:synapse/v20201201:SqlPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
