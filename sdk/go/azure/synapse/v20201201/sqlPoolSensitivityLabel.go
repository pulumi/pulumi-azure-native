...
func NewSqlPoolSensitivityLabel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:synapse/v20201201:SqlPoolSensitivityLabel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlPoolSensitivityLabel(ctx *pulumi.Context,
	...
	var resource SqlPoolSensitivityLabel
	err := ctx.ReadResource("azure-nextgen:synapse/v20201201:SqlPoolSensitivityLabel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
