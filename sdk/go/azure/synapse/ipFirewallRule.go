...
func NewIpFirewallRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:synapse:IpFirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpFirewallRule(ctx *pulumi.Context,
	...
	var resource IpFirewallRule
	err := ctx.ReadResource("azure-nextgen:synapse:IpFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
