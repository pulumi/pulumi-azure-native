...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GitHubClientSecretInput)(nil)).Elem(), GitHubClientSecretArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GitHubClientSecretPtrInput)(nil)).Elem(), GitHubClientSecretArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GitHubClientSecretResponseInput)(nil)).Elem(), GitHubClientSecretResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GitHubClientSecretResponsePtrInput)(nil)).Elem(), GitHubClientSecretResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedVirtualNetworkReferenceInput)(nil)).Elem(), ManagedVirtualNetworkReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedVirtualNetworkReferencePtrInput)(nil)).Elem(), ManagedVirtualNetworkReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedVirtualNetworkReferenceResponseInput)(nil)).Elem(), ManagedVirtualNetworkReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedVirtualNetworkReferenceResponsePtrInput)(nil)).Elem(), ManagedVirtualNetworkReferenceResponseArgs{})
