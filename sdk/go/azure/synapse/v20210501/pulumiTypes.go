...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AutoPausePropertiesInput)(nil)).Elem(), AutoPausePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoPausePropertiesPtrInput)(nil)).Elem(), AutoPausePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoPausePropertiesResponseInput)(nil)).Elem(), AutoPausePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoPausePropertiesResponsePtrInput)(nil)).Elem(), AutoPausePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalePropertiesInput)(nil)).Elem(), AutoScalePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalePropertiesPtrInput)(nil)).Elem(), AutoScalePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalePropertiesResponseInput)(nil)).Elem(), AutoScalePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalePropertiesResponsePtrInput)(nil)).Elem(), AutoScalePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CmdkeySetupInput)(nil)).Elem(), CmdkeySetupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CmdkeySetupResponseInput)(nil)).Elem(), CmdkeySetupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComponentSetupInput)(nil)).Elem(), ComponentSetupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComponentSetupResponseInput)(nil)).Elem(), ComponentSetupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CspWorkspaceAdminPropertiesInput)(nil)).Elem(), CspWorkspaceAdminPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CspWorkspaceAdminPropertiesPtrInput)(nil)).Elem(), CspWorkspaceAdminPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CspWorkspaceAdminPropertiesResponseInput)(nil)).Elem(), CspWorkspaceAdminPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CspWorkspaceAdminPropertiesResponsePtrInput)(nil)).Elem(), CspWorkspaceAdminPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomerManagedKeyDetailsInput)(nil)).Elem(), CustomerManagedKeyDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomerManagedKeyDetailsPtrInput)(nil)).Elem(), CustomerManagedKeyDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomerManagedKeyDetailsResponseInput)(nil)).Elem(), CustomerManagedKeyDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomerManagedKeyDetailsResponsePtrInput)(nil)).Elem(), CustomerManagedKeyDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataLakeStorageAccountDetailsInput)(nil)).Elem(), DataLakeStorageAccountDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataLakeStorageAccountDetailsPtrInput)(nil)).Elem(), DataLakeStorageAccountDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataLakeStorageAccountDetailsResponseInput)(nil)).Elem(), DataLakeStorageAccountDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataLakeStorageAccountDetailsResponsePtrInput)(nil)).Elem(), DataLakeStorageAccountDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DynamicExecutorAllocationInput)(nil)).Elem(), DynamicExecutorAllocationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DynamicExecutorAllocationPtrInput)(nil)).Elem(), DynamicExecutorAllocationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DynamicExecutorAllocationResponseInput)(nil)).Elem(), DynamicExecutorAllocationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DynamicExecutorAllocationResponsePtrInput)(nil)).Elem(), DynamicExecutorAllocationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionDetailsInput)(nil)).Elem(), EncryptionDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionDetailsPtrInput)(nil)).Elem(), EncryptionDetailsArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EntityReferenceInput)(nil)).Elem(), EntityReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EntityReferencePtrInput)(nil)).Elem(), EntityReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EntityReferenceResponseInput)(nil)).Elem(), EntityReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EntityReferenceResponsePtrInput)(nil)).Elem(), EntityReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnvironmentVariableSetupInput)(nil)).Elem(), EnvironmentVariableSetupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnvironmentVariableSetupResponseInput)(nil)).Elem(), EnvironmentVariableSetupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeComputePropertiesInput)(nil)).Elem(), IntegrationRuntimeComputePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeComputePropertiesPtrInput)(nil)).Elem(), IntegrationRuntimeComputePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeComputePropertiesResponseInput)(nil)).Elem(), IntegrationRuntimeComputePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeComputePropertiesResponsePtrInput)(nil)).Elem(), IntegrationRuntimeComputePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeCustomSetupScriptPropertiesInput)(nil)).Elem(), IntegrationRuntimeCustomSetupScriptPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeCustomSetupScriptPropertiesPtrInput)(nil)).Elem(), IntegrationRuntimeCustomSetupScriptPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeCustomSetupScriptPropertiesResponseInput)(nil)).Elem(), IntegrationRuntimeCustomSetupScriptPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeCustomSetupScriptPropertiesResponsePtrInput)(nil)).Elem(), IntegrationRuntimeCustomSetupScriptPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeDataFlowPropertiesInput)(nil)).Elem(), IntegrationRuntimeDataFlowPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeDataFlowPropertiesPtrInput)(nil)).Elem(), IntegrationRuntimeDataFlowPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeDataFlowPropertiesResponseInput)(nil)).Elem(), IntegrationRuntimeDataFlowPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeDataFlowPropertiesResponsePtrInput)(nil)).Elem(), IntegrationRuntimeDataFlowPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeDataProxyPropertiesInput)(nil)).Elem(), IntegrationRuntimeDataProxyPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeDataProxyPropertiesPtrInput)(nil)).Elem(), IntegrationRuntimeDataProxyPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeDataProxyPropertiesResponseInput)(nil)).Elem(), IntegrationRuntimeDataProxyPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeDataProxyPropertiesResponsePtrInput)(nil)).Elem(), IntegrationRuntimeDataProxyPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeSsisCatalogInfoResponseInput)(nil)).Elem(), IntegrationRuntimeSsisCatalogInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeSsisCatalogInfoResponsePtrInput)(nil)).Elem(), IntegrationRuntimeSsisCatalogInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeSsisPropertiesInput)(nil)).Elem(), IntegrationRuntimeSsisPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeSsisPropertiesPtrInput)(nil)).Elem(), IntegrationRuntimeSsisPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeSsisPropertiesResponseInput)(nil)).Elem(), IntegrationRuntimeSsisPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeSsisPropertiesResponsePtrInput)(nil)).Elem(), IntegrationRuntimeSsisPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeVNetPropertiesInput)(nil)).Elem(), IntegrationRuntimeVNetPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeVNetPropertiesPtrInput)(nil)).Elem(), IntegrationRuntimeVNetPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeVNetPropertiesResponseInput)(nil)).Elem(), IntegrationRuntimeVNetPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationRuntimeVNetPropertiesResponsePtrInput)(nil)).Elem(), IntegrationRuntimeVNetPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KekIdentityPropertiesInput)(nil)).Elem(), KekIdentityPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KekIdentityPropertiesPtrInput)(nil)).Elem(), KekIdentityPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KekIdentityPropertiesResponseInput)(nil)).Elem(), KekIdentityPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KekIdentityPropertiesResponsePtrInput)(nil)).Elem(), KekIdentityPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LibraryInfoInput)(nil)).Elem(), LibraryInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LibraryInfoArrayInput)(nil)).Elem(), LibraryInfoArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*LibraryInfoResponseInput)(nil)).Elem(), LibraryInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LibraryInfoResponseArrayInput)(nil)).Elem(), LibraryInfoResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*LibraryRequirementsInput)(nil)).Elem(), LibraryRequirementsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LibraryRequirementsPtrInput)(nil)).Elem(), LibraryRequirementsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LibraryRequirementsResponseInput)(nil)).Elem(), LibraryRequirementsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LibraryRequirementsResponsePtrInput)(nil)).Elem(), LibraryRequirementsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinkedIntegrationRuntimeKeyAuthorizationInput)(nil)).Elem(), LinkedIntegrationRuntimeKeyAuthorizationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinkedIntegrationRuntimeKeyAuthorizationResponseInput)(nil)).Elem(), LinkedIntegrationRuntimeKeyAuthorizationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinkedIntegrationRuntimeRbacAuthorizationInput)(nil)).Elem(), LinkedIntegrationRuntimeRbacAuthorizationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinkedIntegrationRuntimeRbacAuthorizationResponseInput)(nil)).Elem(), LinkedIntegrationRuntimeRbacAuthorizationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinkedIntegrationRuntimeResponseInput)(nil)).Elem(), LinkedIntegrationRuntimeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinkedIntegrationRuntimeResponseArrayInput)(nil)).Elem(), LinkedIntegrationRuntimeResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedIntegrationRuntimeInput)(nil)).Elem(), ManagedIntegrationRuntimeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedIntegrationRuntimeErrorResponseInput)(nil)).Elem(), ManagedIntegrationRuntimeErrorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedIntegrationRuntimeErrorResponseArrayInput)(nil)).Elem(), ManagedIntegrationRuntimeErrorResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedIntegrationRuntimeNodeResponseInput)(nil)).Elem(), ManagedIntegrationRuntimeNodeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedIntegrationRuntimeNodeResponseArrayInput)(nil)).Elem(), ManagedIntegrationRuntimeNodeResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedIntegrationRuntimeOperationResultResponseInput)(nil)).Elem(), ManagedIntegrationRuntimeOperationResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedIntegrationRuntimeResponseInput)(nil)).Elem(), ManagedIntegrationRuntimeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedIntegrationRuntimeStatusResponseInput)(nil)).Elem(), ManagedIntegrationRuntimeStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedVirtualNetworkSettingsInput)(nil)).Elem(), ManagedVirtualNetworkSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedVirtualNetworkSettingsPtrInput)(nil)).Elem(), ManagedVirtualNetworkSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedVirtualNetworkSettingsResponseInput)(nil)).Elem(), ManagedVirtualNetworkSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedVirtualNetworkSettingsResponsePtrInput)(nil)).Elem(), ManagedVirtualNetworkSettingsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateEndpointConnectionForPrivateLinkHubBasicResponseInput)(nil)).Elem(), PrivateEndpointConnectionForPrivateLinkHubBasicResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateEndpointConnectionForPrivateLinkHubBasicResponseArrayInput)(nil)).Elem(), PrivateEndpointConnectionForPrivateLinkHubBasicResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PurviewConfigurationInput)(nil)).Elem(), PurviewConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PurviewConfigurationPtrInput)(nil)).Elem(), PurviewConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PurviewConfigurationResponseInput)(nil)).Elem(), PurviewConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PurviewConfigurationResponsePtrInput)(nil)).Elem(), PurviewConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecureStringInput)(nil)).Elem(), SecureStringArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecureStringPtrInput)(nil)).Elem(), SecureStringArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecureStringResponseInput)(nil)).Elem(), SecureStringResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecureStringResponsePtrInput)(nil)).Elem(), SecureStringResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SelfHostedIntegrationRuntimeInput)(nil)).Elem(), SelfHostedIntegrationRuntimeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SelfHostedIntegrationRuntimeNodeResponseInput)(nil)).Elem(), SelfHostedIntegrationRuntimeNodeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SelfHostedIntegrationRuntimeNodeResponseArrayInput)(nil)).Elem(), SelfHostedIntegrationRuntimeNodeResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SelfHostedIntegrationRuntimeResponseInput)(nil)).Elem(), SelfHostedIntegrationRuntimeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SelfHostedIntegrationRuntimeStatusResponseInput)(nil)).Elem(), SelfHostedIntegrationRuntimeStatusResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SqlPoolVulnerabilityAssessmentRuleBaselineItemInput)(nil)).Elem(), SqlPoolVulnerabilityAssessmentRuleBaselineItemArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlPoolVulnerabilityAssessmentRuleBaselineItemArrayInput)(nil)).Elem(), SqlPoolVulnerabilityAssessmentRuleBaselineItemArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlPoolVulnerabilityAssessmentRuleBaselineItemResponseInput)(nil)).Elem(), SqlPoolVulnerabilityAssessmentRuleBaselineItemResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlPoolVulnerabilityAssessmentRuleBaselineItemResponseArrayInput)(nil)).Elem(), SqlPoolVulnerabilityAssessmentRuleBaselineItemResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkProfileInput)(nil)).Elem(), VirtualNetworkProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkProfilePtrInput)(nil)).Elem(), VirtualNetworkProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkProfileResponseInput)(nil)).Elem(), VirtualNetworkProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkProfileResponsePtrInput)(nil)).Elem(), VirtualNetworkProfileResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceKeyDetailsInput)(nil)).Elem(), WorkspaceKeyDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceKeyDetailsPtrInput)(nil)).Elem(), WorkspaceKeyDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceKeyDetailsResponseInput)(nil)).Elem(), WorkspaceKeyDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceKeyDetailsResponsePtrInput)(nil)).Elem(), WorkspaceKeyDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceRepositoryConfigurationInput)(nil)).Elem(), WorkspaceRepositoryConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceRepositoryConfigurationPtrInput)(nil)).Elem(), WorkspaceRepositoryConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceRepositoryConfigurationResponseInput)(nil)).Elem(), WorkspaceRepositoryConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceRepositoryConfigurationResponsePtrInput)(nil)).Elem(), WorkspaceRepositoryConfigurationResponseArgs{})
