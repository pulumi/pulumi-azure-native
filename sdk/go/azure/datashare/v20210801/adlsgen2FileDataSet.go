...
func NewADLSGen2FileDataSet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:datashare/v20210801:ADLSGen2FileDataSet"),
		},
		{
			Type: pulumi.String("azure-native:datashare:ADLSGen2FileDataSet"),
		},
		{
			Type: pulumi.String("azure-nextgen:datashare:ADLSGen2FileDataSet"),
		},
		{
			Type: pulumi.String("azure-native:datashare/v20181101preview:ADLSGen2FileDataSet"),
		},
		{
			Type: pulumi.String("azure-nextgen:datashare/v20181101preview:ADLSGen2FileDataSet"),
		},
		{
			Type: pulumi.String("azure-native:datashare/v20191101:ADLSGen2FileDataSet"),
		},
		{
			Type: pulumi.String("azure-nextgen:datashare/v20191101:ADLSGen2FileDataSet"),
		},
		{
			Type: pulumi.String("azure-native:datashare/v20200901:ADLSGen2FileDataSet"),
		},
		{
			Type: pulumi.String("azure-nextgen:datashare/v20200901:ADLSGen2FileDataSet"),
		},
		{
			Type: pulumi.String("azure-native:datashare/v20201001preview:ADLSGen2FileDataSet"),
		},
		{
			Type: pulumi.String("azure-nextgen:datashare/v20201001preview:ADLSGen2FileDataSet"),
		},
	})
	opts = append(opts, aliases)
	var resource ADLSGen2FileDataSet
	err := ctx.RegisterResource("azure-native:datashare/v20210801:ADLSGen2FileDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen2FileDataSet(ctx *pulumi.Context,
	...
	var resource ADLSGen2FileDataSet
	err := ctx.ReadResource("azure-native:datashare/v20210801:ADLSGen2FileDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
