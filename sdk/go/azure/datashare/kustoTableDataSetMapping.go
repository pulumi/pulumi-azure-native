...
func NewKustoTableDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare:KustoTableDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustoTableDataSetMapping(ctx *pulumi.Context,
	...
	var resource KustoTableDataSetMapping
	err := ctx.ReadResource("azure-native:datashare:KustoTableDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (*KustoTableDataSetMapping) ElementType() reflect.Type {
	return reflect.TypeOf((*KustoTableDataSetMapping)(nil))
}
