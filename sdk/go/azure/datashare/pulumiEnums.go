...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*DataSetKindInput)(nil)).Elem(), DataSetKind("Blob"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataSetKindPtrInput)(nil)).Elem(), DataSetKind("Blob"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataSetMappingKindInput)(nil)).Elem(), DataSetMappingKind("Blob"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataSetMappingKindPtrInput)(nil)).Elem(), DataSetMappingKind("Blob"))
	pulumi.RegisterInputType(reflect.TypeOf((*OutputTypeInput)(nil)).Elem(), OutputType("Csv"))
	pulumi.RegisterInputType(reflect.TypeOf((*OutputTypePtrInput)(nil)).Elem(), OutputType("Csv"))
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceIntervalInput)(nil)).Elem(), RecurrenceInterval("Hour"))
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceIntervalPtrInput)(nil)).Elem(), RecurrenceInterval("Hour"))
	pulumi.RegisterInputType(reflect.TypeOf((*ShareKindInput)(nil)).Elem(), ShareKind("CopyBased"))
	pulumi.RegisterInputType(reflect.TypeOf((*ShareKindPtrInput)(nil)).Elem(), ShareKind("CopyBased"))
	pulumi.RegisterInputType(reflect.TypeOf((*SynchronizationModeInput)(nil)).Elem(), SynchronizationMode("Incremental"))
	pulumi.RegisterInputType(reflect.TypeOf((*SynchronizationModePtrInput)(nil)).Elem(), SynchronizationMode("Incremental"))
	pulumi.RegisterInputType(reflect.TypeOf((*SynchronizationSettingKindInput)(nil)).Elem(), SynchronizationSettingKind("ScheduleBased"))
	pulumi.RegisterInputType(reflect.TypeOf((*SynchronizationSettingKindPtrInput)(nil)).Elem(), SynchronizationSettingKind("ScheduleBased"))
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerKindInput)(nil)).Elem(), TriggerKind("ScheduleBased"))
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerKindPtrInput)(nil)).Elem(), TriggerKind("ScheduleBased"))
	pulumi.RegisterInputType(reflect.TypeOf((*TypeInput)(nil)).Elem(), Type("SystemAssigned"))
	pulumi.RegisterInputType(reflect.TypeOf((*TypePtrInput)(nil)).Elem(), Type("SystemAssigned"))
