...
func NewKustoDatabaseDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20191101:KustoDatabaseDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustoDatabaseDataSetMapping(ctx *pulumi.Context,
	...
	var resource KustoDatabaseDataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20191101:KustoDatabaseDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*KustoDatabaseDataSetMappingInput)(nil)).Elem(), &KustoDatabaseDataSetMapping{})
