...
func NewBlobContainerDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20191101:BlobContainerDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobContainerDataSetMapping(ctx *pulumi.Context,
	...
	var resource BlobContainerDataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20191101:BlobContainerDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
