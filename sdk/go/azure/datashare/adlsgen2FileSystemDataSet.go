...
func NewADLSGen2FileSystemDataSet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:datashare:ADLSGen2FileSystemDataSet"),
		},
		{
			Type: pulumi.String("azure-native:datashare/v20181101preview:ADLSGen2FileSystemDataSet"),
		},
		{
			Type: pulumi.String("azure-nextgen:datashare/v20181101preview:ADLSGen2FileSystemDataSet"),
		},
		{
			Type: pulumi.String("azure-native:datashare/v20191101:ADLSGen2FileSystemDataSet"),
		},
		{
			Type: pulumi.String("azure-nextgen:datashare/v20191101:ADLSGen2FileSystemDataSet"),
		},
		{
		...
		{
			Type: pulumi.String("azure-nextgen:datashare/v20201001preview:ADLSGen2FileSystemDataSet"),
		},
		{
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ADLSGen2FileSystemDataSetInput)(nil)).Elem(), &ADLSGen2FileSystemDataSet{})
