...
func NewADLSGen2FileDataSetMapping(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:datashare/v20210801:ADLSGen2FileDataSetMapping"),
		},
	})
	opts = append(opts, aliases)
	var resource ADLSGen2FileDataSetMapping
	err := ctx.RegisterResource("azure-native:datashare:ADLSGen2FileDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen2FileDataSetMapping(ctx *pulumi.Context,
	...
	var resource ADLSGen2FileDataSetMapping
	err := ctx.ReadResource("azure-native:datashare:ADLSGen2FileDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
