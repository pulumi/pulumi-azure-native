...
func NewBlobFolderDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20181101preview:BlobFolderDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobFolderDataSet(ctx *pulumi.Context,
	...
	var resource BlobFolderDataSet
	err := ctx.ReadResource("azure-native:datashare/v20181101preview:BlobFolderDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
