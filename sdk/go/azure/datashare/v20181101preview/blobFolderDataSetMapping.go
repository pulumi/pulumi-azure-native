...
func NewBlobFolderDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20181101preview:BlobFolderDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobFolderDataSetMapping(ctx *pulumi.Context,
	...
	var resource BlobFolderDataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20181101preview:BlobFolderDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
