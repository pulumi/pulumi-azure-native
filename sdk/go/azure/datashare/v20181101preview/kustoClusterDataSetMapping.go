...
func NewKustoClusterDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20181101preview:KustoClusterDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustoClusterDataSetMapping(ctx *pulumi.Context,
	...
	var resource KustoClusterDataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20181101preview:KustoClusterDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
