...
func NewDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:datashare/v20181101preview:DataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataSet(ctx *pulumi.Context,
	...
	var resource DataSet
	err := ctx.ReadResource("azure-nextgen:datashare/v20181101preview:DataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
