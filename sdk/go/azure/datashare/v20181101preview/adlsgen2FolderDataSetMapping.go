...
func NewADLSGen2FolderDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20181101preview:ADLSGen2FolderDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen2FolderDataSetMapping(ctx *pulumi.Context,
	...
	var resource ADLSGen2FolderDataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20181101preview:ADLSGen2FolderDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
