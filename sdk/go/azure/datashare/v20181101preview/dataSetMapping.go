...
func NewDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:datashare/v20181101preview:DataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataSetMapping(ctx *pulumi.Context,
	...
	var resource DataSetMapping
	err := ctx.ReadResource("azure-nextgen:datashare/v20181101preview:DataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
