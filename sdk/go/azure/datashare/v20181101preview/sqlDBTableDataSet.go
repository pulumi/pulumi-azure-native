...
func NewSqlDBTableDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20181101preview:SqlDBTableDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlDBTableDataSet(ctx *pulumi.Context,
	...
	var resource SqlDBTableDataSet
	err := ctx.ReadResource("azure-native:datashare/v20181101preview:SqlDBTableDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
