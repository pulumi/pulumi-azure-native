...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ADLSGen2StorageAccountPathInput)(nil)).Elem(), ADLSGen2StorageAccountPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ADLSGen2StorageAccountPathArrayInput)(nil)).Elem(), ADLSGen2StorageAccountPathArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ADLSGen2StorageAccountPathResponseInput)(nil)).Elem(), ADLSGen2StorageAccountPathResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ADLSGen2StorageAccountPathResponseArrayInput)(nil)).Elem(), ADLSGen2StorageAccountPathResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobStorageAccountPathInput)(nil)).Elem(), BlobStorageAccountPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobStorageAccountPathArrayInput)(nil)).Elem(), BlobStorageAccountPathArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobStorageAccountPathResponseInput)(nil)).Elem(), BlobStorageAccountPathResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobStorageAccountPathResponseArrayInput)(nil)).Elem(), BlobStorageAccountPathResponseArray{})
