...
func NewPrivateEndpointConnectionsAdtAPI(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsAdtAPI", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionsAdtAPI(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionsAdtAPI
	err := ctx.ReadResource("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsAdtAPI", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
