...
func NewPrivateEndpointConnectionsForSCCPowershell(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsForSCCPowershell", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionsForSCCPowershell(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionsForSCCPowershell
	err := ctx.ReadResource("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsForSCCPowershell", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
