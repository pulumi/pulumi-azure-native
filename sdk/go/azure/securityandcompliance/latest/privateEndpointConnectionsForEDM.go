...
func NewPrivateEndpointConnectionsForEDM(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsForEDM"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsForEDM", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionsForEDM(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionsForEDM
	err := ctx.ReadResource("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsForEDM", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
