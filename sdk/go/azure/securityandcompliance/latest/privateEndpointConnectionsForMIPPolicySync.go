...
func NewPrivateEndpointConnectionsForMIPPolicySync(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsForMIPPolicySync", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionsForMIPPolicySync(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionsForMIPPolicySync
	err := ctx.ReadResource("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsForMIPPolicySync", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
