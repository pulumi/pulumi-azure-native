...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:securityandcompliance:privateLinkServicesForMIPPolicySync'.
...
func NewPrivateLinkServicesForMIPPolicySync(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityandcompliance/latest:privateLinkServicesForMIPPolicySync", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkServicesForMIPPolicySync(ctx *pulumi.Context,
	...
	var resource PrivateLinkServicesForMIPPolicySync
	err := ctx.ReadResource("azure-native:securityandcompliance/latest:privateLinkServicesForMIPPolicySync", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
