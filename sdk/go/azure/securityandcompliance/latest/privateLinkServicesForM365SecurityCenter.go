...
func NewPrivateLinkServicesForM365SecurityCenter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityandcompliance/latest:privateLinkServicesForM365SecurityCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkServicesForM365SecurityCenter(ctx *pulumi.Context,
	...
	var resource PrivateLinkServicesForM365SecurityCenter
	err := ctx.ReadResource("azure-native:securityandcompliance/latest:privateLinkServicesForM365SecurityCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
