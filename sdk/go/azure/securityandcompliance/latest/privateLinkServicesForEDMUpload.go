...
func NewPrivateLinkServicesForEDMUpload(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityandcompliance/latest:privateLinkServicesForEDMUpload", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkServicesForEDMUpload(ctx *pulumi.Context,
	...
	var resource PrivateLinkServicesForEDMUpload
	err := ctx.ReadResource("azure-native:securityandcompliance/latest:privateLinkServicesForEDMUpload", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
