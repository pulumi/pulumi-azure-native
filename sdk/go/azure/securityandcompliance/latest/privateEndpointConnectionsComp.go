...
func NewPrivateEndpointConnectionsComp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsComp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionsComp(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionsComp
	err := ctx.ReadResource("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsComp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
