...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateEndpointConnectionInput)(nil)).Elem(), PrivateEndpointConnectionArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAccessPolicyEntryInput)(nil)).Elem(), ServiceAccessPolicyEntryArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAccessPolicyEntryArrayInput)(nil)).Elem(), ServiceAccessPolicyEntryArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAccessPolicyEntryResponseInput)(nil)).Elem(), ServiceAccessPolicyEntryResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAccessPolicyEntryResponseArrayInput)(nil)).Elem(), ServiceAccessPolicyEntryResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAuthenticationConfigurationInfoInput)(nil)).Elem(), ServiceAuthenticationConfigurationInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAuthenticationConfigurationInfoPtrInput)(nil)).Elem(), ServiceAuthenticationConfigurationInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAuthenticationConfigurationInfoResponseInput)(nil)).Elem(), ServiceAuthenticationConfigurationInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAuthenticationConfigurationInfoResponsePtrInput)(nil)).Elem(), ServiceAuthenticationConfigurationInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCorsConfigurationInfoInput)(nil)).Elem(), ServiceCorsConfigurationInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCorsConfigurationInfoPtrInput)(nil)).Elem(), ServiceCorsConfigurationInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCorsConfigurationInfoResponseInput)(nil)).Elem(), ServiceCorsConfigurationInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCorsConfigurationInfoResponsePtrInput)(nil)).Elem(), ServiceCorsConfigurationInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCosmosDbConfigurationInfoInput)(nil)).Elem(), ServiceCosmosDbConfigurationInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCosmosDbConfigurationInfoPtrInput)(nil)).Elem(), ServiceCosmosDbConfigurationInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCosmosDbConfigurationInfoResponseInput)(nil)).Elem(), ServiceCosmosDbConfigurationInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCosmosDbConfigurationInfoResponsePtrInput)(nil)).Elem(), ServiceCosmosDbConfigurationInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceExportConfigurationInfoInput)(nil)).Elem(), ServiceExportConfigurationInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceExportConfigurationInfoPtrInput)(nil)).Elem(), ServiceExportConfigurationInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceExportConfigurationInfoResponseInput)(nil)).Elem(), ServiceExportConfigurationInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceExportConfigurationInfoResponsePtrInput)(nil)).Elem(), ServiceExportConfigurationInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicesPropertiesInput)(nil)).Elem(), ServicesPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicesPropertiesPtrInput)(nil)).Elem(), ServicesPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicesPropertiesResponseInput)(nil)).Elem(), ServicesPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicesPropertiesResponsePtrInput)(nil)).Elem(), ServicesPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicesResourceIdentityInput)(nil)).Elem(), ServicesResourceIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicesResourceIdentityPtrInput)(nil)).Elem(), ServicesResourceIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicesResourceResponseIdentityInput)(nil)).Elem(), ServicesResourceResponseIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicesResourceResponseIdentityPtrInput)(nil)).Elem(), ServicesResourceResponseIdentityArgs{})
