...
func NewAlertRuleAction(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:operationalinsights/v20200101:AlertRuleAction"),
		},
	})
	opts = append(opts, aliases)
	var resource AlertRuleAction
	err := ctx.RegisterResource("azure-nextgen:operationalinsights/latest:AlertRuleAction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertRuleAction(ctx *pulumi.Context,
	...
	var resource AlertRuleAction
	err := ctx.ReadResource("azure-nextgen:operationalinsights/latest:AlertRuleAction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
