...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DistributionGroupListReceiverValueInput)(nil)).Elem(), DistributionGroupListReceiverValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DistributionGroupListReceiverValuePtrInput)(nil)).Elem(), DistributionGroupListReceiverValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DistributionGroupListReceiverValueResponseInput)(nil)).Elem(), DistributionGroupListReceiverValueResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DistributionGroupListReceiverValueResponsePtrInput)(nil)).Elem(), DistributionGroupListReceiverValueResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationEventReceiverInput)(nil)).Elem(), NotificationEventReceiverArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationEventReceiverArrayInput)(nil)).Elem(), NotificationEventReceiverArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationEventReceiverResponseInput)(nil)).Elem(), NotificationEventReceiverResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationEventReceiverResponseArrayInput)(nil)).Elem(), NotificationEventReceiverResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationReceiverValueInput)(nil)).Elem(), NotificationReceiverValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationReceiverValuePtrInput)(nil)).Elem(), NotificationReceiverValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationReceiverValueResponseInput)(nil)).Elem(), NotificationReceiverValueResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationReceiverValueResponsePtrInput)(nil)).Elem(), NotificationReceiverValueResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PackageValidationResultResponseInput)(nil)).Elem(), PackageValidationResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PackageValidationResultResponseArrayInput)(nil)).Elem(), PackageValidationResultResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionReceiverValueInput)(nil)).Elem(), SubscriptionReceiverValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionReceiverValuePtrInput)(nil)).Elem(), SubscriptionReceiverValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionReceiverValueResponseInput)(nil)).Elem(), SubscriptionReceiverValueResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionReceiverValueResponsePtrInput)(nil)).Elem(), SubscriptionReceiverValueResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TargetOSInfoInput)(nil)).Elem(), TargetOSInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetOSInfoArrayInput)(nil)).Elem(), TargetOSInfoArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetOSInfoResponseInput)(nil)).Elem(), TargetOSInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetOSInfoResponseArrayInput)(nil)).Elem(), TargetOSInfoResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TestInput)(nil)).Elem(), TestArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TestArrayInput)(nil)).Elem(), TestArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TestBaseAccountSKUInput)(nil)).Elem(), TestBaseAccountSKUArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TestBaseAccountSKUPtrInput)(nil)).Elem(), TestBaseAccountSKUArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TestBaseAccountSKUCapabilityResponseInput)(nil)).Elem(), TestBaseAccountSKUCapabilityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TestBaseAccountSKUCapabilityResponseArrayInput)(nil)).Elem(), TestBaseAccountSKUCapabilityResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TestBaseAccountSKUResponseInput)(nil)).Elem(), TestBaseAccountSKUResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TestBaseAccountSKUResponsePtrInput)(nil)).Elem(), TestBaseAccountSKUResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TestResponseInput)(nil)).Elem(), TestResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TestResponseArrayInput)(nil)).Elem(), TestResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserObjectReceiverValueInput)(nil)).Elem(), UserObjectReceiverValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserObjectReceiverValuePtrInput)(nil)).Elem(), UserObjectReceiverValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserObjectReceiverValueResponseInput)(nil)).Elem(), UserObjectReceiverValueResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserObjectReceiverValueResponsePtrInput)(nil)).Elem(), UserObjectReceiverValueResponseArgs{})
