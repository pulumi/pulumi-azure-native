...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AddActionGroupsInput)(nil)).Elem(), AddActionGroupsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AddActionGroupsResponseInput)(nil)).Elem(), AddActionGroupsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DailyRecurrenceInput)(nil)).Elem(), DailyRecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DailyRecurrenceResponseInput)(nil)).Elem(), DailyRecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MonthlyRecurrenceInput)(nil)).Elem(), MonthlyRecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MonthlyRecurrenceResponseInput)(nil)).Elem(), MonthlyRecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RemoveAllActionGroupsInput)(nil)).Elem(), RemoveAllActionGroupsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RemoveAllActionGroupsResponseInput)(nil)).Elem(), RemoveAllActionGroupsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WeeklyRecurrenceInput)(nil)).Elem(), WeeklyRecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WeeklyRecurrenceResponseInput)(nil)).Elem(), WeeklyRecurrenceResponseArgs{})
