...
func NewActionRuleByName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:alertsmanagement/v20210808preview:ActionRuleByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActionRuleByName(ctx *pulumi.Context,
	...
	var resource ActionRuleByName
	err := ctx.ReadResource("azure-native:alertsmanagement/v20210808preview:ActionRuleByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
