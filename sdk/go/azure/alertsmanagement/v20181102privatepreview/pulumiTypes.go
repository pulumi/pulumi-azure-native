...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ActionRulePropertiesInput)(nil)).Elem(), ActionRulePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActionRulePropertiesPtrInput)(nil)).Elem(), ActionRulePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActionRulePropertiesResponseInput)(nil)).Elem(), ActionRulePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActionRulePropertiesResponsePtrInput)(nil)).Elem(), ActionRulePropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SuppressionConfigPtrInput)(nil)).Elem(), SuppressionConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SuppressionConfigResponseInput)(nil)).Elem(), SuppressionConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SuppressionConfigResponsePtrInput)(nil)).Elem(), SuppressionConfigResponseArgs{})
