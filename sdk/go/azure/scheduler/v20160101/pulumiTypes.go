...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*HttpAuthenticationInput)(nil)).Elem(), HttpAuthenticationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpAuthenticationPtrInput)(nil)).Elem(), HttpAuthenticationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpAuthenticationResponseInput)(nil)).Elem(), HttpAuthenticationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpAuthenticationResponsePtrInput)(nil)).Elem(), HttpAuthenticationResponseArgs{})
