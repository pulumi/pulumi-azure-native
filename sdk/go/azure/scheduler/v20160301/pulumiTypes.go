...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ClientCertAuthenticationInput)(nil)).Elem(), ClientCertAuthenticationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClientCertAuthenticationResponseInput)(nil)).Elem(), ClientCertAuthenticationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*JobActionInput)(nil)).Elem(), JobActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobActionPtrInput)(nil)).Elem(), JobActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobActionResponseInput)(nil)).Elem(), JobActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobActionResponsePtrInput)(nil)).Elem(), JobActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobCollectionPropertiesInput)(nil)).Elem(), JobCollectionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobCollectionPropertiesPtrInput)(nil)).Elem(), JobCollectionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobCollectionPropertiesResponseInput)(nil)).Elem(), JobCollectionPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobCollectionPropertiesResponsePtrInput)(nil)).Elem(), JobCollectionPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobCollectionQuotaInput)(nil)).Elem(), JobCollectionQuotaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobCollectionQuotaPtrInput)(nil)).Elem(), JobCollectionQuotaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobCollectionQuotaResponseInput)(nil)).Elem(), JobCollectionQuotaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobCollectionQuotaResponsePtrInput)(nil)).Elem(), JobCollectionQuotaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobErrorActionInput)(nil)).Elem(), JobErrorActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobErrorActionPtrInput)(nil)).Elem(), JobErrorActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobErrorActionResponseInput)(nil)).Elem(), JobErrorActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobErrorActionResponsePtrInput)(nil)).Elem(), JobErrorActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobMaxRecurrenceInput)(nil)).Elem(), JobMaxRecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobMaxRecurrencePtrInput)(nil)).Elem(), JobMaxRecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobMaxRecurrenceResponseInput)(nil)).Elem(), JobMaxRecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobMaxRecurrenceResponsePtrInput)(nil)).Elem(), JobMaxRecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobPropertiesInput)(nil)).Elem(), JobPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobPropertiesPtrInput)(nil)).Elem(), JobPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobPropertiesResponseInput)(nil)).Elem(), JobPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobPropertiesResponsePtrInput)(nil)).Elem(), JobPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobRecurrenceInput)(nil)).Elem(), JobRecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobRecurrencePtrInput)(nil)).Elem(), JobRecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobRecurrenceResponseInput)(nil)).Elem(), JobRecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobRecurrenceResponsePtrInput)(nil)).Elem(), JobRecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobRecurrenceScheduleInput)(nil)).Elem(), JobRecurrenceScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobRecurrenceSchedulePtrInput)(nil)).Elem(), JobRecurrenceScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobRecurrenceScheduleMonthlyOccurrenceInput)(nil)).Elem(), JobRecurrenceScheduleMonthlyOccurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobRecurrenceScheduleMonthlyOccurrenceArrayInput)(nil)).Elem(), JobRecurrenceScheduleMonthlyOccurrenceArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobRecurrenceScheduleMonthlyOccurrenceResponseInput)(nil)).Elem(), JobRecurrenceScheduleMonthlyOccurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobRecurrenceScheduleMonthlyOccurrenceResponseArrayInput)(nil)).Elem(), JobRecurrenceScheduleMonthlyOccurrenceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobRecurrenceScheduleResponseInput)(nil)).Elem(), JobRecurrenceScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobRecurrenceScheduleResponsePtrInput)(nil)).Elem(), JobRecurrenceScheduleResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OAuthAuthenticationInput)(nil)).Elem(), OAuthAuthenticationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OAuthAuthenticationResponseInput)(nil)).Elem(), OAuthAuthenticationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusAuthenticationInput)(nil)).Elem(), ServiceBusAuthenticationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusAuthenticationPtrInput)(nil)).Elem(), ServiceBusAuthenticationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusAuthenticationResponseInput)(nil)).Elem(), ServiceBusAuthenticationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusAuthenticationResponsePtrInput)(nil)).Elem(), ServiceBusAuthenticationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusBrokeredMessagePropertiesInput)(nil)).Elem(), ServiceBusBrokeredMessagePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusBrokeredMessagePropertiesPtrInput)(nil)).Elem(), ServiceBusBrokeredMessagePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusBrokeredMessagePropertiesResponseInput)(nil)).Elem(), ServiceBusBrokeredMessagePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusBrokeredMessagePropertiesResponsePtrInput)(nil)).Elem(), ServiceBusBrokeredMessagePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusQueueMessageInput)(nil)).Elem(), ServiceBusQueueMessageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusQueueMessagePtrInput)(nil)).Elem(), ServiceBusQueueMessageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusQueueMessageResponseInput)(nil)).Elem(), ServiceBusQueueMessageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusQueueMessageResponsePtrInput)(nil)).Elem(), ServiceBusQueueMessageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusTopicMessageInput)(nil)).Elem(), ServiceBusTopicMessageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusTopicMessagePtrInput)(nil)).Elem(), ServiceBusTopicMessageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusTopicMessageResponseInput)(nil)).Elem(), ServiceBusTopicMessageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusTopicMessageResponsePtrInput)(nil)).Elem(), ServiceBusTopicMessageResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StorageQueueMessageInput)(nil)).Elem(), StorageQueueMessageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageQueueMessagePtrInput)(nil)).Elem(), StorageQueueMessageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageQueueMessageResponseInput)(nil)).Elem(), StorageQueueMessageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageQueueMessageResponsePtrInput)(nil)).Elem(), StorageQueueMessageResponseArgs{})
