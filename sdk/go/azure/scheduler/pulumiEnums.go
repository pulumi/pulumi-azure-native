...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HttpAuthenticationTypeInput)(nil)).Elem(), HttpAuthenticationType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*HttpAuthenticationTypePtrInput)(nil)).Elem(), HttpAuthenticationType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobActionTypeInput)(nil)).Elem(), JobActionType("Http"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobActionTypePtrInput)(nil)).Elem(), JobActionType("Http"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobCollectionStateEnumInput)(nil)).Elem(), JobCollectionStateEnum("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobCollectionStateEnumPtrInput)(nil)).Elem(), JobCollectionStateEnum("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobScheduleDayInput)(nil)).Elem(), JobScheduleDay("Monday"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobScheduleDayPtrInput)(nil)).Elem(), JobScheduleDay("Monday"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobStateEnumInput)(nil)).Elem(), JobStateEnum("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobStateEnumPtrInput)(nil)).Elem(), JobStateEnum("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceFrequencyInput)(nil)).Elem(), RecurrenceFrequency("Minute"))
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceFrequencyPtrInput)(nil)).Elem(), RecurrenceFrequency("Minute"))
	pulumi.RegisterInputType(reflect.TypeOf((*RetryTypeInput)(nil)).Elem(), RetryType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*RetryTypePtrInput)(nil)).Elem(), RetryType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusAuthenticationTypeInput)(nil)).Elem(), ServiceBusAuthenticationType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusAuthenticationTypePtrInput)(nil)).Elem(), ServiceBusAuthenticationType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusTransportTypeInput)(nil)).Elem(), ServiceBusTransportType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceBusTransportTypePtrInput)(nil)).Elem(), ServiceBusTransportType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*SkuDefinitionInput)(nil)).Elem(), SkuDefinition("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*SkuDefinitionPtrInput)(nil)).Elem(), SkuDefinition("Standard"))
