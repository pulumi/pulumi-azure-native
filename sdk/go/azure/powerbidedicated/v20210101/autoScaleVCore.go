...
func NewAutoScaleVCore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:powerbidedicated/v20210101:AutoScaleVCore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutoScaleVCore(ctx *pulumi.Context,
	...
	var resource AutoScaleVCore
	err := ctx.ReadResource("azure-native:powerbidedicated/v20210101:AutoScaleVCore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
