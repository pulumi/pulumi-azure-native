...
// CapacitySkuTierInput is an input type that accepts CapacitySkuTierArgs and CapacitySkuTierOutput values.
// You can construct a concrete instance of `CapacitySkuTierInput` via:
//
//          CapacitySkuTierArgs{...}
...
// ModeInput is an input type that accepts ModeArgs and ModeOutput values.
// You can construct a concrete instance of `ModeInput` via:
//
//          ModeArgs{...}
...
// VCoreSkuTierInput is an input type that accepts VCoreSkuTierArgs and VCoreSkuTierOutput values.
// You can construct a concrete instance of `VCoreSkuTierInput` via:
//
//          VCoreSkuTierArgs{...}
