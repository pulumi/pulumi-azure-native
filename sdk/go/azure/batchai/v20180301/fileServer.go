...
func NewFileServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:batchai/v20180301:FileServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileServer(ctx *pulumi.Context,
	...
	var resource FileServer
	err := ctx.ReadResource("azure-native:batchai/v20180301:FileServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
