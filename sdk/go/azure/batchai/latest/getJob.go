...
type LookupJobResult struct {
	// Caffe2 job settings.
	Caffe2Settings *Caffe2SettingsInvokeResponse `pulumi:"caffe2Settings"`
	// Caffe job settings.
	CaffeSettings *CaffeSettingsInvokeResponse `pulumi:"caffeSettings"`
	// Chainer job settings.
	ChainerSettings *ChainerSettingsInvokeResponse `pulumi:"chainerSettings"`
	// Resource ID of the cluster associated with the job.
	Cluster *ResourceIdInvokeResponse `pulumi:"cluster"`
	// CNTK (aka Microsoft Cognitive Toolkit) job settings.
	CntkSettings *CNTKsettingsInvokeResponse `pulumi:"cntkSettings"`
	// Constraints associated with the Job.
	Constraints *JobPropertiesInvokeResponseConstraints `pulumi:"constraints"`
	// If the container was downloaded as part of cluster setup then the same container image will be used. If not provided, the job will run on the VM.
	ContainerSettings *ContainerSettingsInvokeResponse `pulumi:"containerSettings"`
	// The creation time of the job.
	CreationTime string `pulumi:"creationTime"`
	// Custom MPI job settings.
	CustomMpiSettings *CustomMpiSettingsInvokeResponse `pulumi:"customMpiSettings"`
	// Custom tool kit job settings.
	CustomToolkitSettings *CustomToolkitSettingsInvokeResponse `pulumi:"customToolkitSettings"`
	...
	ExecutionInfo *JobPropertiesInvokeResponseExecutionInfo `pulumi:"executionInfo"`
	...
	HorovodSettings *HorovodSettingsInvokeResponse `pulumi:"horovodSettings"`
	// The ID of the resource.
	Id string `pulumi:"id"`
	// A list of input directories for the job.
	InputDirectories []InputDirectoryInvokeResponse `pulumi:"inputDirectories"`
	...
	JobPreparation *JobPreparationInvokeResponse `pulumi:"jobPreparation"`
	...
	OutputDirectories []OutputDirectoryInvokeResponse `pulumi:"outputDirectories"`
	...
	PyTorchSettings *PyTorchSettingsInvokeResponse `pulumi:"pyTorchSettings"`
	...
	TensorFlowSettings *TensorFlowSettingsInvokeResponse `pulumi:"tensorFlowSettings"`
