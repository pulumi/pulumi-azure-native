...
func NewExperiment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:batchai/v20180501:Experiment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExperiment(ctx *pulumi.Context,
	...
	var resource Experiment
	err := ctx.ReadResource("azure-nextgen:batchai/v20180501:Experiment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
