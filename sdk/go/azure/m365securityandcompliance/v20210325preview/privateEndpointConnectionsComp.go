...
func NewPrivateEndpointConnectionsComp(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsComp"),
		},
		{
			Type: pulumi.String("azure-native:m365securityandcompliance:PrivateEndpointConnectionsComp"),
		},
		{
			Type: pulumi.String("azure-nextgen:m365securityandcompliance:PrivateEndpointConnectionsComp"),
		},
	})
	opts = append(opts, aliases)
	var resource PrivateEndpointConnectionsComp
	err := ctx.RegisterResource("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsComp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionsComp(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionsComp
	err := ctx.ReadResource("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsComp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
