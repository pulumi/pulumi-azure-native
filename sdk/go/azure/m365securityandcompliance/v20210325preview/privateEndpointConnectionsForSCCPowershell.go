...
func NewPrivateEndpointConnectionsForSCCPowershell(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsForSCCPowershell"),
		},
		{
			Type: pulumi.String("azure-native:m365securityandcompliance:PrivateEndpointConnectionsForSCCPowershell"),
		},
		{
			Type: pulumi.String("azure-nextgen:m365securityandcompliance:PrivateEndpointConnectionsForSCCPowershell"),
		},
	})
	opts = append(opts, aliases)
	var resource PrivateEndpointConnectionsForSCCPowershell
	err := ctx.RegisterResource("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsForSCCPowershell", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionsForSCCPowershell(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionsForSCCPowershell
	err := ctx.ReadResource("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsForSCCPowershell", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
