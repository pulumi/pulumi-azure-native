...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*APIServerProfileInput)(nil)).Elem(), APIServerProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*APIServerProfilePtrInput)(nil)).Elem(), APIServerProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*APIServerProfileResponseInput)(nil)).Elem(), APIServerProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*APIServerProfileResponsePtrInput)(nil)).Elem(), APIServerProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterProfileInput)(nil)).Elem(), ClusterProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterProfilePtrInput)(nil)).Elem(), ClusterProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterProfileResponseInput)(nil)).Elem(), ClusterProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterProfileResponsePtrInput)(nil)).Elem(), ClusterProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConsoleProfileInput)(nil)).Elem(), ConsoleProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConsoleProfilePtrInput)(nil)).Elem(), ConsoleProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConsoleProfileResponseInput)(nil)).Elem(), ConsoleProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConsoleProfileResponsePtrInput)(nil)).Elem(), ConsoleProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IngressProfileInput)(nil)).Elem(), IngressProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IngressProfileArrayInput)(nil)).Elem(), IngressProfileArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IngressProfileResponseInput)(nil)).Elem(), IngressProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IngressProfileResponseArrayInput)(nil)).Elem(), IngressProfileResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MasterProfileInput)(nil)).Elem(), MasterProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MasterProfilePtrInput)(nil)).Elem(), MasterProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MasterProfileResponseInput)(nil)).Elem(), MasterProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MasterProfileResponsePtrInput)(nil)).Elem(), MasterProfileResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServicePrincipalProfileInput)(nil)).Elem(), ServicePrincipalProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicePrincipalProfilePtrInput)(nil)).Elem(), ServicePrincipalProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicePrincipalProfileResponseInput)(nil)).Elem(), ServicePrincipalProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicePrincipalProfileResponsePtrInput)(nil)).Elem(), ServicePrincipalProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkerProfileInput)(nil)).Elem(), WorkerProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkerProfileArrayInput)(nil)).Elem(), WorkerProfileArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkerProfileResponseInput)(nil)).Elem(), WorkerProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkerProfileResponseArrayInput)(nil)).Elem(), WorkerProfileResponseArray{})
