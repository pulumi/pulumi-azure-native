...
// EncryptionAtHostInput is an input type that accepts EncryptionAtHostArgs and EncryptionAtHostOutput values.
// You can construct a concrete instance of `EncryptionAtHostInput` via:
//
//          EncryptionAtHostArgs{...}
...
// SoftwareDefinedNetworkInput is an input type that accepts SoftwareDefinedNetworkArgs and SoftwareDefinedNetworkOutput values.
// You can construct a concrete instance of `SoftwareDefinedNetworkInput` via:
//
//          SoftwareDefinedNetworkArgs{...}
...
// VMSizeInput is an input type that accepts VMSizeArgs and VMSizeOutput values.
// You can construct a concrete instance of `VMSizeInput` via:
//
//          VMSizeArgs{...}
