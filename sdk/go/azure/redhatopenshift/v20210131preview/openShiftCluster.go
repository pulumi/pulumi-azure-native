...
func NewOpenShiftCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:redhatopenshift/v20210131preview:OpenShiftCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOpenShiftCluster(ctx *pulumi.Context,
	...
	var resource OpenShiftCluster
	err := ctx.ReadResource("azure-nextgen:redhatopenshift/v20210131preview:OpenShiftCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
