...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPrivateEndpointConnectionPropertiesResponseInput)(nil)).Elem(), ServerPrivateEndpointConnectionPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPrivateLinkServiceConnectionStatePropertyResponseInput)(nil)).Elem(), ServerPrivateLinkServiceConnectionStatePropertyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPrivateLinkServiceConnectionStatePropertyResponsePtrInput)(nil)).Elem(), ServerPrivateLinkServiceConnectionStatePropertyResponseArgs{})
