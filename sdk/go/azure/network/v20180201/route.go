...
func NewRoute(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:network/v20210201:Route"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210301:Route"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210301:Route"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210501:Route"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210501:Route"),
		},
	})
	opts = append(opts, aliases)
	var resource Route
	err := ctx.RegisterResource("azure-native:network/v20180201:Route", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.ReadResource("azure-native:network/v20180201:Route", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
