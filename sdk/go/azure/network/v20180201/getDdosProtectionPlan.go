...
func (o LookupDdosProtectionPlanResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupDdosProtectionPlanResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
