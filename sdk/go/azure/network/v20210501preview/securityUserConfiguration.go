...
func NewSecurityUserConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210501preview:SecurityUserConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityUserConfiguration(ctx *pulumi.Context,
	...
	var resource SecurityUserConfiguration
	err := ctx.ReadResource("azure-native:network/v20210501preview:SecurityUserConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o SecurityUserConfigurationOutput) ApplyOnNetworkIntentPolicyBasedServices() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *SecurityUserConfiguration) pulumi.StringArrayOutput {
