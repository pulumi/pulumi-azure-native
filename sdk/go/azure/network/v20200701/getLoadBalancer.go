...
func LookupLoadBalancer(ctx *pulumi.Context, args *LookupLoadBalancerArgs, opts ...pulumi.InvokeOption) (*LookupLoadBalancerResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:network/v20200701:getLoadBalancer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupLoadBalancerResult struct {
	...
	// The outbound rules.
	OutboundRules []OutboundRuleInvokeResponse `pulumi:"outboundRules"`
	...
	Sku *LoadBalancerSkuInvokeResponse `pulumi:"sku"`
	// Resource tags.
