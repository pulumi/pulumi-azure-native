...
func LookupVirtualNetworkPeering(ctx *pulumi.Context, args *LookupVirtualNetworkPeeringArgs, opts ...pulumi.InvokeOption) (*LookupVirtualNetworkPeeringResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:network/v20200701:getVirtualNetworkPeering", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupVirtualNetworkPeeringResult struct {
	...
	RemoteBgpCommunities *VirtualNetworkBgpCommunitiesInvokeResponse `pulumi:"remoteBgpCommunities"`
