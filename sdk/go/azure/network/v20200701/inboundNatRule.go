...
func NewInboundNatRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20200701:InboundNatRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInboundNatRule(ctx *pulumi.Context,
	...
	var resource InboundNatRule
	err := ctx.ReadResource("azure-nextgen:network/v20200701:InboundNatRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
