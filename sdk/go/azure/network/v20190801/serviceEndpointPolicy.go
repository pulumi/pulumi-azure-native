...
func NewServiceEndpointPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:network/v20201101:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210201:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210201:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210301:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210301:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210501:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210501:ServiceEndpointPolicy"),
		},
	})
	opts = append(opts, aliases)
	var resource ServiceEndpointPolicy
	err := ctx.RegisterResource("azure-native:network/v20190801:ServiceEndpointPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEndpointPolicy(ctx *pulumi.Context,
	...
	var resource ServiceEndpointPolicy
	err := ctx.ReadResource("azure-native:network/v20190801:ServiceEndpointPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
