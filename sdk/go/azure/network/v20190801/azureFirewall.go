...
func NewAzureFirewall(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20190801:AzureFirewall", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureFirewall(ctx *pulumi.Context,
	...
	var resource AzureFirewall
	err := ctx.ReadResource("azure-nextgen:network/v20190801:AzureFirewall", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
