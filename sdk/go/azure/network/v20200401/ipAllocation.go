...
func NewIpAllocation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20200401:IpAllocation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpAllocation(ctx *pulumi.Context,
	...
	var resource IpAllocation
	err := ctx.ReadResource("azure-nextgen:network/v20200401:IpAllocation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
