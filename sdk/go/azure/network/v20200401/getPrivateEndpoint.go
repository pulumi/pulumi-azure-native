...
func LookupPrivateEndpoint(ctx *pulumi.Context, args *LookupPrivateEndpointArgs, opts ...pulumi.InvokeOption) (*LookupPrivateEndpointResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:network/v20200401:getPrivateEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupPrivateEndpointResult struct {
	...
	CustomDnsConfigs []CustomDnsConfigPropertiesFormatInvokeResponse `pulumi:"customDnsConfigs"`
