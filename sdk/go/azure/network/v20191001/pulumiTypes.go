...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleExclusionInput)(nil)).Elem(), ManagedRuleExclusionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleExclusionArrayInput)(nil)).Elem(), ManagedRuleExclusionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleExclusionResponseInput)(nil)).Elem(), ManagedRuleExclusionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleExclusionResponseArrayInput)(nil)).Elem(), ManagedRuleExclusionResponseArray{})
