...
func LookupVirtualWan(ctx *pulumi.Context, args *LookupVirtualWanArgs, opts ...pulumi.InvokeOption) (*LookupVirtualWanResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:network/v20181001:getVirtualWan", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupVirtualWanResult struct {
	...
	P2SVpnServerConfigurations []P2SVpnServerConfigurationInvokeResponse `pulumi:"p2SVpnServerConfigurations"`
