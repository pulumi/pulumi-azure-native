...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderActionInput)(nil)).Elem(), HeaderActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderActionArrayInput)(nil)).Elem(), HeaderActionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderActionResponseInput)(nil)).Elem(), HeaderActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderActionResponseArrayInput)(nil)).Elem(), HeaderActionResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RulesEngineActionInput)(nil)).Elem(), RulesEngineActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RulesEngineActionResponseInput)(nil)).Elem(), RulesEngineActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RulesEngineMatchConditionInput)(nil)).Elem(), RulesEngineMatchConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RulesEngineMatchConditionArrayInput)(nil)).Elem(), RulesEngineMatchConditionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RulesEngineMatchConditionResponseInput)(nil)).Elem(), RulesEngineMatchConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RulesEngineMatchConditionResponseArrayInput)(nil)).Elem(), RulesEngineMatchConditionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RulesEngineResponseInput)(nil)).Elem(), RulesEngineResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RulesEngineResponseArrayInput)(nil)).Elem(), RulesEngineResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RulesEngineRuleResponseInput)(nil)).Elem(), RulesEngineRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RulesEngineRuleResponseArrayInput)(nil)).Elem(), RulesEngineRuleResponseArray{})
