...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CommissionedStateInput)(nil)).Elem(), CommissionedState("Provisioning"))
	pulumi.RegisterInputType(reflect.TypeOf((*CommissionedStatePtrInput)(nil)).Elem(), CommissionedState("Provisioning"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CoverageLevelInput)(nil)).Elem(), CoverageLevel("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*CoverageLevelPtrInput)(nil)).Elem(), CoverageLevel("Default"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DestinationPortBehaviorInput)(nil)).Elem(), DestinationPortBehavior("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*DestinationPortBehaviorPtrInput)(nil)).Elem(), DestinationPortBehavior("None"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointTypeInput)(nil)).Elem(), EndpointType("AzureVM"))
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointTypePtrInput)(nil)).Elem(), EndpointType("AzureVM"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ExpressRouteLinkMacSecCipherInput)(nil)).Elem(), ExpressRouteLinkMacSecCipher("GcmAes256"))
	pulumi.RegisterInputType(reflect.TypeOf((*ExpressRouteLinkMacSecCipherPtrInput)(nil)).Elem(), ExpressRouteLinkMacSecCipher("GcmAes256"))
	pulumi.RegisterInputType(reflect.TypeOf((*ExpressRouteLinkMacSecSciStateInput)(nil)).Elem(), ExpressRouteLinkMacSecSciState("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ExpressRouteLinkMacSecSciStatePtrInput)(nil)).Elem(), ExpressRouteLinkMacSecSciState("Disabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyFilterRuleCollectionActionTypeInput)(nil)).Elem(), FirewallPolicyFilterRuleCollectionActionType("Allow"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyFilterRuleCollectionActionTypePtrInput)(nil)).Elem(), FirewallPolicyFilterRuleCollectionActionType("Allow"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyIntrusionDetectionProtocolInput)(nil)).Elem(), FirewallPolicyIntrusionDetectionProtocol("TCP"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyIntrusionDetectionProtocolPtrInput)(nil)).Elem(), FirewallPolicyIntrusionDetectionProtocol("TCP"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyIntrusionDetectionStateTypeInput)(nil)).Elem(), FirewallPolicyIntrusionDetectionStateType("Off"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyIntrusionDetectionStateTypePtrInput)(nil)).Elem(), FirewallPolicyIntrusionDetectionStateType("Off"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyNatRuleCollectionActionTypeInput)(nil)).Elem(), FirewallPolicyNatRuleCollectionActionType("DNAT"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyNatRuleCollectionActionTypePtrInput)(nil)).Elem(), FirewallPolicyNatRuleCollectionActionType("DNAT"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyRuleApplicationProtocolTypeInput)(nil)).Elem(), FirewallPolicyRuleApplicationProtocolType("Http"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyRuleApplicationProtocolTypePtrInput)(nil)).Elem(), FirewallPolicyRuleApplicationProtocolType("Http"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyRuleCollectionTypeInput)(nil)).Elem(), FirewallPolicyRuleCollectionType("FirewallPolicyNatRuleCollection"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyRuleCollectionTypePtrInput)(nil)).Elem(), FirewallPolicyRuleCollectionType("FirewallPolicyNatRuleCollection"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyRuleNetworkProtocolInput)(nil)).Elem(), FirewallPolicyRuleNetworkProtocol("TCP"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyRuleNetworkProtocolPtrInput)(nil)).Elem(), FirewallPolicyRuleNetworkProtocol("TCP"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyRuleTypeInput)(nil)).Elem(), FirewallPolicyRuleType("ApplicationRule"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicyRuleTypePtrInput)(nil)).Elem(), FirewallPolicyRuleType("ApplicationRule"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicySkuTierInput)(nil)).Elem(), FirewallPolicySkuTier("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallPolicySkuTierPtrInput)(nil)).Elem(), FirewallPolicySkuTier("Standard"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerSkuTierInput)(nil)).Elem(), LoadBalancerSkuTier("Regional"))
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerSkuTierPtrInput)(nil)).Elem(), LoadBalancerSkuTier("Regional"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkInterfaceMigrationPhaseInput)(nil)).Elem(), NetworkInterfaceMigrationPhase("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkInterfaceMigrationPhasePtrInput)(nil)).Elem(), NetworkInterfaceMigrationPhase("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkInterfaceNicTypeInput)(nil)).Elem(), NetworkInterfaceNicType("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkInterfaceNicTypePtrInput)(nil)).Elem(), NetworkInterfaceNicType("Standard"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ProtocolTypeInput)(nil)).Elem(), ProtocolType("DoNotUse"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProtocolTypePtrInput)(nil)).Elem(), ProtocolType("DoNotUse"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PublicIPAddressSkuTierInput)(nil)).Elem(), PublicIPAddressSkuTier("Regional"))
	pulumi.RegisterInputType(reflect.TypeOf((*PublicIPAddressSkuTierPtrInput)(nil)).Elem(), PublicIPAddressSkuTier("Regional"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PublicIPPrefixSkuTierInput)(nil)).Elem(), PublicIPPrefixSkuTier("Regional"))
	pulumi.RegisterInputType(reflect.TypeOf((*PublicIPPrefixSkuTierPtrInput)(nil)).Elem(), PublicIPPrefixSkuTier("Regional"))
	pulumi.RegisterInputType(reflect.TypeOf((*PublicIpAddressMigrationPhaseInput)(nil)).Elem(), PublicIpAddressMigrationPhase("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*PublicIpAddressMigrationPhasePtrInput)(nil)).Elem(), PublicIpAddressMigrationPhase("None"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkGatewayConnectionModeInput)(nil)).Elem(), VirtualNetworkGatewayConnectionMode("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkGatewayConnectionModePtrInput)(nil)).Elem(), VirtualNetworkGatewayConnectionMode("Default"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPrivateEndpointNetworkPoliciesInput)(nil)).Elem(), VirtualNetworkPrivateEndpointNetworkPolicies("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPrivateEndpointNetworkPoliciesPtrInput)(nil)).Elem(), VirtualNetworkPrivateEndpointNetworkPolicies("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPrivateLinkServiceNetworkPoliciesInput)(nil)).Elem(), VirtualNetworkPrivateLinkServiceNetworkPolicies("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPrivateLinkServiceNetworkPoliciesPtrInput)(nil)).Elem(), VirtualNetworkPrivateLinkServiceNetworkPolicies("Enabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VpnLinkConnectionModeInput)(nil)).Elem(), VpnLinkConnectionMode("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*VpnLinkConnectionModePtrInput)(nil)).Elem(), VpnLinkConnectionMode("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*VpnNatRuleModeInput)(nil)).Elem(), VpnNatRuleMode("EgressSnat"))
	pulumi.RegisterInputType(reflect.TypeOf((*VpnNatRuleModePtrInput)(nil)).Elem(), VpnNatRuleMode("EgressSnat"))
	pulumi.RegisterInputType(reflect.TypeOf((*VpnNatRuleTypeInput)(nil)).Elem(), VpnNatRuleType("Static"))
	pulumi.RegisterInputType(reflect.TypeOf((*VpnNatRuleTypePtrInput)(nil)).Elem(), VpnNatRuleType("Static"))
