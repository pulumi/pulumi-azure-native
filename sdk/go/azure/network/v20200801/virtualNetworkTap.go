...
func NewVirtualNetworkTap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20200801:VirtualNetworkTap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkTap(ctx *pulumi.Context,
	...
	var resource VirtualNetworkTap
	err := ctx.ReadResource("azure-nextgen:network/v20200801:VirtualNetworkTap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
