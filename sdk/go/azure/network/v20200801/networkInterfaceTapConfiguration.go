...
func NewNetworkInterfaceTapConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20200801:NetworkInterfaceTapConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkInterfaceTapConfiguration(ctx *pulumi.Context,
	...
	var resource NetworkInterfaceTapConfiguration
	err := ctx.ReadResource("azure-nextgen:network/v20200801:NetworkInterfaceTapConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
