...
func LookupVirtualRouter(ctx *pulumi.Context, args *LookupVirtualRouterArgs, opts ...pulumi.InvokeOption) (*LookupVirtualRouterResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:network/v20200301:getVirtualRouter", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupVirtualRouterResult struct {
	...
	HostedGateway *SubResourceInvokeResponse `pulumi:"hostedGateway"`
	// The Subnet on which VirtualRouter is hosted.
	HostedSubnet *SubResourceInvokeResponse `pulumi:"hostedSubnet"`
	// Resource ID.
	Id *string `pulumi:"id"`
	// Resource location.
	...
	Peerings []SubResourceInvokeResponse `pulumi:"peerings"`
