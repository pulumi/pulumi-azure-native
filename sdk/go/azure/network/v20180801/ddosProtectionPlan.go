...
func NewDdosProtectionPlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20180801:DdosProtectionPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDdosProtectionPlan(ctx *pulumi.Context,
	...
	var resource DdosProtectionPlan
	err := ctx.ReadResource("azure-nextgen:network/v20180801:DdosProtectionPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
