...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AllowedEndpointRecordTypeInput)(nil)).Elem(), AllowedEndpointRecordType("DomainName"))
	pulumi.RegisterInputType(reflect.TypeOf((*AllowedEndpointRecordTypePtrInput)(nil)).Elem(), AllowedEndpointRecordType("DomainName"))
