...
func NewExperiment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20191101:Experiment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExperiment(ctx *pulumi.Context,
	...
	var resource Experiment
	err := ctx.ReadResource("azure-nextgen:network/v20191101:Experiment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
