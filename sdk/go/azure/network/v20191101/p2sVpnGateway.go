...
func NewP2sVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20191101:P2sVpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetP2sVpnGateway(ctx *pulumi.Context,
	...
	var resource P2sVpnGateway
	err := ctx.ReadResource("azure-nextgen:network/v20191101:P2sVpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
