...
func NewNetworkWatcher(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:network/v20210201:NetworkWatcher"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210301:NetworkWatcher"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210301:NetworkWatcher"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210501:NetworkWatcher"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210501:NetworkWatcher"),
		},
	})
	opts = append(opts, aliases)
	var resource NetworkWatcher
	err := ctx.RegisterResource("azure-native:network/v20191201:NetworkWatcher", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkWatcher(ctx *pulumi.Context,
	...
	var resource NetworkWatcher
	err := ctx.ReadResource("azure-native:network/v20191201:NetworkWatcher", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
