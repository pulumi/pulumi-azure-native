...
func NewSecurityConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:network/v20210201preview:SecurityConfiguration"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network:SecurityConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityConfiguration(ctx *pulumi.Context,
	...
	var resource SecurityConfiguration
	err := ctx.ReadResource("azure-native:network:SecurityConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
