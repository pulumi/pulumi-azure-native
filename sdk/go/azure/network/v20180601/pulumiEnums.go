...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ExpressRouteCircuitPeeringAdvertisedPublicPrefixStateInput)(nil)).Elem(), ExpressRouteCircuitPeeringAdvertisedPublicPrefixState("NotConfigured"))
	pulumi.RegisterInputType(reflect.TypeOf((*ExpressRouteCircuitPeeringAdvertisedPublicPrefixStatePtrInput)(nil)).Elem(), ExpressRouteCircuitPeeringAdvertisedPublicPrefixState("NotConfigured"))
