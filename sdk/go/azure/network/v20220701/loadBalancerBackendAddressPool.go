...
func NewLoadBalancerBackendAddressPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220701:LoadBalancerBackendAddressPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoadBalancerBackendAddressPool(ctx *pulumi.Context,
	...
	var resource LoadBalancerBackendAddressPool
	err := ctx.ReadResource("azure-native:network/v20220701:LoadBalancerBackendAddressPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
