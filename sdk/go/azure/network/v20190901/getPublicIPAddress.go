...
func LookupPublicIPAddress(ctx *pulumi.Context, args *LookupPublicIPAddressArgs, opts ...pulumi.InvokeOption) (*LookupPublicIPAddressResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:network/v20190901:getPublicIPAddress", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupPublicIPAddressResult struct {
	...
	DdosSettings *DdosSettingsInvokeResponse `pulumi:"ddosSettings"`
	...
	Sku *PublicIPAddressSkuInvokeResponse `pulumi:"sku"`
	// Resource tags.
