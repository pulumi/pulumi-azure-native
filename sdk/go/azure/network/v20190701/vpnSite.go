...
func NewVpnSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20190701:VpnSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnSite(ctx *pulumi.Context,
	...
	var resource VpnSite
	err := ctx.ReadResource("azure-nextgen:network/v20190701:VpnSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
