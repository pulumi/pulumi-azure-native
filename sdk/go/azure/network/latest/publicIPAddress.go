...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:network:PublicIPAddress'.
...
func NewPublicIPAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/latest:PublicIPAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicIPAddress(ctx *pulumi.Context,
	...
	var resource PublicIPAddress
	err := ctx.ReadResource("azure-nextgen:network/latest:PublicIPAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
