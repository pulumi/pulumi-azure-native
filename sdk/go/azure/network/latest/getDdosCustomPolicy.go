...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:network:getDdosCustomPolicy'.
func LookupDdosCustomPolicy(ctx *pulumi.Context, args *LookupDdosCustomPolicyArgs, opts ...pulumi.InvokeOption) (*LookupDdosCustomPolicyResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:network/latest:getDdosCustomPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
