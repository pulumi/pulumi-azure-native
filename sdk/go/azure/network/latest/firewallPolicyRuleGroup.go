...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:FirewallPolicyRuleGroup'.
...
func NewFirewallPolicyRuleGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/latest:FirewallPolicyRuleGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicyRuleGroup(ctx *pulumi.Context,
	...
	var resource FirewallPolicyRuleGroup
	err := ctx.ReadResource("azure-native:network/latest:FirewallPolicyRuleGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
