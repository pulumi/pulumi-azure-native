...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:VirtualHub'.
...
func NewVirtualHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/latest:VirtualHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHub(ctx *pulumi.Context,
	...
	var resource VirtualHub
	err := ctx.ReadResource("azure-native:network/latest:VirtualHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
