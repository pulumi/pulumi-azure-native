...
func NewLocalNetworkGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/latest:LocalNetworkGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLocalNetworkGateway(ctx *pulumi.Context,
	...
	var resource LocalNetworkGateway
	err := ctx.ReadResource("azure-native:network/latest:LocalNetworkGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
