...
func NewSubnet(ctx *pulumi.Context,
	...
	var resource Subnet
	err := ctx.RegisterResource("azure-nextgen:network/v20181101:Subnet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubnet(ctx *pulumi.Context,
	...
	var resource Subnet
	err := ctx.ReadResource("azure-nextgen:network/v20181101:Subnet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
