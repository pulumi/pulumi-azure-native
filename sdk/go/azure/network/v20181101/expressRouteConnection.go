...
func NewExpressRouteConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:network/v20210201:ExpressRouteConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210301:ExpressRouteConnection"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210301:ExpressRouteConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210501:ExpressRouteConnection"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210501:ExpressRouteConnection"),
		},
	})
	opts = append(opts, aliases)
	var resource ExpressRouteConnection
	err := ctx.RegisterResource("azure-native:network/v20181101:ExpressRouteConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteConnection(ctx *pulumi.Context,
	...
	var resource ExpressRouteConnection
	err := ctx.ReadResource("azure-native:network/v20181101:ExpressRouteConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
