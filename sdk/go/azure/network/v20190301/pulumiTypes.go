...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorManagedRuleGroupOverrideInput)(nil)).Elem(), FrontDoorManagedRuleGroupOverrideArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorManagedRuleGroupOverrideArrayInput)(nil)).Elem(), FrontDoorManagedRuleGroupOverrideArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorManagedRuleGroupOverrideResponseInput)(nil)).Elem(), FrontDoorManagedRuleGroupOverrideResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorManagedRuleGroupOverrideResponseArrayInput)(nil)).Elem(), FrontDoorManagedRuleGroupOverrideResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorManagedRuleOverrideInput)(nil)).Elem(), FrontDoorManagedRuleOverrideArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorManagedRuleOverrideArrayInput)(nil)).Elem(), FrontDoorManagedRuleOverrideArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorManagedRuleOverrideResponseInput)(nil)).Elem(), FrontDoorManagedRuleOverrideResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorManagedRuleOverrideResponseArrayInput)(nil)).Elem(), FrontDoorManagedRuleOverrideResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorManagedRuleSetInput)(nil)).Elem(), FrontDoorManagedRuleSetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorManagedRuleSetArrayInput)(nil)).Elem(), FrontDoorManagedRuleSetArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorManagedRuleSetResponseInput)(nil)).Elem(), FrontDoorManagedRuleSetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorManagedRuleSetResponseArrayInput)(nil)).Elem(), FrontDoorManagedRuleSetResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorMatchConditionInput)(nil)).Elem(), FrontDoorMatchConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorMatchConditionArrayInput)(nil)).Elem(), FrontDoorMatchConditionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorMatchConditionResponseInput)(nil)).Elem(), FrontDoorMatchConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorMatchConditionResponseArrayInput)(nil)).Elem(), FrontDoorMatchConditionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorPolicySettingsInput)(nil)).Elem(), FrontDoorPolicySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorPolicySettingsPtrInput)(nil)).Elem(), FrontDoorPolicySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorPolicySettingsResponseInput)(nil)).Elem(), FrontDoorPolicySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontDoorPolicySettingsResponsePtrInput)(nil)).Elem(), FrontDoorPolicySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontendEndpointLinkResponseInput)(nil)).Elem(), FrontendEndpointLinkResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontendEndpointLinkResponseArrayInput)(nil)).Elem(), FrontendEndpointLinkResponseArray{})
