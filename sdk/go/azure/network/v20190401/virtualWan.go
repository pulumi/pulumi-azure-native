...
func NewVirtualWan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20190401:VirtualWan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualWan(ctx *pulumi.Context,
	...
	var resource VirtualWan
	err := ctx.ReadResource("azure-nextgen:network/v20190401:VirtualWan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
