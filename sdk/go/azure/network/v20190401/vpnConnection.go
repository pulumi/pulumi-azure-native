...
func NewVpnConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20190401:VpnConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnConnection(ctx *pulumi.Context,
	...
	var resource VpnConnection
	err := ctx.ReadResource("azure-nextgen:network/v20190401:VpnConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
