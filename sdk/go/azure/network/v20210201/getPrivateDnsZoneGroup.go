...
func LookupPrivateDnsZoneGroup(ctx *pulumi.Context, args *LookupPrivateDnsZoneGroupArgs, opts ...pulumi.InvokeOption) (*LookupPrivateDnsZoneGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20210201:getPrivateDnsZoneGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupPrivateDnsZoneGroupResultOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupPrivateDnsZoneGroupResult) *string { return v.Type }).(pulumi.StringPtrOutput)
}
