...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BastionHostSkuNameInput)(nil)).Elem(), BastionHostSkuName("Basic"))
	pulumi.RegisterInputType(reflect.TypeOf((*BastionHostSkuNamePtrInput)(nil)).Elem(), BastionHostSkuName("Basic"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GatewayLoadBalancerTunnelInterfaceTypeInput)(nil)).Elem(), GatewayLoadBalancerTunnelInterfaceType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*GatewayLoadBalancerTunnelInterfaceTypePtrInput)(nil)).Elem(), GatewayLoadBalancerTunnelInterfaceType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*GatewayLoadBalancerTunnelProtocolInput)(nil)).Elem(), GatewayLoadBalancerTunnelProtocol("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*GatewayLoadBalancerTunnelProtocolPtrInput)(nil)).Elem(), GatewayLoadBalancerTunnelProtocol("None"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PreferredRoutingGatewayInput)(nil)).Elem(), PreferredRoutingGateway("ExpressRoute"))
	pulumi.RegisterInputType(reflect.TypeOf((*PreferredRoutingGatewayPtrInput)(nil)).Elem(), PreferredRoutingGateway("ExpressRoute"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPeeringLevelInput)(nil)).Elem(), VirtualNetworkPeeringLevel("FullyInSync"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPeeringLevelPtrInput)(nil)).Elem(), VirtualNetworkPeeringLevel("FullyInSync"))
