...
func NewPrivateEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210201:PrivateEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpoint(ctx *pulumi.Context,
	...
	var resource PrivateEndpoint
	err := ctx.ReadResource("azure-native:network/v20210201:PrivateEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o PrivateEndpointOutput) ResourceGuid() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrivateEndpoint) pulumi.StringPtrOutput { return v.ResourceGuid }).(pulumi.StringPtrOutput)
}
