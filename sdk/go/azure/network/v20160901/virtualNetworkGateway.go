...
func NewVirtualNetworkGateway(ctx *pulumi.Context,
	...
	if args == nil || args.GatewayType == nil {
		return nil, errors.New("missing required argument 'GatewayType'")
	}
	...
	if args == nil || args.VpnType == nil {
		return nil, errors.New("missing required argument 'VpnType'")
	}
	if args == nil {
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20160901:VirtualNetworkGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkGateway(ctx *pulumi.Context,
	...
	var resource VirtualNetworkGateway
	err := ctx.ReadResource("azure-nextgen:network/v20160901:VirtualNetworkGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
