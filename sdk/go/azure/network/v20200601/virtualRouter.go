...
func NewVirtualRouter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20200601:VirtualRouter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualRouter(ctx *pulumi.Context,
	...
	var resource VirtualRouter
	err := ctx.ReadResource("azure-nextgen:network/v20200601:VirtualRouter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
