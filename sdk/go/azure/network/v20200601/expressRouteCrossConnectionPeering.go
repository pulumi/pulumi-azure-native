...
func NewExpressRouteCrossConnectionPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20200601:ExpressRouteCrossConnectionPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCrossConnectionPeering(ctx *pulumi.Context,
	...
	var resource ExpressRouteCrossConnectionPeering
	err := ctx.ReadResource("azure-nextgen:network/v20200601:ExpressRouteCrossConnectionPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
