...
func NewFirewallPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20200601:FirewallPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicy(ctx *pulumi.Context,
	...
	var resource FirewallPolicy
	err := ctx.ReadResource("azure-nextgen:network/v20200601:FirewallPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
