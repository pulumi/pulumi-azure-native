...
func NewApplicationSecurityGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:network/v20210201:ApplicationSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210301:ApplicationSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210301:ApplicationSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210501:ApplicationSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210501:ApplicationSecurityGroup"),
		},
	})
	opts = append(opts, aliases)
	var resource ApplicationSecurityGroup
	err := ctx.RegisterResource("azure-native:network/v20200601:ApplicationSecurityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationSecurityGroup(ctx *pulumi.Context,
	...
	var resource ApplicationSecurityGroup
	err := ctx.ReadResource("azure-native:network/v20200601:ApplicationSecurityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
