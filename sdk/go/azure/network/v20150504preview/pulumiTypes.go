...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ZonePropertiesInput)(nil)).Elem(), ZonePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ZonePropertiesPtrInput)(nil)).Elem(), ZonePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ZonePropertiesResponseInput)(nil)).Elem(), ZonePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ZonePropertiesResponsePtrInput)(nil)).Elem(), ZonePropertiesResponseArgs{})
