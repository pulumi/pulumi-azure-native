...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CaaRecordInput)(nil)).Elem(), CaaRecordArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CaaRecordArrayInput)(nil)).Elem(), CaaRecordArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CaaRecordResponseInput)(nil)).Elem(), CaaRecordResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CaaRecordResponseArrayInput)(nil)).Elem(), CaaRecordResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DnsResourceReferenceResponseInput)(nil)).Elem(), DnsResourceReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DnsResourceReferenceResponseArrayInput)(nil)).Elem(), DnsResourceReferenceResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NsRecordInput)(nil)).Elem(), NsRecordArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NsRecordArrayInput)(nil)).Elem(), NsRecordArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NsRecordResponseInput)(nil)).Elem(), NsRecordResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NsRecordResponseArrayInput)(nil)).Elem(), NsRecordResponseArray{})
