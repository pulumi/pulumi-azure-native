...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleSetActionTypeInput)(nil)).Elem(), ManagedRuleSetActionType("Block"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleSetActionTypePtrInput)(nil)).Elem(), ManagedRuleSetActionType("Block"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyRequestBodyCheckInput)(nil)).Elem(), PolicyRequestBodyCheck("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyRequestBodyCheckPtrInput)(nil)).Elem(), PolicyRequestBodyCheck("Disabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SkuNameInput)(nil)).Elem(), SkuName("Classic_AzureFrontDoor"))
	pulumi.RegisterInputType(reflect.TypeOf((*SkuNamePtrInput)(nil)).Elem(), SkuName("Classic_AzureFrontDoor"))
