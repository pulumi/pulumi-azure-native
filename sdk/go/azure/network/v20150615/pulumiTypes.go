...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IPConfigurationArrayInput)(nil)).Elem(), IPConfigurationArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkInterfaceTypeInput)(nil)).Elem(), NetworkInterfaceTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkInterfaceTypeArrayInput)(nil)).Elem(), NetworkInterfaceTypeArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkInterfaceIPConfigurationPtrInput)(nil)).Elem(), NetworkInterfaceIPConfigurationArgs{})
