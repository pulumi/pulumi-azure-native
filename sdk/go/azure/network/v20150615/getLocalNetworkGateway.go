...
func LookupLocalNetworkGateway(ctx *pulumi.Context, args *LookupLocalNetworkGatewayArgs, opts ...pulumi.InvokeOption) (*LookupLocalNetworkGatewayResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20150615:getLocalNetworkGateway", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupLocalNetworkGatewayResultOutput) ProvisioningState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupLocalNetworkGatewayResult) *string { return v.ProvisioningState }).(pulumi.StringPtrOutput)
}
