...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ExpressRouteCircuitPeeringTypeEnumInput)(nil)).Elem(), ExpressRouteCircuitPeeringTypeEnum("AzurePublicPeering"))
	pulumi.RegisterInputType(reflect.TypeOf((*ExpressRouteCircuitPeeringTypeEnumPtrInput)(nil)).Elem(), ExpressRouteCircuitPeeringTypeEnum("AzurePublicPeering"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkGatewayConnectionStatusInput)(nil)).Elem(), VirtualNetworkGatewayConnectionStatus("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkGatewayConnectionStatusPtrInput)(nil)).Elem(), VirtualNetworkGatewayConnectionStatus("Unknown"))
