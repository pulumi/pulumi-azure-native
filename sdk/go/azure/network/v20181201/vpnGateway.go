...
func NewVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20181201:VpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnGateway(ctx *pulumi.Context,
	...
	var resource VpnGateway
	err := ctx.ReadResource("azure-nextgen:network/v20181201:VpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
