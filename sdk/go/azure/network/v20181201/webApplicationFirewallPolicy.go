...
func NewWebApplicationFirewallPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:network/v20210201:WebApplicationFirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210301:WebApplicationFirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210301:WebApplicationFirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210501:WebApplicationFirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210501:WebApplicationFirewallPolicy"),
		},
	})
	opts = append(opts, aliases)
	var resource WebApplicationFirewallPolicy
	err := ctx.RegisterResource("azure-native:network/v20181201:WebApplicationFirewallPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebApplicationFirewallPolicy(ctx *pulumi.Context,
	...
	var resource WebApplicationFirewallPolicy
	err := ctx.ReadResource("azure-native:network/v20181201:WebApplicationFirewallPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
