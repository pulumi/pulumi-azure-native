...
func NewZone(ctx *pulumi.Context,
	...
	var resource Zone
	err := ctx.RegisterResource("azure-nextgen:network/v20160401:Zone", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetZone(ctx *pulumi.Context,
	...
	var resource Zone
	err := ctx.ReadResource("azure-nextgen:network/v20160401:Zone", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
