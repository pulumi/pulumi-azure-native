...
func NewExpressRouteCircuitAuthorization(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:network/v20210201:ExpressRouteCircuitAuthorization"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210301:ExpressRouteCircuitAuthorization"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210301:ExpressRouteCircuitAuthorization"),
		},
		{
			Type: pulumi.String("azure-native:network/v20210501:ExpressRouteCircuitAuthorization"),
		},
		{
			Type: pulumi.String("azure-nextgen:network/v20210501:ExpressRouteCircuitAuthorization"),
		},
	})
	opts = append(opts, aliases)
	var resource ExpressRouteCircuitAuthorization
	err := ctx.RegisterResource("azure-native:network/v20150501preview:ExpressRouteCircuitAuthorization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuitAuthorization(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuitAuthorization
	err := ctx.ReadResource("azure-native:network/v20150501preview:ExpressRouteCircuitAuthorization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
