...
func LookupP2sVpnGateway(ctx *pulumi.Context, args *LookupP2sVpnGatewayArgs, opts ...pulumi.InvokeOption) (*LookupP2sVpnGatewayResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:network/v20200501:getP2sVpnGateway", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupP2sVpnGatewayResult struct {
	...
	P2SConnectionConfigurations []P2SConnectionConfigurationInvokeResponse `pulumi:"p2SConnectionConfigurations"`
	...
	VpnServerConfiguration *SubResourceInvokeResponse `pulumi:"vpnServerConfiguration"`
}
