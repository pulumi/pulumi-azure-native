...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveConnectivityConfigurationResponseInput)(nil)).Elem(), ActiveConnectivityConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveConnectivityConfigurationResponseArrayInput)(nil)).Elem(), ActiveConnectivityConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveDefaultSecurityAdminRuleResponseInput)(nil)).Elem(), ActiveDefaultSecurityAdminRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveDefaultSecurityUserRuleResponseInput)(nil)).Elem(), ActiveDefaultSecurityUserRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveSecurityAdminRuleResponseInput)(nil)).Elem(), ActiveSecurityAdminRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveSecurityUserRuleResponseInput)(nil)).Elem(), ActiveSecurityUserRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AddressPrefixItemInput)(nil)).Elem(), AddressPrefixItemArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AddressPrefixItemResponseInput)(nil)).Elem(), AddressPrefixItemResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AddressPrefixItemResponseArrayInput)(nil)).Elem(), AddressPrefixItemResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigurationGroupResponseInput)(nil)).Elem(), ConfigurationGroupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigurationGroupResponseArrayInput)(nil)).Elem(), ConfigurationGroupResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityGroupItemInput)(nil)).Elem(), ConnectivityGroupItemArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityGroupItemArrayInput)(nil)).Elem(), ConnectivityGroupItemArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityGroupItemResponseInput)(nil)).Elem(), ConnectivityGroupItemResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityGroupItemResponseArrayInput)(nil)).Elem(), ConnectivityGroupItemResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EffectiveConnectivityConfigurationResponseInput)(nil)).Elem(), EffectiveConnectivityConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EffectiveConnectivityConfigurationResponseArrayInput)(nil)).Elem(), EffectiveConnectivityConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EffectiveDefaultSecurityAdminRuleResponseInput)(nil)).Elem(), EffectiveDefaultSecurityAdminRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EffectiveSecurityAdminRuleResponseInput)(nil)).Elem(), EffectiveSecurityAdminRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EffectiveVirtualNetworkResponseInput)(nil)).Elem(), EffectiveVirtualNetworkResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EffectiveVirtualNetworkResponseArrayInput)(nil)).Elem(), EffectiveVirtualNetworkResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GroupMembersItemInput)(nil)).Elem(), GroupMembersItemArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GroupMembersItemArrayInput)(nil)).Elem(), GroupMembersItemArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GroupMembersItemResponseInput)(nil)).Elem(), GroupMembersItemResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GroupMembersItemResponseArrayInput)(nil)).Elem(), GroupMembersItemResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HubInput)(nil)).Elem(), HubArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HubArrayInput)(nil)).Elem(), HubArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HubResponseInput)(nil)).Elem(), HubResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HubResponseArrayInput)(nil)).Elem(), HubResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkManagerDeploymentStatusResponseInput)(nil)).Elem(), NetworkManagerDeploymentStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkManagerDeploymentStatusResponseArrayInput)(nil)).Elem(), NetworkManagerDeploymentStatusResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkManagerPropertiesNetworkManagerScopesInput)(nil)).Elem(), NetworkManagerPropertiesNetworkManagerScopesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkManagerPropertiesNetworkManagerScopesPtrInput)(nil)).Elem(), NetworkManagerPropertiesNetworkManagerScopesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkManagerPropertiesResponseNetworkManagerScopesInput)(nil)).Elem(), NetworkManagerPropertiesResponseNetworkManagerScopesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkManagerPropertiesResponseNetworkManagerScopesPtrInput)(nil)).Elem(), NetworkManagerPropertiesResponseNetworkManagerScopesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkManagerSecurityGroupItemInput)(nil)).Elem(), NetworkManagerSecurityGroupItemArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkManagerSecurityGroupItemArrayInput)(nil)).Elem(), NetworkManagerSecurityGroupItemArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkManagerSecurityGroupItemResponseInput)(nil)).Elem(), NetworkManagerSecurityGroupItemResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkManagerSecurityGroupItemResponseArrayInput)(nil)).Elem(), NetworkManagerSecurityGroupItemResponseArray{})
