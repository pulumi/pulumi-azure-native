...
func NewAdminRuleCollection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:network/v20210201preview:AdminRuleCollection"),
		},
		{
			Type: pulumi.String("azure-native:network:AdminRuleCollection"),
		},
		{
			Type: pulumi.String("azure-nextgen:network:AdminRuleCollection"),
		},
	})
	opts = append(opts, aliases)
	var resource AdminRuleCollection
	err := ctx.RegisterResource("azure-native:network/v20210201preview:AdminRuleCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdminRuleCollection(ctx *pulumi.Context,
	...
	var resource AdminRuleCollection
	err := ctx.ReadResource("azure-native:network/v20210201preview:AdminRuleCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
