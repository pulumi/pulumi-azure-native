...
func NewFrontDoor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20190501:FrontDoor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFrontDoor(ctx *pulumi.Context,
	...
	var resource FrontDoor
	err := ctx.ReadResource("azure-nextgen:network/v20190501:FrontDoor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
