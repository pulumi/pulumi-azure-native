...
func NewFlowLog(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210501:FlowLog", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFlowLog(ctx *pulumi.Context,
	...
	var resource FlowLog
	err := ctx.ReadResource("azure-native:network/v20210501:FlowLog", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
