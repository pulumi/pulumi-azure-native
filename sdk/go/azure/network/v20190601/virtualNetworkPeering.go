...
func NewVirtualNetworkPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:network/v20190601:VirtualNetworkPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkPeering(ctx *pulumi.Context,
	...
	var resource VirtualNetworkPeering
	err := ctx.ReadResource("azure-nextgen:network/v20190601:VirtualNetworkPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
