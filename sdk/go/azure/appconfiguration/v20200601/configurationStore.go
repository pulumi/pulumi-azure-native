...
func NewConfigurationStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:appconfiguration/v20200601:ConfigurationStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationStore(ctx *pulumi.Context,
	...
	var resource ConfigurationStore
	err := ctx.ReadResource("azure-nextgen:appconfiguration/v20200601:ConfigurationStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
