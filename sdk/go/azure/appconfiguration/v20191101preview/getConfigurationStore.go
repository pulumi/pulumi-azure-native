...
func LookupConfigurationStore(ctx *pulumi.Context, args *LookupConfigurationStoreArgs, opts ...pulumi.InvokeOption) (*LookupConfigurationStoreResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:appconfiguration/v20191101preview:getConfigurationStore", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupConfigurationStoreResult struct {
	...
	PrivateEndpointConnections []PrivateEndpointConnectionReferenceInvokeResponse `pulumi:"privateEndpointConnections"`
