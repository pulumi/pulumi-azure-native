...
// A connection string that can be used by supporting clients for authentication.
func (o ApiKeyInvokeResponseOutput) ConnectionString() pulumi.StringOutput {
	return o.ApplyT(func(v ApiKeyInvokeResponse) string { return v.ConnectionString }).(pulumi.StringOutput)
}

// The key ID.
func (o ApiKeyInvokeResponseOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v ApiKeyInvokeResponse) string { return v.Id }).(pulumi.StringOutput)
}

// The last time any of the key's properties were modified.
func (o ApiKeyInvokeResponseOutput) LastModified() pulumi.StringOutput {
	return o.ApplyT(func(v ApiKeyInvokeResponse) string { return v.LastModified }).(pulumi.StringOutput)
}

// A name for the key describing its usage.
func (o ApiKeyInvokeResponseOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v ApiKeyInvokeResponse) string { return v.Name }).(pulumi.StringOutput)
}

// Whether this key can only be used for read operations.
func (o ApiKeyInvokeResponseOutput) ReadOnly() pulumi.BoolOutput {
	return o.ApplyT(func(v ApiKeyInvokeResponse) bool { return v.ReadOnly }).(pulumi.BoolOutput)
}

// The value of the key that is used for authentication purposes.
func (o ApiKeyInvokeResponseOutput) Value() pulumi.StringOutput {
	return o.ApplyT(func(v ApiKeyInvokeResponse) string { return v.Value }).(pulumi.StringOutput)
}
