...
// GuestAgentProfileResponseInput is an input type that accepts GuestAgentProfileResponseArgs and GuestAgentProfileResponseOutput values.
// You can construct a concrete instance of `GuestAgentProfileResponseInput` via:
//
...
// GuestAgentProfileResponsePtrInput is an input type that accepts GuestAgentProfileResponseArgs, GuestAgentProfileResponsePtr and GuestAgentProfileResponsePtrOutput values.
// You can construct a concrete instance of `GuestAgentProfileResponsePtrInput` via:
//
//          GuestAgentProfileResponseArgs{...}
//
//  or:
...
// GuestCredentialResponseInput is an input type that accepts GuestCredentialResponseArgs and GuestCredentialResponseOutput values.
// You can construct a concrete instance of `GuestCredentialResponseInput` via:
//
...
// GuestCredentialResponsePtrInput is an input type that accepts GuestCredentialResponseArgs, GuestCredentialResponsePtr and GuestCredentialResponsePtrOutput values.
// You can construct a concrete instance of `GuestCredentialResponsePtrInput` via:
//
//          GuestCredentialResponseArgs{...}
//
//  or:
...
// HttpProxyConfigurationResponseInput is an input type that accepts HttpProxyConfigurationResponseArgs and HttpProxyConfigurationResponseOutput values.
// You can construct a concrete instance of `HttpProxyConfigurationResponseInput` via:
//
...
// HttpProxyConfigurationResponsePtrInput is an input type that accepts HttpProxyConfigurationResponseArgs, HttpProxyConfigurationResponsePtr and HttpProxyConfigurationResponsePtrOutput values.
// You can construct a concrete instance of `HttpProxyConfigurationResponsePtrInput` via:
//
//          HttpProxyConfigurationResponseArgs{...}
//
//  or:
...
// NicIPAddressSettingsResponseInput is an input type that accepts NicIPAddressSettingsResponseArgs and NicIPAddressSettingsResponseOutput values.
// You can construct a concrete instance of `NicIPAddressSettingsResponseInput` via:
//
...
// NicIPAddressSettingsResponseArrayInput is an input type that accepts NicIPAddressSettingsResponseArray and NicIPAddressSettingsResponseArrayOutput values.
// You can construct a concrete instance of `NicIPAddressSettingsResponseArrayInput` via:
//
//          NicIPAddressSettingsResponseArray{ NicIPAddressSettingsResponseArgs{...} }
...
// NicIPSettingsResponseInput is an input type that accepts NicIPSettingsResponseArgs and NicIPSettingsResponseOutput values.
// You can construct a concrete instance of `NicIPSettingsResponseInput` via:
//
...
// NicIPSettingsResponsePtrInput is an input type that accepts NicIPSettingsResponseArgs, NicIPSettingsResponsePtr and NicIPSettingsResponsePtrOutput values.
// You can construct a concrete instance of `NicIPSettingsResponsePtrInput` via:
//
//          NicIPSettingsResponseArgs{...}
//
//  or:
...
// PlacementProfileResponseInput is an input type that accepts PlacementProfileResponseArgs and PlacementProfileResponseOutput values.
// You can construct a concrete instance of `PlacementProfileResponseInput` via:
//
...
// PlacementProfileResponsePtrInput is an input type that accepts PlacementProfileResponseArgs, PlacementProfileResponsePtr and PlacementProfileResponsePtrOutput values.
// You can construct a concrete instance of `PlacementProfileResponsePtrInput` via:
//
//          PlacementProfileResponseArgs{...}
//
//  or:
...
// ResourceStatusResponseInput is an input type that accepts ResourceStatusResponseArgs and ResourceStatusResponseOutput values.
// You can construct a concrete instance of `ResourceStatusResponseInput` via:
//
...
// ResourceStatusResponseArrayInput is an input type that accepts ResourceStatusResponseArray and ResourceStatusResponseArrayOutput values.
// You can construct a concrete instance of `ResourceStatusResponseArrayInput` via:
//
//          ResourceStatusResponseArray{ ResourceStatusResponseArgs{...} }
...
// VICredentialResponseInput is an input type that accepts VICredentialResponseArgs and VICredentialResponseOutput values.
// You can construct a concrete instance of `VICredentialResponseInput` via:
//
...
// VICredentialResponsePtrInput is an input type that accepts VICredentialResponseArgs, VICredentialResponsePtr and VICredentialResponsePtrOutput values.
// You can construct a concrete instance of `VICredentialResponsePtrInput` via:
//
//          VICredentialResponseArgs{...}
//
//  or:
...
// VirtualSCSIControllerResponseInput is an input type that accepts VirtualSCSIControllerResponseArgs and VirtualSCSIControllerResponseOutput values.
// You can construct a concrete instance of `VirtualSCSIControllerResponseInput` via:
//
...
// VirtualSCSIControllerResponseArrayInput is an input type that accepts VirtualSCSIControllerResponseArray and VirtualSCSIControllerResponseArrayOutput values.
// You can construct a concrete instance of `VirtualSCSIControllerResponseArrayInput` via:
//
//          VirtualSCSIControllerResponseArray{ VirtualSCSIControllerResponseArgs{...} }
