...
type DatabaseAccount struct {
	...
	KeysMetadata                       DatabaseAccountKeysMetadataResponsePtrOutput    `pulumi:"keysMetadata"`
...
func NewDatabaseAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20220515preview:DatabaseAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccount(ctx *pulumi.Context,
	...
	var resource DatabaseAccount
	err := ctx.ReadResource("azure-native:documentdb/v20220515preview:DatabaseAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o DatabaseAccountOutput) KeysMetadata() DatabaseAccountKeysMetadataResponsePtrOutput {
	return o.ApplyT(func(v *DatabaseAccount) DatabaseAccountKeysMetadataResponsePtrOutput { return v.KeysMetadata }).(DatabaseAccountKeysMetadataResponsePtrOutput)
}
