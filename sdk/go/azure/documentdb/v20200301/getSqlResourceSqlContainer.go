...
func LookupSqlResourceSqlContainer(ctx *pulumi.Context, args *LookupSqlResourceSqlContainerArgs, opts ...pulumi.InvokeOption) (*LookupSqlResourceSqlContainerResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:documentdb/v20200301:getSqlResourceSqlContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupSqlResourceSqlContainerResult struct {
	...
	Options  *SqlContainerGetPropertiesInvokeResponseOptions  `pulumi:"options"`
	Resource *SqlContainerGetPropertiesInvokeResponseResource `pulumi:"resource"`
