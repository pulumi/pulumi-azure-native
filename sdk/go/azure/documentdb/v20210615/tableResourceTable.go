...
func NewTableResourceTable(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:documentdb/v20210615:TableResourceTable"),
		},
		{
		...
		{
			Type: pulumi.String("azure-nextgen:documentdb/v20210401preview:TableResourceTable"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20210415:TableResourceTable"),
		},
		{
			Type: pulumi.String("azure-nextgen:documentdb/v20210415:TableResourceTable"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20210515:TableResourceTable"),
		},
		{
			Type: pulumi.String("azure-nextgen:documentdb/v20210515:TableResourceTable"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20210701preview:TableResourceTable"),
		},
		{
			Type: pulumi.String("azure-nextgen:documentdb/v20210701preview:TableResourceTable"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20211015:TableResourceTable"),
		},
		{
			Type: pulumi.String("azure-nextgen:documentdb/v20211015:TableResourceTable"),
		},
	})
	opts = append(opts, aliases)
	var resource TableResourceTable
	err := ctx.RegisterResource("azure-native:documentdb/v20210615:TableResourceTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableResourceTable(ctx *pulumi.Context,
	...
	var resource TableResourceTable
	err := ctx.ReadResource("azure-native:documentdb/v20210615:TableResourceTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
