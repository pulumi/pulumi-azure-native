...
func (o BackupPolicyMigrationStatePtrOutput) Elem() BackupPolicyMigrationStateOutput {
	return o.ApplyT(func(v *BackupPolicyMigrationState) BackupPolicyMigrationState { return *v }).(BackupPolicyMigrationStateOutput)
}
...
// BackupPolicyMigrationStateResponseInput is an input type that accepts BackupPolicyMigrationStateResponseArgs and BackupPolicyMigrationStateResponseOutput values.
// You can construct a concrete instance of `BackupPolicyMigrationStateResponseInput` via:
//
...
// BackupPolicyMigrationStateResponsePtrInput is an input type that accepts BackupPolicyMigrationStateResponseArgs, BackupPolicyMigrationStateResponsePtr and BackupPolicyMigrationStateResponsePtrOutput values.
// You can construct a concrete instance of `BackupPolicyMigrationStateResponsePtrInput` via:
//
//          BackupPolicyMigrationStateResponseArgs{...}
//
//  or:
...
func (o BackupPolicyMigrationStateResponsePtrOutput) Elem() BackupPolicyMigrationStateResponseOutput {
	return o.ApplyT(func(v *BackupPolicyMigrationStateResponse) BackupPolicyMigrationStateResponse { return *v }).(BackupPolicyMigrationStateResponseOutput)
}
