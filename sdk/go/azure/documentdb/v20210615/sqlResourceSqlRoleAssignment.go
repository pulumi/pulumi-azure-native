...
func NewSqlResourceSqlRoleAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:documentdb/v20211015:SqlResourceSqlRoleAssignment"),
		},
	})
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*SqlResourceSqlRoleAssignmentInput)(nil)).Elem(), &SqlResourceSqlRoleAssignment{})
