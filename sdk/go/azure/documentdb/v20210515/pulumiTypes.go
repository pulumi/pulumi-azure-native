...
func (o AnalyticalStorageConfigurationPtrOutput) Elem() AnalyticalStorageConfigurationOutput {
	return o.ApplyT(func(v *AnalyticalStorageConfiguration) AnalyticalStorageConfiguration { return *v }).(AnalyticalStorageConfigurationOutput)
}
...
// AnalyticalStorageConfigurationResponseInput is an input type that accepts AnalyticalStorageConfigurationResponseArgs and AnalyticalStorageConfigurationResponseOutput values.
// You can construct a concrete instance of `AnalyticalStorageConfigurationResponseInput` via:
//
...
// AnalyticalStorageConfigurationResponsePtrInput is an input type that accepts AnalyticalStorageConfigurationResponseArgs, AnalyticalStorageConfigurationResponsePtr and AnalyticalStorageConfigurationResponsePtrOutput values.
// You can construct a concrete instance of `AnalyticalStorageConfigurationResponsePtrInput` via:
//
//          AnalyticalStorageConfigurationResponseArgs{...}
//
//  or:
...
func (o AnalyticalStorageConfigurationResponsePtrOutput) Elem() AnalyticalStorageConfigurationResponseOutput {
	return o.ApplyT(func(v *AnalyticalStorageConfigurationResponse) AnalyticalStorageConfigurationResponse { return *v }).(AnalyticalStorageConfigurationResponseOutput)
}
