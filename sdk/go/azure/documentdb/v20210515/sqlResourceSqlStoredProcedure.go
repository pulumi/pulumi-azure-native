...
func NewSqlResourceSqlStoredProcedure(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:documentdb/v20211015:SqlResourceSqlStoredProcedure"),
		},
	})
	opts = append(opts, aliases)
	var resource SqlResourceSqlStoredProcedure
	err := ctx.RegisterResource("azure-native:documentdb/v20210515:SqlResourceSqlStoredProcedure", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlStoredProcedure(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlStoredProcedure
	err := ctx.ReadResource("azure-native:documentdb/v20210515:SqlResourceSqlStoredProcedure", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
