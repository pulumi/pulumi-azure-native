...
func LookupGremlinResourceGremlinDatabase(ctx *pulumi.Context, args *LookupGremlinResourceGremlinDatabaseArgs, opts ...pulumi.InvokeOption) (*LookupGremlinResourceGremlinDatabaseResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:documentdb/v20200601preview:getGremlinResourceGremlinDatabase", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupGremlinResourceGremlinDatabaseResult struct {
	...
	Options  *GremlinDatabaseGetPropertiesInvokeResponseOptions  `pulumi:"options"`
	Resource *GremlinDatabaseGetPropertiesInvokeResponseResource `pulumi:"resource"`
