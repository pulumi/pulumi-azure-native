...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DefaultRequestDatabaseAccountCreateUpdatePropertiesInput)(nil)).Elem(), DefaultRequestDatabaseAccountCreateUpdatePropertiesArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RestoreReqeustDatabaseAccountCreateUpdatePropertiesInput)(nil)).Elem(), RestoreReqeustDatabaseAccountCreateUpdatePropertiesArgs{})
