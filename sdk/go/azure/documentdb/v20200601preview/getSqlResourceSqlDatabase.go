...
func LookupSqlResourceSqlDatabase(ctx *pulumi.Context, args *LookupSqlResourceSqlDatabaseArgs, opts ...pulumi.InvokeOption) (*LookupSqlResourceSqlDatabaseResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:documentdb/v20200601preview:getSqlResourceSqlDatabase", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupSqlResourceSqlDatabaseResult struct {
	...
	Options  *SqlDatabaseGetPropertiesInvokeResponseOptions  `pulumi:"options"`
	Resource *SqlDatabaseGetPropertiesInvokeResponseResource `pulumi:"resource"`
