...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BackupTypeInput)(nil)).Elem(), BackupType("Periodic"))
	pulumi.RegisterInputType(reflect.TypeOf((*BackupTypePtrInput)(nil)).Elem(), BackupType("Periodic"))
