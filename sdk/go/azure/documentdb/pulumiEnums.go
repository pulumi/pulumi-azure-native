...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AuthenticationMethodInput)(nil)).Elem(), AuthenticationMethod("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*AuthenticationMethodPtrInput)(nil)).Elem(), AuthenticationMethod("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPolicyTypeInput)(nil)).Elem(), BackupPolicyType("Periodic"))
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPolicyTypePtrInput)(nil)).Elem(), BackupPolicyType("Periodic"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedCassandraProvisioningStateInput)(nil)).Elem(), ManagedCassandraProvisioningState("Creating"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedCassandraProvisioningStatePtrInput)(nil)).Elem(), ManagedCassandraProvisioningState("Creating"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkAclBypassInput)(nil)).Elem(), NetworkAclBypass("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkAclBypassPtrInput)(nil)).Elem(), NetworkAclBypass("None"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RoleDefinitionTypeInput)(nil)).Elem(), RoleDefinitionType("BuiltInRole"))
	pulumi.RegisterInputType(reflect.TypeOf((*RoleDefinitionTypePtrInput)(nil)).Elem(), RoleDefinitionType("BuiltInRole"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceSizeInput)(nil)).Elem(), ServiceSize("Cosmos.D4s"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceSizePtrInput)(nil)).Elem(), ServiceSize("Cosmos.D4s"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceTypeInput)(nil)).Elem(), ServiceType("SqlDedicatedGateway"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceTypePtrInput)(nil)).Elem(), ServiceType("SqlDedicatedGateway"))
