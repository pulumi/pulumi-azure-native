...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DataTransferRegionalServiceResourceResponseInput)(nil)).Elem(), DataTransferRegionalServiceResourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataTransferRegionalServiceResourceResponseArrayInput)(nil)).Elem(), DataTransferRegionalServiceResourceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataTransferServiceResourcePropertiesResponseInput)(nil)).Elem(), DataTransferServiceResourcePropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SqlDedicatedGatewayRegionalServiceResourceResponseInput)(nil)).Elem(), SqlDedicatedGatewayRegionalServiceResourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlDedicatedGatewayRegionalServiceResourceResponseArrayInput)(nil)).Elem(), SqlDedicatedGatewayRegionalServiceResourceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlDedicatedGatewayServiceResourcePropertiesResponseInput)(nil)).Elem(), SqlDedicatedGatewayServiceResourcePropertiesResponseArgs{})
