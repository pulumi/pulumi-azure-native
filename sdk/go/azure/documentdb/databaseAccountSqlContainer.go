...
func NewDatabaseAccountSqlContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:documentdb:DatabaseAccountSqlContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountSqlContainer(ctx *pulumi.Context,
	...
	var resource DatabaseAccountSqlContainer
	err := ctx.ReadResource("azure-nextgen:documentdb:DatabaseAccountSqlContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
