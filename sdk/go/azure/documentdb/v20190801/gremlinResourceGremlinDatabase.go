...
func NewGremlinResourceGremlinDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:documentdb/v20190801:GremlinResourceGremlinDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGremlinResourceGremlinDatabase(ctx *pulumi.Context,
	...
	var resource GremlinResourceGremlinDatabase
	err := ctx.ReadResource("azure-nextgen:documentdb/v20190801:GremlinResourceGremlinDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
