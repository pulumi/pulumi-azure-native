...
func NewSqlResourceSqlStoredProcedure(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:documentdb/v20190801:SqlResourceSqlStoredProcedure", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlStoredProcedure(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlStoredProcedure
	err := ctx.ReadResource("azure-nextgen:documentdb/v20190801:SqlResourceSqlStoredProcedure", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
