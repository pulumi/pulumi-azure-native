...
func NewDatabaseAccountMongoDBDatabase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:documentdb/v20211015:DatabaseAccountMongoDBDatabase"),
		},
	})
	opts = append(opts, aliases)
	var resource DatabaseAccountMongoDBDatabase
	err := ctx.RegisterResource("azure-native:documentdb/v20150401:DatabaseAccountMongoDBDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountMongoDBDatabase(ctx *pulumi.Context,
	...
	var resource DatabaseAccountMongoDBDatabase
	err := ctx.ReadResource("azure-native:documentdb/v20150401:DatabaseAccountMongoDBDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
