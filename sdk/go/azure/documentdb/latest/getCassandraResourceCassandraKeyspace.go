...
type LookupCassandraResourceCassandraKeyspaceResult struct {
	...
	Options  *CassandraKeyspaceGetPropertiesInvokeResponseOptions  `pulumi:"options"`
	Resource *CassandraKeyspaceGetPropertiesInvokeResponseResource `pulumi:"resource"`
