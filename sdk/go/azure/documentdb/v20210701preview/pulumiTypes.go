...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraViewGetPropertiesResponseOptionsInput)(nil)).Elem(), CassandraViewGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraViewGetPropertiesResponseOptionsPtrInput)(nil)).Elem(), CassandraViewGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraViewGetPropertiesResponseResourceInput)(nil)).Elem(), CassandraViewGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraViewGetPropertiesResponseResourcePtrInput)(nil)).Elem(), CassandraViewGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraViewResourceInput)(nil)).Elem(), CassandraViewResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraViewResourcePtrInput)(nil)).Elem(), CassandraViewResourceArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticLogSettingsInput)(nil)).Elem(), DiagnosticLogSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticLogSettingsPtrInput)(nil)).Elem(), DiagnosticLogSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticLogSettingsResponseInput)(nil)).Elem(), DiagnosticLogSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticLogSettingsResponsePtrInput)(nil)).Elem(), DiagnosticLogSettingsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GraphAPIComputeRegionalServiceResourceResponseInput)(nil)).Elem(), GraphAPIComputeRegionalServiceResourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GraphAPIComputeRegionalServiceResourceResponseArrayInput)(nil)).Elem(), GraphAPIComputeRegionalServiceResourceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GraphAPIComputeServiceResourcePropertiesResponseInput)(nil)).Elem(), GraphAPIComputeServiceResourcePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GraphResourceInput)(nil)).Elem(), GraphResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GraphResourcePtrInput)(nil)).Elem(), GraphResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GraphResourceGetPropertiesResponseOptionsInput)(nil)).Elem(), GraphResourceGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GraphResourceGetPropertiesResponseOptionsPtrInput)(nil)).Elem(), GraphResourceGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GraphResourceGetPropertiesResponseResourceInput)(nil)).Elem(), GraphResourceGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GraphResourceGetPropertiesResponseResourcePtrInput)(nil)).Elem(), GraphResourceGetPropertiesResponseResourceArgs{})
