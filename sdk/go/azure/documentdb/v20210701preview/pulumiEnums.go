...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AnalyticalStorageSchemaTypeInput)(nil)).Elem(), AnalyticalStorageSchemaType("WellDefined"))
	pulumi.RegisterInputType(reflect.TypeOf((*AnalyticalStorageSchemaTypePtrInput)(nil)).Elem(), AnalyticalStorageSchemaType("WellDefined"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPolicyMigrationStatusInput)(nil)).Elem(), BackupPolicyMigrationStatus("Invalid"))
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPolicyMigrationStatusPtrInput)(nil)).Elem(), BackupPolicyMigrationStatus("Invalid"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EnableFullTextQueryInput)(nil)).Elem(), EnableFullTextQuery("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*EnableFullTextQueryPtrInput)(nil)).Elem(), EnableFullTextQuery("None"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RestoreModeInput)(nil)).Elem(), RestoreMode("PointInTime"))
	pulumi.RegisterInputType(reflect.TypeOf((*RestoreModePtrInput)(nil)).Elem(), RestoreMode("PointInTime"))
