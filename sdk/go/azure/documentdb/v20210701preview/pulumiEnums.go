...
// AnalyticalStorageSchemaTypeInput is an input type that accepts AnalyticalStorageSchemaTypeArgs and AnalyticalStorageSchemaTypeOutput values.
// You can construct a concrete instance of `AnalyticalStorageSchemaTypeInput` via:
//
...
// BackupPolicyMigrationStatusInput is an input type that accepts BackupPolicyMigrationStatusArgs and BackupPolicyMigrationStatusOutput values.
// You can construct a concrete instance of `BackupPolicyMigrationStatusInput` via:
//
...
// BackupStorageRedundancyInput is an input type that accepts BackupStorageRedundancyArgs and BackupStorageRedundancyOutput values.
// You can construct a concrete instance of `BackupStorageRedundancyInput` via:
//
...
// RestoreModeInput is an input type that accepts RestoreModeArgs and RestoreModeOutput values.
// You can construct a concrete instance of `RestoreModeInput` via:
//
//          RestoreModeArgs{...}
