...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedCassandraResourceIdentityTypeInput)(nil)).Elem(), ManagedCassandraResourceIdentityType("SystemAssigned"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedCassandraResourceIdentityTypePtrInput)(nil)).Elem(), ManagedCassandraResourceIdentityType("SystemAssigned"))
