...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AnalyticalStorageConfigurationInput)(nil)).Elem(), AnalyticalStorageConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AnalyticalStorageConfigurationPtrInput)(nil)).Elem(), AnalyticalStorageConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AnalyticalStorageConfigurationResponseInput)(nil)).Elem(), AnalyticalStorageConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AnalyticalStorageConfigurationResponsePtrInput)(nil)).Elem(), AnalyticalStorageConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiPropertiesInput)(nil)).Elem(), ApiPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiPropertiesPtrInput)(nil)).Elem(), ApiPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiPropertiesResponseInput)(nil)).Elem(), ApiPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiPropertiesResponsePtrInput)(nil)).Elem(), ApiPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPolicyMigrationStateInput)(nil)).Elem(), BackupPolicyMigrationStateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPolicyMigrationStatePtrInput)(nil)).Elem(), BackupPolicyMigrationStateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPolicyMigrationStateResponseInput)(nil)).Elem(), BackupPolicyMigrationStateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPolicyMigrationStateResponsePtrInput)(nil)).Elem(), BackupPolicyMigrationStateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CapabilityInput)(nil)).Elem(), CapabilityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CapabilityArrayInput)(nil)).Elem(), CapabilityArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CapabilityResponseInput)(nil)).Elem(), CapabilityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CapabilityResponseArrayInput)(nil)).Elem(), CapabilityResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraKeyspaceGetPropertiesResponseOptionsInput)(nil)).Elem(), CassandraKeyspaceGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraKeyspaceGetPropertiesResponseOptionsPtrInput)(nil)).Elem(), CassandraKeyspaceGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraKeyspaceGetPropertiesResponseResourceInput)(nil)).Elem(), CassandraKeyspaceGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraKeyspaceGetPropertiesResponseResourcePtrInput)(nil)).Elem(), CassandraKeyspaceGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraKeyspaceResourceInput)(nil)).Elem(), CassandraKeyspaceResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraKeyspaceResourcePtrInput)(nil)).Elem(), CassandraKeyspaceResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraPartitionKeyInput)(nil)).Elem(), CassandraPartitionKeyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraPartitionKeyArrayInput)(nil)).Elem(), CassandraPartitionKeyArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraPartitionKeyResponseInput)(nil)).Elem(), CassandraPartitionKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraPartitionKeyResponseArrayInput)(nil)).Elem(), CassandraPartitionKeyResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraSchemaInput)(nil)).Elem(), CassandraSchemaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraSchemaPtrInput)(nil)).Elem(), CassandraSchemaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraSchemaResponseInput)(nil)).Elem(), CassandraSchemaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraSchemaResponsePtrInput)(nil)).Elem(), CassandraSchemaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraTableGetPropertiesResponseOptionsInput)(nil)).Elem(), CassandraTableGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraTableGetPropertiesResponseOptionsPtrInput)(nil)).Elem(), CassandraTableGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraTableGetPropertiesResponseResourceInput)(nil)).Elem(), CassandraTableGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraTableGetPropertiesResponseResourcePtrInput)(nil)).Elem(), CassandraTableGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraTableResourceInput)(nil)).Elem(), CassandraTableResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CassandraTableResourcePtrInput)(nil)).Elem(), CassandraTableResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateInput)(nil)).Elem(), CertificateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateArrayInput)(nil)).Elem(), CertificateArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateResponseInput)(nil)).Elem(), CertificateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateResponseArrayInput)(nil)).Elem(), CertificateResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterKeyInput)(nil)).Elem(), ClusterKeyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterKeyArrayInput)(nil)).Elem(), ClusterKeyArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterKeyResponseInput)(nil)).Elem(), ClusterKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterKeyResponseArrayInput)(nil)).Elem(), ClusterKeyResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterResourceResponsePropertiesInput)(nil)).Elem(), ClusterResourceResponsePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterResourceResponsePropertiesPtrInput)(nil)).Elem(), ClusterResourceResponsePropertiesArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CompositePathInput)(nil)).Elem(), CompositePathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CompositePathArrayInput)(nil)).Elem(), CompositePathArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CompositePathResponseInput)(nil)).Elem(), CompositePathResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CompositePathResponseArrayInput)(nil)).Elem(), CompositePathResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConflictResolutionPolicyInput)(nil)).Elem(), ConflictResolutionPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConflictResolutionPolicyPtrInput)(nil)).Elem(), ConflictResolutionPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConflictResolutionPolicyResponseInput)(nil)).Elem(), ConflictResolutionPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConflictResolutionPolicyResponsePtrInput)(nil)).Elem(), ConflictResolutionPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConsistencyPolicyInput)(nil)).Elem(), ConsistencyPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConsistencyPolicyPtrInput)(nil)).Elem(), ConsistencyPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConsistencyPolicyResponseInput)(nil)).Elem(), ConsistencyPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConsistencyPolicyResponsePtrInput)(nil)).Elem(), ConsistencyPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerPartitionKeyInput)(nil)).Elem(), ContainerPartitionKeyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerPartitionKeyPtrInput)(nil)).Elem(), ContainerPartitionKeyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerPartitionKeyResponseInput)(nil)).Elem(), ContainerPartitionKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerPartitionKeyResponsePtrInput)(nil)).Elem(), ContainerPartitionKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContinuousModeBackupPolicyInput)(nil)).Elem(), ContinuousModeBackupPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContinuousModeBackupPolicyResponseInput)(nil)).Elem(), ContinuousModeBackupPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsPolicyInput)(nil)).Elem(), CorsPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsPolicyArrayInput)(nil)).Elem(), CorsPolicyArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsPolicyResponseInput)(nil)).Elem(), CorsPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsPolicyResponseArrayInput)(nil)).Elem(), CorsPolicyResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CreateUpdateOptionsInput)(nil)).Elem(), CreateUpdateOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CreateUpdateOptionsPtrInput)(nil)).Elem(), CreateUpdateOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataCenterResourcePropertiesInput)(nil)).Elem(), DataCenterResourcePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataCenterResourcePropertiesPtrInput)(nil)).Elem(), DataCenterResourcePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataCenterResourceResponsePropertiesInput)(nil)).Elem(), DataCenterResourceResponsePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataCenterResourceResponsePropertiesPtrInput)(nil)).Elem(), DataCenterResourceResponsePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseAccountConnectionStringResponseInput)(nil)).Elem(), DatabaseAccountConnectionStringResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseAccountConnectionStringResponseArrayInput)(nil)).Elem(), DatabaseAccountConnectionStringResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseRestoreResourceInput)(nil)).Elem(), DatabaseRestoreResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseRestoreResourceArrayInput)(nil)).Elem(), DatabaseRestoreResourceArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseRestoreResourceResponseInput)(nil)).Elem(), DatabaseRestoreResourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseRestoreResourceResponseArrayInput)(nil)).Elem(), DatabaseRestoreResourceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExcludedPathInput)(nil)).Elem(), ExcludedPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExcludedPathArrayInput)(nil)).Elem(), ExcludedPathArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExcludedPathResponseInput)(nil)).Elem(), ExcludedPathResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExcludedPathResponseArrayInput)(nil)).Elem(), ExcludedPathResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FailoverPolicyResponseInput)(nil)).Elem(), FailoverPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FailoverPolicyResponseArrayInput)(nil)).Elem(), FailoverPolicyResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GremlinDatabaseGetPropertiesResponseOptionsInput)(nil)).Elem(), GremlinDatabaseGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GremlinDatabaseGetPropertiesResponseOptionsPtrInput)(nil)).Elem(), GremlinDatabaseGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GremlinDatabaseGetPropertiesResponseResourceInput)(nil)).Elem(), GremlinDatabaseGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GremlinDatabaseGetPropertiesResponseResourcePtrInput)(nil)).Elem(), GremlinDatabaseGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GremlinDatabaseResourceInput)(nil)).Elem(), GremlinDatabaseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GremlinDatabaseResourcePtrInput)(nil)).Elem(), GremlinDatabaseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GremlinGraphGetPropertiesResponseOptionsInput)(nil)).Elem(), GremlinGraphGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GremlinGraphGetPropertiesResponseOptionsPtrInput)(nil)).Elem(), GremlinGraphGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GremlinGraphGetPropertiesResponseResourceInput)(nil)).Elem(), GremlinGraphGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GremlinGraphGetPropertiesResponseResourcePtrInput)(nil)).Elem(), GremlinGraphGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GremlinGraphResourceInput)(nil)).Elem(), GremlinGraphResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GremlinGraphResourcePtrInput)(nil)).Elem(), GremlinGraphResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IncludedPathInput)(nil)).Elem(), IncludedPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IncludedPathArrayInput)(nil)).Elem(), IncludedPathArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IncludedPathResponseInput)(nil)).Elem(), IncludedPathResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IncludedPathResponseArrayInput)(nil)).Elem(), IncludedPathResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IndexesInput)(nil)).Elem(), IndexesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IndexesArrayInput)(nil)).Elem(), IndexesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IndexesResponseInput)(nil)).Elem(), IndexesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IndexesResponseArrayInput)(nil)).Elem(), IndexesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IndexingPolicyInput)(nil)).Elem(), IndexingPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IndexingPolicyPtrInput)(nil)).Elem(), IndexingPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IndexingPolicyResponseInput)(nil)).Elem(), IndexingPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IndexingPolicyResponsePtrInput)(nil)).Elem(), IndexingPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IpAddressOrRangeInput)(nil)).Elem(), IpAddressOrRangeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IpAddressOrRangeArrayInput)(nil)).Elem(), IpAddressOrRangeArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IpAddressOrRangeResponseInput)(nil)).Elem(), IpAddressOrRangeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IpAddressOrRangeResponseArrayInput)(nil)).Elem(), IpAddressOrRangeResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedCassandraManagedServiceIdentityInput)(nil)).Elem(), ManagedCassandraManagedServiceIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedCassandraManagedServiceIdentityPtrInput)(nil)).Elem(), ManagedCassandraManagedServiceIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedCassandraManagedServiceIdentityResponseInput)(nil)).Elem(), ManagedCassandraManagedServiceIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedCassandraManagedServiceIdentityResponsePtrInput)(nil)).Elem(), ManagedCassandraManagedServiceIdentityResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedServiceIdentityResponseUserAssignedIdentitiesInput)(nil)).Elem(), ManagedServiceIdentityResponseUserAssignedIdentitiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedServiceIdentityResponseUserAssignedIdentitiesMapInput)(nil)).Elem(), ManagedServiceIdentityResponseUserAssignedIdentitiesMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDBCollectionGetPropertiesResponseOptionsInput)(nil)).Elem(), MongoDBCollectionGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDBCollectionGetPropertiesResponseOptionsPtrInput)(nil)).Elem(), MongoDBCollectionGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDBCollectionGetPropertiesResponseResourceInput)(nil)).Elem(), MongoDBCollectionGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDBCollectionGetPropertiesResponseResourcePtrInput)(nil)).Elem(), MongoDBCollectionGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDBCollectionResourceInput)(nil)).Elem(), MongoDBCollectionResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDBCollectionResourcePtrInput)(nil)).Elem(), MongoDBCollectionResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDBDatabaseGetPropertiesResponseOptionsInput)(nil)).Elem(), MongoDBDatabaseGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDBDatabaseGetPropertiesResponseOptionsPtrInput)(nil)).Elem(), MongoDBDatabaseGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDBDatabaseGetPropertiesResponseResourceInput)(nil)).Elem(), MongoDBDatabaseGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDBDatabaseGetPropertiesResponseResourcePtrInput)(nil)).Elem(), MongoDBDatabaseGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDBDatabaseResourceInput)(nil)).Elem(), MongoDBDatabaseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDBDatabaseResourcePtrInput)(nil)).Elem(), MongoDBDatabaseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoIndexInput)(nil)).Elem(), MongoIndexArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoIndexArrayInput)(nil)).Elem(), MongoIndexArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoIndexKeysInput)(nil)).Elem(), MongoIndexKeysArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoIndexKeysPtrInput)(nil)).Elem(), MongoIndexKeysArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoIndexKeysResponseInput)(nil)).Elem(), MongoIndexKeysResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoIndexKeysResponsePtrInput)(nil)).Elem(), MongoIndexKeysResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoIndexOptionsInput)(nil)).Elem(), MongoIndexOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoIndexOptionsPtrInput)(nil)).Elem(), MongoIndexOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoIndexOptionsResponseInput)(nil)).Elem(), MongoIndexOptionsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoIndexOptionsResponsePtrInput)(nil)).Elem(), MongoIndexOptionsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoIndexResponseInput)(nil)).Elem(), MongoIndexResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MongoIndexResponseArrayInput)(nil)).Elem(), MongoIndexResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PeriodicModeBackupPolicyInput)(nil)).Elem(), PeriodicModeBackupPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PeriodicModeBackupPolicyResponseInput)(nil)).Elem(), PeriodicModeBackupPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PeriodicModePropertiesInput)(nil)).Elem(), PeriodicModePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PeriodicModePropertiesPtrInput)(nil)).Elem(), PeriodicModePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PeriodicModePropertiesResponseInput)(nil)).Elem(), PeriodicModePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PeriodicModePropertiesResponsePtrInput)(nil)).Elem(), PeriodicModePropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RestoreParametersInput)(nil)).Elem(), RestoreParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestoreParametersPtrInput)(nil)).Elem(), RestoreParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestoreParametersResponseInput)(nil)).Elem(), RestoreParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestoreParametersResponsePtrInput)(nil)).Elem(), RestoreParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SeedNodeInput)(nil)).Elem(), SeedNodeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SeedNodePtrInput)(nil)).Elem(), SeedNodeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SeedNodeArrayInput)(nil)).Elem(), SeedNodeArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SeedNodeResponseInput)(nil)).Elem(), SeedNodeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SeedNodeResponsePtrInput)(nil)).Elem(), SeedNodeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SeedNodeResponseArrayInput)(nil)).Elem(), SeedNodeResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SpatialSpecInput)(nil)).Elem(), SpatialSpecArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SpatialSpecArrayInput)(nil)).Elem(), SpatialSpecArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SpatialSpecResponseInput)(nil)).Elem(), SpatialSpecResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SpatialSpecResponseArrayInput)(nil)).Elem(), SpatialSpecResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlContainerGetPropertiesResponseOptionsInput)(nil)).Elem(), SqlContainerGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlContainerGetPropertiesResponseOptionsPtrInput)(nil)).Elem(), SqlContainerGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlContainerGetPropertiesResponseResourceInput)(nil)).Elem(), SqlContainerGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlContainerGetPropertiesResponseResourcePtrInput)(nil)).Elem(), SqlContainerGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlContainerResourceInput)(nil)).Elem(), SqlContainerResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlContainerResourcePtrInput)(nil)).Elem(), SqlContainerResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlDatabaseGetPropertiesResponseOptionsInput)(nil)).Elem(), SqlDatabaseGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlDatabaseGetPropertiesResponseOptionsPtrInput)(nil)).Elem(), SqlDatabaseGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlDatabaseGetPropertiesResponseResourceInput)(nil)).Elem(), SqlDatabaseGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlDatabaseGetPropertiesResponseResourcePtrInput)(nil)).Elem(), SqlDatabaseGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlDatabaseResourceInput)(nil)).Elem(), SqlDatabaseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlDatabaseResourcePtrInput)(nil)).Elem(), SqlDatabaseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlStoredProcedureGetPropertiesResponseResourceInput)(nil)).Elem(), SqlStoredProcedureGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlStoredProcedureGetPropertiesResponseResourcePtrInput)(nil)).Elem(), SqlStoredProcedureGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlStoredProcedureResourceInput)(nil)).Elem(), SqlStoredProcedureResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlStoredProcedureResourcePtrInput)(nil)).Elem(), SqlStoredProcedureResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlTriggerGetPropertiesResponseResourceInput)(nil)).Elem(), SqlTriggerGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlTriggerGetPropertiesResponseResourcePtrInput)(nil)).Elem(), SqlTriggerGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlTriggerResourceInput)(nil)).Elem(), SqlTriggerResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlTriggerResourcePtrInput)(nil)).Elem(), SqlTriggerResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlUserDefinedFunctionGetPropertiesResponseResourceInput)(nil)).Elem(), SqlUserDefinedFunctionGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlUserDefinedFunctionGetPropertiesResponseResourcePtrInput)(nil)).Elem(), SqlUserDefinedFunctionGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlUserDefinedFunctionResourceInput)(nil)).Elem(), SqlUserDefinedFunctionResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlUserDefinedFunctionResourcePtrInput)(nil)).Elem(), SqlUserDefinedFunctionResourceArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TableGetPropertiesResponseOptionsInput)(nil)).Elem(), TableGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TableGetPropertiesResponseOptionsPtrInput)(nil)).Elem(), TableGetPropertiesResponseOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TableGetPropertiesResponseResourceInput)(nil)).Elem(), TableGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TableGetPropertiesResponseResourcePtrInput)(nil)).Elem(), TableGetPropertiesResponseResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TableResourceInput)(nil)).Elem(), TableResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TableResourcePtrInput)(nil)).Elem(), TableResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UniqueKeyInput)(nil)).Elem(), UniqueKeyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UniqueKeyArrayInput)(nil)).Elem(), UniqueKeyArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*UniqueKeyPolicyInput)(nil)).Elem(), UniqueKeyPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UniqueKeyPolicyPtrInput)(nil)).Elem(), UniqueKeyPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UniqueKeyPolicyResponseInput)(nil)).Elem(), UniqueKeyPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UniqueKeyPolicyResponsePtrInput)(nil)).Elem(), UniqueKeyPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UniqueKeyResponseInput)(nil)).Elem(), UniqueKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UniqueKeyResponseArrayInput)(nil)).Elem(), UniqueKeyResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CompositePathArrayArrayInput)(nil)).Elem(), CompositePathArrayArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CompositePathResponseArrayArrayInput)(nil)).Elem(), CompositePathResponseArrayArray{})
