...
func LookupCassandraResourceCassandraTable(ctx *pulumi.Context, args *LookupCassandraResourceCassandraTableArgs, opts ...pulumi.InvokeOption) (*LookupCassandraResourceCassandraTableResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:documentdb/v20200901:getCassandraResourceCassandraTable", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupCassandraResourceCassandraTableResult struct {
	...
	Options  *CassandraTableGetPropertiesInvokeResponseOptions  `pulumi:"options"`
	Resource *CassandraTableGetPropertiesInvokeResponseResource `pulumi:"resource"`
