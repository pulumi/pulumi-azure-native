...
func NewCassandraResourceCassandraKeyspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:documentdb/v20210515:CassandraResourceCassandraKeyspace"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20210615:CassandraResourceCassandraKeyspace"),
		},
		{
			Type: pulumi.String("azure-nextgen:documentdb/v20210615:CassandraResourceCassandraKeyspace"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20210301preview:CassandraResourceCassandraKeyspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCassandraResourceCassandraKeyspace(ctx *pulumi.Context,
	...
	var resource CassandraResourceCassandraKeyspace
	err := ctx.ReadResource("azure-native:documentdb/v20210301preview:CassandraResourceCassandraKeyspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
