...
func LookupMongoDBResourceMongoDBDatabase(ctx *pulumi.Context, args *LookupMongoDBResourceMongoDBDatabaseArgs, opts ...pulumi.InvokeOption) (*LookupMongoDBResourceMongoDBDatabaseResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:documentdb/v20200401:getMongoDBResourceMongoDBDatabase", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupMongoDBResourceMongoDBDatabaseResult struct {
	...
	Options  *MongoDBDatabaseGetPropertiesInvokeResponseOptions  `pulumi:"options"`
	Resource *MongoDBDatabaseGetPropertiesInvokeResponseResource `pulumi:"resource"`
