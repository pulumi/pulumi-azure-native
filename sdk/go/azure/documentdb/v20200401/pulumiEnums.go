...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CompositePathSortOrderInput)(nil)).Elem(), CompositePathSortOrder("Ascending"))
	pulumi.RegisterInputType(reflect.TypeOf((*CompositePathSortOrderPtrInput)(nil)).Elem(), CompositePathSortOrder("Ascending"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConflictResolutionModeInput)(nil)).Elem(), ConflictResolutionMode("LastWriterWins"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConflictResolutionModePtrInput)(nil)).Elem(), ConflictResolutionMode("LastWriterWins"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorOfferInput)(nil)).Elem(), ConnectorOffer("Small"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorOfferPtrInput)(nil)).Elem(), ConnectorOffer("Small"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataTypeInput)(nil)).Elem(), DataType("String"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataTypePtrInput)(nil)).Elem(), DataType("String"))
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseAccountKindInput)(nil)).Elem(), DatabaseAccountKind("GlobalDocumentDB"))
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseAccountKindPtrInput)(nil)).Elem(), DatabaseAccountKind("GlobalDocumentDB"))
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseAccountOfferTypeInput)(nil)).Elem(), DatabaseAccountOfferType("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseAccountOfferTypePtrInput)(nil)).Elem(), DatabaseAccountOfferType("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*DefaultConsistencyLevelInput)(nil)).Elem(), DefaultConsistencyLevel("Eventual"))
	pulumi.RegisterInputType(reflect.TypeOf((*DefaultConsistencyLevelPtrInput)(nil)).Elem(), DefaultConsistencyLevel("Eventual"))
	pulumi.RegisterInputType(reflect.TypeOf((*IndexKindInput)(nil)).Elem(), IndexKind("Hash"))
	pulumi.RegisterInputType(reflect.TypeOf((*IndexKindPtrInput)(nil)).Elem(), IndexKind("Hash"))
	pulumi.RegisterInputType(reflect.TypeOf((*IndexingModeInput)(nil)).Elem(), IndexingMode("Consistent"))
	pulumi.RegisterInputType(reflect.TypeOf((*IndexingModePtrInput)(nil)).Elem(), IndexingMode("Consistent"))
	pulumi.RegisterInputType(reflect.TypeOf((*PartitionKindInput)(nil)).Elem(), PartitionKind("Hash"))
	pulumi.RegisterInputType(reflect.TypeOf((*PartitionKindPtrInput)(nil)).Elem(), PartitionKind("Hash"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServerVersionInput)(nil)).Elem(), ServerVersion("3.2"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServerVersionPtrInput)(nil)).Elem(), ServerVersion("3.2"))
	pulumi.RegisterInputType(reflect.TypeOf((*SpatialTypeInput)(nil)).Elem(), SpatialType("Point"))
	pulumi.RegisterInputType(reflect.TypeOf((*SpatialTypePtrInput)(nil)).Elem(), SpatialType("Point"))
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerOperationInput)(nil)).Elem(), TriggerOperation("All"))
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerOperationPtrInput)(nil)).Elem(), TriggerOperation("All"))
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerTypeInput)(nil)).Elem(), TriggerType("Pre"))
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerTypePtrInput)(nil)).Elem(), TriggerType("Pre"))
