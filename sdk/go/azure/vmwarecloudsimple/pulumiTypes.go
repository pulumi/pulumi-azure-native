...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*GuestOSCustomizationInput)(nil)).Elem(), GuestOSCustomizationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GuestOSCustomizationPtrInput)(nil)).Elem(), GuestOSCustomizationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GuestOSCustomizationResponseInput)(nil)).Elem(), GuestOSCustomizationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GuestOSCustomizationResponsePtrInput)(nil)).Elem(), GuestOSCustomizationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GuestOSNICCustomizationInput)(nil)).Elem(), GuestOSNICCustomizationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GuestOSNICCustomizationPtrInput)(nil)).Elem(), GuestOSNICCustomizationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GuestOSNICCustomizationResponseInput)(nil)).Elem(), GuestOSNICCustomizationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GuestOSNICCustomizationResponsePtrInput)(nil)).Elem(), GuestOSNICCustomizationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourcePoolInput)(nil)).Elem(), ResourcePoolArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourcePoolPtrInput)(nil)).Elem(), ResourcePoolArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourcePoolResponseInput)(nil)).Elem(), ResourcePoolResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourcePoolResponsePtrInput)(nil)).Elem(), ResourcePoolResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualDiskControllerResponseInput)(nil)).Elem(), VirtualDiskControllerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualDiskControllerResponseArrayInput)(nil)).Elem(), VirtualDiskControllerResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkInput)(nil)).Elem(), VirtualNetworkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkResponseInput)(nil)).Elem(), VirtualNetworkResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNicInput)(nil)).Elem(), VirtualNicArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNicArrayInput)(nil)).Elem(), VirtualNicArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNicResponseInput)(nil)).Elem(), VirtualNicResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNicResponseArrayInput)(nil)).Elem(), VirtualNicResponseArray{})
