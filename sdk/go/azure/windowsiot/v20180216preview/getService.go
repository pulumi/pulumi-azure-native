...
func (o LookupServiceResultOutput) BillingDomainName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupServiceResult) string { return v.BillingDomainName }).(pulumi.StringOutput)
}
