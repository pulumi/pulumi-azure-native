...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listStaticSiteBuildAppSettings'.
func ListStaticSiteBuildAppSettings(ctx *pulumi.Context, args *ListStaticSiteBuildAppSettingsArgs, opts ...pulumi.InvokeOption) (*ListStaticSiteBuildAppSettingsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/latest:listStaticSiteBuildAppSettings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
