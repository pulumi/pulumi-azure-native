...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:StaticSiteUserProvidedFunctionAppForStaticSiteBuild'.
...
func NewStaticSiteUserProvidedFunctionAppForStaticSiteBuild(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/latest:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteUserProvidedFunctionAppForStaticSiteBuild(ctx *pulumi.Context,
	...
	var resource StaticSiteUserProvidedFunctionAppForStaticSiteBuild
	err := ctx.ReadResource("azure-native:web/latest:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
