...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:StaticSiteUserProvidedFunctionAppForStaticSite'.
...
func NewStaticSiteUserProvidedFunctionAppForStaticSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:web/latest:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
		{
			Type: pulumi.String("azure-native:web:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
		{
			Type: pulumi.String("azure-nextgen:web:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
		{
			Type: pulumi.String("azure-native:web/v20201201:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20201201:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
	})
	opts = append(opts, aliases)
	var resource StaticSiteUserProvidedFunctionAppForStaticSite
	err := ctx.RegisterResource("azure-native:web/latest:StaticSiteUserProvidedFunctionAppForStaticSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteUserProvidedFunctionAppForStaticSite(ctx *pulumi.Context,
	...
	var resource StaticSiteUserProvidedFunctionAppForStaticSite
	err := ctx.ReadResource("azure-native:web/latest:StaticSiteUserProvidedFunctionAppForStaticSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
