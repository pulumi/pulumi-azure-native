...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getStaticSiteUserProvidedFunctionAppForStaticSiteBuild'.
func LookupStaticSiteUserProvidedFunctionAppForStaticSiteBuild(ctx *pulumi.Context, args *LookupStaticSiteUserProvidedFunctionAppForStaticSiteBuildArgs, opts ...pulumi.InvokeOption) (*LookupStaticSiteUserProvidedFunctionAppForStaticSiteBuildResult, error) {
	...
	err := ctx.Invoke("azure-native:web/latest:getStaticSiteUserProvidedFunctionAppForStaticSiteBuild", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
