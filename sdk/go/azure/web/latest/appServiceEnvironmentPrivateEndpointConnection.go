...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:AppServiceEnvironmentPrivateEndpointConnection'.
...
func NewAppServiceEnvironmentPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/latest:AppServiceEnvironmentPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceEnvironmentPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource AppServiceEnvironmentPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:web/latest:AppServiceEnvironmentPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
