...
func NewCustomApi(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/latest:CustomApi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomApi(ctx *pulumi.Context,
	...
	var resource CustomApi
	err := ctx.ReadResource("azure-native:web/latest:CustomApi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
