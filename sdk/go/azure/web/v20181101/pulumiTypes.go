...
// A global distribution definition.
type GeoDistributionInvokeResponse struct {
	// Location.
	Location *string `pulumi:"location"`
	// NumberOfWorkers.
	NumberOfWorkers *int `pulumi:"numberOfWorkers"`
...
// GeoDistributionInvokeResponseInput is an input type that accepts GeoDistributionInvokeResponseArgs and GeoDistributionInvokeResponseOutput values.
// You can construct a concrete instance of `GeoDistributionInvokeResponseInput` via:
//
//          GeoDistributionInvokeResponseArgs{...}
type GeoDistributionInvokeResponseInput interface {
	pulumi.Input

	ToGeoDistributionInvokeResponseOutput() GeoDistributionInvokeResponseOutput
	ToGeoDistributionInvokeResponseOutputWithContext(context.Context) GeoDistributionInvokeResponseOutput
}

// A global distribution definition.
type GeoDistributionInvokeResponseArgs struct {
	// Location.
	Location pulumi.StringPtrInput `pulumi:"location"`
	// NumberOfWorkers.
	NumberOfWorkers pulumi.IntPtrInput `pulumi:"numberOfWorkers"`
...
func (GeoDistributionInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GeoDistributionInvokeResponse)(nil)).Elem()
}

func (i GeoDistributionInvokeResponseArgs) ToGeoDistributionInvokeResponseOutput() GeoDistributionInvokeResponseOutput {
	return i.ToGeoDistributionInvokeResponseOutputWithContext(context.Background())
}

func (i GeoDistributionInvokeResponseArgs) ToGeoDistributionInvokeResponseOutputWithContext(ctx context.Context) GeoDistributionInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GeoDistributionInvokeResponseOutput)
}

// GeoDistributionInvokeResponseArrayInput is an input type that accepts GeoDistributionInvokeResponseArray and GeoDistributionInvokeResponseArrayOutput values.
// You can construct a concrete instance of `GeoDistributionInvokeResponseArrayInput` via:
//
//          GeoDistributionInvokeResponseArray{ GeoDistributionInvokeResponseArgs{...} }
type GeoDistributionInvokeResponseArrayInput interface {
	pulumi.Input

	ToGeoDistributionInvokeResponseArrayOutput() GeoDistributionInvokeResponseArrayOutput
	ToGeoDistributionInvokeResponseArrayOutputWithContext(context.Context) GeoDistributionInvokeResponseArrayOutput
}

type GeoDistributionInvokeResponseArray []GeoDistributionInvokeResponseInput

func (GeoDistributionInvokeResponseArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GeoDistributionInvokeResponse)(nil)).Elem()
}

func (i GeoDistributionInvokeResponseArray) ToGeoDistributionInvokeResponseArrayOutput() GeoDistributionInvokeResponseArrayOutput {
	return i.ToGeoDistributionInvokeResponseArrayOutputWithContext(context.Background())
}

func (i GeoDistributionInvokeResponseArray) ToGeoDistributionInvokeResponseArrayOutputWithContext(ctx context.Context) GeoDistributionInvokeResponseArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GeoDistributionInvokeResponseArrayOutput)
}

// A global distribution definition.
type GeoDistributionInvokeResponseOutput struct{ *pulumi.OutputState }

func (GeoDistributionInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GeoDistributionInvokeResponse)(nil)).Elem()
}

func (o GeoDistributionInvokeResponseOutput) ToGeoDistributionInvokeResponseOutput() GeoDistributionInvokeResponseOutput {
	return o
}

func (o GeoDistributionInvokeResponseOutput) ToGeoDistributionInvokeResponseOutputWithContext(ctx context.Context) GeoDistributionInvokeResponseOutput {
	return o
}

// Location.
func (o GeoDistributionInvokeResponseOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GeoDistributionInvokeResponse) *string { return v.Location }).(pulumi.StringPtrOutput)
}

// NumberOfWorkers.
func (o GeoDistributionInvokeResponseOutput) NumberOfWorkers() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GeoDistributionInvokeResponse) *int { return v.NumberOfWorkers }).(pulumi.IntPtrOutput)
}

type GeoDistributionInvokeResponseArrayOutput struct{ *pulumi.OutputState }

func (GeoDistributionInvokeResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GeoDistributionInvokeResponse)(nil)).Elem()
}

func (o GeoDistributionInvokeResponseArrayOutput) ToGeoDistributionInvokeResponseArrayOutput() GeoDistributionInvokeResponseArrayOutput {
	return o
}

func (o GeoDistributionInvokeResponseArrayOutput) ToGeoDistributionInvokeResponseArrayOutputWithContext(ctx context.Context) GeoDistributionInvokeResponseArrayOutput {
	return o
}

func (o GeoDistributionInvokeResponseArrayOutput) Index(i pulumi.IntInput) GeoDistributionInvokeResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GeoDistributionInvokeResponse {
		return vs[0].([]GeoDistributionInvokeResponse)[vs[1].(int)]
	}).(GeoDistributionInvokeResponseOutput)
}
...
type SiteConfigInvokeResponse struct {
	...
	AutoSwapSlotName *string `pulumi:"autoSwapSlotName"`
	// User-provided Azure storage accounts.
	AzureStorageAccounts map[string]AzureStorageInfoValueInvokeResponse `pulumi:"azureStorageAccounts"`
	// Connection strings.
...
type SiteConfigInvokeResponseArgs struct {
	...
	AutoSwapSlotName pulumi.StringPtrInput `pulumi:"autoSwapSlotName"`
	// User-provided Azure storage accounts.
	AzureStorageAccounts AzureStorageInfoValueInvokeResponseMapInput `pulumi:"azureStorageAccounts"`
	// Connection strings.
...
// User-provided Azure storage accounts.
func (o SiteConfigInvokeResponseOutput) AzureStorageAccounts() AzureStorageInfoValueInvokeResponseMapOutput {
	return o.ApplyT(func(v SiteConfigInvokeResponse) map[string]AzureStorageInfoValueInvokeResponse {
		return v.AzureStorageAccounts
	}).(AzureStorageInfoValueInvokeResponseMapOutput)
}
...
// Number of reserved instances.
// This setting only applies to the Consumption Plan
func (o SiteConfigInvokeResponseOutput) ReservedInstanceCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v SiteConfigInvokeResponse) *int { return v.ReservedInstanceCount }).(pulumi.IntPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(GeoDistributionInvokeResponseOutput{})
	pulumi.RegisterOutputType(GeoDistributionInvokeResponseArrayOutput{})
