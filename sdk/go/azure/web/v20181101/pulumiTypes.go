...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AzureStorageInfoValueInput)(nil)).Elem(), AzureStorageInfoValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureStorageInfoValueMapInput)(nil)).Elem(), AzureStorageInfoValueMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureStorageInfoValueResponseInput)(nil)).Elem(), AzureStorageInfoValueResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureStorageInfoValueResponseMapInput)(nil)).Elem(), AzureStorageInfoValueResponseMap{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GeoDistributionInput)(nil)).Elem(), GeoDistributionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GeoDistributionArrayInput)(nil)).Elem(), GeoDistributionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GeoDistributionResponseInput)(nil)).Elem(), GeoDistributionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GeoDistributionResponseArrayInput)(nil)).Elem(), GeoDistributionResponseArray{})
