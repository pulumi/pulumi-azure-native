...
func NewWebAppPrivateEndpointConnectionSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:web/v20210101:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20201201:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20201201:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210115:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210115:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210201:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210201:WebAppPrivateEndpointConnectionSlot"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppPrivateEndpointConnectionSlot
	err := ctx.RegisterResource("azure-native:web/v20210101:WebAppPrivateEndpointConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPrivateEndpointConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppPrivateEndpointConnectionSlot
	err := ctx.ReadResource("azure-native:web/v20210101:WebAppPrivateEndpointConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*WebAppPrivateEndpointConnectionSlotInput)(nil)).Elem(), &WebAppPrivateEndpointConnectionSlot{})
