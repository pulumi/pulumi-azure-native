...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ApiConnectionDefinitionPropertiesInput)(nil)).Elem(), ApiConnectionDefinitionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiConnectionDefinitionPropertiesPtrInput)(nil)).Elem(), ApiConnectionDefinitionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiConnectionDefinitionResponsePropertiesInput)(nil)).Elem(), ApiConnectionDefinitionResponsePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiConnectionDefinitionResponsePropertiesPtrInput)(nil)).Elem(), ApiConnectionDefinitionResponsePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiConnectionTestLinkInput)(nil)).Elem(), ApiConnectionTestLinkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiConnectionTestLinkArrayInput)(nil)).Elem(), ApiConnectionTestLinkArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiConnectionTestLinkResponseInput)(nil)).Elem(), ApiConnectionTestLinkResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiConnectionTestLinkResponseArrayInput)(nil)).Elem(), ApiConnectionTestLinkResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ApiReferenceInput)(nil)).Elem(), ApiReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiReferencePtrInput)(nil)).Elem(), ApiReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiReferenceResponseInput)(nil)).Elem(), ApiReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiReferenceResponsePtrInput)(nil)).Elem(), ApiReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiResourceBackendServiceInput)(nil)).Elem(), ApiResourceBackendServiceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiResourceBackendServicePtrInput)(nil)).Elem(), ApiResourceBackendServiceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiResourceBackendServiceResponseInput)(nil)).Elem(), ApiResourceBackendServiceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiResourceBackendServiceResponsePtrInput)(nil)).Elem(), ApiResourceBackendServiceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiResourceDefinitionsInput)(nil)).Elem(), ApiResourceDefinitionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiResourceDefinitionsPtrInput)(nil)).Elem(), ApiResourceDefinitionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiResourceDefinitionsResponseInput)(nil)).Elem(), ApiResourceDefinitionsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiResourceDefinitionsResponsePtrInput)(nil)).Elem(), ApiResourceDefinitionsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionGatewayDefinitionPropertiesInput)(nil)).Elem(), ConnectionGatewayDefinitionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionGatewayDefinitionPropertiesPtrInput)(nil)).Elem(), ConnectionGatewayDefinitionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionGatewayDefinitionResponsePropertiesInput)(nil)).Elem(), ConnectionGatewayDefinitionResponsePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionGatewayDefinitionResponsePropertiesPtrInput)(nil)).Elem(), ConnectionGatewayDefinitionResponsePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionGatewayReferenceInput)(nil)).Elem(), ConnectionGatewayReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionGatewayReferencePtrInput)(nil)).Elem(), ConnectionGatewayReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionGatewayReferenceResponseInput)(nil)).Elem(), ConnectionGatewayReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionGatewayReferenceResponsePtrInput)(nil)).Elem(), ConnectionGatewayReferenceResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionStatusDefinitionInput)(nil)).Elem(), ConnectionStatusDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionStatusDefinitionArrayInput)(nil)).Elem(), ConnectionStatusDefinitionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionStatusDefinitionResponseInput)(nil)).Elem(), ConnectionStatusDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionStatusDefinitionResponseArrayInput)(nil)).Elem(), ConnectionStatusDefinitionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConsentLinkDefinitionResponseInput)(nil)).Elem(), ConsentLinkDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConsentLinkDefinitionResponseArrayInput)(nil)).Elem(), ConsentLinkDefinitionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConsentLinkParameterDefinitionInput)(nil)).Elem(), ConsentLinkParameterDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConsentLinkParameterDefinitionArrayInput)(nil)).Elem(), ConsentLinkParameterDefinitionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomApiPropertiesDefinitionInput)(nil)).Elem(), CustomApiPropertiesDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomApiPropertiesDefinitionPtrInput)(nil)).Elem(), CustomApiPropertiesDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomApiPropertiesDefinitionResponseInput)(nil)).Elem(), CustomApiPropertiesDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomApiPropertiesDefinitionResponsePtrInput)(nil)).Elem(), CustomApiPropertiesDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsdlDefinitionInput)(nil)).Elem(), WsdlDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsdlDefinitionPtrInput)(nil)).Elem(), WsdlDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsdlDefinitionResponseInput)(nil)).Elem(), WsdlDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsdlDefinitionResponsePtrInput)(nil)).Elem(), WsdlDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsdlServiceInput)(nil)).Elem(), WsdlServiceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsdlServicePtrInput)(nil)).Elem(), WsdlServiceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsdlServiceResponseInput)(nil)).Elem(), WsdlServiceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsdlServiceResponsePtrInput)(nil)).Elem(), WsdlServiceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsdlServiceResponseArrayInput)(nil)).Elem(), WsdlServiceResponseArray{})
