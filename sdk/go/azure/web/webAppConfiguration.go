...
type WebAppConfiguration struct {
	...
	ApiManagementConfig ApiManagementConfigResponsePtrOutput `pulumi:"apiManagementConfig"`
	...
	PowerShellVersion pulumi.StringPtrOutput `pulumi:"powerShellVersion"`
	// Number of preWarmed instances.
	// This setting only applies to the Consumption and Elastic Plans
	PreWarmedInstanceCount pulumi.IntPtrOutput `pulumi:"preWarmedInstanceCount"`
	...
	ScmMinTlsVersion pulumi.StringPtrOutput `pulumi:"scmMinTlsVersion"`
	// SCM type.
	...
	VnetPrivatePortsCount pulumi.IntPtrOutput `pulumi:"vnetPrivatePortsCount"`
...
func NewWebAppConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20181101:WebAppConfiguration"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:web:WebAppConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppConfiguration(ctx *pulumi.Context,
	...
	var resource WebAppConfiguration
	err := ctx.ReadResource("azure-native:web:WebAppConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type WebAppConfigurationState struct {
	...
	// Azure API management settings linked to the app.
	ApiManagementConfig ApiManagementConfigResponsePtrInput
	// App command line to launch.
	...
	// Version of PowerShell.
	PowerShellVersion pulumi.StringPtrInput
	// Number of preWarmed instances.
	// This setting only applies to the Consumption and Elastic Plans
	PreWarmedInstanceCount pulumi.IntPtrInput
	// Publishing user name.
	...
	// ScmMinTlsVersion: configures the minimum version of TLS required for SSL requests for SCM site
	ScmMinTlsVersion pulumi.StringPtrInput
	// SCM type.
	...
	// The number of private ports assigned to this app. These will be assigned dynamically on runtime.
	VnetPrivatePortsCount pulumi.IntPtrInput
	// Virtual Network Route All enabled. This causes all outbound traffic to have Virtual Network Security Groups and User Defined Routes applied.
...
type WebAppConfigurationArgs struct {
	...
	// Azure API management settings linked to the app.
	ApiManagementConfig ApiManagementConfigPtrInput
	// App command line to launch.
	AppCommandLine pulumi.StringPtrInput
	// Application settings.
