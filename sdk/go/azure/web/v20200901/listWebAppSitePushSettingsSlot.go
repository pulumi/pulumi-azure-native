...
func ListWebAppSitePushSettingsSlot(ctx *pulumi.Context, args *ListWebAppSitePushSettingsSlotArgs, opts ...pulumi.InvokeOption) (*ListWebAppSitePushSettingsSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20200901:listWebAppSitePushSettingsSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o ListWebAppSitePushSettingsSlotResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v ListWebAppSitePushSettingsSlotResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
