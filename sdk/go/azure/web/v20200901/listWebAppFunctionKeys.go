...
func ListWebAppFunctionKeys(ctx *pulumi.Context, args *ListWebAppFunctionKeysArgs, opts ...pulumi.InvokeOption) (*ListWebAppFunctionKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20200901:listWebAppFunctionKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o ListWebAppFunctionKeysResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v ListWebAppFunctionKeysResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
