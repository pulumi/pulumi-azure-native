...
func ListWebAppMetadataSlot(ctx *pulumi.Context, args *ListWebAppMetadataSlotArgs, opts ...pulumi.InvokeOption) (*ListWebAppMetadataSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20200901:listWebAppMetadataSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o ListWebAppMetadataSlotResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v ListWebAppMetadataSlotResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
