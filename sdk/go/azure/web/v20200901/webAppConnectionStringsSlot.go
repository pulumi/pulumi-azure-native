...
func NewWebAppConnectionStringsSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20200901:WebAppConnectionStringsSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppConnectionStringsSlot(ctx *pulumi.Context,
	...
	var resource WebAppConnectionStringsSlot
	err := ctx.ReadResource("azure-nextgen:web/v20200901:WebAppConnectionStringsSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
