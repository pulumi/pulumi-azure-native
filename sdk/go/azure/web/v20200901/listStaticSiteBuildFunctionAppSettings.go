...
func ListStaticSiteBuildFunctionAppSettings(ctx *pulumi.Context, args *ListStaticSiteBuildFunctionAppSettingsArgs, opts ...pulumi.InvokeOption) (*ListStaticSiteBuildFunctionAppSettingsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20200901:listStaticSiteBuildFunctionAppSettings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o ListStaticSiteBuildFunctionAppSettingsResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v ListStaticSiteBuildFunctionAppSettingsResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
