...
func NewWebAppPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20200901:WebAppPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource WebAppPrivateEndpointConnection
	err := ctx.ReadResource("azure-nextgen:web/v20200901:WebAppPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
