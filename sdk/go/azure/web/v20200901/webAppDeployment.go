...
func NewWebAppDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20200901:WebAppDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDeployment(ctx *pulumi.Context,
	...
	var resource WebAppDeployment
	err := ctx.ReadResource("azure-nextgen:web/v20200901:WebAppDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
