...
func NewWebAppInstanceFunctionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20190801:WebAppInstanceFunctionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppInstanceFunctionSlot(ctx *pulumi.Context,
	...
	var resource WebAppInstanceFunctionSlot
	err := ctx.ReadResource("azure-nextgen:web/v20190801:WebAppInstanceFunctionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
