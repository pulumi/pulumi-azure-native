...
func NewAppServicePlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20190801:AppServicePlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServicePlan(ctx *pulumi.Context,
	...
	var resource AppServicePlan
	err := ctx.ReadResource("azure-nextgen:web/v20190801:AppServicePlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
