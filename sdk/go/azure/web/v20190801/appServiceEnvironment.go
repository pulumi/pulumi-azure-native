...
func NewAppServiceEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20190801:AppServiceEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceEnvironment(ctx *pulumi.Context,
	...
	var resource AppServiceEnvironment
	err := ctx.ReadResource("azure-nextgen:web/v20190801:AppServiceEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
