...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ApiManagementConfigInput)(nil)).Elem(), ApiManagementConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiManagementConfigPtrInput)(nil)).Elem(), ApiManagementConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiManagementConfigResponseInput)(nil)).Elem(), ApiManagementConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiManagementConfigResponsePtrInput)(nil)).Elem(), ApiManagementConfigResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BackupItemResponseInput)(nil)).Elem(), BackupItemResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupItemResponseArrayInput)(nil)).Elem(), BackupItemResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkConnectionStateInput)(nil)).Elem(), PrivateLinkConnectionStateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkConnectionStatePtrInput)(nil)).Elem(), PrivateLinkConnectionStateArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StaticSiteBuildPropertiesInput)(nil)).Elem(), StaticSiteBuildPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StaticSiteBuildPropertiesPtrInput)(nil)).Elem(), StaticSiteBuildPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StaticSiteBuildPropertiesResponseInput)(nil)).Elem(), StaticSiteBuildPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StaticSiteBuildPropertiesResponsePtrInput)(nil)).Elem(), StaticSiteBuildPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StaticSiteUserARMResourceResponseInput)(nil)).Elem(), StaticSiteUserARMResourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StaticSiteUserARMResourceResponseArrayInput)(nil)).Elem(), StaticSiteUserARMResourceResponseArray{})
