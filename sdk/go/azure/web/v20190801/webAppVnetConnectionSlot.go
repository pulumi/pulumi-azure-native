...
func NewWebAppVnetConnectionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20190801:WebAppVnetConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppVnetConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppVnetConnectionSlot
	err := ctx.ReadResource("azure-nextgen:web/v20190801:WebAppVnetConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
