...
func NewWebAppMetadataSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20190801:WebAppMetadataSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppMetadataSlot(ctx *pulumi.Context,
	...
	var resource WebAppMetadataSlot
	err := ctx.ReadResource("azure-nextgen:web/v20190801:WebAppMetadataSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
