...
func NewWebAppApplicationSettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20190801:WebAppApplicationSettings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppApplicationSettings(ctx *pulumi.Context,
	...
	var resource WebAppApplicationSettings
	err := ctx.ReadResource("azure-nextgen:web/v20190801:WebAppApplicationSettings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
