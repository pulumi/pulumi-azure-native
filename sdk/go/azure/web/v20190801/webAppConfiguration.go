...
type WebAppConfiguration struct {
	...
	AcrUseManagedIdentityCreds pulumi.BoolPtrOutput `pulumi:"acrUseManagedIdentityCreds"`
	// If using user managed identity, the user managed identity ClientId
	AcrUserManagedIdentityID pulumi.StringPtrOutput `pulumi:"acrUserManagedIdentityID"`
...
func NewWebAppConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20190801:WebAppConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppConfiguration(ctx *pulumi.Context,
	...
	var resource WebAppConfiguration
	err := ctx.ReadResource("azure-native:web/v20190801:WebAppConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type WebAppConfigurationState struct {
	// Flag to use Managed Identity Creds for ACR pull
	AcrUseManagedIdentityCreds pulumi.BoolPtrInput
	// If using user managed identity, the user managed identity ClientId
	AcrUserManagedIdentityID pulumi.StringPtrInput
	// <code>true</code> if Always On is enabled; otherwise, <code>false</code>.
