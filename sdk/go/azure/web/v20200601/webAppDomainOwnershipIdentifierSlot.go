...
func NewWebAppDomainOwnershipIdentifierSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:web/v20201201:WebAppDomainOwnershipIdentifierSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210101:WebAppDomainOwnershipIdentifierSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210101:WebAppDomainOwnershipIdentifierSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210115:WebAppDomainOwnershipIdentifierSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210115:WebAppDomainOwnershipIdentifierSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210201:WebAppDomainOwnershipIdentifierSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210201:WebAppDomainOwnershipIdentifierSlot"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppDomainOwnershipIdentifierSlot
	err := ctx.RegisterResource("azure-native:web/v20200601:WebAppDomainOwnershipIdentifierSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDomainOwnershipIdentifierSlot(ctx *pulumi.Context,
	...
	var resource WebAppDomainOwnershipIdentifierSlot
	err := ctx.ReadResource("azure-native:web/v20200601:WebAppDomainOwnershipIdentifierSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*WebAppDomainOwnershipIdentifierSlotInput)(nil)).Elem(), &WebAppDomainOwnershipIdentifierSlot{})
