...
func NewWebAppDeploymentSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:web/v20201201:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210101:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210101:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210115:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210115:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210201:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210201:WebAppDeploymentSlot"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppDeploymentSlot
	err := ctx.RegisterResource("azure-native:web/v20200601:WebAppDeploymentSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDeploymentSlot(ctx *pulumi.Context,
	...
	var resource WebAppDeploymentSlot
	err := ctx.ReadResource("azure-native:web/v20200601:WebAppDeploymentSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*WebAppDeploymentSlotInput)(nil)).Elem(), &WebAppDeploymentSlot{})
