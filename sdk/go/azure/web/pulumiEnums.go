...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*FrontEndServiceTypeInput)(nil)).Elem(), FrontEndServiceType("NodePort"))
	pulumi.RegisterInputType(reflect.TypeOf((*FrontEndServiceTypePtrInput)(nil)).Elem(), FrontEndServiceType("NodePort"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StorageTypeInput)(nil)).Elem(), StorageType("LocalNode"))
	pulumi.RegisterInputType(reflect.TypeOf((*StorageTypePtrInput)(nil)).Elem(), StorageType("LocalNode"))
