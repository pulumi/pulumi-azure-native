...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ClientCertModeInput)(nil)).Elem(), ClientCertMode("Required"))
	pulumi.RegisterInputType(reflect.TypeOf((*ClientCertModePtrInput)(nil)).Elem(), ClientCertMode("Required"))
	pulumi.RegisterInputType(reflect.TypeOf((*ClientCredentialMethodInput)(nil)).Elem(), ClientCredentialMethod("ClientSecretPost"))
	pulumi.RegisterInputType(reflect.TypeOf((*ClientCredentialMethodPtrInput)(nil)).Elem(), ClientCredentialMethod("ClientSecretPost"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CookieExpirationConventionInput)(nil)).Elem(), CookieExpirationConvention("FixedTime"))
	pulumi.RegisterInputType(reflect.TypeOf((*CookieExpirationConventionPtrInput)(nil)).Elem(), CookieExpirationConvention("FixedTime"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ForwardProxyConventionInput)(nil)).Elem(), ForwardProxyConvention("NoProxy"))
	pulumi.RegisterInputType(reflect.TypeOf((*ForwardProxyConventionPtrInput)(nil)).Elem(), ForwardProxyConvention("NoProxy"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancingModeInput)(nil)).Elem(), LoadBalancingMode("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancingModePtrInput)(nil)).Elem(), LoadBalancingMode("None"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StagingEnvironmentPolicyInput)(nil)).Elem(), StagingEnvironmentPolicy("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*StagingEnvironmentPolicyPtrInput)(nil)).Elem(), StagingEnvironmentPolicy("Enabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UnauthenticatedClientActionV2Input)(nil)).Elem(), UnauthenticatedClientActionV2("RedirectToLoginPage"))
	pulumi.RegisterInputType(reflect.TypeOf((*UnauthenticatedClientActionV2PtrInput)(nil)).Elem(), UnauthenticatedClientActionV2("RedirectToLoginPage"))
