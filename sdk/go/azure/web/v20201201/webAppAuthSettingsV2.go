...
func NewWebAppAuthSettingsV2(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:web/v20210101:WebAppAuthSettingsV2"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210115:WebAppAuthSettingsV2"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210115:WebAppAuthSettingsV2"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210201:WebAppAuthSettingsV2"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210201:WebAppAuthSettingsV2"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppAuthSettingsV2
	err := ctx.RegisterResource("azure-native:web/v20201201:WebAppAuthSettingsV2", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppAuthSettingsV2(ctx *pulumi.Context,
	...
	var resource WebAppAuthSettingsV2
	err := ctx.ReadResource("azure-native:web/v20201201:WebAppAuthSettingsV2", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
