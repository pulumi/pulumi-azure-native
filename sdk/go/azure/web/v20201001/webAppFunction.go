...
func NewWebAppFunction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20201001:WebAppFunction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppFunction(ctx *pulumi.Context,
	...
	var resource WebAppFunction
	err := ctx.ReadResource("azure-nextgen:web/v20201001:WebAppFunction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
