...
func NewWebAppBackupConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20201001:WebAppBackupConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppBackupConfiguration(ctx *pulumi.Context,
	...
	var resource WebAppBackupConfiguration
	err := ctx.ReadResource("azure-nextgen:web/v20201001:WebAppBackupConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
