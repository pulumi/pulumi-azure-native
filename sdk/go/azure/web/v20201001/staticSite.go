...
func NewStaticSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20201001:StaticSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSite(ctx *pulumi.Context,
	...
	var resource StaticSite
	err := ctx.ReadResource("azure-nextgen:web/v20201001:StaticSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
