...
func NewWebApplicationSettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web:WebApplicationSettings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebApplicationSettings(ctx *pulumi.Context,
	...
	var resource WebApplicationSettings
	err := ctx.ReadResource("azure-nextgen:web:WebApplicationSettings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
