...
func NewWebAppHostNameBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web:WebAppHostNameBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHostNameBinding(ctx *pulumi.Context,
	...
	var resource WebAppHostNameBinding
	err := ctx.ReadResource("azure-nextgen:web:WebAppHostNameBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
