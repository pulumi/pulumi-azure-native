...
func NewWebAppRelayServiceConnectionSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:web/v20201201:WebAppRelayServiceConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210101:WebAppRelayServiceConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210101:WebAppRelayServiceConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210115:WebAppRelayServiceConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210115:WebAppRelayServiceConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210201:WebAppRelayServiceConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210201:WebAppRelayServiceConnectionSlot"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppRelayServiceConnectionSlot
	err := ctx.RegisterResource("azure-native:web/v20180201:WebAppRelayServiceConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppRelayServiceConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppRelayServiceConnectionSlot
	err := ctx.ReadResource("azure-native:web/v20180201:WebAppRelayServiceConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*WebAppRelayServiceConnectionSlotInput)(nil)).Elem(), &WebAppRelayServiceConnectionSlot{})
