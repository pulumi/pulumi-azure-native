...
func NewWebAppAzureStorageAccountsSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20180201:WebAppAzureStorageAccountsSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppAzureStorageAccountsSlot(ctx *pulumi.Context,
	...
	var resource WebAppAzureStorageAccountsSlot
	err := ctx.ReadResource("azure-nextgen:web/v20180201:WebAppAzureStorageAccountsSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
