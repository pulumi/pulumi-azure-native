...
func NewWebApplicationSettingsSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:web/v20180201:WebApplicationSettingsSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebApplicationSettingsSlot(ctx *pulumi.Context,
	...
	var resource WebApplicationSettingsSlot
	err := ctx.ReadResource("azure-nextgen:web/v20180201:WebApplicationSettingsSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
