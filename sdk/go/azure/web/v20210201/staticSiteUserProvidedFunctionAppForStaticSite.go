...
func NewStaticSiteUserProvidedFunctionAppForStaticSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:web/v20210201:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
		{
		...
		{
			Type: pulumi.String("azure-nextgen:web/v20210101:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
		{
			Type: pulumi.String("azure-native:web/v20210115:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
		{
			Type: pulumi.String("azure-nextgen:web/v20210115:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
	})
	opts = append(opts, aliases)
	var resource StaticSiteUserProvidedFunctionAppForStaticSite
	err := ctx.RegisterResource("azure-native:web/v20210201:StaticSiteUserProvidedFunctionAppForStaticSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteUserProvidedFunctionAppForStaticSite(ctx *pulumi.Context,
	...
	var resource StaticSiteUserProvidedFunctionAppForStaticSite
	err := ctx.ReadResource("azure-native:web/v20210201:StaticSiteUserProvidedFunctionAppForStaticSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*StaticSiteUserProvidedFunctionAppForStaticSiteInput)(nil)).Elem(), &StaticSiteUserProvidedFunctionAppForStaticSite{})
