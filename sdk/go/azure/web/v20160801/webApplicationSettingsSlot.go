...
func NewWebApplicationSettingsSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:web:WebApplicationSettingsSlot"),
		},
		{
		...
		{
			Type: pulumi.String("azure-nextgen:web/v20201001:WebApplicationSettingsSlot"),
		},
	})
	opts = append(opts, aliases)
	var resource WebApplicationSettingsSlot
	err := ctx.RegisterResource("azure-nextgen:web/v20160801:WebApplicationSettingsSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebApplicationSettingsSlot(ctx *pulumi.Context,
	...
	var resource WebApplicationSettingsSlot
	err := ctx.ReadResource("azure-nextgen:web/v20160801:WebApplicationSettingsSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
