...
func LookupWebAppPremierAddOn(ctx *pulumi.Context, args *LookupWebAppPremierAddOnArgs, opts ...pulumi.InvokeOption) (*LookupWebAppPremierAddOnResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20160801:getWebAppPremierAddOn", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupWebAppPremierAddOnResultOutput) PremierAddOnName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWebAppPremierAddOnResult) *string { return v.PremierAddOnName }).(pulumi.StringPtrOutput)
}
