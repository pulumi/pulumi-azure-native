...
func (o SnapshotRecoveryTargetResponseOutput) ToSnapshotRecoveryTargetResponsePtrOutputWithContext(ctx context.Context) SnapshotRecoveryTargetResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v SnapshotRecoveryTargetResponse) *SnapshotRecoveryTargetResponse {
		return &v
...
func (o SnapshotRecoveryTargetResponsePtrOutput) Elem() SnapshotRecoveryTargetResponseOutput {
	return o.ApplyT(func(v *SnapshotRecoveryTargetResponse) SnapshotRecoveryTargetResponse {
		...
		var ret SnapshotRecoveryTargetResponse
		return ret
	}).(SnapshotRecoveryTargetResponseOutput)
}
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ApiDefinitionInfoInput)(nil)).Elem(), ApiDefinitionInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiDefinitionInfoPtrInput)(nil)).Elem(), ApiDefinitionInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiDefinitionInfoResponseInput)(nil)).Elem(), ApiDefinitionInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiDefinitionInfoResponsePtrInput)(nil)).Elem(), ApiDefinitionInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationLogsConfigInput)(nil)).Elem(), ApplicationLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationLogsConfigPtrInput)(nil)).Elem(), ApplicationLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationLogsConfigResponseInput)(nil)).Elem(), ApplicationLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationLogsConfigResponsePtrInput)(nil)).Elem(), ApplicationLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealActionsInput)(nil)).Elem(), AutoHealActionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealActionsPtrInput)(nil)).Elem(), AutoHealActionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealActionsResponseInput)(nil)).Elem(), AutoHealActionsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealActionsResponsePtrInput)(nil)).Elem(), AutoHealActionsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealCustomActionInput)(nil)).Elem(), AutoHealCustomActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealCustomActionPtrInput)(nil)).Elem(), AutoHealCustomActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealCustomActionResponseInput)(nil)).Elem(), AutoHealCustomActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealCustomActionResponsePtrInput)(nil)).Elem(), AutoHealCustomActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealRulesInput)(nil)).Elem(), AutoHealRulesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealRulesPtrInput)(nil)).Elem(), AutoHealRulesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealRulesResponseInput)(nil)).Elem(), AutoHealRulesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealRulesResponsePtrInput)(nil)).Elem(), AutoHealRulesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealTriggersInput)(nil)).Elem(), AutoHealTriggersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealTriggersPtrInput)(nil)).Elem(), AutoHealTriggersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealTriggersResponseInput)(nil)).Elem(), AutoHealTriggersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoHealTriggersResponsePtrInput)(nil)).Elem(), AutoHealTriggersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBlobStorageApplicationLogsConfigInput)(nil)).Elem(), AzureBlobStorageApplicationLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBlobStorageApplicationLogsConfigPtrInput)(nil)).Elem(), AzureBlobStorageApplicationLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBlobStorageApplicationLogsConfigResponseInput)(nil)).Elem(), AzureBlobStorageApplicationLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBlobStorageApplicationLogsConfigResponsePtrInput)(nil)).Elem(), AzureBlobStorageApplicationLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBlobStorageHttpLogsConfigInput)(nil)).Elem(), AzureBlobStorageHttpLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBlobStorageHttpLogsConfigPtrInput)(nil)).Elem(), AzureBlobStorageHttpLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBlobStorageHttpLogsConfigResponseInput)(nil)).Elem(), AzureBlobStorageHttpLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBlobStorageHttpLogsConfigResponsePtrInput)(nil)).Elem(), AzureBlobStorageHttpLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureTableStorageApplicationLogsConfigInput)(nil)).Elem(), AzureTableStorageApplicationLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureTableStorageApplicationLogsConfigPtrInput)(nil)).Elem(), AzureTableStorageApplicationLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureTableStorageApplicationLogsConfigResponseInput)(nil)).Elem(), AzureTableStorageApplicationLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureTableStorageApplicationLogsConfigResponsePtrInput)(nil)).Elem(), AzureTableStorageApplicationLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupScheduleInput)(nil)).Elem(), BackupScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupSchedulePtrInput)(nil)).Elem(), BackupScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupScheduleResponseInput)(nil)).Elem(), BackupScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupScheduleResponsePtrInput)(nil)).Elem(), BackupScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloningInfoInput)(nil)).Elem(), CloningInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloningInfoPtrInput)(nil)).Elem(), CloningInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloningInfoResponseInput)(nil)).Elem(), CloningInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnStringInfoInput)(nil)).Elem(), ConnStringInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnStringInfoArrayInput)(nil)).Elem(), ConnStringInfoArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnStringInfoResponseInput)(nil)).Elem(), ConnStringInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnStringInfoResponseArrayInput)(nil)).Elem(), ConnStringInfoResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnStringValueTypePairInput)(nil)).Elem(), ConnStringValueTypePairArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnStringValueTypePairMapInput)(nil)).Elem(), ConnStringValueTypePairMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnStringValueTypePairResponseInput)(nil)).Elem(), ConnStringValueTypePairResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnStringValueTypePairResponseMapInput)(nil)).Elem(), ConnStringValueTypePairResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsSettingsInput)(nil)).Elem(), CorsSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsSettingsPtrInput)(nil)).Elem(), CorsSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsSettingsResponseInput)(nil)).Elem(), CorsSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsSettingsResponsePtrInput)(nil)).Elem(), CorsSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseBackupSettingInput)(nil)).Elem(), DatabaseBackupSettingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseBackupSettingArrayInput)(nil)).Elem(), DatabaseBackupSettingArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseBackupSettingResponseInput)(nil)).Elem(), DatabaseBackupSettingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseBackupSettingResponseArrayInput)(nil)).Elem(), DatabaseBackupSettingResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnabledConfigInput)(nil)).Elem(), EnabledConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnabledConfigPtrInput)(nil)).Elem(), EnabledConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnabledConfigResponseInput)(nil)).Elem(), EnabledConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnabledConfigResponsePtrInput)(nil)).Elem(), EnabledConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExperimentsInput)(nil)).Elem(), ExperimentsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExperimentsPtrInput)(nil)).Elem(), ExperimentsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExperimentsResponseInput)(nil)).Elem(), ExperimentsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExperimentsResponsePtrInput)(nil)).Elem(), ExperimentsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FileSystemApplicationLogsConfigInput)(nil)).Elem(), FileSystemApplicationLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FileSystemApplicationLogsConfigPtrInput)(nil)).Elem(), FileSystemApplicationLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FileSystemApplicationLogsConfigResponseInput)(nil)).Elem(), FileSystemApplicationLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FileSystemApplicationLogsConfigResponsePtrInput)(nil)).Elem(), FileSystemApplicationLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FileSystemHttpLogsConfigInput)(nil)).Elem(), FileSystemHttpLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FileSystemHttpLogsConfigPtrInput)(nil)).Elem(), FileSystemHttpLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FileSystemHttpLogsConfigResponseInput)(nil)).Elem(), FileSystemHttpLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FileSystemHttpLogsConfigResponsePtrInput)(nil)).Elem(), FileSystemHttpLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HandlerMappingInput)(nil)).Elem(), HandlerMappingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HandlerMappingArrayInput)(nil)).Elem(), HandlerMappingArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HandlerMappingResponseInput)(nil)).Elem(), HandlerMappingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HandlerMappingResponseArrayInput)(nil)).Elem(), HandlerMappingResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HostNameSslStateInput)(nil)).Elem(), HostNameSslStateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HostNameSslStateArrayInput)(nil)).Elem(), HostNameSslStateArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HostNameSslStateResponseInput)(nil)).Elem(), HostNameSslStateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HostNameSslStateResponseArrayInput)(nil)).Elem(), HostNameSslStateResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HostingEnvironmentProfileInput)(nil)).Elem(), HostingEnvironmentProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HostingEnvironmentProfilePtrInput)(nil)).Elem(), HostingEnvironmentProfileArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HttpLogsConfigInput)(nil)).Elem(), HttpLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpLogsConfigPtrInput)(nil)).Elem(), HttpLogsConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpLogsConfigResponseInput)(nil)).Elem(), HttpLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpLogsConfigResponsePtrInput)(nil)).Elem(), HttpLogsConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IpSecurityRestrictionInput)(nil)).Elem(), IpSecurityRestrictionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IpSecurityRestrictionArrayInput)(nil)).Elem(), IpSecurityRestrictionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IpSecurityRestrictionResponseInput)(nil)).Elem(), IpSecurityRestrictionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IpSecurityRestrictionResponseArrayInput)(nil)).Elem(), IpSecurityRestrictionResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NameValuePairInput)(nil)).Elem(), NameValuePairArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NameValuePairArrayInput)(nil)).Elem(), NameValuePairArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NameValuePairResponseInput)(nil)).Elem(), NameValuePairResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NameValuePairResponseArrayInput)(nil)).Elem(), NameValuePairResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PushSettingsInput)(nil)).Elem(), PushSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PushSettingsPtrInput)(nil)).Elem(), PushSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PushSettingsResponseInput)(nil)).Elem(), PushSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PushSettingsResponsePtrInput)(nil)).Elem(), PushSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RampUpRuleInput)(nil)).Elem(), RampUpRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RampUpRuleArrayInput)(nil)).Elem(), RampUpRuleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RampUpRuleResponseInput)(nil)).Elem(), RampUpRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RampUpRuleResponseArrayInput)(nil)).Elem(), RampUpRuleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestsBasedTriggerInput)(nil)).Elem(), RequestsBasedTriggerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestsBasedTriggerPtrInput)(nil)).Elem(), RequestsBasedTriggerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestsBasedTriggerResponseInput)(nil)).Elem(), RequestsBasedTriggerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestsBasedTriggerResponsePtrInput)(nil)).Elem(), RequestsBasedTriggerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SiteConfigInput)(nil)).Elem(), SiteConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SiteConfigPtrInput)(nil)).Elem(), SiteConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SiteConfigResponseInput)(nil)).Elem(), SiteConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SiteConfigResponsePtrInput)(nil)).Elem(), SiteConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SiteLimitsInput)(nil)).Elem(), SiteLimitsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SiteLimitsPtrInput)(nil)).Elem(), SiteLimitsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SiteLimitsResponseInput)(nil)).Elem(), SiteLimitsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SiteLimitsResponsePtrInput)(nil)).Elem(), SiteLimitsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SiteMachineKeyResponseInput)(nil)).Elem(), SiteMachineKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SiteMachineKeyResponsePtrInput)(nil)).Elem(), SiteMachineKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SlotSwapStatusResponseInput)(nil)).Elem(), SlotSwapStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SlotSwapStatusResponsePtrInput)(nil)).Elem(), SlotSwapStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SlowRequestsBasedTriggerInput)(nil)).Elem(), SlowRequestsBasedTriggerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SlowRequestsBasedTriggerPtrInput)(nil)).Elem(), SlowRequestsBasedTriggerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SlowRequestsBasedTriggerResponseInput)(nil)).Elem(), SlowRequestsBasedTriggerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SlowRequestsBasedTriggerResponsePtrInput)(nil)).Elem(), SlowRequestsBasedTriggerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SnapshotRecoveryRequestInput)(nil)).Elem(), SnapshotRecoveryRequestArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SnapshotRecoveryRequestPtrInput)(nil)).Elem(), SnapshotRecoveryRequestArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SnapshotRecoveryRequestResponseInput)(nil)).Elem(), SnapshotRecoveryRequestResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SnapshotRecoveryTargetInput)(nil)).Elem(), SnapshotRecoveryTargetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SnapshotRecoveryTargetPtrInput)(nil)).Elem(), SnapshotRecoveryTargetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SnapshotRecoveryTargetResponseInput)(nil)).Elem(), SnapshotRecoveryTargetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SnapshotRecoveryTargetResponsePtrInput)(nil)).Elem(), SnapshotRecoveryTargetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StatusCodesBasedTriggerInput)(nil)).Elem(), StatusCodesBasedTriggerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StatusCodesBasedTriggerArrayInput)(nil)).Elem(), StatusCodesBasedTriggerArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*StatusCodesBasedTriggerResponseInput)(nil)).Elem(), StatusCodesBasedTriggerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StatusCodesBasedTriggerResponseArrayInput)(nil)).Elem(), StatusCodesBasedTriggerResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualApplicationInput)(nil)).Elem(), VirtualApplicationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualApplicationArrayInput)(nil)).Elem(), VirtualApplicationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualApplicationResponseInput)(nil)).Elem(), VirtualApplicationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualApplicationResponseArrayInput)(nil)).Elem(), VirtualApplicationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualDirectoryInput)(nil)).Elem(), VirtualDirectoryArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualDirectoryArrayInput)(nil)).Elem(), VirtualDirectoryArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualDirectoryResponseInput)(nil)).Elem(), VirtualDirectoryResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualDirectoryResponseArrayInput)(nil)).Elem(), VirtualDirectoryResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VnetRouteResponseInput)(nil)).Elem(), VnetRouteResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VnetRouteResponseArrayInput)(nil)).Elem(), VnetRouteResponseArray{})
