...
// <code>true</code> if quotas should be ignored; otherwise, <code>false</code>.
func (o CloningInfoInvokeResponseOutput) IgnoreQuotas() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v CloningInfoInvokeResponse) *bool { return v.IgnoreQuotas }).(pulumi.BoolPtrOutput)
}
...
// IP address the security restriction is valid for.
func (o IpSecurityRestrictionInvokeResponseOutput) IpAddress() pulumi.StringOutput {
	return o.ApplyT(func(v IpSecurityRestrictionInvokeResponse) string { return v.IpAddress }).(pulumi.StringOutput)
}
...
// Details about app recovery operation.
type SnapshotRecoveryRequestInvokeResponse struct {
	// Resource Id.
	Id string `pulumi:"id"`
	// If true, custom hostname conflicts will be ignored when recovering to a target web app.
	// This setting is only necessary when RecoverConfiguration is enabled.
	...
	RecoverConfiguration *bool `pulumi:"recoverConfiguration"`
	// Specifies the web app that snapshot contents will be written to.
	RecoveryTarget *SnapshotRecoveryTargetInvokeResponse `pulumi:"recoveryTarget"`
	// Point in time in which the app recovery should be attempted, formatted as a DateTime string.
	SnapshotTime *string `pulumi:"snapshotTime"`
	// Resource type.
	Type string `pulumi:"type"`
...
// SnapshotRecoveryRequestInvokeResponseInput is an input type that accepts SnapshotRecoveryRequestInvokeResponseArgs and SnapshotRecoveryRequestInvokeResponseOutput values.
// You can construct a concrete instance of `SnapshotRecoveryRequestInvokeResponseInput` via:
//
//          SnapshotRecoveryRequestInvokeResponseArgs{...}
type SnapshotRecoveryRequestInvokeResponseInput interface {
	pulumi.Input

	ToSnapshotRecoveryRequestInvokeResponseOutput() SnapshotRecoveryRequestInvokeResponseOutput
	ToSnapshotRecoveryRequestInvokeResponseOutputWithContext(context.Context) SnapshotRecoveryRequestInvokeResponseOutput
}

// Details about app recovery operation.
type SnapshotRecoveryRequestInvokeResponseArgs struct {
	// Resource Id.
	Id pulumi.StringInput `pulumi:"id"`
	// If true, custom hostname conflicts will be ignored when recovering to a target web app.
	// This setting is only necessary when RecoverConfiguration is enabled.
	...
	RecoverConfiguration pulumi.BoolPtrInput `pulumi:"recoverConfiguration"`
	// Specifies the web app that snapshot contents will be written to.
	RecoveryTarget SnapshotRecoveryTargetInvokeResponsePtrInput `pulumi:"recoveryTarget"`
	// Point in time in which the app recovery should be attempted, formatted as a DateTime string.
	SnapshotTime pulumi.StringPtrInput `pulumi:"snapshotTime"`
	// Resource type.
	Type pulumi.StringInput `pulumi:"type"`
...
func (SnapshotRecoveryRequestInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*SnapshotRecoveryRequestInvokeResponse)(nil)).Elem()
}

func (i SnapshotRecoveryRequestInvokeResponseArgs) ToSnapshotRecoveryRequestInvokeResponseOutput() SnapshotRecoveryRequestInvokeResponseOutput {
	return i.ToSnapshotRecoveryRequestInvokeResponseOutputWithContext(context.Background())
}

func (i SnapshotRecoveryRequestInvokeResponseArgs) ToSnapshotRecoveryRequestInvokeResponseOutputWithContext(ctx context.Context) SnapshotRecoveryRequestInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SnapshotRecoveryRequestInvokeResponseOutput)
}

// Details about app recovery operation.
type SnapshotRecoveryRequestInvokeResponseOutput struct{ *pulumi.OutputState }

func (SnapshotRecoveryRequestInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*SnapshotRecoveryRequestInvokeResponse)(nil)).Elem()
}

func (o SnapshotRecoveryRequestInvokeResponseOutput) ToSnapshotRecoveryRequestInvokeResponseOutput() SnapshotRecoveryRequestInvokeResponseOutput {
	return o
}

func (o SnapshotRecoveryRequestInvokeResponseOutput) ToSnapshotRecoveryRequestInvokeResponseOutputWithContext(ctx context.Context) SnapshotRecoveryRequestInvokeResponseOutput {
	return o
}

// Resource Id.
func (o SnapshotRecoveryRequestInvokeResponseOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v SnapshotRecoveryRequestInvokeResponse) string { return v.Id }).(pulumi.StringOutput)
}

// If true, custom hostname conflicts will be ignored when recovering to a target web app.
// This setting is only necessary when RecoverConfiguration is enabled.
func (o SnapshotRecoveryRequestInvokeResponseOutput) IgnoreConflictingHostNames() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v SnapshotRecoveryRequestInvokeResponse) *bool { return v.IgnoreConflictingHostNames }).(pulumi.BoolPtrOutput)
}

// Kind of resource.
func (o SnapshotRecoveryRequestInvokeResponseOutput) Kind() pulumi.StringPtrOutput {
	return o.ApplyT(func(v SnapshotRecoveryRequestInvokeResponse) *string { return v.Kind }).(pulumi.StringPtrOutput)
}

// Resource Name.
func (o SnapshotRecoveryRequestInvokeResponseOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v SnapshotRecoveryRequestInvokeResponse) string { return v.Name }).(pulumi.StringOutput)
}

// If <code>true</code> the recovery operation can overwrite source app; otherwise, <code>false</code>.
func (o SnapshotRecoveryRequestInvokeResponseOutput) Overwrite() pulumi.BoolOutput {
	return o.ApplyT(func(v SnapshotRecoveryRequestInvokeResponse) bool { return v.Overwrite }).(pulumi.BoolOutput)
}

// If true, site configuration, in addition to content, will be reverted.
func (o SnapshotRecoveryRequestInvokeResponseOutput) RecoverConfiguration() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v SnapshotRecoveryRequestInvokeResponse) *bool { return v.RecoverConfiguration }).(pulumi.BoolPtrOutput)
}

// Specifies the web app that snapshot contents will be written to.
func (o SnapshotRecoveryRequestInvokeResponseOutput) RecoveryTarget() SnapshotRecoveryTargetInvokeResponsePtrOutput {
	return o.ApplyT(func(v SnapshotRecoveryRequestInvokeResponse) *SnapshotRecoveryTargetInvokeResponse {
		return v.RecoveryTarget
	}).(SnapshotRecoveryTargetInvokeResponsePtrOutput)
}

// Point in time in which the app recovery should be attempted, formatted as a DateTime string.
func (o SnapshotRecoveryRequestInvokeResponseOutput) SnapshotTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v SnapshotRecoveryRequestInvokeResponse) *string { return v.SnapshotTime }).(pulumi.StringPtrOutput)
}

// Resource type.
func (o SnapshotRecoveryRequestInvokeResponseOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v SnapshotRecoveryRequestInvokeResponse) string { return v.Type }).(pulumi.StringOutput)
}
...
// Specifies the web app that snapshot contents will be written to.
type SnapshotRecoveryTargetInvokeResponse struct {
	// ARM resource ID of the target app.
	// /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName} for production slots and
	// /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/slots/{slotName} for other slots.
	Id *string `pulumi:"id"`
...
// SnapshotRecoveryTargetInvokeResponseInput is an input type that accepts SnapshotRecoveryTargetInvokeResponseArgs and SnapshotRecoveryTargetInvokeResponseOutput values.
// You can construct a concrete instance of `SnapshotRecoveryTargetInvokeResponseInput` via:
//
//          SnapshotRecoveryTargetInvokeResponseArgs{...}
type SnapshotRecoveryTargetInvokeResponseInput interface {
	pulumi.Input

	ToSnapshotRecoveryTargetInvokeResponseOutput() SnapshotRecoveryTargetInvokeResponseOutput
	ToSnapshotRecoveryTargetInvokeResponseOutputWithContext(context.Context) SnapshotRecoveryTargetInvokeResponseOutput
}

// Specifies the web app that snapshot contents will be written to.
type SnapshotRecoveryTargetInvokeResponseArgs struct {
	// ARM resource ID of the target app.
	// /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName} for production slots and
	// /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/slots/{slotName} for other slots.
	Id pulumi.StringPtrInput `pulumi:"id"`
...
func (SnapshotRecoveryTargetInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*SnapshotRecoveryTargetInvokeResponse)(nil)).Elem()
}

func (i SnapshotRecoveryTargetInvokeResponseArgs) ToSnapshotRecoveryTargetInvokeResponseOutput() SnapshotRecoveryTargetInvokeResponseOutput {
	return i.ToSnapshotRecoveryTargetInvokeResponseOutputWithContext(context.Background())
}

func (i SnapshotRecoveryTargetInvokeResponseArgs) ToSnapshotRecoveryTargetInvokeResponseOutputWithContext(ctx context.Context) SnapshotRecoveryTargetInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SnapshotRecoveryTargetInvokeResponseOutput)
}

func (i SnapshotRecoveryTargetInvokeResponseArgs) ToSnapshotRecoveryTargetInvokeResponsePtrOutput() SnapshotRecoveryTargetInvokeResponsePtrOutput {
	return i.ToSnapshotRecoveryTargetInvokeResponsePtrOutputWithContext(context.Background())
}

func (i SnapshotRecoveryTargetInvokeResponseArgs) ToSnapshotRecoveryTargetInvokeResponsePtrOutputWithContext(ctx context.Context) SnapshotRecoveryTargetInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SnapshotRecoveryTargetInvokeResponseOutput).ToSnapshotRecoveryTargetInvokeResponsePtrOutputWithContext(ctx)
}

// SnapshotRecoveryTargetInvokeResponsePtrInput is an input type that accepts SnapshotRecoveryTargetInvokeResponseArgs, SnapshotRecoveryTargetInvokeResponsePtr and SnapshotRecoveryTargetInvokeResponsePtrOutput values.
// You can construct a concrete instance of `SnapshotRecoveryTargetInvokeResponsePtrInput` via:
//
//          SnapshotRecoveryTargetInvokeResponseArgs{...}
//
//  or:
//
//          nil
type SnapshotRecoveryTargetInvokeResponsePtrInput interface {
	pulumi.Input

	ToSnapshotRecoveryTargetInvokeResponsePtrOutput() SnapshotRecoveryTargetInvokeResponsePtrOutput
	ToSnapshotRecoveryTargetInvokeResponsePtrOutputWithContext(context.Context) SnapshotRecoveryTargetInvokeResponsePtrOutput
}

type snapshotRecoveryTargetInvokeResponsePtrType SnapshotRecoveryTargetInvokeResponseArgs

func SnapshotRecoveryTargetInvokeResponsePtr(v *SnapshotRecoveryTargetInvokeResponseArgs) SnapshotRecoveryTargetInvokeResponsePtrInput {
	return (*snapshotRecoveryTargetInvokeResponsePtrType)(v)
}

func (*snapshotRecoveryTargetInvokeResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**SnapshotRecoveryTargetInvokeResponse)(nil)).Elem()
}

func (i *snapshotRecoveryTargetInvokeResponsePtrType) ToSnapshotRecoveryTargetInvokeResponsePtrOutput() SnapshotRecoveryTargetInvokeResponsePtrOutput {
	return i.ToSnapshotRecoveryTargetInvokeResponsePtrOutputWithContext(context.Background())
}

func (i *snapshotRecoveryTargetInvokeResponsePtrType) ToSnapshotRecoveryTargetInvokeResponsePtrOutputWithContext(ctx context.Context) SnapshotRecoveryTargetInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SnapshotRecoveryTargetInvokeResponsePtrOutput)
}

// Specifies the web app that snapshot contents will be written to.
type SnapshotRecoveryTargetInvokeResponseOutput struct{ *pulumi.OutputState }

func (SnapshotRecoveryTargetInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*SnapshotRecoveryTargetInvokeResponse)(nil)).Elem()
}

func (o SnapshotRecoveryTargetInvokeResponseOutput) ToSnapshotRecoveryTargetInvokeResponseOutput() SnapshotRecoveryTargetInvokeResponseOutput {
	return o
}

func (o SnapshotRecoveryTargetInvokeResponseOutput) ToSnapshotRecoveryTargetInvokeResponseOutputWithContext(ctx context.Context) SnapshotRecoveryTargetInvokeResponseOutput {
	return o
}

func (o SnapshotRecoveryTargetInvokeResponseOutput) ToSnapshotRecoveryTargetInvokeResponsePtrOutput() SnapshotRecoveryTargetInvokeResponsePtrOutput {
	return o.ToSnapshotRecoveryTargetInvokeResponsePtrOutputWithContext(context.Background())
}

func (o SnapshotRecoveryTargetInvokeResponseOutput) ToSnapshotRecoveryTargetInvokeResponsePtrOutputWithContext(ctx context.Context) SnapshotRecoveryTargetInvokeResponsePtrOutput {
	return o.ApplyT(func(v SnapshotRecoveryTargetInvokeResponse) *SnapshotRecoveryTargetInvokeResponse {
		return &v
	}).(SnapshotRecoveryTargetInvokeResponsePtrOutput)
}
...
// /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName} for production slots and
// /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/slots/{slotName} for other slots.
func (o SnapshotRecoveryTargetInvokeResponseOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v SnapshotRecoveryTargetInvokeResponse) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// Geographical location of the target web app, e.g. SouthEastAsia, SouthCentralUS
func (o SnapshotRecoveryTargetInvokeResponseOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v SnapshotRecoveryTargetInvokeResponse) *string { return v.Location }).(pulumi.StringPtrOutput)
}

type SnapshotRecoveryTargetInvokeResponsePtrOutput struct{ *pulumi.OutputState }

func (SnapshotRecoveryTargetInvokeResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**SnapshotRecoveryTargetInvokeResponse)(nil)).Elem()
}

func (o SnapshotRecoveryTargetInvokeResponsePtrOutput) ToSnapshotRecoveryTargetInvokeResponsePtrOutput() SnapshotRecoveryTargetInvokeResponsePtrOutput {
	return o
}

func (o SnapshotRecoveryTargetInvokeResponsePtrOutput) ToSnapshotRecoveryTargetInvokeResponsePtrOutputWithContext(ctx context.Context) SnapshotRecoveryTargetInvokeResponsePtrOutput {
	return o
}

func (o SnapshotRecoveryTargetInvokeResponsePtrOutput) Elem() SnapshotRecoveryTargetInvokeResponseOutput {
	return o.ApplyT(func(v *SnapshotRecoveryTargetInvokeResponse) SnapshotRecoveryTargetInvokeResponse { return *v }).(SnapshotRecoveryTargetInvokeResponseOutput)
}

// ARM resource ID of the target app.
// /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName} for production slots and
// /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/slots/{slotName} for other slots.
func (o SnapshotRecoveryTargetInvokeResponsePtrOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SnapshotRecoveryTargetInvokeResponse) *string {
		if v == nil {
			return nil
		}
		return v.Id
...
// Geographical location of the target web app, e.g. SouthEastAsia, SouthCentralUS
func (o SnapshotRecoveryTargetInvokeResponsePtrOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SnapshotRecoveryTargetInvokeResponse) *string {
		if v == nil {
			return nil
		}
...
// The name of this route. This is only returned by the server and does not need to be set by the client.
func (o VnetRouteInvokeResponseOutput) VnetRouteName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VnetRouteInvokeResponse) *string { return v.VnetRouteName }).(pulumi.StringPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(SnapshotRecoveryRequestInvokeResponseOutput{})
	...
	pulumi.RegisterOutputType(SnapshotRecoveryTargetInvokeResponseOutput{})
	pulumi.RegisterOutputType(SnapshotRecoveryTargetInvokeResponsePtrOutput{})
