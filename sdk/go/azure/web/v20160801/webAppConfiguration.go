...
func NewWebAppConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20160801:WebAppConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppConfiguration(ctx *pulumi.Context,
	...
	var resource WebAppConfiguration
	err := ctx.ReadResource("azure-native:web/v20160801:WebAppConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
