...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BackupRestoreOperationTypeInput)(nil)).Elem(), BackupRestoreOperationType("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*BackupRestoreOperationTypePtrInput)(nil)).Elem(), BackupRestoreOperationType("Default"))
