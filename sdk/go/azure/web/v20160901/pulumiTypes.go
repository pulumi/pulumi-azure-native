...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkAccessControlEntryInput)(nil)).Elem(), NetworkAccessControlEntryArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkAccessControlEntryArrayInput)(nil)).Elem(), NetworkAccessControlEntryArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkAccessControlEntryResponseInput)(nil)).Elem(), NetworkAccessControlEntryResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkAccessControlEntryResponseArrayInput)(nil)).Elem(), NetworkAccessControlEntryResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SkuCapacityInput)(nil)).Elem(), SkuCapacityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SkuCapacityPtrInput)(nil)).Elem(), SkuCapacityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SkuCapacityResponseInput)(nil)).Elem(), SkuCapacityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SkuCapacityResponsePtrInput)(nil)).Elem(), SkuCapacityResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StampCapacityResponseInput)(nil)).Elem(), StampCapacityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StampCapacityResponseArrayInput)(nil)).Elem(), StampCapacityResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualIPMappingResponseInput)(nil)).Elem(), VirtualIPMappingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualIPMappingResponseArrayInput)(nil)).Elem(), VirtualIPMappingResponseArray{})
