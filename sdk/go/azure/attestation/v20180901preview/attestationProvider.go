...
func NewAttestationProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:attestation/v20180901preview:AttestationProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttestationProvider(ctx *pulumi.Context,
	...
	var resource AttestationProvider
	err := ctx.ReadResource("azure-nextgen:attestation/v20180901preview:AttestationProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
