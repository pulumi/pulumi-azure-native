...
// RebootOptionsInput is an input type that accepts RebootOptionsArgs and RebootOptionsOutput values.
// You can construct a concrete instance of `RebootOptionsInput` via:
//
//          RebootOptionsArgs{...}
...
// TaskScopeInput is an input type that accepts TaskScopeArgs and TaskScopeOutput values.
// You can construct a concrete instance of `TaskScopeInput` via:
//
//          TaskScopeArgs{...}
