...
func NewMaintenanceConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:maintenance/v20210401preview:MaintenanceConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMaintenanceConfiguration(ctx *pulumi.Context,
	...
	var resource MaintenanceConfiguration
	err := ctx.ReadResource("azure-nextgen:maintenance/v20210401preview:MaintenanceConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type MaintenanceConfigurationState struct {
	...
	// The input parameters to be passed to the patch run operation.
	InstallPatches InputPatchConfigurationResponsePtrInput
	// Gets or sets location of the resource
