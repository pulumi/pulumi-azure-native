...
func NewPolicySetDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:management/v20190101:PolicySetDefinitionAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	var resource PolicySetDefinitionAtManagementGroup
	err := ctx.ReadResource("azure-nextgen:management/v20190101:PolicySetDefinitionAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
