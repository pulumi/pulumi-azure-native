...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:management:HierarchySetting'.
...
func NewHierarchySetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:management/latest:HierarchySetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHierarchySetting(ctx *pulumi.Context,
	...
	var resource HierarchySetting
	err := ctx.ReadResource("azure-native:management/latest:HierarchySetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
