...
type DescendantParentGroupInfoInvokeResponse struct {
	// The fully qualified ID for the parent management group.  For example, /providers/Microsoft.Management/managementGroups/0000000-0000-0000-0000-000000000000
	Id *string `pulumi:"id"`
}

// DescendantParentGroupInfoInvokeResponseInput is an input type that accepts DescendantParentGroupInfoInvokeResponseArgs and DescendantParentGroupInfoInvokeResponseOutput values.
// You can construct a concrete instance of `DescendantParentGroupInfoInvokeResponseInput` via:
//
//          DescendantParentGroupInfoInvokeResponseArgs{...}
type DescendantParentGroupInfoInvokeResponseInput interface {
	pulumi.Input

	ToDescendantParentGroupInfoInvokeResponseOutput() DescendantParentGroupInfoInvokeResponseOutput
	ToDescendantParentGroupInfoInvokeResponseOutputWithContext(context.Context) DescendantParentGroupInfoInvokeResponseOutput
}

// The ID of the parent management group.
type DescendantParentGroupInfoInvokeResponseArgs struct {
	// The fully qualified ID for the parent management group.  For example, /providers/Microsoft.Management/managementGroups/0000000-0000-0000-0000-000000000000
	Id pulumi.StringPtrInput `pulumi:"id"`
}

func (DescendantParentGroupInfoInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*DescendantParentGroupInfoInvokeResponse)(nil)).Elem()
}

func (i DescendantParentGroupInfoInvokeResponseArgs) ToDescendantParentGroupInfoInvokeResponseOutput() DescendantParentGroupInfoInvokeResponseOutput {
	return i.ToDescendantParentGroupInfoInvokeResponseOutputWithContext(context.Background())
}

func (i DescendantParentGroupInfoInvokeResponseArgs) ToDescendantParentGroupInfoInvokeResponseOutputWithContext(ctx context.Context) DescendantParentGroupInfoInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DescendantParentGroupInfoInvokeResponseOutput)
}

// The ID of the parent management group.
type DescendantParentGroupInfoInvokeResponseOutput struct{ *pulumi.OutputState }

func (DescendantParentGroupInfoInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DescendantParentGroupInfoInvokeResponse)(nil)).Elem()
}

func (o DescendantParentGroupInfoInvokeResponseOutput) ToDescendantParentGroupInfoInvokeResponseOutput() DescendantParentGroupInfoInvokeResponseOutput {
	return o
}

func (o DescendantParentGroupInfoInvokeResponseOutput) ToDescendantParentGroupInfoInvokeResponseOutputWithContext(ctx context.Context) DescendantParentGroupInfoInvokeResponseOutput {
	return o
}

// The fully qualified ID for the parent management group.  For example, /providers/Microsoft.Management/managementGroups/0000000-0000-0000-0000-000000000000
func (o DescendantParentGroupInfoInvokeResponseOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DescendantParentGroupInfoInvokeResponse) *string { return v.Id }).(pulumi.StringPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(DescendantParentGroupInfoInvokeResponseOutput{})
