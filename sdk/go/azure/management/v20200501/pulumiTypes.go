...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DescendantParentGroupInfoResponseInput)(nil)).Elem(), DescendantParentGroupInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DescendantParentGroupInfoResponsePtrInput)(nil)).Elem(), DescendantParentGroupInfoResponseArgs{})
