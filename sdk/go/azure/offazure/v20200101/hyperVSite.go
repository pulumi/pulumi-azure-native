...
func NewHyperVSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:offazure/v20200101:HyperVSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHyperVSite(ctx *pulumi.Context,
	...
	var resource HyperVSite
	err := ctx.ReadResource("azure-nextgen:offazure/v20200101:HyperVSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
