...
func NewMasterSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure:MasterSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMasterSite(ctx *pulumi.Context,
	...
	var resource MasterSite
	err := ctx.ReadResource("azure-native:offazure:MasterSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
