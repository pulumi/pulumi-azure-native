...
func NewMasterSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:offazure:MasterSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMasterSite(ctx *pulumi.Context,
	...
	var resource MasterSite
	err := ctx.ReadResource("azure-nextgen:offazure:MasterSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
