...
func NewSpatialAnchorsAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:mixedreality/v20191202preview:SpatialAnchorsAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpatialAnchorsAccount(ctx *pulumi.Context,
	...
	var resource SpatialAnchorsAccount
	err := ctx.ReadResource("azure-nextgen:mixedreality/v20191202preview:SpatialAnchorsAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
