...
func NewObjectAnchorsAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:mixedreality/v20210301preview:ObjectAnchorsAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetObjectAnchorsAccount(ctx *pulumi.Context,
	...
	var resource ObjectAnchorsAccount
	err := ctx.ReadResource("azure-nextgen:mixedreality/v20210301preview:ObjectAnchorsAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
