...
func NewSpatialAnchorsAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:mixedreality/v20210101:SpatialAnchorsAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpatialAnchorsAccount(ctx *pulumi.Context,
	...
	var resource SpatialAnchorsAccount
	err := ctx.ReadResource("azure-nextgen:mixedreality/v20210101:SpatialAnchorsAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
