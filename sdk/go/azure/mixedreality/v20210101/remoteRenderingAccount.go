...
func NewRemoteRenderingAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:mixedreality/v20210101:RemoteRenderingAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemoteRenderingAccount(ctx *pulumi.Context,
	...
	var resource RemoteRenderingAccount
	err := ctx.ReadResource("azure-nextgen:mixedreality/v20210101:RemoteRenderingAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
