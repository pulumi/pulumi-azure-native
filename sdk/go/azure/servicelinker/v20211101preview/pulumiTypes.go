...
// SecretAuthInfoResponseInput is an input type that accepts SecretAuthInfoResponseArgs and SecretAuthInfoResponseOutput values.
// You can construct a concrete instance of `SecretAuthInfoResponseInput` via:
//
...
// ServicePrincipalCertificateAuthInfoResponseInput is an input type that accepts ServicePrincipalCertificateAuthInfoResponseArgs and ServicePrincipalCertificateAuthInfoResponseOutput values.
// You can construct a concrete instance of `ServicePrincipalCertificateAuthInfoResponseInput` via:
//
...
// ServicePrincipalSecretAuthInfoResponseInput is an input type that accepts ServicePrincipalSecretAuthInfoResponseArgs and ServicePrincipalSecretAuthInfoResponseOutput values.
// You can construct a concrete instance of `ServicePrincipalSecretAuthInfoResponseInput` via:
//
...
// SourceConfigurationResponseInput is an input type that accepts SourceConfigurationResponseArgs and SourceConfigurationResponseOutput values.
// You can construct a concrete instance of `SourceConfigurationResponseInput` via:
//
//          SourceConfigurationResponseArgs{...}
...
// SourceConfigurationResponseArrayInput is an input type that accepts SourceConfigurationResponseArray and SourceConfigurationResponseArrayOutput values.
// You can construct a concrete instance of `SourceConfigurationResponseArrayInput` via:
//
//          SourceConfigurationResponseArray{ SourceConfigurationResponseArgs{...} }
...
// SystemAssignedIdentityAuthInfoResponseInput is an input type that accepts SystemAssignedIdentityAuthInfoResponseArgs and SystemAssignedIdentityAuthInfoResponseOutput values.
// You can construct a concrete instance of `SystemAssignedIdentityAuthInfoResponseInput` via:
//
...
// UserAssignedIdentityAuthInfoResponseInput is an input type that accepts UserAssignedIdentityAuthInfoResponseArgs and UserAssignedIdentityAuthInfoResponseOutput values.
// You can construct a concrete instance of `UserAssignedIdentityAuthInfoResponseInput` via:
//
