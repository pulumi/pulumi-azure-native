...
// AuthTypeInput is an input type that accepts AuthTypeArgs and AuthTypeOutput values.
// You can construct a concrete instance of `AuthTypeInput` via:
//
//          AuthTypeArgs{...}
...
// ClientTypeInput is an input type that accepts ClientTypeArgs and ClientTypeOutput values.
// You can construct a concrete instance of `ClientTypeInput` via:
//
//          ClientTypeArgs{...}
