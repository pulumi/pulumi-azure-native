...
func NewVirtualMachineImageTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:virtualmachineimages/v20180201preview:VirtualMachineImageTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineImageTemplate(ctx *pulumi.Context,
	...
	var resource VirtualMachineImageTemplate
	err := ctx.ReadResource("azure-nextgen:virtualmachineimages/v20180201preview:VirtualMachineImageTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
