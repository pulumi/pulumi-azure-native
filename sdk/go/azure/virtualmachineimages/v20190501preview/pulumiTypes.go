...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateFileCustomizerInput)(nil)).Elem(), ImageTemplateFileCustomizerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateFileCustomizerResponseInput)(nil)).Elem(), ImageTemplateFileCustomizerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateIdentityInput)(nil)).Elem(), ImageTemplateIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateIdentityPtrInput)(nil)).Elem(), ImageTemplateIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateIdentityResponseInput)(nil)).Elem(), ImageTemplateIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateIdentityResponsePtrInput)(nil)).Elem(), ImageTemplateIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateIdentityResponseUserAssignedIdentitiesInput)(nil)).Elem(), ImageTemplateIdentityResponseUserAssignedIdentitiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateIdentityResponseUserAssignedIdentitiesMapInput)(nil)).Elem(), ImageTemplateIdentityResponseUserAssignedIdentitiesMap{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateSharedImageVersionSourceInput)(nil)).Elem(), ImageTemplateSharedImageVersionSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateSharedImageVersionSourceResponseInput)(nil)).Elem(), ImageTemplateSharedImageVersionSourceResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateVmProfileInput)(nil)).Elem(), ImageTemplateVmProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateVmProfilePtrInput)(nil)).Elem(), ImageTemplateVmProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateVmProfileResponseInput)(nil)).Elem(), ImageTemplateVmProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateVmProfileResponsePtrInput)(nil)).Elem(), ImageTemplateVmProfileResponseArgs{})
