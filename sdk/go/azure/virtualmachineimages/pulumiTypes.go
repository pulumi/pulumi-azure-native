...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateWindowsUpdateCustomizerInput)(nil)).Elem(), ImageTemplateWindowsUpdateCustomizerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageTemplateWindowsUpdateCustomizerResponseInput)(nil)).Elem(), ImageTemplateWindowsUpdateCustomizerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PlatformImagePurchasePlanInput)(nil)).Elem(), PlatformImagePurchasePlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PlatformImagePurchasePlanPtrInput)(nil)).Elem(), PlatformImagePurchasePlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PlatformImagePurchasePlanResponseInput)(nil)).Elem(), PlatformImagePurchasePlanResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PlatformImagePurchasePlanResponsePtrInput)(nil)).Elem(), PlatformImagePurchasePlanResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkConfigInput)(nil)).Elem(), VirtualNetworkConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkConfigPtrInput)(nil)).Elem(), VirtualNetworkConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkConfigResponseInput)(nil)).Elem(), VirtualNetworkConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkConfigResponsePtrInput)(nil)).Elem(), VirtualNetworkConfigResponseArgs{})
