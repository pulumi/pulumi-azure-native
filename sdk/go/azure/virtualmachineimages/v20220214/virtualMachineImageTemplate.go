...
func NewVirtualMachineImageTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:virtualmachineimages/v20220214:VirtualMachineImageTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineImageTemplate(ctx *pulumi.Context,
	...
	var resource VirtualMachineImageTemplate
	err := ctx.ReadResource("azure-native:virtualmachineimages/v20220214:VirtualMachineImageTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
