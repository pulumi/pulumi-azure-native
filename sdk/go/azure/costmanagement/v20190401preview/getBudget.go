...
func LookupBudget(ctx *pulumi.Context, args *LookupBudgetArgs, opts ...pulumi.InvokeOption) (*LookupBudgetResult, error) {
	...
	err := ctx.Invoke("azure-native:costmanagement/v20190401preview:getBudget", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupBudgetResultOutput) Filter() ReportConfigFilterResponsePtrOutput {
	return o.ApplyT(func(v LookupBudgetResult) *ReportConfigFilterResponse { return v.Filter }).(ReportConfigFilterResponsePtrOutput)
}
