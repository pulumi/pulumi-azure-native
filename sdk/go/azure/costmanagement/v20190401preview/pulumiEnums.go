...
// NotificationOperatorTypeInput is an input type that accepts NotificationOperatorTypeArgs and NotificationOperatorTypeOutput values.
// You can construct a concrete instance of `NotificationOperatorTypeInput` via:
//
//          NotificationOperatorTypeArgs{...}
