...
func NewReportConfigByResourceGroupName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:costmanagement:ReportConfigByResourceGroupName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReportConfigByResourceGroupName(ctx *pulumi.Context,
	...
	var resource ReportConfigByResourceGroupName
	err := ctx.ReadResource("azure-nextgen:costmanagement:ReportConfigByResourceGroupName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
