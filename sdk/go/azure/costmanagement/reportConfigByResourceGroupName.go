...
func NewReportConfigByResourceGroupName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:costmanagement:ReportConfigByResourceGroupName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReportConfigByResourceGroupName(ctx *pulumi.Context,
	...
	var resource ReportConfigByResourceGroupName
	err := ctx.ReadResource("azure-native:costmanagement:ReportConfigByResourceGroupName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
