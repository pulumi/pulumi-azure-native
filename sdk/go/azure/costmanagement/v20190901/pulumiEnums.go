...
// QueryColumnTypeInput is an input type that accepts QueryColumnTypeArgs and QueryColumnTypeOutput values.
// You can construct a concrete instance of `QueryColumnTypeInput` via:
//
//          QueryColumnTypeArgs{...}
...
// SortDirectionInput is an input type that accepts SortDirectionArgs and SortDirectionOutput values.
// You can construct a concrete instance of `SortDirectionInput` via:
//
//          SortDirectionArgs{...}
