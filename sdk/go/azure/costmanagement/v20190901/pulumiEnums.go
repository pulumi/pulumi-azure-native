...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*QueryColumnTypeInput)(nil)).Elem(), QueryColumnType("Tag"))
	pulumi.RegisterInputType(reflect.TypeOf((*QueryColumnTypePtrInput)(nil)).Elem(), QueryColumnType("Tag"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SortDirectionInput)(nil)).Elem(), SortDirection("Ascending"))
	pulumi.RegisterInputType(reflect.TypeOf((*SortDirectionPtrInput)(nil)).Elem(), SortDirection("Ascending"))
