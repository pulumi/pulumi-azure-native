...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReportGranularityTypeInput)(nil)).Elem(), ReportGranularityType("Daily"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReportGranularityTypePtrInput)(nil)).Elem(), ReportGranularityType("Daily"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReportTimeframeTypeInput)(nil)).Elem(), ReportTimeframeType("WeekToDate"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReportTimeframeTypePtrInput)(nil)).Elem(), ReportTimeframeType("WeekToDate"))
