...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorStatusInput)(nil)).Elem(), ConnectorStatus("active"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorStatusPtrInput)(nil)).Elem(), ConnectorStatus("active"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReportColumnTypeInput)(nil)).Elem(), ReportColumnType("Tag"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReportColumnTypePtrInput)(nil)).Elem(), ReportColumnType("Tag"))
