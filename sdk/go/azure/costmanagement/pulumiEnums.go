...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionTypeInput)(nil)).Elem(), FunctionType("Avg"))
	pulumi.RegisterInputType(reflect.TypeOf((*FunctionTypePtrInput)(nil)).Elem(), FunctionType("Avg"))
