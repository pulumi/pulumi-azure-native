...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CostAllocationProportionInput)(nil)).Elem(), CostAllocationProportionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CostAllocationProportionArrayInput)(nil)).Elem(), CostAllocationProportionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CostAllocationProportionResponseInput)(nil)).Elem(), CostAllocationProportionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CostAllocationProportionResponseArrayInput)(nil)).Elem(), CostAllocationProportionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CostAllocationRuleDetailsInput)(nil)).Elem(), CostAllocationRuleDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CostAllocationRuleDetailsPtrInput)(nil)).Elem(), CostAllocationRuleDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CostAllocationRuleDetailsResponseInput)(nil)).Elem(), CostAllocationRuleDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CostAllocationRuleDetailsResponsePtrInput)(nil)).Elem(), CostAllocationRuleDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CostAllocationRulePropertiesInput)(nil)).Elem(), CostAllocationRulePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CostAllocationRulePropertiesPtrInput)(nil)).Elem(), CostAllocationRulePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CostAllocationRulePropertiesResponseInput)(nil)).Elem(), CostAllocationRulePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CostAllocationRulePropertiesResponsePtrInput)(nil)).Elem(), CostAllocationRulePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceCostAllocationResourceInput)(nil)).Elem(), SourceCostAllocationResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceCostAllocationResourceArrayInput)(nil)).Elem(), SourceCostAllocationResourceArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceCostAllocationResourceResponseInput)(nil)).Elem(), SourceCostAllocationResourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceCostAllocationResourceResponseArrayInput)(nil)).Elem(), SourceCostAllocationResourceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetCostAllocationResourceInput)(nil)).Elem(), TargetCostAllocationResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetCostAllocationResourceArrayInput)(nil)).Elem(), TargetCostAllocationResourceArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetCostAllocationResourceResponseInput)(nil)).Elem(), TargetCostAllocationResourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetCostAllocationResourceResponseArrayInput)(nil)).Elem(), TargetCostAllocationResourceResponseArray{})
