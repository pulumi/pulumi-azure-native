...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDeliveryDestinationInput)(nil)).Elem(), ExportDeliveryDestinationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDeliveryDestinationPtrInput)(nil)).Elem(), ExportDeliveryDestinationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDeliveryDestinationResponseInput)(nil)).Elem(), ExportDeliveryDestinationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDeliveryDestinationResponsePtrInput)(nil)).Elem(), ExportDeliveryDestinationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDeliveryInfoInput)(nil)).Elem(), ExportDeliveryInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDeliveryInfoPtrInput)(nil)).Elem(), ExportDeliveryInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDeliveryInfoResponseInput)(nil)).Elem(), ExportDeliveryInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDeliveryInfoResponsePtrInput)(nil)).Elem(), ExportDeliveryInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportRecurrencePeriodInput)(nil)).Elem(), ExportRecurrencePeriodArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportRecurrencePeriodPtrInput)(nil)).Elem(), ExportRecurrencePeriodArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportRecurrencePeriodResponseInput)(nil)).Elem(), ExportRecurrencePeriodResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportRecurrencePeriodResponsePtrInput)(nil)).Elem(), ExportRecurrencePeriodResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportScheduleInput)(nil)).Elem(), ExportScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportSchedulePtrInput)(nil)).Elem(), ExportScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportScheduleResponseInput)(nil)).Elem(), ExportScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportScheduleResponsePtrInput)(nil)).Elem(), ExportScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryAggregationInput)(nil)).Elem(), QueryAggregationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryAggregationMapInput)(nil)).Elem(), QueryAggregationMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryAggregationResponseInput)(nil)).Elem(), QueryAggregationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryAggregationResponseMapInput)(nil)).Elem(), QueryAggregationResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryComparisonExpressionInput)(nil)).Elem(), QueryComparisonExpressionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryComparisonExpressionPtrInput)(nil)).Elem(), QueryComparisonExpressionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryComparisonExpressionResponseInput)(nil)).Elem(), QueryComparisonExpressionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryComparisonExpressionResponsePtrInput)(nil)).Elem(), QueryComparisonExpressionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryDatasetInput)(nil)).Elem(), QueryDatasetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryDatasetPtrInput)(nil)).Elem(), QueryDatasetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryDatasetConfigurationInput)(nil)).Elem(), QueryDatasetConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryDatasetConfigurationPtrInput)(nil)).Elem(), QueryDatasetConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryDatasetConfigurationResponseInput)(nil)).Elem(), QueryDatasetConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryDatasetConfigurationResponsePtrInput)(nil)).Elem(), QueryDatasetConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryDatasetResponseInput)(nil)).Elem(), QueryDatasetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryDatasetResponsePtrInput)(nil)).Elem(), QueryDatasetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryDefinitionInput)(nil)).Elem(), QueryDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryDefinitionPtrInput)(nil)).Elem(), QueryDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryDefinitionResponseInput)(nil)).Elem(), QueryDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryDefinitionResponsePtrInput)(nil)).Elem(), QueryDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryFilterInput)(nil)).Elem(), QueryFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryFilterPtrInput)(nil)).Elem(), QueryFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryFilterArrayInput)(nil)).Elem(), QueryFilterArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryFilterResponseInput)(nil)).Elem(), QueryFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryFilterResponsePtrInput)(nil)).Elem(), QueryFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryFilterResponseArrayInput)(nil)).Elem(), QueryFilterResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryGroupingInput)(nil)).Elem(), QueryGroupingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryGroupingArrayInput)(nil)).Elem(), QueryGroupingArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryGroupingResponseInput)(nil)).Elem(), QueryGroupingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryGroupingResponseArrayInput)(nil)).Elem(), QueryGroupingResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*QuerySortingConfigurationInput)(nil)).Elem(), QuerySortingConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QuerySortingConfigurationArrayInput)(nil)).Elem(), QuerySortingConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*QuerySortingConfigurationResponseInput)(nil)).Elem(), QuerySortingConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QuerySortingConfigurationResponseArrayInput)(nil)).Elem(), QuerySortingConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryTimePeriodInput)(nil)).Elem(), QueryTimePeriodArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryTimePeriodPtrInput)(nil)).Elem(), QueryTimePeriodArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryTimePeriodResponseInput)(nil)).Elem(), QueryTimePeriodResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryTimePeriodResponsePtrInput)(nil)).Elem(), QueryTimePeriodResponseArgs{})
