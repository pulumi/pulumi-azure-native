...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CommonExportPropertiesResponseInput)(nil)).Elem(), CommonExportPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CommonExportPropertiesResponsePtrInput)(nil)).Elem(), CommonExportPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ErrorDetailsResponseInput)(nil)).Elem(), ErrorDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ErrorDetailsResponsePtrInput)(nil)).Elem(), ErrorDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDatasetInput)(nil)).Elem(), ExportDatasetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDatasetPtrInput)(nil)).Elem(), ExportDatasetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDatasetConfigurationInput)(nil)).Elem(), ExportDatasetConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDatasetConfigurationPtrInput)(nil)).Elem(), ExportDatasetConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDatasetConfigurationResponseInput)(nil)).Elem(), ExportDatasetConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDatasetConfigurationResponsePtrInput)(nil)).Elem(), ExportDatasetConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDatasetResponseInput)(nil)).Elem(), ExportDatasetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDatasetResponsePtrInput)(nil)).Elem(), ExportDatasetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDefinitionInput)(nil)).Elem(), ExportDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDefinitionPtrInput)(nil)).Elem(), ExportDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDefinitionResponseInput)(nil)).Elem(), ExportDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDefinitionResponsePtrInput)(nil)).Elem(), ExportDefinitionResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ExportExecutionListResultResponseInput)(nil)).Elem(), ExportExecutionListResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportExecutionListResultResponsePtrInput)(nil)).Elem(), ExportExecutionListResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportExecutionResponseInput)(nil)).Elem(), ExportExecutionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportExecutionResponseArrayInput)(nil)).Elem(), ExportExecutionResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ExportTimePeriodInput)(nil)).Elem(), ExportTimePeriodArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportTimePeriodPtrInput)(nil)).Elem(), ExportTimePeriodArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportTimePeriodResponseInput)(nil)).Elem(), ExportTimePeriodResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportTimePeriodResponsePtrInput)(nil)).Elem(), ExportTimePeriodResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiPropertiesInput)(nil)).Elem(), KpiPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiPropertiesArrayInput)(nil)).Elem(), KpiPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiPropertiesResponseInput)(nil)).Elem(), KpiPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiPropertiesResponseArrayInput)(nil)).Elem(), KpiPropertiesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PivotPropertiesInput)(nil)).Elem(), PivotPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PivotPropertiesArrayInput)(nil)).Elem(), PivotPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PivotPropertiesResponseInput)(nil)).Elem(), PivotPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PivotPropertiesResponseArrayInput)(nil)).Elem(), PivotPropertiesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportAggregationInput)(nil)).Elem(), ReportAggregationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportAggregationMapInput)(nil)).Elem(), ReportAggregationMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportAggregationResponseInput)(nil)).Elem(), ReportAggregationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportAggregationResponseMapInput)(nil)).Elem(), ReportAggregationResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportComparisonExpressionInput)(nil)).Elem(), ReportComparisonExpressionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportComparisonExpressionPtrInput)(nil)).Elem(), ReportComparisonExpressionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportComparisonExpressionResponseInput)(nil)).Elem(), ReportComparisonExpressionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportComparisonExpressionResponsePtrInput)(nil)).Elem(), ReportComparisonExpressionResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReportConfigSortingInput)(nil)).Elem(), ReportConfigSortingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportConfigSortingArrayInput)(nil)).Elem(), ReportConfigSortingArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportConfigSortingResponseInput)(nil)).Elem(), ReportConfigSortingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportConfigSortingResponseArrayInput)(nil)).Elem(), ReportConfigSortingResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDatasetInput)(nil)).Elem(), ReportDatasetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDatasetPtrInput)(nil)).Elem(), ReportDatasetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDatasetConfigurationInput)(nil)).Elem(), ReportDatasetConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDatasetConfigurationPtrInput)(nil)).Elem(), ReportDatasetConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDatasetConfigurationResponseInput)(nil)).Elem(), ReportDatasetConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDatasetConfigurationResponsePtrInput)(nil)).Elem(), ReportDatasetConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDatasetResponseInput)(nil)).Elem(), ReportDatasetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDatasetResponsePtrInput)(nil)).Elem(), ReportDatasetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDefinitionInput)(nil)).Elem(), ReportDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDefinitionPtrInput)(nil)).Elem(), ReportDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDefinitionResponseInput)(nil)).Elem(), ReportDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDefinitionResponsePtrInput)(nil)).Elem(), ReportDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDeliveryDestinationInput)(nil)).Elem(), ReportDeliveryDestinationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDeliveryDestinationPtrInput)(nil)).Elem(), ReportDeliveryDestinationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDeliveryDestinationResponseInput)(nil)).Elem(), ReportDeliveryDestinationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDeliveryDestinationResponsePtrInput)(nil)).Elem(), ReportDeliveryDestinationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDeliveryInfoInput)(nil)).Elem(), ReportDeliveryInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDeliveryInfoPtrInput)(nil)).Elem(), ReportDeliveryInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDeliveryInfoResponseInput)(nil)).Elem(), ReportDeliveryInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportDeliveryInfoResponsePtrInput)(nil)).Elem(), ReportDeliveryInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportFilterInput)(nil)).Elem(), ReportFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportFilterPtrInput)(nil)).Elem(), ReportFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportFilterArrayInput)(nil)).Elem(), ReportFilterArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportFilterResponseInput)(nil)).Elem(), ReportFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportFilterResponsePtrInput)(nil)).Elem(), ReportFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportFilterResponseArrayInput)(nil)).Elem(), ReportFilterResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportGroupingInput)(nil)).Elem(), ReportGroupingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportGroupingArrayInput)(nil)).Elem(), ReportGroupingArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportGroupingResponseInput)(nil)).Elem(), ReportGroupingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportGroupingResponseArrayInput)(nil)).Elem(), ReportGroupingResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportRecurrencePeriodInput)(nil)).Elem(), ReportRecurrencePeriodArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportRecurrencePeriodPtrInput)(nil)).Elem(), ReportRecurrencePeriodArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportRecurrencePeriodResponseInput)(nil)).Elem(), ReportRecurrencePeriodResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportRecurrencePeriodResponsePtrInput)(nil)).Elem(), ReportRecurrencePeriodResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReportScheduleResponseInput)(nil)).Elem(), ReportScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportScheduleResponsePtrInput)(nil)).Elem(), ReportScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportTimePeriodInput)(nil)).Elem(), ReportTimePeriodArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportTimePeriodPtrInput)(nil)).Elem(), ReportTimePeriodArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportTimePeriodResponseInput)(nil)).Elem(), ReportTimePeriodResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportTimePeriodResponsePtrInput)(nil)).Elem(), ReportTimePeriodResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SettingsPropertiesCacheInput)(nil)).Elem(), SettingsPropertiesCacheArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SettingsPropertiesCacheArrayInput)(nil)).Elem(), SettingsPropertiesCacheArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SettingsPropertiesResponseCacheInput)(nil)).Elem(), SettingsPropertiesResponseCacheArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SettingsPropertiesResponseCacheArrayInput)(nil)).Elem(), SettingsPropertiesResponseCacheArray{})
