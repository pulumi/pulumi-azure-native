...
func NewSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:costmanagement/latest:Setting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSetting(ctx *pulumi.Context,
	...
	var resource Setting
	err := ctx.ReadResource("azure-native:costmanagement/latest:Setting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
