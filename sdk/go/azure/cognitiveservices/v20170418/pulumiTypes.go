...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CognitiveServicesAccountApiPropertiesInput)(nil)).Elem(), CognitiveServicesAccountApiPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CognitiveServicesAccountApiPropertiesPtrInput)(nil)).Elem(), CognitiveServicesAccountApiPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CognitiveServicesAccountApiPropertiesResponseInput)(nil)).Elem(), CognitiveServicesAccountApiPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CognitiveServicesAccountApiPropertiesResponsePtrInput)(nil)).Elem(), CognitiveServicesAccountApiPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CognitiveServicesAccountPropertiesInput)(nil)).Elem(), CognitiveServicesAccountPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CognitiveServicesAccountPropertiesPtrInput)(nil)).Elem(), CognitiveServicesAccountPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CognitiveServicesAccountPropertiesResponseInput)(nil)).Elem(), CognitiveServicesAccountPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CognitiveServicesAccountPropertiesResponsePtrInput)(nil)).Elem(), CognitiveServicesAccountPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CognitiveServicesAccountSkuChangeInfoResponseInput)(nil)).Elem(), CognitiveServicesAccountSkuChangeInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CognitiveServicesAccountSkuChangeInfoResponsePtrInput)(nil)).Elem(), CognitiveServicesAccountSkuChangeInfoResponseArgs{})
