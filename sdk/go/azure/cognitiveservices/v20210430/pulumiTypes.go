...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AccountPropertiesInput)(nil)).Elem(), AccountPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountPropertiesPtrInput)(nil)).Elem(), AccountPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountPropertiesResponseInput)(nil)).Elem(), AccountPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountPropertiesResponsePtrInput)(nil)).Elem(), AccountPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CallRateLimitResponseInput)(nil)).Elem(), CallRateLimitResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CallRateLimitResponsePtrInput)(nil)).Elem(), CallRateLimitResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*QuotaLimitResponsePtrInput)(nil)).Elem(), QuotaLimitResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestMatchPatternResponseInput)(nil)).Elem(), RequestMatchPatternResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestMatchPatternResponseArrayInput)(nil)).Elem(), RequestMatchPatternResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SkuChangeInfoResponseInput)(nil)).Elem(), SkuChangeInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SkuChangeInfoResponsePtrInput)(nil)).Elem(), SkuChangeInfoResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UserOwnedStorageInput)(nil)).Elem(), UserOwnedStorageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserOwnedStorageArrayInput)(nil)).Elem(), UserOwnedStorageArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserOwnedStorageResponseInput)(nil)).Elem(), UserOwnedStorageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserOwnedStorageResponseArrayInput)(nil)).Elem(), UserOwnedStorageResponseArray{})
