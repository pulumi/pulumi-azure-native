...
type JobDefinition struct {
	...
	CopyMode pulumi.StringPtrOutput `pulumi:"copyMode"`
...
// Strategy to use for copy.
func (o JobDefinitionOutput) CopyMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *JobDefinition) pulumi.StringPtrOutput { return v.CopyMode }).(pulumi.StringPtrOutput)
}
