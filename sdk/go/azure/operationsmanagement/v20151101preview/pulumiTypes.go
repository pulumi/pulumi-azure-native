...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ArmTemplateParameterInput)(nil)).Elem(), ArmTemplateParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmTemplateParameterArrayInput)(nil)).Elem(), ArmTemplateParameterArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmTemplateParameterResponseInput)(nil)).Elem(), ArmTemplateParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmTemplateParameterResponseArrayInput)(nil)).Elem(), ArmTemplateParameterResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementAssociationPropertiesInput)(nil)).Elem(), ManagementAssociationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementAssociationPropertiesPtrInput)(nil)).Elem(), ManagementAssociationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementAssociationPropertiesResponseInput)(nil)).Elem(), ManagementAssociationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementAssociationPropertiesResponsePtrInput)(nil)).Elem(), ManagementAssociationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementConfigurationPropertiesInput)(nil)).Elem(), ManagementConfigurationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementConfigurationPropertiesPtrInput)(nil)).Elem(), ManagementConfigurationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementConfigurationPropertiesResponseInput)(nil)).Elem(), ManagementConfigurationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementConfigurationPropertiesResponsePtrInput)(nil)).Elem(), ManagementConfigurationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SolutionPlanInput)(nil)).Elem(), SolutionPlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SolutionPlanPtrInput)(nil)).Elem(), SolutionPlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SolutionPlanResponseInput)(nil)).Elem(), SolutionPlanResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SolutionPlanResponsePtrInput)(nil)).Elem(), SolutionPlanResponseArgs{})
