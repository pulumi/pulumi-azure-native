...
func (o LookupDatabaseResultOutput) ReadReplicaCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LookupDatabaseResult) *int { return v.ReadReplicaCount }).(pulumi.IntPtrOutput)
}
