...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CreateModeInput)(nil)).Elem(), CreateMode("Copy"))
	pulumi.RegisterInputType(reflect.TypeOf((*CreateModePtrInput)(nil)).Elem(), CreateMode("Copy"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataMaskingStateInput)(nil)).Elem(), DataMaskingState("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataMaskingStatePtrInput)(nil)).Elem(), DataMaskingState("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseEditionInput)(nil)).Elem(), DatabaseEdition("Web"))
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseEditionPtrInput)(nil)).Elem(), DatabaseEdition("Web"))
	pulumi.RegisterInputType(reflect.TypeOf((*ElasticPoolEditionInput)(nil)).Elem(), ElasticPoolEdition("Basic"))
	pulumi.RegisterInputType(reflect.TypeOf((*ElasticPoolEditionPtrInput)(nil)).Elem(), ElasticPoolEdition("Basic"))
	pulumi.RegisterInputType(reflect.TypeOf((*GeoBackupPolicyStateEnumInput)(nil)).Elem(), GeoBackupPolicyStateEnum("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*GeoBackupPolicyStateEnumPtrInput)(nil)).Elem(), GeoBackupPolicyStateEnum("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReadScaleInput)(nil)).Elem(), ReadScale("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReadScalePtrInput)(nil)).Elem(), ReadScale("Enabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityAlertPolicyEmailAccountAdminsInput)(nil)).Elem(), SecurityAlertPolicyEmailAccountAdmins("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityAlertPolicyEmailAccountAdminsPtrInput)(nil)).Elem(), SecurityAlertPolicyEmailAccountAdmins("Enabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityAlertPolicyUseServerDefaultInput)(nil)).Elem(), SecurityAlertPolicyUseServerDefault("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityAlertPolicyUseServerDefaultPtrInput)(nil)).Elem(), SecurityAlertPolicyUseServerDefault("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServerVersionInput)(nil)).Elem(), ServerVersion("2.0"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServerVersionPtrInput)(nil)).Elem(), ServerVersion("2.0"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceObjectiveNameInput)(nil)).Elem(), ServiceObjectiveName("System"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceObjectiveNamePtrInput)(nil)).Elem(), ServiceObjectiveName("System"))
