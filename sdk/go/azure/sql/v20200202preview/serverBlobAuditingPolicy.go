...
func NewServerBlobAuditingPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:sql/v20210501preview:ServerBlobAuditingPolicy"),
		},
	})
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ServerBlobAuditingPolicyInput)(nil)).Elem(), &ServerBlobAuditingPolicy{})
