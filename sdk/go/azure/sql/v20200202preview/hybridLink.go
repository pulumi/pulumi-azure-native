...
func NewHybridLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:sql/v20200801preview:HybridLink"),
		},
	})
	opts = append(opts, aliases)
	var resource HybridLink
	err := ctx.RegisterResource("azure-nextgen:sql/v20200202preview:HybridLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridLink(ctx *pulumi.Context,
	...
	var resource HybridLink
	err := ctx.ReadResource("azure-nextgen:sql/v20200202preview:HybridLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
