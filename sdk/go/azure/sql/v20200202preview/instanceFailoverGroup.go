...
func NewInstanceFailoverGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:sql/v20200202preview:InstanceFailoverGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceFailoverGroup(ctx *pulumi.Context,
	...
	var resource InstanceFailoverGroup
	err := ctx.ReadResource("azure-nextgen:sql/v20200202preview:InstanceFailoverGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
