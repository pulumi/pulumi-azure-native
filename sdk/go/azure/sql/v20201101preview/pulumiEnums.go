...
func (RequestedBackupStorageRedundancy) ElementType() reflect.Type {
	return reflect.TypeOf((*RequestedBackupStorageRedundancy)(nil)).Elem()
}

func (e RequestedBackupStorageRedundancy) ToRequestedBackupStorageRedundancyOutput() RequestedBackupStorageRedundancyOutput {
	return pulumi.ToOutput(e).(RequestedBackupStorageRedundancyOutput)
}

func (e RequestedBackupStorageRedundancy) ToRequestedBackupStorageRedundancyOutputWithContext(ctx context.Context) RequestedBackupStorageRedundancyOutput {
	return pulumi.ToOutputWithContext(ctx, e).(RequestedBackupStorageRedundancyOutput)
}

func (e RequestedBackupStorageRedundancy) ToRequestedBackupStorageRedundancyPtrOutput() RequestedBackupStorageRedundancyPtrOutput {
	return e.ToRequestedBackupStorageRedundancyPtrOutputWithContext(context.Background())
}

func (e RequestedBackupStorageRedundancy) ToRequestedBackupStorageRedundancyPtrOutputWithContext(ctx context.Context) RequestedBackupStorageRedundancyPtrOutput {
	return RequestedBackupStorageRedundancy(e).ToRequestedBackupStorageRedundancyOutputWithContext(ctx).ToRequestedBackupStorageRedundancyPtrOutputWithContext(ctx)
}
...
type RequestedBackupStorageRedundancyOutput struct{ *pulumi.OutputState }

func (RequestedBackupStorageRedundancyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*RequestedBackupStorageRedundancy)(nil)).Elem()
}

func (o RequestedBackupStorageRedundancyOutput) ToRequestedBackupStorageRedundancyOutput() RequestedBackupStorageRedundancyOutput {
	return o
}

func (o RequestedBackupStorageRedundancyOutput) ToRequestedBackupStorageRedundancyOutputWithContext(ctx context.Context) RequestedBackupStorageRedundancyOutput {
	return o
}

func (o RequestedBackupStorageRedundancyOutput) ToRequestedBackupStorageRedundancyPtrOutput() RequestedBackupStorageRedundancyPtrOutput {
	return o.ToRequestedBackupStorageRedundancyPtrOutputWithContext(context.Background())
}

func (o RequestedBackupStorageRedundancyOutput) ToRequestedBackupStorageRedundancyPtrOutputWithContext(ctx context.Context) RequestedBackupStorageRedundancyPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v RequestedBackupStorageRedundancy) *RequestedBackupStorageRedundancy {
		return &v
	}).(RequestedBackupStorageRedundancyPtrOutput)
}

func (o RequestedBackupStorageRedundancyOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o RequestedBackupStorageRedundancyOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e RequestedBackupStorageRedundancy) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o RequestedBackupStorageRedundancyOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o RequestedBackupStorageRedundancyOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e RequestedBackupStorageRedundancy) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type RequestedBackupStorageRedundancyPtrOutput struct{ *pulumi.OutputState }

func (RequestedBackupStorageRedundancyPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**RequestedBackupStorageRedundancy)(nil)).Elem()
}

func (o RequestedBackupStorageRedundancyPtrOutput) ToRequestedBackupStorageRedundancyPtrOutput() RequestedBackupStorageRedundancyPtrOutput {
	return o
}

func (o RequestedBackupStorageRedundancyPtrOutput) ToRequestedBackupStorageRedundancyPtrOutputWithContext(ctx context.Context) RequestedBackupStorageRedundancyPtrOutput {
	return o
}

func (o RequestedBackupStorageRedundancyPtrOutput) Elem() RequestedBackupStorageRedundancyOutput {
	return o.ApplyT(func(v *RequestedBackupStorageRedundancy) RequestedBackupStorageRedundancy {
		if v != nil {
			return *v
		}
		var ret RequestedBackupStorageRedundancy
		return ret
	}).(RequestedBackupStorageRedundancyOutput)
}

func (o RequestedBackupStorageRedundancyPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o RequestedBackupStorageRedundancyPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *RequestedBackupStorageRedundancy) *string {
		if e == nil {
			return nil
		}
...
type RequestedBackupStorageRedundancyInput interface {
	pulumi.Input

	ToRequestedBackupStorageRedundancyOutput() RequestedBackupStorageRedundancyOutput
	ToRequestedBackupStorageRedundancyOutputWithContext(context.Context) RequestedBackupStorageRedundancyOutput
}

var requestedBackupStorageRedundancyPtrType = reflect.TypeOf((**RequestedBackupStorageRedundancy)(nil)).Elem()

type RequestedBackupStorageRedundancyPtrInput interface {
	pulumi.Input

	ToRequestedBackupStorageRedundancyPtrOutput() RequestedBackupStorageRedundancyPtrOutput
	ToRequestedBackupStorageRedundancyPtrOutputWithContext(context.Context) RequestedBackupStorageRedundancyPtrOutput
}

type requestedBackupStorageRedundancyPtr string

func RequestedBackupStorageRedundancyPtr(v string) RequestedBackupStorageRedundancyPtrInput {
	return (*requestedBackupStorageRedundancyPtr)(&v)
}

func (*requestedBackupStorageRedundancyPtr) ElementType() reflect.Type {
	return requestedBackupStorageRedundancyPtrType
}

func (in *requestedBackupStorageRedundancyPtr) ToRequestedBackupStorageRedundancyPtrOutput() RequestedBackupStorageRedundancyPtrOutput {
	return pulumi.ToOutput(in).(RequestedBackupStorageRedundancyPtrOutput)
}

func (in *requestedBackupStorageRedundancyPtr) ToRequestedBackupStorageRedundancyPtrOutputWithContext(ctx context.Context) RequestedBackupStorageRedundancyPtrOutput {
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AdministratorTypeInput)(nil)).Elem(), AdministratorType("ActiveDirectory"))
	pulumi.RegisterInputType(reflect.TypeOf((*AdministratorTypePtrInput)(nil)).Elem(), AdministratorType("ActiveDirectory"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutoExecuteStatusInput)(nil)).Elem(), AutoExecuteStatus("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutoExecuteStatusPtrInput)(nil)).Elem(), AutoExecuteStatus("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*BlobAuditingPolicyStateInput)(nil)).Elem(), BlobAuditingPolicyState("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*BlobAuditingPolicyStatePtrInput)(nil)).Elem(), BlobAuditingPolicyState("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*CatalogCollationTypeInput)(nil)).Elem(), CatalogCollationType("DATABASE_DEFAULT"))
	pulumi.RegisterInputType(reflect.TypeOf((*CatalogCollationTypePtrInput)(nil)).Elem(), CatalogCollationType("DATABASE_DEFAULT"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseLicenseTypeInput)(nil)).Elem(), DatabaseLicenseType("LicenseIncluded"))
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseLicenseTypePtrInput)(nil)).Elem(), DatabaseLicenseType("LicenseIncluded"))
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseReadScaleInput)(nil)).Elem(), DatabaseReadScale("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseReadScalePtrInput)(nil)).Elem(), DatabaseReadScale("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ElasticPoolLicenseTypeInput)(nil)).Elem(), ElasticPoolLicenseType("LicenseIncluded"))
	pulumi.RegisterInputType(reflect.TypeOf((*ElasticPoolLicenseTypePtrInput)(nil)).Elem(), ElasticPoolLicenseType("LicenseIncluded"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*InstancePoolLicenseTypeInput)(nil)).Elem(), InstancePoolLicenseType("LicenseIncluded"))
	pulumi.RegisterInputType(reflect.TypeOf((*InstancePoolLicenseTypePtrInput)(nil)).Elem(), InstancePoolLicenseType("LicenseIncluded"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobScheduleTypeInput)(nil)).Elem(), JobScheduleType("Once"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobScheduleTypePtrInput)(nil)).Elem(), JobScheduleType("Once"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobStepActionSourceInput)(nil)).Elem(), JobStepActionSource("Inline"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobStepActionSourcePtrInput)(nil)).Elem(), JobStepActionSource("Inline"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobStepActionTypeInput)(nil)).Elem(), JobStepActionType("TSql"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobStepActionTypePtrInput)(nil)).Elem(), JobStepActionType("TSql"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobStepOutputTypeEnumInput)(nil)).Elem(), JobStepOutputTypeEnum("SqlDatabase"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobStepOutputTypeEnumPtrInput)(nil)).Elem(), JobStepOutputTypeEnum("SqlDatabase"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobTargetGroupMembershipTypeInput)(nil)).Elem(), JobTargetGroupMembershipType("Include"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobTargetGroupMembershipTypePtrInput)(nil)).Elem(), JobTargetGroupMembershipType("Include"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobTargetTypeInput)(nil)).Elem(), JobTargetType("TargetGroup"))
	pulumi.RegisterInputType(reflect.TypeOf((*JobTargetTypePtrInput)(nil)).Elem(), JobTargetType("TargetGroup"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedDatabaseCreateModeInput)(nil)).Elem(), ManagedDatabaseCreateMode("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedDatabaseCreateModePtrInput)(nil)).Elem(), ManagedDatabaseCreateMode("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedInstanceAdministratorTypeInput)(nil)).Elem(), ManagedInstanceAdministratorType("ActiveDirectory"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedInstanceAdministratorTypePtrInput)(nil)).Elem(), ManagedInstanceAdministratorType("ActiveDirectory"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedInstanceLicenseTypeInput)(nil)).Elem(), ManagedInstanceLicenseType("LicenseIncluded"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedInstanceLicenseTypePtrInput)(nil)).Elem(), ManagedInstanceLicenseType("LicenseIncluded"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedInstanceProxyOverrideInput)(nil)).Elem(), ManagedInstanceProxyOverride("Proxy"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedInstanceProxyOverridePtrInput)(nil)).Elem(), ManagedInstanceProxyOverride("Proxy"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedServerCreateModeInput)(nil)).Elem(), ManagedServerCreateMode("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedServerCreateModePtrInput)(nil)).Elem(), ManagedServerCreateMode("Default"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkServiceConnectionStateStatusInput)(nil)).Elem(), PrivateLinkServiceConnectionStateStatus("Approved"))
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkServiceConnectionStateStatusPtrInput)(nil)).Elem(), PrivateLinkServiceConnectionStateStatus("Approved"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReadOnlyEndpointFailoverPolicyInput)(nil)).Elem(), ReadOnlyEndpointFailoverPolicy("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReadOnlyEndpointFailoverPolicyPtrInput)(nil)).Elem(), ReadOnlyEndpointFailoverPolicy("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReadWriteEndpointFailoverPolicyInput)(nil)).Elem(), ReadWriteEndpointFailoverPolicy("Manual"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReadWriteEndpointFailoverPolicyPtrInput)(nil)).Elem(), ReadWriteEndpointFailoverPolicy("Manual"))
	pulumi.RegisterInputType(reflect.TypeOf((*RequestedBackupStorageRedundancyInput)(nil)).Elem(), RequestedBackupStorageRedundancy("Geo"))
	pulumi.RegisterInputType(reflect.TypeOf((*RequestedBackupStorageRedundancyPtrInput)(nil)).Elem(), RequestedBackupStorageRedundancy("Geo"))
	pulumi.RegisterInputType(reflect.TypeOf((*SampleNameInput)(nil)).Elem(), SampleName("AdventureWorksLT"))
	pulumi.RegisterInputType(reflect.TypeOf((*SampleNamePtrInput)(nil)).Elem(), SampleName("AdventureWorksLT"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecondaryTypeInput)(nil)).Elem(), SecondaryType("Geo"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecondaryTypePtrInput)(nil)).Elem(), SecondaryType("Geo"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityAlertsPolicyStateInput)(nil)).Elem(), SecurityAlertsPolicyState("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityAlertsPolicyStatePtrInput)(nil)).Elem(), SecurityAlertsPolicyState("Enabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServerKeyTypeInput)(nil)).Elem(), ServerKeyType("ServiceManaged"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServerKeyTypePtrInput)(nil)).Elem(), ServerKeyType("ServiceManaged"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPublicNetworkAccessInput)(nil)).Elem(), ServerPublicNetworkAccess("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPublicNetworkAccessPtrInput)(nil)).Elem(), ServerPublicNetworkAccess("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountTypeInput)(nil)).Elem(), StorageAccountType("GRS"))
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountTypePtrInput)(nil)).Elem(), StorageAccountType("GRS"))
	pulumi.RegisterInputType(reflect.TypeOf((*SyncConflictResolutionPolicyInput)(nil)).Elem(), SyncConflictResolutionPolicy("HubWin"))
	pulumi.RegisterInputType(reflect.TypeOf((*SyncConflictResolutionPolicyPtrInput)(nil)).Elem(), SyncConflictResolutionPolicy("HubWin"))
	pulumi.RegisterInputType(reflect.TypeOf((*SyncDirectionInput)(nil)).Elem(), SyncDirection("Bidirectional"))
	pulumi.RegisterInputType(reflect.TypeOf((*SyncDirectionPtrInput)(nil)).Elem(), SyncDirection("Bidirectional"))
	pulumi.RegisterInputType(reflect.TypeOf((*SyncMemberDbTypeInput)(nil)).Elem(), SyncMemberDbType("AzureSqlDatabase"))
	pulumi.RegisterInputType(reflect.TypeOf((*SyncMemberDbTypePtrInput)(nil)).Elem(), SyncMemberDbType("AzureSqlDatabase"))
	pulumi.RegisterInputType(reflect.TypeOf((*TransparentDataEncryptionStateEnumInput)(nil)).Elem(), TransparentDataEncryptionStateEnum("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*TransparentDataEncryptionStateEnumPtrInput)(nil)).Elem(), TransparentDataEncryptionStateEnum("Enabled"))
