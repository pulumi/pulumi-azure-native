...
func NewManagedDatabaseSensitivityLabel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:sql/v20200801preview:ManagedDatabaseSensitivityLabel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedDatabaseSensitivityLabel(ctx *pulumi.Context,
	...
	var resource ManagedDatabaseSensitivityLabel
	err := ctx.ReadResource("azure-nextgen:sql/v20200801preview:ManagedDatabaseSensitivityLabel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
