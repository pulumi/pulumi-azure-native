...
func NewSyncMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:sql/v20200801preview:SyncMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncMember(ctx *pulumi.Context,
	...
	var resource SyncMember
	err := ctx.ReadResource("azure-nextgen:sql/v20200801preview:SyncMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
