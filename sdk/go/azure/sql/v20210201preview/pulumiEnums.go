...
// ServerNetworkAccessFlagInput is an input type that accepts ServerNetworkAccessFlagArgs and ServerNetworkAccessFlagOutput values.
// You can construct a concrete instance of `ServerNetworkAccessFlagInput` via:
//
//          ServerNetworkAccessFlagArgs{...}
