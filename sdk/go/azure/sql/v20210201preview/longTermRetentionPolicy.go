...
func NewLongTermRetentionPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:sql/v20210201preview:LongTermRetentionPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-nextgen:sql/v20210501preview:LongTermRetentionPolicy"),
		},
	})
	opts = append(opts, aliases)
	var resource LongTermRetentionPolicy
	err := ctx.RegisterResource("azure-native:sql/v20210201preview:LongTermRetentionPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLongTermRetentionPolicy(ctx *pulumi.Context,
	...
	var resource LongTermRetentionPolicy
	err := ctx.ReadResource("azure-native:sql/v20210201preview:LongTermRetentionPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*LongTermRetentionPolicyInput)(nil)).Elem(), &LongTermRetentionPolicy{})
