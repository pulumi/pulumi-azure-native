...
func NewManagedInstancePrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:sql/v20210201preview:ManagedInstancePrivateEndpointConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-nextgen:sql/v20201101preview:ManagedInstancePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20210501preview:ManagedInstancePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-nextgen:sql/v20210501preview:ManagedInstancePrivateEndpointConnection"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagedInstancePrivateEndpointConnection
	err := ctx.RegisterResource("azure-native:sql/v20210201preview:ManagedInstancePrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstancePrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource ManagedInstancePrivateEndpointConnection
	err := ctx.ReadResource("azure-native:sql/v20210201preview:ManagedInstancePrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedInstancePrivateEndpointConnectionInput)(nil)).Elem(), &ManagedInstancePrivateEndpointConnection{})
