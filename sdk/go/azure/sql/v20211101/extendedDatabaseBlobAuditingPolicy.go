...
func NewExtendedDatabaseBlobAuditingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20211101:ExtendedDatabaseBlobAuditingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExtendedDatabaseBlobAuditingPolicy(ctx *pulumi.Context,
	...
	var resource ExtendedDatabaseBlobAuditingPolicy
	err := ctx.ReadResource("azure-native:sql/v20211101:ExtendedDatabaseBlobAuditingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
