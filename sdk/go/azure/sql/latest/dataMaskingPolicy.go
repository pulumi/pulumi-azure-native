...
func NewDataMaskingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/latest:DataMaskingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataMaskingPolicy(ctx *pulumi.Context,
	...
	var resource DataMaskingPolicy
	err := ctx.ReadResource("azure-native:sql/latest:DataMaskingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
