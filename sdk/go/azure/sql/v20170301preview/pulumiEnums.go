...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityAlertPolicyStateInput)(nil)).Elem(), SecurityAlertPolicyState("New"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityAlertPolicyStatePtrInput)(nil)).Elem(), SecurityAlertPolicyState("New"))
