...
func NewManagedInstanceAdministrator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:sql/v20210501preview:ManagedInstanceAdministrator"),
		},
		{
		...
		{
			Type: pulumi.String("azure-nextgen:sql/v20210201preview:ManagedInstanceAdministrator"),
		},
	})
	opts = append(opts, aliases)
	var resource ManagedInstanceAdministrator
	err := ctx.RegisterResource("azure-native:sql/v20210501preview:ManagedInstanceAdministrator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstanceAdministrator(ctx *pulumi.Context,
	...
	var resource ManagedInstanceAdministrator
	err := ctx.ReadResource("azure-native:sql/v20210501preview:ManagedInstanceAdministrator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
