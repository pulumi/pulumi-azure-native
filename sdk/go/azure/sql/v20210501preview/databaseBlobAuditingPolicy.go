...
func NewDatabaseBlobAuditingPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:sql/v20210501preview:DatabaseBlobAuditingPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-nextgen:sql/v20210201preview:DatabaseBlobAuditingPolicy"),
		},
	})
	opts = append(opts, aliases)
	var resource DatabaseBlobAuditingPolicy
	err := ctx.RegisterResource("azure-native:sql/v20210501preview:DatabaseBlobAuditingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseBlobAuditingPolicy(ctx *pulumi.Context,
	...
	var resource DatabaseBlobAuditingPolicy
	err := ctx.ReadResource("azure-native:sql/v20210501preview:DatabaseBlobAuditingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseBlobAuditingPolicyInput)(nil)).Elem(), &DatabaseBlobAuditingPolicy{})
