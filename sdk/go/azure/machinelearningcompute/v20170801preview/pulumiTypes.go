...
func (o AppInsightsPropertiesResponseOutput) ToAppInsightsPropertiesResponsePtrOutputWithContext(ctx context.Context) AppInsightsPropertiesResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v AppInsightsPropertiesResponse) *AppInsightsPropertiesResponse {
		return &v
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AcsClusterPropertiesInput)(nil)).Elem(), AcsClusterPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AcsClusterPropertiesPtrInput)(nil)).Elem(), AcsClusterPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AcsClusterPropertiesResponseInput)(nil)).Elem(), AcsClusterPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AcsClusterPropertiesResponsePtrInput)(nil)).Elem(), AcsClusterPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AppInsightsCredentialsResponseInput)(nil)).Elem(), AppInsightsCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AppInsightsCredentialsResponsePtrInput)(nil)).Elem(), AppInsightsCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AppInsightsPropertiesInput)(nil)).Elem(), AppInsightsPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AppInsightsPropertiesPtrInput)(nil)).Elem(), AppInsightsPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AppInsightsPropertiesResponseInput)(nil)).Elem(), AppInsightsPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AppInsightsPropertiesResponsePtrInput)(nil)).Elem(), AppInsightsPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScaleConfigurationInput)(nil)).Elem(), AutoScaleConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScaleConfigurationPtrInput)(nil)).Elem(), AutoScaleConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScaleConfigurationResponseInput)(nil)).Elem(), AutoScaleConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScaleConfigurationResponsePtrInput)(nil)).Elem(), AutoScaleConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerRegistryCredentialsResponseInput)(nil)).Elem(), ContainerRegistryCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerRegistryCredentialsResponsePtrInput)(nil)).Elem(), ContainerRegistryCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerRegistryPropertiesInput)(nil)).Elem(), ContainerRegistryPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerRegistryPropertiesPtrInput)(nil)).Elem(), ContainerRegistryPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerRegistryPropertiesResponseInput)(nil)).Elem(), ContainerRegistryPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerRegistryPropertiesResponsePtrInput)(nil)).Elem(), ContainerRegistryPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceCredentialsResponseInput)(nil)).Elem(), ContainerServiceCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerServiceCredentialsResponsePtrInput)(nil)).Elem(), ContainerServiceCredentialsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ErrorResponseWrapperResponseInput)(nil)).Elem(), ErrorResponseWrapperResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ErrorResponseWrapperResponseArrayInput)(nil)).Elem(), ErrorResponseWrapperResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GlobalServiceConfigurationInput)(nil)).Elem(), GlobalServiceConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GlobalServiceConfigurationPtrInput)(nil)).Elem(), GlobalServiceConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GlobalServiceConfigurationResponseInput)(nil)).Elem(), GlobalServiceConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GlobalServiceConfigurationResponsePtrInput)(nil)).Elem(), GlobalServiceConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesClusterPropertiesInput)(nil)).Elem(), KubernetesClusterPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesClusterPropertiesPtrInput)(nil)).Elem(), KubernetesClusterPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesClusterPropertiesResponseInput)(nil)).Elem(), KubernetesClusterPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesClusterPropertiesResponsePtrInput)(nil)).Elem(), KubernetesClusterPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAuthConfigurationInput)(nil)).Elem(), ServiceAuthConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAuthConfigurationPtrInput)(nil)).Elem(), ServiceAuthConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAuthConfigurationResponseInput)(nil)).Elem(), ServiceAuthConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAuthConfigurationResponsePtrInput)(nil)).Elem(), ServiceAuthConfigurationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountCredentialsResponseInput)(nil)).Elem(), StorageAccountCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountCredentialsResponsePtrInput)(nil)).Elem(), StorageAccountCredentialsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SystemServiceInput)(nil)).Elem(), SystemServiceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SystemServiceArrayInput)(nil)).Elem(), SystemServiceArray{})
