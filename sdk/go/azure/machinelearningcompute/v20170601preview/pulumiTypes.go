...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AppInsightsCredentialsInput)(nil)).Elem(), AppInsightsCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AppInsightsCredentialsPtrInput)(nil)).Elem(), AppInsightsCredentialsArgs{})
