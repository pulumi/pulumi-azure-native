...
func NewOperationalizationCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:machinelearningcompute:OperationalizationCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOperationalizationCluster(ctx *pulumi.Context,
	...
	var resource OperationalizationCluster
	err := ctx.ReadResource("azure-nextgen:machinelearningcompute:OperationalizationCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
