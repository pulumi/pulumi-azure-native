...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BlobStorageEventTypeInput)(nil)).Elem(), BlobStorageEventType("Microsoft.Storage.BlobCreated"))
	pulumi.RegisterInputType(reflect.TypeOf((*BlobStorageEventTypePtrInput)(nil)).Elem(), BlobStorageEventType("Microsoft.Storage.BlobCreated"))
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterPrincipalRoleInput)(nil)).Elem(), ClusterPrincipalRole("AllDatabasesAdmin"))
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterPrincipalRolePtrInput)(nil)).Elem(), ClusterPrincipalRole("AllDatabasesAdmin"))
	pulumi.RegisterInputType(reflect.TypeOf((*CompressionInput)(nil)).Elem(), Compression("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*CompressionPtrInput)(nil)).Elem(), Compression("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataConnectionKindInput)(nil)).Elem(), DataConnectionKind("EventHub"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataConnectionKindPtrInput)(nil)).Elem(), DataConnectionKind("EventHub"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DatabasePrincipalRoleInput)(nil)).Elem(), DatabasePrincipalRole("Admin"))
	pulumi.RegisterInputType(reflect.TypeOf((*DatabasePrincipalRolePtrInput)(nil)).Elem(), DatabasePrincipalRole("Admin"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EngineTypeInput)(nil)).Elem(), EngineType("V2"))
	pulumi.RegisterInputType(reflect.TypeOf((*EngineTypePtrInput)(nil)).Elem(), EngineType("V2"))
	pulumi.RegisterInputType(reflect.TypeOf((*EventGridDataFormatInput)(nil)).Elem(), EventGridDataFormat("MULTIJSON"))
	pulumi.RegisterInputType(reflect.TypeOf((*EventGridDataFormatPtrInput)(nil)).Elem(), EventGridDataFormat("MULTIJSON"))
	pulumi.RegisterInputType(reflect.TypeOf((*EventHubDataFormatInput)(nil)).Elem(), EventHubDataFormat("MULTIJSON"))
	pulumi.RegisterInputType(reflect.TypeOf((*EventHubDataFormatPtrInput)(nil)).Elem(), EventHubDataFormat("MULTIJSON"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubDataFormatInput)(nil)).Elem(), IotHubDataFormat("MULTIJSON"))
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubDataFormatPtrInput)(nil)).Elem(), IotHubDataFormat("MULTIJSON"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PrincipalTypeInput)(nil)).Elem(), PrincipalType("App"))
	pulumi.RegisterInputType(reflect.TypeOf((*PrincipalTypePtrInput)(nil)).Elem(), PrincipalType("App"))
