...
type AcceptedAudiencesResponseInput interface {
	pulumi.Input

	ToAcceptedAudiencesResponseOutput() AcceptedAudiencesResponseOutput
	ToAcceptedAudiencesResponseOutputWithContext(context.Context) AcceptedAudiencesResponseOutput
}

type AcceptedAudiencesResponseArgs struct {
	Value pulumi.StringPtrInput `pulumi:"value"`
}

func (AcceptedAudiencesResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*AcceptedAudiencesResponse)(nil)).Elem()
}

func (i AcceptedAudiencesResponseArgs) ToAcceptedAudiencesResponseOutput() AcceptedAudiencesResponseOutput {
	return i.ToAcceptedAudiencesResponseOutputWithContext(context.Background())
}

func (i AcceptedAudiencesResponseArgs) ToAcceptedAudiencesResponseOutputWithContext(ctx context.Context) AcceptedAudiencesResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AcceptedAudiencesResponseOutput)
}
...
type AcceptedAudiencesResponseArrayInput interface {
	pulumi.Input

	ToAcceptedAudiencesResponseArrayOutput() AcceptedAudiencesResponseArrayOutput
	ToAcceptedAudiencesResponseArrayOutputWithContext(context.Context) AcceptedAudiencesResponseArrayOutput
}

type AcceptedAudiencesResponseArray []AcceptedAudiencesResponseInput

func (AcceptedAudiencesResponseArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]AcceptedAudiencesResponse)(nil)).Elem()
}

func (i AcceptedAudiencesResponseArray) ToAcceptedAudiencesResponseArrayOutput() AcceptedAudiencesResponseArrayOutput {
	return i.ToAcceptedAudiencesResponseArrayOutputWithContext(context.Background())
}

func (i AcceptedAudiencesResponseArray) ToAcceptedAudiencesResponseArrayOutputWithContext(ctx context.Context) AcceptedAudiencesResponseArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AcceptedAudiencesResponseArrayOutput)
}
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AcceptedAudiencesInput)(nil)).Elem(), AcceptedAudiencesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AcceptedAudiencesArrayInput)(nil)).Elem(), AcceptedAudiencesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AcceptedAudiencesResponseInput)(nil)).Elem(), AcceptedAudiencesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AcceptedAudiencesResponseArrayInput)(nil)).Elem(), AcceptedAudiencesResponseArray{})
