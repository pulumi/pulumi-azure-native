...
// ClusterNetworkAccessFlagInput is an input type that accepts ClusterNetworkAccessFlagArgs and ClusterNetworkAccessFlagOutput values.
// You can construct a concrete instance of `ClusterNetworkAccessFlagInput` via:
//
//          ClusterNetworkAccessFlagArgs{...}
