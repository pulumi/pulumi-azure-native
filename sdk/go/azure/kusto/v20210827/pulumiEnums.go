...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterNetworkAccessFlagInput)(nil)).Elem(), ClusterNetworkAccessFlag("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterNetworkAccessFlagPtrInput)(nil)).Elem(), ClusterNetworkAccessFlag("Enabled"))
