...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LanguageExtensionNameInput)(nil)).Elem(), LanguageExtensionName("PYTHON"))
	pulumi.RegisterInputType(reflect.TypeOf((*LanguageExtensionNamePtrInput)(nil)).Elem(), LanguageExtensionName("PYTHON"))
