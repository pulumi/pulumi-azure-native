...
func NewReadOnlyFollowingDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20200215:ReadOnlyFollowingDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReadOnlyFollowingDatabase(ctx *pulumi.Context,
	...
	var resource ReadOnlyFollowingDatabase
	err := ctx.ReadResource("azure-native:kusto/v20200215:ReadOnlyFollowingDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
