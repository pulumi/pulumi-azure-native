...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*FollowerDatabaseDefinitionResponseInput)(nil)).Elem(), FollowerDatabaseDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FollowerDatabaseDefinitionResponseArrayInput)(nil)).Elem(), FollowerDatabaseDefinitionResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LanguageExtensionInput)(nil)).Elem(), LanguageExtensionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LanguageExtensionArrayInput)(nil)).Elem(), LanguageExtensionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*LanguageExtensionResponseInput)(nil)).Elem(), LanguageExtensionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LanguageExtensionResponseArrayInput)(nil)).Elem(), LanguageExtensionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*LanguageExtensionsListInput)(nil)).Elem(), LanguageExtensionsListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LanguageExtensionsListPtrInput)(nil)).Elem(), LanguageExtensionsListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LanguageExtensionsListResponseInput)(nil)).Elem(), LanguageExtensionsListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LanguageExtensionsListResponsePtrInput)(nil)).Elem(), LanguageExtensionsListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OptimizedAutoscaleInput)(nil)).Elem(), OptimizedAutoscaleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OptimizedAutoscalePtrInput)(nil)).Elem(), OptimizedAutoscaleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OptimizedAutoscaleResponseInput)(nil)).Elem(), OptimizedAutoscaleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OptimizedAutoscaleResponsePtrInput)(nil)).Elem(), OptimizedAutoscaleResponseArgs{})
