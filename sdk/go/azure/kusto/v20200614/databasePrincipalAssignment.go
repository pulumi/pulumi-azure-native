...
func NewDatabasePrincipalAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:kusto/v20200614:DatabasePrincipalAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabasePrincipalAssignment(ctx *pulumi.Context,
	...
	var resource DatabasePrincipalAssignment
	err := ctx.ReadResource("azure-nextgen:kusto/v20200614:DatabasePrincipalAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
