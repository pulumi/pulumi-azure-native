...
func LookupReadWriteDatabase(ctx *pulumi.Context, args *LookupReadWriteDatabaseArgs, opts ...pulumi.InvokeOption) (*LookupReadWriteDatabaseResult, error) {
	...
	err := ctx.Invoke("azure-native:kusto/v20191109:getReadWriteDatabase", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupReadWriteDatabaseResult struct {
	...
	Id                string                     `pulumi:"id"`
	IsFollowed        string                     `pulumi:"isFollowed"`
...
func (o LookupReadWriteDatabaseResultOutput) IsFollowed() pulumi.StringOutput {
	return o.ApplyT(func(v LookupReadWriteDatabaseResult) string { return v.IsFollowed }).(pulumi.StringOutput)
}
