...
func NewDataConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:kusto/v20191109:DataConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataConnection(ctx *pulumi.Context,
	...
	var resource DataConnection
	err := ctx.ReadResource("azure-nextgen:kusto/v20191109:DataConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
