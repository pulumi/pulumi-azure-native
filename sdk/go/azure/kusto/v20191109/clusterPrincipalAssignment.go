...
func NewClusterPrincipalAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:kusto/v20191109:ClusterPrincipalAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterPrincipalAssignment(ctx *pulumi.Context,
	...
	var resource ClusterPrincipalAssignment
	err := ctx.ReadResource("azure-nextgen:kusto/v20191109:ClusterPrincipalAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
