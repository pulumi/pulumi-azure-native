...
// UpdateTriggerPayloadTypeInput is an input type that accepts UpdateTriggerPayloadTypeArgs and UpdateTriggerPayloadTypeOutput values.
// You can construct a concrete instance of `UpdateTriggerPayloadTypeInput` via:
//
