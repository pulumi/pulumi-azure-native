...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveDirectoryObjectInput)(nil)).Elem(), ActiveDirectoryObjectArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveDirectoryObjectPtrInput)(nil)).Elem(), ActiveDirectoryObjectArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveDirectoryObjectResponseInput)(nil)).Elem(), ActiveDirectoryObjectResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveDirectoryObjectResponsePtrInput)(nil)).Elem(), ActiveDirectoryObjectResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TokenCertificateInput)(nil)).Elem(), TokenCertificateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TokenCertificateArrayInput)(nil)).Elem(), TokenCertificateArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TokenCertificateResponseInput)(nil)).Elem(), TokenCertificateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TokenCertificateResponseArrayInput)(nil)).Elem(), TokenCertificateResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TokenCredentialsPropertiesInput)(nil)).Elem(), TokenCredentialsPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TokenCredentialsPropertiesPtrInput)(nil)).Elem(), TokenCredentialsPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TokenCredentialsPropertiesResponseInput)(nil)).Elem(), TokenCredentialsPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TokenCredentialsPropertiesResponsePtrInput)(nil)).Elem(), TokenCredentialsPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TokenPasswordInput)(nil)).Elem(), TokenPasswordArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TokenPasswordArrayInput)(nil)).Elem(), TokenPasswordArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TokenPasswordResponseInput)(nil)).Elem(), TokenPasswordResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TokenPasswordResponseArrayInput)(nil)).Elem(), TokenPasswordResponseArray{})
