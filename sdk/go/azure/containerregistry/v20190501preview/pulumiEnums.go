...
// TokenCertificateNameInput is an input type that accepts TokenCertificateNameArgs and TokenCertificateNameOutput values.
// You can construct a concrete instance of `TokenCertificateNameInput` via:
//
//          TokenCertificateNameArgs{...}
...
// TokenPasswordNameInput is an input type that accepts TokenPasswordNameArgs and TokenPasswordNameOutput values.
// You can construct a concrete instance of `TokenPasswordNameInput` via:
//
//          TokenPasswordNameArgs{...}
...
// TokenStatusInput is an input type that accepts TokenStatusArgs and TokenStatusOutput values.
// You can construct a concrete instance of `TokenStatusInput` via:
//
//          TokenStatusArgs{...}
