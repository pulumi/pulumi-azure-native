...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DockerBuildStepInput)(nil)).Elem(), DockerBuildStepArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DockerBuildStepResponseInput)(nil)).Elem(), DockerBuildStepResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncodedTaskStepInput)(nil)).Elem(), EncodedTaskStepArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncodedTaskStepResponseInput)(nil)).Elem(), EncodedTaskStepResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FileTaskStepInput)(nil)).Elem(), FileTaskStepArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SetValueInput)(nil)).Elem(), SetValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SetValueArrayInput)(nil)).Elem(), SetValueArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TimerTriggerInput)(nil)).Elem(), TimerTriggerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TimerTriggerArrayInput)(nil)).Elem(), TimerTriggerArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TimerTriggerResponseInput)(nil)).Elem(), TimerTriggerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TimerTriggerResponseArrayInput)(nil)).Elem(), TimerTriggerResponseArray{})
