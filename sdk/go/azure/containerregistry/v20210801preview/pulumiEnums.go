...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectedRegistryModeInput)(nil)).Elem(), ConnectedRegistryMode("ReadWrite"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectedRegistryModePtrInput)(nil)).Elem(), ConnectedRegistryMode("ReadWrite"))
