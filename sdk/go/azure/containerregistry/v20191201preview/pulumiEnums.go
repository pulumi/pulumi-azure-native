...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerStatusInput)(nil)).Elem(), TriggerStatus("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerStatusPtrInput)(nil)).Elem(), TriggerStatus("Enabled"))
