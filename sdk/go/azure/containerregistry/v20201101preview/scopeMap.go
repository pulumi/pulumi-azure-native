...
func NewScopeMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:containerregistry/v20201101preview:ScopeMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopeMap(ctx *pulumi.Context,
	...
	var resource ScopeMap
	err := ctx.ReadResource("azure-nextgen:containerregistry/v20201101preview:ScopeMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
