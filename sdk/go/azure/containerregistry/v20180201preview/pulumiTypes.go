...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BuildArgumentResponseInput)(nil)).Elem(), BuildArgumentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BuildArgumentResponseArrayInput)(nil)).Elem(), BuildArgumentResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DockerBuildStepResponseInput)(nil)).Elem(), DockerBuildStepResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DockerBuildStepResponsePtrInput)(nil)).Elem(), DockerBuildStepResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SourceControlAuthInfoInput)(nil)).Elem(), SourceControlAuthInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceControlAuthInfoPtrInput)(nil)).Elem(), SourceControlAuthInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceControlAuthInfoResponseInput)(nil)).Elem(), SourceControlAuthInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceControlAuthInfoResponsePtrInput)(nil)).Elem(), SourceControlAuthInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceRepositoryPropertiesInput)(nil)).Elem(), SourceRepositoryPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceRepositoryPropertiesPtrInput)(nil)).Elem(), SourceRepositoryPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceRepositoryPropertiesResponseInput)(nil)).Elem(), SourceRepositoryPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceRepositoryPropertiesResponsePtrInput)(nil)).Elem(), SourceRepositoryPropertiesResponseArgs{})
