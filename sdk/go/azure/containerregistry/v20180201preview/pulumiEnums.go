...
// BuildTaskStatusInput is an input type that accepts BuildTaskStatusArgs and BuildTaskStatusOutput values.
// You can construct a concrete instance of `BuildTaskStatusInput` via:
//
//          BuildTaskStatusArgs{...}
