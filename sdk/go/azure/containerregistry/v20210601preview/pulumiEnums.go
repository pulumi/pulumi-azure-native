...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ExportPolicyStatusInput)(nil)).Elem(), ExportPolicyStatus("enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ExportPolicyStatusPtrInput)(nil)).Elem(), ExportPolicyStatus("enabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ZoneRedundancyInput)(nil)).Elem(), ZoneRedundancy("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ZoneRedundancyPtrInput)(nil)).Elem(), ZoneRedundancy("Enabled"))
