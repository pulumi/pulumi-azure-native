...
func NewGuestConfigurationHCRPAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:hybridcompute/latest:GuestConfigurationHCRPAssignment"),
		},
		{
	...
	err := ctx.RegisterResource("azure-nextgen:hybridcompute/v20200625:GuestConfigurationHCRPAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestConfigurationHCRPAssignment(ctx *pulumi.Context,
	...
	var resource GuestConfigurationHCRPAssignment
	err := ctx.ReadResource("azure-nextgen:hybridcompute/v20200625:GuestConfigurationHCRPAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
