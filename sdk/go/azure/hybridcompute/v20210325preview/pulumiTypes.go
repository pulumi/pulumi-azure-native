...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HybridComputePrivateLinkScopePropertiesInput)(nil)).Elem(), HybridComputePrivateLinkScopePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HybridComputePrivateLinkScopePropertiesPtrInput)(nil)).Elem(), HybridComputePrivateLinkScopePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HybridComputePrivateLinkScopePropertiesResponseInput)(nil)).Elem(), HybridComputePrivateLinkScopePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HybridComputePrivateLinkScopePropertiesResponsePtrInput)(nil)).Elem(), HybridComputePrivateLinkScopePropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LocationDataInput)(nil)).Elem(), LocationDataArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LocationDataPtrInput)(nil)).Elem(), LocationDataArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LocationDataResponseInput)(nil)).Elem(), LocationDataResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LocationDataResponsePtrInput)(nil)).Elem(), LocationDataResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MachineExtensionPropertiesInput)(nil)).Elem(), MachineExtensionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachineExtensionPropertiesPtrInput)(nil)).Elem(), MachineExtensionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachineExtensionPropertiesResponseInput)(nil)).Elem(), MachineExtensionPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachineExtensionPropertiesResponsePtrInput)(nil)).Elem(), MachineExtensionPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachinePropertiesInput)(nil)).Elem(), MachinePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachinePropertiesPtrInput)(nil)).Elem(), MachinePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachinePropertiesResponseInput)(nil)).Elem(), MachinePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachinePropertiesResponsePtrInput)(nil)).Elem(), MachinePropertiesResponseArgs{})
