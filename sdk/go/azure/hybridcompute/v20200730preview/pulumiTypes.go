...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MachineExtensionPropertiesInstanceViewInput)(nil)).Elem(), MachineExtensionPropertiesInstanceViewArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachineExtensionPropertiesInstanceViewPtrInput)(nil)).Elem(), MachineExtensionPropertiesInstanceViewArgs{})
