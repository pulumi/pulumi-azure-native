...
// The machine extension name.
func (o MachineExtensionInstanceViewInvokeResponseOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v MachineExtensionInstanceViewInvokeResponse) string { return v.Name }).(pulumi.StringOutput)
}
...
// Specifies the type of the extension; an example is "CustomScriptExtension".
func (o MachineExtensionInstanceViewInvokeResponseOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v MachineExtensionInstanceViewInvokeResponse) string { return v.Type }).(pulumi.StringOutput)
}

// Specifies the version of the script handler.
func (o MachineExtensionInstanceViewInvokeResponseOutput) TypeHandlerVersion() pulumi.StringOutput {
	return o.ApplyT(func(v MachineExtensionInstanceViewInvokeResponse) string { return v.TypeHandlerVersion }).(pulumi.StringOutput)
}
...
// The status code.
func (o MachineExtensionInstanceViewInvokeResponseStatusOutput) Code() pulumi.StringOutput {
	return o.ApplyT(func(v MachineExtensionInstanceViewInvokeResponseStatus) string { return v.Code }).(pulumi.StringOutput)
}

// The short localizable label for the status.
func (o MachineExtensionInstanceViewInvokeResponseStatusOutput) DisplayStatus() pulumi.StringOutput {
	return o.ApplyT(func(v MachineExtensionInstanceViewInvokeResponseStatus) string { return v.DisplayStatus }).(pulumi.StringOutput)
}

// The level code.
func (o MachineExtensionInstanceViewInvokeResponseStatusOutput) Level() pulumi.StringOutput {
	return o.ApplyT(func(v MachineExtensionInstanceViewInvokeResponseStatus) string { return v.Level }).(pulumi.StringOutput)
}

// The detailed status message, including for alerts and error messages.
func (o MachineExtensionInstanceViewInvokeResponseStatusOutput) Message() pulumi.StringOutput {
	return o.ApplyT(func(v MachineExtensionInstanceViewInvokeResponseStatus) string { return v.Message }).(pulumi.StringOutput)
}

// The time of the status.
func (o MachineExtensionInstanceViewInvokeResponseStatusOutput) Time() pulumi.StringOutput {
	return o.ApplyT(func(v MachineExtensionInstanceViewInvokeResponseStatus) string { return v.Time }).(pulumi.StringOutput)
}
...
// The machine extension name.
func (o MachineExtensionPropertiesInvokeResponseInstanceViewOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v MachineExtensionPropertiesInvokeResponseInstanceView) string { return v.Name }).(pulumi.StringOutput)
}
...
// Specifies the type of the extension; an example is "CustomScriptExtension".
func (o MachineExtensionPropertiesInvokeResponseInstanceViewOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v MachineExtensionPropertiesInvokeResponseInstanceView) string { return v.Type }).(pulumi.StringOutput)
}

// Specifies the version of the script handler.
func (o MachineExtensionPropertiesInvokeResponseInstanceViewOutput) TypeHandlerVersion() pulumi.StringOutput {
	return o.ApplyT(func(v MachineExtensionPropertiesInvokeResponseInstanceView) string { return v.TypeHandlerVersion }).(pulumi.StringOutput)
}
