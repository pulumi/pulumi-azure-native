...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MachineIdentityInput)(nil)).Elem(), MachineIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachineIdentityPtrInput)(nil)).Elem(), MachineIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachinePropertiesResponseOsProfileInput)(nil)).Elem(), MachinePropertiesResponseOsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachinePropertiesResponseOsProfilePtrInput)(nil)).Elem(), MachinePropertiesResponseOsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachineResponseIdentityInput)(nil)).Elem(), MachineResponseIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MachineResponseIdentityPtrInput)(nil)).Elem(), MachineResponseIdentityArgs{})
