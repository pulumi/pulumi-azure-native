...
func NewMachineExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20190802preview:MachineExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineExtension(ctx *pulumi.Context,
	...
	var resource MachineExtension
	err := ctx.ReadResource("azure-native:hybridcompute/v20190802preview:MachineExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o MachineExtensionOutput) PrincipalId() pulumi.StringOutput {
	return o.ApplyT(func(v *MachineExtension) pulumi.StringOutput { return v.PrincipalId }).(pulumi.StringOutput)
}
...
func (o MachineExtensionOutput) TenantId() pulumi.StringOutput {
	return o.ApplyT(func(v *MachineExtension) pulumi.StringOutput { return v.TenantId }).(pulumi.StringOutput)
}
