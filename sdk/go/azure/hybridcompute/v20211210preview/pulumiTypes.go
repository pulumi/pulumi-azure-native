...
type AgentConfigurationResponsePtrOutput struct{ *pulumi.OutputState }

func (AgentConfigurationResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**AgentConfigurationResponse)(nil)).Elem()
}

func (o AgentConfigurationResponsePtrOutput) ToAgentConfigurationResponsePtrOutput() AgentConfigurationResponsePtrOutput {
	return o
}

func (o AgentConfigurationResponsePtrOutput) ToAgentConfigurationResponsePtrOutputWithContext(ctx context.Context) AgentConfigurationResponsePtrOutput {
	return o
}

func (o AgentConfigurationResponsePtrOutput) Elem() AgentConfigurationResponseOutput {
	return o.ApplyT(func(v *AgentConfigurationResponse) AgentConfigurationResponse {
		if v != nil {
			return *v
		}
		var ret AgentConfigurationResponse
		return ret
	}).(AgentConfigurationResponseOutput)
}

func (o AgentConfigurationResponsePtrOutput) IncomingConnectionsPorts() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *AgentConfigurationResponse) []string {
		if v == nil {
			return nil
		}
		return v.IncomingConnectionsPorts
	}).(pulumi.StringArrayOutput)
}

func (o AgentConfigurationResponsePtrOutput) ProxyUrl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AgentConfigurationResponse) *string {
		if v == nil {
			return nil
		}
...
func (o MachinePropertiesResponseOutput) AgentConfiguration() AgentConfigurationResponsePtrOutput {
	return o.ApplyT(func(v MachinePropertiesResponse) *AgentConfigurationResponse { return v.AgentConfiguration }).(AgentConfigurationResponsePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(AgentConfigurationResponsePtrOutput{})
