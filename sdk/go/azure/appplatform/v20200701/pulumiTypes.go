...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CertificatePropertiesInput)(nil)).Elem(), CertificatePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CertificatePropertiesPtrInput)(nil)).Elem(), CertificatePropertiesArgs{})
