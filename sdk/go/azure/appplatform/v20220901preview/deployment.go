...
func NewDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20220901preview:Deployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeployment(ctx *pulumi.Context,
	...
	var resource Deployment
	err := ctx.ReadResource("azure-native:appplatform/v20220901preview:Deployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
