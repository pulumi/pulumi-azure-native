...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigServerGitPropertyInput)(nil)).Elem(), ConfigServerGitPropertyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigServerGitPropertyPtrInput)(nil)).Elem(), ConfigServerGitPropertyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigServerGitPropertyResponseInput)(nil)).Elem(), ConfigServerGitPropertyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigServerGitPropertyResponsePtrInput)(nil)).Elem(), ConfigServerGitPropertyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigServerPropertiesInput)(nil)).Elem(), ConfigServerPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigServerPropertiesPtrInput)(nil)).Elem(), ConfigServerPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigServerPropertiesResponseInput)(nil)).Elem(), ConfigServerPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigServerPropertiesResponsePtrInput)(nil)).Elem(), ConfigServerPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigServerSettingsInput)(nil)).Elem(), ConfigServerSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigServerSettingsPtrInput)(nil)).Elem(), ConfigServerSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigServerSettingsResponseInput)(nil)).Elem(), ConfigServerSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConfigServerSettingsResponsePtrInput)(nil)).Elem(), ConfigServerSettingsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ErrorInput)(nil)).Elem(), ErrorArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ErrorPtrInput)(nil)).Elem(), ErrorArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GitPatternRepositoryInput)(nil)).Elem(), GitPatternRepositoryArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GitPatternRepositoryArrayInput)(nil)).Elem(), GitPatternRepositoryArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GitPatternRepositoryResponseInput)(nil)).Elem(), GitPatternRepositoryResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GitPatternRepositoryResponseArrayInput)(nil)).Elem(), GitPatternRepositoryResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TracePropertiesInput)(nil)).Elem(), TracePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TracePropertiesPtrInput)(nil)).Elem(), TracePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TracePropertiesResponseInput)(nil)).Elem(), TracePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TracePropertiesResponsePtrInput)(nil)).Elem(), TracePropertiesResponseArgs{})
