...
type NetworkProfileInvokeResponse struct {
	...
	RequiredTraffics []RequiredTrafficInvokeResponse `pulumi:"requiredTraffics"`
	// Azure Spring Cloud service reserved CIDR
	ServiceCidr *string `pulumi:"serviceCidr"`
	// Name of the resource group containing network resources of Azure Spring Cloud Service Runtime
	ServiceRuntimeNetworkResourceGroup *string `pulumi:"serviceRuntimeNetworkResourceGroup"`
...
type NetworkProfileInvokeResponseArgs struct {
	...
	// Required inbound or outbound traffics for Azure Spring Cloud instance.
	RequiredTraffics RequiredTrafficInvokeResponseArrayInput `pulumi:"requiredTraffics"`
	// Azure Spring Cloud service reserved CIDR
	ServiceCidr pulumi.StringPtrInput `pulumi:"serviceCidr"`
	// Name of the resource group containing network resources of Azure Spring Cloud Service Runtime
	ServiceRuntimeNetworkResourceGroup pulumi.StringPtrInput `pulumi:"serviceRuntimeNetworkResourceGroup"`
...
// Required inbound or outbound traffics for Azure Spring Cloud instance.
func (o NetworkProfileInvokeResponseOutput) RequiredTraffics() RequiredTrafficInvokeResponseArrayOutput {
	return o.ApplyT(func(v NetworkProfileInvokeResponse) []RequiredTrafficInvokeResponse { return v.RequiredTraffics }).(RequiredTrafficInvokeResponseArrayOutput)
}
...
// Required inbound or outbound traffics for Azure Spring Cloud instance.
func (o NetworkProfileInvokeResponsePtrOutput) RequiredTraffics() RequiredTrafficInvokeResponseArrayOutput {
	return o.ApplyT(func(v *NetworkProfileInvokeResponse) []RequiredTrafficInvokeResponse {
		if v == nil {
			return nil
		}
		return v.RequiredTraffics
	}).(RequiredTrafficInvokeResponseArrayOutput)
}
...
type RequiredTrafficInvokeResponse struct {
...
// RequiredTrafficInvokeResponseInput is an input type that accepts RequiredTrafficInvokeResponseArgs and RequiredTrafficInvokeResponseOutput values.
// You can construct a concrete instance of `RequiredTrafficInvokeResponseInput` via:
//
//          RequiredTrafficInvokeResponseArgs{...}
type RequiredTrafficInvokeResponseInput interface {
	pulumi.Input

	ToRequiredTrafficInvokeResponseOutput() RequiredTrafficInvokeResponseOutput
	ToRequiredTrafficInvokeResponseOutputWithContext(context.Context) RequiredTrafficInvokeResponseOutput
}

// Required inbound or outbound traffic for Azure Spring Cloud instance.
type RequiredTrafficInvokeResponseArgs struct {
	// The direction of required traffic
...
func (RequiredTrafficInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*RequiredTrafficInvokeResponse)(nil)).Elem()
}

func (i RequiredTrafficInvokeResponseArgs) ToRequiredTrafficInvokeResponseOutput() RequiredTrafficInvokeResponseOutput {
	return i.ToRequiredTrafficInvokeResponseOutputWithContext(context.Background())
}

func (i RequiredTrafficInvokeResponseArgs) ToRequiredTrafficInvokeResponseOutputWithContext(ctx context.Context) RequiredTrafficInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RequiredTrafficInvokeResponseOutput)
}

// RequiredTrafficInvokeResponseArrayInput is an input type that accepts RequiredTrafficInvokeResponseArray and RequiredTrafficInvokeResponseArrayOutput values.
// You can construct a concrete instance of `RequiredTrafficInvokeResponseArrayInput` via:
//
//          RequiredTrafficInvokeResponseArray{ RequiredTrafficInvokeResponseArgs{...} }
type RequiredTrafficInvokeResponseArrayInput interface {
	pulumi.Input

	ToRequiredTrafficInvokeResponseArrayOutput() RequiredTrafficInvokeResponseArrayOutput
	ToRequiredTrafficInvokeResponseArrayOutputWithContext(context.Context) RequiredTrafficInvokeResponseArrayOutput
}

type RequiredTrafficInvokeResponseArray []RequiredTrafficInvokeResponseInput

func (RequiredTrafficInvokeResponseArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]RequiredTrafficInvokeResponse)(nil)).Elem()
}

func (i RequiredTrafficInvokeResponseArray) ToRequiredTrafficInvokeResponseArrayOutput() RequiredTrafficInvokeResponseArrayOutput {
	return i.ToRequiredTrafficInvokeResponseArrayOutputWithContext(context.Background())
}

func (i RequiredTrafficInvokeResponseArray) ToRequiredTrafficInvokeResponseArrayOutputWithContext(ctx context.Context) RequiredTrafficInvokeResponseArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RequiredTrafficInvokeResponseArrayOutput)
}

// Required inbound or outbound traffic for Azure Spring Cloud instance.
type RequiredTrafficInvokeResponseOutput struct{ *pulumi.OutputState }

func (RequiredTrafficInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*RequiredTrafficInvokeResponse)(nil)).Elem()
}

func (o RequiredTrafficInvokeResponseOutput) ToRequiredTrafficInvokeResponseOutput() RequiredTrafficInvokeResponseOutput {
	return o
}

func (o RequiredTrafficInvokeResponseOutput) ToRequiredTrafficInvokeResponseOutputWithContext(ctx context.Context) RequiredTrafficInvokeResponseOutput {
	return o
}

// The direction of required traffic
func (o RequiredTrafficInvokeResponseOutput) Direction() pulumi.StringOutput {
	return o.ApplyT(func(v RequiredTrafficInvokeResponse) string { return v.Direction }).(pulumi.StringOutput)
}

// The FQDN list of required traffic
func (o RequiredTrafficInvokeResponseOutput) Fqdns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v RequiredTrafficInvokeResponse) []string { return v.Fqdns }).(pulumi.StringArrayOutput)
}

// The ip list of required traffic
func (o RequiredTrafficInvokeResponseOutput) Ips() pulumi.StringArrayOutput {
	return o.ApplyT(func(v RequiredTrafficInvokeResponse) []string { return v.Ips }).(pulumi.StringArrayOutput)
}

// The port of required traffic
func (o RequiredTrafficInvokeResponseOutput) Port() pulumi.IntOutput {
	return o.ApplyT(func(v RequiredTrafficInvokeResponse) int { return v.Port }).(pulumi.IntOutput)
}

// The protocol of required traffic
func (o RequiredTrafficInvokeResponseOutput) Protocol() pulumi.StringOutput {
	return o.ApplyT(func(v RequiredTrafficInvokeResponse) string { return v.Protocol }).(pulumi.StringOutput)
}

type RequiredTrafficInvokeResponseArrayOutput struct{ *pulumi.OutputState }

func (RequiredTrafficInvokeResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]RequiredTrafficInvokeResponse)(nil)).Elem()
}

func (o RequiredTrafficInvokeResponseArrayOutput) ToRequiredTrafficInvokeResponseArrayOutput() RequiredTrafficInvokeResponseArrayOutput {
	return o
}

func (o RequiredTrafficInvokeResponseArrayOutput) ToRequiredTrafficInvokeResponseArrayOutputWithContext(ctx context.Context) RequiredTrafficInvokeResponseArrayOutput {
	return o
}

func (o RequiredTrafficInvokeResponseArrayOutput) Index(i pulumi.IntInput) RequiredTrafficInvokeResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) RequiredTrafficInvokeResponse {
		return vs[0].([]RequiredTrafficInvokeResponse)[vs[1].(int)]
	}).(RequiredTrafficInvokeResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(RequiredTrafficInvokeResponseOutput{})
	pulumi.RegisterOutputType(RequiredTrafficInvokeResponseArrayOutput{})
