...
func NewIntegrationAccountBatchConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:logic/v20180701preview:IntegrationAccountBatchConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountBatchConfiguration(ctx *pulumi.Context,
	...
	var resource IntegrationAccountBatchConfiguration
	err := ctx.ReadResource("azure-nextgen:logic/v20180701preview:IntegrationAccountBatchConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
