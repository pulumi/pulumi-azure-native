...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AssemblyPropertiesResponsePtrInput)(nil)).Elem(), AssemblyPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureResourceErrorInfoResponseInput)(nil)).Elem(), AzureResourceErrorInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureResourceErrorInfoResponsePtrInput)(nil)).Elem(), AzureResourceErrorInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureResourceErrorInfoResponseArrayInput)(nil)).Elem(), AzureResourceErrorInfoResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BatchConfigurationPropertiesInput)(nil)).Elem(), BatchConfigurationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchConfigurationPropertiesPtrInput)(nil)).Elem(), BatchConfigurationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchConfigurationPropertiesResponseInput)(nil)).Elem(), BatchConfigurationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchConfigurationPropertiesResponsePtrInput)(nil)).Elem(), BatchConfigurationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchReleaseCriteriaInput)(nil)).Elem(), BatchReleaseCriteriaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchReleaseCriteriaPtrInput)(nil)).Elem(), BatchReleaseCriteriaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchReleaseCriteriaResponseInput)(nil)).Elem(), BatchReleaseCriteriaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchReleaseCriteriaResponsePtrInput)(nil)).Elem(), BatchReleaseCriteriaResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ExpressionResponseInput)(nil)).Elem(), ExpressionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExpressionResponseArrayInput)(nil)).Elem(), ExpressionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExpressionRootResponseInput)(nil)).Elem(), ExpressionRootResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExpressionRootResponseArrayInput)(nil)).Elem(), ExpressionRootResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountMapPropertiesParametersSchemaInput)(nil)).Elem(), IntegrationAccountMapPropertiesParametersSchemaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountMapPropertiesParametersSchemaPtrInput)(nil)).Elem(), IntegrationAccountMapPropertiesParametersSchemaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountMapPropertiesResponseParametersSchemaInput)(nil)).Elem(), IntegrationAccountMapPropertiesResponseParametersSchemaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountMapPropertiesResponseParametersSchemaPtrInput)(nil)).Elem(), IntegrationAccountMapPropertiesResponseParametersSchemaArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultKeyResponseInput)(nil)).Elem(), KeyVaultKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultKeyResponseArrayInput)(nil)).Elem(), KeyVaultKeyResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceScheduleInput)(nil)).Elem(), RecurrenceScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceSchedulePtrInput)(nil)).Elem(), RecurrenceScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceScheduleOccurrenceInput)(nil)).Elem(), RecurrenceScheduleOccurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceScheduleOccurrenceArrayInput)(nil)).Elem(), RecurrenceScheduleOccurrenceArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceScheduleOccurrenceResponseInput)(nil)).Elem(), RecurrenceScheduleOccurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceScheduleOccurrenceResponseArrayInput)(nil)).Elem(), RecurrenceScheduleOccurrenceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceScheduleResponseInput)(nil)).Elem(), RecurrenceScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceScheduleResponsePtrInput)(nil)).Elem(), RecurrenceScheduleResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WorkflowTriggerListCallbackUrlQueriesResponseInput)(nil)).Elem(), WorkflowTriggerListCallbackUrlQueriesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkflowTriggerListCallbackUrlQueriesResponsePtrInput)(nil)).Elem(), WorkflowTriggerListCallbackUrlQueriesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkflowTriggerRecurrenceInput)(nil)).Elem(), WorkflowTriggerRecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkflowTriggerRecurrencePtrInput)(nil)).Elem(), WorkflowTriggerRecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkflowTriggerRecurrenceResponseInput)(nil)).Elem(), WorkflowTriggerRecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkflowTriggerRecurrenceResponsePtrInput)(nil)).Elem(), WorkflowTriggerRecurrenceResponseArgs{})
