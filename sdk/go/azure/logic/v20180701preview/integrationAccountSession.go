...
func NewIntegrationAccountSession(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:logic/v20180701preview:IntegrationAccountSession", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountSession(ctx *pulumi.Context,
	...
	var resource IntegrationAccountSession
	err := ctx.ReadResource("azure-nextgen:logic/v20180701preview:IntegrationAccountSession", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
