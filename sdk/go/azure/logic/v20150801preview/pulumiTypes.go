...
func (o IntegrationAccountContentHashResponseOutput) ToIntegrationAccountContentHashResponsePtrOutputWithContext(ctx context.Context) IntegrationAccountContentHashResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v IntegrationAccountContentHashResponse) *IntegrationAccountContentHashResponse {
		return &v
...
func (o IntegrationAccountContentLinkResponseOutput) ToIntegrationAccountContentLinkResponsePtrOutputWithContext(ctx context.Context) IntegrationAccountContentLinkResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v IntegrationAccountContentLinkResponse) *IntegrationAccountContentLinkResponse {
		return &v
...
func (o IntegrationAccountContentLinkResponsePtrOutput) Elem() IntegrationAccountContentLinkResponseOutput {
	return o.ApplyT(func(v *IntegrationAccountContentLinkResponse) IntegrationAccountContentLinkResponse {
		...
		var ret IntegrationAccountContentLinkResponse
		return ret
...
func (o IntegrationAccountContentLinkResponsePtrOutput) ContentSize() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *IntegrationAccountContentLinkResponse) *float64 {
		if v == nil {
			return nil
		}
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AS2AcknowledgementConnectionSettingsInput)(nil)).Elem(), AS2AcknowledgementConnectionSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2AcknowledgementConnectionSettingsPtrInput)(nil)).Elem(), AS2AcknowledgementConnectionSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2AcknowledgementConnectionSettingsResponseInput)(nil)).Elem(), AS2AcknowledgementConnectionSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2AcknowledgementConnectionSettingsResponsePtrInput)(nil)).Elem(), AS2AcknowledgementConnectionSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2AgreementContentInput)(nil)).Elem(), AS2AgreementContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2AgreementContentPtrInput)(nil)).Elem(), AS2AgreementContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2AgreementContentResponseInput)(nil)).Elem(), AS2AgreementContentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2AgreementContentResponsePtrInput)(nil)).Elem(), AS2AgreementContentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2EnvelopeSettingsInput)(nil)).Elem(), AS2EnvelopeSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2EnvelopeSettingsPtrInput)(nil)).Elem(), AS2EnvelopeSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2EnvelopeSettingsResponseInput)(nil)).Elem(), AS2EnvelopeSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2EnvelopeSettingsResponsePtrInput)(nil)).Elem(), AS2EnvelopeSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2ErrorSettingsInput)(nil)).Elem(), AS2ErrorSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2ErrorSettingsPtrInput)(nil)).Elem(), AS2ErrorSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2ErrorSettingsResponseInput)(nil)).Elem(), AS2ErrorSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2ErrorSettingsResponsePtrInput)(nil)).Elem(), AS2ErrorSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2MdnSettingsInput)(nil)).Elem(), AS2MdnSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2MdnSettingsPtrInput)(nil)).Elem(), AS2MdnSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2MdnSettingsResponseInput)(nil)).Elem(), AS2MdnSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2MdnSettingsResponsePtrInput)(nil)).Elem(), AS2MdnSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2MessageConnectionSettingsInput)(nil)).Elem(), AS2MessageConnectionSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2MessageConnectionSettingsPtrInput)(nil)).Elem(), AS2MessageConnectionSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2MessageConnectionSettingsResponseInput)(nil)).Elem(), AS2MessageConnectionSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2MessageConnectionSettingsResponsePtrInput)(nil)).Elem(), AS2MessageConnectionSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2OneWayAgreementInput)(nil)).Elem(), AS2OneWayAgreementArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2OneWayAgreementPtrInput)(nil)).Elem(), AS2OneWayAgreementArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2OneWayAgreementResponseInput)(nil)).Elem(), AS2OneWayAgreementResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2OneWayAgreementResponsePtrInput)(nil)).Elem(), AS2OneWayAgreementResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2ProtocolSettingsInput)(nil)).Elem(), AS2ProtocolSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2ProtocolSettingsPtrInput)(nil)).Elem(), AS2ProtocolSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2ProtocolSettingsResponseInput)(nil)).Elem(), AS2ProtocolSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2ProtocolSettingsResponsePtrInput)(nil)).Elem(), AS2ProtocolSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2SecuritySettingsInput)(nil)).Elem(), AS2SecuritySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2SecuritySettingsPtrInput)(nil)).Elem(), AS2SecuritySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2SecuritySettingsResponseInput)(nil)).Elem(), AS2SecuritySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2SecuritySettingsResponsePtrInput)(nil)).Elem(), AS2SecuritySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2ValidationSettingsInput)(nil)).Elem(), AS2ValidationSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2ValidationSettingsPtrInput)(nil)).Elem(), AS2ValidationSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2ValidationSettingsResponseInput)(nil)).Elem(), AS2ValidationSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AS2ValidationSettingsResponsePtrInput)(nil)).Elem(), AS2ValidationSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AgreementContentInput)(nil)).Elem(), AgreementContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AgreementContentPtrInput)(nil)).Elem(), AgreementContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AgreementContentResponseInput)(nil)).Elem(), AgreementContentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AgreementContentResponsePtrInput)(nil)).Elem(), AgreementContentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*B2BPartnerContentInput)(nil)).Elem(), B2BPartnerContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*B2BPartnerContentPtrInput)(nil)).Elem(), B2BPartnerContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*B2BPartnerContentResponseInput)(nil)).Elem(), B2BPartnerContentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*B2BPartnerContentResponsePtrInput)(nil)).Elem(), B2BPartnerContentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BusinessIdentityInput)(nil)).Elem(), BusinessIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BusinessIdentityPtrInput)(nil)).Elem(), BusinessIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BusinessIdentityArrayInput)(nil)).Elem(), BusinessIdentityArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactAcknowledgementSettingsInput)(nil)).Elem(), EdifactAcknowledgementSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactAcknowledgementSettingsPtrInput)(nil)).Elem(), EdifactAcknowledgementSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactAcknowledgementSettingsResponseInput)(nil)).Elem(), EdifactAcknowledgementSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactAcknowledgementSettingsResponsePtrInput)(nil)).Elem(), EdifactAcknowledgementSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactAgreementContentInput)(nil)).Elem(), EdifactAgreementContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactAgreementContentPtrInput)(nil)).Elem(), EdifactAgreementContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactAgreementContentResponseInput)(nil)).Elem(), EdifactAgreementContentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactAgreementContentResponsePtrInput)(nil)).Elem(), EdifactAgreementContentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactDelimiterOverrideInput)(nil)).Elem(), EdifactDelimiterOverrideArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactDelimiterOverrideArrayInput)(nil)).Elem(), EdifactDelimiterOverrideArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactDelimiterOverrideResponseInput)(nil)).Elem(), EdifactDelimiterOverrideResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactDelimiterOverrideResponseArrayInput)(nil)).Elem(), EdifactDelimiterOverrideResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactEnvelopeOverrideInput)(nil)).Elem(), EdifactEnvelopeOverrideArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactEnvelopeOverrideArrayInput)(nil)).Elem(), EdifactEnvelopeOverrideArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactEnvelopeOverrideResponseInput)(nil)).Elem(), EdifactEnvelopeOverrideResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactEnvelopeOverrideResponseArrayInput)(nil)).Elem(), EdifactEnvelopeOverrideResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactEnvelopeSettingsInput)(nil)).Elem(), EdifactEnvelopeSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactEnvelopeSettingsPtrInput)(nil)).Elem(), EdifactEnvelopeSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactEnvelopeSettingsResponseInput)(nil)).Elem(), EdifactEnvelopeSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactEnvelopeSettingsResponsePtrInput)(nil)).Elem(), EdifactEnvelopeSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactFramingSettingsInput)(nil)).Elem(), EdifactFramingSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactFramingSettingsPtrInput)(nil)).Elem(), EdifactFramingSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactFramingSettingsResponseInput)(nil)).Elem(), EdifactFramingSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactFramingSettingsResponsePtrInput)(nil)).Elem(), EdifactFramingSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactMessageFilterInput)(nil)).Elem(), EdifactMessageFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactMessageFilterPtrInput)(nil)).Elem(), EdifactMessageFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactMessageFilterResponseInput)(nil)).Elem(), EdifactMessageFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactMessageFilterResponsePtrInput)(nil)).Elem(), EdifactMessageFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactMessageIdentifierInput)(nil)).Elem(), EdifactMessageIdentifierArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactMessageIdentifierArrayInput)(nil)).Elem(), EdifactMessageIdentifierArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactMessageIdentifierResponseInput)(nil)).Elem(), EdifactMessageIdentifierResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactMessageIdentifierResponseArrayInput)(nil)).Elem(), EdifactMessageIdentifierResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactOneWayAgreementInput)(nil)).Elem(), EdifactOneWayAgreementArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactOneWayAgreementPtrInput)(nil)).Elem(), EdifactOneWayAgreementArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactOneWayAgreementResponseInput)(nil)).Elem(), EdifactOneWayAgreementResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactOneWayAgreementResponsePtrInput)(nil)).Elem(), EdifactOneWayAgreementResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactProcessingSettingsInput)(nil)).Elem(), EdifactProcessingSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactProcessingSettingsPtrInput)(nil)).Elem(), EdifactProcessingSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactProcessingSettingsResponseInput)(nil)).Elem(), EdifactProcessingSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactProcessingSettingsResponsePtrInput)(nil)).Elem(), EdifactProcessingSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactProtocolSettingsInput)(nil)).Elem(), EdifactProtocolSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactProtocolSettingsPtrInput)(nil)).Elem(), EdifactProtocolSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactProtocolSettingsResponseInput)(nil)).Elem(), EdifactProtocolSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactProtocolSettingsResponsePtrInput)(nil)).Elem(), EdifactProtocolSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactSchemaReferenceInput)(nil)).Elem(), EdifactSchemaReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactSchemaReferenceArrayInput)(nil)).Elem(), EdifactSchemaReferenceArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactSchemaReferenceResponseInput)(nil)).Elem(), EdifactSchemaReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactSchemaReferenceResponseArrayInput)(nil)).Elem(), EdifactSchemaReferenceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactValidationOverrideInput)(nil)).Elem(), EdifactValidationOverrideArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactValidationOverrideArrayInput)(nil)).Elem(), EdifactValidationOverrideArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactValidationOverrideResponseInput)(nil)).Elem(), EdifactValidationOverrideResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactValidationOverrideResponseArrayInput)(nil)).Elem(), EdifactValidationOverrideResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactValidationSettingsInput)(nil)).Elem(), EdifactValidationSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactValidationSettingsPtrInput)(nil)).Elem(), EdifactValidationSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactValidationSettingsResponseInput)(nil)).Elem(), EdifactValidationSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactValidationSettingsResponsePtrInput)(nil)).Elem(), EdifactValidationSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountContentHashResponseInput)(nil)).Elem(), IntegrationAccountContentHashResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountContentHashResponsePtrInput)(nil)).Elem(), IntegrationAccountContentHashResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountContentLinkResponseInput)(nil)).Elem(), IntegrationAccountContentLinkResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountContentLinkResponsePtrInput)(nil)).Elem(), IntegrationAccountContentLinkResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountSkuInput)(nil)).Elem(), IntegrationAccountSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountSkuPtrInput)(nil)).Elem(), IntegrationAccountSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountSkuResponseInput)(nil)).Elem(), IntegrationAccountSkuResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountSkuResponsePtrInput)(nil)).Elem(), IntegrationAccountSkuResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultKeyReferenceKeyVaultInput)(nil)).Elem(), KeyVaultKeyReferenceKeyVaultArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultKeyReferenceKeyVaultPtrInput)(nil)).Elem(), KeyVaultKeyReferenceKeyVaultArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultKeyReferenceResponseKeyVaultInput)(nil)).Elem(), KeyVaultKeyReferenceResponseKeyVaultArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultKeyReferenceResponseKeyVaultPtrInput)(nil)).Elem(), KeyVaultKeyReferenceResponseKeyVaultArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PartnerContentInput)(nil)).Elem(), PartnerContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PartnerContentPtrInput)(nil)).Elem(), PartnerContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PartnerContentResponseInput)(nil)).Elem(), PartnerContentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PartnerContentResponsePtrInput)(nil)).Elem(), PartnerContentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12AcknowledgementSettingsInput)(nil)).Elem(), X12AcknowledgementSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12AcknowledgementSettingsPtrInput)(nil)).Elem(), X12AcknowledgementSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12AcknowledgementSettingsResponseInput)(nil)).Elem(), X12AcknowledgementSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12AcknowledgementSettingsResponsePtrInput)(nil)).Elem(), X12AcknowledgementSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12AgreementContentInput)(nil)).Elem(), X12AgreementContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12AgreementContentPtrInput)(nil)).Elem(), X12AgreementContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12AgreementContentResponseInput)(nil)).Elem(), X12AgreementContentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12AgreementContentResponsePtrInput)(nil)).Elem(), X12AgreementContentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12DelimiterOverridesInput)(nil)).Elem(), X12DelimiterOverridesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12DelimiterOverridesArrayInput)(nil)).Elem(), X12DelimiterOverridesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12DelimiterOverridesResponseInput)(nil)).Elem(), X12DelimiterOverridesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12DelimiterOverridesResponseArrayInput)(nil)).Elem(), X12DelimiterOverridesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12EnvelopeOverrideInput)(nil)).Elem(), X12EnvelopeOverrideArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12EnvelopeOverrideArrayInput)(nil)).Elem(), X12EnvelopeOverrideArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12EnvelopeOverrideResponseInput)(nil)).Elem(), X12EnvelopeOverrideResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12EnvelopeOverrideResponseArrayInput)(nil)).Elem(), X12EnvelopeOverrideResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12EnvelopeSettingsInput)(nil)).Elem(), X12EnvelopeSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12EnvelopeSettingsPtrInput)(nil)).Elem(), X12EnvelopeSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12EnvelopeSettingsResponseInput)(nil)).Elem(), X12EnvelopeSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12EnvelopeSettingsResponsePtrInput)(nil)).Elem(), X12EnvelopeSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12FramingSettingsInput)(nil)).Elem(), X12FramingSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12FramingSettingsPtrInput)(nil)).Elem(), X12FramingSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12FramingSettingsResponseInput)(nil)).Elem(), X12FramingSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12FramingSettingsResponsePtrInput)(nil)).Elem(), X12FramingSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12MessageFilterInput)(nil)).Elem(), X12MessageFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12MessageFilterPtrInput)(nil)).Elem(), X12MessageFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12MessageFilterResponseInput)(nil)).Elem(), X12MessageFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12MessageFilterResponsePtrInput)(nil)).Elem(), X12MessageFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12MessageIdentifierInput)(nil)).Elem(), X12MessageIdentifierArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12MessageIdentifierArrayInput)(nil)).Elem(), X12MessageIdentifierArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12MessageIdentifierResponseInput)(nil)).Elem(), X12MessageIdentifierResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12MessageIdentifierResponseArrayInput)(nil)).Elem(), X12MessageIdentifierResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12OneWayAgreementInput)(nil)).Elem(), X12OneWayAgreementArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12OneWayAgreementPtrInput)(nil)).Elem(), X12OneWayAgreementArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12OneWayAgreementResponseInput)(nil)).Elem(), X12OneWayAgreementResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12OneWayAgreementResponsePtrInput)(nil)).Elem(), X12OneWayAgreementResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ProcessingSettingsInput)(nil)).Elem(), X12ProcessingSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ProcessingSettingsPtrInput)(nil)).Elem(), X12ProcessingSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ProcessingSettingsResponseInput)(nil)).Elem(), X12ProcessingSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ProcessingSettingsResponsePtrInput)(nil)).Elem(), X12ProcessingSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ProtocolSettingsInput)(nil)).Elem(), X12ProtocolSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ProtocolSettingsPtrInput)(nil)).Elem(), X12ProtocolSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ProtocolSettingsResponseInput)(nil)).Elem(), X12ProtocolSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ProtocolSettingsResponsePtrInput)(nil)).Elem(), X12ProtocolSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12SchemaReferenceInput)(nil)).Elem(), X12SchemaReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12SchemaReferenceArrayInput)(nil)).Elem(), X12SchemaReferenceArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12SchemaReferenceResponseInput)(nil)).Elem(), X12SchemaReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12SchemaReferenceResponseArrayInput)(nil)).Elem(), X12SchemaReferenceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12SecuritySettingsInput)(nil)).Elem(), X12SecuritySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12SecuritySettingsPtrInput)(nil)).Elem(), X12SecuritySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12SecuritySettingsResponseInput)(nil)).Elem(), X12SecuritySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12SecuritySettingsResponsePtrInput)(nil)).Elem(), X12SecuritySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ValidationOverrideInput)(nil)).Elem(), X12ValidationOverrideArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ValidationOverrideArrayInput)(nil)).Elem(), X12ValidationOverrideArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ValidationOverrideResponseInput)(nil)).Elem(), X12ValidationOverrideResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ValidationOverrideResponseArrayInput)(nil)).Elem(), X12ValidationOverrideResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ValidationSettingsInput)(nil)).Elem(), X12ValidationSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ValidationSettingsPtrInput)(nil)).Elem(), X12ValidationSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ValidationSettingsResponseInput)(nil)).Elem(), X12ValidationSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*X12ValidationSettingsResponsePtrInput)(nil)).Elem(), X12ValidationSettingsResponseArgs{})
