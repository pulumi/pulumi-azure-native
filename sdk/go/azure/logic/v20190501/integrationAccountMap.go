...
func NewIntegrationAccountMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:logic/v20190501:IntegrationAccountMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountMap(ctx *pulumi.Context,
	...
	var resource IntegrationAccountMap
	err := ctx.ReadResource("azure-nextgen:logic/v20190501:IntegrationAccountMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
