...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationServiceEnvironmentAccessEndpointTypeInput)(nil)).Elem(), IntegrationServiceEnvironmentAccessEndpointType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationServiceEnvironmentAccessEndpointTypePtrInput)(nil)).Elem(), IntegrationServiceEnvironmentAccessEndpointType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationServiceEnvironmentSkuNameInput)(nil)).Elem(), IntegrationServiceEnvironmentSkuName("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationServiceEnvironmentSkuNamePtrInput)(nil)).Elem(), IntegrationServiceEnvironmentSkuName("NotSpecified"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OpenAuthenticationProviderTypeInput)(nil)).Elem(), OpenAuthenticationProviderType("AAD"))
	pulumi.RegisterInputType(reflect.TypeOf((*OpenAuthenticationProviderTypePtrInput)(nil)).Elem(), OpenAuthenticationProviderType("AAD"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WorkflowProvisioningStateInput)(nil)).Elem(), WorkflowProvisioningState("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*WorkflowProvisioningStatePtrInput)(nil)).Elem(), WorkflowProvisioningState("NotSpecified"))
