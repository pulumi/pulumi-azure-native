...
func NewIntegrationAccountCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:logic/v20190501:IntegrationAccountCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountCertificate(ctx *pulumi.Context,
	...
	var resource IntegrationAccountCertificate
	err := ctx.ReadResource("azure-native:logic/v20190501:IntegrationAccountCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
