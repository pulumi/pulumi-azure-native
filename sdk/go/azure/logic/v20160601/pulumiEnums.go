...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AgreementTypeInput)(nil)).Elem(), AgreementType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*AgreementTypePtrInput)(nil)).Elem(), AgreementType("NotSpecified"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactCharacterSetInput)(nil)).Elem(), EdifactCharacterSet("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactCharacterSetPtrInput)(nil)).Elem(), EdifactCharacterSet("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactDecimalIndicatorInput)(nil)).Elem(), EdifactDecimalIndicator("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*EdifactDecimalIndicatorPtrInput)(nil)).Elem(), EdifactDecimalIndicator("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionAlgorithmInput)(nil)).Elem(), EncryptionAlgorithm("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionAlgorithmPtrInput)(nil)).Elem(), EncryptionAlgorithm("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*HashingAlgorithmInput)(nil)).Elem(), HashingAlgorithm("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*HashingAlgorithmPtrInput)(nil)).Elem(), HashingAlgorithm("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountSkuNameInput)(nil)).Elem(), IntegrationAccountSkuName("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*IntegrationAccountSkuNamePtrInput)(nil)).Elem(), IntegrationAccountSkuName("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*KeyTypeInput)(nil)).Elem(), KeyType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*KeyTypePtrInput)(nil)).Elem(), KeyType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*MapTypeInput)(nil)).Elem(), MapType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*MapTypePtrInput)(nil)).Elem(), MapType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*MessageFilterTypeInput)(nil)).Elem(), MessageFilterType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*MessageFilterTypePtrInput)(nil)).Elem(), MessageFilterType("NotSpecified"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PartnerTypeInput)(nil)).Elem(), PartnerType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*PartnerTypePtrInput)(nil)).Elem(), PartnerType("NotSpecified"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RosettaNetActionTypeInput)(nil)).Elem(), RosettaNetActionType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*RosettaNetActionTypePtrInput)(nil)).Elem(), RosettaNetActionType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*RosettaNetPipActivityTypeInput)(nil)).Elem(), RosettaNetPipActivityType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*RosettaNetPipActivityTypePtrInput)(nil)).Elem(), RosettaNetPipActivityType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*RosettaNetPipConfidentialityScopeInput)(nil)).Elem(), RosettaNetPipConfidentialityScope("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*RosettaNetPipConfidentialityScopePtrInput)(nil)).Elem(), RosettaNetPipConfidentialityScope("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*RosettaNetPipRoleTypeInput)(nil)).Elem(), RosettaNetPipRoleType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*RosettaNetPipRoleTypePtrInput)(nil)).Elem(), RosettaNetPipRoleType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*RosettaNetResponseTypeInput)(nil)).Elem(), RosettaNetResponseType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*RosettaNetResponseTypePtrInput)(nil)).Elem(), RosettaNetResponseType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*SchemaTypeInput)(nil)).Elem(), SchemaType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*SchemaTypePtrInput)(nil)).Elem(), SchemaType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*SegmentTerminatorSuffixInput)(nil)).Elem(), SegmentTerminatorSuffix("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*SegmentTerminatorSuffixPtrInput)(nil)).Elem(), SegmentTerminatorSuffix("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*SigningAlgorithmInput)(nil)).Elem(), SigningAlgorithm("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*SigningAlgorithmPtrInput)(nil)).Elem(), SigningAlgorithm("NotSpecified"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TrailingSeparatorPolicyInput)(nil)).Elem(), TrailingSeparatorPolicy("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*TrailingSeparatorPolicyPtrInput)(nil)).Elem(), TrailingSeparatorPolicy("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*UsageIndicatorInput)(nil)).Elem(), UsageIndicator("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*UsageIndicatorPtrInput)(nil)).Elem(), UsageIndicator("NotSpecified"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*X12CharacterSetInput)(nil)).Elem(), X12CharacterSet("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*X12CharacterSetPtrInput)(nil)).Elem(), X12CharacterSet("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*X12DateFormatInput)(nil)).Elem(), X12DateFormat("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*X12DateFormatPtrInput)(nil)).Elem(), X12DateFormat("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*X12TimeFormatInput)(nil)).Elem(), X12TimeFormat("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*X12TimeFormatPtrInput)(nil)).Elem(), X12TimeFormat("NotSpecified"))
