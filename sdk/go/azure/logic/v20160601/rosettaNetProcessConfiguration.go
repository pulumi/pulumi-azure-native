...
func NewRosettaNetProcessConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:logic/v20160601:RosettaNetProcessConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRosettaNetProcessConfiguration(ctx *pulumi.Context,
	...
	var resource RosettaNetProcessConfiguration
	err := ctx.ReadResource("azure-nextgen:logic/v20160601:RosettaNetProcessConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
