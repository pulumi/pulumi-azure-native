...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceReferencePtrInput)(nil)).Elem(), ResourceReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceReferenceResponseInput)(nil)).Elem(), ResourceReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceReferenceResponsePtrInput)(nil)).Elem(), ResourceReferenceResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WorkflowParameterResponseMapInput)(nil)).Elem(), WorkflowParameterResponseMap{})
