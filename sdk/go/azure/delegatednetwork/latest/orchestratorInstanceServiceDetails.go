...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:delegatednetwork:OrchestratorInstanceServiceDetails'.
...
func NewOrchestratorInstanceServiceDetails(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:delegatednetwork/latest:OrchestratorInstanceServiceDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrchestratorInstanceServiceDetails(ctx *pulumi.Context,
	...
	var resource OrchestratorInstanceServiceDetails
	err := ctx.ReadResource("azure-native:delegatednetwork/latest:OrchestratorInstanceServiceDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
