...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:delegatednetwork:getControllerDetails'.
func LookupControllerDetails(ctx *pulumi.Context, args *LookupControllerDetailsArgs, opts ...pulumi.InvokeOption) (*LookupControllerDetailsResult, error) {
	...
	err := ctx.Invoke("azure-native:delegatednetwork/latest:getControllerDetails", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
