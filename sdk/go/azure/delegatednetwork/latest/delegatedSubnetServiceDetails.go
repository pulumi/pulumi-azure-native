...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:delegatednetwork:DelegatedSubnetServiceDetails'.
...
func NewDelegatedSubnetServiceDetails(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:delegatednetwork/latest:DelegatedSubnetServiceDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDelegatedSubnetServiceDetails(ctx *pulumi.Context,
	...
	var resource DelegatedSubnetServiceDetails
	err := ctx.ReadResource("azure-native:delegatednetwork/latest:DelegatedSubnetServiceDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
