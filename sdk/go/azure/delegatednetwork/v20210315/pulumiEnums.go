...
// OrchestratorKindInput is an input type that accepts OrchestratorKindArgs and OrchestratorKindOutput values.
// You can construct a concrete instance of `OrchestratorKindInput` via:
//
