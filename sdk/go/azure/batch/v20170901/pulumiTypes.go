...
// This may differ from targetOSVersion if the pool state is Upgrading. In this case some virtual machines may be on the targetOSVersion and some may be on the currentOSVersion during the upgrade process. Once all virtual machines have upgraded, currentOSVersion is updated to be the same as targetOSVersion.
func (o CloudServiceConfigurationInvokeResponseOutput) CurrentOSVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CloudServiceConfigurationInvokeResponse) *string { return v.CurrentOSVersion }).(pulumi.StringPtrOutput)
}
...
// The default value is * which specifies the latest operating system version for the specified OS family.
func (o CloudServiceConfigurationInvokeResponseOutput) TargetOSVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CloudServiceConfigurationInvokeResponse) *string { return v.TargetOSVersion }).(pulumi.StringPtrOutput)
}
...
// This may differ from targetOSVersion if the pool state is Upgrading. In this case some virtual machines may be on the targetOSVersion and some may be on the currentOSVersion during the upgrade process. Once all virtual machines have upgraded, currentOSVersion is updated to be the same as targetOSVersion.
func (o CloudServiceConfigurationInvokeResponsePtrOutput) CurrentOSVersion() pulumi.StringPtrOutput {
...
// The default value is * which specifies the latest operating system version for the specified OS family.
func (o CloudServiceConfigurationInvokeResponsePtrOutput) TargetOSVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CloudServiceConfigurationInvokeResponse) *string {
		if v == nil {
			return nil
		}
...
// This URL must be readable using anonymous access; that is, the Batch service does not present any credentials when downloading the blob. There are two ways to get such a URL for a blob in Azure storage: include a Shared Access Signature (SAS) granting read permissions on the blob, or set the ACL for the blob or its container to allow public access.
func (o ResourceFileInvokeResponseOutput) BlobSource() pulumi.StringOutput {
	return o.ApplyT(func(v ResourceFileInvokeResponse) string { return v.BlobSource }).(pulumi.StringOutput)
}
...
func (o ResourceFileInvokeResponseOutput) FilePath() pulumi.StringOutput {
	return o.ApplyT(func(v ResourceFileInvokeResponse) string { return v.FilePath }).(pulumi.StringOutput)
}
...
func (o VirtualMachineConfigurationInvokeResponseOutput) OsDisk() OSDiskInvokeResponsePtrOutput {
	return o.ApplyT(func(v VirtualMachineConfigurationInvokeResponse) *OSDiskInvokeResponse { return v.OsDisk }).(OSDiskInvokeResponsePtrOutput)
}
...
func (o VirtualMachineConfigurationInvokeResponsePtrOutput) OsDisk() OSDiskInvokeResponsePtrOutput {
	return o.ApplyT(func(v *VirtualMachineConfigurationInvokeResponse) *OSDiskInvokeResponse {
		if v == nil {
			return nil
		}
		return v.OsDisk
