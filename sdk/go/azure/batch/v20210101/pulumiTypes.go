...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BatchAccountIdentityResponseUserAssignedIdentitiesInput)(nil)).Elem(), BatchAccountIdentityResponseUserAssignedIdentitiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchAccountIdentityResponseUserAssignedIdentitiesMapInput)(nil)).Elem(), BatchAccountIdentityResponseUserAssignedIdentitiesMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchPoolIdentityInput)(nil)).Elem(), BatchPoolIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchPoolIdentityPtrInput)(nil)).Elem(), BatchPoolIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchPoolIdentityResponseInput)(nil)).Elem(), BatchPoolIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchPoolIdentityResponsePtrInput)(nil)).Elem(), BatchPoolIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchPoolIdentityResponseUserAssignedIdentitiesInput)(nil)).Elem(), BatchPoolIdentityResponseUserAssignedIdentitiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchPoolIdentityResponseUserAssignedIdentitiesMapInput)(nil)).Elem(), BatchPoolIdentityResponseUserAssignedIdentitiesMap{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NodePlacementConfigurationInput)(nil)).Elem(), NodePlacementConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NodePlacementConfigurationPtrInput)(nil)).Elem(), NodePlacementConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NodePlacementConfigurationResponseInput)(nil)).Elem(), NodePlacementConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NodePlacementConfigurationResponsePtrInput)(nil)).Elem(), NodePlacementConfigurationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VMExtensionInput)(nil)).Elem(), VMExtensionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VMExtensionArrayInput)(nil)).Elem(), VMExtensionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VMExtensionResponseInput)(nil)).Elem(), VMExtensionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VMExtensionResponseArrayInput)(nil)).Elem(), VMExtensionResponseArray{})
