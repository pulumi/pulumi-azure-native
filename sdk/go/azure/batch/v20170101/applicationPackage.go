...
func NewApplicationPackage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:batch/v20170101:ApplicationPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationPackage(ctx *pulumi.Context,
	...
	var resource ApplicationPackage
	err := ctx.ReadResource("azure-nextgen:batch/v20170101:ApplicationPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
