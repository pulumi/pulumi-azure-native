...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AuthenticationModeInput)(nil)).Elem(), AuthenticationMode("SharedKey"))
	pulumi.RegisterInputType(reflect.TypeOf((*AuthenticationModePtrInput)(nil)).Elem(), AuthenticationMode("SharedKey"))
	pulumi.RegisterInputType(reflect.TypeOf((*AuthenticationModeArrayInput)(nil)).Elem(), AuthenticationModeArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoStorageAuthenticationModeInput)(nil)).Elem(), AutoStorageAuthenticationMode("StorageKeys"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutoStorageAuthenticationModePtrInput)(nil)).Elem(), AutoStorageAuthenticationMode("StorageKeys"))
