...
func (o AuthenticationModeArrayOutput) Index(i pulumi.IntInput) pulumi.StringOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) pulumi.StringOutput {
		return vs[0].([]AuthenticationMode)[vs[1].(int)].ToStringOutput()
	}).(pulumi.StringOutput)
}

// The authentication mode which the Batch service will use to manage the auto-storage account.
type AutoStorageAuthenticationMode pulumi.String
