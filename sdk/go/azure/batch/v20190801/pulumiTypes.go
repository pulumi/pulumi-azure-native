...
func (o NetworkConfigurationOutput) PublicIPs() pulumi.StringArrayOutput {
	return o.ApplyT(func(v NetworkConfiguration) []string { return v.PublicIPs }).(pulumi.StringArrayOutput)
}
...
func (o NetworkConfigurationPtrOutput) PublicIPs() pulumi.StringArrayOutput {
...
func (o NetworkConfigurationResponseOutput) PublicIPs() pulumi.StringArrayOutput {
	return o.ApplyT(func(v NetworkConfigurationResponse) []string { return v.PublicIPs }).(pulumi.StringArrayOutput)
}
...
func (o NetworkConfigurationResponsePtrOutput) PublicIPs() pulumi.StringArrayOutput {
