...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AutoUserScopeInput)(nil)).Elem(), AutoUserScope("Task"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutoUserScopePtrInput)(nil)).Elem(), AutoUserScope("Task"))
	pulumi.RegisterInputType(reflect.TypeOf((*CachingTypeInput)(nil)).Elem(), CachingType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*CachingTypePtrInput)(nil)).Elem(), CachingType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateFormatInput)(nil)).Elem(), CertificateFormat("Pfx"))
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateFormatPtrInput)(nil)).Elem(), CertificateFormat("Pfx"))
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateStoreLocationInput)(nil)).Elem(), CertificateStoreLocation("CurrentUser"))
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateStoreLocationPtrInput)(nil)).Elem(), CertificateStoreLocation("CurrentUser"))
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateVisibilityInput)(nil)).Elem(), CertificateVisibility("StartTask"))
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateVisibilityPtrInput)(nil)).Elem(), CertificateVisibility("StartTask"))
	pulumi.RegisterInputType(reflect.TypeOf((*CertificateVisibilityArrayInput)(nil)).Elem(), CertificateVisibilityArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeNodeDeallocationOptionInput)(nil)).Elem(), ComputeNodeDeallocationOption("Requeue"))
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeNodeDeallocationOptionPtrInput)(nil)).Elem(), ComputeNodeDeallocationOption("Requeue"))
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeNodeFillTypeInput)(nil)).Elem(), ComputeNodeFillType("Spread"))
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeNodeFillTypePtrInput)(nil)).Elem(), ComputeNodeFillType("Spread"))
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerTypeInput)(nil)).Elem(), ContainerType("DockerCompatible"))
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerTypePtrInput)(nil)).Elem(), ContainerType("DockerCompatible"))
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerWorkingDirectoryInput)(nil)).Elem(), ContainerWorkingDirectory("TaskWorkingDirectory"))
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerWorkingDirectoryPtrInput)(nil)).Elem(), ContainerWorkingDirectory("TaskWorkingDirectory"))
	pulumi.RegisterInputType(reflect.TypeOf((*ElevationLevelInput)(nil)).Elem(), ElevationLevel("NonAdmin"))
	pulumi.RegisterInputType(reflect.TypeOf((*ElevationLevelPtrInput)(nil)).Elem(), ElevationLevel("NonAdmin"))
	pulumi.RegisterInputType(reflect.TypeOf((*InboundEndpointProtocolInput)(nil)).Elem(), InboundEndpointProtocol("TCP"))
	pulumi.RegisterInputType(reflect.TypeOf((*InboundEndpointProtocolPtrInput)(nil)).Elem(), InboundEndpointProtocol("TCP"))
	pulumi.RegisterInputType(reflect.TypeOf((*InterNodeCommunicationStateInput)(nil)).Elem(), InterNodeCommunicationState("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*InterNodeCommunicationStatePtrInput)(nil)).Elem(), InterNodeCommunicationState("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*LoginModeInput)(nil)).Elem(), LoginMode("Batch"))
	pulumi.RegisterInputType(reflect.TypeOf((*LoginModePtrInput)(nil)).Elem(), LoginMode("Batch"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkSecurityGroupRuleAccessInput)(nil)).Elem(), NetworkSecurityGroupRuleAccess("Allow"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkSecurityGroupRuleAccessPtrInput)(nil)).Elem(), NetworkSecurityGroupRuleAccess("Allow"))
