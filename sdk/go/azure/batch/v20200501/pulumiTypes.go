...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBlobFileSystemConfigurationInput)(nil)).Elem(), AzureBlobFileSystemConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBlobFileSystemConfigurationPtrInput)(nil)).Elem(), AzureBlobFileSystemConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBlobFileSystemConfigurationResponseInput)(nil)).Elem(), AzureBlobFileSystemConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBlobFileSystemConfigurationResponsePtrInput)(nil)).Elem(), AzureBlobFileSystemConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFileShareConfigurationInput)(nil)).Elem(), AzureFileShareConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFileShareConfigurationPtrInput)(nil)).Elem(), AzureFileShareConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFileShareConfigurationResponseInput)(nil)).Elem(), AzureFileShareConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFileShareConfigurationResponsePtrInput)(nil)).Elem(), AzureFileShareConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchAccountIdentityInput)(nil)).Elem(), BatchAccountIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchAccountIdentityPtrInput)(nil)).Elem(), BatchAccountIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchAccountIdentityResponseInput)(nil)).Elem(), BatchAccountIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BatchAccountIdentityResponsePtrInput)(nil)).Elem(), BatchAccountIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CIFSMountConfigurationInput)(nil)).Elem(), CIFSMountConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CIFSMountConfigurationPtrInput)(nil)).Elem(), CIFSMountConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CIFSMountConfigurationResponseInput)(nil)).Elem(), CIFSMountConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CIFSMountConfigurationResponsePtrInput)(nil)).Elem(), CIFSMountConfigurationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MountConfigurationInput)(nil)).Elem(), MountConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MountConfigurationArrayInput)(nil)).Elem(), MountConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MountConfigurationResponseInput)(nil)).Elem(), MountConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MountConfigurationResponseArrayInput)(nil)).Elem(), MountConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NFSMountConfigurationInput)(nil)).Elem(), NFSMountConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NFSMountConfigurationPtrInput)(nil)).Elem(), NFSMountConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NFSMountConfigurationResponseInput)(nil)).Elem(), NFSMountConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NFSMountConfigurationResponsePtrInput)(nil)).Elem(), NFSMountConfigurationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PublicIPAddressConfigurationInput)(nil)).Elem(), PublicIPAddressConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PublicIPAddressConfigurationPtrInput)(nil)).Elem(), PublicIPAddressConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PublicIPAddressConfigurationResponseInput)(nil)).Elem(), PublicIPAddressConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PublicIPAddressConfigurationResponsePtrInput)(nil)).Elem(), PublicIPAddressConfigurationResponseArgs{})
