...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DiskEncryptionTargetInput)(nil)).Elem(), DiskEncryptionTarget("OsDisk"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiskEncryptionTargetPtrInput)(nil)).Elem(), DiskEncryptionTarget("OsDisk"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiskEncryptionTargetArrayInput)(nil)).Elem(), DiskEncryptionTargetArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IPAddressProvisioningTypeInput)(nil)).Elem(), IPAddressProvisioningType("BatchManaged"))
	pulumi.RegisterInputType(reflect.TypeOf((*IPAddressProvisioningTypePtrInput)(nil)).Elem(), IPAddressProvisioningType("BatchManaged"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeySourceInput)(nil)).Elem(), KeySource("Microsoft.Batch"))
	pulumi.RegisterInputType(reflect.TypeOf((*KeySourcePtrInput)(nil)).Elem(), KeySource("Microsoft.Batch"))
