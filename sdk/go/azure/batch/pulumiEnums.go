...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NodePlacementPolicyTypeInput)(nil)).Elem(), NodePlacementPolicyType("Regional"))
	pulumi.RegisterInputType(reflect.TypeOf((*NodePlacementPolicyTypePtrInput)(nil)).Elem(), NodePlacementPolicyType("Regional"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PoolIdentityTypeInput)(nil)).Elem(), PoolIdentityType("UserAssigned"))
	pulumi.RegisterInputType(reflect.TypeOf((*PoolIdentityTypePtrInput)(nil)).Elem(), PoolIdentityType("UserAssigned"))
