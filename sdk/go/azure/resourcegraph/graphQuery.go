...
func NewGraphQuery(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:resourcegraph:GraphQuery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGraphQuery(ctx *pulumi.Context,
	...
	var resource GraphQuery
	err := ctx.ReadResource("azure-nextgen:resourcegraph:GraphQuery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
