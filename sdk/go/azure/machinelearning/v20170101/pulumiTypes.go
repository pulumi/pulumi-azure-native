...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CommitmentPlanInput)(nil)).Elem(), CommitmentPlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CommitmentPlanPtrInput)(nil)).Elem(), CommitmentPlanArgs{})
