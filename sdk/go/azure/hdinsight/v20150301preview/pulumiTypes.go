...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationGetEndpointInput)(nil)).Elem(), ApplicationGetEndpointArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationGetEndpointArrayInput)(nil)).Elem(), ApplicationGetEndpointArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationGetEndpointResponseInput)(nil)).Elem(), ApplicationGetEndpointResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationGetEndpointResponseArrayInput)(nil)).Elem(), ApplicationGetEndpointResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationGetHttpsEndpointInput)(nil)).Elem(), ApplicationGetHttpsEndpointArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationGetHttpsEndpointArrayInput)(nil)).Elem(), ApplicationGetHttpsEndpointArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationGetHttpsEndpointResponseInput)(nil)).Elem(), ApplicationGetHttpsEndpointResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationGetHttpsEndpointResponseArrayInput)(nil)).Elem(), ApplicationGetHttpsEndpointResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPropertiesInput)(nil)).Elem(), ApplicationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPropertiesPtrInput)(nil)).Elem(), ApplicationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPropertiesResponseInput)(nil)).Elem(), ApplicationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationPropertiesResponsePtrInput)(nil)).Elem(), ApplicationPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleCapacityInput)(nil)).Elem(), AutoscaleCapacityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleCapacityPtrInput)(nil)).Elem(), AutoscaleCapacityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleCapacityResponseInput)(nil)).Elem(), AutoscaleCapacityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleCapacityResponsePtrInput)(nil)).Elem(), AutoscaleCapacityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleRecurrenceInput)(nil)).Elem(), AutoscaleRecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleRecurrencePtrInput)(nil)).Elem(), AutoscaleRecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleRecurrenceResponseInput)(nil)).Elem(), AutoscaleRecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleRecurrenceResponsePtrInput)(nil)).Elem(), AutoscaleRecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleResponseInput)(nil)).Elem(), AutoscaleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleResponsePtrInput)(nil)).Elem(), AutoscaleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleScheduleInput)(nil)).Elem(), AutoscaleScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleScheduleArrayInput)(nil)).Elem(), AutoscaleScheduleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleScheduleResponseInput)(nil)).Elem(), AutoscaleScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleScheduleResponseArrayInput)(nil)).Elem(), AutoscaleScheduleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleTimeAndCapacityInput)(nil)).Elem(), AutoscaleTimeAndCapacityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleTimeAndCapacityPtrInput)(nil)).Elem(), AutoscaleTimeAndCapacityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleTimeAndCapacityResponseInput)(nil)).Elem(), AutoscaleTimeAndCapacityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleTimeAndCapacityResponsePtrInput)(nil)).Elem(), AutoscaleTimeAndCapacityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClientGroupInfoInput)(nil)).Elem(), ClientGroupInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClientGroupInfoPtrInput)(nil)).Elem(), ClientGroupInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClientGroupInfoResponseInput)(nil)).Elem(), ClientGroupInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClientGroupInfoResponsePtrInput)(nil)).Elem(), ClientGroupInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterCreatePropertiesInput)(nil)).Elem(), ClusterCreatePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterCreatePropertiesPtrInput)(nil)).Elem(), ClusterCreatePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterDefinitionInput)(nil)).Elem(), ClusterDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterDefinitionPtrInput)(nil)).Elem(), ClusterDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterDefinitionResponseInput)(nil)).Elem(), ClusterDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterDefinitionResponsePtrInput)(nil)).Elem(), ClusterDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterGetPropertiesResponseInput)(nil)).Elem(), ClusterGetPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterGetPropertiesResponsePtrInput)(nil)).Elem(), ClusterGetPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterIdentityResponseInput)(nil)).Elem(), ClusterIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterIdentityResponsePtrInput)(nil)).Elem(), ClusterIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterIdentityResponseUserAssignedIdentitiesInput)(nil)).Elem(), ClusterIdentityResponseUserAssignedIdentitiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterIdentityResponseUserAssignedIdentitiesMapInput)(nil)).Elem(), ClusterIdentityResponseUserAssignedIdentitiesMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterIdentityUserAssignedIdentitiesInput)(nil)).Elem(), ClusterIdentityUserAssignedIdentitiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterIdentityUserAssignedIdentitiesMapInput)(nil)).Elem(), ClusterIdentityUserAssignedIdentitiesMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeIsolationPropertiesInput)(nil)).Elem(), ComputeIsolationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeIsolationPropertiesPtrInput)(nil)).Elem(), ComputeIsolationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeIsolationPropertiesResponseInput)(nil)).Elem(), ComputeIsolationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeIsolationPropertiesResponsePtrInput)(nil)).Elem(), ComputeIsolationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeProfileInput)(nil)).Elem(), ComputeProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeProfilePtrInput)(nil)).Elem(), ComputeProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeProfileResponseInput)(nil)).Elem(), ComputeProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeProfileResponsePtrInput)(nil)).Elem(), ComputeProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityEndpointResponseInput)(nil)).Elem(), ConnectivityEndpointResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityEndpointResponseArrayInput)(nil)).Elem(), ConnectivityEndpointResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDisksGroupsInput)(nil)).Elem(), DataDisksGroupsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDisksGroupsArrayInput)(nil)).Elem(), DataDisksGroupsArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDisksGroupsResponseInput)(nil)).Elem(), DataDisksGroupsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDisksGroupsResponseArrayInput)(nil)).Elem(), DataDisksGroupsResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiskEncryptionPropertiesInput)(nil)).Elem(), DiskEncryptionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiskEncryptionPropertiesPtrInput)(nil)).Elem(), DiskEncryptionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiskEncryptionPropertiesResponseInput)(nil)).Elem(), DiskEncryptionPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiskEncryptionPropertiesResponsePtrInput)(nil)).Elem(), DiskEncryptionPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionInTransitPropertiesInput)(nil)).Elem(), EncryptionInTransitPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionInTransitPropertiesPtrInput)(nil)).Elem(), EncryptionInTransitPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionInTransitPropertiesResponseInput)(nil)).Elem(), EncryptionInTransitPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionInTransitPropertiesResponsePtrInput)(nil)).Elem(), EncryptionInTransitPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ErrorsInput)(nil)).Elem(), ErrorsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ErrorsArrayInput)(nil)).Elem(), ErrorsArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ErrorsResponseInput)(nil)).Elem(), ErrorsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ErrorsResponseArrayInput)(nil)).Elem(), ErrorsResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExcludedServicesConfigResponseInput)(nil)).Elem(), ExcludedServicesConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExcludedServicesConfigResponsePtrInput)(nil)).Elem(), ExcludedServicesConfigResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KafkaRestPropertiesInput)(nil)).Elem(), KafkaRestPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KafkaRestPropertiesPtrInput)(nil)).Elem(), KafkaRestPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KafkaRestPropertiesResponseInput)(nil)).Elem(), KafkaRestPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KafkaRestPropertiesResponsePtrInput)(nil)).Elem(), KafkaRestPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxOperatingSystemProfileInput)(nil)).Elem(), LinuxOperatingSystemProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxOperatingSystemProfilePtrInput)(nil)).Elem(), LinuxOperatingSystemProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxOperatingSystemProfileResponseInput)(nil)).Elem(), LinuxOperatingSystemProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxOperatingSystemProfileResponsePtrInput)(nil)).Elem(), LinuxOperatingSystemProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkPropertiesInput)(nil)).Elem(), NetworkPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkPropertiesPtrInput)(nil)).Elem(), NetworkPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkPropertiesResponseInput)(nil)).Elem(), NetworkPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkPropertiesResponsePtrInput)(nil)).Elem(), NetworkPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*QuotaInfoResponseInput)(nil)).Elem(), QuotaInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QuotaInfoResponsePtrInput)(nil)).Elem(), QuotaInfoResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RoleResponseInput)(nil)).Elem(), RoleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RoleResponseArrayInput)(nil)).Elem(), RoleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuntimeScriptActionInput)(nil)).Elem(), RuntimeScriptActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuntimeScriptActionArrayInput)(nil)).Elem(), RuntimeScriptActionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuntimeScriptActionResponseInput)(nil)).Elem(), RuntimeScriptActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuntimeScriptActionResponseArrayInput)(nil)).Elem(), RuntimeScriptActionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScriptActionInput)(nil)).Elem(), ScriptActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScriptActionArrayInput)(nil)).Elem(), ScriptActionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScriptActionResponseInput)(nil)).Elem(), ScriptActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScriptActionResponseArrayInput)(nil)).Elem(), ScriptActionResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SshProfileInput)(nil)).Elem(), SshProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SshProfilePtrInput)(nil)).Elem(), SshProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SshProfileResponseInput)(nil)).Elem(), SshProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SshProfileResponsePtrInput)(nil)).Elem(), SshProfileResponseArgs{})
