...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*DaysOfWeekInput)(nil)).Elem(), DaysOfWeek("Monday"))
	pulumi.RegisterInputType(reflect.TypeOf((*DaysOfWeekPtrInput)(nil)).Elem(), DaysOfWeek("Monday"))
	pulumi.RegisterInputType(reflect.TypeOf((*DirectoryTypeInput)(nil)).Elem(), DirectoryType("ActiveDirectory"))
	pulumi.RegisterInputType(reflect.TypeOf((*DirectoryTypePtrInput)(nil)).Elem(), DirectoryType("ActiveDirectory"))
	pulumi.RegisterInputType(reflect.TypeOf((*JsonWebKeyEncryptionAlgorithmInput)(nil)).Elem(), JsonWebKeyEncryptionAlgorithm("RSA-OAEP"))
	pulumi.RegisterInputType(reflect.TypeOf((*JsonWebKeyEncryptionAlgorithmPtrInput)(nil)).Elem(), JsonWebKeyEncryptionAlgorithm("RSA-OAEP"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateIPAllocationMethodInput)(nil)).Elem(), PrivateIPAllocationMethod("dynamic"))
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateIPAllocationMethodPtrInput)(nil)).Elem(), PrivateIPAllocationMethod("dynamic"))
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkInput)(nil)).Elem(), PrivateLink("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkPtrInput)(nil)).Elem(), PrivateLink("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkServiceConnectionStatusInput)(nil)).Elem(), PrivateLinkServiceConnectionStatus("Approved"))
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkServiceConnectionStatusPtrInput)(nil)).Elem(), PrivateLinkServiceConnectionStatus("Approved"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceProviderConnectionInput)(nil)).Elem(), ResourceProviderConnection("Inbound"))
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceProviderConnectionPtrInput)(nil)).Elem(), ResourceProviderConnection("Inbound"))
