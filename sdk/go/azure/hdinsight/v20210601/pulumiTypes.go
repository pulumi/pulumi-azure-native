...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkConfigurationInput)(nil)).Elem(), PrivateLinkConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkConfigurationArrayInput)(nil)).Elem(), PrivateLinkConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkConfigurationResponseInput)(nil)).Elem(), PrivateLinkConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkConfigurationResponseArrayInput)(nil)).Elem(), PrivateLinkConfigurationResponseArray{})
