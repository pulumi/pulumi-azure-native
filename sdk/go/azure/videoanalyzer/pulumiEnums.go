...
// EncoderSystemPresetTypeInput is an input type that accepts EncoderSystemPresetTypeArgs and EncoderSystemPresetTypeOutput values.
// You can construct a concrete instance of `EncoderSystemPresetTypeInput` via:
//
//          EncoderSystemPresetTypeArgs{...}
...
// RtspTransportInput is an input type that accepts RtspTransportArgs and RtspTransportOutput values.
// You can construct a concrete instance of `RtspTransportInput` via:
//
//          RtspTransportArgs{...}
...
// VideoScaleModeInput is an input type that accepts VideoScaleModeArgs and VideoScaleModeOutput values.
// You can construct a concrete instance of `VideoScaleModeInput` via:
//
//          VideoScaleModeArgs{...}
