...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncoderSystemPresetTypeInput)(nil)).Elem(), EncoderSystemPresetType("SingleLayer_540p_H264_AAC"))
	pulumi.RegisterInputType(reflect.TypeOf((*EncoderSystemPresetTypePtrInput)(nil)).Elem(), EncoderSystemPresetType("SingleLayer_540p_H264_AAC"))
	pulumi.RegisterInputType(reflect.TypeOf((*KindInput)(nil)).Elem(), Kind("Live"))
	pulumi.RegisterInputType(reflect.TypeOf((*KindPtrInput)(nil)).Elem(), Kind("Live"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RtspTransportInput)(nil)).Elem(), RtspTransport("Http"))
	pulumi.RegisterInputType(reflect.TypeOf((*RtspTransportPtrInput)(nil)).Elem(), RtspTransport("Http"))
	pulumi.RegisterInputType(reflect.TypeOf((*SkuNameInput)(nil)).Elem(), SkuName("Live_S1"))
	pulumi.RegisterInputType(reflect.TypeOf((*SkuNamePtrInput)(nil)).Elem(), SkuName("Live_S1"))
	pulumi.RegisterInputType(reflect.TypeOf((*VideoScaleModeInput)(nil)).Elem(), VideoScaleMode("Pad"))
	pulumi.RegisterInputType(reflect.TypeOf((*VideoScaleModePtrInput)(nil)).Elem(), VideoScaleMode("Pad"))
