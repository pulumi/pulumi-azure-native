...
func NewPipelineTopology(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:videoanalyzer:PipelineTopology"),
		},
	})
	opts = append(opts, aliases)
	var resource PipelineTopology
	err := ctx.RegisterResource("azure-native:videoanalyzer/v20211101preview:PipelineTopology", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPipelineTopology(ctx *pulumi.Context,
	...
	var resource PipelineTopology
	err := ctx.ReadResource("azure-native:videoanalyzer/v20211101preview:PipelineTopology", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
