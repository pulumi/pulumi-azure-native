...
// AudioEncoderAacResponseInput is an input type that accepts AudioEncoderAacResponseArgs and AudioEncoderAacResponseOutput values.
// You can construct a concrete instance of `AudioEncoderAacResponseInput` via:
//
//          AudioEncoderAacResponseArgs{...}
...
// AudioEncoderAacResponsePtrInput is an input type that accepts AudioEncoderAacResponseArgs, AudioEncoderAacResponsePtr and AudioEncoderAacResponsePtrOutput values.
// You can construct a concrete instance of `AudioEncoderAacResponsePtrInput` via:
//
//          AudioEncoderAacResponseArgs{...}
//
//  or:
...
// EncoderCustomPresetResponseInput is an input type that accepts EncoderCustomPresetResponseArgs and EncoderCustomPresetResponseOutput values.
// You can construct a concrete instance of `EncoderCustomPresetResponseInput` via:
//
//          EncoderCustomPresetResponseArgs{...}
...
// EncoderProcessorResponseInput is an input type that accepts EncoderProcessorResponseArgs and EncoderProcessorResponseOutput values.
// You can construct a concrete instance of `EncoderProcessorResponseInput` via:
//
//          EncoderProcessorResponseArgs{...}
...
// EncoderProcessorResponseArrayInput is an input type that accepts EncoderProcessorResponseArray and EncoderProcessorResponseArrayOutput values.
// You can construct a concrete instance of `EncoderProcessorResponseArrayInput` via:
//
//          EncoderProcessorResponseArray{ EncoderProcessorResponseArgs{...} }
...
// EncoderSystemPresetResponseInput is an input type that accepts EncoderSystemPresetResponseArgs and EncoderSystemPresetResponseOutput values.
// You can construct a concrete instance of `EncoderSystemPresetResponseInput` via:
//
//          EncoderSystemPresetResponseArgs{...}
...
// NodeInputResponseInput is an input type that accepts NodeInputResponseArgs and NodeInputResponseOutput values.
// You can construct a concrete instance of `NodeInputResponseInput` via:
//
//          NodeInputResponseArgs{...}
...
// NodeInputResponseArrayInput is an input type that accepts NodeInputResponseArray and NodeInputResponseArrayOutput values.
// You can construct a concrete instance of `NodeInputResponseArrayInput` via:
//
//          NodeInputResponseArray{ NodeInputResponseArgs{...} }
...
// ParameterDeclarationResponseInput is an input type that accepts ParameterDeclarationResponseArgs and ParameterDeclarationResponseOutput values.
// You can construct a concrete instance of `ParameterDeclarationResponseInput` via:
//
//          ParameterDeclarationResponseArgs{...}
...
// ParameterDeclarationResponseArrayInput is an input type that accepts ParameterDeclarationResponseArray and ParameterDeclarationResponseArrayOutput values.
// You can construct a concrete instance of `ParameterDeclarationResponseArrayInput` via:
//
//          ParameterDeclarationResponseArray{ ParameterDeclarationResponseArgs{...} }
...
// ParameterDefinitionResponseArrayInput is an input type that accepts ParameterDefinitionResponseArray and ParameterDefinitionResponseArrayOutput values.
// You can construct a concrete instance of `ParameterDefinitionResponseArrayInput` via:
//
//          ParameterDefinitionResponseArray{ ParameterDefinitionResponseArgs{...} }
...
// PemCertificateListResponseInput is an input type that accepts PemCertificateListResponseArgs and PemCertificateListResponseOutput values.
// You can construct a concrete instance of `PemCertificateListResponseInput` via:
//
//          PemCertificateListResponseArgs{...}
...
// PemCertificateListResponsePtrInput is an input type that accepts PemCertificateListResponseArgs, PemCertificateListResponsePtr and PemCertificateListResponsePtrOutput values.
// You can construct a concrete instance of `PemCertificateListResponsePtrInput` via:
//
//          PemCertificateListResponseArgs{...}
//
//  or:
...
// PipelineJobErrorResponseInput is an input type that accepts PipelineJobErrorResponseArgs and PipelineJobErrorResponseOutput values.
// You can construct a concrete instance of `PipelineJobErrorResponseInput` via:
//
//          PipelineJobErrorResponseArgs{...}
...
// PipelineJobErrorResponsePtrInput is an input type that accepts PipelineJobErrorResponseArgs, PipelineJobErrorResponsePtr and PipelineJobErrorResponsePtrOutput values.
// You can construct a concrete instance of `PipelineJobErrorResponsePtrInput` via:
//
//          PipelineJobErrorResponseArgs{...}
//
//  or:
...
// RtspSourceResponseInput is an input type that accepts RtspSourceResponseArgs and RtspSourceResponseOutput values.
// You can construct a concrete instance of `RtspSourceResponseInput` via:
//
//          RtspSourceResponseArgs{...}
...
// SecureIotDeviceRemoteTunnelResponseInput is an input type that accepts SecureIotDeviceRemoteTunnelResponseArgs and SecureIotDeviceRemoteTunnelResponseOutput values.
// You can construct a concrete instance of `SecureIotDeviceRemoteTunnelResponseInput` via:
//
//          SecureIotDeviceRemoteTunnelResponseArgs{...}
...
// SecureIotDeviceRemoteTunnelResponsePtrInput is an input type that accepts SecureIotDeviceRemoteTunnelResponseArgs, SecureIotDeviceRemoteTunnelResponsePtr and SecureIotDeviceRemoteTunnelResponsePtrOutput values.
// You can construct a concrete instance of `SecureIotDeviceRemoteTunnelResponsePtrInput` via:
//
//          SecureIotDeviceRemoteTunnelResponseArgs{...}
//
//  or:
...
// TlsEndpointResponseInput is an input type that accepts TlsEndpointResponseArgs and TlsEndpointResponseOutput values.
// You can construct a concrete instance of `TlsEndpointResponseInput` via:
//
//          TlsEndpointResponseArgs{...}
...
// TlsValidationOptionsResponseInput is an input type that accepts TlsValidationOptionsResponseArgs and TlsValidationOptionsResponseOutput values.
// You can construct a concrete instance of `TlsValidationOptionsResponseInput` via:
//
//          TlsValidationOptionsResponseArgs{...}
...
// TlsValidationOptionsResponsePtrInput is an input type that accepts TlsValidationOptionsResponseArgs, TlsValidationOptionsResponsePtr and TlsValidationOptionsResponsePtrOutput values.
// You can construct a concrete instance of `TlsValidationOptionsResponsePtrInput` via:
//
//          TlsValidationOptionsResponseArgs{...}
//
//  or:
...
// UnsecuredEndpointResponseInput is an input type that accepts UnsecuredEndpointResponseArgs and UnsecuredEndpointResponseOutput values.
// You can construct a concrete instance of `UnsecuredEndpointResponseInput` via:
//
//          UnsecuredEndpointResponseArgs{...}
...
// UsernamePasswordCredentialsResponseInput is an input type that accepts UsernamePasswordCredentialsResponseArgs and UsernamePasswordCredentialsResponseOutput values.
// You can construct a concrete instance of `UsernamePasswordCredentialsResponseInput` via:
//
//          UsernamePasswordCredentialsResponseArgs{...}
...
// UsernamePasswordCredentialsResponsePtrInput is an input type that accepts UsernamePasswordCredentialsResponseArgs, UsernamePasswordCredentialsResponsePtr and UsernamePasswordCredentialsResponsePtrOutput values.
// You can construct a concrete instance of `UsernamePasswordCredentialsResponsePtrInput` via:
//
//          UsernamePasswordCredentialsResponseArgs{...}
//
//  or:
...
// VideoCreationPropertiesResponseInput is an input type that accepts VideoCreationPropertiesResponseArgs and VideoCreationPropertiesResponseOutput values.
// You can construct a concrete instance of `VideoCreationPropertiesResponseInput` via:
//
//          VideoCreationPropertiesResponseArgs{...}
...
// VideoCreationPropertiesResponsePtrInput is an input type that accepts VideoCreationPropertiesResponseArgs, VideoCreationPropertiesResponsePtr and VideoCreationPropertiesResponsePtrOutput values.
// You can construct a concrete instance of `VideoCreationPropertiesResponsePtrInput` via:
//
//          VideoCreationPropertiesResponseArgs{...}
//
//  or:
...
// VideoEncoderH264ResponseInput is an input type that accepts VideoEncoderH264ResponseArgs and VideoEncoderH264ResponseOutput values.
// You can construct a concrete instance of `VideoEncoderH264ResponseInput` via:
//
//          VideoEncoderH264ResponseArgs{...}
...
// VideoEncoderH264ResponsePtrInput is an input type that accepts VideoEncoderH264ResponseArgs, VideoEncoderH264ResponsePtr and VideoEncoderH264ResponsePtrOutput values.
// You can construct a concrete instance of `VideoEncoderH264ResponsePtrInput` via:
//
//          VideoEncoderH264ResponseArgs{...}
//
//  or:
...
// VideoPublishingOptionsResponseInput is an input type that accepts VideoPublishingOptionsResponseArgs and VideoPublishingOptionsResponseOutput values.
// You can construct a concrete instance of `VideoPublishingOptionsResponseInput` via:
//
//          VideoPublishingOptionsResponseArgs{...}
...
// VideoPublishingOptionsResponsePtrInput is an input type that accepts VideoPublishingOptionsResponseArgs, VideoPublishingOptionsResponsePtr and VideoPublishingOptionsResponsePtrOutput values.
// You can construct a concrete instance of `VideoPublishingOptionsResponsePtrInput` via:
//
//          VideoPublishingOptionsResponseArgs{...}
//
//  or:
...
// VideoScaleResponseInput is an input type that accepts VideoScaleResponseArgs and VideoScaleResponseOutput values.
// You can construct a concrete instance of `VideoScaleResponseInput` via:
//
//          VideoScaleResponseArgs{...}
...
// VideoScaleResponsePtrInput is an input type that accepts VideoScaleResponseArgs, VideoScaleResponsePtr and VideoScaleResponsePtrOutput values.
// You can construct a concrete instance of `VideoScaleResponsePtrInput` via:
//
//          VideoScaleResponseArgs{...}
//
//  or:
...
// VideoSequenceAbsoluteTimeMarkersResponseInput is an input type that accepts VideoSequenceAbsoluteTimeMarkersResponseArgs and VideoSequenceAbsoluteTimeMarkersResponseOutput values.
// You can construct a concrete instance of `VideoSequenceAbsoluteTimeMarkersResponseInput` via:
//
//          VideoSequenceAbsoluteTimeMarkersResponseArgs{...}
...
// VideoSinkResponseInput is an input type that accepts VideoSinkResponseArgs and VideoSinkResponseOutput values.
// You can construct a concrete instance of `VideoSinkResponseInput` via:
//
//          VideoSinkResponseArgs{...}
...
// VideoSinkResponseArrayInput is an input type that accepts VideoSinkResponseArray and VideoSinkResponseArrayOutput values.
// You can construct a concrete instance of `VideoSinkResponseArrayInput` via:
//
//          VideoSinkResponseArray{ VideoSinkResponseArgs{...} }
...
// VideoSourceResponseInput is an input type that accepts VideoSourceResponseArgs and VideoSourceResponseOutput values.
// You can construct a concrete instance of `VideoSourceResponseInput` via:
//
//          VideoSourceResponseArgs{...}
