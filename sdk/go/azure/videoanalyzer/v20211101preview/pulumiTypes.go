...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GroupLevelAccessControlInput)(nil)).Elem(), GroupLevelAccessControlArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GroupLevelAccessControlPtrInput)(nil)).Elem(), GroupLevelAccessControlArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GroupLevelAccessControlResponseInput)(nil)).Elem(), GroupLevelAccessControlResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GroupLevelAccessControlResponsePtrInput)(nil)).Elem(), GroupLevelAccessControlResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubInput)(nil)).Elem(), IotHubArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubArrayInput)(nil)).Elem(), IotHubArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubResponseInput)(nil)).Elem(), IotHubResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubResponseArrayInput)(nil)).Elem(), IotHubResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkAccessControlInput)(nil)).Elem(), NetworkAccessControlArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkAccessControlPtrInput)(nil)).Elem(), NetworkAccessControlArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkAccessControlResponseInput)(nil)).Elem(), NetworkAccessControlResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkAccessControlResponsePtrInput)(nil)).Elem(), NetworkAccessControlResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VideoArchivalInput)(nil)).Elem(), VideoArchivalArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VideoArchivalPtrInput)(nil)).Elem(), VideoArchivalArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VideoArchivalResponseInput)(nil)).Elem(), VideoArchivalResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VideoArchivalResponsePtrInput)(nil)).Elem(), VideoArchivalResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VideoContentUrlsResponseInput)(nil)).Elem(), VideoContentUrlsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VideoContentUrlsResponsePtrInput)(nil)).Elem(), VideoContentUrlsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VideoPreviewImageUrlsResponsePtrInput)(nil)).Elem(), VideoPreviewImageUrlsResponseArgs{})
