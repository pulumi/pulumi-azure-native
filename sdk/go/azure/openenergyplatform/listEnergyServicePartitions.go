...
type ListEnergyServicePartitionsResult struct {
	...
	Value []DataPartitionPropertiesResponse `pulumi:"value"`
}
...
// List of data partitions along with their properties in a given OEP resource.
func (o ListEnergyServicePartitionsResultOutput) Value() DataPartitionPropertiesResponseArrayOutput {
	return o.ApplyT(func(v ListEnergyServicePartitionsResult) []DataPartitionPropertiesResponse { return v.Value }).(DataPartitionPropertiesResponseArrayOutput)
}
