...
func NewEnergyService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:openenergyplatform/v20220404preview:EnergyService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnergyService(ctx *pulumi.Context,
	...
	var resource EnergyService
	err := ctx.ReadResource("azure-native:openenergyplatform/v20220404preview:EnergyService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
