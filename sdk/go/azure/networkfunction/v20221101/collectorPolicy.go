...
func NewCollectorPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkfunction/v20221101:CollectorPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCollectorPolicy(ctx *pulumi.Context,
	...
	var resource CollectorPolicy
	err := ctx.ReadResource("azure-native:networkfunction/v20221101:CollectorPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
