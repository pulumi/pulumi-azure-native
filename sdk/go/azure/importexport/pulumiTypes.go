...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryPackageInformationInput)(nil)).Elem(), DeliveryPackageInformationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryPackageInformationPtrInput)(nil)).Elem(), DeliveryPackageInformationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryPackageInformationResponseInput)(nil)).Elem(), DeliveryPackageInformationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryPackageInformationResponsePtrInput)(nil)).Elem(), DeliveryPackageInformationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DriveBitLockerKeyResponseInput)(nil)).Elem(), DriveBitLockerKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DriveBitLockerKeyResponseArrayInput)(nil)).Elem(), DriveBitLockerKeyResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DriveStatusInput)(nil)).Elem(), DriveStatusArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DriveStatusArrayInput)(nil)).Elem(), DriveStatusArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DriveStatusResponseInput)(nil)).Elem(), DriveStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DriveStatusResponseArrayInput)(nil)).Elem(), DriveStatusResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionKeyDetailsInput)(nil)).Elem(), EncryptionKeyDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionKeyDetailsPtrInput)(nil)).Elem(), EncryptionKeyDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionKeyDetailsResponseInput)(nil)).Elem(), EncryptionKeyDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionKeyDetailsResponsePtrInput)(nil)).Elem(), EncryptionKeyDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportInput)(nil)).Elem(), ExportArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportPtrInput)(nil)).Elem(), ExportArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportResponseInput)(nil)).Elem(), ExportResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportResponsePtrInput)(nil)).Elem(), ExportResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IdentityDetailsResponseInput)(nil)).Elem(), IdentityDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IdentityDetailsResponsePtrInput)(nil)).Elem(), IdentityDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobDetailsInput)(nil)).Elem(), JobDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobDetailsPtrInput)(nil)).Elem(), JobDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobDetailsResponseInput)(nil)).Elem(), JobDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobDetailsResponsePtrInput)(nil)).Elem(), JobDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PackageInformationInput)(nil)).Elem(), PackageInformationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PackageInformationPtrInput)(nil)).Elem(), PackageInformationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PackageInformationResponseInput)(nil)).Elem(), PackageInformationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PackageInformationResponsePtrInput)(nil)).Elem(), PackageInformationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReturnAddressInput)(nil)).Elem(), ReturnAddressArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReturnAddressPtrInput)(nil)).Elem(), ReturnAddressArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReturnAddressResponseInput)(nil)).Elem(), ReturnAddressResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReturnAddressResponsePtrInput)(nil)).Elem(), ReturnAddressResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReturnShippingInput)(nil)).Elem(), ReturnShippingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReturnShippingPtrInput)(nil)).Elem(), ReturnShippingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReturnShippingResponseInput)(nil)).Elem(), ReturnShippingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReturnShippingResponsePtrInput)(nil)).Elem(), ReturnShippingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ShippingInformationInput)(nil)).Elem(), ShippingInformationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ShippingInformationPtrInput)(nil)).Elem(), ShippingInformationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ShippingInformationResponseInput)(nil)).Elem(), ShippingInformationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ShippingInformationResponsePtrInput)(nil)).Elem(), ShippingInformationResponseArgs{})
