...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PackageInfomationInput)(nil)).Elem(), PackageInfomationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PackageInfomationPtrInput)(nil)).Elem(), PackageInfomationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PackageInfomationResponseInput)(nil)).Elem(), PackageInfomationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PackageInfomationResponsePtrInput)(nil)).Elem(), PackageInfomationResponseArgs{})
