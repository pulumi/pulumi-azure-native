...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*DFPInstanceAdministratorsInput)(nil)).Elem(), DFPInstanceAdministratorsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DFPInstanceAdministratorsPtrInput)(nil)).Elem(), DFPInstanceAdministratorsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DFPInstanceAdministratorsResponseInput)(nil)).Elem(), DFPInstanceAdministratorsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DFPInstanceAdministratorsResponsePtrInput)(nil)).Elem(), DFPInstanceAdministratorsResponseArgs{})
