...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CustomProfileInput)(nil)).Elem(), CustomProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomProfilePtrInput)(nil)).Elem(), CustomProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomProfileResponseInput)(nil)).Elem(), CustomProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomProfileResponsePtrInput)(nil)).Elem(), CustomProfileResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionRoleConfigurationInput)(nil)).Elem(), NetworkFunctionRoleConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionRoleConfigurationArrayInput)(nil)).Elem(), NetworkFunctionRoleConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionRoleConfigurationResponseInput)(nil)).Elem(), NetworkFunctionRoleConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionRoleConfigurationResponseArrayInput)(nil)).Elem(), NetworkFunctionRoleConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionTemplateInput)(nil)).Elem(), NetworkFunctionTemplateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionTemplatePtrInput)(nil)).Elem(), NetworkFunctionTemplateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionTemplateResponseInput)(nil)).Elem(), NetworkFunctionTemplateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionTemplateResponsePtrInput)(nil)).Elem(), NetworkFunctionTemplateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionUserConfigurationInput)(nil)).Elem(), NetworkFunctionUserConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionUserConfigurationArrayInput)(nil)).Elem(), NetworkFunctionUserConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionUserConfigurationOsProfileInput)(nil)).Elem(), NetworkFunctionUserConfigurationOsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionUserConfigurationOsProfilePtrInput)(nil)).Elem(), NetworkFunctionUserConfigurationOsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionUserConfigurationResponseInput)(nil)).Elem(), NetworkFunctionUserConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionUserConfigurationResponseArrayInput)(nil)).Elem(), NetworkFunctionUserConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionUserConfigurationResponseOsProfileInput)(nil)).Elem(), NetworkFunctionUserConfigurationResponseOsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkFunctionUserConfigurationResponseOsProfilePtrInput)(nil)).Elem(), NetworkFunctionUserConfigurationResponseOsProfileArgs{})
