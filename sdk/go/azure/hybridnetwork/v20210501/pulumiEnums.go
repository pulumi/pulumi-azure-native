...
// NetworkFunctionTypeInput is an input type that accepts NetworkFunctionTypeArgs and NetworkFunctionTypeOutput values.
// You can construct a concrete instance of `NetworkFunctionTypeInput` via:
//
//          NetworkFunctionTypeArgs{...}
