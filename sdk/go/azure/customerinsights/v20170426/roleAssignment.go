...
func NewRoleAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:customerinsights/v20170426:RoleAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoleAssignment(ctx *pulumi.Context,
	...
	var resource RoleAssignment
	err := ctx.ReadResource("azure-nextgen:customerinsights/v20170426:RoleAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
