...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AssignmentPrincipalInput)(nil)).Elem(), AssignmentPrincipalArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AssignmentPrincipalArrayInput)(nil)).Elem(), AssignmentPrincipalArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AssignmentPrincipalResponseInput)(nil)).Elem(), AssignmentPrincipalResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AssignmentPrincipalResponseArrayInput)(nil)).Elem(), AssignmentPrincipalResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CanonicalProfileDefinitionResponseInput)(nil)).Elem(), CanonicalProfileDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CanonicalProfileDefinitionResponseArrayInput)(nil)).Elem(), CanonicalProfileDefinitionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CanonicalProfileDefinitionResponsePropertiesInput)(nil)).Elem(), CanonicalProfileDefinitionResponsePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CanonicalProfileDefinitionResponsePropertiesArrayInput)(nil)).Elem(), CanonicalProfileDefinitionResponsePropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingAvailabilityInput)(nil)).Elem(), ConnectorMappingAvailabilityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingAvailabilityPtrInput)(nil)).Elem(), ConnectorMappingAvailabilityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingAvailabilityResponseInput)(nil)).Elem(), ConnectorMappingAvailabilityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingAvailabilityResponsePtrInput)(nil)).Elem(), ConnectorMappingAvailabilityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingCompleteOperationInput)(nil)).Elem(), ConnectorMappingCompleteOperationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingCompleteOperationPtrInput)(nil)).Elem(), ConnectorMappingCompleteOperationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingCompleteOperationResponseInput)(nil)).Elem(), ConnectorMappingCompleteOperationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingCompleteOperationResponsePtrInput)(nil)).Elem(), ConnectorMappingCompleteOperationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingErrorManagementInput)(nil)).Elem(), ConnectorMappingErrorManagementArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingErrorManagementPtrInput)(nil)).Elem(), ConnectorMappingErrorManagementArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingErrorManagementResponseInput)(nil)).Elem(), ConnectorMappingErrorManagementResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingErrorManagementResponsePtrInput)(nil)).Elem(), ConnectorMappingErrorManagementResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingFormatInput)(nil)).Elem(), ConnectorMappingFormatArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingFormatPtrInput)(nil)).Elem(), ConnectorMappingFormatArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingFormatResponseInput)(nil)).Elem(), ConnectorMappingFormatResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingFormatResponsePtrInput)(nil)).Elem(), ConnectorMappingFormatResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingPropertiesInput)(nil)).Elem(), ConnectorMappingPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingPropertiesPtrInput)(nil)).Elem(), ConnectorMappingPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingPropertiesResponseInput)(nil)).Elem(), ConnectorMappingPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingPropertiesResponsePtrInput)(nil)).Elem(), ConnectorMappingPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingStructureInput)(nil)).Elem(), ConnectorMappingStructureArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingStructureArrayInput)(nil)).Elem(), ConnectorMappingStructureArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingStructureResponseInput)(nil)).Elem(), ConnectorMappingStructureResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorMappingStructureResponseArrayInput)(nil)).Elem(), ConnectorMappingStructureResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataSourcePrecedenceResponseInput)(nil)).Elem(), DataSourcePrecedenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataSourcePrecedenceResponseArrayInput)(nil)).Elem(), DataSourcePrecedenceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HubBillingInfoFormatInput)(nil)).Elem(), HubBillingInfoFormatArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HubBillingInfoFormatPtrInput)(nil)).Elem(), HubBillingInfoFormatArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HubBillingInfoFormatResponseInput)(nil)).Elem(), HubBillingInfoFormatResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HubBillingInfoFormatResponsePtrInput)(nil)).Elem(), HubBillingInfoFormatResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiAliasInput)(nil)).Elem(), KpiAliasArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiAliasArrayInput)(nil)).Elem(), KpiAliasArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiAliasResponseInput)(nil)).Elem(), KpiAliasResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiAliasResponseArrayInput)(nil)).Elem(), KpiAliasResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiExtractInput)(nil)).Elem(), KpiExtractArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiExtractArrayInput)(nil)).Elem(), KpiExtractArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiExtractResponseInput)(nil)).Elem(), KpiExtractResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiExtractResponseArrayInput)(nil)).Elem(), KpiExtractResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiGroupByMetadataResponseInput)(nil)).Elem(), KpiGroupByMetadataResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiGroupByMetadataResponseArrayInput)(nil)).Elem(), KpiGroupByMetadataResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiParticipantProfilesMetadataResponseInput)(nil)).Elem(), KpiParticipantProfilesMetadataResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiParticipantProfilesMetadataResponseArrayInput)(nil)).Elem(), KpiParticipantProfilesMetadataResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiThresholdsInput)(nil)).Elem(), KpiThresholdsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiThresholdsPtrInput)(nil)).Elem(), KpiThresholdsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiThresholdsResponseInput)(nil)).Elem(), KpiThresholdsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KpiThresholdsResponsePtrInput)(nil)).Elem(), KpiThresholdsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParticipantProfilePropertyReferenceInput)(nil)).Elem(), ParticipantProfilePropertyReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParticipantProfilePropertyReferenceArrayInput)(nil)).Elem(), ParticipantProfilePropertyReferenceArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParticipantProfilePropertyReferenceResponseInput)(nil)).Elem(), ParticipantProfilePropertyReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParticipantProfilePropertyReferenceResponseArrayInput)(nil)).Elem(), ParticipantProfilePropertyReferenceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParticipantPropertyReferenceInput)(nil)).Elem(), ParticipantPropertyReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParticipantPropertyReferenceArrayInput)(nil)).Elem(), ParticipantPropertyReferenceArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParticipantPropertyReferenceResponseInput)(nil)).Elem(), ParticipantPropertyReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParticipantPropertyReferenceResponseArrayInput)(nil)).Elem(), ParticipantPropertyReferenceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionDistributionDefinitionResponseInput)(nil)).Elem(), PredictionDistributionDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionDistributionDefinitionResponseDistributionsInput)(nil)).Elem(), PredictionDistributionDefinitionResponseDistributionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionDistributionDefinitionResponseDistributionsArrayInput)(nil)).Elem(), PredictionDistributionDefinitionResponseDistributionsArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionGradesInput)(nil)).Elem(), PredictionGradesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionGradesArrayInput)(nil)).Elem(), PredictionGradesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionMappingsInput)(nil)).Elem(), PredictionMappingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionMappingsPtrInput)(nil)).Elem(), PredictionMappingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionResponseGradesInput)(nil)).Elem(), PredictionResponseGradesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionResponseGradesArrayInput)(nil)).Elem(), PredictionResponseGradesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionResponseMappingsInput)(nil)).Elem(), PredictionResponseMappingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionResponseMappingsPtrInput)(nil)).Elem(), PredictionResponseMappingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionResponseSystemGeneratedEntitiesInput)(nil)).Elem(), PredictionResponseSystemGeneratedEntitiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictionResponseSystemGeneratedEntitiesPtrInput)(nil)).Elem(), PredictionResponseSystemGeneratedEntitiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProfileEnumValidValuesFormatInput)(nil)).Elem(), ProfileEnumValidValuesFormatArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProfileEnumValidValuesFormatArrayInput)(nil)).Elem(), ProfileEnumValidValuesFormatArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProfileEnumValidValuesFormatResponseInput)(nil)).Elem(), ProfileEnumValidValuesFormatResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProfileEnumValidValuesFormatResponseArrayInput)(nil)).Elem(), ProfileEnumValidValuesFormatResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertyDefinitionInput)(nil)).Elem(), PropertyDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertyDefinitionArrayInput)(nil)).Elem(), PropertyDefinitionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertyDefinitionResponseInput)(nil)).Elem(), PropertyDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PropertyDefinitionResponseArrayInput)(nil)).Elem(), PropertyDefinitionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RelationshipLinkFieldMappingInput)(nil)).Elem(), RelationshipLinkFieldMappingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RelationshipLinkFieldMappingArrayInput)(nil)).Elem(), RelationshipLinkFieldMappingArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RelationshipLinkFieldMappingResponseInput)(nil)).Elem(), RelationshipLinkFieldMappingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RelationshipLinkFieldMappingResponseArrayInput)(nil)).Elem(), RelationshipLinkFieldMappingResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RelationshipTypeFieldMappingInput)(nil)).Elem(), RelationshipTypeFieldMappingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RelationshipTypeFieldMappingArrayInput)(nil)).Elem(), RelationshipTypeFieldMappingArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RelationshipTypeFieldMappingResponseInput)(nil)).Elem(), RelationshipTypeFieldMappingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RelationshipTypeFieldMappingResponseArrayInput)(nil)).Elem(), RelationshipTypeFieldMappingResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RelationshipTypeMappingInput)(nil)).Elem(), RelationshipTypeMappingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RelationshipTypeMappingArrayInput)(nil)).Elem(), RelationshipTypeMappingArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RelationshipTypeMappingResponseInput)(nil)).Elem(), RelationshipTypeMappingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RelationshipTypeMappingResponseArrayInput)(nil)).Elem(), RelationshipTypeMappingResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceSetDescriptionInput)(nil)).Elem(), ResourceSetDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceSetDescriptionPtrInput)(nil)).Elem(), ResourceSetDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceSetDescriptionResponseInput)(nil)).Elem(), ResourceSetDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceSetDescriptionResponsePtrInput)(nil)).Elem(), ResourceSetDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StrongIdInput)(nil)).Elem(), StrongIdArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StrongIdArrayInput)(nil)).Elem(), StrongIdArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*StrongIdResponseInput)(nil)).Elem(), StrongIdResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StrongIdResponseArrayInput)(nil)).Elem(), StrongIdResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TypePropertiesMappingInput)(nil)).Elem(), TypePropertiesMappingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TypePropertiesMappingArrayInput)(nil)).Elem(), TypePropertiesMappingArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TypePropertiesMappingResponseInput)(nil)).Elem(), TypePropertiesMappingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TypePropertiesMappingResponseArrayInput)(nil)).Elem(), TypePropertiesMappingResponseArray{})
