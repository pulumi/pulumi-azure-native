...
func NewLink(ctx *pulumi.Context,
	...
	var resource Link
	err := ctx.RegisterResource("azure-nextgen:customerinsights/v20170426:Link", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLink(ctx *pulumi.Context,
	...
	var resource Link
	err := ctx.ReadResource("azure-nextgen:customerinsights/v20170426:Link", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type LinkState struct {
	...
	// Name of the source Entity Type.
	SourceEntityTypeName pulumi.StringPtrInput
	// Type of target entity.
	TargetEntityType pulumi.StringPtrInput
	// Name of the target Entity Type.
	TargetEntityTypeName pulumi.StringPtrInput
	// The hub name.
