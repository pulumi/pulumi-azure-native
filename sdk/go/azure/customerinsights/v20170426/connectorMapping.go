...
func NewConnectorMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:customerinsights/v20170426:ConnectorMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectorMapping(ctx *pulumi.Context,
	...
	var resource ConnectorMapping
	err := ctx.ReadResource("azure-nextgen:customerinsights/v20170426:ConnectorMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
