...
func NewHub(ctx *pulumi.Context,
	...
	var resource Hub
	err := ctx.RegisterResource("azure-nextgen:customerinsights/v20170101:Hub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHub(ctx *pulumi.Context,
	...
	var resource Hub
	err := ctx.ReadResource("azure-nextgen:customerinsights/v20170101:Hub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
