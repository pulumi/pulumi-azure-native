...
// The interaction property that maps to the profile property.
func (o ParticipantPropertyReferenceInvokeResponseOutput) InteractionPropertyName() pulumi.StringOutput {
	return o.ApplyT(func(v ParticipantPropertyReferenceInvokeResponse) string { return v.InteractionPropertyName }).(pulumi.StringOutput)
}

// The profile property that maps to the interaction property.
func (o ParticipantPropertyReferenceInvokeResponseOutput) ProfilePropertyName() pulumi.StringOutput {
	return o.ApplyT(func(v ParticipantPropertyReferenceInvokeResponse) string { return v.ProfilePropertyName }).(pulumi.StringOutput)
}
...
//  Property name on the source Interaction Type.
func (o TypePropertiesMappingInvokeResponseOutput) InteractionTypePropertyName() pulumi.StringOutput {
	return o.ApplyT(func(v TypePropertiesMappingInvokeResponse) string { return v.InteractionTypePropertyName }).(pulumi.StringOutput)
}

// Flag to indicate whether the Profile Type property is an id on the Profile Type.
func (o TypePropertiesMappingInvokeResponseOutput) IsProfileTypeId() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v TypePropertiesMappingInvokeResponse) *bool { return v.IsProfileTypeId }).(pulumi.BoolPtrOutput)
}
...
// Property name on the target Profile Type.
func (o TypePropertiesMappingInvokeResponseOutput) ProfileTypePropertyName() pulumi.StringOutput {
	return o.ApplyT(func(v TypePropertiesMappingInvokeResponse) string { return v.ProfileTypePropertyName }).(pulumi.StringOutput)
}
