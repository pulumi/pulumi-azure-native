...
// ConnectorTypesInput is an input type that accepts ConnectorTypesArgs and ConnectorTypesOutput values.
// You can construct a concrete instance of `ConnectorTypesInput` via:
//
//          ConnectorTypesArgs{...}
