...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CalculationWindowTypesInput)(nil)).Elem(), CalculationWindowTypes("Lifetime"))
	pulumi.RegisterInputType(reflect.TypeOf((*CalculationWindowTypesPtrInput)(nil)).Elem(), CalculationWindowTypes("Lifetime"))
	pulumi.RegisterInputType(reflect.TypeOf((*CardinalityTypesInput)(nil)).Elem(), CardinalityTypes("OneToOne"))
	pulumi.RegisterInputType(reflect.TypeOf((*CardinalityTypesPtrInput)(nil)).Elem(), CardinalityTypes("OneToOne"))
	pulumi.RegisterInputType(reflect.TypeOf((*CompletionOperationTypesInput)(nil)).Elem(), CompletionOperationTypes("DoNothing"))
	pulumi.RegisterInputType(reflect.TypeOf((*CompletionOperationTypesPtrInput)(nil)).Elem(), CompletionOperationTypes("DoNothing"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorTypesInput)(nil)).Elem(), ConnectorTypes("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectorTypesPtrInput)(nil)).Elem(), ConnectorTypes("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*EntityTypeInput)(nil)).Elem(), EntityType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*EntityTypePtrInput)(nil)).Elem(), EntityType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*EntityTypesInput)(nil)).Elem(), EntityTypes("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*EntityTypesPtrInput)(nil)).Elem(), EntityTypes("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*ErrorManagementTypesInput)(nil)).Elem(), ErrorManagementTypes("RejectAndContinue"))
	pulumi.RegisterInputType(reflect.TypeOf((*ErrorManagementTypesPtrInput)(nil)).Elem(), ErrorManagementTypes("RejectAndContinue"))
	pulumi.RegisterInputType(reflect.TypeOf((*FormatTypesInput)(nil)).Elem(), FormatTypes("TextFormat"))
	pulumi.RegisterInputType(reflect.TypeOf((*FormatTypesPtrInput)(nil)).Elem(), FormatTypes("TextFormat"))
	pulumi.RegisterInputType(reflect.TypeOf((*FrequencyTypesInput)(nil)).Elem(), FrequencyTypes("Minute"))
	pulumi.RegisterInputType(reflect.TypeOf((*FrequencyTypesPtrInput)(nil)).Elem(), FrequencyTypes("Minute"))
	pulumi.RegisterInputType(reflect.TypeOf((*InstanceOperationTypeInput)(nil)).Elem(), InstanceOperationType("Upsert"))
	pulumi.RegisterInputType(reflect.TypeOf((*InstanceOperationTypePtrInput)(nil)).Elem(), InstanceOperationType("Upsert"))
	pulumi.RegisterInputType(reflect.TypeOf((*KpiFunctionsInput)(nil)).Elem(), KpiFunctions("Sum"))
	pulumi.RegisterInputType(reflect.TypeOf((*KpiFunctionsPtrInput)(nil)).Elem(), KpiFunctions("Sum"))
	pulumi.RegisterInputType(reflect.TypeOf((*LinkTypesInput)(nil)).Elem(), LinkTypes("UpdateAlways"))
	pulumi.RegisterInputType(reflect.TypeOf((*LinkTypesPtrInput)(nil)).Elem(), LinkTypes("UpdateAlways"))
	pulumi.RegisterInputType(reflect.TypeOf((*RoleTypesInput)(nil)).Elem(), RoleTypes("Admin"))
	pulumi.RegisterInputType(reflect.TypeOf((*RoleTypesPtrInput)(nil)).Elem(), RoleTypes("Admin"))
