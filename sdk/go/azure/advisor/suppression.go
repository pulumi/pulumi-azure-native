...
func NewSuppression(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:advisor:Suppression", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSuppression(ctx *pulumi.Context,
	...
	var resource Suppression
	err := ctx.ReadResource("azure-nextgen:advisor:Suppression", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
