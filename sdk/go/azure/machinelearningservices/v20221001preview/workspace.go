...
type Workspace struct {
	...
	ScheduledPurgeDate              pulumi.StringOutput                              `pulumi:"scheduledPurgeDate"`
	...
	SoftDeletedAt                   pulumi.StringOutput                              `pulumi:"softDeletedAt"`
...
func NewWorkspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20221001preview:Workspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspace(ctx *pulumi.Context,
	...
	var resource Workspace
	err := ctx.ReadResource("azure-native:machinelearningservices/v20221001preview:Workspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o WorkspaceOutput) ScheduledPurgeDate() pulumi.StringOutput {
	return o.ApplyT(func(v *Workspace) pulumi.StringOutput { return v.ScheduledPurgeDate }).(pulumi.StringOutput)
}
...
func (o WorkspaceOutput) SoftDeletedAt() pulumi.StringOutput {
	return o.ApplyT(func(v *Workspace) pulumi.StringOutput { return v.SoftDeletedAt }).(pulumi.StringOutput)
}
