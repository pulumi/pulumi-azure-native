...
func (ContentsType) ElementType() reflect.Type {
	return reflect.TypeOf((*ContentsType)(nil)).Elem()
}

func (e ContentsType) ToContentsTypeOutput() ContentsTypeOutput {
	return pulumi.ToOutput(e).(ContentsTypeOutput)
}

func (e ContentsType) ToContentsTypeOutputWithContext(ctx context.Context) ContentsTypeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(ContentsTypeOutput)
}

func (e ContentsType) ToContentsTypePtrOutput() ContentsTypePtrOutput {
	return e.ToContentsTypePtrOutputWithContext(context.Background())
}

func (e ContentsType) ToContentsTypePtrOutputWithContext(ctx context.Context) ContentsTypePtrOutput {
	return ContentsType(e).ToContentsTypeOutputWithContext(ctx).ToContentsTypePtrOutputWithContext(ctx)
}

func (e ContentsType) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e ContentsType) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e ContentsType) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e ContentsType) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type ContentsTypeOutput struct{ *pulumi.OutputState }

func (ContentsTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ContentsType)(nil)).Elem()
}

func (o ContentsTypeOutput) ToContentsTypeOutput() ContentsTypeOutput {
	return o
}

func (o ContentsTypeOutput) ToContentsTypeOutputWithContext(ctx context.Context) ContentsTypeOutput {
	return o
}

func (o ContentsTypeOutput) ToContentsTypePtrOutput() ContentsTypePtrOutput {
	return o.ToContentsTypePtrOutputWithContext(context.Background())
}

func (o ContentsTypeOutput) ToContentsTypePtrOutputWithContext(ctx context.Context) ContentsTypePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ContentsType) *ContentsType {
		return &v
	}).(ContentsTypePtrOutput)
}

func (o ContentsTypeOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o ContentsTypeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ContentsType) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o ContentsTypeOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ContentsTypeOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ContentsType) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type ContentsTypePtrOutput struct{ *pulumi.OutputState }

func (ContentsTypePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ContentsType)(nil)).Elem()
}

func (o ContentsTypePtrOutput) ToContentsTypePtrOutput() ContentsTypePtrOutput {
	return o
}

func (o ContentsTypePtrOutput) ToContentsTypePtrOutputWithContext(ctx context.Context) ContentsTypePtrOutput {
	return o
}

func (o ContentsTypePtrOutput) Elem() ContentsTypeOutput {
	return o.ApplyT(func(v *ContentsType) ContentsType {
		if v != nil {
			return *v
		}
		var ret ContentsType
		return ret
	}).(ContentsTypeOutput)
}

func (o ContentsTypePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ContentsTypePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *ContentsType) *string {
		if e == nil {
			return nil
		}
...
type ContentsTypeInput interface {
	pulumi.Input

	ToContentsTypeOutput() ContentsTypeOutput
	ToContentsTypeOutputWithContext(context.Context) ContentsTypeOutput
}

var contentsTypePtrType = reflect.TypeOf((**ContentsType)(nil)).Elem()

type ContentsTypePtrInput interface {
	pulumi.Input

	ToContentsTypePtrOutput() ContentsTypePtrOutput
	ToContentsTypePtrOutputWithContext(context.Context) ContentsTypePtrOutput
}

type contentsTypePtr string

func ContentsTypePtr(v string) ContentsTypePtrInput {
	return (*contentsTypePtr)(&v)
}

func (*contentsTypePtr) ElementType() reflect.Type {
	return contentsTypePtrType
}

func (in *contentsTypePtr) ToContentsTypePtrOutput() ContentsTypePtrOutput {
	return pulumi.ToOutput(in).(ContentsTypePtrOutput)
}

func (in *contentsTypePtr) ToContentsTypePtrOutputWithContext(ctx context.Context) ContentsTypePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(ContentsTypePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ComputePowerActionInput)(nil)).Elem(), ComputePowerAction("Start"))
	pulumi.RegisterInputType(reflect.TypeOf((*ComputePowerActionPtrInput)(nil)).Elem(), ComputePowerAction("Start"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ContentsTypeInput)(nil)).Elem(), ContentsType("AzureBlob"))
	pulumi.RegisterInputType(reflect.TypeOf((*ContentsTypePtrInput)(nil)).Elem(), ContentsType("AzureBlob"))
	pulumi.RegisterInputType(reflect.TypeOf((*CredentialsTypeInput)(nil)).Elem(), CredentialsType("AccountKey"))
	pulumi.RegisterInputType(reflect.TypeOf((*CredentialsTypePtrInput)(nil)).Elem(), CredentialsType("AccountKey"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetTypeInput)(nil)).Elem(), DatasetType("Simple"))
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetTypePtrInput)(nil)).Elem(), DatasetType("Simple"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OriginTypeInput)(nil)).Elem(), OriginType("Synapse"))
	pulumi.RegisterInputType(reflect.TypeOf((*OriginTypePtrInput)(nil)).Elem(), OriginType("Synapse"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SecretsTypeInput)(nil)).Elem(), SecretsType("AccountKey"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecretsTypePtrInput)(nil)).Elem(), SecretsType("AccountKey"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TextAnnotationTypeInput)(nil)).Elem(), TextAnnotationType("Classification"))
	pulumi.RegisterInputType(reflect.TypeOf((*TextAnnotationTypePtrInput)(nil)).Elem(), TextAnnotationType("Classification"))
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerTypeInput)(nil)).Elem(), TriggerType("Recurrence"))
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerTypePtrInput)(nil)).Elem(), TriggerType("Recurrence"))
	...
	pulumi.RegisterOutputType(ContentsTypeOutput{})
	pulumi.RegisterOutputType(ContentsTypePtrOutput{})
