...
func NewCodeVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:machinelearningservices/v20210301preview:CodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices:CodeVersion"),
		},
		{
			Type: pulumi.String("azure-nextgen:machinelearningservices:CodeVersion"),
		},
	})
	opts = append(opts, aliases)
	var resource CodeVersion
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20210301preview:CodeVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCodeVersion(ctx *pulumi.Context,
	...
	var resource CodeVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20210301preview:CodeVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
