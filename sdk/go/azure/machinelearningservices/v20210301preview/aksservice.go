...
func NewAKSService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20210301preview:AKSService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAKSService(ctx *pulumi.Context,
	...
	var resource AKSService
	err := ctx.ReadResource("azure-native:machinelearningservices/v20210301preview:AKSService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
