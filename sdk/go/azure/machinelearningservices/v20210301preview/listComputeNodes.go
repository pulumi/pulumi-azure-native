...
func (o ListComputeNodesResultOutput) ComputeType() pulumi.StringOutput {
	return o.ApplyT(func(v ListComputeNodesResult) string { return v.ComputeType }).(pulumi.StringOutput)
}
