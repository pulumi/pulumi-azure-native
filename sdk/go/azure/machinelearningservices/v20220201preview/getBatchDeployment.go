...
func LookupBatchDeployment(ctx *pulumi.Context, args *LookupBatchDeploymentArgs, opts ...pulumi.InvokeOption) (*LookupBatchDeploymentResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20220201preview:getBatchDeployment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupBatchDeploymentResult struct {
	BatchDeploymentDetails BatchDeploymentResponse         `pulumi:"batchDeploymentDetails"`
	Id                     string                          `pulumi:"id"`
...
func (val *LookupBatchDeploymentResult) Defaults() *LookupBatchDeploymentResult {
	...
	tmp := *val
	tmp.BatchDeploymentDetails = *tmp.BatchDeploymentDetails.Defaults()
...
func (o LookupBatchDeploymentResultOutput) BatchDeploymentDetails() BatchDeploymentResponseOutput {
	return o.ApplyT(func(v LookupBatchDeploymentResult) BatchDeploymentResponse { return v.BatchDeploymentDetails }).(BatchDeploymentResponseOutput)
}
