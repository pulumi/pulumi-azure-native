...
func LookupBatchEndpoint(ctx *pulumi.Context, args *LookupBatchEndpointArgs, opts ...pulumi.InvokeOption) (*LookupBatchEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20220201preview:getBatchEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupBatchEndpointResult struct {
	BatchEndpointDetails BatchEndpointResponse           `pulumi:"batchEndpointDetails"`
	Id                   string                          `pulumi:"id"`
...
func (o LookupBatchEndpointResultOutput) BatchEndpointDetails() BatchEndpointResponseOutput {
	return o.ApplyT(func(v LookupBatchEndpointResult) BatchEndpointResponse { return v.BatchEndpointDetails }).(BatchEndpointResponseOutput)
}
