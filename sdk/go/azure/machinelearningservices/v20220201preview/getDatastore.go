...
func LookupDatastore(ctx *pulumi.Context, args *LookupDatastoreArgs, opts ...pulumi.InvokeOption) (*LookupDatastoreResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20220201preview:getDatastore", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupDatastoreResultOutput) DatastoreDetails() pulumi.AnyOutput {
	return o.ApplyT(func(v LookupDatastoreResult) interface{} { return v.DatastoreDetails }).(pulumi.AnyOutput)
}
