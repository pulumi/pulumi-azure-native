...
// Public IP address of the compute node.
func (o AmlComputeNodeInformationInvokeResponseOutput) IpAddress() pulumi.StringOutput {
	return o.ApplyT(func(v AmlComputeNodeInformationInvokeResponse) string { return v.IpAddress }).(pulumi.StringOutput)
}
