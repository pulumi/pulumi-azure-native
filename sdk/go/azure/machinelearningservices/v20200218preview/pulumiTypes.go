...
func (o AmlComputePropertiesOutput) VirtualMachineImage() ResourceIdPtrOutput {
	return o.ApplyT(func(v AmlComputeProperties) *ResourceId { return v.VirtualMachineImage }).(ResourceIdPtrOutput)
}
...
type AmlComputeResponsePropertiesArgs struct {
	...
	VirtualMachineImage           ResourceIdResponsePtrInput                    `pulumi:"virtualMachineImage"`
	VmPriority                    pulumi.StringPtrInput                         `pulumi:"vmPriority"`
	VmSize                        pulumi.StringPtrInput                         `pulumi:"vmSize"`
}
