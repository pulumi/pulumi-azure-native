...
func NewLinkedWorkspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:machinelearningservices/v20200515preview:LinkedWorkspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedWorkspace(ctx *pulumi.Context,
	...
	var resource LinkedWorkspace
	err := ctx.ReadResource("azure-nextgen:machinelearningservices/v20200515preview:LinkedWorkspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
