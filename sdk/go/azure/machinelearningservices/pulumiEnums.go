...
// BatchLoggingLevelInput is an input type that accepts BatchLoggingLevelArgs and BatchLoggingLevelOutput values.
// You can construct a concrete instance of `BatchLoggingLevelInput` via:
//
//          BatchLoggingLevelArgs{...}
...
// BatchOutputActionInput is an input type that accepts BatchOutputActionArgs and BatchOutputActionOutput values.
// You can construct a concrete instance of `BatchOutputActionInput` via:
//
//          BatchOutputActionArgs{...}
...
// DataBindingModeInput is an input type that accepts DataBindingModeArgs and DataBindingModeOutput values.
// You can construct a concrete instance of `DataBindingModeInput` via:
//
//          DataBindingModeArgs{...}
...
// DistributionTypeInput is an input type that accepts DistributionTypeArgs and DistributionTypeOutput values.
// You can construct a concrete instance of `DistributionTypeInput` via:
//
//          DistributionTypeArgs{...}
...
// DockerSpecificationTypeInput is an input type that accepts DockerSpecificationTypeArgs and DockerSpecificationTypeOutput values.
// You can construct a concrete instance of `DockerSpecificationTypeInput` via:
//
//          DockerSpecificationTypeArgs{...}
...
// EarlyTerminationPolicyTypeInput is an input type that accepts EarlyTerminationPolicyTypeArgs and EarlyTerminationPolicyTypeOutput values.
// You can construct a concrete instance of `EarlyTerminationPolicyTypeInput` via:
//
//          EarlyTerminationPolicyTypeArgs{...}
...
// EndpointAuthModeInput is an input type that accepts EndpointAuthModeArgs and EndpointAuthModeOutput values.
// You can construct a concrete instance of `EndpointAuthModeInput` via:
//
...
// EndpointComputeTypeInput is an input type that accepts EndpointComputeTypeArgs and EndpointComputeTypeOutput values.
// You can construct a concrete instance of `EndpointComputeTypeInput` via:
//
...
// GoalInput is an input type that accepts GoalArgs and GoalOutput values.
// You can construct a concrete instance of `GoalInput` via:
//
//          GoalArgs{...}
...
// IdentityConfigurationTypeInput is an input type that accepts IdentityConfigurationTypeArgs and IdentityConfigurationTypeOutput values.
// You can construct a concrete instance of `IdentityConfigurationTypeInput` via:
//
//          IdentityConfigurationTypeArgs{...}
...
// ImageAnnotationTypeInput is an input type that accepts ImageAnnotationTypeArgs and ImageAnnotationTypeOutput values.
// You can construct a concrete instance of `ImageAnnotationTypeInput` via:
//
//          ImageAnnotationTypeArgs{...}
...
// MediaTypeInput is an input type that accepts MediaTypeArgs and MediaTypeOutput values.
// You can construct a concrete instance of `MediaTypeInput` via:
//
//          MediaTypeArgs{...}
...
// ReferenceTypeInput is an input type that accepts ReferenceTypeArgs and ReferenceTypeOutput values.
// You can construct a concrete instance of `ReferenceTypeInput` via:
//
//          ReferenceTypeArgs{...}
...
// ResourceIdentityAssignmentInput is an input type that accepts ResourceIdentityAssignmentArgs and ResourceIdentityAssignmentOutput values.
// You can construct a concrete instance of `ResourceIdentityAssignmentInput` via:
//
...
// SamplingAlgorithmInput is an input type that accepts SamplingAlgorithmArgs and SamplingAlgorithmOutput values.
// You can construct a concrete instance of `SamplingAlgorithmInput` via:
//
//          SamplingAlgorithmArgs{...}
