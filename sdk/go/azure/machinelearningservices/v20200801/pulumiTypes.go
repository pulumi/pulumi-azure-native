...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NotebookListCredentialsResultResponseInput)(nil)).Elem(), NotebookListCredentialsResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotebookListCredentialsResultResponsePtrInput)(nil)).Elem(), NotebookListCredentialsResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotebookPreparationErrorResponseInput)(nil)).Elem(), NotebookPreparationErrorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotebookPreparationErrorResponsePtrInput)(nil)).Elem(), NotebookPreparationErrorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotebookResourceInfoResponseInput)(nil)).Elem(), NotebookResourceInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotebookResourceInfoResponsePtrInput)(nil)).Elem(), NotebookResourceInfoResponseArgs{})
