...
func LookupWorkspace(ctx *pulumi.Context, args *LookupWorkspaceArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20220101preview:getWorkspace", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func (o LookupWorkspaceResultOutput) AllowRecoverSoftDeletedWorkspace() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) *string { return v.AllowRecoverSoftDeletedWorkspace }).(pulumi.StringPtrOutput)
}
...
func (o LookupWorkspaceResultOutput) SoftDeleteEnabled() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) *string { return v.SoftDeleteEnabled }).(pulumi.StringPtrOutput)
}
