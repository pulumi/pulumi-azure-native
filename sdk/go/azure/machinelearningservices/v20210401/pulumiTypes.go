...
func (o SynapseSparkPoolPropertiesResponsePropertiesOutput) ToSynapseSparkPoolPropertiesResponsePropertiesPtrOutputWithContext(ctx context.Context) SynapseSparkPoolPropertiesResponsePropertiesPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v SynapseSparkPoolPropertiesResponseProperties) *SynapseSparkPoolPropertiesResponseProperties {
		return &v
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SynapseSparkPoolPropertiesPropertiesInput)(nil)).Elem(), SynapseSparkPoolPropertiesPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SynapseSparkPoolPropertiesPropertiesPtrInput)(nil)).Elem(), SynapseSparkPoolPropertiesPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SynapseSparkPoolPropertiesResponsePropertiesInput)(nil)).Elem(), SynapseSparkPoolPropertiesResponsePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SynapseSparkPoolPropertiesResponsePropertiesPtrInput)(nil)).Elem(), SynapseSparkPoolPropertiesResponsePropertiesArgs{})
