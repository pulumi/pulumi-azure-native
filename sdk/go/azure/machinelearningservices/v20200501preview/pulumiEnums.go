...
// DatastoreTypeArmInput is an input type that accepts DatastoreTypeArmArgs and DatastoreTypeArmOutput values.
// You can construct a concrete instance of `DatastoreTypeArmInput` via:
//
