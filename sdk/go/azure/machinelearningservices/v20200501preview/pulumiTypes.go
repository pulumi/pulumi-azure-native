...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AzureDataLakeSectionResponseInput)(nil)).Elem(), AzureDataLakeSectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureDataLakeSectionResponsePtrInput)(nil)).Elem(), AzureDataLakeSectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMySqlSectionResponseInput)(nil)).Elem(), AzureMySqlSectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureMySqlSectionResponsePtrInput)(nil)).Elem(), AzureMySqlSectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzurePostgreSqlSectionResponseInput)(nil)).Elem(), AzurePostgreSqlSectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzurePostgreSqlSectionResponsePtrInput)(nil)).Elem(), AzurePostgreSqlSectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureSqlDatabaseSectionResponseInput)(nil)).Elem(), AzureSqlDatabaseSectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureSqlDatabaseSectionResponsePtrInput)(nil)).Elem(), AzureSqlDatabaseSectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureStorageSectionResponseInput)(nil)).Elem(), AzureStorageSectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureStorageSectionResponsePtrInput)(nil)).Elem(), AzureStorageSectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClientCredentialsResponseInput)(nil)).Elem(), ClientCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClientCredentialsResponsePtrInput)(nil)).Elem(), ClientCredentialsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetCreateRequestDataPathInput)(nil)).Elem(), DatasetCreateRequestDataPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetCreateRequestDataPathPtrInput)(nil)).Elem(), DatasetCreateRequestDataPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetCreateRequestParametersInput)(nil)).Elem(), DatasetCreateRequestParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetCreateRequestParametersPtrInput)(nil)).Elem(), DatasetCreateRequestParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetCreateRequestPathInput)(nil)).Elem(), DatasetCreateRequestPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetCreateRequestPathPtrInput)(nil)).Elem(), DatasetCreateRequestPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetCreateRequestQueryInput)(nil)).Elem(), DatasetCreateRequestQueryArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetCreateRequestQueryPtrInput)(nil)).Elem(), DatasetCreateRequestQueryArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetCreateRequestRegistrationInput)(nil)).Elem(), DatasetCreateRequestRegistrationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetCreateRequestRegistrationPtrInput)(nil)).Elem(), DatasetCreateRequestRegistrationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetCreateRequestTimeSeriesInput)(nil)).Elem(), DatasetCreateRequestTimeSeriesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetCreateRequestTimeSeriesPtrInput)(nil)).Elem(), DatasetCreateRequestTimeSeriesArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetResponsePtrInput)(nil)).Elem(), DatasetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetResponseDataPathInput)(nil)).Elem(), DatasetResponseDataPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetResponseDataPathPtrInput)(nil)).Elem(), DatasetResponseDataPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetResponseLatestInput)(nil)).Elem(), DatasetResponseLatestArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetResponseLatestPtrInput)(nil)).Elem(), DatasetResponseLatestArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetResponseSqlDataPathInput)(nil)).Elem(), DatasetResponseSqlDataPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetResponseSqlDataPathPtrInput)(nil)).Elem(), DatasetResponseSqlDataPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetStateResponseInput)(nil)).Elem(), DatasetStateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetStateResponsePtrInput)(nil)).Elem(), DatasetStateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetStateResponseDeprecatedByInput)(nil)).Elem(), DatasetStateResponseDeprecatedByArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasetStateResponseDeprecatedByPtrInput)(nil)).Elem(), DatasetStateResponseDeprecatedByArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatastoreResponseInput)(nil)).Elem(), DatastoreResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatastoreResponsePtrInput)(nil)).Elem(), DatastoreResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GlusterFsSectionResponseInput)(nil)).Elem(), GlusterFsSectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GlusterFsSectionResponsePtrInput)(nil)).Elem(), GlusterFsSectionResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LinkedInfoResponseInput)(nil)).Elem(), LinkedInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinkedInfoResponsePtrInput)(nil)).Elem(), LinkedInfoResponseArgs{})
