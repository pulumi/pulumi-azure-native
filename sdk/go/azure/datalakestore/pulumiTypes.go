...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CreateTrustedIdProviderWithAccountParametersInput)(nil)).Elem(), CreateTrustedIdProviderWithAccountParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CreateTrustedIdProviderWithAccountParametersArrayInput)(nil)).Elem(), CreateTrustedIdProviderWithAccountParametersArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CreateVirtualNetworkRuleWithAccountParametersInput)(nil)).Elem(), CreateVirtualNetworkRuleWithAccountParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CreateVirtualNetworkRuleWithAccountParametersArrayInput)(nil)).Elem(), CreateVirtualNetworkRuleWithAccountParametersArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultMetaInfoInput)(nil)).Elem(), KeyVaultMetaInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultMetaInfoPtrInput)(nil)).Elem(), KeyVaultMetaInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultMetaInfoResponseInput)(nil)).Elem(), KeyVaultMetaInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultMetaInfoResponsePtrInput)(nil)).Elem(), KeyVaultMetaInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TrustedIdProviderResponseInput)(nil)).Elem(), TrustedIdProviderResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TrustedIdProviderResponseArrayInput)(nil)).Elem(), TrustedIdProviderResponseArray{})
