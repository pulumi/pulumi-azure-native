...
func NewPolicyDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:authorization/v20190901:PolicyDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyDefinition(ctx *pulumi.Context,
	...
	var resource PolicyDefinition
	err := ctx.ReadResource("azure-nextgen:authorization/v20190901:PolicyDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
