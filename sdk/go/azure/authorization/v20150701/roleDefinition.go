...
func NewRoleDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:authorization/v20150701:RoleDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoleDefinition(ctx *pulumi.Context,
	...
	var resource RoleDefinition
	err := ctx.ReadResource("azure-nextgen:authorization/v20150701:RoleDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
