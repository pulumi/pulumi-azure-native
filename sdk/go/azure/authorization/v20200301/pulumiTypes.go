...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterDefinitionsValueInput)(nil)).Elem(), ParameterDefinitionsValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterDefinitionsValueMapInput)(nil)).Elem(), ParameterDefinitionsValueMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterDefinitionsValueMetadataInput)(nil)).Elem(), ParameterDefinitionsValueMetadataArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterDefinitionsValueMetadataPtrInput)(nil)).Elem(), ParameterDefinitionsValueMetadataArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterDefinitionsValueResponseInput)(nil)).Elem(), ParameterDefinitionsValueResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterDefinitionsValueResponseMapInput)(nil)).Elem(), ParameterDefinitionsValueResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterDefinitionsValueResponseMetadataInput)(nil)).Elem(), ParameterDefinitionsValueResponseMetadataArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterDefinitionsValueResponseMetadataPtrInput)(nil)).Elem(), ParameterDefinitionsValueResponseMetadataArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterValuesValueInput)(nil)).Elem(), ParameterValuesValueArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterValuesValueMapInput)(nil)).Elem(), ParameterValuesValueMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterValuesValueResponseInput)(nil)).Elem(), ParameterValuesValueResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ParameterValuesValueResponseMapInput)(nil)).Elem(), ParameterValuesValueResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyDefinitionGroupInput)(nil)).Elem(), PolicyDefinitionGroupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyDefinitionGroupArrayInput)(nil)).Elem(), PolicyDefinitionGroupArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyDefinitionGroupResponseInput)(nil)).Elem(), PolicyDefinitionGroupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyDefinitionGroupResponseArrayInput)(nil)).Elem(), PolicyDefinitionGroupResponseArray{})
