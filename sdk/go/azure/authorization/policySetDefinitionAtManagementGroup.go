...
func NewPolicySetDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:authorization:PolicySetDefinitionAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	var resource PolicySetDefinitionAtManagementGroup
	err := ctx.ReadResource("azure-nextgen:authorization:PolicySetDefinitionAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
