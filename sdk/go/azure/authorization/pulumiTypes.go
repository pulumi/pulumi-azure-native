...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NonComplianceMessageInput)(nil)).Elem(), NonComplianceMessageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NonComplianceMessageArrayInput)(nil)).Elem(), NonComplianceMessageArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NonComplianceMessageResponseInput)(nil)).Elem(), NonComplianceMessageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NonComplianceMessageResponseArrayInput)(nil)).Elem(), NonComplianceMessageResponseArray{})
