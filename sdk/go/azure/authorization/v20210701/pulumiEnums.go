...
// ExemptionCategoryInput is an input type that accepts ExemptionCategoryArgs and ExemptionCategoryOutput values.
// You can construct a concrete instance of `ExemptionCategoryInput` via:
//
//          ExemptionCategoryArgs{...}
