...
func NewPolicyPricing(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:authorization:PolicyPricing"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:authorization/v20210701:PolicyPricing", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyPricing(ctx *pulumi.Context,
	...
	var resource PolicyPricing
	err := ctx.ReadResource("azure-native:authorization/v20210701:PolicyPricing", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
