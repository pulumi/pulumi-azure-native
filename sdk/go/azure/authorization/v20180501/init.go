...
func (m *module) Construct(ctx *pulumi.Context, name, typ, urn string) (r pulumi.Resource, err error) {
	switch typ {
	case "azure-nextgen:authorization/v20180501:PolicyAssignment":
		r, err = NewPolicyAssignment(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:authorization/v20180501:PolicyDefinition":
		r, err = NewPolicyDefinition(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:authorization/v20180501:PolicyDefinitionAtManagementGroup":
		r, err = NewPolicyDefinitionAtManagementGroup(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:authorization/v20180501:PolicySetDefinition":
		r, err = NewPolicySetDefinition(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:authorization/v20180501:PolicySetDefinitionAtManagementGroup":
