...
// NewPolicyPricing registers a new resource with the given unique name, arguments, and options.
...
// GetPolicyPricing gets an existing PolicyPricing resource's state with the given name, ID, and optional
...
// Input properties used for looking up and filtering PolicyPricing resources.
