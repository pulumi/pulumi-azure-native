...
func (m *module) Construct(ctx *pulumi.Context, name, typ, urn string) (r pulumi.Resource, err error) {
	switch typ {
	case "azure-nextgen:authorization/v20190601:PolicyAssignment":
		r, err = NewPolicyAssignment(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:authorization/v20190601:PolicyDefinition":
		r, err = NewPolicyDefinition(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:authorization/v20190601:PolicyDefinitionAtManagementGroup":
		r, err = NewPolicyDefinitionAtManagementGroup(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:authorization/v20190601:PolicySetDefinition":
		r, err = NewPolicySetDefinition(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:authorization/v20190601:PolicySetDefinitionAtManagementGroup":
