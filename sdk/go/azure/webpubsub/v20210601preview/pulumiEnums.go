...
// WebPubSubRequestTypeInput is an input type that accepts WebPubSubRequestTypeArgs and WebPubSubRequestTypeOutput values.
// You can construct a concrete instance of `WebPubSubRequestTypeInput` via:
//
//          WebPubSubRequestTypeArgs{...}
...
// WebPubSubSkuTierInput is an input type that accepts WebPubSubSkuTierArgs and WebPubSubSkuTierOutput values.
// You can construct a concrete instance of `WebPubSubSkuTierInput` via:
//
//          WebPubSubSkuTierArgs{...}
