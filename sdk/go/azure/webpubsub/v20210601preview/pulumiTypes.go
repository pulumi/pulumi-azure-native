...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticConfigurationInput)(nil)).Elem(), DiagnosticConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticConfigurationPtrInput)(nil)).Elem(), DiagnosticConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticConfigurationResponseInput)(nil)).Elem(), DiagnosticConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticConfigurationResponsePtrInput)(nil)).Elem(), DiagnosticConfigurationResponseArgs{})
