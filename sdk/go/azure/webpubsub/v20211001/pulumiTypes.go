...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceLogCategoryInput)(nil)).Elem(), ResourceLogCategoryArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceLogCategoryArrayInput)(nil)).Elem(), ResourceLogCategoryArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceLogCategoryResponseInput)(nil)).Elem(), ResourceLogCategoryResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceLogCategoryResponseArrayInput)(nil)).Elem(), ResourceLogCategoryResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceLogConfigurationInput)(nil)).Elem(), ResourceLogConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceLogConfigurationPtrInput)(nil)).Elem(), ResourceLogConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceLogConfigurationResponseInput)(nil)).Elem(), ResourceLogConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceLogConfigurationResponsePtrInput)(nil)).Elem(), ResourceLogConfigurationResponseArgs{})
