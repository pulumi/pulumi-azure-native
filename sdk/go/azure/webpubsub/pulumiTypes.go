...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*EventHandlerInput)(nil)).Elem(), EventHandlerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventHandlerArrayInput)(nil)).Elem(), EventHandlerArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventHandlerResponseInput)(nil)).Elem(), EventHandlerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventHandlerResponseArrayInput)(nil)).Elem(), EventHandlerResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WebPubSubFeatureInput)(nil)).Elem(), WebPubSubFeatureArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebPubSubFeatureArrayInput)(nil)).Elem(), WebPubSubFeatureArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebPubSubFeatureResponseInput)(nil)).Elem(), WebPubSubFeatureResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebPubSubFeatureResponseArrayInput)(nil)).Elem(), WebPubSubFeatureResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebPubSubHubPropertiesInput)(nil)).Elem(), WebPubSubHubPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebPubSubHubPropertiesPtrInput)(nil)).Elem(), WebPubSubHubPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebPubSubHubPropertiesResponseInput)(nil)).Elem(), WebPubSubHubPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebPubSubHubPropertiesResponsePtrInput)(nil)).Elem(), WebPubSubHubPropertiesResponseArgs{})
