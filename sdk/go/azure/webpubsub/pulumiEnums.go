...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*FeatureFlagsInput)(nil)).Elem(), FeatureFlags("EnableConnectivityLogs"))
	pulumi.RegisterInputType(reflect.TypeOf((*FeatureFlagsPtrInput)(nil)).Elem(), FeatureFlags("EnableConnectivityLogs"))
