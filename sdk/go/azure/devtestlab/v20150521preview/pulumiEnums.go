...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LabStorageTypeInput)(nil)).Elem(), LabStorageType("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*LabStorageTypePtrInput)(nil)).Elem(), LabStorageType("Standard"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TaskTypeInput)(nil)).Elem(), TaskType("LabVmsShutdownTask"))
	pulumi.RegisterInputType(reflect.TypeOf((*TaskTypePtrInput)(nil)).Elem(), TaskType("LabVmsShutdownTask"))
