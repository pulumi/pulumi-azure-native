...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LabVirtualMachineResponseInput)(nil)).Elem(), LabVirtualMachineResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabVirtualMachineResponsePtrInput)(nil)).Elem(), LabVirtualMachineResponseArgs{})
