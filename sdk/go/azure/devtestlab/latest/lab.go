...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devtestlab:Lab'.
type Lab struct {
...
func NewLab(ctx *pulumi.Context,
	...
	var resource Lab
	err := ctx.RegisterResource("azure-native:devtestlab/latest:Lab", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLab(ctx *pulumi.Context,
	...
	var resource Lab
	err := ctx.ReadResource("azure-native:devtestlab/latest:Lab", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
