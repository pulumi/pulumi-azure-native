...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getServiceFabricSchedule'.
func LookupServiceFabricSchedule(ctx *pulumi.Context, args *LookupServiceFabricScheduleArgs, opts ...pulumi.InvokeOption) (*LookupServiceFabricScheduleResult, error) {
	...
	err := ctx.Invoke("azure-native:devtestlab/latest:getServiceFabricSchedule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
