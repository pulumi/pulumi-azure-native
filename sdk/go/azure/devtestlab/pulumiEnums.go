...
func (o HostCachingOptionsOutput) ToHostCachingOptionsPtrOutput() HostCachingOptionsPtrOutput {
	return o.ToHostCachingOptionsPtrOutputWithContext(context.Background())
}

func (o HostCachingOptionsOutput) ToHostCachingOptionsPtrOutputWithContext(ctx context.Context) HostCachingOptionsPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v HostCachingOptions) *HostCachingOptions {
		return &v
	}).(HostCachingOptionsPtrOutput)
}
...
func (o HostCachingOptionsOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e HostCachingOptions) string {
		return string(e)
	}).(pulumi.StringOutput)
}
...
func (o HostCachingOptionsPtrOutput) Elem() HostCachingOptionsOutput {
	return o.ApplyT(func(v *HostCachingOptions) HostCachingOptions {
		if v != nil {
			return *v
		}
		var ret HostCachingOptions
		return ret
	}).(HostCachingOptionsOutput)
}
...
type HostCachingOptionsInput interface {
	pulumi.Input

	ToHostCachingOptionsOutput() HostCachingOptionsOutput
	ToHostCachingOptionsOutputWithContext(context.Context) HostCachingOptionsOutput
}

var hostCachingOptionsPtrType = reflect.TypeOf((**HostCachingOptions)(nil)).Elem()

type HostCachingOptionsPtrInput interface {
	pulumi.Input

	ToHostCachingOptionsPtrOutput() HostCachingOptionsPtrOutput
	ToHostCachingOptionsPtrOutputWithContext(context.Context) HostCachingOptionsPtrOutput
}

type hostCachingOptionsPtr string

func HostCachingOptionsPtr(v string) HostCachingOptionsPtrInput {
	return (*hostCachingOptionsPtr)(&v)
}

func (*hostCachingOptionsPtr) ElementType() reflect.Type {
	return hostCachingOptionsPtrType
}

func (in *hostCachingOptionsPtr) ToHostCachingOptionsPtrOutput() HostCachingOptionsPtrOutput {
	return pulumi.ToOutput(in).(HostCachingOptionsPtrOutput)
}

func (in *hostCachingOptionsPtr) ToHostCachingOptionsPtrOutputWithContext(ctx context.Context) HostCachingOptionsPtrOutput {
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImageOsTypeInput)(nil)).Elem(), CustomImageOsType("Windows"))
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImageOsTypePtrInput)(nil)).Elem(), CustomImageOsType("Windows"))
	pulumi.RegisterInputType(reflect.TypeOf((*EnableStatusInput)(nil)).Elem(), EnableStatus("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*EnableStatusPtrInput)(nil)).Elem(), EnableStatus("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*EnvironmentPermissionInput)(nil)).Elem(), EnvironmentPermission("Reader"))
	pulumi.RegisterInputType(reflect.TypeOf((*EnvironmentPermissionPtrInput)(nil)).Elem(), EnvironmentPermission("Reader"))
	pulumi.RegisterInputType(reflect.TypeOf((*HostCachingOptionsInput)(nil)).Elem(), HostCachingOptions("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*HostCachingOptionsPtrInput)(nil)).Elem(), HostCachingOptions("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxOsStateInput)(nil)).Elem(), LinuxOsState("NonDeprovisioned"))
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxOsStatePtrInput)(nil)).Elem(), LinuxOsState("NonDeprovisioned"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationChannelEventTypeInput)(nil)).Elem(), NotificationChannelEventType("AutoShutdown"))
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationChannelEventTypePtrInput)(nil)).Elem(), NotificationChannelEventType("AutoShutdown"))
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyEvaluatorTypeInput)(nil)).Elem(), PolicyEvaluatorType("AllowedValuesPolicy"))
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyEvaluatorTypePtrInput)(nil)).Elem(), PolicyEvaluatorType("AllowedValuesPolicy"))
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyFactNameInput)(nil)).Elem(), PolicyFactName("UserOwnedLabVmCount"))
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyFactNamePtrInput)(nil)).Elem(), PolicyFactName("UserOwnedLabVmCount"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PremiumDataDiskInput)(nil)).Elem(), PremiumDataDisk("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*PremiumDataDiskPtrInput)(nil)).Elem(), PremiumDataDisk("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SourceControlTypeInput)(nil)).Elem(), SourceControlType("VsoGit"))
	pulumi.RegisterInputType(reflect.TypeOf((*SourceControlTypePtrInput)(nil)).Elem(), SourceControlType("VsoGit"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TransportProtocolInput)(nil)).Elem(), TransportProtocol("Tcp"))
	pulumi.RegisterInputType(reflect.TypeOf((*TransportProtocolPtrInput)(nil)).Elem(), TransportProtocol("Tcp"))
	pulumi.RegisterInputType(reflect.TypeOf((*UsagePermissionTypeInput)(nil)).Elem(), UsagePermissionType("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*UsagePermissionTypePtrInput)(nil)).Elem(), UsagePermissionType("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsOsStateInput)(nil)).Elem(), WindowsOsState("NonSysprepped"))
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsOsStatePtrInput)(nil)).Elem(), WindowsOsState("NonSysprepped"))
	...
	pulumi.RegisterOutputType(HostCachingOptionsOutput{})
	pulumi.RegisterOutputType(HostCachingOptionsPtrOutput{})
