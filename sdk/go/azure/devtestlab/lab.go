...
func NewLab(ctx *pulumi.Context,
	...
	var resource Lab
	err := ctx.RegisterResource("azure-nextgen:devtestlab:Lab", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLab(ctx *pulumi.Context,
	...
	var resource Lab
	err := ctx.ReadResource("azure-nextgen:devtestlab:Lab", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
