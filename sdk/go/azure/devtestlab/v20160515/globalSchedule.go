...
func NewGlobalSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:devtestlab/v20160515:GlobalSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalSchedule(ctx *pulumi.Context,
	...
	var resource GlobalSchedule
	err := ctx.ReadResource("azure-nextgen:devtestlab/v20160515:GlobalSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
