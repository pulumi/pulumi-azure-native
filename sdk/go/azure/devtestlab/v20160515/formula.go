...
func NewFormula(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:devtestlab/v20160515:Formula", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFormula(ctx *pulumi.Context,
	...
	var resource Formula
	err := ctx.ReadResource("azure-nextgen:devtestlab/v20160515:Formula", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
