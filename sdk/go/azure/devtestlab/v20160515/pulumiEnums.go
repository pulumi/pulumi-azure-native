...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationStatusInput)(nil)).Elem(), NotificationStatus("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationStatusPtrInput)(nil)).Elem(), NotificationStatus("Disabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineCreationSourceInput)(nil)).Elem(), VirtualMachineCreationSource("FromCustomImage"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineCreationSourcePtrInput)(nil)).Elem(), VirtualMachineCreationSource("FromCustomImage"))
