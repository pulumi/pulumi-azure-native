...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicableScheduleResponseInput)(nil)).Elem(), ApplicableScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicableScheduleResponsePtrInput)(nil)).Elem(), ApplicableScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmTemplateParameterPropertiesInput)(nil)).Elem(), ArmTemplateParameterPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmTemplateParameterPropertiesArrayInput)(nil)).Elem(), ArmTemplateParameterPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmTemplateParameterPropertiesResponseInput)(nil)).Elem(), ArmTemplateParameterPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmTemplateParameterPropertiesResponseArrayInput)(nil)).Elem(), ArmTemplateParameterPropertiesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArtifactDeploymentStatusPropertiesResponseInput)(nil)).Elem(), ArtifactDeploymentStatusPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArtifactDeploymentStatusPropertiesResponsePtrInput)(nil)).Elem(), ArtifactDeploymentStatusPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArtifactInstallPropertiesInput)(nil)).Elem(), ArtifactInstallPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArtifactInstallPropertiesArrayInput)(nil)).Elem(), ArtifactInstallPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArtifactInstallPropertiesResponseInput)(nil)).Elem(), ArtifactInstallPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArtifactInstallPropertiesResponseArrayInput)(nil)).Elem(), ArtifactInstallPropertiesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArtifactParameterPropertiesInput)(nil)).Elem(), ArtifactParameterPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArtifactParameterPropertiesArrayInput)(nil)).Elem(), ArtifactParameterPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArtifactParameterPropertiesResponseInput)(nil)).Elem(), ArtifactParameterPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArtifactParameterPropertiesResponseArrayInput)(nil)).Elem(), ArtifactParameterPropertiesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AttachNewDataDiskOptionsInput)(nil)).Elem(), AttachNewDataDiskOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AttachNewDataDiskOptionsPtrInput)(nil)).Elem(), AttachNewDataDiskOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AttachNewDataDiskOptionsResponseInput)(nil)).Elem(), AttachNewDataDiskOptionsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AttachNewDataDiskOptionsResponsePtrInput)(nil)).Elem(), AttachNewDataDiskOptionsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BulkCreationParametersInput)(nil)).Elem(), BulkCreationParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BulkCreationParametersPtrInput)(nil)).Elem(), BulkCreationParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BulkCreationParametersResponseInput)(nil)).Elem(), BulkCreationParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BulkCreationParametersResponsePtrInput)(nil)).Elem(), BulkCreationParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeDataDiskResponseInput)(nil)).Elem(), ComputeDataDiskResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeDataDiskResponseArrayInput)(nil)).Elem(), ComputeDataDiskResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeVmInstanceViewStatusResponseInput)(nil)).Elem(), ComputeVmInstanceViewStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeVmInstanceViewStatusResponseArrayInput)(nil)).Elem(), ComputeVmInstanceViewStatusResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeVmPropertiesResponseInput)(nil)).Elem(), ComputeVmPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeVmPropertiesResponsePtrInput)(nil)).Elem(), ComputeVmPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImagePropertiesCustomInput)(nil)).Elem(), CustomImagePropertiesCustomArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImagePropertiesCustomPtrInput)(nil)).Elem(), CustomImagePropertiesCustomArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImagePropertiesCustomResponseInput)(nil)).Elem(), CustomImagePropertiesCustomResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImagePropertiesCustomResponsePtrInput)(nil)).Elem(), CustomImagePropertiesCustomResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImagePropertiesFromPlanInput)(nil)).Elem(), CustomImagePropertiesFromPlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImagePropertiesFromPlanPtrInput)(nil)).Elem(), CustomImagePropertiesFromPlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImagePropertiesFromPlanResponseInput)(nil)).Elem(), CustomImagePropertiesFromPlanResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImagePropertiesFromPlanResponsePtrInput)(nil)).Elem(), CustomImagePropertiesFromPlanResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImagePropertiesFromVmInput)(nil)).Elem(), CustomImagePropertiesFromVmArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImagePropertiesFromVmPtrInput)(nil)).Elem(), CustomImagePropertiesFromVmArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImagePropertiesFromVmResponseInput)(nil)).Elem(), CustomImagePropertiesFromVmResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomImagePropertiesFromVmResponsePtrInput)(nil)).Elem(), CustomImagePropertiesFromVmResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDiskPropertiesInput)(nil)).Elem(), DataDiskPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDiskPropertiesArrayInput)(nil)).Elem(), DataDiskPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDiskPropertiesResponseInput)(nil)).Elem(), DataDiskPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDiskPropertiesResponseArrayInput)(nil)).Elem(), DataDiskPropertiesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDiskStorageTypeInfoInput)(nil)).Elem(), DataDiskStorageTypeInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDiskStorageTypeInfoArrayInput)(nil)).Elem(), DataDiskStorageTypeInfoArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDiskStorageTypeInfoResponseInput)(nil)).Elem(), DataDiskStorageTypeInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDiskStorageTypeInfoResponseArrayInput)(nil)).Elem(), DataDiskStorageTypeInfoResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DayDetailsInput)(nil)).Elem(), DayDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DayDetailsPtrInput)(nil)).Elem(), DayDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DayDetailsResponseInput)(nil)).Elem(), DayDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DayDetailsResponsePtrInput)(nil)).Elem(), DayDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnvironmentDeploymentPropertiesInput)(nil)).Elem(), EnvironmentDeploymentPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnvironmentDeploymentPropertiesPtrInput)(nil)).Elem(), EnvironmentDeploymentPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnvironmentDeploymentPropertiesResponseInput)(nil)).Elem(), EnvironmentDeploymentPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnvironmentDeploymentPropertiesResponsePtrInput)(nil)).Elem(), EnvironmentDeploymentPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventInput)(nil)).Elem(), EventArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ExternalSubnetResponseInput)(nil)).Elem(), ExternalSubnetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExternalSubnetResponseArrayInput)(nil)).Elem(), ExternalSubnetResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FormulaPropertiesFromVmInput)(nil)).Elem(), FormulaPropertiesFromVmArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FormulaPropertiesFromVmPtrInput)(nil)).Elem(), FormulaPropertiesFromVmArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FormulaPropertiesFromVmResponseInput)(nil)).Elem(), FormulaPropertiesFromVmResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FormulaPropertiesFromVmResponsePtrInput)(nil)).Elem(), FormulaPropertiesFromVmResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageReferenceInput)(nil)).Elem(), GalleryImageReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageReferencePtrInput)(nil)).Elem(), GalleryImageReferenceArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HourDetailsInput)(nil)).Elem(), HourDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HourDetailsPtrInput)(nil)).Elem(), HourDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HourDetailsResponseInput)(nil)).Elem(), HourDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HourDetailsResponsePtrInput)(nil)).Elem(), HourDetailsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LabAnnouncementPropertiesInput)(nil)).Elem(), LabAnnouncementPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabAnnouncementPropertiesPtrInput)(nil)).Elem(), LabAnnouncementPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabAnnouncementPropertiesResponseInput)(nil)).Elem(), LabAnnouncementPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabAnnouncementPropertiesResponsePtrInput)(nil)).Elem(), LabAnnouncementPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabSupportPropertiesInput)(nil)).Elem(), LabSupportPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabSupportPropertiesPtrInput)(nil)).Elem(), LabSupportPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabSupportPropertiesResponseInput)(nil)).Elem(), LabSupportPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabSupportPropertiesResponsePtrInput)(nil)).Elem(), LabSupportPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabVhdResponseInput)(nil)).Elem(), LabVhdResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabVhdResponseArrayInput)(nil)).Elem(), LabVhdResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabVirtualMachineCreationParameterInput)(nil)).Elem(), LabVirtualMachineCreationParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabVirtualMachineCreationParameterPtrInput)(nil)).Elem(), LabVirtualMachineCreationParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabVirtualMachineCreationParameterResponseInput)(nil)).Elem(), LabVirtualMachineCreationParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LabVirtualMachineCreationParameterResponsePtrInput)(nil)).Elem(), LabVirtualMachineCreationParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxOsInfoInput)(nil)).Elem(), LinuxOsInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxOsInfoPtrInput)(nil)).Elem(), LinuxOsInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxOsInfoResponseInput)(nil)).Elem(), LinuxOsInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxOsInfoResponsePtrInput)(nil)).Elem(), LinuxOsInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkInterfacePropertiesInput)(nil)).Elem(), NetworkInterfacePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkInterfacePropertiesPtrInput)(nil)).Elem(), NetworkInterfacePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkInterfacePropertiesResponseInput)(nil)).Elem(), NetworkInterfacePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkInterfacePropertiesResponsePtrInput)(nil)).Elem(), NetworkInterfacePropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleCreationParameterInput)(nil)).Elem(), ScheduleCreationParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleCreationParameterArrayInput)(nil)).Elem(), ScheduleCreationParameterArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleCreationParameterResponseInput)(nil)).Elem(), ScheduleCreationParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleCreationParameterResponseArrayInput)(nil)).Elem(), ScheduleCreationParameterResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SharedPublicIpAddressConfigurationInput)(nil)).Elem(), SharedPublicIpAddressConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharedPublicIpAddressConfigurationPtrInput)(nil)).Elem(), SharedPublicIpAddressConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharedPublicIpAddressConfigurationResponseInput)(nil)).Elem(), SharedPublicIpAddressConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharedPublicIpAddressConfigurationResponsePtrInput)(nil)).Elem(), SharedPublicIpAddressConfigurationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetOverrideInput)(nil)).Elem(), SubnetOverrideArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetOverrideArrayInput)(nil)).Elem(), SubnetOverrideArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetOverrideResponseInput)(nil)).Elem(), SubnetOverrideResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetOverrideResponseArrayInput)(nil)).Elem(), SubnetOverrideResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetSharedPublicIpAddressConfigurationInput)(nil)).Elem(), SubnetSharedPublicIpAddressConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetSharedPublicIpAddressConfigurationPtrInput)(nil)).Elem(), SubnetSharedPublicIpAddressConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetSharedPublicIpAddressConfigurationResponseInput)(nil)).Elem(), SubnetSharedPublicIpAddressConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetSharedPublicIpAddressConfigurationResponsePtrInput)(nil)).Elem(), SubnetSharedPublicIpAddressConfigurationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UserSecretStoreInput)(nil)).Elem(), UserSecretStoreArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserSecretStorePtrInput)(nil)).Elem(), UserSecretStoreArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserSecretStoreResponseInput)(nil)).Elem(), UserSecretStoreResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserSecretStoreResponsePtrInput)(nil)).Elem(), UserSecretStoreResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WeekDetailsInput)(nil)).Elem(), WeekDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WeekDetailsPtrInput)(nil)).Elem(), WeekDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WeekDetailsResponseInput)(nil)).Elem(), WeekDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WeekDetailsResponsePtrInput)(nil)).Elem(), WeekDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsOsInfoInput)(nil)).Elem(), WindowsOsInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsOsInfoPtrInput)(nil)).Elem(), WindowsOsInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsOsInfoResponseInput)(nil)).Elem(), WindowsOsInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsOsInfoResponsePtrInput)(nil)).Elem(), WindowsOsInfoResponseArgs{})
