...
func NewSecret(ctx *pulumi.Context,
	...
	var resource Secret
	err := ctx.RegisterResource("azure-nextgen:devtestlab/v20180915:Secret", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecret(ctx *pulumi.Context,
	...
	var resource Secret
	err := ctx.ReadResource("azure-nextgen:devtestlab/v20180915:Secret", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
