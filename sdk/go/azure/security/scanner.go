...
func NewScanner(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:security/v20211201preview:Scanner"),
		},
	})
	opts = append(opts, aliases)
	var resource Scanner
	err := ctx.RegisterResource("azure-native:security:Scanner", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScanner(ctx *pulumi.Context,
	...
	var resource Scanner
	err := ctx.ReadResource("azure-native:security:Scanner", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
