...
type DefenderFoDatabasesAwsOfferingArcAutoProvisioning struct {
	...
	ServicePrincipalSecretMetadata *DefenderFoDatabasesAwsOfferingServicePrincipalSecretMetadata `pulumi:"servicePrincipalSecretMetadata"`
}
...
type DefenderFoDatabasesAwsOfferingResponseArcAutoProvisioning struct {
	CloudRoleArn                   *string                                                               `pulumi:"cloudRoleArn"`
	Enabled                        *bool                                                                 `pulumi:"enabled"`
	ServicePrincipalSecretMetadata *DefenderFoDatabasesAwsOfferingResponseServicePrincipalSecretMetadata `pulumi:"servicePrincipalSecretMetadata"`
}

type DefenderFoDatabasesAwsOfferingResponseServicePrincipalSecretMetadata struct {
	ExpiryDate           *string `pulumi:"expiryDate"`
	ParameterNameInStore *string `pulumi:"parameterNameInStore"`
	ParameterStoreRegion *string `pulumi:"parameterStoreRegion"`
}

type DefenderFoDatabasesAwsOfferingServicePrincipalSecretMetadata struct {
	ExpiryDate           *string `pulumi:"expiryDate"`
	ParameterNameInStore *string `pulumi:"parameterNameInStore"`
	ParameterStoreRegion *string `pulumi:"parameterStoreRegion"`
}
...
type DefenderForServersAwsOfferingConfigurationConfiguration struct {
	CloudRoleArn  *string     `pulumi:"cloudRoleArn"`
	ExclusionTags interface{} `pulumi:"exclusionTags"`
