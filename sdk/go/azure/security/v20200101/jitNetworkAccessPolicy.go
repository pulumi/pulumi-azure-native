...
func NewJitNetworkAccessPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:security/v20200101:JitNetworkAccessPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJitNetworkAccessPolicy(ctx *pulumi.Context,
	...
	var resource JitNetworkAccessPolicy
	err := ctx.ReadResource("azure-nextgen:security/v20200101:JitNetworkAccessPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
