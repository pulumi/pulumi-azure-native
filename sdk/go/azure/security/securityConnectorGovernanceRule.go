...
func NewSecurityConnectorGovernanceRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:security/v20220101preview:SecurityConnectorGovernanceRule"),
		},
	})
	opts = append(opts, aliases)
	var resource SecurityConnectorGovernanceRule
	err := ctx.RegisterResource("azure-native:security:SecurityConnectorGovernanceRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityConnectorGovernanceRule(ctx *pulumi.Context,
	...
	var resource SecurityConnectorGovernanceRule
	err := ctx.ReadResource("azure-native:security:SecurityConnectorGovernanceRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
