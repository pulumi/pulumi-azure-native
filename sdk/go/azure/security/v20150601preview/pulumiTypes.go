...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AppWhitelistingIssueSummaryResponseInput)(nil)).Elem(), AppWhitelistingIssueSummaryResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AppWhitelistingIssueSummaryResponseArrayInput)(nil)).Elem(), AppWhitelistingIssueSummaryResponseArray{})
