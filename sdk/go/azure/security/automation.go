...
func NewAutomation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:security:Automation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutomation(ctx *pulumi.Context,
	...
	var resource Automation
	err := ctx.ReadResource("azure-nextgen:security:Automation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
