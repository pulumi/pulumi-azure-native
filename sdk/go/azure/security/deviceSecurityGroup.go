...
func NewDeviceSecurityGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:security:DeviceSecurityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceSecurityGroup(ctx *pulumi.Context,
	...
	var resource DeviceSecurityGroup
	err := ctx.ReadResource("azure-nextgen:security:DeviceSecurityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
