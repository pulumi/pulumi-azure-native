...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ActionTypeInput)(nil)).Elem(), ActionType("LogicApp"))
	pulumi.RegisterInputType(reflect.TypeOf((*ActionTypePtrInput)(nil)).Elem(), ActionType("LogicApp"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EventSourceInput)(nil)).Elem(), EventSource("Assessments"))
	pulumi.RegisterInputType(reflect.TypeOf((*EventSourcePtrInput)(nil)).Elem(), EventSource("Assessments"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RuleStateInput)(nil)).Elem(), RuleState("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*RuleStatePtrInput)(nil)).Elem(), RuleState("Enabled"))
