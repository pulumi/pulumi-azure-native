...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TacticsInput)(nil)).Elem(), Tactics("Reconnaissance"))
	pulumi.RegisterInputType(reflect.TypeOf((*TacticsPtrInput)(nil)).Elem(), Tactics("Reconnaissance"))
	pulumi.RegisterInputType(reflect.TypeOf((*TechniquesInput)(nil)).Elem(), Techniques("Abuse Elevation Control Mechanism"))
	pulumi.RegisterInputType(reflect.TypeOf((*TechniquesPtrInput)(nil)).Elem(), Techniques("Abuse Elevation Control Mechanism"))
