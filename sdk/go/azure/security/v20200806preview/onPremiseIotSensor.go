...
func NewOnPremiseIotSensor(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:security/v20200806preview:OnPremiseIotSensor"),
		},
		{
			Type: pulumi.String("azure-native:security:OnPremiseIotSensor"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:security/v20200806preview:OnPremiseIotSensor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOnPremiseIotSensor(ctx *pulumi.Context,
	...
	var resource OnPremiseIotSensor
	err := ctx.ReadResource("azure-native:security/v20200806preview:OnPremiseIotSensor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
