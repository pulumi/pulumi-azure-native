...
func NewGovernanceAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:security/v20220101preview:GovernanceAssignment"),
		},
	})
	opts = append(opts, aliases)
	var resource GovernanceAssignment
	err := ctx.RegisterResource("azure-native:security:GovernanceAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGovernanceAssignment(ctx *pulumi.Context,
	...
	var resource GovernanceAssignment
	err := ctx.ReadResource("azure-native:security:GovernanceAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
