...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CacheExpirationActionParametersInput)(nil)).Elem(), CacheExpirationActionParametersArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CookiesMatchConditionParametersInput)(nil)).Elem(), CookiesMatchConditionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CookiesMatchConditionParametersResponseInput)(nil)).Elem(), CookiesMatchConditionParametersResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DeepCreatedOriginGroupInput)(nil)).Elem(), DeepCreatedOriginGroupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeepCreatedOriginGroupArrayInput)(nil)).Elem(), DeepCreatedOriginGroupArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeepCreatedOriginGroupResponseInput)(nil)).Elem(), DeepCreatedOriginGroupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeepCreatedOriginGroupResponseArrayInput)(nil)).Elem(), DeepCreatedOriginGroupResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleInput)(nil)).Elem(), DeliveryRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleArrayInput)(nil)).Elem(), DeliveryRuleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleCacheExpirationActionInput)(nil)).Elem(), DeliveryRuleCacheExpirationActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleCacheExpirationActionResponseInput)(nil)).Elem(), DeliveryRuleCacheExpirationActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleCacheKeyQueryStringActionInput)(nil)).Elem(), DeliveryRuleCacheKeyQueryStringActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleCacheKeyQueryStringActionResponseInput)(nil)).Elem(), DeliveryRuleCacheKeyQueryStringActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleCookiesConditionInput)(nil)).Elem(), DeliveryRuleCookiesConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleCookiesConditionResponseInput)(nil)).Elem(), DeliveryRuleCookiesConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleHttpVersionConditionInput)(nil)).Elem(), DeliveryRuleHttpVersionConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleHttpVersionConditionResponseInput)(nil)).Elem(), DeliveryRuleHttpVersionConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleIsDeviceConditionInput)(nil)).Elem(), DeliveryRuleIsDeviceConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleIsDeviceConditionResponseInput)(nil)).Elem(), DeliveryRuleIsDeviceConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRulePostArgsConditionInput)(nil)).Elem(), DeliveryRulePostArgsConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRulePostArgsConditionResponseInput)(nil)).Elem(), DeliveryRulePostArgsConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleQueryStringConditionInput)(nil)).Elem(), DeliveryRuleQueryStringConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleQueryStringConditionResponseInput)(nil)).Elem(), DeliveryRuleQueryStringConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRemoteAddressConditionInput)(nil)).Elem(), DeliveryRuleRemoteAddressConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRemoteAddressConditionResponseInput)(nil)).Elem(), DeliveryRuleRemoteAddressConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRequestBodyConditionInput)(nil)).Elem(), DeliveryRuleRequestBodyConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRequestBodyConditionResponseInput)(nil)).Elem(), DeliveryRuleRequestBodyConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRequestHeaderActionInput)(nil)).Elem(), DeliveryRuleRequestHeaderActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRequestHeaderActionResponseInput)(nil)).Elem(), DeliveryRuleRequestHeaderActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRequestHeaderConditionInput)(nil)).Elem(), DeliveryRuleRequestHeaderConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRequestHeaderConditionResponseInput)(nil)).Elem(), DeliveryRuleRequestHeaderConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRequestMethodConditionInput)(nil)).Elem(), DeliveryRuleRequestMethodConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRequestMethodConditionResponseInput)(nil)).Elem(), DeliveryRuleRequestMethodConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRequestSchemeConditionInput)(nil)).Elem(), DeliveryRuleRequestSchemeConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRequestSchemeConditionResponseInput)(nil)).Elem(), DeliveryRuleRequestSchemeConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRequestUriConditionInput)(nil)).Elem(), DeliveryRuleRequestUriConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleRequestUriConditionResponseInput)(nil)).Elem(), DeliveryRuleRequestUriConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleResponseInput)(nil)).Elem(), DeliveryRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleResponseArrayInput)(nil)).Elem(), DeliveryRuleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleResponseHeaderActionInput)(nil)).Elem(), DeliveryRuleResponseHeaderActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleResponseHeaderActionResponseInput)(nil)).Elem(), DeliveryRuleResponseHeaderActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleUrlFileExtensionConditionInput)(nil)).Elem(), DeliveryRuleUrlFileExtensionConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleUrlFileExtensionConditionResponseInput)(nil)).Elem(), DeliveryRuleUrlFileExtensionConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleUrlFileNameConditionInput)(nil)).Elem(), DeliveryRuleUrlFileNameConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleUrlFileNameConditionResponseInput)(nil)).Elem(), DeliveryRuleUrlFileNameConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleUrlPathConditionInput)(nil)).Elem(), DeliveryRuleUrlPathConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleUrlPathConditionResponseInput)(nil)).Elem(), DeliveryRuleUrlPathConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointPropertiesUpdateParametersDeliveryPolicyInput)(nil)).Elem(), EndpointPropertiesUpdateParametersDeliveryPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointPropertiesUpdateParametersDeliveryPolicyPtrInput)(nil)).Elem(), EndpointPropertiesUpdateParametersDeliveryPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointPropertiesUpdateParametersResponseDeliveryPolicyInput)(nil)).Elem(), EndpointPropertiesUpdateParametersResponseDeliveryPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointPropertiesUpdateParametersResponseDeliveryPolicyPtrInput)(nil)).Elem(), EndpointPropertiesUpdateParametersResponseDeliveryPolicyArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderActionParametersInput)(nil)).Elem(), HeaderActionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderActionParametersResponseInput)(nil)).Elem(), HeaderActionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HealthProbeParametersInput)(nil)).Elem(), HealthProbeParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HealthProbeParametersPtrInput)(nil)).Elem(), HealthProbeParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HealthProbeParametersResponseInput)(nil)).Elem(), HealthProbeParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HealthProbeParametersResponsePtrInput)(nil)).Elem(), HealthProbeParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpErrorRangeParametersInput)(nil)).Elem(), HttpErrorRangeParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpErrorRangeParametersArrayInput)(nil)).Elem(), HttpErrorRangeParametersArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpErrorRangeParametersResponseInput)(nil)).Elem(), HttpErrorRangeParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpErrorRangeParametersResponseArrayInput)(nil)).Elem(), HttpErrorRangeParametersResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpVersionMatchConditionParametersInput)(nil)).Elem(), HttpVersionMatchConditionParametersArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OriginGroupOverrideActionInput)(nil)).Elem(), OriginGroupOverrideActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OriginGroupOverrideActionParametersInput)(nil)).Elem(), OriginGroupOverrideActionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OriginGroupOverrideActionParametersResponseInput)(nil)).Elem(), OriginGroupOverrideActionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OriginGroupOverrideActionResponseInput)(nil)).Elem(), OriginGroupOverrideActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PostArgsMatchConditionParametersInput)(nil)).Elem(), PostArgsMatchConditionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PostArgsMatchConditionParametersResponseInput)(nil)).Elem(), PostArgsMatchConditionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryStringMatchConditionParametersInput)(nil)).Elem(), QueryStringMatchConditionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QueryStringMatchConditionParametersResponseInput)(nil)).Elem(), QueryStringMatchConditionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RemoteAddressMatchConditionParametersInput)(nil)).Elem(), RemoteAddressMatchConditionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RemoteAddressMatchConditionParametersResponseInput)(nil)).Elem(), RemoteAddressMatchConditionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestBodyMatchConditionParametersInput)(nil)).Elem(), RequestBodyMatchConditionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestBodyMatchConditionParametersResponseInput)(nil)).Elem(), RequestBodyMatchConditionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestHeaderMatchConditionParametersInput)(nil)).Elem(), RequestHeaderMatchConditionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestHeaderMatchConditionParametersResponseInput)(nil)).Elem(), RequestHeaderMatchConditionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestMethodMatchConditionParametersInput)(nil)).Elem(), RequestMethodMatchConditionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestMethodMatchConditionParametersResponseInput)(nil)).Elem(), RequestMethodMatchConditionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestSchemeMatchConditionParametersInput)(nil)).Elem(), RequestSchemeMatchConditionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestSchemeMatchConditionParametersResponseInput)(nil)).Elem(), RequestSchemeMatchConditionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestUriMatchConditionParametersInput)(nil)).Elem(), RequestUriMatchConditionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RequestUriMatchConditionParametersResponseInput)(nil)).Elem(), RequestUriMatchConditionParametersResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ResponseBasedOriginErrorDetectionParametersInput)(nil)).Elem(), ResponseBasedOriginErrorDetectionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResponseBasedOriginErrorDetectionParametersPtrInput)(nil)).Elem(), ResponseBasedOriginErrorDetectionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResponseBasedOriginErrorDetectionParametersResponseInput)(nil)).Elem(), ResponseBasedOriginErrorDetectionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResponseBasedOriginErrorDetectionParametersResponsePtrInput)(nil)).Elem(), ResponseBasedOriginErrorDetectionParametersResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UrlFileExtensionMatchConditionParametersInput)(nil)).Elem(), UrlFileExtensionMatchConditionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlFileExtensionMatchConditionParametersResponseInput)(nil)).Elem(), UrlFileExtensionMatchConditionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlFileNameMatchConditionParametersInput)(nil)).Elem(), UrlFileNameMatchConditionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlFileNameMatchConditionParametersResponseInput)(nil)).Elem(), UrlFileNameMatchConditionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlPathMatchConditionParametersInput)(nil)).Elem(), UrlPathMatchConditionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlPathMatchConditionParametersResponseInput)(nil)).Elem(), UrlPathMatchConditionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlRedirectActionInput)(nil)).Elem(), UrlRedirectActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlRedirectActionParametersInput)(nil)).Elem(), UrlRedirectActionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlRedirectActionParametersResponseInput)(nil)).Elem(), UrlRedirectActionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlRedirectActionResponseInput)(nil)).Elem(), UrlRedirectActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlRewriteActionInput)(nil)).Elem(), UrlRewriteActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlRewriteActionParametersInput)(nil)).Elem(), UrlRewriteActionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlRewriteActionParametersResponseInput)(nil)).Elem(), UrlRewriteActionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlRewriteActionResponseInput)(nil)).Elem(), UrlRewriteActionResponseArgs{})
