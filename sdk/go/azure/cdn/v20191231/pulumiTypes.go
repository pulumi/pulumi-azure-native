...
// Defines the Origin Group override action for the delivery rule.
type OriginGroupOverrideActionInvokeResponse struct {
	// The name of the action for the delivery rule.
	// Expected value is 'OriginGroupOverride'.
	Name string `pulumi:"name"`
	// Defines the parameters for the action.
	Parameters OriginGroupOverrideActionParametersInvokeResponse `pulumi:"parameters"`
}

// OriginGroupOverrideActionInvokeResponseInput is an input type that accepts OriginGroupOverrideActionInvokeResponseArgs and OriginGroupOverrideActionInvokeResponseOutput values.
// You can construct a concrete instance of `OriginGroupOverrideActionInvokeResponseInput` via:
//
//          OriginGroupOverrideActionInvokeResponseArgs{...}
type OriginGroupOverrideActionInvokeResponseInput interface {
	pulumi.Input

	ToOriginGroupOverrideActionInvokeResponseOutput() OriginGroupOverrideActionInvokeResponseOutput
	ToOriginGroupOverrideActionInvokeResponseOutputWithContext(context.Context) OriginGroupOverrideActionInvokeResponseOutput
}

// Defines the Origin Group override action for the delivery rule.
type OriginGroupOverrideActionInvokeResponseArgs struct {
	// The name of the action for the delivery rule.
	// Expected value is 'OriginGroupOverride'.
	Name pulumi.StringInput `pulumi:"name"`
	// Defines the parameters for the action.
	Parameters OriginGroupOverrideActionParametersInvokeResponseInput `pulumi:"parameters"`
}

func (OriginGroupOverrideActionInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*OriginGroupOverrideActionInvokeResponse)(nil)).Elem()
}

func (i OriginGroupOverrideActionInvokeResponseArgs) ToOriginGroupOverrideActionInvokeResponseOutput() OriginGroupOverrideActionInvokeResponseOutput {
	return i.ToOriginGroupOverrideActionInvokeResponseOutputWithContext(context.Background())
}

func (i OriginGroupOverrideActionInvokeResponseArgs) ToOriginGroupOverrideActionInvokeResponseOutputWithContext(ctx context.Context) OriginGroupOverrideActionInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OriginGroupOverrideActionInvokeResponseOutput)
}

// Defines the Origin Group override action for the delivery rule.
type OriginGroupOverrideActionInvokeResponseOutput struct{ *pulumi.OutputState }

func (OriginGroupOverrideActionInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*OriginGroupOverrideActionInvokeResponse)(nil)).Elem()
}

func (o OriginGroupOverrideActionInvokeResponseOutput) ToOriginGroupOverrideActionInvokeResponseOutput() OriginGroupOverrideActionInvokeResponseOutput {
	return o
}

func (o OriginGroupOverrideActionInvokeResponseOutput) ToOriginGroupOverrideActionInvokeResponseOutputWithContext(ctx context.Context) OriginGroupOverrideActionInvokeResponseOutput {
	return o
}

// The name of the action for the delivery rule.
// Expected value is 'OriginGroupOverride'.
func (o OriginGroupOverrideActionInvokeResponseOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v OriginGroupOverrideActionInvokeResponse) string { return v.Name }).(pulumi.StringOutput)
}

// Defines the parameters for the action.
func (o OriginGroupOverrideActionInvokeResponseOutput) Parameters() OriginGroupOverrideActionParametersInvokeResponseOutput {
	return o.ApplyT(func(v OriginGroupOverrideActionInvokeResponse) OriginGroupOverrideActionParametersInvokeResponse {
		return v.Parameters
	}).(OriginGroupOverrideActionParametersInvokeResponseOutput)
}
...
// Defines the parameters for the Origin Group override action.
type OriginGroupOverrideActionParametersInvokeResponse struct {
	OdataType string `pulumi:"odataType"`
	// A reference to the origin group from where the content will be fetched from when CDN does not have it
	OriginGroup ResourceReferenceInvokeResponse `pulumi:"originGroup"`
}

// OriginGroupOverrideActionParametersInvokeResponseInput is an input type that accepts OriginGroupOverrideActionParametersInvokeResponseArgs and OriginGroupOverrideActionParametersInvokeResponseOutput values.
// You can construct a concrete instance of `OriginGroupOverrideActionParametersInvokeResponseInput` via:
//
//          OriginGroupOverrideActionParametersInvokeResponseArgs{...}
type OriginGroupOverrideActionParametersInvokeResponseInput interface {
	pulumi.Input

	ToOriginGroupOverrideActionParametersInvokeResponseOutput() OriginGroupOverrideActionParametersInvokeResponseOutput
	ToOriginGroupOverrideActionParametersInvokeResponseOutputWithContext(context.Context) OriginGroupOverrideActionParametersInvokeResponseOutput
}

// Defines the parameters for the Origin Group override action.
type OriginGroupOverrideActionParametersInvokeResponseArgs struct {
	OdataType pulumi.StringInput `pulumi:"odataType"`
	// A reference to the origin group from where the content will be fetched from when CDN does not have it
	OriginGroup ResourceReferenceInvokeResponseInput `pulumi:"originGroup"`
}

func (OriginGroupOverrideActionParametersInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*OriginGroupOverrideActionParametersInvokeResponse)(nil)).Elem()
}

func (i OriginGroupOverrideActionParametersInvokeResponseArgs) ToOriginGroupOverrideActionParametersInvokeResponseOutput() OriginGroupOverrideActionParametersInvokeResponseOutput {
	return i.ToOriginGroupOverrideActionParametersInvokeResponseOutputWithContext(context.Background())
}

func (i OriginGroupOverrideActionParametersInvokeResponseArgs) ToOriginGroupOverrideActionParametersInvokeResponseOutputWithContext(ctx context.Context) OriginGroupOverrideActionParametersInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OriginGroupOverrideActionParametersInvokeResponseOutput)
}

// Defines the parameters for the Origin Group override action.
type OriginGroupOverrideActionParametersInvokeResponseOutput struct{ *pulumi.OutputState }

func (OriginGroupOverrideActionParametersInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*OriginGroupOverrideActionParametersInvokeResponse)(nil)).Elem()
}

func (o OriginGroupOverrideActionParametersInvokeResponseOutput) ToOriginGroupOverrideActionParametersInvokeResponseOutput() OriginGroupOverrideActionParametersInvokeResponseOutput {
	return o
}

func (o OriginGroupOverrideActionParametersInvokeResponseOutput) ToOriginGroupOverrideActionParametersInvokeResponseOutputWithContext(ctx context.Context) OriginGroupOverrideActionParametersInvokeResponseOutput {
	return o
}

func (o OriginGroupOverrideActionParametersInvokeResponseOutput) OdataType() pulumi.StringOutput {
	return o.ApplyT(func(v OriginGroupOverrideActionParametersInvokeResponse) string { return v.OdataType }).(pulumi.StringOutput)
}

// A reference to the origin group from where the content will be fetched from when CDN does not have it
func (o OriginGroupOverrideActionParametersInvokeResponseOutput) OriginGroup() ResourceReferenceInvokeResponseOutput {
	return o.ApplyT(func(v OriginGroupOverrideActionParametersInvokeResponse) ResourceReferenceInvokeResponse {
...
func init() {
	...
	pulumi.RegisterOutputType(OriginGroupOverrideActionInvokeResponseOutput{})
	pulumi.RegisterOutputType(OriginGroupOverrideActionParametersOutput{})
	pulumi.RegisterOutputType(OriginGroupOverrideActionParametersInvokeResponseOutput{})
