...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CacheBehaviorInput)(nil)).Elem(), CacheBehavior("BypassCache"))
	pulumi.RegisterInputType(reflect.TypeOf((*CacheBehaviorPtrInput)(nil)).Elem(), CacheBehavior("BypassCache"))
	pulumi.RegisterInputType(reflect.TypeOf((*CacheTypeInput)(nil)).Elem(), CacheType("All"))
	pulumi.RegisterInputType(reflect.TypeOf((*CacheTypePtrInput)(nil)).Elem(), CacheType("All"))
	pulumi.RegisterInputType(reflect.TypeOf((*CookiesOperatorInput)(nil)).Elem(), CookiesOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*CookiesOperatorPtrInput)(nil)).Elem(), CookiesOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleActionInput)(nil)).Elem(), DeliveryRuleAction("CacheExpiration"))
	pulumi.RegisterInputType(reflect.TypeOf((*DeliveryRuleActionPtrInput)(nil)).Elem(), DeliveryRuleAction("CacheExpiration"))
	pulumi.RegisterInputType(reflect.TypeOf((*DestinationProtocolInput)(nil)).Elem(), DestinationProtocol("MatchRequest"))
	pulumi.RegisterInputType(reflect.TypeOf((*DestinationProtocolPtrInput)(nil)).Elem(), DestinationProtocol("MatchRequest"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderActionInput)(nil)).Elem(), HeaderAction("Append"))
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderActionPtrInput)(nil)).Elem(), HeaderAction("Append"))
	pulumi.RegisterInputType(reflect.TypeOf((*HealthProbeRequestTypeInput)(nil)).Elem(), HealthProbeRequestType("NotSet"))
	pulumi.RegisterInputType(reflect.TypeOf((*HealthProbeRequestTypePtrInput)(nil)).Elem(), HealthProbeRequestType("NotSet"))
	pulumi.RegisterInputType(reflect.TypeOf((*HttpVersionOperatorInput)(nil)).Elem(), HttpVersionOperator("Equal"))
	pulumi.RegisterInputType(reflect.TypeOf((*HttpVersionOperatorPtrInput)(nil)).Elem(), HttpVersionOperator("Equal"))
	pulumi.RegisterInputType(reflect.TypeOf((*IsDeviceOperatorInput)(nil)).Elem(), IsDeviceOperator("Equal"))
	pulumi.RegisterInputType(reflect.TypeOf((*IsDeviceOperatorPtrInput)(nil)).Elem(), IsDeviceOperator("Equal"))
	pulumi.RegisterInputType(reflect.TypeOf((*MatchVariableInput)(nil)).Elem(), MatchVariable("RemoteAddress"))
	pulumi.RegisterInputType(reflect.TypeOf((*MatchVariablePtrInput)(nil)).Elem(), MatchVariable("RemoteAddress"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PostArgsOperatorInput)(nil)).Elem(), PostArgsOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*PostArgsOperatorPtrInput)(nil)).Elem(), PostArgsOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProbeProtocolInput)(nil)).Elem(), ProbeProtocol("NotSet"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProbeProtocolPtrInput)(nil)).Elem(), ProbeProtocol("NotSet"))
	pulumi.RegisterInputType(reflect.TypeOf((*QueryStringBehaviorInput)(nil)).Elem(), QueryStringBehavior("Include"))
	pulumi.RegisterInputType(reflect.TypeOf((*QueryStringBehaviorPtrInput)(nil)).Elem(), QueryStringBehavior("Include"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*QueryStringOperatorInput)(nil)).Elem(), QueryStringOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*QueryStringOperatorPtrInput)(nil)).Elem(), QueryStringOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*RedirectTypeInput)(nil)).Elem(), RedirectType("Moved"))
	pulumi.RegisterInputType(reflect.TypeOf((*RedirectTypePtrInput)(nil)).Elem(), RedirectType("Moved"))
	pulumi.RegisterInputType(reflect.TypeOf((*RemoteAddressOperatorInput)(nil)).Elem(), RemoteAddressOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*RemoteAddressOperatorPtrInput)(nil)).Elem(), RemoteAddressOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*RequestBodyOperatorInput)(nil)).Elem(), RequestBodyOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*RequestBodyOperatorPtrInput)(nil)).Elem(), RequestBodyOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*RequestHeaderOperatorInput)(nil)).Elem(), RequestHeaderOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*RequestHeaderOperatorPtrInput)(nil)).Elem(), RequestHeaderOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*RequestMethodOperatorInput)(nil)).Elem(), RequestMethodOperator("Equal"))
	pulumi.RegisterInputType(reflect.TypeOf((*RequestMethodOperatorPtrInput)(nil)).Elem(), RequestMethodOperator("Equal"))
	pulumi.RegisterInputType(reflect.TypeOf((*RequestUriOperatorInput)(nil)).Elem(), RequestUriOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*RequestUriOperatorPtrInput)(nil)).Elem(), RequestUriOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*ResponseBasedDetectedErrorTypesInput)(nil)).Elem(), ResponseBasedDetectedErrorTypes("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*ResponseBasedDetectedErrorTypesPtrInput)(nil)).Elem(), ResponseBasedDetectedErrorTypes("None"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UrlFileExtensionOperatorInput)(nil)).Elem(), UrlFileExtensionOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*UrlFileExtensionOperatorPtrInput)(nil)).Elem(), UrlFileExtensionOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*UrlFileNameOperatorInput)(nil)).Elem(), UrlFileNameOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*UrlFileNameOperatorPtrInput)(nil)).Elem(), UrlFileNameOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*UrlPathOperatorInput)(nil)).Elem(), UrlPathOperator("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*UrlPathOperatorPtrInput)(nil)).Elem(), UrlPathOperator("Any"))
