...
func LookupAFDCustomDomain(ctx *pulumi.Context, args *LookupAFDCustomDomainArgs, opts ...pulumi.InvokeOption) (*LookupAFDCustomDomainResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:cdn/latest:getAFDCustomDomain", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupAFDCustomDomainResult struct {
	...
	AzureDnsZone     *ResourceReferenceInvokeResponse `pulumi:"azureDnsZone"`
	...
	TlsSettings *AFDDomainHttpsParametersInvokeResponse `pulumi:"tlsSettings"`
	// Resource type.
	Type string `pulumi:"type"`
	// Values the customer needs to validate domain ownership
	ValidationProperties DomainValidationPropertiesInvokeResponse `pulumi:"validationProperties"`
}
