...
func NewCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20161002:CustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomDomain(ctx *pulumi.Context,
	...
	var resource CustomDomain
	err := ctx.ReadResource("azure-native:cdn/v20161002:CustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o CustomDomainOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v *CustomDomain) pulumi.StringOutput { return v.Location }).(pulumi.StringOutput)
}
...
func (o CustomDomainOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *CustomDomain) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
