...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AFDEndpointProtocolsInput)(nil)).Elem(), AFDEndpointProtocols("Http"))
	pulumi.RegisterInputType(reflect.TypeOf((*AFDEndpointProtocolsPtrInput)(nil)).Elem(), AFDEndpointProtocols("Http"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AfdCertificateTypeInput)(nil)).Elem(), AfdCertificateType("CustomerCertificate"))
	pulumi.RegisterInputType(reflect.TypeOf((*AfdCertificateTypePtrInput)(nil)).Elem(), AfdCertificateType("CustomerCertificate"))
	pulumi.RegisterInputType(reflect.TypeOf((*AfdMinimumTlsVersionInput)(nil)).Elem(), AfdMinimumTlsVersion("TLS10"))
	pulumi.RegisterInputType(reflect.TypeOf((*AfdMinimumTlsVersionPtrInput)(nil)).Elem(), AfdMinimumTlsVersion("TLS10"))
	pulumi.RegisterInputType(reflect.TypeOf((*AfdQueryStringCachingBehaviorInput)(nil)).Elem(), AfdQueryStringCachingBehavior("IgnoreQueryString"))
	pulumi.RegisterInputType(reflect.TypeOf((*AfdQueryStringCachingBehaviorPtrInput)(nil)).Elem(), AfdQueryStringCachingBehavior("IgnoreQueryString"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EnabledStateInput)(nil)).Elem(), EnabledState("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*EnabledStatePtrInput)(nil)).Elem(), EnabledState("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ForwardingProtocolInput)(nil)).Elem(), ForwardingProtocol("HttpOnly"))
	pulumi.RegisterInputType(reflect.TypeOf((*ForwardingProtocolPtrInput)(nil)).Elem(), ForwardingProtocol("HttpOnly"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HttpsRedirectInput)(nil)).Elem(), HttpsRedirect("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*HttpsRedirectPtrInput)(nil)).Elem(), HttpsRedirect("Enabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LinkToDefaultDomainInput)(nil)).Elem(), LinkToDefaultDomain("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*LinkToDefaultDomainPtrInput)(nil)).Elem(), LinkToDefaultDomain("Enabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SecretTypeInput)(nil)).Elem(), SecretType("UrlSigningKey"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecretTypePtrInput)(nil)).Elem(), SecretType("UrlSigningKey"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityPolicyTypeInput)(nil)).Elem(), SecurityPolicyType("WebApplicationFirewall"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityPolicyTypePtrInput)(nil)).Elem(), SecurityPolicyType("WebApplicationFirewall"))
