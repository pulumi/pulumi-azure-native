...
func NewOrigin(ctx *pulumi.Context,
	...
	var resource Origin
	err := ctx.RegisterResource("azure-nextgen:cdn/v20200901:Origin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrigin(ctx *pulumi.Context,
	...
	var resource Origin
	err := ctx.ReadResource("azure-nextgen:cdn/v20200901:Origin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
