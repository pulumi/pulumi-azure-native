...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AFDDomainHttpsParametersResponseInput)(nil)).Elem(), AFDDomainHttpsParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AFDDomainHttpsParametersResponsePtrInput)(nil)).Elem(), AFDDomainHttpsParametersResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CompressionSettingsResponseArrayInput)(nil)).Elem(), CompressionSettingsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CustomRuleInput)(nil)).Elem(), CustomRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomRuleArrayInput)(nil)).Elem(), CustomRuleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomRuleListInput)(nil)).Elem(), CustomRuleListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomRuleListPtrInput)(nil)).Elem(), CustomRuleListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomRuleListResponseInput)(nil)).Elem(), CustomRuleListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomRuleListResponsePtrInput)(nil)).Elem(), CustomRuleListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomRuleResponseInput)(nil)).Elem(), CustomRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomRuleResponseArrayInput)(nil)).Elem(), CustomRuleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomerCertificateParametersInput)(nil)).Elem(), CustomerCertificateParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomerCertificateParametersResponseInput)(nil)).Elem(), CustomerCertificateParametersResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DomainValidationPropertiesResponseInput)(nil)).Elem(), DomainValidationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DomainValidationPropertiesResponsePtrInput)(nil)).Elem(), DomainValidationPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointPropertiesUpdateParametersResponseWebApplicationFirewallPolicyLinkInput)(nil)).Elem(), EndpointPropertiesUpdateParametersResponseWebApplicationFirewallPolicyLinkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointPropertiesUpdateParametersResponseWebApplicationFirewallPolicyLinkPtrInput)(nil)).Elem(), EndpointPropertiesUpdateParametersResponseWebApplicationFirewallPolicyLinkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkInput)(nil)).Elem(), EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkPtrInput)(nil)).Elem(), EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancingSettingsParametersPtrInput)(nil)).Elem(), LoadBalancingSettingsParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancingSettingsParametersResponseInput)(nil)).Elem(), LoadBalancingSettingsParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancingSettingsParametersResponsePtrInput)(nil)).Elem(), LoadBalancingSettingsParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedCertificateParametersInput)(nil)).Elem(), ManagedCertificateParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedCertificateParametersResponseInput)(nil)).Elem(), ManagedCertificateParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleGroupOverrideInput)(nil)).Elem(), ManagedRuleGroupOverrideArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleGroupOverrideArrayInput)(nil)).Elem(), ManagedRuleGroupOverrideArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleGroupOverrideResponseInput)(nil)).Elem(), ManagedRuleGroupOverrideResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleGroupOverrideResponseArrayInput)(nil)).Elem(), ManagedRuleGroupOverrideResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleOverrideInput)(nil)).Elem(), ManagedRuleOverrideArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleOverrideArrayInput)(nil)).Elem(), ManagedRuleOverrideArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleOverrideResponseInput)(nil)).Elem(), ManagedRuleOverrideResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleOverrideResponseArrayInput)(nil)).Elem(), ManagedRuleOverrideResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleSetInput)(nil)).Elem(), ManagedRuleSetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleSetArrayInput)(nil)).Elem(), ManagedRuleSetArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleSetListInput)(nil)).Elem(), ManagedRuleSetListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleSetListPtrInput)(nil)).Elem(), ManagedRuleSetListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleSetListResponseInput)(nil)).Elem(), ManagedRuleSetListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleSetListResponsePtrInput)(nil)).Elem(), ManagedRuleSetListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleSetResponseInput)(nil)).Elem(), ManagedRuleSetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedRuleSetResponseArrayInput)(nil)).Elem(), ManagedRuleSetResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MatchConditionResponseInput)(nil)).Elem(), MatchConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MatchConditionResponseArrayInput)(nil)).Elem(), MatchConditionResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PolicySettingsInput)(nil)).Elem(), PolicySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicySettingsPtrInput)(nil)).Elem(), PolicySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicySettingsResponseInput)(nil)).Elem(), PolicySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicySettingsResponsePtrInput)(nil)).Elem(), PolicySettingsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RateLimitRuleInput)(nil)).Elem(), RateLimitRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RateLimitRuleArrayInput)(nil)).Elem(), RateLimitRuleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RateLimitRuleListInput)(nil)).Elem(), RateLimitRuleListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RateLimitRuleListPtrInput)(nil)).Elem(), RateLimitRuleListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RateLimitRuleListResponseInput)(nil)).Elem(), RateLimitRuleListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RateLimitRuleListResponsePtrInput)(nil)).Elem(), RateLimitRuleListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RateLimitRuleResponseInput)(nil)).Elem(), RateLimitRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RateLimitRuleResponseArrayInput)(nil)).Elem(), RateLimitRuleResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityPolicyWebApplicationFirewallAssociationInput)(nil)).Elem(), SecurityPolicyWebApplicationFirewallAssociationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityPolicyWebApplicationFirewallAssociationArrayInput)(nil)).Elem(), SecurityPolicyWebApplicationFirewallAssociationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityPolicyWebApplicationFirewallAssociationResponseInput)(nil)).Elem(), SecurityPolicyWebApplicationFirewallAssociationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityPolicyWebApplicationFirewallAssociationResponseArrayInput)(nil)).Elem(), SecurityPolicyWebApplicationFirewallAssociationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityPolicyWebApplicationFirewallParametersInput)(nil)).Elem(), SecurityPolicyWebApplicationFirewallParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityPolicyWebApplicationFirewallParametersPtrInput)(nil)).Elem(), SecurityPolicyWebApplicationFirewallParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityPolicyWebApplicationFirewallParametersResponseInput)(nil)).Elem(), SecurityPolicyWebApplicationFirewallParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityPolicyWebApplicationFirewallParametersResponsePtrInput)(nil)).Elem(), SecurityPolicyWebApplicationFirewallParametersResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SharedPrivateLinkResourcePropertiesArrayInput)(nil)).Elem(), SharedPrivateLinkResourcePropertiesArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SharedPrivateLinkResourcePropertiesResponseArrayInput)(nil)).Elem(), SharedPrivateLinkResourcePropertiesResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UrlSigningActionInput)(nil)).Elem(), UrlSigningActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlSigningActionParametersInput)(nil)).Elem(), UrlSigningActionParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlSigningActionParametersResponseInput)(nil)).Elem(), UrlSigningActionParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlSigningActionResponseInput)(nil)).Elem(), UrlSigningActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlSigningKeyInput)(nil)).Elem(), UrlSigningKeyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlSigningKeyArrayInput)(nil)).Elem(), UrlSigningKeyArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlSigningKeyParametersInput)(nil)).Elem(), UrlSigningKeyParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlSigningKeyParametersResponseInput)(nil)).Elem(), UrlSigningKeyParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlSigningKeyResponseInput)(nil)).Elem(), UrlSigningKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlSigningKeyResponseArrayInput)(nil)).Elem(), UrlSigningKeyResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*UrlSigningParamIdentifierInput)(nil)).Elem(), UrlSigningParamIdentifierArgs{})
