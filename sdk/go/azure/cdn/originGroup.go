...
func NewOriginGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:cdn:OriginGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOriginGroup(ctx *pulumi.Context,
	...
	var resource OriginGroup
	err := ctx.ReadResource("azure-nextgen:cdn:OriginGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
