...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MatchVariableInput)(nil)).Elem(), MatchVariable("RemoteAddr"))
	pulumi.RegisterInputType(reflect.TypeOf((*MatchVariablePtrInput)(nil)).Elem(), MatchVariable("RemoteAddr"))
