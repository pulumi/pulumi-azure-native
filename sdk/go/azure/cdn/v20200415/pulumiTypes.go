...
// The Alias of the Private Link resource. Populating this optional field indicates that this origin is 'Private'
func (o DeepCreatedOriginInvokeResponseOutput) PrivateLinkAlias() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DeepCreatedOriginInvokeResponse) *string { return v.PrivateLinkAlias }).(pulumi.StringPtrOutput)
}

// A custom message to be included in the approval request to connect to the Private Link.
func (o DeepCreatedOriginInvokeResponseOutput) PrivateLinkApprovalMessage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DeepCreatedOriginInvokeResponse) *string { return v.PrivateLinkApprovalMessage }).(pulumi.StringPtrOutput)
}

// The location of the Private Link resource. Required only if 'privateLinkResourceId' is populated
func (o DeepCreatedOriginInvokeResponseOutput) PrivateLinkLocation() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DeepCreatedOriginInvokeResponse) *string { return v.PrivateLinkLocation }).(pulumi.StringPtrOutput)
}

// The Resource Id of the Private Link resource. Populating this optional field indicates that this backend is 'Private'
func (o DeepCreatedOriginInvokeResponseOutput) PrivateLinkResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DeepCreatedOriginInvokeResponse) *string { return v.PrivateLinkResourceId }).(pulumi.StringPtrOutput)
}
