...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AlgorithmInput)(nil)).Elem(), Algorithm("SHA256"))
	pulumi.RegisterInputType(reflect.TypeOf((*AlgorithmPtrInput)(nil)).Elem(), Algorithm("SHA256"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ParamIndicatorInput)(nil)).Elem(), ParamIndicator("Expires"))
	pulumi.RegisterInputType(reflect.TypeOf((*ParamIndicatorPtrInput)(nil)).Elem(), ParamIndicator("Expires"))
