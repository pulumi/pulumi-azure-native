...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphClearEndpointInput)(nil)).Elem(), MediaGraphClearEndpointArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphClearEndpointResponseInput)(nil)).Elem(), MediaGraphClearEndpointResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphPemCertificateListInput)(nil)).Elem(), MediaGraphPemCertificateListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphPemCertificateListPtrInput)(nil)).Elem(), MediaGraphPemCertificateListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphPemCertificateListResponseInput)(nil)).Elem(), MediaGraphPemCertificateListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphPemCertificateListResponsePtrInput)(nil)).Elem(), MediaGraphPemCertificateListResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphTlsEndpointInput)(nil)).Elem(), MediaGraphTlsEndpointArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphTlsEndpointResponseInput)(nil)).Elem(), MediaGraphTlsEndpointResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphTlsValidationOptionsInput)(nil)).Elem(), MediaGraphTlsValidationOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphTlsValidationOptionsPtrInput)(nil)).Elem(), MediaGraphTlsValidationOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphTlsValidationOptionsResponseInput)(nil)).Elem(), MediaGraphTlsValidationOptionsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphTlsValidationOptionsResponsePtrInput)(nil)).Elem(), MediaGraphTlsValidationOptionsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphUsernamePasswordCredentialsInput)(nil)).Elem(), MediaGraphUsernamePasswordCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphUsernamePasswordCredentialsPtrInput)(nil)).Elem(), MediaGraphUsernamePasswordCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphUsernamePasswordCredentialsResponseInput)(nil)).Elem(), MediaGraphUsernamePasswordCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MediaGraphUsernamePasswordCredentialsResponsePtrInput)(nil)).Elem(), MediaGraphUsernamePasswordCredentialsResponseArgs{})
