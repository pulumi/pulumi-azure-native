...
func NewContentKeyPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:media/v20180701:ContentKeyPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentKeyPolicy(ctx *pulumi.Context,
	...
	var resource ContentKeyPolicy
	err := ctx.ReadResource("azure-nextgen:media/v20180701:ContentKeyPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
