...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AbsoluteClipTimePtrInput)(nil)).Elem(), AbsoluteClipTimeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AbsoluteClipTimeResponseInput)(nil)).Elem(), AbsoluteClipTimeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AbsoluteClipTimeResponsePtrInput)(nil)).Elem(), AbsoluteClipTimeResponseArgs{})
