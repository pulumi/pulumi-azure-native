...
func NewLiveOutput(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:media/v20180601preview:LiveOutput", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLiveOutput(ctx *pulumi.Context,
	...
	var resource LiveOutput
	err := ctx.ReadResource("azure-nextgen:media/v20180601preview:LiveOutput", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
