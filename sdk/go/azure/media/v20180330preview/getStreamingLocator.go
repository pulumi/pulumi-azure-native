...
func LookupStreamingLocator(ctx *pulumi.Context, args *LookupStreamingLocatorArgs, opts ...pulumi.InvokeOption) (*LookupStreamingLocatorResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:media/v20180330preview:getStreamingLocator", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupStreamingLocatorResult struct {
	...
	ContentKeys []StreamingLocatorUserDefinedContentKeyInvokeResponse `pulumi:"contentKeys"`
