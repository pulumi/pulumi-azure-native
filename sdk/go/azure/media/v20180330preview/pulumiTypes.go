...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StreamingLocatorUserDefinedContentKeyInput)(nil)).Elem(), StreamingLocatorUserDefinedContentKeyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StreamingLocatorUserDefinedContentKeyArrayInput)(nil)).Elem(), StreamingLocatorUserDefinedContentKeyArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*StreamingLocatorUserDefinedContentKeyResponseInput)(nil)).Elem(), StreamingLocatorUserDefinedContentKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StreamingLocatorUserDefinedContentKeyResponseArrayInput)(nil)).Elem(), StreamingLocatorUserDefinedContentKeyResponseArray{})
