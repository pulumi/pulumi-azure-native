...
func NewTransform(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:media/v20180330preview:Transform", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransform(ctx *pulumi.Context,
	...
	var resource Transform
	err := ctx.ReadResource("azure-nextgen:media/v20180330preview:Transform", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
