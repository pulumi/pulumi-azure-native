...
func NewStreamingLocator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:media/v20180330preview:StreamingLocator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStreamingLocator(ctx *pulumi.Context,
	...
	var resource StreamingLocator
	err := ctx.ReadResource("azure-nextgen:media/v20180330preview:StreamingLocator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
