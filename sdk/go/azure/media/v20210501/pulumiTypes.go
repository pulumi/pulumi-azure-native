...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AccessControlInput)(nil)).Elem(), AccessControlArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessControlPtrInput)(nil)).Elem(), AccessControlArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessControlResponseInput)(nil)).Elem(), AccessControlResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessControlResponsePtrInput)(nil)).Elem(), AccessControlResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeyDeliveryInput)(nil)).Elem(), KeyDeliveryArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyDeliveryPtrInput)(nil)).Elem(), KeyDeliveryArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyDeliveryResponseInput)(nil)).Elem(), KeyDeliveryResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyDeliveryResponsePtrInput)(nil)).Elem(), KeyDeliveryResponseArgs{})
