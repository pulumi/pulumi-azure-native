...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AnalysisResolutionInput)(nil)).Elem(), AnalysisResolution("SourceResolution"))
	pulumi.RegisterInputType(reflect.TypeOf((*AnalysisResolutionPtrInput)(nil)).Elem(), AnalysisResolution("SourceResolution"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AttributeFilterInput)(nil)).Elem(), AttributeFilter("All"))
	pulumi.RegisterInputType(reflect.TypeOf((*AttributeFilterPtrInput)(nil)).Elem(), AttributeFilter("All"))
	pulumi.RegisterInputType(reflect.TypeOf((*AudioAnalysisModeInput)(nil)).Elem(), AudioAnalysisMode("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*AudioAnalysisModePtrInput)(nil)).Elem(), AudioAnalysisMode("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*BlurTypeInput)(nil)).Elem(), BlurType("Box"))
	pulumi.RegisterInputType(reflect.TypeOf((*BlurTypePtrInput)(nil)).Elem(), BlurType("Box"))
	pulumi.RegisterInputType(reflect.TypeOf((*ChannelMappingInput)(nil)).Elem(), ChannelMapping("FrontLeft"))
	pulumi.RegisterInputType(reflect.TypeOf((*ChannelMappingPtrInput)(nil)).Elem(), ChannelMapping("FrontLeft"))
	pulumi.RegisterInputType(reflect.TypeOf((*ComplexityInput)(nil)).Elem(), Complexity("Speed"))
	pulumi.RegisterInputType(reflect.TypeOf((*ComplexityPtrInput)(nil)).Elem(), Complexity("Speed"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncoderNamedPresetInput)(nil)).Elem(), EncoderNamedPreset("H264SingleBitrateSD"))
	pulumi.RegisterInputType(reflect.TypeOf((*EncoderNamedPresetPtrInput)(nil)).Elem(), EncoderNamedPreset("H264SingleBitrateSD"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*FaceRedactorModeInput)(nil)).Elem(), FaceRedactorMode("Analyze"))
	pulumi.RegisterInputType(reflect.TypeOf((*FaceRedactorModePtrInput)(nil)).Elem(), FaceRedactorMode("Analyze"))
	pulumi.RegisterInputType(reflect.TypeOf((*FilterTrackPropertyCompareOperationInput)(nil)).Elem(), FilterTrackPropertyCompareOperation("Equal"))
	pulumi.RegisterInputType(reflect.TypeOf((*FilterTrackPropertyCompareOperationPtrInput)(nil)).Elem(), FilterTrackPropertyCompareOperation("Equal"))
	pulumi.RegisterInputType(reflect.TypeOf((*FilterTrackPropertyTypeInput)(nil)).Elem(), FilterTrackPropertyType("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*FilterTrackPropertyTypePtrInput)(nil)).Elem(), FilterTrackPropertyType("Unknown"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*H265ComplexityInput)(nil)).Elem(), H265Complexity("Speed"))
	pulumi.RegisterInputType(reflect.TypeOf((*H265ComplexityPtrInput)(nil)).Elem(), H265Complexity("Speed"))
	pulumi.RegisterInputType(reflect.TypeOf((*H265VideoProfileInput)(nil)).Elem(), H265VideoProfile("Auto"))
	pulumi.RegisterInputType(reflect.TypeOf((*H265VideoProfilePtrInput)(nil)).Elem(), H265VideoProfile("Auto"))
	pulumi.RegisterInputType(reflect.TypeOf((*InsightsTypeInput)(nil)).Elem(), InsightsType("AudioInsightsOnly"))
	pulumi.RegisterInputType(reflect.TypeOf((*InsightsTypePtrInput)(nil)).Elem(), InsightsType("AudioInsightsOnly"))
	pulumi.RegisterInputType(reflect.TypeOf((*InterleaveOutputInput)(nil)).Elem(), InterleaveOutput("NonInterleavedOutput"))
	pulumi.RegisterInputType(reflect.TypeOf((*InterleaveOutputPtrInput)(nil)).Elem(), InterleaveOutput("NonInterleavedOutput"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TrackAttributeInput)(nil)).Elem(), TrackAttribute("Bitrate"))
	pulumi.RegisterInputType(reflect.TypeOf((*TrackAttributePtrInput)(nil)).Elem(), TrackAttribute("Bitrate"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VideoSyncModeInput)(nil)).Elem(), VideoSyncMode("Auto"))
	pulumi.RegisterInputType(reflect.TypeOf((*VideoSyncModePtrInput)(nil)).Elem(), VideoSyncMode("Auto"))
