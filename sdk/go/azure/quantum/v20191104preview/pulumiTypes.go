...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ProviderInput)(nil)).Elem(), ProviderArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*QuantumWorkspaceIdentityInput)(nil)).Elem(), QuantumWorkspaceIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QuantumWorkspaceIdentityPtrInput)(nil)).Elem(), QuantumWorkspaceIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QuantumWorkspaceResponseIdentityInput)(nil)).Elem(), QuantumWorkspaceResponseIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*QuantumWorkspaceResponseIdentityPtrInput)(nil)).Elem(), QuantumWorkspaceResponseIdentityArgs{})
