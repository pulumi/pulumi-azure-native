...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:communication:getCommunicationService'.
func LookupCommunicationService(ctx *pulumi.Context, args *LookupCommunicationServiceArgs, opts ...pulumi.InvokeOption) (*LookupCommunicationServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:communication/latest:getCommunicationService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
