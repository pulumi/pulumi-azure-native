...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:communication:CommunicationService'.
...
func NewCommunicationService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:communication/latest:CommunicationService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCommunicationService(ctx *pulumi.Context,
	...
	var resource CommunicationService
	err := ctx.ReadResource("azure-native:communication/latest:CommunicationService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
