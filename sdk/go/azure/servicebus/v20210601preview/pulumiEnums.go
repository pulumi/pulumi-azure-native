...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EndPointProvisioningStateInput)(nil)).Elem(), EndPointProvisioningState("Creating"))
	pulumi.RegisterInputType(reflect.TypeOf((*EndPointProvisioningStatePtrInput)(nil)).Elem(), EndPointProvisioningState("Creating"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*FilterTypeInput)(nil)).Elem(), FilterType("SqlFilter"))
	pulumi.RegisterInputType(reflect.TypeOf((*FilterTypePtrInput)(nil)).Elem(), FilterType("SqlFilter"))
	pulumi.RegisterInputType(reflect.TypeOf((*KeySourceInput)(nil)).Elem(), KeySource("Microsoft.KeyVault"))
	pulumi.RegisterInputType(reflect.TypeOf((*KeySourcePtrInput)(nil)).Elem(), KeySource("Microsoft.KeyVault"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkConnectionStatusInput)(nil)).Elem(), PrivateLinkConnectionStatus("Pending"))
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkConnectionStatusPtrInput)(nil)).Elem(), PrivateLinkConnectionStatus("Pending"))
	pulumi.RegisterInputType(reflect.TypeOf((*PublicNetworkAccessFlagInput)(nil)).Elem(), PublicNetworkAccessFlag("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*PublicNetworkAccessFlagPtrInput)(nil)).Elem(), PublicNetworkAccessFlag("Enabled"))
