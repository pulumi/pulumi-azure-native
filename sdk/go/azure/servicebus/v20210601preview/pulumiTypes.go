...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SBClientAffinePropertiesInput)(nil)).Elem(), SBClientAffinePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SBClientAffinePropertiesPtrInput)(nil)).Elem(), SBClientAffinePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SBClientAffinePropertiesResponseInput)(nil)).Elem(), SBClientAffinePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SBClientAffinePropertiesResponsePtrInput)(nil)).Elem(), SBClientAffinePropertiesResponseArgs{})
