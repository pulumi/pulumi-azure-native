...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EntityAvailabilityStatusInput)(nil)).Elem(), EntityAvailabilityStatus("Available"))
	pulumi.RegisterInputType(reflect.TypeOf((*EntityAvailabilityStatusPtrInput)(nil)).Elem(), EntityAvailabilityStatus("Available"))
