...
func NewDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:servicebus/v20210101preview:DisasterRecoveryConfig"),
		},
		{
			Type: pulumi.String("azure-native:servicebus/v20210601preview:DisasterRecoveryConfig"),
		},
		{
			Type: pulumi.String("azure-nextgen:servicebus/v20210601preview:DisasterRecoveryConfig"),
		},
	})
