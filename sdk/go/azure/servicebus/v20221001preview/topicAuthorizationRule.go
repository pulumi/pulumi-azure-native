...
func NewTopicAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicebus/v20221001preview:TopicAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopicAuthorizationRule(ctx *pulumi.Context,
	...
	var resource TopicAuthorizationRule
	err := ctx.ReadResource("azure-native:servicebus/v20221001preview:TopicAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
