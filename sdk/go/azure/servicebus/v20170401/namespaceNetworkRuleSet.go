...
func NewNamespaceNetworkRuleSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:servicebus/v20170401:NamespaceNetworkRuleSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceNetworkRuleSet(ctx *pulumi.Context,
	...
	var resource NamespaceNetworkRuleSet
	err := ctx.ReadResource("azure-nextgen:servicebus/v20170401:NamespaceNetworkRuleSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
