...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CorrelationFilterInput)(nil)).Elem(), CorrelationFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorrelationFilterPtrInput)(nil)).Elem(), CorrelationFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorrelationFilterResponseInput)(nil)).Elem(), CorrelationFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorrelationFilterResponsePtrInput)(nil)).Elem(), CorrelationFilterResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SBSkuInput)(nil)).Elem(), SBSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SBSkuPtrInput)(nil)).Elem(), SBSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SBSkuResponseInput)(nil)).Elem(), SBSkuResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SBSkuResponsePtrInput)(nil)).Elem(), SBSkuResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlFilterInput)(nil)).Elem(), SqlFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlFilterPtrInput)(nil)).Elem(), SqlFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlFilterResponseInput)(nil)).Elem(), SqlFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlFilterResponsePtrInput)(nil)).Elem(), SqlFilterResponseArgs{})
