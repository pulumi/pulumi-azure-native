...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IPActionInput)(nil)).Elem(), IPAction("Accept"))
	pulumi.RegisterInputType(reflect.TypeOf((*IPActionPtrInput)(nil)).Elem(), IPAction("Accept"))
