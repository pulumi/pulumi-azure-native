...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DictionaryValueResponseInput)(nil)).Elem(), DictionaryValueResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DictionaryValueResponseMapInput)(nil)).Elem(), DictionaryValueResponseMap{})
