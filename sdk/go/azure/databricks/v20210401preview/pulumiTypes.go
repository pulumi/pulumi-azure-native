...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CreatedByResponseInput)(nil)).Elem(), CreatedByResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CreatedByResponsePtrInput)(nil)).Elem(), CreatedByResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionEntitiesDefinitionInput)(nil)).Elem(), EncryptionEntitiesDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionEntitiesDefinitionPtrInput)(nil)).Elem(), EncryptionEntitiesDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionEntitiesDefinitionResponseInput)(nil)).Elem(), EncryptionEntitiesDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionEntitiesDefinitionResponsePtrInput)(nil)).Elem(), EncryptionEntitiesDefinitionResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionV2Input)(nil)).Elem(), EncryptionV2Args{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionV2PtrInput)(nil)).Elem(), EncryptionV2Args{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionV2KeyVaultPropertiesInput)(nil)).Elem(), EncryptionV2KeyVaultPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionV2KeyVaultPropertiesPtrInput)(nil)).Elem(), EncryptionV2KeyVaultPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionV2ResponseInput)(nil)).Elem(), EncryptionV2ResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionV2ResponsePtrInput)(nil)).Elem(), EncryptionV2ResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionV2ResponseKeyVaultPropertiesInput)(nil)).Elem(), EncryptionV2ResponseKeyVaultPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionV2ResponseKeyVaultPropertiesPtrInput)(nil)).Elem(), EncryptionV2ResponseKeyVaultPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedIdentityConfigurationResponseInput)(nil)).Elem(), ManagedIdentityConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedIdentityConfigurationResponsePtrInput)(nil)).Elem(), ManagedIdentityConfigurationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkInput)(nil)).Elem(), VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkPtrInput)(nil)).Elem(), VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkInput)(nil)).Elem(), VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkPtrInput)(nil)).Elem(), VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetworkInput)(nil)).Elem(), VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetworkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetworkPtrInput)(nil)).Elem(), VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetworkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetworkInput)(nil)).Elem(), VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetworkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetworkPtrInput)(nil)).Elem(), VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetworkArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceCustomBooleanParameterInput)(nil)).Elem(), WorkspaceCustomBooleanParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceCustomBooleanParameterPtrInput)(nil)).Elem(), WorkspaceCustomBooleanParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceCustomBooleanParameterResponseInput)(nil)).Elem(), WorkspaceCustomBooleanParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceCustomBooleanParameterResponsePtrInput)(nil)).Elem(), WorkspaceCustomBooleanParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceCustomObjectParameterResponseInput)(nil)).Elem(), WorkspaceCustomObjectParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceCustomObjectParameterResponsePtrInput)(nil)).Elem(), WorkspaceCustomObjectParameterResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceCustomParametersResponseInput)(nil)).Elem(), WorkspaceCustomParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceCustomParametersResponsePtrInput)(nil)).Elem(), WorkspaceCustomParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceCustomStringParameterInput)(nil)).Elem(), WorkspaceCustomStringParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceCustomStringParameterPtrInput)(nil)).Elem(), WorkspaceCustomStringParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceCustomStringParameterResponseInput)(nil)).Elem(), WorkspaceCustomStringParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceCustomStringParameterResponsePtrInput)(nil)).Elem(), WorkspaceCustomStringParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceEncryptionParameterInput)(nil)).Elem(), WorkspaceEncryptionParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceEncryptionParameterPtrInput)(nil)).Elem(), WorkspaceEncryptionParameterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceEncryptionParameterResponseInput)(nil)).Elem(), WorkspaceEncryptionParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceEncryptionParameterResponsePtrInput)(nil)).Elem(), WorkspaceEncryptionParameterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspacePropertiesEncryptionInput)(nil)).Elem(), WorkspacePropertiesEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspacePropertiesEncryptionPtrInput)(nil)).Elem(), WorkspacePropertiesEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspacePropertiesResponseEncryptionInput)(nil)).Elem(), WorkspacePropertiesResponseEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspacePropertiesResponseEncryptionPtrInput)(nil)).Elem(), WorkspacePropertiesResponseEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceProviderAuthorizationInput)(nil)).Elem(), WorkspaceProviderAuthorizationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceProviderAuthorizationArrayInput)(nil)).Elem(), WorkspaceProviderAuthorizationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceProviderAuthorizationResponseInput)(nil)).Elem(), WorkspaceProviderAuthorizationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WorkspaceProviderAuthorizationResponseArrayInput)(nil)).Elem(), WorkspaceProviderAuthorizationResponseArray{})
