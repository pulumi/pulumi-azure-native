...
// DataDestinationTypeInput is an input type that accepts DataDestinationTypeArgs and DataDestinationTypeOutput values.
// You can construct a concrete instance of `DataDestinationTypeInput` via:
//
//          DataDestinationTypeArgs{...}
