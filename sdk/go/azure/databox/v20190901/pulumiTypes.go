...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DcAccessSecurityCodeResponsePtrInput)(nil)).Elem(), DcAccessSecurityCodeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DestinationManagedDiskDetailsInput)(nil)).Elem(), DestinationManagedDiskDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DestinationManagedDiskDetailsResponseInput)(nil)).Elem(), DestinationManagedDiskDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DestinationStorageAccountDetailsInput)(nil)).Elem(), DestinationStorageAccountDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DestinationStorageAccountDetailsResponseInput)(nil)).Elem(), DestinationStorageAccountDetailsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*JobErrorDetailsResponseInput)(nil)).Elem(), JobErrorDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobErrorDetailsResponseArrayInput)(nil)).Elem(), JobErrorDetailsResponseArray{})
