...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DataAccountTypeInput)(nil)).Elem(), DataAccountType("StorageAccount"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataAccountTypePtrInput)(nil)).Elem(), DataAccountType("StorageAccount"))
	pulumi.RegisterInputType(reflect.TypeOf((*DoubleEncryptionInput)(nil)).Elem(), DoubleEncryption("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*DoubleEncryptionPtrInput)(nil)).Elem(), DoubleEncryption("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*FilterFileTypeInput)(nil)).Elem(), FilterFileType("AzureBlob"))
	pulumi.RegisterInputType(reflect.TypeOf((*FilterFileTypePtrInput)(nil)).Elem(), FilterFileType("AzureBlob"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KekTypeInput)(nil)).Elem(), KekType("MicrosoftManaged"))
	pulumi.RegisterInputType(reflect.TypeOf((*KekTypePtrInput)(nil)).Elem(), KekType("MicrosoftManaged"))
	pulumi.RegisterInputType(reflect.TypeOf((*LogCollectionLevelInput)(nil)).Elem(), LogCollectionLevel("Error"))
	pulumi.RegisterInputType(reflect.TypeOf((*LogCollectionLevelPtrInput)(nil)).Elem(), LogCollectionLevel("Error"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TransferConfigurationTypeInput)(nil)).Elem(), TransferConfigurationType("TransferAll"))
	pulumi.RegisterInputType(reflect.TypeOf((*TransferConfigurationTypePtrInput)(nil)).Elem(), TransferConfigurationType("TransferAll"))
	pulumi.RegisterInputType(reflect.TypeOf((*TransferTypeInput)(nil)).Elem(), TransferType("ImportToAzure"))
	pulumi.RegisterInputType(reflect.TypeOf((*TransferTypePtrInput)(nil)).Elem(), TransferType("ImportToAzure"))
