...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AccountCredentialDetailsResponseInput)(nil)).Elem(), AccountCredentialDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountCredentialDetailsResponseArrayInput)(nil)).Elem(), AccountCredentialDetailsResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdditionalErrorInfoResponseInput)(nil)).Elem(), AdditionalErrorInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdditionalErrorInfoResponseArrayInput)(nil)).Elem(), AdditionalErrorInfoResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplianceNetworkConfigurationResponseInput)(nil)).Elem(), ApplianceNetworkConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplianceNetworkConfigurationResponseArrayInput)(nil)).Elem(), ApplianceNetworkConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFileFilterDetailsInput)(nil)).Elem(), AzureFileFilterDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFileFilterDetailsPtrInput)(nil)).Elem(), AzureFileFilterDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFileFilterDetailsResponseInput)(nil)).Elem(), AzureFileFilterDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFileFilterDetailsResponsePtrInput)(nil)).Elem(), AzureFileFilterDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobFilterDetailsInput)(nil)).Elem(), BlobFilterDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobFilterDetailsPtrInput)(nil)).Elem(), BlobFilterDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobFilterDetailsResponseInput)(nil)).Elem(), BlobFilterDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobFilterDetailsResponsePtrInput)(nil)).Elem(), BlobFilterDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudErrorResponseInput)(nil)).Elem(), CloudErrorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudErrorResponsePtrInput)(nil)).Elem(), CloudErrorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudErrorResponseArrayInput)(nil)).Elem(), CloudErrorResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CopyProgressResponseInput)(nil)).Elem(), CopyProgressResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CopyProgressResponseArrayInput)(nil)).Elem(), CopyProgressResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomerDiskJobSecretsResponseInput)(nil)).Elem(), CustomerDiskJobSecretsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxAccountCopyLogDetailsResponseInput)(nil)).Elem(), DataBoxAccountCopyLogDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxCustomerDiskCopyLogDetailsResponseInput)(nil)).Elem(), DataBoxCustomerDiskCopyLogDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxCustomerDiskCopyProgressResponseInput)(nil)).Elem(), DataBoxCustomerDiskCopyProgressResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxCustomerDiskCopyProgressResponseArrayInput)(nil)).Elem(), DataBoxCustomerDiskCopyProgressResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxCustomerDiskJobDetailsInput)(nil)).Elem(), DataBoxCustomerDiskJobDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxCustomerDiskJobDetailsResponseInput)(nil)).Elem(), DataBoxCustomerDiskJobDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxDiskCopyLogDetailsResponseInput)(nil)).Elem(), DataBoxDiskCopyLogDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxDiskCopyProgressResponseInput)(nil)).Elem(), DataBoxDiskCopyProgressResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxDiskCopyProgressResponseArrayInput)(nil)).Elem(), DataBoxDiskCopyProgressResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxDiskJobDetailsInput)(nil)).Elem(), DataBoxDiskJobDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxDiskJobDetailsResponseInput)(nil)).Elem(), DataBoxDiskJobDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxDiskJobSecretsResponseInput)(nil)).Elem(), DataBoxDiskJobSecretsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxHeavyAccountCopyLogDetailsResponseInput)(nil)).Elem(), DataBoxHeavyAccountCopyLogDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxHeavyJobDetailsInput)(nil)).Elem(), DataBoxHeavyJobDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxHeavyJobDetailsResponseInput)(nil)).Elem(), DataBoxHeavyJobDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxHeavyJobSecretsResponseInput)(nil)).Elem(), DataBoxHeavyJobSecretsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxHeavySecretResponseInput)(nil)).Elem(), DataBoxHeavySecretResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxHeavySecretResponseArrayInput)(nil)).Elem(), DataBoxHeavySecretResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxJobDetailsInput)(nil)).Elem(), DataBoxJobDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxJobDetailsResponseInput)(nil)).Elem(), DataBoxJobDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxSecretResponseInput)(nil)).Elem(), DataBoxSecretResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxSecretResponseArrayInput)(nil)).Elem(), DataBoxSecretResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataExportDetailsInput)(nil)).Elem(), DataExportDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataExportDetailsArrayInput)(nil)).Elem(), DataExportDetailsArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataExportDetailsResponseInput)(nil)).Elem(), DataExportDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataExportDetailsResponseArrayInput)(nil)).Elem(), DataExportDetailsResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataImportDetailsInput)(nil)).Elem(), DataImportDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataImportDetailsArrayInput)(nil)).Elem(), DataImportDetailsArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataImportDetailsResponseInput)(nil)).Elem(), DataImportDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataImportDetailsResponseArrayInput)(nil)).Elem(), DataImportDetailsResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataboxJobSecretsResponseInput)(nil)).Elem(), DataboxJobSecretsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatacenterAddressInstructionResponseResponseInput)(nil)).Elem(), DatacenterAddressInstructionResponseResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatacenterAddressLocationResponseResponseInput)(nil)).Elem(), DatacenterAddressLocationResponseResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DcAccessSecurityCodeResponseInput)(nil)).Elem(), DcAccessSecurityCodeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiskSecretResponseInput)(nil)).Elem(), DiskSecretResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiskSecretResponseArrayInput)(nil)).Elem(), DiskSecretResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDiskDetailsResponseInput)(nil)).Elem(), ExportDiskDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExportDiskDetailsResponseMapInput)(nil)).Elem(), ExportDiskDetailsResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*FilterFileDetailsInput)(nil)).Elem(), FilterFileDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FilterFileDetailsArrayInput)(nil)).Elem(), FilterFileDetailsArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FilterFileDetailsResponseInput)(nil)).Elem(), FilterFileDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FilterFileDetailsResponseArrayInput)(nil)).Elem(), FilterFileDetailsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ImportDiskDetailsInput)(nil)).Elem(), ImportDiskDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImportDiskDetailsMapInput)(nil)).Elem(), ImportDiskDetailsMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImportDiskDetailsResponseInput)(nil)).Elem(), ImportDiskDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImportDiskDetailsResponseMapInput)(nil)).Elem(), ImportDiskDetailsResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobDeliveryInfoInput)(nil)).Elem(), JobDeliveryInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobDeliveryInfoPtrInput)(nil)).Elem(), JobDeliveryInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobDeliveryInfoResponseInput)(nil)).Elem(), JobDeliveryInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobDeliveryInfoResponsePtrInput)(nil)).Elem(), JobDeliveryInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobStagesResponseInput)(nil)).Elem(), JobStagesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JobStagesResponseArrayInput)(nil)).Elem(), JobStagesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyEncryptionKeyInput)(nil)).Elem(), KeyEncryptionKeyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyEncryptionKeyPtrInput)(nil)).Elem(), KeyEncryptionKeyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyEncryptionKeyResponseInput)(nil)).Elem(), KeyEncryptionKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyEncryptionKeyResponsePtrInput)(nil)).Elem(), KeyEncryptionKeyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LastMitigationActionOnJobResponseInput)(nil)).Elem(), LastMitigationActionOnJobResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedDiskDetailsInput)(nil)).Elem(), ManagedDiskDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedDiskDetailsResponseInput)(nil)).Elem(), ManagedDiskDetailsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PackageCarrierDetailsInput)(nil)).Elem(), PackageCarrierDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PackageCarrierDetailsResponseInput)(nil)).Elem(), PackageCarrierDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PackageCarrierInfoResponseInput)(nil)).Elem(), PackageCarrierInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PackageShippingDetailsResponseInput)(nil)).Elem(), PackageShippingDetailsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ShareCredentialDetailsResponseInput)(nil)).Elem(), ShareCredentialDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ShareCredentialDetailsResponseArrayInput)(nil)).Elem(), ShareCredentialDetailsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountDetailsInput)(nil)).Elem(), StorageAccountDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountDetailsResponseInput)(nil)).Elem(), StorageAccountDetailsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TransferAllDetailsInput)(nil)).Elem(), TransferAllDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferAllDetailsPtrInput)(nil)).Elem(), TransferAllDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferAllDetailsResponseInput)(nil)).Elem(), TransferAllDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferAllDetailsResponsePtrInput)(nil)).Elem(), TransferAllDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferConfigurationInput)(nil)).Elem(), TransferConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferConfigurationResponseInput)(nil)).Elem(), TransferConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferConfigurationResponseTransferAllDetailsInput)(nil)).Elem(), TransferConfigurationResponseTransferAllDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferConfigurationResponseTransferAllDetailsPtrInput)(nil)).Elem(), TransferConfigurationResponseTransferAllDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferConfigurationResponseTransferFilterDetailsInput)(nil)).Elem(), TransferConfigurationResponseTransferFilterDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferConfigurationResponseTransferFilterDetailsPtrInput)(nil)).Elem(), TransferConfigurationResponseTransferFilterDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferConfigurationTransferAllDetailsInput)(nil)).Elem(), TransferConfigurationTransferAllDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferConfigurationTransferAllDetailsPtrInput)(nil)).Elem(), TransferConfigurationTransferAllDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferConfigurationTransferFilterDetailsInput)(nil)).Elem(), TransferConfigurationTransferFilterDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferConfigurationTransferFilterDetailsPtrInput)(nil)).Elem(), TransferConfigurationTransferFilterDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferFilterDetailsInput)(nil)).Elem(), TransferFilterDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferFilterDetailsPtrInput)(nil)).Elem(), TransferFilterDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferFilterDetailsResponseInput)(nil)).Elem(), TransferFilterDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TransferFilterDetailsResponsePtrInput)(nil)).Elem(), TransferFilterDetailsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UnencryptedCredentialsResponseInput)(nil)).Elem(), UnencryptedCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UnencryptedCredentialsResponseArrayInput)(nil)).Elem(), UnencryptedCredentialsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UserAssignedPropertiesInput)(nil)).Elem(), UserAssignedPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserAssignedPropertiesPtrInput)(nil)).Elem(), UserAssignedPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserAssignedPropertiesResponseInput)(nil)).Elem(), UserAssignedPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserAssignedPropertiesResponsePtrInput)(nil)).Elem(), UserAssignedPropertiesResponseArgs{})
