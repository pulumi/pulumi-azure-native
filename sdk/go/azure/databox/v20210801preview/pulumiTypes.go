...
// CustomerDiskJobSecretsResponseInput is an input type that accepts CustomerDiskJobSecretsResponseArgs and CustomerDiskJobSecretsResponseOutput values.
// You can construct a concrete instance of `CustomerDiskJobSecretsResponseInput` via:
//
//          CustomerDiskJobSecretsResponseArgs{...}
...
// DataBoxCustomerDiskCopyLogDetailsResponseInput is an input type that accepts DataBoxCustomerDiskCopyLogDetailsResponseArgs and DataBoxCustomerDiskCopyLogDetailsResponseOutput values.
// You can construct a concrete instance of `DataBoxCustomerDiskCopyLogDetailsResponseInput` via:
//
...
// DataBoxCustomerDiskCopyProgressResponseInput is an input type that accepts DataBoxCustomerDiskCopyProgressResponseArgs and DataBoxCustomerDiskCopyProgressResponseOutput values.
// You can construct a concrete instance of `DataBoxCustomerDiskCopyProgressResponseInput` via:
//
...
// DataBoxCustomerDiskCopyProgressResponseArrayInput is an input type that accepts DataBoxCustomerDiskCopyProgressResponseArray and DataBoxCustomerDiskCopyProgressResponseArrayOutput values.
// You can construct a concrete instance of `DataBoxCustomerDiskCopyProgressResponseArrayInput` via:
//
//          DataBoxCustomerDiskCopyProgressResponseArray{ DataBoxCustomerDiskCopyProgressResponseArgs{...} }
...
// DataBoxCustomerDiskJobDetailsResponseInput is an input type that accepts DataBoxCustomerDiskJobDetailsResponseArgs and DataBoxCustomerDiskJobDetailsResponseOutput values.
// You can construct a concrete instance of `DataBoxCustomerDiskJobDetailsResponseInput` via:
//
...
// DatacenterAddressInstructionResponseResponseInput is an input type that accepts DatacenterAddressInstructionResponseResponseArgs and DatacenterAddressInstructionResponseResponseOutput values.
// You can construct a concrete instance of `DatacenterAddressInstructionResponseResponseInput` via:
//
...
// DatacenterAddressLocationResponseResponseInput is an input type that accepts DatacenterAddressLocationResponseResponseArgs and DatacenterAddressLocationResponseResponseOutput values.
// You can construct a concrete instance of `DatacenterAddressLocationResponseResponseInput` via:
//
...
// ExportDiskDetailsResponseInput is an input type that accepts ExportDiskDetailsResponseArgs and ExportDiskDetailsResponseOutput values.
// You can construct a concrete instance of `ExportDiskDetailsResponseInput` via:
//
...
// ExportDiskDetailsResponseMapInput is an input type that accepts ExportDiskDetailsResponseMap and ExportDiskDetailsResponseMapOutput values.
// You can construct a concrete instance of `ExportDiskDetailsResponseMapInput` via:
//
//          ExportDiskDetailsResponseMap{ "key": ExportDiskDetailsResponseArgs{...} }
...
// ImportDiskDetailsResponseInput is an input type that accepts ImportDiskDetailsResponseArgs and ImportDiskDetailsResponseOutput values.
// You can construct a concrete instance of `ImportDiskDetailsResponseInput` via:
//
...
// ImportDiskDetailsResponseMapInput is an input type that accepts ImportDiskDetailsResponseMap and ImportDiskDetailsResponseMapOutput values.
// You can construct a concrete instance of `ImportDiskDetailsResponseMapInput` via:
//
//          ImportDiskDetailsResponseMap{ "key": ImportDiskDetailsResponseArgs{...} }
...
// PackageCarrierDetailsResponseInput is an input type that accepts PackageCarrierDetailsResponseArgs and PackageCarrierDetailsResponseOutput values.
// You can construct a concrete instance of `PackageCarrierDetailsResponseInput` via:
//
...
// PackageCarrierInfoResponseInput is an input type that accepts PackageCarrierInfoResponseArgs and PackageCarrierInfoResponseOutput values.
// You can construct a concrete instance of `PackageCarrierInfoResponseInput` via:
//
