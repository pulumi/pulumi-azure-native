...
func NewExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:agfoodplatform/v20210901preview:Extension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExtension(ctx *pulumi.Context,
	...
	var resource Extension
	err := ctx.ReadResource("azure-native:agfoodplatform/v20210901preview:Extension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
