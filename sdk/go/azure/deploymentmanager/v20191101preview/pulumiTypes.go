...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ApiKeyAuthenticationInput)(nil)).Elem(), ApiKeyAuthenticationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiKeyAuthenticationResponseInput)(nil)).Elem(), ApiKeyAuthenticationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HealthCheckStepPropertiesInput)(nil)).Elem(), HealthCheckStepPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HealthCheckStepPropertiesResponseInput)(nil)).Elem(), HealthCheckStepPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RestHealthCheckInput)(nil)).Elem(), RestHealthCheckArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestHealthCheckArrayInput)(nil)).Elem(), RestHealthCheckArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestHealthCheckResponseInput)(nil)).Elem(), RestHealthCheckResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestHealthCheckResponseArrayInput)(nil)).Elem(), RestHealthCheckResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestHealthCheckStepAttributesInput)(nil)).Elem(), RestHealthCheckStepAttributesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestHealthCheckStepAttributesResponseInput)(nil)).Elem(), RestHealthCheckStepAttributesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestRequestInput)(nil)).Elem(), RestRequestArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestRequestResponseInput)(nil)).Elem(), RestRequestResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestResponseInput)(nil)).Elem(), RestResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestResponsePtrInput)(nil)).Elem(), RestResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestResponseRegexInput)(nil)).Elem(), RestResponseRegexArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestResponseRegexPtrInput)(nil)).Elem(), RestResponseRegexArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestResponseResponseInput)(nil)).Elem(), RestResponseResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestResponseResponsePtrInput)(nil)).Elem(), RestResponseResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestResponseResponseRegexInput)(nil)).Elem(), RestResponseResponseRegexArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestResponseResponseRegexPtrInput)(nil)).Elem(), RestResponseResponseRegexArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RolloutIdentityAuthenticationInput)(nil)).Elem(), RolloutIdentityAuthenticationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RolloutIdentityAuthenticationResponseInput)(nil)).Elem(), RolloutIdentityAuthenticationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StepGroupInput)(nil)).Elem(), StepGroupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StepGroupArrayInput)(nil)).Elem(), StepGroupArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*StepGroupResponseInput)(nil)).Elem(), StepGroupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StepGroupResponseArrayInput)(nil)).Elem(), StepGroupResponseArray{})
