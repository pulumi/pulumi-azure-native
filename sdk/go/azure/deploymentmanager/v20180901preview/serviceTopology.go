...
func NewServiceTopology(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:deploymentmanager/v20180901preview:ServiceTopology", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceTopology(ctx *pulumi.Context,
	...
	var resource ServiceTopology
	err := ctx.ReadResource("azure-native:deploymentmanager/v20180901preview:ServiceTopology", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
