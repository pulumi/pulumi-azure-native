...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationResponseArrayInput)(nil)).Elem(), NotificationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationTargetInput)(nil)).Elem(), NotificationTargetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationTargetArrayInput)(nil)).Elem(), NotificationTargetArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationTargetResponseInput)(nil)).Elem(), NotificationTargetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationTargetResponseArrayInput)(nil)).Elem(), NotificationTargetResponseArray{})
