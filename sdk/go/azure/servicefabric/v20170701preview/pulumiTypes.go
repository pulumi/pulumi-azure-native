...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterVersionDetailsInput)(nil)).Elem(), ClusterVersionDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterVersionDetailsArrayInput)(nil)).Elem(), ClusterVersionDetailsArray{})
