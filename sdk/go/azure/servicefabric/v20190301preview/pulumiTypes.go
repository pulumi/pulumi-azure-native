...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationDeltaHealthPolicyInput)(nil)).Elem(), ApplicationDeltaHealthPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationDeltaHealthPolicyMapInput)(nil)).Elem(), ApplicationDeltaHealthPolicyMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationDeltaHealthPolicyResponseInput)(nil)).Elem(), ApplicationDeltaHealthPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationDeltaHealthPolicyResponseMapInput)(nil)).Elem(), ApplicationDeltaHealthPolicyResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationHealthPolicyInput)(nil)).Elem(), ApplicationHealthPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationHealthPolicyMapInput)(nil)).Elem(), ApplicationHealthPolicyMap{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationHealthPolicyResponseMapInput)(nil)).Elem(), ApplicationHealthPolicyResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationMetricDescriptionInput)(nil)).Elem(), ApplicationMetricDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationMetricDescriptionArrayInput)(nil)).Elem(), ApplicationMetricDescriptionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationMetricDescriptionResponseInput)(nil)).Elem(), ApplicationMetricDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationMetricDescriptionResponseArrayInput)(nil)).Elem(), ApplicationMetricDescriptionResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ArmApplicationHealthPolicyInput)(nil)).Elem(), ArmApplicationHealthPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmApplicationHealthPolicyPtrInput)(nil)).Elem(), ArmApplicationHealthPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmApplicationHealthPolicyResponseInput)(nil)).Elem(), ArmApplicationHealthPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmApplicationHealthPolicyResponsePtrInput)(nil)).Elem(), ArmApplicationHealthPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmRollingUpgradeMonitoringPolicyInput)(nil)).Elem(), ArmRollingUpgradeMonitoringPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmRollingUpgradeMonitoringPolicyPtrInput)(nil)).Elem(), ArmRollingUpgradeMonitoringPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmRollingUpgradeMonitoringPolicyResponseInput)(nil)).Elem(), ArmRollingUpgradeMonitoringPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmRollingUpgradeMonitoringPolicyResponsePtrInput)(nil)).Elem(), ArmRollingUpgradeMonitoringPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmServiceTypeHealthPolicyInput)(nil)).Elem(), ArmServiceTypeHealthPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmServiceTypeHealthPolicyPtrInput)(nil)).Elem(), ArmServiceTypeHealthPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmServiceTypeHealthPolicyMapInput)(nil)).Elem(), ArmServiceTypeHealthPolicyMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmServiceTypeHealthPolicyResponseInput)(nil)).Elem(), ArmServiceTypeHealthPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmServiceTypeHealthPolicyResponsePtrInput)(nil)).Elem(), ArmServiceTypeHealthPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmServiceTypeHealthPolicyResponseMapInput)(nil)).Elem(), ArmServiceTypeHealthPolicyResponseMap{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NamedPartitionSchemeDescriptionInput)(nil)).Elem(), NamedPartitionSchemeDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NamedPartitionSchemeDescriptionResponseInput)(nil)).Elem(), NamedPartitionSchemeDescriptionResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServerCertificateCommonNameInput)(nil)).Elem(), ServerCertificateCommonNameArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerCertificateCommonNameArrayInput)(nil)).Elem(), ServerCertificateCommonNameArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerCertificateCommonNameResponseInput)(nil)).Elem(), ServerCertificateCommonNameResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerCertificateCommonNameResponseArrayInput)(nil)).Elem(), ServerCertificateCommonNameResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerCertificateCommonNamesInput)(nil)).Elem(), ServerCertificateCommonNamesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerCertificateCommonNamesPtrInput)(nil)).Elem(), ServerCertificateCommonNamesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerCertificateCommonNamesResponseInput)(nil)).Elem(), ServerCertificateCommonNamesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerCertificateCommonNamesResponsePtrInput)(nil)).Elem(), ServerCertificateCommonNamesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCorrelationDescriptionInput)(nil)).Elem(), ServiceCorrelationDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCorrelationDescriptionArrayInput)(nil)).Elem(), ServiceCorrelationDescriptionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCorrelationDescriptionResponseInput)(nil)).Elem(), ServiceCorrelationDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCorrelationDescriptionResponseArrayInput)(nil)).Elem(), ServiceCorrelationDescriptionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceLoadMetricDescriptionInput)(nil)).Elem(), ServiceLoadMetricDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceLoadMetricDescriptionArrayInput)(nil)).Elem(), ServiceLoadMetricDescriptionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceLoadMetricDescriptionResponseInput)(nil)).Elem(), ServiceLoadMetricDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceLoadMetricDescriptionResponseArrayInput)(nil)).Elem(), ServiceLoadMetricDescriptionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicePlacementPolicyDescriptionInput)(nil)).Elem(), ServicePlacementPolicyDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicePlacementPolicyDescriptionArrayInput)(nil)).Elem(), ServicePlacementPolicyDescriptionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicePlacementPolicyDescriptionResponseInput)(nil)).Elem(), ServicePlacementPolicyDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServicePlacementPolicyDescriptionResponseArrayInput)(nil)).Elem(), ServicePlacementPolicyDescriptionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceTypeDeltaHealthPolicyInput)(nil)).Elem(), ServiceTypeDeltaHealthPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceTypeDeltaHealthPolicyPtrInput)(nil)).Elem(), ServiceTypeDeltaHealthPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceTypeDeltaHealthPolicyMapInput)(nil)).Elem(), ServiceTypeDeltaHealthPolicyMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceTypeDeltaHealthPolicyResponseInput)(nil)).Elem(), ServiceTypeDeltaHealthPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceTypeDeltaHealthPolicyResponsePtrInput)(nil)).Elem(), ServiceTypeDeltaHealthPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceTypeDeltaHealthPolicyResponseMapInput)(nil)).Elem(), ServiceTypeDeltaHealthPolicyResponseMap{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SingletonPartitionSchemeDescriptionInput)(nil)).Elem(), SingletonPartitionSchemeDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SingletonPartitionSchemeDescriptionResponseInput)(nil)).Elem(), SingletonPartitionSchemeDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UniformInt64RangePartitionSchemeDescriptionInput)(nil)).Elem(), UniformInt64RangePartitionSchemeDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UniformInt64RangePartitionSchemeDescriptionResponseInput)(nil)).Elem(), UniformInt64RangePartitionSchemeDescriptionResponseArgs{})
