...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*FrontendConfigurationInput)(nil)).Elem(), FrontendConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontendConfigurationArrayInput)(nil)).Elem(), FrontendConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontendConfigurationResponseInput)(nil)).Elem(), FrontendConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FrontendConfigurationResponseArrayInput)(nil)).Elem(), FrontendConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IPTagInput)(nil)).Elem(), IPTagArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IPTagArrayInput)(nil)).Elem(), IPTagArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IPTagResponseInput)(nil)).Elem(), IPTagResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IPTagResponseArrayInput)(nil)).Elem(), IPTagResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NodeTypeSkuInput)(nil)).Elem(), NodeTypeSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NodeTypeSkuPtrInput)(nil)).Elem(), NodeTypeSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NodeTypeSkuResponseInput)(nil)).Elem(), NodeTypeSkuResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NodeTypeSkuResponsePtrInput)(nil)).Elem(), NodeTypeSkuResponseArgs{})
