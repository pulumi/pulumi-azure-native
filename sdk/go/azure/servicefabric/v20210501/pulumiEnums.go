...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterUpgradeModeInput)(nil)).Elem(), ClusterUpgradeMode("Automatic"))
	pulumi.RegisterInputType(reflect.TypeOf((*ClusterUpgradeModePtrInput)(nil)).Elem(), ClusterUpgradeMode("Automatic"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DiskTypeInput)(nil)).Elem(), DiskType("Standard_LRS"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiskTypePtrInput)(nil)).Elem(), DiskType("Standard_LRS"))
	pulumi.RegisterInputType(reflect.TypeOf((*FailureActionInput)(nil)).Elem(), FailureAction("Rollback"))
	pulumi.RegisterInputType(reflect.TypeOf((*FailureActionPtrInput)(nil)).Elem(), FailureAction("Rollback"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NsgProtocolInput)(nil)).Elem(), NsgProtocol("http"))
	pulumi.RegisterInputType(reflect.TypeOf((*NsgProtocolPtrInput)(nil)).Elem(), NsgProtocol("http"))
	pulumi.RegisterInputType(reflect.TypeOf((*PartitionSchemeInput)(nil)).Elem(), PartitionScheme("Singleton"))
	pulumi.RegisterInputType(reflect.TypeOf((*PartitionSchemePtrInput)(nil)).Elem(), PartitionScheme("Singleton"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RollingUpgradeModeInput)(nil)).Elem(), RollingUpgradeMode("Monitored"))
	pulumi.RegisterInputType(reflect.TypeOf((*RollingUpgradeModePtrInput)(nil)).Elem(), RollingUpgradeMode("Monitored"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCorrelationSchemeInput)(nil)).Elem(), ServiceCorrelationScheme("AlignedAffinity"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceCorrelationSchemePtrInput)(nil)).Elem(), ServiceCorrelationScheme("AlignedAffinity"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceKindInput)(nil)).Elem(), ServiceKind("Stateless"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceKindPtrInput)(nil)).Elem(), ServiceKind("Stateless"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServicePackageActivationModeInput)(nil)).Elem(), ServicePackageActivationMode("SharedProcess"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServicePackageActivationModePtrInput)(nil)).Elem(), ServicePackageActivationMode("SharedProcess"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServicePlacementPolicyTypeInput)(nil)).Elem(), ServicePlacementPolicyType("InvalidDomain"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServicePlacementPolicyTypePtrInput)(nil)).Elem(), ServicePlacementPolicyType("InvalidDomain"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceScalingMechanismKindInput)(nil)).Elem(), ServiceScalingMechanismKind("ScalePartitionInstanceCount"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceScalingMechanismKindPtrInput)(nil)).Elem(), ServiceScalingMechanismKind("ScalePartitionInstanceCount"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceScalingTriggerKindInput)(nil)).Elem(), ServiceScalingTriggerKind("AveragePartitionLoad"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceScalingTriggerKindPtrInput)(nil)).Elem(), ServiceScalingTriggerKind("AveragePartitionLoad"))
