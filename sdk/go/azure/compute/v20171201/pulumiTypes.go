...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ApiErrorBaseResponseInput)(nil)).Elem(), ApiErrorBaseResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiErrorBaseResponseArrayInput)(nil)).Elem(), ApiErrorBaseResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApiErrorResponseInput)(nil)).Elem(), ApiErrorResponseArgs{})
