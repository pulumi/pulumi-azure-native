...
func NewVirtualMachineExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:compute/v20180401:VirtualMachineExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineExtension(ctx *pulumi.Context,
	...
	var resource VirtualMachineExtension
	err := ctx.ReadResource("azure-nextgen:compute/v20180401:VirtualMachineExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
