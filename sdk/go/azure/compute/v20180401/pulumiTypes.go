...
func (o AutoOSUpgradePolicyResponseOutput) ToAutoOSUpgradePolicyResponsePtrOutputWithContext(ctx context.Context) AutoOSUpgradePolicyResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v AutoOSUpgradePolicyResponse) *AutoOSUpgradePolicyResponse {
		return &v
...
func (o EncryptionSettingsResponseOutput) ToEncryptionSettingsResponsePtrOutputWithContext(ctx context.Context) EncryptionSettingsResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v EncryptionSettingsResponse) *EncryptionSettingsResponse {
		return &v
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AutoOSUpgradePolicyInput)(nil)).Elem(), AutoOSUpgradePolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoOSUpgradePolicyPtrInput)(nil)).Elem(), AutoOSUpgradePolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoOSUpgradePolicyResponseInput)(nil)).Elem(), AutoOSUpgradePolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoOSUpgradePolicyResponsePtrInput)(nil)).Elem(), AutoOSUpgradePolicyResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionSettingsInput)(nil)).Elem(), EncryptionSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionSettingsPtrInput)(nil)).Elem(), EncryptionSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionSettingsResponseInput)(nil)).Elem(), EncryptionSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionSettingsResponsePtrInput)(nil)).Elem(), EncryptionSettingsResponseArgs{})
