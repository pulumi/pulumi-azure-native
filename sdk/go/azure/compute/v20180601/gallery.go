...
func NewGallery(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:compute/v20180601:Gallery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGallery(ctx *pulumi.Context,
	...
	var resource Gallery
	err := ctx.ReadResource("azure-nextgen:compute/v20180601:Gallery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
