...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:compute:GalleryApplicationVersion'.
...
func NewGalleryApplicationVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/latest:GalleryApplicationVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryApplicationVersion(ctx *pulumi.Context,
	...
	var resource GalleryApplicationVersion
	err := ctx.ReadResource("azure-native:compute/latest:GalleryApplicationVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
