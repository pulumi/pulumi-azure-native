...
func NewGuestConfigurationAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:compute/latest:GuestConfigurationAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestConfigurationAssignment(ctx *pulumi.Context,
	...
	var resource GuestConfigurationAssignment
	err := ctx.ReadResource("azure-nextgen:compute/latest:GuestConfigurationAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
