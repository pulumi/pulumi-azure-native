...
type LookupVirtualMachineScaleSetVMResult struct {
	...
	InstanceView VirtualMachineScaleSetVMInstanceViewInvokeResponse `pulumi:"instanceView"`
	...
	NetworkProfileConfiguration *VirtualMachineScaleSetVMNetworkProfileConfigurationInvokeResponse `pulumi:"networkProfileConfiguration"`
	...
	ProtectionPolicy *VirtualMachineScaleSetVMProtectionPolicyInvokeResponse `pulumi:"protectionPolicy"`
