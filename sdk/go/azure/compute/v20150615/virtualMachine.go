...
func NewVirtualMachine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20150615:VirtualMachine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachine(ctx *pulumi.Context,
	...
	var resource VirtualMachine
	err := ctx.ReadResource("azure-native:compute/v20150615:VirtualMachine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
