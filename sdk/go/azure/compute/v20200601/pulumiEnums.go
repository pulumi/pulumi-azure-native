...
// InGuestPatchModeInput is an input type that accepts InGuestPatchModeArgs and InGuestPatchModeOutput values.
// You can construct a concrete instance of `InGuestPatchModeInput` via:
//
//          InGuestPatchModeArgs{...}
