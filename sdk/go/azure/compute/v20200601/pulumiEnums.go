...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*InGuestPatchModeInput)(nil)).Elem(), InGuestPatchMode("Manual"))
	pulumi.RegisterInputType(reflect.TypeOf((*InGuestPatchModePtrInput)(nil)).Elem(), InGuestPatchMode("Manual"))
