...
func NewVirtualMachineScaleSetVMExtension(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:compute/v20210401:VirtualMachineScaleSetVMExtension"),
		},
		{
			Type: pulumi.String("azure-native:compute:VirtualMachineScaleSetVMExtension"),
		},
		{
			Type: pulumi.String("azure-nextgen:compute:VirtualMachineScaleSetVMExtension"),
		},
		{
		...
		{
			Type: pulumi.String("azure-nextgen:compute/v20210701:VirtualMachineScaleSetVMExtension"),
		},
	})
	opts = append(opts, aliases)
	var resource VirtualMachineScaleSetVMExtension
	err := ctx.RegisterResource("azure-native:compute/v20210401:VirtualMachineScaleSetVMExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetVMExtension(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetVMExtension
	err := ctx.ReadResource("azure-native:compute/v20210401:VirtualMachineScaleSetVMExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
