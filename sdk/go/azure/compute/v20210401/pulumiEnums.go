...
// DiskSecurityTypesInput is an input type that accepts DiskSecurityTypesArgs and DiskSecurityTypesOutput values.
// You can construct a concrete instance of `DiskSecurityTypesInput` via:
//
