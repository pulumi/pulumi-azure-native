...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DedicatedHostLicenseTypesInput)(nil)).Elem(), DedicatedHostLicenseTypes("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*DedicatedHostLicenseTypesPtrInput)(nil)).Elem(), DedicatedHostLicenseTypes("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*DeleteOptionsInput)(nil)).Elem(), DeleteOptions("Delete"))
	pulumi.RegisterInputType(reflect.TypeOf((*DeleteOptionsPtrInput)(nil)).Elem(), DeleteOptions("Delete"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiffDiskOptionsInput)(nil)).Elem(), DiffDiskOptions("Local"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiffDiskOptionsPtrInput)(nil)).Elem(), DiffDiskOptions("Local"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiffDiskPlacementInput)(nil)).Elem(), DiffDiskPlacement("CacheDisk"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiffDiskPlacementPtrInput)(nil)).Elem(), DiffDiskPlacement("CacheDisk"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DiskDeleteOptionTypesInput)(nil)).Elem(), DiskDeleteOptionTypes("Delete"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiskDeleteOptionTypesPtrInput)(nil)).Elem(), DiskDeleteOptionTypes("Delete"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiskDetachOptionTypesInput)(nil)).Elem(), DiskDetachOptionTypes("ForceDetach"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiskDetachOptionTypesPtrInput)(nil)).Elem(), DiskDetachOptionTypes("ForceDetach"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DiskSecurityTypesInput)(nil)).Elem(), DiskSecurityTypes("TrustedLaunch"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiskSecurityTypesPtrInput)(nil)).Elem(), DiskSecurityTypes("TrustedLaunch"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HyperVGenerationTypesInput)(nil)).Elem(), HyperVGenerationTypes("V1"))
	pulumi.RegisterInputType(reflect.TypeOf((*HyperVGenerationTypesPtrInput)(nil)).Elem(), HyperVGenerationTypes("V1"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IPVersionsInput)(nil)).Elem(), IPVersions("IPv4"))
	pulumi.RegisterInputType(reflect.TypeOf((*IPVersionsPtrInput)(nil)).Elem(), IPVersions("IPv4"))
	pulumi.RegisterInputType(reflect.TypeOf((*IntervalInMinsInput)(nil)).Elem(), IntervalInMins("ThreeMins"))
	pulumi.RegisterInputType(reflect.TypeOf((*IntervalInMinsPtrInput)(nil)).Elem(), IntervalInMins("ThreeMins"))
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxPatchAssessmentModeInput)(nil)).Elem(), LinuxPatchAssessmentMode("ImageDefault"))
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxPatchAssessmentModePtrInput)(nil)).Elem(), LinuxPatchAssessmentMode("ImageDefault"))
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxVMGuestPatchModeInput)(nil)).Elem(), LinuxVMGuestPatchMode("ImageDefault"))
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxVMGuestPatchModePtrInput)(nil)).Elem(), LinuxVMGuestPatchMode("ImageDefault"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkApiVersionInput)(nil)).Elem(), NetworkApiVersion("2020-11-01"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkApiVersionPtrInput)(nil)).Elem(), NetworkApiVersion("2020-11-01"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OrchestrationModeInput)(nil)).Elem(), OrchestrationMode("Uniform"))
	pulumi.RegisterInputType(reflect.TypeOf((*OrchestrationModePtrInput)(nil)).Elem(), OrchestrationMode("Uniform"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ProximityPlacementGroupTypeInput)(nil)).Elem(), ProximityPlacementGroupType("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProximityPlacementGroupTypePtrInput)(nil)).Elem(), ProximityPlacementGroupType("Standard"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PublicIPAllocationMethodInput)(nil)).Elem(), PublicIPAllocationMethod("Dynamic"))
	pulumi.RegisterInputType(reflect.TypeOf((*PublicIPAllocationMethodPtrInput)(nil)).Elem(), PublicIPAllocationMethod("Dynamic"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityTypesInput)(nil)).Elem(), SecurityTypes("TrustedLaunch"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecurityTypesPtrInput)(nil)).Elem(), SecurityTypes("TrustedLaunch"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineEvictionPolicyTypesInput)(nil)).Elem(), VirtualMachineEvictionPolicyTypes("Deallocate"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineEvictionPolicyTypesPtrInput)(nil)).Elem(), VirtualMachineEvictionPolicyTypes("Deallocate"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachinePriorityTypesInput)(nil)).Elem(), VirtualMachinePriorityTypes("Regular"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachinePriorityTypesPtrInput)(nil)).Elem(), VirtualMachinePriorityTypes("Regular"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineScaleSetScaleInRulesInput)(nil)).Elem(), VirtualMachineScaleSetScaleInRules("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineScaleSetScaleInRulesPtrInput)(nil)).Elem(), VirtualMachineScaleSetScaleInRules("Default"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsPatchAssessmentModeInput)(nil)).Elem(), WindowsPatchAssessmentMode("ImageDefault"))
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsPatchAssessmentModePtrInput)(nil)).Elem(), WindowsPatchAssessmentMode("ImageDefault"))
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsVMGuestPatchModeInput)(nil)).Elem(), WindowsVMGuestPatchMode("Manual"))
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsVMGuestPatchModePtrInput)(nil)).Elem(), WindowsVMGuestPatchMode("Manual"))
