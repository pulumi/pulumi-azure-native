...
func NewRestorePointCollection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:compute/v20210401:RestorePointCollection"),
		},
		{
			Type: pulumi.String("azure-native:compute:RestorePointCollection"),
		},
		{
			Type: pulumi.String("azure-nextgen:compute:RestorePointCollection"),
		},
		{
			Type: pulumi.String("azure-native:compute/v20210301:RestorePointCollection"),
		},
		{
			Type: pulumi.String("azure-nextgen:compute/v20210301:RestorePointCollection"),
		},
		{
			Type: pulumi.String("azure-native:compute/v20210701:RestorePointCollection"),
		},
		{
			Type: pulumi.String("azure-nextgen:compute/v20210701:RestorePointCollection"),
		},
	})
	opts = append(opts, aliases)
	var resource RestorePointCollection
	err := ctx.RegisterResource("azure-native:compute/v20210401:RestorePointCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRestorePointCollection(ctx *pulumi.Context,
	...
	var resource RestorePointCollection
	err := ctx.ReadResource("azure-native:compute/v20210401:RestorePointCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
