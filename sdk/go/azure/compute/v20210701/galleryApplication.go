...
func NewGalleryApplication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:compute/v20210701:GalleryApplication"),
		},
		{
			Type: pulumi.String("azure-native:compute:GalleryApplication"),
		},
		{
			Type: pulumi.String("azure-nextgen:compute:GalleryApplication"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:compute/v20210701:GalleryApplication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryApplication(ctx *pulumi.Context,
	...
	var resource GalleryApplication
	err := ctx.ReadResource("azure-native:compute/v20210701:GalleryApplication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
