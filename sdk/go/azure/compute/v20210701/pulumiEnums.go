...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicationModeInput)(nil)).Elem(), ReplicationMode("Full"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicationModePtrInput)(nil)).Elem(), ReplicationMode("Full"))
