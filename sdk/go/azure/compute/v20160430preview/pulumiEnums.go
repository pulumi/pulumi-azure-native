...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CachingTypesInput)(nil)).Elem(), CachingTypes("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*CachingTypesPtrInput)(nil)).Elem(), CachingTypes("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*ComponentNamesInput)(nil)).Elem(), ComponentNames("Microsoft-Windows-Shell-Setup"))
	pulumi.RegisterInputType(reflect.TypeOf((*ComponentNamesPtrInput)(nil)).Elem(), ComponentNames("Microsoft-Windows-Shell-Setup"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DiskCreateOptionTypesInput)(nil)).Elem(), DiskCreateOptionTypes("FromImage"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiskCreateOptionTypesPtrInput)(nil)).Elem(), DiskCreateOptionTypes("FromImage"))
	pulumi.RegisterInputType(reflect.TypeOf((*OperatingSystemStateTypesInput)(nil)).Elem(), OperatingSystemStateTypes("Generalized"))
	pulumi.RegisterInputType(reflect.TypeOf((*OperatingSystemStateTypesPtrInput)(nil)).Elem(), OperatingSystemStateTypes("Generalized"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PassNamesInput)(nil)).Elem(), PassNames("OobeSystem"))
	pulumi.RegisterInputType(reflect.TypeOf((*PassNamesPtrInput)(nil)).Elem(), PassNames("OobeSystem"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProtocolTypesInput)(nil)).Elem(), ProtocolTypes("Http"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProtocolTypesPtrInput)(nil)).Elem(), ProtocolTypes("Http"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SettingNamesInput)(nil)).Elem(), SettingNames("AutoLogon"))
	pulumi.RegisterInputType(reflect.TypeOf((*SettingNamesPtrInput)(nil)).Elem(), SettingNames("AutoLogon"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountTypesInput)(nil)).Elem(), StorageAccountTypes("Standard_LRS"))
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountTypesPtrInput)(nil)).Elem(), StorageAccountTypes("Standard_LRS"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineSizeTypesInput)(nil)).Elem(), VirtualMachineSizeTypes("Basic_A0"))
	pulumi.RegisterInputType(reflect.TypeOf((*VirtualMachineSizeTypesPtrInput)(nil)).Elem(), VirtualMachineSizeTypes("Basic_A0"))
