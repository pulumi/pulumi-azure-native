...
func NewGalleryImage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20220303:GalleryImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryImage(ctx *pulumi.Context,
	...
	var resource GalleryImage
	err := ctx.ReadResource("azure-native:compute/v20220303:GalleryImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
