...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceExtensionProfileInput)(nil)).Elem(), CloudServiceExtensionProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceExtensionProfilePtrInput)(nil)).Elem(), CloudServiceExtensionProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceExtensionProfileResponseInput)(nil)).Elem(), CloudServiceExtensionProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceExtensionProfileResponsePtrInput)(nil)).Elem(), CloudServiceExtensionProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceExtensionPropertiesInput)(nil)).Elem(), CloudServiceExtensionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceExtensionPropertiesPtrInput)(nil)).Elem(), CloudServiceExtensionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceExtensionPropertiesResponseInput)(nil)).Elem(), CloudServiceExtensionPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceExtensionPropertiesResponsePtrInput)(nil)).Elem(), CloudServiceExtensionPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceNetworkProfileInput)(nil)).Elem(), CloudServiceNetworkProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceNetworkProfilePtrInput)(nil)).Elem(), CloudServiceNetworkProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceNetworkProfileResponseInput)(nil)).Elem(), CloudServiceNetworkProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceNetworkProfileResponsePtrInput)(nil)).Elem(), CloudServiceNetworkProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceOsProfileInput)(nil)).Elem(), CloudServiceOsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceOsProfilePtrInput)(nil)).Elem(), CloudServiceOsProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceOsProfileResponseInput)(nil)).Elem(), CloudServiceOsProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceOsProfileResponsePtrInput)(nil)).Elem(), CloudServiceOsProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServicePropertiesInput)(nil)).Elem(), CloudServicePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServicePropertiesPtrInput)(nil)).Elem(), CloudServicePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServicePropertiesResponseInput)(nil)).Elem(), CloudServicePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServicePropertiesResponsePtrInput)(nil)).Elem(), CloudServicePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceRoleProfileInput)(nil)).Elem(), CloudServiceRoleProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceRoleProfilePtrInput)(nil)).Elem(), CloudServiceRoleProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceRoleProfilePropertiesInput)(nil)).Elem(), CloudServiceRoleProfilePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceRoleProfilePropertiesArrayInput)(nil)).Elem(), CloudServiceRoleProfilePropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceRoleProfilePropertiesResponseInput)(nil)).Elem(), CloudServiceRoleProfilePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceRoleProfilePropertiesResponseArrayInput)(nil)).Elem(), CloudServiceRoleProfilePropertiesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceRoleProfileResponseInput)(nil)).Elem(), CloudServiceRoleProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceRoleProfileResponsePtrInput)(nil)).Elem(), CloudServiceRoleProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceRoleSkuInput)(nil)).Elem(), CloudServiceRoleSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceRoleSkuPtrInput)(nil)).Elem(), CloudServiceRoleSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceRoleSkuResponseInput)(nil)).Elem(), CloudServiceRoleSkuResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceRoleSkuResponsePtrInput)(nil)).Elem(), CloudServiceRoleSkuResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceVaultAndSecretReferenceInput)(nil)).Elem(), CloudServiceVaultAndSecretReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceVaultAndSecretReferencePtrInput)(nil)).Elem(), CloudServiceVaultAndSecretReferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceVaultAndSecretReferenceResponseInput)(nil)).Elem(), CloudServiceVaultAndSecretReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceVaultAndSecretReferenceResponsePtrInput)(nil)).Elem(), CloudServiceVaultAndSecretReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceVaultCertificateInput)(nil)).Elem(), CloudServiceVaultCertificateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceVaultCertificateArrayInput)(nil)).Elem(), CloudServiceVaultCertificateArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceVaultCertificateResponseInput)(nil)).Elem(), CloudServiceVaultCertificateResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceVaultCertificateResponseArrayInput)(nil)).Elem(), CloudServiceVaultCertificateResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceVaultSecretGroupInput)(nil)).Elem(), CloudServiceVaultSecretGroupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceVaultSecretGroupArrayInput)(nil)).Elem(), CloudServiceVaultSecretGroupArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceVaultSecretGroupResponseInput)(nil)).Elem(), CloudServiceVaultSecretGroupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudServiceVaultSecretGroupResponseArrayInput)(nil)).Elem(), CloudServiceVaultSecretGroupResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExtensionInput)(nil)).Elem(), ExtensionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExtensionArrayInput)(nil)).Elem(), ExtensionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExtensionResponseInput)(nil)).Elem(), ExtensionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExtensionResponseArrayInput)(nil)).Elem(), ExtensionResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerConfigurationPropertiesInput)(nil)).Elem(), LoadBalancerConfigurationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerConfigurationPropertiesPtrInput)(nil)).Elem(), LoadBalancerConfigurationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerConfigurationPropertiesResponseInput)(nil)).Elem(), LoadBalancerConfigurationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerConfigurationPropertiesResponsePtrInput)(nil)).Elem(), LoadBalancerConfigurationPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerFrontendIPConfigurationPropertiesInput)(nil)).Elem(), LoadBalancerFrontendIPConfigurationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerFrontendIPConfigurationPropertiesPtrInput)(nil)).Elem(), LoadBalancerFrontendIPConfigurationPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerFrontendIPConfigurationPropertiesResponseInput)(nil)).Elem(), LoadBalancerFrontendIPConfigurationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerFrontendIPConfigurationPropertiesResponsePtrInput)(nil)).Elem(), LoadBalancerFrontendIPConfigurationPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerFrontendIPConfigurationResponseInput)(nil)).Elem(), LoadBalancerFrontendIPConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerFrontendIPConfigurationResponseArrayInput)(nil)).Elem(), LoadBalancerFrontendIPConfigurationResponseArray{})
