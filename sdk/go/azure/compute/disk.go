...
func NewDisk(ctx *pulumi.Context,
	...
	var resource Disk
	err := ctx.RegisterResource("azure-nextgen:compute:Disk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisk(ctx *pulumi.Context,
	...
	var resource Disk
	err := ctx.ReadResource("azure-nextgen:compute:Disk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
