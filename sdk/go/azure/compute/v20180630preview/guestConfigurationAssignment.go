...
func NewGuestConfigurationAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:compute/v20200625:GuestConfigurationAssignment"),
		},
	})
	opts = append(opts, aliases)
	var resource GuestConfigurationAssignment
	err := ctx.RegisterResource("azure-nextgen:compute/v20180630preview:GuestConfigurationAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestConfigurationAssignment(ctx *pulumi.Context,
	...
	var resource GuestConfigurationAssignment
	err := ctx.ReadResource("azure-nextgen:compute/v20180630preview:GuestConfigurationAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
