...
// NetworkAccessPolicyInput is an input type that accepts NetworkAccessPolicyArgs and NetworkAccessPolicyOutput values.
// You can construct a concrete instance of `NetworkAccessPolicyInput` via:
//
