...
func (o GalleryImageVersionOutput) PublishingProfile() GalleryImageVersionPublishingProfileResponseOutput {
	return o.ApplyT(func(v *GalleryImageVersion) GalleryImageVersionPublishingProfileResponseOutput {
