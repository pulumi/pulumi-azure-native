...
func LookupVirtualMachineScaleSet(ctx *pulumi.Context, args *LookupVirtualMachineScaleSetArgs, opts ...pulumi.InvokeOption) (*LookupVirtualMachineScaleSetResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:compute/v20190301:getVirtualMachineScaleSet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupVirtualMachineScaleSetResult struct {
	...
	AutomaticRepairsPolicy *AutomaticRepairsPolicyInvokeResponse `pulumi:"automaticRepairsPolicy"`
	...
	ScaleInPolicy *ScaleInPolicyInvokeResponse `pulumi:"scaleInPolicy"`
