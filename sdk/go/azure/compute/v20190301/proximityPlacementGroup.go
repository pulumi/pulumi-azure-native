...
func NewProximityPlacementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:compute/v20190301:ProximityPlacementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProximityPlacementGroup(ctx *pulumi.Context,
	...
	var resource ProximityPlacementGroup
	err := ctx.ReadResource("azure-nextgen:compute/v20190301:ProximityPlacementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
