...
func NewGalleryApplicationVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20200930:GalleryApplicationVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryApplicationVersion(ctx *pulumi.Context,
	...
	var resource GalleryApplicationVersion
	err := ctx.ReadResource("azure-native:compute/v20200930:GalleryApplicationVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
