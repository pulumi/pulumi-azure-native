...
func LookupDiskEncryptionSet(ctx *pulumi.Context, args *LookupDiskEncryptionSetArgs, opts ...pulumi.InvokeOption) (*LookupDiskEncryptionSetResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:compute/v20200930:getDiskEncryptionSet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDiskEncryptionSetResult struct {
	...
	ActiveKey *KeyForDiskEncryptionSetInvokeResponse `pulumi:"activeKey"`
	...
	PreviousKeys []KeyForDiskEncryptionSetInvokeResponse `pulumi:"previousKeys"`
