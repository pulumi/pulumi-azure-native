...
func NewGalleryImage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:compute/v20200930:GalleryImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryImage(ctx *pulumi.Context,
	...
	var resource GalleryImage
	err := ctx.ReadResource("azure-nextgen:compute/v20200930:GalleryImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
