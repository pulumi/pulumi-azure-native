...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DiskEncryptionSetTypeInput)(nil)).Elem(), DiskEncryptionSetType("EncryptionAtRestWithCustomerKey"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiskEncryptionSetTypePtrInput)(nil)).Elem(), DiskEncryptionSetType("EncryptionAtRestWithCustomerKey"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GallerySharingPermissionTypesInput)(nil)).Elem(), GallerySharingPermissionTypes("Private"))
	pulumi.RegisterInputType(reflect.TypeOf((*GallerySharingPermissionTypesPtrInput)(nil)).Elem(), GallerySharingPermissionTypes("Private"))
	pulumi.RegisterInputType(reflect.TypeOf((*HostCachingInput)(nil)).Elem(), HostCaching("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*HostCachingPtrInput)(nil)).Elem(), HostCaching("None"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkAccessPolicyInput)(nil)).Elem(), NetworkAccessPolicy("AllowAll"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkAccessPolicyPtrInput)(nil)).Elem(), NetworkAccessPolicy("AllowAll"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountTypeInput)(nil)).Elem(), StorageAccountType("Standard_LRS"))
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountTypePtrInput)(nil)).Elem(), StorageAccountType("Standard_LRS"))
