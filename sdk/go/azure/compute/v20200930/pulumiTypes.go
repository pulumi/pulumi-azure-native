...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DataDiskImageEncryptionInput)(nil)).Elem(), DataDiskImageEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDiskImageEncryptionArrayInput)(nil)).Elem(), DataDiskImageEncryptionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDiskImageEncryptionResponseInput)(nil)).Elem(), DataDiskImageEncryptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataDiskImageEncryptionResponseArrayInput)(nil)).Elem(), DataDiskImageEncryptionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DisallowedInput)(nil)).Elem(), DisallowedArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DisallowedPtrInput)(nil)).Elem(), DisallowedArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DisallowedResponseInput)(nil)).Elem(), DisallowedResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DisallowedResponsePtrInput)(nil)).Elem(), DisallowedResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionImagesInput)(nil)).Elem(), EncryptionImagesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionImagesPtrInput)(nil)).Elem(), EncryptionImagesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionImagesResponseInput)(nil)).Elem(), EncryptionImagesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionImagesResponsePtrInput)(nil)).Elem(), EncryptionImagesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryApplicationVersionPublishingProfileInput)(nil)).Elem(), GalleryApplicationVersionPublishingProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryApplicationVersionPublishingProfilePtrInput)(nil)).Elem(), GalleryApplicationVersionPublishingProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryApplicationVersionPublishingProfileResponseInput)(nil)).Elem(), GalleryApplicationVersionPublishingProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryApplicationVersionPublishingProfileResponsePtrInput)(nil)).Elem(), GalleryApplicationVersionPublishingProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryArtifactVersionSourceInput)(nil)).Elem(), GalleryArtifactVersionSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryArtifactVersionSourcePtrInput)(nil)).Elem(), GalleryArtifactVersionSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryArtifactVersionSourceResponseInput)(nil)).Elem(), GalleryArtifactVersionSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryArtifactVersionSourceResponsePtrInput)(nil)).Elem(), GalleryArtifactVersionSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryDataDiskImageInput)(nil)).Elem(), GalleryDataDiskImageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryDataDiskImageArrayInput)(nil)).Elem(), GalleryDataDiskImageArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryDataDiskImageResponseInput)(nil)).Elem(), GalleryDataDiskImageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryDataDiskImageResponseArrayInput)(nil)).Elem(), GalleryDataDiskImageResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryIdentifierResponseInput)(nil)).Elem(), GalleryIdentifierResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryIdentifierResponsePtrInput)(nil)).Elem(), GalleryIdentifierResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageFeatureInput)(nil)).Elem(), GalleryImageFeatureArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageFeatureArrayInput)(nil)).Elem(), GalleryImageFeatureArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageFeatureResponseInput)(nil)).Elem(), GalleryImageFeatureResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageFeatureResponseArrayInput)(nil)).Elem(), GalleryImageFeatureResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageIdentifierInput)(nil)).Elem(), GalleryImageIdentifierArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageIdentifierPtrInput)(nil)).Elem(), GalleryImageIdentifierArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageIdentifierResponseInput)(nil)).Elem(), GalleryImageIdentifierResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageIdentifierResponsePtrInput)(nil)).Elem(), GalleryImageIdentifierResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageVersionPublishingProfileInput)(nil)).Elem(), GalleryImageVersionPublishingProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageVersionPublishingProfilePtrInput)(nil)).Elem(), GalleryImageVersionPublishingProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageVersionPublishingProfileResponseInput)(nil)).Elem(), GalleryImageVersionPublishingProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageVersionPublishingProfileResponsePtrInput)(nil)).Elem(), GalleryImageVersionPublishingProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageVersionStorageProfileInput)(nil)).Elem(), GalleryImageVersionStorageProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageVersionStorageProfilePtrInput)(nil)).Elem(), GalleryImageVersionStorageProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageVersionStorageProfileResponseInput)(nil)).Elem(), GalleryImageVersionStorageProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryImageVersionStorageProfileResponsePtrInput)(nil)).Elem(), GalleryImageVersionStorageProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryOSDiskImageInput)(nil)).Elem(), GalleryOSDiskImageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryOSDiskImagePtrInput)(nil)).Elem(), GalleryOSDiskImageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryOSDiskImageResponseInput)(nil)).Elem(), GalleryOSDiskImageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GalleryOSDiskImageResponsePtrInput)(nil)).Elem(), GalleryOSDiskImageResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ImagePurchasePlanInput)(nil)).Elem(), ImagePurchasePlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImagePurchasePlanPtrInput)(nil)).Elem(), ImagePurchasePlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImagePurchasePlanResponseInput)(nil)).Elem(), ImagePurchasePlanResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImagePurchasePlanResponsePtrInput)(nil)).Elem(), ImagePurchasePlanResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyForDiskEncryptionSetInput)(nil)).Elem(), KeyForDiskEncryptionSetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyForDiskEncryptionSetPtrInput)(nil)).Elem(), KeyForDiskEncryptionSetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyForDiskEncryptionSetResponseInput)(nil)).Elem(), KeyForDiskEncryptionSetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyForDiskEncryptionSetResponsePtrInput)(nil)).Elem(), KeyForDiskEncryptionSetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyForDiskEncryptionSetResponseArrayInput)(nil)).Elem(), KeyForDiskEncryptionSetResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OSDiskImageEncryptionInput)(nil)).Elem(), OSDiskImageEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OSDiskImageEncryptionPtrInput)(nil)).Elem(), OSDiskImageEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OSDiskImageEncryptionResponseInput)(nil)).Elem(), OSDiskImageEncryptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OSDiskImageEncryptionResponsePtrInput)(nil)).Elem(), OSDiskImageEncryptionResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RecommendedMachineConfigurationInput)(nil)).Elem(), RecommendedMachineConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecommendedMachineConfigurationPtrInput)(nil)).Elem(), RecommendedMachineConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecommendedMachineConfigurationResponseInput)(nil)).Elem(), RecommendedMachineConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecommendedMachineConfigurationResponsePtrInput)(nil)).Elem(), RecommendedMachineConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegionalReplicationStatusResponseInput)(nil)).Elem(), RegionalReplicationStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegionalReplicationStatusResponseArrayInput)(nil)).Elem(), RegionalReplicationStatusResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicationStatusResponseInput)(nil)).Elem(), ReplicationStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicationStatusResponsePtrInput)(nil)).Elem(), ReplicationStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceRangeInput)(nil)).Elem(), ResourceRangeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceRangePtrInput)(nil)).Elem(), ResourceRangeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceRangeResponseInput)(nil)).Elem(), ResourceRangeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceRangeResponsePtrInput)(nil)).Elem(), ResourceRangeResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SharingProfileInput)(nil)).Elem(), SharingProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharingProfilePtrInput)(nil)).Elem(), SharingProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharingProfileGroupResponseInput)(nil)).Elem(), SharingProfileGroupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharingProfileGroupResponseArrayInput)(nil)).Elem(), SharingProfileGroupResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharingProfileResponseInput)(nil)).Elem(), SharingProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharingProfileResponsePtrInput)(nil)).Elem(), SharingProfileResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TargetRegionInput)(nil)).Elem(), TargetRegionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetRegionArrayInput)(nil)).Elem(), TargetRegionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetRegionResponseInput)(nil)).Elem(), TargetRegionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetRegionResponseArrayInput)(nil)).Elem(), TargetRegionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserArtifactManageInput)(nil)).Elem(), UserArtifactManageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserArtifactManagePtrInput)(nil)).Elem(), UserArtifactManageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserArtifactManageResponseInput)(nil)).Elem(), UserArtifactManageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserArtifactManageResponsePtrInput)(nil)).Elem(), UserArtifactManageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserArtifactSourceInput)(nil)).Elem(), UserArtifactSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserArtifactSourcePtrInput)(nil)).Elem(), UserArtifactSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserArtifactSourceResponseInput)(nil)).Elem(), UserArtifactSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserArtifactSourceResponsePtrInput)(nil)).Elem(), UserArtifactSourceResponseArgs{})
