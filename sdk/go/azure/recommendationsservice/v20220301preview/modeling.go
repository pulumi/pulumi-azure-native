...
func NewModeling(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recommendationsservice/v20220301preview:Modeling", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModeling(ctx *pulumi.Context,
	...
	var resource Modeling
	err := ctx.ReadResource("azure-native:recommendationsservice/v20220301preview:Modeling", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
