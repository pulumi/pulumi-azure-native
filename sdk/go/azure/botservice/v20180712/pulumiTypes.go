...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EnterpriseChannelNodeInput)(nil)).Elem(), EnterpriseChannelNodeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnterpriseChannelNodeArrayInput)(nil)).Elem(), EnterpriseChannelNodeArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnterpriseChannelNodeResponseInput)(nil)).Elem(), EnterpriseChannelNodeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnterpriseChannelNodeResponseArrayInput)(nil)).Elem(), EnterpriseChannelNodeResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnterpriseChannelPropertiesInput)(nil)).Elem(), EnterpriseChannelPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnterpriseChannelPropertiesPtrInput)(nil)).Elem(), EnterpriseChannelPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnterpriseChannelPropertiesResponseInput)(nil)).Elem(), EnterpriseChannelPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnterpriseChannelPropertiesResponsePtrInput)(nil)).Elem(), EnterpriseChannelPropertiesResponseArgs{})
