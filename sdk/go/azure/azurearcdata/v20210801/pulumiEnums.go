...
// ArcSqlServerLicenseTypeInput is an input type that accepts ArcSqlServerLicenseTypeArgs and ArcSqlServerLicenseTypeOutput values.
// You can construct a concrete instance of `ArcSqlServerLicenseTypeInput` via:
//
//          ArcSqlServerLicenseTypeArgs{...}
...
// DefenderStatusInput is an input type that accepts DefenderStatusArgs and DefenderStatusOutput values.
// You can construct a concrete instance of `DefenderStatusInput` via:
//
//          DefenderStatusArgs{...}
...
// EditionTypeInput is an input type that accepts EditionTypeArgs and EditionTypeOutput values.
// You can construct a concrete instance of `EditionTypeInput` via:
//
//          EditionTypeArgs{...}
...
// SqlVersionInput is an input type that accepts SqlVersionArgs and SqlVersionOutput values.
// You can construct a concrete instance of `SqlVersionInput` via:
//
//          SqlVersionArgs{...}
