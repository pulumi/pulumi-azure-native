...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ArcSqlManagedInstanceLicenseTypeInput)(nil)).Elem(), ArcSqlManagedInstanceLicenseType("BasePrice"))
	pulumi.RegisterInputType(reflect.TypeOf((*ArcSqlManagedInstanceLicenseTypePtrInput)(nil)).Elem(), ArcSqlManagedInstanceLicenseType("BasePrice"))
	pulumi.RegisterInputType(reflect.TypeOf((*ArcSqlServerLicenseTypeInput)(nil)).Elem(), ArcSqlServerLicenseType("Paid"))
	pulumi.RegisterInputType(reflect.TypeOf((*ArcSqlServerLicenseTypePtrInput)(nil)).Elem(), ArcSqlServerLicenseType("Paid"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionStatusInput)(nil)).Elem(), ConnectionStatus("Connected"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionStatusPtrInput)(nil)).Elem(), ConnectionStatus("Connected"))
	pulumi.RegisterInputType(reflect.TypeOf((*DefenderStatusInput)(nil)).Elem(), DefenderStatus("Protected"))
	pulumi.RegisterInputType(reflect.TypeOf((*DefenderStatusPtrInput)(nil)).Elem(), DefenderStatus("Protected"))
	pulumi.RegisterInputType(reflect.TypeOf((*EditionTypeInput)(nil)).Elem(), EditionType("Evaluation"))
	pulumi.RegisterInputType(reflect.TypeOf((*EditionTypePtrInput)(nil)).Elem(), EditionType("Evaluation"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*InfrastructureInput)(nil)).Elem(), Infrastructure("azure"))
	pulumi.RegisterInputType(reflect.TypeOf((*InfrastructurePtrInput)(nil)).Elem(), Infrastructure("azure"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SqlVersionInput)(nil)).Elem(), SqlVersion("SQL Server 2019"))
	pulumi.RegisterInputType(reflect.TypeOf((*SqlVersionPtrInput)(nil)).Elem(), SqlVersion("SQL Server 2019"))
