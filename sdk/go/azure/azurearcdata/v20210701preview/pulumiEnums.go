...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LicenseTypeInput)(nil)).Elem(), LicenseType("BasePrice"))
	pulumi.RegisterInputType(reflect.TypeOf((*LicenseTypePtrInput)(nil)).Elem(), LicenseType("BasePrice"))
