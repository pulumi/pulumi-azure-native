...
type EncryptionEnforcementStatus pulumi.String

const (
	EncryptionEnforcementStatusUnspecified = EncryptionEnforcementStatus("unspecified")
	EncryptionEnforcementStatusEnabled     = EncryptionEnforcementStatus("enabled")
	EncryptionEnforcementStatusDisabled    = EncryptionEnforcementStatus("disabled")
)

func (EncryptionEnforcementStatus) ElementType() reflect.Type {
	return reflect.TypeOf((*pulumi.String)(nil)).Elem()
}

func (e EncryptionEnforcementStatus) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e EncryptionEnforcementStatus) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e EncryptionEnforcementStatus) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e EncryptionEnforcementStatus) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
