...
type EncryptionWithCmkArgs struct {
	// Enforcement state of encryption with customer managed keys. Can be enabled, disabled, or unspecified.
	Enforcement *EncryptionEnforcementStatus `pulumi:"enforcement"`
}
...
type EncryptionWithCmkResponse struct {
	...
	NonCmkEncryptedResources []NonCmkEncryptedResourceResponse `pulumi:"nonCmkEncryptedResources"`
}

// EncryptionWithCmkResponseInput is an input type that accepts EncryptionWithCmkResponseArgs and EncryptionWithCmkResponseOutput values.
// You can construct a concrete instance of `EncryptionWithCmkResponseInput` via:
//
...
type EncryptionWithCmkResponseArgs struct {
	...
	// The list of Non Cmk encrypted resource.
	NonCmkEncryptedResources NonCmkEncryptedResourceResponseArrayInput `pulumi:"nonCmkEncryptedResources"`
}
...
// EncryptionWithCmkResponsePtrInput is an input type that accepts EncryptionWithCmkResponseArgs, EncryptionWithCmkResponsePtr and EncryptionWithCmkResponsePtrOutput values.
// You can construct a concrete instance of `EncryptionWithCmkResponsePtrInput` via:
//
//          EncryptionWithCmkResponseArgs{...}
//
//  or:
...
// The list of Non Cmk encrypted resource.
func (o EncryptionWithCmkResponseOutput) NonCmkEncryptedResources() NonCmkEncryptedResourceResponseArrayOutput {
	return o.ApplyT(func(v EncryptionWithCmkResponse) []NonCmkEncryptedResourceResponse { return v.NonCmkEncryptedResources }).(NonCmkEncryptedResourceResponseArrayOutput)
}
...
// The list of Non Cmk encrypted resource.
func (o EncryptionWithCmkResponsePtrOutput) NonCmkEncryptedResources() NonCmkEncryptedResourceResponseArrayOutput {
	return o.ApplyT(func(v *EncryptionWithCmkResponse) []NonCmkEncryptedResourceResponse {
		if v == nil {
			return nil
		}
		return v.NonCmkEncryptedResources
	}).(NonCmkEncryptedResourceResponseArrayOutput)
}
...
type NonCmkEncryptedResourceResponse struct {
...
// NonCmkEncryptedResourceResponseInput is an input type that accepts NonCmkEncryptedResourceResponseArgs and NonCmkEncryptedResourceResponseOutput values.
// You can construct a concrete instance of `NonCmkEncryptedResourceResponseInput` via:
//
//          NonCmkEncryptedResourceResponseArgs{...}
type NonCmkEncryptedResourceResponseInput interface {
	pulumi.Input

	ToNonCmkEncryptedResourceResponseOutput() NonCmkEncryptedResourceResponseOutput
	ToNonCmkEncryptedResourceResponseOutputWithContext(context.Context) NonCmkEncryptedResourceResponseOutput
}

// Describes properties of resources not encrypted with customer managed keys.
type NonCmkEncryptedResourceResponseArgs struct {
	// Describes name of resource not encrypted by customer managed keys.
...
func (NonCmkEncryptedResourceResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*NonCmkEncryptedResourceResponse)(nil)).Elem()
}

func (i NonCmkEncryptedResourceResponseArgs) ToNonCmkEncryptedResourceResponseOutput() NonCmkEncryptedResourceResponseOutput {
	return i.ToNonCmkEncryptedResourceResponseOutputWithContext(context.Background())
}

func (i NonCmkEncryptedResourceResponseArgs) ToNonCmkEncryptedResourceResponseOutputWithContext(ctx context.Context) NonCmkEncryptedResourceResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NonCmkEncryptedResourceResponseOutput)
}

// NonCmkEncryptedResourceResponseArrayInput is an input type that accepts NonCmkEncryptedResourceResponseArray and NonCmkEncryptedResourceResponseArrayOutput values.
// You can construct a concrete instance of `NonCmkEncryptedResourceResponseArrayInput` via:
//
//          NonCmkEncryptedResourceResponseArray{ NonCmkEncryptedResourceResponseArgs{...} }
type NonCmkEncryptedResourceResponseArrayInput interface {
	pulumi.Input

	ToNonCmkEncryptedResourceResponseArrayOutput() NonCmkEncryptedResourceResponseArrayOutput
	ToNonCmkEncryptedResourceResponseArrayOutputWithContext(context.Context) NonCmkEncryptedResourceResponseArrayOutput
}

type NonCmkEncryptedResourceResponseArray []NonCmkEncryptedResourceResponseInput

func (NonCmkEncryptedResourceResponseArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]NonCmkEncryptedResourceResponse)(nil)).Elem()
}

func (i NonCmkEncryptedResourceResponseArray) ToNonCmkEncryptedResourceResponseArrayOutput() NonCmkEncryptedResourceResponseArrayOutput {
	return i.ToNonCmkEncryptedResourceResponseArrayOutputWithContext(context.Background())
}

func (i NonCmkEncryptedResourceResponseArray) ToNonCmkEncryptedResourceResponseArrayOutputWithContext(ctx context.Context) NonCmkEncryptedResourceResponseArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NonCmkEncryptedResourceResponseArrayOutput)
}

// Describes properties of resources not encrypted with customer managed keys.
type NonCmkEncryptedResourceResponseOutput struct{ *pulumi.OutputState }

func (NonCmkEncryptedResourceResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*NonCmkEncryptedResourceResponse)(nil)).Elem()
}

func (o NonCmkEncryptedResourceResponseOutput) ToNonCmkEncryptedResourceResponseOutput() NonCmkEncryptedResourceResponseOutput {
	return o
}

func (o NonCmkEncryptedResourceResponseOutput) ToNonCmkEncryptedResourceResponseOutputWithContext(ctx context.Context) NonCmkEncryptedResourceResponseOutput {
	return o
}

// Describes name of resource not encrypted by customer managed keys.
func (o NonCmkEncryptedResourceResponseOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v NonCmkEncryptedResourceResponse) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// Describes type of resource (.i.e. index, indexer, skillset, synonym map and debug session) not encrypted by customer managed keys.
func (o NonCmkEncryptedResourceResponseOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v NonCmkEncryptedResourceResponse) *string { return v.Type }).(pulumi.StringPtrOutput)
}

type NonCmkEncryptedResourceResponseArrayOutput struct{ *pulumi.OutputState }

func (NonCmkEncryptedResourceResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]NonCmkEncryptedResourceResponse)(nil)).Elem()
}

func (o NonCmkEncryptedResourceResponseArrayOutput) ToNonCmkEncryptedResourceResponseArrayOutput() NonCmkEncryptedResourceResponseArrayOutput {
	return o
}

func (o NonCmkEncryptedResourceResponseArrayOutput) ToNonCmkEncryptedResourceResponseArrayOutputWithContext(ctx context.Context) NonCmkEncryptedResourceResponseArrayOutput {
	return o
}

func (o NonCmkEncryptedResourceResponseArrayOutput) Index(i pulumi.IntInput) NonCmkEncryptedResourceResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) NonCmkEncryptedResourceResponse {
		return vs[0].([]NonCmkEncryptedResourceResponse)[vs[1].(int)]
	}).(NonCmkEncryptedResourceResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(NonCmkEncryptedResourceResponseOutput{})
	pulumi.RegisterOutputType(NonCmkEncryptedResourceResponseArrayOutput{})
