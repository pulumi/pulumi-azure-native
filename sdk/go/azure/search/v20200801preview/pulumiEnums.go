...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SharedPrivateLinkResourceProvisioningStateInput)(nil)).Elem(), SharedPrivateLinkResourceProvisioningState("Updating"))
	pulumi.RegisterInputType(reflect.TypeOf((*SharedPrivateLinkResourceProvisioningStatePtrInput)(nil)).Elem(), SharedPrivateLinkResourceProvisioningState("Updating"))
	pulumi.RegisterInputType(reflect.TypeOf((*SharedPrivateLinkResourceStatusInput)(nil)).Elem(), SharedPrivateLinkResourceStatus("Pending"))
	pulumi.RegisterInputType(reflect.TypeOf((*SharedPrivateLinkResourceStatusPtrInput)(nil)).Elem(), SharedPrivateLinkResourceStatus("Pending"))
