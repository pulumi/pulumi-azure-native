...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AadAuthFailureModeInput)(nil)).Elem(), AadAuthFailureMode("http403"))
	pulumi.RegisterInputType(reflect.TypeOf((*AadAuthFailureModePtrInput)(nil)).Elem(), AadAuthFailureMode("http403"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SearchBypassInput)(nil)).Elem(), SearchBypass("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*SearchBypassPtrInput)(nil)).Elem(), SearchBypass("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*SearchDisabledDataExfiltrationOptionInput)(nil)).Elem(), SearchDisabledDataExfiltrationOption("All"))
	pulumi.RegisterInputType(reflect.TypeOf((*SearchDisabledDataExfiltrationOptionPtrInput)(nil)).Elem(), SearchDisabledDataExfiltrationOption("All"))
	pulumi.RegisterInputType(reflect.TypeOf((*SearchEncryptionWithCmkInput)(nil)).Elem(), SearchEncryptionWithCmk("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SearchEncryptionWithCmkPtrInput)(nil)).Elem(), SearchEncryptionWithCmk("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SearchSemanticSearchInput)(nil)).Elem(), SearchSemanticSearch("disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SearchSemanticSearchPtrInput)(nil)).Elem(), SearchSemanticSearch("disabled"))
