...
// FhirServiceKindInput is an input type that accepts FhirServiceKindArgs and FhirServiceKindOutput values.
// You can construct a concrete instance of `FhirServiceKindInput` via:
//
//          FhirServiceKindArgs{...}
...
// IotIdentityResolutionTypeInput is an input type that accepts IotIdentityResolutionTypeArgs and IotIdentityResolutionTypeOutput values.
// You can construct a concrete instance of `IotIdentityResolutionTypeInput` via:
//
