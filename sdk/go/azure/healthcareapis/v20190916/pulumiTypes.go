...
// Setting indicating whether the service has a managed identity associated with it.
type ResourceInvokeResponseIdentity struct {
...
// ResourceInvokeResponseIdentityInput is an input type that accepts ResourceInvokeResponseIdentityArgs and ResourceInvokeResponseIdentityOutput values.
// You can construct a concrete instance of `ResourceInvokeResponseIdentityInput` via:
//
//          ResourceInvokeResponseIdentityArgs{...}
type ResourceInvokeResponseIdentityInput interface {
	pulumi.Input

	ToResourceInvokeResponseIdentityOutput() ResourceInvokeResponseIdentityOutput
	ToResourceInvokeResponseIdentityOutputWithContext(context.Context) ResourceInvokeResponseIdentityOutput
}

// Setting indicating whether the service has a managed identity associated with it.
type ResourceInvokeResponseIdentityArgs struct {
	// The principal ID of the resource identity.
...
func (ResourceInvokeResponseIdentityArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ResourceInvokeResponseIdentity)(nil)).Elem()
}

func (i ResourceInvokeResponseIdentityArgs) ToResourceInvokeResponseIdentityOutput() ResourceInvokeResponseIdentityOutput {
	return i.ToResourceInvokeResponseIdentityOutputWithContext(context.Background())
}

func (i ResourceInvokeResponseIdentityArgs) ToResourceInvokeResponseIdentityOutputWithContext(ctx context.Context) ResourceInvokeResponseIdentityOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ResourceInvokeResponseIdentityOutput)
}

// Setting indicating whether the service has a managed identity associated with it.
type ResourceInvokeResponseIdentityOutput struct{ *pulumi.OutputState }

func (ResourceInvokeResponseIdentityOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ResourceInvokeResponseIdentity)(nil)).Elem()
}

func (o ResourceInvokeResponseIdentityOutput) ToResourceInvokeResponseIdentityOutput() ResourceInvokeResponseIdentityOutput {
	return o
}

func (o ResourceInvokeResponseIdentityOutput) ToResourceInvokeResponseIdentityOutputWithContext(ctx context.Context) ResourceInvokeResponseIdentityOutput {
	return o
}

// The principal ID of the resource identity.
func (o ResourceInvokeResponseIdentityOutput) PrincipalId() pulumi.StringOutput {
	return o.ApplyT(func(v ResourceInvokeResponseIdentity) string { return v.PrincipalId }).(pulumi.StringOutput)
}

// The tenant ID of the resource.
func (o ResourceInvokeResponseIdentityOutput) TenantId() pulumi.StringOutput {
	return o.ApplyT(func(v ResourceInvokeResponseIdentity) string { return v.TenantId }).(pulumi.StringOutput)
}

// Type of identity being specified, currently SystemAssigned and None are allowed.
func (o ResourceInvokeResponseIdentityOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ResourceInvokeResponseIdentity) *string { return v.Type }).(pulumi.StringPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ResourceInvokeResponseIdentityOutput{})
