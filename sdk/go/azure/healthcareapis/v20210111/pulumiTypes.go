...
func (o ServiceAcrConfigurationInfoResponseOutput) ToServiceAcrConfigurationInfoResponsePtrOutputWithContext(ctx context.Context) ServiceAcrConfigurationInfoResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ServiceAcrConfigurationInfoResponse) *ServiceAcrConfigurationInfoResponse {
		return &v
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAcrConfigurationInfoInput)(nil)).Elem(), ServiceAcrConfigurationInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAcrConfigurationInfoPtrInput)(nil)).Elem(), ServiceAcrConfigurationInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAcrConfigurationInfoResponseInput)(nil)).Elem(), ServiceAcrConfigurationInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceAcrConfigurationInfoResponsePtrInput)(nil)).Elem(), ServiceAcrConfigurationInfoResponseArgs{})
