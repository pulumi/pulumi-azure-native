...
func NewDicomService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:healthcareapis/v20221001preview:DicomService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDicomService(ctx *pulumi.Context,
	...
	var resource DicomService
	err := ctx.ReadResource("azure-native:healthcareapis/v20221001preview:DicomService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
