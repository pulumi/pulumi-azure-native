...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceResponseIdentityInput)(nil)).Elem(), ResourceResponseIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceResponseIdentityPtrInput)(nil)).Elem(), ResourceResponseIdentityArgs{})
