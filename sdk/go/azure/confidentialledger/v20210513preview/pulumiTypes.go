...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AADBasedSecurityPrincipalInput)(nil)).Elem(), AADBasedSecurityPrincipalArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AADBasedSecurityPrincipalArrayInput)(nil)).Elem(), AADBasedSecurityPrincipalArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AADBasedSecurityPrincipalResponseInput)(nil)).Elem(), AADBasedSecurityPrincipalResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AADBasedSecurityPrincipalResponseArrayInput)(nil)).Elem(), AADBasedSecurityPrincipalResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CertBasedSecurityPrincipalInput)(nil)).Elem(), CertBasedSecurityPrincipalArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CertBasedSecurityPrincipalArrayInput)(nil)).Elem(), CertBasedSecurityPrincipalArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CertBasedSecurityPrincipalResponseInput)(nil)).Elem(), CertBasedSecurityPrincipalResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CertBasedSecurityPrincipalResponseArrayInput)(nil)).Elem(), CertBasedSecurityPrincipalResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*LedgerPropertiesInput)(nil)).Elem(), LedgerPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LedgerPropertiesPtrInput)(nil)).Elem(), LedgerPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LedgerPropertiesResponseInput)(nil)).Elem(), LedgerPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LedgerPropertiesResponsePtrInput)(nil)).Elem(), LedgerPropertiesResponseArgs{})
