...
func NewSubAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:logz/v20201001:SubAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubAccount(ctx *pulumi.Context,
	...
	var resource SubAccount
	err := ctx.ReadResource("azure-native:logz/v20201001:SubAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
