...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MarketplaceSubscriptionStatusInput)(nil)).Elem(), MarketplaceSubscriptionStatus("Active"))
	pulumi.RegisterInputType(reflect.TypeOf((*MarketplaceSubscriptionStatusPtrInput)(nil)).Elem(), MarketplaceSubscriptionStatus("Active"))
