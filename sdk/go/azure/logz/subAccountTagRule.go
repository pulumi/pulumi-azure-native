...
func NewSubAccountTagRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:logz:SubAccountTagRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubAccountTagRule(ctx *pulumi.Context,
	...
	var resource SubAccountTagRule
	err := ctx.ReadResource("azure-native:logz:SubAccountTagRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
