...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CompanyInfoInput)(nil)).Elem(), CompanyInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CompanyInfoPtrInput)(nil)).Elem(), CompanyInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CompanyInfoResponseInput)(nil)).Elem(), CompanyInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CompanyInfoResponsePtrInput)(nil)).Elem(), CompanyInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ElasticCloudDeploymentResponseInput)(nil)).Elem(), ElasticCloudDeploymentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ElasticCloudDeploymentResponsePtrInput)(nil)).Elem(), ElasticCloudDeploymentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ElasticCloudUserResponseInput)(nil)).Elem(), ElasticCloudUserResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ElasticCloudUserResponsePtrInput)(nil)).Elem(), ElasticCloudUserResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ElasticPropertiesResponseInput)(nil)).Elem(), ElasticPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ElasticPropertiesResponsePtrInput)(nil)).Elem(), ElasticPropertiesResponseArgs{})
