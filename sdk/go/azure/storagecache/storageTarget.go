...
func NewStorageTarget(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:storagecache:StorageTarget", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageTarget(ctx *pulumi.Context,
	...
	var resource StorageTarget
	err := ctx.ReadResource("azure-nextgen:storagecache:StorageTarget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
