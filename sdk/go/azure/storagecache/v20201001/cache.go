...
func NewCache(ctx *pulumi.Context,
	...
	var resource Cache
	err := ctx.RegisterResource("azure-nextgen:storagecache/v20201001:Cache", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCache(ctx *pulumi.Context,
	...
	var resource Cache
	err := ctx.ReadResource("azure-nextgen:storagecache/v20201001:Cache", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
