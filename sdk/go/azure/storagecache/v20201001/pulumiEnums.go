...
// NfsAccessRuleAccessInput is an input type that accepts NfsAccessRuleAccessArgs and NfsAccessRuleAccessOutput values.
// You can construct a concrete instance of `NfsAccessRuleAccessInput` via:
//
...
// NfsAccessRuleScopeInput is an input type that accepts NfsAccessRuleScopeArgs and NfsAccessRuleScopeOutput values.
// You can construct a concrete instance of `NfsAccessRuleScopeInput` via:
//
...
// UsernameSourceInput is an input type that accepts UsernameSourceArgs and UsernameSourceOutput values.
// You can construct a concrete instance of `UsernameSourceInput` via:
//
//          UsernameSourceArgs{...}
