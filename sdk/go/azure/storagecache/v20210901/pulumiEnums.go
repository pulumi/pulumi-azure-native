...
// OperationalStateTypeInput is an input type that accepts OperationalStateTypeArgs and OperationalStateTypeOutput values.
// You can construct a concrete instance of `OperationalStateTypeInput` via:
//
