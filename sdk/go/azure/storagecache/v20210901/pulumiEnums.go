...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OperationalStateTypeInput)(nil)).Elem(), OperationalStateType("Ready"))
	pulumi.RegisterInputType(reflect.TypeOf((*OperationalStateTypePtrInput)(nil)).Elem(), OperationalStateType("Ready"))
