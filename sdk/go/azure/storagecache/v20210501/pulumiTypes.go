...
// CacheIdentityResponseUserAssignedIdentitiesInput is an input type that accepts CacheIdentityResponseUserAssignedIdentitiesArgs and CacheIdentityResponseUserAssignedIdentitiesOutput values.
// You can construct a concrete instance of `CacheIdentityResponseUserAssignedIdentitiesInput` via:
//
...
// CacheIdentityResponseUserAssignedIdentitiesMapInput is an input type that accepts CacheIdentityResponseUserAssignedIdentitiesMap and CacheIdentityResponseUserAssignedIdentitiesMapOutput values.
// You can construct a concrete instance of `CacheIdentityResponseUserAssignedIdentitiesMapInput` via:
//
//          CacheIdentityResponseUserAssignedIdentitiesMap{ "key": CacheIdentityResponseUserAssignedIdentitiesArgs{...} }
