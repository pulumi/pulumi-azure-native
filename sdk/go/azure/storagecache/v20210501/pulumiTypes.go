...
type CacheIdentityResponseArgs struct {
	...
	UserAssignedIdentities CacheIdentityResponseUserAssignedIdentitiesMapInput `pulumi:"userAssignedIdentities"`
}
...
type CacheIdentityResponseUserAssignedIdentitiesInput interface {
	pulumi.Input

	ToCacheIdentityResponseUserAssignedIdentitiesOutput() CacheIdentityResponseUserAssignedIdentitiesOutput
	ToCacheIdentityResponseUserAssignedIdentitiesOutputWithContext(context.Context) CacheIdentityResponseUserAssignedIdentitiesOutput
}

type CacheIdentityResponseUserAssignedIdentitiesArgs struct {
	ClientId    pulumi.StringInput `pulumi:"clientId"`
	PrincipalId pulumi.StringInput `pulumi:"principalId"`
}

func (CacheIdentityResponseUserAssignedIdentitiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*CacheIdentityResponseUserAssignedIdentities)(nil)).Elem()
}

func (i CacheIdentityResponseUserAssignedIdentitiesArgs) ToCacheIdentityResponseUserAssignedIdentitiesOutput() CacheIdentityResponseUserAssignedIdentitiesOutput {
	return i.ToCacheIdentityResponseUserAssignedIdentitiesOutputWithContext(context.Background())
}

func (i CacheIdentityResponseUserAssignedIdentitiesArgs) ToCacheIdentityResponseUserAssignedIdentitiesOutputWithContext(ctx context.Context) CacheIdentityResponseUserAssignedIdentitiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CacheIdentityResponseUserAssignedIdentitiesOutput)
}
...
type CacheIdentityResponseUserAssignedIdentitiesMapInput interface {
	pulumi.Input

	ToCacheIdentityResponseUserAssignedIdentitiesMapOutput() CacheIdentityResponseUserAssignedIdentitiesMapOutput
	ToCacheIdentityResponseUserAssignedIdentitiesMapOutputWithContext(context.Context) CacheIdentityResponseUserAssignedIdentitiesMapOutput
}

type CacheIdentityResponseUserAssignedIdentitiesMap map[string]CacheIdentityResponseUserAssignedIdentitiesInput

func (CacheIdentityResponseUserAssignedIdentitiesMap) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]CacheIdentityResponseUserAssignedIdentities)(nil)).Elem()
}

func (i CacheIdentityResponseUserAssignedIdentitiesMap) ToCacheIdentityResponseUserAssignedIdentitiesMapOutput() CacheIdentityResponseUserAssignedIdentitiesMapOutput {
	return i.ToCacheIdentityResponseUserAssignedIdentitiesMapOutputWithContext(context.Background())
}

func (i CacheIdentityResponseUserAssignedIdentitiesMap) ToCacheIdentityResponseUserAssignedIdentitiesMapOutputWithContext(ctx context.Context) CacheIdentityResponseUserAssignedIdentitiesMapOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CacheIdentityResponseUserAssignedIdentitiesMapOutput)
}
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*BlobNfsTargetInput)(nil)).Elem(), BlobNfsTargetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobNfsTargetPtrInput)(nil)).Elem(), BlobNfsTargetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobNfsTargetResponseInput)(nil)).Elem(), BlobNfsTargetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobNfsTargetResponsePtrInput)(nil)).Elem(), BlobNfsTargetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheActiveDirectorySettingsInput)(nil)).Elem(), CacheActiveDirectorySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheActiveDirectorySettingsPtrInput)(nil)).Elem(), CacheActiveDirectorySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheActiveDirectorySettingsCredentialsInput)(nil)).Elem(), CacheActiveDirectorySettingsCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheActiveDirectorySettingsCredentialsPtrInput)(nil)).Elem(), CacheActiveDirectorySettingsCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheActiveDirectorySettingsResponseInput)(nil)).Elem(), CacheActiveDirectorySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheActiveDirectorySettingsResponsePtrInput)(nil)).Elem(), CacheActiveDirectorySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheActiveDirectorySettingsResponseCredentialsInput)(nil)).Elem(), CacheActiveDirectorySettingsResponseCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheActiveDirectorySettingsResponseCredentialsPtrInput)(nil)).Elem(), CacheActiveDirectorySettingsResponseCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheDirectorySettingsInput)(nil)).Elem(), CacheDirectorySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheDirectorySettingsPtrInput)(nil)).Elem(), CacheDirectorySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheDirectorySettingsResponseInput)(nil)).Elem(), CacheDirectorySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheDirectorySettingsResponsePtrInput)(nil)).Elem(), CacheDirectorySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheEncryptionSettingsInput)(nil)).Elem(), CacheEncryptionSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheEncryptionSettingsPtrInput)(nil)).Elem(), CacheEncryptionSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheEncryptionSettingsResponseInput)(nil)).Elem(), CacheEncryptionSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheEncryptionSettingsResponsePtrInput)(nil)).Elem(), CacheEncryptionSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheHealthResponseInput)(nil)).Elem(), CacheHealthResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheHealthResponsePtrInput)(nil)).Elem(), CacheHealthResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CacheIdentityResponseInput)(nil)).Elem(), CacheIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheIdentityResponsePtrInput)(nil)).Elem(), CacheIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheIdentityResponseUserAssignedIdentitiesInput)(nil)).Elem(), CacheIdentityResponseUserAssignedIdentitiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheIdentityResponseUserAssignedIdentitiesMapInput)(nil)).Elem(), CacheIdentityResponseUserAssignedIdentitiesMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheNetworkSettingsInput)(nil)).Elem(), CacheNetworkSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheNetworkSettingsPtrInput)(nil)).Elem(), CacheNetworkSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheNetworkSettingsResponseInput)(nil)).Elem(), CacheNetworkSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheNetworkSettingsResponsePtrInput)(nil)).Elem(), CacheNetworkSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheResponseSkuInput)(nil)).Elem(), CacheResponseSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheResponseSkuPtrInput)(nil)).Elem(), CacheResponseSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheSecuritySettingsInput)(nil)).Elem(), CacheSecuritySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheSecuritySettingsPtrInput)(nil)).Elem(), CacheSecuritySettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheSecuritySettingsResponseInput)(nil)).Elem(), CacheSecuritySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheSecuritySettingsResponsePtrInput)(nil)).Elem(), CacheSecuritySettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheSkuInput)(nil)).Elem(), CacheSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheSkuPtrInput)(nil)).Elem(), CacheSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheUpgradeStatusResponseInput)(nil)).Elem(), CacheUpgradeStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheUpgradeStatusResponsePtrInput)(nil)).Elem(), CacheUpgradeStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheUsernameDownloadSettingsInput)(nil)).Elem(), CacheUsernameDownloadSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheUsernameDownloadSettingsPtrInput)(nil)).Elem(), CacheUsernameDownloadSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheUsernameDownloadSettingsCredentialsInput)(nil)).Elem(), CacheUsernameDownloadSettingsCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheUsernameDownloadSettingsCredentialsPtrInput)(nil)).Elem(), CacheUsernameDownloadSettingsCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheUsernameDownloadSettingsResponseInput)(nil)).Elem(), CacheUsernameDownloadSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheUsernameDownloadSettingsResponsePtrInput)(nil)).Elem(), CacheUsernameDownloadSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheUsernameDownloadSettingsResponseCredentialsInput)(nil)).Elem(), CacheUsernameDownloadSettingsResponseCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CacheUsernameDownloadSettingsResponseCredentialsPtrInput)(nil)).Elem(), CacheUsernameDownloadSettingsResponseCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClfsTargetInput)(nil)).Elem(), ClfsTargetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClfsTargetPtrInput)(nil)).Elem(), ClfsTargetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClfsTargetResponseInput)(nil)).Elem(), ClfsTargetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ClfsTargetResponsePtrInput)(nil)).Elem(), ClfsTargetResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultKeyReferenceResponseSourceVaultInput)(nil)).Elem(), KeyVaultKeyReferenceResponseSourceVaultArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultKeyReferenceResponseSourceVaultPtrInput)(nil)).Elem(), KeyVaultKeyReferenceResponseSourceVaultArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultKeyReferenceSourceVaultInput)(nil)).Elem(), KeyVaultKeyReferenceSourceVaultArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultKeyReferenceSourceVaultPtrInput)(nil)).Elem(), KeyVaultKeyReferenceSourceVaultArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NamespaceJunctionInput)(nil)).Elem(), NamespaceJunctionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NamespaceJunctionArrayInput)(nil)).Elem(), NamespaceJunctionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NamespaceJunctionResponseInput)(nil)).Elem(), NamespaceJunctionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NamespaceJunctionResponseArrayInput)(nil)).Elem(), NamespaceJunctionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*Nfs3TargetInput)(nil)).Elem(), Nfs3TargetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*Nfs3TargetPtrInput)(nil)).Elem(), Nfs3TargetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*Nfs3TargetResponseInput)(nil)).Elem(), Nfs3TargetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*Nfs3TargetResponsePtrInput)(nil)).Elem(), Nfs3TargetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NfsAccessPolicyInput)(nil)).Elem(), NfsAccessPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NfsAccessPolicyArrayInput)(nil)).Elem(), NfsAccessPolicyArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NfsAccessPolicyResponseInput)(nil)).Elem(), NfsAccessPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NfsAccessPolicyResponseArrayInput)(nil)).Elem(), NfsAccessPolicyResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NfsAccessRuleInput)(nil)).Elem(), NfsAccessRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NfsAccessRuleArrayInput)(nil)).Elem(), NfsAccessRuleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NfsAccessRuleResponseInput)(nil)).Elem(), NfsAccessRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NfsAccessRuleResponseArrayInput)(nil)).Elem(), NfsAccessRuleResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UnknownTargetInput)(nil)).Elem(), UnknownTargetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UnknownTargetPtrInput)(nil)).Elem(), UnknownTargetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UnknownTargetResponseInput)(nil)).Elem(), UnknownTargetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UnknownTargetResponsePtrInput)(nil)).Elem(), UnknownTargetResponseArgs{})
