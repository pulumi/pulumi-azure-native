...
// LinuxUpdateClassesInput is an input type that accepts LinuxUpdateClassesArgs and LinuxUpdateClassesOutput values.
// You can construct a concrete instance of `LinuxUpdateClassesInput` via:
//
...
// WindowsUpdateClassesInput is an input type that accepts WindowsUpdateClassesArgs and WindowsUpdateClassesOutput values.
// You can construct a concrete instance of `WindowsUpdateClassesInput` via:
//
