...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SchedulePropertiesInput)(nil)).Elem(), SchedulePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SchedulePropertiesPtrInput)(nil)).Elem(), SchedulePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SchedulePropertiesResponseInput)(nil)).Elem(), SchedulePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SchedulePropertiesResponsePtrInput)(nil)).Elem(), SchedulePropertiesResponseArgs{})
