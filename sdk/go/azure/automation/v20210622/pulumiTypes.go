...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionPropertiesIdentityInput)(nil)).Elem(), EncryptionPropertiesIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionPropertiesIdentityPtrInput)(nil)).Elem(), EncryptionPropertiesIdentityArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionPropertiesResponseIdentityInput)(nil)).Elem(), EncryptionPropertiesResponseIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionPropertiesResponseIdentityPtrInput)(nil)).Elem(), EncryptionPropertiesResponseIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HybridRunbookWorkerLegacyResponseInput)(nil)).Elem(), HybridRunbookWorkerLegacyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HybridRunbookWorkerLegacyResponseArrayInput)(nil)).Elem(), HybridRunbookWorkerLegacyResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RunAsCredentialAssociationPropertyInput)(nil)).Elem(), RunAsCredentialAssociationPropertyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RunAsCredentialAssociationPropertyPtrInput)(nil)).Elem(), RunAsCredentialAssociationPropertyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RunAsCredentialAssociationPropertyResponseInput)(nil)).Elem(), RunAsCredentialAssociationPropertyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RunAsCredentialAssociationPropertyResponsePtrInput)(nil)).Elem(), RunAsCredentialAssociationPropertyResponseArgs{})
