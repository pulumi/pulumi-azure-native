...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AzureQueryPropertiesInput)(nil)).Elem(), AzureQueryPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureQueryPropertiesArrayInput)(nil)).Elem(), AzureQueryPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureQueryPropertiesResponseInput)(nil)).Elem(), AzureQueryPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureQueryPropertiesResponseArrayInput)(nil)).Elem(), AzureQueryPropertiesResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxPropertiesInput)(nil)).Elem(), LinuxPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxPropertiesPtrInput)(nil)).Elem(), LinuxPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxPropertiesResponseInput)(nil)).Elem(), LinuxPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinuxPropertiesResponsePtrInput)(nil)).Elem(), LinuxPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NonAzureQueryPropertiesInput)(nil)).Elem(), NonAzureQueryPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NonAzureQueryPropertiesArrayInput)(nil)).Elem(), NonAzureQueryPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NonAzureQueryPropertiesResponseInput)(nil)).Elem(), NonAzureQueryPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NonAzureQueryPropertiesResponseArrayInput)(nil)).Elem(), NonAzureQueryPropertiesResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SUCSchedulePropertiesInput)(nil)).Elem(), SUCSchedulePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SUCSchedulePropertiesPtrInput)(nil)).Elem(), SUCSchedulePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SUCSchedulePropertiesResponseInput)(nil)).Elem(), SUCSchedulePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SUCSchedulePropertiesResponsePtrInput)(nil)).Elem(), SUCSchedulePropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SoftwareUpdateConfigurationTasksInput)(nil)).Elem(), SoftwareUpdateConfigurationTasksArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SoftwareUpdateConfigurationTasksPtrInput)(nil)).Elem(), SoftwareUpdateConfigurationTasksArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SoftwareUpdateConfigurationTasksResponseInput)(nil)).Elem(), SoftwareUpdateConfigurationTasksResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SoftwareUpdateConfigurationTasksResponsePtrInput)(nil)).Elem(), SoftwareUpdateConfigurationTasksResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceControlSecurityTokenPropertiesInput)(nil)).Elem(), SourceControlSecurityTokenPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceControlSecurityTokenPropertiesPtrInput)(nil)).Elem(), SourceControlSecurityTokenPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TagSettingsPropertiesInput)(nil)).Elem(), TagSettingsPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TagSettingsPropertiesPtrInput)(nil)).Elem(), TagSettingsPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TagSettingsPropertiesResponseInput)(nil)).Elem(), TagSettingsPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TagSettingsPropertiesResponsePtrInput)(nil)).Elem(), TagSettingsPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetPropertiesInput)(nil)).Elem(), TargetPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetPropertiesPtrInput)(nil)).Elem(), TargetPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetPropertiesResponseInput)(nil)).Elem(), TargetPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetPropertiesResponsePtrInput)(nil)).Elem(), TargetPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TaskPropertiesInput)(nil)).Elem(), TaskPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TaskPropertiesPtrInput)(nil)).Elem(), TaskPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TaskPropertiesResponseInput)(nil)).Elem(), TaskPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TaskPropertiesResponsePtrInput)(nil)).Elem(), TaskPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UpdateConfigurationInput)(nil)).Elem(), UpdateConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UpdateConfigurationPtrInput)(nil)).Elem(), UpdateConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UpdateConfigurationResponseInput)(nil)).Elem(), UpdateConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UpdateConfigurationResponsePtrInput)(nil)).Elem(), UpdateConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsPropertiesInput)(nil)).Elem(), WindowsPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsPropertiesPtrInput)(nil)).Elem(), WindowsPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsPropertiesResponseInput)(nil)).Elem(), WindowsPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WindowsPropertiesResponsePtrInput)(nil)).Elem(), WindowsPropertiesResponseArgs{})
