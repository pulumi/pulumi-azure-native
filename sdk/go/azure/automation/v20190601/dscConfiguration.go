...
func NewDscConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:automation/v20190601:DscConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDscConfiguration(ctx *pulumi.Context,
	...
	var resource DscConfiguration
	err := ctx.ReadResource("azure-nextgen:automation/v20190601:DscConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
