...
func NewSourceControl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:automation/v20200113preview:SourceControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSourceControl(ctx *pulumi.Context,
	...
	var resource SourceControl
	err := ctx.ReadResource("azure-nextgen:automation/v20200113preview:SourceControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
