...
func NewConnectionType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:automation/v20151031:ConnectionType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionType(ctx *pulumi.Context,
	...
	var resource ConnectionType
	err := ctx.ReadResource("azure-nextgen:automation/v20151031:ConnectionType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
