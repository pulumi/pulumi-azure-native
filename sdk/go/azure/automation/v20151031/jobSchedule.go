...
func NewJobSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:automation/v20151031:JobSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobSchedule(ctx *pulumi.Context,
	...
	var resource JobSchedule
	err := ctx.ReadResource("azure-nextgen:automation/v20151031:JobSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
