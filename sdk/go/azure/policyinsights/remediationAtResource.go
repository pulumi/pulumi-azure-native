...
func NewRemediationAtResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:policyinsights:RemediationAtResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemediationAtResource(ctx *pulumi.Context,
	...
	var resource RemediationAtResource
	err := ctx.ReadResource("azure-nextgen:policyinsights:RemediationAtResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
