...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:policyinsights:getAttestationAtResource'.
func LookupAttestationAtResource(ctx *pulumi.Context, args *LookupAttestationAtResourceArgs, opts ...pulumi.InvokeOption) (*LookupAttestationAtResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:policyinsights/latest:getAttestationAtResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
