...
func NewRemediationAtResourceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:policyinsights/v20180701preview:RemediationAtResourceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemediationAtResourceGroup(ctx *pulumi.Context,
	...
	var resource RemediationAtResourceGroup
	err := ctx.ReadResource("azure-native:policyinsights/v20180701preview:RemediationAtResourceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o RemediationAtResourceGroupOutput) DeploymentStatus() RemediationDeploymentSummaryResponsePtrOutput {
	return o.ApplyT(func(v *RemediationAtResourceGroup) RemediationDeploymentSummaryResponsePtrOutput {
