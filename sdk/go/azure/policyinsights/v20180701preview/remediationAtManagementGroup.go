...
func NewRemediationAtManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:policyinsights/v20180701preview:RemediationAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemediationAtManagementGroup(ctx *pulumi.Context,
	...
	var resource RemediationAtManagementGroup
	err := ctx.ReadResource("azure-nextgen:policyinsights/v20180701preview:RemediationAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
