...
func (o RemediationAtResourceOutput) DeploymentStatus() RemediationDeploymentSummaryResponsePtrOutput {
	return o.ApplyT(func(v *RemediationAtResource) RemediationDeploymentSummaryResponsePtrOutput {
