...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RemediationDeploymentSummaryInput)(nil)).Elem(), RemediationDeploymentSummaryArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RemediationDeploymentSummaryPtrInput)(nil)).Elem(), RemediationDeploymentSummaryArgs{})
