...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AccountPropertiesResponseEndpointsInput)(nil)).Elem(), AccountPropertiesResponseEndpointsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountPropertiesResponseEndpointsPtrInput)(nil)).Elem(), AccountPropertiesResponseEndpointsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountPropertiesResponseManagedResourcesInput)(nil)).Elem(), AccountPropertiesResponseManagedResourcesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountPropertiesResponseManagedResourcesPtrInput)(nil)).Elem(), AccountPropertiesResponseManagedResourcesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountPropertiesResponseSystemDataInput)(nil)).Elem(), AccountPropertiesResponseSystemDataArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountPropertiesResponseSystemDataPtrInput)(nil)).Elem(), AccountPropertiesResponseSystemDataArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountResponseSkuInput)(nil)).Elem(), AccountResponseSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountResponseSkuPtrInput)(nil)).Elem(), AccountResponseSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudConnectorsResponseInput)(nil)).Elem(), CloudConnectorsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudConnectorsResponsePtrInput)(nil)).Elem(), CloudConnectorsResponseArgs{})
