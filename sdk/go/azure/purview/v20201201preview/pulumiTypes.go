...
// Gets or sets the default behavior of network ACLs.
func (o NetworkAclsOutput) DefaultAction() pulumi.StringPtrOutput {
	return o.ApplyT(func(v NetworkAcls) *string { return v.DefaultAction }).(pulumi.StringPtrOutput)
}
...
func (o NetworkAclsPtrOutput) Elem() NetworkAclsOutput {
	return o.ApplyT(func(v *NetworkAcls) NetworkAcls { return *v }).(NetworkAclsOutput)
}

// Gets or sets the default behavior of network ACLs.
func (o NetworkAclsPtrOutput) DefaultAction() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NetworkAcls) *string {
		if v == nil {
			return nil
		}
...
// NetworkAclsResponseInput is an input type that accepts NetworkAclsResponseArgs and NetworkAclsResponseOutput values.
// You can construct a concrete instance of `NetworkAclsResponseInput` via:
//
//          NetworkAclsResponseArgs{...}
type NetworkAclsResponseInput interface {
	pulumi.Input

	ToNetworkAclsResponseOutput() NetworkAclsResponseOutput
	ToNetworkAclsResponseOutputWithContext(context.Context) NetworkAclsResponseOutput
}

// The Network ACLs
type NetworkAclsResponseArgs struct {
	// Gets or sets the default behavior of network ACLs.
	DefaultAction pulumi.StringPtrInput `pulumi:"defaultAction"`
}

func (NetworkAclsResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*NetworkAclsResponse)(nil)).Elem()
}

func (i NetworkAclsResponseArgs) ToNetworkAclsResponseOutput() NetworkAclsResponseOutput {
	return i.ToNetworkAclsResponseOutputWithContext(context.Background())
}

func (i NetworkAclsResponseArgs) ToNetworkAclsResponseOutputWithContext(ctx context.Context) NetworkAclsResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NetworkAclsResponseOutput)
}

func (i NetworkAclsResponseArgs) ToNetworkAclsResponsePtrOutput() NetworkAclsResponsePtrOutput {
	return i.ToNetworkAclsResponsePtrOutputWithContext(context.Background())
}

func (i NetworkAclsResponseArgs) ToNetworkAclsResponsePtrOutputWithContext(ctx context.Context) NetworkAclsResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NetworkAclsResponseOutput).ToNetworkAclsResponsePtrOutputWithContext(ctx)
}

// NetworkAclsResponsePtrInput is an input type that accepts NetworkAclsResponseArgs, NetworkAclsResponsePtr and NetworkAclsResponsePtrOutput values.
// You can construct a concrete instance of `NetworkAclsResponsePtrInput` via:
//
//          NetworkAclsResponseArgs{...}
//
//  or:
//
//          nil
type NetworkAclsResponsePtrInput interface {
	pulumi.Input

	ToNetworkAclsResponsePtrOutput() NetworkAclsResponsePtrOutput
	ToNetworkAclsResponsePtrOutputWithContext(context.Context) NetworkAclsResponsePtrOutput
}

type networkAclsResponsePtrType NetworkAclsResponseArgs

func NetworkAclsResponsePtr(v *NetworkAclsResponseArgs) NetworkAclsResponsePtrInput {
	return (*networkAclsResponsePtrType)(v)
}

func (*networkAclsResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**NetworkAclsResponse)(nil)).Elem()
}

func (i *networkAclsResponsePtrType) ToNetworkAclsResponsePtrOutput() NetworkAclsResponsePtrOutput {
	return i.ToNetworkAclsResponsePtrOutputWithContext(context.Background())
}

func (i *networkAclsResponsePtrType) ToNetworkAclsResponsePtrOutputWithContext(ctx context.Context) NetworkAclsResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NetworkAclsResponsePtrOutput)
}
...
func (o NetworkAclsResponseOutput) ToNetworkAclsResponsePtrOutput() NetworkAclsResponsePtrOutput {
	return o.ToNetworkAclsResponsePtrOutputWithContext(context.Background())
}

func (o NetworkAclsResponseOutput) ToNetworkAclsResponsePtrOutputWithContext(ctx context.Context) NetworkAclsResponsePtrOutput {
	return o.ApplyT(func(v NetworkAclsResponse) *NetworkAclsResponse {
		return &v
	}).(NetworkAclsResponsePtrOutput)
}

// Gets or sets the default behavior of network ACLs.
func (o NetworkAclsResponseOutput) DefaultAction() pulumi.StringPtrOutput {
	return o.ApplyT(func(v NetworkAclsResponse) *string { return v.DefaultAction }).(pulumi.StringPtrOutput)
}
...
func (o NetworkAclsResponsePtrOutput) Elem() NetworkAclsResponseOutput {
	return o.ApplyT(func(v *NetworkAclsResponse) NetworkAclsResponse { return *v }).(NetworkAclsResponseOutput)
}

// Gets or sets the default behavior of network ACLs.
func (o NetworkAclsResponsePtrOutput) DefaultAction() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NetworkAclsResponse) *string {
		if v == nil {
			return nil
		}
		return v.DefaultAction
