...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TrackedResourceResponseSystemDataInput)(nil)).Elem(), TrackedResourceResponseSystemDataArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TrackedResourceResponseSystemDataPtrInput)(nil)).Elem(), TrackedResourceResponseSystemDataArgs{})
