...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KEKIdentityInput)(nil)).Elem(), KEKIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KEKIdentityPtrInput)(nil)).Elem(), KEKIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KEKIdentityResponseInput)(nil)).Elem(), KEKIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KEKIdentityResponsePtrInput)(nil)).Elem(), KEKIdentityResponseArgs{})
