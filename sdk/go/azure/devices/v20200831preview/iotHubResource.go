...
func NewIotHubResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:devices/v20200831preview:IotHubResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotHubResource(ctx *pulumi.Context,
	...
	var resource IotHubResource
	err := ctx.ReadResource("azure-nextgen:devices/v20200831preview:IotHubResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
