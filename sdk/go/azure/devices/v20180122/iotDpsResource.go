...
func NewIotDpsResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:devices/v20180122:IotDpsResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotDpsResource(ctx *pulumi.Context,
	...
	var resource IotDpsResource
	err := ctx.ReadResource("azure-nextgen:devices/v20180122:IotDpsResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
