...
// Private endpoint connections created on this IotHub
func (o IotDpsPropertiesDescriptionInvokeResponseOutput) PrivateEndpointConnections() PrivateEndpointConnectionInvokeResponseArrayOutput {
	return o.ApplyT(func(v IotDpsPropertiesDescriptionInvokeResponse) []PrivateEndpointConnectionInvokeResponse {
		return v.PrivateEndpointConnections
...
// Whether requests from Public Network are allowed
func (o IotDpsPropertiesDescriptionInvokeResponseOutput) PublicNetworkAccess() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IotDpsPropertiesDescriptionInvokeResponse) *string { return v.PublicNetworkAccess }).(pulumi.StringPtrOutput)
}
...
type IotHubPropertiesInvokeResponse struct {
	...
	MinTlsVersion *string `pulumi:"minTlsVersion"`
	// Network Rule Set Properties of IotHub
	NetworkRuleSets *NetworkRuleSetPropertiesInvokeResponse `pulumi:"networkRuleSets"`
	// Private endpoint connections created on this IotHub
	PrivateEndpointConnections []PrivateEndpointConnectionInvokeResponse `pulumi:"privateEndpointConnections"`
...
type IotHubPropertiesInvokeResponseArgs struct {
	...
	MinTlsVersion pulumi.StringPtrInput `pulumi:"minTlsVersion"`
	// Network Rule Set Properties of IotHub
	NetworkRuleSets NetworkRuleSetPropertiesInvokeResponsePtrInput `pulumi:"networkRuleSets"`
	// Private endpoint connections created on this IotHub
	PrivateEndpointConnections PrivateEndpointConnectionInvokeResponseArrayInput `pulumi:"privateEndpointConnections"`
	// The provisioning state.
...
// Network Rule Set Properties of IotHub
func (o IotHubPropertiesInvokeResponseOutput) NetworkRuleSets() NetworkRuleSetPropertiesInvokeResponsePtrOutput {
	return o.ApplyT(func(v IotHubPropertiesInvokeResponse) *NetworkRuleSetPropertiesInvokeResponse {
		return v.NetworkRuleSets
	}).(NetworkRuleSetPropertiesInvokeResponsePtrOutput)
}
...
// IP Rule to be applied as part of Network Rule Set
type NetworkRuleSetIpRuleInvokeResponse struct {
	// IP Filter Action
	Action *string `pulumi:"action"`
	// Name of the IP filter rule.
	FilterName string `pulumi:"filterName"`
...
// NetworkRuleSetIpRuleInvokeResponseInput is an input type that accepts NetworkRuleSetIpRuleInvokeResponseArgs and NetworkRuleSetIpRuleInvokeResponseOutput values.
// You can construct a concrete instance of `NetworkRuleSetIpRuleInvokeResponseInput` via:
//
//          NetworkRuleSetIpRuleInvokeResponseArgs{...}
type NetworkRuleSetIpRuleInvokeResponseInput interface {
	pulumi.Input

	ToNetworkRuleSetIpRuleInvokeResponseOutput() NetworkRuleSetIpRuleInvokeResponseOutput
	ToNetworkRuleSetIpRuleInvokeResponseOutputWithContext(context.Context) NetworkRuleSetIpRuleInvokeResponseOutput
}

// IP Rule to be applied as part of Network Rule Set
type NetworkRuleSetIpRuleInvokeResponseArgs struct {
	// IP Filter Action
	Action pulumi.StringPtrInput `pulumi:"action"`
	// Name of the IP filter rule.
	FilterName pulumi.StringInput `pulumi:"filterName"`
...
func (NetworkRuleSetIpRuleInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*NetworkRuleSetIpRuleInvokeResponse)(nil)).Elem()
}

func (i NetworkRuleSetIpRuleInvokeResponseArgs) ToNetworkRuleSetIpRuleInvokeResponseOutput() NetworkRuleSetIpRuleInvokeResponseOutput {
	return i.ToNetworkRuleSetIpRuleInvokeResponseOutputWithContext(context.Background())
}

func (i NetworkRuleSetIpRuleInvokeResponseArgs) ToNetworkRuleSetIpRuleInvokeResponseOutputWithContext(ctx context.Context) NetworkRuleSetIpRuleInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NetworkRuleSetIpRuleInvokeResponseOutput)
}

// NetworkRuleSetIpRuleInvokeResponseArrayInput is an input type that accepts NetworkRuleSetIpRuleInvokeResponseArray and NetworkRuleSetIpRuleInvokeResponseArrayOutput values.
// You can construct a concrete instance of `NetworkRuleSetIpRuleInvokeResponseArrayInput` via:
//
//          NetworkRuleSetIpRuleInvokeResponseArray{ NetworkRuleSetIpRuleInvokeResponseArgs{...} }
type NetworkRuleSetIpRuleInvokeResponseArrayInput interface {
	pulumi.Input

	ToNetworkRuleSetIpRuleInvokeResponseArrayOutput() NetworkRuleSetIpRuleInvokeResponseArrayOutput
	ToNetworkRuleSetIpRuleInvokeResponseArrayOutputWithContext(context.Context) NetworkRuleSetIpRuleInvokeResponseArrayOutput
}

type NetworkRuleSetIpRuleInvokeResponseArray []NetworkRuleSetIpRuleInvokeResponseInput

func (NetworkRuleSetIpRuleInvokeResponseArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]NetworkRuleSetIpRuleInvokeResponse)(nil)).Elem()
}

func (i NetworkRuleSetIpRuleInvokeResponseArray) ToNetworkRuleSetIpRuleInvokeResponseArrayOutput() NetworkRuleSetIpRuleInvokeResponseArrayOutput {
	return i.ToNetworkRuleSetIpRuleInvokeResponseArrayOutputWithContext(context.Background())
}

func (i NetworkRuleSetIpRuleInvokeResponseArray) ToNetworkRuleSetIpRuleInvokeResponseArrayOutputWithContext(ctx context.Context) NetworkRuleSetIpRuleInvokeResponseArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NetworkRuleSetIpRuleInvokeResponseArrayOutput)
}

// IP Rule to be applied as part of Network Rule Set
type NetworkRuleSetIpRuleInvokeResponseOutput struct{ *pulumi.OutputState }

func (NetworkRuleSetIpRuleInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*NetworkRuleSetIpRuleInvokeResponse)(nil)).Elem()
}

func (o NetworkRuleSetIpRuleInvokeResponseOutput) ToNetworkRuleSetIpRuleInvokeResponseOutput() NetworkRuleSetIpRuleInvokeResponseOutput {
	return o
}

func (o NetworkRuleSetIpRuleInvokeResponseOutput) ToNetworkRuleSetIpRuleInvokeResponseOutputWithContext(ctx context.Context) NetworkRuleSetIpRuleInvokeResponseOutput {
	return o
}

// IP Filter Action
func (o NetworkRuleSetIpRuleInvokeResponseOutput) Action() pulumi.StringPtrOutput {
	return o.ApplyT(func(v NetworkRuleSetIpRuleInvokeResponse) *string { return v.Action }).(pulumi.StringPtrOutput)
}

// Name of the IP filter rule.
func (o NetworkRuleSetIpRuleInvokeResponseOutput) FilterName() pulumi.StringOutput {
	return o.ApplyT(func(v NetworkRuleSetIpRuleInvokeResponse) string { return v.FilterName }).(pulumi.StringOutput)
}

// A string that contains the IP address range in CIDR notation for the rule.
func (o NetworkRuleSetIpRuleInvokeResponseOutput) IpMask() pulumi.StringOutput {
	return o.ApplyT(func(v NetworkRuleSetIpRuleInvokeResponse) string { return v.IpMask }).(pulumi.StringOutput)
}

type NetworkRuleSetIpRuleInvokeResponseArrayOutput struct{ *pulumi.OutputState }

func (NetworkRuleSetIpRuleInvokeResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]NetworkRuleSetIpRuleInvokeResponse)(nil)).Elem()
}

func (o NetworkRuleSetIpRuleInvokeResponseArrayOutput) ToNetworkRuleSetIpRuleInvokeResponseArrayOutput() NetworkRuleSetIpRuleInvokeResponseArrayOutput {
	return o
}

func (o NetworkRuleSetIpRuleInvokeResponseArrayOutput) ToNetworkRuleSetIpRuleInvokeResponseArrayOutputWithContext(ctx context.Context) NetworkRuleSetIpRuleInvokeResponseArrayOutput {
	return o
}

func (o NetworkRuleSetIpRuleInvokeResponseArrayOutput) Index(i pulumi.IntInput) NetworkRuleSetIpRuleInvokeResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) NetworkRuleSetIpRuleInvokeResponse {
		return vs[0].([]NetworkRuleSetIpRuleInvokeResponse)[vs[1].(int)]
	}).(NetworkRuleSetIpRuleInvokeResponseOutput)
}
...
// Network Rule Set Properties of IotHub
type NetworkRuleSetPropertiesInvokeResponse struct {
	// If True, then Network Rule Set is also applied to BuiltIn EventHub EndPoint of IotHub
	ApplyToBuiltInEventHubEndpoint bool `pulumi:"applyToBuiltInEventHubEndpoint"`
	// Default Action for Network Rule Set
	DefaultAction *string `pulumi:"defaultAction"`
	// List of IP Rules
	IpRules []NetworkRuleSetIpRuleInvokeResponse `pulumi:"ipRules"`
}

// NetworkRuleSetPropertiesInvokeResponseInput is an input type that accepts NetworkRuleSetPropertiesInvokeResponseArgs and NetworkRuleSetPropertiesInvokeResponseOutput values.
// You can construct a concrete instance of `NetworkRuleSetPropertiesInvokeResponseInput` via:
//
//          NetworkRuleSetPropertiesInvokeResponseArgs{...}
type NetworkRuleSetPropertiesInvokeResponseInput interface {
	pulumi.Input

	ToNetworkRuleSetPropertiesInvokeResponseOutput() NetworkRuleSetPropertiesInvokeResponseOutput
	ToNetworkRuleSetPropertiesInvokeResponseOutputWithContext(context.Context) NetworkRuleSetPropertiesInvokeResponseOutput
}

// Network Rule Set Properties of IotHub
type NetworkRuleSetPropertiesInvokeResponseArgs struct {
	// If True, then Network Rule Set is also applied to BuiltIn EventHub EndPoint of IotHub
	ApplyToBuiltInEventHubEndpoint pulumi.BoolInput `pulumi:"applyToBuiltInEventHubEndpoint"`
	// Default Action for Network Rule Set
	DefaultAction pulumi.StringPtrInput `pulumi:"defaultAction"`
	// List of IP Rules
	IpRules NetworkRuleSetIpRuleInvokeResponseArrayInput `pulumi:"ipRules"`
}

func (NetworkRuleSetPropertiesInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*NetworkRuleSetPropertiesInvokeResponse)(nil)).Elem()
}

func (i NetworkRuleSetPropertiesInvokeResponseArgs) ToNetworkRuleSetPropertiesInvokeResponseOutput() NetworkRuleSetPropertiesInvokeResponseOutput {
	return i.ToNetworkRuleSetPropertiesInvokeResponseOutputWithContext(context.Background())
}

func (i NetworkRuleSetPropertiesInvokeResponseArgs) ToNetworkRuleSetPropertiesInvokeResponseOutputWithContext(ctx context.Context) NetworkRuleSetPropertiesInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NetworkRuleSetPropertiesInvokeResponseOutput)
}

func (i NetworkRuleSetPropertiesInvokeResponseArgs) ToNetworkRuleSetPropertiesInvokeResponsePtrOutput() NetworkRuleSetPropertiesInvokeResponsePtrOutput {
	return i.ToNetworkRuleSetPropertiesInvokeResponsePtrOutputWithContext(context.Background())
}

func (i NetworkRuleSetPropertiesInvokeResponseArgs) ToNetworkRuleSetPropertiesInvokeResponsePtrOutputWithContext(ctx context.Context) NetworkRuleSetPropertiesInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NetworkRuleSetPropertiesInvokeResponseOutput).ToNetworkRuleSetPropertiesInvokeResponsePtrOutputWithContext(ctx)
}

// NetworkRuleSetPropertiesInvokeResponsePtrInput is an input type that accepts NetworkRuleSetPropertiesInvokeResponseArgs, NetworkRuleSetPropertiesInvokeResponsePtr and NetworkRuleSetPropertiesInvokeResponsePtrOutput values.
// You can construct a concrete instance of `NetworkRuleSetPropertiesInvokeResponsePtrInput` via:
//
//          NetworkRuleSetPropertiesInvokeResponseArgs{...}
//
//  or:
//
//          nil
type NetworkRuleSetPropertiesInvokeResponsePtrInput interface {
	pulumi.Input

	ToNetworkRuleSetPropertiesInvokeResponsePtrOutput() NetworkRuleSetPropertiesInvokeResponsePtrOutput
	ToNetworkRuleSetPropertiesInvokeResponsePtrOutputWithContext(context.Context) NetworkRuleSetPropertiesInvokeResponsePtrOutput
}

type networkRuleSetPropertiesInvokeResponsePtrType NetworkRuleSetPropertiesInvokeResponseArgs

func NetworkRuleSetPropertiesInvokeResponsePtr(v *NetworkRuleSetPropertiesInvokeResponseArgs) NetworkRuleSetPropertiesInvokeResponsePtrInput {
	return (*networkRuleSetPropertiesInvokeResponsePtrType)(v)
}

func (*networkRuleSetPropertiesInvokeResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**NetworkRuleSetPropertiesInvokeResponse)(nil)).Elem()
}

func (i *networkRuleSetPropertiesInvokeResponsePtrType) ToNetworkRuleSetPropertiesInvokeResponsePtrOutput() NetworkRuleSetPropertiesInvokeResponsePtrOutput {
	return i.ToNetworkRuleSetPropertiesInvokeResponsePtrOutputWithContext(context.Background())
}

func (i *networkRuleSetPropertiesInvokeResponsePtrType) ToNetworkRuleSetPropertiesInvokeResponsePtrOutputWithContext(ctx context.Context) NetworkRuleSetPropertiesInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NetworkRuleSetPropertiesInvokeResponsePtrOutput)
}

// Network Rule Set Properties of IotHub
type NetworkRuleSetPropertiesInvokeResponseOutput struct{ *pulumi.OutputState }

func (NetworkRuleSetPropertiesInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*NetworkRuleSetPropertiesInvokeResponse)(nil)).Elem()
}

func (o NetworkRuleSetPropertiesInvokeResponseOutput) ToNetworkRuleSetPropertiesInvokeResponseOutput() NetworkRuleSetPropertiesInvokeResponseOutput {
	return o
}

func (o NetworkRuleSetPropertiesInvokeResponseOutput) ToNetworkRuleSetPropertiesInvokeResponseOutputWithContext(ctx context.Context) NetworkRuleSetPropertiesInvokeResponseOutput {
	return o
}

func (o NetworkRuleSetPropertiesInvokeResponseOutput) ToNetworkRuleSetPropertiesInvokeResponsePtrOutput() NetworkRuleSetPropertiesInvokeResponsePtrOutput {
	return o.ToNetworkRuleSetPropertiesInvokeResponsePtrOutputWithContext(context.Background())
}

func (o NetworkRuleSetPropertiesInvokeResponseOutput) ToNetworkRuleSetPropertiesInvokeResponsePtrOutputWithContext(ctx context.Context) NetworkRuleSetPropertiesInvokeResponsePtrOutput {
	return o.ApplyT(func(v NetworkRuleSetPropertiesInvokeResponse) *NetworkRuleSetPropertiesInvokeResponse {
		return &v
	}).(NetworkRuleSetPropertiesInvokeResponsePtrOutput)
}

// If True, then Network Rule Set is also applied to BuiltIn EventHub EndPoint of IotHub
func (o NetworkRuleSetPropertiesInvokeResponseOutput) ApplyToBuiltInEventHubEndpoint() pulumi.BoolOutput {
	return o.ApplyT(func(v NetworkRuleSetPropertiesInvokeResponse) bool { return v.ApplyToBuiltInEventHubEndpoint }).(pulumi.BoolOutput)
}

// Default Action for Network Rule Set
func (o NetworkRuleSetPropertiesInvokeResponseOutput) DefaultAction() pulumi.StringPtrOutput {
	return o.ApplyT(func(v NetworkRuleSetPropertiesInvokeResponse) *string { return v.DefaultAction }).(pulumi.StringPtrOutput)
}

// List of IP Rules
func (o NetworkRuleSetPropertiesInvokeResponseOutput) IpRules() NetworkRuleSetIpRuleInvokeResponseArrayOutput {
	return o.ApplyT(func(v NetworkRuleSetPropertiesInvokeResponse) []NetworkRuleSetIpRuleInvokeResponse { return v.IpRules }).(NetworkRuleSetIpRuleInvokeResponseArrayOutput)
}

type NetworkRuleSetPropertiesInvokeResponsePtrOutput struct{ *pulumi.OutputState }

func (NetworkRuleSetPropertiesInvokeResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**NetworkRuleSetPropertiesInvokeResponse)(nil)).Elem()
}

func (o NetworkRuleSetPropertiesInvokeResponsePtrOutput) ToNetworkRuleSetPropertiesInvokeResponsePtrOutput() NetworkRuleSetPropertiesInvokeResponsePtrOutput {
	return o
}

func (o NetworkRuleSetPropertiesInvokeResponsePtrOutput) ToNetworkRuleSetPropertiesInvokeResponsePtrOutputWithContext(ctx context.Context) NetworkRuleSetPropertiesInvokeResponsePtrOutput {
	return o
}

func (o NetworkRuleSetPropertiesInvokeResponsePtrOutput) Elem() NetworkRuleSetPropertiesInvokeResponseOutput {
	return o.ApplyT(func(v *NetworkRuleSetPropertiesInvokeResponse) NetworkRuleSetPropertiesInvokeResponse { return *v }).(NetworkRuleSetPropertiesInvokeResponseOutput)
}

// If True, then Network Rule Set is also applied to BuiltIn EventHub EndPoint of IotHub
func (o NetworkRuleSetPropertiesInvokeResponsePtrOutput) ApplyToBuiltInEventHubEndpoint() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *NetworkRuleSetPropertiesInvokeResponse) *bool {
		if v == nil {
			return nil
		}
		return &v.ApplyToBuiltInEventHubEndpoint
...
// Default Action for Network Rule Set
func (o NetworkRuleSetPropertiesInvokeResponsePtrOutput) DefaultAction() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NetworkRuleSetPropertiesInvokeResponse) *string {
		if v == nil {
			return nil
		}
		return v.DefaultAction
...
// List of IP Rules
func (o NetworkRuleSetPropertiesInvokeResponsePtrOutput) IpRules() NetworkRuleSetIpRuleInvokeResponseArrayOutput {
	return o.ApplyT(func(v *NetworkRuleSetPropertiesInvokeResponse) []NetworkRuleSetIpRuleInvokeResponse {
		if v == nil {
			return nil
		}
		return v.IpRules
	}).(NetworkRuleSetIpRuleInvokeResponseArrayOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(NetworkRuleSetIpRuleInvokeResponseOutput{})
	pulumi.RegisterOutputType(NetworkRuleSetIpRuleInvokeResponseArrayOutput{})
	...
	pulumi.RegisterOutputType(NetworkRuleSetPropertiesInvokeResponseOutput{})
	pulumi.RegisterOutputType(NetworkRuleSetPropertiesInvokeResponsePtrOutput{})
