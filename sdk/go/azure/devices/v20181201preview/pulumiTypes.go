...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubLocationDescriptionInput)(nil)).Elem(), IotHubLocationDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubLocationDescriptionArrayInput)(nil)).Elem(), IotHubLocationDescriptionArray{})
