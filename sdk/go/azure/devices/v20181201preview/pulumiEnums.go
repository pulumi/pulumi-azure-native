...
// IotHubReplicaRoleTypeInput is an input type that accepts IotHubReplicaRoleTypeArgs and IotHubReplicaRoleTypeOutput values.
// You can construct a concrete instance of `IotHubReplicaRoleTypeInput` via:
//
//          IotHubReplicaRoleTypeArgs{...}
