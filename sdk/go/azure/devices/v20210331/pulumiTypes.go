...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ArmIdentityInput)(nil)).Elem(), ArmIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmIdentityPtrInput)(nil)).Elem(), ArmIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmIdentityResponseInput)(nil)).Elem(), ArmIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmIdentityResponsePtrInput)(nil)).Elem(), ArmIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmUserIdentityResponseInput)(nil)).Elem(), ArmUserIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ArmUserIdentityResponseMapInput)(nil)).Elem(), ArmUserIdentityResponseMap{})
