...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EnrichmentPropertiesInput)(nil)).Elem(), EnrichmentPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnrichmentPropertiesArrayInput)(nil)).Elem(), EnrichmentPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnrichmentPropertiesResponseInput)(nil)).Elem(), EnrichmentPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EnrichmentPropertiesResponseArrayInput)(nil)).Elem(), EnrichmentPropertiesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventHubConsumerGroupNameInput)(nil)).Elem(), EventHubConsumerGroupNameArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventHubConsumerGroupNamePtrInput)(nil)).Elem(), EventHubConsumerGroupNameArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubLocationDescriptionResponseInput)(nil)).Elem(), IotHubLocationDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubLocationDescriptionResponseArrayInput)(nil)).Elem(), IotHubLocationDescriptionResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRuleSetIpRuleInput)(nil)).Elem(), NetworkRuleSetIpRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRuleSetIpRuleArrayInput)(nil)).Elem(), NetworkRuleSetIpRuleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRuleSetIpRuleResponseInput)(nil)).Elem(), NetworkRuleSetIpRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRuleSetIpRuleResponseArrayInput)(nil)).Elem(), NetworkRuleSetIpRuleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRuleSetPropertiesInput)(nil)).Elem(), NetworkRuleSetPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRuleSetPropertiesPtrInput)(nil)).Elem(), NetworkRuleSetPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRuleSetPropertiesResponseInput)(nil)).Elem(), NetworkRuleSetPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRuleSetPropertiesResponsePtrInput)(nil)).Elem(), NetworkRuleSetPropertiesResponseArgs{})
