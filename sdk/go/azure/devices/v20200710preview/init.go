...
func (m *module) Construct(ctx *pulumi.Context, name, typ, urn string) (r pulumi.Resource, err error) {
	switch typ {
	case "azure-nextgen:devices/v20200710preview:Certificate":
		r, err = NewCertificate(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:devices/v20200710preview:IotHubResource":
		r, err = NewIotHubResource(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:devices/v20200710preview:IotHubResourceEventHubConsumerGroup":
		r, err = NewIotHubResourceEventHubConsumerGroup(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:devices/v20200710preview:PrivateEndpointConnection":
