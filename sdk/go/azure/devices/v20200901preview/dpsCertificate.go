...
func NewDpsCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:devices/v20200901preview:DpsCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDpsCertificate(ctx *pulumi.Context,
	...
	var resource DpsCertificate
	err := ctx.ReadResource("azure-nextgen:devices/v20200901preview:DpsCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
