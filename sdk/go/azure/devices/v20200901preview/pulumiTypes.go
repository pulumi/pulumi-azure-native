...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionKeyIdentityInput)(nil)).Elem(), EncryptionKeyIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionKeyIdentityPtrInput)(nil)).Elem(), EncryptionKeyIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionKeyIdentityResponseInput)(nil)).Elem(), EncryptionKeyIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionKeyIdentityResponsePtrInput)(nil)).Elem(), EncryptionKeyIdentityResponseArgs{})
