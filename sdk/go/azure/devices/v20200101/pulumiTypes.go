...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IotDpsPropertiesDescriptionInput)(nil)).Elem(), IotDpsPropertiesDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotDpsPropertiesDescriptionPtrInput)(nil)).Elem(), IotDpsPropertiesDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotDpsPropertiesDescriptionResponseInput)(nil)).Elem(), IotDpsPropertiesDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotDpsPropertiesDescriptionResponsePtrInput)(nil)).Elem(), IotDpsPropertiesDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotDpsSkuInfoInput)(nil)).Elem(), IotDpsSkuInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotDpsSkuInfoPtrInput)(nil)).Elem(), IotDpsSkuInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotDpsSkuInfoResponseInput)(nil)).Elem(), IotDpsSkuInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotDpsSkuInfoResponsePtrInput)(nil)).Elem(), IotDpsSkuInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubDefinitionDescriptionInput)(nil)).Elem(), IotHubDefinitionDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubDefinitionDescriptionArrayInput)(nil)).Elem(), IotHubDefinitionDescriptionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubDefinitionDescriptionResponseInput)(nil)).Elem(), IotHubDefinitionDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IotHubDefinitionDescriptionResponseArrayInput)(nil)).Elem(), IotHubDefinitionDescriptionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionInput)(nil)).Elem(), SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionArrayInput)(nil)).Elem(), SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionResponseInput)(nil)).Elem(), SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionResponseArrayInput)(nil)).Elem(), SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetIpFilterRuleInput)(nil)).Elem(), TargetIpFilterRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetIpFilterRuleArrayInput)(nil)).Elem(), TargetIpFilterRuleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetIpFilterRuleResponseInput)(nil)).Elem(), TargetIpFilterRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetIpFilterRuleResponseArrayInput)(nil)).Elem(), TargetIpFilterRuleResponseArray{})
