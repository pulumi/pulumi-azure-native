...
// GeoRedundantBackupEnumInput is an input type that accepts GeoRedundantBackupEnumArgs and GeoRedundantBackupEnumOutput values.
// You can construct a concrete instance of `GeoRedundantBackupEnumInput` via:
//
