...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GeoRedundantBackupOptionInput)(nil)).Elem(), GeoRedundantBackupOption("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*GeoRedundantBackupOptionPtrInput)(nil)).Elem(), GeoRedundantBackupOption("Enabled"))
