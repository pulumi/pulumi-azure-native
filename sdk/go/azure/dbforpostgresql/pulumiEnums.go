...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServerSecurityAlertPolicyStateEnumInput)(nil)).Elem(), ServerSecurityAlertPolicyStateEnum("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServerSecurityAlertPolicyStateEnumPtrInput)(nil)).Elem(), ServerSecurityAlertPolicyStateEnum("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServerVersionInput)(nil)).Elem(), ServerVersion("9.5"))
	pulumi.RegisterInputType(reflect.TypeOf((*ServerVersionPtrInput)(nil)).Elem(), ServerVersion("9.5"))
