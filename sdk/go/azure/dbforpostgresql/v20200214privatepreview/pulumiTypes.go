...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPropertiesDelegatedSubnetArgumentsInput)(nil)).Elem(), ServerPropertiesDelegatedSubnetArgumentsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPropertiesDelegatedSubnetArgumentsPtrInput)(nil)).Elem(), ServerPropertiesDelegatedSubnetArgumentsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPropertiesPrivateDnsZoneArgumentsInput)(nil)).Elem(), ServerPropertiesPrivateDnsZoneArgumentsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPropertiesPrivateDnsZoneArgumentsPtrInput)(nil)).Elem(), ServerPropertiesPrivateDnsZoneArgumentsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPropertiesResponseDelegatedSubnetArgumentsInput)(nil)).Elem(), ServerPropertiesResponseDelegatedSubnetArgumentsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPropertiesResponseDelegatedSubnetArgumentsPtrInput)(nil)).Elem(), ServerPropertiesResponseDelegatedSubnetArgumentsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPropertiesResponsePrivateDnsZoneArgumentsInput)(nil)).Elem(), ServerPropertiesResponsePrivateDnsZoneArgumentsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerPropertiesResponsePrivateDnsZoneArgumentsPtrInput)(nil)).Elem(), ServerPropertiesResponsePrivateDnsZoneArgumentsArgs{})
