...
func NewServerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:dbforpostgresql:ServerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerGroup(ctx *pulumi.Context,
	...
	var resource ServerGroup
	err := ctx.ReadResource("azure-nextgen:dbforpostgresql:ServerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
