...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AADAppInput)(nil)).Elem(), AADAppArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AADAppPtrInput)(nil)).Elem(), AADAppArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AADAppResponseInput)(nil)).Elem(), AADAppResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AADAppResponsePtrInput)(nil)).Elem(), AADAppResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdminCredentialsInput)(nil)).Elem(), AdminCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdminCredentialsPtrInput)(nil)).Elem(), AdminCredentialsArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DBServerMetadataResponseInput)(nil)).Elem(), DBServerMetadataResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DBServerMetadataResponsePtrInput)(nil)).Elem(), DBServerMetadataResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationResourceGroupInput)(nil)).Elem(), MigrationResourceGroupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationResourceGroupPtrInput)(nil)).Elem(), MigrationResourceGroupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationResourceGroupResponseInput)(nil)).Elem(), MigrationResourceGroupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationResourceGroupResponsePtrInput)(nil)).Elem(), MigrationResourceGroupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationSecretParametersInput)(nil)).Elem(), MigrationSecretParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationSecretParametersPtrInput)(nil)).Elem(), MigrationSecretParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationSecretParametersResponseInput)(nil)).Elem(), MigrationSecretParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationSecretParametersResponsePtrInput)(nil)).Elem(), MigrationSecretParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationStatusResponseInput)(nil)).Elem(), MigrationStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationStatusResponsePtrInput)(nil)).Elem(), MigrationStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationSubStateDetailsResponseInput)(nil)).Elem(), MigrationSubStateDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationSubStateDetailsResponsePtrInput)(nil)).Elem(), MigrationSubStateDetailsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServerSkuResponseInput)(nil)).Elem(), ServerSkuResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerSkuResponsePtrInput)(nil)).Elem(), ServerSkuResponseArgs{})
