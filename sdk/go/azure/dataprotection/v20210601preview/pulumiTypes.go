...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AbsoluteDeleteOptionInput)(nil)).Elem(), AbsoluteDeleteOptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AbsoluteDeleteOptionResponseInput)(nil)).Elem(), AbsoluteDeleteOptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdhocBasedTaggingCriteriaInput)(nil)).Elem(), AdhocBasedTaggingCriteriaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdhocBasedTaggingCriteriaResponseInput)(nil)).Elem(), AdhocBasedTaggingCriteriaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdhocBasedTriggerContextInput)(nil)).Elem(), AdhocBasedTriggerContextArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdhocBasedTriggerContextResponseInput)(nil)).Elem(), AdhocBasedTriggerContextResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBackupParamsInput)(nil)).Elem(), AzureBackupParamsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBackupParamsPtrInput)(nil)).Elem(), AzureBackupParamsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBackupParamsResponseInput)(nil)).Elem(), AzureBackupParamsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBackupParamsResponsePtrInput)(nil)).Elem(), AzureBackupParamsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBackupRuleInput)(nil)).Elem(), AzureBackupRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureBackupRuleResponseInput)(nil)).Elem(), AzureBackupRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureOperationalStoreParametersInput)(nil)).Elem(), AzureOperationalStoreParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureOperationalStoreParametersArrayInput)(nil)).Elem(), AzureOperationalStoreParametersArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureOperationalStoreParametersResponseInput)(nil)).Elem(), AzureOperationalStoreParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureOperationalStoreParametersResponseArrayInput)(nil)).Elem(), AzureOperationalStoreParametersResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureRetentionRuleInput)(nil)).Elem(), AzureRetentionRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureRetentionRuleResponseInput)(nil)).Elem(), AzureRetentionRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupInstanceTypeInput)(nil)).Elem(), BackupInstanceTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupInstanceTypePtrInput)(nil)).Elem(), BackupInstanceTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupInstanceResponseInput)(nil)).Elem(), BackupInstanceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupInstanceResponsePtrInput)(nil)).Elem(), BackupInstanceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPolicyTypeInput)(nil)).Elem(), BackupPolicyTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPolicyTypePtrInput)(nil)).Elem(), BackupPolicyTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPolicyResponseInput)(nil)).Elem(), BackupPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupPolicyResponsePtrInput)(nil)).Elem(), BackupPolicyResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BackupVaultTypeInput)(nil)).Elem(), BackupVaultTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupVaultTypePtrInput)(nil)).Elem(), BackupVaultTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupVaultResponseInput)(nil)).Elem(), BackupVaultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BackupVaultResponsePtrInput)(nil)).Elem(), BackupVaultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CopyOnExpiryOptionInput)(nil)).Elem(), CopyOnExpiryOptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CopyOnExpiryOptionResponseInput)(nil)).Elem(), CopyOnExpiryOptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomCopyOptionInput)(nil)).Elem(), CustomCopyOptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomCopyOptionResponseInput)(nil)).Elem(), CustomCopyOptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataStoreInfoBaseInput)(nil)).Elem(), DataStoreInfoBaseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataStoreInfoBaseResponseInput)(nil)).Elem(), DataStoreInfoBaseResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasourceInput)(nil)).Elem(), DatasourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasourcePtrInput)(nil)).Elem(), DatasourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasourceResponseInput)(nil)).Elem(), DatasourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasourceResponsePtrInput)(nil)).Elem(), DatasourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasourceSetInput)(nil)).Elem(), DatasourceSetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasourceSetPtrInput)(nil)).Elem(), DatasourceSetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasourceSetResponseInput)(nil)).Elem(), DatasourceSetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatasourceSetResponsePtrInput)(nil)).Elem(), DatasourceSetResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DppIdentityDetailsInput)(nil)).Elem(), DppIdentityDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DppIdentityDetailsPtrInput)(nil)).Elem(), DppIdentityDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DppIdentityDetailsResponseInput)(nil)).Elem(), DppIdentityDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DppIdentityDetailsResponsePtrInput)(nil)).Elem(), DppIdentityDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImmediateCopyOptionInput)(nil)).Elem(), ImmediateCopyOptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImmediateCopyOptionResponseInput)(nil)).Elem(), ImmediateCopyOptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InnerErrorResponseInput)(nil)).Elem(), InnerErrorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InnerErrorResponsePtrInput)(nil)).Elem(), InnerErrorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyInfoInput)(nil)).Elem(), PolicyInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyInfoPtrInput)(nil)).Elem(), PolicyInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyInfoResponseInput)(nil)).Elem(), PolicyInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyInfoResponsePtrInput)(nil)).Elem(), PolicyInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyParametersInput)(nil)).Elem(), PolicyParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyParametersPtrInput)(nil)).Elem(), PolicyParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyParametersResponseInput)(nil)).Elem(), PolicyParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyParametersResponsePtrInput)(nil)).Elem(), PolicyParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProtectionStatusDetailsResponseInput)(nil)).Elem(), ProtectionStatusDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProtectionStatusDetailsResponsePtrInput)(nil)).Elem(), ProtectionStatusDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RetentionTagInput)(nil)).Elem(), RetentionTagArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RetentionTagPtrInput)(nil)).Elem(), RetentionTagArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RetentionTagResponseInput)(nil)).Elem(), RetentionTagResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RetentionTagResponsePtrInput)(nil)).Elem(), RetentionTagResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleBasedBackupCriteriaInput)(nil)).Elem(), ScheduleBasedBackupCriteriaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleBasedBackupCriteriaArrayInput)(nil)).Elem(), ScheduleBasedBackupCriteriaArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleBasedBackupCriteriaResponseInput)(nil)).Elem(), ScheduleBasedBackupCriteriaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleBasedBackupCriteriaResponseArrayInput)(nil)).Elem(), ScheduleBasedBackupCriteriaResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleBasedTriggerContextInput)(nil)).Elem(), ScheduleBasedTriggerContextArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleBasedTriggerContextResponseInput)(nil)).Elem(), ScheduleBasedTriggerContextResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretStoreBasedAuthCredentialsInput)(nil)).Elem(), SecretStoreBasedAuthCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretStoreBasedAuthCredentialsPtrInput)(nil)).Elem(), SecretStoreBasedAuthCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretStoreBasedAuthCredentialsResponseInput)(nil)).Elem(), SecretStoreBasedAuthCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretStoreBasedAuthCredentialsResponsePtrInput)(nil)).Elem(), SecretStoreBasedAuthCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretStoreResourceInput)(nil)).Elem(), SecretStoreResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretStoreResourcePtrInput)(nil)).Elem(), SecretStoreResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretStoreResourceResponseInput)(nil)).Elem(), SecretStoreResourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretStoreResourceResponsePtrInput)(nil)).Elem(), SecretStoreResourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceLifeCycleInput)(nil)).Elem(), SourceLifeCycleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceLifeCycleArrayInput)(nil)).Elem(), SourceLifeCycleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceLifeCycleResponseInput)(nil)).Elem(), SourceLifeCycleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SourceLifeCycleResponseArrayInput)(nil)).Elem(), SourceLifeCycleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageSettingInput)(nil)).Elem(), StorageSettingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageSettingArrayInput)(nil)).Elem(), StorageSettingArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageSettingResponseInput)(nil)).Elem(), StorageSettingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageSettingResponseArrayInput)(nil)).Elem(), StorageSettingResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TaggingCriteriaInput)(nil)).Elem(), TaggingCriteriaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TaggingCriteriaArrayInput)(nil)).Elem(), TaggingCriteriaArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TaggingCriteriaResponseInput)(nil)).Elem(), TaggingCriteriaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TaggingCriteriaResponseArrayInput)(nil)).Elem(), TaggingCriteriaResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetCopySettingInput)(nil)).Elem(), TargetCopySettingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetCopySettingArrayInput)(nil)).Elem(), TargetCopySettingArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetCopySettingResponseInput)(nil)).Elem(), TargetCopySettingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetCopySettingResponseArrayInput)(nil)).Elem(), TargetCopySettingResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserFacingErrorResponseInput)(nil)).Elem(), UserFacingErrorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserFacingErrorResponsePtrInput)(nil)).Elem(), UserFacingErrorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserFacingErrorResponseArrayInput)(nil)).Elem(), UserFacingErrorResponseArray{})
