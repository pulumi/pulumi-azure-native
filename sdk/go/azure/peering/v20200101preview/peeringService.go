...
func NewPeeringService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:peering/v20200101preview:PeeringService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeeringService(ctx *pulumi.Context,
	...
	var resource PeeringService
	err := ctx.ReadResource("azure-nextgen:peering/v20200101preview:PeeringService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
