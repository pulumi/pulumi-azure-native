...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LogAnalyticsWorkspacePropertiesResponseInput)(nil)).Elem(), LogAnalyticsWorkspacePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LogAnalyticsWorkspacePropertiesResponsePtrInput)(nil)).Elem(), LogAnalyticsWorkspacePropertiesResponseArgs{})
