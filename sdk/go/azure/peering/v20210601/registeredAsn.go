...
func NewRegisteredAsn(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:peering/v20210601:RegisteredAsn"),
		},
		{
		...
		{
			Type: pulumi.String("azure-nextgen:peering/v20210101:RegisteredAsn"),
		},
	})
	opts = append(opts, aliases)
	var resource RegisteredAsn
	err := ctx.RegisterResource("azure-native:peering/v20210601:RegisteredAsn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegisteredAsn(ctx *pulumi.Context,
	...
	var resource RegisteredAsn
	err := ctx.ReadResource("azure-native:peering/v20210601:RegisteredAsn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*RegisteredAsnInput)(nil)).Elem(), &RegisteredAsn{})
