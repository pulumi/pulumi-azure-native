...
// The ID used within Microsoft's peering provisioning system to track the connection
func (o DirectConnectionInvokeResponseOutput) MicrosoftTrackingId() pulumi.StringOutput {
	return o.ApplyT(func(v DirectConnectionInvokeResponse) string { return v.MicrosoftTrackingId }).(pulumi.StringOutput)
}
