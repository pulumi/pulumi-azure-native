...
func (o ContactInfoResponseOutput) ToContactInfoResponsePtrOutputWithContext(ctx context.Context) ContactInfoResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ContactInfoResponse) *ContactInfoResponse {
		return &v
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ContactInfoPtrInput)(nil)).Elem(), ContactInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContactInfoResponseInput)(nil)).Elem(), ContactInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContactInfoResponsePtrInput)(nil)).Elem(), ContactInfoResponseArgs{})
