...
func NewPeerAsn(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:peering/v20190901preview:PeerAsn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeerAsn(ctx *pulumi.Context,
	...
	var resource PeerAsn
	err := ctx.ReadResource("azure-nextgen:peering/v20190901preview:PeerAsn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
