...
func (o LookupAccountResultOutput) HierarchicalQueueState() pulumi.StringOutput {
	return o.ApplyT(func(v LookupAccountResult) string { return v.HierarchicalQueueState }).(pulumi.StringOutput)
}
