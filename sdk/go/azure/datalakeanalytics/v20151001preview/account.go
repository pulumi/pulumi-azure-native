...
func NewAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datalakeanalytics/v20151001preview:Account", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccount(ctx *pulumi.Context,
	...
	var resource Account
	err := ctx.ReadResource("azure-native:datalakeanalytics/v20151001preview:Account", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o AccountOutput) HierarchicalQueueState() pulumi.StringOutput {
	return o.ApplyT(func(v *Account) pulumi.StringOutput { return v.HierarchicalQueueState }).(pulumi.StringOutput)
}
