...
func NewComputePolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:datalakeanalytics:ComputePolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputePolicy(ctx *pulumi.Context,
	...
	var resource ComputePolicy
	err := ctx.ReadResource("azure-nextgen:datalakeanalytics:ComputePolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
