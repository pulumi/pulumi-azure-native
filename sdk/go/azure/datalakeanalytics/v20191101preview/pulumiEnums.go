...
// AADObjectTypeInput is an input type that accepts AADObjectTypeArgs and AADObjectTypeOutput values.
// You can construct a concrete instance of `AADObjectTypeInput` via:
//
//          AADObjectTypeArgs{...}
