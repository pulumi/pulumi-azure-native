...
type DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueue struct {
	Root interface{} `pulumi:"root"`
}

// DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueInput is an input type that accepts DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueArgs and DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput values.
// You can construct a concrete instance of `DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueInput` via:
//
//          DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueArgs{...}
type DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueInput interface {
	pulumi.Input

	ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput() DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput
	ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutputWithContext(context.Context) DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput
}

// The hierarchical queue associated with this account.
type DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueArgs struct {
	Root pulumi.Input `pulumi:"root"`
}

func (DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueue)(nil)).Elem()
}

func (i DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueArgs) ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput() DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput {
	return i.ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutputWithContext(context.Background())
}

func (i DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueArgs) ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutputWithContext(ctx context.Context) DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput)
}

func (i DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueArgs) ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput() DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput {
	return i.ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutputWithContext(context.Background())
}

func (i DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueArgs) ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutputWithContext(ctx context.Context) DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput).ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutputWithContext(ctx)
}

// DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrInput is an input type that accepts DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueArgs, DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtr and DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput values.
// You can construct a concrete instance of `DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrInput` via:
//
//          DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueArgs{...}
//
//  or:
//
//          nil
type DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrInput interface {
	pulumi.Input

	ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput() DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput
	ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutputWithContext(context.Context) DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput
}

type dataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrType DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueArgs

func DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtr(v *DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueArgs) DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrInput {
	return (*dataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrType)(v)
}

func (*dataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueue)(nil)).Elem()
}

func (i *dataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrType) ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput() DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput {
	return i.ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutputWithContext(context.Background())
}

func (i *dataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrType) ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutputWithContext(ctx context.Context) DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput)
}

// The hierarchical queue associated with this account.
type DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput struct{ *pulumi.OutputState }

func (DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueue)(nil)).Elem()
}

func (o DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput) ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput() DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput {
	return o
}

func (o DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput) ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutputWithContext(ctx context.Context) DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput {
	return o
}

func (o DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput) ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput() DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput {
	return o.ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutputWithContext(context.Background())
}

func (o DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput) ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutputWithContext(ctx context.Context) DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput {
	return o.ApplyT(func(v DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueue) *DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueue {
		return &v
	}).(DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput)
}
func (o DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput) Root() pulumi.AnyOutput {
	return o.ApplyT(func(v DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueue) interface{} { return v.Root }).(pulumi.AnyOutput)
}

type DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput struct{ *pulumi.OutputState }

func (DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueue)(nil)).Elem()
}

func (o DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput) ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput() DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput {
	return o
}

func (o DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput) ToDataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutputWithContext(ctx context.Context) DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput {
	return o
}

func (o DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput) Elem() DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput {
	return o.ApplyT(func(v *DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueue) DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueue {
		return *v
	}).(DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput)
}

func (o DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput) Root() pulumi.AnyOutput {
	return o.ApplyT(func(v *DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueue) interface{} {
		if v == nil {
			return nil
		}
		return v.Root
...
func init() {
	...
	pulumi.RegisterOutputType(DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueueOutput{})
	pulumi.RegisterOutputType(DataLakeAnalyticsAccountPropertiesResponseHierarchicalQueuePtrOutput{})
