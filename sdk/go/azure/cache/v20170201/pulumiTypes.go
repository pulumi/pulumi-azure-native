...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RedisLinkedServerListResponseInput)(nil)).Elem(), RedisLinkedServerListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RedisLinkedServerListResponsePtrInput)(nil)).Elem(), RedisLinkedServerListResponseArgs{})
