...
func NewRedis(ctx *pulumi.Context,
	...
	var resource Redis
	err := ctx.RegisterResource("azure-nextgen:cache/v20170201:Redis", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedis(ctx *pulumi.Context,
	...
	var resource Redis
	err := ctx.ReadResource("azure-nextgen:cache/v20170201:Redis", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type RedisState struct {
	...
	// List of the linked servers associated with the cache
	LinkedServers RedisLinkedServerListResponsePtrInput
	// The geo-location where the resource lives
