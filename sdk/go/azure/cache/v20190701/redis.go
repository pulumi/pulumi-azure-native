...
func NewRedis(ctx *pulumi.Context,
	...
	var resource Redis
	err := ctx.RegisterResource("azure-nextgen:cache/v20190701:Redis", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedis(ctx *pulumi.Context,
	...
	var resource Redis
	err := ctx.ReadResource("azure-nextgen:cache/v20190701:Redis", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
