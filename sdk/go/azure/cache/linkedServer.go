...
func NewLinkedServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:cache:LinkedServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedServer(ctx *pulumi.Context,
	...
	var resource LinkedServer
	err := ctx.ReadResource("azure-nextgen:cache:LinkedServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
