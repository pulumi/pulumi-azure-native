...
func NewOperationByProviderRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:providerhub:OperationByProviderRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOperationByProviderRegistration(ctx *pulumi.Context,
	...
	var resource OperationByProviderRegistration
	err := ctx.ReadResource("azure-nextgen:providerhub:OperationByProviderRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
