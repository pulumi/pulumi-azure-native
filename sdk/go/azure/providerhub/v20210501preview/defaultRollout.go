...
func NewDefaultRollout(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-nextgen:providerhub/v20210901preview:DefaultRollout"),
		},
	})
	opts = append(opts, aliases)
	var resource DefaultRollout
	err := ctx.RegisterResource("azure-native:providerhub/v20210501preview:DefaultRollout", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefaultRollout(ctx *pulumi.Context,
	...
	var resource DefaultRollout
	err := ctx.ReadResource("azure-native:providerhub/v20210501preview:DefaultRollout", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*DefaultRolloutInput)(nil)).Elem(), &DefaultRollout{})
