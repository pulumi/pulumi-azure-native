...
func NewSkusNestedResourceTypeSecond(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:providerhub/v20210601preview:SkusNestedResourceTypeSecond"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:providerhub/v20210501preview:SkusNestedResourceTypeSecond", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSkusNestedResourceTypeSecond(ctx *pulumi.Context,
	...
	var resource SkusNestedResourceTypeSecond
	err := ctx.ReadResource("azure-native:providerhub/v20210501preview:SkusNestedResourceTypeSecond", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*SkusNestedResourceTypeSecondInput)(nil)).Elem(), &SkusNestedResourceTypeSecond{})
