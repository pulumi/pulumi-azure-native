...
func NewSkusNestedResourceTypeFirst(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:providerhub/v20201120:SkusNestedResourceTypeFirst", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSkusNestedResourceTypeFirst(ctx *pulumi.Context,
	...
	var resource SkusNestedResourceTypeFirst
	err := ctx.ReadResource("azure-native:providerhub/v20201120:SkusNestedResourceTypeFirst", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
