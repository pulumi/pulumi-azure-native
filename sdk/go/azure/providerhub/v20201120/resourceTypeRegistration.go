...
func NewResourceTypeRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:providerhub/v20201120:ResourceTypeRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceTypeRegistration(ctx *pulumi.Context,
	...
	var resource ResourceTypeRegistration
	err := ctx.ReadResource("azure-native:providerhub/v20201120:ResourceTypeRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
