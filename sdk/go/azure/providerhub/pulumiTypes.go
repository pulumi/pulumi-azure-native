...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OperationsDefinitionInput)(nil)).Elem(), OperationsDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OperationsDefinitionArrayInput)(nil)).Elem(), OperationsDefinitionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*OperationsDefinitionDisplayInput)(nil)).Elem(), OperationsDefinitionDisplayArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OperationsDefinitionResponseDisplayInput)(nil)).Elem(), OperationsDefinitionResponseDisplayArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OperationsDefinitionResponseDisplayPtrInput)(nil)).Elem(), OperationsDefinitionResponseDisplayArgs{})
