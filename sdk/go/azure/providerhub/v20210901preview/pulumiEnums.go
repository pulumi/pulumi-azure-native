...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointTypeInput)(nil)).Elem(), EndpointType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointTypePtrInput)(nil)).Elem(), EndpointType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ExtensionCategoryInput)(nil)).Elem(), ExtensionCategory("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ExtensionCategoryPtrInput)(nil)).Elem(), ExtensionCategory("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ExtensionOptionTypeInput)(nil)).Elem(), ExtensionOptionType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ExtensionOptionTypePtrInput)(nil)).Elem(), ExtensionOptionType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*FeaturesPolicyInput)(nil)).Elem(), FeaturesPolicy("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*FeaturesPolicyPtrInput)(nil)).Elem(), FeaturesPolicy("Any"))
	pulumi.RegisterInputType(reflect.TypeOf((*IdentityManagementTypesInput)(nil)).Elem(), IdentityManagementTypes("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*IdentityManagementTypesPtrInput)(nil)).Elem(), IdentityManagementTypes("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*LoggingDetailsInput)(nil)).Elem(), LoggingDetails("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*LoggingDetailsPtrInput)(nil)).Elem(), LoggingDetails("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*LoggingDirectionsInput)(nil)).Elem(), LoggingDirections("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*LoggingDirectionsPtrInput)(nil)).Elem(), LoggingDirections("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*MessageScopeInput)(nil)).Elem(), MessageScope("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*MessageScopePtrInput)(nil)).Elem(), MessageScope("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationModeInput)(nil)).Elem(), NotificationMode("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*NotificationModePtrInput)(nil)).Elem(), NotificationMode("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*OptInHeaderTypeInput)(nil)).Elem(), OptInHeaderType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*OptInHeaderTypePtrInput)(nil)).Elem(), OptInHeaderType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyInput)(nil)).Elem(), Policy("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*PolicyPtrInput)(nil)).Elem(), Policy("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*PreflightOptionInput)(nil)).Elem(), PreflightOption("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*PreflightOptionPtrInput)(nil)).Elem(), PreflightOption("None"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReadinessInput)(nil)).Elem(), Readiness("ClosingDown"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReadinessPtrInput)(nil)).Elem(), Readiness("ClosingDown"))
	pulumi.RegisterInputType(reflect.TypeOf((*RegionalityInput)(nil)).Elem(), Regionality("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*RegionalityPtrInput)(nil)).Elem(), Regionality("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceDeletionPolicyInput)(nil)).Elem(), ResourceDeletionPolicy("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceDeletionPolicyPtrInput)(nil)).Elem(), ResourceDeletionPolicy("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceProviderCapabilitiesEffectInput)(nil)).Elem(), ResourceProviderCapabilitiesEffect("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceProviderCapabilitiesEffectPtrInput)(nil)).Elem(), ResourceProviderCapabilitiesEffect("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceProviderTypeInput)(nil)).Elem(), ResourceProviderType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceProviderTypePtrInput)(nil)).Elem(), ResourceProviderType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*RoutingTypeInput)(nil)).Elem(), RoutingType("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*RoutingTypePtrInput)(nil)).Elem(), RoutingType("Default"))
	pulumi.RegisterInputType(reflect.TypeOf((*SkuScaleTypeInput)(nil)).Elem(), SkuScaleType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*SkuScaleTypePtrInput)(nil)).Elem(), SkuScaleType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionNotificationOperationInput)(nil)).Elem(), SubscriptionNotificationOperation("NotDefined"))
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionNotificationOperationPtrInput)(nil)).Elem(), SubscriptionNotificationOperation("NotDefined"))
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionReregistrationResultInput)(nil)).Elem(), SubscriptionReregistrationResult("NotApplicable"))
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionReregistrationResultPtrInput)(nil)).Elem(), SubscriptionReregistrationResult("NotApplicable"))
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionStateInput)(nil)).Elem(), SubscriptionState("NotDefined"))
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionStatePtrInput)(nil)).Elem(), SubscriptionState("NotDefined"))
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionTransitioningStateInput)(nil)).Elem(), SubscriptionTransitioningState("Registered"))
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionTransitioningStatePtrInput)(nil)).Elem(), SubscriptionTransitioningState("Registered"))
	pulumi.RegisterInputType(reflect.TypeOf((*ThrottlingMetricTypeInput)(nil)).Elem(), ThrottlingMetricType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*ThrottlingMetricTypePtrInput)(nil)).Elem(), ThrottlingMetricType("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*TrafficRegionCategoryInput)(nil)).Elem(), TrafficRegionCategory("NotSpecified"))
	pulumi.RegisterInputType(reflect.TypeOf((*TrafficRegionCategoryPtrInput)(nil)).Elem(), TrafficRegionCategory("NotSpecified"))
