...
func NewOrganization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:confluent/v20200301:Organization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganization(ctx *pulumi.Context,
	...
	var resource Organization
	err := ctx.ReadResource("azure-nextgen:confluent/v20200301:Organization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
