...
func (o VirtualmachineRetrieveOutput) GuestAgentProfile() GuestAgentProfileResponsePtrOutput {
	return o.ApplyT(func(v *VirtualmachineRetrieve) GuestAgentProfileResponsePtrOutput { return v.GuestAgentProfile }).(GuestAgentProfileResponsePtrOutput)
}
...
func (o VirtualmachineRetrieveOutput) Identity() IdentityResponsePtrOutput {
	return o.ApplyT(func(v *VirtualmachineRetrieve) IdentityResponsePtrOutput { return v.Identity }).(IdentityResponsePtrOutput)
}
...
func (o VirtualmachineRetrieveOutput) VmId() pulumi.StringOutput {
	return o.ApplyT(func(v *VirtualmachineRetrieve) pulumi.StringOutput { return v.VmId }).(pulumi.StringOutput)
}
