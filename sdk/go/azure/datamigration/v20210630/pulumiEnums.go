...
// MySqlTargetPlatformTypeInput is an input type that accepts MySqlTargetPlatformTypeArgs and MySqlTargetPlatformTypeOutput values.
// You can construct a concrete instance of `MySqlTargetPlatformTypeInput` via:
//
