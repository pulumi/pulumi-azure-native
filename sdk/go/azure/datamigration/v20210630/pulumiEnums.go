...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MySqlTargetPlatformTypeInput)(nil)).Elem(), MySqlTargetPlatformType("SqlServer"))
	pulumi.RegisterInputType(reflect.TypeOf((*MySqlTargetPlatformTypePtrInput)(nil)).Elem(), MySqlTargetPlatformType("SqlServer"))
