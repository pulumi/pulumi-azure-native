...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToSourceSqlServerTaskInputInput)(nil)).Elem(), ConnectToSourceSqlServerTaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToSourceSqlServerTaskInputPtrInput)(nil)).Elem(), ConnectToSourceSqlServerTaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToSourceSqlServerTaskInputResponseInput)(nil)).Elem(), ConnectToSourceSqlServerTaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToSourceSqlServerTaskInputResponsePtrInput)(nil)).Elem(), ConnectToSourceSqlServerTaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToSourceSqlServerTaskOutputDatabaseLevelResponseInput)(nil)).Elem(), ConnectToSourceSqlServerTaskOutputDatabaseLevelResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToSourceSqlServerTaskOutputTaskLevelResponseInput)(nil)).Elem(), ConnectToSourceSqlServerTaskOutputTaskLevelResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToSourceSqlServerTaskPropertiesInput)(nil)).Elem(), ConnectToSourceSqlServerTaskPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToSourceSqlServerTaskPropertiesResponseInput)(nil)).Elem(), ConnectToSourceSqlServerTaskPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlDbTaskInputInput)(nil)).Elem(), ConnectToTargetSqlDbTaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlDbTaskInputPtrInput)(nil)).Elem(), ConnectToTargetSqlDbTaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlDbTaskInputResponseInput)(nil)).Elem(), ConnectToTargetSqlDbTaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlDbTaskInputResponsePtrInput)(nil)).Elem(), ConnectToTargetSqlDbTaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlDbTaskOutputResponseInput)(nil)).Elem(), ConnectToTargetSqlDbTaskOutputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlDbTaskOutputResponseArrayInput)(nil)).Elem(), ConnectToTargetSqlDbTaskOutputResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlDbTaskPropertiesInput)(nil)).Elem(), ConnectToTargetSqlDbTaskPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlDbTaskPropertiesResponseInput)(nil)).Elem(), ConnectToTargetSqlDbTaskPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataItemMigrationSummaryResultResponseInput)(nil)).Elem(), DataItemMigrationSummaryResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataItemMigrationSummaryResultResponseMapInput)(nil)).Elem(), DataItemMigrationSummaryResultResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseFileInfoResponseInput)(nil)).Elem(), DatabaseFileInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseFileInfoResponseArrayInput)(nil)).Elem(), DatabaseFileInfoResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseInfoInput)(nil)).Elem(), DatabaseInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseInfoArrayInput)(nil)).Elem(), DatabaseInfoArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseInfoResponseInput)(nil)).Elem(), DatabaseInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseInfoResponseArrayInput)(nil)).Elem(), DatabaseInfoResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseSummaryResultResponseInput)(nil)).Elem(), DatabaseSummaryResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseSummaryResultResponseMapInput)(nil)).Elem(), DatabaseSummaryResultResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseTableResponseInput)(nil)).Elem(), DatabaseTableResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseTableResponseArrayInput)(nil)).Elem(), DatabaseTableResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUserTablesSqlTaskInputInput)(nil)).Elem(), GetUserTablesSqlTaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUserTablesSqlTaskInputPtrInput)(nil)).Elem(), GetUserTablesSqlTaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUserTablesSqlTaskInputResponseInput)(nil)).Elem(), GetUserTablesSqlTaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUserTablesSqlTaskInputResponsePtrInput)(nil)).Elem(), GetUserTablesSqlTaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUserTablesSqlTaskOutputResponseInput)(nil)).Elem(), GetUserTablesSqlTaskOutputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUserTablesSqlTaskOutputResponseArrayInput)(nil)).Elem(), GetUserTablesSqlTaskOutputResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUserTablesSqlTaskPropertiesInput)(nil)).Elem(), GetUserTablesSqlTaskPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUserTablesSqlTaskPropertiesResponseInput)(nil)).Elem(), GetUserTablesSqlTaskPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbDatabaseInputInput)(nil)).Elem(), MigrateSqlServerSqlDbDatabaseInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbDatabaseInputArrayInput)(nil)).Elem(), MigrateSqlServerSqlDbDatabaseInputArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbDatabaseInputResponseInput)(nil)).Elem(), MigrateSqlServerSqlDbDatabaseInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbDatabaseInputResponseArrayInput)(nil)).Elem(), MigrateSqlServerSqlDbDatabaseInputResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbTaskInputInput)(nil)).Elem(), MigrateSqlServerSqlDbTaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbTaskInputPtrInput)(nil)).Elem(), MigrateSqlServerSqlDbTaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbTaskInputResponseInput)(nil)).Elem(), MigrateSqlServerSqlDbTaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbTaskInputResponsePtrInput)(nil)).Elem(), MigrateSqlServerSqlDbTaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbTaskOutputDatabaseLevelResponseInput)(nil)).Elem(), MigrateSqlServerSqlDbTaskOutputDatabaseLevelResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResultResponseInput)(nil)).Elem(), MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbTaskOutputErrorResponseInput)(nil)).Elem(), MigrateSqlServerSqlDbTaskOutputErrorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbTaskOutputMigrationLevelResponseInput)(nil)).Elem(), MigrateSqlServerSqlDbTaskOutputMigrationLevelResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbTaskOutputTableLevelResponseInput)(nil)).Elem(), MigrateSqlServerSqlDbTaskOutputTableLevelResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbTaskOutputValidationResultResponseInput)(nil)).Elem(), MigrateSqlServerSqlDbTaskOutputValidationResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbTaskPropertiesInput)(nil)).Elem(), MigrateSqlServerSqlDbTaskPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlDbTaskPropertiesResponseInput)(nil)).Elem(), MigrateSqlServerSqlDbTaskPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationReportResultResponseInput)(nil)).Elem(), MigrationReportResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationReportResultResponsePtrInput)(nil)).Elem(), MigrationReportResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationValidationOptionsInput)(nil)).Elem(), MigrationValidationOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationValidationOptionsPtrInput)(nil)).Elem(), MigrationValidationOptionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationValidationOptionsResponseInput)(nil)).Elem(), MigrationValidationOptionsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationValidationOptionsResponsePtrInput)(nil)).Elem(), MigrationValidationOptionsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ODataErrorResponseInput)(nil)).Elem(), ODataErrorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ODataErrorResponseArrayInput)(nil)).Elem(), ODataErrorResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportableExceptionResponseInput)(nil)).Elem(), ReportableExceptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReportableExceptionResponseArrayInput)(nil)).Elem(), ReportableExceptionResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceSkuResponseInput)(nil)).Elem(), ServiceSkuResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceSkuResponsePtrInput)(nil)).Elem(), ServiceSkuResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlConnectionInfoInput)(nil)).Elem(), SqlConnectionInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlConnectionInfoPtrInput)(nil)).Elem(), SqlConnectionInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlConnectionInfoResponseInput)(nil)).Elem(), SqlConnectionInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlConnectionInfoResponsePtrInput)(nil)).Elem(), SqlConnectionInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DatabaseTableResponseArrayMapInput)(nil)).Elem(), DatabaseTableResponseArrayMap{})
