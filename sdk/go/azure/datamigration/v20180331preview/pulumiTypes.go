...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*BlobShareInput)(nil)).Elem(), BlobShareArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobSharePtrInput)(nil)).Elem(), BlobShareArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobShareResponseInput)(nil)).Elem(), BlobShareResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobShareResponsePtrInput)(nil)).Elem(), BlobShareResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToSourceSqlServerTaskOutputAgentJobLevelResponseInput)(nil)).Elem(), ConnectToSourceSqlServerTaskOutputAgentJobLevelResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToSourceSqlServerTaskOutputLoginLevelResponseInput)(nil)).Elem(), ConnectToSourceSqlServerTaskOutputLoginLevelResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlMITaskInputInput)(nil)).Elem(), ConnectToTargetSqlMITaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlMITaskInputPtrInput)(nil)).Elem(), ConnectToTargetSqlMITaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlMITaskInputResponseInput)(nil)).Elem(), ConnectToTargetSqlMITaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlMITaskInputResponsePtrInput)(nil)).Elem(), ConnectToTargetSqlMITaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlMITaskOutputResponseInput)(nil)).Elem(), ConnectToTargetSqlMITaskOutputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlMITaskOutputResponseArrayInput)(nil)).Elem(), ConnectToTargetSqlMITaskOutputResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlMITaskPropertiesInput)(nil)).Elem(), ConnectToTargetSqlMITaskPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectToTargetSqlMITaskPropertiesResponseInput)(nil)).Elem(), ConnectToTargetSqlMITaskPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*FileShareInput)(nil)).Elem(), FileShareArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FileSharePtrInput)(nil)).Elem(), FileShareArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FileShareResponseInput)(nil)).Elem(), FileShareResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FileShareResponsePtrInput)(nil)).Elem(), FileShareResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMIDatabaseInputInput)(nil)).Elem(), MigrateSqlServerSqlMIDatabaseInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMIDatabaseInputArrayInput)(nil)).Elem(), MigrateSqlServerSqlMIDatabaseInputArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMIDatabaseInputResponseInput)(nil)).Elem(), MigrateSqlServerSqlMIDatabaseInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMIDatabaseInputResponseArrayInput)(nil)).Elem(), MigrateSqlServerSqlMIDatabaseInputResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMITaskInputInput)(nil)).Elem(), MigrateSqlServerSqlMITaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMITaskInputPtrInput)(nil)).Elem(), MigrateSqlServerSqlMITaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMITaskInputResponseInput)(nil)).Elem(), MigrateSqlServerSqlMITaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMITaskInputResponsePtrInput)(nil)).Elem(), MigrateSqlServerSqlMITaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMITaskOutputAgentJobLevelResponseInput)(nil)).Elem(), MigrateSqlServerSqlMITaskOutputAgentJobLevelResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMITaskOutputDatabaseLevelResponseInput)(nil)).Elem(), MigrateSqlServerSqlMITaskOutputDatabaseLevelResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMITaskOutputErrorResponseInput)(nil)).Elem(), MigrateSqlServerSqlMITaskOutputErrorResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMITaskOutputLoginLevelResponseInput)(nil)).Elem(), MigrateSqlServerSqlMITaskOutputLoginLevelResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMITaskOutputMigrationLevelResponseInput)(nil)).Elem(), MigrateSqlServerSqlMITaskOutputMigrationLevelResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMITaskPropertiesInput)(nil)).Elem(), MigrateSqlServerSqlMITaskPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrateSqlServerSqlMITaskPropertiesResponseInput)(nil)).Elem(), MigrateSqlServerSqlMITaskPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationEligibilityInfoResponseInput)(nil)).Elem(), MigrationEligibilityInfoResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StartMigrationScenarioServerRoleResultResponseInput)(nil)).Elem(), StartMigrationScenarioServerRoleResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StartMigrationScenarioServerRoleResultResponseMapInput)(nil)).Elem(), StartMigrationScenarioServerRoleResultResponseMap{})
	pulumi.RegisterInputType(reflect.TypeOf((*ValidateMigrationInputSqlServerSqlMITaskInputInput)(nil)).Elem(), ValidateMigrationInputSqlServerSqlMITaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ValidateMigrationInputSqlServerSqlMITaskInputPtrInput)(nil)).Elem(), ValidateMigrationInputSqlServerSqlMITaskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ValidateMigrationInputSqlServerSqlMITaskInputResponseInput)(nil)).Elem(), ValidateMigrationInputSqlServerSqlMITaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ValidateMigrationInputSqlServerSqlMITaskInputResponsePtrInput)(nil)).Elem(), ValidateMigrationInputSqlServerSqlMITaskInputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ValidateMigrationInputSqlServerSqlMITaskOutputResponseInput)(nil)).Elem(), ValidateMigrationInputSqlServerSqlMITaskOutputResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ValidateMigrationInputSqlServerSqlMITaskOutputResponseArrayInput)(nil)).Elem(), ValidateMigrationInputSqlServerSqlMITaskOutputResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ValidateMigrationInputSqlServerSqlMITaskPropertiesInput)(nil)).Elem(), ValidateMigrationInputSqlServerSqlMITaskPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ValidateMigrationInputSqlServerSqlMITaskPropertiesResponseInput)(nil)).Elem(), ValidateMigrationInputSqlServerSqlMITaskPropertiesResponseArgs{})
