...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDbReplicationInput)(nil)).Elem(), MongoDbReplication("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDbReplicationPtrInput)(nil)).Elem(), MongoDbReplication("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDbShardKeyOrderInput)(nil)).Elem(), MongoDbShardKeyOrder("Forward"))
	pulumi.RegisterInputType(reflect.TypeOf((*MongoDbShardKeyOrderPtrInput)(nil)).Elem(), MongoDbShardKeyOrder("Forward"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SsisMigrationOverwriteOptionInput)(nil)).Elem(), SsisMigrationOverwriteOption("Ignore"))
	pulumi.RegisterInputType(reflect.TypeOf((*SsisMigrationOverwriteOptionPtrInput)(nil)).Elem(), SsisMigrationOverwriteOption("Ignore"))
	pulumi.RegisterInputType(reflect.TypeOf((*SsisStoreTypeInput)(nil)).Elem(), SsisStoreType("SsisCatalog"))
	pulumi.RegisterInputType(reflect.TypeOf((*SsisStoreTypePtrInput)(nil)).Elem(), SsisStoreType("SsisCatalog"))
