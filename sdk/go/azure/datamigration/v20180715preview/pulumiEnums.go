...
// BackupModeInput is an input type that accepts BackupModeArgs and BackupModeOutput values.
// You can construct a concrete instance of `BackupModeInput` via:
//
//          BackupModeArgs{...}
...
// MongoDbReplicationInput is an input type that accepts MongoDbReplicationArgs and MongoDbReplicationOutput values.
// You can construct a concrete instance of `MongoDbReplicationInput` via:
//
...
// MongoDbShardKeyOrderInput is an input type that accepts MongoDbShardKeyOrderArgs and MongoDbShardKeyOrderOutput values.
// You can construct a concrete instance of `MongoDbShardKeyOrderInput` via:
//
...
// SqlSourcePlatformInput is an input type that accepts SqlSourcePlatformArgs and SqlSourcePlatformOutput values.
// You can construct a concrete instance of `SqlSourcePlatformInput` via:
//
...
// SsisMigrationOverwriteOptionInput is an input type that accepts SsisMigrationOverwriteOptionArgs and SsisMigrationOverwriteOptionOutput values.
// You can construct a concrete instance of `SsisMigrationOverwriteOptionInput` via:
//
...
// SsisStoreTypeInput is an input type that accepts SsisStoreTypeArgs and SsisStoreTypeOutput values.
// You can construct a concrete instance of `SsisStoreTypeInput` via:
//
//          SsisStoreTypeArgs{...}
