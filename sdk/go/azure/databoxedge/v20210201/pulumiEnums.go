...
// DataBoxEdgeDeviceKindInput is an input type that accepts DataBoxEdgeDeviceKindArgs and DataBoxEdgeDeviceKindOutput values.
// You can construct a concrete instance of `DataBoxEdgeDeviceKindInput` via:
//
//          DataBoxEdgeDeviceKindArgs{...}
...
// DataResidencyTypeInput is an input type that accepts DataResidencyTypeArgs and DataResidencyTypeOutput values.
// You can construct a concrete instance of `DataResidencyTypeInput` via:
//
