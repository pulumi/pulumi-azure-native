...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxEdgeDeviceKindInput)(nil)).Elem(), DataBoxEdgeDeviceKind("AzureDataBoxGateway"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxEdgeDeviceKindPtrInput)(nil)).Elem(), DataBoxEdgeDeviceKind("AzureDataBoxGateway"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DataResidencyTypeInput)(nil)).Elem(), DataResidencyType("GeoZoneReplication"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataResidencyTypePtrInput)(nil)).Elem(), DataResidencyType("GeoZoneReplication"))
