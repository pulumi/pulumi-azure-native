...
func (o DataResidencyResponseOutput) ToDataResidencyResponsePtrOutputWithContext(ctx context.Context) DataResidencyResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v DataResidencyResponse) *DataResidencyResponse {
		return &v
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CniConfigResponseInput)(nil)).Elem(), CniConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CniConfigResponsePtrInput)(nil)).Elem(), CniConfigResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeResourceResponseInput)(nil)).Elem(), ComputeResourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ComputeResourceResponsePtrInput)(nil)).Elem(), ComputeResourceResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DataResidencyInput)(nil)).Elem(), DataResidencyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataResidencyPtrInput)(nil)).Elem(), DataResidencyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataResidencyResponseInput)(nil)).Elem(), DataResidencyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataResidencyResponsePtrInput)(nil)).Elem(), DataResidencyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdgeProfileResponseInput)(nil)).Elem(), EdgeProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdgeProfileResponsePtrInput)(nil)).Elem(), EdgeProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdgeProfileSubscriptionResponseInput)(nil)).Elem(), EdgeProfileSubscriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EdgeProfileSubscriptionResponsePtrInput)(nil)).Elem(), EdgeProfileSubscriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EtcdInfoResponseInput)(nil)).Elem(), EtcdInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EtcdInfoResponsePtrInput)(nil)).Elem(), EtcdInfoResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ImageRepositoryCredentialInput)(nil)).Elem(), ImageRepositoryCredentialArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageRepositoryCredentialPtrInput)(nil)).Elem(), ImageRepositoryCredentialArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageRepositoryCredentialResponseInput)(nil)).Elem(), ImageRepositoryCredentialResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImageRepositoryCredentialResponsePtrInput)(nil)).Elem(), ImageRepositoryCredentialResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IoTEdgeAgentInfoInput)(nil)).Elem(), IoTEdgeAgentInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IoTEdgeAgentInfoPtrInput)(nil)).Elem(), IoTEdgeAgentInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IoTEdgeAgentInfoResponseInput)(nil)).Elem(), IoTEdgeAgentInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IoTEdgeAgentInfoResponsePtrInput)(nil)).Elem(), IoTEdgeAgentInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesClusterInfoInput)(nil)).Elem(), KubernetesClusterInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesClusterInfoPtrInput)(nil)).Elem(), KubernetesClusterInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesClusterInfoResponseInput)(nil)).Elem(), KubernetesClusterInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesClusterInfoResponsePtrInput)(nil)).Elem(), KubernetesClusterInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesIPConfigurationResponseInput)(nil)).Elem(), KubernetesIPConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesIPConfigurationResponseArrayInput)(nil)).Elem(), KubernetesIPConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleComputeInput)(nil)).Elem(), KubernetesRoleComputeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleComputePtrInput)(nil)).Elem(), KubernetesRoleComputeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleComputeResponseInput)(nil)).Elem(), KubernetesRoleComputeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleComputeResponsePtrInput)(nil)).Elem(), KubernetesRoleComputeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleNetworkResponseInput)(nil)).Elem(), KubernetesRoleNetworkResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleNetworkResponsePtrInput)(nil)).Elem(), KubernetesRoleNetworkResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleResourcesInput)(nil)).Elem(), KubernetesRoleResourcesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleResourcesPtrInput)(nil)).Elem(), KubernetesRoleResourcesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleResourcesResponseInput)(nil)).Elem(), KubernetesRoleResourcesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleResourcesResponsePtrInput)(nil)).Elem(), KubernetesRoleResourcesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleStorageInput)(nil)).Elem(), KubernetesRoleStorageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleStoragePtrInput)(nil)).Elem(), KubernetesRoleStorageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleStorageClassInfoResponseInput)(nil)).Elem(), KubernetesRoleStorageClassInfoResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleStorageClassInfoResponseArrayInput)(nil)).Elem(), KubernetesRoleStorageClassInfoResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleStorageResponseInput)(nil)).Elem(), KubernetesRoleStorageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesRoleStorageResponsePtrInput)(nil)).Elem(), KubernetesRoleStorageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerConfigResponseInput)(nil)).Elem(), LoadBalancerConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerConfigResponsePtrInput)(nil)).Elem(), LoadBalancerConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricConfigurationInput)(nil)).Elem(), MetricConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricConfigurationArrayInput)(nil)).Elem(), MetricConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricConfigurationResponseInput)(nil)).Elem(), MetricConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricConfigurationResponseArrayInput)(nil)).Elem(), MetricConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricCounterInput)(nil)).Elem(), MetricCounterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricCounterArrayInput)(nil)).Elem(), MetricCounterArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricCounterResponseInput)(nil)).Elem(), MetricCounterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricCounterResponseArrayInput)(nil)).Elem(), MetricCounterResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricCounterSetInput)(nil)).Elem(), MetricCounterSetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricCounterSetArrayInput)(nil)).Elem(), MetricCounterSetArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricCounterSetResponseInput)(nil)).Elem(), MetricCounterSetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricCounterSetResponseArrayInput)(nil)).Elem(), MetricCounterSetResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceMoveDetailsResponseInput)(nil)).Elem(), ResourceMoveDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceMoveDetailsResponsePtrInput)(nil)).Elem(), ResourceMoveDetailsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SecretResponseMapInput)(nil)).Elem(), SecretResponseMap{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionRegisteredFeaturesResponseInput)(nil)).Elem(), SubscriptionRegisteredFeaturesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionRegisteredFeaturesResponseArrayInput)(nil)).Elem(), SubscriptionRegisteredFeaturesResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TrackingInfoResponsePtrInput)(nil)).Elem(), TrackingInfoResponseArgs{})
