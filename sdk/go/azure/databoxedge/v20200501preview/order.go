...
func NewOrder(ctx *pulumi.Context,
	...
	var resource Order
	err := ctx.RegisterResource("azure-nextgen:databoxedge/v20200501preview:Order", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrder(ctx *pulumi.Context,
	...
	var resource Order
	err := ctx.ReadResource("azure-nextgen:databoxedge/v20200501preview:Order", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
