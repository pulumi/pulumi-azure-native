...
func LookupStorageAccount(ctx *pulumi.Context, args *LookupStorageAccountArgs, opts ...pulumi.InvokeOption) (*LookupStorageAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20200501preview:getStorageAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupStorageAccountResultOutput) DataPolicy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupStorageAccountResult) *string { return v.DataPolicy }).(pulumi.StringPtrOutput)
}
