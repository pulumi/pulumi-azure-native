...
func (OrderStateEnum) ElementType() reflect.Type {
	return reflect.TypeOf((*OrderStateEnum)(nil)).Elem()
}

func (e OrderStateEnum) ToOrderStateEnumOutput() OrderStateEnumOutput {
	return pulumi.ToOutput(e).(OrderStateEnumOutput)
}

func (e OrderStateEnum) ToOrderStateEnumOutputWithContext(ctx context.Context) OrderStateEnumOutput {
	return pulumi.ToOutputWithContext(ctx, e).(OrderStateEnumOutput)
}

func (e OrderStateEnum) ToOrderStateEnumPtrOutput() OrderStateEnumPtrOutput {
	return e.ToOrderStateEnumPtrOutputWithContext(context.Background())
}

func (e OrderStateEnum) ToOrderStateEnumPtrOutputWithContext(ctx context.Context) OrderStateEnumPtrOutput {
	return OrderStateEnum(e).ToOrderStateEnumOutputWithContext(ctx).ToOrderStateEnumPtrOutputWithContext(ctx)
}
...
type OrderStateEnumOutput struct{ *pulumi.OutputState }

func (OrderStateEnumOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*OrderStateEnum)(nil)).Elem()
}

func (o OrderStateEnumOutput) ToOrderStateEnumOutput() OrderStateEnumOutput {
	return o
}

func (o OrderStateEnumOutput) ToOrderStateEnumOutputWithContext(ctx context.Context) OrderStateEnumOutput {
	return o
}

func (o OrderStateEnumOutput) ToOrderStateEnumPtrOutput() OrderStateEnumPtrOutput {
	return o.ToOrderStateEnumPtrOutputWithContext(context.Background())
}

func (o OrderStateEnumOutput) ToOrderStateEnumPtrOutputWithContext(ctx context.Context) OrderStateEnumPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v OrderStateEnum) *OrderStateEnum {
		return &v
	}).(OrderStateEnumPtrOutput)
}

func (o OrderStateEnumOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o OrderStateEnumOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e OrderStateEnum) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o OrderStateEnumOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o OrderStateEnumOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e OrderStateEnum) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type OrderStateEnumPtrOutput struct{ *pulumi.OutputState }

func (OrderStateEnumPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**OrderStateEnum)(nil)).Elem()
}

func (o OrderStateEnumPtrOutput) ToOrderStateEnumPtrOutput() OrderStateEnumPtrOutput {
	return o
}

func (o OrderStateEnumPtrOutput) ToOrderStateEnumPtrOutputWithContext(ctx context.Context) OrderStateEnumPtrOutput {
	return o
}

func (o OrderStateEnumPtrOutput) Elem() OrderStateEnumOutput {
	return o.ApplyT(func(v *OrderStateEnum) OrderStateEnum {
		if v != nil {
			return *v
		}
		var ret OrderStateEnum
		return ret
	}).(OrderStateEnumOutput)
}

func (o OrderStateEnumPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o OrderStateEnumPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *OrderStateEnum) *string {
		if e == nil {
			return nil
		}
...
type OrderStateEnumInput interface {
	pulumi.Input

	ToOrderStateEnumOutput() OrderStateEnumOutput
	ToOrderStateEnumOutputWithContext(context.Context) OrderStateEnumOutput
}

var orderStateEnumPtrType = reflect.TypeOf((**OrderStateEnum)(nil)).Elem()

type OrderStateEnumPtrInput interface {
	pulumi.Input

	ToOrderStateEnumPtrOutput() OrderStateEnumPtrOutput
	ToOrderStateEnumPtrOutputWithContext(context.Context) OrderStateEnumPtrOutput
}

type orderStateEnumPtr string

func OrderStateEnumPtr(v string) OrderStateEnumPtrInput {
	return (*orderStateEnumPtr)(&v)
}

func (*orderStateEnumPtr) ElementType() reflect.Type {
	return orderStateEnumPtrType
}

func (in *orderStateEnumPtr) ToOrderStateEnumPtrOutput() OrderStateEnumPtrOutput {
	return pulumi.ToOutput(in).(OrderStateEnumPtrOutput)
}

func (in *orderStateEnumPtr) ToOrderStateEnumPtrOutputWithContext(ctx context.Context) OrderStateEnumPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(OrderStateEnumPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OrderStateEnumInput)(nil)).Elem(), OrderStateEnum("Untracked"))
	pulumi.RegisterInputType(reflect.TypeOf((*OrderStateEnumPtrInput)(nil)).Elem(), OrderStateEnum("Untracked"))
	...
	pulumi.RegisterOutputType(OrderStateEnumOutput{})
	pulumi.RegisterOutputType(OrderStateEnumPtrOutput{})
