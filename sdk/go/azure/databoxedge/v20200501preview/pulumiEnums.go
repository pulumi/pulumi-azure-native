...
// OrderStateEnumInput is an input type that accepts OrderStateEnumArgs and OrderStateEnumOutput values.
// You can construct a concrete instance of `OrderStateEnumInput` via:
//
//          OrderStateEnumArgs{...}
