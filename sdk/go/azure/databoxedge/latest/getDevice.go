...
func LookupDevice(ctx *pulumi.Context, args *LookupDeviceArgs, opts ...pulumi.InvokeOption) (*LookupDeviceResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:databoxedge/latest:getDevice", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDeviceResult struct {
	...
	EdgeProfile *EdgeProfileInvokeResponse `pulumi:"edgeProfile"`
	...
	ResourceMoveDetails *ResourceMoveDetailsInvokeResponse `pulumi:"resourceMoveDetails"`
