...
func NewOrder(ctx *pulumi.Context,
	...
	var resource Order
	err := ctx.RegisterResource("azure-nextgen:databoxedge/v20190801:Order", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrder(ctx *pulumi.Context,
	...
	var resource Order
	err := ctx.ReadResource("azure-nextgen:databoxedge/v20190801:Order", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
