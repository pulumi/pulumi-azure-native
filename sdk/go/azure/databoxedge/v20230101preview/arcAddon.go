...
type ArcAddon struct {
	...
	CustomLocationsObjectId pulumi.StringOutput      `pulumi:"customLocationsObjectId"`
...
func NewArcAddon(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20230101preview:ArcAddon", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArcAddon(ctx *pulumi.Context,
	...
	var resource ArcAddon
	err := ctx.ReadResource("azure-native:databoxedge/v20230101preview:ArcAddon", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o ArcAddonOutput) CustomLocationsObjectId() pulumi.StringOutput {
	return o.ApplyT(func(v *ArcAddon) pulumi.StringOutput { return v.CustomLocationsObjectId }).(pulumi.StringOutput)
}
