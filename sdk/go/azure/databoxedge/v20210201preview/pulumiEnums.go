...
// AddonTypeInput is an input type that accepts AddonTypeArgs and AddonTypeOutput values.
// You can construct a concrete instance of `AddonTypeInput` via:
//
//          AddonTypeArgs{...}
...
// AzureContainerDataFormatInput is an input type that accepts AzureContainerDataFormatArgs and AzureContainerDataFormatOutput values.
// You can construct a concrete instance of `AzureContainerDataFormatInput` via:
//
...
// ClientPermissionTypeInput is an input type that accepts ClientPermissionTypeArgs and ClientPermissionTypeOutput values.
// You can construct a concrete instance of `ClientPermissionTypeInput` via:
//
...
// DataBoxEdgeDeviceStatusInput is an input type that accepts DataBoxEdgeDeviceStatusArgs and DataBoxEdgeDeviceStatusOutput values.
// You can construct a concrete instance of `DataBoxEdgeDeviceStatusInput` via:
//
//          DataBoxEdgeDeviceStatusArgs{...}
...
// MsiIdentityTypeInput is an input type that accepts MsiIdentityTypeArgs and MsiIdentityTypeOutput values.
// You can construct a concrete instance of `MsiIdentityTypeInput` via:
//
//          MsiIdentityTypeArgs{...}
...
// PlatformTypeInput is an input type that accepts PlatformTypeArgs and PlatformTypeOutput values.
// You can construct a concrete instance of `PlatformTypeInput` via:
//
//          PlatformTypeArgs{...}
...
// RoleStatusInput is an input type that accepts RoleStatusArgs and RoleStatusOutput values.
// You can construct a concrete instance of `RoleStatusInput` via:
//
//          RoleStatusArgs{...}
...
// ShareAccessProtocolInput is an input type that accepts ShareAccessProtocolArgs and ShareAccessProtocolOutput values.
// You can construct a concrete instance of `ShareAccessProtocolInput` via:
//
...
// ShareAccessTypeInput is an input type that accepts ShareAccessTypeArgs and ShareAccessTypeOutput values.
// You can construct a concrete instance of `ShareAccessTypeInput` via:
//
//          ShareAccessTypeArgs{...}
...
// ShipmentTypeInput is an input type that accepts ShipmentTypeArgs and ShipmentTypeOutput values.
// You can construct a concrete instance of `ShipmentTypeInput` via:
//
//          ShipmentTypeArgs{...}
...
// StorageAccountStatusInput is an input type that accepts StorageAccountStatusArgs and StorageAccountStatusOutput values.
// You can construct a concrete instance of `StorageAccountStatusInput` via:
//
