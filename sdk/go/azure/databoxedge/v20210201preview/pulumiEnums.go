...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AccountTypeInput)(nil)).Elem(), AccountType("GeneralPurposeStorage"))
	pulumi.RegisterInputType(reflect.TypeOf((*AccountTypePtrInput)(nil)).Elem(), AccountType("GeneralPurposeStorage"))
	pulumi.RegisterInputType(reflect.TypeOf((*AddonTypeInput)(nil)).Elem(), AddonType("IotEdge"))
	pulumi.RegisterInputType(reflect.TypeOf((*AddonTypePtrInput)(nil)).Elem(), AddonType("IotEdge"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzureContainerDataFormatInput)(nil)).Elem(), AzureContainerDataFormat("BlockBlob"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzureContainerDataFormatPtrInput)(nil)).Elem(), AzureContainerDataFormat("BlockBlob"))
	pulumi.RegisterInputType(reflect.TypeOf((*ClientPermissionTypeInput)(nil)).Elem(), ClientPermissionType("NoAccess"))
	pulumi.RegisterInputType(reflect.TypeOf((*ClientPermissionTypePtrInput)(nil)).Elem(), ClientPermissionType("NoAccess"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxEdgeDeviceStatusInput)(nil)).Elem(), DataBoxEdgeDeviceStatus("ReadyToSetup"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataBoxEdgeDeviceStatusPtrInput)(nil)).Elem(), DataBoxEdgeDeviceStatus("ReadyToSetup"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataPolicyInput)(nil)).Elem(), DataPolicy("Cloud"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataPolicyPtrInput)(nil)).Elem(), DataPolicy("Cloud"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionAlgorithmInput)(nil)).Elem(), EncryptionAlgorithm("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionAlgorithmPtrInput)(nil)).Elem(), EncryptionAlgorithm("None"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MsiIdentityTypeInput)(nil)).Elem(), MsiIdentityType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*MsiIdentityTypePtrInput)(nil)).Elem(), MsiIdentityType("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*PlatformTypeInput)(nil)).Elem(), PlatformType("Windows"))
	pulumi.RegisterInputType(reflect.TypeOf((*PlatformTypePtrInput)(nil)).Elem(), PlatformType("Windows"))
	pulumi.RegisterInputType(reflect.TypeOf((*RoleStatusInput)(nil)).Elem(), RoleStatus("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*RoleStatusPtrInput)(nil)).Elem(), RoleStatus("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*RoleTypesInput)(nil)).Elem(), RoleTypes("IOT"))
	pulumi.RegisterInputType(reflect.TypeOf((*RoleTypesPtrInput)(nil)).Elem(), RoleTypes("IOT"))
	pulumi.RegisterInputType(reflect.TypeOf((*SSLStatusInput)(nil)).Elem(), SSLStatus("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*SSLStatusPtrInput)(nil)).Elem(), SSLStatus("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ShareAccessProtocolInput)(nil)).Elem(), ShareAccessProtocol("SMB"))
	pulumi.RegisterInputType(reflect.TypeOf((*ShareAccessProtocolPtrInput)(nil)).Elem(), ShareAccessProtocol("SMB"))
	pulumi.RegisterInputType(reflect.TypeOf((*ShareAccessTypeInput)(nil)).Elem(), ShareAccessType("Change"))
	pulumi.RegisterInputType(reflect.TypeOf((*ShareAccessTypePtrInput)(nil)).Elem(), ShareAccessType("Change"))
	pulumi.RegisterInputType(reflect.TypeOf((*ShareStatusInput)(nil)).Elem(), ShareStatus("Offline"))
	pulumi.RegisterInputType(reflect.TypeOf((*ShareStatusPtrInput)(nil)).Elem(), ShareStatus("Offline"))
	pulumi.RegisterInputType(reflect.TypeOf((*ShipmentTypeInput)(nil)).Elem(), ShipmentType("NotApplicable"))
	pulumi.RegisterInputType(reflect.TypeOf((*ShipmentTypePtrInput)(nil)).Elem(), ShipmentType("NotApplicable"))
	pulumi.RegisterInputType(reflect.TypeOf((*SkuNameInput)(nil)).Elem(), SkuName("Gateway"))
	pulumi.RegisterInputType(reflect.TypeOf((*SkuNamePtrInput)(nil)).Elem(), SkuName("Gateway"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountStatusInput)(nil)).Elem(), StorageAccountStatus("OK"))
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountStatusPtrInput)(nil)).Elem(), StorageAccountStatus("OK"))
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerEventTypeInput)(nil)).Elem(), TriggerEventType("FileEvent"))
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerEventTypePtrInput)(nil)).Elem(), TriggerEventType("FileEvent"))
	pulumi.RegisterInputType(reflect.TypeOf((*UserTypeInput)(nil)).Elem(), UserType("Share"))
	pulumi.RegisterInputType(reflect.TypeOf((*UserTypePtrInput)(nil)).Elem(), UserType("Share"))
