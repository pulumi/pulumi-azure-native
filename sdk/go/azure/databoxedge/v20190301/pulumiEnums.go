...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ShareStatusInput)(nil)).Elem(), ShareStatus("Online"))
	pulumi.RegisterInputType(reflect.TypeOf((*ShareStatusPtrInput)(nil)).Elem(), ShareStatus("Online"))
