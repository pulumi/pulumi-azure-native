...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AuthorizationResponseArrayInput)(nil)).Elem(), AuthorizationResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EligibleApproverResponseInput)(nil)).Elem(), EligibleApproverResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EligibleApproverResponseArrayInput)(nil)).Elem(), EligibleApproverResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EligibleAuthorizationInput)(nil)).Elem(), EligibleAuthorizationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EligibleAuthorizationArrayInput)(nil)).Elem(), EligibleAuthorizationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EligibleAuthorizationResponseInput)(nil)).Elem(), EligibleAuthorizationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EligibleAuthorizationResponseArrayInput)(nil)).Elem(), EligibleAuthorizationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*JustInTimeAccessPolicyInput)(nil)).Elem(), JustInTimeAccessPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JustInTimeAccessPolicyPtrInput)(nil)).Elem(), JustInTimeAccessPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JustInTimeAccessPolicyResponseInput)(nil)).Elem(), JustInTimeAccessPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*JustInTimeAccessPolicyResponsePtrInput)(nil)).Elem(), JustInTimeAccessPolicyResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RegistrationAssignmentPropertiesInput)(nil)).Elem(), RegistrationAssignmentPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegistrationAssignmentPropertiesPtrInput)(nil)).Elem(), RegistrationAssignmentPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegistrationAssignmentPropertiesResponseInput)(nil)).Elem(), RegistrationAssignmentPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegistrationAssignmentPropertiesResponsePtrInput)(nil)).Elem(), RegistrationAssignmentPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegistrationAssignmentPropertiesResponsePropertiesInput)(nil)).Elem(), RegistrationAssignmentPropertiesResponsePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegistrationAssignmentPropertiesResponsePropertiesPtrInput)(nil)).Elem(), RegistrationAssignmentPropertiesResponsePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegistrationAssignmentPropertiesResponseRegistrationDefinitionInput)(nil)).Elem(), RegistrationAssignmentPropertiesResponseRegistrationDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegistrationAssignmentPropertiesResponseRegistrationDefinitionPtrInput)(nil)).Elem(), RegistrationAssignmentPropertiesResponseRegistrationDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegistrationDefinitionPropertiesInput)(nil)).Elem(), RegistrationDefinitionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegistrationDefinitionPropertiesPtrInput)(nil)).Elem(), RegistrationDefinitionPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegistrationDefinitionPropertiesResponseInput)(nil)).Elem(), RegistrationDefinitionPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RegistrationDefinitionPropertiesResponsePtrInput)(nil)).Elem(), RegistrationDefinitionPropertiesResponseArgs{})
