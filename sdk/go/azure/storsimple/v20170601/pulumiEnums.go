...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*BackupTypeInput)(nil)).Elem(), BackupType("LocalSnapshot"))
	pulumi.RegisterInputType(reflect.TypeOf((*BackupTypePtrInput)(nil)).Elem(), BackupType("LocalSnapshot"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KindInput)(nil)).Elem(), Kind("Series8000"))
	pulumi.RegisterInputType(reflect.TypeOf((*KindPtrInput)(nil)).Elem(), Kind("Series8000"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagerSkuTypeInput)(nil)).Elem(), ManagerSkuType("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagerSkuTypePtrInput)(nil)).Elem(), ManagerSkuType("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagerTypeInput)(nil)).Elem(), ManagerType("GardaV1"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagerTypePtrInput)(nil)).Elem(), ManagerType("GardaV1"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceTypeInput)(nil)).Elem(), RecurrenceType("Minutes"))
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceTypePtrInput)(nil)).Elem(), RecurrenceType("Minutes"))
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleStatusInput)(nil)).Elem(), ScheduleStatus("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleStatusPtrInput)(nil)).Elem(), ScheduleStatus("Enabled"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeStatusInput)(nil)).Elem(), VolumeStatus("Online"))
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeStatusPtrInput)(nil)).Elem(), VolumeStatus("Online"))
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeTypeInput)(nil)).Elem(), VolumeType("Tiered"))
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeTypePtrInput)(nil)).Elem(), VolumeType("Tiered"))
