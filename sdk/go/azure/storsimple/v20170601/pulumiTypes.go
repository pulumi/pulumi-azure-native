...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BandwidthScheduleInput)(nil)).Elem(), BandwidthScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BandwidthScheduleArrayInput)(nil)).Elem(), BandwidthScheduleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*BandwidthScheduleResponseInput)(nil)).Elem(), BandwidthScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BandwidthScheduleResponseArrayInput)(nil)).Elem(), BandwidthScheduleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FailoverSetEligibilityResultResponseInput)(nil)).Elem(), FailoverSetEligibilityResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FailoverSetEligibilityResultResponsePtrInput)(nil)).Elem(), FailoverSetEligibilityResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FailoverSetResponseInput)(nil)).Elem(), FailoverSetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FailoverSetResponseArrayInput)(nil)).Elem(), FailoverSetResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FailoverTargetResponseInput)(nil)).Elem(), FailoverTargetResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*FailoverTargetResponseArrayInput)(nil)).Elem(), FailoverTargetResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleRecurrenceResponseInput)(nil)).Elem(), ScheduleRecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleRecurrenceResponsePtrInput)(nil)).Elem(), ScheduleRecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetEligibilityErrorMessageResponseInput)(nil)).Elem(), TargetEligibilityErrorMessageResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetEligibilityErrorMessageResponseArrayInput)(nil)).Elem(), TargetEligibilityErrorMessageResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetEligibilityResultResponseInput)(nil)).Elem(), TargetEligibilityResultResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetEligibilityResultResponsePtrInput)(nil)).Elem(), TargetEligibilityResultResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeContainerFailoverMetadataResponseInput)(nil)).Elem(), VolumeContainerFailoverMetadataResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeContainerFailoverMetadataResponseArrayInput)(nil)).Elem(), VolumeContainerFailoverMetadataResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeFailoverMetadataResponseInput)(nil)).Elem(), VolumeFailoverMetadataResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeFailoverMetadataResponseArrayInput)(nil)).Elem(), VolumeFailoverMetadataResponseArray{})
