...
func NewManager(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:storsimple/v20170601:Manager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManager(ctx *pulumi.Context,
	...
	var resource Manager
	err := ctx.ReadResource("azure-nextgen:storsimple/v20170601:Manager", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
