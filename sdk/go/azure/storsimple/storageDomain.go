...
func NewStorageDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storsimple:StorageDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageDomain(ctx *pulumi.Context,
	...
	var resource StorageDomain
	err := ctx.ReadResource("azure-native:storsimple:StorageDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
