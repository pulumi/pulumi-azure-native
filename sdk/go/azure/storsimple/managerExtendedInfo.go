...
func NewManagerExtendedInfo(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:storsimple:ManagerExtendedInfo", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagerExtendedInfo(ctx *pulumi.Context,
	...
	var resource ManagerExtendedInfo
	err := ctx.ReadResource("azure-nextgen:storsimple:ManagerExtendedInfo", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
