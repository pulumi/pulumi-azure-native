...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CloudTypeInput)(nil)).Elem(), CloudType("Azure"))
	pulumi.RegisterInputType(reflect.TypeOf((*CloudTypePtrInput)(nil)).Elem(), CloudType("Azure"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataPolicyInput)(nil)).Elem(), DataPolicy("Invalid"))
	pulumi.RegisterInputType(reflect.TypeOf((*DataPolicyPtrInput)(nil)).Elem(), DataPolicy("Invalid"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiskStatusInput)(nil)).Elem(), DiskStatus("Online"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiskStatusPtrInput)(nil)).Elem(), DiskStatus("Online"))
