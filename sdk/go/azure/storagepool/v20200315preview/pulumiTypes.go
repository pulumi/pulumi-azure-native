...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AttributesResponseInput)(nil)).Elem(), AttributesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TargetPortalGroupCreateInput)(nil)).Elem(), TargetPortalGroupCreateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetPortalGroupCreateArrayInput)(nil)).Elem(), TargetPortalGroupCreateArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetPortalGroupResponseInput)(nil)).Elem(), TargetPortalGroupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TargetPortalGroupResponseArrayInput)(nil)).Elem(), TargetPortalGroupResponseArray{})
