...
// ConfigurationProfileInput is an input type that accepts ConfigurationProfileArgs and ConfigurationProfileOutput values.
// You can construct a concrete instance of `ConfigurationProfileInput` via:
//
...
// EnableRealTimeProtectionInput is an input type that accepts EnableRealTimeProtectionArgs and EnableRealTimeProtectionOutput values.
// You can construct a concrete instance of `EnableRealTimeProtectionInput` via:
//
...
// RunScheduledScanInput is an input type that accepts RunScheduledScanArgs and RunScheduledScanOutput values.
// You can construct a concrete instance of `RunScheduledScanInput` via:
//
...
// ScanTypeInput is an input type that accepts ScanTypeArgs and ScanTypeOutput values.
// You can construct a concrete instance of `ScanTypeInput` via:
//
//          ScanTypeArgs{...}
