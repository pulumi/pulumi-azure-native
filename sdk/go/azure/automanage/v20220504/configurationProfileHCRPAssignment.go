...
func NewConfigurationProfileHCRPAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automanage/v20220504:ConfigurationProfileHCRPAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationProfileHCRPAssignment(ctx *pulumi.Context,
	...
	var resource ConfigurationProfileHCRPAssignment
	err := ctx.ReadResource("azure-native:automanage/v20220504:ConfigurationProfileHCRPAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
