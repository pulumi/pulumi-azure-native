...
func NewConfigurationProfileHCIAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automanage/v20220504:ConfigurationProfileHCIAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationProfileHCIAssignment(ctx *pulumi.Context,
	...
	var resource ConfigurationProfileHCIAssignment
	err := ctx.ReadResource("azure-native:automanage/v20220504:ConfigurationProfileHCIAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
