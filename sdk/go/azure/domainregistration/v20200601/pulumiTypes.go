...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DomainPurchaseConsentInput)(nil)).Elem(), DomainPurchaseConsentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DomainPurchaseConsentPtrInput)(nil)).Elem(), DomainPurchaseConsentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DomainPurchaseConsentResponseInput)(nil)).Elem(), DomainPurchaseConsentResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HostNameResponseInput)(nil)).Elem(), HostNameResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HostNameResponseArrayInput)(nil)).Elem(), HostNameResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NameIdentifierResponseInput)(nil)).Elem(), NameIdentifierResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NameIdentifierResponseArrayInput)(nil)).Elem(), NameIdentifierResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TldLegalAgreementResponseInput)(nil)).Elem(), TldLegalAgreementResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TldLegalAgreementResponseArrayInput)(nil)).Elem(), TldLegalAgreementResponseArray{})
