...
// DoubleEncryptionStatusInput is an input type that accepts DoubleEncryptionStatusArgs and DoubleEncryptionStatusOutput values.
// You can construct a concrete instance of `DoubleEncryptionStatusInput` via:
//
//          DoubleEncryptionStatusArgs{...}
...
// OrderItemTypeInput is an input type that accepts OrderItemTypeArgs and OrderItemTypeOutput values.
// You can construct a concrete instance of `OrderItemTypeInput` via:
//
//          OrderItemTypeArgs{...}
