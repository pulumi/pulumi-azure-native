...
func (o VolumeOutput) AzureFile() AzureFileVolumeOutput {
	return o.ApplyT(func(v Volume) AzureFileVolume { return v.AzureFile }).(AzureFileVolumeOutput)
}
...
type VolumeResponseArgs struct {
	AzureFile AzureFileVolumeResponseInput `pulumi:"azureFile"`
	Name      pulumi.StringInput           `pulumi:"name"`
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerEventResponseInput)(nil)).Elem(), ContainerEventResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerEventResponseArrayInput)(nil)).Elem(), ContainerEventResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerStateResponsePtrInput)(nil)).Elem(), ContainerStateResponseArgs{})
