...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerGroupNetworkProfileInput)(nil)).Elem(), ContainerGroupNetworkProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerGroupNetworkProfilePtrInput)(nil)).Elem(), ContainerGroupNetworkProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerGroupNetworkProfileResponseInput)(nil)).Elem(), ContainerGroupNetworkProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerGroupNetworkProfileResponsePtrInput)(nil)).Elem(), ContainerGroupNetworkProfileResponseArgs{})
