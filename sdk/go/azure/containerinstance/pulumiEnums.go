...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerGroupSkuInput)(nil)).Elem(), ContainerGroupSku("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerGroupSkuPtrInput)(nil)).Elem(), ContainerGroupSku("Standard"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SchemeInput)(nil)).Elem(), Scheme("http"))
	pulumi.RegisterInputType(reflect.TypeOf((*SchemePtrInput)(nil)).Elem(), Scheme("http"))
