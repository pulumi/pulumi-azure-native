...
func NewSecretValue(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:servicefabricmesh:SecretValue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretValue(ctx *pulumi.Context,
	...
	var resource SecretValue
	err := ctx.ReadResource("azure-nextgen:servicefabricmesh:SecretValue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
