...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AddRemoveReplicaScalingMechanismInput)(nil)).Elem(), AddRemoveReplicaScalingMechanismArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AddRemoveReplicaScalingMechanismResponseInput)(nil)).Elem(), AddRemoveReplicaScalingMechanismResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationScopedVolumeInput)(nil)).Elem(), ApplicationScopedVolumeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationScopedVolumeArrayInput)(nil)).Elem(), ApplicationScopedVolumeArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskInput)(nil)).Elem(), ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskResponseInput)(nil)).Elem(), ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationScopedVolumeResponseInput)(nil)).Elem(), ApplicationScopedVolumeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationScopedVolumeResponseArrayInput)(nil)).Elem(), ApplicationScopedVolumeResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalingPolicyResponseArrayInput)(nil)).Elem(), AutoScalingPolicyResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalingResourceMetricInput)(nil)).Elem(), AutoScalingResourceMetricArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalingResourceMetricResponseInput)(nil)).Elem(), AutoScalingResourceMetricResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AverageLoadScalingTriggerInput)(nil)).Elem(), AverageLoadScalingTriggerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AverageLoadScalingTriggerResponseInput)(nil)).Elem(), AverageLoadScalingTriggerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureInternalMonitoringPipelineSinkDescriptionInput)(nil)).Elem(), AzureInternalMonitoringPipelineSinkDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureInternalMonitoringPipelineSinkDescriptionArrayInput)(nil)).Elem(), AzureInternalMonitoringPipelineSinkDescriptionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureInternalMonitoringPipelineSinkDescriptionResponseInput)(nil)).Elem(), AzureInternalMonitoringPipelineSinkDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureInternalMonitoringPipelineSinkDescriptionResponseArrayInput)(nil)).Elem(), AzureInternalMonitoringPipelineSinkDescriptionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerCodePackagePropertiesInput)(nil)).Elem(), ContainerCodePackagePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerCodePackagePropertiesArrayInput)(nil)).Elem(), ContainerCodePackagePropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerCodePackagePropertiesResponseInput)(nil)).Elem(), ContainerCodePackagePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerCodePackagePropertiesResponseArrayInput)(nil)).Elem(), ContainerCodePackagePropertiesResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerInstanceViewResponseInput)(nil)).Elem(), ContainerInstanceViewResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerLabelResponseInput)(nil)).Elem(), ContainerLabelResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerLabelResponseArrayInput)(nil)).Elem(), ContainerLabelResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticsDescriptionInput)(nil)).Elem(), DiagnosticsDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticsDescriptionPtrInput)(nil)).Elem(), DiagnosticsDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticsDescriptionResponseInput)(nil)).Elem(), DiagnosticsDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticsDescriptionResponsePtrInput)(nil)).Elem(), DiagnosticsDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticsRefInput)(nil)).Elem(), DiagnosticsRefArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticsRefPtrInput)(nil)).Elem(), DiagnosticsRefArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticsRefResponseInput)(nil)).Elem(), DiagnosticsRefResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DiagnosticsRefResponsePtrInput)(nil)).Elem(), DiagnosticsRefResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointPropertiesInput)(nil)).Elem(), EndpointPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointPropertiesArrayInput)(nil)).Elem(), EndpointPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointPropertiesResponseInput)(nil)).Elem(), EndpointPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointPropertiesResponseArrayInput)(nil)).Elem(), EndpointPropertiesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointRefInput)(nil)).Elem(), EndpointRefArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointRefArrayInput)(nil)).Elem(), EndpointRefArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointRefResponseInput)(nil)).Elem(), EndpointRefResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EndpointRefResponseArrayInput)(nil)).Elem(), EndpointRefResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GatewayDestinationInput)(nil)).Elem(), GatewayDestinationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GatewayDestinationResponseInput)(nil)).Elem(), GatewayDestinationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpConfigInput)(nil)).Elem(), HttpConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpConfigArrayInput)(nil)).Elem(), HttpConfigArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpConfigResponseInput)(nil)).Elem(), HttpConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpConfigResponseArrayInput)(nil)).Elem(), HttpConfigResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpHostConfigInput)(nil)).Elem(), HttpHostConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpHostConfigArrayInput)(nil)).Elem(), HttpHostConfigArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpHostConfigResponseInput)(nil)).Elem(), HttpHostConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpHostConfigResponseArrayInput)(nil)).Elem(), HttpHostConfigResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpRouteConfigInput)(nil)).Elem(), HttpRouteConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpRouteConfigArrayInput)(nil)).Elem(), HttpRouteConfigArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpRouteConfigResponseInput)(nil)).Elem(), HttpRouteConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpRouteConfigResponseArrayInput)(nil)).Elem(), HttpRouteConfigResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpRouteMatchHeaderInput)(nil)).Elem(), HttpRouteMatchHeaderArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpRouteMatchHeaderArrayInput)(nil)).Elem(), HttpRouteMatchHeaderArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpRouteMatchHeaderResponseInput)(nil)).Elem(), HttpRouteMatchHeaderResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpRouteMatchHeaderResponseArrayInput)(nil)).Elem(), HttpRouteMatchHeaderResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpRouteMatchPathInput)(nil)).Elem(), HttpRouteMatchPathArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpRouteMatchPathResponseInput)(nil)).Elem(), HttpRouteMatchPathResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpRouteMatchRuleInput)(nil)).Elem(), HttpRouteMatchRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HttpRouteMatchRuleResponseInput)(nil)).Elem(), HttpRouteMatchRuleResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRefInput)(nil)).Elem(), NetworkRefArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRefPtrInput)(nil)).Elem(), NetworkRefArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRefArrayInput)(nil)).Elem(), NetworkRefArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRefResponseInput)(nil)).Elem(), NetworkRefResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRefResponsePtrInput)(nil)).Elem(), NetworkRefResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRefResponseArrayInput)(nil)).Elem(), NetworkRefResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkResourcePropertiesInput)(nil)).Elem(), NetworkResourcePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkResourcePropertiesPtrInput)(nil)).Elem(), NetworkResourcePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkResourcePropertiesResponseInput)(nil)).Elem(), NetworkResourcePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkResourcePropertiesResponsePtrInput)(nil)).Elem(), NetworkResourcePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReliableCollectionsRefInput)(nil)).Elem(), ReliableCollectionsRefArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReliableCollectionsRefArrayInput)(nil)).Elem(), ReliableCollectionsRefArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReliableCollectionsRefResponseInput)(nil)).Elem(), ReliableCollectionsRefResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReliableCollectionsRefResponseArrayInput)(nil)).Elem(), ReliableCollectionsRefResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SecretResourcePropertiesInput)(nil)).Elem(), SecretResourcePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretResourcePropertiesPtrInput)(nil)).Elem(), SecretResourcePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretResourcePropertiesResponseInput)(nil)).Elem(), SecretResourcePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SecretResourcePropertiesResponsePtrInput)(nil)).Elem(), SecretResourcePropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceResourceDescriptionInput)(nil)).Elem(), ServiceResourceDescriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceResourceDescriptionArrayInput)(nil)).Elem(), ServiceResourceDescriptionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceResourceDescriptionResponseInput)(nil)).Elem(), ServiceResourceDescriptionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServiceResourceDescriptionResponseArrayInput)(nil)).Elem(), ServiceResourceDescriptionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SettingInput)(nil)).Elem(), SettingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SettingArrayInput)(nil)).Elem(), SettingArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SettingResponseInput)(nil)).Elem(), SettingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SettingResponseArrayInput)(nil)).Elem(), SettingResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TcpConfigInput)(nil)).Elem(), TcpConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TcpConfigArrayInput)(nil)).Elem(), TcpConfigArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TcpConfigResponseInput)(nil)).Elem(), TcpConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TcpConfigResponseArrayInput)(nil)).Elem(), TcpConfigResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeProviderParametersAzureFileInput)(nil)).Elem(), VolumeProviderParametersAzureFileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeProviderParametersAzureFilePtrInput)(nil)).Elem(), VolumeProviderParametersAzureFileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeProviderParametersAzureFileResponseInput)(nil)).Elem(), VolumeProviderParametersAzureFileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeProviderParametersAzureFileResponsePtrInput)(nil)).Elem(), VolumeProviderParametersAzureFileResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeReferenceResponseInput)(nil)).Elem(), VolumeReferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeReferenceResponseArrayInput)(nil)).Elem(), VolumeReferenceResponseArray{})
