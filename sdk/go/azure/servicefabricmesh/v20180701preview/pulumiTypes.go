...
func (o IngressConfigResponseOutput) ToIngressConfigResponsePtrOutputWithContext(ctx context.Context) IngressConfigResponsePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v IngressConfigResponse) *IngressConfigResponse {
		return &v
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerVolumeResponseInput)(nil)).Elem(), ContainerVolumeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ContainerVolumeResponseArrayInput)(nil)).Elem(), ContainerVolumeResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IngressConfigResponseInput)(nil)).Elem(), IngressConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IngressConfigResponsePtrInput)(nil)).Elem(), IngressConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*Layer4IngressConfigInput)(nil)).Elem(), Layer4IngressConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*Layer4IngressConfigArrayInput)(nil)).Elem(), Layer4IngressConfigArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*Layer4IngressConfigResponseInput)(nil)).Elem(), Layer4IngressConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*Layer4IngressConfigResponseArrayInput)(nil)).Elem(), Layer4IngressConfigResponseArray{})
