...
type ContainerCodePackagePropertiesInvokeResponse struct {
	...
	// The volumes to be attached to the container.
	VolumeRefs []ContainerVolumeInvokeResponse `pulumi:"volumeRefs"`
}
...
type ContainerCodePackagePropertiesInvokeResponseArgs struct {
	...
	// The volumes to be attached to the container.
	VolumeRefs ContainerVolumeInvokeResponseArrayInput `pulumi:"volumeRefs"`
}
...
// The volumes to be attached to the container.
func (o ContainerCodePackagePropertiesInvokeResponseOutput) VolumeRefs() ContainerVolumeInvokeResponseArrayOutput {
	return o.ApplyT(func(v ContainerCodePackagePropertiesInvokeResponse) []ContainerVolumeInvokeResponse {
		return v.VolumeRefs
	}).(ContainerVolumeInvokeResponseArrayOutput)
}
...
// Describes how a volume is attached to a container.
type ContainerVolumeInvokeResponse struct {
	// The path within the container at which the volume should be mounted. Only valid path characters are allowed.
	DestinationPath string `pulumi:"destinationPath"`
	// Name of the volume.
	Name string `pulumi:"name"`
...
// ContainerVolumeInvokeResponseInput is an input type that accepts ContainerVolumeInvokeResponseArgs and ContainerVolumeInvokeResponseOutput values.
// You can construct a concrete instance of `ContainerVolumeInvokeResponseInput` via:
//
//          ContainerVolumeInvokeResponseArgs{...}
type ContainerVolumeInvokeResponseInput interface {
	pulumi.Input

	ToContainerVolumeInvokeResponseOutput() ContainerVolumeInvokeResponseOutput
	ToContainerVolumeInvokeResponseOutputWithContext(context.Context) ContainerVolumeInvokeResponseOutput
}

// Describes how a volume is attached to a container.
type ContainerVolumeInvokeResponseArgs struct {
	// The path within the container at which the volume should be mounted. Only valid path characters are allowed.
	DestinationPath pulumi.StringInput `pulumi:"destinationPath"`
	// Name of the volume.
	Name pulumi.StringInput `pulumi:"name"`
...
func (ContainerVolumeInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ContainerVolumeInvokeResponse)(nil)).Elem()
}

func (i ContainerVolumeInvokeResponseArgs) ToContainerVolumeInvokeResponseOutput() ContainerVolumeInvokeResponseOutput {
	return i.ToContainerVolumeInvokeResponseOutputWithContext(context.Background())
}

func (i ContainerVolumeInvokeResponseArgs) ToContainerVolumeInvokeResponseOutputWithContext(ctx context.Context) ContainerVolumeInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ContainerVolumeInvokeResponseOutput)
}

// ContainerVolumeInvokeResponseArrayInput is an input type that accepts ContainerVolumeInvokeResponseArray and ContainerVolumeInvokeResponseArrayOutput values.
// You can construct a concrete instance of `ContainerVolumeInvokeResponseArrayInput` via:
//
//          ContainerVolumeInvokeResponseArray{ ContainerVolumeInvokeResponseArgs{...} }
type ContainerVolumeInvokeResponseArrayInput interface {
	pulumi.Input

	ToContainerVolumeInvokeResponseArrayOutput() ContainerVolumeInvokeResponseArrayOutput
	ToContainerVolumeInvokeResponseArrayOutputWithContext(context.Context) ContainerVolumeInvokeResponseArrayOutput
}

type ContainerVolumeInvokeResponseArray []ContainerVolumeInvokeResponseInput

func (ContainerVolumeInvokeResponseArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ContainerVolumeInvokeResponse)(nil)).Elem()
}

func (i ContainerVolumeInvokeResponseArray) ToContainerVolumeInvokeResponseArrayOutput() ContainerVolumeInvokeResponseArrayOutput {
	return i.ToContainerVolumeInvokeResponseArrayOutputWithContext(context.Background())
}

func (i ContainerVolumeInvokeResponseArray) ToContainerVolumeInvokeResponseArrayOutputWithContext(ctx context.Context) ContainerVolumeInvokeResponseArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ContainerVolumeInvokeResponseArrayOutput)
}

// Describes how a volume is attached to a container.
type ContainerVolumeInvokeResponseOutput struct{ *pulumi.OutputState }

func (ContainerVolumeInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ContainerVolumeInvokeResponse)(nil)).Elem()
}

func (o ContainerVolumeInvokeResponseOutput) ToContainerVolumeInvokeResponseOutput() ContainerVolumeInvokeResponseOutput {
	return o
}

func (o ContainerVolumeInvokeResponseOutput) ToContainerVolumeInvokeResponseOutputWithContext(ctx context.Context) ContainerVolumeInvokeResponseOutput {
	return o
}

// The path within the container at which the volume should be mounted. Only valid path characters are allowed.
func (o ContainerVolumeInvokeResponseOutput) DestinationPath() pulumi.StringOutput {
	return o.ApplyT(func(v ContainerVolumeInvokeResponse) string { return v.DestinationPath }).(pulumi.StringOutput)
}

// Name of the volume.
func (o ContainerVolumeInvokeResponseOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v ContainerVolumeInvokeResponse) string { return v.Name }).(pulumi.StringOutput)
}

// The flag indicating whether the volume is read only. Default is 'false'.
func (o ContainerVolumeInvokeResponseOutput) ReadOnly() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v ContainerVolumeInvokeResponse) *bool { return v.ReadOnly }).(pulumi.BoolPtrOutput)
}

type ContainerVolumeInvokeResponseArrayOutput struct{ *pulumi.OutputState }

func (ContainerVolumeInvokeResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ContainerVolumeInvokeResponse)(nil)).Elem()
}

func (o ContainerVolumeInvokeResponseArrayOutput) ToContainerVolumeInvokeResponseArrayOutput() ContainerVolumeInvokeResponseArrayOutput {
	return o
}

func (o ContainerVolumeInvokeResponseArrayOutput) ToContainerVolumeInvokeResponseArrayOutputWithContext(ctx context.Context) ContainerVolumeInvokeResponseArrayOutput {
	return o
}

func (o ContainerVolumeInvokeResponseArrayOutput) Index(i pulumi.IntInput) ContainerVolumeInvokeResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) ContainerVolumeInvokeResponse {
		return vs[0].([]ContainerVolumeInvokeResponse)[vs[1].(int)]
	}).(ContainerVolumeInvokeResponseOutput)
}
...
// Describes public connectivity configuration for the network.
type IngressConfigInvokeResponse struct {
	// Configuration for layer4 public connectivity for this network.
	Layer4 []Layer4IngressConfigInvokeResponse `pulumi:"layer4"`
...
// IngressConfigInvokeResponseInput is an input type that accepts IngressConfigInvokeResponseArgs and IngressConfigInvokeResponseOutput values.
// You can construct a concrete instance of `IngressConfigInvokeResponseInput` via:
//
//          IngressConfigInvokeResponseArgs{...}
type IngressConfigInvokeResponseInput interface {
	pulumi.Input

	ToIngressConfigInvokeResponseOutput() IngressConfigInvokeResponseOutput
	ToIngressConfigInvokeResponseOutputWithContext(context.Context) IngressConfigInvokeResponseOutput
}

// Describes public connectivity configuration for the network.
type IngressConfigInvokeResponseArgs struct {
	// Configuration for layer4 public connectivity for this network.
	Layer4 Layer4IngressConfigInvokeResponseArrayInput `pulumi:"layer4"`
	// The public IP address for reaching this network.
...
func (IngressConfigInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*IngressConfigInvokeResponse)(nil)).Elem()
}

func (i IngressConfigInvokeResponseArgs) ToIngressConfigInvokeResponseOutput() IngressConfigInvokeResponseOutput {
	return i.ToIngressConfigInvokeResponseOutputWithContext(context.Background())
}

func (i IngressConfigInvokeResponseArgs) ToIngressConfigInvokeResponseOutputWithContext(ctx context.Context) IngressConfigInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IngressConfigInvokeResponseOutput)
}

// Describes public connectivity configuration for the network.
type IngressConfigInvokeResponseOutput struct{ *pulumi.OutputState }

func (IngressConfigInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*IngressConfigInvokeResponse)(nil)).Elem()
}

func (o IngressConfigInvokeResponseOutput) ToIngressConfigInvokeResponseOutput() IngressConfigInvokeResponseOutput {
	return o
}

func (o IngressConfigInvokeResponseOutput) ToIngressConfigInvokeResponseOutputWithContext(ctx context.Context) IngressConfigInvokeResponseOutput {
	return o
}

// Configuration for layer4 public connectivity for this network.
func (o IngressConfigInvokeResponseOutput) Layer4() Layer4IngressConfigInvokeResponseArrayOutput {
	return o.ApplyT(func(v IngressConfigInvokeResponse) []Layer4IngressConfigInvokeResponse { return v.Layer4 }).(Layer4IngressConfigInvokeResponseArrayOutput)
}

// The public IP address for reaching this network.
func (o IngressConfigInvokeResponseOutput) PublicIPAddress() pulumi.StringOutput {
	return o.ApplyT(func(v IngressConfigInvokeResponse) string { return v.PublicIPAddress }).(pulumi.StringOutput)
}

// The QoS tier for ingress.
func (o IngressConfigInvokeResponseOutput) QosLevel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IngressConfigInvokeResponse) *string { return v.QosLevel }).(pulumi.StringPtrOutput)
}
...
// Describes the layer4 configuration for public connectivity for this network.
type Layer4IngressConfigInvokeResponse struct {
	// The application name which contains the service to be exposed.
	ApplicationName *string `pulumi:"applicationName"`
	// The service endpoint that needs to be exposed.
	EndpointName *string `pulumi:"endpointName"`
...
// Layer4IngressConfigInvokeResponseInput is an input type that accepts Layer4IngressConfigInvokeResponseArgs and Layer4IngressConfigInvokeResponseOutput values.
// You can construct a concrete instance of `Layer4IngressConfigInvokeResponseInput` via:
//
//          Layer4IngressConfigInvokeResponseArgs{...}
type Layer4IngressConfigInvokeResponseInput interface {
	pulumi.Input

	ToLayer4IngressConfigInvokeResponseOutput() Layer4IngressConfigInvokeResponseOutput
	ToLayer4IngressConfigInvokeResponseOutputWithContext(context.Context) Layer4IngressConfigInvokeResponseOutput
}

// Describes the layer4 configuration for public connectivity for this network.
type Layer4IngressConfigInvokeResponseArgs struct {
	// The application name which contains the service to be exposed.
	ApplicationName pulumi.StringPtrInput `pulumi:"applicationName"`
	// The service endpoint that needs to be exposed.
	EndpointName pulumi.StringPtrInput `pulumi:"endpointName"`
...
func (Layer4IngressConfigInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*Layer4IngressConfigInvokeResponse)(nil)).Elem()
}

func (i Layer4IngressConfigInvokeResponseArgs) ToLayer4IngressConfigInvokeResponseOutput() Layer4IngressConfigInvokeResponseOutput {
	return i.ToLayer4IngressConfigInvokeResponseOutputWithContext(context.Background())
}

func (i Layer4IngressConfigInvokeResponseArgs) ToLayer4IngressConfigInvokeResponseOutputWithContext(ctx context.Context) Layer4IngressConfigInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(Layer4IngressConfigInvokeResponseOutput)
}

// Layer4IngressConfigInvokeResponseArrayInput is an input type that accepts Layer4IngressConfigInvokeResponseArray and Layer4IngressConfigInvokeResponseArrayOutput values.
// You can construct a concrete instance of `Layer4IngressConfigInvokeResponseArrayInput` via:
//
//          Layer4IngressConfigInvokeResponseArray{ Layer4IngressConfigInvokeResponseArgs{...} }
type Layer4IngressConfigInvokeResponseArrayInput interface {
	pulumi.Input

	ToLayer4IngressConfigInvokeResponseArrayOutput() Layer4IngressConfigInvokeResponseArrayOutput
	ToLayer4IngressConfigInvokeResponseArrayOutputWithContext(context.Context) Layer4IngressConfigInvokeResponseArrayOutput
}

type Layer4IngressConfigInvokeResponseArray []Layer4IngressConfigInvokeResponseInput

func (Layer4IngressConfigInvokeResponseArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]Layer4IngressConfigInvokeResponse)(nil)).Elem()
}

func (i Layer4IngressConfigInvokeResponseArray) ToLayer4IngressConfigInvokeResponseArrayOutput() Layer4IngressConfigInvokeResponseArrayOutput {
	return i.ToLayer4IngressConfigInvokeResponseArrayOutputWithContext(context.Background())
}

func (i Layer4IngressConfigInvokeResponseArray) ToLayer4IngressConfigInvokeResponseArrayOutputWithContext(ctx context.Context) Layer4IngressConfigInvokeResponseArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(Layer4IngressConfigInvokeResponseArrayOutput)
}

// Describes the layer4 configuration for public connectivity for this network.
type Layer4IngressConfigInvokeResponseOutput struct{ *pulumi.OutputState }

func (Layer4IngressConfigInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*Layer4IngressConfigInvokeResponse)(nil)).Elem()
}

func (o Layer4IngressConfigInvokeResponseOutput) ToLayer4IngressConfigInvokeResponseOutput() Layer4IngressConfigInvokeResponseOutput {
	return o
}

func (o Layer4IngressConfigInvokeResponseOutput) ToLayer4IngressConfigInvokeResponseOutputWithContext(ctx context.Context) Layer4IngressConfigInvokeResponseOutput {
	return o
}

// The application name which contains the service to be exposed.
func (o Layer4IngressConfigInvokeResponseOutput) ApplicationName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v Layer4IngressConfigInvokeResponse) *string { return v.ApplicationName }).(pulumi.StringPtrOutput)
}

// The service endpoint that needs to be exposed.
func (o Layer4IngressConfigInvokeResponseOutput) EndpointName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v Layer4IngressConfigInvokeResponse) *string { return v.EndpointName }).(pulumi.StringPtrOutput)
}

// Layer4 ingress config name.
func (o Layer4IngressConfigInvokeResponseOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v Layer4IngressConfigInvokeResponse) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// Specifies the public port at which the service endpoint below needs to be exposed.
func (o Layer4IngressConfigInvokeResponseOutput) PublicPort() pulumi.IntPtrOutput {
	return o.ApplyT(func(v Layer4IngressConfigInvokeResponse) *int { return v.PublicPort }).(pulumi.IntPtrOutput)
}

// The service whose endpoint needs to be exposed at the public port.
func (o Layer4IngressConfigInvokeResponseOutput) ServiceName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v Layer4IngressConfigInvokeResponse) *string { return v.ServiceName }).(pulumi.StringPtrOutput)
}

type Layer4IngressConfigInvokeResponseArrayOutput struct{ *pulumi.OutputState }

func (Layer4IngressConfigInvokeResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]Layer4IngressConfigInvokeResponse)(nil)).Elem()
}

func (o Layer4IngressConfigInvokeResponseArrayOutput) ToLayer4IngressConfigInvokeResponseArrayOutput() Layer4IngressConfigInvokeResponseArrayOutput {
	return o
}

func (o Layer4IngressConfigInvokeResponseArrayOutput) ToLayer4IngressConfigInvokeResponseArrayOutputWithContext(ctx context.Context) Layer4IngressConfigInvokeResponseArrayOutput {
	return o
}

func (o Layer4IngressConfigInvokeResponseArrayOutput) Index(i pulumi.IntInput) Layer4IngressConfigInvokeResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) Layer4IngressConfigInvokeResponse {
		return vs[0].([]Layer4IngressConfigInvokeResponse)[vs[1].(int)]
	}).(Layer4IngressConfigInvokeResponseOutput)
}
...
// The health state of a resource such as Application, Service, or Network.
func (o ServiceResourceDescriptionInvokeResponseOutput) HealthState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ServiceResourceDescriptionInvokeResponse) *string { return v.HealthState }).(pulumi.StringPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ContainerVolumeInvokeResponseOutput{})
	pulumi.RegisterOutputType(ContainerVolumeInvokeResponseArrayOutput{})
	...
	pulumi.RegisterOutputType(IngressConfigInvokeResponseOutput{})
	...
	pulumi.RegisterOutputType(Layer4IngressConfigInvokeResponseOutput{})
	pulumi.RegisterOutputType(Layer4IngressConfigInvokeResponseArrayOutput{})
