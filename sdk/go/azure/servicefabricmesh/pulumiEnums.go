...
// ApplicationScopedVolumeKindInput is an input type that accepts ApplicationScopedVolumeKindArgs and ApplicationScopedVolumeKindOutput values.
// You can construct a concrete instance of `ApplicationScopedVolumeKindInput` via:
//
//          ApplicationScopedVolumeKindArgs{...}
...
// AutoScalingMechanismKindInput is an input type that accepts AutoScalingMechanismKindArgs and AutoScalingMechanismKindOutput values.
// You can construct a concrete instance of `AutoScalingMechanismKindInput` via:
//
//          AutoScalingMechanismKindArgs{...}
...
// AutoScalingMetricKindInput is an input type that accepts AutoScalingMetricKindArgs and AutoScalingMetricKindOutput values.
// You can construct a concrete instance of `AutoScalingMetricKindInput` via:
//
//          AutoScalingMetricKindArgs{...}
...
// AutoScalingResourceMetricNameInput is an input type that accepts AutoScalingResourceMetricNameArgs and AutoScalingResourceMetricNameOutput values.
// You can construct a concrete instance of `AutoScalingResourceMetricNameInput` via:
//
...
// AutoScalingTriggerKindInput is an input type that accepts AutoScalingTriggerKindArgs and AutoScalingTriggerKindOutput values.
// You can construct a concrete instance of `AutoScalingTriggerKindInput` via:
//
//          AutoScalingTriggerKindArgs{...}
...
// HeaderMatchTypeInput is an input type that accepts HeaderMatchTypeArgs and HeaderMatchTypeOutput values.
// You can construct a concrete instance of `HeaderMatchTypeInput` via:
//
//          HeaderMatchTypeArgs{...}
...
// NetworkKindInput is an input type that accepts NetworkKindArgs and NetworkKindOutput values.
// You can construct a concrete instance of `NetworkKindInput` via:
//
//          NetworkKindArgs{...}
...
// PathMatchTypeInput is an input type that accepts PathMatchTypeArgs and PathMatchTypeOutput values.
// You can construct a concrete instance of `PathMatchTypeInput` via:
//
//          PathMatchTypeArgs{...}
...
// SecretKindInput is an input type that accepts SecretKindArgs and SecretKindOutput values.
// You can construct a concrete instance of `SecretKindInput` via:
//
//          SecretKindArgs{...}
...
// SizeTypesInput is an input type that accepts SizeTypesArgs and SizeTypesOutput values.
// You can construct a concrete instance of `SizeTypesInput` via:
//
//          SizeTypesArgs{...}
