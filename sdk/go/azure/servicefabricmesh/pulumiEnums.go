...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationScopedVolumeKindInput)(nil)).Elem(), ApplicationScopedVolumeKind("ServiceFabricVolumeDisk"))
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationScopedVolumeKindPtrInput)(nil)).Elem(), ApplicationScopedVolumeKind("ServiceFabricVolumeDisk"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalingMechanismKindInput)(nil)).Elem(), AutoScalingMechanismKind("AddRemoveReplica"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalingMechanismKindPtrInput)(nil)).Elem(), AutoScalingMechanismKind("AddRemoveReplica"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalingMetricKindInput)(nil)).Elem(), AutoScalingMetricKind("Resource"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalingMetricKindPtrInput)(nil)).Elem(), AutoScalingMetricKind("Resource"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalingResourceMetricNameInput)(nil)).Elem(), AutoScalingResourceMetricName("cpu"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalingResourceMetricNamePtrInput)(nil)).Elem(), AutoScalingResourceMetricName("cpu"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalingTriggerKindInput)(nil)).Elem(), AutoScalingTriggerKind("AverageLoad"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutoScalingTriggerKindPtrInput)(nil)).Elem(), AutoScalingTriggerKind("AverageLoad"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderMatchTypeInput)(nil)).Elem(), HeaderMatchType("exact"))
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderMatchTypePtrInput)(nil)).Elem(), HeaderMatchType("exact"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkKindInput)(nil)).Elem(), NetworkKind("Local"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkKindPtrInput)(nil)).Elem(), NetworkKind("Local"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PathMatchTypeInput)(nil)).Elem(), PathMatchType("prefix"))
	pulumi.RegisterInputType(reflect.TypeOf((*PathMatchTypePtrInput)(nil)).Elem(), PathMatchType("prefix"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecretKindInput)(nil)).Elem(), SecretKind("inlinedValue"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecretKindPtrInput)(nil)).Elem(), SecretKind("inlinedValue"))
	pulumi.RegisterInputType(reflect.TypeOf((*SizeTypesInput)(nil)).Elem(), SizeTypes("Small"))
	pulumi.RegisterInputType(reflect.TypeOf((*SizeTypesPtrInput)(nil)).Elem(), SizeTypes("Small"))
