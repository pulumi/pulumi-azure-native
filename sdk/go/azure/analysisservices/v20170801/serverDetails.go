...
func NewServerDetails(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:analysisservices/v20170801:ServerDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerDetails(ctx *pulumi.Context,
	...
	var resource ServerDetails
	err := ctx.ReadResource("azure-nextgen:analysisservices/v20170801:ServerDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
