...
func NewNotificationHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:notificationhubs/v20170401:NotificationHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationHub(ctx *pulumi.Context,
	...
	var resource NotificationHub
	err := ctx.ReadResource("azure-nextgen:notificationhubs/v20170401:NotificationHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
