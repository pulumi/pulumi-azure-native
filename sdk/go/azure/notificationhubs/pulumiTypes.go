...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SharedAccessAuthorizationRulePropertiesPtrInput)(nil)).Elem(), SharedAccessAuthorizationRulePropertiesArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SharedAccessAuthorizationRuleResourceResponseInput)(nil)).Elem(), SharedAccessAuthorizationRuleResourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SharedAccessAuthorizationRuleResourceResponseArrayInput)(nil)).Elem(), SharedAccessAuthorizationRuleResourceResponseArray{})
