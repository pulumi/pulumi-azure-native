...
// ConnectivityStatusInput is an input type that accepts ConnectivityStatusArgs and ConnectivityStatusOutput values.
// You can construct a concrete instance of `ConnectivityStatusInput` via:
//
//          ConnectivityStatusArgs{...}
