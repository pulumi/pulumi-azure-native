...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkStateInput)(nil)).Elem(), PrivateLinkState("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateLinkStatePtrInput)(nil)).Elem(), PrivateLinkState("Enabled"))
