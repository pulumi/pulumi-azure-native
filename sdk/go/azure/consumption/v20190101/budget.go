...
func NewBudget(ctx *pulumi.Context,
	...
	var resource Budget
	err := ctx.RegisterResource("azure-nextgen:consumption/v20190101:Budget", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBudget(ctx *pulumi.Context,
	...
	var resource Budget
	err := ctx.ReadResource("azure-nextgen:consumption/v20190101:Budget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
