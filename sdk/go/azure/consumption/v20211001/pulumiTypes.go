...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetComparisonExpressionInput)(nil)).Elem(), BudgetComparisonExpressionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetComparisonExpressionPtrInput)(nil)).Elem(), BudgetComparisonExpressionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetComparisonExpressionResponseInput)(nil)).Elem(), BudgetComparisonExpressionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetComparisonExpressionResponsePtrInput)(nil)).Elem(), BudgetComparisonExpressionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetFilterInput)(nil)).Elem(), BudgetFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetFilterPtrInput)(nil)).Elem(), BudgetFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetFilterPropertiesInput)(nil)).Elem(), BudgetFilterPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetFilterPropertiesPtrInput)(nil)).Elem(), BudgetFilterPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetFilterPropertiesArrayInput)(nil)).Elem(), BudgetFilterPropertiesArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetFilterPropertiesResponseInput)(nil)).Elem(), BudgetFilterPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetFilterPropertiesResponsePtrInput)(nil)).Elem(), BudgetFilterPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetFilterPropertiesResponseArrayInput)(nil)).Elem(), BudgetFilterPropertiesResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetFilterResponseInput)(nil)).Elem(), BudgetFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BudgetFilterResponsePtrInput)(nil)).Elem(), BudgetFilterResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ForecastSpendResponseInput)(nil)).Elem(), ForecastSpendResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ForecastSpendResponsePtrInput)(nil)).Elem(), ForecastSpendResponseArgs{})
