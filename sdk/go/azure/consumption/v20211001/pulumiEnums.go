...
// BudgetOperatorTypeInput is an input type that accepts BudgetOperatorTypeArgs and BudgetOperatorTypeOutput values.
// You can construct a concrete instance of `BudgetOperatorTypeInput` via:
//
...
// ThresholdTypeInput is an input type that accepts ThresholdTypeArgs and ThresholdTypeOutput values.
// You can construct a concrete instance of `ThresholdTypeInput` via:
//
//          ThresholdTypeArgs{...}
