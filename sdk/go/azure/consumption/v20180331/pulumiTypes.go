...
// The dictionary of filters on tags.
func (o FiltersInvokeResponseOutput) Tags() pulumi.StringArrayMapOutput {
	return o.ApplyT(func(v FiltersInvokeResponse) map[string][]string { return v.Tags }).(pulumi.StringArrayMapOutput)
}
