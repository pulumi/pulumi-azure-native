...
// CultureCodeInput is an input type that accepts CultureCodeArgs and CultureCodeOutput values.
// You can construct a concrete instance of `CultureCodeInput` via:
//
//          CultureCodeArgs{...}
