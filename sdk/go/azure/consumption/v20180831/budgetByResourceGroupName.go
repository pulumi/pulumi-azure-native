...
func NewBudgetByResourceGroupName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:consumption/v20180831:BudgetByResourceGroupName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBudgetByResourceGroupName(ctx *pulumi.Context,
	...
	var resource BudgetByResourceGroupName
	err := ctx.ReadResource("azure-nextgen:consumption/v20180831:BudgetByResourceGroupName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
