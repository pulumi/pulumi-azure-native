...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AvsDataStoreInput)(nil)).Elem(), AvsDataStore("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*AvsDataStorePtrInput)(nil)).Elem(), AvsDataStore("Enabled"))
