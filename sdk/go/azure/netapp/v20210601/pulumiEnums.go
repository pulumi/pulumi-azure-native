...
// AvsDataStoreInput is an input type that accepts AvsDataStoreArgs and AvsDataStoreOutput values.
// You can construct a concrete instance of `AvsDataStoreInput` via:
//
//          AvsDataStoreArgs{...}
