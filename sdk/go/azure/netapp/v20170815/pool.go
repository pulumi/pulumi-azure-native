...
func NewPool(ctx *pulumi.Context,
	...
	if isZero(args.Size) {
		args.Size = pulumi.Float64Ptr(4398046511104.0)
	}
	...
	var resource Pool
	err := ctx.RegisterResource("azure-native:netapp/v20170815:Pool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.ReadResource("azure-native:netapp/v20170815:Pool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o PoolOutput) ServiceLevel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Pool) pulumi.StringPtrOutput { return v.ServiceLevel }).(pulumi.StringPtrOutput)
}

func (o PoolOutput) Size() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *Pool) pulumi.Float64PtrOutput { return v.Size }).(pulumi.Float64PtrOutput)
}
