...
func NewBackupPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:netapp/v20200901:BackupPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupPolicy(ctx *pulumi.Context,
	...
	var resource BackupPolicy
	err := ctx.ReadResource("azure-nextgen:netapp/v20200901:BackupPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
