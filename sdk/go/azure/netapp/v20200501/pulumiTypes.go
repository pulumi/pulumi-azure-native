...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DailyScheduleInput)(nil)).Elem(), DailyScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DailySchedulePtrInput)(nil)).Elem(), DailyScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DailyScheduleResponseInput)(nil)).Elem(), DailyScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DailyScheduleResponsePtrInput)(nil)).Elem(), DailyScheduleResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HourlyScheduleInput)(nil)).Elem(), HourlyScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HourlySchedulePtrInput)(nil)).Elem(), HourlyScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HourlyScheduleResponseInput)(nil)).Elem(), HourlyScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HourlyScheduleResponsePtrInput)(nil)).Elem(), HourlyScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MonthlyScheduleInput)(nil)).Elem(), MonthlyScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MonthlySchedulePtrInput)(nil)).Elem(), MonthlyScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MonthlyScheduleResponseInput)(nil)).Elem(), MonthlyScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MonthlyScheduleResponsePtrInput)(nil)).Elem(), MonthlyScheduleResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeBackupPropertiesInput)(nil)).Elem(), VolumeBackupPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeBackupPropertiesPtrInput)(nil)).Elem(), VolumeBackupPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeBackupPropertiesResponseInput)(nil)).Elem(), VolumeBackupPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeBackupPropertiesResponsePtrInput)(nil)).Elem(), VolumeBackupPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeBackupsInput)(nil)).Elem(), VolumeBackupsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeBackupsArrayInput)(nil)).Elem(), VolumeBackupsArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeBackupsResponseInput)(nil)).Elem(), VolumeBackupsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeBackupsResponseArrayInput)(nil)).Elem(), VolumeBackupsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WeeklyScheduleResponseInput)(nil)).Elem(), WeeklyScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WeeklyScheduleResponsePtrInput)(nil)).Elem(), WeeklyScheduleResponseArgs{})
