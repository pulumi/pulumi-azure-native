...
func NewSnapshotPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:netapp/v20200501:SnapshotPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshotPolicy(ctx *pulumi.Context,
	...
	var resource SnapshotPolicy
	err := ctx.ReadResource("azure-nextgen:netapp/v20200501:SnapshotPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
