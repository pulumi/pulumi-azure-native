...
// PoolServiceLevelInput is an input type that accepts PoolServiceLevelArgs and PoolServiceLevelOutput values.
// You can construct a concrete instance of `PoolServiceLevelInput` via:
//
//          PoolServiceLevelArgs{...}
...
// VolumeServiceLevelInput is an input type that accepts VolumeServiceLevelArgs and VolumeServiceLevelOutput values.
// You can construct a concrete instance of `VolumeServiceLevelInput` via:
//
//          VolumeServiceLevelArgs{...}
