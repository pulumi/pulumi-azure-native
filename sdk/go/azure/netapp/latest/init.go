...
func (m *module) Construct(ctx *pulumi.Context, name, typ, urn string) (r pulumi.Resource, err error) {
	switch typ {
	case "azure-nextgen:netapp/latest:Account":
		r, err = NewAccount(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:netapp/latest:Backup":
		r, err = NewBackup(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:netapp/latest:BackupPolicy":
		r, err = NewBackupPolicy(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:netapp/latest:Pool":
		r, err = NewPool(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:netapp/latest:Snapshot":
		r, err = NewSnapshot(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:netapp/latest:SnapshotPolicy":
		r, err = NewSnapshotPolicy(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:netapp/latest:Volume":
