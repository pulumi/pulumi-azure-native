...
func (m *module) Construct(ctx *pulumi.Context, name, typ, urn string) (r pulumi.Resource, err error) {
	switch typ {
	case "azure-nextgen:netapp/v20190601:Account":
		r, err = NewAccount(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:netapp/v20190601:Pool":
		r, err = NewPool(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:netapp/v20190601:Snapshot":
		r, err = NewSnapshot(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:netapp/v20190601:Volume":
