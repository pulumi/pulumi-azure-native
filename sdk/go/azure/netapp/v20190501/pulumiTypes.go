...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MountTargetPropertiesInput)(nil)).Elem(), MountTargetPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MountTargetPropertiesArrayInput)(nil)).Elem(), MountTargetPropertiesArray{})
