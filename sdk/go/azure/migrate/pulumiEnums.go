...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AssessmentSizingCriterionInput)(nil)).Elem(), AssessmentSizingCriterion("PerformanceBased"))
	pulumi.RegisterInputType(reflect.TypeOf((*AssessmentSizingCriterionPtrInput)(nil)).Elem(), AssessmentSizingCriterion("PerformanceBased"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AzureDiskTypeInput)(nil)).Elem(), AzureDiskType("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzureDiskTypePtrInput)(nil)).Elem(), AzureDiskType("Unknown"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AzureVmFamilyInput)(nil)).Elem(), AzureVmFamily("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzureVmFamilyPtrInput)(nil)).Elem(), AzureVmFamily("Unknown"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ProjectStatusInput)(nil)).Elem(), ProjectStatus("Active"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProjectStatusPtrInput)(nil)).Elem(), ProjectStatus("Active"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReservedInstanceInput)(nil)).Elem(), ReservedInstance("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*ReservedInstancePtrInput)(nil)).Elem(), ReservedInstance("None"))
