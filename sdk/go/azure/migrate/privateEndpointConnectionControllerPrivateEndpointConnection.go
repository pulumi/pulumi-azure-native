...
func NewPrivateEndpointConnectionControllerPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate:PrivateEndpointConnectionControllerPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionControllerPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionControllerPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:migrate:PrivateEndpointConnectionControllerPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
