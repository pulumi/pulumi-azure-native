...
func NewMigrateProject(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:migrate:MigrateProject", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMigrateProject(ctx *pulumi.Context,
	...
	var resource MigrateProject
	err := ctx.ReadResource("azure-nextgen:migrate:MigrateProject", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
