...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AssessmentStageInput)(nil)).Elem(), AssessmentStage("InProgress"))
	pulumi.RegisterInputType(reflect.TypeOf((*AssessmentStagePtrInput)(nil)).Elem(), AssessmentStage("InProgress"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzureHybridUseBenefitInput)(nil)).Elem(), AzureHybridUseBenefit("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzureHybridUseBenefitPtrInput)(nil)).Elem(), AzureHybridUseBenefit("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzureLocationInput)(nil)).Elem(), AzureLocation("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzureLocationPtrInput)(nil)).Elem(), AzureLocation("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzureOfferCodeInput)(nil)).Elem(), AzureOfferCode("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzureOfferCodePtrInput)(nil)).Elem(), AzureOfferCode("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzurePricingTierInput)(nil)).Elem(), AzurePricingTier("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzurePricingTierPtrInput)(nil)).Elem(), AzurePricingTier("Standard"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzureStorageRedundancyInput)(nil)).Elem(), AzureStorageRedundancy("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*AzureStorageRedundancyPtrInput)(nil)).Elem(), AzureStorageRedundancy("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*CurrencyInput)(nil)).Elem(), Currency("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*CurrencyPtrInput)(nil)).Elem(), Currency("Unknown"))
	pulumi.RegisterInputType(reflect.TypeOf((*PercentileInput)(nil)).Elem(), Percentile("Percentile50"))
	pulumi.RegisterInputType(reflect.TypeOf((*PercentilePtrInput)(nil)).Elem(), Percentile("Percentile50"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TimeRangeInput)(nil)).Elem(), TimeRange("Day"))
	pulumi.RegisterInputType(reflect.TypeOf((*TimeRangePtrInput)(nil)).Elem(), TimeRange("Day"))
