...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionStateRequestBodyPropertiesInput)(nil)).Elem(), ConnectionStateRequestBodyPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionStateRequestBodyPropertiesPtrInput)(nil)).Elem(), ConnectionStateRequestBodyPropertiesArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ProjectSummaryResponseInput)(nil)).Elem(), ProjectSummaryResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProjectSummaryResponseMapInput)(nil)).Elem(), ProjectSummaryResponseMap{})
