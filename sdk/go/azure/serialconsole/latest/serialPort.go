...
func NewSerialPort(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:serialconsole/latest:SerialPort", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSerialPort(ctx *pulumi.Context,
	...
	var resource SerialPort
	err := ctx.ReadResource("azure-native:serialconsole/latest:SerialPort", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
