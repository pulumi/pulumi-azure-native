...
type TemplateSpecVersion struct {
	...
	UiDefinition pulumi.AnyOutput `pulumi:"uiDefinition"`
}
...
func NewTemplateSpecVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:resources/v20201001preview:TemplateSpecVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTemplateSpecVersion(ctx *pulumi.Context,
	...
	var resource TemplateSpecVersion
	err := ctx.ReadResource("azure-nextgen:resources/v20201001preview:TemplateSpecVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
