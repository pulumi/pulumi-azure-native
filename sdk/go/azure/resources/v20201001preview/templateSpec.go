...
func NewTemplateSpec(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:resources/v20201001preview:TemplateSpec", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTemplateSpec(ctx *pulumi.Context,
	...
	var resource TemplateSpec
	err := ctx.ReadResource("azure-nextgen:resources/v20201001preview:TemplateSpec", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
