...
// CleanupOptionsInput is an input type that accepts CleanupOptionsArgs and CleanupOptionsOutput values.
// You can construct a concrete instance of `CleanupOptionsInput` via:
//
//          CleanupOptionsArgs{...}
...
// ScriptTypeInput is an input type that accepts ScriptTypeArgs and ScriptTypeOutput values.
// You can construct a concrete instance of `ScriptTypeInput` via:
//
//          ScriptTypeArgs{...}
