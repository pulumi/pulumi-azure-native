...
func NewResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:resources:Resource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResource(ctx *pulumi.Context,
	...
	var resource Resource
	err := ctx.ReadResource("azure-nextgen:resources:Resource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
