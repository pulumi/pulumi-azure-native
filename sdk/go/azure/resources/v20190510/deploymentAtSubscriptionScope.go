...
func NewDeploymentAtSubscriptionScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:resources/v20190510:DeploymentAtSubscriptionScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtSubscriptionScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtSubscriptionScope
	err := ctx.ReadResource("azure-nextgen:resources/v20190510:DeploymentAtSubscriptionScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
