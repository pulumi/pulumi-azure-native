...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ScriptStatusResponseInput)(nil)).Elem(), ScriptStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScriptStatusResponsePtrInput)(nil)).Elem(), ScriptStatusResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountConfigurationInput)(nil)).Elem(), StorageAccountConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountConfigurationPtrInput)(nil)).Elem(), StorageAccountConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountConfigurationResponseInput)(nil)).Elem(), StorageAccountConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountConfigurationResponsePtrInput)(nil)).Elem(), StorageAccountConfigurationResponseArgs{})
