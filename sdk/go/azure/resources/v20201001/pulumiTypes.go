...
// The query string (for example, a SAS token) to be used with the templateLink URI.
func (o TemplateLinkInvokeResponseOutput) QueryString() pulumi.StringPtrOutput {
	return o.ApplyT(func(v TemplateLinkInvokeResponse) *string { return v.QueryString }).(pulumi.StringPtrOutput)
}
