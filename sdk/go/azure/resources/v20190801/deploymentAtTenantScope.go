...
func NewDeploymentAtTenantScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20190801:DeploymentAtTenantScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtTenantScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtTenantScope
	err := ctx.ReadResource("azure-native:resources/v20190801:DeploymentAtTenantScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
