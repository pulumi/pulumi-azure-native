...
func NewResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:resources/v20160901:Resource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResource(ctx *pulumi.Context,
	...
	var resource Resource
	err := ctx.ReadResource("azure-nextgen:resources/v20160901:Resource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
