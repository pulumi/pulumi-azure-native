...
// TemplateSpecArtifactKindInput is an input type that accepts TemplateSpecArtifactKindArgs and TemplateSpecArtifactKindOutput values.
// You can construct a concrete instance of `TemplateSpecArtifactKindInput` via:
//
//          TemplateSpecArtifactKindArgs{...}
