...
type ProviderExtendedLocationInvokeResponse struct {
...
// ProviderExtendedLocationInvokeResponseInput is an input type that accepts ProviderExtendedLocationInvokeResponseArgs and ProviderExtendedLocationInvokeResponseOutput values.
// You can construct a concrete instance of `ProviderExtendedLocationInvokeResponseInput` via:
//
//          ProviderExtendedLocationInvokeResponseArgs{...}
type ProviderExtendedLocationInvokeResponseInput interface {
	pulumi.Input

	ToProviderExtendedLocationInvokeResponseOutput() ProviderExtendedLocationInvokeResponseOutput
	ToProviderExtendedLocationInvokeResponseOutputWithContext(context.Context) ProviderExtendedLocationInvokeResponseOutput
}

// The provider extended location.
type ProviderExtendedLocationInvokeResponseArgs struct {
	// The extended locations for the azure location.
...
func (ProviderExtendedLocationInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ProviderExtendedLocationInvokeResponse)(nil)).Elem()
}

func (i ProviderExtendedLocationInvokeResponseArgs) ToProviderExtendedLocationInvokeResponseOutput() ProviderExtendedLocationInvokeResponseOutput {
	return i.ToProviderExtendedLocationInvokeResponseOutputWithContext(context.Background())
}

func (i ProviderExtendedLocationInvokeResponseArgs) ToProviderExtendedLocationInvokeResponseOutputWithContext(ctx context.Context) ProviderExtendedLocationInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ProviderExtendedLocationInvokeResponseOutput)
}

// ProviderExtendedLocationInvokeResponseArrayInput is an input type that accepts ProviderExtendedLocationInvokeResponseArray and ProviderExtendedLocationInvokeResponseArrayOutput values.
// You can construct a concrete instance of `ProviderExtendedLocationInvokeResponseArrayInput` via:
//
//          ProviderExtendedLocationInvokeResponseArray{ ProviderExtendedLocationInvokeResponseArgs{...} }
type ProviderExtendedLocationInvokeResponseArrayInput interface {
	pulumi.Input

	ToProviderExtendedLocationInvokeResponseArrayOutput() ProviderExtendedLocationInvokeResponseArrayOutput
	ToProviderExtendedLocationInvokeResponseArrayOutputWithContext(context.Context) ProviderExtendedLocationInvokeResponseArrayOutput
}

type ProviderExtendedLocationInvokeResponseArray []ProviderExtendedLocationInvokeResponseInput

func (ProviderExtendedLocationInvokeResponseArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ProviderExtendedLocationInvokeResponse)(nil)).Elem()
}

func (i ProviderExtendedLocationInvokeResponseArray) ToProviderExtendedLocationInvokeResponseArrayOutput() ProviderExtendedLocationInvokeResponseArrayOutput {
	return i.ToProviderExtendedLocationInvokeResponseArrayOutputWithContext(context.Background())
}

func (i ProviderExtendedLocationInvokeResponseArray) ToProviderExtendedLocationInvokeResponseArrayOutputWithContext(ctx context.Context) ProviderExtendedLocationInvokeResponseArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ProviderExtendedLocationInvokeResponseArrayOutput)
}

// The provider extended location.
type ProviderExtendedLocationInvokeResponseOutput struct{ *pulumi.OutputState }

func (ProviderExtendedLocationInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ProviderExtendedLocationInvokeResponse)(nil)).Elem()
}

func (o ProviderExtendedLocationInvokeResponseOutput) ToProviderExtendedLocationInvokeResponseOutput() ProviderExtendedLocationInvokeResponseOutput {
	return o
}

func (o ProviderExtendedLocationInvokeResponseOutput) ToProviderExtendedLocationInvokeResponseOutputWithContext(ctx context.Context) ProviderExtendedLocationInvokeResponseOutput {
	return o
}

// The extended locations for the azure location.
func (o ProviderExtendedLocationInvokeResponseOutput) ExtendedLocations() pulumi.StringArrayOutput {
	return o.ApplyT(func(v ProviderExtendedLocationInvokeResponse) []string { return v.ExtendedLocations }).(pulumi.StringArrayOutput)
}

// The azure location.
func (o ProviderExtendedLocationInvokeResponseOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProviderExtendedLocationInvokeResponse) *string { return v.Location }).(pulumi.StringPtrOutput)
}

// The extended location type.
func (o ProviderExtendedLocationInvokeResponseOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProviderExtendedLocationInvokeResponse) *string { return v.Type }).(pulumi.StringPtrOutput)
}

type ProviderExtendedLocationInvokeResponseArrayOutput struct{ *pulumi.OutputState }

func (ProviderExtendedLocationInvokeResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ProviderExtendedLocationInvokeResponse)(nil)).Elem()
}

func (o ProviderExtendedLocationInvokeResponseArrayOutput) ToProviderExtendedLocationInvokeResponseArrayOutput() ProviderExtendedLocationInvokeResponseArrayOutput {
	return o
}

func (o ProviderExtendedLocationInvokeResponseArrayOutput) ToProviderExtendedLocationInvokeResponseArrayOutputWithContext(ctx context.Context) ProviderExtendedLocationInvokeResponseArrayOutput {
	return o
}

func (o ProviderExtendedLocationInvokeResponseArrayOutput) Index(i pulumi.IntInput) ProviderExtendedLocationInvokeResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) ProviderExtendedLocationInvokeResponse {
		return vs[0].([]ProviderExtendedLocationInvokeResponse)[vs[1].(int)]
	}).(ProviderExtendedLocationInvokeResponseOutput)
}
...
type ProviderResourceTypeInvokeResponse struct {
	...
	LocationMappings []ProviderExtendedLocationInvokeResponse `pulumi:"locationMappings"`
...
type ProviderResourceTypeInvokeResponseArgs struct {
	...
	// The location mappings that are supported by this resource type.
	LocationMappings ProviderExtendedLocationInvokeResponseArrayInput `pulumi:"locationMappings"`
	// The collection of locations where this resource type can be created.
...
// The location mappings that are supported by this resource type.
func (o ProviderResourceTypeInvokeResponseOutput) LocationMappings() ProviderExtendedLocationInvokeResponseArrayOutput {
	return o.ApplyT(func(v ProviderResourceTypeInvokeResponse) []ProviderExtendedLocationInvokeResponse {
		return v.LocationMappings
	}).(ProviderExtendedLocationInvokeResponseArrayOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ProviderExtendedLocationInvokeResponseOutput{})
	pulumi.RegisterOutputType(ProviderExtendedLocationInvokeResponseArrayOutput{})
