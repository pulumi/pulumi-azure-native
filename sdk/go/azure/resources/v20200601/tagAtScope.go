...
func NewTagAtScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:resources/v20200601:TagAtScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagAtScope(ctx *pulumi.Context,
	...
	var resource TagAtScope
	err := ctx.ReadResource("azure-nextgen:resources/v20200601:TagAtScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
