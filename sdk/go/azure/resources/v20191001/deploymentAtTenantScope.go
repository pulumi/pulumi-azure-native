...
func NewDeploymentAtTenantScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:resources/v20191001:DeploymentAtTenantScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtTenantScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtTenantScope
	err := ctx.ReadResource("azure-nextgen:resources/v20191001:DeploymentAtTenantScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
