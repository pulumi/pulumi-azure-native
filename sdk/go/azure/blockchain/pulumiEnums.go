...
// BlockchainProtocolInput is an input type that accepts BlockchainProtocolArgs and BlockchainProtocolOutput values.
// You can construct a concrete instance of `BlockchainProtocolInput` via:
//
//          BlockchainProtocolArgs{...}
