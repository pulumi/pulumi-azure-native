...
// ScalingHostPoolTypeInput is an input type that accepts ScalingHostPoolTypeArgs and ScalingHostPoolTypeOutput values.
// You can construct a concrete instance of `ScalingHostPoolTypeInput` via:
//
