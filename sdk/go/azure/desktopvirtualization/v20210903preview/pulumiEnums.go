...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OperationInput)(nil)).Elem(), Operation("Start"))
	pulumi.RegisterInputType(reflect.TypeOf((*OperationPtrInput)(nil)).Elem(), Operation("Start"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingHostPoolTypeInput)(nil)).Elem(), ScalingHostPoolType("Pooled"))
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingHostPoolTypePtrInput)(nil)).Elem(), ScalingHostPoolType("Pooled"))
