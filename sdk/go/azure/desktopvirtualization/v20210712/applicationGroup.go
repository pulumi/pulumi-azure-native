...
func NewApplicationGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20210712:ApplicationGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationGroup(ctx *pulumi.Context,
	...
	var resource ApplicationGroup
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20210712:ApplicationGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
