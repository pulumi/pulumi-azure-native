...
func NewApplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:desktopvirtualization/v20200921preview:Application", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplication(ctx *pulumi.Context,
	...
	var resource Application
	err := ctx.ReadResource("azure-nextgen:desktopvirtualization/v20200921preview:Application", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
