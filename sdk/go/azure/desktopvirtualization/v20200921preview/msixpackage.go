...
func NewMSIXPackage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20200921preview:MSIXPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMSIXPackage(ctx *pulumi.Context,
	...
	var resource MSIXPackage
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20200921preview:MSIXPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
