...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RemoteApplicationTypeInput)(nil)).Elem(), RemoteApplicationType("InBuilt"))
	pulumi.RegisterInputType(reflect.TypeOf((*RemoteApplicationTypePtrInput)(nil)).Elem(), RemoteApplicationType("InBuilt"))
