...
func NewApplicationGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:desktopvirtualization/v20190123preview:ApplicationGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationGroup(ctx *pulumi.Context,
	...
	var resource ApplicationGroup
	err := ctx.ReadResource("azure-nextgen:desktopvirtualization/v20190123preview:ApplicationGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
