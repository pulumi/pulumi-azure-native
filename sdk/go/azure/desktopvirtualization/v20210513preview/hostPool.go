...
type HostPool struct {
	...
	SessionHostComponentUpdateConfiguration SessionHostComponentUpdateConfigurationPropertiesResponsePtrOutput `pulumi:"sessionHostComponentUpdateConfiguration"`
...
func NewHostPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20210513preview:HostPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHostPool(ctx *pulumi.Context,
	...
	var resource HostPool
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20210513preview:HostPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type hostPoolState struct {
	...
	// The session host configuration for updating agent, monitoring agent, and stack component.
	SessionHostComponentUpdateConfiguration *SessionHostComponentUpdateConfigurationPropertiesResponse `pulumi:"sessionHostComponentUpdateConfiguration"`
...
type HostPoolState struct {
	...
	// The session host configuration for updating agent, monitoring agent, and stack component.
	SessionHostComponentUpdateConfiguration SessionHostComponentUpdateConfigurationPropertiesResponsePtrInput
...
type hostPoolArgs struct {
	...
	Ring *int `pulumi:"ring"`
	// The session host configuration for updating agent, monitoring agent, and stack component.
	SessionHostComponentUpdateConfiguration *SessionHostComponentUpdateConfigurationProperties `pulumi:"sessionHostComponentUpdateConfiguration"`
...
type HostPoolArgs struct {
	...
	Ring pulumi.IntPtrInput
	// The session host configuration for updating agent, monitoring agent, and stack component.
	SessionHostComponentUpdateConfiguration SessionHostComponentUpdateConfigurationPropertiesPtrInput
