...
func NewPrivateEndpointConnectionByWorkspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20210513preview:PrivateEndpointConnectionByWorkspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionByWorkspace(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionByWorkspace
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20210513preview:PrivateEndpointConnectionByWorkspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
