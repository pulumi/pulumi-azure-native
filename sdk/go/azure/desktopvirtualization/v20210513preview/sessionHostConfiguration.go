...
func NewSessionHostConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization:SessionHostConfiguration"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20210513preview:SessionHostConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSessionHostConfiguration(ctx *pulumi.Context,
	...
	var resource SessionHostConfiguration
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20210513preview:SessionHostConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
