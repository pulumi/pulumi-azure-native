...
// DomainJoinTypeInput is an input type that accepts DomainJoinTypeArgs and DomainJoinTypeOutput values.
// You can construct a concrete instance of `DomainJoinTypeInput` via:
//
//          DomainJoinTypeArgs{...}
...
const (
	...
	SessionHostComponentUpdateTypeTenantAdminControlled = SessionHostComponentUpdateType("TenantAdminControlled")
)
...
// SessionHostComponentUpdateTypeInput is an input type that accepts SessionHostComponentUpdateTypeArgs and SessionHostComponentUpdateTypeOutput values.
// You can construct a concrete instance of `SessionHostComponentUpdateTypeInput` via:
//
...
func (VirtualMachineDiskType) ElementType() reflect.Type {
	return reflect.TypeOf((*VirtualMachineDiskType)(nil)).Elem()
}

func (e VirtualMachineDiskType) ToVirtualMachineDiskTypeOutput() VirtualMachineDiskTypeOutput {
	return pulumi.ToOutput(e).(VirtualMachineDiskTypeOutput)
}

func (e VirtualMachineDiskType) ToVirtualMachineDiskTypeOutputWithContext(ctx context.Context) VirtualMachineDiskTypeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(VirtualMachineDiskTypeOutput)
}

func (e VirtualMachineDiskType) ToVirtualMachineDiskTypePtrOutput() VirtualMachineDiskTypePtrOutput {
	return e.ToVirtualMachineDiskTypePtrOutputWithContext(context.Background())
}

func (e VirtualMachineDiskType) ToVirtualMachineDiskTypePtrOutputWithContext(ctx context.Context) VirtualMachineDiskTypePtrOutput {
	return VirtualMachineDiskType(e).ToVirtualMachineDiskTypeOutputWithContext(ctx).ToVirtualMachineDiskTypePtrOutputWithContext(ctx)
}
...
type VirtualMachineDiskTypeOutput struct{ *pulumi.OutputState }

func (VirtualMachineDiskTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VirtualMachineDiskType)(nil)).Elem()
}

func (o VirtualMachineDiskTypeOutput) ToVirtualMachineDiskTypeOutput() VirtualMachineDiskTypeOutput {
	return o
}

func (o VirtualMachineDiskTypeOutput) ToVirtualMachineDiskTypeOutputWithContext(ctx context.Context) VirtualMachineDiskTypeOutput {
	return o
}

func (o VirtualMachineDiskTypeOutput) ToVirtualMachineDiskTypePtrOutput() VirtualMachineDiskTypePtrOutput {
	return o.ToVirtualMachineDiskTypePtrOutputWithContext(context.Background())
}

func (o VirtualMachineDiskTypeOutput) ToVirtualMachineDiskTypePtrOutputWithContext(ctx context.Context) VirtualMachineDiskTypePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v VirtualMachineDiskType) *VirtualMachineDiskType {
		return &v
	}).(VirtualMachineDiskTypePtrOutput)
}

func (o VirtualMachineDiskTypeOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o VirtualMachineDiskTypeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e VirtualMachineDiskType) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o VirtualMachineDiskTypeOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o VirtualMachineDiskTypeOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e VirtualMachineDiskType) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type VirtualMachineDiskTypePtrOutput struct{ *pulumi.OutputState }

func (VirtualMachineDiskTypePtrOutput) ElementType() reflect.Type {
	return virtualMachineDiskTypePtrType
}

func (o VirtualMachineDiskTypePtrOutput) ToVirtualMachineDiskTypePtrOutput() VirtualMachineDiskTypePtrOutput {
	return o
}

func (o VirtualMachineDiskTypePtrOutput) ToVirtualMachineDiskTypePtrOutputWithContext(ctx context.Context) VirtualMachineDiskTypePtrOutput {
	return o
}

func (o VirtualMachineDiskTypePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o VirtualMachineDiskTypePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *VirtualMachineDiskType) *string {
		if e == nil {
			return nil
		}
...
func (o VirtualMachineDiskTypePtrOutput) Elem() VirtualMachineDiskTypeOutput {
	return o.ApplyT(func(v *VirtualMachineDiskType) VirtualMachineDiskType {
		var ret VirtualMachineDiskType
		if v != nil {
			ret = *v
		}
		return ret
	}).(VirtualMachineDiskTypeOutput)
}

// VirtualMachineDiskTypeInput is an input type that accepts VirtualMachineDiskTypeArgs and VirtualMachineDiskTypeOutput values.
// You can construct a concrete instance of `VirtualMachineDiskTypeInput` via:
//
//          VirtualMachineDiskTypeArgs{...}
type VirtualMachineDiskTypeInput interface {
	pulumi.Input

	ToVirtualMachineDiskTypeOutput() VirtualMachineDiskTypeOutput
	ToVirtualMachineDiskTypeOutputWithContext(context.Context) VirtualMachineDiskTypeOutput
}

var virtualMachineDiskTypePtrType = reflect.TypeOf((**VirtualMachineDiskType)(nil)).Elem()

type VirtualMachineDiskTypePtrInput interface {
	pulumi.Input

	ToVirtualMachineDiskTypePtrOutput() VirtualMachineDiskTypePtrOutput
	ToVirtualMachineDiskTypePtrOutputWithContext(context.Context) VirtualMachineDiskTypePtrOutput
}

type virtualMachineDiskTypePtr string

func VirtualMachineDiskTypePtr(v string) VirtualMachineDiskTypePtrInput {
	return (*virtualMachineDiskTypePtr)(&v)
}

func (*virtualMachineDiskTypePtr) ElementType() reflect.Type {
	return virtualMachineDiskTypePtrType
}

func (in *virtualMachineDiskTypePtr) ToVirtualMachineDiskTypePtrOutput() VirtualMachineDiskTypePtrOutput {
	return pulumi.ToOutput(in).(VirtualMachineDiskTypePtrOutput)
}

func (in *virtualMachineDiskTypePtr) ToVirtualMachineDiskTypePtrOutputWithContext(ctx context.Context) VirtualMachineDiskTypePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(VirtualMachineDiskTypePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(VirtualMachineDiskTypeOutput{})
	pulumi.RegisterOutputType(VirtualMachineDiskTypePtrOutput{})
}
