...
func NewHostPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:desktopvirtualization/v20191210preview:HostPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHostPool(ctx *pulumi.Context,
	...
	var resource HostPool
	err := ctx.ReadResource("azure-nextgen:desktopvirtualization/v20191210preview:HostPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
