...
// SSOSecretTypeInput is an input type that accepts SSOSecretTypeArgs and SSOSecretTypeOutput values.
// You can construct a concrete instance of `SSOSecretTypeInput` via:
//
//          SSOSecretTypeArgs{...}
...
// SessionHostLoadBalancingAlgorithmInput is an input type that accepts SessionHostLoadBalancingAlgorithmArgs and SessionHostLoadBalancingAlgorithmOutput values.
// You can construct a concrete instance of `SessionHostLoadBalancingAlgorithmInput` via:
//
...
// StopHostsWhenInput is an input type that accepts StopHostsWhenArgs and StopHostsWhenOutput values.
// You can construct a concrete instance of `StopHostsWhenInput` via:
//
//          StopHostsWhenArgs{...}
