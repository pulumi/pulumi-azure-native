...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SSOSecretTypeInput)(nil)).Elem(), SSOSecretType("SharedKey"))
	pulumi.RegisterInputType(reflect.TypeOf((*SSOSecretTypePtrInput)(nil)).Elem(), SSOSecretType("SharedKey"))
	pulumi.RegisterInputType(reflect.TypeOf((*SessionHostLoadBalancingAlgorithmInput)(nil)).Elem(), SessionHostLoadBalancingAlgorithm("BreadthFirst"))
	pulumi.RegisterInputType(reflect.TypeOf((*SessionHostLoadBalancingAlgorithmPtrInput)(nil)).Elem(), SessionHostLoadBalancingAlgorithm("BreadthFirst"))
	pulumi.RegisterInputType(reflect.TypeOf((*StopHostsWhenInput)(nil)).Elem(), StopHostsWhen("ZeroSessions"))
	pulumi.RegisterInputType(reflect.TypeOf((*StopHostsWhenPtrInput)(nil)).Elem(), StopHostsWhen("ZeroSessions"))
