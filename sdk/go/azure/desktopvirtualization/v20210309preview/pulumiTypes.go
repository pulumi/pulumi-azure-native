...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationRequestPropertiesInput)(nil)).Elem(), MigrationRequestPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationRequestPropertiesPtrInput)(nil)).Elem(), MigrationRequestPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationRequestPropertiesResponseInput)(nil)).Elem(), MigrationRequestPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MigrationRequestPropertiesResponsePtrInput)(nil)).Elem(), MigrationRequestPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceModelWithAllowedPropertySetIdentityInput)(nil)).Elem(), ResourceModelWithAllowedPropertySetIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceModelWithAllowedPropertySetIdentityPtrInput)(nil)).Elem(), ResourceModelWithAllowedPropertySetIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceModelWithAllowedPropertySetPlanInput)(nil)).Elem(), ResourceModelWithAllowedPropertySetPlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceModelWithAllowedPropertySetPlanPtrInput)(nil)).Elem(), ResourceModelWithAllowedPropertySetPlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceModelWithAllowedPropertySetResponseIdentityInput)(nil)).Elem(), ResourceModelWithAllowedPropertySetResponseIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceModelWithAllowedPropertySetResponseIdentityPtrInput)(nil)).Elem(), ResourceModelWithAllowedPropertySetResponseIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceModelWithAllowedPropertySetResponsePlanInput)(nil)).Elem(), ResourceModelWithAllowedPropertySetResponsePlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceModelWithAllowedPropertySetResponsePlanPtrInput)(nil)).Elem(), ResourceModelWithAllowedPropertySetResponsePlanArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceModelWithAllowedPropertySetResponseSkuInput)(nil)).Elem(), ResourceModelWithAllowedPropertySetResponseSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceModelWithAllowedPropertySetResponseSkuPtrInput)(nil)).Elem(), ResourceModelWithAllowedPropertySetResponseSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceModelWithAllowedPropertySetSkuInput)(nil)).Elem(), ResourceModelWithAllowedPropertySetSkuArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceModelWithAllowedPropertySetSkuPtrInput)(nil)).Elem(), ResourceModelWithAllowedPropertySetSkuArgs{})
