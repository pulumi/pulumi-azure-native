...
// DigitalTwinsIdentityTypeInput is an input type that accepts DigitalTwinsIdentityTypeArgs and DigitalTwinsIdentityTypeOutput values.
// You can construct a concrete instance of `DigitalTwinsIdentityTypeInput` via:
//
