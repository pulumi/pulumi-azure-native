...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionPropertiesPrivateLinkServiceConnectionStateInput)(nil)).Elem(), ConnectionPropertiesPrivateLinkServiceConnectionStateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionPropertiesPrivateLinkServiceConnectionStatePtrInput)(nil)).Elem(), ConnectionPropertiesPrivateLinkServiceConnectionStateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionPropertiesResponsePrivateEndpointInput)(nil)).Elem(), ConnectionPropertiesResponsePrivateEndpointArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionPropertiesResponsePrivateEndpointPtrInput)(nil)).Elem(), ConnectionPropertiesResponsePrivateEndpointArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionPropertiesResponsePrivateLinkServiceConnectionStateInput)(nil)).Elem(), ConnectionPropertiesResponsePrivateLinkServiceConnectionStateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectionPropertiesResponsePrivateLinkServiceConnectionStatePtrInput)(nil)).Elem(), ConnectionPropertiesResponsePrivateLinkServiceConnectionStateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DigitalTwinsIdentityInput)(nil)).Elem(), DigitalTwinsIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DigitalTwinsIdentityPtrInput)(nil)).Elem(), DigitalTwinsIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DigitalTwinsIdentityResponseInput)(nil)).Elem(), DigitalTwinsIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DigitalTwinsIdentityResponsePtrInput)(nil)).Elem(), DigitalTwinsIdentityResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateEndpointConnectionResponsePropertiesInput)(nil)).Elem(), PrivateEndpointConnectionResponsePropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateEndpointConnectionResponsePropertiesPtrInput)(nil)).Elem(), PrivateEndpointConnectionResponsePropertiesArgs{})
