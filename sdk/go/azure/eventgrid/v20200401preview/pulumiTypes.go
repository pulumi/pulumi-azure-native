...
// Information about the deadletter destination with resource identity.
type DeadLetterWithResourceIdentityInvokeResponse struct {
	// Information about the destination where events have to be delivered for the event subscription.
	// Uses the managed identity setup on the parent resource (namely, topic or domain) to acquire the authentication tokens being used during delivery / dead-lettering.
	DeadLetterDestination *StorageBlobDeadLetterDestinationInvokeResponse `pulumi:"deadLetterDestination"`
	// The identity to use when dead-lettering events.
	Identity *EventSubscriptionIdentityInvokeResponse `pulumi:"identity"`
}

// DeadLetterWithResourceIdentityInvokeResponseInput is an input type that accepts DeadLetterWithResourceIdentityInvokeResponseArgs and DeadLetterWithResourceIdentityInvokeResponseOutput values.
// You can construct a concrete instance of `DeadLetterWithResourceIdentityInvokeResponseInput` via:
//
//          DeadLetterWithResourceIdentityInvokeResponseArgs{...}
type DeadLetterWithResourceIdentityInvokeResponseInput interface {
	pulumi.Input

	ToDeadLetterWithResourceIdentityInvokeResponseOutput() DeadLetterWithResourceIdentityInvokeResponseOutput
	ToDeadLetterWithResourceIdentityInvokeResponseOutputWithContext(context.Context) DeadLetterWithResourceIdentityInvokeResponseOutput
}

// Information about the deadletter destination with resource identity.
type DeadLetterWithResourceIdentityInvokeResponseArgs struct {
	// Information about the destination where events have to be delivered for the event subscription.
	// Uses the managed identity setup on the parent resource (namely, topic or domain) to acquire the authentication tokens being used during delivery / dead-lettering.
	DeadLetterDestination StorageBlobDeadLetterDestinationInvokeResponsePtrInput `pulumi:"deadLetterDestination"`
	// The identity to use when dead-lettering events.
	Identity EventSubscriptionIdentityInvokeResponsePtrInput `pulumi:"identity"`
}

func (DeadLetterWithResourceIdentityInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*DeadLetterWithResourceIdentityInvokeResponse)(nil)).Elem()
}

func (i DeadLetterWithResourceIdentityInvokeResponseArgs) ToDeadLetterWithResourceIdentityInvokeResponseOutput() DeadLetterWithResourceIdentityInvokeResponseOutput {
	return i.ToDeadLetterWithResourceIdentityInvokeResponseOutputWithContext(context.Background())
}

func (i DeadLetterWithResourceIdentityInvokeResponseArgs) ToDeadLetterWithResourceIdentityInvokeResponseOutputWithContext(ctx context.Context) DeadLetterWithResourceIdentityInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DeadLetterWithResourceIdentityInvokeResponseOutput)
}

// Information about the deadletter destination with resource identity.
type DeadLetterWithResourceIdentityInvokeResponseOutput struct{ *pulumi.OutputState }

func (DeadLetterWithResourceIdentityInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DeadLetterWithResourceIdentityInvokeResponse)(nil)).Elem()
}

func (o DeadLetterWithResourceIdentityInvokeResponseOutput) ToDeadLetterWithResourceIdentityInvokeResponseOutput() DeadLetterWithResourceIdentityInvokeResponseOutput {
	return o
}

func (o DeadLetterWithResourceIdentityInvokeResponseOutput) ToDeadLetterWithResourceIdentityInvokeResponseOutputWithContext(ctx context.Context) DeadLetterWithResourceIdentityInvokeResponseOutput {
	return o
}

// Information about the destination where events have to be delivered for the event subscription.
// Uses the managed identity setup on the parent resource (namely, topic or domain) to acquire the authentication tokens being used during delivery / dead-lettering.
func (o DeadLetterWithResourceIdentityInvokeResponseOutput) DeadLetterDestination() StorageBlobDeadLetterDestinationInvokeResponsePtrOutput {
	return o.ApplyT(func(v DeadLetterWithResourceIdentityInvokeResponse) *StorageBlobDeadLetterDestinationInvokeResponse {
		return v.DeadLetterDestination
	}).(StorageBlobDeadLetterDestinationInvokeResponsePtrOutput)
}

// The identity to use when dead-lettering events.
func (o DeadLetterWithResourceIdentityInvokeResponseOutput) Identity() EventSubscriptionIdentityInvokeResponsePtrOutput {
	return o.ApplyT(func(v DeadLetterWithResourceIdentityInvokeResponse) *EventSubscriptionIdentityInvokeResponse {
		return v.Identity
	}).(EventSubscriptionIdentityInvokeResponsePtrOutput)
}
...
// Information about the delivery for an event subscription with resource identity.
type DeliveryWithResourceIdentityInvokeResponse struct {
	// Information about the destination where events have to be delivered for the event subscription.
	// Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery / dead-lettering.
	Destination interface{} `pulumi:"destination"`
	// The identity to use when delivering events.
...
// DeliveryWithResourceIdentityInvokeResponseInput is an input type that accepts DeliveryWithResourceIdentityInvokeResponseArgs and DeliveryWithResourceIdentityInvokeResponseOutput values.
// You can construct a concrete instance of `DeliveryWithResourceIdentityInvokeResponseInput` via:
//
//          DeliveryWithResourceIdentityInvokeResponseArgs{...}
type DeliveryWithResourceIdentityInvokeResponseInput interface {
	pulumi.Input

	ToDeliveryWithResourceIdentityInvokeResponseOutput() DeliveryWithResourceIdentityInvokeResponseOutput
	ToDeliveryWithResourceIdentityInvokeResponseOutputWithContext(context.Context) DeliveryWithResourceIdentityInvokeResponseOutput
}

// Information about the delivery for an event subscription with resource identity.
type DeliveryWithResourceIdentityInvokeResponseArgs struct {
	// Information about the destination where events have to be delivered for the event subscription.
	// Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery / dead-lettering.
	Destination pulumi.Input `pulumi:"destination"`
	// The identity to use when delivering events.
...
func (DeliveryWithResourceIdentityInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*DeliveryWithResourceIdentityInvokeResponse)(nil)).Elem()
}

func (i DeliveryWithResourceIdentityInvokeResponseArgs) ToDeliveryWithResourceIdentityInvokeResponseOutput() DeliveryWithResourceIdentityInvokeResponseOutput {
	return i.ToDeliveryWithResourceIdentityInvokeResponseOutputWithContext(context.Background())
}

func (i DeliveryWithResourceIdentityInvokeResponseArgs) ToDeliveryWithResourceIdentityInvokeResponseOutputWithContext(ctx context.Context) DeliveryWithResourceIdentityInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DeliveryWithResourceIdentityInvokeResponseOutput)
}

// Information about the delivery for an event subscription with resource identity.
type DeliveryWithResourceIdentityInvokeResponseOutput struct{ *pulumi.OutputState }

func (DeliveryWithResourceIdentityInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DeliveryWithResourceIdentityInvokeResponse)(nil)).Elem()
}

func (o DeliveryWithResourceIdentityInvokeResponseOutput) ToDeliveryWithResourceIdentityInvokeResponseOutput() DeliveryWithResourceIdentityInvokeResponseOutput {
	return o
}

func (o DeliveryWithResourceIdentityInvokeResponseOutput) ToDeliveryWithResourceIdentityInvokeResponseOutputWithContext(ctx context.Context) DeliveryWithResourceIdentityInvokeResponseOutput {
	return o
}

// Information about the destination where events have to be delivered for the event subscription.
// Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery / dead-lettering.
func (o DeliveryWithResourceIdentityInvokeResponseOutput) Destination() pulumi.AnyOutput {
	return o.ApplyT(func(v DeliveryWithResourceIdentityInvokeResponse) interface{} { return v.Destination }).(pulumi.AnyOutput)
}

// The identity to use when delivering events.
func (o DeliveryWithResourceIdentityInvokeResponseOutput) Identity() EventSubscriptionIdentityInvokeResponsePtrOutput {
	return o.ApplyT(func(v DeliveryWithResourceIdentityInvokeResponse) *EventSubscriptionIdentityInvokeResponse {
		return v.Identity
	}).(EventSubscriptionIdentityInvokeResponsePtrOutput)
}
...
// Properties of the destination of an event channel.
type EventChannelDestinationInvokeResponse struct {
	// Azure subscription ID of the customer creating the event channel. The partner topic
	// associated with the event channel will be created under this Azure subscription.
	AzureSubscriptionId *string `pulumi:"azureSubscriptionId"`
	// Name of the partner topic associated with the event channel.
...
// EventChannelDestinationInvokeResponseInput is an input type that accepts EventChannelDestinationInvokeResponseArgs and EventChannelDestinationInvokeResponseOutput values.
// You can construct a concrete instance of `EventChannelDestinationInvokeResponseInput` via:
//
//          EventChannelDestinationInvokeResponseArgs{...}
type EventChannelDestinationInvokeResponseInput interface {
	pulumi.Input

	ToEventChannelDestinationInvokeResponseOutput() EventChannelDestinationInvokeResponseOutput
	ToEventChannelDestinationInvokeResponseOutputWithContext(context.Context) EventChannelDestinationInvokeResponseOutput
}

// Properties of the destination of an event channel.
type EventChannelDestinationInvokeResponseArgs struct {
	// Azure subscription ID of the customer creating the event channel. The partner topic
	// associated with the event channel will be created under this Azure subscription.
	AzureSubscriptionId pulumi.StringPtrInput `pulumi:"azureSubscriptionId"`
	// Name of the partner topic associated with the event channel.
...
func (EventChannelDestinationInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*EventChannelDestinationInvokeResponse)(nil)).Elem()
}

func (i EventChannelDestinationInvokeResponseArgs) ToEventChannelDestinationInvokeResponseOutput() EventChannelDestinationInvokeResponseOutput {
	return i.ToEventChannelDestinationInvokeResponseOutputWithContext(context.Background())
}

func (i EventChannelDestinationInvokeResponseArgs) ToEventChannelDestinationInvokeResponseOutputWithContext(ctx context.Context) EventChannelDestinationInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(EventChannelDestinationInvokeResponseOutput)
}

// Properties of the destination of an event channel.
type EventChannelDestinationInvokeResponseOutput struct{ *pulumi.OutputState }

func (EventChannelDestinationInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*EventChannelDestinationInvokeResponse)(nil)).Elem()
}

func (o EventChannelDestinationInvokeResponseOutput) ToEventChannelDestinationInvokeResponseOutput() EventChannelDestinationInvokeResponseOutput {
	return o
}

func (o EventChannelDestinationInvokeResponseOutput) ToEventChannelDestinationInvokeResponseOutputWithContext(ctx context.Context) EventChannelDestinationInvokeResponseOutput {
	return o
}

// Azure subscription ID of the customer creating the event channel. The partner topic
// associated with the event channel will be created under this Azure subscription.
func (o EventChannelDestinationInvokeResponseOutput) AzureSubscriptionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EventChannelDestinationInvokeResponse) *string { return v.AzureSubscriptionId }).(pulumi.StringPtrOutput)
}

// Name of the partner topic associated with the event channel.
func (o EventChannelDestinationInvokeResponseOutput) PartnerTopicName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EventChannelDestinationInvokeResponse) *string { return v.PartnerTopicName }).(pulumi.StringPtrOutput)
}

// Azure Resource Group of the customer creating the event channel. The partner topic
// associated with the event channel will be created under this resource group.
func (o EventChannelDestinationInvokeResponseOutput) ResourceGroup() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EventChannelDestinationInvokeResponse) *string { return v.ResourceGroup }).(pulumi.StringPtrOutput)
}
...
// Filter for the Event Channel.
type EventChannelFilterInvokeResponse struct {
	// An array of advanced filters that are used for filtering event channels.
	AdvancedFilters []interface{} `pulumi:"advancedFilters"`
}

// EventChannelFilterInvokeResponseInput is an input type that accepts EventChannelFilterInvokeResponseArgs and EventChannelFilterInvokeResponseOutput values.
// You can construct a concrete instance of `EventChannelFilterInvokeResponseInput` via:
//
//          EventChannelFilterInvokeResponseArgs{...}
type EventChannelFilterInvokeResponseInput interface {
	pulumi.Input

	ToEventChannelFilterInvokeResponseOutput() EventChannelFilterInvokeResponseOutput
	ToEventChannelFilterInvokeResponseOutputWithContext(context.Context) EventChannelFilterInvokeResponseOutput
}

// Filter for the Event Channel.
type EventChannelFilterInvokeResponseArgs struct {
	// An array of advanced filters that are used for filtering event channels.
	AdvancedFilters pulumi.ArrayInput `pulumi:"advancedFilters"`
}

func (EventChannelFilterInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*EventChannelFilterInvokeResponse)(nil)).Elem()
}

func (i EventChannelFilterInvokeResponseArgs) ToEventChannelFilterInvokeResponseOutput() EventChannelFilterInvokeResponseOutput {
	return i.ToEventChannelFilterInvokeResponseOutputWithContext(context.Background())
}

func (i EventChannelFilterInvokeResponseArgs) ToEventChannelFilterInvokeResponseOutputWithContext(ctx context.Context) EventChannelFilterInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(EventChannelFilterInvokeResponseOutput)
}

// Filter for the Event Channel.
type EventChannelFilterInvokeResponseOutput struct{ *pulumi.OutputState }

func (EventChannelFilterInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*EventChannelFilterInvokeResponse)(nil)).Elem()
}

func (o EventChannelFilterInvokeResponseOutput) ToEventChannelFilterInvokeResponseOutput() EventChannelFilterInvokeResponseOutput {
	return o
}

func (o EventChannelFilterInvokeResponseOutput) ToEventChannelFilterInvokeResponseOutputWithContext(ctx context.Context) EventChannelFilterInvokeResponseOutput {
	return o
}

// An array of advanced filters that are used for filtering event channels.
func (o EventChannelFilterInvokeResponseOutput) AdvancedFilters() pulumi.ArrayOutput {
	return o.ApplyT(func(v EventChannelFilterInvokeResponse) []interface{} { return v.AdvancedFilters }).(pulumi.ArrayOutput)
}
...
// Properties of the source of an event channel.
type EventChannelSourceInvokeResponse struct {
	// The identifier of the resource that's the source of the events.
	// This represents a unique resource in the partner's resource model.
	Source *string `pulumi:"source"`
}

// EventChannelSourceInvokeResponseInput is an input type that accepts EventChannelSourceInvokeResponseArgs and EventChannelSourceInvokeResponseOutput values.
// You can construct a concrete instance of `EventChannelSourceInvokeResponseInput` via:
//
//          EventChannelSourceInvokeResponseArgs{...}
type EventChannelSourceInvokeResponseInput interface {
	pulumi.Input

	ToEventChannelSourceInvokeResponseOutput() EventChannelSourceInvokeResponseOutput
	ToEventChannelSourceInvokeResponseOutputWithContext(context.Context) EventChannelSourceInvokeResponseOutput
}

// Properties of the source of an event channel.
type EventChannelSourceInvokeResponseArgs struct {
	// The identifier of the resource that's the source of the events.
	// This represents a unique resource in the partner's resource model.
	Source pulumi.StringPtrInput `pulumi:"source"`
}

func (EventChannelSourceInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*EventChannelSourceInvokeResponse)(nil)).Elem()
}

func (i EventChannelSourceInvokeResponseArgs) ToEventChannelSourceInvokeResponseOutput() EventChannelSourceInvokeResponseOutput {
	return i.ToEventChannelSourceInvokeResponseOutputWithContext(context.Background())
}

func (i EventChannelSourceInvokeResponseArgs) ToEventChannelSourceInvokeResponseOutputWithContext(ctx context.Context) EventChannelSourceInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(EventChannelSourceInvokeResponseOutput)
}

// Properties of the source of an event channel.
type EventChannelSourceInvokeResponseOutput struct{ *pulumi.OutputState }

func (EventChannelSourceInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*EventChannelSourceInvokeResponse)(nil)).Elem()
}

func (o EventChannelSourceInvokeResponseOutput) ToEventChannelSourceInvokeResponseOutput() EventChannelSourceInvokeResponseOutput {
	return o
}

func (o EventChannelSourceInvokeResponseOutput) ToEventChannelSourceInvokeResponseOutputWithContext(ctx context.Context) EventChannelSourceInvokeResponseOutput {
	return o
}

// The identifier of the resource that's the source of the events.
// This represents a unique resource in the partner's resource model.
func (o EventChannelSourceInvokeResponseOutput) Source() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EventChannelSourceInvokeResponse) *string { return v.Source }).(pulumi.StringPtrOutput)
}
...
// The identity information with the event subscription.
type EventSubscriptionIdentityInvokeResponse struct {
	// The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove any identity.
	Type *string `pulumi:"type"`
	// The user identity associated with the resource.
	UserAssignedIdentity *string `pulumi:"userAssignedIdentity"`
...
// EventSubscriptionIdentityInvokeResponseInput is an input type that accepts EventSubscriptionIdentityInvokeResponseArgs and EventSubscriptionIdentityInvokeResponseOutput values.
// You can construct a concrete instance of `EventSubscriptionIdentityInvokeResponseInput` via:
//
//          EventSubscriptionIdentityInvokeResponseArgs{...}
type EventSubscriptionIdentityInvokeResponseInput interface {
	pulumi.Input

	ToEventSubscriptionIdentityInvokeResponseOutput() EventSubscriptionIdentityInvokeResponseOutput
	ToEventSubscriptionIdentityInvokeResponseOutputWithContext(context.Context) EventSubscriptionIdentityInvokeResponseOutput
}

// The identity information with the event subscription.
type EventSubscriptionIdentityInvokeResponseArgs struct {
	// The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove any identity.
	Type pulumi.StringPtrInput `pulumi:"type"`
	// The user identity associated with the resource.
	UserAssignedIdentity pulumi.StringPtrInput `pulumi:"userAssignedIdentity"`
...
func (EventSubscriptionIdentityInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*EventSubscriptionIdentityInvokeResponse)(nil)).Elem()
}

func (i EventSubscriptionIdentityInvokeResponseArgs) ToEventSubscriptionIdentityInvokeResponseOutput() EventSubscriptionIdentityInvokeResponseOutput {
	return i.ToEventSubscriptionIdentityInvokeResponseOutputWithContext(context.Background())
}

func (i EventSubscriptionIdentityInvokeResponseArgs) ToEventSubscriptionIdentityInvokeResponseOutputWithContext(ctx context.Context) EventSubscriptionIdentityInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(EventSubscriptionIdentityInvokeResponseOutput)
}

func (i EventSubscriptionIdentityInvokeResponseArgs) ToEventSubscriptionIdentityInvokeResponsePtrOutput() EventSubscriptionIdentityInvokeResponsePtrOutput {
	return i.ToEventSubscriptionIdentityInvokeResponsePtrOutputWithContext(context.Background())
}

func (i EventSubscriptionIdentityInvokeResponseArgs) ToEventSubscriptionIdentityInvokeResponsePtrOutputWithContext(ctx context.Context) EventSubscriptionIdentityInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(EventSubscriptionIdentityInvokeResponseOutput).ToEventSubscriptionIdentityInvokeResponsePtrOutputWithContext(ctx)
}

// EventSubscriptionIdentityInvokeResponsePtrInput is an input type that accepts EventSubscriptionIdentityInvokeResponseArgs, EventSubscriptionIdentityInvokeResponsePtr and EventSubscriptionIdentityInvokeResponsePtrOutput values.
// You can construct a concrete instance of `EventSubscriptionIdentityInvokeResponsePtrInput` via:
//
//          EventSubscriptionIdentityInvokeResponseArgs{...}
//
//  or:
//
//          nil
type EventSubscriptionIdentityInvokeResponsePtrInput interface {
	pulumi.Input

	ToEventSubscriptionIdentityInvokeResponsePtrOutput() EventSubscriptionIdentityInvokeResponsePtrOutput
	ToEventSubscriptionIdentityInvokeResponsePtrOutputWithContext(context.Context) EventSubscriptionIdentityInvokeResponsePtrOutput
}

type eventSubscriptionIdentityInvokeResponsePtrType EventSubscriptionIdentityInvokeResponseArgs

func EventSubscriptionIdentityInvokeResponsePtr(v *EventSubscriptionIdentityInvokeResponseArgs) EventSubscriptionIdentityInvokeResponsePtrInput {
	return (*eventSubscriptionIdentityInvokeResponsePtrType)(v)
}

func (*eventSubscriptionIdentityInvokeResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**EventSubscriptionIdentityInvokeResponse)(nil)).Elem()
}

func (i *eventSubscriptionIdentityInvokeResponsePtrType) ToEventSubscriptionIdentityInvokeResponsePtrOutput() EventSubscriptionIdentityInvokeResponsePtrOutput {
	return i.ToEventSubscriptionIdentityInvokeResponsePtrOutputWithContext(context.Background())
}

func (i *eventSubscriptionIdentityInvokeResponsePtrType) ToEventSubscriptionIdentityInvokeResponsePtrOutputWithContext(ctx context.Context) EventSubscriptionIdentityInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(EventSubscriptionIdentityInvokeResponsePtrOutput)
}

// The identity information with the event subscription.
type EventSubscriptionIdentityInvokeResponseOutput struct{ *pulumi.OutputState }

func (EventSubscriptionIdentityInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*EventSubscriptionIdentityInvokeResponse)(nil)).Elem()
}

func (o EventSubscriptionIdentityInvokeResponseOutput) ToEventSubscriptionIdentityInvokeResponseOutput() EventSubscriptionIdentityInvokeResponseOutput {
	return o
}

func (o EventSubscriptionIdentityInvokeResponseOutput) ToEventSubscriptionIdentityInvokeResponseOutputWithContext(ctx context.Context) EventSubscriptionIdentityInvokeResponseOutput {
	return o
}

func (o EventSubscriptionIdentityInvokeResponseOutput) ToEventSubscriptionIdentityInvokeResponsePtrOutput() EventSubscriptionIdentityInvokeResponsePtrOutput {
	return o.ToEventSubscriptionIdentityInvokeResponsePtrOutputWithContext(context.Background())
}

func (o EventSubscriptionIdentityInvokeResponseOutput) ToEventSubscriptionIdentityInvokeResponsePtrOutputWithContext(ctx context.Context) EventSubscriptionIdentityInvokeResponsePtrOutput {
	return o.ApplyT(func(v EventSubscriptionIdentityInvokeResponse) *EventSubscriptionIdentityInvokeResponse {
		return &v
	}).(EventSubscriptionIdentityInvokeResponsePtrOutput)
}

// The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove any identity.
func (o EventSubscriptionIdentityInvokeResponseOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EventSubscriptionIdentityInvokeResponse) *string { return v.Type }).(pulumi.StringPtrOutput)
}

// The user identity associated with the resource.
func (o EventSubscriptionIdentityInvokeResponseOutput) UserAssignedIdentity() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EventSubscriptionIdentityInvokeResponse) *string { return v.UserAssignedIdentity }).(pulumi.StringPtrOutput)
}

type EventSubscriptionIdentityInvokeResponsePtrOutput struct{ *pulumi.OutputState }

func (EventSubscriptionIdentityInvokeResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**EventSubscriptionIdentityInvokeResponse)(nil)).Elem()
}

func (o EventSubscriptionIdentityInvokeResponsePtrOutput) ToEventSubscriptionIdentityInvokeResponsePtrOutput() EventSubscriptionIdentityInvokeResponsePtrOutput {
	return o
}

func (o EventSubscriptionIdentityInvokeResponsePtrOutput) ToEventSubscriptionIdentityInvokeResponsePtrOutputWithContext(ctx context.Context) EventSubscriptionIdentityInvokeResponsePtrOutput {
	return o
}

func (o EventSubscriptionIdentityInvokeResponsePtrOutput) Elem() EventSubscriptionIdentityInvokeResponseOutput {
	return o.ApplyT(func(v *EventSubscriptionIdentityInvokeResponse) EventSubscriptionIdentityInvokeResponse { return *v }).(EventSubscriptionIdentityInvokeResponseOutput)
}

// The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove any identity.
func (o EventSubscriptionIdentityInvokeResponsePtrOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *EventSubscriptionIdentityInvokeResponse) *string {
		if v == nil {
			return nil
		}
		return v.Type
...
// The user identity associated with the resource.
func (o EventSubscriptionIdentityInvokeResponsePtrOutput) UserAssignedIdentity() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *EventSubscriptionIdentityInvokeResponse) *string {
		if v == nil {
			return nil
		}
...
// The identity information for the resource.
type IdentityInfoInvokeResponse struct {
	// The principal ID of resource identity.
	PrincipalId *string `pulumi:"principalId"`
	// The tenant ID of resource.
	TenantId *string `pulumi:"tenantId"`
...
// IdentityInfoInvokeResponseInput is an input type that accepts IdentityInfoInvokeResponseArgs and IdentityInfoInvokeResponseOutput values.
// You can construct a concrete instance of `IdentityInfoInvokeResponseInput` via:
//
//          IdentityInfoInvokeResponseArgs{...}
type IdentityInfoInvokeResponseInput interface {
	pulumi.Input

	ToIdentityInfoInvokeResponseOutput() IdentityInfoInvokeResponseOutput
	ToIdentityInfoInvokeResponseOutputWithContext(context.Context) IdentityInfoInvokeResponseOutput
}

// The identity information for the resource.
type IdentityInfoInvokeResponseArgs struct {
	// The principal ID of resource identity.
	PrincipalId pulumi.StringPtrInput `pulumi:"principalId"`
	// The tenant ID of resource.
	TenantId pulumi.StringPtrInput `pulumi:"tenantId"`
...
func (IdentityInfoInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*IdentityInfoInvokeResponse)(nil)).Elem()
}

func (i IdentityInfoInvokeResponseArgs) ToIdentityInfoInvokeResponseOutput() IdentityInfoInvokeResponseOutput {
	return i.ToIdentityInfoInvokeResponseOutputWithContext(context.Background())
}

func (i IdentityInfoInvokeResponseArgs) ToIdentityInfoInvokeResponseOutputWithContext(ctx context.Context) IdentityInfoInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IdentityInfoInvokeResponseOutput)
}

// The identity information for the resource.
type IdentityInfoInvokeResponseOutput struct{ *pulumi.OutputState }

func (IdentityInfoInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*IdentityInfoInvokeResponse)(nil)).Elem()
}

func (o IdentityInfoInvokeResponseOutput) ToIdentityInfoInvokeResponseOutput() IdentityInfoInvokeResponseOutput {
	return o
}

func (o IdentityInfoInvokeResponseOutput) ToIdentityInfoInvokeResponseOutputWithContext(ctx context.Context) IdentityInfoInvokeResponseOutput {
	return o
}

// The principal ID of resource identity.
func (o IdentityInfoInvokeResponseOutput) PrincipalId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IdentityInfoInvokeResponse) *string { return v.PrincipalId }).(pulumi.StringPtrOutput)
}

// The tenant ID of resource.
func (o IdentityInfoInvokeResponseOutput) TenantId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IdentityInfoInvokeResponse) *string { return v.TenantId }).(pulumi.StringPtrOutput)
}

// The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove any identity.
func (o IdentityInfoInvokeResponseOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IdentityInfoInvokeResponse) *string { return v.Type }).(pulumi.StringPtrOutput)
}

// The list of user identities associated with the resource. The user identity dictionary key references will be ARM resource ids in the form:
// '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
// This property is currently not used and reserved for future usage.
func (o IdentityInfoInvokeResponseOutput) UserAssignedIdentities() UserIdentityPropertiesInvokeResponseMapOutput {
	return o.ApplyT(func(v IdentityInfoInvokeResponse) map[string]UserIdentityPropertiesInvokeResponse {
		return v.UserAssignedIdentities
...
func (i StorageBlobDeadLetterDestinationInvokeResponseArgs) ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutput() StorageBlobDeadLetterDestinationInvokeResponsePtrOutput {
	return i.ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutputWithContext(context.Background())
}

func (i StorageBlobDeadLetterDestinationInvokeResponseArgs) ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutputWithContext(ctx context.Context) StorageBlobDeadLetterDestinationInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StorageBlobDeadLetterDestinationInvokeResponseOutput).ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutputWithContext(ctx)
}

// StorageBlobDeadLetterDestinationInvokeResponsePtrInput is an input type that accepts StorageBlobDeadLetterDestinationInvokeResponseArgs, StorageBlobDeadLetterDestinationInvokeResponsePtr and StorageBlobDeadLetterDestinationInvokeResponsePtrOutput values.
// You can construct a concrete instance of `StorageBlobDeadLetterDestinationInvokeResponsePtrInput` via:
//
//          StorageBlobDeadLetterDestinationInvokeResponseArgs{...}
//
//  or:
//
//          nil
type StorageBlobDeadLetterDestinationInvokeResponsePtrInput interface {
	pulumi.Input

	ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutput() StorageBlobDeadLetterDestinationInvokeResponsePtrOutput
	ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutputWithContext(context.Context) StorageBlobDeadLetterDestinationInvokeResponsePtrOutput
}

type storageBlobDeadLetterDestinationInvokeResponsePtrType StorageBlobDeadLetterDestinationInvokeResponseArgs

func StorageBlobDeadLetterDestinationInvokeResponsePtr(v *StorageBlobDeadLetterDestinationInvokeResponseArgs) StorageBlobDeadLetterDestinationInvokeResponsePtrInput {
	return (*storageBlobDeadLetterDestinationInvokeResponsePtrType)(v)
}

func (*storageBlobDeadLetterDestinationInvokeResponsePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**StorageBlobDeadLetterDestinationInvokeResponse)(nil)).Elem()
}

func (i *storageBlobDeadLetterDestinationInvokeResponsePtrType) ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutput() StorageBlobDeadLetterDestinationInvokeResponsePtrOutput {
	return i.ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutputWithContext(context.Background())
}

func (i *storageBlobDeadLetterDestinationInvokeResponsePtrType) ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutputWithContext(ctx context.Context) StorageBlobDeadLetterDestinationInvokeResponsePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StorageBlobDeadLetterDestinationInvokeResponsePtrOutput)
}
...
func (o StorageBlobDeadLetterDestinationInvokeResponseOutput) ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutput() StorageBlobDeadLetterDestinationInvokeResponsePtrOutput {
	return o.ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutputWithContext(context.Background())
}

func (o StorageBlobDeadLetterDestinationInvokeResponseOutput) ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutputWithContext(ctx context.Context) StorageBlobDeadLetterDestinationInvokeResponsePtrOutput {
	return o.ApplyT(func(v StorageBlobDeadLetterDestinationInvokeResponse) *StorageBlobDeadLetterDestinationInvokeResponse {
		return &v
	}).(StorageBlobDeadLetterDestinationInvokeResponsePtrOutput)
}
...
type StorageBlobDeadLetterDestinationInvokeResponsePtrOutput struct{ *pulumi.OutputState }

func (StorageBlobDeadLetterDestinationInvokeResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**StorageBlobDeadLetterDestinationInvokeResponse)(nil)).Elem()
}

func (o StorageBlobDeadLetterDestinationInvokeResponsePtrOutput) ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutput() StorageBlobDeadLetterDestinationInvokeResponsePtrOutput {
	return o
}

func (o StorageBlobDeadLetterDestinationInvokeResponsePtrOutput) ToStorageBlobDeadLetterDestinationInvokeResponsePtrOutputWithContext(ctx context.Context) StorageBlobDeadLetterDestinationInvokeResponsePtrOutput {
	return o
}

func (o StorageBlobDeadLetterDestinationInvokeResponsePtrOutput) Elem() StorageBlobDeadLetterDestinationInvokeResponseOutput {
	return o.ApplyT(func(v *StorageBlobDeadLetterDestinationInvokeResponse) StorageBlobDeadLetterDestinationInvokeResponse {
		return *v
	}).(StorageBlobDeadLetterDestinationInvokeResponseOutput)
}

// The name of the Storage blob container that is the destination of the deadletter events
func (o StorageBlobDeadLetterDestinationInvokeResponsePtrOutput) BlobContainerName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StorageBlobDeadLetterDestinationInvokeResponse) *string {
		if v == nil {
			return nil
		}
		return v.BlobContainerName
...
// Type of the endpoint for the dead letter destination
// Expected value is 'StorageBlob'.
func (o StorageBlobDeadLetterDestinationInvokeResponsePtrOutput) EndpointType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StorageBlobDeadLetterDestinationInvokeResponse) *string {
		if v == nil {
			return nil
		}
...
// The Azure Resource ID of the storage account that is the destination of the deadletter events
func (o StorageBlobDeadLetterDestinationInvokeResponsePtrOutput) ResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StorageBlobDeadLetterDestinationInvokeResponse) *string {
		if v == nil {
			return nil
		}
...
func init() {
	...
	pulumi.RegisterOutputType(DeadLetterWithResourceIdentityInvokeResponseOutput{})
	...
	pulumi.RegisterOutputType(DeliveryWithResourceIdentityInvokeResponseOutput{})
	...
	pulumi.RegisterOutputType(EventChannelDestinationInvokeResponseOutput{})
	...
	pulumi.RegisterOutputType(EventChannelFilterInvokeResponseOutput{})
	...
	pulumi.RegisterOutputType(EventChannelSourceInvokeResponseOutput{})
	...
	pulumi.RegisterOutputType(EventSubscriptionIdentityInvokeResponseOutput{})
	pulumi.RegisterOutputType(EventSubscriptionIdentityInvokeResponsePtrOutput{})
	...
	pulumi.RegisterOutputType(IdentityInfoInvokeResponseOutput{})
	...
	pulumi.RegisterOutputType(StorageBlobDeadLetterDestinationInvokeResponsePtrOutput{})
