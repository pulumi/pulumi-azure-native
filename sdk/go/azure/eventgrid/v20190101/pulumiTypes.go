...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RetryPolicyResponseInput)(nil)).Elem(), RetryPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RetryPolicyResponsePtrInput)(nil)).Elem(), RetryPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageBlobDeadLetterDestinationInput)(nil)).Elem(), StorageBlobDeadLetterDestinationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageBlobDeadLetterDestinationPtrInput)(nil)).Elem(), StorageBlobDeadLetterDestinationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageBlobDeadLetterDestinationResponseInput)(nil)).Elem(), StorageBlobDeadLetterDestinationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageBlobDeadLetterDestinationResponsePtrInput)(nil)).Elem(), StorageBlobDeadLetterDestinationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageQueueEventSubscriptionDestinationInput)(nil)).Elem(), StorageQueueEventSubscriptionDestinationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageQueueEventSubscriptionDestinationResponseInput)(nil)).Elem(), StorageQueueEventSubscriptionDestinationResponseArgs{})
