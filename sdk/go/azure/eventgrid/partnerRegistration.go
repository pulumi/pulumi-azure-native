...
func NewPartnerRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:eventgrid:PartnerRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartnerRegistration(ctx *pulumi.Context,
	...
	var resource PartnerRegistration
	err := ctx.ReadResource("azure-nextgen:eventgrid:PartnerRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
