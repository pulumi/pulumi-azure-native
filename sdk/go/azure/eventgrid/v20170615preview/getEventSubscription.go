...
func LookupEventSubscription(ctx *pulumi.Context, args *LookupEventSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupEventSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:eventgrid/v20170615preview:getEventSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupEventSubscriptionResult struct {
	...
	Destination *EventSubscriptionDestinationInvokeResponse `pulumi:"destination"`
