...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityCollectionResponseInput)(nil)).Elem(), ConnectivityCollectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityCollectionResponsePtrInput)(nil)).Elem(), ConnectivityCollectionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedNetworkGroupResponseInput)(nil)).Elem(), ManagedNetworkGroupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedNetworkGroupResponseArrayInput)(nil)).Elem(), ManagedNetworkGroupResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedNetworkPeeringPolicyPropertiesInput)(nil)).Elem(), ManagedNetworkPeeringPolicyPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedNetworkPeeringPolicyPropertiesPtrInput)(nil)).Elem(), ManagedNetworkPeeringPolicyPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedNetworkPeeringPolicyPropertiesResponseInput)(nil)).Elem(), ManagedNetworkPeeringPolicyPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedNetworkPeeringPolicyPropertiesResponsePtrInput)(nil)).Elem(), ManagedNetworkPeeringPolicyPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedNetworkPeeringPolicyResponseInput)(nil)).Elem(), ManagedNetworkPeeringPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedNetworkPeeringPolicyResponseArrayInput)(nil)).Elem(), ManagedNetworkPeeringPolicyResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceIdArrayInput)(nil)).Elem(), ResourceIdArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceIdResponseArrayInput)(nil)).Elem(), ResourceIdResponseArray{})
