...
func NewScopeAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:managednetwork:ScopeAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopeAssignment(ctx *pulumi.Context,
	...
	var resource ScopeAssignment
	err := ctx.ReadResource("azure-nextgen:managednetwork:ScopeAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
