...
func (ProtectionIntentItemType) ElementType() reflect.Type {
	return reflect.TypeOf((*ProtectionIntentItemType)(nil)).Elem()
}

func (e ProtectionIntentItemType) ToProtectionIntentItemTypeOutput() ProtectionIntentItemTypeOutput {
	return pulumi.ToOutput(e).(ProtectionIntentItemTypeOutput)
}

func (e ProtectionIntentItemType) ToProtectionIntentItemTypeOutputWithContext(ctx context.Context) ProtectionIntentItemTypeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(ProtectionIntentItemTypeOutput)
}

func (e ProtectionIntentItemType) ToProtectionIntentItemTypePtrOutput() ProtectionIntentItemTypePtrOutput {
	return e.ToProtectionIntentItemTypePtrOutputWithContext(context.Background())
}

func (e ProtectionIntentItemType) ToProtectionIntentItemTypePtrOutputWithContext(ctx context.Context) ProtectionIntentItemTypePtrOutput {
	return ProtectionIntentItemType(e).ToProtectionIntentItemTypeOutputWithContext(ctx).ToProtectionIntentItemTypePtrOutputWithContext(ctx)
}

func (e ProtectionIntentItemType) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e ProtectionIntentItemType) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e ProtectionIntentItemType) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e ProtectionIntentItemType) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type ProtectionIntentItemTypeOutput struct{ *pulumi.OutputState }

func (ProtectionIntentItemTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ProtectionIntentItemType)(nil)).Elem()
}

func (o ProtectionIntentItemTypeOutput) ToProtectionIntentItemTypeOutput() ProtectionIntentItemTypeOutput {
	return o
}

func (o ProtectionIntentItemTypeOutput) ToProtectionIntentItemTypeOutputWithContext(ctx context.Context) ProtectionIntentItemTypeOutput {
	return o
}

func (o ProtectionIntentItemTypeOutput) ToProtectionIntentItemTypePtrOutput() ProtectionIntentItemTypePtrOutput {
	return o.ToProtectionIntentItemTypePtrOutputWithContext(context.Background())
}

func (o ProtectionIntentItemTypeOutput) ToProtectionIntentItemTypePtrOutputWithContext(ctx context.Context) ProtectionIntentItemTypePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ProtectionIntentItemType) *ProtectionIntentItemType {
		return &v
	}).(ProtectionIntentItemTypePtrOutput)
}

func (o ProtectionIntentItemTypeOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o ProtectionIntentItemTypeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ProtectionIntentItemType) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o ProtectionIntentItemTypeOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ProtectionIntentItemTypeOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ProtectionIntentItemType) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type ProtectionIntentItemTypePtrOutput struct{ *pulumi.OutputState }

func (ProtectionIntentItemTypePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ProtectionIntentItemType)(nil)).Elem()
}

func (o ProtectionIntentItemTypePtrOutput) ToProtectionIntentItemTypePtrOutput() ProtectionIntentItemTypePtrOutput {
	return o
}

func (o ProtectionIntentItemTypePtrOutput) ToProtectionIntentItemTypePtrOutputWithContext(ctx context.Context) ProtectionIntentItemTypePtrOutput {
	return o
}

func (o ProtectionIntentItemTypePtrOutput) Elem() ProtectionIntentItemTypeOutput {
	return o.ApplyT(func(v *ProtectionIntentItemType) ProtectionIntentItemType {
		if v != nil {
			return *v
		}
		var ret ProtectionIntentItemType
		return ret
	}).(ProtectionIntentItemTypeOutput)
}

func (o ProtectionIntentItemTypePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ProtectionIntentItemTypePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *ProtectionIntentItemType) *string {
		if e == nil {
			return nil
		}
...
type ProtectionIntentItemTypeInput interface {
	pulumi.Input

	ToProtectionIntentItemTypeOutput() ProtectionIntentItemTypeOutput
	ToProtectionIntentItemTypeOutputWithContext(context.Context) ProtectionIntentItemTypeOutput
}

var protectionIntentItemTypePtrType = reflect.TypeOf((**ProtectionIntentItemType)(nil)).Elem()

type ProtectionIntentItemTypePtrInput interface {
	pulumi.Input

	ToProtectionIntentItemTypePtrOutput() ProtectionIntentItemTypePtrOutput
	ToProtectionIntentItemTypePtrOutputWithContext(context.Context) ProtectionIntentItemTypePtrOutput
}

type protectionIntentItemTypePtr string

func ProtectionIntentItemTypePtr(v string) ProtectionIntentItemTypePtrInput {
	return (*protectionIntentItemTypePtr)(&v)
}

func (*protectionIntentItemTypePtr) ElementType() reflect.Type {
	return protectionIntentItemTypePtrType
}

func (in *protectionIntentItemTypePtr) ToProtectionIntentItemTypePtrOutput() ProtectionIntentItemTypePtrOutput {
	return pulumi.ToOutput(in).(ProtectionIntentItemTypePtrOutput)
}

func (in *protectionIntentItemTypePtr) ToProtectionIntentItemTypePtrOutputWithContext(ctx context.Context) ProtectionIntentItemTypePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(ProtectionIntentItemTypePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ProtectionIntentItemTypeOutput{})
	pulumi.RegisterOutputType(ProtectionIntentItemTypePtrOutput{})
