...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*A2AUnprotectedDiskDetailsResponseInput)(nil)).Elem(), A2AUnprotectedDiskDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*A2AUnprotectedDiskDetailsResponseArrayInput)(nil)).Elem(), A2AUnprotectedDiskDetailsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AgentDetailsResponseInput)(nil)).Elem(), AgentDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AgentDetailsResponseArrayInput)(nil)).Elem(), AgentDetailsResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AgentDiskDetailsResponseInput)(nil)).Elem(), AgentDiskDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AgentDiskDetailsResponseArrayInput)(nil)).Elem(), AgentDiskDetailsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DraDetailsResponseInput)(nil)).Elem(), DraDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DraDetailsResponseArrayInput)(nil)).Elem(), DraDetailsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*IPConfigResponseInput)(nil)).Elem(), IPConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*IPConfigResponseArrayInput)(nil)).Elem(), IPConfigResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*InMageAzureV2DiskInputDetailsInput)(nil)).Elem(), InMageAzureV2DiskInputDetailsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageAzureV2DiskInputDetailsArrayInput)(nil)).Elem(), InMageAzureV2DiskInputDetailsArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*InMageAzureV2ManagedDiskDetailsResponseInput)(nil)).Elem(), InMageAzureV2ManagedDiskDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageAzureV2ManagedDiskDetailsResponseArrayInput)(nil)).Elem(), InMageAzureV2ManagedDiskDetailsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmAgentUpgradeBlockingErrorDetailsResponseInput)(nil)).Elem(), InMageRcmAgentUpgradeBlockingErrorDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmAgentUpgradeBlockingErrorDetailsResponseArrayInput)(nil)).Elem(), InMageRcmAgentUpgradeBlockingErrorDetailsResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmDiskInputInput)(nil)).Elem(), InMageRcmDiskInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmDiskInputArrayInput)(nil)).Elem(), InMageRcmDiskInputArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmDisksDefaultInputInput)(nil)).Elem(), InMageRcmDisksDefaultInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmDisksDefaultInputPtrInput)(nil)).Elem(), InMageRcmDisksDefaultInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmEnableProtectionInputInput)(nil)).Elem(), InMageRcmEnableProtectionInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmFabricCreationInputInput)(nil)).Elem(), InMageRcmFabricCreationInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmFabricSpecificDetailsResponseInput)(nil)).Elem(), InMageRcmFabricSpecificDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmLastAgentUpgradeErrorDetailsResponseInput)(nil)).Elem(), InMageRcmLastAgentUpgradeErrorDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmLastAgentUpgradeErrorDetailsResponseArrayInput)(nil)).Elem(), InMageRcmLastAgentUpgradeErrorDetailsResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmMobilityAgentDetailsResponseInput)(nil)).Elem(), InMageRcmMobilityAgentDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmNicDetailsResponseInput)(nil)).Elem(), InMageRcmNicDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmNicDetailsResponseArrayInput)(nil)).Elem(), InMageRcmNicDetailsResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmPolicyCreationInputInput)(nil)).Elem(), InMageRcmPolicyCreationInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmPolicyDetailsResponseInput)(nil)).Elem(), InMageRcmPolicyDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmProtectedDiskDetailsResponseInput)(nil)).Elem(), InMageRcmProtectedDiskDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmProtectedDiskDetailsResponseArrayInput)(nil)).Elem(), InMageRcmProtectedDiskDetailsResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*InMageRcmReplicationDetailsResponseInput)(nil)).Elem(), InMageRcmReplicationDetailsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ProcessServerDetailsResponseInput)(nil)).Elem(), ProcessServerDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProcessServerDetailsResponseArrayInput)(nil)).Elem(), ProcessServerDetailsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PushInstallerDetailsResponseInput)(nil)).Elem(), PushInstallerDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PushInstallerDetailsResponseArrayInput)(nil)).Elem(), PushInstallerDetailsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RcmProxyDetailsResponseInput)(nil)).Elem(), RcmProxyDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RcmProxyDetailsResponseArrayInput)(nil)).Elem(), RcmProxyDetailsResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecoveryPlanA2ADetailsResponseInput)(nil)).Elem(), RecoveryPlanA2ADetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecoveryPlanA2ADetailsResponseArrayInput)(nil)).Elem(), RecoveryPlanA2ADetailsResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecoveryPlanA2AInputInput)(nil)).Elem(), RecoveryPlanA2AInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecoveryPlanA2AInputArrayInput)(nil)).Elem(), RecoveryPlanA2AInputArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicationAgentDetailsResponseInput)(nil)).Elem(), ReplicationAgentDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicationAgentDetailsResponseArrayInput)(nil)).Elem(), ReplicationAgentDetailsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReprotectAgentDetailsResponseInput)(nil)).Elem(), ReprotectAgentDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReprotectAgentDetailsResponseArrayInput)(nil)).Elem(), ReprotectAgentDetailsResponseArray{})
