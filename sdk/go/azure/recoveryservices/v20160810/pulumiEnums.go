...
func (o PossibleOperationsDirectionsArrayOutput) Index(i pulumi.IntInput) PossibleOperationsDirectionsOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) PossibleOperationsDirectionsOutput {
		return vs[0].([]PossibleOperationsDirections)[vs[1].(int)].ToPossibleOperationsDirectionsOutput()
	}).(PossibleOperationsDirectionsOutput)
}
...
func (o ReplicationProtectedItemOperationArrayOutput) Index(i pulumi.IntInput) ReplicationProtectedItemOperationOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) ReplicationProtectedItemOperationOutput {
		return vs[0].([]ReplicationProtectedItemOperation)[vs[1].(int)].ToReplicationProtectedItemOperationOutput()
	}).(ReplicationProtectedItemOperationOutput)
}
