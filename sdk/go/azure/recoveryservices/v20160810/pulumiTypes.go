...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ProtectionContainerMappingProviderSpecificDetailsResponseInput)(nil)).Elem(), ProtectionContainerMappingProviderSpecificDetailsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProtectionContainerMappingProviderSpecificDetailsResponsePtrInput)(nil)).Elem(), ProtectionContainerMappingProviderSpecificDetailsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicationProviderSpecificContainerMappingInputInput)(nil)).Elem(), ReplicationProviderSpecificContainerMappingInputArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicationProviderSpecificContainerMappingInputPtrInput)(nil)).Elem(), ReplicationProviderSpecificContainerMappingInputArgs{})
