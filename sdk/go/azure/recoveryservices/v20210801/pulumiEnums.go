...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AutomationAccountAuthenticationTypeInput)(nil)).Elem(), AutomationAccountAuthenticationType("RunAsAccount"))
	pulumi.RegisterInputType(reflect.TypeOf((*AutomationAccountAuthenticationTypePtrInput)(nil)).Elem(), AutomationAccountAuthenticationType("RunAsAccount"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RecoveryPlanActionLocationInput)(nil)).Elem(), RecoveryPlanActionLocation("Primary"))
	pulumi.RegisterInputType(reflect.TypeOf((*RecoveryPlanActionLocationPtrInput)(nil)).Elem(), RecoveryPlanActionLocation("Primary"))
