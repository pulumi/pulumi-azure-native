...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CmkKekIdentityInput)(nil)).Elem(), CmkKekIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CmkKekIdentityPtrInput)(nil)).Elem(), CmkKekIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CmkKekIdentityResponseInput)(nil)).Elem(), CmkKekIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CmkKekIdentityResponsePtrInput)(nil)).Elem(), CmkKekIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CmkKeyVaultPropertiesInput)(nil)).Elem(), CmkKeyVaultPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CmkKeyVaultPropertiesPtrInput)(nil)).Elem(), CmkKeyVaultPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CmkKeyVaultPropertiesResponseInput)(nil)).Elem(), CmkKeyVaultPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CmkKeyVaultPropertiesResponsePtrInput)(nil)).Elem(), CmkKeyVaultPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VaultPropertiesEncryptionInput)(nil)).Elem(), VaultPropertiesEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VaultPropertiesEncryptionPtrInput)(nil)).Elem(), VaultPropertiesEncryptionArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VaultPropertiesResponseEncryptionInput)(nil)).Elem(), VaultPropertiesResponseEncryptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VaultPropertiesResponseEncryptionPtrInput)(nil)).Elem(), VaultPropertiesResponseEncryptionArgs{})
