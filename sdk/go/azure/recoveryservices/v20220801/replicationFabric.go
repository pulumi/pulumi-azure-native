...
func NewReplicationFabric(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20220801:ReplicationFabric", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationFabric(ctx *pulumi.Context,
	...
	var resource ReplicationFabric
	err := ctx.ReadResource("azure-native:recoveryservices/v20220801:ReplicationFabric", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
