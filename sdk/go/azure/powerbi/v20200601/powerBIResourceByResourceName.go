...
func NewPowerBIResourceByResourceName(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:powerbi:PowerBIResourceByResourceName"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:powerbi/v20200601:PowerBIResourceByResourceName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPowerBIResourceByResourceName(ctx *pulumi.Context,
	...
	var resource PowerBIResourceByResourceName
	err := ctx.ReadResource("azure-native:powerbi/v20200601:PowerBIResourceByResourceName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
