...
func NewLocationSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:iotsecurity:LocationSite"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:iotsecurity/v20210901preview:LocationSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLocationSite(ctx *pulumi.Context,
	...
	var resource LocationSite
	err := ctx.ReadResource("azure-native:iotsecurity/v20210901preview:LocationSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
