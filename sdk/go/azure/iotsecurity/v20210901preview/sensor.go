...
func NewSensor(ctx *pulumi.Context,
	...
	var resource Sensor
	err := ctx.RegisterResource("azure-native:iotsecurity/v20210901preview:Sensor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSensor(ctx *pulumi.Context,
	...
	var resource Sensor
	err := ctx.ReadResource("azure-native:iotsecurity/v20210901preview:Sensor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
