...
func NewSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:iotsecurity/v20210901preview:Site"),
		},
		{
	...
	var resource Site
	err := ctx.RegisterResource("azure-native:iotsecurity/v20210901preview:Site", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSite(ctx *pulumi.Context,
	...
	var resource Site
	err := ctx.ReadResource("azure-native:iotsecurity/v20210901preview:Site", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
