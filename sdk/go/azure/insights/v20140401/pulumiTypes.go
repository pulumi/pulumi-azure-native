...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleNotificationInput)(nil)).Elem(), AutoscaleNotificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleNotificationArrayInput)(nil)).Elem(), AutoscaleNotificationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleNotificationResponseInput)(nil)).Elem(), AutoscaleNotificationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleNotificationResponseArrayInput)(nil)).Elem(), AutoscaleNotificationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleProfileInput)(nil)).Elem(), AutoscaleProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleProfileArrayInput)(nil)).Elem(), AutoscaleProfileArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleProfileResponseInput)(nil)).Elem(), AutoscaleProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoscaleProfileResponseArrayInput)(nil)).Elem(), AutoscaleProfileResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EmailNotificationInput)(nil)).Elem(), EmailNotificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EmailNotificationPtrInput)(nil)).Elem(), EmailNotificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EmailNotificationResponseInput)(nil)).Elem(), EmailNotificationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EmailNotificationResponsePtrInput)(nil)).Elem(), EmailNotificationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LocationThresholdRuleConditionInput)(nil)).Elem(), LocationThresholdRuleConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LocationThresholdRuleConditionResponseInput)(nil)).Elem(), LocationThresholdRuleConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementEventAggregationConditionInput)(nil)).Elem(), ManagementEventAggregationConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementEventAggregationConditionPtrInput)(nil)).Elem(), ManagementEventAggregationConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementEventAggregationConditionResponseInput)(nil)).Elem(), ManagementEventAggregationConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementEventAggregationConditionResponsePtrInput)(nil)).Elem(), ManagementEventAggregationConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementEventRuleConditionInput)(nil)).Elem(), ManagementEventRuleConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementEventRuleConditionResponseInput)(nil)).Elem(), ManagementEventRuleConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricTriggerInput)(nil)).Elem(), MetricTriggerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricTriggerResponseInput)(nil)).Elem(), MetricTriggerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceInput)(nil)).Elem(), RecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrencePtrInput)(nil)).Elem(), RecurrenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceResponseInput)(nil)).Elem(), RecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceResponsePtrInput)(nil)).Elem(), RecurrenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrentScheduleInput)(nil)).Elem(), RecurrentScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrentSchedulePtrInput)(nil)).Elem(), RecurrentScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrentScheduleResponseInput)(nil)).Elem(), RecurrentScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrentScheduleResponsePtrInput)(nil)).Elem(), RecurrentScheduleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuleEmailActionInput)(nil)).Elem(), RuleEmailActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuleEmailActionResponseInput)(nil)).Elem(), RuleEmailActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuleManagementEventClaimsDataSourceInput)(nil)).Elem(), RuleManagementEventClaimsDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuleManagementEventClaimsDataSourcePtrInput)(nil)).Elem(), RuleManagementEventClaimsDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuleManagementEventClaimsDataSourceResponseInput)(nil)).Elem(), RuleManagementEventClaimsDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuleManagementEventClaimsDataSourceResponsePtrInput)(nil)).Elem(), RuleManagementEventClaimsDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuleManagementEventDataSourceInput)(nil)).Elem(), RuleManagementEventDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuleManagementEventDataSourceResponseInput)(nil)).Elem(), RuleManagementEventDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuleMetricDataSourceInput)(nil)).Elem(), RuleMetricDataSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuleMetricDataSourceResponseInput)(nil)).Elem(), RuleMetricDataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuleWebhookActionInput)(nil)).Elem(), RuleWebhookActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RuleWebhookActionResponseInput)(nil)).Elem(), RuleWebhookActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleActionInput)(nil)).Elem(), ScaleActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleActionResponseInput)(nil)).Elem(), ScaleActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleCapacityInput)(nil)).Elem(), ScaleCapacityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleCapacityResponseInput)(nil)).Elem(), ScaleCapacityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleRuleInput)(nil)).Elem(), ScaleRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleRuleArrayInput)(nil)).Elem(), ScaleRuleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleRuleMetricDimensionInput)(nil)).Elem(), ScaleRuleMetricDimensionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleRuleMetricDimensionArrayInput)(nil)).Elem(), ScaleRuleMetricDimensionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleRuleMetricDimensionResponseInput)(nil)).Elem(), ScaleRuleMetricDimensionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleRuleMetricDimensionResponseArrayInput)(nil)).Elem(), ScaleRuleMetricDimensionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleRuleResponseInput)(nil)).Elem(), ScaleRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleRuleResponseArrayInput)(nil)).Elem(), ScaleRuleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ThresholdRuleConditionInput)(nil)).Elem(), ThresholdRuleConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ThresholdRuleConditionResponseInput)(nil)).Elem(), ThresholdRuleConditionResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WebhookNotificationInput)(nil)).Elem(), WebhookNotificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebhookNotificationArrayInput)(nil)).Elem(), WebhookNotificationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebhookNotificationResponseInput)(nil)).Elem(), WebhookNotificationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebhookNotificationResponseArrayInput)(nil)).Elem(), WebhookNotificationResponseArray{})
