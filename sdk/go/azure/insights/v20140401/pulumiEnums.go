...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ComparisonOperationTypeInput)(nil)).Elem(), ComparisonOperationType("Equals"))
	pulumi.RegisterInputType(reflect.TypeOf((*ComparisonOperationTypePtrInput)(nil)).Elem(), ComparisonOperationType("Equals"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MetricStatisticTypeInput)(nil)).Elem(), MetricStatisticType("Average"))
	pulumi.RegisterInputType(reflect.TypeOf((*MetricStatisticTypePtrInput)(nil)).Elem(), MetricStatisticType("Average"))
	pulumi.RegisterInputType(reflect.TypeOf((*OperationTypeInput)(nil)).Elem(), OperationType("Scale"))
	pulumi.RegisterInputType(reflect.TypeOf((*OperationTypePtrInput)(nil)).Elem(), OperationType("Scale"))
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceFrequencyInput)(nil)).Elem(), RecurrenceFrequency("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*RecurrenceFrequencyPtrInput)(nil)).Elem(), RecurrenceFrequency("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleDirectionInput)(nil)).Elem(), ScaleDirection("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleDirectionPtrInput)(nil)).Elem(), ScaleDirection("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleRuleMetricDimensionOperationTypeInput)(nil)).Elem(), ScaleRuleMetricDimensionOperationType("Equals"))
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleRuleMetricDimensionOperationTypePtrInput)(nil)).Elem(), ScaleRuleMetricDimensionOperationType("Equals"))
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleTypeInput)(nil)).Elem(), ScaleType("ChangeCount"))
	pulumi.RegisterInputType(reflect.TypeOf((*ScaleTypePtrInput)(nil)).Elem(), ScaleType("ChangeCount"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TimeAggregationTypeInput)(nil)).Elem(), TimeAggregationType("Average"))
	pulumi.RegisterInputType(reflect.TypeOf((*TimeAggregationTypePtrInput)(nil)).Elem(), TimeAggregationType("Average"))
