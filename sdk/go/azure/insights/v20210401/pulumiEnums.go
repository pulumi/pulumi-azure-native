...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*KnownDataCollectionEndpointResourceKindInput)(nil)).Elem(), KnownDataCollectionEndpointResourceKind("Linux"))
	pulumi.RegisterInputType(reflect.TypeOf((*KnownDataCollectionEndpointResourceKindPtrInput)(nil)).Elem(), KnownDataCollectionEndpointResourceKind("Linux"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KnownPublicNetworkAccessOptionsInput)(nil)).Elem(), KnownPublicNetworkAccessOptions("Enabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*KnownPublicNetworkAccessOptionsPtrInput)(nil)).Elem(), KnownPublicNetworkAccessOptions("Enabled"))
