...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ActionsInput)(nil)).Elem(), ActionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActionsPtrInput)(nil)).Elem(), ActionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActionsResponseInput)(nil)).Elem(), ActionsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActionsResponsePtrInput)(nil)).Elem(), ActionsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConditionFailingPeriodsInput)(nil)).Elem(), ConditionFailingPeriodsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConditionFailingPeriodsPtrInput)(nil)).Elem(), ConditionFailingPeriodsArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConditionResponseFailingPeriodsInput)(nil)).Elem(), ConditionResponseFailingPeriodsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConditionResponseFailingPeriodsPtrInput)(nil)).Elem(), ConditionResponseFailingPeriodsArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduledQueryRuleCriteriaInput)(nil)).Elem(), ScheduledQueryRuleCriteriaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduledQueryRuleCriteriaPtrInput)(nil)).Elem(), ScheduledQueryRuleCriteriaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduledQueryRuleCriteriaResponseInput)(nil)).Elem(), ScheduledQueryRuleCriteriaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduledQueryRuleCriteriaResponsePtrInput)(nil)).Elem(), ScheduledQueryRuleCriteriaResponseArgs{})
