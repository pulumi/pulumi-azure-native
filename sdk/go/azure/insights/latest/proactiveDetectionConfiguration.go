...
//
// Deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:insights:ProactiveDetectionConfiguration'.
...
func NewProactiveDetectionConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/latest:ProactiveDetectionConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProactiveDetectionConfiguration(ctx *pulumi.Context,
	...
	var resource ProactiveDetectionConfiguration
	err := ctx.ReadResource("azure-native:insights/latest:ProactiveDetectionConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
