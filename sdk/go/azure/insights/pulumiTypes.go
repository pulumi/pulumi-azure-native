...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ActionGroupTypeInput)(nil)).Elem(), ActionGroupTypeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActionGroupTypeArrayInput)(nil)).Elem(), ActionGroupTypeArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AlertingActionInput)(nil)).Elem(), AlertingActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertingActionResponseInput)(nil)).Elem(), AlertingActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationInsightsComponentAnalyticsItemPropertiesInput)(nil)).Elem(), ApplicationInsightsComponentAnalyticsItemPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationInsightsComponentAnalyticsItemPropertiesPtrInput)(nil)).Elem(), ApplicationInsightsComponentAnalyticsItemPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationInsightsComponentAnalyticsItemPropertiesResponseInput)(nil)).Elem(), ApplicationInsightsComponentAnalyticsItemPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationInsightsComponentAnalyticsItemPropertiesResponsePtrInput)(nil)).Elem(), ApplicationInsightsComponentAnalyticsItemPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationInsightsComponentDataVolumeCapInput)(nil)).Elem(), ApplicationInsightsComponentDataVolumeCapArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationInsightsComponentDataVolumeCapPtrInput)(nil)).Elem(), ApplicationInsightsComponentDataVolumeCapArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationInsightsComponentDataVolumeCapResponseInput)(nil)).Elem(), ApplicationInsightsComponentDataVolumeCapResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationInsightsComponentDataVolumeCapResponsePtrInput)(nil)).Elem(), ApplicationInsightsComponentDataVolumeCapResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationInsightsComponentProactiveDetectionConfigurationResponseRuleDefinitionsInput)(nil)).Elem(), ApplicationInsightsComponentProactiveDetectionConfigurationResponseRuleDefinitionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationInsightsComponentProactiveDetectionConfigurationResponseRuleDefinitionsPtrInput)(nil)).Elem(), ApplicationInsightsComponentProactiveDetectionConfigurationResponseRuleDefinitionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitionsInput)(nil)).Elem(), ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitionsPtrInput)(nil)).Elem(), ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitionsArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AzNsActionGroupInput)(nil)).Elem(), AzNsActionGroupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzNsActionGroupPtrInput)(nil)).Elem(), AzNsActionGroupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzNsActionGroupResponseInput)(nil)).Elem(), AzNsActionGroupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzNsActionGroupResponsePtrInput)(nil)).Elem(), AzNsActionGroupResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CriteriaArrayInput)(nil)).Elem(), CriteriaArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CriteriaResponseInput)(nil)).Elem(), CriteriaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CriteriaResponseArrayInput)(nil)).Elem(), CriteriaResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DimensionResponseInput)(nil)).Elem(), DimensionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DimensionResponseArrayInput)(nil)).Elem(), DimensionResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LogMetricTriggerInput)(nil)).Elem(), LogMetricTriggerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LogMetricTriggerPtrInput)(nil)).Elem(), LogMetricTriggerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LogMetricTriggerResponseInput)(nil)).Elem(), LogMetricTriggerResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LogMetricTriggerResponsePtrInput)(nil)).Elem(), LogMetricTriggerResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LogToMetricActionInput)(nil)).Elem(), LogToMetricActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LogToMetricActionResponseInput)(nil)).Elem(), LogToMetricActionResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TriggerConditionResponseInput)(nil)).Elem(), TriggerConditionResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestGeolocationInput)(nil)).Elem(), WebTestGeolocationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestGeolocationArrayInput)(nil)).Elem(), WebTestGeolocationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestGeolocationResponseInput)(nil)).Elem(), WebTestGeolocationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestGeolocationResponseArrayInput)(nil)).Elem(), WebTestGeolocationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesConfigurationInput)(nil)).Elem(), WebTestPropertiesConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesConfigurationPtrInput)(nil)).Elem(), WebTestPropertiesConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesResponseConfigurationInput)(nil)).Elem(), WebTestPropertiesResponseConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesResponseConfigurationPtrInput)(nil)).Elem(), WebTestPropertiesResponseConfigurationArgs{})
