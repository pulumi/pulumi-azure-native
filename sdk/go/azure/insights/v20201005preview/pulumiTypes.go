...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderFieldInput)(nil)).Elem(), HeaderFieldArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderFieldArrayInput)(nil)).Elem(), HeaderFieldArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderFieldResponseInput)(nil)).Elem(), HeaderFieldResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeaderFieldResponseArrayInput)(nil)).Elem(), HeaderFieldResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesContentValidationInput)(nil)).Elem(), WebTestPropertiesContentValidationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesContentValidationPtrInput)(nil)).Elem(), WebTestPropertiesContentValidationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesRequestInput)(nil)).Elem(), WebTestPropertiesRequestArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesRequestPtrInput)(nil)).Elem(), WebTestPropertiesRequestArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesResponseContentValidationInput)(nil)).Elem(), WebTestPropertiesResponseContentValidationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesResponseContentValidationPtrInput)(nil)).Elem(), WebTestPropertiesResponseContentValidationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesResponseRequestInput)(nil)).Elem(), WebTestPropertiesResponseRequestArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesResponseRequestPtrInput)(nil)).Elem(), WebTestPropertiesResponseRequestArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesResponseValidationRulesInput)(nil)).Elem(), WebTestPropertiesResponseValidationRulesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesResponseValidationRulesPtrInput)(nil)).Elem(), WebTestPropertiesResponseValidationRulesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesValidationRulesInput)(nil)).Elem(), WebTestPropertiesValidationRulesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WebTestPropertiesValidationRulesPtrInput)(nil)).Elem(), WebTestPropertiesValidationRulesArgs{})
