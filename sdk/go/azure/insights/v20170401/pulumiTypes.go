...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertActionGroupInput)(nil)).Elem(), ActivityLogAlertActionGroupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertActionGroupArrayInput)(nil)).Elem(), ActivityLogAlertActionGroupArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertActionGroupResponseInput)(nil)).Elem(), ActivityLogAlertActionGroupResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertActionGroupResponseArrayInput)(nil)).Elem(), ActivityLogAlertActionGroupResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertActionListInput)(nil)).Elem(), ActivityLogAlertActionListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertActionListPtrInput)(nil)).Elem(), ActivityLogAlertActionListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertActionListResponseInput)(nil)).Elem(), ActivityLogAlertActionListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertActionListResponsePtrInput)(nil)).Elem(), ActivityLogAlertActionListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertAllOfConditionInput)(nil)).Elem(), ActivityLogAlertAllOfConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertAllOfConditionPtrInput)(nil)).Elem(), ActivityLogAlertAllOfConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertAllOfConditionResponseInput)(nil)).Elem(), ActivityLogAlertAllOfConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertAllOfConditionResponsePtrInput)(nil)).Elem(), ActivityLogAlertAllOfConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertLeafConditionInput)(nil)).Elem(), ActivityLogAlertLeafConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertLeafConditionArrayInput)(nil)).Elem(), ActivityLogAlertLeafConditionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertLeafConditionResponseInput)(nil)).Elem(), ActivityLogAlertLeafConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActivityLogAlertLeafConditionResponseArrayInput)(nil)).Elem(), ActivityLogAlertLeafConditionResponseArray{})
