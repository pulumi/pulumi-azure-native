...
func NewPrivateLinkScopedResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:insights:PrivateLinkScopedResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkScopedResource(ctx *pulumi.Context,
	...
	var resource PrivateLinkScopedResource
	err := ctx.ReadResource("azure-nextgen:insights:PrivateLinkScopedResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
