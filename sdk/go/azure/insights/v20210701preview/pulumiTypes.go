...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AccessModeSettingsInput)(nil)).Elem(), AccessModeSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessModeSettingsPtrInput)(nil)).Elem(), AccessModeSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessModeSettingsExclusionInput)(nil)).Elem(), AccessModeSettingsExclusionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessModeSettingsExclusionArrayInput)(nil)).Elem(), AccessModeSettingsExclusionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessModeSettingsExclusionResponseInput)(nil)).Elem(), AccessModeSettingsExclusionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessModeSettingsExclusionResponseArrayInput)(nil)).Elem(), AccessModeSettingsExclusionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessModeSettingsResponseInput)(nil)).Elem(), AccessModeSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessModeSettingsResponsePtrInput)(nil)).Elem(), AccessModeSettingsResponseArgs{})
