...
func NewSubscriptionDiagnosticSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:insights:SubscriptionDiagnosticSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscriptionDiagnosticSetting(ctx *pulumi.Context,
	...
	var resource SubscriptionDiagnosticSetting
	err := ctx.ReadResource("azure-nextgen:insights:SubscriptionDiagnosticSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
