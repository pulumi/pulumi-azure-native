...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DataSourceConfigurationResponseInput)(nil)).Elem(), DataSourceConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataSourceResponseInput)(nil)).Elem(), DataSourceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DataSourceResponseArrayInput)(nil)).Elem(), DataSourceResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EtwEventConfigurationInput)(nil)).Elem(), EtwEventConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EtwEventConfigurationArrayInput)(nil)).Elem(), EtwEventConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EtwEventConfigurationResponseInput)(nil)).Elem(), EtwEventConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EtwEventConfigurationResponseArrayInput)(nil)).Elem(), EtwEventConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EtwProviderConfigurationInput)(nil)).Elem(), EtwProviderConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EtwProviderConfigurationArrayInput)(nil)).Elem(), EtwProviderConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EtwProviderConfigurationResponseInput)(nil)).Elem(), EtwProviderConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EtwProviderConfigurationResponseArrayInput)(nil)).Elem(), EtwProviderConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventLogConfigurationInput)(nil)).Elem(), EventLogConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventLogConfigurationArrayInput)(nil)).Elem(), EventLogConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventLogConfigurationResponseInput)(nil)).Elem(), EventLogConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EventLogConfigurationResponseArrayInput)(nil)).Elem(), EventLogConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PerformanceCounterConfigurationInput)(nil)).Elem(), PerformanceCounterConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PerformanceCounterConfigurationArrayInput)(nil)).Elem(), PerformanceCounterConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PerformanceCounterConfigurationResponseInput)(nil)).Elem(), PerformanceCounterConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PerformanceCounterConfigurationResponseArrayInput)(nil)).Elem(), PerformanceCounterConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SinkConfigurationInput)(nil)).Elem(), SinkConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SinkConfigurationArrayInput)(nil)).Elem(), SinkConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SinkConfigurationResponseInput)(nil)).Elem(), SinkConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SinkConfigurationResponseArrayInput)(nil)).Elem(), SinkConfigurationResponseArray{})
