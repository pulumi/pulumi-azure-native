...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MetricSettingsInput)(nil)).Elem(), MetricSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricSettingsArrayInput)(nil)).Elem(), MetricSettingsArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricSettingsResponseInput)(nil)).Elem(), MetricSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MetricSettingsResponseArrayInput)(nil)).Elem(), MetricSettingsResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PredictiveAutoscalePolicyInput)(nil)).Elem(), PredictiveAutoscalePolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictiveAutoscalePolicyPtrInput)(nil)).Elem(), PredictiveAutoscalePolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictiveAutoscalePolicyResponseInput)(nil)).Elem(), PredictiveAutoscalePolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PredictiveAutoscalePolicyResponsePtrInput)(nil)).Elem(), PredictiveAutoscalePolicyResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionLogSettingsInput)(nil)).Elem(), SubscriptionLogSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionLogSettingsArrayInput)(nil)).Elem(), SubscriptionLogSettingsArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionLogSettingsResponseInput)(nil)).Elem(), SubscriptionLogSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SubscriptionLogSettingsResponseArrayInput)(nil)).Elem(), SubscriptionLogSettingsResponseArray{})
