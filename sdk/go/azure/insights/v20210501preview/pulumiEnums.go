...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*PredictiveAutoscalePolicyScaleModeInput)(nil)).Elem(), PredictiveAutoscalePolicyScaleMode("Disabled"))
	pulumi.RegisterInputType(reflect.TypeOf((*PredictiveAutoscalePolicyScaleModePtrInput)(nil)).Elem(), PredictiveAutoscalePolicyScaleMode("Disabled"))
