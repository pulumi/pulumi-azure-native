...
func NewExportConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:insights/v20150501:ExportConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExportConfiguration(ctx *pulumi.Context,
	...
	var resource ExportConfiguration
	err := ctx.ReadResource("azure-nextgen:insights/v20150501:ExportConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
