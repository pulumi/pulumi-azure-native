...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ActionGroupResponseArrayInput)(nil)).Elem(), ActionGroupResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActionListInput)(nil)).Elem(), ActionListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActionListPtrInput)(nil)).Elem(), ActionListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActionListResponseInput)(nil)).Elem(), ActionListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActionListResponsePtrInput)(nil)).Elem(), ActionListResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertRuleAllOfConditionInput)(nil)).Elem(), AlertRuleAllOfConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertRuleAllOfConditionPtrInput)(nil)).Elem(), AlertRuleAllOfConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertRuleAllOfConditionResponseInput)(nil)).Elem(), AlertRuleAllOfConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertRuleAllOfConditionResponsePtrInput)(nil)).Elem(), AlertRuleAllOfConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertRuleAnyOfOrLeafConditionInput)(nil)).Elem(), AlertRuleAnyOfOrLeafConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertRuleAnyOfOrLeafConditionArrayInput)(nil)).Elem(), AlertRuleAnyOfOrLeafConditionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertRuleAnyOfOrLeafConditionResponseInput)(nil)).Elem(), AlertRuleAnyOfOrLeafConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertRuleAnyOfOrLeafConditionResponseArrayInput)(nil)).Elem(), AlertRuleAnyOfOrLeafConditionResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertRuleLeafConditionInput)(nil)).Elem(), AlertRuleLeafConditionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertRuleLeafConditionArrayInput)(nil)).Elem(), AlertRuleLeafConditionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertRuleLeafConditionResponseInput)(nil)).Elem(), AlertRuleLeafConditionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AlertRuleLeafConditionResponseArrayInput)(nil)).Elem(), AlertRuleLeafConditionResponseArray{})
