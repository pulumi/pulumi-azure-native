...
func NewGallery(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20220901preview:Gallery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGallery(ctx *pulumi.Context,
	...
	var resource Gallery
	err := ctx.ReadResource("azure-native:devcenter/v20220901preview:Gallery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
