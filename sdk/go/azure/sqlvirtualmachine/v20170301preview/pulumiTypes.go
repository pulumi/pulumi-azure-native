...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AdditionalFeaturesServerConfigurationsInput)(nil)).Elem(), AdditionalFeaturesServerConfigurationsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdditionalFeaturesServerConfigurationsPtrInput)(nil)).Elem(), AdditionalFeaturesServerConfigurationsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdditionalFeaturesServerConfigurationsResponseInput)(nil)).Elem(), AdditionalFeaturesServerConfigurationsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AdditionalFeaturesServerConfigurationsResponsePtrInput)(nil)).Elem(), AdditionalFeaturesServerConfigurationsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoBackupSettingsInput)(nil)).Elem(), AutoBackupSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoBackupSettingsPtrInput)(nil)).Elem(), AutoBackupSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoBackupSettingsResponseInput)(nil)).Elem(), AutoBackupSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoBackupSettingsResponsePtrInput)(nil)).Elem(), AutoBackupSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoPatchingSettingsInput)(nil)).Elem(), AutoPatchingSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoPatchingSettingsPtrInput)(nil)).Elem(), AutoPatchingSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoPatchingSettingsResponseInput)(nil)).Elem(), AutoPatchingSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoPatchingSettingsResponsePtrInput)(nil)).Elem(), AutoPatchingSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultCredentialSettingsInput)(nil)).Elem(), KeyVaultCredentialSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultCredentialSettingsPtrInput)(nil)).Elem(), KeyVaultCredentialSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultCredentialSettingsResponseInput)(nil)).Elem(), KeyVaultCredentialSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyVaultCredentialSettingsResponsePtrInput)(nil)).Elem(), KeyVaultCredentialSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerConfigurationInput)(nil)).Elem(), LoadBalancerConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerConfigurationArrayInput)(nil)).Elem(), LoadBalancerConfigurationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerConfigurationResponseInput)(nil)).Elem(), LoadBalancerConfigurationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LoadBalancerConfigurationResponseArrayInput)(nil)).Elem(), LoadBalancerConfigurationResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateIPAddressInput)(nil)).Elem(), PrivateIPAddressArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateIPAddressPtrInput)(nil)).Elem(), PrivateIPAddressArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateIPAddressResponseInput)(nil)).Elem(), PrivateIPAddressResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*PrivateIPAddressResponsePtrInput)(nil)).Elem(), PrivateIPAddressResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SQLStorageSettingsInput)(nil)).Elem(), SQLStorageSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SQLStorageSettingsPtrInput)(nil)).Elem(), SQLStorageSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SQLStorageSettingsResponseInput)(nil)).Elem(), SQLStorageSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SQLStorageSettingsResponsePtrInput)(nil)).Elem(), SQLStorageSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerConfigurationsManagementSettingsInput)(nil)).Elem(), ServerConfigurationsManagementSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerConfigurationsManagementSettingsPtrInput)(nil)).Elem(), ServerConfigurationsManagementSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerConfigurationsManagementSettingsResponseInput)(nil)).Elem(), ServerConfigurationsManagementSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ServerConfigurationsManagementSettingsResponsePtrInput)(nil)).Elem(), ServerConfigurationsManagementSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlConnectivityUpdateSettingsInput)(nil)).Elem(), SqlConnectivityUpdateSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlConnectivityUpdateSettingsPtrInput)(nil)).Elem(), SqlConnectivityUpdateSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlConnectivityUpdateSettingsResponseInput)(nil)).Elem(), SqlConnectivityUpdateSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlConnectivityUpdateSettingsResponsePtrInput)(nil)).Elem(), SqlConnectivityUpdateSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlStorageUpdateSettingsInput)(nil)).Elem(), SqlStorageUpdateSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlStorageUpdateSettingsPtrInput)(nil)).Elem(), SqlStorageUpdateSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlStorageUpdateSettingsResponseInput)(nil)).Elem(), SqlStorageUpdateSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlStorageUpdateSettingsResponsePtrInput)(nil)).Elem(), SqlStorageUpdateSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlWorkloadTypeUpdateSettingsInput)(nil)).Elem(), SqlWorkloadTypeUpdateSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlWorkloadTypeUpdateSettingsPtrInput)(nil)).Elem(), SqlWorkloadTypeUpdateSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlWorkloadTypeUpdateSettingsResponseInput)(nil)).Elem(), SqlWorkloadTypeUpdateSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SqlWorkloadTypeUpdateSettingsResponsePtrInput)(nil)).Elem(), SqlWorkloadTypeUpdateSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageConfigurationSettingsInput)(nil)).Elem(), StorageConfigurationSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageConfigurationSettingsPtrInput)(nil)).Elem(), StorageConfigurationSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageConfigurationSettingsResponseInput)(nil)).Elem(), StorageConfigurationSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageConfigurationSettingsResponsePtrInput)(nil)).Elem(), StorageConfigurationSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsfcDomainCredentialsInput)(nil)).Elem(), WsfcDomainCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsfcDomainCredentialsPtrInput)(nil)).Elem(), WsfcDomainCredentialsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsfcDomainCredentialsResponseInput)(nil)).Elem(), WsfcDomainCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsfcDomainCredentialsResponsePtrInput)(nil)).Elem(), WsfcDomainCredentialsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsfcDomainProfileInput)(nil)).Elem(), WsfcDomainProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsfcDomainProfilePtrInput)(nil)).Elem(), WsfcDomainProfileArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsfcDomainProfileResponseInput)(nil)).Elem(), WsfcDomainProfileResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WsfcDomainProfileResponsePtrInput)(nil)).Elem(), WsfcDomainProfileResponseArgs{})
