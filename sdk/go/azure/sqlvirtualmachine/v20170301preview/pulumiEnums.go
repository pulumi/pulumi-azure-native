...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*BackupScheduleTypeInput)(nil)).Elem(), BackupScheduleType("Manual"))
	pulumi.RegisterInputType(reflect.TypeOf((*BackupScheduleTypePtrInput)(nil)).Elem(), BackupScheduleType("Manual"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityTypeInput)(nil)).Elem(), ConnectivityType("LOCAL"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityTypePtrInput)(nil)).Elem(), ConnectivityType("LOCAL"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DiskConfigurationTypeInput)(nil)).Elem(), DiskConfigurationType("NEW"))
	pulumi.RegisterInputType(reflect.TypeOf((*DiskConfigurationTypePtrInput)(nil)).Elem(), DiskConfigurationType("NEW"))
	pulumi.RegisterInputType(reflect.TypeOf((*FullBackupFrequencyTypeInput)(nil)).Elem(), FullBackupFrequencyType("Daily"))
	pulumi.RegisterInputType(reflect.TypeOf((*FullBackupFrequencyTypePtrInput)(nil)).Elem(), FullBackupFrequencyType("Daily"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SqlImageSkuInput)(nil)).Elem(), SqlImageSku("Developer"))
	pulumi.RegisterInputType(reflect.TypeOf((*SqlImageSkuPtrInput)(nil)).Elem(), SqlImageSku("Developer"))
	pulumi.RegisterInputType(reflect.TypeOf((*SqlManagementModeInput)(nil)).Elem(), SqlManagementMode("Full"))
	pulumi.RegisterInputType(reflect.TypeOf((*SqlManagementModePtrInput)(nil)).Elem(), SqlManagementMode("Full"))
	pulumi.RegisterInputType(reflect.TypeOf((*SqlServerLicenseTypeInput)(nil)).Elem(), SqlServerLicenseType("PAYG"))
	pulumi.RegisterInputType(reflect.TypeOf((*SqlServerLicenseTypePtrInput)(nil)).Elem(), SqlServerLicenseType("PAYG"))
	pulumi.RegisterInputType(reflect.TypeOf((*SqlVmGroupImageSkuInput)(nil)).Elem(), SqlVmGroupImageSku("Developer"))
	pulumi.RegisterInputType(reflect.TypeOf((*SqlVmGroupImageSkuPtrInput)(nil)).Elem(), SqlVmGroupImageSku("Developer"))
	pulumi.RegisterInputType(reflect.TypeOf((*SqlWorkloadTypeInput)(nil)).Elem(), SqlWorkloadType("GENERAL"))
	pulumi.RegisterInputType(reflect.TypeOf((*SqlWorkloadTypePtrInput)(nil)).Elem(), SqlWorkloadType("GENERAL"))
	pulumi.RegisterInputType(reflect.TypeOf((*StorageWorkloadTypeInput)(nil)).Elem(), StorageWorkloadType("GENERAL"))
	pulumi.RegisterInputType(reflect.TypeOf((*StorageWorkloadTypePtrInput)(nil)).Elem(), StorageWorkloadType("GENERAL"))
