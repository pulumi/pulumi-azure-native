...
func NewSourceControl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220601preview:SourceControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSourceControl(ctx *pulumi.Context,
	...
	var resource SourceControl
	err := ctx.ReadResource("azure-native:securityinsights/v20220601preview:SourceControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
