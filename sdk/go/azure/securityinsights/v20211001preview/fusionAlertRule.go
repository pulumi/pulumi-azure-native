...
func NewFusionAlertRule(ctx *pulumi.Context,
	...
	if args.SourceSettings == nil {
		return nil, errors.New("invalid value for required argument 'SourceSettings'")
	}
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20211001preview:FusionAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFusionAlertRule(ctx *pulumi.Context,
	...
	var resource FusionAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20211001preview:FusionAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
