...
func LookupNrtAlertRule(ctx *pulumi.Context, args *LookupNrtAlertRuleArgs, opts ...pulumi.InvokeOption) (*LookupNrtAlertRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20211001preview:getNrtAlertRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupNrtAlertRuleResultOutput) Query() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupNrtAlertRuleResult) *string { return v.Query }).(pulumi.StringPtrOutput)
}

func (o LookupNrtAlertRuleResultOutput) Severity() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupNrtAlertRuleResult) *string { return v.Severity }).(pulumi.StringPtrOutput)
}
