...
func NewOfficeIRMDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220801preview:OfficeIRMDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOfficeIRMDataConnector(ctx *pulumi.Context,
	...
	var resource OfficeIRMDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20220801preview:OfficeIRMDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
