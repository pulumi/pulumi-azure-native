...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AlertDetailInput)(nil)).Elem(), AlertDetail("DisplayName"))
	pulumi.RegisterInputType(reflect.TypeOf((*AlertDetailPtrInput)(nil)).Elem(), AlertDetail("DisplayName"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityTypeInput)(nil)).Elem(), ConnectivityType("IsConnectedQuery"))
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityTypePtrInput)(nil)).Elem(), ConnectivityType("IsConnectedQuery"))
	pulumi.RegisterInputType(reflect.TypeOf((*ContentTypeInput)(nil)).Elem(), ContentType("AnalyticRule"))
	pulumi.RegisterInputType(reflect.TypeOf((*ContentTypePtrInput)(nil)).Elem(), ContentType("AnalyticRule"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CustomEntityQueryKindInput)(nil)).Elem(), CustomEntityQueryKind("Activity"))
	pulumi.RegisterInputType(reflect.TypeOf((*CustomEntityQueryKindPtrInput)(nil)).Elem(), CustomEntityQueryKind("Activity"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EntityMappingTypeInput)(nil)).Elem(), EntityMappingType("Account"))
	pulumi.RegisterInputType(reflect.TypeOf((*EntityMappingTypePtrInput)(nil)).Elem(), EntityMappingType("Account"))
	pulumi.RegisterInputType(reflect.TypeOf((*EntityTypeInput)(nil)).Elem(), EntityType("Account"))
	pulumi.RegisterInputType(reflect.TypeOf((*EntityTypePtrInput)(nil)).Elem(), EntityType("Account"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KindInput)(nil)).Elem(), Kind("DataConnector"))
	pulumi.RegisterInputType(reflect.TypeOf((*KindPtrInput)(nil)).Elem(), Kind("DataConnector"))
	pulumi.RegisterInputType(reflect.TypeOf((*MatchingMethodInput)(nil)).Elem(), MatchingMethod("AllEntities"))
	pulumi.RegisterInputType(reflect.TypeOf((*MatchingMethodPtrInput)(nil)).Elem(), MatchingMethod("AllEntities"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OperatorInput)(nil)).Elem(), Operator("AND"))
	pulumi.RegisterInputType(reflect.TypeOf((*OperatorPtrInput)(nil)).Elem(), Operator("AND"))
	pulumi.RegisterInputType(reflect.TypeOf((*PermissionProviderScopeInput)(nil)).Elem(), PermissionProviderScope("ResourceGroup"))
	pulumi.RegisterInputType(reflect.TypeOf((*PermissionProviderScopePtrInput)(nil)).Elem(), PermissionProviderScope("ResourceGroup"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ProviderNameInput)(nil)).Elem(), ProviderName("Microsoft.OperationalInsights/solutions"))
	pulumi.RegisterInputType(reflect.TypeOf((*ProviderNamePtrInput)(nil)).Elem(), ProviderName("Microsoft.OperationalInsights/solutions"))
	pulumi.RegisterInputType(reflect.TypeOf((*RepoTypeInput)(nil)).Elem(), RepoType("Github"))
	pulumi.RegisterInputType(reflect.TypeOf((*RepoTypePtrInput)(nil)).Elem(), RepoType("Github"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SettingTypeInput)(nil)).Elem(), SettingType("CopyableLabel"))
	pulumi.RegisterInputType(reflect.TypeOf((*SettingTypePtrInput)(nil)).Elem(), SettingType("CopyableLabel"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SourceKindInput)(nil)).Elem(), SourceKind("LocalWorkspace"))
	pulumi.RegisterInputType(reflect.TypeOf((*SourceKindPtrInput)(nil)).Elem(), SourceKind("LocalWorkspace"))
	pulumi.RegisterInputType(reflect.TypeOf((*SupportTierInput)(nil)).Elem(), SupportTier("Microsoft"))
	pulumi.RegisterInputType(reflect.TypeOf((*SupportTierPtrInput)(nil)).Elem(), SupportTier("Microsoft"))
