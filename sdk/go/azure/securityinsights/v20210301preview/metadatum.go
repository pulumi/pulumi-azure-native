...
func NewMetadatum(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights:Metadatum"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20210301preview:Metadatum", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetadatum(ctx *pulumi.Context,
	...
	var resource Metadatum
	err := ctx.ReadResource("azure-native:securityinsights/v20210301preview:Metadatum", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
