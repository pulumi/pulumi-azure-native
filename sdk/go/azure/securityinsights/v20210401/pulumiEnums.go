...
// ThreatIntelligenceResourceInnerKindInput is an input type that accepts ThreatIntelligenceResourceInnerKindArgs and ThreatIntelligenceResourceInnerKindOutput values.
// You can construct a concrete instance of `ThreatIntelligenceResourceInnerKindInput` via:
//
//          ThreatIntelligenceResourceInnerKindArgs{...}
