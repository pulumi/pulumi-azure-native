...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LinkedResourceInput)(nil)).Elem(), LinkedResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LinkedResourceArrayInput)(nil)).Elem(), LinkedResourceArray{})
