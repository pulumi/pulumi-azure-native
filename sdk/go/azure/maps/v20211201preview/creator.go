...
func NewCreator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:maps/v20211201preview:Creator"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:maps/v20211201preview:Creator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCreator(ctx *pulumi.Context,
	...
	var resource Creator
	err := ctx.ReadResource("azure-native:maps/v20211201preview:Creator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
