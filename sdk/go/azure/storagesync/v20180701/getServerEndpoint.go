...
func LookupServerEndpoint(ctx *pulumi.Context, args *LookupServerEndpointArgs, opts ...pulumi.InvokeOption) (*LookupServerEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:storagesync/v20180701:getServerEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupServerEndpointResultOutput) SyncStatus() pulumi.AnyOutput {
	return o.ApplyT(func(v LookupServerEndpointResult) interface{} { return v.SyncStatus }).(pulumi.AnyOutput)
}
