...
func (m *module) Construct(ctx *pulumi.Context, name, typ, urn string) (r pulumi.Resource, err error) {
	switch typ {
	case "azure-nextgen:storagesync/v20180402:CloudEndpoint":
		r, err = NewCloudEndpoint(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:storagesync/v20180402:RegisteredServer":
		r, err = NewRegisteredServer(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:storagesync/v20180402:ServerEndpoint":
		r, err = NewServerEndpoint(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:storagesync/v20180402:StorageSyncService":
		r, err = NewStorageSyncService(ctx, name, nil, pulumi.URN_(urn))
	case "azure-nextgen:storagesync/v20180402:SyncGroup":
