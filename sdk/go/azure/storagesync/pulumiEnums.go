...
// FeatureStatusInput is an input type that accepts FeatureStatusArgs and FeatureStatusOutput values.
// You can construct a concrete instance of `FeatureStatusInput` via:
//
//          FeatureStatusArgs{...}
...
// IncomingTrafficPolicyInput is an input type that accepts IncomingTrafficPolicyArgs and IncomingTrafficPolicyOutput values.
// You can construct a concrete instance of `IncomingTrafficPolicyInput` via:
//
//          IncomingTrafficPolicyArgs{...}
...
// InitialDownloadPolicyInput is an input type that accepts InitialDownloadPolicyArgs and InitialDownloadPolicyOutput values.
// You can construct a concrete instance of `InitialDownloadPolicyInput` via:
//
...
// LocalCacheModeInput is an input type that accepts LocalCacheModeArgs and LocalCacheModeOutput values.
// You can construct a concrete instance of `LocalCacheModeInput` via:
//
//          LocalCacheModeArgs{...}
