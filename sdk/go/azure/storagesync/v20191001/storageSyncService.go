...
func NewStorageSyncService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:storagesync/v20191001:StorageSyncService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageSyncService(ctx *pulumi.Context,
	...
	var resource StorageSyncService
	err := ctx.ReadResource("azure-nextgen:storagesync/v20191001:StorageSyncService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
