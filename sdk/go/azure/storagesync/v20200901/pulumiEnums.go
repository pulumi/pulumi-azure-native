...
// InitialUploadPolicyInput is an input type that accepts InitialUploadPolicyArgs and InitialUploadPolicyOutput values.
// You can construct a concrete instance of `InitialUploadPolicyInput` via:
//
