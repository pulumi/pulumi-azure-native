...
type ServerEndpointBackgroundDataDownloadActivityInvokeResponse struct {
...
// ServerEndpointBackgroundDataDownloadActivityInvokeResponseInput is an input type that accepts ServerEndpointBackgroundDataDownloadActivityInvokeResponseArgs and ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput values.
// You can construct a concrete instance of `ServerEndpointBackgroundDataDownloadActivityInvokeResponseInput` via:
//
//          ServerEndpointBackgroundDataDownloadActivityInvokeResponseArgs{...}
type ServerEndpointBackgroundDataDownloadActivityInvokeResponseInput interface {
	pulumi.Input

	ToServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput() ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput
	ToServerEndpointBackgroundDataDownloadActivityInvokeResponseOutputWithContext(context.Context) ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput
}

// Background data download activity object
type ServerEndpointBackgroundDataDownloadActivityInvokeResponseArgs struct {
	// Running count of bytes downloaded
...
func (ServerEndpointBackgroundDataDownloadActivityInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ServerEndpointBackgroundDataDownloadActivityInvokeResponse)(nil)).Elem()
}

func (i ServerEndpointBackgroundDataDownloadActivityInvokeResponseArgs) ToServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput() ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput {
	return i.ToServerEndpointBackgroundDataDownloadActivityInvokeResponseOutputWithContext(context.Background())
}

func (i ServerEndpointBackgroundDataDownloadActivityInvokeResponseArgs) ToServerEndpointBackgroundDataDownloadActivityInvokeResponseOutputWithContext(ctx context.Context) ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput)
}

// Background data download activity object
type ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput struct{ *pulumi.OutputState }

func (ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ServerEndpointBackgroundDataDownloadActivityInvokeResponse)(nil)).Elem()
}

func (o ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput) ToServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput() ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput {
	return o
}

func (o ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput) ToServerEndpointBackgroundDataDownloadActivityInvokeResponseOutputWithContext(ctx context.Context) ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput {
	return o
}

// Running count of bytes downloaded
func (o ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput) DownloadedBytes() pulumi.Float64Output {
	return o.ApplyT(func(v ServerEndpointBackgroundDataDownloadActivityInvokeResponse) float64 { return v.DownloadedBytes }).(pulumi.Float64Output)
}

// Progress percentage
func (o ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput) PercentProgress() pulumi.IntOutput {
	return o.ApplyT(func(v ServerEndpointBackgroundDataDownloadActivityInvokeResponse) int { return v.PercentProgress }).(pulumi.IntOutput)
}

// Timestamp when properties were updated
func (o ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput) Timestamp() pulumi.StringOutput {
	return o.ApplyT(func(v ServerEndpointBackgroundDataDownloadActivityInvokeResponse) string { return v.Timestamp }).(pulumi.StringOutput)
}
...
// Sync mode
func (o ServerEndpointSyncActivityStatusInvokeResponseOutput) SyncMode() pulumi.StringOutput {
	return o.ApplyT(func(v ServerEndpointSyncActivityStatusInvokeResponse) string { return v.SyncMode }).(pulumi.StringOutput)
}
...
// Sync mode
func (o ServerEndpointSyncSessionStatusInvokeResponseOutput) LastSyncMode() pulumi.StringOutput {
	return o.ApplyT(func(v ServerEndpointSyncSessionStatusInvokeResponse) string { return v.LastSyncMode }).(pulumi.StringOutput)
}
...
type ServerEndpointSyncStatusInvokeResponse struct {
	...
	BackgroundDataDownloadActivity ServerEndpointBackgroundDataDownloadActivityInvokeResponse `pulumi:"backgroundDataDownloadActivity"`
...
type ServerEndpointSyncStatusInvokeResponseArgs struct {
	// Background data download activity
	BackgroundDataDownloadActivity ServerEndpointBackgroundDataDownloadActivityInvokeResponseInput `pulumi:"backgroundDataDownloadActivity"`
	// Combined Health Status.
...
// Background data download activity
func (o ServerEndpointSyncStatusInvokeResponseOutput) BackgroundDataDownloadActivity() ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput {
	return o.ApplyT(func(v ServerEndpointSyncStatusInvokeResponse) ServerEndpointBackgroundDataDownloadActivityInvokeResponse {
		return v.BackgroundDataDownloadActivity
	}).(ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ServerEndpointBackgroundDataDownloadActivityInvokeResponseOutput{})
