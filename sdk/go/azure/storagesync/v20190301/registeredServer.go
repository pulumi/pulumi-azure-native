...
func NewRegisteredServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:storagesync/v20190301:RegisteredServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegisteredServer(ctx *pulumi.Context,
	...
	var resource RegisteredServer
	err := ctx.ReadResource("azure-nextgen:storagesync/v20190301:RegisteredServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
