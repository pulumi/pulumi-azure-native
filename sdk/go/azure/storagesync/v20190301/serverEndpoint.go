...
func NewServerEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:storagesync/v20190301:ServerEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerEndpoint(ctx *pulumi.Context,
	...
	var resource ServerEndpoint
	err := ctx.ReadResource("azure-nextgen:storagesync/v20190301:ServerEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
