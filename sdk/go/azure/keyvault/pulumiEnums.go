...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CreateModeInput)(nil)).Elem(), CreateMode("recover"))
	pulumi.RegisterInputType(reflect.TypeOf((*CreateModePtrInput)(nil)).Elem(), CreateMode("recover"))
	pulumi.RegisterInputType(reflect.TypeOf((*JsonWebKeyCurveNameInput)(nil)).Elem(), JsonWebKeyCurveName("P-256"))
	pulumi.RegisterInputType(reflect.TypeOf((*JsonWebKeyCurveNamePtrInput)(nil)).Elem(), JsonWebKeyCurveName("P-256"))
	pulumi.RegisterInputType(reflect.TypeOf((*JsonWebKeyOperationInput)(nil)).Elem(), JsonWebKeyOperation("encrypt"))
	pulumi.RegisterInputType(reflect.TypeOf((*JsonWebKeyOperationPtrInput)(nil)).Elem(), JsonWebKeyOperation("encrypt"))
	pulumi.RegisterInputType(reflect.TypeOf((*JsonWebKeyTypeInput)(nil)).Elem(), JsonWebKeyType("EC"))
	pulumi.RegisterInputType(reflect.TypeOf((*JsonWebKeyTypePtrInput)(nil)).Elem(), JsonWebKeyType("EC"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedHsmSkuFamilyInput)(nil)).Elem(), ManagedHsmSkuFamily("B"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedHsmSkuFamilyPtrInput)(nil)).Elem(), ManagedHsmSkuFamily("B"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedHsmSkuNameInput)(nil)).Elem(), ManagedHsmSkuName("Standard_B1"))
	pulumi.RegisterInputType(reflect.TypeOf((*ManagedHsmSkuNamePtrInput)(nil)).Elem(), ManagedHsmSkuName("Standard_B1"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRuleActionInput)(nil)).Elem(), NetworkRuleAction("Allow"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRuleActionPtrInput)(nil)).Elem(), NetworkRuleAction("Allow"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRuleBypassOptionsInput)(nil)).Elem(), NetworkRuleBypassOptions("AzureServices"))
	pulumi.RegisterInputType(reflect.TypeOf((*NetworkRuleBypassOptionsPtrInput)(nil)).Elem(), NetworkRuleBypassOptions("AzureServices"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StoragePermissionsInput)(nil)).Elem(), StoragePermissions("all"))
	pulumi.RegisterInputType(reflect.TypeOf((*StoragePermissionsPtrInput)(nil)).Elem(), StoragePermissions("all"))
	pulumi.RegisterInputType(reflect.TypeOf((*VaultProvisioningStateInput)(nil)).Elem(), VaultProvisioningState("Succeeded"))
	pulumi.RegisterInputType(reflect.TypeOf((*VaultProvisioningStatePtrInput)(nil)).Elem(), VaultProvisioningState("Succeeded"))
