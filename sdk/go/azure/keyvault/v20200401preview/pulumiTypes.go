...
// Properties of the managed HSM Pool
type ManagedHsmPropertiesInvokeResponse struct {
	// The create mode to indicate whether the resource is being created or is being recovered from a deleted resource.
	CreateMode *string `pulumi:"createMode"`
	// Property specifying whether protection against purge is enabled for this managed HSM pool. Setting this property to true activates protection against purge for this managed HSM pool and its content - only the Managed HSM service may initiate a hard, irrecoverable deletion. The setting is effective only if soft delete is also enabled. Enabling this functionality is irreversible.
	EnablePurgeProtection *bool `pulumi:"enablePurgeProtection"`
...
// ManagedHsmPropertiesInvokeResponseInput is an input type that accepts ManagedHsmPropertiesInvokeResponseArgs and ManagedHsmPropertiesInvokeResponseOutput values.
// You can construct a concrete instance of `ManagedHsmPropertiesInvokeResponseInput` via:
//
//          ManagedHsmPropertiesInvokeResponseArgs{...}
type ManagedHsmPropertiesInvokeResponseInput interface {
	pulumi.Input

	ToManagedHsmPropertiesInvokeResponseOutput() ManagedHsmPropertiesInvokeResponseOutput
	ToManagedHsmPropertiesInvokeResponseOutputWithContext(context.Context) ManagedHsmPropertiesInvokeResponseOutput
}

// Properties of the managed HSM Pool
type ManagedHsmPropertiesInvokeResponseArgs struct {
	// The create mode to indicate whether the resource is being created or is being recovered from a deleted resource.
...
func (ManagedHsmPropertiesInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ManagedHsmPropertiesInvokeResponse)(nil)).Elem()
}

func (i ManagedHsmPropertiesInvokeResponseArgs) ToManagedHsmPropertiesInvokeResponseOutput() ManagedHsmPropertiesInvokeResponseOutput {
	return i.ToManagedHsmPropertiesInvokeResponseOutputWithContext(context.Background())
}

func (i ManagedHsmPropertiesInvokeResponseArgs) ToManagedHsmPropertiesInvokeResponseOutputWithContext(ctx context.Context) ManagedHsmPropertiesInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ManagedHsmPropertiesInvokeResponseOutput)
}

// Properties of the managed HSM Pool
type ManagedHsmPropertiesInvokeResponseOutput struct{ *pulumi.OutputState }

func (ManagedHsmPropertiesInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ManagedHsmPropertiesInvokeResponse)(nil)).Elem()
}

func (o ManagedHsmPropertiesInvokeResponseOutput) ToManagedHsmPropertiesInvokeResponseOutput() ManagedHsmPropertiesInvokeResponseOutput {
	return o
}

func (o ManagedHsmPropertiesInvokeResponseOutput) ToManagedHsmPropertiesInvokeResponseOutputWithContext(ctx context.Context) ManagedHsmPropertiesInvokeResponseOutput {
	return o
}

// The create mode to indicate whether the resource is being created or is being recovered from a deleted resource.
func (o ManagedHsmPropertiesInvokeResponseOutput) CreateMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ManagedHsmPropertiesInvokeResponse) *string { return v.CreateMode }).(pulumi.StringPtrOutput)
}

// Property specifying whether protection against purge is enabled for this managed HSM pool. Setting this property to true activates protection against purge for this managed HSM pool and its content - only the Managed HSM service may initiate a hard, irrecoverable deletion. The setting is effective only if soft delete is also enabled. Enabling this functionality is irreversible.
func (o ManagedHsmPropertiesInvokeResponseOutput) EnablePurgeProtection() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v ManagedHsmPropertiesInvokeResponse) *bool { return v.EnablePurgeProtection }).(pulumi.BoolPtrOutput)
}

// Property to specify whether the 'soft delete' functionality is enabled for this managed HSM pool. If it's not set to any value(true or false) when creating new managed HSM pool, it will be set to true by default. Once set to true, it cannot be reverted to false.
func (o ManagedHsmPropertiesInvokeResponseOutput) EnableSoftDelete() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v ManagedHsmPropertiesInvokeResponse) *bool { return v.EnableSoftDelete }).(pulumi.BoolPtrOutput)
}

// The URI of the managed hsm pool for performing operations on keys.
func (o ManagedHsmPropertiesInvokeResponseOutput) HsmUri() pulumi.StringOutput {
	return o.ApplyT(func(v ManagedHsmPropertiesInvokeResponse) string { return v.HsmUri }).(pulumi.StringOutput)
}

// Array of initial administrators object ids for this managed hsm pool.
func (o ManagedHsmPropertiesInvokeResponseOutput) InitialAdminObjectIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v ManagedHsmPropertiesInvokeResponse) []string { return v.InitialAdminObjectIds }).(pulumi.StringArrayOutput)
}

// Provisioning state.
func (o ManagedHsmPropertiesInvokeResponseOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v ManagedHsmPropertiesInvokeResponse) string { return v.ProvisioningState }).(pulumi.StringOutput)
}

// softDelete data retention days. It accepts >=7 and <=90.
func (o ManagedHsmPropertiesInvokeResponseOutput) SoftDeleteRetentionInDays() pulumi.IntPtrOutput {
	return o.ApplyT(func(v ManagedHsmPropertiesInvokeResponse) *int { return v.SoftDeleteRetentionInDays }).(pulumi.IntPtrOutput)
}

// Resource Status Message.
func (o ManagedHsmPropertiesInvokeResponseOutput) StatusMessage() pulumi.StringOutput {
	return o.ApplyT(func(v ManagedHsmPropertiesInvokeResponse) string { return v.StatusMessage }).(pulumi.StringOutput)
}

// The Azure Active Directory tenant ID that should be used for authenticating requests to the managed HSM pool.
func (o ManagedHsmPropertiesInvokeResponseOutput) TenantId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ManagedHsmPropertiesInvokeResponse) *string { return v.TenantId }).(pulumi.StringPtrOutput)
}
...
// SKU details
type ManagedHsmSkuInvokeResponse struct {
	// SKU Family of the managed HSM Pool
	Family string `pulumi:"family"`
	// SKU of the managed HSM Pool
	Name string `pulumi:"name"`
...
// ManagedHsmSkuInvokeResponseInput is an input type that accepts ManagedHsmSkuInvokeResponseArgs and ManagedHsmSkuInvokeResponseOutput values.
// You can construct a concrete instance of `ManagedHsmSkuInvokeResponseInput` via:
//
//          ManagedHsmSkuInvokeResponseArgs{...}
type ManagedHsmSkuInvokeResponseInput interface {
	pulumi.Input

	ToManagedHsmSkuInvokeResponseOutput() ManagedHsmSkuInvokeResponseOutput
	ToManagedHsmSkuInvokeResponseOutputWithContext(context.Context) ManagedHsmSkuInvokeResponseOutput
}

// SKU details
type ManagedHsmSkuInvokeResponseArgs struct {
	// SKU Family of the managed HSM Pool
	Family pulumi.StringInput `pulumi:"family"`
	// SKU of the managed HSM Pool
...
func (ManagedHsmSkuInvokeResponseArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ManagedHsmSkuInvokeResponse)(nil)).Elem()
}

func (i ManagedHsmSkuInvokeResponseArgs) ToManagedHsmSkuInvokeResponseOutput() ManagedHsmSkuInvokeResponseOutput {
	return i.ToManagedHsmSkuInvokeResponseOutputWithContext(context.Background())
}

func (i ManagedHsmSkuInvokeResponseArgs) ToManagedHsmSkuInvokeResponseOutputWithContext(ctx context.Context) ManagedHsmSkuInvokeResponseOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ManagedHsmSkuInvokeResponseOutput)
}

// SKU details
type ManagedHsmSkuInvokeResponseOutput struct{ *pulumi.OutputState }

func (ManagedHsmSkuInvokeResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ManagedHsmSkuInvokeResponse)(nil)).Elem()
}

func (o ManagedHsmSkuInvokeResponseOutput) ToManagedHsmSkuInvokeResponseOutput() ManagedHsmSkuInvokeResponseOutput {
	return o
}

func (o ManagedHsmSkuInvokeResponseOutput) ToManagedHsmSkuInvokeResponseOutputWithContext(ctx context.Context) ManagedHsmSkuInvokeResponseOutput {
	return o
}

// SKU Family of the managed HSM Pool
func (o ManagedHsmSkuInvokeResponseOutput) Family() pulumi.StringOutput {
	return o.ApplyT(func(v ManagedHsmSkuInvokeResponse) string { return v.Family }).(pulumi.StringOutput)
}

// SKU of the managed HSM Pool
func (o ManagedHsmSkuInvokeResponseOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v ManagedHsmSkuInvokeResponse) string { return v.Name }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ManagedHsmPropertiesInvokeResponseOutput{})
	...
	pulumi.RegisterOutputType(ManagedHsmSkuInvokeResponseOutput{})
