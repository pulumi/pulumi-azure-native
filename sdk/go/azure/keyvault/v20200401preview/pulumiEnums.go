...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CertificatePermissionsInput)(nil)).Elem(), CertificatePermissions("get"))
	pulumi.RegisterInputType(reflect.TypeOf((*CertificatePermissionsPtrInput)(nil)).Elem(), CertificatePermissions("get"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeyPermissionsInput)(nil)).Elem(), KeyPermissions("encrypt"))
	pulumi.RegisterInputType(reflect.TypeOf((*KeyPermissionsPtrInput)(nil)).Elem(), KeyPermissions("encrypt"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SecretPermissionsInput)(nil)).Elem(), SecretPermissions("get"))
	pulumi.RegisterInputType(reflect.TypeOf((*SecretPermissionsPtrInput)(nil)).Elem(), SecretPermissions("get"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StoragePermissionsInput)(nil)).Elem(), StoragePermissions("get"))
	pulumi.RegisterInputType(reflect.TypeOf((*StoragePermissionsPtrInput)(nil)).Elem(), StoragePermissions("get"))
