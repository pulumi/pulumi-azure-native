...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KeyRotationPolicyActionTypeInput)(nil)).Elem(), KeyRotationPolicyActionType("rotate"))
	pulumi.RegisterInputType(reflect.TypeOf((*KeyRotationPolicyActionTypePtrInput)(nil)).Elem(), KeyRotationPolicyActionType("rotate"))
