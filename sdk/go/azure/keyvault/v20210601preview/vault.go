...
func NewVault(ctx *pulumi.Context,
	...
	var resource Vault
	err := ctx.RegisterResource("azure-native:keyvault/v20210601preview:Vault", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVault(ctx *pulumi.Context,
	...
	var resource Vault
	err := ctx.ReadResource("azure-native:keyvault/v20210601preview:Vault", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
