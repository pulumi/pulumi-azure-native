...
// Gets or sets the custom domain name. Name is the CNAME source.
func (o CustomDomainInvokeResponseOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CustomDomainInvokeResponse) *string { return v.Name }).(pulumi.StringPtrOutput)
}
