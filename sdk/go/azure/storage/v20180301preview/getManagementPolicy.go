...
func (o LookupManagementPolicyResultOutput) Policy() pulumi.AnyOutput {
	return o.ApplyT(func(v LookupManagementPolicyResult) interface{} { return v.Policy }).(pulumi.AnyOutput)
}
