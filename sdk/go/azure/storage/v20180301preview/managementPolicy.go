...
func NewManagementPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20180301preview:ManagementPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementPolicy(ctx *pulumi.Context,
	...
	var resource ManagementPolicy
	err := ctx.ReadResource("azure-native:storage/v20180301preview:ManagementPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o ManagementPolicyOutput) Policy() pulumi.AnyOutput {
	return o.ApplyT(func(v *ManagementPolicy) pulumi.AnyOutput { return v.Policy }).(pulumi.AnyOutput)
}
