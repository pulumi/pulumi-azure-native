...
func NewBlobContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20181101:BlobContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobContainer(ctx *pulumi.Context,
	...
	var resource BlobContainer
	err := ctx.ReadResource("azure-native:storage/v20181101:BlobContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
