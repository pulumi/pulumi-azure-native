...
func NewBlobInventoryPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:storage/v20210101:BlobInventoryPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobInventoryPolicy(ctx *pulumi.Context,
	...
	var resource BlobInventoryPolicy
	err := ctx.ReadResource("azure-nextgen:storage/v20210101:BlobInventoryPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
