...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CorsRuleResponseInput)(nil)).Elem(), CorsRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsRuleResponseArrayInput)(nil)).Elem(), CorsRuleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsRulesInput)(nil)).Elem(), CorsRulesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsRulesPtrInput)(nil)).Elem(), CorsRulesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsRulesResponseInput)(nil)).Elem(), CorsRulesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CorsRulesResponsePtrInput)(nil)).Elem(), CorsRulesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DeleteRetentionPolicyInput)(nil)).Elem(), DeleteRetentionPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeleteRetentionPolicyPtrInput)(nil)).Elem(), DeleteRetentionPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeleteRetentionPolicyResponseInput)(nil)).Elem(), DeleteRetentionPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeleteRetentionPolicyResponsePtrInput)(nil)).Elem(), DeleteRetentionPolicyResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GeoReplicationStatsResponseInput)(nil)).Elem(), GeoReplicationStatsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GeoReplicationStatsResponsePtrInput)(nil)).Elem(), GeoReplicationStatsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ImmutabilityPolicyPropertiesResponseInput)(nil)).Elem(), ImmutabilityPolicyPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImmutabilityPolicyPropertiesResponsePtrInput)(nil)).Elem(), ImmutabilityPolicyPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LegalHoldPropertiesResponseInput)(nil)).Elem(), LegalHoldPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LegalHoldPropertiesResponsePtrInput)(nil)).Elem(), LegalHoldPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RestrictionInput)(nil)).Elem(), RestrictionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestrictionArrayInput)(nil)).Elem(), RestrictionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestrictionResponseInput)(nil)).Elem(), RestrictionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestrictionResponseArrayInput)(nil)).Elem(), RestrictionResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TagPropertyResponseInput)(nil)).Elem(), TagPropertyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TagPropertyResponseArrayInput)(nil)).Elem(), TagPropertyResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*UpdateHistoryPropertyResponseInput)(nil)).Elem(), UpdateHistoryPropertyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UpdateHistoryPropertyResponseArrayInput)(nil)).Elem(), UpdateHistoryPropertyResponseArray{})
