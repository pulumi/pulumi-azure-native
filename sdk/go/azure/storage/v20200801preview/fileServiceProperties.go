...
func NewFileServiceProperties(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:storage/v20200801preview:FileServiceProperties", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileServiceProperties(ctx *pulumi.Context,
	...
	var resource FileServiceProperties
	err := ctx.ReadResource("azure-nextgen:storage/v20200801preview:FileServiceProperties", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
