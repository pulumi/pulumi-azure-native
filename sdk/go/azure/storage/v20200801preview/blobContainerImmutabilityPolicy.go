...
func NewBlobContainerImmutabilityPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:storage/v20200801preview:BlobContainerImmutabilityPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobContainerImmutabilityPolicy(ctx *pulumi.Context,
	...
	var resource BlobContainerImmutabilityPolicy
	err := ctx.ReadResource("azure-nextgen:storage/v20200801preview:BlobContainerImmutabilityPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
