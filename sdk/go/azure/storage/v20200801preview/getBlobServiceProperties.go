...
func LookupBlobServiceProperties(ctx *pulumi.Context, args *LookupBlobServicePropertiesArgs, opts ...pulumi.InvokeOption) (*LookupBlobServicePropertiesResult, error) {
	...
	err := ctx.Invoke("azure-nextgen:storage/v20200801preview:getBlobServiceProperties", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupBlobServicePropertiesResult struct {
	...
	LastAccessTimeTrackingPolicy *LastAccessTimeTrackingPolicyInvokeResponse `pulumi:"lastAccessTimeTrackingPolicy"`
