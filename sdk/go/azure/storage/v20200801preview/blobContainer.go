...
func NewBlobContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:storage/v20200801preview:BlobContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobContainer(ctx *pulumi.Context,
	...
	var resource BlobContainer
	err := ctx.ReadResource("azure-nextgen:storage/v20200801preview:BlobContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
