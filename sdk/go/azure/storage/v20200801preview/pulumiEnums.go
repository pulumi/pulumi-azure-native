...
// DirectoryServiceOptionsInput is an input type that accepts DirectoryServiceOptionsArgs and DirectoryServiceOptionsOutput values.
// You can construct a concrete instance of `DirectoryServiceOptionsInput` via:
//
...
// EncryptionScopeSourceInput is an input type that accepts EncryptionScopeSourceArgs and EncryptionScopeSourceOutput values.
// You can construct a concrete instance of `EncryptionScopeSourceInput` via:
//
...
// EncryptionScopeStateEnumInput is an input type that accepts EncryptionScopeStateEnumArgs and EncryptionScopeStateEnumOutput values.
// You can construct a concrete instance of `EncryptionScopeStateEnumInput` via:
//
//          EncryptionScopeStateEnumArgs{...}
...
// InventoryRuleTypeInput is an input type that accepts InventoryRuleTypeArgs and InventoryRuleTypeOutput values.
// You can construct a concrete instance of `InventoryRuleTypeInput` via:
//
...
// LargeFileSharesStateInput is an input type that accepts LargeFileSharesStateArgs and LargeFileSharesStateOutput values.
// You can construct a concrete instance of `LargeFileSharesStateInput` via:
//
...
// MinimumTlsVersionInput is an input type that accepts MinimumTlsVersionArgs and MinimumTlsVersionOutput values.
// You can construct a concrete instance of `MinimumTlsVersionInput` via:
//
...
// RootSquashTypeInput is an input type that accepts RootSquashTypeArgs and RootSquashTypeOutput values.
// You can construct a concrete instance of `RootSquashTypeInput` via:
//
//          RootSquashTypeArgs{...}
...
// RoutingChoiceInput is an input type that accepts RoutingChoiceArgs and RoutingChoiceOutput values.
// You can construct a concrete instance of `RoutingChoiceInput` via:
//
//          RoutingChoiceArgs{...}
...
// ShareAccessTierInput is an input type that accepts ShareAccessTierArgs and ShareAccessTierOutput values.
// You can construct a concrete instance of `ShareAccessTierInput` via:
//
//          ShareAccessTierArgs{...}
