...
func NewBlobServiceProperties(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-nextgen:storage/v20200801preview:BlobServiceProperties", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobServiceProperties(ctx *pulumi.Context,
	...
	var resource BlobServiceProperties
	err := ctx.ReadResource("azure-nextgen:storage/v20200801preview:BlobServiceProperties", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
