...
// DefaultSharePermissionInput is an input type that accepts DefaultSharePermissionArgs and DefaultSharePermissionOutput values.
// You can construct a concrete instance of `DefaultSharePermissionInput` via:
//
...
// ExpirationActionInput is an input type that accepts ExpirationActionArgs and ExpirationActionOutput values.
// You can construct a concrete instance of `ExpirationActionInput` via:
//
...
// FormatInput is an input type that accepts FormatArgs and FormatOutput values.
// You can construct a concrete instance of `FormatInput` via:
//
//          FormatArgs{...}
...
// ObjectTypeInput is an input type that accepts ObjectTypeArgs and ObjectTypeOutput values.
// You can construct a concrete instance of `ObjectTypeInput` via:
//
//          ObjectTypeArgs{...}
