...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DefaultSharePermissionInput)(nil)).Elem(), DefaultSharePermission("None"))
	pulumi.RegisterInputType(reflect.TypeOf((*DefaultSharePermissionPtrInput)(nil)).Elem(), DefaultSharePermission("None"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*FormatInput)(nil)).Elem(), Format("Csv"))
	pulumi.RegisterInputType(reflect.TypeOf((*FormatPtrInput)(nil)).Elem(), Format("Csv"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ObjectTypeInput)(nil)).Elem(), ObjectType("Blob"))
	pulumi.RegisterInputType(reflect.TypeOf((*ObjectTypePtrInput)(nil)).Elem(), ObjectType("Blob"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ScheduleInput)(nil)).Elem(), Schedule("Daily"))
	pulumi.RegisterInputType(reflect.TypeOf((*SchedulePtrInput)(nil)).Elem(), Schedule("Daily"))
