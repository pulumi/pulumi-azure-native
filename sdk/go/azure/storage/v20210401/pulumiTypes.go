...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AccessPolicyInput)(nil)).Elem(), AccessPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessPolicyPtrInput)(nil)).Elem(), AccessPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessPolicyResponseInput)(nil)).Elem(), AccessPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccessPolicyResponsePtrInput)(nil)).Elem(), AccessPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveDirectoryPropertiesInput)(nil)).Elem(), ActiveDirectoryPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveDirectoryPropertiesPtrInput)(nil)).Elem(), ActiveDirectoryPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveDirectoryPropertiesResponseInput)(nil)).Elem(), ActiveDirectoryPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ActiveDirectoryPropertiesResponsePtrInput)(nil)).Elem(), ActiveDirectoryPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFilesIdentityBasedAuthenticationInput)(nil)).Elem(), AzureFilesIdentityBasedAuthenticationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFilesIdentityBasedAuthenticationPtrInput)(nil)).Elem(), AzureFilesIdentityBasedAuthenticationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFilesIdentityBasedAuthenticationResponseInput)(nil)).Elem(), AzureFilesIdentityBasedAuthenticationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AzureFilesIdentityBasedAuthenticationResponsePtrInput)(nil)).Elem(), AzureFilesIdentityBasedAuthenticationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobInventoryPolicyDefinitionInput)(nil)).Elem(), BlobInventoryPolicyDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobInventoryPolicyDefinitionResponseInput)(nil)).Elem(), BlobInventoryPolicyDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobInventoryPolicyFilterInput)(nil)).Elem(), BlobInventoryPolicyFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobInventoryPolicyFilterPtrInput)(nil)).Elem(), BlobInventoryPolicyFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobInventoryPolicyFilterResponseInput)(nil)).Elem(), BlobInventoryPolicyFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobInventoryPolicyFilterResponsePtrInput)(nil)).Elem(), BlobInventoryPolicyFilterResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BlobInventoryPolicyRuleResponseInput)(nil)).Elem(), BlobInventoryPolicyRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobInventoryPolicyRuleResponseArrayInput)(nil)).Elem(), BlobInventoryPolicyRuleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobInventoryPolicySchemaInput)(nil)).Elem(), BlobInventoryPolicySchemaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobInventoryPolicySchemaPtrInput)(nil)).Elem(), BlobInventoryPolicySchemaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobInventoryPolicySchemaResponseInput)(nil)).Elem(), BlobInventoryPolicySchemaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobInventoryPolicySchemaResponsePtrInput)(nil)).Elem(), BlobInventoryPolicySchemaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobRestoreParametersResponseInput)(nil)).Elem(), BlobRestoreParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobRestoreParametersResponsePtrInput)(nil)).Elem(), BlobRestoreParametersResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobRestoreRangeResponseInput)(nil)).Elem(), BlobRestoreRangeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobRestoreRangeResponseArrayInput)(nil)).Elem(), BlobRestoreRangeResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobRestoreStatusResponseInput)(nil)).Elem(), BlobRestoreStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BlobRestoreStatusResponsePtrInput)(nil)).Elem(), BlobRestoreStatusResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ChangeFeedInput)(nil)).Elem(), ChangeFeedArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ChangeFeedPtrInput)(nil)).Elem(), ChangeFeedArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ChangeFeedResponseInput)(nil)).Elem(), ChangeFeedResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ChangeFeedResponsePtrInput)(nil)).Elem(), ChangeFeedResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DateAfterCreationInput)(nil)).Elem(), DateAfterCreationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DateAfterCreationPtrInput)(nil)).Elem(), DateAfterCreationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DateAfterCreationResponseInput)(nil)).Elem(), DateAfterCreationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DateAfterCreationResponsePtrInput)(nil)).Elem(), DateAfterCreationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DateAfterModificationInput)(nil)).Elem(), DateAfterModificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DateAfterModificationPtrInput)(nil)).Elem(), DateAfterModificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DateAfterModificationResponseInput)(nil)).Elem(), DateAfterModificationResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DateAfterModificationResponsePtrInput)(nil)).Elem(), DateAfterModificationResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionIdentityInput)(nil)).Elem(), EncryptionIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionIdentityPtrInput)(nil)).Elem(), EncryptionIdentityArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionIdentityResponseInput)(nil)).Elem(), EncryptionIdentityResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionIdentityResponsePtrInput)(nil)).Elem(), EncryptionIdentityResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionScopeKeyVaultPropertiesInput)(nil)).Elem(), EncryptionScopeKeyVaultPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionScopeKeyVaultPropertiesPtrInput)(nil)).Elem(), EncryptionScopeKeyVaultPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionScopeKeyVaultPropertiesResponseInput)(nil)).Elem(), EncryptionScopeKeyVaultPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EncryptionScopeKeyVaultPropertiesResponsePtrInput)(nil)).Elem(), EncryptionScopeKeyVaultPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ImmutableStorageWithVersioningInput)(nil)).Elem(), ImmutableStorageWithVersioningArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImmutableStorageWithVersioningPtrInput)(nil)).Elem(), ImmutableStorageWithVersioningArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImmutableStorageWithVersioningResponseInput)(nil)).Elem(), ImmutableStorageWithVersioningResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImmutableStorageWithVersioningResponsePtrInput)(nil)).Elem(), ImmutableStorageWithVersioningResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyCreationTimeResponseInput)(nil)).Elem(), KeyCreationTimeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyCreationTimeResponsePtrInput)(nil)).Elem(), KeyCreationTimeResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyPolicyInput)(nil)).Elem(), KeyPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyPolicyPtrInput)(nil)).Elem(), KeyPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyPolicyResponseInput)(nil)).Elem(), KeyPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KeyPolicyResponsePtrInput)(nil)).Elem(), KeyPolicyResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LastAccessTimeTrackingPolicyInput)(nil)).Elem(), LastAccessTimeTrackingPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LastAccessTimeTrackingPolicyPtrInput)(nil)).Elem(), LastAccessTimeTrackingPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LastAccessTimeTrackingPolicyResponseInput)(nil)).Elem(), LastAccessTimeTrackingPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LastAccessTimeTrackingPolicyResponsePtrInput)(nil)).Elem(), LastAccessTimeTrackingPolicyResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyActionInput)(nil)).Elem(), ManagementPolicyActionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyActionResponseInput)(nil)).Elem(), ManagementPolicyActionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyBaseBlobInput)(nil)).Elem(), ManagementPolicyBaseBlobArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyBaseBlobPtrInput)(nil)).Elem(), ManagementPolicyBaseBlobArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyBaseBlobResponseInput)(nil)).Elem(), ManagementPolicyBaseBlobResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyBaseBlobResponsePtrInput)(nil)).Elem(), ManagementPolicyBaseBlobResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyDefinitionInput)(nil)).Elem(), ManagementPolicyDefinitionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyDefinitionResponseInput)(nil)).Elem(), ManagementPolicyDefinitionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyFilterInput)(nil)).Elem(), ManagementPolicyFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyFilterPtrInput)(nil)).Elem(), ManagementPolicyFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyFilterResponseInput)(nil)).Elem(), ManagementPolicyFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyFilterResponsePtrInput)(nil)).Elem(), ManagementPolicyFilterResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyRuleResponseInput)(nil)).Elem(), ManagementPolicyRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyRuleResponseArrayInput)(nil)).Elem(), ManagementPolicyRuleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicySchemaInput)(nil)).Elem(), ManagementPolicySchemaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicySchemaPtrInput)(nil)).Elem(), ManagementPolicySchemaArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicySchemaResponseInput)(nil)).Elem(), ManagementPolicySchemaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicySchemaResponsePtrInput)(nil)).Elem(), ManagementPolicySchemaResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicySnapShotInput)(nil)).Elem(), ManagementPolicySnapShotArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicySnapShotPtrInput)(nil)).Elem(), ManagementPolicySnapShotArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicySnapShotResponseInput)(nil)).Elem(), ManagementPolicySnapShotResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicySnapShotResponsePtrInput)(nil)).Elem(), ManagementPolicySnapShotResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyVersionInput)(nil)).Elem(), ManagementPolicyVersionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyVersionPtrInput)(nil)).Elem(), ManagementPolicyVersionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyVersionResponseInput)(nil)).Elem(), ManagementPolicyVersionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ManagementPolicyVersionResponsePtrInput)(nil)).Elem(), ManagementPolicyVersionResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MultichannelInput)(nil)).Elem(), MultichannelArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MultichannelPtrInput)(nil)).Elem(), MultichannelArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MultichannelResponseInput)(nil)).Elem(), MultichannelResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MultichannelResponsePtrInput)(nil)).Elem(), MultichannelResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ObjectReplicationPolicyFilterInput)(nil)).Elem(), ObjectReplicationPolicyFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ObjectReplicationPolicyFilterPtrInput)(nil)).Elem(), ObjectReplicationPolicyFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ObjectReplicationPolicyFilterResponseInput)(nil)).Elem(), ObjectReplicationPolicyFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ObjectReplicationPolicyFilterResponsePtrInput)(nil)).Elem(), ObjectReplicationPolicyFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ObjectReplicationPolicyRuleInput)(nil)).Elem(), ObjectReplicationPolicyRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ObjectReplicationPolicyRuleArrayInput)(nil)).Elem(), ObjectReplicationPolicyRuleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ObjectReplicationPolicyRuleResponseInput)(nil)).Elem(), ObjectReplicationPolicyRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ObjectReplicationPolicyRuleResponseArrayInput)(nil)).Elem(), ObjectReplicationPolicyRuleResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ProtocolSettingsInput)(nil)).Elem(), ProtocolSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProtocolSettingsPtrInput)(nil)).Elem(), ProtocolSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProtocolSettingsResponseInput)(nil)).Elem(), ProtocolSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProtocolSettingsResponsePtrInput)(nil)).Elem(), ProtocolSettingsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceAccessRuleInput)(nil)).Elem(), ResourceAccessRuleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceAccessRuleArrayInput)(nil)).Elem(), ResourceAccessRuleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceAccessRuleResponseInput)(nil)).Elem(), ResourceAccessRuleResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ResourceAccessRuleResponseArrayInput)(nil)).Elem(), ResourceAccessRuleResponseArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestorePolicyPropertiesInput)(nil)).Elem(), RestorePolicyPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestorePolicyPropertiesPtrInput)(nil)).Elem(), RestorePolicyPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestorePolicyPropertiesResponseInput)(nil)).Elem(), RestorePolicyPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RestorePolicyPropertiesResponsePtrInput)(nil)).Elem(), RestorePolicyPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RoutingPreferenceInput)(nil)).Elem(), RoutingPreferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RoutingPreferencePtrInput)(nil)).Elem(), RoutingPreferenceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RoutingPreferenceResponseInput)(nil)).Elem(), RoutingPreferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RoutingPreferenceResponsePtrInput)(nil)).Elem(), RoutingPreferenceResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SasPolicyInput)(nil)).Elem(), SasPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SasPolicyPtrInput)(nil)).Elem(), SasPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SasPolicyResponseInput)(nil)).Elem(), SasPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SasPolicyResponsePtrInput)(nil)).Elem(), SasPolicyResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SignedIdentifierInput)(nil)).Elem(), SignedIdentifierArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SignedIdentifierArrayInput)(nil)).Elem(), SignedIdentifierArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SignedIdentifierResponseInput)(nil)).Elem(), SignedIdentifierResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SignedIdentifierResponseArrayInput)(nil)).Elem(), SignedIdentifierResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SmbSettingInput)(nil)).Elem(), SmbSettingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SmbSettingPtrInput)(nil)).Elem(), SmbSettingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SmbSettingResponseInput)(nil)).Elem(), SmbSettingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SmbSettingResponsePtrInput)(nil)).Elem(), SmbSettingResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountInternetEndpointsResponseInput)(nil)).Elem(), StorageAccountInternetEndpointsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountInternetEndpointsResponsePtrInput)(nil)).Elem(), StorageAccountInternetEndpointsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountMicrosoftEndpointsResponseInput)(nil)).Elem(), StorageAccountMicrosoftEndpointsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StorageAccountMicrosoftEndpointsResponsePtrInput)(nil)).Elem(), StorageAccountMicrosoftEndpointsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TagFilterInput)(nil)).Elem(), TagFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TagFilterArrayInput)(nil)).Elem(), TagFilterArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TagFilterResponseInput)(nil)).Elem(), TagFilterResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TagFilterResponseArrayInput)(nil)).Elem(), TagFilterResponseArray{})
