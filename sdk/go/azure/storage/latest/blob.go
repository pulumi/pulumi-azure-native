...
func NewBlob(ctx *pulumi.Context,
	...
	var resource Blob
	err := ctx.RegisterResource("azure-nextgen:storage/latest:Blob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlob(ctx *pulumi.Context,
	...
	var resource Blob
	err := ctx.ReadResource("azure-nextgen:storage/latest:Blob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
