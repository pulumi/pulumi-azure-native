...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AccountImmutabilityPolicyStateInput)(nil)).Elem(), AccountImmutabilityPolicyState("Unlocked"))
	pulumi.RegisterInputType(reflect.TypeOf((*AccountImmutabilityPolicyStatePtrInput)(nil)).Elem(), AccountImmutabilityPolicyState("Unlocked"))
