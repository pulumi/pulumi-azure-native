...
// AccountImmutabilityPolicyStateInput is an input type that accepts AccountImmutabilityPolicyStateArgs and AccountImmutabilityPolicyStateOutput values.
// You can construct a concrete instance of `AccountImmutabilityPolicyStateInput` via:
//
