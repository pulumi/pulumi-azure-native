...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AccountImmutabilityPolicyPropertiesInput)(nil)).Elem(), AccountImmutabilityPolicyPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountImmutabilityPolicyPropertiesPtrInput)(nil)).Elem(), AccountImmutabilityPolicyPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountImmutabilityPolicyPropertiesResponseInput)(nil)).Elem(), AccountImmutabilityPolicyPropertiesResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AccountImmutabilityPolicyPropertiesResponsePtrInput)(nil)).Elem(), AccountImmutabilityPolicyPropertiesResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ImmutableStorageAccountInput)(nil)).Elem(), ImmutableStorageAccountArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImmutableStorageAccountPtrInput)(nil)).Elem(), ImmutableStorageAccountArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImmutableStorageAccountResponseInput)(nil)).Elem(), ImmutableStorageAccountResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ImmutableStorageAccountResponsePtrInput)(nil)).Elem(), ImmutableStorageAccountResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ProtectedAppendWritesHistoryResponseInput)(nil)).Elem(), ProtectedAppendWritesHistoryResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ProtectedAppendWritesHistoryResponsePtrInput)(nil)).Elem(), ProtectedAppendWritesHistoryResponseArgs{})
