...
namespace Pulumi.AzureNative.ApiCenter.V20240315Preview
{
    public static class GetMetadataSchema
    {
        ...
        public static Task<GetMetadataSchemaResult> InvokeAsync(GetMetadataSchemaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMetadataSchemaResult>("azure-native:apicenter/v20240315preview:getMetadataSchema", args ?? new GetMetadataSchemaArgs(), options.WithDefaults());
