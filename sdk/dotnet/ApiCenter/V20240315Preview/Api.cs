...
namespace Pulumi.AzureNative.ApiCenter.V20240315Preview
{
    ...
    /// API entity.
    /// </summary>
    [AzureNativeResourceType("azure-native:apicenter/v20240315preview:Api")]
    public partial class Api : global::Pulumi.CustomResource
    {
        ...
        public Api(string name, ApiArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240315preview:Api", name, args ?? new ApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Api(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240315preview:Api", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:apicenter:Api" },
    ...
    public sealed class ApiArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiCenter.V20240315Preview.ApiKind> Kind { get; set; } = null!;
