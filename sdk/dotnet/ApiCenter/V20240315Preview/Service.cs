...
namespace Pulumi.AzureNative.ApiCenter.V20240315Preview
{
    ...
    /// The service entity.
    /// </summary>
    [AzureNativeResourceType("azure-native:apicenter/v20240315preview:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240315preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240315preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
