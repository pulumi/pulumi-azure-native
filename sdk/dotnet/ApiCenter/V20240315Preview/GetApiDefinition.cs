...
namespace Pulumi.AzureNative.ApiCenter.V20240315Preview
{
    public static class GetApiDefinition
    {
        ...
        public static Task<GetApiDefinitionResult> InvokeAsync(GetApiDefinitionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiDefinitionResult>("azure-native:apicenter/v20240315preview:getApiDefinition", args ?? new GetApiDefinitionArgs(), options.WithDefaults());

        /// <summary>
        /// Returns details of the API definition.
        /// </summary>
        public static Output<GetApiDefinitionResult> Invoke(GetApiDefinitionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiDefinitionResult>("azure-native:apicenter/v20240315preview:getApiDefinition", args ?? new GetApiDefinitionInvokeArgs(), options.WithDefaults());
