...
namespace Pulumi.AzureNative.ApiCenter
{
    ...
    public partial class Deployment : global::Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apicenter:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apicenter:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_apicenter_v20240301:apicenter:Deployment" },
                    new global::Pulumi.Alias { Type = "azure-native_apicenter_v20240315preview:apicenter:Deployment" },
                    new global::Pulumi.Alias { Type = "azure-native_apicenter_v20240601preview:apicenter:Deployment" },
                },
            };
    ...
    public sealed class DeploymentArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.ApiCenter.DeploymentState>? State { get; set; }
