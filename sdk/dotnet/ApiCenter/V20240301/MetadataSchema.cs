...
namespace Pulumi.AzureNative.ApiCenter.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apicenter/v20240301:MetadataSchema")]
    public partial class MetadataSchema : global::Pulumi.CustomResource
    {
        ...
        public MetadataSchema(string name, MetadataSchemaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240301:MetadataSchema", name, args ?? new MetadataSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetadataSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240301:MetadataSchema", name, null, MakeResourceOptions(options, id))
        {
        }
