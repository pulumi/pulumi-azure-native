...
namespace Pulumi.AzureNative.ApiCenter.V20240301
{
    ...
    /// API entity.
    /// </summary>
    [AzureNativeResourceType("azure-native:apicenter/v20240301:Api")]
    public partial class Api : global::Pulumi.CustomResource
    {
        ...
        public Api(string name, ApiArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240301:Api", name, args ?? new ApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Api(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240301:Api", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiCenter.V20240301.ApiKind> Kind { get; set; } = null!;
