...
namespace Pulumi.AzureNative.ApiCenter.V20240301
{
    public static class GetApiVersion
    {
        ...
        public static Task<GetApiVersionResult> InvokeAsync(GetApiVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiVersionResult>("azure-native:apicenter/v20240301:getApiVersion", args ?? new GetApiVersionArgs(), options.WithDefaults());
