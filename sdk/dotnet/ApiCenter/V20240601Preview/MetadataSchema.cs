...
namespace Pulumi.AzureNative.ApiCenter.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apicenter/v20240601preview:MetadataSchema")]
    public partial class MetadataSchema : global::Pulumi.CustomResource
    {
        ...
        public MetadataSchema(string name, MetadataSchemaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240601preview:MetadataSchema", name, args ?? new MetadataSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetadataSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240601preview:MetadataSchema", name, null, MakeResourceOptions(options, id))
        {
        }
