...
namespace Pulumi.AzureNative.ApiCenter.V20240601Preview
{
    ...
    /// API entity.
    /// </summary>
    [AzureNativeResourceType("azure-native:apicenter/v20240601preview:Api")]
    public partial class Api : global::Pulumi.CustomResource
    {
        ...
        public Api(string name, ApiArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240601preview:Api", name, args ?? new ApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Api(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240601preview:Api", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiCenter.V20240601Preview.ApiKind> Kind { get; set; } = null!;
