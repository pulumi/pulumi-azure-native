...
namespace Pulumi.AzureNative.ApiCenter.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apicenter/v20240601preview:Deployment")]
    public partial class Deployment : global::Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240601preview:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240601preview:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeploymentArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.ApiCenter.V20240601Preview.DeploymentState>? State { get; set; }
