...
namespace Pulumi.AzureNative.ApiCenter.V20240601Preview
{
    ...
    /// Environment entity.
    /// </summary>
    [AzureNativeResourceType("azure-native:apicenter/v20240601preview:Environment")]
    public partial class Environment : global::Pulumi.CustomResource
    {
        ...
        public Environment(string name, EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240601preview:Environment", name, args ?? new EnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apicenter/v20240601preview:Environment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EnvironmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiCenter.V20240601Preview.EnvironmentKind> Kind { get; set; } = null!;
