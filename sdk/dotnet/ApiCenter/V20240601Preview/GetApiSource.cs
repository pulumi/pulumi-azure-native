...
namespace Pulumi.AzureNative.ApiCenter.V20240601Preview
{
    public static class GetApiSource
    {
        ...
        public static Task<GetApiSourceResult> InvokeAsync(GetApiSourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiSourceResult>("azure-native:apicenter/v20240601preview:getApiSource", args ?? new GetApiSourceArgs(), options.WithDefaults());
