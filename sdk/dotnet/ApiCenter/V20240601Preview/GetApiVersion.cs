...
namespace Pulumi.AzureNative.ApiCenter.V20240601Preview
{
    public static class GetApiVersion
    {
        ...
        public static Task<GetApiVersionResult> InvokeAsync(GetApiVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiVersionResult>("azure-native:apicenter/v20240601preview:getApiVersion", args ?? new GetApiVersionArgs(), options.WithDefaults());

        /// <summary>
        /// Returns details of the API version.
        /// </summary>
        public static Output<GetApiVersionResult> Invoke(GetApiVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiVersionResult>("azure-native:apicenter/v20240601preview:getApiVersion", args ?? new GetApiVersionInvokeArgs(), options.WithDefaults());
