...
namespace Pulumi.AzureNative.ProviderHub.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:providerhub:SkusNestedResourceTypeThird'.")]
    [AzureNativeResourceType("azure-native:providerhub/latest:SkusNestedResourceTypeThird")]
    public partial class SkusNestedResourceTypeThird : Pulumi.CustomResource
    {
        ...
        public SkusNestedResourceTypeThird(string name, SkusNestedResourceTypeThirdArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/latest:SkusNestedResourceTypeThird", name, args ?? new SkusNestedResourceTypeThirdArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SkusNestedResourceTypeThird(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/latest:SkusNestedResourceTypeThird", name, null, MakeResourceOptions(options, id))
        {
        }
