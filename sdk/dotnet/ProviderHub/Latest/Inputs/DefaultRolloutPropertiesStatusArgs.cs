...
namespace Pulumi.AzureNative.ProviderHub.Latest.Inputs
{
    ...
    public sealed class DefaultRolloutPropertiesStatusArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ProviderHub.Latest.TrafficRegionCategory>? NextTrafficRegion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ProviderHub.Latest.SubscriptionReregistrationResult>? SubscriptionReregistrationResult { get; set; }
