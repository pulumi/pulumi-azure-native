...
namespace Pulumi.AzureNextGen.ProviderHub.Latest.Outputs
{
    ...
    [OutputType]
    public sealed class ResourceTypeRegistrationPropertiesInvokeResponseCheckNameAvailabilitySpecificationsResult
    {
        public readonly bool? EnableDefaultValidation;
        public readonly ImmutableArray<string> ResourceTypesWithCustomValidation;

        [OutputConstructor]
        private ResourceTypeRegistrationPropertiesInvokeResponseCheckNameAvailabilitySpecificationsResult(
