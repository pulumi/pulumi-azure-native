...
namespace Pulumi.AzureNative.ProviderHub.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:providerhub:ProviderRegistration'.")]
    [AzureNativeResourceType("azure-native:providerhub/latest:ProviderRegistration")]
    public partial class ProviderRegistration : Pulumi.CustomResource
    {
        ...
        public ProviderRegistration(string name, ProviderRegistrationArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/latest:ProviderRegistration", name, args ?? new ProviderRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProviderRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/latest:ProviderRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
