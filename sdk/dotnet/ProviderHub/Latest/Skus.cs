...
namespace Pulumi.AzureNative.ProviderHub.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:providerhub:Skus'.")]
    [AzureNativeResourceType("azure-native:providerhub/latest:Skus")]
    public partial class Skus : Pulumi.CustomResource
    {
        ...
        public Skus(string name, SkusArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/latest:Skus", name, args ?? new SkusArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Skus(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/latest:Skus", name, null, MakeResourceOptions(options, id))
        {
        }
