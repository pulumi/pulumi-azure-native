...
namespace Pulumi.AzureNative.ProviderHub.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:providerhub:NotificationRegistration'.")]
    [AzureNativeResourceType("azure-native:providerhub/latest:NotificationRegistration")]
    public partial class NotificationRegistration : Pulumi.CustomResource
    {
        ...
        public NotificationRegistration(string name, NotificationRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/latest:NotificationRegistration", name, args ?? new NotificationRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/latest:NotificationRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
