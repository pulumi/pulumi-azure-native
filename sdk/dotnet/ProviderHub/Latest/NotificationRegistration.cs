...
namespace Pulumi.AzureNextGen.ProviderHub.Latest
{
    ...
    public partial class NotificationRegistration : Pulumi.CustomResource
    {
        ...
        public NotificationRegistration(string name, NotificationRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:providerhub/latest:NotificationRegistration", name, args ?? new NotificationRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:providerhub/latest:NotificationRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
