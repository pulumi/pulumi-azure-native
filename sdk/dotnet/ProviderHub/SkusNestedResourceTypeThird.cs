...
namespace Pulumi.AzureNative.ProviderHub
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:providerhub:SkusNestedResourceTypeThird")]
    public partial class SkusNestedResourceTypeThird : global::Pulumi.CustomResource
    {
        ...
        public SkusNestedResourceTypeThird(string name, SkusNestedResourceTypeThirdArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub:SkusNestedResourceTypeThird", name, args ?? new SkusNestedResourceTypeThirdArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SkusNestedResourceTypeThird(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub:SkusNestedResourceTypeThird", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_providerhub_v20201120:providerhub:SkusNestedResourceTypeThird" },
                    new global::Pulumi.Alias { Type = "azure-native_providerhub_v20210501preview:providerhub:SkusNestedResourceTypeThird" },
                    new global::Pulumi.Alias { Type = "azure-native_providerhub_v20210601preview:providerhub:SkusNestedResourceTypeThird" },
                    new global::Pulumi.Alias { Type = "azure-native_providerhub_v20210901preview:providerhub:SkusNestedResourceTypeThird" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SkusNestedResourceTypeThird Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
