...
namespace Pulumi.AzureNextGen.ProviderHub
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:providerhub:ProviderRegistration")]
    public partial class ProviderRegistration : Pulumi.CustomResource
    {
        ...
        private ProviderRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:providerhub:ProviderRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
