...
namespace Pulumi.AzureNative.ProviderHub.V20201120
{
    ...
    /// {
    ///     var skusNestedResourceTypeFirst = new AzureNative.ProviderHub.V20201120.SkusNestedResourceTypeFirst("skusNestedResourceTypeFirst", new()
    ///     {
    ///         NestedResourceTypeFirst = "nestedResourceTypeFirst",
    ///         Properties = new AzureNative.ProviderHub.V20201120.Inputs.SkuResourcePropertiesArgs
    ///         {
    ///             SkuSettings = new[]
    ///             {
    ///                 new AzureNative.ProviderHub.V20201120.Inputs.SkuSettingArgs
    ///                 {
    ///                     Kind = "Standard",
    ///                     Name = "freeSku",
    ///                     Tier = "Tier1",
    ...
    ///                     Costs = new[]
    ///                     {
    ///                         new AzureNative.ProviderHub.V20201120.Inputs.SkuCostArgs
    ///                         {
    ///                             MeterId = "xxx",
    ///                         },
    ///                     },
    ...
    public partial class SkusNestedResourceTypeFirst : global::Pulumi.CustomResource
    {
        ...
        public SkusNestedResourceTypeFirst(string name, SkusNestedResourceTypeFirstArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20201120:SkusNestedResourceTypeFirst", name, args ?? new SkusNestedResourceTypeFirstArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SkusNestedResourceTypeFirst(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20201120:SkusNestedResourceTypeFirst", name, null, MakeResourceOptions(options, id))
        {
        }
