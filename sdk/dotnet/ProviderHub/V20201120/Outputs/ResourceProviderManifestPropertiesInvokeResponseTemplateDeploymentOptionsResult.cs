...
namespace Pulumi.AzureNextGen.ProviderHub.V20201120.Outputs
{
    ...
    [OutputType]
    public sealed class ResourceProviderManifestPropertiesInvokeResponseTemplateDeploymentOptionsResult
    {
        public readonly ImmutableArray<string> PreflightOptions;
        public readonly bool? PreflightSupported;

        [OutputConstructor]
        private ResourceProviderManifestPropertiesInvokeResponseTemplateDeploymentOptionsResult(
