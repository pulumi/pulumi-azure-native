...
namespace Pulumi.AzureNextGen.ProviderHub.V20201120.Outputs
{
    ...
    [OutputType]
    public sealed class ResourceTypeRegistrationPropertiesInvokeResponseTemplateDeploymentOptionsResult
    {
        public readonly ImmutableArray<string> PreflightOptions;
        public readonly bool? PreflightSupported;

        [OutputConstructor]
        private ResourceTypeRegistrationPropertiesInvokeResponseTemplateDeploymentOptionsResult(
