...
namespace Pulumi.AzureNative.ProviderHub.V20201120
{
    ...
    public static class GetNotificationRegistration
    {
        ...
        public static Task<GetNotificationRegistrationResult> InvokeAsync(GetNotificationRegistrationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNotificationRegistrationResult>("azure-native:providerhub/v20201120:getNotificationRegistration", args ?? new GetNotificationRegistrationArgs(), options.WithDefaults());
        ...
        public static Output<GetNotificationRegistrationResult> Invoke(GetNotificationRegistrationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNotificationRegistrationResult>("azure-native:providerhub/v20201120:getNotificationRegistration", args ?? new GetNotificationRegistrationInvokeArgs(), options.WithDefaults());
    }
