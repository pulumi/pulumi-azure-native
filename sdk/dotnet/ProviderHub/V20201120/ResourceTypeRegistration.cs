...
namespace Pulumi.AzureNative.ProviderHub.V20201120
{
    ...
    /// {
    ///     var resourceTypeRegistration = new AzureNative.ProviderHub.V20201120.ResourceTypeRegistration("resourceTypeRegistration", new()
    ///     {
    ///         Properties = new AzureNative.ProviderHub.V20201120.Inputs.ResourceTypeRegistrationPropertiesArgs
    ///         {
    ///             Endpoints = new[]
    ///             {
    ///                 new AzureNative.ProviderHub.V20201120.Inputs.ResourceTypeEndpointArgs
    ///                 {
    ///                     ApiVersions = new[]
    ///                     {
    ///                         "2020-06-01-preview",
    ...
    ///             {
    ///                 new AzureNative.ProviderHub.V20201120.Inputs.SwaggerSpecificationArgs
    ///                 {
    ///                     ApiVersions = new[]
    ///                     {
    ///                         "2020-06-01-preview",
    ...
    public partial class ResourceTypeRegistration : global::Pulumi.CustomResource
    {
        ...
        public ResourceTypeRegistration(string name, ResourceTypeRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20201120:ResourceTypeRegistration", name, args ?? new ResourceTypeRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceTypeRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20201120:ResourceTypeRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
