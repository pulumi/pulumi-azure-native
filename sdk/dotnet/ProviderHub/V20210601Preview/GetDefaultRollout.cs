...
namespace Pulumi.AzureNative.ProviderHub.V20210601Preview
{
    public static class GetDefaultRollout
    {
        ...
        public static Task<GetDefaultRolloutResult> InvokeAsync(GetDefaultRolloutArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDefaultRolloutResult>("azure-native:providerhub/v20210601preview:getDefaultRollout", args ?? new GetDefaultRolloutArgs(), options.WithVersion());

        /// <summary>
        /// Default rollout definition.
        /// </summary>
        public static Output<GetDefaultRolloutResult> Invoke(GetDefaultRolloutInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDefaultRolloutResult>("azure-native:providerhub/v20210601preview:getDefaultRollout", args ?? new GetDefaultRolloutInvokeArgs(), options.WithVersion());
    }
