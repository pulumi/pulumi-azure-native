...
namespace Pulumi.AzureNative.ProviderHub.V20210601Preview.Inputs
{
    ...
    public sealed class DefaultRolloutPropertiesStatusArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ProviderHub.V20210601Preview.TrafficRegionCategory>? NextTrafficRegion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ProviderHub.V20210601Preview.SubscriptionReregistrationResult>? SubscriptionReregistrationResult { get; set; }
