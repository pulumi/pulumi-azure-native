...
namespace Pulumi.AzureNative.ProviderHub.V20210601Preview.Inputs
{
    ...
    public sealed class NotificationRegistrationPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("messageScope")]
        public InputUnion<string, Pulumi.AzureNative.ProviderHub.V20210601Preview.MessageScope>? MessageScope { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ProviderHub.V20210601Preview.NotificationMode>? NotificationMode { get; set; }
