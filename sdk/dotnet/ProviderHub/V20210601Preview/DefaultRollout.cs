...
namespace Pulumi.AzureNative.ProviderHub.V20210601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:providerhub/v20210601preview:DefaultRollout is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:DefaultRollout to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:providerhub/v20210601preview:DefaultRollout")]
    public partial class DefaultRollout : global::Pulumi.CustomResource
    {
        ...
        public DefaultRollout(string name, DefaultRolloutArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:DefaultRollout", name, args ?? new DefaultRolloutArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DefaultRollout(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:DefaultRollout", name, null, MakeResourceOptions(options, id))
        {
        }
