...
{
    [Obsolete(@"azure-native:providerhub/v20210601preview:ProviderRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:ProviderRegistration to guarantee forwards compatibility.")]
    ...
    public partial class ProviderRegistration : global::Pulumi.CustomResource
    {
        ...
        public ProviderRegistration(string name, ProviderRegistrationArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:ProviderRegistration", name, args ?? new ProviderRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProviderRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:ProviderRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
