...
{
    [Obsolete(@"azure-native:providerhub/v20210601preview:ResourceTypeRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:ResourceTypeRegistration to guarantee forwards compatibility.")]
    ...
    public partial class ResourceTypeRegistration : global::Pulumi.CustomResource
    {
        ...
        public ResourceTypeRegistration(string name, ResourceTypeRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:ResourceTypeRegistration", name, args ?? new ResourceTypeRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceTypeRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:ResourceTypeRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
