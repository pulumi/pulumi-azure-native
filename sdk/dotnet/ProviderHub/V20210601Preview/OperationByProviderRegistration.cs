...
{
    [Obsolete(@"azure-native:providerhub/v20210601preview:OperationByProviderRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:OperationByProviderRegistration to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:providerhub/v20210601preview:OperationByProviderRegistration")]
    public partial class OperationByProviderRegistration : global::Pulumi.CustomResource
    {
        ...
        public OperationByProviderRegistration(string name, OperationByProviderRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:OperationByProviderRegistration", name, args ?? new OperationByProviderRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OperationByProviderRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:OperationByProviderRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
