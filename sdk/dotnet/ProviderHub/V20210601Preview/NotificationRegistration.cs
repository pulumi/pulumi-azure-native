...
namespace Pulumi.AzureNative.ProviderHub.V20210601Preview
{
    ...
    [AzureNativeResourceType("azure-native:providerhub/v20210601preview:NotificationRegistration")]
    public partial class NotificationRegistration : global::Pulumi.CustomResource
    {
        ...
        public NotificationRegistration(string name, NotificationRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:NotificationRegistration", name, args ?? new NotificationRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:NotificationRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
