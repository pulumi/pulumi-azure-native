...
{
    [AzureNativeResourceType("azure-native:providerhub/v20210601preview:SkusNestedResourceTypeFirst")]
    public partial class SkusNestedResourceTypeFirst : Pulumi.CustomResource
    {
        ...
        public SkusNestedResourceTypeFirst(string name, SkusNestedResourceTypeFirstArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:SkusNestedResourceTypeFirst", name, args ?? new SkusNestedResourceTypeFirstArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SkusNestedResourceTypeFirst(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:SkusNestedResourceTypeFirst", name, null, MakeResourceOptions(options, id))
        {
        }
