...
namespace Pulumi.AzureNative.ProviderHub.V20210601Preview
{
    ...
    public partial class SkusNestedResourceTypeSecond : Pulumi.CustomResource
    {
        ...
        public SkusNestedResourceTypeSecond(string name, SkusNestedResourceTypeSecondArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:SkusNestedResourceTypeSecond", name, args ?? new SkusNestedResourceTypeSecondArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SkusNestedResourceTypeSecond(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210601preview:SkusNestedResourceTypeSecond", name, null, MakeResourceOptions(options, id))
        {
        }
