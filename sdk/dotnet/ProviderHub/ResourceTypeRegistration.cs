...
namespace Pulumi.AzureNextGen.ProviderHub
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:providerhub:ResourceTypeRegistration")]
    public partial class ResourceTypeRegistration : Pulumi.CustomResource
    {
        ...
        public ResourceTypeRegistration(string name, ResourceTypeRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:providerhub:ResourceTypeRegistration", name, args ?? new ResourceTypeRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceTypeRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:providerhub:ResourceTypeRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
