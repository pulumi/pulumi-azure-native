...
namespace Pulumi.AzureNative.ProviderHub
{
    ...
    public partial class SkusNestedResourceTypeFirst : global::Pulumi.CustomResource
    {
        ...
        public SkusNestedResourceTypeFirst(string name, SkusNestedResourceTypeFirstArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub:SkusNestedResourceTypeFirst", name, args ?? new SkusNestedResourceTypeFirstArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SkusNestedResourceTypeFirst(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub:SkusNestedResourceTypeFirst", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_providerhub_v20201120:providerhub:SkusNestedResourceTypeFirst" },
                    new global::Pulumi.Alias { Type = "azure-native_providerhub_v20210501preview:providerhub:SkusNestedResourceTypeFirst" },
                    new global::Pulumi.Alias { Type = "azure-native_providerhub_v20210601preview:providerhub:SkusNestedResourceTypeFirst" },
                    new global::Pulumi.Alias { Type = "azure-native_providerhub_v20210901preview:providerhub:SkusNestedResourceTypeFirst" },
                },
            };
