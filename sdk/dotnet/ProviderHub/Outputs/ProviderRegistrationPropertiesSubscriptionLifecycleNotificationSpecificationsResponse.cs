...
namespace Pulumi.AzureNative.ProviderHub.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ProviderRegistrationPropertiesSubscriptionLifecycleNotificationSpecificationsResponse
    {
        /// <summary>
        /// The soft delete TTL.
        /// </summary>
        ...
        [OutputConstructor]
        private ProviderRegistrationPropertiesSubscriptionLifecycleNotificationSpecificationsResponse(
