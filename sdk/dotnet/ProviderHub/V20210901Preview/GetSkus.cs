...
namespace Pulumi.AzureNative.ProviderHub.V20210901Preview
{
    public static class GetSkus
    {
        public static Task<GetSkusResult> InvokeAsync(GetSkusArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSkusResult>("azure-native:providerhub/v20210901preview:getSkus", args ?? new GetSkusArgs(), options.WithVersion());

        public static Output<GetSkusResult> Invoke(GetSkusInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSkusResult>("azure-native:providerhub/v20210901preview:getSkus", args ?? new GetSkusInvokeArgs(), options.WithVersion());
    }
