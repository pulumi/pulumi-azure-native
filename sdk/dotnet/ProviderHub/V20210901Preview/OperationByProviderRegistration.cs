...
namespace Pulumi.AzureNative.ProviderHub.V20210901Preview
{
    ...
    public partial class OperationByProviderRegistration : global::Pulumi.CustomResource
    {
        ...
        public OperationByProviderRegistration(string name, OperationByProviderRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210901preview:OperationByProviderRegistration", name, args ?? new OperationByProviderRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OperationByProviderRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210901preview:OperationByProviderRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
