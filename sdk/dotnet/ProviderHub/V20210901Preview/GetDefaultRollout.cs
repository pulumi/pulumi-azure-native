...
namespace Pulumi.AzureNative.ProviderHub.V20210901Preview
{
    public static class GetDefaultRollout
    {
        ...
        public static Task<GetDefaultRolloutResult> InvokeAsync(GetDefaultRolloutArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDefaultRolloutResult>("azure-native:providerhub/v20210901preview:getDefaultRollout", args ?? new GetDefaultRolloutArgs(), options.WithDefaults());

        /// <summary>
        /// Default rollout definition.
        /// </summary>
        public static Output<GetDefaultRolloutResult> Invoke(GetDefaultRolloutInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDefaultRolloutResult>("azure-native:providerhub/v20210901preview:getDefaultRollout", args ?? new GetDefaultRolloutInvokeArgs(), options.WithDefaults());
    }
