...
namespace Pulumi.AzureNative.ProviderHub.V20210901Preview.Inputs
{
    ...
    public sealed class DefaultRolloutPropertiesStatusArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ProviderHub.V20210901Preview.TrafficRegionCategory>? NextTrafficRegion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ProviderHub.V20210901Preview.SubscriptionReregistrationResult>? SubscriptionReregistrationResult { get; set; }
