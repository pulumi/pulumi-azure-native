...
{
    [AzureNativeResourceType("azure-native:providerhub/v20210901preview:SkusNestedResourceTypeFirst")]
    public partial class SkusNestedResourceTypeFirst : Pulumi.CustomResource
    {
        ...
        public SkusNestedResourceTypeFirst(string name, SkusNestedResourceTypeFirstArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210901preview:SkusNestedResourceTypeFirst", name, args ?? new SkusNestedResourceTypeFirstArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SkusNestedResourceTypeFirst(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210901preview:SkusNestedResourceTypeFirst", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:providerhub/v20210901preview:SkusNestedResourceTypeFirst"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:providerhub/v20201120:SkusNestedResourceTypeFirst"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:providerhub/v20210501preview:SkusNestedResourceTypeFirst"},
                    new Pulumi.Alias { Type = "azure-native:providerhub/v20210601preview:SkusNestedResourceTypeFirst"},
                    new Pulumi.Alias { Type = "azure-nextgen:providerhub/v20210601preview:SkusNestedResourceTypeFirst"},
                },
            };
