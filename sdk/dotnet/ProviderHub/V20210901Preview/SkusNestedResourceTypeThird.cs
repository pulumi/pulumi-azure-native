...
namespace Pulumi.AzureNative.ProviderHub.V20210901Preview
{
    ...
    public partial class SkusNestedResourceTypeThird : Pulumi.CustomResource
    {
        ...
        public SkusNestedResourceTypeThird(string name, SkusNestedResourceTypeThirdArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210901preview:SkusNestedResourceTypeThird", name, args ?? new SkusNestedResourceTypeThirdArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SkusNestedResourceTypeThird(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210901preview:SkusNestedResourceTypeThird", name, null, MakeResourceOptions(options, id))
        {
        }
