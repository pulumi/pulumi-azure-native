...
namespace Pulumi.AzureNative.ProviderHub.V20210901Preview
{
    ...
    public partial class DefaultRollout : Pulumi.CustomResource
    {
        ...
        public DefaultRollout(string name, DefaultRolloutArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210901preview:DefaultRollout", name, args ?? new DefaultRolloutArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DefaultRollout(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210901preview:DefaultRollout", name, null, MakeResourceOptions(options, id))
        {
        }
