...
namespace Pulumi.AzureNative.ProviderHub.V20210901Preview
{
    ...
    /// {
    ///     var skusNestedResourceTypeSecond = new AzureNative.ProviderHub.V20210901Preview.SkusNestedResourceTypeSecond("skusNestedResourceTypeSecond", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:providerhub/v20210901preview:SkusNestedResourceTypeSecond")]
    public partial class SkusNestedResourceTypeSecond : global::Pulumi.CustomResource
    {
        ...
        public SkusNestedResourceTypeSecond(string name, SkusNestedResourceTypeSecondArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210901preview:SkusNestedResourceTypeSecond", name, args ?? new SkusNestedResourceTypeSecondArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SkusNestedResourceTypeSecond(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210901preview:SkusNestedResourceTypeSecond", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:providerhub:SkusNestedResourceTypeSecond"},
                    new global::Pulumi.Alias { Type = "azure-native:providerhub/v20201120:SkusNestedResourceTypeSecond"},
                    new global::Pulumi.Alias { Type = "azure-native:providerhub/v20210501preview:SkusNestedResourceTypeSecond"},
                    new global::Pulumi.Alias { Type = "azure-native:providerhub/v20210601preview:SkusNestedResourceTypeSecond"},
                },
            };
    ...
    public sealed class SkusNestedResourceTypeSecondArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public static new SkusNestedResourceTypeSecondArgs Empty => new SkusNestedResourceTypeSecondArgs();
    }
}
