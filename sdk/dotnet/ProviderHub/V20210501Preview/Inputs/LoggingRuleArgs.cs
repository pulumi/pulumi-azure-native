...
namespace Pulumi.AzureNative.ProviderHub.V20210501Preview.Inputs
{
    ...
    public sealed class LoggingRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ProviderHub.V20210501Preview.LoggingDetails> DetailLevel { get; set; } = null!;

        [Input("direction", required: true)]
        public InputUnion<string, Pulumi.AzureNative.ProviderHub.V20210501Preview.LoggingDirections> Direction { get; set; } = null!;
