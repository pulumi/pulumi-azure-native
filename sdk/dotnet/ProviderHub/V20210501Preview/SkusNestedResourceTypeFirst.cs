...
{
    [Obsolete(@"azure-native:providerhub/v20210501preview:SkusNestedResourceTypeFirst is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:SkusNestedResourceTypeFirst to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:providerhub/v20210501preview:SkusNestedResourceTypeFirst")]
    public partial class SkusNestedResourceTypeFirst : global::Pulumi.CustomResource
    {
        ...
        public SkusNestedResourceTypeFirst(string name, SkusNestedResourceTypeFirstArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210501preview:SkusNestedResourceTypeFirst", name, args ?? new SkusNestedResourceTypeFirstArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SkusNestedResourceTypeFirst(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210501preview:SkusNestedResourceTypeFirst", name, null, MakeResourceOptions(options, id))
        {
        }
