...
namespace Pulumi.AzureNative.ProviderHub.V20210501Preview
{
    ...
    /// {
    ///     var operationByProviderRegistration = new AzureNative.ProviderHub.V20210501Preview.OperationByProviderRegistration("operationByProviderRegistration", new()
    ///     {
    ///         Contents = new[]
    ///         {
    ///             new AzureNative.ProviderHub.V20210501Preview.Inputs.OperationsDefinitionArgs
    ///             {
    ///                 Display = new AzureNative.ProviderHub.V20210501Preview.Inputs.OperationsDefinitionDisplayArgs
    ///                 {
    ...
    public partial class OperationByProviderRegistration : global::Pulumi.CustomResource
    {
        ...
        public OperationByProviderRegistration(string name, OperationByProviderRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210501preview:OperationByProviderRegistration", name, args ?? new OperationByProviderRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OperationByProviderRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210501preview:OperationByProviderRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
