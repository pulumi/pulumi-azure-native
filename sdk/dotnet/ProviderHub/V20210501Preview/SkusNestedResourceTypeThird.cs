...
{
    [AzureNativeResourceType("azure-native:providerhub/v20210501preview:SkusNestedResourceTypeThird")]
    public partial class SkusNestedResourceTypeThird : Pulumi.CustomResource
    {
        ...
        public SkusNestedResourceTypeThird(string name, SkusNestedResourceTypeThirdArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210501preview:SkusNestedResourceTypeThird", name, args ?? new SkusNestedResourceTypeThirdArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SkusNestedResourceTypeThird(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210501preview:SkusNestedResourceTypeThird", name, null, MakeResourceOptions(options, id))
        {
        }
