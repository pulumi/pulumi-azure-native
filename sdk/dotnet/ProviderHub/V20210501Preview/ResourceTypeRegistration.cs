...
{
    [AzureNativeResourceType("azure-native:providerhub/v20210501preview:ResourceTypeRegistration")]
    public partial class ResourceTypeRegistration : global::Pulumi.CustomResource
    {
        ...
        public ResourceTypeRegistration(string name, ResourceTypeRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210501preview:ResourceTypeRegistration", name, args ?? new ResourceTypeRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceTypeRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210501preview:ResourceTypeRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
