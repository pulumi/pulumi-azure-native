...
{
    [Obsolete(@"azure-native:providerhub/v20210501preview:Skus is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:Skus to guarantee forwards compatibility.")]
    public static class GetSkus
    {
        ...
        public static Task<GetSkusResult> InvokeAsync(GetSkusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSkusResult>("azure-native:providerhub/v20210501preview:getSkus", args ?? new GetSkusArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the sku details for the given resource type and sku name.
        /// </summary>
        public static Output<GetSkusResult> Invoke(GetSkusInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSkusResult>("azure-native:providerhub/v20210501preview:getSkus", args ?? new GetSkusInvokeArgs(), options.WithDefaults());
    }
