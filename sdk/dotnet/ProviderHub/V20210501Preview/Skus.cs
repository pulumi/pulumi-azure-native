...
namespace Pulumi.AzureNative.ProviderHub.V20210501Preview
{
    ...
    public partial class Skus : Pulumi.CustomResource
    {
        ...
        public Skus(string name, SkusArgs args, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210501preview:Skus", name, args ?? new SkusArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Skus(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:providerhub/v20210501preview:Skus", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:providerhub/v20210501preview:Skus"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:providerhub/v20210601preview:Skus"},
                    new Pulumi.Alias { Type = "azure-native:providerhub/v20210901preview:Skus"},
                    new Pulumi.Alias { Type = "azure-nextgen:providerhub/v20210901preview:Skus"},
                },
            };
