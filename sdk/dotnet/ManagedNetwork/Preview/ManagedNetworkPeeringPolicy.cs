...
namespace Pulumi.AzureRM.ManagedNetwork.Preview
{
    ...
    public partial class ManagedNetworkPeeringPolicy : Pulumi.CustomResource
    {
        ...
        public ManagedNetworkPeeringPolicy(string name, ManagedNetworkPeeringPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managednetwork/preview:ManagedNetworkPeeringPolicy", name, args ?? new ManagedNetworkPeeringPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedNetworkPeeringPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managednetwork/preview:ManagedNetworkPeeringPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:managednetwork/v20190601preview:ManagedNetworkPeeringPolicy"},
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ManagedNetworkPeeringPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class ManagedNetworkPeeringPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.ManagedNetworkPeeringPolicyPropertiesArgs>? Properties { get; set; }
