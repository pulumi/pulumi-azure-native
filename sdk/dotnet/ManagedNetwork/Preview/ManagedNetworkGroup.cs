...
namespace Pulumi.AzureRM.ManagedNetwork.Preview
{
    ...
    public partial class ManagedNetworkGroup : Pulumi.CustomResource
    {
        ...
        public ManagedNetworkGroup(string name, ManagedNetworkGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managednetwork/preview:ManagedNetworkGroup", name, args ?? new ManagedNetworkGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedNetworkGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managednetwork/preview:ManagedNetworkGroup", name, null, MakeResourceOptions(options, id))
        {
        }
