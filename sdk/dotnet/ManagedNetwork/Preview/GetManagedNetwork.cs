...
namespace Pulumi.AzureRM.ManagedNetwork.Preview
{
    public static class GetManagedNetwork
    {
        public static Task<GetManagedNetworkResult> InvokeAsync(GetManagedNetworkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedNetworkResult>("azurerm:managednetwork/preview:getManagedNetwork", args ?? new GetManagedNetworkArgs(), options.WithVersion());
    }
