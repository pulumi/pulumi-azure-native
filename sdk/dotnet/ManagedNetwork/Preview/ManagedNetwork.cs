...
namespace Pulumi.AzureRM.ManagedNetwork.Preview
{
    ...
    public partial class ManagedNetwork : Pulumi.CustomResource
    {
        ...
        public ManagedNetwork(string name, ManagedNetworkArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managednetwork/preview:ManagedNetwork", name, args ?? new ManagedNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managednetwork/preview:ManagedNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:managednetwork/v20190601preview:ManagedNetwork"},
                },
            };
