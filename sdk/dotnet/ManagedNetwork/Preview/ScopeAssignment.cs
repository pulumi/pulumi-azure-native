...
namespace Pulumi.AzureRM.ManagedNetwork.Preview
{
    ...
    public partial class ScopeAssignment : Pulumi.CustomResource
    {
        ...
        public ScopeAssignment(string name, ScopeAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managednetwork/preview:ScopeAssignment", name, args ?? new ScopeAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managednetwork/preview:ScopeAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:managednetwork/v20190601preview:ScopeAssignment"},
                },
            };
