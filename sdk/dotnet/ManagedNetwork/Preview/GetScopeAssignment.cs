...
namespace Pulumi.AzureRM.ManagedNetwork.Preview
{
    public static class GetScopeAssignment
    {
        public static Task<GetScopeAssignmentResult> InvokeAsync(GetScopeAssignmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScopeAssignmentResult>("azurerm:managednetwork/preview:getScopeAssignment", args ?? new GetScopeAssignmentArgs(), options.WithVersion());
    }
