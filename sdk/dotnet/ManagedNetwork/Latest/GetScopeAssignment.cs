...
namespace Pulumi.AzureRM.ManagedNetwork.Latest
{
    public static class GetScopeAssignment
    {
        public static Task<GetScopeAssignmentResult> InvokeAsync(GetScopeAssignmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScopeAssignmentResult>("azurerm:managednetwork/latest:getScopeAssignment", args ?? new GetScopeAssignmentArgs(), options.WithVersion());
    }
