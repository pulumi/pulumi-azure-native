...
namespace Pulumi.AzureRM.ManagedNetwork.Latest
{
    public static class GetManagedNetworkGroup
    {
        public static Task<GetManagedNetworkGroupResult> InvokeAsync(GetManagedNetworkGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedNetworkGroupResult>("azurerm:managednetwork/latest:getManagedNetworkGroup", args ?? new GetManagedNetworkGroupArgs(), options.WithVersion());
    }
