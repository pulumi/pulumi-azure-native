...
namespace Pulumi.AzureRM.ManagedNetwork.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedNetworkGroup = new AzureRM.ManagedNetwork.Latest.ManagedNetworkGroup("managedNetworkGroup", new AzureRM.ManagedNetwork.Latest.ManagedNetworkGroupArgs
    ///         {
    ...
    public partial class ManagedNetworkGroup : Pulumi.CustomResource
    {
        ...
        public ManagedNetworkGroup(string name, ManagedNetworkGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managednetwork/latest:ManagedNetworkGroup", name, args ?? new ManagedNetworkGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedNetworkGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managednetwork/latest:ManagedNetworkGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:managednetwork/v20190601preview:ManagedNetworkGroup"},
                },
            };
