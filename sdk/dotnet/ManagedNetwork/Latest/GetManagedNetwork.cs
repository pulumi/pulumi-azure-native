...
namespace Pulumi.AzureRM.ManagedNetwork.Latest
{
    public static class GetManagedNetwork
    {
        public static Task<GetManagedNetworkResult> InvokeAsync(GetManagedNetworkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedNetworkResult>("azurerm:managednetwork/latest:getManagedNetwork", args ?? new GetManagedNetworkArgs(), options.WithVersion());
    }
