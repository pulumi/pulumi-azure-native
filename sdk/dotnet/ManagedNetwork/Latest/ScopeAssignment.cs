...
namespace Pulumi.AzureRM.ManagedNetwork.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var scopeAssignment = new AzureRM.ManagedNetwork.Latest.ScopeAssignment("scopeAssignment", new AzureRM.ManagedNetwork.Latest.ScopeAssignmentArgs
    ///         {
    ...
    public partial class ScopeAssignment : Pulumi.CustomResource
    {
        ...
        public ScopeAssignment(string name, ScopeAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managednetwork/latest:ScopeAssignment", name, args ?? new ScopeAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managednetwork/latest:ScopeAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
