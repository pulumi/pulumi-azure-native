...
namespace Pulumi.AzureRM.StreamAnalytics.Inputs
{
    ...
    /// </summary>
    public sealed class StreamingJobPropertiesResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("functions")]
        private InputList<Inputs.FunctionResponseGetArgs>? _functions;

        /// <summary>
        /// A list of one or more functions for the streaming job. The name property for each function is required when specifying this property in a PUT request. This property cannot be modify via a PATCH operation. You must use the PATCH API available for the individual transformation.
        /// </summary>
        public InputList<Inputs.FunctionResponseGetArgs> Functions
        {
            get => _functions ?? (_functions = new InputList<Inputs.FunctionResponseGetArgs>());
            set => _functions = value;
        }

        [Input("inputs")]
        private InputList<Inputs.InputResponseGetArgs>? _inputs;

        /// <summary>
        /// A list of one or more inputs to the streaming job. The name property for each input is required when specifying this property in a PUT request. This property cannot be modify via a PATCH operation. You must use the PATCH API available for the individual input.
        /// </summary>
        public InputList<Inputs.InputResponseGetArgs> Inputs
        {
            get => _inputs ?? (_inputs = new InputList<Inputs.InputResponseGetArgs>());
            set => _inputs = value;
        }
        ...
        [Input("outputs")]
        private InputList<Inputs.OutputResponseGetArgs>? _outputs;

        /// <summary>
        /// A list of one or more outputs for the streaming job. The name property for each output is required when specifying this property in a PUT request. This property cannot be modify via a PATCH operation. You must use the PATCH API available for the individual output.
        /// </summary>
        public InputList<Inputs.OutputResponseGetArgs> Outputs
        {
            get => _outputs ?? (_outputs = new InputList<Inputs.OutputResponseGetArgs>());
            set => _outputs = value;
        }
        ...
        public Input<Inputs.TransformationResponseGetArgs>? Transformation { get; set; }

        public StreamingJobPropertiesResponseGetArgs()
        {
        }
    }
}
