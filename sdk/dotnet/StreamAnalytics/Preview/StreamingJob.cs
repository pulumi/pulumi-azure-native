...
namespace Pulumi.AzureRM.StreamAnalytics.Preview
{
    ...
    public partial class StreamingJob : Pulumi.CustomResource
    {
        ...
        public StreamingJob(string name, StreamingJobArgs args, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics/preview:StreamingJob", name, args ?? new StreamingJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics/preview:StreamingJob", name, null, MakeResourceOptions(options, id))
        {
        }
