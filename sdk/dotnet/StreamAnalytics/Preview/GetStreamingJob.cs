...
namespace Pulumi.AzureRM.StreamAnalytics.Preview
{
    public static class GetStreamingJob
    {
        public static Task<GetStreamingJobResult> InvokeAsync(GetStreamingJobArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamingJobResult>("azurerm:streamanalytics/preview:getStreamingJob", args ?? new GetStreamingJobArgs(), options.WithVersion());
    }
