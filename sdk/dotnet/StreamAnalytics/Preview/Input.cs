...
namespace Pulumi.AzureRM.StreamAnalytics.Preview
{
    /// <summary>
    ...
    public partial class Input : Pulumi.CustomResource
    {
        ...
        public Input(string name, InputArgs args, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics/preview:Input", name, args ?? new InputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Input(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics/preview:Input", name, null, MakeResourceOptions(options, id))
        {
        }
