...
namespace Pulumi.AzureRM.StreamAnalytics.Preview
{
    ...
    public partial class Function : Pulumi.CustomResource
    {
        ...
        public Function(string name, FunctionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics/preview:Function", name, args ?? new FunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Function(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics/preview:Function", name, null, MakeResourceOptions(options, id))
        {
        }
