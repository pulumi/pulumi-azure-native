...
namespace Pulumi.AzureNextGen.StreamAnalytics.V20170401Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct StreamingJobSkuName : IEquatable<StreamingJobSkuName>
    {
        private readonly string _value;

        private StreamingJobSkuName(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static StreamingJobSkuName Standard { get; } = new StreamingJobSkuName("Standard");

        public static bool operator ==(StreamingJobSkuName left, StreamingJobSkuName right) => left.Equals(right);
        public static bool operator !=(StreamingJobSkuName left, StreamingJobSkuName right) => !left.Equals(right);

        public static explicit operator string(StreamingJobSkuName value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is StreamingJobSkuName other && Equals(other);
        public bool Equals(StreamingJobSkuName other) => string.Equals(_value, other._value, StringComparison.Ordinal);
