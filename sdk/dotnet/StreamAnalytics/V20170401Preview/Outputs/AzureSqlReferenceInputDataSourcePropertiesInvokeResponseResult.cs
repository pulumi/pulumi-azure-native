...
namespace Pulumi.AzureNextGen.StreamAnalytics.V20170401Preview.Outputs
{
    ...
    [OutputType]
    public sealed class AzureSqlReferenceInputDataSourcePropertiesInvokeResponseResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AzureSqlReferenceInputDataSourcePropertiesInvokeResponseResult(
            string? database,
