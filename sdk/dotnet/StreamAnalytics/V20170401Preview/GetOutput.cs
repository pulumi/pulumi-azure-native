...
namespace Pulumi.AzureNative.StreamAnalytics.V20170401Preview
{
    ...
    public static class GetOutput
    {
        ...
        public static Task<GetOutputResult> InvokeAsync(GetOutputArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOutputResult>("azure-native:streamanalytics/v20170401preview:getOutput", args ?? new GetOutputArgs(), options.WithDefaults());

        /// <summary>
        /// An output object, containing all information associated with the named output. All outputs are contained under a streaming job.
        /// </summary>
        public static Output<GetOutputResult> Invoke(GetOutputInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOutputResult>("azure-native:streamanalytics/v20170401preview:getOutput", args ?? new GetOutputInvokeArgs(), options.WithDefaults());
    }
