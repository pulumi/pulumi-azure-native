...
namespace Pulumi.AzureNative.StreamAnalytics.V20170401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:streamanalytics/v20170401preview:Output")]
    public partial class Output : Pulumi.CustomResource
    {
        ...
        public Output(string name, OutputArgs args, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20170401preview:Output", name, args ?? new OutputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Output(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20170401preview:Output", name, null, MakeResourceOptions(options, id))
        {
        }
