...
namespace Pulumi.AzureNative.StreamAnalytics.V20170401Preview
{
    public static class GetStreamingJob
    {
        ...
        public static Task<GetStreamingJobResult> InvokeAsync(GetStreamingJobArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamingJobResult>("azure-native:streamanalytics/v20170401preview:getStreamingJob", args ?? new GetStreamingJobArgs(), options.WithDefaults());

        /// <summary>
        /// A streaming job object, containing all information associated with the named streaming job.
        /// </summary>
        public static Output<GetStreamingJobResult> Invoke(GetStreamingJobInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStreamingJobResult>("azure-native:streamanalytics/v20170401preview:getStreamingJob", args ?? new GetStreamingJobInvokeArgs(), options.WithDefaults());
    }
