...
namespace Pulumi.AzureRM.StreamAnalytics.V20170401Preview
{
    ...
    public partial class Input : Pulumi.CustomResource
    {
        ...
        public Input(string name, InputArgs args, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics/v20170401preview:Input", name, args ?? new InputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Input(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics/v20170401preview:Input", name, null, MakeResourceOptions(options, id))
        {
        }
