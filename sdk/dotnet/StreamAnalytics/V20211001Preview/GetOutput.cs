...
namespace Pulumi.AzureNative.StreamAnalytics.V20211001Preview
{
    public static class GetOutput
    {
        ...
        public static Task<GetOutputResult> InvokeAsync(GetOutputArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOutputResult>("azure-native:streamanalytics/v20211001preview:getOutput", args ?? new GetOutputArgs(), options.WithVersion());

        /// <summary>
        /// An output object, containing all information associated with the named output. All outputs are contained under a streaming job.
        /// </summary>
        public static Output<GetOutputResult> Invoke(GetOutputInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOutputResult>("azure-native:streamanalytics/v20211001preview:getOutput", args ?? new GetOutputInvokeArgs(), options.WithVersion());
    }
