...
namespace Pulumi.AzureNative.StreamAnalytics.V20211001Preview
{
    ...
    public partial class StreamingJob : Pulumi.CustomResource
    {
        ...
        public StreamingJob(string name, StreamingJobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20211001preview:StreamingJob", name, args ?? new StreamingJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20211001preview:StreamingJob", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:streamanalytics/v20211001preview:StreamingJob"},
    ...
    public sealed class StreamingJobArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StreamAnalytics.V20211001Preview.CompatibilityLevel>? CompatibilityLevel { get; set; }

        /// <summary>
        /// Valid values are JobStorageAccount and SystemAccount. If set to JobStorageAccount, this requires the user to also specify jobStorageAccount property. .
        /// </summary>
        [Input("contentStoragePolicy")]
        public InputUnion<string, Pulumi.AzureNative.StreamAnalytics.V20211001Preview.ContentStoragePolicy>? ContentStoragePolicy { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.StreamAnalytics.V20211001Preview.EventsOutOfOrderPolicy>? EventsOutOfOrderPolicy { get; set; }
        ...
        /// </summary>
        [Input("jobType")]
        public InputUnion<string, Pulumi.AzureNative.StreamAnalytics.V20211001Preview.JobType>? JobType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.StreamAnalytics.V20211001Preview.OutputErrorPolicy>? OutputErrorPolicy { get; set; }

        /// <summary>
        /// This property should only be utilized when it is desired that the job be started immediately upon creation. Value may be JobStartTime, CustomTime, or LastOutputEventTime to indicate whether the starting point of the output event stream should start whenever the job is started, start at a custom user time stamp specified via the outputStartTime property, or start from the last event output time.
        /// </summary>
        [Input("outputStartMode")]
        public InputUnion<string, Pulumi.AzureNative.StreamAnalytics.V20211001Preview.OutputStartMode>? OutputStartMode { get; set; }
