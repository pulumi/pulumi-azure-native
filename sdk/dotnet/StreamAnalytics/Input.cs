...
namespace Pulumi.AzureRM.StreamAnalytics
{
    ...
    public partial class Input : Pulumi.CustomResource
    {
        ...
        public Input(string name, InputArgs args, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics:Input", name, args ?? new InputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Input(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics:Input", name, null, MakeResourceOptions(options, id))
        {
        }
