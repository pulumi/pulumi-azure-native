...
namespace Pulumi.AzureRM.StreamAnalytics
{
    ...
    public partial class Output : Pulumi.CustomResource
    {
        ...
        public Output(string name, OutputArgs args, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics:Output", name, args ?? new OutputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Output(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics:Output", name, null, MakeResourceOptions(options, id))
        {
        }
