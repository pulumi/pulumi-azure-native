...
namespace Pulumi.AzureRM.StreamAnalytics.V20160301
{
    public static class GetStreamingJob
    {
        public static Task<GetStreamingJobResult> InvokeAsync(GetStreamingJobArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamingJobResult>("azurerm:streamanalytics/v20160301:getStreamingJob", args ?? new GetStreamingJobArgs(), options.WithVersion());
    }
