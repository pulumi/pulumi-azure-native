...
namespace Pulumi.AzureNextGen.StreamAnalytics.V20160301
{
    ...
    public partial class Function : Pulumi.CustomResource
    {
        ...
        public Function(string name, FunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:streamanalytics/v20160301:Function", name, args ?? new FunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Function(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:streamanalytics/v20160301:Function", name, null, MakeResourceOptions(options, id))
        {
        }
