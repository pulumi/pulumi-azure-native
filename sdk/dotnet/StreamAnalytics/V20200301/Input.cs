...
namespace Pulumi.AzureNative.StreamAnalytics.V20200301
{
    ...
    public partial class Input : global::Pulumi.CustomResource
    {
        ...
        public Input(string name, InputArgs args, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20200301:Input", name, args ?? new InputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Input(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20200301:Input", name, null, MakeResourceOptions(options, id))
        {
        }
