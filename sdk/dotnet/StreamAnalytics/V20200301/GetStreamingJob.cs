...
namespace Pulumi.AzureNative.StreamAnalytics.V20200301
{
    public static class GetStreamingJob
    {
        ...
        public static Task<GetStreamingJobResult> InvokeAsync(GetStreamingJobArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamingJobResult>("azure-native:streamanalytics/v20200301:getStreamingJob", args ?? new GetStreamingJobArgs(), options.WithDefaults());

        /// <summary>
        /// A streaming job object, containing all information associated with the named streaming job.
        /// </summary>
        public static Output<GetStreamingJobResult> Invoke(GetStreamingJobInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStreamingJobResult>("azure-native:streamanalytics/v20200301:getStreamingJob", args ?? new GetStreamingJobInvokeArgs(), options.WithDefaults());
    }
