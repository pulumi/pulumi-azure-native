...
namespace Pulumi.AzureNative.StreamAnalytics.V20200301
{
    ...
    /// {
    ///     var cluster = new AzureNative.StreamAnalytics.V20200301.Cluster("cluster", new()
    ///     {
    ///         ClusterName = "An Example Cluster",
    ///         Location = "North US",
    ///         ResourceGroupName = "sjrg",
    ///         Sku = new AzureNative.StreamAnalytics.V20200301.Inputs.ClusterSkuArgs
    ///         {
    ///             Capacity = 48,
    ///             Name = "Default",
    ///         },
    ...
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20200301:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20200301:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
