...
namespace Pulumi.AzureNative.StreamAnalytics.V20200301
{
    ...
    [AzureNativeResourceType("azure-native:streamanalytics/v20200301:Output")]
    public partial class Output : global::Pulumi.CustomResource
    {
        ...
        public Output(string name, OutputArgs args, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20200301:Output", name, args ?? new OutputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Output(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20200301:Output", name, null, MakeResourceOptions(options, id))
        {
        }
