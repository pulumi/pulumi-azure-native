...
namespace Pulumi.AzureNative.StreamAnalytics.V20200301
{
    public static class GetCluster
    {
        ...
        public static Task<GetClusterResult> InvokeAsync(GetClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetClusterResult>("azure-native:streamanalytics/v20200301:getCluster", args ?? new GetClusterArgs(), options.WithDefaults());

        /// <summary>
        /// A Stream Analytics Cluster object
        /// </summary>
        public static Output<GetClusterResult> Invoke(GetClusterInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetClusterResult>("azure-native:streamanalytics/v20200301:getCluster", args ?? new GetClusterInvokeArgs(), options.WithDefaults());
    }
