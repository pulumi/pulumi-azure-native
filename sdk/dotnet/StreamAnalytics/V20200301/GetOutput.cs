...
namespace Pulumi.AzureNative.StreamAnalytics.V20200301
{
    public static class GetOutput
    {
        ...
        public static Task<GetOutputResult> InvokeAsync(GetOutputArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOutputResult>("azure-native:streamanalytics/v20200301:getOutput", args ?? new GetOutputArgs(), options.WithDefaults());

        /// <summary>
        /// An output object, containing all information associated with the named output. All outputs are contained under a streaming job.
        /// </summary>
        public static Output<GetOutputResult> Invoke(GetOutputInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOutputResult>("azure-native:streamanalytics/v20200301:getOutput", args ?? new GetOutputInvokeArgs(), options.WithDefaults());
    }
