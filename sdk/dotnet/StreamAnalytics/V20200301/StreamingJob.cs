...
namespace Pulumi.AzureNative.StreamAnalytics.V20200301
{
    ...
    public partial class StreamingJob : global::Pulumi.CustomResource
    {
        ...
        public StreamingJob(string name, StreamingJobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20200301:StreamingJob", name, args ?? new StreamingJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20200301:StreamingJob", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StreamingJobArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StreamAnalytics.V20200301.CompatibilityLevel>? CompatibilityLevel { get; set; }

        /// <summary>
        /// Valid values are JobStorageAccount and SystemAccount. If set to JobStorageAccount, this requires the user to also specify jobStorageAccount property. .
        /// </summary>
        [Input("contentStoragePolicy")]
        public InputUnion<string, Pulumi.AzureNative.StreamAnalytics.V20200301.ContentStoragePolicy>? ContentStoragePolicy { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.StreamAnalytics.V20200301.EventsOutOfOrderPolicy>? EventsOutOfOrderPolicy { get; set; }
        ...
        /// </summary>
        [Input("jobType")]
        public InputUnion<string, Pulumi.AzureNative.StreamAnalytics.V20200301.JobType>? JobType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.StreamAnalytics.V20200301.OutputErrorPolicy>? OutputErrorPolicy { get; set; }

        /// <summary>
        /// This property should only be utilized when it is desired that the job be started immediately upon creation. Value may be JobStartTime, CustomTime, or LastOutputEventTime to indicate whether the starting point of the output event stream should start whenever the job is started, start at a custom user time stamp specified via the outputStartTime property, or start from the last event output time.
        /// </summary>
        [Input("outputStartMode")]
        public InputUnion<string, Pulumi.AzureNative.StreamAnalytics.V20200301.OutputStartMode>? OutputStartMode { get; set; }
