...
namespace Pulumi.AzureNative.StreamAnalytics.V20200301
{
    ...
    /// {
    ///     var privateEndpoint = new AzureNative.StreamAnalytics.V20200301.PrivateEndpoint("privateEndpoint", new()
    ///     {
    ///         ClusterName = "testcluster",
    ///         ManualPrivateLinkServiceConnections = new[]
    ///         {
    ///             new AzureNative.StreamAnalytics.V20200301.Inputs.PrivateLinkServiceConnectionArgs
    ///             {
    ///                 GroupIds = new[]
    ///                 {
    ///                     "groupIdFromResource",
    ...
    public partial class PrivateEndpoint : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpoint(string name, PrivateEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20200301:PrivateEndpoint", name, args ?? new PrivateEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20200301:PrivateEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
