...
namespace Pulumi.AzureNative.StreamAnalytics.V20200301
{
    public static class GetFunction
    {
        ...
        public static Task<GetFunctionResult> InvokeAsync(GetFunctionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFunctionResult>("azure-native:streamanalytics/v20200301:getFunction", args ?? new GetFunctionArgs(), options.WithVersion());

        /// <summary>
        /// A function object, containing all information associated with the named function. All functions are contained under a streaming job.
        /// </summary>
        public static Output<GetFunctionResult> Invoke(GetFunctionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFunctionResult>("azure-native:streamanalytics/v20200301:getFunction", args ?? new GetFunctionInvokeArgs(), options.WithVersion());
    }
