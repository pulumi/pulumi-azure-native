...
namespace Pulumi.AzureNative.StreamAnalytics.V20200301
{
    ...
    public partial class Function : Pulumi.CustomResource
    {
        ...
        public Function(string name, FunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20200301:Function", name, args ?? new FunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Function(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:streamanalytics/v20200301:Function", name, null, MakeResourceOptions(options, id))
        {
        }
