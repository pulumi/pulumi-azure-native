...
namespace Pulumi.AzureRM.StreamAnalytics.Latest
{
    ...
    ///             JobName = "sj8653",
    ///             Properties = new AzureRM.StreamAnalytics.Latest.Inputs.FunctionPropertiesArgs
    ///             {
    ///                 Binding = 
    ///                 {
    ///                     { "properties", 
    ...
    public partial class Function : Pulumi.CustomResource
    {
        ...
        public Function(string name, FunctionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics/latest:Function", name, args ?? new FunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Function(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:streamanalytics/latest:Function", name, null, MakeResourceOptions(options, id))
        {
        }
