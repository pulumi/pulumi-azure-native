...
namespace Pulumi.AzureRM.DataCatalog.Preview
{
    /// <summary>
    /// Azure Data Catalog.
    /// </summary>
    public partial class ADCCatalog : Pulumi.CustomResource
    {
        ...
        public ADCCatalog(string name, ADCCatalogArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datacatalog/preview:ADCCatalog", name, args ?? new ADCCatalogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ADCCatalog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datacatalog/preview:ADCCatalog", name, null, MakeResourceOptions(options, id))
        {
        }
