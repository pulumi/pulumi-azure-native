...
namespace Pulumi.AzureNative.ProgrammableConnectivity.V20240115Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:programmableconnectivity/v20240115preview:Gateway")]
    public partial class Gateway : global::Pulumi.CustomResource
    {
        ...
        public Gateway(string name, GatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:programmableconnectivity/v20240115preview:Gateway", name, args ?? new GatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:programmableconnectivity/v20240115preview:Gateway", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:programmableconnectivity:Gateway" },
                },
            };
