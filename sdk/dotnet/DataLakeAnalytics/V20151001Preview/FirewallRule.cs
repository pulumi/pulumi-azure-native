...
namespace Pulumi.AzureNextGen.DataLakeAnalytics.V20151001Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datalakeanalytics/v20151001preview:FirewallRule")]
    public partial class FirewallRule : Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datalakeanalytics/v20151001preview:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datalakeanalytics/v20151001preview:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
