...
namespace Pulumi.AzureRM.DataLakeAnalytics
{
    ...
    public partial class ComputePolicy : Pulumi.CustomResource
    {
        ...
        public ComputePolicy(string name, ComputePolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datalakeanalytics:ComputePolicy", name, args ?? new ComputePolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComputePolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datalakeanalytics:ComputePolicy", name, null, MakeResourceOptions(options, id))
        {
        }
