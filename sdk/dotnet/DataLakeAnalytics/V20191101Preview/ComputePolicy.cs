...
namespace Pulumi.AzureNative.DataLakeAnalytics.V20191101Preview
{
    ...
    public partial class ComputePolicy : global::Pulumi.CustomResource
    {
        ...
        public ComputePolicy(string name, ComputePolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datalakeanalytics/v20191101preview:ComputePolicy", name, args ?? new ComputePolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComputePolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datalakeanalytics/v20191101preview:ComputePolicy", name, null, MakeResourceOptions(options, id))
        {
        }
