...
namespace Pulumi.AzureNative.DataLakeAnalytics.V20191101Preview
{
    ...
    /// {
    ///     var firewallRule = new AzureNative.DataLakeAnalytics.V20191101Preview.FirewallRule("firewallRule", new()
    ///     {
    ...
    public partial class FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datalakeanalytics/v20191101preview:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datalakeanalytics/v20191101preview:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
