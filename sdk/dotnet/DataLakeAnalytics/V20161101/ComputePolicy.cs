...
namespace Pulumi.AzureNative.DataLakeAnalytics.V20161101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datalakeanalytics/v20161101:ComputePolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:datalakeanalytics/v20191101preview:ComputePolicy to guarantee forwards compatibility.")]
    ...
    public partial class ComputePolicy : global::Pulumi.CustomResource
    {
        ...
        public ComputePolicy(string name, ComputePolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datalakeanalytics/v20161101:ComputePolicy", name, args ?? new ComputePolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComputePolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datalakeanalytics/v20161101:ComputePolicy", name, null, MakeResourceOptions(options, id))
        {
        }
