...
namespace Pulumi.AzureRM.DataLakeAnalytics.Preview
{
    public static class GetComputePolicy
    {
        public static Task<GetComputePolicyResult> InvokeAsync(GetComputePolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetComputePolicyResult>("azurerm:datalakeanalytics/preview:getComputePolicy", args ?? new GetComputePolicyArgs(), options.WithVersion());
    }
