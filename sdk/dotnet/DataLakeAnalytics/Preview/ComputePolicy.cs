...
namespace Pulumi.AzureRM.DataLakeAnalytics.Preview
{
    ...
    public partial class ComputePolicy : Pulumi.CustomResource
    {
        ...
        public ComputePolicy(string name, ComputePolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datalakeanalytics/preview:ComputePolicy", name, args ?? new ComputePolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComputePolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datalakeanalytics/preview:ComputePolicy", name, null, MakeResourceOptions(options, id))
        {
        }
