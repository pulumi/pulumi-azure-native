...
namespace Pulumi.AzureNative.RedHatOpenShift.V20231122
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redhatopenshift/v20231122:OpenShiftCluster")]
    public partial class OpenShiftCluster : global::Pulumi.CustomResource
    {
        ...
        public OpenShiftCluster(string name, OpenShiftClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20231122:OpenShiftCluster", name, args ?? new OpenShiftClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenShiftCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20231122:OpenShiftCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OpenShiftClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.RedHatOpenShift.V20231122.ProvisioningState>? ProvisioningState { get; set; }
