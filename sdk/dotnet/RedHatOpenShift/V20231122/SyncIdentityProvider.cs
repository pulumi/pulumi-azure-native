...
namespace Pulumi.AzureNative.RedHatOpenShift.V20231122
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redhatopenshift/v20231122:SyncIdentityProvider")]
    public partial class SyncIdentityProvider : global::Pulumi.CustomResource
    {
        ...
        public SyncIdentityProvider(string name, SyncIdentityProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20231122:SyncIdentityProvider", name, args ?? new SyncIdentityProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncIdentityProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20231122:SyncIdentityProvider", name, null, MakeResourceOptions(options, id))
        {
        }
