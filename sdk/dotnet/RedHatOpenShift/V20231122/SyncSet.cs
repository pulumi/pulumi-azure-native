...
namespace Pulumi.AzureNative.RedHatOpenShift.V20231122
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redhatopenshift/v20231122:SyncSet")]
    public partial class SyncSet : global::Pulumi.CustomResource
    {
        ...
        public SyncSet(string name, SyncSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20231122:SyncSet", name, args ?? new SyncSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20231122:SyncSet", name, null, MakeResourceOptions(options, id))
        {
        }
