...
namespace Pulumi.AzureNative.RedHatOpenShift.V20231122
{
    public static class GetSyncIdentityProvider
    {
        ...
        public static Task<GetSyncIdentityProviderResult> InvokeAsync(GetSyncIdentityProviderArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSyncIdentityProviderResult>("azure-native:redhatopenshift/v20231122:getSyncIdentityProvider", args ?? new GetSyncIdentityProviderArgs(), options.WithDefaults());
