...
namespace Pulumi.AzureNative.RedHatOpenShift.V20231122
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redhatopenshift/v20231122:MachinePool")]
    public partial class MachinePool : global::Pulumi.CustomResource
    {
        ...
        public MachinePool(string name, MachinePoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20231122:MachinePool", name, args ?? new MachinePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachinePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20231122:MachinePool", name, null, MakeResourceOptions(options, id))
        {
        }
