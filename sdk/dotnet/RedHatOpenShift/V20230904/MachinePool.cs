...
namespace Pulumi.AzureNative.RedHatOpenShift.V20230904
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redhatopenshift/v20230904:MachinePool")]
    public partial class MachinePool : global::Pulumi.CustomResource
    {
        ...
        public MachinePool(string name, MachinePoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20230904:MachinePool", name, args ?? new MachinePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachinePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20230904:MachinePool", name, null, MakeResourceOptions(options, id))
        {
        }
