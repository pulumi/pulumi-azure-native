...
namespace Pulumi.AzureNative.RedHatOpenShift.V20230904
{
    public static class GetSyncSet
    {
        ...
        public static Task<GetSyncSetResult> InvokeAsync(GetSyncSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSyncSetResult>("azure-native:redhatopenshift/v20230904:getSyncSet", args ?? new GetSyncSetArgs(), options.WithDefaults());

        /// <summary>
        /// The operation returns properties of a SyncSet.
        /// </summary>
        public static Output<GetSyncSetResult> Invoke(GetSyncSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSyncSetResult>("azure-native:redhatopenshift/v20230904:getSyncSet", args ?? new GetSyncSetInvokeArgs(), options.WithDefaults());
    }
