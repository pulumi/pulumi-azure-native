...
namespace Pulumi.AzureRM.RedHatOpenShift.Preview
{
    ...
    public partial class OpenShiftCluster : Pulumi.CustomResource
    {
        ...
        public OpenShiftCluster(string name, OpenShiftClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:redhatopenshift/preview:OpenShiftCluster", name, args ?? new OpenShiftClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenShiftCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:redhatopenshift/preview:OpenShiftCluster", name, null, MakeResourceOptions(options, id))
        {
        }
