...
namespace Pulumi.AzureNative.RedHatOpenShift.V20230701Preview
{
    public static class GetSyncSet
    {
        ...
        public static Task<GetSyncSetResult> InvokeAsync(GetSyncSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSyncSetResult>("azure-native:redhatopenshift/v20230701preview:getSyncSet", args ?? new GetSyncSetArgs(), options.WithDefaults());
