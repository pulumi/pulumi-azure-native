...
namespace Pulumi.AzureNative.RedHatOpenShift.V20210901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redhatopenshift/v20210901preview:OpenShiftCluster")]
    public partial class OpenShiftCluster : global::Pulumi.CustomResource
    {
        ...
        public OpenShiftCluster(string name, OpenShiftClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20210901preview:OpenShiftCluster", name, args ?? new OpenShiftClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenShiftCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20210901preview:OpenShiftCluster", name, null, MakeResourceOptions(options, id))
        {
        }
