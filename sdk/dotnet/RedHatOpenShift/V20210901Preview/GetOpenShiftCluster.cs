...
namespace Pulumi.AzureNative.RedHatOpenShift.V20210901Preview
{
    public static class GetOpenShiftCluster
    {
        ...
        public static Task<GetOpenShiftClusterResult> InvokeAsync(GetOpenShiftClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOpenShiftClusterResult>("azure-native:redhatopenshift/v20210901preview:getOpenShiftCluster", args ?? new GetOpenShiftClusterArgs(), options.WithVersion());

        /// <summary>
        /// OpenShiftCluster represents an Azure Red Hat OpenShift cluster.
        /// </summary>
        public static Output<GetOpenShiftClusterResult> Invoke(GetOpenShiftClusterInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOpenShiftClusterResult>("azure-native:redhatopenshift/v20210901preview:getOpenShiftCluster", args ?? new GetOpenShiftClusterInvokeArgs(), options.WithVersion());
    }
