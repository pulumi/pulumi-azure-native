...
namespace Pulumi.AzureNative.RedHatOpenShift.V20220904
{
    ...
    /// {
    ///     var syncSet = new AzureNative.RedHatOpenShift.V20220904.SyncSet("syncSet", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:redhatopenshift/v20220904:SyncSet mySyncSet /subscriptions/subscriptionId/resourceGroups/resourceGroup/providers/Microsoft.RedHatOpenShift/OpenShiftClusters/resourceName/syncSets/mySyncSet 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:redhatopenshift/v20220904:SyncSet")]
    public partial class SyncSet : global::Pulumi.CustomResource
    {
        ...
        public SyncSet(string name, SyncSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20220904:SyncSet", name, args ?? new SyncSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20220904:SyncSet", name, null, MakeResourceOptions(options, id))
        {
        }
