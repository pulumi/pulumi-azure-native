...
namespace Pulumi.AzureNative.RedHatOpenShift.V20220904
{
    ...
    /// {
    ///     var syncIdentityProvider = new AzureNative.RedHatOpenShift.V20220904.SyncIdentityProvider("syncIdentityProvider", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:redhatopenshift/v20220904:SyncIdentityProvider")]
    public partial class SyncIdentityProvider : global::Pulumi.CustomResource
    {
        ...
        public SyncIdentityProvider(string name, SyncIdentityProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20220904:SyncIdentityProvider", name, args ?? new SyncIdentityProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncIdentityProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20220904:SyncIdentityProvider", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:redhatopenshift:SyncIdentityProvider"},
                },
            };
