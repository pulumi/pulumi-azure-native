...
namespace Pulumi.AzureNative.RedHatOpenShift.V20240812Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redhatopenshift/v20240812preview:OpenShiftCluster")]
    public partial class OpenShiftCluster : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.PlatformWorkloadIdentityProfileResponse?> PlatformWorkloadIdentityProfile { get; private set; } = null!;
        ...
        public OpenShiftCluster(string name, OpenShiftClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20240812preview:OpenShiftCluster", name, args ?? new OpenShiftClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenShiftCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redhatopenshift/v20240812preview:OpenShiftCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OpenShiftClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.PlatformWorkloadIdentityProfileArgs>? PlatformWorkloadIdentityProfile { get; set; }

        /// <summary>
        /// The cluster provisioning state.
        /// </summary>
        [Input("provisioningState")]
        public InputUnion<string, Pulumi.AzureNative.RedHatOpenShift.V20240812Preview.ProvisioningState>? ProvisioningState { get; set; }
