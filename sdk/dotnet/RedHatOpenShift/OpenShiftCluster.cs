...
namespace Pulumi.AzureRM.RedHatOpenShift
{
    ...
    public partial class OpenShiftCluster : Pulumi.CustomResource
    {
        ...
        private OpenShiftCluster(string name, Input<string> id, OpenShiftClusterState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:redhatopenshift:OpenShiftCluster", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpenShiftCluster Get(string name, Input<string> id, OpenShiftClusterState? state = null, CustomResourceOptions? options = null)
        {
            return new OpenShiftCluster(name, id, state, options);
        }
    }
    ...
    public sealed class OpenShiftClusterState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The geo-location where the resource lives
        /// </summary>
        ...
        public Input<Inputs.OpenShiftClusterPropertiesResponseGetArgs> Properties { get; set; } = null!;
