...
namespace Pulumi.AzureNextGen.RedHatOpenShift.V20210131Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:redhatopenshift/v20210131preview:OpenShiftCluster")]
    public partial class OpenShiftCluster : Pulumi.CustomResource
    {
        ...
        public OpenShiftCluster(string name, OpenShiftClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:redhatopenshift/v20210131preview:OpenShiftCluster", name, args ?? new OpenShiftClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenShiftCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:redhatopenshift/v20210131preview:OpenShiftCluster", name, null, MakeResourceOptions(options, id))
        {
        }
