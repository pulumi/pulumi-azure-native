...
namespace Pulumi.AzureNextGen.RedHatOpenShift.V20210131Preview
{
    public static class GetOpenShiftCluster
    {
        public static Task<GetOpenShiftClusterResult> InvokeAsync(GetOpenShiftClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOpenShiftClusterResult>("azure-nextgen:redhatopenshift/v20210131preview:getOpenShiftCluster", args ?? new GetOpenShiftClusterArgs(), options.WithVersion());
    }
