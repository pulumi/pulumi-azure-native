...
namespace Pulumi.AzureNative.FrontDoor
{
    ...
    public partial class NetworkExperimentProfile : global::Pulumi.CustomResource
    {
        ...
        public NetworkExperimentProfile(string name, NetworkExperimentProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor:NetworkExperimentProfile", name, args ?? new NetworkExperimentProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkExperimentProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor:NetworkExperimentProfile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkExperimentProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.State>? EnabledState { get; set; }
