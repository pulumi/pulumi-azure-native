...
namespace Pulumi.AzureNative.FrontDoor.V20191101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:frontdoor/v20191101:NetworkExperimentProfile")]
    public partial class NetworkExperimentProfile : global::Pulumi.CustomResource
    {
        ...
        public NetworkExperimentProfile(string name, NetworkExperimentProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20191101:NetworkExperimentProfile", name, args ?? new NetworkExperimentProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkExperimentProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20191101:NetworkExperimentProfile", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:frontdoor:NetworkExperimentProfile" },
    ...
    public sealed class NetworkExperimentProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20191101.State>? EnabledState { get; set; }
