...
namespace Pulumi.AzureNative.FrontDoor.V20191101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:frontdoor/v20191101:Experiment")]
    public partial class Experiment : global::Pulumi.CustomResource
    {
        ...
        public Experiment(string name, ExperimentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20191101:Experiment", name, args ?? new ExperimentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Experiment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20191101:Experiment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:frontdoor:Experiment" },
