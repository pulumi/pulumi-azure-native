...
namespace Pulumi.AzureNative.FrontDoor.V20190301.Inputs
{
    ...
    public sealed class CustomRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20190301.ActionType> Action { get; set; } = null!;

        /// <summary>
        /// Describes if the custom rule is in enabled or disabled state. Defaults to Enabled if not specified.
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20190301.CustomRuleEnabledState>? EnabledState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20190301.RuleType> RuleType { get; set; } = null!;
