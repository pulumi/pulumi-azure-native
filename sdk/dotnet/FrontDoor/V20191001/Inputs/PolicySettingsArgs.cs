...
namespace Pulumi.AzureNative.FrontDoor.V20191001.Inputs
{
    ...
    public sealed class PolicySettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20191001.PolicyEnabledState>? EnabledState { get; set; }

        /// <summary>
        /// Describes if it is in detection mode or prevention mode at policy level.
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20191001.PolicyMode>? Mode { get; set; }
