...
namespace Pulumi.AzureNative.FrontDoor.V20191001.Inputs
{
    ...
    public sealed class CustomRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20191001.ActionType> Action { get; set; } = null!;

        /// <summary>
        /// Describes if the custom rule is in enabled or disabled state. Defaults to Enabled if not specified.
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20191001.CustomRuleEnabledState>? EnabledState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20191001.RuleType> RuleType { get; set; } = null!;
