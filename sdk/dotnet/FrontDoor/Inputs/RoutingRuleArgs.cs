...
namespace Pulumi.AzureNative.FrontDoor.Inputs
{
    ...
    public sealed class RoutingRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.FrontDoor.FrontDoorProtocol>>? _acceptedProtocols;

        /// <summary>
        /// Protocol schemes to match for this rule
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.FrontDoor.FrontDoorProtocol>> AcceptedProtocols
        {
            get => _acceptedProtocols ?? (_acceptedProtocols = new InputList<Union<string, Pulumi.AzureNative.FrontDoor.FrontDoorProtocol>>());
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.RoutingRuleEnabledState>? EnabledState { get; set; }
