...
namespace Pulumi.AzureNative.FrontDoor.V20220501
{
    /// <summary>
    /// Defines web application firewall policy.
    /// </summary>
    [AzureNativeResourceType("azure-native:frontdoor/v20220501:Policy")]
    public partial class Policy : global::Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20220501:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20220501:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
