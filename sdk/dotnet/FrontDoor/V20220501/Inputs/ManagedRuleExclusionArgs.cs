...
namespace Pulumi.AzureNative.FrontDoor.V20220501.Inputs
{
    ...
    public sealed class ManagedRuleExclusionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20220501.ManagedRuleExclusionMatchVariable> MatchVariable { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20220501.ManagedRuleExclusionSelectorMatchOperator> SelectorMatchOperator { get; set; } = null!;
