...
namespace Pulumi.AzureNative.FrontDoor.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:frontdoor/v20240201:Policy")]
    public partial class Policy : global::Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20240201:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20240201:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
