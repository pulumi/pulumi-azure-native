...
namespace Pulumi.AzureNative.FrontDoor.V20201101.Inputs
{
    ...
    public sealed class ManagedRuleOverrideArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("action")]
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20201101.ActionType>? Action { get; set; }

        /// <summary>
        /// Describes if the managed rule is in enabled or disabled state. Defaults to Disabled if not specified.
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20201101.ManagedRuleEnabledState>? EnabledState { get; set; }
