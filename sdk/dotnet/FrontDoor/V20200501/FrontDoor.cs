...
namespace Pulumi.AzureNative.FrontDoor.V20200501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:frontdoor/v20200501:FrontDoor")]
    public partial class FrontDoor : global::Pulumi.CustomResource
    {
        ...
        public FrontDoor(string name, FrontDoorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20200501:FrontDoor", name, args ?? new FrontDoorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FrontDoor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20200501:FrontDoor", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FrontDoorArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20200501.FrontDoorEnabledState>? EnabledState { get; set; }
