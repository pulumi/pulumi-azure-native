...
namespace Pulumi.AzureNative.FrontDoor.V20200501
{
    public static class GetRulesEngine
    {
        ...
        public static Task<GetRulesEngineResult> InvokeAsync(GetRulesEngineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRulesEngineResult>("azure-native:frontdoor/v20200501:getRulesEngine", args ?? new GetRulesEngineArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Rules Engine Configuration with the specified name within the specified Front Door.
        /// </summary>
        public static Output<GetRulesEngineResult> Invoke(GetRulesEngineInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRulesEngineResult>("azure-native:frontdoor/v20200501:getRulesEngine", args ?? new GetRulesEngineInvokeArgs(), options.WithDefaults());
