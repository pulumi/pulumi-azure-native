...
namespace Pulumi.AzureNative.FrontDoor.V20210601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:frontdoor/v20210601:Policy")]
    public partial class Policy : global::Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20210601:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20210601:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
