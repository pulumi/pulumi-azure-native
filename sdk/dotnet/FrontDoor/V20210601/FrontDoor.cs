...
namespace Pulumi.AzureNative.FrontDoor.V20210601
{
    /// <summary>
    /// Front Door represents a collection of backend endpoints to route traffic to along with rules that specify how traffic is sent there.
    /// </summary>
    [AzureNativeResourceType("azure-native:frontdoor/v20210601:FrontDoor")]
    public partial class FrontDoor : global::Pulumi.CustomResource
    {
        ...
        public FrontDoor(string name, FrontDoorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20210601:FrontDoor", name, args ?? new FrontDoorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FrontDoor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20210601:FrontDoor", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:frontdoor:FrontDoor" },
    ...
    public sealed class FrontDoorArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20210601.FrontDoorEnabledState>? EnabledState { get; set; }
