...
namespace Pulumi.AzureNative.FrontDoor.V20210601.Inputs
{
    ...
    public sealed class ManagedRuleExclusionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20210601.ManagedRuleExclusionMatchVariable> MatchVariable { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20210601.ManagedRuleExclusionSelectorMatchOperator> SelectorMatchOperator { get; set; } = null!;
