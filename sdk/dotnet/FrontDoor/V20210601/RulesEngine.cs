...
namespace Pulumi.AzureNative.FrontDoor.V20210601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:frontdoor/v20210601:RulesEngine")]
    public partial class RulesEngine : global::Pulumi.CustomResource
    {
        ...
        public RulesEngine(string name, RulesEngineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20210601:RulesEngine", name, args ?? new RulesEngineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RulesEngine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20210601:RulesEngine", name, null, MakeResourceOptions(options, id))
        {
        }
