...
namespace Pulumi.AzureNative.FrontDoor.V20200401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:frontdoor/v20200401:RulesEngine")]
    public partial class RulesEngine : global::Pulumi.CustomResource
    {
        ...
        public RulesEngine(string name, RulesEngineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20200401:RulesEngine", name, args ?? new RulesEngineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RulesEngine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:frontdoor/v20200401:RulesEngine", name, null, MakeResourceOptions(options, id))
        {
        }
