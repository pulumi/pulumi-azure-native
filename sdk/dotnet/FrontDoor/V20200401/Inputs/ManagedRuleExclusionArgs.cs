...
namespace Pulumi.AzureNative.FrontDoor.V20200401.Inputs
{
    ...
    public sealed class ManagedRuleExclusionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20200401.ManagedRuleExclusionMatchVariable> MatchVariable { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.FrontDoor.V20200401.ManagedRuleExclusionSelectorMatchOperator> SelectorMatchOperator { get; set; } = null!;
