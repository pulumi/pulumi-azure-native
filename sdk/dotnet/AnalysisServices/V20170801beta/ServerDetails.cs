...
namespace Pulumi.AzureRM.AnalysisServices.V20170801beta
{
    /// <summary>
    ...
    public partial class ServerDetails : Pulumi.CustomResource
    {
        ...
        public ServerDetails(string name, ServerDetailsArgs args, CustomResourceOptions? options = null)
            : base("azurerm:analysisservices/v20170801beta:ServerDetails", name, args ?? new ServerDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:analysisservices/v20170801beta:ServerDetails", name, null, MakeResourceOptions(options, id))
        {
        }
