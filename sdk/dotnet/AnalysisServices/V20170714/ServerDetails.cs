...
namespace Pulumi.AzureNextGen.AnalysisServices.V20170714
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:analysisservices/v20170714:ServerDetails")]
    public partial class ServerDetails : Pulumi.CustomResource
    {
        ...
        public ServerDetails(string name, ServerDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:analysisservices/v20170714:ServerDetails", name, args ?? new ServerDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:analysisservices/v20170714:ServerDetails", name, null, MakeResourceOptions(options, id))
        {
        }
