...
azure-native:analysisservices/v20170714:ServerDetails is being removed in the next major version of this provider. Please upgrade to azure-native:analysisservices/v20170801beta:ServerDetails to guarantee forwards compatibility.")]
    ...
    public partial class ServerDetails : global::Pulumi.CustomResource
    {
        ...
        public ServerDetails(string name, ServerDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:analysisservices/v20170714:ServerDetails", name, args ?? new ServerDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:analysisservices/v20170714:ServerDetails", name, null, MakeResourceOptions(options, id))
        {
        }
