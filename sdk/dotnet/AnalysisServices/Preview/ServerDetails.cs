...
namespace Pulumi.AzureRM.AnalysisServices.Preview
{
    ...
    public partial class ServerDetails : Pulumi.CustomResource
    {
        ...
        public ServerDetails(string name, ServerDetailsArgs args, CustomResourceOptions? options = null)
            : base("azurerm:analysisservices/preview:ServerDetails", name, args ?? new ServerDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:analysisservices/preview:ServerDetails", name, null, MakeResourceOptions(options, id))
        {
        }
