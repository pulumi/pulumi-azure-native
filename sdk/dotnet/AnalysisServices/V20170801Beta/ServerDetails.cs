...
namespace Pulumi.AzureNative.AnalysisServices.V20170801Beta
{
    /// <summary>
    ...
    /// {
    ///     var serverDetails = new AzureNative.AnalysisServices.V20170801Beta.ServerDetails("serverDetails", new()
    ///     {
    ///         AsAdministrators = new AzureNative.AnalysisServices.V20170801Beta.Inputs.ServerAdministratorsArgs
    ///         {
    ///             Members = new[]
    ///             {
    ...
    ///         Sku = new AzureNative.AnalysisServices.V20170801Beta.Inputs.ResourceSkuArgs
    ///         {
    ///             Capacity = 1,
    ///             Name = "S1",
    ///             Tier = "Standard",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:analysisservices/v20170801beta:ServerDetails azsdktest /subscriptions/613192d7-503f-477a-9cfe-4efc3ee2bd60/resourceGroups/TestRG/providers/Microsoft.AnalysisServices/servers/azsdktest 
    /// ```
    /// </summary>
    ...
    public partial class ServerDetails : global::Pulumi.CustomResource
    {
        ...
        public ServerDetails(string name, ServerDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:analysisservices/v20170801beta:ServerDetails", name, args ?? new ServerDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:analysisservices/v20170801beta:ServerDetails", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerDetailsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.AnalysisServices.V20170801Beta.ConnectionMode>? QuerypoolConnectionMode { get; set; }
