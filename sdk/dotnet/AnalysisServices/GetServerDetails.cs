...
namespace Pulumi.AzureRM.AnalysisServices
{
    public static class GetServerDetails
    {
        public static Task<GetServerDetailsResult> InvokeAsync(GetServerDetailsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerDetailsResult>("azurerm:analysisservices:getServerDetails", args ?? new GetServerDetailsArgs(), options.WithVersion());
    }
