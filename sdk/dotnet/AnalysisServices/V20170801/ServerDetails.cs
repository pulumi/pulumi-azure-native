...
namespace Pulumi.AzureRM.AnalysisServices.V20170801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serverDetails = new AzureRM.AnalysisServices.V20170801.ServerDetails("serverDetails", new AzureRM.AnalysisServices.V20170801.ServerDetailsArgs
    ///         {
    ///             AsAdministrators = new AzureRM.AnalysisServices.V20170801.Inputs.ServerAdministratorsArgs
    ///             {
    ///                 Members = 
    ///                 {
    ...
    ///             Sku = new AzureRM.AnalysisServices.V20170801.Inputs.ResourceSkuArgs
    ///             {
    ///                 Capacity = 1,
    ///                 Name = "S1",
    ///                 Tier = "Standard",
