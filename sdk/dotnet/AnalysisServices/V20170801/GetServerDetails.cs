...
namespace Pulumi.AzureRM.AnalysisServices.V20170801
{
    public static class GetServerDetails
    {
        public static Task<GetServerDetailsResult> InvokeAsync(GetServerDetailsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerDetailsResult>("azurerm:analysisservices/v20170801:getServerDetails", args ?? new GetServerDetailsArgs(), options.WithVersion());
    }
