...
namespace Pulumi.AzureNative.HybridConnectivity.V20230315
{
    ...
    public partial class ServiceConfiguration : global::Pulumi.CustomResource
    {
        ...
        public ServiceConfiguration(string name, ServiceConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridconnectivity/v20230315:ServiceConfiguration", name, args ?? new ServiceConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridconnectivity/v20230315:ServiceConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:hybridconnectivity:ServiceConfiguration" },
    ...
    public sealed class ServiceConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createdByType")]
        public InputUnion<string, Pulumi.AzureNative.HybridConnectivity.V20230315.CreatedByType>? CreatedByType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.HybridConnectivity.V20230315.CreatedByType>? LastModifiedByType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.HybridConnectivity.V20230315.ServiceName> ServiceName { get; set; } = null!;
