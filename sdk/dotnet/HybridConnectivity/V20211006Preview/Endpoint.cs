...
namespace Pulumi.AzureNative.HybridConnectivity.V20211006Preview
{
    ...
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridconnectivity/v20211006preview:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridconnectivity/v20211006preview:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:hybridconnectivity:Endpoint"},
    ...
    public sealed class EndpointArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createdByType")]
        public InputUnion<string, Pulumi.AzureNative.HybridConnectivity.V20211006Preview.CreatedByType>? CreatedByType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.HybridConnectivity.V20211006Preview.CreatedByType>? LastModifiedByType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.HybridConnectivity.V20211006Preview.Type> Type { get; set; } = null!;
