...
namespace Pulumi.AzureNative.HybridConnectivity
{
    ...
    public partial class PublicCloudConnector : global::Pulumi.CustomResource
    {
        ...
        public PublicCloudConnector(string name, PublicCloudConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridconnectivity:PublicCloudConnector", name, args ?? new PublicCloudConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicCloudConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridconnectivity:PublicCloudConnector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:hybridconnectivity/v20241201:PublicCloudConnector" },
                    new global::Pulumi.Alias { Type = "azure-native_hybridconnectivity_v20241201:hybridconnectivity:PublicCloudConnector" },
                },
            };
