...
namespace Pulumi.AzureNative.HybridConnectivity.V20241201
{
    public static class ListEndpointIngressGatewayCredentials
    {
        ...
        public static Task<ListEndpointIngressGatewayCredentialsResult> InvokeAsync(ListEndpointIngressGatewayCredentialsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListEndpointIngressGatewayCredentialsResult>("azure-native:hybridconnectivity/v20241201:listEndpointIngressGatewayCredentials", args ?? new ListEndpointIngressGatewayCredentialsArgs(), options.WithDefaults());
        ...
        public static Output<ListEndpointIngressGatewayCredentialsResult> Invoke(ListEndpointIngressGatewayCredentialsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListEndpointIngressGatewayCredentialsResult>("azure-native:hybridconnectivity/v20241201:listEndpointIngressGatewayCredentials", args ?? new ListEndpointIngressGatewayCredentialsInvokeArgs(), options.WithDefaults());
    }
