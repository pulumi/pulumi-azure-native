...
namespace Pulumi.AzureNative.HybridConnectivity.V20241201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridconnectivity/v20241201:ServiceConfiguration")]
    public partial class ServiceConfiguration : global::Pulumi.CustomResource
    {
        ...
        public ServiceConfiguration(string name, ServiceConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridconnectivity/v20241201:ServiceConfiguration", name, args ?? new ServiceConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridconnectivity/v20241201:ServiceConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.HybridConnectivity.V20241201.ServiceName> ServiceName { get; set; } = null!;
