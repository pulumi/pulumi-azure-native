...
namespace Pulumi.AzureNative.HybridContainerService.V20220501Preview.Inputs
{
    ...
    public sealed class NetworkProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.HybridContainerService.V20220501Preview.LoadBalancerSku>? LoadBalancerSku { get; set; }
        ...
        /// </summary>
        [Input("networkPolicy")]
        public InputUnion<string, Pulumi.AzureNative.HybridContainerService.V20220501Preview.NetworkPolicy>? NetworkPolicy { get; set; }
