...
namespace Pulumi.AzureNative.HybridContainerService
{
    public static class GetagentPool
    {
        ...
        public static Task<GetagentPoolResult> InvokeAsync(GetagentPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetagentPoolResult>("azure-native:hybridcontainerservice:getagentPool", args ?? new GetagentPoolArgs(), options.WithDefaults());
        ...
        public static Output<GetagentPoolResult> Invoke(GetagentPoolInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetagentPoolResult>("azure-native:hybridcontainerservice:getagentPool", args ?? new GetagentPoolInvokeArgs(), options.WithDefaults());
    }
