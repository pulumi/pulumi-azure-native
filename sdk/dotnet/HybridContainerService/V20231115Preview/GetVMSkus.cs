...
namespace Pulumi.AzureNative.HybridContainerService.V20231115Preview
{
    public static class GetVMSkus
    {
        ...
        public static Task<GetVMSkusResult> InvokeAsync(GetVMSkusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVMSkusResult>("azure-native:hybridcontainerservice/v20231115preview:getVMSkus", args ?? new GetVMSkusArgs(), options.WithDefaults());
