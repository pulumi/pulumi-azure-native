...
namespace Pulumi.AzureNative.HybridContainerService.V20231115Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcontainerservice/v20231115preview:VirtualNetworkRetrieve")]
    public partial class VirtualNetworkRetrieve : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkRetrieve(string name, VirtualNetworkRetrieveArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20231115preview:VirtualNetworkRetrieve", name, args ?? new VirtualNetworkRetrieveArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkRetrieve(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20231115preview:VirtualNetworkRetrieve", name, null, MakeResourceOptions(options, id))
        {
        }
