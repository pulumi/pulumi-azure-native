...
namespace Pulumi.AzureNative.HybridContainerService.V20231115Preview
{
    public static class GetClusterInstanceHybridIdentityMetadatum
    {
        ...
        public static Task<GetClusterInstanceHybridIdentityMetadatumResult> InvokeAsync(GetClusterInstanceHybridIdentityMetadatumArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterInstanceHybridIdentityMetadatumResult>("azure-native:hybridcontainerservice/v20231115preview:getClusterInstanceHybridIdentityMetadatum", args ?? new GetClusterInstanceHybridIdentityMetadatumArgs(), options.WithDefaults());
        ...
        public static Output<GetClusterInstanceHybridIdentityMetadatumResult> Invoke(GetClusterInstanceHybridIdentityMetadatumInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClusterInstanceHybridIdentityMetadatumResult>("azure-native:hybridcontainerservice/v20231115preview:getClusterInstanceHybridIdentityMetadatum", args ?? new GetClusterInstanceHybridIdentityMetadatumInvokeArgs(), options.WithDefaults());
