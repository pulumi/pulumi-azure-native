...
namespace Pulumi.AzureNative.HybridContainerService.V20231115Preview
{
    public static class GetVirtualNetworkRetrieve
    {
        ...
        public static Task<GetVirtualNetworkRetrieveResult> InvokeAsync(GetVirtualNetworkRetrieveArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkRetrieveResult>("azure-native:hybridcontainerservice/v20231115preview:getVirtualNetworkRetrieve", args ?? new GetVirtualNetworkRetrieveArgs(), options.WithDefaults());
        ...
        public static Output<GetVirtualNetworkRetrieveResult> Invoke(GetVirtualNetworkRetrieveInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVirtualNetworkRetrieveResult>("azure-native:hybridcontainerservice/v20231115preview:getVirtualNetworkRetrieve", args ?? new GetVirtualNetworkRetrieveInvokeArgs(), options.WithDefaults());
    }
