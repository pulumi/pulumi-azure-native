...
namespace Pulumi.AzureNative.HybridContainerService.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcontainerservice/v20240101:VirtualNetworkRetrieve")]
    public partial class VirtualNetworkRetrieve : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkRetrieve(string name, VirtualNetworkRetrieveArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20240101:VirtualNetworkRetrieve", name, args ?? new VirtualNetworkRetrieveArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkRetrieve(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20240101:VirtualNetworkRetrieve", name, null, MakeResourceOptions(options, id))
        {
        }
