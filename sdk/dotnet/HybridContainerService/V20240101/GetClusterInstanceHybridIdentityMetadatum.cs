...
namespace Pulumi.AzureNative.HybridContainerService.V20240101
{
    public static class GetClusterInstanceHybridIdentityMetadatum
    {
        ...
        public static Task<GetClusterInstanceHybridIdentityMetadatumResult> InvokeAsync(GetClusterInstanceHybridIdentityMetadatumArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterInstanceHybridIdentityMetadatumResult>("azure-native:hybridcontainerservice/v20240101:getClusterInstanceHybridIdentityMetadatum", args ?? new GetClusterInstanceHybridIdentityMetadatumArgs(), options.WithDefaults());
        ...
        public static Output<GetClusterInstanceHybridIdentityMetadatumResult> Invoke(GetClusterInstanceHybridIdentityMetadatumInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClusterInstanceHybridIdentityMetadatumResult>("azure-native:hybridcontainerservice/v20240101:getClusterInstanceHybridIdentityMetadatum", args ?? new GetClusterInstanceHybridIdentityMetadatumInvokeArgs(), options.WithDefaults());
