...
namespace Pulumi.AzureNative.HybridContainerService.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcontainerservice/v20240101:ClusterInstanceAgentPool")]
    public partial class ClusterInstanceAgentPool : global::Pulumi.CustomResource
    {
        ...
        public ClusterInstanceAgentPool(string name, ClusterInstanceAgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20240101:ClusterInstanceAgentPool", name, args ?? new ClusterInstanceAgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterInstanceAgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20240101:ClusterInstanceAgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:hybridcontainerservice/v20231115preview:ClusterInstanceAgentPool" },
