...
namespace Pulumi.AzureNative.HybridContainerService.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcontainerservice/v20240101:ProvisionedClusterInstance")]
    public partial class ProvisionedClusterInstance : global::Pulumi.CustomResource
    {
        ...
        public ProvisionedClusterInstance(string name, ProvisionedClusterInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20240101:ProvisionedClusterInstance", name, args ?? new ProvisionedClusterInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProvisionedClusterInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20240101:ProvisionedClusterInstance", name, null, MakeResourceOptions(options, id))
        {
        }
