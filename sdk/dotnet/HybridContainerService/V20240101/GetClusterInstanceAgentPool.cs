...
namespace Pulumi.AzureNative.HybridContainerService.V20240101
{
    public static class GetClusterInstanceAgentPool
    {
        ...
        public static Task<GetClusterInstanceAgentPoolResult> InvokeAsync(GetClusterInstanceAgentPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterInstanceAgentPoolResult>("azure-native:hybridcontainerservice/v20240101:getClusterInstanceAgentPool", args ?? new GetClusterInstanceAgentPoolArgs(), options.WithDefaults());
        ...
        public static Output<GetClusterInstanceAgentPoolResult> Invoke(GetClusterInstanceAgentPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClusterInstanceAgentPoolResult>("azure-native:hybridcontainerservice/v20240101:getClusterInstanceAgentPool", args ?? new GetClusterInstanceAgentPoolInvokeArgs(), options.WithDefaults());
