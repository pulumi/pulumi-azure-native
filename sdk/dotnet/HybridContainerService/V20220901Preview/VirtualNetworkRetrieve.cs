...
namespace Pulumi.AzureNative.HybridContainerService.V20220901Preview
{
    ...
    /// {
    ///     var virtualNetworkRetrieve = new AzureNative.HybridContainerService.V20220901Preview.VirtualNetworkRetrieve("virtualNetworkRetrieve", new()
    ///     {
    ///         ExtendedLocation = new AzureNative.HybridContainerService.V20220901Preview.Inputs.VirtualNetworksExtendedLocationArgs
    ///         {
    ///             Name = "/subscriptions/a3e42606-29b1-4d7d-b1d9-9ff6b9d3c71b/resourcegroups/test-arcappliance-resgrp/providers/microsoft.extendedlocation/customlocations/testcustomlocation",
    ///             Type = "CustomLocation",
    ///         },
    ///         Location = "westus",
    ///         Properties = new AzureNative.HybridContainerService.V20220901Preview.Inputs.VirtualNetworksPropertiesArgs
    ///         {
    ///             InfraVnetProfile = new AzureNative.HybridContainerService.V20220901Preview.Inputs.VirtualNetworksPropertiesInfraVnetProfileArgs
    ///             {
    ///                 Hci = new AzureNative.HybridContainerService.V20220901Preview.Inputs.VirtualNetworksPropertiesHciArgs
    ///                 {
    ...
    ///             VipPool = new[]
    ///             {
    ///                 new AzureNative.HybridContainerService.V20220901Preview.Inputs.VirtualNetworksPropertiesVipPoolArgs
    ///                 {
    ///                     EndIP = "192.168.0.50",
    ...
    ///             VmipPool = new[]
    ///             {
    ///                 new AzureNative.HybridContainerService.V20220901Preview.Inputs.VirtualNetworksPropertiesVmipPoolArgs
    ///                 {
    ///                     EndIP = "192.168.0.130",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcontainerservice/v20220901preview:virtualNetworkRetrieve")]
    public partial class VirtualNetworkRetrieve : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkRetrieve(string name, VirtualNetworkRetrieveArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20220901preview:virtualNetworkRetrieve", name, args ?? new VirtualNetworkRetrieveArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkRetrieve(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20220901preview:virtualNetworkRetrieve", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualNetworkRetrieve Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new VirtualNetworkRetrieve(name, id, options);
        }
    }
    ...
    public sealed class VirtualNetworkRetrieveArgs : global::Pulumi.ResourceArgs
    {
        ...
        public static new VirtualNetworkRetrieveArgs Empty => new VirtualNetworkRetrieveArgs();
    }
}
