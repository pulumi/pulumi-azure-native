...
namespace Pulumi.AzureNative.HybridContainerService.V20220901Preview
{
    public static class GetProvisionedCluster
    {
        ...
        public static Task<GetProvisionedClusterResult> InvokeAsync(GetProvisionedClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProvisionedClusterResult>("azure-native:hybridcontainerservice/v20220901preview:getProvisionedCluster", args ?? new GetProvisionedClusterArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the Hybrid AKS provisioned cluster
        /// </summary>
        public static Output<GetProvisionedClusterResult> Invoke(GetProvisionedClusterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProvisionedClusterResult>("azure-native:hybridcontainerservice/v20220901preview:getProvisionedCluster", args ?? new GetProvisionedClusterInvokeArgs(), options.WithDefaults());
