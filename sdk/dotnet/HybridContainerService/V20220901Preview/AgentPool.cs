...
namespace Pulumi.AzureNative.HybridContainerService.V20220901Preview
{
    ...
    /// {
    ///     var agentPool = new AzureNative.HybridContainerService.V20220901Preview.AgentPool("agentPool", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:hybridcontainerservice/v20220901preview:agentPool test-hybridaksnodepool /subscriptions/a3e42606-29b1-4d7d-b1d9-9ff6b9d3c71b/resourceGroups/test-arcappliance-resgrp/providers/Microsoft.HybridContainerService/provisionedClusters/test-hybridakscluster/agentPools/test-hybridaksnodepool 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcontainerservice/v20220901preview:agentPool")]
    public partial class AgentPool : global::Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20220901preview:agentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20220901preview:agentPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AgentPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.HybridContainerService.V20220901Preview.Mode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.HybridContainerService.V20220901Preview.OsType>? OsType { get; set; }
