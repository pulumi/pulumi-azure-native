...
namespace Pulumi.AzureNative.HybridContainerService.V20220901Preview
{
    ...
    /// {
    ///     var hybridIdentityMetadatum = new AzureNative.HybridContainerService.V20220901Preview.HybridIdentityMetadatum("hybridIdentityMetadatum", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcontainerservice/v20220901preview:HybridIdentityMetadatum")]
    public partial class HybridIdentityMetadatum : global::Pulumi.CustomResource
    {
        ...
        public HybridIdentityMetadatum(string name, HybridIdentityMetadatumArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20220901preview:HybridIdentityMetadatum", name, args ?? new HybridIdentityMetadatumArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridIdentityMetadatum(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcontainerservice/v20220901preview:HybridIdentityMetadatum", name, null, MakeResourceOptions(options, id))
        {
        }
