...
namespace Pulumi.AzureNative.IoTOperations.V20250401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20250401:Broker")]
    public partial class Broker : global::Pulumi.CustomResource
    {
        ...
        public Broker(string name, BrokerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20250401:Broker", name, args ?? new BrokerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Broker(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20250401:Broker", name, null, MakeResourceOptions(options, id))
        {
        }
