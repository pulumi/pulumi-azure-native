...
namespace Pulumi.AzureNative.IoTOperations.V20250401
{
    /// <summary>
    /// Instance dataflowEndpoint resource
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20250401:DataflowEndpoint")]
    public partial class DataflowEndpoint : global::Pulumi.CustomResource
    {
        ...
        public DataflowEndpoint(string name, DataflowEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20250401:DataflowEndpoint", name, args ?? new DataflowEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataflowEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20250401:DataflowEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
