...
namespace Pulumi.AzureNative.IoTOperations.V20250401
{
    public static class GetDataflowProfile
    {
        ...
        public static Task<GetDataflowProfileResult> InvokeAsync(GetDataflowProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataflowProfileResult>("azure-native:iotoperations/v20250401:getDataflowProfile", args ?? new GetDataflowProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Get a DataflowProfileResource
        /// </summary>
        public static Output<GetDataflowProfileResult> Invoke(GetDataflowProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataflowProfileResult>("azure-native:iotoperations/v20250401:getDataflowProfile", args ?? new GetDataflowProfileInvokeArgs(), options.WithDefaults());
