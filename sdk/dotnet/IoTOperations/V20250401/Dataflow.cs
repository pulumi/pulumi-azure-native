...
namespace Pulumi.AzureNative.IoTOperations.V20250401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20250401:Dataflow")]
    public partial class Dataflow : global::Pulumi.CustomResource
    {
        ...
        public Dataflow(string name, DataflowArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20250401:Dataflow", name, args ?? new DataflowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dataflow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20250401:Dataflow", name, null, MakeResourceOptions(options, id))
        {
        }
