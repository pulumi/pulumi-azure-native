...
namespace Pulumi.AzureNative.IoTOperations.V20250401
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct InstanceFeatureMode : IEquatable<InstanceFeatureMode>
    {
        private readonly string _value;

        private InstanceFeatureMode(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static InstanceFeatureMode Stable { get; } = new InstanceFeatureMode("Stable");
        /// <summary>
        /// Opt in to enable a preview feature
        /// </summary>
        public static InstanceFeatureMode Preview { get; } = new InstanceFeatureMode("Preview");
        /// <summary>
        /// Opt out of a feature
        /// </summary>
        public static InstanceFeatureMode Disabled { get; } = new InstanceFeatureMode("Disabled");

        public static bool operator ==(InstanceFeatureMode left, InstanceFeatureMode right) => left.Equals(right);
        public static bool operator !=(InstanceFeatureMode left, InstanceFeatureMode right) => !left.Equals(right);

        public static explicit operator string(InstanceFeatureMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is InstanceFeatureMode other && Equals(other);
        public bool Equals(InstanceFeatureMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
