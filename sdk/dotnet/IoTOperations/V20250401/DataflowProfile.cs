...
namespace Pulumi.AzureNative.IoTOperations.V20250401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20250401:DataflowProfile")]
    public partial class DataflowProfile : global::Pulumi.CustomResource
    {
        ...
        public DataflowProfile(string name, DataflowProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20250401:DataflowProfile", name, args ?? new DataflowProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataflowProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20250401:DataflowProfile", name, null, MakeResourceOptions(options, id))
        {
        }
