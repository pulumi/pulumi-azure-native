...
namespace Pulumi.AzureNative.IoTOperations.V20240915Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20240915preview:DataflowProfile")]
    public partial class DataflowProfile : global::Pulumi.CustomResource
    {
        ...
        public DataflowProfile(string name, DataflowProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240915preview:DataflowProfile", name, args ?? new DataflowProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataflowProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240915preview:DataflowProfile", name, null, MakeResourceOptions(options, id))
        {
        }
