...
namespace Pulumi.AzureNative.IoTOperations.V20240915Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20240915preview:Instance")]
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240915preview:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240915preview:Instance", name, null, MakeResourceOptions(options, id))
        {
        }
