...
namespace Pulumi.AzureNative.IoTOperations.V20240915Preview
{
    public static class GetBroker
    {
        ...
        public static Task<GetBrokerResult> InvokeAsync(GetBrokerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBrokerResult>("azure-native:iotoperations/v20240915preview:getBroker", args ?? new GetBrokerArgs(), options.WithDefaults());

        /// <summary>
        /// Get a BrokerResource
        /// </summary>
        public static Output<GetBrokerResult> Invoke(GetBrokerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBrokerResult>("azure-native:iotoperations/v20240915preview:getBroker", args ?? new GetBrokerInvokeArgs(), options.WithDefaults());
