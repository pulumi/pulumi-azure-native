...
namespace Pulumi.AzureNative.IoTOperations.V20240815Preview
{
    public static class GetBrokerListener
    {
        ...
        public static Task<GetBrokerListenerResult> InvokeAsync(GetBrokerListenerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBrokerListenerResult>("azure-native:iotoperations/v20240815preview:getBrokerListener", args ?? new GetBrokerListenerArgs(), options.WithDefaults());

        /// <summary>
        /// Get a BrokerListenerResource
        /// </summary>
        public static Output<GetBrokerListenerResult> Invoke(GetBrokerListenerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBrokerListenerResult>("azure-native:iotoperations/v20240815preview:getBrokerListener", args ?? new GetBrokerListenerInvokeArgs(), options.WithDefaults());
    }
