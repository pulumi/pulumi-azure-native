...
namespace Pulumi.AzureNative.IoTOperations.V20240815Preview
{
    public static class GetDataflow
    {
        ...
        public static Task<GetDataflowResult> InvokeAsync(GetDataflowArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataflowResult>("azure-native:iotoperations/v20240815preview:getDataflow", args ?? new GetDataflowArgs(), options.WithDefaults());

        /// <summary>
        /// Get a DataflowResource
        /// </summary>
        public static Output<GetDataflowResult> Invoke(GetDataflowInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataflowResult>("azure-native:iotoperations/v20240815preview:getDataflow", args ?? new GetDataflowInvokeArgs(), options.WithDefaults());
