...
namespace Pulumi.AzureNative.IoTOperations.V20240815Preview
{
    public static class GetDataflowProfile
    {
        ...
        public static Task<GetDataflowProfileResult> InvokeAsync(GetDataflowProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataflowProfileResult>("azure-native:iotoperations/v20240815preview:getDataflowProfile", args ?? new GetDataflowProfileArgs(), options.WithDefaults());
