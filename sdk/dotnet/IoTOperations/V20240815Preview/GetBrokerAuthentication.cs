...
namespace Pulumi.AzureNative.IoTOperations.V20240815Preview
{
    public static class GetBrokerAuthentication
    {
        ...
        public static Task<GetBrokerAuthenticationResult> InvokeAsync(GetBrokerAuthenticationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBrokerAuthenticationResult>("azure-native:iotoperations/v20240815preview:getBrokerAuthentication", args ?? new GetBrokerAuthenticationArgs(), options.WithDefaults());
        ...
        public static Output<GetBrokerAuthenticationResult> Invoke(GetBrokerAuthenticationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBrokerAuthenticationResult>("azure-native:iotoperations/v20240815preview:getBrokerAuthentication", args ?? new GetBrokerAuthenticationInvokeArgs(), options.WithDefaults());
