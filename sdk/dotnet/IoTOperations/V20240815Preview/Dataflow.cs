...
namespace Pulumi.AzureNative.IoTOperations.V20240815Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20240815preview:Dataflow")]
    public partial class Dataflow : global::Pulumi.CustomResource
    {
        ...
        public Dataflow(string name, DataflowArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240815preview:Dataflow", name, args ?? new DataflowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dataflow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240815preview:Dataflow", name, null, MakeResourceOptions(options, id))
        {
        }
