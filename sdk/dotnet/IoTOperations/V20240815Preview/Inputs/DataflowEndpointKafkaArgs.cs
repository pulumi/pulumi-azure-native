...
namespace Pulumi.AzureNative.IoTOperations.V20240815Preview.Inputs
{
    ...
    public sealed class DataflowEndpointKafkaArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.IoTOperations.V20240815Preview.CloudEventAttributeType>? CloudEventAttributes { get; set; }

        /// <summary>
        /// Compression. Can be none, gzip, lz4, or snappy. No effect if the endpoint is used as a source.
        /// </summary>
        [Input("compression")]
        public InputUnion<string, Pulumi.AzureNative.IoTOperations.V20240815Preview.DataflowEndpointKafkaCompression>? Compression { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.IoTOperations.V20240815Preview.OperationalMode>? CopyMqttProperties { get; set; }
        ...
        /// </summary>
        [Input("kafkaAcks")]
        public InputUnion<string, Pulumi.AzureNative.IoTOperations.V20240815Preview.DataflowEndpointKafkaAcks>? KafkaAcks { get; set; }

        /// <summary>
        /// Partition handling strategy. Can be default or static. No effect if the endpoint is used as a source.
        /// </summary>
        [Input("partitionStrategy")]
        public InputUnion<string, Pulumi.AzureNative.IoTOperations.V20240815Preview.DataflowEndpointKafkaPartitionStrategy>? PartitionStrategy { get; set; }
