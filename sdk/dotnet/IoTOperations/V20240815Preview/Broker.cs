...
namespace Pulumi.AzureNative.IoTOperations.V20240815Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20240815preview:Broker")]
    public partial class Broker : global::Pulumi.CustomResource
    {
        ...
        public Broker(string name, BrokerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240815preview:Broker", name, args ?? new BrokerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Broker(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240815preview:Broker", name, null, MakeResourceOptions(options, id))
        {
        }
