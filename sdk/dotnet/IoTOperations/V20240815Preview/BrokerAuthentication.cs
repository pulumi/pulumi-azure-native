...
namespace Pulumi.AzureNative.IoTOperations.V20240815Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20240815preview:BrokerAuthentication")]
    public partial class BrokerAuthentication : global::Pulumi.CustomResource
    {
        ...
        public BrokerAuthentication(string name, BrokerAuthenticationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240815preview:BrokerAuthentication", name, args ?? new BrokerAuthenticationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BrokerAuthentication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240815preview:BrokerAuthentication", name, null, MakeResourceOptions(options, id))
        {
        }
