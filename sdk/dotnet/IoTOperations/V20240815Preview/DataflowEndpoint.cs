...
namespace Pulumi.AzureNative.IoTOperations.V20240815Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20240815preview:DataflowEndpoint")]
    public partial class DataflowEndpoint : global::Pulumi.CustomResource
    {
        ...
        public DataflowEndpoint(string name, DataflowEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240815preview:DataflowEndpoint", name, args ?? new DataflowEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataflowEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240815preview:DataflowEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
