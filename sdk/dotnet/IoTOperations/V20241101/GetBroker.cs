...
namespace Pulumi.AzureNative.IoTOperations.V20241101
{
    public static class GetBroker
    {
        ...
        public static Task<GetBrokerResult> InvokeAsync(GetBrokerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBrokerResult>("azure-native:iotoperations/v20241101:getBroker", args ?? new GetBrokerArgs(), options.WithDefaults());

        /// <summary>
        /// Get a BrokerResource
        /// </summary>
        public static Output<GetBrokerResult> Invoke(GetBrokerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBrokerResult>("azure-native:iotoperations/v20241101:getBroker", args ?? new GetBrokerInvokeArgs(), options.WithDefaults());
