...
namespace Pulumi.AzureNative.IoTOperations.V20241101
{
    public static class GetDataflow
    {
        ...
        public static Task<GetDataflowResult> InvokeAsync(GetDataflowArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataflowResult>("azure-native:iotoperations/v20241101:getDataflow", args ?? new GetDataflowArgs(), options.WithDefaults());

        /// <summary>
        /// Get a DataflowResource
        /// </summary>
        public static Output<GetDataflowResult> Invoke(GetDataflowInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataflowResult>("azure-native:iotoperations/v20241101:getDataflow", args ?? new GetDataflowInvokeArgs(), options.WithDefaults());
    }
