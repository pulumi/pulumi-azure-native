...
namespace Pulumi.AzureNative.IoTOperations.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20241101:Instance")]
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20241101:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20241101:Instance", name, null, MakeResourceOptions(options, id))
        {
        }
