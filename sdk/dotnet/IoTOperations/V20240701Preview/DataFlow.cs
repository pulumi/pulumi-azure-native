...
namespace Pulumi.AzureNative.IoTOperations.V20240701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20240701preview:DataFlow")]
    public partial class DataFlow : global::Pulumi.CustomResource
    {
        ...
        public DataFlow(string name, DataFlowArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240701preview:DataFlow", name, args ?? new DataFlowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataFlow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240701preview:DataFlow", name, null, MakeResourceOptions(options, id))
        {
        }
