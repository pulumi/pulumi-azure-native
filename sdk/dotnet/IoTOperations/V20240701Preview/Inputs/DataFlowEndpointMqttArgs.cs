...
namespace Pulumi.AzureNative.IoTOperations.V20240701Preview.Inputs
{
    ...
    public sealed class DataFlowEndpointMqttArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.IoTOperations.V20240701Preview.BrokerProtocolType>? Protocol { get; set; }
        ...
        /// </summary>
        [Input("retain")]
        public InputUnion<string, Pulumi.AzureNative.IoTOperations.V20240701Preview.MqttRetainType>? Retain { get; set; }
