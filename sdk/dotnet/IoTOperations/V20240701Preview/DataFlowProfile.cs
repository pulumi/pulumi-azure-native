...
namespace Pulumi.AzureNative.IoTOperations.V20240701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperations/v20240701preview:DataFlowProfile")]
    public partial class DataFlowProfile : global::Pulumi.CustomResource
    {
        ...
        public DataFlowProfile(string name, DataFlowProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240701preview:DataFlowProfile", name, args ?? new DataFlowProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataFlowProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperations/v20240701preview:DataFlowProfile", name, null, MakeResourceOptions(options, id))
        {
        }
