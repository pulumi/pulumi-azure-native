...
namespace Pulumi.AzureNative.Easm.V20230401Preview
{
    ...
    /// Workspace details.
    /// </summary>
    [AzureNativeResourceType("azure-native:easm/v20230401preview:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:easm/v20230401preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:easm/v20230401preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
