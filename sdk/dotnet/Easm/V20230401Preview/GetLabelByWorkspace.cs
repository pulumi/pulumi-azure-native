...
namespace Pulumi.AzureNative.Easm.V20230401Preview
{
    public static class GetLabelByWorkspace
    {
        ...
        public static Task<GetLabelByWorkspaceResult> InvokeAsync(GetLabelByWorkspaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLabelByWorkspaceResult>("azure-native:easm/v20230401preview:getLabelByWorkspace", args ?? new GetLabelByWorkspaceArgs(), options.WithDefaults());
