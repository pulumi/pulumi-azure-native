...
namespace Pulumi.AzureRM.Automation
{
    public static class GetConnectionType
    {
        public static Task<GetConnectionTypeResult> InvokeAsync(GetConnectionTypeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConnectionTypeResult>("azurerm:automation:getConnectionType", args ?? new GetConnectionTypeArgs(), options.WithVersion());
    }
