...
namespace Pulumi.AzureRM.Automation.Latest
{
    public static class GetSourceControl
    {
        public static Task<GetSourceControlResult> InvokeAsync(GetSourceControlArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSourceControlResult>("azurerm:automation/latest:getSourceControl", args ?? new GetSourceControlArgs(), options.WithVersion());
    }
