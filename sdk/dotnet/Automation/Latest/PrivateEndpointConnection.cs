...
namespace Pulumi.AzureRM.Automation.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.Automation.Latest.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.Automation.Latest.PrivateEndpointConnectionArgs
    ///         {
    ///             AutomationAccountName = "ddb1",
    ///             PrivateEndpointConnectionName = "privateEndpointConnectionName",
    ///             PrivateLinkServiceConnectionState = new AzureRM.Automation.Latest.Inputs.PrivateLinkServiceConnectionStatePropertyArgs
    ///             {
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/latest:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/latest:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
