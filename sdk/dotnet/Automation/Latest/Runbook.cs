...
namespace Pulumi.AzureRM.Automation.Latest
{
    ...
    public partial class Runbook : Pulumi.CustomResource
    {
        ...
        public Runbook(string name, RunbookArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/latest:Runbook", name, args ?? new RunbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Runbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/latest:Runbook", name, null, MakeResourceOptions(options, id))
        {
        }
