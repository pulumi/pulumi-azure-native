...
namespace Pulumi.AzureNative.Automation.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:automation:AutomationAccount'.")]
    [AzureNativeResourceType("azure-native:automation/latest:AutomationAccount")]
    public partial class AutomationAccount : Pulumi.CustomResource
    {
        ...
        public AutomationAccount(string name, AutomationAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/latest:AutomationAccount", name, args ?? new AutomationAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutomationAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/latest:AutomationAccount", name, null, MakeResourceOptions(options, id))
        {
        }
