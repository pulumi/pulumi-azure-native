...
namespace Pulumi.AzureRM.Automation.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sourceControl = new AzureRM.Automation.Latest.SourceControl("sourceControl", new AzureRM.Automation.Latest.SourceControlArgs
    ///         {
    ///             AutoSync = true,
    ...
    ///             SecurityToken = new AzureRM.Automation.Latest.Inputs.SourceControlSecurityTokenPropertiesArgs
    ///             {
    ...
    public partial class SourceControl : Pulumi.CustomResource
    {
        ...
        public SourceControl(string name, SourceControlArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/latest:SourceControl", name, args ?? new SourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/latest:SourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
