...
namespace Pulumi.AzureNative.Automation.V20220808
{
    public static class GetCredential
    {
        ...
        public static Task<GetCredentialResult> InvokeAsync(GetCredentialArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCredentialResult>("azure-native:automation/v20220808:getCredential", args ?? new GetCredentialArgs(), options.WithDefaults());
