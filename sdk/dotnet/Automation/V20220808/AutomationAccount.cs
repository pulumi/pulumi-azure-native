...
namespace Pulumi.AzureNative.Automation.V20220808
{
    ...
    /// {
    ///     var automationAccount = new AzureNative.Automation.V20220808.AutomationAccount("automationAccount", new()
    ///     {
    ///         AutomationAccountName = "myAutomationAccount9",
    ///         Location = "East US 2",
    ///         Name = "myAutomationAccount9",
    ///         ResourceGroupName = "rg",
    ///         Sku = new AzureNative.Automation.V20220808.Inputs.SkuArgs
    ///         {
    ///             Name = "Free",
    ///         },
    ///     });
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20220808:AutomationAccount")]
    public partial class AutomationAccount : global::Pulumi.CustomResource
    {
        ...
        public AutomationAccount(string name, AutomationAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:AutomationAccount", name, args ?? new AutomationAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutomationAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:AutomationAccount", name, null, MakeResourceOptions(options, id))
        {
        }
