...
namespace Pulumi.AzureNative.Automation.V20220808
{
    ...
    /// {
    ///     var connectionType = new AzureNative.Automation.V20220808.ConnectionType("connectionType", new()
    ///     {
    ///         AutomationAccountName = "myAutomationAccount22",
    ///         ConnectionTypeName = "myCT",
    ///         FieldDefinitions = 
    ///         {
    ///             { "myBoolField", new AzureNative.Automation.V20220808.Inputs.FieldDefinitionArgs
    ///             {
    ///                 IsEncrypted = false,
    ///                 IsOptional = false,
    ///                 Type = "bool",
    ///             } },
    ///             { "myStringField", new AzureNative.Automation.V20220808.Inputs.FieldDefinitionArgs
    ///             {
    ///                 IsEncrypted = false,
    ///                 IsOptional = false,
    ///                 Type = "string",
    ///             } },
    ///             { "myStringFieldEncrypted", new AzureNative.Automation.V20220808.Inputs.FieldDefinitionArgs
    ///             {
    ///                 IsEncrypted = true,
    ///                 IsOptional = false,
    ///                 Type = "string",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20220808:ConnectionType")]
    public partial class ConnectionType : global::Pulumi.CustomResource
    {
        ...
        public ConnectionType(string name, ConnectionTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:ConnectionType", name, args ?? new ConnectionTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:ConnectionType", name, null, MakeResourceOptions(options, id))
        {
        }
