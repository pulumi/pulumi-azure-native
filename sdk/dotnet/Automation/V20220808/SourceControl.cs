...
namespace Pulumi.AzureNative.Automation.V20220808
{
    ...
    /// {
    ///     var sourceControl = new AzureNative.Automation.V20220808.SourceControl("sourceControl", new()
    ///     {
    ///         AutoSync = true,
    ...
    ///         SecurityToken = new AzureNative.Automation.V20220808.Inputs.SourceControlSecurityTokenPropertiesArgs
    ///         {
    ///             AccessToken = "******",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20220808:SourceControl")]
    public partial class SourceControl : global::Pulumi.CustomResource
    {
        ...
        public SourceControl(string name, SourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:SourceControl", name, args ?? new SourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:SourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
