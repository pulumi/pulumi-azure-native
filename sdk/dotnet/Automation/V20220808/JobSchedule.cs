...
namespace Pulumi.AzureNative.Automation.V20220808
{
    ...
    public partial class JobSchedule : global::Pulumi.CustomResource
    {
        ...
        public JobSchedule(string name, JobScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:JobSchedule", name, args ?? new JobScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:JobSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
