...
namespace Pulumi.AzureNative.Automation.V20220808
{
    ...
    /// {
    ///     var schedule = new AzureNative.Automation.V20220808.Schedule("schedule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20220808:Schedule")]
    public partial class Schedule : global::Pulumi.CustomResource
    {
        ...
        public Schedule(string name, ScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:Schedule", name, args ?? new ScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:Schedule", name, null, MakeResourceOptions(options, id))
        {
        }
