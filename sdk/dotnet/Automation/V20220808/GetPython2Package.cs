...
namespace Pulumi.AzureNative.Automation.V20220808
{
    public static class GetPython2Package
    {
        ...
        public static Task<GetPython2PackageResult> InvokeAsync(GetPython2PackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPython2PackageResult>("azure-native:automation/v20220808:getPython2Package", args ?? new GetPython2PackageArgs(), options.WithDefaults());
