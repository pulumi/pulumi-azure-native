...
namespace Pulumi.AzureNative.Automation.V20220808
{
    ...
    /// {
    ///     var python2Package = new AzureNative.Automation.V20220808.Python2Package("python2Package", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20220808:Python2Package")]
    public partial class Python2Package : global::Pulumi.CustomResource
    {
        ...
        public Python2Package(string name, Python2PackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:Python2Package", name, args ?? new Python2PackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Python2Package(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:Python2Package", name, null, MakeResourceOptions(options, id))
        {
        }
