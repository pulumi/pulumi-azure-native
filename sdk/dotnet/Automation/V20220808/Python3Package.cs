...
namespace Pulumi.AzureNative.Automation.V20220808
{
    ...
    public partial class Python3Package : global::Pulumi.CustomResource
    {
        ...
        public Python3Package(string name, Python3PackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:Python3Package", name, args ?? new Python3PackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Python3Package(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:Python3Package", name, null, MakeResourceOptions(options, id))
        {
        }
