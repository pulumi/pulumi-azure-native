...
namespace Pulumi.AzureNative.Automation.V20220808
{
    ...
    public partial class Credential : global::Pulumi.CustomResource
    {
        ...
        public Credential(string name, CredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:Credential", name, args ?? new CredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Credential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20220808:Credential", name, null, MakeResourceOptions(options, id))
        {
        }
