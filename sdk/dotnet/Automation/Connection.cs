...
namespace Pulumi.AzureRM.Automation
{
    ...
    public partial class Connection : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ConnectionPropertiesResponseResult> Properties { get; private set; } = null!;
        ...
        public Connection(string name, ConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation:Connection", name, args ?? new ConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation:Connection", name, null, MakeResourceOptions(options, id))
        {
        }
