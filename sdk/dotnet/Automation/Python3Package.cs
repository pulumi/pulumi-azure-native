...
namespace Pulumi.AzureNative.Automation
{
    ...
    public partial class Python3Package : global::Pulumi.CustomResource
    {
        ...
        public Python3Package(string name, Python3PackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation:Python3Package", name, args ?? new Python3PackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Python3Package(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation:Python3Package", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_automation_v20220808:automation:Python3Package" },
                    new global::Pulumi.Alias { Type = "azure-native_automation_v20230515preview:automation:Python3Package" },
                    new global::Pulumi.Alias { Type = "azure-native_automation_v20231101:automation:Python3Package" },
                    new global::Pulumi.Alias { Type = "azure-native_automation_v20241023:automation:Python3Package" },
                },
            };
