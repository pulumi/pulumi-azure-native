...
namespace Pulumi.AzureNative.Automation.V20190601
{
    public static class GetWatcher
    {
        ...
        public static Task<GetWatcherResult> InvokeAsync(GetWatcherArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWatcherResult>("azure-native:automation/v20190601:getWatcher", args ?? new GetWatcherArgs(), options.WithVersion());

        /// <summary>
        /// Definition of the watcher type.
        /// </summary>
        public static Output<GetWatcherResult> Invoke(GetWatcherInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWatcherResult>("azure-native:automation/v20190601:getWatcher", args ?? new GetWatcherInvokeArgs(), options.WithVersion());
    }
