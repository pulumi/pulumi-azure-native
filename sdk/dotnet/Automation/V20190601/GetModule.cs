...
namespace Pulumi.AzureNative.Automation.V20190601
{
    public static class GetModule
    {
        ...
        public static Task<GetModuleResult> InvokeAsync(GetModuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetModuleResult>("azure-native:automation/v20190601:getModule", args ?? new GetModuleArgs(), options.WithVersion());

        /// <summary>
        /// Definition of the module type.
        /// </summary>
        public static Output<GetModuleResult> Invoke(GetModuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetModuleResult>("azure-native:automation/v20190601:getModule", args ?? new GetModuleInvokeArgs(), options.WithVersion());
    }
