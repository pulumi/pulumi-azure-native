...
namespace Pulumi.AzureNextGen.Automation.V20190601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:automation/v20190601:SourceControl")]
    public partial class SourceControl : Pulumi.CustomResource
    {
        ...
        public SourceControl(string name, SourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:automation/v20190601:SourceControl", name, args ?? new SourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:automation/v20190601:SourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SourceControlArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("sourceType")]
        public InputUnion<string, Pulumi.AzureNextGen.Automation.V20190601.SourceType>? SourceType { get; set; }
