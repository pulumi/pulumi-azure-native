...
namespace Pulumi.AzureNative.Automation.V20190601
{
    ...
    /// {
    ///     var python2Package = new AzureNative.Automation.V20190601.Python2Package("python2Package", new()
    ///     {
    ...
    public partial class Python2Package : global::Pulumi.CustomResource
    {
        ...
        public Python2Package(string name, Python2PackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20190601:Python2Package", name, args ?? new Python2PackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Python2Package(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20190601:Python2Package", name, null, MakeResourceOptions(options, id))
        {
        }
