...
namespace Pulumi.AzureNative.Automation.V20190601
{
    ...
    /// {
    ///     var certificate = new AzureNative.Automation.V20190601.Certificate("certificate", new()
    ///     {
    ...
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20190601:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20190601:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
