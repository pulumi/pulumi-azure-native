...
namespace Pulumi.AzureNative.Automation.V20190601
{
    ...
    /// {
    ///     var jobSchedule = new AzureNative.Automation.V20190601.JobSchedule("jobSchedule", new()
    ///     {
    ...
    ///         Runbook = new AzureNative.Automation.V20190601.Inputs.RunbookAssociationPropertyArgs
    ///         {
    ///             Name = "TestRunbook",
    ///         },
    ///         Schedule = new AzureNative.Automation.V20190601.Inputs.ScheduleAssociationPropertyArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20190601:JobSchedule")]
    public partial class JobSchedule : global::Pulumi.CustomResource
    {
        ...
        public JobSchedule(string name, JobScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20190601:JobSchedule", name, args ?? new JobScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20190601:JobSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
