...
namespace Pulumi.AzureNextGen.Automation.V20190601
{
    public static class GetDscConfiguration
    {
        ...
        public static Task<GetDscConfigurationResult> InvokeAsync(GetDscConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDscConfigurationResult>("azure-nextgen:automation/v20190601:getDscConfiguration", args ?? new GetDscConfigurationArgs(), options.WithVersion());
    }
