...
namespace Pulumi.AzureNative.Automation.V20190601
{
    ...
    /// {
    ///     var watcher = new AzureNative.Automation.V20190601.Watcher("watcher", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:automation/v20190601:Watcher MyTestWatcher /subscriptions/subId/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/MyTestAutomationAccount/watchers/MyTestWatcher 
    /// ```
    /// </summary>
    ...
    public partial class Watcher : global::Pulumi.CustomResource
    {
        ...
        public Watcher(string name, WatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20190601:Watcher", name, args ?? new WatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Watcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20190601:Watcher", name, null, MakeResourceOptions(options, id))
        {
        }
