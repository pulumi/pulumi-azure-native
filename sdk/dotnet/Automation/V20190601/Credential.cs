...
namespace Pulumi.AzureNative.Automation.V20190601
{
    ...
    /// {
    ///     var credential = new AzureNative.Automation.V20190601.Credential("credential", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:automation/v20190601:Credential myCredential /subscriptions/subid/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/myAutomationAccount18/credentials/myCredential 
    /// ```
    /// </summary>
    ...
    public partial class Credential : global::Pulumi.CustomResource
    {
        ...
        public Credential(string name, CredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20190601:Credential", name, args ?? new CredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Credential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20190601:Credential", name, null, MakeResourceOptions(options, id))
        {
        }
