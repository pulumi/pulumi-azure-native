...
namespace Pulumi.AzureNextGen.Automation.V20190601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:automation/v20190601:Credential")]
    public partial class Credential : Pulumi.CustomResource
    {
        ...
        public Credential(string name, CredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:automation/v20190601:Credential", name, args ?? new CredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Credential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:automation/v20190601:Credential", name, null, MakeResourceOptions(options, id))
        {
        }
