...
{
    [Obsolete(@"azure-native:automation/v20190601:Runbook is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Runbook to guarantee forwards compatibility.")]
    public static class GetRunbook
    {
        ...
        public static Task<GetRunbookResult> InvokeAsync(GetRunbookArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRunbookResult>("azure-native:automation/v20190601:getRunbook", args ?? new GetRunbookArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve the runbook identified by runbook name.
        /// </summary>
        public static Output<GetRunbookResult> Invoke(GetRunbookInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRunbookResult>("azure-native:automation/v20190601:getRunbook", args ?? new GetRunbookInvokeArgs(), options.WithDefaults());
    }
