...
namespace Pulumi.AzureNative.Automation.V20190601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20190601:AutomationAccount")]
    public partial class AutomationAccount : Pulumi.CustomResource
    {
        ...
        public AutomationAccount(string name, AutomationAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20190601:AutomationAccount", name, args ?? new AutomationAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutomationAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20190601:AutomationAccount", name, null, MakeResourceOptions(options, id))
        {
        }
