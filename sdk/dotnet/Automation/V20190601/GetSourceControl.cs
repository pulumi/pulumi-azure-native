...
namespace Pulumi.AzureNative.Automation.V20190601
{
    public static class GetSourceControl
    {
        ...
        public static Output<GetSourceControlResult> Invoke(GetSourceControlInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSourceControlResult>("azure-native:automation/v20190601:getSourceControl", args ?? new GetSourceControlInvokeArgs(), options.WithVersion());
    }
