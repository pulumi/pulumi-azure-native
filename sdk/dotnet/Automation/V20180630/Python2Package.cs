...
namespace Pulumi.AzureRM.Automation.V20180630
{
    ...
    public partial class Python2Package : Pulumi.CustomResource
    {
        ...
        public Python2Package(string name, Python2PackageArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/v20180630:Python2Package", name, args ?? new Python2PackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Python2Package(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/v20180630:Python2Package", name, null, MakeResourceOptions(options, id))
        {
        }
