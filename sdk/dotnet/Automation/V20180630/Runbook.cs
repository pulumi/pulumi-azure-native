...
namespace Pulumi.AzureNative.Automation.V20180630
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:automation/v20180630:Runbook is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Runbook to guarantee forwards compatibility.")]
    ...
    public partial class Runbook : global::Pulumi.CustomResource
    {
        ...
        public Runbook(string name, RunbookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20180630:Runbook", name, args ?? new RunbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Runbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20180630:Runbook", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RunbookArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Automation.V20180630.RunbookTypeEnum> RunbookType { get; set; } = null!;
