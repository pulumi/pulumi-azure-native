...
namespace Pulumi.AzureNextGen.Automation.V20180630
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:automation/v20180630:Runbook")]
    public partial class Runbook : Pulumi.CustomResource
    {
        ...
        public Runbook(string name, RunbookArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:automation/v20180630:Runbook", name, args ?? new RunbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Runbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:automation/v20180630:Runbook", name, null, MakeResourceOptions(options, id))
        {
        }
