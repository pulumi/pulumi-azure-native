...
namespace Pulumi.AzureNative.Automation.V20200113Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:automation/v20200113preview:DscNodeConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:DscNodeConfiguration to guarantee forwards compatibility.")]
    ...
    public partial class DscNodeConfiguration : global::Pulumi.CustomResource
    {
        ...
        public DscNodeConfiguration(string name, DscNodeConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20200113preview:DscNodeConfiguration", name, args ?? new DscNodeConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DscNodeConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20200113preview:DscNodeConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
