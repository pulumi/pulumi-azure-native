...
namespace Pulumi.AzureNextGen.Automation.V20200113Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:automation/v20200113preview:DscNodeConfiguration")]
    public partial class DscNodeConfiguration : Pulumi.CustomResource
    {
        ...
        public DscNodeConfiguration(string name, DscNodeConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:automation/v20200113preview:DscNodeConfiguration", name, args ?? new DscNodeConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DscNodeConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:automation/v20200113preview:DscNodeConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
