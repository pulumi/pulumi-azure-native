...
namespace Pulumi.AzureNextGen.Automation.V20200113Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:automation/v20200113preview:JobSchedule")]
    public partial class JobSchedule : Pulumi.CustomResource
    {
        ...
        public JobSchedule(string name, JobScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:automation/v20200113preview:JobSchedule", name, args ?? new JobScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:automation/v20200113preview:JobSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
