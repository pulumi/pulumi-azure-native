...
namespace Pulumi.AzureNative.Automation.V20200113Preview
{
    ...
    [AzureNativeResourceType("azure-native:automation/v20200113preview:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20200113preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20200113preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
