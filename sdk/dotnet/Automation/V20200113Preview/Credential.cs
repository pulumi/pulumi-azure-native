...
namespace Pulumi.AzureNative.Automation.V20200113Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:automation/v20200113preview:Credential is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Credential to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:automation/v20200113preview:Credential")]
    public partial class Credential : global::Pulumi.CustomResource
    {
        ...
        public Credential(string name, CredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20200113preview:Credential", name, args ?? new CredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Credential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20200113preview:Credential", name, null, MakeResourceOptions(options, id))
        {
        }
