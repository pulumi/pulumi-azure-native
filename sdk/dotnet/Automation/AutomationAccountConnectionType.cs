...
namespace Pulumi.AzureRM.Automation
{
    ...
    public partial class AutomationAccountConnectionType : Pulumi.CustomResource
    {
        ...
        private AutomationAccountConnectionType(string name, Input<string> id, AutomationAccountConnectionTypeState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:automation:AutomationAccountConnectionType", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AutomationAccountConnectionType Get(string name, Input<string> id, AutomationAccountConnectionTypeState? state = null, CustomResourceOptions? options = null)
        {
            return new AutomationAccountConnectionType(name, id, state, options);
        }
    }
    ...
    public sealed class AutomationAccountConnectionTypeState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Gets the name of the connection type.
        /// </summary>
        ...
        /// </summary>
        [Input("properties", required: true)]
        public Input<Inputs.ConnectionTypePropertiesResponseGetArgs> Properties { get; set; } = null!;
        ...
        public AutomationAccountConnectionTypeState()
        {
        }
    }
}
