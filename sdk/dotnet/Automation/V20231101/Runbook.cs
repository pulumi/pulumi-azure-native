...
namespace Pulumi.AzureNative.Automation.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20231101:Runbook")]
    public partial class Runbook : global::Pulumi.CustomResource
    {
        ...
        public Runbook(string name, RunbookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:Runbook", name, args ?? new RunbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Runbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:Runbook", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RunbookArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Automation.V20231101.RunbookTypeEnum> RunbookType { get; set; } = null!;
