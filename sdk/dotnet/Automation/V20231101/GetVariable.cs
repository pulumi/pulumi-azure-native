...
namespace Pulumi.AzureNative.Automation.V20231101
{
    public static class GetVariable
    {
        ...
        public static Task<GetVariableResult> InvokeAsync(GetVariableArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVariableResult>("azure-native:automation/v20231101:getVariable", args ?? new GetVariableArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve the variable identified by variable name.
        /// </summary>
        public static Output<GetVariableResult> Invoke(GetVariableInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVariableResult>("azure-native:automation/v20231101:getVariable", args ?? new GetVariableInvokeArgs(), options.WithDefaults());
    }
