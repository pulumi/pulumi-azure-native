...
namespace Pulumi.AzureNative.Automation.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20231101:HybridRunbookWorker")]
    public partial class HybridRunbookWorker : global::Pulumi.CustomResource
    {
        ...
        public HybridRunbookWorker(string name, HybridRunbookWorkerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:HybridRunbookWorker", name, args ?? new HybridRunbookWorkerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridRunbookWorker(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:HybridRunbookWorker", name, null, MakeResourceOptions(options, id))
        {
        }
