...
namespace Pulumi.AzureNative.Automation.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20231101:Module")]
    public partial class Module : global::Pulumi.CustomResource
    {
        ...
        public Module(string name, ModuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:Module", name, args ?? new ModuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Module(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:Module", name, null, MakeResourceOptions(options, id))
        {
        }
