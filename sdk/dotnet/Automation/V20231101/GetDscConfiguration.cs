...
namespace Pulumi.AzureNative.Automation.V20231101
{
    public static class GetDscConfiguration
    {
        ...
        public static Task<GetDscConfigurationResult> InvokeAsync(GetDscConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDscConfigurationResult>("azure-native:automation/v20231101:getDscConfiguration", args ?? new GetDscConfigurationArgs(), options.WithDefaults());
