...
namespace Pulumi.AzureNative.Automation.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20231101:PowerShell72Module")]
    public partial class PowerShell72Module : global::Pulumi.CustomResource
    {
        ...
        public PowerShell72Module(string name, PowerShell72ModuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:PowerShell72Module", name, args ?? new PowerShell72ModuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PowerShell72Module(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:PowerShell72Module", name, null, MakeResourceOptions(options, id))
        {
        }
