...
namespace Pulumi.AzureNative.Automation.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20231101:HybridRunbookWorkerGroup")]
    public partial class HybridRunbookWorkerGroup : global::Pulumi.CustomResource
    {
        ...
        public HybridRunbookWorkerGroup(string name, HybridRunbookWorkerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:HybridRunbookWorkerGroup", name, args ?? new HybridRunbookWorkerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridRunbookWorkerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:HybridRunbookWorkerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
