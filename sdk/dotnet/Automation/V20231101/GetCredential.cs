...
namespace Pulumi.AzureNative.Automation.V20231101
{
    public static class GetCredential
    {
        ...
        public static Task<GetCredentialResult> InvokeAsync(GetCredentialArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCredentialResult>("azure-native:automation/v20231101:getCredential", args ?? new GetCredentialArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve the credential identified by credential name.
        /// </summary>
        public static Output<GetCredentialResult> Invoke(GetCredentialInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCredentialResult>("azure-native:automation/v20231101:getCredential", args ?? new GetCredentialInvokeArgs(), options.WithDefaults());
    }
