...
namespace Pulumi.AzureNative.Automation.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20231101:DscConfiguration")]
    public partial class DscConfiguration : global::Pulumi.CustomResource
    {
        ...
        public DscConfiguration(string name, DscConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:DscConfiguration", name, args ?? new DscConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DscConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:DscConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
