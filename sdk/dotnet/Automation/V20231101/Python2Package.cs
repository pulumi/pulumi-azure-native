...
namespace Pulumi.AzureNative.Automation.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20231101:Python2Package")]
    public partial class Python2Package : global::Pulumi.CustomResource
    {
        ...
        public Python2Package(string name, Python2PackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:Python2Package", name, args ?? new Python2PackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Python2Package(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20231101:Python2Package", name, null, MakeResourceOptions(options, id))
        {
        }
