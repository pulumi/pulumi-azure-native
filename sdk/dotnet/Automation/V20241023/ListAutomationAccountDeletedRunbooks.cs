...
namespace Pulumi.AzureNative.Automation.V20241023
{
    public static class ListAutomationAccountDeletedRunbooks
    {
        ...
        public static Task<ListAutomationAccountDeletedRunbooksResult> InvokeAsync(ListAutomationAccountDeletedRunbooksArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAutomationAccountDeletedRunbooksResult>("azure-native:automation/v20241023:listAutomationAccountDeletedRunbooks", args ?? new ListAutomationAccountDeletedRunbooksArgs(), options.WithDefaults());
