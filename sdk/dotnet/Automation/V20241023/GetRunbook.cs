...
namespace Pulumi.AzureNative.Automation.V20241023
{
    public static class GetRunbook
    {
        ...
        public static Task<GetRunbookResult> InvokeAsync(GetRunbookArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRunbookResult>("azure-native:automation/v20241023:getRunbook", args ?? new GetRunbookArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve the runbook identified by runbook name.
        /// </summary>
        public static Output<GetRunbookResult> Invoke(GetRunbookInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRunbookResult>("azure-native:automation/v20241023:getRunbook", args ?? new GetRunbookInvokeArgs(), options.WithDefaults());
