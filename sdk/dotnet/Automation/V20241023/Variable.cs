...
namespace Pulumi.AzureNative.Automation.V20241023
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20241023:Variable")]
    public partial class Variable : global::Pulumi.CustomResource
    {
        ...
        public Variable(string name, VariableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20241023:Variable", name, args ?? new VariableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Variable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20241023:Variable", name, null, MakeResourceOptions(options, id))
        {
        }
