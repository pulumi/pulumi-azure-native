...
namespace Pulumi.AzureNative.Automation.V20241023
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20241023:AutomationAccount")]
    public partial class AutomationAccount : global::Pulumi.CustomResource
    {
        ...
        public AutomationAccount(string name, AutomationAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20241023:AutomationAccount", name, args ?? new AutomationAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutomationAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20241023:AutomationAccount", name, null, MakeResourceOptions(options, id))
        {
        }
