...
namespace Pulumi.AzureNative.Automation.V20241023
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20241023:Webhook")]
    public partial class Webhook : global::Pulumi.CustomResource
    {
        ...
        public Webhook(string name, WebhookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20241023:Webhook", name, args ?? new WebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20241023:Webhook", name, null, MakeResourceOptions(options, id))
        {
        }
