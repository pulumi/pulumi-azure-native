...
namespace Pulumi.AzureNative.Automation.V20241023
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20241023:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20241023:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20241023:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
