...
namespace Pulumi.AzureNative.Automation.V20241023
{
    public static class GetDscConfiguration
    {
        ...
        public static Task<GetDscConfigurationResult> InvokeAsync(GetDscConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDscConfigurationResult>("azure-native:automation/v20241023:getDscConfiguration", args ?? new GetDscConfigurationArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve the configuration identified by configuration name.
        /// </summary>
        public static Output<GetDscConfigurationResult> Invoke(GetDscConfigurationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDscConfigurationResult>("azure-native:automation/v20241023:getDscConfiguration", args ?? new GetDscConfigurationInvokeArgs(), options.WithDefaults());
    }
