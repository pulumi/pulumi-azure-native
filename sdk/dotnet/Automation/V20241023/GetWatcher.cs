...
namespace Pulumi.AzureNative.Automation.V20241023
{
    public static class GetWatcher
    {
        ...
        public static Task<GetWatcherResult> InvokeAsync(GetWatcherArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWatcherResult>("azure-native:automation/v20241023:getWatcher", args ?? new GetWatcherArgs(), options.WithDefaults());
