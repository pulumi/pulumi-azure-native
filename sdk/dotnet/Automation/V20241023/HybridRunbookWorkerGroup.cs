...
namespace Pulumi.AzureNative.Automation.V20241023
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20241023:HybridRunbookWorkerGroup")]
    public partial class HybridRunbookWorkerGroup : global::Pulumi.CustomResource
    {
        ...
        public HybridRunbookWorkerGroup(string name, HybridRunbookWorkerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20241023:HybridRunbookWorkerGroup", name, args ?? new HybridRunbookWorkerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridRunbookWorkerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20241023:HybridRunbookWorkerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
