...
namespace Pulumi.AzureNative.Automation.V20241023
{
    public static class GetRuntimeEnvironment
    {
        ...
        public static Task<GetRuntimeEnvironmentResult> InvokeAsync(GetRuntimeEnvironmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRuntimeEnvironmentResult>("azure-native:automation/v20241023:getRuntimeEnvironment", args ?? new GetRuntimeEnvironmentArgs(), options.WithDefaults());
