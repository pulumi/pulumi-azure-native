...
namespace Pulumi.AzureNative.Automation.V20241023
{
    public static class GetModule
    {
        ...
        public static Task<GetModuleResult> InvokeAsync(GetModuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetModuleResult>("azure-native:automation/v20241023:getModule", args ?? new GetModuleArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve the module identified by module name.
        /// </summary>
        public static Output<GetModuleResult> Invoke(GetModuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetModuleResult>("azure-native:automation/v20241023:getModule", args ?? new GetModuleInvokeArgs(), options.WithDefaults());
