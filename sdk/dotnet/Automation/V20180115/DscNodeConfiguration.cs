...
namespace Pulumi.AzureRM.Automation.V20180115
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dscNodeConfiguration = new AzureRM.Automation.V20180115.DscNodeConfiguration("dscNodeConfiguration", new AzureRM.Automation.V20180115.DscNodeConfigurationArgs
    ///         {
    ///             AutomationAccountName = "myAutomationAccount20",
    ///             Configuration = new AzureRM.Automation.V20180115.Inputs.DscConfigurationAssociationPropertyArgs
    ///             {
    ///                 Name = "configName",
    ///             },
    ...
    ///             Source = new AzureRM.Automation.V20180115.Inputs.ContentSourceArgs
    ///             {
    ///                 Hash = new AzureRM.Automation.V20180115.Inputs.ContentHashArgs
    ///                 {
    ///                     Algorithm = "sha256",
    ...
    public partial class DscNodeConfiguration : Pulumi.CustomResource
    {
        ...
        public DscNodeConfiguration(string name, DscNodeConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/v20180115:DscNodeConfiguration", name, args ?? new DscNodeConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DscNodeConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/v20180115:DscNodeConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
