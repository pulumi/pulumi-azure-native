...
namespace Pulumi.AzureNative.Automation.V20170515Preview
{
    ...
    /// {
    ///     var softwareUpdateConfigurationByName = new AzureNative.Automation.V20170515Preview.SoftwareUpdateConfigurationByName("softwareUpdateConfigurationByName", new()
    ///     {
    ///         AutomationAccountName = "myaccount",
    ///         ResourceGroupName = "mygroup",
    ///         ScheduleInfo = new AzureNative.Automation.V20170515Preview.Inputs.SchedulePropertiesArgs
    ///         {
    ///             AdvancedSchedule = new AzureNative.Automation.V20170515Preview.Inputs.AdvancedScheduleArgs
    ///             {
    ///                 WeekDays = new[]
    ///                 {
    ///                     "Monday",
    ...
    ///         Tasks = new AzureNative.Automation.V20170515Preview.Inputs.SoftwareUpdateConfigurationTasksArgs
    ///         {
    ///             PostTask = new AzureNative.Automation.V20170515Preview.Inputs.TaskPropertiesArgs
    ///             {
    ///                 Source = "GetCache",
    ///             },
    ///             PreTask = new AzureNative.Automation.V20170515Preview.Inputs.TaskPropertiesArgs
    ///             {
    ///                 Parameters = 
    ///                 {
    ...
    ///             },
    ///         },
    ///         UpdateConfiguration = new AzureNative.Automation.V20170515Preview.Inputs.UpdateConfigurationArgs
    ///         {
    ...
    ///                 "box2.contoso.com",
    ///             },
    ///             OperatingSystem = AzureNative.Automation.V20170515Preview.OperatingSystemType.Windows,
    ///             Targets = new AzureNative.Automation.V20170515Preview.Inputs.TargetPropertiesArgs
    ///             {
    ///                 AzureQueries = new[]
    ///                 {
    ///                     new AzureNative.Automation.V20170515Preview.Inputs.AzureQueryPropertiesArgs
    ///                     {
    ///                         Locations = new[]
    ///                         {
    ///                             "Japan East",
    ...
    ///                         },
    ///                         TagSettings = new AzureNative.Automation.V20170515Preview.Inputs.TagSettingsPropertiesArgs
    ///                         {
    ///                             FilterOperator = AzureNative.Automation.V20170515Preview.TagOperators.All,
    ///                             Tags = new[]
    ///                             {
    ///                                 
    ///                                 {
    ...
    ///                 NonAzureQueries = new[]
    ///                 {
    ///                     new AzureNative.Automation.V20170515Preview.Inputs.NonAzureQueryPropertiesArgs
    ///                     {
    ...
    ///                 },
    ///             },
    ///             Windows = new AzureNative.Automation.V20170515Preview.Inputs.WindowsPropertiesArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20170515preview:SoftwareUpdateConfigurationByName")]
    public partial class SoftwareUpdateConfigurationByName : global::Pulumi.CustomResource
    {
        ...
        public SoftwareUpdateConfigurationByName(string name, SoftwareUpdateConfigurationByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20170515preview:SoftwareUpdateConfigurationByName", name, args ?? new SoftwareUpdateConfigurationByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SoftwareUpdateConfigurationByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20170515preview:SoftwareUpdateConfigurationByName", name, null, MakeResourceOptions(options, id))
        {
        }
