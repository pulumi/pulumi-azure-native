...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20230515preview:Python3Package")]
    public partial class Python3Package : global::Pulumi.CustomResource
    {
        ...
        public Python3Package(string name, Python3PackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20230515preview:Python3Package", name, args ?? new Python3PackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Python3Package(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20230515preview:Python3Package", name, null, MakeResourceOptions(options, id))
        {
        }
