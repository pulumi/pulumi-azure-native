...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20230515preview:SoftwareUpdateConfigurationByName")]
    public partial class SoftwareUpdateConfigurationByName : global::Pulumi.CustomResource
    {
        ...
        public SoftwareUpdateConfigurationByName(string name, SoftwareUpdateConfigurationByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20230515preview:SoftwareUpdateConfigurationByName", name, args ?? new SoftwareUpdateConfigurationByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SoftwareUpdateConfigurationByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20230515preview:SoftwareUpdateConfigurationByName", name, null, MakeResourceOptions(options, id))
        {
        }
