...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20230515preview:HybridRunbookWorkerGroup")]
    public partial class HybridRunbookWorkerGroup : global::Pulumi.CustomResource
    {
        ...
        public HybridRunbookWorkerGroup(string name, HybridRunbookWorkerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20230515preview:HybridRunbookWorkerGroup", name, args ?? new HybridRunbookWorkerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridRunbookWorkerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20230515preview:HybridRunbookWorkerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
