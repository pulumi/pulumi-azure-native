...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20230515preview:Runbook")]
    public partial class Runbook : global::Pulumi.CustomResource
    {
        ...
        public Runbook(string name, RunbookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20230515preview:Runbook", name, args ?? new RunbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Runbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20230515preview:Runbook", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RunbookArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Automation.V20230515Preview.RunbookTypeEnum> RunbookType { get; set; } = null!;
