...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    public static class GetSchedule
    {
        ...
        public static Task<GetScheduleResult> InvokeAsync(GetScheduleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScheduleResult>("azure-native:automation/v20230515preview:getSchedule", args ?? new GetScheduleArgs(), options.WithDefaults());
