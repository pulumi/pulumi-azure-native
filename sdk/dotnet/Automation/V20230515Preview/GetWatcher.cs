...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    public static class GetWatcher
    {
        ...
        public static Task<GetWatcherResult> InvokeAsync(GetWatcherArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWatcherResult>("azure-native:automation/v20230515preview:getWatcher", args ?? new GetWatcherArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve the watcher identified by watcher name.
        /// </summary>
        public static Output<GetWatcherResult> Invoke(GetWatcherInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWatcherResult>("azure-native:automation/v20230515preview:getWatcher", args ?? new GetWatcherInvokeArgs(), options.WithDefaults());
    }
