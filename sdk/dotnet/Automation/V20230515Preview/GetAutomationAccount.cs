...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    public static class GetAutomationAccount
    {
        ...
        public static Task<GetAutomationAccountResult> InvokeAsync(GetAutomationAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAutomationAccountResult>("azure-native:automation/v20230515preview:getAutomationAccount", args ?? new GetAutomationAccountArgs(), options.WithDefaults());

        /// <summary>
        /// Get information about an Automation Account.
        /// </summary>
        public static Output<GetAutomationAccountResult> Invoke(GetAutomationAccountInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAutomationAccountResult>("azure-native:automation/v20230515preview:getAutomationAccount", args ?? new GetAutomationAccountInvokeArgs(), options.WithDefaults());
    }
