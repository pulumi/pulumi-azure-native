...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    public static class GetPython3Package
    {
        ...
        public static Task<GetPython3PackageResult> InvokeAsync(GetPython3PackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPython3PackageResult>("azure-native:automation/v20230515preview:getPython3Package", args ?? new GetPython3PackageArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve the python 3 package identified by package name.
        /// </summary>
        public static Output<GetPython3PackageResult> Invoke(GetPython3PackageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPython3PackageResult>("azure-native:automation/v20230515preview:getPython3Package", args ?? new GetPython3PackageInvokeArgs(), options.WithDefaults());
    }
