...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    public static class GetVariable
    {
        ...
        public static Task<GetVariableResult> InvokeAsync(GetVariableArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVariableResult>("azure-native:automation/v20230515preview:getVariable", args ?? new GetVariableArgs(), options.WithDefaults());
