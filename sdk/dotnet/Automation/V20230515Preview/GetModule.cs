...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    public static class GetModule
    {
        ...
        public static Task<GetModuleResult> InvokeAsync(GetModuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetModuleResult>("azure-native:automation/v20230515preview:getModule", args ?? new GetModuleArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve the module identified by module name.
        /// </summary>
        public static Output<GetModuleResult> Invoke(GetModuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetModuleResult>("azure-native:automation/v20230515preview:getModule", args ?? new GetModuleInvokeArgs(), options.WithDefaults());
    }
