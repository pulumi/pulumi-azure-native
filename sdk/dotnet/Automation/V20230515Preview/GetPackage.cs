...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    public static class GetPackage
    {
        ...
        public static Task<GetPackageResult> InvokeAsync(GetPackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPackageResult>("azure-native:automation/v20230515preview:getPackage", args ?? new GetPackageArgs(), options.WithDefaults());
