...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20230515preview:ConnectionType")]
    public partial class ConnectionType : global::Pulumi.CustomResource
    {
        ...
        public ConnectionType(string name, ConnectionTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20230515preview:ConnectionType", name, args ?? new ConnectionTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20230515preview:ConnectionType", name, null, MakeResourceOptions(options, id))
        {
        }
