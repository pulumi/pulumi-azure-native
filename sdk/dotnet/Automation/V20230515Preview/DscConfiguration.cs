...
namespace Pulumi.AzureNative.Automation.V20230515Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20230515preview:DscConfiguration")]
    public partial class DscConfiguration : global::Pulumi.CustomResource
    {
        ...
        public DscConfiguration(string name, DscConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20230515preview:DscConfiguration", name, args ?? new DscConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DscConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20230515preview:DscConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
