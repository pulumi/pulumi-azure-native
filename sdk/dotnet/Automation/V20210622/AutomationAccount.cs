...
namespace Pulumi.AzureNative.Automation.V20210622
{
    ...
    public partial class AutomationAccount : Pulumi.CustomResource
    {
        ...
        public AutomationAccount(string name, AutomationAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20210622:AutomationAccount", name, args ?? new AutomationAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutomationAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20210622:AutomationAccount", name, null, MakeResourceOptions(options, id))
        {
        }
