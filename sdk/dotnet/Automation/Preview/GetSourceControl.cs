...
namespace Pulumi.AzureRM.Automation.Preview
{
    public static class GetSourceControl
    {
        public static Task<GetSourceControlResult> InvokeAsync(GetSourceControlArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSourceControlResult>("azurerm:automation/preview:getSourceControl", args ?? new GetSourceControlArgs(), options.WithVersion());
    }
