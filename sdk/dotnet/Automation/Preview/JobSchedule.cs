...
namespace Pulumi.AzureRM.Automation.Preview
{
    ...
    public partial class JobSchedule : Pulumi.CustomResource
    {
        ...
        public JobSchedule(string name, JobScheduleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/preview:JobSchedule", name, args ?? new JobScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/preview:JobSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
