...
namespace Pulumi.AzureRM.Automation.Preview
{
    public static class GetDscConfiguration
    {
        public static Task<GetDscConfigurationResult> InvokeAsync(GetDscConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDscConfigurationResult>("azurerm:automation/preview:getDscConfiguration", args ?? new GetDscConfigurationArgs(), options.WithVersion());
    }
