...
namespace Pulumi.AzureRM.Automation.Preview
{
    ...
    public partial class Module : Pulumi.CustomResource
    {
        ...
        public Module(string name, ModuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/preview:Module", name, args ?? new ModuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Module(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/preview:Module", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:automation/latest:Module"},
