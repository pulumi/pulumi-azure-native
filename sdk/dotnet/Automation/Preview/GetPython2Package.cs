...
namespace Pulumi.AzureRM.Automation.Preview
{
    public static class GetPython2Package
    {
        public static Task<GetPython2PackageResult> InvokeAsync(GetPython2PackageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPython2PackageResult>("azurerm:automation/preview:getPython2Package", args ?? new GetPython2PackageArgs(), options.WithVersion());
    }
