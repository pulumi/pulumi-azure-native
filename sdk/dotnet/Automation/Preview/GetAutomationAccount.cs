...
namespace Pulumi.AzureRM.Automation.Preview
{
    public static class GetAutomationAccount
    {
        public static Task<GetAutomationAccountResult> InvokeAsync(GetAutomationAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAutomationAccountResult>("azurerm:automation/preview:getAutomationAccount", args ?? new GetAutomationAccountArgs(), options.WithVersion());
    }
