...
namespace Pulumi.AzureRM.Automation.Preview
{
    ...
    public partial class DscConfiguration : Pulumi.CustomResource
    {
        ...
        public DscConfiguration(string name, DscConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/preview:DscConfiguration", name, args ?? new DscConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DscConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/preview:DscConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
