...
namespace Pulumi.AzureRM.Automation.Preview
{
    ...
    public partial class ConnectionType : Pulumi.CustomResource
    {
        ...
        public ConnectionType(string name, ConnectionTypeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/preview:ConnectionType", name, args ?? new ConnectionTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/preview:ConnectionType", name, null, MakeResourceOptions(options, id))
        {
        }
