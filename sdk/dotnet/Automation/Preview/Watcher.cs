...
namespace Pulumi.AzureRM.Automation.Preview
{
    ...
    public partial class Watcher : Pulumi.CustomResource
    {
        ...
        public Watcher(string name, WatcherArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/preview:Watcher", name, args ?? new WatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Watcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/preview:Watcher", name, null, MakeResourceOptions(options, id))
        {
        }
