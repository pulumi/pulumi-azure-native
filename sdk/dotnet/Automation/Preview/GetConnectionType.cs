...
namespace Pulumi.AzureRM.Automation.Preview
{
    public static class GetConnectionType
    {
        public static Task<GetConnectionTypeResult> InvokeAsync(GetConnectionTypeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConnectionTypeResult>("azurerm:automation/preview:getConnectionType", args ?? new GetConnectionTypeArgs(), options.WithVersion());
    }
