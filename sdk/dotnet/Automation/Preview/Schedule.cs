...
namespace Pulumi.AzureRM.Automation.Preview
{
    ...
    public partial class Schedule : Pulumi.CustomResource
    {
        ...
        public Schedule(string name, ScheduleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/preview:Schedule", name, args ?? new ScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/preview:Schedule", name, null, MakeResourceOptions(options, id))
        {
        }
