...
namespace Pulumi.AzureRM.Automation
{
    ...
    public partial class AutomationAccount : Pulumi.CustomResource
    {
        ...
        public AutomationAccount(string name, AutomationAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation:AutomationAccount", name, args ?? new AutomationAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutomationAccount(string name, Input<string> id, AutomationAccountState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:automation:AutomationAccount", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AutomationAccount Get(string name, Input<string> id, AutomationAccountState? state = null, CustomResourceOptions? options = null)
        {
            return new AutomationAccount(name, id, state, options);
        }
    }
    ...
    public sealed class AutomationAccountState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Gets or sets the etag of the resource.
        /// </summary>
        ...
        public Input<Inputs.AutomationAccountPropertiesResponseGetArgs> Properties { get; set; } = null!;
