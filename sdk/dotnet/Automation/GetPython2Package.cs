...
namespace Pulumi.AzureNative.Automation
{
    public static class GetPython2Package
    {
        ...
        public static Task<GetPython2PackageResult> InvokeAsync(GetPython2PackageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPython2PackageResult>("azure-native:automation:getPython2Package", args ?? new GetPython2PackageArgs(), options.WithDefaults());
        ...
        public static Output<GetPython2PackageResult> Invoke(GetPython2PackageInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPython2PackageResult>("azure-native:automation:getPython2Package", args ?? new GetPython2PackageInvokeArgs(), options.WithDefaults());
    }
