...
namespace Pulumi.AzureNative.Automation.V20151031
{
    public static class GetRunbook
    {
        ...
        public static Task<GetRunbookResult> InvokeAsync(GetRunbookArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRunbookResult>("azure-native:automation/v20151031:getRunbook", args ?? new GetRunbookArgs(), options.WithVersion());

        /// <summary>
        /// Definition of the runbook type.
        /// </summary>
        public static Output<GetRunbookResult> Invoke(GetRunbookInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRunbookResult>("azure-native:automation/v20151031:getRunbook", args ?? new GetRunbookInvokeArgs(), options.WithVersion());
    }
