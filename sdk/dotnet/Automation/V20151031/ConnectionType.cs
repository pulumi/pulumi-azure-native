...
namespace Pulumi.AzureNative.Automation.V20151031
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:automation/v20151031:ConnectionType is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:ConnectionType to guarantee forwards compatibility.")]
    ...
    public partial class ConnectionType : global::Pulumi.CustomResource
    {
        ...
        public ConnectionType(string name, ConnectionTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20151031:ConnectionType", name, args ?? new ConnectionTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20151031:ConnectionType", name, null, MakeResourceOptions(options, id))
        {
        }
