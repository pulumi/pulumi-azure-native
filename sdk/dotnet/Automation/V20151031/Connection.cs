...
namespace Pulumi.AzureRM.Automation.V20151031
{
    ...
    ///     public MyStack()
    ///     {
    ///         var connection = new AzureRM.Automation.V20151031.Connection("connection", new AzureRM.Automation.V20151031.ConnectionArgs
    ///         {
    ///             AutomationAccountName = "myAutomationAccount28",
    ///             ConnectionName = "mysConnection",
    ///             ConnectionType = new AzureRM.Automation.V20151031.Inputs.ConnectionTypeAssociationPropertyArgs
    ///             {
    ///                 Name = "Azure",
    ///             },
    ...
    public partial class Connection : Pulumi.CustomResource
    {
        ...
        public Connection(string name, ConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/v20151031:Connection", name, args ?? new ConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/v20151031:Connection", name, null, MakeResourceOptions(options, id))
        {
        }
