...
namespace Pulumi.AzureNative.Automation.V20151031
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20151031:Connection")]
    public partial class Connection : Pulumi.CustomResource
    {
        ...
        public Connection(string name, ConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20151031:Connection", name, args ?? new ConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20151031:Connection", name, null, MakeResourceOptions(options, id))
        {
        }
