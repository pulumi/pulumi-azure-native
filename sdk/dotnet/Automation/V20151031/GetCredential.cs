...
namespace Pulumi.AzureNative.Automation.V20151031
{
    public static class GetCredential
    {
        ...
        public static Task<GetCredentialResult> InvokeAsync(GetCredentialArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCredentialResult>("azure-native:automation/v20151031:getCredential", args ?? new GetCredentialArgs(), options.WithDefaults());

        /// <summary>
        /// Definition of the credential.
        /// </summary>
        public static Output<GetCredentialResult> Invoke(GetCredentialInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCredentialResult>("azure-native:automation/v20151031:getCredential", args ?? new GetCredentialInvokeArgs(), options.WithDefaults());
    }
