...
namespace Pulumi.AzureNative.Automation.V20151031
{
    ...
    [AzureNativeResourceType("azure-native:automation/v20151031:Watcher")]
    public partial class Watcher : global::Pulumi.CustomResource
    {
        ...
        public Watcher(string name, WatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20151031:Watcher", name, args ?? new WatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Watcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20151031:Watcher", name, null, MakeResourceOptions(options, id))
        {
        }
