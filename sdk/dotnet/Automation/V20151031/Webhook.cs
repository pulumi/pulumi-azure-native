...
namespace Pulumi.AzureRM.Automation.V20151031
{
    ...
    ///     public MyStack()
    ///     {
    ///         var webhook = new AzureRM.Automation.V20151031.Webhook("webhook", new AzureRM.Automation.V20151031.WebhookArgs
    ///         {
    ...
    ///             Runbook = new AzureRM.Automation.V20151031.Inputs.RunbookAssociationPropertyArgs
    ///             {
    ///                 Name = "TestRunbook",
    ///             },
    ...
    public partial class Webhook : Pulumi.CustomResource
    {
        ...
        public Webhook(string name, WebhookArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/v20151031:Webhook", name, args ?? new WebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/v20151031:Webhook", name, null, MakeResourceOptions(options, id))
        {
        }
