...
namespace Pulumi.AzureRM.Automation.V20151031
{
    ...
    ///     public MyStack()
    ///     {
    ///         var schedule = new AzureRM.Automation.V20151031.Schedule("schedule", new AzureRM.Automation.V20151031.ScheduleArgs
    ///         {
    ///             AdvancedSchedule = ,
    ...
    public partial class Schedule : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:automation/latest:Schedule"},
                },
            };
