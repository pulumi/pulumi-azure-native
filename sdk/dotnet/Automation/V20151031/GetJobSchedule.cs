...
{
    [Obsolete(@"azure-native:automation/v20151031:JobSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:JobSchedule to guarantee forwards compatibility.")]
    public static class GetJobSchedule
    {
        ...
        public static Task<GetJobScheduleResult> InvokeAsync(GetJobScheduleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobScheduleResult>("azure-native:automation/v20151031:getJobSchedule", args ?? new GetJobScheduleArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve the job schedule identified by job schedule name.
        /// </summary>
        public static Output<GetJobScheduleResult> Invoke(GetJobScheduleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobScheduleResult>("azure-native:automation/v20151031:getJobSchedule", args ?? new GetJobScheduleInvokeArgs(), options.WithDefaults());
    }
