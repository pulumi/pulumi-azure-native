...
namespace Pulumi.AzureNative.Automation.V20151031
{
    public static class GetConnectionType
    {
        ...
        public static Task<GetConnectionTypeResult> InvokeAsync(GetConnectionTypeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConnectionTypeResult>("azure-native:automation/v20151031:getConnectionType", args ?? new GetConnectionTypeArgs(), options.WithVersion());

        /// <summary>
        /// Definition of the connection type.
        /// </summary>
        public static Output<GetConnectionTypeResult> Invoke(GetConnectionTypeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetConnectionTypeResult>("azure-native:automation/v20151031:getConnectionType", args ?? new GetConnectionTypeInvokeArgs(), options.WithVersion());
    }
