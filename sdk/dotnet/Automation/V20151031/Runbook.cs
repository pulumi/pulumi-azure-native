...
namespace Pulumi.AzureNative.Automation.V20151031
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:automation/v20151031:Runbook")]
    public partial class Runbook : global::Pulumi.CustomResource
    {
        ...
        public Runbook(string name, RunbookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20151031:Runbook", name, args ?? new RunbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Runbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20151031:Runbook", name, null, MakeResourceOptions(options, id))
        {
        }
