...
namespace Pulumi.AzureRM.Automation.V20151031
{
    ...
    public partial class Module : Pulumi.CustomResource
    {
        ...
        public Module(string name, ModuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/v20151031:Module", name, args ?? new ModuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Module(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/v20151031:Module", name, null, MakeResourceOptions(options, id))
        {
        }
