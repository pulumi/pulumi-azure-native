...
namespace Pulumi.AzureNative.Automation.V20151031
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:automation/v20151031:Variable is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Variable to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:automation/v20151031:Variable")]
    public partial class Variable : global::Pulumi.CustomResource
    {
        ...
        public Variable(string name, VariableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20151031:Variable", name, args ?? new VariableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Variable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automation/v20151031:Variable", name, null, MakeResourceOptions(options, id))
        {
        }
