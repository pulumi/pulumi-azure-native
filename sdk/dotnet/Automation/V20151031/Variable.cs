...
namespace Pulumi.AzureRM.Automation.V20151031
{
    ...
    ///     public MyStack()
    ///     {
    ///         var variable = new AzureRM.Automation.V20151031.Variable("variable", new AzureRM.Automation.V20151031.VariableArgs
    ///         {
    ...
    public partial class Variable : Pulumi.CustomResource
    {
        ...
        public Variable(string name, VariableArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automation/v20151031:Variable", name, args ?? new VariableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Variable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automation/v20151031:Variable", name, null, MakeResourceOptions(options, id))
        {
        }
