...
namespace Pulumi.AzureNative.Logz.V20220101Preview
{
    ...
    /// {
    ///     var subAccountTagRule = new AzureNative.Logz.V20220101Preview.SubAccountTagRule("subAccountTagRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:logz/v20220101preview:SubAccountTagRule")]
    public partial class SubAccountTagRule : global::Pulumi.CustomResource
    {
        ...
        public SubAccountTagRule(string name, SubAccountTagRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20220101preview:SubAccountTagRule", name, args ?? new SubAccountTagRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubAccountTagRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20220101preview:SubAccountTagRule", name, null, MakeResourceOptions(options, id))
        {
        }
