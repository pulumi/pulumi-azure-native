...
namespace Pulumi.AzureNative.Logz.V20220101Preview
{
    ...
    public partial class MetricsSource : global::Pulumi.CustomResource
    {
        ...
        public MetricsSource(string name, MetricsSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20220101preview:MetricsSource", name, args ?? new MetricsSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetricsSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20220101preview:MetricsSource", name, null, MakeResourceOptions(options, id))
        {
        }
