...
namespace Pulumi.AzureNative.Logz.V20220101Preview
{
    ...
    /// {
    ///     var subAccount = new AzureNative.Logz.V20220101Preview.SubAccount("subAccount", new()
    ///     {
    ...
    public partial class SubAccount : global::Pulumi.CustomResource
    {
        ...
        public SubAccount(string name, SubAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20220101preview:SubAccount", name, args ?? new SubAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20220101preview:SubAccount", name, null, MakeResourceOptions(options, id))
        {
        }
