...
namespace Pulumi.AzureNative.Logz.V20220101Preview
{
    ...
    /// {
    ///     var monitor = new AzureNative.Logz.V20220101Preview.Monitor("monitor", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:logz/v20220101preview:Monitor")]
    public partial class Monitor : global::Pulumi.CustomResource
    {
        ...
        public Monitor(string name, MonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20220101preview:Monitor", name, args ?? new MonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Monitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20220101preview:Monitor", name, null, MakeResourceOptions(options, id))
        {
        }
