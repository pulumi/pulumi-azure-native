...
namespace Pulumi.AzureNative.Logz.V20220101Preview
{
    public static class ListSubAccountVMHosts
    {
        ...
        public static Task<ListSubAccountVMHostsResult> InvokeAsync(ListSubAccountVMHostsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListSubAccountVMHostsResult>("azure-native:logz/v20220101preview:listSubAccountVMHosts", args ?? new ListSubAccountVMHostsArgs(), options.WithDefaults());

        /// <summary>
        /// Response of a list VM Host Update Operation.
        /// </summary>
        public static Output<ListSubAccountVMHostsResult> Invoke(ListSubAccountVMHostsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListSubAccountVMHostsResult>("azure-native:logz/v20220101preview:listSubAccountVMHosts", args ?? new ListSubAccountVMHostsInvokeArgs(), options.WithDefaults());
    }
