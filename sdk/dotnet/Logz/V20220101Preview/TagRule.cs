...
namespace Pulumi.AzureNative.Logz.V20220101Preview
{
    ...
    /// {
    ///     var tagRule = new AzureNative.Logz.V20220101Preview.TagRule("tagRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:logz/v20220101preview:TagRule")]
    public partial class TagRule : global::Pulumi.CustomResource
    {
        ...
        public TagRule(string name, TagRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20220101preview:TagRule", name, args ?? new TagRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20220101preview:TagRule", name, null, MakeResourceOptions(options, id))
        {
        }
