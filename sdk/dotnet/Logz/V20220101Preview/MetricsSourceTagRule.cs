...
namespace Pulumi.AzureNative.Logz.V20220101Preview
{
    ...
    /// {
    ///     var metricsSourceTagRule = new AzureNative.Logz.V20220101Preview.MetricsSourceTagRule("metricsSourceTagRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:logz/v20220101preview:MetricsSourceTagRule")]
    public partial class MetricsSourceTagRule : global::Pulumi.CustomResource
    {
        ...
        public MetricsSourceTagRule(string name, MetricsSourceTagRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20220101preview:MetricsSourceTagRule", name, args ?? new MetricsSourceTagRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetricsSourceTagRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20220101preview:MetricsSourceTagRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:logz:MetricsSourceTagRule"},
                },
            };
