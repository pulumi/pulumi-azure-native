...
namespace Pulumi.AzureNative.Logz
{
    ...
    public partial class MetricsSource : global::Pulumi.CustomResource
    {
        ...
        public MetricsSource(string name, MetricsSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz:MetricsSource", name, args ?? new MetricsSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetricsSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz:MetricsSource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MetricsSource Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class MetricsSourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("metricsSourceName")]
        public Input<string>? MetricsSourceName { get; set; }
