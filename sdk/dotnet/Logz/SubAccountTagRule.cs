...
namespace Pulumi.AzureNative.Logz
{
    ...
    public partial class SubAccountTagRule : global::Pulumi.CustomResource
    {
        ...
        public SubAccountTagRule(string name, SubAccountTagRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz:SubAccountTagRule", name, args ?? new SubAccountTagRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubAccountTagRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz:SubAccountTagRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:logz/v20201001preview:SubAccountTagRule"},
