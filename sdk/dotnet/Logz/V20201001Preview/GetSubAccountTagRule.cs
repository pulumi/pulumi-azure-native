...
namespace Pulumi.AzureNative.Logz.V20201001Preview
{
    public static class GetSubAccountTagRule
    {
        ...
        public static Task<GetSubAccountTagRuleResult> InvokeAsync(GetSubAccountTagRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSubAccountTagRuleResult>("azure-native:logz/v20201001preview:getSubAccountTagRule", args ?? new GetSubAccountTagRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Capture logs and metrics of Azure resources based on ARM tags.
        /// </summary>
        public static Output<GetSubAccountTagRuleResult> Invoke(GetSubAccountTagRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSubAccountTagRuleResult>("azure-native:logz/v20201001preview:getSubAccountTagRule", args ?? new GetSubAccountTagRuleInvokeArgs(), options.WithDefaults());
    }
