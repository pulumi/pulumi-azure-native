...
namespace Pulumi.AzureNative.Logz.V20201001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:logz/v20201001preview:SubAccountTagRule is being removed in the next major version of this provider. Upgrade to at least azure-native:logz/v20220101preview:SubAccountTagRule to guarantee forwards compatibility.")]
    ...
    public partial class SubAccountTagRule : global::Pulumi.CustomResource
    {
        ...
        public SubAccountTagRule(string name, SubAccountTagRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20201001preview:SubAccountTagRule", name, args ?? new SubAccountTagRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubAccountTagRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20201001preview:SubAccountTagRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SubAccountTagRule Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
