...
namespace Pulumi.AzureNative.Logz.V20201001Preview
{
    ...
    public partial class SubAccount : Pulumi.CustomResource
    {
        ...
        public SubAccount(string name, SubAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20201001preview:SubAccount", name, args ?? new SubAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20201001preview:SubAccount", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:logz/v20201001preview:SubAccount"},
                    new Pulumi.Alias { Type = "azure-native:logz:SubAccount"},
                    new Pulumi.Alias { Type = "azure-nextgen:logz:SubAccount"},
                    new Pulumi.Alias { Type = "azure-native:logz/v20201001:SubAccount"},
                    new Pulumi.Alias { Type = "azure-nextgen:logz/v20201001:SubAccount"},
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SubAccount Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class SubAccountArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<string>? SubAccountName { get; set; }
