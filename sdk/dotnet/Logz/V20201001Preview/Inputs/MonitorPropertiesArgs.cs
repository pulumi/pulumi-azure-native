...
namespace Pulumi.AzureNative.Logz.V20201001Preview.Inputs
{
    ...
    public sealed class MonitorPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Logz.V20201001Preview.MarketplaceSubscriptionStatus>? MarketplaceSubscriptionStatus { get; set; }

        /// <summary>
        /// Flag specifying if the resource monitoring is enabled or disabled.
        /// </summary>
        [Input("monitoringStatus")]
        public InputUnion<string, Pulumi.AzureNative.Logz.V20201001Preview.MonitoringStatus>? MonitoringStatus { get; set; }
