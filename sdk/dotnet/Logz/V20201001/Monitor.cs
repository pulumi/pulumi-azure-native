...
namespace Pulumi.AzureNative.Logz.V20201001
{
    ...
    /// {
    ///     var monitor = new AzureNative.Logz.V20201001.Monitor("monitor", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:logz/v20201001:Monitor myMonitor /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/monitors/myMonitor 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:logz/v20201001:Monitor")]
    public partial class Monitor : global::Pulumi.CustomResource
    {
        ...
        public Monitor(string name, MonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20201001:Monitor", name, args ?? new MonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Monitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20201001:Monitor", name, null, MakeResourceOptions(options, id))
        {
        }
