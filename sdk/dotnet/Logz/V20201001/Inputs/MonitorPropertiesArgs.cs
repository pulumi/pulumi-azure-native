...
namespace Pulumi.AzureNative.Logz.V20201001.Inputs
{
    ...
    public sealed class MonitorPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Logz.V20201001.MarketplaceSubscriptionStatus>? MarketplaceSubscriptionStatus { get; set; }

        /// <summary>
        /// Flag specifying if the resource monitoring is enabled or disabled.
        /// </summary>
        [Input("monitoringStatus")]
        public InputUnion<string, Pulumi.AzureNative.Logz.V20201001.MonitoringStatus>? MonitoringStatus { get; set; }
