...
{
    [Obsolete(@"azure-native:logz/v20201001:SubAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:logz/v20220101preview:SubAccount to guarantee forwards compatibility.")]
    ...
    public partial class SubAccount : global::Pulumi.CustomResource
    {
        ...
        public SubAccount(string name, SubAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20201001:SubAccount", name, args ?? new SubAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20201001:SubAccount", name, null, MakeResourceOptions(options, id))
        {
        }
