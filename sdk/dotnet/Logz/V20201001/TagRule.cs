...
namespace Pulumi.AzureNative.Logz.V20201001
{
    ...
    public partial class TagRule : global::Pulumi.CustomResource
    {
        ...
        public TagRule(string name, TagRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20201001:TagRule", name, args ?? new TagRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz/v20201001:TagRule", name, null, MakeResourceOptions(options, id))
        {
        }
