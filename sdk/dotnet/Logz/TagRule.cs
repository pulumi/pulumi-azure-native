...
namespace Pulumi.AzureNative.Logz
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:logz:TagRule")]
    public partial class TagRule : global::Pulumi.CustomResource
    {
        ...
        public TagRule(string name, TagRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logz:TagRule", name, args ?? new TagRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logz:TagRule", name, null, MakeResourceOptions(options, id))
        {
        }
