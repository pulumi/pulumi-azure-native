...
namespace Pulumi.AzureNative.AzureSphere.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azuresphere/v20240401:Device")]
    public partial class Device : global::Pulumi.CustomResource
    {
        ...
        public Device(string name, DeviceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuresphere/v20240401:Device", name, args ?? new DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Device(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuresphere/v20240401:Device", name, null, MakeResourceOptions(options, id))
        {
        }
