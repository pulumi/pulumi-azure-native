...
namespace Pulumi.AzureNative.AzureSphere.V20240401
{
    public static class GetProduct
    {
        ...
        public static Task<GetProductResult> InvokeAsync(GetProductArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProductResult>("azure-native:azuresphere/v20240401:getProduct", args ?? new GetProductArgs(), options.WithDefaults());
