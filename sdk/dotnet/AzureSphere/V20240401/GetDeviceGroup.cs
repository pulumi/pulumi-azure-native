...
namespace Pulumi.AzureNative.AzureSphere.V20240401
{
    public static class GetDeviceGroup
    {
        ...
        public static Task<GetDeviceGroupResult> InvokeAsync(GetDeviceGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDeviceGroupResult>("azure-native:azuresphere/v20240401:getDeviceGroup", args ?? new GetDeviceGroupArgs(), options.WithDefaults());
