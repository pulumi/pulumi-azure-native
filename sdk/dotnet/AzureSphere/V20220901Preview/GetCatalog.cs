...
namespace Pulumi.AzureNative.AzureSphere.V20220901Preview
{
    public static class GetCatalog
    {
        ...
        public static Task<GetCatalogResult> InvokeAsync(GetCatalogArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCatalogResult>("azure-native:azuresphere/v20220901preview:getCatalog", args ?? new GetCatalogArgs(), options.WithDefaults());
