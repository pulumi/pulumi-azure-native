...
namespace Pulumi.AzureNative.AzureSphere.V20220901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azuresphere/v20220901preview:Image")]
    public partial class Image : global::Pulumi.CustomResource
    {
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuresphere/v20220901preview:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuresphere/v20220901preview:Image", name, null, MakeResourceOptions(options, id))
        {
        }
