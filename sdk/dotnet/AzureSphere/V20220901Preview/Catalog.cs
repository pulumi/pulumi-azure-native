...
namespace Pulumi.AzureNative.AzureSphere.V20220901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azuresphere/v20220901preview:Catalog")]
    public partial class Catalog : global::Pulumi.CustomResource
    {
        ...
        public Catalog(string name, CatalogArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuresphere/v20220901preview:Catalog", name, args ?? new CatalogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Catalog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuresphere/v20220901preview:Catalog", name, null, MakeResourceOptions(options, id))
        {
        }
