...
namespace Pulumi.AzureNative.AzureSphere.V20220901Preview
{
    public static class GetDeviceGroup
    {
        ...
        public static Task<GetDeviceGroupResult> InvokeAsync(GetDeviceGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDeviceGroupResult>("azure-native:azuresphere/v20220901preview:getDeviceGroup", args ?? new GetDeviceGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Get a DeviceGroup. '.default' and '.unassigned' are system defined values and cannot be used for product or device group name.
        /// </summary>
        public static Output<GetDeviceGroupResult> Invoke(GetDeviceGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDeviceGroupResult>("azure-native:azuresphere/v20220901preview:getDeviceGroup", args ?? new GetDeviceGroupInvokeArgs(), options.WithDefaults());
    }
