...
namespace Pulumi.AzureNative.AzureSphere.V20220901Preview
{
    public static class ListCatalogDeviceGroups
    {
        ...
        public static Task<ListCatalogDeviceGroupsResult> InvokeAsync(ListCatalogDeviceGroupsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListCatalogDeviceGroupsResult>("azure-native:azuresphere/v20220901preview:listCatalogDeviceGroups", args ?? new ListCatalogDeviceGroupsArgs(), options.WithDefaults());
