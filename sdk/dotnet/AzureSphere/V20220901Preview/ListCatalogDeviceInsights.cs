...
namespace Pulumi.AzureNative.AzureSphere.V20220901Preview
{
    public static class ListCatalogDeviceInsights
    {
        ...
        public static Task<ListCatalogDeviceInsightsResult> InvokeAsync(ListCatalogDeviceInsightsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListCatalogDeviceInsightsResult>("azure-native:azuresphere/v20220901preview:listCatalogDeviceInsights", args ?? new ListCatalogDeviceInsightsArgs(), options.WithDefaults());
