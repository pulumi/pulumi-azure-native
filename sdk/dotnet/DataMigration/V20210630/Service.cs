...
namespace Pulumi.AzureNative.DataMigration.V20210630
{
    ...
    /// {
    ///     var service = new AzureNative.DataMigration.V20210630.Service("service", new()
    ///     {
    ///         GroupName = "DmsSdkRg",
    ///         Location = "southcentralus",
    ///         ServiceName = "DmsSdkService",
    ///         Sku = new AzureNative.DataMigration.V20210630.Inputs.ServiceSkuArgs
    ///         {
    ///             Name = "Basic_1vCore",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datamigration/v20210630:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20210630:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20210630:Service", name, null, MakeResourceOptions(options, id))
        {
        }
