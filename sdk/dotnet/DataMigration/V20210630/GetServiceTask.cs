...
namespace Pulumi.AzureNative.DataMigration.V20210630
{
    public static class GetServiceTask
    {
        ...
        public static Task<GetServiceTaskResult> InvokeAsync(GetServiceTaskArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceTaskResult>("azure-native:datamigration/v20210630:getServiceTask", args ?? new GetServiceTaskArgs(), options.WithVersion());

        /// <summary>
        /// A task resource
        /// </summary>
        public static Output<GetServiceTaskResult> Invoke(GetServiceTaskInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceTaskResult>("azure-native:datamigration/v20210630:getServiceTask", args ?? new GetServiceTaskInvokeArgs(), options.WithVersion());
    }
