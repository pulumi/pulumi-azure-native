...
namespace Pulumi.AzureNative.DataMigration.V20210630
{
    ...
    public partial class ServiceTask : Pulumi.CustomResource
    {
        ...
        public ServiceTask(string name, ServiceTaskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20210630:ServiceTask", name, args ?? new ServiceTaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceTask(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20210630:ServiceTask", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:datamigration/v20210630:ServiceTask"},
