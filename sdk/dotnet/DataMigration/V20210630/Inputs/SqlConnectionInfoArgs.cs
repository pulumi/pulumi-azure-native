...
namespace Pulumi.AzureNative.DataMigration.V20210630.Inputs
{
    ...
    public sealed class SqlConnectionInfoArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataMigration.V20210630.AuthenticationType>? Authentication { get; set; }
        ...
        /// </summary>
        [Input("platform")]
        public InputUnion<string, Pulumi.AzureNative.DataMigration.V20210630.SqlSourcePlatform>? Platform { get; set; }
