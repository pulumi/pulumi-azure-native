...
namespace Pulumi.AzureNative.DataMigration.V20210630
{
    ...
    /// A task resource
    /// </summary>
    [AzureNativeResourceType("azure-native:datamigration/v20210630:Task")]
    public partial class Task : Pulumi.CustomResource
    {
        ...
        public Task(string name, TaskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20210630:Task", name, args ?? new TaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Task(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20210630:Task", name, null, MakeResourceOptions(options, id))
        {
        }
