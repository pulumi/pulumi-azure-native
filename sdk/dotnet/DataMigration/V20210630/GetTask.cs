...
namespace Pulumi.AzureNative.DataMigration.V20210630
{
    public static class GetTask
    {
        ...
        public static Task<GetTaskResult> InvokeAsync(GetTaskArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTaskResult>("azure-native:datamigration/v20210630:getTask", args ?? new GetTaskArgs(), options.WithVersion());

        /// <summary>
        /// A task resource
        /// </summary>
        public static Output<GetTaskResult> Invoke(GetTaskInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTaskResult>("azure-native:datamigration/v20210630:getTask", args ?? new GetTaskInvokeArgs(), options.WithVersion());
    }
