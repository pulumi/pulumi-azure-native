...
namespace Pulumi.AzureNative.DataMigration.V20220130Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:datamigration/v20220130preview:SqlMigrationService")]
    public partial class SqlMigrationService : global::Pulumi.CustomResource
    {
        ...
        public SqlMigrationService(string name, SqlMigrationServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20220130preview:SqlMigrationService", name, args ?? new SqlMigrationServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlMigrationService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20220130preview:SqlMigrationService", name, null, MakeResourceOptions(options, id))
        {
        }
