...
namespace Pulumi.AzureNative.DataMigration.V20220130Preview
{
    ...
    /// A task resource
    /// </summary>
    [Obsolete(@"azure-native:datamigration/v20220130preview:Task is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:Task to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:datamigration/v20220130preview:Task")]
    public partial class Task : global::Pulumi.CustomResource
    {
        ...
        public Task(string name, TaskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20220130preview:Task", name, args ?? new TaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Task(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20220130preview:Task", name, null, MakeResourceOptions(options, id))
        {
        }
