...
namespace Pulumi.AzureNative.DataMigration.V20180419
{
    ...
    /// A project resource
    /// </summary>
    [Obsolete(@"azure-native:datamigration/v20180419:Project is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20210630:Project to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:datamigration/v20180419:Project")]
    public partial class Project : global::Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20180419:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20180419:Project", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProjectArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataMigration.V20180419.ProjectSourcePlatform> SourcePlatform { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataMigration.V20180419.ProjectTargetPlatform> TargetPlatform { get; set; } = null!;
