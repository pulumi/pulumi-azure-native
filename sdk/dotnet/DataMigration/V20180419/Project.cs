...
namespace Pulumi.AzureRM.DataMigration.V20180419
{
    ...
    ///     public MyStack()
    ///     {
    ///         var project = new AzureRM.DataMigration.V20180419.Project("project", new AzureRM.DataMigration.V20180419.ProjectArgs
    ///         {
    ///             GroupName = "DmsSdkRg",
    ...
    public partial class Project : Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/v20180419:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/v20180419:Project", name, null, MakeResourceOptions(options, id))
        {
        }
