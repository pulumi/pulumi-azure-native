...
namespace Pulumi.AzureNextGen.DataMigration.V20180419
{
    ...
    /// A task resource
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datamigration/v20180419:Task")]
    public partial class Task : Pulumi.CustomResource
    {
        ...
        public Task(string name, TaskArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datamigration/v20180419:Task", name, args ?? new TaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Task(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datamigration/v20180419:Task", name, null, MakeResourceOptions(options, id))
        {
        }
