...
namespace Pulumi.AzureNextGen.DataMigration.V20180419.Outputs
{
    ...
    [OutputType]
    public sealed class ExecutionStatisticsInvokeResponseResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableDictionary<string, Outputs.WaitStatisticsInvokeResponseResult>? WaitStats;

        [OutputConstructor]
        private ExecutionStatisticsInvokeResponseResult(
            double cpuTimeMs,
            ...
            ImmutableDictionary<string, Outputs.WaitStatisticsInvokeResponseResult>? waitStats)
        {
            CpuTimeMs = cpuTimeMs;
