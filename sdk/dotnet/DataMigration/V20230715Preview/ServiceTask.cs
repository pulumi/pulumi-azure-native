...
namespace Pulumi.AzureNative.DataMigration.V20230715Preview
{
    ...
    /// A task resource
    /// </summary>
    [AzureNativeResourceType("azure-native:datamigration/v20230715preview:ServiceTask")]
    public partial class ServiceTask : global::Pulumi.CustomResource
    {
        ...
        public ServiceTask(string name, ServiceTaskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20230715preview:ServiceTask", name, args ?? new ServiceTaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceTask(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20230715preview:ServiceTask", name, null, MakeResourceOptions(options, id))
        {
        }
