...
namespace Pulumi.AzureNative.DataMigration.V20230715Preview.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ConnectToMongoDbTaskPropertiesResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.MongoDbConnectionInfoResponse? Input;
        /// <summary>
        /// An array containing a single MongoDbClusterInfo object
        /// </summary>
        public readonly ImmutableArray<Outputs.MongoDbClusterInfoResponse> Output;
        /// <summary>
        ...
        [OutputConstructor]
        private ConnectToMongoDbTaskPropertiesResponse(
            ...
            Outputs.MongoDbConnectionInfoResponse? input,

            ImmutableArray<Outputs.MongoDbClusterInfoResponse> output,
