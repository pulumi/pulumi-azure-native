...
namespace Pulumi.AzureNative.DataMigration.V20230715Preview
{
    public static class GetDatabaseMigrationsMongoToCosmosDbvCoreMongo
    {
        ...
        public static Task<GetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult> InvokeAsync(GetDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult>("azure-native:datamigration/v20230715preview:getDatabaseMigrationsMongoToCosmosDbvCoreMongo", args ?? new GetDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs(), options.WithDefaults());
