...
namespace Pulumi.AzureNative.DataMigration.V20230715Preview
{
    public static class GetDatabaseMigrationsSqlDb
    {
        ...
        public static Task<GetDatabaseMigrationsSqlDbResult> InvokeAsync(GetDatabaseMigrationsSqlDbArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseMigrationsSqlDbResult>("azure-native:datamigration/v20230715preview:getDatabaseMigrationsSqlDb", args ?? new GetDatabaseMigrationsSqlDbArgs(), options.WithDefaults());
        ...
        public static Output<GetDatabaseMigrationsSqlDbResult> Invoke(GetDatabaseMigrationsSqlDbInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDatabaseMigrationsSqlDbResult>("azure-native:datamigration/v20230715preview:getDatabaseMigrationsSqlDb", args ?? new GetDatabaseMigrationsSqlDbInvokeArgs(), options.WithDefaults());
    }
