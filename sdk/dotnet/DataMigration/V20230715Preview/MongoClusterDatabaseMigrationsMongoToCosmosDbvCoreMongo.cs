...
namespace Pulumi.AzureNative.DataMigration.V20230715Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:datamigration/v20230715preview:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo")]
    public partial class MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo : global::Pulumi.CustomResource
    {
        ...
        public MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo(string name, MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20230715preview:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        ...
        private MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20230715preview:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo", name, null, MakeResourceOptions(options, id))
        {
        }
