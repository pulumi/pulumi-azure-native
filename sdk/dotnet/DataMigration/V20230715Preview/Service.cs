...
namespace Pulumi.AzureNative.DataMigration.V20230715Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:datamigration/v20230715preview:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20230715preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20230715preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
