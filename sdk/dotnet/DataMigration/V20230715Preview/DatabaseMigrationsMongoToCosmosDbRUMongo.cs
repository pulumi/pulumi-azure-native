...
namespace Pulumi.AzureNative.DataMigration.V20230715Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbRUMongo")]
    public partial class DatabaseMigrationsMongoToCosmosDbRUMongo : global::Pulumi.CustomResource
    {
        ...
        public DatabaseMigrationsMongoToCosmosDbRUMongo(string name, DatabaseMigrationsMongoToCosmosDbRUMongoArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbRUMongo", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseMigrationsMongoToCosmosDbRUMongo(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbRUMongo", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:datamigration:DatabaseMigrationsMongoToCosmosDbRUMongo"},
                },
            };
