...
namespace Pulumi.AzureNative.DataMigration.V20230715Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:datamigration/v20230715preview:DatabaseMigrationsSqlDb")]
    public partial class DatabaseMigrationsSqlDb : global::Pulumi.CustomResource
    {
        ...
        public DatabaseMigrationsSqlDb(string name, DatabaseMigrationsSqlDbArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20230715preview:DatabaseMigrationsSqlDb", name, args ?? new DatabaseMigrationsSqlDbArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseMigrationsSqlDb(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20230715preview:DatabaseMigrationsSqlDb", name, null, MakeResourceOptions(options, id))
        {
        }
