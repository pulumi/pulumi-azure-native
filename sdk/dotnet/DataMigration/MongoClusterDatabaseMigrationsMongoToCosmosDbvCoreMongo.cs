...
namespace Pulumi.AzureNative.DataMigration
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:datamigration:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo")]
    public partial class MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo(string name, MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo", name, null, MakeResourceOptions(options, id))
        {
        }

        private static MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs MakeArgs(MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs args)
        {
            args ??= new MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs();
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:datamigration/v20230715preview:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo" },
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo(name, id, options);
        }
    }

    public sealed class MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs : global::Pulumi.ResourceArgs
    {
        ...
        public MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs()
        {
        }
        public static new MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs Empty => new MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs();
    }
}
