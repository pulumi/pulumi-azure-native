...
namespace Pulumi.AzureNative.DataMigration.V20211030Preview
{
    ...
    /// A file resource
    /// </summary>
    [Obsolete(@"azure-native:datamigration/v20211030preview:File is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:File to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:datamigration/v20211030preview:File")]
    public partial class File : global::Pulumi.CustomResource
    {
        ...
        public File(string name, FileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20211030preview:File", name, args ?? new FileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private File(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20211030preview:File", name, null, MakeResourceOptions(options, id))
        {
        }
