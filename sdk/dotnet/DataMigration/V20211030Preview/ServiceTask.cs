...
namespace Pulumi.AzureNative.DataMigration.V20211030Preview
{
    ...
    /// A task resource
    /// </summary>
    [Obsolete(@"azure-native:datamigration/v20211030preview:ServiceTask is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:ServiceTask to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:datamigration/v20211030preview:ServiceTask")]
    public partial class ServiceTask : global::Pulumi.CustomResource
    {
        ...
        public ServiceTask(string name, ServiceTaskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20211030preview:ServiceTask", name, args ?? new ServiceTaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceTask(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20211030preview:ServiceTask", name, null, MakeResourceOptions(options, id))
        {
        }
