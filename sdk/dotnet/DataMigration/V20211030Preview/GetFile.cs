...
namespace Pulumi.AzureNative.DataMigration.V20211030Preview
{
    public static class GetFile
    {
        ...
        public static Task<GetFileResult> InvokeAsync(GetFileArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFileResult>("azure-native:datamigration/v20211030preview:getFile", args ?? new GetFileArgs(), options.WithVersion());

        /// <summary>
        /// A file resource
        /// </summary>
        public static Output<GetFileResult> Invoke(GetFileInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFileResult>("azure-native:datamigration/v20211030preview:getFile", args ?? new GetFileInvokeArgs(), options.WithVersion());
    }
