...
namespace Pulumi.AzureNative.DataMigration
{
    ...
    public partial class DatabaseMigrationsMongoToCosmosDbRUMongo : global::Pulumi.CustomResource
    {
        ...
        public DatabaseMigrationsMongoToCosmosDbRUMongo(string name, DatabaseMigrationsMongoToCosmosDbRUMongoArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration:DatabaseMigrationsMongoToCosmosDbRUMongo", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseMigrationsMongoToCosmosDbRUMongo(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration:DatabaseMigrationsMongoToCosmosDbRUMongo", name, null, MakeResourceOptions(options, id))
        {
        }

        private static DatabaseMigrationsMongoToCosmosDbRUMongoArgs MakeArgs(DatabaseMigrationsMongoToCosmosDbRUMongoArgs args)
        {
            args ??= new DatabaseMigrationsMongoToCosmosDbRUMongoArgs();
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbRUMongo" },
                    new global::Pulumi.Alias { Type = "azure-native:datamigration/v20250315preview:DatabaseMigrationsMongoToCosmosDbRUMongo" },
                    new global::Pulumi.Alias { Type = "azure-native:datamigration/v20250630:DatabaseMigrationsMongoToCosmosDbRUMongo" },
                    new global::Pulumi.Alias { Type = "azure-native:datamigration/v20250901preview:DatabaseMigrationsMongoToCosmosDbRUMongo" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabaseMigrationsMongoToCosmosDbRUMongo Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DatabaseMigrationsMongoToCosmosDbRUMongo(name, id, options);
        }
    }

    public sealed class DatabaseMigrationsMongoToCosmosDbRUMongoArgs : global::Pulumi.ResourceArgs
    {
        ...
        public DatabaseMigrationsMongoToCosmosDbRUMongoArgs()
        {
        }
        public static new DatabaseMigrationsMongoToCosmosDbRUMongoArgs Empty => new DatabaseMigrationsMongoToCosmosDbRUMongoArgs();
    }
}
