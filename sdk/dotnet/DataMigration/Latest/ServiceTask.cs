...
namespace Pulumi.AzureRM.DataMigration.Latest
{
    ...
    public partial class ServiceTask : Pulumi.CustomResource
    {
        ...
        public ServiceTask(string name, ServiceTaskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/latest:ServiceTask", name, args ?? new ServiceTaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceTask(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/latest:ServiceTask", name, null, MakeResourceOptions(options, id))
        {
        }
