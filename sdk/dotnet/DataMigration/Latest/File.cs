...
namespace Pulumi.AzureRM.DataMigration.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var file = new AzureRM.DataMigration.Latest.File("file", new AzureRM.DataMigration.Latest.FileArgs
    ///         {
    ///             FileName = "x114d023d8",
    ///             GroupName = "DmsSdkRg",
    ...
    public partial class File : Pulumi.CustomResource
    {
        ...
        public File(string name, FileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/latest:File", name, args ?? new FileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private File(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/latest:File", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:datamigration/v20180715preview:File"},
                },
            };
