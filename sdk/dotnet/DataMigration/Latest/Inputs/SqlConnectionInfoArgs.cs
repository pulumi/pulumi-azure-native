...
namespace Pulumi.AzureNextGen.DataMigration.Latest.Inputs
{
    ...
    public sealed class SqlConnectionInfoArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataMigration.Latest.AuthenticationType>? Authentication { get; set; }
        ...
        /// </summary>
        [Input("platform")]
        public InputUnion<string, Pulumi.AzureNextGen.DataMigration.Latest.SqlSourcePlatform>? Platform { get; set; }
