...
namespace Pulumi.AzureNative.DataMigration.Latest.Inputs
{
    ...
    public sealed class SqlConnectionInfoArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataMigration.Latest.AuthenticationType>? Authentication { get; set; }
        ...
        /// </summary>
        [Input("platform")]
        public InputUnion<string, Pulumi.AzureNative.DataMigration.Latest.SqlSourcePlatform>? Platform { get; set; }
