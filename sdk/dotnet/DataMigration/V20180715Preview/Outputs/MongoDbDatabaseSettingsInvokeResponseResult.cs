...
namespace Pulumi.AzureNextGen.DataMigration.V20180715Preview.Outputs
{
    ...
    [OutputType]
    public sealed class MongoDbDatabaseSettingsInvokeResponseResult
    {
        /// <summary>
        /// The collections on the source database to migrate to the target. The keys are the unqualified names of the collections.
        /// </summary>
        public readonly ImmutableDictionary<string, Outputs.MongoDbCollectionSettingsInvokeResponseResult> Collections;
        /// <summary>
        ...
        [OutputConstructor]
        private MongoDbDatabaseSettingsInvokeResponseResult(
            ImmutableDictionary<string, Outputs.MongoDbCollectionSettingsInvokeResponseResult> collections,
