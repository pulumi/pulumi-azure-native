...
namespace Pulumi.AzureNextGen.DataMigration.V20180715Preview.Outputs
{
    ...
    [OutputType]
    public sealed class MongoDbClusterInfoInvokeResponseResult
    {
        /// <summary>
        /// A list of non-system databases in the cluster
        /// </summary>
        public readonly ImmutableArray<Outputs.MongoDbDatabaseInfoInvokeResponseResult> Databases;
        /// <summary>
        ...
        [OutputConstructor]
        private MongoDbClusterInfoInvokeResponseResult(
            ImmutableArray<Outputs.MongoDbDatabaseInfoInvokeResponseResult> databases,
