...
namespace Pulumi.AzureNextGen.DataMigration.V20180715Preview.Outputs
{
    ...
    [OutputType]
    public sealed class MongoDbDatabaseInfoInvokeResponseResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.MongoDbCollectionInfoInvokeResponseResult> Collections;
        /// <summary>
        ...
        [OutputConstructor]
        private MongoDbDatabaseInfoInvokeResponseResult(
            double averageDocumentSize,

            ImmutableArray<Outputs.MongoDbCollectionInfoInvokeResponseResult> collections,
