...
namespace Pulumi.AzureNextGen.DataMigration.V20180715Preview
{
    ...
    public partial class Project : Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datamigration/v20180715preview:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datamigration/v20180715preview:Project", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProjectArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataMigration.V20180715Preview.ProjectSourcePlatform> SourcePlatform { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataMigration.V20180715Preview.ProjectTargetPlatform> TargetPlatform { get; set; } = null!;
