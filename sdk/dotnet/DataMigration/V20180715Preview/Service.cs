...
namespace Pulumi.AzureRM.DataMigration.V20180715Preview
{
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/v20180715preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/v20180715preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
