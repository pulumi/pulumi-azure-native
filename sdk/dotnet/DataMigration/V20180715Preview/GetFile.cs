...
{
    [Obsolete(@"azure-native:datamigration/v20180715preview:File is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:File to guarantee forwards compatibility.")]
    public static class GetFile
    {
        ...
        public static Task<GetFileResult> InvokeAsync(GetFileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFileResult>("azure-native:datamigration/v20180715preview:getFile", args ?? new GetFileArgs(), options.WithDefaults());

        /// <summary>
        /// The files resource is a nested, proxy-only resource representing a file stored under the project resource. This method retrieves information about a file.
        /// </summary>
        public static Output<GetFileResult> Invoke(GetFileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFileResult>("azure-native:datamigration/v20180715preview:getFile", args ?? new GetFileInvokeArgs(), options.WithDefaults());
    }
