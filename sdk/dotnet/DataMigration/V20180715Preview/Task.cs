...
namespace Pulumi.AzureRM.DataMigration.V20180715Preview
{
    ...
    public partial class Task : Pulumi.CustomResource
    {
        ...
        public Task(string name, TaskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/v20180715preview:Task", name, args ?? new TaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Task(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/v20180715preview:Task", name, null, MakeResourceOptions(options, id))
        {
        }
