...
namespace Pulumi.AzureNative.DataMigration.V20180715Preview
{
    ...
    [AzureNativeResourceType("azure-native:datamigration/v20180715preview:Task")]
    public partial class Task : global::Pulumi.CustomResource
    {
        ...
        public Task(string name, TaskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20180715preview:Task", name, args ?? new TaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Task(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20180715preview:Task", name, null, MakeResourceOptions(options, id))
        {
        }
