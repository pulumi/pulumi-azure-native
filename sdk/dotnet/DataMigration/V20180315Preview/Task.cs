...
namespace Pulumi.AzureRM.DataMigration.V20180315Preview
{
    ...
    public partial class Task : Pulumi.CustomResource
    {
        ...
        public Task(string name, TaskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/v20180315preview:Task", name, args ?? new TaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Task(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/v20180315preview:Task", name, null, MakeResourceOptions(options, id))
        {
        }
