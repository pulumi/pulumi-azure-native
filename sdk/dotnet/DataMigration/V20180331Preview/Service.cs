...
namespace Pulumi.AzureNative.DataMigration.V20180331Preview
{
    ...
    [AzureNativeResourceType("azure-native:datamigration/v20180331preview:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20180331preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20180331preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
