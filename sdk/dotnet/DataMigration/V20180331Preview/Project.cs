...
namespace Pulumi.AzureNative.DataMigration.V20180331Preview
{
    ...
    /// {
    ///     var project = new AzureNative.DataMigration.V20180331Preview.Project("project", new()
    ///     {
    ///         GroupName = "DmsSdkRg",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:datamigration/v20180331preview:Project DmsSdkProject /subscriptions/fc04246f-04c5-437e-ac5e-206a19e7193f/resourceGroups/DmsSdkRg/providers/Microsoft.DataMigration/services/DmsSdkService/projects/DmsSdkProject 
    /// ```
    /// </summary>
    ...
    public partial class Project : global::Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20180331preview:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20180331preview:Project", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProjectArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataMigration.V20180331Preview.ProjectSourcePlatform> SourcePlatform { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataMigration.V20180331Preview.ProjectTargetPlatform> TargetPlatform { get; set; } = null!;
