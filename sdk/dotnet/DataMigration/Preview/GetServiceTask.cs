...
namespace Pulumi.AzureRM.DataMigration.Preview
{
    public static class GetServiceTask
    {
        public static Task<GetServiceTaskResult> InvokeAsync(GetServiceTaskArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceTaskResult>("azurerm:datamigration/preview:getServiceTask", args ?? new GetServiceTaskArgs(), options.WithVersion());
    }
