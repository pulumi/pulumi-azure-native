...
namespace Pulumi.AzureRM.DataMigration.Preview
{
    ...
    public partial class File : Pulumi.CustomResource
    {
        ...
        public File(string name, FileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/preview:File", name, args ?? new FileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private File(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/preview:File", name, null, MakeResourceOptions(options, id))
        {
        }
