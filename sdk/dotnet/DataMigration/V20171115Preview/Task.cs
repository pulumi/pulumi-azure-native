...
namespace Pulumi.AzureNative.DataMigration.V20171115Preview
{
    ...
    /// A task resource
    /// </summary>
    [AzureNativeResourceType("azure-native:datamigration/v20171115preview:Task")]
    public partial class Task : Pulumi.CustomResource
    {
        ...
        public Task(string name, TaskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20171115preview:Task", name, args ?? new TaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Task(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20171115preview:Task", name, null, MakeResourceOptions(options, id))
        {
        }
