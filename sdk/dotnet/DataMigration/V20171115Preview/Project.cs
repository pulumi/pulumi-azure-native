...
namespace Pulumi.AzureRM.DataMigration.V20171115Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var project = new AzureRM.DataMigration.V20171115Preview.Project("project", new AzureRM.DataMigration.V20171115Preview.ProjectArgs
    ///         {
    ///             GroupName = "DmsSdkRg",
    ...
    public partial class Project : Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/v20171115preview:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/v20171115preview:Project", name, null, MakeResourceOptions(options, id))
        {
        }
