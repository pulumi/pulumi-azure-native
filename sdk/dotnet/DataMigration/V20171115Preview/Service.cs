...
namespace Pulumi.AzureNative.DataMigration.V20171115Preview
{
    ...
    [AzureNativeResourceType("azure-native:datamigration/v20171115preview:Service")]
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20171115preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20171115preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
