...
namespace Pulumi.AzureRM.DataMigration.V20171115Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var service = new AzureRM.DataMigration.V20171115Preview.Service("service", new AzureRM.DataMigration.V20171115Preview.ServiceArgs
    ///         {
    ///             GroupName = "DmsSdkRg",
    ///             Location = "southcentralus",
    ///             ServiceName = "DmsSdkService",
    ///             Sku = new AzureRM.DataMigration.V20171115Preview.Inputs.ServiceSkuArgs
    ///             {
    ///                 Name = "Basic_1vCore",
    ///             },
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/v20171115preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datamigration/v20171115preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
