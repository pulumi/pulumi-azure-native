...
namespace Pulumi.AzureNative.DataMigration.V20171115Preview
{
    ...
    public static class GetTask
    {
        ...
        public static Task<GetTaskResult> InvokeAsync(GetTaskArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTaskResult>("azure-native:datamigration/v20171115preview:getTask", args ?? new GetTaskArgs(), options.WithDefaults());

        /// <summary>
        /// A task resource
        /// </summary>
        public static Output<GetTaskResult> Invoke(GetTaskInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTaskResult>("azure-native:datamigration/v20171115preview:getTask", args ?? new GetTaskInvokeArgs(), options.WithDefaults());
    }
