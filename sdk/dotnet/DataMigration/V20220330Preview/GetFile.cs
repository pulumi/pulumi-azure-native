...
namespace Pulumi.AzureNative.DataMigration.V20220330Preview
{
    public static class GetFile
    {
        ...
        public static Task<GetFileResult> InvokeAsync(GetFileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFileResult>("azure-native:datamigration/v20220330preview:getFile", args ?? new GetFileArgs(), options.WithDefaults());

        /// <summary>
        /// The files resource is a nested, proxy-only resource representing a file stored under the project resource. This method retrieves information about a file.
        /// </summary>
        public static Output<GetFileResult> Invoke(GetFileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFileResult>("azure-native:datamigration/v20220330preview:getFile", args ?? new GetFileInvokeArgs(), options.WithDefaults());
    }
