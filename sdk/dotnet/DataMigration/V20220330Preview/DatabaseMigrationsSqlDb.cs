...
namespace Pulumi.AzureNative.DataMigration.V20220330Preview
{
    ...
    public partial class DatabaseMigrationsSqlDb : global::Pulumi.CustomResource
    {
        ...
        public DatabaseMigrationsSqlDb(string name, DatabaseMigrationsSqlDbArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20220330preview:DatabaseMigrationsSqlDb", name, args ?? new DatabaseMigrationsSqlDbArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseMigrationsSqlDb(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20220330preview:DatabaseMigrationsSqlDb", name, null, MakeResourceOptions(options, id))
        {
        }
