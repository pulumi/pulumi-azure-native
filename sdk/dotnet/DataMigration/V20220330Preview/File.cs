...
namespace Pulumi.AzureNative.DataMigration.V20220330Preview
{
    ...
    /// {
    ///     var file = new AzureNative.DataMigration.V20220330Preview.File("file", new()
    ///     {
    ///         FileName = "x114d023d8",
    ///         GroupName = "DmsSdkRg",
    ///         ProjectName = "DmsSdkProject",
    ///         Properties = new AzureNative.DataMigration.V20220330Preview.Inputs.ProjectFilePropertiesArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:datamigration/v20220330preview:File x114d023d8 /subscriptions/fc04246f-04c5-437e-ac5e-206a19e7193f/resourceGroups/DmsSdkRg/providers/Microsoft.DataMigration/services/DmsSdkService/projects/DmsSdkProject/files/x114d023d8 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datamigration/v20220330preview:File")]
    public partial class File : global::Pulumi.CustomResource
    {
        ...
        public File(string name, FileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20220330preview:File", name, args ?? new FileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private File(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datamigration/v20220330preview:File", name, null, MakeResourceOptions(options, id))
        {
        }
