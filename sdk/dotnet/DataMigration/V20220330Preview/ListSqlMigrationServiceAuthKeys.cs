...
namespace Pulumi.AzureNative.DataMigration.V20220330Preview
{
    public static class ListSqlMigrationServiceAuthKeys
    {
        ...
        public static Task<ListSqlMigrationServiceAuthKeysResult> InvokeAsync(ListSqlMigrationServiceAuthKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListSqlMigrationServiceAuthKeysResult>("azure-native:datamigration/v20220330preview:listSqlMigrationServiceAuthKeys", args ?? new ListSqlMigrationServiceAuthKeysArgs(), options.WithDefaults());
        ...
        public static Output<ListSqlMigrationServiceAuthKeysResult> Invoke(ListSqlMigrationServiceAuthKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListSqlMigrationServiceAuthKeysResult>("azure-native:datamigration/v20220330preview:listSqlMigrationServiceAuthKeys", args ?? new ListSqlMigrationServiceAuthKeysInvokeArgs(), options.WithDefaults());
    }
