...
namespace Pulumi.AzureRM.Subscription.Preview
{
    /// <summary>
    ...
    public partial class Alias : Pulumi.CustomResource
    {
        ...
        public Alias(string name, AliasArgs args, CustomResourceOptions? options = null)
            : base("azurerm:subscription/preview:Alias", name, args ?? new AliasArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Alias(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:subscription/preview:Alias", name, null, MakeResourceOptions(options, id))
        {
        }
