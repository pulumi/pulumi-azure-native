...
namespace Pulumi.AzureNative.Subscription.V20240801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:subscription/v20240801preview:Alias")]
    public partial class Alias : global::Pulumi.CustomResource
    {
        ...
        public Alias(string name, AliasArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:subscription/v20240801preview:Alias", name, args ?? new AliasArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Alias(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:subscription/v20240801preview:Alias", name, null, MakeResourceOptions(options, id))
        {
        }
