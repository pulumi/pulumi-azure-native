...
namespace Pulumi.AzureNative.Redis.V20160401
{
    /// <summary>
    /// A firewall rule on a redis cache has a name, and describes a contiguous range of IP addresses permitted to connect
    /// </summary>
    [AzureNativeResourceType("azure-native:redis/v20160401:RedisFirewallRule")]
    public partial class RedisFirewallRule : global::Pulumi.CustomResource
    {
        ...
        public RedisFirewallRule(string name, RedisFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redis/v20160401:RedisFirewallRule", name, args ?? new RedisFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RedisFirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redis/v20160401:RedisFirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20170201:RedisFirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20171001:RedisFirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20180301:RedisFirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20190701:RedisFirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20200601:RedisFirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20201201:RedisFirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20210601:RedisFirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20220501:RedisFirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20220601:RedisFirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20230401:RedisFirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20230501preview:RedisFirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20230801:RedisFirewallRule" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:redis:RedisFirewallRule" },
                },
            };
