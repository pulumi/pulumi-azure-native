...
namespace Pulumi.AzureNative.Redis.V20160401
{
    public static class GetRedisFirewallRule
    {
        ...
        public static Task<GetRedisFirewallRuleResult> InvokeAsync(GetRedisFirewallRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRedisFirewallRuleResult>("azure-native:redis/v20160401:getRedisFirewallRule", args ?? new GetRedisFirewallRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a single firewall rule in a specified redis cache.
        /// </summary>
        public static Output<GetRedisFirewallRuleResult> Invoke(GetRedisFirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRedisFirewallRuleResult>("azure-native:redis/v20160401:getRedisFirewallRule", args ?? new GetRedisFirewallRuleInvokeArgs(), options.WithDefaults());
