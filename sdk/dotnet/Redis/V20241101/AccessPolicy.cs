...
namespace Pulumi.AzureNative.Redis.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redis/v20241101:AccessPolicy")]
    public partial class AccessPolicy : global::Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redis/v20241101:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redis/v20241101:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20230501preview:AccessPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20230801:AccessPolicy" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:redis:AccessPolicy" },
                },
            };
