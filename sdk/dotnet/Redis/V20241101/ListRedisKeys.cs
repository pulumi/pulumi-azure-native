...
namespace Pulumi.AzureNative.Redis.V20241101
{
    public static class ListRedisKeys
    {
        ...
        public static Task<ListRedisKeysResult> InvokeAsync(ListRedisKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListRedisKeysResult>("azure-native:redis/v20241101:listRedisKeys", args ?? new ListRedisKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve a Redis cache's access keys. This operation requires write permission to the cache resource.
        /// </summary>
        public static Output<ListRedisKeysResult> Invoke(ListRedisKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListRedisKeysResult>("azure-native:redis/v20241101:listRedisKeys", args ?? new ListRedisKeysInvokeArgs(), options.WithDefaults());
