...
namespace Pulumi.AzureNative.Redis.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redis/v20241101:Redis")]
    public partial class Redis : global::Pulumi.CustomResource
    {
        ...
        public Redis(string name, RedisArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redis/v20241101:Redis", name, args ?? new RedisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Redis(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redis/v20241101:Redis", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:redis:Redis" },
                },
            };
    ...
    public sealed class RedisArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Redis.V20241101.TlsVersion>? MinimumTlsVersion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Redis.V20241101.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        /// </summary>
        [Input("updateChannel")]
        public InputUnion<string, Pulumi.AzureNative.Redis.V20241101.UpdateChannel>? UpdateChannel { get; set; }

        /// <summary>
        /// Optional: Specifies how availability zones are allocated to the Redis cache. 'Automatic' enables zone redundancy and Azure will automatically select zones based on regional availability and capacity. 'UserDefined' will select availability zones passed in by you using the 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocationPolicy' is not passed, it will be set to 'UserDefined' when zones are passed in, otherwise, it will be set to 'Automatic' in regions where zones are supported and 'NoZones' in regions where zones are not supported.
        /// </summary>
        [Input("zonalAllocationPolicy")]
        public InputUnion<string, Pulumi.AzureNative.Redis.V20241101.ZonalAllocationPolicy>? ZonalAllocationPolicy { get; set; }
