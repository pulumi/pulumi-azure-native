...
namespace Pulumi.AzureNative.Redis.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redis/v20241101:LinkedServer")]
    public partial class LinkedServer : global::Pulumi.CustomResource
    {
        ...
        public LinkedServer(string name, LinkedServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redis/v20241101:LinkedServer", name, args ?? new LinkedServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redis/v20241101:LinkedServer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20170201:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20171001:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20180301:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20190701:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20200601:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20201201:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20210601:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20220501:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20220601:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20230401:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20230501preview:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20230801:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20240301:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis/v20240401preview:LinkedServer" },
                    new global::Pulumi.Alias { Type = "azure-native:redis:LinkedServer" },
                },
            };
    ...
    public sealed class LinkedServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Redis.V20241101.ReplicationRole> ServerRole { get; set; } = null!;
