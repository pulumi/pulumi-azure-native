...
namespace Pulumi.AzureNative.Redis.V20241101
{
    public static class GetRedis
    {
        ...
        public static Task<GetRedisResult> InvokeAsync(GetRedisArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRedisResult>("azure-native:redis/v20241101:getRedis", args ?? new GetRedisArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Redis cache (resource description).
        /// </summary>
        public static Output<GetRedisResult> Invoke(GetRedisInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRedisResult>("azure-native:redis/v20241101:getRedis", args ?? new GetRedisInvokeArgs(), options.WithDefaults());
