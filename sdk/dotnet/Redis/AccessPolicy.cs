...
namespace Pulumi.AzureNative.Redis
{
    ...
    public partial class AccessPolicy : global::Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redis:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redis:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_redis_v20230501preview:redis:AccessPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native_redis_v20230801:redis:AccessPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native_redis_v20240301:redis:AccessPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native_redis_v20240401preview:redis:AccessPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native_redis_v20241101:redis:AccessPolicy" },
                },
            };
