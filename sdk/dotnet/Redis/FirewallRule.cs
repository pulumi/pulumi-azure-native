...
namespace Pulumi.AzureNative.Redis
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redis:FirewallRule")]
    public partial class FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redis:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redis:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_redis_v20160401:redis:FirewallRule" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_redis_v20220501:redis:FirewallRule" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_redis_v20241101:redis:FirewallRule" },
                },
            };
