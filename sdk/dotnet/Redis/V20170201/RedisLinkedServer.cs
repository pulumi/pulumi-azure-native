...
namespace Pulumi.AzureNative.Redis.V20170201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redis/v20170201:RedisLinkedServer")]
    public partial class RedisLinkedServer : global::Pulumi.CustomResource
    {
        ...
        public RedisLinkedServer(string name, RedisLinkedServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redis/v20170201:RedisLinkedServer", name, args ?? new RedisLinkedServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RedisLinkedServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redis/v20170201:RedisLinkedServer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:redis:RedisLinkedServer" },
                },
            };
    ...
    public sealed class RedisLinkedServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Redis.V20170201.ReplicationRole> ServerRole { get; set; } = null!;
