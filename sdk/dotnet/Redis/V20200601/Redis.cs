...
namespace Pulumi.AzureNative.Redis.V20200601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redis/v20200601:Redis")]
    public partial class Redis : global::Pulumi.CustomResource
    {
        ...
        public Redis(string name, RedisArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redis/v20200601:Redis", name, args ?? new RedisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Redis(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redis/v20200601:Redis", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RedisArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Redis.V20200601.TlsVersion>? MinimumTlsVersion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Redis.V20200601.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
