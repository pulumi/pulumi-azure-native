...
namespace Pulumi.AzureNative.FluidRelay.V20220215
{
    public static class GetFluidRelayServerKeys
    {
        ...
        public static Task<GetFluidRelayServerKeysResult> InvokeAsync(GetFluidRelayServerKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFluidRelayServerKeysResult>("azure-native:fluidrelay/v20220215:getFluidRelayServerKeys", args ?? new GetFluidRelayServerKeysArgs(), options.WithDefaults());
        ...
        public static Output<GetFluidRelayServerKeysResult> Invoke(GetFluidRelayServerKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFluidRelayServerKeysResult>("azure-native:fluidrelay/v20220215:getFluidRelayServerKeys", args ?? new GetFluidRelayServerKeysInvokeArgs(), options.WithDefaults());
    }
