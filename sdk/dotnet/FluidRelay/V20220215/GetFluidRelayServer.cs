...
namespace Pulumi.AzureNative.FluidRelay.V20220215
{
    public static class GetFluidRelayServer
    {
        ...
        public static Task<GetFluidRelayServerResult> InvokeAsync(GetFluidRelayServerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFluidRelayServerResult>("azure-native:fluidrelay/v20220215:getFluidRelayServer", args ?? new GetFluidRelayServerArgs(), options.WithDefaults());

        /// <summary>
        /// A FluidRelay Server.
        /// </summary>
        public static Output<GetFluidRelayServerResult> Invoke(GetFluidRelayServerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFluidRelayServerResult>("azure-native:fluidrelay/v20220215:getFluidRelayServer", args ?? new GetFluidRelayServerInvokeArgs(), options.WithDefaults());
