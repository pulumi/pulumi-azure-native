...
namespace Pulumi.AzureNative.FluidRelay.V20210910Preview
{
    ...
    /// A FluidRelay Server.
    /// </summary>
    [Obsolete(@"azure-native:fluidrelay/v20210910preview:FluidRelayServer is being removed in the next major version of this provider. Please upgrade to azure-native:fluidrelay/v20220601:FluidRelayServer to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:fluidrelay/v20210910preview:FluidRelayServer")]
    public partial class FluidRelayServer : global::Pulumi.CustomResource
    {
        ...
        public FluidRelayServer(string name, FluidRelayServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:fluidrelay/v20210910preview:FluidRelayServer", name, args ?? new FluidRelayServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FluidRelayServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:fluidrelay/v20210910preview:FluidRelayServer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FluidRelayServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.FluidRelay.V20210910Preview.ProvisioningState>? ProvisioningState { get; set; }
