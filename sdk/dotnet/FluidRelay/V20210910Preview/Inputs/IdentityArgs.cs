...
namespace Pulumi.AzureNative.FluidRelay.V20210910Preview.Inputs
{
    ...
    public sealed class IdentityArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNative.FluidRelay.V20210910Preview.ResourceIdentityType>? Type { get; set; }
