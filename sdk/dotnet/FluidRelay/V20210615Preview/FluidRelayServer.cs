...
namespace Pulumi.AzureNative.FluidRelay.V20210615Preview
{
    ...
    public partial class FluidRelayServer : Pulumi.CustomResource
    {
        ...
        public FluidRelayServer(string name, FluidRelayServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:fluidrelay/v20210615preview:FluidRelayServer", name, args ?? new FluidRelayServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FluidRelayServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:fluidrelay/v20210615preview:FluidRelayServer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FluidRelayServerArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.FluidRelay.V20210615Preview.ProvisioningState>? ProvisioningState { get; set; }
