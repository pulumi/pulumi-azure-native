...
namespace Pulumi.AzureNative.FluidRelay.V20210312Preview
{
    public static class GetFluidRelayServer
    {
        ...
        public static Output<GetFluidRelayServerResult> Invoke(GetFluidRelayServerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFluidRelayServerResult>("azure-native:fluidrelay/v20210312preview:getFluidRelayServer", args ?? new GetFluidRelayServerInvokeArgs(), options.WithVersion());
    }
