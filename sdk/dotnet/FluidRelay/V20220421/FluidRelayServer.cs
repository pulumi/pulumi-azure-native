...
namespace Pulumi.AzureNative.FluidRelay.V20220421
{
    ...
    /// A FluidRelay Server.
    /// </summary>
    [Obsolete(@"azure-native:fluidrelay/v20220421:FluidRelayServer is being removed in the next major version of this provider. Upgrade to at least azure-native:fluidrelay/v20220601:FluidRelayServer to guarantee forwards compatibility.")]
    ...
    public partial class FluidRelayServer : global::Pulumi.CustomResource
    {
        ...
        public FluidRelayServer(string name, FluidRelayServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:fluidrelay/v20220421:FluidRelayServer", name, args ?? new FluidRelayServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FluidRelayServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:fluidrelay/v20220421:FluidRelayServer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FluidRelayServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.FluidRelay.V20220421.ProvisioningState>? ProvisioningState { get; set; }
