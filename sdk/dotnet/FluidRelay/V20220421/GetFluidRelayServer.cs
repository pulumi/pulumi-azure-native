...
namespace Pulumi.AzureNative.FluidRelay.V20220421
{
    public static class GetFluidRelayServer
    {
        ...
        public static Task<GetFluidRelayServerResult> InvokeAsync(GetFluidRelayServerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFluidRelayServerResult>("azure-native:fluidrelay/v20220421:getFluidRelayServer", args ?? new GetFluidRelayServerArgs(), options.WithDefaults());

        /// <summary>
        /// A FluidRelay Server.
        /// </summary>
        public static Output<GetFluidRelayServerResult> Invoke(GetFluidRelayServerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFluidRelayServerResult>("azure-native:fluidrelay/v20220421:getFluidRelayServer", args ?? new GetFluidRelayServerInvokeArgs(), options.WithDefaults());
    }
