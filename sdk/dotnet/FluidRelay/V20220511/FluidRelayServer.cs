...
namespace Pulumi.AzureNative.FluidRelay.V20220511
{
    ...
    /// A FluidRelay Server.
    /// </summary>
    [AzureNativeResourceType("azure-native:fluidrelay/v20220511:FluidRelayServer")]
    public partial class FluidRelayServer : Pulumi.CustomResource
    {
        ...
        public FluidRelayServer(string name, FluidRelayServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:fluidrelay/v20220511:FluidRelayServer", name, args ?? new FluidRelayServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FluidRelayServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:fluidrelay/v20220511:FluidRelayServer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FluidRelayServerArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.FluidRelay.V20220511.ProvisioningState>? ProvisioningState { get; set; }
