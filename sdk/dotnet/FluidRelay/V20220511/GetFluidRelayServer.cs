...
namespace Pulumi.AzureNative.FluidRelay.V20220511
{
    [Obsolete(@"azure-native:fluidrelay/v20220511:FluidRelayServer is being removed in the next major version of this provider. Upgrade to at least azure-native:fluidrelay/v20220601:FluidRelayServer to guarantee forwards compatibility.")]
    public static class GetFluidRelayServer
    {
        ...
        public static Task<GetFluidRelayServerResult> InvokeAsync(GetFluidRelayServerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFluidRelayServerResult>("azure-native:fluidrelay/v20220511:getFluidRelayServer", args ?? new GetFluidRelayServerArgs(), options.WithDefaults());

        /// <summary>
        /// A FluidRelay Server.
        /// </summary>
        public static Output<GetFluidRelayServerResult> Invoke(GetFluidRelayServerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFluidRelayServerResult>("azure-native:fluidrelay/v20220511:getFluidRelayServer", args ?? new GetFluidRelayServerInvokeArgs(), options.WithDefaults());
    }
