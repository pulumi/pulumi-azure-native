...
namespace Pulumi.AzureNative.FluidRelay.V20210830Preview
{
    ...
    /// A FluidRelay Server.
    /// </summary>
    [Obsolete(@"azure-native:fluidrelay/v20210830preview:FluidRelayServer is being removed in the next major version of this provider. Upgrade to at least azure-native:fluidrelay/v20220601:FluidRelayServer to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:fluidrelay/v20210830preview:FluidRelayServer")]
    public partial class FluidRelayServer : global::Pulumi.CustomResource
    {
        ...
        public FluidRelayServer(string name, FluidRelayServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:fluidrelay/v20210830preview:FluidRelayServer", name, args ?? new FluidRelayServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FluidRelayServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:fluidrelay/v20210830preview:FluidRelayServer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FluidRelayServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.FluidRelay.V20210830Preview.ProvisioningState>? ProvisioningState { get; set; }
