...
namespace Pulumi.AzureRM.Media.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var job = new AzureRM.Media.V20200501.Job("job", new AzureRM.Media.V20200501.JobArgs
    ///         {
    ...
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/v20200501:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/v20200501:Job", name, null, MakeResourceOptions(options, id))
        {
        }
