...
namespace Pulumi.AzureRM.Media.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var liveOutput = new AzureRM.Media.V20200501.LiveOutput("liveOutput", new AzureRM.Media.V20200501.LiveOutputArgs
    ///         {
    ///             AccountName = "slitestmedia10",
    ///             ArchiveWindowLength = "PT5M",
    ///             AssetName = "6f3264f5-a189-48b4-a29a-a40f22575212",
    ///             Description = "test live output 1",
    ///             Hls = new AzureRM.Media.V20200501.Inputs.HlsArgs
    ///             {
    ...
    public partial class LiveOutput : Pulumi.CustomResource
    {
        ...
        public LiveOutput(string name, LiveOutputArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/v20200501:LiveOutput", name, args ?? new LiveOutputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LiveOutput(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/v20200501:LiveOutput", name, null, MakeResourceOptions(options, id))
        {
        }
