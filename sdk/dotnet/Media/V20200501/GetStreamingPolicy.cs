...
namespace Pulumi.AzureNextGen.Media.V20200501
{
    public static class GetStreamingPolicy
    {
        public static Task<GetStreamingPolicyResult> InvokeAsync(GetStreamingPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamingPolicyResult>("azure-nextgen:media/v20200501:getStreamingPolicy", args ?? new GetStreamingPolicyArgs(), options.WithVersion());
    }
