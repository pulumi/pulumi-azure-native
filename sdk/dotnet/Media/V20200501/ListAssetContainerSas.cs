...
namespace Pulumi.AzureNative.Media.V20200501
{
    public static class ListAssetContainerSas
    {
        ...
        public static Output<ListAssetContainerSasResult> Invoke(ListAssetContainerSasInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListAssetContainerSasResult>("azure-native:media/v20200501:listAssetContainerSas", args ?? new ListAssetContainerSasInvokeArgs(), options.WithVersion());
    }
