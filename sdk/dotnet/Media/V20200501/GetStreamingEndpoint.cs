...
{
    [Obsolete(@"azure-native:media/v20200501:StreamingEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20221101:StreamingEndpoint to guarantee forwards compatibility.")]
    public static class GetStreamingEndpoint
    {
        ...
        public static Task<GetStreamingEndpointResult> InvokeAsync(GetStreamingEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStreamingEndpointResult>("azure-native:media/v20200501:getStreamingEndpoint", args ?? new GetStreamingEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a streaming endpoint.
        /// </summary>
        public static Output<GetStreamingEndpointResult> Invoke(GetStreamingEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStreamingEndpointResult>("azure-native:media/v20200501:getStreamingEndpoint", args ?? new GetStreamingEndpointInvokeArgs(), options.WithDefaults());
    }
