...
namespace Pulumi.AzureNative.Media.V20200501
{
    ...
    public partial class Asset : Pulumi.CustomResource
    {
        ...
        public Asset(string name, AssetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20200501:Asset", name, args ?? new AssetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Asset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20200501:Asset", name, null, MakeResourceOptions(options, id))
        {
        }
