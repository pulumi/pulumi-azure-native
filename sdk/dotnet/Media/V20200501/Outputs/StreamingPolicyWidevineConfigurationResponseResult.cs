...
namespace Pulumi.AzureRM.Media.V20200501.Outputs
{
    ...
    [OutputType]
    public sealed class StreamingPolicyWidevineConfigurationResponseResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private StreamingPolicyWidevineConfigurationResponseResult(string? customLicenseAcquisitionUrlTemplate)
        {
