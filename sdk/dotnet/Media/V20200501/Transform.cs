...
namespace Pulumi.AzureRM.Media.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var transform = new AzureRM.Media.V20200501.Transform("transform", new AzureRM.Media.V20200501.TransformArgs
    ///         {
    ///             AccountName = "contosomedia",
    ///             Description = "Example Transform to illustrate create and update.",
    ///             Outputs = 
    ///             {
    ///                 new AzureRM.Media.V20200501.Inputs.TransformOutputArgs
    ///                 {
