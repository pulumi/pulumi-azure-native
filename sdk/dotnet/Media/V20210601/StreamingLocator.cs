...
namespace Pulumi.AzureNative.Media.V20210601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20210601:StreamingLocator")]
    public partial class StreamingLocator : Pulumi.CustomResource
    {
        ...
        public StreamingLocator(string name, StreamingLocatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20210601:StreamingLocator", name, args ?? new StreamingLocatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingLocator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20210601:StreamingLocator", name, null, MakeResourceOptions(options, id))
        {
        }
