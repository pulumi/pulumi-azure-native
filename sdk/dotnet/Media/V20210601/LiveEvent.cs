...
namespace Pulumi.AzureNative.Media.V20210601
{
    ...
    /// The live event.
    /// </summary>
    [Obsolete(@"azure-native:media/v20210601:LiveEvent is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20221101:LiveEvent to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:media/v20210601:LiveEvent")]
    public partial class LiveEvent : global::Pulumi.CustomResource
    {
        ...
        public LiveEvent(string name, LiveEventArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20210601:LiveEvent", name, args ?? new LiveEventArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LiveEvent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20210601:LiveEvent", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LiveEventArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("streamOptions")]
        private InputList<Union<string, Pulumi.AzureNative.Media.V20210601.StreamOptionsFlag>>? _streamOptions;

        /// <summary>
        /// The options to use for the LiveEvent. This value is specified at creation time and cannot be updated. The valid values for the array entry values are 'Default' and 'LowLatency'.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Media.V20210601.StreamOptionsFlag>> StreamOptions
        {
            get => _streamOptions ?? (_streamOptions = new InputList<Union<string, Pulumi.AzureNative.Media.V20210601.StreamOptionsFlag>>());
