...
namespace Pulumi.AzureNative.Media.V20210601
{
    ...
    /// An Account Filter.
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20210601:AccountFilter")]
    public partial class AccountFilter : Pulumi.CustomResource
    {
        ...
        public AccountFilter(string name, AccountFilterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20210601:AccountFilter", name, args ?? new AccountFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccountFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20210601:AccountFilter", name, null, MakeResourceOptions(options, id))
        {
        }
