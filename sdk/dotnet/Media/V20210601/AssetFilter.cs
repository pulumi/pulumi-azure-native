...
namespace Pulumi.AzureNative.Media.V20210601
{
    ...
    [AzureNativeResourceType("azure-native:media/v20210601:AssetFilter")]
    public partial class AssetFilter : global::Pulumi.CustomResource
    {
        ...
        public AssetFilter(string name, AssetFilterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20210601:AssetFilter", name, args ?? new AssetFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssetFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20210601:AssetFilter", name, null, MakeResourceOptions(options, id))
        {
        }
