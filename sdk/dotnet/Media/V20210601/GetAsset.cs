...
{
    [Obsolete(@"azure-native:media/v20210601:Asset is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Asset to guarantee forwards compatibility.")]
    public static class GetAsset
    {
        ...
        public static Task<GetAssetResult> InvokeAsync(GetAssetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssetResult>("azure-native:media/v20210601:getAsset", args ?? new GetAssetArgs(), options.WithDefaults());

        /// <summary>
        /// Get the details of an Asset in the Media Services account
        /// </summary>
        public static Output<GetAssetResult> Invoke(GetAssetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssetResult>("azure-native:media/v20210601:getAsset", args ?? new GetAssetInvokeArgs(), options.WithDefaults());
    }
