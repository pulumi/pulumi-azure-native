...
namespace Pulumi.AzureNative.Media.V20210601
{
    public static class GetAssetEncryptionKey
    {
        ...
        public static Task<GetAssetEncryptionKeyResult> InvokeAsync(GetAssetEncryptionKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAssetEncryptionKeyResult>("azure-native:media/v20210601:getAssetEncryptionKey", args ?? new GetAssetEncryptionKeyArgs(), options.WithVersion());

        /// <summary>
        /// Data needed to decrypt asset files encrypted with legacy storage encryption.
        /// </summary>
        public static Output<GetAssetEncryptionKeyResult> Invoke(GetAssetEncryptionKeyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAssetEncryptionKeyResult>("azure-native:media/v20210601:getAssetEncryptionKey", args ?? new GetAssetEncryptionKeyInvokeArgs(), options.WithVersion());
    }
