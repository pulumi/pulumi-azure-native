...
namespace Pulumi.AzureNative.Media.V20210601
{
    public static class ListAssetContainerSas
    {
        ...
        public static Task<ListAssetContainerSasResult> InvokeAsync(ListAssetContainerSasArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAssetContainerSasResult>("azure-native:media/v20210601:listAssetContainerSas", args ?? new ListAssetContainerSasArgs(), options.WithDefaults());

        /// <summary>
        /// The Asset Storage container SAS URLs.
        /// </summary>
        public static Output<ListAssetContainerSasResult> Invoke(ListAssetContainerSasInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListAssetContainerSasResult>("azure-native:media/v20210601:listAssetContainerSas", args ?? new ListAssetContainerSasInvokeArgs(), options.WithDefaults());
    }
