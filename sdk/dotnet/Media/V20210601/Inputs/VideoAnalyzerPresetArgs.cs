...
namespace Pulumi.AzureNative.Media.V20210601.Inputs
{
    ...
    public sealed class VideoAnalyzerPresetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.V20210601.InsightsType>? InsightsToExtract { get; set; }

        /// <summary>
        /// Determines the set of audio analysis operations to be performed. If unspecified, the Standard AudioAnalysisMode would be chosen.
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20210601.AudioAnalysisMode>? Mode { get; set; }
