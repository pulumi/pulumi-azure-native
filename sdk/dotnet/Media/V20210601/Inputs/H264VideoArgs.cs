...
namespace Pulumi.AzureNative.Media.V20210601.Inputs
{
    ...
    public sealed class H264VideoArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("complexity")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20210601.H264Complexity>? Complexity { get; set; }
        ...
        /// </summary>
        [Input("stretchMode")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20210601.StretchMode>? StretchMode { get; set; }

        /// <summary>
        /// The Video Sync Mode
        /// </summary>
        [Input("syncMode")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20210601.VideoSyncMode>? SyncMode { get; set; }
