...
namespace Pulumi.AzureNative.Media.V20210601.Inputs
{
    ...
    public sealed class TransformOutputArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("onError")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20210601.OnErrorType>? OnError { get; set; }

        /// <summary>
        /// Preset that describes the operations that will be used to modify, transcode, or extract insights from the source file to generate the output.
        /// </summary>
        [Input("preset", required: true)]
        public object Preset { get; set; } = null!;

        /// <summary>
        /// Sets the relative priority of the TransformOutputs within a Transform. This sets the priority that the service uses for processing TransformOutputs. The default priority is Normal.
        /// </summary>
        [Input("relativePriority")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20210601.Priority>? RelativePriority { get; set; }
