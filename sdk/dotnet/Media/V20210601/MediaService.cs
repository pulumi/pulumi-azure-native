...
namespace Pulumi.AzureNative.Media.V20210601
{
    ...
    public partial class MediaService : global::Pulumi.CustomResource
    {
        ...
        public MediaService(string name, MediaServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20210601:MediaService", name, args ?? new MediaServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MediaService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20210601:MediaService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MediaServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.V20210601.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.V20210601.StorageAuthentication>? StorageAuthentication { get; set; }
