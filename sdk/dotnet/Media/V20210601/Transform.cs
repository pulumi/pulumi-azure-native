...
namespace Pulumi.AzureNative.Media.V20210601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20210601:Transform")]
    public partial class Transform : global::Pulumi.CustomResource
    {
        ...
        public Transform(string name, TransformArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20210601:Transform", name, args ?? new TransformArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Transform(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20210601:Transform", name, null, MakeResourceOptions(options, id))
        {
        }
