...
namespace Pulumi.AzureRM.Media.Inputs
{
    ...
    /// </summary>
    public sealed class LiveOutputPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("hls")]
        public Input<Inputs.HlsResponseArgs>? Hls { get; set; }
        ...
        public LiveOutputPropertiesResponseArgs()
        {
        }
    }
}
