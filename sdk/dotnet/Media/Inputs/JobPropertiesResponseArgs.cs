...
namespace Pulumi.AzureRM.Media.Inputs
{
    ...
    public sealed class JobPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.JobInputResponseArgs> Input { get; set; } = null!;
        ...
        private InputList<Inputs.JobOutputResponseArgs>? _outputs;

        /// <summary>
        /// The outputs for the Job.
        /// </summary>
        public InputList<Inputs.JobOutputResponseArgs> Outputs
        {
            get => _outputs ?? (_outputs = new InputList<Inputs.JobOutputResponseArgs>());
            set => _outputs = value;
        }
