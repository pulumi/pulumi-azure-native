...
namespace Pulumi.AzureNextGen.Media.Inputs
{
    ...
    public sealed class FaceDetectorPresetArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("blurType")]
        public InputUnion<string, Pulumi.AzureNextGen.Media.BlurType>? BlurType { get; set; }
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNextGen.Media.FaceRedactorMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("resolution")]
        public InputUnion<string, Pulumi.AzureNextGen.Media.AnalysisResolution>? Resolution { get; set; }
