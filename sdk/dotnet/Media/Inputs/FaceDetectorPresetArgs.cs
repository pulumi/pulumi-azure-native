...
namespace Pulumi.AzureNative.Media.Inputs
{
    ...
    public sealed class FaceDetectorPresetArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("blurType")]
        public InputUnion<string, Pulumi.AzureNative.Media.BlurType>? BlurType { get; set; }
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Media.FaceRedactorMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("resolution")]
        public InputUnion<string, Pulumi.AzureNative.Media.AnalysisResolution>? Resolution { get; set; }
