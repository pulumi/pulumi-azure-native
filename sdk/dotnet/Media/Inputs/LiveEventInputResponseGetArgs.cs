...
namespace Pulumi.AzureRM.Media.Inputs
{
    ...
    /// </summary>
    public sealed class LiveEventInputResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The access control for LiveEvent Input.
        /// </summary>
        [Input("accessControl")]
        public Input<Inputs.LiveEventInputAccessControlResponseGetArgs>? AccessControl { get; set; }
        ...
        [Input("endpoints")]
        private InputList<Inputs.LiveEventEndpointResponseGetArgs>? _endpoints;

        /// <summary>
        /// The input endpoints for the Live Event.
        /// </summary>
        public InputList<Inputs.LiveEventEndpointResponseGetArgs> Endpoints
        {
            get => _endpoints ?? (_endpoints = new InputList<Inputs.LiveEventEndpointResponseGetArgs>());
        ...
        public LiveEventInputResponseGetArgs()
        {
        }
    }
}
