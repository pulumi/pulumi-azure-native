...
namespace Pulumi.AzureNative.Media.Inputs
{
    ...
    public sealed class H264LayerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("entropyMode")]
        public InputUnion<string, Pulumi.AzureNative.Media.EntropyMode>? EntropyMode { get; set; }
        ...
        /// </summary>
        [Input("profile")]
        public InputUnion<string, Pulumi.AzureNative.Media.H264VideoProfile>? Profile { get; set; }
