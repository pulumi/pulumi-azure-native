...
namespace Pulumi.AzureNextGen.Media.Inputs
{
    ...
    public sealed class H264LayerArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("entropyMode")]
        public InputUnion<string, Pulumi.AzureNextGen.Media.EntropyMode>? EntropyMode { get; set; }
        ...
        /// </summary>
        [Input("profile")]
        public InputUnion<string, Pulumi.AzureNextGen.Media.H264VideoProfile>? Profile { get; set; }
