...
namespace Pulumi.AzureNative.Media.Inputs
{
    ...
    public sealed class ContentKeyPolicyPlayReadyPlayRightArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.ContentKeyPolicyPlayReadyUnknownOutputPassingOption> AllowPassingVideoContentToUnknownOutput { get; set; } = null!;
