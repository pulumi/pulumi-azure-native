...
namespace Pulumi.AzureRM.Media.Inputs
{
    ...
    /// </summary>
    public sealed class StreamingEndpointPropertiesResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The access control definition of the StreamingEndpoint.
        /// </summary>
        [Input("accessControl")]
        public Input<Inputs.StreamingEndpointAccessControlResponseGetArgs>? AccessControl { get; set; }
        ...
        public StreamingEndpointPropertiesResponseGetArgs()
        {
        }
    }
}
