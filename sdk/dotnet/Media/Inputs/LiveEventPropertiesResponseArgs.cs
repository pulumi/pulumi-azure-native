...
namespace Pulumi.AzureRM.Media.Inputs
{
    ...
    /// </summary>
    public sealed class LiveEventPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("encoding")]
        public Input<Inputs.LiveEventEncodingResponseArgs>? Encoding { get; set; }

        /// <summary>
        /// The Live Event input.
        /// </summary>
        [Input("input", required: true)]
        public Input<Inputs.LiveEventInputResponseArgs> Input { get; set; } = null!;
        ...
        /// </summary>
        [Input("preview")]
        public Input<Inputs.LiveEventPreviewResponseArgs>? Preview { get; set; }
        ...
        public LiveEventPropertiesResponseArgs()
        {
        }
    }
}
