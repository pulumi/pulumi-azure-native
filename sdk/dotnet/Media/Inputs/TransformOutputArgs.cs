...
namespace Pulumi.AzureNative.Media.Inputs
{
    ...
    public sealed class TransformOutputArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("onError")]
        public InputUnion<string, Pulumi.AzureNative.Media.OnErrorType>? OnError { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.Priority>? RelativePriority { get; set; }
