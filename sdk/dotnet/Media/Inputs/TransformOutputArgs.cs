...
namespace Pulumi.AzureNextGen.Media.Inputs
{
    ...
    public sealed class TransformOutputArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("onError")]
        public InputUnion<string, Pulumi.AzureNextGen.Media.OnErrorType>? OnError { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Media.Priority>? RelativePriority { get; set; }
