...
namespace Pulumi.AzureRM.Media
{
    public static class GetContentKeyPolicy
    {
        public static Task<GetContentKeyPolicyResult> InvokeAsync(GetContentKeyPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContentKeyPolicyResult>("azurerm:media:getContentKeyPolicy", args ?? new GetContentKeyPolicyArgs(), options.WithVersion());
    }
