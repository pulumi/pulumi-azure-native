...
namespace Pulumi.AzureNative.Media.V20220501Preview.Inputs
{
    ...
    public sealed class H264LayerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("entropyMode")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20220501Preview.EntropyMode>? EntropyMode { get; set; }
        ...
        /// </summary>
        [Input("profile")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20220501Preview.H264VideoProfile>? Profile { get; set; }
