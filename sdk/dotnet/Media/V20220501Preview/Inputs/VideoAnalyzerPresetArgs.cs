...
namespace Pulumi.AzureNative.Media.V20220501Preview.Inputs
{
    ...
    public sealed class VideoAnalyzerPresetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.V20220501Preview.InsightsType>? InsightsToExtract { get; set; }

        /// <summary>
        /// Determines the set of audio analysis operations to be performed. If unspecified, the Standard AudioAnalysisMode would be chosen.
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20220501Preview.AudioAnalysisMode>? Mode { get; set; }
