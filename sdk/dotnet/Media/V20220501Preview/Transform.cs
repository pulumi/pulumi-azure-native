...
namespace Pulumi.AzureNative.Media.V20220501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:media/v20220501preview:Transform is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Transform to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:media/v20220501preview:Transform")]
    public partial class Transform : global::Pulumi.CustomResource
    {
        ...
        public Transform(string name, TransformArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220501preview:Transform", name, args ?? new TransformArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Transform(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220501preview:Transform", name, null, MakeResourceOptions(options, id))
        {
        }
