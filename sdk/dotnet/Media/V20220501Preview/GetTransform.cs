...
namespace Pulumi.AzureNative.Media.V20220501Preview
{
    public static class GetTransform
    {
        ...
        public static Task<GetTransformResult> InvokeAsync(GetTransformArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTransformResult>("azure-native:media/v20220501preview:getTransform", args ?? new GetTransformArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Transform.
        /// </summary>
        public static Output<GetTransformResult> Invoke(GetTransformInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTransformResult>("azure-native:media/v20220501preview:getTransform", args ?? new GetTransformInvokeArgs(), options.WithDefaults());
