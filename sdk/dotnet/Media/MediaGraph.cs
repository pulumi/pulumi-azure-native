...
namespace Pulumi.AzureNative.Media
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:media:MediaGraph")]
    public partial class MediaGraph : global::Pulumi.CustomResource
    {
        ...
        public MediaGraph(string name, MediaGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media:MediaGraph", name, args ?? new MediaGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MediaGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media:MediaGraph", name, null, MakeResourceOptions(options, id))
        {
        }
