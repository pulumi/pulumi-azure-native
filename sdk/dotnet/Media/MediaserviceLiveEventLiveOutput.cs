...
namespace Pulumi.AzureRM.Media
{
    ...
    public partial class MediaserviceLiveEventLiveOutput : Pulumi.CustomResource
    {
        ...
        private MediaserviceLiveEventLiveOutput(string name, Input<string> id, MediaserviceLiveEventLiveOutputState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:media:MediaserviceLiveEventLiveOutput", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MediaserviceLiveEventLiveOutput Get(string name, Input<string> id, MediaserviceLiveEventLiveOutputState? state = null, CustomResourceOptions? options = null)
        {
            return new MediaserviceLiveEventLiveOutput(name, id, state, options);
        }
    }
    ...
    public sealed class MediaserviceLiveEventLiveOutputState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the resource
        /// </summary>
        ...
        public Input<Inputs.LiveOutputPropertiesResponseGetArgs> Properties { get; set; } = null!;
        ...
        public MediaserviceLiveEventLiveOutputState()
        {
        }
    }
}
