...
namespace Pulumi.AzureNative.Media.V20220701
{
    ...
    /// {
    ///     var job = new AzureNative.Media.V20220701.Job("job", new()
    ///     {
    ...
    ///             { "key1", "value1" },
    ///         },
    ///         Input = new AzureNative.Media.V20220701.Inputs.JobInputAssetArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20220701:Job")]
    public partial class Job : global::Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220701:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220701:Job", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class JobArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20220701.Priority>? Priority { get; set; }
