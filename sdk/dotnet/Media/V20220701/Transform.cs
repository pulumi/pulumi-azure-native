...
namespace Pulumi.AzureNative.Media.V20220701
{
    ...
    /// {
    ///     var transform = new AzureNative.Media.V20220701.Transform("transform", new()
    ///     {
    ///         AccountName = "contosomedia",
    ///         Description = "Example Transform to illustrate create and update.",
    ///         Outputs = new[]
    ///         {
    ///             new AzureNative.Media.V20220701.Inputs.TransformOutputArgs
    ///             {
    ///                 Preset = new AzureNative.Media.V20220701.Inputs.BuiltInStandardEncoderPresetArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20220701:Transform")]
    public partial class Transform : global::Pulumi.CustomResource
    {
        ...
        public Transform(string name, TransformArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220701:Transform", name, args ?? new TransformArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Transform(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220701:Transform", name, null, MakeResourceOptions(options, id))
        {
        }
