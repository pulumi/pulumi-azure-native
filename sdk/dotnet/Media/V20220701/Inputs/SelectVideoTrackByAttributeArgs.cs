...
namespace Pulumi.AzureNative.Media.V20220701.Inputs
{
    ...
    public sealed class SelectVideoTrackByAttributeArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.V20220701.TrackAttribute> Attribute { get; set; } = null!;

        /// <summary>
        /// The type of AttributeFilter to apply to the TrackAttribute in order to select the tracks.
        /// </summary>
        [Input("filter", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Media.V20220701.AttributeFilter> Filter { get; set; } = null!;
