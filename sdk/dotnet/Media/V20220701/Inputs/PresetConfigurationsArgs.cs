...
namespace Pulumi.AzureNative.Media.V20220701.Inputs
{
    ...
    public sealed class PresetConfigurationsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("complexity")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20220701.Complexity>? Complexity { get; set; }

        /// <summary>
        /// Sets the interleave mode of the output to control how audio and video are stored in the container format. Example: set InterleavedOutput as NonInterleavedOutput to produce audio-only and video-only outputs in separate MP4 files.
        /// </summary>
        [Input("interleaveOutput")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20220701.InterleaveOutput>? InterleaveOutput { get; set; }
