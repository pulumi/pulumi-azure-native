...
namespace Pulumi.AzureNative.Media.V20220701
{
    public static class GetTransform
    {
        ...
        public static Task<GetTransformResult> InvokeAsync(GetTransformArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTransformResult>("azure-native:media/v20220701:getTransform", args ?? new GetTransformArgs(), options.WithDefaults());
