...
namespace Pulumi.AzureNative.Media.V20151001
{
    ...
    public partial class MediaService : Pulumi.CustomResource
    {
        ...
        public MediaService(string name, MediaServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20151001:MediaService", name, args ?? new MediaServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MediaService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20151001:MediaService", name, null, MakeResourceOptions(options, id))
        {
        }
