...
namespace Pulumi.AzureNative.Media.V20230101
{
    ...
    /// {
    ///     var contentKeyPolicy = new AzureNative.Media.V20230101.ContentKeyPolicy("contentKeyPolicy", new()
    ///     {
    ...
    ///         Options = new[]
    ///         {
    ///             new AzureNative.Media.V20230101.Inputs.ContentKeyPolicyOptionArgs
    ///             {
    ///                 Configuration = new AzureNative.Media.V20230101.Inputs.ContentKeyPolicyClearKeyConfigurationArgs
    ///                 {
    ///                     OdataType = "#Microsoft.Media.ContentKeyPolicyClearKeyConfiguration",
    ///                 },
    ///                 Name = "ClearKeyOption",
    ///                 Restriction = new AzureNative.Media.V20230101.Inputs.ContentKeyPolicyTokenRestrictionArgs
    ///                 {
    ///                     Audience = "urn:audience",
    ///                     Issuer = "urn:issuer",
    ///                     OdataType = "#Microsoft.Media.ContentKeyPolicyTokenRestriction",
    ///                     PrimaryVerificationKey = new AzureNative.Media.V20230101.Inputs.ContentKeyPolicySymmetricTokenKeyArgs
    ///                     {
    ...
    ///             new AzureNative.Media.V20230101.Inputs.ContentKeyPolicyOptionArgs
    ///             {
    ///                 Configuration = new AzureNative.Media.V20230101.Inputs.ContentKeyPolicyPlayReadyConfigurationArgs
    ///                 {
    ///                     Licenses = new[]
    ///                     {
    ///                         new AzureNative.Media.V20230101.Inputs.ContentKeyPolicyPlayReadyLicenseArgs
    ///                         {
    ///                             AllowTestDevices = true,
    ///                             BeginDate = "2017-10-16T18:22:53.46Z",
    ///                             ContentKeyLocation = new AzureNative.Media.V20230101.Inputs.ContentKeyPolicyPlayReadyContentEncryptionKeyFromHeaderArgs
    ///                             {
    ///                                 OdataType = "#Microsoft.Media.ContentKeyPolicyPlayReadyContentEncryptionKeyFromHeader",
    ///                             },
    ///                             ContentType = "UltraVioletDownload",
    ///                             LicenseType = "Persistent",
    ///                             PlayRight = new AzureNative.Media.V20230101.Inputs.ContentKeyPolicyPlayReadyPlayRightArgs
    ///                             {
    ...
    ///                 Restriction = new AzureNative.Media.V20230101.Inputs.ContentKeyPolicyOpenRestrictionArgs
    ///                 {
    ...
    ///             new AzureNative.Media.V20230101.Inputs.ContentKeyPolicyOptionArgs
    ///             {
    ///                 Configuration = new AzureNative.Media.V20230101.Inputs.ContentKeyPolicyWidevineConfigurationArgs
    ///                 {
    ...
    ///                     {
    ///                         new AzureNative.Media.V20230101.Inputs.ContentKeyPolicySymmetricTokenKeyArgs
    ///                         {
    ///                             KeyValue = "AAAAAAAAAAAAAAAAAAAAAA==",
    ///                             OdataType = "#Microsoft.Media.ContentKeyPolicySymmetricTokenKey",
    ///                         },
    ...
    ///                     Issuer = "urn:issuer",
    ///                     OdataType = "#Microsoft.Media.ContentKeyPolicyTokenRestriction",
    ///                     PrimaryVerificationKey = new AzureNative.Media.V20230101.Inputs.ContentKeyPolicyRsaTokenKeyArgs
    ///                     {
    ///                         Exponent = "AQAB",
    ///                         Modulus = "AQAD",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:media/v20230101:ContentKeyPolicy PolicyCreatedWithMultipleOptions /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/contosorg/providers/Microsoft.Media/mediaservices/contosomedia/contentKeyPolicies/PolicyCreatedWithMultipleOptions 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20230101:ContentKeyPolicy")]
    public partial class ContentKeyPolicy : global::Pulumi.CustomResource
    {
        ...
        public ContentKeyPolicy(string name, ContentKeyPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20230101:ContentKeyPolicy", name, args ?? new ContentKeyPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentKeyPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20230101:ContentKeyPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
