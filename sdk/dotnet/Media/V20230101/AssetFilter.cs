...
namespace Pulumi.AzureNative.Media.V20230101
{
    ...
    /// {
    ///     var assetFilter = new AzureNative.Media.V20230101.AssetFilter("assetFilter", new()
    ///     {
    ///         AccountName = "contosomedia",
    ///         AssetName = "ClimbingMountRainer",
    ///         FilterName = "newAssetFilter",
    ///         FirstQuality = new AzureNative.Media.V20230101.Inputs.FirstQualityArgs
    ///         {
    ///             Bitrate = 128000,
    ///         },
    ///         PresentationTimeRange = new AzureNative.Media.V20230101.Inputs.PresentationTimeRangeArgs
    ///         {
    ...
    ///         Tracks = new[]
    ///         {
    ///             new AzureNative.Media.V20230101.Inputs.FilterTrackSelectionArgs
    ///             {
    ///                 TrackSelections = new[]
    ///                 {
    ///                     new AzureNative.Media.V20230101.Inputs.FilterTrackPropertyConditionArgs
    ///                     {
    ///                         Operation = "Equal",
    ///                         Property = "Type",
    ///                         Value = "Audio",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20230101:AssetFilter")]
    public partial class AssetFilter : global::Pulumi.CustomResource
    {
        ...
        public AssetFilter(string name, AssetFilterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20230101:AssetFilter", name, args ?? new AssetFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssetFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20230101:AssetFilter", name, null, MakeResourceOptions(options, id))
        {
        }
