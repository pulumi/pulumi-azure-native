...
namespace Pulumi.AzureNative.Media.V20230101
{
    public static class GetAssetFilter
    {
        ...
        public static Task<GetAssetFilterResult> InvokeAsync(GetAssetFilterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssetFilterResult>("azure-native:media/v20230101:getAssetFilter", args ?? new GetAssetFilterArgs(), options.WithDefaults());
