...
namespace Pulumi.AzureNative.Media.V20230101
{
    public static class ListAssetContainerSas
    {
        ...
        public static Task<ListAssetContainerSasResult> InvokeAsync(ListAssetContainerSasArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAssetContainerSasResult>("azure-native:media/v20230101:listAssetContainerSas", args ?? new ListAssetContainerSasArgs(), options.WithDefaults());

        /// <summary>
        /// Lists storage container URLs with shared access signatures (SAS) for uploading and downloading Asset content. The signatures are derived from the storage account keys.
        /// </summary>
        public static Output<ListAssetContainerSasResult> Invoke(ListAssetContainerSasInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListAssetContainerSasResult>("azure-native:media/v20230101:listAssetContainerSas", args ?? new ListAssetContainerSasInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class ListAssetContainerSasArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("permissions")]
        public Union<string, Pulumi.AzureNative.Media.V20230101.AssetContainerPermission>? Permissions { get; set; }
    ...
    public sealed class ListAssetContainerSasInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("permissions")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20230101.AssetContainerPermission>? Permissions { get; set; }
