...
namespace Pulumi.AzureNative.Media.V20230101
{
    ...
    /// {
    ///     var streamingLocator = new AzureNative.Media.V20230101.StreamingLocator("streamingLocator", new()
    ///     {
    ...
    ///         ContentKeys = new[]
    ///         {
    ///             new AzureNative.Media.V20230101.Inputs.StreamingLocatorContentKeyArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:media/v20230101:StreamingLocator UserCreatedSecureStreamingLocatorWithUserDefinedContentKeys /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/contosorg/providers/Microsoft.Media/mediaservices/contosomedia/streamingLocators/UserCreatedSecureStreamingLocatorWithUserDefinedContentKeys 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20230101:StreamingLocator")]
    public partial class StreamingLocator : global::Pulumi.CustomResource
    {
        ...
        public StreamingLocator(string name, StreamingLocatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20230101:StreamingLocator", name, args ?? new StreamingLocatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingLocator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20230101:StreamingLocator", name, null, MakeResourceOptions(options, id))
        {
        }
