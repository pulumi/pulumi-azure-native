...
namespace Pulumi.AzureNative.Media.V20230101
{
    public static class GetAccountFilter
    {
        ...
        public static Task<GetAccountFilterResult> InvokeAsync(GetAccountFilterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountFilterResult>("azure-native:media/v20230101:getAccountFilter", args ?? new GetAccountFilterArgs(), options.WithDefaults());
