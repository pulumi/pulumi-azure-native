...
namespace Pulumi.AzureNative.Media.V20230101
{
    public static class GetStreamingPolicy
    {
        ...
        public static Task<GetStreamingPolicyResult> InvokeAsync(GetStreamingPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStreamingPolicyResult>("azure-native:media/v20230101:getStreamingPolicy", args ?? new GetStreamingPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Get the details of a Streaming Policy in the Media Services account
        /// </summary>
        public static Output<GetStreamingPolicyResult> Invoke(GetStreamingPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStreamingPolicyResult>("azure-native:media/v20230101:getStreamingPolicy", args ?? new GetStreamingPolicyInvokeArgs(), options.WithDefaults());
    }
