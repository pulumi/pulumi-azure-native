...
namespace Pulumi.AzureNative.Media.V20230101
{
    ...
    /// {
    ///     var accountFilter = new AzureNative.Media.V20230101.AccountFilter("accountFilter", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:media/v20230101:AccountFilter newAccountFilter /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/contosorg/providers/Microsoft.Media/mediaservices/contosomedia/accountFilters/newAccountFilter 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20230101:AccountFilter")]
    public partial class AccountFilter : global::Pulumi.CustomResource
    {
        ...
        public AccountFilter(string name, AccountFilterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20230101:AccountFilter", name, args ?? new AccountFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccountFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20230101:AccountFilter", name, null, MakeResourceOptions(options, id))
        {
        }
