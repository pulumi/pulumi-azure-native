...
namespace Pulumi.AzureNative.Media.V20230101
{
    public static class GetStreamingLocator
    {
        ...
        public static Task<GetStreamingLocatorResult> InvokeAsync(GetStreamingLocatorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStreamingLocatorResult>("azure-native:media/v20230101:getStreamingLocator", args ?? new GetStreamingLocatorArgs(), options.WithDefaults());
