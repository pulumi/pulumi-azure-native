...
namespace Pulumi.AzureRM.Media.Latest
{
    public static class ListAssetContainerSas
    {
        public static Task<ListAssetContainerSasResult> InvokeAsync(ListAssetContainerSasArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAssetContainerSasResult>("azurerm:media/latest:listAssetContainerSas", args ?? new ListAssetContainerSasArgs(), options.WithVersion());
    }
