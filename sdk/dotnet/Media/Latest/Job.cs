...
namespace Pulumi.AzureRM.Media.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var job = new AzureRM.Media.Latest.Job("job", new AzureRM.Media.Latest.JobArgs
    ///         {
    ...
    ///                 { "key1", "value1" },
    ///             },
    ///             Input = new AzureRM.Media.Latest.Inputs.JobInputArgs
    ///             {
    ...
    ///             Outputs = 
    ///             {
    ///                 new AzureRM.Media.Latest.Inputs.JobOutputArgs
    ///                 {
    ...
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/latest:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/latest:Job", name, null, MakeResourceOptions(options, id))
        {
        }
