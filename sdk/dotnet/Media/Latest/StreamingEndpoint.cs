...
namespace Pulumi.AzureNative.Media.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:media:StreamingEndpoint'.")]
    [AzureNativeResourceType("azure-native:media/latest:StreamingEndpoint")]
    public partial class StreamingEndpoint : Pulumi.CustomResource
    {
        ...
        public StreamingEndpoint(string name, StreamingEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/latest:StreamingEndpoint", name, args ?? new StreamingEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/latest:StreamingEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
