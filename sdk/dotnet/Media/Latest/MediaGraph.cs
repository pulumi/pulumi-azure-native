...
namespace Pulumi.AzureRM.Media.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var mediaGraph = new AzureRM.Media.Latest.MediaGraph("mediaGraph", new AzureRM.Media.Latest.MediaGraphArgs
    ///         {
    ...
    ///             Sinks = 
    ///             {
    ///                 new AzureRM.Media.Latest.Inputs.MediaGraphAssetSinkArgs
    ///                 {
    ...
    ///             Sources = 
    ///             {
    ///                 new AzureRM.Media.Latest.Inputs.MediaGraphRtspSourceArgs
    ///                 {
    ///                     Endpoint = 
    ///                     {
    ///                         { "@odata.type", "#Microsoft.Media.MediaGraphClearEndpoint" },
    ///                         { "credentials", new AzureRM.Media.Latest.Inputs.MediaGraphUsernamePasswordCredentialsArgs
    ///                         {
    ...
    ///                         {
    ///                             %!v(PANIC=Format method: interface conversion: model.Expression is *model.TemplateExpression, not *model.LiteralValueExpression) },
    ///                             { "trustedCertificates", new AzureRM.Media.Latest.Inputs.MediaGraphPemCertificateListArgs
    ///                             {
    ///                                 %!v(PANIC=Format method: interface conversion: model.Expression is *model.TemplateExpression, not *model.LiteralValueExpression) },
    ///                                 { "url", "rtsps://contoso.com:443/stream1" },
    ///                                 { "validationOptions", new AzureRM.Media.Latest.Inputs.MediaGraphTlsValidationOptionsArgs
    ///                                 {
    ///                                     IgnoreHostname = true,
    ...
    public partial class MediaGraph : Pulumi.CustomResource
    {
        ...
        public MediaGraph(string name, MediaGraphArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/latest:MediaGraph", name, args ?? new MediaGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MediaGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/latest:MediaGraph", name, null, MakeResourceOptions(options, id))
        {
        }
