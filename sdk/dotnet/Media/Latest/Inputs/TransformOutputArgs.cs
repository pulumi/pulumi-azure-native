...
namespace Pulumi.AzureNative.Media.Latest.Inputs
{
    ...
    public sealed class TransformOutputArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("onError")]
        public InputUnion<string, Pulumi.AzureNative.Media.Latest.OnErrorType>? OnError { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.Latest.Priority>? RelativePriority { get; set; }
