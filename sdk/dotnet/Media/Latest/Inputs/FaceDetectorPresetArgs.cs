...
namespace Pulumi.AzureNative.Media.Latest.Inputs
{
    ...
    public sealed class FaceDetectorPresetArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("blurType")]
        public InputUnion<string, Pulumi.AzureNative.Media.Latest.BlurType>? BlurType { get; set; }
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Media.Latest.FaceRedactorMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("resolution")]
        public InputUnion<string, Pulumi.AzureNative.Media.Latest.AnalysisResolution>? Resolution { get; set; }
