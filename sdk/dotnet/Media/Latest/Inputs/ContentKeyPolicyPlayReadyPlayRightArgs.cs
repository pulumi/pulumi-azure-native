...
namespace Pulumi.AzureNative.Media.Latest.Inputs
{
    ...
    public sealed class ContentKeyPolicyPlayReadyPlayRightArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.Latest.ContentKeyPolicyPlayReadyUnknownOutputPassingOption> AllowPassingVideoContentToUnknownOutput { get; set; } = null!;
