...
namespace Pulumi.AzureNative.Media.Latest.Inputs
{
    ...
    public sealed class H264LayerArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("entropyMode")]
        public InputUnion<string, Pulumi.AzureNative.Media.Latest.EntropyMode>? EntropyMode { get; set; }
        ...
        /// </summary>
        [Input("profile")]
        public InputUnion<string, Pulumi.AzureNative.Media.Latest.H264VideoProfile>? Profile { get; set; }
