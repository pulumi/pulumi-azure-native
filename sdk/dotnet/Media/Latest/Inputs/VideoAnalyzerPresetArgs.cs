...
namespace Pulumi.AzureNextGen.Media.Latest.Inputs
{
    ...
    public sealed class VideoAnalyzerPresetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Media.Latest.InsightsType>? InsightsToExtract { get; set; }

        /// <summary>
        /// Determines the set of audio analysis operations to be performed. If unspecified, the Standard AudioAnalysisMode would be chosen.
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNextGen.Media.Latest.AudioAnalysisMode>? Mode { get; set; }
