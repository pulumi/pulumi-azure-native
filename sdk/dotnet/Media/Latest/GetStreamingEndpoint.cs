...
namespace Pulumi.AzureRM.Media.Latest
{
    public static class GetStreamingEndpoint
    {
        public static Task<GetStreamingEndpointResult> InvokeAsync(GetStreamingEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamingEndpointResult>("azurerm:media/latest:getStreamingEndpoint", args ?? new GetStreamingEndpointArgs(), options.WithVersion());
    }
