...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:listMediaServiceKeys'.")]
    public static class ListMediaServiceKeys
    {
        ...
        public static Task<ListMediaServiceKeysResult> InvokeAsync(ListMediaServiceKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListMediaServiceKeysResult>("azure-native:media/latest:listMediaServiceKeys", args ?? new ListMediaServiceKeysArgs(), options.WithVersion());
    }
