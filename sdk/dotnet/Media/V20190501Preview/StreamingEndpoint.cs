...
namespace Pulumi.AzureNative.Media.V20190501Preview
{
    ...
    public partial class StreamingEndpoint : Pulumi.CustomResource
    {
        ...
        public StreamingEndpoint(string name, StreamingEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20190501preview:StreamingEndpoint", name, args ?? new StreamingEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20190501preview:StreamingEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
