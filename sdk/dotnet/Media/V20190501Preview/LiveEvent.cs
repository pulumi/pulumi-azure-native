...
namespace Pulumi.AzureRM.Media.V20190501Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var liveEvent = new AzureRM.Media.V20190501Preview.LiveEvent("liveEvent", new AzureRM.Media.V20190501Preview.LiveEventArgs
    ///         {
    ///             AccountName = "slitestmedia10",
    ///             Description = "test event 1",
    ///             Input = new AzureRM.Media.V20190501Preview.Inputs.LiveEventInputArgs
    ///             {
    ...
    ///             Location = "West US",
    ///             Preview = new AzureRM.Media.V20190501Preview.Inputs.LiveEventPreviewArgs
    ///             {
    ///                 AccessControl = new AzureRM.Media.V20190501Preview.Inputs.LiveEventPreviewAccessControlArgs
    ///                 {
    ...
    public partial class LiveEvent : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.LiveEventTranscriptionResponseResult>> Transcriptions { get; private set; } = null!;
        ...
        public LiveEvent(string name, LiveEventArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/v20190501preview:LiveEvent", name, args ?? new LiveEventArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LiveEvent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/v20190501preview:LiveEvent", name, null, MakeResourceOptions(options, id))
        {
        }
