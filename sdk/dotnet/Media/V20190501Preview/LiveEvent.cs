...
namespace Pulumi.AzureNextGen.Media.V20190501Preview
{
    ...
    /// The Live Event.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:media/v20190501preview:LiveEvent")]
    public partial class LiveEvent : Pulumi.CustomResource
    {
        ...
        public LiveEvent(string name, LiveEventArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:media/v20190501preview:LiveEvent", name, args ?? new LiveEventArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LiveEvent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:media/v20190501preview:LiveEvent", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LiveEventArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("streamOptions")]
        private InputList<Union<string, Pulumi.AzureNextGen.Media.V20190501Preview.StreamOptionsFlag>>? _streamOptions;

        /// <summary>
        /// The options to use for the LiveEvent.  This value is specified at creation time and cannot be updated.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.Media.V20190501Preview.StreamOptionsFlag>> StreamOptions
        {
            get => _streamOptions ?? (_streamOptions = new InputList<Union<string, Pulumi.AzureNextGen.Media.V20190501Preview.StreamOptionsFlag>>());
