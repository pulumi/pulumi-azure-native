...
namespace Pulumi.AzureNative.Media.V20180701
{
    ...
    /// An Asset Filter.
    /// </summary>
    [Obsolete(@"azure-native:media/v20180701:AssetFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:AssetFilter to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:media/v20180701:AssetFilter")]
    public partial class AssetFilter : global::Pulumi.CustomResource
    {
        ...
        public AssetFilter(string name, AssetFilterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180701:AssetFilter", name, args ?? new AssetFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssetFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180701:AssetFilter", name, null, MakeResourceOptions(options, id))
        {
        }
