...
namespace Pulumi.AzureRM.Media.V20180701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var streamingEndpoint = new AzureRM.Media.V20180701.StreamingEndpoint("streamingEndpoint", new AzureRM.Media.V20180701.StreamingEndpointArgs
    ///         {
    ///             AccessControl = new AzureRM.Media.V20180701.Inputs.StreamingEndpointAccessControlArgs
    ///             {
    ///                 Akamai = new AzureRM.Media.V20180701.Inputs.AkamaiAccessControlArgs
    ///                 {
    ///                     AkamaiSignatureHeaderAuthenticationKeyList = 
    ///                     {
    ///                         new AzureRM.Media.V20180701.Inputs.AkamaiSignatureHeaderAuthenticationKeyArgs
    ///                         {
    ...
    public partial class StreamingEndpoint : Pulumi.CustomResource
    {
        ...
        public StreamingEndpoint(string name, StreamingEndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180701:StreamingEndpoint", name, args ?? new StreamingEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180701:StreamingEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
