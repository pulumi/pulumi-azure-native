...
namespace Pulumi.AzureNextGen.Media.V20180701
{
    ...
    /// The Live Output.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:media/v20180701:LiveOutput")]
    public partial class LiveOutput : Pulumi.CustomResource
    {
        ...
        public LiveOutput(string name, LiveOutputArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:media/v20180701:LiveOutput", name, args ?? new LiveOutputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LiveOutput(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:media/v20180701:LiveOutput", name, null, MakeResourceOptions(options, id))
        {
        }
