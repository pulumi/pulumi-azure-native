...
namespace Pulumi.AzureNative.Media.V20180701.Inputs
{
    ...
    public sealed class DeinterlaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20180701.DeinterlaceMode>? Mode { get; set; }

        /// <summary>
        /// The field parity for de-interlacing, defaults to Auto.
        /// </summary>
        [Input("parity")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20180701.DeinterlaceParity>? Parity { get; set; }
