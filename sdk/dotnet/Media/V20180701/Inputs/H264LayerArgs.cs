...
namespace Pulumi.AzureNextGen.Media.V20180701.Inputs
{
    ...
    public sealed class H264LayerArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("entropyMode")]
        public InputUnion<string, Pulumi.AzureNextGen.Media.V20180701.EntropyMode>? EntropyMode { get; set; }
        ...
        /// </summary>
        [Input("profile")]
        public InputUnion<string, Pulumi.AzureNextGen.Media.V20180701.H264VideoProfile>? Profile { get; set; }
