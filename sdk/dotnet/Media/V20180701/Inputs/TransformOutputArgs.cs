...
namespace Pulumi.AzureNative.Media.V20180701.Inputs
{
    ...
    public sealed class TransformOutputArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("onError")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20180701.OnErrorType>? OnError { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.V20180701.Priority>? RelativePriority { get; set; }
