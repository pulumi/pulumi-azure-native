...
namespace Pulumi.AzureNative.Media.V20180701
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:media/v20180701:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Job to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:media/v20180701:Job")]
    public partial class Job : global::Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180701:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180701:Job", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class JobArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20180701.Priority>? Priority { get; set; }
