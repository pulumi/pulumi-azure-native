...
namespace Pulumi.AzureNative.Media.V20180701
{
    public static class GetStreamingPolicy
    {
        ...
        public static Output<GetStreamingPolicyResult> Invoke(GetStreamingPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStreamingPolicyResult>("azure-native:media/v20180701:getStreamingPolicy", args ?? new GetStreamingPolicyInvokeArgs(), options.WithVersion());
    }
