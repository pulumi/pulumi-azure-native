...
namespace Pulumi.AzureRM.Media.V20180701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var accountFilter = new AzureRM.Media.V20180701.AccountFilter("accountFilter", new AzureRM.Media.V20180701.AccountFilterArgs
    ///         {
    ...
    public partial class AccountFilter : Pulumi.CustomResource
    {
        ...
        public AccountFilter(string name, AccountFilterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180701:AccountFilter", name, args ?? new AccountFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccountFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180701:AccountFilter", name, null, MakeResourceOptions(options, id))
        {
        }
