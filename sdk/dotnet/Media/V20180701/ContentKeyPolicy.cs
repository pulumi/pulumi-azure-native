...
namespace Pulumi.AzureNative.Media.V20180701
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:media/v20180701:ContentKeyPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:ContentKeyPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:media/v20180701:ContentKeyPolicy")]
    public partial class ContentKeyPolicy : global::Pulumi.CustomResource
    {
        ...
        public ContentKeyPolicy(string name, ContentKeyPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180701:ContentKeyPolicy", name, args ?? new ContentKeyPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentKeyPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180701:ContentKeyPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
