...
namespace Pulumi.AzureRM.Media.V20180701
{
    public static class GetAccountFilter
    {
        public static Task<GetAccountFilterResult> InvokeAsync(GetAccountFilterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountFilterResult>("azurerm:media/v20180701:getAccountFilter", args ?? new GetAccountFilterArgs(), options.WithVersion());
    }
