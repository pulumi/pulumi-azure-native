...
namespace Pulumi.AzureNative.Media.V20180701
{
    public static class GetAccountFilter
    {
        ...
        public static Task<GetAccountFilterResult> InvokeAsync(GetAccountFilterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountFilterResult>("azure-native:media/v20180701:getAccountFilter", args ?? new GetAccountFilterArgs(), options.WithDefaults());

        /// <summary>
        /// An Account Filter.
        /// </summary>
        public static Output<GetAccountFilterResult> Invoke(GetAccountFilterInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAccountFilterResult>("azure-native:media/v20180701:getAccountFilter", args ?? new GetAccountFilterInvokeArgs(), options.WithDefaults());
    }
