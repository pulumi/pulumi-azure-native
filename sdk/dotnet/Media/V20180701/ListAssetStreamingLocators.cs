...
namespace Pulumi.AzureRM.Media.V20180701
{
    public static class ListAssetStreamingLocators
    {
        public static Task<ListAssetStreamingLocatorsResult> InvokeAsync(ListAssetStreamingLocatorsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAssetStreamingLocatorsResult>("azurerm:media/v20180701:listAssetStreamingLocators", args ?? new ListAssetStreamingLocatorsArgs(), options.WithVersion());
    }
