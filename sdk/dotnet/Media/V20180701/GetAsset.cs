...
namespace Pulumi.AzureNative.Media.V20180701
{
    public static class GetAsset
    {
        ...
        public static Task<GetAssetResult> InvokeAsync(GetAssetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssetResult>("azure-native:media/v20180701:getAsset", args ?? new GetAssetArgs(), options.WithDefaults());

        /// <summary>
        /// Get the details of an Asset in the Media Services account
        /// </summary>
        public static Output<GetAssetResult> Invoke(GetAssetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssetResult>("azure-native:media/v20180701:getAsset", args ?? new GetAssetInvokeArgs(), options.WithDefaults());
