...
namespace Pulumi.AzureRM.Media.V20180701
{
    public static class ListAssetContainerSas
    {
        public static Task<ListAssetContainerSasResult> InvokeAsync(ListAssetContainerSasArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAssetContainerSasResult>("azurerm:media/v20180701:listAssetContainerSas", args ?? new ListAssetContainerSasArgs(), options.WithVersion());
    }
