...
namespace Pulumi.AzureNative.Media.V20180701
{
    ...
    public partial class StreamingLocator : Pulumi.CustomResource
    {
        ...
        public StreamingLocator(string name, StreamingLocatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180701:StreamingLocator", name, args ?? new StreamingLocatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingLocator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180701:StreamingLocator", name, null, MakeResourceOptions(options, id))
        {
        }
