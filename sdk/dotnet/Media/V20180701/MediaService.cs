...
namespace Pulumi.AzureNextGen.Media.V20180701
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:media/v20180701:MediaService")]
    public partial class MediaService : Pulumi.CustomResource
    {
        ...
        public MediaService(string name, MediaServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:media/v20180701:MediaService", name, args ?? new MediaServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MediaService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:media/v20180701:MediaService", name, null, MakeResourceOptions(options, id))
        {
        }
