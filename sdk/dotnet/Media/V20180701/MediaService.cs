...
namespace Pulumi.AzureNative.Media.V20180701
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:media/v20180701:MediaService is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:MediaService to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:media/v20180701:MediaService")]
    public partial class MediaService : global::Pulumi.CustomResource
    {
        ...
        public MediaService(string name, MediaServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180701:MediaService", name, args ?? new MediaServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MediaService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180701:MediaService", name, null, MakeResourceOptions(options, id))
        {
        }
