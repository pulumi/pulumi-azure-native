...
namespace Pulumi.AzureNative.Media.V20180701
{
    public static class GetMediaService
    {
        ...
        public static Output<GetMediaServiceResult> Invoke(GetMediaServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMediaServiceResult>("azure-native:media/v20180701:getMediaService", args ?? new GetMediaServiceInvokeArgs(), options.WithVersion());
    }
