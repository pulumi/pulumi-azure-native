...
namespace Pulumi.AzureNative.Media.V20220801.Inputs
{
    ...
    public sealed class LiveEventEncodingArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("encodingType")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20220801.LiveEventEncodingType>? EncodingType { get; set; }
        ...
        /// </summary>
        [Input("stretchMode")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20220801.StretchMode>? StretchMode { get; set; }
