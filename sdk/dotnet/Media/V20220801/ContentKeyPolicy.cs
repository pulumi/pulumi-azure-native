...
namespace Pulumi.AzureNative.Media.V20220801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20220801:ContentKeyPolicy")]
    public partial class ContentKeyPolicy : global::Pulumi.CustomResource
    {
        ...
        public ContentKeyPolicy(string name, ContentKeyPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220801:ContentKeyPolicy", name, args ?? new ContentKeyPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentKeyPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220801:ContentKeyPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
