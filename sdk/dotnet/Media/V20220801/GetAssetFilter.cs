...
namespace Pulumi.AzureNative.Media.V20220801
{
    ...
    public static class GetAssetFilter
    {
        ...
        public static Task<GetAssetFilterResult> InvokeAsync(GetAssetFilterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssetFilterResult>("azure-native:media/v20220801:getAssetFilter", args ?? new GetAssetFilterArgs(), options.WithDefaults());

        /// <summary>
        /// Get the details of an Asset Filter associated with the specified Asset.
        /// </summary>
        public static Output<GetAssetFilterResult> Invoke(GetAssetFilterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssetFilterResult>("azure-native:media/v20220801:getAssetFilter", args ?? new GetAssetFilterInvokeArgs(), options.WithDefaults());
    }
