...
namespace Pulumi.AzureNative.Media.V20220801
{
    ...
    /// The Live Output.
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20220801:LiveOutput")]
    public partial class LiveOutput : global::Pulumi.CustomResource
    {
        ...
        public LiveOutput(string name, LiveOutputArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220801:LiveOutput", name, args ?? new LiveOutputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LiveOutput(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220801:LiveOutput", name, null, MakeResourceOptions(options, id))
        {
        }
