...
namespace Pulumi.AzureNative.Media.V20220801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20220801:StreamingLocator")]
    public partial class StreamingLocator : global::Pulumi.CustomResource
    {
        ...
        public StreamingLocator(string name, StreamingLocatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220801:StreamingLocator", name, args ?? new StreamingLocatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingLocator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220801:StreamingLocator", name, null, MakeResourceOptions(options, id))
        {
        }
