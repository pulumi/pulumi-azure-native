...
namespace Pulumi.AzureNative.Media.V20220801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20220801:StreamingEndpoint")]
    public partial class StreamingEndpoint : global::Pulumi.CustomResource
    {
        ...
        public StreamingEndpoint(string name, StreamingEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220801:StreamingEndpoint", name, args ?? new StreamingEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220801:StreamingEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
