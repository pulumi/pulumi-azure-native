...
namespace Pulumi.AzureNative.Media.V20220801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20220801:Track")]
    public partial class Track : global::Pulumi.CustomResource
    {
        ...
        public Track(string name, TrackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220801:Track", name, args ?? new TrackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Track(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20220801:Track", name, null, MakeResourceOptions(options, id))
        {
        }
