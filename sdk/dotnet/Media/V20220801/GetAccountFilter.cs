...
namespace Pulumi.AzureNative.Media.V20220801
{
    public static class GetAccountFilter
    {
        ...
        public static Task<GetAccountFilterResult> InvokeAsync(GetAccountFilterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountFilterResult>("azure-native:media/v20220801:getAccountFilter", args ?? new GetAccountFilterArgs(), options.WithDefaults());

        /// <summary>
        /// Get the details of an Account Filter in the Media Services account.
        /// </summary>
        public static Output<GetAccountFilterResult> Invoke(GetAccountFilterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccountFilterResult>("azure-native:media/v20220801:getAccountFilter", args ?? new GetAccountFilterInvokeArgs(), options.WithDefaults());
    }
