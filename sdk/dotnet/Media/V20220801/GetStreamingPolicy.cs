...
namespace Pulumi.AzureNative.Media.V20220801
{
    public static class GetStreamingPolicy
    {
        ...
        public static Task<GetStreamingPolicyResult> InvokeAsync(GetStreamingPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamingPolicyResult>("azure-native:media/v20220801:getStreamingPolicy", args ?? new GetStreamingPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// A Streaming Policy resource
        /// </summary>
        public static Output<GetStreamingPolicyResult> Invoke(GetStreamingPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStreamingPolicyResult>("azure-native:media/v20220801:getStreamingPolicy", args ?? new GetStreamingPolicyInvokeArgs(), options.WithDefaults());
    }
