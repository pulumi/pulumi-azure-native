...
namespace Pulumi.AzureNextGen.Media
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:media:Asset")]
    public partial class Asset : Pulumi.CustomResource
    {
        ...
        public Asset(string name, AssetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:media:Asset", name, args ?? new AssetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Asset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:media:Asset", name, null, MakeResourceOptions(options, id))
        {
        }
