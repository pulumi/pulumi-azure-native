...
namespace Pulumi.AzureRM.Media.Preview
{
    public static class GetStreamingPolicy
    {
        public static Task<GetStreamingPolicyResult> InvokeAsync(GetStreamingPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamingPolicyResult>("azurerm:media/preview:getStreamingPolicy", args ?? new GetStreamingPolicyArgs(), options.WithVersion());
    }
