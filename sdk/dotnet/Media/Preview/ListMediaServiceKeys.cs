...
namespace Pulumi.AzureRM.Media.Preview
{
    public static class ListMediaServiceKeys
    {
        public static Task<ListMediaServiceKeysResult> InvokeAsync(ListMediaServiceKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListMediaServiceKeysResult>("azurerm:media/preview:listMediaServiceKeys", args ?? new ListMediaServiceKeysArgs(), options.WithVersion());
    }
