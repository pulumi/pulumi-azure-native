...
namespace Pulumi.AzureRM.Media.Preview
{
    public static class GetAccountFilter
    {
        public static Task<GetAccountFilterResult> InvokeAsync(GetAccountFilterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountFilterResult>("azurerm:media/preview:getAccountFilter", args ?? new GetAccountFilterArgs(), options.WithVersion());
    }
