...
namespace Pulumi.AzureNative.Media.V20211101.Inputs
{
    ...
    public sealed class TrackPropertyConditionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.V20211101.TrackPropertyCompareOperation> Operation { get; set; } = null!;

        /// <summary>
        /// Track property type
        /// </summary>
        [Input("property", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Media.V20211101.TrackPropertyType> Property { get; set; } = null!;
