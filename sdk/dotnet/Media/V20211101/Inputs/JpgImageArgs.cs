...
namespace Pulumi.AzureNative.Media.V20211101.Inputs
{
    ...
    public sealed class JpgImageArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("stretchMode")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20211101.StretchMode>? StretchMode { get; set; }

        /// <summary>
        /// The Video Sync Mode
        /// </summary>
        [Input("syncMode")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20211101.VideoSyncMode>? SyncMode { get; set; }
