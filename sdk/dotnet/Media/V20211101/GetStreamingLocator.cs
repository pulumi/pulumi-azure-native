...
namespace Pulumi.AzureNative.Media.V20211101
{
    ...
    public static class GetStreamingLocator
    {
        ...
        public static Task<GetStreamingLocatorResult> InvokeAsync(GetStreamingLocatorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStreamingLocatorResult>("azure-native:media/v20211101:getStreamingLocator", args ?? new GetStreamingLocatorArgs(), options.WithDefaults());

        /// <summary>
        /// Get the details of a Streaming Locator in the Media Services account
        /// </summary>
        public static Output<GetStreamingLocatorResult> Invoke(GetStreamingLocatorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStreamingLocatorResult>("azure-native:media/v20211101:getStreamingLocator", args ?? new GetStreamingLocatorInvokeArgs(), options.WithDefaults());
    }
