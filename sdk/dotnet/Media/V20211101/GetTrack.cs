...
{
    [Obsolete(@"azure-native:media/v20211101:Track is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Track to guarantee forwards compatibility.")]
    public static class GetTrack
    {
        ...
        public static Task<GetTrackResult> InvokeAsync(GetTrackArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTrackResult>("azure-native:media/v20211101:getTrack", args ?? new GetTrackArgs(), options.WithDefaults());

        /// <summary>
        /// Get the details of a Track in the Asset
        /// </summary>
        public static Output<GetTrackResult> Invoke(GetTrackInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTrackResult>("azure-native:media/v20211101:getTrack", args ?? new GetTrackInvokeArgs(), options.WithDefaults());
    }
