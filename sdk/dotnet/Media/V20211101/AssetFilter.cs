...
namespace Pulumi.AzureNative.Media.V20211101
{
    ...
    public partial class AssetFilter : global::Pulumi.CustomResource
    {
        ...
        public AssetFilter(string name, AssetFilterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:AssetFilter", name, args ?? new AssetFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssetFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:AssetFilter", name, null, MakeResourceOptions(options, id))
        {
        }
