...
namespace Pulumi.AzureNative.Media.V20211101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20211101:StreamingEndpoint")]
    public partial class StreamingEndpoint : global::Pulumi.CustomResource
    {
        ...
        public StreamingEndpoint(string name, StreamingEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:StreamingEndpoint", name, args ?? new StreamingEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:StreamingEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
