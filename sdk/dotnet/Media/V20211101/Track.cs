...
namespace Pulumi.AzureNative.Media.V20211101
{
    ...
    /// {
    ///     var track = new AzureNative.Media.V20211101.Track("track", new()
    ///     {
    ///         AccountName = "contosomedia",
    ///         AssetName = "ClimbingMountRainer",
    ///         ResourceGroupName = "contoso",
    ///         Track = new AzureNative.Media.V20211101.Inputs.TextTrackArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20211101:Track")]
    public partial class Track : global::Pulumi.CustomResource
    {
        ...
        public Track(string name, TrackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:Track", name, args ?? new TrackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Track(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:Track", name, null, MakeResourceOptions(options, id))
        {
        }
