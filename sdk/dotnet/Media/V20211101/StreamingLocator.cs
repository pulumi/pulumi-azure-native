...
namespace Pulumi.AzureNative.Media.V20211101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:media/v20211101:StreamingLocator is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:StreamingLocator to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:media/v20211101:StreamingLocator")]
    public partial class StreamingLocator : global::Pulumi.CustomResource
    {
        ...
        public StreamingLocator(string name, StreamingLocatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:StreamingLocator", name, args ?? new StreamingLocatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingLocator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:StreamingLocator", name, null, MakeResourceOptions(options, id))
        {
        }
