...
namespace Pulumi.AzureNative.Media.V20211101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20211101:StreamingPolicy")]
    public partial class StreamingPolicy : global::Pulumi.CustomResource
    {
        ...
        public StreamingPolicy(string name, StreamingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:StreamingPolicy", name, args ?? new StreamingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:StreamingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
