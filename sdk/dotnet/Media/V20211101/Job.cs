...
namespace Pulumi.AzureNative.Media.V20211101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20211101:Job")]
    public partial class Job : global::Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:Job", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class JobArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20211101.Priority>? Priority { get; set; }
