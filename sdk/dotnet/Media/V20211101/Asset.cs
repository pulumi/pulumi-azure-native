...
namespace Pulumi.AzureNative.Media.V20211101
{
    ...
    /// An Asset.
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20211101:Asset")]
    public partial class Asset : global::Pulumi.CustomResource
    {
        ...
        public Asset(string name, AssetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:Asset", name, args ?? new AssetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Asset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:Asset", name, null, MakeResourceOptions(options, id))
        {
        }
