...
namespace Pulumi.AzureNative.Media.V20211101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:media/v20211101:MediaService is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:MediaService to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:media/v20211101:MediaService")]
    public partial class MediaService : global::Pulumi.CustomResource
    {
        ...
        public MediaService(string name, MediaServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:MediaService", name, args ?? new MediaServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MediaService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20211101:MediaService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MediaServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.V20211101.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.V20211101.StorageAuthentication>? StorageAuthentication { get; set; }
