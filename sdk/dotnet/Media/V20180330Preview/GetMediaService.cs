...
namespace Pulumi.AzureNative.Media.V20180330Preview
{
    public static class GetMediaService
    {
        ...
        public static Task<GetMediaServiceResult> InvokeAsync(GetMediaServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMediaServiceResult>("azure-native:media/v20180330preview:getMediaService", args ?? new GetMediaServiceArgs(), options.WithVersion());

        /// <summary>
        /// A Media Services account.
        /// </summary>
        public static Output<GetMediaServiceResult> Invoke(GetMediaServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMediaServiceResult>("azure-native:media/v20180330preview:getMediaService", args ?? new GetMediaServiceInvokeArgs(), options.WithVersion());
    }
