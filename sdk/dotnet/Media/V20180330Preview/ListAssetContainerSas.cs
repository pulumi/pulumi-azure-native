...
namespace Pulumi.AzureNative.Media.V20180330Preview
{
    public static class ListAssetContainerSas
    {
        ...
        public static Task<ListAssetContainerSasResult> InvokeAsync(ListAssetContainerSasArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAssetContainerSasResult>("azure-native:media/v20180330preview:listAssetContainerSas", args ?? new ListAssetContainerSasArgs(), options.WithVersion());

        /// <summary>
        /// The Asset Storage container SAS URLs.
        /// </summary>
        public static Output<ListAssetContainerSasResult> Invoke(ListAssetContainerSasInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListAssetContainerSasResult>("azure-native:media/v20180330preview:listAssetContainerSas", args ?? new ListAssetContainerSasInvokeArgs(), options.WithVersion());
    }
    ...
    public sealed class ListAssetContainerSasArgs : Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("permissions")]
        public Union<string, Pulumi.AzureNative.Media.V20180330Preview.AssetContainerPermission>? Permissions { get; set; }
    ...
    public sealed class ListAssetContainerSasInvokeArgs : Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("permissions")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20180330Preview.AssetContainerPermission>? Permissions { get; set; }
