...
namespace Pulumi.AzureNative.Media.V20180330Preview
{
    ...
    /// The Live Event.
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20180330preview:LiveEvent")]
    public partial class LiveEvent : Pulumi.CustomResource
    {
        ...
        public LiveEvent(string name, LiveEventArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180330preview:LiveEvent", name, args ?? new LiveEventArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LiveEvent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180330preview:LiveEvent", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LiveEventArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("streamOptions")]
        private InputList<Pulumi.AzureNative.Media.V20180330Preview.StreamOptionsFlag>? _streamOptions;

        /// <summary>
        /// The stream options.
        /// </summary>
        public InputList<Pulumi.AzureNative.Media.V20180330Preview.StreamOptionsFlag> StreamOptions
        {
            get => _streamOptions ?? (_streamOptions = new InputList<Pulumi.AzureNative.Media.V20180330Preview.StreamOptionsFlag>());
