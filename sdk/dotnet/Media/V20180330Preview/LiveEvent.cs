...
namespace Pulumi.AzureRM.Media.V20180330Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var liveEvent = new AzureRM.Media.V20180330Preview.LiveEvent("liveEvent", new AzureRM.Media.V20180330Preview.LiveEventArgs
    ///         {
    ///             AccountName = "slitestmedia10",
    ///             Description = "test event 1",
    ///             Input = new AzureRM.Media.V20180330Preview.Inputs.LiveEventInputArgs
    ///             {
    ...
    ///             Location = "West US",
    ///             Preview = new AzureRM.Media.V20180330Preview.Inputs.LiveEventPreviewArgs
    ///             {
    ///                 AccessControl = new AzureRM.Media.V20180330Preview.Inputs.LiveEventPreviewAccessControlArgs
    ///                 {
    ///                     Ip = new AzureRM.Media.V20180330Preview.Inputs.IPAccessControlArgs
    ///                     {
    ///                         Allow = 
    ///                         {
    ///                             new AzureRM.Media.V20180330Preview.Inputs.IPRangeArgs
    ///                             {
    ///                                 Address = "0.0.0.0",
    ///                                 Name = "AllowAll",
    ///                             },
