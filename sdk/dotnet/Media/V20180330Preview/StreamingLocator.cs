...
namespace Pulumi.AzureNative.Media.V20180330Preview
{
    ...
    public partial class StreamingLocator : global::Pulumi.CustomResource
    {
        ...
        public StreamingLocator(string name, StreamingLocatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180330preview:StreamingLocator", name, args ?? new StreamingLocatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingLocator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180330preview:StreamingLocator", name, null, MakeResourceOptions(options, id))
        {
        }
