...
namespace Pulumi.AzureNative.Media.V20180330Preview
{
    ...
    /// The Live Output.
    /// </summary>
    [Obsolete(@"azure-native:media/v20180330preview:LiveOutput is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20221101:LiveOutput to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:media/v20180330preview:LiveOutput")]
    public partial class LiveOutput : global::Pulumi.CustomResource
    {
        ...
        public LiveOutput(string name, LiveOutputArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180330preview:LiveOutput", name, args ?? new LiveOutputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LiveOutput(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180330preview:LiveOutput", name, null, MakeResourceOptions(options, id))
        {
        }
