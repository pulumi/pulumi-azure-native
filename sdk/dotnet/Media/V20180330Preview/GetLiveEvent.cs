...
{
    [Obsolete(@"azure-native:media/v20180330preview:LiveEvent is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20180601preview:LiveEvent to guarantee forwards compatibility.")]
    public static class GetLiveEvent
    {
        ...
        public static Task<GetLiveEventResult> InvokeAsync(GetLiveEventArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLiveEventResult>("azure-native:media/v20180330preview:getLiveEvent", args ?? new GetLiveEventArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Live Event.
        /// </summary>
        public static Output<GetLiveEventResult> Invoke(GetLiveEventInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLiveEventResult>("azure-native:media/v20180330preview:getLiveEvent", args ?? new GetLiveEventInvokeArgs(), options.WithDefaults());
    }
