...
namespace Pulumi.AzureNative.Media.V20180330Preview
{
    public static class GetLiveOutput
    {
        ...
        public static Output<GetLiveOutputResult> Invoke(GetLiveOutputInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetLiveOutputResult>("azure-native:media/v20180330preview:getLiveOutput", args ?? new GetLiveOutputInvokeArgs(), options.WithVersion());
    }
