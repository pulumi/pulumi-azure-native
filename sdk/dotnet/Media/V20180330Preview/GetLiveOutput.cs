...
namespace Pulumi.AzureRM.Media.V20180330Preview
{
    public static class GetLiveOutput
    {
        public static Task<GetLiveOutputResult> InvokeAsync(GetLiveOutputArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLiveOutputResult>("azurerm:media/v20180330preview:getLiveOutput", args ?? new GetLiveOutputArgs(), options.WithVersion());
    }
