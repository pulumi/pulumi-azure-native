...
namespace Pulumi.AzureNextGen.Media.V20180330Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:media/v20180330preview:MediaService")]
    public partial class MediaService : Pulumi.CustomResource
    {
        ...
        public MediaService(string name, MediaServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:media/v20180330preview:MediaService", name, args ?? new MediaServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MediaService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:media/v20180330preview:MediaService", name, null, MakeResourceOptions(options, id))
        {
        }
