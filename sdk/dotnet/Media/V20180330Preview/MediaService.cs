...
namespace Pulumi.AzureNative.Media.V20180330Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:media/v20180330preview:MediaService is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:MediaService to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:media/v20180330preview:MediaService")]
    public partial class MediaService : global::Pulumi.CustomResource
    {
        ...
        public MediaService(string name, MediaServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180330preview:MediaService", name, args ?? new MediaServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MediaService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180330preview:MediaService", name, null, MakeResourceOptions(options, id))
        {
        }
