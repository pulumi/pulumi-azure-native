...
namespace Pulumi.AzureRM.Media.V20180330Preview
{
    public static class GetStreamingLocator
    {
        public static Task<GetStreamingLocatorResult> InvokeAsync(GetStreamingLocatorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamingLocatorResult>("azurerm:media/v20180330preview:getStreamingLocator", args ?? new GetStreamingLocatorArgs(), options.WithVersion());
    }
    ...
    public sealed class GetStreamingLocatorResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.StreamingLocatorUserDefinedContentKeyResponseResult> ContentKeys;
        /// <summary>
        ...
        private GetStreamingLocatorResult(
            ...
            ImmutableArray<Outputs.StreamingLocatorUserDefinedContentKeyResponseResult> contentKeys,
