...
namespace Pulumi.AzureNative.Media.V20180330Preview
{
    public static class GetStreamingEndpoint
    {
        ...
        public static Output<GetStreamingEndpointResult> Invoke(GetStreamingEndpointInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStreamingEndpointResult>("azure-native:media/v20180330preview:getStreamingEndpoint", args ?? new GetStreamingEndpointInvokeArgs(), options.WithVersion());
    }
