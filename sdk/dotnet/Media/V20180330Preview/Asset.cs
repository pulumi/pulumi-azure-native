...
namespace Pulumi.AzureRM.Media.V20180330Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var asset = new AzureRM.Media.V20180330Preview.Asset("asset", new AzureRM.Media.V20180330Preview.AssetArgs
    ///         {
    ...
    public partial class Asset : Pulumi.CustomResource
    {
        ...
        public Asset(string name, AssetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180330preview:Asset", name, args ?? new AssetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Asset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180330preview:Asset", name, null, MakeResourceOptions(options, id))
        {
        }
