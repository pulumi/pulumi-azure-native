...
namespace Pulumi.AzureNative.Media.V20180330Preview
{
    ...
    public partial class Asset : global::Pulumi.CustomResource
    {
        ...
        public Asset(string name, AssetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180330preview:Asset", name, args ?? new AssetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Asset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180330preview:Asset", name, null, MakeResourceOptions(options, id))
        {
        }
