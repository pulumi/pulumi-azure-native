...
namespace Pulumi.AzureNextGen.Media.V20180330Preview.Inputs
{
    ...
    public sealed class TransformOutputArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("onError")]
        public InputUnion<string, Pulumi.AzureNextGen.Media.V20180330Preview.OnErrorType>? OnError { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Media.V20180330Preview.Priority>? RelativePriority { get; set; }
