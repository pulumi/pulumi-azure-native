...
namespace Pulumi.AzureNative.Media.V20180330Preview.Inputs
{
    ...
    public sealed class TransformOutputArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("onError")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20180330Preview.OnErrorType>? OnError { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.V20180330Preview.Priority>? RelativePriority { get; set; }
