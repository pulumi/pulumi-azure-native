...
namespace Pulumi.AzureNative.Media.V20180330Preview.Inputs
{
    ...
    public sealed class H264LayerArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("entropyMode")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20180330Preview.EntropyMode>? EntropyMode { get; set; }
        ...
        /// </summary>
        [Input("profile")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20180330Preview.H264VideoProfile>? Profile { get; set; }
