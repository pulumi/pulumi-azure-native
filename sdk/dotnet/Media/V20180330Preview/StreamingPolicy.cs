...
namespace Pulumi.AzureNative.Media.V20180330Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20180330preview:StreamingPolicy")]
    public partial class StreamingPolicy : Pulumi.CustomResource
    {
        ...
        public StreamingPolicy(string name, StreamingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180330preview:StreamingPolicy", name, args ?? new StreamingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180330preview:StreamingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
