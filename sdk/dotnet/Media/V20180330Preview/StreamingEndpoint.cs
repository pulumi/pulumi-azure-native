...
namespace Pulumi.AzureRM.Media.V20180330Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var streamingEndpoint = new AzureRM.Media.V20180330Preview.StreamingEndpoint("streamingEndpoint", new AzureRM.Media.V20180330Preview.StreamingEndpointArgs
    ///         {
    ///             AccessControl = new AzureRM.Media.V20180330Preview.Inputs.StreamingEndpointAccessControlArgs
    ///             {
    ///                 Akamai = new AzureRM.Media.V20180330Preview.Inputs.AkamaiAccessControlArgs
    ///                 {
    ///                     AkamaiSignatureHeaderAuthenticationKeyList = 
    ///                     {
    ///                         new AzureRM.Media.V20180330Preview.Inputs.AkamaiSignatureHeaderAuthenticationKeyArgs
    ///                         {
    ...
    public partial class StreamingEndpoint : Pulumi.CustomResource
    {
        ...
        public StreamingEndpoint(string name, StreamingEndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180330preview:StreamingEndpoint", name, args ?? new StreamingEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180330preview:StreamingEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
