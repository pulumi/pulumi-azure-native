...
namespace Pulumi.AzureRM.Media.V20180601Preview
{
    public static class GetContentKeyPolicy
    {
        public static Task<GetContentKeyPolicyResult> InvokeAsync(GetContentKeyPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContentKeyPolicyResult>("azurerm:media/v20180601preview:getContentKeyPolicy", args ?? new GetContentKeyPolicyArgs(), options.WithVersion());
    }
