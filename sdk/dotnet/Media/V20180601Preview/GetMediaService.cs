...
namespace Pulumi.AzureRM.Media.V20180601Preview
{
    public static class GetMediaService
    {
        public static Task<GetMediaServiceResult> InvokeAsync(GetMediaServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMediaServiceResult>("azurerm:media/v20180601preview:getMediaService", args ?? new GetMediaServiceArgs(), options.WithVersion());
    }
