...
namespace Pulumi.AzureNextGen.Media.V20180601Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:media/v20180601preview:StreamingEndpoint")]
    public partial class StreamingEndpoint : Pulumi.CustomResource
    {
        ...
        public StreamingEndpoint(string name, StreamingEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:media/v20180601preview:StreamingEndpoint", name, args ?? new StreamingEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:media/v20180601preview:StreamingEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
