...
namespace Pulumi.AzureNextGen.Media.V20180601Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:media/v20180601preview:Transform")]
    public partial class Transform : Pulumi.CustomResource
    {
        ...
        public Transform(string name, TransformArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:media/v20180601preview:Transform", name, args ?? new TransformArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Transform(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:media/v20180601preview:Transform", name, null, MakeResourceOptions(options, id))
        {
        }
