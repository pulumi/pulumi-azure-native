...
namespace Pulumi.AzureRM.Media.V20180601Preview
{
    public static class GetLiveOutput
    {
        public static Task<GetLiveOutputResult> InvokeAsync(GetLiveOutputArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLiveOutputResult>("azurerm:media/v20180601preview:getLiveOutput", args ?? new GetLiveOutputArgs(), options.WithVersion());
    }
