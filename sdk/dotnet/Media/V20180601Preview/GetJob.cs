...
namespace Pulumi.AzureNative.Media.V20180601Preview
{
    public static class GetJob
    {
        ...
        public static Task<GetJobResult> InvokeAsync(GetJobArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJobResult>("azure-native:media/v20180601preview:getJob", args ?? new GetJobArgs(), options.WithVersion());

        /// <summary>
        /// A Job resource type. The progress and state can be obtained by polling a Job or subscribing to events using EventGrid.
        /// </summary>
        public static Output<GetJobResult> Invoke(GetJobInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetJobResult>("azure-native:media/v20180601preview:getJob", args ?? new GetJobInvokeArgs(), options.WithVersion());
    }
