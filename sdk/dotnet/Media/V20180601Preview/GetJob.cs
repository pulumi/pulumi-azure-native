...
{
    [Obsolete(@"azure-native:media/v20180601preview:Job is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20220701:Job to guarantee forwards compatibility.")]
    public static class GetJob
    {
        ...
        public static Task<GetJobResult> InvokeAsync(GetJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobResult>("azure-native:media/v20180601preview:getJob", args ?? new GetJobArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Job.
        /// </summary>
        public static Output<GetJobResult> Invoke(GetJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobResult>("azure-native:media/v20180601preview:getJob", args ?? new GetJobInvokeArgs(), options.WithDefaults());
    }
