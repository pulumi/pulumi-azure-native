...
namespace Pulumi.AzureRM.Media.V20180601Preview
{
    ...
    ///                         { "licenses", 
    ///                         {
    ///                             new AzureRM.Media.V20180601Preview.Inputs.ContentKeyPolicyPlayReadyLicenseArgs
    ///                             {
    ...
    ///                                 PlayRight = new AzureRM.Media.V20180601Preview.Inputs.ContentKeyPolicyPlayReadyPlayRightArgs
    ///                                 {
    ...
    public partial class ContentKeyPolicy : Pulumi.CustomResource
    {
        ...
        public ContentKeyPolicy(string name, ContentKeyPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180601preview:ContentKeyPolicy", name, args ?? new ContentKeyPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentKeyPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180601preview:ContentKeyPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
