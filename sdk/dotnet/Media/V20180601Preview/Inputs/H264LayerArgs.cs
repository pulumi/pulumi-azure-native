...
namespace Pulumi.AzureNative.Media.V20180601Preview.Inputs
{
    ...
    public sealed class H264LayerArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("entropyMode")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20180601Preview.EntropyMode>? EntropyMode { get; set; }
        ...
        /// </summary>
        [Input("profile")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20180601Preview.H264VideoProfile>? Profile { get; set; }
