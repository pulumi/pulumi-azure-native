...
namespace Pulumi.AzureNative.Media.V20180601Preview.Inputs
{
    ...
    public sealed class TransformOutputArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("onError")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20180601Preview.OnErrorType>? OnError { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Media.V20180601Preview.Priority>? RelativePriority { get; set; }
