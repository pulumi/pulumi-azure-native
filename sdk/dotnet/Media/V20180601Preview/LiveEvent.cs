...
namespace Pulumi.AzureNative.Media.V20180601Preview
{
    ...
    /// {
    ///     var liveEvent = new AzureNative.Media.V20180601Preview.LiveEvent("liveEvent", new()
    ///     {
    ///         AccountName = "slitestmedia10",
    ///         Description = "test event 1",
    ///         Input = new AzureNative.Media.V20180601Preview.Inputs.LiveEventInputArgs
    ///         {
    ///             KeyFrameIntervalDuration = "PT2S",
    ///             StreamingProtocol = AzureNative.Media.V20180601Preview.LiveEventInputProtocol.RTMP,
    ///         },
    ///         LiveEventName = "myLiveEvent1",
    ///         Location = "West US",
    ///         Preview = new AzureNative.Media.V20180601Preview.Inputs.LiveEventPreviewArgs
    ///         {
    ///             AccessControl = new AzureNative.Media.V20180601Preview.Inputs.LiveEventPreviewAccessControlArgs
    ///             {
    ...
    public partial class LiveEvent : global::Pulumi.CustomResource
    {
        ...
        public LiveEvent(string name, LiveEventArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180601preview:LiveEvent", name, args ?? new LiveEventArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LiveEvent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180601preview:LiveEvent", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LiveEventArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("streamOptions")]
        private InputList<Pulumi.AzureNative.Media.V20180601Preview.StreamOptionsFlag>? _streamOptions;

        /// <summary>
        /// The stream options.
        /// </summary>
        public InputList<Pulumi.AzureNative.Media.V20180601Preview.StreamOptionsFlag> StreamOptions
        {
            get => _streamOptions ?? (_streamOptions = new InputList<Pulumi.AzureNative.Media.V20180601Preview.StreamOptionsFlag>());
