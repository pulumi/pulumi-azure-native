...
namespace Pulumi.AzureRM.Media.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var liveEvent = new AzureRM.Media.V20180601Preview.LiveEvent("liveEvent", new AzureRM.Media.V20180601Preview.LiveEventArgs
    ///         {
    ///             AccountName = "slitestmedia10",
    ///             Description = "test event 1",
    ///             Input = new AzureRM.Media.V20180601Preview.Inputs.LiveEventInputArgs
    ///             {
    ...
    ///             Location = "West US",
    ///             Preview = new AzureRM.Media.V20180601Preview.Inputs.LiveEventPreviewArgs
    ///             {
    ///                 AccessControl = new AzureRM.Media.V20180601Preview.Inputs.LiveEventPreviewAccessControlArgs
    ///                 {
    ...
    public partial class LiveEvent : Pulumi.CustomResource
    {
        ...
        public LiveEvent(string name, LiveEventArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180601preview:LiveEvent", name, args ?? new LiveEventArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LiveEvent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180601preview:LiveEvent", name, null, MakeResourceOptions(options, id))
        {
        }
