...
namespace Pulumi.AzureRM.Media.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var asset = new AzureRM.Media.V20180601Preview.Asset("asset", new AzureRM.Media.V20180601Preview.AssetArgs
    ///         {
    ...
    public partial class Asset : Pulumi.CustomResource
    {
        ...
        public Asset(string name, AssetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180601preview:Asset", name, args ?? new AssetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Asset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180601preview:Asset", name, null, MakeResourceOptions(options, id))
        {
        }
