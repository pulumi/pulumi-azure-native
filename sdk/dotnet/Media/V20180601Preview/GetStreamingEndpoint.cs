...
namespace Pulumi.AzureNative.Media.V20180601Preview
{
    public static class GetStreamingEndpoint
    {
        ...
        public static Task<GetStreamingEndpointResult> InvokeAsync(GetStreamingEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamingEndpointResult>("azure-native:media/v20180601preview:getStreamingEndpoint", args ?? new GetStreamingEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// The StreamingEndpoint.
        /// </summary>
        public static Output<GetStreamingEndpointResult> Invoke(GetStreamingEndpointInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStreamingEndpointResult>("azure-native:media/v20180601preview:getStreamingEndpoint", args ?? new GetStreamingEndpointInvokeArgs(), options.WithDefaults());
    }
