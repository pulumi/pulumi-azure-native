...
namespace Pulumi.AzureNative.Media.V20180601Preview
{
    ...
    [AzureNativeResourceType("azure-native:media/v20180601preview:StreamingPolicy")]
    public partial class StreamingPolicy : global::Pulumi.CustomResource
    {
        ...
        public StreamingPolicy(string name, StreamingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180601preview:StreamingPolicy", name, args ?? new StreamingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20180601preview:StreamingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
