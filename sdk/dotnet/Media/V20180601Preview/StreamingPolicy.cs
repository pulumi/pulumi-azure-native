...
namespace Pulumi.AzureRM.Media.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var streamingPolicy = new AzureRM.Media.V20180601Preview.StreamingPolicy("streamingPolicy", new AzureRM.Media.V20180601Preview.StreamingPolicyArgs
    ///         {
    ///             AccountName = "contosomedia",
    ///             NoEncryption = new AzureRM.Media.V20180601Preview.Inputs.NoEncryptionArgs
    ///             {
    ///                 EnabledProtocols = new AzureRM.Media.V20180601Preview.Inputs.EnabledProtocolsArgs
    ///                 {
    ///                     Dash = true,
    ///                     Download = true,
    ///                     Hls = true,
    ...
    ///         {
    ///             AccountName = "contosomedia",
    ///             CommonEncryptionCbcs = new AzureRM.Media.V20180601Preview.Inputs.CommonEncryptionCbcsArgs
    ///             {
    ///                 ContentKeys = new AzureRM.Media.V20180601Preview.Inputs.StreamingPolicyContentKeysArgs
    ///                 {
    ///                     DefaultKey = new AzureRM.Media.V20180601Preview.Inputs.DefaultKeyArgs
    ///                     {
    ///                         Label = "cbcsDefaultKey",
    ///                     },
    ///                 },
    ///                 Drm = new AzureRM.Media.V20180601Preview.Inputs.CbcsDrmConfigurationArgs
    ///                 {
    ///                     FairPlay = new AzureRM.Media.V20180601Preview.Inputs.StreamingPolicyFairPlayConfigurationArgs
    ///                     {
    ...
    ///         {
    ///             AccountName = "contosomedia",
    ///             CommonEncryptionCenc = new AzureRM.Media.V20180601Preview.Inputs.CommonEncryptionCencArgs
    ///             {
    ///                 ClearTracks = 
    ///                 {
    ///                     new AzureRM.Media.V20180601Preview.Inputs.TrackSelectionArgs
    ///                     {
    ///                         TrackSelections = 
    ///                         {
    ///                             new AzureRM.Media.V20180601Preview.Inputs.TrackPropertyConditionArgs
    ///                             {
    ///                                 Operation = "Equal",
    ///                                 Property = "FourCC",
    ///                                 Value = "hev1",
    ...
    ///                     },
    ///                 },
    ///                 Drm = new AzureRM.Media.V20180601Preview.Inputs.CencDrmConfigurationArgs
    ///                 {
    ///                     PlayReady = new AzureRM.Media.V20180601Preview.Inputs.StreamingPolicyPlayReadyConfigurationArgs
    ///                     {
    ///                         CustomLicenseAcquisitionUrlTemplate = "https://contoso.com/{AssetAlternativeId}/playready/{ContentKeyId}",
    ///                         PlayReadyCustomAttributes = "PlayReady CustomAttributes",
    ///                     },
    ///                     Widevine = new AzureRM.Media.V20180601Preview.Inputs.StreamingPolicyWidevineConfigurationArgs
    ///                     {
    ...
    ///             EnvelopeEncryption = new AzureRM.Media.V20180601Preview.Inputs.EnvelopeEncryptionArgs
    ///             {
    ///                 ContentKeys = new AzureRM.Media.V20180601Preview.Inputs.StreamingPolicyContentKeysArgs
    ///                 {
    ///                     DefaultKey = new AzureRM.Media.V20180601Preview.Inputs.DefaultKeyArgs
    ...
    public partial class StreamingPolicy : Pulumi.CustomResource
    {
        ...
        public StreamingPolicy(string name, StreamingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180601preview:StreamingPolicy", name, args ?? new StreamingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media/v20180601preview:StreamingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
