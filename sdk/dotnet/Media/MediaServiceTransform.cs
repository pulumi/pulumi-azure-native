...
namespace Pulumi.AzureRM.Media
{
    ...
    public partial class MediaServiceTransform : Pulumi.CustomResource
    {
        ...
        private MediaServiceTransform(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:media:MediaServiceTransform", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MediaServiceTransform Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new MediaServiceTransform(name, id, options);
        }
    }
