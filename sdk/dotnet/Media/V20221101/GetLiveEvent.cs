...
namespace Pulumi.AzureNative.Media.V20221101
{
    public static class GetLiveEvent
    {
        ...
        public static Task<GetLiveEventResult> InvokeAsync(GetLiveEventArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLiveEventResult>("azure-native:media/v20221101:getLiveEvent", args ?? new GetLiveEventArgs(), options.WithDefaults());

        /// <summary>
        /// Gets properties of a live event.
        /// </summary>
        public static Output<GetLiveEventResult> Invoke(GetLiveEventInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLiveEventResult>("azure-native:media/v20221101:getLiveEvent", args ?? new GetLiveEventInvokeArgs(), options.WithDefaults());
    }
