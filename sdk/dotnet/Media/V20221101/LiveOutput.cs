...
namespace Pulumi.AzureNative.Media.V20221101
{
    /// <summary>
    /// The Live Output.
    /// 
    ...
    /// {
    ///     var liveOutput = new AzureNative.Media.V20221101.LiveOutput("liveOutput", new()
    ///     {
    ///         AccountName = "slitestmedia10",
    ///         ArchiveWindowLength = "PT5M",
    ///         AssetName = "6f3264f5-a189-48b4-a29a-a40f22575212",
    ///         Description = "test live output 1",
    ///         Hls = new AzureNative.Media.V20221101.Inputs.HlsArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:media/v20221101:LiveOutput myLiveOutput1 /subscriptions/0a6ec948-5a62-437d-b9df-934dc7c1b722/resourceGroups/mediaresources/providers/Microsoft.Media/mediaservices/slitestmedia10/liveevents/myLiveEvent1/liveoutputs/myLiveOutput1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20221101:LiveOutput")]
    public partial class LiveOutput : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("rewindWindowLength")]
        public Output<string?> RewindWindowLength { get; private set; } = null!;
        ...
        public LiveOutput(string name, LiveOutputArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20221101:LiveOutput", name, args ?? new LiveOutputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LiveOutput(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20221101:LiveOutput", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:media:LiveOutput"},
    ...
    public sealed class LiveOutputArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// ISO 8601 time between 1 minute to the duration of archiveWindowLength to control seek-able window length during Live. The service won't use this property once LiveOutput stops. The archived VOD will have full content with original ArchiveWindowLength. For example, use PT1H30M to indicate 1 hour and 30 minutes of rewind window length. Service will use implicit default value 30m only if Live Event enables LL.
        /// </summary>
        [Input("rewindWindowLength")]
        public Input<string>? RewindWindowLength { get; set; }
