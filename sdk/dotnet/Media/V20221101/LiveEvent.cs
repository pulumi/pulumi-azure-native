...
namespace Pulumi.AzureNative.Media.V20221101
{
    ...
    /// {
    ///     var liveEvent = new AzureNative.Media.V20221101.LiveEvent("liveEvent", new()
    ///     {
    ///         AccountName = "slitestmedia10",
    ///         Description = "test event 1",
    ///         Input = new AzureNative.Media.V20221101.Inputs.LiveEventInputArgs
    ///         {
    ///             AccessControl = new AzureNative.Media.V20221101.Inputs.LiveEventInputAccessControlArgs
    ///             {
    ...
    ///         Location = "West US",
    ///         Preview = new AzureNative.Media.V20221101.Inputs.LiveEventPreviewArgs
    ///         {
    ///             AccessControl = new AzureNative.Media.V20221101.Inputs.LiveEventPreviewAccessControlArgs
    ///             {
    ///                 Ip = new AzureNative.Media.V20221101.Inputs.IPAccessControlArgs
    ///                 {
    ///                     Allow = new[]
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:media/v20221101:LiveEvent")]
    public partial class LiveEvent : global::Pulumi.CustomResource
    {
        ...
        public LiveEvent(string name, LiveEventArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20221101:LiveEvent", name, args ?? new LiveEventArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LiveEvent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20221101:LiveEvent", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LiveEventArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("streamOptions")]
        private InputList<Union<string, Pulumi.AzureNative.Media.V20221101.StreamOptionsFlag>>? _streamOptions;

        /// <summary>
        /// The options to use for the LiveEvent. This value is specified at creation time and cannot be updated. The valid values for the array entry values are 'Default' and 'LowLatency'.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Media.V20221101.StreamOptionsFlag>> StreamOptions
        {
            get => _streamOptions ?? (_streamOptions = new InputList<Union<string, Pulumi.AzureNative.Media.V20221101.StreamOptionsFlag>>());
