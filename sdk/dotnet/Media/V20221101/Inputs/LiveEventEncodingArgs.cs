...
namespace Pulumi.AzureNative.Media.V20221101.Inputs
{
    ...
    public sealed class LiveEventEncodingArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("encodingType")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20221101.LiveEventEncodingType>? EncodingType { get; set; }
        ...
        /// </summary>
        [Input("stretchMode")]
        public InputUnion<string, Pulumi.AzureNative.Media.V20221101.StretchMode>? StretchMode { get; set; }
