...
namespace Pulumi.AzureNative.Media.V20190901Preview
{
    ...
    [AzureNativeResourceType("azure-native:media/v20190901preview:MediaGraph")]
    public partial class MediaGraph : global::Pulumi.CustomResource
    {
        ...
        public MediaGraph(string name, MediaGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-native:media/v20190901preview:MediaGraph", name, args ?? new MediaGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MediaGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:media/v20190901preview:MediaGraph", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:media/v20200201preview:MediaGraph"},
                },
            };
