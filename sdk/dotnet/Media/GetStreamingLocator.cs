...
namespace Pulumi.AzureRM.Media
{
    public static class GetStreamingLocator
    {
        public static Task<GetStreamingLocatorResult> InvokeAsync(GetStreamingLocatorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamingLocatorResult>("azurerm:media:getStreamingLocator", args ?? new GetStreamingLocatorArgs(), options.WithVersion());
    }
