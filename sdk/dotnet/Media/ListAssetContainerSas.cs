...
namespace Pulumi.AzureRM.Media
{
    public static class ListAssetContainerSas
    {
        public static Task<ListAssetContainerSasResult> InvokeAsync(ListAssetContainerSasArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAssetContainerSasResult>("azurerm:media:listAssetContainerSas", args ?? new ListAssetContainerSasArgs(), options.WithVersion());
    }
