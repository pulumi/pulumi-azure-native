...
namespace Pulumi.AzureNative.Network.V20200701
{
    public static class GetInboundNatRule
    {
        ...
        public static Task<GetInboundNatRuleResult> InvokeAsync(GetInboundNatRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInboundNatRuleResult>("azure-native:network/v20200701:getInboundNatRule", args ?? new GetInboundNatRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Inbound NAT rule of the load balancer.
        /// </summary>
        public static Output<GetInboundNatRuleResult> Invoke(GetInboundNatRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetInboundNatRuleResult>("azure-native:network/v20200701:getInboundNatRule", args ?? new GetInboundNatRuleInvokeArgs(), options.WithDefaults());
    }
