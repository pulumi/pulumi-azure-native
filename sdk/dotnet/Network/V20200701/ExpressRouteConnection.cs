...
namespace Pulumi.AzureNative.Network.V20200701
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20200701:ExpressRouteConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20200701:ExpressRouteConnection")]
    public partial class ExpressRouteConnection : global::Pulumi.CustomResource
    {
        ...
        public ExpressRouteConnection(string name, ExpressRouteConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200701:ExpressRouteConnection", name, args ?? new ExpressRouteConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200701:ExpressRouteConnection", name, null, MakeResourceOptions(options, id))
        {
        }
