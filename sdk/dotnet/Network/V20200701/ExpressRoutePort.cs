...
namespace Pulumi.AzureNative.Network.V20200701
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20200701:ExpressRoutePort is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRoutePort to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20200701:ExpressRoutePort")]
    public partial class ExpressRoutePort : global::Pulumi.CustomResource
    {
        ...
        public ExpressRoutePort(string name, ExpressRoutePortArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200701:ExpressRoutePort", name, args ?? new ExpressRoutePortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRoutePort(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200701:ExpressRoutePort", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRoutePortArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("encapsulation")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200701.ExpressRoutePortsEncapsulation>? Encapsulation { get; set; }
