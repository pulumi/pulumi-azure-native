...
namespace Pulumi.AzureNative.Network.V20200701
{
    public static class GetActiveSessions
    {
        ...
        public static Task<GetActiveSessionsResult> InvokeAsync(GetActiveSessionsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetActiveSessionsResult>("azure-native:network/v20200701:getActiveSessions", args ?? new GetActiveSessionsArgs(), options.WithDefaults());

        /// <summary>
        /// Response for GetActiveSessions.
        /// </summary>
        public static Output<GetActiveSessionsResult> Invoke(GetActiveSessionsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetActiveSessionsResult>("azure-native:network/v20200701:getActiveSessions", args ?? new GetActiveSessionsInvokeArgs(), options.WithDefaults());
    }
