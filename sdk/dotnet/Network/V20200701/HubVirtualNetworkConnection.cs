...
namespace Pulumi.AzureNextGen.Network.V20200701
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200701:HubVirtualNetworkConnection")]
    public partial class HubVirtualNetworkConnection : Pulumi.CustomResource
    {
        ...
        public HubVirtualNetworkConnection(string name, HubVirtualNetworkConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200701:HubVirtualNetworkConnection", name, args ?? new HubVirtualNetworkConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubVirtualNetworkConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200701:HubVirtualNetworkConnection", name, null, MakeResourceOptions(options, id))
        {
        }
