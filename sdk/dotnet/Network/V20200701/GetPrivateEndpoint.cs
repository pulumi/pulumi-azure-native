...
namespace Pulumi.AzureNative.Network.V20200701
{
    public static class GetPrivateEndpoint
    {
        ...
        public static Task<GetPrivateEndpointResult> InvokeAsync(GetPrivateEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateEndpointResult>("azure-native:network/v20200701:getPrivateEndpoint", args ?? new GetPrivateEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Private endpoint resource.
        /// </summary>
        public static Output<GetPrivateEndpointResult> Invoke(GetPrivateEndpointInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPrivateEndpointResult>("azure-native:network/v20200701:getPrivateEndpoint", args ?? new GetPrivateEndpointInvokeArgs(), options.WithDefaults());
    }
