...
namespace Pulumi.AzureNative.Network.V20200701
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20200701:VirtualHubBgpConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualHubBgpConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20200701:VirtualHubBgpConnection")]
    public partial class VirtualHubBgpConnection : global::Pulumi.CustomResource
    {
        ...
        public VirtualHubBgpConnection(string name, VirtualHubBgpConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200701:VirtualHubBgpConnection", name, args ?? new VirtualHubBgpConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubBgpConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200701:VirtualHubBgpConnection", name, null, MakeResourceOptions(options, id))
        {
        }
