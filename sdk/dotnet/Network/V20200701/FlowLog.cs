...
namespace Pulumi.AzureNative.Network.V20200701
{
    ...
    /// A flow log resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200701:FlowLog")]
    public partial class FlowLog : Pulumi.CustomResource
    {
        ...
        public FlowLog(string name, FlowLogArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200701:FlowLog", name, args ?? new FlowLogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FlowLog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200701:FlowLog", name, null, MakeResourceOptions(options, id))
        {
        }
