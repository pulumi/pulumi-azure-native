...
namespace Pulumi.AzureNative.Network.V20200701
{
    public static class GetDscpConfiguration
    {
        ...
        public static Output<GetDscpConfigurationResult> Invoke(GetDscpConfigurationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDscpConfigurationResult>("azure-native:network/v20200701:getDscpConfiguration", args ?? new GetDscpConfigurationInvokeArgs(), options.WithVersion());
    }
