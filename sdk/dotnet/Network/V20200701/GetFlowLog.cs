...
{
    [Obsolete(@"azure-native:network/v20200701:FlowLog is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:FlowLog to guarantee forwards compatibility.")]
    public static class GetFlowLog
    {
        ...
        public static Task<GetFlowLogResult> InvokeAsync(GetFlowLogArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFlowLogResult>("azure-native:network/v20200701:getFlowLog", args ?? new GetFlowLogArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a flow log resource by name.
        /// </summary>
        public static Output<GetFlowLogResult> Invoke(GetFlowLogInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFlowLogResult>("azure-native:network/v20200701:getFlowLog", args ?? new GetFlowLogInvokeArgs(), options.WithDefaults());
    }
