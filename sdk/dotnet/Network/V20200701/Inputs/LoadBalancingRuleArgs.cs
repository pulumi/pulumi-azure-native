...
namespace Pulumi.AzureNextGen.Network.V20200701.Inputs
{
    ...
    public sealed class LoadBalancingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200701.LoadDistribution>? LoadDistribution { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200701.TransportProtocol> Protocol { get; set; } = null!;
