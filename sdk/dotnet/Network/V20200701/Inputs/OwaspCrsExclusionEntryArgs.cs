...
namespace Pulumi.AzureNextGen.Network.V20200701.Inputs
{
    ...
    public sealed class OwaspCrsExclusionEntryArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200701.OwaspCrsExclusionEntryMatchVariable> MatchVariable { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200701.OwaspCrsExclusionEntrySelectorMatchOperator> SelectorMatchOperator { get; set; } = null!;
