...
namespace Pulumi.AzureNative.Network.V20200701.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200701.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200701.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
