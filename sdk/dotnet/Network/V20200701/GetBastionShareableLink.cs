...
namespace Pulumi.AzureNative.Network.V20200701
{
    public static class GetBastionShareableLink
    {
        ...
        public static Task<GetBastionShareableLinkResult> InvokeAsync(GetBastionShareableLinkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBastionShareableLinkResult>("azure-native:network/v20200701:getBastionShareableLink", args ?? new GetBastionShareableLinkArgs(), options.WithDefaults());
        ...
        public static Output<GetBastionShareableLinkResult> Invoke(GetBastionShareableLinkInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBastionShareableLinkResult>("azure-native:network/v20200701:getBastionShareableLink", args ?? new GetBastionShareableLinkInvokeArgs(), options.WithDefaults());
    }
