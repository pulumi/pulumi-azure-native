...
namespace Pulumi.AzureNextGen.Network.V20190401.Inputs
{
    ...
    public sealed class RoutingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNextGen.Network.V20190401.FrontDoorProtocol>>? _acceptedProtocols;

        /// <summary>
        /// Protocol schemes to match for this rule
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.Network.V20190401.FrontDoorProtocol>> AcceptedProtocols
        {
            get => _acceptedProtocols ?? (_acceptedProtocols = new InputList<Union<string, Pulumi.AzureNextGen.Network.V20190401.FrontDoorProtocol>>());
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190401.RoutingRuleEnabledState>? EnabledState { get; set; }
