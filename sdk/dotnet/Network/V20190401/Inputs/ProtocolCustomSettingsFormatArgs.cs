...
namespace Pulumi.AzureNative.Network.V20190401.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190401.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190401.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
