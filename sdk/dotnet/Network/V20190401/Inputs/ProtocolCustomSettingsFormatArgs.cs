...
namespace Pulumi.AzureNextGen.Network.V20190401.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190401.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190401.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
