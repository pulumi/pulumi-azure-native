...
namespace Pulumi.AzureNative.Network.V20190401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20190401:P2sVpnServerConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190701:P2sVpnServerConfiguration to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20190401:P2sVpnServerConfiguration")]
    public partial class P2sVpnServerConfiguration : global::Pulumi.CustomResource
    {
        ...
        public P2sVpnServerConfiguration(string name, P2sVpnServerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190401:P2sVpnServerConfiguration", name, args ?? new P2sVpnServerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private P2sVpnServerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190401:P2sVpnServerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
