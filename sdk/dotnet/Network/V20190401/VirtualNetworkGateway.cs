...
namespace Pulumi.AzureRM.Network.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkGateway = new AzureRM.Network.V20190401.VirtualNetworkGateway("virtualNetworkGateway", new AzureRM.Network.V20190401.VirtualNetworkGatewayArgs
    ///         {
    ///             ActiveActive = false,
    ...
    ///                 PeerWeight = 0,
    ///             },
    ///             CustomRoutes = new AzureRM.Network.V20190401.Inputs.AddressSpaceArgs
    ///             {
    ///                 AddressPrefixes = 
    ///                 {
    ///                     "101.168.0.6/32",
    ...
    ///             IpConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20190401.Inputs.VirtualNetworkGatewayIPConfigurationArgs
    ///                 {
    ///                     Name = "gwipconfig1",
    ///                 },
    ///             },
    ...
    ///             Sku = new AzureRM.Network.V20190401.Inputs.VirtualNetworkGatewaySkuArgs
    ///             {
    ///                 Name = "VpnGw1",
    ///                 Tier = "VpnGw1",
    ///             },
