...
namespace Pulumi.AzureRM.Network.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var frontDoor = new AzureRM.Network.V20190401.FrontDoor("frontDoor", new AzureRM.Network.V20190401.FrontDoorArgs
    ///         {
    ///             BackendPools = 
    ///             {
    ///                 new AzureRM.Network.V20190401.Inputs.BackendPoolArgs
    ///                 {
    ///                     Name = "backendPool1",
    ///                 },
    ///             },
    ///             BackendPoolsSettings = new AzureRM.Network.V20190401.Inputs.BackendPoolsSettingsArgs
    ///             {
    ...
    ///             FrontendEndpoints = 
    ///             {
    ///                 new AzureRM.Network.V20190401.Inputs.FrontendEndpointArgs
    ///                 {
    ...
    ///             HealthProbeSettings = 
    ///             {
    ///                 new AzureRM.Network.V20190401.Inputs.HealthProbeSettingsModelArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Network.V20190401.Inputs.LoadBalancingSettingsModelArgs
    ///                 {
    ...
    ///             RoutingRules = 
    ///             {
    ///                 new AzureRM.Network.V20190401.Inputs.RoutingRuleArgs
    ///                 {
    ///                     Name = "routingRule1",
    ///                 },
    ///             },
    ...
    public partial class FrontDoor : Pulumi.CustomResource
    {
        ...
        public FrontDoor(string name, FrontDoorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190401:FrontDoor", name, args ?? new FrontDoorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FrontDoor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190401:FrontDoor", name, null, MakeResourceOptions(options, id))
        {
        }
