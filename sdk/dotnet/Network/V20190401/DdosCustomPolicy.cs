...
namespace Pulumi.AzureRM.Network.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var ddosCustomPolicy = new AzureRM.Network.V20190401.DdosCustomPolicy("ddosCustomPolicy", new AzureRM.Network.V20190401.DdosCustomPolicyArgs
    ///         {
    ///             DdosCustomPolicyName = "test-ddos-custom-policy",
    ///             Location = "westus",
    ///             ProtocolCustomSettings = 
    ///             {
    ///                 new AzureRM.Network.V20190401.Inputs.ProtocolCustomSettingsFormatArgs
    ///                 {
    ///                     Protocol = "Tcp",
    ///                 },
    ///             },
    ...
    public partial class DdosCustomPolicy : Pulumi.CustomResource
    {
        ...
        public DdosCustomPolicy(string name, DdosCustomPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190401:DdosCustomPolicy", name, args ?? new DdosCustomPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DdosCustomPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190401:DdosCustomPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
