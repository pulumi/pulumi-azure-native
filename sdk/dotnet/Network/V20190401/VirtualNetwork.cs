...
namespace Pulumi.AzureNative.Network.V20190401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190401:VirtualNetwork")]
    public partial class VirtualNetwork : Pulumi.CustomResource
    {
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190401:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190401:VirtualNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
