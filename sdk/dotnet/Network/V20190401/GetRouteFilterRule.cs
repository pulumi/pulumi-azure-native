...
namespace Pulumi.AzureRM.Network.V20190401
{
    public static class GetRouteFilterRule
    {
        public static Task<GetRouteFilterRuleResult> InvokeAsync(GetRouteFilterRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteFilterRuleResult>("azurerm:network/v20190401:getRouteFilterRule", args ?? new GetRouteFilterRuleArgs(), options.WithVersion());
    }
