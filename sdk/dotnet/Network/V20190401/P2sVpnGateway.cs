...
namespace Pulumi.AzureRM.Network.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var p2sVpnGateway = new AzureRM.Network.V20190401.P2sVpnGateway("p2sVpnGateway", new AzureRM.Network.V20190401.P2sVpnGatewayArgs
    ///         {
    ...
    ///             Location = "West US",
    ///             P2SVpnServerConfiguration = new AzureRM.Network.V20190401.Inputs.SubResourceArgs
    ///             {
    ...
    ///             },
    ///             VpnClientAddressPool = new AzureRM.Network.V20190401.Inputs.AddressSpaceArgs
    ///             {
    ///                 AddressPrefixes = 
    ///                 {
    ///                     "101.3.0.0/16",
    ...
    public partial class P2sVpnGateway : Pulumi.CustomResource
    {
        ...
        public P2sVpnGateway(string name, P2sVpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190401:P2sVpnGateway", name, args ?? new P2sVpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private P2sVpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190401:P2sVpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
