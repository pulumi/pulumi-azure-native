...
namespace Pulumi.AzureNextGen.Network.V20190401
{
    public static class GetNatGateway
    {
        public static Task<GetNatGatewayResult> InvokeAsync(GetNatGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNatGatewayResult>("azure-nextgen:network/v20190401:getNatGateway", args ?? new GetNatGatewayArgs(), options.WithVersion());
    }
