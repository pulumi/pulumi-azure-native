...
namespace Pulumi.AzureNextGen.Network.V20190401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190401:LocalNetworkGateway")]
    public partial class LocalNetworkGateway : Pulumi.CustomResource
    {
        ...
        public LocalNetworkGateway(string name, LocalNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190401:LocalNetworkGateway", name, args ?? new LocalNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190401:LocalNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
