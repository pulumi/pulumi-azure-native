...
namespace Pulumi.AzureNextGen.Network.V20190401
{
    public static class GetVirtualHub
    {
        public static Task<GetVirtualHubResult> InvokeAsync(GetVirtualHubArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualHubResult>("azure-nextgen:network/v20190401:getVirtualHub", args ?? new GetVirtualHubArgs(), options.WithVersion());
    }
