...
namespace Pulumi.AzureNextGen.Network.V20190401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190401:SecurityRule")]
    public partial class SecurityRule : Pulumi.CustomResource
    {
        ...
        public SecurityRule(string name, SecurityRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190401:SecurityRule", name, args ?? new SecurityRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190401:SecurityRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190401.SecurityRuleAccess> Access { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190401.SecurityRuleDirection> Direction { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190401.SecurityRuleProtocol> Protocol { get; set; } = null!;
