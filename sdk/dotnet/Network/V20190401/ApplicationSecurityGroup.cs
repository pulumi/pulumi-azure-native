...
namespace Pulumi.AzureRM.Network.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationSecurityGroup = new AzureRM.Network.V20190401.ApplicationSecurityGroup("applicationSecurityGroup", new AzureRM.Network.V20190401.ApplicationSecurityGroupArgs
    ///         {
    ...
    public partial class ApplicationSecurityGroup : Pulumi.CustomResource
    {
        ...
        public ApplicationSecurityGroup(string name, ApplicationSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190401:ApplicationSecurityGroup", name, args ?? new ApplicationSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190401:ApplicationSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
