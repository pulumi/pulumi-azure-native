...
namespace Pulumi.AzureRM.Network.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var publicIPPrefix = new AzureRM.Network.V20190401.PublicIPPrefix("publicIPPrefix", new AzureRM.Network.V20190401.PublicIPPrefixArgs
    ///         {
    ///             Location = "westus",
    ///             PrefixLength = 30,
    ...
    ///             Sku = new AzureRM.Network.V20190401.Inputs.PublicIPPrefixSkuArgs
    ///             {
    ///                 Name = "Standard",
    ///             },
    ///         });
    ...
    public partial class PublicIPPrefix : Pulumi.CustomResource
    {
        ...
        public PublicIPPrefix(string name, PublicIPPrefixArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190401:PublicIPPrefix", name, args ?? new PublicIPPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190401:PublicIPPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
