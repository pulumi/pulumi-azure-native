...
namespace Pulumi.AzureNative.Network.V20190401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190401:PrivateLinkService")]
    public partial class PrivateLinkService : Pulumi.CustomResource
    {
        ...
        public PrivateLinkService(string name, PrivateLinkServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190401:PrivateLinkService", name, args ?? new PrivateLinkServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190401:PrivateLinkService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:network/v20201101:PrivateLinkService"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20201101:PrivateLinkService"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210201:PrivateLinkService"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:PrivateLinkService"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:PrivateLinkService"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:PrivateLinkService"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:PrivateLinkService"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:PrivateLinkService"},
                },
            };
