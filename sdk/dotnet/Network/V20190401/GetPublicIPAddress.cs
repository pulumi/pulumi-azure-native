...
namespace Pulumi.AzureNative.Network.V20190401
{
    public static class GetPublicIPAddress
    {
        ...
        public static Task<GetPublicIPAddressResult> InvokeAsync(GetPublicIPAddressArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPublicIPAddressResult>("azure-native:network/v20190401:getPublicIPAddress", args ?? new GetPublicIPAddressArgs(), options.WithDefaults());

        /// <summary>
        /// Public IP address resource.
        /// </summary>
        public static Output<GetPublicIPAddressResult> Invoke(GetPublicIPAddressInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPublicIPAddressResult>("azure-native:network/v20190401:getPublicIPAddress", args ?? new GetPublicIPAddressInvokeArgs(), options.WithDefaults());
    }
