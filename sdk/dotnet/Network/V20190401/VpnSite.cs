...
namespace Pulumi.AzureRM.Network.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnSite = new AzureRM.Network.V20190401.VpnSite("vpnSite", new AzureRM.Network.V20190401.VpnSiteArgs
    ///         {
    ///             AddressSpace = new AzureRM.Network.V20190401.Inputs.AddressSpaceArgs
    ///             {
    ///                 AddressPrefixes = 
    ///                 {
    ///                     "10.0.0.0/16",
    ///                 },
    ///             },
    ///             BgpProperties = new AzureRM.Network.V20190401.Inputs.BgpSettingsArgs
    ///             {
    ///                 Asn = 1234,
    ///                 BgpPeeringAddress = "192.168.0.0",
    ///             },
    ///             DeviceProperties = new AzureRM.Network.V20190401.Inputs.DevicePropertiesArgs
    ///             {
    ///                 DeviceModel = "model01",
    ...
    public partial class VpnSite : Pulumi.CustomResource
    {
        ...
        public VpnSite(string name, VpnSiteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190401:VpnSite", name, args ?? new VpnSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190401:VpnSite", name, null, MakeResourceOptions(options, id))
        {
        }
