...
{
    [Obsolete(@"azure-native:network/v20190401:BastionHost is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:BastionHost to guarantee forwards compatibility.")]
    public static class GetBastionHost
    {
        ...
        public static Task<GetBastionHostResult> InvokeAsync(GetBastionHostArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBastionHostResult>("azure-native:network/v20190401:getBastionHost", args ?? new GetBastionHostArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified Bastion Host.
        /// </summary>
        public static Output<GetBastionHostResult> Invoke(GetBastionHostInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBastionHostResult>("azure-native:network/v20190401:getBastionHost", args ?? new GetBastionHostInvokeArgs(), options.WithDefaults());
    }
