...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class PrivateLinkServicePrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateLinkServicePrivateEndpointConnection(string name, PrivateLinkServicePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:PrivateLinkServicePrivateEndpointConnection", name, args ?? new PrivateLinkServicePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkServicePrivateEndpointConnection(string name, Input<string> id, PrivateLinkServicePrivateEndpointConnectionState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:PrivateLinkServicePrivateEndpointConnection", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PrivateLinkServicePrivateEndpointConnection Get(string name, Input<string> id, PrivateLinkServicePrivateEndpointConnectionState? state = null, CustomResourceOptions? options = null)
        {
            return new PrivateLinkServicePrivateEndpointConnection(name, id, state, options);
        }
    }
    ...
    public sealed class PrivateLinkServicePrivateEndpointConnectionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A unique read-only string that changes whenever the resource is updated.
        /// </summary>
        ...
        public PrivateLinkServicePrivateEndpointConnectionState()
        {
        }
    }
}
