...
namespace Pulumi.AzureNative.Network
{
    ...
    public partial class NetworkSecurityPerimeter : global::Pulumi.CustomResource
    {
        ...
        public NetworkSecurityPerimeter(string name, NetworkSecurityPerimeterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network:NetworkSecurityPerimeter", name, args ?? new NetworkSecurityPerimeterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityPerimeter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network:NetworkSecurityPerimeter", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240701:NetworkSecurityPerimeter" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20241001:NetworkSecurityPerimeter" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250101:NetworkSecurityPerimeter" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250301:NetworkSecurityPerimeter" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250501:NetworkSecurityPerimeter" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250701:NetworkSecurityPerimeter" },
                },
            };
