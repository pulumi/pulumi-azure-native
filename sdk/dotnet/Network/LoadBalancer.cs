...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class LoadBalancer : Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:LoadBalancer", name, args ?? new LoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancer(string name, Input<string> id, LoadBalancerState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:LoadBalancer", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LoadBalancerState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.LoadBalancerPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;

        /// <summary>
        /// The load balancer SKU.
        /// </summary>
        [Input("sku")]
        public Input<Inputs.LoadBalancerSkuResponseGetArgs>? Sku { get; set; }
