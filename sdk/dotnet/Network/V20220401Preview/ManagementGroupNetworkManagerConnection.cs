...
namespace Pulumi.AzureNative.Network.V20220401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220401preview:ManagementGroupNetworkManagerConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ManagementGroupNetworkManagerConnection to guarantee forwards compatibility.")]
    ...
    public partial class ManagementGroupNetworkManagerConnection : global::Pulumi.CustomResource
    {
        ...
        public ManagementGroupNetworkManagerConnection(string name, ManagementGroupNetworkManagerConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:ManagementGroupNetworkManagerConnection", name, args ?? new ManagementGroupNetworkManagerConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroupNetworkManagerConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:ManagementGroupNetworkManagerConnection", name, null, MakeResourceOptions(options, id))
        {
        }
