...
namespace Pulumi.AzureNative.Network.V20220401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220401preview:SubscriptionNetworkManagerConnection")]
    public partial class SubscriptionNetworkManagerConnection : global::Pulumi.CustomResource
    {
        ...
        public SubscriptionNetworkManagerConnection(string name, SubscriptionNetworkManagerConnectionArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:SubscriptionNetworkManagerConnection", name, args ?? new SubscriptionNetworkManagerConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionNetworkManagerConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:SubscriptionNetworkManagerConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240101:SubscriptionNetworkManagerConnection" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240301:SubscriptionNetworkManagerConnection" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240501:SubscriptionNetworkManagerConnection" },
                },
            };
