...
namespace Pulumi.AzureNative.Network.V20220401Preview
{
    ...
    /// {
    ///     var defaultUserRule = new AzureNative.Network.V20220401Preview.DefaultUserRule("defaultUserRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220401preview:DefaultUserRule")]
    public partial class DefaultUserRule : global::Pulumi.CustomResource
    {
        ...
        public DefaultUserRule(string name, DefaultUserRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:DefaultUserRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private DefaultUserRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:DefaultUserRule", name, null, MakeResourceOptions(options, id))
        {
        }
