...
namespace Pulumi.AzureNative.Network.V20220401Preview
{
    ...
    public partial class ScopeConnection : global::Pulumi.CustomResource
    {
        ...
        public ScopeConnection(string name, ScopeConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:ScopeConnection", name, args ?? new ScopeConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:ScopeConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230501:ScopeConnection" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240101:ScopeConnection" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240301:ScopeConnection" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240501:ScopeConnection" },
                },
            };
