...
namespace Pulumi.AzureNative.Network.V20220401Preview
{
    ...
    /// {
    ///     var profile = new AzureNative.Network.V20220401Preview.Profile("profile", new()
    ///     {
    ///         DnsConfig = new AzureNative.Network.V20220401Preview.Inputs.DnsConfigArgs
    ///         {
    ...
    ///         Location = "global",
    ///         MaxReturn = 2,
    ///         MonitorConfig = new AzureNative.Network.V20220401Preview.Inputs.MonitorConfigArgs
    ///         {
    ///             Path = "/testpath.aspx",
    ///             Port = 80,
    ///             Protocol = "HTTP",
    ...
    ///         Endpoints = new[]
    ///         {
    ///             new AzureNative.Network.V20220401Preview.Inputs.EndpointArgs
    ///             {
    ...
    ///             CustomHeaders = new[]
    ///             {
    ///                 new AzureNative.Network.V20220401Preview.Inputs.MonitorConfigCustomHeadersArgs
    ///                 {
    ///                     Name = "header-1",
    ///                     Value = "value-1",
    ///                 },
    ...
    ///             {
    ///                 new AzureNative.Network.V20220401Preview.Inputs.MonitorConfigExpectedStatusCodeRangesArgs
    ///                 {
    ///                     Max = 205,
    ///                     Min = 200,
    ///                 },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220401preview:Profile")]
    public partial class Profile : global::Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.V20220401Preview.AllowedEndpointRecordType>>? _allowedEndpointRecordTypes;

        /// <summary>
        /// The list of allowed endpoint record types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20220401Preview.AllowedEndpointRecordType>> AllowedEndpointRecordTypes
        {
            get => _allowedEndpointRecordTypes ?? (_allowedEndpointRecordTypes = new InputList<Union<string, Pulumi.AzureNative.Network.V20220401Preview.AllowedEndpointRecordType>>());
        ...
        /// </summary>
        [Input("profileStatus")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220401Preview.ProfileStatus>? ProfileStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220401Preview.TrafficRoutingMethod>? TrafficRoutingMethod { get; set; }

        /// <summary>
        /// Indicates whether Traffic View is 'Enabled' or 'Disabled' for the Traffic Manager profile. Null, indicates 'Disabled'. Enabling this feature will increase the cost of the Traffic Manage profile.
        /// </summary>
        [Input("trafficViewEnrollmentStatus")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220401Preview.TrafficViewEnrollmentStatus>? TrafficViewEnrollmentStatus { get; set; }
