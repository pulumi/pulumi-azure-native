...
namespace Pulumi.AzureNative.Network.V20220401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220401preview:NetworkManager is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkManager to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20220401preview:NetworkManager")]
    public partial class NetworkManager : global::Pulumi.CustomResource
    {
        ...
        public NetworkManager(string name, NetworkManagerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:NetworkManager", name, args ?? new NetworkManagerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkManager(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:NetworkManager", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkManagerArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.V20220401Preview.ConfigurationType>>? _networkManagerScopeAccesses;

        /// <summary>
        /// Scope Access.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20220401Preview.ConfigurationType>> NetworkManagerScopeAccesses
        {
            get => _networkManagerScopeAccesses ?? (_networkManagerScopeAccesses = new InputList<Union<string, Pulumi.AzureNative.Network.V20220401Preview.ConfigurationType>>());
