...
namespace Pulumi.AzureNative.Network.V20220401Preview
{
    ...
    /// {
    ///     var endpoint = new AzureNative.Network.V20220401Preview.Endpoint("endpoint", new()
    ///     {
    ///         AlwaysServe = "Enabled",
    ...
    ///         CustomHeaders = new[]
    ///         {
    ///             new AzureNative.Network.V20220401Preview.Inputs.EndpointPropertiesCustomHeadersArgs
    ///             {
    ///                 Name = "header-1",
    ///                 Value = "value-1",
    ///             },
    ...
    ///         Subnets = new[]
    ///         {
    ///             new AzureNative.Network.V20220401Preview.Inputs.EndpointPropertiesSubnetsArgs
    ///             {
    ///                 First = "1.2.3.0",
    ///                 Scope = 24,
    ///             },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220401preview:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
