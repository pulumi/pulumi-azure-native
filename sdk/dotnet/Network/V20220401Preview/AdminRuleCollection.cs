...
namespace Pulumi.AzureNative.Network.V20220401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220401preview:AdminRuleCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:AdminRuleCollection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20220401preview:AdminRuleCollection")]
    public partial class AdminRuleCollection : global::Pulumi.CustomResource
    {
        ...
        public AdminRuleCollection(string name, AdminRuleCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:AdminRuleCollection", name, args ?? new AdminRuleCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AdminRuleCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:AdminRuleCollection", name, null, MakeResourceOptions(options, id))
        {
        }
