...
namespace Pulumi.AzureNative.Network.V20220401Preview
{
    ...
    public partial class DefaultAdminRule : global::Pulumi.CustomResource
    {
        ...
        public DefaultAdminRule(string name, DefaultAdminRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:DefaultAdminRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private DefaultAdminRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:DefaultAdminRule", name, null, MakeResourceOptions(options, id))
        {
        }
