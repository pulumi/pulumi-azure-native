...
namespace Pulumi.AzureNative.Network.V20220401Preview
{
    ...
    public partial class TrafficManagerUserMetricsKey : global::Pulumi.CustomResource
    {
        ...
        public TrafficManagerUserMetricsKey(string name, TrafficManagerUserMetricsKeyArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:TrafficManagerUserMetricsKey", name, args ?? new TrafficManagerUserMetricsKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TrafficManagerUserMetricsKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:TrafficManagerUserMetricsKey", name, null, MakeResourceOptions(options, id))
        {
        }
