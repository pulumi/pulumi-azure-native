...
namespace Pulumi.AzureNative.Network.V20220401Preview
{
    ...
    public partial class UserRule : global::Pulumi.CustomResource
    {
        ...
        public UserRule(string name, UserRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:UserRule", name, args ?? new UserRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class UserRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220401Preview.UserRuleKind> Kind { get; set; } = null!;
