...
namespace Pulumi.AzureNative.Network.V20220401Preview
{
    ...
    /// {
    ///     var userRule = new AzureNative.Network.V20220401Preview.UserRule("userRule", new()
    ///     {
    ...
    ///         Destinations = new[]
    ///         {
    ///             new AzureNative.Network.V20220401Preview.Inputs.AddressPrefixItemArgs
    ///             {
    ///                 AddressPrefix = "*",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220401preview:UserRule")]
    public partial class UserRule : global::Pulumi.CustomResource
    {
        ...
        public UserRule(string name, UserRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:UserRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private UserRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401preview:UserRule", name, null, MakeResourceOptions(options, id))
        {
        }
