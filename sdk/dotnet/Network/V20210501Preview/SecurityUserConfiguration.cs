...
namespace Pulumi.AzureNative.Network.V20210501Preview
{
    ...
    /// {
    ///     var securityUserConfiguration = new AzureNative.Network.V20210501Preview.SecurityUserConfiguration("securityUserConfiguration", new()
    ///     {
    ...
    public partial class SecurityUserConfiguration : global::Pulumi.CustomResource
    {
        ...
        public SecurityUserConfiguration(string name, SecurityUserConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:SecurityUserConfiguration", name, args ?? new SecurityUserConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityUserConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:SecurityUserConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
