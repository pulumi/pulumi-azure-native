...
namespace Pulumi.AzureNative.Network.V20210501Preview
{
    ...
    public partial class DefaultUserRule : Pulumi.CustomResource
    {
        ...
        public DefaultUserRule(string name, DefaultUserRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:DefaultUserRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private DefaultUserRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:DefaultUserRule", name, null, MakeResourceOptions(options, id))
        {
        }
