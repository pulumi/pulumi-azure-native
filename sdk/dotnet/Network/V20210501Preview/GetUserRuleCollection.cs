...
namespace Pulumi.AzureNative.Network.V20210501Preview
{
    public static class GetUserRuleCollection
    {
        ...
        public static Task<GetUserRuleCollectionResult> InvokeAsync(GetUserRuleCollectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetUserRuleCollectionResult>("azure-native:network/v20210501preview:getUserRuleCollection", args ?? new GetUserRuleCollectionArgs(), options.WithVersion());

        /// <summary>
        /// Defines the rule collection.
        /// </summary>
        public static Output<GetUserRuleCollectionResult> Invoke(GetUserRuleCollectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetUserRuleCollectionResult>("azure-native:network/v20210501preview:getUserRuleCollection", args ?? new GetUserRuleCollectionInvokeArgs(), options.WithVersion());
    }
