...
namespace Pulumi.AzureNative.Network.V20210501Preview
{
    ...
    /// {
    ///     var defaultAdminRule = new AzureNative.Network.V20210501Preview.DefaultAdminRule("defaultAdminRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210501preview:DefaultAdminRule")]
    public partial class DefaultAdminRule : global::Pulumi.CustomResource
    {
        ...
        public DefaultAdminRule(string name, DefaultAdminRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:DefaultAdminRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private DefaultAdminRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:DefaultAdminRule", name, null, MakeResourceOptions(options, id))
        {
        }
