...
namespace Pulumi.AzureNative.Network.V20210501Preview
{
    ...
    /// {
    ///     var userRuleCollection = new AzureNative.Network.V20210501Preview.UserRuleCollection("userRuleCollection", new()
    ///     {
    ///         AppliesToGroups = new[]
    ///         {
    ...
    public partial class UserRuleCollection : global::Pulumi.CustomResource
    {
        ...
        public UserRuleCollection(string name, UserRuleCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:UserRuleCollection", name, args ?? new UserRuleCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserRuleCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:UserRuleCollection", name, null, MakeResourceOptions(options, id))
        {
        }
