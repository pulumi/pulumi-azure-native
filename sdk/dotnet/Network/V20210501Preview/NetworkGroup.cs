...
namespace Pulumi.AzureNative.Network.V20210501Preview
{
    ...
    /// {
    ///     var networkGroup = new AzureNative.Network.V20210501Preview.NetworkGroup("networkGroup", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210501preview:NetworkGroup")]
    public partial class NetworkGroup : global::Pulumi.CustomResource
    {
        ...
        public NetworkGroup(string name, NetworkGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:NetworkGroup", name, args ?? new NetworkGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:NetworkGroup", name, null, MakeResourceOptions(options, id))
        {
        }
