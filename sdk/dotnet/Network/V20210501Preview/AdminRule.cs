...
namespace Pulumi.AzureNative.Network.V20210501Preview
{
    ...
    public partial class AdminRule : Pulumi.CustomResource
    {
        ...
        public AdminRule(string name, AdminRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:AdminRule", name, args ?? new AdminRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class AdminRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210501Preview.AdminRuleKind> Kind { get; set; } = null!;
