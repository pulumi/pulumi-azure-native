...
namespace Pulumi.AzureNative.Network.V20210501Preview
{
    ...
    public static class GetUserRule
    {
        ...
        public static Task<GetUserRuleResult> InvokeAsync(GetUserRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetUserRuleResult>("azure-native:network/v20210501preview:getUserRule", args ?? new GetUserRuleArgs(), options.WithVersion());

        /// <summary>
        /// Network base rule.
        /// </summary>
        public static Output<GetUserRuleResult> Invoke(GetUserRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetUserRuleResult>("azure-native:network/v20210501preview:getUserRule", args ?? new GetUserRuleInvokeArgs(), options.WithVersion());
    }
