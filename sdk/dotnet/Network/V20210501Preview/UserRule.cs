...
namespace Pulumi.AzureNative.Network.V20210501Preview
{
    ...
    public partial class UserRule : Pulumi.CustomResource
    {
        ...
        public UserRule(string name, UserRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:UserRule", name, args ?? new UserRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501preview:UserRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210501Preview.UserRuleKind> Kind { get; set; } = null!;
