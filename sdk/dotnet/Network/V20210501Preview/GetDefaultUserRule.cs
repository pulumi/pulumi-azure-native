...
namespace Pulumi.AzureNative.Network.V20210501Preview
{
    public static class GetDefaultUserRule
    {
        ...
        public static Task<GetDefaultUserRuleResult> InvokeAsync(GetDefaultUserRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDefaultUserRuleResult>("azure-native:network/v20210501preview:getDefaultUserRule", args ?? new GetDefaultUserRuleArgs(), options.WithDefaults());
