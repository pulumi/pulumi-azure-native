...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class ApplicationGateway : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ApplicationGatewayPropertiesFormatResponse> Properties { get; private set; } = null!;
        ...
        public ApplicationGateway(string name, ApplicationGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:ApplicationGateway", name, args ?? new ApplicationGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ApplicationGateway(string name, Input<string> id, ApplicationGatewayState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:ApplicationGateway", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApplicationGatewayState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ApplicationGatewayPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
