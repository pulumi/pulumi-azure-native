...
namespace Pulumi.AzureNextGen.Network.V20180101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20180101:NetworkSecurityGroup")]
    public partial class NetworkSecurityGroup : Pulumi.CustomResource
    {
        ...
        public NetworkSecurityGroup(string name, NetworkSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180101:NetworkSecurityGroup", name, args ?? new NetworkSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180101:NetworkSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
