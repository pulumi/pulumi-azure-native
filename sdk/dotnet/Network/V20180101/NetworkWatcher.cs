...
namespace Pulumi.AzureNative.Network.V20180101
{
    ...
    /// {
    ///     var networkWatcher = new AzureNative.Network.V20180101.NetworkWatcher("networkWatcher", new()
    ///     {
    ///         Location = "eastus",
    ...
    public partial class NetworkWatcher : global::Pulumi.CustomResource
    {
        ...
        public NetworkWatcher(string name, NetworkWatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180101:NetworkWatcher", name, args ?? new NetworkWatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkWatcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180101:NetworkWatcher", name, null, MakeResourceOptions(options, id))
        {
        }
