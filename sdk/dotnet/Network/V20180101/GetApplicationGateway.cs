...
namespace Pulumi.AzureRM.Network.V20180101
{
    public static class GetApplicationGateway
    {
        public static Task<GetApplicationGatewayResult> InvokeAsync(GetApplicationGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationGatewayResult>("azurerm:network/v20180101:getApplicationGateway", args ?? new GetApplicationGatewayArgs(), options.WithVersion());
    }
