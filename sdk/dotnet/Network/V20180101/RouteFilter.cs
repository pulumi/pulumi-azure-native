...
namespace Pulumi.AzureNative.Network.V20180101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20180101:RouteFilter")]
    public partial class RouteFilter : Pulumi.CustomResource
    {
        ...
        public RouteFilter(string name, RouteFilterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180101:RouteFilter", name, args ?? new RouteFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180101:RouteFilter", name, null, MakeResourceOptions(options, id))
        {
        }
