...
namespace Pulumi.AzureNextGen.Network.V20180101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20180101:VirtualNetworkGateway")]
    public partial class VirtualNetworkGateway : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGateway(string name, VirtualNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180101:VirtualNetworkGateway", name, args ?? new VirtualNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180101:VirtualNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
