...
namespace Pulumi.AzureNative.Network.V20180101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20180101:RouteFilterRule")]
    public partial class RouteFilterRule : Pulumi.CustomResource
    {
        ...
        public RouteFilterRule(string name, RouteFilterRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180101:RouteFilterRule", name, args ?? new RouteFilterRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilterRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180101:RouteFilterRule", name, null, MakeResourceOptions(options, id))
        {
        }
