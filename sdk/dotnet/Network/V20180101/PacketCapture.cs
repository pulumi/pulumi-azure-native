...
namespace Pulumi.AzureNative.Network.V20180101
{
    ...
    /// {
    ///     var packetCapture = new AzureNative.Network.V20180101.PacketCapture("packetCapture", new()
    ///     {
    ///         BytesToCapturePerPacket = 10000,
    ///         Filters = new[]
    ///         {
    ///             new AzureNative.Network.V20180101.Inputs.PacketCaptureFilterArgs
    ///             {
    ...
    ///         StorageLocation = new AzureNative.Network.V20180101.Inputs.PacketCaptureStorageLocationArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20180101:PacketCapture pc1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/networkWatchers/nw1/packetCaptures/pc1 
    /// ```
    /// </summary>
    [Obsolete(@"Version 2018-01-01 will be removed in v2 of the provider.")]
    [AzureNativeResourceType("azure-native:network/v20180101:PacketCapture")]
    public partial class PacketCapture : global::Pulumi.CustomResource
    {
        ...
        public PacketCapture(string name, PacketCaptureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180101:PacketCapture", name, args ?? new PacketCaptureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCapture(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180101:PacketCapture", name, null, MakeResourceOptions(options, id))
        {
        }
