...
namespace Pulumi.AzureNative.Network.V20180601.Inputs
{
    ...
    public sealed class ExpressRouteCircuitPeeringArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("peeringType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20180601.ExpressRoutePeeringType>? PeeringType { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20180601.ExpressRoutePeeringState>? State { get; set; }
