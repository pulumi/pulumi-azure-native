...
namespace Pulumi.AzureRM.Network.V20180601
{
    public static class GetApplicationGateway
    {
        public static Task<GetApplicationGatewayResult> InvokeAsync(GetApplicationGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationGatewayResult>("azurerm:network/v20180601:getApplicationGateway", args ?? new GetApplicationGatewayArgs(), options.WithVersion());
    }
