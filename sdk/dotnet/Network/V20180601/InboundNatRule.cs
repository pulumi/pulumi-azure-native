...
namespace Pulumi.AzureNextGen.Network.V20180601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20180601:InboundNatRule")]
    ...
    public sealed class InboundNatRuleArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20180601.TransportProtocol>? Protocol { get; set; }
