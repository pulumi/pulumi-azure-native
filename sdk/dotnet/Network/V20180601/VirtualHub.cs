...
namespace Pulumi.AzureNative.Network.V20180601
{
    ...
    /// VirtualHub Resource.
    /// </summary>
    [Obsolete(@"azure-native:network/v20180601:VirtualHub is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20180701:VirtualHub to guarantee forwards compatibility.")]
    ...
    public partial class VirtualHub : global::Pulumi.CustomResource
    {
        ...
        public VirtualHub(string name, VirtualHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180601:VirtualHub", name, args ?? new VirtualHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180601:VirtualHub", name, null, MakeResourceOptions(options, id))
        {
        }
