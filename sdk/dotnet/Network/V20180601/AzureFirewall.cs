...
namespace Pulumi.AzureNextGen.Network.V20180601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20180601:AzureFirewall")]
    public partial class AzureFirewall : Pulumi.CustomResource
    {
        ...
        public AzureFirewall(string name, AzureFirewallArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180601:AzureFirewall", name, args ?? new AzureFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureFirewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180601:AzureFirewall", name, null, MakeResourceOptions(options, id))
        {
        }
