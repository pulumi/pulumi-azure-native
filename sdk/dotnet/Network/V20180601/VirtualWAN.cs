...
namespace Pulumi.AzureNative.Network.V20180601
{
    ...
    /// VirtualWAN Resource.
    /// </summary>
    [Obsolete(@"azure-native:network/v20180601:VirtualWAN is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180701:VirtualWAN to guarantee forwards compatibility.")]
    ...
    public partial class VirtualWAN : global::Pulumi.CustomResource
    {
        ...
        public VirtualWAN(string name, VirtualWANArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180601:VirtualWAN", name, args ?? new VirtualWANArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWAN(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180601:VirtualWAN", name, null, MakeResourceOptions(options, id))
        {
        }
