...
namespace Pulumi.AzureNative.Network.V20180601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20180601:PacketCapture is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200601:PacketCapture to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20180601:PacketCapture")]
    public partial class PacketCapture : global::Pulumi.CustomResource
    {
        ...
        public PacketCapture(string name, PacketCaptureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180601:PacketCapture", name, args ?? new PacketCaptureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCapture(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180601:PacketCapture", name, null, MakeResourceOptions(options, id))
        {
        }
