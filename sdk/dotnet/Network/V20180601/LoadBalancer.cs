...
namespace Pulumi.AzureNative.Network.V20180601
{
    ...
    /// {
    ///     var loadBalancer = new AzureNative.Network.V20180601.LoadBalancer("loadBalancer", new()
    ///     {
    ///         BackendAddressPools = new[]
    ///         {
    ///             new AzureNative.Network.V20180601.Inputs.BackendAddressPoolArgs
    ///             {
    ///                 Name = "be-lb",
    ///             },
    ///         },
    ...
    ///         {
    ///             new AzureNative.Network.V20180601.Inputs.FrontendIPConfigurationArgs
    ///             {
    ///                 Name = "fe-lb",
    ///                 Subnet = new AzureNative.Network.V20180601.Inputs.SubnetArgs
    ///                 {
    ...
    ///         InboundNatRules = new[]
    ///         {
    ///             new AzureNative.Network.V20180601.Inputs.InboundNatRuleArgs
    ///             {
    ///                 BackendPort = 3389,
    ///                 EnableFloatingIP = true,
    ///                 FrontendIPConfiguration = new AzureNative.Network.V20180601.Inputs.SubResourceArgs
    ///                 {
    ...
    ///         {
    ///             new AzureNative.Network.V20180601.Inputs.LoadBalancingRuleArgs
    ///             {
    ///                 BackendAddressPool = new AzureNative.Network.V20180601.Inputs.SubResourceArgs
    ///                 {
    ...
    ///                 Name = "rulelb",
    ///                 Probe = new AzureNative.Network.V20180601.Inputs.SubResourceArgs
    ///                 {
    ...
    ///         },
    ///         Location = "eastus",
    ///         OutboundNatRules = new[] {},
    ///         Probes = new[]
    ///         {
    ///             new AzureNative.Network.V20180601.Inputs.ProbeArgs
    ///             {
    ...
    ///         },
    ///         ResourceGroupName = "rg1",
    ///         Sku = new AzureNative.Network.V20180601.Inputs.LoadBalancerSkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ///     });
    ...
    ///         InboundNatPools = new[]
    ///         {
    ///             new AzureNative.Network.V20180601.Inputs.InboundNatPoolArgs
    ///             {
    ///                 BackendPort = 8888,
    ///                 EnableFloatingIP = true,
    ///                 FrontendIPConfiguration = new AzureNative.Network.V20180601.Inputs.SubResourceArgs
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20180601:LoadBalancer lb /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20180601:LoadBalancer")]
    public partial class LoadBalancer : global::Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180601:LoadBalancer", name, args ?? new LoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180601:LoadBalancer", name, null, MakeResourceOptions(options, id))
        {
        }
