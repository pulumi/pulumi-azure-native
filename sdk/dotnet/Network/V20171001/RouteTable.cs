...
namespace Pulumi.AzureNextGen.Network.V20171001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20171001:RouteTable")]
    public partial class RouteTable : Pulumi.CustomResource
    {
        ...
        public RouteTable(string name, RouteTableArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20171001:RouteTable", name, args ?? new RouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20171001:RouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
