...
namespace Pulumi.AzureNative.Network.V20171001.Inputs
{
    ...
    public sealed class IpsecPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20171001.DhGroup> DhGroup { get; set; } = null!;

        /// <summary>
        /// The IKE encryption algorithm (IKE phase 2).
        /// </summary>
        [Input("ikeEncryption", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Network.V20171001.IkeEncryption> IkeEncryption { get; set; } = null!;

        /// <summary>
        /// The IKE integrity algorithm (IKE phase 2).
        /// </summary>
        [Input("ikeIntegrity", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Network.V20171001.IkeIntegrity> IkeIntegrity { get; set; } = null!;

        /// <summary>
        /// The IPSec encryption algorithm (IKE phase 1).
        /// </summary>
        [Input("ipsecEncryption", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Network.V20171001.IpsecEncryption> IpsecEncryption { get; set; } = null!;

        /// <summary>
        /// The IPSec integrity algorithm (IKE phase 1).
        /// </summary>
        [Input("ipsecIntegrity", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Network.V20171001.IpsecIntegrity> IpsecIntegrity { get; set; } = null!;

        /// <summary>
        /// The DH Groups used in IKE Phase 2 for new child SA.
        /// </summary>
        [Input("pfsGroup", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Network.V20171001.PfsGroup> PfsGroup { get; set; } = null!;
