...
namespace Pulumi.AzureNative.Network.V20171001
{
    ...
    public static class GetRecordSet
    {
        ...
        public static Task<GetRecordSetResult> InvokeAsync(GetRecordSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRecordSetResult>("azure-native:network/v20171001:getRecordSet", args ?? new GetRecordSetArgs(), options.WithDefaults());

        /// <summary>
        /// Describes a DNS record set (a collection of DNS records with the same name and type).
        /// </summary>
        public static Output<GetRecordSetResult> Invoke(GetRecordSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRecordSetResult>("azure-native:network/v20171001:getRecordSet", args ?? new GetRecordSetInvokeArgs(), options.WithDefaults());
    }
