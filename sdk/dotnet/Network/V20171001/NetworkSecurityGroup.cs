...
namespace Pulumi.AzureNextGen.Network.V20171001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20171001:NetworkSecurityGroup")]
    public partial class NetworkSecurityGroup : Pulumi.CustomResource
    {
        ...
        public NetworkSecurityGroup(string name, NetworkSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20171001:NetworkSecurityGroup", name, args ?? new NetworkSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20171001:NetworkSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
