...
namespace Pulumi.AzureRM.Network.V20171001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var zone = new AzureRM.Network.V20171001.Zone("zone", new AzureRM.Network.V20171001.ZoneArgs
    ///         {
    ///             Location = "Global",
    ...
    public partial class Zone : Pulumi.CustomResource
    {
        ...
        public Zone(string name, ZoneArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20171001:Zone", name, args ?? new ZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Zone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20171001:Zone", name, null, MakeResourceOptions(options, id))
        {
        }
