...
namespace Pulumi.AzureRM.Network.V20171001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var recordSet = new AzureRM.Network.V20171001.RecordSet("recordSet", new AzureRM.Network.V20171001.RecordSetArgs
    ///         {
    ///             ARecords = 
    ///             {
    ///                 new AzureRM.Network.V20171001.Inputs.ARecordArgs
    ///                 {
    ...
    ///             AaaaRecords = 
    ///             {
    ///                 new AzureRM.Network.V20171001.Inputs.AaaaRecordArgs
    ///                 {
    ///                     Ipv6Address = "::1",
    ///                 },
    ///             },
    ...
    ///             CaaRecords = 
    ///             {
    ///                 new AzureRM.Network.V20171001.Inputs.CaaRecordArgs
    ///                 {
    ///                     Flags = 0,
    ///                     Tag = "issue",
    ...
    ///         var recordSet = new AzureRM.Network.V20171001.RecordSet("recordSet", new AzureRM.Network.V20171001.RecordSetArgs
    ///         {
    ///             CnameRecord = new AzureRM.Network.V20171001.Inputs.CnameRecordArgs
    ///             {
    ///                 Cname = "contoso.com",
    ///             },
    ///             Metadata = 
    ...
    ///             MxRecords = 
    ///             {
    ///                 new AzureRM.Network.V20171001.Inputs.MxRecordArgs
    ///                 {
    ...
    ///             NsRecords = 
    ///             {
    ///                 new AzureRM.Network.V20171001.Inputs.NsRecordArgs
    ///                 {
    ...
    ///             PtrRecords = 
    ///             {
    ///                 new AzureRM.Network.V20171001.Inputs.PtrRecordArgs
    ///                 {
    ///                     Ptrdname = "localhost",
    ///                 },
    ///             },
    ...
    ///             ResourceGroupName = "rg1",
    ///             SoaRecord = new AzureRM.Network.V20171001.Inputs.SoaRecordArgs
    ///             {
    ...
    ///             SrvRecords = 
    ///             {
    ///                 new AzureRM.Network.V20171001.Inputs.SrvRecordArgs
    ///                 {
    ///                     Port = 80,
    ///                     Priority = 0,
    ///                     Target = "contoso.com",
    ...
    ///             TxtRecords = 
    ///             {
    ///                 new AzureRM.Network.V20171001.Inputs.TxtRecordArgs
    ///                 {
    ///                     Value = 
    ///                     {
    ///                         "string1",
    ...
    public partial class RecordSet : Pulumi.CustomResource
    {
        ...
        public RecordSet(string name, RecordSetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20171001:RecordSet", name, args ?? new RecordSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RecordSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20171001:RecordSet", name, null, MakeResourceOptions(options, id))
        {
        }
