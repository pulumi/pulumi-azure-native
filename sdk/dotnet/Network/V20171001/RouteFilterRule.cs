...
namespace Pulumi.AzureNextGen.Network.V20171001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20171001:RouteFilterRule")]
    public partial class RouteFilterRule : Pulumi.CustomResource
    {
        ...
        public RouteFilterRule(string name, RouteFilterRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20171001:RouteFilterRule", name, args ?? new RouteFilterRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilterRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20171001:RouteFilterRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteFilterRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20171001.Access> Access { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20171001.RouteFilterRuleType> RouteFilterRuleType { get; set; } = null!;
