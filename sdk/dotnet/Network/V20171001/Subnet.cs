...
namespace Pulumi.AzureRM.Network.V20171001
{
    ...
    public partial class Subnet : Pulumi.CustomResource
    {
        ...
        public Subnet(string name, SubnetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20171001:Subnet", name, args ?? new SubnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20171001:Subnet", name, null, MakeResourceOptions(options, id))
        {
        }
