...
namespace Pulumi.AzureNative.Network.V20171001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20171001:ApplicationSecurityGroup")]
    public partial class ApplicationSecurityGroup : Pulumi.CustomResource
    {
        ...
        public ApplicationSecurityGroup(string name, ApplicationSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20171001:ApplicationSecurityGroup", name, args ?? new ApplicationSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20171001:ApplicationSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
