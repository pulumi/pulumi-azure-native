...
namespace Pulumi.AzureRM.Network.V20150504Preview
{
    ...
    public partial class Zone : Pulumi.CustomResource
    {
        ...
        public Zone(string name, ZoneArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20150504preview:Zone", name, args ?? new ZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Zone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20150504preview:Zone", name, null, MakeResourceOptions(options, id))
        {
        }
