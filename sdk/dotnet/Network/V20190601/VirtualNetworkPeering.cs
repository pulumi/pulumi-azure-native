...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// {
    ///     var virtualNetworkPeering = new AzureNative.Network.V20190601.VirtualNetworkPeering("virtualNetworkPeering", new()
    ///     {
    ///         AllowForwardedTraffic = true,
    ///         AllowGatewayTransit = false,
    ///         AllowVirtualNetworkAccess = true,
    ///         RemoteVirtualNetwork = new AzureNative.Network.V20190601.Inputs.SubResourceArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190601:VirtualNetworkPeering")]
    public partial class VirtualNetworkPeering : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkPeering(string name, VirtualNetworkPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:VirtualNetworkPeering", name, args ?? new VirtualNetworkPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:VirtualNetworkPeering", name, null, MakeResourceOptions(options, id))
        {
        }
