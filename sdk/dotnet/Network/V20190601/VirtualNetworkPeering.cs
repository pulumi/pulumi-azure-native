...
namespace Pulumi.AzureRM.Network.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkPeering = new AzureRM.Network.V20190601.VirtualNetworkPeering("virtualNetworkPeering", new AzureRM.Network.V20190601.VirtualNetworkPeeringArgs
    ///         {
    ///             AllowForwardedTraffic = true,
    ///             AllowGatewayTransit = false,
    ///             AllowVirtualNetworkAccess = true,
    ///             RemoteVirtualNetwork = new AzureRM.Network.V20190601.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class VirtualNetworkPeering : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkPeering(string name, VirtualNetworkPeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:VirtualNetworkPeering", name, args ?? new VirtualNetworkPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:VirtualNetworkPeering", name, null, MakeResourceOptions(options, id))
        {
        }
