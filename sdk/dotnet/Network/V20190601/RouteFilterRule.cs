...
namespace Pulumi.AzureRM.Network.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var routeFilterRule = new AzureRM.Network.V20190601.RouteFilterRule("routeFilterRule", new AzureRM.Network.V20190601.RouteFilterRuleArgs
    ///         {
    ///             Access = "Allow",
    ///             Communities = 
    ///             {
    ...
    public partial class RouteFilterRule : Pulumi.CustomResource
    {
        ...
        public RouteFilterRule(string name, RouteFilterRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:RouteFilterRule", name, args ?? new RouteFilterRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilterRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:RouteFilterRule", name, null, MakeResourceOptions(options, id))
        {
        }
