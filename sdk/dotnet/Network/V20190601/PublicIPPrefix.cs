...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// {
    ///     var publicIPPrefix = new AzureNative.Network.V20190601.PublicIPPrefix("publicIPPrefix", new()
    ///     {
    ///         Location = "westus",
    ///         PrefixLength = 30,
    ...
    ///         Sku = new AzureNative.Network.V20190601.Inputs.PublicIPPrefixSkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ///     });
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20190601:PublicIPPrefix test-ipprefix /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/publicIPPrefixes/test-ipprefix 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190601:PublicIPPrefix")]
    public partial class PublicIPPrefix : global::Pulumi.CustomResource
    {
        ...
        public PublicIPPrefix(string name, PublicIPPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:PublicIPPrefix", name, args ?? new PublicIPPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:PublicIPPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20220101:PublicIPPrefix"},
                    new global::Pulumi.Alias { Type = "azure-native:network/v20220501:PublicIPPrefix"},
                    new global::Pulumi.Alias { Type = "azure-native:network/v20220701:PublicIPPrefix"},
                    new global::Pulumi.Alias { Type = "azure-native:network/v20220901:PublicIPPrefix"},
                },
            };
    ...
    public sealed class PublicIPPrefixArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190601.IPVersion>? PublicIPAddressVersion { get; set; }
