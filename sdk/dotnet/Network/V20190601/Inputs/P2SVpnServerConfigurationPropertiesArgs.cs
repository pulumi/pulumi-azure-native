...
namespace Pulumi.AzureNative.Network.V20190601.Inputs
{
    ...
    public sealed class P2SVpnServerConfigurationPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("vpnProtocols")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20190601.VpnGatewayTunnelingProtocol>>? _vpnProtocols;

        /// <summary>
        /// VPN protocols for the P2SVpnServerConfiguration.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20190601.VpnGatewayTunnelingProtocol>> VpnProtocols
        {
            get => _vpnProtocols ?? (_vpnProtocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20190601.VpnGatewayTunnelingProtocol>>());
