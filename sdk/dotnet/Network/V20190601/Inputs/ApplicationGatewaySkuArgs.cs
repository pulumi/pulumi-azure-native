...
namespace Pulumi.AzureNative.Network.V20190601.Inputs
{
    ...
    public sealed class ApplicationGatewaySkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190601.ApplicationGatewaySkuName>? Name { get; set; }

        /// <summary>
        /// Tier of an application gateway.
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190601.ApplicationGatewayTier>? Tier { get; set; }
