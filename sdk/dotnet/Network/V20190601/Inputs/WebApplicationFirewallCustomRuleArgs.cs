...
namespace Pulumi.AzureNative.Network.V20190601.Inputs
{
    ...
    public sealed class WebApplicationFirewallCustomRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190601.WebApplicationFirewallAction> Action { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190601.WebApplicationFirewallRuleType> RuleType { get; set; } = null!;
