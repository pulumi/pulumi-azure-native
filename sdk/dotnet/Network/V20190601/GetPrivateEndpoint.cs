...
namespace Pulumi.AzureRM.Network.V20190601
{
    public static class GetPrivateEndpoint
    {
        public static Task<GetPrivateEndpointResult> InvokeAsync(GetPrivateEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateEndpointResult>("azurerm:network/v20190601:getPrivateEndpoint", args ?? new GetPrivateEndpointArgs(), options.WithVersion());
    }
