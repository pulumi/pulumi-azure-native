...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// {
    ///     var publicIPAddress = new AzureNative.Network.V20190601.PublicIPAddress("publicIPAddress", new()
    ///     {
    ///         DnsSettings = new AzureNative.Network.V20190601.Inputs.PublicIPAddressDnsSettingsArgs
    ///         {
    ...
    ///         PublicIpAddressName = "test-ip",
    ///         ResourceGroupName = "rg1",
    ///         Sku = new AzureNative.Network.V20190601.Inputs.PublicIPAddressSkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ///     });
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190601:PublicIPAddress")]
    public partial class PublicIPAddress : global::Pulumi.CustomResource
    {
        ...
        public PublicIPAddress(string name, PublicIPAddressArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:PublicIPAddress", name, args ?? new PublicIPAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:PublicIPAddress", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PublicIPAddressArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190601.IPAllocationMethod>? PublicIPAllocationMethod { get; set; }
