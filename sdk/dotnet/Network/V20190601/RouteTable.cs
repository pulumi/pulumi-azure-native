...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// {
    ///     var routeTable = new AzureNative.Network.V20190601.RouteTable("routeTable", new()
    ///     {
    ///         Location = "westus",
    ...
    ///         Routes = new[]
    ///         {
    ///             new AzureNative.Network.V20190601.Inputs.RouteArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190601:RouteTable")]
    public partial class RouteTable : global::Pulumi.CustomResource
    {
        ...
        public RouteTable(string name, RouteTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:RouteTable", name, args ?? new RouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:RouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
