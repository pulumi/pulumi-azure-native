...
namespace Pulumi.AzureNextGen.Network.V20190601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190601:ExpressRouteCircuitAuthorization")]
    public partial class ExpressRouteCircuitAuthorization : Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitAuthorization(string name, ExpressRouteCircuitAuthorizationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190601:ExpressRouteCircuitAuthorization", name, args ?? new ExpressRouteCircuitAuthorizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitAuthorization(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190601:ExpressRouteCircuitAuthorization", name, null, MakeResourceOptions(options, id))
        {
        }
