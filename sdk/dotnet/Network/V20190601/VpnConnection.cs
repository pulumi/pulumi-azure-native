...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190601:VpnConnection")]
    public partial class VpnConnection : Pulumi.CustomResource
    {
        ...
        public VpnConnection(string name, VpnConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:VpnConnection", name, args ?? new VpnConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:VpnConnection", name, null, MakeResourceOptions(options, id))
        {
        }
