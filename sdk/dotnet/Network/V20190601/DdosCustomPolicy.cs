...
namespace Pulumi.AzureRM.Network.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var ddosCustomPolicy = new AzureRM.Network.V20190601.DdosCustomPolicy("ddosCustomPolicy", new AzureRM.Network.V20190601.DdosCustomPolicyArgs
    ///         {
    ///             DdosCustomPolicyName = "test-ddos-custom-policy",
    ///             Location = "centraluseuap",
    ///             ProtocolCustomSettings = 
    ///             {
    ///                 new AzureRM.Network.V20190601.Inputs.ProtocolCustomSettingsFormatArgs
    ///                 {
    ///                     Protocol = "Tcp",
    ///                 },
    ///             },
    ...
    public partial class DdosCustomPolicy : Pulumi.CustomResource
    {
        ...
        public DdosCustomPolicy(string name, DdosCustomPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:DdosCustomPolicy", name, args ?? new DdosCustomPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DdosCustomPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:DdosCustomPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
