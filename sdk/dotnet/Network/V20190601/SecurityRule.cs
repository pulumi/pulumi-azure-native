...
namespace Pulumi.AzureRM.Network.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var securityRule = new AzureRM.Network.V20190601.SecurityRule("securityRule", new AzureRM.Network.V20190601.SecurityRuleArgs
    ///         {
    ///             Access = "Deny",
    ...
    public partial class SecurityRule : Pulumi.CustomResource
    {
        ...
        public SecurityRule(string name, SecurityRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:SecurityRule", name, args ?? new SecurityRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:SecurityRule", name, null, MakeResourceOptions(options, id))
        {
        }
