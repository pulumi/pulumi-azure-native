...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190601:PrivateLinkService")]
    public partial class PrivateLinkService : Pulumi.CustomResource
    {
        ...
        public PrivateLinkService(string name, PrivateLinkServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:PrivateLinkService", name, args ?? new PrivateLinkServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:PrivateLinkService", name, null, MakeResourceOptions(options, id))
        {
        }
