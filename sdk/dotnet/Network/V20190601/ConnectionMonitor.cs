...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    [AzureNativeResourceType("azure-native:network/v20190601:ConnectionMonitor")]
    public partial class ConnectionMonitor : global::Pulumi.CustomResource
    {
        ...
        public ConnectionMonitor(string name, ConnectionMonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:ConnectionMonitor", name, args ?? new ConnectionMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:ConnectionMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
