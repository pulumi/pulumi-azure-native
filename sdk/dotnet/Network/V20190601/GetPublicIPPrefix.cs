...
namespace Pulumi.AzureNative.Network.V20190601
{
    public static class GetPublicIPPrefix
    {
        ...
        public static Task<GetPublicIPPrefixResult> InvokeAsync(GetPublicIPPrefixArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPublicIPPrefixResult>("azure-native:network/v20190601:getPublicIPPrefix", args ?? new GetPublicIPPrefixArgs(), options.WithDefaults());

        /// <summary>
        /// Public IP prefix resource.
        /// </summary>
        public static Output<GetPublicIPPrefixResult> Invoke(GetPublicIPPrefixInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPublicIPPrefixResult>("azure-native:network/v20190601:getPublicIPPrefix", args ?? new GetPublicIPPrefixInvokeArgs(), options.WithDefaults());
    }
