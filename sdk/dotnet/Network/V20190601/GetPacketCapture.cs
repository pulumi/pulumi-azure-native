...
namespace Pulumi.AzureNative.Network.V20190601
{
    public static class GetPacketCapture
    {
        ...
        public static Task<GetPacketCaptureResult> InvokeAsync(GetPacketCaptureArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPacketCaptureResult>("azure-native:network/v20190601:getPacketCapture", args ?? new GetPacketCaptureArgs(), options.WithVersion());

        /// <summary>
        /// Information about packet capture session.
        /// </summary>
        public static Output<GetPacketCaptureResult> Invoke(GetPacketCaptureInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPacketCaptureResult>("azure-native:network/v20190601:getPacketCapture", args ?? new GetPacketCaptureInvokeArgs(), options.WithVersion());
    }
