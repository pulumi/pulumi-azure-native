...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// VpnGateway Resource.
    /// </summary>
    [Obsolete(@"azure-native:network/v20190601:VpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnGateway to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20190601:VpnGateway")]
    public partial class VpnGateway : global::Pulumi.CustomResource
    {
        ...
        public VpnGateway(string name, VpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:VpnGateway", name, args ?? new VpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:VpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
