...
namespace Pulumi.AzureRM.Network.V20190601
{
    public static class GetVpnConnection
    {
        public static Task<GetVpnConnectionResult> InvokeAsync(GetVpnConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnConnectionResult>("azurerm:network/v20190601:getVpnConnection", args ?? new GetVpnConnectionArgs(), options.WithVersion());
    }
