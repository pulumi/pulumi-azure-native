...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// {
    ///     var inboundNatRule = new AzureNative.Network.V20190601.InboundNatRule("inboundNatRule", new()
    ///     {
    ///         BackendPort = 3389,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190601:InboundNatRule")]
    public partial class InboundNatRule : global::Pulumi.CustomResource
    {
        ...
        public InboundNatRule(string name, InboundNatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:InboundNatRule", name, args ?? new InboundNatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InboundNatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:InboundNatRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InboundNatRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190601.TransportProtocol>? Protocol { get; set; }
