...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// {
    ///     var natGateway = new AzureNative.Network.V20190601.NatGateway("natGateway", new()
    ///     {
    ///         Location = "westus",
    ///         NatGatewayName = "test-natgateway",
    ///         PublicIpAddresses = new[]
    ///         {
    ///             new AzureNative.Network.V20190601.Inputs.SubResourceArgs
    ///             {
    ...
    ///         Sku = new AzureNative.Network.V20190601.Inputs.NatGatewaySkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ///     });
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20190601:NatGateway test-natGateway /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/natGateways/test-natGateway 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190601:NatGateway")]
    public partial class NatGateway : global::Pulumi.CustomResource
    {
        ...
        public NatGateway(string name, NatGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:NatGateway", name, args ?? new NatGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:NatGateway", name, null, MakeResourceOptions(options, id))
        {
        }
