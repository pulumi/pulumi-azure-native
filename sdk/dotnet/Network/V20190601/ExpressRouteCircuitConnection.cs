...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20190601:ExpressRouteCircuitConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuitConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20190601:ExpressRouteCircuitConnection")]
    public partial class ExpressRouteCircuitConnection : global::Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitConnection(string name, ExpressRouteCircuitConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:ExpressRouteCircuitConnection", name, args ?? new ExpressRouteCircuitConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:ExpressRouteCircuitConnection", name, null, MakeResourceOptions(options, id))
        {
        }
