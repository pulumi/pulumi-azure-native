...
namespace Pulumi.AzureRM.Network.V20190601
{
    public static class GetSecurityRule
    {
        public static Task<GetSecurityRuleResult> InvokeAsync(GetSecurityRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSecurityRuleResult>("azurerm:network/v20190601:getSecurityRule", args ?? new GetSecurityRuleArgs(), options.WithVersion());
    }
