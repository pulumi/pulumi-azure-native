...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// {
    ///     var route = new AzureNative.Network.V20190601.Route("route", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190601:Route")]
    public partial class Route : global::Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:Route", name, null, MakeResourceOptions(options, id))
        {
        }
