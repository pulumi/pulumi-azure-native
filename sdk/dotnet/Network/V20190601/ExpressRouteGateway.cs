...
namespace Pulumi.AzureRM.Network.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var expressRouteGateway = new AzureRM.Network.V20190601.ExpressRouteGateway("expressRouteGateway", new AzureRM.Network.V20190601.ExpressRouteGatewayArgs
    ///         {
    ///             AutoScaleConfiguration = new AzureRM.Network.V20190601.Inputs.ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs
    ///             {
    ///                 Bounds = new AzureRM.Network.V20190601.Inputs.ExpressRouteGatewayPropertiesBoundsArgs
    ///                 {
    ///                     Min = 3,
    ///                 },
    ///             },
    ...
    ///             VirtualHub = new AzureRM.Network.V20190601.Inputs.VirtualHubIdArgs
    ///             {
    ...
    public partial class ExpressRouteGateway : Pulumi.CustomResource
    {
        ...
        public ExpressRouteGateway(string name, ExpressRouteGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:ExpressRouteGateway", name, args ?? new ExpressRouteGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:ExpressRouteGateway", name, null, MakeResourceOptions(options, id))
        {
        }
