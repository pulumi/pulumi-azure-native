...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// {
    ///     var loadBalancer = new AzureNative.Network.V20190601.LoadBalancer("loadBalancer", new()
    ///     {
    ///         BackendAddressPools = new[]
    ///         {
    ///             new AzureNative.Network.V20190601.Inputs.BackendAddressPoolArgs
    ///             {
    ///                 Name = "be-lb",
    ///             },
    ///         },
    ...
    ///         {
    ///             new AzureNative.Network.V20190601.Inputs.FrontendIPConfigurationArgs
    ///             {
    ///                 Name = "fe-lb",
    ...
    ///         InboundNatRules = new[]
    ///         {
    ///             new AzureNative.Network.V20190601.Inputs.InboundNatRuleArgs
    ///             {
    ///                 BackendPort = 3389,
    ...
    ///         {
    ///             new AzureNative.Network.V20190601.Inputs.LoadBalancingRuleArgs
    ///             {
    ...
    ///                 Name = "rulelb",
    ///                 Probe = new AzureNative.Network.V20190601.Inputs.SubResourceArgs
    ///                 {
    ...
    ///         Probes = new[]
    ///         {
    ///             new AzureNative.Network.V20190601.Inputs.ProbeArgs
    ///             {
    ...
    ///         },
    ///         ResourceGroupName = "rg1",
    ///         Sku = new AzureNative.Network.V20190601.Inputs.LoadBalancerSkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ///     });
    ...
    ///         InboundNatPools = new[]
    ///         {
    ///             new AzureNative.Network.V20190601.Inputs.InboundNatPoolArgs
    ///             {
    ///                 BackendPort = 8888,
    ///                 EnableFloatingIP = true,
    ///                 EnableTcpReset = true,
    ...
    ///         OutboundRules = new[]
    ///         {
    ///             new AzureNative.Network.V20190601.Inputs.OutboundRuleArgs
    ///             {
    ///                 BackendAddressPool = new AzureNative.Network.V20190601.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb/backendAddressPools/be-lb",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190601:LoadBalancer")]
    public partial class LoadBalancer : global::Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:LoadBalancer", name, args ?? new LoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:LoadBalancer", name, null, MakeResourceOptions(options, id))
        {
        }
