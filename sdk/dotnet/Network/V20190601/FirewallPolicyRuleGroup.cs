...
namespace Pulumi.AzureRM.Network.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var firewallPolicyRuleGroup = new AzureRM.Network.V20190601.FirewallPolicyRuleGroup("firewallPolicyRuleGroup", new AzureRM.Network.V20190601.FirewallPolicyRuleGroupArgs
    ///         {
    ...
    public partial class FirewallPolicyRuleGroup : Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleGroup(string name, FirewallPolicyRuleGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:FirewallPolicyRuleGroup", name, args ?? new FirewallPolicyRuleGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:FirewallPolicyRuleGroup", name, null, MakeResourceOptions(options, id))
        {
        }
