...
namespace Pulumi.AzureRM.Network.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualWan = new AzureRM.Network.V20190601.VirtualWan("virtualWan", new AzureRM.Network.V20190601.VirtualWanArgs
    ///         {
    ...
    public partial class VirtualWan : Pulumi.CustomResource
    {
        ...
        public VirtualWan(string name, VirtualWanArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:VirtualWan", name, args ?? new VirtualWanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190601:VirtualWan", name, null, MakeResourceOptions(options, id))
        {
        }
