...
namespace Pulumi.AzureNextGen.Network.V20190601
{
    public static class GetNetworkProfile
    {
        public static Task<GetNetworkProfileResult> InvokeAsync(GetNetworkProfileArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkProfileResult>("azure-nextgen:network/v20190601:getNetworkProfile", args ?? new GetNetworkProfileArgs(), options.WithVersion());
    }
