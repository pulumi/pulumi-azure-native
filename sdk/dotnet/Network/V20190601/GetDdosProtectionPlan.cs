...
namespace Pulumi.AzureNextGen.Network.V20190601
{
    public static class GetDdosProtectionPlan
    {
        public static Task<GetDdosProtectionPlanResult> InvokeAsync(GetDdosProtectionPlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDdosProtectionPlanResult>("azure-nextgen:network/v20190601:getDdosProtectionPlan", args ?? new GetDdosProtectionPlanArgs(), options.WithVersion());
    }
