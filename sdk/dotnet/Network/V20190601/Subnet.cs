...
namespace Pulumi.AzureNative.Network.V20190601
{
    ...
    /// {
    ///     var subnet = new AzureNative.Network.V20190601.Subnet("subnet", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190601:Subnet")]
    public partial class Subnet : global::Pulumi.CustomResource
    {
        ...
        public Subnet(string name, SubnetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:Subnet", name, args ?? new SubnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190601:Subnet", name, null, MakeResourceOptions(options, id))
        {
        }
