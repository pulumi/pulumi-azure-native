...
namespace Pulumi.AzureNative.Network.V20210301.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210301.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210301.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
