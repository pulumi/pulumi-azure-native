...
namespace Pulumi.AzureNative.Network.V20210301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20210301:NatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NatRule to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20210301:NatRule")]
    public partial class NatRule : global::Pulumi.CustomResource
    {
        ...
        public NatRule(string name, NatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210301:NatRule", name, args ?? new NatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210301:NatRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NatRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210301.VpnNatRuleMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210301.VpnNatRuleType>? Type { get; set; }
