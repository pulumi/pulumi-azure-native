...
{
    [Obsolete(@"azure-native:network/v20210301:SecurityRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220701:SecurityRule to guarantee forwards compatibility.")]
    public static class GetSecurityRule
    {
        ...
        public static Task<GetSecurityRuleResult> InvokeAsync(GetSecurityRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSecurityRuleResult>("azure-native:network/v20210301:getSecurityRule", args ?? new GetSecurityRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Get the specified network security rule.
        /// </summary>
        public static Output<GetSecurityRuleResult> Invoke(GetSecurityRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSecurityRuleResult>("azure-native:network/v20210301:getSecurityRule", args ?? new GetSecurityRuleInvokeArgs(), options.WithDefaults());
    }
