...
namespace Pulumi.AzureNative.Network.V20210301
{
    public static class GetNetworkProfile
    {
        ...
        public static Task<GetNetworkProfileResult> InvokeAsync(GetNetworkProfileArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkProfileResult>("azure-native:network/v20210301:getNetworkProfile", args ?? new GetNetworkProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Network profile resource.
        /// </summary>
        public static Output<GetNetworkProfileResult> Invoke(GetNetworkProfileInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNetworkProfileResult>("azure-native:network/v20210301:getNetworkProfile", args ?? new GetNetworkProfileInvokeArgs(), options.WithDefaults());
    }
