...
namespace Pulumi.AzureNative.Network.V20210301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20210301:NetworkProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkProfile to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20210301:NetworkProfile")]
    public partial class NetworkProfile : global::Pulumi.CustomResource
    {
        ...
        public NetworkProfile(string name, NetworkProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210301:NetworkProfile", name, args ?? new NetworkProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210301:NetworkProfile", name, null, MakeResourceOptions(options, id))
        {
        }
