...
namespace Pulumi.AzureNative.Network.V20210301
{
    public static class GetExpressRoutePort
    {
        ...
        public static Task<GetExpressRoutePortResult> InvokeAsync(GetExpressRoutePortArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExpressRoutePortResult>("azure-native:network/v20210301:getExpressRoutePort", args ?? new GetExpressRoutePortArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the requested ExpressRoutePort resource.
        /// </summary>
        public static Output<GetExpressRoutePortResult> Invoke(GetExpressRoutePortInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExpressRoutePortResult>("azure-native:network/v20210301:getExpressRoutePort", args ?? new GetExpressRoutePortInvokeArgs(), options.WithDefaults());
    }
