...
namespace Pulumi.AzureNative.Network.V20210301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20210301:HubVirtualNetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:HubVirtualNetworkConnection to guarantee forwards compatibility.")]
    ...
    public partial class HubVirtualNetworkConnection : global::Pulumi.CustomResource
    {
        ...
        public HubVirtualNetworkConnection(string name, HubVirtualNetworkConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210301:HubVirtualNetworkConnection", name, args ?? new HubVirtualNetworkConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubVirtualNetworkConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210301:HubVirtualNetworkConnection", name, null, MakeResourceOptions(options, id))
        {
        }
