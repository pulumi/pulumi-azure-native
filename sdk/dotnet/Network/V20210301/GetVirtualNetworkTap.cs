...
namespace Pulumi.AzureNative.Network.V20210301
{
    public static class GetVirtualNetworkTap
    {
        ...
        public static Task<GetVirtualNetworkTapResult> InvokeAsync(GetVirtualNetworkTapArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkTapResult>("azure-native:network/v20210301:getVirtualNetworkTap", args ?? new GetVirtualNetworkTapArgs(), options.WithDefaults());

        /// <summary>
        /// Virtual Network Tap resource.
        /// </summary>
        public static Output<GetVirtualNetworkTapResult> Invoke(GetVirtualNetworkTapInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVirtualNetworkTapResult>("azure-native:network/v20210301:getVirtualNetworkTap", args ?? new GetVirtualNetworkTapInvokeArgs(), options.WithDefaults());
    }
