...
namespace Pulumi.AzureNative.Network.V20210301
{
    ...
    /// {
    ///     var virtualNetworkGatewayNatRule = new AzureNative.Network.V20210301.VirtualNetworkGatewayNatRule("virtualNetworkGatewayNatRule", new()
    ///     {
    ///         ExternalMappings = new[]
    ///         {
    ///             new AzureNative.Network.V20210301.Inputs.VpnNatRuleMappingArgs
    ///             {
    ...
    public partial class VirtualNetworkGatewayNatRule : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGatewayNatRule(string name, VirtualNetworkGatewayNatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210301:VirtualNetworkGatewayNatRule", name, args ?? new VirtualNetworkGatewayNatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGatewayNatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210301:VirtualNetworkGatewayNatRule", name, null, MakeResourceOptions(options, id))
        {
        }
