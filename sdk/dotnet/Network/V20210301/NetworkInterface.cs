    ...
    public partial class NetworkInterface : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:NetworkInterface"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:NetworkInterface"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:NetworkInterface"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:NetworkInterface"},
                },
            };
