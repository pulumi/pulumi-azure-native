...
namespace Pulumi.AzureNative.Network
{
    ...
    public partial class NspAccessRule : global::Pulumi.CustomResource
    {
        ...
        public NspAccessRule(string name, NspAccessRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network:NspAccessRule", name, args ?? new NspAccessRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NspAccessRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network:NspAccessRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_network_v20210201preview:network:NspAccessRule" },
                    new global::Pulumi.Alias { Type = "azure-native_network_v20230701preview:network:NspAccessRule" },
                    new global::Pulumi.Alias { Type = "azure-native_network_v20230801preview:network:NspAccessRule" },
                    new global::Pulumi.Alias { Type = "azure-native_network_v20240601preview:network:NspAccessRule" },
                },
            };
