...
namespace Pulumi.AzureNextGen.Network
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network:PrivateLinkService")]
    public partial class PrivateLinkService : Pulumi.CustomResource
    {
        ...
        public PrivateLinkService(string name, PrivateLinkServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network:PrivateLinkService", name, args ?? new PrivateLinkServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network:PrivateLinkService", name, null, MakeResourceOptions(options, id))
        {
        }
