...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class PrivateLinkService : Pulumi.CustomResource
    {
        ...
        public PrivateLinkService(string name, PrivateLinkServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:PrivateLinkService", name, args ?? new PrivateLinkServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkService(string name, Input<string> id, PrivateLinkServiceState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:PrivateLinkService", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PrivateLinkService Get(string name, Input<string> id, PrivateLinkServiceState? state = null, CustomResourceOptions? options = null)
        {
            return new PrivateLinkService(name, id, state, options);
        }
    }
    ...
    public sealed class PrivateLinkServiceState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A unique read-only string that changes whenever the resource is updated.
        /// </summary>
        ...
        public Input<Inputs.PrivateLinkServicePropertiesResponseGetArgs> Properties { get; set; } = null!;
        ...
        public PrivateLinkServiceState()
        {
        }
    }
}
