...
namespace Pulumi.AzureNative.Network.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220201preview:DefaultUserRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220401preview:DefaultUserRule to guarantee forwards compatibility.")]
    ...
    public partial class DefaultUserRule : global::Pulumi.CustomResource
    {
        ...
        public DefaultUserRule(string name, DefaultUserRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220201preview:DefaultUserRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private DefaultUserRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220201preview:DefaultUserRule", name, null, MakeResourceOptions(options, id))
        {
        }
