...
namespace Pulumi.AzureNative.Network.V20220201Preview
{
    ...
    /// {
    ///     var scopeConnection = new AzureNative.Network.V20220201Preview.ScopeConnection("scopeConnection", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220201preview:ScopeConnection")]
    public partial class ScopeConnection : global::Pulumi.CustomResource
    {
        ...
        public ScopeConnection(string name, ScopeConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220201preview:ScopeConnection", name, args ?? new ScopeConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220201preview:ScopeConnection", name, null, MakeResourceOptions(options, id))
        {
        }
