...
namespace Pulumi.AzureNative.Network.V20220201Preview
{
    ...
    /// StaticMember Item.
    /// </summary>
    [Obsolete(@"azure-native:network/v20220201preview:StaticMember is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:StaticMember to guarantee forwards compatibility.")]
    ...
    public partial class StaticMember : global::Pulumi.CustomResource
    {
        ...
        public StaticMember(string name, StaticMemberArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220201preview:StaticMember", name, args ?? new StaticMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220201preview:StaticMember", name, null, MakeResourceOptions(options, id))
        {
        }
