...
namespace Pulumi.AzureNative.Network.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220201preview:SecurityUserConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220401preview:SecurityUserConfiguration to guarantee forwards compatibility.")]
    ...
    public partial class SecurityUserConfiguration : global::Pulumi.CustomResource
    {
        ...
        public SecurityUserConfiguration(string name, SecurityUserConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220201preview:SecurityUserConfiguration", name, args ?? new SecurityUserConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityUserConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220201preview:SecurityUserConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityUserConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220201Preview.DeleteExistingNSGs>? DeleteExistingNSGs { get; set; }
