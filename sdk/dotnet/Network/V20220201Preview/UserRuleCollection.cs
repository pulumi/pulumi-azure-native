...
namespace Pulumi.AzureNative.Network.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220201preview:UserRuleCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220401preview:UserRuleCollection to guarantee forwards compatibility.")]
    ...
    public partial class UserRuleCollection : global::Pulumi.CustomResource
    {
        ...
        public UserRuleCollection(string name, UserRuleCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220201preview:UserRuleCollection", name, args ?? new UserRuleCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserRuleCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220201preview:UserRuleCollection", name, null, MakeResourceOptions(options, id))
        {
        }
