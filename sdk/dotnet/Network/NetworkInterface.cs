...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class NetworkInterface : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.NetworkInterfacePropertiesFormatResponse> Properties { get; private set; } = null!;
        ...
        public NetworkInterface(string name, NetworkInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:NetworkInterface", name, args ?? new NetworkInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterface(string name, Input<string> id, NetworkInterfaceState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:NetworkInterface", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkInterfaceState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.NetworkInterfacePropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
