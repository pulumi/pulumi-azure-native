...
namespace Pulumi.AzureNative.Network
{
    public static class GetNetworkProfile
    {
        ...
        public static Task<GetNetworkProfileResult> InvokeAsync(GetNetworkProfileArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkProfileResult>("azure-native:network:getNetworkProfile", args ?? new GetNetworkProfileArgs(), options.WithDefaults());
        ...
        public static Output<GetNetworkProfileResult> Invoke(GetNetworkProfileInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNetworkProfileResult>("azure-native:network:getNetworkProfile", args ?? new GetNetworkProfileInvokeArgs(), options.WithDefaults());
    }
