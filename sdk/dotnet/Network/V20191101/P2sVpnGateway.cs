...
namespace Pulumi.AzureRM.Network.V20191101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var p2sVpnGateway = new AzureRM.Network.V20191101.P2sVpnGateway("p2sVpnGateway", new AzureRM.Network.V20191101.P2sVpnGatewayArgs
    ///         {
    ///             GatewayName = "p2sVpnGateway1",
    ///             Location = "West US",
    ///             P2SConnectionConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20191101.Inputs.P2SConnectionConfigurationArgs
    ///                 {
    ...
    ///             VpnServerConfiguration = new AzureRM.Network.V20191101.Inputs.SubResourceArgs
    ///             {
