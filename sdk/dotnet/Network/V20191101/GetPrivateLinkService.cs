...
namespace Pulumi.AzureNative.Network.V20191101
{
    public static class GetPrivateLinkService
    {
        ...
        public static Task<GetPrivateLinkServiceResult> InvokeAsync(GetPrivateLinkServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateLinkServiceResult>("azure-native:network/v20191101:getPrivateLinkService", args ?? new GetPrivateLinkServiceArgs(), options.WithVersion());

        /// <summary>
        /// Private link service resource.
        /// </summary>
        public static Output<GetPrivateLinkServiceResult> Invoke(GetPrivateLinkServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPrivateLinkServiceResult>("azure-native:network/v20191101:getPrivateLinkService", args ?? new GetPrivateLinkServiceInvokeArgs(), options.WithVersion());
    }
