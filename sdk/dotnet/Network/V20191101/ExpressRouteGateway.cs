...
namespace Pulumi.AzureNative.Network.V20191101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20191101:ExpressRouteGateway")]
    public partial class ExpressRouteGateway : global::Pulumi.CustomResource
    {
        ...
        public ExpressRouteGateway(string name, ExpressRouteGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191101:ExpressRouteGateway", name, args ?? new ExpressRouteGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191101:ExpressRouteGateway", name, null, MakeResourceOptions(options, id))
        {
        }
