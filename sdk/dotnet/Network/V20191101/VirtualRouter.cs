...
namespace Pulumi.AzureRM.Network.V20191101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualRouter = new AzureRM.Network.V20191101.VirtualRouter("virtualRouter", new AzureRM.Network.V20191101.VirtualRouterArgs
    ///         {
    ///             HostedGateway = new AzureRM.Network.V20191101.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class VirtualRouter : Pulumi.CustomResource
    {
        ...
        public VirtualRouter(string name, VirtualRouterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:VirtualRouter", name, args ?? new VirtualRouterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:VirtualRouter", name, null, MakeResourceOptions(options, id))
        {
        }
