...
namespace Pulumi.AzureNative.Network.V20191101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20191101:VirtualRouter")]
    public partial class VirtualRouter : Pulumi.CustomResource
    {
        ...
        public VirtualRouter(string name, VirtualRouterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191101:VirtualRouter", name, args ?? new VirtualRouterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191101:VirtualRouter", name, null, MakeResourceOptions(options, id))
        {
        }
