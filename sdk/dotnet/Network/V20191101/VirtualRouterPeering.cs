...
namespace Pulumi.AzureNative.Network.V20191101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20191101:VirtualRouterPeering")]
    public partial class VirtualRouterPeering : Pulumi.CustomResource
    {
        ...
        public VirtualRouterPeering(string name, VirtualRouterPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191101:VirtualRouterPeering", name, args ?? new VirtualRouterPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouterPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191101:VirtualRouterPeering", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:network/v20201101:VirtualRouterPeering"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20201101:VirtualRouterPeering"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210201:VirtualRouterPeering"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:VirtualRouterPeering"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:VirtualRouterPeering"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:VirtualRouterPeering"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:VirtualRouterPeering"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:VirtualRouterPeering"},
                },
            };
