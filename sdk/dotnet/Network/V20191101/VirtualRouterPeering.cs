...
namespace Pulumi.AzureRM.Network.V20191101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualRouterPeering = new AzureRM.Network.V20191101.VirtualRouterPeering("virtualRouterPeering", new AzureRM.Network.V20191101.VirtualRouterPeeringArgs
    ///         {
    ///             PeerAsn = 20000,
    ///             PeerIp = "192.168.1.5",
    ...
    public partial class VirtualRouterPeering : Pulumi.CustomResource
    {
        ...
        public VirtualRouterPeering(string name, VirtualRouterPeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:VirtualRouterPeering", name, args ?? new VirtualRouterPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouterPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:VirtualRouterPeering", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:network/latest:VirtualRouterPeering"},
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/v20200601:VirtualRouterPeering"},
                },
            };
