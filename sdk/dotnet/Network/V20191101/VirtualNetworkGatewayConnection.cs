...
namespace Pulumi.AzureNative.Network.V20191101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20191101:VirtualNetworkGatewayConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkGatewayConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20191101:VirtualNetworkGatewayConnection")]
    public partial class VirtualNetworkGatewayConnection : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGatewayConnection(string name, VirtualNetworkGatewayConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191101:VirtualNetworkGatewayConnection", name, args ?? new VirtualNetworkGatewayConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGatewayConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191101:VirtualNetworkGatewayConnection", name, null, MakeResourceOptions(options, id))
        {
        }
