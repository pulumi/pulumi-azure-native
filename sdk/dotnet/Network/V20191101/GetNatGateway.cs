...
namespace Pulumi.AzureNative.Network.V20191101
{
    public static class GetNatGateway
    {
        ...
        public static Task<GetNatGatewayResult> InvokeAsync(GetNatGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNatGatewayResult>("azure-native:network/v20191101:getNatGateway", args ?? new GetNatGatewayArgs(), options.WithVersion());

        /// <summary>
        /// Nat Gateway resource.
        /// </summary>
        public static Output<GetNatGatewayResult> Invoke(GetNatGatewayInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNatGatewayResult>("azure-native:network/v20191101:getNatGateway", args ?? new GetNatGatewayInvokeArgs(), options.WithVersion());
    }
