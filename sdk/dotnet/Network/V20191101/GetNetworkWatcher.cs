...
namespace Pulumi.AzureNextGen.Network.V20191101
{
    public static class GetNetworkWatcher
    {
        public static Task<GetNetworkWatcherResult> InvokeAsync(GetNetworkWatcherArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkWatcherResult>("azure-nextgen:network/v20191101:getNetworkWatcher", args ?? new GetNetworkWatcherArgs(), options.WithVersion());
    }
