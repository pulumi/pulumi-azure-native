...
namespace Pulumi.AzureRM.Network.V20191101
{
    ...
    public partial class AzureFirewall : Pulumi.CustomResource
    {
        ...
        public AzureFirewall(string name, AzureFirewallArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:AzureFirewall", name, args ?? new AzureFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureFirewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:AzureFirewall", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/v20180801:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20181001:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20181101:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20181201:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190201:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190401:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190601:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190701:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190801:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190901:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20191201:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200301:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200401:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200501:AzureFirewall"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200601:AzureFirewall"},
                },
            };
