...
namespace Pulumi.AzureNative.Network.V20191101
{
    ...
    [AzureNativeResourceType("azure-native:network/v20191101:FirewallPolicyRuleGroup")]
    public partial class FirewallPolicyRuleGroup : global::Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleGroup(string name, FirewallPolicyRuleGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191101:FirewallPolicyRuleGroup", name, args ?? new FirewallPolicyRuleGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191101:FirewallPolicyRuleGroup", name, null, MakeResourceOptions(options, id))
        {
        }
