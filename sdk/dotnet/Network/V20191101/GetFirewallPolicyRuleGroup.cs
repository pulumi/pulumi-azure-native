...
namespace Pulumi.AzureNextGen.Network.V20191101
{
    public static class GetFirewallPolicyRuleGroup
    {
        public static Task<GetFirewallPolicyRuleGroupResult> InvokeAsync(GetFirewallPolicyRuleGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallPolicyRuleGroupResult>("azure-nextgen:network/v20191101:getFirewallPolicyRuleGroup", args ?? new GetFirewallPolicyRuleGroupArgs(), options.WithVersion());
    }
    ...
    public sealed class GetFirewallPolicyRuleGroupResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Union<Outputs.FirewallPolicyFilterRuleInvokeResponseResult, Outputs.FirewallPolicyNatRuleInvokeResponseResult>> Rules;
        /// <summary>
        /// Rule Group type.
        /// </summary>
        ...
        private GetFirewallPolicyRuleGroupResult(
            ...
            ImmutableArray<Union<Outputs.FirewallPolicyFilterRuleInvokeResponseResult, Outputs.FirewallPolicyNatRuleInvokeResponseResult>> rules,
