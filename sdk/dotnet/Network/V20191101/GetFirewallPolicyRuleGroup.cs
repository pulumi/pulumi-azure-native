...
namespace Pulumi.AzureRM.Network.V20191101
{
    public static class GetFirewallPolicyRuleGroup
    {
        public static Task<GetFirewallPolicyRuleGroupResult> InvokeAsync(GetFirewallPolicyRuleGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallPolicyRuleGroupResult>("azurerm:network/v20191101:getFirewallPolicyRuleGroup", args ?? new GetFirewallPolicyRuleGroupArgs(), options.WithVersion());
    }
    ...
    public sealed class GetFirewallPolicyRuleGroupResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Union<Outputs.FirewallPolicyFilterRuleResponseResult, Outputs.FirewallPolicyNatRuleResponseResult>> Rules;
        /// <summary>
        /// Rule Group type.
        /// </summary>
        ...
        private GetFirewallPolicyRuleGroupResult(
            ...
            ImmutableArray<Union<Outputs.FirewallPolicyFilterRuleResponseResult, Outputs.FirewallPolicyNatRuleResponseResult>> rules,
