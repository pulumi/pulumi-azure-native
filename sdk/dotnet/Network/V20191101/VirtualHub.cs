...
namespace Pulumi.AzureRM.Network.V20191101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualHub = new AzureRM.Network.V20191101.VirtualHub("virtualHub", new AzureRM.Network.V20191101.VirtualHubArgs
    ///         {
    ...
    public partial class VirtualHub : Pulumi.CustomResource
    {
        ...
        public VirtualHub(string name, VirtualHubArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:VirtualHub", name, args ?? new VirtualHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:VirtualHub", name, null, MakeResourceOptions(options, id))
        {
        }
