...
namespace Pulumi.AzureRM.Network.V20191101
{
    public static class GetFirewallPolicy
    {
        public static Task<GetFirewallPolicyResult> InvokeAsync(GetFirewallPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallPolicyResult>("azurerm:network/v20191101:getFirewallPolicy", args ?? new GetFirewallPolicyArgs(), options.WithVersion());
    }
