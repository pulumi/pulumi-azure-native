...
namespace Pulumi.AzureRM.Network.V20191101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var connectionMonitor = new AzureRM.Network.V20191101.ConnectionMonitor("connectionMonitor", new AzureRM.Network.V20191101.ConnectionMonitorArgs
    ///         {
    ///             ConnectionMonitorName = "cm1",
    ///             Destination = new AzureRM.Network.V20191101.Inputs.ConnectionMonitorDestinationArgs
    ///             {
    ///                 Address = "bing.com",
    ///                 Port = 80,
    ///             },
    ...
    ///             Source = new AzureRM.Network.V20191101.Inputs.ConnectionMonitorSourceArgs
    ///             {
    ...
    ///             Endpoints = 
    ///             {
    ///                 new AzureRM.Network.V20191101.Inputs.ConnectionMonitorEndpointArgs
    ///                 {
    ///                     Name = "vm1",
    ...
    ///                 new AzureRM.Network.V20191101.Inputs.ConnectionMonitorEndpointArgs
    ///                 {
    ///                     Filter = new AzureRM.Network.V20191101.Inputs.ConnectionMonitorEndpointFilterArgs
    ///                     {
    ///                         Items = 
    ///                         {
    ///                             new AzureRM.Network.V20191101.Inputs.ConnectionMonitorEndpointFilterItemArgs
    ///                             {
    ///                                 Address = "npmuser",
    ///                                 Type = "AgentAddress",
    ///                             },
    ...
    ///             TestConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20191101.Inputs.ConnectionMonitorTestConfigurationArgs
    ///                 {
    ///                     Name = "testConfig1",
    ///                     Protocol = "Tcp",
    ///                     TcpConfiguration = new AzureRM.Network.V20191101.Inputs.ConnectionMonitorTcpConfigurationArgs
    ///                     {
    ...
    ///             TestGroups = 
    ///             {
    ///                 new AzureRM.Network.V20191101.Inputs.ConnectionMonitorTestGroupArgs
    ///                 {
    ///                     Destinations = 
    ///                     {
    ///                         "bing",
