...
namespace Pulumi.AzureNative.Network.V20191101
{
    public static class GetSubnet
    {
        ...
        public static Task<GetSubnetResult> InvokeAsync(GetSubnetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSubnetResult>("azure-native:network/v20191101:getSubnet", args ?? new GetSubnetArgs(), options.WithVersion());

        /// <summary>
        /// Subnet in a virtual network resource.
        /// </summary>
        public static Output<GetSubnetResult> Invoke(GetSubnetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSubnetResult>("azure-native:network/v20191101:getSubnet", args ?? new GetSubnetInvokeArgs(), options.WithVersion());
    }
