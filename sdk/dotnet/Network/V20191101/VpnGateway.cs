...
namespace Pulumi.AzureRM.Network.V20191101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnGateway = new AzureRM.Network.V20191101.VpnGateway("vpnGateway", new AzureRM.Network.V20191101.VpnGatewayArgs
    ///         {
    ...
    ///             Connections = 
    ///             {
    ///                 new AzureRM.Network.V20191101.Inputs.VpnConnectionArgs
    ///                 {
    ///                     Name = "vpnConnection1",
    ///                 },
    ///             },
    ...
    public partial class VpnGateway : Pulumi.CustomResource
    {
        ...
        public VpnGateway(string name, VpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:VpnGateway", name, args ?? new VpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:VpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
