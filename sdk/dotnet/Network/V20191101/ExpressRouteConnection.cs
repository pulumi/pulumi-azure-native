...
namespace Pulumi.AzureRM.Network.V20191101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var expressRouteConnection = new AzureRM.Network.V20191101.ExpressRouteConnection("expressRouteConnection", new AzureRM.Network.V20191101.ExpressRouteConnectionArgs
    ///         {
    ///             AuthorizationKey = "authorizationKey",
    ///             ConnectionName = "connectionName",
    ///             ExpressRouteCircuitPeering = new AzureRM.Network.V20191101.Inputs.ExpressRouteCircuitPeeringIdArgs
    ///             {
    ...
    public partial class ExpressRouteConnection : Pulumi.CustomResource
    {
        ...
        public ExpressRouteConnection(string name, ExpressRouteConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:ExpressRouteConnection", name, args ?? new ExpressRouteConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:ExpressRouteConnection", name, null, MakeResourceOptions(options, id))
        {
        }
