...
namespace Pulumi.AzureNextGen.Network.V20191101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20191101:NetworkWatcher")]
    public partial class NetworkWatcher : Pulumi.CustomResource
    {
        ...
        public NetworkWatcher(string name, NetworkWatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20191101:NetworkWatcher", name, args ?? new NetworkWatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkWatcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20191101:NetworkWatcher", name, null, MakeResourceOptions(options, id))
        {
        }
