...
namespace Pulumi.AzureNextGen.Network.V20191101
{
    public static class GetVirtualWan
    {
        public static Task<GetVirtualWanResult> InvokeAsync(GetVirtualWanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualWanResult>("azure-nextgen:network/v20191101:getVirtualWan", args ?? new GetVirtualWanArgs(), options.WithVersion());
    }
