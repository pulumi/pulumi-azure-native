...
namespace Pulumi.AzureRM.Network.V20191101
{
    public static class GetVirtualRouter
    {
        public static Task<GetVirtualRouterResult> InvokeAsync(GetVirtualRouterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualRouterResult>("azurerm:network/v20191101:getVirtualRouter", args ?? new GetVirtualRouterArgs(), options.WithVersion());
    }
