...
namespace Pulumi.AzureRM.Network.V20191101
{
    ...
    public partial class PrivateLinkService : Pulumi.CustomResource
    {
        ...
        public PrivateLinkService(string name, PrivateLinkServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:PrivateLinkService", name, args ?? new PrivateLinkServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:PrivateLinkService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/preview:PrivateLinkService"},
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/v20200601:PrivateLinkService"},
                },
            };
