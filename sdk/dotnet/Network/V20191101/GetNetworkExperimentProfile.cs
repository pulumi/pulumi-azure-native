...
namespace Pulumi.AzureRM.Network.V20191101
{
    public static class GetNetworkExperimentProfile
    {
        public static Task<GetNetworkExperimentProfileResult> InvokeAsync(GetNetworkExperimentProfileArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkExperimentProfileResult>("azurerm:network/v20191101:getNetworkExperimentProfile", args ?? new GetNetworkExperimentProfileArgs(), options.WithVersion());
    }
