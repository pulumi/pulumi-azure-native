...
namespace Pulumi.AzureNextGen.Network.V20191101.Inputs
{
    ...
    public sealed class ConnectionMonitorTestConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20191101.PreferredIPVersion>? PreferredIPVersion { get; set; }

        /// <summary>
        /// The protocol to use in test evaluation.
        /// </summary>
        [Input("protocol", required: true)]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20191101.ConnectionMonitorTestConfigurationProtocol> Protocol { get; set; } = null!;
