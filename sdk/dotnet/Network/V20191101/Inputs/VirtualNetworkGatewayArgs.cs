...
namespace Pulumi.AzureNextGen.Network.V20191101.Inputs
{
    ...
    public sealed class VirtualNetworkGatewayArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("gatewayType")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20191101.VirtualNetworkGatewayType>? GatewayType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20191101.VpnGatewayGeneration>? VpnGatewayGeneration { get; set; }

        /// <summary>
        /// The type of this virtual network gateway.
        /// </summary>
        [Input("vpnType")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20191101.VpnType>? VpnType { get; set; }
