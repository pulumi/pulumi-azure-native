...
namespace Pulumi.AzureNative.Network.V20191101.Inputs
{
    ...
    public sealed class NetworkRuleConditionArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("ipProtocols")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20191101.FirewallPolicyRuleConditionNetworkProtocol>>? _ipProtocols;

        /// <summary>
        /// Array of FirewallPolicyRuleConditionNetworkProtocols.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20191101.FirewallPolicyRuleConditionNetworkProtocol>> IpProtocols
        {
            get => _ipProtocols ?? (_ipProtocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20191101.FirewallPolicyRuleConditionNetworkProtocol>>());
