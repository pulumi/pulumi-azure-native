...
namespace Pulumi.AzureNextGen.Network.V20191101
{
    public static class GetVpnConnection
    {
        public static Task<GetVpnConnectionResult> InvokeAsync(GetVpnConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnConnectionResult>("azure-nextgen:network/v20191101:getVpnConnection", args ?? new GetVpnConnectionArgs(), options.WithVersion());
    }
