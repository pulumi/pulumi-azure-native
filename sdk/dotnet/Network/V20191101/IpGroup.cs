...
namespace Pulumi.AzureRM.Network.V20191101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var ipGroup = new AzureRM.Network.V20191101.IpGroup("ipGroup", new AzureRM.Network.V20191101.IpGroupArgs
    ///         {
    ///             IpAddresses = 
    ///             {
    ///                 "13.64.39.16/32",
    ...
    public partial class IpGroup : Pulumi.CustomResource
    {
        ...
        public IpGroup(string name, IpGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:IpGroup", name, args ?? new IpGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:IpGroup", name, null, MakeResourceOptions(options, id))
        {
        }
