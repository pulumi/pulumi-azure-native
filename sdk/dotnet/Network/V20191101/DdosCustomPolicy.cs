...
namespace Pulumi.AzureRM.Network.V20191101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var ddosCustomPolicy = new AzureRM.Network.V20191101.DdosCustomPolicy("ddosCustomPolicy", new AzureRM.Network.V20191101.DdosCustomPolicyArgs
    ///         {
    ///             DdosCustomPolicyName = "test-ddos-custom-policy",
    ///             Location = "centraluseuap",
    ///             ProtocolCustomSettings = 
    ///             {
    ///                 new AzureRM.Network.V20191101.Inputs.ProtocolCustomSettingsFormatArgs
    ///                 {
    ///                     Protocol = "Tcp",
    ///                 },
    ///             },
    ...
    public partial class DdosCustomPolicy : Pulumi.CustomResource
    {
        ...
        public DdosCustomPolicy(string name, DdosCustomPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:DdosCustomPolicy", name, args ?? new DdosCustomPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DdosCustomPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191101:DdosCustomPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
