...
namespace Pulumi.AzureRM.Network.Preview
{
    public static class GetNetworkProfile
    {
        public static Task<GetNetworkProfileResult> InvokeAsync(GetNetworkProfileArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkProfileResult>("azurerm:network/preview:getNetworkProfile", args ?? new GetNetworkProfileArgs(), options.WithVersion());
    }
