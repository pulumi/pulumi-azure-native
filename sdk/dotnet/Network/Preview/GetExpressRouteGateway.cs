...
namespace Pulumi.AzureRM.Network.Preview
{
    public static class GetExpressRouteGateway
    {
        public static Task<GetExpressRouteGatewayResult> InvokeAsync(GetExpressRouteGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExpressRouteGatewayResult>("azurerm:network/preview:getExpressRouteGateway", args ?? new GetExpressRouteGatewayArgs(), options.WithVersion());
    }
