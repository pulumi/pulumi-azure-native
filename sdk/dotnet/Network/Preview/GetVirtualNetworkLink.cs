...
namespace Pulumi.AzureRM.Network.Preview
{
    public static class GetVirtualNetworkLink
    {
        public static Task<GetVirtualNetworkLinkResult> InvokeAsync(GetVirtualNetworkLinkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkLinkResult>("azurerm:network/preview:getVirtualNetworkLink", args ?? new GetVirtualNetworkLinkArgs(), options.WithVersion());
    }
