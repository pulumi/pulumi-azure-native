...
namespace Pulumi.AzureRM.Network.Preview
{
    public static class GetSecurityPartnerProvider
    {
        public static Task<GetSecurityPartnerProviderResult> InvokeAsync(GetSecurityPartnerProviderArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSecurityPartnerProviderResult>("azurerm:network/preview:getSecurityPartnerProvider", args ?? new GetSecurityPartnerProviderArgs(), options.WithVersion());
    }
