...
namespace Pulumi.AzureRM.Network.Preview
{
    ...
    public partial class HubRouteTable : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.SubResourceResponseResult>> AssociatedConnections { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.SubResourceResponseResult>> PropagatingConnections { get; private set; } = null!;
        ...
        public HubRouteTable(string name, HubRouteTableArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/preview:HubRouteTable", name, args ?? new HubRouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubRouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/preview:HubRouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
