...
namespace Pulumi.AzureRM.Network.Preview
{
    ...
    public partial class NetworkExperimentProfile : Pulumi.CustomResource
    {
        ...
        public NetworkExperimentProfile(string name, NetworkExperimentProfileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/preview:NetworkExperimentProfile", name, args ?? new NetworkExperimentProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkExperimentProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/preview:NetworkExperimentProfile", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/v20191101:NetworkExperimentProfile"},
                },
            };
