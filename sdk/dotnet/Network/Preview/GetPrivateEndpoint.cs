...
namespace Pulumi.AzureRM.Network.Preview
{
    public static class GetPrivateEndpoint
    {
        public static Task<GetPrivateEndpointResult> InvokeAsync(GetPrivateEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateEndpointResult>("azurerm:network/preview:getPrivateEndpoint", args ?? new GetPrivateEndpointArgs(), options.WithVersion());
    }
