...
namespace Pulumi.AzureRM.Network.Preview
{
    public static class GetPublicIPAddress
    {
        public static Task<GetPublicIPAddressResult> InvokeAsync(GetPublicIPAddressArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPublicIPAddressResult>("azurerm:network/preview:getPublicIPAddress", args ?? new GetPublicIPAddressArgs(), options.WithVersion());
    }
