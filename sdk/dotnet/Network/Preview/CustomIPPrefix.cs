...
namespace Pulumi.AzureRM.Network.Preview
{
    ...
    public partial class CustomIPPrefix : Pulumi.CustomResource
    {
        ...
        public CustomIPPrefix(string name, CustomIPPrefixArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/preview:CustomIPPrefix", name, args ?? new CustomIPPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomIPPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/preview:CustomIPPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:network/latest:CustomIPPrefix"},
