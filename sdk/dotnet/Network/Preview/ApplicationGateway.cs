...
namespace Pulumi.AzureRM.Network.Preview
{
    ...
    public partial class ApplicationGateway : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.ApplicationGatewayPrivateEndpointConnectionResponseResult>> PrivateEndpointConnections { get; private set; } = null!;

        /// <summary>
        /// PrivateLink configurations on application gateway.
        /// </summary>
        [Output("privateLinkConfigurations")]
        public Output<ImmutableArray<Outputs.ApplicationGatewayPrivateLinkConfigurationResponseResult>> PrivateLinkConfigurations { get; private set; } = null!;
        ...
        /// </summary>
        [Output("sslProfiles")]
        public Output<ImmutableArray<Outputs.ApplicationGatewaySslProfileResponseResult>> SslProfiles { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.ApplicationGatewayTrustedClientCertificateResponseResult>> TrustedClientCertificates { get; private set; } = null!;
        ...
        public ApplicationGateway(string name, ApplicationGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/preview:ApplicationGateway", name, args ?? new ApplicationGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/preview:ApplicationGateway", name, null, MakeResourceOptions(options, id))
        {
        }
