...
namespace Pulumi.AzureRM.Network.Preview
{
    public static class GetHubRouteTable
    {
        public static Task<GetHubRouteTableResult> InvokeAsync(GetHubRouteTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHubRouteTableResult>("azurerm:network/preview:getHubRouteTable", args ?? new GetHubRouteTableArgs(), options.WithVersion());
    }
