...
namespace Pulumi.AzureRM.Network.Preview
{
    public static class GetDscpConfiguration
    {
        public static Task<GetDscpConfigurationResult> InvokeAsync(GetDscpConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDscpConfigurationResult>("azurerm:network/preview:getDscpConfiguration", args ?? new GetDscpConfigurationArgs(), options.WithVersion());
    }
