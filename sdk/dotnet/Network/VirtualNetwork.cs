...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class VirtualNetwork : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VirtualNetworkPropertiesFormatResponse> Properties { get; private set; } = null!;
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, VirtualNetworkState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:VirtualNetwork", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VirtualNetworkPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
