...
namespace Pulumi.AzureNative.Network.V20230501.Inputs
{
    ...
    public sealed class ApplicationGatewayBackendHttpSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230501.ApplicationGatewayCookieBasedAffinity>? CookieBasedAffinity { get; set; }
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230501.ApplicationGatewayProtocol>? Protocol { get; set; }
