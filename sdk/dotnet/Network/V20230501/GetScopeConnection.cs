...
namespace Pulumi.AzureNative.Network.V20230501
{
    public static class GetScopeConnection
    {
        ...
        public static Task<GetScopeConnectionResult> InvokeAsync(GetScopeConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScopeConnectionResult>("azure-native:network/v20230501:getScopeConnection", args ?? new GetScopeConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// Get specified scope connection created by this Network Manager.
        /// </summary>
        public static Output<GetScopeConnectionResult> Invoke(GetScopeConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScopeConnectionResult>("azure-native:network/v20230501:getScopeConnection", args ?? new GetScopeConnectionInvokeArgs(), options.WithDefaults());
