...
namespace Pulumi.AzureNative.Network.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230501:ConnectivityConfiguration")]
    public partial class ConnectivityConfiguration : global::Pulumi.CustomResource
    {
        ...
        public ConnectivityConfiguration(string name, ConnectivityConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:ConnectivityConfiguration", name, args ?? new ConnectivityConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectivityConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:ConnectivityConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230601:ConnectivityConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230901:ConnectivityConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20231101:ConnectivityConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240101:ConnectivityConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240301:ConnectivityConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240501:ConnectivityConfiguration" },
    ...
    public sealed class ConnectivityConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230501.ConnectivityTopology> ConnectivityTopology { get; set; } = null!;

        /// <summary>
        /// Flag if need to remove current existing peerings.
        /// </summary>
        [Input("deleteExistingPeering")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230501.DeleteExistingPeering>? DeleteExistingPeering { get; set; }
        ...
        /// </summary>
        [Input("isGlobal")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230501.IsGlobal>? IsGlobal { get; set; }
