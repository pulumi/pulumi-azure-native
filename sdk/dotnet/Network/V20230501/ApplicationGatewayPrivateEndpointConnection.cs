...
namespace Pulumi.AzureNative.Network.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230501:ApplicationGatewayPrivateEndpointConnection")]
    public partial class ApplicationGatewayPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGatewayPrivateEndpointConnection(string name, ApplicationGatewayPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:ApplicationGatewayPrivateEndpointConnection", name, args ?? new ApplicationGatewayPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGatewayPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:ApplicationGatewayPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
