...
namespace Pulumi.AzureNative.Network.V20230501
{
    ...
    /// StaticMember Item.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230501:StaticMember")]
    public partial class StaticMember : global::Pulumi.CustomResource
    {
        ...
        public StaticMember(string name, StaticMemberArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:StaticMember", name, args ?? new StaticMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:StaticMember", name, null, MakeResourceOptions(options, id))
        {
        }
