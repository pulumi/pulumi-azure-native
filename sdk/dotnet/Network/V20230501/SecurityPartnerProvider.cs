...
namespace Pulumi.AzureNative.Network.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230501:SecurityPartnerProvider")]
    public partial class SecurityPartnerProvider : global::Pulumi.CustomResource
    {
        ...
        public SecurityPartnerProvider(string name, SecurityPartnerProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:SecurityPartnerProvider", name, args ?? new SecurityPartnerProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityPartnerProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:SecurityPartnerProvider", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityPartnerProviderArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230501.SecurityProviderName>? SecurityProviderName { get; set; }
