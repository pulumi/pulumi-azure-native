...
namespace Pulumi.AzureNative.Network.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230501:ConnectionMonitor")]
    public partial class ConnectionMonitor : global::Pulumi.CustomResource
    {
        ...
        public ConnectionMonitor(string name, ConnectionMonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:ConnectionMonitor", name, args ?? new ConnectionMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:ConnectionMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
