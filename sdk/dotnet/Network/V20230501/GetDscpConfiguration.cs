...
namespace Pulumi.AzureNative.Network.V20230501
{
    public static class GetDscpConfiguration
    {
        ...
        public static Task<GetDscpConfigurationResult> InvokeAsync(GetDscpConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDscpConfigurationResult>("azure-native:network/v20230501:getDscpConfiguration", args ?? new GetDscpConfigurationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a DSCP Configuration.
        /// </summary>
        public static Output<GetDscpConfigurationResult> Invoke(GetDscpConfigurationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDscpConfigurationResult>("azure-native:network/v20230501:getDscpConfiguration", args ?? new GetDscpConfigurationInvokeArgs(), options.WithDefaults());
