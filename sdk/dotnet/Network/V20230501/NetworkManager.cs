...
namespace Pulumi.AzureNative.Network.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230501:NetworkManager")]
    public partial class NetworkManager : global::Pulumi.CustomResource
    {
        ...
        public NetworkManager(string name, NetworkManagerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:NetworkManager", name, args ?? new NetworkManagerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkManager(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:NetworkManager", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkManagerArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.V20230501.ConfigurationType>>? _networkManagerScopeAccesses;

        /// <summary>
        /// Scope Access.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20230501.ConfigurationType>> NetworkManagerScopeAccesses
        {
            get => _networkManagerScopeAccesses ?? (_networkManagerScopeAccesses = new InputList<Union<string, Pulumi.AzureNative.Network.V20230501.ConfigurationType>>());
