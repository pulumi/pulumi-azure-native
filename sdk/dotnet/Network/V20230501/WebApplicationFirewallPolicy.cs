...
namespace Pulumi.AzureNative.Network.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230501:WebApplicationFirewallPolicy")]
    public partial class WebApplicationFirewallPolicy : global::Pulumi.CustomResource
    {
        ...
        public WebApplicationFirewallPolicy(string name, WebApplicationFirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:WebApplicationFirewallPolicy", name, args ?? new WebApplicationFirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApplicationFirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:WebApplicationFirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
