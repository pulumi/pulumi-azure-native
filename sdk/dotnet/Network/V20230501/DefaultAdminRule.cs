...
namespace Pulumi.AzureNative.Network.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230501:DefaultAdminRule")]
    public partial class DefaultAdminRule : global::Pulumi.CustomResource
    {
        ...
        public DefaultAdminRule(string name, DefaultAdminRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:DefaultAdminRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private DefaultAdminRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:DefaultAdminRule", name, null, MakeResourceOptions(options, id))
        {
        }
