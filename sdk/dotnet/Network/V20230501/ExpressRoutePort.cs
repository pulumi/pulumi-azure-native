...
namespace Pulumi.AzureNative.Network.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230501:ExpressRoutePort")]
    public partial class ExpressRoutePort : global::Pulumi.CustomResource
    {
        ...
        public ExpressRoutePort(string name, ExpressRoutePortArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:ExpressRoutePort", name, args ?? new ExpressRoutePortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRoutePort(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:ExpressRoutePort", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRoutePortArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("billingType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230501.ExpressRoutePortsBillingType>? BillingType { get; set; }

        /// <summary>
        /// Encapsulation method on physical ports.
        /// </summary>
        [Input("encapsulation")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230501.ExpressRoutePortsEncapsulation>? Encapsulation { get; set; }
