...
namespace Pulumi.AzureNative.Network.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230501:LoadBalancerBackendAddressPool")]
    public partial class LoadBalancerBackendAddressPool : global::Pulumi.CustomResource
    {
        ...
        public LoadBalancerBackendAddressPool(string name, LoadBalancerBackendAddressPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:LoadBalancerBackendAddressPool", name, args ?? new LoadBalancerBackendAddressPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancerBackendAddressPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:LoadBalancerBackendAddressPool", name, null, MakeResourceOptions(options, id))
        {
        }
