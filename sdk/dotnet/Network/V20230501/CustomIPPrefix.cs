...
namespace Pulumi.AzureNative.Network.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230501:CustomIPPrefix")]
    public partial class CustomIPPrefix : global::Pulumi.CustomResource
    {
        ...
        public CustomIPPrefix(string name, CustomIPPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:CustomIPPrefix", name, args ?? new CustomIPPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomIPPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:CustomIPPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CustomIPPrefixArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230501.CommissionedState>? CommissionedState { get; set; }
        ...
        /// </summary>
        [Input("geo")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230501.Geo>? Geo { get; set; }
        ...
        /// </summary>
        [Input("prefixType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230501.CustomIpPrefixType>? PrefixType { get; set; }
