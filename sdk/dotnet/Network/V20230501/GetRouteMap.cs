...
namespace Pulumi.AzureNative.Network.V20230501
{
    public static class GetRouteMap
    {
        ...
        public static Task<GetRouteMapResult> InvokeAsync(GetRouteMapArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRouteMapResult>("azure-native:network/v20230501:getRouteMap", args ?? new GetRouteMapArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the details of a RouteMap.
        /// </summary>
        public static Output<GetRouteMapResult> Invoke(GetRouteMapInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRouteMapResult>("azure-native:network/v20230501:getRouteMap", args ?? new GetRouteMapInvokeArgs(), options.WithDefaults());
