...
namespace Pulumi.AzureNative.Network.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230501:NetworkGroup")]
    public partial class NetworkGroup : global::Pulumi.CustomResource
    {
        ...
        public NetworkGroup(string name, NetworkGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:NetworkGroup", name, args ?? new NetworkGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230501:NetworkGroup", name, null, MakeResourceOptions(options, id))
        {
        }
