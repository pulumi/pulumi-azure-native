...
namespace Pulumi.AzureNative.Network.V20160601
{
    ...
    [AzureNativeResourceType("azure-native:network/v20160601:RouteTable")]
    public partial class RouteTable : Pulumi.CustomResource
    {
        ...
        public RouteTable(string name, RouteTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20160601:RouteTable", name, args ?? new RouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20160601:RouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
