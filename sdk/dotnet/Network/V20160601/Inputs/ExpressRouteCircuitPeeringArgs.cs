...
namespace Pulumi.AzureNative.Network.V20160601.Inputs
{
    ...
    public sealed class ExpressRouteCircuitPeeringArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("peeringType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20160601.ExpressRouteCircuitPeeringType>? PeeringType { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20160601.ExpressRouteCircuitPeeringState>? State { get; set; }
