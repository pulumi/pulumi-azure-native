...
namespace Pulumi.AzureNextGen.Network.V20160601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20160601:SecurityRule")]
    public partial class SecurityRule : Pulumi.CustomResource
    {
        ...
        public SecurityRule(string name, SecurityRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20160601:SecurityRule", name, args ?? new SecurityRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20160601:SecurityRule", name, null, MakeResourceOptions(options, id))
        {
        }
