...
namespace Pulumi.AzureNative.Network.V20160601
{
    ...
    [AzureNativeResourceType("azure-native:network/v20160601:VirtualNetworkPeering")]
    public partial class VirtualNetworkPeering : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkPeering(string name, VirtualNetworkPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20160601:VirtualNetworkPeering", name, args ?? new VirtualNetworkPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20160601:VirtualNetworkPeering", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkPeeringArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("peeringState")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20160601.VirtualNetworkPeeringState>? PeeringState { get; set; }
