...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    ...
    public partial class NspAssociationsProxy : Pulumi.CustomResource
    {
        ...
        public NspAssociationsProxy(string name, NspAssociationsProxyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:NspAssociationsProxy", name, args ?? new NspAssociationsProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NspAssociationsProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:NspAssociationsProxy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NspAssociationsProxy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
