...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    ...
    /// {
    ///     var defaultUserRule = new AzureNative.Network.V20210201Preview.DefaultUserRule("defaultUserRule", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20210201preview:DefaultUserRule SampleUserRule /subscriptions/subId/resourceGroups/rg1/providers/Microsoft.Network/networkManagers/testNetworkManager/SecurityUserConfigurations/Policy1/ruleCollections/testRuleCollection/rules/SampleUserRule 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201preview:DefaultUserRule")]
    public partial class DefaultUserRule : global::Pulumi.CustomResource
    {
        ...
        public DefaultUserRule(string name, DefaultUserRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:DefaultUserRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private DefaultUserRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:DefaultUserRule", name, null, MakeResourceOptions(options, id))
        {
        }

        private static DefaultUserRuleArgs MakeArgs(DefaultUserRuleArgs args)
        {
            args ??= new DefaultUserRuleArgs();
            args.Kind = "Default";
            return args;
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DefaultUserRule Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
