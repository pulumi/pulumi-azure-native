...
namespace Pulumi.AzureNative.Network.V20210201Preview.Inputs
{
    ...
    public sealed class ConnectivityGroupItemArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201Preview.GroupConnectivity>? GroupConnectivity { get; set; }
        ...
        /// </summary>
        [Input("useHubGateway")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201Preview.UseHubGateway>? UseHubGateway { get; set; }
