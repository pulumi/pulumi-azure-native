...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    public static class GetDefaultUserRule
    {
        ...
        public static Task<GetDefaultUserRuleResult> InvokeAsync(GetDefaultUserRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDefaultUserRuleResult>("azure-native:network/v20210201preview:getDefaultUserRule", args ?? new GetDefaultUserRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a user rule.
        /// </summary>
        public static Output<GetDefaultUserRuleResult> Invoke(GetDefaultUserRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDefaultUserRuleResult>("azure-native:network/v20210201preview:getDefaultUserRule", args ?? new GetDefaultUserRuleInvokeArgs(), options.WithDefaults());
