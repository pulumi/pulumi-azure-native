...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    public static class GetDefaultAdminRule
    {
        ...
        public static Output<GetDefaultAdminRuleResult> Invoke(GetDefaultAdminRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDefaultAdminRuleResult>("azure-native:network/v20210201preview:getDefaultAdminRule", args ?? new GetDefaultAdminRuleInvokeArgs(), options.WithVersion());
    }
