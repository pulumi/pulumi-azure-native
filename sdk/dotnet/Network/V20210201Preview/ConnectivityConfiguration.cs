...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    ...
    /// {
    ///     var connectivityConfiguration = new AzureNative.Network.V20210201Preview.ConnectivityConfiguration("connectivityConfiguration", new()
    ///     {
    ///         AppliesToGroups = new[]
    ///         {
    ///             new AzureNative.Network.V20210201Preview.Inputs.ConnectivityGroupItemArgs
    ///             {
    ...
    ///         Hubs = new[]
    ///         {
    ///             new AzureNative.Network.V20210201Preview.Inputs.HubArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201preview:ConnectivityConfiguration")]
    public partial class ConnectivityConfiguration : global::Pulumi.CustomResource
    {
        ...
        public ConnectivityConfiguration(string name, ConnectivityConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:ConnectivityConfiguration", name, args ?? new ConnectivityConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectivityConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:ConnectivityConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectivityConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201Preview.ConnectivityTopology> ConnectivityTopology { get; set; } = null!;
