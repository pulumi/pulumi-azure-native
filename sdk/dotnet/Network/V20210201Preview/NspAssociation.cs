...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    ...
    public partial class NspAssociation : Pulumi.CustomResource
    {
        ...
        public NspAssociation(string name, NspAssociationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:NspAssociation", name, args ?? new NspAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NspAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:NspAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:network:NspAssociation"},
                },
            };
    ...
    public sealed class NspAssociationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessMode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201Preview.AssociationAccessMode>? AccessMode { get; set; }
