...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    ...
    /// {
    ///     var nspLink = new AzureNative.Network.V20210201Preview.NspLink("nspLink", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201preview:NspLink")]
    public partial class NspLink : global::Pulumi.CustomResource
    {
        ...
        public NspLink(string name, NspLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:NspLink", name, args ?? new NspLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NspLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:NspLink", name, null, MakeResourceOptions(options, id))
        {
        }
