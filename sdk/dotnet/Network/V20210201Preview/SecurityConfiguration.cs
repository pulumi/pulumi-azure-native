...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201preview:SecurityConfiguration")]
    public partial class SecurityConfiguration : Pulumi.CustomResource
    {
        ...
        public Output<bool?> DeleteExistingNSGs { get; private set; } = null!;
        ...
        public SecurityConfiguration(string name, SecurityConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:SecurityConfiguration", name, args ?? new SecurityConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:SecurityConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201preview:SecurityConfiguration"},
                    new Pulumi.Alias { Type = "azure-native:network:SecurityConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:network:SecurityConfiguration"},
                },
            };
    ...
    public sealed class SecurityConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<bool>? DeleteExistingNSGs { get; set; }
