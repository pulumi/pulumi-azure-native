...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    public static class GetNspAssociationsProxy
    {
        ...
        public static Task<GetNspAssociationsProxyResult> InvokeAsync(GetNspAssociationsProxyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNspAssociationsProxyResult>("azure-native:network/v20210201preview:getNspAssociationsProxy", args ?? new GetNspAssociationsProxyArgs(), options.WithDefaults());
        ...
        public static Output<GetNspAssociationsProxyResult> Invoke(GetNspAssociationsProxyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNspAssociationsProxyResult>("azure-native:network/v20210201preview:getNspAssociationsProxy", args ?? new GetNspAssociationsProxyInvokeArgs(), options.WithDefaults());
    }
