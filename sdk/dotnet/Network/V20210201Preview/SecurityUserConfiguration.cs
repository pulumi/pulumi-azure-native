...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    ...
    public partial class SecurityUserConfiguration : global::Pulumi.CustomResource
    {
        ...
        public SecurityUserConfiguration(string name, SecurityUserConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:SecurityUserConfiguration", name, args ?? new SecurityUserConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityUserConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:SecurityUserConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
