...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    ...
    /// {
    ///     var adminRule = new AzureNative.Network.V20210201Preview.AdminRule("adminRule", new()
    ///     {
    ...
    ///         Destinations = new[]
    ///         {
    ///             new AzureNative.Network.V20210201Preview.Inputs.AddressPrefixItemArgs
    ///             {
    ///                 AddressPrefix = "*",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20210201preview:AdminRule SampleAdminRule /subscriptions/subId/resourceGroups/rg1/providers/Microsoft.Network/networkManagers/testNetworkManager/securityAdminConfigurations/myTestSecurityConfig/ruleCollections/testRuleCollection/rules/SampleAdminRule 
    /// ```
    /// </summary>
    ...
    public partial class AdminRule : global::Pulumi.CustomResource
    {
        ...
        public AdminRule(string name, AdminRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:AdminRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AdminRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:AdminRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AdminRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201Preview.SecurityConfigurationRuleAccess> Access { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201Preview.SecurityConfigurationRuleDirection> Direction { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201Preview.SecurityConfigurationRuleProtocol> Protocol { get; set; } = null!;
