...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    ...
    /// {
    ///     var userRule = new AzureNative.Network.V20210201Preview.UserRule("userRule", new()
    ///     {
    ...
    public partial class UserRule : global::Pulumi.CustomResource
    {
        ...
        public UserRule(string name, UserRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:UserRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private UserRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:UserRule", name, null, MakeResourceOptions(options, id))
        {
        }
