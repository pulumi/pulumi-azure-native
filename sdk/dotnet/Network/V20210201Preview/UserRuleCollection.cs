...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    ...
    /// {
    ///     var userRuleCollection = new AzureNative.Network.V20210201Preview.UserRuleCollection("userRuleCollection", new()
    ///     {
    ///         AppliesToGroups = new[]
    ///         {
    ///             new AzureNative.Network.V20210201Preview.Inputs.NetworkManagerSecurityGroupItemArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201preview:UserRuleCollection")]
    public partial class UserRuleCollection : global::Pulumi.CustomResource
    {
        ...
        public UserRuleCollection(string name, UserRuleCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:UserRuleCollection", name, args ?? new UserRuleCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserRuleCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201preview:UserRuleCollection", name, null, MakeResourceOptions(options, id))
        {
        }
