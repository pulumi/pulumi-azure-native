...
namespace Pulumi.AzureNative.Network.V20210201Preview
{
    public static class GetSecurityConfiguration
    {
        ...
        public static Task<GetSecurityConfigurationResult> InvokeAsync(GetSecurityConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSecurityConfigurationResult>("azure-native:network/v20210201preview:getSecurityConfiguration", args ?? new GetSecurityConfigurationArgs(), options.WithVersion());
    }
