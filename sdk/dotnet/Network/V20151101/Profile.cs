...
namespace Pulumi.AzureNextGen.Network.V20151101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20151101:Profile")]
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20151101:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20151101:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
