...
namespace Pulumi.AzureNative.Network.V20190901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190901:ExpressRouteCircuitConnection")]
    public partial class ExpressRouteCircuitConnection : global::Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitConnection(string name, ExpressRouteCircuitConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:ExpressRouteCircuitConnection", name, args ?? new ExpressRouteCircuitConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:ExpressRouteCircuitConnection", name, null, MakeResourceOptions(options, id))
        {
        }
