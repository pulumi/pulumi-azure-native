...
namespace Pulumi.AzureRM.Network.V20190901
{
    public static class GetExpressRoutePort
    {
        public static Task<GetExpressRoutePortResult> InvokeAsync(GetExpressRoutePortArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExpressRoutePortResult>("azurerm:network/v20190901:getExpressRoutePort", args ?? new GetExpressRoutePortArgs(), options.WithVersion());
    }
