...
namespace Pulumi.AzureRM.Network.V20190901
{
    ...
    ///                 
    ///                 {
    ///                     { "action", new AzureRM.Network.V20190901.Inputs.FirewallPolicyFilterRuleActionArgs
    ///                     {
    ///                         Type = "Deny",
    ///                     } },
    ...
    public partial class FirewallPolicyRuleGroup : Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleGroup(string name, FirewallPolicyRuleGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:FirewallPolicyRuleGroup", name, args ?? new FirewallPolicyRuleGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:FirewallPolicyRuleGroup", name, null, MakeResourceOptions(options, id))
        {
        }
