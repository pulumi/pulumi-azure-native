...
namespace Pulumi.AzureRM.Network.V20190901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var route = new AzureRM.Network.V20190901.Route("route", new AzureRM.Network.V20190901.RouteArgs
    ///         {
    ...
    public partial class Route : Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:Route", name, null, MakeResourceOptions(options, id))
        {
        }
