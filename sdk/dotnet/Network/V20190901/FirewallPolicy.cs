...
namespace Pulumi.AzureRM.Network.V20190901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var firewallPolicy = new AzureRM.Network.V20190901.FirewallPolicy("firewallPolicy", new AzureRM.Network.V20190901.FirewallPolicyArgs
    ///         {
    ...
    public partial class FirewallPolicy : Pulumi.CustomResource
    {
        ...
        public FirewallPolicy(string name, FirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:FirewallPolicy", name, args ?? new FirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:FirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
