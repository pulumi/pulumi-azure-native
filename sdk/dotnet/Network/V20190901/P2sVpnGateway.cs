...
namespace Pulumi.AzureNextGen.Network.V20190901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190901:P2sVpnGateway")]
    public partial class P2sVpnGateway : Pulumi.CustomResource
    {
        ...
        public P2sVpnGateway(string name, P2sVpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190901:P2sVpnGateway", name, args ?? new P2sVpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private P2sVpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190901:P2sVpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
