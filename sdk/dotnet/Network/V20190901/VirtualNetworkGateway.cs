...
namespace Pulumi.AzureNative.Network.V20190901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190901:VirtualNetworkGateway")]
    public partial class VirtualNetworkGateway : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGateway(string name, VirtualNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:VirtualNetworkGateway", name, args ?? new VirtualNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:VirtualNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:network/v20210201:VirtualNetworkGateway"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:VirtualNetworkGateway"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:VirtualNetworkGateway"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:VirtualNetworkGateway"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:VirtualNetworkGateway"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:VirtualNetworkGateway"},
                },
            };
    ...
    public sealed class VirtualNetworkGatewayArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("gatewayType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190901.VirtualNetworkGatewayType>? GatewayType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190901.VpnGatewayGeneration>? VpnGatewayGeneration { get; set; }

        /// <summary>
        /// The type of this virtual network gateway.
        /// </summary>
        [Input("vpnType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190901.VpnType>? VpnType { get; set; }
