...
namespace Pulumi.AzureRM.Network.V20190901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnSite = new AzureRM.Network.V20190901.VpnSite("vpnSite", new AzureRM.Network.V20190901.VpnSiteArgs
    ///         {
    ///             AddressSpace = new AzureRM.Network.V20190901.Inputs.AddressSpaceArgs
    ///             {
    ///                 AddressPrefixes = 
    ///                 {
    ///                     "10.0.0.0/16",
    ...
    ///             VpnSiteLinks = 
    ///             {
    ///                 new AzureRM.Network.V20190901.Inputs.VpnSiteLinkArgs
    ///                 {
    ///                     Name = "vpnSiteLink1",
    ///                 },
    ///             },
    ...
    public partial class VpnSite : Pulumi.CustomResource
    {
        ...
        public VpnSite(string name, VpnSiteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:VpnSite", name, args ?? new VpnSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:VpnSite", name, null, MakeResourceOptions(options, id))
        {
        }
