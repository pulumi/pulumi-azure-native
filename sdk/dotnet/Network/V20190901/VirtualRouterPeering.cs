...
namespace Pulumi.AzureNative.Network.V20190901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190901:VirtualRouterPeering")]
    public partial class VirtualRouterPeering : global::Pulumi.CustomResource
    {
        ...
        public VirtualRouterPeering(string name, VirtualRouterPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:VirtualRouterPeering", name, args ?? new VirtualRouterPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouterPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:VirtualRouterPeering", name, null, MakeResourceOptions(options, id))
        {
        }
