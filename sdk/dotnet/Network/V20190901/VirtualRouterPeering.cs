...
namespace Pulumi.AzureRM.Network.V20190901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualRouterPeering = new AzureRM.Network.V20190901.VirtualRouterPeering("virtualRouterPeering", new AzureRM.Network.V20190901.VirtualRouterPeeringArgs
    ///         {
    ///             PeerAsn = 20000,
    ///             PeerIp = "192.168.1.5",
    ...
    public partial class VirtualRouterPeering : Pulumi.CustomResource
    {
        ...
        public VirtualRouterPeering(string name, VirtualRouterPeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:VirtualRouterPeering", name, args ?? new VirtualRouterPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouterPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:VirtualRouterPeering", name, null, MakeResourceOptions(options, id))
        {
        }
