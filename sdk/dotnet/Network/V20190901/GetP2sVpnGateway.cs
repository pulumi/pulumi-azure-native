...
namespace Pulumi.AzureNextGen.Network.V20190901
{
    public static class GetP2sVpnGateway
    {
        public static Task<GetP2sVpnGatewayResult> InvokeAsync(GetP2sVpnGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetP2sVpnGatewayResult>("azure-nextgen:network/v20190901:getP2sVpnGateway", args ?? new GetP2sVpnGatewayArgs(), options.WithVersion());
    }
