...
namespace Pulumi.AzureNextGen.Network.V20190901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190901:AzureFirewall")]
    public partial class AzureFirewall : Pulumi.CustomResource
    {
        ...
        public AzureFirewall(string name, AzureFirewallArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190901:AzureFirewall", name, args ?? new AzureFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureFirewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190901:AzureFirewall", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AzureFirewallArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190901.AzureFirewallThreatIntelMode>? ThreatIntelMode { get; set; }
