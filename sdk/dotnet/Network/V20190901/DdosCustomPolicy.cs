...
namespace Pulumi.AzureRM.Network.V20190901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var ddosCustomPolicy = new AzureRM.Network.V20190901.DdosCustomPolicy("ddosCustomPolicy", new AzureRM.Network.V20190901.DdosCustomPolicyArgs
    ///         {
    ///             DdosCustomPolicyName = "test-ddos-custom-policy",
    ///             Location = "centraluseuap",
    ///             ProtocolCustomSettings = 
    ///             {
    ///                 new AzureRM.Network.V20190901.Inputs.ProtocolCustomSettingsFormatArgs
    ///                 {
    ///                     Protocol = "Tcp",
    ///                 },
    ///             },
    ...
    public partial class DdosCustomPolicy : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.ProtocolCustomSettingsFormatResponseResult>> ProtocolCustomSettings { get; private set; } = null!;
        ...
        public DdosCustomPolicy(string name, DdosCustomPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:DdosCustomPolicy", name, args ?? new DdosCustomPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DdosCustomPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:DdosCustomPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/v20181201:DdosCustomPolicy"},
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/v20190601:DdosCustomPolicy"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190701:DdosCustomPolicy"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190801:DdosCustomPolicy"},
                    new Pulumi.Alias { Type = "azurerm:network/v20191101:DdosCustomPolicy"},
                    new Pulumi.Alias { Type = "azurerm:network/v20191201:DdosCustomPolicy"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200301:DdosCustomPolicy"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200401:DdosCustomPolicy"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200501:DdosCustomPolicy"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200601:DdosCustomPolicy"},
                },
            };
