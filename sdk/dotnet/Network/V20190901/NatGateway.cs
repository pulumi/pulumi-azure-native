...
namespace Pulumi.AzureNative.Network.V20190901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20190901:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NatGateway to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20190901:NatGateway")]
    public partial class NatGateway : global::Pulumi.CustomResource
    {
        ...
        public NatGateway(string name, NatGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:NatGateway", name, args ?? new NatGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:NatGateway", name, null, MakeResourceOptions(options, id))
        {
        }
