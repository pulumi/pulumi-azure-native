...
namespace Pulumi.AzureRM.Network.V20190901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var natGateway = new AzureRM.Network.V20190901.NatGateway("natGateway", new AzureRM.Network.V20190901.NatGatewayArgs
    ///         {
    ///             Location = "westus",
    ///             NatGatewayName = "test-natgateway",
    ///             PublicIpAddresses = 
    ///             {
    ///                 new AzureRM.Network.V20190901.Inputs.SubResourceArgs
    ///                 {
    ...
    ///             Sku = new AzureRM.Network.V20190901.Inputs.NatGatewaySkuArgs
    ///             {
    ///                 Name = "Standard",
    ///             },
    ///         });
