...
namespace Pulumi.AzureNextGen.Network.V20190901
{
    public static class GetVirtualRouter
    {
        public static Task<GetVirtualRouterResult> InvokeAsync(GetVirtualRouterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualRouterResult>("azure-nextgen:network/v20190901:getVirtualRouter", args ?? new GetVirtualRouterArgs(), options.WithVersion());
    }
