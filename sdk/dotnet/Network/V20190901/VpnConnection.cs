...
namespace Pulumi.AzureNative.Network.V20190901
{
    ...
    [AzureNativeResourceType("azure-native:network/v20190901:VpnConnection")]
    public partial class VpnConnection : global::Pulumi.CustomResource
    {
        ...
        public VpnConnection(string name, VpnConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:VpnConnection", name, args ?? new VpnConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:VpnConnection", name, null, MakeResourceOptions(options, id))
        {
        }
