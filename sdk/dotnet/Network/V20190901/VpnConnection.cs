...
namespace Pulumi.AzureRM.Network.V20190901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnConnection = new AzureRM.Network.V20190901.VpnConnection("vpnConnection", new AzureRM.Network.V20190901.VpnConnectionArgs
    ///         {
    ///             ConnectionName = "vpnConnection1",
    ///             GatewayName = "gateway1",
    ///             RemoteVpnSite = new AzureRM.Network.V20190901.Inputs.SubResourceArgs
    ///             {
    ...
    ///             VpnLinkConnections = 
    ///             {
    ///                 new AzureRM.Network.V20190901.Inputs.VpnSiteLinkConnectionArgs
    ///                 {
    ...
    public partial class VpnConnection : Pulumi.CustomResource
    {
        ...
        public VpnConnection(string name, VpnConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:VpnConnection", name, args ?? new VpnConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:VpnConnection", name, null, MakeResourceOptions(options, id))
        {
        }
