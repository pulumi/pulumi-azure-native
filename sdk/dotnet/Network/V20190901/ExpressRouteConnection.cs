...
namespace Pulumi.AzureRM.Network.V20190901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var expressRouteConnection = new AzureRM.Network.V20190901.ExpressRouteConnection("expressRouteConnection", new AzureRM.Network.V20190901.ExpressRouteConnectionArgs
    ///         {
    ///             AuthorizationKey = "authorizationKey",
    ///             ConnectionName = "connectionName",
    ///             ExpressRouteCircuitPeering = new AzureRM.Network.V20190901.Inputs.ExpressRouteCircuitPeeringIdArgs
    ///             {
    ...
    public partial class ExpressRouteConnection : Pulumi.CustomResource
    {
        ...
        public ExpressRouteConnection(string name, ExpressRouteConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:ExpressRouteConnection", name, args ?? new ExpressRouteConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:ExpressRouteConnection", name, null, MakeResourceOptions(options, id))
        {
        }
