...
namespace Pulumi.AzureNative.Network.V20190901
{
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20200801:VpnServerConfiguration"},
                    new Pulumi.Alias { Type = "azure-native:network/v20201101:VpnServerConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20201101:VpnServerConfiguration"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210201:VpnServerConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:VpnServerConfiguration"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:VpnServerConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:VpnServerConfiguration"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:VpnServerConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:VpnServerConfiguration"},
                },
            };
    ...
    public sealed class VpnServerConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.V20190901.VpnAuthenticationType>>? _vpnAuthenticationTypes;

        /// <summary>
        /// VPN authentication types for the VpnServerConfiguration.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20190901.VpnAuthenticationType>> VpnAuthenticationTypes
        {
            get => _vpnAuthenticationTypes ?? (_vpnAuthenticationTypes = new InputList<Union<string, Pulumi.AzureNative.Network.V20190901.VpnAuthenticationType>>());
        ...
        [Input("vpnProtocols")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20190901.VpnGatewayTunnelingProtocol>>? _vpnProtocols;

        /// <summary>
        /// VPN protocols for the VpnServerConfiguration.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20190901.VpnGatewayTunnelingProtocol>> VpnProtocols
        {
            get => _vpnProtocols ?? (_vpnProtocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20190901.VpnGatewayTunnelingProtocol>>());
