...
namespace Pulumi.AzureNextGen.Network.V20190901
{
    public static class GetPacketCapture
    {
        public static Task<GetPacketCaptureResult> InvokeAsync(GetPacketCaptureArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPacketCaptureResult>("azure-nextgen:network/v20190901:getPacketCapture", args ?? new GetPacketCaptureArgs(), options.WithVersion());
    }
