...
namespace Pulumi.AzureNative.Network.V20190901.Inputs
{
    ...
    public sealed class ExpressRouteCircuitSkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("family")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190901.ExpressRouteCircuitSkuFamily>? Family { get; set; }
        ...
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190901.ExpressRouteCircuitSkuTier>? Tier { get; set; }
