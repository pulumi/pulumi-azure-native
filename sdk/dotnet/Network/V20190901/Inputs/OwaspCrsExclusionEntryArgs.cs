...
namespace Pulumi.AzureNative.Network.V20190901.Inputs
{
    ...
    public sealed class OwaspCrsExclusionEntryArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190901.OwaspCrsExclusionEntryMatchVariable> MatchVariable { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190901.OwaspCrsExclusionEntrySelectorMatchOperator> SelectorMatchOperator { get; set; } = null!;
