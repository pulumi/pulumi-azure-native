...
namespace Pulumi.AzureNative.Network.V20190901.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190901.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190901.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
