...
namespace Pulumi.AzureNextGen.Network.V20190901
{
    public static class GetBastionHost
    {
        public static Task<GetBastionHostResult> InvokeAsync(GetBastionHostArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBastionHostResult>("azure-nextgen:network/v20190901:getBastionHost", args ?? new GetBastionHostArgs(), options.WithVersion());
    }
