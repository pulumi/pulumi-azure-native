...
namespace Pulumi.AzureRM.Network.V20190901
{
    public static class GetRouteFilterRule
    {
        public static Task<GetRouteFilterRuleResult> InvokeAsync(GetRouteFilterRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteFilterRuleResult>("azurerm:network/v20190901:getRouteFilterRule", args ?? new GetRouteFilterRuleArgs(), options.WithVersion());
    }
