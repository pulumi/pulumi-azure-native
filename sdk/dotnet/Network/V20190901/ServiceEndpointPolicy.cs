...
namespace Pulumi.AzureNextGen.Network.V20190901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190901:ServiceEndpointPolicy")]
    public partial class ServiceEndpointPolicy : Pulumi.CustomResource
    {
        ...
        public ServiceEndpointPolicy(string name, ServiceEndpointPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190901:ServiceEndpointPolicy", name, args ?? new ServiceEndpointPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceEndpointPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190901:ServiceEndpointPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
