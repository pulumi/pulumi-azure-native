...
namespace Pulumi.AzureNative.Network.V20190901
{
    ...
    /// {
    ///     var connectionMonitor = new AzureNative.Network.V20190901.ConnectionMonitor("connectionMonitor", new()
    ///     {
    ///         ConnectionMonitorName = "cm1",
    ///         Destination = new AzureNative.Network.V20190901.Inputs.ConnectionMonitorDestinationArgs
    ///         {
    ///             Address = "bing.com",
    ///             Port = 80,
    ///         },
    ...
    ///         Source = new AzureNative.Network.V20190901.Inputs.ConnectionMonitorSourceArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190901:ConnectionMonitor")]
    public partial class ConnectionMonitor : global::Pulumi.CustomResource
    {
        ...
        public ConnectionMonitor(string name, ConnectionMonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:ConnectionMonitor", name, args ?? new ConnectionMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:ConnectionMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
