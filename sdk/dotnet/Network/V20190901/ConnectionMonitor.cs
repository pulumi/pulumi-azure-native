...
namespace Pulumi.AzureRM.Network.V20190901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var connectionMonitor = new AzureRM.Network.V20190901.ConnectionMonitor("connectionMonitor", new AzureRM.Network.V20190901.ConnectionMonitorArgs
    ///         {
    ///             ConnectionMonitorName = "cm1",
    ///             Destination = new AzureRM.Network.V20190901.Inputs.ConnectionMonitorDestinationArgs
    ///             {
    ///                 Address = "bing.com",
    ///                 Port = 80,
    ///             },
    ...
    ///             Source = new AzureRM.Network.V20190901.Inputs.ConnectionMonitorSourceArgs
    ///             {
