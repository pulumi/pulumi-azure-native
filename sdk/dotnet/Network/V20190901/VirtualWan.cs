...
namespace Pulumi.AzureNative.Network.V20190901
{
    ...
    [AzureNativeResourceType("azure-native:network/v20190901:VirtualWan")]
    public partial class VirtualWan : global::Pulumi.CustomResource
    {
        ...
        public VirtualWan(string name, VirtualWanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:VirtualWan", name, args ?? new VirtualWanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190901:VirtualWan", name, null, MakeResourceOptions(options, id))
        {
        }
