...
namespace Pulumi.AzureRM.Network.V20190901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var ipGroup = new AzureRM.Network.V20190901.IpGroup("ipGroup", new AzureRM.Network.V20190901.IpGroupArgs
    ///         {
    ///             IpAddresses = 
    ///             {
    ///                 "13.64.39.16/32",
    ...
    public partial class IpGroup : Pulumi.CustomResource
    {
        ...
        public IpGroup(string name, IpGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:IpGroup", name, args ?? new IpGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:IpGroup", name, null, MakeResourceOptions(options, id))
        {
        }
