...
namespace Pulumi.AzureRM.Network.V20190901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualHubRouteTableV2 = new AzureRM.Network.V20190901.VirtualHubRouteTableV2("virtualHubRouteTableV2", new AzureRM.Network.V20190901.VirtualHubRouteTableV2Args
    ///         {
    ///             AttachedConnections = 
    ///             {
    ///                 "All_Vnets",
    ...
    ///             Routes = 
    ///             {
    ///                 new AzureRM.Network.V20190901.Inputs.VirtualHubRouteV2Args
    ///                 {
    ...
    public partial class VirtualHubRouteTableV2 : Pulumi.CustomResource
    {
        ...
        public VirtualHubRouteTableV2(string name, VirtualHubRouteTableV2Args args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:VirtualHubRouteTableV2", name, args ?? new VirtualHubRouteTableV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubRouteTableV2(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190901:VirtualHubRouteTableV2", name, null, MakeResourceOptions(options, id))
        {
        }
