...
namespace Pulumi.AzureNative.Network.V20220701
{
    ...
    public partial class OutboundEndpoint : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public OutboundEndpoint(string name, OutboundEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:OutboundEndpoint", name, args ?? new OutboundEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OutboundEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:OutboundEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OutboundEndpointArgs : Pulumi.ResourceArgs
    {
        /// <summary>
