...
namespace Pulumi.AzureNative.Network.V20220701
{
    ...
    /// {
    ///     var securityRule = new AzureNative.Network.V20220701.SecurityRule("securityRule", new()
    ///     {
    ///         Access = "Deny",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220701:SecurityRule")]
    public partial class SecurityRule : global::Pulumi.CustomResource
    {
        ...
        public SecurityRule(string name, SecurityRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:SecurityRule", name, args ?? new SecurityRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:SecurityRule", name, null, MakeResourceOptions(options, id))
        {
        }
