...
namespace Pulumi.AzureNative.Network.V20220701
{
    ...
    /// {
    ///     var dnsResolver = new AzureNative.Network.V20220701.DnsResolver("dnsResolver", new()
    ///     {
    ...
    ///             { "key1", "value1" },
    ///         },
    ///         VirtualNetwork = new AzureNative.Network.V20220701.Inputs.SubResourceArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220701:DnsResolver")]
    public partial class DnsResolver : global::Pulumi.CustomResource
    {
        ...
        public DnsResolver(string name, DnsResolverArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:DnsResolver", name, args ?? new DnsResolverArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsResolver(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:DnsResolver", name, null, MakeResourceOptions(options, id))
        {
        }
