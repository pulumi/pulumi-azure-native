...
{
    [Obsolete(@"azure-native:network/v20220701:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualHub to guarantee forwards compatibility.")]
    public static class GetVirtualHub
    {
        ...
        public static Task<GetVirtualHubResult> InvokeAsync(GetVirtualHubArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualHubResult>("azure-native:network/v20220701:getVirtualHub", args ?? new GetVirtualHubArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the details of a VirtualHub.
        /// </summary>
        public static Output<GetVirtualHubResult> Invoke(GetVirtualHubInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVirtualHubResult>("azure-native:network/v20220701:getVirtualHub", args ?? new GetVirtualHubInvokeArgs(), options.WithDefaults());
    }
