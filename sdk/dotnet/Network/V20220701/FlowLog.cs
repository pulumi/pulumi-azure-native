...
namespace Pulumi.AzureNative.Network.V20220701
{
    ...
    /// A flow log resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220701:FlowLog")]
    public partial class FlowLog : global::Pulumi.CustomResource
    {
        ...
        public FlowLog(string name, FlowLogArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:FlowLog", name, args ?? new FlowLogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FlowLog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:FlowLog", name, null, MakeResourceOptions(options, id))
        {
        }
