...
namespace Pulumi.AzureNative.Network.V20220701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220701:PrivateResolverVirtualNetworkLink")]
    public partial class PrivateResolverVirtualNetworkLink : global::Pulumi.CustomResource
    {
        ...
        public PrivateResolverVirtualNetworkLink(string name, PrivateResolverVirtualNetworkLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:PrivateResolverVirtualNetworkLink", name, args ?? new PrivateResolverVirtualNetworkLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateResolverVirtualNetworkLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:PrivateResolverVirtualNetworkLink", name, null, MakeResourceOptions(options, id))
        {
        }
