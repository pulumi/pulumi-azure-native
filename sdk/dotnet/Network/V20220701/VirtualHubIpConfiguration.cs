...
namespace Pulumi.AzureNative.Network.V20220701
{
    ...
    /// IpConfigurations.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220701:VirtualHubIpConfiguration")]
    public partial class VirtualHubIpConfiguration : global::Pulumi.CustomResource
    {
        ...
        public VirtualHubIpConfiguration(string name, VirtualHubIpConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:VirtualHubIpConfiguration", name, args ?? new VirtualHubIpConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubIpConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:VirtualHubIpConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
