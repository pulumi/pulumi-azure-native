...
namespace Pulumi.AzureNative.Network.V20220701
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220701:VirtualRouterPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualRouterPeering to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20220701:VirtualRouterPeering")]
    public partial class VirtualRouterPeering : global::Pulumi.CustomResource
    {
        ...
        public VirtualRouterPeering(string name, VirtualRouterPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:VirtualRouterPeering", name, args ?? new VirtualRouterPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouterPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:VirtualRouterPeering", name, null, MakeResourceOptions(options, id))
        {
        }
