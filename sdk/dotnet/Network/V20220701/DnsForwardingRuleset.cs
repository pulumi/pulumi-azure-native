...
namespace Pulumi.AzureNative.Network.V20220701
{
    ...
    public partial class DnsForwardingRuleset : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DnsForwardingRuleset(string name, DnsForwardingRulesetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:DnsForwardingRuleset", name, args ?? new DnsForwardingRulesetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsForwardingRuleset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:DnsForwardingRuleset", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:network:DnsForwardingRuleset"},
                    new Pulumi.Alias { Type = "azure-native:network/v20200401preview:DnsForwardingRuleset"},
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DnsForwardingRuleset Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DnsForwardingRuleset(name, id, options);
        }
    }

    public sealed class DnsForwardingRulesetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public DnsForwardingRulesetArgs()
        {
        }
    }
}
