...
namespace Pulumi.AzureNative.Network.V20220701
{
    public static class GetPrivateResolverVirtualNetworkLink
    {
        ...
        public static Task<GetPrivateResolverVirtualNetworkLinkResult> InvokeAsync(GetPrivateResolverVirtualNetworkLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateResolverVirtualNetworkLinkResult>("azure-native:network/v20220701:getPrivateResolverVirtualNetworkLink", args ?? new GetPrivateResolverVirtualNetworkLinkArgs(), options.WithDefaults());
