...
namespace Pulumi.AzureNative.Network.V20220701.Inputs
{
    ...
    public sealed class ConnectionMonitorTestConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220701.PreferredIPVersion>? PreferredIPVersion { get; set; }

        /// <summary>
        /// The protocol to use in test evaluation.
        /// </summary>
        [Input("protocol", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220701.ConnectionMonitorTestConfigurationProtocol> Protocol { get; set; } = null!;
