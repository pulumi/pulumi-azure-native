...
namespace Pulumi.AzureNative.Network.V20220701
{
    ...
    /// {
    ///     var subnet = new AzureNative.Network.V20220701.Subnet("subnet", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.Network.V20220701.Inputs.ServiceEndpointPropertiesFormatArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220701:Subnet")]
    public partial class Subnet : global::Pulumi.CustomResource
    {
        ...
        public Subnet(string name, SubnetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:Subnet", name, args ?? new SubnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:Subnet", name, null, MakeResourceOptions(options, id))
        {
        }
