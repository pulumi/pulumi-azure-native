...
namespace Pulumi.AzureNative.Network.V20220701
{
    ...
    [AzureNativeResourceType("azure-native:network/v20220701:HubRouteTable")]
    public partial class HubRouteTable : global::Pulumi.CustomResource
    {
        ...
        public HubRouteTable(string name, HubRouteTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:HubRouteTable", name, args ?? new HubRouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubRouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:HubRouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
