...
namespace Pulumi.AzureNative.Network.V20220701
{
    ...
    [AzureNativeResourceType("azure-native:network/v20220701:PrivateEndpoint")]
    public partial class PrivateEndpoint : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpoint(string name, PrivateEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:PrivateEndpoint", name, args ?? new PrivateEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:PrivateEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
