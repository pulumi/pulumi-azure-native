...
namespace Pulumi.AzureNative.Network.V20220701
{
    ...
    /// {
    ///     var inboundEndpoint = new AzureNative.Network.V20220701.InboundEndpoint("inboundEndpoint", new()
    ///     {
    ///         DnsResolverName = "sampleDnsResolver",
    ///         InboundEndpointName = "sampleInboundEndpoint",
    ///         IpConfigurations = new[]
    ///         {
    ///             new AzureNative.Network.V20220701.Inputs.InboundEndpointIPConfigurationArgs
    ///             {
    ...
    public partial class InboundEndpoint : global::Pulumi.CustomResource
    {
        ...
        public InboundEndpoint(string name, InboundEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:InboundEndpoint", name, args ?? new InboundEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InboundEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220701:InboundEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
