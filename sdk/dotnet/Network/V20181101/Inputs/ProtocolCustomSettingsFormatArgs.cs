...
namespace Pulumi.AzureNextGen.Network.V20181101.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20181101.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20181101.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
