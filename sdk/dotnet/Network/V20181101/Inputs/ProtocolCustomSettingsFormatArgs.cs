...
namespace Pulumi.AzureNative.Network.V20181101.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20181101.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20181101.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
