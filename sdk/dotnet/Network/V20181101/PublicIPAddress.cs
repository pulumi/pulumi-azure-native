...
namespace Pulumi.AzureNextGen.Network.V20181101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20181101:PublicIPAddress")]
    public partial class PublicIPAddress : Pulumi.CustomResource
    {
        ...
        public PublicIPAddress(string name, PublicIPAddressArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181101:PublicIPAddress", name, args ?? new PublicIPAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181101:PublicIPAddress", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PublicIPAddressArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20181101.IPVersion>? PublicIPAddressVersion { get; set; }

        /// <summary>
        /// The public IP allocation method. Possible values are: 'Static' and 'Dynamic'.
        /// </summary>
        [Input("publicIPAllocationMethod")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20181101.IPAllocationMethod>? PublicIPAllocationMethod { get; set; }
