...
namespace Pulumi.AzureNative.Network.V20181101
{
    ...
    [AzureNativeResourceType("azure-native:network/v20181101:InboundNatRule")]
    public partial class InboundNatRule : global::Pulumi.CustomResource
    {
        ...
        public InboundNatRule(string name, InboundNatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181101:InboundNatRule", name, args ?? new InboundNatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InboundNatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181101:InboundNatRule", name, null, MakeResourceOptions(options, id))
        {
        }
