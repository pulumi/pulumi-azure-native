...
namespace Pulumi.AzureRM.Network.V20181101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var p2sVpnGateway = new AzureRM.Network.V20181101.P2sVpnGateway("p2sVpnGateway", new AzureRM.Network.V20181101.P2sVpnGatewayArgs
    ///         {
    ///             GatewayName = "p2sVpnGateway1",
    ///             Location = "West US",
    ///             P2SVpnServerConfiguration = new AzureRM.Network.V20181101.Inputs.SubResourceArgs
    ///             {
    ...
    ///             },
    ///             VpnClientAddressPool = new AzureRM.Network.V20181101.Inputs.AddressSpaceArgs
    ///             {
    ///                 AddressPrefixes = 
    ///                 {
    ///                     "101.3.0.0/16",
    ...
    public partial class P2sVpnGateway : Pulumi.CustomResource
    {
        ...
        public P2sVpnGateway(string name, P2sVpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181101:P2sVpnGateway", name, args ?? new P2sVpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private P2sVpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181101:P2sVpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
