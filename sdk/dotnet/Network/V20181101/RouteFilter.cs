...
namespace Pulumi.AzureNextGen.Network.V20181101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20181101:RouteFilter")]
    public partial class RouteFilter : Pulumi.CustomResource
    {
        ...
        public RouteFilter(string name, RouteFilterArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181101:RouteFilter", name, args ?? new RouteFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181101:RouteFilter", name, null, MakeResourceOptions(options, id))
        {
        }
