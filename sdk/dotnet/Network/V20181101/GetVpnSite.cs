...
namespace Pulumi.AzureNative.Network.V20181101
{
    public static class GetVpnSite
    {
        ...
        public static Task<GetVpnSiteResult> InvokeAsync(GetVpnSiteArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnSiteResult>("azure-native:network/v20181101:getVpnSite", args ?? new GetVpnSiteArgs(), options.WithDefaults());

        /// <summary>
        /// VpnSite Resource.
        /// </summary>
        public static Output<GetVpnSiteResult> Invoke(GetVpnSiteInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVpnSiteResult>("azure-native:network/v20181101:getVpnSite", args ?? new GetVpnSiteInvokeArgs(), options.WithDefaults());
    }
