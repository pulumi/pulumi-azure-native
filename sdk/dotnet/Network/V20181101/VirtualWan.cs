...
namespace Pulumi.AzureRM.Network.V20181101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualWan = new AzureRM.Network.V20181101.VirtualWan("virtualWan", new AzureRM.Network.V20181101.VirtualWanArgs
    ///         {
    ...
    public partial class VirtualWan : Pulumi.CustomResource
    {
        ...
        public VirtualWan(string name, VirtualWanArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181101:VirtualWan", name, args ?? new VirtualWanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181101:VirtualWan", name, null, MakeResourceOptions(options, id))
        {
        }
