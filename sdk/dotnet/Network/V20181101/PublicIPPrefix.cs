...
namespace Pulumi.AzureRM.Network.V20181101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var publicIPPrefix = new AzureRM.Network.V20181101.PublicIPPrefix("publicIPPrefix", new AzureRM.Network.V20181101.PublicIPPrefixArgs
    ///         {
    ///             Location = "westus",
    ///             PrefixLength = 30,
    ...
    ///             Sku = new AzureRM.Network.V20181101.Inputs.PublicIPPrefixSkuArgs
    ///             {
    ///                 Name = "Standard",
    ///             },
    ///         });
    ...
    public partial class PublicIPPrefix : Pulumi.CustomResource
    {
        ...
        public PublicIPPrefix(string name, PublicIPPrefixArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181101:PublicIPPrefix", name, args ?? new PublicIPPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181101:PublicIPPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
