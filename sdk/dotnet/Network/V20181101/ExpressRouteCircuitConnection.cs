...
namespace Pulumi.AzureRM.Network.V20181101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var expressRouteCircuitConnection = new AzureRM.Network.V20181101.ExpressRouteCircuitConnection("expressRouteCircuitConnection", new AzureRM.Network.V20181101.ExpressRouteCircuitConnectionArgs
    ///         {
    ///             AddressPrefix = "10.0.0.0/29",
    ///             AuthorizationKey = "946a1918-b7a2-4917-b43c-8c4cdaee006a",
    ///             CircuitName = "ExpressRouteARMCircuitA",
    ///             ConnectionName = "circuitConnectionUSAUS",
    ///             ExpressRouteCircuitPeering = new AzureRM.Network.V20181101.Inputs.SubResourceArgs
    ///             {
    ...
    ///             },
    ///             PeerExpressRouteCircuitPeering = new AzureRM.Network.V20181101.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class ExpressRouteCircuitConnection : Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitConnection(string name, ExpressRouteCircuitConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181101:ExpressRouteCircuitConnection", name, args ?? new ExpressRouteCircuitConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181101:ExpressRouteCircuitConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:network/latest:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20180201:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20180401:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20180601:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20180701:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20180801:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20181001:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20181201:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190201:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190401:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190601:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190701:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190801:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190901:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20191101:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20191201:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200301:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200401:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200501:ExpressRouteCircuitConnection"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200601:ExpressRouteCircuitConnection"},
                },
            };
