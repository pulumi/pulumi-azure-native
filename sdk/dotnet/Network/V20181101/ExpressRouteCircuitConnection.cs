...
namespace Pulumi.AzureNative.Network.V20181101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20181101:ExpressRouteCircuitConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteCircuitConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20181101:ExpressRouteCircuitConnection")]
    public partial class ExpressRouteCircuitConnection : global::Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitConnection(string name, ExpressRouteCircuitConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181101:ExpressRouteCircuitConnection", name, args ?? new ExpressRouteCircuitConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181101:ExpressRouteCircuitConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20210201:ExpressRouteCircuitConnection"},
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20220501:ExpressRouteCircuitConnection"},
                    new global::Pulumi.Alias { Type = "azure-native:network/v20220701:ExpressRouteCircuitConnection"},
                    new global::Pulumi.Alias { Type = "azure-native:network/v20220901:ExpressRouteCircuitConnection"},
                },
            };
