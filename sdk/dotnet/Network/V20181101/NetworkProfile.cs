...
namespace Pulumi.AzureNextGen.Network.V20181101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20181101:NetworkProfile")]
    public partial class NetworkProfile : Pulumi.CustomResource
    {
        ...
        public NetworkProfile(string name, NetworkProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181101:NetworkProfile", name, args ?? new NetworkProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181101:NetworkProfile", name, null, MakeResourceOptions(options, id))
        {
        }
