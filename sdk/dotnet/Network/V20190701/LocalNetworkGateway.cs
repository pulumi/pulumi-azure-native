...
namespace Pulumi.AzureRM.Network.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var localNetworkGateway = new AzureRM.Network.V20190701.LocalNetworkGateway("localNetworkGateway", new AzureRM.Network.V20190701.LocalNetworkGatewayArgs
    ///         {
    ///             GatewayIpAddress = "11.12.13.14",
    ///             LocalNetworkAddressSpace = new AzureRM.Network.V20190701.Inputs.AddressSpaceArgs
    ///             {
    ///                 AddressPrefixes = 
    ///                 {
    ///                     "10.1.0.0/16",
    ...
    public partial class LocalNetworkGateway : Pulumi.CustomResource
    {
        ...
        public LocalNetworkGateway(string name, LocalNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:LocalNetworkGateway", name, args ?? new LocalNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:LocalNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
