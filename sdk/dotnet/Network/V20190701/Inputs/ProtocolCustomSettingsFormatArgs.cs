...
namespace Pulumi.AzureNative.Network.V20190701.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190701.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190701.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
