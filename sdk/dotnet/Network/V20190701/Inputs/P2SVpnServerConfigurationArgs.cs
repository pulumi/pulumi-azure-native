...
namespace Pulumi.AzureNative.Network.V20190701.Inputs
{
    ...
    public sealed class P2SVpnServerConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("vpnProtocols")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20190701.VpnGatewayTunnelingProtocol>>? _vpnProtocols;

        /// <summary>
        /// VPN protocols for the P2SVpnServerConfiguration.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20190701.VpnGatewayTunnelingProtocol>> VpnProtocols
        {
            get => _vpnProtocols ?? (_vpnProtocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20190701.VpnGatewayTunnelingProtocol>>());
