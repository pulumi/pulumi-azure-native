...
namespace Pulumi.AzureRM.Network.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var firewallPolicy = new AzureRM.Network.V20190701.FirewallPolicy("firewallPolicy", new AzureRM.Network.V20190701.FirewallPolicyArgs
    ///         {
    ...
    public partial class FirewallPolicy : Pulumi.CustomResource
    {
        ...
        public FirewallPolicy(string name, FirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:FirewallPolicy", name, args ?? new FirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:FirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
