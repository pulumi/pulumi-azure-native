...
namespace Pulumi.AzureRM.Network.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkPeering = new AzureRM.Network.V20190701.VirtualNetworkPeering("virtualNetworkPeering", new AzureRM.Network.V20190701.VirtualNetworkPeeringArgs
    ///         {
    ///             AllowForwardedTraffic = true,
    ///             AllowGatewayTransit = false,
    ///             AllowVirtualNetworkAccess = true,
    ///             RemoteVirtualNetwork = new AzureRM.Network.V20190701.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class VirtualNetworkPeering : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkPeering(string name, VirtualNetworkPeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:VirtualNetworkPeering", name, args ?? new VirtualNetworkPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:VirtualNetworkPeering", name, null, MakeResourceOptions(options, id))
        {
        }
