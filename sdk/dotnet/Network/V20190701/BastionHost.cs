...
namespace Pulumi.AzureRM.Network.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var bastionHost = new AzureRM.Network.V20190701.BastionHost("bastionHost", new AzureRM.Network.V20190701.BastionHostArgs
    ///         {
    ///             BastionHostName = "bastionhosttenant'",
    ///             IpConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20190701.Inputs.BastionHostIPConfigurationArgs
    ///                 {
    ...
    public partial class BastionHost : Pulumi.CustomResource
    {
        ...
        public BastionHost(string name, BastionHostArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:BastionHost", name, args ?? new BastionHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BastionHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:BastionHost", name, null, MakeResourceOptions(options, id))
        {
        }
