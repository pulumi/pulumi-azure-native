...
namespace Pulumi.AzureNative.Network.V20190701
{
    ...
    /// Rule Group resource.
    /// </summary>
    [Obsolete(@"azure-native:network/v20190701:FirewallPolicyRuleGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200401:FirewallPolicyRuleGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20190701:FirewallPolicyRuleGroup")]
    public partial class FirewallPolicyRuleGroup : global::Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleGroup(string name, FirewallPolicyRuleGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190701:FirewallPolicyRuleGroup", name, args ?? new FirewallPolicyRuleGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190701:FirewallPolicyRuleGroup", name, null, MakeResourceOptions(options, id))
        {
        }
