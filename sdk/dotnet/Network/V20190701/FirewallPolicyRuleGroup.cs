...
namespace Pulumi.AzureRM.Network.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var firewallPolicyRuleGroup = new AzureRM.Network.V20190701.FirewallPolicyRuleGroup("firewallPolicyRuleGroup", new AzureRM.Network.V20190701.FirewallPolicyRuleGroupArgs
    ///         {
    ...
    ///             Rules = 
    ///             {
    ///                 new AzureRM.Network.V20190701.Inputs.FirewallPolicyRuleArgs
    ///                 {
    ...
    public partial class FirewallPolicyRuleGroup : Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleGroup(string name, FirewallPolicyRuleGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:FirewallPolicyRuleGroup", name, args ?? new FirewallPolicyRuleGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:FirewallPolicyRuleGroup", name, null, MakeResourceOptions(options, id))
        {
        }
