...
namespace Pulumi.AzureRM.Network.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnGateway = new AzureRM.Network.V20190701.VpnGateway("vpnGateway", new AzureRM.Network.V20190701.VpnGatewayArgs
    ///         {
    ///             BgpSettings = new AzureRM.Network.V20190701.Inputs.BgpSettingsArgs
    ///             {
    ///                 Asn = 65515,
    ///                 PeerWeight = 0,
    ///             },
    ///             Connections = 
    ///             {
    ///                 new AzureRM.Network.V20190701.Inputs.VpnConnectionArgs
    ///                 {
    ///                     Name = "vpnConnection1",
    ///                 },
    ///             },
    ...
    public partial class VpnGateway : Pulumi.CustomResource
    {
        ...
        public VpnGateway(string name, VpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:VpnGateway", name, args ?? new VpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:VpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
