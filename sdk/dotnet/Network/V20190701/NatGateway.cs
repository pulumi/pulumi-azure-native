...
namespace Pulumi.AzureRM.Network.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var natGateway = new AzureRM.Network.V20190701.NatGateway("natGateway", new AzureRM.Network.V20190701.NatGatewayArgs
    ///         {
    ///             Location = "westus",
    ///             NatGatewayName = "test-natgateway",
    ///             PublicIpAddresses = 
    ///             {
    ///                 new AzureRM.Network.V20190701.Inputs.SubResourceArgs
    ///                 {
    ...
    ///             Sku = new AzureRM.Network.V20190701.Inputs.NatGatewaySkuArgs
    ///             {
    ///                 Name = "Standard",
    ///             },
    ///         });
    ...
    public partial class NatGateway : Pulumi.CustomResource
    {
        ...
        public NatGateway(string name, NatGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:NatGateway", name, args ?? new NatGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:NatGateway", name, null, MakeResourceOptions(options, id))
        {
        }
