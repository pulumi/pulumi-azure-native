...
namespace Pulumi.AzureRM.Network.V20190701
{
    public static class GetAzureFirewall
    {
        public static Task<GetAzureFirewallResult> InvokeAsync(GetAzureFirewallArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAzureFirewallResult>("azurerm:network/v20190701:getAzureFirewall", args ?? new GetAzureFirewallArgs(), options.WithVersion());
    }
