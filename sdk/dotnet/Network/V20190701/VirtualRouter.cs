...
namespace Pulumi.AzureRM.Network.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualRouter = new AzureRM.Network.V20190701.VirtualRouter("virtualRouter", new AzureRM.Network.V20190701.VirtualRouterArgs
    ///         {
    ///             HostedGateway = new AzureRM.Network.V20190701.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class VirtualRouter : Pulumi.CustomResource
    {
        ...
        public VirtualRouter(string name, VirtualRouterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:VirtualRouter", name, args ?? new VirtualRouterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:VirtualRouter", name, null, MakeResourceOptions(options, id))
        {
        }
