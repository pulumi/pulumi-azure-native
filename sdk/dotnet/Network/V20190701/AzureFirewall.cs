...
namespace Pulumi.AzureRM.Network.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var azureFirewall = new AzureRM.Network.V20190701.AzureFirewall("azureFirewall", new AzureRM.Network.V20190701.AzureFirewallArgs
    ///         {
    ///             ApplicationRuleCollections = 
    ///             {
    ///                 new AzureRM.Network.V20190701.Inputs.AzureFirewallApplicationRuleCollectionArgs
    ///                 {
    ///                     Name = "apprulecoll",
    ///                 },
    ///             },
    ...
    ///             IpConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20190701.Inputs.AzureFirewallIPConfigurationArgs
    ///                 {
    ...
    ///             NatRuleCollections = 
    ///             {
    ///                 new AzureRM.Network.V20190701.Inputs.AzureFirewallNatRuleCollectionArgs
    ///                 {
    ///                     Name = "natrulecoll",
    ///                 },
    ///             },
    ...
    ///             {
    ///                 new AzureRM.Network.V20190701.Inputs.AzureFirewallNetworkRuleCollectionArgs
    ///                 {
    ///                     Name = "netrulecoll",
    ///                 },
    ///             },
    ...
    ///         {
    ///             AzureFirewallName = "azurefirewall",
    ///             FirewallPolicy = new AzureRM.Network.V20190701.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class AzureFirewall : Pulumi.CustomResource
    {
        ...
        public AzureFirewall(string name, AzureFirewallArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:AzureFirewall", name, args ?? new AzureFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureFirewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:AzureFirewall", name, null, MakeResourceOptions(options, id))
        {
        }
