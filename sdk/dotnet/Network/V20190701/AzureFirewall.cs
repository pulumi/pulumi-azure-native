...
namespace Pulumi.AzureNative.Network.V20190701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190701:AzureFirewall")]
    public partial class AzureFirewall : Pulumi.CustomResource
    {
        ...
        public AzureFirewall(string name, AzureFirewallArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190701:AzureFirewall", name, args ?? new AzureFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureFirewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190701:AzureFirewall", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AzureFirewallArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190701.AzureFirewallThreatIntelMode>? ThreatIntelMode { get; set; }
