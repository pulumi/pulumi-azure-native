...
namespace Pulumi.AzureNative.Network.V20190701
{
    ...
    /// {
    ///     var p2sVpnServerConfiguration = new AzureNative.Network.V20190701.P2sVpnServerConfiguration("p2sVpnServerConfiguration", new()
    ///     {
    ///         P2SVpnServerConfigRadiusClientRootCertificates = new[]
    ///         {
    ///             new AzureNative.Network.V20190701.Inputs.P2SVpnServerConfigRadiusClientRootCertificateArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.Network.V20190701.Inputs.P2SVpnServerConfigRadiusServerRootCertificateArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.Network.V20190701.Inputs.P2SVpnServerConfigVpnClientRevokedCertificateArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.Network.V20190701.Inputs.P2SVpnServerConfigVpnClientRootCertificateArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.Network.V20190701.Inputs.IpsecPolicyArgs
    ///             {
    ///                 DhGroup = "DHGroup14",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190701:P2sVpnServerConfiguration")]
    public partial class P2sVpnServerConfiguration : global::Pulumi.CustomResource
    {
        ...
        public P2sVpnServerConfiguration(string name, P2sVpnServerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190701:P2sVpnServerConfiguration", name, args ?? new P2sVpnServerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private P2sVpnServerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190701:P2sVpnServerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
