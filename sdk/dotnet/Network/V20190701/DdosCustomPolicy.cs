...
namespace Pulumi.AzureRM.Network.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var ddosCustomPolicy = new AzureRM.Network.V20190701.DdosCustomPolicy("ddosCustomPolicy", new AzureRM.Network.V20190701.DdosCustomPolicyArgs
    ///         {
    ///             DdosCustomPolicyName = "test-ddos-custom-policy",
    ///             Location = "centraluseuap",
    ///             ProtocolCustomSettings = 
    ///             {
    ///                 new AzureRM.Network.V20190701.Inputs.ProtocolCustomSettingsFormatArgs
    ///                 {
    ///                     Protocol = "Tcp",
    ///                 },
    ///             },
    ...
    public partial class DdosCustomPolicy : Pulumi.CustomResource
    {
        ...
        public DdosCustomPolicy(string name, DdosCustomPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:DdosCustomPolicy", name, args ?? new DdosCustomPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DdosCustomPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190701:DdosCustomPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/v20190901:DdosCustomPolicy"},
