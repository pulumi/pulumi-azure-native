...
namespace Pulumi.AzureNextGen.Network.V20190701
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190701:PublicIPAddress")]
    public partial class PublicIPAddress : Pulumi.CustomResource
    {
        ...
        public PublicIPAddress(string name, PublicIPAddressArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190701:PublicIPAddress", name, args ?? new PublicIPAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190701:PublicIPAddress", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PublicIPAddressArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190701.IPVersion>? PublicIPAddressVersion { get; set; }

        /// <summary>
        /// The public IP address allocation method.
        /// </summary>
        [Input("publicIPAllocationMethod")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190701.IPAllocationMethod>? PublicIPAllocationMethod { get; set; }
