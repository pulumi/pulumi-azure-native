...
namespace Pulumi.AzureNative.Network.V20190701
{
    public static class GetVirtualHub
    {
        ...
        public static Output<GetVirtualHubResult> Invoke(GetVirtualHubInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVirtualHubResult>("azure-native:network/v20190701:getVirtualHub", args ?? new GetVirtualHubInvokeArgs(), options.WithVersion());
    }
