...
namespace Pulumi.AzureNative.Network.V20190701
{
    public static class GetVirtualHub
    {
        ...
        public static Task<GetVirtualHubResult> InvokeAsync(GetVirtualHubArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualHubResult>("azure-native:network/v20190701:getVirtualHub", args ?? new GetVirtualHubArgs(), options.WithDefaults());

        /// <summary>
        /// VirtualHub Resource.
        /// </summary>
        public static Output<GetVirtualHubResult> Invoke(GetVirtualHubInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVirtualHubResult>("azure-native:network/v20190701:getVirtualHub", args ?? new GetVirtualHubInvokeArgs(), options.WithDefaults());
    }
