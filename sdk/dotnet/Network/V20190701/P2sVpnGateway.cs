        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20201101:P2sVpnGateway"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210201:P2sVpnGateway"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:P2sVpnGateway"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:P2sVpnGateway"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:P2sVpnGateway"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:P2sVpnGateway"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:P2sVpnGateway"},
                },
            };
