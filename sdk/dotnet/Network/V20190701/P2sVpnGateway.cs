...
namespace Pulumi.AzureNative.Network.V20190701
{
    ...
    public partial class P2sVpnGateway : global::Pulumi.CustomResource
    {
        ...
        public P2sVpnGateway(string name, P2sVpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190701:P2sVpnGateway", name, args ?? new P2sVpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private P2sVpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190701:P2sVpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
