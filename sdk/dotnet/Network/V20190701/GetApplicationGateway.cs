...
namespace Pulumi.AzureNative.Network.V20190701
{
    public static class GetApplicationGateway
    {
        ...
        public static Task<GetApplicationGatewayResult> InvokeAsync(GetApplicationGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationGatewayResult>("azure-native:network/v20190701:getApplicationGateway", args ?? new GetApplicationGatewayArgs(), options.WithVersion());

        /// <summary>
        /// Application gateway resource.
        /// </summary>
        public static Output<GetApplicationGatewayResult> Invoke(GetApplicationGatewayInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationGatewayResult>("azure-native:network/v20190701:getApplicationGateway", args ?? new GetApplicationGatewayInvokeArgs(), options.WithVersion());
    }
