...
namespace Pulumi.AzureNative.Network.V20190701
{
    public static class GetRouteFilterRule
    {
        ...
        public static Task<GetRouteFilterRuleResult> InvokeAsync(GetRouteFilterRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteFilterRuleResult>("azure-native:network/v20190701:getRouteFilterRule", args ?? new GetRouteFilterRuleArgs(), options.WithVersion());

        /// <summary>
        /// Route Filter Rule Resource.
        /// </summary>
        public static Output<GetRouteFilterRuleResult> Invoke(GetRouteFilterRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRouteFilterRuleResult>("azure-native:network/v20190701:getRouteFilterRule", args ?? new GetRouteFilterRuleInvokeArgs(), options.WithVersion());
    }
