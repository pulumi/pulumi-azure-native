...
namespace Pulumi.AzureNextGen.Network.V20190701
{
    public static class GetVirtualRouter
    {
        public static Task<GetVirtualRouterResult> InvokeAsync(GetVirtualRouterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualRouterResult>("azure-nextgen:network/v20190701:getVirtualRouter", args ?? new GetVirtualRouterArgs(), options.WithVersion());
    }
