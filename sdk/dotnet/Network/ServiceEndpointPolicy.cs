...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class ServiceEndpointPolicy : Pulumi.CustomResource
    {
        ...
        public ServiceEndpointPolicy(string name, ServiceEndpointPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:ServiceEndpointPolicy", name, args ?? new ServiceEndpointPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceEndpointPolicy(string name, Input<string> id, ServiceEndpointPolicyState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:ServiceEndpointPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceEndpointPolicy Get(string name, Input<string> id, ServiceEndpointPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new ServiceEndpointPolicy(name, id, state, options);
        }
    }
    ...
    public sealed class ServiceEndpointPolicyState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A unique read-only string that changes whenever the resource is updated.
        /// </summary>
        ...
        public Input<Inputs.ServiceEndpointPolicyPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
        ...
        public ServiceEndpointPolicyState()
        {
        }
    }
}
