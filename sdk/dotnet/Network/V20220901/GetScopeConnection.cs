...
{
    [Obsolete(@"azure-native:network/v20220901:ScopeConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ScopeConnection to guarantee forwards compatibility.")]
    public static class GetScopeConnection
    {
        ...
        public static Task<GetScopeConnectionResult> InvokeAsync(GetScopeConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScopeConnectionResult>("azure-native:network/v20220901:getScopeConnection", args ?? new GetScopeConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// Get specified scope connection created by this Network Manager.
        /// </summary>
        public static Output<GetScopeConnectionResult> Invoke(GetScopeConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScopeConnectionResult>("azure-native:network/v20220901:getScopeConnection", args ?? new GetScopeConnectionInvokeArgs(), options.WithDefaults());
    }
