...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var inboundNatRule = new AzureNative.Network.V20220901.InboundNatRule("inboundNatRule", new()
    ///     {
    ///         BackendPort = 3389,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:InboundNatRule")]
    public partial class InboundNatRule : global::Pulumi.CustomResource
    {
        ...
        public InboundNatRule(string name, InboundNatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:InboundNatRule", name, args ?? new InboundNatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InboundNatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:InboundNatRule", name, null, MakeResourceOptions(options, id))
        {
        }
