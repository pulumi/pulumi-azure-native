...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var virtualNetworkTap = new AzureNative.Network.V20220901.VirtualNetworkTap("virtualNetworkTap", new()
    ///     {
    ///         DestinationNetworkInterfaceIPConfiguration = new AzureNative.Network.V20220901.Inputs.NetworkInterfaceIPConfigurationArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:VirtualNetworkTap")]
    public partial class VirtualNetworkTap : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkTap(string name, VirtualNetworkTapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualNetworkTap", name, args ?? new VirtualNetworkTapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkTap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualNetworkTap", name, null, MakeResourceOptions(options, id))
        {
        }
