...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var firewallPolicyRuleCollectionGroup = new AzureNative.Network.V20220901.FirewallPolicyRuleCollectionGroup("firewallPolicyRuleCollectionGroup", new()
    ///     {
    ...
    ///         RuleCollections = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.FirewallPolicyNatRuleCollectionArgs
    ///             {
    ///                 Action = new AzureNative.Network.V20220901.Inputs.FirewallPolicyNatRuleCollectionActionArgs
    ///                 {
    ///                     Type = "DNAT",
    ///                 },
    ...
    ///                 Rules = new[]
    ///                 {
    ///                     new AzureNative.Network.V20220901.Inputs.NatRuleArgs
    ///                     {
    ...
    ///         RuleCollections = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.FirewallPolicyFilterRuleCollectionArgs
    ///             {
    ///                 Action = new AzureNative.Network.V20220901.Inputs.FirewallPolicyFilterRuleCollectionActionArgs
    ///                 {
    ///                     Type = "Deny",
    ///                 },
    ...
    ///                 Rules = new[]
    ///                 {
    ///                     new AzureNative.Network.V20220901.Inputs.NetworkRuleArgs
    ///                     {
    ///                         DestinationAddresses = new[]
    ///                         {
    ///                             "*",
    ...
    ///                 Rules = new[]
    ///                 {
    ///                     new AzureNative.Network.V20220901.Inputs.ApplicationRuleArgs
    ///                     {
    ///                         Description = "Deny inbound rule",
    ///                         Name = "rule1",
    ///                         Protocols = new[]
    ///                         {
    ///                             new AzureNative.Network.V20220901.Inputs.FirewallPolicyRuleApplicationProtocolArgs
    ///                             {
    ///                                 Port = 443,
    ///                                 ProtocolType = "Https",
    ///                             },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup ruleCollectionGroup1 /subscriptions/e747cc13-97d4-4a79-b463-42d7f4e558f2/resourceGroups/rg1/providers/Microsoft.Network/firewallPolicies/firewallPolicy/ruleCollectionGroups/ruleCollectionGroup1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup")]
    public partial class FirewallPolicyRuleCollectionGroup : global::Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleCollectionGroup(string name, FirewallPolicyRuleCollectionGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup", name, args ?? new FirewallPolicyRuleCollectionGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleCollectionGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup", name, null, MakeResourceOptions(options, id))
        {
        }
