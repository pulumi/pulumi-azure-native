...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    public partial class SecurityAdminConfiguration : global::Pulumi.CustomResource
    {
        ...
        public SecurityAdminConfiguration(string name, SecurityAdminConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:SecurityAdminConfiguration", name, args ?? new SecurityAdminConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityAdminConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:SecurityAdminConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityAdminConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.V20220901.NetworkIntentPolicyBasedService>>? _applyOnNetworkIntentPolicyBasedServices;

        /// <summary>
        /// Enum list of network intent policy based services.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20220901.NetworkIntentPolicyBasedService>> ApplyOnNetworkIntentPolicyBasedServices
        {
            get => _applyOnNetworkIntentPolicyBasedServices ?? (_applyOnNetworkIntentPolicyBasedServices = new InputList<Union<string, Pulumi.AzureNative.Network.V20220901.NetworkIntentPolicyBasedService>>());
