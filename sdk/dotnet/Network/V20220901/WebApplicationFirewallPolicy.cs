...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220901:WebApplicationFirewallPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:WebApplicationFirewallPolicy to guarantee forwards compatibility.")]
    ...
    public partial class WebApplicationFirewallPolicy : global::Pulumi.CustomResource
    {
        ...
        public WebApplicationFirewallPolicy(string name, WebApplicationFirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:WebApplicationFirewallPolicy", name, args ?? new WebApplicationFirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApplicationFirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:WebApplicationFirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
