...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var hubRouteTable = new AzureNative.Network.V20220901.HubRouteTable("hubRouteTable", new()
    ///     {
    ///         Labels = new[]
    ///         {
    ///             "label1",
    ...
    ///         Routes = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.HubRouteArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20220901:HubRouteTable hubRouteTable1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualHubs/virtualHub1/hubRouteTables/hubRouteTable1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:HubRouteTable")]
    public partial class HubRouteTable : global::Pulumi.CustomResource
    {
        ...
        public HubRouteTable(string name, HubRouteTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:HubRouteTable", name, args ?? new HubRouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubRouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:HubRouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
