...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var routeFilter = new AzureNative.Network.V20220901.RouteFilter("routeFilter", new()
    ///     {
    ///         Location = "West US",
    ...
    ///         Rules = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.RouteFilterRuleArgs
    ///             {
    ///                 Access = "Allow",
    ///                 Communities = new[]
    ///                 {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20220901:RouteFilter filterName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/routeFilters/filterName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:RouteFilter")]
    public partial class RouteFilter : global::Pulumi.CustomResource
    {
        ...
        public RouteFilter(string name, RouteFilterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:RouteFilter", name, args ?? new RouteFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:RouteFilter", name, null, MakeResourceOptions(options, id))
        {
        }
