...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var virtualNetwork = new AzureNative.Network.V20220901.VirtualNetwork("virtualNetwork", new()
    ///     {
    ///         AddressSpace = new AzureNative.Network.V20220901.Inputs.AddressSpaceArgs
    ///         {
    ///             AddressPrefixes = new[]
    ///             {
    ///                 "10.0.0.0/16",
    ...
    ///             },
    ///         },
    ///         BgpCommunities = new AzureNative.Network.V20220901.Inputs.VirtualNetworkBgpCommunitiesArgs
    ///         {
    ...
    ///         Subnets = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.SubnetArgs
    ///             {
    ...
    ///                 Delegations = new[]
    ///                 {
    ///                     new AzureNative.Network.V20220901.Inputs.DelegationArgs
    ///                     {
    ///                         Name = "myDelegation",
    ...
    ///             },
    ///         },
    ///         Encryption = new AzureNative.Network.V20220901.Inputs.VirtualNetworkEncryptionArgs
    ///         {
    ///             Enabled = true,
    ...
    ///                 {
    ///                     new AzureNative.Network.V20220901.Inputs.ServiceEndpointPropertiesFormatArgs
    ///                     {
    ...
    ///                 {
    ///                     new AzureNative.Network.V20220901.Inputs.ServiceEndpointPolicyArgs
    ///                     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:VirtualNetwork")]
    public partial class VirtualNetwork : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
