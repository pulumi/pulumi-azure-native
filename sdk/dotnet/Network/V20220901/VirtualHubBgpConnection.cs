...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var virtualHubBgpConnection = new AzureNative.Network.V20220901.VirtualHubBgpConnection("virtualHubBgpConnection", new()
    ///     {
    ///         ConnectionName = "conn1",
    ///         HubVirtualNetworkConnection = new AzureNative.Network.V20220901.Inputs.SubResourceArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20220901:VirtualHubBgpConnection conn1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualHubs/hub1/bgpConnections/conn1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:VirtualHubBgpConnection")]
    public partial class VirtualHubBgpConnection : global::Pulumi.CustomResource
    {
        ...
        public VirtualHubBgpConnection(string name, VirtualHubBgpConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualHubBgpConnection", name, args ?? new VirtualHubBgpConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubBgpConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualHubBgpConnection", name, null, MakeResourceOptions(options, id))
        {
        }
