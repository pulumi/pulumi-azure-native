...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var expressRoutePortAuthorization = new AzureNative.Network.V20220901.ExpressRoutePortAuthorization("expressRoutePortAuthorization", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20220901:ExpressRoutePortAuthorization authorizationName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/ExpressRoutePorts/expressRoutePortName/authorizations/authorizationName 
    /// ```
    /// </summary>
