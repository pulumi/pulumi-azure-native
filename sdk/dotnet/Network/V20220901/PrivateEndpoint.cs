...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var privateEndpoint = new AzureNative.Network.V20220901.PrivateEndpoint("privateEndpoint", new()
    ///     {
    ///         CustomNetworkInterfaceName = "testPeNic",
    ///         IpConfigurations = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.PrivateEndpointIPConfigurationArgs
    ///             {
    ///                 GroupId = "file",
    ///                 MemberName = "file",
    ///                 Name = "pestaticconfig",
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.PrivateLinkServiceConnectionArgs
    ///             {
    ///                 GroupIds = new[]
    ///                 {
    ///                     "groupIdFromResource",
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.ApplicationSecurityGroupArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:PrivateEndpoint")]
    public partial class PrivateEndpoint : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpoint(string name, PrivateEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:PrivateEndpoint", name, args ?? new PrivateEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:PrivateEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
