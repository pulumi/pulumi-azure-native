...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var vpnGateway = new AzureNative.Network.V20220901.VpnGateway("vpnGateway", new()
    ///     {
    ...
    ///             {
    ///                 new AzureNative.Network.V20220901.Inputs.IPConfigurationBgpPeeringAddressArgs
    ///                 {
    ...
    ///         Connections = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.VpnConnectionArgs
    ///             {
    ///                 Name = "vpnConnection1",
    ...
    ///         NatRules = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.VpnGatewayNatRuleArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:VpnGateway")]
    public partial class VpnGateway : global::Pulumi.CustomResource
    {
        ...
        public VpnGateway(string name, VpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VpnGateway", name, args ?? new VpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
