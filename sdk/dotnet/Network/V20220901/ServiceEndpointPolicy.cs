...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var serviceEndpointPolicy = new AzureNative.Network.V20220901.ServiceEndpointPolicy("serviceEndpointPolicy", new()
    ///     {
    ///         Location = "westus",
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.ServiceEndpointPolicyDefinitionArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:ServiceEndpointPolicy")]
    public partial class ServiceEndpointPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServiceEndpointPolicy(string name, ServiceEndpointPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ServiceEndpointPolicy", name, args ?? new ServiceEndpointPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceEndpointPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ServiceEndpointPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
