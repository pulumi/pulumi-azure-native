...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var networkWatcher = new AzureNative.Network.V20220901.NetworkWatcher("networkWatcher", new()
    ///     {
    ///         Location = "eastus",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:NetworkWatcher")]
    public partial class NetworkWatcher : global::Pulumi.CustomResource
    {
        ...
        public NetworkWatcher(string name, NetworkWatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:NetworkWatcher", name, args ?? new NetworkWatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkWatcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:NetworkWatcher", name, null, MakeResourceOptions(options, id))
        {
        }
