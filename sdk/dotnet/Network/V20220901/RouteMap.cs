...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    public partial class RouteMap : global::Pulumi.CustomResource
    {
        ...
        public RouteMap(string name, RouteMapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:RouteMap", name, args ?? new RouteMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:RouteMap", name, null, MakeResourceOptions(options, id))
        {
        }
