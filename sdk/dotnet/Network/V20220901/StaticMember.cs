...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// StaticMember Item.
    /// </summary>
    [Obsolete(@"azure-native:network/v20220901:StaticMember is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:StaticMember to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20220901:StaticMember")]
    public partial class StaticMember : global::Pulumi.CustomResource
    {
        ...
        public StaticMember(string name, StaticMemberArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:StaticMember", name, args ?? new StaticMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:StaticMember", name, null, MakeResourceOptions(options, id))
        {
        }
