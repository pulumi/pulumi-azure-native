...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var azureFirewall = new AzureNative.Network.V20220901.AzureFirewall("azureFirewall", new()
    ///     {
    ///         ApplicationRuleCollections = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.AzureFirewallApplicationRuleCollectionArgs
    ///             {
    ///                 Action = new AzureNative.Network.V20220901.Inputs.AzureFirewallRCActionArgs
    ///                 {
    ///                     Type = "Deny",
    ///                 },
    ///                 Name = "apprulecoll",
    ...
    ///                 Rules = new[]
    ///                 {
    ///                     new AzureNative.Network.V20220901.Inputs.AzureFirewallApplicationRuleArgs
    ///                     {
    ///                         Description = "Deny inbound rule",
    ///                         Name = "rule1",
    ///                         Protocols = new[]
    ///                         {
    ///                             new AzureNative.Network.V20220901.Inputs.AzureFirewallApplicationRuleProtocolArgs
    ///                             {
    ///                                 Port = 443,
    ///                                 ProtocolType = "Https",
    ///                             },
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.AzureFirewallIPConfigurationArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.AzureFirewallNatRuleCollectionArgs
    ///             {
    ///                 Action = new AzureNative.Network.V20220901.Inputs.AzureFirewallNatRCActionArgs
    ///                 {
    ///                     Type = "Dnat",
    ///                 },
    ///                 Name = "natrulecoll",
    ...
    ///                 Rules = new[]
    ///                 {
    ///                     new AzureNative.Network.V20220901.Inputs.AzureFirewallNatRuleArgs
    ///                     {
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.AzureFirewallNetworkRuleCollectionArgs
    ///             {
    ///                 Action = new AzureNative.Network.V20220901.Inputs.AzureFirewallRCActionArgs
    ///                 {
    ///                     Type = "Deny",
    ...
    ///                 Rules = new[]
    ///                 {
    ///                     new AzureNative.Network.V20220901.Inputs.AzureFirewallNetworkRuleArgs
    ///                     {
    ...
    ///         Sku = new AzureNative.Network.V20220901.Inputs.AzureFirewallSkuArgs
    ///         {
    ///             Name = "AZFW_VNet",
    ///             Tier = "Standard",
    ///         },
    ...
    ///         },
    ///         Location = "West US",
    ///         ManagementIpConfiguration = new AzureNative.Network.V20220901.Inputs.AzureFirewallIPConfigurationArgs
    ///         {
    ...
    ///     {
    ///         AzureFirewallName = "azurefirewall",
    ///         FirewallPolicy = new AzureNative.Network.V20220901.Inputs.SubResourceArgs
    ///         {
    ///             Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/firewallPolicies/policy1",
    ///         },
    ///         HubIPAddresses = new AzureNative.Network.V20220901.Inputs.HubIPAddressesArgs
    ///         {
    ///             PublicIPs = new AzureNative.Network.V20220901.Inputs.HubPublicIPAddressesArgs
    ///             {
    ///                 Addresses = new[] {},
    ///                 Count = 1,
    ///             },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20220901:AzureFirewall azurefirewall /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/azureFirewalls/azurefirewall 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:AzureFirewall")]
    public partial class AzureFirewall : global::Pulumi.CustomResource
    {
        ...
        public AzureFirewall(string name, AzureFirewallArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:AzureFirewall", name, args ?? new AzureFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureFirewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:AzureFirewall", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AzureFirewallArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220901.AzureFirewallThreatIntelMode>? ThreatIntelMode { get; set; }
