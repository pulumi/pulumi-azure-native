...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var vpnServerConfiguration = new AzureNative.Network.V20220901.VpnServerConfiguration("vpnServerConfiguration", new()
    ///     {
    ///         ConfigurationPolicyGroups = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.VpnServerConfigurationPolicyGroupArgs
    ///             {
    ...
    ///                 PolicyMembers = new[]
    ///                 {
    ///                     new AzureNative.Network.V20220901.Inputs.VpnServerConfigurationPolicyGroupMemberArgs
    ///                     {
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.VpnServerConfigRadiusClientRootCertificateArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.VpnServerConfigRadiusServerRootCertificateArgs
    ///             {
    ...
    ///         RadiusServers = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.RadiusServerArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.IpsecPolicyArgs
    ///             {
    ///                 DhGroup = "DHGroup14",
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.VpnServerConfigVpnClientRevokedCertificateArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.VpnServerConfigVpnClientRootCertificateArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20220901:VpnServerConfiguration vpnServerConfiguration1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/vpnServerConfigurations/vpnServerConfiguration1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:VpnServerConfiguration")]
    public partial class VpnServerConfiguration : global::Pulumi.CustomResource
    {
        ...
        public VpnServerConfiguration(string name, VpnServerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VpnServerConfiguration", name, args ?? new VpnServerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnServerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VpnServerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VpnServerConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.V20220901.VpnAuthenticationType>>? _vpnAuthenticationTypes;

        /// <summary>
        /// VPN authentication types for the VpnServerConfiguration.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20220901.VpnAuthenticationType>> VpnAuthenticationTypes
        {
            get => _vpnAuthenticationTypes ?? (_vpnAuthenticationTypes = new InputList<Union<string, Pulumi.AzureNative.Network.V20220901.VpnAuthenticationType>>());
        ...
        [Input("vpnProtocols")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20220901.VpnGatewayTunnelingProtocol>>? _vpnProtocols;

        /// <summary>
        /// VPN protocols for the VpnServerConfiguration.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20220901.VpnGatewayTunnelingProtocol>> VpnProtocols
        {
            get => _vpnProtocols ?? (_vpnProtocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20220901.VpnGatewayTunnelingProtocol>>());
