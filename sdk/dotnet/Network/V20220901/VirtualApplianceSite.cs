...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var virtualApplianceSite = new AzureNative.Network.V20220901.VirtualApplianceSite("virtualApplianceSite", new()
    ///     {
    ///         AddressPrefix = "192.168.1.0/24",
    ///         NetworkVirtualApplianceName = "nva",
    ///         O365Policy = new AzureNative.Network.V20220901.Inputs.Office365PolicyPropertiesArgs
    ///         {
    ///             BreakOutCategories = new AzureNative.Network.V20220901.Inputs.BreakOutCategoryPoliciesArgs
    ///             {
    ///                 Allow = true,
    ///                 Default = true,
    ///                 Optimize = true,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:VirtualApplianceSite")]
    public partial class VirtualApplianceSite : global::Pulumi.CustomResource
    {
        ...
        public VirtualApplianceSite(string name, VirtualApplianceSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualApplianceSite", name, args ?? new VirtualApplianceSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualApplianceSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualApplianceSite", name, null, MakeResourceOptions(options, id))
        {
        }
