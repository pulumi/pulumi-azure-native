...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220901:ApplicationGatewayPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ApplicationGatewayPrivateEndpointConnection to guarantee forwards compatibility.")]
    ...
    public partial class ApplicationGatewayPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGatewayPrivateEndpointConnection(string name, ApplicationGatewayPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ApplicationGatewayPrivateEndpointConnection", name, args ?? new ApplicationGatewayPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGatewayPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ApplicationGatewayPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
