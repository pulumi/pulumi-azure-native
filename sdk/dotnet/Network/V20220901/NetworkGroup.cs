...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var networkGroup = new AzureNative.Network.V20220901.NetworkGroup("networkGroup", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:NetworkGroup")]
    public partial class NetworkGroup : global::Pulumi.CustomResource
    {
        ...
        public NetworkGroup(string name, NetworkGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:NetworkGroup", name, args ?? new NetworkGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:NetworkGroup", name, null, MakeResourceOptions(options, id))
        {
        }
