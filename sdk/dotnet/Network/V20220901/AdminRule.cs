...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// Network admin rule.
    /// </summary>
    [Obsolete(@"azure-native:network/v20220901:AdminRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:AdminRule to guarantee forwards compatibility.")]
    ...
    public partial class AdminRule : global::Pulumi.CustomResource
    {
        ...
        public AdminRule(string name, AdminRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:AdminRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AdminRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:AdminRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AdminRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220901.SecurityConfigurationRuleAccess> Access { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220901.SecurityConfigurationRuleDirection> Direction { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220901.SecurityConfigurationRuleProtocol> Protocol { get; set; } = null!;
