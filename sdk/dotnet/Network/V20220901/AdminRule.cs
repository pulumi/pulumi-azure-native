...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    public partial class AdminRule : global::Pulumi.CustomResource
    {
        ...
        public AdminRule(string name, AdminRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:AdminRule", name, args ?? new AdminRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class AdminRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220901.AdminRuleKind> Kind { get; set; } = null!;
