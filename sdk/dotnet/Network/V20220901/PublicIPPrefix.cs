...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var publicIPPrefix = new AzureNative.Network.V20220901.PublicIPPrefix("publicIPPrefix", new()
    ///     {
    ///         Location = "westus",
    ///         PrefixLength = 30,
    ...
    ///         Sku = new AzureNative.Network.V20220901.Inputs.PublicIPPrefixSkuArgs
    ///         {
    ///             Name = "Standard",
    ///             Tier = "Regional",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:PublicIPPrefix")]
    public partial class PublicIPPrefix : global::Pulumi.CustomResource
    {
        ...
        public PublicIPPrefix(string name, PublicIPPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:PublicIPPrefix", name, args ?? new PublicIPPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:PublicIPPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
