...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var networkProfile = new AzureNative.Network.V20220901.NetworkProfile("networkProfile", new()
    ///     {
    ///         ContainerNetworkInterfaceConfigurations = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.ContainerNetworkInterfaceConfigurationArgs
    ///             {
    ///                 IpConfigurations = new[]
    ///                 {
    ///                     new AzureNative.Network.V20220901.Inputs.IPConfigurationProfileArgs
    ///                     {
    ///                         Name = "ipconfig1",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:NetworkProfile")]
    public partial class NetworkProfile : global::Pulumi.CustomResource
    {
        ...
        public NetworkProfile(string name, NetworkProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:NetworkProfile", name, args ?? new NetworkProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:NetworkProfile", name, null, MakeResourceOptions(options, id))
        {
        }
