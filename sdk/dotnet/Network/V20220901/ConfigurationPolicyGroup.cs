...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220901:ConfigurationPolicyGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ConfigurationPolicyGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20220901:ConfigurationPolicyGroup")]
    public partial class ConfigurationPolicyGroup : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationPolicyGroup(string name, ConfigurationPolicyGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ConfigurationPolicyGroup", name, args ?? new ConfigurationPolicyGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationPolicyGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ConfigurationPolicyGroup", name, null, MakeResourceOptions(options, id))
        {
        }
