...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var securityPartnerProvider = new AzureNative.Network.V20220901.SecurityPartnerProvider("securityPartnerProvider", new()
    ///     {
    ///         Location = "West US",
    ...
    ///             { "key1", "value1" },
    ///         },
    ///         VirtualHub = new AzureNative.Network.V20220901.Inputs.SubResourceArgs
    ///         {
