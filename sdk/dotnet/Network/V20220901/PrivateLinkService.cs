...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var privateLinkService = new AzureNative.Network.V20220901.PrivateLinkService("privateLinkService", new()
    ///     {
    ///         AutoApproval = new AzureNative.Network.V20220901.Inputs.PrivateLinkServicePropertiesAutoApprovalArgs
    ///         {
    ///             Subscriptions = new[]
    ///             {
    ///                 "subscription1",
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.PrivateLinkServiceIpConfigurationArgs
    ///             {
    ///                 Name = "fe-lb",
    ...
    ///         ServiceName = "testPls",
    ///         Visibility = new AzureNative.Network.V20220901.Inputs.PrivateLinkServicePropertiesVisibilityArgs
    ///         {
    ///             Subscriptions = new[]
    ///             {
    ///                 "subscription1",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:PrivateLinkService")]
    public partial class PrivateLinkService : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkService(string name, PrivateLinkServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:PrivateLinkService", name, args ?? new PrivateLinkServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:PrivateLinkService", name, null, MakeResourceOptions(options, id))
        {
        }
