...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var managementGroupNetworkManagerConnection = new AzureNative.Network.V20220901.ManagementGroupNetworkManagerConnection("managementGroupNetworkManagerConnection", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20220901:ManagementGroupNetworkManagerConnection TestNMConnection /providers/Microsoft.Management/managementGroups/managementGroupA/providers/Microsoft.Network/networkManagerConnections/TestNMConnection 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:ManagementGroupNetworkManagerConnection")]
    public partial class ManagementGroupNetworkManagerConnection : global::Pulumi.CustomResource
    {
        ...
        public ManagementGroupNetworkManagerConnection(string name, ManagementGroupNetworkManagerConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ManagementGroupNetworkManagerConnection", name, args ?? new ManagementGroupNetworkManagerConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroupNetworkManagerConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ManagementGroupNetworkManagerConnection", name, null, MakeResourceOptions(options, id))
        {
        }
