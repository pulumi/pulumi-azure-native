...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var hubVirtualNetworkConnection = new AzureNative.Network.V20220901.HubVirtualNetworkConnection("hubVirtualNetworkConnection", new()
    ///     {
    ...
    ///                 },
    ///             },
    ///             VnetRoutes = new AzureNative.Network.V20220901.Inputs.VnetRouteArgs
    ///             {
    ///                 StaticRoutes = new[]
    ///                 {
    ///                     new AzureNative.Network.V20220901.Inputs.StaticRouteArgs
    ///                     {
    ///                         AddressPrefixes = new[]
    ///                         {
    ///                             "10.1.0.0/16",
    ...
    ///                     },
    ///                 },
    ///                 StaticRoutesConfig = new AzureNative.Network.V20220901.Inputs.StaticRoutesConfigArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:HubVirtualNetworkConnection")]
    public partial class HubVirtualNetworkConnection : global::Pulumi.CustomResource
    {
        ...
        public HubVirtualNetworkConnection(string name, HubVirtualNetworkConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:HubVirtualNetworkConnection", name, args ?? new HubVirtualNetworkConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubVirtualNetworkConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:HubVirtualNetworkConnection", name, null, MakeResourceOptions(options, id))
        {
        }
