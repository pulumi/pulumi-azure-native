...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var bastionHost = new AzureNative.Network.V20220901.BastionHost("bastionHost", new()
    ///     {
    ///         BastionHostName = "bastionhosttenant",
    ///         IpConfigurations = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.BastionHostIPConfigurationArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:BastionHost")]
    public partial class BastionHost : global::Pulumi.CustomResource
    {
        ...
        public BastionHost(string name, BastionHostArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:BastionHost", name, args ?? new BastionHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BastionHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:BastionHost", name, null, MakeResourceOptions(options, id))
        {
        }
