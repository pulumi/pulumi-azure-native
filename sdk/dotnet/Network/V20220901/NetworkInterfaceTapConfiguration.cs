...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var networkInterfaceTapConfiguration = new AzureNative.Network.V20220901.NetworkInterfaceTapConfiguration("networkInterfaceTapConfiguration", new()
    ///     {
    ///         NetworkInterfaceName = "mynic",
    ///         ResourceGroupName = "testrg",
    ///         TapConfigurationName = "tapconfiguration1",
    ///         VirtualNetworkTap = new AzureNative.Network.V20220901.Inputs.VirtualNetworkTapArgs
    ///         {
