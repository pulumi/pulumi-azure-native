...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220901:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.")]
    ...
    public partial class VirtualNetworkGatewayNatRule : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGatewayNatRule(string name, VirtualNetworkGatewayNatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualNetworkGatewayNatRule", name, args ?? new VirtualNetworkGatewayNatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGatewayNatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualNetworkGatewayNatRule", name, null, MakeResourceOptions(options, id))
        {
        }
