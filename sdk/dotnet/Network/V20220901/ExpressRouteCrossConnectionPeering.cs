...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var expressRouteCrossConnectionPeering = new AzureNative.Network.V20220901.ExpressRouteCrossConnectionPeering("expressRouteCrossConnectionPeering", new()
    ///     {
    ///         CrossConnectionName = "&lt;circuitServiceKey&gt;",
    ///         Ipv6PeeringConfig = new AzureNative.Network.V20220901.Inputs.Ipv6ExpressRouteCircuitPeeringConfigArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:ExpressRouteCrossConnectionPeering")]
    public partial class ExpressRouteCrossConnectionPeering : global::Pulumi.CustomResource
    {
        ...
        public ExpressRouteCrossConnectionPeering(string name, ExpressRouteCrossConnectionPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ExpressRouteCrossConnectionPeering", name, args ?? new ExpressRouteCrossConnectionPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCrossConnectionPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ExpressRouteCrossConnectionPeering", name, null, MakeResourceOptions(options, id))
        {
        }
