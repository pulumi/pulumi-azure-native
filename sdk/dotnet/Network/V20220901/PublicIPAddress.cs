...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var publicIPAddress = new AzureNative.Network.V20220901.PublicIPAddress("publicIPAddress", new()
    ///     {
    ///         DnsSettings = new AzureNative.Network.V20220901.Inputs.PublicIPAddressDnsSettingsArgs
    ///         {
    ...
    ///         PublicIpAddressName = "test-ip",
    ///         ResourceGroupName = "rg1",
    ///         Sku = new AzureNative.Network.V20220901.Inputs.PublicIPAddressSkuArgs
    ///         {
    ///             Name = "Standard",
    ///             Tier = "Global",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:PublicIPAddress")]
    public partial class PublicIPAddress : global::Pulumi.CustomResource
    {
        ...
        public PublicIPAddress(string name, PublicIPAddressArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:PublicIPAddress", name, args ?? new PublicIPAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:PublicIPAddress", name, null, MakeResourceOptions(options, id))
        {
        }
