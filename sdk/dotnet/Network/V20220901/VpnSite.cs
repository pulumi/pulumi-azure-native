...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var vpnSite = new AzureNative.Network.V20220901.VpnSite("vpnSite", new()
    ///     {
    ...
    ///         Location = "West US",
    ///         O365Policy = new AzureNative.Network.V20220901.Inputs.O365PolicyPropertiesArgs
    ///         {
    ///             BreakOutCategories = new AzureNative.Network.V20220901.Inputs.O365BreakOutCategoryPoliciesArgs
    ///             {
    ///                 Allow = true,
    ///                 Default = false,
    ///                 Optimize = true,
    ...
    ///         VpnSiteLinks = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.VpnSiteLinkArgs
    ///             {
    ///                 BgpProperties = new AzureNative.Network.V20220901.Inputs.VpnLinkBgpSettingsArgs
    ///                 {
    ///                     Asn = 1234,
    ...
    ///                 LinkProperties = new AzureNative.Network.V20220901.Inputs.VpnLinkProviderPropertiesArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:VpnSite")]
    public partial class VpnSite : global::Pulumi.CustomResource
    {
        ...
        public VpnSite(string name, VpnSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VpnSite", name, args ?? new VpnSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VpnSite", name, null, MakeResourceOptions(options, id))
        {
        }
