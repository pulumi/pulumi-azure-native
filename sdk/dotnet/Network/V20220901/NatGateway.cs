...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var natGateway = new AzureNative.Network.V20220901.NatGateway("natGateway", new()
    ///     {
    ///         Location = "westus",
    ...
    ///         Sku = new AzureNative.Network.V20220901.Inputs.NatGatewaySkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ///     });
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:NatGateway")]
    public partial class NatGateway : global::Pulumi.CustomResource
    {
        ...
        public NatGateway(string name, NatGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:NatGateway", name, args ?? new NatGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:NatGateway", name, null, MakeResourceOptions(options, id))
        {
        }
