...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var virtualWan = new AzureNative.Network.V20220901.VirtualWan("virtualWan", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20220901:VirtualWan wan1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualWANs/wan1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:VirtualWan")]
    public partial class VirtualWan : global::Pulumi.CustomResource
    {
        ...
        public VirtualWan(string name, VirtualWanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualWan", name, args ?? new VirtualWanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualWan", name, null, MakeResourceOptions(options, id))
        {
        }
