...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var applicationSecurityGroup = new AzureNative.Network.V20220901.ApplicationSecurityGroup("applicationSecurityGroup", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20220901:ApplicationSecurityGroup test-asg /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationSecurityGroups/test-asg 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:ApplicationSecurityGroup")]
    public partial class ApplicationSecurityGroup : global::Pulumi.CustomResource
    {
        ...
        public ApplicationSecurityGroup(string name, ApplicationSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ApplicationSecurityGroup", name, args ?? new ApplicationSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ApplicationSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
