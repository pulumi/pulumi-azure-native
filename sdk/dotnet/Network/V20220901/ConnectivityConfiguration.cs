...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var connectivityConfiguration = new AzureNative.Network.V20220901.ConnectivityConfiguration("connectivityConfiguration", new()
    ///     {
    ///         AppliesToGroups = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.ConnectivityGroupItemArgs
    ///             {
    ...
    ///         Hubs = new[]
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.HubArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20220901:ConnectivityConfiguration myTestConnectivityConfig subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.Network/networkManagers/testNetworkManager/connectivityConfigurations/myTestConnectivityConfig 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:ConnectivityConfiguration")]
    public partial class ConnectivityConfiguration : global::Pulumi.CustomResource
    {
        ...
        public ConnectivityConfiguration(string name, ConnectivityConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ConnectivityConfiguration", name, args ?? new ConnectivityConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectivityConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:ConnectivityConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectivityConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220901.ConnectivityTopology> ConnectivityTopology { get; set; } = null!;

        /// <summary>
        /// Flag if need to remove current existing peerings.
        /// </summary>
        [Input("deleteExistingPeering")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220901.DeleteExistingPeering>? DeleteExistingPeering { get; set; }
        ...
        /// </summary>
        [Input("isGlobal")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220901.IsGlobal>? IsGlobal { get; set; }
