...
namespace Pulumi.AzureNative.Network.V20220901
{
    ...
    /// {
    ///     var virtualNetworkGatewayConnection = new AzureNative.Network.V20220901.VirtualNetworkGatewayConnection("virtualNetworkGatewayConnection", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.Network.V20220901.Inputs.GatewayCustomBgpIpAddressIpConfigurationArgs
    ///             {
    ...
    ///         },
    ///         IpsecPolicies = new[] {},
    ///         LocalNetworkGateway2 = new AzureNative.Network.V20220901.Inputs.LocalNetworkGatewayArgs
    ///         {
    ...
    ///         VirtualNetworkGateway1 = new AzureNative.Network.V20220901.Inputs.VirtualNetworkGatewayArgs
    ///         {
    ///             ActiveActive = false,
    ///             BgpSettings = new AzureNative.Network.V20220901.Inputs.BgpSettingsArgs
    ///             {
    ///                 Asn = 65514,
    ...
    ///             {
    ///                 new AzureNative.Network.V20220901.Inputs.VirtualNetworkGatewayIPConfigurationArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworkGateways/vpngw/ipConfigurations/gwipconfig1",
    ///                     Name = "gwipconfig1",
    ///                     PrivateIPAllocationMethod = "Dynamic",
    ///                     PublicIPAddress = new AzureNative.Network.V20220901.Inputs.SubResourceArgs
    ///                     {
    ///                         Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/publicIPAddresses/gwpip",
    ///                     },
    ///                     Subnet = new AzureNative.Network.V20220901.Inputs.SubResourceArgs
    ///                     {
    ...
    ///             },
    ///             Location = "centralus",
    ///             Sku = new AzureNative.Network.V20220901.Inputs.VirtualNetworkGatewaySkuArgs
    ///             {
    ///                 Name = "VpnGw1",
    ///                 Tier = "VpnGw1",
    ///             },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220901:VirtualNetworkGatewayConnection")]
    public partial class VirtualNetworkGatewayConnection : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGatewayConnection(string name, VirtualNetworkGatewayConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualNetworkGatewayConnection", name, args ?? new VirtualNetworkGatewayConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGatewayConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220901:VirtualNetworkGatewayConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkGatewayConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220901.VirtualNetworkGatewayConnectionMode>? ConnectionMode { get; set; }

        /// <summary>
        /// Connection protocol used for this connection.
        /// </summary>
        [Input("connectionProtocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220901.VirtualNetworkGatewayConnectionProtocol>? ConnectionProtocol { get; set; }

        /// <summary>
        /// Gateway connection type.
        /// </summary>
        [Input("connectionType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220901.VirtualNetworkGatewayConnectionType> ConnectionType { get; set; } = null!;
