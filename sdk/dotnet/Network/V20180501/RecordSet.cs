...
namespace Pulumi.AzureRM.Network.V20180501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var recordSet = new AzureRM.Network.V20180501.RecordSet("recordSet", new AzureRM.Network.V20180501.RecordSetArgs
    ///         {
    ///             ARecords = 
    ///             {
    ///                 new AzureRM.Network.V20180501.Inputs.ARecordArgs
    ///                 {
    ...
    ///             RelativeRecordSetName = "record1",
    ///             ResourceGroupName = "rg1",
    ///             TargetResource = new AzureRM.Network.V20180501.Inputs.SubResourceArgs
    ///             {
    ...
    ///             AaaaRecords = 
    ///             {
    ///                 new AzureRM.Network.V20180501.Inputs.AaaaRecordArgs
    ///                 {
    ///                     Ipv6Address = "::1",
    ///                 },
    ///             },
    ...
    ///             CaaRecords = 
    ///             {
    ///                 new AzureRM.Network.V20180501.Inputs.CaaRecordArgs
    ///                 {
    ///                     Flags = 0,
    ///                     Tag = "issue",
    ...
    ///         var recordSet = new AzureRM.Network.V20180501.RecordSet("recordSet", new AzureRM.Network.V20180501.RecordSetArgs
    ///         {
    ///             CnameRecord = new AzureRM.Network.V20180501.Inputs.CnameRecordArgs
    ///             {
    ///                 Cname = "contoso.com",
    ///             },
    ///             Metadata = 
    ...
    ///             MxRecords = 
    ///             {
    ///                 new AzureRM.Network.V20180501.Inputs.MxRecordArgs
    ///                 {
    ...
    ///             NsRecords = 
    ///             {
    ///                 new AzureRM.Network.V20180501.Inputs.NsRecordArgs
    ///                 {
    ...
    ///             PtrRecords = 
    ///             {
    ///                 new AzureRM.Network.V20180501.Inputs.PtrRecordArgs
    ///                 {
    ///                     Ptrdname = "localhost",
    ///                 },
    ///             },
    ...
    ///             ResourceGroupName = "rg1",
    ///             SoaRecord = new AzureRM.Network.V20180501.Inputs.SoaRecordArgs
    ///             {
    ...
    ///             SrvRecords = 
    ///             {
    ///                 new AzureRM.Network.V20180501.Inputs.SrvRecordArgs
    ///                 {
    ///                     Port = 80,
    ///                     Priority = 0,
    ///                     Target = "contoso.com",
    ...
    ///             TxtRecords = 
    ///             {
    ///                 new AzureRM.Network.V20180501.Inputs.TxtRecordArgs
    ///                 {
    ///                     Value = 
    ///                     {
    ///                         "string1",
    ...
    public partial class RecordSet : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.SubResourceResponseResult?> TargetResource { get; private set; } = null!;
