...
namespace Pulumi.AzureNextGen.Network.V20180501
{
    ...
    public partial class Zone : Pulumi.CustomResource
    {
        ...
        public Zone(string name, ZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180501:Zone", name, args ?? new ZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Zone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180501:Zone", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ZoneArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("zoneType")]
        public Input<Pulumi.AzureNextGen.Network.V20180501.ZoneType>? ZoneType { get; set; }

        public ZoneArgs()
        {
            ZoneType = Pulumi.AzureNextGen.Network.V20180501.ZoneType.Public;
        }
    }
}
