...
namespace Pulumi.AzureNative.Network
{
    public static class GetNatGateway
    {
        ...
        public static Task<GetNatGatewayResult> InvokeAsync(GetNatGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNatGatewayResult>("azure-native:network:getNatGateway", args ?? new GetNatGatewayArgs(), options.WithDefaults());
        ...
        public static Output<GetNatGatewayResult> Invoke(GetNatGatewayInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNatGatewayResult>("azure-native:network:getNatGateway", args ?? new GetNatGatewayInvokeArgs(), options.WithDefaults());
    }
