...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class LoadBalancerBackendAddressPool : Pulumi.CustomResource
    {
        ...
        public LoadBalancerBackendAddressPool(string name, LoadBalancerBackendAddressPoolArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:LoadBalancerBackendAddressPool", name, args ?? new LoadBalancerBackendAddressPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancerBackendAddressPool(string name, Input<string> id, LoadBalancerBackendAddressPoolState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:LoadBalancerBackendAddressPool", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LoadBalancerBackendAddressPool Get(string name, Input<string> id, LoadBalancerBackendAddressPoolState? state = null, CustomResourceOptions? options = null)
        {
            return new LoadBalancerBackendAddressPool(name, id, state, options);
        }
    }
    ...
    public sealed class LoadBalancerBackendAddressPoolState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A unique read-only string that changes whenever the resource is updated.
        /// </summary>
        ...
        public Input<Inputs.BackendAddressPoolPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
        ...
        public LoadBalancerBackendAddressPoolState()
        {
        }
    }
}
