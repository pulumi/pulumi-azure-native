...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class NatGateway : Pulumi.CustomResource
    {
        ...
        private NatGateway(string name, Input<string> id, NatGatewayState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:NatGateway", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NatGatewayState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.NatGatewayPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;

        /// <summary>
        /// The nat gateway SKU.
        /// </summary>
        [Input("sku")]
        public Input<Inputs.NatGatewaySkuResponseGetArgs>? Sku { get; set; }
