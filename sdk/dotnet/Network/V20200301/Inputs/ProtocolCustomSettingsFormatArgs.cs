...
namespace Pulumi.AzureNative.Network.V20200301.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200301.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200301.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
