...
namespace Pulumi.AzureNative.Network.V20200301.Inputs
{
    ...
    public sealed class VirtualNetworkGatewayArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("gatewayType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200301.VirtualNetworkGatewayType>? GatewayType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200301.VpnGatewayGeneration>? VpnGatewayGeneration { get; set; }

        /// <summary>
        /// The type of this virtual network gateway.
        /// </summary>
        [Input("vpnType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200301.VpnType>? VpnType { get; set; }
