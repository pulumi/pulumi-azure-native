...
namespace Pulumi.AzureRM.Network.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var bastionHost = new AzureRM.Network.V20200301.BastionHost("bastionHost", new AzureRM.Network.V20200301.BastionHostArgs
    ///         {
    ///             BastionHostName = "bastionhosttenant'",
    ///             IpConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20200301.Inputs.BastionHostIPConfigurationArgs
    ///                 {
    ...
    public partial class BastionHost : Pulumi.CustomResource
    {
        ...
        public BastionHost(string name, BastionHostArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:BastionHost", name, args ?? new BastionHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BastionHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:BastionHost", name, null, MakeResourceOptions(options, id))
        {
        }
