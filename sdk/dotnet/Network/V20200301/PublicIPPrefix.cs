...
namespace Pulumi.AzureNextGen.Network.V20200301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200301:PublicIPPrefix")]
    public partial class PublicIPPrefix : Pulumi.CustomResource
    {
        ...
        public PublicIPPrefix(string name, PublicIPPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200301:PublicIPPrefix", name, args ?? new PublicIPPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200301:PublicIPPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PublicIPPrefixArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200301.IPVersion>? PublicIPAddressVersion { get; set; }
