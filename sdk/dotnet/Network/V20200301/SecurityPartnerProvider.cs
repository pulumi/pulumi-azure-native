...
namespace Pulumi.AzureRM.Network.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var securityPartnerProvider = new AzureRM.Network.V20200301.SecurityPartnerProvider("securityPartnerProvider", new AzureRM.Network.V20200301.SecurityPartnerProviderArgs
    ///         {
    ///             Location = "West US",
    ...
    public partial class SecurityPartnerProvider : Pulumi.CustomResource
    {
        ...
        public SecurityPartnerProvider(string name, SecurityPartnerProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:SecurityPartnerProvider", name, args ?? new SecurityPartnerProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityPartnerProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:SecurityPartnerProvider", name, null, MakeResourceOptions(options, id))
        {
        }
