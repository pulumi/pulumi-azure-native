...
namespace Pulumi.AzureNative.Network.V20200301
{
    ...
    public static class GetFlowLog
    {
        ...
        public static Task<GetFlowLogResult> InvokeAsync(GetFlowLogArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFlowLogResult>("azure-native:network/v20200301:getFlowLog", args ?? new GetFlowLogArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a flow log resource by name.
        /// </summary>
        public static Output<GetFlowLogResult> Invoke(GetFlowLogInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFlowLogResult>("azure-native:network/v20200301:getFlowLog", args ?? new GetFlowLogInvokeArgs(), options.WithDefaults());
    }
