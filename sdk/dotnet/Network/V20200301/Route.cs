...
namespace Pulumi.AzureNextGen.Network.V20200301
{
    ...
    /// Route resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200301:Route")]
    public partial class Route : Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200301:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200301:Route", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200301.RouteNextHopType> NextHopType { get; set; } = null!;
