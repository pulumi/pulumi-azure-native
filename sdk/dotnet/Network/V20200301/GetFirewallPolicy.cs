...
namespace Pulumi.AzureRM.Network.V20200301
{
    public static class GetFirewallPolicy
    {
        public static Task<GetFirewallPolicyResult> InvokeAsync(GetFirewallPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallPolicyResult>("azurerm:network/v20200301:getFirewallPolicy", args ?? new GetFirewallPolicyArgs(), options.WithVersion());
    }
