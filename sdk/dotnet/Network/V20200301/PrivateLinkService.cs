...
namespace Pulumi.AzureNative.Network.V20200301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200301:PrivateLinkService")]
    public partial class PrivateLinkService : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkService(string name, PrivateLinkServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200301:PrivateLinkService", name, args ?? new PrivateLinkServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200301:PrivateLinkService", name, null, MakeResourceOptions(options, id))
        {
        }
