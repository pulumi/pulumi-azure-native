...
{
    [Obsolete(@"azure-native:network/v20200301:NetworkProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkProfile to guarantee forwards compatibility.")]
    public static class GetNetworkProfile
    {
        ...
        public static Task<GetNetworkProfileResult> InvokeAsync(GetNetworkProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkProfileResult>("azure-native:network/v20200301:getNetworkProfile", args ?? new GetNetworkProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified network profile in a specified resource group.
        /// </summary>
        public static Output<GetNetworkProfileResult> Invoke(GetNetworkProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkProfileResult>("azure-native:network/v20200301:getNetworkProfile", args ?? new GetNetworkProfileInvokeArgs(), options.WithDefaults());
    }
