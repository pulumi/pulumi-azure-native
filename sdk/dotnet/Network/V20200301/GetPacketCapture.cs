...
namespace Pulumi.AzureRM.Network.V20200301
{
    public static class GetPacketCapture
    {
        public static Task<GetPacketCaptureResult> InvokeAsync(GetPacketCaptureArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPacketCaptureResult>("azurerm:network/v20200301:getPacketCapture", args ?? new GetPacketCaptureArgs(), options.WithVersion());
    }
