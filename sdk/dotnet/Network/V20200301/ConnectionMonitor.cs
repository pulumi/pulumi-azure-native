...
namespace Pulumi.AzureRM.Network.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var connectionMonitor = new AzureRM.Network.V20200301.ConnectionMonitor("connectionMonitor", new AzureRM.Network.V20200301.ConnectionMonitorArgs
    ///         {
    ///             ConnectionMonitorName = "cm1",
    ///             Destination = new AzureRM.Network.V20200301.Inputs.ConnectionMonitorDestinationArgs
    ///             {
    ///                 Address = "bing.com",
    ///                 Port = 80,
    ///             },
    ...
    ///             Source = new AzureRM.Network.V20200301.Inputs.ConnectionMonitorSourceArgs
    ///             {
    ...
    ///             Endpoints = 
    ///             {
    ///                 new AzureRM.Network.V20200301.Inputs.ConnectionMonitorEndpointArgs
    ///                 {
    ///                     Name = "vm1",
    ...
    ///                 new AzureRM.Network.V20200301.Inputs.ConnectionMonitorEndpointArgs
    ///                 {
    ///                     Filter = new AzureRM.Network.V20200301.Inputs.ConnectionMonitorEndpointFilterArgs
    ///                     {
    ///                         Items = 
    ///                         {
    ///                             new AzureRM.Network.V20200301.Inputs.ConnectionMonitorEndpointFilterItemArgs
    ///                             {
    ///                                 Address = "npmuser",
    ///                                 Type = "AgentAddress",
    ///                             },
    ...
    ///             TestConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20200301.Inputs.ConnectionMonitorTestConfigurationArgs
    ///                 {
    ///                     Name = "testConfig1",
    ///                     Protocol = "Tcp",
    ///                     TcpConfiguration = new AzureRM.Network.V20200301.Inputs.ConnectionMonitorTcpConfigurationArgs
    ///                     {
    ...
    ///             TestGroups = 
    ///             {
    ///                 new AzureRM.Network.V20200301.Inputs.ConnectionMonitorTestGroupArgs
    ///                 {
    ///                     Destinations = 
    ///                     {
    ///                         "bing",
