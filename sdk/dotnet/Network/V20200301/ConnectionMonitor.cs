...
namespace Pulumi.AzureNative.Network.V20200301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200301:ConnectionMonitor")]
    public partial class ConnectionMonitor : Pulumi.CustomResource
    {
        ...
        public ConnectionMonitor(string name, ConnectionMonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200301:ConnectionMonitor", name, args ?? new ConnectionMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200301:ConnectionMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:network:ConnectionMonitor"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:ConnectionMonitor"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:ConnectionMonitor"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:ConnectionMonitor"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:ConnectionMonitor"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:ConnectionMonitor"},
                },
            };
