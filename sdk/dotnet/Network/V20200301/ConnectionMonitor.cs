...
namespace Pulumi.AzureRM.Network.V20200301
{
    ...
    public partial class ConnectionMonitor : Pulumi.CustomResource
    {
        ...
        public ConnectionMonitor(string name, ConnectionMonitorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:ConnectionMonitor", name, args ?? new ConnectionMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:ConnectionMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:network/v20171001:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20171101:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20180101:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20180201:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20180401:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20180601:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20180701:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20180801:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20181001:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20181101:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20181201:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20190201:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20190401:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20190601:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20190701:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20190801:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20190901:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20191101:ConnectionMonitor"},
                    new Alias { Type = "azurerm:network/v20191201:ConnectionMonitor"},
