...
namespace Pulumi.AzureNextGen.Network.V20200301
{
    ...
    public partial class VirtualNetworkGatewayConnection : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGatewayConnection(string name, VirtualNetworkGatewayConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200301:VirtualNetworkGatewayConnection", name, args ?? new VirtualNetworkGatewayConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGatewayConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200301:VirtualNetworkGatewayConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkGatewayConnectionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200301.VirtualNetworkGatewayConnectionProtocol>? ConnectionProtocol { get; set; }

        /// <summary>
        /// Gateway connection type.
        /// </summary>
        [Input("connectionType", required: true)]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200301.VirtualNetworkGatewayConnectionType> ConnectionType { get; set; } = null!;
