...
namespace Pulumi.AzureRM.Network.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var firewallPolicyRuleGroup = new AzureRM.Network.V20200301.FirewallPolicyRuleGroup("firewallPolicyRuleGroup", new AzureRM.Network.V20200301.FirewallPolicyRuleGroupArgs
    ///         {
    ...
    ///                 
    ///                 {
    ///                     { "action", new AzureRM.Network.V20200301.Inputs.FirewallPolicyNatRuleActionArgs
    ///                     {
    ///                         Type = "Deny",
    ///                     } },
    ///                     { "name", "Example-Filter-Rule" },
    ...
    public partial class FirewallPolicyRuleGroup : Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleGroup(string name, FirewallPolicyRuleGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:FirewallPolicyRuleGroup", name, args ?? new FirewallPolicyRuleGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:FirewallPolicyRuleGroup", name, null, MakeResourceOptions(options, id))
        {
        }
