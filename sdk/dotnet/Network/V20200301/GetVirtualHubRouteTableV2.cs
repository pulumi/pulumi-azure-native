...
namespace Pulumi.AzureRM.Network.V20200301
{
    public static class GetVirtualHubRouteTableV2
    {
        public static Task<GetVirtualHubRouteTableV2Result> InvokeAsync(GetVirtualHubRouteTableV2Args args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualHubRouteTableV2Result>("azurerm:network/v20200301:getVirtualHubRouteTableV2", args ?? new GetVirtualHubRouteTableV2Args(), options.WithVersion());
    }
