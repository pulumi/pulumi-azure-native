...
namespace Pulumi.AzureRM.Network.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnSite = new AzureRM.Network.V20200301.VpnSite("vpnSite", new AzureRM.Network.V20200301.VpnSiteArgs
    ///         {
    ///             AddressSpace = new AzureRM.Network.V20200301.Inputs.AddressSpaceArgs
    ///             {
    ///                 AddressPrefixes = 
    ///                 {
    ///                     "10.0.0.0/16",
    ...
    ///                 { "key1", "value1" },
    ///             },
    ///             VirtualWan = new AzureRM.Network.V20200301.Inputs.SubResourceArgs
    ///             {
    ///                 Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualWANs/wan1",
    ///             },
    ///             VpnSiteLinks = 
    ///             {
    ///                 new AzureRM.Network.V20200301.Inputs.VpnSiteLinkArgs
    ///                 {
    ///                     Name = "vpnSiteLink1",
    ///                 },
    ///             },
    ...
    public partial class VpnSite : Pulumi.CustomResource
    {
        ...
        public VpnSite(string name, VpnSiteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:VpnSite", name, args ?? new VpnSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:VpnSite", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/v20181101:VpnSite"},
