...
namespace Pulumi.AzureNextGen.Network.V20200301
{
    public static class GetExpressRoutePort
    {
        public static Task<GetExpressRoutePortResult> InvokeAsync(GetExpressRoutePortArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExpressRoutePortResult>("azure-nextgen:network/v20200301:getExpressRoutePort", args ?? new GetExpressRoutePortArgs(), options.WithVersion());
    }
