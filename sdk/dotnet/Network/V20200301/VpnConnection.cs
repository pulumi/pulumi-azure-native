...
namespace Pulumi.AzureRM.Network.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnConnection = new AzureRM.Network.V20200301.VpnConnection("vpnConnection", new AzureRM.Network.V20200301.VpnConnectionArgs
    ///         {
    ///             ConnectionName = "vpnConnection1",
    ///             GatewayName = "gateway1",
    ///             RemoteVpnSite = new AzureRM.Network.V20200301.Inputs.SubResourceArgs
    ///             {
    ...
    ///             VpnLinkConnections = 
    ///             {
    ///                 new AzureRM.Network.V20200301.Inputs.VpnSiteLinkConnectionArgs
    ///                 {
    ...
    public partial class VpnConnection : Pulumi.CustomResource
    {
        ...
        public VpnConnection(string name, VpnConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:VpnConnection", name, args ?? new VpnConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:VpnConnection", name, null, MakeResourceOptions(options, id))
        {
        }
