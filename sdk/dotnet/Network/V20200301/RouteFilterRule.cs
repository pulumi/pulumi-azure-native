...
namespace Pulumi.AzureNative.Network.V20200301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200301:RouteFilterRule")]
    public partial class RouteFilterRule : Pulumi.CustomResource
    {
        ...
        public RouteFilterRule(string name, RouteFilterRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200301:RouteFilterRule", name, args ?? new RouteFilterRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilterRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200301:RouteFilterRule", name, null, MakeResourceOptions(options, id))
        {
        }
