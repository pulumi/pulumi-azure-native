...
namespace Pulumi.AzureNative.Network.V20200301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200301:ExpressRouteCircuitPeering")]
    public partial class ExpressRouteCircuitPeering : Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitPeering(string name, ExpressRouteCircuitPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200301:ExpressRouteCircuitPeering", name, args ?? new ExpressRouteCircuitPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200301:ExpressRouteCircuitPeering", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRouteCircuitPeeringArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("peeringType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200301.ExpressRoutePeeringType>? PeeringType { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200301.ExpressRoutePeeringState>? State { get; set; }
