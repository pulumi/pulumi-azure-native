...
namespace Pulumi.AzureNextGen.Network.V20200301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200301:AzureFirewall")]
    public partial class AzureFirewall : Pulumi.CustomResource
    {
        ...
        public AzureFirewall(string name, AzureFirewallArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200301:AzureFirewall", name, args ?? new AzureFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureFirewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200301:AzureFirewall", name, null, MakeResourceOptions(options, id))
        {
        }
