...
namespace Pulumi.AzureNative.Network.V20200301
{
    ...
    /// VirtualHub Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200301:VirtualHub")]
    public partial class VirtualHub : Pulumi.CustomResource
    {
        ...
        public VirtualHub(string name, VirtualHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200301:VirtualHub", name, args ?? new VirtualHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200301:VirtualHub", name, null, MakeResourceOptions(options, id))
        {
        }
