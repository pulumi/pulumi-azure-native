...
namespace Pulumi.AzureNative.Network.V20200301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200301:ExpressRouteCircuit")]
    public partial class ExpressRouteCircuit : global::Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuit(string name, ExpressRouteCircuitArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200301:ExpressRouteCircuit", name, args ?? new ExpressRouteCircuitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuit(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200301:ExpressRouteCircuit", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRouteCircuitArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200301.ServiceProviderProvisioningState>? ServiceProviderProvisioningState { get; set; }
