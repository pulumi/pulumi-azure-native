...
namespace Pulumi.AzureRM.Network.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnGateway = new AzureRM.Network.V20200301.VpnGateway("vpnGateway", new AzureRM.Network.V20200301.VpnGatewayArgs
    ///         {
    ///             BgpSettings = new AzureRM.Network.V20200301.Inputs.BgpSettingsArgs
    ///             {
    ///                 Asn = 65515,
    ///                 PeerWeight = 0,
    ///             },
    ///             Connections = 
    ///             {
    ///                 new AzureRM.Network.V20200301.Inputs.VpnConnectionArgs
    ///                 {
    ///                     Name = "vpnConnection1",
    ///                 },
    ///             },
    ...
    public partial class VpnGateway : Pulumi.CustomResource
    {
        ...
        public VpnGateway(string name, VpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:VpnGateway", name, args ?? new VpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200301:VpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
