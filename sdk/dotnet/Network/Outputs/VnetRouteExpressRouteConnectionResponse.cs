...
namespace Pulumi.AzureNative.Network.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VnetRouteExpressRouteConnectionResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.StaticRoutesConfigExpressRouteConnectionResponse? StaticRoutesConfig;

        [OutputConstructor]
        private VnetRouteExpressRouteConnectionResponse(
            ImmutableArray<Outputs.SubResourceResponse> bgpConnections,

            ImmutableArray<Outputs.StaticRouteResponse> staticRoutes,

            Outputs.StaticRoutesConfigExpressRouteConnectionResponse? staticRoutesConfig)
        {
