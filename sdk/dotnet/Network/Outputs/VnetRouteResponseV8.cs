...
namespace Pulumi.AzureNative.Network.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VnetRouteResponseV8
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.StaticRoutesConfigResponseV8? StaticRoutesConfig;

        [OutputConstructor]
        private VnetRouteResponseV8(
            ImmutableArray<Outputs.SubResourceResponse> bgpConnections,

            ImmutableArray<Outputs.StaticRouteResponse> staticRoutes,

            Outputs.StaticRoutesConfigResponseV8? staticRoutesConfig)
        {
