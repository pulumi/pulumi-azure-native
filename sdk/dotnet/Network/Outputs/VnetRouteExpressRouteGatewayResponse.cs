...
namespace Pulumi.AzureNative.Network.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VnetRouteExpressRouteGatewayResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.StaticRoutesConfigExpressRouteGatewayResponse? StaticRoutesConfig;

        [OutputConstructor]
        private VnetRouteExpressRouteGatewayResponse(
            ImmutableArray<Outputs.SubResourceResponse> bgpConnections,

            ImmutableArray<Outputs.StaticRouteResponse> staticRoutes,

            Outputs.StaticRoutesConfigExpressRouteGatewayResponse? staticRoutesConfig)
        {
