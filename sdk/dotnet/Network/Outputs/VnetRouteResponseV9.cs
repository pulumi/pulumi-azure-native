...
namespace Pulumi.AzureNative.Network.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VnetRouteResponseV9
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.StaticRoutesConfigResponseV9? StaticRoutesConfig;

        [OutputConstructor]
        private VnetRouteResponseV9(
            ImmutableArray<Outputs.SubResourceResponse> bgpConnections,

            ImmutableArray<Outputs.StaticRouteResponse> staticRoutes,

            Outputs.StaticRoutesConfigResponseV9? staticRoutesConfig)
        {
