...
namespace Pulumi.AzureNative.Network.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VnetRouteResponseV3
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.StaticRoutesConfigResponseV3? StaticRoutesConfig;

        [OutputConstructor]
        private VnetRouteResponseV3(
            ImmutableArray<Outputs.SubResourceResponse> bgpConnections,

            ImmutableArray<Outputs.StaticRouteResponse> staticRoutes,

            Outputs.StaticRoutesConfigResponseV3? staticRoutesConfig)
        {
