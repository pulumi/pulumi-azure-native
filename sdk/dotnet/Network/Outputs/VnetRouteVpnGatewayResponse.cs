...
namespace Pulumi.AzureNative.Network.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VnetRouteVpnGatewayResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.StaticRoutesConfigVpnGatewayResponse? StaticRoutesConfig;

        [OutputConstructor]
        private VnetRouteVpnGatewayResponse(
            ImmutableArray<Outputs.SubResourceResponse> bgpConnections,

            ImmutableArray<Outputs.StaticRouteResponse> staticRoutes,

            Outputs.StaticRoutesConfigVpnGatewayResponse? staticRoutesConfig)
        {
