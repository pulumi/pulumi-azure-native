...
namespace Pulumi.AzureNative.Network.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class RoutingConfigurationExpressRouteGatewayResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.VnetRouteExpressRouteGatewayResponse? VnetRoutes;

        [OutputConstructor]
        private RoutingConfigurationExpressRouteGatewayResponse(
            ...
            Outputs.VnetRouteExpressRouteGatewayResponse? vnetRoutes)
        {
