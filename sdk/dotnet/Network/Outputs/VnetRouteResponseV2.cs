...
namespace Pulumi.AzureNative.Network.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VnetRouteResponseV2
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.StaticRoutesConfigResponseV2? StaticRoutesConfig;

        [OutputConstructor]
        private VnetRouteResponseV2(
            ImmutableArray<Outputs.SubResourceResponse> bgpConnections,

            ImmutableArray<Outputs.StaticRouteResponse> staticRoutes,

            Outputs.StaticRoutesConfigResponseV2? staticRoutesConfig)
        {
