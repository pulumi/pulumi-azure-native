...
namespace Pulumi.AzureNative.Network.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VnetRouteResponseV6
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.StaticRoutesConfigResponseV6? StaticRoutesConfig;

        [OutputConstructor]
        private VnetRouteResponseV6(
            ImmutableArray<Outputs.SubResourceResponse> bgpConnections,

            ImmutableArray<Outputs.StaticRouteResponse> staticRoutes,

            Outputs.StaticRoutesConfigResponseV6? staticRoutesConfig)
        {
