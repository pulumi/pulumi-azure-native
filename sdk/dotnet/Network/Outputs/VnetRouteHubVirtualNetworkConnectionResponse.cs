...
namespace Pulumi.AzureNative.Network.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VnetRouteHubVirtualNetworkConnectionResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.StaticRoutesConfigHubVirtualNetworkConnectionResponse? StaticRoutesConfig;

        [OutputConstructor]
        private VnetRouteHubVirtualNetworkConnectionResponse(
            ImmutableArray<Outputs.SubResourceResponse> bgpConnections,

            ImmutableArray<Outputs.StaticRouteResponse> staticRoutes,

            Outputs.StaticRoutesConfigHubVirtualNetworkConnectionResponse? staticRoutesConfig)
        {
