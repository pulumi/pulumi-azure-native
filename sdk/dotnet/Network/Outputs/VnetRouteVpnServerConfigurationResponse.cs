...
namespace Pulumi.AzureNative.Network.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VnetRouteVpnServerConfigurationResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.StaticRoutesConfigVpnServerConfigurationResponse? StaticRoutesConfig;

        [OutputConstructor]
        private VnetRouteVpnServerConfigurationResponse(
            ImmutableArray<Outputs.SubResourceResponse> bgpConnections,

            ImmutableArray<Outputs.StaticRouteResponse> staticRoutes,

            Outputs.StaticRoutesConfigVpnServerConfigurationResponse? staticRoutesConfig)
        {
