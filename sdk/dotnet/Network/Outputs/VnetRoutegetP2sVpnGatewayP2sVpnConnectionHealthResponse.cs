...
namespace Pulumi.AzureNative.Network.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VnetRoutegetP2sVpnGatewayP2sVpnConnectionHealthResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.StaticRoutesConfiggetP2sVpnGatewayP2sVpnConnectionHealthResponse? StaticRoutesConfig;

        [OutputConstructor]
        private VnetRoutegetP2sVpnGatewayP2sVpnConnectionHealthResponse(
            ImmutableArray<Outputs.SubResourceResponse> bgpConnections,

            ImmutableArray<Outputs.StaticRouteResponse> staticRoutes,

            Outputs.StaticRoutesConfiggetP2sVpnGatewayP2sVpnConnectionHealthResponse? staticRoutesConfig)
        {
