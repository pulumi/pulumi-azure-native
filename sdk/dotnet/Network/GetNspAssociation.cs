...
namespace Pulumi.AzureNative.Network
{
    public static class GetNspAssociation
    {
        ...
        public static Task<GetNspAssociationResult> InvokeAsync(GetNspAssociationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNspAssociationResult>("azure-native:network:getNspAssociation", args ?? new GetNspAssociationArgs(), options.WithDefaults());
        ...
        public static Output<GetNspAssociationResult> Invoke(GetNspAssociationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNspAssociationResult>("azure-native:network:getNspAssociation", args ?? new GetNspAssociationInvokeArgs(), options.WithDefaults());
    }
