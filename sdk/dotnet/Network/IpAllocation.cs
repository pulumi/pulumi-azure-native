...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class IpAllocation : Pulumi.CustomResource
    {
        ...
        public IpAllocation(string name, IpAllocationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:IpAllocation", name, args ?? new IpAllocationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpAllocation(string name, Input<string> id, IpAllocationState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:IpAllocation", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IpAllocation Get(string name, Input<string> id, IpAllocationState? state = null, CustomResourceOptions? options = null)
        {
            return new IpAllocation(name, id, state, options);
        }
    }
    ...
    public sealed class IpAllocationState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A unique read-only string that changes whenever the resource is updated.
        /// </summary>
        ...
        public Input<Inputs.IpAllocationPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
