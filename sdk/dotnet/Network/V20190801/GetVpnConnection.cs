...
namespace Pulumi.AzureNative.Network.V20190801
{
    public static class GetVpnConnection
    {
        ...
        public static Task<GetVpnConnectionResult> InvokeAsync(GetVpnConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVpnConnectionResult>("azure-native:network/v20190801:getVpnConnection", args ?? new GetVpnConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the details of a vpn connection.
        /// </summary>
        public static Output<GetVpnConnectionResult> Invoke(GetVpnConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVpnConnectionResult>("azure-native:network/v20190801:getVpnConnection", args ?? new GetVpnConnectionInvokeArgs(), options.WithDefaults());
    }
