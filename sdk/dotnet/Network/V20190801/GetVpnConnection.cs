...
namespace Pulumi.AzureNextGen.Network.V20190801
{
    public static class GetVpnConnection
    {
        public static Task<GetVpnConnectionResult> InvokeAsync(GetVpnConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnConnectionResult>("azure-nextgen:network/v20190801:getVpnConnection", args ?? new GetVpnConnectionArgs(), options.WithVersion());
    }
