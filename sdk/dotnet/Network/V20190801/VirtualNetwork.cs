...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// {
    ///     var virtualNetwork = new AzureNative.Network.V20190801.VirtualNetwork("virtualNetwork", new()
    ///     {
    ///         AddressSpace = new AzureNative.Network.V20190801.Inputs.AddressSpaceArgs
    ///         {
    ///             AddressPrefixes = new[]
    ///             {
    ///                 "10.0.0.0/16",
    ...
    ///             },
    ///         },
    ///         BgpCommunities = new AzureNative.Network.V20190801.Inputs.VirtualNetworkBgpCommunitiesArgs
    ///         {
    ...
    ///         Subnets = new[]
    ///         {
    ///             new AzureNative.Network.V20190801.Inputs.SubnetArgs
    ///             {
    ...
    ///                 Delegations = new[]
    ///                 {
    ///                     new AzureNative.Network.V20190801.Inputs.DelegationArgs
    ///                     {
    ///                         Name = "myDelegation",
    ...
    ///                 {
    ///                     new AzureNative.Network.V20190801.Inputs.ServiceEndpointPropertiesFormatArgs
    ///                     {
    ...
    ///                 {
    ///                     new AzureNative.Network.V20190801.Inputs.ServiceEndpointPolicyArgs
    ///                     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20190801:VirtualNetwork test-vnet /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/test-vnet 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190801:VirtualNetwork")]
    public partial class VirtualNetwork : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:VirtualNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
