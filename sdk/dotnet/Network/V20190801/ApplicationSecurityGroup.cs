...
namespace Pulumi.AzureRM.Network.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationSecurityGroup = new AzureRM.Network.V20190801.ApplicationSecurityGroup("applicationSecurityGroup", new AzureRM.Network.V20190801.ApplicationSecurityGroupArgs
    ///         {
    ...
    public partial class ApplicationSecurityGroup : Pulumi.CustomResource
    {
        ...
        public ApplicationSecurityGroup(string name, ApplicationSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190801:ApplicationSecurityGroup", name, args ?? new ApplicationSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190801:ApplicationSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
