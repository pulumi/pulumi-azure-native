...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// {
    ///     var expressRouteCircuitPeering = new AzureNative.Network.V20190801.ExpressRouteCircuitPeering("expressRouteCircuitPeering", new()
    ///     {
    ///         AzureASN = 12076,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190801:ExpressRouteCircuitPeering")]
    public partial class ExpressRouteCircuitPeering : global::Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitPeering(string name, ExpressRouteCircuitPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:ExpressRouteCircuitPeering", name, args ?? new ExpressRouteCircuitPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:ExpressRouteCircuitPeering", name, null, MakeResourceOptions(options, id))
        {
        }
