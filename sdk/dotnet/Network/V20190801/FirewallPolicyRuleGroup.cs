...
namespace Pulumi.AzureNextGen.Network.V20190801
{
    ...
    /// Rule Group resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190801:FirewallPolicyRuleGroup")]
    public partial class FirewallPolicyRuleGroup : Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleGroup(string name, FirewallPolicyRuleGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190801:FirewallPolicyRuleGroup", name, args ?? new FirewallPolicyRuleGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190801:FirewallPolicyRuleGroup", name, null, MakeResourceOptions(options, id))
        {
        }
