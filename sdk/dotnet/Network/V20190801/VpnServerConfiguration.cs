...
namespace Pulumi.AzureNextGen.Network.V20190801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190801:VpnServerConfiguration")]
    public partial class VpnServerConfiguration : Pulumi.CustomResource
    {
        ...
        public VpnServerConfiguration(string name, VpnServerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190801:VpnServerConfiguration", name, args ?? new VpnServerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnServerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190801:VpnServerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
