...
namespace Pulumi.AzureNextGen.Network.V20190801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190801:ExpressRouteConnection")]
    public partial class ExpressRouteConnection : Pulumi.CustomResource
    {
        ...
        public ExpressRouteConnection(string name, ExpressRouteConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190801:ExpressRouteConnection", name, args ?? new ExpressRouteConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190801:ExpressRouteConnection", name, null, MakeResourceOptions(options, id))
        {
        }
