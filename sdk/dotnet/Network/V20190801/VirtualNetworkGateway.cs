...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// {
    ///     var virtualNetworkGateway = new AzureNative.Network.V20190801.VirtualNetworkGateway("virtualNetworkGateway", new()
    ///     {
    ///         ActiveActive = false,
    ...
    ///             PeerWeight = 0,
    ///         },
    ///         CustomRoutes = new AzureNative.Network.V20190801.Inputs.AddressSpaceArgs
    ///         {
    ///             AddressPrefixes = new[]
    ///             {
    ///                 "101.168.0.6/32",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190801:VirtualNetworkGateway")]
    public partial class VirtualNetworkGateway : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGateway(string name, VirtualNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:VirtualNetworkGateway", name, args ?? new VirtualNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:VirtualNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkGatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("gatewayType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190801.VirtualNetworkGatewayType>? GatewayType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190801.VpnGatewayGeneration>? VpnGatewayGeneration { get; set; }

        /// <summary>
        /// The type of this virtual network gateway.
        /// </summary>
        [Input("vpnType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190801.VpnType>? VpnType { get; set; }
