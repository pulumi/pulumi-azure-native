...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20190801:SecurityRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220701:SecurityRule to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20190801:SecurityRule")]
    public partial class SecurityRule : global::Pulumi.CustomResource
    {
        ...
        public SecurityRule(string name, SecurityRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:SecurityRule", name, args ?? new SecurityRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:SecurityRule", name, null, MakeResourceOptions(options, id))
        {
        }
