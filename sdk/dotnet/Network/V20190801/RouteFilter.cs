...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// {
    ///     var routeFilter = new AzureNative.Network.V20190801.RouteFilter("routeFilter", new()
    ///     {
    ///         Location = "West US",
    ///         Peerings = new[] {},
    ...
    ///         Rules = new[]
    ///         {
    ///             new AzureNative.Network.V20190801.Inputs.RouteFilterRuleArgs
    ///             {
    ///                 Access = "Allow",
    ///                 Communities = new[]
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190801:RouteFilter")]
    public partial class RouteFilter : global::Pulumi.CustomResource
    {
        ...
        public RouteFilter(string name, RouteFilterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:RouteFilter", name, args ?? new RouteFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:RouteFilter", name, null, MakeResourceOptions(options, id))
        {
        }
