...
namespace Pulumi.AzureRM.Network.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var bastionHost = new AzureRM.Network.V20190801.BastionHost("bastionHost", new AzureRM.Network.V20190801.BastionHostArgs
    ///         {
    ///             BastionHostName = "bastionhosttenant'",
    ///             IpConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20190801.Inputs.BastionHostIPConfigurationArgs
    ///                 {
    ...
    public partial class BastionHost : Pulumi.CustomResource
    {
        ...
        public BastionHost(string name, BastionHostArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190801:BastionHost", name, args ?? new BastionHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BastionHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190801:BastionHost", name, null, MakeResourceOptions(options, id))
        {
        }
