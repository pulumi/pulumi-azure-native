...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20190801:VirtualNetworkTap is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkTap to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20190801:VirtualNetworkTap")]
    public partial class VirtualNetworkTap : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkTap(string name, VirtualNetworkTapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:VirtualNetworkTap", name, args ?? new VirtualNetworkTapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkTap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:VirtualNetworkTap", name, null, MakeResourceOptions(options, id))
        {
        }
