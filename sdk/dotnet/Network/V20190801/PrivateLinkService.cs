...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// {
    ///     var privateLinkService = new AzureNative.Network.V20190801.PrivateLinkService("privateLinkService", new()
    ///     {
    ///         AutoApproval = new AzureNative.Network.V20190801.Inputs.PrivateLinkServicePropertiesAutoApprovalArgs
    ///         {
    ///             Subscriptions = new[]
    ///             {
    ///                 "subscription1",
    ...
    ///         {
    ///             new AzureNative.Network.V20190801.Inputs.PrivateLinkServiceIpConfigurationArgs
    ///             {
    ///                 Name = "fe-lb",
    ...
    ///         ServiceName = "testPls",
    ///         Visibility = new AzureNative.Network.V20190801.Inputs.PrivateLinkServicePropertiesVisibilityArgs
    ///         {
    ///             Subscriptions = new[]
    ///             {
    ///                 "subscription1",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190801:PrivateLinkService")]
    public partial class PrivateLinkService : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkService(string name, PrivateLinkServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:PrivateLinkService", name, args ?? new PrivateLinkServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:PrivateLinkService", name, null, MakeResourceOptions(options, id))
        {
        }
