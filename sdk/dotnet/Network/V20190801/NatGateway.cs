...
namespace Pulumi.AzureRM.Network.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var natGateway = new AzureRM.Network.V20190801.NatGateway("natGateway", new AzureRM.Network.V20190801.NatGatewayArgs
    ///         {
    ///             Location = "westus",
    ///             NatGatewayName = "test-natgateway",
    ///             PublicIpAddresses = 
    ///             {
    ///                 new AzureRM.Network.V20190801.Inputs.SubResourceArgs
    ///                 {
    ...
    ///             Sku = new AzureRM.Network.V20190801.Inputs.NatGatewaySkuArgs
    ///             {
    ///                 Name = "Standard",
    ///             },
    ///         });
    ...
    public partial class NatGateway : Pulumi.CustomResource
    {
        ...
        public NatGateway(string name, NatGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190801:NatGateway", name, args ?? new NatGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190801:NatGateway", name, null, MakeResourceOptions(options, id))
        {
        }
