...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// {
    ///     var natGateway = new AzureNative.Network.V20190801.NatGateway("natGateway", new()
    ///     {
    ///         Location = "westus",
    ...
    ///         Sku = new AzureNative.Network.V20190801.Inputs.NatGatewaySkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ///     });
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190801:NatGateway")]
    public partial class NatGateway : global::Pulumi.CustomResource
    {
        ...
        public NatGateway(string name, NatGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:NatGateway", name, args ?? new NatGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:NatGateway", name, null, MakeResourceOptions(options, id))
        {
        }
