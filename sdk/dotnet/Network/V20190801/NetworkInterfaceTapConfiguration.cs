...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    [AzureNativeResourceType("azure-native:network/v20190801:NetworkInterfaceTapConfiguration")]
    public partial class NetworkInterfaceTapConfiguration : global::Pulumi.CustomResource
    {
        ...
        public NetworkInterfaceTapConfiguration(string name, NetworkInterfaceTapConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:NetworkInterfaceTapConfiguration", name, args ?? new NetworkInterfaceTapConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterfaceTapConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:NetworkInterfaceTapConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
