...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// {
    ///     var expressRouteCrossConnectionPeering = new AzureNative.Network.V20190801.ExpressRouteCrossConnectionPeering("expressRouteCrossConnectionPeering", new()
    ///     {
    ///         CrossConnectionName = "&lt;circuitServiceKey&gt;",
    ///         Ipv6PeeringConfig = new AzureNative.Network.V20190801.Inputs.Ipv6ExpressRouteCircuitPeeringConfigArgs
    ///         {
