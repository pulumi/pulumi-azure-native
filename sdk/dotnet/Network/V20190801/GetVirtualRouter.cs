...
namespace Pulumi.AzureRM.Network.V20190801
{
    public static class GetVirtualRouter
    {
        public static Task<GetVirtualRouterResult> InvokeAsync(GetVirtualRouterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualRouterResult>("azurerm:network/v20190801:getVirtualRouter", args ?? new GetVirtualRouterArgs(), options.WithVersion());
    }
