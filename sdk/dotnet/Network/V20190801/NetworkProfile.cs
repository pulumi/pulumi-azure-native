...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// {
    ///     var networkProfile = new AzureNative.Network.V20190801.NetworkProfile("networkProfile", new()
    ///     {
    ///         ContainerNetworkInterfaceConfigurations = new[]
    ///         {
    ///             new AzureNative.Network.V20190801.Inputs.ContainerNetworkInterfaceConfigurationArgs
    ///             {
    ///                 IpConfigurations = new[]
    ///                 {
    ///                     new AzureNative.Network.V20190801.Inputs.IPConfigurationProfileArgs
    ///                     {
    ///                         Name = "ipconfig1",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190801:NetworkProfile")]
    public partial class NetworkProfile : global::Pulumi.CustomResource
    {
        ...
        public NetworkProfile(string name, NetworkProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:NetworkProfile", name, args ?? new NetworkProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:NetworkProfile", name, null, MakeResourceOptions(options, id))
        {
        }
