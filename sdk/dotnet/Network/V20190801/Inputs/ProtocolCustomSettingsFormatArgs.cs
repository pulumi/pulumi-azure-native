...
namespace Pulumi.AzureNative.Network.V20190801.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190801.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20190801.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
