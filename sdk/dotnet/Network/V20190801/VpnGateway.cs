...
namespace Pulumi.AzureRM.Network.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnGateway = new AzureRM.Network.V20190801.VpnGateway("vpnGateway", new AzureRM.Network.V20190801.VpnGatewayArgs
    ///         {
    ...
    ///             Connections = 
    ///             {
    ///                 new AzureRM.Network.V20190801.Inputs.VpnConnectionArgs
    ///                 {
    ///                     Name = "vpnConnection1",
    ///                 },
    ///             },
    ...
    ///                 { "key1", "value1" },
    ///             },
    ///             VirtualHub = new AzureRM.Network.V20190801.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class VpnGateway : Pulumi.CustomResource
    {
        ...
        public VpnGateway(string name, VpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190801:VpnGateway", name, args ?? new VpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190801:VpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
