...
{
    [Obsolete(@"azure-native:network/v20190801:AzureFirewall is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200401:AzureFirewall to guarantee forwards compatibility.")]
    public static class GetAzureFirewall
    {
        ...
        public static Task<GetAzureFirewallResult> InvokeAsync(GetAzureFirewallArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAzureFirewallResult>("azure-native:network/v20190801:getAzureFirewall", args ?? new GetAzureFirewallArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified Azure Firewall.
        /// </summary>
        public static Output<GetAzureFirewallResult> Invoke(GetAzureFirewallInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAzureFirewallResult>("azure-native:network/v20190801:getAzureFirewall", args ?? new GetAzureFirewallInvokeArgs(), options.WithDefaults());
    }
