...
namespace Pulumi.AzureRM.Network.V20190801
{
    public static class GetAzureFirewall
    {
        public static Task<GetAzureFirewallResult> InvokeAsync(GetAzureFirewallArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAzureFirewallResult>("azurerm:network/v20190801:getAzureFirewall", args ?? new GetAzureFirewallArgs(), options.WithVersion());
    }
