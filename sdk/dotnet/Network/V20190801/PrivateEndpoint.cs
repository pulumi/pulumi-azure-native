...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190801:PrivateEndpoint")]
    public partial class PrivateEndpoint : Pulumi.CustomResource
    {
        ...
        public PrivateEndpoint(string name, PrivateEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:PrivateEndpoint", name, args ?? new PrivateEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:PrivateEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
