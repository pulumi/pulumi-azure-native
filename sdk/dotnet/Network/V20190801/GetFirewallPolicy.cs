...
namespace Pulumi.AzureRM.Network.V20190801
{
    public static class GetFirewallPolicy
    {
        public static Task<GetFirewallPolicyResult> InvokeAsync(GetFirewallPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallPolicyResult>("azurerm:network/v20190801:getFirewallPolicy", args ?? new GetFirewallPolicyArgs(), options.WithVersion());
    }
