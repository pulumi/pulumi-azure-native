...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// {
    ///     var expressRoutePort = new AzureNative.Network.V20190801.ExpressRoutePort("expressRoutePort", new()
    ///     {
    ///         BandwidthInGbps = 100,
    ///         Encapsulation = "QinQ",
    ...
    ///         Links = new[]
    ///         {
    ///             new AzureNative.Network.V20190801.Inputs.ExpressRouteLinkArgs
    ///             {
    ///                 AdminState = "Enabled",
    ///                 Name = "link1",
    ///             },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190801:ExpressRoutePort")]
    public partial class ExpressRoutePort : global::Pulumi.CustomResource
    {
        ...
        public ExpressRoutePort(string name, ExpressRoutePortArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:ExpressRoutePort", name, args ?? new ExpressRoutePortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRoutePort(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:ExpressRoutePort", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRoutePortArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("encapsulation")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190801.ExpressRoutePortsEncapsulation>? Encapsulation { get; set; }
