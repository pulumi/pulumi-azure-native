...
namespace Pulumi.AzureNative.Network.V20190801
{
    ...
    /// {
    ///     var networkInterface = new AzureNative.Network.V20190801.NetworkInterface("networkInterface", new()
    ///     {
    ///         EnableAcceleratedNetworking = true,
    ///         IpConfigurations = new[]
    ///         {
    ///             new AzureNative.Network.V20190801.Inputs.NetworkInterfaceIPConfigurationArgs
    ///             {
    ///                 Name = "ipconfig1",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190801:NetworkInterface")]
    public partial class NetworkInterface : global::Pulumi.CustomResource
    {
        ...
        public NetworkInterface(string name, NetworkInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:NetworkInterface", name, args ?? new NetworkInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190801:NetworkInterface", name, null, MakeResourceOptions(options, id))
        {
        }
