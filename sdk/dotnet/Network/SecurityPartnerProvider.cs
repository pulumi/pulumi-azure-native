...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class SecurityPartnerProvider : Pulumi.CustomResource
    {
        ...
        public SecurityPartnerProvider(string name, SecurityPartnerProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:SecurityPartnerProvider", name, args ?? new SecurityPartnerProviderArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private SecurityPartnerProvider(string name, Input<string> id, SecurityPartnerProviderState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:SecurityPartnerProvider", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityPartnerProviderState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A unique read-only string that changes whenever the resource is updated.
        /// </summary>
        ...
        public Input<Inputs.SecurityPartnerProviderPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
