...
namespace Pulumi.AzureNative.Network.V20200101
{
    ...
    [AzureNativeResourceType("azure-native:network/v20200101:VirtualNetworkLink")]
    public partial class VirtualNetworkLink : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkLink(string name, VirtualNetworkLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200101:VirtualNetworkLink", name, args ?? new VirtualNetworkLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200101:VirtualNetworkLink", name, null, MakeResourceOptions(options, id))
        {
        }
