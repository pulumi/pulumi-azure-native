...
namespace Pulumi.AzureRM.Network.V20200101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var rulesEngine = new AzureRM.Network.V20200101.RulesEngine("rulesEngine", new AzureRM.Network.V20200101.RulesEngineArgs
    ///         {
    ///             FrontDoorName = "frontDoor1",
    ///             ResourceGroupName = "rg1",
    ///             Rules = 
    ///             {
    ///                 new AzureRM.Network.V20200101.Inputs.RulesEngineRuleArgs
    ///                 {
    ///                     Action = new AzureRM.Network.V20200101.Inputs.RulesEngineActionArgs
    ///                     {
    ...
    ///                     MatchConditions = 
    ///                     {
    ///                         new AzureRM.Network.V20200101.Inputs.RulesEngineMatchConditionArgs
    ///                         {
    ...
    ///                         {
    ///                             new AzureRM.Network.V20200101.Inputs.HeaderActionArgs
    ///                             {
    ...
    ///                             { "backendPool", new AzureRM.Network.V20200101.Inputs.SubResourceArgs
    ///                             {
    ///                                 Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoors/frontDoor1/backendPools/backendPool1",
    ///                             } },
    ///                             { "cacheConfiguration", new AzureRM.Network.V20200101.Inputs.CacheConfigurationArgs
    ///                             {
    ...
    public partial class RulesEngine : Pulumi.CustomResource
    {
        ...
        public RulesEngine(string name, RulesEngineArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200101:RulesEngine", name, args ?? new RulesEngineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RulesEngine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200101:RulesEngine", name, null, MakeResourceOptions(options, id))
        {
        }
