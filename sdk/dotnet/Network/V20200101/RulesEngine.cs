...
namespace Pulumi.AzureNextGen.Network.V20200101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200101:RulesEngine")]
    public partial class RulesEngine : Pulumi.CustomResource
    {
        ...
        public RulesEngine(string name, RulesEngineArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200101:RulesEngine", name, args ?? new RulesEngineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RulesEngine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200101:RulesEngine", name, null, MakeResourceOptions(options, id))
        {
        }
