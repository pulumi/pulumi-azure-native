...
namespace Pulumi.AzureRM.Network.V20200101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var frontDoor = new AzureRM.Network.V20200101.FrontDoor("frontDoor", new AzureRM.Network.V20200101.FrontDoorArgs
    ///         {
    ///             BackendPools = 
    ///             {
    ///                 new AzureRM.Network.V20200101.Inputs.BackendPoolArgs
    ///                 {
    ///                     Name = "backendPool1",
    ///                 },
    ///             },
    ///             BackendPoolsSettings = new AzureRM.Network.V20200101.Inputs.BackendPoolsSettingsArgs
    ///             {
    ...
    ///             FrontendEndpoints = 
    ///             {
    ///                 new AzureRM.Network.V20200101.Inputs.FrontendEndpointArgs
    ///                 {
    ...
    ///             HealthProbeSettings = 
    ///             {
    ///                 new AzureRM.Network.V20200101.Inputs.HealthProbeSettingsModelArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Network.V20200101.Inputs.LoadBalancingSettingsModelArgs
    ///                 {
    ...
    ///             RoutingRules = 
    ///             {
    ///                 new AzureRM.Network.V20200101.Inputs.RoutingRuleArgs
    ///                 {
    ///                     Name = "routingRule1",
    ///                 },
    ///             },
    ...
    public partial class FrontDoor : Pulumi.CustomResource
    {
        ...
        public FrontDoor(string name, FrontDoorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200101:FrontDoor", name, args ?? new FrontDoorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FrontDoor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200101:FrontDoor", name, null, MakeResourceOptions(options, id))
        {
        }
