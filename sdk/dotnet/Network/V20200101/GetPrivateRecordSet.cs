...
namespace Pulumi.AzureNative.Network.V20200101
{
    public static class GetPrivateRecordSet
    {
        ...
        public static Task<GetPrivateRecordSetResult> InvokeAsync(GetPrivateRecordSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateRecordSetResult>("azure-native:network/v20200101:getPrivateRecordSet", args ?? new GetPrivateRecordSetArgs(), options.WithVersion());

        /// <summary>
        /// Describes a DNS record set (a collection of DNS records with the same name and type) in a Private DNS zone.
        /// </summary>
        public static Output<GetPrivateRecordSetResult> Invoke(GetPrivateRecordSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPrivateRecordSetResult>("azure-native:network/v20200101:getPrivateRecordSet", args ?? new GetPrivateRecordSetInvokeArgs(), options.WithVersion());
    }
