...
namespace Pulumi.AzureNextGen.Network.V20200101.Inputs
{
    ...
    public sealed class RedirectConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200101.FrontDoorRedirectProtocol>? RedirectProtocol { get; set; }

        /// <summary>
        /// The redirect type the rule will use when redirecting traffic.
        /// </summary>
        [Input("redirectType")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200101.FrontDoorRedirectType>? RedirectType { get; set; }
