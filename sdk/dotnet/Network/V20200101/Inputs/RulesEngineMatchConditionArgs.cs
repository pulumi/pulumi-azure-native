...
namespace Pulumi.AzureNextGen.Network.V20200101.Inputs
{
    ...
    public sealed class RulesEngineMatchConditionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200101.RulesEngineMatchVariable> RulesEngineMatchVariable { get; set; } = null!;

        /// <summary>
        /// Describes operator to apply to the match condition.
        /// </summary>
        [Input("rulesEngineOperator", required: true)]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200101.RulesEngineOperator> RulesEngineOperator { get; set; } = null!;
        ...
        [Input("transforms")]
        private InputList<Union<string, Pulumi.AzureNextGen.Network.V20200101.Transform>>? _transforms;

        /// <summary>
        /// List of transforms
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.Network.V20200101.Transform>> Transforms
        {
            get => _transforms ?? (_transforms = new InputList<Union<string, Pulumi.AzureNextGen.Network.V20200101.Transform>>());
