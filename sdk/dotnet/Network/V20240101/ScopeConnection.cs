...
namespace Pulumi.AzureNative.Network.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240101:ScopeConnection")]
    public partial class ScopeConnection : global::Pulumi.CustomResource
    {
        ...
        public ScopeConnection(string name, ScopeConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:ScopeConnection", name, args ?? new ScopeConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:ScopeConnection", name, null, MakeResourceOptions(options, id))
        {
        }
