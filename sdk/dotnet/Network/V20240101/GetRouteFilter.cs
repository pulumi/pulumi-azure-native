...
namespace Pulumi.AzureNative.Network.V20240101
{
    public static class GetRouteFilter
    {
        ...
        public static Task<GetRouteFilterResult> InvokeAsync(GetRouteFilterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRouteFilterResult>("azure-native:network/v20240101:getRouteFilter", args ?? new GetRouteFilterArgs(), options.WithDefaults());
