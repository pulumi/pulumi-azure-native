...
namespace Pulumi.AzureNative.Network.V20240101
{
    public static class GetNatRule
    {
        ...
        public static Task<GetNatRuleResult> InvokeAsync(GetNatRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNatRuleResult>("azure-native:network/v20240101:getNatRule", args ?? new GetNatRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the details of a nat ruleGet.
        /// </summary>
        public static Output<GetNatRuleResult> Invoke(GetNatRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNatRuleResult>("azure-native:network/v20240101:getNatRule", args ?? new GetNatRuleInvokeArgs(), options.WithDefaults());
    }
