...
namespace Pulumi.AzureNative.Network.V20240101.Inputs
{
    ...
    public sealed class MatchConditionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240101.WebApplicationFirewallOperator> Operator { get; set; } = null!;

        [Input("transforms")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20240101.WebApplicationFirewallTransform>>? _transforms;

        /// <summary>
        /// List of transforms.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20240101.WebApplicationFirewallTransform>> Transforms
        {
            get => _transforms ?? (_transforms = new InputList<Union<string, Pulumi.AzureNative.Network.V20240101.WebApplicationFirewallTransform>>());
