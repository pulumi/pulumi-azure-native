...
namespace Pulumi.AzureNative.Network.V20240101
{
    public static class GetAzureFirewall
    {
        ...
        public static Task<GetAzureFirewallResult> InvokeAsync(GetAzureFirewallArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAzureFirewallResult>("azure-native:network/v20240101:getAzureFirewall", args ?? new GetAzureFirewallArgs(), options.WithDefaults());
