...
namespace Pulumi.AzureNative.Network.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240101:FirewallPolicyRuleCollectionGroupDraft")]
    public partial class FirewallPolicyRuleCollectionGroupDraft : global::Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleCollectionGroupDraft(string name, FirewallPolicyRuleCollectionGroupDraftArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:FirewallPolicyRuleCollectionGroupDraft", name, args ?? new FirewallPolicyRuleCollectionGroupDraftArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleCollectionGroupDraft(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:FirewallPolicyRuleCollectionGroupDraft", name, null, MakeResourceOptions(options, id))
        {
        }
