...
namespace Pulumi.AzureNative.Network.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240101:VirtualHubBgpConnection")]
    public partial class VirtualHubBgpConnection : global::Pulumi.CustomResource
    {
        ...
        public VirtualHubBgpConnection(string name, VirtualHubBgpConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:VirtualHubBgpConnection", name, args ?? new VirtualHubBgpConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubBgpConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:VirtualHubBgpConnection", name, null, MakeResourceOptions(options, id))
        {
        }
