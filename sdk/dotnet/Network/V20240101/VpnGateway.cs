...
namespace Pulumi.AzureNative.Network.V20240101
{
    ...
    /// VpnGateway Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240101:VpnGateway")]
    public partial class VpnGateway : global::Pulumi.CustomResource
    {
        ...
        public VpnGateway(string name, VpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:VpnGateway", name, args ?? new VpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:VpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
