...
namespace Pulumi.AzureNative.Network.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240101:VirtualNetworkPeering")]
    public partial class VirtualNetworkPeering : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkPeering(string name, VirtualNetworkPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:VirtualNetworkPeering", name, args ?? new VirtualNetworkPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:VirtualNetworkPeering", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkPeeringArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("peeringState")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240101.VirtualNetworkPeeringState>? PeeringState { get; set; }

        /// <summary>
        /// The peering sync status of the virtual network peering.
        /// </summary>
        [Input("peeringSyncLevel")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240101.VirtualNetworkPeeringLevel>? PeeringSyncLevel { get; set; }
