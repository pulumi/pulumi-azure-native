...
namespace Pulumi.AzureNative.Network.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240101:VirtualNetworkGateway")]
    public partial class VirtualNetworkGateway : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGateway(string name, VirtualNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:VirtualNetworkGateway", name, args ?? new VirtualNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:VirtualNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkGatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("adminState")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240101.AdminState>? AdminState { get; set; }
        ...
        /// </summary>
        [Input("gatewayType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240101.VirtualNetworkGatewayType>? GatewayType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240101.VpnGatewayGeneration>? VpnGatewayGeneration { get; set; }

        /// <summary>
        /// The type of this virtual network gateway.
        /// </summary>
        [Input("vpnType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240101.VpnType>? VpnType { get; set; }
