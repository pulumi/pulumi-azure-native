...
namespace Pulumi.AzureNative.Network.V20240101
{
    public static class GetVirtualNetworkGatewayVpnProfilePackageUrl
    {
        ...
        public static Task<GetVirtualNetworkGatewayVpnProfilePackageUrlResult> InvokeAsync(GetVirtualNetworkGatewayVpnProfilePackageUrlArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkGatewayVpnProfilePackageUrlResult>("azure-native:network/v20240101:getVirtualNetworkGatewayVpnProfilePackageUrl", args ?? new GetVirtualNetworkGatewayVpnProfilePackageUrlArgs(), options.WithDefaults());
