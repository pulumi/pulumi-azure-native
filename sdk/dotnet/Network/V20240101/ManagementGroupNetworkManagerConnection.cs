...
namespace Pulumi.AzureNative.Network.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240101:ManagementGroupNetworkManagerConnection")]
    public partial class ManagementGroupNetworkManagerConnection : global::Pulumi.CustomResource
    {
        ...
        public ManagementGroupNetworkManagerConnection(string name, ManagementGroupNetworkManagerConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:ManagementGroupNetworkManagerConnection", name, args ?? new ManagementGroupNetworkManagerConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroupNetworkManagerConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101:ManagementGroupNetworkManagerConnection", name, null, MakeResourceOptions(options, id))
        {
        }
