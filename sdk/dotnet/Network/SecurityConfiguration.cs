...
namespace Pulumi.AzureNative.Network
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network:SecurityConfiguration")]
    public partial class SecurityConfiguration : Pulumi.CustomResource
    {
        ...
        public SecurityConfiguration(string name, SecurityConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network:SecurityConfiguration", name, args ?? new SecurityConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network:SecurityConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:network/v20210201preview:SecurityConfiguration"},
