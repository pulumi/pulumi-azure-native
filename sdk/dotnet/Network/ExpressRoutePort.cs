...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class ExpressRoutePort : Pulumi.CustomResource
    {
        ...
        public ExpressRoutePort(string name, ExpressRoutePortArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:ExpressRoutePort", name, args ?? new ExpressRoutePortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRoutePort(string name, Input<string> id, ExpressRoutePortState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:ExpressRoutePort", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRoutePortState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ExpressRoutePortPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
