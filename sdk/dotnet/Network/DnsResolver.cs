...
namespace Pulumi.AzureNative.Network
{
    ...
    public partial class DnsResolver : Pulumi.CustomResource
    {
        ...
        public DnsResolver(string name, DnsResolverArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network:DnsResolver", name, args ?? new DnsResolverArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsResolver(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network:DnsResolver", name, null, MakeResourceOptions(options, id))
        {
        }
