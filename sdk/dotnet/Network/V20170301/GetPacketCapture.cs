...
namespace Pulumi.AzureNextGen.Network.V20170301
{
    public static class GetPacketCapture
    {
        public static Task<GetPacketCaptureResult> InvokeAsync(GetPacketCaptureArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPacketCaptureResult>("azure-nextgen:network/v20170301:getPacketCapture", args ?? new GetPacketCaptureArgs(), options.WithVersion());
    }
