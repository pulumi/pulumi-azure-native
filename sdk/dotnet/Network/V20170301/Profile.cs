...
namespace Pulumi.AzureNative.Network.V20170301
{
    ...
    [AzureNativeResourceType("azure-native:network/v20170301:Profile")]
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170301:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170301:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
