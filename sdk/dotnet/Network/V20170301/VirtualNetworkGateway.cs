...
namespace Pulumi.AzureNextGen.Network.V20170301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20170301:VirtualNetworkGateway")]
    public partial class VirtualNetworkGateway : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGateway(string name, VirtualNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20170301:VirtualNetworkGateway", name, args ?? new VirtualNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20170301:VirtualNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkGatewayArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("gatewayType")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170301.VirtualNetworkGatewayType>? GatewayType { get; set; }
        ...
        /// </summary>
        [Input("vpnType")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170301.VpnType>? VpnType { get; set; }
