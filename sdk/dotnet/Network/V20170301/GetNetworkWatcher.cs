...
namespace Pulumi.AzureRM.Network.V20170301
{
    public static class GetNetworkWatcher
    {
        public static Task<GetNetworkWatcherResult> InvokeAsync(GetNetworkWatcherArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkWatcherResult>("azurerm:network/v20170301:getNetworkWatcher", args ?? new GetNetworkWatcherArgs(), options.WithVersion());
    }
