...
namespace Pulumi.AzureNextGen.Network.V20170301.Inputs
{
    ...
    public sealed class ExpressRouteCircuitSkuArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("family")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170301.ExpressRouteCircuitSkuFamily>? Family { get; set; }
        ...
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170301.ExpressRouteCircuitSkuTier>? Tier { get; set; }
