...
namespace Pulumi.AzureNative.Network.V20191201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20191201:VirtualHubRouteTableV2 is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHubRouteTableV2 to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20191201:VirtualHubRouteTableV2")]
    public partial class VirtualHubRouteTableV2 : global::Pulumi.CustomResource
    {
        ...
        public VirtualHubRouteTableV2(string name, VirtualHubRouteTableV2Args args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191201:VirtualHubRouteTableV2", name, args ?? new VirtualHubRouteTableV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubRouteTableV2(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191201:VirtualHubRouteTableV2", name, null, MakeResourceOptions(options, id))
        {
        }
