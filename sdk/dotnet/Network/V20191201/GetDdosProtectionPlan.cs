...
namespace Pulumi.AzureNative.Network.V20191201
{
    ...
    public static class GetDdosProtectionPlan
    {
        ...
        public static Task<GetDdosProtectionPlanResult> InvokeAsync(GetDdosProtectionPlanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDdosProtectionPlanResult>("azure-native:network/v20191201:getDdosProtectionPlan", args ?? new GetDdosProtectionPlanArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about the specified DDoS protection plan.
        /// </summary>
        public static Output<GetDdosProtectionPlanResult> Invoke(GetDdosProtectionPlanInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDdosProtectionPlanResult>("azure-native:network/v20191201:getDdosProtectionPlan", args ?? new GetDdosProtectionPlanInvokeArgs(), options.WithDefaults());
    }
