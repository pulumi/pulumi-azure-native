...
namespace Pulumi.AzureNextGen.Network.V20191201
{
    public static class GetFirewallPolicy
    {
        public static Task<GetFirewallPolicyResult> InvokeAsync(GetFirewallPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallPolicyResult>("azure-nextgen:network/v20191201:getFirewallPolicy", args ?? new GetFirewallPolicyArgs(), options.WithVersion());
    }
    ...
    public sealed class GetFirewallPolicyResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.SubResourceInvokeResponseResult> RuleGroups;
        /// <summary>
        /// Resource tags.
        /// </summary>
        ...
        private GetFirewallPolicyResult(
            ...
            ImmutableArray<Outputs.SubResourceInvokeResponseResult> ruleGroups,
