...
namespace Pulumi.AzureNextGen.Network.V20191201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20191201:NetworkInterfaceTapConfiguration")]
    public partial class NetworkInterfaceTapConfiguration : Pulumi.CustomResource
    {
        ...
        public NetworkInterfaceTapConfiguration(string name, NetworkInterfaceTapConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20191201:NetworkInterfaceTapConfiguration", name, args ?? new NetworkInterfaceTapConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterfaceTapConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20191201:NetworkInterfaceTapConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
