...
namespace Pulumi.AzureRM.Network.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var firewallPolicyRuleGroup = new AzureRM.Network.V20191201.FirewallPolicyRuleGroup("firewallPolicyRuleGroup", new AzureRM.Network.V20191201.FirewallPolicyRuleGroupArgs
    ///         {
    ...
    ///                 
    ///                 {
    ///                     { "action", new AzureRM.Network.V20191201.Inputs.FirewallPolicyNatRuleActionArgs
    ///                     {
    ///                         Type = "Deny",
    ///                     } },
    ...
    public partial class FirewallPolicyRuleGroup : Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleGroup(string name, FirewallPolicyRuleGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:FirewallPolicyRuleGroup", name, args ?? new FirewallPolicyRuleGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:FirewallPolicyRuleGroup", name, null, MakeResourceOptions(options, id))
        {
        }
