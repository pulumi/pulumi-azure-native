...
namespace Pulumi.AzureRM.Network.V20191201
{
    public static class GetPublicIPPrefix
    {
        public static Task<GetPublicIPPrefixResult> InvokeAsync(GetPublicIPPrefixArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPublicIPPrefixResult>("azurerm:network/v20191201:getPublicIPPrefix", args ?? new GetPublicIPPrefixArgs(), options.WithVersion());
    }
