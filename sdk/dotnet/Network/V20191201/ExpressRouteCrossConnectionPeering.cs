...
namespace Pulumi.AzureNextGen.Network.V20191201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20191201:ExpressRouteCrossConnectionPeering")]
    public partial class ExpressRouteCrossConnectionPeering : Pulumi.CustomResource
    {
        ...
        public ExpressRouteCrossConnectionPeering(string name, ExpressRouteCrossConnectionPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20191201:ExpressRouteCrossConnectionPeering", name, args ?? new ExpressRouteCrossConnectionPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCrossConnectionPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20191201:ExpressRouteCrossConnectionPeering", name, null, MakeResourceOptions(options, id))
        {
        }
