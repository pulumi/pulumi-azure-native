...
namespace Pulumi.AzureNative.Network.V20191201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20191201:NetworkInterface")]
    public partial class NetworkInterface : global::Pulumi.CustomResource
    {
        ...
        public NetworkInterface(string name, NetworkInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191201:NetworkInterface", name, args ?? new NetworkInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191201:NetworkInterface", name, null, MakeResourceOptions(options, id))
        {
        }
