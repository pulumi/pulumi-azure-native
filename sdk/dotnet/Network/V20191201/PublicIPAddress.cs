...
namespace Pulumi.AzureNative.Network.V20191201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20191201:PublicIPAddress is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PublicIPAddress to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20191201:PublicIPAddress")]
    public partial class PublicIPAddress : global::Pulumi.CustomResource
    {
        ...
        public PublicIPAddress(string name, PublicIPAddressArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191201:PublicIPAddress", name, args ?? new PublicIPAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191201:PublicIPAddress", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PublicIPAddressArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20191201.IPVersion>? PublicIPAddressVersion { get; set; }

        /// <summary>
        /// The public IP address allocation method.
        /// </summary>
        [Input("publicIPAllocationMethod")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20191201.IPAllocationMethod>? PublicIPAllocationMethod { get; set; }
