...
namespace Pulumi.AzureNative.Network.V20191201
{
    public static class GetConnectionMonitor
    {
        ...
        public static Task<GetConnectionMonitorResult> InvokeAsync(GetConnectionMonitorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConnectionMonitorResult>("azure-native:network/v20191201:getConnectionMonitor", args ?? new GetConnectionMonitorArgs(), options.WithVersion());

        /// <summary>
        /// Information about the connection monitor.
        /// </summary>
        public static Output<GetConnectionMonitorResult> Invoke(GetConnectionMonitorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetConnectionMonitorResult>("azure-native:network/v20191201:getConnectionMonitor", args ?? new GetConnectionMonitorInvokeArgs(), options.WithVersion());
    }
