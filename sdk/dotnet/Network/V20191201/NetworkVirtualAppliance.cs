...
namespace Pulumi.AzureRM.Network.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var networkVirtualAppliance = new AzureRM.Network.V20191201.NetworkVirtualAppliance("networkVirtualAppliance", new AzureRM.Network.V20191201.NetworkVirtualApplianceArgs
    ///         {
    ...
    ///             },
    ///             Identity = new AzureRM.Network.V20191201.Inputs.ManagedServiceIdentityArgs
    ///             {
    ///                 Type = "UserAssigned",
    ///             },
    ///             Location = "West US",
    ...
    ///             Sku = new AzureRM.Network.V20191201.Inputs.VirtualApplianceSkuPropertiesArgs
    ///             {
    ///                 BundledScaleUnit = "1",
    ...
    ///             VirtualHub = new AzureRM.Network.V20191201.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class NetworkVirtualAppliance : Pulumi.CustomResource
    {
        ...
        public NetworkVirtualAppliance(string name, NetworkVirtualApplianceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:NetworkVirtualAppliance", name, args ?? new NetworkVirtualApplianceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkVirtualAppliance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:NetworkVirtualAppliance", name, null, MakeResourceOptions(options, id))
        {
        }
