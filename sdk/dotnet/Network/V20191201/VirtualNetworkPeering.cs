...
namespace Pulumi.AzureRM.Network.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkPeering = new AzureRM.Network.V20191201.VirtualNetworkPeering("virtualNetworkPeering", new AzureRM.Network.V20191201.VirtualNetworkPeeringArgs
    ///         {
    ///             AllowForwardedTraffic = true,
    ///             AllowGatewayTransit = false,
    ///             AllowVirtualNetworkAccess = true,
    ///             RemoteVirtualNetwork = new AzureRM.Network.V20191201.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class VirtualNetworkPeering : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkPeering(string name, VirtualNetworkPeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:VirtualNetworkPeering", name, args ?? new VirtualNetworkPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:VirtualNetworkPeering", name, null, MakeResourceOptions(options, id))
        {
        }
