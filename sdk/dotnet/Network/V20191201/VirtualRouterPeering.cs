...
namespace Pulumi.AzureRM.Network.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualRouterPeering = new AzureRM.Network.V20191201.VirtualRouterPeering("virtualRouterPeering", new AzureRM.Network.V20191201.VirtualRouterPeeringArgs
    ///         {
    ///             PeerAsn = 20000,
    ///             PeerIp = "192.168.1.5",
    ...
    public partial class VirtualRouterPeering : Pulumi.CustomResource
    {
        ...
        public VirtualRouterPeering(string name, VirtualRouterPeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:VirtualRouterPeering", name, args ?? new VirtualRouterPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouterPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:VirtualRouterPeering", name, null, MakeResourceOptions(options, id))
        {
        }
