...
namespace Pulumi.AzureNextGen.Network.V20191201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20191201:NetworkProfile")]
    public partial class NetworkProfile : Pulumi.CustomResource
    {
        ...
        public NetworkProfile(string name, NetworkProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20191201:NetworkProfile", name, args ?? new NetworkProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20191201:NetworkProfile", name, null, MakeResourceOptions(options, id))
        {
        }
