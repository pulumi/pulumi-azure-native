...
namespace Pulumi.AzureNative.Network.V20191201.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20191201.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20191201.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
