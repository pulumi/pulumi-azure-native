...
namespace Pulumi.AzureNextGen.Network.V20191201.Inputs
{
    ...
    public sealed class AzureFirewallNetworkRuleArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("protocols")]
        private InputList<Union<string, Pulumi.AzureNextGen.Network.V20191201.AzureFirewallNetworkRuleProtocol>>? _protocols;

        /// <summary>
        /// Array of AzureFirewallNetworkRuleProtocols.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.Network.V20191201.AzureFirewallNetworkRuleProtocol>> Protocols
        {
            get => _protocols ?? (_protocols = new InputList<Union<string, Pulumi.AzureNextGen.Network.V20191201.AzureFirewallNetworkRuleProtocol>>());
