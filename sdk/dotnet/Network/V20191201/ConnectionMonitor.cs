...
namespace Pulumi.AzureRM.Network.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var connectionMonitor = new AzureRM.Network.V20191201.ConnectionMonitor("connectionMonitor", new AzureRM.Network.V20191201.ConnectionMonitorArgs
    ///         {
    ///             ConnectionMonitorName = "cm1",
    ///             Destination = new AzureRM.Network.V20191201.Inputs.ConnectionMonitorDestinationArgs
    ///             {
    ///                 Address = "bing.com",
    ///                 Port = 80,
    ///             },
    ...
    ///             Source = new AzureRM.Network.V20191201.Inputs.ConnectionMonitorSourceArgs
    ///             {
    ...
    ///             Endpoints = 
    ///             {
    ///                 new AzureRM.Network.V20191201.Inputs.ConnectionMonitorEndpointArgs
    ///                 {
    ///                     Name = "vm1",
    ...
    ///                 new AzureRM.Network.V20191201.Inputs.ConnectionMonitorEndpointArgs
    ///                 {
    ///                     Filter = new AzureRM.Network.V20191201.Inputs.ConnectionMonitorEndpointFilterArgs
    ///                     {
    ///                         Items = 
    ///                         {
    ///                             new AzureRM.Network.V20191201.Inputs.ConnectionMonitorEndpointFilterItemArgs
    ///                             {
    ///                                 Address = "npmuser",
    ///                                 Type = "AgentAddress",
    ///                             },
    ...
    ///             TestConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20191201.Inputs.ConnectionMonitorTestConfigurationArgs
    ///                 {
    ///                     Name = "testConfig1",
    ///                     Protocol = "Tcp",
    ///                     TcpConfiguration = new AzureRM.Network.V20191201.Inputs.ConnectionMonitorTcpConfigurationArgs
    ///                     {
    ...
    ///             TestGroups = 
    ///             {
    ///                 new AzureRM.Network.V20191201.Inputs.ConnectionMonitorTestGroupArgs
    ///                 {
    ///                     Destinations = 
    ///                     {
    ///                         "bing",
    ...
    public partial class ConnectionMonitor : Pulumi.CustomResource
    {
        ...
        public ConnectionMonitor(string name, ConnectionMonitorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:ConnectionMonitor", name, args ?? new ConnectionMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:ConnectionMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
