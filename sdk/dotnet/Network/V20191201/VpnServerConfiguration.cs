...
namespace Pulumi.AzureNative.Network.V20191201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20191201:VpnServerConfiguration")]
    public partial class VpnServerConfiguration : Pulumi.CustomResource
    {
        ...
        public VpnServerConfiguration(string name, VpnServerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191201:VpnServerConfiguration", name, args ?? new VpnServerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnServerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191201:VpnServerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VpnServerConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.V20191201.VpnAuthenticationType>>? _vpnAuthenticationTypes;

        /// <summary>
        /// VPN authentication types for the VpnServerConfiguration.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20191201.VpnAuthenticationType>> VpnAuthenticationTypes
        {
            get => _vpnAuthenticationTypes ?? (_vpnAuthenticationTypes = new InputList<Union<string, Pulumi.AzureNative.Network.V20191201.VpnAuthenticationType>>());
        ...
        [Input("vpnProtocols")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20191201.VpnGatewayTunnelingProtocol>>? _vpnProtocols;

        /// <summary>
        /// VPN protocols for the VpnServerConfiguration.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20191201.VpnGatewayTunnelingProtocol>> VpnProtocols
        {
            get => _vpnProtocols ?? (_vpnProtocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20191201.VpnGatewayTunnelingProtocol>>());
