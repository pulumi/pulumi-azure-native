...
namespace Pulumi.AzureRM.Network.V20191201
{
    public static class GetVpnConnection
    {
        public static Task<GetVpnConnectionResult> InvokeAsync(GetVpnConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnConnectionResult>("azurerm:network/v20191201:getVpnConnection", args ?? new GetVpnConnectionArgs(), options.WithVersion());
    }
