...
namespace Pulumi.AzureNextGen.Network.V20191201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20191201:ApplicationGateway")]
    public partial class ApplicationGateway : Pulumi.CustomResource
    {
        ...
        public ApplicationGateway(string name, ApplicationGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20191201:ApplicationGateway", name, args ?? new ApplicationGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20191201:ApplicationGateway", name, null, MakeResourceOptions(options, id))
        {
        }
