...
namespace Pulumi.AzureRM.Network.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnConnection = new AzureRM.Network.V20191201.VpnConnection("vpnConnection", new AzureRM.Network.V20191201.VpnConnectionArgs
    ///         {
    ///             ConnectionName = "vpnConnection1",
    ///             GatewayName = "gateway1",
    ///             RemoteVpnSite = new AzureRM.Network.V20191201.Inputs.SubResourceArgs
    ///             {
    ...
    ///             VpnLinkConnections = 
    ///             {
    ///                 new AzureRM.Network.V20191201.Inputs.VpnSiteLinkConnectionArgs
    ///                 {
    ...
    public partial class VpnConnection : Pulumi.CustomResource
    {
        ...
        public VpnConnection(string name, VpnConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:VpnConnection", name, args ?? new VpnConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:VpnConnection", name, null, MakeResourceOptions(options, id))
        {
        }
