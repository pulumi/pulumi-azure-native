...
namespace Pulumi.AzureNative.Network.V20191201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20191201:PrivateEndpoint")]
    public partial class PrivateEndpoint : Pulumi.CustomResource
    {
        ...
        public PrivateEndpoint(string name, PrivateEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191201:PrivateEndpoint", name, args ?? new PrivateEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20191201:PrivateEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20181001:PrivateEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20181101:PrivateEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20181101:PrivateEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20181201:PrivateEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20181201:PrivateEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20190201:PrivateEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20190201:PrivateEndpoint"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20201101:PrivateEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210201:PrivateEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:PrivateEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:PrivateEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:PrivateEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:PrivateEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:PrivateEndpoint"},
                },
            };
