...
namespace Pulumi.AzureRM.Network.V20191201
{
    public static class GetInboundNatRule
    {
        public static Task<GetInboundNatRuleResult> InvokeAsync(GetInboundNatRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInboundNatRuleResult>("azurerm:network/v20191201:getInboundNatRule", args ?? new GetInboundNatRuleArgs(), options.WithVersion());
    }
