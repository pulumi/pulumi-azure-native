...
namespace Pulumi.AzureNative.Network.V20191201
{
    public static class GetVirtualWan
    {
        ...
        public static Task<GetVirtualWanResult> InvokeAsync(GetVirtualWanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualWanResult>("azure-native:network/v20191201:getVirtualWan", args ?? new GetVirtualWanArgs(), options.WithDefaults());

        /// <summary>
        /// VirtualWAN Resource.
        /// </summary>
        public static Output<GetVirtualWanResult> Invoke(GetVirtualWanInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVirtualWanResult>("azure-native:network/v20191201:getVirtualWan", args ?? new GetVirtualWanInvokeArgs(), options.WithDefaults());
    }
