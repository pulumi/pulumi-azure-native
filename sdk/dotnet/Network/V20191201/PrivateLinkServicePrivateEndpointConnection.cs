...
namespace Pulumi.AzureNextGen.Network.V20191201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20191201:PrivateLinkServicePrivateEndpointConnection")]
    public partial class PrivateLinkServicePrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateLinkServicePrivateEndpointConnection(string name, PrivateLinkServicePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20191201:PrivateLinkServicePrivateEndpointConnection", name, args ?? new PrivateLinkServicePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkServicePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20191201:PrivateLinkServicePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
