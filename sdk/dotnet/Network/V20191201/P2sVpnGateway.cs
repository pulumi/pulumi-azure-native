...
namespace Pulumi.AzureRM.Network.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var p2sVpnGateway = new AzureRM.Network.V20191201.P2sVpnGateway("p2sVpnGateway", new AzureRM.Network.V20191201.P2sVpnGatewayArgs
    ///         {
    ///             GatewayName = "p2sVpnGateway1",
    ///             Location = "West US",
    ///             P2SConnectionConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20191201.Inputs.P2SConnectionConfigurationArgs
    ///                 {
    ...
    ///             VpnServerConfiguration = new AzureRM.Network.V20191201.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class P2sVpnGateway : Pulumi.CustomResource
    {
        ...
        public P2sVpnGateway(string name, P2sVpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:P2sVpnGateway", name, args ?? new P2sVpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private P2sVpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20191201:P2sVpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
