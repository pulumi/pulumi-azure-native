...
namespace Pulumi.AzureNative.Network.V20220501
{
    ...
    /// VirtualHub Resource.
    /// </summary>
    [Obsolete(@"azure-native:network/v20220501:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualHub to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20220501:VirtualHub")]
    public partial class VirtualHub : global::Pulumi.CustomResource
    {
        ...
        public VirtualHub(string name, VirtualHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:VirtualHub", name, args ?? new VirtualHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:VirtualHub", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualHubArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220501.HubRoutingPreference>? HubRoutingPreference { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220501.PreferredRoutingGateway>? PreferredRoutingGateway { get; set; }
