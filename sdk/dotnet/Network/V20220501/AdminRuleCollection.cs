...
namespace Pulumi.AzureNative.Network.V20220501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220501:AdminRuleCollection")]
    public partial class AdminRuleCollection : global::Pulumi.CustomResource
    {
        ...
        public AdminRuleCollection(string name, AdminRuleCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:AdminRuleCollection", name, args ?? new AdminRuleCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AdminRuleCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:AdminRuleCollection", name, null, MakeResourceOptions(options, id))
        {
        }
