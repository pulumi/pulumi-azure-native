...
namespace Pulumi.AzureNative.Network.V20220501
{
    ...
    [AzureNativeResourceType("azure-native:network/v20220501:ConfigurationPolicyGroup")]
    public partial class ConfigurationPolicyGroup : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationPolicyGroup(string name, ConfigurationPolicyGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:ConfigurationPolicyGroup", name, args ?? new ConfigurationPolicyGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationPolicyGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:ConfigurationPolicyGroup", name, null, MakeResourceOptions(options, id))
        {
        }
