...
namespace Pulumi.AzureNative.Network.V20220501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220501:AzureFirewall")]
    public partial class AzureFirewall : global::Pulumi.CustomResource
    {
        ...
        public AzureFirewall(string name, AzureFirewallArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:AzureFirewall", name, args ?? new AzureFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureFirewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:AzureFirewall", name, null, MakeResourceOptions(options, id))
        {
        }
