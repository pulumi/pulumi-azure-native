...
namespace Pulumi.AzureNative.Network.V20220501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220501:SubscriptionNetworkManagerConnection")]
    public partial class SubscriptionNetworkManagerConnection : global::Pulumi.CustomResource
    {
        ...
        public SubscriptionNetworkManagerConnection(string name, SubscriptionNetworkManagerConnectionArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:SubscriptionNetworkManagerConnection", name, args ?? new SubscriptionNetworkManagerConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionNetworkManagerConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:SubscriptionNetworkManagerConnection", name, null, MakeResourceOptions(options, id))
        {
        }
