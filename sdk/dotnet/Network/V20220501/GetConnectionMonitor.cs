...
namespace Pulumi.AzureNative.Network.V20220501
{
    ...
    public static class GetConnectionMonitor
    {
        ...
        public static Task<GetConnectionMonitorResult> InvokeAsync(GetConnectionMonitorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectionMonitorResult>("azure-native:network/v20220501:getConnectionMonitor", args ?? new GetConnectionMonitorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a connection monitor by name.
        /// </summary>
        public static Output<GetConnectionMonitorResult> Invoke(GetConnectionMonitorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectionMonitorResult>("azure-native:network/v20220501:getConnectionMonitor", args ?? new GetConnectionMonitorInvokeArgs(), options.WithDefaults());
    }
