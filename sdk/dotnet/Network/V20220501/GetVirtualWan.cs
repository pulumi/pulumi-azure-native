...
{
    [Obsolete(@"azure-native:network/v20220501:VirtualWan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualWan to guarantee forwards compatibility.")]
    public static class GetVirtualWan
    {
        ...
        public static Task<GetVirtualWanResult> InvokeAsync(GetVirtualWanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualWanResult>("azure-native:network/v20220501:getVirtualWan", args ?? new GetVirtualWanArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the details of a VirtualWAN.
        /// </summary>
        public static Output<GetVirtualWanResult> Invoke(GetVirtualWanInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVirtualWanResult>("azure-native:network/v20220501:getVirtualWan", args ?? new GetVirtualWanInvokeArgs(), options.WithDefaults());
    }
