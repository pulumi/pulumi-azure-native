...
{
    [Obsolete(@"azure-native:network/v20220501:ExpressRouteGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteGateway to guarantee forwards compatibility.")]
    public static class GetExpressRouteGateway
    {
        ...
        public static Task<GetExpressRouteGatewayResult> InvokeAsync(GetExpressRouteGatewayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExpressRouteGatewayResult>("azure-native:network/v20220501:getExpressRouteGateway", args ?? new GetExpressRouteGatewayArgs(), options.WithDefaults());
        ...
        public static Output<GetExpressRouteGatewayResult> Invoke(GetExpressRouteGatewayInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExpressRouteGatewayResult>("azure-native:network/v20220501:getExpressRouteGateway", args ?? new GetExpressRouteGatewayInvokeArgs(), options.WithDefaults());
    }
