...
namespace Pulumi.AzureNative.Network.V20220501
{
    ...
    [AzureNativeResourceType("azure-native:network/v20220501:IpGroup")]
    public partial class IpGroup : global::Pulumi.CustomResource
    {
        ...
        public IpGroup(string name, IpGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:IpGroup", name, args ?? new IpGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:IpGroup", name, null, MakeResourceOptions(options, id))
        {
        }
