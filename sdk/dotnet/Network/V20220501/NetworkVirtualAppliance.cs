...
namespace Pulumi.AzureNative.Network.V20220501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220501:NetworkVirtualAppliance is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkVirtualAppliance to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20220501:NetworkVirtualAppliance")]
    public partial class NetworkVirtualAppliance : global::Pulumi.CustomResource
    {
        ...
        public NetworkVirtualAppliance(string name, NetworkVirtualApplianceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:NetworkVirtualAppliance", name, args ?? new NetworkVirtualApplianceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkVirtualAppliance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:NetworkVirtualAppliance", name, null, MakeResourceOptions(options, id))
        {
        }
