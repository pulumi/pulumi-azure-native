...
namespace Pulumi.AzureNative.Network.V20220501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220501:Subnet is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220701:Subnet to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20220501:Subnet")]
    public partial class Subnet : global::Pulumi.CustomResource
    {
        ...
        public Subnet(string name, SubnetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:Subnet", name, args ?? new SubnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:Subnet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SubnetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220501.VirtualNetworkPrivateEndpointNetworkPolicies>? PrivateEndpointNetworkPolicies { get; set; }

        /// <summary>
        /// Enable or Disable apply network policies on private link service in the subnet.
        /// </summary>
        [Input("privateLinkServiceNetworkPolicies")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220501.VirtualNetworkPrivateLinkServiceNetworkPolicies>? PrivateLinkServiceNetworkPolicies { get; set; }
