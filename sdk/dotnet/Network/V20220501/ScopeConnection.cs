...
namespace Pulumi.AzureNative.Network.V20220501
{
    ...
    [AzureNativeResourceType("azure-native:network/v20220501:ScopeConnection")]
    public partial class ScopeConnection : global::Pulumi.CustomResource
    {
        ...
        public ScopeConnection(string name, ScopeConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:ScopeConnection", name, args ?? new ScopeConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220501:ScopeConnection", name, null, MakeResourceOptions(options, id))
        {
        }
