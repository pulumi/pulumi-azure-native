...
namespace Pulumi.AzureNative.Network.V20240601Preview
{
    public static class GetNetworkSecurityPerimeterProfile
    {
        ...
        public static Task<GetNetworkSecurityPerimeterProfileResult> InvokeAsync(GetNetworkSecurityPerimeterProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkSecurityPerimeterProfileResult>("azure-native:network/v20240601preview:getNetworkSecurityPerimeterProfile", args ?? new GetNetworkSecurityPerimeterProfileArgs(), options.WithDefaults());
        ...
        public static Output<GetNetworkSecurityPerimeterProfileResult> Invoke(GetNetworkSecurityPerimeterProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkSecurityPerimeterProfileResult>("azure-native:network/v20240601preview:getNetworkSecurityPerimeterProfile", args ?? new GetNetworkSecurityPerimeterProfileInvokeArgs(), options.WithDefaults());
