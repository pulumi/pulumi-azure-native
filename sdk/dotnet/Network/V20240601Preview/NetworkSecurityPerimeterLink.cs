...
namespace Pulumi.AzureNative.Network.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240601preview:NetworkSecurityPerimeterLink")]
    public partial class NetworkSecurityPerimeterLink : global::Pulumi.CustomResource
    {
        ...
        public NetworkSecurityPerimeterLink(string name, NetworkSecurityPerimeterLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240601preview:NetworkSecurityPerimeterLink", name, args ?? new NetworkSecurityPerimeterLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityPerimeterLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240601preview:NetworkSecurityPerimeterLink", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network:NetworkSecurityPerimeterLink" },
                },
            };
