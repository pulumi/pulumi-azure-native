...
namespace Pulumi.AzureNative.Network.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240601preview:NetworkSecurityPerimeterAccessRule")]
    public partial class NetworkSecurityPerimeterAccessRule : global::Pulumi.CustomResource
    {
        ...
        public NetworkSecurityPerimeterAccessRule(string name, NetworkSecurityPerimeterAccessRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240601preview:NetworkSecurityPerimeterAccessRule", name, args ?? new NetworkSecurityPerimeterAccessRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityPerimeterAccessRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240601preview:NetworkSecurityPerimeterAccessRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network:NetworkSecurityPerimeterAccessRule" },
                },
            };
    ...
    public sealed class NetworkSecurityPerimeterAccessRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240601Preview.AccessRuleDirection>? Direction { get; set; }
