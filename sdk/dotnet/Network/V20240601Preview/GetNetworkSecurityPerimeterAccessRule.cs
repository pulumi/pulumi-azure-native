...
namespace Pulumi.AzureNative.Network.V20240601Preview
{
    public static class GetNetworkSecurityPerimeterAccessRule
    {
        ...
        public static Task<GetNetworkSecurityPerimeterAccessRuleResult> InvokeAsync(GetNetworkSecurityPerimeterAccessRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkSecurityPerimeterAccessRuleResult>("azure-native:network/v20240601preview:getNetworkSecurityPerimeterAccessRule", args ?? new GetNetworkSecurityPerimeterAccessRuleArgs(), options.WithDefaults());
        ...
        public static Output<GetNetworkSecurityPerimeterAccessRuleResult> Invoke(GetNetworkSecurityPerimeterAccessRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkSecurityPerimeterAccessRuleResult>("azure-native:network/v20240601preview:getNetworkSecurityPerimeterAccessRule", args ?? new GetNetworkSecurityPerimeterAccessRuleInvokeArgs(), options.WithDefaults());
