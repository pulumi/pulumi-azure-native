...
namespace Pulumi.AzureNative.Network.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240601preview:NetworkSecurityPerimeterProfile")]
    public partial class NetworkSecurityPerimeterProfile : global::Pulumi.CustomResource
    {
        ...
        public NetworkSecurityPerimeterProfile(string name, NetworkSecurityPerimeterProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240601preview:NetworkSecurityPerimeterProfile", name, args ?? new NetworkSecurityPerimeterProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityPerimeterProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240601preview:NetworkSecurityPerimeterProfile", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network:NetworkSecurityPerimeterProfile" },
                },
            };
