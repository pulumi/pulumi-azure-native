...
namespace Pulumi.AzureRM.Network.V20180701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualWAN = new AzureRM.Network.V20180701.VirtualWAN("virtualWAN", new AzureRM.Network.V20180701.VirtualWANArgs
    ///         {
    ...
    public partial class VirtualWAN : Pulumi.CustomResource
    {
        ...
        public VirtualWAN(string name, VirtualWANArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180701:VirtualWAN", name, args ?? new VirtualWANArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWAN(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180701:VirtualWAN", name, null, MakeResourceOptions(options, id))
        {
        }
