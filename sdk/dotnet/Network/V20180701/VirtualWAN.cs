...
namespace Pulumi.AzureNextGen.Network.V20180701
{
    ...
    public partial class VirtualWAN : Pulumi.CustomResource
    {
        ...
        public VirtualWAN(string name, VirtualWANArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180701:VirtualWAN", name, args ?? new VirtualWANArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWAN(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180701:VirtualWAN", name, null, MakeResourceOptions(options, id))
        {
        }
