...
namespace Pulumi.AzureNative.Network.V20180701
{
    ...
    /// {
    ///     var virtualWAN = new AzureNative.Network.V20180701.VirtualWAN("virtualWAN", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20180701:VirtualWAN wan1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualWANs/wan1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20180701:VirtualWAN")]
    public partial class VirtualWAN : global::Pulumi.CustomResource
    {
        ...
        public VirtualWAN(string name, VirtualWANArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180701:VirtualWAN", name, args ?? new VirtualWANArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWAN(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180701:VirtualWAN", name, null, MakeResourceOptions(options, id))
        {
        }
