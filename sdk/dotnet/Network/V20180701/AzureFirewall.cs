...
namespace Pulumi.AzureRM.Network.V20180701
{
    ...
    public partial class AzureFirewall : Pulumi.CustomResource
    {
        ...
        public AzureFirewall(string name, AzureFirewallArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180701:AzureFirewall", name, args ?? new AzureFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureFirewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180701:AzureFirewall", name, null, MakeResourceOptions(options, id))
        {
        }
