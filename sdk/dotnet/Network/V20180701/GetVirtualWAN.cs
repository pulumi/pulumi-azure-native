...
namespace Pulumi.AzureNative.Network.V20180701
{
    public static class GetVirtualWAN
    {
        ...
        public static Task<GetVirtualWANResult> InvokeAsync(GetVirtualWANArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualWANResult>("azure-native:network/v20180701:getVirtualWAN", args ?? new GetVirtualWANArgs(), options.WithDefaults());

        /// <summary>
        /// VirtualWAN Resource.
        /// </summary>
        public static Output<GetVirtualWANResult> Invoke(GetVirtualWANInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVirtualWANResult>("azure-native:network/v20180701:getVirtualWAN", args ?? new GetVirtualWANInvokeArgs(), options.WithDefaults());
    }
