...
namespace Pulumi.AzureNative.Network.V20180701
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20180701:DdosProtectionPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220501:DdosProtectionPlan to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20180701:DdosProtectionPlan")]
    public partial class DdosProtectionPlan : global::Pulumi.CustomResource
    {
        ...
        public DdosProtectionPlan(string name, DdosProtectionPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180701:DdosProtectionPlan", name, args ?? new DdosProtectionPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DdosProtectionPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180701:DdosProtectionPlan", name, null, MakeResourceOptions(options, id))
        {
        }
