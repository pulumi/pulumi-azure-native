...
namespace Pulumi.AzureRM.Network.V20180701
{
    ...
    public partial class RouteFilter : Pulumi.CustomResource
    {
        ...
        public RouteFilter(string name, RouteFilterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180701:RouteFilter", name, args ?? new RouteFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180701:RouteFilter", name, null, MakeResourceOptions(options, id))
        {
        }
