...
namespace Pulumi.AzureNextGen.Network.V20180701
{
    public static class GetPacketCapture
    {
        public static Task<GetPacketCaptureResult> InvokeAsync(GetPacketCaptureArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPacketCaptureResult>("azure-nextgen:network/v20180701:getPacketCapture", args ?? new GetPacketCaptureArgs(), options.WithVersion());
    }
