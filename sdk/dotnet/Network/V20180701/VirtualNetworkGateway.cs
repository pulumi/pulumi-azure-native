...
namespace Pulumi.AzureRM.Network.V20180701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkGateway = new AzureRM.Network.V20180701.VirtualNetworkGateway("virtualNetworkGateway", new AzureRM.Network.V20180701.VirtualNetworkGatewayArgs
    ///         {
    ///             ActiveActive = false,
    ///             BgpSettings = new AzureRM.Network.V20180701.Inputs.BgpSettingsArgs
    ///             {
    ///                 Asn = 65515,
    ...
    ///             IpConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20180701.Inputs.VirtualNetworkGatewayIPConfigurationArgs
    ///                 {
    ///                     Name = "gwipconfig1",
    ///                 },
    ///             },
    ...
    ///             Sku = new AzureRM.Network.V20180701.Inputs.VirtualNetworkGatewaySkuArgs
    ///             {
    ///                 Name = "VpnGw1",
    ///                 Tier = "VpnGw1",
    ///             },
    ...
    public partial class VirtualNetworkGateway : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGateway(string name, VirtualNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180701:VirtualNetworkGateway", name, args ?? new VirtualNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180701:VirtualNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
