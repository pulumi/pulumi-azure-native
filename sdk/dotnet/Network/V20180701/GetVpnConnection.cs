...
namespace Pulumi.AzureRM.Network.V20180701
{
    public static class GetVpnConnection
    {
        public static Task<GetVpnConnectionResult> InvokeAsync(GetVpnConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnConnectionResult>("azurerm:network/v20180701:getVpnConnection", args ?? new GetVpnConnectionArgs(), options.WithVersion());
    }
