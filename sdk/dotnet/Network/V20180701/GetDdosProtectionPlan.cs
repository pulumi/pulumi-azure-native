...
namespace Pulumi.AzureRM.Network.V20180701
{
    public static class GetDdosProtectionPlan
    {
        public static Task<GetDdosProtectionPlanResult> InvokeAsync(GetDdosProtectionPlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDdosProtectionPlanResult>("azurerm:network/v20180701:getDdosProtectionPlan", args ?? new GetDdosProtectionPlanArgs(), options.WithVersion());
    }
