...
namespace Pulumi.AzureNextGen.Network.V20180701
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20180701:LocalNetworkGateway")]
    public partial class LocalNetworkGateway : Pulumi.CustomResource
    {
        ...
        public LocalNetworkGateway(string name, LocalNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180701:LocalNetworkGateway", name, args ?? new LocalNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180701:LocalNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
