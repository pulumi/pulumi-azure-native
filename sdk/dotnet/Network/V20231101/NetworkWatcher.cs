...
namespace Pulumi.AzureNative.Network.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20231101:NetworkWatcher")]
    public partial class NetworkWatcher : global::Pulumi.CustomResource
    {
        ...
        public NetworkWatcher(string name, NetworkWatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20231101:NetworkWatcher", name, args ?? new NetworkWatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkWatcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20231101:NetworkWatcher", name, null, MakeResourceOptions(options, id))
        {
        }
