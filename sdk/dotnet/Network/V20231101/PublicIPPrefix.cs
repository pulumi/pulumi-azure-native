...
namespace Pulumi.AzureNative.Network.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20231101:PublicIPPrefix")]
    public partial class PublicIPPrefix : global::Pulumi.CustomResource
    {
        ...
        public PublicIPPrefix(string name, PublicIPPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20231101:PublicIPPrefix", name, args ?? new PublicIPPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20231101:PublicIPPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
