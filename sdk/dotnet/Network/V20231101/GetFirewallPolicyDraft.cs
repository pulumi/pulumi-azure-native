...
namespace Pulumi.AzureNative.Network.V20231101
{
    public static class GetFirewallPolicyDraft
    {
        ...
        public static Task<GetFirewallPolicyDraftResult> InvokeAsync(GetFirewallPolicyDraftArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallPolicyDraftResult>("azure-native:network/v20231101:getFirewallPolicyDraft", args ?? new GetFirewallPolicyDraftArgs(), options.WithDefaults());
        ...
        public static Output<GetFirewallPolicyDraftResult> Invoke(GetFirewallPolicyDraftInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirewallPolicyDraftResult>("azure-native:network/v20231101:getFirewallPolicyDraft", args ?? new GetFirewallPolicyDraftInvokeArgs(), options.WithDefaults());
