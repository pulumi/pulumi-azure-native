...
namespace Pulumi.AzureNative.Network.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20231101:NetworkVirtualApplianceConnection")]
    public partial class NetworkVirtualApplianceConnection : global::Pulumi.CustomResource
    {
        ...
        public NetworkVirtualApplianceConnection(string name, NetworkVirtualApplianceConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20231101:NetworkVirtualApplianceConnection", name, args ?? new NetworkVirtualApplianceConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkVirtualApplianceConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20231101:NetworkVirtualApplianceConnection", name, null, MakeResourceOptions(options, id))
        {
        }
