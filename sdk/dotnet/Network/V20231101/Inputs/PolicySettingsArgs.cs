...
namespace Pulumi.AzureNative.Network.V20231101.Inputs
{
    ...
    public sealed class PolicySettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20231101.WebApplicationFirewallMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20231101.WebApplicationFirewallEnabledState>? State { get; set; }
