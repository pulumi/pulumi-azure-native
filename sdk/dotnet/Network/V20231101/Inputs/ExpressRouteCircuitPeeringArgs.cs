...
namespace Pulumi.AzureNative.Network.V20231101.Inputs
{
    ...
    public sealed class ExpressRouteCircuitPeeringArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("peeringType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20231101.ExpressRoutePeeringType>? PeeringType { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20231101.ExpressRoutePeeringState>? State { get; set; }
