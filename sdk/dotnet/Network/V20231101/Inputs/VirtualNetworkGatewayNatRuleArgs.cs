...
namespace Pulumi.AzureNative.Network.V20231101.Inputs
{
    ...
    public sealed class VirtualNetworkGatewayNatRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20231101.VpnNatRuleMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20231101.VpnNatRuleType>? Type { get; set; }
