...
namespace Pulumi.AzureNative.Network.V20231101
{
    public static class GetVirtualWan
    {
        ...
        public static Task<GetVirtualWanResult> InvokeAsync(GetVirtualWanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualWanResult>("azure-native:network/v20231101:getVirtualWan", args ?? new GetVirtualWanArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the details of a VirtualWAN.
        /// </summary>
        public static Output<GetVirtualWanResult> Invoke(GetVirtualWanInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVirtualWanResult>("azure-native:network/v20231101:getVirtualWan", args ?? new GetVirtualWanInvokeArgs(), options.WithDefaults());
    }
