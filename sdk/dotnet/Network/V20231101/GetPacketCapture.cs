...
namespace Pulumi.AzureNative.Network.V20231101
{
    public static class GetPacketCapture
    {
        ...
        public static Task<GetPacketCaptureResult> InvokeAsync(GetPacketCaptureArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPacketCaptureResult>("azure-native:network/v20231101:getPacketCapture", args ?? new GetPacketCaptureArgs(), options.WithDefaults());
