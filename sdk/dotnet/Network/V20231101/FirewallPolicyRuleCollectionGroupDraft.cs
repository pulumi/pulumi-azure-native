...
namespace Pulumi.AzureNative.Network.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20231101:FirewallPolicyRuleCollectionGroupDraft")]
    public partial class FirewallPolicyRuleCollectionGroupDraft : global::Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleCollectionGroupDraft(string name, FirewallPolicyRuleCollectionGroupDraftArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20231101:FirewallPolicyRuleCollectionGroupDraft", name, args ?? new FirewallPolicyRuleCollectionGroupDraftArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleCollectionGroupDraft(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20231101:FirewallPolicyRuleCollectionGroupDraft", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:network:FirewallPolicyRuleCollectionGroupDraft" },
