...
namespace Pulumi.AzureNative.Network.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20231101:FirewallPolicyDraft")]
    public partial class FirewallPolicyDraft : global::Pulumi.CustomResource
    {
        ...
        public FirewallPolicyDraft(string name, FirewallPolicyDraftArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20231101:FirewallPolicyDraft", name, args ?? new FirewallPolicyDraftArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyDraft(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20231101:FirewallPolicyDraft", name, null, MakeResourceOptions(options, id))
        {
        }
