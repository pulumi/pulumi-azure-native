...
namespace Pulumi.AzureNative.Network.V20231101
{
    public static class GetNetworkGroup
    {
        ...
        public static Task<GetNetworkGroupResult> InvokeAsync(GetNetworkGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkGroupResult>("azure-native:network/v20231101:getNetworkGroup", args ?? new GetNetworkGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified network group.
        /// </summary>
        public static Output<GetNetworkGroupResult> Invoke(GetNetworkGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkGroupResult>("azure-native:network/v20231101:getNetworkGroup", args ?? new GetNetworkGroupInvokeArgs(), options.WithDefaults());
