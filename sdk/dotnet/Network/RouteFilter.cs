...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class RouteFilter : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.RouteFilterPropertiesFormatResponse> Properties { get; private set; } = null!;
        ...
        public RouteFilter(string name, RouteFilterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:RouteFilter", name, args ?? new RouteFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilter(string name, Input<string> id, RouteFilterState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:RouteFilter", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteFilterState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RouteFilterPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
