...
namespace Pulumi.AzureNextGen.Network
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network:PrivateZone")]
    public partial class PrivateZone : Pulumi.CustomResource
    {
        ...
        public PrivateZone(string name, PrivateZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network:PrivateZone", name, args ?? new PrivateZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateZone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network:PrivateZone", name, null, MakeResourceOptions(options, id))
        {
        }
