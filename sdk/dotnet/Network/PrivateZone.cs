...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class PrivateZone : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.PrivateZonePropertiesResponseResult> Properties { get; private set; } = null!;
        ...
        public PrivateZone(string name, PrivateZoneArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:PrivateZone", name, args ?? new PrivateZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateZone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network:PrivateZone", name, null, MakeResourceOptions(options, id))
        {
        }
