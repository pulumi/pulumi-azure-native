...
namespace Pulumi.AzureNative.Network.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230701preview:DnsResolverPolicyVirtualNetworkLink")]
    public partial class DnsResolverPolicyVirtualNetworkLink : global::Pulumi.CustomResource
    {
        ...
        public DnsResolverPolicyVirtualNetworkLink(string name, DnsResolverPolicyVirtualNetworkLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230701preview:DnsResolverPolicyVirtualNetworkLink", name, args ?? new DnsResolverPolicyVirtualNetworkLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsResolverPolicyVirtualNetworkLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230701preview:DnsResolverPolicyVirtualNetworkLink", name, null, MakeResourceOptions(options, id))
        {
        }
