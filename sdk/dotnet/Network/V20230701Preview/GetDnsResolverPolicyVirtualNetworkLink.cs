...
namespace Pulumi.AzureNative.Network.V20230701Preview
{
    public static class GetDnsResolverPolicyVirtualNetworkLink
    {
        ...
        public static Task<GetDnsResolverPolicyVirtualNetworkLinkResult> InvokeAsync(GetDnsResolverPolicyVirtualNetworkLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDnsResolverPolicyVirtualNetworkLinkResult>("azure-native:network/v20230701preview:getDnsResolverPolicyVirtualNetworkLink", args ?? new GetDnsResolverPolicyVirtualNetworkLinkArgs(), options.WithDefaults());
