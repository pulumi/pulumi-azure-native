...
namespace Pulumi.AzureNative.Network.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230701preview:NetworkSecurityPerimeter")]
    public partial class NetworkSecurityPerimeter : global::Pulumi.CustomResource
    {
        ...
        public NetworkSecurityPerimeter(string name, NetworkSecurityPerimeterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230701preview:NetworkSecurityPerimeter", name, args ?? new NetworkSecurityPerimeterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityPerimeter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230701preview:NetworkSecurityPerimeter", name, null, MakeResourceOptions(options, id))
        {
        }
