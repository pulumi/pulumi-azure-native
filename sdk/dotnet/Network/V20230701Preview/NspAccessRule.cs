...
namespace Pulumi.AzureNative.Network.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230701preview:NspAccessRule")]
    public partial class NspAccessRule : global::Pulumi.CustomResource
    {
        ...
        public NspAccessRule(string name, NspAccessRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230701preview:NspAccessRule", name, args ?? new NspAccessRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NspAccessRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230701preview:NspAccessRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NspAccessRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230701Preview.AccessRuleDirection>? Direction { get; set; }
