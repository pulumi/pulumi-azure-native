...
namespace Pulumi.AzureNative.Network.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230701preview:OutboundEndpoint")]
    public partial class OutboundEndpoint : global::Pulumi.CustomResource
    {
        ...
        public OutboundEndpoint(string name, OutboundEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230701preview:OutboundEndpoint", name, args ?? new OutboundEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OutboundEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230701preview:OutboundEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
