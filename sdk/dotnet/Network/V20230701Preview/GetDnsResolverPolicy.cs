...
namespace Pulumi.AzureNative.Network.V20230701Preview
{
    public static class GetDnsResolverPolicy
    {
        ...
        public static Task<GetDnsResolverPolicyResult> InvokeAsync(GetDnsResolverPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDnsResolverPolicyResult>("azure-native:network/v20230701preview:getDnsResolverPolicy", args ?? new GetDnsResolverPolicyArgs(), options.WithDefaults());
