...
namespace Pulumi.AzureNative.Network.V20230701Preview
{
    public static class GetRecordSet
    {
        ...
        public static Task<GetRecordSetResult> InvokeAsync(GetRecordSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRecordSetResult>("azure-native:network/v20230701preview:getRecordSet", args ?? new GetRecordSetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a record set.
        /// </summary>
        public static Output<GetRecordSetResult> Invoke(GetRecordSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRecordSetResult>("azure-native:network/v20230701preview:getRecordSet", args ?? new GetRecordSetInvokeArgs(), options.WithDefaults());
    }
