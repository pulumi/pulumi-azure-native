...
namespace Pulumi.AzureNative.Network.V20230701Preview
{
    public static class GetNspAssociation
    {
        ...
        public static Task<GetNspAssociationResult> InvokeAsync(GetNspAssociationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNspAssociationResult>("azure-native:network/v20230701preview:getNspAssociation", args ?? new GetNspAssociationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified NSP association by name.
        /// </summary>
        public static Output<GetNspAssociationResult> Invoke(GetNspAssociationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNspAssociationResult>("azure-native:network/v20230701preview:getNspAssociation", args ?? new GetNspAssociationInvokeArgs(), options.WithDefaults());
