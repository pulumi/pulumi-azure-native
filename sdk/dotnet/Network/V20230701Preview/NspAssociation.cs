...
namespace Pulumi.AzureNative.Network.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230701preview:NspAssociation")]
    public partial class NspAssociation : global::Pulumi.CustomResource
    {
        ...
        public NspAssociation(string name, NspAssociationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230701preview:NspAssociation", name, args ?? new NspAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NspAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230701preview:NspAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NspAssociationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessMode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230701Preview.AssociationAccessMode>? AccessMode { get; set; }
