...
namespace Pulumi.AzureNative.Network.V20221101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20221101:CustomIPPrefix")]
    public partial class CustomIPPrefix : global::Pulumi.CustomResource
    {
        ...
        public CustomIPPrefix(string name, CustomIPPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20221101:CustomIPPrefix", name, args ?? new CustomIPPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomIPPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20221101:CustomIPPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CustomIPPrefixArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20221101.CommissionedState>? CommissionedState { get; set; }
        ...
        /// </summary>
        [Input("geo")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20221101.Geo>? Geo { get; set; }
        ...
        /// </summary>
        [Input("prefixType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20221101.CustomIpPrefixType>? PrefixType { get; set; }
