...
namespace Pulumi.AzureNative.Network.V20221101
{
    public static class GetVirtualHub
    {
        ...
        public static Task<GetVirtualHubResult> InvokeAsync(GetVirtualHubArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualHubResult>("azure-native:network/v20221101:getVirtualHub", args ?? new GetVirtualHubArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the details of a VirtualHub.
        /// </summary>
        public static Output<GetVirtualHubResult> Invoke(GetVirtualHubInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVirtualHubResult>("azure-native:network/v20221101:getVirtualHub", args ?? new GetVirtualHubInvokeArgs(), options.WithDefaults());
