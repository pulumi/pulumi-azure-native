...
namespace Pulumi.AzureNative.Network.V20221101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20221101:HubVirtualNetworkConnection")]
    public partial class HubVirtualNetworkConnection : global::Pulumi.CustomResource
    {
        ...
        public HubVirtualNetworkConnection(string name, HubVirtualNetworkConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20221101:HubVirtualNetworkConnection", name, args ?? new HubVirtualNetworkConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubVirtualNetworkConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20221101:HubVirtualNetworkConnection", name, null, MakeResourceOptions(options, id))
        {
        }
