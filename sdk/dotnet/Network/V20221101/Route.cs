...
namespace Pulumi.AzureNative.Network.V20221101
{
    ...
    /// Route resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20221101:Route")]
    public partial class Route : global::Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20221101:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20221101:Route", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20221101.RouteNextHopType> NextHopType { get; set; } = null!;
