...
namespace Pulumi.AzureNative.Network.V20221101
{
    public static class GetHubRouteTable
    {
        ...
        public static Task<GetHubRouteTableResult> InvokeAsync(GetHubRouteTableArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHubRouteTableResult>("azure-native:network/v20221101:getHubRouteTable", args ?? new GetHubRouteTableArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the details of a RouteTable.
        /// </summary>
        public static Output<GetHubRouteTableResult> Invoke(GetHubRouteTableInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHubRouteTableResult>("azure-native:network/v20221101:getHubRouteTable", args ?? new GetHubRouteTableInvokeArgs(), options.WithDefaults());
    }
