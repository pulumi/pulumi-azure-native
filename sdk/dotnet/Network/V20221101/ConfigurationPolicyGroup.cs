...
namespace Pulumi.AzureNative.Network.V20221101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20221101:ConfigurationPolicyGroup")]
    public partial class ConfigurationPolicyGroup : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationPolicyGroup(string name, ConfigurationPolicyGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20221101:ConfigurationPolicyGroup", name, args ?? new ConfigurationPolicyGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationPolicyGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20221101:ConfigurationPolicyGroup", name, null, MakeResourceOptions(options, id))
        {
        }
