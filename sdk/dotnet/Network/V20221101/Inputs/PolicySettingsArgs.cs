...
namespace Pulumi.AzureNative.Network.V20221101.Inputs
{
    ...
    public sealed class PolicySettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20221101.WebApplicationFirewallMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20221101.WebApplicationFirewallEnabledState>? State { get; set; }
