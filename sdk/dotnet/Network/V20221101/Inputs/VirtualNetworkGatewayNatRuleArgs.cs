...
namespace Pulumi.AzureNative.Network.V20221101.Inputs
{
    ...
    public sealed class VirtualNetworkGatewayNatRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20221101.VpnNatRuleMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20221101.VpnNatRuleType>? Type { get; set; }
