...
namespace Pulumi.AzureNative.Network.V20221101
{
    public static class GetNetworkWatcher
    {
        ...
        public static Task<GetNetworkWatcherResult> InvokeAsync(GetNetworkWatcherArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkWatcherResult>("azure-native:network/v20221101:getNetworkWatcher", args ?? new GetNetworkWatcherArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified network watcher by resource group.
        /// </summary>
        public static Output<GetNetworkWatcherResult> Invoke(GetNetworkWatcherInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkWatcherResult>("azure-native:network/v20221101:getNetworkWatcher", args ?? new GetNetworkWatcherInvokeArgs(), options.WithDefaults());
    }
