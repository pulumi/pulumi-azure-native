...
namespace Pulumi.AzureNative.Network.V20221101
{
    ...
    /// StaticMember Item.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20221101:StaticMember")]
    public partial class StaticMember : global::Pulumi.CustomResource
    {
        ...
        public StaticMember(string name, StaticMemberArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20221101:StaticMember", name, args ?? new StaticMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20221101:StaticMember", name, null, MakeResourceOptions(options, id))
        {
        }
