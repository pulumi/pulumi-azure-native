...
namespace Pulumi.AzureNative.Network.V20221101
{
    public static class GetNatGateway
    {
        ...
        public static Task<GetNatGatewayResult> InvokeAsync(GetNatGatewayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNatGatewayResult>("azure-native:network/v20221101:getNatGateway", args ?? new GetNatGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified nat gateway in a specified resource group.
        /// </summary>
        public static Output<GetNatGatewayResult> Invoke(GetNatGatewayInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNatGatewayResult>("azure-native:network/v20221101:getNatGateway", args ?? new GetNatGatewayInvokeArgs(), options.WithDefaults());
    }
