...
namespace Pulumi.AzureNative.Network.V20221101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20221101:VirtualNetworkGatewayConnection")]
    public partial class VirtualNetworkGatewayConnection : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGatewayConnection(string name, VirtualNetworkGatewayConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20221101:VirtualNetworkGatewayConnection", name, args ?? new VirtualNetworkGatewayConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGatewayConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20221101:VirtualNetworkGatewayConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkGatewayConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20221101.VirtualNetworkGatewayConnectionMode>? ConnectionMode { get; set; }

        /// <summary>
        /// Connection protocol used for this connection.
        /// </summary>
        [Input("connectionProtocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20221101.VirtualNetworkGatewayConnectionProtocol>? ConnectionProtocol { get; set; }

        /// <summary>
        /// Gateway connection type.
        /// </summary>
        [Input("connectionType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Network.V20221101.VirtualNetworkGatewayConnectionType> ConnectionType { get; set; } = null!;
