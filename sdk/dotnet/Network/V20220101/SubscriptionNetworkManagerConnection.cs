...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    [AzureNativeResourceType("azure-native:network/v20220101:SubscriptionNetworkManagerConnection")]
    public partial class SubscriptionNetworkManagerConnection : global::Pulumi.CustomResource
    {
        ...
        public SubscriptionNetworkManagerConnection(string name, SubscriptionNetworkManagerConnectionArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:SubscriptionNetworkManagerConnection", name, args ?? new SubscriptionNetworkManagerConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionNetworkManagerConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:SubscriptionNetworkManagerConnection", name, null, MakeResourceOptions(options, id))
        {
        }
