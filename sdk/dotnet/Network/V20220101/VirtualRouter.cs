...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    /// {
    ///     var virtualRouter = new AzureNative.Network.V20220101.VirtualRouter("virtualRouter", new()
    ///     {
    ///         HostedGateway = new AzureNative.Network.V20220101.Inputs.SubResourceArgs
    ///         {
