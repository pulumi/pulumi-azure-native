...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    [AzureNativeResourceType("azure-native:network/v20220101:VirtualNetworkTap")]
    public partial class VirtualNetworkTap : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkTap(string name, VirtualNetworkTapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:VirtualNetworkTap", name, args ?? new VirtualNetworkTapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkTap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:VirtualNetworkTap", name, null, MakeResourceOptions(options, id))
        {
        }
