...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220101:HubRouteTable")]
    public partial class HubRouteTable : Pulumi.CustomResource
    {
        ...
        public HubRouteTable(string name, HubRouteTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:HubRouteTable", name, args ?? new HubRouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubRouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:HubRouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
