...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220101:ManagementGroupNetworkManagerConnection")]
    public partial class ManagementGroupNetworkManagerConnection : Pulumi.CustomResource
    {
        ...
        public ManagementGroupNetworkManagerConnection(string name, ManagementGroupNetworkManagerConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:ManagementGroupNetworkManagerConnection", name, args ?? new ManagementGroupNetworkManagerConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroupNetworkManagerConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:ManagementGroupNetworkManagerConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:network/v20220401preview:ManagementGroupNetworkManagerConnection"},
                },
            };
