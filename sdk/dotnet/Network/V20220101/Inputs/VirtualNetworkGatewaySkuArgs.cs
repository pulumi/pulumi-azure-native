...
namespace Pulumi.AzureNative.Network.V20220101.Inputs
{
    ...
    public sealed class VirtualNetworkGatewaySkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.VirtualNetworkGatewaySkuName>? Name { get; set; }

        /// <summary>
        /// Gateway SKU tier.
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.VirtualNetworkGatewaySkuTier>? Tier { get; set; }
