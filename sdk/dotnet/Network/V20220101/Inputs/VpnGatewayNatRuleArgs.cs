...
namespace Pulumi.AzureNative.Network.V20220101.Inputs
{
    ...
    public sealed class VpnGatewayNatRuleArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.VpnNatRuleMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.VpnNatRuleType>? Type { get; set; }
