...
namespace Pulumi.AzureNative.Network.V20220101.Inputs
{
    ...
    public sealed class WebApplicationFirewallCustomRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.WebApplicationFirewallAction> Action { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.WebApplicationFirewallRuleType> RuleType { get; set; } = null!;
