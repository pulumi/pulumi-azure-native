...
namespace Pulumi.AzureNative.Network.V20220101.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
