...
namespace Pulumi.AzureNative.Network.V20220101
{
    public static class GetNetworkManager
    {
        ...
        public static Task<GetNetworkManagerResult> InvokeAsync(GetNetworkManagerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkManagerResult>("azure-native:network/v20220101:getNetworkManager", args ?? new GetNetworkManagerArgs(), options.WithDefaults());

        /// <summary>
        /// The Managed Network resource
        /// </summary>
        public static Output<GetNetworkManagerResult> Invoke(GetNetworkManagerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNetworkManagerResult>("azure-native:network/v20220101:getNetworkManager", args ?? new GetNetworkManagerInvokeArgs(), options.WithDefaults());
    }
