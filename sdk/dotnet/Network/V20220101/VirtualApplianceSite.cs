...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    [AzureNativeResourceType("azure-native:network/v20220101:VirtualApplianceSite")]
    public partial class VirtualApplianceSite : global::Pulumi.CustomResource
    {
        ...
        public VirtualApplianceSite(string name, VirtualApplianceSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:VirtualApplianceSite", name, args ?? new VirtualApplianceSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualApplianceSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:VirtualApplianceSite", name, null, MakeResourceOptions(options, id))
        {
        }
