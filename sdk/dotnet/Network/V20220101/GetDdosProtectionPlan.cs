...
{
    [Obsolete(@"azure-native:network/v20220101:DdosProtectionPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220501:DdosProtectionPlan to guarantee forwards compatibility.")]
    public static class GetDdosProtectionPlan
    {
        ...
        public static Task<GetDdosProtectionPlanResult> InvokeAsync(GetDdosProtectionPlanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDdosProtectionPlanResult>("azure-native:network/v20220101:getDdosProtectionPlan", args ?? new GetDdosProtectionPlanArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about the specified DDoS protection plan.
        /// </summary>
        public static Output<GetDdosProtectionPlanResult> Invoke(GetDdosProtectionPlanInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDdosProtectionPlanResult>("azure-native:network/v20220101:getDdosProtectionPlan", args ?? new GetDdosProtectionPlanInvokeArgs(), options.WithDefaults());
    }
