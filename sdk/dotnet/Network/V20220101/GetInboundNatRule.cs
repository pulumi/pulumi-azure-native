...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    public static class GetInboundNatRule
    {
        ...
        public static Task<GetInboundNatRuleResult> InvokeAsync(GetInboundNatRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInboundNatRuleResult>("azure-native:network/v20220101:getInboundNatRule", args ?? new GetInboundNatRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified load balancer inbound NAT rule.
        /// </summary>
        public static Output<GetInboundNatRuleResult> Invoke(GetInboundNatRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInboundNatRuleResult>("azure-native:network/v20220101:getInboundNatRule", args ?? new GetInboundNatRuleInvokeArgs(), options.WithDefaults());
    }
