...
namespace Pulumi.AzureNative.Network.V20220101
{
    public static class GetScopeConnection
    {
        ...
        public static Task<GetScopeConnectionResult> InvokeAsync(GetScopeConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScopeConnectionResult>("azure-native:network/v20220101:getScopeConnection", args ?? new GetScopeConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// The Scope Connections resource
        /// </summary>
        public static Output<GetScopeConnectionResult> Invoke(GetScopeConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetScopeConnectionResult>("azure-native:network/v20220101:getScopeConnection", args ?? new GetScopeConnectionInvokeArgs(), options.WithDefaults());
    }
