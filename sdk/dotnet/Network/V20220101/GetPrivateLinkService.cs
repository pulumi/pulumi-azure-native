...
namespace Pulumi.AzureNative.Network.V20220101
{
    public static class GetPrivateLinkService
    {
        ...
        public static Task<GetPrivateLinkServiceResult> InvokeAsync(GetPrivateLinkServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateLinkServiceResult>("azure-native:network/v20220101:getPrivateLinkService", args ?? new GetPrivateLinkServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Private link service resource.
        /// </summary>
        public static Output<GetPrivateLinkServiceResult> Invoke(GetPrivateLinkServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPrivateLinkServiceResult>("azure-native:network/v20220101:getPrivateLinkService", args ?? new GetPrivateLinkServiceInvokeArgs(), options.WithDefaults());
    }
