...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    /// {
    ///     var routingIntent = new AzureNative.Network.V20220101.RoutingIntent("routingIntent", new()
    ///     {
    ///         ResourceGroupName = "rg1",
    ///         RoutingIntentName = "Intent1",
    ///         RoutingPolicies = new[]
    ///         {
    ///             new AzureNative.Network.V20220101.Inputs.RoutingPolicyArgs
    ///             {
    ///                 Destinations = new[]
    ///                 {
    ///                     "Internet",
    ...
    public partial class RoutingIntent : global::Pulumi.CustomResource
    {
        ...
        public RoutingIntent(string name, RoutingIntentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:RoutingIntent", name, args ?? new RoutingIntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoutingIntent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:RoutingIntent", name, null, MakeResourceOptions(options, id))
        {
        }
