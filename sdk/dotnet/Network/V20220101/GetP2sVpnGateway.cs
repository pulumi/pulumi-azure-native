...
namespace Pulumi.AzureNative.Network.V20220101
{
    public static class GetP2sVpnGateway
    {
        ...
        public static Task<GetP2sVpnGatewayResult> InvokeAsync(GetP2sVpnGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetP2sVpnGatewayResult>("azure-native:network/v20220101:getP2sVpnGateway", args ?? new GetP2sVpnGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// P2SVpnGateway Resource.
        /// </summary>
        public static Output<GetP2sVpnGatewayResult> Invoke(GetP2sVpnGatewayInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetP2sVpnGatewayResult>("azure-native:network/v20220101:getP2sVpnGateway", args ?? new GetP2sVpnGatewayInvokeArgs(), options.WithDefaults());
    }
