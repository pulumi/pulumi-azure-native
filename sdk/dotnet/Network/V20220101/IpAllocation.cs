...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220101:IpAllocation")]
    public partial class IpAllocation : global::Pulumi.CustomResource
    {
        ...
        public IpAllocation(string name, IpAllocationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:IpAllocation", name, args ?? new IpAllocationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpAllocation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:IpAllocation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IpAllocationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("prefixType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.IPVersion>? PrefixType { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.IpAllocationType>? Type { get; set; }
