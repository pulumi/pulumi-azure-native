...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    /// {
    ///     var expressRoutePortAuthorization = new AzureNative.Network.V20220101.ExpressRoutePortAuthorization("expressRoutePortAuthorization", new()
    ///     {
    ...
    public partial class ExpressRoutePortAuthorization : global::Pulumi.CustomResource
    {
        ...
        public ExpressRoutePortAuthorization(string name, ExpressRoutePortAuthorizationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:ExpressRoutePortAuthorization", name, args ?? new ExpressRoutePortAuthorizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRoutePortAuthorization(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:ExpressRoutePortAuthorization", name, null, MakeResourceOptions(options, id))
        {
        }
