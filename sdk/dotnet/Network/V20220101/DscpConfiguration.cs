...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220101:DscpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:DscpConfiguration to guarantee forwards compatibility.")]
    ...
    public partial class DscpConfiguration : global::Pulumi.CustomResource
    {
        ...
        public DscpConfiguration(string name, DscpConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:DscpConfiguration", name, args ?? new DscpConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DscpConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:DscpConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DscpConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.ProtocolType>? Protocol { get; set; }
