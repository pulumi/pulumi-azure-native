...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220101:ConnectivityConfiguration")]
    public partial class ConnectivityConfiguration : global::Pulumi.CustomResource
    {
        ...
        public ConnectivityConfiguration(string name, ConnectivityConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:ConnectivityConfiguration", name, args ?? new ConnectivityConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectivityConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:ConnectivityConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectivityConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.ConnectivityTopology> ConnectivityTopology { get; set; } = null!;

        /// <summary>
        /// Flag if need to remove current existing peerings.
        /// </summary>
        [Input("deleteExistingPeering")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220101.DeleteExistingPeering>? DeleteExistingPeering { get; set; }
