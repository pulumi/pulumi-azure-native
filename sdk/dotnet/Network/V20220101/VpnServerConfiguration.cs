...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20220101:VpnServerConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VpnServerConfiguration to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20220101:VpnServerConfiguration")]
    public partial class VpnServerConfiguration : global::Pulumi.CustomResource
    {
        ...
        public VpnServerConfiguration(string name, VpnServerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:VpnServerConfiguration", name, args ?? new VpnServerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnServerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:VpnServerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VpnServerConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.V20220101.VpnAuthenticationType>>? _vpnAuthenticationTypes;

        /// <summary>
        /// VPN authentication types for the VpnServerConfiguration.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20220101.VpnAuthenticationType>> VpnAuthenticationTypes
        {
            get => _vpnAuthenticationTypes ?? (_vpnAuthenticationTypes = new InputList<Union<string, Pulumi.AzureNative.Network.V20220101.VpnAuthenticationType>>());
        ...
        [Input("vpnProtocols")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20220101.VpnGatewayTunnelingProtocol>>? _vpnProtocols;

        /// <summary>
        /// VPN protocols for the VpnServerConfiguration.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20220101.VpnGatewayTunnelingProtocol>> VpnProtocols
        {
            get => _vpnProtocols ?? (_vpnProtocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20220101.VpnGatewayTunnelingProtocol>>());
