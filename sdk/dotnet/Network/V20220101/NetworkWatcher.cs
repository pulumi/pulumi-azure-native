...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220101:NetworkWatcher")]
    public partial class NetworkWatcher : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<string>> RunningOperationIds { get; private set; } = null!;
        ...
        public NetworkWatcher(string name, NetworkWatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:NetworkWatcher", name, args ?? new NetworkWatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkWatcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:NetworkWatcher", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkWatcherArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<string>? _runningOperationIds;

        /// <summary>
        /// List of running operation GUIDs.
        /// </summary>
        public InputList<string> RunningOperationIds
        {
            get => _runningOperationIds ?? (_runningOperationIds = new InputList<string>());
