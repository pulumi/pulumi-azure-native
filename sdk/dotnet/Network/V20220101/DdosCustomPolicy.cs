...
namespace Pulumi.AzureNative.Network.V20220101
{
    ...
    /// {
    ///     var ddosCustomPolicy = new AzureNative.Network.V20220101.DdosCustomPolicy("ddosCustomPolicy", new()
    ///     {
    ///         DdosCustomPolicyName = "test-ddos-custom-policy",
    ///         Location = "centraluseuap",
    ///         ProtocolCustomSettings = new[]
    ///         {
    ///             new AzureNative.Network.V20220101.Inputs.ProtocolCustomSettingsFormatArgs
    ///             {
    ///                 Protocol = "Tcp",
    ///             },
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220101:DdosCustomPolicy")]
    public partial class DdosCustomPolicy : global::Pulumi.CustomResource
    {
        ...
        public DdosCustomPolicy(string name, DdosCustomPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:DdosCustomPolicy", name, args ?? new DdosCustomPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DdosCustomPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220101:DdosCustomPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
