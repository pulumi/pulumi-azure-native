...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class VpnSite : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VpnSitePropertiesResponse> Properties { get; private set; } = null!;
        ...
        public VpnSite(string name, VpnSiteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:VpnSite", name, args ?? new VpnSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnSite(string name, Input<string> id, VpnSiteState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:VpnSite", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VpnSiteState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VpnSitePropertiesResponseGetArgs> Properties { get; set; } = null!;
