...
namespace Pulumi.AzureNative.Network.V20240501
{
    public static class GetNetworkProfile
    {
        ...
        public static Task<GetNetworkProfileResult> InvokeAsync(GetNetworkProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkProfileResult>("azure-native:network/v20240501:getNetworkProfile", args ?? new GetNetworkProfileArgs(), options.WithDefaults());
