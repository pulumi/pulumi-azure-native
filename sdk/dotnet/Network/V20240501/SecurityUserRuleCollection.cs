...
namespace Pulumi.AzureNative.Network.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240501:SecurityUserRuleCollection")]
    public partial class SecurityUserRuleCollection : global::Pulumi.CustomResource
    {
        ...
        public SecurityUserRuleCollection(string name, SecurityUserRuleCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:SecurityUserRuleCollection", name, args ?? new SecurityUserRuleCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityUserRuleCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:SecurityUserRuleCollection", name, null, MakeResourceOptions(options, id))
        {
        }
