...
namespace Pulumi.AzureNative.Network.V20240501
{
    public static class GetActiveSessions
    {
        ...
        public static Task<GetActiveSessionsResult> InvokeAsync(GetActiveSessionsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetActiveSessionsResult>("azure-native:network/v20240501:getActiveSessions", args ?? new GetActiveSessionsArgs(), options.WithDefaults());
