...
namespace Pulumi.AzureNative.Network.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240501:VirtualNetworkGatewayNatRule")]
    public partial class VirtualNetworkGatewayNatRule : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGatewayNatRule(string name, VirtualNetworkGatewayNatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:VirtualNetworkGatewayNatRule", name, args ?? new VirtualNetworkGatewayNatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGatewayNatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:VirtualNetworkGatewayNatRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20220501:VirtualNetworkGatewayNatRule" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20220701:VirtualNetworkGatewayNatRule" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20220901:VirtualNetworkGatewayNatRule" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20221101:VirtualNetworkGatewayNatRule" },
    ...
    public sealed class VirtualNetworkGatewayNatRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.VpnNatRuleMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.VpnNatRuleType>? Type { get; set; }
