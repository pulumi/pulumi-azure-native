...
namespace Pulumi.AzureNative.Network.V20240501
{
    public static class GetVirtualRouter
    {
        ...
        public static Task<GetVirtualRouterResult> InvokeAsync(GetVirtualRouterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualRouterResult>("azure-native:network/v20240501:getVirtualRouter", args ?? new GetVirtualRouterArgs(), options.WithDefaults());
