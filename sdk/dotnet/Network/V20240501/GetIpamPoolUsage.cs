...
namespace Pulumi.AzureNative.Network.V20240501
{
    public static class GetIpamPoolUsage
    {
        ...
        public static Task<GetIpamPoolUsageResult> InvokeAsync(GetIpamPoolUsageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIpamPoolUsageResult>("azure-native:network/v20240501:getIpamPoolUsage", args ?? new GetIpamPoolUsageArgs(), options.WithDefaults());

        /// <summary>
        /// IpamPool usage information.
        /// </summary>
        public static Output<GetIpamPoolUsageResult> Invoke(GetIpamPoolUsageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIpamPoolUsageResult>("azure-native:network/v20240501:getIpamPoolUsage", args ?? new GetIpamPoolUsageInvokeArgs(), options.WithDefaults());
    }
