...
namespace Pulumi.AzureNative.Network.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240501:FirewallPolicyDraft")]
    public partial class FirewallPolicyDraft : global::Pulumi.CustomResource
    {
        ...
        public FirewallPolicyDraft(string name, FirewallPolicyDraftArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:FirewallPolicyDraft", name, args ?? new FirewallPolicyDraftArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyDraft(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:FirewallPolicyDraft", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FirewallPolicyDraftArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.AzureFirewallThreatIntelMode>? ThreatIntelMode { get; set; }
