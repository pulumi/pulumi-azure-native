...
namespace Pulumi.AzureNative.Network.V20240501
{
    public static class GetRoutingRuleCollection
    {
        ...
        public static Task<GetRoutingRuleCollectionResult> InvokeAsync(GetRoutingRuleCollectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRoutingRuleCollectionResult>("azure-native:network/v20240501:getRoutingRuleCollection", args ?? new GetRoutingRuleCollectionArgs(), options.WithDefaults());
        ...
        public static Output<GetRoutingRuleCollectionResult> Invoke(GetRoutingRuleCollectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRoutingRuleCollectionResult>("azure-native:network/v20240501:getRoutingRuleCollection", args ?? new GetRoutingRuleCollectionInvokeArgs(), options.WithDefaults());
