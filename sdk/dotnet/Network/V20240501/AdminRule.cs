...
namespace Pulumi.AzureNative.Network.V20240501
{
    ...
    /// Network admin rule.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240501:AdminRule")]
    public partial class AdminRule : global::Pulumi.CustomResource
    {
        ...
        public AdminRule(string name, AdminRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:AdminRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AdminRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:AdminRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AdminRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.SecurityConfigurationRuleAccess> Access { get; set; } = null!;
