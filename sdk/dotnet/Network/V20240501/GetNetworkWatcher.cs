...
namespace Pulumi.AzureNative.Network.V20240501
{
    public static class GetNetworkWatcher
    {
        ...
        public static Task<GetNetworkWatcherResult> InvokeAsync(GetNetworkWatcherArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkWatcherResult>("azure-native:network/v20240501:getNetworkWatcher", args ?? new GetNetworkWatcherArgs(), options.WithDefaults());
