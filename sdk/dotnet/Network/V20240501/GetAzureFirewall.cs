...
namespace Pulumi.AzureNative.Network.V20240501
{
    public static class GetAzureFirewall
    {
        ...
        public static Task<GetAzureFirewallResult> InvokeAsync(GetAzureFirewallArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAzureFirewallResult>("azure-native:network/v20240501:getAzureFirewall", args ?? new GetAzureFirewallArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified Azure Firewall.
        /// </summary>
        public static Output<GetAzureFirewallResult> Invoke(GetAzureFirewallInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAzureFirewallResult>("azure-native:network/v20240501:getAzureFirewall", args ?? new GetAzureFirewallInvokeArgs(), options.WithDefaults());
