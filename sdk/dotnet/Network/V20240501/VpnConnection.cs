...
namespace Pulumi.AzureNative.Network.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240501:VpnConnection")]
    public partial class VpnConnection : global::Pulumi.CustomResource
    {
        ...
        public VpnConnection(string name, VpnConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:VpnConnection", name, args ?? new VpnConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:VpnConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VpnConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.VirtualNetworkGatewayConnectionProtocol>? VpnConnectionProtocolType { get; set; }
