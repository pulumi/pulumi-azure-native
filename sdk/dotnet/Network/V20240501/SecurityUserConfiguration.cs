...
namespace Pulumi.AzureNative.Network.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240501:SecurityUserConfiguration")]
    public partial class SecurityUserConfiguration : global::Pulumi.CustomResource
    {
        ...
        public SecurityUserConfiguration(string name, SecurityUserConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:SecurityUserConfiguration", name, args ?? new SecurityUserConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityUserConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:SecurityUserConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
