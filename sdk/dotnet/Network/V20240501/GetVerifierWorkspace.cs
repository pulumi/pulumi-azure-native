...
namespace Pulumi.AzureNative.Network.V20240501
{
    public static class GetVerifierWorkspace
    {
        ...
        public static Task<GetVerifierWorkspaceResult> InvokeAsync(GetVerifierWorkspaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVerifierWorkspaceResult>("azure-native:network/v20240501:getVerifierWorkspace", args ?? new GetVerifierWorkspaceArgs(), options.WithDefaults());

        /// <summary>
        /// Instance of Verifier Workspace.
        /// </summary>
        public static Output<GetVerifierWorkspaceResult> Invoke(GetVerifierWorkspaceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVerifierWorkspaceResult>("azure-native:network/v20240501:getVerifierWorkspace", args ?? new GetVerifierWorkspaceInvokeArgs(), options.WithDefaults());
