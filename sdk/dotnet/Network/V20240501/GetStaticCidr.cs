...
namespace Pulumi.AzureNative.Network.V20240501
{
    public static class GetStaticCidr
    {
        ...
        public static Task<GetStaticCidrResult> InvokeAsync(GetStaticCidrArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStaticCidrResult>("azure-native:network/v20240501:getStaticCidr", args ?? new GetStaticCidrArgs(), options.WithDefaults());
