...
namespace Pulumi.AzureNative.Network.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240501:PublicIPAddress")]
    public partial class PublicIPAddress : global::Pulumi.CustomResource
    {
        ...
        public PublicIPAddress(string name, PublicIPAddressArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:PublicIPAddress", name, args ?? new PublicIPAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:PublicIPAddress", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PublicIPAddressArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("deleteOption")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.DeleteOptions>? DeleteOption { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.PublicIPAddressMigrationPhase>? MigrationPhase { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.IPAllocationMethod>? PublicIPAllocationMethod { get; set; }
