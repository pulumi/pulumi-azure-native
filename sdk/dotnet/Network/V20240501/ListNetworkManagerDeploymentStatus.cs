...
namespace Pulumi.AzureNative.Network.V20240501
{
    public static class ListNetworkManagerDeploymentStatus
    {
        ...
        public static Task<ListNetworkManagerDeploymentStatusResult> InvokeAsync(ListNetworkManagerDeploymentStatusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListNetworkManagerDeploymentStatusResult>("azure-native:network/v20240501:listNetworkManagerDeploymentStatus", args ?? new ListNetworkManagerDeploymentStatusArgs(), options.WithDefaults());
        ...
        public static Output<ListNetworkManagerDeploymentStatusResult> Invoke(ListNetworkManagerDeploymentStatusInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListNetworkManagerDeploymentStatusResult>("azure-native:network/v20240501:listNetworkManagerDeploymentStatus", args ?? new ListNetworkManagerDeploymentStatusInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class ListNetworkManagerDeploymentStatusArgs : global::Pulumi.InvokeArgs
    {
        ...
        private List<Union<string, Pulumi.AzureNative.Network.V20240501.ConfigurationType>>? _deploymentTypes;

        /// <summary>
        /// List of deployment types.
        /// </summary>
        public List<Union<string, Pulumi.AzureNative.Network.V20240501.ConfigurationType>> DeploymentTypes
        {
            get => _deploymentTypes ?? (_deploymentTypes = new List<Union<string, Pulumi.AzureNative.Network.V20240501.ConfigurationType>>());
    ...
    {
        [Input("deploymentTypes")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20240501.ConfigurationType>>? _deploymentTypes;

        /// <summary>
        /// List of deployment types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20240501.ConfigurationType>> DeploymentTypes
        {
            get => _deploymentTypes ?? (_deploymentTypes = new InputList<Union<string, Pulumi.AzureNative.Network.V20240501.ConfigurationType>>());
            set => _deploymentTypes = value;
        }
