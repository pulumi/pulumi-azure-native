...
namespace Pulumi.AzureNative.Network.V20240501
{
    public static class GetRoutingIntent
    {
        ...
        public static Task<GetRoutingIntentResult> InvokeAsync(GetRoutingIntentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRoutingIntentResult>("azure-native:network/v20240501:getRoutingIntent", args ?? new GetRoutingIntentArgs(), options.WithDefaults());
