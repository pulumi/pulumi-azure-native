...
namespace Pulumi.AzureNative.Network.V20240501
{
    public static class GetIpamPool
    {
        ...
        public static Task<GetIpamPoolResult> InvokeAsync(GetIpamPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIpamPoolResult>("azure-native:network/v20240501:getIpamPool", args ?? new GetIpamPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Instance of Pool resource.
        /// </summary>
        public static Output<GetIpamPoolResult> Invoke(GetIpamPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIpamPoolResult>("azure-native:network/v20240501:getIpamPool", args ?? new GetIpamPoolInvokeArgs(), options.WithDefaults());
    }
