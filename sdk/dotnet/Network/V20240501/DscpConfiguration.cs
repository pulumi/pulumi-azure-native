...
namespace Pulumi.AzureNative.Network.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240501:DscpConfiguration")]
    public partial class DscpConfiguration : global::Pulumi.CustomResource
    {
        ...
        public DscpConfiguration(string name, DscpConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:DscpConfiguration", name, args ?? new DscpConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DscpConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:DscpConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DscpConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.ProtocolType>? Protocol { get; set; }
