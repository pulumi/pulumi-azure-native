...
namespace Pulumi.AzureNative.Network.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240501:IpamPool")]
    public partial class IpamPool : global::Pulumi.CustomResource
    {
        ...
        public IpamPool(string name, IpamPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:IpamPool", name, args ?? new IpamPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpamPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240501:IpamPool", name, null, MakeResourceOptions(options, id))
        {
        }
