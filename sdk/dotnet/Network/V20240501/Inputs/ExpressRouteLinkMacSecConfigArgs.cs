...
namespace Pulumi.AzureNative.Network.V20240501.Inputs
{
    ...
    public sealed class ExpressRouteLinkMacSecConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cipher")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.ExpressRouteLinkMacSecCipher>? Cipher { get; set; }
        ...
        /// </summary>
        [Input("sciState")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.ExpressRouteLinkMacSecSciState>? SciState { get; set; }
