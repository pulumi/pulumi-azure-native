...
namespace Pulumi.AzureNative.Network.V20240501.Inputs
{
    ...
    public sealed class ConnectivityGroupItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.GroupConnectivity> GroupConnectivity { get; set; } = null!;
        ...
        /// </summary>
        [Input("useHubGateway")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240501.UseHubGateway>? UseHubGateway { get; set; }
