...
namespace Pulumi.AzureNative.Network
{
    ...
    public partial class NspProfile : global::Pulumi.CustomResource
    {
        ...
        public NspProfile(string name, NspProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network:NspProfile", name, args ?? new NspProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NspProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network:NspProfile", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20241001:NspProfile" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250101:NspProfile" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250301:NspProfile" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250501:NspProfile" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250701:NspProfile" },
                },
            };
