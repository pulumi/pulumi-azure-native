...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class VirtualHubHubVirtualNetworkConnection : Pulumi.CustomResource
    {
        ...
        private VirtualHubHubVirtualNetworkConnection(string name, Input<string> id, VirtualHubHubVirtualNetworkConnectionState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:VirtualHubHubVirtualNetworkConnection", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualHubHubVirtualNetworkConnection Get(string name, Input<string> id, VirtualHubHubVirtualNetworkConnectionState? state = null, CustomResourceOptions? options = null)
        {
            return new VirtualHubHubVirtualNetworkConnection(name, id, state, options);
        }
    }
    ...
    public sealed class VirtualHubHubVirtualNetworkConnectionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A unique read-only string that changes whenever the resource is updated.
        /// </summary>
        ...
        public Input<Inputs.HubVirtualNetworkConnectionPropertiesResponseGetArgs> Properties { get; set; } = null!;

        public VirtualHubHubVirtualNetworkConnectionState()
        {
        }
    }
}
