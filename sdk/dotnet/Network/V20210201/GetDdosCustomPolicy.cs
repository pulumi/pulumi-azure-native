...
namespace Pulumi.AzureNative.Network.V20210201
{
    public static class GetDdosCustomPolicy
    {
        ...
        public static Task<GetDdosCustomPolicyResult> InvokeAsync(GetDdosCustomPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDdosCustomPolicyResult>("azure-native:network/v20210201:getDdosCustomPolicy", args ?? new GetDdosCustomPolicyArgs(), options.WithVersion());

        /// <summary>
        /// A DDoS custom policy in a resource group.
        /// </summary>
        public static Output<GetDdosCustomPolicyResult> Invoke(GetDdosCustomPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDdosCustomPolicyResult>("azure-native:network/v20210201:getDdosCustomPolicy", args ?? new GetDdosCustomPolicyInvokeArgs(), options.WithVersion());
    }
