...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201:VirtualNetworkPeering")]
    public partial class VirtualNetworkPeering : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkPeering(string name, VirtualNetworkPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:VirtualNetworkPeering", name, args ?? new VirtualNetworkPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:VirtualNetworkPeering", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkPeeringArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("peeringState")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201.VirtualNetworkPeeringState>? PeeringState { get; set; }

        /// <summary>
        /// The peering sync status of the virtual network peering.
        /// </summary>
        [Input("peeringSyncLevel")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201.VirtualNetworkPeeringLevel>? PeeringSyncLevel { get; set; }
