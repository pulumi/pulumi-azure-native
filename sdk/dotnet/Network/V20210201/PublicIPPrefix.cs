...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20210201:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PublicIPPrefix to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20210201:PublicIPPrefix")]
    public partial class PublicIPPrefix : global::Pulumi.CustomResource
    {
        ...
        public PublicIPPrefix(string name, PublicIPPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:PublicIPPrefix", name, args ?? new PublicIPPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:PublicIPPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
