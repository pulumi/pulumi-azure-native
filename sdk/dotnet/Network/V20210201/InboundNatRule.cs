    ...
    public partial class InboundNatRule : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:InboundNatRule"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20200801:InboundNatRule"},
                    new Pulumi.Alias { Type = "azure-native:network/v20201101:InboundNatRule"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20201101:InboundNatRule"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:InboundNatRule"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:InboundNatRule"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:InboundNatRule"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:InboundNatRule"},
                },
            };
