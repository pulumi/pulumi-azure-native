...
namespace Pulumi.AzureNative.Network.V20210201
{
    public static class GetRouteTable
    {
        ...
        public static Task<GetRouteTableResult> InvokeAsync(GetRouteTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteTableResult>("azure-native:network/v20210201:getRouteTable", args ?? new GetRouteTableArgs(), options.WithDefaults());

        /// <summary>
        /// Route table resource.
        /// </summary>
        public static Output<GetRouteTableResult> Invoke(GetRouteTableInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRouteTableResult>("azure-native:network/v20210201:getRouteTable", args ?? new GetRouteTableInvokeArgs(), options.WithDefaults());
    }
