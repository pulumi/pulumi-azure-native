...
namespace Pulumi.AzureNative.Network.V20210201.Inputs
{
    ...
    public sealed class ApplicationGatewayBackendHttpSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201.ApplicationGatewayCookieBasedAffinity>? CookieBasedAffinity { get; set; }
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201.ApplicationGatewayProtocol>? Protocol { get; set; }
