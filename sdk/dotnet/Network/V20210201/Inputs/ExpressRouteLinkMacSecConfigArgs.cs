...
namespace Pulumi.AzureNative.Network.V20210201.Inputs
{
    ...
    public sealed class ExpressRouteLinkMacSecConfigArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cipher")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201.ExpressRouteLinkMacSecCipher>? Cipher { get; set; }
        ...
        /// </summary>
        [Input("sciState")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201.ExpressRouteLinkMacSecSciState>? SciState { get; set; }
