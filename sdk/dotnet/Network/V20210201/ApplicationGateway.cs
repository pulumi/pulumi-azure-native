...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20210201:ApplicationGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ApplicationGateway to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20210201:ApplicationGateway")]
    public partial class ApplicationGateway : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGateway(string name, ApplicationGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:ApplicationGateway", name, args ?? new ApplicationGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:ApplicationGateway", name, null, MakeResourceOptions(options, id))
        {
        }
