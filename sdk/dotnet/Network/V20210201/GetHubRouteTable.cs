...
namespace Pulumi.AzureNative.Network.V20210201
{
    public static class GetHubRouteTable
    {
        ...
        public static Task<GetHubRouteTableResult> InvokeAsync(GetHubRouteTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHubRouteTableResult>("azure-native:network/v20210201:getHubRouteTable", args ?? new GetHubRouteTableArgs(), options.WithDefaults());

        /// <summary>
        /// RouteTable resource in a virtual hub.
        /// </summary>
        public static Output<GetHubRouteTableResult> Invoke(GetHubRouteTableInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetHubRouteTableResult>("azure-native:network/v20210201:getHubRouteTable", args ?? new GetHubRouteTableInvokeArgs(), options.WithDefaults());
    }
