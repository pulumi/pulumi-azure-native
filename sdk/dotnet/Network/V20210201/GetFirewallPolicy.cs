...
namespace Pulumi.AzureNative.Network.V20210201
{
    public static class GetFirewallPolicy
    {
        ...
        public static Task<GetFirewallPolicyResult> InvokeAsync(GetFirewallPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallPolicyResult>("azure-native:network/v20210201:getFirewallPolicy", args ?? new GetFirewallPolicyArgs(), options.WithVersion());

        /// <summary>
        /// FirewallPolicy Resource.
        /// </summary>
        public static Output<GetFirewallPolicyResult> Invoke(GetFirewallPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFirewallPolicyResult>("azure-native:network/v20210201:getFirewallPolicy", args ?? new GetFirewallPolicyInvokeArgs(), options.WithVersion());
    }
