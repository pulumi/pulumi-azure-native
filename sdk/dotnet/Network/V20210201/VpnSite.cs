...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    /// VpnSite Resource.
    /// </summary>
    [Obsolete(@"azure-native:network/v20210201:VpnSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VpnSite to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20210201:VpnSite")]
    public partial class VpnSite : global::Pulumi.CustomResource
    {
        ...
        public VpnSite(string name, VpnSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:VpnSite", name, args ?? new VpnSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:VpnSite", name, null, MakeResourceOptions(options, id))
        {
        }
