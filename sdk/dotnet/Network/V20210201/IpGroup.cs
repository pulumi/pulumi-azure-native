...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201:IpGroup")]
    public partial class IpGroup : Pulumi.CustomResource
    {
        ...
        public IpGroup(string name, IpGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:IpGroup", name, args ?? new IpGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:IpGroup", name, null, MakeResourceOptions(options, id))
        {
        }
