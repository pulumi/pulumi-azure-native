...
namespace Pulumi.AzureNative.Network.V20210201
{
    public static class GetPublicIPPrefix
    {
        ...
        public static Task<GetPublicIPPrefixResult> InvokeAsync(GetPublicIPPrefixArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPublicIPPrefixResult>("azure-native:network/v20210201:getPublicIPPrefix", args ?? new GetPublicIPPrefixArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified public IP prefix in a specified resource group.
        /// </summary>
        public static Output<GetPublicIPPrefixResult> Invoke(GetPublicIPPrefixInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPublicIPPrefixResult>("azure-native:network/v20210201:getPublicIPPrefix", args ?? new GetPublicIPPrefixInvokeArgs(), options.WithDefaults());
