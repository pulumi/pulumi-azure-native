...
namespace Pulumi.AzureNative.Network.V20210201
{
    public static class GetIpGroup
    {
        ...
        public static Task<GetIpGroupResult> InvokeAsync(GetIpGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIpGroupResult>("azure-native:network/v20210201:getIpGroup", args ?? new GetIpGroupArgs(), options.WithVersion());

        /// <summary>
        /// The IpGroups resource information.
        /// </summary>
        public static Output<GetIpGroupResult> Invoke(GetIpGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIpGroupResult>("azure-native:network/v20210201:getIpGroup", args ?? new GetIpGroupInvokeArgs(), options.WithVersion());
    }
