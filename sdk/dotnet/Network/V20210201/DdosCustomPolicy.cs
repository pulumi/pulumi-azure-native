...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201:DdosCustomPolicy")]
    public partial class DdosCustomPolicy : Pulumi.CustomResource
    {
        ...
        public DdosCustomPolicy(string name, DdosCustomPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:DdosCustomPolicy", name, args ?? new DdosCustomPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DdosCustomPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:DdosCustomPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
