...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    /// {
    ///     var privateEndpoint = new AzureNative.Network.V20210201.PrivateEndpoint("privateEndpoint", new()
    ///     {
    ///         Location = "eastus2euap",
    ///         PrivateEndpointName = "testPe",
    ///         PrivateLinkServiceConnections = new[]
    ///         {
    ///             new AzureNative.Network.V20210201.Inputs.PrivateLinkServiceConnectionArgs
    ///             {
    ///                 GroupIds = new[]
    ///                 {
    ///                     "groupIdFromResource",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201:PrivateEndpoint")]
    public partial class PrivateEndpoint : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpoint(string name, PrivateEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:PrivateEndpoint", name, args ?? new PrivateEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:PrivateEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
