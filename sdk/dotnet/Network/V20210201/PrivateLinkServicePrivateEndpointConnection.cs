...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201:PrivateLinkServicePrivateEndpointConnection")]
    public partial class PrivateLinkServicePrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateLinkServicePrivateEndpointConnection(string name, PrivateLinkServicePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:PrivateLinkServicePrivateEndpointConnection", name, args ?? new PrivateLinkServicePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkServicePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:PrivateLinkServicePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:PrivateLinkServicePrivateEndpointConnection"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:network/v20200701:PrivateLinkServicePrivateEndpointConnection"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20200801:PrivateLinkServicePrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:network/v20201101:PrivateLinkServicePrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20201101:PrivateLinkServicePrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:PrivateLinkServicePrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:PrivateLinkServicePrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:PrivateLinkServicePrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:PrivateLinkServicePrivateEndpointConnection"},
                },
            };
