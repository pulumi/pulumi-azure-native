...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    /// VirtualWAN Resource.
    /// </summary>
    [Obsolete(@"azure-native:network/v20210201:VirtualWan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualWan to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20210201:VirtualWan")]
    public partial class VirtualWan : global::Pulumi.CustomResource
    {
        ...
        public VirtualWan(string name, VirtualWanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:VirtualWan", name, args ?? new VirtualWanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:VirtualWan", name, null, MakeResourceOptions(options, id))
        {
        }
