...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    /// VirtualHub Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201:VirtualHub")]
    public partial class VirtualHub : global::Pulumi.CustomResource
    {
        ...
        public VirtualHub(string name, VirtualHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:VirtualHub", name, args ?? new VirtualHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:VirtualHub", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualHubArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201.PreferredRoutingGateway>? PreferredRoutingGateway { get; set; }
