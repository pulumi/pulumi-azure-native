...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    [AzureNativeResourceType("azure-native:network/v20210201:VirtualNetwork")]
    public partial class VirtualNetwork : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:VirtualNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
