...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201:FirewallPolicyRuleCollectionGroup")]
    public partial class FirewallPolicyRuleCollectionGroup : global::Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleCollectionGroup(string name, FirewallPolicyRuleCollectionGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:FirewallPolicyRuleCollectionGroup", name, args ?? new FirewallPolicyRuleCollectionGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleCollectionGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:FirewallPolicyRuleCollectionGroup", name, null, MakeResourceOptions(options, id))
        {
        }
