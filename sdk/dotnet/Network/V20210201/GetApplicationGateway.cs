...
namespace Pulumi.AzureNative.Network.V20210201
{
    public static class GetApplicationGateway
    {
        ...
        public static Task<GetApplicationGatewayResult> InvokeAsync(GetApplicationGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationGatewayResult>("azure-native:network/v20210201:getApplicationGateway", args ?? new GetApplicationGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// Application gateway resource.
        /// </summary>
        public static Output<GetApplicationGatewayResult> Invoke(GetApplicationGatewayInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationGatewayResult>("azure-native:network/v20210201:getApplicationGateway", args ?? new GetApplicationGatewayInvokeArgs(), options.WithDefaults());
    }
