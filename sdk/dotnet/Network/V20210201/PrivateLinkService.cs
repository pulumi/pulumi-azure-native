...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    /// {
    ///     var privateLinkService = new AzureNative.Network.V20210201.PrivateLinkService("privateLinkService", new()
    ///     {
    ///         AutoApproval = new AzureNative.Network.V20210201.Inputs.PrivateLinkServicePropertiesAutoApprovalArgs
    ///         {
    ///             Subscriptions = new[]
    ///             {
    ///                 "subscription1",
    ...
    ///         {
    ///             new AzureNative.Network.V20210201.Inputs.PrivateLinkServiceIpConfigurationArgs
    ///             {
    ///                 Name = "fe-lb",
    ///                 PrivateIPAddress = "10.0.1.4",
    ///                 PrivateIPAddressVersion = "IPv4",
    ///                 PrivateIPAllocationMethod = "Static",
    ///                 Subnet = new AzureNative.Network.V20210201.Inputs.SubnetArgs
    ///                 {
    ...
    ///         {
    ///             new AzureNative.Network.V20210201.Inputs.FrontendIPConfigurationArgs
    ///             {
    ...
    ///         ServiceName = "testPls",
    ///         Visibility = new AzureNative.Network.V20210201.Inputs.PrivateLinkServicePropertiesVisibilityArgs
    ///         {
    ///             Subscriptions = new[]
    ///             {
    ///                 "subscription1",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210201:PrivateLinkService")]
    public partial class PrivateLinkService : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkService(string name, PrivateLinkServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:PrivateLinkService", name, args ?? new PrivateLinkServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:PrivateLinkService", name, null, MakeResourceOptions(options, id))
        {
        }
