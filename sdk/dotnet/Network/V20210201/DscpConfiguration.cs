...
namespace Pulumi.AzureNative.Network.V20210201
{
    ...
    public partial class DscpConfiguration : Pulumi.CustomResource
    {
        ...
        public DscpConfiguration(string name, DscpConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:DscpConfiguration", name, args ?? new DscpConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DscpConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210201:DscpConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DscpConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210201.ProtocolType>? Protocol { get; set; }
