...
namespace Pulumi.AzureNative.Network.V20160901.Inputs
{
    ...
    public sealed class ApplicationGatewaySslPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20160901.ApplicationGatewaySslProtocol>> DisabledSslProtocols
        {
            get => _disabledSslProtocols ?? (_disabledSslProtocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20160901.ApplicationGatewaySslProtocol>>());
