...
namespace Pulumi.AzureNextGen.Network.V20160901.Inputs
{
    ...
    public sealed class PublicIPAddressArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20160901.IPVersion>? PublicIPAddressVersion { get; set; }

        /// <summary>
        /// The public IP allocation method. Possible values are: 'Static' and 'Dynamic'.
        /// </summary>
        [Input("publicIPAllocationMethod")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20160901.IPAllocationMethod>? PublicIPAllocationMethod { get; set; }
