...
namespace Pulumi.AzureNative.Network.V20160901
{
    public static class GetRoute
    {
        ...
        public static Task<GetRouteResult> InvokeAsync(GetRouteArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteResult>("azure-native:network/v20160901:getRoute", args ?? new GetRouteArgs(), options.WithDefaults());

        /// <summary>
        /// Route resource
        /// </summary>
        public static Output<GetRouteResult> Invoke(GetRouteInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRouteResult>("azure-native:network/v20160901:getRoute", args ?? new GetRouteInvokeArgs(), options.WithDefaults());
    }
