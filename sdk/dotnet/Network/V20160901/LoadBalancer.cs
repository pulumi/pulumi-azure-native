...
namespace Pulumi.AzureRM.Network.V20160901
{
    ...
    public partial class LoadBalancer : Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20160901:LoadBalancer", name, args ?? new LoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20160901:LoadBalancer", name, null, MakeResourceOptions(options, id))
        {
        }
