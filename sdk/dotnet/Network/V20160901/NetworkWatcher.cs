...
namespace Pulumi.AzureNative.Network.V20160901
{
    ...
    [AzureNativeResourceType("azure-native:network/v20160901:NetworkWatcher")]
    public partial class NetworkWatcher : global::Pulumi.CustomResource
    {
        ...
        public NetworkWatcher(string name, NetworkWatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20160901:NetworkWatcher", name, args ?? new NetworkWatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkWatcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20160901:NetworkWatcher", name, null, MakeResourceOptions(options, id))
        {
        }
