...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class ApplicationSecurityGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ApplicationSecurityGroupPropertiesFormatResponse> Properties { get; private set; } = null!;
        ...
        public ApplicationSecurityGroup(string name, ApplicationSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:ApplicationSecurityGroup", name, args ?? new ApplicationSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ApplicationSecurityGroup(string name, Input<string> id, ApplicationSecurityGroupState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:ApplicationSecurityGroup", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApplicationSecurityGroupState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ApplicationSecurityGroupPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
