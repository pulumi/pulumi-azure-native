...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class LocalNetworkGateway : Pulumi.CustomResource
    {
        ...
        public LocalNetworkGateway(string name, LocalNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:LocalNetworkGateway", name, args ?? new LocalNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private LocalNetworkGateway(string name, Input<string> id, LocalNetworkGatewayState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:LocalNetworkGateway", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LocalNetworkGatewayState : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties", required: true)]
        public Input<Inputs.LocalNetworkGatewayPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
