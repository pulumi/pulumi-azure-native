...
namespace Pulumi.AzureNextGen.Network.Inputs
{
    ...
    public sealed class ExpressRouteLinkMacSecConfigArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cipher")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.ExpressRouteLinkMacSecCipher>? Cipher { get; set; }
        ...
        /// </summary>
        [Input("sciState")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.ExpressRouteLinkMacSecSciState>? SciState { get; set; }
