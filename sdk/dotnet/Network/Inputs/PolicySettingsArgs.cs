...
namespace Pulumi.AzureNextGen.Network.Inputs
{
    ...
    public sealed class PolicySettingsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.WebApplicationFirewallMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.WebApplicationFirewallEnabledState>? State { get; set; }
