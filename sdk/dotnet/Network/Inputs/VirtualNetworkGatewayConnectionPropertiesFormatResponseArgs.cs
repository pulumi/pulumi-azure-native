...
namespace Pulumi.AzureRM.Network.Inputs
{
    ...
    /// </summary>
    public sealed class VirtualNetworkGatewayConnectionPropertiesFormatResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.LocalNetworkGatewayResponseArgs>? LocalNetworkGateway2 { get; set; }

        /// <summary>
        /// The reference to peerings resource.
        /// </summary>
        [Input("peer")]
        public Input<Inputs.SubResourceResponseArgs>? Peer { get; set; }
        ...
        private InputList<Inputs.TrafficSelectorPolicyResponseArgs>? _trafficSelectorPolicies;

        /// <summary>
        /// The Traffic Selector Policies to be considered by this connection.
        /// </summary>
        public InputList<Inputs.TrafficSelectorPolicyResponseArgs> TrafficSelectorPolicies
        {
            get => _trafficSelectorPolicies ?? (_trafficSelectorPolicies = new InputList<Inputs.TrafficSelectorPolicyResponseArgs>());
            set => _trafficSelectorPolicies = value;
        }

        [Input("tunnelConnectionStatus", required: true)]
        private InputList<Inputs.TunnelConnectionHealthResponseArgs>? _tunnelConnectionStatus;

        /// <summary>
        /// Collection of all tunnels' connection health status.
        /// </summary>
        public InputList<Inputs.TunnelConnectionHealthResponseArgs> TunnelConnectionStatus
        {
            get => _tunnelConnectionStatus ?? (_tunnelConnectionStatus = new InputList<Inputs.TunnelConnectionHealthResponseArgs>());
        ...
        public Input<Inputs.VirtualNetworkGatewayResponseArgs> VirtualNetworkGateway1 { get; set; } = null!;

        /// <summary>
        /// The reference to virtual network gateway resource.
        /// </summary>
        [Input("virtualNetworkGateway2")]
        public Input<Inputs.VirtualNetworkGatewayResponseArgs>? VirtualNetworkGateway2 { get; set; }

        public VirtualNetworkGatewayConnectionPropertiesFormatResponseArgs()
        {
        }
    }
}
