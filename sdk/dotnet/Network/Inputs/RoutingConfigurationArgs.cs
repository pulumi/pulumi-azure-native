...
namespace Pulumi.AzureNative.Network.Inputs
{
    ...
    public sealed class RoutingConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CommonSubResourceArgs>? AssociatedRouteTable { get; set; }

        /// <summary>
        /// The resource id of the RouteMap associated with this RoutingConfiguration for inbound learned routes.
        /// </summary>
        [Input("inboundRouteMap")]
        public Input<Inputs.CommonSubResourceArgs>? InboundRouteMap { get; set; }

        /// <summary>
        /// The resource id of theRouteMap associated with this RoutingConfiguration for outbound advertised routes.
        /// </summary>
        [Input("outboundRouteMap")]
        public Input<Inputs.CommonSubResourceArgs>? OutboundRouteMap { get; set; }
