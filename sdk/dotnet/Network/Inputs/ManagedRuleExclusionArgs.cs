...
namespace Pulumi.AzureNative.Network.Inputs
{
    ...
    public sealed class ManagedRuleExclusionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.ManagedRuleExclusionMatchVariable> MatchVariable { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.ManagedRuleExclusionSelectorMatchOperator> SelectorMatchOperator { get; set; } = null!;
