...
namespace Pulumi.AzureNative.Network.Inputs
{
    ...
    public sealed class IPTrafficArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.NetworkProtocol>>? _protocols;
        public InputList<Union<string, Pulumi.AzureNative.Network.NetworkProtocol>> Protocols
        {
            get => _protocols ?? (_protocols = new InputList<Union<string, Pulumi.AzureNative.Network.NetworkProtocol>>());
