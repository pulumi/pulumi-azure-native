...
namespace Pulumi.AzureRM.Network.Inputs
{
    ...
    public sealed class MatchConditionResponseGetArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.MatchVariableResponseGetArgs>? _matchVariables;

        /// <summary>
        /// List of match variables.
        /// </summary>
        public InputList<Inputs.MatchVariableResponseGetArgs> MatchVariables
        {
            get => _matchVariables ?? (_matchVariables = new InputList<Inputs.MatchVariableResponseGetArgs>());
