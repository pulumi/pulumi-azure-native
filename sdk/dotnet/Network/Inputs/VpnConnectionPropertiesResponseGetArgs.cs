...
namespace Pulumi.AzureRM.Network.Inputs
{
    ...
    /// </summary>
    public sealed class VpnConnectionPropertiesResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("remoteVpnSite")]
        public Input<Inputs.SubResourceResponseGetArgs>? RemoteVpnSite { get; set; }
        ...
        private InputList<Inputs.VpnSiteLinkConnectionResponseGetArgs>? _vpnLinkConnections;

        /// <summary>
        /// List of all vpn site link connections to the gateway.
        /// </summary>
        public InputList<Inputs.VpnSiteLinkConnectionResponseGetArgs> VpnLinkConnections
        {
            get => _vpnLinkConnections ?? (_vpnLinkConnections = new InputList<Inputs.VpnSiteLinkConnectionResponseGetArgs>());
            set => _vpnLinkConnections = value;
        }

        public VpnConnectionPropertiesResponseGetArgs()
        {
        }
    }
}
