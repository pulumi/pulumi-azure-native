...
namespace Pulumi.AzureRM.Network.Inputs
{
    ...
    /// </summary>
    public sealed class RoutingRulePropertiesResponseArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.SubResourceResponseArgs>? _frontendEndpoints;

        /// <summary>
        /// Frontend endpoints associated with this rule
        /// </summary>
        public InputList<Inputs.SubResourceResponseArgs> FrontendEndpoints
        {
            get => _frontendEndpoints ?? (_frontendEndpoints = new InputList<Inputs.SubResourceResponseArgs>());
        ...
        public Input<Inputs.RouteConfigurationResponseArgs>? RouteConfiguration { get; set; }

        /// <summary>
        /// A reference to a specific Rules Engine Configuration to apply to this route.
        /// </summary>
        [Input("rulesEngine")]
        public Input<Inputs.SubResourceResponseArgs>? RulesEngine { get; set; }

        /// <summary>
        /// Defines the Web Application Firewall policy for each routing rule (if applicable)
        /// </summary>
        [Input("webApplicationFirewallPolicyLink")]
        public Input<Inputs.RoutingRuleUpdateParametersResponsePropertiesArgs>? WebApplicationFirewallPolicyLink { get; set; }

        public RoutingRulePropertiesResponseArgs()
        {
        }
    }
}
