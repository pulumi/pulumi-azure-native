...
namespace Pulumi.AzureRM.Network.Inputs
{
    ...
    /// </summary>
    public sealed class BastionHostIPConfigurationPropertiesFormatResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.SubResourceResponseGetArgs> PublicIPAddress { get; set; } = null!;

        /// <summary>
        /// Reference of the subnet resource.
        /// </summary>
        [Input("subnet", required: true)]
        public Input<Inputs.SubResourceResponseGetArgs> Subnet { get; set; } = null!;

        public BastionHostIPConfigurationPropertiesFormatResponseGetArgs()
        {
        }
    }
}
