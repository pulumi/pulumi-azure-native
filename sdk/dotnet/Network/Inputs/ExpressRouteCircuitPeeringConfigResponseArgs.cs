...
namespace Pulumi.AzureRM.Network.Inputs
{
    ...
    /// </summary>
    public sealed class ExpressRouteCircuitPeeringConfigResponseArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("advertisedPublicPrefixesState", required: true)]
        public Input<string> AdvertisedPublicPrefixesState { get; set; } = null!;
