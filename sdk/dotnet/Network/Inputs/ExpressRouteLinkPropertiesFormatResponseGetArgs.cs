...
namespace Pulumi.AzureRM.Network.Inputs
{
    ...
    /// </summary>
    public sealed class ExpressRouteLinkPropertiesFormatResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("macSecConfig")]
        public Input<Inputs.ExpressRouteLinkMacSecConfigResponseGetArgs>? MacSecConfig { get; set; }
        ...
        public ExpressRouteLinkPropertiesFormatResponseGetArgs()
        {
        }
    }
}
