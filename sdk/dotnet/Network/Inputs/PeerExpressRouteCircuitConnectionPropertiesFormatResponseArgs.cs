...
namespace Pulumi.AzureRM.Network.Inputs
{
    ...
    /// </summary>
    public sealed class PeerExpressRouteCircuitConnectionPropertiesFormatResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.SubResourceResponseArgs>? ExpressRouteCircuitPeering { get; set; }

        /// <summary>
        /// Reference to Express Route Circuit Private Peering Resource of the peered circuit.
        /// </summary>
        [Input("peerExpressRouteCircuitPeering")]
        public Input<Inputs.SubResourceResponseArgs>? PeerExpressRouteCircuitPeering { get; set; }
