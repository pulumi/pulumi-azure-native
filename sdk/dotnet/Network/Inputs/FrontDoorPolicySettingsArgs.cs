...
namespace Pulumi.AzureNative.Network.Inputs
{
    ...
    public sealed class FrontDoorPolicySettingsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.Network.PolicyEnabledState>? EnabledState { get; set; }

        /// <summary>
        /// Describes if it is in detection mode or prevention mode at policy level.
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Network.PolicyMode>? Mode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.PolicyRequestBodyCheck>? RequestBodyCheck { get; set; }
