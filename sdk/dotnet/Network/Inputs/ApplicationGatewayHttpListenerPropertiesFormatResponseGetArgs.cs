...
namespace Pulumi.AzureRM.Network.Inputs
{
    ...
    /// </summary>
    public sealed class ApplicationGatewayHttpListenerPropertiesFormatResponseGetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SubResourceResponseGetArgs>? FrontendIPConfiguration { get; set; }

        /// <summary>
        /// Frontend port resource of an application gateway.
        /// </summary>
        [Input("frontendPort")]
        public Input<Inputs.SubResourceResponseGetArgs>? FrontendPort { get; set; }
        ...
        public Input<Inputs.SubResourceResponseGetArgs>? SslCertificate { get; set; }

        public ApplicationGatewayHttpListenerPropertiesFormatResponseGetArgs()
        {
        }
    }
}
