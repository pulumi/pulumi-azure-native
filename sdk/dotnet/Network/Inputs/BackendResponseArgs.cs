...
namespace Pulumi.AzureRM.Network.Inputs
{
    ...
    /// </summary>
    public sealed class BackendResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("privateEndpointStatus", required: true)]
        public Input<string> PrivateEndpointStatus { get; set; } = null!;
