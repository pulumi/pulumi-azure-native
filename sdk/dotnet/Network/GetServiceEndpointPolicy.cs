...
namespace Pulumi.AzureRM.Network
{
    public static class GetServiceEndpointPolicy
    {
        public static Task<GetServiceEndpointPolicyResult> InvokeAsync(GetServiceEndpointPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceEndpointPolicyResult>("azurerm:network:getServiceEndpointPolicy", args ?? new GetServiceEndpointPolicyArgs(), options.WithVersion());
    }
