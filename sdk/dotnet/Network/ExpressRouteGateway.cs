...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class ExpressRouteGateway : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ExpressRouteGatewayPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public ExpressRouteGateway(string name, ExpressRouteGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:ExpressRouteGateway", name, args ?? new ExpressRouteGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ExpressRouteGateway(string name, Input<string> id, ExpressRouteGatewayState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:ExpressRouteGateway", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRouteGatewayState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ExpressRouteGatewayPropertiesResponseGetArgs> Properties { get; set; } = null!;
