...
namespace Pulumi.AzureRM.Network
{
    public static class GetInterfaceEndpoint
    {
        public static Task<GetInterfaceEndpointResult> InvokeAsync(GetInterfaceEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInterfaceEndpointResult>("azurerm:network:getInterfaceEndpoint", args ?? new GetInterfaceEndpointArgs(), options.WithVersion());
    }
