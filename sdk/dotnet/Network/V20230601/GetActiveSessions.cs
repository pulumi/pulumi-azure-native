...
namespace Pulumi.AzureNative.Network.V20230601
{
    public static class GetActiveSessions
    {
        ...
        public static Task<GetActiveSessionsResult> InvokeAsync(GetActiveSessionsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetActiveSessionsResult>("azure-native:network/v20230601:getActiveSessions", args ?? new GetActiveSessionsArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the list of currently active sessions on the Bastion.
        /// </summary>
        public static Output<GetActiveSessionsResult> Invoke(GetActiveSessionsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetActiveSessionsResult>("azure-native:network/v20230601:getActiveSessions", args ?? new GetActiveSessionsInvokeArgs(), options.WithDefaults());
    }
