...
namespace Pulumi.AzureNative.Network.V20230601.Inputs
{
    ...
    public sealed class ApplicationGatewaySkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.ApplicationGatewaySkuName>? Name { get; set; }

        /// <summary>
        /// Tier of an application gateway.
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.ApplicationGatewayTier>? Tier { get; set; }
