...
namespace Pulumi.AzureNative.Network.V20230601.Inputs
{
    ...
    public sealed class LoadBalancerSkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.LoadBalancerSkuName>? Name { get; set; }

        /// <summary>
        /// Tier of a load balancer SKU.
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.LoadBalancerSkuTier>? Tier { get; set; }
