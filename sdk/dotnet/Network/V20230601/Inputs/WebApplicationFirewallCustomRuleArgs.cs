...
namespace Pulumi.AzureNative.Network.V20230601.Inputs
{
    ...
    public sealed class WebApplicationFirewallCustomRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.WebApplicationFirewallAction> Action { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.ApplicationGatewayFirewallRateLimitDuration>? RateLimitDuration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.WebApplicationFirewallRuleType> RuleType { get; set; } = null!;

        /// <summary>
        /// Describes if the custom rule is in enabled or disabled state. Defaults to Enabled if not specified.
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.WebApplicationFirewallState>? State { get; set; }
