...
namespace Pulumi.AzureNative.Network.V20230601.Inputs
{
    ...
    public sealed class ManagedRuleOverrideArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("action")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.ActionType>? Action { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.ManagedRuleEnabledState>? State { get; set; }
