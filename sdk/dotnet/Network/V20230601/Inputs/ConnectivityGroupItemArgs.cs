...
namespace Pulumi.AzureNative.Network.V20230601.Inputs
{
    ...
    public sealed class ConnectivityGroupItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.GroupConnectivity> GroupConnectivity { get; set; } = null!;
        ...
        /// </summary>
        [Input("useHubGateway")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.UseHubGateway>? UseHubGateway { get; set; }
