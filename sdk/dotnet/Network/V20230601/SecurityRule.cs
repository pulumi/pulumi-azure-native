...
namespace Pulumi.AzureNative.Network.V20230601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230601:SecurityRule")]
    public partial class SecurityRule : global::Pulumi.CustomResource
    {
        ...
        public SecurityRule(string name, SecurityRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230601:SecurityRule", name, args ?? new SecurityRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230601:SecurityRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.SecurityRuleAccess> Access { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.SecurityRuleDirection> Direction { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230601.SecurityRuleProtocol> Protocol { get; set; } = null!;
