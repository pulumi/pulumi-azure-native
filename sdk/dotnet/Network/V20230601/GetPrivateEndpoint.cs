...
namespace Pulumi.AzureNative.Network.V20230601
{
    public static class GetPrivateEndpoint
    {
        ...
        public static Task<GetPrivateEndpointResult> InvokeAsync(GetPrivateEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateEndpointResult>("azure-native:network/v20230601:getPrivateEndpoint", args ?? new GetPrivateEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified private endpoint by resource group.
        /// </summary>
        public static Output<GetPrivateEndpointResult> Invoke(GetPrivateEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPrivateEndpointResult>("azure-native:network/v20230601:getPrivateEndpoint", args ?? new GetPrivateEndpointInvokeArgs(), options.WithDefaults());
