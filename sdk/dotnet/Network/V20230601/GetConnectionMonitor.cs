...
namespace Pulumi.AzureNative.Network.V20230601
{
    public static class GetConnectionMonitor
    {
        ...
        public static Task<GetConnectionMonitorResult> InvokeAsync(GetConnectionMonitorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectionMonitorResult>("azure-native:network/v20230601:getConnectionMonitor", args ?? new GetConnectionMonitorArgs(), options.WithDefaults());
