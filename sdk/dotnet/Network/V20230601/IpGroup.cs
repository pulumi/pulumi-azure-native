...
namespace Pulumi.AzureNative.Network.V20230601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230601:IpGroup")]
    public partial class IpGroup : global::Pulumi.CustomResource
    {
        ...
        public IpGroup(string name, IpGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230601:IpGroup", name, args ?? new IpGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230601:IpGroup", name, null, MakeResourceOptions(options, id))
        {
        }
