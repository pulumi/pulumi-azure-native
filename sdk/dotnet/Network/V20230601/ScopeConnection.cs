...
namespace Pulumi.AzureNative.Network.V20230601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230601:ScopeConnection")]
    public partial class ScopeConnection : global::Pulumi.CustomResource
    {
        ...
        public ScopeConnection(string name, ScopeConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230601:ScopeConnection", name, args ?? new ScopeConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230601:ScopeConnection", name, null, MakeResourceOptions(options, id))
        {
        }
