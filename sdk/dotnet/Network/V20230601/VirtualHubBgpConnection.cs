...
namespace Pulumi.AzureNative.Network.V20230601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230601:VirtualHubBgpConnection")]
    public partial class VirtualHubBgpConnection : global::Pulumi.CustomResource
    {
        ...
        public VirtualHubBgpConnection(string name, VirtualHubBgpConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230601:VirtualHubBgpConnection", name, args ?? new VirtualHubBgpConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubBgpConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230601:VirtualHubBgpConnection", name, null, MakeResourceOptions(options, id))
        {
        }
