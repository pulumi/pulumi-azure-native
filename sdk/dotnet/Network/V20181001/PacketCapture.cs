...
namespace Pulumi.AzureNextGen.Network.V20181001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20181001:PacketCapture")]
    public partial class PacketCapture : Pulumi.CustomResource
    {
        ...
        public PacketCapture(string name, PacketCaptureArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181001:PacketCapture", name, args ?? new PacketCaptureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCapture(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181001:PacketCapture", name, null, MakeResourceOptions(options, id))
        {
        }
