...
namespace Pulumi.AzureNative.Network.V20181001
{
    ...
    [AzureNativeResourceType("azure-native:network/v20181001:P2sVpnServerConfiguration")]
    public partial class P2sVpnServerConfiguration : global::Pulumi.CustomResource
    {
        ...
        public P2sVpnServerConfiguration(string name, P2sVpnServerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181001:P2sVpnServerConfiguration", name, args ?? new P2sVpnServerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private P2sVpnServerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181001:P2sVpnServerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
