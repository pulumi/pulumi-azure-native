...
namespace Pulumi.AzureNextGen.Network.V20181001.Inputs
{
    ...
    public sealed class ExpressRouteCircuitSkuArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("family")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20181001.ExpressRouteCircuitSkuFamily>? Family { get; set; }
        ...
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20181001.ExpressRouteCircuitSkuTier>? Tier { get; set; }
