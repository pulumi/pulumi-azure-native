...
namespace Pulumi.AzureNative.Network.V20181001
{
    public static class GetInterfaceEndpoint
    {
        ...
        public static Task<GetInterfaceEndpointResult> InvokeAsync(GetInterfaceEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInterfaceEndpointResult>("azure-native:network/v20181001:getInterfaceEndpoint", args ?? new GetInterfaceEndpointArgs(), options.WithVersion());

        /// <summary>
        /// Interface endpoint resource.
        /// </summary>
        public static Output<GetInterfaceEndpointResult> Invoke(GetInterfaceEndpointInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetInterfaceEndpointResult>("azure-native:network/v20181001:getInterfaceEndpoint", args ?? new GetInterfaceEndpointInvokeArgs(), options.WithVersion());
    }
