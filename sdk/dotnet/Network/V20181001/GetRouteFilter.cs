...
namespace Pulumi.AzureNextGen.Network.V20181001
{
    public static class GetRouteFilter
    {
        public static Task<GetRouteFilterResult> InvokeAsync(GetRouteFilterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteFilterResult>("azure-nextgen:network/v20181001:getRouteFilter", args ?? new GetRouteFilterArgs(), options.WithVersion());
    }
