...
namespace Pulumi.AzureRM.Network.V20181001
{
    public static class GetVpnConnection
    {
        public static Task<GetVpnConnectionResult> InvokeAsync(GetVpnConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnConnectionResult>("azurerm:network/v20181001:getVpnConnection", args ?? new GetVpnConnectionArgs(), options.WithVersion());
    }
