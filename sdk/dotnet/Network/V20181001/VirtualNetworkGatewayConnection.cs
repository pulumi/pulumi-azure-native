...
namespace Pulumi.AzureRM.Network.V20181001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkGatewayConnection = new AzureRM.Network.V20181001.VirtualNetworkGatewayConnection("virtualNetworkGatewayConnection", new AzureRM.Network.V20181001.VirtualNetworkGatewayConnectionArgs
    ///         {
    ///             ConnectionProtocol = "IKEv2",
    ///             ConnectionType = "IPsec",
    ///             EnableBgp = false,
    ///             IpsecPolicies = {},
    ///             LocalNetworkGateway2 = new AzureRM.Network.V20181001.Inputs.LocalNetworkGatewayArgs
    ///             {
    ...
    ///             VirtualNetworkGateway1 = new AzureRM.Network.V20181001.Inputs.VirtualNetworkGatewayArgs
    ///             {
    ///                 Etag = "W/\"00000000-0000-0000-0000-000000000000\"",
    ...
    public partial class VirtualNetworkGatewayConnection : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGatewayConnection(string name, VirtualNetworkGatewayConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181001:VirtualNetworkGatewayConnection", name, args ?? new VirtualNetworkGatewayConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGatewayConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181001:VirtualNetworkGatewayConnection", name, null, MakeResourceOptions(options, id))
        {
        }
