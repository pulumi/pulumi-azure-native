...
namespace Pulumi.AzureNextGen.Network.V20181001
{
    public static class GetRouteTable
    {
        public static Task<GetRouteTableResult> InvokeAsync(GetRouteTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteTableResult>("azure-nextgen:network/v20181001:getRouteTable", args ?? new GetRouteTableArgs(), options.WithVersion());
    }
