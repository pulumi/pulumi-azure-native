...
namespace Pulumi.AzureRM.Network.V20181001
{
    public static class GetVirtualNetworkPeering
    {
        public static Task<GetVirtualNetworkPeeringResult> InvokeAsync(GetVirtualNetworkPeeringArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkPeeringResult>("azurerm:network/v20181001:getVirtualNetworkPeering", args ?? new GetVirtualNetworkPeeringArgs(), options.WithVersion());
    }
