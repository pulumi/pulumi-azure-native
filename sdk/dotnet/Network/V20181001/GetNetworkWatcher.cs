...
namespace Pulumi.AzureNextGen.Network.V20181001
{
    public static class GetNetworkWatcher
    {
        public static Task<GetNetworkWatcherResult> InvokeAsync(GetNetworkWatcherArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkWatcherResult>("azure-nextgen:network/v20181001:getNetworkWatcher", args ?? new GetNetworkWatcherArgs(), options.WithVersion());
    }
