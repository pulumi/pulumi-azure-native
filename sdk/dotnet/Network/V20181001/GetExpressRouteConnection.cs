...
namespace Pulumi.AzureNative.Network.V20181001
{
    public static class GetExpressRouteConnection
    {
        ...
        public static Task<GetExpressRouteConnectionResult> InvokeAsync(GetExpressRouteConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExpressRouteConnectionResult>("azure-native:network/v20181001:getExpressRouteConnection", args ?? new GetExpressRouteConnectionArgs(), options.WithVersion());
        ...
        public static Output<GetExpressRouteConnectionResult> Invoke(GetExpressRouteConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetExpressRouteConnectionResult>("azure-native:network/v20181001:getExpressRouteConnection", args ?? new GetExpressRouteConnectionInvokeArgs(), options.WithVersion());
    }
