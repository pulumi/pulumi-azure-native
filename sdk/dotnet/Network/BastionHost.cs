...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class BastionHost : Pulumi.CustomResource
    {
        ...
        public BastionHost(string name, BastionHostArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:BastionHost", name, args ?? new BastionHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BastionHost(string name, Input<string> id, BastionHostState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:BastionHost", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BastionHostArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.BastionHostPropertiesFormatArgs>? Properties { get; set; }
    ...
    public sealed class BastionHostState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.BastionHostPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
