...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class NetworkSecurityGroupSecurityRule : Pulumi.CustomResource
    {
        ...
        public NetworkSecurityGroupSecurityRule(string name, NetworkSecurityGroupSecurityRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:NetworkSecurityGroupSecurityRule", name, args ?? new NetworkSecurityGroupSecurityRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityGroupSecurityRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network:NetworkSecurityGroupSecurityRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetworkSecurityGroupSecurityRule Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new NetworkSecurityGroupSecurityRule(name, id, options);
        }
    }
