...
namespace Pulumi.AzureRM.Network.V20170501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var profile = new AzureRM.Network.V20170501.Profile("profile", new AzureRM.Network.V20170501.ProfileArgs
    ///         {
    ///             DnsConfig = new AzureRM.Network.V20170501.Inputs.DnsConfigArgs
    ///             {
    ///                 RelativeName = "azsmnet6386",
    ///                 Ttl = 35,
    ///             },
    ///             Location = "global",
    ///             MonitorConfig = new AzureRM.Network.V20170501.Inputs.MonitorConfigArgs
    ///             {
    ///                 Path = "/testpath.aspx",
    ///                 Port = 80,
    ///                 Protocol = "HTTP",
