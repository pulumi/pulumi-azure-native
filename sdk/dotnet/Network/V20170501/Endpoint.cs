...
namespace Pulumi.AzureRM.Network.V20170501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var endpoint = new AzureRM.Network.V20170501.Endpoint("endpoint", new AzureRM.Network.V20170501.EndpointArgs
    ///         {
    ...
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20170501:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20170501:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
