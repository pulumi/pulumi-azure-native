...
azure-native:network/v20170501:Endpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20180201:Endpoint to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20170501:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170501:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170501:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20170501.EndpointMonitorStatus>? EndpointMonitorStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20170501.EndpointStatus>? EndpointStatus { get; set; }
