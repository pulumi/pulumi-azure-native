...
namespace Pulumi.AzureNextGen.Network.V20170501.Inputs
{
    ...
    public sealed class MonitorConfigArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170501.ProfileMonitorStatus>? ProfileMonitorStatus { get; set; }

        /// <summary>
        /// The protocol (HTTP, HTTPS or TCP) used to probe for endpoint health.
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170501.MonitorProtocol>? Protocol { get; set; }
