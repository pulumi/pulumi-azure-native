...
namespace Pulumi.AzureNative.Network.V20210601.Inputs
{
    ...
    public sealed class RulesEngineMatchConditionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210601.RulesEngineMatchVariable> RulesEngineMatchVariable { get; set; } = null!;

        /// <summary>
        /// Describes operator to apply to the match condition.
        /// </summary>
        [Input("rulesEngineOperator", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210601.RulesEngineOperator> RulesEngineOperator { get; set; } = null!;
        ...
        [Input("transforms")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20210601.Transform>>? _transforms;

        /// <summary>
        /// List of transforms
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20210601.Transform>> Transforms
        {
            get => _transforms ?? (_transforms = new InputList<Union<string, Pulumi.AzureNative.Network.V20210601.Transform>>());
