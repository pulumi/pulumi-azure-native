...
namespace Pulumi.AzureNative.Network.V20210601.Inputs
{
    ...
    public sealed class RedirectConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210601.FrontDoorRedirectProtocol>? RedirectProtocol { get; set; }

        /// <summary>
        /// The redirect type the rule will use when redirecting traffic.
        /// </summary>
        [Input("redirectType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210601.FrontDoorRedirectType>? RedirectType { get; set; }
