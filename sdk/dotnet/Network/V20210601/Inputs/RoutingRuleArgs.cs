...
namespace Pulumi.AzureNative.Network.V20210601.Inputs
{
    ...
    public sealed class RoutingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.V20210601.FrontDoorProtocol>>? _acceptedProtocols;

        /// <summary>
        /// Protocol schemes to match for this rule
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20210601.FrontDoorProtocol>> AcceptedProtocols
        {
            get => _acceptedProtocols ?? (_acceptedProtocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20210601.FrontDoorProtocol>>());
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210601.RoutingRuleEnabledState>? EnabledState { get; set; }
