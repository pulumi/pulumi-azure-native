...
namespace Pulumi.AzureNative.Network.V20210601
{
    ...
    /// {
    ///     var policy = new AzureNative.Network.V20210601.Policy("policy", new()
    ///     {
    ///         CustomRules = new AzureNative.Network.V20210601.Inputs.CustomRuleListArgs
    ///         {
    ///             Rules = new[]
    ///             {
    ///                 new AzureNative.Network.V20210601.Inputs.CustomRuleArgs
    ///                 {
    ///                     Action = "Block",
    ///                     MatchConditions = new[]
    ///                     {
    ///                         new AzureNative.Network.V20210601.Inputs.FrontDoorMatchConditionArgs
    ///                         {
    ///                             MatchValue = new[]
    ///                             {
    ///                                 "192.168.1.0/24",
    ...
    ///             },
    ///         },
    ///         ManagedRules = new AzureNative.Network.V20210601.Inputs.ManagedRuleSetListArgs
    ///         {
    ///             ManagedRuleSets = new[]
    ///             {
    ///                 new AzureNative.Network.V20210601.Inputs.FrontDoorManagedRuleSetArgs
    ///                 {
    ///                     Exclusions = new[]
    ///                     {
    ///                         new AzureNative.Network.V20210601.Inputs.ManagedRuleExclusionArgs
    ///                         {
    ...
    ///                     {
    ///                         new AzureNative.Network.V20210601.Inputs.FrontDoorManagedRuleGroupOverrideArgs
    ///                         {
    ///                             Exclusions = new[]
    ///                             {
    ///                                 new AzureNative.Network.V20210601.Inputs.ManagedRuleExclusionArgs
    ...
    ///                             Rules = new[]
    ///                             {
    ///                                 new AzureNative.Network.V20210601.Inputs.FrontDoorManagedRuleOverrideArgs
    ///                                 {
    ///                                     Action = "Redirect",
    ...
    ///         },
    ///         PolicyName = "Policy1",
    ///         PolicySettings = new AzureNative.Network.V20210601.Inputs.FrontDoorPolicySettingsArgs
    ///         {
    ...
    ///         Sku = new AzureNative.Network.V20210601.Inputs.SkuArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210601:Policy")]
    public partial class Policy : global::Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210601:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210601:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
