...
namespace Pulumi.AzureNative.Network.V20210501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210501:VirtualApplianceSite")]
    public partial class VirtualApplianceSite : Pulumi.CustomResource
    {
        ...
        public VirtualApplianceSite(string name, VirtualApplianceSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:VirtualApplianceSite", name, args ?? new VirtualApplianceSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualApplianceSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:VirtualApplianceSite", name, null, MakeResourceOptions(options, id))
        {
        }
