...
namespace Pulumi.AzureNative.Network.V20210501
{
    ...
    /// VirtualWAN Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210501:VirtualWan")]
    public partial class VirtualWan : global::Pulumi.CustomResource
    {
        ...
        public VirtualWan(string name, VirtualWanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:VirtualWan", name, args ?? new VirtualWanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:VirtualWan", name, null, MakeResourceOptions(options, id))
        {
        }
