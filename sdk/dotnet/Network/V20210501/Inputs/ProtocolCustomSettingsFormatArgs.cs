...
namespace Pulumi.AzureNative.Network.V20210501.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210501.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210501.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
