...
namespace Pulumi.AzureNative.Network.V20210501.Inputs
{
    ...
    public sealed class NetworkRuleArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("ipProtocols")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20210501.FirewallPolicyRuleNetworkProtocol>>? _ipProtocols;

        /// <summary>
        /// Array of FirewallPolicyRuleNetworkProtocols.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20210501.FirewallPolicyRuleNetworkProtocol>> IpProtocols
        {
            get => _ipProtocols ?? (_ipProtocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20210501.FirewallPolicyRuleNetworkProtocol>>());
