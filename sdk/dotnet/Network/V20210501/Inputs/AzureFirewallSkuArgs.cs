...
namespace Pulumi.AzureNative.Network.V20210501.Inputs
{
    ...
    public sealed class AzureFirewallSkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210501.AzureFirewallSkuName>? Name { get; set; }

        /// <summary>
        /// Tier of an Azure Firewall.
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210501.AzureFirewallSkuTier>? Tier { get; set; }
