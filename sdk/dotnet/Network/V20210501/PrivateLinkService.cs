...
namespace Pulumi.AzureNative.Network.V20210501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20210501:PrivateLinkService is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PrivateLinkService to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20210501:PrivateLinkService")]
    public partial class PrivateLinkService : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkService(string name, PrivateLinkServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:PrivateLinkService", name, args ?? new PrivateLinkServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:PrivateLinkService", name, null, MakeResourceOptions(options, id))
        {
        }
