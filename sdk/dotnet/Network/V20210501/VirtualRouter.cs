...
namespace Pulumi.AzureNative.Network.V20210501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210501:VirtualRouter")]
    public partial class VirtualRouter : global::Pulumi.CustomResource
    {
        ...
        public VirtualRouter(string name, VirtualRouterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:VirtualRouter", name, args ?? new VirtualRouterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:VirtualRouter", name, null, MakeResourceOptions(options, id))
        {
        }
