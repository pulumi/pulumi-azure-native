...
namespace Pulumi.AzureNative.Network.V20210501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210501:BastionHost")]
    public partial class BastionHost : global::Pulumi.CustomResource
    {
        ...
        public BastionHost(string name, BastionHostArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:BastionHost", name, args ?? new BastionHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BastionHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:BastionHost", name, null, MakeResourceOptions(options, id))
        {
        }
