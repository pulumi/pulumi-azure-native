...
namespace Pulumi.AzureNative.Network.V20210501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210501:FirewallPolicyRuleCollectionGroup")]
    public partial class FirewallPolicyRuleCollectionGroup : global::Pulumi.CustomResource
    {
        ...
        public FirewallPolicyRuleCollectionGroup(string name, FirewallPolicyRuleCollectionGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:FirewallPolicyRuleCollectionGroup", name, args ?? new FirewallPolicyRuleCollectionGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyRuleCollectionGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:FirewallPolicyRuleCollectionGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:network:FirewallPolicyRuleCollectionGroup" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20221101:FirewallPolicyRuleCollectionGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230201:FirewallPolicyRuleCollectionGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230401:FirewallPolicyRuleCollectionGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230501:FirewallPolicyRuleCollectionGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230601:FirewallPolicyRuleCollectionGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230901:FirewallPolicyRuleCollectionGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20231101:FirewallPolicyRuleCollectionGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240101:FirewallPolicyRuleCollectionGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240301:FirewallPolicyRuleCollectionGroup" },
