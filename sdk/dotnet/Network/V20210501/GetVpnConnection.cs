...
namespace Pulumi.AzureNative.Network.V20210501
{
    public static class GetVpnConnection
    {
        ...
        public static Task<GetVpnConnectionResult> InvokeAsync(GetVpnConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnConnectionResult>("azure-native:network/v20210501:getVpnConnection", args ?? new GetVpnConnectionArgs(), options.WithVersion());

        /// <summary>
        /// VpnConnection Resource.
        /// </summary>
        public static Output<GetVpnConnectionResult> Invoke(GetVpnConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVpnConnectionResult>("azure-native:network/v20210501:getVpnConnection", args ?? new GetVpnConnectionInvokeArgs(), options.WithVersion());
    }
