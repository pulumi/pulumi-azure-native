...
namespace Pulumi.AzureNative.Network.V20210501
{
    ...
    [AzureNativeResourceType("azure-native:network/v20210501:ApplicationGateway")]
    public partial class ApplicationGateway : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGateway(string name, ApplicationGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:ApplicationGateway", name, args ?? new ApplicationGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:ApplicationGateway", name, null, MakeResourceOptions(options, id))
        {
        }
