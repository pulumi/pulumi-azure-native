...
namespace Pulumi.AzureNative.Network.V20210501
{
    public static class GetPrivateEndpoint
    {
        ...
        public static Task<GetPrivateEndpointResult> InvokeAsync(GetPrivateEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateEndpointResult>("azure-native:network/v20210501:getPrivateEndpoint", args ?? new GetPrivateEndpointArgs(), options.WithVersion());

        /// <summary>
        /// Private endpoint resource.
        /// </summary>
        public static Output<GetPrivateEndpointResult> Invoke(GetPrivateEndpointInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPrivateEndpointResult>("azure-native:network/v20210501:getPrivateEndpoint", args ?? new GetPrivateEndpointInvokeArgs(), options.WithVersion());
    }
