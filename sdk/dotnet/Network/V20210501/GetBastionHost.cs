...
namespace Pulumi.AzureNative.Network.V20210501
{
    public static class GetBastionHost
    {
        ...
        public static Task<GetBastionHostResult> InvokeAsync(GetBastionHostArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBastionHostResult>("azure-native:network/v20210501:getBastionHost", args ?? new GetBastionHostArgs(), options.WithDefaults());

        /// <summary>
        /// Bastion Host resource.
        /// </summary>
        public static Output<GetBastionHostResult> Invoke(GetBastionHostInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBastionHostResult>("azure-native:network/v20210501:getBastionHost", args ?? new GetBastionHostInvokeArgs(), options.WithDefaults());
    }
