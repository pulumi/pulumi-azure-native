...
namespace Pulumi.AzureNative.Network.V20210501
{
    ...
    [AzureNativeResourceType("azure-native:network/v20210501:HubRouteTable")]
    public partial class HubRouteTable : global::Pulumi.CustomResource
    {
        ...
        public HubRouteTable(string name, HubRouteTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:HubRouteTable", name, args ?? new HubRouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubRouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:HubRouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
