...
namespace Pulumi.AzureNative.Network.V20210501
{
    ...
    [AzureNativeResourceType("azure-native:network/v20210501:ApplicationGatewayPrivateEndpointConnection")]
    public partial class ApplicationGatewayPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGatewayPrivateEndpointConnection(string name, ApplicationGatewayPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:ApplicationGatewayPrivateEndpointConnection", name, args ?? new ApplicationGatewayPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGatewayPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:ApplicationGatewayPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
