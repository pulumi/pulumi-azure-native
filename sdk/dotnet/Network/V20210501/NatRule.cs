...
namespace Pulumi.AzureNative.Network.V20210501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210501:NatRule")]
    public partial class NatRule : Pulumi.CustomResource
    {
        ...
        public NatRule(string name, NatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:NatRule", name, args ?? new NatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210501:NatRule", name, null, MakeResourceOptions(options, id))
        {
        }
