...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class RouteTableRoute : Pulumi.CustomResource
    {
        ...
        private RouteTableRoute(string name, Input<string> id, RouteTableRouteState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:RouteTableRoute", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteTableRouteState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A unique read-only string that changes whenever the resource is updated.
        /// </summary>
        ...
        public Input<Inputs.RoutePropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
