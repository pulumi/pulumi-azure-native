...
namespace Pulumi.AzureNative.Network.V20210801
{
    public static class GetDscpConfiguration
    {
        ...
        public static Task<GetDscpConfigurationResult> InvokeAsync(GetDscpConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDscpConfigurationResult>("azure-native:network/v20210801:getDscpConfiguration", args ?? new GetDscpConfigurationArgs(), options.WithDefaults());

        /// <summary>
        /// Differentiated Services Code Point configuration for any given network interface
        /// </summary>
        public static Output<GetDscpConfigurationResult> Invoke(GetDscpConfigurationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDscpConfigurationResult>("azure-native:network/v20210801:getDscpConfiguration", args ?? new GetDscpConfigurationInvokeArgs(), options.WithDefaults());
    }
