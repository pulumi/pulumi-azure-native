...
namespace Pulumi.AzureNative.Network.V20210801.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210801.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210801.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
