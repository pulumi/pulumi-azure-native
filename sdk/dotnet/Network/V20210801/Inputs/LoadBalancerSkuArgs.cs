...
namespace Pulumi.AzureNative.Network.V20210801.Inputs
{
    ...
    public sealed class LoadBalancerSkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210801.LoadBalancerSkuName>? Name { get; set; }

        /// <summary>
        /// Tier of a load balancer SKU.
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210801.LoadBalancerSkuTier>? Tier { get; set; }
