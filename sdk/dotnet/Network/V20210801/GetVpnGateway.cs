...
namespace Pulumi.AzureNative.Network.V20210801
{
    public static class GetVpnGateway
    {
        ...
        public static Task<GetVpnGatewayResult> InvokeAsync(GetVpnGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnGatewayResult>("azure-native:network/v20210801:getVpnGateway", args ?? new GetVpnGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// VpnGateway Resource.
        /// </summary>
        public static Output<GetVpnGatewayResult> Invoke(GetVpnGatewayInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVpnGatewayResult>("azure-native:network/v20210801:getVpnGateway", args ?? new GetVpnGatewayInvokeArgs(), options.WithDefaults());
    }
