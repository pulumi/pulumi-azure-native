...
namespace Pulumi.AzureNative.Network.V20210801
{
    ...
    public static class GetRouteTable
    {
        ...
        public static Task<GetRouteTableResult> InvokeAsync(GetRouteTableArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRouteTableResult>("azure-native:network/v20210801:getRouteTable", args ?? new GetRouteTableArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified route table.
        /// </summary>
        public static Output<GetRouteTableResult> Invoke(GetRouteTableInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRouteTableResult>("azure-native:network/v20210801:getRouteTable", args ?? new GetRouteTableInvokeArgs(), options.WithDefaults());
    }
