...
namespace Pulumi.AzureNative.Network.V20210801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20210801:RoutingIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RoutingIntent to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20210801:RoutingIntent")]
    public partial class RoutingIntent : global::Pulumi.CustomResource
    {
        ...
        public RoutingIntent(string name, RoutingIntentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:RoutingIntent", name, args ?? new RoutingIntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoutingIntent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:RoutingIntent", name, null, MakeResourceOptions(options, id))
        {
        }
