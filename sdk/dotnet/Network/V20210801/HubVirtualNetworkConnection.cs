...
namespace Pulumi.AzureNative.Network.V20210801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210801:HubVirtualNetworkConnection")]
    public partial class HubVirtualNetworkConnection : global::Pulumi.CustomResource
    {
        ...
        public HubVirtualNetworkConnection(string name, HubVirtualNetworkConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:HubVirtualNetworkConnection", name, args ?? new HubVirtualNetworkConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubVirtualNetworkConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:HubVirtualNetworkConnection", name, null, MakeResourceOptions(options, id))
        {
        }
