...
namespace Pulumi.AzureNative.Network.V20210801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20210801:NetworkInterface")]
    public partial class NetworkInterface : global::Pulumi.CustomResource
    {
        ...
        public NetworkInterface(string name, NetworkInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:NetworkInterface", name, args ?? new NetworkInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:NetworkInterface", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkInterfaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("auxiliaryMode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210801.NetworkInterfaceAuxiliaryMode>? AuxiliaryMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210801.NetworkInterfaceMigrationPhase>? MigrationPhase { get; set; }
        ...
        /// </summary>
        [Input("nicType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210801.NetworkInterfaceNicType>? NicType { get; set; }
