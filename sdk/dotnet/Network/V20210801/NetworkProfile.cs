...
namespace Pulumi.AzureNative.Network.V20210801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20210801:NetworkProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkProfile to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20210801:NetworkProfile")]
    public partial class NetworkProfile : global::Pulumi.CustomResource
    {
        ...
        public NetworkProfile(string name, NetworkProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:NetworkProfile", name, args ?? new NetworkProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:NetworkProfile", name, null, MakeResourceOptions(options, id))
        {
        }
