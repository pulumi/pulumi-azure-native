...
namespace Pulumi.AzureNative.Network.V20210801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20210801:ExpressRouteConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20210801:ExpressRouteConnection")]
    public partial class ExpressRouteConnection : global::Pulumi.CustomResource
    {
        ...
        public ExpressRouteConnection(string name, ExpressRouteConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:ExpressRouteConnection", name, args ?? new ExpressRouteConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:ExpressRouteConnection", name, null, MakeResourceOptions(options, id))
        {
        }
