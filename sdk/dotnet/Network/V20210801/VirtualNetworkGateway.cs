...
namespace Pulumi.AzureNative.Network.V20210801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20210801:VirtualNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkGateway to guarantee forwards compatibility.")]
    ...
    public partial class VirtualNetworkGateway : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGateway(string name, VirtualNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:VirtualNetworkGateway", name, args ?? new VirtualNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:VirtualNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkGatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("gatewayType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210801.VirtualNetworkGatewayType>? GatewayType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20210801.VpnGatewayGeneration>? VpnGatewayGeneration { get; set; }

        /// <summary>
        /// The type of this virtual network gateway.
        /// </summary>
        [Input("vpnType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20210801.VpnType>? VpnType { get; set; }
