...
namespace Pulumi.AzureNative.Network.V20210801
{
    ...
    [AzureNativeResourceType("azure-native:network/v20210801:IpGroup")]
    public partial class IpGroup : global::Pulumi.CustomResource
    {
        ...
        public IpGroup(string name, IpGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:IpGroup", name, args ?? new IpGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210801:IpGroup", name, null, MakeResourceOptions(options, id))
        {
        }
