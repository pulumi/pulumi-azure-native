...
namespace Pulumi.AzureRM.Network.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkPeering = new AzureRM.Network.V20200501.VirtualNetworkPeering("virtualNetworkPeering", new AzureRM.Network.V20200501.VirtualNetworkPeeringArgs
    ///         {
    ...
    public partial class VirtualNetworkPeering : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkPeering(string name, VirtualNetworkPeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:VirtualNetworkPeering", name, args ?? new VirtualNetworkPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:VirtualNetworkPeering", name, null, MakeResourceOptions(options, id))
        {
        }
