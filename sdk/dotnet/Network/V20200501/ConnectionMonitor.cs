...
namespace Pulumi.AzureRM.Network.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var connectionMonitor = new AzureRM.Network.V20200501.ConnectionMonitor("connectionMonitor", new AzureRM.Network.V20200501.ConnectionMonitorArgs
    ///         {
    ///             ConnectionMonitorName = "cm1",
    ///             Destination = new AzureRM.Network.V20200501.Inputs.ConnectionMonitorDestinationArgs
    ///             {
    ///                 Address = "bing.com",
    ///                 Port = 80,
    ///             },
    ...
    ///             Source = new AzureRM.Network.V20200501.Inputs.ConnectionMonitorSourceArgs
    ///             {
    ...
    ///             Endpoints = 
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.ConnectionMonitorEndpointArgs
    ///                 {
    ///                     Name = "vm1",
    ...
    ///                 new AzureRM.Network.V20200501.Inputs.ConnectionMonitorEndpointArgs
    ///                 {
    ///                     Filter = new AzureRM.Network.V20200501.Inputs.ConnectionMonitorEndpointFilterArgs
    ///                     {
    ///                         Items = 
    ///                         {
    ///                             new AzureRM.Network.V20200501.Inputs.ConnectionMonitorEndpointFilterItemArgs
    ///                             {
    ///                                 Address = "npmuser",
    ///                                 Type = "AgentAddress",
    ///                             },
    ...
    ///             TestConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.ConnectionMonitorTestConfigurationArgs
    ///                 {
    ///                     Name = "testConfig1",
    ///                     Protocol = "Tcp",
    ///                     TcpConfiguration = new AzureRM.Network.V20200501.Inputs.ConnectionMonitorTcpConfigurationArgs
    ///                     {
    ...
    ///             TestGroups = 
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.ConnectionMonitorTestGroupArgs
    ///                 {
    ///                     Destinations = 
    ///                     {
    ///                         "bing",
    ...
    public partial class ConnectionMonitor : Pulumi.CustomResource
    {
        ...
        public ConnectionMonitor(string name, ConnectionMonitorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:ConnectionMonitor", name, args ?? new ConnectionMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:ConnectionMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
