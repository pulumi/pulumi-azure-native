...
namespace Pulumi.AzureNextGen.Network.V20200501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200501:ExpressRouteCircuitAuthorization")]
    public partial class ExpressRouteCircuitAuthorization : Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitAuthorization(string name, ExpressRouteCircuitAuthorizationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200501:ExpressRouteCircuitAuthorization", name, args ?? new ExpressRouteCircuitAuthorizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitAuthorization(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200501:ExpressRouteCircuitAuthorization", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRouteCircuitAuthorizationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200501.AuthorizationUseStatus>? AuthorizationUseStatus { get; set; }
