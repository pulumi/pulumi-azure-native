...
namespace Pulumi.AzureNative.Network.V20200501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200501:WebApplicationFirewallPolicy")]
    public partial class WebApplicationFirewallPolicy : Pulumi.CustomResource
    {
        ...
        public WebApplicationFirewallPolicy(string name, WebApplicationFirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200501:WebApplicationFirewallPolicy", name, args ?? new WebApplicationFirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApplicationFirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200501:WebApplicationFirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:WebApplicationFirewallPolicy"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:WebApplicationFirewallPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:WebApplicationFirewallPolicy"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:WebApplicationFirewallPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:WebApplicationFirewallPolicy"},
                },
            };
