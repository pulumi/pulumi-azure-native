...
namespace Pulumi.AzureNextGen.Network.V20200501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200501:VirtualNetworkTap")]
    public partial class VirtualNetworkTap : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkTap(string name, VirtualNetworkTapArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200501:VirtualNetworkTap", name, args ?? new VirtualNetworkTapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkTap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200501:VirtualNetworkTap", name, null, MakeResourceOptions(options, id))
        {
        }
