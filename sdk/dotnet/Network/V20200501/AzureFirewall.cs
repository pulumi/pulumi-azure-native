...
namespace Pulumi.AzureRM.Network.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var azureFirewall = new AzureRM.Network.V20200501.AzureFirewall("azureFirewall", new AzureRM.Network.V20200501.AzureFirewallArgs
    ///         {
    ///             ApplicationRuleCollections = 
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.AzureFirewallApplicationRuleCollectionArgs
    ///                 {
    ///                     Name = "apprulecoll",
    ///                 },
    ///             },
    ...
    ///             IpConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.AzureFirewallIPConfigurationArgs
    ///                 {
    ...
    ///             NatRuleCollections = 
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.AzureFirewallNatRuleCollectionArgs
    ///                 {
    ///                     Name = "natrulecoll",
    ///                 },
    ///             },
    ...
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.AzureFirewallNetworkRuleCollectionArgs
    ///                 {
    ///                     Name = "netrulecoll",
    ///                 },
    ///             },
    ///             ResourceGroupName = "rg1",
    ///             Sku = new AzureRM.Network.V20200501.Inputs.AzureFirewallSkuArgs
    ///             {
    ///                 Name = "AZFW_VNet",
    ///                 Tier = "Standard",
    ///             },
    ...
    ///             },
    ///             Location = "West US",
    ///             ManagementIpConfiguration = new AzureRM.Network.V20200501.Inputs.AzureFirewallIPConfigurationArgs
    ///             {
    ...
    ///         {
    ///             AzureFirewallName = "azurefirewall",
    ///             FirewallPolicy = new AzureRM.Network.V20200501.Inputs.SubResourceArgs
    ///             {
    ///                 Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/firewallPolicies/policy1",
    ///             },
    ///             HubIPAddresses = new AzureRM.Network.V20200501.Inputs.HubIPAddressesArgs
    ///             {
    ///                 PublicIPs = new AzureRM.Network.V20200501.Inputs.HubPublicIPAddressesArgs
    ///                 {
    ///                     Addresses = {},
    ///                     Count = 1,
    ///                 },
    ...
    public partial class AzureFirewall : Pulumi.CustomResource
    {
        ...
        public AzureFirewall(string name, AzureFirewallArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:AzureFirewall", name, args ?? new AzureFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureFirewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:AzureFirewall", name, null, MakeResourceOptions(options, id))
        {
        }
