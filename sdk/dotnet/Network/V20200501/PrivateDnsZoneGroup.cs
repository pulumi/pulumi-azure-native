...
namespace Pulumi.AzureNative.Network.V20200501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200501:PrivateDnsZoneGroup")]
    public partial class PrivateDnsZoneGroup : global::Pulumi.CustomResource
    {
        ...
        public PrivateDnsZoneGroup(string name, PrivateDnsZoneGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200501:PrivateDnsZoneGroup", name, args ?? new PrivateDnsZoneGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateDnsZoneGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200501:PrivateDnsZoneGroup", name, null, MakeResourceOptions(options, id))
        {
        }
