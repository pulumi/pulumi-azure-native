...
namespace Pulumi.AzureNextGen.Network.V20200501
{
    public static class GetRouteFilter
    {
        public static Task<GetRouteFilterResult> InvokeAsync(GetRouteFilterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteFilterResult>("azure-nextgen:network/v20200501:getRouteFilter", args ?? new GetRouteFilterArgs(), options.WithVersion());
    }
