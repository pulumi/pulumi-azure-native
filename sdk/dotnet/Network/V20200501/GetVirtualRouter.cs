...
{
    [Obsolete(@"azure-native:network/v20200501:VirtualRouter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualRouter to guarantee forwards compatibility.")]
    public static class GetVirtualRouter
    {
        ...
        public static Task<GetVirtualRouterResult> InvokeAsync(GetVirtualRouterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualRouterResult>("azure-native:network/v20200501:getVirtualRouter", args ?? new GetVirtualRouterArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified Virtual Router.
        /// </summary>
        public static Output<GetVirtualRouterResult> Invoke(GetVirtualRouterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVirtualRouterResult>("azure-native:network/v20200501:getVirtualRouter", args ?? new GetVirtualRouterInvokeArgs(), options.WithDefaults());
    }
