...
namespace Pulumi.AzureNextGen.Network.V20200501
{
    public static class GetSubnet
    {
        public static Task<GetSubnetResult> InvokeAsync(GetSubnetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSubnetResult>("azure-nextgen:network/v20200501:getSubnet", args ?? new GetSubnetArgs(), options.WithVersion());
    }
    ...
    public sealed class GetSubnetResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.SubResourceInvokeResponseResult> IpAllocations;
        /// <summary>
        ...
        private GetSubnetResult(
            ...
            ImmutableArray<Outputs.SubResourceInvokeResponseResult> ipAllocations,
