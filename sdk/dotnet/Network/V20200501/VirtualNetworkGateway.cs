...
namespace Pulumi.AzureRM.Network.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkGateway = new AzureRM.Network.V20200501.VirtualNetworkGateway("virtualNetworkGateway", new AzureRM.Network.V20200501.VirtualNetworkGatewayArgs
    ///         {
    ///             ActiveActive = false,
    ///             BgpSettings = new AzureRM.Network.V20200501.Inputs.BgpSettingsArgs
    ///             {
    ///                 Asn = 65515,
    ///                 BgpPeeringAddress = "10.0.1.30",
    ///                 PeerWeight = 0,
    ///             },
    ///             CustomRoutes = new AzureRM.Network.V20200501.Inputs.AddressSpaceArgs
    ///             {
    ///                 AddressPrefixes = 
    ///                 {
    ///                     "101.168.0.6/32",
    ...
    ///             IpConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.VirtualNetworkGatewayIPConfigurationArgs
    ///                 {
    ///                     Name = "gwipconfig1",
    ///                 },
    ///             },
    ...
    ///             Sku = new AzureRM.Network.V20200501.Inputs.VirtualNetworkGatewaySkuArgs
    ///             {
    ///                 Name = "VpnGw1",
    ///                 Tier = "VpnGw1",
    ///             },
    ///             VirtualNetworkGatewayName = "vpngw",
    ///             VpnClientConfiguration = new AzureRM.Network.V20200501.Inputs.VpnClientConfigurationArgs
    ///             {
    ///                 RadiusServers = 
    ///                 {
    ///                     new AzureRM.Network.V20200501.Inputs.RadiusServerArgs
    ///                     {
    ...
    public partial class VirtualNetworkGateway : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGateway(string name, VirtualNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:VirtualNetworkGateway", name, args ?? new VirtualNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:VirtualNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
