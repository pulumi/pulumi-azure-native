...
namespace Pulumi.AzureRM.Network.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var p2sVpnGateway = new AzureRM.Network.V20200501.P2sVpnGateway("p2sVpnGateway", new AzureRM.Network.V20200501.P2sVpnGatewayArgs
    ///         {
    ///             CustomDnsServers = 
    ///             {
    ///                 "1.1.1.1",
    ...
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.P2SConnectionConfigurationArgs
    ///                 {
    ...
    ///             VpnServerConfiguration = new AzureRM.Network.V20200501.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class P2sVpnGateway : Pulumi.CustomResource
    {
        ...
        public P2sVpnGateway(string name, P2sVpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:P2sVpnGateway", name, args ?? new P2sVpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private P2sVpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:P2sVpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
