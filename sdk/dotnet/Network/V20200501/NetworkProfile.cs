...
namespace Pulumi.AzureRM.Network.V20200501
{
    ...
    public partial class NetworkProfile : Pulumi.CustomResource
    {
        ...
        public NetworkProfile(string name, NetworkProfileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:NetworkProfile", name, args ?? new NetworkProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:NetworkProfile", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:network/latest:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/preview:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20180801:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20181001:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20181101:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20181201:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190201:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190401:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190601:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190701:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190801:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190901:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20191101:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20191201:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200301:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200401:NetworkProfile"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200601:NetworkProfile"},
                },
            };
