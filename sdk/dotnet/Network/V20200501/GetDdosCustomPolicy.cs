...
namespace Pulumi.AzureNextGen.Network.V20200501
{
    public static class GetDdosCustomPolicy
    {
        public static Task<GetDdosCustomPolicyResult> InvokeAsync(GetDdosCustomPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDdosCustomPolicyResult>("azure-nextgen:network/v20200501:getDdosCustomPolicy", args ?? new GetDdosCustomPolicyArgs(), options.WithVersion());
    }
