...
namespace Pulumi.AzureNextGen.Network.V20200501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200501:NatGateway")]
    public partial class NatGateway : Pulumi.CustomResource
    {
        ...
        public NatGateway(string name, NatGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200501:NatGateway", name, args ?? new NatGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200501:NatGateway", name, null, MakeResourceOptions(options, id))
        {
        }
