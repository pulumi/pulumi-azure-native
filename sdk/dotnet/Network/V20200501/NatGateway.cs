...
namespace Pulumi.AzureRM.Network.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var natGateway = new AzureRM.Network.V20200501.NatGateway("natGateway", new AzureRM.Network.V20200501.NatGatewayArgs
    ///         {
    ///             Location = "westus",
    ...
    ///             Sku = new AzureRM.Network.V20200501.Inputs.NatGatewaySkuArgs
    ///             {
    ///                 Name = "Standard",
    ///             },
    ///         });
    ...
    public partial class NatGateway : Pulumi.CustomResource
    {
        ...
        public NatGateway(string name, NatGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:NatGateway", name, args ?? new NatGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:NatGateway", name, null, MakeResourceOptions(options, id))
        {
        }
