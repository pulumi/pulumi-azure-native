...
namespace Pulumi.AzureNative.Network.V20200501
{
    ...
    /// {
    ///     var rulesEngine = new AzureNative.Network.V20200501.RulesEngine("rulesEngine", new()
    ///     {
    ///         FrontDoorName = "frontDoor1",
    ///         ResourceGroupName = "rg1",
    ///         Rules = new[]
    ///         {
    ///             new AzureNative.Network.V20200501.Inputs.RulesEngineRuleArgs
    ///             {
    ///                 Action = new AzureNative.Network.V20200501.Inputs.RulesEngineActionArgs
    ///                 {
    ///                     RouteConfigurationOverride = new AzureNative.Network.V20200501.Inputs.RedirectConfigurationArgs
    ///                     {
    ...
    ///                 MatchConditions = new[]
    ///                 {
    ///                     new AzureNative.Network.V20200501.Inputs.RulesEngineMatchConditionArgs
    ///                     {
    ...
    ///                     {
    ///                         new AzureNative.Network.V20200501.Inputs.HeaderActionArgs
    ///                         {
    ...
    ///                 Action = new AzureNative.Network.V20200501.Inputs.RulesEngineActionArgs
    ///                 {
    ///                     RouteConfigurationOverride = new AzureNative.Network.V20200501.Inputs.ForwardingConfigurationArgs
    ///                     {
    ///                         BackendPool = new AzureNative.Network.V20200501.Inputs.SubResourceArgs
    ///                         {
    ///                             Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoors/frontDoor1/backendPools/backendPool1",
    ///                         },
    ///                         CacheConfiguration = new AzureNative.Network.V20200501.Inputs.CacheConfigurationArgs
    ///                         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200501:RulesEngine")]
    public partial class RulesEngine : global::Pulumi.CustomResource
    {
        ...
        public RulesEngine(string name, RulesEngineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200501:RulesEngine", name, args ?? new RulesEngineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RulesEngine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200501:RulesEngine", name, null, MakeResourceOptions(options, id))
        {
        }
