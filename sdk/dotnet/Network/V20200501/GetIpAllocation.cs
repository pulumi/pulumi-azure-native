...
namespace Pulumi.AzureNextGen.Network.V20200501
{
    public static class GetIpAllocation
    {
        public static Task<GetIpAllocationResult> InvokeAsync(GetIpAllocationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIpAllocationResult>("azure-nextgen:network/v20200501:getIpAllocation", args ?? new GetIpAllocationArgs(), options.WithVersion());
    }
