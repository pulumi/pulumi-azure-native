...
namespace Pulumi.AzureNative.Network.V20200501
{
    public static class GetIpAllocation
    {
        ...
        public static Task<GetIpAllocationResult> InvokeAsync(GetIpAllocationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIpAllocationResult>("azure-native:network/v20200501:getIpAllocation", args ?? new GetIpAllocationArgs(), options.WithDefaults());

        /// <summary>
        /// IpAllocation resource.
        /// </summary>
        public static Output<GetIpAllocationResult> Invoke(GetIpAllocationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIpAllocationResult>("azure-native:network/v20200501:getIpAllocation", args ?? new GetIpAllocationInvokeArgs(), options.WithDefaults());
    }
