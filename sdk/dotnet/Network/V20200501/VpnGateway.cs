...
namespace Pulumi.AzureNextGen.Network.V20200501
{
    ...
    /// VpnGateway Resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200501:VpnGateway")]
    public partial class VpnGateway : Pulumi.CustomResource
    {
        ...
        public VpnGateway(string name, VpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200501:VpnGateway", name, args ?? new VpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200501:VpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
