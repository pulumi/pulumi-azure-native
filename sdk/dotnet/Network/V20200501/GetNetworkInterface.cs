...
namespace Pulumi.AzureNative.Network.V20200501
{
    public static class GetNetworkInterface
    {
        ...
        public static Task<GetNetworkInterfaceResult> InvokeAsync(GetNetworkInterfaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkInterfaceResult>("azure-native:network/v20200501:getNetworkInterface", args ?? new GetNetworkInterfaceArgs(), options.WithVersion());

        /// <summary>
        /// A network interface in a resource group.
        /// </summary>
        public static Output<GetNetworkInterfaceResult> Invoke(GetNetworkInterfaceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNetworkInterfaceResult>("azure-native:network/v20200501:getNetworkInterface", args ?? new GetNetworkInterfaceInvokeArgs(), options.WithVersion());
    }
