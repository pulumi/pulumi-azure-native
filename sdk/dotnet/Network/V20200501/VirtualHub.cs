...
namespace Pulumi.AzureRM.Network.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualHub = new AzureRM.Network.V20200501.VirtualHub("virtualHub", new AzureRM.Network.V20200501.VirtualHubArgs
    ///         {
    ...
    ///             VirtualWan = new AzureRM.Network.V20200501.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class VirtualHub : Pulumi.CustomResource
    {
        ...
        public VirtualHub(string name, VirtualHubArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:VirtualHub", name, args ?? new VirtualHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:VirtualHub", name, null, MakeResourceOptions(options, id))
        {
        }
