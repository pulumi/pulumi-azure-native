...
namespace Pulumi.AzureNextGen.Network.V20200501
{
    ...
    /// A flow log resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200501:FlowLog")]
    public partial class FlowLog : Pulumi.CustomResource
    {
        ...
        public FlowLog(string name, FlowLogArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200501:FlowLog", name, args ?? new FlowLogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FlowLog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200501:FlowLog", name, null, MakeResourceOptions(options, id))
        {
        }
