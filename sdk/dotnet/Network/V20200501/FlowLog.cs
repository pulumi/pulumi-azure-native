...
namespace Pulumi.AzureRM.Network.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var flowLog = new AzureRM.Network.V20200501.FlowLog("flowLog", new AzureRM.Network.V20200501.FlowLogArgs
    ///         {
    ///             Enabled = true,
    ///             FlowLogName = "fl",
    ///             Format = new AzureRM.Network.V20200501.Inputs.FlowLogFormatParametersArgs
    ///             {
    ///                 Type = "JSON",
    ///                 Version = 1,
    ///             },
    ...
    public partial class FlowLog : Pulumi.CustomResource
    {
        ...
        public FlowLog(string name, FlowLogArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:FlowLog", name, args ?? new FlowLogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FlowLog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:FlowLog", name, null, MakeResourceOptions(options, id))
        {
        }
