...
namespace Pulumi.AzureNative.Network.V20200501
{
    ...
    /// {
    ///     var frontDoor = new AzureNative.Network.V20200501.FrontDoor("frontDoor", new()
    ///     {
    ///         BackendPools = new[]
    ///         {
    ///             new AzureNative.Network.V20200501.Inputs.BackendPoolArgs
    ///             {
    ///                 Backends = new[]
    ///                 {
    ///                     new AzureNative.Network.V20200501.Inputs.BackendArgs
    ///                     {
    ...
    ///                     },
    ///                 },
    ///                 HealthProbeSettings = new AzureNative.Network.V20200501.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoors/frontDoor1/healthProbeSettings/healthProbeSettings1",
    ///                 },
    ///                 LoadBalancingSettings = new AzureNative.Network.V20200501.Inputs.SubResourceArgs
    ///                 {
    ...
    ///             },
    ///         },
    ///         BackendPoolsSettings = new AzureNative.Network.V20200501.Inputs.BackendPoolsSettingsArgs
    ///         {
    ...
    ///         {
    ///             new AzureNative.Network.V20200501.Inputs.FrontendEndpointArgs
    ///             {
    ///                 HostName = "www.contoso.com",
    ///                 Name = "frontendEndpoint1",
    ///                 SessionAffinityEnabledState = "Enabled",
    ///                 SessionAffinityTtlSeconds = 60,
    ///                 WebApplicationFirewallPolicyLink = new AzureNative.Network.V20200501.Inputs.FrontendEndpointUpdateParametersWebApplicationFirewallPolicyLinkArgs
    ///                 {
    ...
    ///         {
    ///             new AzureNative.Network.V20200501.Inputs.HealthProbeSettingsModelArgs
    ///             {
    ///                 EnabledState = "Enabled",
    ...
    ///         {
    ///             new AzureNative.Network.V20200501.Inputs.LoadBalancingSettingsModelArgs
    ///             {
    ...
    ///         RoutingRules = new[]
    ///         {
    ///             new AzureNative.Network.V20200501.Inputs.RoutingRuleArgs
    ///             {
    ...
    ///                 FrontendEndpoints = new[]
    ///                 {
    ///                     new AzureNative.Network.V20200501.Inputs.SubResourceArgs
    ///                     {
    ...
    ///                     "/*",
    ///                 },
    ///                 RouteConfiguration = new AzureNative.Network.V20200501.Inputs.ForwardingConfigurationArgs
    ///                 {
    ///                     BackendPool = new AzureNative.Network.V20200501.Inputs.SubResourceArgs
    ///                     {
    ///                         Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoors/frontDoor1/backendPools/backendPool1",
    ///                     },
    ///                     OdataType = "#Microsoft.Azure.FrontDoor.Models.FrontdoorForwardingConfiguration",
    ///                 },
    ///                 RulesEngine = new AzureNative.Network.V20200501.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoors/frontDoor1/rulesEngines/rulesEngine1",
    ///                 },
    ///                 WebApplicationFirewallPolicyLink = new AzureNative.Network.V20200501.Inputs.RoutingRuleUpdateParametersWebApplicationFirewallPolicyLinkArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoorWebApplicationFirewallPolicies/policy1",
    ///                 },
    ///             },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200501:FrontDoor")]
    public partial class FrontDoor : global::Pulumi.CustomResource
    {
        ...
        public FrontDoor(string name, FrontDoorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200501:FrontDoor", name, args ?? new FrontDoorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FrontDoor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200501:FrontDoor", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FrontDoorArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200501.FrontDoorEnabledState>? EnabledState { get; set; }
