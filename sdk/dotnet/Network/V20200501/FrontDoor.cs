...
namespace Pulumi.AzureRM.Network.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var frontDoor = new AzureRM.Network.V20200501.FrontDoor("frontDoor", new AzureRM.Network.V20200501.FrontDoorArgs
    ///         {
    ///             BackendPools = 
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.BackendPoolArgs
    ///                 {
    ///                     Name = "backendPool1",
    ///                 },
    ///             },
    ///             BackendPoolsSettings = new AzureRM.Network.V20200501.Inputs.BackendPoolsSettingsArgs
    ///             {
    ...
    ///             FrontendEndpoints = 
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.FrontendEndpointArgs
    ///                 {
    ...
    ///             HealthProbeSettings = 
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.HealthProbeSettingsModelArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.LoadBalancingSettingsModelArgs
    ///                 {
    ...
    ///             RoutingRules = 
    ///             {
    ///                 new AzureRM.Network.V20200501.Inputs.RoutingRuleArgs
    ///                 {
    ///                     Name = "routingRule1",
    ///                 },
    ///             },
    ...
    public partial class FrontDoor : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("rulesEngines")]
        public Output<ImmutableArray<Outputs.RulesEngineResponseResult>> RulesEngines { get; private set; } = null!;
        ...
        public FrontDoor(string name, FrontDoorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:FrontDoor", name, args ?? new FrontDoorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FrontDoor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:FrontDoor", name, null, MakeResourceOptions(options, id))
        {
        }
