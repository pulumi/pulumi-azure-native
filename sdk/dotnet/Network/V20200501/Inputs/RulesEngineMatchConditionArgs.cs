...
namespace Pulumi.AzureNative.Network.V20200501.Inputs
{
    ...
    public sealed class RulesEngineMatchConditionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200501.RulesEngineMatchVariable> RulesEngineMatchVariable { get; set; } = null!;

        /// <summary>
        /// Describes operator to apply to the match condition.
        /// </summary>
        [Input("rulesEngineOperator", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200501.RulesEngineOperator> RulesEngineOperator { get; set; } = null!;
        ...
        [Input("transforms")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20200501.Transform>>? _transforms;

        /// <summary>
        /// List of transforms
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20200501.Transform>> Transforms
        {
            get => _transforms ?? (_transforms = new InputList<Union<string, Pulumi.AzureNative.Network.V20200501.Transform>>());
