...
namespace Pulumi.AzureNative.Network.V20200501.Inputs
{
    ...
    public sealed class PolicySettingsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200501.WebApplicationFirewallMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200501.WebApplicationFirewallEnabledState>? State { get; set; }
