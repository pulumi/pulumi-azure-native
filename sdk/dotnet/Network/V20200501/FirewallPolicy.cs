...
namespace Pulumi.AzureRM.Network.V20200501
{
    ...
    public partial class FirewallPolicy : Pulumi.CustomResource
    {
        ...
        public FirewallPolicy(string name, FirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:FirewallPolicy", name, args ?? new FirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:FirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:network/v20190601:FirewallPolicy"},
                    new Alias { Type = "azurerm:network/v20190701:FirewallPolicy"},
                    new Alias { Type = "azurerm:network/v20190801:FirewallPolicy"},
                    new Alias { Type = "azurerm:network/v20190901:FirewallPolicy"},
                    new Alias { Type = "azurerm:network/v20191101:FirewallPolicy"},
                    new Alias { Type = "azurerm:network/v20191201:FirewallPolicy"},
                    new Alias { Type = "azurerm:network/v20200301:FirewallPolicy"},
                    new Alias { Type = "azurerm:network/v20200401:FirewallPolicy"},
                    new Alias { Type = "azurerm:network/v20200601:FirewallPolicy"},
                },
            };
