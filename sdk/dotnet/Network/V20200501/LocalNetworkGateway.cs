...
namespace Pulumi.AzureNative.Network.V20200501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200501:LocalNetworkGateway")]
    public partial class LocalNetworkGateway : Pulumi.CustomResource
    {
        ...
        public LocalNetworkGateway(string name, LocalNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200501:LocalNetworkGateway", name, args ?? new LocalNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200501:LocalNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
