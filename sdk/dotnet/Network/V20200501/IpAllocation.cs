...
namespace Pulumi.AzureNextGen.Network.V20200501
{
    ...
    public partial class IpAllocation : Pulumi.CustomResource
    {
        ...
        public IpAllocation(string name, IpAllocationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200501:IpAllocation", name, args ?? new IpAllocationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpAllocation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200501:IpAllocation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IpAllocationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("prefixType")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200501.IPVersion>? PrefixType { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200501.IpAllocationType>? Type { get; set; }
