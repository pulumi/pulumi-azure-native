...
namespace Pulumi.AzureRM.Network.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var route = new AzureRM.Network.V20200501.Route("route", new AzureRM.Network.V20200501.RouteArgs
    ///         {
    ...
    public partial class Route : Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200501:Route", name, null, MakeResourceOptions(options, id))
        {
        }
