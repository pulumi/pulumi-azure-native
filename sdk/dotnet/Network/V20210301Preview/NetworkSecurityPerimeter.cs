...
namespace Pulumi.AzureNative.Network.V20210301Preview
{
    ...
    public partial class NetworkSecurityPerimeter : global::Pulumi.CustomResource
    {
        ...
        public NetworkSecurityPerimeter(string name, NetworkSecurityPerimeterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210301preview:NetworkSecurityPerimeter", name, args ?? new NetworkSecurityPerimeterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityPerimeter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20210301preview:NetworkSecurityPerimeter", name, null, MakeResourceOptions(options, id))
        {
        }
