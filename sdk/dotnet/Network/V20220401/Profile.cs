...
namespace Pulumi.AzureNative.Network.V20220401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20220401:Profile")]
    public partial class Profile : global::Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20220401:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.V20220401.AllowedEndpointRecordType>>? _allowedEndpointRecordTypes;

        /// <summary>
        /// The list of allowed endpoint record types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20220401.AllowedEndpointRecordType>> AllowedEndpointRecordTypes
        {
            get => _allowedEndpointRecordTypes ?? (_allowedEndpointRecordTypes = new InputList<Union<string, Pulumi.AzureNative.Network.V20220401.AllowedEndpointRecordType>>());
        ...
        /// </summary>
        [Input("profileStatus")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220401.ProfileStatus>? ProfileStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20220401.TrafficRoutingMethod>? TrafficRoutingMethod { get; set; }

        /// <summary>
        /// Indicates whether Traffic View is 'Enabled' or 'Disabled' for the Traffic Manager profile. Null, indicates 'Disabled'. Enabling this feature will increase the cost of the Traffic Manage profile.
        /// </summary>
        [Input("trafficViewEnrollmentStatus")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20220401.TrafficViewEnrollmentStatus>? TrafficViewEnrollmentStatus { get; set; }
