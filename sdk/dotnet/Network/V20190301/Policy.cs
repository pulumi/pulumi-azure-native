...
namespace Pulumi.AzureNative.Network.V20190301
{
    ...
    public partial class Policy : global::Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190301:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190301:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
