...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class Connection : Pulumi.CustomResource
    {
        ...
        public Connection(string name, ConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:Connection", name, args ?? new ConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connection(string name, Input<string> id, ConnectionState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:Connection", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectionState : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties", required: true)]
        public Input<Inputs.VirtualNetworkGatewayConnectionPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
