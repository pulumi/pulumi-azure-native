...
namespace Pulumi.AzureNative.Network.V20230901
{
    public static class GetAdminRule
    {
        ...
        public static Task<GetAdminRuleResult> InvokeAsync(GetAdminRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAdminRuleResult>("azure-native:network/v20230901:getAdminRule", args ?? new GetAdminRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a network manager security configuration admin rule.
        /// </summary>
        public static Output<GetAdminRuleResult> Invoke(GetAdminRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAdminRuleResult>("azure-native:network/v20230901:getAdminRule", args ?? new GetAdminRuleInvokeArgs(), options.WithDefaults());
