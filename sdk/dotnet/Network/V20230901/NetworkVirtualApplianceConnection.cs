...
namespace Pulumi.AzureNative.Network.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230901:NetworkVirtualApplianceConnection")]
    public partial class NetworkVirtualApplianceConnection : global::Pulumi.CustomResource
    {
        ...
        public NetworkVirtualApplianceConnection(string name, NetworkVirtualApplianceConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230901:NetworkVirtualApplianceConnection", name, args ?? new NetworkVirtualApplianceConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkVirtualApplianceConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230901:NetworkVirtualApplianceConnection", name, null, MakeResourceOptions(options, id))
        {
        }
