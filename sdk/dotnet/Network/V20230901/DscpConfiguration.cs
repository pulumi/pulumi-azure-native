...
namespace Pulumi.AzureNative.Network.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230901:DscpConfiguration")]
    public partial class DscpConfiguration : global::Pulumi.CustomResource
    {
        ...
        public DscpConfiguration(string name, DscpConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230901:DscpConfiguration", name, args ?? new DscpConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DscpConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230901:DscpConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
