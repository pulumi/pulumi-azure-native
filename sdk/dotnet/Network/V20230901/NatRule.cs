...
namespace Pulumi.AzureNative.Network.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230901:NatRule")]
    public partial class NatRule : global::Pulumi.CustomResource
    {
        ...
        public NatRule(string name, NatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230901:NatRule", name, args ?? new NatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230901:NatRule", name, null, MakeResourceOptions(options, id))
        {
        }
