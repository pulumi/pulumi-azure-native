...
namespace Pulumi.AzureNative.Network.V20230901
{
    public static class GetNetworkManager
    {
        ...
        public static Task<GetNetworkManagerResult> InvokeAsync(GetNetworkManagerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkManagerResult>("azure-native:network/v20230901:getNetworkManager", args ?? new GetNetworkManagerArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified Network Manager.
        /// </summary>
        public static Output<GetNetworkManagerResult> Invoke(GetNetworkManagerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkManagerResult>("azure-native:network/v20230901:getNetworkManager", args ?? new GetNetworkManagerInvokeArgs(), options.WithDefaults());
