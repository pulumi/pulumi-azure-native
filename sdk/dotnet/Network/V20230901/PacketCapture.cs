...
namespace Pulumi.AzureNative.Network.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230901:PacketCapture")]
    public partial class PacketCapture : global::Pulumi.CustomResource
    {
        ...
        public PacketCapture(string name, PacketCaptureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230901:PacketCapture", name, args ?? new PacketCaptureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCapture(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230901:PacketCapture", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PacketCaptureArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("targetType")]
        public Input<Pulumi.AzureNative.Network.V20230901.PacketCaptureTargetType>? TargetType { get; set; }
