...
namespace Pulumi.AzureNative.Network.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230901:FirewallPolicy")]
    public partial class FirewallPolicy : global::Pulumi.CustomResource
    {
        ...
        public FirewallPolicy(string name, FirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230901:FirewallPolicy", name, args ?? new FirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230901:FirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
