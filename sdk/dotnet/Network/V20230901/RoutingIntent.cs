...
namespace Pulumi.AzureNative.Network.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230901:RoutingIntent")]
    public partial class RoutingIntent : global::Pulumi.CustomResource
    {
        ...
        public RoutingIntent(string name, RoutingIntentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230901:RoutingIntent", name, args ?? new RoutingIntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoutingIntent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230901:RoutingIntent", name, null, MakeResourceOptions(options, id))
        {
        }
