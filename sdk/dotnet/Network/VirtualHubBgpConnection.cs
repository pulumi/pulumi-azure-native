...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class VirtualHubBgpConnection : Pulumi.CustomResource
    {
        ...
        public VirtualHubBgpConnection(string name, VirtualHubBgpConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:VirtualHubBgpConnection", name, args ?? new VirtualHubBgpConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubBgpConnection(string name, Input<string> id, VirtualHubBgpConnectionState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:VirtualHubBgpConnection", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualHubBgpConnection Get(string name, Input<string> id, VirtualHubBgpConnectionState? state = null, CustomResourceOptions? options = null)
        {
            return new VirtualHubBgpConnection(name, id, state, options);
        }
    }
    ...
    public sealed class VirtualHubBgpConnectionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A unique read-only string that changes whenever the resource is updated.
        /// </summary>
        ...
        public Input<Inputs.BgpConnectionPropertiesResponseGetArgs> Properties { get; set; } = null!;
        ...
        public VirtualHubBgpConnectionState()
        {
        }
    }
}
