...
namespace Pulumi.AzureNextGen.Network.V20180401
{
    public static class GetVirtualNetworkGatewayLearnedRoutes
    {
        public static Task<GetVirtualNetworkGatewayLearnedRoutesResult> InvokeAsync(GetVirtualNetworkGatewayLearnedRoutesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkGatewayLearnedRoutesResult>("azure-nextgen:network/v20180401:getVirtualNetworkGatewayLearnedRoutes", args ?? new GetVirtualNetworkGatewayLearnedRoutesArgs(), options.WithVersion());
    }
    ...
    public sealed class GetVirtualNetworkGatewayLearnedRoutesResult
    {
        ...
        [OutputConstructor]
        private GetVirtualNetworkGatewayLearnedRoutesResult(ImmutableArray<Outputs.GatewayRouteInvokeResponseResult> value)
        {
            Value = value;
        }
    }
