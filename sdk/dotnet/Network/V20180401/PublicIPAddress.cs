...
namespace Pulumi.AzureNative.Network.V20180401
{
    ...
    [AzureNativeResourceType("azure-native:network/v20180401:PublicIPAddress")]
    public partial class PublicIPAddress : Pulumi.CustomResource
    {
        ...
        public PublicIPAddress(string name, PublicIPAddressArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:PublicIPAddress", name, args ?? new PublicIPAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:PublicIPAddress", name, null, MakeResourceOptions(options, id))
        {
        }
