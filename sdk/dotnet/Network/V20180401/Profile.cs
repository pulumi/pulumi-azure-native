...
namespace Pulumi.AzureRM.Network.V20180401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var profile = new AzureRM.Network.V20180401.Profile("profile", new AzureRM.Network.V20180401.ProfileArgs
    ///         {
    ///             DnsConfig = new AzureRM.Network.V20180401.Inputs.DnsConfigArgs
    ///             {
    ///                 RelativeName = "azsmnet6386",
    ///                 Ttl = 35,
    ///             },
    ///             Location = "global",
    ///             MonitorConfig = new AzureRM.Network.V20180401.Inputs.MonitorConfigArgs
    ///             {
    ///                 Path = "/testpath.aspx",
    ///                 Port = 80,
    ///                 Protocol = "HTTP",
    ...
    ///             Endpoints = 
    ///             {
    ///                 new AzureRM.Network.V20180401.Inputs.EndpointArgs
    ///                 {
    ...
    ///                 CustomHeaders = 
    ///                 {
    ///                     new AzureRM.Network.V20180401.Inputs.MonitorConfigCustomHeadersArgs
    ///                     {
    ///                         Name = "header-1",
    ///                         Value = "value-1",
    ///                     },
    ...
    ///                 {
    ///                     new AzureRM.Network.V20180401.Inputs.MonitorConfigExpectedStatusCodeRangesArgs
    ///                     {
    ///                         Max = 205,
    ///                         Min = 200,
    ///                     },
    ...
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180401:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180401:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
