...
namespace Pulumi.AzureNextGen.Network.V20180401
{
    ...
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180401:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180401:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProfileArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("profileStatus")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20180401.ProfileStatus>? ProfileStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20180401.TrafficRoutingMethod>? TrafficRoutingMethod { get; set; }

        /// <summary>
        /// Indicates whether Traffic View is 'Enabled' or 'Disabled' for the Traffic Manager profile. Null, indicates 'Disabled'. Enabling this feature will increase the cost of the Traffic Manage profile.
        /// </summary>
        [Input("trafficViewEnrollmentStatus")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20180401.TrafficViewEnrollmentStatus>? TrafficViewEnrollmentStatus { get; set; }
