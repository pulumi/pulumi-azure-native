...
namespace Pulumi.AzureNextGen.Network.V20180401
{
    public static class GetVirtualHub
    {
        public static Task<GetVirtualHubResult> InvokeAsync(GetVirtualHubArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualHubResult>("azure-nextgen:network/v20180401:getVirtualHub", args ?? new GetVirtualHubArgs(), options.WithVersion());
    }
