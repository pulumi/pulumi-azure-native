...
namespace Pulumi.AzureNative.Network.V20180401
{
    ...
    [AzureNativeResourceType("azure-native:network/v20180401:NetworkWatcher")]
    public partial class NetworkWatcher : Pulumi.CustomResource
    {
        ...
        public NetworkWatcher(string name, NetworkWatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:NetworkWatcher", name, args ?? new NetworkWatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkWatcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:NetworkWatcher", name, null, MakeResourceOptions(options, id))
        {
        }
