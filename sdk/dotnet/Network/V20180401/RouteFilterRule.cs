...
namespace Pulumi.AzureNative.Network.V20180401
{
    ...
    [AzureNativeResourceType("azure-native:network/v20180401:RouteFilterRule")]
    public partial class RouteFilterRule : global::Pulumi.CustomResource
    {
        ...
        public RouteFilterRule(string name, RouteFilterRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:RouteFilterRule", name, args ?? new RouteFilterRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilterRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:RouteFilterRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteFilterRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20180401.Access> Access { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20180401.RouteFilterRuleType> RouteFilterRuleType { get; set; } = null!;
