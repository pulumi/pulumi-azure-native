...
namespace Pulumi.AzureNextGen.Network.V20180401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20180401:LoadBalancer")]
    public partial class LoadBalancer : Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180401:LoadBalancer", name, args ?? new LoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180401:LoadBalancer", name, null, MakeResourceOptions(options, id))
        {
        }
