...
namespace Pulumi.AzureNative.Network.V20180401
{
    public static class GetVirtualNetwork
    {
        ...
        public static Task<GetVirtualNetworkResult> InvokeAsync(GetVirtualNetworkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkResult>("azure-native:network/v20180401:getVirtualNetwork", args ?? new GetVirtualNetworkArgs(), options.WithVersion());

        /// <summary>
        /// Virtual Network resource.
        /// </summary>
        public static Output<GetVirtualNetworkResult> Invoke(GetVirtualNetworkInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVirtualNetworkResult>("azure-native:network/v20180401:getVirtualNetwork", args ?? new GetVirtualNetworkInvokeArgs(), options.WithVersion());
    }
