...
azure-native:network/v20180401:TrafficManagerUserMetricsKey is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220401preview:TrafficManagerUserMetricsKey to guarantee forwards compatibility.")]
    public static class GetTrafficManagerUserMetricsKey
    {
        ...
        public static Task<GetTrafficManagerUserMetricsKeyResult> InvokeAsync(GetTrafficManagerUserMetricsKeyArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTrafficManagerUserMetricsKeyResult>("azure-native:network/v20180401:getTrafficManagerUserMetricsKey", args ?? new GetTrafficManagerUserMetricsKeyArgs(), options.WithDefaults());
    }
