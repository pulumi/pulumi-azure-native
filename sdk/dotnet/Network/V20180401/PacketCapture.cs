...
namespace Pulumi.AzureRM.Network.V20180401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var packetCapture = new AzureRM.Network.V20180401.PacketCapture("packetCapture", new AzureRM.Network.V20180401.PacketCaptureArgs
    ///         {
    ///             BytesToCapturePerPacket = 10000,
    ///             Filters = 
    ///             {
    ///                 new AzureRM.Network.V20180401.Inputs.PacketCaptureFilterArgs
    ///                 {
    ...
    ///             StorageLocation = new AzureRM.Network.V20180401.Inputs.PacketCaptureStorageLocationArgs
    ///             {
    ...
    public partial class PacketCapture : Pulumi.CustomResource
    {
        ...
        public PacketCapture(string name, PacketCaptureArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180401:PacketCapture", name, args ?? new PacketCaptureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCapture(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180401:PacketCapture", name, null, MakeResourceOptions(options, id))
        {
        }
