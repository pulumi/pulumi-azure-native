...
namespace Pulumi.AzureRM.Network.V20180401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnGateway = new AzureRM.Network.V20180401.VpnGateway("vpnGateway", new AzureRM.Network.V20180401.VpnGatewayArgs
    ///         {
    ///             BgpSettings = new AzureRM.Network.V20180401.Inputs.BgpSettingsArgs
    ///             {
    ///                 Asn = 65515,
    ...
    ///             Connections = 
    ///             {
    ///                 new AzureRM.Network.V20180401.Inputs.VpnConnectionArgs
    ///                 {
    ///                     Name = "vpnConnection1",
    ///                 },
    ///             },
    ...
    ///             Location = "West US",
    ///             Policies = new AzureRM.Network.V20180401.Inputs.PoliciesArgs
    ///             {
    ...
    ///                 { "key1", "value1" },
    ///             },
    ///             VirtualHub = new AzureRM.Network.V20180401.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class VpnGateway : Pulumi.CustomResource
    {
        ...
        public VpnGateway(string name, VpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180401:VpnGateway", name, args ?? new VpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180401:VpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
