...
namespace Pulumi.AzureNative.Network.V20180401
{
    ...
    /// VpnSite Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20180401:VpnSite")]
    public partial class VpnSite : Pulumi.CustomResource
    {
        ...
        public VpnSite(string name, VpnSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:VpnSite", name, args ?? new VpnSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:VpnSite", name, null, MakeResourceOptions(options, id))
        {
        }
