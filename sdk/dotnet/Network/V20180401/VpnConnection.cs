...
namespace Pulumi.AzureNative.Network.V20180401
{
    ...
    /// {
    ///     var vpnConnection = new AzureNative.Network.V20180401.VpnConnection("vpnConnection", new()
    ///     {
    ///         ConnectionName = "vpnConnection1",
    ///         GatewayName = "gateway1",
    ///         RemoteVpnSite = new AzureNative.Network.V20180401.Inputs.SubResourceArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20180401:VpnConnection vpnConnection1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/vpnGateways/gateway1/vpnConnections/vpnConnection1 
    /// ```
    /// </summary>
    ...
    public partial class VpnConnection : global::Pulumi.CustomResource
    {
        ...
        public VpnConnection(string name, VpnConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:VpnConnection", name, args ?? new VpnConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:VpnConnection", name, null, MakeResourceOptions(options, id))
        {
        }
