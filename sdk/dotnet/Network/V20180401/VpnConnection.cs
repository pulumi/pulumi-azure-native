...
namespace Pulumi.AzureNextGen.Network.V20180401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20180401:VpnConnection")]
    public partial class VpnConnection : Pulumi.CustomResource
    {
        ...
        public VpnConnection(string name, VpnConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180401:VpnConnection", name, args ?? new VpnConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180401:VpnConnection", name, null, MakeResourceOptions(options, id))
        {
        }
