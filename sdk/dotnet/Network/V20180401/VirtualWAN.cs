...
azure-native:network/v20180401:VirtualWAN is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20180701:VirtualWAN to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20180401:VirtualWAN")]
    public partial class VirtualWAN : global::Pulumi.CustomResource
    {
        ...
        public VirtualWAN(string name, VirtualWANArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:VirtualWAN", name, args ?? new VirtualWANArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWAN(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:VirtualWAN", name, null, MakeResourceOptions(options, id))
        {
        }
