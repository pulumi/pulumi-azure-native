...
namespace Pulumi.AzureRM.Network.V20180401
{
    public static class GetNetworkWatcher
    {
        public static Task<GetNetworkWatcherResult> InvokeAsync(GetNetworkWatcherArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkWatcherResult>("azurerm:network/v20180401:getNetworkWatcher", args ?? new GetNetworkWatcherArgs(), options.WithVersion());
    }
