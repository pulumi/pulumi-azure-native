...
namespace Pulumi.AzureRM.Network.V20180401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var endpoint = new AzureRM.Network.V20180401.Endpoint("endpoint", new AzureRM.Network.V20180401.EndpointArgs
    ///         {
    ///             CustomHeaders = 
    ///             {
    ///                 new AzureRM.Network.V20180401.Inputs.EndpointPropertiesCustomHeadersArgs
    ///                 {
    ///                     Name = "header-1",
    ///                     Value = "value-1",
    ///                 },
    ...
    ///             Subnets = 
    ///             {
    ///                 new AzureRM.Network.V20180401.Inputs.EndpointPropertiesSubnetsArgs
    ///                 {
    ///                     First = "1.2.3.0",
    ///                     Scope = 24,
    ///                 },
    ...
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("subnets")]
        public Output<ImmutableArray<Outputs.EndpointPropertiesResponseSubnetsResult>> Subnets { get; private set; } = null!;
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180401:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180401:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
