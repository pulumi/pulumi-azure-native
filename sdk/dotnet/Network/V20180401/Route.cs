...
namespace Pulumi.AzureNative.Network.V20180401
{
    ...
    /// Route resource
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20180401:Route")]
    public partial class Route : Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180401:Route", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20180401.RouteNextHopType> NextHopType { get; set; } = null!;
