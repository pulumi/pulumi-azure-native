...
namespace Pulumi.AzureRM.Network
{
    ...
    /// </summary>
    public partial class RouteFilterRouteFilterRule : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public RouteFilterRouteFilterRule(string name, RouteFilterRouteFilterRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:RouteFilterRouteFilterRule", name, args ?? new RouteFilterRouteFilterRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class RouteFilterRouteFilterRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Resource ID.
        /// </summary>
