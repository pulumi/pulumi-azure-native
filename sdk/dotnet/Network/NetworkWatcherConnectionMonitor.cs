...
namespace Pulumi.AzureRM.Network
{
    ...
    /// </summary>
    public partial class NetworkWatcherConnectionMonitor : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public NetworkWatcherConnectionMonitor(string name, NetworkWatcherConnectionMonitorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:NetworkWatcherConnectionMonitor", name, args ?? new NetworkWatcherConnectionMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class NetworkWatcherConnectionMonitorArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Connection monitor location.
        /// </summary>
