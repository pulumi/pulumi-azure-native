...
namespace Pulumi.AzureNative.Network.V20181201
{
    public static class GetLoadBalancer
    {
        ...
        public static Task<GetLoadBalancerResult> InvokeAsync(GetLoadBalancerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLoadBalancerResult>("azure-native:network/v20181201:getLoadBalancer", args ?? new GetLoadBalancerArgs(), options.WithVersion());

        /// <summary>
        /// LoadBalancer resource
        /// </summary>
        public static Output<GetLoadBalancerResult> Invoke(GetLoadBalancerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetLoadBalancerResult>("azure-native:network/v20181201:getLoadBalancer", args ?? new GetLoadBalancerInvokeArgs(), options.WithVersion());
    }
