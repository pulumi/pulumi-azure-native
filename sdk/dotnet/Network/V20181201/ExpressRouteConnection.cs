...
namespace Pulumi.AzureRM.Network.V20181201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var expressRouteConnection = new AzureRM.Network.V20181201.ExpressRouteConnection("expressRouteConnection", new AzureRM.Network.V20181201.ExpressRouteConnectionArgs
    ///         {
    ///             AuthorizationKey = "authorizationKey",
    ///             ConnectionName = "connectionName",
    ///             ExpressRouteCircuitPeering = new AzureRM.Network.V20181201.Inputs.ExpressRouteCircuitPeeringIdArgs
    ///             {
    ...
    public partial class ExpressRouteConnection : Pulumi.CustomResource
    {
        ...
        public ExpressRouteConnection(string name, ExpressRouteConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181201:ExpressRouteConnection", name, args ?? new ExpressRouteConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181201:ExpressRouteConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/v20180801:ExpressRouteConnection"},
