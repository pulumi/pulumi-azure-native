...
namespace Pulumi.AzureNative.Network.V20181201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20181201:DdosCustomPolicy")]
    public partial class DdosCustomPolicy : Pulumi.CustomResource
    {
        ...
        public DdosCustomPolicy(string name, DdosCustomPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181201:DdosCustomPolicy", name, args ?? new DdosCustomPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DdosCustomPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181201:DdosCustomPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
