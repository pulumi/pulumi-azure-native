...
namespace Pulumi.AzureRM.Network.V20181201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnGateway = new AzureRM.Network.V20181201.VpnGateway("vpnGateway", new AzureRM.Network.V20181201.VpnGatewayArgs
    ///         {
    ...
    ///             Connections = 
    ///             {
    ///                 new AzureRM.Network.V20181201.Inputs.VpnConnectionArgs
    ///                 {
    ///                     Name = "vpnConnection1",
    ///                 },
    ///             },
    ...
    public partial class VpnGateway : Pulumi.CustomResource
    {
        ...
        public VpnGateway(string name, VpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181201:VpnGateway", name, args ?? new VpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181201:VpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
