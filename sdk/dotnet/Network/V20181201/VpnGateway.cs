...
namespace Pulumi.AzureNative.Network.V20181201
{
    ...
    /// VpnGateway Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20181201:VpnGateway")]
    public partial class VpnGateway : global::Pulumi.CustomResource
    {
        ...
        public VpnGateway(string name, VpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181201:VpnGateway", name, args ?? new VpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181201:VpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
