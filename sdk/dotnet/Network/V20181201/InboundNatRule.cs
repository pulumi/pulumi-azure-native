...
namespace Pulumi.AzureNextGen.Network.V20181201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20181201:InboundNatRule")]
    public partial class InboundNatRule : Pulumi.CustomResource
    {
        ...
        public InboundNatRule(string name, InboundNatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181201:InboundNatRule", name, args ?? new InboundNatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InboundNatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181201:InboundNatRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InboundNatRuleArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20181201.TransportProtocol>? Protocol { get; set; }
