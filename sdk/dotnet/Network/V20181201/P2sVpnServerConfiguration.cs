...
namespace Pulumi.AzureRM.Network.V20181201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var p2sVpnServerConfiguration = new AzureRM.Network.V20181201.P2sVpnServerConfiguration("p2sVpnServerConfiguration", new AzureRM.Network.V20181201.P2sVpnServerConfigurationArgs
    ///         {
    ///             P2SVpnServerConfigRadiusClientRootCertificates = 
    ///             {
    ///                 new AzureRM.Network.V20181201.Inputs.P2SVpnServerConfigRadiusClientRootCertificateArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Network.V20181201.Inputs.P2SVpnServerConfigRadiusServerRootCertificateArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Network.V20181201.Inputs.P2SVpnServerConfigVpnClientRevokedCertificateArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Network.V20181201.Inputs.P2SVpnServerConfigVpnClientRootCertificateArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Network.V20181201.Inputs.IpsecPolicyArgs
    ///                 {
    ///                     DhGroup = "DHGroup14",
    ...
    public partial class P2sVpnServerConfiguration : Pulumi.CustomResource
    {
        ...
        public P2sVpnServerConfiguration(string name, P2sVpnServerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181201:P2sVpnServerConfiguration", name, args ?? new P2sVpnServerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private P2sVpnServerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20181201:P2sVpnServerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
