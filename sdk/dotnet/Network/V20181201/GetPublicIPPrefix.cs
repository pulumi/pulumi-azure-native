...
namespace Pulumi.AzureNative.Network.V20181201
{
    public static class GetPublicIPPrefix
    {
        ...
        public static Task<GetPublicIPPrefixResult> InvokeAsync(GetPublicIPPrefixArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPublicIPPrefixResult>("azure-native:network/v20181201:getPublicIPPrefix", args ?? new GetPublicIPPrefixArgs(), options.WithVersion());

        /// <summary>
        /// Public IP prefix resource.
        /// </summary>
        public static Output<GetPublicIPPrefixResult> Invoke(GetPublicIPPrefixInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPublicIPPrefixResult>("azure-native:network/v20181201:getPublicIPPrefix", args ?? new GetPublicIPPrefixInvokeArgs(), options.WithVersion());
    }
