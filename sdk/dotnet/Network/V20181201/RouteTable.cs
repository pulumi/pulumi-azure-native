...
namespace Pulumi.AzureNative.Network.V20181201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20181201:RouteTable is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:RouteTable to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20181201:RouteTable")]
    public partial class RouteTable : global::Pulumi.CustomResource
    {
        ...
        public RouteTable(string name, RouteTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181201:RouteTable", name, args ?? new RouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181201:RouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
