...
namespace Pulumi.AzureNextGen.Network.V20181201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20181201:VirtualNetworkPeering")]
    public partial class VirtualNetworkPeering : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkPeering(string name, VirtualNetworkPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181201:VirtualNetworkPeering", name, args ?? new VirtualNetworkPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181201:VirtualNetworkPeering", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkPeeringArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("peeringState")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20181201.VirtualNetworkPeeringState>? PeeringState { get; set; }
