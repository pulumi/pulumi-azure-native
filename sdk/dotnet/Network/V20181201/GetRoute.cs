...
namespace Pulumi.AzureNative.Network.V20181201
{
    public static class GetRoute
    {
        ...
        public static Task<GetRouteResult> InvokeAsync(GetRouteArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteResult>("azure-native:network/v20181201:getRoute", args ?? new GetRouteArgs(), options.WithDefaults());

        /// <summary>
        /// Route resource
        /// </summary>
        public static Output<GetRouteResult> Invoke(GetRouteInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRouteResult>("azure-native:network/v20181201:getRoute", args ?? new GetRouteInvokeArgs(), options.WithDefaults());
    }
