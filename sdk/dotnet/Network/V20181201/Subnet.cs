...
namespace Pulumi.AzureNative.Network.V20181201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20181201:Subnet")]
    public partial class Subnet : global::Pulumi.CustomResource
    {
        ...
        public Subnet(string name, SubnetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181201:Subnet", name, args ?? new SubnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20181201:Subnet", name, null, MakeResourceOptions(options, id))
        {
        }
