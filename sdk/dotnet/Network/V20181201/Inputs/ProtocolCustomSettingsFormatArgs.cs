...
namespace Pulumi.AzureNative.Network.V20181201.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20181201.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20181201.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
