...
namespace Pulumi.AzureNative.Network.V20181201.Inputs
{
    ...
    public sealed class AzureFirewallNatRuleArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("protocols")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20181201.AzureFirewallNetworkRuleProtocol>>? _protocols;

        /// <summary>
        /// Array of AzureFirewallNetworkRuleProtocols applicable to this NAT rule.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20181201.AzureFirewallNetworkRuleProtocol>> Protocols
        {
            get => _protocols ?? (_protocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20181201.AzureFirewallNetworkRuleProtocol>>());
