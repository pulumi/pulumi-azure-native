...
namespace Pulumi.AzureRM.Network.V20181201.Inputs
{
    ...
    public sealed class ExpressRouteCircuitPeeringPropertiesFormatResponseArgs : Pulumi.InvokeArgs
    {
        ...
        private List<Inputs.PeerExpressRouteCircuitConnectionResponseArgs>? _peeredConnections;

        /// <summary>
        /// The list of peered circuit connections associated with Azure Private Peering for this circuit.
        /// </summary>
        public List<Inputs.PeerExpressRouteCircuitConnectionResponseArgs> PeeredConnections
        {
            get => _peeredConnections ?? (_peeredConnections = new List<Inputs.PeerExpressRouteCircuitConnectionResponseArgs>());
