...
namespace Pulumi.AzureNextGen.Network.V20181201.Inputs
{
    ...
    public sealed class LoadBalancingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20181201.LoadDistribution>? LoadDistribution { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20181201.TransportProtocol> Protocol { get; set; } = null!;
