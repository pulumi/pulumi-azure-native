...
namespace Pulumi.AzureNextGen.Network.V20181201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20181201:ExpressRouteGateway")]
    public partial class ExpressRouteGateway : Pulumi.CustomResource
    {
        ...
        public ExpressRouteGateway(string name, ExpressRouteGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181201:ExpressRouteGateway", name, args ?? new ExpressRouteGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20181201:ExpressRouteGateway", name, null, MakeResourceOptions(options, id))
        {
        }
