...
namespace Pulumi.AzureRM.Network.V20181201
{
    public static class GetDdosCustomPolicy
    {
        public static Task<GetDdosCustomPolicyResult> InvokeAsync(GetDdosCustomPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDdosCustomPolicyResult>("azurerm:network/v20181201:getDdosCustomPolicy", args ?? new GetDdosCustomPolicyArgs(), options.WithVersion());
    }
