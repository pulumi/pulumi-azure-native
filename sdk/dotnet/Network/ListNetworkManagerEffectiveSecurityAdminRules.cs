...
namespace Pulumi.AzureNative.Network
{
    public static class ListNetworkManagerEffectiveSecurityAdminRules
    {
        ...
        public static Task<ListNetworkManagerEffectiveSecurityAdminRulesResult> InvokeAsync(ListNetworkManagerEffectiveSecurityAdminRulesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNetworkManagerEffectiveSecurityAdminRulesResult>("azure-native:network:listNetworkManagerEffectiveSecurityAdminRules", args ?? new ListNetworkManagerEffectiveSecurityAdminRulesArgs(), options.WithDefaults());
        ...
        public static Output<ListNetworkManagerEffectiveSecurityAdminRulesResult> Invoke(ListNetworkManagerEffectiveSecurityAdminRulesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListNetworkManagerEffectiveSecurityAdminRulesResult>("azure-native:network:listNetworkManagerEffectiveSecurityAdminRules", args ?? new ListNetworkManagerEffectiveSecurityAdminRulesInvokeArgs(), options.WithDefaults());
    }
