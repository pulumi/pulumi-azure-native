...
namespace Pulumi.AzureNative.Network
{
    ...
    public partial class NetworkManagerRoutingConfiguration : global::Pulumi.CustomResource
    {
        ...
        public NetworkManagerRoutingConfiguration(string name, NetworkManagerRoutingConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network:NetworkManagerRoutingConfiguration", name, args ?? new NetworkManagerRoutingConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkManagerRoutingConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network:NetworkManagerRoutingConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240901preview:NetworkManagerRoutingConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20241001:NetworkManagerRoutingConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250101:NetworkManagerRoutingConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250301:NetworkManagerRoutingConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250501:NetworkManagerRoutingConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250701:NetworkManagerRoutingConfiguration" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetworkManagerRoutingConfiguration Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new NetworkManagerRoutingConfiguration(name, id, options);
        }
    }
