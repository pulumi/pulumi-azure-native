...
namespace Pulumi.AzureRM.Network.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var bastionHost = new AzureRM.Network.V20200401.BastionHost("bastionHost", new AzureRM.Network.V20200401.BastionHostArgs
    ///         {
    ///             BastionHostName = "bastionhosttenant'",
    ///             IpConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20200401.Inputs.BastionHostIPConfigurationArgs
    ///                 {
    ...
    public partial class BastionHost : Pulumi.CustomResource
    {
        ...
        public BastionHost(string name, BastionHostArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:BastionHost", name, args ?? new BastionHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BastionHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:BastionHost", name, null, MakeResourceOptions(options, id))
        {
        }
