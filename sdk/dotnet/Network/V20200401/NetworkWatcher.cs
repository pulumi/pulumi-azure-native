...
namespace Pulumi.AzureNative.Network.V20200401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20200401:NetworkWatcher is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220501:NetworkWatcher to guarantee forwards compatibility.")]
    ...
    public partial class NetworkWatcher : global::Pulumi.CustomResource
    {
        ...
        public NetworkWatcher(string name, NetworkWatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:NetworkWatcher", name, args ?? new NetworkWatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkWatcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:NetworkWatcher", name, null, MakeResourceOptions(options, id))
        {
        }
