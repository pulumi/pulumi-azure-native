...
namespace Pulumi.AzureRM.Network.V20200401
{
    public static class GetIpAllocation
    {
        public static Task<GetIpAllocationResult> InvokeAsync(GetIpAllocationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIpAllocationResult>("azurerm:network/v20200401:getIpAllocation", args ?? new GetIpAllocationArgs(), options.WithVersion());
    }
