...
namespace Pulumi.AzureRM.Network.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var rulesEngine = new AzureRM.Network.V20200401.RulesEngine("rulesEngine", new AzureRM.Network.V20200401.RulesEngineArgs
    ///         {
    ///             FrontDoorName = "frontDoor1",
    ///             ResourceGroupName = "rg1",
    ///             Rules = 
    ///             {
    ///                 new AzureRM.Network.V20200401.Inputs.RulesEngineRuleArgs
    ///                 {
    ///                     Action = new AzureRM.Network.V20200401.Inputs.RulesEngineActionArgs
    ///                     {
    ...
    ///                     MatchConditions = 
    ///                     {
    ///                         new AzureRM.Network.V20200401.Inputs.RulesEngineMatchConditionArgs
    ///                         {
    ...
    ///                         {
    ///                             new AzureRM.Network.V20200401.Inputs.HeaderActionArgs
    ///                             {
    ...
    ///                             { "backendPool", new AzureRM.Network.V20200401.Inputs.SubResourceArgs
    ///                             {
    ///                                 Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoors/frontDoor1/backendPools/backendPool1",
    ///                             } },
    ///                             { "cacheConfiguration", new AzureRM.Network.V20200401.Inputs.CacheConfigurationArgs
    ///                             {
