...
namespace Pulumi.AzureNative.Network.V20200401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20200401:ApplicationSecurityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ApplicationSecurityGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20200401:ApplicationSecurityGroup")]
    public partial class ApplicationSecurityGroup : global::Pulumi.CustomResource
    {
        ...
        public ApplicationSecurityGroup(string name, ApplicationSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:ApplicationSecurityGroup", name, args ?? new ApplicationSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:ApplicationSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
