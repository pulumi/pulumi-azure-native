...
namespace Pulumi.AzureNextGen.Network.V20200401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200401:NatGateway")]
    public partial class NatGateway : Pulumi.CustomResource
    {
        ...
        public NatGateway(string name, NatGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200401:NatGateway", name, args ?? new NatGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200401:NatGateway", name, null, MakeResourceOptions(options, id))
        {
        }
