...
namespace Pulumi.AzureRM.Network.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policy = new AzureRM.Network.V20200401.Policy("policy", new AzureRM.Network.V20200401.PolicyArgs
    ///         {
    ///             CustomRules = new AzureRM.Network.V20200401.Inputs.CustomRuleListArgs
    ///             {
    ///                 Rules = 
    ///                 {
    ///                     new AzureRM.Network.V20200401.Inputs.CustomRuleArgs
    ///                     {
    ///                         Action = "Block",
    ///                         MatchConditions = 
    ///                         {
    ///                             new AzureRM.Network.V20200401.Inputs.MatchConditionArgs
    ///                             {
    ///                                 Operator = "IPMatch",
    ///                             },
    ///                         },
    ...
    ///                 },
    ///             },
    ///             ManagedRules = new AzureRM.Network.V20200401.Inputs.ManagedRuleSetListArgs
    ///             {
    ///                 ManagedRuleSets = 
    ///                 {
    ///                     new AzureRM.Network.V20200401.Inputs.ManagedRuleSetArgs
    ///                     {
    ///                         RuleGroupOverrides = 
    ///                         {
    ///                             new AzureRM.Network.V20200401.Inputs.ManagedRuleGroupOverrideArgs
    ///                             {
    ///                                 RuleGroupName = "SQLI",
    ///                                 Rules = 
    ///                                 {
    ///                                     new AzureRM.Network.V20200401.Inputs.ManagedRuleOverrideArgs
    ///                                     {
    ///                                         RuleId = "942100",
    ///                                     },
    ///                                     new AzureRM.Network.V20200401.Inputs.ManagedRuleOverrideArgs
    ...
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.RoutingRuleLinkResponseResult>> RoutingRuleLinks { get; private set; } = null!;
