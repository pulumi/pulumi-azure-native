...
namespace Pulumi.AzureNative.Network.V20200401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200401:ApplicationGateway")]
    public partial class ApplicationGateway : Pulumi.CustomResource
    {
        ...
        public ApplicationGateway(string name, ApplicationGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:ApplicationGateway", name, args ?? new ApplicationGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:ApplicationGateway", name, null, MakeResourceOptions(options, id))
        {
        }
