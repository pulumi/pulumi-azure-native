...
namespace Pulumi.AzureNative.Network.V20200401
{
    ...
    /// A flow log resource.
    /// </summary>
    [Obsolete(@"azure-native:network/v20200401:FlowLog is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:FlowLog to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20200401:FlowLog")]
    public partial class FlowLog : global::Pulumi.CustomResource
    {
        ...
        public FlowLog(string name, FlowLogArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:FlowLog", name, args ?? new FlowLogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FlowLog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:FlowLog", name, null, MakeResourceOptions(options, id))
        {
        }
