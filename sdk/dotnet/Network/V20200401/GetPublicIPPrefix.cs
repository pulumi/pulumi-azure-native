...
namespace Pulumi.AzureRM.Network.V20200401
{
    public static class GetPublicIPPrefix
    {
        public static Task<GetPublicIPPrefixResult> InvokeAsync(GetPublicIPPrefixArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPublicIPPrefixResult>("azurerm:network/v20200401:getPublicIPPrefix", args ?? new GetPublicIPPrefixArgs(), options.WithVersion());
    }
