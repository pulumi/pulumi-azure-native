...
namespace Pulumi.AzureNative.Network.V20200401
{
    ...
    [AzureNativeResourceType("azure-native:network/v20200401:IpAllocation")]
    public partial class IpAllocation : global::Pulumi.CustomResource
    {
        ...
        public IpAllocation(string name, IpAllocationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:IpAllocation", name, args ?? new IpAllocationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpAllocation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:IpAllocation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IpAllocationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("prefixType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200401.IPVersion>? PrefixType { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200401.IpAllocationType>? Type { get; set; }
