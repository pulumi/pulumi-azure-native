...
namespace Pulumi.AzureRM.Network.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var ipAllocation = new AzureRM.Network.V20200401.IpAllocation("ipAllocation", new AzureRM.Network.V20200401.IpAllocationArgs
    ///         {
    ///             AllocationTags = 
    ///             {
    ...
    public partial class IpAllocation : Pulumi.CustomResource
    {
        ...
        public IpAllocation(string name, IpAllocationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:IpAllocation", name, args ?? new IpAllocationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpAllocation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:IpAllocation", name, null, MakeResourceOptions(options, id))
        {
        }
