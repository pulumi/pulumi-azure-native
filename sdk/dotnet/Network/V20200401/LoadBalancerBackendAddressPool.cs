...
namespace Pulumi.AzureNative.Network.V20200401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20200401:LoadBalancerBackendAddressPool is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:LoadBalancerBackendAddressPool to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20200401:LoadBalancerBackendAddressPool")]
    public partial class LoadBalancerBackendAddressPool : global::Pulumi.CustomResource
    {
        ...
        public LoadBalancerBackendAddressPool(string name, LoadBalancerBackendAddressPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:LoadBalancerBackendAddressPool", name, args ?? new LoadBalancerBackendAddressPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancerBackendAddressPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:LoadBalancerBackendAddressPool", name, null, MakeResourceOptions(options, id))
        {
        }
