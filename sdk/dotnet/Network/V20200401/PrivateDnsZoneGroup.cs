...
namespace Pulumi.AzureRM.Network.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateDnsZoneGroup = new AzureRM.Network.V20200401.PrivateDnsZoneGroup("privateDnsZoneGroup", new AzureRM.Network.V20200401.PrivateDnsZoneGroupArgs
    ///         {
    ...
    public partial class PrivateDnsZoneGroup : Pulumi.CustomResource
    {
        ...
        public PrivateDnsZoneGroup(string name, PrivateDnsZoneGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:PrivateDnsZoneGroup", name, args ?? new PrivateDnsZoneGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateDnsZoneGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:PrivateDnsZoneGroup", name, null, MakeResourceOptions(options, id))
        {
        }
