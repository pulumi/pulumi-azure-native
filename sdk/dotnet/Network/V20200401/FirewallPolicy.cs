...
namespace Pulumi.AzureRM.Network.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var firewallPolicy = new AzureRM.Network.V20200401.FirewallPolicy("firewallPolicy", new AzureRM.Network.V20200401.FirewallPolicyArgs
    ///         {
    ...
    ///             ThreatIntelWhitelist = new AzureRM.Network.V20200401.Inputs.FirewallPolicyThreatIntelWhitelistArgs
    ///             {
    ///                 Fqdns = 
    ///                 {
    ///                     "*.microsoft.com",
    ...
    public partial class FirewallPolicy : Pulumi.CustomResource
    {
        ...
        public FirewallPolicy(string name, FirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:FirewallPolicy", name, args ?? new FirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:FirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
