...
namespace Pulumi.AzureRM.Network.V20200401
{
    public static class GetNetworkProfile
    {
        public static Task<GetNetworkProfileResult> InvokeAsync(GetNetworkProfileArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkProfileResult>("azurerm:network/v20200401:getNetworkProfile", args ?? new GetNetworkProfileArgs(), options.WithVersion());
    }
