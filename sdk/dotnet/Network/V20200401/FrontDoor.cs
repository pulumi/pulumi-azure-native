...
namespace Pulumi.AzureRM.Network.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var frontDoor = new AzureRM.Network.V20200401.FrontDoor("frontDoor", new AzureRM.Network.V20200401.FrontDoorArgs
    ///         {
    ///             BackendPools = 
    ///             {
    ///                 new AzureRM.Network.V20200401.Inputs.BackendPoolArgs
    ///                 {
    ///                     Name = "backendPool1",
    ///                 },
    ///             },
    ///             BackendPoolsSettings = new AzureRM.Network.V20200401.Inputs.BackendPoolsSettingsArgs
    ///             {
    ...
    ///             FrontendEndpoints = 
    ///             {
    ///                 new AzureRM.Network.V20200401.Inputs.FrontendEndpointArgs
    ///                 {
    ...
    ///             HealthProbeSettings = 
    ///             {
    ///                 new AzureRM.Network.V20200401.Inputs.HealthProbeSettingsModelArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Network.V20200401.Inputs.LoadBalancingSettingsModelArgs
    ///                 {
    ...
    ///             RoutingRules = 
    ///             {
    ///                 new AzureRM.Network.V20200401.Inputs.RoutingRuleArgs
    ///                 {
    ///                     Name = "routingRule1",
    ///                 },
    ///             },
