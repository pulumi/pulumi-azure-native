...
namespace Pulumi.AzureNextGen.Network.V20200401
{
    public static class GetHubRouteTable
    {
        public static Task<GetHubRouteTableResult> InvokeAsync(GetHubRouteTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHubRouteTableResult>("azure-nextgen:network/v20200401:getHubRouteTable", args ?? new GetHubRouteTableArgs(), options.WithVersion());
    }
