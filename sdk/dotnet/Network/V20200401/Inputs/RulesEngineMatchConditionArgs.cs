...
namespace Pulumi.AzureNextGen.Network.V20200401.Inputs
{
    ...
    public sealed class RulesEngineMatchConditionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200401.RulesEngineMatchVariable> RulesEngineMatchVariable { get; set; } = null!;

        /// <summary>
        /// Describes operator to apply to the match condition.
        /// </summary>
        [Input("rulesEngineOperator", required: true)]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200401.RulesEngineOperator> RulesEngineOperator { get; set; } = null!;
        ...
        [Input("transforms")]
        private InputList<Union<string, Pulumi.AzureNextGen.Network.V20200401.Transform>>? _transforms;

        /// <summary>
        /// List of transforms
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.Network.V20200401.Transform>> Transforms
        {
            get => _transforms ?? (_transforms = new InputList<Union<string, Pulumi.AzureNextGen.Network.V20200401.Transform>>());
