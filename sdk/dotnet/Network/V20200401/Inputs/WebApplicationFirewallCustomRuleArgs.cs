...
namespace Pulumi.AzureNative.Network.V20200401.Inputs
{
    ...
    public sealed class WebApplicationFirewallCustomRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200401.WebApplicationFirewallAction> Action { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200401.WebApplicationFirewallRuleType> RuleType { get; set; } = null!;
