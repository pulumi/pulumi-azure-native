...
namespace Pulumi.AzureNextGen.Network.V20200401.Inputs
{
    ...
    public sealed class NatRuleConditionArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("ipProtocols")]
        private InputList<Union<string, Pulumi.AzureNextGen.Network.V20200401.FirewallPolicyRuleConditionNetworkProtocol>>? _ipProtocols;

        /// <summary>
        /// Array of FirewallPolicyRuleConditionNetworkProtocols.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.Network.V20200401.FirewallPolicyRuleConditionNetworkProtocol>> IpProtocols
        {
            get => _ipProtocols ?? (_ipProtocols = new InputList<Union<string, Pulumi.AzureNextGen.Network.V20200401.FirewallPolicyRuleConditionNetworkProtocol>>());
