...
namespace Pulumi.AzureNative.Network.V20200401.Inputs
{
    ...
    public sealed class CacheConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200401.DynamicCompressionEnabled>? DynamicCompression { get; set; }

        /// <summary>
        /// Treatment of URL query terms when forming the cache key.
        /// </summary>
        [Input("queryParameterStripDirective")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200401.FrontDoorQuery>? QueryParameterStripDirective { get; set; }
