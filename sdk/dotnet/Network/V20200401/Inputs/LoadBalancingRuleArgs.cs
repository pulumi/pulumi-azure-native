...
namespace Pulumi.AzureNative.Network.V20200401.Inputs
{
    ...
    public sealed class LoadBalancingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200401.LoadDistribution>? LoadDistribution { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200401.TransportProtocol> Protocol { get; set; } = null!;
