...
namespace Pulumi.AzureRM.Network.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var hubRouteTable = new AzureRM.Network.V20200401.HubRouteTable("hubRouteTable", new AzureRM.Network.V20200401.HubRouteTableArgs
    ///         {
    ///             Labels = 
    ///             {
    ///                 "label1",
    ...
    ///             Routes = 
    ///             {
    ///                 new AzureRM.Network.V20200401.Inputs.HubRouteArgs
    ///                 {
    ...
    public partial class HubRouteTable : Pulumi.CustomResource
    {
        ...
        public HubRouteTable(string name, HubRouteTableArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:HubRouteTable", name, args ?? new HubRouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubRouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:HubRouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
