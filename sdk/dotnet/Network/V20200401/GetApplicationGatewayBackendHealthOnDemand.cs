...
namespace Pulumi.AzureNextGen.Network.V20200401
{
    public static class GetApplicationGatewayBackendHealthOnDemand
    {
        public static Task<GetApplicationGatewayBackendHealthOnDemandResult> InvokeAsync(GetApplicationGatewayBackendHealthOnDemandArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationGatewayBackendHealthOnDemandResult>("azure-nextgen:network/v20200401:getApplicationGatewayBackendHealthOnDemand", args ?? new GetApplicationGatewayBackendHealthOnDemandArgs(), options.WithVersion());
    }
    ...
    public sealed class GetApplicationGatewayBackendHealthOnDemandArgs : Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public Union<string, Pulumi.AzureNextGen.Network.V20200401.ApplicationGatewayProtocol>? Protocol { get; set; }
