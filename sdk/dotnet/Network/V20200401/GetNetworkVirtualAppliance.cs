...
namespace Pulumi.AzureRM.Network.V20200401
{
    public static class GetNetworkVirtualAppliance
    {
        public static Task<GetNetworkVirtualApplianceResult> InvokeAsync(GetNetworkVirtualApplianceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkVirtualApplianceResult>("azurerm:network/v20200401:getNetworkVirtualAppliance", args ?? new GetNetworkVirtualApplianceArgs(), options.WithVersion());
    }
    ...
    public sealed class GetNetworkVirtualApplianceResult
    {
        ...
        /// </summary>
        public readonly Outputs.VirtualApplianceSkuPropertiesResponseResult? Sku;
        /// <summary>
        /// Resource tags.
        /// </summary>
