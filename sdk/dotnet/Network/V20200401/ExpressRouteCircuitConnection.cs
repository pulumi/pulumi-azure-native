...
namespace Pulumi.AzureRM.Network.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var expressRouteCircuitConnection = new AzureRM.Network.V20200401.ExpressRouteCircuitConnection("expressRouteCircuitConnection", new AzureRM.Network.V20200401.ExpressRouteCircuitConnectionArgs
    ///         {
    ///             AddressPrefix = "10.0.0.0/29",
    ///             AuthorizationKey = "946a1918-b7a2-4917-b43c-8c4cdaee006a",
    ///             CircuitName = "ExpressRouteARMCircuitA",
    ///             ConnectionName = "circuitConnectionUSAUS",
    ///             ExpressRouteCircuitPeering = new AzureRM.Network.V20200401.Inputs.SubResourceArgs
    ///             {
    ...
    ///             },
    ///             Ipv6CircuitConnectionConfig = new AzureRM.Network.V20200401.Inputs.Ipv6CircuitConnectionConfigArgs
    ///             {
    ///                 AddressPrefix = "aa:bb::/125",
    ///             },
    ///             PeerExpressRouteCircuitPeering = new AzureRM.Network.V20200401.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class ExpressRouteCircuitConnection : Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitConnection(string name, ExpressRouteCircuitConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:ExpressRouteCircuitConnection", name, args ?? new ExpressRouteCircuitConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:ExpressRouteCircuitConnection", name, null, MakeResourceOptions(options, id))
        {
        }
