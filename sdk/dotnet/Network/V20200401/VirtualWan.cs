...
namespace Pulumi.AzureNextGen.Network.V20200401
{
    ...
    /// VirtualWAN Resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200401:VirtualWan")]
    public partial class VirtualWan : Pulumi.CustomResource
    {
        ...
        public VirtualWan(string name, VirtualWanArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200401:VirtualWan", name, args ?? new VirtualWanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200401:VirtualWan", name, null, MakeResourceOptions(options, id))
        {
        }
