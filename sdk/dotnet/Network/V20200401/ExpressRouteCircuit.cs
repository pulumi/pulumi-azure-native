...
namespace Pulumi.AzureNative.Network.V20200401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20200401:ExpressRouteCircuit is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteCircuit to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20200401:ExpressRouteCircuit")]
    public partial class ExpressRouteCircuit : global::Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuit(string name, ExpressRouteCircuitArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:ExpressRouteCircuit", name, args ?? new ExpressRouteCircuitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuit(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401:ExpressRouteCircuit", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRouteCircuitArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200401.ServiceProviderProvisioningState>? ServiceProviderProvisioningState { get; set; }
