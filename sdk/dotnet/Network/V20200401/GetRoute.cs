...
namespace Pulumi.AzureNative.Network.V20200401
{
    public static class GetRoute
    {
        ...
        public static Task<GetRouteResult> InvokeAsync(GetRouteArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteResult>("azure-native:network/v20200401:getRoute", args ?? new GetRouteArgs(), options.WithVersion());

        /// <summary>
        /// Route resource.
        /// </summary>
        public static Output<GetRouteResult> Invoke(GetRouteInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRouteResult>("azure-native:network/v20200401:getRoute", args ?? new GetRouteInvokeArgs(), options.WithVersion());
    }
