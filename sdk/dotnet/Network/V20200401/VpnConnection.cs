...
namespace Pulumi.AzureRM.Network.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnConnection = new AzureRM.Network.V20200401.VpnConnection("vpnConnection", new AzureRM.Network.V20200401.VpnConnectionArgs
    ///         {
    ///             ConnectionName = "vpnConnection1",
    ///             GatewayName = "gateway1",
    ///             RemoteVpnSite = new AzureRM.Network.V20200401.Inputs.SubResourceArgs
    ///             {
    ...
    ///             VpnLinkConnections = 
    ///             {
    ///                 new AzureRM.Network.V20200401.Inputs.VpnSiteLinkConnectionArgs
    ///                 {
