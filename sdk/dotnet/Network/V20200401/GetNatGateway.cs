...
namespace Pulumi.AzureNextGen.Network.V20200401
{
    public static class GetNatGateway
    {
        public static Task<GetNatGatewayResult> InvokeAsync(GetNatGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNatGatewayResult>("azure-nextgen:network/v20200401:getNatGateway", args ?? new GetNatGatewayArgs(), options.WithVersion());
    }
