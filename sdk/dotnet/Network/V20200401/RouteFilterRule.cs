...
namespace Pulumi.AzureRM.Network.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var routeFilterRule = new AzureRM.Network.V20200401.RouteFilterRule("routeFilterRule", new AzureRM.Network.V20200401.RouteFilterRuleArgs
    ///         {
    ///             Access = "Allow",
    ///             Communities = 
    ///             {
    ...
    public partial class RouteFilterRule : Pulumi.CustomResource
    {
        ...
        public RouteFilterRule(string name, RouteFilterRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:RouteFilterRule", name, args ?? new RouteFilterRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilterRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200401:RouteFilterRule", name, null, MakeResourceOptions(options, id))
        {
        }
