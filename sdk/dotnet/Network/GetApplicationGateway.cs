...
namespace Pulumi.AzureRM.Network
{
    public static class GetApplicationGateway
    {
        public static Task<GetApplicationGatewayResult> InvokeAsync(GetApplicationGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationGatewayResult>("azurerm:network:getApplicationGateway", args ?? new GetApplicationGatewayArgs(), options.WithVersion());
    }
