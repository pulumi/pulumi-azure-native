...
namespace Pulumi.AzureRM.Network
{
    public static class GetPrivateEndpoint
    {
        public static Task<GetPrivateEndpointResult> InvokeAsync(GetPrivateEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateEndpointResult>("azurerm:network:getPrivateEndpoint", args ?? new GetPrivateEndpointArgs(), options.WithVersion());
    }
