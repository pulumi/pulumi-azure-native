...
namespace Pulumi.AzureNative.Network.V20180901
{
    public static class GetPrivateRecordSet
    {
        ...
        public static Output<GetPrivateRecordSetResult> Invoke(GetPrivateRecordSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPrivateRecordSetResult>("azure-native:network/v20180901:getPrivateRecordSet", args ?? new GetPrivateRecordSetInvokeArgs(), options.WithVersion());
    }
