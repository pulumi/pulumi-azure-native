...
namespace Pulumi.AzureNative.Network.V20180901
{
    public static class GetPrivateZone
    {
        ...
        public static Output<GetPrivateZoneResult> Invoke(GetPrivateZoneInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPrivateZoneResult>("azure-native:network/v20180901:getPrivateZone", args ?? new GetPrivateZoneInvokeArgs(), options.WithVersion());
    }
