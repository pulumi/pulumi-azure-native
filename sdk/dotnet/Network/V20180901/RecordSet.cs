...
namespace Pulumi.AzureNextGen.Network.V20180901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20180901:RecordSet")]
    public partial class RecordSet : Pulumi.CustomResource
    {
        ...
        public RecordSet(string name, RecordSetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180901:RecordSet", name, args ?? new RecordSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RecordSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180901:RecordSet", name, null, MakeResourceOptions(options, id))
        {
        }
