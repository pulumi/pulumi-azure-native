...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class VirtualHub : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VirtualHubPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public VirtualHub(string name, VirtualHubArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:VirtualHub", name, args ?? new VirtualHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHub(string name, Input<string> id, VirtualHubState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:VirtualHub", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualHubState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VirtualHubPropertiesResponseGetArgs> Properties { get; set; } = null!;
