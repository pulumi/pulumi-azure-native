...
namespace Pulumi.AzureNextGen.Network.V20150615.Inputs
{
    ...
    public sealed class ApplicationGatewaySkuArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20150615.ApplicationGatewaySkuName>? Name { get; set; }

        /// <summary>
        /// Tier of an application gateway.
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20150615.ApplicationGatewayTier>? Tier { get; set; }
