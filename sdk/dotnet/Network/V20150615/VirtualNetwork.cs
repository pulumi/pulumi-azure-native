...
namespace Pulumi.AzureNative.Network.V20150615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20150615:VirtualNetwork")]
    public partial class VirtualNetwork : Pulumi.CustomResource
    {
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20150615:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20150615:VirtualNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
