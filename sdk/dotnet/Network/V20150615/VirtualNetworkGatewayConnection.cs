...
namespace Pulumi.AzureNextGen.Network.V20150615
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20150615:VirtualNetworkGatewayConnection")]
    public partial class VirtualNetworkGatewayConnection : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGatewayConnection(string name, VirtualNetworkGatewayConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20150615:VirtualNetworkGatewayConnection", name, args ?? new VirtualNetworkGatewayConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGatewayConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20150615:VirtualNetworkGatewayConnection", name, null, MakeResourceOptions(options, id))
        {
        }
