...
namespace Pulumi.AzureNative.Network.V20150615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20150615:Subnet")]
    public partial class Subnet : Pulumi.CustomResource
    {
        ...
        public Subnet(string name, SubnetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20150615:Subnet", name, args ?? new SubnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20150615:Subnet", name, null, MakeResourceOptions(options, id))
        {
        }
