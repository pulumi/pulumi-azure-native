...
namespace Pulumi.AzureRM.Network.V20150615
{
    ...
    public partial class Route : Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20150615:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20150615:Route", name, null, MakeResourceOptions(options, id))
        {
        }
