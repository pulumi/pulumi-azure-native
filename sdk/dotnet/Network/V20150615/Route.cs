...
namespace Pulumi.AzureNextGen.Network.V20150615
{
    ...
    /// Route resource
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20150615:Route")]
    public partial class Route : Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20150615:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20150615:Route", name, null, MakeResourceOptions(options, id))
        {
        }
