...
namespace Pulumi.AzureNative.Network.Latest.Inputs
{
    ...
    public sealed class CacheConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.Latest.DynamicCompressionEnabled>? DynamicCompression { get; set; }

        /// <summary>
        /// Treatment of URL query terms when forming the cache key.
        /// </summary>
        [Input("queryParameterStripDirective")]
        public InputUnion<string, Pulumi.AzureNative.Network.Latest.FrontDoorQuery>? QueryParameterStripDirective { get; set; }
