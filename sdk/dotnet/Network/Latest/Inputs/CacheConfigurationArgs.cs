...
namespace Pulumi.AzureNextGen.Network.Latest.Inputs
{
    ...
    public sealed class CacheConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.Latest.DynamicCompressionEnabled>? DynamicCompression { get; set; }

        /// <summary>
        /// Treatment of URL query terms when forming the cache key.
        /// </summary>
        [Input("queryParameterStripDirective")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.Latest.FrontDoorQuery>? QueryParameterStripDirective { get; set; }
