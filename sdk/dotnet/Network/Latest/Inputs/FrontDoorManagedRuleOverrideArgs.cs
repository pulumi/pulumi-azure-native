...
namespace Pulumi.AzureNative.Network.Latest.Inputs
{
    ...
    public sealed class FrontDoorManagedRuleOverrideArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("action")]
        public InputUnion<string, Pulumi.AzureNative.Network.Latest.ActionType>? Action { get; set; }

        /// <summary>
        /// Describes if the managed rule is in enabled or disabled state. Defaults to Disabled if not specified.
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.Network.Latest.ManagedRuleEnabledState>? EnabledState { get; set; }
