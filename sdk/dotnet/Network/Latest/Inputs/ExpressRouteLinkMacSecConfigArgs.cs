...
namespace Pulumi.AzureNextGen.Network.Latest.Inputs
{
    ...
    public sealed class ExpressRouteLinkMacSecConfigArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cipher")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.Latest.ExpressRouteLinkMacSecCipher>? Cipher { get; set; }
        ...
        /// </summary>
        [Input("sciState")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.Latest.ExpressRouteLinkMacSecSciState>? SciState { get; set; }
