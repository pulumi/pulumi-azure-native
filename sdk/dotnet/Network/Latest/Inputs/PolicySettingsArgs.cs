...
namespace Pulumi.AzureNextGen.Network.Latest.Inputs
{
    ...
    public sealed class PolicySettingsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.Latest.WebApplicationFirewallMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.Latest.WebApplicationFirewallEnabledState>? State { get; set; }
