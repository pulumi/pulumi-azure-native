...
namespace Pulumi.AzureNative.Network.Latest.Inputs
{
    ...
    public sealed class CustomRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.Latest.ActionType> Action { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.Latest.RuleType> RuleType { get; set; } = null!;
