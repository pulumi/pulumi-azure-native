...
namespace Pulumi.AzureNative.Network.Latest.Inputs
{
    ...
    public sealed class FrontDoorPolicySettingsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.Network.Latest.PolicyEnabledState>? EnabledState { get; set; }

        /// <summary>
        /// Describes if it is in detection mode or prevention mode at policy level.
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Network.Latest.PolicyMode>? Mode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.Latest.PolicyRequestBodyCheck>? RequestBodyCheck { get; set; }
