...
namespace Pulumi.AzureNextGen.Network.Latest.Inputs
{
    ...
    public sealed class RoutingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNextGen.Network.Latest.FrontDoorProtocol>>? _acceptedProtocols;

        /// <summary>
        /// Protocol schemes to match for this rule
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.Network.Latest.FrontDoorProtocol>> AcceptedProtocols
        {
            get => _acceptedProtocols ?? (_acceptedProtocols = new InputList<Union<string, Pulumi.AzureNextGen.Network.Latest.FrontDoorProtocol>>());
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.Latest.RoutingRuleEnabledState>? EnabledState { get; set; }
