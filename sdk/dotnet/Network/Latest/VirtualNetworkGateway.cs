...
namespace Pulumi.AzureRM.Network.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkGateway = new AzureRM.Network.Latest.VirtualNetworkGateway("virtualNetworkGateway", new AzureRM.Network.Latest.VirtualNetworkGatewayArgs
    ///         {
    ///             ActiveActive = false,
    ...
    ///                 PeerWeight = 0,
    ///             },
    ///             CustomRoutes = new AzureRM.Network.Latest.Inputs.AddressSpaceArgs
    ///             {
    ///                 AddressPrefixes = 
    ///                 {
    ///                     "101.168.0.6/32",
    ...
    ///             IpConfigurations = 
    ///             {
    ///                 new AzureRM.Network.Latest.Inputs.VirtualNetworkGatewayIPConfigurationArgs
    ///                 {
    ///                     Name = "gwipconfig1",
    ///                 },
    ///             },
    ...
    ///             Sku = new AzureRM.Network.Latest.Inputs.VirtualNetworkGatewaySkuArgs
    ///             {
    ///                 Name = "VpnGw1",
    ///                 Tier = "VpnGw1",
    ///             },
    ///             VirtualNetworkGatewayName = "vpngw",
    ///             VpnClientConfiguration = new AzureRM.Network.Latest.Inputs.VpnClientConfigurationArgs
    ///             {
    ///                 RadiusServers = 
    ///                 {
    ...
    public partial class VirtualNetworkGateway : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGateway(string name, VirtualNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/latest:VirtualNetworkGateway", name, args ?? new VirtualNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/latest:VirtualNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
