...
namespace Pulumi.AzureNextGen.Network.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:network:VirtualHubRouteTableV2'.")]
    [AzureNextGenResourceType("azure-nextgen:network/latest:VirtualHubRouteTableV2")]
    public partial class VirtualHubRouteTableV2 : Pulumi.CustomResource
    {
        ...
        public VirtualHubRouteTableV2(string name, VirtualHubRouteTableV2Args args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/latest:VirtualHubRouteTableV2", name, args ?? new VirtualHubRouteTableV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubRouteTableV2(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/latest:VirtualHubRouteTableV2", name, null, MakeResourceOptions(options, id))
        {
        }
