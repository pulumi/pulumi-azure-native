...
namespace Pulumi.AzureRM.Network.Latest
{
    ...
    public partial class NetworkInterface : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.SubResourceResponseResult> DscpConfiguration { get; private set; } = null!;
        ...
        public NetworkInterface(string name, NetworkInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/latest:NetworkInterface", name, args ?? new NetworkInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/latest:NetworkInterface", name, null, MakeResourceOptions(options, id))
        {
        }
