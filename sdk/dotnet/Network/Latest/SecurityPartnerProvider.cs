...
namespace Pulumi.AzureRM.Network.Latest
{
    ...
    public partial class SecurityPartnerProvider : Pulumi.CustomResource
    {
        ...
        public SecurityPartnerProvider(string name, SecurityPartnerProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/latest:SecurityPartnerProvider", name, args ?? new SecurityPartnerProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityPartnerProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/latest:SecurityPartnerProvider", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:network/preview:SecurityPartnerProvider"},
