...
namespace Pulumi.AzureNextGen.Network.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:network:WebApplicationFirewallPolicy'.")]
    [AzureNextGenResourceType("azure-nextgen:network/latest:WebApplicationFirewallPolicy")]
    public partial class WebApplicationFirewallPolicy : Pulumi.CustomResource
    {
        ...
        public WebApplicationFirewallPolicy(string name, WebApplicationFirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/latest:WebApplicationFirewallPolicy", name, args ?? new WebApplicationFirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApplicationFirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/latest:WebApplicationFirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
