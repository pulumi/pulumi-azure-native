...
namespace Pulumi.AzureRM.Network.Latest
{
    public static class GetP2sVpnGateway
    {
        public static Task<GetP2sVpnGatewayResult> InvokeAsync(GetP2sVpnGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetP2sVpnGatewayResult>("azurerm:network/latest:getP2sVpnGateway", args ?? new GetP2sVpnGatewayArgs(), options.WithVersion());
    }
