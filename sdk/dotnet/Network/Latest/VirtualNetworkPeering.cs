...
namespace Pulumi.AzureRM.Network.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkPeering = new AzureRM.Network.Latest.VirtualNetworkPeering("virtualNetworkPeering", new AzureRM.Network.Latest.VirtualNetworkPeeringArgs
    ///         {
    ...
    public partial class VirtualNetworkPeering : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkPeering(string name, VirtualNetworkPeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/latest:VirtualNetworkPeering", name, args ?? new VirtualNetworkPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/latest:VirtualNetworkPeering", name, null, MakeResourceOptions(options, id))
        {
        }
