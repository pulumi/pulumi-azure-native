...
namespace Pulumi.AzureNative.Network.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:ServiceEndpointPolicyDefinition'.")]
    [AzureNativeResourceType("azure-native:network/latest:ServiceEndpointPolicyDefinition")]
    public partial class ServiceEndpointPolicyDefinition : Pulumi.CustomResource
    {
        ...
        public ServiceEndpointPolicyDefinition(string name, ServiceEndpointPolicyDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/latest:ServiceEndpointPolicyDefinition", name, args ?? new ServiceEndpointPolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceEndpointPolicyDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/latest:ServiceEndpointPolicyDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
