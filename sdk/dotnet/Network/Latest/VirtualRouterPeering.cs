...
namespace Pulumi.AzureNative.Network.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:VirtualRouterPeering'.")]
    [AzureNativeResourceType("azure-native:network/latest:VirtualRouterPeering")]
    public partial class VirtualRouterPeering : Pulumi.CustomResource
    {
        ...
        public VirtualRouterPeering(string name, VirtualRouterPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/latest:VirtualRouterPeering", name, args ?? new VirtualRouterPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouterPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/latest:VirtualRouterPeering", name, null, MakeResourceOptions(options, id))
        {
        }
