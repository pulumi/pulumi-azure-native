...
namespace Pulumi.AzureNative.Network.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:RulesEngine'.")]
    [AzureNativeResourceType("azure-native:network/latest:RulesEngine")]
    public partial class RulesEngine : Pulumi.CustomResource
    {
        ...
        public RulesEngine(string name, RulesEngineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/latest:RulesEngine", name, args ?? new RulesEngineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RulesEngine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/latest:RulesEngine", name, null, MakeResourceOptions(options, id))
        {
        }
