...
namespace Pulumi.AzureNative.Network.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:VpnServerConfiguration'.")]
    [AzureNativeResourceType("azure-native:network/latest:VpnServerConfiguration")]
    public partial class VpnServerConfiguration : Pulumi.CustomResource
    {
        ...
        public VpnServerConfiguration(string name, VpnServerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/latest:VpnServerConfiguration", name, args ?? new VpnServerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnServerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/latest:VpnServerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
