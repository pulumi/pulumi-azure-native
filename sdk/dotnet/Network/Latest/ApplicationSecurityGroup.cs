...
namespace Pulumi.AzureNative.Network.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:ApplicationSecurityGroup'.")]
    [AzureNativeResourceType("azure-native:network/latest:ApplicationSecurityGroup")]
    public partial class ApplicationSecurityGroup : Pulumi.CustomResource
    {
        ...
        public ApplicationSecurityGroup(string name, ApplicationSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/latest:ApplicationSecurityGroup", name, args ?? new ApplicationSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/latest:ApplicationSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
