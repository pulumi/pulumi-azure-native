...
namespace Pulumi.AzureRM.Network.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkLink = new AzureRM.Network.Latest.VirtualNetworkLink("virtualNetworkLink", new AzureRM.Network.Latest.VirtualNetworkLinkArgs
    ///         {
    ///             Location = "Global",
    ...
    ///                 { "key1", "value1" },
    ///             },
    ///             VirtualNetwork = new AzureRM.Network.Latest.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class VirtualNetworkLink : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkLink(string name, VirtualNetworkLinkArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/latest:VirtualNetworkLink", name, args ?? new VirtualNetworkLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/latest:VirtualNetworkLink", name, null, MakeResourceOptions(options, id))
        {
        }
