...
namespace Pulumi.AzureRM.Network.Latest
{
    ...
    public partial class ExpressRouteCircuitPeering : Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitPeering(string name, ExpressRouteCircuitPeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/latest:ExpressRouteCircuitPeering", name, args ?? new ExpressRouteCircuitPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/latest:ExpressRouteCircuitPeering", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/v20150501preview:ExpressRouteCircuitPeering"},
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/v20160901:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20161201:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20170301:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20170601:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20170801:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20170901:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20171001:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20171101:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20180101:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20180201:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20180401:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20180601:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20180701:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20180801:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20181001:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20181101:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20181201:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190201:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190401:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190601:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190701:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190801:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20190901:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20191101:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20191201:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200301:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200401:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200501:ExpressRouteCircuitPeering"},
                    new Pulumi.Alias { Type = "azurerm:network/v20200601:ExpressRouteCircuitPeering"},
                },
            };
