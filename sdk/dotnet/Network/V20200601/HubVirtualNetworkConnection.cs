    ...
    public partial class HubVirtualNetworkConnection : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:network/v20180401:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20180601:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20180701:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20180801:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20181001:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20181101:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20181201:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20190201:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20190401:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20190601:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20190701:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20190801:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20190901:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20191101:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20191201:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20200301:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20200401:HubVirtualNetworkConnection"},
                    new Alias { Type = "azurerm:network/v20200501:HubVirtualNetworkConnection"},
                },
            };
