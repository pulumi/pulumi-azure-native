...
namespace Pulumi.AzureRM.Network.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var hubVirtualNetworkConnection = new AzureRM.Network.V20200601.HubVirtualNetworkConnection("hubVirtualNetworkConnection", new AzureRM.Network.V20200601.HubVirtualNetworkConnectionArgs
    ///         {
    ///             ConnectionName = "connection1",
    ///             EnableInternetSecurity = false,
    ///             RemoteVirtualNetwork = new AzureRM.Network.V20200601.Inputs.SubResourceArgs
    ///             {
    ///                 Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/SpokeVnet1",
    ///             },
    ///             ResourceGroupName = "rg1",
    ///             RoutingConfiguration = new AzureRM.Network.V20200601.Inputs.RoutingConfigurationArgs
    ///             {
    ///                 AssociatedRouteTable = new AzureRM.Network.V20200601.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualHubs/virtualHub1/hubRouteTables/hubRouteTable1",
    ///                 },
    ///                 PropagatedRouteTables = new AzureRM.Network.V20200601.Inputs.PropagatedRouteTableArgs
    ///                 {
    ///                     Ids = 
    ///                     {
    ///                         new AzureRM.Network.V20200601.Inputs.SubResourceArgs
    ///                         {
    ///                             Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualHubs/virtualHub1/hubRouteTables/hubRouteTable1",
    ///                         },
    ///                     },
    ...
    ///                     },
    ///                 },
    ///                 VnetRoutes = new AzureRM.Network.V20200601.Inputs.VnetRouteArgs
    ///                 {
    ///                     StaticRoutes = 
    ///                     {
    ///                         new AzureRM.Network.V20200601.Inputs.StaticRouteArgs
    ///                         {
    ///                             AddressPrefixes = 
    ///                             {
    ///                                 "10.1.0.0/16",
