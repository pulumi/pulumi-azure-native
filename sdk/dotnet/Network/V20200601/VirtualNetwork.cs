...
namespace Pulumi.AzureRM.Network.V20200601
{
    ...
    public partial class VirtualNetwork : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.VirtualNetworkBgpCommunitiesResponseResult?> BgpCommunities { get; private set; } = null!;

        /// <summary>
        /// The DDoS protection plan associated with the virtual network.
        /// </summary>
        [Output("ddosProtectionPlan")]
        public Output<Outputs.SubResourceResponseResult?> DdosProtectionPlan { get; private set; } = null!;
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:VirtualNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Alias { Type = "azurerm:network/v20191101:VirtualNetwork"},
