...
namespace Pulumi.AzureNative.Network.V20200601
{
    ...
    /// {
    ///     var subnet = new AzureNative.Network.V20200601.Subnet("subnet", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.Network.V20200601.Inputs.ServiceEndpointPropertiesFormatArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200601:Subnet")]
    public partial class Subnet : global::Pulumi.CustomResource
    {
        ...
        public Subnet(string name, SubnetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:Subnet", name, args ?? new SubnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:Subnet", name, null, MakeResourceOptions(options, id))
        {
        }
