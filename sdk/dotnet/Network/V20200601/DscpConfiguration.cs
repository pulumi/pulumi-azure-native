...
namespace Pulumi.AzureNative.Network.V20200601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200601:DscpConfiguration")]
    public partial class DscpConfiguration : global::Pulumi.CustomResource
    {
        ...
        public DscpConfiguration(string name, DscpConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:DscpConfiguration", name, args ?? new DscpConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DscpConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:DscpConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20210801:DscpConfiguration" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230201:DscpConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230401:DscpConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230501:DscpConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230601:DscpConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230901:DscpConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20231101:DscpConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240101:DscpConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240301:DscpConfiguration" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240501:DscpConfiguration" },
                },
            };
    ...
    public sealed class DscpConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200601.ProtocolType>? Protocol { get; set; }
