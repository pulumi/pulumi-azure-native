...
namespace Pulumi.AzureRM.Network.V20200601
{
    public static class GetFirewallPolicyRuleCollectionGroup
    {
        public static Task<GetFirewallPolicyRuleCollectionGroupResult> InvokeAsync(GetFirewallPolicyRuleCollectionGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallPolicyRuleCollectionGroupResult>("azurerm:network/v20200601:getFirewallPolicyRuleCollectionGroup", args ?? new GetFirewallPolicyRuleCollectionGroupArgs(), options.WithVersion());
    }
    ...
    public sealed class GetFirewallPolicyRuleCollectionGroupResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Union<Outputs.FirewallPolicyFilterRuleCollectionResponseResult, Outputs.FirewallPolicyNatRuleCollectionResponseResult>> RuleCollections;
        /// <summary>
        /// Rule Group type.
        /// </summary>
        ...
        private GetFirewallPolicyRuleCollectionGroupResult(
            ...
            ImmutableArray<Union<Outputs.FirewallPolicyFilterRuleCollectionResponseResult, Outputs.FirewallPolicyNatRuleCollectionResponseResult>> ruleCollections,
