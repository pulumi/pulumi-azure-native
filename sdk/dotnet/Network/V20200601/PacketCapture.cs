...
namespace Pulumi.AzureNative.Network.V20200601
{
    ...
    /// {
    ///     var packetCapture = new AzureNative.Network.V20200601.PacketCapture("packetCapture", new()
    ///     {
    ///         BytesToCapturePerPacket = 10000,
    ///         Filters = new[]
    ///         {
    ///             new AzureNative.Network.V20200601.Inputs.PacketCaptureFilterArgs
    ///             {
    ...
    ///         StorageLocation = new AzureNative.Network.V20200601.Inputs.PacketCaptureStorageLocationArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200601:PacketCapture")]
    public partial class PacketCapture : global::Pulumi.CustomResource
    {
        ...
        public PacketCapture(string name, PacketCaptureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:PacketCapture", name, args ?? new PacketCaptureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCapture(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:PacketCapture", name, null, MakeResourceOptions(options, id))
        {
        }
