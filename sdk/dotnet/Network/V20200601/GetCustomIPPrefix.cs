...
namespace Pulumi.AzureNative.Network.V20200601
{
    public static class GetCustomIPPrefix
    {
        ...
        public static Task<GetCustomIPPrefixResult> InvokeAsync(GetCustomIPPrefixArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCustomIPPrefixResult>("azure-native:network/v20200601:getCustomIPPrefix", args ?? new GetCustomIPPrefixArgs(), options.WithDefaults());

        /// <summary>
        /// Custom IP prefix resource.
        /// </summary>
        public static Output<GetCustomIPPrefixResult> Invoke(GetCustomIPPrefixInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCustomIPPrefixResult>("azure-native:network/v20200601:getCustomIPPrefix", args ?? new GetCustomIPPrefixInvokeArgs(), options.WithDefaults());
    }
