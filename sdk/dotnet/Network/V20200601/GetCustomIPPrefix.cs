...
namespace Pulumi.AzureRM.Network.V20200601
{
    public static class GetCustomIPPrefix
    {
        public static Task<GetCustomIPPrefixResult> InvokeAsync(GetCustomIPPrefixArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCustomIPPrefixResult>("azurerm:network/v20200601:getCustomIPPrefix", args ?? new GetCustomIPPrefixArgs(), options.WithVersion());
    }
