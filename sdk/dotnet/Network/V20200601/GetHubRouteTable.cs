...
namespace Pulumi.AzureRM.Network.V20200601
{
    public static class GetHubRouteTable
    {
        public static Task<GetHubRouteTableResult> InvokeAsync(GetHubRouteTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHubRouteTableResult>("azurerm:network/v20200601:getHubRouteTable", args ?? new GetHubRouteTableArgs(), options.WithVersion());
    }
