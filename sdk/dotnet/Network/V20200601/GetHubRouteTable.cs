...
namespace Pulumi.AzureNative.Network.V20200601
{
    public static class GetHubRouteTable
    {
        ...
        public static Output<GetHubRouteTableResult> Invoke(GetHubRouteTableInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetHubRouteTableResult>("azure-native:network/v20200601:getHubRouteTable", args ?? new GetHubRouteTableInvokeArgs(), options.WithVersion());
    }
