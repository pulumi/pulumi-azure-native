...
namespace Pulumi.AzureNextGen.Network.V20200601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200601:RouteFilterRule")]
    public partial class RouteFilterRule : Pulumi.CustomResource
    {
        ...
        public RouteFilterRule(string name, RouteFilterRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200601:RouteFilterRule", name, args ?? new RouteFilterRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilterRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200601:RouteFilterRule", name, null, MakeResourceOptions(options, id))
        {
        }
