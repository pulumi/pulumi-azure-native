...
namespace Pulumi.AzureRM.Network.V20200601
{
    public static class GetVirtualNetworkTap
    {
        public static Task<GetVirtualNetworkTapResult> InvokeAsync(GetVirtualNetworkTapArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkTapResult>("azurerm:network/v20200601:getVirtualNetworkTap", args ?? new GetVirtualNetworkTapArgs(), options.WithVersion());
    }
