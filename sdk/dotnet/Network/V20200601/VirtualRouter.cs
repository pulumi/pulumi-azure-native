...
namespace Pulumi.AzureRM.Network.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualRouter = new AzureRM.Network.V20200601.VirtualRouter("virtualRouter", new AzureRM.Network.V20200601.VirtualRouterArgs
    ///         {
    ///             HostedGateway = new AzureRM.Network.V20200601.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class VirtualRouter : Pulumi.CustomResource
    {
        ...
        public VirtualRouter(string name, VirtualRouterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:VirtualRouter", name, args ?? new VirtualRouterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:VirtualRouter", name, null, MakeResourceOptions(options, id))
        {
        }
