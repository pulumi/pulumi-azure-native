...
namespace Pulumi.AzureRM.Network.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateDnsZoneGroup = new AzureRM.Network.V20200601.PrivateDnsZoneGroup("privateDnsZoneGroup", new AzureRM.Network.V20200601.PrivateDnsZoneGroupArgs
    ///         {
    ...
    public partial class PrivateDnsZoneGroup : Pulumi.CustomResource
    {
        ...
        public PrivateDnsZoneGroup(string name, PrivateDnsZoneGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:PrivateDnsZoneGroup", name, args ?? new PrivateDnsZoneGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateDnsZoneGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:PrivateDnsZoneGroup", name, null, MakeResourceOptions(options, id))
        {
        }
