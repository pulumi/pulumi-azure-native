...
namespace Pulumi.AzureNative.Network.V20200601
{
    ...
    public static class GetDdosCustomPolicy
    {
        ...
        public static Task<GetDdosCustomPolicyResult> InvokeAsync(GetDdosCustomPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDdosCustomPolicyResult>("azure-native:network/v20200601:getDdosCustomPolicy", args ?? new GetDdosCustomPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about the specified DDoS custom policy.
        /// </summary>
        public static Output<GetDdosCustomPolicyResult> Invoke(GetDdosCustomPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDdosCustomPolicyResult>("azure-native:network/v20200601:getDdosCustomPolicy", args ?? new GetDdosCustomPolicyInvokeArgs(), options.WithDefaults());
    }
