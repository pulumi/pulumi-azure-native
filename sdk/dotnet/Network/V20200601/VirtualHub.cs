...
namespace Pulumi.AzureNative.Network.V20200601
{
    ...
    /// {
    ///     var virtualHub = new AzureNative.Network.V20200601.VirtualHub("virtualHub", new()
    ///     {
    ...
    ///         VirtualWan = new AzureNative.Network.V20200601.Inputs.SubResourceArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200601:VirtualHub")]
    public partial class VirtualHub : global::Pulumi.CustomResource
    {
        ...
        public VirtualHub(string name, VirtualHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:VirtualHub", name, args ?? new VirtualHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:VirtualHub", name, null, MakeResourceOptions(options, id))
        {
        }
