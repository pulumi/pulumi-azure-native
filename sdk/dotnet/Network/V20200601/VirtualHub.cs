...
namespace Pulumi.AzureRM.Network.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualHub = new AzureRM.Network.V20200601.VirtualHub("virtualHub", new AzureRM.Network.V20200601.VirtualHubArgs
    ///         {
    ...
    ///             VirtualWan = new AzureRM.Network.V20200601.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class VirtualHub : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.SubResourceResponseResult>> BgpConnections { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.SubResourceResponseResult>> IpConfigurations { get; private set; } = null!;
        ...
        public Output<Outputs.SubResourceResponseResult?> SecurityPartnerProvider { get; private set; } = null!;
        ...
        public VirtualHub(string name, VirtualHubArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:VirtualHub", name, args ?? new VirtualHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:VirtualHub", name, null, MakeResourceOptions(options, id))
        {
        }
