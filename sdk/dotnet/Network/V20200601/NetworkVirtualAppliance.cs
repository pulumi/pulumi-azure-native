...
namespace Pulumi.AzureRM.Network.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var networkVirtualAppliance = new AzureRM.Network.V20200601.NetworkVirtualAppliance("networkVirtualAppliance", new AzureRM.Network.V20200601.NetworkVirtualApplianceArgs
    ///         {
    ...
    ///             },
    ///             Identity = new AzureRM.Network.V20200601.Inputs.ManagedServiceIdentityArgs
    ///             {
    ///                 Type = "UserAssigned",
    ///             },
    ///             Location = "West US",
    ///             NetworkVirtualApplianceName = "nva",
    ///             NvaSku = new AzureRM.Network.V20200601.Inputs.VirtualApplianceSkuPropertiesArgs
    ///             {
    ///                 BundledScaleUnit = "1",
    ...
    public partial class NetworkVirtualAppliance : Pulumi.CustomResource
    {
        ...
        public NetworkVirtualAppliance(string name, NetworkVirtualApplianceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:NetworkVirtualAppliance", name, args ?? new NetworkVirtualApplianceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkVirtualAppliance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:NetworkVirtualAppliance", name, null, MakeResourceOptions(options, id))
        {
        }
