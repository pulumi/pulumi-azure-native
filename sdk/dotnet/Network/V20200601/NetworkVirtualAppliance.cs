...
namespace Pulumi.AzureNative.Network.V20200601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200601:NetworkVirtualAppliance")]
    public partial class NetworkVirtualAppliance : Pulumi.CustomResource
    {
        ...
        public NetworkVirtualAppliance(string name, NetworkVirtualApplianceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:NetworkVirtualAppliance", name, args ?? new NetworkVirtualApplianceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkVirtualAppliance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:NetworkVirtualAppliance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20201101:NetworkVirtualAppliance"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210201:NetworkVirtualAppliance"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:NetworkVirtualAppliance"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:NetworkVirtualAppliance"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:NetworkVirtualAppliance"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:NetworkVirtualAppliance"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:NetworkVirtualAppliance"},
                },
            };
