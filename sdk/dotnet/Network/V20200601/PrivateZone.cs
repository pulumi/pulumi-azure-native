...
namespace Pulumi.AzureNative.Network.V20200601
{
    ...
    /// {
    ///     var privateZone = new AzureNative.Network.V20200601.PrivateZone("privateZone", new()
    ///     {
    ///         Location = "Global",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200601:PrivateZone")]
    public partial class PrivateZone : global::Pulumi.CustomResource
    {
        ...
        public PrivateZone(string name, PrivateZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:PrivateZone", name, args ?? new PrivateZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateZone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:PrivateZone", name, null, MakeResourceOptions(options, id))
        {
        }
