...
namespace Pulumi.AzureRM.Network.V20200601
{
    ...
    public partial class BastionHost : Pulumi.CustomResource
    {
        ...
        public BastionHost(string name, BastionHostArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:BastionHost", name, args ?? new BastionHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BastionHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:BastionHost", name, null, MakeResourceOptions(options, id))
        {
        }
