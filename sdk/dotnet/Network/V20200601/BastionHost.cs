...
namespace Pulumi.AzureNative.Network.V20200601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20200601:BastionHost is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:BastionHost to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20200601:BastionHost")]
    public partial class BastionHost : global::Pulumi.CustomResource
    {
        ...
        public BastionHost(string name, BastionHostArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:BastionHost", name, args ?? new BastionHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BastionHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:BastionHost", name, null, MakeResourceOptions(options, id))
        {
        }
