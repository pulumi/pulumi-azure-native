...
namespace Pulumi.AzureNative.Network.V20200601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20200601:P2sVpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:P2sVpnGateway to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20200601:P2sVpnGateway")]
    public partial class P2sVpnGateway : global::Pulumi.CustomResource
    {
        ...
        public P2sVpnGateway(string name, P2sVpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:P2sVpnGateway", name, args ?? new P2sVpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private P2sVpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200601:P2sVpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
