...
namespace Pulumi.AzureNative.Network.V20200601
{
    public static class GetExpressRoutePort
    {
        ...
        public static Task<GetExpressRoutePortResult> InvokeAsync(GetExpressRoutePortArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExpressRoutePortResult>("azure-native:network/v20200601:getExpressRoutePort", args ?? new GetExpressRoutePortArgs(), options.WithDefaults());

        /// <summary>
        /// ExpressRoutePort resource definition.
        /// </summary>
        public static Output<GetExpressRoutePortResult> Invoke(GetExpressRoutePortInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetExpressRoutePortResult>("azure-native:network/v20200601:getExpressRoutePort", args ?? new GetExpressRoutePortInvokeArgs(), options.WithDefaults());
    }
