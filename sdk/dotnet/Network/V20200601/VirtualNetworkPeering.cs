...
namespace Pulumi.AzureRM.Network.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkPeering = new AzureRM.Network.V20200601.VirtualNetworkPeering("virtualNetworkPeering", new AzureRM.Network.V20200601.VirtualNetworkPeeringArgs
    ///         {
    ...
    public partial class VirtualNetworkPeering : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.VirtualNetworkBgpCommunitiesResponseResult?> RemoteBgpCommunities { get; private set; } = null!;
        ...
        public VirtualNetworkPeering(string name, VirtualNetworkPeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:VirtualNetworkPeering", name, args ?? new VirtualNetworkPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20200601:VirtualNetworkPeering", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:network/v20170901:VirtualNetworkPeering"},
