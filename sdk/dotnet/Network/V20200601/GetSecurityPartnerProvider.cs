...
namespace Pulumi.AzureRM.Network.V20200601
{
    public static class GetSecurityPartnerProvider
    {
        public static Task<GetSecurityPartnerProviderResult> InvokeAsync(GetSecurityPartnerProviderArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSecurityPartnerProviderResult>("azurerm:network/v20200601:getSecurityPartnerProvider", args ?? new GetSecurityPartnerProviderArgs(), options.WithVersion());
    }
