...
namespace Pulumi.AzureNextGen.Network.V20200601.Inputs
{
    ...
    public sealed class RouteFilterRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200601.Access> Access { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200601.RouteFilterRuleType> RouteFilterRuleType { get; set; } = null!;
