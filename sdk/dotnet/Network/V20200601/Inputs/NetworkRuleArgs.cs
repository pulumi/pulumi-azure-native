...
namespace Pulumi.AzureNative.Network.V20200601.Inputs
{
    ...
    public sealed class NetworkRuleArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("ipProtocols")]
        private InputList<Union<string, Pulumi.AzureNative.Network.V20200601.FirewallPolicyRuleNetworkProtocol>>? _ipProtocols;

        /// <summary>
        /// Array of FirewallPolicyRuleNetworkProtocols.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20200601.FirewallPolicyRuleNetworkProtocol>> IpProtocols
        {
            get => _ipProtocols ?? (_ipProtocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20200601.FirewallPolicyRuleNetworkProtocol>>());
