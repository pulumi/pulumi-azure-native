...
namespace Pulumi.AzureNextGen.Network.V20200601
{
    public static class GetNatGateway
    {
        public static Task<GetNatGatewayResult> InvokeAsync(GetNatGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNatGatewayResult>("azure-nextgen:network/v20200601:getNatGateway", args ?? new GetNatGatewayArgs(), options.WithVersion());
    }
