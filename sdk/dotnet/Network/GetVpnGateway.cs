...
namespace Pulumi.AzureNative.Network
{
    public static class GetVpnGateway
    {
        ...
        public static Task<GetVpnGatewayResult> InvokeAsync(GetVpnGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnGatewayResult>("azure-native:network:getVpnGateway", args ?? new GetVpnGatewayArgs(), options.WithVersion());
        ...
        public static Output<GetVpnGatewayResult> Invoke(GetVpnGatewayInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVpnGatewayResult>("azure-native:network:getVpnGateway", args ?? new GetVpnGatewayInvokeArgs(), options.WithVersion());
    }
