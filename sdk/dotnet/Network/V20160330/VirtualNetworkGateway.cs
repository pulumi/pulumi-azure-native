...
azure-native:network/v20160330:VirtualNetworkGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20160601:VirtualNetworkGateway to guarantee forwards compatibility.")]
    ...
    public partial class VirtualNetworkGateway : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGateway(string name, VirtualNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20160330:VirtualNetworkGateway", name, args ?? new VirtualNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20160330:VirtualNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
