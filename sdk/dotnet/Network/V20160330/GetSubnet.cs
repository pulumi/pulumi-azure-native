...
namespace Pulumi.AzureNative.Network.V20160330
{
    public static class GetSubnet
    {
        ...
        public static Task<GetSubnetResult> InvokeAsync(GetSubnetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSubnetResult>("azure-native:network/v20160330:getSubnet", args ?? new GetSubnetArgs(), options.WithDefaults());

        /// <summary>
        /// The Get subnet operation retrieves information about the specified subnet.
        /// </summary>
        public static Output<GetSubnetResult> Invoke(GetSubnetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSubnetResult>("azure-native:network/v20160330:getSubnet", args ?? new GetSubnetInvokeArgs(), options.WithDefaults());
    }
