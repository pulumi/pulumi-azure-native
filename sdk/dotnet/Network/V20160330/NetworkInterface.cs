...
namespace Pulumi.AzureNextGen.Network.V20160330
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20160330:NetworkInterface")]
    public partial class NetworkInterface : Pulumi.CustomResource
    {
        ...
        public NetworkInterface(string name, NetworkInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20160330:NetworkInterface", name, args ?? new NetworkInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20160330:NetworkInterface", name, null, MakeResourceOptions(options, id))
        {
        }
