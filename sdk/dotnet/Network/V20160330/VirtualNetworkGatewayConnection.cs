...
namespace Pulumi.AzureNative.Network.V20160330
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20160330:VirtualNetworkGatewayConnection")]
    public partial class VirtualNetworkGatewayConnection : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGatewayConnection(string name, VirtualNetworkGatewayConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20160330:VirtualNetworkGatewayConnection", name, args ?? new VirtualNetworkGatewayConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGatewayConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20160330:VirtualNetworkGatewayConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkGatewayConnectionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20160330.VirtualNetworkGatewayConnectionStatus>? ConnectionStatus { get; set; }

        /// <summary>
        /// Gateway connection type IPsec/Dedicated/VpnClient/Vnet2Vnet
        /// </summary>
        [Input("connectionType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20160330.VirtualNetworkGatewayConnectionType>? ConnectionType { get; set; }
