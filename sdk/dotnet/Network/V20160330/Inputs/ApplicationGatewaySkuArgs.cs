...
namespace Pulumi.AzureNative.Network.V20160330.Inputs
{
    ...
    public sealed class ApplicationGatewaySkuArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20160330.ApplicationGatewaySkuName>? Name { get; set; }

        /// <summary>
        /// Gets or sets tier of application gateway
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20160330.ApplicationGatewayTier>? Tier { get; set; }
