...
namespace Pulumi.AzureNextGen.Network.V20160330.Inputs
{
    ...
    public sealed class InboundNatRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.NetworkInterfaceIPConfigurationArgs>? BackendIPConfiguration { get; set; }
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20160330.TransportProtocol>? Protocol { get; set; }
