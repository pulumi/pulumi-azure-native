...
namespace Pulumi.AzureNextGen.Network.V20150501Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20150501preview:NetworkSecurityGroup")]
    public partial class NetworkSecurityGroup : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.SubResourceResponse>> NetworkInterfaces { get; private set; } = null!;
        ...
        public NetworkSecurityGroup(string name, NetworkSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20150501preview:NetworkSecurityGroup", name, args ?? new NetworkSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20150501preview:NetworkSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkSecurityGroupArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.SubResourceArgs>? _networkInterfaces;

        /// <summary>
        /// Gets collection of references to Network Interfaces
        /// </summary>
        public InputList<Inputs.SubResourceArgs> NetworkInterfaces
        {
            get => _networkInterfaces ?? (_networkInterfaces = new InputList<Inputs.SubResourceArgs>());
