...
namespace Pulumi.AzureRM.Network.V20150501Preview
{
    ...
    public partial class NetworkSecurityGroup : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.SubResourceResponseResult>> NetworkInterfaces { get; private set; } = null!;
        ...
        public NetworkSecurityGroup(string name, NetworkSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20150501preview:NetworkSecurityGroup", name, args ?? new NetworkSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20150501preview:NetworkSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
