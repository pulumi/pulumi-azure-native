...
namespace Pulumi.AzureNative.Network.V20150501Preview
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20150501preview:LoadBalancer myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName} 
    /// ```
    /// </summary>
    ...
    public partial class LoadBalancer : global::Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20150501preview:LoadBalancer", name, args ?? new LoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20150501preview:LoadBalancer", name, null, MakeResourceOptions(options, id))
        {
        }
