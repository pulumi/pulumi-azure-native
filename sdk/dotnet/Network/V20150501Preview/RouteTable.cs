...
namespace Pulumi.AzureNative.Network.V20150501Preview
{
    ...
    /// RouteTable resource
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20150501preview:RouteTable")]
    public partial class RouteTable : Pulumi.CustomResource
    {
        ...
        public RouteTable(string name, RouteTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20150501preview:RouteTable", name, args ?? new RouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20150501preview:RouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
