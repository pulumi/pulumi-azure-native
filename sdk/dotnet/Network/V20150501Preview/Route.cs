...
namespace Pulumi.AzureNative.Network.V20150501Preview
{
    ...
    [AzureNativeResourceType("azure-native:network/v20150501preview:Route")]
    public partial class Route : global::Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20150501preview:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20150501preview:Route", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20150501Preview.RouteNextHopType> NextHopType { get; set; } = null!;
