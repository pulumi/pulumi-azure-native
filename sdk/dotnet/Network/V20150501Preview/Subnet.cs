...
namespace Pulumi.AzureRM.Network.V20150501Preview
{
    ...
    public partial class Subnet : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.SubResourceResponseResult?> NetworkSecurityGroup { get; private set; } = null!;
        ...
        /// </summary>
        [Output("routeTable")]
        public Output<Outputs.SubResourceResponseResult?> RouteTable { get; private set; } = null!;
        ...
        public Subnet(string name, SubnetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20150501preview:Subnet", name, args ?? new SubnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20150501preview:Subnet", name, null, MakeResourceOptions(options, id))
        {
        }
