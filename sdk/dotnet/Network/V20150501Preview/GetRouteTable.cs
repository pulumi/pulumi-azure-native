...
namespace Pulumi.AzureNative.Network.V20150501Preview
{
    ...
    public static class GetRouteTable
    {
        ...
        public static Task<GetRouteTableResult> InvokeAsync(GetRouteTableArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRouteTableResult>("azure-native:network/v20150501preview:getRouteTable", args ?? new GetRouteTableArgs(), options.WithDefaults());

        /// <summary>
        /// The Get RouteTables operation retrieves information about the specified route table.
        /// </summary>
        public static Output<GetRouteTableResult> Invoke(GetRouteTableInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRouteTableResult>("azure-native:network/v20150501preview:getRouteTable", args ?? new GetRouteTableInvokeArgs(), options.WithDefaults());
    }
