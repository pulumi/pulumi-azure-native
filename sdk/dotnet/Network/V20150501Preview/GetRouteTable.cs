...
namespace Pulumi.AzureRM.Network.V20150501Preview
{
    public static class GetRouteTable
    {
        public static Task<GetRouteTableResult> InvokeAsync(GetRouteTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteTableResult>("azurerm:network/v20150501preview:getRouteTable", args ?? new GetRouteTableArgs(), options.WithVersion());
    }
