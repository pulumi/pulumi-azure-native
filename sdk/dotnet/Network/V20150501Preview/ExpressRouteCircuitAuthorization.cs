...
namespace Pulumi.AzureNextGen.Network.V20150501Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20150501preview:ExpressRouteCircuitAuthorization")]
    public partial class ExpressRouteCircuitAuthorization : Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitAuthorization(string name, ExpressRouteCircuitAuthorizationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20150501preview:ExpressRouteCircuitAuthorization", name, args ?? new ExpressRouteCircuitAuthorizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitAuthorization(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20150501preview:ExpressRouteCircuitAuthorization", name, null, MakeResourceOptions(options, id))
        {
        }
