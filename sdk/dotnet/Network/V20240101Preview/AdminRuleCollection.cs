...
namespace Pulumi.AzureNative.Network.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240101preview:AdminRuleCollection")]
    public partial class AdminRuleCollection : global::Pulumi.CustomResource
    {
        ...
        public AdminRuleCollection(string name, AdminRuleCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101preview:AdminRuleCollection", name, args ?? new AdminRuleCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AdminRuleCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101preview:AdminRuleCollection", name, null, MakeResourceOptions(options, id))
        {
        }
