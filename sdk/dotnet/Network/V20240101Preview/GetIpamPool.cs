...
namespace Pulumi.AzureNative.Network.V20240101Preview
{
    public static class GetIpamPool
    {
        ...
        public static Task<GetIpamPoolResult> InvokeAsync(GetIpamPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIpamPoolResult>("azure-native:network/v20240101preview:getIpamPool", args ?? new GetIpamPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Instance of Pool resource.
        /// </summary>
        public static Output<GetIpamPoolResult> Invoke(GetIpamPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIpamPoolResult>("azure-native:network/v20240101preview:getIpamPool", args ?? new GetIpamPoolInvokeArgs(), options.WithDefaults());
    }
