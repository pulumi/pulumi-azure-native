...
namespace Pulumi.AzureNative.Network.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240101preview:IpamPool")]
    public partial class IpamPool : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.IpamPoolPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public IpamPool(string name, IpamPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101preview:IpamPool", name, args ?? new IpamPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpamPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101preview:IpamPool", name, null, MakeResourceOptions(options, id))
        {
        }
