...
namespace Pulumi.AzureNative.Network.V20240101Preview.Inputs
{
    ...
    public sealed class IPTrafficArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.V20240101Preview.NetworkProtocol>>? _protocols;
        public InputList<Union<string, Pulumi.AzureNative.Network.V20240101Preview.NetworkProtocol>> Protocols
        {
            get => _protocols ?? (_protocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20240101Preview.NetworkProtocol>>());
