...
namespace Pulumi.AzureNative.Network.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240101preview:DefaultAdminRule")]
    public partial class DefaultAdminRule : global::Pulumi.CustomResource
    {
        ...
        public DefaultAdminRule(string name, DefaultAdminRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101preview:DefaultAdminRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private DefaultAdminRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240101preview:DefaultAdminRule", name, null, MakeResourceOptions(options, id))
        {
        }
