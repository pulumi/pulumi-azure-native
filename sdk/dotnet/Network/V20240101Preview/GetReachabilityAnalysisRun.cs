...
namespace Pulumi.AzureNative.Network.V20240101Preview
{
    public static class GetReachabilityAnalysisRun
    {
        ...
        public static Task<GetReachabilityAnalysisRunResult> InvokeAsync(GetReachabilityAnalysisRunArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReachabilityAnalysisRunResult>("azure-native:network/v20240101preview:getReachabilityAnalysisRun", args ?? new GetReachabilityAnalysisRunArgs(), options.WithDefaults());
