...
namespace Pulumi.AzureNative.Network.V20171101
{
    ...
    [AzureNativeResourceType("azure-native:network/v20171101:InboundNatRule")]
    public partial class InboundNatRule : Pulumi.CustomResource
    {
        ...
        public InboundNatRule(string name, InboundNatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20171101:InboundNatRule", name, args ?? new InboundNatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InboundNatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20171101:InboundNatRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InboundNatRuleArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20171101.TransportProtocol>? Protocol { get; set; }
