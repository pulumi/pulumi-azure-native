...
namespace Pulumi.AzureNative.Network.V20171101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20171101:PacketCapture")]
    public partial class PacketCapture : Pulumi.CustomResource
    {
        ...
        public PacketCapture(string name, PacketCaptureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20171101:PacketCapture", name, args ?? new PacketCaptureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCapture(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20171101:PacketCapture", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20201101:PacketCapture"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210201:PacketCapture"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:PacketCapture"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:PacketCapture"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:PacketCapture"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:PacketCapture"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:PacketCapture"},
                },
            };
