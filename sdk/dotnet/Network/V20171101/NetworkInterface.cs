...
namespace Pulumi.AzureNative.Network.V20171101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20171101:NetworkInterface")]
    public partial class NetworkInterface : Pulumi.CustomResource
    {
        ...
        public NetworkInterface(string name, NetworkInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20171101:NetworkInterface", name, args ?? new NetworkInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20171101:NetworkInterface", name, null, MakeResourceOptions(options, id))
        {
        }
