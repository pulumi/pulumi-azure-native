...
namespace Pulumi.AzureNextGen.Network.V20171101.Inputs
{
    ...
    public sealed class ApplicationGatewayBackendHttpSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20171101.ApplicationGatewayCookieBasedAffinity>? CookieBasedAffinity { get; set; }
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20171101.ApplicationGatewayProtocol>? Protocol { get; set; }
