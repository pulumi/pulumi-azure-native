...
namespace Pulumi.AzureNextGen.Network.V20171101.Inputs
{
    ...
    public sealed class LoadBalancingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20171101.LoadDistribution>? LoadDistribution { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20171101.TransportProtocol> Protocol { get; set; } = null!;
