...
namespace Pulumi.AzureNative.Network.V20171101
{
    public static class GetInboundNatRule
    {
        ...
        public static Task<GetInboundNatRuleResult> InvokeAsync(GetInboundNatRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInboundNatRuleResult>("azure-native:network/v20171101:getInboundNatRule", args ?? new GetInboundNatRuleArgs(), options.WithVersion());

        /// <summary>
        /// Inbound NAT rule of the load balancer.
        /// </summary>
        public static Output<GetInboundNatRuleResult> Invoke(GetInboundNatRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetInboundNatRuleResult>("azure-native:network/v20171101:getInboundNatRule", args ?? new GetInboundNatRuleInvokeArgs(), options.WithVersion());
    }
