...
namespace Pulumi.AzureNative.Network
{
    ...
    public partial class SecurityUserRuleCollection : global::Pulumi.CustomResource
    {
        ...
        public SecurityUserRuleCollection(string name, SecurityUserRuleCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network:SecurityUserRuleCollection", name, args ?? new SecurityUserRuleCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityUserRuleCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network:SecurityUserRuleCollection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_network_v20210201preview:network:SecurityUserRuleCollection" },
                    new global::Pulumi.Alias { Type = "azure-native_network_v20210501preview:network:SecurityUserRuleCollection" },
                    new global::Pulumi.Alias { Type = "azure-native_network_v20220201preview:network:SecurityUserRuleCollection" },
                    new global::Pulumi.Alias { Type = "azure-native_network_v20220401preview:network:SecurityUserRuleCollection" },
                    new global::Pulumi.Alias { Type = "azure-native_network_v20240301:network:SecurityUserRuleCollection" },
                    new global::Pulumi.Alias { Type = "azure-native_network_v20240501:network:SecurityUserRuleCollection" },
                },
            };
