...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class NetworkProfile : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.NetworkProfilePropertiesFormatResponse> Properties { get; private set; } = null!;
        ...
        public NetworkProfile(string name, NetworkProfileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:NetworkProfile", name, args ?? new NetworkProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkProfile(string name, Input<string> id, NetworkProfileState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:NetworkProfile", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkProfileState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.NetworkProfilePropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
