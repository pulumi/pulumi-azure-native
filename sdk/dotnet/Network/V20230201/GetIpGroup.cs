...
namespace Pulumi.AzureNative.Network.V20230201
{
    public static class GetIpGroup
    {
        ...
        public static Task<GetIpGroupResult> InvokeAsync(GetIpGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIpGroupResult>("azure-native:network/v20230201:getIpGroup", args ?? new GetIpGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified ipGroups.
        /// </summary>
        public static Output<GetIpGroupResult> Invoke(GetIpGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIpGroupResult>("azure-native:network/v20230201:getIpGroup", args ?? new GetIpGroupInvokeArgs(), options.WithDefaults());
    }
