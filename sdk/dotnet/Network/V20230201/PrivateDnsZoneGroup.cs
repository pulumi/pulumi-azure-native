...
namespace Pulumi.AzureNative.Network.V20230201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230201:PrivateDnsZoneGroup")]
    public partial class PrivateDnsZoneGroup : global::Pulumi.CustomResource
    {
        ...
        public PrivateDnsZoneGroup(string name, PrivateDnsZoneGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230201:PrivateDnsZoneGroup", name, args ?? new PrivateDnsZoneGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateDnsZoneGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230201:PrivateDnsZoneGroup", name, null, MakeResourceOptions(options, id))
        {
        }
