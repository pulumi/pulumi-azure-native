...
namespace Pulumi.AzureNative.Network.V20230201
{
    public static class GetPrivateLinkService
    {
        ...
        public static Task<GetPrivateLinkServiceResult> InvokeAsync(GetPrivateLinkServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateLinkServiceResult>("azure-native:network/v20230201:getPrivateLinkService", args ?? new GetPrivateLinkServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified private link service by resource group.
        /// </summary>
        public static Output<GetPrivateLinkServiceResult> Invoke(GetPrivateLinkServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPrivateLinkServiceResult>("azure-native:network/v20230201:getPrivateLinkService", args ?? new GetPrivateLinkServiceInvokeArgs(), options.WithDefaults());
    }
