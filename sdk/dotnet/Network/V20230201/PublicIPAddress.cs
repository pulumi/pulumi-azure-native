...
namespace Pulumi.AzureNative.Network.V20230201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230201:PublicIPAddress")]
    public partial class PublicIPAddress : global::Pulumi.CustomResource
    {
        ...
        public PublicIPAddress(string name, PublicIPAddressArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230201:PublicIPAddress", name, args ?? new PublicIPAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230201:PublicIPAddress", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PublicIPAddressArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("deleteOption")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230201.DeleteOptions>? DeleteOption { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230201.PublicIPAddressMigrationPhase>? MigrationPhase { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230201.IPVersion>? PublicIPAddressVersion { get; set; }

        /// <summary>
        /// The public IP address allocation method.
        /// </summary>
        [Input("publicIPAllocationMethod")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230201.IPAllocationMethod>? PublicIPAllocationMethod { get; set; }
