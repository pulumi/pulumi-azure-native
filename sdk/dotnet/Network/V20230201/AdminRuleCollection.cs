...
namespace Pulumi.AzureNative.Network.V20230201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230201:AdminRuleCollection")]
    public partial class AdminRuleCollection : global::Pulumi.CustomResource
    {
        ...
        public AdminRuleCollection(string name, AdminRuleCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230201:AdminRuleCollection", name, args ?? new AdminRuleCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AdminRuleCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230201:AdminRuleCollection", name, null, MakeResourceOptions(options, id))
        {
        }
