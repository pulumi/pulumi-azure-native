...
namespace Pulumi.AzureNative.Network.V20230201
{
    ...
    /// VirtualHub Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230201:VirtualHub")]
    public partial class VirtualHub : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("securityPartnerProvider")]
        public Output<Outputs.SubResourceResponse?> SecurityPartnerProvider { get; private set; } = null!;
        ...
        public VirtualHub(string name, VirtualHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230201:VirtualHub", name, args ?? new VirtualHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230201:VirtualHub", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualHubArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230201.HubRoutingPreference>? HubRoutingPreference { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20230201.PreferredRoutingGateway>? PreferredRoutingGateway { get; set; }
        ...
        public Input<Inputs.SubResourceArgs>? SecurityPartnerProvider { get; set; }
