...
namespace Pulumi.AzureNative.Network.V20230201
{
    public static class GetCustomIPPrefix
    {
        ...
        public static Task<GetCustomIPPrefixResult> InvokeAsync(GetCustomIPPrefixArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomIPPrefixResult>("azure-native:network/v20230201:getCustomIPPrefix", args ?? new GetCustomIPPrefixArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified custom IP prefix in a specified resource group.
        /// </summary>
        public static Output<GetCustomIPPrefixResult> Invoke(GetCustomIPPrefixInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCustomIPPrefixResult>("azure-native:network/v20230201:getCustomIPPrefix", args ?? new GetCustomIPPrefixInvokeArgs(), options.WithDefaults());
    }
