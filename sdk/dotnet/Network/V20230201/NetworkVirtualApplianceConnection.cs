...
namespace Pulumi.AzureNative.Network.V20230201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230201:NetworkVirtualApplianceConnection")]
    public partial class NetworkVirtualApplianceConnection : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.RoutingConfigurationNfvResponse?> RoutingConfiguration { get; private set; } = null!;
        ...
        public NetworkVirtualApplianceConnection(string name, NetworkVirtualApplianceConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230201:NetworkVirtualApplianceConnection", name, args ?? new NetworkVirtualApplianceConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkVirtualApplianceConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230201:NetworkVirtualApplianceConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230401:NetworkVirtualApplianceConnection"},
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230501:NetworkVirtualApplianceConnection"},
                },
            };
    ...
    public sealed class NetworkVirtualApplianceConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RoutingConfigurationNfvArgs>? RoutingConfiguration { get; set; }
