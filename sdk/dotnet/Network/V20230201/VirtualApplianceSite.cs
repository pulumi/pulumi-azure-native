...
namespace Pulumi.AzureNative.Network.V20230201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230201:VirtualApplianceSite")]
    public partial class VirtualApplianceSite : global::Pulumi.CustomResource
    {
        ...
        public VirtualApplianceSite(string name, VirtualApplianceSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230201:VirtualApplianceSite", name, args ?? new VirtualApplianceSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualApplianceSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230201:VirtualApplianceSite", name, null, MakeResourceOptions(options, id))
        {
        }
