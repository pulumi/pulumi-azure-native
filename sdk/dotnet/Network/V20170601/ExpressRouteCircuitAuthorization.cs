...
namespace Pulumi.AzureNative.Network.V20170601
{
    ...
    [AzureNativeResourceType("azure-native:network/v20170601:ExpressRouteCircuitAuthorization")]
    public partial class ExpressRouteCircuitAuthorization : Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitAuthorization(string name, ExpressRouteCircuitAuthorizationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170601:ExpressRouteCircuitAuthorization", name, args ?? new ExpressRouteCircuitAuthorizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitAuthorization(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170601:ExpressRouteCircuitAuthorization", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRouteCircuitAuthorizationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20170601.AuthorizationUseStatus>? AuthorizationUseStatus { get; set; }
