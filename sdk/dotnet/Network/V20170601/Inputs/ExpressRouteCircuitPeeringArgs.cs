...
namespace Pulumi.AzureNextGen.Network.V20170601.Inputs
{
    ...
    public sealed class ExpressRouteCircuitPeeringArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("peeringType")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170601.ExpressRouteCircuitPeeringType>? PeeringType { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170601.ExpressRouteCircuitPeeringState>? State { get; set; }
