...
namespace Pulumi.AzureNative.Network.V20190201
{
    public static class GetVpnGateway
    {
        ...
        public static Task<GetVpnGatewayResult> InvokeAsync(GetVpnGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnGatewayResult>("azure-native:network/v20190201:getVpnGateway", args ?? new GetVpnGatewayArgs(), options.WithVersion());

        /// <summary>
        /// VpnGateway Resource.
        /// </summary>
        public static Output<GetVpnGatewayResult> Invoke(GetVpnGatewayInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVpnGatewayResult>("azure-native:network/v20190201:getVpnGateway", args ?? new GetVpnGatewayInvokeArgs(), options.WithVersion());
    }
