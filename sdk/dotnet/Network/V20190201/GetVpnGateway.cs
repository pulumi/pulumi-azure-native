...
namespace Pulumi.AzureNextGen.Network.V20190201
{
    public static class GetVpnGateway
    {
        public static Task<GetVpnGatewayResult> InvokeAsync(GetVpnGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnGatewayResult>("azure-nextgen:network/v20190201:getVpnGateway", args ?? new GetVpnGatewayArgs(), options.WithVersion());
    }
