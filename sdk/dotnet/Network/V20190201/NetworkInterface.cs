...
namespace Pulumi.AzureNative.Network.V20190201
{
    ...
    /// {
    ///     var networkInterface = new AzureNative.Network.V20190201.NetworkInterface("networkInterface", new()
    ///     {
    ///         EnableAcceleratedNetworking = true,
    ///         IpConfigurations = new[]
    ///         {
    ///             new AzureNative.Network.V20190201.Inputs.NetworkInterfaceIPConfigurationArgs
    ///             {
    ///                 Name = "ipconfig1",
    ///                 PublicIPAddress = new AzureNative.Network.V20190201.Inputs.PublicIPAddressArgs
    ///                 {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20190201:NetworkInterface test-nic /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/networkInterfaces/test-nic 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190201:NetworkInterface")]
    public partial class NetworkInterface : global::Pulumi.CustomResource
    {
        ...
        public NetworkInterface(string name, NetworkInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190201:NetworkInterface", name, args ?? new NetworkInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190201:NetworkInterface", name, null, MakeResourceOptions(options, id))
        {
        }
