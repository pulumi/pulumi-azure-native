...
namespace Pulumi.AzureNative.Network.V20190201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190201:ServiceEndpointPolicy")]
    public partial class ServiceEndpointPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServiceEndpointPolicy(string name, ServiceEndpointPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190201:ServiceEndpointPolicy", name, args ?? new ServiceEndpointPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceEndpointPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190201:ServiceEndpointPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
