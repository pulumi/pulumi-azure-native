...
namespace Pulumi.AzureRM.Network.V20190201
{
    public static class GetPacketCapture
    {
        public static Task<GetPacketCaptureResult> InvokeAsync(GetPacketCaptureArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPacketCaptureResult>("azurerm:network/v20190201:getPacketCapture", args ?? new GetPacketCaptureArgs(), options.WithVersion());
    }
