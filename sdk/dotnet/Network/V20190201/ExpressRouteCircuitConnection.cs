...
namespace Pulumi.AzureNextGen.Network.V20190201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190201:ExpressRouteCircuitConnection")]
    public partial class ExpressRouteCircuitConnection : Pulumi.CustomResource
    {
        ...
        public ExpressRouteCircuitConnection(string name, ExpressRouteCircuitConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190201:ExpressRouteCircuitConnection", name, args ?? new ExpressRouteCircuitConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCircuitConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190201:ExpressRouteCircuitConnection", name, null, MakeResourceOptions(options, id))
        {
        }
