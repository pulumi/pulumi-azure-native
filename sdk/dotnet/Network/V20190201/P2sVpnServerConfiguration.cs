...
namespace Pulumi.AzureNextGen.Network.V20190201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190201:P2sVpnServerConfiguration")]
    public partial class P2sVpnServerConfiguration : Pulumi.CustomResource
    {
        ...
        public P2sVpnServerConfiguration(string name, P2sVpnServerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190201:P2sVpnServerConfiguration", name, args ?? new P2sVpnServerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private P2sVpnServerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190201:P2sVpnServerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
