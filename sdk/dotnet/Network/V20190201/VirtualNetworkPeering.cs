...
namespace Pulumi.AzureNative.Network.V20190201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20190201:VirtualNetworkPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:VirtualNetworkPeering to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20190201:VirtualNetworkPeering")]
    public partial class VirtualNetworkPeering : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkPeering(string name, VirtualNetworkPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190201:VirtualNetworkPeering", name, args ?? new VirtualNetworkPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190201:VirtualNetworkPeering", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkPeeringArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("peeringState")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20190201.VirtualNetworkPeeringState>? PeeringState { get; set; }
