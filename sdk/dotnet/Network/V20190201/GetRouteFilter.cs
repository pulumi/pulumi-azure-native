...
namespace Pulumi.AzureNextGen.Network.V20190201
{
    public static class GetRouteFilter
    {
        public static Task<GetRouteFilterResult> InvokeAsync(GetRouteFilterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteFilterResult>("azure-nextgen:network/v20190201:getRouteFilter", args ?? new GetRouteFilterArgs(), options.WithVersion());
    }
