...
{
    [Obsolete(@"azure-native:network/v20190201:RouteFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:RouteFilter to guarantee forwards compatibility.")]
    public static class GetRouteFilter
    {
        ...
        public static Task<GetRouteFilterResult> InvokeAsync(GetRouteFilterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRouteFilterResult>("azure-native:network/v20190201:getRouteFilter", args ?? new GetRouteFilterArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified route filter.
        /// </summary>
        public static Output<GetRouteFilterResult> Invoke(GetRouteFilterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRouteFilterResult>("azure-native:network/v20190201:getRouteFilter", args ?? new GetRouteFilterInvokeArgs(), options.WithDefaults());
    }
