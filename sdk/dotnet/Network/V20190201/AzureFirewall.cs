...
namespace Pulumi.AzureRM.Network.V20190201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var azureFirewall = new AzureRM.Network.V20190201.AzureFirewall("azureFirewall", new AzureRM.Network.V20190201.AzureFirewallArgs
    ///         {
    ///             ApplicationRuleCollections = 
    ///             {
    ///                 new AzureRM.Network.V20190201.Inputs.AzureFirewallApplicationRuleCollectionArgs
    ///                 {
    ///                     Name = "apprulecoll",
    ///                 },
    ///             },
    ...
    ///             IpConfigurations = 
    ///             {
    ///                 new AzureRM.Network.V20190201.Inputs.AzureFirewallIPConfigurationArgs
    ///                 {
    ...
    ///             NatRuleCollections = 
    ///             {
    ///                 new AzureRM.Network.V20190201.Inputs.AzureFirewallNatRuleCollectionArgs
    ///                 {
    ///                     Name = "natrulecoll",
    ///                 },
    ///             },
    ...
    ///             {
    ///                 new AzureRM.Network.V20190201.Inputs.AzureFirewallNetworkRuleCollectionArgs
    ///                 {
    ///                     Name = "netrulecoll",
    ///                 },
    ///             },
    ...
    public partial class AzureFirewall : Pulumi.CustomResource
    {
        ...
        public AzureFirewall(string name, AzureFirewallArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190201:AzureFirewall", name, args ?? new AzureFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureFirewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190201:AzureFirewall", name, null, MakeResourceOptions(options, id))
        {
        }
