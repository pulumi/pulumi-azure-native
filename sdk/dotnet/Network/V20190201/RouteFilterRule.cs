...
namespace Pulumi.AzureNative.Network.V20190201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20190201:RouteFilterRule")]
    public partial class RouteFilterRule : global::Pulumi.CustomResource
    {
        ...
        public RouteFilterRule(string name, RouteFilterRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190201:RouteFilterRule", name, args ?? new RouteFilterRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilterRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20190201:RouteFilterRule", name, null, MakeResourceOptions(options, id))
        {
        }
