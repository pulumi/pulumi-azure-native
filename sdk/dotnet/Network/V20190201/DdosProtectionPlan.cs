...
namespace Pulumi.AzureRM.Network.V20190201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var ddosProtectionPlan = new AzureRM.Network.V20190201.DdosProtectionPlan("ddosProtectionPlan", new AzureRM.Network.V20190201.DdosProtectionPlanArgs
    ///         {
    ...
    public partial class DdosProtectionPlan : Pulumi.CustomResource
    {
        ...
        public DdosProtectionPlan(string name, DdosProtectionPlanArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190201:DdosProtectionPlan", name, args ?? new DdosProtectionPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DdosProtectionPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20190201:DdosProtectionPlan", name, null, MakeResourceOptions(options, id))
        {
        }
