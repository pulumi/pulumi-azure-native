...
namespace Pulumi.AzureNextGen.Network.V20190201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190201:DdosProtectionPlan")]
    public partial class DdosProtectionPlan : Pulumi.CustomResource
    {
        ...
        public DdosProtectionPlan(string name, DdosProtectionPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190201:DdosProtectionPlan", name, args ?? new DdosProtectionPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DdosProtectionPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190201:DdosProtectionPlan", name, null, MakeResourceOptions(options, id))
        {
        }
