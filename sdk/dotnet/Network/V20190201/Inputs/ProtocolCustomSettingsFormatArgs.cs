...
namespace Pulumi.AzureNextGen.Network.V20190201.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190201.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190201.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
