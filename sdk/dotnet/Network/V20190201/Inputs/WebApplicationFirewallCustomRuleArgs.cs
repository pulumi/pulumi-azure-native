...
namespace Pulumi.AzureNextGen.Network.V20190201.Inputs
{
    ...
    public sealed class WebApplicationFirewallCustomRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190201.WebApplicationFirewallAction> Action { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20190201.WebApplicationFirewallRuleType> RuleType { get; set; } = null!;
