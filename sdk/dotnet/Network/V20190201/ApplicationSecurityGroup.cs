...
namespace Pulumi.AzureNextGen.Network.V20190201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20190201:ApplicationSecurityGroup")]
    public partial class ApplicationSecurityGroup : Pulumi.CustomResource
    {
        ...
        public ApplicationSecurityGroup(string name, ApplicationSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190201:ApplicationSecurityGroup", name, args ?? new ApplicationSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20190201:ApplicationSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
