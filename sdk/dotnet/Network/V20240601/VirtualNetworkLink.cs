...
namespace Pulumi.AzureNative.Network.V20240601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240601:VirtualNetworkLink")]
    public partial class VirtualNetworkLink : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkLink(string name, VirtualNetworkLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240601:VirtualNetworkLink", name, args ?? new VirtualNetworkLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240601:VirtualNetworkLink", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkLinkArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240601.ResolutionPolicy>? ResolutionPolicy { get; set; }
