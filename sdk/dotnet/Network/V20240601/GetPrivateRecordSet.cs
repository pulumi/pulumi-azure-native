...
namespace Pulumi.AzureNative.Network.V20240601
{
    public static class GetPrivateRecordSet
    {
        ...
        public static Task<GetPrivateRecordSetResult> InvokeAsync(GetPrivateRecordSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateRecordSetResult>("azure-native:network/v20240601:getPrivateRecordSet", args ?? new GetPrivateRecordSetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a record set.
        /// </summary>
        public static Output<GetPrivateRecordSetResult> Invoke(GetPrivateRecordSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPrivateRecordSetResult>("azure-native:network/v20240601:getPrivateRecordSet", args ?? new GetPrivateRecordSetInvokeArgs(), options.WithDefaults());
    }
