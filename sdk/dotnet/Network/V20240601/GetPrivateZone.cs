...
namespace Pulumi.AzureNative.Network.V20240601
{
    public static class GetPrivateZone
    {
        ...
        public static Task<GetPrivateZoneResult> InvokeAsync(GetPrivateZoneArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateZoneResult>("azure-native:network/v20240601:getPrivateZone", args ?? new GetPrivateZoneArgs(), options.WithDefaults());
