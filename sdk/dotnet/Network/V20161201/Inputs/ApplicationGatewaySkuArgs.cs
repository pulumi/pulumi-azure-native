...
namespace Pulumi.AzureNextGen.Network.V20161201.Inputs
{
    ...
    public sealed class ApplicationGatewaySkuArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20161201.ApplicationGatewaySkuName>? Name { get; set; }

        /// <summary>
        /// Tier of an application gateway. Possible values are: 'Standard' and 'WAF'.
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20161201.ApplicationGatewayTier>? Tier { get; set; }
