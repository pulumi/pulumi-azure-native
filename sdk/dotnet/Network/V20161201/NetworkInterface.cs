...
namespace Pulumi.AzureNextGen.Network.V20161201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20161201:NetworkInterface")]
    public partial class NetworkInterface : Pulumi.CustomResource
    {
        ...
        public NetworkInterface(string name, NetworkInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20161201:NetworkInterface", name, args ?? new NetworkInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20161201:NetworkInterface", name, null, MakeResourceOptions(options, id))
        {
        }
