...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class P2svpnGateway : Pulumi.CustomResource
    {
        ...
        private P2svpnGateway(string name, Input<string> id, P2svpnGatewayState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:P2svpnGateway", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static P2svpnGateway Get(string name, Input<string> id, P2svpnGatewayState? state = null, CustomResourceOptions? options = null)
        {
            return new P2svpnGateway(name, id, state, options);
        }
    }
    ...
    public sealed class P2svpnGatewayState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A unique read-only string that changes whenever the resource is updated.
        /// </summary>
        ...
        public Input<Inputs.P2SVpnGatewayPropertiesResponseGetArgs> Properties { get; set; } = null!;
