...
namespace Pulumi.AzureNative.Network
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network:NspAssociationsProxy")]
    public partial class NspAssociationsProxy : global::Pulumi.CustomResource
    {
        ...
        public NspAssociationsProxy(string name, NspAssociationsProxyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network:NspAssociationsProxy", name, args ?? new NspAssociationsProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NspAssociationsProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network:NspAssociationsProxy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:network/v20210201preview:NspAssociationsProxy"},
                },
            };
