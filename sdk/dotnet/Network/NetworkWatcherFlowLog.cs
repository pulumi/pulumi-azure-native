...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class NetworkWatcherFlowLog : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.FlowLogPropertiesFormatResponse> Properties { get; private set; } = null!;
        ...
        public NetworkWatcherFlowLog(string name, NetworkWatcherFlowLogArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network:NetworkWatcherFlowLog", name, args ?? new NetworkWatcherFlowLogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkWatcherFlowLog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network:NetworkWatcherFlowLog", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetworkWatcherFlowLog Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new NetworkWatcherFlowLog(name, id, options);
        }
    }
