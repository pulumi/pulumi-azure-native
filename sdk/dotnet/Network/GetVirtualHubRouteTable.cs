...
namespace Pulumi.AzureRM.Network
{
    public static class GetVirtualHubRouteTable
    {
        public static Task<GetVirtualHubRouteTableResult> InvokeAsync(GetVirtualHubRouteTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualHubRouteTableResult>("azurerm:network:getVirtualHubRouteTable", args ?? new GetVirtualHubRouteTableArgs(), options.WithVersion());
    }


    public sealed class GetVirtualHubRouteTableArgs : Pulumi.InvokeArgs
    {
        /// <summary>
