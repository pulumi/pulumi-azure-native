...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class ExpressRouteCrossConnectionPeering : Pulumi.CustomResource
    {
        ...
        private ExpressRouteCrossConnectionPeering(string name, Input<string> id, ExpressRouteCrossConnectionPeeringState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:ExpressRouteCrossConnectionPeering", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ExpressRouteCrossConnectionPeering Get(string name, Input<string> id, ExpressRouteCrossConnectionPeeringState? state = null, CustomResourceOptions? options = null)
        {
            return new ExpressRouteCrossConnectionPeering(name, id, state, options);
        }
    }
    ...
    public sealed class ExpressRouteCrossConnectionPeeringState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A unique read-only string that changes whenever the resource is updated.
        /// </summary>
        ...
        public Input<Inputs.ExpressRouteCrossConnectionPeeringPropertiesResponseGetArgs> Properties { get; set; } = null!;

        public ExpressRouteCrossConnectionPeeringState()
        {
        }
    }
}
