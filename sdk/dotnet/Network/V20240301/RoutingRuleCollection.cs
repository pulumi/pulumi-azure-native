...
namespace Pulumi.AzureNative.Network.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240301:RoutingRuleCollection")]
    public partial class RoutingRuleCollection : global::Pulumi.CustomResource
    {
        ...
        public RoutingRuleCollection(string name, RoutingRuleCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:RoutingRuleCollection", name, args ?? new RoutingRuleCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoutingRuleCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:RoutingRuleCollection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RoutingRuleCollectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.DisableBgpRoutePropagation>? DisableBgpRoutePropagation { get; set; }
