...
namespace Pulumi.AzureNative.Network.V20240301
{
    public static class GetIpAllocation
    {
        ...
        public static Task<GetIpAllocationResult> InvokeAsync(GetIpAllocationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIpAllocationResult>("azure-native:network/v20240301:getIpAllocation", args ?? new GetIpAllocationArgs(), options.WithDefaults());
