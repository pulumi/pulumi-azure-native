...
namespace Pulumi.AzureNative.Network.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240301:NetworkGroup")]
    public partial class NetworkGroup : global::Pulumi.CustomResource
    {
        ...
        public NetworkGroup(string name, NetworkGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:NetworkGroup", name, args ?? new NetworkGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:NetworkGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("memberType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.GroupMemberType>? MemberType { get; set; }
