...
namespace Pulumi.AzureNative.Network.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240301:VirtualHubRouteTableV2")]
    public partial class VirtualHubRouteTableV2 : global::Pulumi.CustomResource
    {
        ...
        public VirtualHubRouteTableV2(string name, VirtualHubRouteTableV2Args args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:VirtualHubRouteTableV2", name, args ?? new VirtualHubRouteTableV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubRouteTableV2(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:VirtualHubRouteTableV2", name, null, MakeResourceOptions(options, id))
        {
        }
