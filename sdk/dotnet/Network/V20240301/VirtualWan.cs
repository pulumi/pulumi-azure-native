...
namespace Pulumi.AzureNative.Network.V20240301
{
    ...
    /// VirtualWAN Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240301:VirtualWan")]
    public partial class VirtualWan : global::Pulumi.CustomResource
    {
        ...
        public VirtualWan(string name, VirtualWanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:VirtualWan", name, args ?? new VirtualWanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualWan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:VirtualWan", name, null, MakeResourceOptions(options, id))
        {
        }
