...
namespace Pulumi.AzureNative.Network.V20240301
{
    public static class GetRoutingIntent
    {
        ...
        public static Task<GetRoutingIntentResult> InvokeAsync(GetRoutingIntentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRoutingIntentResult>("azure-native:network/v20240301:getRoutingIntent", args ?? new GetRoutingIntentArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the details of a RoutingIntent.
        /// </summary>
        public static Output<GetRoutingIntentResult> Invoke(GetRoutingIntentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRoutingIntentResult>("azure-native:network/v20240301:getRoutingIntent", args ?? new GetRoutingIntentInvokeArgs(), options.WithDefaults());
    }
