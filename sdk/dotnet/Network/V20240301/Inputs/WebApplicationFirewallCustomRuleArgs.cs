...
namespace Pulumi.AzureNative.Network.V20240301.Inputs
{
    ...
    public sealed class WebApplicationFirewallCustomRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.WebApplicationFirewallAction> Action { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.ApplicationGatewayFirewallRateLimitDuration>? RateLimitDuration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.WebApplicationFirewallRuleType> RuleType { get; set; } = null!;

        /// <summary>
        /// Describes if the custom rule is in enabled or disabled state. Defaults to Enabled if not specified.
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.WebApplicationFirewallState>? State { get; set; }
