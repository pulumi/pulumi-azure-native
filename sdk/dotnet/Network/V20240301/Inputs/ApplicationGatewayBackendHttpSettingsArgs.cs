...
namespace Pulumi.AzureNative.Network.V20240301.Inputs
{
    ...
    public sealed class ApplicationGatewayBackendHttpSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.ApplicationGatewayCookieBasedAffinity>? CookieBasedAffinity { get; set; }
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.ApplicationGatewayProtocol>? Protocol { get; set; }
