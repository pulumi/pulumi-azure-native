...
namespace Pulumi.AzureNative.Network.V20240301.Inputs
{
    ...
    public sealed class FirewallPolicyIntrusionDetectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.FirewallPolicyIntrusionDetectionStateType>? Mode { get; set; }

        /// <summary>
        /// IDPS profile name. When attached to a parent policy, the firewall's effective profile is the profile name of the parent policy.
        /// </summary>
        [Input("profile")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.FirewallPolicyIntrusionDetectionProfileType>? Profile { get; set; }
