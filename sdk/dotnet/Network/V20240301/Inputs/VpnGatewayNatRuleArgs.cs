...
namespace Pulumi.AzureNative.Network.V20240301.Inputs
{
    ...
    public sealed class VpnGatewayNatRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.VpnNatRuleMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.VpnNatRuleType>? Type { get; set; }
