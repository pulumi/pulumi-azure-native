...
namespace Pulumi.AzureNative.Network.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240301:SecurityUserRule")]
    public partial class SecurityUserRule : global::Pulumi.CustomResource
    {
        ...
        public SecurityUserRule(string name, SecurityUserRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:SecurityUserRule", name, args ?? new SecurityUserRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityUserRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:SecurityUserRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityUserRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.SecurityConfigurationRuleDirection> Direction { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.SecurityConfigurationRuleProtocol> Protocol { get; set; } = null!;
