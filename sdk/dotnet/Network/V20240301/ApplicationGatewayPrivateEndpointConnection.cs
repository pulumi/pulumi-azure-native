...
namespace Pulumi.AzureNative.Network.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240301:ApplicationGatewayPrivateEndpointConnection")]
    public partial class ApplicationGatewayPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGatewayPrivateEndpointConnection(string name, ApplicationGatewayPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:ApplicationGatewayPrivateEndpointConnection", name, args ?? new ApplicationGatewayPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGatewayPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:ApplicationGatewayPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
