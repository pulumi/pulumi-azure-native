...
namespace Pulumi.AzureNative.Network.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240301:VirtualRouterPeering")]
    public partial class VirtualRouterPeering : global::Pulumi.CustomResource
    {
        ...
        public VirtualRouterPeering(string name, VirtualRouterPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:VirtualRouterPeering", name, args ?? new VirtualRouterPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouterPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:VirtualRouterPeering", name, null, MakeResourceOptions(options, id))
        {
        }
