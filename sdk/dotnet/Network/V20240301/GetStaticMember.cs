...
namespace Pulumi.AzureNative.Network.V20240301
{
    public static class GetStaticMember
    {
        ...
        public static Task<GetStaticMemberResult> InvokeAsync(GetStaticMemberArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStaticMemberResult>("azure-native:network/v20240301:getStaticMember", args ?? new GetStaticMemberArgs(), options.WithDefaults());
