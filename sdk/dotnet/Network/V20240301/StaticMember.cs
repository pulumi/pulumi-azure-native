...
namespace Pulumi.AzureNative.Network.V20240301
{
    ...
    /// StaticMember Item.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240301:StaticMember")]
    public partial class StaticMember : global::Pulumi.CustomResource
    {
        ...
        public StaticMember(string name, StaticMemberArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:StaticMember", name, args ?? new StaticMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:StaticMember", name, null, MakeResourceOptions(options, id))
        {
        }
