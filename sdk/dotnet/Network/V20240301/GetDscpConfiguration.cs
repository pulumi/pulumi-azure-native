...
namespace Pulumi.AzureNative.Network.V20240301
{
    public static class GetDscpConfiguration
    {
        ...
        public static Task<GetDscpConfigurationResult> InvokeAsync(GetDscpConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDscpConfigurationResult>("azure-native:network/v20240301:getDscpConfiguration", args ?? new GetDscpConfigurationArgs(), options.WithDefaults());
