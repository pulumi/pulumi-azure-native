...
namespace Pulumi.AzureNative.Network.V20240301
{
    public static class GetVirtualWan
    {
        ...
        public static Task<GetVirtualWanResult> InvokeAsync(GetVirtualWanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualWanResult>("azure-native:network/v20240301:getVirtualWan", args ?? new GetVirtualWanArgs(), options.WithDefaults());
