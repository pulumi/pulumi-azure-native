...
namespace Pulumi.AzureNative.Network.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240301:NetworkInterface")]
    public partial class NetworkInterface : global::Pulumi.CustomResource
    {
        ...
        public NetworkInterface(string name, NetworkInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:NetworkInterface", name, args ?? new NetworkInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:NetworkInterface", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkInterfaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("auxiliaryMode")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.NetworkInterfaceAuxiliaryMode>? AuxiliaryMode { get; set; }

        /// <summary>
        /// Auxiliary sku of Network Interface resource.
        /// </summary>
        [Input("auxiliarySku")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.NetworkInterfaceAuxiliarySku>? AuxiliarySku { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.NetworkInterfaceMigrationPhase>? MigrationPhase { get; set; }
        ...
        /// </summary>
        [Input("nicType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20240301.NetworkInterfaceNicType>? NicType { get; set; }
