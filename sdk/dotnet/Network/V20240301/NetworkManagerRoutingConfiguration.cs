...
namespace Pulumi.AzureNative.Network.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20240301:NetworkManagerRoutingConfiguration")]
    public partial class NetworkManagerRoutingConfiguration : global::Pulumi.CustomResource
    {
        ...
        public NetworkManagerRoutingConfiguration(string name, NetworkManagerRoutingConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:NetworkManagerRoutingConfiguration", name, args ?? new NetworkManagerRoutingConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkManagerRoutingConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20240301:NetworkManagerRoutingConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
