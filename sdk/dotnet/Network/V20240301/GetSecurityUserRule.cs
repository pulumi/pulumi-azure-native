...
namespace Pulumi.AzureNative.Network.V20240301
{
    public static class GetSecurityUserRule
    {
        ...
        public static Task<GetSecurityUserRuleResult> InvokeAsync(GetSecurityUserRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSecurityUserRuleResult>("azure-native:network/v20240301:getSecurityUserRule", args ?? new GetSecurityUserRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a security user rule.
        /// </summary>
        public static Output<GetSecurityUserRuleResult> Invoke(GetSecurityUserRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSecurityUserRuleResult>("azure-native:network/v20240301:getSecurityUserRule", args ?? new GetSecurityUserRuleInvokeArgs(), options.WithDefaults());
    }
