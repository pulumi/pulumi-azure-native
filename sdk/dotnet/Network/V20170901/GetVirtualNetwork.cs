...
namespace Pulumi.AzureNextGen.Network.V20170901
{
    public static class GetVirtualNetwork
    {
        public static Task<GetVirtualNetworkResult> InvokeAsync(GetVirtualNetworkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkResult>("azure-nextgen:network/v20170901:getVirtualNetwork", args ?? new GetVirtualNetworkArgs(), options.WithVersion());
    }
