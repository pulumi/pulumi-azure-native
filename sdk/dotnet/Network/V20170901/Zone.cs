...
azure-native:network/v20170901:Zone is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230701preview:Zone to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20170901:Zone")]
    public partial class Zone : global::Pulumi.CustomResource
    {
        ...
        public Zone(string name, ZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170901:Zone", name, args ?? new ZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Zone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170901:Zone", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ZoneArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("zoneType")]
        public Input<Pulumi.AzureNative.Network.V20170901.ZoneType>? ZoneType { get; set; }

        public ZoneArgs()
        {
            ZoneType = Pulumi.AzureNative.Network.V20170901.ZoneType.Public;
        }
