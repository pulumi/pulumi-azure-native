...
namespace Pulumi.AzureNextGen.Network.V20170901
{
    ...
    public partial class NetworkWatcher : Pulumi.CustomResource
    {
        ...
        public NetworkWatcher(string name, NetworkWatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20170901:NetworkWatcher", name, args ?? new NetworkWatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkWatcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20170901:NetworkWatcher", name, null, MakeResourceOptions(options, id))
        {
        }
