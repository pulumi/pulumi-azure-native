...
namespace Pulumi.AzureNative.Network.V20170901
{
    ...
    [AzureNativeResourceType("azure-native:network/v20170901:ApplicationGateway")]
    public partial class ApplicationGateway : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGateway(string name, ApplicationGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170901:ApplicationGateway", name, args ?? new ApplicationGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170901:ApplicationGateway", name, null, MakeResourceOptions(options, id))
        {
        }
