...
namespace Pulumi.AzureRM.Network.V20170901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkPeering = new AzureRM.Network.V20170901.VirtualNetworkPeering("virtualNetworkPeering", new AzureRM.Network.V20170901.VirtualNetworkPeeringArgs
    ///         {
    ///             AllowForwardedTraffic = true,
    ///             AllowGatewayTransit = false,
    ///             AllowVirtualNetworkAccess = true,
    ///             RemoteVirtualNetwork = new AzureRM.Network.V20170901.Inputs.SubResourceArgs
    ///             {
