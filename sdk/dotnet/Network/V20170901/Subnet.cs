...
namespace Pulumi.AzureNative.Network.V20170901
{
    ...
    [AzureNativeResourceType("azure-native:network/v20170901:Subnet")]
    public partial class Subnet : Pulumi.CustomResource
    {
        ...
        public Subnet(string name, SubnetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170901:Subnet", name, args ?? new SubnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170901:Subnet", name, null, MakeResourceOptions(options, id))
        {
        }
