...
azure-native:network/v20170901:Subnet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:Subnet to guarantee forwards compatibility.")]
    public static class GetSubnet
    {
        ...
        public static Task<GetSubnetResult> InvokeAsync(GetSubnetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSubnetResult>("azure-native:network/v20170901:getSubnet", args ?? new GetSubnetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified subnet by virtual network and resource group.
        /// </summary>
        public static Output<GetSubnetResult> Invoke(GetSubnetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSubnetResult>("azure-native:network/v20170901:getSubnet", args ?? new GetSubnetInvokeArgs(), options.WithDefaults());
    }
