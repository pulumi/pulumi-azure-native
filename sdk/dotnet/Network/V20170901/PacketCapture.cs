...
namespace Pulumi.AzureRM.Network.V20170901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var packetCapture = new AzureRM.Network.V20170901.PacketCapture("packetCapture", new AzureRM.Network.V20170901.PacketCaptureArgs
    ///         {
    ///             BytesToCapturePerPacket = 10000,
    ///             Filters = 
    ///             {
    ///                 new AzureRM.Network.V20170901.Inputs.PacketCaptureFilterArgs
    ///                 {
    ...
    ///             StorageLocation = new AzureRM.Network.V20170901.Inputs.PacketCaptureStorageLocationArgs
    ///             {
    ...
    public partial class PacketCapture : Pulumi.CustomResource
    {
        ...
        public PacketCapture(string name, PacketCaptureArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20170901:PacketCapture", name, args ?? new PacketCaptureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCapture(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20170901:PacketCapture", name, null, MakeResourceOptions(options, id))
        {
        }
