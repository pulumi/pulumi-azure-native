...
namespace Pulumi.AzureNative.Network.V20170901
{
    ...
    public static class GetPacketCapture
    {
        ...
        public static Task<GetPacketCaptureResult> InvokeAsync(GetPacketCaptureArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPacketCaptureResult>("azure-native:network/v20170901:getPacketCapture", args ?? new GetPacketCaptureArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a packet capture session by name.
        /// </summary>
        public static Output<GetPacketCaptureResult> Invoke(GetPacketCaptureInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPacketCaptureResult>("azure-native:network/v20170901:getPacketCapture", args ?? new GetPacketCaptureInvokeArgs(), options.WithDefaults());
    }
