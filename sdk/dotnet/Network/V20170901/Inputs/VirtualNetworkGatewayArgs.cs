...
namespace Pulumi.AzureNextGen.Network.V20170901.Inputs
{
    ...
    public sealed class VirtualNetworkGatewayArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("gatewayType")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170901.VirtualNetworkGatewayType>? GatewayType { get; set; }
        ...
        /// </summary>
        [Input("vpnType")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170901.VpnType>? VpnType { get; set; }
