...
namespace Pulumi.AzureNextGen.Network.V20170901.Inputs
{
    ...
    public sealed class LoadBalancingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170901.LoadDistribution>? LoadDistribution { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170901.TransportProtocol> Protocol { get; set; } = null!;
