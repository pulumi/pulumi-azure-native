...
namespace Pulumi.AzureNative.Network.V20170901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20170901:VirtualNetworkGateway")]
    public partial class VirtualNetworkGateway : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGateway(string name, VirtualNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170901:VirtualNetworkGateway", name, args ?? new VirtualNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170901:VirtualNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
