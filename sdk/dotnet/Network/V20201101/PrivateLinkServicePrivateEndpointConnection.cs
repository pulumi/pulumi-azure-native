...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var privateLinkServicePrivateEndpointConnection = new AzureNative.Network.V20201101.PrivateLinkServicePrivateEndpointConnection("privateLinkServicePrivateEndpointConnection", new()
    ///     {
    ///         Name = "testPlePeConnection",
    ///         PeConnectionName = "testPlePeConnection",
    ///         PrivateLinkServiceConnectionState = new AzureNative.Network.V20201101.Inputs.PrivateLinkServiceConnectionStateArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:PrivateLinkServicePrivateEndpointConnection")]
    public partial class PrivateLinkServicePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkServicePrivateEndpointConnection(string name, PrivateLinkServicePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:PrivateLinkServicePrivateEndpointConnection", name, args ?? new PrivateLinkServicePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkServicePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:PrivateLinkServicePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
