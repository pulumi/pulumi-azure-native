...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var applicationSecurityGroup = new AzureNative.Network.V20201101.ApplicationSecurityGroup("applicationSecurityGroup", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:ApplicationSecurityGroup")]
    public partial class ApplicationSecurityGroup : global::Pulumi.CustomResource
    {
        ...
        public ApplicationSecurityGroup(string name, ApplicationSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:ApplicationSecurityGroup", name, args ?? new ApplicationSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:ApplicationSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
