...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var hubRouteTable = new AzureNative.Network.V20201101.HubRouteTable("hubRouteTable", new()
    ///     {
    ///         Labels = new[]
    ///         {
    ///             "label1",
    ...
    ///         Routes = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.HubRouteArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:HubRouteTable")]
    public partial class HubRouteTable : global::Pulumi.CustomResource
    {
        ...
        public HubRouteTable(string name, HubRouteTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:HubRouteTable", name, args ?? new HubRouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubRouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:HubRouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
