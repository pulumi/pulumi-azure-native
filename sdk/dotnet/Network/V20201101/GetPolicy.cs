...
namespace Pulumi.AzureNative.Network.V20201101
{
    public static class GetPolicy
    {
        ...
        public static Task<GetPolicyResult> InvokeAsync(GetPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPolicyResult>("azure-native:network/v20201101:getPolicy", args ?? new GetPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Defines web application firewall policy.
        /// </summary>
        public static Output<GetPolicyResult> Invoke(GetPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPolicyResult>("azure-native:network/v20201101:getPolicy", args ?? new GetPolicyInvokeArgs(), options.WithVersion());
    }
