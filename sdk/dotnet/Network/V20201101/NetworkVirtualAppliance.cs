...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var networkVirtualAppliance = new AzureNative.Network.V20201101.NetworkVirtualAppliance("networkVirtualAppliance", new()
    ///     {
    ...
    ///         },
    ///         Identity = new AzureNative.Network.V20201101.Inputs.ManagedServiceIdentityArgs
    ///         {
    ///             Type = AzureNative.Network.V20201101.ResourceIdentityType.UserAssigned,
    ...
    ///         NvaSku = new AzureNative.Network.V20201101.Inputs.VirtualApplianceSkuPropertiesArgs
    ///         {
    ///             BundledScaleUnit = "1",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:NetworkVirtualAppliance")]
    public partial class NetworkVirtualAppliance : global::Pulumi.CustomResource
    {
        ...
        public NetworkVirtualAppliance(string name, NetworkVirtualApplianceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:NetworkVirtualAppliance", name, args ?? new NetworkVirtualApplianceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkVirtualAppliance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:NetworkVirtualAppliance", name, null, MakeResourceOptions(options, id))
        {
        }
