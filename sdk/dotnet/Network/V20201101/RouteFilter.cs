...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var routeFilter = new AzureNative.Network.V20201101.RouteFilter("routeFilter", new()
    ///     {
    ///         Location = "West US",
    ...
    ///         Rules = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.RouteFilterRuleArgs
    ///             {
    ///                 Access = "Allow",
    ///                 Communities = new[]
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:RouteFilter")]
    public partial class RouteFilter : global::Pulumi.CustomResource
    {
        ...
        public RouteFilter(string name, RouteFilterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:RouteFilter", name, args ?? new RouteFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:RouteFilter", name, null, MakeResourceOptions(options, id))
        {
        }
