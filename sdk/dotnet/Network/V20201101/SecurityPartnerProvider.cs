...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var securityPartnerProvider = new AzureNative.Network.V20201101.SecurityPartnerProvider("securityPartnerProvider", new()
    ///     {
    ///         Location = "West US",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20201101:SecurityPartnerProvider securityPartnerProvider /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/securityPartnerProviders/securityPartnerProvider 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:SecurityPartnerProvider")]
    public partial class SecurityPartnerProvider : global::Pulumi.CustomResource
    {
        ...
        public SecurityPartnerProvider(string name, SecurityPartnerProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:SecurityPartnerProvider", name, args ?? new SecurityPartnerProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityPartnerProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:SecurityPartnerProvider", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityPartnerProviderArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20201101.SecurityProviderName>? SecurityProviderName { get; set; }
