...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var privateLinkService = new AzureNative.Network.V20201101.PrivateLinkService("privateLinkService", new()
    ///     {
    ///         AutoApproval = new AzureNative.Network.V20201101.Inputs.PrivateLinkServicePropertiesAutoApprovalArgs
    ///         {
    ///             Subscriptions = new[]
    ///             {
    ///                 "subscription1",
    ...
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.PrivateLinkServiceIpConfigurationArgs
    ///             {
    ///                 Name = "fe-lb",
    ...
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.FrontendIPConfigurationArgs
    ///             {
    ...
    ///         ServiceName = "testPls",
    ///         Visibility = new AzureNative.Network.V20201101.Inputs.PrivateLinkServicePropertiesVisibilityArgs
    ///         {
    ///             Subscriptions = new[]
    ///             {
    ///                 "subscription1",
    ...
    public partial class PrivateLinkService : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkService(string name, PrivateLinkServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:PrivateLinkService", name, args ?? new PrivateLinkServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:PrivateLinkService", name, null, MakeResourceOptions(options, id))
        {
        }
