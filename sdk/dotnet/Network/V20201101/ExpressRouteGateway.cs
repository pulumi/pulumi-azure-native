...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var expressRouteGateway = new AzureNative.Network.V20201101.ExpressRouteGateway("expressRouteGateway", new()
    ///     {
    ///         AutoScaleConfiguration = new AzureNative.Network.V20201101.Inputs.ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs
    ///         {
    ///             Bounds = new AzureNative.Network.V20201101.Inputs.ExpressRouteGatewayPropertiesBoundsArgs
    ///             {
    ///                 Min = 3,
    ///             },
    ///         },
    ...
    ///         VirtualHub = new AzureNative.Network.V20201101.Inputs.VirtualHubIdArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:ExpressRouteGateway")]
    public partial class ExpressRouteGateway : global::Pulumi.CustomResource
    {
        ...
        public ExpressRouteGateway(string name, ExpressRouteGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:ExpressRouteGateway", name, args ?? new ExpressRouteGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:ExpressRouteGateway", name, null, MakeResourceOptions(options, id))
        {
        }
