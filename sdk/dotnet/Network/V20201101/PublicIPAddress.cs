...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var publicIPAddress = new AzureNative.Network.V20201101.PublicIPAddress("publicIPAddress", new()
    ///     {
    ///         DnsSettings = new AzureNative.Network.V20201101.Inputs.PublicIPAddressDnsSettingsArgs
    ///         {
    ...
    ///         PublicIpAddressName = "test-ip",
    ///         ResourceGroupName = "rg1",
    ///         Sku = new AzureNative.Network.V20201101.Inputs.PublicIPAddressSkuArgs
    ///         {
    ///             Name = "Standard",
    ///             Tier = "Global",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:PublicIPAddress")]
    public partial class PublicIPAddress : global::Pulumi.CustomResource
    {
        ...
        public PublicIPAddress(string name, PublicIPAddressArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:PublicIPAddress", name, args ?? new PublicIPAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:PublicIPAddress", name, null, MakeResourceOptions(options, id))
        {
        }
