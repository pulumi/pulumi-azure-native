...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var virtualNetworkGateway = new AzureNative.Network.V20201101.VirtualNetworkGateway("virtualNetworkGateway", new()
    ///     {
    ///         ActiveActive = false,
    ...
    ///             PeerWeight = 0,
    ///         },
    ///         CustomRoutes = new AzureNative.Network.V20201101.Inputs.AddressSpaceArgs
    ///         {
    ///             AddressPrefixes = new[]
    ///             {
    ///                 "101.168.0.6/32",
    ...
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.VirtualNetworkGatewayIPConfigurationArgs
    ///             {
    ///                 Name = "gwipconfig1",
    ...
    ///         Sku = new AzureNative.Network.V20201101.Inputs.VirtualNetworkGatewaySkuArgs
    ///         {
    ///             Name = "VpnGw1",
    ///             Tier = "VpnGw1",
    ///         },
    ///         VirtualNetworkGatewayName = "vpngw",
    ///         VpnClientConfiguration = new AzureNative.Network.V20201101.Inputs.VpnClientConfigurationArgs
    ///         {
    ///             RadiusServers = new[]
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:VirtualNetworkGateway")]
    public partial class VirtualNetworkGateway : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGateway(string name, VirtualNetworkGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:VirtualNetworkGateway", name, args ?? new VirtualNetworkGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:VirtualNetworkGateway", name, null, MakeResourceOptions(options, id))
        {
        }
