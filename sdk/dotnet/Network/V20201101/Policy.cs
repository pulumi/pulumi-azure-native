...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var policy = new AzureNative.Network.V20201101.Policy("policy", new()
    ///     {
    ///         CustomRules = new AzureNative.Network.V20201101.Inputs.CustomRuleListArgs
    ///         {
    ///             Rules = new[]
    ///             {
    ///                 new AzureNative.Network.V20201101.Inputs.CustomRuleArgs
    ///                 {
    ///                     Action = "Block",
    ///                     MatchConditions = new[]
    ///                     {
    ///                         new AzureNative.Network.V20201101.Inputs.FrontDoorMatchConditionArgs
    ///                         {
    ///                             MatchValue = new[]
    ///                             {
    ///                                 "192.168.1.0/24",
    ...
    ///             },
    ///         },
    ///         ManagedRules = new AzureNative.Network.V20201101.Inputs.ManagedRuleSetListArgs
    ///         {
    ///             ManagedRuleSets = new[]
    ///             {
    ///                 new AzureNative.Network.V20201101.Inputs.FrontDoorManagedRuleSetArgs
    ///                 {
    ///                     Exclusions = new[]
    ///                     {
    ///                         new AzureNative.Network.V20201101.Inputs.ManagedRuleExclusionArgs
    ///                         {
    ...
    ///                     {
    ///                         new AzureNative.Network.V20201101.Inputs.FrontDoorManagedRuleGroupOverrideArgs
    ///                         {
    ///                             Exclusions = new[]
    ///                             {
    ///                                 new AzureNative.Network.V20201101.Inputs.ManagedRuleExclusionArgs
    ...
    ///                             Rules = new[]
    ///                             {
    ///                                 new AzureNative.Network.V20201101.Inputs.FrontDoorManagedRuleOverrideArgs
    ///                                 {
    ///                                     Action = "Redirect",
    ...
    ///         },
    ///         PolicyName = "Policy1",
    ///         PolicySettings = new AzureNative.Network.V20201101.Inputs.FrontDoorPolicySettingsArgs
    ///         {
    ...
    ///         Sku = new AzureNative.Network.V20201101.Inputs.SkuArgs
    ///         {
