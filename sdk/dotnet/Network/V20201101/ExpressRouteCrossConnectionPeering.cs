    ...
    public partial class ExpressRouteCrossConnectionPeering : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20201101:ExpressRouteCrossConnectionPeering"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:ExpressRouteCrossConnectionPeering"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:ExpressRouteCrossConnectionPeering"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:ExpressRouteCrossConnectionPeering"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:ExpressRouteCrossConnectionPeering"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:ExpressRouteCrossConnectionPeering"},
                },
            };
