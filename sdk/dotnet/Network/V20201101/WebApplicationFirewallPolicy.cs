...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var webApplicationFirewallPolicy = new AzureNative.Network.V20201101.WebApplicationFirewallPolicy("webApplicationFirewallPolicy", new()
    ///     {
    ///         CustomRules = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.WebApplicationFirewallCustomRuleArgs
    ///             {
    ///                 Action = "Block",
    ///                 MatchConditions = new[]
    ///                 {
    ///                     new AzureNative.Network.V20201101.Inputs.MatchConditionArgs
    ///                     {
    ///                         MatchValues = new[]
    ///                         {
    ///                             "192.168.1.0/24",
    ...
    ///                         MatchVariables = new[]
    ///                         {
    ///                             new AzureNative.Network.V20201101.Inputs.MatchVariableArgs
    ///                             {
    ...
    ///         },
    ///         Location = "WestUs",
    ///         ManagedRules = new AzureNative.Network.V20201101.Inputs.ManagedRulesDefinitionArgs
    ///         {
    ///             ManagedRuleSets = new[]
    ///             {
    ///                 new AzureNative.Network.V20201101.Inputs.ManagedRuleSetArgs
    ///                 {
    ///                     RuleSetType = "OWASP",
    ///                     RuleSetVersion = "3.0",
    ///                 },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:WebApplicationFirewallPolicy")]
    public partial class WebApplicationFirewallPolicy : global::Pulumi.CustomResource
    {
        ...
        public WebApplicationFirewallPolicy(string name, WebApplicationFirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:WebApplicationFirewallPolicy", name, args ?? new WebApplicationFirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApplicationFirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:WebApplicationFirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
