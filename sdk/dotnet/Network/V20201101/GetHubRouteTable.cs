...
namespace Pulumi.AzureNative.Network.V20201101
{
    public static class GetHubRouteTable
    {
        ...
        public static Task<GetHubRouteTableResult> InvokeAsync(GetHubRouteTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHubRouteTableResult>("azure-native:network/v20201101:getHubRouteTable", args ?? new GetHubRouteTableArgs(), options.WithVersion());

        /// <summary>
        /// RouteTable resource in a virtual hub.
        /// </summary>
        public static Output<GetHubRouteTableResult> Invoke(GetHubRouteTableInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetHubRouteTableResult>("azure-native:network/v20201101:getHubRouteTable", args ?? new GetHubRouteTableInvokeArgs(), options.WithVersion());
    }
