...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var networkInterface = new AzureNative.Network.V20201101.NetworkInterface("networkInterface", new()
    ///     {
    ///         EnableAcceleratedNetworking = true,
    ///         IpConfigurations = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.NetworkInterfaceIPConfigurationArgs
    ///             {
    ///                 Name = "ipconfig1",
    ///                 PublicIPAddress = new AzureNative.Network.V20201101.Inputs.PublicIPAddressArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:NetworkInterface")]
    public partial class NetworkInterface : global::Pulumi.CustomResource
    {
        ...
        public NetworkInterface(string name, NetworkInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:NetworkInterface", name, args ?? new NetworkInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:NetworkInterface", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkInterfaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20201101.NetworkInterfaceMigrationPhase>? MigrationPhase { get; set; }
        ...
        /// </summary>
        [Input("nicType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20201101.NetworkInterfaceNicType>? NicType { get; set; }
