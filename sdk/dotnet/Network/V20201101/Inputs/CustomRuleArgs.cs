...
namespace Pulumi.AzureNative.Network.V20201101.Inputs
{
    ...
    public sealed class CustomRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20201101.ActionType> Action { get; set; } = null!;

        /// <summary>
        /// Describes if the custom rule is in enabled or disabled state. Defaults to Enabled if not specified.
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20201101.CustomRuleEnabledState>? EnabledState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20201101.RuleType> RuleType { get; set; } = null!;
