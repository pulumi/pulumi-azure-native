...
namespace Pulumi.AzureNative.Network.V20201101
{
    public static class GetBastionHost
    {
        ...
        public static Task<GetBastionHostResult> InvokeAsync(GetBastionHostArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBastionHostResult>("azure-native:network/v20201101:getBastionHost", args ?? new GetBastionHostArgs(), options.WithVersion());

        /// <summary>
        /// Bastion Host resource.
        /// </summary>
        public static Output<GetBastionHostResult> Invoke(GetBastionHostInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBastionHostResult>("azure-native:network/v20201101:getBastionHost", args ?? new GetBastionHostInvokeArgs(), options.WithVersion());
    }
