...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var privateDnsZoneGroup = new AzureNative.Network.V20201101.PrivateDnsZoneGroup("privateDnsZoneGroup", new()
    ///     {
    ///         PrivateDnsZoneConfigs = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.PrivateDnsZoneConfigArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:PrivateDnsZoneGroup")]
    public partial class PrivateDnsZoneGroup : global::Pulumi.CustomResource
    {
        ...
        public PrivateDnsZoneGroup(string name, PrivateDnsZoneGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:PrivateDnsZoneGroup", name, args ?? new PrivateDnsZoneGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateDnsZoneGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:PrivateDnsZoneGroup", name, null, MakeResourceOptions(options, id))
        {
        }
