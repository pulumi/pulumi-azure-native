...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    public partial class FlowLog : Pulumi.CustomResource
    {
        ...
        public FlowLog(string name, FlowLogArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:FlowLog", name, args ?? new FlowLogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FlowLog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:FlowLog", name, null, MakeResourceOptions(options, id))
        {
        }
