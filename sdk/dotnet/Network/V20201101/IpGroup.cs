...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var ipGroup = new AzureNative.Network.V20201101.IpGroup("ipGroup", new()
    ///     {
    ///         IpAddresses = new[]
    ///         {
    ///             "13.64.39.16/32",
    ...
    public partial class IpGroup : global::Pulumi.CustomResource
    {
        ...
        public IpGroup(string name, IpGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:IpGroup", name, args ?? new IpGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:IpGroup", name, null, MakeResourceOptions(options, id))
        {
        }
