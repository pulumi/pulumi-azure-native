...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var serviceEndpointPolicyDefinition = new AzureNative.Network.V20201101.ServiceEndpointPolicyDefinition("serviceEndpointPolicyDefinition", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:ServiceEndpointPolicyDefinition")]
    public partial class ServiceEndpointPolicyDefinition : global::Pulumi.CustomResource
    {
        ...
        public ServiceEndpointPolicyDefinition(string name, ServiceEndpointPolicyDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:ServiceEndpointPolicyDefinition", name, args ?? new ServiceEndpointPolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceEndpointPolicyDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:ServiceEndpointPolicyDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
