...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var loadBalancer = new AzureNative.Network.V20201101.LoadBalancer("loadBalancer", new()
    ///     {
    ///         BackendAddressPools = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.BackendAddressPoolArgs
    ///             {
    ///                 Name = "be-lb",
    ///             },
    ///         },
    ...
    ///         InboundNatRules = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.InboundNatRuleArgs
    ///             {
    ///                 BackendPort = 3389,
    ...
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.LoadBalancingRuleArgs
    ///             {
    ///                 BackendAddressPool = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ...
    ///                 Name = "rulelb",
    ///                 Probe = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ...
    ///         Probes = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ProbeArgs
    ///             {
    ...
    ///         },
    ///         ResourceGroupName = "rg1",
    ///         Sku = new AzureNative.Network.V20201101.Inputs.LoadBalancerSkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ///     });
    ...
    ///                 {
    ///                     new AzureNative.Network.V20201101.Inputs.LoadBalancerBackendAddressArgs
    ///                     {
    ///                         LoadBalancerFrontendIPConfiguration = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                         {
    ...
    ///         InboundNatPools = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.InboundNatPoolArgs
    ///             {
    ///                 BackendPort = 8888,
    ///                 EnableFloatingIP = true,
    ///                 EnableTcpReset = true,
    ...
    ///         OutboundRules = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.OutboundRuleArgs
    ///             {
    ///                 BackendAddressPool = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb/backendAddressPools/be-lb",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:LoadBalancer")]
    public partial class LoadBalancer : global::Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:LoadBalancer", name, args ?? new LoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:LoadBalancer", name, null, MakeResourceOptions(options, id))
        {
        }
