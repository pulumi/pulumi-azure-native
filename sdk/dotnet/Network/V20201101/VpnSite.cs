...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var vpnSite = new AzureNative.Network.V20201101.VpnSite("vpnSite", new()
    ///     {
    ///         AddressSpace = new AzureNative.Network.V20201101.Inputs.AddressSpaceArgs
    ///         {
    ///             AddressPrefixes = new[]
    ///             {
    ///                 "10.0.0.0/16",
    ...
    ///         Location = "West US",
    ///         O365Policy = new AzureNative.Network.V20201101.Inputs.O365PolicyPropertiesArgs
    ///         {
    ///             BreakOutCategories = new AzureNative.Network.V20201101.Inputs.O365BreakOutCategoryPoliciesArgs
    ///             {
    ///                 Allow = true,
    ///                 Default = false,
    ///                 Optimize = true,
    ...
    ///             { "key1", "value1" },
    ///         },
    ///         VirtualWan = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///         {
    ///             Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualWANs/wan1",
    ///         },
    ///         VpnSiteLinks = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.VpnSiteLinkArgs
    ///             {
    ///                 BgpProperties = new AzureNative.Network.V20201101.Inputs.VpnLinkBgpSettingsArgs
    ///                 {
    ///                     Asn = 1234,
    ...
    ///                 LinkProperties = new AzureNative.Network.V20201101.Inputs.VpnLinkProviderPropertiesArgs
    ///                 {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20201101:VpnSite vpnSite1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/vpnSites/vpnSite1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:VpnSite")]
    public partial class VpnSite : global::Pulumi.CustomResource
    {
        ...
        public VpnSite(string name, VpnSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:VpnSite", name, args ?? new VpnSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:VpnSite", name, null, MakeResourceOptions(options, id))
        {
        }
