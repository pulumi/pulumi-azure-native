...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var loadBalancerBackendAddressPool = new AzureNative.Network.V20201101.LoadBalancerBackendAddressPool("loadBalancerBackendAddressPool", new()
    ///     {
    ...
    ///                 IpAddress = "10.0.0.4",
    ///                 Name = "address1",
    ///                 VirtualNetwork = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:LoadBalancerBackendAddressPool")]
    public partial class LoadBalancerBackendAddressPool : global::Pulumi.CustomResource
    {
        ...
        public LoadBalancerBackendAddressPool(string name, LoadBalancerBackendAddressPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:LoadBalancerBackendAddressPool", name, args ?? new LoadBalancerBackendAddressPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancerBackendAddressPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:LoadBalancerBackendAddressPool", name, null, MakeResourceOptions(options, id))
        {
        }
