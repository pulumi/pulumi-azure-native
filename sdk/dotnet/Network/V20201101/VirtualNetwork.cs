...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var virtualNetwork = new AzureNative.Network.V20201101.VirtualNetwork("virtualNetwork", new()
    ///     {
    ...
    ///             },
    ///         },
    ///         BgpCommunities = new AzureNative.Network.V20201101.Inputs.VirtualNetworkBgpCommunitiesArgs
    ///         {
    ...
    ///         Subnets = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.SubnetArgs
    ///             {
    ...
    ///                 Delegations = new[]
    ///                 {
    ///                     new AzureNative.Network.V20201101.Inputs.DelegationArgs
    ///                     {
    ///                         Name = "myDelegation",
    ...
    ///                 {
    ///                     new AzureNative.Network.V20201101.Inputs.ServiceEndpointPolicyArgs
    ///                     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:VirtualNetwork")]
    public partial class VirtualNetwork : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:VirtualNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
