...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var subnet = new AzureNative.Network.V20201101.Subnet("subnet", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ServiceEndpointPropertiesFormatArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20201101:Subnet subnet1 /subscriptions/subid/resourceGroups/subnet-test/providers/Microsoft.Network/virtualNetworks/vnetname/subnets/subnet1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:Subnet")]
    public partial class Subnet : global::Pulumi.CustomResource
    {
        ...
        public Subnet(string name, SubnetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:Subnet", name, args ?? new SubnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:Subnet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SubnetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20201101.VirtualNetworkPrivateEndpointNetworkPolicies>? PrivateEndpointNetworkPolicies { get; set; }

        /// <summary>
        /// Enable or Disable apply network policies on private link service in the subnet.
        /// </summary>
        [Input("privateLinkServiceNetworkPolicies")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20201101.VirtualNetworkPrivateLinkServiceNetworkPolicies>? PrivateLinkServiceNetworkPolicies { get; set; }
