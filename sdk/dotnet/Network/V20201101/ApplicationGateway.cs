...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var applicationGateway = new AzureNative.Network.V20201101.ApplicationGateway("applicationGateway", new()
    ///     {
    ///         ApplicationGatewayName = "appgw",
    ///         BackendAddressPools = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewayBackendAddressPoolArgs
    ///             {
    ///                 BackendAddresses = new[]
    ///                 {
    ///                     new AzureNative.Network.V20201101.Inputs.ApplicationGatewayBackendAddressArgs
    ///                     {
    ///                         IpAddress = "10.0.1.1",
    ///                     },
    ///                     new AzureNative.Network.V20201101.Inputs.ApplicationGatewayBackendAddressArgs
    ...
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewayBackendHttpSettingsArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewayFrontendIPConfigurationArgs
    ///             {
    ///                 Name = "appgwfip",
    ...
    ///         FrontendPorts = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewayFrontendPortArgs
    ///             {
    ///                 Name = "appgwfp",
    ///                 Port = 443,
    ///             },
    ...
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewayIPConfigurationArgs
    ///             {
    ///                 Name = "appgwipc",
    ...
    ///         HttpListeners = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewayHttpListenerArgs
    ///             {
    ///                 FrontendIPConfiguration = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/frontendIPConfigurations/appgwfip",
    ///                 },
    ///                 FrontendPort = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ...
    ///                 SslCertificate = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/sslCertificates/sslcert",
    ///                 },
    ///                 SslProfile = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ...
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewayRequestRoutingRuleArgs
    ///             {
    ///                 BackendAddressPool = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/backendAddressPools/appgwpool",
    ///                 },
    ///                 BackendHttpSettings = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/backendHttpSettingsCollection/appgwbhs",
    ///                 },
    ///                 HttpListener = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/httpListeners/appgwhl",
    ///                 },
    ///                 Name = "appgwrule",
    ///                 Priority = 10,
    ///                 RewriteRuleSet = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ...
    ///                 UrlPathMap = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ...
    ///         RewriteRuleSets = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewayRewriteRuleSetArgs
    ///             {
    ///                 Name = "rewriteRuleSet1",
    ///                 RewriteRules = new[]
    ///                 {
    ///                     new AzureNative.Network.V20201101.Inputs.ApplicationGatewayRewriteRuleArgs
    ///                     {
    ///                         ActionSet = new AzureNative.Network.V20201101.Inputs.ApplicationGatewayRewriteRuleActionSetArgs
    ///                         {
    ///                             RequestHeaderConfigurations = new[]
    ///                             {
    ///                                 new AzureNative.Network.V20201101.Inputs.ApplicationGatewayHeaderConfigurationArgs
    ///                                 {
    ...
    ///                                 },
    ///                             },
    ///                             UrlConfiguration = new AzureNative.Network.V20201101.Inputs.ApplicationGatewayUrlConfigurationArgs
    ///                             {
    ///                                 ModifiedPath = "/abc",
    ///                             },
    ///                         },
    ///                         Conditions = new[]
    ///                         {
    ///                             new AzureNative.Network.V20201101.Inputs.ApplicationGatewayRewriteRuleConditionArgs
    ///                             {
    ///                                 IgnoreCase = true,
    ///                                 Negate = false,
    ///                                 Pattern = "^Bearer",
    ...
    ///             },
    ///         },
    ///         Sku = new AzureNative.Network.V20201101.Inputs.ApplicationGatewaySkuArgs
    ///         {
    ///             Capacity = 3,
    ///             Name = "Standard_v2",
    ///             Tier = "Standard_v2",
    ...
    ///         SslCertificates = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewaySslCertificateArgs
    ///             {
    ///                 Data = "****",
    ///                 Name = "sslcert",
    ///                 Password = "****",
    ...
    ///         SslProfiles = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewaySslProfileArgs
    ///             {
    ///                 ClientAuthConfiguration = new AzureNative.Network.V20201101.Inputs.ApplicationGatewayClientAuthConfigurationArgs
    ///                 {
    ///                     VerifyClientCertIssuerDN = true,
    ///                 },
    ///                 Name = "sslProfile1",
    ///                 SslPolicy = new AzureNative.Network.V20201101.Inputs.ApplicationGatewaySslPolicyArgs
    ///                 {
    ///                     CipherSuites = new[]
    ///                     {
    ...
    ///         TrustedClientCertificates = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewayTrustedClientCertificateArgs
    ///             {
    ///                 Data = "****",
    ///                 Name = "clientcert",
    ///             },
    ...
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewayTrustedRootCertificateArgs
    ///             {
    ///                 Data = "****",
    ///                 Name = "rootcert",
    ///             },
    ...
    ///         UrlPathMaps = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ApplicationGatewayUrlPathMapArgs
    ///             {
    ///                 DefaultBackendAddressPool = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/backendAddressPools/appgwpool",
    ///                 },
    ///                 DefaultBackendHttpSettings = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/backendHttpSettingsCollection/appgwbhs",
    ///                 },
    ///                 DefaultRewriteRuleSet = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/rewriteRuleSets/rewriteRuleSet1",
    ///                 },
    ///                 Name = "pathMap1",
    ///                 PathRules = new[]
    ///                 {
    ///                     new AzureNative.Network.V20201101.Inputs.ApplicationGatewayPathRuleArgs
    ///                     {
    ///                         BackendAddressPool = new AzureNative.Network.V20201101.Inputs.SubResourceArgs
    ///                         {
    ///                             Id = "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/backendAddressPools/appgwpool",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:ApplicationGateway")]
    public partial class ApplicationGateway : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGateway(string name, ApplicationGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:ApplicationGateway", name, args ?? new ApplicationGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:ApplicationGateway", name, null, MakeResourceOptions(options, id))
        {
        }
