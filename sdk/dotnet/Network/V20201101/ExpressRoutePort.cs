...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var expressRoutePort = new AzureNative.Network.V20201101.ExpressRoutePort("expressRoutePort", new()
    ///     {
    ///         BandwidthInGbps = 100,
    ///         Encapsulation = "QinQ",
    ...
    ///         Links = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ExpressRouteLinkArgs
    ///             {
    ///                 AdminState = "Enabled",
    ///                 Name = "link1",
    ///             },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:network/v20201101:ExpressRoutePort portName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/expressRoutePorts/portName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:ExpressRoutePort")]
    public partial class ExpressRoutePort : global::Pulumi.CustomResource
    {
        ...
        public ExpressRoutePort(string name, ExpressRoutePortArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:ExpressRoutePort", name, args ?? new ExpressRoutePortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRoutePort(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:ExpressRoutePort", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRoutePortArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("encapsulation")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20201101.ExpressRoutePortsEncapsulation>? Encapsulation { get; set; }
