...
namespace Pulumi.AzureNative.Network.V20201101
{
    public static class GetFlowLog
    {
        ...
        public static Task<GetFlowLogResult> InvokeAsync(GetFlowLogArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFlowLogResult>("azure-native:network/v20201101:getFlowLog", args ?? new GetFlowLogArgs(), options.WithDefaults());

        /// <summary>
        /// A flow log resource.
        /// </summary>
        public static Output<GetFlowLogResult> Invoke(GetFlowLogInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFlowLogResult>("azure-native:network/v20201101:getFlowLog", args ?? new GetFlowLogInvokeArgs(), options.WithDefaults());
    }
