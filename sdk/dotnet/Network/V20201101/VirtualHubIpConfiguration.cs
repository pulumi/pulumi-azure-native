...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// IpConfigurations.
    /// </summary>
    [Obsolete(@"azure-native:network/v20201101:VirtualHubIpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHubIpConfiguration to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20201101:VirtualHubIpConfiguration")]
    public partial class VirtualHubIpConfiguration : global::Pulumi.CustomResource
    {
        ...
        public VirtualHubIpConfiguration(string name, VirtualHubIpConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:VirtualHubIpConfiguration", name, args ?? new VirtualHubIpConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubIpConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:VirtualHubIpConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
