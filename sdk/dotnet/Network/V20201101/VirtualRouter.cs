...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    [AzureNativeResourceType("azure-native:network/v20201101:VirtualRouter")]
    public partial class VirtualRouter : global::Pulumi.CustomResource
    {
        ...
        public VirtualRouter(string name, VirtualRouterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:VirtualRouter", name, args ?? new VirtualRouterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:VirtualRouter", name, null, MakeResourceOptions(options, id))
        {
        }
