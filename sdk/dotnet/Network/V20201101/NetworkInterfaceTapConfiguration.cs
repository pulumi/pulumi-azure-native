...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var networkInterfaceTapConfiguration = new AzureNative.Network.V20201101.NetworkInterfaceTapConfiguration("networkInterfaceTapConfiguration", new()
    ///     {
    ///         NetworkInterfaceName = "mynic",
    ///         ResourceGroupName = "testrg",
    ///         TapConfigurationName = "tapconfiguration1",
    ///         VirtualNetworkTap = new AzureNative.Network.V20201101.Inputs.VirtualNetworkTapArgs
    ///         {
