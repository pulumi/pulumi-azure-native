...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var virtualHubRouteTableV2 = new AzureNative.Network.V20201101.VirtualHubRouteTableV2("virtualHubRouteTableV2", new()
    ///     {
    ...
    ///         Routes = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.VirtualHubRouteV2Args
    ///             {
    ...
    public partial class VirtualHubRouteTableV2 : global::Pulumi.CustomResource
    {
        ...
        public VirtualHubRouteTableV2(string name, VirtualHubRouteTableV2Args args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:VirtualHubRouteTableV2", name, args ?? new VirtualHubRouteTableV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubRouteTableV2(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:VirtualHubRouteTableV2", name, null, MakeResourceOptions(options, id))
        {
        }
