...
namespace Pulumi.AzureNative.Network.V20201101
{
    ...
    /// {
    ///     var connectionMonitor = new AzureNative.Network.V20201101.ConnectionMonitor("connectionMonitor", new()
    ///     {
    ///         ConnectionMonitorName = "cm1",
    ///         Endpoints = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ConnectionMonitorEndpointArgs
    ///             {
    ///                 Name = "source",
    ...
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ConnectionMonitorTestConfigurationArgs
    ///             {
    ///                 Name = "tcp",
    ///                 Protocol = "Tcp",
    ///                 TcpConfiguration = new AzureNative.Network.V20201101.Inputs.ConnectionMonitorTcpConfigurationArgs
    ///                 {
    ///                     Port = 80,
    ///                 },
    ///                 TestFrequencySec = 60,
    ...
    ///         TestGroups = new[]
    ///         {
    ///             new AzureNative.Network.V20201101.Inputs.ConnectionMonitorTestGroupArgs
    ///             {
    ///                 Destinations = new[]
    ///                 {
    ///                     "destination",
    ...
    ///             new AzureNative.Network.V20201101.Inputs.ConnectionMonitorEndpointArgs
    ///             {
    ///                 Filter = new AzureNative.Network.V20201101.Inputs.ConnectionMonitorEndpointFilterArgs
    ///                 {
    ///                     Items = new[]
    ///                     {
    ///                         new AzureNative.Network.V20201101.Inputs.ConnectionMonitorEndpointFilterItemArgs
    ///                         {
    ///                             Address = "npmuser",
    ///                             Type = "AgentAddress",
    ///                         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20201101:ConnectionMonitor")]
    public partial class ConnectionMonitor : global::Pulumi.CustomResource
    {
        ...
        public ConnectionMonitor(string name, ConnectionMonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:ConnectionMonitor", name, args ?? new ConnectionMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20201101:ConnectionMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
