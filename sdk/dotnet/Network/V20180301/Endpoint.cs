...
namespace Pulumi.AzureRM.Network.V20180301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var endpoint = new AzureRM.Network.V20180301.Endpoint("endpoint", new AzureRM.Network.V20180301.EndpointArgs
    ///         {
    ///             CustomHeaders = 
    ///             {
    ///                 new AzureRM.Network.V20180301.Inputs.EndpointPropertiesCustomHeadersArgs
    ///                 {
    ///                     Name = "header-1",
    ///                     Value = "value-1",
    ///                 },
    ...
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.EndpointPropertiesResponseCustomHeadersResult>> CustomHeaders { get; private set; } = null!;
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180301:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180301:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
