...
namespace Pulumi.AzureNative.Network.V20180201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20180201:SecurityRule")]
    public partial class SecurityRule : Pulumi.CustomResource
    {
        ...
        public SecurityRule(string name, SecurityRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180201:SecurityRule", name, args ?? new SecurityRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180201:SecurityRule", name, null, MakeResourceOptions(options, id))
        {
        }
