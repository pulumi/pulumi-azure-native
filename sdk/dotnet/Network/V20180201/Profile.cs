...
namespace Pulumi.AzureRM.Network.V20180201
{
    ...
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180201:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180201:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
