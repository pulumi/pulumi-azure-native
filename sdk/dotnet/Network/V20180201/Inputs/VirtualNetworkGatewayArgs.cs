...
namespace Pulumi.AzureNextGen.Network.V20180201.Inputs
{
    ...
    public sealed class VirtualNetworkGatewayArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("gatewayType")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20180201.VirtualNetworkGatewayType>? GatewayType { get; set; }
        ...
        /// </summary>
        [Input("vpnType")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20180201.VpnType>? VpnType { get; set; }
