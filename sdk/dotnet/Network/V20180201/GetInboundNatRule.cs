...
namespace Pulumi.AzureRM.Network.V20180201
{
    public static class GetInboundNatRule
    {
        public static Task<GetInboundNatRuleResult> InvokeAsync(GetInboundNatRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInboundNatRuleResult>("azurerm:network/v20180201:getInboundNatRule", args ?? new GetInboundNatRuleArgs(), options.WithVersion());
    }
