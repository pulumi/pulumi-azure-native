...
namespace Pulumi.AzureNative.Network.V20180201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20180201:RouteTable")]
    public partial class RouteTable : Pulumi.CustomResource
    {
        ...
        public RouteTable(string name, RouteTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180201:RouteTable", name, args ?? new RouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180201:RouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
