...
namespace Pulumi.AzureNative.Network.V20180201
{
    ...
    public static class GetRouteFilter
    {
        ...
        public static Task<GetRouteFilterResult> InvokeAsync(GetRouteFilterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteFilterResult>("azure-native:network/v20180201:getRouteFilter", args ?? new GetRouteFilterArgs(), options.WithDefaults());

        /// <summary>
        /// Route Filter Resource.
        /// </summary>
        public static Output<GetRouteFilterResult> Invoke(GetRouteFilterInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRouteFilterResult>("azure-native:network/v20180201:getRouteFilter", args ?? new GetRouteFilterInvokeArgs(), options.WithDefaults());
    }
