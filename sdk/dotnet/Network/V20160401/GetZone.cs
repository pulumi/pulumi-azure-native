...
namespace Pulumi.AzureNative.Network.V20160401
{
    public static class GetZone
    {
        ...
        public static Task<GetZoneResult> InvokeAsync(GetZoneArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetZoneResult>("azure-native:network/v20160401:getZone", args ?? new GetZoneArgs(), options.WithDefaults());

        /// <summary>
        /// Describes a DNS zone.
        /// </summary>
        public static Output<GetZoneResult> Invoke(GetZoneInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetZoneResult>("azure-native:network/v20160401:getZone", args ?? new GetZoneInvokeArgs(), options.WithDefaults());
    }
