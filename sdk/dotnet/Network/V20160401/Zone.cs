...
namespace Pulumi.AzureNextGen.Network.V20160401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20160401:Zone")]
    ...
    public sealed class ZoneArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("zoneType")]
        public Input<Pulumi.AzureNextGen.Network.V20160401.ZoneType>? ZoneType { get; set; }

        public ZoneArgs()
        {
            ZoneType = Pulumi.AzureNextGen.Network.V20160401.ZoneType.Public;
        }
    }
}
