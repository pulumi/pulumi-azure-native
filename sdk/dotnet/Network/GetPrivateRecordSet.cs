...
namespace Pulumi.AzureNative.Network
{
    public static class GetPrivateRecordSet
    {
        ...
        public static Task<GetPrivateRecordSetResult> InvokeAsync(GetPrivateRecordSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateRecordSetResult>("azure-native:network:getPrivateRecordSet", args ?? new GetPrivateRecordSetArgs(), options.WithDefaults());
        ...
        public static Output<GetPrivateRecordSetResult> Invoke(GetPrivateRecordSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPrivateRecordSetResult>("azure-native:network:getPrivateRecordSet", args ?? new GetPrivateRecordSetInvokeArgs(), options.WithDefaults());
    }
