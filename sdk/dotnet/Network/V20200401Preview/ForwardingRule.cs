...
namespace Pulumi.AzureNative.Network.V20200401Preview
{
    ...
    /// {
    ///     var forwardingRule = new AzureNative.Network.V20200401Preview.ForwardingRule("forwardingRule", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.Network.V20200401Preview.Inputs.TargetDnsServerArgs
    ///             {
    ///                 IpAddress = "10.0.0.1",
    ///                 Port = 53,
    ///             },
