...
namespace Pulumi.AzureNative.Network.V20200401Preview
{
    public static class GetForwardingRule
    {
        ...
        public static Task<GetForwardingRuleResult> InvokeAsync(GetForwardingRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetForwardingRuleResult>("azure-native:network/v20200401preview:getForwardingRule", args ?? new GetForwardingRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Describes a forwarding rule within a DNS forwarding ruleset.
        /// </summary>
        public static Output<GetForwardingRuleResult> Invoke(GetForwardingRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetForwardingRuleResult>("azure-native:network/v20200401preview:getForwardingRule", args ?? new GetForwardingRuleInvokeArgs(), options.WithDefaults());
    }
