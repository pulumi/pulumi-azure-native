...
namespace Pulumi.AzureNative.Network.V20200401Preview
{
    public static class GetPrivateResolverVirtualNetworkLink
    {
        ...
        public static Task<GetPrivateResolverVirtualNetworkLinkResult> InvokeAsync(GetPrivateResolverVirtualNetworkLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateResolverVirtualNetworkLinkResult>("azure-native:network/v20200401preview:getPrivateResolverVirtualNetworkLink", args ?? new GetPrivateResolverVirtualNetworkLinkArgs(), options.WithDefaults());
        ...
        public static Output<GetPrivateResolverVirtualNetworkLinkResult> Invoke(GetPrivateResolverVirtualNetworkLinkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPrivateResolverVirtualNetworkLinkResult>("azure-native:network/v20200401preview:getPrivateResolverVirtualNetworkLink", args ?? new GetPrivateResolverVirtualNetworkLinkInvokeArgs(), options.WithDefaults());
    }
