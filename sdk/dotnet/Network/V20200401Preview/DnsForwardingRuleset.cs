...
namespace Pulumi.AzureNative.Network.V20200401Preview
{
    ...
    /// {
    ///     var dnsForwardingRuleset = new AzureNative.Network.V20200401Preview.DnsForwardingRuleset("dnsForwardingRuleset", new()
    ///     {
    ///         DnsForwardingRulesetName = "samplednsForwardingRuleset",
    ///         DnsResolverOutboundEndpoints = new[]
    ///         {
    ///             new AzureNative.Network.V20200401Preview.Inputs.SubResourceArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200401preview:DnsForwardingRuleset")]
    public partial class DnsForwardingRuleset : global::Pulumi.CustomResource
    {
        ...
        public DnsForwardingRuleset(string name, DnsForwardingRulesetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401preview:DnsForwardingRuleset", name, args ?? new DnsForwardingRulesetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsForwardingRuleset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401preview:DnsForwardingRuleset", name, null, MakeResourceOptions(options, id))
        {
        }
