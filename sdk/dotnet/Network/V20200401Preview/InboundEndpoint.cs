...
namespace Pulumi.AzureNative.Network.V20200401Preview
{
    ...
    /// {
    ///     var inboundEndpoint = new AzureNative.Network.V20200401Preview.InboundEndpoint("inboundEndpoint", new()
    ///     {
    ///         DnsResolverName = "sampleDnsResolver",
    ///         InboundEndpointName = "sampleInboundEndpoint",
    ///         IpConfigurations = new[]
    ///         {
    ///             new AzureNative.Network.V20200401Preview.Inputs.InboundEndpointIPConfigurationArgs
    ///             {
    ///                 PrivateIpAllocationMethod = "Dynamic",
    ///                 Subnet = new AzureNative.Network.V20200401Preview.Inputs.SubResourceArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200401preview:InboundEndpoint")]
    public partial class InboundEndpoint : global::Pulumi.CustomResource
    {
        ...
        public InboundEndpoint(string name, InboundEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401preview:InboundEndpoint", name, args ?? new InboundEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InboundEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401preview:InboundEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
