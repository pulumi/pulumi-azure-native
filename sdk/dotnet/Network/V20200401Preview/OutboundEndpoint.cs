...
namespace Pulumi.AzureNative.Network.V20200401Preview
{
    ...
    /// {
    ///     var outboundEndpoint = new AzureNative.Network.V20200401Preview.OutboundEndpoint("outboundEndpoint", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200401preview:OutboundEndpoint")]
    public partial class OutboundEndpoint : global::Pulumi.CustomResource
    {
        ...
        public OutboundEndpoint(string name, OutboundEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401preview:OutboundEndpoint", name, args ?? new OutboundEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OutboundEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401preview:OutboundEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
