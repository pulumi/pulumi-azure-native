...
namespace Pulumi.AzureNative.Network.V20200401Preview
{
    ...
    /// {
    ///     var dnsResolver = new AzureNative.Network.V20200401Preview.DnsResolver("dnsResolver", new()
    ///     {
    ...
    public partial class DnsResolver : global::Pulumi.CustomResource
    {
        ...
        public DnsResolver(string name, DnsResolverArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401preview:DnsResolver", name, args ?? new DnsResolverArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsResolver(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200401preview:DnsResolver", name, null, MakeResourceOptions(options, id))
        {
        }
