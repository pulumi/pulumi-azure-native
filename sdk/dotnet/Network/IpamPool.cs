...
namespace Pulumi.AzureNative.Network
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network:IpamPool")]
    public partial class IpamPool : global::Pulumi.CustomResource
    {
        ...
        public IpamPool(string name, IpamPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network:IpamPool", name, args ?? new IpamPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpamPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network:IpamPool", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240701:IpamPool" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20241001:IpamPool" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250101:IpamPool" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250301:IpamPool" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250501:IpamPool" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20250701:IpamPool" },
                },
            };
