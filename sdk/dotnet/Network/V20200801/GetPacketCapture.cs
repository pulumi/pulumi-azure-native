...
{
    [Obsolete(@"azure-native:network/v20200801:PacketCapture is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PacketCapture to guarantee forwards compatibility.")]
    public static class GetPacketCapture
    {
        ...
        public static Task<GetPacketCaptureResult> InvokeAsync(GetPacketCaptureArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPacketCaptureResult>("azure-native:network/v20200801:getPacketCapture", args ?? new GetPacketCaptureArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a packet capture session by name.
        /// </summary>
        public static Output<GetPacketCaptureResult> Invoke(GetPacketCaptureInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPacketCaptureResult>("azure-native:network/v20200801:getPacketCapture", args ?? new GetPacketCaptureInvokeArgs(), options.WithDefaults());
    }
