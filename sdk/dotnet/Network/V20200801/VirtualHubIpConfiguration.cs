...
namespace Pulumi.AzureNative.Network.V20200801
{
    ...
    /// IpConfigurations.
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200801:VirtualHubIpConfiguration")]
    public partial class VirtualHubIpConfiguration : Pulumi.CustomResource
    {
        ...
        public VirtualHubIpConfiguration(string name, VirtualHubIpConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200801:VirtualHubIpConfiguration", name, args ?? new VirtualHubIpConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubIpConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200801:VirtualHubIpConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:network/v20210201:VirtualHubIpConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:VirtualHubIpConfiguration"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:VirtualHubIpConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:VirtualHubIpConfiguration"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:VirtualHubIpConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:VirtualHubIpConfiguration"},
                },
            };
