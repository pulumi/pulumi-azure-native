...
namespace Pulumi.AzureNextGen.Network.V20200801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200801:VirtualHubRouteTableV2")]
    public partial class VirtualHubRouteTableV2 : Pulumi.CustomResource
    {
        ...
        public VirtualHubRouteTableV2(string name, VirtualHubRouteTableV2Args args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200801:VirtualHubRouteTableV2", name, args ?? new VirtualHubRouteTableV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHubRouteTableV2(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200801:VirtualHubRouteTableV2", name, null, MakeResourceOptions(options, id))
        {
        }
