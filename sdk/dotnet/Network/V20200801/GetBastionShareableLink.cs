...
namespace Pulumi.AzureNative.Network.V20200801
{
    public static class GetBastionShareableLink
    {
        ...
        public static Task<GetBastionShareableLinkResult> InvokeAsync(GetBastionShareableLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBastionShareableLinkResult>("azure-native:network/v20200801:getBastionShareableLink", args ?? new GetBastionShareableLinkArgs(), options.WithDefaults());
        ...
        public static Output<GetBastionShareableLinkResult> Invoke(GetBastionShareableLinkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBastionShareableLinkResult>("azure-native:network/v20200801:getBastionShareableLink", args ?? new GetBastionShareableLinkInvokeArgs(), options.WithDefaults());
    }
