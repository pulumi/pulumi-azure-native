...
namespace Pulumi.AzureNative.Network.V20200801
{
    public static class GetNatGateway
    {
        ...
        public static Task<GetNatGatewayResult> InvokeAsync(GetNatGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNatGatewayResult>("azure-native:network/v20200801:getNatGateway", args ?? new GetNatGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// Nat Gateway resource.
        /// </summary>
        public static Output<GetNatGatewayResult> Invoke(GetNatGatewayInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNatGatewayResult>("azure-native:network/v20200801:getNatGateway", args ?? new GetNatGatewayInvokeArgs(), options.WithDefaults());
    }
