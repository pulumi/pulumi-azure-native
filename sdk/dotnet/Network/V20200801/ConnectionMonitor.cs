...
namespace Pulumi.AzureNative.Network.V20200801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20200801:ConnectionMonitor is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ConnectionMonitor to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20200801:ConnectionMonitor")]
    public partial class ConnectionMonitor : global::Pulumi.CustomResource
    {
        ...
        public ConnectionMonitor(string name, ConnectionMonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200801:ConnectionMonitor", name, args ?? new ConnectionMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200801:ConnectionMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
