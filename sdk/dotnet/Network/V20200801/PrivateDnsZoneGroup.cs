...
namespace Pulumi.AzureNextGen.Network.V20200801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200801:PrivateDnsZoneGroup")]
    public partial class PrivateDnsZoneGroup : Pulumi.CustomResource
    {
        ...
        public PrivateDnsZoneGroup(string name, PrivateDnsZoneGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200801:PrivateDnsZoneGroup", name, args ?? new PrivateDnsZoneGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateDnsZoneGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200801:PrivateDnsZoneGroup", name, null, MakeResourceOptions(options, id))
        {
        }
