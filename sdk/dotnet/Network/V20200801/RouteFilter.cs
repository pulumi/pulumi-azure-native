...
namespace Pulumi.AzureNative.Network.V20200801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20200801:RouteFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:RouteFilter to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20200801:RouteFilter")]
    public partial class RouteFilter : global::Pulumi.CustomResource
    {
        ...
        public RouteFilter(string name, RouteFilterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200801:RouteFilter", name, args ?? new RouteFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200801:RouteFilter", name, null, MakeResourceOptions(options, id))
        {
        }
