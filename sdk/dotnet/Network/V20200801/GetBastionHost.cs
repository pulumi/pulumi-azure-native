...
namespace Pulumi.AzureNative.Network.V20200801
{
    ...
    public static class GetBastionHost
    {
        ...
        public static Task<GetBastionHostResult> InvokeAsync(GetBastionHostArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBastionHostResult>("azure-native:network/v20200801:getBastionHost", args ?? new GetBastionHostArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified Bastion Host.
        /// </summary>
        public static Output<GetBastionHostResult> Invoke(GetBastionHostInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBastionHostResult>("azure-native:network/v20200801:getBastionHost", args ?? new GetBastionHostInvokeArgs(), options.WithDefaults());
    }
