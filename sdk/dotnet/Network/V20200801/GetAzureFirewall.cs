...
namespace Pulumi.AzureNextGen.Network.V20200801
{
    public static class GetAzureFirewall
    {
        ...
        public static Task<GetAzureFirewallResult> InvokeAsync(GetAzureFirewallArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAzureFirewallResult>("azure-nextgen:network/v20200801:getAzureFirewall", args ?? new GetAzureFirewallArgs(), options.WithVersion());
    }
