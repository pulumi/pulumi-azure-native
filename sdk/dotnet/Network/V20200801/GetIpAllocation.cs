...
namespace Pulumi.AzureNextGen.Network.V20200801
{
    public static class GetIpAllocation
    {
        ...
        public static Task<GetIpAllocationResult> InvokeAsync(GetIpAllocationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIpAllocationResult>("azure-nextgen:network/v20200801:getIpAllocation", args ?? new GetIpAllocationArgs(), options.WithVersion());
    }
