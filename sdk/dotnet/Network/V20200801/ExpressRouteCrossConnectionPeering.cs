...
namespace Pulumi.AzureNextGen.Network.V20200801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200801:ExpressRouteCrossConnectionPeering")]
    public partial class ExpressRouteCrossConnectionPeering : Pulumi.CustomResource
    {
        ...
        public ExpressRouteCrossConnectionPeering(string name, ExpressRouteCrossConnectionPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200801:ExpressRouteCrossConnectionPeering", name, args ?? new ExpressRouteCrossConnectionPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCrossConnectionPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200801:ExpressRouteCrossConnectionPeering", name, null, MakeResourceOptions(options, id))
        {
        }
