...
namespace Pulumi.AzureNative.Network.V20200801
{
    public static class GetSecurityRule
    {
        ...
        public static Task<GetSecurityRuleResult> InvokeAsync(GetSecurityRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSecurityRuleResult>("azure-native:network/v20200801:getSecurityRule", args ?? new GetSecurityRuleArgs(), options.WithVersion());

        /// <summary>
        /// Network security rule.
        /// </summary>
        public static Output<GetSecurityRuleResult> Invoke(GetSecurityRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSecurityRuleResult>("azure-native:network/v20200801:getSecurityRule", args ?? new GetSecurityRuleInvokeArgs(), options.WithVersion());
    }
