...
namespace Pulumi.AzureNative.Network.V20200801
{
    ...
    public partial class DdosCustomPolicy : global::Pulumi.CustomResource
    {
        ...
        public DdosCustomPolicy(string name, DdosCustomPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200801:DdosCustomPolicy", name, args ?? new DdosCustomPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DdosCustomPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200801:DdosCustomPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
