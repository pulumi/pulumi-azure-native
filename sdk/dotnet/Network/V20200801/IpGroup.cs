...
namespace Pulumi.AzureNextGen.Network.V20200801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20200801:IpGroup")]
    public partial class IpGroup : Pulumi.CustomResource
    {
        ...
        public IpGroup(string name, IpGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200801:IpGroup", name, args ?? new IpGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20200801:IpGroup", name, null, MakeResourceOptions(options, id))
        {
        }
