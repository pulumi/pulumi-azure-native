...
namespace Pulumi.AzureNextGen.Network.V20200801.Inputs
{
    ...
    public sealed class LoadBalancingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200801.LoadDistribution>? LoadDistribution { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200801.TransportProtocol> Protocol { get; set; } = null!;
