...
namespace Pulumi.AzureNextGen.Network.V20200801.Inputs
{
    ...
    public sealed class AzureFirewallNetworkRuleArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("protocols")]
        private InputList<Union<string, Pulumi.AzureNextGen.Network.V20200801.AzureFirewallNetworkRuleProtocol>>? _protocols;

        /// <summary>
        /// Array of AzureFirewallNetworkRuleProtocols.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.Network.V20200801.AzureFirewallNetworkRuleProtocol>> Protocols
        {
            get => _protocols ?? (_protocols = new InputList<Union<string, Pulumi.AzureNextGen.Network.V20200801.AzureFirewallNetworkRuleProtocol>>());
