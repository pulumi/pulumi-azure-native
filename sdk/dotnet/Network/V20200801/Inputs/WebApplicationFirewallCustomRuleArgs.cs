...
namespace Pulumi.AzureNative.Network.V20200801.Inputs
{
    ...
    public sealed class WebApplicationFirewallCustomRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200801.WebApplicationFirewallAction> Action { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200801.WebApplicationFirewallRuleType> RuleType { get; set; } = null!;
