...
namespace Pulumi.AzureNextGen.Network.V20200801.Inputs
{
    ...
    public sealed class OwaspCrsExclusionEntryArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200801.OwaspCrsExclusionEntryMatchVariable> MatchVariable { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200801.OwaspCrsExclusionEntrySelectorMatchOperator> SelectorMatchOperator { get; set; } = null!;
