...
namespace Pulumi.AzureNextGen.Network.V20200801.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200801.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20200801.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
