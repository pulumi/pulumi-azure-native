...
namespace Pulumi.AzureNative.Network.V20200801.Inputs
{
    ...
    public sealed class ProtocolCustomSettingsFormatArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200801.DdosCustomPolicyProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20200801.DdosCustomPolicyTriggerSensitivityOverride>? TriggerSensitivityOverride { get; set; }
