...
namespace Pulumi.AzureNextGen.Network.V20200801
{
    public static class GetVirtualNetworkGatewayConnection
    {
        public static Task<GetVirtualNetworkGatewayConnectionResult> InvokeAsync(GetVirtualNetworkGatewayConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkGatewayConnectionResult>("azure-nextgen:network/v20200801:getVirtualNetworkGatewayConnection", args ?? new GetVirtualNetworkGatewayConnectionArgs(), options.WithVersion());
    }
    ...
    public sealed class GetVirtualNetworkGatewayConnectionResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.TrafficSelectorPolicyInvokeResponseResult> TrafficSelectorPolicies;
        /// <summary>
        ...
        private GetVirtualNetworkGatewayConnectionResult(
            ...
            ImmutableArray<Outputs.TrafficSelectorPolicyInvokeResponseResult> trafficSelectorPolicies,
