...
namespace Pulumi.AzureNative.Network.V20200801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20200801:ExpressRoutePort")]
    public partial class ExpressRoutePort : Pulumi.CustomResource
    {
        ...
        public ExpressRoutePort(string name, ExpressRoutePortArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200801:ExpressRoutePort", name, args ?? new ExpressRoutePortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRoutePort(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20200801:ExpressRoutePort", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRoutePortArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("encapsulation")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20200801.ExpressRoutePortsEncapsulation>? Encapsulation { get; set; }
