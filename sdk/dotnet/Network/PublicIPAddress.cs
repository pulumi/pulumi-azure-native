...
namespace Pulumi.AzureRM.Network
{
    ...
    public partial class PublicIPAddress : Pulumi.CustomResource
    {
        ...
        private PublicIPAddress(string name, Input<string> id, PublicIPAddressState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:network:PublicIPAddress", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PublicIPAddress Get(string name, Input<string> id, PublicIPAddressState? state = null, CustomResourceOptions? options = null)
        {
            return new PublicIPAddress(name, id, state, options);
        }
    }
    ...
    public sealed class PublicIPAddressState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A unique read-only string that changes whenever the resource is updated.
        /// </summary>
        ...
        public Input<Inputs.PublicIPAddressPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
