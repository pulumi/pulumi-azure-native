...
namespace Pulumi.AzureNative.Network.V20180801
{
    public static class GetInterfaceEndpoint
    {
        ...
        public static Output<GetInterfaceEndpointResult> Invoke(GetInterfaceEndpointInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetInterfaceEndpointResult>("azure-native:network/v20180801:getInterfaceEndpoint", args ?? new GetInterfaceEndpointInvokeArgs(), options.WithVersion());
    }
