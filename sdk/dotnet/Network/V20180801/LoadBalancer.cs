...
namespace Pulumi.AzureRM.Network.V20180801
{
    ...
    public partial class LoadBalancer : Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180801:LoadBalancer", name, args ?? new LoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180801:LoadBalancer", name, null, MakeResourceOptions(options, id))
        {
        }
