...
namespace Pulumi.AzureNative.Network.V20180801
{
    public static class GetSubnet
    {
        ...
        public static Task<GetSubnetResult> InvokeAsync(GetSubnetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSubnetResult>("azure-native:network/v20180801:getSubnet", args ?? new GetSubnetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified subnet by virtual network and resource group.
        /// </summary>
        public static Output<GetSubnetResult> Invoke(GetSubnetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSubnetResult>("azure-native:network/v20180801:getSubnet", args ?? new GetSubnetInvokeArgs(), options.WithDefaults());
    }
