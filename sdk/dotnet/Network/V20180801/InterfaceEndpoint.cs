...
namespace Pulumi.AzureNative.Network.V20180801
{
    ...
    public partial class InterfaceEndpoint : Pulumi.CustomResource
    {
        ...
        public InterfaceEndpoint(string name, InterfaceEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180801:InterfaceEndpoint", name, args ?? new InterfaceEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InterfaceEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180801:InterfaceEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20190401:InterfaceEndpoint"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20190701:InterfaceEndpoint"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20191101:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20191201:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20191201:InterfaceEndpoint"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20200401:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20200501:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20200501:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20200601:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20200601:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20200701:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20200701:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20200801:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20200801:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20201101:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20201101:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210201:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:InterfaceEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:InterfaceEndpoint"},
                },
            };
