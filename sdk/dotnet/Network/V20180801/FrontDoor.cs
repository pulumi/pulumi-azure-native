...
namespace Pulumi.AzureRM.Network.V20180801
{
    ...
    public partial class FrontDoor : Pulumi.CustomResource
    {
        ...
        public FrontDoor(string name, FrontDoorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180801:FrontDoor", name, args ?? new FrontDoorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FrontDoor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180801:FrontDoor", name, null, MakeResourceOptions(options, id))
        {
        }
