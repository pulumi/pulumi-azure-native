...
namespace Pulumi.AzureRM.Network.V20180801
{
    public static class GetRouteFilterRule
    {
        public static Task<GetRouteFilterRuleResult> InvokeAsync(GetRouteFilterRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouteFilterRuleResult>("azurerm:network/v20180801:getRouteFilterRule", args ?? new GetRouteFilterRuleArgs(), options.WithVersion());
    }
