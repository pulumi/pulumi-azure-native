...
namespace Pulumi.AzureNative.Network.V20180801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:network/v20180801:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20180801:ExpressRouteCrossConnectionPeering")]
    public partial class ExpressRouteCrossConnectionPeering : global::Pulumi.CustomResource
    {
        ...
        public ExpressRouteCrossConnectionPeering(string name, ExpressRouteCrossConnectionPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180801:ExpressRouteCrossConnectionPeering", name, args ?? new ExpressRouteCrossConnectionPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRouteCrossConnectionPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180801:ExpressRouteCrossConnectionPeering", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRouteCrossConnectionPeeringArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("peeringType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20180801.ExpressRoutePeeringType>? PeeringType { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20180801.ExpressRoutePeeringState>? State { get; set; }
