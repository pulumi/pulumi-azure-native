...
namespace Pulumi.AzureRM.Network.V20180801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vpnSite = new AzureRM.Network.V20180801.VpnSite("vpnSite", new AzureRM.Network.V20180801.VpnSiteArgs
    ///         {
    ///             AddressSpace = new AzureRM.Network.V20180801.Inputs.AddressSpaceArgs
    ///             {
    ///                 AddressPrefixes = 
    ///                 {
    ///                     "10.0.0.0/16",
    ///                 },
    ///             },
    ///             BgpProperties = new AzureRM.Network.V20180801.Inputs.BgpSettingsArgs
    ///             {
    ///                 Asn = 1234,
    ///                 BgpPeeringAddress = "192.168.0.0",
    ///             },
    ///             DeviceProperties = new AzureRM.Network.V20180801.Inputs.DevicePropertiesArgs
    ///             {
    ///                 DeviceModel = "model01",
    ...
    public partial class VpnSite : Pulumi.CustomResource
    {
        ...
        public VpnSite(string name, VpnSiteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180801:VpnSite", name, args ?? new VpnSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180801:VpnSite", name, null, MakeResourceOptions(options, id))
        {
        }
