...
namespace Pulumi.AzureNative.Network.V20180801
{
    ...
    /// VpnSite Resource.
    /// </summary>
    [Obsolete(@"azure-native:network/v20180801:VpnSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnSite to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:network/v20180801:VpnSite")]
    public partial class VpnSite : global::Pulumi.CustomResource
    {
        ...
        public VpnSite(string name, VpnSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180801:VpnSite", name, args ?? new VpnSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180801:VpnSite", name, null, MakeResourceOptions(options, id))
        {
        }
