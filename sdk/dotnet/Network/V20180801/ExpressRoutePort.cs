...
namespace Pulumi.AzureNextGen.Network.V20180801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20180801:ExpressRoutePort")]
    public partial class ExpressRoutePort : Pulumi.CustomResource
    {
        ...
        public ExpressRoutePort(string name, ExpressRoutePortArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180801:ExpressRoutePort", name, args ?? new ExpressRoutePortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRoutePort(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180801:ExpressRoutePort", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExpressRoutePortArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("encapsulation")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20180801.ExpressRoutePortsEncapsulation>? Encapsulation { get; set; }
