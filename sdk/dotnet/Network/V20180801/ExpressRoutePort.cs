...
namespace Pulumi.AzureRM.Network.V20180801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var expressRoutePort = new AzureRM.Network.V20180801.ExpressRoutePort("expressRoutePort", new AzureRM.Network.V20180801.ExpressRoutePortArgs
    ///         {
    ///             BandwidthInGbps = 100,
    ///             Encapsulation = "QinQ",
    ...
    ///             Links = 
    ///             {
    ///                 new AzureRM.Network.V20180801.Inputs.ExpressRouteLinkArgs
    ///                 {
    ///                     Name = "link1",
    ///                 },
    ///             },
    ...
    public partial class ExpressRoutePort : Pulumi.CustomResource
    {
        ...
        public ExpressRoutePort(string name, ExpressRoutePortArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180801:ExpressRoutePort", name, args ?? new ExpressRoutePortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExpressRoutePort(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180801:ExpressRoutePort", name, null, MakeResourceOptions(options, id))
        {
        }
