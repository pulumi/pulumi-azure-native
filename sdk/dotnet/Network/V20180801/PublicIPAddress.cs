...
namespace Pulumi.AzureNative.Network.V20180801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20180801:PublicIPAddress")]
    public partial class PublicIPAddress : Pulumi.CustomResource
    {
        ...
        public PublicIPAddress(string name, PublicIPAddressArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180801:PublicIPAddress", name, args ?? new PublicIPAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIPAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180801:PublicIPAddress", name, null, MakeResourceOptions(options, id))
        {
        }
