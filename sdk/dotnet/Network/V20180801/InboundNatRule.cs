...
namespace Pulumi.AzureNextGen.Network.V20180801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20180801:InboundNatRule")]
    public partial class InboundNatRule : Pulumi.CustomResource
    {
        ...
        public InboundNatRule(string name, InboundNatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180801:InboundNatRule", name, args ?? new InboundNatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InboundNatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180801:InboundNatRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InboundNatRuleArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20180801.TransportProtocol>? Protocol { get; set; }
