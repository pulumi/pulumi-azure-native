...
namespace Pulumi.AzureNextGen.Network.V20180801
{
    public static class GetDdosProtectionPlan
    {
        public static Task<GetDdosProtectionPlanResult> InvokeAsync(GetDdosProtectionPlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDdosProtectionPlanResult>("azure-nextgen:network/v20180801:getDdosProtectionPlan", args ?? new GetDdosProtectionPlanArgs(), options.WithVersion());
    }
    ...
    public sealed class GetDdosProtectionPlanResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.SubResourceInvokeResponseResult> VirtualNetworks;
        ...
        private GetDdosProtectionPlanResult(
            ...
            ImmutableArray<Outputs.SubResourceInvokeResponseResult> virtualNetworks)
        {
            Etag = etag;
            Id = id;
            Location = location;
