...
namespace Pulumi.AzureNative.Network.V20180801
{
    public static class GetVpnSite
    {
        ...
        public static Task<GetVpnSiteResult> InvokeAsync(GetVpnSiteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVpnSiteResult>("azure-native:network/v20180801:getVpnSite", args ?? new GetVpnSiteArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the details of a VPN site.
        /// </summary>
        public static Output<GetVpnSiteResult> Invoke(GetVpnSiteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVpnSiteResult>("azure-native:network/v20180801:getVpnSite", args ?? new GetVpnSiteInvokeArgs(), options.WithDefaults());
