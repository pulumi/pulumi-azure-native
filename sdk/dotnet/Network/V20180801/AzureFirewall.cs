...
namespace Pulumi.AzureNextGen.Network.V20180801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:network/v20180801:AzureFirewall")]
    public partial class AzureFirewall : Pulumi.CustomResource
    {
        ...
        public AzureFirewall(string name, AzureFirewallArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180801:AzureFirewall", name, args ?? new AzureFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureFirewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:network/v20180801:AzureFirewall", name, null, MakeResourceOptions(options, id))
        {
        }
