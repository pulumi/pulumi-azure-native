...
namespace Pulumi.AzureRM.Network.V20180801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serviceEndpointPolicyDefinition = new AzureRM.Network.V20180801.ServiceEndpointPolicyDefinition("serviceEndpointPolicyDefinition", new AzureRM.Network.V20180801.ServiceEndpointPolicyDefinitionArgs
    ///         {
    ...
    public partial class ServiceEndpointPolicyDefinition : Pulumi.CustomResource
    {
        ...
        public ServiceEndpointPolicyDefinition(string name, ServiceEndpointPolicyDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180801:ServiceEndpointPolicyDefinition", name, args ?? new ServiceEndpointPolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceEndpointPolicyDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20180801:ServiceEndpointPolicyDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
