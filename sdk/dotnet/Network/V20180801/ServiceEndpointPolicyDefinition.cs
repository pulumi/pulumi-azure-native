...
namespace Pulumi.AzureNative.Network.V20180801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20180801:ServiceEndpointPolicyDefinition")]
    public partial class ServiceEndpointPolicyDefinition : Pulumi.CustomResource
    {
        ...
        public ServiceEndpointPolicyDefinition(string name, ServiceEndpointPolicyDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180801:ServiceEndpointPolicyDefinition", name, args ?? new ServiceEndpointPolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceEndpointPolicyDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180801:ServiceEndpointPolicyDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
