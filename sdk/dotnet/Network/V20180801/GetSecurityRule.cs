...
namespace Pulumi.AzureRM.Network.V20180801
{
    public static class GetSecurityRule
    {
        public static Task<GetSecurityRuleResult> InvokeAsync(GetSecurityRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSecurityRuleResult>("azurerm:network/v20180801:getSecurityRule", args ?? new GetSecurityRuleArgs(), options.WithVersion());
    }
