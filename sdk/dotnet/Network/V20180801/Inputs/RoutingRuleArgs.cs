...
namespace Pulumi.AzureNative.Network.V20180801.Inputs
{
    ...
    public sealed class RoutingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Network.V20180801.FrontDoorProtocol>>? _acceptedProtocols;

        /// <summary>
        /// Protocol schemes to match for this rule
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Network.V20180801.FrontDoorProtocol>> AcceptedProtocols
        {
            get => _acceptedProtocols ?? (_acceptedProtocols = new InputList<Union<string, Pulumi.AzureNative.Network.V20180801.FrontDoorProtocol>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20180801.FrontDoorForwardingProtocol>? ForwardingProtocol { get; set; }
