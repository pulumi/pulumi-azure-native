...
namespace Pulumi.AzureNative.Network.V20180801.Inputs
{
    ...
    public sealed class MonitorConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20180801.ProfileMonitorStatus>? ProfileMonitorStatus { get; set; }

        /// <summary>
        /// The protocol (HTTP, HTTPS or TCP) used to probe for endpoint health.
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20180801.MonitorProtocol>? Protocol { get; set; }
