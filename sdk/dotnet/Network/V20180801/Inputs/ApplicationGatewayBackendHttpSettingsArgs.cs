...
namespace Pulumi.AzureNextGen.Network.V20180801.Inputs
{
    ...
    public sealed class ApplicationGatewayBackendHttpSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20180801.ApplicationGatewayCookieBasedAffinity>? CookieBasedAffinity { get; set; }
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20180801.ApplicationGatewayProtocol>? Protocol { get; set; }
