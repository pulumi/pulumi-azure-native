        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:network/v20201101:RouteFilter"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20201101:RouteFilter"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210201:RouteFilter"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210201:RouteFilter"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210301:RouteFilter"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210301:RouteFilter"},
                    new Pulumi.Alias { Type = "azure-native:network/v20210501:RouteFilter"},
                    new Pulumi.Alias { Type = "azure-nextgen:network/v20210501:RouteFilter"},
                },
            };
