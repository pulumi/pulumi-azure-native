...
namespace Pulumi.AzureNative.Network.V20180801
{
    ...
    /// {
    ///     var trafficManagerUserMetricsKey = new AzureNative.Network.V20180801.TrafficManagerUserMetricsKey("trafficManagerUserMetricsKey");
    /// 
    /// });
    /// 
    /// 
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20180801:TrafficManagerUserMetricsKey")]
    public partial class TrafficManagerUserMetricsKey : global::Pulumi.CustomResource
    {
        ...
        public TrafficManagerUserMetricsKey(string name, TrafficManagerUserMetricsKeyArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180801:TrafficManagerUserMetricsKey", name, args ?? new TrafficManagerUserMetricsKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TrafficManagerUserMetricsKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20180801:TrafficManagerUserMetricsKey", name, null, MakeResourceOptions(options, id))
        {
        }
