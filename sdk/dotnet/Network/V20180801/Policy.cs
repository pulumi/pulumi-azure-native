...
namespace Pulumi.AzureRM.Network.V20180801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policy = new AzureRM.Network.V20180801.Policy("policy", new AzureRM.Network.V20180801.PolicyArgs
    ///         {
    ///             CustomRules = new AzureRM.Network.V20180801.Inputs.CustomRulesArgs
    ///             {
    ///                 Rules = 
    ///                 {
    ///                     new AzureRM.Network.V20180801.Inputs.CustomRuleArgs
    ///                     {
    ///                         Action = "Block",
    ///                         MatchConditions = 
    ///                         {
    ///                             new AzureRM.Network.V20180801.Inputs.MatchConditionArgs
    ///                             {
    ///                                 MatchValue = 
    ///                                 {
    ///                                     "192.168.1.0/24",
    ...
    ///                 },
    ///             },
    ///             ManagedRules = new AzureRM.Network.V20180801.Inputs.ManagedRuleSetsArgs
    ///             {
    ///                 RuleSets = 
    ///                 {
