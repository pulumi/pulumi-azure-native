...
namespace Pulumi.AzureRM.Network
{
    public static class GetDdosCustomPolicy
    {
        public static Task<GetDdosCustomPolicyResult> InvokeAsync(GetDdosCustomPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDdosCustomPolicyResult>("azurerm:network:getDdosCustomPolicy", args ?? new GetDdosCustomPolicyArgs(), options.WithVersion());
    }
