...
namespace Pulumi.AzureNative.Network.V20240201
{
    ...
    public readonly struct VariableName : IEquatable<VariableName>
    {
        ...
        public static explicit operator string(VariableName value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is VariableName other && Equals(other);
        public bool Equals(VariableName other) => string.Equals(_value, other._value, StringComparison.Ordinal);
