...
namespace Pulumi.AzureNative.Network.V20240201.Inputs
{
    ...
    public sealed class ManagedRuleExclusionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240201.ManagedRuleExclusionMatchVariable> MatchVariable { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20240201.ManagedRuleExclusionSelectorMatchOperator> SelectorMatchOperator { get; set; } = null!;
