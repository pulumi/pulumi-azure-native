...
namespace Pulumi.AzureNative.Network.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230401:VirtualNetworkGatewayNatRule")]
    public partial class VirtualNetworkGatewayNatRule : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkGatewayNatRule(string name, VirtualNetworkGatewayNatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230401:VirtualNetworkGatewayNatRule", name, args ?? new VirtualNetworkGatewayNatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkGatewayNatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230401:VirtualNetworkGatewayNatRule", name, null, MakeResourceOptions(options, id))
        {
        }
