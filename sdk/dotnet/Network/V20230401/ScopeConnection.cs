...
namespace Pulumi.AzureNative.Network.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230401:ScopeConnection")]
    public partial class ScopeConnection : global::Pulumi.CustomResource
    {
        ...
        public ScopeConnection(string name, ScopeConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230401:ScopeConnection", name, args ?? new ScopeConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230401:ScopeConnection", name, null, MakeResourceOptions(options, id))
        {
        }
