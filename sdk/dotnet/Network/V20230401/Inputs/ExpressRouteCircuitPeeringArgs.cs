...
namespace Pulumi.AzureNative.Network.V20230401.Inputs
{
    ...
    public sealed class ExpressRouteCircuitPeeringArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("peeringType")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230401.ExpressRoutePeeringType>? PeeringType { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Network.V20230401.ExpressRoutePeeringState>? State { get; set; }
