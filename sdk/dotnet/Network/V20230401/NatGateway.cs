...
namespace Pulumi.AzureNative.Network.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230401:NatGateway")]
    public partial class NatGateway : global::Pulumi.CustomResource
    {
        ...
        public NatGateway(string name, NatGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230401:NatGateway", name, args ?? new NatGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230401:NatGateway", name, null, MakeResourceOptions(options, id))
        {
        }
