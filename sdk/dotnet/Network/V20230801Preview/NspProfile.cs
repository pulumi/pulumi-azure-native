...
namespace Pulumi.AzureNative.Network.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230801preview:NspProfile")]
    public partial class NspProfile : global::Pulumi.CustomResource
    {
        ...
        public NspProfile(string name, NspProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230801preview:NspProfile", name, args ?? new NspProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NspProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230801preview:NspProfile", name, null, MakeResourceOptions(options, id))
        {
        }
