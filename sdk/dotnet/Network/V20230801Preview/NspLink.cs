...
namespace Pulumi.AzureNative.Network.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230801preview:NspLink")]
    public partial class NspLink : global::Pulumi.CustomResource
    {
        ...
        public NspLink(string name, NspLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230801preview:NspLink", name, args ?? new NspLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NspLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230801preview:NspLink", name, null, MakeResourceOptions(options, id))
        {
        }
