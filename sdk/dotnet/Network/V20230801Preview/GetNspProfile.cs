...
namespace Pulumi.AzureNative.Network.V20230801Preview
{
    public static class GetNspProfile
    {
        ...
        public static Task<GetNspProfileResult> InvokeAsync(GetNspProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNspProfileResult>("azure-native:network/v20230801preview:getNspProfile", args ?? new GetNspProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified NSP profile.
        /// </summary>
        public static Output<GetNspProfileResult> Invoke(GetNspProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNspProfileResult>("azure-native:network/v20230801preview:getNspProfile", args ?? new GetNspProfileInvokeArgs(), options.WithDefaults());
