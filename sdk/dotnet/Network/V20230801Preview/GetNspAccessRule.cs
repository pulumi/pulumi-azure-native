...
namespace Pulumi.AzureNative.Network.V20230801Preview
{
    public static class GetNspAccessRule
    {
        ...
        public static Task<GetNspAccessRuleResult> InvokeAsync(GetNspAccessRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNspAccessRuleResult>("azure-native:network/v20230801preview:getNspAccessRule", args ?? new GetNspAccessRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified NSP access rule by name.
        /// </summary>
        public static Output<GetNspAccessRuleResult> Invoke(GetNspAccessRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNspAccessRuleResult>("azure-native:network/v20230801preview:getNspAccessRule", args ?? new GetNspAccessRuleInvokeArgs(), options.WithDefaults());
    }
