...
namespace Pulumi.AzureNative.Network.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20230801preview:NetworkSecurityPerimeter")]
    public partial class NetworkSecurityPerimeter : global::Pulumi.CustomResource
    {
        ...
        public NetworkSecurityPerimeter(string name, NetworkSecurityPerimeterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230801preview:NetworkSecurityPerimeter", name, args ?? new NetworkSecurityPerimeterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityPerimeter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20230801preview:NetworkSecurityPerimeter", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:network/v20240601preview:NetworkSecurityPerimeter" },
