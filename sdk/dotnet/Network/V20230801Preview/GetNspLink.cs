...
namespace Pulumi.AzureNative.Network.V20230801Preview
{
    public static class GetNspLink
    {
        ...
        public static Task<GetNspLinkResult> InvokeAsync(GetNspLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNspLinkResult>("azure-native:network/v20230801preview:getNspLink", args ?? new GetNspLinkArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified NSP link resource.
        /// </summary>
        public static Output<GetNspLinkResult> Invoke(GetNspLinkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNspLinkResult>("azure-native:network/v20230801preview:getNspLink", args ?? new GetNspLinkInvokeArgs(), options.WithDefaults());
    }
