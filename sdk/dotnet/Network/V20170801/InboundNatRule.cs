...
namespace Pulumi.AzureNative.Network.V20170801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20170801:InboundNatRule")]
    public partial class InboundNatRule : Pulumi.CustomResource
    {
        ...
        public InboundNatRule(string name, InboundNatRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170801:InboundNatRule", name, args ?? new InboundNatRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InboundNatRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170801:InboundNatRule", name, null, MakeResourceOptions(options, id))
        {
        }
