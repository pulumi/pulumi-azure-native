...
namespace Pulumi.AzureNative.Network.V20170801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:network/v20170801:SecurityRule")]
    public partial class SecurityRule : Pulumi.CustomResource
    {
        ...
        public SecurityRule(string name, SecurityRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170801:SecurityRule", name, args ?? new SecurityRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:network/v20170801:SecurityRule", name, null, MakeResourceOptions(options, id))
        {
        }
