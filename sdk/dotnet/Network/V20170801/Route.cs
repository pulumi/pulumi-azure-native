...
namespace Pulumi.AzureRM.Network.V20170801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var route = new AzureRM.Network.V20170801.Route("route", new AzureRM.Network.V20170801.RouteArgs
    ///         {
    ...
    public partial class Route : Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:network/v20170801:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:network/v20170801:Route", name, null, MakeResourceOptions(options, id))
        {
        }
