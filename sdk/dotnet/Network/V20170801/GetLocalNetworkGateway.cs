...
namespace Pulumi.AzureRM.Network.V20170801
{
    public static class GetLocalNetworkGateway
    {
        public static Task<GetLocalNetworkGatewayResult> InvokeAsync(GetLocalNetworkGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLocalNetworkGatewayResult>("azurerm:network/v20170801:getLocalNetworkGateway", args ?? new GetLocalNetworkGatewayArgs(), options.WithVersion());
    }
    ...
    public sealed class GetLocalNetworkGatewayResult
    {
        ...
        /// </summary>
        public readonly Outputs.LocalNetworkGatewayPropertiesFormatResponseResult Properties;
        /// <summary>
        /// Resource tags.
        /// </summary>
        ...
        private GetLocalNetworkGatewayResult(
            ...
            Outputs.LocalNetworkGatewayPropertiesFormatResponseResult properties,
