...
namespace Pulumi.AzureNative.Network.V20170801.Inputs
{
    ...
    public sealed class ExpressRouteCircuitPeeringConfigArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Network.V20170801.ExpressRouteCircuitPeeringAdvertisedPublicPrefixState>? AdvertisedPublicPrefixesState { get; set; }
