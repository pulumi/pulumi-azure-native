...
namespace Pulumi.AzureNextGen.Network.V20170801.Inputs
{
    ...
    public sealed class ExpressRouteCircuitSkuArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("family")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170801.ExpressRouteCircuitSkuFamily>? Family { get; set; }
        ...
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNextGen.Network.V20170801.ExpressRouteCircuitSkuTier>? Tier { get; set; }
