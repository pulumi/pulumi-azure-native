...
namespace Pulumi.AzureNextGen.Network.V20170801.Inputs
{
    ...
    public sealed class VpnClientConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNextGen.Network.V20170801.VpnClientProtocol>>? _vpnClientProtocols;

        /// <summary>
        /// VpnClientProtocols for Virtual network gateway.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.Network.V20170801.VpnClientProtocol>> VpnClientProtocols
        {
            get => _vpnClientProtocols ?? (_vpnClientProtocols = new InputList<Union<string, Pulumi.AzureNextGen.Network.V20170801.VpnClientProtocol>>());
