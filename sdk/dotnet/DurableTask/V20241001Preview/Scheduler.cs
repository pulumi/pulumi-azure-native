...
namespace Pulumi.AzureNative.DurableTask.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:durabletask/v20241001preview:Scheduler")]
    public partial class Scheduler : global::Pulumi.CustomResource
    {
        ...
        public Scheduler(string name, SchedulerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:durabletask/v20241001preview:Scheduler", name, args ?? new SchedulerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Scheduler(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:durabletask/v20241001preview:Scheduler", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:durabletask:Scheduler" },
                },
            };
