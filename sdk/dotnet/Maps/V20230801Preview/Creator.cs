...
namespace Pulumi.AzureNative.Maps.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:maps/v20230801preview:Creator")]
    public partial class Creator : global::Pulumi.CustomResource
    {
        ...
        public Creator(string name, CreatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maps/v20230801preview:Creator", name, args ?? new CreatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Creator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maps/v20230801preview:Creator", name, null, MakeResourceOptions(options, id))
        {
        }
