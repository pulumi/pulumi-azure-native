...
namespace Pulumi.AzureRM.Maps.V20170101beta1
{
    public static class ListAccountKeys
    {
        public static Task<ListAccountKeysResult> InvokeAsync(ListAccountKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAccountKeysResult>("azurerm:maps/v20170101beta1:listAccountKeys", args ?? new ListAccountKeysArgs(), options.WithVersion());
    }
