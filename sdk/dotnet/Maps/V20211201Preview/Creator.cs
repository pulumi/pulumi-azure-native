...
namespace Pulumi.AzureNative.Maps.V20211201Preview
{
    ...
    /// {
    ///     var creator = new AzureNative.Maps.V20211201Preview.Creator("creator", new()
    ///     {
    ///         AccountName = "myMapsAccount",
    ///         CreatorName = "myCreator",
    ///         Location = "eastus2",
    ///         Properties = new AzureNative.Maps.V20211201Preview.Inputs.CreatorPropertiesArgs
    ///         {
    ///             StorageUnits = 5,
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:maps/v20211201preview:Creator")]
    public partial class Creator : global::Pulumi.CustomResource
    {
        ...
        public Creator(string name, CreatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maps/v20211201preview:Creator", name, args ?? new CreatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Creator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maps/v20211201preview:Creator", name, null, MakeResourceOptions(options, id))
        {
        }
