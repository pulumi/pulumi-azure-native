...
namespace Pulumi.AzureNative.Maps.V20211201Preview
{
    public static class GetCreator
    {
        ...
        public static Task<GetCreatorResult> InvokeAsync(GetCreatorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCreatorResult>("azure-native:maps/v20211201preview:getCreator", args ?? new GetCreatorArgs(), options.WithVersion());

        /// <summary>
        /// An Azure resource which represents Maps Creator product and provides ability to manage private location data.
        /// </summary>
        public static Output<GetCreatorResult> Invoke(GetCreatorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCreatorResult>("azure-native:maps/v20211201preview:getCreator", args ?? new GetCreatorInvokeArgs(), options.WithVersion());
    }
