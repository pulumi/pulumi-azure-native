...
namespace Pulumi.AzureNative.Maps.V20210701Preview
{
    ...
    public partial class Creator : Pulumi.CustomResource
    {
        ...
        public Creator(string name, CreatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maps/v20210701preview:Creator", name, args ?? new CreatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Creator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maps/v20210701preview:Creator", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:maps/v20210701preview:Creator"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:maps/v20210201:Creator"},
                    new Pulumi.Alias { Type = "azure-nextgen:maps/v20210201:Creator"},
                    new Pulumi.Alias { Type = "azure-native:maps/v20211201preview:Creator"},
                    new Pulumi.Alias { Type = "azure-nextgen:maps/v20211201preview:Creator"},
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Creator Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
