...
namespace Pulumi.AzureNative.Maps.V20231201Preview
{
    public static class GetCreator
    {
        ...
        public static Task<GetCreatorResult> InvokeAsync(GetCreatorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCreatorResult>("azure-native:maps/v20231201preview:getCreator", args ?? new GetCreatorArgs(), options.WithDefaults());
