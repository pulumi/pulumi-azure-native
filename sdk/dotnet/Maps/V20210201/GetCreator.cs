...
namespace Pulumi.AzureNative.Maps.V20210201
{
    [Obsolete(@"azure-native:maps/v20210201:Creator is being removed in the next major version of this provider. Upgrade to at least azure-native:maps/v20211201preview:Creator to guarantee forwards compatibility.")]
    public static class GetCreator
    {
        ...
        public static Task<GetCreatorResult> InvokeAsync(GetCreatorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCreatorResult>("azure-native:maps/v20210201:getCreator", args ?? new GetCreatorArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Maps Creator resource.
        /// </summary>
        public static Output<GetCreatorResult> Invoke(GetCreatorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCreatorResult>("azure-native:maps/v20210201:getCreator", args ?? new GetCreatorInvokeArgs(), options.WithDefaults());
    }
