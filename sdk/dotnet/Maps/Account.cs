...
namespace Pulumi.AzureNextGen.Maps
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:maps:Account")]
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:maps:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:maps:Account", name, null, MakeResourceOptions(options, id))
        {
        }
