...
namespace Pulumi.AzureRM.Maps.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var creator = new AzureRM.Maps.Latest.Creator("creator", new AzureRM.Maps.Latest.CreatorArgs
    ///         {
    ...
    public partial class Creator : Pulumi.CustomResource
    {
        ...
        public Creator(string name, CreatorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:maps/latest:Creator", name, args ?? new CreatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Creator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:maps/latest:Creator", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:maps/v20200201preview:Creator"},
                },
            };
