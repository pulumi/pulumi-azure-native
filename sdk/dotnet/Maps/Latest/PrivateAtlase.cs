...
namespace Pulumi.AzureRM.Maps.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateAtlase = new AzureRM.Maps.Latest.PrivateAtlase("privateAtlase", new AzureRM.Maps.Latest.PrivateAtlaseArgs
    ///         {
    ...
    public partial class PrivateAtlase : Pulumi.CustomResource
    {
        ...
        public PrivateAtlase(string name, PrivateAtlaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:maps/latest:PrivateAtlase", name, args ?? new PrivateAtlaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateAtlase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:maps/latest:PrivateAtlase", name, null, MakeResourceOptions(options, id))
        {
        }
