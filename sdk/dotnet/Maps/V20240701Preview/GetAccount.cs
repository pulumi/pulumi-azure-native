...
namespace Pulumi.AzureNative.Maps.V20240701Preview
{
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azure-native:maps/v20240701preview:getAccount", args ?? new GetAccountArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Maps Account.
        /// </summary>
        public static Output<GetAccountResult> Invoke(GetAccountInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccountResult>("azure-native:maps/v20240701preview:getAccount", args ?? new GetAccountInvokeArgs(), options.WithDefaults());
