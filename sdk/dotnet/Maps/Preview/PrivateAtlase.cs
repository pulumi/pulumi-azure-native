...
namespace Pulumi.AzureRM.Maps.Preview
{
    /// <summary>
    ...
    public partial class PrivateAtlase : Pulumi.CustomResource
    {
        ...
        public PrivateAtlase(string name, PrivateAtlaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:maps/preview:PrivateAtlase", name, args ?? new PrivateAtlaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateAtlase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:maps/preview:PrivateAtlase", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:maps/v20200201preview:PrivateAtlase"},
                },
            };
