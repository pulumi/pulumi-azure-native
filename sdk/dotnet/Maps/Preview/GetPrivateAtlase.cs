...
namespace Pulumi.AzureRM.Maps.Preview
{
    public static class GetPrivateAtlase
    {
        public static Task<GetPrivateAtlaseResult> InvokeAsync(GetPrivateAtlaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateAtlaseResult>("azurerm:maps/preview:getPrivateAtlase", args ?? new GetPrivateAtlaseArgs(), options.WithVersion());
    }
    ...
    public sealed class GetPrivateAtlaseResult
    {
        ...
        /// </summary>
        public readonly Outputs.PrivateAtlasPropertiesResponseResult Properties;
        /// <summary>
        /// Resource tags.
        /// </summary>
        ...
        private GetPrivateAtlaseResult(
            ...
            Outputs.PrivateAtlasPropertiesResponseResult properties,
