...
namespace Pulumi.AzureNative.Maps.V20240101Preview
{
    public static class ListAccountSas
    {
        ...
        public static Task<ListAccountSasResult> InvokeAsync(ListAccountSasArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAccountSasResult>("azure-native:maps/v20240101preview:listAccountSas", args ?? new ListAccountSasArgs(), options.WithDefaults());
        ...
        public static Output<ListAccountSasResult> Invoke(ListAccountSasInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListAccountSasResult>("azure-native:maps/v20240101preview:listAccountSas", args ?? new ListAccountSasInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class ListAccountSasArgs : global::Pulumi.InvokeArgs
    {
        ...
        public Union<string, Pulumi.AzureNative.Maps.V20240101Preview.SigningKey> SigningKey { get; set; } = null!;
    ...
    public sealed class ListAccountSasInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("signingKey", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Maps.V20240101Preview.SigningKey> SigningKey { get; set; } = null!;
