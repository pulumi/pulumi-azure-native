...
namespace Pulumi.AzureNative.Maps.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:maps/v20240101preview:Creator")]
    public partial class Creator : global::Pulumi.CustomResource
    {
        ...
        public Creator(string name, CreatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maps/v20240101preview:Creator", name, args ?? new CreatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Creator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maps/v20240101preview:Creator", name, null, MakeResourceOptions(options, id))
        {
        }
