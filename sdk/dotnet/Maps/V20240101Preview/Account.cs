...
namespace Pulumi.AzureNative.Maps.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:maps/v20240101preview:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maps/v20240101preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maps/v20240101preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Maps.V20240101Preview.Kind>? Kind { get; set; }
