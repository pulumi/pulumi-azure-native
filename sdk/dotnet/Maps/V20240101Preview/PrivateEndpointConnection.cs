...
namespace Pulumi.AzureNative.Maps.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:maps/v20240101preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maps/v20240101preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maps/v20240101preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
