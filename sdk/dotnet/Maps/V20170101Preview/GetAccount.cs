...
namespace Pulumi.AzureRM.Maps.V20170101Preview
{
    public static class GetAccount
    {
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azurerm:maps/v20170101preview:getAccount", args ?? new GetAccountArgs(), options.WithVersion());
    }
