...
namespace Pulumi.AzureRM.Maps.V20170101Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var account = new AzureRM.Maps.V20170101Preview.Account("account", new AzureRM.Maps.V20170101Preview.AccountArgs
    ///         {
    ///             AccountName = "myMapsAccount",
    ///             Location = "global",
    ///             ResourceGroupName = "myResourceGroup",
    ///             Sku = new AzureRM.Maps.V20170101Preview.Inputs.SkuArgs
    ///             {
    ///                 Name = "S0",
    ///             },
    ///             Tags = 
    ...
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:maps/v20170101preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:maps/v20170101preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
