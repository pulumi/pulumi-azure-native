...
namespace Pulumi.AzureNextGen.Maps.V20170101Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:maps/v20170101preview:Account")]
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:maps/v20170101preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:maps/v20170101preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
