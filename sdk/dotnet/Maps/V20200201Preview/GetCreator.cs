...
namespace Pulumi.AzureNative.Maps.V20200201Preview
{
    public static class GetCreator
    {
        ...
        public static Task<GetCreatorResult> InvokeAsync(GetCreatorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCreatorResult>("azure-native:maps/v20200201preview:getCreator", args ?? new GetCreatorArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Maps Creator resource.
        /// </summary>
        public static Output<GetCreatorResult> Invoke(GetCreatorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCreatorResult>("azure-native:maps/v20200201preview:getCreator", args ?? new GetCreatorInvokeArgs(), options.WithDefaults());
    }
