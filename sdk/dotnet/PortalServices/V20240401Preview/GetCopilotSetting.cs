...
namespace Pulumi.AzureNative.PortalServices.V20240401Preview
{
    public static class GetCopilotSetting
    {
        ...
        public static Task<GetCopilotSettingResult> InvokeAsync(GetCopilotSettingArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCopilotSettingResult>("azure-native:portalservices/v20240401preview:getCopilotSetting", args ?? new GetCopilotSettingArgs(), options.WithDefaults());
