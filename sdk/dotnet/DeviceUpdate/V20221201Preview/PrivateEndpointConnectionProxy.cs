...
namespace Pulumi.AzureNative.DeviceUpdate.V20221201Preview
{
    ...
    public partial class PrivateEndpointConnectionProxy : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionProxy(string name, PrivateEndpointConnectionProxyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy", name, args ?? new PrivateEndpointConnectionProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy", name, null, MakeResourceOptions(options, id))
        {
        }
