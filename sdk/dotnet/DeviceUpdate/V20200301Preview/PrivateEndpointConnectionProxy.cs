...
namespace Pulumi.AzureNative.DeviceUpdate.V20200301Preview
{
    ...
    /// {
    ///     var privateEndpointConnectionProxy = new AzureNative.DeviceUpdate.V20200301Preview.PrivateEndpointConnectionProxy("privateEndpointConnectionProxy", new()
    ///     {
    ///         AccountName = "contoso",
    ///         PrivateEndpointConnectionProxyId = "peexample01",
    ///         RemotePrivateEndpoint = new AzureNative.DeviceUpdate.V20200301Preview.Inputs.RemotePrivateEndpointArgs
    ///         {
    ...
    ///             {
    ///                 new AzureNative.DeviceUpdate.V20200301Preview.Inputs.PrivateLinkServiceConnectionArgs
    ///                 {
    ///                     GroupIds = new[]
    ///                     {
    ///                         "DeviceUpdate",
    ...
    ///             {
    ///                 new AzureNative.DeviceUpdate.V20200301Preview.Inputs.PrivateLinkServiceProxyArgs
    ///                 {
