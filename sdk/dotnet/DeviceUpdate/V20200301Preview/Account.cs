...
namespace Pulumi.AzureNative.DeviceUpdate.V20200301Preview
{
    ...
    /// {
    ///     var account = new AzureNative.DeviceUpdate.V20200301Preview.Account("account", new()
    ///     {
    ///         AccountName = "contoso",
    ///         Location = "westus2",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceupdate/v20200301preview:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20200301preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20200301preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
