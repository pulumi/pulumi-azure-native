...
namespace Pulumi.AzureNative.DeviceUpdate.V20200301Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:deviceupdate/v20200301preview:Instance is being removed in the next major version of this provider. Upgrade to at least azure-native:deviceupdate/v20230701:Instance to guarantee forwards compatibility.")]
    ...
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20200301preview:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20200301preview:Instance", name, null, MakeResourceOptions(options, id))
        {
        }
