...
namespace Pulumi.AzureNative.DeviceUpdate.V20220401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:deviceupdate/v20220401preview:Account is being removed in the next major version of this provider. Please upgrade to azure-native:deviceupdate/v20221201preview:Account to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:deviceupdate/v20220401preview:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20220401preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20220401preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DeviceUpdate.V20220401Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        /// </summary>
        [Input("sku")]
        public InputUnion<string, Pulumi.AzureNative.DeviceUpdate.V20220401Preview.SKU>? Sku { get; set; }
