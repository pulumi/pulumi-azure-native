...
namespace Pulumi.AzureNative.DeviceUpdate.V20220401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:deviceupdate/v20220401preview:Instance is being removed in the next major version of this provider. Please upgrade to azure-native:deviceupdate/v20221201preview:Instance to guarantee forwards compatibility.")]
    ...
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20220401preview:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20220401preview:Instance", name, null, MakeResourceOptions(options, id))
        {
        }
