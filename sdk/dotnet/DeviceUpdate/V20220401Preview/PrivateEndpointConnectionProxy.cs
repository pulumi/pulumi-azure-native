...
namespace Pulumi.AzureNative.DeviceUpdate.V20220401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:deviceupdate/v20220401preview:PrivateEndpointConnectionProxy is being removed in the next major version of this provider. Upgrade to at least azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy to guarantee forwards compatibility.")]
    ...
    public partial class PrivateEndpointConnectionProxy : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionProxy(string name, PrivateEndpointConnectionProxyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20220401preview:PrivateEndpointConnectionProxy", name, args ?? new PrivateEndpointConnectionProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20220401preview:PrivateEndpointConnectionProxy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy"},
                },
            };
