...
namespace Pulumi.AzureNative.DeviceUpdate.V20221001
{
    public static class GetInstance
    {
        ...
        public static Task<GetInstanceResult> InvokeAsync(GetInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInstanceResult>("azure-native:deviceupdate/v20221001:getInstance", args ?? new GetInstanceArgs(), options.WithDefaults());

        /// <summary>
        /// Device Update instance details.
        /// </summary>
        public static Output<GetInstanceResult> Invoke(GetInstanceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetInstanceResult>("azure-native:deviceupdate/v20221001:getInstance", args ?? new GetInstanceInvokeArgs(), options.WithDefaults());
    }
