...
namespace Pulumi.AzureNative.DeviceUpdate.V20221001
{
    ...
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20221001:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20221001:Instance", name, null, MakeResourceOptions(options, id))
        {
        }
