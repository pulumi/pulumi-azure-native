...
namespace Pulumi.AzureNative.DeviceUpdate.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceupdate/v20230701:PrivateEndpointConnectionProxy")]
    public partial class PrivateEndpointConnectionProxy : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionProxy(string name, PrivateEndpointConnectionProxyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20230701:PrivateEndpointConnectionProxy", name, args ?? new PrivateEndpointConnectionProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20230701:PrivateEndpointConnectionProxy", name, null, MakeResourceOptions(options, id))
        {
        }
