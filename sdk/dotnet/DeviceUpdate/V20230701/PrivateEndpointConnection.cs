...
namespace Pulumi.AzureNative.DeviceUpdate.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceupdate/v20230701:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20230701:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceupdate/v20230701:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
