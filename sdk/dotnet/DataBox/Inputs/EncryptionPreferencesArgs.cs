...
namespace Pulumi.AzureNative.DataBox.Inputs
{
    ...
    public sealed class EncryptionPreferencesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBox.DoubleEncryption>? DoubleEncryption { get; set; }

        /// <summary>
        /// Defines Hardware level encryption (Only for disk)
        /// </summary>
        [Input("hardwareEncryption")]
        public InputUnion<string, Pulumi.AzureNative.DataBox.HardwareEncryption>? HardwareEncryption { get; set; }
