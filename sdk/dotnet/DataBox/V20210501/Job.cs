...
namespace Pulumi.AzureNative.DataBox.V20210501
{
    ...
    /// Job Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:databox/v20210501:Job")]
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databox/v20210501:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databox/v20210501:Job", name, null, MakeResourceOptions(options, id))
        {
        }
