...
namespace Pulumi.AzureNative.DataBox.V20210501
{
    public static class ListJobCredentials
    {
        ...
        public static Task<ListJobCredentialsResult> InvokeAsync(ListJobCredentialsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListJobCredentialsResult>("azure-native:databox/v20210501:listJobCredentials", args ?? new ListJobCredentialsArgs(), options.WithDefaults());

        /// <summary>
        /// This method gets the unencrypted secrets related to the job.
        /// </summary>
        public static Output<ListJobCredentialsResult> Invoke(ListJobCredentialsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListJobCredentialsResult>("azure-native:databox/v20210501:listJobCredentials", args ?? new ListJobCredentialsInvokeArgs(), options.WithDefaults());
    }
