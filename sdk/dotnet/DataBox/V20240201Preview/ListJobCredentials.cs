...
namespace Pulumi.AzureNative.DataBox.V20240201Preview
{
    public static class ListJobCredentials
    {
        ...
        public static Task<ListJobCredentialsResult> InvokeAsync(ListJobCredentialsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListJobCredentialsResult>("azure-native:databox/v20240201preview:listJobCredentials", args ?? new ListJobCredentialsArgs(), options.WithDefaults());
