...
namespace Pulumi.AzureNative.DataBox.V20220201
{
    ...
    /// Job Resource.
    /// </summary>
    [Obsolete(@"azure-native:databox/v20220201:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:databox/v20221201:Job to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:databox/v20220201:Job")]
    public partial class Job : global::Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databox/v20220201:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databox/v20220201:Job", name, null, MakeResourceOptions(options, id))
        {
        }
