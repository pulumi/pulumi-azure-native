...
namespace Pulumi.AzureNative.DataBox.V20250201
{
    ...
    public readonly struct ModelName : IEquatable<ModelName>
    {
        ...
        /// Data Box.
        /// </summary>
        public static ModelName DataBox { get; } = new ModelName("DataBox");
        /// <summary>
        /// Data Box Disk.
        /// </summary>
        public static ModelName DataBoxDisk { get; } = new ModelName("DataBoxDisk");
        /// <summary>
        /// Data Box Heavy.
        /// </summary>
        public static ModelName DataBoxHeavy { get; } = new ModelName("DataBoxHeavy");
        /// <summary>
        /// Data Box Customer Disk
        /// </summary>
        public static ModelName DataBoxCustomerDisk { get; } = new ModelName("DataBoxCustomerDisk");
        /// <summary>
        /// Data Box V2 with 125TB usable capacity.
        /// </summary>
        public static ModelName AzureDataBox120 { get; } = new ModelName("AzureDataBox120");
        /// <summary>
        /// Data Box V2 with 500TB usable capacity.
        /// </summary>
        public static ModelName AzureDataBox525 { get; } = new ModelName("AzureDataBox525");

        public static bool operator ==(ModelName left, ModelName right) => left.Equals(right);
        public static bool operator !=(ModelName left, ModelName right) => !left.Equals(right);

        public static explicit operator string(ModelName value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ModelName other && Equals(other);
        public bool Equals(ModelName other) => string.Equals(_value, other._value, StringComparison.Ordinal);
