...
namespace Pulumi.AzureNative.DataBox.V20240301Preview
{
    /// <summary>
    /// Job Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:databox/v20240301preview:Job")]
    public partial class Job : global::Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databox/v20240301preview:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databox/v20240301preview:Job", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:databox/v20240201preview:Job" },
                    new global::Pulumi.Alias { Type = "azure-native:databox/v20250201:Job" },
    ...
    public sealed class JobArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("deliveryType")]
        public InputUnion<string, Pulumi.AzureNative.DataBox.V20240301Preview.JobDeliveryType>? DeliveryType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBox.V20240301Preview.TransferType> TransferType { get; set; } = null!;
