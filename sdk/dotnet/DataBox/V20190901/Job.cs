...
namespace Pulumi.AzureRM.DataBox.V20190901
{
    ...
    public partial class Job : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("error")]
        public Output<Outputs.ErrorResponseResult> Error { get; private set; } = null!;
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databox/v20190901:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databox/v20190901:Job", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:databox/v20180101:Job"},
                },
            };
