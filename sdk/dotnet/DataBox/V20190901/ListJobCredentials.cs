...
namespace Pulumi.AzureNative.DataBox.V20190901
{
    public static class ListJobCredentials
    {
        ...
        public static Task<ListJobCredentialsResult> InvokeAsync(ListJobCredentialsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListJobCredentialsResult>("azure-native:databox/v20190901:listJobCredentials", args ?? new ListJobCredentialsArgs(), options.WithDefaults());

        /// <summary>
        /// List of unencrypted credentials for accessing device.
        /// </summary>
        public static Output<ListJobCredentialsResult> Invoke(ListJobCredentialsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListJobCredentialsResult>("azure-native:databox/v20190901:listJobCredentials", args ?? new ListJobCredentialsInvokeArgs(), options.WithDefaults());
    }
