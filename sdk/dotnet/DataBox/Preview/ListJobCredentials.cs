...
namespace Pulumi.AzureRM.DataBox.Preview
{
    public static class ListJobCredentials
    {
        public static Task<ListJobCredentialsResult> InvokeAsync(ListJobCredentialsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListJobCredentialsResult>("azurerm:databox/preview:listJobCredentials", args ?? new ListJobCredentialsArgs(), options.WithVersion());
    }
