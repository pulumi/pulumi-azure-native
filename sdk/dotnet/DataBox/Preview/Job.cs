...
namespace Pulumi.AzureRM.DataBox.Preview
{
    ...
    public partial class Job : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("details")]
        public Output<Outputs.JobDetailsResponseResult?> Details { get; private set; } = null!;
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databox/preview:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databox/preview:Job", name, null, MakeResourceOptions(options, id))
        {
        }
