...
namespace Pulumi.AzureRM.DataBox.V20180101
{
    public static class ListJobCredentials
    {
        public static Task<ListJobCredentialsResult> InvokeAsync(ListJobCredentialsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListJobCredentialsResult>("azurerm:databox/v20180101:listJobCredentials", args ?? new ListJobCredentialsArgs(), options.WithVersion());
    }
