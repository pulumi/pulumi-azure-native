...
namespace Pulumi.AzureNextGen.DataBox.V20180101
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct DataDestinationType : IEquatable<DataDestinationType>
    {
        private readonly string _value;

        private DataDestinationType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// Unknown type.
        /// </summary>
        public static DataDestinationType UnknownType { get; } = new DataDestinationType("UnknownType");
        /// <summary>
        /// Storage Accounts .
        /// </summary>
        public static DataDestinationType StorageAccount { get; } = new DataDestinationType("StorageAccount");
        /// <summary>
        /// Azure Managed disk storage.
        /// </summary>
        public static DataDestinationType ManagedDisk { get; } = new DataDestinationType("ManagedDisk");

        public static bool operator ==(DataDestinationType left, DataDestinationType right) => left.Equals(right);
        public static bool operator !=(DataDestinationType left, DataDestinationType right) => !left.Equals(right);

        public static explicit operator string(DataDestinationType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is DataDestinationType other && Equals(other);
        public bool Equals(DataDestinationType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
