...
namespace Pulumi.AzureRM.DataBox.V20200401
{
    public static class ListJobCredentials
    {
        public static Task<ListJobCredentialsResult> InvokeAsync(ListJobCredentialsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListJobCredentialsResult>("azurerm:databox/v20200401:listJobCredentials", args ?? new ListJobCredentialsArgs(), options.WithVersion());
    }
