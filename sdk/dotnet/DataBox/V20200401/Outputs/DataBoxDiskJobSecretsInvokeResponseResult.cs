...
namespace Pulumi.AzureNextGen.DataBox.V20200401.Outputs
{
    ...
    [OutputType]
    public sealed class DataBoxDiskJobSecretsInvokeResponseResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.DiskSecretInvokeResponseResult> DiskSecrets;
        /// <summary>
        ...
        [OutputConstructor]
        private DataBoxDiskJobSecretsInvokeResponseResult(
            Outputs.DcAccessSecurityCodeInvokeResponseResult dcAccessSecurityCode,

            ImmutableArray<Outputs.DiskSecretInvokeResponseResult> diskSecrets,
