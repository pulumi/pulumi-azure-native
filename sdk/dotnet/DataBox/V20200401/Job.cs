...
namespace Pulumi.AzureRM.DataBox.V20200401
{
    ...
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databox/v20200401:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databox/v20200401:Job", name, null, MakeResourceOptions(options, id))
        {
        }
