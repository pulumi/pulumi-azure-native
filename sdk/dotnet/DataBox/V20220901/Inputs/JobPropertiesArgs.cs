...
namespace Pulumi.AzureNative.DataBox.V20220901.Inputs
{
    ...
    public sealed class JobPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("deliveryType")]
        public InputUnion<string, Pulumi.AzureNative.DataBox.V20220901.JobDeliveryType>? DeliveryType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBox.V20220901.TransferType> TransferType { get; set; } = null!;
