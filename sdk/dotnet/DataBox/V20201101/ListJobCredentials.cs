...
namespace Pulumi.AzureNextGen.DataBox.V20201101
{
    public static class ListJobCredentials
    {
        public static Task<ListJobCredentialsResult> InvokeAsync(ListJobCredentialsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListJobCredentialsResult>("azure-nextgen:databox/v20201101:listJobCredentials", args ?? new ListJobCredentialsArgs(), options.WithVersion());
    }
