...
namespace Pulumi.AzureNative.DataBox.V20201101
{
    ...
    /// {
    ///     var job = new AzureNative.DataBox.V20201101.Job("job", new()
    ///     {
    ///         Details = new AzureNative.DataBox.V20201101.Inputs.DataBoxJobDetailsArgs
    ///         {
    ///             ContactDetails = new AzureNative.DataBox.V20201101.Inputs.ContactDetailsArgs
    ///             {
    ...
    ///             {
    ///                 new AzureNative.DataBox.V20201101.Inputs.DataImportDetailsArgs
    ///                 {
    ///                     AccountDetails = new AzureNative.DataBox.V20201101.Inputs.StorageAccountDetailsArgs
    ///                     {
    ...
    ///             ShippingAddress = new AzureNative.DataBox.V20201101.Inputs.ShippingAddressArgs
    ///             {
    ...
    ///         Sku = new AzureNative.DataBox.V20201101.Inputs.SkuArgs
    ///         {
    ///             Name = "DataBox",
    ///         },
    ...
    ///             },
    ///             JobDetailsType = "DataBox",
    ///             Preferences = new AzureNative.DataBox.V20201101.Inputs.PreferencesArgs
    ///             {
    ///                 EncryptionPreferences = new AzureNative.DataBox.V20201101.Inputs.EncryptionPreferencesArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureNative.DataBox.V20201101.Inputs.DataExportDetailsArgs
    ///                 {
    ///                     AccountDetails = new AzureNative.DataBox.V20201101.Inputs.StorageAccountDetailsArgs
    ///                     {
    ///                         DataAccountType = "StorageAccount",
    ...
    ///                     },
    ///                     TransferConfiguration = new AzureNative.DataBox.V20201101.Inputs.TransferConfigurationArgs
    ///                     {
    ///                         TransferAllDetails = new AzureNative.DataBox.V20201101.Inputs.TransferConfigurationTransferAllDetailsArgs
    ///                         {
    ///                             Include = new AzureNative.DataBox.V20201101.Inputs.TransferAllDetailsArgs
    ///                             {
    ///                                 DataAccountType = "StorageAccount",
    ...
    ///             },
    ///         },
    ///         Identity = new AzureNative.DataBox.V20201101.Inputs.ResourceIdentityArgs
    ///         {
    ///             Type = "UserAssigned",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:databox/v20201101:Job SdkJob5337 /subscriptions/fa68082f-8ff7-4a25-95c7-ce9da541242f/resourceGroups/SdkRg7552/providers/Microsoft.DataBox/jobs/SdkJob5337 
    /// ```
    /// </summary>
    ...
    public partial class Job : global::Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databox/v20201101:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databox/v20201101:Job", name, null, MakeResourceOptions(options, id))
        {
        }
