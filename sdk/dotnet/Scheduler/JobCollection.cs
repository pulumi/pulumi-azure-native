...
namespace Pulumi.AzureNative.Scheduler
{
    ...
    public partial class JobCollection : global::Pulumi.CustomResource
    {
        ...
        public JobCollection(string name, JobCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scheduler:JobCollection", name, args ?? new JobCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scheduler:JobCollection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_scheduler_v20140801preview:scheduler:JobCollection" },
                    new global::Pulumi.Alias { Type = "azure-native_scheduler_v20160101:scheduler:JobCollection" },
                    new global::Pulumi.Alias { Type = "azure-native_scheduler_v20160301:scheduler:JobCollection" },
                },
            };
    ...
    public sealed class JobCollectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.JobCollectionPropertiesArgs>? Properties { get; set; }
