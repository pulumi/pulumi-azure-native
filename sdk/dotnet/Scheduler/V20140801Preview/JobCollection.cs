...
namespace Pulumi.AzureNative.Scheduler.V20140801Preview
{
    ...
    [AzureNativeResourceType("azure-native:scheduler/v20140801preview:JobCollection")]
    public partial class JobCollection : Pulumi.CustomResource
    {
        ...
        public JobCollection(string name, JobCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scheduler/v20140801preview:JobCollection", name, args ?? new JobCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scheduler/v20140801preview:JobCollection", name, null, MakeResourceOptions(options, id))
        {
        }
