...
{
    [AzureNextGenResourceType("azure-nextgen:scheduler/v20140801preview:Job")]
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:scheduler/v20140801preview:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:scheduler/v20140801preview:Job", name, null, MakeResourceOptions(options, id))
        {
        }
