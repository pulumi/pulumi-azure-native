...
namespace Pulumi.AzureRM.Scheduler.Inputs
{
    ...
    public sealed class JobRecurrenceScheduleResponseGetArgs : Pulumi.ResourceArgs
    {
        [Input("hours")]
        ...
        private InputList<Inputs.JobRecurrenceScheduleMonthlyOccurrenceResponseGetArgs>? _monthlyOccurrences;

        /// <summary>
        /// Gets or sets the occurrences of days within a month.
        /// </summary>
        public InputList<Inputs.JobRecurrenceScheduleMonthlyOccurrenceResponseGetArgs> MonthlyOccurrences
        {
            get => _monthlyOccurrences ?? (_monthlyOccurrences = new InputList<Inputs.JobRecurrenceScheduleMonthlyOccurrenceResponseGetArgs>());
        ...
        public JobRecurrenceScheduleResponseGetArgs()
        {
        }
    }
}
