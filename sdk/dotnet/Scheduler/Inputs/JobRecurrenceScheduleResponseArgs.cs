...
namespace Pulumi.AzureRM.Scheduler.Inputs
{
    ...
    public sealed class JobRecurrenceScheduleResponseArgs : Pulumi.ResourceArgs
    {
        [Input("hours")]
        ...
        private InputList<Inputs.JobRecurrenceScheduleMonthlyOccurrenceResponseArgs>? _monthlyOccurrences;

        /// <summary>
        /// Gets or sets the occurrences of days within a month.
        /// </summary>
        public InputList<Inputs.JobRecurrenceScheduleMonthlyOccurrenceResponseArgs> MonthlyOccurrences
        {
            get => _monthlyOccurrences ?? (_monthlyOccurrences = new InputList<Inputs.JobRecurrenceScheduleMonthlyOccurrenceResponseArgs>());
        ...
        public JobRecurrenceScheduleResponseArgs()
        {
        }
    }
}
