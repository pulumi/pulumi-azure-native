...
namespace Pulumi.AzureNative.Scheduler.V20160101
{
    ...
    [AzureNativeResourceType("azure-native:scheduler/v20160101:Job")]
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scheduler/v20160101:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scheduler/v20160101:Job", name, null, MakeResourceOptions(options, id))
        {
        }
