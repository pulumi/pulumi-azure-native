...
namespace Pulumi.AzureNative.Scheduler.V20160101
{
    ...
    public static class GetJobCollection
    {
        public static Task<GetJobCollectionResult> InvokeAsync(GetJobCollectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJobCollectionResult>("azure-native:scheduler/v20160101:getJobCollection", args ?? new GetJobCollectionArgs(), options.WithDefaults());

        public static Output<GetJobCollectionResult> Invoke(GetJobCollectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetJobCollectionResult>("azure-native:scheduler/v20160101:getJobCollection", args ?? new GetJobCollectionInvokeArgs(), options.WithDefaults());
    }
