...
namespace Pulumi.AzureNative.Scheduler.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:scheduler:Job'.")]
    [AzureNativeResourceType("azure-native:scheduler/latest:Job")]
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scheduler/latest:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scheduler/latest:Job", name, null, MakeResourceOptions(options, id))
        {
        }
