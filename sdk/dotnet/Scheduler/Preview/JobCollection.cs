...
namespace Pulumi.AzureRM.Scheduler.Preview
{
    public partial class JobCollection : Pulumi.CustomResource
    {
        ...
        public JobCollection(string name, JobCollectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:scheduler/preview:JobCollection", name, args ?? new JobCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:scheduler/preview:JobCollection", name, null, MakeResourceOptions(options, id))
        {
        }
