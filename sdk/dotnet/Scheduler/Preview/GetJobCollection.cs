...
namespace Pulumi.AzureRM.Scheduler.Preview
{
    public static class GetJobCollection
    {
        public static Task<GetJobCollectionResult> InvokeAsync(GetJobCollectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJobCollectionResult>("azurerm:scheduler/preview:getJobCollection", args ?? new GetJobCollectionArgs(), options.WithVersion());
    }
