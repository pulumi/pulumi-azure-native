...
namespace Pulumi.AzureNative.Discovery
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:discovery:NodePool")]
    public partial class NodePool : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.NodePoolPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public NodePool(string name, NodePoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:discovery:NodePool", name, args ?? new NodePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:discovery:NodePool", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:discovery/v20260201preview:NodePool" },
                    new global::Pulumi.Alias { Type = "azure-native:discovery/v20260601:NodePool" },
                },
            };
    ...
    public sealed class NodePoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.NodePoolPropertiesArgs>? Properties { get; set; }
