...
namespace Pulumi.AzureRM.AAD.V20170101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var domainService = new AzureRM.AAD.V20170101.DomainService("domainService", new AzureRM.AAD.V20170101.DomainServiceArgs
    ///         {
    ///             DomainName = "zdomain.zforest.com",
    ///             DomainSecuritySettings = new AzureRM.AAD.V20170101.Inputs.DomainSecuritySettingsArgs
    ///             {
    ///                 NtlmV1 = "Enabled",
    ...
    ///             LdapsSettings = new AzureRM.AAD.V20170101.Inputs.LdapsSettingsArgs
    ///             {
    ...
    ///             },
    ///             Location = "westus",
    ///             NotificationSettings = new AzureRM.AAD.V20170101.Inputs.NotificationSettingsArgs
    ///             {
    ...
    public partial class DomainService : Pulumi.CustomResource
    {
        ...
        public DomainService(string name, DomainServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:aad/v20170101:DomainService", name, args ?? new DomainServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:aad/v20170101:DomainService", name, null, MakeResourceOptions(options, id))
        {
        }
