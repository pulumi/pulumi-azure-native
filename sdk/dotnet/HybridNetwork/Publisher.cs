...
namespace Pulumi.AzureNative.HybridNetwork
{
    ...
    public partial class Publisher : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.PublisherPropertiesFormatResponse> Properties { get; private set; } = null!;
        ...
        public Publisher(string name, PublisherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork:Publisher", name, args ?? new PublisherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Publisher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork:Publisher", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:hybridnetwork/v20230901:Publisher" },
                    new global::Pulumi.Alias { Type = "azure-native:hybridnetwork/v20240415:Publisher" },
                    new global::Pulumi.Alias { Type = "azure-native_hybridnetwork_v20230901:hybridnetwork:Publisher" },
                    new global::Pulumi.Alias { Type = "azure-native_hybridnetwork_v20240415:hybridnetwork:Publisher" },
                },
            };
    ...
    public sealed class PublisherArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.PublisherPropertiesFormatArgs>? Properties { get; set; }
