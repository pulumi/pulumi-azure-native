...
namespace Pulumi.AzureNative.HybridNetwork.V20240415
{
    public static class ListArtifactManifestCredential
    {
        ...
        public static Task<ListArtifactManifestCredentialResult> InvokeAsync(ListArtifactManifestCredentialArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListArtifactManifestCredentialResult>("azure-native:hybridnetwork/v20240415:listArtifactManifestCredential", args ?? new ListArtifactManifestCredentialArgs(), options.WithDefaults());
        ...
        public static Output<ListArtifactManifestCredentialResult> Invoke(ListArtifactManifestCredentialInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListArtifactManifestCredentialResult>("azure-native:hybridnetwork/v20240415:listArtifactManifestCredential", args ?? new ListArtifactManifestCredentialInvokeArgs(), options.WithDefaults());
    }
