...
namespace Pulumi.AzureNative.HybridNetwork.V20240415
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridnetwork/v20240415:NetworkFunction")]
    public partial class NetworkFunction : global::Pulumi.CustomResource
    {
        ...
        public NetworkFunction(string name, NetworkFunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20240415:NetworkFunction", name, args ?? new NetworkFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20240415:NetworkFunction", name, null, MakeResourceOptions(options, id))
        {
        }
