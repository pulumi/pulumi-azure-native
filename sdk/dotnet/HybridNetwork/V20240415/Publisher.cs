...
namespace Pulumi.AzureNative.HybridNetwork.V20240415
{
    ...
    /// publisher resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridnetwork/v20240415:Publisher")]
    public partial class Publisher : global::Pulumi.CustomResource
    {
        ...
        public Publisher(string name, PublisherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20240415:Publisher", name, args ?? new PublisherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Publisher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20240415:Publisher", name, null, MakeResourceOptions(options, id))
        {
        }
