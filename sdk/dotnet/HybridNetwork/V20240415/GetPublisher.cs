...
namespace Pulumi.AzureNative.HybridNetwork.V20240415
{
    public static class GetPublisher
    {
        ...
        public static Task<GetPublisherResult> InvokeAsync(GetPublisherArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPublisherResult>("azure-native:hybridnetwork/v20240415:getPublisher", args ?? new GetPublisherArgs(), options.WithDefaults());
