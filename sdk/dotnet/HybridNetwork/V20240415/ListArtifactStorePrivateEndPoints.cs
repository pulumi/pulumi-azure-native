...
namespace Pulumi.AzureNative.HybridNetwork.V20240415
{
    public static class ListArtifactStorePrivateEndPoints
    {
        ...
        public static Task<ListArtifactStorePrivateEndPointsResult> InvokeAsync(ListArtifactStorePrivateEndPointsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListArtifactStorePrivateEndPointsResult>("azure-native:hybridnetwork/v20240415:listArtifactStorePrivateEndPoints", args ?? new ListArtifactStorePrivateEndPointsArgs(), options.WithDefaults());
