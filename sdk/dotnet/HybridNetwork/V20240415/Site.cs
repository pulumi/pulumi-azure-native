...
namespace Pulumi.AzureNative.HybridNetwork.V20240415
{
    ...
    /// Site resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridnetwork/v20240415:Site")]
    public partial class Site : global::Pulumi.CustomResource
    {
        ...
        public Site(string name, SiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20240415:Site", name, args ?? new SiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Site(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20240415:Site", name, null, MakeResourceOptions(options, id))
        {
        }
