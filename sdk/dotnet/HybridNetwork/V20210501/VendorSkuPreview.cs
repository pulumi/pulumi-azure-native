...
namespace Pulumi.AzureNative.HybridNetwork.V20210501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:hybridnetwork/v20210501:VendorSkuPreview is being removed in the next major version of this provider. Please upgrade to azure-native:hybridnetwork/v20220101preview:VendorSkuPreview to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:hybridnetwork/v20210501:VendorSkuPreview")]
    public partial class VendorSkuPreview : global::Pulumi.CustomResource
    {
        ...
        public VendorSkuPreview(string name, VendorSkuPreviewArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20210501:VendorSkuPreview", name, args ?? new VendorSkuPreviewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VendorSkuPreview(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20210501:VendorSkuPreview", name, null, MakeResourceOptions(options, id))
        {
        }
