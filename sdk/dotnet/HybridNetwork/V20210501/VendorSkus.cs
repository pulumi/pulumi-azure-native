...
namespace Pulumi.AzureNative.HybridNetwork.V20210501
{
    ...
    /// Sku sub resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridnetwork/v20210501:VendorSkus")]
    public partial class VendorSkus : global::Pulumi.CustomResource
    {
        ...
        public VendorSkus(string name, VendorSkusArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20210501:VendorSkus", name, args ?? new VendorSkusArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VendorSkus(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20210501:VendorSkus", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VendorSkusArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.HybridNetwork.V20210501.SkuDeploymentMode>? DeploymentMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.HybridNetwork.V20210501.NetworkFunctionType>? NetworkFunctionType { get; set; }
        ...
        /// </summary>
        [Input("skuType")]
        public InputUnion<string, Pulumi.AzureNative.HybridNetwork.V20210501.SkuType>? SkuType { get; set; }
