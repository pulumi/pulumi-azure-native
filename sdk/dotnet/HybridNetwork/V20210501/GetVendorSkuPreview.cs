...
namespace Pulumi.AzureNative.HybridNetwork.V20210501
{
    ...
    public static class GetVendorSkuPreview
    {
        ...
        public static Task<GetVendorSkuPreviewResult> InvokeAsync(GetVendorSkuPreviewArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVendorSkuPreviewResult>("azure-native:hybridnetwork/v20210501:getVendorSkuPreview", args ?? new GetVendorSkuPreviewArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the preview information of a vendor sku.
        /// </summary>
        public static Output<GetVendorSkuPreviewResult> Invoke(GetVendorSkuPreviewInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVendorSkuPreviewResult>("azure-native:hybridnetwork/v20210501:getVendorSkuPreview", args ?? new GetVendorSkuPreviewInvokeArgs(), options.WithDefaults());
    }
