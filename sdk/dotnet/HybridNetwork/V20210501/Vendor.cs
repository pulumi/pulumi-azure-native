...
namespace Pulumi.AzureNative.HybridNetwork.V20210501
{
    ...
    [AzureNativeResourceType("azure-native:hybridnetwork/v20210501:Vendor")]
    public partial class Vendor : global::Pulumi.CustomResource
    {
        ...
        public Vendor(string name, VendorArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20210501:Vendor", name, args ?? new VendorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vendor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20210501:Vendor", name, null, MakeResourceOptions(options, id))
        {
        }
