...
namespace Pulumi.AzureNative.HybridNetwork.V20230901
{
    ...
    /// publisher resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridnetwork/v20230901:Publisher")]
    public partial class Publisher : global::Pulumi.CustomResource
    {
        ...
        public Publisher(string name, PublisherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20230901:Publisher", name, args ?? new PublisherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Publisher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20230901:Publisher", name, null, MakeResourceOptions(options, id))
        {
        }
