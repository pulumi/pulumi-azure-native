...
namespace Pulumi.AzureNative.HybridNetwork.V20230901
{
    ...
    /// Site resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridnetwork/v20230901:Site")]
    public partial class Site : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SitePropertiesFormatResponse> Properties { get; private set; } = null!;
        ...
        public Site(string name, SiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20230901:Site", name, args ?? new SiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Site(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20230901:Site", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:hybridnetwork:Site" },
                },
            };
    ...
    public sealed class SiteArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.SitePropertiesFormatArgs>? Properties { get; set; }
