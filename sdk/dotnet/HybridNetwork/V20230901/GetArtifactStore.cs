...
namespace Pulumi.AzureNative.HybridNetwork.V20230901
{
    public static class GetArtifactStore
    {
        ...
        public static Task<GetArtifactStoreResult> InvokeAsync(GetArtifactStoreArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetArtifactStoreResult>("azure-native:hybridnetwork/v20230901:getArtifactStore", args ?? new GetArtifactStoreArgs(), options.WithDefaults());
