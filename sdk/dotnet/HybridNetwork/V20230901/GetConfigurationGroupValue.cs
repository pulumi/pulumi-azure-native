...
namespace Pulumi.AzureNative.HybridNetwork.V20230901
{
    public static class GetConfigurationGroupValue
    {
        ...
        public static Task<GetConfigurationGroupValueResult> InvokeAsync(GetConfigurationGroupValueArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConfigurationGroupValueResult>("azure-native:hybridnetwork/v20230901:getConfigurationGroupValue", args ?? new GetConfigurationGroupValueArgs(), options.WithDefaults());
