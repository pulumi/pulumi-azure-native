...
namespace Pulumi.AzureNative.HybridNetwork.V20230901
{
    public static class GetPublisher
    {
        ...
        public static Task<GetPublisherResult> InvokeAsync(GetPublisherArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPublisherResult>("azure-native:hybridnetwork/v20230901:getPublisher", args ?? new GetPublisherArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about the specified publisher.
        /// </summary>
        public static Output<GetPublisherResult> Invoke(GetPublisherInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPublisherResult>("azure-native:hybridnetwork/v20230901:getPublisher", args ?? new GetPublisherInvokeArgs(), options.WithDefaults());
    }
