...
namespace Pulumi.AzureNative.HybridNetwork.V20230901
{
    public static class GetSite
    {
        ...
        public static Task<GetSiteResult> InvokeAsync(GetSiteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSiteResult>("azure-native:hybridnetwork/v20230901:getSite", args ?? new GetSiteArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about the specified network site.
        /// </summary>
        public static Output<GetSiteResult> Invoke(GetSiteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSiteResult>("azure-native:hybridnetwork/v20230901:getSite", args ?? new GetSiteInvokeArgs(), options.WithDefaults());
