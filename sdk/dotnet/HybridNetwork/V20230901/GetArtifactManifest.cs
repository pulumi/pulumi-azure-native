...
namespace Pulumi.AzureNative.HybridNetwork.V20230901
{
    public static class GetArtifactManifest
    {
        ...
        public static Task<GetArtifactManifestResult> InvokeAsync(GetArtifactManifestArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetArtifactManifestResult>("azure-native:hybridnetwork/v20230901:getArtifactManifest", args ?? new GetArtifactManifestArgs(), options.WithDefaults());
