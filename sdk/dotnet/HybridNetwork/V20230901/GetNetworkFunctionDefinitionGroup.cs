...
namespace Pulumi.AzureNative.HybridNetwork.V20230901
{
    public static class GetNetworkFunctionDefinitionGroup
    {
        ...
        public static Task<GetNetworkFunctionDefinitionGroupResult> InvokeAsync(GetNetworkFunctionDefinitionGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkFunctionDefinitionGroupResult>("azure-native:hybridnetwork/v20230901:getNetworkFunctionDefinitionGroup", args ?? new GetNetworkFunctionDefinitionGroupArgs(), options.WithDefaults());
