...
namespace Pulumi.AzureRM.HybridNetwork.Preview
{
    ...
    public partial class Vendor : Pulumi.CustomResource
    {
        ...
        public Vendor(string name, VendorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/preview:Vendor", name, args ?? new VendorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vendor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/preview:Vendor", name, null, MakeResourceOptions(options, id))
        {
        }
