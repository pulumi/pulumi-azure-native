...
namespace Pulumi.AzureRM.HybridNetwork.Preview
{
    ...
    public partial class VirtualNetworkFunction : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkFunction(string name, VirtualNetworkFunctionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/preview:VirtualNetworkFunction", name, args ?? new VirtualNetworkFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/preview:VirtualNetworkFunction", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:hybridnetwork/v20200101preview:VirtualNetworkFunction"},
                },
            };
