...
namespace Pulumi.AzureRM.HybridNetwork.Preview
{
    public static class GetVendorSkuPreview
    {
        public static Task<GetVendorSkuPreviewResult> InvokeAsync(GetVendorSkuPreviewArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVendorSkuPreviewResult>("azurerm:hybridnetwork/preview:getVendorSkuPreview", args ?? new GetVendorSkuPreviewArgs(), options.WithVersion());
    }
