...
namespace Pulumi.AzureRM.HybridNetwork.Preview
{
    ...
    public partial class VendorSkuPreview : Pulumi.CustomResource
    {
        ...
        public VendorSkuPreview(string name, VendorSkuPreviewArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/preview:VendorSkuPreview", name, args ?? new VendorSkuPreviewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VendorSkuPreview(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/preview:VendorSkuPreview", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:hybridnetwork/v20200101preview:VendorSkuPreview"},
                },
            };
