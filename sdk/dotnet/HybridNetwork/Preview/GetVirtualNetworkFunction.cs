...
namespace Pulumi.AzureRM.HybridNetwork.Preview
{
    public static class GetVirtualNetworkFunction
    {
        public static Task<GetVirtualNetworkFunctionResult> InvokeAsync(GetVirtualNetworkFunctionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkFunctionResult>("azurerm:hybridnetwork/preview:getVirtualNetworkFunction", args ?? new GetVirtualNetworkFunctionArgs(), options.WithVersion());
    }
