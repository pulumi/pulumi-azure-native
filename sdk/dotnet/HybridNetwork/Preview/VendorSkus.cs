...
namespace Pulumi.AzureRM.HybridNetwork.Preview
{
    ...
    public partial class VendorSkus : Pulumi.CustomResource
    {
        ...
        public VendorSkus(string name, VendorSkusArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/preview:VendorSkus", name, args ?? new VendorSkusArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VendorSkus(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/preview:VendorSkus", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:hybridnetwork/v20200101preview:VendorSkus"},
                },
            };
