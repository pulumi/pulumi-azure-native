...
namespace Pulumi.AzureNative.HybridNetwork.V20220101Preview
{
    ...
    /// {
    ///     var vendor = new AzureNative.HybridNetwork.V20220101Preview.Vendor("vendor", new()
    ///     {
    ...
    public partial class Vendor : global::Pulumi.CustomResource
    {
        ...
        public Vendor(string name, VendorArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20220101preview:Vendor", name, args ?? new VendorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vendor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20220101preview:Vendor", name, null, MakeResourceOptions(options, id))
        {
        }
