...
namespace Pulumi.AzureNative.HybridNetwork.V20220101Preview
{
    ...
    /// {
    ///     var networkFunction = new AzureNative.HybridNetwork.V20220101Preview.NetworkFunction("networkFunction", new()
    ///     {
    ///         Device = new AzureNative.HybridNetwork.V20220101Preview.Inputs.SubResourceArgs
    ///         {
    ...
    ///         {
    ///             new AzureNative.HybridNetwork.V20220101Preview.Inputs.NetworkFunctionUserConfigurationArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridnetwork/v20220101preview:NetworkFunction")]
    public partial class NetworkFunction : global::Pulumi.CustomResource
    {
        ...
        public NetworkFunction(string name, NetworkFunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20220101preview:NetworkFunction", name, args ?? new NetworkFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20220101preview:NetworkFunction", name, null, MakeResourceOptions(options, id))
        {
        }
