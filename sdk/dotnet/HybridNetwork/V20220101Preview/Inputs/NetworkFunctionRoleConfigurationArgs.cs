...
namespace Pulumi.AzureNative.HybridNetwork.V20220101Preview.Inputs
{
    ...
    public sealed class NetworkFunctionRoleConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("roleType")]
        public InputUnion<string, Pulumi.AzureNative.HybridNetwork.V20220101Preview.NetworkFunctionRoleConfigurationType>? RoleType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.HybridNetwork.V20220101Preview.VirtualMachineSizeTypes>? VirtualMachineSize { get; set; }
