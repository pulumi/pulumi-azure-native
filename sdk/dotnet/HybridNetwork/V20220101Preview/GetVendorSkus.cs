...
namespace Pulumi.AzureNative.HybridNetwork.V20220101Preview
{
    public static class GetVendorSkus
    {
        ...
        public static Task<GetVendorSkusResult> InvokeAsync(GetVendorSkusArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVendorSkusResult>("azure-native:hybridnetwork/v20220101preview:getVendorSkus", args ?? new GetVendorSkusArgs(), options.WithDefaults());

        /// <summary>
        /// Sku sub resource.
        /// </summary>
        public static Output<GetVendorSkusResult> Invoke(GetVendorSkusInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVendorSkusResult>("azure-native:hybridnetwork/v20220101preview:getVendorSkus", args ?? new GetVendorSkusInvokeArgs(), options.WithDefaults());
    }
