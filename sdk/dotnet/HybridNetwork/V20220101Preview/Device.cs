...
namespace Pulumi.AzureNative.HybridNetwork.V20220101Preview
{
    ...
    /// {
    ///     var device = new AzureNative.HybridNetwork.V20220101Preview.Device("device", new()
    ///     {
    ...
    public partial class Device : global::Pulumi.CustomResource
    {
        ...
        public Device(string name, DeviceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20220101preview:Device", name, args ?? new DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Device(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridnetwork/v20220101preview:Device", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeviceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.HybridNetwork.V20220101Preview.DeviceType> DeviceType { get; set; } = null!;
