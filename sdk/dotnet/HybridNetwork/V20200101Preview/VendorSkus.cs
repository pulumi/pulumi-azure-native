...
namespace Pulumi.AzureNative.HybridNetwork.V20200101Preview
{
    ...
    /// {
    ///     var vendorSkus = new AzureNative.HybridNetwork.V20200101Preview.VendorSkus("vendorSkus", new()
    ///     {
    ///         DeploymentMode = "PrivateEdgeZone",
    ///         ManagedApplicationTemplate = null,
    ///         NetworkFunctionTemplate = new AzureNative.HybridNetwork.V20200101Preview.Inputs.NetworkFunctionTemplateArgs
    ///         {
    ///             NetworkFunctionRoleConfigurations = new[]
    ///             {
    ///                 new AzureNative.HybridNetwork.V20200101Preview.Inputs.NetworkFunctionRoleConfigurationArgs
    ///                 {
    ///                     CustomProfile = new AzureNative.HybridNetwork.V20200101Preview.Inputs.CustomProfileArgs
    ///                     {
    ...
    ///                         },
    ///                     },
    ///                     OsProfile = new AzureNative.HybridNetwork.V20200101Preview.Inputs.OsProfileArgs
    ///                     {
    ///                         AdminUsername = "dummyuser",
    ///                         CustomData = "base-64 encoded string of custom data",
    ///                         LinuxConfiguration = new AzureNative.HybridNetwork.V20200101Preview.Inputs.LinuxConfigurationArgs
    ///                         {
    ///                             Ssh = new AzureNative.HybridNetwork.V20200101Preview.Inputs.SshConfigurationArgs
    ///                             {
    ///                                 PublicKeys = new[]
    ///                                 {
    ///                                     new AzureNative.HybridNetwork.V20200101Preview.Inputs.SshPublicKeyArgs
    ///                                     {
    ...
    ///                     StorageProfile = new AzureNative.HybridNetwork.V20200101Preview.Inputs.StorageProfileArgs
    ///                     {
    ///                         DataDisks = new[]
    ///                         {
    ///                             new AzureNative.HybridNetwork.V20200101Preview.Inputs.DataDiskArgs
    ///                             {
    ///                                 CreateOption = "Empty",
    ///                                 DiskSizeGB = 10,
    ///                                 Name = "DataDisk1",
    ///                             },
    ///                         },
    ///                         ImageReference = new AzureNative.HybridNetwork.V20200101Preview.Inputs.ImageReferenceArgs
    ///                         {
    ///                             Offer = "UbuntuServer",
    ///                             Publisher = "Canonical",
    ///                             Sku = "18.04-LTS",
    ...
    ///                         },
    ///                         OsDisk = new AzureNative.HybridNetwork.V20200101Preview.Inputs.OsDiskArgs
    ///                         {
    ///                             DiskSizeGB = 30,
    ///                             Name = "vhdName",
    ///                             OsType = "Linux",
    ///                             Vhd = new AzureNative.HybridNetwork.V20200101Preview.Inputs.VirtualHardDiskArgs
    ///                             {
