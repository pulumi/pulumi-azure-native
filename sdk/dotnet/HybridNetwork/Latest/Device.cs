...
namespace Pulumi.AzureRM.HybridNetwork.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var device = new AzureRM.HybridNetwork.Latest.Device("device", new AzureRM.HybridNetwork.Latest.DeviceArgs
    ///         {
    ///             AzureStackEdge = new AzureRM.HybridNetwork.Latest.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class Device : Pulumi.CustomResource
    {
        ...
        public Device(string name, DeviceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/latest:Device", name, args ?? new DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Device(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/latest:Device", name, null, MakeResourceOptions(options, id))
        {
        }
