...
namespace Pulumi.AzureRM.HybridNetwork.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkFunction = new AzureRM.HybridNetwork.Latest.VirtualNetworkFunction("virtualNetworkFunction", new AzureRM.HybridNetwork.Latest.VirtualNetworkFunctionArgs
    ///         {
    ///             Device = new AzureRM.HybridNetwork.Latest.Inputs.SubResourceArgs
    ///             {
    ...
    ///             {
    ///                 new AzureRM.HybridNetwork.Latest.Inputs.VirtualNetworkFunctionUserConfigurationArgs
    ///                 {
    ///                     NetworkInterfaces = 
    ///                     {
    ...
    public partial class VirtualNetworkFunction : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkFunction(string name, VirtualNetworkFunctionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/latest:VirtualNetworkFunction", name, args ?? new VirtualNetworkFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/latest:VirtualNetworkFunction", name, null, MakeResourceOptions(options, id))
        {
        }
