...
namespace Pulumi.AzureRM.HybridNetwork.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vendorSkuPreview = new AzureRM.HybridNetwork.Latest.VendorSkuPreview("vendorSkuPreview", new AzureRM.HybridNetwork.Latest.VendorSkuPreviewArgs
    ///         {
    ...
    public partial class VendorSkuPreview : Pulumi.CustomResource
    {
        ...
        public VendorSkuPreview(string name, VendorSkuPreviewArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/latest:VendorSkuPreview", name, args ?? new VendorSkuPreviewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VendorSkuPreview(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/latest:VendorSkuPreview", name, null, MakeResourceOptions(options, id))
        {
        }
