...
namespace Pulumi.AzureRM.HybridNetwork.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vendorSkus = new AzureRM.HybridNetwork.Latest.VendorSkus("vendorSkus", new AzureRM.HybridNetwork.Latest.VendorSkusArgs
    ///         {
    ...
    ///             VirtualNetworkFunctionTemplate = new AzureRM.HybridNetwork.Latest.Inputs.VirtualNetworkFunctionTemplateArgs
    ///             {
    ///                 VirutalNetworkFunctionRoleConfigurations = 
    ///                 {
    ///                     new AzureRM.HybridNetwork.Latest.Inputs.VirtualNetworkFunctionRoleConfigurationArgs
    ///                     {
    ///                         ImageReference = new AzureRM.HybridNetwork.Latest.Inputs.ImageReferenceArgs
    ///                         {
    ///                             OsType = "Linux",
    ...
    ///                         NetworkInterfaces = 
    ///                         {
    ///                             new AzureRM.HybridNetwork.Latest.Inputs.NetworkInterfaceArgs
    ///                             {
    ///                                 IpConfigurations = 
    ///                                 {
    ///                                     new AzureRM.HybridNetwork.Latest.Inputs.NetworkInterfaceIPConfigurationArgs
    ///                                     {
    ///                                         Gateway = "",
    ///                                         IpAddress = "",
    ...
    ///                             },
    ///                         },
    ///                         OsProfile = new AzureRM.HybridNetwork.Latest.Inputs.OsProfileArgs
    ///                         {
    ...
    public partial class VendorSkus : Pulumi.CustomResource
    {
        ...
        public VendorSkus(string name, VendorSkusArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/latest:VendorSkus", name, args ?? new VendorSkusArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VendorSkus(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/latest:VendorSkus", name, null, MakeResourceOptions(options, id))
        {
        }
