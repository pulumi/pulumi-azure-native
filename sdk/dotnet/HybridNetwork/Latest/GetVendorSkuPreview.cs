...
namespace Pulumi.AzureRM.HybridNetwork.Latest
{
    public static class GetVendorSkuPreview
    {
        public static Task<GetVendorSkuPreviewResult> InvokeAsync(GetVendorSkuPreviewArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVendorSkuPreviewResult>("azurerm:hybridnetwork/latest:getVendorSkuPreview", args ?? new GetVendorSkuPreviewArgs(), options.WithVersion());
    }
