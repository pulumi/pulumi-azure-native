...
namespace Pulumi.AzureRM.HybridNetwork.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vendor = new AzureRM.HybridNetwork.Latest.Vendor("vendor", new AzureRM.HybridNetwork.Latest.VendorArgs
    ///         {
    ...
    public partial class Vendor : Pulumi.CustomResource
    {
        ...
        public Vendor(string name, VendorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/latest:Vendor", name, args ?? new VendorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vendor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridnetwork/latest:Vendor", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:hybridnetwork/v20200101preview:Vendor"},
                },
            };
