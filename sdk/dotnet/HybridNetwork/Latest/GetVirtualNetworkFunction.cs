...
namespace Pulumi.AzureRM.HybridNetwork.Latest
{
    public static class GetVirtualNetworkFunction
    {
        public static Task<GetVirtualNetworkFunctionResult> InvokeAsync(GetVirtualNetworkFunctionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkFunctionResult>("azurerm:hybridnetwork/latest:getVirtualNetworkFunction", args ?? new GetVirtualNetworkFunctionArgs(), options.WithVersion());
    }
