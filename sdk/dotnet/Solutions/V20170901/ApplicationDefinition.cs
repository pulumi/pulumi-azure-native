...
namespace Pulumi.AzureRM.Solutions.V20170901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationDefinition = new AzureRM.Solutions.V20170901.ApplicationDefinition("applicationDefinition", new AzureRM.Solutions.V20170901.ApplicationDefinitionArgs
    ///         {
    ///             Authorizations = 
    ///             {
    ///                 new AzureRM.Solutions.V20170901.Inputs.ApplicationProviderAuthorizationArgs
    ///                 {
    ...
    public partial class ApplicationDefinition : Pulumi.CustomResource
    {
        ...
        public ApplicationDefinition(string name, ApplicationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:solutions/v20170901:ApplicationDefinition", name, args ?? new ApplicationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:solutions/v20170901:ApplicationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
