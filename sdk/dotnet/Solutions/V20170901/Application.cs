...
namespace Pulumi.AzureNative.Solutions.V20170901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:solutions/v20170901:Application")]
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20170901:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20170901:Application", name, null, MakeResourceOptions(options, id))
        {
        }
