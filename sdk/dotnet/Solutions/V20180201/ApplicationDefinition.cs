...
namespace Pulumi.AzureNative.Solutions.V20180201
{
    ...
    [AzureNativeResourceType("azure-native:solutions/v20180201:ApplicationDefinition")]
    public partial class ApplicationDefinition : global::Pulumi.CustomResource
    {
        ...
        public ApplicationDefinition(string name, ApplicationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20180201:ApplicationDefinition", name, args ?? new ApplicationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20180201:ApplicationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
