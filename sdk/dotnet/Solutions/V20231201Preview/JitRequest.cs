...
namespace Pulumi.AzureNative.Solutions.V20231201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:solutions/v20231201preview:JitRequest")]
    public partial class JitRequest : global::Pulumi.CustomResource
    {
        ...
        public JitRequest(string name, JitRequestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20231201preview:JitRequest", name, args ?? new JitRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JitRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20231201preview:JitRequest", name, null, MakeResourceOptions(options, id))
        {
        }
