...
namespace Pulumi.AzureNative.Solutions.V20231201Preview
{
    public static class GetApplication
    {
        ...
        public static Task<GetApplicationResult> InvokeAsync(GetApplicationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApplicationResult>("azure-native:solutions/v20231201preview:getApplication", args ?? new GetApplicationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the managed application.
        /// </summary>
        public static Output<GetApplicationResult> Invoke(GetApplicationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApplicationResult>("azure-native:solutions/v20231201preview:getApplication", args ?? new GetApplicationInvokeArgs(), options.WithDefaults());
    }
