...
namespace Pulumi.AzureRM.Solutions.Preview
{
    ...
    public partial class Appliance : Pulumi.CustomResource
    {
        ...
        public Appliance(string name, ApplianceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:solutions/preview:Appliance", name, args ?? new ApplianceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Appliance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:solutions/preview:Appliance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:solutions/v20160901preview:Appliance"},
                },
            };
