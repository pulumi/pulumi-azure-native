...
namespace Pulumi.AzureRM.Solutions.Preview
{
    public static class GetApplianceDefinition
    {
        public static Task<GetApplianceDefinitionResult> InvokeAsync(GetApplianceDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplianceDefinitionResult>("azurerm:solutions/preview:getApplianceDefinition", args ?? new GetApplianceDefinitionArgs(), options.WithVersion());
    }
