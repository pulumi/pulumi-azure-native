...
namespace Pulumi.AzureRM.Solutions.Preview
{
    ...
    public partial class JitRequest : Pulumi.CustomResource
    {
        ...
        public JitRequest(string name, JitRequestArgs args, CustomResourceOptions? options = null)
            : base("azurerm:solutions/preview:JitRequest", name, args ?? new JitRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JitRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:solutions/preview:JitRequest", name, null, MakeResourceOptions(options, id))
        {
        }
