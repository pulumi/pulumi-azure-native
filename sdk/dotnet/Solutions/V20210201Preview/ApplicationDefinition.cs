...
namespace Pulumi.AzureNative.Solutions.V20210201Preview
{
    ...
    public partial class ApplicationDefinition : global::Pulumi.CustomResource
    {
        ...
        public ApplicationDefinition(string name, ApplicationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20210201preview:ApplicationDefinition", name, args ?? new ApplicationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20210201preview:ApplicationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApplicationDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Solutions.V20210201Preview.ApplicationLockLevel> LockLevel { get; set; } = null!;
