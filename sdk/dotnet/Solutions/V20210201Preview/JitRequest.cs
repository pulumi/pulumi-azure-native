...
namespace Pulumi.AzureNative.Solutions.V20210201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:solutions/v20210201preview:JitRequest")]
    public partial class JitRequest : Pulumi.CustomResource
    {
        ...
        public JitRequest(string name, JitRequestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20210201preview:JitRequest", name, args ?? new JitRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JitRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20210201preview:JitRequest", name, null, MakeResourceOptions(options, id))
        {
        }
