...
namespace Pulumi.AzureNative.Solutions.V20210201Preview
{
    public static class GetJitRequest
    {
        ...
        public static Task<GetJitRequestResult> InvokeAsync(GetJitRequestArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJitRequestResult>("azure-native:solutions/v20210201preview:getJitRequest", args ?? new GetJitRequestArgs(), options.WithDefaults());

        /// <summary>
        /// Information about JIT request definition.
        /// </summary>
        public static Output<GetJitRequestResult> Invoke(GetJitRequestInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetJitRequestResult>("azure-native:solutions/v20210201preview:getJitRequest", args ?? new GetJitRequestInvokeArgs(), options.WithDefaults());
    }
