...
namespace Pulumi.AzureNative.Solutions.V20180901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:solutions/v20180901preview:ApplicationDefinition")]
    public partial class ApplicationDefinition : Pulumi.CustomResource
    {
        ...
        public ApplicationDefinition(string name, ApplicationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20180901preview:ApplicationDefinition", name, args ?? new ApplicationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20180901preview:ApplicationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
