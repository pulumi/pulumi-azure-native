...
namespace Pulumi.AzureNative.Solutions.V20180301
{
    ...
    public static class GetJitRequest
    {
        ...
        public static Task<GetJitRequestResult> InvokeAsync(GetJitRequestArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJitRequestResult>("azure-native:solutions/v20180301:getJitRequest", args ?? new GetJitRequestArgs(), options.WithDefaults());

        /// <summary>
        /// Information about JIT request definition.
        /// </summary>
        public static Output<GetJitRequestResult> Invoke(GetJitRequestInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJitRequestResult>("azure-native:solutions/v20180301:getJitRequest", args ?? new GetJitRequestInvokeArgs(), options.WithDefaults());
    }
