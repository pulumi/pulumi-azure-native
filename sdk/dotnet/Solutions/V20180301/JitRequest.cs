...
namespace Pulumi.AzureNative.Solutions.V20180301
{
    ...
    [AzureNativeResourceType("azure-native:solutions/v20180301:JitRequest")]
    public partial class JitRequest : Pulumi.CustomResource
    {
        ...
        public JitRequest(string name, JitRequestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20180301:JitRequest", name, args ?? new JitRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JitRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20180301:JitRequest", name, null, MakeResourceOptions(options, id))
        {
        }
