...
namespace Pulumi.AzureNative.Solutions.V20210701
{
    public static class GetApplicationDefinition
    {
        ...
        public static Task<GetApplicationDefinitionResult> InvokeAsync(GetApplicationDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationDefinitionResult>("azure-native:solutions/v20210701:getApplicationDefinition", args ?? new GetApplicationDefinitionArgs(), options.WithVersion());
        ...
        public static Output<GetApplicationDefinitionResult> Invoke(GetApplicationDefinitionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationDefinitionResult>("azure-native:solutions/v20210701:getApplicationDefinition", args ?? new GetApplicationDefinitionInvokeArgs(), options.WithVersion());
    }
