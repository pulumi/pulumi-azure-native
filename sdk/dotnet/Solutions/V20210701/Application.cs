...
namespace Pulumi.AzureNative.Solutions.V20210701
{
    ...
    /// {
    ///     var application = new AzureNative.Solutions.V20210701.Application("application", new()
    ///     {
    ...
    public partial class Application : global::Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20210701:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20210701:Application", name, null, MakeResourceOptions(options, id))
        {
        }
