...
namespace Pulumi.AzureNative.Solutions.V20190701
{
    public static class ListApplicationTokens
    {
        ...
        public static Task<ListApplicationTokensResult> InvokeAsync(ListApplicationTokensArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListApplicationTokensResult>("azure-native:solutions/v20190701:listApplicationTokens", args ?? new ListApplicationTokensArgs(), options.WithDefaults());

        /// <summary>
        /// The array of managed identity tokens.
        /// </summary>
        public static Output<ListApplicationTokensResult> Invoke(ListApplicationTokensInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListApplicationTokensResult>("azure-native:solutions/v20190701:listApplicationTokens", args ?? new ListApplicationTokensInvokeArgs(), options.WithDefaults());
    }
