...
namespace Pulumi.AzureRM.Solutions.V20190701
{
    ...
    public partial class JitRequest : Pulumi.CustomResource
    {
        ...
        public JitRequest(string name, JitRequestArgs args, CustomResourceOptions? options = null)
            : base("azurerm:solutions/v20190701:JitRequest", name, args ?? new JitRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JitRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:solutions/v20190701:JitRequest", name, null, MakeResourceOptions(options, id))
        {
        }
