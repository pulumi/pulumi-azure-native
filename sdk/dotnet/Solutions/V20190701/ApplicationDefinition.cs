...
namespace Pulumi.AzureNative.Solutions.V20190701
{
    ...
    /// {
    ///     var applicationDefinition = new AzureNative.Solutions.V20190701.ApplicationDefinition("applicationDefinition", new()
    ///     {
    ///         ApplicationDefinitionName = "myManagedApplicationDef",
    ///         Authorizations = new[]
    ///         {
    ///             new AzureNative.Solutions.V20190701.Inputs.ApplicationAuthorizationArgs
    ///             {
    ...
    ///         Location = "East US 2",
    ///         LockLevel = AzureNative.Solutions.V20190701.ApplicationLockLevel.None,
    ...
    public partial class ApplicationDefinition : global::Pulumi.CustomResource
    {
        ...
        public ApplicationDefinition(string name, ApplicationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20190701:ApplicationDefinition", name, args ?? new ApplicationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20190701:ApplicationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
