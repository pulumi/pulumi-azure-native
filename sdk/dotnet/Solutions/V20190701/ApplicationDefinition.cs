...
namespace Pulumi.AzureRM.Solutions.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationDefinition = new AzureRM.Solutions.V20190701.ApplicationDefinition("applicationDefinition", new AzureRM.Solutions.V20190701.ApplicationDefinitionArgs
    ///         {
    ///             ApplicationDefinitionName = "myManagedApplicationDef",
    ///             Authorizations = 
    ///             {
    ///                 new AzureRM.Solutions.V20190701.Inputs.ApplicationAuthorizationArgs
    ///                 {
    ...
    public partial class ApplicationDefinition : Pulumi.CustomResource
    {
        ...
        public ApplicationDefinition(string name, ApplicationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:solutions/v20190701:ApplicationDefinition", name, args ?? new ApplicationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:solutions/v20190701:ApplicationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
