...
namespace Pulumi.AzureNative.Solutions.V20200821Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:solutions/v20200821preview:Application")]
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20200821preview:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20200821preview:Application", name, null, MakeResourceOptions(options, id))
        {
        }
