...
namespace Pulumi.AzureNative.Solutions.V20200821Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:solutions/v20200821preview:ApplicationDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20210701:ApplicationDefinition to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:solutions/v20200821preview:ApplicationDefinition")]
    public partial class ApplicationDefinition : global::Pulumi.CustomResource
    {
        ...
        public ApplicationDefinition(string name, ApplicationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20200821preview:ApplicationDefinition", name, args ?? new ApplicationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20200821preview:ApplicationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
