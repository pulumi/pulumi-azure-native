...
namespace Pulumi.AzureNative.Solutions.V20200821Preview
{
    ...
    public static class GetApplicationDefinition
    {
        ...
        public static Task<GetApplicationDefinitionResult> InvokeAsync(GetApplicationDefinitionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApplicationDefinitionResult>("azure-native:solutions/v20200821preview:getApplicationDefinition", args ?? new GetApplicationDefinitionArgs(), options.WithDefaults());
        ...
        public static Output<GetApplicationDefinitionResult> Invoke(GetApplicationDefinitionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApplicationDefinitionResult>("azure-native:solutions/v20200821preview:getApplicationDefinition", args ?? new GetApplicationDefinitionInvokeArgs(), options.WithDefaults());
    }
