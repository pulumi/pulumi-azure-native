...
namespace Pulumi.AzureNative.Solutions.V20160901Preview
{
    ...
    public partial class ApplianceDefinition : Pulumi.CustomResource
    {
        ...
        public ApplianceDefinition(string name, ApplianceDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20160901preview:ApplianceDefinition", name, args ?? new ApplianceDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplianceDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20160901preview:ApplianceDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:solutions/v20180601:ApplianceDefinition"},
                    new Pulumi.Alias { Type = "azure-native:solutions/v20190701:ApplianceDefinition"},
                    new Pulumi.Alias { Type = "azure-nextgen:solutions/v20190701:ApplianceDefinition"},
                    new Pulumi.Alias { Type = "azure-native:solutions/v20200821preview:ApplianceDefinition"},
                    new Pulumi.Alias { Type = "azure-nextgen:solutions/v20200821preview:ApplianceDefinition"},
                    new Pulumi.Alias { Type = "azure-native:solutions/v20210701:ApplianceDefinition"},
                    new Pulumi.Alias { Type = "azure-nextgen:solutions/v20210701:ApplianceDefinition"},
                },
            };
