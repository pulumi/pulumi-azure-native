...
namespace Pulumi.AzureNative.Solutions.V20180601
{
    public static class GetApplicationDefinition
    {
        ...
        public static Output<GetApplicationDefinitionResult> Invoke(GetApplicationDefinitionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationDefinitionResult>("azure-native:solutions/v20180601:getApplicationDefinition", args ?? new GetApplicationDefinitionInvokeArgs(), options.WithVersion());
    }
