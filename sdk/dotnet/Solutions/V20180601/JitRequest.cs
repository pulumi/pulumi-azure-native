...
azure-native:solutions/v20180601:JitRequest is being removed in the next major version of this provider. Please upgrade to azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.")]
    ...
    public partial class JitRequest : global::Pulumi.CustomResource
    {
        ...
        public JitRequest(string name, JitRequestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20180601:JitRequest", name, args ?? new JitRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JitRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20180601:JitRequest", name, null, MakeResourceOptions(options, id))
        {
        }
