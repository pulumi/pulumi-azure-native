...
namespace Pulumi.AzureNextGen.Solutions.V20180601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:solutions/v20180601:ApplicationDefinition")]
    public partial class ApplicationDefinition : Pulumi.CustomResource
    {
        ...
        public ApplicationDefinition(string name, ApplicationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:solutions/v20180601:ApplicationDefinition", name, args ?? new ApplicationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:solutions/v20180601:ApplicationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApplicationDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Solutions.V20180601.ApplicationLockLevel> LockLevel { get; set; } = null!;
