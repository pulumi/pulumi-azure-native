...
namespace Pulumi.AzureNative.Solutions.V20180601
{
    ...
    public partial class ApplicationDefinition : global::Pulumi.CustomResource
    {
        ...
        public ApplicationDefinition(string name, ApplicationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20180601:ApplicationDefinition", name, args ?? new ApplicationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20180601:ApplicationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
