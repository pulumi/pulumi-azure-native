...
namespace Pulumi.AzureNative.Solutions.V20171201
{
    ...
    public partial class ApplicationDefinition : Pulumi.CustomResource
    {
        ...
        public ApplicationDefinition(string name, ApplicationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20171201:ApplicationDefinition", name, args ?? new ApplicationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:solutions/v20171201:ApplicationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApplicationDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Solutions.V20171201.ApplicationLockLevel> LockLevel { get; set; } = null!;
