...
namespace Pulumi.AzureRM.Solutions.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var appliance = new AzureRM.Solutions.Latest.Appliance("appliance", new AzureRM.Solutions.Latest.ApplianceArgs
    ///         {
    ...
    public partial class Appliance : Pulumi.CustomResource
    {
        ...
        public Appliance(string name, ApplianceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:solutions/latest:Appliance", name, args ?? new ApplianceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Appliance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:solutions/latest:Appliance", name, null, MakeResourceOptions(options, id))
        {
        }
