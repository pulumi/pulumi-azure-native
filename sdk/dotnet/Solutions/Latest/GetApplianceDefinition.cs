...
namespace Pulumi.AzureRM.Solutions.Latest
{
    public static class GetApplianceDefinition
    {
        public static Task<GetApplianceDefinitionResult> InvokeAsync(GetApplianceDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplianceDefinitionResult>("azurerm:solutions/latest:getApplianceDefinition", args ?? new GetApplianceDefinitionArgs(), options.WithVersion());
    }
