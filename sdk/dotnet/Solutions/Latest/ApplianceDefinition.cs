...
namespace Pulumi.AzureRM.Solutions.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applianceDefinition = new AzureRM.Solutions.Latest.ApplianceDefinition("applianceDefinition", new AzureRM.Solutions.Latest.ApplianceDefinitionArgs
    ///         {
    ///             ApplianceDefinitionName = "myApplianceDef",
    ///             Authorizations = 
    ///             {
    ///                 new AzureRM.Solutions.Latest.Inputs.ApplianceProviderAuthorizationArgs
    ///                 {
    ...
    public partial class ApplianceDefinition : Pulumi.CustomResource
    {
        ...
        public ApplianceDefinition(string name, ApplianceDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:solutions/latest:ApplianceDefinition", name, args ?? new ApplianceDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplianceDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:solutions/latest:ApplianceDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:solutions/v20160901preview:ApplianceDefinition"},
                },
            };
