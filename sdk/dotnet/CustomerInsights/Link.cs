...
namespace Pulumi.AzureRM.CustomerInsights
{
    ...
    public partial class Link : Pulumi.CustomResource
    {
        ...
        public Link(string name, LinkArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights:Link", name, args ?? new LinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Link(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights:Link", name, null, MakeResourceOptions(options, id))
        {
        }
