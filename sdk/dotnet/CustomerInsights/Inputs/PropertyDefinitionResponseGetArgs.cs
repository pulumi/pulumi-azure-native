...
namespace Pulumi.AzureRM.CustomerInsights.Inputs
{
    ...
    /// Property definition.
    /// </summary>
    public sealed class PropertyDefinitionResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.DataSourcePrecedenceResponseGetArgs>? _dataSourcePrecedenceRules;
        ...
        /// </summary>
        public InputList<Inputs.DataSourcePrecedenceResponseGetArgs> DataSourcePrecedenceRules
        {
            get => _dataSourcePrecedenceRules ?? (_dataSourcePrecedenceRules = new InputList<Inputs.DataSourcePrecedenceResponseGetArgs>());
            set => _dataSourcePrecedenceRules = value;
        }

        [Input("enumValidValues")]
        private InputList<Inputs.ProfileEnumValidValuesFormatResponseGetArgs>? _enumValidValues;

        /// <summary>
        /// Describes valid values for an enum property.
        /// </summary>
        public InputList<Inputs.ProfileEnumValidValuesFormatResponseGetArgs> EnumValidValues
        {
            get => _enumValidValues ?? (_enumValidValues = new InputList<Inputs.ProfileEnumValidValuesFormatResponseGetArgs>());
        ...
        public PropertyDefinitionResponseGetArgs()
        {
        }
    }
}
