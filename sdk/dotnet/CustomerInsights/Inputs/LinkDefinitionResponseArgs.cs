...
namespace Pulumi.AzureRM.CustomerInsights.Inputs
{
    ...
    /// </summary>
    public sealed class LinkDefinitionResponseArgs : Pulumi.ResourceArgs
    {
        [Input("description")]
        ...
        [Input("mappings")]
        private InputList<Inputs.TypePropertiesMappingResponseArgs>? _mappings;

        /// <summary>
        /// The set of properties mappings between the source and target Types.
        /// </summary>
        public InputList<Inputs.TypePropertiesMappingResponseArgs> Mappings
        {
            get => _mappings ?? (_mappings = new InputList<Inputs.TypePropertiesMappingResponseArgs>());
            set => _mappings = value;
        }
        ...
        private InputList<Inputs.ParticipantPropertyReferenceResponseArgs>? _participantPropertyReferences;

        /// <summary>
        /// The properties that represent the participating profile.
        /// </summary>
        public InputList<Inputs.ParticipantPropertyReferenceResponseArgs> ParticipantPropertyReferences
        {
            get => _participantPropertyReferences ?? (_participantPropertyReferences = new InputList<Inputs.ParticipantPropertyReferenceResponseArgs>());
        ...
        public LinkDefinitionResponseArgs()
        {
        }
    }
}
