...
namespace Pulumi.AzureRM.CustomerInsights.Inputs
{
    ...
    /// Property definition.
    /// </summary>
    public sealed class PropertyDefinitionResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("dataSourcePrecedenceRules", required: true)]
        private InputList<Inputs.DataSourcePrecedenceResponseArgs>? _dataSourcePrecedenceRules;
        ...
        /// </summary>
        public InputList<Inputs.DataSourcePrecedenceResponseArgs> DataSourcePrecedenceRules
        {
            get => _dataSourcePrecedenceRules ?? (_dataSourcePrecedenceRules = new InputList<Inputs.DataSourcePrecedenceResponseArgs>());
            set => _dataSourcePrecedenceRules = value;
        }

        [Input("enumValidValues")]
        private InputList<Inputs.ProfileEnumValidValuesFormatResponseArgs>? _enumValidValues;

        /// <summary>
        /// Describes valid values for an enum property.
        /// </summary>
        public InputList<Inputs.ProfileEnumValidValuesFormatResponseArgs> EnumValidValues
        {
            get => _enumValidValues ?? (_enumValidValues = new InputList<Inputs.ProfileEnumValidValuesFormatResponseArgs>());
        ...
        public PropertyDefinitionResponseArgs()
        {
        }
    }
}
