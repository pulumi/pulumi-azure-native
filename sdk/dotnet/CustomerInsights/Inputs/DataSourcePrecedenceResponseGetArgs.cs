...
namespace Pulumi.AzureRM.CustomerInsights.Inputs
{
    ...
    /// </summary>
    public sealed class DataSourcePrecedenceResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("dataSource")]
        public Input<Inputs.DataSourceResponseGetArgs>? DataSource { get; set; }
        ...
        public DataSourcePrecedenceResponseGetArgs()
        {
        }
    }
}
