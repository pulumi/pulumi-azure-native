...
namespace Pulumi.AzureRM.CustomerInsights.Inputs
{
    ...
    /// </summary>
    public sealed class ProfileTypeDefinitionResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("strongIds")]
        private InputList<Inputs.StrongIdResponseArgs>? _strongIds;

        /// <summary>
        /// The strong IDs.
        /// </summary>
        public InputList<Inputs.StrongIdResponseArgs> StrongIds
        {
            get => _strongIds ?? (_strongIds = new InputList<Inputs.StrongIdResponseArgs>());
        ...
        public ProfileTypeDefinitionResponseArgs()
        {
        }
    }
}
