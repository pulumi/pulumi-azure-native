...
namespace Pulumi.AzureRM.CustomerInsights
{
    ...
    public partial class Kpi : Pulumi.CustomResource
    {
        ...
        public Kpi(string name, KpiArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights:Kpi", name, args ?? new KpiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Kpi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights:Kpi", name, null, MakeResourceOptions(options, id))
        {
        }
