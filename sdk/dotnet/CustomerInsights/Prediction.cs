...
namespace Pulumi.AzureRM.CustomerInsights
{
    ...
    public partial class Prediction : Pulumi.CustomResource
    {
        ...
        public Prediction(string name, PredictionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights:Prediction", name, args ?? new PredictionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Prediction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights:Prediction", name, null, MakeResourceOptions(options, id))
        {
        }
