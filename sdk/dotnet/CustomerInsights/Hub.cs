...
namespace Pulumi.AzureRM.CustomerInsights
{
    ...
    public partial class Hub : Pulumi.CustomResource
    {
        ...
        public Hub(string name, HubArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights:Hub", name, args ?? new HubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Hub(string name, Input<string> id, HubState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights:Hub", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class HubState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.HubPropertiesFormatResponseGetArgs> Properties { get; set; } = null!;
