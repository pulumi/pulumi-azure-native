...
namespace Pulumi.AzureNative.CustomerInsights
{
    public static class GetPredictionModelStatus
    {
        ...
        public static Task<GetPredictionModelStatusResult> InvokeAsync(GetPredictionModelStatusArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPredictionModelStatusResult>("azure-native:customerinsights:getPredictionModelStatus", args ?? new GetPredictionModelStatusArgs(), options.WithDefaults());
        ...
        public static Output<GetPredictionModelStatusResult> Invoke(GetPredictionModelStatusInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPredictionModelStatusResult>("azure-native:customerinsights:getPredictionModelStatus", args ?? new GetPredictionModelStatusInvokeArgs(), options.WithDefaults());
    }
