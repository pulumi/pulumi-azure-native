...
namespace Pulumi.AzureRM.CustomerInsights
{
    public static class GetRoleAssignment
    {
        public static Task<GetRoleAssignmentResult> InvokeAsync(GetRoleAssignmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRoleAssignmentResult>("azurerm:customerinsights:getRoleAssignment", args ?? new GetRoleAssignmentArgs(), options.WithVersion());
    }
