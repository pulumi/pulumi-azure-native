...
namespace Pulumi.AzureRM.CustomerInsights.Preview
{
    ...
    public partial class Hub : Pulumi.CustomResource
    {
        ...
        public Hub(string name, HubArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/preview:Hub", name, args ?? new HubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Hub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/preview:Hub", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:customerinsights/v20170101:Hub"},
