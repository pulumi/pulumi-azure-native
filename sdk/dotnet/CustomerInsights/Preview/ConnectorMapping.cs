...
namespace Pulumi.AzureRM.CustomerInsights.Preview
{
    ...
    public partial class ConnectorMapping : Pulumi.CustomResource
    {
        ...
        public ConnectorMapping(string name, ConnectorMappingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/preview:ConnectorMapping", name, args ?? new ConnectorMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectorMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/preview:ConnectorMapping", name, null, MakeResourceOptions(options, id))
        {
        }
