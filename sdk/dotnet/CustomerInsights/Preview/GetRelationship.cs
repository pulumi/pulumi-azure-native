...
namespace Pulumi.AzureRM.CustomerInsights.Preview
{
    public static class GetRelationship
    {
        public static Task<GetRelationshipResult> InvokeAsync(GetRelationshipArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRelationshipResult>("azurerm:customerinsights/preview:getRelationship", args ?? new GetRelationshipArgs(), options.WithVersion());
    }
