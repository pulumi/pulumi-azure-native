...
namespace Pulumi.AzureRM.CustomerInsights.Preview
{
    public static class GetPrediction
    {
        public static Task<GetPredictionResult> InvokeAsync(GetPredictionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPredictionResult>("azurerm:customerinsights/preview:getPrediction", args ?? new GetPredictionArgs(), options.WithVersion());
    }
