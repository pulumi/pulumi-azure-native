...
namespace Pulumi.AzureRM.CustomerInsights.Preview
{
    public static class GetRelationshipLink
    {
        public static Task<GetRelationshipLinkResult> InvokeAsync(GetRelationshipLinkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRelationshipLinkResult>("azurerm:customerinsights/preview:getRelationshipLink", args ?? new GetRelationshipLinkArgs(), options.WithVersion());
    }
