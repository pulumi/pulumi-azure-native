...
namespace Pulumi.AzureRM.CustomerInsights.Preview
{
    ...
    public partial class Prediction : Pulumi.CustomResource
    {
        ...
        public Prediction(string name, PredictionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/preview:Prediction", name, args ?? new PredictionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Prediction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/preview:Prediction", name, null, MakeResourceOptions(options, id))
        {
        }
