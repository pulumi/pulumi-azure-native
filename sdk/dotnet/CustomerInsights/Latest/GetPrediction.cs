...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getPrediction'.")]
    public static class GetPrediction
    {
        ...
        public static Task<GetPredictionResult> InvokeAsync(GetPredictionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPredictionResult>("azure-native:customerinsights/latest:getPrediction", args ?? new GetPredictionArgs(), options.WithVersion());
    }
