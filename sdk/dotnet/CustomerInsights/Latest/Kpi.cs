...
namespace Pulumi.AzureRM.CustomerInsights.Latest
{
    ...
    public partial class Kpi : Pulumi.CustomResource
    {
        ...
        public Kpi(string name, KpiArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/latest:Kpi", name, args ?? new KpiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Kpi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/latest:Kpi", name, null, MakeResourceOptions(options, id))
        {
        }
