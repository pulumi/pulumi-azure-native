...
namespace Pulumi.AzureNative.CustomerInsights.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:customerinsights:RelationshipLink'.")]
    [AzureNativeResourceType("azure-native:customerinsights/latest:RelationshipLink")]
    public partial class RelationshipLink : Pulumi.CustomResource
    {
        ...
        public RelationshipLink(string name, RelationshipLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/latest:RelationshipLink", name, args ?? new RelationshipLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RelationshipLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/latest:RelationshipLink", name, null, MakeResourceOptions(options, id))
        {
        }
