...
namespace Pulumi.AzureRM.CustomerInsights.Latest
{
    ...
    public partial class Connector : Pulumi.CustomResource
    {
        ...
        public Connector(string name, ConnectorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/latest:Connector", name, args ?? new ConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/latest:Connector", name, null, MakeResourceOptions(options, id))
        {
        }
