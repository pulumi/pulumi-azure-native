...
namespace Pulumi.AzureNative.CustomerInsights.V20170101
{
    public static class GetLink
    {
        ...
        public static Task<GetLinkResult> InvokeAsync(GetLinkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLinkResult>("azure-native:customerinsights/v20170101:getLink", args ?? new GetLinkArgs(), options.WithVersion());

        /// <summary>
        /// The link resource format.
        /// </summary>
        public static Output<GetLinkResult> Invoke(GetLinkInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetLinkResult>("azure-native:customerinsights/v20170101:getLink", args ?? new GetLinkInvokeArgs(), options.WithVersion());
    }
