...
namespace Pulumi.AzureRM.CustomerInsights.V20170101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var relationship = new AzureRM.CustomerInsights.V20170101.Relationship("relationship", new AzureRM.CustomerInsights.V20170101.RelationshipArgs
    ///         {
    ...
    public partial class Relationship : Pulumi.CustomResource
    {
        ...
        public Relationship(string name, RelationshipArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/v20170101:Relationship", name, args ?? new RelationshipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Relationship(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/v20170101:Relationship", name, null, MakeResourceOptions(options, id))
        {
        }
