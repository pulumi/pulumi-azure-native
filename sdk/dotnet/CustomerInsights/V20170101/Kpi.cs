...
namespace Pulumi.AzureRM.CustomerInsights.V20170101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var kpi = new AzureRM.CustomerInsights.V20170101.Kpi("kpi", new AzureRM.CustomerInsights.V20170101.KpiArgs
    ///         {
    ///             Aliases = 
    ///             {
    ///                 new AzureRM.CustomerInsights.V20170101.Inputs.KpiAliasArgs
    ///                 {
    ///                     AliasName = "alias",
    ///                     Expression = "Id+4",
    ///                 },
    ...
    ///             ThresHolds = new AzureRM.CustomerInsights.V20170101.Inputs.KpiThresholdsArgs
    ///             {
    ///                 IncreasingKpi = true,
    ///                 LowerLimit = 5,
    ///                 UpperLimit = 50,
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:customerinsights/v20170426:Kpi"},
                },
            };
