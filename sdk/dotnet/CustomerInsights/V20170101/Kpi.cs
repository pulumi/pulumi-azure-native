...
azure-native:customerinsights/v20170101:Kpi is being removed in the next major version of this provider. Please upgrade to azure-native:customerinsights/v20170426:Kpi to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:customerinsights/v20170101:Kpi")]
    public partial class Kpi : global::Pulumi.CustomResource
    {
        ...
        public Kpi(string name, KpiArgs args, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170101:Kpi", name, args ?? new KpiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Kpi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170101:Kpi", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class KpiArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.CustomerInsights.V20170101.CalculationWindowTypes> CalculationWindow { get; set; } = null!;
        ...
        public Input<Pulumi.AzureNative.CustomerInsights.V20170101.KpiFunctions> Function { get; set; } = null!;
