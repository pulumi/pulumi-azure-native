...
namespace Pulumi.AzureNative.CustomerInsights.V20170101
{
    ...
    public partial class RoleAssignment : global::Pulumi.CustomResource
    {
        ...
        public RoleAssignment(string name, RoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170101:RoleAssignment", name, args ?? new RoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170101:RoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RoleAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.CustomerInsights.V20170101.RoleTypes> Role { get; set; } = null!;
