...
namespace Pulumi.AzureNative.CustomerInsights.V20170101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:customerinsights/v20170101:ConnectorMapping")]
    public partial class ConnectorMapping : Pulumi.CustomResource
    {
        ...
        public ConnectorMapping(string name, ConnectorMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170101:ConnectorMapping", name, args ?? new ConnectorMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectorMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170101:ConnectorMapping", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectorMappingArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("connectorType")]
        public InputUnion<string, Pulumi.AzureNative.CustomerInsights.V20170101.ConnectorTypes>? ConnectorType { get; set; }
        ...
        public Input<Pulumi.AzureNative.CustomerInsights.V20170101.EntityTypes> EntityType { get; set; } = null!;
