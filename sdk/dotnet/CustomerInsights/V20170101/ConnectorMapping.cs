...
namespace Pulumi.AzureNextGen.CustomerInsights.V20170101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:customerinsights/v20170101:ConnectorMapping")]
    ...
    public sealed class ConnectorMappingArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("connectorType")]
        public InputUnion<string, Pulumi.AzureNextGen.CustomerInsights.V20170101.ConnectorTypes>? ConnectorType { get; set; }
