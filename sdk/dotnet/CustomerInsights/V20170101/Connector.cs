...
namespace Pulumi.AzureRM.CustomerInsights.V20170101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var connector = new AzureRM.CustomerInsights.V20170101.Connector("connector", new AzureRM.CustomerInsights.V20170101.ConnectorArgs
    ///         {
    ...
    public partial class Connector : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:customerinsights/latest:Connector"},
                    new Pulumi.Alias { Type = "azurerm:customerinsights/v20170426:Connector"},
                },
            };
