...
namespace Pulumi.AzureRM.CustomerInsights
{
    ...
    public partial class HubRoleAssignment : Pulumi.CustomResource
    {
        ...
        private HubRoleAssignment(string name, Input<string> id, HubRoleAssignmentState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights:HubRoleAssignment", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HubRoleAssignment Get(string name, Input<string> id, HubRoleAssignmentState? state = null, CustomResourceOptions? options = null)
        {
            return new HubRoleAssignment(name, id, state, options);
        }
    }
    ...
    public sealed class HubRoleAssignmentState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Resource name.
        /// </summary>
        ...
        public Input<Inputs.RoleAssignmentResponseGetArgs> Properties { get; set; } = null!;
