...
namespace Pulumi.AzureRM.CustomerInsights.V20170426
{
    ...
    public partial class RoleAssignment : Pulumi.CustomResource
    {
        ...
        public RoleAssignment(string name, RoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/v20170426:RoleAssignment", name, args ?? new RoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/v20170426:RoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
