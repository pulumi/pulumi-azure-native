...
namespace Pulumi.AzureNative.CustomerInsights.V20170426
{
    public static class GetRelationshipLink
    {
        ...
        public static Task<GetRelationshipLinkResult> InvokeAsync(GetRelationshipLinkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRelationshipLinkResult>("azure-native:customerinsights/v20170426:getRelationshipLink", args ?? new GetRelationshipLinkArgs(), options.WithDefaults());

        /// <summary>
        /// The relationship link resource format.
        /// </summary>
        public static Output<GetRelationshipLinkResult> Invoke(GetRelationshipLinkInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRelationshipLinkResult>("azure-native:customerinsights/v20170426:getRelationshipLink", args ?? new GetRelationshipLinkInvokeArgs(), options.WithDefaults());
    }
