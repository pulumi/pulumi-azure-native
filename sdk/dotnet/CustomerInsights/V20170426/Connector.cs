...
namespace Pulumi.AzureNative.CustomerInsights.V20170426
{
    ...
    public partial class Connector : Pulumi.CustomResource
    {
        ...
        public Connector(string name, ConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170426:Connector", name, args ?? new ConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170426:Connector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectorArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.CustomerInsights.V20170426.ConnectorTypes> ConnectorType { get; set; } = null!;
