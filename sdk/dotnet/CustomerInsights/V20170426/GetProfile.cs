...
namespace Pulumi.AzureNative.CustomerInsights.V20170426
{
    public static class GetProfile
    {
        ...
        public static Task<GetProfileResult> InvokeAsync(GetProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProfileResult>("azure-native:customerinsights/v20170426:getProfile", args ?? new GetProfileArgs(), options.WithDefaults());
