...
namespace Pulumi.AzureNative.CustomerInsights.V20170426
{
    public static class GetProfile
    {
        ...
        public static Output<GetProfileResult> Invoke(GetProfileInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProfileResult>("azure-native:customerinsights/v20170426:getProfile", args ?? new GetProfileInvokeArgs(), options.WithVersion());
    }
