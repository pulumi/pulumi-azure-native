...
namespace Pulumi.AzureNative.CustomerInsights.V20170426
{
    ...
    /// {
    ///     var relationship = new AzureNative.CustomerInsights.V20170426.Relationship("relationship", new()
    ///     {
    ///         Cardinality = AzureNative.CustomerInsights.V20170426.CardinalityTypes.OneToOne,
    ///         Description = 
    ///         {
    ...
    public partial class Relationship : global::Pulumi.CustomResource
    {
        ...
        public Relationship(string name, RelationshipArgs args, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170426:Relationship", name, args ?? new RelationshipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Relationship(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170426:Relationship", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RelationshipArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cardinality")]
        public Input<Pulumi.AzureNative.CustomerInsights.V20170426.CardinalityTypes>? Cardinality { get; set; }
