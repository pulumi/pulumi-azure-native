...
namespace Pulumi.AzureNative.CustomerInsights.V20170426
{
    ...
    public partial class ConnectorMapping : global::Pulumi.CustomResource
    {
        ...
        public ConnectorMapping(string name, ConnectorMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170426:ConnectorMapping", name, args ?? new ConnectorMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectorMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170426:ConnectorMapping", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectorMappingArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("connectorType")]
        public InputUnion<string, Pulumi.AzureNative.CustomerInsights.V20170426.ConnectorTypes>? ConnectorType { get; set; }
