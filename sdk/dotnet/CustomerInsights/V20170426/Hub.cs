...
namespace Pulumi.AzureNextGen.CustomerInsights.V20170426
{
    ...
    /// Hub resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:customerinsights/v20170426:Hub")]
    public partial class Hub : Pulumi.CustomResource
    {
        ...
        public Hub(string name, HubArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:customerinsights/v20170426:Hub", name, args ?? new HubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Hub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:customerinsights/v20170426:Hub", name, null, MakeResourceOptions(options, id))
        {
        }
