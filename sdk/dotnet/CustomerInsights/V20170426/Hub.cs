...
namespace Pulumi.AzureNative.CustomerInsights.V20170426
{
    ...
    public partial class Hub : global::Pulumi.CustomResource
    {
        ...
        public Hub(string name, HubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170426:Hub", name, args ?? new HubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Hub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170426:Hub", name, null, MakeResourceOptions(options, id))
        {
        }
