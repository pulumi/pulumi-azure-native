...
namespace Pulumi.AzureNative.CustomerInsights.V20170426
{
    ...
    public partial class Link : Pulumi.CustomResource
    {
        ...
        public Link(string name, LinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170426:Link", name, args ?? new LinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Link(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170426:Link", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LinkArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("operationType")]
        public Input<Pulumi.AzureNative.CustomerInsights.V20170426.InstanceOperationType>? OperationType { get; set; }
        ...
        public Input<Pulumi.AzureNative.CustomerInsights.V20170426.EntityType> SourceEntityType { get; set; } = null!;
        ...
        public Input<Pulumi.AzureNative.CustomerInsights.V20170426.EntityType> TargetEntityType { get; set; } = null!;
