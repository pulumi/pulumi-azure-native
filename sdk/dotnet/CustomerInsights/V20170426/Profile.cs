...
namespace Pulumi.AzureRM.CustomerInsights.V20170426
{
    ...
    ///     public MyStack()
    ///     {
    ///         var profile = new AzureRM.CustomerInsights.V20170426.Profile("profile", new AzureRM.CustomerInsights.V20170426.ProfileArgs
    ///         {
    ///             ApiEntitySetName = "TestProfileType396",
    ///             Fields = 
    ///             {
    ///                 new AzureRM.CustomerInsights.V20170426.Inputs.PropertyDefinitionArgs
    ///                 {
    ///                     FieldName = "Id",
    ...
    ///             StrongIds = 
    ///             {
    ///                 new AzureRM.CustomerInsights.V20170426.Inputs.StrongIdArgs
    ///                 {
    ///                     KeyPropertyNames = 
    ///                     {
    ///                         "Id",
    ...
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/v20170426:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customerinsights/v20170426:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:customerinsights/v20170101:Profile"},
                },
            };
