...
namespace Pulumi.AzureNative.CustomerInsights.V20170426
{
    ...
    public partial class Profile : global::Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170426:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:customerinsights/v20170426:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("entityType")]
        public Input<Pulumi.AzureNative.CustomerInsights.V20170426.EntityTypes>? EntityType { get; set; }
