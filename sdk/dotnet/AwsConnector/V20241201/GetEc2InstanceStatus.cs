...
namespace Pulumi.AzureNative.AwsConnector.V20241201
{
    public static class GetEc2InstanceStatus
    {
        ...
        public static Task<GetEc2InstanceStatusResult> InvokeAsync(GetEc2InstanceStatusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEc2InstanceStatusResult>("azure-native:awsconnector/v20241201:getEc2InstanceStatus", args ?? new GetEc2InstanceStatusArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Ec2InstanceStatus
        /// </summary>
        public static Output<GetEc2InstanceStatusResult> Invoke(GetEc2InstanceStatusInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEc2InstanceStatusResult>("azure-native:awsconnector/v20241201:getEc2InstanceStatus", args ?? new GetEc2InstanceStatusInvokeArgs(), options.WithDefaults());
    }
