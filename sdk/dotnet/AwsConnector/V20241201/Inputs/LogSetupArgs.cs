...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Inputs
{
    ...
    public sealed class LogSetupArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("types")]
        private InputList<Union<string, Pulumi.AzureNative.AwsConnector.V20241201.LogType>>? _types;

        /// <summary>
        /// &lt;p&gt;The available cluster control plane log types.&lt;/p&gt;
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AwsConnector.V20241201.LogType>> Types
        {
            get => _types ?? (_types = new InputList<Union<string, Pulumi.AzureNative.AwsConnector.V20241201.LogType>>());
            set => _types = value;
        }
