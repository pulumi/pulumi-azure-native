...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Inputs
{
    ...
    /// </summary>
    public sealed class AwsMacie2JobSummaryPropertiesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.S3BucketCriteriaForJobArgs>? BucketCriteria { get; set; }

        [Input("bucketDefinitions")]
        private InputList<Inputs.S3BucketDefinitionForJobArgs>? _bucketDefinitions;
        ...
        /// </summary>
        public InputList<Inputs.S3BucketDefinitionForJobArgs> BucketDefinitions
        {
            get => _bucketDefinitions ?? (_bucketDefinitions = new InputList<Inputs.S3BucketDefinitionForJobArgs>());
        ...
        /// </summary>
        [Input("jobStatus")]
        public Input<Inputs.JobStatusEnumValueArgs>? JobStatus { get; set; }
        ...
        /// </summary>
        [Input("jobType")]
        public Input<Inputs.JobTypeEnumValueArgs>? JobType { get; set; }
        ...
        /// </summary>
        [Input("lastRunErrorStatus")]
        public Input<Inputs.LastRunErrorStatusArgs>? LastRunErrorStatus { get; set; }
        ...
        public Input<Inputs.UserPausedDetailsArgs>? UserPausedDetails { get; set; }

        public AwsMacie2JobSummaryPropertiesArgs()
        {
        }
        public static new AwsMacie2JobSummaryPropertiesArgs Empty => new AwsMacie2JobSummaryPropertiesArgs();
    }
}
