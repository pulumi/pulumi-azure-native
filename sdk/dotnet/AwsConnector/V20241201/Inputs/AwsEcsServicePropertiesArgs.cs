...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Inputs
{
    ...
    /// </summary>
    public sealed class AwsEcsServicePropertiesArgs : global::Pulumi.ResourceArgs
    {
        [Input("capacityProviderStrategy")]
        private InputList<Inputs.CapacityProviderStrategyItemArgs>? _capacityProviderStrategy;

        /// <summary>
        /// The capacity provider strategy to use for the service. If a ``capacityProviderStrategy`` is specified, the ``launchType`` parameter must be omitted. If no ``capacityProviderStrategy`` or ``launchType`` is specified, the ``defaultCapacityProviderStrategy`` for the cluster is used. A capacity provider strategy may contain a maximum of 6 capacity providers.
        /// </summary>
        public InputList<Inputs.CapacityProviderStrategyItemArgs> CapacityProviderStrategy
        {
            get => _capacityProviderStrategy ?? (_capacityProviderStrategy = new InputList<Inputs.CapacityProviderStrategyItemArgs>());
        ...
        public Input<Inputs.DeploymentControllerArgs>? DeploymentController { get; set; }
        ...
        /// </summary>
        [Input("launchType")]
        public InputUnion<string, Pulumi.AzureNative.AwsConnector.V20241201.LaunchType>? LaunchType { get; set; }

        [Input("loadBalancers")]
        private InputList<Inputs.LoadBalancerArgs>? _loadBalancers;

        /// <summary>
        /// A list of load balancer objects to associate with the service. If you specify the ``Role`` property, ``LoadBalancers`` must be specified as well. For information about the number of load balancers that you can specify per service, see [Service Load Balancing](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-load-balancing.html) in the *Amazon Elastic Container Service Developer Guide*.
        /// </summary>
        public InputList<Inputs.LoadBalancerArgs> LoadBalancers
        {
            get => _loadBalancers ?? (_loadBalancers = new InputList<Inputs.LoadBalancerArgs>());
        ...
        private InputList<Inputs.PlacementConstraintArgs>? _placementConstraints;

        /// <summary>
        /// An array of placement constraint objects to use for tasks in your service. You can specify a maximum of 10 constraints for each task. This limit includes constraints in the task definition and those specified at runtime.
        /// </summary>
        public InputList<Inputs.PlacementConstraintArgs> PlacementConstraints
        {
            get => _placementConstraints ?? (_placementConstraints = new InputList<Inputs.PlacementConstraintArgs>());
            set => _placementConstraints = value;
        }

        [Input("placementStrategies")]
        private InputList<Inputs.PlacementStrategyArgs>? _placementStrategies;

        /// <summary>
        /// The placement strategy objects to use for tasks in your service. You can specify a maximum of 5 strategy rules for each service.
        /// </summary>
        public InputList<Inputs.PlacementStrategyArgs> PlacementStrategies
        {
            get => _placementStrategies ?? (_placementStrategies = new InputList<Inputs.PlacementStrategyArgs>());
        ...
        /// </summary>
        [Input("propagateTags")]
        public InputUnion<string, Pulumi.AzureNative.AwsConnector.V20241201.PropagateTags>? PropagateTags { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AwsConnector.V20241201.SchedulingStrategy>? SchedulingStrategy { get; set; }
        ...
        public AwsEcsServicePropertiesArgs()
        {
            PlatformVersion = "LATEST";
        }
        public static new AwsEcsServicePropertiesArgs Empty => new AwsEcsServicePropertiesArgs();
    }
}
