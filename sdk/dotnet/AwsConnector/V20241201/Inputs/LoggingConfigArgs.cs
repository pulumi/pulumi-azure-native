...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Inputs
{
    ...
    public sealed class LoggingConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AwsConnector.V20241201.LoggingConfigApplicationLogLevel>? ApplicationLogLevel { get; set; }
        ...
        /// </summary>
        [Input("logFormat")]
        public InputUnion<string, Pulumi.AzureNative.AwsConnector.V20241201.LoggingConfigLogFormat>? LogFormat { get; set; }
        ...
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.AwsConnector.V20241201.LoggingConfigProtocol>? Protocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AwsConnector.V20241201.LoggingConfigSystemLogLevel>? SystemLogLevel { get; set; }
