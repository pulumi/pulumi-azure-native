...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Inputs
{
    ...
    /// </summary>
    public sealed class EnhancedMetricsConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.DataSourceLevelMetricsBehaviorEnumValueArgs>? DataSourceLevelMetricsBehavior { get; set; }
        ...
        public Input<Inputs.OperationLevelMetricsConfigEnumValueArgs>? OperationLevelMetricsConfig { get; set; }
        ...
        public Input<Inputs.ResolverLevelMetricsBehaviorEnumValueArgs>? ResolverLevelMetricsBehavior { get; set; }

        public EnhancedMetricsConfigArgs()
        {
        }
        public static new EnhancedMetricsConfigArgs Empty => new EnhancedMetricsConfigArgs();
    }
}
