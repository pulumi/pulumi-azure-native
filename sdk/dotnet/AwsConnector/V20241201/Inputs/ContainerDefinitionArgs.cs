...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Inputs
{
    ...
    public sealed class ContainerDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("dependsOn")]
        private InputList<Inputs.ContainerDependencyArgs>? _dependsOn;
        ...
        /// </summary>
        public InputList<Inputs.ContainerDependencyArgs> DependsOn
        {
            get => _dependsOn ?? (_dependsOn = new InputList<Inputs.ContainerDependencyArgs>());
        ...
        [Input("environment")]
        private InputList<Inputs.KeyValuePairArgs>? _environment;
        ...
        /// </summary>
        public InputList<Inputs.KeyValuePairArgs> Environment
        {
            get => _environment ?? (_environment = new InputList<Inputs.KeyValuePairArgs>());
            set => _environment = value;
        }

        [Input("environmentFiles")]
        private InputList<Inputs.EnvironmentFileArgs>? _environmentFiles;
        ...
        /// </summary>
        public InputList<Inputs.EnvironmentFileArgs> EnvironmentFiles
        {
            get => _environmentFiles ?? (_environmentFiles = new InputList<Inputs.EnvironmentFileArgs>());
        ...
        [Input("extraHosts")]
        private InputList<Inputs.HostEntryArgs>? _extraHosts;
        ...
        /// </summary>
        public InputList<Inputs.HostEntryArgs> ExtraHosts
        {
            get => _extraHosts ?? (_extraHosts = new InputList<Inputs.HostEntryArgs>());
        ...
        public Input<Inputs.FirelensConfigurationArgs>? FirelensConfiguration { get; set; }
        ...
        public Input<Inputs.LinuxParametersArgs>? LinuxParameters { get; set; }
        ...
        [Input("mountPoints")]
        private InputList<Inputs.MountPointArgs>? _mountPoints;
        ...
        /// </summary>
        public InputList<Inputs.MountPointArgs> MountPoints
        {
            get => _mountPoints ?? (_mountPoints = new InputList<Inputs.MountPointArgs>());
        ...
        [Input("portMappings")]
        private InputList<Inputs.PortMappingArgs>? _portMappings;
        ...
        /// </summary>
        public InputList<Inputs.PortMappingArgs> PortMappings
        {
            get => _portMappings ?? (_portMappings = new InputList<Inputs.PortMappingArgs>());
        ...
        public Input<Inputs.RepositoryCredentialsArgs>? RepositoryCredentials { get; set; }

        [Input("resourceRequirements")]
        private InputList<Inputs.ResourceRequirementArgs>? _resourceRequirements;

        /// <summary>
        /// The type and amount of a resource to assign to a container. The only supported resource is a GPU.
        /// </summary>
        public InputList<Inputs.ResourceRequirementArgs> ResourceRequirements
        {
            get => _resourceRequirements ?? (_resourceRequirements = new InputList<Inputs.ResourceRequirementArgs>());
        ...
        private InputList<Inputs.SystemControlArgs>? _systemControls;
        ...
        /// </summary>
        public InputList<Inputs.SystemControlArgs> SystemControls
        {
            get => _systemControls ?? (_systemControls = new InputList<Inputs.SystemControlArgs>());
            set => _systemControls = value;
        }

        [Input("ulimits")]
        private InputList<Inputs.UlimitArgs>? _ulimits;
        ...
        /// </summary>
        public InputList<Inputs.UlimitArgs> Ulimits
        {
            get => _ulimits ?? (_ulimits = new InputList<Inputs.UlimitArgs>());
            set => _ulimits = value;
        }
        ...
        [Input("volumesFrom")]
        private InputList<Inputs.VolumeFromArgs>? _volumesFrom;

        /// <summary>
        /// Data volumes to mount from another container. This parameter maps to ``VolumesFrom`` in the [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate) section of the [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/) and the ``--volumes-from`` option to [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/#security-configuration).
        /// </summary>
        public InputList<Inputs.VolumeFromArgs> VolumesFrom
        {
            get => _volumesFrom ?? (_volumesFrom = new InputList<Inputs.VolumeFromArgs>());
