...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Inputs
{
    ...
    {
        [Input("capabilities")]
        private InputList<Union<string, Pulumi.AzureNative.AwsConnector.V20241201.Capabilities>>? _capabilities;

        /// <summary>
        /// Property capabilities
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AwsConnector.V20241201.Capabilities>> Capabilities
        {
            get => _capabilities ?? (_capabilities = new InputList<Union<string, Pulumi.AzureNative.AwsConnector.V20241201.Capabilities>>());
        ...
        /// </summary>
        [Input("stackStatus")]
        public InputUnion<string, Pulumi.AzureNative.AwsConnector.V20241201.StackStatus>? StackStatus { get; set; }
