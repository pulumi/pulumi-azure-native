...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Inputs
{
    ...
    public sealed class CorsRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.AwsConnector.V20241201.CorsRuleAllowedMethods>>? _allowedMethods;

        /// <summary>
        /// An HTTP method that you allow the origin to run.  *Allowed values*: ``GET`` | ``PUT`` | ``HEAD`` | ``POST`` | ``DELETE``
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AwsConnector.V20241201.CorsRuleAllowedMethods>> AllowedMethods
        {
            get => _allowedMethods ?? (_allowedMethods = new InputList<Union<string, Pulumi.AzureNative.AwsConnector.V20241201.CorsRuleAllowedMethods>>());
