...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Inputs
{
    ...
    public sealed class HeaderArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public InputUnion<string, Pulumi.AzureNative.AwsConnector.V20241201.HeaderDirection>? Direction { get; set; }

        /// <summary>
        /// Property protocol
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.AwsConnector.V20241201.HeaderProtocol>? Protocol { get; set; }
