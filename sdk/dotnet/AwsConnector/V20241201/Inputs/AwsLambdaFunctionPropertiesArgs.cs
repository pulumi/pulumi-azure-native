...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Inputs
{
    ...
    {
        [Input("architectures")]
        private InputList<Union<string, Pulumi.AzureNative.AwsConnector.V20241201.Architectures>>? _architectures;

        /// <summary>
        /// The instruction set architecture that the function supports. Enter a string array with one of the valid values (arm64 or x86_64). The default value is ``x86_64``.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AwsConnector.V20241201.Architectures>> Architectures
        {
            get => _architectures ?? (_architectures = new InputList<Union<string, Pulumi.AzureNative.AwsConnector.V20241201.Architectures>>());
        ...
        /// </summary>
        [Input("packageType")]
        public InputUnion<string, Pulumi.AzureNative.AwsConnector.V20241201.PackageType>? PackageType { get; set; }
