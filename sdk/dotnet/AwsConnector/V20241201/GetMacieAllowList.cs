...
namespace Pulumi.AzureNative.AwsConnector.V20241201
{
    public static class GetMacieAllowList
    {
        ...
        public static Task<GetMacieAllowListResult> InvokeAsync(GetMacieAllowListArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMacieAllowListResult>("azure-native:awsconnector/v20241201:getMacieAllowList", args ?? new GetMacieAllowListArgs(), options.WithDefaults());
