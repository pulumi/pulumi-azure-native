...
namespace Pulumi.AzureNative.AwsConnector.V20241201
{
    public static class GetIamGroup
    {
        ...
        public static Task<GetIamGroupResult> InvokeAsync(GetIamGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIamGroupResult>("azure-native:awsconnector/v20241201:getIamGroup", args ?? new GetIamGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Get a IamGroup
        /// </summary>
        public static Output<GetIamGroupResult> Invoke(GetIamGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIamGroupResult>("azure-native:awsconnector/v20241201:getIamGroup", args ?? new GetIamGroupInvokeArgs(), options.WithDefaults());
    }
