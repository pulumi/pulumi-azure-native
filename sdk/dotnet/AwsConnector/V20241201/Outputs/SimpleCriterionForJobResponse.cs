...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class SimpleCriterionForJobResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.SimpleCriterionKeyForJobEnumValueResponse? Key;
        /// <summary>
        ...
        [OutputConstructor]
        private SimpleCriterionForJobResponse(
            Outputs.JobComparatorEnumValueResponse? comparator,

            Outputs.SimpleCriterionKeyForJobEnumValueResponse? key,
