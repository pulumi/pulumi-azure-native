...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class CapacityReservationSpecificationResponseResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.CapacityReservationPreferenceEnumValueResponse? CapacityReservationPreference;
        /// <summary>
        /// &lt;p&gt;Information about the targeted Capacity Reservation or Capacity Reservation group.&lt;/p&gt;
        /// </summary>
        public readonly Outputs.CapacityReservationTargetResponseResponse? CapacityReservationTarget;

        [OutputConstructor]
        private CapacityReservationSpecificationResponseResponse(
            Outputs.CapacityReservationPreferenceEnumValueResponse? capacityReservationPreference,

            Outputs.CapacityReservationTargetResponseResponse? capacityReservationTarget)
        {
