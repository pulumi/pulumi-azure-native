...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ProjectCacheResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.CacheTypeEnumValueResponse? Type;

        [OutputConstructor]
        private ProjectCacheResponse(
            string? location,

            ImmutableArray<string> modes,

            Outputs.CacheTypeEnumValueResponse? type)
        {
            Location = location;
            Modes = modes;
            Type = type;
