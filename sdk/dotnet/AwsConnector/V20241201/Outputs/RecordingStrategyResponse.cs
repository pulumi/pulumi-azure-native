...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class RecordingStrategyResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.RecordingStrategyTypeEnumValueResponse? UseOnly;

        [OutputConstructor]
        private RecordingStrategyResponse(Outputs.RecordingStrategyTypeEnumValueResponse? useOnly)
        {
            UseOnly = useOnly;
        }
    }
