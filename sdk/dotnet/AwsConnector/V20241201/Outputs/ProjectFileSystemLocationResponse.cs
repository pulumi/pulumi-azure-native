...
namespace Pulumi.AzureNative.AwsConnector.V20241201.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ProjectFileSystemLocationResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.FileSystemTypeEnumValueResponse? Type;

        [OutputConstructor]
        private ProjectFileSystemLocationResponse(
            string? identifier,
            ...
            Outputs.FileSystemTypeEnumValueResponse? type)
        {
