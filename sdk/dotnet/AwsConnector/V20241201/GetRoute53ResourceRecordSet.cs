...
namespace Pulumi.AzureNative.AwsConnector.V20241201
{
    public static class GetRoute53ResourceRecordSet
    {
        ...
        public static Task<GetRoute53ResourceRecordSetResult> InvokeAsync(GetRoute53ResourceRecordSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRoute53ResourceRecordSetResult>("azure-native:awsconnector/v20241201:getRoute53ResourceRecordSet", args ?? new GetRoute53ResourceRecordSetArgs(), options.WithDefaults());
