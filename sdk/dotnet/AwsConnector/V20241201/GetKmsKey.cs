...
namespace Pulumi.AzureNative.AwsConnector.V20241201
{
    public static class GetKmsKey
    {
        ...
        public static Task<GetKmsKeyResult> InvokeAsync(GetKmsKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKmsKeyResult>("azure-native:awsconnector/v20241201:getKmsKey", args ?? new GetKmsKeyArgs(), options.WithDefaults());
