...
namespace Pulumi.AzureNative.AwsConnector.V20241201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:awsconnector/v20241201:Ec2NetworkInterface")]
    public partial class Ec2NetworkInterface : global::Pulumi.CustomResource
    {
        ...
        public Ec2NetworkInterface(string name, Ec2NetworkInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:awsconnector/v20241201:Ec2NetworkInterface", name, args ?? new Ec2NetworkInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ec2NetworkInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:awsconnector/v20241201:Ec2NetworkInterface", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:awsconnector:Ec2NetworkInterface" },
                },
            };
