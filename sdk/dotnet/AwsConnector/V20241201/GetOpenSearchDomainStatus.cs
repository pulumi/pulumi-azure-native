...
namespace Pulumi.AzureNative.AwsConnector.V20241201
{
    public static class GetOpenSearchDomainStatus
    {
        ...
        public static Task<GetOpenSearchDomainStatusResult> InvokeAsync(GetOpenSearchDomainStatusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOpenSearchDomainStatusResult>("azure-native:awsconnector/v20241201:getOpenSearchDomainStatus", args ?? new GetOpenSearchDomainStatusArgs(), options.WithDefaults());
