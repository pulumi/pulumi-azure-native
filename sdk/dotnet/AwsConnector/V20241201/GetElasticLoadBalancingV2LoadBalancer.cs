...
namespace Pulumi.AzureNative.AwsConnector.V20241201
{
    public static class GetElasticLoadBalancingV2LoadBalancer
    {
        ...
        public static Task<GetElasticLoadBalancingV2LoadBalancerResult> InvokeAsync(GetElasticLoadBalancingV2LoadBalancerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetElasticLoadBalancingV2LoadBalancerResult>("azure-native:awsconnector/v20241201:getElasticLoadBalancingV2LoadBalancer", args ?? new GetElasticLoadBalancingV2LoadBalancerArgs(), options.WithDefaults());
        ...
        public static Output<GetElasticLoadBalancingV2LoadBalancerResult> Invoke(GetElasticLoadBalancingV2LoadBalancerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetElasticLoadBalancingV2LoadBalancerResult>("azure-native:awsconnector/v20241201:getElasticLoadBalancingV2LoadBalancer", args ?? new GetElasticLoadBalancingV2LoadBalancerInvokeArgs(), options.WithDefaults());
