...
namespace Pulumi.AzureNative.AwsConnector.V20241201
{
    public static class GetEcsCluster
    {
        ...
        public static Task<GetEcsClusterResult> InvokeAsync(GetEcsClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEcsClusterResult>("azure-native:awsconnector/v20241201:getEcsCluster", args ?? new GetEcsClusterArgs(), options.WithDefaults());
