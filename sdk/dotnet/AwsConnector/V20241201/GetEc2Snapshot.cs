...
namespace Pulumi.AzureNative.AwsConnector.V20241201
{
    public static class GetEc2Snapshot
    {
        ...
        public static Task<GetEc2SnapshotResult> InvokeAsync(GetEc2SnapshotArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEc2SnapshotResult>("azure-native:awsconnector/v20241201:getEc2Snapshot", args ?? new GetEc2SnapshotArgs(), options.WithDefaults());
