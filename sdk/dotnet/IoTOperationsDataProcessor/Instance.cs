...
namespace Pulumi.AzureNative.IoTOperationsDataProcessor
{
    ...
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsdataprocessor:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsdataprocessor:Instance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:iotoperationsdataprocessor/v20231004preview:Instance" },
                    new global::Pulumi.Alias { Type = "azure-native_iotoperationsdataprocessor_v20231004preview:iotoperationsdataprocessor:Instance" },
                },
            };
