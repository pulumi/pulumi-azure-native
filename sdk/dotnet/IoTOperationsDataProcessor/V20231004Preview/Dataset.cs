...
namespace Pulumi.AzureNative.IoTOperationsDataProcessor.V20231004Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperationsdataprocessor/v20231004preview:Dataset")]
    public partial class Dataset : global::Pulumi.CustomResource
    {
        ...
        public Dataset(string name, DatasetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsdataprocessor/v20231004preview:Dataset", name, args ?? new DatasetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dataset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsdataprocessor/v20231004preview:Dataset", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:iotoperationsdataprocessor:Dataset" },
                },
            };
