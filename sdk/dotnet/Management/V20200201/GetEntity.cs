...
namespace Pulumi.AzureNative.Management.V20200201
{
    public static class GetEntity
    {
        ...
        public static Task<GetEntityResult> InvokeAsync(GetEntityArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEntityResult>("azure-native:management/v20200201:getEntity", args ?? new GetEntityArgs(), options.WithDefaults());

        /// <summary>
        /// Describes the result of the request to view entities.
        /// </summary>
        public static Output<GetEntityResult> Invoke(GetEntityInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEntityResult>("azure-native:management/v20200201:getEntity", args ?? new GetEntityInvokeArgs(), options.WithDefaults());
    }
