...
namespace Pulumi.AzureNextGen.Management.V20200201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:management/v20200201:HierarchySetting")]
    public partial class HierarchySetting : Pulumi.CustomResource
    {
        ...
        public HierarchySetting(string name, HierarchySettingArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:management/v20200201:HierarchySetting", name, args ?? new HierarchySettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HierarchySetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:management/v20200201:HierarchySetting", name, null, MakeResourceOptions(options, id))
        {
        }
