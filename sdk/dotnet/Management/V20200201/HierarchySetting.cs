...
namespace Pulumi.AzureNative.Management.V20200201
{
    ...
    public partial class HierarchySetting : global::Pulumi.CustomResource
    {
        ...
        public HierarchySetting(string name, HierarchySettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:management/v20200201:HierarchySetting", name, args ?? new HierarchySettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HierarchySetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:management/v20200201:HierarchySetting", name, null, MakeResourceOptions(options, id))
        {
        }
