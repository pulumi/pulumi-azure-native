...
namespace Pulumi.AzureNextGen.Management.V20200301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:management/v20200301:PolicySetDefinitionAtManagementGroup")]
    public partial class PolicySetDefinitionAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public PolicySetDefinitionAtManagementGroup(string name, PolicySetDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:management/v20200301:PolicySetDefinitionAtManagementGroup", name, args ?? new PolicySetDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:management/v20200301:PolicySetDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:management/v20180501:PolicySetDefinitionAtManagementGroup"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:management/v20200901:PolicySetDefinitionAtManagementGroup"},
                },
            };
    ...
    public sealed class PolicySetDefinitionAtManagementGroupArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNextGen.Management.V20200301.PolicyType>? PolicyType { get; set; }
