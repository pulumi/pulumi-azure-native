...
namespace Pulumi.AzureRM.Management.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policySetDefinitionAtManagementGroup = new AzureRM.Management.V20200301.PolicySetDefinitionAtManagementGroup("policySetDefinitionAtManagementGroup", new AzureRM.Management.V20200301.PolicySetDefinitionAtManagementGroupArgs
    ///         {
    ...
    ///             PolicyDefinitions = 
    ///             {
    ///                 new AzureRM.Management.V20200301.Inputs.PolicyDefinitionReferenceArgs
    ///                 {
    ///                     Parameters = 
    ///                     {
    ///                         { "listOfAllowedSKUs", new AzureRM.Management.V20200301.Inputs.ParameterValuesValueArgs
    ///                         {
    ///                             Value = 
    ///                             {
    ///                                 "Standard_GRS",
    ...
    ///                     Parameters = 
    ///                     {
    ///                         { "prefix", new AzureRM.Management.V20200301.Inputs.ParameterValuesValueArgs
    ///                         {
    ///                             Value = "DeptA",
    ///                         } },
    ///                         { "suffix", new AzureRM.Management.V20200301.Inputs.ParameterValuesValueArgs
    ///                         {
    ///                             Value = "-LC",
    ///                         } },
    ///                     },
    ...
    ///             {
    ///                 new AzureRM.Management.V20200301.Inputs.PolicyDefinitionGroupArgs
    ///                 {
    ...
    public partial class PolicySetDefinitionAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public PolicySetDefinitionAtManagementGroup(string name, PolicySetDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:management/v20200301:PolicySetDefinitionAtManagementGroup", name, args ?? new PolicySetDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:management/v20200301:PolicySetDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
