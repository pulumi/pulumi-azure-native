...
namespace Pulumi.AzureRM.Management.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policyDefinitionAtManagementGroup = new AzureRM.Management.V20200301.PolicyDefinitionAtManagementGroup("policyDefinitionAtManagementGroup", new AzureRM.Management.V20200301.PolicyDefinitionAtManagementGroupArgs
    ///         {
    ...
    ///             Parameters = 
    ///             {
    ///                 { "prefix", new AzureRM.Management.V20200301.Inputs.ParameterDefinitionsValueArgs
    ///                 {
    ///                     Metadata = new AzureRM.Management.V20200301.Inputs.ParameterDefinitionsValueMetadataArgs
    ///                     {
    ...
    ///                     Type = "String",
    ///                 } },
    ///                 { "suffix", new AzureRM.Management.V20200301.Inputs.ParameterDefinitionsValueArgs
    ///                 {
    ///                     Metadata = new AzureRM.Management.V20200301.Inputs.ParameterDefinitionsValueMetadataArgs
    ///                     {
    ...
    public partial class PolicyDefinitionAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionAtManagementGroup(string name, PolicyDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:management/v20200301:PolicyDefinitionAtManagementGroup", name, args ?? new PolicyDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:management/v20200301:PolicyDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:management/v20161201:PolicyDefinitionAtManagementGroup"},
