...
namespace Pulumi.AzureRM.Management.V20190101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policyDefinitionAtManagementGroup = new AzureRM.Management.V20190101.PolicyDefinitionAtManagementGroup("policyDefinitionAtManagementGroup", new AzureRM.Management.V20190101.PolicyDefinitionAtManagementGroupArgs
    ///         {
    ...
    public partial class PolicyDefinitionAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionAtManagementGroup(string name, PolicyDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:management/v20190101:PolicyDefinitionAtManagementGroup", name, args ?? new PolicyDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:management/v20190101:PolicyDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
