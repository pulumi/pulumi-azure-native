...
namespace Pulumi.AzureRM.Management.V20180501
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var policySetDefinitionAtManagementGroup = new AzureRM.Management.V20180501.PolicySetDefinitionAtManagementGroup("policySetDefinitionAtManagementGroup", new AzureRM.Management.V20180501.PolicySetDefinitionAtManagementGroupArgs
    ///         {
    ...
    ///             PolicyDefinitions = 
    ///             {
    ///                 new AzureRM.Management.V20180501.Inputs.PolicyDefinitionReferenceArgs
    ///                 {
    ///                     Parameters = 
    ///                     {
    ///                         { "listOfAllowedSKUs", 
    ...
    public partial class PolicySetDefinitionAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public PolicySetDefinitionAtManagementGroup(string name, PolicySetDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:management/v20180501:PolicySetDefinitionAtManagementGroup", name, args ?? new PolicySetDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:management/v20180501:PolicySetDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
