...
namespace Pulumi.AzureRM.Management.V20171101Preview
{
    ...
    public partial class ManagementGroup : Pulumi.CustomResource
    {
        ...
        public ManagementGroup(string name, ManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:management/v20171101preview:ManagementGroup", name, args ?? new ManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:management/v20171101preview:ManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
