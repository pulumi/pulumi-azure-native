...
namespace Pulumi.AzureNative.Management.V20230401
{
    public static class GetManagementGroup
    {
        ...
        public static Task<GetManagementGroupResult> InvokeAsync(GetManagementGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagementGroupResult>("azure-native:management/v20230401:getManagementGroup", args ?? new GetManagementGroupArgs(), options.WithDefaults());
