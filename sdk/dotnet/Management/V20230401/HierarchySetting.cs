...
namespace Pulumi.AzureNative.Management.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:management/v20230401:HierarchySetting")]
    public partial class HierarchySetting : global::Pulumi.CustomResource
    {
        ...
        public HierarchySetting(string name, HierarchySettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:management/v20230401:HierarchySetting", name, args ?? new HierarchySettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HierarchySetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:management/v20230401:HierarchySetting", name, null, MakeResourceOptions(options, id))
        {
        }
