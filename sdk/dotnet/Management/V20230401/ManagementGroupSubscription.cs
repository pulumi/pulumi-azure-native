...
namespace Pulumi.AzureNative.Management.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:management/v20230401:ManagementGroupSubscription")]
    public partial class ManagementGroupSubscription : global::Pulumi.CustomResource
    {
        ...
        public ManagementGroupSubscription(string name, ManagementGroupSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:management/v20230401:ManagementGroupSubscription", name, args ?? new ManagementGroupSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroupSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:management/v20230401:ManagementGroupSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
