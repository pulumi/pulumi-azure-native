...
namespace Pulumi.AzureNative.Management.V20230401
{
    public static class GetEntity
    {
        ...
        public static Task<GetEntityResult> InvokeAsync(GetEntityArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEntityResult>("azure-native:management/v20230401:getEntity", args ?? new GetEntityArgs(), options.WithDefaults());

        /// <summary>
        /// List all entities (Management Groups, Subscriptions, etc.) for the authenticated user.
        /// </summary>
        public static Output<GetEntityResult> Invoke(GetEntityInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEntityResult>("azure-native:management/v20230401:getEntity", args ?? new GetEntityInvokeArgs(), options.WithDefaults());
    }
