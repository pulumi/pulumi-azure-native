...
namespace Pulumi.AzureRM.Management.V20180301
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var policyDefinitionAtManagementGroup = new AzureRM.Management.V20180301.PolicyDefinitionAtManagementGroup("policyDefinitionAtManagementGroup", new AzureRM.Management.V20180301.PolicyDefinitionAtManagementGroupArgs
    ///         {
    ...
    public partial class PolicyDefinitionAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionAtManagementGroup(string name, PolicyDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:management/v20180301:PolicyDefinitionAtManagementGroup", name, args ?? new PolicyDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:management/v20180301:PolicyDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
