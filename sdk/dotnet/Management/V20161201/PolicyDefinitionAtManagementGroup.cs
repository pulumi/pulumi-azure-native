...
namespace Pulumi.AzureNextGen.Management.V20161201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:management/v20161201:PolicyDefinitionAtManagementGroup")]
    ...
    public sealed class PolicyDefinitionAtManagementGroupArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNextGen.Management.V20161201.PolicyMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNextGen.Management.V20161201.PolicyType>? PolicyType { get; set; }
