...
namespace Pulumi.AzureNextGen.Management.V20180301Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:management/v20180301preview:ManagementGroup")]
    public partial class ManagementGroup : Pulumi.CustomResource
    {
        ...
        public ManagementGroup(string name, ManagementGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-nextgen:management/v20180301preview:ManagementGroup", name, args ?? new ManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:management/v20180301preview:ManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
