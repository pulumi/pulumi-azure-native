...
namespace Pulumi.AzureNextGen.Management.Latest
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:management/latest:PolicyDefinitionAtManagementGroup")]
    public partial class PolicyDefinitionAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionAtManagementGroup(string name, PolicyDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:management/latest:PolicyDefinitionAtManagementGroup", name, args ?? new PolicyDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:management/latest:PolicyDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyDefinitionAtManagementGroupArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNextGen.Management.Latest.PolicyType>? PolicyType { get; set; }
