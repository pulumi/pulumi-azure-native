...
namespace Pulumi.AzureRM.Management.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var blueprint = new AzureRM.Management.Latest.Blueprint("blueprint", new AzureRM.Management.Latest.BlueprintArgs
    ///         {
    ...
    ///             Parameters = 
    ///             {
    ///                 { "costCenter", new AzureRM.Management.Latest.Inputs.ParameterDefinitionArgs
    ///                 {
    ///                     Metadata = 
    ///                     {
    ...
    ///                     Type = "string",
    ///                 } },
    ///                 { "owners", new AzureRM.Management.Latest.Inputs.ParameterDefinitionArgs
    ///                 {
    ///                     Metadata = 
    ///                     {
    ...
    ///                     Type = "array",
    ///                 } },
    ///                 { "storageAccountType", new AzureRM.Management.Latest.Inputs.ParameterDefinitionArgs
    ///                 {
    ///                     Metadata = 
    ///                     {
    ...
    ///             ResourceGroups = 
    ///             {
    ///                 { "storageRG", new AzureRM.Management.Latest.Inputs.ResourceGroupDefinitionArgs
    ///                 {
    ///                     Metadata = 
    ///                     {
    ...
    public partial class Blueprint : Pulumi.CustomResource
    {
        ...
        public Blueprint(string name, BlueprintArgs args, CustomResourceOptions? options = null)
            : base("azurerm:management/latest:Blueprint", name, args ?? new BlueprintArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Blueprint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:management/latest:Blueprint", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:management/v20171111preview:Blueprint"},
                },
            };
