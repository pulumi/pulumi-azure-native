...
namespace Pulumi.AzureRM.Management.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var artifact = new AzureRM.Management.Latest.Artifact("artifact", new AzureRM.Management.Latest.ArtifactArgs
    ///         {
    ...
    public partial class Artifact : Pulumi.CustomResource
    {
        ...
        public Artifact(string name, ArtifactArgs args, CustomResourceOptions? options = null)
            : base("azurerm:management/latest:Artifact", name, args ?? new ArtifactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Artifact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:management/latest:Artifact", name, null, MakeResourceOptions(options, id))
        {
        }
