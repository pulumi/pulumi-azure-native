...
namespace Pulumi.AzureNative.Management.V20200501
{
    ...
    /// {
    ///     var managementGroup = new AzureNative.Management.V20200501.ManagementGroup("managementGroup", new()
    ///     {
    ///         Details = new AzureNative.Management.V20200501.Inputs.CreateManagementGroupDetailsArgs
    ///         {
    ///             Parent = new AzureNative.Management.V20200501.Inputs.CreateParentGroupInfoArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:management/v20200501:ManagementGroup ChildGroup /providers/Microsoft.Management/managementGroups/ChildGroup 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:management/v20200501:ManagementGroup")]
    public partial class ManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public ManagementGroup(string name, ManagementGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:management/v20200501:ManagementGroup", name, args ?? new ManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:management/v20200501:ManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
