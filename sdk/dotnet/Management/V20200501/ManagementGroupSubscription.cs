...
namespace Pulumi.AzureRM.Management.V20200501
{
    ...
    public partial class ManagementGroupSubscription : Pulumi.CustomResource
    {
        ...
        public ManagementGroupSubscription(string name, ManagementGroupSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:management/v20200501:ManagementGroupSubscription", name, args ?? new ManagementGroupSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroupSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:management/v20200501:ManagementGroupSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:management/preview:ManagementGroupSubscription"},
                },
            };
