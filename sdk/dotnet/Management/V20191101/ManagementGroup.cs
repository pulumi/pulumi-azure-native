...
namespace Pulumi.AzureNextGen.Management.V20191101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:management/v20191101:ManagementGroup")]
    public partial class ManagementGroup : Pulumi.CustomResource
    {
        ...
        private ManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:management/v20191101:ManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
