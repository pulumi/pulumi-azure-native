...
namespace Pulumi.AzureRM.Management.V20190801
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var deploymentAtManagementGroupScope = new AzureRM.Management.V20190801.DeploymentAtManagementGroupScope("deploymentAtManagementGroupScope", new AzureRM.Management.V20190801.DeploymentAtManagementGroupScopeArgs
    ///         {
    ...
    public partial class DeploymentAtManagementGroupScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtManagementGroupScope(string name, DeploymentAtManagementGroupScopeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:management/v20190801:DeploymentAtManagementGroupScope", name, args ?? new DeploymentAtManagementGroupScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtManagementGroupScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:management/v20190801:DeploymentAtManagementGroupScope", name, null, MakeResourceOptions(options, id))
        {
        }
