...
namespace Pulumi.AzureRM.Management.Preview
{
    public static class GetManagementGroupSubscription
    {
        public static Task<GetManagementGroupSubscriptionResult> InvokeAsync(GetManagementGroupSubscriptionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagementGroupSubscriptionResult>("azurerm:management/preview:getManagementGroupSubscription", args ?? new GetManagementGroupSubscriptionArgs(), options.WithVersion());
    }
