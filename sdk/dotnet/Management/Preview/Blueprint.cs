...
namespace Pulumi.AzureRM.Management.Preview
{
    ...
    public partial class Blueprint : Pulumi.CustomResource
    {
        ...
        public Blueprint(string name, BlueprintArgs args, CustomResourceOptions? options = null)
            : base("azurerm:management/preview:Blueprint", name, args ?? new BlueprintArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Blueprint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:management/preview:Blueprint", name, null, MakeResourceOptions(options, id))
        {
        }
