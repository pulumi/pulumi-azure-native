...
namespace Pulumi.AzureRM.Management.Preview
{
    ...
    public partial class HierarchySetting : Pulumi.CustomResource
    {
        ...
        public HierarchySetting(string name, HierarchySettingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:management/preview:HierarchySetting", name, args ?? new HierarchySettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HierarchySetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:management/preview:HierarchySetting", name, null, MakeResourceOptions(options, id))
        {
        }
