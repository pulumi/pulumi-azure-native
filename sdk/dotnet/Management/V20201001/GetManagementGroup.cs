...
{
    [Obsolete(@"azure-native:management/v20201001:ManagementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:management/v20210401:ManagementGroup to guarantee forwards compatibility.")]
    public static class GetManagementGroup
    {
        ...
        public static Task<GetManagementGroupResult> InvokeAsync(GetManagementGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagementGroupResult>("azure-native:management/v20201001:getManagementGroup", args ?? new GetManagementGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Get the details of the management group.
        /// </summary>
        public static Output<GetManagementGroupResult> Invoke(GetManagementGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagementGroupResult>("azure-native:management/v20201001:getManagementGroup", args ?? new GetManagementGroupInvokeArgs(), options.WithDefaults());
    }
