...
namespace Pulumi.AzureNative.Management.V20201001
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:management/v20201001:HierarchySetting is being removed in the next major version of this provider. Upgrade to at least azure-native:management/v20210401:HierarchySetting to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:management/v20201001:HierarchySetting")]
    public partial class HierarchySetting : global::Pulumi.CustomResource
    {
        ...
        public HierarchySetting(string name, HierarchySettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:management/v20201001:HierarchySetting", name, args ?? new HierarchySettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HierarchySetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:management/v20201001:HierarchySetting", name, null, MakeResourceOptions(options, id))
        {
        }
