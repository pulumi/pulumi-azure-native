...
namespace Pulumi.AzureNative.Management.V20201001
{
    ...
    public partial class ManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public ManagementGroup(string name, ManagementGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:management/v20201001:ManagementGroup", name, args ?? new ManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:management/v20201001:ManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
