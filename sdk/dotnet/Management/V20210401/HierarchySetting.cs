...
namespace Pulumi.AzureNative.Management.V20210401
{
    ...
    /// {
    ///     var hierarchySetting = new AzureNative.Management.V20210401.HierarchySetting("hierarchySetting", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:management/v20210401:HierarchySetting")]
    public partial class HierarchySetting : global::Pulumi.CustomResource
    {
        ...
        public HierarchySetting(string name, HierarchySettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:management/v20210401:HierarchySetting", name, args ?? new HierarchySettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HierarchySetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:management/v20210401:HierarchySetting", name, null, MakeResourceOptions(options, id))
        {
        }
