...
namespace Pulumi.AzureNative.Management.V20210401
{
    public static class GetManagementGroup
    {
        ...
        public static Task<GetManagementGroupResult> InvokeAsync(GetManagementGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagementGroupResult>("azure-native:management/v20210401:getManagementGroup", args ?? new GetManagementGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Get the details of the management group.
        /// </summary>
        public static Output<GetManagementGroupResult> Invoke(GetManagementGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagementGroupResult>("azure-native:management/v20210401:getManagementGroup", args ?? new GetManagementGroupInvokeArgs(), options.WithDefaults());
    }
