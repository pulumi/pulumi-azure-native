...
namespace Pulumi.AzureNative.Management.V20210401
{
    ...
    /// {
    ///     var managementGroup = new AzureNative.Management.V20210401.ManagementGroup("managementGroup", new()
    ///     {
    ///         Details = new AzureNative.Management.V20210401.Inputs.CreateManagementGroupDetailsArgs
    ///         {
    ///             Parent = new AzureNative.Management.V20210401.Inputs.CreateParentGroupInfoArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:management/v20210401:ManagementGroup")]
    public partial class ManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public ManagementGroup(string name, ManagementGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:management/v20210401:ManagementGroup", name, args ?? new ManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:management/v20210401:ManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
