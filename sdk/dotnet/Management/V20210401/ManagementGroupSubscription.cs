...
namespace Pulumi.AzureNative.Management.V20210401
{
    ...
    /// {
    ///     var managementGroupSubscription = new AzureNative.Management.V20210401.ManagementGroupSubscription("managementGroupSubscription", new()
    ///     {
    ///         GroupId = "Group",
    ///     });
    /// 
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:management/v20210401:ManagementGroupSubscription")]
    public partial class ManagementGroupSubscription : global::Pulumi.CustomResource
    {
        ...
        public ManagementGroupSubscription(string name, ManagementGroupSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:management/v20210401:ManagementGroupSubscription", name, args ?? new ManagementGroupSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroupSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:management/v20210401:ManagementGroupSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:management:ManagementGroupSubscription"},
