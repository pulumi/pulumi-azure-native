...
namespace Pulumi.AzureNextGen.Management.V20180101Preview
{
    public static class GetManagementGroup
    {
        public static Task<GetManagementGroupResult> InvokeAsync(GetManagementGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagementGroupResult>("azure-nextgen:management/v20180101preview:getManagementGroup", args ?? new GetManagementGroupArgs(), options.WithVersion());
    }
