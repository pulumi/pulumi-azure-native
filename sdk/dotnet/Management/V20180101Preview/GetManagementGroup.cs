...
namespace Pulumi.AzureNative.Management.V20180101Preview
{
    public static class GetManagementGroup
    {
        ...
        public static Task<GetManagementGroupResult> InvokeAsync(GetManagementGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagementGroupResult>("azure-native:management/v20180101preview:getManagementGroup", args ?? new GetManagementGroupArgs(), options.WithVersion());

        /// <summary>
        /// The management group details.
        /// </summary>
        public static Output<GetManagementGroupResult> Invoke(GetManagementGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetManagementGroupResult>("azure-native:management/v20180101preview:getManagementGroup", args ?? new GetManagementGroupInvokeArgs(), options.WithVersion());
    }
