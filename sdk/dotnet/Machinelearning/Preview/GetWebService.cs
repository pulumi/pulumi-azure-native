...
namespace Pulumi.AzureRM.MachineLearning.Preview
{
    public static class GetWebService
    {
        public static Task<GetWebServiceResult> InvokeAsync(GetWebServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebServiceResult>("azurerm:machinelearning/preview:getWebService", args ?? new GetWebServiceArgs(), options.WithVersion());
    }
