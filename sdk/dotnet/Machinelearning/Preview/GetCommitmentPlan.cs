...
namespace Pulumi.AzureRM.MachineLearning.Preview
{
    public static class GetCommitmentPlan
    {
        public static Task<GetCommitmentPlanResult> InvokeAsync(GetCommitmentPlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCommitmentPlanResult>("azurerm:machinelearning/preview:getCommitmentPlan", args ?? new GetCommitmentPlanArgs(), options.WithVersion());
    }
