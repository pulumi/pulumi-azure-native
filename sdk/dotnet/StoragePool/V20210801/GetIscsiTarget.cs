...
namespace Pulumi.AzureNative.StoragePool.V20210801
{
    public static class GetIscsiTarget
    {
        ...
        public static Task<GetIscsiTargetResult> InvokeAsync(GetIscsiTargetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIscsiTargetResult>("azure-native:storagepool/v20210801:getIscsiTarget", args ?? new GetIscsiTargetArgs(), options.WithDefaults());

        /// <summary>
        /// Response for iSCSI Target requests.
        /// </summary>
        public static Output<GetIscsiTargetResult> Invoke(GetIscsiTargetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIscsiTargetResult>("azure-native:storagepool/v20210801:getIscsiTarget", args ?? new GetIscsiTargetInvokeArgs(), options.WithDefaults());
    }
