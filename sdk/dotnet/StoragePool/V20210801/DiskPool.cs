...
namespace Pulumi.AzureNative.StoragePool.V20210801
{
    ...
    public partial class DiskPool : Pulumi.CustomResource
    {
        ...
        public DiskPool(string name, DiskPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagepool/v20210801:DiskPool", name, args ?? new DiskPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagepool/v20210801:DiskPool", name, null, MakeResourceOptions(options, id))
        {
        }
