...
namespace Pulumi.AzureNative.StoragePool.V20210801
{
    public static class GetDiskPool
    {
        ...
        public static Task<GetDiskPoolResult> InvokeAsync(GetDiskPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDiskPoolResult>("azure-native:storagepool/v20210801:getDiskPool", args ?? new GetDiskPoolArgs(), options.WithVersion());

        /// <summary>
        /// Response for Disk Pool request.
        /// </summary>
        public static Output<GetDiskPoolResult> Invoke(GetDiskPoolInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDiskPoolResult>("azure-native:storagepool/v20210801:getDiskPool", args ?? new GetDiskPoolInvokeArgs(), options.WithVersion());
    }
