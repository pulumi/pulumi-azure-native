...
namespace Pulumi.AzureNative.StoragePool.V20210401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storagepool/v20210401preview:IscsiTarget is being removed in the next major version of this provider. Upgrade to at least azure-native:storagepool/v20210801:IscsiTarget to guarantee forwards compatibility.")]
    ...
    public partial class IscsiTarget : global::Pulumi.CustomResource
    {
        ...
        public IscsiTarget(string name, IscsiTargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagepool/v20210401preview:IscsiTarget", name, args ?? new IscsiTargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IscsiTarget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagepool/v20210401preview:IscsiTarget", name, null, MakeResourceOptions(options, id))
        {
        }
