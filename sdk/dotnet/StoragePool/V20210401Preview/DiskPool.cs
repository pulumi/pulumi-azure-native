...
namespace Pulumi.AzureNative.StoragePool.V20210401Preview
{
    ...
    public partial class DiskPool : global::Pulumi.CustomResource
    {
        ...
        public DiskPool(string name, DiskPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagepool/v20210401preview:DiskPool", name, args ?? new DiskPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagepool/v20210401preview:DiskPool", name, null, MakeResourceOptions(options, id))
        {
        }
