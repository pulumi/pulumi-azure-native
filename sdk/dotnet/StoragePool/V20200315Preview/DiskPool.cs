...
namespace Pulumi.AzureNative.StoragePool.V20200315Preview
{
    ...
    /// {
    ///     var diskPool = new AzureNative.StoragePool.V20200315Preview.DiskPool("diskPool", new()
    ///     {
    ...
    ///         Disks = new[]
    ///         {
    ///             new AzureNative.StoragePool.V20200315Preview.Inputs.DiskArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:storagepool/v20200315preview:DiskPool myDiskPool /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.StoragePool/diskPools/myDiskPool 
    /// ```
    /// </summary>
