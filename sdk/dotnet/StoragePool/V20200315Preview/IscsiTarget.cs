...
namespace Pulumi.AzureNative.StoragePool.V20200315Preview
{
    ...
    /// {
    ///     var iscsiTarget = new AzureNative.StoragePool.V20200315Preview.IscsiTarget("iscsiTarget", new()
    ///     {
    ...
    ///         Tpgs = new[]
    ///         {
    ///             new AzureNative.StoragePool.V20200315Preview.Inputs.TargetPortalGroupCreateArgs
    ///             {
    ///                 Acls = new[]
    ///                 {
    ///                     new AzureNative.StoragePool.V20200315Preview.Inputs.AclArgs
    ///                     {
    ...
    ///                     },
    ///                 },
    ///                 Attributes = new AzureNative.StoragePool.V20200315Preview.Inputs.AttributesArgs
    ///                 {
    ///                     Authentication = true,
    ...
    ///                 Luns = new[]
    ///                 {
    ///                     new AzureNative.StoragePool.V20200315Preview.Inputs.IscsiLunArgs
    ///                     {
    ...
    public partial class IscsiTarget : global::Pulumi.CustomResource
    {
        ...
        public IscsiTarget(string name, IscsiTargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagepool/v20200315preview:IscsiTarget", name, args ?? new IscsiTargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IscsiTarget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagepool/v20200315preview:IscsiTarget", name, null, MakeResourceOptions(options, id))
        {
        }
