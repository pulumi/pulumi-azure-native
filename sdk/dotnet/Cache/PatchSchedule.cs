...
namespace Pulumi.AzureNextGen.Cache
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:cache:PatchSchedule")]
    public partial class PatchSchedule : Pulumi.CustomResource
    {
        ...
        public PatchSchedule(string name, PatchScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache:PatchSchedule", name, args ?? new PatchScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PatchSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache:PatchSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
