...
namespace Pulumi.AzureNative.Cache
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache:AccessPolicy")]
    public partial class AccessPolicy : global::Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
