...
namespace Pulumi.AzureRM.Cache.Preview
{
    public static class GetPatchSchedule
    {
        public static Task<GetPatchScheduleResult> InvokeAsync(GetPatchScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPatchScheduleResult>("azurerm:cache/preview:getPatchSchedule", args ?? new GetPatchScheduleArgs(), options.WithVersion());
    }
