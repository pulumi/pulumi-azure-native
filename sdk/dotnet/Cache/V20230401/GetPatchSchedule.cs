...
namespace Pulumi.AzureNative.Cache.V20230401
{
    public static class GetPatchSchedule
    {
        ...
        public static Task<GetPatchScheduleResult> InvokeAsync(GetPatchScheduleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPatchScheduleResult>("azure-native:cache/v20230401:getPatchSchedule", args ?? new GetPatchScheduleArgs(), options.WithDefaults());
