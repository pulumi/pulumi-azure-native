...
namespace Pulumi.AzureNative.Cache.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20230401:Redis")]
    public partial class Redis : global::Pulumi.CustomResource
    {
        ...
        public Redis(string name, RedisArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230401:Redis", name, args ?? new RedisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Redis(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230401:Redis", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RedisArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20230401.TlsVersion>? MinimumTlsVersion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20230401.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
