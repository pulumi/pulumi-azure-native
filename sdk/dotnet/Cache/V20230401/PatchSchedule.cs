...
namespace Pulumi.AzureNative.Cache.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20230401:PatchSchedule")]
    public partial class PatchSchedule : global::Pulumi.CustomResource
    {
        ...
        public PatchSchedule(string name, PatchScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230401:PatchSchedule", name, args ?? new PatchScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PatchSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230401:PatchSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
