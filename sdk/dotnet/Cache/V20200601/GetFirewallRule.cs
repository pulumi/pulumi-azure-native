...
namespace Pulumi.AzureNextGen.Cache.V20200601
{
    public static class GetFirewallRule
    {
        public static Task<GetFirewallRuleResult> InvokeAsync(GetFirewallRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallRuleResult>("azure-nextgen:cache/v20200601:getFirewallRule", args ?? new GetFirewallRuleArgs(), options.WithVersion());
    }
