...
namespace Pulumi.AzureNextGen.Cache.V20200601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:cache/v20200601:LinkedServer")]
    ...
    public sealed class LinkedServerArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Cache.V20200601.ReplicationRole> ServerRole { get; set; } = null!;
