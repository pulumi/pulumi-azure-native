...
namespace Pulumi.AzureNative.Cache.V20200601
{
    ...
    /// {
    ///     var firewallRule = new AzureNative.Cache.V20200601.FirewallRule("firewallRule", new()
    ///     {
    ///         CacheName = "cache1",
    ///         EndIP = "192.168.1.4",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:cache/v20200601:FirewallRule cache1/rule1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Cache/Redis/cache1/firewallRules/rule1 
    /// ```
    /// </summary>
