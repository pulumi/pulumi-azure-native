...
namespace Pulumi.AzureNative.Cache.V20200601
{
    public static class GetPatchSchedule
    {
        ...
        public static Task<GetPatchScheduleResult> InvokeAsync(GetPatchScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPatchScheduleResult>("azure-native:cache/v20200601:getPatchSchedule", args ?? new GetPatchScheduleArgs(), options.WithVersion());

        /// <summary>
        /// Response to put/get patch schedules for Redis cache.
        /// </summary>
        public static Output<GetPatchScheduleResult> Invoke(GetPatchScheduleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPatchScheduleResult>("azure-native:cache/v20200601:getPatchSchedule", args ?? new GetPatchScheduleInvokeArgs(), options.WithVersion());
    }
