...
namespace Pulumi.AzureNextGen.Cache.V20200601
{
    public static class GetLinkedServer
    {
        public static Task<GetLinkedServerResult> InvokeAsync(GetLinkedServerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLinkedServerResult>("azure-nextgen:cache/v20200601:getLinkedServer", args ?? new GetLinkedServerArgs(), options.WithVersion());
    }
