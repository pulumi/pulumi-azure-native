...
namespace Pulumi.AzureNative.Cache.V20200601
{
    ...
    /// {
    ///     var redis = new AzureNative.Cache.V20200601.Redis("redis", new()
    ///     {
    ///         EnableNonSslPort = true,
    ///         Location = "West US",
    ///         MinimumTlsVersion = "1.2",
    ///         Name = "cache1",
    ///         RedisConfiguration = new AzureNative.Cache.V20200601.Inputs.RedisCommonPropertiesRedisConfigurationArgs
    ///         {
    ...
    ///         ShardCount = 2,
    ///         Sku = new AzureNative.Cache.V20200601.Inputs.SkuArgs
    ///         {
    ///             Capacity = 1,
    ///             Family = "P",
    ///             Name = "Premium",
