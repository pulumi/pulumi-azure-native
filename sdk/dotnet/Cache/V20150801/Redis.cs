...
namespace Pulumi.AzureRM.Cache.V20150801
{
    ...
    public partial class Redis : Pulumi.CustomResource
    {
        ...
        public Redis(string name, RedisArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20150801:Redis", name, args ?? new RedisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Redis(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20150801:Redis", name, null, MakeResourceOptions(options, id))
        {
        }
