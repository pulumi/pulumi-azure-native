...
namespace Pulumi.AzureNative.Cache.V20210201Preview
{
    ...
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20210201preview:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20210201preview:Database", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20210201Preview.Protocol>? ClientProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20210201Preview.ClusteringPolicy>? ClusteringPolicy { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20210201Preview.EvictionPolicy>? EvictionPolicy { get; set; }
