...
namespace Pulumi.AzureNative.Cache.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20240301:AccessPolicyAssignment")]
    public partial class AccessPolicyAssignment : global::Pulumi.CustomResource
    {
        ...
        public AccessPolicyAssignment(string name, AccessPolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240301:AccessPolicyAssignment", name, args ?? new AccessPolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240301:AccessPolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
