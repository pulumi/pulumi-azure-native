...
namespace Pulumi.AzureNative.Cache.V20240401Preview
{
    public static class ListRedisKeys
    {
        ...
        public static Task<ListRedisKeysResult> InvokeAsync(ListRedisKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListRedisKeysResult>("azure-native:cache/v20240401preview:listRedisKeys", args ?? new ListRedisKeysArgs(), options.WithDefaults());
