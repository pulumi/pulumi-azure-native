...
namespace Pulumi.AzureNative.Cache.V20240401Preview
{
    public static class GetAccessPolicyAssignment
    {
        ...
        public static Task<GetAccessPolicyAssignmentResult> InvokeAsync(GetAccessPolicyAssignmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccessPolicyAssignmentResult>("azure-native:cache/v20240401preview:getAccessPolicyAssignment", args ?? new GetAccessPolicyAssignmentArgs(), options.WithDefaults());
        ...
        public static Output<GetAccessPolicyAssignmentResult> Invoke(GetAccessPolicyAssignmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccessPolicyAssignmentResult>("azure-native:cache/v20240401preview:getAccessPolicyAssignment", args ?? new GetAccessPolicyAssignmentInvokeArgs(), options.WithDefaults());
