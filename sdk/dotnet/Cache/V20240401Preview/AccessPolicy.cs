...
namespace Pulumi.AzureNative.Cache.V20240401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20240401preview:AccessPolicy")]
    public partial class AccessPolicy : global::Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240401preview:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240401preview:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
