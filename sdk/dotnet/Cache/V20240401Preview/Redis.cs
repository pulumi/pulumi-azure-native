...
namespace Pulumi.AzureNative.Cache.V20240401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20240401preview:Redis")]
    public partial class Redis : global::Pulumi.CustomResource
    {
        ...
        public Redis(string name, RedisArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240401preview:Redis", name, args ?? new RedisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Redis(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240401preview:Redis", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RedisArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240401Preview.TlsVersion>? MinimumTlsVersion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240401Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        /// </summary>
        [Input("updateChannel")]
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240401Preview.UpdateChannel>? UpdateChannel { get; set; }

        /// <summary>
        /// Optional: Specifies how availability zones are allocated to the Redis cache. 'Automatic' enables zone redundancy and Azure will select zones based on regional availability and capacity. 'UserDefined' will select availability zones passed in by you using the 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocation' is not passed, it will be set to 'UserDefined' when zones are passed in, otherwise, will be set to 'NoZones'
        /// </summary>
        [Input("zonalAllocationPolicy")]
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240401Preview.ZonalAllocationPolicy>? ZonalAllocationPolicy { get; set; }
