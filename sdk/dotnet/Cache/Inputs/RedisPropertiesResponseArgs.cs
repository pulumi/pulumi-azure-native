...
namespace Pulumi.AzureRM.Cache.Inputs
{
    ...
    /// </summary>
    public sealed class RedisPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The keys of the Redis cache - not set if this object is not the response to Create or Update redis cache
        /// </summary>
        [Input("accessKeys", required: true)]
        public Input<Inputs.RedisAccessKeysResponseArgs> AccessKeys { get; set; } = null!;
        ...
        private InputList<Inputs.RedisLinkedServerResponseArgs>? _linkedServers;

        /// <summary>
        /// List of the linked servers associated with the cache
        /// </summary>
        public InputList<Inputs.RedisLinkedServerResponseArgs> LinkedServers
        {
            get => _linkedServers ?? (_linkedServers = new InputList<Inputs.RedisLinkedServerResponseArgs>());
        ...
        public RedisPropertiesResponseArgs()
        {
        }
    }
}
