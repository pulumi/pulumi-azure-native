...
namespace Pulumi.AzureNative.Cache.V20220601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:cache/v20220601:PatchSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:PatchSchedule to guarantee forwards compatibility.")]
    ...
    public partial class PatchSchedule : global::Pulumi.CustomResource
    {
        ...
        public PatchSchedule(string name, PatchScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20220601:PatchSchedule", name, args ?? new PatchScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PatchSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20220601:PatchSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
