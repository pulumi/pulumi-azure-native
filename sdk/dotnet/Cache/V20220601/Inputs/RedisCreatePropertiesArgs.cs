...
namespace Pulumi.AzureNative.Cache.V20220601.Inputs
{
    ...
    public sealed class RedisCreatePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20220601.TlsVersion>? MinimumTlsVersion { get; set; }

        /// <summary>
        /// Whether or not public endpoint access is allowed for this cache.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'. If 'Disabled', private endpoints are the exclusive access method. Default value is 'Enabled'
        /// </summary>
        [Input("publicNetworkAccess")]
        public InputUnion<string, Pulumi.AzureNative.Cache.V20220601.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
