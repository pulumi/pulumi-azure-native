...
namespace Pulumi.AzureNative.Cache.V20220601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:cache/v20220601:Redis is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:Redis to guarantee forwards compatibility.")]
    ...
    public partial class Redis : global::Pulumi.CustomResource
    {
        ...
        public Redis(string name, RedisArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20220601:Redis", name, args ?? new RedisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Redis(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20220601:Redis", name, null, MakeResourceOptions(options, id))
        {
        }
