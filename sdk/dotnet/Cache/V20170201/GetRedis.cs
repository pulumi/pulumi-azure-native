...
namespace Pulumi.AzureNative.Cache.V20170201
{
    public static class GetRedis
    {
        ...
        public static Task<GetRedisResult> InvokeAsync(GetRedisArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRedisResult>("azure-native:cache/v20170201:getRedis", args ?? new GetRedisArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Redis cache (resource description).
        /// </summary>
        public static Output<GetRedisResult> Invoke(GetRedisInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRedisResult>("azure-native:cache/v20170201:getRedis", args ?? new GetRedisInvokeArgs(), options.WithDefaults());
    }
