...
namespace Pulumi.AzureNextGen.Cache.V20170201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:cache/v20170201:FirewallRule")]
    public partial class FirewallRule : Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache/v20170201:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache/v20170201:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
