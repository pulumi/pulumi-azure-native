...
namespace Pulumi.AzureNative.Cache.V20170201
{
    ...
    public partial class Redis : Pulumi.CustomResource
    {
        ...
        public Redis(string name, RedisArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20170201:Redis", name, args ?? new RedisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Redis(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20170201:Redis", name, null, MakeResourceOptions(options, id))
        {
        }
