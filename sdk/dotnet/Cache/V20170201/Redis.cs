...
namespace Pulumi.AzureRM.Cache.V20170201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var redis = new AzureRM.Cache.V20170201.Redis("redis", new AzureRM.Cache.V20170201.RedisArgs
    ///         {
    ...
    ///             ShardCount = 2,
    ///             Sku = new AzureRM.Cache.V20170201.Inputs.SkuArgs
    ///             {
    ///                 Capacity = 1,
    ///                 Family = "P",
    ///                 Name = "Premium",
    ...
    public partial class Redis : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.RedisLinkedServerListResponseResult> LinkedServers { get; private set; } = null!;
        ...
        public Redis(string name, RedisArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20170201:Redis", name, args ?? new RedisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Redis(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20170201:Redis", name, null, MakeResourceOptions(options, id))
        {
        }
