...
namespace Pulumi.AzureNative.Cache.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20230801:LinkedServer")]
    public partial class LinkedServer : global::Pulumi.CustomResource
    {
        ...
        public LinkedServer(string name, LinkedServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230801:LinkedServer", name, args ?? new LinkedServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230801:LinkedServer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LinkedServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Cache.V20230801.ReplicationRole> ServerRole { get; set; } = null!;
