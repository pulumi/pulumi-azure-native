...
namespace Pulumi.AzureNative.Cache.V20230801
{
    public static class GetPatchSchedule
    {
        ...
        public static Task<GetPatchScheduleResult> InvokeAsync(GetPatchScheduleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPatchScheduleResult>("azure-native:cache/v20230801:getPatchSchedule", args ?? new GetPatchScheduleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the patching schedule of a redis cache.
        /// </summary>
        public static Output<GetPatchScheduleResult> Invoke(GetPatchScheduleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPatchScheduleResult>("azure-native:cache/v20230801:getPatchSchedule", args ?? new GetPatchScheduleInvokeArgs(), options.WithDefaults());
    }
