...
namespace Pulumi.AzureNative.Cache.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20230501preview:FirewallRule")]
    public partial class FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230501preview:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230501preview:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
