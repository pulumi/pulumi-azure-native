...
namespace Pulumi.AzureNative.Cache.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20230501preview:AccessPolicy")]
    public partial class AccessPolicy : global::Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230501preview:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230501preview:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cache/v20240301:AccessPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:cache/v20240401preview:AccessPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:cache/v20241101:AccessPolicy" },
                },
            };
