...
namespace Pulumi.AzureNative.Cache.V20230501Preview
{
    public static class GetLinkedServer
    {
        ...
        public static Task<GetLinkedServerResult> InvokeAsync(GetLinkedServerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLinkedServerResult>("azure-native:cache/v20230501preview:getLinkedServer", args ?? new GetLinkedServerArgs(), options.WithDefaults());
