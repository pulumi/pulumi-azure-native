...
namespace Pulumi.AzureNative.Cache.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20230501preview:AccessPolicyAssignment")]
    public partial class AccessPolicyAssignment : global::Pulumi.CustomResource
    {
        ...
        public AccessPolicyAssignment(string name, AccessPolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230501preview:AccessPolicyAssignment", name, args ?? new AccessPolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230501preview:AccessPolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
