...
namespace Pulumi.AzureNative.Cache.V20230501Preview
{
    public static class GetFirewallRule
    {
        ...
        public static Task<GetFirewallRuleResult> InvokeAsync(GetFirewallRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallRuleResult>("azure-native:cache/v20230501preview:getFirewallRule", args ?? new GetFirewallRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a single firewall rule in a specified redis cache.
        /// </summary>
        public static Output<GetFirewallRuleResult> Invoke(GetFirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirewallRuleResult>("azure-native:cache/v20230501preview:getFirewallRule", args ?? new GetFirewallRuleInvokeArgs(), options.WithDefaults());
    }
