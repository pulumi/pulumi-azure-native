...
namespace Pulumi.AzureNative.Cache.V20221101Preview
{
    public static class GetRedisEnterprise
    {
        ...
        public static Task<GetRedisEnterpriseResult> InvokeAsync(GetRedisEnterpriseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRedisEnterpriseResult>("azure-native:cache/v20221101preview:getRedisEnterprise", args ?? new GetRedisEnterpriseArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a RedisEnterprise cluster
        /// </summary>
        public static Output<GetRedisEnterpriseResult> Invoke(GetRedisEnterpriseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRedisEnterpriseResult>("azure-native:cache/v20221101preview:getRedisEnterprise", args ?? new GetRedisEnterpriseInvokeArgs(), options.WithDefaults());
