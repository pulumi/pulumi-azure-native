...
namespace Pulumi.AzureNative.Cache.V20221101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:cache/v20221101preview:RedisEnterprise is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230301preview:RedisEnterprise to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:cache/v20221101preview:RedisEnterprise")]
    public partial class RedisEnterprise : global::Pulumi.CustomResource
    {
        ...
        public RedisEnterprise(string name, RedisEnterpriseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20221101preview:RedisEnterprise", name, args ?? new RedisEnterpriseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RedisEnterprise(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20221101preview:RedisEnterprise", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RedisEnterpriseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20221101Preview.TlsVersion>? MinimumTlsVersion { get; set; }
