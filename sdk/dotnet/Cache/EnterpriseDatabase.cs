...
namespace Pulumi.AzureNative.Cache
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache:EnterpriseDatabase")]
    public partial class EnterpriseDatabase : global::Pulumi.CustomResource
    {
        ...
        public EnterpriseDatabase(string name, EnterpriseDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache:EnterpriseDatabase", name, args ?? new EnterpriseDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnterpriseDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache:EnterpriseDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EnterpriseDatabaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.AccessKeysAuthentication>? AccessKeysAuthentication { get; set; }
        ...
        /// </summary>
        [Input("deferUpgrade")]
        public InputUnion<string, Pulumi.AzureNative.Cache.DeferUpgradeSetting>? DeferUpgrade { get; set; }
