...
namespace Pulumi.AzureNative.Cache.V20220101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:cache/v20220101:Database is being removed in the next major version of this provider. Please upgrade to azure-native:cache/v20230301preview:Database to guarantee forwards compatibility.")]
    ...
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20220101:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20220101:Database", name, null, MakeResourceOptions(options, id))
        {
        }
