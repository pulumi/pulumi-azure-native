...
namespace Pulumi.AzureNative.Cache.V20220101
{
    public static class ListDatabaseKeys
    {
        ...
        public static Task<ListDatabaseKeysResult> InvokeAsync(ListDatabaseKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListDatabaseKeysResult>("azure-native:cache/v20220101:listDatabaseKeys", args ?? new ListDatabaseKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the access keys for the RedisEnterprise database.
        /// </summary>
        public static Output<ListDatabaseKeysResult> Invoke(ListDatabaseKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListDatabaseKeysResult>("azure-native:cache/v20220101:listDatabaseKeys", args ?? new ListDatabaseKeysInvokeArgs(), options.WithDefaults());
    }
