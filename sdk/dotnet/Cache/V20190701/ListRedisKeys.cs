...
namespace Pulumi.AzureNative.Cache.V20190701
{
    public static class ListRedisKeys
    {
        ...
        public static Task<ListRedisKeysResult> InvokeAsync(ListRedisKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListRedisKeysResult>("azure-native:cache/v20190701:listRedisKeys", args ?? new ListRedisKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Redis cache access keys.
        /// </summary>
        public static Output<ListRedisKeysResult> Invoke(ListRedisKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListRedisKeysResult>("azure-native:cache/v20190701:listRedisKeys", args ?? new ListRedisKeysInvokeArgs(), options.WithDefaults());
    }
