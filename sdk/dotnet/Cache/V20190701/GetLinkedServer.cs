...
namespace Pulumi.AzureNextGen.Cache.V20190701
{
    public static class GetLinkedServer
    {
        public static Task<GetLinkedServerResult> InvokeAsync(GetLinkedServerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLinkedServerResult>("azure-nextgen:cache/v20190701:getLinkedServer", args ?? new GetLinkedServerArgs(), options.WithVersion());
    }
