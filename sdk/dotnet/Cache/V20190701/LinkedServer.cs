...
namespace Pulumi.AzureNative.Cache.V20190701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20190701:LinkedServer")]
    public partial class LinkedServer : Pulumi.CustomResource
    {
        ...
        public LinkedServer(string name, LinkedServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20190701:LinkedServer", name, args ?? new LinkedServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20190701:LinkedServer", name, null, MakeResourceOptions(options, id))
        {
        }
