...
namespace Pulumi.AzureRM.Cache.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var firewallRule = new AzureRM.Cache.V20190701.FirewallRule("firewallRule", new AzureRM.Cache.V20190701.FirewallRuleArgs
    ///         {
    ///             CacheName = "cache1",
    ///             EndIP = "192.168.1.4",
    ...
    public partial class FirewallRule : Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20190701:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20190701:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
