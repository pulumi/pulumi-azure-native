...
namespace Pulumi.AzureRM.Cache.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var patchSchedule = new AzureRM.Cache.V20190701.PatchSchedule("patchSchedule", new AzureRM.Cache.V20190701.PatchScheduleArgs
    ///         {
    ///             Default = "default",
    ///             Name = "cache1",
    ...
    ///             ScheduleEntries = 
    ///             {
    ///                 new AzureRM.Cache.V20190701.Inputs.ScheduleEntryArgs
    ///                 {
    ///                     DayOfWeek = "Monday",
    ...
    public partial class PatchSchedule : Pulumi.CustomResource
    {
        ...
        public PatchSchedule(string name, PatchScheduleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20190701:PatchSchedule", name, args ?? new PatchScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PatchSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20190701:PatchSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
