...
namespace Pulumi.AzureNextGen.Cache.V20190701
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:cache/v20190701:PatchSchedule")]
    public partial class PatchSchedule : Pulumi.CustomResource
    {
        ...
        public PatchSchedule(string name, PatchScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache/v20190701:PatchSchedule", name, args ?? new PatchScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PatchSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache/v20190701:PatchSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
