...
namespace Pulumi.AzureNative.Cache.V20230301Preview
{
    public static class GetEnterpriseDatabase
    {
        ...
        public static Task<GetEnterpriseDatabaseResult> InvokeAsync(GetEnterpriseDatabaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEnterpriseDatabaseResult>("azure-native:cache/v20230301preview:getEnterpriseDatabase", args ?? new GetEnterpriseDatabaseArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a database in a RedisEnterprise cluster.
        /// </summary>
        public static Output<GetEnterpriseDatabaseResult> Invoke(GetEnterpriseDatabaseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEnterpriseDatabaseResult>("azure-native:cache/v20230301preview:getEnterpriseDatabase", args ?? new GetEnterpriseDatabaseInvokeArgs(), options.WithDefaults());
