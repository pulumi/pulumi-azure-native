...
namespace Pulumi.AzureNative.Cache.V20230301Preview
{
    ...
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230301preview:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230301preview:Database", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20230301Preview.Protocol>? ClientProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20230301Preview.ClusteringPolicy>? ClusteringPolicy { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20230301Preview.EvictionPolicy>? EvictionPolicy { get; set; }
