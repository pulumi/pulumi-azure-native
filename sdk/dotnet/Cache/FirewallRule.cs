...
namespace Pulumi.AzureNextGen.Cache
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:cache:FirewallRule")]
    public partial class FirewallRule : Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
