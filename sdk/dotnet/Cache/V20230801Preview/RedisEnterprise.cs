...
namespace Pulumi.AzureNative.Cache.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20230801preview:RedisEnterprise")]
    public partial class RedisEnterprise : global::Pulumi.CustomResource
    {
        ...
        public RedisEnterprise(string name, RedisEnterpriseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230801preview:RedisEnterprise", name, args ?? new RedisEnterpriseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RedisEnterprise(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230801preview:RedisEnterprise", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RedisEnterpriseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20230801Preview.TlsVersion>? MinimumTlsVersion { get; set; }
