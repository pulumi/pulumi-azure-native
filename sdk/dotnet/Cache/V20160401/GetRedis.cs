...
namespace Pulumi.AzureNative.Cache.V20160401
{
    ...
    public static class GetRedis
    {
        ...
        public static Task<GetRedisResult> InvokeAsync(GetRedisArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRedisResult>("azure-native:cache/v20160401:getRedis", args ?? new GetRedisArgs(), options.WithDefaults());

        /// <summary>
        /// A single Redis item in List or Get Operation.
        /// </summary>
        public static Output<GetRedisResult> Invoke(GetRedisInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRedisResult>("azure-native:cache/v20160401:getRedis", args ?? new GetRedisInvokeArgs(), options.WithDefaults());
    }
