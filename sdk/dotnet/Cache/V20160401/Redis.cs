...
namespace Pulumi.AzureNative.Cache.V20160401
{
    ...
    public partial class Redis : Pulumi.CustomResource
    {
        ...
        public Redis(string name, RedisArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20160401:Redis", name, args ?? new RedisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Redis(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20160401:Redis", name, null, MakeResourceOptions(options, id))
        {
        }
