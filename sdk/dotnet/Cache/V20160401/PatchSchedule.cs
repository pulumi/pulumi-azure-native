...
namespace Pulumi.AzureRM.Cache.V20160401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var patchSchedule = new AzureRM.Cache.V20160401.PatchSchedule("patchSchedule", new AzureRM.Cache.V20160401.PatchScheduleArgs
    ///         {
    ///             Name = "cache1",
    ///             ResourceGroupName = "rg1",
    ///             ScheduleEntries = 
    ///             {
    ///                 new AzureRM.Cache.V20160401.Inputs.ScheduleEntryArgs
    ///                 {
    ///                     DayOfWeek = "Monday",
    ...
    public partial class PatchSchedule : Pulumi.CustomResource
    {
        ...
        public PatchSchedule(string name, PatchScheduleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20160401:PatchSchedule", name, args ?? new PatchScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PatchSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20160401:PatchSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:cache/v20170201:PatchSchedule"},
                },
            };
