...
namespace Pulumi.AzureNative.Cache.V20160401
{
    public static class GetPatchSchedule
    {
        ...
        public static Task<GetPatchScheduleResult> InvokeAsync(GetPatchScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPatchScheduleResult>("azure-native:cache/v20160401:getPatchSchedule", args ?? new GetPatchScheduleArgs(), options.WithDefaults());

        /// <summary>
        /// Response to put/get patch schedules for Redis cache.
        /// </summary>
        public static Output<GetPatchScheduleResult> Invoke(GetPatchScheduleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPatchScheduleResult>("azure-native:cache/v20160401:getPatchSchedule", args ?? new GetPatchScheduleInvokeArgs(), options.WithDefaults());
    }
