...
namespace Pulumi.AzureNative.Cache.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20241101:FirewallRule")]
    public partial class FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20241101:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20241101:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
