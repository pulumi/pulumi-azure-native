...
namespace Pulumi.AzureNative.Cache.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20241101:AccessPolicy")]
    public partial class AccessPolicy : global::Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20241101:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20241101:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
