...
namespace Pulumi.AzureNative.Cache.V20241101
{
    /// <summary>
    /// Response to put/get patch schedules for Redis cache.
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20241101:PatchSchedule")]
    public partial class PatchSchedule : global::Pulumi.CustomResource
    {
        ...
        public PatchSchedule(string name, PatchScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20241101:PatchSchedule", name, args ?? new PatchScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PatchSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20241101:PatchSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
