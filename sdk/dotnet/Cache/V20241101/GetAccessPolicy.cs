...
namespace Pulumi.AzureNative.Cache.V20241101
{
    public static class GetAccessPolicy
    {
        ...
        public static Task<GetAccessPolicyResult> InvokeAsync(GetAccessPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccessPolicyResult>("azure-native:cache/v20241101:getAccessPolicy", args ?? new GetAccessPolicyArgs(), options.WithDefaults());
