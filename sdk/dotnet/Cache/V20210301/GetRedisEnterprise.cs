...
namespace Pulumi.AzureNative.Cache.V20210301
{
    public static class GetRedisEnterprise
    {
        ...
        public static Output<GetRedisEnterpriseResult> Invoke(GetRedisEnterpriseInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRedisEnterpriseResult>("azure-native:cache/v20210301:getRedisEnterprise", args ?? new GetRedisEnterpriseInvokeArgs(), options.WithVersion());
    }
