...
namespace Pulumi.AzureNextGen.Cache.V20210301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:cache/v20210301:RedisEnterprise")]
    public partial class RedisEnterprise : Pulumi.CustomResource
    {
        ...
        public RedisEnterprise(string name, RedisEnterpriseArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache/v20210301:RedisEnterprise", name, args ?? new RedisEnterpriseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RedisEnterprise(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache/v20210301:RedisEnterprise", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RedisEnterpriseArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cache.V20210301.TlsVersion>? MinimumTlsVersion { get; set; }
