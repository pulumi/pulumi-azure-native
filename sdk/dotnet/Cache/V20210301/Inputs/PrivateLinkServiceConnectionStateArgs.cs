...
namespace Pulumi.AzureNextGen.Cache.V20210301.Inputs
{
    ...
    public sealed class PrivateLinkServiceConnectionStateArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNextGen.Cache.V20210301.PrivateEndpointServiceConnectionStatus>? Status { get; set; }
