...
namespace Pulumi.AzureNative.Cache.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20230701:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230701:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20230701:Database", name, null, MakeResourceOptions(options, id))
        {
        }
