...
namespace Pulumi.AzureNative.Cache.V20241001
{
    public static class GetEnterprisePrivateEndpointConnection
    {
        ...
        public static Task<GetEnterprisePrivateEndpointConnectionResult> InvokeAsync(GetEnterprisePrivateEndpointConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEnterprisePrivateEndpointConnectionResult>("azure-native:cache/v20241001:getEnterprisePrivateEndpointConnection", args ?? new GetEnterprisePrivateEndpointConnectionArgs(), options.WithDefaults());
