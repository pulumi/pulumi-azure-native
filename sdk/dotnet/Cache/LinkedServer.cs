...
namespace Pulumi.AzureNextGen.Cache
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:cache:LinkedServer")]
    public partial class LinkedServer : Pulumi.CustomResource
    {
        ...
        public LinkedServer(string name, LinkedServerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache:LinkedServer", name, args ?? new LinkedServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache:LinkedServer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LinkedServerArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Cache.ReplicationRole> ServerRole { get; set; } = null!;
