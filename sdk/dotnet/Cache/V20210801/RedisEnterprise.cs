...
namespace Pulumi.AzureNative.Cache.V20210801
{
    ...
    [AzureNativeResourceType("azure-native:cache/v20210801:RedisEnterprise")]
    public partial class RedisEnterprise : global::Pulumi.CustomResource
    {
        ...
        public RedisEnterprise(string name, RedisEnterpriseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20210801:RedisEnterprise", name, args ?? new RedisEnterpriseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RedisEnterprise(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20210801:RedisEnterprise", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RedisEnterpriseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20210801.TlsVersion>? MinimumTlsVersion { get; set; }
