...
namespace Pulumi.AzureNative.Cache.V20210801.Inputs
{
    ...
    public sealed class PrivateLinkServiceConnectionStateArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.Cache.V20210801.PrivateEndpointServiceConnectionStatus>? Status { get; set; }
