...
namespace Pulumi.AzureNative.Cache.V20210801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20210801:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20210801:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20210801:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
