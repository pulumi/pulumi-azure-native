...
namespace Pulumi.AzureNative.Cache.V20210801
{
    /// <summary>
    /// The Private Endpoint Connection resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20210801:EnterprisePrivateEndpointConnection")]
    public partial class EnterprisePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public EnterprisePrivateEndpointConnection(string name, EnterprisePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20210801:EnterprisePrivateEndpointConnection", name, args ?? new EnterprisePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnterprisePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20210801:EnterprisePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
