...
namespace Pulumi.AzureNative.Cache.V20210801
{
    public static class GetDatabase
    {
        ...
        public static Task<GetDatabaseResult> InvokeAsync(GetDatabaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseResult>("azure-native:cache/v20210801:getDatabase", args ?? new GetDatabaseArgs(), options.WithVersion());

        /// <summary>
        /// Describes a database on the RedisEnterprise cluster
        /// </summary>
        public static Output<GetDatabaseResult> Invoke(GetDatabaseInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatabaseResult>("azure-native:cache/v20210801:getDatabase", args ?? new GetDatabaseInvokeArgs(), options.WithVersion());
    }
