...
namespace Pulumi.AzureNative.Cache.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20240201:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240201:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240201:Database", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240201.Protocol>? ClientProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240201.ClusteringPolicy>? ClusteringPolicy { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240201.EvictionPolicy>? EvictionPolicy { get; set; }
