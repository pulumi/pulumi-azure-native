...
namespace Pulumi.AzureNative.Cache.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20231101:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20231101:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20231101:Database", name, null, MakeResourceOptions(options, id))
        {
        }
