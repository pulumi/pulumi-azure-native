...
namespace Pulumi.AzureRM.Cache.V20180301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var linkedServer = new AzureRM.Cache.V20180301.LinkedServer("linkedServer", new AzureRM.Cache.V20180301.LinkedServerArgs
    ///         {
    ...
    public partial class LinkedServer : Pulumi.CustomResource
    {
        ...
        public LinkedServer(string name, LinkedServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20180301:LinkedServer", name, args ?? new LinkedServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20180301:LinkedServer", name, null, MakeResourceOptions(options, id))
        {
        }
