...
azure-native:cache/v20180301:LinkedServer is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20220601:LinkedServer to guarantee forwards compatibility.")]
    ...
    public partial class LinkedServer : global::Pulumi.CustomResource
    {
        ...
        public LinkedServer(string name, LinkedServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20180301:LinkedServer", name, args ?? new LinkedServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20180301:LinkedServer", name, null, MakeResourceOptions(options, id))
        {
        }
