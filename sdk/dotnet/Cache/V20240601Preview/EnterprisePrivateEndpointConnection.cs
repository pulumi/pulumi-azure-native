...
namespace Pulumi.AzureNative.Cache.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20240601preview:EnterprisePrivateEndpointConnection")]
    public partial class EnterprisePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public EnterprisePrivateEndpointConnection(string name, EnterprisePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240601preview:EnterprisePrivateEndpointConnection", name, args ?? new EnterprisePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnterprisePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240601preview:EnterprisePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
