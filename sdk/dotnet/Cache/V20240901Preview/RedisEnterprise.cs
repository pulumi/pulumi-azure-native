...
namespace Pulumi.AzureNative.Cache.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20240901preview:RedisEnterprise")]
    public partial class RedisEnterprise : global::Pulumi.CustomResource
    {
        ...
        public RedisEnterprise(string name, RedisEnterpriseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240901preview:RedisEnterprise", name, args ?? new RedisEnterpriseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RedisEnterprise(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240901preview:RedisEnterprise", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RedisEnterpriseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240901Preview.HighAvailability>? HighAvailability { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240901Preview.TlsVersion>? MinimumTlsVersion { get; set; }
