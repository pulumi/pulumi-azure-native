...
namespace Pulumi.AzureNative.Cache.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20240901preview:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240901preview:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240901preview:Database", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cache/v20250401:Database" },
    ...
    public sealed class DatabaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240901Preview.AccessKeysAuthentication>? AccessKeysAuthentication { get; set; }

        /// <summary>
        /// Specifies whether redis clients can connect using TLS-encrypted or plaintext redis protocols. Default is TLS-encrypted.
        /// </summary>
        [Input("clientProtocol")]
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240901Preview.Protocol>? ClientProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240901Preview.ClusteringPolicy>? ClusteringPolicy { get; set; }
        ...
        /// </summary>
        [Input("deferUpgrade")]
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240901Preview.DeferUpgradeSetting>? DeferUpgrade { get; set; }

        /// <summary>
        /// Redis eviction policy - default is VolatileLRU
        /// </summary>
        [Input("evictionPolicy")]
        public InputUnion<string, Pulumi.AzureNative.Cache.V20240901Preview.EvictionPolicy>? EvictionPolicy { get; set; }
