...
namespace Pulumi.AzureNative.Cache.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20240901preview:AccessPolicyAssignment")]
    public partial class AccessPolicyAssignment : global::Pulumi.CustomResource
    {
        ...
        public AccessPolicyAssignment(string name, AccessPolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240901preview:AccessPolicyAssignment", name, args ?? new AccessPolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20240901preview:AccessPolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:cache/v20250401:AccessPolicyAssignment" },
                },
            };
