...
namespace Pulumi.AzureNative.Cache.V20250401.Inputs
{
    ...
    public sealed class PersistenceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("aofFrequency")]
        public InputUnion<string, Pulumi.AzureNative.Cache.V20250401.AofFrequency>? AofFrequency { get; set; }
        ...
        /// </summary>
        [Input("rdbFrequency")]
        public InputUnion<string, Pulumi.AzureNative.Cache.V20250401.RdbFrequency>? RdbFrequency { get; set; }
