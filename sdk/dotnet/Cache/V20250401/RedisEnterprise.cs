...
namespace Pulumi.AzureNative.Cache.V20250401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20250401:RedisEnterprise")]
    public partial class RedisEnterprise : global::Pulumi.CustomResource
    {
        ...
        public RedisEnterprise(string name, RedisEnterpriseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20250401:RedisEnterprise", name, args ?? new RedisEnterpriseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RedisEnterprise(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20250401:RedisEnterprise", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RedisEnterpriseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20250401.HighAvailability>? HighAvailability { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cache.V20250401.TlsVersion>? MinimumTlsVersion { get; set; }
