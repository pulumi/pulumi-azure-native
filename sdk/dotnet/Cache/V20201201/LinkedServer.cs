...
namespace Pulumi.AzureNative.Cache.V20201201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:cache/v20201201:LinkedServer is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:LinkedServer to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:cache/v20201201:LinkedServer")]
    public partial class LinkedServer : global::Pulumi.CustomResource
    {
        ...
        public LinkedServer(string name, LinkedServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20201201:LinkedServer", name, args ?? new LinkedServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20201201:LinkedServer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LinkedServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Cache.V20201201.ReplicationRole> ServerRole { get; set; } = null!;
