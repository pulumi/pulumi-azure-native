...
namespace Pulumi.AzureNative.Cache.V20201201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cache/v20201201:Redis")]
    public partial class Redis : global::Pulumi.CustomResource
    {
        ...
        public Redis(string name, RedisArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20201201:Redis", name, args ?? new RedisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Redis(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cache/v20201201:Redis", name, null, MakeResourceOptions(options, id))
        {
        }
