...
namespace Pulumi.AzureNextGen.Cache.V20171001
{
    ...
    public partial class Redis : Pulumi.CustomResource
    {
        ...
        public Redis(string name, RedisArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache/v20171001:Redis", name, args ?? new RedisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Redis(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:cache/v20171001:Redis", name, null, MakeResourceOptions(options, id))
        {
        }
