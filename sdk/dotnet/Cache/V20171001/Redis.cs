...
namespace Pulumi.AzureRM.Cache.V20171001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var redis = new AzureRM.Cache.V20171001.Redis("redis", new AzureRM.Cache.V20171001.RedisArgs
    ///         {
    ...
    ///             ShardCount = 2,
    ///             Sku = new AzureRM.Cache.V20171001.Inputs.SkuArgs
    ///             {
    ///                 Capacity = 1,
    ///                 Family = "P",
    ///                 Name = "Premium",
    ...
    public partial class Redis : Pulumi.CustomResource
    {
        ...
        public Redis(string name, RedisArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20171001:Redis", name, args ?? new RedisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Redis(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cache/v20171001:Redis", name, null, MakeResourceOptions(options, id))
        {
        }
