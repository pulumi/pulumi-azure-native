...
namespace Pulumi.AzureNative.Confluent.V20211201
{
    ...
    /// {
    ///     var organization = new AzureNative.Confluent.V20211201.Organization("organization", new()
    ///     {
    ///         Location = "West US",
    ///         OfferDetail = new AzureNative.Confluent.V20211201.Inputs.OfferDetailArgs
    ///         {
    ///             Id = "string",
    ///             PlanId = "string",
    ///             PlanName = "string",
    ...
    ///             { "Environment", "Dev" },
    ///         },
    ///         UserDetail = new AzureNative.Confluent.V20211201.Inputs.UserDetailArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:confluent/v20211201:Organization")]
    public partial class Organization : global::Pulumi.CustomResource
    {
        ...
        public Organization(string name, OrganizationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:confluent/v20211201:Organization", name, args ?? new OrganizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Organization(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:confluent/v20211201:Organization", name, null, MakeResourceOptions(options, id))
        {
        }
