...
namespace Pulumi.AzureNative.Confluent
{
    ...
    public partial class Connector : global::Pulumi.CustomResource
    {
        ...
        public Connector(string name, ConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:confluent:Connector", name, args ?? new ConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:confluent:Connector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:confluent/v20250717preview:Connector" },
                    new global::Pulumi.Alias { Type = "azure-native:confluent/v20250818preview:Connector" },
                    new global::Pulumi.Alias { Type = "azure-native:confluent/v20260501preview:Connector" },
                    new global::Pulumi.Alias { Type = "azure-native:confluent/v20260602preview:Connector" },
                },
            };
