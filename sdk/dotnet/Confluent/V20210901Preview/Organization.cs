...
namespace Pulumi.AzureNative.Confluent.V20210901Preview
{
    ...
    public partial class Organization : global::Pulumi.CustomResource
    {
        ...
        public Organization(string name, OrganizationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:confluent/v20210901preview:Organization", name, args ?? new OrganizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Organization(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:confluent/v20210901preview:Organization", name, null, MakeResourceOptions(options, id))
        {
        }
