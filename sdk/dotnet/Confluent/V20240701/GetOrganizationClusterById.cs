...
namespace Pulumi.AzureNative.Confluent.V20240701
{
    public static class GetOrganizationClusterById
    {
        ...
        public static Task<GetOrganizationClusterByIdResult> InvokeAsync(GetOrganizationClusterByIdArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOrganizationClusterByIdResult>("azure-native:confluent/v20240701:getOrganizationClusterById", args ?? new GetOrganizationClusterByIdArgs(), options.WithDefaults());
        ...
        public static Output<GetOrganizationClusterByIdResult> Invoke(GetOrganizationClusterByIdInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOrganizationClusterByIdResult>("azure-native:confluent/v20240701:getOrganizationClusterById", args ?? new GetOrganizationClusterByIdInvokeArgs(), options.WithDefaults());
