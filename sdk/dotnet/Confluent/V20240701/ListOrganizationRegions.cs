...
namespace Pulumi.AzureNative.Confluent.V20240701
{
    public static class ListOrganizationRegions
    {
        ...
        public static Task<ListOrganizationRegionsResult> InvokeAsync(ListOrganizationRegionsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListOrganizationRegionsResult>("azure-native:confluent/v20240701:listOrganizationRegions", args ?? new ListOrganizationRegionsArgs(), options.WithDefaults());
        ...
        public static Output<ListOrganizationRegionsResult> Invoke(ListOrganizationRegionsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListOrganizationRegionsResult>("azure-native:confluent/v20240701:listOrganizationRegions", args ?? new ListOrganizationRegionsInvokeArgs(), options.WithDefaults());
