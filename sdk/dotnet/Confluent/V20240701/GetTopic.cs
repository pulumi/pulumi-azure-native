...
namespace Pulumi.AzureNative.Confluent.V20240701
{
    public static class GetTopic
    {
        ...
        public static Task<GetTopicResult> InvokeAsync(GetTopicArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTopicResult>("azure-native:confluent/v20240701:getTopic", args ?? new GetTopicArgs(), options.WithDefaults());

        /// <summary>
        /// Details of topic record
        /// </summary>
        public static Output<GetTopicResult> Invoke(GetTopicInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTopicResult>("azure-native:confluent/v20240701:getTopic", args ?? new GetTopicInvokeArgs(), options.WithDefaults());
