...
namespace Pulumi.AzureNative.Confluent.V20240701
{
    public static class GetConnector
    {
        ...
        public static Task<GetConnectorResult> InvokeAsync(GetConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectorResult>("azure-native:confluent/v20240701:getConnector", args ?? new GetConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Details of connector record
        /// </summary>
        public static Output<GetConnectorResult> Invoke(GetConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectorResult>("azure-native:confluent/v20240701:getConnector", args ?? new GetConnectorInvokeArgs(), options.WithDefaults());
