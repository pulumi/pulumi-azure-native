...
namespace Pulumi.AzureNative.Confluent.V20240701
{
    public static class ListAccessClusters
    {
        ...
        public static Task<ListAccessClustersResult> InvokeAsync(ListAccessClustersArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAccessClustersResult>("azure-native:confluent/v20240701:listAccessClusters", args ?? new ListAccessClustersArgs(), options.WithDefaults());

        /// <summary>
        /// Details of the clusters returned on successful response
        /// </summary>
        public static Output<ListAccessClustersResult> Invoke(ListAccessClustersInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListAccessClustersResult>("azure-native:confluent/v20240701:listAccessClusters", args ?? new ListAccessClustersInvokeArgs(), options.WithDefaults());
