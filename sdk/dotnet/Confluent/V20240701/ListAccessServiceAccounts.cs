...
namespace Pulumi.AzureNative.Confluent.V20240701
{
    public static class ListAccessServiceAccounts
    {
        ...
        public static Task<ListAccessServiceAccountsResult> InvokeAsync(ListAccessServiceAccountsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAccessServiceAccountsResult>("azure-native:confluent/v20240701:listAccessServiceAccounts", args ?? new ListAccessServiceAccountsArgs(), options.WithDefaults());
        ...
        public static Output<ListAccessServiceAccountsResult> Invoke(ListAccessServiceAccountsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListAccessServiceAccountsResult>("azure-native:confluent/v20240701:listAccessServiceAccounts", args ?? new ListAccessServiceAccountsInvokeArgs(), options.WithDefaults());
