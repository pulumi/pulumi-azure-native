...
namespace Pulumi.AzureNative.Confluent.V20240701
{
    public static class GetOrganizationEnvironmentById
    {
        ...
        public static Task<GetOrganizationEnvironmentByIdResult> InvokeAsync(GetOrganizationEnvironmentByIdArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOrganizationEnvironmentByIdResult>("azure-native:confluent/v20240701:getOrganizationEnvironmentById", args ?? new GetOrganizationEnvironmentByIdArgs(), options.WithDefaults());
        ...
        public static Output<GetOrganizationEnvironmentByIdResult> Invoke(GetOrganizationEnvironmentByIdInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOrganizationEnvironmentByIdResult>("azure-native:confluent/v20240701:getOrganizationEnvironmentById", args ?? new GetOrganizationEnvironmentByIdInvokeArgs(), options.WithDefaults());
