...
namespace Pulumi.AzureNative.Confluent.V20240213
{
    public static class ListAccessUsers
    {
        ...
        public static Task<ListAccessUsersResult> InvokeAsync(ListAccessUsersArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAccessUsersResult>("azure-native:confluent/v20240213:listAccessUsers", args ?? new ListAccessUsersArgs(), options.WithDefaults());
