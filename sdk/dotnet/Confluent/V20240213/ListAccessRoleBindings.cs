...
namespace Pulumi.AzureNative.Confluent.V20240213
{
    public static class ListAccessRoleBindings
    {
        ...
        public static Task<ListAccessRoleBindingsResult> InvokeAsync(ListAccessRoleBindingsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAccessRoleBindingsResult>("azure-native:confluent/v20240213:listAccessRoleBindings", args ?? new ListAccessRoleBindingsArgs(), options.WithDefaults());
        ...
        public static Output<ListAccessRoleBindingsResult> Invoke(ListAccessRoleBindingsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListAccessRoleBindingsResult>("azure-native:confluent/v20240213:listAccessRoleBindings", args ?? new ListAccessRoleBindingsInvokeArgs(), options.WithDefaults());
    }
