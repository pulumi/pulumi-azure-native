...
namespace Pulumi.AzureNative.Confluent.V20200301Preview
{
    /// <summary>
    ...
    /// {
    ///     var organization = new AzureNative.Confluent.V20200301Preview.Organization("organization", new()
    ///     {
    ///         Location = "West US",
    ///         OfferDetail = new AzureNative.Confluent.V20200301Preview.Inputs.OrganizationResourcePropertiesOfferDetailArgs
    ///         {
    ///             Id = "string",
    ///             PlanId = "string",
    ///             PlanName = "string",
    ...
    ///             { "Environment", "Dev" },
    ///         },
    ///         UserDetail = new AzureNative.Confluent.V20200301Preview.Inputs.OrganizationResourcePropertiesUserDetailArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:confluent/v20200301preview:Organization myOrganization /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.Confluent/organizations/myOrganization 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:confluent/v20200301preview:Organization")]
    public partial class Organization : global::Pulumi.CustomResource
    {
        ...
        public Organization(string name, OrganizationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:confluent/v20200301preview:Organization", name, args ?? new OrganizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Organization(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:confluent/v20200301preview:Organization", name, null, MakeResourceOptions(options, id))
        {
        }
