...
namespace Pulumi.AzureNative.Confluent.V20230822
{
    public static class ListAccessUsers
    {
        ...
        public static Task<ListAccessUsersResult> InvokeAsync(ListAccessUsersArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAccessUsersResult>("azure-native:confluent/v20230822:listAccessUsers", args ?? new ListAccessUsersArgs(), options.WithDefaults());

        /// <summary>
        /// List users success response
        /// </summary>
        public static Output<ListAccessUsersResult> Invoke(ListAccessUsersInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListAccessUsersResult>("azure-native:confluent/v20230822:listAccessUsers", args ?? new ListAccessUsersInvokeArgs(), options.WithDefaults());
    }
