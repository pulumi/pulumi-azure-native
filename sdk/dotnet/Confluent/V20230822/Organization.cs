...
namespace Pulumi.AzureNative.Confluent.V20230822
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:confluent/v20230822:Organization")]
    public partial class Organization : global::Pulumi.CustomResource
    {
        ...
        public Organization(string name, OrganizationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:confluent/v20230822:Organization", name, args ?? new OrganizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Organization(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:confluent/v20230822:Organization", name, null, MakeResourceOptions(options, id))
        {
        }
