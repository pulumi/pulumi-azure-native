...
namespace Pulumi.AzureNative.Confluent.V20230822
{
    public static class ListAccessServiceAccounts
    {
        ...
        public static Task<ListAccessServiceAccountsResult> InvokeAsync(ListAccessServiceAccountsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAccessServiceAccountsResult>("azure-native:confluent/v20230822:listAccessServiceAccounts", args ?? new ListAccessServiceAccountsArgs(), options.WithDefaults());
