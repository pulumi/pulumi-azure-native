...
namespace Pulumi.AzureRM.DeploymentManager.V20191101Preview
{
    ...
    public partial class Step : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.StepPropertiesResponseResult> Properties { get; private set; } = null!;
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:deploymentmanager/preview:Step"},
    ...
    public sealed class StepArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.StepPropertiesArgs> Properties { get; set; } = null!;
