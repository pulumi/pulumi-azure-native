...
namespace Pulumi.AzureRM.DeploymentManager.Preview
{
    public static class GetServiceUnit
    {
        public static Task<GetServiceUnitResult> InvokeAsync(GetServiceUnitArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceUnitResult>("azurerm:deploymentmanager/preview:getServiceUnit", args ?? new GetServiceUnitArgs(), options.WithVersion());
    }
