...
namespace Pulumi.AzureRM.DeploymentManager.Preview
{
    public static class GetArtifactSource
    {
        public static Task<GetArtifactSourceResult> InvokeAsync(GetArtifactSourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetArtifactSourceResult>("azurerm:deploymentmanager/preview:getArtifactSource", args ?? new GetArtifactSourceArgs(), options.WithVersion());
    }
