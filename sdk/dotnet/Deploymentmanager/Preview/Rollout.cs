...
namespace Pulumi.AzureRM.DeploymentManager.Preview
{
    ...
    public partial class Rollout : Pulumi.CustomResource
    {
        ...
        public Rollout(string name, RolloutArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/preview:Rollout", name, args ?? new RolloutArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rollout(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/preview:Rollout", name, null, MakeResourceOptions(options, id))
        {
        }
