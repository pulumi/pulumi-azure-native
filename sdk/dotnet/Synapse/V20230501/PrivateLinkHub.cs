...
namespace Pulumi.AzureNative.Synapse.V20230501
{
    ...
    /// A privateLinkHub
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20230501:PrivateLinkHub")]
    public partial class PrivateLinkHub : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkHub(string name, PrivateLinkHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:PrivateLinkHub", name, args ?? new PrivateLinkHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:PrivateLinkHub", name, null, MakeResourceOptions(options, id))
        {
        }
