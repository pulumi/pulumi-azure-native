...
namespace Pulumi.AzureNative.Synapse.V20230501
{
    public static class GetPrivateLinkHub
    {
        ...
        public static Task<GetPrivateLinkHubResult> InvokeAsync(GetPrivateLinkHubArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateLinkHubResult>("azure-native:synapse/v20230501:getPrivateLinkHub", args ?? new GetPrivateLinkHubArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a privateLinkHub
        /// </summary>
        public static Output<GetPrivateLinkHubResult> Invoke(GetPrivateLinkHubInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPrivateLinkHubResult>("azure-native:synapse/v20230501:getPrivateLinkHub", args ?? new GetPrivateLinkHubInvokeArgs(), options.WithDefaults());
    }
