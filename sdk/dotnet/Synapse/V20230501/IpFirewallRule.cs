...
namespace Pulumi.AzureNative.Synapse.V20230501
{
    ...
    /// IP firewall rule
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20230501:IpFirewallRule")]
    public partial class IpFirewallRule : global::Pulumi.CustomResource
    {
        ...
        public IpFirewallRule(string name, IpFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:IpFirewallRule", name, args ?? new IpFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpFirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:IpFirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
