...
namespace Pulumi.AzureNative.Synapse.V20230501
{
    ...
    /// A Big Data pool
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20230501:BigDataPool")]
    public partial class BigDataPool : global::Pulumi.CustomResource
    {
        ...
        public BigDataPool(string name, BigDataPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:BigDataPool", name, args ?? new BigDataPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BigDataPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:BigDataPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BigDataPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("nodeSize")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20230501.NodeSize>? NodeSize { get; set; }

        /// <summary>
        /// The kind of nodes that the Big Data pool provides.
        /// </summary>
        [Input("nodeSizeFamily")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20230501.NodeSizeFamily>? NodeSizeFamily { get; set; }
