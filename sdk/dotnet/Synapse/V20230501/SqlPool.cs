...
namespace Pulumi.AzureNative.Synapse.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20230501:SqlPool")]
    public partial class SqlPool : global::Pulumi.CustomResource
    {
        ...
        public SqlPool(string name, SqlPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:SqlPool", name, args ?? new SqlPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:SqlPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20230501.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20230501.StorageAccountType>? StorageAccountType { get; set; }
