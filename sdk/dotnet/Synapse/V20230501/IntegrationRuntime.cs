...
namespace Pulumi.AzureNative.Synapse.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20230501:IntegrationRuntime")]
    public partial class IntegrationRuntime : global::Pulumi.CustomResource
    {
        ...
        public IntegrationRuntime(string name, IntegrationRuntimeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:IntegrationRuntime", name, args ?? new IntegrationRuntimeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationRuntime(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:IntegrationRuntime", name, null, MakeResourceOptions(options, id))
        {
        }
