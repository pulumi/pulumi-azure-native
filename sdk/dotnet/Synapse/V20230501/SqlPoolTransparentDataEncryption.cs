...
namespace Pulumi.AzureNative.Synapse.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20230501:SqlPoolTransparentDataEncryption")]
    public partial class SqlPoolTransparentDataEncryption : global::Pulumi.CustomResource
    {
        ...
        public SqlPoolTransparentDataEncryption(string name, SqlPoolTransparentDataEncryptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:SqlPoolTransparentDataEncryption", name, args ?? new SqlPoolTransparentDataEncryptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolTransparentDataEncryption(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:SqlPoolTransparentDataEncryption", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlPoolTransparentDataEncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20230501.TransparentDataEncryptionStatus>? Status { get; set; }
