...
namespace Pulumi.AzureNative.Synapse.V20230501
{
    ...
    /// A workspace key
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20230501:Key")]
    public partial class Key : global::Pulumi.CustomResource
    {
        ...
        public Key(string name, KeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:Key", name, args ?? new KeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Key(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:Key", name, null, MakeResourceOptions(options, id))
        {
        }
