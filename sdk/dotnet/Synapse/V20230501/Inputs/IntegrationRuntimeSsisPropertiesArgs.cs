...
namespace Pulumi.AzureNative.Synapse.V20230501.Inputs
{
    ...
    public sealed class IntegrationRuntimeSsisPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("edition")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20230501.IntegrationRuntimeEdition>? Edition { get; set; }
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20230501.IntegrationRuntimeLicenseType>? LicenseType { get; set; }
