...
namespace Pulumi.AzureNative.Synapse.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20230501:WorkspaceAadAdmin")]
    public partial class WorkspaceAadAdmin : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceAadAdmin(string name, WorkspaceAadAdminArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:WorkspaceAadAdmin", name, args ?? new WorkspaceAadAdminArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceAadAdmin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20230501:WorkspaceAadAdmin", name, null, MakeResourceOptions(options, id))
        {
        }
