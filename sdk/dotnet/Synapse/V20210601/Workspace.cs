...
namespace Pulumi.AzureNative.Synapse.V20210601
{
    ...
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210601.WorkspacePublicNetworkAccess>? PublicNetworkAccess { get; set; }
