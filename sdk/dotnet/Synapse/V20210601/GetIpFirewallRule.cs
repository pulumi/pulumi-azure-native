...
namespace Pulumi.AzureNative.Synapse.V20210601
{
    public static class GetIpFirewallRule
    {
        ...
        public static Task<GetIpFirewallRuleResult> InvokeAsync(GetIpFirewallRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIpFirewallRuleResult>("azure-native:synapse/v20210601:getIpFirewallRule", args ?? new GetIpFirewallRuleArgs(), options.WithVersion());

        /// <summary>
        /// IP firewall rule
        /// </summary>
        public static Output<GetIpFirewallRuleResult> Invoke(GetIpFirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIpFirewallRuleResult>("azure-native:synapse/v20210601:getIpFirewallRule", args ?? new GetIpFirewallRuleInvokeArgs(), options.WithVersion());
    }
