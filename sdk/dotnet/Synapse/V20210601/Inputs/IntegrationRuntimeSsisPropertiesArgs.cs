...
namespace Pulumi.AzureNative.Synapse.V20210601.Inputs
{
    ...
    public sealed class IntegrationRuntimeSsisPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("edition")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210601.IntegrationRuntimeEdition>? Edition { get; set; }
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210601.IntegrationRuntimeLicenseType>? LicenseType { get; set; }
