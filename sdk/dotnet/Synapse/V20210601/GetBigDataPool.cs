...
{
    [Obsolete(@"azure-native:synapse/v20210601:BigDataPool is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:BigDataPool to guarantee forwards compatibility.")]
    public static class GetBigDataPool
    {
        ...
        public static Task<GetBigDataPoolResult> InvokeAsync(GetBigDataPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBigDataPoolResult>("azure-native:synapse/v20210601:getBigDataPool", args ?? new GetBigDataPoolArgs(), options.WithDefaults());
