...
namespace Pulumi.AzureNative.Synapse.V20210601Preview
{
    ...
    public partial class KustoPoolAttachedDatabaseConfiguration : Pulumi.CustomResource
    {
        ...
        public KustoPoolAttachedDatabaseConfiguration(string name, KustoPoolAttachedDatabaseConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:KustoPoolAttachedDatabaseConfiguration", name, args ?? new KustoPoolAttachedDatabaseConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KustoPoolAttachedDatabaseConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:KustoPoolAttachedDatabaseConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
