...
namespace Pulumi.AzureNative.Synapse.V20210601Preview.Inputs
{
    ...
    public sealed class IntegrationRuntimeSsisPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("edition")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210601Preview.IntegrationRuntimeEdition>? Edition { get; set; }
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210601Preview.IntegrationRuntimeLicenseType>? LicenseType { get; set; }
