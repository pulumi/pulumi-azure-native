...
namespace Pulumi.AzureNative.Synapse.V20210601Preview
{
    ...
    /// {
    ///     var key = new AzureNative.Synapse.V20210601Preview.Key("key", new()
    ///     {
    ///         IsActiveCMK = true,
    ///         KeyName = "somekey",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210601preview:Key")]
    public partial class Key : global::Pulumi.CustomResource
    {
        ...
        public Key(string name, KeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:Key", name, args ?? new KeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Key(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:Key", name, null, MakeResourceOptions(options, id))
        {
        }
