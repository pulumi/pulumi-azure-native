...
namespace Pulumi.AzureNative.Synapse.V20210601Preview
{
    ...
    /// {
    ///     var kustoPoolPrincipalAssignment = new AzureNative.Synapse.V20210601Preview.KustoPoolPrincipalAssignment("kustoPoolPrincipalAssignment", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:synapse/v20210601preview:KustoPoolPrincipalAssignment synapseWorkspaceName/kustoclusterrptest4/kustoprincipal1 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Synapse/workspaces/synapseWorkspaceName/kustoPools/kustoclusterrptest4/PrincipalAssignments/kustoprincipal1 
    /// ```
    /// </summary>
    ...
    public partial class KustoPoolPrincipalAssignment : global::Pulumi.CustomResource
    {
        ...
        public KustoPoolPrincipalAssignment(string name, KustoPoolPrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:KustoPoolPrincipalAssignment", name, args ?? new KustoPoolPrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KustoPoolPrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:KustoPoolPrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static KustoPoolPrincipalAssignment Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class KustoPoolPrincipalAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210601Preview.PrincipalType> PrincipalType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210601Preview.ClusterPrincipalRole> Role { get; set; } = null!;
