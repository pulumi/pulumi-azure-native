...
namespace Pulumi.AzureNative.Synapse.V20210601Preview
{
    ...
    /// {
    ///     var sqlPoolSensitivityLabel = new AzureNative.Synapse.V20210601Preview.SqlPoolSensitivityLabel("sqlPoolSensitivityLabel", new()
    ///     {
    ///         ColumnName = "myColumn",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210601preview:SqlPoolSensitivityLabel")]
    public partial class SqlPoolSensitivityLabel : global::Pulumi.CustomResource
    {
        ...
        public SqlPoolSensitivityLabel(string name, SqlPoolSensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:SqlPoolSensitivityLabel", name, args ?? new SqlPoolSensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolSensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:SqlPoolSensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlPoolSensitivityLabelArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("rank")]
        public Input<Pulumi.AzureNative.Synapse.V20210601Preview.SensitivityLabelRank>? Rank { get; set; }
