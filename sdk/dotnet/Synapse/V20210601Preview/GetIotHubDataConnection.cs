...
namespace Pulumi.AzureNative.Synapse.V20210601Preview
{
    public static class GetIotHubDataConnection
    {
        ...
        public static Task<GetIotHubDataConnectionResult> InvokeAsync(GetIotHubDataConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIotHubDataConnectionResult>("azure-native:synapse/v20210601preview:getIotHubDataConnection", args ?? new GetIotHubDataConnectionArgs(), options.WithVersion());
        ...
        public static Output<GetIotHubDataConnectionResult> Invoke(GetIotHubDataConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIotHubDataConnectionResult>("azure-native:synapse/v20210601preview:getIotHubDataConnection", args ?? new GetIotHubDataConnectionInvokeArgs(), options.WithVersion());
    }
