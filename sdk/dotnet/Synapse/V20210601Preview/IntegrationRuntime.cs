...
namespace Pulumi.AzureNative.Synapse.V20210601Preview
{
    ...
    public partial class IntegrationRuntime : global::Pulumi.CustomResource
    {
        ...
        public IntegrationRuntime(string name, IntegrationRuntimeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:IntegrationRuntime", name, args ?? new IntegrationRuntimeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationRuntime(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:IntegrationRuntime", name, null, MakeResourceOptions(options, id))
        {
        }
