...
namespace Pulumi.AzureNative.Synapse.V20210601Preview
{
    ...
    public partial class SqlPoolWorkloadGroup : Pulumi.CustomResource
    {
        ...
        public SqlPoolWorkloadGroup(string name, SqlPoolWorkloadGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:SqlPoolWorkloadGroup", name, args ?? new SqlPoolWorkloadGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolWorkloadGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:SqlPoolWorkloadGroup", name, null, MakeResourceOptions(options, id))
        {
        }
