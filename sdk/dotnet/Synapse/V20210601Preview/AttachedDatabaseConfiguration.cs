...
namespace Pulumi.AzureNative.Synapse.V20210601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210601preview:AttachedDatabaseConfiguration")]
    public partial class AttachedDatabaseConfiguration : Pulumi.CustomResource
    {
        ...
        public AttachedDatabaseConfiguration(string name, AttachedDatabaseConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:AttachedDatabaseConfiguration", name, args ?? new AttachedDatabaseConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedDatabaseConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:AttachedDatabaseConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210601preview:AttachedDatabaseConfiguration"},
                    new Pulumi.Alias { Type = "azure-native:synapse:AttachedDatabaseConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:synapse:AttachedDatabaseConfiguration"},
                },
            };
    ...
    public sealed class AttachedDatabaseConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210601Preview.DefaultPrincipalsModificationKind> DefaultPrincipalsModificationKind { get; set; } = null!;
