...
namespace Pulumi.AzureNative.Synapse.V20210601Preview
{
    ...
    /// {
    ///     var bigDataPool = new AzureNative.Synapse.V20210601Preview.BigDataPool("bigDataPool", new()
    ///     {
    ///         AutoPause = new AzureNative.Synapse.V20210601Preview.Inputs.AutoPausePropertiesArgs
    ///         {
    ///             DelayInMinutes = 15,
    ///             Enabled = true,
    ///         },
    ///         AutoScale = new AzureNative.Synapse.V20210601Preview.Inputs.AutoScalePropertiesArgs
    ///         {
    ///             Enabled = true,
    ///             MaxNodeCount = 50,
    ///             MinNodeCount = 3,
    ...
    ///         LibraryRequirements = new AzureNative.Synapse.V20210601Preview.Inputs.LibraryRequirementsArgs
    ///         {
    ///             Content = "",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:synapse/v20210601preview:BigDataPool ExamplePool /subscriptions/01234567-89ab-4def-0123-456789abcdef/resourceGroups/ExampleResourceGroup/providers/Microsoft.Synapse/workspaces/ExampleWorkspace/bigDataPools/ExamplePool 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210601preview:BigDataPool")]
    public partial class BigDataPool : global::Pulumi.CustomResource
    {
        ...
        public BigDataPool(string name, BigDataPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:BigDataPool", name, args ?? new BigDataPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BigDataPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:BigDataPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BigDataPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("nodeSize")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210601Preview.NodeSize>? NodeSize { get; set; }

        /// <summary>
        /// The kind of nodes that the Big Data pool provides.
        /// </summary>
        [Input("nodeSizeFamily")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210601Preview.NodeSizeFamily>? NodeSizeFamily { get; set; }
