...
namespace Pulumi.AzureNative.Synapse.V20210601Preview
{
    ...
    /// {
    ///     var readOnlyFollowingDatabase = new AzureNative.Synapse.V20210601Preview.ReadOnlyFollowingDatabase("readOnlyFollowingDatabase", new()
    ///     {
    ...
    public partial class ReadOnlyFollowingDatabase : global::Pulumi.CustomResource
    {
        ...
        public ReadOnlyFollowingDatabase(string name, ReadOnlyFollowingDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:ReadOnlyFollowingDatabase", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ReadOnlyFollowingDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:ReadOnlyFollowingDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
