...
namespace Pulumi.AzureNative.Synapse.V20210601Preview
{
    ...
    [AzureNativeResourceType("azure-native:synapse/v20210601preview:DataConnection")]
    public partial class DataConnection : Pulumi.CustomResource
    {
        ...
        public DataConnection(string name, DataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:DataConnection", name, args ?? new DataConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210601preview:DataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
