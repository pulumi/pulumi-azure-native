...
namespace Pulumi.AzureNative.Synapse.V20201201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20201201:SqlPoolWorkloadClassifier")]
    public partial class SqlPoolWorkloadClassifier : Pulumi.CustomResource
    {
        ...
        public SqlPoolWorkloadClassifier(string name, SqlPoolWorkloadClassifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20201201:SqlPoolWorkloadClassifier", name, args ?? new SqlPoolWorkloadClassifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolWorkloadClassifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20201201:SqlPoolWorkloadClassifier", name, null, MakeResourceOptions(options, id))
        {
        }
