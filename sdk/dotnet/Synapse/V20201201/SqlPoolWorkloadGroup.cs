...
namespace Pulumi.AzureNative.Synapse.V20201201
{
    ...
    public partial class SqlPoolWorkloadGroup : Pulumi.CustomResource
    {
        ...
        public SqlPoolWorkloadGroup(string name, SqlPoolWorkloadGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20201201:SqlPoolWorkloadGroup", name, args ?? new SqlPoolWorkloadGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolWorkloadGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20201201:SqlPoolWorkloadGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210601:SqlPoolWorkloadGroup"},
                    new Pulumi.Alias { Type = "azure-native:synapse/v20210601preview:SqlPoolWorkloadGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210601preview:SqlPoolWorkloadGroup"},
                },
            };
