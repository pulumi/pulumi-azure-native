...
namespace Pulumi.AzureNextGen.Synapse.V20201201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:synapse/v20201201:SqlPoolWorkloadGroup")]
    public partial class SqlPoolWorkloadGroup : Pulumi.CustomResource
    {
        ...
        public SqlPoolWorkloadGroup(string name, SqlPoolWorkloadGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:synapse/v20201201:SqlPoolWorkloadGroup", name, args ?? new SqlPoolWorkloadGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolWorkloadGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:synapse/v20201201:SqlPoolWorkloadGroup", name, null, MakeResourceOptions(options, id))
        {
        }
