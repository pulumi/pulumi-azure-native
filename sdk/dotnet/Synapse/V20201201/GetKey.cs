...
azure-native:synapse/v20201201:Key is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:Key to guarantee forwards compatibility.")]
    public static class GetKey
    {
        ...
        public static Task<GetKeyResult> InvokeAsync(GetKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKeyResult>("azure-native:synapse/v20201201:getKey", args ?? new GetKeyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a workspace key
        /// </summary>
        public static Output<GetKeyResult> Invoke(GetKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKeyResult>("azure-native:synapse/v20201201:getKey", args ?? new GetKeyInvokeArgs(), options.WithDefaults());
    }
