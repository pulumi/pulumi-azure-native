...
namespace Pulumi.AzureNative.Synapse.V20201201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20201201:SqlPoolTransparentDataEncryption")]
    public partial class SqlPoolTransparentDataEncryption : Pulumi.CustomResource
    {
        ...
        public SqlPoolTransparentDataEncryption(string name, SqlPoolTransparentDataEncryptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20201201:SqlPoolTransparentDataEncryption", name, args ?? new SqlPoolTransparentDataEncryptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolTransparentDataEncryption(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20201201:SqlPoolTransparentDataEncryption", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlPoolTransparentDataEncryptionArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20201201.TransparentDataEncryptionStatus>? Status { get; set; }
