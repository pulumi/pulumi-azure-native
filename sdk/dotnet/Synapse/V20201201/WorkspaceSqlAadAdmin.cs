...
namespace Pulumi.AzureNextGen.Synapse.V20201201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:synapse/v20201201:WorkspaceSqlAadAdmin")]
    public partial class WorkspaceSqlAadAdmin : Pulumi.CustomResource
    {
        ...
        public WorkspaceSqlAadAdmin(string name, WorkspaceSqlAadAdminArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:synapse/v20201201:WorkspaceSqlAadAdmin", name, args ?? new WorkspaceSqlAadAdminArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceSqlAadAdmin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:synapse/v20201201:WorkspaceSqlAadAdmin", name, null, MakeResourceOptions(options, id))
        {
        }
