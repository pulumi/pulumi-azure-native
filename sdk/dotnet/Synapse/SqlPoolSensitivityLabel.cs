...
namespace Pulumi.AzureNative.Synapse
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse:SqlPoolSensitivityLabel")]
    public partial class SqlPoolSensitivityLabel : global::Pulumi.CustomResource
    {
        ...
        public SqlPoolSensitivityLabel(string name, SqlPoolSensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse:SqlPoolSensitivityLabel", name, args ?? new SqlPoolSensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolSensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse:SqlPoolSensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_synapse_v20190601preview:synapse:SqlPoolSensitivityLabel" },
                    new global::Pulumi.Alias { Type = "azure-native_synapse_v20201201:synapse:SqlPoolSensitivityLabel" },
                    new global::Pulumi.Alias { Type = "azure-native_synapse_v20210301:synapse:SqlPoolSensitivityLabel" },
                    new global::Pulumi.Alias { Type = "azure-native_synapse_v20210401preview:synapse:SqlPoolSensitivityLabel" },
                    new global::Pulumi.Alias { Type = "azure-native_synapse_v20210501:synapse:SqlPoolSensitivityLabel" },
                    new global::Pulumi.Alias { Type = "azure-native_synapse_v20210601:synapse:SqlPoolSensitivityLabel" },
                    new global::Pulumi.Alias { Type = "azure-native_synapse_v20210601preview:synapse:SqlPoolSensitivityLabel" },
                },
            };
    ...
    public sealed class SqlPoolSensitivityLabelArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("rank")]
        public Input<Pulumi.AzureNative.Synapse.SensitivityLabelRank>? Rank { get; set; }
