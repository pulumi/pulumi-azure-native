...
namespace Pulumi.AzureRM.Synapse.Preview
{
    ...
    public partial class IpFirewallRule : Pulumi.CustomResource
    {
        ...
        public IpFirewallRule(string name, IpFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:synapse/preview:IpFirewallRule", name, args ?? new IpFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpFirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:synapse/preview:IpFirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:synapse/v20190601preview:IpFirewallRule"},
                },
            };
