...
namespace Pulumi.AzureRM.Synapse.Preview
{
    public static class GetIpFirewallRule
    {
        public static Task<GetIpFirewallRuleResult> InvokeAsync(GetIpFirewallRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIpFirewallRuleResult>("azurerm:synapse/preview:getIpFirewallRule", args ?? new GetIpFirewallRuleArgs(), options.WithVersion());
    }
