...
namespace Pulumi.AzureNextGen.Synapse
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:synapse:IntegrationRuntime")]
    public partial class IntegrationRuntime : Pulumi.CustomResource
    {
        ...
        public IntegrationRuntime(string name, IntegrationRuntimeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:synapse:IntegrationRuntime", name, args ?? new IntegrationRuntimeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationRuntime(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:synapse:IntegrationRuntime", name, null, MakeResourceOptions(options, id))
        {
        }
