...
namespace Pulumi.AzureRM.Synapse.V20200401Preview
{
    public static class GetSqlDatabase
    {
        public static Task<GetSqlDatabaseResult> InvokeAsync(GetSqlDatabaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlDatabaseResult>("azurerm:synapse/v20200401preview:getSqlDatabase", args ?? new GetSqlDatabaseArgs(), options.WithVersion());
    }
