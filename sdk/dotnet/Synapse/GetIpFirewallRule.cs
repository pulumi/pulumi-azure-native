...
namespace Pulumi.AzureNative.Synapse
{
    public static class GetIpFirewallRule
    {
        ...
        public static Output<GetIpFirewallRuleResult> Invoke(GetIpFirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIpFirewallRuleResult>("azure-native:synapse:getIpFirewallRule", args ?? new GetIpFirewallRuleInvokeArgs(), options.WithVersion());
    }
