...
namespace Pulumi.AzureNative.Synapse.Latest.Inputs
{
    ...
    public sealed class IntegrationRuntimeSsisPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("edition")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.Latest.IntegrationRuntimeEdition>? Edition { get; set; }
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.Latest.IntegrationRuntimeLicenseType>? LicenseType { get; set; }
