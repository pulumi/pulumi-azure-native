...
namespace Pulumi.AzureRM.Synapse.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workspace = new AzureRM.Synapse.Latest.Workspace("workspace", new AzureRM.Synapse.Latest.WorkspaceArgs
    ///         {
    ///             DefaultDataLakeStorage = new AzureRM.Synapse.Latest.Inputs.DataLakeStorageAccountDetailsArgs
    ///             {
    ///                 AccountUrl = "https://accountname.dfs.core.windows.net",
    ///                 Filesystem = "default",
    ///             },
    ///             Identity = new AzureRM.Synapse.Latest.Inputs.ManagedIdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "East US",
    ...
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableDictionary<string, ImmutableDictionary<string, object>>> ExtraProperties { get; private set; } = null!;
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:synapse/v20190601preview:Workspace"},
                },
            };
