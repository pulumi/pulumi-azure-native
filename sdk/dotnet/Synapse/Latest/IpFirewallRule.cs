...
namespace Pulumi.AzureRM.Synapse.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var ipFirewallRule = new AzureRM.Synapse.Latest.IpFirewallRule("ipFirewallRule", new AzureRM.Synapse.Latest.IpFirewallRuleArgs
    ///         {
    ...
    public partial class IpFirewallRule : Pulumi.CustomResource
    {
        ...
        public IpFirewallRule(string name, IpFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:IpFirewallRule", name, args ?? new IpFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpFirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:IpFirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
