...
namespace Pulumi.AzureRM.Synapse.Latest
{
    public static class GetIpFirewallRule
    {
        public static Task<GetIpFirewallRuleResult> InvokeAsync(GetIpFirewallRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIpFirewallRuleResult>("azurerm:synapse/latest:getIpFirewallRule", args ?? new GetIpFirewallRuleArgs(), options.WithVersion());
    }
