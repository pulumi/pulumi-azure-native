...
namespace Pulumi.AzureRM.Synapse.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateLinkHub = new AzureRM.Synapse.Latest.PrivateLinkHub("privateLinkHub", new AzureRM.Synapse.Latest.PrivateLinkHubArgs
    ///         {
    ///             Location = "East US",
    ...
    public partial class PrivateLinkHub : Pulumi.CustomResource
    {
        ...
        public PrivateLinkHub(string name, PrivateLinkHubArgs args, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:PrivateLinkHub", name, args ?? new PrivateLinkHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:PrivateLinkHub", name, null, MakeResourceOptions(options, id))
        {
        }
