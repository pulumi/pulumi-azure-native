...
namespace Pulumi.AzureNative.Synapse.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:synapse:WorkspaceAadAdmin'.")]
    [AzureNativeResourceType("azure-native:synapse/latest:WorkspaceAadAdmin")]
    public partial class WorkspaceAadAdmin : Pulumi.CustomResource
    {
        ...
        public WorkspaceAadAdmin(string name, WorkspaceAadAdminArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/latest:WorkspaceAadAdmin", name, args ?? new WorkspaceAadAdminArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceAadAdmin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/latest:WorkspaceAadAdmin", name, null, MakeResourceOptions(options, id))
        {
        }
