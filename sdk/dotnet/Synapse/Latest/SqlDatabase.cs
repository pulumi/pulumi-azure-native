...
namespace Pulumi.AzureRM.Synapse.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlDatabase = new AzureRM.Synapse.Latest.SqlDatabase("sqlDatabase", new AzureRM.Synapse.Latest.SqlDatabaseArgs
    ///         {
    ///             Location = "westus",
    ...
    public partial class SqlDatabase : Pulumi.CustomResource
    {
        ...
        public SqlDatabase(string name, SqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:SqlDatabase", name, args ?? new SqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:SqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
