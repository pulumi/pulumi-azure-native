...
namespace Pulumi.AzureRM.Synapse.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var integrationRuntime = new AzureRM.Synapse.Latest.IntegrationRuntime("integrationRuntime", new AzureRM.Synapse.Latest.IntegrationRuntimeArgs
    ///         {
    ...
    public partial class IntegrationRuntime : Pulumi.CustomResource
    {
        ...
        public IntegrationRuntime(string name, IntegrationRuntimeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:IntegrationRuntime", name, args ?? new IntegrationRuntimeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationRuntime(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:IntegrationRuntime", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:synapse/v20190601preview:IntegrationRuntime"},
                },
            };
