...
namespace Pulumi.AzureNextGen.Synapse.Latest
{
    ...
    public partial class WorkspaceSqlAadAdmin : Pulumi.CustomResource
    {
        ...
        public WorkspaceSqlAadAdmin(string name, WorkspaceSqlAadAdminArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:synapse/latest:WorkspaceSqlAadAdmin", name, args ?? new WorkspaceSqlAadAdminArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceSqlAadAdmin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:synapse/latest:WorkspaceSqlAadAdmin", name, null, MakeResourceOptions(options, id))
        {
        }
