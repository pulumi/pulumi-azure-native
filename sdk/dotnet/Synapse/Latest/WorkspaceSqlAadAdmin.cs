...
namespace Pulumi.AzureNative.Synapse.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:synapse:WorkspaceSqlAadAdmin'.")]
    [AzureNativeResourceType("azure-native:synapse/latest:WorkspaceSqlAadAdmin")]
    public partial class WorkspaceSqlAadAdmin : Pulumi.CustomResource
    {
        ...
        public WorkspaceSqlAadAdmin(string name, WorkspaceSqlAadAdminArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/latest:WorkspaceSqlAadAdmin", name, args ?? new WorkspaceSqlAadAdminArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceSqlAadAdmin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/latest:WorkspaceSqlAadAdmin", name, null, MakeResourceOptions(options, id))
        {
        }
