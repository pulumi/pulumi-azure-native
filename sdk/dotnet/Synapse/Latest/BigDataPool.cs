...
namespace Pulumi.AzureRM.Synapse.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var bigDataPool = new AzureRM.Synapse.Latest.BigDataPool("bigDataPool", new AzureRM.Synapse.Latest.BigDataPoolArgs
    ///         {
    ///             AutoPause = new AzureRM.Synapse.Latest.Inputs.AutoPausePropertiesArgs
    ///             {
    ///                 DelayInMinutes = 15,
    ///                 Enabled = true,
    ///             },
    ///             AutoScale = new AzureRM.Synapse.Latest.Inputs.AutoScalePropertiesArgs
    ///             {
    ///                 Enabled = true,
    ///                 MaxNodeCount = 50,
    ///                 MinNodeCount = 3,
    ...
    ///             LibraryRequirements = new AzureRM.Synapse.Latest.Inputs.LibraryRequirementsArgs
    ///             {
    ///                 Content = "",
    ...
    public partial class BigDataPool : Pulumi.CustomResource
    {
        ...
        public BigDataPool(string name, BigDataPoolArgs args, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:BigDataPool", name, args ?? new BigDataPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BigDataPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:BigDataPool", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:synapse/v20190601preview:BigDataPool"},
                },
            };
