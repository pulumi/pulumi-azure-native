...
namespace Pulumi.AzureRM.Synapse.Latest
{
    /// <summary>
    /// A sql pool resource.
    /// 
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlPoolsV3 = new AzureRM.Synapse.Latest.SqlPoolsV3("sqlPoolsV3", new AzureRM.Synapse.Latest.SqlPoolsV3Args
    ///         {
    ///             Location = "westus",
    ///             ResourceGroupName = "rg_fb5ce457-3576-425e-b22d-7300689fbea0",
    ///             Sku = new AzureRM.Synapse.Latest.Inputs.SkuArgs
    ///             {
    ///                 Name = "DW1000f",
    ///                 Tier = "Synapse",
    ///             },
    ...
    public partial class SqlPoolsV3 : Pulumi.CustomResource
    {
        ...
        public SqlPoolsV3(string name, SqlPoolsV3Args args, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:SqlPoolsV3", name, args ?? new SqlPoolsV3Args(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolsV3(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:synapse/latest:SqlPoolsV3", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:synapse/v20200401preview:SqlPoolsV3"},
                },
            };
