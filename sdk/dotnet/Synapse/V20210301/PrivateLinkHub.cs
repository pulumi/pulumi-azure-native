...
namespace Pulumi.AzureNative.Synapse.V20210301
{
    ...
    /// {
    ///     var privateLinkHub = new AzureNative.Synapse.V20210301.PrivateLinkHub("privateLinkHub", new()
    ///     {
    ///         Location = "East US",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210301:PrivateLinkHub")]
    public partial class PrivateLinkHub : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkHub(string name, PrivateLinkHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210301:PrivateLinkHub", name, args ?? new PrivateLinkHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210301:PrivateLinkHub", name, null, MakeResourceOptions(options, id))
        {
        }
