...
namespace Pulumi.AzureNative.Synapse.V20210301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:synapse/v20210301:SqlPoolTransparentDataEncryption is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:SqlPoolTransparentDataEncryption to guarantee forwards compatibility.")]
    ...
    public partial class SqlPoolTransparentDataEncryption : global::Pulumi.CustomResource
    {
        ...
        public SqlPoolTransparentDataEncryption(string name, SqlPoolTransparentDataEncryptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210301:SqlPoolTransparentDataEncryption", name, args ?? new SqlPoolTransparentDataEncryptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolTransparentDataEncryption(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210301:SqlPoolTransparentDataEncryption", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlPoolTransparentDataEncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210301.TransparentDataEncryptionStatus>? Status { get; set; }
