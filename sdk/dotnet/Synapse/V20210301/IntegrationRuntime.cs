...
namespace Pulumi.AzureNative.Synapse.V20210301
{
    ...
    /// {
    ///     var integrationRuntime = new AzureNative.Synapse.V20210301.IntegrationRuntime("integrationRuntime", new()
    ///     {
    ///         IntegrationRuntimeName = "exampleIntegrationRuntime",
    ///         Properties = new AzureNative.Synapse.V20210301.Inputs.SelfHostedIntegrationRuntimeArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210301:IntegrationRuntime")]
    public partial class IntegrationRuntime : global::Pulumi.CustomResource
    {
        ...
        public IntegrationRuntime(string name, IntegrationRuntimeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210301:IntegrationRuntime", name, args ?? new IntegrationRuntimeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationRuntime(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210301:IntegrationRuntime", name, null, MakeResourceOptions(options, id))
        {
        }
