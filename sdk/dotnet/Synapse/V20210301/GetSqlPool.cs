...
namespace Pulumi.AzureNative.Synapse.V20210301
{
    public static class GetSqlPool
    {
        ...
        public static Task<GetSqlPoolResult> InvokeAsync(GetSqlPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlPoolResult>("azure-native:synapse/v20210301:getSqlPool", args ?? new GetSqlPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Get SQL pool properties
        /// </summary>
        public static Output<GetSqlPoolResult> Invoke(GetSqlPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSqlPoolResult>("azure-native:synapse/v20210301:getSqlPool", args ?? new GetSqlPoolInvokeArgs(), options.WithDefaults());
    }
