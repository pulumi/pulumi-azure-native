...
namespace Pulumi.AzureNative.Synapse.V20210301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:synapse/v20210301:SqlPoolWorkloadClassifier is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:SqlPoolWorkloadClassifier to guarantee forwards compatibility.")]
    ...
    public partial class SqlPoolWorkloadClassifier : global::Pulumi.CustomResource
    {
        ...
        public SqlPoolWorkloadClassifier(string name, SqlPoolWorkloadClassifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210301:SqlPoolWorkloadClassifier", name, args ?? new SqlPoolWorkloadClassifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolWorkloadClassifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210301:SqlPoolWorkloadClassifier", name, null, MakeResourceOptions(options, id))
        {
        }
