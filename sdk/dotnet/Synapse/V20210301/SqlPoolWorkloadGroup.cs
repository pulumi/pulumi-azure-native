...
namespace Pulumi.AzureNative.Synapse.V20210301
{
    ...
    /// {
    ///     var sqlPoolWorkloadGroup = new AzureNative.Synapse.V20210301.SqlPoolWorkloadGroup("sqlPoolWorkloadGroup", new()
    ///     {
    ///         Importance = "normal",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210301:SqlPoolWorkloadGroup")]
    public partial class SqlPoolWorkloadGroup : global::Pulumi.CustomResource
    {
        ...
        public SqlPoolWorkloadGroup(string name, SqlPoolWorkloadGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210301:SqlPoolWorkloadGroup", name, args ?? new SqlPoolWorkloadGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolWorkloadGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210301:SqlPoolWorkloadGroup", name, null, MakeResourceOptions(options, id))
        {
        }
