...
namespace Pulumi.AzureNative.Synapse.V20210301
{
    ...
    /// {
    ///     var sqlPool = new AzureNative.Synapse.V20210301.SqlPool("sqlPool", new()
    ///     {
    ///         Collation = "",
    ///         CreateMode = "",
    ...
    ///         Sku = new AzureNative.Synapse.V20210301.Inputs.SkuArgs
    ///         {
    ///             Name = "",
    ///             Tier = "",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210301:SqlPool")]
    public partial class SqlPool : global::Pulumi.CustomResource
    {
        ...
        public SqlPool(string name, SqlPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210301:SqlPool", name, args ?? new SqlPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210301:SqlPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210301.StorageAccountType>? StorageAccountType { get; set; }
