...
namespace Pulumi.AzureNative.Synapse.V20190601Preview
{
    public static class GetPrivateLinkHub
    {
        ...
        public static Output<GetPrivateLinkHubResult> Invoke(GetPrivateLinkHubInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPrivateLinkHubResult>("azure-native:synapse/v20190601preview:getPrivateLinkHub", args ?? new GetPrivateLinkHubInvokeArgs(), options.WithVersion());
    }
