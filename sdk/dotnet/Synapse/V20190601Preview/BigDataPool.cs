...
namespace Pulumi.AzureNative.Synapse.V20190601Preview
{
    ...
    public partial class BigDataPool : Pulumi.CustomResource
    {
        ...
        public BigDataPool(string name, BigDataPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20190601preview:BigDataPool", name, args ?? new BigDataPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BigDataPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20190601preview:BigDataPool", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210401preview:BigDataPool"},
                    new Pulumi.Alias { Type = "azure-native:synapse/v20210501:BigDataPool"},
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210501:BigDataPool"},
                    new Pulumi.Alias { Type = "azure-native:synapse/v20210601:BigDataPool"},
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210601:BigDataPool"},
                    new Pulumi.Alias { Type = "azure-native:synapse/v20210601preview:BigDataPool"},
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210601preview:BigDataPool"},
                },
            };
    ...
    public sealed class BigDataPoolArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("nodeSize")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20190601Preview.NodeSize>? NodeSize { get; set; }

        /// <summary>
        /// The kind of nodes that the Big Data pool provides.
        /// </summary>
        [Input("nodeSizeFamily")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20190601Preview.NodeSizeFamily>? NodeSizeFamily { get; set; }
