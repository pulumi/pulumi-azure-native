...
namespace Pulumi.AzureNative.Synapse.V20190601Preview
{
    ...
    /// A workspace key
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20190601preview:Key")]
    public partial class Key : Pulumi.CustomResource
    {
        ...
        public Key(string name, KeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20190601preview:Key", name, args ?? new KeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Key(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20190601preview:Key", name, null, MakeResourceOptions(options, id))
        {
        }
