...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:synapse/v20210401preview:SqlPool is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210501:SqlPool to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:synapse/v20210401preview:SqlPool")]
    public partial class SqlPool : global::Pulumi.CustomResource
    {
        ...
        public SqlPool(string name, SqlPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:SqlPool", name, args ?? new SqlPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:SqlPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210401Preview.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210401Preview.StorageAccountType>? StorageAccountType { get; set; }
