...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    ...
    /// {
    ///     var kustoPoolPrincipalAssignment = new AzureNative.Synapse.V20210401Preview.KustoPoolPrincipalAssignment("kustoPoolPrincipalAssignment", new()
    ///     {
    ...
    public partial class KustoPoolPrincipalAssignment : global::Pulumi.CustomResource
    {
        ...
        public KustoPoolPrincipalAssignment(string name, KustoPoolPrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:KustoPoolPrincipalAssignment", name, args ?? new KustoPoolPrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KustoPoolPrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:KustoPoolPrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class KustoPoolPrincipalAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210401Preview.ClusterPrincipalRole> Role { get; set; } = null!;
