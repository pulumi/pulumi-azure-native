...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210401preview:SqlPoolWorkloadClassifier")]
    public partial class SqlPoolWorkloadClassifier : Pulumi.CustomResource
    {
        ...
        public SqlPoolWorkloadClassifier(string name, SqlPoolWorkloadClassifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:SqlPoolWorkloadClassifier", name, args ?? new SqlPoolWorkloadClassifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPoolWorkloadClassifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:SqlPoolWorkloadClassifier", name, null, MakeResourceOptions(options, id))
        {
        }
