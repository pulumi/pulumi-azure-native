...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    ...
    [AzureNativeResourceType("azure-native:synapse/v20210401preview:WorkspaceAadAdmin")]
    public partial class WorkspaceAadAdmin : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceAadAdmin(string name, WorkspaceAadAdminArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:WorkspaceAadAdmin", name, args ?? new WorkspaceAadAdminArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceAadAdmin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:WorkspaceAadAdmin", name, null, MakeResourceOptions(options, id))
        {
        }
