...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    public static class GetBigDataPool
    {
        ...
        public static Task<GetBigDataPoolResult> InvokeAsync(GetBigDataPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBigDataPoolResult>("azure-native:synapse/v20210401preview:getBigDataPool", args ?? new GetBigDataPoolArgs(), options.WithVersion());

        /// <summary>
        /// A Big Data pool
        /// </summary>
        public static Output<GetBigDataPoolResult> Invoke(GetBigDataPoolInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBigDataPoolResult>("azure-native:synapse/v20210401preview:getBigDataPool", args ?? new GetBigDataPoolInvokeArgs(), options.WithVersion());
    }
