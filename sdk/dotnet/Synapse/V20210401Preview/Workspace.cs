...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    ...
    /// A workspace
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210401preview:Workspace")]
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210401preview:Workspace"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210501:Workspace"},
                    new Pulumi.Alias { Type = "azure-native:synapse/v20210601:Workspace"},
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210601:Workspace"},
                    new Pulumi.Alias { Type = "azure-native:synapse/v20210601preview:Workspace"},
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210601preview:Workspace"},
                },
            };
    ...
    public sealed class WorkspaceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210401Preview.WorkspacePublicNetworkAccess>? PublicNetworkAccess { get; set; }
