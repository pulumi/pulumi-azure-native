...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    ...
    /// A privateLinkHub
    /// </summary>
    [Obsolete(@"azure-native:synapse/v20210401preview:PrivateLinkHub is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:PrivateLinkHub to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:synapse/v20210401preview:PrivateLinkHub")]
    public partial class PrivateLinkHub : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkHub(string name, PrivateLinkHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:PrivateLinkHub", name, args ?? new PrivateLinkHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:PrivateLinkHub", name, null, MakeResourceOptions(options, id))
        {
        }
