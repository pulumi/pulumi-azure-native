...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20201201:PrivateEndpointConnection"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210501:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:synapse/v20210601:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210601:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:synapse/v20210601preview:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:synapse/v20210601preview:PrivateEndpointConnection"},
                },
            };
