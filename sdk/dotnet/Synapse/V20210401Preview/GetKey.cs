...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    public static class GetKey
    {
        ...
        public static Task<GetKeyResult> InvokeAsync(GetKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKeyResult>("azure-native:synapse/v20210401preview:getKey", args ?? new GetKeyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a workspace key
        /// </summary>
        public static Output<GetKeyResult> Invoke(GetKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKeyResult>("azure-native:synapse/v20210401preview:getKey", args ?? new GetKeyInvokeArgs(), options.WithDefaults());
    }
