...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    public static class GetIotHubDataConnection
    {
        ...
        public static Task<GetIotHubDataConnectionResult> InvokeAsync(GetIotHubDataConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIotHubDataConnectionResult>("azure-native:synapse/v20210401preview:getIotHubDataConnection", args ?? new GetIotHubDataConnectionArgs(), options.WithDefaults());
        ...
        public static Output<GetIotHubDataConnectionResult> Invoke(GetIotHubDataConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIotHubDataConnectionResult>("azure-native:synapse/v20210401preview:getIotHubDataConnection", args ?? new GetIotHubDataConnectionInvokeArgs(), options.WithDefaults());
    }
