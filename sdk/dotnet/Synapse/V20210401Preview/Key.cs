...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    ...
    /// A workspace key
    /// </summary>
    [Obsolete(@"azure-native:synapse/v20210401preview:Key is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:Key to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:synapse/v20210401preview:Key")]
    public partial class Key : global::Pulumi.CustomResource
    {
        ...
        public Key(string name, KeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:Key", name, args ?? new KeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Key(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:Key", name, null, MakeResourceOptions(options, id))
        {
        }
