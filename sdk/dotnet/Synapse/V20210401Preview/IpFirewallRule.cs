...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    ...
    [AzureNativeResourceType("azure-native:synapse/v20210401preview:IpFirewallRule")]
    public partial class IpFirewallRule : global::Pulumi.CustomResource
    {
        ...
        public IpFirewallRule(string name, IpFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:IpFirewallRule", name, args ?? new IpFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpFirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:IpFirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
