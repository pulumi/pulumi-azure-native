...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    ...
    /// {
    ///     var eventGridDataConnection = new AzureNative.Synapse.V20210401Preview.EventGridDataConnection("eventGridDataConnection", new()
    ///     {
    ...
    public partial class EventGridDataConnection : global::Pulumi.CustomResource
    {
        ...
        public EventGridDataConnection(string name, EventGridDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:EventGridDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EventGridDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:EventGridDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventGridDataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210401Preview.BlobStorageEventType>? BlobStorageEventType { get; set; }
        ...
        /// </summary>
        [Input("dataFormat")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210401Preview.EventGridDataFormat>? DataFormat { get; set; }
