...
namespace Pulumi.AzureNative.Synapse.V20210401Preview
{
    ...
    /// A Big Data pool
    /// </summary>
    [Obsolete(@"azure-native:synapse/v20210401preview:BigDataPool is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210501:BigDataPool to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:synapse/v20210401preview:BigDataPool")]
    public partial class BigDataPool : global::Pulumi.CustomResource
    {
        ...
        public BigDataPool(string name, BigDataPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:BigDataPool", name, args ?? new BigDataPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BigDataPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210401preview:BigDataPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BigDataPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("nodeSize")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210401Preview.NodeSize>? NodeSize { get; set; }

        /// <summary>
        /// The kind of nodes that the Big Data pool provides.
        /// </summary>
        [Input("nodeSizeFamily")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210401Preview.NodeSizeFamily>? NodeSizeFamily { get; set; }
