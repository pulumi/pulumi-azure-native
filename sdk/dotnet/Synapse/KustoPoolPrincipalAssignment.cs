...
namespace Pulumi.AzureNative.Synapse
{
    ...
    public partial class KustoPoolPrincipalAssignment : global::Pulumi.CustomResource
    {
        ...
        public KustoPoolPrincipalAssignment(string name, KustoPoolPrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse:KustoPoolPrincipalAssignment", name, args ?? new KustoPoolPrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KustoPoolPrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse:KustoPoolPrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_synapse_v20210401preview:synapse:KustoPoolPrincipalAssignment" },
                    new global::Pulumi.Alias { Type = "azure-native_synapse_v20210601preview:synapse:KustoPoolPrincipalAssignment" },
                },
            };
    ...
    public sealed class KustoPoolPrincipalAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.PrincipalType> PrincipalType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.ClusterPrincipalRole> Role { get; set; } = null!;
