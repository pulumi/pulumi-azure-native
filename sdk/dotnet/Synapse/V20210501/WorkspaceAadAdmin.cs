...
namespace Pulumi.AzureNative.Synapse.V20210501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210501:WorkspaceAadAdmin")]
    public partial class WorkspaceAadAdmin : Pulumi.CustomResource
    {
        ...
        public WorkspaceAadAdmin(string name, WorkspaceAadAdminArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210501:WorkspaceAadAdmin", name, args ?? new WorkspaceAadAdminArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceAadAdmin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210501:WorkspaceAadAdmin", name, null, MakeResourceOptions(options, id))
        {
        }
