...
namespace Pulumi.AzureNative.Synapse.V20210501
{
    public static class GetPrivateLinkHub
    {
        ...
        public static Task<GetPrivateLinkHubResult> InvokeAsync(GetPrivateLinkHubArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateLinkHubResult>("azure-native:synapse/v20210501:getPrivateLinkHub", args ?? new GetPrivateLinkHubArgs(), options.WithVersion());

        /// <summary>
        /// A privateLinkHub
        /// </summary>
        public static Output<GetPrivateLinkHubResult> Invoke(GetPrivateLinkHubInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPrivateLinkHubResult>("azure-native:synapse/v20210501:getPrivateLinkHub", args ?? new GetPrivateLinkHubInvokeArgs(), options.WithVersion());
    }
