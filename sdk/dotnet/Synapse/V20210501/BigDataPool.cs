...
namespace Pulumi.AzureNative.Synapse.V20210501
{
    ...
    /// {
    ///     var bigDataPool = new AzureNative.Synapse.V20210501.BigDataPool("bigDataPool", new()
    ///     {
    ///         AutoPause = new AzureNative.Synapse.V20210501.Inputs.AutoPausePropertiesArgs
    ///         {
    ///             DelayInMinutes = 15,
    ///             Enabled = true,
    ///         },
    ///         AutoScale = new AzureNative.Synapse.V20210501.Inputs.AutoScalePropertiesArgs
    ///         {
    ///             Enabled = true,
    ///             MaxNodeCount = 50,
    ///             MinNodeCount = 3,
    ...
    ///         LibraryRequirements = new AzureNative.Synapse.V20210501.Inputs.LibraryRequirementsArgs
    ///         {
    ///             Content = "",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210501:BigDataPool")]
    public partial class BigDataPool : global::Pulumi.CustomResource
    {
        ...
        public BigDataPool(string name, BigDataPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210501:BigDataPool", name, args ?? new BigDataPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BigDataPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210501:BigDataPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BigDataPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("nodeSize")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210501.NodeSize>? NodeSize { get; set; }

        /// <summary>
        /// The kind of nodes that the Big Data pool provides.
        /// </summary>
        [Input("nodeSizeFamily")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210501.NodeSizeFamily>? NodeSizeFamily { get; set; }
