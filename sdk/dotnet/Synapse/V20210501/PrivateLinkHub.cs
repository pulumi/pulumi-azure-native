...
namespace Pulumi.AzureNative.Synapse.V20210501
{
    ...
    /// A privateLinkHub
    /// </summary>
    [Obsolete(@"azure-native:synapse/v20210501:PrivateLinkHub is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:PrivateLinkHub to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:synapse/v20210501:PrivateLinkHub")]
    public partial class PrivateLinkHub : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkHub(string name, PrivateLinkHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210501:PrivateLinkHub", name, args ?? new PrivateLinkHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210501:PrivateLinkHub", name, null, MakeResourceOptions(options, id))
        {
        }
