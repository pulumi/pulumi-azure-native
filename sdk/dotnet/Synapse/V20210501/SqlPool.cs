...
namespace Pulumi.AzureNative.Synapse.V20210501
{
    ...
    /// {
    ///     var sqlPool = new AzureNative.Synapse.V20210501.SqlPool("sqlPool", new()
    ///     {
    ///         Collation = "",
    ///         CreateMode = "",
    ...
    ///         Sku = new AzureNative.Synapse.V20210501.Inputs.SkuArgs
    ///         {
    ///             Name = "",
    ///             Tier = "",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:synapse/v20210501:SqlPool ExampleSqlPool /subscriptions/01234567-89ab-4def-0123-456789abcdef/resourceGroups/ExampleResourceGroup/providers/Microsoft.Synapse/workspaces/ExampleWorkspaces/sqlPools/ExampleSqlPool 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210501:SqlPool")]
    public partial class SqlPool : global::Pulumi.CustomResource
    {
        ...
        public SqlPool(string name, SqlPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210501:SqlPool", name, args ?? new SqlPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210501:SqlPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210501.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210501.StorageAccountType>? StorageAccountType { get; set; }
