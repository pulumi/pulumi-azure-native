...
namespace Pulumi.AzureNative.Synapse.V20210501
{
    ...
    /// {
    ///     var workspace = new AzureNative.Synapse.V20210501.Workspace("workspace", new()
    ///     {
    ///         CspWorkspaceAdminProperties = new AzureNative.Synapse.V20210501.Inputs.CspWorkspaceAdminPropertiesArgs
    ///         {
    ///             InitialWorkspaceAdminObjectId = "6c20646f-8050-49ec-b3b1-80a0e58e454d",
    ///         },
    ///         DefaultDataLakeStorage = new AzureNative.Synapse.V20210501.Inputs.DataLakeStorageAccountDetailsArgs
    ///         {
    ///             AccountUrl = "https://accountname.dfs.core.windows.net",
    ///             Filesystem = "default",
    ///         },
    ///         Encryption = new AzureNative.Synapse.V20210501.Inputs.EncryptionDetailsArgs
    ///         {
    ///             Cmk = new AzureNative.Synapse.V20210501.Inputs.CustomerManagedKeyDetailsArgs
    ///             {
    ///                 KekIdentity = new AzureNative.Synapse.V20210501.Inputs.KekIdentityPropertiesArgs
    ///                 {
    ...
    ///                 },
    ///                 Key = new AzureNative.Synapse.V20210501.Inputs.WorkspaceKeyDetailsArgs
    ///                 {
    ...
    ///             },
    ///         },
    ///         Identity = new AzureNative.Synapse.V20210501.Inputs.ManagedIdentityArgs
    ///         {
    ///             Type = AzureNative.Synapse.V20210501.ResourceIdentityType.SystemAssigned_UserAssigned,
    ...
    ///         ManagedVirtualNetworkSettings = new AzureNative.Synapse.V20210501.Inputs.ManagedVirtualNetworkSettingsArgs
    ///         {
    ...
    ///         PurviewConfiguration = new AzureNative.Synapse.V20210501.Inputs.PurviewConfigurationArgs
    ///         {
    ...
    ///         WorkspaceRepositoryConfiguration = new AzureNative.Synapse.V20210501.Inputs.WorkspaceRepositoryConfigurationArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:synapse/v20210501:Workspace workspace1 /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/resourceGroup1/providers/Microsoft.Synapse/workspaces/workspace1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:synapse/v20210501:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210501:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210501:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Synapse.V20210501.WorkspacePublicNetworkAccess>? PublicNetworkAccess { get; set; }
