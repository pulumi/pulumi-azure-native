...
namespace Pulumi.AzureNative.Synapse.V20210501
{
    public static class GetBigDataPool
    {
        ...
        public static Task<GetBigDataPoolResult> InvokeAsync(GetBigDataPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBigDataPoolResult>("azure-native:synapse/v20210501:getBigDataPool", args ?? new GetBigDataPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Big Data pool.
        /// </summary>
        public static Output<GetBigDataPoolResult> Invoke(GetBigDataPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBigDataPoolResult>("azure-native:synapse/v20210501:getBigDataPool", args ?? new GetBigDataPoolInvokeArgs(), options.WithDefaults());
    }
