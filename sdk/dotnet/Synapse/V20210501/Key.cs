...
namespace Pulumi.AzureNative.Synapse.V20210501
{
    ...
    [AzureNativeResourceType("azure-native:synapse/v20210501:Key")]
    public partial class Key : global::Pulumi.CustomResource
    {
        ...
        public Key(string name, KeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210501:Key", name, args ?? new KeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Key(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:synapse/v20210501:Key", name, null, MakeResourceOptions(options, id))
        {
        }
