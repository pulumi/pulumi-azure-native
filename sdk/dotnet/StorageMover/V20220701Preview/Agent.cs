...
namespace Pulumi.AzureNative.StorageMover.V20220701Preview
{
    ...
    /// {
    ///     var agent = new AzureNative.StorageMover.V20220701Preview.Agent("agent", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:storagemover/v20220701preview:Agent examples-agentName /subscriptions/11111111-2222-3333-4444-555555555555/resourceGroups/examples-rg/providers/Microsoft.StorageMover/storageMovers/examples-storageMoverName/agents/examples-agentName 
    /// ```
    /// </summary>
    ...
    public partial class Agent : global::Pulumi.CustomResource
    {
        ...
        public Agent(string name, AgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20220701preview:Agent", name, args ?? new AgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Agent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20220701preview:Agent", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:storagemover:Agent"},
