...
namespace Pulumi.AzureNative.StorageMover.V20220701Preview
{
    ...
    /// {
    ///     var project = new AzureNative.StorageMover.V20220701Preview.Project("project", new()
    ///     {
    ...
    public partial class Project : global::Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20220701preview:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20220701preview:Project", name, null, MakeResourceOptions(options, id))
        {
        }
