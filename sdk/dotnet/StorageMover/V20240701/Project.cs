...
namespace Pulumi.AzureNative.StorageMover.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagemover/v20240701:Project")]
    public partial class Project : global::Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20240701:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20240701:Project", name, null, MakeResourceOptions(options, id))
        {
        }
