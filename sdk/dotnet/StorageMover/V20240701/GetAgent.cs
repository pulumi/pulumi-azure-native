...
namespace Pulumi.AzureNative.StorageMover.V20240701
{
    public static class GetAgent
    {
        ...
        public static Task<GetAgentResult> InvokeAsync(GetAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAgentResult>("azure-native:storagemover/v20240701:getAgent", args ?? new GetAgentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an Agent resource.
        /// </summary>
        public static Output<GetAgentResult> Invoke(GetAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAgentResult>("azure-native:storagemover/v20240701:getAgent", args ?? new GetAgentInvokeArgs(), options.WithDefaults());
    }
