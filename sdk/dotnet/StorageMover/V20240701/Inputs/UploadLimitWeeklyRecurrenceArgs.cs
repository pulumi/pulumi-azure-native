...
namespace Pulumi.AzureNative.StorageMover.V20240701.Inputs
{
    ...
    public sealed class UploadLimitWeeklyRecurrenceArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.AzureNative.StorageMover.V20240701.DayOfWeek>? _days;

        /// <summary>
        /// The set of days of week for the schedule recurrence. A day must not be specified more than once in a recurrence.
        /// </summary>
        public InputList<Pulumi.AzureNative.StorageMover.V20240701.DayOfWeek> Days
        {
            get => _days ?? (_days = new InputList<Pulumi.AzureNative.StorageMover.V20240701.DayOfWeek>());
            set => _days = value;
        }
