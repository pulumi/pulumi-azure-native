...
namespace Pulumi.AzureNative.StorageMover.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagemover/v20240701:JobDefinition")]
    public partial class JobDefinition : global::Pulumi.CustomResource
    {
        ...
        public JobDefinition(string name, JobDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20240701:JobDefinition", name, args ?? new JobDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20240701:JobDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class JobDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageMover.V20240701.CopyMode> CopyMode { get; set; } = null!;
