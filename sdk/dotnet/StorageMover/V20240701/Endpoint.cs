...
namespace Pulumi.AzureNative.StorageMover.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagemover/v20240701:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20240701:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20240701:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
