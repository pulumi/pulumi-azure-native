...
namespace Pulumi.AzureNative.StorageMover.V20240701
{
    public static class GetStorageMover
    {
        ...
        public static Task<GetStorageMoverResult> InvokeAsync(GetStorageMoverArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStorageMoverResult>("azure-native:storagemover/v20240701:getStorageMover", args ?? new GetStorageMoverArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Storage Mover resource.
        /// </summary>
        public static Output<GetStorageMoverResult> Invoke(GetStorageMoverInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStorageMoverResult>("azure-native:storagemover/v20240701:getStorageMover", args ?? new GetStorageMoverInvokeArgs(), options.WithDefaults());
