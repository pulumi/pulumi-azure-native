...
namespace Pulumi.AzureNative.StorageMover
{
    ...
    public partial class Project : global::Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagemover:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagemover:Project", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:storagemover/v20250801:Project" },
                    new global::Pulumi.Alias { Type = "azure-native:storagemover/v20251201:Project" },
                    new global::Pulumi.Alias { Type = "azure-native:storagemover/v20260501:Project" },
                },
            };
