...
namespace Pulumi.AzureNative.StorageMover.V20231001
{
    public static class GetStorageMover
    {
        ...
        public static Task<GetStorageMoverResult> InvokeAsync(GetStorageMoverArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStorageMoverResult>("azure-native:storagemover/v20231001:getStorageMover", args ?? new GetStorageMoverArgs(), options.WithDefaults());
