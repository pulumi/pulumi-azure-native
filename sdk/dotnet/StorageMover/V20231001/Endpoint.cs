...
namespace Pulumi.AzureNative.StorageMover.V20231001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagemover/v20231001:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20231001:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20231001:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
