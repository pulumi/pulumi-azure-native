...
namespace Pulumi.AzureNative.StorageMover.V20230301
{
    ...
    /// {
    ///     var agent = new AzureNative.StorageMover.V20230301.Agent("agent", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storagemover/v20230301:Agent")]
    public partial class Agent : global::Pulumi.CustomResource
    {
        ...
        public Agent(string name, AgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20230301:Agent", name, args ?? new AgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Agent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20230301:Agent", name, null, MakeResourceOptions(options, id))
        {
        }
