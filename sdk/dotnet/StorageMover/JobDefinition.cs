...
namespace Pulumi.AzureNative.StorageMover
{
    ...
    public partial class JobDefinition : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:storagemover/v20220701preview:JobDefinition"},
                },
            };
    ...
    public sealed class JobDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("copyMode")]
        public InputUnion<string, Pulumi.AzureNative.StorageMover.CopyMode>? CopyMode { get; set; }
