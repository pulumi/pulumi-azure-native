...
namespace Pulumi.AzureNative.StorageMover.V20230701Preview
{
    ...
    /// The Agent resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:storagemover/v20230701preview:Agent")]
    public partial class Agent : global::Pulumi.CustomResource
    {
        ...
        public Agent(string name, AgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20230701preview:Agent", name, args ?? new AgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Agent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20230701preview:Agent", name, null, MakeResourceOptions(options, id))
        {
        }
