...
namespace Pulumi.AzureNative.StorageMover.V20230701Preview
{
    public static class GetStorageMover
    {
        ...
        public static Task<GetStorageMoverResult> InvokeAsync(GetStorageMoverArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStorageMoverResult>("azure-native:storagemover/v20230701preview:getStorageMover", args ?? new GetStorageMoverArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Storage Mover resource.
        /// </summary>
        public static Output<GetStorageMoverResult> Invoke(GetStorageMoverInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStorageMoverResult>("azure-native:storagemover/v20230701preview:getStorageMover", args ?? new GetStorageMoverInvokeArgs(), options.WithDefaults());
