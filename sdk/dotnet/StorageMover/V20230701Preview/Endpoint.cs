...
namespace Pulumi.AzureNative.StorageMover.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagemover/v20230701preview:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20230701preview:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagemover/v20230701preview:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
