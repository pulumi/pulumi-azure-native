...
namespace Pulumi.AzureNative.StorageMover.V20230701Preview
{
    public static class GetAgent
    {
        ...
        public static Task<GetAgentResult> InvokeAsync(GetAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAgentResult>("azure-native:storagemover/v20230701preview:getAgent", args ?? new GetAgentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an Agent resource.
        /// </summary>
        public static Output<GetAgentResult> Invoke(GetAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAgentResult>("azure-native:storagemover/v20230701preview:getAgent", args ?? new GetAgentInvokeArgs(), options.WithDefaults());
