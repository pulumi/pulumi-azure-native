...
namespace Pulumi.AzureNative.ExtendedLocation.V20210831Preview
{
    ...
    public partial class ResourceSyncRule : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("selector")]
        public Output<Outputs.ResourceSyncRulePropertiesResponseSelector?> Selector { get; private set; } = null!;
        ...
        public ResourceSyncRule(string name, ResourceSyncRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:extendedlocation/v20210831preview:ResourceSyncRule", name, args ?? new ResourceSyncRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceSyncRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:extendedlocation/v20210831preview:ResourceSyncRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:extendedlocation:ResourceSyncRule"},
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceSyncRule Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class ResourceSyncRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("selector")]
        public Input<Inputs.ResourceSyncRulePropertiesSelectorArgs>? Selector { get; set; }
        ...
        public Input<string>? TargetResourceGroup { get; set; }
