...
namespace Pulumi.AzureNative.ExtendedLocation.V20200715PrivatePreview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:extendedlocation/v20200715privatepreview:customLocation")]
    public partial class CustomLocation : Pulumi.CustomResource
    {
        ...
        public CustomLocation(string name, CustomLocationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:extendedlocation/v20200715privatepreview:customLocation", name, args ?? new CustomLocationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomLocation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:extendedlocation/v20200715privatepreview:customLocation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:extendedlocation/v20200715privatepreview:customLocation"},
    ...
    public sealed class CustomLocationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostType")]
        public InputUnion<string, Pulumi.AzureNative.ExtendedLocation.V20200715PrivatePreview.HostType>? HostType { get; set; }
