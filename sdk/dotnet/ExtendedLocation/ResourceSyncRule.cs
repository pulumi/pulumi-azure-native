...
namespace Pulumi.AzureNative.ExtendedLocation
{
    ...
    public partial class ResourceSyncRule : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("selector")]
        public Output<Outputs.ResourceSyncRulePropertiesSelectorResponse?> Selector { get; private set; } = null!;
        ...
        public ResourceSyncRule(string name, ResourceSyncRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:extendedlocation:ResourceSyncRule", name, args ?? new ResourceSyncRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceSyncRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:extendedlocation:ResourceSyncRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:extendedlocation/v20240915preview:ResourceSyncRule" },
                },
            };
