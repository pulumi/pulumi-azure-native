...
namespace Pulumi.AzureNative.ExtendedLocation.V20210315Preview
{
    ...
    /// {
    ///     var customLocation = new AzureNative.ExtendedLocation.V20210315Preview.CustomLocation("customLocation", new()
    ///     {
    ///         Authentication = new AzureNative.ExtendedLocation.V20210315Preview.Inputs.CustomLocationPropertiesAuthenticationArgs
    ///         {
    ///             Type = "KubeConfig",
    ...
    public partial class CustomLocation : global::Pulumi.CustomResource
    {
        ...
        public CustomLocation(string name, CustomLocationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:extendedlocation/v20210315preview:CustomLocation", name, args ?? new CustomLocationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomLocation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:extendedlocation/v20210315preview:CustomLocation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CustomLocationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostType")]
        public InputUnion<string, Pulumi.AzureNative.ExtendedLocation.V20210315Preview.HostType>? HostType { get; set; }
