...
namespace Pulumi.AzureNative.PolicyInsights
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:policyinsights:RemediationAtResourceGroup")]
    public partial class RemediationAtResourceGroup : global::Pulumi.CustomResource
    {
        ...
        public RemediationAtResourceGroup(string name, RemediationAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights:RemediationAtResourceGroup", name, args ?? new RemediationAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights:RemediationAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_policyinsights_v20180701preview:policyinsights:RemediationAtResourceGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_policyinsights_v20190701:policyinsights:RemediationAtResourceGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_policyinsights_v20211001:policyinsights:RemediationAtResourceGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_policyinsights_v20241001:policyinsights:RemediationAtResourceGroup" },
                },
            };
