...
namespace Pulumi.AzureNative.PolicyInsights
{
    ...
    public partial class AttestationAtResourceGroup : Pulumi.CustomResource
    {
        ...
        public AttestationAtResourceGroup(string name, AttestationAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights:AttestationAtResourceGroup", name, args ?? new AttestationAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights:AttestationAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:policyinsights:AttestationAtResourceGroup"},
                    new Pulumi.Alias { Type = "azure-native:policyinsights/latest:AttestationAtResourceGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:policyinsights/latest:AttestationAtResourceGroup"},
                    new Pulumi.Alias { Type = "azure-native:policyinsights/v20210101:AttestationAtResourceGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:policyinsights/v20210101:AttestationAtResourceGroup"},
                },
            };
