...
namespace Pulumi.AzureNative.PolicyInsights.V20211001
{
    ...
    /// {
    ///     var remediationAtManagementGroup = new AzureNative.PolicyInsights.V20211001.RemediationAtManagementGroup("remediationAtManagementGroup", new()
    ///     {
    ...
    public partial class RemediationAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public RemediationAtManagementGroup(string name, RemediationAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20211001:RemediationAtManagementGroup", name, args ?? new RemediationAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20211001:RemediationAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RemediationAtManagementGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.PolicyInsights.V20211001.ResourceDiscoveryMode>? ResourceDiscoveryMode { get; set; }
