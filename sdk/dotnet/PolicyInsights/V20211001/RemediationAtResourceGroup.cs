...
namespace Pulumi.AzureNative.PolicyInsights.V20211001
{
    ...
    /// {
    ///     var remediationAtResourceGroup = new AzureNative.PolicyInsights.V20211001.RemediationAtResourceGroup("remediationAtResourceGroup", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:policyinsights/v20211001:RemediationAtResourceGroup")]
    public partial class RemediationAtResourceGroup : global::Pulumi.CustomResource
    {
        ...
        public RemediationAtResourceGroup(string name, RemediationAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20211001:RemediationAtResourceGroup", name, args ?? new RemediationAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20211001:RemediationAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
