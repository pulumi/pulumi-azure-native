...
namespace Pulumi.AzureNative.PolicyInsights.V20211001
{
    ...
    /// {
    ///     var remediationAtResource = new AzureNative.PolicyInsights.V20211001.RemediationAtResource("remediationAtResource", new()
    ///     {
    ...
    public partial class RemediationAtResource : global::Pulumi.CustomResource
    {
        ...
        public RemediationAtResource(string name, RemediationAtResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20211001:RemediationAtResource", name, args ?? new RemediationAtResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20211001:RemediationAtResource", name, null, MakeResourceOptions(options, id))
        {
        }
