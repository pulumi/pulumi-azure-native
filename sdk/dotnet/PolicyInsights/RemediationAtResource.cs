...
namespace Pulumi.AzureNative.PolicyInsights
{
    ...
    public partial class RemediationAtResource : global::Pulumi.CustomResource
    {
        ...
        public RemediationAtResource(string name, RemediationAtResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights:RemediationAtResource", name, args ?? new RemediationAtResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights:RemediationAtResource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:policyinsights/v20241001:RemediationAtResource" },
                    new global::Pulumi.Alias { Type = "azure-native_policyinsights_v20180701preview:policyinsights:RemediationAtResource" },
                    new global::Pulumi.Alias { Type = "azure-native_policyinsights_v20190701:policyinsights:RemediationAtResource" },
                    new global::Pulumi.Alias { Type = "azure-native_policyinsights_v20211001:policyinsights:RemediationAtResource" },
                    new global::Pulumi.Alias { Type = "azure-native_policyinsights_v20241001:policyinsights:RemediationAtResource" },
                },
            };
