...
namespace Pulumi.AzureNextGen.PolicyInsights
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:policyinsights:RemediationAtResource")]
    public partial class RemediationAtResource : Pulumi.CustomResource
    {
        ...
        public RemediationAtResource(string name, RemediationAtResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:policyinsights:RemediationAtResource", name, args ?? new RemediationAtResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:policyinsights:RemediationAtResource", name, null, MakeResourceOptions(options, id))
        {
        }
