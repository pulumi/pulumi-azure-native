...
namespace Pulumi.AzureRM.PolicyInsights.Inputs
{
    ...
    /// </summary>
    public sealed class RemediationPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.RemediationDeploymentSummaryResponseArgs> DeploymentStatus { get; set; } = null!;

        /// <summary>
        /// The filters that will be applied to determine which resources to remediate.
        /// </summary>
        [Input("filters")]
        public Input<Inputs.RemediationFiltersResponseArgs>? Filters { get; set; }
        ...
        public RemediationPropertiesResponseArgs()
        {
        }
    }
}
