...
namespace Pulumi.AzureRM.PolicyInsights.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var remediationAtManagementGroup = new AzureRM.PolicyInsights.V20190701.RemediationAtManagementGroup("remediationAtManagementGroup", new AzureRM.PolicyInsights.V20190701.RemediationAtManagementGroupArgs
    ///         {
    ...
    public partial class RemediationAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public RemediationAtManagementGroup(string name, RemediationAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:policyinsights/v20190701:RemediationAtManagementGroup", name, args ?? new RemediationAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:policyinsights/v20190701:RemediationAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
