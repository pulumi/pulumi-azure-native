...
namespace Pulumi.AzureNative.PolicyInsights.V20190701
{
    public static class GetRemediationAtResource
    {
        ...
        public static Output<GetRemediationAtResourceResult> Invoke(GetRemediationAtResourceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRemediationAtResourceResult>("azure-native:policyinsights/v20190701:getRemediationAtResource", args ?? new GetRemediationAtResourceInvokeArgs(), options.WithVersion());
    }
