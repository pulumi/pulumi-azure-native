...
namespace Pulumi.AzureNative.PolicyInsights.V20190701
{
    ...
    /// {
    ///     var remediationAtSubscription = new AzureNative.PolicyInsights.V20190701.RemediationAtSubscription("remediationAtSubscription", new()
    ///     {
    ...
    ///     var remediationAtSubscription = new AzureNative.PolicyInsights.V20190701.RemediationAtSubscription("remediationAtSubscription", new()
    ///     {
    ///         Filters = new AzureNative.PolicyInsights.V20190701.Inputs.RemediationFiltersArgs
    ///         {
    ///             Locations = new[]
    ///             {
    ///                 "eastus",
