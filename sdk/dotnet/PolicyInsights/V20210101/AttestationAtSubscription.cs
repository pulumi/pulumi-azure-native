...
namespace Pulumi.AzureNextGen.PolicyInsights.V20210101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:policyinsights/v20210101:AttestationAtSubscription")]
    public partial class AttestationAtSubscription : Pulumi.CustomResource
    {
        ...
        public AttestationAtSubscription(string name, AttestationAtSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:policyinsights/v20210101:AttestationAtSubscription", name, args ?? new AttestationAtSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationAtSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:policyinsights/v20210101:AttestationAtSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
