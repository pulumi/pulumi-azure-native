...
namespace Pulumi.AzureNative.PolicyInsights.V20241001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:policyinsights/v20241001:AttestationAtSubscription")]
    public partial class AttestationAtSubscription : global::Pulumi.CustomResource
    {
        ...
        public AttestationAtSubscription(string name, AttestationAtSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20241001:AttestationAtSubscription", name, args ?? new AttestationAtSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationAtSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20241001:AttestationAtSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AttestationAtSubscription Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
