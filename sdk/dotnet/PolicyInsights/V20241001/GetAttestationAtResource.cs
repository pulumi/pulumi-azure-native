...
namespace Pulumi.AzureNative.PolicyInsights.V20241001
{
    public static class GetAttestationAtResource
    {
        ...
        public static Task<GetAttestationAtResourceResult> InvokeAsync(GetAttestationAtResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAttestationAtResourceResult>("azure-native:policyinsights/v20241001:getAttestationAtResource", args ?? new GetAttestationAtResourceArgs(), options.WithDefaults());
        ...
        public static Output<GetAttestationAtResourceResult> Invoke(GetAttestationAtResourceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAttestationAtResourceResult>("azure-native:policyinsights/v20241001:getAttestationAtResource", args ?? new GetAttestationAtResourceInvokeArgs(), options.WithDefaults());
