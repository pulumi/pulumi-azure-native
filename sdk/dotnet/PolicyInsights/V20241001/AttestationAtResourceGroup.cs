...
namespace Pulumi.AzureNative.PolicyInsights.V20241001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:policyinsights/v20241001:AttestationAtResourceGroup")]
    public partial class AttestationAtResourceGroup : global::Pulumi.CustomResource
    {
        ...
        public AttestationAtResourceGroup(string name, AttestationAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20241001:AttestationAtResourceGroup", name, args ?? new AttestationAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20241001:AttestationAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
