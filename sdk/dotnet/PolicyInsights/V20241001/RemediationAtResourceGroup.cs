...
namespace Pulumi.AzureNative.PolicyInsights.V20241001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:policyinsights/v20241001:RemediationAtResourceGroup")]
    public partial class RemediationAtResourceGroup : global::Pulumi.CustomResource
    {
        ...
        public RemediationAtResourceGroup(string name, RemediationAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20241001:RemediationAtResourceGroup", name, args ?? new RemediationAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20241001:RemediationAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RemediationAtResourceGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.PolicyInsights.V20241001.ResourceDiscoveryMode>? ResourceDiscoveryMode { get; set; }
