...
namespace Pulumi.AzureNative.PolicyInsights.V20241001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:policyinsights/v20241001:AttestationAtResource")]
    public partial class AttestationAtResource : global::Pulumi.CustomResource
    {
        ...
        public AttestationAtResource(string name, AttestationAtResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20241001:AttestationAtResource", name, args ?? new AttestationAtResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationAtResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20241001:AttestationAtResource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AttestationAtResourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.PolicyInsights.V20241001.ComplianceState>? ComplianceState { get; set; }
