...
namespace Pulumi.AzureNative.PolicyInsights.V20241001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:policyinsights/v20241001:RemediationAtResource")]
    public partial class RemediationAtResource : global::Pulumi.CustomResource
    {
        ...
        public RemediationAtResource(string name, RemediationAtResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20241001:RemediationAtResource", name, args ?? new RemediationAtResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20241001:RemediationAtResource", name, null, MakeResourceOptions(options, id))
        {
        }
