...
namespace Pulumi.AzureRM.PolicyInsights.Preview
{
    ...
    public partial class RemediationAtResourceGroup : Pulumi.CustomResource
    {
        ...
        public RemediationAtResourceGroup(string name, RemediationAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:policyinsights/preview:RemediationAtResourceGroup", name, args ?? new RemediationAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:policyinsights/preview:RemediationAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
