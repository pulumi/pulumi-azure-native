...
namespace Pulumi.AzureRM.PolicyInsights.Preview
{
    ...
    public partial class RemediationAtSubscription : Pulumi.CustomResource
    {
        ...
        public RemediationAtSubscription(string name, RemediationAtSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:policyinsights/preview:RemediationAtSubscription", name, args ?? new RemediationAtSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:policyinsights/preview:RemediationAtSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
