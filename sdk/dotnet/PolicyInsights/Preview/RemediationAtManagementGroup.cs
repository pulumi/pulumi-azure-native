...
namespace Pulumi.AzureRM.PolicyInsights.Preview
{
    ...
    public partial class RemediationAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public RemediationAtManagementGroup(string name, RemediationAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:policyinsights/preview:RemediationAtManagementGroup", name, args ?? new RemediationAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:policyinsights/preview:RemediationAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
