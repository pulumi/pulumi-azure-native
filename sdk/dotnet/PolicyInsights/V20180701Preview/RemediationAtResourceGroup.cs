...
namespace Pulumi.AzureRM.PolicyInsights.V20180701Preview
{
    ...
    public partial class RemediationAtResourceGroup : Pulumi.CustomResource
    {
        ...
        public RemediationAtResourceGroup(string name, RemediationAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:policyinsights/v20180701preview:RemediationAtResourceGroup", name, args ?? new RemediationAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:policyinsights/v20180701preview:RemediationAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
