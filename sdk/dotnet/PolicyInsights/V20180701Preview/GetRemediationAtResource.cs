...
namespace Pulumi.AzureNative.PolicyInsights.V20180701Preview
{
    ...
    public static class GetRemediationAtResource
    {
        ...
        public static Task<GetRemediationAtResourceResult> InvokeAsync(GetRemediationAtResourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRemediationAtResourceResult>("azure-native:policyinsights/v20180701preview:getRemediationAtResource", args ?? new GetRemediationAtResourceArgs(), options.WithDefaults());
        ...
        public static Output<GetRemediationAtResourceResult> Invoke(GetRemediationAtResourceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRemediationAtResourceResult>("azure-native:policyinsights/v20180701preview:getRemediationAtResource", args ?? new GetRemediationAtResourceInvokeArgs(), options.WithDefaults());
    }
