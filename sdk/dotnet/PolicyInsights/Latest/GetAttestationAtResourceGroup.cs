...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:policyinsights:getAttestationAtResourceGroup'.")]
    public static class GetAttestationAtResourceGroup
    {
        ...
        public static Task<GetAttestationAtResourceGroupResult> InvokeAsync(GetAttestationAtResourceGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAttestationAtResourceGroupResult>("azure-native:policyinsights/latest:getAttestationAtResourceGroup", args ?? new GetAttestationAtResourceGroupArgs(), options.WithVersion());
    }
