...
namespace Pulumi.AzureNative.PolicyInsights.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:policyinsights:AttestationAtResource'.")]
    [AzureNativeResourceType("azure-native:policyinsights/latest:AttestationAtResource")]
    public partial class AttestationAtResource : Pulumi.CustomResource
    {
        ...
        public AttestationAtResource(string name, AttestationAtResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/latest:AttestationAtResource", name, args ?? new AttestationAtResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationAtResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/latest:AttestationAtResource", name, null, MakeResourceOptions(options, id))
        {
        }
