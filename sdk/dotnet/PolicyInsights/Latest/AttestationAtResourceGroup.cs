...
namespace Pulumi.AzureNative.PolicyInsights.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:policyinsights:AttestationAtResourceGroup'.")]
    [AzureNativeResourceType("azure-native:policyinsights/latest:AttestationAtResourceGroup")]
    public partial class AttestationAtResourceGroup : Pulumi.CustomResource
    {
        ...
        public AttestationAtResourceGroup(string name, AttestationAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/latest:AttestationAtResourceGroup", name, args ?? new AttestationAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/latest:AttestationAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AttestationAtResourceGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.PolicyInsights.Latest.ComplianceState>? ComplianceState { get; set; }
