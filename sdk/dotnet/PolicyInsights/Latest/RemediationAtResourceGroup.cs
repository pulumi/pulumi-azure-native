...
namespace Pulumi.AzureRM.PolicyInsights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var remediationAtResourceGroup = new AzureRM.PolicyInsights.Latest.RemediationAtResourceGroup("remediationAtResourceGroup", new AzureRM.PolicyInsights.Latest.RemediationAtResourceGroupArgs
    ///         {
    ...
    public partial class RemediationAtResourceGroup : Pulumi.CustomResource
    {
        ...
        public RemediationAtResourceGroup(string name, RemediationAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:policyinsights/latest:RemediationAtResourceGroup", name, args ?? new RemediationAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemediationAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:policyinsights/latest:RemediationAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
