...
namespace Pulumi.AzureNative.PolicyInsights.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:policyinsights:AttestationAtSubscription'.")]
    [AzureNativeResourceType("azure-native:policyinsights/latest:AttestationAtSubscription")]
    public partial class AttestationAtSubscription : Pulumi.CustomResource
    {
        ...
        public AttestationAtSubscription(string name, AttestationAtSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/latest:AttestationAtSubscription", name, args ?? new AttestationAtSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationAtSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/latest:AttestationAtSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
