...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:policyinsights:getAttestationAtResource'.")]
    public static class GetAttestationAtResource
    {
        ...
        public static Task<GetAttestationAtResourceResult> InvokeAsync(GetAttestationAtResourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAttestationAtResourceResult>("azure-native:policyinsights/latest:getAttestationAtResource", args ?? new GetAttestationAtResourceArgs(), options.WithVersion());
    }
