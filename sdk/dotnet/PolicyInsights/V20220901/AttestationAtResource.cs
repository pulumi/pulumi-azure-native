...
namespace Pulumi.AzureNative.PolicyInsights.V20220901
{
    ...
    public partial class AttestationAtResource : global::Pulumi.CustomResource
    {
        ...
        public AttestationAtResource(string name, AttestationAtResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20220901:AttestationAtResource", name, args ?? new AttestationAtResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationAtResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20220901:AttestationAtResource", name, null, MakeResourceOptions(options, id))
        {
        }
