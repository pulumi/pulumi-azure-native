...
namespace Pulumi.AzureNative.PolicyInsights.V20220901
{
    /// <summary>
    ...
    /// {
    ///     var attestationAtResourceGroup = new AzureNative.PolicyInsights.V20220901.AttestationAtResourceGroup("attestationAtResourceGroup", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:policyinsights/v20220901:AttestationAtResourceGroup 790996e6-9871-4b1f-9cd9-ec42cd6ced1e /subscriptions/35ee058e-5fa0-414c-8145-3ebb8d09b6e2/resourcegroups/myrg/providers/microsoft.policyinsights/attestations/790996e6-9871-4b1f-9cd9-ec42cd6ced1e 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:policyinsights/v20220901:AttestationAtResourceGroup")]
    public partial class AttestationAtResourceGroup : global::Pulumi.CustomResource
    {
        ...
        public AttestationAtResourceGroup(string name, AttestationAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20220901:AttestationAtResourceGroup", name, args ?? new AttestationAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20220901:AttestationAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:policyinsights:AttestationAtResourceGroup"},
                    new global::Pulumi.Alias { Type = "azure-native:policyinsights/v20210101:AttestationAtResourceGroup"},
                },
            };
    ...
    public sealed class AttestationAtResourceGroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The time the evidence was assessed
        /// </summary>
        ...
        public InputUnion<string, Pulumi.AzureNative.PolicyInsights.V20220901.ComplianceState>? ComplianceState { get; set; }
        ...
        public static new AttestationAtResourceGroupArgs Empty => new AttestationAtResourceGroupArgs();
    }
}
