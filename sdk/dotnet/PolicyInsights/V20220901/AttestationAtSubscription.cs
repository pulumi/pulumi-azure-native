...
namespace Pulumi.AzureNative.PolicyInsights.V20220901
{
    ...
    /// {
    ///     var attestationAtSubscription = new AzureNative.PolicyInsights.V20220901.AttestationAtSubscription("attestationAtSubscription", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:policyinsights/v20220901:AttestationAtSubscription")]
    public partial class AttestationAtSubscription : global::Pulumi.CustomResource
    {
        ...
        public AttestationAtSubscription(string name, AttestationAtSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20220901:AttestationAtSubscription", name, args ?? new AttestationAtSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationAtSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:policyinsights/v20220901:AttestationAtSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
