...
namespace Pulumi.AzureRM.MachineLearning.Inputs
{
    ...
    /// </summary>
    public sealed class WebServicePropertiesResponseGetArgs : Pulumi.ResourceArgs
    {
        [Input("assets")]
        ...
        public Input<Inputs.CommitmentPlanResponseGetArgs>? CommitmentPlan { get; set; }
        ...
        /// </summary>
        [Input("diagnostics")]
        public Input<Inputs.DiagnosticsConfigurationResponseGetArgs>? Diagnostics { get; set; }

        /// <summary>
        /// Defines sample input data for one or more of the service's inputs.
        /// </summary>
        [Input("exampleRequest")]
        public Input<Inputs.ExampleRequestResponseGetArgs>? ExampleRequest { get; set; }
        ...
        /// </summary>
        [Input("input")]
        public Input<Inputs.ServiceInputOutputSpecificationResponseGetArgs>? Input { get; set; }
        ...
        /// </summary>
        [Input("keys")]
        public Input<Inputs.WebServiceKeysResponseGetArgs>? Keys { get; set; }
        ...
        public Input<Inputs.MachineLearningWorkspaceResponseGetArgs>? MachineLearningWorkspace { get; set; }
        ...
        /// </summary>
        [Input("output")]
        public Input<Inputs.ServiceInputOutputSpecificationResponseGetArgs>? Output { get; set; }
        ...
        public Input<Inputs.BlobLocationResponseGetArgs>? PayloadsLocation { get; set; }
        ...
        public Input<Inputs.RealtimeConfigurationResponseGetArgs>? RealtimeConfiguration { get; set; }
        ...
        public Input<Inputs.StorageAccountResponseGetArgs>? StorageAccount { get; set; }
        ...
        public WebServicePropertiesResponseGetArgs()
        {
        }
    }
}
