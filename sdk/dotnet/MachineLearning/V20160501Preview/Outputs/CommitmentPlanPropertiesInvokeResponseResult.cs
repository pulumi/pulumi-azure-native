...
namespace Pulumi.AzureNextGen.MachineLearning.V20160501Preview.Outputs
{
    ...
    [OutputType]
    public sealed class CommitmentPlanPropertiesInvokeResponseResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableDictionary<string, Outputs.PlanQuantityInvokeResponseResult> IncludedQuantities;
        /// <summary>
        ...
        [OutputConstructor]
        private CommitmentPlanPropertiesInvokeResponseResult(
            ...
            ImmutableDictionary<string, Outputs.PlanQuantityInvokeResponseResult> includedQuantities,
