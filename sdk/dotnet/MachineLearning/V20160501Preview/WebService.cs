...
namespace Pulumi.AzureNative.MachineLearning.V20160501Preview
{
    ...
    public partial class WebService : global::Pulumi.CustomResource
    {
        ...
        public WebService(string name, WebServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearning/v20160501preview:WebService", name, args ?? new WebServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearning/v20160501preview:WebService", name, null, MakeResourceOptions(options, id))
        {
        }
