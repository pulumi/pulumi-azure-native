...
namespace Pulumi.AzureNextGen.MachineLearning.V20170101.Inputs
{
    ...
    public sealed class ColumnSpecificationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNextGen.MachineLearning.V20170101.ColumnFormat>? Format { get; set; }

        /// <summary>
        /// Data type of the column.
        /// </summary>
        [Input("type", required: true)]
        public InputUnion<string, Pulumi.AzureNextGen.MachineLearning.V20170101.ColumnType> Type { get; set; } = null!;
