...
namespace Pulumi.AzureRM.MachineLearning.Preview
{
    ...
    public partial class CommitmentPlan : Pulumi.CustomResource
    {
        ...
        public CommitmentPlan(string name, CommitmentPlanArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearning/preview:CommitmentPlan", name, args ?? new CommitmentPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommitmentPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearning/preview:CommitmentPlan", name, null, MakeResourceOptions(options, id))
        {
        }
