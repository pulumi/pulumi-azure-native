...
namespace Pulumi.AzureRM.MachineLearning.Preview
{
    ...
    public partial class WebService : Pulumi.CustomResource
    {
        ...
        public WebService(string name, WebServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearning/preview:WebService", name, args ?? new WebServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearning/preview:WebService", name, null, MakeResourceOptions(options, id))
        {
        }
