...
namespace Pulumi.AzureRM.MachineLearning.Latest
{
    public static class GetCommitmentPlan
    {
        public static Task<GetCommitmentPlanResult> InvokeAsync(GetCommitmentPlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCommitmentPlanResult>("azurerm:machinelearning/latest:getCommitmentPlan", args ?? new GetCommitmentPlanArgs(), options.WithVersion());
    }
