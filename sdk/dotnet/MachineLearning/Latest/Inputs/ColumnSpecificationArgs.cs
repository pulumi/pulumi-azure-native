...
namespace Pulumi.AzureNative.MachineLearning.Latest.Inputs
{
    ...
    public sealed class ColumnSpecificationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearning.Latest.ColumnFormat>? Format { get; set; }

        /// <summary>
        /// Data type of the column.
        /// </summary>
        [Input("type", required: true)]
        public InputUnion<string, Pulumi.AzureNative.MachineLearning.Latest.ColumnType> Type { get; set; } = null!;
