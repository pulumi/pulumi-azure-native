...
namespace Pulumi.AzureNative.MachineLearning.V20160401
{
    /// <summary>
    /// An object that represents a machine learning workspace.
    /// </summary>
    [Obsolete(@"azure-native:machinelearning/v20160401:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearning/v20191001:Workspace to guarantee forwards compatibility.")]
    ...
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearning/v20160401:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearning/v20160401:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
