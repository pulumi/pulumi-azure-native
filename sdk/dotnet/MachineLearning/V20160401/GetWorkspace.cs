...
namespace Pulumi.AzureRM.MachineLearning.V20160401
{
    public static class GetWorkspace
    {
        public static Task<GetWorkspaceResult> InvokeAsync(GetWorkspaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceResult>("azurerm:machinelearning/v20160401:getWorkspace", args ?? new GetWorkspaceArgs(), options.WithVersion());
    }
