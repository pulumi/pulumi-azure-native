...
namespace Pulumi.AzureRM.StorSimple
{
    ...
    public partial class ManagerDeviceFileserverShare : Pulumi.CustomResource
    {
        ...
        private ManagerDeviceFileserverShare(string name, Input<string> id, ManagerDeviceFileserverShareState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:storsimple:ManagerDeviceFileserverShare", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ManagerDeviceFileserverShare Get(string name, Input<string> id, ManagerDeviceFileserverShareState? state = null, CustomResourceOptions? options = null)
        {
            return new ManagerDeviceFileserverShare(name, id, state, options);
        }
    }
    ...
    public sealed class ManagerDeviceFileserverShareState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name.
        /// </summary>
        ...
        /// </summary>
        [Input("properties", required: true)]
        public Input<Inputs.FileSharePropertiesResponseGetArgs> Properties { get; set; } = null!;
        ...
        public ManagerDeviceFileserverShareState()
        {
        }
    }
}
