...
namespace Pulumi.AzureNative.StorSimple
{
    public static class ListDeviceFailoverTars
    {
        ...
        public static Task<ListDeviceFailoverTarsResult> InvokeAsync(ListDeviceFailoverTarsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListDeviceFailoverTarsResult>("azure-native:storsimple:listDeviceFailoverTars", args ?? new ListDeviceFailoverTarsArgs(), options.WithVersion());
        ...
        public static Output<ListDeviceFailoverTarsResult> Invoke(ListDeviceFailoverTarsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListDeviceFailoverTarsResult>("azure-native:storsimple:listDeviceFailoverTars", args ?? new ListDeviceFailoverTarsInvokeArgs(), options.WithVersion());
    }
