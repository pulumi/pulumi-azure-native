...
namespace Pulumi.AzureRM.StorSimple
{
    public static class ListDeviceFailoverTars
    {
        public static Task<ListDeviceFailoverTarsResult> InvokeAsync(ListDeviceFailoverTarsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListDeviceFailoverTarsResult>("azurerm:storsimple:listDeviceFailoverTars", args ?? new ListDeviceFailoverTarsArgs(), options.WithVersion());
    }
