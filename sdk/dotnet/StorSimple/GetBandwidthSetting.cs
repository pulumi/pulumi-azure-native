...
namespace Pulumi.AzureRM.StorSimple
{
    public static class GetBandwidthSetting
    {
        public static Task<GetBandwidthSettingResult> InvokeAsync(GetBandwidthSettingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBandwidthSettingResult>("azurerm:storsimple:getBandwidthSetting", args ?? new GetBandwidthSettingArgs(), options.WithVersion());
    }
