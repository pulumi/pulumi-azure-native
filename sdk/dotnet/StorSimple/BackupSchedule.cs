...
namespace Pulumi.AzureNextGen.StorSimple
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storsimple:BackupSchedule")]
    public partial class BackupSchedule : Pulumi.CustomResource
    {
        ...
        public BackupSchedule(string name, BackupScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storsimple:BackupSchedule", name, args ?? new BackupScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storsimple:BackupSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BackupScheduleArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.StorSimple.BackupType> BackupType { get; set; } = null!;
        ...
        public Input<Pulumi.AzureNextGen.StorSimple.ScheduleStatus> ScheduleStatus { get; set; } = null!;
