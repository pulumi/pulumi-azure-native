...
namespace Pulumi.AzureNative.StorSimple
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storsimple:BackupSchedule")]
    public partial class BackupSchedule : global::Pulumi.CustomResource
    {
        ...
        public BackupSchedule(string name, BackupScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storsimple:BackupSchedule", name, args ?? new BackupScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storsimple:BackupSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:storsimple/v20170601:BackupSchedule" },
                    new global::Pulumi.Alias { Type = "azure-native_storsimple_v20170601:storsimple:BackupSchedule" },
                },
            };
