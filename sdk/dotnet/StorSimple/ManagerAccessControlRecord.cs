...
namespace Pulumi.AzureRM.StorSimple
{
    ...
    /// </summary>
    public partial class ManagerAccessControlRecord : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ManagerAccessControlRecord(string name, ManagerAccessControlRecordArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple:ManagerAccessControlRecord", name, args ?? new ManagerAccessControlRecordArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class ManagerAccessControlRecordArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Kind of the object. Currently only Series8000 is supported
        /// </summary>
