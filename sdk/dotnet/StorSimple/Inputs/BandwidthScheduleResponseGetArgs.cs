...
namespace Pulumi.AzureRM.StorSimple.Inputs
{
    ...
    /// </summary>
    public sealed class BandwidthScheduleResponseGetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.TimeResponseGetArgs> Start { get; set; } = null!;

        /// <summary>
        /// The stop time of the schedule.
        /// </summary>
        [Input("stop", required: true)]
        public Input<Inputs.TimeResponseGetArgs> Stop { get; set; } = null!;

        public BandwidthScheduleResponseGetArgs()
        {
        }
    }
}
