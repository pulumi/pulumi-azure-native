...
namespace Pulumi.AzureRM.StorSimple.Inputs
{
    ...
    /// </summary>
    public sealed class BandwidthScheduleResponseArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.TimeResponseArgs> Start { get; set; } = null!;

        /// <summary>
        /// The stop time of the schedule.
        /// </summary>
        [Input("stop", required: true)]
        public Input<Inputs.TimeResponseArgs> Stop { get; set; } = null!;

        public BandwidthScheduleResponseArgs()
        {
        }
    }
}
