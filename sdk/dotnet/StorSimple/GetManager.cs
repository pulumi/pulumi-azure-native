...
namespace Pulumi.AzureNative.StorSimple
{
    public static class GetManager
    {
        ...
        public static Output<GetManagerResult> Invoke(GetManagerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagerResult>("azure-native:storsimple:getManager", args ?? new GetManagerInvokeArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the properties of the specified manager name.
        /// Azure REST API version: 2017-06-01.
        /// </summary>
        public static Output<GetManagerResult> Invoke(GetManagerInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagerResult>("azure-native:storsimple:getManager", args ?? new GetManagerInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetManagerArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The manager name
        /// </summary>
        ...
        public static new GetManagerArgs Empty => new GetManagerArgs();
    }

    public sealed class GetManagerInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The manager name
        /// </summary>
        ...
        public static new GetManagerInvokeArgs Empty => new GetManagerInvokeArgs();
    }
