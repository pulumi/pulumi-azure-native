...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getBackupSchedule'.")]
    public static class GetBackupSchedule
    {
        ...
        public static Task<GetBackupScheduleResult> InvokeAsync(GetBackupScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackupScheduleResult>("azure-native:storsimple/latest:getBackupSchedule", args ?? new GetBackupScheduleArgs(), options.WithVersion());
    }
