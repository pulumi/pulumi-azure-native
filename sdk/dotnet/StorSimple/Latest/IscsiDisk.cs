...
namespace Pulumi.AzureNative.StorSimple.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storsimple:IscsiDisk'.")]
    [AzureNativeResourceType("azure-native:storsimple/latest:IscsiDisk")]
    public partial class IscsiDisk : Pulumi.CustomResource
    {
        ...
        public IscsiDisk(string name, IscsiDiskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storsimple/latest:IscsiDisk", name, args ?? new IscsiDiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IscsiDisk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storsimple/latest:IscsiDisk", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:storsimple/v20161001:IscsiDisk"},
    ...
    public sealed class IscsiDiskArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.StorSimple.Latest.DiskStatus> DiskStatus { get; set; } = null!;
