...
namespace Pulumi.AzureNative.StorSimple.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storsimple:ManagerExtendedInfo'.")]
    [AzureNativeResourceType("azure-native:storsimple/latest:ManagerExtendedInfo")]
    public partial class ManagerExtendedInfo : Pulumi.CustomResource
    {
        ...
        public ManagerExtendedInfo(string name, ManagerExtendedInfoArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storsimple/latest:ManagerExtendedInfo", name, args ?? new ManagerExtendedInfoArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagerExtendedInfo(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storsimple/latest:ManagerExtendedInfo", name, null, MakeResourceOptions(options, id))
        {
        }
