...
namespace Pulumi.AzureNative.StorSimple.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storsimple:StorageDomain'.")]
    [AzureNativeResourceType("azure-native:storsimple/latest:StorageDomain")]
    public partial class StorageDomain : Pulumi.CustomResource
    {
        ...
        public StorageDomain(string name, StorageDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storsimple/latest:StorageDomain", name, args ?? new StorageDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storsimple/latest:StorageDomain", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageDomainArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.StorSimple.Latest.EncryptionStatus> EncryptionStatus { get; set; } = null!;
