...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    public static class GetBackupSchedule
    {
        public static Task<GetBackupScheduleResult> InvokeAsync(GetBackupScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackupScheduleResult>("azurerm:storsimple/preview:getBackupSchedule", args ?? new GetBackupScheduleArgs(), options.WithVersion());
    }
