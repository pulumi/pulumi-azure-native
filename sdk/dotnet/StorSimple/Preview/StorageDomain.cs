...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    ...
    public partial class StorageDomain : Pulumi.CustomResource
    {
        ...
        public StorageDomain(string name, StorageDomainArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:StorageDomain", name, args ?? new StorageDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:StorageDomain", name, null, MakeResourceOptions(options, id))
        {
        }
