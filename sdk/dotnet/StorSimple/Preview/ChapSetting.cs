...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    ...
    public partial class ChapSetting : Pulumi.CustomResource
    {
        ...
        public ChapSetting(string name, ChapSettingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:ChapSetting", name, args ?? new ChapSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ChapSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:ChapSetting", name, null, MakeResourceOptions(options, id))
        {
        }
