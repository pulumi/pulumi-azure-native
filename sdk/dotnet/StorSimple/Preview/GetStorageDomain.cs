...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    public static class GetStorageDomain
    {
        public static Task<GetStorageDomainResult> InvokeAsync(GetStorageDomainArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageDomainResult>("azurerm:storsimple/preview:getStorageDomain", args ?? new GetStorageDomainArgs(), options.WithVersion());
    }
