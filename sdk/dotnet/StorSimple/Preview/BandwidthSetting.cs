...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    ...
    public partial class BandwidthSetting : Pulumi.CustomResource
    {
        ...
        public BandwidthSetting(string name, BandwidthSettingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:BandwidthSetting", name, args ?? new BandwidthSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BandwidthSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:BandwidthSetting", name, null, MakeResourceOptions(options, id))
        {
        }
