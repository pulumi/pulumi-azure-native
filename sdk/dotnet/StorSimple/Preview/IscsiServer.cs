...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    ...
    public partial class IscsiServer : Pulumi.CustomResource
    {
        ...
        public IscsiServer(string name, IscsiServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:IscsiServer", name, args ?? new IscsiServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IscsiServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:IscsiServer", name, null, MakeResourceOptions(options, id))
        {
        }
