...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    public static class ListDeviceFailoverSets
    {
        public static Task<ListDeviceFailoverSetsResult> InvokeAsync(ListDeviceFailoverSetsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListDeviceFailoverSetsResult>("azurerm:storsimple/preview:listDeviceFailoverSets", args ?? new ListDeviceFailoverSetsArgs(), options.WithVersion());
    }
