...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    ...
    public partial class BackupScheduleGroup : Pulumi.CustomResource
    {
        ...
        public BackupScheduleGroup(string name, BackupScheduleGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:BackupScheduleGroup", name, args ?? new BackupScheduleGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupScheduleGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:BackupScheduleGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:storsimple/latest:BackupScheduleGroup"},
