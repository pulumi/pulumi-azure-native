...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    ...
    public partial class BackupSchedule : Pulumi.CustomResource
    {
        ...
        public BackupSchedule(string name, BackupScheduleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:BackupSchedule", name, args ?? new BackupScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:BackupSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
