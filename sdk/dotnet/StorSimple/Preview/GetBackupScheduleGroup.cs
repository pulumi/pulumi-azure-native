...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    public static class GetBackupScheduleGroup
    {
        public static Task<GetBackupScheduleGroupResult> InvokeAsync(GetBackupScheduleGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackupScheduleGroupResult>("azurerm:storsimple/preview:getBackupScheduleGroup", args ?? new GetBackupScheduleGroupArgs(), options.WithVersion());
    }
