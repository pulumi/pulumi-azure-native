...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    ...
    public partial class IscsiDisk : Pulumi.CustomResource
    {
        ...
        public IscsiDisk(string name, IscsiDiskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:IscsiDisk", name, args ?? new IscsiDiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IscsiDisk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:IscsiDisk", name, null, MakeResourceOptions(options, id))
        {
        }
