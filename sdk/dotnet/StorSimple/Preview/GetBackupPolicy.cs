...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    public static class GetBackupPolicy
    {
        public static Task<GetBackupPolicyResult> InvokeAsync(GetBackupPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackupPolicyResult>("azurerm:storsimple/preview:getBackupPolicy", args ?? new GetBackupPolicyArgs(), options.WithVersion());
    }
