...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    ...
    public partial class VolumeContainer : Pulumi.CustomResource
    {
        ...
        public VolumeContainer(string name, VolumeContainerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:VolumeContainer", name, args ?? new VolumeContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/preview:VolumeContainer", name, null, MakeResourceOptions(options, id))
        {
        }
