...
namespace Pulumi.AzureRM.StorSimple.Preview
{
    public static class GetVolumeContainer
    {
        public static Task<GetVolumeContainerResult> InvokeAsync(GetVolumeContainerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVolumeContainerResult>("azurerm:storsimple/preview:getVolumeContainer", args ?? new GetVolumeContainerArgs(), options.WithVersion());
    }
