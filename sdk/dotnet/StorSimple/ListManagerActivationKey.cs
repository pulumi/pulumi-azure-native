...
namespace Pulumi.AzureRM.StorSimple
{
    public static class ListManagerActivationKey
    {
        public static Task<ListManagerActivationKeyResult> InvokeAsync(ListManagerActivationKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListManagerActivationKeyResult>("azurerm:storsimple:listManagerActivationKey", args ?? new ListManagerActivationKeyArgs(), options.WithVersion());
    }
