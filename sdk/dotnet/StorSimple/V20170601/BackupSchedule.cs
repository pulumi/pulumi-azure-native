...
namespace Pulumi.AzureRM.StorSimple.V20170601
{
    ...
    public partial class BackupSchedule : Pulumi.CustomResource
    {
        ...
        public BackupSchedule(string name, BackupScheduleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/v20170601:BackupSchedule", name, args ?? new BackupScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/v20170601:BackupSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
