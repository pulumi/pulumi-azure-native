...
namespace Pulumi.AzureRM.StorSimple.V20170601
{
    public static class ListManagerActivationKey
    {
        public static Task<ListManagerActivationKeyResult> InvokeAsync(ListManagerActivationKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListManagerActivationKeyResult>("azurerm:storsimple/v20170601:listManagerActivationKey", args ?? new ListManagerActivationKeyArgs(), options.WithVersion());
    }
