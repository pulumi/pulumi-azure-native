...
namespace Pulumi.AzureNative.StorSimple.V20170601
{
    ...
    /// {
    ///     var bandwidthSetting = new AzureNative.StorSimple.V20170601.BandwidthSetting("bandwidthSetting", new()
    ///     {
    ...
    ///         Schedules = new[]
    ///         {
    ///             new AzureNative.StorSimple.V20170601.Inputs.BandwidthScheduleArgs
    ///             {
    ///                 Days = new[]
    ///                 {
    ///                     AzureNative.StorSimple.V20170601.DayOfWeek.Saturday,
    ///                     AzureNative.StorSimple.V20170601.DayOfWeek.Sunday,
    ///                 },
    ///                 RateInMbps = 10,
    ///                 Start = new AzureNative.StorSimple.V20170601.Inputs.TimeArgs
    ///                 {
    ///                     Hours = 10,
    ///                     Minutes = 0,
    ///                     Seconds = 0,
    ///                 },
    ///                 Stop = new AzureNative.StorSimple.V20170601.Inputs.TimeArgs
    ///                 {
    ///                     Hours = 20,
    ///                     Minutes = 0,
    ///                     Seconds = 0,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storsimple/v20170601:BandwidthSetting")]
    public partial class BandwidthSetting : global::Pulumi.CustomResource
    {
        ...
        public BandwidthSetting(string name, BandwidthSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storsimple/v20170601:BandwidthSetting", name, args ?? new BandwidthSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BandwidthSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storsimple/v20170601:BandwidthSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:storsimple:BandwidthSetting"},
                },
            };
