...
namespace Pulumi.AzureRM.StorSimple.V20170601
{
    ...
    public partial class AccessControlRecord : Pulumi.CustomResource
    {
        ...
        public AccessControlRecord(string name, AccessControlRecordArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/v20170601:AccessControlRecord", name, args ?? new AccessControlRecordArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessControlRecord(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/v20170601:AccessControlRecord", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:storsimple/v20161001:AccessControlRecord"},
                },
            };
