...
namespace Pulumi.AzureNative.StorSimple.V20170601
{
    ...
    /// {
    ///     var accessControlRecord = new AzureNative.StorSimple.V20170601.AccessControlRecord("accessControlRecord", new()
    ///     {
    ...
    public partial class AccessControlRecord : global::Pulumi.CustomResource
    {
        ...
        public AccessControlRecord(string name, AccessControlRecordArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storsimple/v20170601:AccessControlRecord", name, args ?? new AccessControlRecordArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessControlRecord(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storsimple/v20170601:AccessControlRecord", name, null, MakeResourceOptions(options, id))
        {
        }
