...
namespace Pulumi.AzureRM.StorSimple.V20161001
{
    ...
    public partial class IscsiDisk : Pulumi.CustomResource
    {
        ...
        public IscsiDisk(string name, IscsiDiskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/v20161001:IscsiDisk", name, args ?? new IscsiDiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IscsiDisk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/v20161001:IscsiDisk", name, null, MakeResourceOptions(options, id))
        {
        }
