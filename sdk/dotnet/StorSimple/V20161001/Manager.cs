...
namespace Pulumi.AzureRM.StorSimple.V20161001
{
    ...
    public partial class Manager : Pulumi.CustomResource
    {
        ...
        public Manager(string name, ManagerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/v20161001:Manager", name, args ?? new ManagerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Manager(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storsimple/v20161001:Manager", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:storsimple/preview:Manager"},
                    new Pulumi.Alias { Type = "azurerm:storsimple/v20170601:Manager"},
                },
            };
