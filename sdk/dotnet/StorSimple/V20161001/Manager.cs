...
namespace Pulumi.AzureNextGen.StorSimple.V20161001
{
    ...
    public partial class Manager : Pulumi.CustomResource
    {
        ...
        public Manager(string name, ManagerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storsimple/v20161001:Manager", name, args ?? new ManagerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Manager(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storsimple/v20161001:Manager", name, null, MakeResourceOptions(options, id))
        {
        }
