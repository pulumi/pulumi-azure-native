...
namespace Pulumi.AzureNative.StorSimple.V20161001
{
    ...
    public partial class ManagerExtendedInfo : global::Pulumi.CustomResource
    {
        ...
        public ManagerExtendedInfo(string name, ManagerExtendedInfoArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storsimple/v20161001:ManagerExtendedInfo", name, args ?? new ManagerExtendedInfoArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagerExtendedInfo(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storsimple/v20161001:ManagerExtendedInfo", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagerExtendedInfoArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ManagerExtendedInfoPropertiesArgs> Properties { get; set; } = null!;
