...
namespace Pulumi.AzureRM.StorSimple
{
    ...
    public partial class ManagerDeviceBackupPolicy : Pulumi.CustomResource
    {
        ...
        private ManagerDeviceBackupPolicy(string name, Input<string> id, ManagerDeviceBackupPolicyState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:storsimple:ManagerDeviceBackupPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ManagerDeviceBackupPolicy Get(string name, Input<string> id, ManagerDeviceBackupPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new ManagerDeviceBackupPolicy(name, id, state, options);
        }
    }
    ...
    public sealed class ManagerDeviceBackupPolicyState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Kind of the object. Currently only Series8000 is supported
        /// </summary>
        ...
        /// </summary>
        [Input("properties", required: true)]
        public Input<Inputs.BackupPolicyPropertiesResponseGetArgs> Properties { get; set; } = null!;
        ...
        public ManagerDeviceBackupPolicyState()
        {
        }
    }
}
