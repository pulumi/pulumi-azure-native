...
namespace Pulumi.AzureNative.ServiceNetworking.V20250301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicenetworking/v20250301preview:TrafficControllerInterface")]
    public partial class TrafficControllerInterface : global::Pulumi.CustomResource
    {
        ...
        public TrafficControllerInterface(string name, TrafficControllerInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicenetworking/v20250301preview:TrafficControllerInterface", name, args ?? new TrafficControllerInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TrafficControllerInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicenetworking/v20250301preview:TrafficControllerInterface", name, null, MakeResourceOptions(options, id))
        {
        }
