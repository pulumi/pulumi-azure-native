...
namespace Pulumi.AzureNative.ServiceNetworking.V20250301Preview
{
    public static class GetSecurityPoliciesInterface
    {
        ...
        public static Task<GetSecurityPoliciesInterfaceResult> InvokeAsync(GetSecurityPoliciesInterfaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSecurityPoliciesInterfaceResult>("azure-native:servicenetworking/v20250301preview:getSecurityPoliciesInterface", args ?? new GetSecurityPoliciesInterfaceArgs(), options.WithDefaults());
        ...
        public static Output<GetSecurityPoliciesInterfaceResult> Invoke(GetSecurityPoliciesInterfaceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSecurityPoliciesInterfaceResult>("azure-native:servicenetworking/v20250301preview:getSecurityPoliciesInterface", args ?? new GetSecurityPoliciesInterfaceInvokeArgs(), options.WithDefaults());
    ...
    public sealed class GetSecurityPoliciesInterfaceResult
    {
        ...
        /// </summary>
        public readonly Outputs.IpAccessRulesPolicyResponse? IpAccessRulesPolicy;
        /// <summary>
        ...
        private GetSecurityPoliciesInterfaceResult(
            ...
            Outputs.IpAccessRulesPolicyResponse? ipAccessRulesPolicy,
