...
namespace Pulumi.AzureNative.ServiceNetworking.V20250301Preview
{
    public static class GetFrontendsInterface
    {
        ...
        public static Task<GetFrontendsInterfaceResult> InvokeAsync(GetFrontendsInterfaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFrontendsInterfaceResult>("azure-native:servicenetworking/v20250301preview:getFrontendsInterface", args ?? new GetFrontendsInterfaceArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Frontend
        /// </summary>
        public static Output<GetFrontendsInterfaceResult> Invoke(GetFrontendsInterfaceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFrontendsInterfaceResult>("azure-native:servicenetworking/v20250301preview:getFrontendsInterface", args ?? new GetFrontendsInterfaceInvokeArgs(), options.WithDefaults());
