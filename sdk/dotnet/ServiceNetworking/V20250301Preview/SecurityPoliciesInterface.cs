...
namespace Pulumi.AzureNative.ServiceNetworking.V20250301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicenetworking/v20250301preview:SecurityPoliciesInterface")]
    public partial class SecurityPoliciesInterface : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("ipAccessRulesPolicy")]
        public Output<Outputs.IpAccessRulesPolicyResponse?> IpAccessRulesPolicy { get; private set; } = null!;
        ...
        public SecurityPoliciesInterface(string name, SecurityPoliciesInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicenetworking/v20250301preview:SecurityPoliciesInterface", name, args ?? new SecurityPoliciesInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityPoliciesInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicenetworking/v20250301preview:SecurityPoliciesInterface", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SecurityPoliciesInterface Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new SecurityPoliciesInterface(name, id, options);
        }
    }

    public sealed class SecurityPoliciesInterfaceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Ip Access Policy of the Traffic Controller Security Policy. Single Security Policy can have only one policy type set.
        /// </summary>
        [Input("ipAccessRulesPolicy")]
        public Input<Inputs.IpAccessRulesPolicyArgs>? IpAccessRulesPolicy { get; set; }
        ...
        public SecurityPoliciesInterfaceArgs()
        {
        }
        public static new SecurityPoliciesInterfaceArgs Empty => new SecurityPoliciesInterfaceArgs();
    }
}
