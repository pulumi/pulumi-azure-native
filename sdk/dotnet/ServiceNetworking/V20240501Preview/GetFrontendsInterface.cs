...
namespace Pulumi.AzureNative.ServiceNetworking.V20240501Preview
{
    public static class GetFrontendsInterface
    {
        ...
        public static Task<GetFrontendsInterfaceResult> InvokeAsync(GetFrontendsInterfaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFrontendsInterfaceResult>("azure-native:servicenetworking/v20240501preview:getFrontendsInterface", args ?? new GetFrontendsInterfaceArgs(), options.WithDefaults());
