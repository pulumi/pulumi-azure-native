...
namespace Pulumi.AzureNative.ServiceNetworking.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicenetworking/v20240501preview:FrontendsInterface")]
    public partial class FrontendsInterface : global::Pulumi.CustomResource
    {
        ...
        public FrontendsInterface(string name, FrontendsInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicenetworking/v20240501preview:FrontendsInterface", name, args ?? new FrontendsInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FrontendsInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicenetworking/v20240501preview:FrontendsInterface", name, null, MakeResourceOptions(options, id))
        {
        }
