...
namespace Pulumi.AzureNative.ServiceNetworking.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicenetworking/v20250101:FrontendsInterface")]
    public partial class FrontendsInterface : global::Pulumi.CustomResource
    {
        ...
        public FrontendsInterface(string name, FrontendsInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicenetworking/v20250101:FrontendsInterface", name, args ?? new FrontendsInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FrontendsInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicenetworking/v20250101:FrontendsInterface", name, null, MakeResourceOptions(options, id))
        {
        }
