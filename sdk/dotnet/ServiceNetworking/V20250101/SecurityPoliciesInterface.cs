...
namespace Pulumi.AzureNative.ServiceNetworking.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicenetworking/v20250101:SecurityPoliciesInterface")]
    public partial class SecurityPoliciesInterface : global::Pulumi.CustomResource
    {
        ...
        public SecurityPoliciesInterface(string name, SecurityPoliciesInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicenetworking/v20250101:SecurityPoliciesInterface", name, args ?? new SecurityPoliciesInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityPoliciesInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicenetworking/v20250101:SecurityPoliciesInterface", name, null, MakeResourceOptions(options, id))
        {
        }
