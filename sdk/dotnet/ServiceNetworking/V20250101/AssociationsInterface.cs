...
namespace Pulumi.AzureNative.ServiceNetworking.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicenetworking/v20250101:AssociationsInterface")]
    public partial class AssociationsInterface : global::Pulumi.CustomResource
    {
        ...
        public AssociationsInterface(string name, AssociationsInterfaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicenetworking/v20250101:AssociationsInterface", name, args ?? new AssociationsInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssociationsInterface(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicenetworking/v20250101:AssociationsInterface", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AssociationsInterfaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceNetworking.V20250101.AssociationType> AssociationType { get; set; } = null!;
