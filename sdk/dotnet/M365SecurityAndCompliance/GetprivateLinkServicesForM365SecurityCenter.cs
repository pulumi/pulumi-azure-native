...
namespace Pulumi.AzureNative.M365SecurityAndCompliance
{
    public static class GetprivateLinkServicesForM365SecurityCenter
    {
        ...
        public static Task<GetprivateLinkServicesForM365SecurityCenterResult> InvokeAsync(GetprivateLinkServicesForM365SecurityCenterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetprivateLinkServicesForM365SecurityCenterResult>("azure-native:m365securityandcompliance:getprivateLinkServicesForM365SecurityCenter", args ?? new GetprivateLinkServicesForM365SecurityCenterArgs(), options.WithDefaults());
        ...
        public static Output<GetprivateLinkServicesForM365SecurityCenterResult> Invoke(GetprivateLinkServicesForM365SecurityCenterInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetprivateLinkServicesForM365SecurityCenterResult>("azure-native:m365securityandcompliance:getprivateLinkServicesForM365SecurityCenter", args ?? new GetprivateLinkServicesForM365SecurityCenterInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetprivateLinkServicesForM365SecurityCenterArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    public sealed class GetprivateLinkServicesForM365SecurityCenterInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// The name of the resource group that contains the service instance.
        /// </summary>
