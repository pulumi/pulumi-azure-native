...
namespace Pulumi.AzureNative.M365SecurityAndCompliance
{
    ...
    public partial class PrivateLinkServicesForSCCPowershell : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkServicesForSCCPowershell(string name, PrivateLinkServicesForSCCPowershellArgs args, CustomResourceOptions? options = null)
            : base("azure-native:m365securityandcompliance:PrivateLinkServicesForSCCPowershell", name, args ?? new PrivateLinkServicesForSCCPowershellArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkServicesForSCCPowershell(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:m365securityandcompliance:PrivateLinkServicesForSCCPowershell", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_m365securityandcompliance_v20210325preview:m365securityandcompliance:PrivateLinkServicesForSCCPowershell" },
                },
            };
