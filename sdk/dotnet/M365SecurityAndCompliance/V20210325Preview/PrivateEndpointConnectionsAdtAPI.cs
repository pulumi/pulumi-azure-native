...
namespace Pulumi.AzureNative.M365SecurityAndCompliance.V20210325Preview
{
    ...
    /// {
    ///     var privateEndpointConnectionsAdtAPI = new AzureNative.M365SecurityAndCompliance.V20210325Preview.PrivateEndpointConnectionsAdtAPI("privateEndpointConnectionsAdtAPI", new()
    ///     {
    ...
    public partial class PrivateEndpointConnectionsAdtAPI : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsAdtAPI(string name, PrivateEndpointConnectionsAdtAPIArgs args, CustomResourceOptions? options = null)
            : base("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsAdtAPI", name, args ?? new PrivateEndpointConnectionsAdtAPIArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsAdtAPI(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsAdtAPI", name, null, MakeResourceOptions(options, id))
        {
        }
