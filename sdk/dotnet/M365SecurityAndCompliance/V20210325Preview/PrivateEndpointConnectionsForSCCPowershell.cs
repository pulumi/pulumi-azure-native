...
namespace Pulumi.AzureNative.M365SecurityAndCompliance.V20210325Preview
{
    ...
    public partial class PrivateEndpointConnectionsForSCCPowershell : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsForSCCPowershell(string name, PrivateEndpointConnectionsForSCCPowershellArgs args, CustomResourceOptions? options = null)
            : base("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsForSCCPowershell", name, args ?? new PrivateEndpointConnectionsForSCCPowershellArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsForSCCPowershell(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsForSCCPowershell", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsForSCCPowershell"},
                    new Pulumi.Alias { Type = "azure-native:m365securityandcompliance:PrivateEndpointConnectionsForSCCPowershell"},
                    new Pulumi.Alias { Type = "azure-nextgen:m365securityandcompliance:PrivateEndpointConnectionsForSCCPowershell"},
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PrivateEndpointConnectionsForSCCPowershell Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
