...
namespace Pulumi.AzureNative.M365SecurityAndCompliance
{
    ...
    public partial class PrivateEndpointConnectionsForEDM : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsForEDM(string name, PrivateEndpointConnectionsForEDMArgs args, CustomResourceOptions? options = null)
            : base("azure-native:m365securityandcompliance:PrivateEndpointConnectionsForEDM", name, args ?? new PrivateEndpointConnectionsForEDMArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsForEDM(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:m365securityandcompliance:PrivateEndpointConnectionsForEDM", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_m365securityandcompliance_v20210325preview:m365securityandcompliance:PrivateEndpointConnectionsForEDM" },
                },
            };
