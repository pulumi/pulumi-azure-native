...
namespace Pulumi.AzureNative.Sql
{
    ...
    public partial class StartStopManagedInstanceSchedule : global::Pulumi.CustomResource
    {
        ...
        public StartStopManagedInstanceSchedule(string name, StartStopManagedInstanceScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql:StartStopManagedInstanceSchedule", name, args ?? new StartStopManagedInstanceScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StartStopManagedInstanceSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql:StartStopManagedInstanceSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20241101preview:StartStopManagedInstanceSchedule" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20250101:StartStopManagedInstanceSchedule" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20250201preview:StartStopManagedInstanceSchedule" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20250801preview:StartStopManagedInstanceSchedule" },
                },
            };
