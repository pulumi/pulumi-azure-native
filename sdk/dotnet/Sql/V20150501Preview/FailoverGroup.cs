...
namespace Pulumi.AzureRM.Sql.V20150501Preview
{
    ...
    public partial class FailoverGroup : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.PartnerInfoResponseResult>> PartnerServers { get; private set; } = null!;

        /// <summary>
        /// Read-only endpoint of the failover group instance.
        /// </summary>
        [Output("readOnlyEndpoint")]
        public Output<Outputs.FailoverGroupReadOnlyEndpointResponseResult?> ReadOnlyEndpoint { get; private set; } = null!;

        /// <summary>
        /// Read-write endpoint of the failover group instance.
        /// </summary>
        [Output("readWriteEndpoint")]
        public Output<Outputs.FailoverGroupReadWriteEndpointResponseResult> ReadWriteEndpoint { get; private set; } = null!;
        ...
        public FailoverGroup(string name, FailoverGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/v20150501preview:FailoverGroup", name, args ?? new FailoverGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FailoverGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/v20150501preview:FailoverGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:sql/preview:FailoverGroup"},
                },
            };
