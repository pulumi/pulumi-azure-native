...
namespace Pulumi.AzureNative.Sql.V20150501Preview
{
    public static class GetFirewallRule
    {
        ...
        public static Output<GetFirewallRuleResult> Invoke(GetFirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFirewallRuleResult>("azure-native:sql/v20150501preview:getFirewallRule", args ?? new GetFirewallRuleInvokeArgs(), options.WithVersion());
    }
