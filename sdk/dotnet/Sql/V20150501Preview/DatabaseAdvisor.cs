...
namespace Pulumi.AzureNative.Sql.V20150501Preview
{
    ...
    [AzureNativeResourceType("azure-native:sql/v20150501preview:DatabaseAdvisor")]
    public partial class DatabaseAdvisor : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAdvisor(string name, DatabaseAdvisorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20150501preview:DatabaseAdvisor", name, args ?? new DatabaseAdvisorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAdvisor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20150501preview:DatabaseAdvisor", name, null, MakeResourceOptions(options, id))
        {
        }
