...
namespace Pulumi.AzureNative.Sql.V20150501Preview
{
    public static class GetSyncAgent
    {
        ...
        public static Task<GetSyncAgentResult> InvokeAsync(GetSyncAgentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSyncAgentResult>("azure-native:sql/v20150501preview:getSyncAgent", args ?? new GetSyncAgentArgs(), options.WithDefaults());

        /// <summary>
        /// An Azure SQL Database sync agent.
        /// </summary>
        public static Output<GetSyncAgentResult> Invoke(GetSyncAgentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSyncAgentResult>("azure-native:sql/v20150501preview:getSyncAgent", args ?? new GetSyncAgentInvokeArgs(), options.WithDefaults());
    }
