...
namespace Pulumi.AzureNative.Sql.V20211101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20211101preview:ServerAzureADOnlyAuthentication is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerAzureADOnlyAuthentication to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20211101preview:ServerAzureADOnlyAuthentication")]
    public partial class ServerAzureADOnlyAuthentication : global::Pulumi.CustomResource
    {
        ...
        public ServerAzureADOnlyAuthentication(string name, ServerAzureADOnlyAuthenticationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:ServerAzureADOnlyAuthentication", name, args ?? new ServerAzureADOnlyAuthenticationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAzureADOnlyAuthentication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:ServerAzureADOnlyAuthentication", name, null, MakeResourceOptions(options, id))
        {
        }
