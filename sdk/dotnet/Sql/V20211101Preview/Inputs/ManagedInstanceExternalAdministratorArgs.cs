...
namespace Pulumi.AzureNative.Sql.V20211101Preview.Inputs
{
    ...
    public sealed class ManagedInstanceExternalAdministratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20211101Preview.AdministratorType>? AdministratorType { get; set; }
        ...
        /// </summary>
        [Input("principalType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20211101Preview.PrincipalType>? PrincipalType { get; set; }
