...
namespace Pulumi.AzureNative.Sql.V20211101Preview
{
    ...
    [AzureNativeResourceType("azure-native:sql/v20211101preview:ServerTrustGroup")]
    public partial class ServerTrustGroup : global::Pulumi.CustomResource
    {
        ...
        public ServerTrustGroup(string name, ServerTrustGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:ServerTrustGroup", name, args ?? new ServerTrustGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerTrustGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:ServerTrustGroup", name, null, MakeResourceOptions(options, id))
        {
        }
