...
namespace Pulumi.AzureNative.Sql.V20211101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20211101preview:ManagedDatabase")]
    public partial class ManagedDatabase : Pulumi.CustomResource
    {
        ...
        public ManagedDatabase(string name, ManagedDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:ManagedDatabase", name, args ?? new ManagedDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:ManagedDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedDatabaseArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20211101Preview.ManagedDatabaseCreateMode>? CreateMode { get; set; }
