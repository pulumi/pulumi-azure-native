...
{
    [Obsolete(@"azure-native:sql/v20211101preview:WorkloadGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:WorkloadGroup to guarantee forwards compatibility.")]
    public static class GetWorkloadGroup
    {
        ...
        public static Task<GetWorkloadGroupResult> InvokeAsync(GetWorkloadGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkloadGroupResult>("azure-native:sql/v20211101preview:getWorkloadGroup", args ?? new GetWorkloadGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a workload group
        /// </summary>
        public static Output<GetWorkloadGroupResult> Invoke(GetWorkloadGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkloadGroupResult>("azure-native:sql/v20211101preview:getWorkloadGroup", args ?? new GetWorkloadGroupInvokeArgs(), options.WithDefaults());
    }
