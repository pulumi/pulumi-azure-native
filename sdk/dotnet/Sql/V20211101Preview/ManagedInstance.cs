...
namespace Pulumi.AzureNative.Sql.V20211101Preview
{
    ...
    [AzureNativeResourceType("azure-native:sql/v20211101preview:ManagedInstance")]
    public partial class ManagedInstance : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstance(string name, ManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:ManagedInstance", name, args ?? new ManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:ManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedInstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20211101Preview.ManagedInstanceLicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20211101Preview.ManagedServerCreateMode>? ManagedInstanceCreateMode { get; set; }
        ...
        /// </summary>
        [Input("proxyOverride")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20211101Preview.ManagedInstanceProxyOverride>? ProxyOverride { get; set; }
