...
namespace Pulumi.AzureNative.Sql.V20211101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20211101preview:ManagedInstancePrivateEndpointConnection")]
    public partial class ManagedInstancePrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public ManagedInstancePrivateEndpointConnection(string name, ManagedInstancePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:ManagedInstancePrivateEndpointConnection", name, args ?? new ManagedInstancePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstancePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:ManagedInstancePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
