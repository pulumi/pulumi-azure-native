...
namespace Pulumi.AzureNative.Sql.V20211101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20211101preview:ServerAdvisor is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerAdvisor to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20211101preview:ServerAdvisor")]
    public partial class ServerAdvisor : global::Pulumi.CustomResource
    {
        ...
        public ServerAdvisor(string name, ServerAdvisorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:ServerAdvisor", name, args ?? new ServerAdvisorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAdvisor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:ServerAdvisor", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerAdvisorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20211101Preview.AutoExecuteStatus> AutoExecuteStatus { get; set; } = null!;
