...
namespace Pulumi.AzureNative.Sql.V20211101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20211101preview:InstancePool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:InstancePool to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20211101preview:InstancePool")]
    public partial class InstancePool : global::Pulumi.CustomResource
    {
        ...
        public InstancePool(string name, InstancePoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:InstancePool", name, args ?? new InstancePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstancePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:InstancePool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InstancePoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20211101Preview.InstancePoolLicenseType> LicenseType { get; set; } = null!;
