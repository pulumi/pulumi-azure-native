...
namespace Pulumi.AzureNative.Sql.V20211101Preview
{
    public static class GetJobTargetGroup
    {
        ...
        public static Task<GetJobTargetGroupResult> InvokeAsync(GetJobTargetGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJobTargetGroupResult>("azure-native:sql/v20211101preview:getJobTargetGroup", args ?? new GetJobTargetGroupArgs(), options.WithDefaults());

        /// <summary>
        /// A group of job targets.
        /// </summary>
        public static Output<GetJobTargetGroupResult> Invoke(GetJobTargetGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetJobTargetGroupResult>("azure-native:sql/v20211101preview:getJobTargetGroup", args ?? new GetJobTargetGroupInvokeArgs(), options.WithDefaults());
    }
