...
namespace Pulumi.AzureNative.Sql.V20211101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20211101preview:LongTermRetentionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:LongTermRetentionPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20211101preview:LongTermRetentionPolicy")]
    public partial class LongTermRetentionPolicy : global::Pulumi.CustomResource
    {
        ...
        public LongTermRetentionPolicy(string name, LongTermRetentionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:LongTermRetentionPolicy", name, args ?? new LongTermRetentionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LongTermRetentionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101preview:LongTermRetentionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
