...
{
    [Obsolete(@"azure-native:sql/v20211101preview:SyncAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncAgent to guarantee forwards compatibility.")]
    public static class GetSyncAgent
    {
        ...
        public static Task<GetSyncAgentResult> InvokeAsync(GetSyncAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSyncAgentResult>("azure-native:sql/v20211101preview:getSyncAgent", args ?? new GetSyncAgentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a sync agent.
        /// </summary>
        public static Output<GetSyncAgentResult> Invoke(GetSyncAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSyncAgentResult>("azure-native:sql/v20211101preview:getSyncAgent", args ?? new GetSyncAgentInvokeArgs(), options.WithDefaults());
    }
