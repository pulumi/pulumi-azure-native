...
namespace Pulumi.AzureNative.Sql.V20230201Preview
{
    public static class GetJob
    {
        ...
        public static Task<GetJobResult> InvokeAsync(GetJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobResult>("azure-native:sql/v20230201preview:getJob", args ?? new GetJobArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a job.
        /// </summary>
        public static Output<GetJobResult> Invoke(GetJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobResult>("azure-native:sql/v20230201preview:getJob", args ?? new GetJobInvokeArgs(), options.WithDefaults());
