...
namespace Pulumi.AzureNative.Sql.V20230201Preview
{
    public static class GetServerTrustCertificate
    {
        ...
        public static Task<GetServerTrustCertificateResult> InvokeAsync(GetServerTrustCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerTrustCertificateResult>("azure-native:sql/v20230201preview:getServerTrustCertificate", args ?? new GetServerTrustCertificateArgs(), options.WithDefaults());
        ...
        public static Output<GetServerTrustCertificateResult> Invoke(GetServerTrustCertificateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServerTrustCertificateResult>("azure-native:sql/v20230201preview:getServerTrustCertificate", args ?? new GetServerTrustCertificateInvokeArgs(), options.WithDefaults());
    }
