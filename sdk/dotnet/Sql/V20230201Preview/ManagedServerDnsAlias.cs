...
namespace Pulumi.AzureNative.Sql.V20230201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230201preview:ManagedServerDnsAlias")]
    public partial class ManagedServerDnsAlias : global::Pulumi.CustomResource
    {
        ...
        public ManagedServerDnsAlias(string name, ManagedServerDnsAliasArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230201preview:ManagedServerDnsAlias", name, args ?? new ManagedServerDnsAliasArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedServerDnsAlias(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230201preview:ManagedServerDnsAlias", name, null, MakeResourceOptions(options, id))
        {
        }
