...
namespace Pulumi.AzureNative.Sql.V20230201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230201preview:EncryptionProtector")]
    public partial class EncryptionProtector : global::Pulumi.CustomResource
    {
        ...
        public EncryptionProtector(string name, EncryptionProtectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230201preview:EncryptionProtector", name, args ?? new EncryptionProtectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EncryptionProtector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230201preview:EncryptionProtector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20240501preview:EncryptionProtector" },
    ...
    public sealed class EncryptionProtectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230201Preview.ServerKeyType> ServerKeyType { get; set; } = null!;
