...
namespace Pulumi.AzureNative.Sql.V20230201Preview
{
    public static class GetDataMaskingPolicy
    {
        ...
        public static Task<GetDataMaskingPolicyResult> InvokeAsync(GetDataMaskingPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataMaskingPolicyResult>("azure-native:sql/v20230201preview:getDataMaskingPolicy", args ?? new GetDataMaskingPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the database data masking policy.
        /// </summary>
        public static Output<GetDataMaskingPolicyResult> Invoke(GetDataMaskingPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataMaskingPolicyResult>("azure-native:sql/v20230201preview:getDataMaskingPolicy", args ?? new GetDataMaskingPolicyInvokeArgs(), options.WithDefaults());
