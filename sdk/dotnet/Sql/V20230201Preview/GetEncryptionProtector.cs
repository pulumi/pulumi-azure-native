...
namespace Pulumi.AzureNative.Sql.V20230201Preview
{
    public static class GetEncryptionProtector
    {
        ...
        public static Task<GetEncryptionProtectorResult> InvokeAsync(GetEncryptionProtectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEncryptionProtectorResult>("azure-native:sql/v20230201preview:getEncryptionProtector", args ?? new GetEncryptionProtectorArgs(), options.WithDefaults());
        ...
        public static Output<GetEncryptionProtectorResult> Invoke(GetEncryptionProtectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEncryptionProtectorResult>("azure-native:sql/v20230201preview:getEncryptionProtector", args ?? new GetEncryptionProtectorInvokeArgs(), options.WithDefaults());
