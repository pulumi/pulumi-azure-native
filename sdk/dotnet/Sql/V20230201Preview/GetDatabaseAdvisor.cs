...
namespace Pulumi.AzureNative.Sql.V20230201Preview
{
    public static class GetDatabaseAdvisor
    {
        ...
        public static Task<GetDatabaseAdvisorResult> InvokeAsync(GetDatabaseAdvisorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAdvisorResult>("azure-native:sql/v20230201preview:getDatabaseAdvisor", args ?? new GetDatabaseAdvisorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a database advisor.
        /// </summary>
        public static Output<GetDatabaseAdvisorResult> Invoke(GetDatabaseAdvisorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDatabaseAdvisorResult>("azure-native:sql/v20230201preview:getDatabaseAdvisor", args ?? new GetDatabaseAdvisorInvokeArgs(), options.WithDefaults());
