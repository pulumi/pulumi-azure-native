...
namespace Pulumi.AzureNative.Sql.V20230201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230201preview:InstancePool")]
    public partial class InstancePool : global::Pulumi.CustomResource
    {
        ...
        public InstancePool(string name, InstancePoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230201preview:InstancePool", name, args ?? new InstancePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstancePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230201preview:InstancePool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InstancePoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230201Preview.InstancePoolLicenseType> LicenseType { get; set; } = null!;
