...
namespace Pulumi.AzureNative.Sql.V20230201Preview
{
    public static class GetGeoBackupPolicy
    {
        ...
        public static Task<GetGeoBackupPolicyResult> InvokeAsync(GetGeoBackupPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGeoBackupPolicyResult>("azure-native:sql/v20230201preview:getGeoBackupPolicy", args ?? new GetGeoBackupPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Geo backup policy for the given database resource.
        /// </summary>
        public static Output<GetGeoBackupPolicyResult> Invoke(GetGeoBackupPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGeoBackupPolicyResult>("azure-native:sql/v20230201preview:getGeoBackupPolicy", args ?? new GetGeoBackupPolicyInvokeArgs(), options.WithDefaults());
    }
