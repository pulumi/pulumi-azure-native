...
namespace Pulumi.AzureNative.Sql.V20230201Preview
{
    public static class GetServerTrustGroup
    {
        ...
        public static Task<GetServerTrustGroupResult> InvokeAsync(GetServerTrustGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerTrustGroupResult>("azure-native:sql/v20230201preview:getServerTrustGroup", args ?? new GetServerTrustGroupArgs(), options.WithDefaults());
