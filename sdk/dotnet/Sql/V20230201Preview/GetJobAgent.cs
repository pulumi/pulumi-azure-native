...
namespace Pulumi.AzureNative.Sql.V20230201Preview
{
    public static class GetJobAgent
    {
        ...
        public static Task<GetJobAgentResult> InvokeAsync(GetJobAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobAgentResult>("azure-native:sql/v20230201preview:getJobAgent", args ?? new GetJobAgentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a job agent.
        /// </summary>
        public static Output<GetJobAgentResult> Invoke(GetJobAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobAgentResult>("azure-native:sql/v20230201preview:getJobAgent", args ?? new GetJobAgentInvokeArgs(), options.WithDefaults());
    }
