...
namespace Pulumi.AzureNative.Sql.V20230201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230201preview:SyncAgent")]
    public partial class SyncAgent : global::Pulumi.CustomResource
    {
        ...
        public SyncAgent(string name, SyncAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230201preview:SyncAgent", name, args ?? new SyncAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230201preview:SyncAgent", name, null, MakeResourceOptions(options, id))
        {
        }
