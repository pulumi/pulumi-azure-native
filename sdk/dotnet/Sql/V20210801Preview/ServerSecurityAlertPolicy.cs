...
namespace Pulumi.AzureNative.Sql.V20210801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20210801preview:ServerSecurityAlertPolicy")]
    public partial class ServerSecurityAlertPolicy : Pulumi.CustomResource
    {
        ...
        public ServerSecurityAlertPolicy(string name, ServerSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:ServerSecurityAlertPolicy", name, args ?? new ServerSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:ServerSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerSecurityAlertPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20210801Preview.SecurityAlertsPolicyState> State { get; set; } = null!;
