...
namespace Pulumi.AzureNative.Sql.V20210801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20210801preview:ManagedInstanceKey")]
    public partial class ManagedInstanceKey : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstanceKey(string name, ManagedInstanceKeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:ManagedInstanceKey", name, args ?? new ManagedInstanceKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:ManagedInstanceKey", name, null, MakeResourceOptions(options, id))
        {
        }
