...
namespace Pulumi.AzureNative.Sql.V20210801Preview
{
    ...
    /// {
    ///     var iPv6FirewallRule = new AzureNative.Sql.V20210801Preview.IPv6FirewallRule("iPv6FirewallRule", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:sql/v20210801preview:IPv6FirewallRule firewallrulecrudtest-3927 /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/firewallrulecrudtest-12/providers/Microsoft.Sql/servers/firewallrulecrudtest-6285/ipv6FirewallRules/firewallrulecrudtest-3927 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20210801preview:IPv6FirewallRule")]
    public partial class IPv6FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public IPv6FirewallRule(string name, IPv6FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:IPv6FirewallRule", name, args ?? new IPv6FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IPv6FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:IPv6FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
