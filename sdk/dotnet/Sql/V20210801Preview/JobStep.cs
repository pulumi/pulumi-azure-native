...
namespace Pulumi.AzureNative.Sql.V20210801Preview
{
    ...
    /// A job step.
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210801preview:JobStep is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobStep to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20210801preview:JobStep")]
    public partial class JobStep : global::Pulumi.CustomResource
    {
        ...
        public JobStep(string name, JobStepArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:JobStep", name, args ?? new JobStepArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobStep(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:JobStep", name, null, MakeResourceOptions(options, id))
        {
        }
