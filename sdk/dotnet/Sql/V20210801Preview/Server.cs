...
namespace Pulumi.AzureNative.Sql.V20210801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210801preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:Server to guarantee forwards compatibility.")]
    ...
    public partial class Server : global::Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:Server", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20210801Preview.ServerNetworkAccessFlag>? PublicNetworkAccess { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20210801Preview.ServerNetworkAccessFlag>? RestrictOutboundNetworkAccess { get; set; }
