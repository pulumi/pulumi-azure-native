...
namespace Pulumi.AzureNative.Sql.V20210801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210801preview:ServerTrustGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerTrustGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20210801preview:ServerTrustGroup")]
    public partial class ServerTrustGroup : global::Pulumi.CustomResource
    {
        ...
        public ServerTrustGroup(string name, ServerTrustGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:ServerTrustGroup", name, args ?? new ServerTrustGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerTrustGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:ServerTrustGroup", name, null, MakeResourceOptions(options, id))
        {
        }
