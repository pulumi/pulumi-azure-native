...
namespace Pulumi.AzureNative.Sql.V20210801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210801preview:ExtendedDatabaseBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ExtendedDatabaseBlobAuditingPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20210801preview:ExtendedDatabaseBlobAuditingPolicy")]
    public partial class ExtendedDatabaseBlobAuditingPolicy : global::Pulumi.CustomResource
    {
        ...
        public ExtendedDatabaseBlobAuditingPolicy(string name, ExtendedDatabaseBlobAuditingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:ExtendedDatabaseBlobAuditingPolicy", name, args ?? new ExtendedDatabaseBlobAuditingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExtendedDatabaseBlobAuditingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:ExtendedDatabaseBlobAuditingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
