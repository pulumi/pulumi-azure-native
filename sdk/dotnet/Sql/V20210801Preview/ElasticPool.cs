...
namespace Pulumi.AzureNative.Sql.V20210801Preview
{
    ...
    /// An elastic pool.
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210801preview:ElasticPool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ElasticPool to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20210801preview:ElasticPool")]
    public partial class ElasticPool : global::Pulumi.CustomResource
    {
        ...
        public ElasticPool(string name, ElasticPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:ElasticPool", name, args ?? new ElasticPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ElasticPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:ElasticPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ElasticPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20210801Preview.ElasticPoolLicenseType>? LicenseType { get; set; }
