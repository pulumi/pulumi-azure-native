...
namespace Pulumi.AzureNative.Sql.V20210801Preview
{
    ...
    /// A sensitivity label.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20210801preview:ManagedDatabaseSensitivityLabel")]
    public partial class ManagedDatabaseSensitivityLabel : global::Pulumi.CustomResource
    {
        ...
        public ManagedDatabaseSensitivityLabel(string name, ManagedDatabaseSensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:ManagedDatabaseSensitivityLabel", name, args ?? new ManagedDatabaseSensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedDatabaseSensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:ManagedDatabaseSensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedDatabaseSensitivityLabelArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("rank")]
        public Input<Pulumi.AzureNative.Sql.V20210801Preview.SensitivityLabelRank>? Rank { get; set; }
