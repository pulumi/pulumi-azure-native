...
namespace Pulumi.AzureNative.Sql.V20210801Preview
{
    public static class GetElasticPool
    {
        ...
        public static Task<GetElasticPoolResult> InvokeAsync(GetElasticPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetElasticPoolResult>("azure-native:sql/v20210801preview:getElasticPool", args ?? new GetElasticPoolArgs(), options.WithVersion());

        /// <summary>
        /// An elastic pool.
        /// </summary>
        public static Output<GetElasticPoolResult> Invoke(GetElasticPoolInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetElasticPoolResult>("azure-native:sql/v20210801preview:getElasticPool", args ?? new GetElasticPoolInvokeArgs(), options.WithVersion());
    }
