...
namespace Pulumi.AzureNative.Sql.V20210801Preview
{
    ...
    [AzureNativeResourceType("azure-native:sql/v20210801preview:VirtualNetworkRule")]
    public partial class VirtualNetworkRule : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkRule(string name, VirtualNetworkRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:VirtualNetworkRule", name, args ?? new VirtualNetworkRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210801preview:VirtualNetworkRule", name, null, MakeResourceOptions(options, id))
        {
        }
