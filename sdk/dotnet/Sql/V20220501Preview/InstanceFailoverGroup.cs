...
namespace Pulumi.AzureNative.Sql.V20220501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220501preview:InstanceFailoverGroup")]
    public partial class InstanceFailoverGroup : global::Pulumi.CustomResource
    {
        ...
        public InstanceFailoverGroup(string name, InstanceFailoverGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:InstanceFailoverGroup", name, args ?? new InstanceFailoverGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceFailoverGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:InstanceFailoverGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InstanceFailoverGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("secondaryType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220501Preview.SecondaryInstanceType>? SecondaryType { get; set; }
