...
namespace Pulumi.AzureNative.Sql.V20220501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220501preview:ServerAzureADAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerAzureADAdministrator to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20220501preview:ServerAzureADAdministrator")]
    public partial class ServerAzureADAdministrator : global::Pulumi.CustomResource
    {
        ...
        public ServerAzureADAdministrator(string name, ServerAzureADAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:ServerAzureADAdministrator", name, args ?? new ServerAzureADAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAzureADAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:ServerAzureADAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerAzureADAdministratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220501Preview.AdministratorType> AdministratorType { get; set; } = null!;
