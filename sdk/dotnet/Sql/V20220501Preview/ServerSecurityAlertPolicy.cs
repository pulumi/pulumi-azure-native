...
namespace Pulumi.AzureNative.Sql.V20220501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220501preview:ServerSecurityAlertPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerSecurityAlertPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20220501preview:ServerSecurityAlertPolicy")]
    public partial class ServerSecurityAlertPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServerSecurityAlertPolicy(string name, ServerSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:ServerSecurityAlertPolicy", name, args ?? new ServerSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:ServerSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerSecurityAlertPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20220501Preview.SecurityAlertsPolicyState> State { get; set; } = null!;
