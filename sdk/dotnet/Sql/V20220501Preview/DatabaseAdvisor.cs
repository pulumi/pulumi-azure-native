...
namespace Pulumi.AzureNative.Sql.V20220501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220501preview:DatabaseAdvisor")]
    public partial class DatabaseAdvisor : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAdvisor(string name, DatabaseAdvisorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:DatabaseAdvisor", name, args ?? new DatabaseAdvisorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAdvisor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:DatabaseAdvisor", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseAdvisorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20220501Preview.AutoExecuteStatus> AutoExecuteStatus { get; set; } = null!;
