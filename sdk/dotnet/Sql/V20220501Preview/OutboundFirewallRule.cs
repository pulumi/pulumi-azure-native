...
namespace Pulumi.AzureNative.Sql.V20220501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220501preview:OutboundFirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:OutboundFirewallRule to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20220501preview:OutboundFirewallRule")]
    public partial class OutboundFirewallRule : global::Pulumi.CustomResource
    {
        ...
        public OutboundFirewallRule(string name, OutboundFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:OutboundFirewallRule", name, args ?? new OutboundFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OutboundFirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:OutboundFirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
