...
namespace Pulumi.AzureNative.Sql.V20220501Preview
{
    ...
    /// A database resource.
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220501preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:Database to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20220501preview:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:Database", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220501Preview.CatalogCollationType>? CatalogCollation { get; set; }
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220501Preview.CreateMode>? CreateMode { get; set; }
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220501Preview.DatabaseLicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220501Preview.AlwaysEncryptedEnclaveType>? PreferredEnclaveType { get; set; }

        /// <summary>
        /// The state of read-only routing. If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica in the same region. Not applicable to a Hyperscale database within an elastic pool.
        /// </summary>
        [Input("readScale")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220501Preview.DatabaseReadScale>? ReadScale { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220501Preview.BackupStorageRedundancy>? RequestedBackupStorageRedundancy { get; set; }
        ...
        /// </summary>
        [Input("sampleName")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220501Preview.SampleName>? SampleName { get; set; }

        /// <summary>
        /// The secondary type of the database if it is a secondary.  Valid values are Geo, Named and Standby.
        /// </summary>
        [Input("secondaryType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220501Preview.SecondaryType>? SecondaryType { get; set; }
