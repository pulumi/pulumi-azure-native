...
namespace Pulumi.AzureNative.Sql.V20220501Preview
{
    ...
    public partial class LongTermRetentionPolicy : global::Pulumi.CustomResource
    {
        ...
        public LongTermRetentionPolicy(string name, LongTermRetentionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:LongTermRetentionPolicy", name, args ?? new LongTermRetentionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LongTermRetentionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:LongTermRetentionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
