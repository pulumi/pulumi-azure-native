...
namespace Pulumi.AzureNative.Sql.V20220501Preview
{
    ...
    [AzureNativeResourceType("azure-native:sql/v20220501preview:ServerAdvisor")]
    public partial class ServerAdvisor : global::Pulumi.CustomResource
    {
        ...
        public ServerAdvisor(string name, ServerAdvisorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:ServerAdvisor", name, args ?? new ServerAdvisorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAdvisor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:ServerAdvisor", name, null, MakeResourceOptions(options, id))
        {
        }
