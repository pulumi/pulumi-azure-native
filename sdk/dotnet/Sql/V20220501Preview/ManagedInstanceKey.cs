...
namespace Pulumi.AzureNative.Sql.V20220501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220501preview:ManagedInstanceKey is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceKey to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20220501preview:ManagedInstanceKey")]
    public partial class ManagedInstanceKey : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstanceKey(string name, ManagedInstanceKeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:ManagedInstanceKey", name, args ?? new ManagedInstanceKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:ManagedInstanceKey", name, null, MakeResourceOptions(options, id))
        {
        }
