...
namespace Pulumi.AzureNative.Sql.V20220501Preview
{
    ...
    public static class GetJobStep
    {
        ...
        public static Task<GetJobStepResult> InvokeAsync(GetJobStepArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobStepResult>("azure-native:sql/v20220501preview:getJobStep", args ?? new GetJobStepArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a job step in a job's current version.
        /// </summary>
        public static Output<GetJobStepResult> Invoke(GetJobStepInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobStepResult>("azure-native:sql/v20220501preview:getJobStep", args ?? new GetJobStepInvokeArgs(), options.WithDefaults());
    }
