...
namespace Pulumi.AzureNative.Sql.V20220501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220501preview:ServerTrustCertificate")]
    public partial class ServerTrustCertificate : global::Pulumi.CustomResource
    {
        ...
        public ServerTrustCertificate(string name, ServerTrustCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:ServerTrustCertificate", name, args ?? new ServerTrustCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerTrustCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220501preview:ServerTrustCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20221101preview:ServerTrustCertificate" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230201preview:ServerTrustCertificate" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230501preview:ServerTrustCertificate" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801preview:ServerTrustCertificate" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20240501preview:ServerTrustCertificate" },
                },
            };
