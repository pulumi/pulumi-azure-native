...
namespace Pulumi.AzureNative.Sql.V20200801Preview
{
    ...
    /// A server DNS alias.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20200801preview:ServerDnsAlias")]
    public partial class ServerDnsAlias : Pulumi.CustomResource
    {
        ...
        public ServerDnsAlias(string name, ServerDnsAliasArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200801preview:ServerDnsAlias", name, args ?? new ServerDnsAliasArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerDnsAlias(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200801preview:ServerDnsAlias", name, null, MakeResourceOptions(options, id))
        {
        }
