...
namespace Pulumi.AzureNextGen.Sql.V20200801Preview
{
    ...
    /// A sensitivity label.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:sql/v20200801preview:SensitivityLabel")]
    public partial class SensitivityLabel : Pulumi.CustomResource
    {
        ...
        public SensitivityLabel(string name, SensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/v20200801preview:SensitivityLabel", name, args ?? new SensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/v20200801preview:SensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SensitivityLabelArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("rank")]
        public Input<Pulumi.AzureNextGen.Sql.V20200801Preview.SensitivityLabelRank>? Rank { get; set; }
