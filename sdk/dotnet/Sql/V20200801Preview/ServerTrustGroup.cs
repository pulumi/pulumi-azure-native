...
namespace Pulumi.AzureNative.Sql.V20200801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20200801preview:ServerTrustGroup")]
    public partial class ServerTrustGroup : Pulumi.CustomResource
    {
        ...
        public ServerTrustGroup(string name, ServerTrustGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200801preview:ServerTrustGroup", name, args ?? new ServerTrustGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerTrustGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200801preview:ServerTrustGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20200202preview:ServerTrustGroup"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20201101preview:ServerTrustGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20201101preview:ServerTrustGroup"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20210201preview:ServerTrustGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20210201preview:ServerTrustGroup"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20210501preview:ServerTrustGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20210501preview:ServerTrustGroup"},
                },
            };
