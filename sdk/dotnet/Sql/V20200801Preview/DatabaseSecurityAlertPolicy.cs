...
namespace Pulumi.AzureNextGen.Sql.V20200801Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:sql/v20200801preview:DatabaseSecurityAlertPolicy")]
    public partial class DatabaseSecurityAlertPolicy : Pulumi.CustomResource
    {
        ...
        public DatabaseSecurityAlertPolicy(string name, DatabaseSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/v20200801preview:DatabaseSecurityAlertPolicy", name, args ?? new DatabaseSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/v20200801preview:DatabaseSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseSecurityAlertPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Sql.V20200801Preview.SecurityAlertsPolicyState> State { get; set; } = null!;
