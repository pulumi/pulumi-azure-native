...
namespace Pulumi.AzureNative.Sql.V20200801Preview
{
    ...
    public partial class DatabaseSecurityAlertPolicy : global::Pulumi.CustomResource
    {
        ...
        public DatabaseSecurityAlertPolicy(string name, DatabaseSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200801preview:DatabaseSecurityAlertPolicy", name, args ?? new DatabaseSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200801preview:DatabaseSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseSecurityAlertPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20200801Preview.SecurityAlertsPolicyState> State { get; set; } = null!;
