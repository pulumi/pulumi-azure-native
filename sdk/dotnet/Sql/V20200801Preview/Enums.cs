...
namespace Pulumi.AzureNextGen.Sql.V20200801Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct IdentityTypeWithNone : IEquatable<IdentityTypeWithNone>
    {
        private readonly string _value;

        private IdentityTypeWithNone(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static IdentityTypeWithNone None { get; } = new IdentityTypeWithNone("None");
        public static IdentityTypeWithNone SystemAssigned { get; } = new IdentityTypeWithNone("SystemAssigned");

        public static bool operator ==(IdentityTypeWithNone left, IdentityTypeWithNone right) => left.Equals(right);
        public static bool operator !=(IdentityTypeWithNone left, IdentityTypeWithNone right) => !left.Equals(right);

        public static explicit operator string(IdentityTypeWithNone value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is IdentityTypeWithNone other && Equals(other);
        public bool Equals(IdentityTypeWithNone other) => string.Equals(_value, other._value, StringComparison.Ordinal);
