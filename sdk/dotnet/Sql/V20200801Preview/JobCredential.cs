...
namespace Pulumi.AzureNative.Sql.V20200801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20200801preview:JobCredential")]
    public partial class JobCredential : Pulumi.CustomResource
    {
        ...
        public JobCredential(string name, JobCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200801preview:JobCredential", name, args ?? new JobCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200801preview:JobCredential", name, null, MakeResourceOptions(options, id))
        {
        }
