...
namespace Pulumi.AzureNextGen.Sql.V20200801Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:sql/v20200801preview:JobAgent")]
    public partial class JobAgent : Pulumi.CustomResource
    {
        ...
        public JobAgent(string name, JobAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/v20200801preview:JobAgent", name, args ?? new JobAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/v20200801preview:JobAgent", name, null, MakeResourceOptions(options, id))
        {
        }
