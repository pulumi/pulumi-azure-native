...
namespace Pulumi.AzureNative.Sql.V20200801Preview
{
    public static class GetEncryptionProtector
    {
        ...
        public static Task<GetEncryptionProtectorResult> InvokeAsync(GetEncryptionProtectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEncryptionProtectorResult>("azure-native:sql/v20200801preview:getEncryptionProtector", args ?? new GetEncryptionProtectorArgs(), options.WithDefaults());
        ...
        public static Output<GetEncryptionProtectorResult> Invoke(GetEncryptionProtectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEncryptionProtectorResult>("azure-native:sql/v20200801preview:getEncryptionProtector", args ?? new GetEncryptionProtectorInvokeArgs(), options.WithDefaults());
    }
