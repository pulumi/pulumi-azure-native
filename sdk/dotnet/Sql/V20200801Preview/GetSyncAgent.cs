...
namespace Pulumi.AzureNative.Sql.V20200801Preview
{
    public static class GetSyncAgent
    {
        ...
        public static Task<GetSyncAgentResult> InvokeAsync(GetSyncAgentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSyncAgentResult>("azure-native:sql/v20200801preview:getSyncAgent", args ?? new GetSyncAgentArgs(), options.WithVersion());

        /// <summary>
        /// An Azure SQL Database sync agent.
        /// </summary>
        public static Output<GetSyncAgentResult> Invoke(GetSyncAgentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSyncAgentResult>("azure-native:sql/v20200801preview:getSyncAgent", args ?? new GetSyncAgentInvokeArgs(), options.WithVersion());
    }
