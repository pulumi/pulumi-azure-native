...
{
    [Obsolete(@"azure-native:sql/v20200801preview:ServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerDnsAlias to guarantee forwards compatibility.")]
    public static class GetServerDnsAlias
    {
        ...
        public static Task<GetServerDnsAliasResult> InvokeAsync(GetServerDnsAliasArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerDnsAliasResult>("azure-native:sql/v20200801preview:getServerDnsAlias", args ?? new GetServerDnsAliasArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a server DNS alias.
        /// </summary>
        public static Output<GetServerDnsAliasResult> Invoke(GetServerDnsAliasInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServerDnsAliasResult>("azure-native:sql/v20200801preview:getServerDnsAlias", args ?? new GetServerDnsAliasInvokeArgs(), options.WithDefaults());
    }
