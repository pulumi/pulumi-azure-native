...
namespace Pulumi.AzureNative.Sql.V20200801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20200801preview:ServerAzureADAdministrator")]
    public partial class ServerAzureADAdministrator : Pulumi.CustomResource
    {
        ...
        public ServerAzureADAdministrator(string name, ServerAzureADAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200801preview:ServerAzureADAdministrator", name, args ?? new ServerAzureADAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAzureADAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200801preview:ServerAzureADAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20201101preview:ServerAzureADAdministrator"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20210201preview:ServerAzureADAdministrator"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20210201preview:ServerAzureADAdministrator"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20210501preview:ServerAzureADAdministrator"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20210501preview:ServerAzureADAdministrator"},
                },
            };
    ...
    public sealed class ServerAzureADAdministratorArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20200801Preview.AdministratorType> AdministratorType { get; set; } = null!;
