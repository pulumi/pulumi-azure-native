...
namespace Pulumi.AzureNative.Sql.V20140401
{
    ...
    /// {
    ///     var firewallRule = new AzureNative.Sql.V20140401.FirewallRule("firewallRule", new()
    ///     {
    ...
    public partial class FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20140401:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20140401:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
