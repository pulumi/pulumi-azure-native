...
namespace Pulumi.AzureNative.Sql.V20140401
{
    ...
    /// {
    ///     var serverAdvisor = new AzureNative.Sql.V20140401.ServerAdvisor("serverAdvisor", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:sql/v20140401:ServerAdvisor CreateIndex /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workloadinsight-demos/providers/Microsoft.Sql/servers/misosisvr/advisors/CreateIndex 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20140401:ServerAdvisor")]
    public partial class ServerAdvisor : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("autoExecuteValue")]
        public Output<string> AutoExecuteValue { get; private set; } = null!;
        ...
        public ServerAdvisor(string name, ServerAdvisorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20140401:ServerAdvisor", name, args ?? new ServerAdvisorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAdvisor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20140401:ServerAdvisor", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerAdvisorArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// Gets the auto-execute status (whether to let the system execute the recommendations) of this advisor. Possible values are 'Enabled' and 'Disabled'
        /// </summary>
        [Input("autoExecuteValue", required: true)]
        public Input<Pulumi.AzureNative.Sql.V20140401.AutoExecuteStatus> AutoExecuteValue { get; set; } = null!;
