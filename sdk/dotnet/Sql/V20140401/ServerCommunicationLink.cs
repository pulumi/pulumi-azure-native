...
namespace Pulumi.AzureNative.Sql.V20140401
{
    ...
    /// {
    ///     var serverCommunicationLink = new AzureNative.Sql.V20140401.ServerCommunicationLink("serverCommunicationLink", new()
    ///     {
    ...
    public partial class ServerCommunicationLink : global::Pulumi.CustomResource
    {
        ...
        public ServerCommunicationLink(string name, ServerCommunicationLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20140401:ServerCommunicationLink", name, args ?? new ServerCommunicationLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerCommunicationLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20140401:ServerCommunicationLink", name, null, MakeResourceOptions(options, id))
        {
        }
