...
namespace Pulumi.AzureRM.Sql.V20140401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var disasterRecoveryConfiguration = new AzureRM.Sql.V20140401.DisasterRecoveryConfiguration("disasterRecoveryConfiguration", new AzureRM.Sql.V20140401.DisasterRecoveryConfigurationArgs
    ///         {
    ...
    public partial class DisasterRecoveryConfiguration : Pulumi.CustomResource
    {
        ...
        public DisasterRecoveryConfiguration(string name, DisasterRecoveryConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/v20140401:DisasterRecoveryConfiguration", name, args ?? new DisasterRecoveryConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DisasterRecoveryConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/v20140401:DisasterRecoveryConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
