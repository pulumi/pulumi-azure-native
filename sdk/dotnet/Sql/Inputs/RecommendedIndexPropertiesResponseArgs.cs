...
namespace Pulumi.AzureRM.Sql.Inputs
{
    ...
    /// </summary>
    public sealed class RecommendedIndexPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.OperationImpactResponseArgs>? _estimatedImpact;

        /// <summary>
        /// The estimated impact of doing recommended index action.
        /// </summary>
        public InputList<Inputs.OperationImpactResponseArgs> EstimatedImpact
        {
            get => _estimatedImpact ?? (_estimatedImpact = new InputList<Inputs.OperationImpactResponseArgs>());
        ...
        private InputList<Inputs.OperationImpactResponseArgs>? _reportedImpact;

        /// <summary>
        /// The values reported after index action is complete.
        /// </summary>
        public InputList<Inputs.OperationImpactResponseArgs> ReportedImpact
        {
            get => _reportedImpact ?? (_reportedImpact = new InputList<Inputs.OperationImpactResponseArgs>());
        ...
        public RecommendedIndexPropertiesResponseArgs()
        {
        }
    }
}
