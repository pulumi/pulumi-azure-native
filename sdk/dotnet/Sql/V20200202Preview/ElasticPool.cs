...
namespace Pulumi.AzureNative.Sql.V20200202Preview
{
    ...
    /// An elastic pool.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20200202preview:ElasticPool")]
    public partial class ElasticPool : Pulumi.CustomResource
    {
        ...
        public ElasticPool(string name, ElasticPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200202preview:ElasticPool", name, args ?? new ElasticPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ElasticPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200202preview:ElasticPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ElasticPoolArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20200202Preview.ElasticPoolLicenseType>? LicenseType { get; set; }
