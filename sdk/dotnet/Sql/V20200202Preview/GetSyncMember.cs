...
namespace Pulumi.AzureNextGen.Sql.V20200202Preview
{
    public static class GetSyncMember
    {
        ...
        public static Task<GetSyncMemberResult> InvokeAsync(GetSyncMemberArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSyncMemberResult>("azure-nextgen:sql/v20200202preview:getSyncMember", args ?? new GetSyncMemberArgs(), options.WithVersion());
    }
