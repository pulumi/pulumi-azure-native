...
namespace Pulumi.AzureNative.Sql.V20200202Preview
{
    ...
    [AzureNativeResourceType("azure-native:sql/v20200202preview:ServerSecurityAlertPolicy")]
    public partial class ServerSecurityAlertPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServerSecurityAlertPolicy(string name, ServerSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200202preview:ServerSecurityAlertPolicy", name, args ?? new ServerSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200202preview:ServerSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
