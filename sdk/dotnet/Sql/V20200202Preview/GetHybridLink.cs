...
namespace Pulumi.AzureNextGen.Sql.V20200202Preview
{
    public static class GetHybridLink
    {
        public static Task<GetHybridLinkResult> InvokeAsync(GetHybridLinkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHybridLinkResult>("azure-nextgen:sql/v20200202preview:getHybridLink", args ?? new GetHybridLinkArgs(), options.WithVersion());
    }
