...
namespace Pulumi.AzureNative.Sql.V20200202Preview
{
    ...
    /// A failover group.
    /// </summary>
    [Obsolete(@"azure-native:sql/v20200202preview:FailoverGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:FailoverGroup to guarantee forwards compatibility.")]
    ...
    public partial class FailoverGroup : global::Pulumi.CustomResource
    {
        ...
        public FailoverGroup(string name, FailoverGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200202preview:FailoverGroup", name, args ?? new FailoverGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FailoverGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200202preview:FailoverGroup", name, null, MakeResourceOptions(options, id))
        {
        }
