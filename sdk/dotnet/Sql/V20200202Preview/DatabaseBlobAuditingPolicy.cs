...
namespace Pulumi.AzureNative.Sql.V20200202Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20200202preview:DatabaseBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DatabaseBlobAuditingPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20200202preview:DatabaseBlobAuditingPolicy")]
    public partial class DatabaseBlobAuditingPolicy : global::Pulumi.CustomResource
    {
        ...
        public DatabaseBlobAuditingPolicy(string name, DatabaseBlobAuditingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200202preview:DatabaseBlobAuditingPolicy", name, args ?? new DatabaseBlobAuditingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseBlobAuditingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200202preview:DatabaseBlobAuditingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
