...
namespace Pulumi.AzureNextGen.Sql.V20200202Preview
{
    ...
    /// A job step.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:sql/v20200202preview:JobStep")]
    public partial class JobStep : Pulumi.CustomResource
    {
        ...
        public JobStep(string name, JobStepArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/v20200202preview:JobStep", name, args ?? new JobStepArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobStep(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/v20200202preview:JobStep", name, null, MakeResourceOptions(options, id))
        {
        }
