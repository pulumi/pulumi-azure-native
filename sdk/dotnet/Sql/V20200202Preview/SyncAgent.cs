...
namespace Pulumi.AzureNextGen.Sql.V20200202Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:sql/v20200202preview:SyncAgent")]
    public partial class SyncAgent : Pulumi.CustomResource
    {
        ...
        public SyncAgent(string name, SyncAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/v20200202preview:SyncAgent", name, args ?? new SyncAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/v20200202preview:SyncAgent", name, null, MakeResourceOptions(options, id))
        {
        }
