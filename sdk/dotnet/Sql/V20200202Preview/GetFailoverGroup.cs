...
namespace Pulumi.AzureNative.Sql.V20200202Preview
{
    public static class GetFailoverGroup
    {
        ...
        public static Task<GetFailoverGroupResult> InvokeAsync(GetFailoverGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFailoverGroupResult>("azure-native:sql/v20200202preview:getFailoverGroup", args ?? new GetFailoverGroupArgs(), options.WithDefaults());

        /// <summary>
        /// A failover group.
        /// </summary>
        public static Output<GetFailoverGroupResult> Invoke(GetFailoverGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFailoverGroupResult>("azure-native:sql/v20200202preview:getFailoverGroup", args ?? new GetFailoverGroupInvokeArgs(), options.WithDefaults());
    }
