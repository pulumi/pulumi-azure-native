...
namespace Pulumi.AzureNextGen.Sql.V20200202Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:sql/v20200202preview:HybridLink")]
    public partial class HybridLink : Pulumi.CustomResource
    {
        ...
        public HybridLink(string name, HybridLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/v20200202preview:HybridLink", name, args ?? new HybridLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/v20200202preview:HybridLink", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20200801preview:HybridLink"},
                },
            };
    ...
    public sealed class HybridLinkArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Sql.V20200202Preview.ReplicationMode>? ReplicationMode { get; set; }
