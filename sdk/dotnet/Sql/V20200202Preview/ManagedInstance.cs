...
namespace Pulumi.AzureRM.Sql.V20200202Preview
{
    ...
    public partial class ManagedInstance : Pulumi.CustomResource
    {
        ...
        public ManagedInstance(string name, ManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/v20200202preview:ManagedInstance", name, args ?? new ManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/v20200202preview:ManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
