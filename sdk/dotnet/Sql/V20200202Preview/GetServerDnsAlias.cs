...
namespace Pulumi.AzureNextGen.Sql.V20200202Preview
{
    public static class GetServerDnsAlias
    {
        public static Task<GetServerDnsAliasResult> InvokeAsync(GetServerDnsAliasArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerDnsAliasResult>("azure-nextgen:sql/v20200202preview:getServerDnsAlias", args ?? new GetServerDnsAliasArgs(), options.WithVersion());
    }
