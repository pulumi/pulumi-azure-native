...
namespace Pulumi.AzureNative.Sql.V20200202Preview
{
    public static class GetServerDnsAlias
    {
        ...
        public static Task<GetServerDnsAliasResult> InvokeAsync(GetServerDnsAliasArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerDnsAliasResult>("azure-native:sql/v20200202preview:getServerDnsAlias", args ?? new GetServerDnsAliasArgs(), options.WithVersion());

        /// <summary>
        /// A server DNS alias.
        /// </summary>
        public static Output<GetServerDnsAliasResult> Invoke(GetServerDnsAliasInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServerDnsAliasResult>("azure-native:sql/v20200202preview:getServerDnsAlias", args ?? new GetServerDnsAliasInvokeArgs(), options.WithVersion());
    }
