...
namespace Pulumi.AzureNative.Sql.V20200202Preview
{
    ...
    public partial class JobAgent : Pulumi.CustomResource
    {
        ...
        public JobAgent(string name, JobAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200202preview:JobAgent", name, args ?? new JobAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20200202preview:JobAgent", name, null, MakeResourceOptions(options, id))
        {
        }
