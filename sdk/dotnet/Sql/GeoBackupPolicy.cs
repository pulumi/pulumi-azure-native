...
namespace Pulumi.AzureNative.Sql
{
    ...
    public partial class GeoBackupPolicy : global::Pulumi.CustomResource
    {
        ...
        public GeoBackupPolicy(string name, GeoBackupPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql:GeoBackupPolicy", name, args ?? new GeoBackupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GeoBackupPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql:GeoBackupPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20241101preview:GeoBackupPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20250101:GeoBackupPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20250201preview:GeoBackupPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20250801preview:GeoBackupPolicy" },
                },
            };
