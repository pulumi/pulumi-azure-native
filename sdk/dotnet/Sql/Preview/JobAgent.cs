...
namespace Pulumi.AzureRM.Sql.Preview
{
    ...
    public partial class JobAgent : Pulumi.CustomResource
    {
        ...
        public JobAgent(string name, JobAgentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/preview:JobAgent", name, args ?? new JobAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/preview:JobAgent", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:sql/v20170301preview:JobAgent"},
                },
            };
