...
namespace Pulumi.AzureRM.Sql.Preview
{
    public static class GetServerCommunicationLink
    {
        public static Task<GetServerCommunicationLinkResult> InvokeAsync(GetServerCommunicationLinkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerCommunicationLinkResult>("azurerm:sql/preview:getServerCommunicationLink", args ?? new GetServerCommunicationLinkArgs(), options.WithVersion());
    }
