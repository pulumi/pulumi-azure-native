...
namespace Pulumi.AzureRM.Sql.Preview
{
    public static class GetManagedInstance
    {
        public static Task<GetManagedInstanceResult> InvokeAsync(GetManagedInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedInstanceResult>("azurerm:sql/preview:getManagedInstance", args ?? new GetManagedInstanceArgs(), options.WithVersion());
    }
