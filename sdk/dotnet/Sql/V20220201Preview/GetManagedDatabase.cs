...
{
    [Obsolete(@"azure-native:sql/v20220201preview:ManagedDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedDatabase to guarantee forwards compatibility.")]
    public static class GetManagedDatabase
    {
        ...
        public static Task<GetManagedDatabaseResult> InvokeAsync(GetManagedDatabaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagedDatabaseResult>("azure-native:sql/v20220201preview:getManagedDatabase", args ?? new GetManagedDatabaseArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a managed database.
        /// </summary>
        public static Output<GetManagedDatabaseResult> Invoke(GetManagedDatabaseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagedDatabaseResult>("azure-native:sql/v20220201preview:getManagedDatabase", args ?? new GetManagedDatabaseInvokeArgs(), options.WithDefaults());
    }
