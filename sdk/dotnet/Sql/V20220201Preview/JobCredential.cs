...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    ...
    [AzureNativeResourceType("azure-native:sql/v20220201preview:JobCredential")]
    public partial class JobCredential : global::Pulumi.CustomResource
    {
        ...
        public JobCredential(string name, JobCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:JobCredential", name, args ?? new JobCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:JobCredential", name, null, MakeResourceOptions(options, id))
        {
        }
