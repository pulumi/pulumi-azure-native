...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220201preview:EncryptionProtector is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:EncryptionProtector to guarantee forwards compatibility.")]
    ...
    public partial class EncryptionProtector : global::Pulumi.CustomResource
    {
        ...
        public EncryptionProtector(string name, EncryptionProtectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:EncryptionProtector", name, args ?? new EncryptionProtectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EncryptionProtector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:EncryptionProtector", name, null, MakeResourceOptions(options, id))
        {
        }
