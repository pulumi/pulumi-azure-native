...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220201preview:ServerAzureADAdministrator")]
    public partial class ServerAzureADAdministrator : global::Pulumi.CustomResource
    {
        ...
        public ServerAzureADAdministrator(string name, ServerAzureADAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:ServerAzureADAdministrator", name, args ?? new ServerAzureADAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAzureADAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:ServerAzureADAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerAzureADAdministratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220201Preview.AdministratorType> AdministratorType { get; set; } = null!;
