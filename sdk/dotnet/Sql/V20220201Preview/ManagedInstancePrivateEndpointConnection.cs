...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220201preview:ManagedInstancePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedInstancePrivateEndpointConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20220201preview:ManagedInstancePrivateEndpointConnection")]
    public partial class ManagedInstancePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstancePrivateEndpointConnection(string name, ManagedInstancePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:ManagedInstancePrivateEndpointConnection", name, args ?? new ManagedInstancePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstancePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:ManagedInstancePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
