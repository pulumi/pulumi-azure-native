...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220201preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceAdministrator to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20220201preview:ManagedInstanceAdministrator")]
    public partial class ManagedInstanceAdministrator : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstanceAdministrator(string name, ManagedInstanceAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:ManagedInstanceAdministrator", name, args ?? new ManagedInstanceAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:ManagedInstanceAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedInstanceAdministratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220201Preview.ManagedInstanceAdministratorType> AdministratorType { get; set; } = null!;
