...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220201preview:ManagedServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedServerDnsAlias to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20220201preview:ManagedServerDnsAlias")]
    public partial class ManagedServerDnsAlias : global::Pulumi.CustomResource
    {
        ...
        public ManagedServerDnsAlias(string name, ManagedServerDnsAliasArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:ManagedServerDnsAlias", name, args ?? new ManagedServerDnsAliasArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedServerDnsAlias(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:ManagedServerDnsAlias", name, null, MakeResourceOptions(options, id))
        {
        }
