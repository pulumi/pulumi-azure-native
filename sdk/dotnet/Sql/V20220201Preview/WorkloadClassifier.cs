...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220201preview:WorkloadClassifier is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:WorkloadClassifier to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20220201preview:WorkloadClassifier")]
    public partial class WorkloadClassifier : global::Pulumi.CustomResource
    {
        ...
        public WorkloadClassifier(string name, WorkloadClassifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:WorkloadClassifier", name, args ?? new WorkloadClassifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadClassifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:WorkloadClassifier", name, null, MakeResourceOptions(options, id))
        {
        }
