...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220201preview:ServerBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerBlobAuditingPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20220201preview:ServerBlobAuditingPolicy")]
    public partial class ServerBlobAuditingPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServerBlobAuditingPolicy(string name, ServerBlobAuditingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:ServerBlobAuditingPolicy", name, args ?? new ServerBlobAuditingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerBlobAuditingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:ServerBlobAuditingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
