...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    public static class GetDataMaskingPolicy
    {
        ...
        public static Task<GetDataMaskingPolicyResult> InvokeAsync(GetDataMaskingPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataMaskingPolicyResult>("azure-native:sql/v20220201preview:getDataMaskingPolicy", args ?? new GetDataMaskingPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// A database data masking policy.
        /// </summary>
        public static Output<GetDataMaskingPolicyResult> Invoke(GetDataMaskingPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDataMaskingPolicyResult>("azure-native:sql/v20220201preview:getDataMaskingPolicy", args ?? new GetDataMaskingPolicyInvokeArgs(), options.WithDefaults());
    }
