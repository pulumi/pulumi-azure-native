...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    public static class GetFirewallRule
    {
        ...
        public static Task<GetFirewallRuleResult> InvokeAsync(GetFirewallRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallRuleResult>("azure-native:sql/v20220201preview:getFirewallRule", args ?? new GetFirewallRuleArgs(), options.WithDefaults());

        /// <summary>
        /// A server firewall rule.
        /// </summary>
        public static Output<GetFirewallRuleResult> Invoke(GetFirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFirewallRuleResult>("azure-native:sql/v20220201preview:getFirewallRule", args ?? new GetFirewallRuleInvokeArgs(), options.WithDefaults());
    }
