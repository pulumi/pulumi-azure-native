...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    public static class GetElasticPool
    {
        ...
        public static Task<GetElasticPoolResult> InvokeAsync(GetElasticPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetElasticPoolResult>("azure-native:sql/v20220201preview:getElasticPool", args ?? new GetElasticPoolArgs(), options.WithDefaults());

        /// <summary>
        /// An elastic pool.
        /// </summary>
        public static Output<GetElasticPoolResult> Invoke(GetElasticPoolInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetElasticPoolResult>("azure-native:sql/v20220201preview:getElasticPool", args ?? new GetElasticPoolInvokeArgs(), options.WithDefaults());
    }
