...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    ...
    /// A sensitivity label.
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220201preview:ManagedDatabaseSensitivityLabel is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedDatabaseSensitivityLabel to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20220201preview:ManagedDatabaseSensitivityLabel")]
    public partial class ManagedDatabaseSensitivityLabel : global::Pulumi.CustomResource
    {
        ...
        public ManagedDatabaseSensitivityLabel(string name, ManagedDatabaseSensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:ManagedDatabaseSensitivityLabel", name, args ?? new ManagedDatabaseSensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedDatabaseSensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:ManagedDatabaseSensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
