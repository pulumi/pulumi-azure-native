...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    public static class GetWorkloadGroup
    {
        ...
        public static Task<GetWorkloadGroupResult> InvokeAsync(GetWorkloadGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkloadGroupResult>("azure-native:sql/v20220201preview:getWorkloadGroup", args ?? new GetWorkloadGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Workload group operations for a data warehouse
        /// </summary>
        public static Output<GetWorkloadGroupResult> Invoke(GetWorkloadGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWorkloadGroupResult>("azure-native:sql/v20220201preview:getWorkloadGroup", args ?? new GetWorkloadGroupInvokeArgs(), options.WithDefaults());
    }
