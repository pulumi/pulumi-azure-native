...
namespace Pulumi.AzureNative.Sql.V20220201Preview
{
    ...
    [AzureNativeResourceType("azure-native:sql/v20220201preview:WorkloadGroup")]
    public partial class WorkloadGroup : global::Pulumi.CustomResource
    {
        ...
        public WorkloadGroup(string name, WorkloadGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:WorkloadGroup", name, args ?? new WorkloadGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220201preview:WorkloadGroup", name, null, MakeResourceOptions(options, id))
        {
        }
