...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20240501preview:ManagedInstance")]
    public partial class ManagedInstance : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstance(string name, ManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ManagedInstance", name, args ?? new ManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedInstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20240501Preview.AuthMetadataLookupModes>? AuthenticationMetadata { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20240501Preview.ManagedInstanceDatabaseFormat>? DatabaseFormat { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20240501Preview.HybridSecondaryUsage>? HybridSecondaryUsage { get; set; }
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20240501Preview.ManagedInstanceLicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20240501Preview.ManagedServerCreateMode>? ManagedInstanceCreateMode { get; set; }
        ...
        /// </summary>
        [Input("pricingModel")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20240501Preview.PricingModel>? PricingModel { get; set; }
        ...
        /// </summary>
        [Input("proxyOverride")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20240501Preview.ManagedInstanceProxyOverride>? ProxyOverride { get; set; }
