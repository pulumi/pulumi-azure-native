...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20240501preview:ManagedDatabase")]
    public partial class ManagedDatabase : global::Pulumi.CustomResource
    {
        ...
        public ManagedDatabase(string name, ManagedDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ManagedDatabase", name, args ?? new ManagedDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ManagedDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedDatabaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20240501Preview.CatalogCollationType>? CatalogCollation { get; set; }
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20240501Preview.ManagedDatabaseCreateMode>? CreateMode { get; set; }
