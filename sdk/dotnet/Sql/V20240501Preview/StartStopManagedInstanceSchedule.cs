...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20240501preview:StartStopManagedInstanceSchedule")]
    public partial class StartStopManagedInstanceSchedule : global::Pulumi.CustomResource
    {
        ...
        public StartStopManagedInstanceSchedule(string name, StartStopManagedInstanceScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:StartStopManagedInstanceSchedule", name, args ?? new StartStopManagedInstanceScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StartStopManagedInstanceSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:StartStopManagedInstanceSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
