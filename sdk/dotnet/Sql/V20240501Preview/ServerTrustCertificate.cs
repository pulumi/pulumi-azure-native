...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20240501preview:ServerTrustCertificate")]
    public partial class ServerTrustCertificate : global::Pulumi.CustomResource
    {
        ...
        public ServerTrustCertificate(string name, ServerTrustCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ServerTrustCertificate", name, args ?? new ServerTrustCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerTrustCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ServerTrustCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
