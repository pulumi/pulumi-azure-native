...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    public static class GetWorkloadClassifier
    {
        ...
        public static Task<GetWorkloadClassifierResult> InvokeAsync(GetWorkloadClassifierArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkloadClassifierResult>("azure-native:sql/v20240501preview:getWorkloadClassifier", args ?? new GetWorkloadClassifierArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a workload classifier
        /// </summary>
        public static Output<GetWorkloadClassifierResult> Invoke(GetWorkloadClassifierInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkloadClassifierResult>("azure-native:sql/v20240501preview:getWorkloadClassifier", args ?? new GetWorkloadClassifierInvokeArgs(), options.WithDefaults());
    }
