...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    public static class GetSyncAgent
    {
        ...
        public static Task<GetSyncAgentResult> InvokeAsync(GetSyncAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSyncAgentResult>("azure-native:sql/v20240501preview:getSyncAgent", args ?? new GetSyncAgentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a sync agent.
        /// </summary>
        public static Output<GetSyncAgentResult> Invoke(GetSyncAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSyncAgentResult>("azure-native:sql/v20240501preview:getSyncAgent", args ?? new GetSyncAgentInvokeArgs(), options.WithDefaults());
    }
