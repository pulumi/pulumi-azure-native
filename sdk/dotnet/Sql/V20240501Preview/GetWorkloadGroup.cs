...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    public static class GetWorkloadGroup
    {
        ...
        public static Task<GetWorkloadGroupResult> InvokeAsync(GetWorkloadGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkloadGroupResult>("azure-native:sql/v20240501preview:getWorkloadGroup", args ?? new GetWorkloadGroupArgs(), options.WithDefaults());
