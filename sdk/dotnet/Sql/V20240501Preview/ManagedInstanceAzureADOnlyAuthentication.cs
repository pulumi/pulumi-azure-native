...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20240501preview:ManagedInstanceAzureADOnlyAuthentication")]
    public partial class ManagedInstanceAzureADOnlyAuthentication : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstanceAzureADOnlyAuthentication(string name, ManagedInstanceAzureADOnlyAuthenticationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ManagedInstanceAzureADOnlyAuthentication", name, args ?? new ManagedInstanceAzureADOnlyAuthenticationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceAzureADOnlyAuthentication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ManagedInstanceAzureADOnlyAuthentication", name, null, MakeResourceOptions(options, id))
        {
        }
