...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    ...
    /// A Geo backup policy.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20240501preview:GeoBackupPolicy")]
    public partial class GeoBackupPolicy : global::Pulumi.CustomResource
    {
        ...
        public GeoBackupPolicy(string name, GeoBackupPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:GeoBackupPolicy", name, args ?? new GeoBackupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GeoBackupPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:GeoBackupPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GeoBackupPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20240501Preview.GeoBackupPolicyState> State { get; set; } = null!;
