...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20240501preview:ManagedInstanceAdministrator")]
    public partial class ManagedInstanceAdministrator : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstanceAdministrator(string name, ManagedInstanceAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ManagedInstanceAdministrator", name, args ?? new ManagedInstanceAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ManagedInstanceAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedInstanceAdministratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20240501Preview.ManagedInstanceAdministratorType> AdministratorType { get; set; } = null!;
