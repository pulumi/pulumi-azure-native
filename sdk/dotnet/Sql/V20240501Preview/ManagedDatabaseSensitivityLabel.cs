...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    ...
    /// A sensitivity label.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20240501preview:ManagedDatabaseSensitivityLabel")]
    public partial class ManagedDatabaseSensitivityLabel : global::Pulumi.CustomResource
    {
        ...
        public ManagedDatabaseSensitivityLabel(string name, ManagedDatabaseSensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ManagedDatabaseSensitivityLabel", name, args ?? new ManagedDatabaseSensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedDatabaseSensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ManagedDatabaseSensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedDatabaseSensitivityLabelArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20240501Preview.ClientClassificationSource>? ClientClassificationSource { get; set; }
        ...
        [Input("rank")]
        public Input<Pulumi.AzureNative.Sql.V20240501Preview.SensitivityLabelRank>? Rank { get; set; }
