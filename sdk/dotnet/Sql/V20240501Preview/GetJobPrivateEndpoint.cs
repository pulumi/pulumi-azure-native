...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    public static class GetJobPrivateEndpoint
    {
        ...
        public static Task<GetJobPrivateEndpointResult> InvokeAsync(GetJobPrivateEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobPrivateEndpointResult>("azure-native:sql/v20240501preview:getJobPrivateEndpoint", args ?? new GetJobPrivateEndpointArgs(), options.WithDefaults());
