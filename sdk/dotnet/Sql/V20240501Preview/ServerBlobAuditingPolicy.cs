...
namespace Pulumi.AzureNative.Sql.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20240501preview:ServerBlobAuditingPolicy")]
    public partial class ServerBlobAuditingPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServerBlobAuditingPolicy(string name, ServerBlobAuditingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ServerBlobAuditingPolicy", name, args ?? new ServerBlobAuditingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerBlobAuditingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20240501preview:ServerBlobAuditingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
