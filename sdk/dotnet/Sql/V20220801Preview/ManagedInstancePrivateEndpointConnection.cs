...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// {
    ///     var managedInstancePrivateEndpointConnection = new AzureNative.Sql.V20220801Preview.ManagedInstancePrivateEndpointConnection("managedInstancePrivateEndpointConnection", new()
    ///     {
    ///         ManagedInstanceName = "test-cl",
    ///         PrivateEndpointConnectionName = "private-endpoint-connection-name",
    ///         PrivateLinkServiceConnectionState = new AzureNative.Sql.V20220801Preview.Inputs.ManagedInstancePrivateLinkServiceConnectionStatePropertyArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220801preview:ManagedInstancePrivateEndpointConnection")]
    public partial class ManagedInstancePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstancePrivateEndpointConnection(string name, ManagedInstancePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:ManagedInstancePrivateEndpointConnection", name, args ?? new ManagedInstancePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstancePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:ManagedInstancePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
