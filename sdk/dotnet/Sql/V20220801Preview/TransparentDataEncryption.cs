...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// {
    ///     var transparentDataEncryption = new AzureNative.Sql.V20220801Preview.TransparentDataEncryption("transparentDataEncryption", new()
    ///     {
    ///         DatabaseName = "testdb",
    ///         ResourceGroupName = "securitytde-42-rg",
    ///         ServerName = "securitytde-42",
    ///         State = AzureNative.Sql.V20220801Preview.TransparentDataEncryptionState.Enabled,
    ///         TdeName = "current",
    ///     });
    /// 
    /// });
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220801preview:TransparentDataEncryption")]
    public partial class TransparentDataEncryption : global::Pulumi.CustomResource
    {
        ...
        public TransparentDataEncryption(string name, TransparentDataEncryptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:TransparentDataEncryption", name, args ?? new TransparentDataEncryptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TransparentDataEncryption(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:TransparentDataEncryption", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TransparentDataEncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20220801Preview.TransparentDataEncryptionState> State { get; set; } = null!;
