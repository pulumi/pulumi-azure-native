...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    public partial class WorkloadClassifier : global::Pulumi.CustomResource
    {
        ...
        public WorkloadClassifier(string name, WorkloadClassifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:WorkloadClassifier", name, args ?? new WorkloadClassifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadClassifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:WorkloadClassifier", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:sql:WorkloadClassifier" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20221101preview:WorkloadClassifier" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230201preview:WorkloadClassifier" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230501preview:WorkloadClassifier" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801preview:WorkloadClassifier" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20240501preview:WorkloadClassifier" },
                },
            };
