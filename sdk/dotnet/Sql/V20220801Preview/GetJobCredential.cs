...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    public static class GetJobCredential
    {
        ...
        public static Task<GetJobCredentialResult> InvokeAsync(GetJobCredentialArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobCredentialResult>("azure-native:sql/v20220801preview:getJobCredential", args ?? new GetJobCredentialArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a jobs credential.
        /// </summary>
        public static Output<GetJobCredentialResult> Invoke(GetJobCredentialInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobCredentialResult>("azure-native:sql/v20220801preview:getJobCredential", args ?? new GetJobCredentialInvokeArgs(), options.WithDefaults());
