...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// {
    ///     var databaseBlobAuditingPolicy = new AzureNative.Sql.V20220801Preview.DatabaseBlobAuditingPolicy("databaseBlobAuditingPolicy", new()
    ///     {
    ...
    ///         State = AzureNative.Sql.V20220801Preview.BlobAuditingPolicyState.Enabled,
    ///     });
    /// 
    /// });
    /// 
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:sql/v20220801preview:DatabaseBlobAuditingPolicy default /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/blobauditingtest-4799/providers/Microsoft.Sql/servers/blobauditingtest-6440/databases/testdb 
    /// ```
    /// </summary>
