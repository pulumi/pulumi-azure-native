...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220801preview:ServerTrustCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerTrustCertificate to guarantee forwards compatibility.")]
    ...
    public partial class ServerTrustCertificate : global::Pulumi.CustomResource
    {
        ...
        public ServerTrustCertificate(string name, ServerTrustCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:ServerTrustCertificate", name, args ?? new ServerTrustCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerTrustCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:ServerTrustCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
