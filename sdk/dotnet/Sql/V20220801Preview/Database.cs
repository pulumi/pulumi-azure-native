...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// {
    ///     var database = new AzureNative.Sql.V20220801Preview.Database("database", new()
    ///     {
    ///         DatabaseName = "testdb",
    ...
    ///         Identity = new AzureNative.Sql.V20220801Preview.Inputs.DatabaseIdentityArgs
    ///         {
    ///             Type = "UserAssigned",
    ///             UserAssignedIdentities = 
    ///             {
    ///                 { "/subscriptions/00000000-1111-2222-3333-444444444444/resourcegroups/Default-SQL-SouthEastAsia/providers/Microsoft.ManagedIdentity/userAssignedIdentities/umi", null },
    ///             },
    ///         },
    ///         Keys = 
    ///         {
    ///             { "https://your-key-vault-name.vault.azure.net/yourKey/yourKeyVersion", null },
    ///             { "https://your-key-vault-name.vault.azure.net/yourKey2/yourKey2Version", null },
    ///         },
    ///         Location = "southeastasia",
    ///         MaxSizeBytes = 1073741824,
    ///         ResourceGroupName = "Default-SQL-SouthEastAsia",
    ...
    ///             UserAssignedIdentities = 
    ///             {
    ///                 { "/subscriptions/00000000-1111-2222-3333-444444444444/resourcegroups/Default-SQL-SouthEastAsia/providers/Microsoft.Sql/userAssignedIdentities/umi", null },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:sql/v20220801preview:Database testdb /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default-SQL-SouthEastAsia/providers/Microsoft.Sql/servers/testsvr/databases/testdb 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220801preview:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:Database", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.AvailabilityZoneType>? AvailabilityZone { get; set; }

        /// <summary>
        /// Collation of the metadata catalog.
        /// </summary>
        [Input("catalogCollation")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.CatalogCollationType>? CatalogCollation { get; set; }
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.CreateMode>? CreateMode { get; set; }
        ...
        [Input("keys")]
        private InputMap<object>? _keys;

        /// <summary>
        /// The resource ids of the user assigned identities to use
        /// </summary>
        public InputMap<object> Keys
        {
            get => _keys ?? (_keys = new InputMap<object>());
            set => _keys = value;
        }
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.DatabaseLicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.AlwaysEncryptedEnclaveType>? PreferredEnclaveType { get; set; }

        /// <summary>
        /// The state of read-only routing. If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica in the same region. Not applicable to a Hyperscale database within an elastic pool.
        /// </summary>
        [Input("readScale")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.DatabaseReadScale>? ReadScale { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.BackupStorageRedundancy>? RequestedBackupStorageRedundancy { get; set; }
        ...
        /// </summary>
        [Input("sampleName")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.SampleName>? SampleName { get; set; }

        /// <summary>
        /// The secondary type of the database if it is a secondary.  Valid values are Geo, Named and Standby.
        /// </summary>
        [Input("secondaryType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.SecondaryType>? SecondaryType { get; set; }
