...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220801preview:JobCredential is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobCredential to guarantee forwards compatibility.")]
    ...
    public partial class JobCredential : global::Pulumi.CustomResource
    {
        ...
        public JobCredential(string name, JobCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:JobCredential", name, args ?? new JobCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:JobCredential", name, null, MakeResourceOptions(options, id))
        {
        }
