...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// {
    ///     var databaseSecurityAlertPolicy = new AzureNative.Sql.V20220801Preview.DatabaseSecurityAlertPolicy("databaseSecurityAlertPolicy", new()
    ///     {
    ///         DatabaseName = "testdb",
    ///         DisabledAlerts = new[]
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220801preview:DatabaseSecurityAlertPolicy")]
    public partial class DatabaseSecurityAlertPolicy : global::Pulumi.CustomResource
    {
        ...
        public DatabaseSecurityAlertPolicy(string name, DatabaseSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:DatabaseSecurityAlertPolicy", name, args ?? new DatabaseSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:DatabaseSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
