...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// {
    ///     var serverSecurityAlertPolicy = new AzureNative.Sql.V20220801Preview.ServerSecurityAlertPolicy("serverSecurityAlertPolicy", new()
    ///     {
    ///         DisabledAlerts = new[]
    ///         {
    ///             "Access_Anomaly",
    ...
    ///         State = AzureNative.Sql.V20220801Preview.SecurityAlertsPolicyState.Enabled,
