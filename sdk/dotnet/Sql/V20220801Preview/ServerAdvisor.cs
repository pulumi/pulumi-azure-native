...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// {
    ///     var serverAdvisor = new AzureNative.Sql.V20220801Preview.ServerAdvisor("serverAdvisor", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:sql/v20220801preview:ServerAdvisor CreateIndex /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workloadinsight-demos/providers/Microsoft.Sql/servers/misosisvr/advisors/CreateIndex 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220801preview:ServerAdvisor")]
    public partial class ServerAdvisor : global::Pulumi.CustomResource
    {
        ...
        public ServerAdvisor(string name, ServerAdvisorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:ServerAdvisor", name, args ?? new ServerAdvisorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAdvisor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:ServerAdvisor", name, null, MakeResourceOptions(options, id))
        {
        }
