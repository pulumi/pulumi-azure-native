...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// {
    ///     var jobTargetGroup = new AzureNative.Sql.V20220801Preview.JobTargetGroup("jobTargetGroup", new()
    ///     {
    ///         JobAgentName = "agent1",
    ///         Members = new[]
    ///         {
    ///             new AzureNative.Sql.V20220801Preview.Inputs.JobTargetArgs
    ///             {
    ///                 DatabaseName = "database1",
    ///                 MembershipType = AzureNative.Sql.V20220801Preview.JobTargetGroupMembershipType.Exclude,
    ///                 ServerName = "server1",
    ///                 Type = "SqlDatabase",
    ///             },
    ///             new AzureNative.Sql.V20220801Preview.Inputs.JobTargetArgs
    ///             {
    ///                 MembershipType = AzureNative.Sql.V20220801Preview.JobTargetGroupMembershipType.Include,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220801preview:JobTargetGroup")]
    public partial class JobTargetGroup : global::Pulumi.CustomResource
    {
        ...
        public JobTargetGroup(string name, JobTargetGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:JobTargetGroup", name, args ?? new JobTargetGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobTargetGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:JobTargetGroup", name, null, MakeResourceOptions(options, id))
        {
        }
