...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// {
    ///     var jobStep = new AzureNative.Sql.V20220801Preview.JobStep("jobStep", new()
    ///     {
    ///         Action = new AzureNative.Sql.V20220801Preview.Inputs.JobStepActionArgs
    ///         {
    ///             Source = "Inline",
    ///             Type = "TSql",
    ///             Value = "select 2",
    ...
    ///         ExecutionOptions = new AzureNative.Sql.V20220801Preview.Inputs.JobStepExecutionOptionsArgs
    ///         {
    ...
    ///         JobAgentName = "agent1",
    ///         JobName = "job1",
    ///         Output = new AzureNative.Sql.V20220801Preview.Inputs.JobStepOutputArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220801preview:JobStep")]
    public partial class JobStep : global::Pulumi.CustomResource
    {
        ...
        public JobStep(string name, JobStepArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:JobStep", name, args ?? new JobStepArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobStep(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:JobStep", name, null, MakeResourceOptions(options, id))
        {
        }
