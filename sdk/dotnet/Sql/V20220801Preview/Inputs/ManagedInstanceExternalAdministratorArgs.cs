...
namespace Pulumi.AzureNative.Sql.V20220801Preview.Inputs
{
    ...
    public sealed class ManagedInstanceExternalAdministratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.AdministratorType>? AdministratorType { get; set; }
        ...
        /// </summary>
        [Input("principalType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.PrincipalType>? PrincipalType { get; set; }
