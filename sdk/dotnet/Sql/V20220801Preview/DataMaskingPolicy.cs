...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// {
    ///     var dataMaskingPolicy = new AzureNative.Sql.V20220801Preview.DataMaskingPolicy("dataMaskingPolicy", new()
    ///     {
    ///         DataMaskingPolicyName = "Default",
    ///         DataMaskingState = AzureNative.Sql.V20220801Preview.DataMaskingState.Enabled,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220801preview:DataMaskingPolicy")]
    public partial class DataMaskingPolicy : global::Pulumi.CustomResource
    {
        ...
        public DataMaskingPolicy(string name, DataMaskingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:DataMaskingPolicy", name, args ?? new DataMaskingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataMaskingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:DataMaskingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataMaskingPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20220801Preview.DataMaskingState> DataMaskingState { get; set; } = null!;
