...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// {
    ///     var geoBackupPolicy = new AzureNative.Sql.V20220801Preview.GeoBackupPolicy("geoBackupPolicy", new()
    ///     {
    ///         DatabaseName = "testdw",
    ///         GeoBackupPolicyName = "Default",
    ///         ResourceGroupName = "sqlcrudtest-4799",
    ///         ServerName = "sqlcrudtest-5961",
    ///         State = AzureNative.Sql.V20220801Preview.GeoBackupPolicyState.Enabled,
    ///     });
    /// 
    /// });
    /// 
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20220801preview:GeoBackupPolicy")]
    public partial class GeoBackupPolicy : global::Pulumi.CustomResource
    {
        ...
        public GeoBackupPolicy(string name, GeoBackupPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:GeoBackupPolicy", name, args ?? new GeoBackupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GeoBackupPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:GeoBackupPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GeoBackupPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20220801Preview.GeoBackupPolicyState> State { get; set; } = null!;
