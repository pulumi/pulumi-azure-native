...
namespace Pulumi.AzureNative.Sql.V20220801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20220801preview:ManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstance to guarantee forwards compatibility.")]
    ...
    public partial class ManagedInstance : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstance(string name, ManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:ManagedInstance", name, args ?? new ManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20220801preview:ManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedInstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.ManagedInstanceLicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.ManagedServerCreateMode>? ManagedInstanceCreateMode { get; set; }
        ...
        /// </summary>
        [Input("proxyOverride")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20220801Preview.ManagedInstanceProxyOverride>? ProxyOverride { get; set; }
