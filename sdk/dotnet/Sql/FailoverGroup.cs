...
namespace Pulumi.AzureNative.Sql
{
    ...
    public partial class FailoverGroup : global::Pulumi.CustomResource
    {
        ...
        public FailoverGroup(string name, FailoverGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql:FailoverGroup", name, args ?? new FailoverGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FailoverGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql:FailoverGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20150501preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20200202preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20200801preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20201101preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20210201preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20210501preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20210801preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20211101:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20211101preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20220201preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20220501preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20220801preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20221101preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20230201preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20230501preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20230801:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20230801preview:sql:FailoverGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_sql_v20240501preview:sql:FailoverGroup" },
                },
            };
    ...
    public sealed class FailoverGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("secondaryType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.FailoverGroupDatabasesSecondaryType>? SecondaryType { get; set; }
