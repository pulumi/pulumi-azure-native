...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    public static class GetServerKey
    {
        ...
        public static Task<GetServerKeyResult> InvokeAsync(GetServerKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerKeyResult>("azure-native:sql/v20221101preview:getServerKey", args ?? new GetServerKeyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a server key.
        /// </summary>
        public static Output<GetServerKeyResult> Invoke(GetServerKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServerKeyResult>("azure-native:sql/v20221101preview:getServerKey", args ?? new GetServerKeyInvokeArgs(), options.WithDefaults());
    }
