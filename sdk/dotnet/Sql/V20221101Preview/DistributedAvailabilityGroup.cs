...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20221101preview:DistributedAvailabilityGroup")]
    public partial class DistributedAvailabilityGroup : global::Pulumi.CustomResource
    {
        ...
        public DistributedAvailabilityGroup(string name, DistributedAvailabilityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:DistributedAvailabilityGroup", name, args ?? new DistributedAvailabilityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DistributedAvailabilityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:DistributedAvailabilityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DistributedAvailabilityGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20221101Preview.ReplicationMode>? ReplicationMode { get; set; }
