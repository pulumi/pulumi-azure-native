...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20221101preview:IPv6FirewallRule")]
    public partial class IPv6FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public IPv6FirewallRule(string name, IPv6FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:IPv6FirewallRule", name, args ?? new IPv6FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IPv6FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:IPv6FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
