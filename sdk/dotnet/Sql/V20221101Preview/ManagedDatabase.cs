...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20221101preview:ManagedDatabase")]
    public partial class ManagedDatabase : global::Pulumi.CustomResource
    {
        ...
        public ManagedDatabase(string name, ManagedDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:ManagedDatabase", name, args ?? new ManagedDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:ManagedDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedDatabaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20221101Preview.ManagedDatabaseCreateMode>? CreateMode { get; set; }
