...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    ...
    /// A server DNS alias.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20221101preview:ServerDnsAlias")]
    public partial class ServerDnsAlias : global::Pulumi.CustomResource
    {
        ...
        public ServerDnsAlias(string name, ServerDnsAliasArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:ServerDnsAlias", name, args ?? new ServerDnsAliasArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerDnsAlias(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:ServerDnsAlias", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801:ServerDnsAlias" },
