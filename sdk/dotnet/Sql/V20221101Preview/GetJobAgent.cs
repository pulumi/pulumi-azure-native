...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    public static class GetJobAgent
    {
        ...
        public static Task<GetJobAgentResult> InvokeAsync(GetJobAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobAgentResult>("azure-native:sql/v20221101preview:getJobAgent", args ?? new GetJobAgentArgs(), options.WithDefaults());
