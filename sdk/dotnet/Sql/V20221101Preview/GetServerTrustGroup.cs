...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    public static class GetServerTrustGroup
    {
        ...
        public static Task<GetServerTrustGroupResult> InvokeAsync(GetServerTrustGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerTrustGroupResult>("azure-native:sql/v20221101preview:getServerTrustGroup", args ?? new GetServerTrustGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a server trust group.
        /// </summary>
        public static Output<GetServerTrustGroupResult> Invoke(GetServerTrustGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServerTrustGroupResult>("azure-native:sql/v20221101preview:getServerTrustGroup", args ?? new GetServerTrustGroupInvokeArgs(), options.WithDefaults());
    }
