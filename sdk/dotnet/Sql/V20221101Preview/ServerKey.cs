...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    ...
    /// A server key.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20221101preview:ServerKey")]
    public partial class ServerKey : global::Pulumi.CustomResource
    {
        ...
        public ServerKey(string name, ServerKeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:ServerKey", name, args ?? new ServerKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:ServerKey", name, null, MakeResourceOptions(options, id))
        {
        }
