...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20221101preview:ManagedServerDnsAlias")]
    public partial class ManagedServerDnsAlias : global::Pulumi.CustomResource
    {
        ...
        public ManagedServerDnsAlias(string name, ManagedServerDnsAliasArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:ManagedServerDnsAlias", name, args ?? new ManagedServerDnsAliasArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedServerDnsAlias(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:ManagedServerDnsAlias", name, null, MakeResourceOptions(options, id))
        {
        }
