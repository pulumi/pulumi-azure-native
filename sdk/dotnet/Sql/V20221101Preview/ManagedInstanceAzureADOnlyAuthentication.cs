...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20221101preview:ManagedInstanceAzureADOnlyAuthentication")]
    public partial class ManagedInstanceAzureADOnlyAuthentication : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstanceAzureADOnlyAuthentication(string name, ManagedInstanceAzureADOnlyAuthenticationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:ManagedInstanceAzureADOnlyAuthentication", name, args ?? new ManagedInstanceAzureADOnlyAuthenticationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceAzureADOnlyAuthentication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:ManagedInstanceAzureADOnlyAuthentication", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20211101:ManagedInstanceAzureADOnlyAuthentication" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230201preview:ManagedInstanceAzureADOnlyAuthentication" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230501preview:ManagedInstanceAzureADOnlyAuthentication" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801:ManagedInstanceAzureADOnlyAuthentication" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801preview:ManagedInstanceAzureADOnlyAuthentication" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20240501preview:ManagedInstanceAzureADOnlyAuthentication" },
