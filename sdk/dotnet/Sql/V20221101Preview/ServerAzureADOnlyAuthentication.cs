...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20221101preview:ServerAzureADOnlyAuthentication")]
    public partial class ServerAzureADOnlyAuthentication : global::Pulumi.CustomResource
    {
        ...
        public ServerAzureADOnlyAuthentication(string name, ServerAzureADOnlyAuthenticationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:ServerAzureADOnlyAuthentication", name, args ?? new ServerAzureADOnlyAuthenticationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAzureADOnlyAuthentication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:ServerAzureADOnlyAuthentication", name, null, MakeResourceOptions(options, id))
        {
        }
