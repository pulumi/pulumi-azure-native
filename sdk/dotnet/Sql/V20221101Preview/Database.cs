...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    ...
    /// A database resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20221101preview:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:Database", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20221101Preview.AvailabilityZoneType>? AvailabilityZone { get; set; }

        /// <summary>
        /// Collation of the metadata catalog.
        /// </summary>
        [Input("catalogCollation")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20221101Preview.CatalogCollationType>? CatalogCollation { get; set; }
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20221101Preview.CreateMode>? CreateMode { get; set; }
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20221101Preview.DatabaseLicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20221101Preview.AlwaysEncryptedEnclaveType>? PreferredEnclaveType { get; set; }

        /// <summary>
        /// The state of read-only routing. If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica in the same region. Not applicable to a Hyperscale database within an elastic pool.
        /// </summary>
        [Input("readScale")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20221101Preview.DatabaseReadScale>? ReadScale { get; set; }
        ...
        /// </summary>
        [Input("sampleName")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20221101Preview.SampleName>? SampleName { get; set; }

        /// <summary>
        /// The secondary type of the database if it is a secondary.  Valid values are Geo, Named and Standby.
        /// </summary>
        [Input("secondaryType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20221101Preview.SecondaryType>? SecondaryType { get; set; }
