...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    ...
    /// A failover group.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20221101preview:FailoverGroup")]
    public partial class FailoverGroup : global::Pulumi.CustomResource
    {
        ...
        public FailoverGroup(string name, FailoverGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:FailoverGroup", name, args ?? new FailoverGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FailoverGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:FailoverGroup", name, null, MakeResourceOptions(options, id))
        {
        }
