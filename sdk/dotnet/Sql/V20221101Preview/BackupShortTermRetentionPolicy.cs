...
namespace Pulumi.AzureNative.Sql.V20221101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20221101preview:BackupShortTermRetentionPolicy")]
    public partial class BackupShortTermRetentionPolicy : global::Pulumi.CustomResource
    {
        ...
        public BackupShortTermRetentionPolicy(string name, BackupShortTermRetentionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:BackupShortTermRetentionPolicy", name, args ?? new BackupShortTermRetentionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupShortTermRetentionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20221101preview:BackupShortTermRetentionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
