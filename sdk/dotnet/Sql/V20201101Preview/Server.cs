...
namespace Pulumi.AzureNative.Sql.V20201101Preview
{
    ...
    /// {
    ///     var server = new AzureNative.Sql.V20201101Preview.Server("server", new()
    ///     {
    ///         AdministratorLogin = "dummylogin",
    ///         AdministratorLoginPassword = "PLACEHOLDER",
    ///         Administrators = new AzureNative.Sql.V20201101Preview.Inputs.ServerExternalAdministratorArgs
    ///         {
