...
namespace Pulumi.AzureNative.Sql.V20201101Preview
{
    ...
    /// {
    ///     var serverTrustGroup = new AzureNative.Sql.V20201101Preview.ServerTrustGroup("serverTrustGroup", new()
    ///     {
    ///         GroupMembers = new[]
    ///         {
    ///             new AzureNative.Sql.V20201101Preview.Inputs.ServerInfoArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20201101preview:ServerTrustGroup")]
    public partial class ServerTrustGroup : global::Pulumi.CustomResource
    {
        ...
        public ServerTrustGroup(string name, ServerTrustGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:ServerTrustGroup", name, args ?? new ServerTrustGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerTrustGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:ServerTrustGroup", name, null, MakeResourceOptions(options, id))
        {
        }
