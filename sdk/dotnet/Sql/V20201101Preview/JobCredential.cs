...
namespace Pulumi.AzureNative.Sql.V20201101Preview
{
    ...
    /// {
    ///     var jobCredential = new AzureNative.Sql.V20201101Preview.JobCredential("jobCredential", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20201101preview:JobCredential")]
    public partial class JobCredential : global::Pulumi.CustomResource
    {
        ...
        public JobCredential(string name, JobCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:JobCredential", name, args ?? new JobCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:JobCredential", name, null, MakeResourceOptions(options, id))
        {
        }
