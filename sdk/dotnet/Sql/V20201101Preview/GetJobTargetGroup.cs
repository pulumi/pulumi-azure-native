...
namespace Pulumi.AzureNative.Sql.V20201101Preview
{
    ...
    public static class GetJobTargetGroup
    {
        ...
        public static Task<GetJobTargetGroupResult> InvokeAsync(GetJobTargetGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobTargetGroupResult>("azure-native:sql/v20201101preview:getJobTargetGroup", args ?? new GetJobTargetGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a target group.
        /// </summary>
        public static Output<GetJobTargetGroupResult> Invoke(GetJobTargetGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobTargetGroupResult>("azure-native:sql/v20201101preview:getJobTargetGroup", args ?? new GetJobTargetGroupInvokeArgs(), options.WithDefaults());
    }
