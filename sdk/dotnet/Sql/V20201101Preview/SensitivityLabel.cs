...
namespace Pulumi.AzureNative.Sql.V20201101Preview
{
    ...
    /// {
    ///     var sensitivityLabel = new AzureNative.Sql.V20201101Preview.SensitivityLabel("sensitivityLabel", new()
    ///     {
    ///         ColumnName = "myColumn",
    ...
    ///         LabelName = "PII",
    ///         Rank = AzureNative.Sql.V20201101Preview.SensitivityLabelRank.Low,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20201101preview:SensitivityLabel")]
    public partial class SensitivityLabel : global::Pulumi.CustomResource
    {
        ...
        public SensitivityLabel(string name, SensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:SensitivityLabel", name, args ?? new SensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:SensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
