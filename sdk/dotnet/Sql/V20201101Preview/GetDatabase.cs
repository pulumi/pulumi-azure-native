...
namespace Pulumi.AzureNative.Sql.V20201101Preview
{
    public static class GetDatabase
    {
        ...
        public static Task<GetDatabaseResult> InvokeAsync(GetDatabaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseResult>("azure-native:sql/v20201101preview:getDatabase", args ?? new GetDatabaseArgs(), options.WithVersion());

        /// <summary>
        /// A database resource.
        /// </summary>
        public static Output<GetDatabaseResult> Invoke(GetDatabaseInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatabaseResult>("azure-native:sql/v20201101preview:getDatabase", args ?? new GetDatabaseInvokeArgs(), options.WithVersion());
    }
