...
namespace Pulumi.AzureNative.Sql.V20201101Preview
{
    ...
    /// {
    ///     var serverAdvisor = new AzureNative.Sql.V20201101Preview.ServerAdvisor("serverAdvisor", new()
    ///     {
    ///         AdvisorName = "CreateIndex",
    ///         AutoExecuteStatus = AzureNative.Sql.V20201101Preview.AutoExecuteStatus.Disabled,
    ...
    public partial class ServerAdvisor : global::Pulumi.CustomResource
    {
        ...
        public ServerAdvisor(string name, ServerAdvisorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:ServerAdvisor", name, args ?? new ServerAdvisorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAdvisor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:ServerAdvisor", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerAdvisorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20201101Preview.AutoExecuteStatus> AutoExecuteStatus { get; set; } = null!;
