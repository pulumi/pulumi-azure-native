...
namespace Pulumi.AzureNative.Sql.V20201101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20201101preview:ExtendedDatabaseBlobAuditingPolicy")]
    public partial class ExtendedDatabaseBlobAuditingPolicy : Pulumi.CustomResource
    {
        ...
        public ExtendedDatabaseBlobAuditingPolicy(string name, ExtendedDatabaseBlobAuditingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:ExtendedDatabaseBlobAuditingPolicy", name, args ?? new ExtendedDatabaseBlobAuditingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExtendedDatabaseBlobAuditingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:ExtendedDatabaseBlobAuditingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20201101preview:ExtendedDatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql:ExtendedDatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql:ExtendedDatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20170301preview:ExtendedDatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20170301preview:ExtendedDatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20200202preview:ExtendedDatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20200202preview:ExtendedDatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20200801preview:ExtendedDatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20200801preview:ExtendedDatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20210201preview:ExtendedDatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20210201preview:ExtendedDatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20210501preview:ExtendedDatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20210501preview:ExtendedDatabaseBlobAuditingPolicy"},
                },
            };
    ...
    public sealed class ExtendedDatabaseBlobAuditingPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20201101Preview.BlobAuditingPolicyState> State { get; set; } = null!;
