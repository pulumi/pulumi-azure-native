...
namespace Pulumi.AzureNative.Sql.V20201101Preview
{
    ...
    /// {
    ///     var serverSecurityAlertPolicy = new AzureNative.Sql.V20201101Preview.ServerSecurityAlertPolicy("serverSecurityAlertPolicy", new()
    ///     {
    ///         DisabledAlerts = new[]
    ///         {
    ///             "Access_Anomaly",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20201101preview:ServerSecurityAlertPolicy")]
    public partial class ServerSecurityAlertPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServerSecurityAlertPolicy(string name, ServerSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:ServerSecurityAlertPolicy", name, args ?? new ServerSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:ServerSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
