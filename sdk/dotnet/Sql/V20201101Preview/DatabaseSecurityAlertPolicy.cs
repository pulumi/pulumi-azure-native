...
namespace Pulumi.AzureNative.Sql.V20201101Preview
{
    ...
    /// {
    ///     var databaseSecurityAlertPolicy = new AzureNative.Sql.V20201101Preview.DatabaseSecurityAlertPolicy("databaseSecurityAlertPolicy", new()
    ///     {
    ///         DatabaseName = "testdb",
    ///         DisabledAlerts = new[]
    ///         {
    ...
    ///         State = AzureNative.Sql.V20201101Preview.SecurityAlertsPolicyState.Enabled,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20201101preview:DatabaseSecurityAlertPolicy")]
    public partial class DatabaseSecurityAlertPolicy : global::Pulumi.CustomResource
    {
        ...
        public DatabaseSecurityAlertPolicy(string name, DatabaseSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:DatabaseSecurityAlertPolicy", name, args ?? new DatabaseSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20201101preview:DatabaseSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseSecurityAlertPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20201101Preview.SecurityAlertsPolicyState> State { get; set; } = null!;
