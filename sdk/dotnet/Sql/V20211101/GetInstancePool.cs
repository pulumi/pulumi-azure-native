...
{
    [Obsolete(@"azure-native:sql/v20211101:InstancePool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:InstancePool to guarantee forwards compatibility.")]
    public static class GetInstancePool
    {
        ...
        public static Task<GetInstancePoolResult> InvokeAsync(GetInstancePoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInstancePoolResult>("azure-native:sql/v20211101:getInstancePool", args ?? new GetInstancePoolArgs(), options.WithDefaults());
