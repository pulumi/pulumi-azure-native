...
namespace Pulumi.AzureNative.Sql.V20211101.Inputs
{
    ...
    public sealed class ManagedInstanceExternalAdministratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20211101.AdministratorType>? AdministratorType { get; set; }
        ...
        /// </summary>
        [Input("principalType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20211101.PrincipalType>? PrincipalType { get; set; }
