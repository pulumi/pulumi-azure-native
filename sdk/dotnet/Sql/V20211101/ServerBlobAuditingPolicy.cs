...
namespace Pulumi.AzureNative.Sql.V20211101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20211101:ServerBlobAuditingPolicy")]
    public partial class ServerBlobAuditingPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServerBlobAuditingPolicy(string name, ServerBlobAuditingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:ServerBlobAuditingPolicy", name, args ?? new ServerBlobAuditingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerBlobAuditingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:ServerBlobAuditingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
