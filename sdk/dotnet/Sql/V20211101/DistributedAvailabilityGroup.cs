...
namespace Pulumi.AzureNative.Sql.V20211101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20211101:DistributedAvailabilityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DistributedAvailabilityGroup to guarantee forwards compatibility.")]
    ...
    public partial class DistributedAvailabilityGroup : global::Pulumi.CustomResource
    {
        ...
        public DistributedAvailabilityGroup(string name, DistributedAvailabilityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:DistributedAvailabilityGroup", name, args ?? new DistributedAvailabilityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DistributedAvailabilityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:DistributedAvailabilityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DistributedAvailabilityGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20211101.ReplicationMode>? ReplicationMode { get; set; }
