...
namespace Pulumi.AzureNative.Sql.V20211101
{
    ...
    [AzureNativeResourceType("azure-native:sql/v20211101:LongTermRetentionPolicy")]
    public partial class LongTermRetentionPolicy : global::Pulumi.CustomResource
    {
        ...
        public LongTermRetentionPolicy(string name, LongTermRetentionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:LongTermRetentionPolicy", name, args ?? new LongTermRetentionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LongTermRetentionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:LongTermRetentionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
