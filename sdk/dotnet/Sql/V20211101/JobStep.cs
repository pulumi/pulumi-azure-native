...
namespace Pulumi.AzureNative.Sql.V20211101
{
    ...
    public partial class JobStep : global::Pulumi.CustomResource
    {
        ...
        public JobStep(string name, JobStepArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:JobStep", name, args ?? new JobStepArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobStep(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:JobStep", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230201preview:JobStep" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230501preview:JobStep" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801:JobStep" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801preview:JobStep" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20240501preview:JobStep" },
