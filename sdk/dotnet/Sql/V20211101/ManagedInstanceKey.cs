...
namespace Pulumi.AzureNative.Sql.V20211101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20211101:ManagedInstanceKey is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedInstanceKey to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20211101:ManagedInstanceKey")]
    public partial class ManagedInstanceKey : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstanceKey(string name, ManagedInstanceKeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:ManagedInstanceKey", name, args ?? new ManagedInstanceKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:ManagedInstanceKey", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedInstanceKeyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20211101.ServerKeyType> ServerKeyType { get; set; } = null!;
