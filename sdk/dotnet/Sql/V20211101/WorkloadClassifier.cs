...
namespace Pulumi.AzureNative.Sql.V20211101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20211101:WorkloadClassifier is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:WorkloadClassifier to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20211101:WorkloadClassifier")]
    public partial class WorkloadClassifier : global::Pulumi.CustomResource
    {
        ...
        public WorkloadClassifier(string name, WorkloadClassifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:WorkloadClassifier", name, args ?? new WorkloadClassifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadClassifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:WorkloadClassifier", name, null, MakeResourceOptions(options, id))
        {
        }
