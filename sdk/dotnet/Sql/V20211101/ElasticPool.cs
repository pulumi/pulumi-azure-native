...
namespace Pulumi.AzureNative.Sql.V20211101
{
    ...
    /// An elastic pool.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20211101:ElasticPool")]
    public partial class ElasticPool : global::Pulumi.CustomResource
    {
        ...
        public ElasticPool(string name, ElasticPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:ElasticPool", name, args ?? new ElasticPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ElasticPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:ElasticPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ElasticPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20211101.ElasticPoolLicenseType>? LicenseType { get; set; }
