...
{
    [Obsolete(@"azure-native:sql/v20211101:IPv6FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:IPv6FirewallRule to guarantee forwards compatibility.")]
    public static class GetIPv6FirewallRule
    {
        ...
        public static Task<GetIPv6FirewallRuleResult> InvokeAsync(GetIPv6FirewallRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIPv6FirewallRuleResult>("azure-native:sql/v20211101:getIPv6FirewallRule", args ?? new GetIPv6FirewallRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an IPv6 firewall rule.
        /// </summary>
        public static Output<GetIPv6FirewallRuleResult> Invoke(GetIPv6FirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIPv6FirewallRuleResult>("azure-native:sql/v20211101:getIPv6FirewallRule", args ?? new GetIPv6FirewallRuleInvokeArgs(), options.WithDefaults());
    }
