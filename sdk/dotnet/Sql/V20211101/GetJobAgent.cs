...
{
    [Obsolete(@"azure-native:sql/v20211101:JobAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:JobAgent to guarantee forwards compatibility.")]
    public static class GetJobAgent
    {
        ...
        public static Task<GetJobAgentResult> InvokeAsync(GetJobAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobAgentResult>("azure-native:sql/v20211101:getJobAgent", args ?? new GetJobAgentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a job agent.
        /// </summary>
        public static Output<GetJobAgentResult> Invoke(GetJobAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobAgentResult>("azure-native:sql/v20211101:getJobAgent", args ?? new GetJobAgentInvokeArgs(), options.WithDefaults());
    }
