...
namespace Pulumi.AzureNative.Sql.V20211101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20211101:DatabaseBlobAuditingPolicy")]
    public partial class DatabaseBlobAuditingPolicy : Pulumi.CustomResource
    {
        ...
        public DatabaseBlobAuditingPolicy(string name, DatabaseBlobAuditingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:DatabaseBlobAuditingPolicy", name, args ?? new DatabaseBlobAuditingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseBlobAuditingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20211101:DatabaseBlobAuditingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseBlobAuditingPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20211101.BlobAuditingPolicyState> State { get; set; } = null!;
