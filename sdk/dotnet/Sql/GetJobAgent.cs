...
namespace Pulumi.AzureNative.Sql
{
    public static class GetJobAgent
    {
        ...
        public static Task<GetJobAgentResult> InvokeAsync(GetJobAgentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJobAgentResult>("azure-native:sql:getJobAgent", args ?? new GetJobAgentArgs(), options.WithDefaults());
        ...
        public static Output<GetJobAgentResult> Invoke(GetJobAgentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetJobAgentResult>("azure-native:sql:getJobAgent", args ?? new GetJobAgentInvokeArgs(), options.WithDefaults());
    }
