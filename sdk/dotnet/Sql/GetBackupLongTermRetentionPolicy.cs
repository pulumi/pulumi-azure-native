...
namespace Pulumi.AzureNative.Sql
{
    public static class GetBackupLongTermRetentionPolicy
    {
        ...
        public static Task<GetBackupLongTermRetentionPolicyResult> InvokeAsync(GetBackupLongTermRetentionPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackupLongTermRetentionPolicyResult>("azure-native:sql:getBackupLongTermRetentionPolicy", args ?? new GetBackupLongTermRetentionPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetBackupLongTermRetentionPolicyResult> Invoke(GetBackupLongTermRetentionPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBackupLongTermRetentionPolicyResult>("azure-native:sql:getBackupLongTermRetentionPolicy", args ?? new GetBackupLongTermRetentionPolicyInvokeArgs(), options.WithDefaults());
    }
