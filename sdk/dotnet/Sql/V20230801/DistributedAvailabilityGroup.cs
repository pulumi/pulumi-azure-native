...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:DistributedAvailabilityGroup")]
    public partial class DistributedAvailabilityGroup : global::Pulumi.CustomResource
    {
        ...
        public DistributedAvailabilityGroup(string name, DistributedAvailabilityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:DistributedAvailabilityGroup", name, args ?? new DistributedAvailabilityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DistributedAvailabilityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:DistributedAvailabilityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DistributedAvailabilityGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("failoverMode")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230801.FailoverModeType>? FailoverMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230801.LinkRole>? InstanceLinkRole { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230801.ReplicationModeType>? ReplicationMode { get; set; }
        ...
        /// </summary>
        [Input("seedingMode")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230801.SeedingModeType>? SeedingMode { get; set; }
