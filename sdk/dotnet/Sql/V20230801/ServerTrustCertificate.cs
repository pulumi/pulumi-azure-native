...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:ServerTrustCertificate")]
    public partial class ServerTrustCertificate : global::Pulumi.CustomResource
    {
        ...
        public ServerTrustCertificate(string name, ServerTrustCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:ServerTrustCertificate", name, args ?? new ServerTrustCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerTrustCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:ServerTrustCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
