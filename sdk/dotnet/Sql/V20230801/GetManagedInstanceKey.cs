...
namespace Pulumi.AzureNative.Sql.V20230801
{
    public static class GetManagedInstanceKey
    {
        ...
        public static Task<GetManagedInstanceKeyResult> InvokeAsync(GetManagedInstanceKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagedInstanceKeyResult>("azure-native:sql/v20230801:getManagedInstanceKey", args ?? new GetManagedInstanceKeyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a managed instance key.
        /// </summary>
        public static Output<GetManagedInstanceKeyResult> Invoke(GetManagedInstanceKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagedInstanceKeyResult>("azure-native:sql/v20230801:getManagedInstanceKey", args ?? new GetManagedInstanceKeyInvokeArgs(), options.WithDefaults());
