...
namespace Pulumi.AzureNative.Sql.V20230801
{
    public static class GetElasticPool
    {
        ...
        public static Task<GetElasticPoolResult> InvokeAsync(GetElasticPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetElasticPoolResult>("azure-native:sql/v20230801:getElasticPool", args ?? new GetElasticPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an elastic pool.
        /// </summary>
        public static Output<GetElasticPoolResult> Invoke(GetElasticPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetElasticPoolResult>("azure-native:sql/v20230801:getElasticPool", args ?? new GetElasticPoolInvokeArgs(), options.WithDefaults());
