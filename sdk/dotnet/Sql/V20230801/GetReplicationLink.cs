...
namespace Pulumi.AzureNative.Sql.V20230801
{
    public static class GetReplicationLink
    {
        ...
        public static Task<GetReplicationLinkResult> InvokeAsync(GetReplicationLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReplicationLinkResult>("azure-native:sql/v20230801:getReplicationLink", args ?? new GetReplicationLinkArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a replication link.
        /// </summary>
        public static Output<GetReplicationLinkResult> Invoke(GetReplicationLinkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReplicationLinkResult>("azure-native:sql/v20230801:getReplicationLink", args ?? new GetReplicationLinkInvokeArgs(), options.WithDefaults());
