...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:ServerAdvisor")]
    public partial class ServerAdvisor : global::Pulumi.CustomResource
    {
        ...
        public ServerAdvisor(string name, ServerAdvisorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:ServerAdvisor", name, args ?? new ServerAdvisorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAdvisor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:ServerAdvisor", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerAdvisorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20230801.AutoExecuteStatus> AutoExecuteStatus { get; set; } = null!;
