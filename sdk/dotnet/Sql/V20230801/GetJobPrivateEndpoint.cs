...
namespace Pulumi.AzureNative.Sql.V20230801
{
    public static class GetJobPrivateEndpoint
    {
        ...
        public static Task<GetJobPrivateEndpointResult> InvokeAsync(GetJobPrivateEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobPrivateEndpointResult>("azure-native:sql/v20230801:getJobPrivateEndpoint", args ?? new GetJobPrivateEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a private endpoint.
        /// </summary>
        public static Output<GetJobPrivateEndpointResult> Invoke(GetJobPrivateEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobPrivateEndpointResult>("azure-native:sql/v20230801:getJobPrivateEndpoint", args ?? new GetJobPrivateEndpointInvokeArgs(), options.WithDefaults());
