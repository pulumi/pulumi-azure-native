...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:OutboundFirewallRule")]
    public partial class OutboundFirewallRule : global::Pulumi.CustomResource
    {
        ...
        public OutboundFirewallRule(string name, OutboundFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:OutboundFirewallRule", name, args ?? new OutboundFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OutboundFirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:OutboundFirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
