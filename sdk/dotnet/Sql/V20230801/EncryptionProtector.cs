...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:EncryptionProtector")]
    public partial class EncryptionProtector : global::Pulumi.CustomResource
    {
        ...
        public EncryptionProtector(string name, EncryptionProtectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:EncryptionProtector", name, args ?? new EncryptionProtectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EncryptionProtector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:EncryptionProtector", name, null, MakeResourceOptions(options, id))
        {
        }
