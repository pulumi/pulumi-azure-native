...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// An elastic pool.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:ElasticPool")]
    public partial class ElasticPool : global::Pulumi.CustomResource
    {
        ...
        public ElasticPool(string name, ElasticPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:ElasticPool", name, args ?? new ElasticPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ElasticPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:ElasticPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ElasticPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230801.AvailabilityZoneType>? AvailabilityZone { get; set; }
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230801.ElasticPoolLicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230801.AlwaysEncryptedEnclaveType>? PreferredEnclaveType { get; set; }
