...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:DataMaskingPolicy")]
    public partial class DataMaskingPolicy : global::Pulumi.CustomResource
    {
        ...
        public DataMaskingPolicy(string name, DataMaskingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:DataMaskingPolicy", name, args ?? new DataMaskingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataMaskingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:DataMaskingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataMaskingPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20230801.DataMaskingState> DataMaskingState { get; set; } = null!;
