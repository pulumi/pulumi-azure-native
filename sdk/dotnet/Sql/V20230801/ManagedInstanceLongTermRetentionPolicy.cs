...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:ManagedInstanceLongTermRetentionPolicy")]
    public partial class ManagedInstanceLongTermRetentionPolicy : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstanceLongTermRetentionPolicy(string name, ManagedInstanceLongTermRetentionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:ManagedInstanceLongTermRetentionPolicy", name, args ?? new ManagedInstanceLongTermRetentionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceLongTermRetentionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:ManagedInstanceLongTermRetentionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedInstanceLongTermRetentionPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230801.BackupStorageAccessTier>? BackupStorageAccessTier { get; set; }
