...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// A sensitivity label.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:SensitivityLabel")]
    public partial class SensitivityLabel : global::Pulumi.CustomResource
    {
        ...
        public SensitivityLabel(string name, SensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:SensitivityLabel", name, args ?? new SensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:SensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SensitivityLabelArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230801.ClientClassificationSource>? ClientClassificationSource { get; set; }
        ...
        [Input("rank")]
        public Input<Pulumi.AzureNative.Sql.V20230801.SensitivityLabelRank>? Rank { get; set; }
