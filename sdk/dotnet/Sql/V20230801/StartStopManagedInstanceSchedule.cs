...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:StartStopManagedInstanceSchedule")]
    public partial class StartStopManagedInstanceSchedule : global::Pulumi.CustomResource
    {
        ...
        public StartStopManagedInstanceSchedule(string name, StartStopManagedInstanceScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:StartStopManagedInstanceSchedule", name, args ?? new StartStopManagedInstanceScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StartStopManagedInstanceSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:StartStopManagedInstanceSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
