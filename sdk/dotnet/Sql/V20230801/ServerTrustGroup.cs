...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:ServerTrustGroup")]
    public partial class ServerTrustGroup : global::Pulumi.CustomResource
    {
        ...
        public ServerTrustGroup(string name, ServerTrustGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:ServerTrustGroup", name, args ?? new ServerTrustGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerTrustGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:ServerTrustGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerTrustGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Sql.V20230801.TrustScope>>? _trustScopes;

        /// <summary>
        /// Trust scope of the server trust group.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Sql.V20230801.TrustScope>> TrustScopes
        {
            get => _trustScopes ?? (_trustScopes = new InputList<Union<string, Pulumi.AzureNative.Sql.V20230801.TrustScope>>());
