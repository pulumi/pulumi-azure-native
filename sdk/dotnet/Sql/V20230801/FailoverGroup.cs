...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// A failover group.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:FailoverGroup")]
    public partial class FailoverGroup : global::Pulumi.CustomResource
    {
        ...
        public FailoverGroup(string name, FailoverGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:FailoverGroup", name, args ?? new FailoverGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FailoverGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:FailoverGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FailoverGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("secondaryType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230801.FailoverGroupDatabasesSecondaryType>? SecondaryType { get; set; }
