...
namespace Pulumi.AzureNative.Sql.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801:JobAgent")]
    public partial class JobAgent : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("identity")]
        public Output<Outputs.JobAgentIdentityResponse?> Identity { get; private set; } = null!;
        ...
        public JobAgent(string name, JobAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:JobAgent", name, args ?? new JobAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801:JobAgent", name, null, MakeResourceOptions(options, id))
        {
        }
