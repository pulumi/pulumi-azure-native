...
namespace Pulumi.AzureRM.Sql
{
    ...
    public partial class ServerFirewallRule : Pulumi.CustomResource
    {
        ...
        public ServerFirewallRule(string name, ServerFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql:ServerFirewallRule", name, args ?? new ServerFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ServerFirewallRule(string name, Input<string> id, ServerFirewallRuleState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:sql:ServerFirewallRule", name, state, MakeResourceOptions(options, id))
        {
        }
