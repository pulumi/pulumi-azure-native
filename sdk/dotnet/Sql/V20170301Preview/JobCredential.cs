...
namespace Pulumi.AzureNative.Sql.V20170301Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20170301preview:JobCredential is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobCredential to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20170301preview:JobCredential")]
    public partial class JobCredential : global::Pulumi.CustomResource
    {
        ...
        public JobCredential(string name, JobCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20170301preview:JobCredential", name, args ?? new JobCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20170301preview:JobCredential", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20211101:JobCredential"},
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20211101preview:JobCredential"},
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20220201preview:JobCredential"},
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20220501preview:JobCredential"},
