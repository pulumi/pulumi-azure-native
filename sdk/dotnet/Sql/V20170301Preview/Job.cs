...
namespace Pulumi.AzureNative.Sql.V20170301Preview
{
    ...
    public partial class Job : global::Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20170301preview:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20170301preview:Job", name, null, MakeResourceOptions(options, id))
        {
        }
