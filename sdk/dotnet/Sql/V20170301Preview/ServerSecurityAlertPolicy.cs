...
namespace Pulumi.AzureNative.Sql.V20170301Preview
{
    ...
    /// {
    ///     var serverSecurityAlertPolicy = new AzureNative.Sql.V20170301Preview.ServerSecurityAlertPolicy("serverSecurityAlertPolicy", new()
    ///     {
    ///         DisabledAlerts = new[]
    ///         {
    ///             "Access_Anomaly",
    ...
    ///         State = AzureNative.Sql.V20170301Preview.SecurityAlertPolicyState.Enabled,
    ...
    ///         SecurityAlertPolicyName = "Default",
    ///         ServerName = "securityalert-6440",
    ///         State = AzureNative.Sql.V20170301Preview.SecurityAlertPolicyState.Disabled,
    ///         StorageAccountAccessKey = "sdlfkjabc+sdlfkjsdlkfsjdfLDKFTERLKFDFKLjsdfksjdflsdkfD2342309432849328476458/3RSD==",
    ///         StorageEndpoint = "https://mystorage.blob.core.windows.net",
    ///     });
    /// 
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:sql/v20170301preview:ServerSecurityAlertPolicy Default /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/securityalert-4799/providers/Microsoft.Sql/servers/securityalert-6440/securityAlertPolicies/default 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20170301preview:ServerSecurityAlertPolicy")]
    public partial class ServerSecurityAlertPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServerSecurityAlertPolicy(string name, ServerSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20170301preview:ServerSecurityAlertPolicy", name, args ?? new ServerSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20170301preview:ServerSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerSecurityAlertPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20170301Preview.SecurityAlertPolicyState> State { get; set; } = null!;
