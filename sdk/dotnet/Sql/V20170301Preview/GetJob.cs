...
namespace Pulumi.AzureNative.Sql.V20170301Preview
{
    public static class GetJob
    {
        ...
        public static Task<GetJobResult> InvokeAsync(GetJobArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJobResult>("azure-native:sql/v20170301preview:getJob", args ?? new GetJobArgs(), options.WithVersion());

        /// <summary>
        /// A job.
        /// </summary>
        public static Output<GetJobResult> Invoke(GetJobInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetJobResult>("azure-native:sql/v20170301preview:getJob", args ?? new GetJobInvokeArgs(), options.WithVersion());
    }
