...
namespace Pulumi.AzureNextGen.Sql.V20170301Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:sql/v20170301preview:ManagedDatabase")]
    ...
    public sealed class ManagedDatabaseArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNextGen.Sql.V20170301Preview.ManagedDatabaseCreateMode>? CreateMode { get; set; }
