...
namespace Pulumi.AzureRM.Sql.V20170301Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedDatabase = new AzureRM.Sql.V20170301Preview.ManagedDatabase("managedDatabase", new AzureRM.Sql.V20170301Preview.ManagedDatabaseArgs
    ///         {
    ...
    public partial class ManagedDatabase : Pulumi.CustomResource
    {
        ...
        public ManagedDatabase(string name, ManagedDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/v20170301preview:ManagedDatabase", name, args ?? new ManagedDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/v20170301preview:ManagedDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
