...
namespace Pulumi.AzureNative.Sql.V20170301Preview
{
    public static class GetServerDnsAlias
    {
        ...
        public static Output<GetServerDnsAliasResult> Invoke(GetServerDnsAliasInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServerDnsAliasResult>("azure-native:sql/v20170301preview:getServerDnsAlias", args ?? new GetServerDnsAliasInvokeArgs(), options.WithVersion());
    }
