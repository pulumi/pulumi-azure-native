...
namespace Pulumi.AzureNative.Sql.V20210501Preview
{
    ...
    public static class GetInstancePool
    {
        ...
        public static Task<GetInstancePoolResult> InvokeAsync(GetInstancePoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInstancePoolResult>("azure-native:sql/v20210501preview:getInstancePool", args ?? new GetInstancePoolArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an instance pool.
        /// </summary>
        public static Output<GetInstancePoolResult> Invoke(GetInstancePoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInstancePoolResult>("azure-native:sql/v20210501preview:getInstancePool", args ?? new GetInstancePoolInvokeArgs(), options.WithDefaults());
    }
