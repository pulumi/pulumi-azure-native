...
namespace Pulumi.AzureNative.Sql.V20210501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210501preview:SyncMember is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncMember to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20210501preview:SyncMember")]
    public partial class SyncMember : global::Pulumi.CustomResource
    {
        ...
        public SyncMember(string name, SyncMemberArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:SyncMember", name, args ?? new SyncMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:SyncMember", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SyncMemberArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("databaseType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20210501Preview.SyncMemberDbType>? DatabaseType { get; set; }
        ...
        /// </summary>
        [Input("syncDirection")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20210501Preview.SyncDirection>? SyncDirection { get; set; }
