...
namespace Pulumi.AzureNative.Sql.V20210501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20210501preview:DatabaseBlobAuditingPolicy")]
    public partial class DatabaseBlobAuditingPolicy : Pulumi.CustomResource
    {
        ...
        public DatabaseBlobAuditingPolicy(string name, DatabaseBlobAuditingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:DatabaseBlobAuditingPolicy", name, args ?? new DatabaseBlobAuditingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseBlobAuditingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:DatabaseBlobAuditingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20210501preview:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20150501preview:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20150501preview:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20170301preview:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20170301preview:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20200202preview:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20200202preview:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20200801preview:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20200801preview:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20201101preview:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20201101preview:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-native:sql/v20210201preview:DatabaseBlobAuditingPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:sql/v20210201preview:DatabaseBlobAuditingPolicy"},
                },
            };
