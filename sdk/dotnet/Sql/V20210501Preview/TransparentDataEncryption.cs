...
namespace Pulumi.AzureNative.Sql.V20210501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210501preview:TransparentDataEncryption is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:TransparentDataEncryption to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20210501preview:TransparentDataEncryption")]
    public partial class TransparentDataEncryption : global::Pulumi.CustomResource
    {
        ...
        public TransparentDataEncryption(string name, TransparentDataEncryptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:TransparentDataEncryption", name, args ?? new TransparentDataEncryptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TransparentDataEncryption(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:TransparentDataEncryption", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TransparentDataEncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20210501Preview.TransparentDataEncryptionState> State { get; set; } = null!;
