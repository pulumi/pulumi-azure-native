...
namespace Pulumi.AzureNative.Sql.V20210501Preview
{
    ...
    [AzureNativeResourceType("azure-native:sql/v20210501preview:WorkloadClassifier")]
    public partial class WorkloadClassifier : global::Pulumi.CustomResource
    {
        ...
        public WorkloadClassifier(string name, WorkloadClassifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:WorkloadClassifier", name, args ?? new WorkloadClassifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadClassifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:WorkloadClassifier", name, null, MakeResourceOptions(options, id))
        {
        }
