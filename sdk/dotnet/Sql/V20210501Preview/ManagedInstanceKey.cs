...
namespace Pulumi.AzureNative.Sql.V20210501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20210501preview:ManagedInstanceKey")]
    public partial class ManagedInstanceKey : Pulumi.CustomResource
    {
        ...
        public ManagedInstanceKey(string name, ManagedInstanceKeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:ManagedInstanceKey", name, args ?? new ManagedInstanceKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:ManagedInstanceKey", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedInstanceKeyArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20210501Preview.ServerKeyType> ServerKeyType { get; set; } = null!;
