...
namespace Pulumi.AzureNative.Sql.V20210501Preview
{
    public static class GetServerTrustCertificate
    {
        ...
        public static Task<GetServerTrustCertificateResult> InvokeAsync(GetServerTrustCertificateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerTrustCertificateResult>("azure-native:sql/v20210501preview:getServerTrustCertificate", args ?? new GetServerTrustCertificateArgs(), options.WithVersion());
        ...
        public static Output<GetServerTrustCertificateResult> Invoke(GetServerTrustCertificateInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServerTrustCertificateResult>("azure-native:sql/v20210501preview:getServerTrustCertificate", args ?? new GetServerTrustCertificateInvokeArgs(), options.WithVersion());
    }
