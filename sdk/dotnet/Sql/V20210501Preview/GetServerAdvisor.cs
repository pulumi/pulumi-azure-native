...
{
    [Obsolete(@"azure-native:sql/v20210501preview:ServerAdvisor is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerAdvisor to guarantee forwards compatibility.")]
    public static class GetServerAdvisor
    {
        ...
        public static Task<GetServerAdvisorResult> InvokeAsync(GetServerAdvisorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerAdvisorResult>("azure-native:sql/v20210501preview:getServerAdvisor", args ?? new GetServerAdvisorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a server advisor.
        /// </summary>
        public static Output<GetServerAdvisorResult> Invoke(GetServerAdvisorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServerAdvisorResult>("azure-native:sql/v20210501preview:getServerAdvisor", args ?? new GetServerAdvisorInvokeArgs(), options.WithDefaults());
    }
