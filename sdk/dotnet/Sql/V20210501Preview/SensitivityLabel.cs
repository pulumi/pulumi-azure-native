...
namespace Pulumi.AzureNative.Sql.V20210501Preview
{
    ...
    /// A sensitivity label.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20210501preview:SensitivityLabel")]
    public partial class SensitivityLabel : global::Pulumi.CustomResource
    {
        ...
        public SensitivityLabel(string name, SensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:SensitivityLabel", name, args ?? new SensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:SensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
