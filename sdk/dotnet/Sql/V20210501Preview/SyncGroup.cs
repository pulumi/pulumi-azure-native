...
namespace Pulumi.AzureNative.Sql.V20210501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210501preview:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20210501preview:SyncGroup")]
    public partial class SyncGroup : global::Pulumi.CustomResource
    {
        ...
        public SyncGroup(string name, SyncGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:SyncGroup", name, args ?? new SyncGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210501preview:SyncGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SyncGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20210501Preview.SyncConflictResolutionPolicy>? ConflictResolutionPolicy { get; set; }
