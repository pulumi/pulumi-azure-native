...
namespace Pulumi.AzureNative.Sql.V20210201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210201preview:ManagedInstanceAzureADOnlyAuthentication is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceAzureADOnlyAuthentication to guarantee forwards compatibility.")]
    ...
    public partial class ManagedInstanceAzureADOnlyAuthentication : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstanceAzureADOnlyAuthentication(string name, ManagedInstanceAzureADOnlyAuthenticationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:ManagedInstanceAzureADOnlyAuthentication", name, args ?? new ManagedInstanceAzureADOnlyAuthenticationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceAzureADOnlyAuthentication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:ManagedInstanceAzureADOnlyAuthentication", name, null, MakeResourceOptions(options, id))
        {
        }
