...
namespace Pulumi.AzureNative.Sql.V20210201Preview
{
    ...
    /// A job.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20210201preview:Job")]
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:Job", name, null, MakeResourceOptions(options, id))
        {
        }
