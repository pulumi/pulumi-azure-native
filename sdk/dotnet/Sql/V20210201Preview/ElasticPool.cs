...
namespace Pulumi.AzureNative.Sql.V20210201Preview
{
    ...
    /// An elastic pool.
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210201preview:ElasticPool is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ElasticPool to guarantee forwards compatibility.")]
