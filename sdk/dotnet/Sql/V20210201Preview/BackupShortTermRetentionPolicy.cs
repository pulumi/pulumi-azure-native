...
namespace Pulumi.AzureNative.Sql.V20210201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210201preview:BackupShortTermRetentionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:BackupShortTermRetentionPolicy to guarantee forwards compatibility.")]
    ...
    public partial class BackupShortTermRetentionPolicy : global::Pulumi.CustomResource
    {
        ...
        public BackupShortTermRetentionPolicy(string name, BackupShortTermRetentionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:BackupShortTermRetentionPolicy", name, args ?? new BackupShortTermRetentionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupShortTermRetentionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:BackupShortTermRetentionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
