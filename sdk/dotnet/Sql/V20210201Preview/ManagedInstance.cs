...
namespace Pulumi.AzureNative.Sql.V20210201Preview
{
    ...
    /// {
    ///     var managedInstance = new AzureNative.Sql.V20210201Preview.ManagedInstance("managedInstance", new()
    ///     {
    ///         AdministratorLogin = "dummylogin",
    ///         AdministratorLoginPassword = "PLACEHOLDER",
    ///         Administrators = new AzureNative.Sql.V20210201Preview.Inputs.ManagedInstanceExternalAdministratorArgs
    ///         {
    ...
    ///         Sku = new AzureNative.Sql.V20210201Preview.Inputs.SkuArgs
    ///         {
    ///             Name = "GP_Gen5",
    ///             Tier = "GeneralPurpose",
    ///         },
    ...
    public partial class ManagedInstance : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstance(string name, ManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:ManagedInstance", name, args ?? new ManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:ManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedInstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20210201Preview.ManagedInstanceLicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20210201Preview.ManagedServerCreateMode>? ManagedInstanceCreateMode { get; set; }
        ...
        /// </summary>
        [Input("proxyOverride")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20210201Preview.ManagedInstanceProxyOverride>? ProxyOverride { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20210201Preview.StorageAccountType>? StorageAccountType { get; set; }
