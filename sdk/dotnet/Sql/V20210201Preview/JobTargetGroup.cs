...
namespace Pulumi.AzureNative.Sql.V20210201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20210201preview:JobTargetGroup")]
    public partial class JobTargetGroup : global::Pulumi.CustomResource
    {
        ...
        public JobTargetGroup(string name, JobTargetGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:JobTargetGroup", name, args ?? new JobTargetGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobTargetGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:JobTargetGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230201preview:JobTargetGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230501preview:JobTargetGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801preview:JobTargetGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20240501preview:JobTargetGroup" },
                },
            };
