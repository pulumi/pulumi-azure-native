...
{
    [Obsolete(@"azure-native:sql/v20210201preview:JobStep is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobStep to guarantee forwards compatibility.")]
    public static class GetJobStep
    {
        ...
        public static Task<GetJobStepResult> InvokeAsync(GetJobStepArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobStepResult>("azure-native:sql/v20210201preview:getJobStep", args ?? new GetJobStepArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a job step in a job's current version.
        /// </summary>
        public static Output<GetJobStepResult> Invoke(GetJobStepInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobStepResult>("azure-native:sql/v20210201preview:getJobStep", args ?? new GetJobStepInvokeArgs(), options.WithDefaults());
    }
