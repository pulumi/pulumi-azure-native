...
namespace Pulumi.AzureNative.Sql.V20210201Preview
{
    ...
    /// A sensitivity label.
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210201preview:ManagedDatabaseSensitivityLabel is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedDatabaseSensitivityLabel to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20210201preview:ManagedDatabaseSensitivityLabel")]
    public partial class ManagedDatabaseSensitivityLabel : global::Pulumi.CustomResource
    {
        ...
        public ManagedDatabaseSensitivityLabel(string name, ManagedDatabaseSensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:ManagedDatabaseSensitivityLabel", name, args ?? new ManagedDatabaseSensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedDatabaseSensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:ManagedDatabaseSensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20200202preview:ManagedDatabaseSensitivityLabel"},
    ...
    public sealed class ManagedDatabaseSensitivityLabelArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("rank")]
        public Input<Pulumi.AzureNative.Sql.V20210201Preview.SensitivityLabelRank>? Rank { get; set; }
