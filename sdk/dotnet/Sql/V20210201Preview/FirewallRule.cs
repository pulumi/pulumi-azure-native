...
namespace Pulumi.AzureNative.Sql.V20210201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sql/v20210201preview:FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:FirewallRule to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sql/v20210201preview:FirewallRule")]
    public partial class FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20210201preview:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
