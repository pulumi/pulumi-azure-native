...
namespace Pulumi.AzureNextGen.Sql.V20190601Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:sql/v20190601preview:SyncMember")]
    ...
    public sealed class SyncMemberArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("databaseType")]
        public InputUnion<string, Pulumi.AzureNextGen.Sql.V20190601Preview.SyncMemberDbType>? DatabaseType { get; set; }
        ...
        /// </summary>
        [Input("syncDirection")]
        public InputUnion<string, Pulumi.AzureNextGen.Sql.V20190601Preview.SyncDirection>? SyncDirection { get; set; }
