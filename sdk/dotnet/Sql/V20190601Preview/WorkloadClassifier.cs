...
namespace Pulumi.AzureNative.Sql.V20190601Preview
{
    ...
    public partial class WorkloadClassifier : Pulumi.CustomResource
    {
        ...
        public WorkloadClassifier(string name, WorkloadClassifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20190601preview:WorkloadClassifier", name, args ?? new WorkloadClassifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadClassifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20190601preview:WorkloadClassifier", name, null, MakeResourceOptions(options, id))
        {
        }
