...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var syncGroup = new AzureRM.Sql.Latest.SyncGroup("syncGroup", new AzureRM.Sql.Latest.SyncGroupArgs
    ///         {
    ...
    public partial class SyncGroup : Pulumi.CustomResource
    {
        ...
        public SyncGroup(string name, SyncGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:SyncGroup", name, args ?? new SyncGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:SyncGroup", name, null, MakeResourceOptions(options, id))
        {
        }
