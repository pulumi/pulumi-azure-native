...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:sql:getDataMaskingPolicy'.")]
    public static class GetDataMaskingPolicy
    {
        ...
        public static Task<GetDataMaskingPolicyResult> InvokeAsync(GetDataMaskingPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataMaskingPolicyResult>("azure-native:sql/latest:getDataMaskingPolicy", args ?? new GetDataMaskingPolicyArgs(), options.WithVersion());
    }
