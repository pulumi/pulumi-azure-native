...
namespace Pulumi.AzureNative.Sql.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:sql:ServerAzureADAdministrator'.")]
    [AzureNativeResourceType("azure-native:sql/latest:ServerAzureADAdministrator")]
    public partial class ServerAzureADAdministrator : Pulumi.CustomResource
    {
        ...
        public ServerAzureADAdministrator(string name, ServerAzureADAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/latest:ServerAzureADAdministrator", name, args ?? new ServerAzureADAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAzureADAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/latest:ServerAzureADAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerAzureADAdministratorArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.Latest.AdministratorType> AdministratorType { get; set; } = null!;
