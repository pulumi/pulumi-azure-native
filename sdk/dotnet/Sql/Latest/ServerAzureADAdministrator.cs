...
namespace Pulumi.AzureNextGen.Sql.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:sql:ServerAzureADAdministrator'.")]
    [AzureNextGenResourceType("azure-nextgen:sql/latest:ServerAzureADAdministrator")]
    public partial class ServerAzureADAdministrator : Pulumi.CustomResource
    {
        ...
        public ServerAzureADAdministrator(string name, ServerAzureADAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/latest:ServerAzureADAdministrator", name, args ?? new ServerAzureADAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAzureADAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:sql/latest:ServerAzureADAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
