...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedInstance = new AzureRM.Sql.Latest.ManagedInstance("managedInstance", new AzureRM.Sql.Latest.ManagedInstanceArgs
    ///         {
    ...
    public partial class ManagedInstance : Pulumi.CustomResource
    {
        ...
        public ManagedInstance(string name, ManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ManagedInstance", name, args ?? new ManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
