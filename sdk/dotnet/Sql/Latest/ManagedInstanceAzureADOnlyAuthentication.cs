...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedInstanceAzureADOnlyAuthentication = new AzureRM.Sql.Latest.ManagedInstanceAzureADOnlyAuthentication("managedInstanceAzureADOnlyAuthentication", new AzureRM.Sql.Latest.ManagedInstanceAzureADOnlyAuthenticationArgs
    ///         {
    ...
    public partial class ManagedInstanceAzureADOnlyAuthentication : Pulumi.CustomResource
    {
        ...
        public ManagedInstanceAzureADOnlyAuthentication(string name, ManagedInstanceAzureADOnlyAuthenticationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ManagedInstanceAzureADOnlyAuthentication", name, args ?? new ManagedInstanceAzureADOnlyAuthenticationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceAzureADOnlyAuthentication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ManagedInstanceAzureADOnlyAuthentication", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:sql/v20200202preview:ManagedInstanceAzureADOnlyAuthentication"},
                },
            };
