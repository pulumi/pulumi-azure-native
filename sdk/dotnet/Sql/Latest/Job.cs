...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var job = new AzureRM.Sql.Latest.Job("job", new AzureRM.Sql.Latest.JobArgs
    ///         {
    ///             Description = "my favourite job",
    ///             JobAgentName = "agent1",
    ///             JobName = "job1",
    ///             ResourceGroupName = "group1",
    ///             Schedule = new AzureRM.Sql.Latest.Inputs.JobScheduleArgs
    ///             {
    ///                 Enabled = true,
    ...
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:Job", name, null, MakeResourceOptions(options, id))
        {
        }
