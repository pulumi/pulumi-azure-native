...
namespace Pulumi.AzureRM.Sql.Latest
{
    public static class GetJobTargetGroup
    {
        public static Task<GetJobTargetGroupResult> InvokeAsync(GetJobTargetGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJobTargetGroupResult>("azurerm:sql/latest:getJobTargetGroup", args ?? new GetJobTargetGroupArgs(), options.WithVersion());
    }
