...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serverAzureADOnlyAuthentication = new AzureRM.Sql.Latest.ServerAzureADOnlyAuthentication("serverAzureADOnlyAuthentication", new AzureRM.Sql.Latest.ServerAzureADOnlyAuthenticationArgs
    ///         {
    ...
    public partial class ServerAzureADOnlyAuthentication : Pulumi.CustomResource
    {
        ...
        public ServerAzureADOnlyAuthentication(string name, ServerAzureADOnlyAuthenticationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ServerAzureADOnlyAuthentication", name, args ?? new ServerAzureADOnlyAuthenticationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAzureADOnlyAuthentication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ServerAzureADOnlyAuthentication", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:sql/v20200202preview:ServerAzureADOnlyAuthentication"},
                },
            };
