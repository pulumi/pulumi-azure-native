...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var syncMember = new AzureRM.Sql.Latest.SyncMember("syncMember", new AzureRM.Sql.Latest.SyncMemberArgs
    ///         {
    ...
    public partial class SyncMember : Pulumi.CustomResource
    {
        ...
        public SyncMember(string name, SyncMemberArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:SyncMember", name, args ?? new SyncMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:SyncMember", name, null, MakeResourceOptions(options, id))
        {
        }
