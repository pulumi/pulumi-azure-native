...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var instancePool = new AzureRM.Sql.Latest.InstancePool("instancePool", new AzureRM.Sql.Latest.InstancePoolArgs
    ///         {
    ...
    public partial class InstancePool : Pulumi.CustomResource
    {
        ...
        public InstancePool(string name, InstancePoolArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:InstancePool", name, args ?? new InstancePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstancePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:InstancePool", name, null, MakeResourceOptions(options, id))
        {
        }
