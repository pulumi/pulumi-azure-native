...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var jobAgent = new AzureRM.Sql.Latest.JobAgent("jobAgent", new AzureRM.Sql.Latest.JobAgentArgs
    ///         {
    ...
    public partial class JobAgent : Pulumi.CustomResource
    {
        ...
        public JobAgent(string name, JobAgentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:JobAgent", name, args ?? new JobAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:JobAgent", name, null, MakeResourceOptions(options, id))
        {
        }
