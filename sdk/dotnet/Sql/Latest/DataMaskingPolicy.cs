...
namespace Pulumi.AzureNative.Sql.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:sql:DataMaskingPolicy'.")]
    [AzureNativeResourceType("azure-native:sql/latest:DataMaskingPolicy")]
    public partial class DataMaskingPolicy : Pulumi.CustomResource
    {
        ...
        public DataMaskingPolicy(string name, DataMaskingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/latest:DataMaskingPolicy", name, args ?? new DataMaskingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataMaskingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/latest:DataMaskingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataMaskingPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.Latest.DataMaskingState> DataMaskingState { get; set; } = null!;
