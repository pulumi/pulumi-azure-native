...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedDatabaseSensitivityLabel = new AzureRM.Sql.Latest.ManagedDatabaseSensitivityLabel("managedDatabaseSensitivityLabel", new AzureRM.Sql.Latest.ManagedDatabaseSensitivityLabelArgs
    ///         {
    ///             ColumnName = "myColumn",
    ...
    public partial class ManagedDatabaseSensitivityLabel : Pulumi.CustomResource
    {
        ...
        public ManagedDatabaseSensitivityLabel(string name, ManagedDatabaseSensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ManagedDatabaseSensitivityLabel", name, args ?? new ManagedDatabaseSensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedDatabaseSensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ManagedDatabaseSensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
