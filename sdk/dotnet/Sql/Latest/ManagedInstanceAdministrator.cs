...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedInstanceAdministrator = new AzureRM.Sql.Latest.ManagedInstanceAdministrator("managedInstanceAdministrator", new AzureRM.Sql.Latest.ManagedInstanceAdministratorArgs
    ///         {
    ...
    public partial class ManagedInstanceAdministrator : Pulumi.CustomResource
    {
        ...
        public ManagedInstanceAdministrator(string name, ManagedInstanceAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ManagedInstanceAdministrator", name, args ?? new ManagedInstanceAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ManagedInstanceAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:sql/v20170301preview:ManagedInstanceAdministrator"},
                },
            };
