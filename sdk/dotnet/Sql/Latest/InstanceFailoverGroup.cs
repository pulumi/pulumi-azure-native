...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var instanceFailoverGroup = new AzureRM.Sql.Latest.InstanceFailoverGroup("instanceFailoverGroup", new AzureRM.Sql.Latest.InstanceFailoverGroupArgs
    ///         {
    ///             FailoverGroupName = "failover-group-test-3",
    ///             LocationName = "Japan East",
    ///             ManagedInstancePairs = 
    ///             {
    ///                 new AzureRM.Sql.Latest.Inputs.ManagedInstancePairInfoArgs
    ///                 {
    ...
    ///             PartnerRegions = 
    ///             {
    ///                 new AzureRM.Sql.Latest.Inputs.PartnerRegionInfoArgs
    ///                 {
    ///                     Location = "Japan West",
    ///                 },
    ///             },
    ///             ReadOnlyEndpoint = new AzureRM.Sql.Latest.Inputs.InstanceFailoverGroupReadOnlyEndpointArgs
    ///             {
    ///                 FailoverPolicy = "Disabled",
    ///             },
    ///             ReadWriteEndpoint = new AzureRM.Sql.Latest.Inputs.InstanceFailoverGroupReadWriteEndpointArgs
    ///             {
    ...
    public partial class InstanceFailoverGroup : Pulumi.CustomResource
    {
        ...
        public InstanceFailoverGroup(string name, InstanceFailoverGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:InstanceFailoverGroup", name, args ?? new InstanceFailoverGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceFailoverGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:InstanceFailoverGroup", name, null, MakeResourceOptions(options, id))
        {
        }
