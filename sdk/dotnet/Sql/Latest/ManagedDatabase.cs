...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedDatabase = new AzureRM.Sql.Latest.ManagedDatabase("managedDatabase", new AzureRM.Sql.Latest.ManagedDatabaseArgs
    ///         {
    ...
    public partial class ManagedDatabase : Pulumi.CustomResource
    {
        ...
        public ManagedDatabase(string name, ManagedDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ManagedDatabase", name, args ?? new ManagedDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ManagedDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
