...
namespace Pulumi.AzureRM.Sql.Latest
{
    public static class GetManagedInstanceKey
    {
        public static Task<GetManagedInstanceKeyResult> InvokeAsync(GetManagedInstanceKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedInstanceKeyResult>("azurerm:sql/latest:getManagedInstanceKey", args ?? new GetManagedInstanceKeyArgs(), options.WithVersion());
    }
