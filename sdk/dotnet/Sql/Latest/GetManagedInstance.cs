...
namespace Pulumi.AzureRM.Sql.Latest
{
    public static class GetManagedInstance
    {
        public static Task<GetManagedInstanceResult> InvokeAsync(GetManagedInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedInstanceResult>("azurerm:sql/latest:getManagedInstance", args ?? new GetManagedInstanceArgs(), options.WithVersion());
    }
