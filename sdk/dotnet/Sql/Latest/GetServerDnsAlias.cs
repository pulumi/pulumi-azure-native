...
namespace Pulumi.AzureRM.Sql.Latest
{
    public static class GetServerDnsAlias
    {
        public static Task<GetServerDnsAliasResult> InvokeAsync(GetServerDnsAliasArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerDnsAliasResult>("azurerm:sql/latest:getServerDnsAlias", args ?? new GetServerDnsAliasArgs(), options.WithVersion());
    }
