...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sensitivityLabel = new AzureRM.Sql.Latest.SensitivityLabel("sensitivityLabel", new AzureRM.Sql.Latest.SensitivityLabelArgs
    ///         {
    ///             ColumnName = "myColumn",
    ...
    public partial class SensitivityLabel : Pulumi.CustomResource
    {
        ...
        public SensitivityLabel(string name, SensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:SensitivityLabel", name, args ?? new SensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:SensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:sql/v20170301preview:SensitivityLabel"},
                },
            };
