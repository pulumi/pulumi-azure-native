...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serverKey = new AzureRM.Sql.Latest.ServerKey("serverKey", new AzureRM.Sql.Latest.ServerKeyArgs
    ///         {
    ...
    public partial class ServerKey : Pulumi.CustomResource
    {
        ...
        public ServerKey(string name, ServerKeyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ServerKey", name, args ?? new ServerKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ServerKey", name, null, MakeResourceOptions(options, id))
        {
        }
