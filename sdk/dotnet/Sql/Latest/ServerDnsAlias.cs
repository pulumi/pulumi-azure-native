...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serverDnsAlias = new AzureRM.Sql.Latest.ServerDnsAlias("serverDnsAlias", new AzureRM.Sql.Latest.ServerDnsAliasArgs
    ///         {
    ...
    public partial class ServerDnsAlias : Pulumi.CustomResource
    {
        ...
        public ServerDnsAlias(string name, ServerDnsAliasArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ServerDnsAlias", name, args ?? new ServerDnsAliasArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerDnsAlias(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:ServerDnsAlias", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:sql/v20170301preview:ServerDnsAlias"},
                },
            };
