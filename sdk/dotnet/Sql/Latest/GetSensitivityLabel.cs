...
namespace Pulumi.AzureRM.Sql.Latest
{
    public static class GetSensitivityLabel
    {
        public static Task<GetSensitivityLabelResult> InvokeAsync(GetSensitivityLabelArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSensitivityLabelResult>("azurerm:sql/latest:getSensitivityLabel", args ?? new GetSensitivityLabelArgs(), options.WithVersion());
    }
