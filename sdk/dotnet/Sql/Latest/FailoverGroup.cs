...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var failoverGroup = new AzureRM.Sql.Latest.FailoverGroup("failoverGroup", new AzureRM.Sql.Latest.FailoverGroupArgs
    ///         {
    ///             Databases = 
    ///             {
    ...
    ///             PartnerServers = 
    ///             {
    ///                 new AzureRM.Sql.Latest.Inputs.PartnerInfoArgs
    ///                 {
    ///                     Id = "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.Sql/servers/failover-group-secondary-server",
    ///                 },
    ///             },
    ///             ReadOnlyEndpoint = new AzureRM.Sql.Latest.Inputs.FailoverGroupReadOnlyEndpointArgs
    ///             {
    ///                 FailoverPolicy = "Disabled",
    ///             },
    ///             ReadWriteEndpoint = new AzureRM.Sql.Latest.Inputs.FailoverGroupReadWriteEndpointArgs
    ///             {
    ...
    public partial class FailoverGroup : Pulumi.CustomResource
    {
        ...
        public FailoverGroup(string name, FailoverGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:FailoverGroup", name, args ?? new FailoverGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FailoverGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:FailoverGroup", name, null, MakeResourceOptions(options, id))
        {
        }
