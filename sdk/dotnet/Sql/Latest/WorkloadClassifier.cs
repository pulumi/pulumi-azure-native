...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workloadClassifier = new AzureRM.Sql.Latest.WorkloadClassifier("workloadClassifier", new AzureRM.Sql.Latest.WorkloadClassifierArgs
    ///         {
    ...
    public partial class WorkloadClassifier : Pulumi.CustomResource
    {
        ...
        public WorkloadClassifier(string name, WorkloadClassifierArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:WorkloadClassifier", name, args ?? new WorkloadClassifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadClassifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:WorkloadClassifier", name, null, MakeResourceOptions(options, id))
        {
        }
