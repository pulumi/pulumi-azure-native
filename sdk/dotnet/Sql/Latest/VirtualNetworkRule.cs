...
namespace Pulumi.AzureRM.Sql.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkRule = new AzureRM.Sql.Latest.VirtualNetworkRule("virtualNetworkRule", new AzureRM.Sql.Latest.VirtualNetworkRuleArgs
    ///         {
    ...
    public partial class VirtualNetworkRule : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkRule(string name, VirtualNetworkRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:VirtualNetworkRule", name, args ?? new VirtualNetworkRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/latest:VirtualNetworkRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:sql/v20150501preview:VirtualNetworkRule"},
                },
            };
