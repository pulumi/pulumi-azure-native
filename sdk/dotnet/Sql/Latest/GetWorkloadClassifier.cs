...
namespace Pulumi.AzureRM.Sql.Latest
{
    public static class GetWorkloadClassifier
    {
        public static Task<GetWorkloadClassifierResult> InvokeAsync(GetWorkloadClassifierArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkloadClassifierResult>("azurerm:sql/latest:getWorkloadClassifier", args ?? new GetWorkloadClassifierArgs(), options.WithVersion());
    }
