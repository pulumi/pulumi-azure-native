...
namespace Pulumi.AzureNative.Sql.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230501preview:ManagedInstanceLongTermRetentionPolicy")]
    public partial class ManagedInstanceLongTermRetentionPolicy : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstanceLongTermRetentionPolicy(string name, ManagedInstanceLongTermRetentionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:ManagedInstanceLongTermRetentionPolicy", name, args ?? new ManagedInstanceLongTermRetentionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceLongTermRetentionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:ManagedInstanceLongTermRetentionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
