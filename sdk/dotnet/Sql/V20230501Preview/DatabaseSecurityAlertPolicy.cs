...
namespace Pulumi.AzureNative.Sql.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230501preview:DatabaseSecurityAlertPolicy")]
    public partial class DatabaseSecurityAlertPolicy : global::Pulumi.CustomResource
    {
        ...
        public DatabaseSecurityAlertPolicy(string name, DatabaseSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:DatabaseSecurityAlertPolicy", name, args ?? new DatabaseSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:DatabaseSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
