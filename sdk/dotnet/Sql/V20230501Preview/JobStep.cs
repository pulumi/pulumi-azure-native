...
namespace Pulumi.AzureNative.Sql.V20230501Preview
{
    ...
    /// A job step.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230501preview:JobStep")]
    public partial class JobStep : global::Pulumi.CustomResource
    {
        ...
        public JobStep(string name, JobStepArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:JobStep", name, args ?? new JobStepArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobStep(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:JobStep", name, null, MakeResourceOptions(options, id))
        {
        }
