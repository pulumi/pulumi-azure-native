...
namespace Pulumi.AzureNative.Sql.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230501preview:DatabaseAdvisor")]
    public partial class DatabaseAdvisor : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAdvisor(string name, DatabaseAdvisorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:DatabaseAdvisor", name, args ?? new DatabaseAdvisorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAdvisor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:DatabaseAdvisor", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20210801preview:DatabaseAdvisor" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230201preview:DatabaseAdvisor" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801:DatabaseAdvisor" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801preview:DatabaseAdvisor" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20240501preview:DatabaseAdvisor" },
    ...
    public sealed class DatabaseAdvisorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20230501Preview.AutoExecuteStatus> AutoExecuteStatus { get; set; } = null!;
