...
namespace Pulumi.AzureNative.Sql.V20230501Preview
{
    ...
    /// A Geo backup policy.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230501preview:GeoBackupPolicy")]
    public partial class GeoBackupPolicy : global::Pulumi.CustomResource
    {
        ...
        public GeoBackupPolicy(string name, GeoBackupPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:GeoBackupPolicy", name, args ?? new GeoBackupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GeoBackupPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:GeoBackupPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230201preview:GeoBackupPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801:GeoBackupPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801preview:GeoBackupPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20240501preview:GeoBackupPolicy" },
    ...
    public sealed class GeoBackupPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20230501Preview.GeoBackupPolicyState> State { get; set; } = null!;
