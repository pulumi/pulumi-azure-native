...
namespace Pulumi.AzureNative.Sql.V20230501Preview.Inputs
{
    ...
    public sealed class ManagedInstanceExternalAdministratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230501Preview.AdministratorType>? AdministratorType { get; set; }
        ...
        /// </summary>
        [Input("principalType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230501Preview.PrincipalType>? PrincipalType { get; set; }
