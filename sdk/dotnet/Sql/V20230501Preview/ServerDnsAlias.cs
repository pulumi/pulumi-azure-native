...
namespace Pulumi.AzureNative.Sql.V20230501Preview
{
    ...
    /// A server DNS alias.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230501preview:ServerDnsAlias")]
    public partial class ServerDnsAlias : global::Pulumi.CustomResource
    {
        ...
        public ServerDnsAlias(string name, ServerDnsAliasArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:ServerDnsAlias", name, args ?? new ServerDnsAliasArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerDnsAlias(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:ServerDnsAlias", name, null, MakeResourceOptions(options, id))
        {
        }
