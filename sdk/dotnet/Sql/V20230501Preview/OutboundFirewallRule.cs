...
namespace Pulumi.AzureNative.Sql.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230501preview:OutboundFirewallRule")]
    public partial class OutboundFirewallRule : global::Pulumi.CustomResource
    {
        ...
        public OutboundFirewallRule(string name, OutboundFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:OutboundFirewallRule", name, args ?? new OutboundFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OutboundFirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:OutboundFirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801:OutboundFirewallRule" },
