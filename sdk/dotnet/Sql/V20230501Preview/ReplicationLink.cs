...
namespace Pulumi.AzureNative.Sql.V20230501Preview
{
    ...
    /// A replication link.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230501preview:ReplicationLink")]
    public partial class ReplicationLink : global::Pulumi.CustomResource
    {
        ...
        public ReplicationLink(string name, ReplicationLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:ReplicationLink", name, args ?? new ReplicationLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:ReplicationLink", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ReplicationLinkArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("linkType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230501Preview.ReplicationLinkType>? LinkType { get; set; }
