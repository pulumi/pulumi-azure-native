...
namespace Pulumi.AzureNative.Sql.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230501preview:JobAgent")]
    public partial class JobAgent : global::Pulumi.CustomResource
    {
        ...
        public JobAgent(string name, JobAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:JobAgent", name, args ?? new JobAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:JobAgent", name, null, MakeResourceOptions(options, id))
        {
        }
