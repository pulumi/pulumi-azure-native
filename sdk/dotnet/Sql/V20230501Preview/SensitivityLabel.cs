...
namespace Pulumi.AzureNative.Sql.V20230501Preview
{
    ...
    /// A sensitivity label.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230501preview:SensitivityLabel")]
    public partial class SensitivityLabel : global::Pulumi.CustomResource
    {
        [Output("clientClassificationSource")]
        public Output<string?> ClientClassificationSource { get; private set; } = null!;
        ...
        public SensitivityLabel(string name, SensitivityLabelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:SensitivityLabel", name, args ?? new SensitivityLabelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SensitivityLabel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230501preview:SensitivityLabel", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20201101preview:SensitivityLabel" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801:SensitivityLabel" },
    ...
    public sealed class SensitivityLabelArgs : global::Pulumi.ResourceArgs
    {
        [Input("clientClassificationSource")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230501Preview.ClientClassificationSource>? ClientClassificationSource { get; set; }
        ...
        [Input("rank")]
        public Input<Pulumi.AzureNative.Sql.V20230501Preview.SensitivityLabelRank>? Rank { get; set; }
        ...
        public static new SensitivityLabelArgs Empty => new SensitivityLabelArgs();
    }
}
