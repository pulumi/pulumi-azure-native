...
namespace Pulumi.AzureNextGen.Sql.V20171001Preview
{
    ...
    /// An elastic pool.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:sql/v20171001preview:ElasticPool")]
    ...
    public sealed class ElasticPoolArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNextGen.Sql.V20171001Preview.ElasticPoolLicenseType>? LicenseType { get; set; }
