...
namespace Pulumi.AzureRM.Sql.V20171001Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var database = new AzureRM.Sql.V20171001Preview.Database("database", new AzureRM.Sql.V20171001Preview.DatabaseArgs
    ///         {
    ///             DatabaseName = "testdb",
    ...
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sql/v20171001preview:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sql/v20171001preview:Database", name, null, MakeResourceOptions(options, id))
        {
        }
