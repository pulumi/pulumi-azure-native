...
namespace Pulumi.AzureNative.Sql.V20230801Preview
{
    public static class GetSensitivityLabel
    {
        ...
        public static Task<GetSensitivityLabelResult> InvokeAsync(GetSensitivityLabelArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSensitivityLabelResult>("azure-native:sql/v20230801preview:getSensitivityLabel", args ?? new GetSensitivityLabelArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the sensitivity label of a given column
        /// </summary>
        public static Output<GetSensitivityLabelResult> Invoke(GetSensitivityLabelInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSensitivityLabelResult>("azure-native:sql/v20230801preview:getSensitivityLabel", args ?? new GetSensitivityLabelInvokeArgs(), options.WithDefaults());
    }
