...
namespace Pulumi.AzureNative.Sql.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801preview:ManagedInstanceAdministrator")]
    public partial class ManagedInstanceAdministrator : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstanceAdministrator(string name, ManagedInstanceAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:ManagedInstanceAdministrator", name, args ?? new ManagedInstanceAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstanceAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:ManagedInstanceAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedInstanceAdministratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230801Preview.ManagedInstanceAdministratorType> AdministratorType { get; set; } = null!;
