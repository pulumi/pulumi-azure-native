...
namespace Pulumi.AzureNative.Sql.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801preview:TransparentDataEncryption")]
    public partial class TransparentDataEncryption : global::Pulumi.CustomResource
    {
        ...
        public TransparentDataEncryption(string name, TransparentDataEncryptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:TransparentDataEncryption", name, args ?? new TransparentDataEncryptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TransparentDataEncryption(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:TransparentDataEncryption", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TransparentDataEncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20230801Preview.TransparentDataEncryptionState> State { get; set; } = null!;
