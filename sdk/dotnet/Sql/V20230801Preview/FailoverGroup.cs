...
namespace Pulumi.AzureNative.Sql.V20230801Preview
{
    ...
    /// A failover group.
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801preview:FailoverGroup")]
    public partial class FailoverGroup : global::Pulumi.CustomResource
    {
        ...
        public FailoverGroup(string name, FailoverGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:FailoverGroup", name, args ?? new FailoverGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FailoverGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:FailoverGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:sql/v20230801:FailoverGroup" },
    ...
    public sealed class FailoverGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("secondaryType")]
        public InputUnion<string, Pulumi.AzureNative.Sql.V20230801Preview.FailoverGroupDatabasesSecondaryType>? SecondaryType { get; set; }
