...
namespace Pulumi.AzureNative.Sql.V20230801Preview
{
    public static class GetStartStopManagedInstanceSchedule
    {
        ...
        public static Task<GetStartStopManagedInstanceScheduleResult> InvokeAsync(GetStartStopManagedInstanceScheduleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStartStopManagedInstanceScheduleResult>("azure-native:sql/v20230801preview:getStartStopManagedInstanceSchedule", args ?? new GetStartStopManagedInstanceScheduleArgs(), options.WithDefaults());
        ...
        public static Output<GetStartStopManagedInstanceScheduleResult> Invoke(GetStartStopManagedInstanceScheduleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStartStopManagedInstanceScheduleResult>("azure-native:sql/v20230801preview:getStartStopManagedInstanceSchedule", args ?? new GetStartStopManagedInstanceScheduleInvokeArgs(), options.WithDefaults());
