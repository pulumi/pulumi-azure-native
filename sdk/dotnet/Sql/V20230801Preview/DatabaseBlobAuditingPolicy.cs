...
namespace Pulumi.AzureNative.Sql.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801preview:DatabaseBlobAuditingPolicy")]
    public partial class DatabaseBlobAuditingPolicy : global::Pulumi.CustomResource
    {
        ...
        public DatabaseBlobAuditingPolicy(string name, DatabaseBlobAuditingPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:DatabaseBlobAuditingPolicy", name, args ?? new DatabaseBlobAuditingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseBlobAuditingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:DatabaseBlobAuditingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseBlobAuditingPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20230801Preview.BlobAuditingPolicyState> State { get; set; } = null!;
