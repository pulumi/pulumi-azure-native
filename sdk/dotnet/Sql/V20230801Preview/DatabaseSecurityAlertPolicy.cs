...
namespace Pulumi.AzureNative.Sql.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801preview:DatabaseSecurityAlertPolicy")]
    public partial class DatabaseSecurityAlertPolicy : global::Pulumi.CustomResource
    {
        ...
        public DatabaseSecurityAlertPolicy(string name, DatabaseSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:DatabaseSecurityAlertPolicy", name, args ?? new DatabaseSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:DatabaseSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseSecurityAlertPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Sql.V20230801Preview.SecurityAlertsPolicyState> State { get; set; } = null!;
