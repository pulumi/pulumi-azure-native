...
namespace Pulumi.AzureNative.Sql.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801preview:ManagedInstancePrivateEndpointConnection")]
    public partial class ManagedInstancePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public ManagedInstancePrivateEndpointConnection(string name, ManagedInstancePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:ManagedInstancePrivateEndpointConnection", name, args ?? new ManagedInstancePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedInstancePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:ManagedInstancePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
