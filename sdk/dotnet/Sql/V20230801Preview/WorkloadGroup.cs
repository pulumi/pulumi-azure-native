...
namespace Pulumi.AzureNative.Sql.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sql/v20230801preview:WorkloadGroup")]
    public partial class WorkloadGroup : global::Pulumi.CustomResource
    {
        ...
        public WorkloadGroup(string name, WorkloadGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:WorkloadGroup", name, args ?? new WorkloadGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sql/v20230801preview:WorkloadGroup", name, null, MakeResourceOptions(options, id))
        {
        }
