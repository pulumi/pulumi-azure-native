...
namespace Pulumi.AzureNative.Sql.V20230801Preview
{
    public static class GetSyncMember
    {
        ...
        public static Task<GetSyncMemberResult> InvokeAsync(GetSyncMemberArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSyncMemberResult>("azure-native:sql/v20230801preview:getSyncMember", args ?? new GetSyncMemberArgs(), options.WithDefaults());
