...
namespace Pulumi.AzureNative.Sql
{
    public static class GetIPv6FirewallRule
    {
        ...
        public static Task<GetIPv6FirewallRuleResult> InvokeAsync(GetIPv6FirewallRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIPv6FirewallRuleResult>("azure-native:sql:getIPv6FirewallRule", args ?? new GetIPv6FirewallRuleArgs(), options.WithVersion());
        ...
        public static Output<GetIPv6FirewallRuleResult> Invoke(GetIPv6FirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIPv6FirewallRuleResult>("azure-native:sql:getIPv6FirewallRule", args ?? new GetIPv6FirewallRuleInvokeArgs(), options.WithVersion());
    }
