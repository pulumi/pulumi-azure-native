...
namespace Pulumi.AzureNative.ContainerRegistry.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20230701:ScopeMap")]
    public partial class ScopeMap : global::Pulumi.CustomResource
    {
        ...
        public ScopeMap(string name, ScopeMapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230701:ScopeMap", name, args ?? new ScopeMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230701:ScopeMap", name, null, MakeResourceOptions(options, id))
        {
        }
