...
namespace Pulumi.AzureNative.ContainerRegistry.V20230701
{
    public static class GetToken
    {
        ...
        public static Task<GetTokenResult> InvokeAsync(GetTokenArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTokenResult>("azure-native:containerregistry/v20230701:getToken", args ?? new GetTokenArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified token.
        /// </summary>
        public static Output<GetTokenResult> Invoke(GetTokenInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTokenResult>("azure-native:containerregistry/v20230701:getToken", args ?? new GetTokenInvokeArgs(), options.WithDefaults());
    }
