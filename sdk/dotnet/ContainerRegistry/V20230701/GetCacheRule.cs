...
namespace Pulumi.AzureNative.ContainerRegistry.V20230701
{
    public static class GetCacheRule
    {
        ...
        public static Task<GetCacheRuleResult> InvokeAsync(GetCacheRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCacheRuleResult>("azure-native:containerregistry/v20230701:getCacheRule", args ?? new GetCacheRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified cache rule resource.
        /// </summary>
        public static Output<GetCacheRuleResult> Invoke(GetCacheRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCacheRuleResult>("azure-native:containerregistry/v20230701:getCacheRule", args ?? new GetCacheRuleInvokeArgs(), options.WithDefaults());
