...
namespace Pulumi.AzureNative.ContainerRegistry.V20230701
{
    public static class GetCredentialSet
    {
        ...
        public static Task<GetCredentialSetResult> InvokeAsync(GetCredentialSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCredentialSetResult>("azure-native:containerregistry/v20230701:getCredentialSet", args ?? new GetCredentialSetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified credential set resource.
        /// </summary>
        public static Output<GetCredentialSetResult> Invoke(GetCredentialSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCredentialSetResult>("azure-native:containerregistry/v20230701:getCredentialSet", args ?? new GetCredentialSetInvokeArgs(), options.WithDefaults());
