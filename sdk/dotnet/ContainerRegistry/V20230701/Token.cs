...
namespace Pulumi.AzureNative.ContainerRegistry.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20230701:Token")]
    public partial class Token : global::Pulumi.CustomResource
    {
        ...
        public Token(string name, TokenArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230701:Token", name, args ?? new TokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Token(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230701:Token", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TokenArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20230701.TokenStatus>? Status { get; set; }
