...
namespace Pulumi.AzureNative.ContainerRegistry.V20230701
{
    public static class ListWebhookEvents
    {
        ...
        public static Task<ListWebhookEventsResult> InvokeAsync(ListWebhookEventsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListWebhookEventsResult>("azure-native:containerregistry/v20230701:listWebhookEvents", args ?? new ListWebhookEventsArgs(), options.WithDefaults());
