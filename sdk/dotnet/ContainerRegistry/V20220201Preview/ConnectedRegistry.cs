...
namespace Pulumi.AzureNative.ContainerRegistry.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:containerregistry/v20220201preview:ConnectedRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:ConnectedRegistry to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:containerregistry/v20220201preview:ConnectedRegistry")]
    public partial class ConnectedRegistry : global::Pulumi.CustomResource
    {
        ...
        public ConnectedRegistry(string name, ConnectedRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20220201preview:ConnectedRegistry", name, args ?? new ConnectedRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20220201preview:ConnectedRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectedRegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20220201Preview.ConnectedRegistryMode> Mode { get; set; } = null!;
