...
namespace Pulumi.AzureNative.ContainerRegistry.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:containerregistry/v20220201preview:ExportPipeline is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:ExportPipeline to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:containerregistry/v20220201preview:ExportPipeline")]
    public partial class ExportPipeline : global::Pulumi.CustomResource
    {
        ...
        public ExportPipeline(string name, ExportPipelineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20220201preview:ExportPipeline", name, args ?? new ExportPipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExportPipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20220201preview:ExportPipeline", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExportPipelineArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("options")]
        private InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20220201Preview.PipelineOptions>>? _options;

        /// <summary>
        /// The list of all options configured for the pipeline.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20220201Preview.PipelineOptions>> Options
        {
            get => _options ?? (_options = new InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20220201Preview.PipelineOptions>>());
            set => _options = value;
        }
