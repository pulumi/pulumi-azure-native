...
namespace Pulumi.AzureNative.ContainerRegistry.V20220201Preview
{
    ...
    public static class GetReplication
    {
        ...
        public static Task<GetReplicationResult> InvokeAsync(GetReplicationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReplicationResult>("azure-native:containerregistry/v20220201preview:getReplication", args ?? new GetReplicationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified replication.
        /// </summary>
        public static Output<GetReplicationResult> Invoke(GetReplicationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReplicationResult>("azure-native:containerregistry/v20220201preview:getReplication", args ?? new GetReplicationInvokeArgs(), options.WithDefaults());
    }
