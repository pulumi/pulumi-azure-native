...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    public static class ListTaskDetails
    {
        public static Task<ListTaskDetailsResult> InvokeAsync(ListTaskDetailsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListTaskDetailsResult>("azurerm:containerregistry/preview:listTaskDetails", args ?? new ListTaskDetailsArgs(), options.WithVersion());
    }
