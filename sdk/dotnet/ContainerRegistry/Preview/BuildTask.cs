...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    ...
    public partial class BuildTask : Pulumi.CustomResource
    {
        ...
        public BuildTask(string name, BuildTaskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/preview:BuildTask", name, args ?? new BuildTaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BuildTask(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/preview:BuildTask", name, null, MakeResourceOptions(options, id))
        {
        }
