...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    public static class ListWebhookEvents
    {
        public static Task<ListWebhookEventsResult> InvokeAsync(ListWebhookEventsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebhookEventsResult>("azurerm:containerregistry/preview:listWebhookEvents", args ?? new ListWebhookEventsArgs(), options.WithVersion());
    }
