...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    public static class ListAgentPoolQueueStatus
    {
        public static Task<ListAgentPoolQueueStatusResult> InvokeAsync(ListAgentPoolQueueStatusArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAgentPoolQueueStatusResult>("azurerm:containerregistry/preview:listAgentPoolQueueStatus", args ?? new ListAgentPoolQueueStatusArgs(), options.WithVersion());
    }
