...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    public static class GetPipelineRun
    {
        public static Task<GetPipelineRunResult> InvokeAsync(GetPipelineRunArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPipelineRunResult>("azurerm:containerregistry/preview:getPipelineRun", args ?? new GetPipelineRunArgs(), options.WithVersion());
    }
