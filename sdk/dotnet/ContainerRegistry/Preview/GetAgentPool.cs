...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    public static class GetAgentPool
    {
        public static Task<GetAgentPoolResult> InvokeAsync(GetAgentPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAgentPoolResult>("azurerm:containerregistry/preview:getAgentPool", args ?? new GetAgentPoolArgs(), options.WithVersion());
    }
