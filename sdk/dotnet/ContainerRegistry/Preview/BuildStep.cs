...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    ...
    public partial class BuildStep : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.BuildStepPropertiesResponseResult> Properties { get; private set; } = null!;
        ...
        public BuildStep(string name, BuildStepArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/preview:BuildStep", name, args ?? new BuildStepArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BuildStep(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/preview:BuildStep", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:containerregistry/v20180201preview:BuildStep"},
                },
            };
