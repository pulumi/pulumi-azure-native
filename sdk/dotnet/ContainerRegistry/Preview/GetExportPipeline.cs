...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    public static class GetExportPipeline
    {
        public static Task<GetExportPipelineResult> InvokeAsync(GetExportPipelineArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExportPipelineResult>("azurerm:containerregistry/preview:getExportPipeline", args ?? new GetExportPipelineArgs(), options.WithVersion());
    }
