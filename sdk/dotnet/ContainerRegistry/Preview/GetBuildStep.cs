...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    public static class GetBuildStep
    {
        public static Task<GetBuildStepResult> InvokeAsync(GetBuildStepArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBuildStepResult>("azurerm:containerregistry/preview:getBuildStep", args ?? new GetBuildStepArgs(), options.WithVersion());
    }
