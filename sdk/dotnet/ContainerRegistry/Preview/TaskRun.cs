...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    ...
    public partial class TaskRun : Pulumi.CustomResource
    {
        ...
        public TaskRun(string name, TaskRunArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/preview:TaskRun", name, args ?? new TaskRunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TaskRun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/preview:TaskRun", name, null, MakeResourceOptions(options, id))
        {
        }
