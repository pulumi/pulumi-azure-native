...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    public static class GetBuildTask
    {
        public static Task<GetBuildTaskResult> InvokeAsync(GetBuildTaskArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBuildTaskResult>("azurerm:containerregistry/preview:getBuildTask", args ?? new GetBuildTaskArgs(), options.WithVersion());
    }
