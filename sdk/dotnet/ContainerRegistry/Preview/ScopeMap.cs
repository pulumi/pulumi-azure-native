...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    ...
    public partial class ScopeMap : Pulumi.CustomResource
    {
        ...
        public ScopeMap(string name, ScopeMapArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/preview:ScopeMap", name, args ?? new ScopeMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/preview:ScopeMap", name, null, MakeResourceOptions(options, id))
        {
        }
