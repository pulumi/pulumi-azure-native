...
namespace Pulumi.AzureRM.ContainerRegistry.Preview
{
    public static class GetReplication
    {
        public static Task<GetReplicationResult> InvokeAsync(GetReplicationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationResult>("azurerm:containerregistry/preview:getReplication", args ?? new GetReplicationArgs(), options.WithVersion());
    }
