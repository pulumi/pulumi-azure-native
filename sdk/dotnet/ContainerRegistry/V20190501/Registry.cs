...
namespace Pulumi.AzureNative.ContainerRegistry.V20190501
{
    ...
    /// {
    ///     var registry = new AzureNative.ContainerRegistry.V20190501.Registry("registry", new()
    ///     {
    ///         AdminUserEnabled = true,
    ///         Location = "westus",
    ///         RegistryName = "myRegistry",
    ///         ResourceGroupName = "myResourceGroup",
    ///         Sku = new AzureNative.ContainerRegistry.V20190501.Inputs.SkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ///         Tags = 
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20190501:Registry")]
    public partial class Registry : global::Pulumi.CustomResource
    {
        ...
        public Registry(string name, RegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20190501:Registry", name, args ?? new RegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20190501:Registry", name, null, MakeResourceOptions(options, id))
        {
        }
