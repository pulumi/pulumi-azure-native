...
namespace Pulumi.AzureNative.ContainerRegistry.V20190501.Inputs
{
    ...
    public sealed class TrustPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20190501.PolicyStatus>? Status { get; set; }

        /// <summary>
        /// The type of trust policy.
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20190501.TrustPolicyType>? Type { get; set; }
