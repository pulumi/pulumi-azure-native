...
namespace Pulumi.AzureNative.ContainerRegistry.V20221201
{
    ...
    [AzureNativeResourceType("azure-native:containerregistry/v20221201:Registry")]
    public partial class Registry : global::Pulumi.CustomResource
    {
        ...
        public Registry(string name, RegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20221201:Registry", name, args ?? new RegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20221201:Registry", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20221201.NetworkRuleBypassOptions>? NetworkRuleBypassOptions { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20221201.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
