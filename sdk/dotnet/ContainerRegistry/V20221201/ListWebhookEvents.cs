...
namespace Pulumi.AzureNative.ContainerRegistry.V20221201
{
    public static class ListWebhookEvents
    {
        ...
        public static Task<ListWebhookEventsResult> InvokeAsync(ListWebhookEventsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListWebhookEventsResult>("azure-native:containerregistry/v20221201:listWebhookEvents", args ?? new ListWebhookEventsArgs(), options.WithDefaults());

        /// <summary>
        /// Lists recent events for the specified webhook.
        /// </summary>
        public static Output<ListWebhookEventsResult> Invoke(ListWebhookEventsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListWebhookEventsResult>("azure-native:containerregistry/v20221201:listWebhookEvents", args ?? new ListWebhookEventsInvokeArgs(), options.WithDefaults());
    }
