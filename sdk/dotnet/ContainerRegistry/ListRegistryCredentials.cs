...
namespace Pulumi.AzureRM.ContainerRegistry
{
    public static class ListRegistryCredentials
    {
        public static Task<ListRegistryCredentialsResult> InvokeAsync(ListRegistryCredentialsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListRegistryCredentialsResult>("azurerm:containerregistry:listRegistryCredentials", args ?? new ListRegistryCredentialsArgs(), options.WithVersion());
    }
