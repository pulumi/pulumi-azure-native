...
namespace Pulumi.AzureRM.ContainerRegistry
{
    ...
    public partial class RegistryWebhook : Pulumi.CustomResource
    {
        ...
        public RegistryWebhook(string name, RegistryWebhookArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry:RegistryWebhook", name, args ?? new RegistryWebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistryWebhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry:RegistryWebhook", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RegistryWebhook Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new RegistryWebhook(name, id, options);
        }
    }
