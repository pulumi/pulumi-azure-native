...
namespace Pulumi.AzureNative.ContainerRegistry.V20231101Preview
{
    public static class GetScopeMap
    {
        ...
        public static Task<GetScopeMapResult> InvokeAsync(GetScopeMapArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScopeMapResult>("azure-native:containerregistry/v20231101preview:getScopeMap", args ?? new GetScopeMapArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified scope map.
        /// </summary>
        public static Output<GetScopeMapResult> Invoke(GetScopeMapInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScopeMapResult>("azure-native:containerregistry/v20231101preview:getScopeMap", args ?? new GetScopeMapInvokeArgs(), options.WithDefaults());
