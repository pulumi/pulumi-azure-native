...
namespace Pulumi.AzureNative.ContainerRegistry.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20231101preview:ExportPipeline")]
    public partial class ExportPipeline : global::Pulumi.CustomResource
    {
        ...
        public ExportPipeline(string name, ExportPipelineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20231101preview:ExportPipeline", name, args ?? new ExportPipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExportPipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20231101preview:ExportPipeline", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExportPipelineArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("options")]
        private InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20231101Preview.PipelineOptions>>? _options;

        /// <summary>
        /// The list of all options configured for the pipeline.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20231101Preview.PipelineOptions>> Options
        {
            get => _options ?? (_options = new InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20231101Preview.PipelineOptions>>());
            set => _options = value;
        }
