...
namespace Pulumi.AzureNative.ContainerRegistry.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20231101preview:ArchiveVersion")]
    public partial class ArchiveVersion : global::Pulumi.CustomResource
    {
        ...
        public ArchiveVersion(string name, ArchiveVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20231101preview:ArchiveVersion", name, args ?? new ArchiveVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArchiveVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20231101preview:ArchiveVersion", name, null, MakeResourceOptions(options, id))
        {
        }
