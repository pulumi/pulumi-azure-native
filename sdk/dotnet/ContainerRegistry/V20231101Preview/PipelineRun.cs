...
namespace Pulumi.AzureNative.ContainerRegistry.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20231101preview:PipelineRun")]
    public partial class PipelineRun : global::Pulumi.CustomResource
    {
        ...
        public PipelineRun(string name, PipelineRunArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20231101preview:PipelineRun", name, args ?? new PipelineRunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PipelineRun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20231101preview:PipelineRun", name, null, MakeResourceOptions(options, id))
        {
        }
