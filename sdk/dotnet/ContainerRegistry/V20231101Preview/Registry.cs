...
namespace Pulumi.AzureNative.ContainerRegistry.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20231101preview:Registry")]
    public partial class Registry : global::Pulumi.CustomResource
    {
        ...
        public Registry(string name, RegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20231101preview:Registry", name, args ?? new RegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20231101preview:Registry", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20231101Preview.MetadataSearch>? MetadataSearch { get; set; }

        /// <summary>
        /// Whether to allow trusted Azure services to access a network restricted registry.
        /// </summary>
        [Input("networkRuleBypassOptions")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20231101Preview.NetworkRuleBypassOptions>? NetworkRuleBypassOptions { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20231101Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20231101Preview.ZoneRedundancy>? ZoneRedundancy { get; set; }
