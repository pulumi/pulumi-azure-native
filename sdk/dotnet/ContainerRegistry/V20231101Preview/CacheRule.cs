...
namespace Pulumi.AzureNative.ContainerRegistry.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20231101preview:CacheRule")]
    public partial class CacheRule : global::Pulumi.CustomResource
    {
        ...
        public CacheRule(string name, CacheRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20231101preview:CacheRule", name, args ?? new CacheRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CacheRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20231101preview:CacheRule", name, null, MakeResourceOptions(options, id))
        {
        }
