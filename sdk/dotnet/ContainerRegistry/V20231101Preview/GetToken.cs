...
namespace Pulumi.AzureNative.ContainerRegistry.V20231101Preview
{
    public static class GetToken
    {
        ...
        public static Task<GetTokenResult> InvokeAsync(GetTokenArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTokenResult>("azure-native:containerregistry/v20231101preview:getToken", args ?? new GetTokenArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified token.
        /// </summary>
        public static Output<GetTokenResult> Invoke(GetTokenInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTokenResult>("azure-native:containerregistry/v20231101preview:getToken", args ?? new GetTokenInvokeArgs(), options.WithDefaults());
    }
