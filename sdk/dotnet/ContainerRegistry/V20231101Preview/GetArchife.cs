...
namespace Pulumi.AzureNative.ContainerRegistry.V20231101Preview
{
    public static class GetArchife
    {
        ...
        public static Task<GetArchifeResult> InvokeAsync(GetArchifeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetArchifeResult>("azure-native:containerregistry/v20231101preview:getArchife", args ?? new GetArchifeArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the archive.
        /// </summary>
        public static Output<GetArchifeResult> Invoke(GetArchifeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetArchifeResult>("azure-native:containerregistry/v20231101preview:getArchife", args ?? new GetArchifeInvokeArgs(), options.WithDefaults());
