...
namespace Pulumi.AzureNative.ContainerRegistry.V20231101Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct MetadataSearch : IEquatable<MetadataSearch>
    {
        private readonly string _value;

        private MetadataSearch(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static MetadataSearch Enabled { get; } = new MetadataSearch("Enabled");
        public static MetadataSearch Disabled { get; } = new MetadataSearch("Disabled");

        public static bool operator ==(MetadataSearch left, MetadataSearch right) => left.Equals(right);
        public static bool operator !=(MetadataSearch left, MetadataSearch right) => !left.Equals(right);

        public static explicit operator string(MetadataSearch value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is MetadataSearch other && Equals(other);
        public bool Equals(MetadataSearch other) => string.Equals(_value, other._value, StringComparison.Ordinal);
