...
namespace Pulumi.AzureNative.ContainerRegistry.V20210901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:containerregistry/v20210901:Replication is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Replication to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:containerregistry/v20210901:Replication")]
    public partial class Replication : global::Pulumi.CustomResource
    {
        ...
        public Replication(string name, ReplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210901:Replication", name, args ?? new ReplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210901:Replication", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ReplicationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20210901.ZoneRedundancy>? ZoneRedundancy { get; set; }
