...
namespace Pulumi.AzureRM.ContainerRegistry.V20191201Preview
{
    ...
    public partial class Webhook : Pulumi.CustomResource
    {
        ...
        public Webhook(string name, WebhookArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/v20191201preview:Webhook", name, args ?? new WebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/v20191201preview:Webhook", name, null, MakeResourceOptions(options, id))
        {
        }
