...
namespace Pulumi.AzureNative.ContainerRegistry.V20191201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:containerregistry/v20191201preview:PipelineRun is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:PipelineRun to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:containerregistry/v20191201preview:PipelineRun")]
    public partial class PipelineRun : global::Pulumi.CustomResource
    {
        ...
        public PipelineRun(string name, PipelineRunArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20191201preview:PipelineRun", name, args ?? new PipelineRunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PipelineRun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20191201preview:PipelineRun", name, null, MakeResourceOptions(options, id))
        {
        }
