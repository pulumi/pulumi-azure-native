...
namespace Pulumi.AzureNative.ContainerRegistry.V20241101Preview.Inputs
{
    ...
    public sealed class TrustPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20241101Preview.PolicyStatus>? Status { get; set; }

        /// <summary>
        /// The type of trust policy.
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20241101Preview.TrustPolicyType>? Type { get; set; }
