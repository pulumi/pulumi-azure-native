...
namespace Pulumi.AzureNative.ContainerRegistry.V20241101Preview.Inputs
{
    ...
    public sealed class PrivateLinkServiceConnectionStateArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20241101Preview.ActionsRequired>? ActionsRequired { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20241101Preview.ConnectionStatus>? Status { get; set; }
