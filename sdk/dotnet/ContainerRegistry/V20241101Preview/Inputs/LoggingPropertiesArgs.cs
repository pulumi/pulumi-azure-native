...
namespace Pulumi.AzureNative.ContainerRegistry.V20241101Preview.Inputs
{
    ...
    public sealed class LoggingPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20241101Preview.AuditLogStatus>? AuditLogStatus { get; set; }

        /// <summary>
        /// The verbosity of logs persisted on the connected registry.
        /// </summary>
        [Input("logLevel")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20241101Preview.LogLevel>? LogLevel { get; set; }
