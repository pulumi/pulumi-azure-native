...
namespace Pulumi.AzureNative.ContainerRegistry.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20241101preview:Archife")]
    public partial class Archife : global::Pulumi.CustomResource
    {
        ...
        public Archife(string name, ArchifeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20241101preview:Archife", name, args ?? new ArchifeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Archife(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20241101preview:Archife", name, null, MakeResourceOptions(options, id))
        {
        }
