...
namespace Pulumi.AzureNative.ContainerRegistry.V20241101Preview
{
    public static class GetConnectedRegistry
    {
        ...
        public static Task<GetConnectedRegistryResult> InvokeAsync(GetConnectedRegistryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectedRegistryResult>("azure-native:containerregistry/v20241101preview:getConnectedRegistry", args ?? new GetConnectedRegistryArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the connected registry.
        /// </summary>
        public static Output<GetConnectedRegistryResult> Invoke(GetConnectedRegistryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectedRegistryResult>("azure-native:containerregistry/v20241101preview:getConnectedRegistry", args ?? new GetConnectedRegistryInvokeArgs(), options.WithDefaults());
