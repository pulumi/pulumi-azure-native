...
namespace Pulumi.AzureNative.ContainerRegistry.V20241101Preview
{
    public static class GetArchife
    {
        ...
        public static Task<GetArchifeResult> InvokeAsync(GetArchifeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetArchifeResult>("azure-native:containerregistry/v20241101preview:getArchife", args ?? new GetArchifeArgs(), options.WithDefaults());
