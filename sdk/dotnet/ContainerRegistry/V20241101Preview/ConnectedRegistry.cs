...
namespace Pulumi.AzureNative.ContainerRegistry.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20241101preview:ConnectedRegistry")]
    public partial class ConnectedRegistry : global::Pulumi.CustomResource
    {
        ...
        public ConnectedRegistry(string name, ConnectedRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20241101preview:ConnectedRegistry", name, args ?? new ConnectedRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20241101preview:ConnectedRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectedRegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20241101Preview.ConnectedRegistryMode> Mode { get; set; } = null!;
