...
namespace Pulumi.AzureNative.ContainerRegistry.V20160627Preview
{
    ...
    /// </summary>
    [Obsolete(@"Version 2016-06-27-preview will be removed in v2 of the provider.")]
    ...
    public partial class Registry : global::Pulumi.CustomResource
    {
        ...
        public Registry(string name, RegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20160627preview:Registry", name, args ?? new RegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20160627preview:Registry", name, null, MakeResourceOptions(options, id))
        {
        }
