...
namespace Pulumi.AzureNative.ContainerRegistry.Inputs
{
    ...
    public sealed class SourceTriggerArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.SourceTriggerEvent>>? _sourceTriggerEvents;

        /// <summary>
        /// The source event corresponding to the trigger.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.SourceTriggerEvent>> SourceTriggerEvents
        {
            get => _sourceTriggerEvents ?? (_sourceTriggerEvents = new InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.SourceTriggerEvent>>());
