...
namespace Pulumi.AzureRM.ContainerRegistry.Inputs
{
    ...
    /// </summary>
    public sealed class CredentialsResponseArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SourceRegistryCredentialsResponseArgs>? SourceRegistry { get; set; }

        public CredentialsResponseArgs()
        {
        }
    }
}
