...
namespace Pulumi.AzureRM.ContainerRegistry.Inputs
{
    ...
    /// </summary>
    public sealed class SourceTriggerResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.SourcePropertiesResponseArgs> SourceRepository { get; set; } = null!;
        ...
        public SourceTriggerResponseArgs()
        {
        }
    }
}
