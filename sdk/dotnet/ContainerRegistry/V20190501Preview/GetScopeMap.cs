...
namespace Pulumi.AzureNative.ContainerRegistry.V20190501Preview
{
    public static class GetScopeMap
    {
        ...
        public static Output<GetScopeMapResult> Invoke(GetScopeMapInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetScopeMapResult>("azure-native:containerregistry/v20190501preview:getScopeMap", args ?? new GetScopeMapInvokeArgs(), options.WithVersion());
    }
