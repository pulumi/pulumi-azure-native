...
namespace Pulumi.AzureNative.ContainerRegistry.V20190501Preview
{
    ...
    public partial class ScopeMap : Pulumi.CustomResource
    {
        ...
        public ScopeMap(string name, ScopeMapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20190501preview:ScopeMap", name, args ?? new ScopeMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20190501preview:ScopeMap", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:containerregistry/v20210601preview:ScopeMap"},
                    new Pulumi.Alias { Type = "azure-native:containerregistry/v20210801preview:ScopeMap"},
                    new Pulumi.Alias { Type = "azure-nextgen:containerregistry/v20210801preview:ScopeMap"},
                },
            };
