...
namespace Pulumi.AzureRM.ContainerRegistry.V20171001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var webhook = new AzureRM.ContainerRegistry.V20171001.Webhook("webhook", new AzureRM.ContainerRegistry.V20171001.WebhookArgs
    ///         {
    ///             Actions = 
    ///             {
    ///                 "push",
    ...
    public partial class Webhook : Pulumi.CustomResource
    {
        ...
        public Webhook(string name, WebhookArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/v20171001:Webhook", name, args ?? new WebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/v20171001:Webhook", name, null, MakeResourceOptions(options, id))
        {
        }
