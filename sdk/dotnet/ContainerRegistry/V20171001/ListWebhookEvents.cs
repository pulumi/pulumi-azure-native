...
namespace Pulumi.AzureNative.ContainerRegistry.V20171001
{
    public static class ListWebhookEvents
    {
        ...
        public static Task<ListWebhookEventsResult> InvokeAsync(ListWebhookEventsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListWebhookEventsResult>("azure-native:containerregistry/v20171001:listWebhookEvents", args ?? new ListWebhookEventsArgs(), options.WithDefaults());

        /// <summary>
        /// The result of a request to list events for a webhook.
        /// </summary>
        public static Output<ListWebhookEventsResult> Invoke(ListWebhookEventsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListWebhookEventsResult>("azure-native:containerregistry/v20171001:listWebhookEvents", args ?? new ListWebhookEventsInvokeArgs(), options.WithDefaults());
    }
