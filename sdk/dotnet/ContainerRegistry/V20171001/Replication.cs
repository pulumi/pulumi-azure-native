...
namespace Pulumi.AzureRM.ContainerRegistry.V20171001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var replication = new AzureRM.ContainerRegistry.V20171001.Replication("replication", new AzureRM.ContainerRegistry.V20171001.ReplicationArgs
    ///         {
    ///             Location = "eastus",
    ...
    public partial class Replication : Pulumi.CustomResource
    {
        ...
        public Replication(string name, ReplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/v20171001:Replication", name, args ?? new ReplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/v20171001:Replication", name, null, MakeResourceOptions(options, id))
        {
        }
