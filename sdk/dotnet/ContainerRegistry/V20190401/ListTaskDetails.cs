...
namespace Pulumi.AzureRM.ContainerRegistry.V20190401
{
    public static class ListTaskDetails
    {
        public static Task<ListTaskDetailsResult> InvokeAsync(ListTaskDetailsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListTaskDetailsResult>("azurerm:containerregistry/v20190401:listTaskDetails", args ?? new ListTaskDetailsArgs(), options.WithVersion());
    }
