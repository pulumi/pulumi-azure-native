...
namespace Pulumi.AzureRM.ContainerRegistry.V20190401
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var task = new AzureRM.ContainerRegistry.V20190401.Task("task", new AzureRM.ContainerRegistry.V20190401.TaskArgs
    ///         {
    ///             AgentConfiguration = new AzureRM.ContainerRegistry.V20190401.Inputs.AgentPropertiesArgs
    ///             {
    ///                 Cpu = 2,
    ///             },
    ///             Identity = new AzureRM.ContainerRegistry.V20190401.Inputs.IdentityPropertiesArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "eastus",
    ///             Platform = new AzureRM.ContainerRegistry.V20190401.Inputs.PlatformPropertiesArgs
    ///             {
    ///                 Architecture = "amd64",
    ///                 Os = "Linux",
    ///             },
    ...
    ///             Status = "Enabled",
    ///             Step = new AzureRM.ContainerRegistry.V20190401.Inputs.TaskStepPropertiesArgs
    ///             {
    ///                 ContextPath = "src",
    ///             },
    ///             Tags = 
    ...
    ///             },
    ///             TaskName = "mytTask",
    ///             Trigger = new AzureRM.ContainerRegistry.V20190401.Inputs.TriggerPropertiesArgs
    ///             {
    ///                 BaseImageTrigger = new AzureRM.ContainerRegistry.V20190401.Inputs.BaseImageTriggerArgs
    ///                 {
    ...
    ///                 SourceTriggers = 
    ///                 {
    ///                     new AzureRM.ContainerRegistry.V20190401.Inputs.SourceTriggerArgs
    ///                     {
    ///                         Name = "mySourceTrigger",
    ///                         SourceRepository = new AzureRM.ContainerRegistry.V20190401.Inputs.SourcePropertiesArgs
    ///                         {
    ///                             Branch = "master",
    ///                             RepositoryUrl = "https://github.com/Azure/azure-rest-api-specs",
    ///                             SourceControlAuthProperties = new AzureRM.ContainerRegistry.V20190401.Inputs.AuthInfoArgs
    ///                             {
    ///                                 Token = "xxxxx",
    ///                                 TokenType = "PAT",
    ///                             },
    ...
    ///                 TimerTriggers = 
    ///                 {
    ///                     new AzureRM.ContainerRegistry.V20190401.Inputs.TimerTriggerArgs
    ///                     {
    ///                         Name = "myTimerTrigger",
    ///                         Schedule = "30 9 * * 1-5",
    ///                     },
    ...
    public partial class Task : Pulumi.CustomResource
    {
        ...
        public Task(string name, TaskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/v20190401:Task", name, args ?? new TaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Task(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/v20190401:Task", name, null, MakeResourceOptions(options, id))
        {
        }
