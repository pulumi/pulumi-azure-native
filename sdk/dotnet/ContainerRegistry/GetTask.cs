...
namespace Pulumi.AzureNative.ContainerRegistry
{
    public static class GetTask
    {
        ...
        public static Task<GetTaskResult> InvokeAsync(GetTaskArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTaskResult>("azure-native:containerregistry:getTask", args ?? new GetTaskArgs(), options.WithVersion());
        ...
        public static Output<GetTaskResult> Invoke(GetTaskInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTaskResult>("azure-native:containerregistry:getTask", args ?? new GetTaskInvokeArgs(), options.WithVersion());
    }
