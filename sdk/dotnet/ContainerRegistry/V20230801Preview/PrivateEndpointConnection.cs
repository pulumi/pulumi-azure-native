...
namespace Pulumi.AzureNative.ContainerRegistry.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20230801preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230801preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230801preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
