...
namespace Pulumi.AzureNative.ContainerRegistry.V20230801Preview
{
    public static class GetCredentialSet
    {
        ...
        public static Task<GetCredentialSetResult> InvokeAsync(GetCredentialSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCredentialSetResult>("azure-native:containerregistry/v20230801preview:getCredentialSet", args ?? new GetCredentialSetArgs(), options.WithDefaults());
