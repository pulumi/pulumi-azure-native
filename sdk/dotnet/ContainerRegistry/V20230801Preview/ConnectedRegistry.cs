...
namespace Pulumi.AzureNative.ContainerRegistry.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20230801preview:ConnectedRegistry")]
    public partial class ConnectedRegistry : global::Pulumi.CustomResource
    {
        ...
        public ConnectedRegistry(string name, ConnectedRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230801preview:ConnectedRegistry", name, args ?? new ConnectedRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230801preview:ConnectedRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectedRegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20230801Preview.ConnectedRegistryMode> Mode { get; set; } = null!;
