...
namespace Pulumi.AzureNative.ContainerRegistry.V20230801Preview
{
    public static class GetArchiveVersion
    {
        ...
        public static Task<GetArchiveVersionResult> InvokeAsync(GetArchiveVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetArchiveVersionResult>("azure-native:containerregistry/v20230801preview:getArchiveVersion", args ?? new GetArchiveVersionArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the archive version.
        /// </summary>
        public static Output<GetArchiveVersionResult> Invoke(GetArchiveVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetArchiveVersionResult>("azure-native:containerregistry/v20230801preview:getArchiveVersion", args ?? new GetArchiveVersionInvokeArgs(), options.WithDefaults());
