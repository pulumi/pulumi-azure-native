...
namespace Pulumi.AzureNative.ContainerRegistry.V20190601Preview
{
    public static class ListTaskDetails
    {
        ...
        public static Task<ListTaskDetailsResult> InvokeAsync(ListTaskDetailsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListTaskDetailsResult>("azure-native:containerregistry/v20190601preview:listTaskDetails", args ?? new ListTaskDetailsArgs(), options.WithDefaults());
        ...
        public static Output<ListTaskDetailsResult> Invoke(ListTaskDetailsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListTaskDetailsResult>("azure-native:containerregistry/v20190601preview:listTaskDetails", args ?? new ListTaskDetailsInvokeArgs(), options.WithDefaults());
    }
