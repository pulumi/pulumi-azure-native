...
namespace Pulumi.AzureRM.ContainerRegistry
{
    public static class ListRunLogSasUrl
    {
        public static Task<ListRunLogSasUrlResult> InvokeAsync(ListRunLogSasUrlArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListRunLogSasUrlResult>("azurerm:containerregistry:listRunLogSasUrl", args ?? new ListRunLogSasUrlArgs(), options.WithVersion());
    }
