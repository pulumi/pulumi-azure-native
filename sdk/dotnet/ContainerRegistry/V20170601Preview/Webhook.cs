...
namespace Pulumi.AzureNextGen.ContainerRegistry.V20170601Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:containerregistry/v20170601preview:Webhook")]
    ...
    public sealed class WebhookArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNextGen.ContainerRegistry.V20170601Preview.WebhookAction>>? _actions;

        /// <summary>
        /// The list of actions that trigger the webhook to post notifications.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.ContainerRegistry.V20170601Preview.WebhookAction>> Actions
        {
            get => _actions ?? (_actions = new InputList<Union<string, Pulumi.AzureNextGen.ContainerRegistry.V20170601Preview.WebhookAction>>());
            set => _actions = value;
        }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerRegistry.V20170601Preview.WebhookStatus>? Status { get; set; }
