...
namespace Pulumi.AzureRM.ContainerRegistry.V20170601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var replication = new AzureRM.ContainerRegistry.V20170601Preview.Replication("replication", new AzureRM.ContainerRegistry.V20170601Preview.ReplicationArgs
    ///         {
    ///             Location = "eastus",
    ...
    public partial class Replication : Pulumi.CustomResource
    {
        ...
        public Replication(string name, ReplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/v20170601preview:Replication", name, args ?? new ReplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/v20170601preview:Replication", name, null, MakeResourceOptions(options, id))
        {
        }
