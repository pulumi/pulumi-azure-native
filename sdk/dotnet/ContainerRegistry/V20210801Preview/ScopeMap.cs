...
namespace Pulumi.AzureNative.ContainerRegistry.V20210801Preview
{
    ...
    [AzureNativeResourceType("azure-native:containerregistry/v20210801preview:ScopeMap")]
    public partial class ScopeMap : global::Pulumi.CustomResource
    {
        ...
        public ScopeMap(string name, ScopeMapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210801preview:ScopeMap", name, args ?? new ScopeMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210801preview:ScopeMap", name, null, MakeResourceOptions(options, id))
        {
        }
