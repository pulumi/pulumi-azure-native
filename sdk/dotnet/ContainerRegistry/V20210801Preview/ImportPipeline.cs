...
namespace Pulumi.AzureNative.ContainerRegistry.V20210801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20210801preview:ImportPipeline")]
    public partial class ImportPipeline : global::Pulumi.CustomResource
    {
        ...
        public ImportPipeline(string name, ImportPipelineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210801preview:ImportPipeline", name, args ?? new ImportPipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImportPipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210801preview:ImportPipeline", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ImportPipelineArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("options")]
        private InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20210801Preview.PipelineOptions>>? _options;

        /// <summary>
        /// The list of all options configured for the pipeline.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20210801Preview.PipelineOptions>> Options
        {
            get => _options ?? (_options = new InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20210801Preview.PipelineOptions>>());
            set => _options = value;
        }
