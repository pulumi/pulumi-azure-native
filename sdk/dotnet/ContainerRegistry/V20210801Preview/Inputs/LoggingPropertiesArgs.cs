...
namespace Pulumi.AzureNative.ContainerRegistry.V20210801Preview.Inputs
{
    ...
    public sealed class LoggingPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20210801Preview.AuditLogStatus>? AuditLogStatus { get; set; }

        /// <summary>
        /// The verbosity of logs persisted on the connected registry.
        /// </summary>
        [Input("logLevel")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20210801Preview.LogLevel>? LogLevel { get; set; }
