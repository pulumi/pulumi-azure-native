...
namespace Pulumi.AzureNative.ContainerRegistry.V20210801Preview.Inputs
{
    ...
    public sealed class PrivateLinkServiceConnectionStateArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20210801Preview.ActionsRequired>? ActionsRequired { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20210801Preview.ConnectionStatus>? Status { get; set; }
