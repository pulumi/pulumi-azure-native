...
namespace Pulumi.AzureNative.ContainerRegistry.V20210801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20210801preview:Replication")]
    public partial class Replication : Pulumi.CustomResource
    {
        ...
        public Replication(string name, ReplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210801preview:Replication", name, args ?? new ReplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210801preview:Replication", name, null, MakeResourceOptions(options, id))
        {
        }
