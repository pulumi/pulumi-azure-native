...
namespace Pulumi.AzureRM.ContainerRegistry
{
    public static class ListWebhookEvents
    {
        public static Task<ListWebhookEventsResult> InvokeAsync(ListWebhookEventsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebhookEventsResult>("azurerm:containerregistry:listWebhookEvents", args ?? new ListWebhookEventsArgs(), options.WithVersion());
    }
