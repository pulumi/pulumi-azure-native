...
namespace Pulumi.AzureNative.ContainerRegistry
{
    ...
    public partial class Task : global::Pulumi.CustomResource
    {
        ...
        public Task(string name, TaskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry:Task", name, args ?? new TaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Task(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry:Task", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_containerregistry_v20180901:containerregistry:Task" },
                    new global::Pulumi.Alias { Type = "azure-native_containerregistry_v20190401:containerregistry:Task" },
                    new global::Pulumi.Alias { Type = "azure-native_containerregistry_v20190601preview:containerregistry:Task" },
                },
            };
    ...
    public sealed class TaskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.TaskStatus>? Status { get; set; }
