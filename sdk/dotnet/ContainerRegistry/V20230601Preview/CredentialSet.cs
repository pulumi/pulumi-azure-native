...
namespace Pulumi.AzureNative.ContainerRegistry.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20230601preview:CredentialSet")]
    public partial class CredentialSet : global::Pulumi.CustomResource
    {
        ...
        public CredentialSet(string name, CredentialSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230601preview:CredentialSet", name, args ?? new CredentialSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CredentialSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230601preview:CredentialSet", name, null, MakeResourceOptions(options, id))
        {
        }
