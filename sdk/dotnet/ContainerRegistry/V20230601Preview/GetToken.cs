...
namespace Pulumi.AzureNative.ContainerRegistry.V20230601Preview
{
    public static class GetToken
    {
        ...
        public static Task<GetTokenResult> InvokeAsync(GetTokenArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTokenResult>("azure-native:containerregistry/v20230601preview:getToken", args ?? new GetTokenArgs(), options.WithDefaults());
