...
namespace Pulumi.AzureRM.ContainerRegistry
{
    ...
    public partial class Webhook : Pulumi.CustomResource
    {
        ...
        public Webhook(string name, WebhookArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry:Webhook", name, args ?? new WebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry:Webhook", name, null, MakeResourceOptions(options, id))
        {
        }
