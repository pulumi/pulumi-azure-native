...
namespace Pulumi.AzureNative.ContainerRegistry.V20230101Preview
{
    ...
    /// {
    ///     var exportPipeline = new AzureNative.ContainerRegistry.V20230101Preview.ExportPipeline("exportPipeline", new()
    ///     {
    ...
    ///         Target = new AzureNative.ContainerRegistry.V20230101Preview.Inputs.ExportPipelineTargetPropertiesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20230101preview:ExportPipeline")]
    public partial class ExportPipeline : global::Pulumi.CustomResource
    {
        ...
        public ExportPipeline(string name, ExportPipelineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:ExportPipeline", name, args ?? new ExportPipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExportPipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:ExportPipeline", name, null, MakeResourceOptions(options, id))
        {
        }
