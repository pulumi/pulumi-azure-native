...
namespace Pulumi.AzureNative.ContainerRegistry.V20230101Preview
{
    ...
    public partial class Replication : global::Pulumi.CustomResource
    {
        ...
        public Replication(string name, ReplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:Replication", name, args ?? new ReplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:Replication", name, null, MakeResourceOptions(options, id))
        {
        }
