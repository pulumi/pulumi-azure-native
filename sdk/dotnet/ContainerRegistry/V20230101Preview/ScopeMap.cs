...
namespace Pulumi.AzureNative.ContainerRegistry.V20230101Preview
{
    ...
    /// {
    ///     var scopeMap = new AzureNative.ContainerRegistry.V20230101Preview.ScopeMap("scopeMap", new()
    ///     {
    ///         Actions = new[]
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20230101preview:ScopeMap")]
    public partial class ScopeMap : global::Pulumi.CustomResource
    {
        ...
        public ScopeMap(string name, ScopeMapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:ScopeMap", name, args ?? new ScopeMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:ScopeMap", name, null, MakeResourceOptions(options, id))
        {
        }
