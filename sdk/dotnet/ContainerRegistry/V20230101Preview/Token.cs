...
namespace Pulumi.AzureNative.ContainerRegistry.V20230101Preview
{
    ...
    /// {
    ///     var token = new AzureNative.ContainerRegistry.V20230101Preview.Token("token", new()
    ///     {
    ///         Credentials = new AzureNative.ContainerRegistry.V20230101Preview.Inputs.TokenCredentialsPropertiesArgs
    ///         {
    ///             Certificates = new[]
    ///             {
    ///                 new AzureNative.ContainerRegistry.V20230101Preview.Inputs.TokenCertificateArgs
    ///                 {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:containerregistry/v20230101preview:Token myToken /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.ContainerRegistry/registries/myRegistry/tokens/myToken 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20230101preview:Token")]
    public partial class Token : global::Pulumi.CustomResource
    {
        ...
        public Token(string name, TokenArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:Token", name, args ?? new TokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Token(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:Token", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TokenArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20230101Preview.TokenStatus>? Status { get; set; }
