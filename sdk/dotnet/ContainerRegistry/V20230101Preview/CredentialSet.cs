...
namespace Pulumi.AzureNative.ContainerRegistry.V20230101Preview
{
    ...
    public partial class CredentialSet : global::Pulumi.CustomResource
    {
        ...
        public CredentialSet(string name, CredentialSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:CredentialSet", name, args ?? new CredentialSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CredentialSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:CredentialSet", name, null, MakeResourceOptions(options, id))
        {
        }
