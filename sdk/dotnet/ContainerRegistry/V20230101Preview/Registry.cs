...
namespace Pulumi.AzureNative.ContainerRegistry.V20230101Preview
{
    ...
    /// {
    ///     var registry = new AzureNative.ContainerRegistry.V20230101Preview.Registry("registry", new()
    ///     {
    ///         AdminUserEnabled = true,
    ///         Location = "westus",
    ///         RegistryName = "myRegistry",
    ///         ResourceGroupName = "myResourceGroup",
    ///         Sku = new AzureNative.ContainerRegistry.V20230101Preview.Inputs.SkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ///         Tags = 
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20230101preview:Registry")]
    public partial class Registry : global::Pulumi.CustomResource
    {
        ...
        public Registry(string name, RegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:Registry", name, args ?? new RegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:Registry", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20230101Preview.NetworkRuleBypassOptions>? NetworkRuleBypassOptions { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20230101Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20230101Preview.ZoneRedundancy>? ZoneRedundancy { get; set; }
