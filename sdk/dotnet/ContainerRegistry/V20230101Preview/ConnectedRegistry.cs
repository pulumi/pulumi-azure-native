...
namespace Pulumi.AzureNative.ContainerRegistry.V20230101Preview
{
    ...
    /// {
    ///     var connectedRegistry = new AzureNative.ContainerRegistry.V20230101Preview.ConnectedRegistry("connectedRegistry", new()
    ///     {
    ///         ClientTokenIds = new[]
    ///         {
    ...
    ///             "sample/repo/*:1.0:*",
    ///         },
    ///         Parent = new AzureNative.ContainerRegistry.V20230101Preview.Inputs.ParentPropertiesArgs
    ///         {
    ///             SyncProperties = new AzureNative.ContainerRegistry.V20230101Preview.Inputs.SyncPropertiesArgs
    ///             {
    ///                 MessageTtl = "P2D",
    ///                 Schedule = "0 9 * * *",
    ///                 SyncWindow = "PT3H",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20230101preview:ConnectedRegistry")]
    public partial class ConnectedRegistry : global::Pulumi.CustomResource
    {
        ...
        public ConnectedRegistry(string name, ConnectedRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:ConnectedRegistry", name, args ?? new ConnectedRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20230101preview:ConnectedRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectedRegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20230101Preview.ConnectedRegistryMode> Mode { get; set; } = null!;
