...
namespace Pulumi.AzureNative.ContainerRegistry.V20180901
{
    public static class GetTask
    {
        ...
        public static Task<GetTaskResult> InvokeAsync(GetTaskArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTaskResult>("azure-native:containerregistry/v20180901:getTask", args ?? new GetTaskArgs(), options.WithDefaults());

        /// <summary>
        /// Get the properties of a specified task.
        /// </summary>
        public static Output<GetTaskResult> Invoke(GetTaskInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTaskResult>("azure-native:containerregistry/v20180901:getTask", args ?? new GetTaskInvokeArgs(), options.WithDefaults());
