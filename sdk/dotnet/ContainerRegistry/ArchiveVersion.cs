...
namespace Pulumi.AzureNative.ContainerRegistry
{
    ...
    public partial class ArchiveVersion : global::Pulumi.CustomResource
    {
        ...
        public ArchiveVersion(string name, ArchiveVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry:ArchiveVersion", name, args ?? new ArchiveVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArchiveVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry:ArchiveVersion", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:containerregistry/v20250301preview:ArchiveVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:containerregistry/v20250501preview:ArchiveVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:containerregistry/v20250601preview:ArchiveVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:containerregistry/v20260101preview:ArchiveVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:containerregistry/v20260301preview:ArchiveVersion" },
                },
            };
