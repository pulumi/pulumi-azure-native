...
namespace Pulumi.AzureNative.ContainerRegistry.V20211201Preview
{
    public static class GetRegistry
    {
        ...
        public static Task<GetRegistryResult> InvokeAsync(GetRegistryArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegistryResult>("azure-native:containerregistry/v20211201preview:getRegistry", args ?? new GetRegistryArgs(), options.WithVersion());

        /// <summary>
        /// An object that represents a container registry.
        /// </summary>
        public static Output<GetRegistryResult> Invoke(GetRegistryInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegistryResult>("azure-native:containerregistry/v20211201preview:getRegistry", args ?? new GetRegistryInvokeArgs(), options.WithVersion());
    }
