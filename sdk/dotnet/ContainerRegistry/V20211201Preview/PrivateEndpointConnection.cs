...
namespace Pulumi.AzureNative.ContainerRegistry.V20211201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:containerregistry/v20211201preview:PrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:PrivateEndpointConnection to guarantee forwards compatibility.")]
    ...
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20211201preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20211201preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
