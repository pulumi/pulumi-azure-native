...
namespace Pulumi.AzureNative.ContainerRegistry.V20211201Preview
{
    public static class GetExportPipeline
    {
        ...
        public static Task<GetExportPipelineResult> InvokeAsync(GetExportPipelineArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExportPipelineResult>("azure-native:containerregistry/v20211201preview:getExportPipeline", args ?? new GetExportPipelineArgs(), options.WithVersion());

        /// <summary>
        /// An object that represents an export pipeline for a container registry.
        /// </summary>
        public static Output<GetExportPipelineResult> Invoke(GetExportPipelineInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetExportPipelineResult>("azure-native:containerregistry/v20211201preview:getExportPipeline", args ?? new GetExportPipelineInvokeArgs(), options.WithVersion());
    }
