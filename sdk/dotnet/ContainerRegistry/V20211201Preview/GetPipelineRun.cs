...
{
    [Obsolete(@"azure-native:containerregistry/v20211201preview:PipelineRun is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:PipelineRun to guarantee forwards compatibility.")]
    public static class GetPipelineRun
    {
        ...
        public static Task<GetPipelineRunResult> InvokeAsync(GetPipelineRunArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPipelineRunResult>("azure-native:containerregistry/v20211201preview:getPipelineRun", args ?? new GetPipelineRunArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the detailed information for a given pipeline run.
        /// </summary>
        public static Output<GetPipelineRunResult> Invoke(GetPipelineRunInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPipelineRunResult>("azure-native:containerregistry/v20211201preview:getPipelineRun", args ?? new GetPipelineRunInvokeArgs(), options.WithDefaults());
    }
