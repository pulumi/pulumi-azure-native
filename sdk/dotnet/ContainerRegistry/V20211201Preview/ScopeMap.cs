...
namespace Pulumi.AzureNative.ContainerRegistry.V20211201Preview
{
    ...
    [AzureNativeResourceType("azure-native:containerregistry/v20211201preview:ScopeMap")]
    public partial class ScopeMap : global::Pulumi.CustomResource
    {
        ...
        public ScopeMap(string name, ScopeMapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20211201preview:ScopeMap", name, args ?? new ScopeMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20211201preview:ScopeMap", name, null, MakeResourceOptions(options, id))
        {
        }
