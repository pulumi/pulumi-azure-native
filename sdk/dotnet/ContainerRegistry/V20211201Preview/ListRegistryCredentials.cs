...
namespace Pulumi.AzureNative.ContainerRegistry.V20211201Preview
{
    public static class ListRegistryCredentials
    {
        ...
        public static Task<ListRegistryCredentialsResult> InvokeAsync(ListRegistryCredentialsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListRegistryCredentialsResult>("azure-native:containerregistry/v20211201preview:listRegistryCredentials", args ?? new ListRegistryCredentialsArgs(), options.WithDefaults());
        ...
        public static Output<ListRegistryCredentialsResult> Invoke(ListRegistryCredentialsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListRegistryCredentialsResult>("azure-native:containerregistry/v20211201preview:listRegistryCredentials", args ?? new ListRegistryCredentialsInvokeArgs(), options.WithDefaults());
    }
