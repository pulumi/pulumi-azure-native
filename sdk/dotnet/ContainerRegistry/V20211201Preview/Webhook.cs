...
namespace Pulumi.AzureNative.ContainerRegistry.V20211201Preview
{
    ...
    [AzureNativeResourceType("azure-native:containerregistry/v20211201preview:Webhook")]
    public partial class Webhook : global::Pulumi.CustomResource
    {
        ...
        public Webhook(string name, WebhookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20211201preview:Webhook", name, args ?? new WebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20211201preview:Webhook", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebhookArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20211201Preview.WebhookAction>>? _actions;

        /// <summary>
        /// The list of actions that trigger the webhook to post notifications.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20211201Preview.WebhookAction>> Actions
        {
            get => _actions ?? (_actions = new InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20211201Preview.WebhookAction>>());
            set => _actions = value;
        }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20211201Preview.WebhookStatus>? Status { get; set; }
