...
namespace Pulumi.AzureNative.ContainerRegistry.V20211201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20211201preview:ExportPipeline")]
    public partial class ExportPipeline : global::Pulumi.CustomResource
    {
        ...
        public ExportPipeline(string name, ExportPipelineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20211201preview:ExportPipeline", name, args ?? new ExportPipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExportPipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20211201preview:ExportPipeline", name, null, MakeResourceOptions(options, id))
        {
        }
