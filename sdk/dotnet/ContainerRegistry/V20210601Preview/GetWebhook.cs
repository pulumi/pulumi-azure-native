...
namespace Pulumi.AzureNative.ContainerRegistry.V20210601Preview
{
    public static class GetWebhook
    {
        ...
        public static Task<GetWebhookResult> InvokeAsync(GetWebhookArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebhookResult>("azure-native:containerregistry/v20210601preview:getWebhook", args ?? new GetWebhookArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified webhook.
        /// </summary>
        public static Output<GetWebhookResult> Invoke(GetWebhookInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebhookResult>("azure-native:containerregistry/v20210601preview:getWebhook", args ?? new GetWebhookInvokeArgs(), options.WithDefaults());
    }
