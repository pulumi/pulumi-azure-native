...
namespace Pulumi.AzureNative.ContainerRegistry.V20210601Preview
{
    public static class GetImportPipeline
    {
        ...
        public static Task<GetImportPipelineResult> InvokeAsync(GetImportPipelineArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetImportPipelineResult>("azure-native:containerregistry/v20210601preview:getImportPipeline", args ?? new GetImportPipelineArgs(), options.WithDefaults());

        /// <summary>
        /// An object that represents an import pipeline for a container registry.
        /// </summary>
        public static Output<GetImportPipelineResult> Invoke(GetImportPipelineInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetImportPipelineResult>("azure-native:containerregistry/v20210601preview:getImportPipeline", args ?? new GetImportPipelineInvokeArgs(), options.WithDefaults());
    }
