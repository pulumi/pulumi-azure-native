...
namespace Pulumi.AzureNative.ContainerRegistry.V20210601Preview
{
    public static class GetToken
    {
        ...
        public static Task<GetTokenResult> InvokeAsync(GetTokenArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTokenResult>("azure-native:containerregistry/v20210601preview:getToken", args ?? new GetTokenArgs(), options.WithVersion());

        /// <summary>
        /// An object that represents a token for a container registry.
        /// </summary>
        public static Output<GetTokenResult> Invoke(GetTokenInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTokenResult>("azure-native:containerregistry/v20210601preview:getToken", args ?? new GetTokenInvokeArgs(), options.WithVersion());
    }
