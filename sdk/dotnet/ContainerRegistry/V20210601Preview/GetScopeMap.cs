...
namespace Pulumi.AzureNative.ContainerRegistry.V20210601Preview
{
    public static class GetScopeMap
    {
        ...
        public static Task<GetScopeMapResult> InvokeAsync(GetScopeMapArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScopeMapResult>("azure-native:containerregistry/v20210601preview:getScopeMap", args ?? new GetScopeMapArgs(), options.WithVersion());

        /// <summary>
        /// An object that represents a scope map for a container registry.
        /// </summary>
        public static Output<GetScopeMapResult> Invoke(GetScopeMapInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetScopeMapResult>("azure-native:containerregistry/v20210601preview:getScopeMap", args ?? new GetScopeMapInvokeArgs(), options.WithVersion());
    }
