...
namespace Pulumi.AzureNative.ContainerRegistry.V20210601Preview
{
    ...
    public static class GetExportPipeline
    {
        ...
        public static Task<GetExportPipelineResult> InvokeAsync(GetExportPipelineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExportPipelineResult>("azure-native:containerregistry/v20210601preview:getExportPipeline", args ?? new GetExportPipelineArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the export pipeline.
        /// </summary>
        public static Output<GetExportPipelineResult> Invoke(GetExportPipelineInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExportPipelineResult>("azure-native:containerregistry/v20210601preview:getExportPipeline", args ?? new GetExportPipelineInvokeArgs(), options.WithDefaults());
    }
