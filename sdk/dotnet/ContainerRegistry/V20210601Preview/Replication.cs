...
namespace Pulumi.AzureNative.ContainerRegistry.V20210601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20210601preview:Replication")]
    public partial class Replication : Pulumi.CustomResource
    {
        ...
        public Replication(string name, ReplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210601preview:Replication", name, args ?? new ReplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210601preview:Replication", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ReplicationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20210601Preview.ZoneRedundancy>? ZoneRedundancy { get; set; }
