...
namespace Pulumi.AzureNative.ContainerRegistry.V20210601Preview
{
    public static class ListWebhookEvents
    {
        ...
        public static Task<ListWebhookEventsResult> InvokeAsync(ListWebhookEventsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebhookEventsResult>("azure-native:containerregistry/v20210601preview:listWebhookEvents", args ?? new ListWebhookEventsArgs(), options.WithVersion());

        /// <summary>
        /// The result of a request to list events for a webhook.
        /// </summary>
        public static Output<ListWebhookEventsResult> Invoke(ListWebhookEventsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListWebhookEventsResult>("azure-native:containerregistry/v20210601preview:listWebhookEvents", args ?? new ListWebhookEventsInvokeArgs(), options.WithVersion());
    }
