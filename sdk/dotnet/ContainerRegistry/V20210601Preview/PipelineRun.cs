...
namespace Pulumi.AzureNative.ContainerRegistry.V20210601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20210601preview:PipelineRun")]
    public partial class PipelineRun : Pulumi.CustomResource
    {
        ...
        public PipelineRun(string name, PipelineRunArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210601preview:PipelineRun", name, args ?? new PipelineRunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PipelineRun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210601preview:PipelineRun", name, null, MakeResourceOptions(options, id))
        {
        }
