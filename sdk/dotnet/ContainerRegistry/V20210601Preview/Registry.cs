...
namespace Pulumi.AzureNative.ContainerRegistry.V20210601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:containerregistry/v20210601preview:Registry is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Registry to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:containerregistry/v20210601preview:Registry")]
    public partial class Registry : global::Pulumi.CustomResource
    {
        ...
        public Registry(string name, RegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210601preview:Registry", name, args ?? new RegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210601preview:Registry", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20210601Preview.NetworkRuleBypassOptions>? NetworkRuleBypassOptions { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20210601Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
