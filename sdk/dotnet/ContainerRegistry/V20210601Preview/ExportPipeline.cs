...
namespace Pulumi.AzureNative.ContainerRegistry.V20210601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:containerregistry/v20210601preview:ExportPipeline is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:ExportPipeline to guarantee forwards compatibility.")]
    ...
    public partial class ExportPipeline : global::Pulumi.CustomResource
    {
        ...
        public ExportPipeline(string name, ExportPipelineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210601preview:ExportPipeline", name, args ?? new ExportPipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExportPipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20210601preview:ExportPipeline", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExportPipelineArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("options")]
        private InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20210601Preview.PipelineOptions>>? _options;

        /// <summary>
        /// The list of all options configured for the pipeline.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20210601Preview.PipelineOptions>> Options
        {
            get => _options ?? (_options = new InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.V20210601Preview.PipelineOptions>>());
            set => _options = value;
        }
