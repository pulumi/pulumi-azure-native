...
namespace Pulumi.AzureNative.ContainerRegistry.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:containerregistry:Replication'.")]
    [AzureNativeResourceType("azure-native:containerregistry/latest:Replication")]
    public partial class Replication : Pulumi.CustomResource
    {
        ...
        public Replication(string name, ReplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/latest:Replication", name, args ?? new ReplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/latest:Replication", name, null, MakeResourceOptions(options, id))
        {
        }
