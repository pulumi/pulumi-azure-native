...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.ContainerRegistry.Latest.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.ContainerRegistry.Latest.PrivateEndpointConnectionArgs
    ///         {
    ///             PrivateEndpointConnectionName = "myConnection",
    ///             PrivateLinkServiceConnectionState = new AzureRM.ContainerRegistry.Latest.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
