...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var exportPipeline = new AzureRM.ContainerRegistry.Latest.ExportPipeline("exportPipeline", new AzureRM.ContainerRegistry.Latest.ExportPipelineArgs
    ///         {
    ...
    ///             Target = new AzureRM.ContainerRegistry.Latest.Inputs.ExportPipelineTargetPropertiesArgs
    ///             {
    ...
    public partial class ExportPipeline : Pulumi.CustomResource
    {
        ...
        public ExportPipeline(string name, ExportPipelineArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:ExportPipeline", name, args ?? new ExportPipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExportPipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:ExportPipeline", name, null, MakeResourceOptions(options, id))
        {
        }
