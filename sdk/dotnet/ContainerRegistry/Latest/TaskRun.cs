...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var taskRun = new AzureRM.ContainerRegistry.Latest.TaskRun("taskRun", new AzureRM.ContainerRegistry.Latest.TaskRunArgs
    ///         {
    ///             ForceUpdateTag = "test",
    ...
    public partial class TaskRun : Pulumi.CustomResource
    {
        ...
        public TaskRun(string name, TaskRunArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:TaskRun", name, args ?? new TaskRunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TaskRun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:TaskRun", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:containerregistry/v20190601preview:TaskRun"},
                },
            };
