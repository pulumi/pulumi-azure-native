...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var agentPool = new AzureRM.ContainerRegistry.Latest.AgentPool("agentPool", new AzureRM.ContainerRegistry.Latest.AgentPoolArgs
    ///         {
    ...
    public partial class AgentPool : Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
