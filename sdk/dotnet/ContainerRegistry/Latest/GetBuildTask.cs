...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    public static class GetBuildTask
    {
        public static Task<GetBuildTaskResult> InvokeAsync(GetBuildTaskArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBuildTaskResult>("azurerm:containerregistry/latest:getBuildTask", args ?? new GetBuildTaskArgs(), options.WithVersion());
    }
    ...
    public sealed class GetBuildTaskResult
    {
        ...
        /// </summary>
        public readonly Outputs.SourceRepositoryPropertiesResponseResult SourceRepository;
        /// <summary>
        ...
        private GetBuildTaskResult(
            ...
            Outputs.SourceRepositoryPropertiesResponseResult sourceRepository,
