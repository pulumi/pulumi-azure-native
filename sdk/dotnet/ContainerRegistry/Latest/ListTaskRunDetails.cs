...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    public static class ListTaskRunDetails
    {
        public static Task<ListTaskRunDetailsResult> InvokeAsync(ListTaskRunDetailsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListTaskRunDetailsResult>("azurerm:containerregistry/latest:listTaskRunDetails", args ?? new ListTaskRunDetailsArgs(), options.WithVersion());
    }
