...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var scopeMap = new AzureRM.ContainerRegistry.Latest.ScopeMap("scopeMap", new AzureRM.ContainerRegistry.Latest.ScopeMapArgs
    ///         {
    ///             Actions = 
    ///             {
    ...
    public partial class ScopeMap : Pulumi.CustomResource
    {
        ...
        public ScopeMap(string name, ScopeMapArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:ScopeMap", name, args ?? new ScopeMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:ScopeMap", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:containerregistry/v20190501preview:ScopeMap"},
                },
            };
