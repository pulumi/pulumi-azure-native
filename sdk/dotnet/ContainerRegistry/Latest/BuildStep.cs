...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var buildStep = new AzureRM.ContainerRegistry.Latest.BuildStep("buildStep", new AzureRM.ContainerRegistry.Latest.BuildStepArgs
    ///         {
    ...
    public partial class BuildStep : Pulumi.CustomResource
    {
        ...
        public BuildStep(string name, BuildStepArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:BuildStep", name, args ?? new BuildStepArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BuildStep(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:BuildStep", name, null, MakeResourceOptions(options, id))
        {
        }
