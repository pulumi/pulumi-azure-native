...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    public static class GetPipelineRun
    {
        public static Task<GetPipelineRunResult> InvokeAsync(GetPipelineRunArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPipelineRunResult>("azurerm:containerregistry/latest:getPipelineRun", args ?? new GetPipelineRunArgs(), options.WithVersion());
    }
