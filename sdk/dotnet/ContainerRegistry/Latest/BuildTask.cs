...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var buildTask = new AzureRM.ContainerRegistry.Latest.BuildTask("buildTask", new AzureRM.ContainerRegistry.Latest.BuildTaskArgs
    ///         {
    ///             Alias = "myalias",
    ...
    ///             SourceRepository = new AzureRM.ContainerRegistry.Latest.Inputs.SourceRepositoryPropertiesArgs
    ///             {
    ///                 IsCommitTriggerEnabled = true,
    ///                 RepositoryUrl = "https://github.com/Azure/azure-rest-api-specs",
    ///                 SourceControlAuthProperties = new AzureRM.ContainerRegistry.Latest.Inputs.SourceControlAuthInfoArgs
    ///                 {
    ///                     Scope = "repo",
    ///                     Token = "xxxxxx",
    ///                     TokenType = "OAuth",
    ...
    public partial class BuildTask : Pulumi.CustomResource
    {
        ...
        public BuildTask(string name, BuildTaskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:BuildTask", name, args ?? new BuildTaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BuildTask(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:BuildTask", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:containerregistry/v20180201preview:BuildTask"},
                },
            };
