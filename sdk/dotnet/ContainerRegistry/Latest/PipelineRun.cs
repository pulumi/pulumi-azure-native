...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var pipelineRun = new AzureRM.ContainerRegistry.Latest.PipelineRun("pipelineRun", new AzureRM.ContainerRegistry.Latest.PipelineRunArgs
    ///         {
    ///             PipelineRunName = "myPipelineRun",
    ///             RegistryName = "myRegistry",
    ///             Request = new AzureRM.ContainerRegistry.Latest.Inputs.PipelineRunRequestArgs
    ///             {
    ///                 Artifacts = 
    ///                 {
    ...
    ///                 Target = new AzureRM.ContainerRegistry.Latest.Inputs.PipelineRunTargetPropertiesArgs
    ///                 {
    ///                     Name = "myblob.tar.gz",
    ...
    ///                 Source = new AzureRM.ContainerRegistry.Latest.Inputs.PipelineRunSourcePropertiesArgs
    ///                 {
    ///                     Name = "myblob.tar.gz",
    ///                     Type = "AzureStorageBlob",
    ///                 },
    ...
    public partial class PipelineRun : Pulumi.CustomResource
    {
        ...
        public PipelineRun(string name, PipelineRunArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:PipelineRun", name, args ?? new PipelineRunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PipelineRun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/latest:PipelineRun", name, null, MakeResourceOptions(options, id))
        {
        }
