...
namespace Pulumi.AzureNative.ContainerRegistry.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:containerregistry:Webhook'.")]
    [AzureNativeResourceType("azure-native:containerregistry/latest:Webhook")]
    public partial class Webhook : Pulumi.CustomResource
    {
        ...
        public Webhook(string name, WebhookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/latest:Webhook", name, args ?? new WebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/latest:Webhook", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebhookArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.Latest.WebhookAction>>? _actions;

        /// <summary>
        /// The list of actions that trigger the webhook to post notifications.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.Latest.WebhookAction>> Actions
        {
            get => _actions ?? (_actions = new InputList<Union<string, Pulumi.AzureNative.ContainerRegistry.Latest.WebhookAction>>());
            set => _actions = value;
        }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.Latest.WebhookStatus>? Status { get; set; }
