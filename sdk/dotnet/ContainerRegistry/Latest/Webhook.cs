...
namespace Pulumi.AzureNextGen.ContainerRegistry.Latest
{
    ...
    public sealed class WebhookArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNextGen.ContainerRegistry.Latest.WebhookAction>>? _actions;

        /// <summary>
        /// The list of actions that trigger the webhook to post notifications.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.ContainerRegistry.Latest.WebhookAction>> Actions
        {
            get => _actions ?? (_actions = new InputList<Union<string, Pulumi.AzureNextGen.ContainerRegistry.Latest.WebhookAction>>());
            set => _actions = value;
        }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerRegistry.Latest.WebhookStatus>? Status { get; set; }
