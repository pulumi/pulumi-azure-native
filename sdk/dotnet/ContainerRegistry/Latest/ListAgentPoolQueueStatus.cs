...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    public static class ListAgentPoolQueueStatus
    {
        public static Task<ListAgentPoolQueueStatusResult> InvokeAsync(ListAgentPoolQueueStatusArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAgentPoolQueueStatusResult>("azurerm:containerregistry/latest:listAgentPoolQueueStatus", args ?? new ListAgentPoolQueueStatusArgs(), options.WithVersion());
    }
