...
namespace Pulumi.AzureRM.ContainerRegistry.Latest
{
    public static class GetImportPipeline
    {
        public static Task<GetImportPipelineResult> InvokeAsync(GetImportPipelineArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetImportPipelineResult>("azurerm:containerregistry/latest:getImportPipeline", args ?? new GetImportPipelineArgs(), options.WithVersion());
    }
