...
namespace Pulumi.AzureNative.ContainerRegistry.V20201101Preview
{
    ...
    public static class GetImportPipeline
    {
        ...
        public static Task<GetImportPipelineResult> InvokeAsync(GetImportPipelineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetImportPipelineResult>("azure-native:containerregistry/v20201101preview:getImportPipeline", args ?? new GetImportPipelineArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the import pipeline.
        /// </summary>
        public static Output<GetImportPipelineResult> Invoke(GetImportPipelineInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetImportPipelineResult>("azure-native:containerregistry/v20201101preview:getImportPipeline", args ?? new GetImportPipelineInvokeArgs(), options.WithDefaults());
    }
