...
namespace Pulumi.AzureNative.ContainerRegistry.V20201101Preview
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.ContainerRegistry.V20201101Preview.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         PrivateEndpointConnectionName = "myConnection",
    ///         PrivateLinkServiceConnectionState = new AzureNative.ContainerRegistry.V20201101Preview.Inputs.PrivateLinkServiceConnectionStateArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20201101preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20201101preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20201101preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
