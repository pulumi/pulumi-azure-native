...
namespace Pulumi.AzureNextGen.ContainerRegistry.V20201101Preview
{
    ...
    public partial class Token : Pulumi.CustomResource
    {
        ...
        public Token(string name, TokenArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:containerregistry/v20201101preview:Token", name, args ?? new TokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Token(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:containerregistry/v20201101preview:Token", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TokenArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerRegistry.V20201101Preview.TokenStatus>? Status { get; set; }
