...
namespace Pulumi.AzureNative.ContainerRegistry.V20201101Preview
{
    ...
    /// {
    ///     var token = new AzureNative.ContainerRegistry.V20201101Preview.Token("token", new()
    ///     {
    ///         Credentials = new AzureNative.ContainerRegistry.V20201101Preview.Inputs.TokenCredentialsPropertiesArgs
    ///         {
    ///             Certificates = new[]
    ///             {
    ///                 new AzureNative.ContainerRegistry.V20201101Preview.Inputs.TokenCertificateArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerregistry/v20201101preview:Token")]
    public partial class Token : global::Pulumi.CustomResource
    {
        ...
        public Token(string name, TokenArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20201101preview:Token", name, args ?? new TokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Token(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerregistry/v20201101preview:Token", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TokenArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.ContainerRegistry.V20201101Preview.TokenStatus>? Status { get; set; }
