...
namespace Pulumi.AzureRM.ContainerRegistry.V20170301
{
    ...
    public partial class Registry : Pulumi.CustomResource
    {
        ...
        public Registry(string name, RegistryArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/v20170301:Registry", name, args ?? new RegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerregistry/v20170301:Registry", name, null, MakeResourceOptions(options, id))
        {
        }
