...
namespace Pulumi.AzureNative.AzureDataTransfer.V20250301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azuredatatransfer/v20250301preview:Pipeline")]
    public partial class Pipeline : global::Pulumi.CustomResource
    {
        ...
        public Pipeline(string name, PipelineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuredatatransfer/v20250301preview:Pipeline", name, args ?? new PipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuredatatransfer/v20250301preview:Pipeline", name, null, MakeResourceOptions(options, id))
        {
        }
