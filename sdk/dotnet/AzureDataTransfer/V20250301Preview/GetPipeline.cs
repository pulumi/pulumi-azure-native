...
namespace Pulumi.AzureNative.AzureDataTransfer.V20250301Preview
{
    public static class GetPipeline
    {
        ...
        public static Task<GetPipelineResult> InvokeAsync(GetPipelineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPipelineResult>("azure-native:azuredatatransfer/v20250301preview:getPipeline", args ?? new GetPipelineArgs(), options.WithDefaults());

        /// <summary>
        /// Gets pipeline resource.
        /// </summary>
        public static Output<GetPipelineResult> Invoke(GetPipelineInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPipelineResult>("azure-native:azuredatatransfer/v20250301preview:getPipeline", args ?? new GetPipelineInvokeArgs(), options.WithDefaults());
