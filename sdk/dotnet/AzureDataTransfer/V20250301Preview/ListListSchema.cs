...
namespace Pulumi.AzureNative.AzureDataTransfer.V20250301Preview
{
    public static class ListListSchema
    {
        ...
        public static Task<ListListSchemaResult> InvokeAsync(ListListSchemaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListListSchemaResult>("azure-native:azuredatatransfer/v20250301preview:listListSchema", args ?? new ListListSchemaArgs(), options.WithDefaults());

        /// <summary>
        /// Lists the schemas for the specified connection in a pipeline.
        /// </summary>
        public static Output<ListListSchemaResult> Invoke(ListListSchemaInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListListSchemaResult>("azure-native:azuredatatransfer/v20250301preview:listListSchema", args ?? new ListListSchemaInvokeArgs(), options.WithDefaults());
    ...
    public sealed class ListListSchemaArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public Union<string, Pulumi.AzureNative.AzureDataTransfer.V20250301Preview.SchemaDirection>? Direction { get; set; }
        ...
        /// </summary>
        [Input("schemaType")]
        public Union<string, Pulumi.AzureNative.AzureDataTransfer.V20250301Preview.SchemaType>? SchemaType { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public Union<string, Pulumi.AzureNative.AzureDataTransfer.V20250301Preview.SchemaStatus>? Status { get; set; }
    ...
    public sealed class ListListSchemaInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public InputUnion<string, Pulumi.AzureNative.AzureDataTransfer.V20250301Preview.SchemaDirection>? Direction { get; set; }
        ...
        /// </summary>
        [Input("schemaType")]
        public InputUnion<string, Pulumi.AzureNative.AzureDataTransfer.V20250301Preview.SchemaType>? SchemaType { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.AzureDataTransfer.V20250301Preview.SchemaStatus>? Status { get; set; }
