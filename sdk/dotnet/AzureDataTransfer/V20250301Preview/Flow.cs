...
namespace Pulumi.AzureNative.AzureDataTransfer.V20250301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azuredatatransfer/v20250301preview:Flow")]
    public partial class Flow : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.FlowPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public Flow(string name, FlowArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuredatatransfer/v20250301preview:Flow", name, args ?? new FlowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Flow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuredatatransfer/v20250301preview:Flow", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FlowArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.FlowPropertiesArgs>? Properties { get; set; }
