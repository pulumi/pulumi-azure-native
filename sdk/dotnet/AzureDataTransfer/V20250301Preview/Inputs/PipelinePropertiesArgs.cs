...
namespace Pulumi.AzureNative.AzureDataTransfer.V20250301Preview.Inputs
{
    ...
    public sealed class PipelinePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("flowTypes")]
        private InputList<Union<string, Pulumi.AzureNative.AzureDataTransfer.V20250301Preview.FlowType>>? _flowTypes;

        /// <summary>
        /// The flow types allowed for this pipeline
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AzureDataTransfer.V20250301Preview.FlowType>> FlowTypes
        {
            get => _flowTypes ?? (_flowTypes = new InputList<Union<string, Pulumi.AzureNative.AzureDataTransfer.V20250301Preview.FlowType>>());
