...
namespace Pulumi.AzureNative.AzureDataTransfer.V20231011Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azuredatatransfer/v20231011preview:Flow")]
    public partial class Flow : global::Pulumi.CustomResource
    {
        ...
        public Flow(string name, FlowArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuredatatransfer/v20231011preview:Flow", name, args ?? new FlowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Flow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuredatatransfer/v20231011preview:Flow", name, null, MakeResourceOptions(options, id))
        {
        }
