...
namespace Pulumi.AzureNative.AzureDataTransfer.V20231011Preview
{
    public static class GetConnection
    {
        ...
        public static Task<GetConnectionResult> InvokeAsync(GetConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectionResult>("azure-native:azuredatatransfer/v20231011preview:getConnection", args ?? new GetConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// Gets connection resource.
        /// </summary>
        public static Output<GetConnectionResult> Invoke(GetConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectionResult>("azure-native:azuredatatransfer/v20231011preview:getConnection", args ?? new GetConnectionInvokeArgs(), options.WithDefaults());
