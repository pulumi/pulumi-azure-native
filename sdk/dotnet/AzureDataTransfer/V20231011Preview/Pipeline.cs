...
namespace Pulumi.AzureNative.AzureDataTransfer.V20231011Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azuredatatransfer/v20231011preview:Pipeline")]
    public partial class Pipeline : global::Pulumi.CustomResource
    {
        ...
        public Pipeline(string name, PipelineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuredatatransfer/v20231011preview:Pipeline", name, args ?? new PipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuredatatransfer/v20231011preview:Pipeline", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:azuredatatransfer:Pipeline" },
                },
            };
