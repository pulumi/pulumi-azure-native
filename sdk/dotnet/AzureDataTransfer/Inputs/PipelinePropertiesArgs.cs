...
namespace Pulumi.AzureNative.AzureDataTransfer.Inputs
{
    ...
    public sealed class PipelinePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("flowTypes")]
        private InputList<Union<string, Pulumi.AzureNative.AzureDataTransfer.FlowType>>? _flowTypes;

        /// <summary>
        /// The flow types allowed for this pipeline
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AzureDataTransfer.FlowType>> FlowTypes
        {
            get => _flowTypes ?? (_flowTypes = new InputList<Union<string, Pulumi.AzureNative.AzureDataTransfer.FlowType>>());
