...
namespace Pulumi.AzureNative.AzureDataTransfer.Inputs
{
    ...
    public sealed class FlowPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("flowType")]
        public InputUnion<string, Pulumi.AzureNative.AzureDataTransfer.FlowType>? FlowType { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.AzureDataTransfer.FlowStatus>? Status { get; set; }
