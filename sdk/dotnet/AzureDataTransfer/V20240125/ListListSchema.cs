...
namespace Pulumi.AzureNative.AzureDataTransfer.V20240125
{
    public static class ListListSchema
    {
        ...
        public static Task<ListListSchemaResult> InvokeAsync(ListListSchemaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListListSchemaResult>("azure-native:azuredatatransfer/v20240125:listListSchema", args ?? new ListListSchemaArgs(), options.WithDefaults());

        /// <summary>
        /// Lists the schemas for the specified connection in a pipeline.
        /// </summary>
        public static Output<ListListSchemaResult> Invoke(ListListSchemaInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListListSchemaResult>("azure-native:azuredatatransfer/v20240125:listListSchema", args ?? new ListListSchemaInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class ListListSchemaArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Union<string, Pulumi.AzureNative.AzureDataTransfer.V20240125.SchemaStatus>? Status { get; set; }
