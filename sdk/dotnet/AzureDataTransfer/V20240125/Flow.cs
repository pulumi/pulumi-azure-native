...
namespace Pulumi.AzureNative.AzureDataTransfer.V20240125
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azuredatatransfer/v20240125:Flow")]
    public partial class Flow : global::Pulumi.CustomResource
    {
        ...
        public Flow(string name, FlowArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuredatatransfer/v20240125:Flow", name, args ?? new FlowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Flow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuredatatransfer/v20240125:Flow", name, null, MakeResourceOptions(options, id))
        {
        }
