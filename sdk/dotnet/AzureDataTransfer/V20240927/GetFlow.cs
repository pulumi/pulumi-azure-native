...
namespace Pulumi.AzureNative.AzureDataTransfer.V20240927
{
    public static class GetFlow
    {
        ...
        public static Task<GetFlowResult> InvokeAsync(GetFlowArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFlowResult>("azure-native:azuredatatransfer/v20240927:getFlow", args ?? new GetFlowArgs(), options.WithDefaults());
