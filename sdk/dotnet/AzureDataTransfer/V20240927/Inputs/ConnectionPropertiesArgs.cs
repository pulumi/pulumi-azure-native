...
namespace Pulumi.AzureNative.AzureDataTransfer.V20240927.Inputs
{
    ...
    public sealed class ConnectionPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public InputUnion<string, Pulumi.AzureNative.AzureDataTransfer.V20240927.Direction>? Direction { get; set; }

        [Input("flowTypes")]
        private InputList<Union<string, Pulumi.AzureNative.AzureDataTransfer.V20240927.FlowType>>? _flowTypes;

        /// <summary>
        /// The flow types being requested for this connection
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AzureDataTransfer.V20240927.FlowType>> FlowTypes
        {
            get => _flowTypes ?? (_flowTypes = new InputList<Union<string, Pulumi.AzureNative.AzureDataTransfer.V20240927.FlowType>>());
