...
namespace Pulumi.AzureNative.AzureDataTransfer.V20240927
{
    public static class ListAzureDataTransferApprovedSchemas
    {
        ...
        public static Task<ListAzureDataTransferApprovedSchemasResult> InvokeAsync(ListAzureDataTransferApprovedSchemasArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAzureDataTransferApprovedSchemasResult>("azure-native:azuredatatransfer/v20240927:listAzureDataTransferApprovedSchemas", args ?? new ListAzureDataTransferApprovedSchemasArgs(), options.WithDefaults());
    ...
    public sealed class ListAzureDataTransferApprovedSchemasArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public Union<string, Pulumi.AzureNative.AzureDataTransfer.V20240927.ListApprovedSchemasDirection>? Direction { get; set; }
    ...
    public sealed class ListAzureDataTransferApprovedSchemasInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public InputUnion<string, Pulumi.AzureNative.AzureDataTransfer.V20240927.ListApprovedSchemasDirection>? Direction { get; set; }
