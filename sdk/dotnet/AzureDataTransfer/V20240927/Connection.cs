...
namespace Pulumi.AzureNative.AzureDataTransfer.V20240927
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azuredatatransfer/v20240927:Connection")]
    public partial class Connection : global::Pulumi.CustomResource
    {
        ...
        public Connection(string name, ConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuredatatransfer/v20240927:Connection", name, args ?? new ConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuredatatransfer/v20240927:Connection", name, null, MakeResourceOptions(options, id))
        {
        }
