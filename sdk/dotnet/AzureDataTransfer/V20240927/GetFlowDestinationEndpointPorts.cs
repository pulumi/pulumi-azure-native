...
namespace Pulumi.AzureNative.AzureDataTransfer.V20240927
{
    public static class GetFlowDestinationEndpointPorts
    {
        ...
        public static Task<GetFlowDestinationEndpointPortsResult> InvokeAsync(GetFlowDestinationEndpointPortsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFlowDestinationEndpointPortsResult>("azure-native:azuredatatransfer/v20240927:getFlowDestinationEndpointPorts", args ?? new GetFlowDestinationEndpointPortsArgs(), options.WithDefaults());
