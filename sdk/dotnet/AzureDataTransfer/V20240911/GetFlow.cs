...
namespace Pulumi.AzureNative.AzureDataTransfer.V20240911
{
    public static class GetFlow
    {
        ...
        public static Task<GetFlowResult> InvokeAsync(GetFlowArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFlowResult>("azure-native:azuredatatransfer/v20240911:getFlow", args ?? new GetFlowArgs(), options.WithDefaults());

        /// <summary>
        /// Gets flow resource.
        /// </summary>
        public static Output<GetFlowResult> Invoke(GetFlowInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFlowResult>("azure-native:azuredatatransfer/v20240911:getFlow", args ?? new GetFlowInvokeArgs(), options.WithDefaults());
