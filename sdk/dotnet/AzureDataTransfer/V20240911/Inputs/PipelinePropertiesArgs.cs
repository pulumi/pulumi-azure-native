...
namespace Pulumi.AzureNative.AzureDataTransfer.V20240911.Inputs
{
    ...
    public sealed class PipelinePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("flowTypes")]
        private InputList<Union<string, Pulumi.AzureNative.AzureDataTransfer.V20240911.FlowType>>? _flowTypes;

        /// <summary>
        /// The flow types allowed for this pipeline
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AzureDataTransfer.V20240911.FlowType>> FlowTypes
        {
            get => _flowTypes ?? (_flowTypes = new InputList<Union<string, Pulumi.AzureNative.AzureDataTransfer.V20240911.FlowType>>());
