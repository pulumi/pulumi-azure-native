...
namespace Pulumi.AzureNative.StorageCache.V20230301Preview
{
    ...
    /// {
    ///     var storageTarget = new AzureNative.StorageCache.V20230301Preview.StorageTarget("storageTarget", new()
    ///     {
    ///         CacheName = "sc1",
    ///         Junctions = new[]
    ///         {
    ///             new AzureNative.StorageCache.V20230301Preview.Inputs.NamespaceJunctionArgs
    ///             {
    ...
    ///             },
    ///         },
    ///         Nfs3 = new AzureNative.StorageCache.V20230301Preview.Inputs.Nfs3TargetArgs
    ///         {
    ///             Target = "10.0.44.44",
    ...
    ///     var storageTarget = new AzureNative.StorageCache.V20230301Preview.StorageTarget("storageTarget", new()
    ///     {
    ///         BlobNfs = new AzureNative.StorageCache.V20230301Preview.Inputs.BlobNfsTargetArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storagecache/v20230301preview:StorageTarget")]
    public partial class StorageTarget : global::Pulumi.CustomResource
    {
        ...
        public StorageTarget(string name, StorageTargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20230301preview:StorageTarget", name, args ?? new StorageTargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageTarget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20230301preview:StorageTarget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageTargetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20230301Preview.OperationalStateType>? State { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20230301Preview.StorageTargetType> TargetType { get; set; } = null!;
