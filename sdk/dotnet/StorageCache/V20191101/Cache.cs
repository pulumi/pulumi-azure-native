...
namespace Pulumi.AzureNative.StorageCache.V20191101
{
    ...
    public partial class Cache : global::Pulumi.CustomResource
    {
        ...
        public Cache(string name, CacheArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20191101:Cache", name, args ?? new CacheArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cache(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20191101:Cache", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CacheArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20191101.ProvisioningStateType>? ProvisioningState { get; set; }
