...
namespace Pulumi.AzureNative.StorageCache.V20191101
{
    ...
    public partial class StorageTarget : Pulumi.CustomResource
    {
        ...
        public StorageTarget(string name, StorageTargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20191101:StorageTarget", name, args ?? new StorageTargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageTarget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20191101:StorageTarget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageTargetArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("targetType")]
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20191101.StorageTargetType>? TargetType { get; set; }
