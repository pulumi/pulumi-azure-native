...
namespace Pulumi.AzureRM.StorageCache.Latest
{
    public static class GetStorageTarget
    {
        public static Task<GetStorageTargetResult> InvokeAsync(GetStorageTargetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageTargetResult>("azurerm:storagecache/latest:getStorageTarget", args ?? new GetStorageTargetArgs(), options.WithVersion());
    }
