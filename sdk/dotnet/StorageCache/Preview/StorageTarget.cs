...
namespace Pulumi.AzureRM.StorageCache.Preview
{
    ...
    public partial class StorageTarget : Pulumi.CustomResource
    {
        ...
        public StorageTarget(string name, StorageTargetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagecache/preview:StorageTarget", name, args ?? new StorageTargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageTarget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagecache/preview:StorageTarget", name, null, MakeResourceOptions(options, id))
        {
        }
