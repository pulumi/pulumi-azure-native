...
namespace Pulumi.AzureRM.StorageCache.Preview
{
    ...
    public partial class Cache : Pulumi.CustomResource
    {
        ...
        public Cache(string name, CacheArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagecache/preview:Cache", name, args ?? new CacheArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cache(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagecache/preview:Cache", name, null, MakeResourceOptions(options, id))
        {
        }
