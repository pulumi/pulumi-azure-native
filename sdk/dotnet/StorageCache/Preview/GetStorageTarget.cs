...
namespace Pulumi.AzureRM.StorageCache.Preview
{
    public static class GetStorageTarget
    {
        public static Task<GetStorageTargetResult> InvokeAsync(GetStorageTargetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageTargetResult>("azurerm:storagecache/preview:getStorageTarget", args ?? new GetStorageTargetArgs(), options.WithVersion());
    }
