...
namespace Pulumi.AzureNative.StorageCache.V20230501
{
    public static class GetamlFilesystem
    {
        ...
        public static Task<GetamlFilesystemResult> InvokeAsync(GetamlFilesystemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetamlFilesystemResult>("azure-native:storagecache/v20230501:getamlFilesystem", args ?? new GetamlFilesystemArgs(), options.WithDefaults());

        /// <summary>
        /// Returns an AML file system.
        /// </summary>
        public static Output<GetamlFilesystemResult> Invoke(GetamlFilesystemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetamlFilesystemResult>("azure-native:storagecache/v20230501:getamlFilesystem", args ?? new GetamlFilesystemInvokeArgs(), options.WithDefaults());
    }
