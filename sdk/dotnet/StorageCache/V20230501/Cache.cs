...
namespace Pulumi.AzureNative.StorageCache.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagecache/v20230501:Cache")]
    public partial class Cache : global::Pulumi.CustomResource
    {
        ...
        public Cache(string name, CacheArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20230501:Cache", name, args ?? new CacheArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cache(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20230501:Cache", name, null, MakeResourceOptions(options, id))
        {
        }
