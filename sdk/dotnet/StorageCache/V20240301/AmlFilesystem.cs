...
namespace Pulumi.AzureNative.StorageCache.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagecache/v20240301:AmlFilesystem")]
    public partial class AmlFilesystem : global::Pulumi.CustomResource
    {
        ...
        public AmlFilesystem(string name, AmlFilesystemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20240301:AmlFilesystem", name, args ?? new AmlFilesystemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AmlFilesystem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20240301:AmlFilesystem", name, null, MakeResourceOptions(options, id))
        {
        }
