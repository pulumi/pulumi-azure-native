...
namespace Pulumi.AzureNative.StorageCache.V20240301
{
    public static class GetAmlFilesystem
    {
        ...
        public static Task<GetAmlFilesystemResult> InvokeAsync(GetAmlFilesystemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAmlFilesystemResult>("azure-native:storagecache/v20240301:getAmlFilesystem", args ?? new GetAmlFilesystemArgs(), options.WithDefaults());
