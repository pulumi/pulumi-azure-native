...
namespace Pulumi.AzureRM.StorageCache.V20190801Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cache = new AzureRM.StorageCache.V20190801Preview.Cache("cache", new AzureRM.StorageCache.V20190801Preview.CacheArgs
    ///         {
    ///             CacheName = "sc1",
    ///             CacheSizeGB = 3072,
    ///             Location = "westus",
    ///             ResourceGroupName = "scgroup",
    ///             Sku = new AzureRM.StorageCache.V20190801Preview.Inputs.CacheSkuArgs
    ///             {
    ///                 Name = "Standard_2G",
    ///             },
    ...
    public partial class Cache : Pulumi.CustomResource
    {
        ...
        public Cache(string name, CacheArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagecache/v20190801preview:Cache", name, args ?? new CacheArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cache(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagecache/v20190801preview:Cache", name, null, MakeResourceOptions(options, id))
        {
        }
