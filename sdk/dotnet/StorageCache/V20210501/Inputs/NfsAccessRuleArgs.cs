...
namespace Pulumi.AzureNative.StorageCache.V20210501.Inputs
{
    ...
    public sealed class NfsAccessRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20210501.NfsAccessRuleAccess> Access { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20210501.NfsAccessRuleScope> Scope { get; set; } = null!;
