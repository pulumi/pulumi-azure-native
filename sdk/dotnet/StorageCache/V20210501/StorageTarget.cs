...
namespace Pulumi.AzureNative.StorageCache.V20210501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagecache/v20210501:StorageTarget")]
    public partial class StorageTarget : Pulumi.CustomResource
    {
        ...
        public StorageTarget(string name, StorageTargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20210501:StorageTarget", name, args ?? new StorageTargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageTarget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20210501:StorageTarget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageTargetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20210501.StorageTargetType> TargetType { get; set; } = null!;
