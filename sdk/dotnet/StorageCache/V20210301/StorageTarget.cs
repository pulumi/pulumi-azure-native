...
namespace Pulumi.AzureNative.StorageCache.V20210301
{
    /// <summary>
    ...
    public partial class StorageTarget : global::Pulumi.CustomResource
    {
        ...
        public StorageTarget(string name, StorageTargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20210301:StorageTarget", name, args ?? new StorageTargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageTarget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20210301:StorageTarget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageTargetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20210301.ProvisioningStateType>? ProvisioningState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20210301.StorageTargetType> TargetType { get; set; } = null!;
