...
namespace Pulumi.AzureRM.StorageCache.V20200301
{
    public static class GetStorageTarget
    {
        public static Task<GetStorageTargetResult> InvokeAsync(GetStorageTargetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageTargetResult>("azurerm:storagecache/v20200301:getStorageTarget", args ?? new GetStorageTargetArgs(), options.WithVersion());
    }
