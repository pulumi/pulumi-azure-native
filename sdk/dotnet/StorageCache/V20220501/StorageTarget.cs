...
namespace Pulumi.AzureNative.StorageCache.V20220501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storagecache/v20220501:StorageTarget is being removed in the next major version of this provider. Upgrade to at least azure-native:storagecache/v20230301preview:StorageTarget to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storagecache/v20220501:StorageTarget")]
    public partial class StorageTarget : global::Pulumi.CustomResource
    {
        ...
        public StorageTarget(string name, StorageTargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20220501:StorageTarget", name, args ?? new StorageTargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageTarget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20220501:StorageTarget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageTargetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20220501.OperationalStateType>? State { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20220501.StorageTargetType> TargetType { get; set; } = null!;
