...
namespace Pulumi.AzureNative.StorageCache.V20220501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storagecache/v20220501:Cache is being removed in the next major version of this provider. Upgrade to at least azure-native:storagecache/v20230301preview:Cache to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storagecache/v20220501:Cache")]
    public partial class Cache : global::Pulumi.CustomResource
    {
        ...
        public Cache(string name, CacheArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20220501:Cache", name, args ?? new CacheArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cache(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20220501:Cache", name, null, MakeResourceOptions(options, id))
        {
        }
