...
namespace Pulumi.AzureNative.StorageCache
{
    ...
    public partial class AmlFilesystem : global::Pulumi.CustomResource
    {
        ...
        public AmlFilesystem(string name, AmlFilesystemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache:AmlFilesystem", name, args ?? new AmlFilesystemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AmlFilesystem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache:AmlFilesystem", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_storagecache_v20230301preview:storagecache:AmlFilesystem" },
                    new global::Pulumi.Alias { Type = "azure-native_storagecache_v20230501:storagecache:AmlFilesystem" },
                    new global::Pulumi.Alias { Type = "azure-native_storagecache_v20231101preview:storagecache:AmlFilesystem" },
                    new global::Pulumi.Alias { Type = "azure-native_storagecache_v20240301:storagecache:AmlFilesystem" },
                    new global::Pulumi.Alias { Type = "azure-native_storagecache_v20240701:storagecache:AmlFilesystem" },
                },
            };
