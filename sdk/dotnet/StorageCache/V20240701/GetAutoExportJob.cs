...
namespace Pulumi.AzureNative.StorageCache.V20240701
{
    public static class GetAutoExportJob
    {
        ...
        public static Task<GetAutoExportJobResult> InvokeAsync(GetAutoExportJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAutoExportJobResult>("azure-native:storagecache/v20240701:getAutoExportJob", args ?? new GetAutoExportJobArgs(), options.WithDefaults());

        /// <summary>
        /// Returns an auto export job.
        /// </summary>
        public static Output<GetAutoExportJobResult> Invoke(GetAutoExportJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAutoExportJobResult>("azure-native:storagecache/v20240701:getAutoExportJob", args ?? new GetAutoExportJobInvokeArgs(), options.WithDefaults());
