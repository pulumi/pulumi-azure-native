...
namespace Pulumi.AzureNative.StorageCache.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagecache/v20240701:AmlFilesystem")]
    public partial class AmlFilesystem : global::Pulumi.CustomResource
    {
        ...
        public AmlFilesystem(string name, AmlFilesystemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20240701:AmlFilesystem", name, args ?? new AmlFilesystemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AmlFilesystem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20240701:AmlFilesystem", name, null, MakeResourceOptions(options, id))
        {
        }
