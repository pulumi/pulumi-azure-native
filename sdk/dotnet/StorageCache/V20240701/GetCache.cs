...
namespace Pulumi.AzureNative.StorageCache.V20240701
{
    public static class GetCache
    {
        ...
        public static Task<GetCacheResult> InvokeAsync(GetCacheArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCacheResult>("azure-native:storagecache/v20240701:getCache", args ?? new GetCacheArgs(), options.WithDefaults());

        /// <summary>
        /// Returns a cache.
        /// </summary>
        public static Output<GetCacheResult> Invoke(GetCacheInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCacheResult>("azure-native:storagecache/v20240701:getCache", args ?? new GetCacheInvokeArgs(), options.WithDefaults());
