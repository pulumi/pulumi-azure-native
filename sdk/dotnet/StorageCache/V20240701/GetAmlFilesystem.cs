...
namespace Pulumi.AzureNative.StorageCache.V20240701
{
    public static class GetAmlFilesystem
    {
        ...
        public static Task<GetAmlFilesystemResult> InvokeAsync(GetAmlFilesystemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAmlFilesystemResult>("azure-native:storagecache/v20240701:getAmlFilesystem", args ?? new GetAmlFilesystemArgs(), options.WithDefaults());

        /// <summary>
        /// Returns an AML file system.
        /// </summary>
        public static Output<GetAmlFilesystemResult> Invoke(GetAmlFilesystemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAmlFilesystemResult>("azure-native:storagecache/v20240701:getAmlFilesystem", args ?? new GetAmlFilesystemInvokeArgs(), options.WithDefaults());
