...
namespace Pulumi.AzureNative.StorageCache.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagecache/v20240701:ImportJob")]
    public partial class ImportJob : global::Pulumi.CustomResource
    {
        ...
        public ImportJob(string name, ImportJobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20240701:ImportJob", name, args ?? new ImportJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImportJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20240701:ImportJob", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ImportJobArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20240701.ConflictResolutionMode>? ConflictResolutionMode { get; set; }
