...
namespace Pulumi.AzureNative.StorageCache.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagecache/v20240701:StorageTarget")]
    public partial class StorageTarget : global::Pulumi.CustomResource
    {
        ...
        public StorageTarget(string name, StorageTargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20240701:StorageTarget", name, args ?? new StorageTargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageTarget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20240701:StorageTarget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageTargetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20240701.OperationalStateType>? State { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20240701.StorageTargetType> TargetType { get; set; } = null!;
