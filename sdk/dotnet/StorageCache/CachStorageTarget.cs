...
namespace Pulumi.AzureRM.StorageCache
{
    ...
    public partial class CachStorageTarget : Pulumi.CustomResource
    {
        ...
        private CachStorageTarget(string name, Input<string> id, CachStorageTargetState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:storagecache:CachStorageTarget", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CachStorageTarget Get(string name, Input<string> id, CachStorageTargetState? state = null, CustomResourceOptions? options = null)
        {
            return new CachStorageTarget(name, id, state, options);
        }
    }
    ...
    public sealed class CachStorageTargetState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Name of the Storage Target.
        /// </summary>
        ...
        public Input<Inputs.StorageTargetPropertiesResponseGetArgs> Properties { get; set; } = null!;
