...
namespace Pulumi.AzureNative.StorageCache
{
    ...
    public partial class ImportJob : global::Pulumi.CustomResource
    {
        ...
        public ImportJob(string name, ImportJobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache:ImportJob", name, args ?? new ImportJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImportJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache:ImportJob", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_storagecache_v20240301:storagecache:ImportJob" },
                    new global::Pulumi.Alias { Type = "azure-native_storagecache_v20240701:storagecache:ImportJob" },
                },
            };
