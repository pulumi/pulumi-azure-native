...
namespace Pulumi.AzureNextGen.StorageCache
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storagecache:Cache")]
    public partial class Cache : Pulumi.CustomResource
    {
        ...
        public Cache(string name, CacheArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagecache:Cache", name, args ?? new CacheArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cache(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagecache:Cache", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CacheArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.StorageCache.ProvisioningStateType>? ProvisioningState { get; set; }
