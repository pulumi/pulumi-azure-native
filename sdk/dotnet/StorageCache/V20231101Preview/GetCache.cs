...
namespace Pulumi.AzureNative.StorageCache.V20231101Preview
{
    public static class GetCache
    {
        ...
        public static Task<GetCacheResult> InvokeAsync(GetCacheArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCacheResult>("azure-native:storagecache/v20231101preview:getCache", args ?? new GetCacheArgs(), options.WithDefaults());

        /// <summary>
        /// Returns a cache.
        /// </summary>
        public static Output<GetCacheResult> Invoke(GetCacheInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCacheResult>("azure-native:storagecache/v20231101preview:getCache", args ?? new GetCacheInvokeArgs(), options.WithDefaults());
    }
