...
namespace Pulumi.AzureNative.StorageCache.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagecache/v20231101preview:Cache")]
    public partial class Cache : global::Pulumi.CustomResource
    {
        ...
        public Cache(string name, CacheArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20231101preview:Cache", name, args ?? new CacheArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cache(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20231101preview:Cache", name, null, MakeResourceOptions(options, id))
        {
        }
