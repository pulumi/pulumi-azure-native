...
namespace Pulumi.AzureNative.StorageCache.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagecache/v20231101preview:AmlFilesystem")]
    public partial class AmlFilesystem : global::Pulumi.CustomResource
    {
        ...
        public AmlFilesystem(string name, AmlFilesystemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20231101preview:AmlFilesystem", name, args ?? new AmlFilesystemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AmlFilesystem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20231101preview:AmlFilesystem", name, null, MakeResourceOptions(options, id))
        {
        }
