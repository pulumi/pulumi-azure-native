...
namespace Pulumi.AzureNative.StorageCache.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagecache/v20220101:Cache")]
    public partial class Cache : Pulumi.CustomResource
    {
        ...
        public Cache(string name, CacheArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20220101:Cache", name, args ?? new CacheArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cache(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20220101:Cache", name, null, MakeResourceOptions(options, id))
        {
        }
