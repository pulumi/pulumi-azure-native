...
namespace Pulumi.AzureNextGen.StorageCache.V20201001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storagecache/v20201001:StorageTarget")]
    public partial class StorageTarget : Pulumi.CustomResource
    {
        ...
        public StorageTarget(string name, StorageTargetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagecache/v20201001:StorageTarget", name, args ?? new StorageTargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageTarget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagecache/v20201001:StorageTarget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageTargetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.StorageCache.V20201001.ProvisioningStateType>? ProvisioningState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.StorageCache.V20201001.StorageTargetType> TargetType { get; set; } = null!;
