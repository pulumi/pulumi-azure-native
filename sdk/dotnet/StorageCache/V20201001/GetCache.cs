...
namespace Pulumi.AzureNative.StorageCache.V20201001
{
    public static class GetCache
    {
        ...
        public static Task<GetCacheResult> InvokeAsync(GetCacheArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCacheResult>("azure-native:storagecache/v20201001:getCache", args ?? new GetCacheArgs(), options.WithVersion());

        /// <summary>
        /// A Cache instance. Follows Azure Resource Manager standards: https://github.com/Azure/azure-resource-manager-rpc/blob/master/v1.0/resource-api-reference.md
        /// </summary>
        public static Output<GetCacheResult> Invoke(GetCacheInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCacheResult>("azure-native:storagecache/v20201001:getCache", args ?? new GetCacheInvokeArgs(), options.WithVersion());
    }
