...
namespace Pulumi.AzureNative.StorageCache.V20201001.Inputs
{
    ...
    public sealed class NfsAccessRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20201001.NfsAccessRuleAccess> Access { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20201001.NfsAccessRuleScope> Scope { get; set; } = null!;
