...
namespace Pulumi.AzureNative.StorageCache.V20210901
{
    ...
    [AzureNativeResourceType("azure-native:storagecache/v20210901:Cache")]
    public partial class Cache : global::Pulumi.CustomResource
    {
        ...
        public Cache(string name, CacheArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20210901:Cache", name, args ?? new CacheArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cache(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagecache/v20210901:Cache", name, null, MakeResourceOptions(options, id))
        {
        }
