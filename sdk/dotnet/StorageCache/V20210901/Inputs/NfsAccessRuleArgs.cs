...
namespace Pulumi.AzureNative.StorageCache.V20210901.Inputs
{
    ...
    public sealed class NfsAccessRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20210901.NfsAccessRuleAccess> Access { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageCache.V20210901.NfsAccessRuleScope> Scope { get; set; } = null!;
