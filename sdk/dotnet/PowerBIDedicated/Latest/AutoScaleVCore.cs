...
namespace Pulumi.AzureNative.PowerBIDedicated.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:powerbidedicated:AutoScaleVCore'.")]
    [AzureNativeResourceType("azure-native:powerbidedicated/latest:AutoScaleVCore")]
    public partial class AutoScaleVCore : Pulumi.CustomResource
    {
        ...
        public AutoScaleVCore(string name, AutoScaleVCoreArgs args, CustomResourceOptions? options = null)
            : base("azure-native:powerbidedicated/latest:AutoScaleVCore", name, args ?? new AutoScaleVCoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutoScaleVCore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:powerbidedicated/latest:AutoScaleVCore", name, null, MakeResourceOptions(options, id))
        {
        }
