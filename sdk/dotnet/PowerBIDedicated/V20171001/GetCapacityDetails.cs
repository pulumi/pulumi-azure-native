...
namespace Pulumi.AzureNative.PowerBIDedicated.V20171001
{
    public static class GetCapacityDetails
    {
        ...
        public static Output<GetCapacityDetailsResult> Invoke(GetCapacityDetailsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCapacityDetailsResult>("azure-native:powerbidedicated/v20171001:getCapacityDetails", args ?? new GetCapacityDetailsInvokeArgs(), options.WithVersion());
    }
