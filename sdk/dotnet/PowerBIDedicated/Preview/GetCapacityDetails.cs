...
namespace Pulumi.AzureRM.PowerBIDedicated.Preview
{
    public static class GetCapacityDetails
    {
        public static Task<GetCapacityDetailsResult> InvokeAsync(GetCapacityDetailsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCapacityDetailsResult>("azurerm:powerbidedicated/preview:getCapacityDetails", args ?? new GetCapacityDetailsArgs(), options.WithVersion());
    }
