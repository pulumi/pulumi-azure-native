...
namespace Pulumi.AzureNative.PowerBIDedicated.V20210101
{
    ...
    public partial class CapacityDetails : Pulumi.CustomResource
    {
        ...
        public CapacityDetails(string name, CapacityDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:powerbidedicated/v20210101:CapacityDetails", name, args ?? new CapacityDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:powerbidedicated/v20210101:CapacityDetails", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CapacityDetailsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.PowerBIDedicated.V20210101.Mode>? Mode { get; set; }
