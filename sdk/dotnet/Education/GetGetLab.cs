...
{
    public static class GetGetLab
    {
        /// <summary>
        /// Lab details.
        /// API Version: 2021-12-01-preview.
        /// </summary>
        public static Task<GetGetLabResult> InvokeAsync(GetGetLabArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGetLabResult>("azure-native:education:getGetLab", args ?? new GetGetLabArgs(), options.WithDefaults());

        /// <summary>
        /// Lab details.
        /// API Version: 2021-12-01-preview.
        /// </summary>
        public static Output<GetGetLabResult> Invoke(GetGetLabInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGetLabResult>("azure-native:education:getGetLab", args ?? new GetGetLabInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetGetLabArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetGetLabArgs()
        {
        }
    }

    public sealed class GetGetLabInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// Billing account name.
        /// </summary>
    ...
    [OutputType]
    public sealed class GetGetLabResult
    {
        /// <summary>
