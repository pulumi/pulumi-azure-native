...
{
    public static class GetGetStudent
    {
        /// <summary>
        /// Student details.
        /// </summary>
        public static Task<GetGetStudentResult> InvokeAsync(GetGetStudentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGetStudentResult>("azure-native:education/v20211201preview:getGetStudent", args ?? new GetGetStudentArgs(), options.WithDefaults());

        /// <summary>
        /// Student details.
        /// </summary>
        public static Output<GetGetStudentResult> Invoke(GetGetStudentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGetStudentResult>("azure-native:education/v20211201preview:getGetStudent", args ?? new GetGetStudentInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetGetStudentArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetGetStudentArgs()
        {
        }
    }

    public sealed class GetGetStudentInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// Billing account name.
        /// </summary>
        ...
        public GetGetStudentInvokeArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetGetStudentResult
    {
        /// <summary>
        /// Student Budget
        /// </summary>
