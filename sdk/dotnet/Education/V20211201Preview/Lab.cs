...
namespace Pulumi.AzureNative.Education.V20211201Preview
{
    ...
    /// {
    ///     var lab = new AzureNative.Education.V20211201Preview.Lab("lab", new()
    ///     {
    ///         BillingAccountName = "{billingAccountName}",
    ///         BillingProfileName = "{billingProfileName}",
    ///         BudgetPerStudent = new AzureNative.Education.V20211201Preview.Inputs.AmountArgs
    ///         {
    ///             Currency = "USD",
    ///             Value = 100,
    ///         },
    ...
    public partial class Lab : global::Pulumi.CustomResource
    {
        ...
        public Lab(string name, LabArgs args, CustomResourceOptions? options = null)
            : base("azure-native:education/v20211201preview:Lab", name, args ?? new LabArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Lab(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:education/v20211201preview:Lab", name, null, MakeResourceOptions(options, id))
        {
        }
