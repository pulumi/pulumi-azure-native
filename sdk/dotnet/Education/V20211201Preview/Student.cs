...
namespace Pulumi.AzureNative.Education.V20211201Preview
{
    ...
    public partial class Student : global::Pulumi.CustomResource
    {
        ...
        public Student(string name, StudentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:education/v20211201preview:Student", name, args ?? new StudentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Student(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:education/v20211201preview:Student", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:education:Student" },
                },
            };
