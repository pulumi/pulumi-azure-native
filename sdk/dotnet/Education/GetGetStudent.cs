...
namespace Pulumi.AzureNative.Education
{
    public static class GetGetStudent
    {
        ...
        public static Task<GetGetStudentResult> InvokeAsync(GetGetStudentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGetStudentResult>("azure-native:education:getGetStudent", args ?? new GetGetStudentArgs(), options.WithDefaults());
        ...
        public static Output<GetGetStudentResult> Invoke(GetGetStudentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGetStudentResult>("azure-native:education:getGetStudent", args ?? new GetGetStudentInvokeArgs(), options.WithDefaults());
    }
