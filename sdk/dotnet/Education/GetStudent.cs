...
namespace Pulumi.AzureNative.Education
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:education:GetStudent")]
    public partial class GetStudent : Pulumi.CustomResource
    {
        ...
        public GetStudent(string name, GetStudentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:education:GetStudent", name, args ?? new GetStudentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GetStudent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:education:GetStudent", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:education/v20211201preview:GetStudent"},
                },
            };
