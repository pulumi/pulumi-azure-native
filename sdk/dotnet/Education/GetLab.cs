...
namespace Pulumi.AzureNative.Education
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:education:GetLab")]
    public partial class GetLab : Pulumi.CustomResource
    {
        ...
        public GetLab(string name, GetLabArgs args, CustomResourceOptions? options = null)
            : base("azure-native:education:GetLab", name, args ?? new GetLabArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GetLab(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:education:GetLab", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:education/v20211201preview:GetLab"},
                },
            };
