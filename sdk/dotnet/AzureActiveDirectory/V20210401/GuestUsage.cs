...
namespace Pulumi.AzureNative.AzureActiveDirectory.V20210401
{
    ...
    [AzureNativeResourceType("azure-native:azureactivedirectory/v20210401:GuestUsage")]
    public partial class GuestUsage : global::Pulumi.CustomResource
    {
        ...
        public GuestUsage(string name, GuestUsageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azureactivedirectory/v20210401:GuestUsage", name, args ?? new GuestUsageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestUsage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azureactivedirectory/v20210401:GuestUsage", name, null, MakeResourceOptions(options, id))
        {
        }
