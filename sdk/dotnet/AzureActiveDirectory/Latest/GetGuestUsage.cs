...
namespace Pulumi.AzureRM.AzureActiveDirectory.Latest
{
    public static class GetGuestUsage
    {
        public static Task<GetGuestUsageResult> InvokeAsync(GetGuestUsageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGuestUsageResult>("azurerm:azureactivedirectory/latest:getGuestUsage", args ?? new GetGuestUsageArgs(), options.WithVersion());
    }
