...
namespace Pulumi.AzureNative.AzureActiveDirectory.V20230118Preview
{
    ...
    public partial class GuestUsage : global::Pulumi.CustomResource
    {
        ...
        public GuestUsage(string name, GuestUsageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azureactivedirectory/v20230118preview:GuestUsage", name, args ?? new GuestUsageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestUsage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azureactivedirectory/v20230118preview:GuestUsage", name, null, MakeResourceOptions(options, id))
        {
        }
