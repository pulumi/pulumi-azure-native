...
namespace Pulumi.AzureNative.AzureActiveDirectory.V20230118Preview
{
    public static class GetGuestUsage
    {
        ...
        public static Task<GetGuestUsageResult> InvokeAsync(GetGuestUsageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGuestUsageResult>("azure-native:azureactivedirectory/v20230118preview:getGuestUsage", args ?? new GetGuestUsageArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Guest Usages resource for the Microsoft.AzureActiveDirectory resource provider
        /// </summary>
        public static Output<GetGuestUsageResult> Invoke(GetGuestUsageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGuestUsageResult>("azure-native:azureactivedirectory/v20230118preview:getGuestUsage", args ?? new GetGuestUsageInvokeArgs(), options.WithDefaults());
    }
