...
namespace Pulumi.AzureRM.AzureActiveDirectory.Preview
{
    public static class GetGuestUsage
    {
        public static Task<GetGuestUsageResult> InvokeAsync(GetGuestUsageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGuestUsageResult>("azurerm:azureactivedirectory/preview:getGuestUsage", args ?? new GetGuestUsageArgs(), options.WithVersion());
    }
