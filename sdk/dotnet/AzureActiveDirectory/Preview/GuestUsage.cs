...
namespace Pulumi.AzureRM.AzureActiveDirectory.Preview
{
    ...
    public partial class GuestUsage : Pulumi.CustomResource
    {
        ...
        public GuestUsage(string name, GuestUsageArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azureactivedirectory/preview:GuestUsage", name, args ?? new GuestUsageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestUsage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azureactivedirectory/preview:GuestUsage", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:azureactivedirectory/v20200501preview:GuestUsage"},
                },
            };
