...
{
    [AzureNativeResourceType("azure-native:azureactivedirectory/v20230517preview:B2CTenant")]
    public partial class B2CTenant : global::Pulumi.CustomResource
    {
        ...
        public B2CTenant(string name, B2CTenantArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azureactivedirectory/v20230517preview:B2CTenant", name, args ?? new B2CTenantArgs(), MakeResourceOptions(options, ""))
        {
        }

        private B2CTenant(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azureactivedirectory/v20230517preview:B2CTenant", name, null, MakeResourceOptions(options, id))
        {
        }
