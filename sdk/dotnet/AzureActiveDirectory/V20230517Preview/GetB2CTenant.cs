...
namespace Pulumi.AzureNative.AzureActiveDirectory.V20230517Preview
{
    public static class GetB2CTenant
    {
        ...
        public static Task<GetB2CTenantResult> InvokeAsync(GetB2CTenantArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetB2CTenantResult>("azure-native:azureactivedirectory/v20230517preview:getB2CTenant", args ?? new GetB2CTenantArgs(), options.WithDefaults());
