...
namespace Pulumi.AzureNative.AzureActiveDirectory.V20230517Preview
{
    public static class GetCIAMTenant
    {
        ...
        public static Task<GetCIAMTenantResult> InvokeAsync(GetCIAMTenantArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCIAMTenantResult>("azure-native:azureactivedirectory/v20230517preview:getCIAMTenant", args ?? new GetCIAMTenantArgs(), options.WithDefaults());
