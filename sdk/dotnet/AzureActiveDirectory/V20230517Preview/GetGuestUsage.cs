...
namespace Pulumi.AzureNative.AzureActiveDirectory.V20230517Preview
{
    public static class GetGuestUsage
    {
        ...
        public static Task<GetGuestUsageResult> InvokeAsync(GetGuestUsageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGuestUsageResult>("azure-native:azureactivedirectory/v20230517preview:getGuestUsage", args ?? new GetGuestUsageArgs(), options.WithDefaults());
