...
namespace Pulumi.AzureNative.AzureActiveDirectory.V20230517Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azureactivedirectory/v20230517preview:GuestUsage")]
    public partial class GuestUsage : global::Pulumi.CustomResource
    {
        ...
        public GuestUsage(string name, GuestUsageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azureactivedirectory/v20230517preview:GuestUsage", name, args ?? new GuestUsageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestUsage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azureactivedirectory/v20230517preview:GuestUsage", name, null, MakeResourceOptions(options, id))
        {
        }
