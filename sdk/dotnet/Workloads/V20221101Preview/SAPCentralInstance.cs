...
namespace Pulumi.AzureNative.Workloads.V20221101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:workloads/v20221101preview:SAPCentralInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:workloads/v20230401:SAPCentralInstance to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:workloads/v20221101preview:SAPCentralInstance")]
    public partial class SAPCentralInstance : global::Pulumi.CustomResource
    {
        ...
        public SAPCentralInstance(string name, SAPCentralInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20221101preview:SAPCentralInstance", name, args ?? new SAPCentralInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAPCentralInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20221101preview:SAPCentralInstance", name, null, MakeResourceOptions(options, id))
        {
        }
