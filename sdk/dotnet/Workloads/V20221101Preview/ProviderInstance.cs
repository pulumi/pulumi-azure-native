...
namespace Pulumi.AzureNative.Workloads.V20221101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:workloads/v20221101preview:ProviderInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:workloads/v20230401:ProviderInstance to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:workloads/v20221101preview:ProviderInstance")]
    public partial class ProviderInstance : global::Pulumi.CustomResource
    {
        ...
        public ProviderInstance(string name, ProviderInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20221101preview:ProviderInstance", name, args ?? new ProviderInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProviderInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20221101preview:ProviderInstance", name, null, MakeResourceOptions(options, id))
        {
        }
