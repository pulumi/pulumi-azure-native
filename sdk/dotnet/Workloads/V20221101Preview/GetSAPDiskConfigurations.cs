...
namespace Pulumi.AzureNative.Workloads.V20221101Preview
{
    public static class GetSAPDiskConfigurations
    {
        ...
        public static Task<GetSAPDiskConfigurationsResult> InvokeAsync(GetSAPDiskConfigurationsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSAPDiskConfigurationsResult>("azure-native:workloads/v20221101preview:getSAPDiskConfigurations", args ?? new GetSAPDiskConfigurationsArgs(), options.WithDefaults());
        ...
        public static Output<GetSAPDiskConfigurationsResult> Invoke(GetSAPDiskConfigurationsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSAPDiskConfigurationsResult>("azure-native:workloads/v20221101preview:getSAPDiskConfigurations", args ?? new GetSAPDiskConfigurationsInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetSAPDiskConfigurationsArgs : global::Pulumi.InvokeArgs
    {
        ...
        public Union<string, Pulumi.AzureNative.Workloads.V20221101Preview.SAPDeploymentType> DeploymentType { get; set; } = null!;

        /// <summary>
        /// Defines the environment type - Production/Non Production.
        /// </summary>
        [Input("environment", required: true)]
        public Union<string, Pulumi.AzureNative.Workloads.V20221101Preview.SAPEnvironmentType> Environment { get; set; } = null!;
    ...
    public sealed class GetSAPDiskConfigurationsInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("deploymentType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Workloads.V20221101Preview.SAPDeploymentType> DeploymentType { get; set; } = null!;
