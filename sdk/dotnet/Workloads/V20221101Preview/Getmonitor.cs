...
{
    [Obsolete(@"azure-native:workloads/v20221101preview:monitor is being removed in the next major version of this provider. Upgrade to at least azure-native:workloads/v20230401:monitor to guarantee forwards compatibility.")]
    public static class Getmonitor
    {
        ...
        public static Task<GetmonitorResult> InvokeAsync(GetmonitorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetmonitorResult>("azure-native:workloads/v20221101preview:getmonitor", args ?? new GetmonitorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets properties of a SAP monitor for the specified subscription, resource group, and resource name.
        /// </summary>
        public static Output<GetmonitorResult> Invoke(GetmonitorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetmonitorResult>("azure-native:workloads/v20221101preview:getmonitor", args ?? new GetmonitorInvokeArgs(), options.WithDefaults());
    }
