...
namespace Pulumi.AzureNative.Workloads.V20221101Preview
{
    ...
    public partial class SAPVirtualInstance : global::Pulumi.CustomResource
    {
        ...
        public SAPVirtualInstance(string name, SAPVirtualInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20221101preview:SAPVirtualInstance", name, args ?? new SAPVirtualInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAPVirtualInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20221101preview:SAPVirtualInstance", name, null, MakeResourceOptions(options, id))
        {
        }
