...
namespace Pulumi.AzureNative.Workloads.V20231201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20231201preview:Monitor")]
    public partial class Monitor : global::Pulumi.CustomResource
    {
        ...
        public Monitor(string name, MonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231201preview:Monitor", name, args ?? new MonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Monitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231201preview:Monitor", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MonitorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Workloads.V20231201Preview.RoutingPreference>? RoutingPreference { get; set; }
