...
namespace Pulumi.AzureNative.Workloads.V20231201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20231201preview:ProviderInstance")]
    public partial class ProviderInstance : global::Pulumi.CustomResource
    {
        ...
        public ProviderInstance(string name, ProviderInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231201preview:ProviderInstance", name, args ?? new ProviderInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProviderInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231201preview:ProviderInstance", name, null, MakeResourceOptions(options, id))
        {
        }
