...
namespace Pulumi.AzureNative.Workloads.V20211201Preview
{
    ...
    /// {
    ///     var sapCentralInstance = new AzureNative.Workloads.V20211201Preview.SAPCentralInstance("sapCentralInstance", new()
    ///     {
    ...
    public partial class SAPCentralInstance : global::Pulumi.CustomResource
    {
        ...
        public SAPCentralInstance(string name, SAPCentralInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20211201preview:SAPCentralInstance", name, args ?? new SAPCentralInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAPCentralInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20211201preview:SAPCentralInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SAPCentralInstance Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
