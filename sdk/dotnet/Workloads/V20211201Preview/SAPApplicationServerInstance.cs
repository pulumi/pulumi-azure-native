...
namespace Pulumi.AzureNative.Workloads.V20211201Preview
{
    ...
    /// {
    ///     var sapApplicationServerInstance = new AzureNative.Workloads.V20211201Preview.SAPApplicationServerInstance("sapApplicationServerInstance", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20211201preview:SAPApplicationServerInstance")]
    public partial class SAPApplicationServerInstance : global::Pulumi.CustomResource
    {
        ...
        public SAPApplicationServerInstance(string name, SAPApplicationServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20211201preview:SAPApplicationServerInstance", name, args ?? new SAPApplicationServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAPApplicationServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20211201preview:SAPApplicationServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
