...
namespace Pulumi.AzureNative.Workloads.V20211201Preview
{
    ...
    /// {
    ///     var sapDatabaseInstance = new AzureNative.Workloads.V20211201Preview.SAPDatabaseInstance("sapDatabaseInstance", new()
    ///     {
    ...
    public partial class SAPDatabaseInstance : global::Pulumi.CustomResource
    {
        ...
        public SAPDatabaseInstance(string name, SAPDatabaseInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20211201preview:SAPDatabaseInstance", name, args ?? new SAPDatabaseInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAPDatabaseInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20211201preview:SAPDatabaseInstance", name, null, MakeResourceOptions(options, id))
        {
        }
