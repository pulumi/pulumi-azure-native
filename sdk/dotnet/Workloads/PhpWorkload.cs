...
namespace Pulumi.AzureNative.Workloads
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads:PhpWorkload")]
    public partial class PhpWorkload : global::Pulumi.CustomResource
    {
        ...
        public PhpWorkload(string name, PhpWorkloadArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads:PhpWorkload", name, args ?? new PhpWorkloadArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PhpWorkload(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads:PhpWorkload", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:workloads/v20211201preview:PhpWorkload"},
                },
            };
    ...
    public sealed class PhpWorkloadArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Workloads.WorkloadKind> Kind { get; set; } = null!;
