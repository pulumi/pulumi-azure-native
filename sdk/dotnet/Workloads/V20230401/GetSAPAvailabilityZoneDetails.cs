...
namespace Pulumi.AzureNative.Workloads.V20230401
{
    public static class GetSAPAvailabilityZoneDetails
    {
        ...
        public static Task<GetSAPAvailabilityZoneDetailsResult> InvokeAsync(GetSAPAvailabilityZoneDetailsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSAPAvailabilityZoneDetailsResult>("azure-native:workloads/v20230401:getSAPAvailabilityZoneDetails", args ?? new GetSAPAvailabilityZoneDetailsArgs(), options.WithDefaults());
