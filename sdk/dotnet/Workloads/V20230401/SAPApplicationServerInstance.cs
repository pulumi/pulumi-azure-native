...
namespace Pulumi.AzureNative.Workloads.V20230401
{
    ...
    /// {
    ///     var sapApplicationServerInstance = new AzureNative.Workloads.V20230401.SAPApplicationServerInstance("sapApplicationServerInstance", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20230401:SAPApplicationServerInstance")]
    public partial class SAPApplicationServerInstance : global::Pulumi.CustomResource
    {
        ...
        public SAPApplicationServerInstance(string name, SAPApplicationServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20230401:SAPApplicationServerInstance", name, args ?? new SAPApplicationServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAPApplicationServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20230401:SAPApplicationServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
