...
namespace Pulumi.AzureNative.Workloads.V20230401
{
    ...
    /// {
    ///     var sapDatabaseInstance = new AzureNative.Workloads.V20230401.SAPDatabaseInstance("sapDatabaseInstance", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20230401:SAPDatabaseInstance")]
    public partial class SAPDatabaseInstance : global::Pulumi.CustomResource
    {
        ...
        public SAPDatabaseInstance(string name, SAPDatabaseInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20230401:SAPDatabaseInstance", name, args ?? new SAPDatabaseInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAPDatabaseInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20230401:SAPDatabaseInstance", name, null, MakeResourceOptions(options, id))
        {
        }
