...
namespace Pulumi.AzureNative.Workloads.V20230401
{
    ...
    /// {
    ///     var sapCentralInstance = new AzureNative.Workloads.V20230401.SAPCentralInstance("sapCentralInstance", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20230401:SAPCentralInstance")]
    public partial class SAPCentralInstance : global::Pulumi.CustomResource
    {
        ...
        public SAPCentralInstance(string name, SAPCentralInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20230401:SAPCentralInstance", name, args ?? new SAPCentralInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAPCentralInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20230401:SAPCentralInstance", name, null, MakeResourceOptions(options, id))
        {
        }
