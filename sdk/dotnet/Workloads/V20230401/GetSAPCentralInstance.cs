...
namespace Pulumi.AzureNative.Workloads.V20230401
{
    public static class GetSAPCentralInstance
    {
        ...
        public static Task<GetSAPCentralInstanceResult> InvokeAsync(GetSAPCentralInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSAPCentralInstanceResult>("azure-native:workloads/v20230401:getSAPCentralInstance", args ?? new GetSAPCentralInstanceArgs(), options.WithDefaults());
