...
namespace Pulumi.AzureNative.Workloads.V20230401
{
    public static class GetProviderInstance
    {
        ...
        public static Task<GetProviderInstanceResult> InvokeAsync(GetProviderInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProviderInstanceResult>("azure-native:workloads/v20230401:getProviderInstance", args ?? new GetProviderInstanceArgs(), options.WithDefaults());
