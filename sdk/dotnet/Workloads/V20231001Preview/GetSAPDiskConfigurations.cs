...
namespace Pulumi.AzureNative.Workloads.V20231001Preview
{
    public static class GetSAPDiskConfigurations
    {
        ...
        public static Task<GetSAPDiskConfigurationsResult> InvokeAsync(GetSAPDiskConfigurationsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSAPDiskConfigurationsResult>("azure-native:workloads/v20231001preview:getSAPDiskConfigurations", args ?? new GetSAPDiskConfigurationsArgs(), options.WithDefaults());
    ...
    public sealed class GetSAPDiskConfigurationsArgs : global::Pulumi.InvokeArgs
    {
        ...
        public Union<string, Pulumi.AzureNative.Workloads.V20231001Preview.SAPDatabaseType> DatabaseType { get; set; } = null!;
        ...
        public Union<string, Pulumi.AzureNative.Workloads.V20231001Preview.SAPDeploymentType> DeploymentType { get; set; } = null!;

        /// <summary>
        /// Defines the environment type - Production/Non Production.
        /// </summary>
        [Input("environment", required: true)]
        public Union<string, Pulumi.AzureNative.Workloads.V20231001Preview.SAPEnvironmentType> Environment { get; set; } = null!;
        ...
        public Union<string, Pulumi.AzureNative.Workloads.V20231001Preview.SAPProductType> SapProduct { get; set; } = null!;
    ...
    public sealed class GetSAPDiskConfigurationsInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("databaseType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Workloads.V20231001Preview.SAPDatabaseType> DatabaseType { get; set; } = null!;
        ...
        /// </summary>
        [Input("deploymentType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Workloads.V20231001Preview.SAPDeploymentType> DeploymentType { get; set; } = null!;

        /// <summary>
        /// Defines the environment type - Production/Non Production.
        /// </summary>
        [Input("environment", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Workloads.V20231001Preview.SAPEnvironmentType> Environment { get; set; } = null!;
        ...
        /// </summary>
        [Input("sapProduct", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Workloads.V20231001Preview.SAPProductType> SapProduct { get; set; } = null!;
