...
namespace Pulumi.AzureNative.Workloads.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20231001preview:ServerInstance")]
    public partial class ServerInstance : global::Pulumi.CustomResource
    {
        ...
        public ServerInstance(string name, ServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231001preview:ServerInstance", name, args ?? new ServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231001preview:ServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:workloads:ServerInstance" },
                },
            };
