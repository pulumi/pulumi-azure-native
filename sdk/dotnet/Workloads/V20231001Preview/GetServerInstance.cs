...
namespace Pulumi.AzureNative.Workloads.V20231001Preview
{
    public static class GetServerInstance
    {
        ...
        public static Task<GetServerInstanceResult> InvokeAsync(GetServerInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerInstanceResult>("azure-native:workloads/v20231001preview:getServerInstance", args ?? new GetServerInstanceArgs(), options.WithDefaults());
