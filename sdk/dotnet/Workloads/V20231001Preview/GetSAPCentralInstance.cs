...
namespace Pulumi.AzureNative.Workloads.V20231001Preview
{
    public static class GetSAPCentralInstance
    {
        ...
        public static Task<GetSAPCentralInstanceResult> InvokeAsync(GetSAPCentralInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSAPCentralInstanceResult>("azure-native:workloads/v20231001preview:getSAPCentralInstance", args ?? new GetSAPCentralInstanceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the SAP Central Services Instance resource.
        /// </summary>
        public static Output<GetSAPCentralInstanceResult> Invoke(GetSAPCentralInstanceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSAPCentralInstanceResult>("azure-native:workloads/v20231001preview:getSAPCentralInstance", args ?? new GetSAPCentralInstanceInvokeArgs(), options.WithDefaults());
