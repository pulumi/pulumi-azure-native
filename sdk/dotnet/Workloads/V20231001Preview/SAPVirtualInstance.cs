...
namespace Pulumi.AzureNative.Workloads.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20231001preview:SAPVirtualInstance")]
    public partial class SAPVirtualInstance : global::Pulumi.CustomResource
    {
        ...
        public SAPVirtualInstance(string name, SAPVirtualInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231001preview:SAPVirtualInstance", name, args ?? new SAPVirtualInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAPVirtualInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231001preview:SAPVirtualInstance", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SAPVirtualInstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Workloads.V20231001Preview.ManagedResourcesNetworkAccessType>? ManagedResourcesNetworkAccessType { get; set; }
