...
namespace Pulumi.AzureNative.Workloads.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20231001preview:SAPDatabaseInstance")]
    public partial class SAPDatabaseInstance : global::Pulumi.CustomResource
    {
        ...
        public SAPDatabaseInstance(string name, SAPDatabaseInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231001preview:SAPDatabaseInstance", name, args ?? new SAPDatabaseInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAPDatabaseInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231001preview:SAPDatabaseInstance", name, null, MakeResourceOptions(options, id))
        {
        }
