...
namespace Pulumi.AzureNative.Workloads.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20231001preview:SAPApplicationServerInstance")]
    public partial class SAPApplicationServerInstance : global::Pulumi.CustomResource
    {
        ...
        public SAPApplicationServerInstance(string name, SAPApplicationServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231001preview:SAPApplicationServerInstance", name, args ?? new SAPApplicationServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAPApplicationServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231001preview:SAPApplicationServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
