...
namespace Pulumi.AzureNative.Workloads.V20231001Preview
{
    public static class GetSAPAvailabilityZoneDetails
    {
        ...
        public static Task<GetSAPAvailabilityZoneDetailsResult> InvokeAsync(GetSAPAvailabilityZoneDetailsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSAPAvailabilityZoneDetailsResult>("azure-native:workloads/v20231001preview:getSAPAvailabilityZoneDetails", args ?? new GetSAPAvailabilityZoneDetailsArgs(), options.WithDefaults());
        ...
        public static Output<GetSAPAvailabilityZoneDetailsResult> Invoke(GetSAPAvailabilityZoneDetailsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSAPAvailabilityZoneDetailsResult>("azure-native:workloads/v20231001preview:getSAPAvailabilityZoneDetails", args ?? new GetSAPAvailabilityZoneDetailsInvokeArgs(), options.WithDefaults());
