...
namespace Pulumi.AzureNative.Workloads.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20231001preview:Connector")]
    public partial class Connector : global::Pulumi.CustomResource
    {
        ...
        public Connector(string name, ConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231001preview:Connector", name, args ?? new ConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231001preview:Connector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:workloads:Connector"},
                },
            };
