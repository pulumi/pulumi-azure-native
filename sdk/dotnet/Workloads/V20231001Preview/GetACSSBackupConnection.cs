...
namespace Pulumi.AzureNative.Workloads.V20231001Preview
{
    public static class GetACSSBackupConnection
    {
        ...
        public static Task<GetACSSBackupConnectionResult> InvokeAsync(GetACSSBackupConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetACSSBackupConnectionResult>("azure-native:workloads/v20231001preview:getACSSBackupConnection", args ?? new GetACSSBackupConnectionArgs(), options.WithDefaults());
