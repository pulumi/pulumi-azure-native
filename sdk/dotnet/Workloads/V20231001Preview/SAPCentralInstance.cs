...
namespace Pulumi.AzureNative.Workloads.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20231001preview:SAPCentralInstance")]
    public partial class SAPCentralInstance : global::Pulumi.CustomResource
    {
        ...
        public SAPCentralInstance(string name, SAPCentralInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231001preview:SAPCentralInstance", name, args ?? new SAPCentralInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAPCentralInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20231001preview:SAPCentralInstance", name, null, MakeResourceOptions(options, id))
        {
        }
