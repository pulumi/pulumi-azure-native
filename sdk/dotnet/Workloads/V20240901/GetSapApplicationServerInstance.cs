...
namespace Pulumi.AzureNative.Workloads.V20240901
{
    public static class GetSapApplicationServerInstance
    {
        ...
        public static Task<GetSapApplicationServerInstanceResult> InvokeAsync(GetSapApplicationServerInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSapApplicationServerInstanceResult>("azure-native:workloads/v20240901:getSapApplicationServerInstance", args ?? new GetSapApplicationServerInstanceArgs(), options.WithDefaults());
        ...
        public static Output<GetSapApplicationServerInstanceResult> Invoke(GetSapApplicationServerInstanceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSapApplicationServerInstanceResult>("azure-native:workloads/v20240901:getSapApplicationServerInstance", args ?? new GetSapApplicationServerInstanceInvokeArgs(), options.WithDefaults());
    }
