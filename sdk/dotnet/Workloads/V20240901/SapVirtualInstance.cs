...
namespace Pulumi.AzureNative.Workloads.V20240901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20240901:SapVirtualInstance")]
    public partial class SapVirtualInstance : global::Pulumi.CustomResource
    {
        ...
        public SapVirtualInstance(string name, SapVirtualInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20240901:SapVirtualInstance", name, args ?? new SapVirtualInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SapVirtualInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20240901:SapVirtualInstance", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SapVirtualInstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Workloads.V20240901.ManagedResourcesNetworkAccessType>? ManagedResourcesNetworkAccessType { get; set; }
