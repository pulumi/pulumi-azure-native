...
namespace Pulumi.AzureNative.Workloads.V20240901
{
    public static class GetSapDatabaseInstance
    {
        ...
        public static Task<GetSapDatabaseInstanceResult> InvokeAsync(GetSapDatabaseInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSapDatabaseInstanceResult>("azure-native:workloads/v20240901:getSapDatabaseInstance", args ?? new GetSapDatabaseInstanceArgs(), options.WithDefaults());
        ...
        public static Output<GetSapDatabaseInstanceResult> Invoke(GetSapDatabaseInstanceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSapDatabaseInstanceResult>("azure-native:workloads/v20240901:getSapDatabaseInstance", args ?? new GetSapDatabaseInstanceInvokeArgs(), options.WithDefaults());
    }
