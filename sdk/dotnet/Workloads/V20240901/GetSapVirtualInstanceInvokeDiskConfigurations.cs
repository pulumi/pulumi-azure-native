...
namespace Pulumi.AzureNative.Workloads.V20240901
{
    public static class GetSapVirtualInstanceInvokeDiskConfigurations
    {
        ...
        public static Task<GetSapVirtualInstanceInvokeDiskConfigurationsResult> InvokeAsync(GetSapVirtualInstanceInvokeDiskConfigurationsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSapVirtualInstanceInvokeDiskConfigurationsResult>("azure-native:workloads/v20240901:getSapVirtualInstanceInvokeDiskConfigurations", args ?? new GetSapVirtualInstanceInvokeDiskConfigurationsArgs(), options.WithDefaults());
