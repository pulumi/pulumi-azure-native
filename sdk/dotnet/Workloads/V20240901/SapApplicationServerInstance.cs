...
namespace Pulumi.AzureNative.Workloads.V20240901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20240901:SapApplicationServerInstance")]
    public partial class SapApplicationServerInstance : global::Pulumi.CustomResource
    {
        ...
        public SapApplicationServerInstance(string name, SapApplicationServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20240901:SapApplicationServerInstance", name, args ?? new SapApplicationServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SapApplicationServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20240901:SapApplicationServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
