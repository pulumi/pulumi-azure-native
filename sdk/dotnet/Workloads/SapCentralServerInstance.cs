...
namespace Pulumi.AzureNative.Workloads
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads:SapCentralServerInstance")]
    public partial class SapCentralServerInstance : global::Pulumi.CustomResource
    {
        ...
        public SapCentralServerInstance(string name, SapCentralServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads:SapCentralServerInstance", name, args ?? new SapCentralServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SapCentralServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads:SapCentralServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
