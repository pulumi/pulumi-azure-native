...
namespace Pulumi.AzureNative.Workloads
{
    ...
    public partial class SapLandscapeMonitor : global::Pulumi.CustomResource
    {
        ...
        public SapLandscapeMonitor(string name, SapLandscapeMonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads:SapLandscapeMonitor", name, args ?? new SapLandscapeMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SapLandscapeMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads:SapLandscapeMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_workloads_v20221101preview:workloads:SapLandscapeMonitor" },
                    new global::Pulumi.Alias { Type = "azure-native_workloads_v20230401:workloads:SapLandscapeMonitor" },
                    new global::Pulumi.Alias { Type = "azure-native_workloads_v20231001preview:workloads:SapLandscapeMonitor" },
                    new global::Pulumi.Alias { Type = "azure-native_workloads_v20231201preview:workloads:SapLandscapeMonitor" },
                    new global::Pulumi.Alias { Type = "azure-native_workloads_v20240201preview:workloads:SapLandscapeMonitor" },
                },
            };
