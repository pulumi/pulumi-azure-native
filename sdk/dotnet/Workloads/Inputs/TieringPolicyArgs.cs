...
namespace Pulumi.AzureNative.Workloads.Inputs
{
    ...
    public sealed class TieringPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("durationType")]
        public InputUnion<string, Pulumi.AzureNative.Workloads.RetentionDurationType>? DurationType { get; set; }
        ...
        /// </summary>
        [Input("tieringMode")]
        public InputUnion<string, Pulumi.AzureNative.Workloads.TieringMode>? TieringMode { get; set; }
