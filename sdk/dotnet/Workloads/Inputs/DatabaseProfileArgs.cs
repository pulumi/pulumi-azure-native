...
namespace Pulumi.AzureNative.Workloads.Inputs
{
    ...
    public sealed class DatabaseProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("haEnabled")]
        public InputUnion<string, Pulumi.AzureNative.Workloads.HAEnabled>? HaEnabled { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Workloads.EnableSslEnforcement>? SslEnforcementEnabled { get; set; }
        ...
        public Input<Pulumi.AzureNative.Workloads.DatabaseTier> Tier { get; set; } = null!;

        /// <summary>
        /// Database type
        /// </summary>
        [Input("type", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Workloads.DatabaseType> Type { get; set; } = null!;
