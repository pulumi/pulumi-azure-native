...
namespace Pulumi.AzureNative.Workloads.Inputs
{
    ...
    public sealed class NetworkProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Workloads.AzureFrontDoorEnabled>? AzureFrontDoorEnabled { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Workloads.LoadBalancerType> LoadBalancerType { get; set; } = null!;
