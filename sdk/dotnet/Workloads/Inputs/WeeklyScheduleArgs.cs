...
namespace Pulumi.AzureNative.Workloads.Inputs
{
    ...
    public sealed class WeeklyScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.AzureNative.Workloads.DayOfWeek>? _scheduleRunDays;

        /// <summary>
        /// Schedule run days.
        /// </summary>
        public InputList<Pulumi.AzureNative.Workloads.DayOfWeek> ScheduleRunDays
        {
            get => _scheduleRunDays ?? (_scheduleRunDays = new InputList<Pulumi.AzureNative.Workloads.DayOfWeek>());
