...
namespace Pulumi.AzureNative.Workloads.V20240201Preview.Inputs
{
    ...
    public sealed class AlertRulePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("autoMitigate")]
        public InputUnion<string, Pulumi.AzureNative.Workloads.V20240201Preview.AlertAutoMitigate>? AutoMitigate { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Workloads.V20240201Preview.ConditionalOperator>? FailingPeriodsOperator { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.Workloads.V20240201Preview.AlertRuleStatus>? Status { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Workloads.V20240201Preview.ConditionalOperator>? ThresholdOperator { get; set; }
