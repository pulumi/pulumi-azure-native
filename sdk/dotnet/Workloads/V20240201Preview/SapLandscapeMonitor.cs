...
namespace Pulumi.AzureNative.Workloads.V20240201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:workloads/v20240201preview:SapLandscapeMonitor")]
    public partial class SapLandscapeMonitor : global::Pulumi.CustomResource
    {
        ...
        public SapLandscapeMonitor(string name, SapLandscapeMonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20240201preview:SapLandscapeMonitor", name, args ?? new SapLandscapeMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SapLandscapeMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:workloads/v20240201preview:SapLandscapeMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
