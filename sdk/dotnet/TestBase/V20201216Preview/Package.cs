...
namespace Pulumi.AzureNative.TestBase.V20201216Preview
{
    ...
    public partial class Package : Pulumi.CustomResource
    {
        ...
        public Package(string name, PackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20201216preview:Package", name, args ?? new PackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Package(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20201216preview:Package", name, null, MakeResourceOptions(options, id))
        {
        }
