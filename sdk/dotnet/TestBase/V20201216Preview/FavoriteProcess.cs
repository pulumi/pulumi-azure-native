...
namespace Pulumi.AzureNative.TestBase.V20201216Preview
{
    ...
    [AzureNativeResourceType("azure-native:testbase/v20201216preview:FavoriteProcess")]
    public partial class FavoriteProcess : global::Pulumi.CustomResource
    {
        ...
        public FavoriteProcess(string name, FavoriteProcessArgs args, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20201216preview:FavoriteProcess", name, args ?? new FavoriteProcessArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FavoriteProcess(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20201216preview:FavoriteProcess", name, null, MakeResourceOptions(options, id))
        {
        }
