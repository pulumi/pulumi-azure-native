...
azure-native:testbase/v20201216preview:TestBaseAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:testbase/v20220401preview:TestBaseAccount to guarantee forwards compatibility.")]
    ...
    public partial class TestBaseAccount : global::Pulumi.CustomResource
    {
        ...
        public TestBaseAccount(string name, TestBaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20201216preview:TestBaseAccount", name, args ?? new TestBaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TestBaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20201216preview:TestBaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
