...
namespace Pulumi.AzureNative.TestBase.V20220401Preview
{
    public static class GetPackage
    {
        ...
        public static Task<GetPackageResult> InvokeAsync(GetPackageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPackageResult>("azure-native:testbase/v20220401preview:getPackage", args ?? new GetPackageArgs(), options.WithDefaults());

        /// <summary>
        /// The Test Base Package resource.
        /// </summary>
        public static Output<GetPackageResult> Invoke(GetPackageInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPackageResult>("azure-native:testbase/v20220401preview:getPackage", args ?? new GetPackageInvokeArgs(), options.WithDefaults());
    }
