...
namespace Pulumi.AzureNative.TestBase.V20220401Preview
{
    ...
    /// {
    ///     var favoriteProcess = new AzureNative.TestBase.V20220401Preview.FavoriteProcess("favoriteProcess", new()
    ///     {
    ...
    public partial class FavoriteProcess : global::Pulumi.CustomResource
    {
        ...
        public FavoriteProcess(string name, FavoriteProcessArgs args, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20220401preview:FavoriteProcess", name, args ?? new FavoriteProcessArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FavoriteProcess(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20220401preview:FavoriteProcess", name, null, MakeResourceOptions(options, id))
        {
        }
