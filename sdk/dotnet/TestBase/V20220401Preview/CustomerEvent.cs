...
namespace Pulumi.AzureNative.TestBase.V20220401Preview
{
    ...
    public partial class CustomerEvent : global::Pulumi.CustomResource
    {
        ...
        public CustomerEvent(string name, CustomerEventArgs args, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20220401preview:CustomerEvent", name, args ?? new CustomerEventArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomerEvent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20220401preview:CustomerEvent", name, null, MakeResourceOptions(options, id))
        {
        }
