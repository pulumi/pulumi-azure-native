...
namespace Pulumi.AzureNative.TestBase.V20220401Preview
{
    public static class GetFavoriteProcess
    {
        ...
        public static Task<GetFavoriteProcessResult> InvokeAsync(GetFavoriteProcessArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFavoriteProcessResult>("azure-native:testbase/v20220401preview:getFavoriteProcess", args ?? new GetFavoriteProcessArgs(), options.WithDefaults());

        /// <summary>
        /// A favorite process identifier.
        /// </summary>
        public static Output<GetFavoriteProcessResult> Invoke(GetFavoriteProcessInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFavoriteProcessResult>("azure-native:testbase/v20220401preview:getFavoriteProcess", args ?? new GetFavoriteProcessInvokeArgs(), options.WithDefaults());
    }
