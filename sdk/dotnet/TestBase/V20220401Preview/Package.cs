...
namespace Pulumi.AzureNative.TestBase.V20220401Preview
{
    ...
    public partial class Package : global::Pulumi.CustomResource
    {
        ...
        public Package(string name, PackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20220401preview:Package", name, args ?? new PackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Package(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20220401preview:Package", name, null, MakeResourceOptions(options, id))
        {
        }
