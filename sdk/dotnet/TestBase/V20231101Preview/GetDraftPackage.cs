...
namespace Pulumi.AzureNative.TestBase.V20231101Preview
{
    public static class GetDraftPackage
    {
        ...
        public static Task<GetDraftPackageResult> InvokeAsync(GetDraftPackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDraftPackageResult>("azure-native:testbase/v20231101preview:getDraftPackage", args ?? new GetDraftPackageArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Test Base Draft Package.
        /// </summary>
        public static Output<GetDraftPackageResult> Invoke(GetDraftPackageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDraftPackageResult>("azure-native:testbase/v20231101preview:getDraftPackage", args ?? new GetDraftPackageInvokeArgs(), options.WithDefaults());
