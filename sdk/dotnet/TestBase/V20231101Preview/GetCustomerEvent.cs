...
namespace Pulumi.AzureNative.TestBase.V20231101Preview
{
    public static class GetCustomerEvent
    {
        ...
        public static Task<GetCustomerEventResult> InvokeAsync(GetCustomerEventArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomerEventResult>("azure-native:testbase/v20231101preview:getCustomerEvent", args ?? new GetCustomerEventArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Test Base CustomerEvent.
        /// </summary>
        public static Output<GetCustomerEventResult> Invoke(GetCustomerEventInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCustomerEventResult>("azure-native:testbase/v20231101preview:getCustomerEvent", args ?? new GetCustomerEventInvokeArgs(), options.WithDefaults());
