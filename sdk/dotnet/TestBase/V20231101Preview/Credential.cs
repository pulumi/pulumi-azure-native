...
namespace Pulumi.AzureNative.TestBase.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:testbase/v20231101preview:Credential")]
    public partial class Credential : global::Pulumi.CustomResource
    {
        ...
        public Credential(string name, CredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20231101preview:Credential", name, args ?? new CredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Credential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20231101preview:Credential", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:testbase:Credential" },
                },
            };
    ...
    public sealed class CredentialArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TestBase.V20231101Preview.CredentialType> CredentialType { get; set; } = null!;
