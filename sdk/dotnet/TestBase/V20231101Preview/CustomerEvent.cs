...
namespace Pulumi.AzureNative.TestBase.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:testbase/v20231101preview:CustomerEvent")]
    public partial class CustomerEvent : global::Pulumi.CustomResource
    {
        ...
        public CustomerEvent(string name, CustomerEventArgs args, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20231101preview:CustomerEvent", name, args ?? new CustomerEventArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomerEvent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20231101preview:CustomerEvent", name, null, MakeResourceOptions(options, id))
        {
        }
