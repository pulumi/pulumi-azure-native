...
namespace Pulumi.AzureNative.TestBase.V20231101Preview
{
    public static class GetTestBaseAccountFileUploadUrl
    {
        ...
        public static Task<GetTestBaseAccountFileUploadUrlResult> InvokeAsync(GetTestBaseAccountFileUploadUrlArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTestBaseAccountFileUploadUrlResult>("azure-native:testbase/v20231101preview:getTestBaseAccountFileUploadUrl", args ?? new GetTestBaseAccountFileUploadUrlArgs(), options.WithDefaults());
    ...
    public sealed class GetTestBaseAccountFileUploadUrlArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("resourceType")]
        public Union<string, Pulumi.AzureNative.TestBase.V20231101Preview.FileUploadResourceType>? ResourceType { get; set; }
    ...
    public sealed class GetTestBaseAccountFileUploadUrlInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("resourceType")]
        public InputUnion<string, Pulumi.AzureNative.TestBase.V20231101Preview.FileUploadResourceType>? ResourceType { get; set; }
