...
namespace Pulumi.AzureNative.TestBase.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:testbase/v20231101preview:ImageDefinition")]
    public partial class ImageDefinition : global::Pulumi.CustomResource
    {
        ...
        public ImageDefinition(string name, ImageDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20231101preview:ImageDefinition", name, args ?? new ImageDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImageDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20231101preview:ImageDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:testbase:ImageDefinition" },
                },
            };
    ...
    public sealed class ImageDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TestBase.V20231101Preview.ImageArchitecture> Architecture { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.TestBase.V20231101Preview.ImageOSState> OsState { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.TestBase.V20231101Preview.ImageSecurityType> SecurityType { get; set; } = null!;
