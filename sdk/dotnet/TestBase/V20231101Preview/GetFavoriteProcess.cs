...
namespace Pulumi.AzureNative.TestBase.V20231101Preview
{
    public static class GetFavoriteProcess
    {
        ...
        public static Task<GetFavoriteProcessResult> InvokeAsync(GetFavoriteProcessArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFavoriteProcessResult>("azure-native:testbase/v20231101preview:getFavoriteProcess", args ?? new GetFavoriteProcessArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a favorite process for a Test Base Package.
        /// </summary>
        public static Output<GetFavoriteProcessResult> Invoke(GetFavoriteProcessInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFavoriteProcessResult>("azure-native:testbase/v20231101preview:getFavoriteProcess", args ?? new GetFavoriteProcessInvokeArgs(), options.WithDefaults());
    }
