...
namespace Pulumi.AzureNative.TestBase.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:testbase/v20231101preview:TestBaseAccount")]
    public partial class TestBaseAccount : global::Pulumi.CustomResource
    {
        ...
        public TestBaseAccount(string name, TestBaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20231101preview:TestBaseAccount", name, args ?? new TestBaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TestBaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20231101preview:TestBaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
