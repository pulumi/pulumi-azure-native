...
namespace Pulumi.AzureNative.TestBase.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:testbase/v20231101preview:FavoriteProcess")]
    public partial class FavoriteProcess : global::Pulumi.CustomResource
    {
        ...
        public FavoriteProcess(string name, FavoriteProcessArgs args, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20231101preview:FavoriteProcess", name, args ?? new FavoriteProcessArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FavoriteProcess(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:testbase/v20231101preview:FavoriteProcess", name, null, MakeResourceOptions(options, id))
        {
        }
