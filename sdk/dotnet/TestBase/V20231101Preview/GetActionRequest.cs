...
namespace Pulumi.AzureNative.TestBase.V20231101Preview
{
    public static class GetActionRequest
    {
        ...
        public static Task<GetActionRequestResult> InvokeAsync(GetActionRequestArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetActionRequestResult>("azure-native:testbase/v20231101preview:getActionRequest", args ?? new GetActionRequestArgs(), options.WithDefaults());
