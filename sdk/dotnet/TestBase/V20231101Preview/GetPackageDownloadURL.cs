...
namespace Pulumi.AzureNative.TestBase.V20231101Preview
{
    public static class GetPackageDownloadURL
    {
        ...
        public static Task<GetPackageDownloadURLResult> InvokeAsync(GetPackageDownloadURLArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPackageDownloadURLResult>("azure-native:testbase/v20231101preview:getPackageDownloadURL", args ?? new GetPackageDownloadURLArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the download URL of a package.
        /// </summary>
        public static Output<GetPackageDownloadURLResult> Invoke(GetPackageDownloadURLInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPackageDownloadURLResult>("azure-native:testbase/v20231101preview:getPackageDownloadURL", args ?? new GetPackageDownloadURLInvokeArgs(), options.WithDefaults());
    }
