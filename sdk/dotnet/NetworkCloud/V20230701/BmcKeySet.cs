...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20230701:BmcKeySet")]
    public partial class BmcKeySet : global::Pulumi.CustomResource
    {
        ...
        public BmcKeySet(string name, BmcKeySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230701:BmcKeySet", name, args ?? new BmcKeySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BmcKeySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230701:BmcKeySet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BmcKeySetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20230701.BmcKeySetPrivilegeLevel> PrivilegeLevel { get; set; } = null!;
