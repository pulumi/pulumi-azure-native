...
namespace Pulumi.AzureNative.NetworkCloud.V20230701
{
    public static class GetBmcKeySet
    {
        ...
        public static Task<GetBmcKeySetResult> InvokeAsync(GetBmcKeySetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBmcKeySetResult>("azure-native:networkcloud/v20230701:getBmcKeySet", args ?? new GetBmcKeySetArgs(), options.WithDefaults());
