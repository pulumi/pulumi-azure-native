...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20230701:BareMetalMachine")]
    public partial class BareMetalMachine : global::Pulumi.CustomResource
    {
        ...
        public BareMetalMachine(string name, BareMetalMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230701:BareMetalMachine", name, args ?? new BareMetalMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BareMetalMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230701:BareMetalMachine", name, null, MakeResourceOptions(options, id))
        {
        }
