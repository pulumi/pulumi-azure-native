...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20230701:Console")]
    public partial class Console : global::Pulumi.CustomResource
    {
        ...
        public Console(string name, ConsoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230701:Console", name, args ?? new ConsoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Console(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230701:Console", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConsoleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20230701.ConsoleEnabled> Enabled { get; set; } = null!;
