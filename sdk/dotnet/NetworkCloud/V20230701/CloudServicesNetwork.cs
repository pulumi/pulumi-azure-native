...
namespace Pulumi.AzureNative.NetworkCloud.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:networkcloud/v20230701:CloudServicesNetwork")]
    public partial class CloudServicesNetwork : global::Pulumi.CustomResource
    {
        ...
        public CloudServicesNetwork(string name, CloudServicesNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230701:CloudServicesNetwork", name, args ?? new CloudServicesNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudServicesNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230701:CloudServicesNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CloudServicesNetworkArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20230701.CloudServicesNetworkEnableDefaultEgressEndpoints>? EnableDefaultEgressEndpoints { get; set; }
