...
namespace Pulumi.AzureNative.NetworkCloud.V20221212Preview
{
    ...
    /// {
    ///     var bareMetalMachineKeySet = new AzureNative.NetworkCloud.V20221212Preview.BareMetalMachineKeySet("bareMetalMachineKeySet", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:networkcloud/v20221212preview:BareMetalMachineKeySet")]
    public partial class BareMetalMachineKeySet : global::Pulumi.CustomResource
    {
        ...
        public BareMetalMachineKeySet(string name, BareMetalMachineKeySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:BareMetalMachineKeySet", name, args ?? new BareMetalMachineKeySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BareMetalMachineKeySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:BareMetalMachineKeySet", name, null, MakeResourceOptions(options, id))
        {
        }
