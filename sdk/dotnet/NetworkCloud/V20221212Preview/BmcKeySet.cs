...
namespace Pulumi.AzureNative.NetworkCloud.V20221212Preview
{
    ...
    /// {
    ///     var bmcKeySet = new AzureNative.NetworkCloud.V20221212Preview.BmcKeySet("bmcKeySet", new()
    ///     {
    ...
    ///         UserList = new[]
    ///         {
    ///             new AzureNative.NetworkCloud.V20221212Preview.Inputs.KeySetUserArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:networkcloud/v20221212preview:BmcKeySet")]
    public partial class BmcKeySet : global::Pulumi.CustomResource
    {
        ...
        public BmcKeySet(string name, BmcKeySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:BmcKeySet", name, args ?? new BmcKeySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BmcKeySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:BmcKeySet", name, null, MakeResourceOptions(options, id))
        {
        }
