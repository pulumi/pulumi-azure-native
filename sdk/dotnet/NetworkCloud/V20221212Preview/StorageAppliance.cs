...
namespace Pulumi.AzureNative.NetworkCloud.V20221212Preview
{
    ...
    public partial class StorageAppliance : global::Pulumi.CustomResource
    {
        ...
        public StorageAppliance(string name, StorageApplianceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:StorageAppliance", name, args ?? new StorageApplianceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAppliance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:StorageAppliance", name, null, MakeResourceOptions(options, id))
        {
        }
