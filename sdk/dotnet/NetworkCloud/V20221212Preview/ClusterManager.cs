...
namespace Pulumi.AzureNative.NetworkCloud.V20221212Preview
{
    ...
    /// {
    ///     var clusterManager = new AzureNative.NetworkCloud.V20221212Preview.ClusterManager("clusterManager", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:networkcloud/v20221212preview:ClusterManager")]
    public partial class ClusterManager : global::Pulumi.CustomResource
    {
        ...
        public ClusterManager(string name, ClusterManagerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:ClusterManager", name, args ?? new ClusterManagerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterManager(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:ClusterManager", name, null, MakeResourceOptions(options, id))
        {
        }
