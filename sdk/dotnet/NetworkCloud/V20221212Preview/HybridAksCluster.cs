...
namespace Pulumi.AzureNative.NetworkCloud.V20221212Preview
{
    ...
    public partial class HybridAksCluster : global::Pulumi.CustomResource
    {
        ...
        public HybridAksCluster(string name, HybridAksClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:HybridAksCluster", name, args ?? new HybridAksClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridAksCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:HybridAksCluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud:HybridAksCluster"},
                },
            };
