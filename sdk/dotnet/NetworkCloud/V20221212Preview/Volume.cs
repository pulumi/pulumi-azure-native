...
namespace Pulumi.AzureNative.NetworkCloud.V20221212Preview
{
    ...
    /// {
    ///     var volume = new AzureNative.NetworkCloud.V20221212Preview.Volume("volume", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:networkcloud/v20221212preview:Volume volumeName /subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.NetworkCloud/volumes/volumeName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:networkcloud/v20221212preview:Volume")]
    public partial class Volume : global::Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
