...
namespace Pulumi.AzureNative.NetworkCloud.V20221212Preview
{
    ...
    public partial class MetricsConfiguration : global::Pulumi.CustomResource
    {
        ...
        public MetricsConfiguration(string name, MetricsConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:MetricsConfiguration", name, args ?? new MetricsConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetricsConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:MetricsConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
