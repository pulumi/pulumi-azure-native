...
{
    [Obsolete(@"azure-native:networkcloud/v20221212preview:L3Network is being removed in the next major version of this provider. Upgrade to at least azure-native:networkcloud/v20230501preview:L3Network to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:networkcloud/v20221212preview:L3Network")]
    public partial class L3Network : global::Pulumi.CustomResource
    {
        ...
        public L3Network(string name, L3NetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:L3Network", name, args ?? new L3NetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private L3Network(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:L3Network", name, null, MakeResourceOptions(options, id))
        {
        }
