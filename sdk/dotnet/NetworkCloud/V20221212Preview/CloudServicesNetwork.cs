...
namespace Pulumi.AzureNative.NetworkCloud.V20221212Preview
{
    ...
    public partial class CloudServicesNetwork : global::Pulumi.CustomResource
    {
        ...
        public CloudServicesNetwork(string name, CloudServicesNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:CloudServicesNetwork", name, args ?? new CloudServicesNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudServicesNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20221212preview:CloudServicesNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CloudServicesNetworkArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20221212Preview.CloudServicesNetworkEnableDefaultEgressEndpoints>? EnableDefaultEgressEndpoints { get; set; }
