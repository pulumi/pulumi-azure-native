...
namespace Pulumi.AzureNative.NetworkCloud
{
    ...
    public partial class Rack : global::Pulumi.CustomResource
    {
        ...
        public Rack(string name, RackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud:Rack", name, args ?? new RackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud:Rack", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20250901:Rack" },
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20260101preview:Rack" },
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20260501preview:Rack" },
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20260701:Rack" },
                },
            };
