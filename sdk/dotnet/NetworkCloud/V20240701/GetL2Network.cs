...
namespace Pulumi.AzureNative.NetworkCloud.V20240701
{
    public static class GetL2Network
    {
        ...
        public static Task<GetL2NetworkResult> InvokeAsync(GetL2NetworkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetL2NetworkResult>("azure-native:networkcloud/v20240701:getL2Network", args ?? new GetL2NetworkArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of the provided layer 2 (L2) network.
        /// </summary>
        public static Output<GetL2NetworkResult> Invoke(GetL2NetworkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetL2NetworkResult>("azure-native:networkcloud/v20240701:getL2Network", args ?? new GetL2NetworkInvokeArgs(), options.WithDefaults());
    }
