...
namespace Pulumi.AzureNative.NetworkCloud.V20240701
{
    public static class GetClusterManager
    {
        ...
        public static Task<GetClusterManagerResult> InvokeAsync(GetClusterManagerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterManagerResult>("azure-native:networkcloud/v20240701:getClusterManager", args ?? new GetClusterManagerArgs(), options.WithDefaults());
