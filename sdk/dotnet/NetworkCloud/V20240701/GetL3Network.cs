...
namespace Pulumi.AzureNative.NetworkCloud.V20240701
{
    public static class GetL3Network
    {
        ...
        public static Task<GetL3NetworkResult> InvokeAsync(GetL3NetworkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetL3NetworkResult>("azure-native:networkcloud/v20240701:getL3Network", args ?? new GetL3NetworkArgs(), options.WithDefaults());
