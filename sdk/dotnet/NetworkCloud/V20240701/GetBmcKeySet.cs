...
namespace Pulumi.AzureNative.NetworkCloud.V20240701
{
    public static class GetBmcKeySet
    {
        ...
        public static Task<GetBmcKeySetResult> InvokeAsync(GetBmcKeySetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBmcKeySetResult>("azure-native:networkcloud/v20240701:getBmcKeySet", args ?? new GetBmcKeySetArgs(), options.WithDefaults());

        /// <summary>
        /// Get baseboard management controller key set of the provided cluster.
        /// </summary>
        public static Output<GetBmcKeySetResult> Invoke(GetBmcKeySetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBmcKeySetResult>("azure-native:networkcloud/v20240701:getBmcKeySet", args ?? new GetBmcKeySetInvokeArgs(), options.WithDefaults());
    }
