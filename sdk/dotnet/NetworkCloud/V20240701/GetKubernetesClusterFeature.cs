...
namespace Pulumi.AzureNative.NetworkCloud.V20240701
{
    public static class GetKubernetesClusterFeature
    {
        ...
        public static Task<GetKubernetesClusterFeatureResult> InvokeAsync(GetKubernetesClusterFeatureArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKubernetesClusterFeatureResult>("azure-native:networkcloud/v20240701:getKubernetesClusterFeature", args ?? new GetKubernetesClusterFeatureArgs(), options.WithDefaults());
