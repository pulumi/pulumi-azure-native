...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20240701:ClusterManager")]
    public partial class ClusterManager : global::Pulumi.CustomResource
    {
        ...
        public ClusterManager(string name, ClusterManagerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240701:ClusterManager", name, args ?? new ClusterManagerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterManager(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240701:ClusterManager", name, null, MakeResourceOptions(options, id))
        {
        }
