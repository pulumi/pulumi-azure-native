...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20240701:StorageAppliance")]
    public partial class StorageAppliance : global::Pulumi.CustomResource
    {
        ...
        public StorageAppliance(string name, StorageApplianceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240701:StorageAppliance", name, args ?? new StorageApplianceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAppliance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240701:StorageAppliance", name, null, MakeResourceOptions(options, id))
        {
        }
