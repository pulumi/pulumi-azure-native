...
namespace Pulumi.AzureNative.NetworkCloud.V20240701.Inputs
{
    ...
    public sealed class OsDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createOption")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240701.OsDiskCreateOption>? CreateOption { get; set; }

        /// <summary>
        /// The strategy for deleting the OS disk.
        /// </summary>
        [Input("deleteOption")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240701.OsDiskDeleteOption>? DeleteOption { get; set; }
