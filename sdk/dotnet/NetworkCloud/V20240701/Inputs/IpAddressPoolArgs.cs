...
namespace Pulumi.AzureNative.NetworkCloud.V20240701.Inputs
{
    ...
    public sealed class IpAddressPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("autoAssign")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240701.BfdEnabled>? AutoAssign { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240701.BfdEnabled>? OnlyUseHostIps { get; set; }
