...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20240701:VirtualMachine")]
    public partial class VirtualMachine : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240701:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240701:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualMachineArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("bootMethod")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240701.VirtualMachineBootMethod>? BootMethod { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240701.VirtualMachineIsolateEmulatorThread>? IsolateEmulatorThread { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240701.VirtualMachineVirtioInterfaceType>? VirtioInterface { get; set; }
        ...
        /// </summary>
        [Input("vmDeviceModel")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240701.VirtualMachineDeviceModelType>? VmDeviceModel { get; set; }
