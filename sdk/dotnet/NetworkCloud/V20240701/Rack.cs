...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20240701:Rack")]
    public partial class Rack : global::Pulumi.CustomResource
    {
        ...
        public Rack(string name, RackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240701:Rack", name, args ?? new RackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240701:Rack", name, null, MakeResourceOptions(options, id))
        {
        }
