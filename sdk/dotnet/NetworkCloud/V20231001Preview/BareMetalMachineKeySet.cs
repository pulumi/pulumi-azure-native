...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20231001preview:BareMetalMachineKeySet")]
    public partial class BareMetalMachineKeySet : global::Pulumi.CustomResource
    {
        ...
        public BareMetalMachineKeySet(string name, BareMetalMachineKeySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20231001preview:BareMetalMachineKeySet", name, args ?? new BareMetalMachineKeySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BareMetalMachineKeySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20231001preview:BareMetalMachineKeySet", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20240601preview:BareMetalMachineKeySet" },
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20240701:BareMetalMachineKeySet" },
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20241001preview:BareMetalMachineKeySet" },
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20250201:BareMetalMachineKeySet" },
    ...
    public sealed class BareMetalMachineKeySetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20231001Preview.BareMetalMachineKeySetPrivilegeLevel> PrivilegeLevel { get; set; } = null!;
