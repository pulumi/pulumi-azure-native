...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20231001preview:TrunkedNetwork")]
    public partial class TrunkedNetwork : global::Pulumi.CustomResource
    {
        ...
        public TrunkedNetwork(string name, TrunkedNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20231001preview:TrunkedNetwork", name, args ?? new TrunkedNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TrunkedNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20231001preview:TrunkedNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TrunkedNetworkArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20231001Preview.HybridAksPluginType>? HybridAksPluginType { get; set; }
