...
namespace Pulumi.AzureNative.NetworkCloud.V20231001Preview.Inputs
{
    ...
    public sealed class ClusterUpdateStrategyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20231001Preview.ClusterUpdateStrategyType> StrategyType { get; set; } = null!;

        /// <summary>
        /// Selection of how the threshold should be evaluated.
        /// </summary>
        [Input("thresholdType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20231001Preview.ValidationThresholdType> ThresholdType { get; set; } = null!;
