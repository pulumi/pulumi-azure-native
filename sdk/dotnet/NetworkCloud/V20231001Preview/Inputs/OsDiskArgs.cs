...
namespace Pulumi.AzureNative.NetworkCloud.V20231001Preview.Inputs
{
    ...
    public sealed class OsDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createOption")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20231001Preview.OsDiskCreateOption>? CreateOption { get; set; }

        /// <summary>
        /// The strategy for deleting the OS disk.
        /// </summary>
        [Input("deleteOption")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20231001Preview.OsDiskDeleteOption>? DeleteOption { get; set; }
