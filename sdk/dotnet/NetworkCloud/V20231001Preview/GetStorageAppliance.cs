...
namespace Pulumi.AzureNative.NetworkCloud.V20231001Preview
{
    public static class GetStorageAppliance
    {
        ...
        public static Task<GetStorageApplianceResult> InvokeAsync(GetStorageApplianceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStorageApplianceResult>("azure-native:networkcloud/v20231001preview:getStorageAppliance", args ?? new GetStorageApplianceArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of the provided storage appliance.
        /// </summary>
        public static Output<GetStorageApplianceResult> Invoke(GetStorageApplianceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStorageApplianceResult>("azure-native:networkcloud/v20231001preview:getStorageAppliance", args ?? new GetStorageApplianceInvokeArgs(), options.WithDefaults());
