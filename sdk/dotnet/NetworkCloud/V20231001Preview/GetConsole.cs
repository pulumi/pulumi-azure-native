...
namespace Pulumi.AzureNative.NetworkCloud.V20231001Preview
{
    public static class GetConsole
    {
        ...
        public static Task<GetConsoleResult> InvokeAsync(GetConsoleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConsoleResult>("azure-native:networkcloud/v20231001preview:getConsole", args ?? new GetConsoleArgs(), options.WithDefaults());
