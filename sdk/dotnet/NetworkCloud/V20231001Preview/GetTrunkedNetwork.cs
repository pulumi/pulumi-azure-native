...
namespace Pulumi.AzureNative.NetworkCloud.V20231001Preview
{
    public static class GetTrunkedNetwork
    {
        ...
        public static Task<GetTrunkedNetworkResult> InvokeAsync(GetTrunkedNetworkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTrunkedNetworkResult>("azure-native:networkcloud/v20231001preview:getTrunkedNetwork", args ?? new GetTrunkedNetworkArgs(), options.WithDefaults());
