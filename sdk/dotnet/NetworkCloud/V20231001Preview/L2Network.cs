...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20231001preview:L2Network")]
    public partial class L2Network : global::Pulumi.CustomResource
    {
        ...
        public L2Network(string name, L2NetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20231001preview:L2Network", name, args ?? new L2NetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private L2Network(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20231001preview:L2Network", name, null, MakeResourceOptions(options, id))
        {
        }
