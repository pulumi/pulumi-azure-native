...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20231001preview:BmcKeySet")]
    public partial class BmcKeySet : global::Pulumi.CustomResource
    {
        ...
        public BmcKeySet(string name, BmcKeySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20231001preview:BmcKeySet", name, args ?? new BmcKeySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BmcKeySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20231001preview:BmcKeySet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BmcKeySetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20231001Preview.BmcKeySetPrivilegeLevel> PrivilegeLevel { get; set; } = null!;
