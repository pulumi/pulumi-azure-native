...
namespace Pulumi.AzureNative.NetworkCloud.V20240601Preview
{
    public static class GetRack
    {
        ...
        public static Task<GetRackResult> InvokeAsync(GetRackArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRackResult>("azure-native:networkcloud/v20240601preview:getRack", args ?? new GetRackArgs(), options.WithDefaults());
