...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20240601preview:L2Network")]
    public partial class L2Network : global::Pulumi.CustomResource
    {
        ...
        public L2Network(string name, L2NetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240601preview:L2Network", name, args ?? new L2NetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private L2Network(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240601preview:L2Network", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20241001preview:L2Network" },
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20250201:L2Network" },
