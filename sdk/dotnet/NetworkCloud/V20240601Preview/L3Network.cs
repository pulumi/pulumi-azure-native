...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20240601preview:L3Network")]
    public partial class L3Network : global::Pulumi.CustomResource
    {
        ...
        public L3Network(string name, L3NetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240601preview:L3Network", name, args ?? new L3NetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private L3Network(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240601preview:L3Network", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class L3NetworkArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240601Preview.HybridAksIpamEnabled>? HybridAksIpamEnabled { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240601Preview.IpAllocationType>? IpAllocationType { get; set; }
