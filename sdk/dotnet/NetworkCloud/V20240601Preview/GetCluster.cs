...
namespace Pulumi.AzureNative.NetworkCloud.V20240601Preview
{
    public static class GetCluster
    {
        ...
        public static Task<GetClusterResult> InvokeAsync(GetClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterResult>("azure-native:networkcloud/v20240601preview:getCluster", args ?? new GetClusterArgs(), options.WithDefaults());
