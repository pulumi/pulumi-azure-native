...
namespace Pulumi.AzureNative.NetworkCloud.V20240601Preview
{
    public static class GetMetricsConfiguration
    {
        ...
        public static Task<GetMetricsConfigurationResult> InvokeAsync(GetMetricsConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMetricsConfigurationResult>("azure-native:networkcloud/v20240601preview:getMetricsConfiguration", args ?? new GetMetricsConfigurationArgs(), options.WithDefaults());
