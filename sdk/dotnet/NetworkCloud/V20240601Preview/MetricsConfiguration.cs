...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20240601preview:MetricsConfiguration")]
    public partial class MetricsConfiguration : global::Pulumi.CustomResource
    {
        ...
        public MetricsConfiguration(string name, MetricsConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240601preview:MetricsConfiguration", name, args ?? new MetricsConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetricsConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20240601preview:MetricsConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
