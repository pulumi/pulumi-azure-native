...
namespace Pulumi.AzureNative.NetworkCloud.V20240601Preview.Inputs
{
    ...
    public sealed class ClusterUpdateStrategyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240601Preview.ClusterUpdateStrategyType> StrategyType { get; set; } = null!;

        /// <summary>
        /// Selection of how the threshold should be evaluated.
        /// </summary>
        [Input("thresholdType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240601Preview.ValidationThresholdType> ThresholdType { get; set; } = null!;
