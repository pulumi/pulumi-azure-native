...
namespace Pulumi.AzureNative.NetworkCloud.V20240601Preview.Inputs
{
    ...
    public sealed class ServiceLoadBalancerBgpPeerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("bfdEnabled")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240601Preview.BfdEnabled>? BfdEnabled { get; set; }

        /// <summary>
        /// The indicator to enable multi-hop peering support.
        /// </summary>
        [Input("bgpMultiHop")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20240601Preview.BgpMultiHop>? BgpMultiHop { get; set; }
