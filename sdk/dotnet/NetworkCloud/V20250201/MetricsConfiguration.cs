...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20250201:MetricsConfiguration")]
    public partial class MetricsConfiguration : global::Pulumi.CustomResource
    {
        ...
        public MetricsConfiguration(string name, MetricsConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20250201:MetricsConfiguration", name, args ?? new MetricsConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetricsConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20250201:MetricsConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
