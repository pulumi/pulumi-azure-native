...
namespace Pulumi.AzureNative.NetworkCloud.V20250201
{
    public static class GetClusterManager
    {
        ...
        public static Task<GetClusterManagerResult> InvokeAsync(GetClusterManagerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterManagerResult>("azure-native:networkcloud/v20250201:getClusterManager", args ?? new GetClusterManagerArgs(), options.WithDefaults());

        /// <summary>
        /// Get the properties of the provided cluster manager.
        /// </summary>
        public static Output<GetClusterManagerResult> Invoke(GetClusterManagerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClusterManagerResult>("azure-native:networkcloud/v20250201:getClusterManager", args ?? new GetClusterManagerInvokeArgs(), options.WithDefaults());
