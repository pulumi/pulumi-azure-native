...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20250201:BareMetalMachineKeySet")]
    public partial class BareMetalMachineKeySet : global::Pulumi.CustomResource
    {
        ...
        public BareMetalMachineKeySet(string name, BareMetalMachineKeySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20250201:BareMetalMachineKeySet", name, args ?? new BareMetalMachineKeySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BareMetalMachineKeySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20250201:BareMetalMachineKeySet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BareMetalMachineKeySetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20250201.BareMetalMachineKeySetPrivilegeLevel> PrivilegeLevel { get; set; } = null!;
