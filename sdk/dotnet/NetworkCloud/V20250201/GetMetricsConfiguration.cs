...
namespace Pulumi.AzureNative.NetworkCloud.V20250201
{
    public static class GetMetricsConfiguration
    {
        ...
        public static Task<GetMetricsConfigurationResult> InvokeAsync(GetMetricsConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMetricsConfigurationResult>("azure-native:networkcloud/v20250201:getMetricsConfiguration", args ?? new GetMetricsConfigurationArgs(), options.WithDefaults());
        ...
        public static Output<GetMetricsConfigurationResult> Invoke(GetMetricsConfigurationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMetricsConfigurationResult>("azure-native:networkcloud/v20250201:getMetricsConfiguration", args ?? new GetMetricsConfigurationInvokeArgs(), options.WithDefaults());
