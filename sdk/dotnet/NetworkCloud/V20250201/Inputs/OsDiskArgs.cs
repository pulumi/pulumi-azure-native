...
namespace Pulumi.AzureNative.NetworkCloud.V20250201.Inputs
{
    ...
    public sealed class OsDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createOption")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20250201.OsDiskCreateOption>? CreateOption { get; set; }

        /// <summary>
        /// The strategy for deleting the OS disk.
        /// </summary>
        [Input("deleteOption")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20250201.OsDiskDeleteOption>? DeleteOption { get; set; }
