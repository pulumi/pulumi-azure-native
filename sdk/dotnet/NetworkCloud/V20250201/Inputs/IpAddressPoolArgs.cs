...
namespace Pulumi.AzureNative.NetworkCloud.V20250201.Inputs
{
    ...
    public sealed class IpAddressPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("autoAssign")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20250201.BfdEnabled>? AutoAssign { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20250201.BfdEnabled>? OnlyUseHostIps { get; set; }
