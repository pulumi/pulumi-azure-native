...
namespace Pulumi.AzureNative.NetworkCloud.V20250201
{
    public static class GetRack
    {
        ...
        public static Task<GetRackResult> InvokeAsync(GetRackArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRackResult>("azure-native:networkcloud/v20250201:getRack", args ?? new GetRackArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of the provided rack.
        /// </summary>
        public static Output<GetRackResult> Invoke(GetRackInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRackResult>("azure-native:networkcloud/v20250201:getRack", args ?? new GetRackInvokeArgs(), options.WithDefaults());
