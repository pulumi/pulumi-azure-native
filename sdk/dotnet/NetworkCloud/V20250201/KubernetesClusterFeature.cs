...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20250201:KubernetesClusterFeature")]
    public partial class KubernetesClusterFeature : global::Pulumi.CustomResource
    {
        ...
        public KubernetesClusterFeature(string name, KubernetesClusterFeatureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20250201:KubernetesClusterFeature", name, args ?? new KubernetesClusterFeatureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KubernetesClusterFeature(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20250201:KubernetesClusterFeature", name, null, MakeResourceOptions(options, id))
        {
        }
