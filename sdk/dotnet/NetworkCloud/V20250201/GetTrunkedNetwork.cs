...
namespace Pulumi.AzureNative.NetworkCloud.V20250201
{
    public static class GetTrunkedNetwork
    {
        ...
        public static Task<GetTrunkedNetworkResult> InvokeAsync(GetTrunkedNetworkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTrunkedNetworkResult>("azure-native:networkcloud/v20250201:getTrunkedNetwork", args ?? new GetTrunkedNetworkArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of the provided trunked network.
        /// </summary>
        public static Output<GetTrunkedNetworkResult> Invoke(GetTrunkedNetworkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTrunkedNetworkResult>("azure-native:networkcloud/v20250201:getTrunkedNetwork", args ?? new GetTrunkedNetworkInvokeArgs(), options.WithDefaults());
