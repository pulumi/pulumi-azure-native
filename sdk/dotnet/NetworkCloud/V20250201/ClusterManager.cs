...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20250201:ClusterManager")]
    public partial class ClusterManager : global::Pulumi.CustomResource
    {
        ...
        public ClusterManager(string name, ClusterManagerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20250201:ClusterManager", name, args ?? new ClusterManagerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterManager(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20250201:ClusterManager", name, null, MakeResourceOptions(options, id))
        {
        }
