...
namespace Pulumi.AzureNative.NetworkCloud
{
    ...
    public partial class VirtualMachine : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20250901:VirtualMachine" },
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20260101preview:VirtualMachine" },
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20260501preview:VirtualMachine" },
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20260701:VirtualMachine" },
                },
            };
