...
namespace Pulumi.AzureNative.NetworkCloud.V20241001Preview
{
    public static class GetKubernetesClusterFeature
    {
        ...
        public static Task<GetKubernetesClusterFeatureResult> InvokeAsync(GetKubernetesClusterFeatureArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKubernetesClusterFeatureResult>("azure-native:networkcloud/v20241001preview:getKubernetesClusterFeature", args ?? new GetKubernetesClusterFeatureArgs(), options.WithDefaults());
        ...
        public static Output<GetKubernetesClusterFeatureResult> Invoke(GetKubernetesClusterFeatureInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKubernetesClusterFeatureResult>("azure-native:networkcloud/v20241001preview:getKubernetesClusterFeature", args ?? new GetKubernetesClusterFeatureInvokeArgs(), options.WithDefaults());
