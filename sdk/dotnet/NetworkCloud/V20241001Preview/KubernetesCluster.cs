...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20241001preview:KubernetesCluster")]
    public partial class KubernetesCluster : global::Pulumi.CustomResource
    {
        ...
        public KubernetesCluster(string name, KubernetesClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20241001preview:KubernetesCluster", name, args ?? new KubernetesClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KubernetesCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20241001preview:KubernetesCluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20240701:KubernetesCluster" },
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20250201:KubernetesCluster" },
