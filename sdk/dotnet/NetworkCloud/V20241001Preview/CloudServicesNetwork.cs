...
namespace Pulumi.AzureNative.NetworkCloud.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:networkcloud/v20241001preview:CloudServicesNetwork")]
    public partial class CloudServicesNetwork : global::Pulumi.CustomResource
    {
        ...
        public CloudServicesNetwork(string name, CloudServicesNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20241001preview:CloudServicesNetwork", name, args ?? new CloudServicesNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudServicesNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20241001preview:CloudServicesNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CloudServicesNetworkArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20241001Preview.CloudServicesNetworkEnableDefaultEgressEndpoints>? EnableDefaultEgressEndpoints { get; set; }
