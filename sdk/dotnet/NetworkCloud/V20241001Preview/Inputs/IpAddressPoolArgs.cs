...
namespace Pulumi.AzureNative.NetworkCloud.V20241001Preview.Inputs
{
    ...
    public sealed class IpAddressPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("autoAssign")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20241001Preview.BfdEnabled>? AutoAssign { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20241001Preview.BfdEnabled>? OnlyUseHostIps { get; set; }
