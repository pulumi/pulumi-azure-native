...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20241001preview:BareMetalMachineKeySet")]
    public partial class BareMetalMachineKeySet : global::Pulumi.CustomResource
    {
        ...
        public BareMetalMachineKeySet(string name, BareMetalMachineKeySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20241001preview:BareMetalMachineKeySet", name, args ?? new BareMetalMachineKeySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BareMetalMachineKeySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20241001preview:BareMetalMachineKeySet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BareMetalMachineKeySetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20241001Preview.BareMetalMachineKeySetPrivilegeLevel> PrivilegeLevel { get; set; } = null!;
