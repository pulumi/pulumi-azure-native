...
namespace Pulumi.AzureNative.NetworkCloud
{
    ...
    public partial class KubernetesCluster : global::Pulumi.CustomResource
    {
        ...
        public KubernetesCluster(string name, KubernetesClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud:KubernetesCluster", name, args ?? new KubernetesClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KubernetesCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud:KubernetesCluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_networkcloud_v20230701:networkcloud:KubernetesCluster" },
                    new global::Pulumi.Alias { Type = "azure-native_networkcloud_v20231001preview:networkcloud:KubernetesCluster" },
                    new global::Pulumi.Alias { Type = "azure-native_networkcloud_v20240601preview:networkcloud:KubernetesCluster" },
                    new global::Pulumi.Alias { Type = "azure-native_networkcloud_v20240701:networkcloud:KubernetesCluster" },
                    new global::Pulumi.Alias { Type = "azure-native_networkcloud_v20241001preview:networkcloud:KubernetesCluster" },
                    new global::Pulumi.Alias { Type = "azure-native_networkcloud_v20250201:networkcloud:KubernetesCluster" },
                },
            };
