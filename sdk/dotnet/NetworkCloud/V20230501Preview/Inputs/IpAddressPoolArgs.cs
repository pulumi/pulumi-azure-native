...
namespace Pulumi.AzureNative.NetworkCloud.V20230501Preview.Inputs
{
    ...
    public sealed class IpAddressPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("autoAssign")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20230501Preview.BfdEnabled>? AutoAssign { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20230501Preview.BfdEnabled>? OnlyUseHostIps { get; set; }
