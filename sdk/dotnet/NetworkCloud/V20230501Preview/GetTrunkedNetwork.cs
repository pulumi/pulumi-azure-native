...
namespace Pulumi.AzureNative.NetworkCloud.V20230501Preview
{
    public static class GetTrunkedNetwork
    {
        ...
        public static Task<GetTrunkedNetworkResult> InvokeAsync(GetTrunkedNetworkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTrunkedNetworkResult>("azure-native:networkcloud/v20230501preview:getTrunkedNetwork", args ?? new GetTrunkedNetworkArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of the provided trunked network.
        /// </summary>
        public static Output<GetTrunkedNetworkResult> Invoke(GetTrunkedNetworkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTrunkedNetworkResult>("azure-native:networkcloud/v20230501preview:getTrunkedNetwork", args ?? new GetTrunkedNetworkInvokeArgs(), options.WithDefaults());
    }
