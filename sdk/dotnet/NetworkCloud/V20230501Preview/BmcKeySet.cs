...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20230501preview:BmcKeySet")]
    public partial class BmcKeySet : global::Pulumi.CustomResource
    {
        ...
        public BmcKeySet(string name, BmcKeySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230501preview:BmcKeySet", name, args ?? new BmcKeySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BmcKeySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230501preview:BmcKeySet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BmcKeySetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20230501Preview.BmcKeySetPrivilegeLevel> PrivilegeLevel { get; set; } = null!;
