...
namespace Pulumi.AzureNative.NetworkCloud.V20230501Preview
{
    public static class GetConsole
    {
        ...
        public static Task<GetConsoleResult> InvokeAsync(GetConsoleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConsoleResult>("azure-native:networkcloud/v20230501preview:getConsole", args ?? new GetConsoleArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of the provided virtual machine console.
        /// </summary>
        public static Output<GetConsoleResult> Invoke(GetConsoleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConsoleResult>("azure-native:networkcloud/v20230501preview:getConsole", args ?? new GetConsoleInvokeArgs(), options.WithDefaults());
    }
