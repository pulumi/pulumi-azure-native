...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20230501preview:TrunkedNetwork")]
    public partial class TrunkedNetwork : global::Pulumi.CustomResource
    {
        ...
        public TrunkedNetwork(string name, TrunkedNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230501preview:TrunkedNetwork", name, args ?? new TrunkedNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TrunkedNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230501preview:TrunkedNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
