...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20230501preview:BareMetalMachine")]
    public partial class BareMetalMachine : global::Pulumi.CustomResource
    {
        ...
        public BareMetalMachine(string name, BareMetalMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230501preview:BareMetalMachine", name, args ?? new BareMetalMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BareMetalMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230501preview:BareMetalMachine", name, null, MakeResourceOptions(options, id))
        {
        }
