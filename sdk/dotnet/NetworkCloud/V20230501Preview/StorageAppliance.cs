...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20230501preview:StorageAppliance")]
    public partial class StorageAppliance : global::Pulumi.CustomResource
    {
        ...
        public StorageAppliance(string name, StorageApplianceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230501preview:StorageAppliance", name, args ?? new StorageApplianceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAppliance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230501preview:StorageAppliance", name, null, MakeResourceOptions(options, id))
        {
        }
