...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20230501preview:VirtualMachine")]
    public partial class VirtualMachine : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230501preview:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230501preview:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualMachineArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("bootMethod")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20230501Preview.VirtualMachineBootMethod>? BootMethod { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20230501Preview.VirtualMachineIsolateEmulatorThread>? IsolateEmulatorThread { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20230501Preview.VirtualMachineVirtioInterfaceType>? VirtioInterface { get; set; }
        ...
        /// </summary>
        [Input("vmDeviceModel")]
        public InputUnion<string, Pulumi.AzureNative.NetworkCloud.V20230501Preview.VirtualMachineDeviceModelType>? VmDeviceModel { get; set; }
