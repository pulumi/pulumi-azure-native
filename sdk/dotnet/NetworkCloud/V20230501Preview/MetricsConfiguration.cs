...
{
    [AzureNativeResourceType("azure-native:networkcloud/v20230501preview:MetricsConfiguration")]
    public partial class MetricsConfiguration : global::Pulumi.CustomResource
    {
        ...
        public MetricsConfiguration(string name, MetricsConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230501preview:MetricsConfiguration", name, args ?? new MetricsConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetricsConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkcloud/v20230501preview:MetricsConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:networkcloud/v20221212preview:MetricsConfiguration"},
                },
            };
