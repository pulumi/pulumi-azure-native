...
namespace Pulumi.AzureNative.NetworkCloud.V20230501Preview
{
    public static class GetClusterManager
    {
        ...
        public static Task<GetClusterManagerResult> InvokeAsync(GetClusterManagerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterManagerResult>("azure-native:networkcloud/v20230501preview:getClusterManager", args ?? new GetClusterManagerArgs(), options.WithDefaults());

        /// <summary>
        /// Get the properties of the provided cluster manager.
        /// </summary>
        public static Output<GetClusterManagerResult> Invoke(GetClusterManagerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClusterManagerResult>("azure-native:networkcloud/v20230501preview:getClusterManager", args ?? new GetClusterManagerInvokeArgs(), options.WithDefaults());
    }
