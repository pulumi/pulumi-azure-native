...
namespace Pulumi.AzureNative.Dashboard
{
    ...
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dashboard:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dashboard:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_dashboard_v20220501preview:dashboard:PrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native_dashboard_v20220801:dashboard:PrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native_dashboard_v20221001preview:dashboard:PrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native_dashboard_v20230901:dashboard:PrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native_dashboard_v20231001preview:dashboard:PrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native_dashboard_v20241001:dashboard:PrivateEndpointConnection" },
                },
            };
