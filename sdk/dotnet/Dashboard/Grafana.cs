...
namespace Pulumi.AzureNative.Dashboard
{
    ...
    public partial class Grafana : global::Pulumi.CustomResource
    {
        ...
        public Grafana(string name, GrafanaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dashboard:Grafana", name, args ?? new GrafanaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Grafana(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dashboard:Grafana", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:dashboard/v20241101preview:Grafana" },
                    new global::Pulumi.Alias { Type = "azure-native:dashboard/v20250801:Grafana" },
                    new global::Pulumi.Alias { Type = "azure-native:dashboard/v20250901preview:Grafana" },
                },
            };
