...
namespace Pulumi.AzureNative.Dashboard.V20231001Preview.Inputs
{
    ...
    public sealed class ManagedGrafanaPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("apiKey")]
        public InputUnion<string, Pulumi.AzureNative.Dashboard.V20231001Preview.ApiKey>? ApiKey { get; set; }

        /// <summary>
        /// Scope for dns deterministic name hash calculation.
        /// </summary>
        [Input("autoGeneratedDomainNameLabelScope")]
        public InputUnion<string, Pulumi.AzureNative.Dashboard.V20231001Preview.AutoGeneratedDomainNameLabelScope>? AutoGeneratedDomainNameLabelScope { get; set; }

        /// <summary>
        /// Whether a Grafana instance uses deterministic outbound IPs.
        /// </summary>
        [Input("deterministicOutboundIP")]
        public InputUnion<string, Pulumi.AzureNative.Dashboard.V20231001Preview.DeterministicOutboundIP>? DeterministicOutboundIP { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Dashboard.V20231001Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }

        /// <summary>
        /// The zone redundancy setting of the Grafana instance.
        /// </summary>
        [Input("zoneRedundancy")]
        public InputUnion<string, Pulumi.AzureNative.Dashboard.V20231001Preview.ZoneRedundancy>? ZoneRedundancy { get; set; }
