...
namespace Pulumi.AzureNative.Dashboard.V20231001Preview
{
    public static class GetIntegrationFabric
    {
        ...
        public static Task<GetIntegrationFabricResult> InvokeAsync(GetIntegrationFabricArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIntegrationFabricResult>("azure-native:dashboard/v20231001preview:getIntegrationFabric", args ?? new GetIntegrationFabricArgs(), options.WithDefaults());
