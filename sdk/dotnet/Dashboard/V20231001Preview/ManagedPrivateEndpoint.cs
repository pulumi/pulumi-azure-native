...
namespace Pulumi.AzureNative.Dashboard.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dashboard/v20231001preview:ManagedPrivateEndpoint")]
    public partial class ManagedPrivateEndpoint : global::Pulumi.CustomResource
    {
        ...
        public ManagedPrivateEndpoint(string name, ManagedPrivateEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dashboard/v20231001preview:ManagedPrivateEndpoint", name, args ?? new ManagedPrivateEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedPrivateEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dashboard/v20231001preview:ManagedPrivateEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
