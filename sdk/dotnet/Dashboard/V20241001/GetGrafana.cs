...
namespace Pulumi.AzureNative.Dashboard.V20241001
{
    public static class GetGrafana
    {
        ...
        public static Task<GetGrafanaResult> InvokeAsync(GetGrafanaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGrafanaResult>("azure-native:dashboard/v20241001:getGrafana", args ?? new GetGrafanaArgs(), options.WithDefaults());

        /// <summary>
        /// The grafana resource type.
        /// </summary>
        public static Output<GetGrafanaResult> Invoke(GetGrafanaInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGrafanaResult>("azure-native:dashboard/v20241001:getGrafana", args ?? new GetGrafanaInvokeArgs(), options.WithDefaults());
