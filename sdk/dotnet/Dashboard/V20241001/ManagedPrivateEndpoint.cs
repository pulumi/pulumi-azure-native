...
namespace Pulumi.AzureNative.Dashboard.V20241001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dashboard/v20241001:ManagedPrivateEndpoint")]
    public partial class ManagedPrivateEndpoint : global::Pulumi.CustomResource
    {
        ...
        public ManagedPrivateEndpoint(string name, ManagedPrivateEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dashboard/v20241001:ManagedPrivateEndpoint", name, args ?? new ManagedPrivateEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedPrivateEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dashboard/v20241001:ManagedPrivateEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
