...
namespace Pulumi.AzureNative.Dashboard.V20241001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dashboard/v20241001:Grafana")]
    public partial class Grafana : global::Pulumi.CustomResource
    {
        ...
        public Grafana(string name, GrafanaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dashboard/v20241001:Grafana", name, args ?? new GrafanaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Grafana(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dashboard/v20241001:Grafana", name, null, MakeResourceOptions(options, id))
        {
        }
