...
namespace Pulumi.AzureNative.Dashboard.V20220501Preview
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.Dashboard.V20220501Preview.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:dashboard/v20220501preview:PrivateEndpointConnection myConnection /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/Microsoft.Dashboard/grafana/myWorkspace/privateEndpointConnections/myConnection 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dashboard/v20220501preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dashboard/v20220501preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dashboard/v20220501preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
