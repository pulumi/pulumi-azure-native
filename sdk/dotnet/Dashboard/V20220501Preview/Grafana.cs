...
namespace Pulumi.AzureNative.Dashboard.V20220501Preview
{
    ...
    /// {
    ///     var grafana = new AzureNative.Dashboard.V20220501Preview.Grafana("grafana", new()
    ///     {
    ///         Identity = new AzureNative.Dashboard.V20220501Preview.Inputs.ManagedServiceIdentityArgs
    ///         {
    ///             Type = "SystemAssigned",
    ///         },
    ///         Location = "West US",
    ///         Properties = new AzureNative.Dashboard.V20220501Preview.Inputs.ManagedGrafanaPropertiesArgs
    ///         {
    ///             ApiKey = "Enabled",
    ...
    ///         Sku = new AzureNative.Dashboard.V20220501Preview.Inputs.ResourceSkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ///         Tags = 
    ...
    public partial class Grafana : global::Pulumi.CustomResource
    {
        ...
        public Grafana(string name, GrafanaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dashboard/v20220501preview:Grafana", name, args ?? new GrafanaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Grafana(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dashboard/v20220501preview:Grafana", name, null, MakeResourceOptions(options, id))
        {
        }
