...
namespace Pulumi.AzureNative.Dashboard.V20221001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dashboard/v20221001preview:Grafana")]
    public partial class Grafana : global::Pulumi.CustomResource
    {
        ...
        public Grafana(string name, GrafanaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dashboard/v20221001preview:Grafana", name, args ?? new GrafanaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Grafana(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dashboard/v20221001preview:Grafana", name, null, MakeResourceOptions(options, id))
        {
        }
