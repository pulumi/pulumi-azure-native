...
namespace Pulumi.AzureNative.Advisor.V20250101
{
    /// <summary>
    /// The details of the snoozed or dismissed rule; for example, the duration, name, and GUID associated with the rule.
    /// </summary>
    [AzureNativeResourceType("azure-native:advisor/v20250101:Suppression")]
    public partial class Suppression : global::Pulumi.CustomResource
    {
        ...
        public Suppression(string name, SuppressionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:advisor/v20250101:Suppression", name, args ?? new SuppressionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Suppression(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:advisor/v20250101:Suppression", name, null, MakeResourceOptions(options, id))
        {
        }
