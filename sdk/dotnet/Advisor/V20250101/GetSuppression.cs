...
namespace Pulumi.AzureNative.Advisor.V20250101
{
    public static class GetSuppression
    {
        ...
        public static Task<GetSuppressionResult> InvokeAsync(GetSuppressionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSuppressionResult>("azure-native:advisor/v20250101:getSuppression", args ?? new GetSuppressionArgs(), options.WithDefaults());

        /// <summary>
        /// Obtains the details of a suppression.
        /// </summary>
        public static Output<GetSuppressionResult> Invoke(GetSuppressionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSuppressionResult>("azure-native:advisor/v20250101:getSuppression", args ?? new GetSuppressionInvokeArgs(), options.WithDefaults());
