...
namespace Pulumi.AzureNative.Advisor.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:advisor/v20230101:Suppression")]
    public partial class Suppression : global::Pulumi.CustomResource
    {
        ...
        public Suppression(string name, SuppressionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:advisor/v20230101:Suppression", name, args ?? new SuppressionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Suppression(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:advisor/v20230101:Suppression", name, null, MakeResourceOptions(options, id))
        {
        }
