...
namespace Pulumi.AzureRM.Advisor.V20160712Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var suppression = new AzureRM.Advisor.V20160712Preview.Suppression("suppression", new AzureRM.Advisor.V20160712Preview.SuppressionArgs
    ///         {
    ...
    public partial class Suppression : Pulumi.CustomResource
    {
        ...
        public Suppression(string name, SuppressionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:advisor/v20160712preview:Suppression", name, args ?? new SuppressionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Suppression(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:advisor/v20160712preview:Suppression", name, null, MakeResourceOptions(options, id))
        {
        }
