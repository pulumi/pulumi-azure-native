...
namespace Pulumi.AzureRM.Advisor.V20170419
{
    ...
    ///     public MyStack()
    ///     {
    ///         var suppression = new AzureRM.Advisor.V20170419.Suppression("suppression", new AzureRM.Advisor.V20170419.SuppressionArgs
    ///         {
    ...
    public partial class Suppression : Pulumi.CustomResource
    {
        ...
        public Suppression(string name, SuppressionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:advisor/v20170419:Suppression", name, args ?? new SuppressionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Suppression(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:advisor/v20170419:Suppression", name, null, MakeResourceOptions(options, id))
        {
        }
