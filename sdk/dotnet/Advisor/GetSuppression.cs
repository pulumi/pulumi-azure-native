...
namespace Pulumi.AzureRM.Advisor
{
    public static class GetSuppression
    {
        public static Task<GetSuppressionResult> InvokeAsync(GetSuppressionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSuppressionResult>("azurerm:advisor:getSuppression", args ?? new GetSuppressionArgs(), options.WithVersion());
    }
