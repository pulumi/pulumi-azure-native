...
namespace Pulumi.AzureNextGen.Advisor.V20170331
{
    public static class GetSuppression
    {
        public static Task<GetSuppressionResult> InvokeAsync(GetSuppressionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSuppressionResult>("azure-nextgen:advisor/v20170331:getSuppression", args ?? new GetSuppressionArgs(), options.WithVersion());
    }
