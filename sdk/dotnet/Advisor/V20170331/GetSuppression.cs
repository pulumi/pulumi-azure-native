...
namespace Pulumi.AzureNative.Advisor.V20170331
{
    public static class GetSuppression
    {
        ...
        public static Task<GetSuppressionResult> InvokeAsync(GetSuppressionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSuppressionResult>("azure-native:advisor/v20170331:getSuppression", args ?? new GetSuppressionArgs(), options.WithVersion());

        /// <summary>
        /// The details of the snoozed or dismissed rule; for example, the duration, name, and GUID associated with the rule.
        /// </summary>
        public static Output<GetSuppressionResult> Invoke(GetSuppressionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSuppressionResult>("azure-native:advisor/v20170331:getSuppression", args ?? new GetSuppressionInvokeArgs(), options.WithVersion());
    }
