...
namespace Pulumi.AzureNative.Advisor.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:advisor/v20230901preview:Assessment")]
    public partial class Assessment : global::Pulumi.CustomResource
    {
        ...
        public Assessment(string name, AssessmentArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:advisor/v20230901preview:Assessment", name, args ?? new AssessmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Assessment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:advisor/v20230901preview:Assessment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:advisor:Assessment" },
                },
            };
