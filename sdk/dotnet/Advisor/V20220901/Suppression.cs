...
namespace Pulumi.AzureNative.Advisor.V20220901
{
    ...
    [AzureNativeResourceType("azure-native:advisor/v20220901:Suppression")]
    public partial class Suppression : global::Pulumi.CustomResource
    {
        ...
        public Suppression(string name, SuppressionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:advisor/v20220901:Suppression", name, args ?? new SuppressionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Suppression(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:advisor/v20220901:Suppression", name, null, MakeResourceOptions(options, id))
        {
        }
