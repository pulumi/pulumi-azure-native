...
namespace Pulumi.AzureRM.Advisor.Preview
{
    public static class GetSuppression
    {
        public static Task<GetSuppressionResult> InvokeAsync(GetSuppressionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSuppressionResult>("azurerm:advisor/preview:getSuppression", args ?? new GetSuppressionArgs(), options.WithVersion());
    }
