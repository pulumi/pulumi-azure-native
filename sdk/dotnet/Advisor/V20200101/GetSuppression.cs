...
namespace Pulumi.AzureNative.Advisor.V20200101
{
    [Obsolete(@"azure-native:advisor/v20200101:Suppression is being removed in the next major version of this provider. Upgrade to at least azure-native:advisor/v20230101:Suppression to guarantee forwards compatibility.")]
    public static class GetSuppression
    {
        ...
        public static Task<GetSuppressionResult> InvokeAsync(GetSuppressionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSuppressionResult>("azure-native:advisor/v20200101:getSuppression", args ?? new GetSuppressionArgs(), options.WithDefaults());

        /// <summary>
        /// Obtains the details of a suppression.
        /// </summary>
        public static Output<GetSuppressionResult> Invoke(GetSuppressionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSuppressionResult>("azure-native:advisor/v20200101:getSuppression", args ?? new GetSuppressionInvokeArgs(), options.WithDefaults());
    }
