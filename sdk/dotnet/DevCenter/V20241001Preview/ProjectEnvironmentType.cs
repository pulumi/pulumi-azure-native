...
namespace Pulumi.AzureNative.DevCenter.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20241001preview:ProjectEnvironmentType")]
    public partial class ProjectEnvironmentType : global::Pulumi.CustomResource
    {
        ...
        public ProjectEnvironmentType(string name, ProjectEnvironmentTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:ProjectEnvironmentType", name, args ?? new ProjectEnvironmentTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectEnvironmentType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:ProjectEnvironmentType", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProjectEnvironmentTypeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20241001Preview.EnvironmentTypeEnableStatus>? Status { get; set; }
