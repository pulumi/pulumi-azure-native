...
namespace Pulumi.AzureNative.DevCenter.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20241001preview:ProjectCatalog")]
    public partial class ProjectCatalog : global::Pulumi.CustomResource
    {
        ...
        public ProjectCatalog(string name, ProjectCatalogArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:ProjectCatalog", name, args ?? new ProjectCatalogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectCatalog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:ProjectCatalog", name, null, MakeResourceOptions(options, id))
        {
        }
