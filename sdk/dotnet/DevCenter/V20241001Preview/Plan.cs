...
namespace Pulumi.AzureNative.DevCenter.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20241001preview:Plan")]
    public partial class Plan : global::Pulumi.CustomResource
    {
        ...
        public Plan(string name, PlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:Plan", name, args ?? new PlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Plan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:Plan", name, null, MakeResourceOptions(options, id))
        {
        }
