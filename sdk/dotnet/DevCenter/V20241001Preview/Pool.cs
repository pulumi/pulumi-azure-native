...
namespace Pulumi.AzureNative.DevCenter.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20241001preview:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("stopOnNoConnect")]
        public Output<Outputs.StopOnNoConnectConfigurationResponse?> StopOnNoConnect { get; private set; } = null!;
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20241001Preview.PoolDevBoxDefinitionType>? DevBoxDefinitionType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20241001Preview.LicenseType> LicenseType { get; set; } = null!;

        /// <summary>
        /// Indicates whether owners of Dev Boxes in this pool are added as local administrators on the Dev Box.
        /// </summary>
        [Input("localAdministrator", required: true)]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20241001Preview.LocalAdminStatus> LocalAdministrator { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20241001Preview.SingleSignOnStatus>? SingleSignOnStatus { get; set; }
        ...
        /// Stop on no connect configuration settings for Dev Boxes created in this pool.
        /// </summary>
        [Input("stopOnNoConnect")]
        public Input<Inputs.StopOnNoConnectConfigurationArgs>? StopOnNoConnect { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20241001Preview.VirtualNetworkType>? VirtualNetworkType { get; set; }
