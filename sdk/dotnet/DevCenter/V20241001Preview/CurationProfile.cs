...
namespace Pulumi.AzureNative.DevCenter.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20241001preview:CurationProfile")]
    public partial class CurationProfile : global::Pulumi.CustomResource
    {
        ...
        public CurationProfile(string name, CurationProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:CurationProfile", name, args ?? new CurationProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CurationProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:CurationProfile", name, null, MakeResourceOptions(options, id))
        {
        }
