...
namespace Pulumi.AzureNative.DevCenter.V20241001Preview
{
    public static class GetProjectInheritedSettings
    {
        ...
        public static Task<GetProjectInheritedSettingsResult> InvokeAsync(GetProjectInheritedSettingsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectInheritedSettingsResult>("azure-native:devcenter/v20241001preview:getProjectInheritedSettings", args ?? new GetProjectInheritedSettingsArgs(), options.WithDefaults());
