...
namespace Pulumi.AzureNative.DevCenter.V20241001Preview
{
    public static class GetProjectCatalog
    {
        ...
        public static Task<GetProjectCatalogResult> InvokeAsync(GetProjectCatalogArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectCatalogResult>("azure-native:devcenter/v20241001preview:getProjectCatalog", args ?? new GetProjectCatalogArgs(), options.WithDefaults());
