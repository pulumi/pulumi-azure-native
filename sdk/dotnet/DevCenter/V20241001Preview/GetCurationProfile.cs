...
namespace Pulumi.AzureNative.DevCenter.V20241001Preview
{
    public static class GetCurationProfile
    {
        ...
        public static Task<GetCurationProfileResult> InvokeAsync(GetCurationProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCurationProfileResult>("azure-native:devcenter/v20241001preview:getCurationProfile", args ?? new GetCurationProfileArgs(), options.WithDefaults());
