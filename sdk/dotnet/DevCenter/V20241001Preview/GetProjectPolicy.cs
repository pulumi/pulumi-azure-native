...
namespace Pulumi.AzureNative.DevCenter.V20241001Preview
{
    public static class GetProjectPolicy
    {
        ...
        public static Task<GetProjectPolicyResult> InvokeAsync(GetProjectPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectPolicyResult>("azure-native:devcenter/v20241001preview:getProjectPolicy", args ?? new GetProjectPolicyArgs(), options.WithDefaults());
