...
namespace Pulumi.AzureNative.DevCenter.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20241001preview:ProjectPolicy")]
    public partial class ProjectPolicy : global::Pulumi.CustomResource
    {
        ...
        public ProjectPolicy(string name, ProjectPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:ProjectPolicy", name, args ?? new ProjectPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:ProjectPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
