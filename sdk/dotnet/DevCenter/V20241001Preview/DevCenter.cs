...
namespace Pulumi.AzureNative.DevCenter.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20241001preview:DevCenter")]
    public partial class DevCenter : global::Pulumi.CustomResource
    {
        ...
        public DevCenter(string name, DevCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:DevCenter", name, args ?? new DevCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20241001preview:DevCenter", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DevCenterArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.DevCenter.V20241001Preview.DevCenterResourceType>>? _restrictedResourceTypes;

        /// <summary>
        /// Indicates the resource types that are restricted from being accessed by a project unless allowed by a project policy.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.DevCenter.V20241001Preview.DevCenterResourceType>> RestrictedResourceTypes
        {
            get => _restrictedResourceTypes ?? (_restrictedResourceTypes = new InputList<Union<string, Pulumi.AzureNative.DevCenter.V20241001Preview.DevCenterResourceType>>());
