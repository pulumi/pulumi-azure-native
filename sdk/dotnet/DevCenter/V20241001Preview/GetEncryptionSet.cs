...
namespace Pulumi.AzureNative.DevCenter.V20241001Preview
{
    public static class GetEncryptionSet
    {
        ...
        public static Task<GetEncryptionSetResult> InvokeAsync(GetEncryptionSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEncryptionSetResult>("azure-native:devcenter/v20241001preview:getEncryptionSet", args ?? new GetEncryptionSetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a devcenter encryption set.
        /// </summary>
        public static Output<GetEncryptionSetResult> Invoke(GetEncryptionSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEncryptionSetResult>("azure-native:devcenter/v20241001preview:getEncryptionSet", args ?? new GetEncryptionSetInvokeArgs(), options.WithDefaults());
