...
namespace Pulumi.AzureNative.DevCenter.V20250201
{
    public static class GetDevBoxDefinition
    {
        ...
        public static Task<GetDevBoxDefinitionResult> InvokeAsync(GetDevBoxDefinitionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDevBoxDefinitionResult>("azure-native:devcenter/v20250201:getDevBoxDefinition", args ?? new GetDevBoxDefinitionArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Dev Box definition
        /// </summary>
        public static Output<GetDevBoxDefinitionResult> Invoke(GetDevBoxDefinitionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDevBoxDefinitionResult>("azure-native:devcenter/v20250201:getDevBoxDefinition", args ?? new GetDevBoxDefinitionInvokeArgs(), options.WithDefaults());
