...
namespace Pulumi.AzureNative.DevCenter.V20250201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20250201:Project")]
    public partial class Project : global::Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20250201:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20250201:Project", name, null, MakeResourceOptions(options, id))
        {
        }
