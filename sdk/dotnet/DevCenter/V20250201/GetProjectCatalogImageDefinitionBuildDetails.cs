...
namespace Pulumi.AzureNative.DevCenter.V20250201
{
    public static class GetProjectCatalogImageDefinitionBuildDetails
    {
        ...
        public static Task<GetProjectCatalogImageDefinitionBuildDetailsResult> InvokeAsync(GetProjectCatalogImageDefinitionBuildDetailsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectCatalogImageDefinitionBuildDetailsResult>("azure-native:devcenter/v20250201:getProjectCatalogImageDefinitionBuildDetails", args ?? new GetProjectCatalogImageDefinitionBuildDetailsArgs(), options.WithDefaults());
        ...
        public static Output<GetProjectCatalogImageDefinitionBuildDetailsResult> Invoke(GetProjectCatalogImageDefinitionBuildDetailsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProjectCatalogImageDefinitionBuildDetailsResult>("azure-native:devcenter/v20250201:getProjectCatalogImageDefinitionBuildDetails", args ?? new GetProjectCatalogImageDefinitionBuildDetailsInvokeArgs(), options.WithDefaults());
