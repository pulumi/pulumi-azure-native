...
namespace Pulumi.AzureNative.DevCenter.V20250201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20250201:Catalog")]
    public partial class Catalog : global::Pulumi.CustomResource
    {
        ...
        public Catalog(string name, CatalogArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20250201:Catalog", name, args ?? new CatalogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Catalog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20250201:Catalog", name, null, MakeResourceOptions(options, id))
        {
        }
