...
namespace Pulumi.AzureNative.DevCenter.V20250201
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct DevCenterResourceType : IEquatable<DevCenterResourceType>
    {
        private readonly string _value;

        private DevCenterResourceType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static DevCenterResourceType Images { get; } = new DevCenterResourceType("Images");
        public static DevCenterResourceType AttachedNetworks { get; } = new DevCenterResourceType("AttachedNetworks");
        public static DevCenterResourceType Skus { get; } = new DevCenterResourceType("Skus");

        public static bool operator ==(DevCenterResourceType left, DevCenterResourceType right) => left.Equals(right);
        public static bool operator !=(DevCenterResourceType left, DevCenterResourceType right) => !left.Equals(right);

        public static explicit operator string(DevCenterResourceType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is DevCenterResourceType other && Equals(other);
        public bool Equals(DevCenterResourceType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct PolicyAction : IEquatable<PolicyAction>
    {
        ...
        public static PolicyAction Allow { get; } = new PolicyAction("Allow");
        public static PolicyAction Deny { get; } = new PolicyAction("Deny");
    ...
    /// </summary>
    [EnumType]
    public readonly struct StopOnNoConnectEnableStatus : IEquatable<StopOnNoConnectEnableStatus>
    {
        private readonly string _value;

        private StopOnNoConnectEnableStatus(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static StopOnNoConnectEnableStatus Enabled { get; } = new StopOnNoConnectEnableStatus("Enabled");
        public static StopOnNoConnectEnableStatus Disabled { get; } = new StopOnNoConnectEnableStatus("Disabled");

        public static bool operator ==(StopOnNoConnectEnableStatus left, StopOnNoConnectEnableStatus right) => left.Equals(right);
        public static bool operator !=(StopOnNoConnectEnableStatus left, StopOnNoConnectEnableStatus right) => !left.Equals(right);

        public static explicit operator string(StopOnNoConnectEnableStatus value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is StopOnNoConnectEnableStatus other && Equals(other);
        public bool Equals(StopOnNoConnectEnableStatus other) => string.Equals(_value, other._value, StringComparison.Ordinal);
