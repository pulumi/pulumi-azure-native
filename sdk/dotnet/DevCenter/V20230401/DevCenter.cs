...
namespace Pulumi.AzureNative.DevCenter.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20230401:DevCenter")]
    public partial class DevCenter : global::Pulumi.CustomResource
    {
        ...
        public DevCenter(string name, DevCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230401:DevCenter", name, args ?? new DevCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230401:DevCenter", name, null, MakeResourceOptions(options, id))
        {
        }
