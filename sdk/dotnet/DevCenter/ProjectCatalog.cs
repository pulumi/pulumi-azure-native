...
namespace Pulumi.AzureNative.DevCenter
{
    ...
    public partial class ProjectCatalog : global::Pulumi.CustomResource
    {
        ...
        public ProjectCatalog(string name, ProjectCatalogArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter:ProjectCatalog", name, args ?? new ProjectCatalogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectCatalog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter:ProjectCatalog", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:devcenter/v20250401preview:ProjectCatalog" },
                    new global::Pulumi.Alias { Type = "azure-native:devcenter/v20250701preview:ProjectCatalog" },
                    new global::Pulumi.Alias { Type = "azure-native:devcenter/v20251001preview:ProjectCatalog" },
                    new global::Pulumi.Alias { Type = "azure-native:devcenter/v20260101preview:ProjectCatalog" },
                },
            };
