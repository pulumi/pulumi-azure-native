...
namespace Pulumi.AzureNative.DevCenter.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20240201:AttachedNetworkByDevCenter")]
    public partial class AttachedNetworkByDevCenter : global::Pulumi.CustomResource
    {
        ...
        public AttachedNetworkByDevCenter(string name, AttachedNetworkByDevCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240201:AttachedNetworkByDevCenter", name, args ?? new AttachedNetworkByDevCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedNetworkByDevCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240201:AttachedNetworkByDevCenter", name, null, MakeResourceOptions(options, id))
        {
        }
