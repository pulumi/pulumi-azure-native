...
namespace Pulumi.AzureNative.DevCenter.V20240201
{
    public static class GetCatalogSyncErrorDetails
    {
        ...
        public static Task<GetCatalogSyncErrorDetailsResult> InvokeAsync(GetCatalogSyncErrorDetailsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCatalogSyncErrorDetailsResult>("azure-native:devcenter/v20240201:getCatalogSyncErrorDetails", args ?? new GetCatalogSyncErrorDetailsArgs(), options.WithDefaults());
        ...
        public static Output<GetCatalogSyncErrorDetailsResult> Invoke(GetCatalogSyncErrorDetailsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCatalogSyncErrorDetailsResult>("azure-native:devcenter/v20240201:getCatalogSyncErrorDetails", args ?? new GetCatalogSyncErrorDetailsInvokeArgs(), options.WithDefaults());
    }
