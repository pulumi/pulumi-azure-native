...
namespace Pulumi.AzureNative.DevCenter.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20240201:DevBoxDefinition")]
    public partial class DevBoxDefinition : global::Pulumi.CustomResource
    {
        ...
        public DevBoxDefinition(string name, DevBoxDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240201:DevBoxDefinition", name, args ?? new DevBoxDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevBoxDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240201:DevBoxDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DevBoxDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20240201.HibernateSupport>? HibernateSupport { get; set; }
