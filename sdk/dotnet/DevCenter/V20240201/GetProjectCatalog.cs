...
namespace Pulumi.AzureNative.DevCenter.V20240201
{
    public static class GetProjectCatalog
    {
        ...
        public static Task<GetProjectCatalogResult> InvokeAsync(GetProjectCatalogArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectCatalogResult>("azure-native:devcenter/v20240201:getProjectCatalog", args ?? new GetProjectCatalogArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an associated project catalog.
        /// </summary>
        public static Output<GetProjectCatalogResult> Invoke(GetProjectCatalogInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProjectCatalogResult>("azure-native:devcenter/v20240201:getProjectCatalog", args ?? new GetProjectCatalogInvokeArgs(), options.WithDefaults());
