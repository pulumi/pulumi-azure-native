...
namespace Pulumi.AzureNative.DevCenter.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20240201:EnvironmentType")]
    public partial class EnvironmentType : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentType(string name, EnvironmentTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240201:EnvironmentType", name, args ?? new EnvironmentTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240201:EnvironmentType", name, null, MakeResourceOptions(options, id))
        {
        }
