...
namespace Pulumi.AzureNative.DevCenter.V20240201
{
    public static class GetProjectCatalogSyncErrorDetails
    {
        ...
        public static Task<GetProjectCatalogSyncErrorDetailsResult> InvokeAsync(GetProjectCatalogSyncErrorDetailsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectCatalogSyncErrorDetailsResult>("azure-native:devcenter/v20240201:getProjectCatalogSyncErrorDetails", args ?? new GetProjectCatalogSyncErrorDetailsArgs(), options.WithDefaults());
