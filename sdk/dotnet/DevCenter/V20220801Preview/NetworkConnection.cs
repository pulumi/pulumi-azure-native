...
namespace Pulumi.AzureNative.DevCenter.V20220801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:devcenter/v20220801preview:NetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:NetworkConnection to guarantee forwards compatibility.")]
    ...
    public partial class NetworkConnection : global::Pulumi.CustomResource
    {
        ...
        public NetworkConnection(string name, NetworkConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220801preview:NetworkConnection", name, args ?? new NetworkConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220801preview:NetworkConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20220801Preview.DomainJoinType> DomainJoinType { get; set; } = null!;
