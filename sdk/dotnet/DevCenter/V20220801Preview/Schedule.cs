...
namespace Pulumi.AzureNative.DevCenter.V20220801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:devcenter/v20220801preview:Schedule is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:Schedule to guarantee forwards compatibility.")]
    ...
    public partial class Schedule : global::Pulumi.CustomResource
    {
        ...
        public Schedule(string name, ScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220801preview:Schedule", name, args ?? new ScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220801preview:Schedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20220801Preview.ScheduledFrequency> Frequency { get; set; } = null!;
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20220801Preview.EnableStatus>? State { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20220801Preview.ScheduledType> Type { get; set; } = null!;
