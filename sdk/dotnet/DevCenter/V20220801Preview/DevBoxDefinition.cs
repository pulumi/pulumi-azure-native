...
namespace Pulumi.AzureNative.DevCenter.V20220801Preview
{
    ...
    public partial class DevBoxDefinition : Pulumi.CustomResource
    {
        ...
        public DevBoxDefinition(string name, DevBoxDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220801preview:DevBoxDefinition", name, args ?? new DevBoxDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevBoxDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220801preview:DevBoxDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:devcenter:DevBoxDefinition"},
                },
            };
