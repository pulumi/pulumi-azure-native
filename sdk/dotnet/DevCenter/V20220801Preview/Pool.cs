...
namespace Pulumi.AzureNative.DevCenter.V20220801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:devcenter/v20220801preview:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:Pool to guarantee forwards compatibility.")]
    ...
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220801preview:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220801preview:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20220801Preview.LicenseType> LicenseType { get; set; } = null!;

        /// <summary>
        /// Indicates whether owners of Dev Boxes in this pool are added as local administrators on the Dev Box.
        /// </summary>
        [Input("localAdministrator", required: true)]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20220801Preview.LocalAdminStatus> LocalAdministrator { get; set; } = null!;
