...
{
    [Obsolete(@"azure-native:devcenter/v20220801preview:Catalog is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:Catalog to guarantee forwards compatibility.")]
    public static class GetCatalog
    {
        ...
        public static Task<GetCatalogResult> InvokeAsync(GetCatalogArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCatalogResult>("azure-native:devcenter/v20220801preview:getCatalog", args ?? new GetCatalogArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a catalog
        /// </summary>
        public static Output<GetCatalogResult> Invoke(GetCatalogInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCatalogResult>("azure-native:devcenter/v20220801preview:getCatalog", args ?? new GetCatalogInvokeArgs(), options.WithDefaults());
    }
