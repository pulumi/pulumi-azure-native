...
namespace Pulumi.AzureNative.DevCenter.V20240701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20240701preview:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("devBoxDefinition")]
        public Output<Outputs.PoolDevBoxDefinitionResponse?> DevBoxDefinition { get; private set; } = null!;
        ...
        /// </summary>
        [Output("devBoxDefinitionType")]
        public Output<string?> DevBoxDefinitionType { get; private set; } = null!;
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240701preview:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240701preview:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// A definition of the machines that are created from this Pool. Will be ignored if devBoxDefinitionType is Reference or not provided.
        /// </summary>
        [Input("devBoxDefinition")]
        public Input<Inputs.PoolDevBoxDefinitionArgs>? DevBoxDefinition { get; set; }
        ...
        /// Indicates if the pool is created from an existing Dev Box Definition or if one is provided directly.
        /// </summary>
        [Input("devBoxDefinitionType")]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20240701Preview.PoolDevBoxDefinitionType>? DevBoxDefinitionType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20240701Preview.LicenseType> LicenseType { get; set; } = null!;

        /// <summary>
        /// Indicates whether owners of Dev Boxes in this pool are added as local administrators on the Dev Box.
        /// </summary>
        [Input("localAdministrator", required: true)]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20240701Preview.LocalAdminStatus> LocalAdministrator { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20240701Preview.SingleSignOnStatus>? SingleSignOnStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20240701Preview.VirtualNetworkType>? VirtualNetworkType { get; set; }
