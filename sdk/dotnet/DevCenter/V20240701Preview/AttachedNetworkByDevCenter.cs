...
namespace Pulumi.AzureNative.DevCenter.V20240701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20240701preview:AttachedNetworkByDevCenter")]
    public partial class AttachedNetworkByDevCenter : global::Pulumi.CustomResource
    {
        ...
        public AttachedNetworkByDevCenter(string name, AttachedNetworkByDevCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240701preview:AttachedNetworkByDevCenter", name, args ?? new AttachedNetworkByDevCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedNetworkByDevCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240701preview:AttachedNetworkByDevCenter", name, null, MakeResourceOptions(options, id))
        {
        }
