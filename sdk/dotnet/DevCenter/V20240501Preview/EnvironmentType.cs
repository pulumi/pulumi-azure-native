...
namespace Pulumi.AzureNative.DevCenter.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20240501preview:EnvironmentType")]
    public partial class EnvironmentType : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentType(string name, EnvironmentTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240501preview:EnvironmentType", name, args ?? new EnvironmentTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240501preview:EnvironmentType", name, null, MakeResourceOptions(options, id))
        {
        }
