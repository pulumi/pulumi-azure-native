...
namespace Pulumi.AzureNative.DevCenter.V20240501Preview
{
    public static class GetGallery
    {
        ...
        public static Task<GetGalleryResult> InvokeAsync(GetGalleryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGalleryResult>("azure-native:devcenter/v20240501preview:getGallery", args ?? new GetGalleryArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a gallery
        /// </summary>
        public static Output<GetGalleryResult> Invoke(GetGalleryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGalleryResult>("azure-native:devcenter/v20240501preview:getGallery", args ?? new GetGalleryInvokeArgs(), options.WithDefaults());
