...
namespace Pulumi.AzureNative.DevCenter.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20240501preview:ProjectEnvironmentType")]
    public partial class ProjectEnvironmentType : global::Pulumi.CustomResource
    {
        ...
        public ProjectEnvironmentType(string name, ProjectEnvironmentTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240501preview:ProjectEnvironmentType", name, args ?? new ProjectEnvironmentTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectEnvironmentType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240501preview:ProjectEnvironmentType", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:devcenter/v20240601preview:ProjectEnvironmentType" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:devcenter/v20250201:ProjectEnvironmentType" },
    ...
    public sealed class ProjectEnvironmentTypeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20240501Preview.EnvironmentTypeEnableStatus>? Status { get; set; }
