...
namespace Pulumi.AzureNative.DevCenter.V20240501Preview
{
    public static class GetProjectCatalogSyncErrorDetails
    {
        ...
        public static Task<GetProjectCatalogSyncErrorDetailsResult> InvokeAsync(GetProjectCatalogSyncErrorDetailsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectCatalogSyncErrorDetailsResult>("azure-native:devcenter/v20240501preview:getProjectCatalogSyncErrorDetails", args ?? new GetProjectCatalogSyncErrorDetailsArgs(), options.WithDefaults());
        ...
        public static Output<GetProjectCatalogSyncErrorDetailsResult> Invoke(GetProjectCatalogSyncErrorDetailsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProjectCatalogSyncErrorDetailsResult>("azure-native:devcenter/v20240501preview:getProjectCatalogSyncErrorDetails", args ?? new GetProjectCatalogSyncErrorDetailsInvokeArgs(), options.WithDefaults());
    }
