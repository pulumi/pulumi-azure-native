...
namespace Pulumi.AzureNative.DevCenter.V20240501Preview
{
    public static class GetProject
    {
        ...
        public static Task<GetProjectResult> InvokeAsync(GetProjectArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectResult>("azure-native:devcenter/v20240501preview:getProject", args ?? new GetProjectArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a specific project.
        /// </summary>
        public static Output<GetProjectResult> Invoke(GetProjectInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProjectResult>("azure-native:devcenter/v20240501preview:getProject", args ?? new GetProjectInvokeArgs(), options.WithDefaults());
