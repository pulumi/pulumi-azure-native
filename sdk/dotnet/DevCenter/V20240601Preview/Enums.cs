...
namespace Pulumi.AzureNative.DevCenter.V20240601Preview
{
    ...
    public readonly struct CatalogItemType : IEquatable<CatalogItemType>
    {
        ...
        public static CatalogItemType ImageDefinition { get; } = new CatalogItemType("ImageDefinition");
    ...
    public readonly struct DomainJoinType : IEquatable<DomainJoinType>
    {
        ...
        public static DomainJoinType None { get; } = new DomainJoinType("None");
    ...
    /// </summary>
    [EnumType]
    public readonly struct InstallAzureMonitorAgentEnableStatus : IEquatable<InstallAzureMonitorAgentEnableStatus>
    {
        private readonly string _value;

        private InstallAzureMonitorAgentEnableStatus(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static InstallAzureMonitorAgentEnableStatus Enabled { get; } = new InstallAzureMonitorAgentEnableStatus("Enabled");
        public static InstallAzureMonitorAgentEnableStatus Disabled { get; } = new InstallAzureMonitorAgentEnableStatus("Disabled");
        ...
        public static explicit operator string(InstallAzureMonitorAgentEnableStatus value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is InstallAzureMonitorAgentEnableStatus other && Equals(other);
        public bool Equals(InstallAzureMonitorAgentEnableStatus other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct MicrosoftHostedNetworkEnableStatus : IEquatable<MicrosoftHostedNetworkEnableStatus>
    {
        private readonly string _value;

        private MicrosoftHostedNetworkEnableStatus(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static MicrosoftHostedNetworkEnableStatus Enabled { get; } = new MicrosoftHostedNetworkEnableStatus("Enabled");
        public static MicrosoftHostedNetworkEnableStatus Disabled { get; } = new MicrosoftHostedNetworkEnableStatus("Disabled");
        ...
        public static explicit operator string(MicrosoftHostedNetworkEnableStatus value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is MicrosoftHostedNetworkEnableStatus other && Equals(other);
        public bool Equals(MicrosoftHostedNetworkEnableStatus other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct PoolDevBoxDefinitionType : IEquatable<PoolDevBoxDefinitionType>
    {
        private readonly string _value;

        private PoolDevBoxDefinitionType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static PoolDevBoxDefinitionType Reference { get; } = new PoolDevBoxDefinitionType("Reference");
        public static PoolDevBoxDefinitionType Value { get; } = new PoolDevBoxDefinitionType("Value");

        public static bool operator ==(PoolDevBoxDefinitionType left, PoolDevBoxDefinitionType right) => left.Equals(right);
        public static bool operator !=(PoolDevBoxDefinitionType left, PoolDevBoxDefinitionType right) => !left.Equals(right);

        public static explicit operator string(PoolDevBoxDefinitionType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is PoolDevBoxDefinitionType other && Equals(other);
        public bool Equals(PoolDevBoxDefinitionType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
