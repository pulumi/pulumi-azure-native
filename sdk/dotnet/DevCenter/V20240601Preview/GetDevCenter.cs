...
namespace Pulumi.AzureNative.DevCenter.V20240601Preview
{
    public static class GetDevCenter
    {
        ...
        public static Task<GetDevCenterResult> InvokeAsync(GetDevCenterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDevCenterResult>("azure-native:devcenter/v20240601preview:getDevCenter", args ?? new GetDevCenterArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a devcenter.
        /// </summary>
        public static Output<GetDevCenterResult> Invoke(GetDevCenterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDevCenterResult>("azure-native:devcenter/v20240601preview:getDevCenter", args ?? new GetDevCenterInvokeArgs(), options.WithDefaults());
    }
