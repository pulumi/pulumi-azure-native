...
namespace Pulumi.AzureNative.DevCenter.V20240601Preview
{
    public static class GetPlanMember
    {
        ...
        public static Task<GetPlanMemberResult> InvokeAsync(GetPlanMemberArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPlanMemberResult>("azure-native:devcenter/v20240601preview:getPlanMember", args ?? new GetPlanMemberArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a devcenter plan member.
        /// </summary>
        public static Output<GetPlanMemberResult> Invoke(GetPlanMemberInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPlanMemberResult>("azure-native:devcenter/v20240601preview:getPlanMember", args ?? new GetPlanMemberInvokeArgs(), options.WithDefaults());
