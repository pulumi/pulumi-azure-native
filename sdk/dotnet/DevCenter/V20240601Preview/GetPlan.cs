...
namespace Pulumi.AzureNative.DevCenter.V20240601Preview
{
    public static class GetPlan
    {
        ...
        public static Task<GetPlanResult> InvokeAsync(GetPlanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPlanResult>("azure-native:devcenter/v20240601preview:getPlan", args ?? new GetPlanArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a devcenter plan.
        /// </summary>
        public static Output<GetPlanResult> Invoke(GetPlanInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPlanResult>("azure-native:devcenter/v20240601preview:getPlan", args ?? new GetPlanInvokeArgs(), options.WithDefaults());
