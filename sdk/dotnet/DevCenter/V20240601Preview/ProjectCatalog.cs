...
namespace Pulumi.AzureNative.DevCenter.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20240601preview:ProjectCatalog")]
    public partial class ProjectCatalog : global::Pulumi.CustomResource
    {
        ...
        public ProjectCatalog(string name, ProjectCatalogArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240601preview:ProjectCatalog", name, args ?? new ProjectCatalogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectCatalog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240601preview:ProjectCatalog", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProjectCatalogArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("syncType")]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20240601Preview.CatalogSyncType>? SyncType { get; set; }
