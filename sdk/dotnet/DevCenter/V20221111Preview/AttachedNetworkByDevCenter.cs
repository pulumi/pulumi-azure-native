...
namespace Pulumi.AzureNative.DevCenter.V20221111Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:devcenter/v20221111preview:AttachedNetworkByDevCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:AttachedNetworkByDevCenter to guarantee forwards compatibility.")]
    ...
    public partial class AttachedNetworkByDevCenter : global::Pulumi.CustomResource
    {
        ...
        public AttachedNetworkByDevCenter(string name, AttachedNetworkByDevCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221111preview:AttachedNetworkByDevCenter", name, args ?? new AttachedNetworkByDevCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedNetworkByDevCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221111preview:AttachedNetworkByDevCenter", name, null, MakeResourceOptions(options, id))
        {
        }
