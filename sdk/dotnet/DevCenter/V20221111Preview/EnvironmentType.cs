...
namespace Pulumi.AzureNative.DevCenter.V20221111Preview
{
    ...
    /// {
    ///     var environmentType = new AzureNative.DevCenter.V20221111Preview.EnvironmentType("environmentType", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:devcenter/v20221111preview:EnvironmentType DevTest /subscriptions/0ac520ee-14c0-480f-b6c9-0a90c58ffff/resourceGroups/rg1/providers/Microsoft.DevCenter/devcenters/Contoso/environmentTypes/DevTest 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20221111preview:EnvironmentType")]
    public partial class EnvironmentType : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentType(string name, EnvironmentTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221111preview:EnvironmentType", name, args ?? new EnvironmentTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221111preview:EnvironmentType", name, null, MakeResourceOptions(options, id))
        {
        }
