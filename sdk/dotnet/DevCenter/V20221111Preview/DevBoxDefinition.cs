...
namespace Pulumi.AzureNative.DevCenter.V20221111Preview
{
    ...
    /// {
    ///     var devBoxDefinition = new AzureNative.DevCenter.V20221111Preview.DevBoxDefinition("devBoxDefinition", new()
    ///     {
    ///         DevBoxDefinitionName = "WebDevBox",
    ///         DevCenterName = "Contoso",
    ///         HibernateSupport = "Enabled",
    ///         ImageReference = new AzureNative.DevCenter.V20221111Preview.Inputs.ImageReferenceArgs
    ///         {
    ...
    ///         Sku = new AzureNative.DevCenter.V20221111Preview.Inputs.SkuArgs
    ///         {
    ///             Name = "Preview",
    ///         },
    ///     });
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:devcenter/v20221111preview:DevBoxDefinition WebDevBox /subscriptions/0ac520ee-14c0-480f-b6c9-0a90c58ffff/resourceGroups/rg1/providers/Microsoft.DevCenter/devcenters/Contoso/devboxdefinitions/devBoxDefinitionName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20221111preview:DevBoxDefinition")]
    public partial class DevBoxDefinition : global::Pulumi.CustomResource
    {
        ...
        public DevBoxDefinition(string name, DevBoxDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221111preview:DevBoxDefinition", name, args ?? new DevBoxDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevBoxDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221111preview:DevBoxDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DevBoxDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20221111Preview.HibernateSupport>? HibernateSupport { get; set; }
