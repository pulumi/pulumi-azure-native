...
namespace Pulumi.AzureNative.DevCenter.V20221111Preview
{
    ...
    /// {
    ///     var schedule = new AzureNative.DevCenter.V20221111Preview.Schedule("schedule", new()
    ///     {
    ///         Frequency = "Daily",
    ///         PoolName = "DevPool",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20221111preview:Schedule")]
    public partial class Schedule : global::Pulumi.CustomResource
    {
        ...
        public Schedule(string name, ScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221111preview:Schedule", name, args ?? new ScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221111preview:Schedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20221111Preview.ScheduledFrequency> Frequency { get; set; } = null!;
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20221111Preview.EnableStatus>? State { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20221111Preview.ScheduledType> Type { get; set; } = null!;
