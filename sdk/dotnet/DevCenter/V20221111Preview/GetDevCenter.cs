...
{
    [Obsolete(@"azure-native:devcenter/v20221111preview:DevCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:DevCenter to guarantee forwards compatibility.")]
    public static class GetDevCenter
    {
        ...
        public static Task<GetDevCenterResult> InvokeAsync(GetDevCenterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDevCenterResult>("azure-native:devcenter/v20221111preview:getDevCenter", args ?? new GetDevCenterArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a devcenter.
        /// </summary>
        public static Output<GetDevCenterResult> Invoke(GetDevCenterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDevCenterResult>("azure-native:devcenter/v20221111preview:getDevCenter", args ?? new GetDevCenterInvokeArgs(), options.WithDefaults());
    }
