...
namespace Pulumi.AzureNative.DevCenter.V20221111Preview
{
    public static class GetDevBoxDefinition
    {
        ...
        public static Task<GetDevBoxDefinitionResult> InvokeAsync(GetDevBoxDefinitionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDevBoxDefinitionResult>("azure-native:devcenter/v20221111preview:getDevBoxDefinition", args ?? new GetDevBoxDefinitionArgs(), options.WithDefaults());
