...
namespace Pulumi.AzureNative.DevCenter.V20221111Preview
{
    ...
    /// {
    ///     var networkConnection = new AzureNative.DevCenter.V20221111Preview.NetworkConnection("networkConnection", new()
    ///     {
    ...
    public partial class NetworkConnection : global::Pulumi.CustomResource
    {
        ...
        public NetworkConnection(string name, NetworkConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221111preview:NetworkConnection", name, args ?? new NetworkConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221111preview:NetworkConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20221111Preview.DomainJoinType> DomainJoinType { get; set; } = null!;
