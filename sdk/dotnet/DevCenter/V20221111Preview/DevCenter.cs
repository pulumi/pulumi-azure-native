...
namespace Pulumi.AzureNative.DevCenter.V20221111Preview
{
    ...
    /// {
    ///     var devCenter = new AzureNative.DevCenter.V20221111Preview.DevCenter("devCenter", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20221111preview:DevCenter")]
    public partial class DevCenter : global::Pulumi.CustomResource
    {
        ...
        public DevCenter(string name, DevCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221111preview:DevCenter", name, args ?? new DevCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221111preview:DevCenter", name, null, MakeResourceOptions(options, id))
        {
        }
