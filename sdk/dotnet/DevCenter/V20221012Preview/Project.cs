...
namespace Pulumi.AzureNative.DevCenter.V20221012Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:devcenter/v20221012preview:Project is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:Project to guarantee forwards compatibility.")]
    ...
    public partial class Project : global::Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221012preview:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221012preview:Project", name, null, MakeResourceOptions(options, id))
        {
        }
