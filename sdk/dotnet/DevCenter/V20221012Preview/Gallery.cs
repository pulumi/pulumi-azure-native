...
namespace Pulumi.AzureNative.DevCenter.V20221012Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:devcenter/v20221012preview:Gallery is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:Gallery to guarantee forwards compatibility.")]
    ...
    public partial class Gallery : global::Pulumi.CustomResource
    {
        ...
        public Gallery(string name, GalleryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221012preview:Gallery", name, args ?? new GalleryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gallery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20221012preview:Gallery", name, null, MakeResourceOptions(options, id))
        {
        }
