...
{
    [Obsolete(@"azure-native:devcenter/v20221012preview:DevBoxDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:DevBoxDefinition to guarantee forwards compatibility.")]
    public static class GetDevBoxDefinition
    {
        ...
        public static Task<GetDevBoxDefinitionResult> InvokeAsync(GetDevBoxDefinitionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDevBoxDefinitionResult>("azure-native:devcenter/v20221012preview:getDevBoxDefinition", args ?? new GetDevBoxDefinitionArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Dev Box definition
        /// </summary>
        public static Output<GetDevBoxDefinitionResult> Invoke(GetDevBoxDefinitionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDevBoxDefinitionResult>("azure-native:devcenter/v20221012preview:getDevBoxDefinition", args ?? new GetDevBoxDefinitionInvokeArgs(), options.WithDefaults());
    }
