...
namespace Pulumi.AzureNative.DevCenter.V20230801Preview
{
    public static class GetCatalog
    {
        ...
        public static Task<GetCatalogResult> InvokeAsync(GetCatalogArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCatalogResult>("azure-native:devcenter/v20230801preview:getCatalog", args ?? new GetCatalogArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a catalog
        /// </summary>
        public static Output<GetCatalogResult> Invoke(GetCatalogInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCatalogResult>("azure-native:devcenter/v20230801preview:getCatalog", args ?? new GetCatalogInvokeArgs(), options.WithDefaults());
