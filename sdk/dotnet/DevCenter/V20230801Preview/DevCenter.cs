...
namespace Pulumi.AzureNative.DevCenter.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20230801preview:DevCenter")]
    public partial class DevCenter : global::Pulumi.CustomResource
    {
        ...
        public DevCenter(string name, DevCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230801preview:DevCenter", name, args ?? new DevCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230801preview:DevCenter", name, null, MakeResourceOptions(options, id))
        {
        }
