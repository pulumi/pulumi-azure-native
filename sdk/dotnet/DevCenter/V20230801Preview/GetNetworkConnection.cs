...
namespace Pulumi.AzureNative.DevCenter.V20230801Preview
{
    public static class GetNetworkConnection
    {
        ...
        public static Task<GetNetworkConnectionResult> InvokeAsync(GetNetworkConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkConnectionResult>("azure-native:devcenter/v20230801preview:getNetworkConnection", args ?? new GetNetworkConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a network connection resource
        /// </summary>
        public static Output<GetNetworkConnectionResult> Invoke(GetNetworkConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkConnectionResult>("azure-native:devcenter/v20230801preview:getNetworkConnection", args ?? new GetNetworkConnectionInvokeArgs(), options.WithDefaults());
