...
namespace Pulumi.AzureNative.DevCenter.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20230801preview:EnvironmentType")]
    public partial class EnvironmentType : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentType(string name, EnvironmentTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230801preview:EnvironmentType", name, args ?? new EnvironmentTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230801preview:EnvironmentType", name, null, MakeResourceOptions(options, id))
        {
        }
