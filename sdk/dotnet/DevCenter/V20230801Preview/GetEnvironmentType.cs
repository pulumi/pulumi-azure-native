...
namespace Pulumi.AzureNative.DevCenter.V20230801Preview
{
    public static class GetEnvironmentType
    {
        ...
        public static Task<GetEnvironmentTypeResult> InvokeAsync(GetEnvironmentTypeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEnvironmentTypeResult>("azure-native:devcenter/v20230801preview:getEnvironmentType", args ?? new GetEnvironmentTypeArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an environment type.
        /// </summary>
        public static Output<GetEnvironmentTypeResult> Invoke(GetEnvironmentTypeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEnvironmentTypeResult>("azure-native:devcenter/v20230801preview:getEnvironmentType", args ?? new GetEnvironmentTypeInvokeArgs(), options.WithDefaults());
