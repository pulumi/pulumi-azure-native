...
namespace Pulumi.AzureNative.DevCenter.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20231001preview:Catalog")]
    public partial class Catalog : global::Pulumi.CustomResource
    {
        ...
        public Catalog(string name, CatalogArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20231001preview:Catalog", name, args ?? new CatalogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Catalog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20231001preview:Catalog", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CatalogArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("syncType")]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20231001Preview.CatalogSyncType>? SyncType { get; set; }
