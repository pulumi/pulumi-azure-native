...
namespace Pulumi.AzureNative.DevCenter.V20230101Preview
{
    ...
    /// {
    ///     var networkConnection = new AzureNative.DevCenter.V20230101Preview.NetworkConnection("networkConnection", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20230101preview:NetworkConnection")]
    public partial class NetworkConnection : global::Pulumi.CustomResource
    {
        ...
        public NetworkConnection(string name, NetworkConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230101preview:NetworkConnection", name, args ?? new NetworkConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230101preview:NetworkConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20230101Preview.DomainJoinType> DomainJoinType { get; set; } = null!;
