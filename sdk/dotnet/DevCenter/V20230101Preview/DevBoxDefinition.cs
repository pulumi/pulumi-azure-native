...
namespace Pulumi.AzureNative.DevCenter.V20230101Preview
{
    ...
    /// {
    ///     var devBoxDefinition = new AzureNative.DevCenter.V20230101Preview.DevBoxDefinition("devBoxDefinition", new()
    ///     {
    ///         DevBoxDefinitionName = "WebDevBox",
    ///         DevCenterName = "Contoso",
    ///         HibernateSupport = "Enabled",
    ///         ImageReference = new AzureNative.DevCenter.V20230101Preview.Inputs.ImageReferenceArgs
    ///         {
    ...
    ///         Sku = new AzureNative.DevCenter.V20230101Preview.Inputs.SkuArgs
    ///         {
    ///             Name = "Preview",
    ///         },
    ///     });
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20230101preview:DevBoxDefinition")]
    public partial class DevBoxDefinition : global::Pulumi.CustomResource
    {
        ...
        public DevBoxDefinition(string name, DevBoxDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230101preview:DevBoxDefinition", name, args ?? new DevBoxDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevBoxDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230101preview:DevBoxDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DevBoxDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20230101Preview.HibernateSupport>? HibernateSupport { get; set; }
