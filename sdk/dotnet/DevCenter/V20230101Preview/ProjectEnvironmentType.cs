...
namespace Pulumi.AzureNative.DevCenter.V20230101Preview
{
    ...
    /// {
    ///     var projectEnvironmentType = new AzureNative.DevCenter.V20230101Preview.ProjectEnvironmentType("projectEnvironmentType", new()
    ///     {
    ///         CreatorRoleAssignment = new AzureNative.DevCenter.V20230101Preview.Inputs.ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignmentArgs
    ///         {
    ///             Roles = 
    ///             {
    ...
    ///         UserRoleAssignments = 
    ///         {
    ///             { "e45e3m7c-176e-416a-b466-0c5ec8298f8a", new AzureNative.DevCenter.V20230101Preview.Inputs.UserRoleAssignmentArgs
    ///             {
    ///                 Roles = 
    ///                 {
    ///                     { "4cbf0b6c-e750-441c-98a7-10da8387e4d6", null },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20230101preview:ProjectEnvironmentType")]
    public partial class ProjectEnvironmentType : global::Pulumi.CustomResource
    {
        ...
        public ProjectEnvironmentType(string name, ProjectEnvironmentTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230101preview:ProjectEnvironmentType", name, args ?? new ProjectEnvironmentTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectEnvironmentType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230101preview:ProjectEnvironmentType", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProjectEnvironmentTypeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20230101Preview.EnvironmentTypeEnableStatus>? Status { get; set; }
