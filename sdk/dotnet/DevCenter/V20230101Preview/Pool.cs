...
namespace Pulumi.AzureNative.DevCenter.V20230101Preview
{
    ...
    /// {
    ///     var pool = new AzureNative.DevCenter.V20230101Preview.Pool("pool", new()
    ///     {
    ...
    ///         StopOnDisconnect = new AzureNative.DevCenter.V20230101Preview.Inputs.StopOnDisconnectConfigurationArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20230101preview:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230101preview:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230101preview:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20230101Preview.LicenseType> LicenseType { get; set; } = null!;

        /// <summary>
        /// Indicates whether owners of Dev Boxes in this pool are added as local administrators on the Dev Box.
        /// </summary>
        [Input("localAdministrator", required: true)]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20230101Preview.LocalAdminStatus> LocalAdministrator { get; set; } = null!;
