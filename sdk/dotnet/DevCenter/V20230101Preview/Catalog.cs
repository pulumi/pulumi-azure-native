...
namespace Pulumi.AzureNative.DevCenter.V20230101Preview
{
    ...
    /// {
    ///     var catalog = new AzureNative.DevCenter.V20230101Preview.Catalog("catalog", new()
    ///     {
    ///         AdoGit = new AzureNative.DevCenter.V20230101Preview.Inputs.GitCatalogArgs
    ///         {
    ///             Branch = "main",
    ///             Path = "/templates",
    ...
    ///         CatalogName = "CentralCatalog",
    ///         DevCenterName = "Contoso",
    ///         GitHub = new AzureNative.DevCenter.V20230101Preview.Inputs.GitCatalogArgs
    ///         {
    ///             Branch = "main",
    ///             Path = "/templates",
    ///             SecretIdentifier = "https://contosokv.vault.azure.net/secrets/CentralRepoPat",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20230101preview:Catalog")]
    public partial class Catalog : global::Pulumi.CustomResource
    {
        ...
        public Catalog(string name, CatalogArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230101preview:Catalog", name, args ?? new CatalogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Catalog(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230101preview:Catalog", name, null, MakeResourceOptions(options, id))
        {
        }
