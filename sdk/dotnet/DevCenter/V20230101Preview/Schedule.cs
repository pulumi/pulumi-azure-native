...
namespace Pulumi.AzureNative.DevCenter.V20230101Preview
{
    ...
    /// {
    ///     var schedule = new AzureNative.DevCenter.V20230101Preview.Schedule("schedule", new()
    ///     {
    ///         Frequency = "Daily",
    ///         PoolName = "DevPool",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20230101preview:Schedule")]
    public partial class Schedule : global::Pulumi.CustomResource
    {
        ...
        public Schedule(string name, ScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230101preview:Schedule", name, args ?? new ScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20230101preview:Schedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20230101Preview.ScheduledFrequency> Frequency { get; set; } = null!;
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20230101Preview.ScheduleEnableStatus>? State { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20230101Preview.ScheduledType> Type { get; set; } = null!;
