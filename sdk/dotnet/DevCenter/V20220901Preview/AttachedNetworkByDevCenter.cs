...
namespace Pulumi.AzureNative.DevCenter.V20220901Preview
{
    ...
    /// {
    ///     var attachedNetworkByDevCenter = new AzureNative.DevCenter.V20220901Preview.AttachedNetworkByDevCenter("attachedNetworkByDevCenter", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20220901preview:AttachedNetworkByDevCenter")]
    public partial class AttachedNetworkByDevCenter : global::Pulumi.CustomResource
    {
        ...
        public AttachedNetworkByDevCenter(string name, AttachedNetworkByDevCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220901preview:AttachedNetworkByDevCenter", name, args ?? new AttachedNetworkByDevCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedNetworkByDevCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220901preview:AttachedNetworkByDevCenter", name, null, MakeResourceOptions(options, id))
        {
        }
