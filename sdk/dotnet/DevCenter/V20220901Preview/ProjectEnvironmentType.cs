...
namespace Pulumi.AzureNative.DevCenter.V20220901Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:devcenter/v20220901preview:ProjectEnvironmentType is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:ProjectEnvironmentType to guarantee forwards compatibility.")]
    ...
    public partial class ProjectEnvironmentType : global::Pulumi.CustomResource
    {
        ...
        public ProjectEnvironmentType(string name, ProjectEnvironmentTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220901preview:ProjectEnvironmentType", name, args ?? new ProjectEnvironmentTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectEnvironmentType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220901preview:ProjectEnvironmentType", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProjectEnvironmentTypeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.DevCenter.V20220901Preview.EnableStatus>? Status { get; set; }
