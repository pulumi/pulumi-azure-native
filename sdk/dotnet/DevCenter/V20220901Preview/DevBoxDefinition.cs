...
namespace Pulumi.AzureNative.DevCenter.V20220901Preview
{
    ...
    public partial class DevBoxDefinition : global::Pulumi.CustomResource
    {
        ...
        public DevBoxDefinition(string name, DevBoxDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220901preview:DevBoxDefinition", name, args ?? new DevBoxDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevBoxDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20220901preview:DevBoxDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
