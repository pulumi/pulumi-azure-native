...
namespace Pulumi.AzureNative.DevCenter.V20220901Preview
{
    public static class GetPool
    {
        ...
        public static Task<GetPoolResult> InvokeAsync(GetPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPoolResult>("azure-native:devcenter/v20220901preview:getPool", args ?? new GetPoolArgs(), options.WithDefaults());

        /// <summary>
        /// A pool of Virtual Machines.
        /// </summary>
        public static Output<GetPoolResult> Invoke(GetPoolInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPoolResult>("azure-native:devcenter/v20220901preview:getPool", args ?? new GetPoolInvokeArgs(), options.WithDefaults());
    }
