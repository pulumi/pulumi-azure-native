...
namespace Pulumi.AzureNative.DevCenter.V20240801Preview
{
    public static class GetProjectCatalogImageDefinitionBuildDetails
    {
        ...
        public static Task<GetProjectCatalogImageDefinitionBuildDetailsResult> InvokeAsync(GetProjectCatalogImageDefinitionBuildDetailsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectCatalogImageDefinitionBuildDetailsResult>("azure-native:devcenter/v20240801preview:getProjectCatalogImageDefinitionBuildDetails", args ?? new GetProjectCatalogImageDefinitionBuildDetailsArgs(), options.WithDefaults());
        ...
        public static Output<GetProjectCatalogImageDefinitionBuildDetailsResult> Invoke(GetProjectCatalogImageDefinitionBuildDetailsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProjectCatalogImageDefinitionBuildDetailsResult>("azure-native:devcenter/v20240801preview:getProjectCatalogImageDefinitionBuildDetails", args ?? new GetProjectCatalogImageDefinitionBuildDetailsInvokeArgs(), options.WithDefaults());
