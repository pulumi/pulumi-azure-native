...
namespace Pulumi.AzureNative.DevCenter.V20240801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20240801preview:DevCenter")]
    public partial class DevCenter : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("restrictedResourceTypes")]
        public Output<ImmutableArray<string>> RestrictedResourceTypes { get; private set; } = null!;
        ...
        public DevCenter(string name, DevCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240801preview:DevCenter", name, args ?? new DevCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240801preview:DevCenter", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DevCenterArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("restrictedResourceTypes")]
        private InputList<Union<string, Pulumi.AzureNative.DevCenter.V20240801Preview.DevCenterResourceType>>? _restrictedResourceTypes;

        /// <summary>
        /// Indicates the resource types that are restricted from being accessed by a project unless allowed by a curation profile.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.DevCenter.V20240801Preview.DevCenterResourceType>> RestrictedResourceTypes
        {
            get => _restrictedResourceTypes ?? (_restrictedResourceTypes = new InputList<Union<string, Pulumi.AzureNative.DevCenter.V20240801Preview.DevCenterResourceType>>());
            set => _restrictedResourceTypes = value;
        }
