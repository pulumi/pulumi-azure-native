...
namespace Pulumi.AzureNative.DevCenter.V20240801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20240801preview:Plan")]
    public partial class Plan : global::Pulumi.CustomResource
    {
        ...
        public Plan(string name, PlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240801preview:Plan", name, args ?? new PlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Plan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240801preview:Plan", name, null, MakeResourceOptions(options, id))
        {
        }
