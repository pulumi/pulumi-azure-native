...
namespace Pulumi.AzureNative.DevCenter.V20240801Preview
{
    public static class GetDevCenter
    {
        ...
        public static Task<GetDevCenterResult> InvokeAsync(GetDevCenterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDevCenterResult>("azure-native:devcenter/v20240801preview:getDevCenter", args ?? new GetDevCenterArgs(), options.WithDefaults());
