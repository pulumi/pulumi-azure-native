...
namespace Pulumi.AzureNative.DevCenter.V20240801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devcenter/v20240801preview:CurationProfile")]
    public partial class CurationProfile : global::Pulumi.CustomResource
    {
        ...
        public CurationProfile(string name, CurationProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240801preview:CurationProfile", name, args ?? new CurationProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CurationProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devcenter/v20240801preview:CurationProfile", name, null, MakeResourceOptions(options, id))
        {
        }
