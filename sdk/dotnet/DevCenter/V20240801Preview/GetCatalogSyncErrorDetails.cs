...
namespace Pulumi.AzureNative.DevCenter.V20240801Preview
{
    public static class GetCatalogSyncErrorDetails
    {
        ...
        public static Task<GetCatalogSyncErrorDetailsResult> InvokeAsync(GetCatalogSyncErrorDetailsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCatalogSyncErrorDetailsResult>("azure-native:devcenter/v20240801preview:getCatalogSyncErrorDetails", args ?? new GetCatalogSyncErrorDetailsArgs(), options.WithDefaults());
        ...
        public static Output<GetCatalogSyncErrorDetailsResult> Invoke(GetCatalogSyncErrorDetailsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCatalogSyncErrorDetailsResult>("azure-native:devcenter/v20240801preview:getCatalogSyncErrorDetails", args ?? new GetCatalogSyncErrorDetailsInvokeArgs(), options.WithDefaults());
