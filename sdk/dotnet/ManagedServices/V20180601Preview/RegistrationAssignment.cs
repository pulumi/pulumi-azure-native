...
namespace Pulumi.AzureRM.ManagedServices.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var registrationAssignment = new AzureRM.ManagedServices.V20180601Preview.RegistrationAssignment("registrationAssignment", new AzureRM.ManagedServices.V20180601Preview.RegistrationAssignmentArgs
    ///         {
    ...
    public partial class RegistrationAssignment : Pulumi.CustomResource
    {
        ...
        public RegistrationAssignment(string name, RegistrationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/v20180601preview:RegistrationAssignment", name, args ?? new RegistrationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/v20180601preview:RegistrationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
