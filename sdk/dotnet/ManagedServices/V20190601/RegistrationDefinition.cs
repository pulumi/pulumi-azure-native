...
namespace Pulumi.AzureNative.ManagedServices.V20190601
{
    ...
    public partial class RegistrationDefinition : global::Pulumi.CustomResource
    {
        ...
        public RegistrationDefinition(string name, RegistrationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedservices/v20190601:RegistrationDefinition", name, args ?? new RegistrationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedservices/v20190601:RegistrationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
