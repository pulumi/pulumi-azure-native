...
namespace Pulumi.AzureRM.ManagedServices.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var registrationDefinition = new AzureRM.ManagedServices.V20190601.RegistrationDefinition("registrationDefinition", new AzureRM.ManagedServices.V20190601.RegistrationDefinitionArgs
    ///         {
    ///             Plan = new AzureRM.ManagedServices.V20190601.Inputs.PlanArgs
    ///             {
    ///                 Name = "addesai-plan",
    ///                 Product = "test",
    ...
    public partial class RegistrationDefinition : Pulumi.CustomResource
    {
        ...
        public RegistrationDefinition(string name, RegistrationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/v20190601:RegistrationDefinition", name, args ?? new RegistrationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/v20190601:RegistrationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
