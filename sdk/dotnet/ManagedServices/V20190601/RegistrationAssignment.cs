...
namespace Pulumi.AzureRM.ManagedServices.V20190601
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var registrationAssignment = new AzureRM.ManagedServices.V20190601.RegistrationAssignment("registrationAssignment", new AzureRM.ManagedServices.V20190601.RegistrationAssignmentArgs
    ///         {
    ...
    public partial class RegistrationAssignment : Pulumi.CustomResource
    {
        ...
        public RegistrationAssignment(string name, RegistrationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/v20190601:RegistrationAssignment", name, args ?? new RegistrationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/v20190601:RegistrationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:managedservices/v20190901:RegistrationAssignment"},
                },
            };
