...
namespace Pulumi.AzureNextGen.ManagedServices.V20190601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:managedservices/v20190601:RegistrationAssignment")]
    public partial class RegistrationAssignment : Pulumi.CustomResource
    {
        ...
        public RegistrationAssignment(string name, RegistrationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:managedservices/v20190601:RegistrationAssignment", name, args ?? new RegistrationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:managedservices/v20190601:RegistrationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
