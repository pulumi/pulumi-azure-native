...
namespace Pulumi.AzureNative.ManagedServices.V20220101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managedservices/v20220101preview:RegistrationAssignment")]
    public partial class RegistrationAssignment : global::Pulumi.CustomResource
    {
        ...
        public RegistrationAssignment(string name, RegistrationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedservices/v20220101preview:RegistrationAssignment", name, args ?? new RegistrationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedservices/v20220101preview:RegistrationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
