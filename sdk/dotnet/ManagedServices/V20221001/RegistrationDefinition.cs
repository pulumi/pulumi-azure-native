...
namespace Pulumi.AzureNative.ManagedServices.V20221001
{
    ...
    public partial class RegistrationDefinition : global::Pulumi.CustomResource
    {
        ...
        public RegistrationDefinition(string name, RegistrationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedservices/v20221001:RegistrationDefinition", name, args ?? new RegistrationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedservices/v20221001:RegistrationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
