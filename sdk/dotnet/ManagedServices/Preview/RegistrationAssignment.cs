...
namespace Pulumi.AzureRM.ManagedServices.Preview
{
    ...
    public partial class RegistrationAssignment : Pulumi.CustomResource
    {
        ...
        public RegistrationAssignment(string name, RegistrationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/preview:RegistrationAssignment", name, args ?? new RegistrationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/preview:RegistrationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
