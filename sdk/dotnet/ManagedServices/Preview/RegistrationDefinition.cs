...
namespace Pulumi.AzureRM.ManagedServices.Preview
{
    ...
    public partial class RegistrationDefinition : Pulumi.CustomResource
    {
        ...
        public RegistrationDefinition(string name, RegistrationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/preview:RegistrationDefinition", name, args ?? new RegistrationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/preview:RegistrationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
