...
azure-native:managedservices/v20190401preview:RegistrationDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:managedservices/v20221001:RegistrationDefinition to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:managedservices/v20190401preview:RegistrationDefinition")]
    public partial class RegistrationDefinition : global::Pulumi.CustomResource
    {
        ...
        public RegistrationDefinition(string name, RegistrationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedservices/v20190401preview:RegistrationDefinition", name, args ?? new RegistrationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedservices/v20190401preview:RegistrationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
