...
namespace Pulumi.AzureNextGen.ManagedServices.V20190401Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:managedservices/v20190401preview:RegistrationDefinition")]
    public partial class RegistrationDefinition : Pulumi.CustomResource
    {
        ...
        public RegistrationDefinition(string name, RegistrationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:managedservices/v20190401preview:RegistrationDefinition", name, args ?? new RegistrationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:managedservices/v20190401preview:RegistrationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
