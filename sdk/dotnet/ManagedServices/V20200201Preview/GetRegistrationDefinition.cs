...
namespace Pulumi.AzureRM.ManagedServices.V20200201Preview
{
    public static class GetRegistrationDefinition
    {
        public static Task<GetRegistrationDefinitionResult> InvokeAsync(GetRegistrationDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegistrationDefinitionResult>("azurerm:managedservices/v20200201preview:getRegistrationDefinition", args ?? new GetRegistrationDefinitionArgs(), options.WithVersion());
    }
