...
namespace Pulumi.AzureRM.ManagedServices.V20200201Preview
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var registrationDefinition = new AzureRM.ManagedServices.V20200201Preview.RegistrationDefinition("registrationDefinition", new AzureRM.ManagedServices.V20200201Preview.RegistrationDefinitionArgs
    ///         {
    ///             Plan = new AzureRM.ManagedServices.V20200201Preview.Inputs.PlanArgs
    ///             {
    ///                 Name = "addesai-plan",
    ///                 Product = "test",
    ...
    public partial class RegistrationDefinition : Pulumi.CustomResource
    {
        ...
        public RegistrationDefinition(string name, RegistrationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/v20200201preview:RegistrationDefinition", name, args ?? new RegistrationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/v20200201preview:RegistrationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
