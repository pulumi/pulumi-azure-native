...
namespace Pulumi.AzureNative.ManagedServices.V20200201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:managedservices/v20200201preview:RegistrationDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:managedservices/v20221001:RegistrationDefinition to guarantee forwards compatibility.")]
    ...
    public partial class RegistrationDefinition : global::Pulumi.CustomResource
    {
        ...
        public RegistrationDefinition(string name, RegistrationDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedservices/v20200201preview:RegistrationDefinition", name, args ?? new RegistrationDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedservices/v20200201preview:RegistrationDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
