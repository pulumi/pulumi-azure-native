...
namespace Pulumi.AzureNextGen.ManagedServices.V20200201Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:managedservices/v20200201preview:RegistrationAssignment")]
    public partial class RegistrationAssignment : Pulumi.CustomResource
    {
        ...
        public RegistrationAssignment(string name, RegistrationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:managedservices/v20200201preview:RegistrationAssignment", name, args ?? new RegistrationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:managedservices/v20200201preview:RegistrationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
