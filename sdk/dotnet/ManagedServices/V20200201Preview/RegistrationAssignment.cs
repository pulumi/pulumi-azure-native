...
namespace Pulumi.AzureRM.ManagedServices.V20200201Preview
{
    ...
    public partial class RegistrationAssignment : Pulumi.CustomResource
    {
        ...
        public RegistrationAssignment(string name, RegistrationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/v20200201preview:RegistrationAssignment", name, args ?? new RegistrationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managedservices/v20200201preview:RegistrationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
