...
namespace Pulumi.AzureNative.SecurityAndCompliance
{
    ...
    public partial class PrivateEndpointConnectionsForMIPPolicySync : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsForMIPPolicySync(string name, PrivateEndpointConnectionsForMIPPolicySyncArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance:PrivateEndpointConnectionsForMIPPolicySync", name, args ?? new PrivateEndpointConnectionsForMIPPolicySyncArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsForMIPPolicySync(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance:PrivateEndpointConnectionsForMIPPolicySync", name, null, MakeResourceOptions(options, id))
        {
        }
