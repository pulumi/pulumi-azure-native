...
namespace Pulumi.AzureNative.SecurityAndCompliance
{
    ...
    public partial class PrivateEndpointConnectionsSec : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsSec(string name, PrivateEndpointConnectionsSecArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance:PrivateEndpointConnectionsSec", name, args ?? new PrivateEndpointConnectionsSecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsSec(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance:PrivateEndpointConnectionsSec", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_securityandcompliance_v20210111:securityandcompliance:PrivateEndpointConnectionsSec" },
                    new global::Pulumi.Alias { Type = "azure-native_securityandcompliance_v20210308:securityandcompliance:PrivateEndpointConnectionsSec" },
                },
            };
