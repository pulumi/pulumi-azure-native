...
namespace Pulumi.AzureNative.SecurityAndCompliance
{
    ...
    public partial class PrivateEndpointConnectionsAdtAPI : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsAdtAPI(string name, PrivateEndpointConnectionsAdtAPIArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance:PrivateEndpointConnectionsAdtAPI", name, args ?? new PrivateEndpointConnectionsAdtAPIArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsAdtAPI(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance:PrivateEndpointConnectionsAdtAPI", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsAdtAPI" },
                    new global::Pulumi.Alias { Type = "azure-native_securityandcompliance_v20210111:securityandcompliance:PrivateEndpointConnectionsAdtAPI" },
                    new global::Pulumi.Alias { Type = "azure-native_securityandcompliance_v20210308:securityandcompliance:PrivateEndpointConnectionsAdtAPI" },
                },
            };
