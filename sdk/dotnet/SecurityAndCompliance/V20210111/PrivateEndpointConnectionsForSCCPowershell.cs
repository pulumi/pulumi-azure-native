...
namespace Pulumi.AzureNative.SecurityAndCompliance.V20210111
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsForSCCPowershell")]
    public partial class PrivateEndpointConnectionsForSCCPowershell : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsForSCCPowershell(string name, PrivateEndpointConnectionsForSCCPowershellArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsForSCCPowershell", name, args ?? new PrivateEndpointConnectionsForSCCPowershellArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsForSCCPowershell(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsForSCCPowershell", name, null, MakeResourceOptions(options, id))
        {
        }
