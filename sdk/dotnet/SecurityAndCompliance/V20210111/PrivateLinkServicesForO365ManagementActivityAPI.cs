...
namespace Pulumi.AzureNative.SecurityAndCompliance.V20210111
{
    ...
    public partial class PrivateLinkServicesForO365ManagementActivityAPI : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkServicesForO365ManagementActivityAPI(string name, PrivateLinkServicesForO365ManagementActivityAPIArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/v20210111:PrivateLinkServicesForO365ManagementActivityAPI", name, args ?? new PrivateLinkServicesForO365ManagementActivityAPIArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkServicesForO365ManagementActivityAPI(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/v20210111:PrivateLinkServicesForO365ManagementActivityAPI", name, null, MakeResourceOptions(options, id))
        {
        }
