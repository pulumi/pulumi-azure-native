...
namespace Pulumi.AzureNative.SecurityAndCompliance.V20210111
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsSec is being removed in the next major version of this provider. Upgrade to at least azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsSec to guarantee forwards compatibility.")]
    ...
    public partial class PrivateEndpointConnectionsSec : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsSec(string name, PrivateEndpointConnectionsSecArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsSec", name, args ?? new PrivateEndpointConnectionsSecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsSec(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsSec", name, null, MakeResourceOptions(options, id))
        {
        }
