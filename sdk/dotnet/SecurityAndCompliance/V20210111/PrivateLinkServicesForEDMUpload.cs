...
namespace Pulumi.AzureNative.SecurityAndCompliance.V20210111
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityandcompliance/v20210111:privateLinkServicesForEDMUpload is being removed in the next major version of this provider. Please upgrade to azure-native:securityandcompliance/v20210308:privateLinkServicesForEDMUpload to guarantee forwards compatibility.")]
    ...
    public partial class PrivateLinkServicesForEDMUpload : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkServicesForEDMUpload(string name, PrivateLinkServicesForEDMUploadArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/v20210111:privateLinkServicesForEDMUpload", name, args ?? new PrivateLinkServicesForEDMUploadArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkServicesForEDMUpload(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/v20210111:privateLinkServicesForEDMUpload", name, null, MakeResourceOptions(options, id))
        {
        }
