...
namespace Pulumi.AzureNative.SecurityAndCompliance.V20210111
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityandcompliance/v20210111:privateLinkServicesForM365ComplianceCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:securityandcompliance/v20210308:privateLinkServicesForM365ComplianceCenter to guarantee forwards compatibility.")]
    ...
    public partial class PrivateLinkServicesForM365ComplianceCenter : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkServicesForM365ComplianceCenter(string name, PrivateLinkServicesForM365ComplianceCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/v20210111:privateLinkServicesForM365ComplianceCenter", name, args ?? new PrivateLinkServicesForM365ComplianceCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkServicesForM365ComplianceCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/v20210111:privateLinkServicesForM365ComplianceCenter", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PrivateLinkServicesForM365ComplianceCenter Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class PrivateLinkServicesForM365ComplianceCenterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.SecurityAndCompliance.V20210111.Kind> Kind { get; set; } = null!;
