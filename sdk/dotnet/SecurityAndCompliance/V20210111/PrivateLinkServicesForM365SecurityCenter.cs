...
namespace Pulumi.AzureNative.SecurityAndCompliance.V20210111
{
    ...
    [AzureNativeResourceType("azure-native:securityandcompliance/v20210111:privateLinkServicesForM365SecurityCenter")]
    public partial class PrivateLinkServicesForM365SecurityCenter : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkServicesForM365SecurityCenter(string name, PrivateLinkServicesForM365SecurityCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/v20210111:privateLinkServicesForM365SecurityCenter", name, args ?? new PrivateLinkServicesForM365SecurityCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkServicesForM365SecurityCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/v20210111:privateLinkServicesForM365SecurityCenter", name, null, MakeResourceOptions(options, id))
        {
        }
