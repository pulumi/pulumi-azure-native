...
namespace Pulumi.AzureNative.SecurityAndCompliance.Latest
{
    ...
    public partial class PrivateEndpointConnectionsForEDM : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsForEDM(string name, PrivateEndpointConnectionsForEDMArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsForEDM", name, args ?? new PrivateEndpointConnectionsForEDMArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsForEDM(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsForEDM", name, null, MakeResourceOptions(options, id))
        {
        }
