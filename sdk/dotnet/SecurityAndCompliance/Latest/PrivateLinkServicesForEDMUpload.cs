...
namespace Pulumi.AzureNative.SecurityAndCompliance.Latest
{
    ...
    public partial class PrivateLinkServicesForEDMUpload : Pulumi.CustomResource
    {
        ...
        public PrivateLinkServicesForEDMUpload(string name, PrivateLinkServicesForEDMUploadArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:privateLinkServicesForEDMUpload", name, args ?? new PrivateLinkServicesForEDMUploadArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkServicesForEDMUpload(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:privateLinkServicesForEDMUpload", name, null, MakeResourceOptions(options, id))
        {
        }
