...
namespace Pulumi.AzureNative.SecurityAndCompliance.Latest
{
    ...
    public partial class PrivateEndpointConnectionsForSCCPowershell : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsForSCCPowershell(string name, PrivateEndpointConnectionsForSCCPowershellArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsForSCCPowershell", name, args ?? new PrivateEndpointConnectionsForSCCPowershellArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsForSCCPowershell(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsForSCCPowershell", name, null, MakeResourceOptions(options, id))
        {
        }
