...
namespace Pulumi.AzureNative.SecurityAndCompliance.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:securityandcompliance:privateLinkServicesForO365ManagementActivityAPI'.")]
    [AzureNativeResourceType("azure-native:securityandcompliance/latest:privateLinkServicesForO365ManagementActivityAPI")]
    public partial class PrivateLinkServicesForO365ManagementActivityAPI : Pulumi.CustomResource
    {
        ...
        public PrivateLinkServicesForO365ManagementActivityAPI(string name, PrivateLinkServicesForO365ManagementActivityAPIArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:privateLinkServicesForO365ManagementActivityAPI", name, args ?? new PrivateLinkServicesForO365ManagementActivityAPIArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkServicesForO365ManagementActivityAPI(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:privateLinkServicesForO365ManagementActivityAPI", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PrivateLinkServicesForO365ManagementActivityAPIArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.SecurityAndCompliance.Latest.Kind> Kind { get; set; } = null!;
