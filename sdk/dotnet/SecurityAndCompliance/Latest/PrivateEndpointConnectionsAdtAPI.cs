...
namespace Pulumi.AzureNative.SecurityAndCompliance.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:securityandcompliance:PrivateEndpointConnectionsAdtAPI'.")]
    [AzureNativeResourceType("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsAdtAPI")]
    public partial class PrivateEndpointConnectionsAdtAPI : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsAdtAPI(string name, PrivateEndpointConnectionsAdtAPIArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsAdtAPI", name, args ?? new PrivateEndpointConnectionsAdtAPIArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsAdtAPI(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsAdtAPI", name, null, MakeResourceOptions(options, id))
        {
        }
