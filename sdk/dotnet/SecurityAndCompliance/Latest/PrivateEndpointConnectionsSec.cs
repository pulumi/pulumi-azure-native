...
namespace Pulumi.AzureNative.SecurityAndCompliance.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:securityandcompliance:PrivateEndpointConnectionsSec'.")]
    [AzureNativeResourceType("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsSec")]
    public partial class PrivateEndpointConnectionsSec : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsSec(string name, PrivateEndpointConnectionsSecArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsSec", name, args ?? new PrivateEndpointConnectionsSecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsSec(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:PrivateEndpointConnectionsSec", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:securityandcompliance/v20210308:PrivateEndpointConnectionsSec"},
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PrivateEndpointConnectionsSec Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
