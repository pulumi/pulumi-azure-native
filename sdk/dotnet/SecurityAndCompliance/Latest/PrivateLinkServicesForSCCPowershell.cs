...
namespace Pulumi.AzureNative.SecurityAndCompliance.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:securityandcompliance:privateLinkServicesForSCCPowershell'.")]
    [AzureNativeResourceType("azure-native:securityandcompliance/latest:privateLinkServicesForSCCPowershell")]
    public partial class PrivateLinkServicesForSCCPowershell : Pulumi.CustomResource
    {
        ...
        public PrivateLinkServicesForSCCPowershell(string name, PrivateLinkServicesForSCCPowershellArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:privateLinkServicesForSCCPowershell", name, args ?? new PrivateLinkServicesForSCCPowershellArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkServicesForSCCPowershell(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance/latest:privateLinkServicesForSCCPowershell", name, null, MakeResourceOptions(options, id))
        {
        }
