...
namespace Pulumi.AzureNative.SecurityAndCompliance.V20210308
{
    public static class GetPrivateEndpointConnectionsAdtAPI
    {
        ...
        public static Task<GetPrivateEndpointConnectionsAdtAPIResult> InvokeAsync(GetPrivateEndpointConnectionsAdtAPIArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateEndpointConnectionsAdtAPIResult>("azure-native:securityandcompliance/v20210308:getPrivateEndpointConnectionsAdtAPI", args ?? new GetPrivateEndpointConnectionsAdtAPIArgs(), options.WithDefaults());
