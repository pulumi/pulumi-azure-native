...
namespace Pulumi.AzureNative.SecurityAndCompliance
{
    ...
    public partial class PrivateEndpointConnectionsForSCCPowershell : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionsForSCCPowershell(string name, PrivateEndpointConnectionsForSCCPowershellArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance:PrivateEndpointConnectionsForSCCPowershell", name, args ?? new PrivateEndpointConnectionsForSCCPowershellArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionsForSCCPowershell(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityandcompliance:PrivateEndpointConnectionsForSCCPowershell", name, null, MakeResourceOptions(options, id))
        {
        }
