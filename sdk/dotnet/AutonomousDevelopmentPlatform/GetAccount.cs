...
namespace Pulumi.AzureNative.AutonomousDevelopmentPlatform
{
    public static class GetAccount
    {
        ...
        public static Output<GetAccountResult> Invoke(GetAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAccountResult>("azure-native:autonomousdevelopmentplatform:getAccount", args ?? new GetAccountInvokeArgs(), options.WithVersion());
    }
