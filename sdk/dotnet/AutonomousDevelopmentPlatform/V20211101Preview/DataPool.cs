...
namespace Pulumi.AzureNative.AutonomousDevelopmentPlatform.V20211101Preview
{
    ...
    /// {
    ///     var dataPool = new AzureNative.AutonomousDevelopmentPlatform.V20211101Preview.DataPool("dataPool", new()
    ///     {
    ///         AccountName = "sampleacct",
    ///         DataPoolName = "sampledp",
    ///         Locations = new[]
    ///         {
    ///             new AzureNative.AutonomousDevelopmentPlatform.V20211101Preview.Inputs.DataPoolLocationArgs
    ///             {
    ///                 Encryption = new AzureNative.AutonomousDevelopmentPlatform.V20211101Preview.Inputs.DataPoolEncryptionArgs
    ///                 {
    ///                     KeyName = "key1",
    ...
    public partial class DataPool : global::Pulumi.CustomResource
    {
        ...
        public DataPool(string name, DataPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:autonomousdevelopmentplatform/v20211101preview:DataPool", name, args ?? new DataPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:autonomousdevelopmentplatform/v20211101preview:DataPool", name, null, MakeResourceOptions(options, id))
        {
        }
