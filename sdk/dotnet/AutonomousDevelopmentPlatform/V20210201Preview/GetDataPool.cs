...
namespace Pulumi.AzureNative.AutonomousDevelopmentPlatform.V20210201Preview
{
    public static class GetDataPool
    {
        ...
        public static Task<GetDataPoolResult> InvokeAsync(GetDataPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataPoolResult>("azure-native:autonomousdevelopmentplatform/v20210201preview:getDataPool", args ?? new GetDataPoolArgs(), options.WithDefaults());

        /// <summary>
        /// ADP Data Pool
        /// </summary>
        public static Output<GetDataPoolResult> Invoke(GetDataPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataPoolResult>("azure-native:autonomousdevelopmentplatform/v20210201preview:getDataPool", args ?? new GetDataPoolInvokeArgs(), options.WithDefaults());
    }
