...
namespace Pulumi.AzureNative.AutonomousDevelopmentPlatform.V20210201Preview
{
    ...
    /// {
    ///     var account = new AzureNative.AutonomousDevelopmentPlatform.V20210201Preview.Account("account", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:autonomousdevelopmentplatform/v20210201preview:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:autonomousdevelopmentplatform/v20210201preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:autonomousdevelopmentplatform/v20210201preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
