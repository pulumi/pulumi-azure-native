...
namespace Pulumi.AzureNative.AutonomousDevelopmentPlatform.V20210201Preview
{
    ...
    /// ADP Data Pool
    /// </summary>
    [Obsolete(@"azure-native:autonomousdevelopmentplatform/v20210201preview:DataPool is being removed in the next major version of this provider. Upgrade to at least azure-native:autonomousdevelopmentplatform/v20211101preview:DataPool to guarantee forwards compatibility.")]
    ...
    public partial class DataPool : global::Pulumi.CustomResource
    {
        ...
        public DataPool(string name, DataPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:autonomousdevelopmentplatform/v20210201preview:DataPool", name, args ?? new DataPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:autonomousdevelopmentplatform/v20210201preview:DataPool", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:autonomousdevelopmentplatform/v20211101preview:DataPool"},
                },
            };
