...
namespace Pulumi.AzureNative.AutonomousDevelopmentPlatform.V20200701Preview
{
    ...
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azure-native:autonomousdevelopmentplatform/v20200701preview:getAccount", args ?? new GetAccountArgs(), options.WithDefaults());

        /// <summary>
        /// An ADP account.
        /// </summary>
        public static Output<GetAccountResult> Invoke(GetAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAccountResult>("azure-native:autonomousdevelopmentplatform/v20200701preview:getAccount", args ?? new GetAccountInvokeArgs(), options.WithDefaults());
    }
