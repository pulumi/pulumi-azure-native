...
namespace Pulumi.AzureRM.RecoveryServices.V20180110
{
    public static class GetReplicationProtectedItem
    {
        public static Task<GetReplicationProtectedItemResult> InvokeAsync(GetReplicationProtectedItemArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationProtectedItemResult>("azurerm:recoveryservices/v20180110:getReplicationProtectedItem", args ?? new GetReplicationProtectedItemArgs(), options.WithVersion());
    }
