...
azure-native:recoveryservices/v20180110:ReplicationvCenter is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20210301:ReplicationvCenter to guarantee forwards compatibility.")]
    public static class GetReplicationvCenter
    {
        ...
        public static Task<GetReplicationvCenterResult> InvokeAsync(GetReplicationvCenterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReplicationvCenterResult>("azure-native:recoveryservices/v20180110:getReplicationvCenter", args ?? new GetReplicationvCenterArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of a registered vCenter server(Add vCenter server.)
        /// </summary>
        public static Output<GetReplicationvCenterResult> Invoke(GetReplicationvCenterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReplicationvCenterResult>("azure-native:recoveryservices/v20180110:getReplicationvCenter", args ?? new GetReplicationvCenterInvokeArgs(), options.WithDefaults());
    }
