...
namespace Pulumi.AzureRM.RecoveryServices.V20180110
{
    ...
    ///     public MyStack()
    ///     {
    ///         var replicationRecoveryPlan = new AzureRM.RecoveryServices.V20180110.ReplicationRecoveryPlan("replicationRecoveryPlan", new AzureRM.RecoveryServices.V20180110.ReplicationRecoveryPlanArgs
    ///         {
    ...
    public partial class ReplicationRecoveryPlan : Pulumi.CustomResource
    {
        ...
        public ReplicationRecoveryPlan(string name, ReplicationRecoveryPlanArgs args, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/v20180110:ReplicationRecoveryPlan", name, args ?? new ReplicationRecoveryPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationRecoveryPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/v20180110:ReplicationRecoveryPlan", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:recoveryservices/v20180710:ReplicationRecoveryPlan"},
                },
            };
