...
namespace Pulumi.AzureRM.RecoveryServices.V20180110
{
    ...
    ///     public MyStack()
    ///     {
    ///         var replicationvCenter = new AzureRM.RecoveryServices.V20180110.ReplicationvCenter("replicationvCenter", new AzureRM.RecoveryServices.V20180110.ReplicationvCenterArgs
    ///         {
    ...
    public partial class ReplicationvCenter : Pulumi.CustomResource
    {
        ...
        public ReplicationvCenter(string name, ReplicationvCenterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/v20180110:ReplicationvCenter", name, args ?? new ReplicationvCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationvCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/v20180110:ReplicationvCenter", name, null, MakeResourceOptions(options, id))
        {
        }
