...
namespace Pulumi.AzureNextGen.RecoveryServices.V20180110
{
    public static class GetReplicationFabric
    {
        public static Task<GetReplicationFabricResult> InvokeAsync(GetReplicationFabricArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationFabricResult>("azure-nextgen:recoveryservices/v20180110:getReplicationFabric", args ?? new GetReplicationFabricArgs(), options.WithVersion());
    }
