...
namespace Pulumi.AzureNative.RecoveryServices.V20180110
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20180110:ReplicationPolicy")]
    public partial class ReplicationPolicy : Pulumi.CustomResource
    {
        ...
        public ReplicationPolicy(string name, ReplicationPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20180110:ReplicationPolicy", name, args ?? new ReplicationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20180110:ReplicationPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
