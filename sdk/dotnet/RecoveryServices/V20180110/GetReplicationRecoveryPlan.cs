...
namespace Pulumi.AzureRM.RecoveryServices.V20180110
{
    public static class GetReplicationRecoveryPlan
    {
        public static Task<GetReplicationRecoveryPlanResult> InvokeAsync(GetReplicationRecoveryPlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationRecoveryPlanResult>("azurerm:recoveryservices/v20180110:getReplicationRecoveryPlan", args ?? new GetReplicationRecoveryPlanArgs(), options.WithVersion());
    }
