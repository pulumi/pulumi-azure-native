...
namespace Pulumi.AzureNative.RecoveryServices.V20180110
{
    public static class GetReplicationMigrationItem
    {
        ...
        public static Output<GetReplicationMigrationItemResult> Invoke(GetReplicationMigrationItemInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetReplicationMigrationItemResult>("azure-native:recoveryservices/v20180110:getReplicationMigrationItem", args ?? new GetReplicationMigrationItemInvokeArgs(), options.WithVersion());
    }
