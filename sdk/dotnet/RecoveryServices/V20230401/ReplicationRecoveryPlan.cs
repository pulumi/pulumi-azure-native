...
namespace Pulumi.AzureNative.RecoveryServices.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20230401:ReplicationRecoveryPlan")]
    public partial class ReplicationRecoveryPlan : global::Pulumi.CustomResource
    {
        ...
        public ReplicationRecoveryPlan(string name, ReplicationRecoveryPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230401:ReplicationRecoveryPlan", name, args ?? new ReplicationRecoveryPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationRecoveryPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230401:ReplicationRecoveryPlan", name, null, MakeResourceOptions(options, id))
        {
        }
