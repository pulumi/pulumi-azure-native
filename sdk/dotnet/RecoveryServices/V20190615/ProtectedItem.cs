...
namespace Pulumi.AzureRM.RecoveryServices.V20190615
{
    ...
    ///     public MyStack()
    ///     {
    ///         var protectedItem = new AzureRM.RecoveryServices.V20190615.ProtectedItem("protectedItem", new AzureRM.RecoveryServices.V20190615.ProtectedItemArgs
    ///         {
    ...
    public partial class ProtectedItem : Pulumi.CustomResource
    {
        ...
        public ProtectedItem(string name, ProtectedItemArgs args, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/v20190615:ProtectedItem", name, args ?? new ProtectedItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectedItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/v20190615:ProtectedItem", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:recoveryservices/v20190513:ProtectedItem"},
                },
            };
