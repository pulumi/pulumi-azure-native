...
namespace Pulumi.AzureRM.RecoveryServices.Preview
{
    public static class GetProtectedItem
    {
        public static Task<GetProtectedItemResult> InvokeAsync(GetProtectedItemArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProtectedItemResult>("azurerm:recoveryservices/preview:getProtectedItem", args ?? new GetProtectedItemArgs(), options.WithVersion());
    }
