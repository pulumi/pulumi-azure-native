...
namespace Pulumi.AzureRM.RecoveryServices.Preview
{
    /// <summary>
    ...
    public partial class ProtectionPolicy : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Union<Outputs.AzureIaaSVMProtectionPolicyResponseResult, Union<Outputs.AzureSqlProtectionPolicyResponseResult, Outputs.MabProtectionPolicyResponseResult>>> Properties { get; private set; } = null!;
        ...
        public ProtectionPolicy(string name, ProtectionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/preview:ProtectionPolicy", name, args ?? new ProtectionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/preview:ProtectionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:recoveryservices/v20160601:ProtectionPolicy"},
                },
            };
