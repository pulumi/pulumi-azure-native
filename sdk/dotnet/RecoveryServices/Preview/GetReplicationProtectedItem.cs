...
namespace Pulumi.AzureRM.RecoveryServices.Preview
{
    public static class GetReplicationProtectedItem
    {
        public static Task<GetReplicationProtectedItemResult> InvokeAsync(GetReplicationProtectedItemArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationProtectedItemResult>("azurerm:recoveryservices/preview:getReplicationProtectedItem", args ?? new GetReplicationProtectedItemArgs(), options.WithVersion());
    }
