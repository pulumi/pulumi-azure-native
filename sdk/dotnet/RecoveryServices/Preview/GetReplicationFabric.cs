...
namespace Pulumi.AzureRM.RecoveryServices.Preview
{
    public static class GetReplicationFabric
    {
        public static Task<GetReplicationFabricResult> InvokeAsync(GetReplicationFabricArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationFabricResult>("azurerm:recoveryservices/preview:getReplicationFabric", args ?? new GetReplicationFabricArgs(), options.WithVersion());
    }
