...
namespace Pulumi.AzureRM.RecoveryServices.Preview
{
    ...
    public partial class ReplicationPolicy : Pulumi.CustomResource
    {
        ...
        public ReplicationPolicy(string name, ReplicationPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/preview:ReplicationPolicy", name, args ?? new ReplicationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/preview:ReplicationPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
