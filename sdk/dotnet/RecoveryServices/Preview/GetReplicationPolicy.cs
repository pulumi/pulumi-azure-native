...
namespace Pulumi.AzureRM.RecoveryServices.Preview
{
    public static class GetReplicationPolicy
    {
        public static Task<GetReplicationPolicyResult> InvokeAsync(GetReplicationPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationPolicyResult>("azurerm:recoveryservices/preview:getReplicationPolicy", args ?? new GetReplicationPolicyArgs(), options.WithVersion());
    }
