...
namespace Pulumi.AzureRM.RecoveryServices.Preview
{
    public static class GetReplicationvCenter
    {
        public static Task<GetReplicationvCenterResult> InvokeAsync(GetReplicationvCenterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationvCenterResult>("azurerm:recoveryservices/preview:getReplicationvCenter", args ?? new GetReplicationvCenterArgs(), options.WithVersion());
    }
