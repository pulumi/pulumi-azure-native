...
namespace Pulumi.AzureRM.RecoveryServices.Preview
{
    public static class GetProtectionPolicy
    {
        public static Task<GetProtectionPolicyResult> InvokeAsync(GetProtectionPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProtectionPolicyResult>("azurerm:recoveryservices/preview:getProtectionPolicy", args ?? new GetProtectionPolicyArgs(), options.WithVersion());
    }
