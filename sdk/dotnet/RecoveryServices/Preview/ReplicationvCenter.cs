...
namespace Pulumi.AzureRM.RecoveryServices.Preview
{
    ...
    public partial class ReplicationvCenter : Pulumi.CustomResource
    {
        ...
        public ReplicationvCenter(string name, ReplicationvCenterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/preview:ReplicationvCenter", name, args ?? new ReplicationvCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationvCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/preview:ReplicationvCenter", name, null, MakeResourceOptions(options, id))
        {
        }
