...
namespace Pulumi.AzureNative.RecoveryServices.V20220901Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:recoveryservices/v20220901preview:ProtectionIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionIntent to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:recoveryservices/v20220901preview:ProtectionIntent")]
    public partial class ProtectionIntent : global::Pulumi.CustomResource
    {
        ...
        public ProtectionIntent(string name, ProtectionIntentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220901preview:ProtectionIntent", name, args ?? new ProtectionIntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionIntent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220901preview:ProtectionIntent", name, null, MakeResourceOptions(options, id))
        {
        }
