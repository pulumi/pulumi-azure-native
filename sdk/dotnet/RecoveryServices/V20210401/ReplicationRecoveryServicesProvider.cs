...
namespace Pulumi.AzureNative.RecoveryServices.V20210401
{
    ...
    /// Provider details.
    /// </summary>
    [Obsolete(@"azure-native:recoveryservices/v20210401:ReplicationRecoveryServicesProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationRecoveryServicesProvider to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:recoveryservices/v20210401:ReplicationRecoveryServicesProvider")]
    public partial class ReplicationRecoveryServicesProvider : global::Pulumi.CustomResource
    {
        ...
        public ReplicationRecoveryServicesProvider(string name, ReplicationRecoveryServicesProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210401:ReplicationRecoveryServicesProvider", name, args ?? new ReplicationRecoveryServicesProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationRecoveryServicesProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210401:ReplicationRecoveryServicesProvider", name, null, MakeResourceOptions(options, id))
        {
        }
