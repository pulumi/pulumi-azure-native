...
namespace Pulumi.AzureNative.RecoveryServices.V20210401.Inputs
{
    ...
    public sealed class VMwareCbtEnableMigrationInputArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210401.LicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210401.SqlServerLicenseType>? SqlServerLicenseType { get; set; }
