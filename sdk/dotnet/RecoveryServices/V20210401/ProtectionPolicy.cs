...
namespace Pulumi.AzureNative.RecoveryServices.V20210401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:recoveryservices/v20210401:ProtectionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ProtectionPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:recoveryservices/v20210401:ProtectionPolicy")]
    public partial class ProtectionPolicy : global::Pulumi.CustomResource
    {
        ...
        public ProtectionPolicy(string name, ProtectionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210401:ProtectionPolicy", name, args ?? new ProtectionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210401:ProtectionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
