        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210210:ReplicationRecoveryPlan"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210301:ReplicationRecoveryPlan"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210301:ReplicationRecoveryPlan"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210401:ReplicationRecoveryPlan"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210401:ReplicationRecoveryPlan"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210601:ReplicationRecoveryPlan"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210601:ReplicationRecoveryPlan"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210701:ReplicationRecoveryPlan"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210701:ReplicationRecoveryPlan"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210801:ReplicationRecoveryPlan"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210801:ReplicationRecoveryPlan"},
                },
            };
