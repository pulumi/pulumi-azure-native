...
namespace Pulumi.AzureNative.RecoveryServices.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20230801:ReplicationStorageClassificationMapping")]
    public partial class ReplicationStorageClassificationMapping : global::Pulumi.CustomResource
    {
        ...
        public ReplicationStorageClassificationMapping(string name, ReplicationStorageClassificationMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230801:ReplicationStorageClassificationMapping", name, args ?? new ReplicationStorageClassificationMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationStorageClassificationMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230801:ReplicationStorageClassificationMapping", name, null, MakeResourceOptions(options, id))
        {
        }
