...
namespace Pulumi.AzureNative.RecoveryServices.V20230801.Inputs
{
    ...
    public sealed class AzureIaaSVMProtectionPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20230801.IAASVMPolicyType>? PolicyType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20230801.IaasVMSnapshotConsistencyType>? SnapshotConsistencyType { get; set; }
