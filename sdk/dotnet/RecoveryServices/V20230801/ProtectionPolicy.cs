...
namespace Pulumi.AzureNative.RecoveryServices.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20230801:ProtectionPolicy")]
    public partial class ProtectionPolicy : global::Pulumi.CustomResource
    {
        ...
        public ProtectionPolicy(string name, ProtectionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230801:ProtectionPolicy", name, args ?? new ProtectionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230801:ProtectionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
