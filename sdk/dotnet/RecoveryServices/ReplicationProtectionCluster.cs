...
namespace Pulumi.AzureNative.RecoveryServices
{
    ...
    public partial class ReplicationProtectionCluster : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ReplicationProtectionClusterPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public ReplicationProtectionCluster(string name, ReplicationProtectionClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices:ReplicationProtectionCluster", name, args ?? new ReplicationProtectionClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationProtectionCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices:ReplicationProtectionCluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:recoveryservices/v20250101:ReplicationProtectionCluster" },
                    new global::Pulumi.Alias { Type = "azure-native:recoveryservices/v20250201:ReplicationProtectionCluster" },
                    new global::Pulumi.Alias { Type = "azure-native:recoveryservices/v20250801:ReplicationProtectionCluster" },
                    new global::Pulumi.Alias { Type = "azure-native:recoveryservices/v20260101:ReplicationProtectionCluster" },
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ReplicationProtectionCluster Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ReplicationProtectionCluster(name, id, options);
        }
    }

    public sealed class ReplicationProtectionClusterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Fabric name.
        /// </summary>
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.ReplicationProtectionClusterPropertiesArgs>? Properties { get; set; }
        ...
        public ReplicationProtectionClusterArgs()
        {
        }
        public static new ReplicationProtectionClusterArgs Empty => new ReplicationProtectionClusterArgs();
    }
}
