...
namespace Pulumi.AzureNative.RecoveryServices.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20241101preview:ProtectionIntent")]
    public partial class ProtectionIntent : global::Pulumi.CustomResource
    {
        ...
        public ProtectionIntent(string name, ProtectionIntentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20241101preview:ProtectionIntent", name, args ?? new ProtectionIntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionIntent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20241101preview:ProtectionIntent", name, null, MakeResourceOptions(options, id))
        {
        }
