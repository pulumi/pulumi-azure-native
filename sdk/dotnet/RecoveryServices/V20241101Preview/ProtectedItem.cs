...
namespace Pulumi.AzureNative.RecoveryServices.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20241101preview:ProtectedItem")]
    public partial class ProtectedItem : global::Pulumi.CustomResource
    {
        ...
        public ProtectedItem(string name, ProtectedItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20241101preview:ProtectedItem", name, args ?? new ProtectedItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectedItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20241101preview:ProtectedItem", name, null, MakeResourceOptions(options, id))
        {
        }
