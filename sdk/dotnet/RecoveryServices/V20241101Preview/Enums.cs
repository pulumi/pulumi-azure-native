...
namespace Pulumi.AzureNative.RecoveryServices.V20241101Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct VMWorkloadPolicyType : IEquatable<VMWorkloadPolicyType>
    {
        private readonly string _value;

        private VMWorkloadPolicyType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static VMWorkloadPolicyType Invalid { get; } = new VMWorkloadPolicyType("Invalid");
        public static VMWorkloadPolicyType SnapshotV1 { get; } = new VMWorkloadPolicyType("SnapshotV1");
        public static VMWorkloadPolicyType SnapshotV2 { get; } = new VMWorkloadPolicyType("SnapshotV2");
        public static VMWorkloadPolicyType Streaming { get; } = new VMWorkloadPolicyType("Streaming");

        public static bool operator ==(VMWorkloadPolicyType left, VMWorkloadPolicyType right) => left.Equals(right);
        public static bool operator !=(VMWorkloadPolicyType left, VMWorkloadPolicyType right) => !left.Equals(right);

        public static explicit operator string(VMWorkloadPolicyType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is VMWorkloadPolicyType other && Equals(other);
        public bool Equals(VMWorkloadPolicyType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
