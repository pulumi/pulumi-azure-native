...
namespace Pulumi.AzureNextGen.RecoveryServices.V20210201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:recoveryservices/v20210201:ProtectionPolicy")]
    public partial class ProtectionPolicy : Pulumi.CustomResource
    {
        ...
        public ProtectionPolicy(string name, ProtectionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices/v20210201:ProtectionPolicy", name, args ?? new ProtectionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices/v20210201:ProtectionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
