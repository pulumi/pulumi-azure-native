...
namespace Pulumi.AzureNextGen.RecoveryServices.V20210201
{
    public static class GetProtectedItem
    {
        ...
        public static Task<GetProtectedItemResult> InvokeAsync(GetProtectedItemArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProtectedItemResult>("azure-nextgen:recoveryservices/v20210201:getProtectedItem", args ?? new GetProtectedItemArgs(), options.WithVersion());
    }
