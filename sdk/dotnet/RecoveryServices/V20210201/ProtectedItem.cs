...
namespace Pulumi.AzureNative.RecoveryServices.V20210201
{
    ...
    /// {
    ///     var protectedItem = new AzureNative.RecoveryServices.V20210201.ProtectedItem("protectedItem", new()
    ///     {
    ///         ContainerName = "IaasVMContainer;iaasvmcontainerv2;netsdktestrg;netvmtestv2vm1",
    ///         FabricName = "Azure",
    ///         Properties = new AzureNative.RecoveryServices.V20210201.Inputs.AzureIaaSComputeVMProtectedItemArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210201:ProtectedItem")]
    public partial class ProtectedItem : global::Pulumi.CustomResource
    {
        ...
        public ProtectedItem(string name, ProtectedItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210201:ProtectedItem", name, args ?? new ProtectedItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectedItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210201:ProtectedItem", name, null, MakeResourceOptions(options, id))
        {
        }
