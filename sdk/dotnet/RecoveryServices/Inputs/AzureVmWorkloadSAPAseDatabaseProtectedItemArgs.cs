...
namespace Pulumi.AzureNative.RecoveryServices.Inputs
{
    ...
    public sealed class AzureVmWorkloadSAPAseDatabaseProtectedItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.LastBackupStatus>? LastBackupStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.ProtectedItemHealthStatus>? ProtectedItemHealthStatus { get; set; }
