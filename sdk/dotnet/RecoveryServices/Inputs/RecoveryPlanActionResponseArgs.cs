...
namespace Pulumi.AzureRM.RecoveryServices.Inputs
{
    ...
    /// </summary>
    public sealed class RecoveryPlanActionResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The action name.
        /// </summary>
        ...
        public Input<Inputs.RecoveryPlanActionDetailsResponseArgs> CustomDetails { get; set; } = null!;
        ...
        public RecoveryPlanActionResponseArgs()
        {
        }
    }
}
