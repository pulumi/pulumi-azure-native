...
namespace Pulumi.AzureRM.RecoveryServices.Inputs
{
    ...
    /// </summary>
    public sealed class RecoveryPlanActionResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The action name.
        /// </summary>
        ...
        public Input<Inputs.RecoveryPlanActionDetailsResponseGetArgs> CustomDetails { get; set; } = null!;
        ...
        public RecoveryPlanActionResponseGetArgs()
        {
        }
    }
}
