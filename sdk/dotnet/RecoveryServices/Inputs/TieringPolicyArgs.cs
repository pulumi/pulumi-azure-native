...
namespace Pulumi.AzureNative.RecoveryServices.Inputs
{
    ...
    public sealed class TieringPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("durationType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.RetentionDurationType>? DurationType { get; set; }
        ...
        /// </summary>
        [Input("tieringMode")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.TieringMode>? TieringMode { get; set; }
