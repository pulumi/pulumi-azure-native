...
namespace Pulumi.AzureNative.RecoveryServices.V20220801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:recoveryservices/v20220801:ReplicationStorageClassificationMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationStorageClassificationMapping to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:recoveryservices/v20220801:ReplicationStorageClassificationMapping")]
    public partial class ReplicationStorageClassificationMapping : global::Pulumi.CustomResource
    {
        ...
        public ReplicationStorageClassificationMapping(string name, ReplicationStorageClassificationMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220801:ReplicationStorageClassificationMapping", name, args ?? new ReplicationStorageClassificationMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationStorageClassificationMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220801:ReplicationStorageClassificationMapping", name, null, MakeResourceOptions(options, id))
        {
        }
