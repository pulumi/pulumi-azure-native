...
namespace Pulumi.AzureNative.RecoveryServices.V20220801
{
    ...
    /// Provider details.
    /// </summary>
    [Obsolete(@"azure-native:recoveryservices/v20220801:ReplicationRecoveryServicesProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationRecoveryServicesProvider to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:recoveryservices/v20220801:ReplicationRecoveryServicesProvider")]
    public partial class ReplicationRecoveryServicesProvider : global::Pulumi.CustomResource
    {
        ...
        public ReplicationRecoveryServicesProvider(string name, ReplicationRecoveryServicesProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220801:ReplicationRecoveryServicesProvider", name, args ?? new ReplicationRecoveryServicesProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationRecoveryServicesProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220801:ReplicationRecoveryServicesProvider", name, null, MakeResourceOptions(options, id))
        {
        }
