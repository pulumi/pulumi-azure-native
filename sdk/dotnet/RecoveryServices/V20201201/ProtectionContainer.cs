...
namespace Pulumi.AzureNextGen.RecoveryServices.V20201201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:recoveryservices/v20201201:ProtectionContainer")]
    public partial class ProtectionContainer : Pulumi.CustomResource
    {
        ...
        public ProtectionContainer(string name, ProtectionContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices/v20201201:ProtectionContainer", name, args ?? new ProtectionContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices/v20201201:ProtectionContainer", name, null, MakeResourceOptions(options, id))
        {
        }
