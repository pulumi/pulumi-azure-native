...
namespace Pulumi.AzureNative.RecoveryServices.V20210801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210801:ReplicationNetworkMapping")]
    public partial class ReplicationNetworkMapping : global::Pulumi.CustomResource
    {
        ...
        public ReplicationNetworkMapping(string name, ReplicationNetworkMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210801:ReplicationNetworkMapping", name, args ?? new ReplicationNetworkMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationNetworkMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210801:ReplicationNetworkMapping", name, null, MakeResourceOptions(options, id))
        {
        }
