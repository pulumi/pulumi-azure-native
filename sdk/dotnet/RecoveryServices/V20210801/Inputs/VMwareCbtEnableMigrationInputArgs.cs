...
namespace Pulumi.AzureNative.RecoveryServices.V20210801.Inputs
{
    ...
    public sealed class VMwareCbtEnableMigrationInputArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210801.LicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210801.SqlServerLicenseType>? SqlServerLicenseType { get; set; }
