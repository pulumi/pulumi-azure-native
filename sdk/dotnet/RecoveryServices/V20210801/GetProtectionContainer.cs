...
namespace Pulumi.AzureNative.RecoveryServices.V20210801
{
    public static class GetProtectionContainer
    {
        ...
        public static Task<GetProtectionContainerResult> InvokeAsync(GetProtectionContainerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProtectionContainerResult>("azure-native:recoveryservices/v20210801:getProtectionContainer", args ?? new GetProtectionContainerArgs(), options.WithVersion());
        ...
        public static Output<GetProtectionContainerResult> Invoke(GetProtectionContainerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProtectionContainerResult>("azure-native:recoveryservices/v20210801:getProtectionContainer", args ?? new GetProtectionContainerInvokeArgs(), options.WithVersion());
    }
