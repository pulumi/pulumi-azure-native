...
namespace Pulumi.AzureNative.RecoveryServices.V20210801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210801:ReplicationPolicy")]
    public partial class ReplicationPolicy : Pulumi.CustomResource
    {
        ...
        public ReplicationPolicy(string name, ReplicationPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210801:ReplicationPolicy", name, args ?? new ReplicationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210801:ReplicationPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
