...
namespace Pulumi.AzureNative.RecoveryServices.V20230601
{
    public static class GetProtectionContainer
    {
        ...
        public static Task<GetProtectionContainerResult> InvokeAsync(GetProtectionContainerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProtectionContainerResult>("azure-native:recoveryservices/v20230601:getProtectionContainer", args ?? new GetProtectionContainerArgs(), options.WithDefaults());
        ...
        public static Output<GetProtectionContainerResult> Invoke(GetProtectionContainerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProtectionContainerResult>("azure-native:recoveryservices/v20230601:getProtectionContainer", args ?? new GetProtectionContainerInvokeArgs(), options.WithDefaults());
