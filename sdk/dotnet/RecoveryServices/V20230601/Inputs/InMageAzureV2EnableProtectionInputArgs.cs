...
namespace Pulumi.AzureNative.RecoveryServices.V20230601.Inputs
{
    ...
    public sealed class InMageAzureV2EnableProtectionInputArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20230601.LicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20230601.SqlServerLicenseType>? SqlServerLicenseType { get; set; }
