...
namespace Pulumi.AzureNative.RecoveryServices.V20160810
{
    ...
    [AzureNativeResourceType("azure-native:recoveryservices/v20160810:ReplicationFabric")]
    public partial class ReplicationFabric : global::Pulumi.CustomResource
    {
        ...
        public ReplicationFabric(string name, ReplicationFabricArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20160810:ReplicationFabric", name, args ?? new ReplicationFabricArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationFabric(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20160810:ReplicationFabric", name, null, MakeResourceOptions(options, id))
        {
        }
