...
namespace Pulumi.AzureRM.RecoveryServices.V20160810
{
    ...
    ///     public MyStack()
    ///     {
    ///         var replicationStorageClassificationMapping = new AzureRM.RecoveryServices.V20160810.ReplicationStorageClassificationMapping("replicationStorageClassificationMapping", new AzureRM.RecoveryServices.V20160810.ReplicationStorageClassificationMappingArgs
    ///         {
    ...
    public partial class ReplicationStorageClassificationMapping : Pulumi.CustomResource
    {
        ...
        public ReplicationStorageClassificationMapping(string name, ReplicationStorageClassificationMappingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/v20160810:ReplicationStorageClassificationMapping", name, args ?? new ReplicationStorageClassificationMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationStorageClassificationMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/v20160810:ReplicationStorageClassificationMapping", name, null, MakeResourceOptions(options, id))
        {
        }
