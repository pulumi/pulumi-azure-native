...
namespace Pulumi.AzureRM.RecoveryServices.V20160810
{
    ...
    ///     public MyStack()
    ///     {
    ///         var replicationRecoveryPlan = new AzureRM.RecoveryServices.V20160810.ReplicationRecoveryPlan("replicationRecoveryPlan", new AzureRM.RecoveryServices.V20160810.ReplicationRecoveryPlanArgs
    ///         {
    ...
    public partial class ReplicationRecoveryPlan : Pulumi.CustomResource
    {
        ...
        public ReplicationRecoveryPlan(string name, ReplicationRecoveryPlanArgs args, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/v20160810:ReplicationRecoveryPlan", name, args ?? new ReplicationRecoveryPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationRecoveryPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/v20160810:ReplicationRecoveryPlan", name, null, MakeResourceOptions(options, id))
        {
        }
