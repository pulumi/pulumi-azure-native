...
namespace Pulumi.AzureNative.RecoveryServices.V20210210
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210210:ProtectionPolicy")]
    public partial class ProtectionPolicy : Pulumi.CustomResource
    {
        ...
        public ProtectionPolicy(string name, ProtectionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210210:ProtectionPolicy", name, args ?? new ProtectionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210210:ProtectionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
