...
namespace Pulumi.AzureNative.RecoveryServices.V20210210
{
    ...
    /// Fabric definition.
    /// </summary>
    [Obsolete(@"azure-native:recoveryservices/v20210210:ReplicationFabric is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationFabric to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:recoveryservices/v20210210:ReplicationFabric")]
    public partial class ReplicationFabric : global::Pulumi.CustomResource
    {
        ...
        public ReplicationFabric(string name, ReplicationFabricArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210210:ReplicationFabric", name, args ?? new ReplicationFabricArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationFabric(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210210:ReplicationFabric", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:recoveryservices/v20211001:ReplicationFabric"},
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:recoveryservices/v20220401:ReplicationFabric"},
                    new global::Pulumi.Alias { Type = "azure-native:recoveryservices/v20220501:ReplicationFabric"},
                    new global::Pulumi.Alias { Type = "azure-native:recoveryservices/v20220801:ReplicationFabric"},
                    new global::Pulumi.Alias { Type = "azure-native:recoveryservices/v20220910:ReplicationFabric"},
