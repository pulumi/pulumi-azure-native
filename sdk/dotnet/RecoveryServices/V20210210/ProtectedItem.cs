...
namespace Pulumi.AzureNative.RecoveryServices.V20210210
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210210:ProtectedItem")]
    public partial class ProtectedItem : Pulumi.CustomResource
    {
        ...
        public ProtectedItem(string name, ProtectedItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210210:ProtectedItem", name, args ?? new ProtectedItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectedItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210210:ProtectedItem", name, null, MakeResourceOptions(options, id))
        {
        }
