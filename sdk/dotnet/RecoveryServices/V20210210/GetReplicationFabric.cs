...
namespace Pulumi.AzureNative.RecoveryServices.V20210210
{
    public static class GetReplicationFabric
    {
        ...
        public static Task<GetReplicationFabricResult> InvokeAsync(GetReplicationFabricArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationFabricResult>("azure-native:recoveryservices/v20210210:getReplicationFabric", args ?? new GetReplicationFabricArgs(), options.WithVersion());

        /// <summary>
        /// Fabric definition.
        /// </summary>
        public static Output<GetReplicationFabricResult> Invoke(GetReplicationFabricInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetReplicationFabricResult>("azure-native:recoveryservices/v20210210:getReplicationFabric", args ?? new GetReplicationFabricInvokeArgs(), options.WithVersion());
    }
