...
namespace Pulumi.AzureNative.RecoveryServices.V20210210
{
    ...
    /// Provider details.
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210210:ReplicationRecoveryServicesProvider")]
    public partial class ReplicationRecoveryServicesProvider : Pulumi.CustomResource
    {
        ...
        public ReplicationRecoveryServicesProvider(string name, ReplicationRecoveryServicesProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210210:ReplicationRecoveryServicesProvider", name, args ?? new ReplicationRecoveryServicesProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationRecoveryServicesProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210210:ReplicationRecoveryServicesProvider", name, null, MakeResourceOptions(options, id))
        {
        }
