...
{
    [Obsolete(@"azure-native:recoveryservices/v20210210:ProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectedItem to guarantee forwards compatibility.")]
    public static class GetProtectedItem
    {
        ...
        public static Task<GetProtectedItemResult> InvokeAsync(GetProtectedItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProtectedItemResult>("azure-native:recoveryservices/v20210210:getProtectedItem", args ?? new GetProtectedItemArgs(), options.WithDefaults());
        ...
        public static Output<GetProtectedItemResult> Invoke(GetProtectedItemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProtectedItemResult>("azure-native:recoveryservices/v20210210:getProtectedItem", args ?? new GetProtectedItemInvokeArgs(), options.WithDefaults());
    }
