...
namespace Pulumi.AzureNative.RecoveryServices.V20210210
{
    public static class GetProtectionPolicy
    {
        ...
        public static Task<GetProtectionPolicyResult> InvokeAsync(GetProtectionPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProtectionPolicyResult>("azure-native:recoveryservices/v20210210:getProtectionPolicy", args ?? new GetProtectionPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Base class for backup policy. Workload-specific backup policies are derived from this class.
        /// </summary>
        public static Output<GetProtectionPolicyResult> Invoke(GetProtectionPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProtectionPolicyResult>("azure-native:recoveryservices/v20210210:getProtectionPolicy", args ?? new GetProtectionPolicyInvokeArgs(), options.WithDefaults());
    }
