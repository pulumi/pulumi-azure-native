...
namespace Pulumi.AzureNative.RecoveryServices.V20220201
{
    ...
    /// vCenter definition.
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20220201:ReplicationvCenter")]
    public partial class ReplicationvCenter : Pulumi.CustomResource
    {
        ...
        public ReplicationvCenter(string name, ReplicationvCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220201:ReplicationvCenter", name, args ?? new ReplicationvCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationvCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220201:ReplicationvCenter", name, null, MakeResourceOptions(options, id))
        {
        }
