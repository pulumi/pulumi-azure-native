...
namespace Pulumi.AzureNative.RecoveryServices.V20220201
{
    ...
    /// Migration item.
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20220201:ReplicationMigrationItem")]
    public partial class ReplicationMigrationItem : global::Pulumi.CustomResource
    {
        ...
        public ReplicationMigrationItem(string name, ReplicationMigrationItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220201:ReplicationMigrationItem", name, args ?? new ReplicationMigrationItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationMigrationItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220201:ReplicationMigrationItem", name, null, MakeResourceOptions(options, id))
        {
        }
