...
namespace Pulumi.AzureNative.RecoveryServices.V20220201.Inputs
{
    ...
    public sealed class HyperVReplicaAzureEnableProtectionInputArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20220201.LicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20220201.SqlServerLicenseType>? SqlServerLicenseType { get; set; }
