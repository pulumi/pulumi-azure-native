...
namespace Pulumi.AzureNative.RecoveryServices.V20230201
{
    ...
    /// {
    ///     var replicationProtectionContainerMapping = new AzureNative.RecoveryServices.V20230201.ReplicationProtectionContainerMapping("replicationProtectionContainerMapping", new()
    ///     {
    ///         FabricName = "cloud1",
    ///         MappingName = "cloud1protectionprofile1",
    ///         Properties = new AzureNative.RecoveryServices.V20230201.Inputs.CreateProtectionContainerMappingInputPropertiesArgs
    ///         {
