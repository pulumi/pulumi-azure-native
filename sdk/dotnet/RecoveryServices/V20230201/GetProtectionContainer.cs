...
{
    [Obsolete(@"azure-native:recoveryservices/v20230201:ProtectionContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionContainer to guarantee forwards compatibility.")]
    public static class GetProtectionContainer
    {
        ...
        public static Task<GetProtectionContainerResult> InvokeAsync(GetProtectionContainerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProtectionContainerResult>("azure-native:recoveryservices/v20230201:getProtectionContainer", args ?? new GetProtectionContainerArgs(), options.WithDefaults());
        ...
        public static Output<GetProtectionContainerResult> Invoke(GetProtectionContainerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProtectionContainerResult>("azure-native:recoveryservices/v20230201:getProtectionContainer", args ?? new GetProtectionContainerInvokeArgs(), options.WithDefaults());
    }
