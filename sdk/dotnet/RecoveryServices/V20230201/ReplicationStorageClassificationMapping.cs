...
namespace Pulumi.AzureNative.RecoveryServices.V20230201
{
    ...
    /// {
    ///     var replicationStorageClassificationMapping = new AzureNative.RecoveryServices.V20230201.ReplicationStorageClassificationMapping("replicationStorageClassificationMapping", new()
    ///     {
    ///         FabricName = "2a48e3770ac08aa2be8bfbd94fcfb1cbf2dcc487b78fb9d3bd778304441b06a0",
    ///         Properties = new AzureNative.RecoveryServices.V20230201.Inputs.StorageMappingInputPropertiesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20230201:ReplicationStorageClassificationMapping")]
    public partial class ReplicationStorageClassificationMapping : global::Pulumi.CustomResource
    {
        ...
        public ReplicationStorageClassificationMapping(string name, ReplicationStorageClassificationMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230201:ReplicationStorageClassificationMapping", name, args ?? new ReplicationStorageClassificationMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationStorageClassificationMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230201:ReplicationStorageClassificationMapping", name, null, MakeResourceOptions(options, id))
        {
        }
