...
namespace Pulumi.AzureNative.RecoveryServices.V20230201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:recoveryservices/v20230201:ProtectionIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionIntent to guarantee forwards compatibility.")]
    ...
    public partial class ProtectionIntent : global::Pulumi.CustomResource
    {
        ...
        public ProtectionIntent(string name, ProtectionIntentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230201:ProtectionIntent", name, args ?? new ProtectionIntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionIntent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230201:ProtectionIntent", name, null, MakeResourceOptions(options, id))
        {
        }
