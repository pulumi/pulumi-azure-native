...
namespace Pulumi.AzureNative.RecoveryServices.V20230201
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.RecoveryServices.V20230201.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         PrivateEndpointConnectionName = "gaallatestpe2.5704c932-249a-490b-a142-1396838cd3b",
    ///         Properties = new AzureNative.RecoveryServices.V20230201.Inputs.PrivateEndpointConnectionArgs
    ///         {
    ///             PrivateEndpoint = new AzureNative.RecoveryServices.V20230201.Inputs.PrivateEndpointArgs
    ///             {
    ...
    ///             },
    ///             PrivateLinkServiceConnectionState = new AzureNative.RecoveryServices.V20230201.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:recoveryservices/v20230201:PrivateEndpointConnection gaallatestpe1.3592346090307038890.backup.5704c932-249a-490b-a142-1396838cd3b /subscriptions/04cf684a-d41f-4550-9f70-7708a3a2283b/resourceGroups/gaallaRG/providers/Microsoft.RecoveryServicesBVTD2/vaults/gaallavaultbvtd2msi/privateEndpointConnections/gaallatestpe3.3592346090307038890.backup.5704c932-249a-490b-a142-1396838cd3b 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20230201:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230201:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230201:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
