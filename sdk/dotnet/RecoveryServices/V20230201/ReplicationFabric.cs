...
namespace Pulumi.AzureNative.RecoveryServices.V20230201
{
    ...
    /// {
    ///     var replicationFabric = new AzureNative.RecoveryServices.V20230201.ReplicationFabric("replicationFabric", new()
    ///     {
    ///         FabricName = "cloud1",
    ///         Properties = new AzureNative.RecoveryServices.V20230201.Inputs.FabricCreationInputPropertiesArgs
    ///         {
    ///             CustomDetails = 
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20230201:ReplicationFabric")]
    public partial class ReplicationFabric : global::Pulumi.CustomResource
    {
        ...
        public ReplicationFabric(string name, ReplicationFabricArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230201:ReplicationFabric", name, args ?? new ReplicationFabricArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationFabric(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230201:ReplicationFabric", name, null, MakeResourceOptions(options, id))
        {
        }
