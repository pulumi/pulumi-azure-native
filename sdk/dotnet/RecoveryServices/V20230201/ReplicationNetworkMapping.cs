...
namespace Pulumi.AzureNative.RecoveryServices.V20230201
{
    ...
    /// {
    ///     var replicationNetworkMapping = new AzureNative.RecoveryServices.V20230201.ReplicationNetworkMapping("replicationNetworkMapping", new()
    ///     {
    ...
    ///         Properties = new AzureNative.RecoveryServices.V20230201.Inputs.CreateNetworkMappingInputPropertiesArgs
    ///         {
    ///             FabricSpecificDetails = new AzureNative.RecoveryServices.V20230201.Inputs.VmmToAzureCreateNetworkMappingInputArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20230201:ReplicationNetworkMapping")]
    public partial class ReplicationNetworkMapping : global::Pulumi.CustomResource
    {
        ...
        public ReplicationNetworkMapping(string name, ReplicationNetworkMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230201:ReplicationNetworkMapping", name, args ?? new ReplicationNetworkMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationNetworkMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230201:ReplicationNetworkMapping", name, null, MakeResourceOptions(options, id))
        {
        }
