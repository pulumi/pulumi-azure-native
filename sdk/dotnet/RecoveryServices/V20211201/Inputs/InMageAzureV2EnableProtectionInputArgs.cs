...
namespace Pulumi.AzureNative.RecoveryServices.V20211201.Inputs
{
    ...
    public sealed class InMageAzureV2EnableProtectionInputArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("diskType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20211201.DiskAccountType>? DiskType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20211201.SqlServerLicenseType>? SqlServerLicenseType { get; set; }
