...
namespace Pulumi.AzureNative.RecoveryServices.V20211201
{
    public static class GetReplicationMigrationItem
    {
        ...
        public static Task<GetReplicationMigrationItemResult> InvokeAsync(GetReplicationMigrationItemArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationMigrationItemResult>("azure-native:recoveryservices/v20211201:getReplicationMigrationItem", args ?? new GetReplicationMigrationItemArgs(), options.WithVersion());
        ...
        public static Output<GetReplicationMigrationItemResult> Invoke(GetReplicationMigrationItemInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetReplicationMigrationItemResult>("azure-native:recoveryservices/v20211201:getReplicationMigrationItem", args ?? new GetReplicationMigrationItemInvokeArgs(), options.WithVersion());
    }
