...
namespace Pulumi.AzureNative.RecoveryServices.V20221001
{
    ...
    public partial class ReplicationRecoveryServicesProvider : global::Pulumi.CustomResource
    {
        ...
        public ReplicationRecoveryServicesProvider(string name, ReplicationRecoveryServicesProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20221001:ReplicationRecoveryServicesProvider", name, args ?? new ReplicationRecoveryServicesProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationRecoveryServicesProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20221001:ReplicationRecoveryServicesProvider", name, null, MakeResourceOptions(options, id))
        {
        }
