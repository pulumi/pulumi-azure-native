...
namespace Pulumi.AzureNative.RecoveryServices.V20210201Preview
{
    ...
    /// {
    ///     var resourceGuardProxy = new AzureNative.RecoveryServices.V20210201Preview.ResourceGuardProxy("resourceGuardProxy", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210201preview:ResourceGuardProxy")]
    public partial class ResourceGuardProxy : global::Pulumi.CustomResource
    {
        ...
        public ResourceGuardProxy(string name, ResourceGuardProxyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210201preview:ResourceGuardProxy", name, args ?? new ResourceGuardProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGuardProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210201preview:ResourceGuardProxy", name, null, MakeResourceOptions(options, id))
        {
        }
