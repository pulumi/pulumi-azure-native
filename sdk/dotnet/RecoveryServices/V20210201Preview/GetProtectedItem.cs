...
namespace Pulumi.AzureNative.RecoveryServices.V20210201Preview
{
    public static class GetProtectedItem
    {
        ...
        public static Task<GetProtectedItemResult> InvokeAsync(GetProtectedItemArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProtectedItemResult>("azure-native:recoveryservices/v20210201preview:getProtectedItem", args ?? new GetProtectedItemArgs(), options.WithVersion());

        /// <summary>
        /// Base class for backup items.
        /// </summary>
        public static Output<GetProtectedItemResult> Invoke(GetProtectedItemInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProtectedItemResult>("azure-native:recoveryservices/v20210201preview:getProtectedItem", args ?? new GetProtectedItemInvokeArgs(), options.WithVersion());
    }
