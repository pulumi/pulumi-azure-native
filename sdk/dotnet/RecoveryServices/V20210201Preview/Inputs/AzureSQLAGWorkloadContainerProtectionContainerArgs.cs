...
namespace Pulumi.AzureNative.RecoveryServices.V20210201Preview.Inputs
{
    ...
    public sealed class AzureSQLAGWorkloadContainerProtectionContainerArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("operationType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210201Preview.OperationType>? OperationType { get; set; }
        ...
        /// </summary>
        [Input("workloadType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210201Preview.WorkloadType>? WorkloadType { get; set; }
