...
namespace Pulumi.AzureNative.RecoveryServices.V20210201Preview
{
    public static class GetProtectionPolicy
    {
        ...
        public static Task<GetProtectionPolicyResult> InvokeAsync(GetProtectionPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProtectionPolicyResult>("azure-native:recoveryservices/v20210201preview:getProtectionPolicy", args ?? new GetProtectionPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Base class for backup policy. Workload-specific backup policies are derived from this class.
        /// </summary>
        public static Output<GetProtectionPolicyResult> Invoke(GetProtectionPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProtectionPolicyResult>("azure-native:recoveryservices/v20210201preview:getProtectionPolicy", args ?? new GetProtectionPolicyInvokeArgs(), options.WithVersion());
    }
