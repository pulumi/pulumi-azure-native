...
namespace Pulumi.AzureNative.RecoveryServices.V20240401
{
    public static class GetProtectedItem
    {
        ...
        public static Task<GetProtectedItemResult> InvokeAsync(GetProtectedItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProtectedItemResult>("azure-native:recoveryservices/v20240401:getProtectedItem", args ?? new GetProtectedItemArgs(), options.WithDefaults());
        ...
        public static Output<GetProtectedItemResult> Invoke(GetProtectedItemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProtectedItemResult>("azure-native:recoveryservices/v20240401:getProtectedItem", args ?? new GetProtectedItemInvokeArgs(), options.WithDefaults());
