...
namespace Pulumi.AzureNative.RecoveryServices.V20240401.Inputs
{
    ...
    public sealed class ClassicAlertSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20240401.AlertsState>? AlertsForCriticalOperations { get; set; }

        [Input("emailNotificationsForSiteRecovery")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20240401.AlertsState>? EmailNotificationsForSiteRecovery { get; set; }
