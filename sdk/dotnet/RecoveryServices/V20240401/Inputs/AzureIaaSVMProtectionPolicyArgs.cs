...
namespace Pulumi.AzureNative.RecoveryServices.V20240401.Inputs
{
    ...
    public sealed class AzureIaaSVMProtectionPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20240401.IAASVMPolicyType>? PolicyType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20240401.IaasVMSnapshotConsistencyType>? SnapshotConsistencyType { get; set; }
