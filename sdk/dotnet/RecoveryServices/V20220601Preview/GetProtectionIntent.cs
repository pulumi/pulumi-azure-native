...
namespace Pulumi.AzureNative.RecoveryServices.V20220601Preview
{
    public static class GetProtectionIntent
    {
        ...
        public static Task<GetProtectionIntentResult> InvokeAsync(GetProtectionIntentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProtectionIntentResult>("azure-native:recoveryservices/v20220601preview:getProtectionIntent", args ?? new GetProtectionIntentArgs(), options.WithDefaults());

        /// <summary>
        /// Base class for backup ProtectionIntent.
        /// </summary>
        public static Output<GetProtectionIntentResult> Invoke(GetProtectionIntentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProtectionIntentResult>("azure-native:recoveryservices/v20220601preview:getProtectionIntent", args ?? new GetProtectionIntentInvokeArgs(), options.WithDefaults());
    }
