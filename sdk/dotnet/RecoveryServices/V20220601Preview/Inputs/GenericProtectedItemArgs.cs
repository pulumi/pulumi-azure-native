...
namespace Pulumi.AzureNative.RecoveryServices.V20220601Preview.Inputs
{
    ...
    public sealed class GenericProtectedItemArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20220601Preview.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20220601Preview.ProtectionState>? ProtectionState { get; set; }
