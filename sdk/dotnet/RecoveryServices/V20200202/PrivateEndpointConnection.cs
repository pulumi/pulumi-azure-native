...
namespace Pulumi.AzureNative.RecoveryServices.V20200202
{
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20200202:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20200202:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210201preview:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210210:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210210:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210301:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210301:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210401:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210401:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210601:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210601:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210701:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210701:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210801:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210801:PrivateEndpointConnection"},
                },
            };
