...
namespace Pulumi.AzureNative.RecoveryServices.V20240430Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20240430preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20240430preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20240430preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
