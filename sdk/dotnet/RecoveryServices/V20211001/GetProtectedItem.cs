...
namespace Pulumi.AzureNative.RecoveryServices.V20211001
{
    public static class GetProtectedItem
    {
        ...
        public static Task<GetProtectedItemResult> InvokeAsync(GetProtectedItemArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProtectedItemResult>("azure-native:recoveryservices/v20211001:getProtectedItem", args ?? new GetProtectedItemArgs(), options.WithVersion());

        /// <summary>
        /// Base class for backup items.
        /// </summary>
        public static Output<GetProtectedItemResult> Invoke(GetProtectedItemInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProtectedItemResult>("azure-native:recoveryservices/v20211001:getProtectedItem", args ?? new GetProtectedItemInvokeArgs(), options.WithVersion());
    }
