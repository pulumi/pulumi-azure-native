...
namespace Pulumi.AzureNative.RecoveryServices.V20211001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20211001:ReplicationRecoveryPlan")]
    public partial class ReplicationRecoveryPlan : Pulumi.CustomResource
    {
        ...
        public ReplicationRecoveryPlan(string name, ReplicationRecoveryPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20211001:ReplicationRecoveryPlan", name, args ?? new ReplicationRecoveryPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationRecoveryPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20211001:ReplicationRecoveryPlan", name, null, MakeResourceOptions(options, id))
        {
        }
