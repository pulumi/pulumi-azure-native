...
{
    [Obsolete(@"azure-native:recoveryservices/v20211001:ResourceGuardProxy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ResourceGuardProxy to guarantee forwards compatibility.")]
    public static class GetResourceGuardProxy
    {
        ...
        public static Task<GetResourceGuardProxyResult> InvokeAsync(GetResourceGuardProxyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetResourceGuardProxyResult>("azure-native:recoveryservices/v20211001:getResourceGuardProxy", args ?? new GetResourceGuardProxyArgs(), options.WithDefaults());

        /// <summary>
        /// Returns ResourceGuardProxy under vault and with the name referenced in request
        /// </summary>
        public static Output<GetResourceGuardProxyResult> Invoke(GetResourceGuardProxyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetResourceGuardProxyResult>("azure-native:recoveryservices/v20211001:getResourceGuardProxy", args ?? new GetResourceGuardProxyInvokeArgs(), options.WithDefaults());
    }
