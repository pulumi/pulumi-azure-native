...
namespace Pulumi.AzureRM.RecoveryServices.V20180710
{
    ...
    ///     public MyStack()
    ///     {
    ///         var replicationStorageClassificationMapping = new AzureRM.RecoveryServices.V20180710.ReplicationStorageClassificationMapping("replicationStorageClassificationMapping", new AzureRM.RecoveryServices.V20180710.ReplicationStorageClassificationMappingArgs
    ///         {
    ...
    public partial class ReplicationStorageClassificationMapping : Pulumi.CustomResource
    {
        ...
        public ReplicationStorageClassificationMapping(string name, ReplicationStorageClassificationMappingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/v20180710:ReplicationStorageClassificationMapping", name, args ?? new ReplicationStorageClassificationMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationStorageClassificationMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/v20180710:ReplicationStorageClassificationMapping", name, null, MakeResourceOptions(options, id))
        {
        }
