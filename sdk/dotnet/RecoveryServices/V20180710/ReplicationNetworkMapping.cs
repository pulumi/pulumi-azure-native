...
namespace Pulumi.AzureNative.RecoveryServices.V20180710
{
    ...
    /// {
    ///     var replicationNetworkMapping = new AzureNative.RecoveryServices.V20180710.ReplicationNetworkMapping("replicationNetworkMapping", new()
    ///     {
    ...
    ///         Properties = new AzureNative.RecoveryServices.V20180710.Inputs.CreateNetworkMappingInputPropertiesArgs
    ///         {
    ///             FabricSpecificDetails = new AzureNative.RecoveryServices.V20180710.Inputs.VmmToAzureCreateNetworkMappingInputArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20180710:ReplicationNetworkMapping")]
    public partial class ReplicationNetworkMapping : global::Pulumi.CustomResource
    {
        ...
        public ReplicationNetworkMapping(string name, ReplicationNetworkMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20180710:ReplicationNetworkMapping", name, args ?? new ReplicationNetworkMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationNetworkMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20180710:ReplicationNetworkMapping", name, null, MakeResourceOptions(options, id))
        {
        }
