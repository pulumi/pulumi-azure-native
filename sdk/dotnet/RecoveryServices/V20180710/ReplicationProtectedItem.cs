...
namespace Pulumi.AzureNextGen.RecoveryServices.V20180710
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:recoveryservices/v20180710:ReplicationProtectedItem")]
    public partial class ReplicationProtectedItem : Pulumi.CustomResource
    {
        ...
        public ReplicationProtectedItem(string name, ReplicationProtectedItemArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices/v20180710:ReplicationProtectedItem", name, args ?? new ReplicationProtectedItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationProtectedItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices/v20180710:ReplicationProtectedItem", name, null, MakeResourceOptions(options, id))
        {
        }
