...
namespace Pulumi.AzureRM.RecoveryServices
{
    ...
    /// </summary>
    public partial class VaultBackupPolicy : Pulumi.CustomResource
    {
        /// <summary>
        /// Optional ETag.
        /// </summary>
        ...
        public VaultBackupPolicy(string name, VaultBackupPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices:VaultBackupPolicy", name, args ?? new VaultBackupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class VaultBackupPolicyArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Optional ETag.
        /// </summary>
