...
namespace Pulumi.AzureNative.RecoveryServices.V20210601
{
    public static class GetReplicationvCenter
    {
        ...
        public static Task<GetReplicationvCenterResult> InvokeAsync(GetReplicationvCenterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationvCenterResult>("azure-native:recoveryservices/v20210601:getReplicationvCenter", args ?? new GetReplicationvCenterArgs(), options.WithVersion());

        /// <summary>
        /// vCenter definition.
        /// </summary>
        public static Output<GetReplicationvCenterResult> Invoke(GetReplicationvCenterInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetReplicationvCenterResult>("azure-native:recoveryservices/v20210601:getReplicationvCenter", args ?? new GetReplicationvCenterInvokeArgs(), options.WithVersion());
    }
