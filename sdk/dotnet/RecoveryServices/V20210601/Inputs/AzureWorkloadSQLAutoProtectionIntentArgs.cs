...
namespace Pulumi.AzureNative.RecoveryServices.V20210601.Inputs
{
    ...
    public sealed class AzureWorkloadSQLAutoProtectionIntentArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210601.ProtectionStatus>? ProtectionState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210601.WorkloadItemType>? WorkloadItemType { get; set; }
