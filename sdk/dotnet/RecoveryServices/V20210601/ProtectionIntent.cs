...
namespace Pulumi.AzureNative.RecoveryServices.V20210601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210601:ProtectionIntent")]
    public partial class ProtectionIntent : global::Pulumi.CustomResource
    {
        ...
        public ProtectionIntent(string name, ProtectionIntentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210601:ProtectionIntent", name, args ?? new ProtectionIntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionIntent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210601:ProtectionIntent", name, null, MakeResourceOptions(options, id))
        {
        }
