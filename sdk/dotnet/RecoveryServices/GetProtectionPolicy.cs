...
namespace Pulumi.AzureRM.RecoveryServices
{
    public static class GetProtectionPolicy
    {
        public static Task<GetProtectionPolicyResult> InvokeAsync(GetProtectionPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProtectionPolicyResult>("azurerm:recoveryservices:getProtectionPolicy", args ?? new GetProtectionPolicyArgs(), options.WithVersion());
    }
