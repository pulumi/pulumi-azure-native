...
namespace Pulumi.AzureNative.RecoveryServices.V20240730Preview
{
    public static class GetProtectedItem
    {
        ...
        public static Task<GetProtectedItemResult> InvokeAsync(GetProtectedItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProtectedItemResult>("azure-native:recoveryservices/v20240730preview:getProtectedItem", args ?? new GetProtectedItemArgs(), options.WithDefaults());
