...
namespace Pulumi.AzureNative.RecoveryServices.V20210701
{
    ...
    [AzureNativeResourceType("azure-native:recoveryservices/v20210701:Vault")]
    public partial class Vault : global::Pulumi.CustomResource
    {
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210701:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210701:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
