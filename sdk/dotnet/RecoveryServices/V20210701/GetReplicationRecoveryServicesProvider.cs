...
namespace Pulumi.AzureNative.RecoveryServices.V20210701
{
    public static class GetReplicationRecoveryServicesProvider
    {
        ...
        /// Gets the details of registered recovery services provider.
        /// </summary>
        public static Output<GetReplicationRecoveryServicesProviderResult> Invoke(GetReplicationRecoveryServicesProviderInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetReplicationRecoveryServicesProviderResult>("azure-native:recoveryservices/v20210701:getReplicationRecoveryServicesProvider", args ?? new GetReplicationRecoveryServicesProviderInvokeArgs(), options.WithDefaults());
    }
