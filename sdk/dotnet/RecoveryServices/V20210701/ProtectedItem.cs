    ...
    public partial class ProtectedItem : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210701:ProtectedItem"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210201preview:ProtectedItem"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210210:ProtectedItem"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210210:ProtectedItem"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210301:ProtectedItem"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210301:ProtectedItem"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210401:ProtectedItem"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210401:ProtectedItem"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210601:ProtectedItem"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210601:ProtectedItem"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210801:ProtectedItem"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210801:ProtectedItem"},
                },
            };
