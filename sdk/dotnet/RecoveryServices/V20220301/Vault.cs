...
namespace Pulumi.AzureNative.RecoveryServices.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:recoveryservices/v20220301:Vault is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:Vault to guarantee forwards compatibility.")]
    ...
    public partial class Vault : global::Pulumi.CustomResource
    {
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220301:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220301:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
