...
namespace Pulumi.AzureNextGen.RecoveryServices
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:recoveryservices:ReplicationvCenter")]
    public partial class ReplicationvCenter : Pulumi.CustomResource
    {
        ...
        public ReplicationvCenter(string name, ReplicationvCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices:ReplicationvCenter", name, args ?? new ReplicationvCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationvCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices:ReplicationvCenter", name, null, MakeResourceOptions(options, id))
        {
        }
