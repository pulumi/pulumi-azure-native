...
namespace Pulumi.AzureNative.RecoveryServices.V20210301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210301:ProtectionIntent")]
    public partial class ProtectionIntent : Pulumi.CustomResource
    {
        ...
        public ProtectionIntent(string name, ProtectionIntentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210301:ProtectionIntent", name, args ?? new ProtectionIntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionIntent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210301:ProtectionIntent", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210301:ProtectionIntent"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210210:ProtectionIntent"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210401:ProtectionIntent"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210401:ProtectionIntent"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210601:ProtectionIntent"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210601:ProtectionIntent"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210701:ProtectionIntent"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210701:ProtectionIntent"},
                    new Pulumi.Alias { Type = "azure-native:recoveryservices/v20210801:ProtectionIntent"},
                    new Pulumi.Alias { Type = "azure-nextgen:recoveryservices/v20210801:ProtectionIntent"},
                },
            };
