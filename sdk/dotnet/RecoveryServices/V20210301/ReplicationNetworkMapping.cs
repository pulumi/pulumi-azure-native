...
namespace Pulumi.AzureNative.RecoveryServices.V20210301
{
    ...
    /// {
    ///     var replicationNetworkMapping = new AzureNative.RecoveryServices.V20210301.ReplicationNetworkMapping("replicationNetworkMapping", new()
    ///     {
    ...
    ///         Properties = new AzureNative.RecoveryServices.V20210301.Inputs.CreateNetworkMappingInputPropertiesArgs
    ///         {
    ///             FabricSpecificDetails = new AzureNative.RecoveryServices.V20210301.Inputs.VmmToAzureCreateNetworkMappingInputArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:recoveryservices/v20210301:ReplicationNetworkMapping corpe2amap /Subscriptions/9112a37f-0f3e-46ec-9c00-060c6edca071/resourceGroups/srcBvte2a14C27/providers/Microsoft.RecoveryServices/vaults/srce2avaultbvtaC27/replicationFabrics/b0cef6e9a4437b81803d0b55ada4f700ab66caae59c35d62723a1589c0cd13ac/replicationNetworks/e2267b5c-2650-49bd-ab3f-d66aae694c06/replicationNetworkMappings/corpe2amap 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210301:ReplicationNetworkMapping")]
    public partial class ReplicationNetworkMapping : global::Pulumi.CustomResource
    {
        ...
        public ReplicationNetworkMapping(string name, ReplicationNetworkMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210301:ReplicationNetworkMapping", name, args ?? new ReplicationNetworkMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationNetworkMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210301:ReplicationNetworkMapping", name, null, MakeResourceOptions(options, id))
        {
        }
