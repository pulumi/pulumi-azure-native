...
namespace Pulumi.AzureNative.RecoveryServices.V20210301
{
    ...
    /// {
    ///     var replicationvCenter = new AzureNative.RecoveryServices.V20210301.ReplicationvCenter("replicationvCenter", new()
    ///     {
    ///         FabricName = "MadhaviFabric",
    ///         Properties = new AzureNative.RecoveryServices.V20210301.Inputs.AddVCenterRequestPropertiesArgs
    ///         {
    ///             FriendlyName = "esx-78",
    ///             IpAddress = "inmtest78",
    ///             Port = "443",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210301:ReplicationvCenter")]
    public partial class ReplicationvCenter : global::Pulumi.CustomResource
    {
        ...
        public ReplicationvCenter(string name, ReplicationvCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210301:ReplicationvCenter", name, args ?? new ReplicationvCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationvCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210301:ReplicationvCenter", name, null, MakeResourceOptions(options, id))
        {
        }
