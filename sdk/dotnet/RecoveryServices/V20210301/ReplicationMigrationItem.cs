...
namespace Pulumi.AzureNative.RecoveryServices.V20210301
{
    ...
    /// Migration item.
    /// </summary>
    [Obsolete(@"azure-native:recoveryservices/v20210301:ReplicationMigrationItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationMigrationItem to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:recoveryservices/v20210301:ReplicationMigrationItem")]
    public partial class ReplicationMigrationItem : global::Pulumi.CustomResource
    {
        ...
        public ReplicationMigrationItem(string name, ReplicationMigrationItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210301:ReplicationMigrationItem", name, args ?? new ReplicationMigrationItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationMigrationItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210301:ReplicationMigrationItem", name, null, MakeResourceOptions(options, id))
        {
        }
