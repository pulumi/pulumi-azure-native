...
namespace Pulumi.AzureNative.RecoveryServices.V20210301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210301:ReplicationProtectionContainerMapping")]
    public partial class ReplicationProtectionContainerMapping : global::Pulumi.CustomResource
    {
        ...
        public ReplicationProtectionContainerMapping(string name, ReplicationProtectionContainerMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210301:ReplicationProtectionContainerMapping", name, args ?? new ReplicationProtectionContainerMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationProtectionContainerMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210301:ReplicationProtectionContainerMapping", name, null, MakeResourceOptions(options, id))
        {
        }
