...
namespace Pulumi.AzureNative.RecoveryServices.V20210301.Inputs
{
    ...
    public sealed class AzureIaaSVMProtectedItemArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("healthStatus")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210301.HealthStatus>? HealthStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210301.ProtectionState>? ProtectionState { get; set; }
