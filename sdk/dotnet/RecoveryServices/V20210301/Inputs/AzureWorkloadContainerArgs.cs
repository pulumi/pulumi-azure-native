...
namespace Pulumi.AzureNative.RecoveryServices.V20210301.Inputs
{
    ...
    public sealed class AzureWorkloadContainerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("operationType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210301.OperationType>? OperationType { get; set; }
        ...
        /// </summary>
        [Input("workloadType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210301.WorkloadType>? WorkloadType { get; set; }
