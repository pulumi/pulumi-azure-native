...
namespace Pulumi.AzureNative.RecoveryServices.V20210301.Inputs
{
    ...
    public sealed class MabFileFolderProtectedItemArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210301.CreateMode>? CreateMode { get; set; }
        ...
        /// </summary>
        [Input("workloadType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210301.DataSourceType>? WorkloadType { get; set; }
