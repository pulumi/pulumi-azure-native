...
namespace Pulumi.AzureNextGen.RecoveryServices
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:recoveryservices:ReplicationPolicy")]
    public partial class ReplicationPolicy : Pulumi.CustomResource
    {
        ...
        public ReplicationPolicy(string name, ReplicationPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices:ReplicationPolicy", name, args ?? new ReplicationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices:ReplicationPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
