...
namespace Pulumi.AzureRM.RecoveryServices.Latest
{
    ...
    public partial class ReplicationNetworkMapping : Pulumi.CustomResource
    {
        ...
        public ReplicationNetworkMapping(string name, ReplicationNetworkMappingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/latest:ReplicationNetworkMapping", name, args ?? new ReplicationNetworkMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationNetworkMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/latest:ReplicationNetworkMapping", name, null, MakeResourceOptions(options, id))
        {
        }
