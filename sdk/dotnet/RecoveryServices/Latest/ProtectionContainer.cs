...
namespace Pulumi.AzureRM.RecoveryServices.Latest
{
    ...
    public partial class ProtectionContainer : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ProtectionContainerResponseResult> Properties { get; private set; } = null!;
        ...
        public ProtectionContainer(string name, ProtectionContainerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/latest:ProtectionContainer", name, args ?? new ProtectionContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:recoveryservices/latest:ProtectionContainer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:recoveryservices/preview:ProtectionContainer"},
                    new Pulumi.Alias { Type = "azurerm:recoveryservices/v20161201:ProtectionContainer"},
                },
            };
    ...
    public sealed class ProtectionContainerArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.ProtectionContainerArgs>? Properties { get; set; }
