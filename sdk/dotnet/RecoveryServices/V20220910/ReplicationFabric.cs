...
namespace Pulumi.AzureNative.RecoveryServices.V20220910
{
    ...
    /// Fabric definition.
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20220910:ReplicationFabric")]
    public partial class ReplicationFabric : global::Pulumi.CustomResource
    {
        ...
        public ReplicationFabric(string name, ReplicationFabricArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220910:ReplicationFabric", name, args ?? new ReplicationFabricArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationFabric(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220910:ReplicationFabric", name, null, MakeResourceOptions(options, id))
        {
        }
