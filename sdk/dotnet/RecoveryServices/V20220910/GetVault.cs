...
namespace Pulumi.AzureNative.RecoveryServices.V20220910
{
    public static class GetVault
    {
        ...
        public static Task<GetVaultResult> InvokeAsync(GetVaultArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVaultResult>("azure-native:recoveryservices/v20220910:getVault", args ?? new GetVaultArgs(), options.WithDefaults());

        /// <summary>
        /// Get the Vault details.
        /// </summary>
        public static Output<GetVaultResult> Invoke(GetVaultInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVaultResult>("azure-native:recoveryservices/v20220910:getVault", args ?? new GetVaultInvokeArgs(), options.WithDefaults());
    }
