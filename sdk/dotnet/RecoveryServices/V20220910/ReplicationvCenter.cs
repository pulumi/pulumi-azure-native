...
namespace Pulumi.AzureNative.RecoveryServices.V20220910
{
    ...
    /// vCenter definition.
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20220910:ReplicationvCenter")]
    public partial class ReplicationvCenter : global::Pulumi.CustomResource
    {
        ...
        public ReplicationvCenter(string name, ReplicationvCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220910:ReplicationvCenter", name, args ?? new ReplicationvCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationvCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220910:ReplicationvCenter", name, null, MakeResourceOptions(options, id))
        {
        }
