...
namespace Pulumi.AzureNative.RecoveryServices.V20220910
{
    ...
    [AzureNativeResourceType("azure-native:recoveryservices/v20220910:ReplicationRecoveryServicesProvider")]
    public partial class ReplicationRecoveryServicesProvider : global::Pulumi.CustomResource
    {
        ...
        public ReplicationRecoveryServicesProvider(string name, ReplicationRecoveryServicesProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220910:ReplicationRecoveryServicesProvider", name, args ?? new ReplicationRecoveryServicesProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationRecoveryServicesProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220910:ReplicationRecoveryServicesProvider", name, null, MakeResourceOptions(options, id))
        {
        }
