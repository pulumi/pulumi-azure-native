...
namespace Pulumi.AzureNative.RecoveryServices.V20220910
{
    ...
    [AzureNativeResourceType("azure-native:recoveryservices/v20220910:ReplicationProtectionContainerMapping")]
    public partial class ReplicationProtectionContainerMapping : global::Pulumi.CustomResource
    {
        ...
        public ReplicationProtectionContainerMapping(string name, ReplicationProtectionContainerMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220910:ReplicationProtectionContainerMapping", name, args ?? new ReplicationProtectionContainerMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationProtectionContainerMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220910:ReplicationProtectionContainerMapping", name, null, MakeResourceOptions(options, id))
        {
        }
