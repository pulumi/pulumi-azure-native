...
namespace Pulumi.AzureNative.RecoveryServices.V20211101
{
    public static class GetReplicationPolicy
    {
        ...
        public static Task<GetReplicationPolicyResult> InvokeAsync(GetReplicationPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationPolicyResult>("azure-native:recoveryservices/v20211101:getReplicationPolicy", args ?? new GetReplicationPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Protection profile details.
        /// </summary>
        public static Output<GetReplicationPolicyResult> Invoke(GetReplicationPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetReplicationPolicyResult>("azure-native:recoveryservices/v20211101:getReplicationPolicy", args ?? new GetReplicationPolicyInvokeArgs(), options.WithVersion());
    }
