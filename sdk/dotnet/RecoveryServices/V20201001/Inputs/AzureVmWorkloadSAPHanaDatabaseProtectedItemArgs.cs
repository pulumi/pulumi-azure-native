...
namespace Pulumi.AzureNative.RecoveryServices.V20201001.Inputs
{
    ...
    public sealed class AzureVmWorkloadSAPHanaDatabaseProtectedItemArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20201001.LastBackupStatus>? LastBackupStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20201001.ProtectedItemHealthStatus>? ProtectedItemHealthStatus { get; set; }
