...
namespace Pulumi.AzureNative.RecoveryServices.V20201001.Inputs
{
    ...
    public sealed class AzureWorkloadContainerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("operationType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20201001.OperationType>? OperationType { get; set; }
        ...
        /// </summary>
        [Input("workloadType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20201001.WorkloadType>? WorkloadType { get; set; }
