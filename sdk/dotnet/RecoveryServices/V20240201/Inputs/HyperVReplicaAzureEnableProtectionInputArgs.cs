...
namespace Pulumi.AzureNative.RecoveryServices.V20240201.Inputs
{
    ...
    public sealed class HyperVReplicaAzureEnableProtectionInputArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20240201.LicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20240201.SqlServerLicenseType>? SqlServerLicenseType { get; set; }
