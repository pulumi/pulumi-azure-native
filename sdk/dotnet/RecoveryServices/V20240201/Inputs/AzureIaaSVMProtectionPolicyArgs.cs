...
namespace Pulumi.AzureNative.RecoveryServices.V20240201.Inputs
{
    ...
    public sealed class AzureIaaSVMProtectionPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20240201.IAASVMPolicyType>? PolicyType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20240201.IaasVMSnapshotConsistencyType>? SnapshotConsistencyType { get; set; }
