...
namespace Pulumi.AzureNative.RecoveryServices.V20240201.Inputs
{
    ...
    public sealed class AzureVmWorkloadSAPAseDatabaseProtectedItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20240201.LastBackupStatus>? LastBackupStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20240201.ProtectedItemHealthStatus>? ProtectedItemHealthStatus { get; set; }
