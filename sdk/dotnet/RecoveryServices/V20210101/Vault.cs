...
namespace Pulumi.AzureNative.RecoveryServices.V20210101
{
    ...
    /// {
    ///     var vault = new AzureNative.RecoveryServices.V20210101.Vault("vault", new()
    ///     {
    ///         Identity = new AzureNative.RecoveryServices.V20210101.Inputs.IdentityDataArgs
    ///         {
    ///             Type = "SystemAssigned",
    ///         },
    ///         Location = "West US",
    ...
    ///         Sku = new AzureNative.RecoveryServices.V20210101.Inputs.SkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ...
    ///         },
    ///         Location = "West US",
    ///         Properties = new AzureNative.RecoveryServices.V20210101.Inputs.VaultPropertiesArgs
    ///         {
    ///             Encryption = new AzureNative.RecoveryServices.V20210101.Inputs.VaultPropertiesEncryptionArgs
    ///             {
    ///                 InfrastructureEncryption = "Enabled",
    ///                 KekIdentity = new AzureNative.RecoveryServices.V20210101.Inputs.CmkKekIdentityArgs
    ///                 {
    ...
    ///                 },
    ///                 KeyVaultProperties = new AzureNative.RecoveryServices.V20210101.Inputs.CmkKeyVaultPropertiesArgs
    ///                 {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:recoveryservices/v20210101:Vault swaggerExample /subscriptions/77777777-b0c6-47a2-b37c-d8e65a629c18/resourceGroups/Default-RecoveryServices-ResourceGroup/providers/Microsoft.RecoveryServices/vaults/swaggerExample 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20210101:Vault")]
    public partial class Vault : global::Pulumi.CustomResource
    {
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210101:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20210101:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
