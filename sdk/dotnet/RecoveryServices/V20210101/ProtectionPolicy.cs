...
namespace Pulumi.AzureNextGen.RecoveryServices.V20210101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:recoveryservices/v20210101:ProtectionPolicy")]
    public partial class ProtectionPolicy : Pulumi.CustomResource
    {
        ...
        public ProtectionPolicy(string name, ProtectionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices/v20210101:ProtectionPolicy", name, args ?? new ProtectionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices/v20210101:ProtectionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
