...
namespace Pulumi.AzureNextGen.RecoveryServices.V20210101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:recoveryservices/v20210101:ProtectedItem")]
    public partial class ProtectedItem : Pulumi.CustomResource
    {
        ...
        public ProtectedItem(string name, ProtectedItemArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices/v20210101:ProtectedItem", name, args ?? new ProtectedItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectedItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:recoveryservices/v20210101:ProtectedItem", name, null, MakeResourceOptions(options, id))
        {
        }
