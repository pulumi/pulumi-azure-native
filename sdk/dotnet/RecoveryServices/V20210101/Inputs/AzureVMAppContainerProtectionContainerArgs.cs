...
namespace Pulumi.AzureNative.RecoveryServices.V20210101.Inputs
{
    ...
    public sealed class AzureVMAppContainerProtectionContainerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("operationType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210101.OperationType>? OperationType { get; set; }
        ...
        /// </summary>
        [Input("workloadType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20210101.WorkloadType>? WorkloadType { get; set; }
