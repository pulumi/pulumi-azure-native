...
{
    [Obsolete(@"azure-native:recoveryservices/v20220401:ProtectionIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ProtectionIntent to guarantee forwards compatibility.")]
    public static class GetProtectionIntent
    {
        ...
        public static Task<GetProtectionIntentResult> InvokeAsync(GetProtectionIntentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProtectionIntentResult>("azure-native:recoveryservices/v20220401:getProtectionIntent", args ?? new GetProtectionIntentArgs(), options.WithDefaults());
        ...
        public static Output<GetProtectionIntentResult> Invoke(GetProtectionIntentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProtectionIntentResult>("azure-native:recoveryservices/v20220401:getProtectionIntent", args ?? new GetProtectionIntentInvokeArgs(), options.WithDefaults());
    }
