...
{
    [Obsolete(@"azure-native:recoveryservices/v20220401:Vault is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:Vault to guarantee forwards compatibility.")]
    public static class GetVault
    {
        ...
        public static Task<GetVaultResult> InvokeAsync(GetVaultArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVaultResult>("azure-native:recoveryservices/v20220401:getVault", args ?? new GetVaultArgs(), options.WithDefaults());

        /// <summary>
        /// Get the Vault details.
        /// </summary>
        public static Output<GetVaultResult> Invoke(GetVaultInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVaultResult>("azure-native:recoveryservices/v20220401:getVault", args ?? new GetVaultInvokeArgs(), options.WithDefaults());
    }
