...
namespace Pulumi.AzureNative.RecoveryServices.V20220101
{
    public static class GetReplicationPolicy
    {
        ...
        public static Task<GetReplicationPolicyResult> InvokeAsync(GetReplicationPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationPolicyResult>("azure-native:recoveryservices/v20220101:getReplicationPolicy", args ?? new GetReplicationPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Protection profile details.
        /// </summary>
        public static Output<GetReplicationPolicyResult> Invoke(GetReplicationPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetReplicationPolicyResult>("azure-native:recoveryservices/v20220101:getReplicationPolicy", args ?? new GetReplicationPolicyInvokeArgs(), options.WithDefaults());
    }
