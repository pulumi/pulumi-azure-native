...
namespace Pulumi.AzureNative.RecoveryServices.V20220101
{
    public static class GetReplicationPolicy
    {
        ...
        public static Task<GetReplicationPolicyResult> InvokeAsync(GetReplicationPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReplicationPolicyResult>("azure-native:recoveryservices/v20220101:getReplicationPolicy", args ?? new GetReplicationPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of a replication policy.
        /// </summary>
        public static Output<GetReplicationPolicyResult> Invoke(GetReplicationPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReplicationPolicyResult>("azure-native:recoveryservices/v20220101:getReplicationPolicy", args ?? new GetReplicationPolicyInvokeArgs(), options.WithDefaults());
    }
