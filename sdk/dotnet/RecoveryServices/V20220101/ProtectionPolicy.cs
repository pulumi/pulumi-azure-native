...
namespace Pulumi.AzureNative.RecoveryServices.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20220101:ProtectionPolicy")]
    public partial class ProtectionPolicy : Pulumi.CustomResource
    {
        ...
        public ProtectionPolicy(string name, ProtectionPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220101:ProtectionPolicy", name, args ?? new ProtectionPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220101:ProtectionPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
