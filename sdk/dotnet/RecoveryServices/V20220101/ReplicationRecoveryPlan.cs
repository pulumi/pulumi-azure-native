...
namespace Pulumi.AzureNative.RecoveryServices.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20220101:ReplicationRecoveryPlan")]
    public partial class ReplicationRecoveryPlan : Pulumi.CustomResource
    {
        ...
        public ReplicationRecoveryPlan(string name, ReplicationRecoveryPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220101:ReplicationRecoveryPlan", name, args ?? new ReplicationRecoveryPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationRecoveryPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20220101:ReplicationRecoveryPlan", name, null, MakeResourceOptions(options, id))
        {
        }
