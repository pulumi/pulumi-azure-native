...
namespace Pulumi.AzureNative.RecoveryServices.V20161201
{
    ...
    [AzureNativeResourceType("azure-native:recoveryservices/v20161201:ProtectionContainer")]
    public partial class ProtectionContainer : Pulumi.CustomResource
    {
        ...
        public ProtectionContainer(string name, ProtectionContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20161201:ProtectionContainer", name, args ?? new ProtectionContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20161201:ProtectionContainer", name, null, MakeResourceOptions(options, id))
        {
        }
