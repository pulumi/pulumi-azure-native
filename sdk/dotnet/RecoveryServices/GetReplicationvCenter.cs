...
namespace Pulumi.AzureRM.RecoveryServices
{
    public static class GetReplicationvCenter
    {
        public static Task<GetReplicationvCenterResult> InvokeAsync(GetReplicationvCenterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicationvCenterResult>("azurerm:recoveryservices:getReplicationvCenter", args ?? new GetReplicationvCenterArgs(), options.WithVersion());
    }
