...
namespace Pulumi.AzureNative.RecoveryServices.V20241001.Inputs
{
    ...
    public sealed class AzureIaaSVMProtectionPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20241001.IAASVMPolicyType>? PolicyType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20241001.IaasVMSnapshotConsistencyType>? SnapshotConsistencyType { get; set; }
