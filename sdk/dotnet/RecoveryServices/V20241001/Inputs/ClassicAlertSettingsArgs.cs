...
namespace Pulumi.AzureNative.RecoveryServices.V20241001.Inputs
{
    ...
    public sealed class ClassicAlertSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20241001.AlertsState>? AlertsForCriticalOperations { get; set; }

        [Input("emailNotificationsForSiteRecovery")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20241001.AlertsState>? EmailNotificationsForSiteRecovery { get; set; }
