...
namespace Pulumi.AzureNative.RecoveryServices.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20240101:ProtectedItem")]
    public partial class ProtectedItem : global::Pulumi.CustomResource
    {
        ...
        public ProtectedItem(string name, ProtectedItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20240101:ProtectedItem", name, args ?? new ProtectedItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectedItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20240101:ProtectedItem", name, null, MakeResourceOptions(options, id))
        {
        }
