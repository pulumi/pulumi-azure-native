...
{
    [AzureNativeResourceType("azure-native:recoveryservices/v20240101:ResourceGuardProxy")]
    public partial class ResourceGuardProxy : global::Pulumi.CustomResource
    {
        ...
        public ResourceGuardProxy(string name, ResourceGuardProxyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20240101:ResourceGuardProxy", name, args ?? new ResourceGuardProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGuardProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20240101:ResourceGuardProxy", name, null, MakeResourceOptions(options, id))
        {
        }
