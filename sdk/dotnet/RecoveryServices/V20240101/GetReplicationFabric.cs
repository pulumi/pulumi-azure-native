...
namespace Pulumi.AzureNative.RecoveryServices.V20240101
{
    public static class GetReplicationFabric
    {
        ...
        public static Task<GetReplicationFabricResult> InvokeAsync(GetReplicationFabricArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReplicationFabricResult>("azure-native:recoveryservices/v20240101:getReplicationFabric", args ?? new GetReplicationFabricArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of an Azure Site Recovery fabric.
        /// </summary>
        public static Output<GetReplicationFabricResult> Invoke(GetReplicationFabricInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReplicationFabricResult>("azure-native:recoveryservices/v20240101:getReplicationFabric", args ?? new GetReplicationFabricInvokeArgs(), options.WithDefaults());
