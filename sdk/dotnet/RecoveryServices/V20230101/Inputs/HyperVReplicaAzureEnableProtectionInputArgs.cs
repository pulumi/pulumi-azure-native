...
namespace Pulumi.AzureNative.RecoveryServices.V20230101.Inputs
{
    ...
    public sealed class HyperVReplicaAzureEnableProtectionInputArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20230101.LicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.RecoveryServices.V20230101.SqlServerLicenseType>? SqlServerLicenseType { get; set; }
