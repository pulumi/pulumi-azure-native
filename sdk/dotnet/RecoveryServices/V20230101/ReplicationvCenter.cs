...
namespace Pulumi.AzureNative.RecoveryServices.V20230101
{
    ...
    [AzureNativeResourceType("azure-native:recoveryservices/v20230101:ReplicationvCenter")]
    public partial class ReplicationvCenter : global::Pulumi.CustomResource
    {
        ...
        public ReplicationvCenter(string name, ReplicationvCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230101:ReplicationvCenter", name, args ?? new ReplicationvCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationvCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230101:ReplicationvCenter", name, null, MakeResourceOptions(options, id))
        {
        }
