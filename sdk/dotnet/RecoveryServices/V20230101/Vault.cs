...
namespace Pulumi.AzureNative.RecoveryServices.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20230101:Vault")]
    public partial class Vault : global::Pulumi.CustomResource
    {
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230101:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230101:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
