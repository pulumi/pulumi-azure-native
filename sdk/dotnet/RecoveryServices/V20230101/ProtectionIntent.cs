...
namespace Pulumi.AzureNative.RecoveryServices.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:recoveryservices/v20230101:ProtectionIntent")]
    public partial class ProtectionIntent : global::Pulumi.CustomResource
    {
        ...
        public ProtectionIntent(string name, ProtectionIntentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230101:ProtectionIntent", name, args ?? new ProtectionIntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectionIntent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recoveryservices/v20230101:ProtectionIntent", name, null, MakeResourceOptions(options, id))
        {
        }
