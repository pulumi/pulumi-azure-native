...
namespace Pulumi.AzureRM.HybridData.Preview
{
    public static class GetDataStore
    {
        public static Task<GetDataStoreResult> InvokeAsync(GetDataStoreArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataStoreResult>("azurerm:hybriddata/preview:getDataStore", args ?? new GetDataStoreArgs(), options.WithVersion());
    }
