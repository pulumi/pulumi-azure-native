...
namespace Pulumi.AzureRM.HybridData.Preview
{
    ...
    public partial class DataStore : Pulumi.CustomResource
    {
        ...
        public DataStore(string name, DataStoreArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybriddata/preview:DataStore", name, args ?? new DataStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybriddata/preview:DataStore", name, null, MakeResourceOptions(options, id))
        {
        }
