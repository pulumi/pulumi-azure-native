...
namespace Pulumi.AzureRM.HybridData.Preview
{
    public static class GetJobDefinition
    {
        public static Task<GetJobDefinitionResult> InvokeAsync(GetJobDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJobDefinitionResult>("azurerm:hybriddata/preview:getJobDefinition", args ?? new GetJobDefinitionArgs(), options.WithVersion());
    }
