...
namespace Pulumi.AzureNextGen.HybridData.V20190601
{
    ...
    public partial class DataManager : Pulumi.CustomResource
    {
        ...
        public DataManager(string name, DataManagerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:hybriddata/v20190601:DataManager", name, args ?? new DataManagerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataManager(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:hybriddata/v20190601:DataManager", name, null, MakeResourceOptions(options, id))
        {
        }
