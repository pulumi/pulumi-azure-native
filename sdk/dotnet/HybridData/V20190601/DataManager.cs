...
namespace Pulumi.AzureRM.HybridData.V20190601
{
    ...
    public partial class DataManager : Pulumi.CustomResource
    {
        ...
        public DataManager(string name, DataManagerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybriddata/v20190601:DataManager", name, args ?? new DataManagerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataManager(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybriddata/v20190601:DataManager", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:hybriddata/preview:DataManager"},
