...
namespace Pulumi.AzureNative.HybridData.V20190601
{
    ...
    public partial class JobDefinition : Pulumi.CustomResource
    {
        ...
        public JobDefinition(string name, JobDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybriddata/v20190601:JobDefinition", name, args ?? new JobDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybriddata/v20190601:JobDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
