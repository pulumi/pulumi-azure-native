...
namespace Pulumi.AzureNextGen.HybridData.V20190601
{
    ...
    /// Job Definition.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:hybriddata/v20190601:JobDefinition")]
    public partial class JobDefinition : Pulumi.CustomResource
    {
        ...
        public JobDefinition(string name, JobDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:hybriddata/v20190601:JobDefinition", name, args ?? new JobDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:hybriddata/v20190601:JobDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class JobDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        {
            UserConfirmation = Pulumi.AzureNextGen.HybridData.V20190601.UserConfirmation.NotRequired;
        }
    }
}
