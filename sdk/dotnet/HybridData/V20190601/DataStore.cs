...
namespace Pulumi.AzureNextGen.HybridData.V20190601
{
    ...
    /// Data store.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:hybriddata/v20190601:DataStore")]
    public partial class DataStore : Pulumi.CustomResource
    {
        ...
        public DataStore(string name, DataStoreArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:hybriddata/v20190601:DataStore", name, args ?? new DataStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:hybriddata/v20190601:DataStore", name, null, MakeResourceOptions(options, id))
        {
        }
