...
namespace Pulumi.AzureNative.Orbital.V20210404Preview
{
    ...
    public partial class Spacecraft : Pulumi.CustomResource
    {
        ...
        public Spacecraft(string name, SpacecraftArgs args, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20210404preview:Spacecraft", name, args ?? new SpacecraftArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Spacecraft(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20210404preview:Spacecraft", name, null, MakeResourceOptions(options, id))
        {
        }
