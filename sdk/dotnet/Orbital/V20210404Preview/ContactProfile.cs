...
namespace Pulumi.AzureNative.Orbital.V20210404Preview
{
    ...
    public partial class ContactProfile : Pulumi.CustomResource
    {
        ...
        public ContactProfile(string name, ContactProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20210404preview:ContactProfile", name, args ?? new ContactProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContactProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20210404preview:ContactProfile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContactProfileArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Orbital.V20210404Preview.AutoTrackingConfiguration>? AutoTrackingConfiguration { get; set; }
