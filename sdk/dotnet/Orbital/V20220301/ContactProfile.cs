...
namespace Pulumi.AzureNative.Orbital.V20220301
{
    ...
    /// {
    ///     var contactProfile = new AzureNative.Orbital.V20220301.ContactProfile("contactProfile", new()
    ///     {
    ///         AutoTrackingConfiguration = AzureNative.Orbital.V20220301.AutoTrackingConfiguration.Disabled,
    ///         ContactProfileName = "CONTOSO-CP",
    ///         EventHubUri = "/subscriptions/c1be1141-a7c9-4aac-9608-3c2e2f1152c3/resourceGroups/contoso-Rgp/providers/Microsoft.EventHub/namespaces/contosoHub/eventhubs/contosoHub",
    ///         Links = new[]
    ///         {
    ///             new AzureNative.Orbital.V20220301.Inputs.ContactProfileLinkArgs
    ///             {
    ///                 Channels = new[]
    ///                 {
    ///                     new AzureNative.Orbital.V20220301.Inputs.ContactProfileLinkChannelArgs
    ///                     {
    ///                         BandwidthMHz = 2,
    ///                         CenterFrequencyMHz = 2250,
    ///                         EndPoint = new AzureNative.Orbital.V20220301.Inputs.EndPointArgs
    ///                         {
    ...
    ///         NetworkConfiguration = new AzureNative.Orbital.V20220301.Inputs.ContactProfilesPropertiesNetworkConfigurationArgs
    ///         {
    ...
    public partial class ContactProfile : global::Pulumi.CustomResource
    {
        ...
        public ContactProfile(string name, ContactProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20220301:ContactProfile", name, args ?? new ContactProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContactProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20220301:ContactProfile", name, null, MakeResourceOptions(options, id))
        {
        }
