...
namespace Pulumi.AzureNative.Orbital.V20220301
{
    ...
    /// {
    ///     var contact = new AzureNative.Orbital.V20220301.Contact("contact", new()
    ///     {
    ///         ContactName = "contact1",
    ///         ContactProfile = new AzureNative.Orbital.V20220301.Inputs.ContactsPropertiesContactProfileArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:orbital/v20220301:Contact")]
    public partial class Contact : global::Pulumi.CustomResource
    {
        ...
        public Contact(string name, ContactArgs args, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20220301:Contact", name, args ?? new ContactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Contact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20220301:Contact", name, null, MakeResourceOptions(options, id))
        {
        }
