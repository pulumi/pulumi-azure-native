...
namespace Pulumi.AzureNative.Orbital.V20220301
{
    ...
    /// {
    ///     var spacecraft = new AzureNative.Orbital.V20220301.Spacecraft("spacecraft", new()
    ///     {
    ///         Links = new[]
    ///         {
    ///             new AzureNative.Orbital.V20220301.Inputs.SpacecraftLinkArgs
    ///             {
    ///                 BandwidthMHz = 2,
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:orbital/v20220301:Spacecraft CONTOSO_SAT /subscriptions/c1be1141-a7c9-4aac-9608-3c2e2f1152c3/resourceGroups/contoso-Rgp/providers/Microsoft.Orbital/spacecrafts/CONTOSO_SAT 
    /// ```
    /// </summary>
    ...
    public partial class Spacecraft : global::Pulumi.CustomResource
    {
        ...
        public Spacecraft(string name, SpacecraftArgs args, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20220301:Spacecraft", name, args ?? new SpacecraftArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Spacecraft(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20220301:Spacecraft", name, null, MakeResourceOptions(options, id))
        {
        }
