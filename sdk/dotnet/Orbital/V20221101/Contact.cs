...
namespace Pulumi.AzureNative.Orbital.V20221101
{
    ...
    public partial class Contact : global::Pulumi.CustomResource
    {
        ...
        public Contact(string name, ContactArgs args, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20221101:Contact", name, args ?? new ContactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Contact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20221101:Contact", name, null, MakeResourceOptions(options, id))
        {
        }
