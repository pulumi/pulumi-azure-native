...
namespace Pulumi.AzureNative.Orbital.V20221101
{
    public static class GetContact
    {
        ...
        public static Task<GetContactResult> InvokeAsync(GetContactArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContactResult>("azure-native:orbital/v20221101:getContact", args ?? new GetContactArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified contact in a specified resource group.
        /// </summary>
        public static Output<GetContactResult> Invoke(GetContactInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContactResult>("azure-native:orbital/v20221101:getContact", args ?? new GetContactInvokeArgs(), options.WithDefaults());
