...
namespace Pulumi.AzureNative.Orbital.V20240301Preview
{
    public static class ListEdgeSiteL2Connections
    {
        ...
        public static Task<ListEdgeSiteL2ConnectionsResult> InvokeAsync(ListEdgeSiteL2ConnectionsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListEdgeSiteL2ConnectionsResult>("azure-native:orbital/v20240301preview:listEdgeSiteL2Connections", args ?? new ListEdgeSiteL2ConnectionsArgs(), options.WithDefaults());
