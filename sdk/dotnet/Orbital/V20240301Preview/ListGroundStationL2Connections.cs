...
namespace Pulumi.AzureNative.Orbital.V20240301Preview
{
    public static class ListGroundStationL2Connections
    {
        ...
        public static Task<ListGroundStationL2ConnectionsResult> InvokeAsync(ListGroundStationL2ConnectionsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListGroundStationL2ConnectionsResult>("azure-native:orbital/v20240301preview:listGroundStationL2Connections", args ?? new ListGroundStationL2ConnectionsArgs(), options.WithDefaults());
