...
namespace Pulumi.AzureNative.Orbital.V20240301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:orbital/v20240301preview:GroundStation")]
    public partial class GroundStation : global::Pulumi.CustomResource
    {
        ...
        public GroundStation(string name, GroundStationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20240301preview:GroundStation", name, args ?? new GroundStationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroundStation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20240301preview:GroundStation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GroundStationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Orbital.V20240301Preview.Capability>>? _capabilities;

        /// <summary>
        /// Ground station capabilities.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Orbital.V20240301Preview.Capability>> Capabilities
        {
            get => _capabilities ?? (_capabilities = new InputList<Union<string, Pulumi.AzureNative.Orbital.V20240301Preview.Capability>>());
