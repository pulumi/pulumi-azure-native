...
namespace Pulumi.AzureNative.Orbital.V20240301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:orbital/v20240301preview:L2Connection")]
    public partial class L2Connection : global::Pulumi.CustomResource
    {
        ...
        public L2Connection(string name, L2ConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20240301preview:L2Connection", name, args ?? new L2ConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private L2Connection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20240301preview:L2Connection", name, null, MakeResourceOptions(options, id))
        {
        }
