...
namespace Pulumi.AzureNative.Orbital.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:orbital/v20240301:GroundStation")]
    public partial class GroundStation : global::Pulumi.CustomResource
    {
        ...
        public GroundStation(string name, GroundStationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20240301:GroundStation", name, args ?? new GroundStationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroundStation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:orbital/v20240301:GroundStation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:orbital:GroundStation" },
    ...
    public sealed class GroundStationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Orbital.V20240301.Capability>>? _capabilities;

        /// <summary>
        /// Ground station capabilities.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Orbital.V20240301.Capability>> Capabilities
        {
            get => _capabilities ?? (_capabilities = new InputList<Union<string, Pulumi.AzureNative.Orbital.V20240301.Capability>>());
