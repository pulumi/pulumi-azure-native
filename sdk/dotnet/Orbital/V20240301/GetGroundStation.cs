...
namespace Pulumi.AzureNative.Orbital.V20240301
{
    public static class GetGroundStation
    {
        ...
        public static Task<GetGroundStationResult> InvokeAsync(GetGroundStationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGroundStationResult>("azure-native:orbital/v20240301:getGroundStation", args ?? new GetGroundStationArgs(), options.WithDefaults());
