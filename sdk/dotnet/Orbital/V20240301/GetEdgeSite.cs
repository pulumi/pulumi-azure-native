...
namespace Pulumi.AzureNative.Orbital.V20240301
{
    public static class GetEdgeSite
    {
        ...
        public static Task<GetEdgeSiteResult> InvokeAsync(GetEdgeSiteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEdgeSiteResult>("azure-native:orbital/v20240301:getEdgeSite", args ?? new GetEdgeSiteArgs(), options.WithDefaults());
