...
namespace Pulumi.AzureNative.Authorization
{
    ...
    public partial class VariableValue : global::Pulumi.CustomResource
    {
        ...
        public VariableValue(string name, VariableValueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization:VariableValue", name, args ?? new VariableValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VariableValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization:VariableValue", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20220801preview:VariableValue" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20241201preview:VariableValue" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20251201preview:VariableValue" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20260101preview:VariableValue" },
                },
            };
