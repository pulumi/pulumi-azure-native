...
namespace Pulumi.AzureNative.Authorization.V20211116Preview
{
    ...
    public partial class AccessReviewHistoryDefinitionById : Pulumi.CustomResource
    {
        ...
        public AccessReviewHistoryDefinitionById(string name, AccessReviewHistoryDefinitionByIdArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20211116preview:AccessReviewHistoryDefinitionById", name, args ?? new AccessReviewHistoryDefinitionByIdArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessReviewHistoryDefinitionById(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20211116preview:AccessReviewHistoryDefinitionById", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:authorization:AccessReviewHistoryDefinitionById"},
                },
            };
    ...
    {
        [Input("decisions")]
        private InputList<Union<string, Pulumi.AzureNative.Authorization.V20211116Preview.AccessReviewResult>>? _decisions;

        /// <summary>
        /// Collection of review decisions which the history data should be filtered on. For example if Approve and Deny are supplied the data will only contain review results in which the decision maker approved or denied a review request.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Authorization.V20211116Preview.AccessReviewResult>> Decisions
        {
            get => _decisions ?? (_decisions = new InputList<Union<string, Pulumi.AzureNative.Authorization.V20211116Preview.AccessReviewResult>>());
