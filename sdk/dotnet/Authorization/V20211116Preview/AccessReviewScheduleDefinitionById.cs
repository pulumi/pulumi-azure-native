...
namespace Pulumi.AzureNative.Authorization.V20211116Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20211116preview:AccessReviewScheduleDefinitionById")]
    public partial class AccessReviewScheduleDefinitionById : global::Pulumi.CustomResource
    {
        ...
        public AccessReviewScheduleDefinitionById(string name, AccessReviewScheduleDefinitionByIdArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20211116preview:AccessReviewScheduleDefinitionById", name, args ?? new AccessReviewScheduleDefinitionByIdArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessReviewScheduleDefinitionById(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20211116preview:AccessReviewScheduleDefinitionById", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccessReviewScheduleDefinitionByIdArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20211116Preview.DefaultDecisionType>? DefaultDecision { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20211116Preview.AccessReviewRecurrencePatternType>? Type { get; set; }
