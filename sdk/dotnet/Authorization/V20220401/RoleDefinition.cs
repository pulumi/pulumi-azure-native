...
namespace Pulumi.AzureNative.Authorization.V20220401
{
    ...
    /// {
    ///     var roleDefinition = new AzureNative.Authorization.V20220401.RoleDefinition("roleDefinition", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20220401:RoleDefinition")]
    public partial class RoleDefinition : global::Pulumi.CustomResource
    {
        ...
        public RoleDefinition(string name, RoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20220401:RoleDefinition", name, args ?? new RoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20220401:RoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
