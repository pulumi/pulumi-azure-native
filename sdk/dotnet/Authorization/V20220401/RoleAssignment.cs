...
namespace Pulumi.AzureNative.Authorization.V20220401
{
    ...
    /// {
    ///     var roleAssignment = new AzureNative.Authorization.V20220401.RoleAssignment("roleAssignment", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:authorization/v20220401:RoleAssignment 05c5a614-a7d6-4502-b150-c2fb455033ff /subscriptions/a925f2f7-5c63-4b7b-8799-25a5f97bc3b2/providers/Microsoft.Authorization/roleAssignments/05c5a614-a7d6-4502-b150-c2fb455033ff 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20220401:RoleAssignment")]
    public partial class RoleAssignment : global::Pulumi.CustomResource
    {
        ...
        public RoleAssignment(string name, RoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20220401:RoleAssignment", name, args ?? new RoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20220401:RoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
