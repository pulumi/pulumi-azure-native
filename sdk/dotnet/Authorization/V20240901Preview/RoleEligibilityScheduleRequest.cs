...
namespace Pulumi.AzureNative.Authorization.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20240901preview:RoleEligibilityScheduleRequest")]
    public partial class RoleEligibilityScheduleRequest : global::Pulumi.CustomResource
    {
        ...
        public RoleEligibilityScheduleRequest(string name, RoleEligibilityScheduleRequestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240901preview:RoleEligibilityScheduleRequest", name, args ?? new RoleEligibilityScheduleRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleEligibilityScheduleRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240901preview:RoleEligibilityScheduleRequest", name, null, MakeResourceOptions(options, id))
        {
        }
