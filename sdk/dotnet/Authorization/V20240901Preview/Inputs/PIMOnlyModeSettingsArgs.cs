...
namespace Pulumi.AzureNative.Authorization.V20240901Preview.Inputs
{
    ...
    public sealed class PIMOnlyModeSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Authorization.V20240901Preview.ExcludedPrincipalTypes>>? _excludedAssignmentTypes;

        /// <summary>
        /// The list of excluded assignment types allowed.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Authorization.V20240901Preview.ExcludedPrincipalTypes>> ExcludedAssignmentTypes
        {
            get => _excludedAssignmentTypes ?? (_excludedAssignmentTypes = new InputList<Union<string, Pulumi.AzureNative.Authorization.V20240901Preview.ExcludedPrincipalTypes>>());
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20240901Preview.PIMOnlyMode>? Mode { get; set; }
