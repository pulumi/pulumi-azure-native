...
namespace Pulumi.AzureNative.Authorization.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20240901preview:RoleManagementPolicy")]
    public partial class RoleManagementPolicy : global::Pulumi.CustomResource
    {
        ...
        public RoleManagementPolicy(string name, RoleManagementPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240901preview:RoleManagementPolicy", name, args ?? new RoleManagementPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleManagementPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240901preview:RoleManagementPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
