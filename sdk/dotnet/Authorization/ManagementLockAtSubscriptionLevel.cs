...
namespace Pulumi.AzureNative.Authorization
{
    ...
    public partial class ManagementLockAtSubscriptionLevel : global::Pulumi.CustomResource
    {
        ...
        public ManagementLockAtSubscriptionLevel(string name, ManagementLockAtSubscriptionLevelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization:ManagementLockAtSubscriptionLevel", name, args ?? new ManagementLockAtSubscriptionLevelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementLockAtSubscriptionLevel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization:ManagementLockAtSubscriptionLevel", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_authorization_v20150101:authorization:ManagementLockAtSubscriptionLevel" },
                    new global::Pulumi.Alias { Type = "azure-native_authorization_v20160901:authorization:ManagementLockAtSubscriptionLevel" },
                    new global::Pulumi.Alias { Type = "azure-native_authorization_v20170401:authorization:ManagementLockAtSubscriptionLevel" },
                    new global::Pulumi.Alias { Type = "azure-native_authorization_v20200501:authorization:ManagementLockAtSubscriptionLevel" },
                },
            };
