...
namespace Pulumi.AzureNative.Authorization.V20220401Preview
{
    public static class GetPimRoleEligibilitySchedule
    {
        ...
        public static Task<GetPimRoleEligibilityScheduleResult> InvokeAsync(GetPimRoleEligibilityScheduleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPimRoleEligibilityScheduleResult>("azure-native:authorization/v20220401preview:getPimRoleEligibilitySchedule", args ?? new GetPimRoleEligibilityScheduleArgs(), options.WithDefaults());
        ...
        public static Output<GetPimRoleEligibilityScheduleResult> Invoke(GetPimRoleEligibilityScheduleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPimRoleEligibilityScheduleResult>("azure-native:authorization/v20220401preview:getPimRoleEligibilitySchedule", args ?? new GetPimRoleEligibilityScheduleInvokeArgs(), options.WithDefaults());
