...
namespace Pulumi.AzureNative.Authorization.V20220401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20220401preview:PimRoleEligibilitySchedule")]
    public partial class PimRoleEligibilitySchedule : global::Pulumi.CustomResource
    {
        ...
        public PimRoleEligibilitySchedule(string name, PimRoleEligibilityScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20220401preview:PimRoleEligibilitySchedule", name, args ?? new PimRoleEligibilityScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PimRoleEligibilitySchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20220401preview:PimRoleEligibilitySchedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PimRoleEligibilityScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20220401Preview.RequestType> RequestType { get; set; } = null!;
