...
namespace Pulumi.AzureNative.Authorization.V20180301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:authorization/v20180301:PolicySetDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20190601:PolicySetDefinition to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:authorization/v20180301:PolicySetDefinition")]
    public partial class PolicySetDefinition : global::Pulumi.CustomResource
    {
        ...
        public PolicySetDefinition(string name, PolicySetDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20180301:PolicySetDefinition", name, args ?? new PolicySetDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20180301:PolicySetDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
