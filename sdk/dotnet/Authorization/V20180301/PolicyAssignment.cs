...
namespace Pulumi.AzureNative.Authorization.V20180301
{
    ...
    public partial class PolicyAssignment : global::Pulumi.CustomResource
    {
        ...
        public PolicyAssignment(string name, PolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20180301:PolicyAssignment", name, args ?? new PolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20180301:PolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
