...
namespace Pulumi.AzureRM.Authorization.V20180301
{
    ...
    public partial class PolicyAssignment : Pulumi.CustomResource
    {
        ...
        public PolicyAssignment(string name, PolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20180301:PolicyAssignment", name, args ?? new PolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20180301:PolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:authorization/v20151101:PolicyAssignment"},
                    new Alias { Type = "azurerm:authorization/v20161201:PolicyAssignment"},
                    new Alias { Type = "azurerm:authorization/v20180501:PolicyAssignment"},
                    new Alias { Type = "azurerm:authorization/v20190101:PolicyAssignment"},
                    new Alias { Type = "azurerm:authorization/v20190601:PolicyAssignment"},
                    new Alias { Type = "azurerm:authorization/v20190901:PolicyAssignment"},
                },
            };
