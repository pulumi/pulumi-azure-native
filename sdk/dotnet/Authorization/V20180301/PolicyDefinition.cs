...
namespace Pulumi.AzureRM.Authorization.V20180301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policyDefinition = new AzureRM.Authorization.V20180301.PolicyDefinition("policyDefinition", new AzureRM.Authorization.V20180301.PolicyDefinitionArgs
    ///         {
    ...
    public partial class PolicyDefinition : Pulumi.CustomResource
    {
        ...
        public PolicyDefinition(string name, PolicyDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20180301:PolicyDefinition", name, args ?? new PolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20180301:PolicyDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
