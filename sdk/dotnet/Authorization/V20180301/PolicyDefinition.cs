...
namespace Pulumi.AzureNextGen.Authorization.V20180301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:authorization/v20180301:PolicyDefinition")]
    public partial class PolicyDefinition : Pulumi.CustomResource
    {
        ...
        public PolicyDefinition(string name, PolicyDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20180301:PolicyDefinition", name, args ?? new PolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20180301:PolicyDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
