...
namespace Pulumi.AzureNative.Authorization.V20201001
{
    public static class GetRoleManagementPolicy
    {
        ...
        public static Task<GetRoleManagementPolicyResult> InvokeAsync(GetRoleManagementPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRoleManagementPolicyResult>("azure-native:authorization/v20201001:getRoleManagementPolicy", args ?? new GetRoleManagementPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetRoleManagementPolicyResult> Invoke(GetRoleManagementPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRoleManagementPolicyResult>("azure-native:authorization/v20201001:getRoleManagementPolicy", args ?? new GetRoleManagementPolicyInvokeArgs(), options.WithDefaults());
    }
