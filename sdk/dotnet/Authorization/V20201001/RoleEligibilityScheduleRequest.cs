...
namespace Pulumi.AzureNative.Authorization.V20201001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20201001:RoleEligibilityScheduleRequest")]
    public partial class RoleEligibilityScheduleRequest : global::Pulumi.CustomResource
    {
        ...
        public RoleEligibilityScheduleRequest(string name, RoleEligibilityScheduleRequestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20201001:RoleEligibilityScheduleRequest", name, args ?? new RoleEligibilityScheduleRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleEligibilityScheduleRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20201001:RoleEligibilityScheduleRequest", name, null, MakeResourceOptions(options, id))
        {
        }
