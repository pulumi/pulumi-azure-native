...
namespace Pulumi.AzureNative.Authorization.V20201001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20201001:RoleManagementPolicy")]
    public partial class RoleManagementPolicy : global::Pulumi.CustomResource
    {
        ...
        public RoleManagementPolicy(string name, RoleManagementPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20201001:RoleManagementPolicy", name, args ?? new RoleManagementPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleManagementPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20201001:RoleManagementPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
