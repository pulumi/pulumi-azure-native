...
namespace Pulumi.AzureNative.Authorization.V20201001
{
    ...
    public partial class RoleManagementPolicyAssignment : global::Pulumi.CustomResource
    {
        ...
        public RoleManagementPolicyAssignment(string name, RoleManagementPolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20201001:RoleManagementPolicyAssignment", name, args ?? new RoleManagementPolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleManagementPolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20201001:RoleManagementPolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
