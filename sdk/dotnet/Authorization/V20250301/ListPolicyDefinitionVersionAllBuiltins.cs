...
namespace Pulumi.AzureNative.Authorization.V20250301
{
    public static class ListPolicyDefinitionVersionAllBuiltins
    {
        ...
        public static Task<ListPolicyDefinitionVersionAllBuiltinsResult> InvokeAsync(ListPolicyDefinitionVersionAllBuiltinsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListPolicyDefinitionVersionAllBuiltinsResult>("azure-native:authorization/v20250301:listPolicyDefinitionVersionAllBuiltins", args ?? new ListPolicyDefinitionVersionAllBuiltinsArgs(), options.WithDefaults());

        /// <summary>
        /// This operation lists all the built-in policy definition versions for all built-in policy definitions.
        /// </summary>
        public static Output<ListPolicyDefinitionVersionAllBuiltinsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListPolicyDefinitionVersionAllBuiltinsResult>("azure-native:authorization/v20250301:listPolicyDefinitionVersionAllBuiltins", InvokeArgs.Empty, options.WithDefaults());
