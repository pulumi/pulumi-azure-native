...
namespace Pulumi.AzureNative.Authorization.V20250301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20250301:PolicyAssignment")]
    public partial class PolicyAssignment : global::Pulumi.CustomResource
    {
        ...
        public PolicyAssignment(string name, PolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250301:PolicyAssignment", name, args ?? new PolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250301:PolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20250301.AssignmentType>? AssignmentType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20250301.EnforcementMode>? EnforcementMode { get; set; }
