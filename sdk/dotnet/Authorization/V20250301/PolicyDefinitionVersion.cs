...
namespace Pulumi.AzureNative.Authorization.V20250301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20250301:PolicyDefinitionVersion")]
    public partial class PolicyDefinitionVersion : global::Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionVersion(string name, PolicyDefinitionVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250301:PolicyDefinitionVersion", name, args ?? new PolicyDefinitionVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250301:PolicyDefinitionVersion", name, null, MakeResourceOptions(options, id))
        {
        }
