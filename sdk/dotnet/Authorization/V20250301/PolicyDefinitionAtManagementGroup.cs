...
namespace Pulumi.AzureNative.Authorization.V20250301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20250301:PolicyDefinitionAtManagementGroup")]
    public partial class PolicyDefinitionAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("externalEvaluationEnforcementSettings")]
        public Output<Outputs.ExternalEvaluationEnforcementSettingsResponse?> ExternalEvaluationEnforcementSettings { get; private set; } = null!;
        ...
        public PolicyDefinitionAtManagementGroup(string name, PolicyDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250301:PolicyDefinitionAtManagementGroup", name, args ?? new PolicyDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250301:PolicyDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyDefinitionAtManagementGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// The details of the source of external evaluation results required by the policy during enforcement evaluation.
        /// </summary>
        [Input("externalEvaluationEnforcementSettings")]
        public Input<Inputs.ExternalEvaluationEnforcementSettingsArgs>? ExternalEvaluationEnforcementSettings { get; set; }
        ...
        /// </summary>
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20250301.PolicyType>? PolicyType { get; set; }
