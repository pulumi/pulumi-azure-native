...
namespace Pulumi.AzureNative.Authorization.V20241201Preview
{
    public static class GetVariableValue
    {
        ...
        public static Task<GetVariableValueResult> InvokeAsync(GetVariableValueArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVariableValueResult>("azure-native:authorization/v20241201preview:getVariableValue", args ?? new GetVariableValueArgs(), options.WithDefaults());

        /// <summary>
        /// This operation retrieves a single variable value; given its name, subscription it was created at and the variable it's created for.
        /// </summary>
        public static Output<GetVariableValueResult> Invoke(GetVariableValueInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVariableValueResult>("azure-native:authorization/v20241201preview:getVariableValue", args ?? new GetVariableValueInvokeArgs(), options.WithDefaults());
