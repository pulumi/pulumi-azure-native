...
namespace Pulumi.AzureNative.Authorization.V20241201Preview
{
    ...
    /// The variable value.
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20241201preview:VariableValueAtManagementGroup")]
    public partial class VariableValueAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public VariableValueAtManagementGroup(string name, VariableValueAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20241201preview:VariableValueAtManagementGroup", name, args ?? new VariableValueAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VariableValueAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20241201preview:VariableValueAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
