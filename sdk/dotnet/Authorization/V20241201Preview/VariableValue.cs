...
namespace Pulumi.AzureNative.Authorization.V20241201Preview
{
    ...
    /// The variable value.
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20241201preview:VariableValue")]
    public partial class VariableValue : global::Pulumi.CustomResource
    {
        ...
        public VariableValue(string name, VariableValueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20241201preview:VariableValue", name, args ?? new VariableValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VariableValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20241201preview:VariableValue", name, null, MakeResourceOptions(options, id))
        {
        }
