...
namespace Pulumi.AzureNative.Authorization.V20241201Preview
{
    ...
    /// The variable.
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20241201preview:Variable")]
    public partial class Variable : global::Pulumi.CustomResource
    {
        ...
        public Variable(string name, VariableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20241201preview:Variable", name, args ?? new VariableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Variable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20241201preview:Variable", name, null, MakeResourceOptions(options, id))
        {
        }
