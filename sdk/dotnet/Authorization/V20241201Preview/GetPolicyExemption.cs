...
namespace Pulumi.AzureNative.Authorization.V20241201Preview
{
    public static class GetPolicyExemption
    {
        ...
        public static Task<GetPolicyExemptionResult> InvokeAsync(GetPolicyExemptionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicyExemptionResult>("azure-native:authorization/v20241201preview:getPolicyExemption", args ?? new GetPolicyExemptionArgs(), options.WithDefaults());

        /// <summary>
        /// This operation retrieves a single policy exemption, given its name and the scope it was created at.
        /// </summary>
        public static Output<GetPolicyExemptionResult> Invoke(GetPolicyExemptionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPolicyExemptionResult>("azure-native:authorization/v20241201preview:getPolicyExemption", args ?? new GetPolicyExemptionInvokeArgs(), options.WithDefaults());
