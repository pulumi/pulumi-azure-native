...
namespace Pulumi.AzureNative.Authorization.V20241201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20241201preview:PolicyExemption")]
    public partial class PolicyExemption : global::Pulumi.CustomResource
    {
        ...
        public PolicyExemption(string name, PolicyExemptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20241201preview:PolicyExemption", name, args ?? new PolicyExemptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyExemption(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20241201preview:PolicyExemption", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyExemptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20241201Preview.AssignmentScopeValidation>? AssignmentScopeValidation { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20241201Preview.ExemptionCategory> ExemptionCategory { get; set; } = null!;
