...
namespace Pulumi.AzureNative.Authorization.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20240501:PolicyDefinitionVersion")]
    public partial class PolicyDefinitionVersion : global::Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionVersion(string name, PolicyDefinitionVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240501:PolicyDefinitionVersion", name, args ?? new PolicyDefinitionVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240501:PolicyDefinitionVersion", name, null, MakeResourceOptions(options, id))
        {
        }
