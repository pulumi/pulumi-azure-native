...
namespace Pulumi.AzureNative.Authorization.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20240501:PolicySetDefinitionVersion")]
    public partial class PolicySetDefinitionVersion : global::Pulumi.CustomResource
    {
        ...
        public PolicySetDefinitionVersion(string name, PolicySetDefinitionVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240501:PolicySetDefinitionVersion", name, args ?? new PolicySetDefinitionVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinitionVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240501:PolicySetDefinitionVersion", name, null, MakeResourceOptions(options, id))
        {
        }
