...
namespace Pulumi.AzureNative.Authorization.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20240501:PolicyDefinitionVersionAtManagementGroup")]
    public partial class PolicyDefinitionVersionAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionVersionAtManagementGroup(string name, PolicyDefinitionVersionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240501:PolicyDefinitionVersionAtManagementGroup", name, args ?? new PolicyDefinitionVersionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionVersionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240501:PolicyDefinitionVersionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
