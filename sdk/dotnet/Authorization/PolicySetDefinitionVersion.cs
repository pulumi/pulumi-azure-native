...
namespace Pulumi.AzureNative.Authorization
{
    ...
    public partial class PolicySetDefinitionVersion : global::Pulumi.CustomResource
    {
        ...
        public PolicySetDefinitionVersion(string name, PolicySetDefinitionVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization:PolicySetDefinitionVersion", name, args ?? new PolicySetDefinitionVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinitionVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization:PolicySetDefinitionVersion", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20230401:PolicySetDefinitionVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20240501:PolicySetDefinitionVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20250101:PolicySetDefinitionVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20250301:PolicySetDefinitionVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20251101:PolicySetDefinitionVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20251201preview:PolicySetDefinitionVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20260101preview:PolicySetDefinitionVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20260601:PolicySetDefinitionVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20260701:PolicySetDefinitionVersion" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PolicySetDefinitionVersion Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new PolicySetDefinitionVersion(name, id, options);
        }
    }

    public sealed class PolicySetDefinitionVersionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The policy set definition description.
        /// </summary>
        ...
        public PolicySetDefinitionVersionArgs()
        {
        }
        public static new PolicySetDefinitionVersionArgs Empty => new PolicySetDefinitionVersionArgs();
    }
}
