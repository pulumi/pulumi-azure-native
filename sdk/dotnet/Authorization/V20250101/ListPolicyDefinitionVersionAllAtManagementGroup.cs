...
namespace Pulumi.AzureNative.Authorization.V20250101
{
    public static class ListPolicyDefinitionVersionAllAtManagementGroup
    {
        ...
        public static Task<ListPolicyDefinitionVersionAllAtManagementGroupResult> InvokeAsync(ListPolicyDefinitionVersionAllAtManagementGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListPolicyDefinitionVersionAllAtManagementGroupResult>("azure-native:authorization/v20250101:listPolicyDefinitionVersionAllAtManagementGroup", args ?? new ListPolicyDefinitionVersionAllAtManagementGroupArgs(), options.WithDefaults());
        ...
        public static Output<ListPolicyDefinitionVersionAllAtManagementGroupResult> Invoke(ListPolicyDefinitionVersionAllAtManagementGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListPolicyDefinitionVersionAllAtManagementGroupResult>("azure-native:authorization/v20250101:listPolicyDefinitionVersionAllAtManagementGroup", args ?? new ListPolicyDefinitionVersionAllAtManagementGroupInvokeArgs(), options.WithDefaults());
    }
