...
namespace Pulumi.AzureNative.Authorization.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20250101:PolicySetDefinitionAtManagementGroup")]
    public partial class PolicySetDefinitionAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public PolicySetDefinitionAtManagementGroup(string name, PolicySetDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250101:PolicySetDefinitionAtManagementGroup", name, args ?? new PolicySetDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250101:PolicySetDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
