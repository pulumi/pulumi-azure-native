...
namespace Pulumi.AzureNative.Authorization.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20250101:PolicySetDefinitionVersion")]
    public partial class PolicySetDefinitionVersion : global::Pulumi.CustomResource
    {
        ...
        public PolicySetDefinitionVersion(string name, PolicySetDefinitionVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250101:PolicySetDefinitionVersion", name, args ?? new PolicySetDefinitionVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinitionVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250101:PolicySetDefinitionVersion", name, null, MakeResourceOptions(options, id))
        {
        }
