...
namespace Pulumi.AzureNative.Authorization.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20250101:PolicySetDefinitionVersionAtManagementGroup")]
    public partial class PolicySetDefinitionVersionAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public PolicySetDefinitionVersionAtManagementGroup(string name, PolicySetDefinitionVersionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250101:PolicySetDefinitionVersionAtManagementGroup", name, args ?? new PolicySetDefinitionVersionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinitionVersionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250101:PolicySetDefinitionVersionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
