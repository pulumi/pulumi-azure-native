...
namespace Pulumi.AzureNative.Authorization.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20250101:PolicyDefinitionVersion")]
    public partial class PolicyDefinitionVersion : global::Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionVersion(string name, PolicyDefinitionVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250101:PolicyDefinitionVersion", name, args ?? new PolicyDefinitionVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20250101:PolicyDefinitionVersion", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyDefinitionVersionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20250101.PolicyType>? PolicyType { get; set; }
