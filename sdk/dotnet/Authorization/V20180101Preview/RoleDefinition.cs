...
namespace Pulumi.AzureNative.Authorization.V20180101Preview
{
    ...
    public partial class RoleDefinition : global::Pulumi.CustomResource
    {
        ...
        public RoleDefinition(string name, RoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20180101preview:RoleDefinition", name, args ?? new RoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20180101preview:RoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
