...
namespace Pulumi.AzureRM.Authorization.V20180101Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var roleAssignment = new AzureRM.Authorization.V20180101Preview.RoleAssignment("roleAssignment", new AzureRM.Authorization.V20180101Preview.RoleAssignmentArgs
    ///         {
    ///             CanDelegate = false,
    ...
    public partial class RoleAssignment : Pulumi.CustomResource
    {
        ...
        public RoleAssignment(string name, RoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20180101preview:RoleAssignment", name, args ?? new RoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20180101preview:RoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
