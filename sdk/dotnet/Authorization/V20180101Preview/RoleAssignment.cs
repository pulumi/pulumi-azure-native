...
namespace Pulumi.AzureNative.Authorization.V20180101Preview
{
    ...
    /// Role Assignments
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20180101preview:RoleAssignment")]
    public partial class RoleAssignment : Pulumi.CustomResource
    {
        ...
        public RoleAssignment(string name, RoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20180101preview:RoleAssignment", name, args ?? new RoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20180101preview:RoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
