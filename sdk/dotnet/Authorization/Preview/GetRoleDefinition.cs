...
namespace Pulumi.AzureRM.Authorization.Preview
{
    public static class GetRoleDefinition
    {
        public static Task<GetRoleDefinitionResult> InvokeAsync(GetRoleDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRoleDefinitionResult>("azurerm:authorization/preview:getRoleDefinition", args ?? new GetRoleDefinitionArgs(), options.WithVersion());
    }
