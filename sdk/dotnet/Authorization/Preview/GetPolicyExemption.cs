...
namespace Pulumi.AzureRM.Authorization.Preview
{
    public static class GetPolicyExemption
    {
        public static Task<GetPolicyExemptionResult> InvokeAsync(GetPolicyExemptionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPolicyExemptionResult>("azurerm:authorization/preview:getPolicyExemption", args ?? new GetPolicyExemptionArgs(), options.WithVersion());
    }
