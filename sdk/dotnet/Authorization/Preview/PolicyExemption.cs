...
namespace Pulumi.AzureRM.Authorization.Preview
{
    ...
    public partial class PolicyExemption : Pulumi.CustomResource
    {
        ...
        public PolicyExemption(string name, PolicyExemptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization/preview:PolicyExemption", name, args ?? new PolicyExemptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyExemption(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:authorization/preview:PolicyExemption", name, null, MakeResourceOptions(options, id))
        {
        }
