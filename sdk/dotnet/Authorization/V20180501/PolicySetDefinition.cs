...
namespace Pulumi.AzureRM.Authorization.V20180501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policySetDefinition = new AzureRM.Authorization.V20180501.PolicySetDefinition("policySetDefinition", new AzureRM.Authorization.V20180501.PolicySetDefinitionArgs
    ///         {
    ...
    ///             PolicyDefinitions = 
    ///             {
    ///                 new AzureRM.Authorization.V20180501.Inputs.PolicyDefinitionReferenceArgs
    ///                 {
    ///                     Parameters = 
    ///                     {
    ///                         { "listOfAllowedSKUs", 
    ...
    public partial class PolicySetDefinition : Pulumi.CustomResource
    {
        ...
        public PolicySetDefinition(string name, PolicySetDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20180501:PolicySetDefinition", name, args ?? new PolicySetDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20180501:PolicySetDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
