...
namespace Pulumi.AzureNextGen.Authorization.V20180501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:authorization/v20180501:PolicySetDefinition")]
    public partial class PolicySetDefinition : Pulumi.CustomResource
    {
        ...
        public PolicySetDefinition(string name, PolicySetDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20180501:PolicySetDefinition", name, args ?? new PolicySetDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20180501:PolicySetDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
