...
namespace Pulumi.AzureRM.Authorization.V20180501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policyAssignment = new AzureRM.Authorization.V20180501.PolicyAssignment("policyAssignment", new AzureRM.Authorization.V20180501.PolicyAssignmentArgs
    ///         {
    ...
    ///             Description = "Force resource names to begin with given DeptA and end with -LC",
    ///             DisplayName = "Enforce resource naming rules",
    ///             Identity = new AzureRM.Authorization.V20180501.Inputs.IdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "eastus",
    ...
    public partial class PolicyAssignment : Pulumi.CustomResource
    {
        ...
        public PolicyAssignment(string name, PolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20180501:PolicyAssignment", name, args ?? new PolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20180501:PolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
