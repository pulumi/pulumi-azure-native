...
namespace Pulumi.AzureNextGen.Authorization.V20180501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:authorization/v20180501:PolicyDefinition")]
    public partial class PolicyDefinition : Pulumi.CustomResource
    {
        ...
        public PolicyDefinition(string name, PolicyDefinitionArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20180501:PolicyDefinition", name, args ?? new PolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20180501:PolicyDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNextGen.Authorization.V20180501.PolicyMode>? Mode { get; set; }
