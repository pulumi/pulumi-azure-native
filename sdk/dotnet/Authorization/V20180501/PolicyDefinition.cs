...
namespace Pulumi.AzureNative.Authorization.V20180501
{
    ...
    /// {
    ///     var policyDefinition = new AzureNative.Authorization.V20180501.PolicyDefinition("policyDefinition", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20180501:PolicyDefinition")]
    public partial class PolicyDefinition : global::Pulumi.CustomResource
    {
        ...
        public PolicyDefinition(string name, PolicyDefinitionArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20180501:PolicyDefinition", name, args ?? new PolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20180501:PolicyDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20180501.PolicyMode>? Mode { get; set; }
