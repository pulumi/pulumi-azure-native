...
namespace Pulumi.AzureNextGen.Authorization.V20180501
{
    public static class GetPolicyDefinition
    {
        public static Task<GetPolicyDefinitionResult> InvokeAsync(GetPolicyDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPolicyDefinitionResult>("azure-nextgen:authorization/v20180501:getPolicyDefinition", args ?? new GetPolicyDefinitionArgs(), options.WithVersion());
    }
