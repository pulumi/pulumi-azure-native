...
namespace Pulumi.AzureNative.Authorization.V20171001Preview
{
    ...
    /// {
    ///     var roleAssignment = new AzureNative.Authorization.V20171001Preview.RoleAssignment("roleAssignment", new()
    ///     {
    ///         CanDelegate = false,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20171001preview:RoleAssignment")]
    public partial class RoleAssignment : global::Pulumi.CustomResource
    {
        ...
        public RoleAssignment(string name, RoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20171001preview:RoleAssignment", name, args ?? new RoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20171001preview:RoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
