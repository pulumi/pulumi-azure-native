...
namespace Pulumi.AzureRM.Authorization.V20190101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policySetDefinition = new AzureRM.Authorization.V20190101.PolicySetDefinition("policySetDefinition", new AzureRM.Authorization.V20190101.PolicySetDefinitionArgs
    ///         {
    ...
    ///             PolicyDefinitions = 
    ///             {
    ///                 new AzureRM.Authorization.V20190101.Inputs.PolicyDefinitionReferenceArgs
    ///                 {
    ///                     Parameters = 
    ///                     {
    ///                         { "listOfAllowedSKUs", 
