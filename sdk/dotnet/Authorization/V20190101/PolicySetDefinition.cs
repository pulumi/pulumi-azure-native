...
namespace Pulumi.AzureRM.Authorization.V20190101
{
    ...
    public partial class PolicySetDefinition : Pulumi.CustomResource
    {
        ...
        public PolicySetDefinition(string name, PolicySetDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20190101:PolicySetDefinition", name, args ?? new PolicySetDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20190101:PolicySetDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:authorization/v20180301:PolicySetDefinition"},
                    new Alias { Type = "azurerm:authorization/v20180501:PolicySetDefinition"},
                    new Alias { Type = "azurerm:authorization/v20190601:PolicySetDefinition"},
                    new Alias { Type = "azurerm:authorization/v20190901:PolicySetDefinition"},
                },
            };
