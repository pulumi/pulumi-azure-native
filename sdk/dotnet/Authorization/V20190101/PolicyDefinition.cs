...
namespace Pulumi.AzureNative.Authorization.V20190101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20190101:PolicyDefinition")]
    public partial class PolicyDefinition : Pulumi.CustomResource
    {
        ...
        public PolicyDefinition(string name, PolicyDefinitionArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20190101:PolicyDefinition", name, args ?? new PolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20190101:PolicyDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
