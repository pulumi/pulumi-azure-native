...
namespace Pulumi.AzureNative.Authorization.V20190101
{
    ...
    [AzureNativeResourceType("azure-native:authorization/v20190101:PolicyAssignment")]
    public partial class PolicyAssignment : global::Pulumi.CustomResource
    {
        ...
        public PolicyAssignment(string name, PolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20190101:PolicyAssignment", name, args ?? new PolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20190101:PolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
