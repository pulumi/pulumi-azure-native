...
namespace Pulumi.AzureNextGen.Authorization.V20190601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:authorization/v20190601:PolicyDefinitionAtManagementGroup")]
    public partial class PolicyDefinitionAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionAtManagementGroup(string name, PolicyDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20190601:PolicyDefinitionAtManagementGroup", name, args ?? new PolicyDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20190601:PolicyDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
