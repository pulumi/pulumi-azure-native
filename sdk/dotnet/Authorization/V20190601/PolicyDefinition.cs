...
namespace Pulumi.AzureNextGen.Authorization.V20190601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:authorization/v20190601:PolicyDefinition")]
    ...
    public sealed class PolicyDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNextGen.Authorization.V20190601.PolicyType>? PolicyType { get; set; }
