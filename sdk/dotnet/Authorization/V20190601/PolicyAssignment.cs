...
namespace Pulumi.AzureRM.Authorization.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policyAssignment = new AzureRM.Authorization.V20190601.PolicyAssignment("policyAssignment", new AzureRM.Authorization.V20190601.PolicyAssignmentArgs
    ///         {
    ...
    ///             Identity = new AzureRM.Authorization.V20190601.Inputs.IdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "eastus",
    ...
    public partial class PolicyAssignment : Pulumi.CustomResource
    {
        ...
        public PolicyAssignment(string name, PolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20190601:PolicyAssignment", name, args ?? new PolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20190601:PolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
