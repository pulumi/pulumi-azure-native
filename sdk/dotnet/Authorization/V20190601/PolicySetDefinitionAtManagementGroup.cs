...
namespace Pulumi.AzureNative.Authorization.V20190601
{
    ...
    /// {
    ///     var policySetDefinitionAtManagementGroup = new AzureNative.Authorization.V20190601.PolicySetDefinitionAtManagementGroup("policySetDefinitionAtManagementGroup", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20190601:PolicySetDefinitionAtManagementGroup")]
    public partial class PolicySetDefinitionAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public PolicySetDefinitionAtManagementGroup(string name, PolicySetDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20190601:PolicySetDefinitionAtManagementGroup", name, args ?? new PolicySetDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20190601:PolicySetDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
