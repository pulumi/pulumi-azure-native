...
namespace Pulumi.AzureRM.Authorization.V20190601
{
    public static class GetPolicyDefinition
    {
        public static Task<GetPolicyDefinitionResult> InvokeAsync(GetPolicyDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPolicyDefinitionResult>("azurerm:authorization/v20190601:getPolicyDefinition", args ?? new GetPolicyDefinitionArgs(), options.WithVersion());
    }
