...
namespace Pulumi.AzureNextGen.Authorization.V20180901Preview
{
    ...
    /// Role Assignments
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:authorization/v20180901preview:RoleAssignment")]
    public partial class RoleAssignment : Pulumi.CustomResource
    {
        ...
        public RoleAssignment(string name, RoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20180901preview:RoleAssignment", name, args ?? new RoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20180901preview:RoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RoleAssignmentArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("principalType")]
        public InputUnion<string, Pulumi.AzureNextGen.Authorization.V20180901Preview.PrincipalType>? PrincipalType { get; set; }
