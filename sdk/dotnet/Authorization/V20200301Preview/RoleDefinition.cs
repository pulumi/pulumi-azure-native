...
namespace Pulumi.AzureNative.Authorization.V20200301Preview
{
    ...
    /// Role definition.
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20200301preview:RoleDefinition")]
    public partial class RoleDefinition : Pulumi.CustomResource
    {
        ...
        public RoleDefinition(string name, RoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200301preview:RoleDefinition", name, args ?? new RoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200301preview:RoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
