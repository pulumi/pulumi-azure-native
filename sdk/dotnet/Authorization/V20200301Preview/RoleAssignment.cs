...
namespace Pulumi.AzureNextGen.Authorization.V20200301Preview
{
    ...
    /// Role Assignments
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:authorization/v20200301preview:RoleAssignment")]
    public partial class RoleAssignment : Pulumi.CustomResource
    {
        ...
        public RoleAssignment(string name, RoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20200301preview:RoleAssignment", name, args ?? new RoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20200301preview:RoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RoleAssignmentArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("principalType")]
        public InputUnion<string, Pulumi.AzureNextGen.Authorization.V20200301Preview.PrincipalType>? PrincipalType { get; set; }
