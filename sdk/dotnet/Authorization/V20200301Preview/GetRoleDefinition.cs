...
namespace Pulumi.AzureNative.Authorization.V20200301Preview
{
    public static class GetRoleDefinition
    {
        ...
        public static Task<GetRoleDefinitionResult> InvokeAsync(GetRoleDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRoleDefinitionResult>("azure-native:authorization/v20200301preview:getRoleDefinition", args ?? new GetRoleDefinitionArgs(), options.WithVersion());
    }
