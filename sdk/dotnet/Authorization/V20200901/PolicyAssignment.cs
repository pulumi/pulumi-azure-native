...
namespace Pulumi.AzureNative.Authorization.V20200901
{
    ...
    /// {
    ///     var policyAssignment = new AzureNative.Authorization.V20200901.PolicyAssignment("policyAssignment", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.Authorization.V20200901.Inputs.NonComplianceMessageArgs
    ///             {
    ...
    ///         Identity = new AzureNative.Authorization.V20200901.Inputs.IdentityArgs
    ///         {
    ///             Type = AzureNative.Authorization.V20200901.ResourceIdentityType.SystemAssigned,
    ///         },
    ///         Location = "eastus",
    ///         Metadata = 
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20200901:PolicyAssignment")]
    public partial class PolicyAssignment : global::Pulumi.CustomResource
    {
        ...
        public PolicyAssignment(string name, PolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200901:PolicyAssignment", name, args ?? new PolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200901:PolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20200901.EnforcementMode>? EnforcementMode { get; set; }
