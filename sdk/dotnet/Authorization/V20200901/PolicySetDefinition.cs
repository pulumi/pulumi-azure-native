...
namespace Pulumi.AzureNative.Authorization.V20200901
{
    ...
    /// {
    ///     var policySetDefinition = new AzureNative.Authorization.V20200901.PolicySetDefinition("policySetDefinition", new()
    ///     {
    ...
    ///         Parameters = 
    ///         {
    ///             { "namePrefix", new AzureNative.Authorization.V20200901.Inputs.ParameterDefinitionsValueArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20200901:PolicySetDefinition")]
    public partial class PolicySetDefinition : global::Pulumi.CustomResource
    {
        ...
        public PolicySetDefinition(string name, PolicySetDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200901:PolicySetDefinition", name, args ?? new PolicySetDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200901:PolicySetDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
