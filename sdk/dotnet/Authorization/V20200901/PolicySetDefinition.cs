...
namespace Pulumi.AzureNextGen.Authorization.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:authorization/v20200901:PolicySetDefinition")]
    public partial class PolicySetDefinition : Pulumi.CustomResource
    {
        ...
        public PolicySetDefinition(string name, PolicySetDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20200901:PolicySetDefinition", name, args ?? new PolicySetDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20200901:PolicySetDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
