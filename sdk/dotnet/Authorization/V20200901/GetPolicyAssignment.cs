...
namespace Pulumi.AzureNative.Authorization.V20200901
{
    public static class GetPolicyAssignment
    {
        ...
        public static Task<GetPolicyAssignmentResult> InvokeAsync(GetPolicyAssignmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPolicyAssignmentResult>("azure-native:authorization/v20200901:getPolicyAssignment", args ?? new GetPolicyAssignmentArgs(), options.WithVersion());

        /// <summary>
        /// The policy assignment.
        /// </summary>
        public static Output<GetPolicyAssignmentResult> Invoke(GetPolicyAssignmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPolicyAssignmentResult>("azure-native:authorization/v20200901:getPolicyAssignment", args ?? new GetPolicyAssignmentInvokeArgs(), options.WithVersion());
    }
