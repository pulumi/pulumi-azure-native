...
namespace Pulumi.AzureNative.Authorization.V20200901
{
    ...
    /// {
    ///     var policyDefinition = new AzureNative.Authorization.V20200901.PolicyDefinition("policyDefinition", new()
    ///     {
    ...
    ///         Parameters = 
    ///         {
    ///             { "prefix", new AzureNative.Authorization.V20200901.Inputs.ParameterDefinitionsValueArgs
    ///             {
    ///                 Metadata = new AzureNative.Authorization.V20200901.Inputs.ParameterDefinitionsValueMetadataArgs
    ///                 {
    ...
    ///                 Type = "String",
    ///             } },
    ///             { "suffix", new AzureNative.Authorization.V20200901.Inputs.ParameterDefinitionsValueArgs
    ///             {
    ///                 Metadata = new AzureNative.Authorization.V20200901.Inputs.ParameterDefinitionsValueMetadataArgs
    ///                 {
    ...
    ///         Parameters = 
    ///         {
    ///             { "requiredRetentionDays", new AzureNative.Authorization.V20200901.Inputs.ParameterDefinitionsValueArgs
    ///             {
    ///                 AllowedValues = new[]
    ///                 {
    ///                     0,
