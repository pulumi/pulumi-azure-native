...
namespace Pulumi.AzureNative.Authorization.V20211201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById")]
    public partial class AccessReviewScheduleDefinitionById : global::Pulumi.CustomResource
    {
        ...
        public AccessReviewScheduleDefinitionById(string name, AccessReviewScheduleDefinitionByIdArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById", name, args ?? new AccessReviewScheduleDefinitionByIdArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessReviewScheduleDefinitionById(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById", name, null, MakeResourceOptions(options, id))
        {
        }
