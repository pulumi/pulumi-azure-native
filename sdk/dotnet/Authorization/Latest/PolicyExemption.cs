...
namespace Pulumi.AzureRM.Authorization.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policyExemption = new AzureRM.Authorization.Latest.PolicyExemption("policyExemption", new AzureRM.Authorization.Latest.PolicyExemptionArgs
    ///         {
    ...
    public partial class PolicyExemption : Pulumi.CustomResource
    {
        ...
        public PolicyExemption(string name, PolicyExemptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization/latest:PolicyExemption", name, args ?? new PolicyExemptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyExemption(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:authorization/latest:PolicyExemption", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:authorization/v20200701preview:PolicyExemption"},
                },
            };
