...
namespace Pulumi.AzureNative.Authorization.V20210301Preview
{
    /// <summary>
    /// Access Review Schedule Definition.
    /// </summary>
    [Obsolete(@"azure-native:authorization/v20210301preview:AccessReviewScheduleDefinitionById is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById to guarantee forwards compatibility.")]
    ...
    public partial class AccessReviewScheduleDefinitionById : global::Pulumi.CustomResource
    {
        ...
        public AccessReviewScheduleDefinitionById(string name, AccessReviewScheduleDefinitionByIdArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20210301preview:AccessReviewScheduleDefinitionById", name, args ?? new AccessReviewScheduleDefinitionByIdArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessReviewScheduleDefinitionById(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20210301preview:AccessReviewScheduleDefinitionById", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccessReviewScheduleDefinitionByIdArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20210301Preview.DefaultDecisionType>? DefaultDecision { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20210301Preview.AccessReviewRecurrenceRangeType>? Type { get; set; }
