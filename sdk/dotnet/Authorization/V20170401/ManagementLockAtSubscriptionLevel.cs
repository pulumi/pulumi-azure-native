...
namespace Pulumi.AzureNative.Authorization.V20170401
{
    ...
    /// {
    ///     var managementLockAtSubscriptionLevel = new AzureNative.Authorization.V20170401.ManagementLockAtSubscriptionLevel("managementLockAtSubscriptionLevel", new()
    ///     {
    ///         Level = "ReadOnly",
    ///         LockName = "testlock",
    ///     });
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:authorization/v20170401:ManagementLockAtSubscriptionLevel testlock /subscriptions/subscriptionId/resourceGroups/resourcegroupname/providers/Microsoft.Authorization/locks/testlock 
    /// ```
    /// </summary>
    ...
    public partial class ManagementLockAtSubscriptionLevel : global::Pulumi.CustomResource
    {
        ...
        public ManagementLockAtSubscriptionLevel(string name, ManagementLockAtSubscriptionLevelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20170401:ManagementLockAtSubscriptionLevel", name, args ?? new ManagementLockAtSubscriptionLevelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementLockAtSubscriptionLevel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20170401:ManagementLockAtSubscriptionLevel", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:authorization:ManagementLockAtSubscriptionLevel"},
