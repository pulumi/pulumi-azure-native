...
namespace Pulumi.AzureNative.Authorization.V20170401
{
    public static class GetManagementLockByScope
    {
        ...
        public static Task<GetManagementLockByScopeResult> InvokeAsync(GetManagementLockByScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagementLockByScopeResult>("azure-native:authorization/v20170401:getManagementLockByScope", args ?? new GetManagementLockByScopeArgs(), options.WithVersion());
        ...
        public static Output<GetManagementLockByScopeResult> Invoke(GetManagementLockByScopeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetManagementLockByScopeResult>("azure-native:authorization/v20170401:getManagementLockByScope", args ?? new GetManagementLockByScopeInvokeArgs(), options.WithVersion());
    }
