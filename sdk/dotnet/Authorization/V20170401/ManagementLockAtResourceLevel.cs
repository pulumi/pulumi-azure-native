...
namespace Pulumi.AzureNative.Authorization.V20170401
{
    ...
    /// {
    ///     var managementLockAtResourceLevel = new AzureNative.Authorization.V20170401.ManagementLockAtResourceLevel("managementLockAtResourceLevel", new()
    ///     {
    ///         Level = "ReadOnly",
    ///         LockName = "testlock",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:authorization/v20170401:ManagementLockAtResourceLevel testlock /subscriptions/subscriptionId/resourceGroups/resourcegroupname/providers/Microsoft.Authorization/locks/testlock 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20170401:ManagementLockAtResourceLevel")]
    public partial class ManagementLockAtResourceLevel : global::Pulumi.CustomResource
    {
        ...
        public ManagementLockAtResourceLevel(string name, ManagementLockAtResourceLevelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20170401:ManagementLockAtResourceLevel", name, args ?? new ManagementLockAtResourceLevelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementLockAtResourceLevel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20170401:ManagementLockAtResourceLevel", name, null, MakeResourceOptions(options, id))
        {
        }
