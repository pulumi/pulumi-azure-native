...
namespace Pulumi.AzureRM.Authorization
{
    ...
    public partial class PolicyDefinition : Pulumi.CustomResource
    {
        ...
        public PolicyDefinition(string name, PolicyDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization:PolicyDefinition", name, args ?? new PolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinition(string name, Input<string> id, PolicyDefinitionState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:authorization:PolicyDefinition", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PolicyDefinition Get(string name, Input<string> id, PolicyDefinitionState? state = null, CustomResourceOptions? options = null)
        {
            return new PolicyDefinition(name, id, state, options);
        }
    }
    ...
    public sealed class PolicyDefinitionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the policy definition.
        /// </summary>
        ...
        public Input<Inputs.PolicyDefinitionPropertiesResponseGetArgs> Properties { get; set; } = null!;
