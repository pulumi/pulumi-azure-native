...
namespace Pulumi.AzureNative.Authorization.V20161201
{
    ...
    [AzureNativeResourceType("azure-native:authorization/v20161201:PolicyAssignment")]
    public partial class PolicyAssignment : Pulumi.CustomResource
    {
        ...
        public PolicyAssignment(string name, PolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20161201:PolicyAssignment", name, args ?? new PolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20161201:PolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
