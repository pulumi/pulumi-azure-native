...
namespace Pulumi.AzureNative.Authorization.V20161201
{
    ...
    /// </summary>
    [Obsolete(@"Version v20161201 will be removed in the next major version of the provider. Upgrade to version v20170401 or later.")]
    ...
    public partial class PolicyDefinitionAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionAtManagementGroup(string name, PolicyDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20161201:PolicyDefinitionAtManagementGroup", name, args ?? new PolicyDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20161201:PolicyDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyDefinitionAtManagementGroupArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20161201.PolicyMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20161201.PolicyType>? PolicyType { get; set; }
