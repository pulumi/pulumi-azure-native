...
namespace Pulumi.AzureNative.Authorization.V20161201
{
    ...
    public static class GetPolicyDefinition
    {
        ...
        public static Task<GetPolicyDefinitionResult> InvokeAsync(GetPolicyDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPolicyDefinitionResult>("azure-native:authorization/v20161201:getPolicyDefinition", args ?? new GetPolicyDefinitionArgs(), options.WithDefaults());

        /// <summary>
        /// The policy definition.
        /// </summary>
        public static Output<GetPolicyDefinitionResult> Invoke(GetPolicyDefinitionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPolicyDefinitionResult>("azure-native:authorization/v20161201:getPolicyDefinition", args ?? new GetPolicyDefinitionInvokeArgs(), options.WithDefaults());
    }
