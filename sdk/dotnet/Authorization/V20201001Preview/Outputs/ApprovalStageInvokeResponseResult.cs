...
namespace Pulumi.AzureNextGen.Authorization.V20201001Preview.Outputs
{
    ...
    [OutputType]
    public sealed class ApprovalStageInvokeResponseResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.SingleUserInvokeResponseResult> EscalationApprovers;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.SingleUserInvokeResponseResult> PrimaryApprovers;

        [OutputConstructor]
        private ApprovalStageInvokeResponseResult(
            int? approvalStageTimeOutInDays,

            ImmutableArray<Outputs.SingleUserInvokeResponseResult> escalationApprovers,
            ...
            ImmutableArray<Outputs.SingleUserInvokeResponseResult> primaryApprovers)
        {
