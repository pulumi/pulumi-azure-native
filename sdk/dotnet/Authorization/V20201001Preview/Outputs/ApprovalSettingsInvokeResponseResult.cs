...
namespace Pulumi.AzureNextGen.Authorization.V20201001Preview.Outputs
{
    ...
    [OutputType]
    public sealed class ApprovalSettingsInvokeResponseResult
    {
        /// <summary>
        /// The type of rule
        /// </summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.ApprovalStageInvokeResponseResult> ApprovalStages;
        /// <summary>
        ...
        [OutputConstructor]
        private ApprovalSettingsInvokeResponseResult(
            string? approvalMode,

            ImmutableArray<Outputs.ApprovalStageInvokeResponseResult> approvalStages,
