...
namespace Pulumi.AzureNextGen.Authorization.V20201001Preview.Outputs
{
    ...
    [OutputType]
    public sealed class RoleManagementPolicyAuthenticationContextRuleInvokeResponseResult
    {
        /// <summary>
        /// The claim value.
        /// </summary>
        ...
        [OutputConstructor]
        private RoleManagementPolicyAuthenticationContextRuleInvokeResponseResult(
            string? claimValue,
