...
namespace Pulumi.AzureNative.Authorization.V20201001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20201001preview:RoleEligibilityScheduleRequest")]
    public partial class RoleEligibilityScheduleRequest : global::Pulumi.CustomResource
    {
        ...
        public RoleEligibilityScheduleRequest(string name, RoleEligibilityScheduleRequestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20201001preview:RoleEligibilityScheduleRequest", name, args ?? new RoleEligibilityScheduleRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleEligibilityScheduleRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20201001preview:RoleEligibilityScheduleRequest", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RoleEligibilityScheduleRequestArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20201001Preview.RequestType> RequestType { get; set; } = null!;
