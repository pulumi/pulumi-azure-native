...
namespace Pulumi.AzureNextGen.Authorization
{
    ...
    public partial class RoleDefinition : Pulumi.CustomResource
    {
        ...
        public RoleDefinition(string name, RoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization:RoleDefinition", name, args ?? new RoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization:RoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
