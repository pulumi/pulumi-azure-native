...
namespace Pulumi.AzureNative.Authorization
{
    ...
    public partial class RoleDefinition : global::Pulumi.CustomResource
    {
        ...
        public RoleDefinition(string name, RoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization:RoleDefinition", name, args ?? new RoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization:RoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_authorization_v20150701:authorization:RoleDefinition" },
                    new global::Pulumi.Alias { Type = "azure-native_authorization_v20180101preview:authorization:RoleDefinition" },
                    new global::Pulumi.Alias { Type = "azure-native_authorization_v20220401:authorization:RoleDefinition" },
                    new global::Pulumi.Alias { Type = "azure-native_authorization_v20220501preview:authorization:RoleDefinition" },
                },
            };
