...
namespace Pulumi.AzureNative.Authorization.V20160901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20160901:ManagementLockAtResourceLevel")]
    public partial class ManagementLockAtResourceLevel : Pulumi.CustomResource
    {
        ...
        public ManagementLockAtResourceLevel(string name, ManagementLockAtResourceLevelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20160901:ManagementLockAtResourceLevel", name, args ?? new ManagementLockAtResourceLevelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementLockAtResourceLevel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20160901:ManagementLockAtResourceLevel", name, null, MakeResourceOptions(options, id))
        {
        }
