...
namespace Pulumi.AzureRM.Authorization.V20160901
{
    ...
    public partial class ManagementLockAtResourceGroupLevel : Pulumi.CustomResource
    {
        ...
        public ManagementLockAtResourceGroupLevel(string name, ManagementLockAtResourceGroupLevelArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20160901:ManagementLockAtResourceGroupLevel", name, args ?? new ManagementLockAtResourceGroupLevelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementLockAtResourceGroupLevel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20160901:ManagementLockAtResourceGroupLevel", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:authorization/v20150101:ManagementLockAtResourceGroupLevel"},
                },
            };
