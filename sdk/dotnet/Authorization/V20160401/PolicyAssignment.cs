...
namespace Pulumi.AzureNextGen.Authorization.V20160401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:authorization/v20160401:PolicyAssignment")]
    public partial class PolicyAssignment : Pulumi.CustomResource
    {
        ...
        public PolicyAssignment(string name, PolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20160401:PolicyAssignment", name, args ?? new PolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20160401:PolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
