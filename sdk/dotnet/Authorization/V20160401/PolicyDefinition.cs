...
namespace Pulumi.AzureNextGen.Authorization.V20160401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:authorization/v20160401:PolicyDefinition")]
    ...
    public sealed class PolicyDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNextGen.Authorization.V20160401.PolicyType>? PolicyType { get; set; }
