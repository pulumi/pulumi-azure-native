...
namespace Pulumi.AzureNative.Authorization.V20230401
{
    public static class ListPolicyDefinitionVersionAllBuiltins
    {
        ...
        public static Task<ListPolicyDefinitionVersionAllBuiltinsResult> InvokeAsync(ListPolicyDefinitionVersionAllBuiltinsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListPolicyDefinitionVersionAllBuiltinsResult>("azure-native:authorization/v20230401:listPolicyDefinitionVersionAllBuiltins", args ?? new ListPolicyDefinitionVersionAllBuiltinsArgs(), options.WithDefaults());
