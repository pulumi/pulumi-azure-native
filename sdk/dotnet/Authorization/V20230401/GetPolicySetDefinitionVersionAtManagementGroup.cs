...
namespace Pulumi.AzureNative.Authorization.V20230401
{
    public static class GetPolicySetDefinitionVersionAtManagementGroup
    {
        ...
        public static Task<GetPolicySetDefinitionVersionAtManagementGroupResult> InvokeAsync(GetPolicySetDefinitionVersionAtManagementGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicySetDefinitionVersionAtManagementGroupResult>("azure-native:authorization/v20230401:getPolicySetDefinitionVersionAtManagementGroup", args ?? new GetPolicySetDefinitionVersionAtManagementGroupArgs(), options.WithDefaults());
        ...
        public static Output<GetPolicySetDefinitionVersionAtManagementGroupResult> Invoke(GetPolicySetDefinitionVersionAtManagementGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPolicySetDefinitionVersionAtManagementGroupResult>("azure-native:authorization/v20230401:getPolicySetDefinitionVersionAtManagementGroup", args ?? new GetPolicySetDefinitionVersionAtManagementGroupInvokeArgs(), options.WithDefaults());
