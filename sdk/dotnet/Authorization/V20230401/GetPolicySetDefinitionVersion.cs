...
namespace Pulumi.AzureNative.Authorization.V20230401
{
    public static class GetPolicySetDefinitionVersion
    {
        ...
        public static Task<GetPolicySetDefinitionVersionResult> InvokeAsync(GetPolicySetDefinitionVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicySetDefinitionVersionResult>("azure-native:authorization/v20230401:getPolicySetDefinitionVersion", args ?? new GetPolicySetDefinitionVersionArgs(), options.WithDefaults());
        ...
        public static Output<GetPolicySetDefinitionVersionResult> Invoke(GetPolicySetDefinitionVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPolicySetDefinitionVersionResult>("azure-native:authorization/v20230401:getPolicySetDefinitionVersion", args ?? new GetPolicySetDefinitionVersionInvokeArgs(), options.WithDefaults());
    }
