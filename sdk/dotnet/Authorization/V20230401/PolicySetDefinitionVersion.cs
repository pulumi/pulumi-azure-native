...
namespace Pulumi.AzureNative.Authorization.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20230401:PolicySetDefinitionVersion")]
    public partial class PolicySetDefinitionVersion : global::Pulumi.CustomResource
    {
        ...
        public PolicySetDefinitionVersion(string name, PolicySetDefinitionVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20230401:PolicySetDefinitionVersion", name, args ?? new PolicySetDefinitionVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinitionVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20230401:PolicySetDefinitionVersion", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:authorization:PolicySetDefinitionVersion"},
                },
            };
