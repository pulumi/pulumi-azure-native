...
namespace Pulumi.AzureNative.Authorization.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20230401:PolicyDefinitionVersion")]
    public partial class PolicyDefinitionVersion : global::Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionVersion(string name, PolicyDefinitionVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20230401:PolicyDefinitionVersion", name, args ?? new PolicyDefinitionVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20230401:PolicyDefinitionVersion", name, null, MakeResourceOptions(options, id))
        {
        }
