...
namespace Pulumi.AzureNative.Authorization.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20230401:PolicySetDefinition")]
    public partial class PolicySetDefinition : global::Pulumi.CustomResource
    {
        ...
        public PolicySetDefinition(string name, PolicySetDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20230401:PolicySetDefinition", name, args ?? new PolicySetDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20230401:PolicySetDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
