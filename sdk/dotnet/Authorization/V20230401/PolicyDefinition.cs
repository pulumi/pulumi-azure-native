...
namespace Pulumi.AzureNative.Authorization.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20230401:PolicyDefinition")]
    public partial class PolicyDefinition : global::Pulumi.CustomResource
    {
        ...
        public PolicyDefinition(string name, PolicyDefinitionArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20230401:PolicyDefinition", name, args ?? new PolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20230401:PolicyDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
