...
namespace Pulumi.AzureNative.Authorization.V20210601
{
    ...
    /// {
    ///     var policyDefinition = new AzureNative.Authorization.V20210601.PolicyDefinition("policyDefinition", new()
    ///     {
    ...
    ///         Parameters = 
    ///         {
    ///             { "prefix", new AzureNative.Authorization.V20210601.Inputs.ParameterDefinitionsValueArgs
    ///             {
    ///                 Metadata = new AzureNative.Authorization.V20210601.Inputs.ParameterDefinitionsValueMetadataArgs
    ///                 {
    ...
    ///                 Type = "String",
    ///             } },
    ///             { "suffix", new AzureNative.Authorization.V20210601.Inputs.ParameterDefinitionsValueArgs
    ///             {
    ///                 Metadata = new AzureNative.Authorization.V20210601.Inputs.ParameterDefinitionsValueMetadataArgs
    ///                 {
    ...
    ///         Parameters = 
    ///         {
    ///             { "requiredRetentionDays", new AzureNative.Authorization.V20210601.Inputs.ParameterDefinitionsValueArgs
    ///             {
    ///                 AllowedValues = new[]
    ///                 {
    ///                     0,
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:authorization/v20210601:PolicyDefinition ResourceNaming /subscriptions/ae640e6b-ba3e-4256-9d62-2993eecfa6f2/providers/Microsoft.Authorization/policyDefinitions/ResourceNaming 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20210601:PolicyDefinition")]
    public partial class PolicyDefinition : global::Pulumi.CustomResource
    {
        ...
        public PolicyDefinition(string name, PolicyDefinitionArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20210601:PolicyDefinition", name, args ?? new PolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20210601:PolicyDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
