...
namespace Pulumi.AzureNative.Authorization.V20210601
{
    ...
    /// {
    ///     var policySetDefinitionAtManagementGroup = new AzureNative.Authorization.V20210601.PolicySetDefinitionAtManagementGroup("policySetDefinitionAtManagementGroup", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.Authorization.V20210601.Inputs.PolicyDefinitionReferenceArgs
    ///             {
    ///                 Parameters = 
    ///                 {
    ///                     { "listOfAllowedSKUs", new AzureNative.Authorization.V20210601.Inputs.ParameterValuesValueArgs
    ///                     {
    ///                         Value = new[]
    ///                         {
    ///                             "Standard_GRS",
    ...
    ///                 Parameters = 
    ///                 {
    ///                     { "prefix", new AzureNative.Authorization.V20210601.Inputs.ParameterValuesValueArgs
    ///                     {
    ///                         Value = "DeptA",
    ///                     } },
    ///                     { "suffix", new AzureNative.Authorization.V20210601.Inputs.ParameterValuesValueArgs
    ///                     {
    ///                         Value = "-LC",
    ///                     } },
    ///                 },
    ...
    ///         {
    ///             new AzureNative.Authorization.V20210601.Inputs.PolicyDefinitionGroupArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:authorization/v20210601:PolicySetDefinitionAtManagementGroup CostManagement /providers/Microsoft.Management/managementgroups/MyManagementGroup/providers/Microsoft.Authorization/policySetDefinitions/CostManagement 
    /// ```
    /// </summary>
    ...
    public partial class PolicySetDefinitionAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public PolicySetDefinitionAtManagementGroup(string name, PolicySetDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20210601:PolicySetDefinitionAtManagementGroup", name, args ?? new PolicySetDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20210601:PolicySetDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicySetDefinitionAtManagementGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20210601.PolicyType>? PolicyType { get; set; }
