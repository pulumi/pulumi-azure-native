...
namespace Pulumi.AzureNative.Authorization.V20210601
{
    ...
    /// {
    ///     var policyDefinitionAtManagementGroup = new AzureNative.Authorization.V20210601.PolicyDefinitionAtManagementGroup("policyDefinitionAtManagementGroup", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20210601:PolicyDefinitionAtManagementGroup")]
    public partial class PolicyDefinitionAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionAtManagementGroup(string name, PolicyDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20210601:PolicyDefinitionAtManagementGroup", name, args ?? new PolicyDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20210601:PolicyDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
