...
namespace Pulumi.AzureNative.Authorization.V20200501
{
    ...
    /// {
    ///     var managementLockAtSubscriptionLevel = new AzureNative.Authorization.V20200501.ManagementLockAtSubscriptionLevel("managementLockAtSubscriptionLevel", new()
    ///     {
    ///         Level = "ReadOnly",
    ///         LockName = "testlock",
    ///     });
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20200501:ManagementLockAtSubscriptionLevel")]
    public partial class ManagementLockAtSubscriptionLevel : global::Pulumi.CustomResource
    {
        ...
        public ManagementLockAtSubscriptionLevel(string name, ManagementLockAtSubscriptionLevelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200501:ManagementLockAtSubscriptionLevel", name, args ?? new ManagementLockAtSubscriptionLevelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementLockAtSubscriptionLevel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200501:ManagementLockAtSubscriptionLevel", name, null, MakeResourceOptions(options, id))
        {
        }
