...
namespace Pulumi.AzureNative.Authorization.V20200501
{
    ...
    /// {
    ///     var privateLinkAssociation = new AzureNative.Authorization.V20200501.PrivateLinkAssociation("privateLinkAssociation", new()
    ///     {
    ///         GroupId = "my-management-group",
    ///         PlaId = "00000000-0000-0000-0000-000000000000",
    ///         Properties = new AzureNative.Authorization.V20200501.Inputs.PrivateLinkAssociationPropertiesArgs
    ///         {
    ...
    public partial class PrivateLinkAssociation : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.PrivateLinkAssociationPropertiesExpandedResponse> Properties { get; private set; } = null!;
        ...
        public PrivateLinkAssociation(string name, PrivateLinkAssociationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200501:PrivateLinkAssociation", name, args ?? new PrivateLinkAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200501:PrivateLinkAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PrivateLinkAssociation Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class PrivateLinkAssociationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.PrivateLinkAssociationPropertiesArgs>? Properties { get; set; }
