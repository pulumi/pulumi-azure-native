...
namespace Pulumi.AzureNative.Authorization.V20200501
{
    ...
    /// {
    ///     var managementLockAtResourceGroupLevel = new AzureNative.Authorization.V20200501.ManagementLockAtResourceGroupLevel("managementLockAtResourceGroupLevel", new()
    ///     {
    ///         Level = "ReadOnly",
    ///         LockName = "testlock",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:authorization/v20200501:ManagementLockAtResourceGroupLevel testlock /subscriptions/subscriptionId/resourceGroups/resourcegroupname/providers/Microsoft.Authorization/locks/testlock 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20200501:ManagementLockAtResourceGroupLevel")]
    public partial class ManagementLockAtResourceGroupLevel : global::Pulumi.CustomResource
    {
        ...
        public ManagementLockAtResourceGroupLevel(string name, ManagementLockAtResourceGroupLevelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200501:ManagementLockAtResourceGroupLevel", name, args ?? new ManagementLockAtResourceGroupLevelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementLockAtResourceGroupLevel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200501:ManagementLockAtResourceGroupLevel", name, null, MakeResourceOptions(options, id))
        {
        }
