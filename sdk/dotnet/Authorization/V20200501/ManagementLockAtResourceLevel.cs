...
namespace Pulumi.AzureNative.Authorization.V20200501
{
    ...
    /// {
    ///     var managementLockAtResourceLevel = new AzureNative.Authorization.V20200501.ManagementLockAtResourceLevel("managementLockAtResourceLevel", new()
    ///     {
    ///         Level = "ReadOnly",
    ///         LockName = "testlock",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20200501:ManagementLockAtResourceLevel")]
    public partial class ManagementLockAtResourceLevel : global::Pulumi.CustomResource
    {
        ...
        public ManagementLockAtResourceLevel(string name, ManagementLockAtResourceLevelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200501:ManagementLockAtResourceLevel", name, args ?? new ManagementLockAtResourceLevelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementLockAtResourceLevel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200501:ManagementLockAtResourceLevel", name, null, MakeResourceOptions(options, id))
        {
        }
