...
namespace Pulumi.AzureNative.Authorization.V20200501
{
    ...
    /// {
    ///     var managementLockByScope = new AzureNative.Authorization.V20200501.ManagementLockByScope("managementLockByScope", new()
    ///     {
    ///         Level = "ReadOnly",
    ///         LockName = "testlock",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20200501:ManagementLockByScope")]
    public partial class ManagementLockByScope : global::Pulumi.CustomResource
    {
        ...
        public ManagementLockByScope(string name, ManagementLockByScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200501:ManagementLockByScope", name, args ?? new ManagementLockByScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementLockByScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200501:ManagementLockByScope", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20170401:ManagementLockByScope"},
                },
            };
    ...
    public sealed class ManagementLockByScopeArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20200501.LockLevel> Level { get; set; } = null!;
