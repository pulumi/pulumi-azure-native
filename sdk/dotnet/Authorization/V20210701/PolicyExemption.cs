...
namespace Pulumi.AzureNative.Authorization.V20210701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20210701:PolicyExemption")]
    public partial class PolicyExemption : Pulumi.CustomResource
    {
        ...
        public PolicyExemption(string name, PolicyExemptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20210701:PolicyExemption", name, args ?? new PolicyExemptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyExemption(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20210701:PolicyExemption", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyExemptionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20210701.ExemptionCategory> ExemptionCategory { get; set; } = null!;
