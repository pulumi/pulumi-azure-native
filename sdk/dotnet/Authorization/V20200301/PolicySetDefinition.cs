...
namespace Pulumi.AzureNative.Authorization.V20200301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20200301:PolicySetDefinition")]
    public partial class PolicySetDefinition : Pulumi.CustomResource
    {
        ...
        public PolicySetDefinition(string name, PolicySetDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200301:PolicySetDefinition", name, args ?? new PolicySetDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20200301:PolicySetDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
