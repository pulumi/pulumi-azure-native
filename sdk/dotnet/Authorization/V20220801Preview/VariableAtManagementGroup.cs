...
namespace Pulumi.AzureNative.Authorization.V20220801Preview
{
    ...
    public partial class VariableAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public VariableAtManagementGroup(string name, VariableAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20220801preview:VariableAtManagementGroup", name, args ?? new VariableAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VariableAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20220801preview:VariableAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
