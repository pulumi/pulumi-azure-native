...
namespace Pulumi.AzureNative.Authorization.V20220801Preview
{
    ...
    public partial class VariableValueAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public VariableValueAtManagementGroup(string name, VariableValueAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20220801preview:VariableValueAtManagementGroup", name, args ?? new VariableValueAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VariableValueAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20220801preview:VariableValueAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
