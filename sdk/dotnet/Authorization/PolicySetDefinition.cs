...
namespace Pulumi.AzureRM.Authorization
{
    ...
    public partial class PolicySetDefinition : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.PolicySetDefinitionPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public PolicySetDefinition(string name, PolicySetDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization:PolicySetDefinition", name, args ?? new PolicySetDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private PolicySetDefinition(string name, Input<string> id, PolicySetDefinitionState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:authorization:PolicySetDefinition", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicySetDefinitionState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.PolicySetDefinitionPropertiesResponseGetArgs> Properties { get; set; } = null!;
