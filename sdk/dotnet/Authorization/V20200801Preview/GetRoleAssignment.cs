...
namespace Pulumi.AzureNative.Authorization.V20200801Preview
{
    public static class GetRoleAssignment
    {
        ...
        public static Task<GetRoleAssignmentResult> InvokeAsync(GetRoleAssignmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRoleAssignmentResult>("azure-native:authorization/v20200801preview:getRoleAssignment", args ?? new GetRoleAssignmentArgs(), options.WithDefaults());

        /// <summary>
        /// Role Assignments
        /// </summary>
        public static Output<GetRoleAssignmentResult> Invoke(GetRoleAssignmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRoleAssignmentResult>("azure-native:authorization/v20200801preview:getRoleAssignment", args ?? new GetRoleAssignmentInvokeArgs(), options.WithDefaults());
    }
