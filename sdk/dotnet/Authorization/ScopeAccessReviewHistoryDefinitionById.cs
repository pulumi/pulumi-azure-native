...
namespace Pulumi.AzureNative.Authorization
{
    ...
    public partial class ScopeAccessReviewHistoryDefinitionById : global::Pulumi.CustomResource
    {
        ...
        public ScopeAccessReviewHistoryDefinitionById(string name, ScopeAccessReviewHistoryDefinitionByIdArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization:ScopeAccessReviewHistoryDefinitionById", name, args ?? new ScopeAccessReviewHistoryDefinitionByIdArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeAccessReviewHistoryDefinitionById(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization:ScopeAccessReviewHistoryDefinitionById", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_authorization_v20211201preview:authorization:ScopeAccessReviewHistoryDefinitionById" },
                },
            };
