...
namespace Pulumi.AzureNative.Authorization
{
    ...
    public partial class ResourceManagementPrivateLink : Pulumi.CustomResource
    {
        ...
        [Output("properties")]
        public Output<Outputs.ResourceManagementPrivateLinkEndpointConnectionsResponse> Properties { get; private set; } = null!;
        ...
        public ResourceManagementPrivateLink(string name, ResourceManagementPrivateLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization:ResourceManagementPrivateLink", name, args ?? new ResourceManagementPrivateLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceManagementPrivateLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization:ResourceManagementPrivateLink", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:authorization:ResourceManagementPrivateLink"},
                    new Pulumi.Alias { Type = "azure-native:authorization/v20200501:ResourceManagementPrivateLink"},
                    new Pulumi.Alias { Type = "azure-nextgen:authorization/v20200501:ResourceManagementPrivateLink"},
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceManagementPrivateLink Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
