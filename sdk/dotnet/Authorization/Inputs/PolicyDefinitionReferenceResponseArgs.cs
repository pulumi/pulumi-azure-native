...
namespace Pulumi.AzureRM.Authorization.Inputs
{
    ...
    /// </summary>
    public sealed class PolicyDefinitionReferenceResponseArgs : Pulumi.ResourceArgs
    {
        [Input("groupNames")]
        ...
        /// </summary>
        [Input("parameters")]
        public Input<Inputs.ParameterValuesResponseArgs>? Parameters { get; set; }
        ...
        public PolicyDefinitionReferenceResponseArgs()
        {
        }
    }
}
