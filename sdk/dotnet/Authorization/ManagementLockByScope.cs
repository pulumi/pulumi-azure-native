...
namespace Pulumi.AzureNative.Authorization
{
    ...
    public partial class ManagementLockByScope : global::Pulumi.CustomResource
    {
        ...
        public ManagementLockByScope(string name, ManagementLockByScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization:ManagementLockByScope", name, args ?? new ManagementLockByScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementLockByScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization:ManagementLockByScope", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_authorization_v20160901:authorization:ManagementLockByScope" },
                    new global::Pulumi.Alias { Type = "azure-native_authorization_v20170401:authorization:ManagementLockByScope" },
                    new global::Pulumi.Alias { Type = "azure-native_authorization_v20200501:authorization:ManagementLockByScope" },
                },
            };
