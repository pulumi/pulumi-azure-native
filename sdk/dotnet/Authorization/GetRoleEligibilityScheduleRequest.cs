...
namespace Pulumi.AzureNative.Authorization
{
    public static class GetRoleEligibilityScheduleRequest
    {
        ...
        public static Task<GetRoleEligibilityScheduleRequestResult> InvokeAsync(GetRoleEligibilityScheduleRequestArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRoleEligibilityScheduleRequestResult>("azure-native:authorization:getRoleEligibilityScheduleRequest", args ?? new GetRoleEligibilityScheduleRequestArgs(), options.WithDefaults());
        ...
        public static Output<GetRoleEligibilityScheduleRequestResult> Invoke(GetRoleEligibilityScheduleRequestInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRoleEligibilityScheduleRequestResult>("azure-native:authorization:getRoleEligibilityScheduleRequest", args ?? new GetRoleEligibilityScheduleRequestInvokeArgs(), options.WithDefaults());
