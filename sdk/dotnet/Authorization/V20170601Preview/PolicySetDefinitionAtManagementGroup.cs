...
namespace Pulumi.AzureNextGen.Authorization.V20170601Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:authorization/v20170601preview:PolicySetDefinitionAtManagementGroup")]
    public partial class PolicySetDefinitionAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public PolicySetDefinitionAtManagementGroup(string name, PolicySetDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20170601preview:PolicySetDefinitionAtManagementGroup", name, args ?? new PolicySetDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:authorization/v20170601preview:PolicySetDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicySetDefinitionAtManagementGroupArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNextGen.Authorization.V20170601Preview.PolicyType>? PolicyType { get; set; }
