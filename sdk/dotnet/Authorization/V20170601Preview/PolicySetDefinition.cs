...
namespace Pulumi.AzureNative.Authorization.V20170601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20170601preview:PolicySetDefinition")]
    public partial class PolicySetDefinition : Pulumi.CustomResource
    {
        ...
        public PolicySetDefinition(string name, PolicySetDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20170601preview:PolicySetDefinition", name, args ?? new PolicySetDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicySetDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20170601preview:PolicySetDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
