...
namespace Pulumi.AzureRM.Authorization.V20200401Preview
{
    /// <summary>
    /// Role Assignments
    /// </summary>
    public partial class RoleAssignment : Pulumi.CustomResource
    {
        ...
        public RoleAssignment(string name, RoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20200401preview:RoleAssignment", name, args ?? new RoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:authorization/v20200401preview:RoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
