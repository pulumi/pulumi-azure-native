...
namespace Pulumi.AzureNative.Authorization.V20240201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20240201preview:PimRoleEligibilitySchedule")]
    public partial class PimRoleEligibilitySchedule : global::Pulumi.CustomResource
    {
        ...
        public PimRoleEligibilitySchedule(string name, PimRoleEligibilityScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240201preview:PimRoleEligibilitySchedule", name, args ?? new PimRoleEligibilityScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PimRoleEligibilitySchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240201preview:PimRoleEligibilitySchedule", name, null, MakeResourceOptions(options, id))
        {
        }
