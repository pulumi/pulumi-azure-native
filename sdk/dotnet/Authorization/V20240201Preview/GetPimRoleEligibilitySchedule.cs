...
namespace Pulumi.AzureNative.Authorization.V20240201Preview
{
    public static class GetPimRoleEligibilitySchedule
    {
        ...
        public static Task<GetPimRoleEligibilityScheduleResult> InvokeAsync(GetPimRoleEligibilityScheduleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPimRoleEligibilityScheduleResult>("azure-native:authorization/v20240201preview:getPimRoleEligibilitySchedule", args ?? new GetPimRoleEligibilityScheduleArgs(), options.WithDefaults());
        ...
        public static Output<GetPimRoleEligibilityScheduleResult> Invoke(GetPimRoleEligibilityScheduleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPimRoleEligibilityScheduleResult>("azure-native:authorization/v20240201preview:getPimRoleEligibilitySchedule", args ?? new GetPimRoleEligibilityScheduleInvokeArgs(), options.WithDefaults());
