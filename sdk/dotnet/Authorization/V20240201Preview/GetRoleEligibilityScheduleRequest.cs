...
{
    public static class GetRoleEligibilityScheduleRequest
    {
        /// <summary>
        /// Get the specified role eligibility schedule request.
        /// </summary>
        public static Task<GetRoleEligibilityScheduleRequestResult> InvokeAsync(GetRoleEligibilityScheduleRequestArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRoleEligibilityScheduleRequestResult>("azure-native:authorization/v20240201preview:getRoleEligibilityScheduleRequest", args ?? new GetRoleEligibilityScheduleRequestArgs(), options.WithDefaults());

        /// <summary>
        /// Get the specified role eligibility schedule request.
        /// </summary>
        public static Output<GetRoleEligibilityScheduleRequestResult> Invoke(GetRoleEligibilityScheduleRequestInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRoleEligibilityScheduleRequestResult>("azure-native:authorization/v20240201preview:getRoleEligibilityScheduleRequest", args ?? new GetRoleEligibilityScheduleRequestInvokeArgs(), options.WithDefaults());

        /// <summary>
        /// Get the specified role eligibility schedule request.
        /// </summary>
        public static Output<GetRoleEligibilityScheduleRequestResult> Invoke(GetRoleEligibilityScheduleRequestInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetRoleEligibilityScheduleRequestResult>("azure-native:authorization/v20240201preview:getRoleEligibilityScheduleRequest", args ?? new GetRoleEligibilityScheduleRequestInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetRoleEligibilityScheduleRequestArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetRoleEligibilityScheduleRequestArgs()
        {
        }
        public static new GetRoleEligibilityScheduleRequestArgs Empty => new GetRoleEligibilityScheduleRequestArgs();
    }

    public sealed class GetRoleEligibilityScheduleRequestInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The name (guid) of the role eligibility schedule request to get.
        /// </summary>
        ...
        public GetRoleEligibilityScheduleRequestInvokeArgs()
        {
        }
        public static new GetRoleEligibilityScheduleRequestInvokeArgs Empty => new GetRoleEligibilityScheduleRequestInvokeArgs();
    }


    [OutputType]
    public sealed class GetRoleEligibilityScheduleRequestResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetRoleEligibilityScheduleRequestResult(
            string approvalId,
