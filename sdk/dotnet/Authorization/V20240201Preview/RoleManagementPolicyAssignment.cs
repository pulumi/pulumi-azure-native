...
namespace Pulumi.AzureNative.Authorization.V20240201Preview
{
    /// <summary>
    /// Role management policy
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20240201preview:RoleManagementPolicyAssignment")]
    public partial class RoleManagementPolicyAssignment : global::Pulumi.CustomResource
    {
        ...
        public RoleManagementPolicyAssignment(string name, RoleManagementPolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240201preview:RoleManagementPolicyAssignment", name, args ?? new RoleManagementPolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleManagementPolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240201preview:RoleManagementPolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
