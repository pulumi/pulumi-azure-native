...
namespace Pulumi.AzureNative.Authorization.V20240201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20240201preview:RoleEligibilityScheduleRequest")]
    public partial class RoleEligibilityScheduleRequest : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public RoleEligibilityScheduleRequest(string name, RoleEligibilityScheduleRequestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240201preview:RoleEligibilityScheduleRequest", name, args ?? new RoleEligibilityScheduleRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoleEligibilityScheduleRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20240201preview:RoleEligibilityScheduleRequest", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20201001:RoleEligibilityScheduleRequest" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20201001preview:RoleEligibilityScheduleRequest" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20220401preview:RoleEligibilityScheduleRequest" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization/v20240901preview:RoleEligibilityScheduleRequest" },
                    new global::Pulumi.Alias { Type = "azure-native:authorization:RoleEligibilityScheduleRequest" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RoleEligibilityScheduleRequest Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new RoleEligibilityScheduleRequest(name, id, options);
        }
    }

    public sealed class RoleEligibilityScheduleRequestArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The conditions on the role assignment. This limits the resources it can be assigned to. e.g.: @Resource[Microsoft.Storage/storageAccounts/blobServices/containers:ContainerName] StringEqualsIgnoreCase 'foo_storage_container'
        /// </summary>
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20240201Preview.RequestType> RequestType { get; set; } = null!;
        ...
        public RoleEligibilityScheduleRequestArgs()
        {
        }
        public static new RoleEligibilityScheduleRequestArgs Empty => new RoleEligibilityScheduleRequestArgs();
    }
}
