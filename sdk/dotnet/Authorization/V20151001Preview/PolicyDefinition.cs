...
azure-native:authorization/v20151001preview:PolicyDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20160401:PolicyDefinition to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:authorization/v20151001preview:PolicyDefinition")]
    public partial class PolicyDefinition : global::Pulumi.CustomResource
    {
        ...
        public PolicyDefinition(string name, PolicyDefinitionArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20151001preview:PolicyDefinition", name, args ?? new PolicyDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20151001preview:PolicyDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("policyType")]
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20151001Preview.PolicyType>? PolicyType { get; set; }
