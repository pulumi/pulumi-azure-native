...
namespace Pulumi.AzureNative.Authorization.V20190901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20190901:PolicyDefinitionAtManagementGroup")]
    public partial class PolicyDefinitionAtManagementGroup : Pulumi.CustomResource
    {
        ...
        public PolicyDefinitionAtManagementGroup(string name, PolicyDefinitionAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20190901:PolicyDefinitionAtManagementGroup", name, args ?? new PolicyDefinitionAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyDefinitionAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20190901:PolicyDefinitionAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
