...
namespace Pulumi.AzureNative.Authorization.V20190901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:authorization/v20190901:PolicyAssignment")]
    public partial class PolicyAssignment : global::Pulumi.CustomResource
    {
        ...
        public PolicyAssignment(string name, PolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20190901:PolicyAssignment", name, args ?? new PolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:authorization/v20190901:PolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Authorization.V20190901.EnforcementMode>? EnforcementMode { get; set; }
