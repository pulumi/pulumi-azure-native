...
namespace Pulumi.AzureRM.Authorization.V20190901
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policySetDefinition = new AzureRM.Authorization.V20190901.PolicySetDefinition("policySetDefinition", new AzureRM.Authorization.V20190901.PolicySetDefinitionArgs
    ///         {
    ...
    ///             Parameters = 
    ///             {
    ///                 { "namePrefix", new AzureRM.Authorization.V20190901.Inputs.ParameterDefinitionsValueArgs
    ///                 {
    ...
    ///             PolicyDefinitions = 
    ///             {
    ///                 new AzureRM.Authorization.V20190901.Inputs.PolicyDefinitionReferenceArgs
    ///                 {
    ///                     Parameters = 
    ///                     {
    ///                         { "listOfAllowedSKUs", new AzureRM.Authorization.V20190901.Inputs.ParameterValuesValueArgs
    ///                         {
    ///                             Value = 
    ///                             {
    ///                                 "Standard_GRS",
    ...
    ///                     Parameters = 
    ///                     {
    ///                         { "prefix", new AzureRM.Authorization.V20190901.Inputs.ParameterValuesValueArgs
    ///                         {
    ///                             Value = "[parameters('namePrefix')]",
    ///                         } },
    ///                         { "suffix", new AzureRM.Authorization.V20190901.Inputs.ParameterValuesValueArgs
    ///                         {
    ///                             Value = "-LC",
    ///                         } },
    ///                     },
    ...
    ///             {
    ///                 new AzureRM.Authorization.V20190901.Inputs.PolicyDefinitionGroupArgs
    ///                 {
