...
namespace Pulumi.AzureNative.Authorization.V20190901
{
    public static class GetPolicyDefinition
    {
        ...
        public static Task<GetPolicyDefinitionResult> InvokeAsync(GetPolicyDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPolicyDefinitionResult>("azure-native:authorization/v20190901:getPolicyDefinition", args ?? new GetPolicyDefinitionArgs(), options.WithVersion());

        /// <summary>
        /// The policy definition.
        /// </summary>
        public static Output<GetPolicyDefinitionResult> Invoke(GetPolicyDefinitionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPolicyDefinitionResult>("azure-native:authorization/v20190901:getPolicyDefinition", args ?? new GetPolicyDefinitionInvokeArgs(), options.WithVersion());
    }
