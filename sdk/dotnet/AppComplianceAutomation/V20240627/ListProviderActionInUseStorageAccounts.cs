...
namespace Pulumi.AzureNative.AppComplianceAutomation.V20240627
{
    public static class ListProviderActionInUseStorageAccounts
    {
        ...
        public static Task<ListProviderActionInUseStorageAccountsResult> InvokeAsync(ListProviderActionInUseStorageAccountsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListProviderActionInUseStorageAccountsResult>("azure-native:appcomplianceautomation/v20240627:listProviderActionInUseStorageAccounts", args ?? new ListProviderActionInUseStorageAccountsArgs(), options.WithDefaults());
        ...
        public static Output<ListProviderActionInUseStorageAccountsResult> Invoke(ListProviderActionInUseStorageAccountsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListProviderActionInUseStorageAccountsResult>("azure-native:appcomplianceautomation/v20240627:listProviderActionInUseStorageAccounts", args ?? new ListProviderActionInUseStorageAccountsInvokeArgs(), options.WithDefaults());
    }
