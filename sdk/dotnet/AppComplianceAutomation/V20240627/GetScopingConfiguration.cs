...
namespace Pulumi.AzureNative.AppComplianceAutomation.V20240627
{
    public static class GetScopingConfiguration
    {
        ...
        public static Task<GetScopingConfigurationResult> InvokeAsync(GetScopingConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScopingConfigurationResult>("azure-native:appcomplianceautomation/v20240627:getScopingConfiguration", args ?? new GetScopingConfigurationArgs(), options.WithDefaults());
