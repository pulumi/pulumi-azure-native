...
namespace Pulumi.AzureNative.AppComplianceAutomation.V20221116Preview
{
    /// <summary>
    ...
    public partial class Report : global::Pulumi.CustomResource
    {
        ...
        public Report(string name, ReportArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appcomplianceautomation/v20221116preview:Report", name, args ?? new ReportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Report(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appcomplianceautomation/v20221116preview:Report", name, null, MakeResourceOptions(options, id))
        {
        }
