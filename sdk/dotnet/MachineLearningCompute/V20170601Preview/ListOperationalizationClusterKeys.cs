...
namespace Pulumi.AzureNative.MachineLearningCompute.V20170601Preview
{
    public static class ListOperationalizationClusterKeys
    {
        ...
        public static Task<ListOperationalizationClusterKeysResult> InvokeAsync(ListOperationalizationClusterKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListOperationalizationClusterKeysResult>("azure-native:machinelearningcompute/v20170601preview:listOperationalizationClusterKeys", args ?? new ListOperationalizationClusterKeysArgs(), options.WithDefaults());
        ...
        public static Output<ListOperationalizationClusterKeysResult> Invoke(ListOperationalizationClusterKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListOperationalizationClusterKeysResult>("azure-native:machinelearningcompute/v20170601preview:listOperationalizationClusterKeys", args ?? new ListOperationalizationClusterKeysInvokeArgs(), options.WithDefaults());
    }
