...
namespace Pulumi.AzureRM.MachineLearningCompute.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var operationalizationCluster = new AzureRM.MachineLearningCompute.Latest.OperationalizationCluster("operationalizationCluster", new AzureRM.MachineLearningCompute.Latest.OperationalizationClusterArgs
    ///         {
    ///             ClusterName = "myCluster",
    ///             ClusterType = "ACS",
    ///             ContainerService = new AzureRM.MachineLearningCompute.Latest.Inputs.AcsClusterPropertiesArgs
    ///             {
    ///                 OrchestratorProperties = new AzureRM.MachineLearningCompute.Latest.Inputs.KubernetesClusterPropertiesArgs
    ///                 {
    ///                     ServicePrincipal = new AzureRM.MachineLearningCompute.Latest.Inputs.ServicePrincipalPropertiesArgs
    ///                     {
    ...
    ///             GlobalServiceConfiguration = new AzureRM.MachineLearningCompute.Latest.Inputs.GlobalServiceConfigurationArgs
    ///             {
    ///                 Ssl = new AzureRM.MachineLearningCompute.Latest.Inputs.SslConfigurationArgs
    ///                 {
    ...
    public partial class OperationalizationCluster : Pulumi.CustomResource
    {
        ...
        public OperationalizationCluster(string name, OperationalizationClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningcompute/latest:OperationalizationCluster", name, args ?? new OperationalizationClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OperationalizationCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningcompute/latest:OperationalizationCluster", name, null, MakeResourceOptions(options, id))
        {
        }
