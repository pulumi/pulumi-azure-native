...
namespace Pulumi.AzureRM.MachineLearningCompute.Latest
{
    public static class ListOperationalizationClusterKeys
    {
        public static Task<ListOperationalizationClusterKeysResult> InvokeAsync(ListOperationalizationClusterKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListOperationalizationClusterKeysResult>("azurerm:machinelearningcompute/latest:listOperationalizationClusterKeys", args ?? new ListOperationalizationClusterKeysArgs(), options.WithVersion());
    }
