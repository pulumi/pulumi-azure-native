...
namespace Pulumi.AzureRM.MachineLearningCompute.Preview
{
    public static class ListOperationalizationClusterKeys
    {
        public static Task<ListOperationalizationClusterKeysResult> InvokeAsync(ListOperationalizationClusterKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListOperationalizationClusterKeysResult>("azurerm:machinelearningcompute/preview:listOperationalizationClusterKeys", args ?? new ListOperationalizationClusterKeysArgs(), options.WithVersion());
    }
