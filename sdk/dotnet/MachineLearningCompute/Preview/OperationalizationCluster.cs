...
namespace Pulumi.AzureRM.MachineLearningCompute.Preview
{
    ...
    public partial class OperationalizationCluster : Pulumi.CustomResource
    {
        ...
        public OperationalizationCluster(string name, OperationalizationClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningcompute/preview:OperationalizationCluster", name, args ?? new OperationalizationClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OperationalizationCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningcompute/preview:OperationalizationCluster", name, null, MakeResourceOptions(options, id))
        {
        }
