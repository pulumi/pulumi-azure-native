...
namespace Pulumi.AzureNextGen.MachineLearningCompute.Inputs
{
    ...
    public sealed class AcsClusterPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("agentVmSize")]
        public InputUnion<string, Pulumi.AzureNextGen.MachineLearningCompute.AgentVMSizeTypes>? AgentVmSize { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.MachineLearningCompute.OrchestratorType> OrchestratorType { get; set; } = null!;
