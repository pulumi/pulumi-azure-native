...
namespace Pulumi.AzureNative.HDInsight.V20230415Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hdinsight/v20230415preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20230415preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20230415preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
