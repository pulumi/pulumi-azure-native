...
namespace Pulumi.AzureNative.HDInsight.V20230415Preview.Inputs
{
    ...
    public sealed class ClusterCreatePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.HDInsight.V20230415Preview.OSType>? OsType { get; set; }
        ...
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.HDInsight.V20230415Preview.Tier>? Tier { get; set; }
