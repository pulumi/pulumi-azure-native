...
namespace Pulumi.AzureNative.HDInsight.V20230601Preview
{
    ...
    /// The cluster.
    /// </summary>
    [AzureNativeResourceType("azure-native:hdinsight/v20230601preview:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20230601preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20230601preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
