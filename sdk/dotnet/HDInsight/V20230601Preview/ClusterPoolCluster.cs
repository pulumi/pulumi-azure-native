...
namespace Pulumi.AzureNative.HDInsight.V20230601Preview
{
    ...
    /// The cluster.
    /// </summary>
    [AzureNativeResourceType("azure-native:hdinsight/v20230601preview:ClusterPoolCluster")]
    public partial class ClusterPoolCluster : global::Pulumi.CustomResource
    {
        ...
        public ClusterPoolCluster(string name, ClusterPoolClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20230601preview:ClusterPoolCluster", name, args ?? new ClusterPoolClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterPoolCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20230601preview:ClusterPoolCluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:hdinsight:ClusterPoolCluster" },
