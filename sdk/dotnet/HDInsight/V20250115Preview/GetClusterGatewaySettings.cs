...
namespace Pulumi.AzureNative.HDInsight.V20250115Preview
{
    public static class GetClusterGatewaySettings
    {
        ...
        public static Task<GetClusterGatewaySettingsResult> InvokeAsync(GetClusterGatewaySettingsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterGatewaySettingsResult>("azure-native:hdinsight/v20250115preview:getClusterGatewaySettings", args ?? new GetClusterGatewaySettingsArgs(), options.WithDefaults());
        ...
        public static Output<GetClusterGatewaySettingsResult> Invoke(GetClusterGatewaySettingsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClusterGatewaySettingsResult>("azure-native:hdinsight/v20250115preview:getClusterGatewaySettings", args ?? new GetClusterGatewaySettingsInvokeArgs(), options.WithDefaults());
    ...
    public sealed class GetClusterGatewaySettingsResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.EntraUserInfoResponse> RestAuthEntraUsers;
        /// <summary>
        ...
        private GetClusterGatewaySettingsResult(
            ...
            ImmutableArray<Outputs.EntraUserInfoResponse> restAuthEntraUsers,
