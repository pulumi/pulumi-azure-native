...
namespace Pulumi.AzureRM.HDInsight.V20180601beta1
{
    ...
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hdinsight/v20180601beta1:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hdinsight/v20180601beta1:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
