...
namespace Pulumi.AzureRM.HDInsight.V20180601beta1
{
    ...
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hdinsight/v20180601beta1:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hdinsight/v20180601beta1:Application", name, null, MakeResourceOptions(options, id))
        {
        }
