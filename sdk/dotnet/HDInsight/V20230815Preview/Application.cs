...
namespace Pulumi.AzureNative.HDInsight.V20230815Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hdinsight/v20230815preview:Application")]
    public partial class Application : global::Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20230815preview:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20230815preview:Application", name, null, MakeResourceOptions(options, id))
        {
        }
