...
namespace Pulumi.AzureNative.HDInsight.V20230815Preview.Inputs
{
    ...
    public sealed class NetworkPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.HDInsight.V20230815Preview.OutboundDependenciesManagedType>? OutboundDependenciesManagedType { get; set; }

        /// <summary>
        /// Indicates whether or not private link is enabled.
        /// </summary>
        [Input("privateLink")]
        public InputUnion<string, Pulumi.AzureNative.HDInsight.V20230815Preview.PrivateLink>? PrivateLink { get; set; }

        /// <summary>
        /// The direction for the resource provider connection.
        /// </summary>
        [Input("resourceProviderConnection")]
        public InputUnion<string, Pulumi.AzureNative.HDInsight.V20230815Preview.ResourceProviderConnection>? ResourceProviderConnection { get; set; }
