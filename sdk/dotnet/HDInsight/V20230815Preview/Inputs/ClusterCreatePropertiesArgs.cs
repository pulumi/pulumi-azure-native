...
namespace Pulumi.AzureNative.HDInsight.V20230815Preview.Inputs
{
    ...
    public sealed class ClusterCreatePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.HDInsight.V20230815Preview.OSType>? OsType { get; set; }
        ...
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.HDInsight.V20230815Preview.Tier>? Tier { get; set; }
