...
namespace Pulumi.AzureNative.HDInsight.V20240501Preview
{
    ...
    /// The cluster.
    /// </summary>
    [AzureNativeResourceType("azure-native:hdinsight/v20240501preview:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20240501preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20240501preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
