...
namespace Pulumi.AzureNative.HDInsight.V20240501Preview
{
    ...
    /// The cluster.
    /// </summary>
    [AzureNativeResourceType("azure-native:hdinsight/v20240501preview:ClusterPoolCluster")]
    public partial class ClusterPoolCluster : global::Pulumi.CustomResource
    {
        ...
        public ClusterPoolCluster(string name, ClusterPoolClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20240501preview:ClusterPoolCluster", name, args ?? new ClusterPoolClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterPoolCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20240501preview:ClusterPoolCluster", name, null, MakeResourceOptions(options, id))
        {
        }
