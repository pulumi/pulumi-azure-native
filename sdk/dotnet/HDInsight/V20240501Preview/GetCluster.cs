...
namespace Pulumi.AzureNative.HDInsight.V20240501Preview
{
    public static class GetCluster
    {
        ...
        public static Task<GetClusterResult> InvokeAsync(GetClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterResult>("azure-native:hdinsight/v20240501preview:getCluster", args ?? new GetClusterArgs(), options.WithDefaults());
