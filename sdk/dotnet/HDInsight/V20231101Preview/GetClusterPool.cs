...
namespace Pulumi.AzureNative.HDInsight.V20231101Preview
{
    public static class GetClusterPool
    {
        ...
        public static Task<GetClusterPoolResult> InvokeAsync(GetClusterPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterPoolResult>("azure-native:hdinsight/v20231101preview:getClusterPool", args ?? new GetClusterPoolArgs(), options.WithDefaults());
