...
namespace Pulumi.AzureNative.HDInsight.V20231101Preview.Inputs
{
    ...
    public sealed class ScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.HDInsight.V20231101Preview.ScheduleDay>>? _days;

        /// <summary>
        /// User has to set the days where schedule has to be set for autoscale operation.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.HDInsight.V20231101Preview.ScheduleDay>> Days
        {
            get => _days ?? (_days = new InputList<Union<string, Pulumi.AzureNative.HDInsight.V20231101Preview.ScheduleDay>>());
            set => _days = value;
        }
