...
namespace Pulumi.AzureNative.HDInsight.V20150301Preview
{
    ...
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20150301preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20150301preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
