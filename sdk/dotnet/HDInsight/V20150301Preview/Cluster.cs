...
namespace Pulumi.AzureNextGen.HDInsight.V20150301Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:hdinsight/v20150301preview:Cluster")]
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:hdinsight/v20150301preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:hdinsight/v20150301preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
