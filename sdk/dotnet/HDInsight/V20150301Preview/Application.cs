...
namespace Pulumi.AzureRM.HDInsight.V20150301Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var application = new AzureRM.HDInsight.V20150301Preview.Application("application", new AzureRM.HDInsight.V20150301Preview.ApplicationArgs
    ///         {
    ///             ApplicationName = "hue",
    ...
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hdinsight/v20150301preview:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hdinsight/v20150301preview:Application", name, null, MakeResourceOptions(options, id))
        {
        }
