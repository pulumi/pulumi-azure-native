...
namespace Pulumi.AzureNative.HDInsight.V20240501
{
    /// <summary>
    /// The cluster.
    /// </summary>
    [AzureNativeResourceType("azure-native:hdinsight/v20240501:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20240501:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hdinsight/v20240501:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
