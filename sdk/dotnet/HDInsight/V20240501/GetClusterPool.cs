...
namespace Pulumi.AzureNative.HDInsight.V20240501
{
    public static class GetClusterPool
    {
        ...
        public static Task<GetClusterPoolResult> InvokeAsync(GetClusterPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterPoolResult>("azure-native:hdinsight/v20240501:getClusterPool", args ?? new GetClusterPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a cluster pool.
        /// </summary>
        public static Output<GetClusterPoolResult> Invoke(GetClusterPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClusterPoolResult>("azure-native:hdinsight/v20240501:getClusterPool", args ?? new GetClusterPoolInvokeArgs(), options.WithDefaults());
    }
