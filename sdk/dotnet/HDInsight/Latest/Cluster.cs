...
namespace Pulumi.AzureRM.HDInsight.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cluster = new AzureRM.HDInsight.Latest.Cluster("cluster", new AzureRM.HDInsight.Latest.ClusterArgs
    ///         {
    ...
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hdinsight/latest:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hdinsight/latest:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
