...
namespace Pulumi.AzureNative.HDInsight.V20210601.Inputs
{
    ...
    public sealed class ClusterCreatePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.HDInsight.V20210601.OSType>? OsType { get; set; }
        ...
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.HDInsight.V20210601.Tier>? Tier { get; set; }
