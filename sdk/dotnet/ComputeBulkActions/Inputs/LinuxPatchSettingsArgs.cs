...
namespace Pulumi.AzureNative.ComputeBulkActions.Inputs
{
    ...
    public sealed class LinuxPatchSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ComputeBulkActions.LinuxPatchAssessmentMode>? AssessmentMode { get; set; }
        ...
        /// </summary>
        [Input("patchMode")]
        public InputUnion<string, Pulumi.AzureNative.ComputeBulkActions.LinuxVMGuestPatchMode>? PatchMode { get; set; }
