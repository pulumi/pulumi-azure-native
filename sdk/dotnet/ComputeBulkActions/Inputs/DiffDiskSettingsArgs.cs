...
namespace Pulumi.AzureNative.ComputeBulkActions.Inputs
{
    ...
    public sealed class DiffDiskSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("option")]
        public InputUnion<string, Pulumi.AzureNative.ComputeBulkActions.DiffDiskOptions>? Option { get; set; }
        ...
        /// </summary>
        [Input("placement")]
        public InputUnion<string, Pulumi.AzureNative.ComputeBulkActions.DiffDiskPlacement>? Placement { get; set; }
