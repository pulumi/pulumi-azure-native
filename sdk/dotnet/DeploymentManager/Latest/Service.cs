...
namespace Pulumi.AzureRM.DeploymentManager.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var service = new AzureRM.DeploymentManager.Latest.Service("service", new AzureRM.DeploymentManager.Latest.ServiceArgs
    ///         {
    ///             Location = "centralus",
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/latest:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/latest:Service", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:deploymentmanager/v20191101preview:Service"},
                },
            };
