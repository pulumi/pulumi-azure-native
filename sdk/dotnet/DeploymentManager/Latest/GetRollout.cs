...
namespace Pulumi.AzureRM.DeploymentManager.Latest
{
    public static class GetRollout
    {
        public static Task<GetRolloutResult> InvokeAsync(GetRolloutArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRolloutResult>("azurerm:deploymentmanager/latest:getRollout", args ?? new GetRolloutArgs(), options.WithVersion());
    }
    ...
    public sealed class GetRolloutResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.StepGroupResponseResult> StepGroups;
        /// <summary>
        /// Resource tags.
        /// </summary>
        ...
        private GetRolloutResult(
            ...
            ImmutableArray<Outputs.StepGroupResponseResult> stepGroups,
