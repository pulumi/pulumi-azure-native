...
namespace Pulumi.AzureRM.DeploymentManager.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var rollout = new AzureRM.DeploymentManager.Latest.Rollout("rollout", new AzureRM.DeploymentManager.Latest.RolloutArgs
    ///         {
    ...
    ///             Identity = new AzureRM.DeploymentManager.Latest.Inputs.IdentityArgs
    ///             {
    ///                 IdentityIds = 
    ///                 {
    ...
    ///             StepGroups = 
    ///             {
    ///                 new AzureRM.DeploymentManager.Latest.Inputs.StepGroupArgs
    ///                 {
    ...
    ///                     PostDeploymentSteps = 
    ///                     {
    ///                         new AzureRM.DeploymentManager.Latest.Inputs.PrePostStepArgs
    ///                         {
    ...
    public partial class Rollout : Pulumi.CustomResource
    {
        ...
        public Rollout(string name, RolloutArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/latest:Rollout", name, args ?? new RolloutArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rollout(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/latest:Rollout", name, null, MakeResourceOptions(options, id))
        {
        }
