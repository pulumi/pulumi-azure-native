...
namespace Pulumi.AzureRM.DeploymentManager.Latest
{
    public static class GetServiceTopology
    {
        public static Task<GetServiceTopologyResult> InvokeAsync(GetServiceTopologyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceTopologyResult>("azurerm:deploymentmanager/latest:getServiceTopology", args ?? new GetServiceTopologyArgs(), options.WithVersion());
    }
