...
namespace Pulumi.AzureRM.DeploymentManager.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var step = new AzureRM.DeploymentManager.Latest.Step("step", new AzureRM.DeploymentManager.Latest.StepArgs
    ///         {
    ///             Location = "centralus",
    ...
    public partial class Step : Pulumi.CustomResource
    {
        ...
        public Step(string name, StepArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/latest:Step", name, args ?? new StepArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Step(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/latest:Step", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:deploymentmanager/v20191101preview:Step"},
                },
            };
