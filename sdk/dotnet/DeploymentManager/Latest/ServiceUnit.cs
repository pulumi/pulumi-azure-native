...
namespace Pulumi.AzureRM.DeploymentManager.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serviceUnit = new AzureRM.DeploymentManager.Latest.ServiceUnit("serviceUnit", new AzureRM.DeploymentManager.Latest.ServiceUnitArgs
    ///         {
    ///             Artifacts = new AzureRM.DeploymentManager.Latest.Inputs.ServiceUnitArtifactsArgs
    ///             {
    ...
    public partial class ServiceUnit : Pulumi.CustomResource
    {
        ...
        public ServiceUnit(string name, ServiceUnitArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/latest:ServiceUnit", name, args ?? new ServiceUnitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceUnit(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/latest:ServiceUnit", name, null, MakeResourceOptions(options, id))
        {
        }
