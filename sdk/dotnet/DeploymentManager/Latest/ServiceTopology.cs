...
namespace Pulumi.AzureRM.DeploymentManager.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serviceTopology = new AzureRM.DeploymentManager.Latest.ServiceTopology("serviceTopology", new AzureRM.DeploymentManager.Latest.ServiceTopologyArgs
    ///         {
    ...
    public partial class ServiceTopology : Pulumi.CustomResource
    {
        ...
        public ServiceTopology(string name, ServiceTopologyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/latest:ServiceTopology", name, args ?? new ServiceTopologyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceTopology(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/latest:ServiceTopology", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:deploymentmanager/v20180901preview:ServiceTopology"},
                    new Pulumi.Alias { Type = "azurerm:deploymentmanager/v20191101preview:ServiceTopology"},
                },
            };
