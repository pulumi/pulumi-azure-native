...
namespace Pulumi.AzureRM.DeploymentManager.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var artifactSource = new AzureRM.DeploymentManager.Latest.ArtifactSource("artifactSource", new AzureRM.DeploymentManager.Latest.ArtifactSourceArgs
    ///         {
    ///             ArtifactSourceName = "myArtifactSource",
    ///             Authentication = new AzureRM.DeploymentManager.Latest.Inputs.SasAuthenticationArgs
    ///             {
    ///                 Type = "Sas",
    ///             },
    ///             Location = "centralus",
    ...
    public partial class ArtifactSource : Pulumi.CustomResource
    {
        ...
        public ArtifactSource(string name, ArtifactSourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/latest:ArtifactSource", name, args ?? new ArtifactSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArtifactSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/latest:ArtifactSource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:deploymentmanager/v20191101preview:ArtifactSource"},
                },
            };
