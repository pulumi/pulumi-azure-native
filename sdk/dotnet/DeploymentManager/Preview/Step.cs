...
namespace Pulumi.AzureRM.DeploymentManager.Preview
{
    ...
    public partial class Step : Pulumi.CustomResource
    {
        ...
        public Step(string name, StepArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/preview:Step", name, args ?? new StepArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Step(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/preview:Step", name, null, MakeResourceOptions(options, id))
        {
        }
