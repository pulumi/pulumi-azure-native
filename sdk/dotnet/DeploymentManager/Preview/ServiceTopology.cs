...
namespace Pulumi.AzureRM.DeploymentManager.Preview
{
    ...
    public partial class ServiceTopology : Pulumi.CustomResource
    {
        ...
        public ServiceTopology(string name, ServiceTopologyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/preview:ServiceTopology", name, args ?? new ServiceTopologyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceTopology(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/preview:ServiceTopology", name, null, MakeResourceOptions(options, id))
        {
        }
