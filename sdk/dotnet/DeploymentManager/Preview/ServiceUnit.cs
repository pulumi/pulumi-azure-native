...
namespace Pulumi.AzureRM.DeploymentManager.Preview
{
    ...
    public partial class ServiceUnit : Pulumi.CustomResource
    {
        ...
        public ServiceUnit(string name, ServiceUnitArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/preview:ServiceUnit", name, args ?? new ServiceUnitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceUnit(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/preview:ServiceUnit", name, null, MakeResourceOptions(options, id))
        {
        }
