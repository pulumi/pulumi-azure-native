...
namespace Pulumi.AzureRM.DeploymentManager.Preview
{
    public static class GetServiceTopology
    {
        public static Task<GetServiceTopologyResult> InvokeAsync(GetServiceTopologyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceTopologyResult>("azurerm:deploymentmanager/preview:getServiceTopology", args ?? new GetServiceTopologyArgs(), options.WithVersion());
    }
