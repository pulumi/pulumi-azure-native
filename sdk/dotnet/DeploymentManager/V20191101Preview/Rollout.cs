...
namespace Pulumi.AzureNextGen.DeploymentManager.V20191101Preview
{
    ...
    public partial class Rollout : Pulumi.CustomResource
    {
        ...
        public Rollout(string name, RolloutArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:deploymentmanager/v20191101preview:Rollout", name, args ?? new RolloutArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rollout(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:deploymentmanager/v20191101preview:Rollout", name, null, MakeResourceOptions(options, id))
        {
        }
