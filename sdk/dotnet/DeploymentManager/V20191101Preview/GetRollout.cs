...
namespace Pulumi.AzureRM.DeploymentManager.V20191101Preview
{
    public static class GetRollout
    {
        public static Task<GetRolloutResult> InvokeAsync(GetRolloutArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRolloutResult>("azurerm:deploymentmanager/v20191101preview:getRollout", args ?? new GetRolloutArgs(), options.WithVersion());
    }
