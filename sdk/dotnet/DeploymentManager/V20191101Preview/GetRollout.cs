...
namespace Pulumi.AzureNative.DeploymentManager.V20191101Preview
{
    public static class GetRollout
    {
        ...
        public static Task<GetRolloutResult> InvokeAsync(GetRolloutArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRolloutResult>("azure-native:deploymentmanager/v20191101preview:getRollout", args ?? new GetRolloutArgs(), options.WithDefaults());

        /// <summary>
        /// Defines the PUT rollout request body.
        /// </summary>
        public static Output<GetRolloutResult> Invoke(GetRolloutInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRolloutResult>("azure-native:deploymentmanager/v20191101preview:getRollout", args ?? new GetRolloutInvokeArgs(), options.WithDefaults());
    }
