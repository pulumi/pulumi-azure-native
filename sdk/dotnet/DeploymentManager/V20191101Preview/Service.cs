...
namespace Pulumi.AzureNextGen.DeploymentManager.V20191101Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:deploymentmanager/v20191101preview:Service")]
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:deploymentmanager/v20191101preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:deploymentmanager/v20191101preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
