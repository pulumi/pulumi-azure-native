...
namespace Pulumi.AzureRM.DeploymentManager.V20180901Preview
{
    ...
    public partial class Step : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.WaitStepPropertiesResponseResult> Properties { get; private set; } = null!;
        ...
        public Step(string name, StepArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/v20180901preview:Step", name, args ?? new StepArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Step(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/v20180901preview:Step", name, null, MakeResourceOptions(options, id))
        {
        }
