...
namespace Pulumi.AzureNative.DeploymentManager.V20180901Preview
{
    public static class GetStep
    {
        ...
        public static Task<GetStepResult> InvokeAsync(GetStepArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStepResult>("azure-native:deploymentmanager/v20180901preview:getStep", args ?? new GetStepArgs(), options.WithDefaults());

        /// <summary>
        /// The resource representation of a rollout step.
        /// </summary>
        public static Output<GetStepResult> Invoke(GetStepInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStepResult>("azure-native:deploymentmanager/v20180901preview:getStep", args ?? new GetStepInvokeArgs(), options.WithDefaults());
    }
