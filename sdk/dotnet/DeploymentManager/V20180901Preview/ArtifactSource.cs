...
namespace Pulumi.AzureRM.DeploymentManager.V20180901Preview
{
    ...
    ///             Authentication = new AzureRM.DeploymentManager.V20180901Preview.Inputs.AuthenticationArgs
    ///             {
    ///                 Type = "Sas",
    ///             },
    ///             Location = "centralus",
    ...
    public partial class ArtifactSource : Pulumi.CustomResource
    {
        ...
        public ArtifactSource(string name, ArtifactSourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/v20180901preview:ArtifactSource", name, args ?? new ArtifactSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArtifactSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/v20180901preview:ArtifactSource", name, null, MakeResourceOptions(options, id))
        {
        }
