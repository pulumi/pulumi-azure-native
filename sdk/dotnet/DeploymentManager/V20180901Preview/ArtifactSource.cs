...
namespace Pulumi.AzureNative.DeploymentManager.V20180901Preview
{
    ...
    public partial class ArtifactSource : Pulumi.CustomResource
    {
        ...
        public ArtifactSource(string name, ArtifactSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deploymentmanager/v20180901preview:ArtifactSource", name, args ?? new ArtifactSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArtifactSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deploymentmanager/v20180901preview:ArtifactSource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:deploymentmanager:ArtifactSource"},
