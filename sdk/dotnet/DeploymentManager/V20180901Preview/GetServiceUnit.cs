...
namespace Pulumi.AzureNative.DeploymentManager.V20180901Preview
{
    public static class GetServiceUnit
    {
        ...
        public static Task<GetServiceUnitResult> InvokeAsync(GetServiceUnitArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceUnitResult>("azure-native:deploymentmanager/v20180901preview:getServiceUnit", args ?? new GetServiceUnitArgs(), options.WithVersion());

        /// <summary>
        /// Represents the response of a service unit resource.
        /// </summary>
        public static Output<GetServiceUnitResult> Invoke(GetServiceUnitInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceUnitResult>("azure-native:deploymentmanager/v20180901preview:getServiceUnit", args ?? new GetServiceUnitInvokeArgs(), options.WithVersion());
    }
