...
namespace Pulumi.AzureRM.DeploymentManager.V20180901Preview
{
    ...
    public partial class ServiceUnit : Pulumi.CustomResource
    {
        ...
        public ServiceUnit(string name, ServiceUnitArgs args, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/v20180901preview:ServiceUnit", name, args ?? new ServiceUnitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceUnit(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:deploymentmanager/v20180901preview:ServiceUnit", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:deploymentmanager/preview:ServiceUnit"},
                    new Pulumi.Alias { Type = "azurerm:deploymentmanager/v20191101preview:ServiceUnit"},
                },
            };
