...
namespace Pulumi.AzureNative.DeploymentManager.V20180901Preview
{
    ...
    public partial class ServiceTopology : global::Pulumi.CustomResource
    {
        ...
        public ServiceTopology(string name, ServiceTopologyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deploymentmanager/v20180901preview:ServiceTopology", name, args ?? new ServiceTopologyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceTopology(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deploymentmanager/v20180901preview:ServiceTopology", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:deploymentmanager/v20191101preview:ServiceTopology"},
                },
            };
    ...
    public sealed class ServiceTopologyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("serviceTopologyName")]
        public Input<string>? ServiceTopologyName { get; set; }
