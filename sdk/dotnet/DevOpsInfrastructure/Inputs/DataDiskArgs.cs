...
namespace Pulumi.AzureNative.DevOpsInfrastructure.Inputs
{
    ...
    public sealed class DataDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public InputUnion<string, Pulumi.AzureNative.DevOpsInfrastructure.CachingType>? Caching { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevOpsInfrastructure.StorageAccountType>? StorageAccountType { get; set; }
