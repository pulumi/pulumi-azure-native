...
namespace Pulumi.AzureNative.DevOpsInfrastructure.V20250121
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devopsinfrastructure/v20250121:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devopsinfrastructure/v20250121:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devopsinfrastructure/v20250121:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevOpsInfrastructure.V20250121.ProvisioningState>? ProvisioningState { get; set; }
