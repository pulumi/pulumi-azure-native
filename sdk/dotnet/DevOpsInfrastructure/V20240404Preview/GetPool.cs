...
namespace Pulumi.AzureNative.DevOpsInfrastructure.V20240404Preview
{
    public static class GetPool
    {
        ...
        public static Task<GetPoolResult> InvokeAsync(GetPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPoolResult>("azure-native:devopsinfrastructure/v20240404preview:getPool", args ?? new GetPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Pool
        /// </summary>
        public static Output<GetPoolResult> Invoke(GetPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPoolResult>("azure-native:devopsinfrastructure/v20240404preview:getPool", args ?? new GetPoolInvokeArgs(), options.WithDefaults());
