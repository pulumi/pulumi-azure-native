...
namespace Pulumi.AzureNative.OpenEnergyPlatform.V20220404Preview
{
    ...
    /// {
    ///     var energyService = new AzureNative.OpenEnergyPlatform.V20220404Preview.EnergyService("energyService", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:openenergyplatform/v20220404preview:EnergyService")]
    public partial class EnergyService : global::Pulumi.CustomResource
    {
        ...
        [Output("properties")]
        public Output<Outputs.EnergyServicePropertiesResponse> Properties { get; private set; } = null!;
        ...
        public EnergyService(string name, EnergyServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:openenergyplatform/v20220404preview:EnergyService", name, args ?? new EnergyServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnergyService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:openenergyplatform/v20220404preview:EnergyService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static EnergyService Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class EnergyServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("properties")]
        public Input<Inputs.EnergyServicePropertiesArgs>? Properties { get; set; }
