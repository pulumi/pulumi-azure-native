...
namespace Pulumi.AzureNative.Attestation.V20210601Preview
{
    ...
    public partial class AttestationProvider : global::Pulumi.CustomResource
    {
        ...
        public AttestationProvider(string name, AttestationProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:attestation/v20210601preview:AttestationProvider", name, args ?? new AttestationProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:attestation/v20210601preview:AttestationProvider", name, null, MakeResourceOptions(options, id))
        {
        }
