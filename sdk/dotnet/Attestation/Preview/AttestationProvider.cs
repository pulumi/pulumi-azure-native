...
namespace Pulumi.AzureRM.Attestation.Preview
{
    /// <summary>
    ...
    public partial class AttestationProvider : Pulumi.CustomResource
    {
        ...
        public AttestationProvider(string name, AttestationProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:attestation/preview:AttestationProvider", name, args ?? new AttestationProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:attestation/preview:AttestationProvider", name, null, MakeResourceOptions(options, id))
        {
        }
