...
namespace Pulumi.AzureNextGen.Attestation.Inputs
{
    ...
    public sealed class PrivateLinkServiceConnectionStateArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNextGen.Attestation.PrivateEndpointServiceConnectionStatus>? Status { get; set; }
