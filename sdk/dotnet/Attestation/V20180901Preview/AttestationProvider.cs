...
namespace Pulumi.AzureRM.Attestation.V20180901Preview
{
    /// <summary>
    ...
    public partial class AttestationProvider : Pulumi.CustomResource
    {
        ...
        public AttestationProvider(string name, AttestationProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:attestation/v20180901preview:AttestationProvider", name, args ?? new AttestationProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:attestation/v20180901preview:AttestationProvider", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:attestation/preview:AttestationProvider"},
                },
            };
