...
namespace Pulumi.AzureNative.Attestation.V20210601.Inputs
{
    ...
    public sealed class AttestationServiceCreationSpecificParamsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Attestation.V20210601.PublicNetworkAccessType>? PublicNetworkAccess { get; set; }

        /// <summary>
        /// The setting that controls whether authentication is enabled or disabled for TPM Attestation REST APIs.
        /// </summary>
        [Input("tpmAttestationAuthentication")]
        public InputUnion<string, Pulumi.AzureNative.Attestation.V20210601.TpmAttestationAuthenticationType>? TpmAttestationAuthentication { get; set; }
