...
namespace Pulumi.AzureNative.Attestation.V20210601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:attestation/v20210601:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:attestation/v20210601:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:attestation/v20210601:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
