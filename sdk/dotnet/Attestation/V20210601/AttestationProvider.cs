...
namespace Pulumi.AzureNative.Attestation.V20210601
{
    /// <summary>
    /// Attestation service response message.
    /// </summary>
    [AzureNativeResourceType("azure-native:attestation/v20210601:AttestationProvider")]
    public partial class AttestationProvider : global::Pulumi.CustomResource
    {
        ...
        public AttestationProvider(string name, AttestationProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:attestation/v20210601:AttestationProvider", name, args ?? new AttestationProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestationProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:attestation/v20210601:AttestationProvider", name, null, MakeResourceOptions(options, id))
        {
        }
