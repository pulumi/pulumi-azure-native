...
namespace Pulumi.AzureNative.Attestation.V20210601
{
    public static class GetAttestationProvider
    {
        ...
        public static Task<GetAttestationProviderResult> InvokeAsync(GetAttestationProviderArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAttestationProviderResult>("azure-native:attestation/v20210601:getAttestationProvider", args ?? new GetAttestationProviderArgs(), options.WithDefaults());
