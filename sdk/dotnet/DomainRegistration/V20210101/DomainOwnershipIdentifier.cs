...
namespace Pulumi.AzureNative.DomainRegistration.V20210101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:domainregistration/v20210101:DomainOwnershipIdentifier")]
    public partial class DomainOwnershipIdentifier : Pulumi.CustomResource
    {
        ...
        public DomainOwnershipIdentifier(string name, DomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20210101:DomainOwnershipIdentifier", name, args ?? new DomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20210101:DomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
