...
namespace Pulumi.AzureNextGen.DomainRegistration.V20190801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:domainregistration/v20190801:Domain")]
    public partial class Domain : Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:domainregistration/v20190801:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:domainregistration/v20190801:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
