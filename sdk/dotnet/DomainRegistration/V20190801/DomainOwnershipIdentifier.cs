...
namespace Pulumi.AzureRM.DomainRegistration.V20190801
{
    ...
    public partial class DomainOwnershipIdentifier : Pulumi.CustomResource
    {
        ...
        public DomainOwnershipIdentifier(string name, DomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azurerm:domainregistration/v20190801:DomainOwnershipIdentifier", name, args ?? new DomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:domainregistration/v20190801:DomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
