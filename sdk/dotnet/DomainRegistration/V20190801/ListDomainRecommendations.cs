...
namespace Pulumi.AzureRM.DomainRegistration.V20190801
{
    public static class ListDomainRecommendations
    {
        public static Task<ListDomainRecommendationsResult> InvokeAsync(ListDomainRecommendationsArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListDomainRecommendationsResult>("azurerm:domainregistration/v20190801:listDomainRecommendations", args ?? new ListDomainRecommendationsArgs(), options.WithVersion());
    }
