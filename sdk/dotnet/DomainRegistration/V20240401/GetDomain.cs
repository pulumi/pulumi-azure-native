...
namespace Pulumi.AzureNative.DomainRegistration.V20240401
{
    public static class GetDomain
    {
        ...
        public static Task<GetDomainResult> InvokeAsync(GetDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainResult>("azure-native:domainregistration/v20240401:getDomain", args ?? new GetDomainArgs(), options.WithDefaults());
