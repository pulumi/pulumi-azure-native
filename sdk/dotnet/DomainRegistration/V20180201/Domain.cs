...
azure-native:domainregistration/v20180201:Domain is being removed in the next major version of this provider. Please upgrade to azure-native:domainregistration/v20201001:Domain to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:domainregistration/v20180201:Domain")]
    public partial class Domain : global::Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20180201:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20180201:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DomainArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dnsType")]
        public Input<Pulumi.AzureNative.DomainRegistration.V20180201.DnsType>? DnsType { get; set; }
        ...
        /// </summary>
        [Input("targetDnsType")]
        public Input<Pulumi.AzureNative.DomainRegistration.V20180201.DnsType>? TargetDnsType { get; set; }
