...
namespace Pulumi.AzureRM.DomainRegistration.V20180201
{
    public static class ListTopLevelDomainAgreements
    {
        public static Task<ListTopLevelDomainAgreementsResult> InvokeAsync(ListTopLevelDomainAgreementsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListTopLevelDomainAgreementsResult>("azurerm:domainregistration/v20180201:listTopLevelDomainAgreements", args ?? new ListTopLevelDomainAgreementsArgs(), options.WithVersion());
    }
