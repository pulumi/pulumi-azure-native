...
namespace Pulumi.AzureNextGen.DomainRegistration
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:domainregistration:DomainOwnershipIdentifier")]
    public partial class DomainOwnershipIdentifier : Pulumi.CustomResource
    {
        ...
        public DomainOwnershipIdentifier(string name, DomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:domainregistration:DomainOwnershipIdentifier", name, args ?? new DomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:domainregistration:DomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
