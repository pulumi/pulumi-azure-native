...
namespace Pulumi.AzureNative.DomainRegistration.V20230101
{
    /// <summary>
    /// Domain ownership Identifier.
    /// </summary>
    [AzureNativeResourceType("azure-native:domainregistration/v20230101:DomainOwnershipIdentifier")]
    public partial class DomainOwnershipIdentifier : global::Pulumi.CustomResource
    {
        ...
        public DomainOwnershipIdentifier(string name, DomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20230101:DomainOwnershipIdentifier", name, args ?? new DomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20230101:DomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
