...
namespace Pulumi.AzureNative.DomainRegistration.V20200901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:domainregistration/v20200901:DomainOwnershipIdentifier")]
    public partial class DomainOwnershipIdentifier : Pulumi.CustomResource
    {
        ...
        public DomainOwnershipIdentifier(string name, DomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20200901:DomainOwnershipIdentifier", name, args ?? new DomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20200901:DomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:domainregistration/v20210101:DomainOwnershipIdentifier"},
                    new Pulumi.Alias { Type = "azure-native:domainregistration/v20210115:DomainOwnershipIdentifier"},
                    new Pulumi.Alias { Type = "azure-nextgen:domainregistration/v20210115:DomainOwnershipIdentifier"},
                    new Pulumi.Alias { Type = "azure-native:domainregistration/v20210201:DomainOwnershipIdentifier"},
                    new Pulumi.Alias { Type = "azure-nextgen:domainregistration/v20210201:DomainOwnershipIdentifier"},
                },
            };
