...
namespace Pulumi.AzureNative.DomainRegistration.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:domainregistration/v20220301:DomainOwnershipIdentifier is being removed in the next major version of this provider. Upgrade to at least azure-native:domainregistration/v20220901:DomainOwnershipIdentifier to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:domainregistration/v20220301:DomainOwnershipIdentifier")]
    public partial class DomainOwnershipIdentifier : global::Pulumi.CustomResource
    {
        ...
        public DomainOwnershipIdentifier(string name, DomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20220301:DomainOwnershipIdentifier", name, args ?? new DomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20220301:DomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
