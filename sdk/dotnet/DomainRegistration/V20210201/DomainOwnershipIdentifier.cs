...
namespace Pulumi.AzureNative.DomainRegistration.V20210201
{
    ...
    [AzureNativeResourceType("azure-native:domainregistration/v20210201:DomainOwnershipIdentifier")]
    public partial class DomainOwnershipIdentifier : global::Pulumi.CustomResource
    {
        ...
        public DomainOwnershipIdentifier(string name, DomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20210201:DomainOwnershipIdentifier", name, args ?? new DomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20210201:DomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
