...
namespace Pulumi.AzureNextGen.DomainRegistration.V20200601
{
    ...
    public partial class DomainOwnershipIdentifier : Pulumi.CustomResource
    {
        ...
        public DomainOwnershipIdentifier(string name, DomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:domainregistration/v20200601:DomainOwnershipIdentifier", name, args ?? new DomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:domainregistration/v20200601:DomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
