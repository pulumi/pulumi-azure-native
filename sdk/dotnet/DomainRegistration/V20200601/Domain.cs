...
namespace Pulumi.AzureRM.DomainRegistration.V20200601
{
    /// <summary>
    ...
    public partial class Domain : Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azurerm:domainregistration/v20200601:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:domainregistration/v20200601:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
