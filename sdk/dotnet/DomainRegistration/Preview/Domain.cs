...
namespace Pulumi.AzureRM.DomainRegistration.Preview
{
    ...
    public partial class Domain : Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azurerm:domainregistration/preview:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:domainregistration/preview:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
