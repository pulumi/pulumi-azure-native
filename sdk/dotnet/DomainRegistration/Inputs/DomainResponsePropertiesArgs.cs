...
namespace Pulumi.AzureRM.DomainRegistration.Inputs
{
    ...
    /// </summary>
    public sealed class DomainResponsePropertiesArgs : Pulumi.ResourceArgs
    {
        [Input("authCode")]
        ...
        public Input<Inputs.DomainPurchaseConsentResponseArgs> Consent { get; set; } = null!;

        /// <summary>
        /// Administrative contact.
        /// </summary>
        [Input("contactAdmin", required: true)]
        public Input<Inputs.ContactResponseArgs> ContactAdmin { get; set; } = null!;

        /// <summary>
        /// Billing contact.
        /// </summary>
        [Input("contactBilling", required: true)]
        public Input<Inputs.ContactResponseArgs> ContactBilling { get; set; } = null!;

        /// <summary>
        /// Registrant contact.
        /// </summary>
        [Input("contactRegistrant", required: true)]
        public Input<Inputs.ContactResponseArgs> ContactRegistrant { get; set; } = null!;

        /// <summary>
        /// Technical contact.
        /// </summary>
        [Input("contactTech", required: true)]
        public Input<Inputs.ContactResponseArgs> ContactTech { get; set; } = null!;
        ...
        private InputList<Inputs.HostNameResponseArgs>? _managedHostNames;

        /// <summary>
        /// All hostnames derived from the domain and assigned to Azure resources.
        /// </summary>
        public InputList<Inputs.HostNameResponseArgs> ManagedHostNames
        {
            get => _managedHostNames ?? (_managedHostNames = new InputList<Inputs.HostNameResponseArgs>());
        ...
        public DomainResponsePropertiesArgs()
        {
        }
    }
}
