...
namespace Pulumi.AzureRM.DomainRegistration.Latest
{
    ...
    public partial class Domain : Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azurerm:domainregistration/latest:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:domainregistration/latest:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
