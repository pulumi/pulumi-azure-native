...
namespace Pulumi.AzureNative.DomainRegistration.V20220901
{
    ...
    public partial class DomainOwnershipIdentifier : global::Pulumi.CustomResource
    {
        ...
        public DomainOwnershipIdentifier(string name, DomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20220901:DomainOwnershipIdentifier", name, args ?? new DomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:domainregistration/v20220901:DomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
