...
namespace Pulumi.AzureRM.DomainRegistration.V20150801
{
    ...
    public partial class Domain : Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azurerm:domainregistration/v20150801:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:domainregistration/v20150801:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
