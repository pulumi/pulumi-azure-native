...
namespace Pulumi.AzureNative.HybridCloud.V20230101Preview
{
    public static class GetCloudConnector
    {
        ...
        public static Task<GetCloudConnectorResult> InvokeAsync(GetCloudConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCloudConnectorResult>("azure-native:hybridcloud/v20230101preview:getCloudConnector", args ?? new GetCloudConnectorArgs(), options.WithDefaults());
