...
namespace Pulumi.AzureNative.HybridCloud.V20230101Preview
{
    public static class GetCloudConnection
    {
        ...
        public static Task<GetCloudConnectionResult> InvokeAsync(GetCloudConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCloudConnectionResult>("azure-native:hybridcloud/v20230101preview:getCloudConnection", args ?? new GetCloudConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified cloud connection in a specified resource group.
        /// </summary>
        public static Output<GetCloudConnectionResult> Invoke(GetCloudConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCloudConnectionResult>("azure-native:hybridcloud/v20230101preview:getCloudConnection", args ?? new GetCloudConnectionInvokeArgs(), options.WithDefaults());
    }
