...
namespace Pulumi.AzureNative.IoTOperationsOrchestrator.V20231004Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperationsorchestrator/v20231004preview:Solution")]
    public partial class Solution : global::Pulumi.CustomResource
    {
        ...
        public Solution(string name, SolutionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsorchestrator/v20231004preview:Solution", name, args ?? new SolutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Solution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsorchestrator/v20231004preview:Solution", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:iotoperationsorchestrator:Solution"},
                },
            };
