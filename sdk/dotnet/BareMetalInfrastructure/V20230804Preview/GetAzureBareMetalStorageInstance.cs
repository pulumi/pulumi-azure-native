...
namespace Pulumi.AzureNative.BareMetalInfrastructure.V20230804Preview
{
    public static class GetAzureBareMetalStorageInstance
    {
        ...
        public static Task<GetAzureBareMetalStorageInstanceResult> InvokeAsync(GetAzureBareMetalStorageInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAzureBareMetalStorageInstanceResult>("azure-native:baremetalinfrastructure/v20230804preview:getAzureBareMetalStorageInstance", args ?? new GetAzureBareMetalStorageInstanceArgs(), options.WithDefaults());
