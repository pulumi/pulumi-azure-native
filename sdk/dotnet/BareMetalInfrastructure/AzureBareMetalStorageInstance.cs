...
namespace Pulumi.AzureNative.BareMetalInfrastructure
{
    ...
    public partial class AzureBareMetalStorageInstance : global::Pulumi.CustomResource
    {
        ...
        public AzureBareMetalStorageInstance(string name, AzureBareMetalStorageInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:baremetalinfrastructure:AzureBareMetalStorageInstance", name, args ?? new AzureBareMetalStorageInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureBareMetalStorageInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:baremetalinfrastructure:AzureBareMetalStorageInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_baremetalinfrastructure_v20230406:baremetalinfrastructure:AzureBareMetalStorageInstance" },
                    new global::Pulumi.Alias { Type = "azure-native_baremetalinfrastructure_v20230804preview:baremetalinfrastructure:AzureBareMetalStorageInstance" },
                    new global::Pulumi.Alias { Type = "azure-native_baremetalinfrastructure_v20231101preview:baremetalinfrastructure:AzureBareMetalStorageInstance" },
                    new global::Pulumi.Alias { Type = "azure-native_baremetalinfrastructure_v20240801preview:baremetalinfrastructure:AzureBareMetalStorageInstance" },
                },
            };
