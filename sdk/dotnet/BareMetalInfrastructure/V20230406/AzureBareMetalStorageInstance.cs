...
namespace Pulumi.AzureNative.BareMetalInfrastructure.V20230406
{
    /// <summary>
    /// AzureBareMetalStorageInstance info on Azure (ARM properties and AzureBareMetalStorage properties)
    /// </summary>
    [AzureNativeResourceType("azure-native:baremetalinfrastructure/v20230406:AzureBareMetalStorageInstance")]
    public partial class AzureBareMetalStorageInstance : global::Pulumi.CustomResource
    {
        ...
        public AzureBareMetalStorageInstance(string name, AzureBareMetalStorageInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:baremetalinfrastructure/v20230406:AzureBareMetalStorageInstance", name, args ?? new AzureBareMetalStorageInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureBareMetalStorageInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:baremetalinfrastructure/v20230406:AzureBareMetalStorageInstance", name, null, MakeResourceOptions(options, id))
        {
        }
