...
namespace Pulumi.AzureNative.BareMetalInfrastructure.V20240801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:baremetalinfrastructure/v20240801preview:AzureBareMetalInstance")]
    public partial class AzureBareMetalInstance : global::Pulumi.CustomResource
    {
        ...
        public AzureBareMetalInstance(string name, AzureBareMetalInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:baremetalinfrastructure/v20240801preview:AzureBareMetalInstance", name, args ?? new AzureBareMetalInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureBareMetalInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:baremetalinfrastructure/v20240801preview:AzureBareMetalInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:baremetalinfrastructure:AzureBareMetalInstance" },
                },
            };
    ...
    public sealed class AzureBareMetalInstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("powerState")]
        public InputUnion<string, Pulumi.AzureNative.BareMetalInfrastructure.V20240801Preview.AzureBareMetalInstancePowerStateEnum>? PowerState { get; set; }
