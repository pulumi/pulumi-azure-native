...
namespace Pulumi.AzureNative.BareMetalInfrastructure.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:baremetalinfrastructure/v20231101preview:AzureBareMetalStorageInstance")]
    public partial class AzureBareMetalStorageInstance : global::Pulumi.CustomResource
    {
        ...
        public AzureBareMetalStorageInstance(string name, AzureBareMetalStorageInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:baremetalinfrastructure/v20231101preview:AzureBareMetalStorageInstance", name, args ?? new AzureBareMetalStorageInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureBareMetalStorageInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:baremetalinfrastructure/v20231101preview:AzureBareMetalStorageInstance", name, null, MakeResourceOptions(options, id))
        {
        }
