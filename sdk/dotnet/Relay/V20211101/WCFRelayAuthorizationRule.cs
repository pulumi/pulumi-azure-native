...
namespace Pulumi.AzureNative.Relay.V20211101
{
    ...
    /// {
    ///     var wcfRelayAuthorizationRule = new AzureNative.Relay.V20211101.WCFRelayAuthorizationRule("wcfRelayAuthorizationRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:relay/v20211101:WCFRelayAuthorizationRule")]
    public partial class WCFRelayAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public WCFRelayAuthorizationRule(string name, WCFRelayAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20211101:WCFRelayAuthorizationRule", name, args ?? new WCFRelayAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WCFRelayAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20211101:WCFRelayAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
