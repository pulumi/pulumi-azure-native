...
namespace Pulumi.AzureNative.Relay.V20211101
{
    ...
    /// {
    ///     var hybridConnection = new AzureNative.Relay.V20211101.HybridConnection("hybridConnection", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:relay/v20211101:HybridConnection")]
    public partial class HybridConnection : global::Pulumi.CustomResource
    {
        ...
        public HybridConnection(string name, HybridConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20211101:HybridConnection", name, args ?? new HybridConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20211101:HybridConnection", name, null, MakeResourceOptions(options, id))
        {
        }
