...
namespace Pulumi.AzureNative.Relay.V20211101
{
    ...
    /// {
    ///     var hybridConnectionAuthorizationRule = new AzureNative.Relay.V20211101.HybridConnectionAuthorizationRule("hybridConnectionAuthorizationRule", new()
    ///     {
    ...
    public partial class HybridConnectionAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public HybridConnectionAuthorizationRule(string name, HybridConnectionAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20211101:HybridConnectionAuthorizationRule", name, args ?? new HybridConnectionAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridConnectionAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20211101:HybridConnectionAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
