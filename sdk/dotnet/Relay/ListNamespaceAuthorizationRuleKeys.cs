...
namespace Pulumi.AzureRM.Relay
{
    public static class ListNamespaceAuthorizationRuleKeys
    {
        public static Task<ListNamespaceAuthorizationRuleKeysResult> InvokeAsync(ListNamespaceAuthorizationRuleKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceAuthorizationRuleKeysResult>("azurerm:relay:listNamespaceAuthorizationRuleKeys", args ?? new ListNamespaceAuthorizationRuleKeysArgs(), options.WithVersion());
    }
