...
namespace Pulumi.AzureNextGen.Relay
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:relay:HybridConnection")]
    public partial class HybridConnection : Pulumi.CustomResource
    {
        ...
        public HybridConnection(string name, HybridConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:relay:HybridConnection", name, args ?? new HybridConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:relay:HybridConnection", name, null, MakeResourceOptions(options, id))
        {
        }
