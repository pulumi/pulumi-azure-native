...
namespace Pulumi.AzureRM.Relay
{
    ...
    /// </summary>
    public partial class NamespaceWcfRelayAuthorizationRule : Pulumi.CustomResource
    {
        /// <summary>
        /// Resource name.
        /// </summary>
        ...
        public NamespaceWcfRelayAuthorizationRule(string name, NamespaceWcfRelayAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:relay:NamespaceWcfRelayAuthorizationRule", name, args ?? new NamespaceWcfRelayAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class NamespaceWcfRelayAuthorizationRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
