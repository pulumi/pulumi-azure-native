...
namespace Pulumi.AzureNative.Relay
{
    ...
    public partial class HybridConnectionAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public HybridConnectionAuthorizationRule(string name, HybridConnectionAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:relay:HybridConnectionAuthorizationRule", name, args ?? new HybridConnectionAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridConnectionAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:relay:HybridConnectionAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_relay_v20160701:relay:HybridConnectionAuthorizationRule" },
                    new global::Pulumi.Alias { Type = "azure-native_relay_v20170401:relay:HybridConnectionAuthorizationRule" },
                    new global::Pulumi.Alias { Type = "azure-native_relay_v20211101:relay:HybridConnectionAuthorizationRule" },
                    new global::Pulumi.Alias { Type = "azure-native_relay_v20240101:relay:HybridConnectionAuthorizationRule" },
                },
            };
