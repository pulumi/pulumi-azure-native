...
namespace Pulumi.AzureNative.Relay.V20170401
{
    public static class GetHybridConnection
    {
        ...
        public static Output<GetHybridConnectionResult> Invoke(GetHybridConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetHybridConnectionResult>("azure-native:relay/v20170401:getHybridConnection", args ?? new GetHybridConnectionInvokeArgs(), options.WithVersion());
    }
