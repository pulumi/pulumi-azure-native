...
namespace Pulumi.AzureNative.Relay.V20170401
{
    ...
    /// {
    ///     var namespaceAuthorizationRule = new AzureNative.Relay.V20170401.NamespaceAuthorizationRule("namespaceAuthorizationRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:relay/v20170401:NamespaceAuthorizationRule")]
    public partial class NamespaceAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public NamespaceAuthorizationRule(string name, NamespaceAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20170401:NamespaceAuthorizationRule", name, args ?? new NamespaceAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20170401:NamespaceAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
