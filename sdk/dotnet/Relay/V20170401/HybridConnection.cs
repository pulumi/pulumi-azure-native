...
namespace Pulumi.AzureNative.Relay.V20170401
{
    ...
    /// {
    ///     var hybridConnection = new AzureNative.Relay.V20170401.HybridConnection("hybridConnection", new()
    ///     {
    ...
    public partial class HybridConnection : global::Pulumi.CustomResource
    {
        ...
        public HybridConnection(string name, HybridConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20170401:HybridConnection", name, args ?? new HybridConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20170401:HybridConnection", name, null, MakeResourceOptions(options, id))
        {
        }
