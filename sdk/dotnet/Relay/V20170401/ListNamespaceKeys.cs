...
namespace Pulumi.AzureNative.Relay.V20170401
{
    public static class ListNamespaceKeys
    {
        ...
        public static Output<ListNamespaceKeysResult> Invoke(ListNamespaceKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListNamespaceKeysResult>("azure-native:relay/v20170401:listNamespaceKeys", args ?? new ListNamespaceKeysInvokeArgs(), options.WithVersion());
    }
