...
namespace Pulumi.AzureRM.Relay.Preview
{
    public static class ListWCFRelayKeys
    {
        public static Task<ListWCFRelayKeysResult> InvokeAsync(ListWCFRelayKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWCFRelayKeysResult>("azurerm:relay/preview:listWCFRelayKeys", args ?? new ListWCFRelayKeysArgs(), options.WithVersion());
    }
