...
namespace Pulumi.AzureRM.Relay
{
    ...
    /// </summary>
    public partial class NamespaceWcfRelay : Pulumi.CustomResource
    {
        /// <summary>
        /// Resource name.
        /// </summary>
        ...
        public NamespaceWcfRelay(string name, NamespaceWcfRelayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:relay:NamespaceWcfRelay", name, args ?? new NamespaceWcfRelayArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class NamespaceWcfRelayArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The relay name.
        /// </summary>
