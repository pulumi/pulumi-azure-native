...
namespace Pulumi.AzureRM.Relay.V20160701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var namespaceAuthorizationRule = new AzureRM.Relay.V20160701.NamespaceAuthorizationRule("namespaceAuthorizationRule", new AzureRM.Relay.V20160701.NamespaceAuthorizationRuleArgs
    ///         {
    ...
    public partial class NamespaceAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public NamespaceAuthorizationRule(string name, NamespaceAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:relay/v20160701:NamespaceAuthorizationRule", name, args ?? new NamespaceAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:relay/v20160701:NamespaceAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
