...
namespace Pulumi.AzureNative.Relay.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:relay/v20240101:Namespace")]
    public partial class Namespace : global::Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20240101:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20240101:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Relay.V20240101.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
