...
namespace Pulumi.AzureNative.Relay.V20240101
{
    public static class GetWCFRelay
    {
        ...
        public static Task<GetWCFRelayResult> InvokeAsync(GetWCFRelayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWCFRelayResult>("azure-native:relay/v20240101:getWCFRelay", args ?? new GetWCFRelayArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the description for the specified WCF relay.
        /// </summary>
        public static Output<GetWCFRelayResult> Invoke(GetWCFRelayInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWCFRelayResult>("azure-native:relay/v20240101:getWCFRelay", args ?? new GetWCFRelayInvokeArgs(), options.WithDefaults());
    }
