...
namespace Pulumi.AzureNative.Relay.V20240101
{
    public static class ListWCFRelayKeys
    {
        ...
        public static Task<ListWCFRelayKeysResult> InvokeAsync(ListWCFRelayKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListWCFRelayKeysResult>("azure-native:relay/v20240101:listWCFRelayKeys", args ?? new ListWCFRelayKeysArgs(), options.WithDefaults());
