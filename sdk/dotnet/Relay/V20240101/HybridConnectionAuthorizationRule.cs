...
namespace Pulumi.AzureNative.Relay.V20240101
{
    /// <summary>
    /// Single item in a List or Get AuthorizationRule operation
    /// </summary>
    [AzureNativeResourceType("azure-native:relay/v20240101:HybridConnectionAuthorizationRule")]
    public partial class HybridConnectionAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public HybridConnectionAuthorizationRule(string name, HybridConnectionAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20240101:HybridConnectionAuthorizationRule", name, args ?? new HybridConnectionAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridConnectionAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20240101:HybridConnectionAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class HybridConnectionAuthorizationRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Relay.V20240101.AccessRights>>? _rights;

        /// <summary>
        /// The rights associated with the rule.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Relay.V20240101.AccessRights>> Rights
        {
            get => _rights ?? (_rights = new InputList<Union<string, Pulumi.AzureNative.Relay.V20240101.AccessRights>>());
            set => _rights = value;
        }
