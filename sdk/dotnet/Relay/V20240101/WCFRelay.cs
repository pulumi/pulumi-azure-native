...
namespace Pulumi.AzureNative.Relay.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:relay/v20240101:WCFRelay")]
    public partial class WCFRelay : global::Pulumi.CustomResource
    {
        ...
        public WCFRelay(string name, WCFRelayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20240101:WCFRelay", name, args ?? new WCFRelayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WCFRelay(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20240101:WCFRelay", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WCFRelayArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("relayType")]
        public Input<Pulumi.AzureNative.Relay.V20240101.Relaytype>? RelayType { get; set; }
