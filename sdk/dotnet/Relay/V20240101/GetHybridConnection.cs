...
namespace Pulumi.AzureNative.Relay.V20240101
{
    public static class GetHybridConnection
    {
        ...
        public static Task<GetHybridConnectionResult> InvokeAsync(GetHybridConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHybridConnectionResult>("azure-native:relay/v20240101:getHybridConnection", args ?? new GetHybridConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the description for the specified hybrid connection.
        /// </summary>
        public static Output<GetHybridConnectionResult> Invoke(GetHybridConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHybridConnectionResult>("azure-native:relay/v20240101:getHybridConnection", args ?? new GetHybridConnectionInvokeArgs(), options.WithDefaults());
