...
namespace Pulumi.AzureNative.Relay.V20240101
{
    public static class GetNamespace
    {
        ...
        public static Task<GetNamespaceResult> InvokeAsync(GetNamespaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNamespaceResult>("azure-native:relay/v20240101:getNamespace", args ?? new GetNamespaceArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the description for the specified namespace.
        /// </summary>
        public static Output<GetNamespaceResult> Invoke(GetNamespaceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNamespaceResult>("azure-native:relay/v20240101:getNamespace", args ?? new GetNamespaceInvokeArgs(), options.WithDefaults());
