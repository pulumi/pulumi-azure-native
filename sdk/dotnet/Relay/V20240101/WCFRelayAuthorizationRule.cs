...
namespace Pulumi.AzureNative.Relay.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:relay/v20240101:WCFRelayAuthorizationRule")]
    public partial class WCFRelayAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public WCFRelayAuthorizationRule(string name, WCFRelayAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20240101:WCFRelayAuthorizationRule", name, args ?? new WCFRelayAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WCFRelayAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:relay/v20240101:WCFRelayAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
