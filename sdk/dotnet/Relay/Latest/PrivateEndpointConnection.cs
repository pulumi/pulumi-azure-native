...
namespace Pulumi.AzureRM.Relay.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.Relay.Latest.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.Relay.Latest.PrivateEndpointConnectionArgs
    ///         {
    ///             Location = "South Central US",
    ///             NamespaceName = "sdk-Namespace-5849",
    ///             PrivateEndpoint = new AzureRM.Relay.Latest.Inputs.PrivateEndpointArgs
    ///             {
    ...
    ///             PrivateLinkServiceConnectionState = new AzureRM.Relay.Latest.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:relay/latest:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:relay/latest:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
