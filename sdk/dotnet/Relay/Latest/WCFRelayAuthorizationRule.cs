...
namespace Pulumi.AzureNative.Relay.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:relay:WCFRelayAuthorizationRule'.")]
    [AzureNativeResourceType("azure-native:relay/latest:WCFRelayAuthorizationRule")]
    public partial class WCFRelayAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public WCFRelayAuthorizationRule(string name, WCFRelayAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:relay/latest:WCFRelayAuthorizationRule", name, args ?? new WCFRelayAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WCFRelayAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:relay/latest:WCFRelayAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
