...
namespace Pulumi.AzureNative.Relay.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:relay:WCFRelay'.")]
    [AzureNativeResourceType("azure-native:relay/latest:WCFRelay")]
    public partial class WCFRelay : Pulumi.CustomResource
    {
        ...
        public WCFRelay(string name, WCFRelayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:relay/latest:WCFRelay", name, args ?? new WCFRelayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WCFRelay(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:relay/latest:WCFRelay", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WCFRelayArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("relayType")]
        public Input<Pulumi.AzureNative.Relay.Latest.Relaytype>? RelayType { get; set; }
