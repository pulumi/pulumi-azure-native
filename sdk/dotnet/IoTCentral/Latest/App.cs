...
namespace Pulumi.AzureNative.IoTCentral.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:iotcentral:App'.")]
    [AzureNativeResourceType("azure-native:iotcentral/latest:App")]
    public partial class App : Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotcentral/latest:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotcentral/latest:App", name, null, MakeResourceOptions(options, id))
        {
        }
