...
namespace Pulumi.AzureRM.IoTCentral.Preview
{
    public static class GetApp
    {
        public static Task<GetAppResult> InvokeAsync(GetAppArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAppResult>("azurerm:iotcentral/preview:getApp", args ?? new GetAppArgs(), options.WithVersion());
    }
