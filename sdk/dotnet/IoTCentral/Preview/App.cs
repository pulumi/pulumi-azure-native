...
namespace Pulumi.AzureRM.IoTCentral.Preview
{
    ...
    public partial class App : Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("azurerm:iotcentral/preview:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:iotcentral/preview:App", name, null, MakeResourceOptions(options, id))
        {
        }
