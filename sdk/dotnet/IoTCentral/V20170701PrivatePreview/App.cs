...
namespace Pulumi.AzureRM.IoTCentral.V20170701PrivatePreview
{
    /// <summary>
    ...
    public partial class App : Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("azurerm:iotcentral/v20170701privatepreview:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:iotcentral/v20170701privatepreview:App", name, null, MakeResourceOptions(options, id))
        {
        }
