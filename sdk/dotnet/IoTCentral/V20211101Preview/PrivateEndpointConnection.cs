...
namespace Pulumi.AzureNative.IoTCentral.V20211101Preview
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.IoTCentral.V20211101Preview.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         PrivateEndpointConnectionName = "myIoTCentralAppEndpoint",
    ///         PrivateLinkServiceConnectionState = new AzureNative.IoTCentral.V20211101Preview.Inputs.PrivateLinkServiceConnectionStateArgs
    ///         {
    ...
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotcentral/v20211101preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotcentral/v20211101preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
