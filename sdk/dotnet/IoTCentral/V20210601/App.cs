...
namespace Pulumi.AzureNative.IoTCentral.V20210601
{
    ...
    /// {
    ///     var app = new AzureNative.IoTCentral.V20210601.App("app", new()
    ///     {
    ///         DisplayName = "My IoT Central App",
    ///         Identity = new AzureNative.IoTCentral.V20210601.Inputs.SystemAssignedServiceIdentityArgs
    ///         {
    ///             Type = "SystemAssigned",
    ///         },
    ///         Location = "westus",
    ...
    ///         Sku = new AzureNative.IoTCentral.V20210601.Inputs.AppSkuInfoArgs
    ///         {
    ///             Name = "ST2",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:iotcentral/v20210601:App")]
    public partial class App : global::Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotcentral/v20210601:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotcentral/v20210601:App", name, null, MakeResourceOptions(options, id))
        {
        }
