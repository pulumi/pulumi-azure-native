...
namespace Pulumi.AzureNative.ApplicationInsights.V20201120
{
    /// <summary>
    /// An Application Insights workbook template definition.
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights/v20201120:WorkbookTemplate")]
    public partial class WorkbookTemplate : global::Pulumi.CustomResource
    {
        ...
        public WorkbookTemplate(string name, WorkbookTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20201120:WorkbookTemplate", name, args ?? new WorkbookTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkbookTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20201120:WorkbookTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:applicationinsights:WorkbookTemplate" },
