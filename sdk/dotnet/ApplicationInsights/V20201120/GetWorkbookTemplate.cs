...
namespace Pulumi.AzureNative.ApplicationInsights.V20201120
{
    public static class GetWorkbookTemplate
    {
        ...
        public static Task<GetWorkbookTemplateResult> InvokeAsync(GetWorkbookTemplateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkbookTemplateResult>("azure-native:applicationinsights/v20201120:getWorkbookTemplate", args ?? new GetWorkbookTemplateArgs(), options.WithDefaults());

        /// <summary>
        /// Get a single workbook template by its resourceName.
        /// </summary>
        public static Output<GetWorkbookTemplateResult> Invoke(GetWorkbookTemplateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkbookTemplateResult>("azure-native:applicationinsights/v20201120:getWorkbookTemplate", args ?? new GetWorkbookTemplateInvokeArgs(), options.WithDefaults());
