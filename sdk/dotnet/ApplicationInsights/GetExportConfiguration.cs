...
namespace Pulumi.AzureNative.ApplicationInsights
{
    public static class GetExportConfiguration
    {
        ...
        public static Task<GetExportConfigurationResult> InvokeAsync(GetExportConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExportConfigurationResult>("azure-native:applicationinsights:getExportConfiguration", args ?? new GetExportConfigurationArgs(), options.WithDefaults());
        ...
        public static Output<GetExportConfigurationResult> Invoke(GetExportConfigurationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExportConfigurationResult>("azure-native:applicationinsights:getExportConfiguration", args ?? new GetExportConfigurationInvokeArgs(), options.WithDefaults());
