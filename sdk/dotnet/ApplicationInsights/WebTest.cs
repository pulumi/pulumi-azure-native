...
namespace Pulumi.AzureNative.ApplicationInsights
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights:WebTest")]
    public partial class WebTest : global::Pulumi.CustomResource
    {
        ...
        public WebTest(string name, WebTestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:WebTest", name, args ?? new WebTestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebTest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:WebTest", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_applicationinsights_v20150501:applicationinsights:WebTest" },
                    new global::Pulumi.Alias { Type = "azure-native_applicationinsights_v20180501preview:applicationinsights:WebTest" },
                    new global::Pulumi.Alias { Type = "azure-native_applicationinsights_v20201005preview:applicationinsights:WebTest" },
                    new global::Pulumi.Alias { Type = "azure-native_applicationinsights_v20220615:applicationinsights:WebTest" },
                },
            };
    ...
    public sealed class WebTestArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public Input<Pulumi.AzureNative.ApplicationInsights.WebTestKind>? Kind { get; set; }
        ...
        public Input<Pulumi.AzureNative.ApplicationInsights.WebTestKind> WebTestKind { get; set; } = null!;
        ...
        {
            Frequency = 300;
            Kind = Pulumi.AzureNative.ApplicationInsights.WebTestKind.Ping;
            Timeout = 30;
            WebTestKind = Pulumi.AzureNative.ApplicationInsights.WebTestKind.Ping;
        }
