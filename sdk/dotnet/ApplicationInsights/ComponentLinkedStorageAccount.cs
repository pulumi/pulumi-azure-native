...
namespace Pulumi.AzureNative.ApplicationInsights
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights:ComponentLinkedStorageAccount")]
    public partial class ComponentLinkedStorageAccount : global::Pulumi.CustomResource
    {
        ...
        public ComponentLinkedStorageAccount(string name, ComponentLinkedStorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:ComponentLinkedStorageAccount", name, args ?? new ComponentLinkedStorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComponentLinkedStorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:ComponentLinkedStorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
