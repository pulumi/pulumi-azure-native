...
namespace Pulumi.AzureNative.ApplicationInsights
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights:Favorite")]
    public partial class Favorite : global::Pulumi.CustomResource
    {
        ...
        public Favorite(string name, FavoriteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:Favorite", name, args ?? new FavoriteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Favorite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:Favorite", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_applicationinsights_v20150501:applicationinsights:Favorite" },
                },
            };
    ...
    public sealed class FavoriteArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("favoriteType")]
        public Input<Pulumi.AzureNative.ApplicationInsights.FavoriteType>? FavoriteType { get; set; }
