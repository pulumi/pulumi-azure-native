...
namespace Pulumi.AzureNative.ApplicationInsights
{
    public static class ListEASubscriptionListMigrationDatePost
    {
        ...
        public static Task<ListEASubscriptionListMigrationDatePostResult> InvokeAsync(ListEASubscriptionListMigrationDatePostArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListEASubscriptionListMigrationDatePostResult>("azure-native:applicationinsights:listEASubscriptionListMigrationDatePost", args ?? new ListEASubscriptionListMigrationDatePostArgs(), options.WithDefaults());
        ...
        public static Output<ListEASubscriptionListMigrationDatePostResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListEASubscriptionListMigrationDatePostResult>("azure-native:applicationinsights:listEASubscriptionListMigrationDatePost", InvokeArgs.Empty, options.WithDefaults());
