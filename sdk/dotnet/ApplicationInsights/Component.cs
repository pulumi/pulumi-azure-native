...
namespace Pulumi.AzureNative.ApplicationInsights
{
    ...
    public partial class Component : global::Pulumi.CustomResource
    {
        ...
        public Component(string name, ComponentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:Component", name, args ?? new ComponentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Component(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:Component", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ComponentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApplicationInsights.ApplicationType> ApplicationType { get; set; } = null!;
        ...
        /// </summary>
        [Input("flowType")]
        public InputUnion<string, Pulumi.AzureNative.ApplicationInsights.FlowType>? FlowType { get; set; }
        ...
        /// </summary>
        [Input("ingestionMode")]
        public InputUnion<string, Pulumi.AzureNative.ApplicationInsights.IngestionMode>? IngestionMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApplicationInsights.PublicNetworkAccessType>? PublicNetworkAccessForIngestion { get; set; }

        /// <summary>
        /// The network access type for accessing Application Insights query.
        /// </summary>
        [Input("publicNetworkAccessForQuery")]
        public InputUnion<string, Pulumi.AzureNative.ApplicationInsights.PublicNetworkAccessType>? PublicNetworkAccessForQuery { get; set; }

        /// <summary>
        /// Describes what tool created this Application Insights component. Customers using this API should set this to the default 'rest'.
        /// </summary>
        [Input("requestSource")]
        public InputUnion<string, Pulumi.AzureNative.ApplicationInsights.RequestSource>? RequestSource { get; set; }
