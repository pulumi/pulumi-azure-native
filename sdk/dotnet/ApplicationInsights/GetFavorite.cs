...
namespace Pulumi.AzureNative.ApplicationInsights
{
    public static class GetFavorite
    {
        ...
        public static Task<GetFavoriteResult> InvokeAsync(GetFavoriteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFavoriteResult>("azure-native:applicationinsights:getFavorite", args ?? new GetFavoriteArgs(), options.WithDefaults());
        ...
        public static Output<GetFavoriteResult> Invoke(GetFavoriteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFavoriteResult>("azure-native:applicationinsights:getFavorite", args ?? new GetFavoriteInvokeArgs(), options.WithDefaults());
