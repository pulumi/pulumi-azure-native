...
namespace Pulumi.AzureNative.ApplicationInsights
{
    public static class GetComponent
    {
        ...
        public static Task<GetComponentResult> InvokeAsync(GetComponentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetComponentResult>("azure-native:applicationinsights:getComponent", args ?? new GetComponentArgs(), options.WithDefaults());
        ...
        public static Output<GetComponentResult> Invoke(GetComponentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetComponentResult>("azure-native:applicationinsights:getComponent", args ?? new GetComponentInvokeArgs(), options.WithDefaults());
