...
namespace Pulumi.AzureNative.ApplicationInsights.V20200602Preview
{
    public static class GetLiveToken
    {
        ...
        public static Task<GetLiveTokenResult> InvokeAsync(GetLiveTokenArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLiveTokenResult>("azure-native:applicationinsights/v20200602preview:getLiveToken", args ?? new GetLiveTokenArgs(), options.WithDefaults());

        /// <summary>
        /// **Gets an access token for live metrics stream data.**
        /// </summary>
        public static Output<GetLiveTokenResult> Invoke(GetLiveTokenInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLiveTokenResult>("azure-native:applicationinsights/v20200602preview:getLiveToken", args ?? new GetLiveTokenInvokeArgs(), options.WithDefaults());
