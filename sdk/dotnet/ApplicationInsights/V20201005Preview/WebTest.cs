...
namespace Pulumi.AzureNative.ApplicationInsights.V20201005Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights/v20201005preview:WebTest")]
    public partial class WebTest : global::Pulumi.CustomResource
    {
        ...
        public WebTest(string name, WebTestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20201005preview:WebTest", name, args ?? new WebTestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebTest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20201005preview:WebTest", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:applicationinsights/v20150501:WebTest" },
                    new global::Pulumi.Alias { Type = "azure-native:applicationinsights/v20180501preview:WebTest" },
                    new global::Pulumi.Alias { Type = "azure-native:applicationinsights/v20220615:WebTest" },
                    new global::Pulumi.Alias { Type = "azure-native:applicationinsights:WebTest" },
    ...
    public sealed class WebTestArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public Input<Pulumi.AzureNative.ApplicationInsights.V20201005Preview.WebTestKind>? Kind { get; set; }
        ...
        public Input<Pulumi.AzureNative.ApplicationInsights.V20201005Preview.WebTestKindEnum> WebTestKind { get; set; } = null!;
        ...
        {
            Frequency = 300;
            Kind = Pulumi.AzureNative.ApplicationInsights.V20201005Preview.WebTestKind.Ping;
            Timeout = 30;
            WebTestKind = Pulumi.AzureNative.ApplicationInsights.V20201005Preview.WebTestKindEnum.Ping;
        }
