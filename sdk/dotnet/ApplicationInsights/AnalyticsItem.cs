...
namespace Pulumi.AzureNative.ApplicationInsights
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights:AnalyticsItem")]
    public partial class AnalyticsItem : global::Pulumi.CustomResource
    {
        ...
        public AnalyticsItem(string name, AnalyticsItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:AnalyticsItem", name, args ?? new AnalyticsItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AnalyticsItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:AnalyticsItem", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_applicationinsights_v20150501:applicationinsights:AnalyticsItem" },
                },
            };
    ...
    public sealed class AnalyticsItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("scope")]
        public InputUnion<string, Pulumi.AzureNative.ApplicationInsights.ItemScope>? Scope { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ApplicationInsights.ItemType>? Type { get; set; }
