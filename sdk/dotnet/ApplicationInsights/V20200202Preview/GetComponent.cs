...
namespace Pulumi.AzureNative.ApplicationInsights.V20200202Preview
{
    public static class GetComponent
    {
        ...
        public static Task<GetComponentResult> InvokeAsync(GetComponentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetComponentResult>("azure-native:applicationinsights/v20200202preview:getComponent", args ?? new GetComponentArgs(), options.WithDefaults());

        /// <summary>
        /// Returns an Application Insights component.
        /// </summary>
        public static Output<GetComponentResult> Invoke(GetComponentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetComponentResult>("azure-native:applicationinsights/v20200202preview:getComponent", args ?? new GetComponentInvokeArgs(), options.WithDefaults());
