...
namespace Pulumi.AzureNative.ApplicationInsights
{
    public static class GetAnalyticsItem
    {
        ...
        public static Task<GetAnalyticsItemResult> InvokeAsync(GetAnalyticsItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAnalyticsItemResult>("azure-native:applicationinsights:getAnalyticsItem", args ?? new GetAnalyticsItemArgs(), options.WithDefaults());
        ...
        public static Output<GetAnalyticsItemResult> Invoke(GetAnalyticsItemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAnalyticsItemResult>("azure-native:applicationinsights:getAnalyticsItem", args ?? new GetAnalyticsItemInvokeArgs(), options.WithDefaults());
