...
namespace Pulumi.AzureNative.ApplicationInsights.V20200210Preview
{
    public static class GetTestResultFile
    {
        ...
        public static Task<GetTestResultFileResult> InvokeAsync(GetTestResultFileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTestResultFileResult>("azure-native:applicationinsights/v20200210preview:getTestResultFile", args ?? new GetTestResultFileArgs(), options.WithDefaults());

        /// <summary>
        /// Returns a file test result for the matching test
        /// </summary>
        public static Output<GetTestResultFileResult> Invoke(GetTestResultFileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTestResultFileResult>("azure-native:applicationinsights/v20200210preview:getTestResultFile", args ?? new GetTestResultFileInvokeArgs(), options.WithDefaults());
