...
namespace Pulumi.AzureNative.ApplicationInsights
{
    public static class GetMyWorkbook
    {
        ...
        public static Task<GetMyWorkbookResult> InvokeAsync(GetMyWorkbookArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMyWorkbookResult>("azure-native:applicationinsights:getMyWorkbook", args ?? new GetMyWorkbookArgs(), options.WithDefaults());
        ...
        public static Output<GetMyWorkbookResult> Invoke(GetMyWorkbookInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMyWorkbookResult>("azure-native:applicationinsights:getMyWorkbook", args ?? new GetMyWorkbookInvokeArgs(), options.WithDefaults());
