...
namespace Pulumi.AzureNative.ApplicationInsights
{
    ...
    public partial class MyWorkbook : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("identity")]
        public Output<Outputs.MyWorkbookManagedIdentityResponse?> Identity { get; private set; } = null!;
        ...
        public MyWorkbook(string name, MyWorkbookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:MyWorkbook", name, args ?? new MyWorkbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MyWorkbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:MyWorkbook", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MyWorkbookArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("identity")]
        public Input<Inputs.MyWorkbookManagedIdentityArgs>? Identity { get; set; }

        /// <summary>
        /// The kind of workbook. Choices are user and shared.
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.ApplicationInsights.Kind>? Kind { get; set; }
