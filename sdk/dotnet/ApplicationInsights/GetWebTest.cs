...
namespace Pulumi.AzureNative.ApplicationInsights
{
    public static class GetWebTest
    {
        ...
        public static Task<GetWebTestResult> InvokeAsync(GetWebTestArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebTestResult>("azure-native:applicationinsights:getWebTest", args ?? new GetWebTestArgs(), options.WithDefaults());
        ...
        public static Output<GetWebTestResult> Invoke(GetWebTestInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebTestResult>("azure-native:applicationinsights:getWebTest", args ?? new GetWebTestInvokeArgs(), options.WithDefaults());
