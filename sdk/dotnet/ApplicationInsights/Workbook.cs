...
namespace Pulumi.AzureNative.ApplicationInsights
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights:Workbook")]
    public partial class Workbook : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("identity")]
        public Output<Outputs.WorkbookResourceIdentityResponse?> Identity { get; private set; } = null!;
        ...
        public Workbook(string name, WorkbookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:Workbook", name, args ?? new WorkbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:Workbook", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkbookArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.ApplicationInsights.WorkbookSharedTypeKind>? Kind { get; set; }
