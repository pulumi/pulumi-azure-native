...
namespace Pulumi.AzureNative.ApplicationInsights
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights:ComponentCurrentBillingFeature")]
    public partial class ComponentCurrentBillingFeature : global::Pulumi.CustomResource
    {
        ...
        public ComponentCurrentBillingFeature(string name, ComponentCurrentBillingFeatureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:ComponentCurrentBillingFeature", name, args ?? new ComponentCurrentBillingFeatureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComponentCurrentBillingFeature(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights:ComponentCurrentBillingFeature", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_applicationinsights_v20150501:applicationinsights:ComponentCurrentBillingFeature" },
                },
            };
