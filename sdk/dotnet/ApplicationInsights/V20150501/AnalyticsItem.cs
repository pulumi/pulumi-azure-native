...
namespace Pulumi.AzureNative.ApplicationInsights.V20150501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights/v20150501:AnalyticsItem")]
    public partial class AnalyticsItem : global::Pulumi.CustomResource
    {
        ...
        public AnalyticsItem(string name, AnalyticsItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20150501:AnalyticsItem", name, args ?? new AnalyticsItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AnalyticsItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20150501:AnalyticsItem", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:applicationinsights:AnalyticsItem" },
    ...
    public sealed class AnalyticsItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("scope")]
        public InputUnion<string, Pulumi.AzureNative.ApplicationInsights.V20150501.ItemScope>? Scope { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ApplicationInsights.V20150501.ItemType>? Type { get; set; }
