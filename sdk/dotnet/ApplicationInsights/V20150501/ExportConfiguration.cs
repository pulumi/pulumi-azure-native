...
namespace Pulumi.AzureNative.ApplicationInsights.V20150501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights/v20150501:ExportConfiguration")]
    public partial class ExportConfiguration : global::Pulumi.CustomResource
    {
        ...
        public ExportConfiguration(string name, ExportConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20150501:ExportConfiguration", name, args ?? new ExportConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExportConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20150501:ExportConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:applicationinsights:ExportConfiguration" },
