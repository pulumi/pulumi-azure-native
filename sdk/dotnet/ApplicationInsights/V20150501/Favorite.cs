...
namespace Pulumi.AzureNative.ApplicationInsights.V20150501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights/v20150501:Favorite")]
    public partial class Favorite : global::Pulumi.CustomResource
    {
        ...
        public Favorite(string name, FavoriteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20150501:Favorite", name, args ?? new FavoriteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Favorite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20150501:Favorite", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:applicationinsights:Favorite" },
    ...
    public sealed class FavoriteArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("favoriteType")]
        public Input<Pulumi.AzureNative.ApplicationInsights.V20150501.FavoriteType>? FavoriteType { get; set; }
