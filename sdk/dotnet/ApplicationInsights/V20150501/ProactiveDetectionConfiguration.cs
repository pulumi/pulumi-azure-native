...
namespace Pulumi.AzureNative.ApplicationInsights.V20150501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights/v20150501:ProactiveDetectionConfiguration")]
    public partial class ProactiveDetectionConfiguration : global::Pulumi.CustomResource
    {
        ...
        public ProactiveDetectionConfiguration(string name, ProactiveDetectionConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20150501:ProactiveDetectionConfiguration", name, args ?? new ProactiveDetectionConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProactiveDetectionConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20150501:ProactiveDetectionConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:applicationinsights:ProactiveDetectionConfiguration" },
