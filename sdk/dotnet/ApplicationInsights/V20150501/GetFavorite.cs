...
namespace Pulumi.AzureNative.ApplicationInsights.V20150501
{
    public static class GetFavorite
    {
        ...
        public static Task<GetFavoriteResult> InvokeAsync(GetFavoriteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFavoriteResult>("azure-native:applicationinsights/v20150501:getFavorite", args ?? new GetFavoriteArgs(), options.WithDefaults());

        /// <summary>
        /// Get a single favorite by its FavoriteId, defined within an Application Insights component.
        /// </summary>
        public static Output<GetFavoriteResult> Invoke(GetFavoriteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFavoriteResult>("azure-native:applicationinsights/v20150501:getFavorite", args ?? new GetFavoriteInvokeArgs(), options.WithDefaults());
