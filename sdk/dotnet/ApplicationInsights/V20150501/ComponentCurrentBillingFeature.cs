...
namespace Pulumi.AzureNative.ApplicationInsights.V20150501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights/v20150501:ComponentCurrentBillingFeature")]
    public partial class ComponentCurrentBillingFeature : global::Pulumi.CustomResource
    {
        ...
        public ComponentCurrentBillingFeature(string name, ComponentCurrentBillingFeatureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20150501:ComponentCurrentBillingFeature", name, args ?? new ComponentCurrentBillingFeatureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComponentCurrentBillingFeature(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20150501:ComponentCurrentBillingFeature", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:applicationinsights:ComponentCurrentBillingFeature" },
