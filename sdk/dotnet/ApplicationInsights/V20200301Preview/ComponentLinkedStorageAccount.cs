...
namespace Pulumi.AzureNative.ApplicationInsights.V20200301Preview
{
    /// <summary>
    /// An Application Insights component linked storage accounts
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights/v20200301preview:ComponentLinkedStorageAccount")]
    public partial class ComponentLinkedStorageAccount : global::Pulumi.CustomResource
    {
        ...
        public ComponentLinkedStorageAccount(string name, ComponentLinkedStorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20200301preview:ComponentLinkedStorageAccount", name, args ?? new ComponentLinkedStorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComponentLinkedStorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20200301preview:ComponentLinkedStorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:applicationinsights:ComponentLinkedStorageAccount" },
