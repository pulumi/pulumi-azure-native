...
namespace Pulumi.AzureNative.ApplicationInsights.V20180501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:applicationinsights/v20180501preview:ProactiveDetectionConfiguration")]
    public partial class ProactiveDetectionConfiguration : global::Pulumi.CustomResource
    {
        ...
        public ProactiveDetectionConfiguration(string name, ProactiveDetectionConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20180501preview:ProactiveDetectionConfiguration", name, args ?? new ProactiveDetectionConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProactiveDetectionConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:applicationinsights/v20180501preview:ProactiveDetectionConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
