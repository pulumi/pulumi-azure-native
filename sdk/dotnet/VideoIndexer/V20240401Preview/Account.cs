...
namespace Pulumi.AzureNative.VideoIndexer.V20240401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:videoindexer/v20240401preview:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:videoindexer/v20240401preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:videoindexer/v20240401preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
