...
namespace Pulumi.AzureNative.VideoIndexer.V20250301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:videoindexer/v20250301:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:videoindexer/v20250301:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:videoindexer/v20250301:Account", name, null, MakeResourceOptions(options, id))
        {
        }
