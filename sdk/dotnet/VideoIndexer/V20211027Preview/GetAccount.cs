...
namespace Pulumi.AzureNative.VideoIndexer.V20211027Preview
{
    [Obsolete(@"azure-native:videoindexer/v20211027preview:Account is being removed in the next major version of this provider. Upgrade to at least azure-native:videoindexer/v20220801:Account to guarantee forwards compatibility.")]
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azure-native:videoindexer/v20211027preview:getAccount", args ?? new GetAccountArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of an Azure Video Analyzer for Media account.
        /// </summary>
        public static Output<GetAccountResult> Invoke(GetAccountInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccountResult>("azure-native:videoindexer/v20211027preview:getAccount", args ?? new GetAccountInvokeArgs(), options.WithDefaults());
    }
