...
namespace Pulumi.AzureNative.VideoIndexer.V20220413Preview
{
    /// <summary>
    /// An Azure Video Indexer account.
    /// </summary>
    [Obsolete(@"azure-native:videoindexer/v20220413preview:Account is being removed in the next major version of this provider. Upgrade to at least azure-native:videoindexer/v20220801:Account to guarantee forwards compatibility.")]
    ...
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:videoindexer/v20220413preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:videoindexer/v20220413preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
