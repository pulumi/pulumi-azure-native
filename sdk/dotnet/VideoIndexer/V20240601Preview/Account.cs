...
namespace Pulumi.AzureNative.VideoIndexer.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:videoindexer/v20240601preview:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:videoindexer/v20240601preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:videoindexer/v20240601preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.VideoIndexer.V20240601Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
