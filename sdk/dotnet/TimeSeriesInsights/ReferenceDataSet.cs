...
namespace Pulumi.AzureRM.TimeSeriesInsights
{
    ...
    public partial class ReferenceDataSet : Pulumi.CustomResource
    {
        ...
        public ReferenceDataSet(string name, ReferenceDataSetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights:ReferenceDataSet", name, args ?? new ReferenceDataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReferenceDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights:ReferenceDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
