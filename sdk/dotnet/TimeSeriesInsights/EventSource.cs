...
namespace Pulumi.AzureRM.TimeSeriesInsights
{
    ...
    public partial class EventSource : Pulumi.CustomResource
    {
        ...
        public EventSource(string name, EventSourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights:EventSource", name, args ?? new EventSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights:EventSource", name, null, MakeResourceOptions(options, id))
        {
        }
