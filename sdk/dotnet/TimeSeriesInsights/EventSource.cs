...
namespace Pulumi.AzureNextGen.TimeSeriesInsights
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:timeseriesinsights:EventSource")]
    public partial class EventSource : Pulumi.CustomResource
    {
        ...
        public EventSource(string name, EventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:timeseriesinsights:EventSource", name, args ?? new EventSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:timeseriesinsights:EventSource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventSourceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.TimeSeriesInsights.EventSourceKind> Kind { get; set; } = null!;
