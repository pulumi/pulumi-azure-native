...
namespace Pulumi.AzureRM.TimeSeriesInsights.Latest
{
    ...
    public partial class AccessPolicy : Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights/latest:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights/latest:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
