...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210331Preview
{
    ...
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20210331preview:EventSource")]
    public partial class EventSource : global::Pulumi.CustomResource
    {
        ...
        public EventSource(string name, EventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210331preview:EventSource", name, args ?? new EventSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210331preview:EventSource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:timeseriesinsights/v20180815preview:EventSource"},
    ...
    public sealed class EventSourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TimeSeriesInsights.V20210331Preview.EventSourceKind> Kind { get; set; } = null!;
