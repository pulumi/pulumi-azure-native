...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210331Preview
{
    public static class GetGen2Environment
    {
        ...
        public static Task<GetGen2EnvironmentResult> InvokeAsync(GetGen2EnvironmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGen2EnvironmentResult>("azure-native:timeseriesinsights/v20210331preview:getGen2Environment", args ?? new GetGen2EnvironmentArgs(), options.WithDefaults());

        /// <summary>
        /// An environment is a set of time-series data available for query, and is the top level Azure Time Series Insights resource. Gen2 environments do not have set data retention limits.
        /// </summary>
        public static Output<GetGen2EnvironmentResult> Invoke(GetGen2EnvironmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGen2EnvironmentResult>("azure-native:timeseriesinsights/v20210331preview:getGen2Environment", args ?? new GetGen2EnvironmentInvokeArgs(), options.WithDefaults());
    }
