...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210331Preview
{
    public static class GetAccessPolicy
    {
        ...
        public static Task<GetAccessPolicyResult> InvokeAsync(GetAccessPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccessPolicyResult>("azure-native:timeseriesinsights/v20210331preview:getAccessPolicy", args ?? new GetAccessPolicyArgs(), options.WithVersion());

        /// <summary>
        /// An access policy is used to grant users and applications access to the environment. Roles are assigned to service principals in Azure Active Directory. These roles define the actions the principal can perform through the Time Series Insights data plane APIs.
        /// </summary>
        public static Output<GetAccessPolicyResult> Invoke(GetAccessPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAccessPolicyResult>("azure-native:timeseriesinsights/v20210331preview:getAccessPolicy", args ?? new GetAccessPolicyInvokeArgs(), options.WithVersion());
    }
