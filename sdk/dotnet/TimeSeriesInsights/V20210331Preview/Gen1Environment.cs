...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210331Preview
{
    ...
    /// {
    ///     var gen1Environment = new AzureNative.TimeSeriesInsights.V20210331Preview.Gen1Environment("gen1Environment", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.TimeSeriesInsights.V20210331Preview.Inputs.TimeSeriesIdPropertyArgs
    ///             {
    ///                 Name = "DeviceId1",
    ///                 Type = "String",
    ///             },
    ...
    ///         Sku = new AzureNative.TimeSeriesInsights.V20210331Preview.Inputs.SkuArgs
    ///         {
    ///             Capacity = 1,
    ///             Name = "S1",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:timeseriesinsights/v20210331preview:Gen1Environment env1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.TimeSeriesInsights/Environments/env1 
    /// ```
    /// </summary>
    ...
    public partial class Gen1Environment : global::Pulumi.CustomResource
    {
        ...
        public Gen1Environment(string name, Gen1EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210331preview:Gen1Environment", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private Gen1Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210331preview:Gen1Environment", name, null, MakeResourceOptions(options, id))
        {
        }
