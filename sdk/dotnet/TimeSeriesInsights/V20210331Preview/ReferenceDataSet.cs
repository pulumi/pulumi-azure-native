...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210331Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20210331preview:ReferenceDataSet")]
    public partial class ReferenceDataSet : global::Pulumi.CustomResource
    {
        ...
        public ReferenceDataSet(string name, ReferenceDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210331preview:ReferenceDataSet", name, args ?? new ReferenceDataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReferenceDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210331preview:ReferenceDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ReferenceDataSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TimeSeriesInsights.V20210331Preview.DataStringComparisonBehavior>? DataStringComparisonBehavior { get; set; }
