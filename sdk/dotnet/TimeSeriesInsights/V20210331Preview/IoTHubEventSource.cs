...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210331Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:timeseriesinsights/v20210331preview:IoTHubEventSource is being removed in the next major version of this provider. Upgrade to at least azure-native:timeseriesinsights/v20210630preview:IoTHubEventSource to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20210331preview:IoTHubEventSource")]
    public partial class IoTHubEventSource : global::Pulumi.CustomResource
    {
        ...
        public IoTHubEventSource(string name, IoTHubEventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210331preview:IoTHubEventSource", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTHubEventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210331preview:IoTHubEventSource", name, null, MakeResourceOptions(options, id))
        {
        }
