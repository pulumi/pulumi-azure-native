...
namespace Pulumi.AzureNative.TimeSeriesInsights
{
    public static class GetReferenceDataSet
    {
        ...
        public static Output<GetReferenceDataSetResult> Invoke(GetReferenceDataSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetReferenceDataSetResult>("azure-native:timeseriesinsights:getReferenceDataSet", args ?? new GetReferenceDataSetInvokeArgs(), options.WithVersion());
    }
