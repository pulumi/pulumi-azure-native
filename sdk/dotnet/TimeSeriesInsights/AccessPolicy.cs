...
namespace Pulumi.AzureRM.TimeSeriesInsights
{
    ...
    public partial class AccessPolicy : Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
