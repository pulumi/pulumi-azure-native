...
namespace Pulumi.AzureRM.TimeSeriesInsights.Preview
{
    ...
    public partial class ReferenceDataSet : Pulumi.CustomResource
    {
        ...
        public ReferenceDataSet(string name, ReferenceDataSetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights/preview:ReferenceDataSet", name, args ?? new ReferenceDataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReferenceDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights/preview:ReferenceDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
