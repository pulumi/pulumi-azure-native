...
namespace Pulumi.AzureRM.TimeSeriesInsights.Preview
{
    public static class GetAccessPolicy
    {
        public static Task<GetAccessPolicyResult> InvokeAsync(GetAccessPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccessPolicyResult>("azurerm:timeseriesinsights/preview:getAccessPolicy", args ?? new GetAccessPolicyArgs(), options.WithVersion());
    }
