...
namespace Pulumi.AzureRM.TimeSeriesInsights.V20170228Preview
{
    public static class GetAccessPolicy
    {
        public static Task<GetAccessPolicyResult> InvokeAsync(GetAccessPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccessPolicyResult>("azurerm:timeseriesinsights/v20170228preview:getAccessPolicy", args ?? new GetAccessPolicyArgs(), options.WithVersion());
    }
