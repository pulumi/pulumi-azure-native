...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20170228Preview
{
    ...
    public partial class IoTHubEventSource : Pulumi.CustomResource
    {
        ...
        public IoTHubEventSource(string name, IoTHubEventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20170228preview:IoTHubEventSource", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTHubEventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20170228preview:IoTHubEventSource", name, null, MakeResourceOptions(options, id))
        {
        }
