...
namespace Pulumi.AzureNextGen.TimeSeriesInsights.V20170228Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:timeseriesinsights/v20170228preview:AccessPolicy")]
    public partial class AccessPolicy : Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:timeseriesinsights/v20170228preview:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:timeseriesinsights/v20170228preview:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccessPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("roles")]
        private InputList<Pulumi.AzureNextGen.TimeSeriesInsights.V20170228Preview.AccessPolicyRole>? _roles;

        /// <summary>
        /// The list of roles the principal is assigned on the environment.
        /// </summary>
        public InputList<Pulumi.AzureNextGen.TimeSeriesInsights.V20170228Preview.AccessPolicyRole> Roles
        {
            get => _roles ?? (_roles = new InputList<Pulumi.AzureNextGen.TimeSeriesInsights.V20170228Preview.AccessPolicyRole>());
            set => _roles = value;
        }
