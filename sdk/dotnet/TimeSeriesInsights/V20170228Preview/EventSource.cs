...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20170228Preview
{
    ...
    public partial class EventSource : global::Pulumi.CustomResource
    {
        ...
        public EventSource(string name, EventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20170228preview:EventSource", name, args ?? new EventSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20170228preview:EventSource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventSourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.TimeSeriesInsights.V20170228Preview.Kind> Kind { get; set; } = null!;
