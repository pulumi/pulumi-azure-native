...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20180815Preview
{
    public static class GetEventHubEventSource
    {
        ...
        public static Task<GetEventHubEventSourceResult> InvokeAsync(GetEventHubEventSourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEventHubEventSourceResult>("azure-native:timeseriesinsights/v20180815preview:getEventHubEventSource", args ?? new GetEventHubEventSourceArgs(), options.WithDefaults());
        ...
        public static Output<GetEventHubEventSourceResult> Invoke(GetEventHubEventSourceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEventHubEventSourceResult>("azure-native:timeseriesinsights/v20180815preview:getEventHubEventSource", args ?? new GetEventHubEventSourceInvokeArgs(), options.WithDefaults());
    }
