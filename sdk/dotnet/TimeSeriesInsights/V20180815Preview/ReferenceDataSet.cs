...
azure-native:timeseriesinsights/v20180815preview:ReferenceDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:timeseriesinsights/v20210630preview:ReferenceDataSet to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20180815preview:ReferenceDataSet")]
    public partial class ReferenceDataSet : global::Pulumi.CustomResource
    {
        ...
        public ReferenceDataSet(string name, ReferenceDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20180815preview:ReferenceDataSet", name, args ?? new ReferenceDataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReferenceDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20180815preview:ReferenceDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
