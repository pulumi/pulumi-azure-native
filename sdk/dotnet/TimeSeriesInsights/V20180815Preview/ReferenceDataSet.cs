...
namespace Pulumi.AzureNextGen.TimeSeriesInsights.V20180815Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:timeseriesinsights/v20180815preview:ReferenceDataSet")]
    public partial class ReferenceDataSet : Pulumi.CustomResource
    {
        ...
        public ReferenceDataSet(string name, ReferenceDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:timeseriesinsights/v20180815preview:ReferenceDataSet", name, args ?? new ReferenceDataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReferenceDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:timeseriesinsights/v20180815preview:ReferenceDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ReferenceDataSetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.TimeSeriesInsights.V20180815Preview.DataStringComparisonBehavior>? DataStringComparisonBehavior { get; set; }
