...
namespace Pulumi.AzureRM.TimeSeriesInsights.V20180815Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var accessPolicy = new AzureRM.TimeSeriesInsights.V20180815Preview.AccessPolicy("accessPolicy", new AzureRM.TimeSeriesInsights.V20180815Preview.AccessPolicyArgs
    ///         {
    ...
    public partial class AccessPolicy : Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights/v20180815preview:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights/v20180815preview:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
