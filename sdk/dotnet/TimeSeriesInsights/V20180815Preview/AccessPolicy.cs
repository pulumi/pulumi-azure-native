...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20180815Preview
{
    ...
    public partial class AccessPolicy : Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20180815preview:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20180815preview:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccessPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("roles")]
        private InputList<Union<string, Pulumi.AzureNative.TimeSeriesInsights.V20180815Preview.AccessPolicyRole>>? _roles;

        /// <summary>
        /// The list of roles the principal is assigned on the environment.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.TimeSeriesInsights.V20180815Preview.AccessPolicyRole>> Roles
        {
            get => _roles ?? (_roles = new InputList<Union<string, Pulumi.AzureNative.TimeSeriesInsights.V20180815Preview.AccessPolicyRole>>());
            set => _roles = value;
        }
