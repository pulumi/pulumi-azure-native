...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20180815Preview.Inputs
{
    ...
    /// </summary>
    public sealed class StandardEnvironmentCreationPropertiesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public InputUnion<string, Pulumi.AzureNative.TimeSeriesInsights.V20180815Preview.StorageLimitExceededBehavior>? StorageLimitExceededBehavior { get; set; }

        public StandardEnvironmentCreationPropertiesArgs()
        {
        }
        public static new StandardEnvironmentCreationPropertiesArgs Empty => new StandardEnvironmentCreationPropertiesArgs();
    }
}
