...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20180815Preview
{
    ...
    /// {
    ///     var eventHubEventSource = new AzureNative.TimeSeriesInsights.V20180815Preview.EventHubEventSource("eventHubEventSource", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20180815preview:EventHubEventSource")]
    public partial class EventHubEventSource : global::Pulumi.CustomResource
    {
        ...
        public EventHubEventSource(string name, EventHubEventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20180815preview:EventHubEventSource", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EventHubEventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20180815preview:EventHubEventSource", name, null, MakeResourceOptions(options, id))
        {
        }
