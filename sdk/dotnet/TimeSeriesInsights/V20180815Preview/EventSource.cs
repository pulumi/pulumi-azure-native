...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20180815Preview
{
    ...
    public partial class EventSource : global::Pulumi.CustomResource
    {
        ...
        public EventSource(string name, EventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20180815preview:EventSource", name, args ?? new EventSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20180815preview:EventSource", name, null, MakeResourceOptions(options, id))
        {
        }
