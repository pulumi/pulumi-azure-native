...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20180815Preview
{
    ...
    public partial class Environment : Pulumi.CustomResource
    {
        ...
        public Environment(string name, EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20180815preview:Environment", name, args ?? new EnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20180815preview:Environment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EnvironmentArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TimeSeriesInsights.V20180815Preview.Kind> Kind { get; set; } = null!;
