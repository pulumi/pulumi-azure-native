...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview
{
    public static class GetIoTHubEventSource
    {
        ...
        public static Task<GetIoTHubEventSourceResult> InvokeAsync(GetIoTHubEventSourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIoTHubEventSourceResult>("azure-native:timeseriesinsights/v20210630preview:getIoTHubEventSource", args ?? new GetIoTHubEventSourceArgs(), options.WithVersion());

        /// <summary>
        /// An event source that receives its data from an Azure IoTHub.
        /// </summary>
        public static Output<GetIoTHubEventSourceResult> Invoke(GetIoTHubEventSourceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIoTHubEventSourceResult>("azure-native:timeseriesinsights/v20210630preview:getIoTHubEventSource", args ?? new GetIoTHubEventSourceInvokeArgs(), options.WithVersion());
    }
