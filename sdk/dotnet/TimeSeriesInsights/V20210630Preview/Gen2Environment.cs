...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview
{
    ...
    /// {
    ///     var gen2Environment = new AzureNative.TimeSeriesInsights.V20210630Preview.Gen2Environment("gen2Environment", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:timeseriesinsights/v20210630preview:Gen2Environment env1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.TimeSeriesInsights/Environments/env1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20210630preview:Gen2Environment")]
    public partial class Gen2Environment : global::Pulumi.CustomResource
    {
        ...
        public Gen2Environment(string name, Gen2EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210630preview:Gen2Environment", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private Gen2Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210630preview:Gen2Environment", name, null, MakeResourceOptions(options, id))
        {
        }
