...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview
{
    ...
    public static class GetEnvironment
    {
        ...
        public static Task<GetEnvironmentResult> InvokeAsync(GetEnvironmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEnvironmentResult>("azure-native:timeseriesinsights/v20210630preview:getEnvironment", args ?? new GetEnvironmentArgs(), options.WithVersion());

        /// <summary>
        /// An environment is a set of time-series data available for query, and is the top level Azure Time Series Insights resource.
        /// </summary>
        public static Output<GetEnvironmentResult> Invoke(GetEnvironmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEnvironmentResult>("azure-native:timeseriesinsights/v20210630preview:getEnvironment", args ?? new GetEnvironmentInvokeArgs(), options.WithVersion());
    }
