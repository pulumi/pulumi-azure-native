...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview
{
    ...
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20210630preview:EventSource")]
    public partial class EventSource : Pulumi.CustomResource
    {
        ...
        public EventSource(string name, EventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210630preview:EventSource", name, args ?? new EventSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210630preview:EventSource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventSourceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview.EventSourceKind> Kind { get; set; } = null!;
