...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview
{
    ...
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20210630preview:Environment")]
    public partial class Environment : global::Pulumi.CustomResource
    {
        ...
        public Environment(string name, EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210630preview:Environment", name, args ?? new EnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210630preview:Environment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:timeseriesinsights/v20170228preview:Environment"},
    ...
    public sealed class EnvironmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview.EnvironmentKind> Kind { get; set; } = null!;
