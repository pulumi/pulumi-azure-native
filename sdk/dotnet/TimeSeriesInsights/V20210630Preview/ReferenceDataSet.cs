...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview
{
    ...
    /// {
    ///     var referenceDataSet = new AzureNative.TimeSeriesInsights.V20210630Preview.ReferenceDataSet("referenceDataSet", new()
    ///     {
    ///         EnvironmentName = "env1",
    ///         KeyProperties = new[]
    ///         {
    ///             new AzureNative.TimeSeriesInsights.V20210630Preview.Inputs.ReferenceDataSetKeyPropertyArgs
    ///             {
    ///                 Name = "DeviceId1",
    ///                 Type = "String",
    ///             },
    ...
    public partial class ReferenceDataSet : global::Pulumi.CustomResource
    {
        ...
        public ReferenceDataSet(string name, ReferenceDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210630preview:ReferenceDataSet", name, args ?? new ReferenceDataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReferenceDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210630preview:ReferenceDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
