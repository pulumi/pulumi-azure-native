...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview
{
    ...
    /// {
    ///     var eventHubEventSource = new AzureNative.TimeSeriesInsights.V20210630Preview.EventHubEventSource("eventHubEventSource", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:timeseriesinsights/v20210630preview:EventHubEventSource es1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.TimeSeriesInsights/Environments/env1/eventSources/es1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20210630preview:EventHubEventSource")]
    public partial class EventHubEventSource : global::Pulumi.CustomResource
    {
        ...
        public EventHubEventSource(string name, EventHubEventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210630preview:EventHubEventSource", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EventHubEventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210630preview:EventHubEventSource", name, null, MakeResourceOptions(options, id))
        {
        }
