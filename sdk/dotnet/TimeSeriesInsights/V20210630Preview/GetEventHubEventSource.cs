...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview
{
    public static class GetEventHubEventSource
    {
        ...
        public static Task<GetEventHubEventSourceResult> InvokeAsync(GetEventHubEventSourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEventHubEventSourceResult>("azure-native:timeseriesinsights/v20210630preview:getEventHubEventSource", args ?? new GetEventHubEventSourceArgs(), options.WithVersion());
        ...
        public static Output<GetEventHubEventSourceResult> Invoke(GetEventHubEventSourceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEventHubEventSourceResult>("azure-native:timeseriesinsights/v20210630preview:getEventHubEventSource", args ?? new GetEventHubEventSourceInvokeArgs(), options.WithVersion());
    }
