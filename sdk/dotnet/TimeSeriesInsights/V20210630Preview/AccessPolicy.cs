...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview
{
    ...
    /// {
    ///     var accessPolicy = new AzureNative.TimeSeriesInsights.V20210630Preview.AccessPolicy("accessPolicy", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:timeseriesinsights/v20210630preview:AccessPolicy ap1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.TimeSeriesInsights/Environments/env1/accessPolicies/ap1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20210630preview:AccessPolicy")]
    public partial class AccessPolicy : global::Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210630preview:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20210630preview:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccessPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("roles")]
        private InputList<Union<string, Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview.AccessPolicyRole>>? _roles;

        /// <summary>
        /// The list of roles the principal is assigned on the environment.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview.AccessPolicyRole>> Roles
        {
            get => _roles ?? (_roles = new InputList<Union<string, Pulumi.AzureNative.TimeSeriesInsights.V20210630Preview.AccessPolicyRole>>());
            set => _roles = value;
        }
