...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20200515
{
    ...
    /// {
    ///     var ioTHubEventSource = new AzureNative.TimeSeriesInsights.V20200515.IoTHubEventSource("ioTHubEventSource", new()
    ///     {
    ...
    public partial class IoTHubEventSource : global::Pulumi.CustomResource
    {
        ...
        public IoTHubEventSource(string name, IoTHubEventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20200515:IoTHubEventSource", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTHubEventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20200515:IoTHubEventSource", name, null, MakeResourceOptions(options, id))
        {
        }
