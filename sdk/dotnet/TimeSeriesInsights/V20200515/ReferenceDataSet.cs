...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20200515
{
    ...
    /// {
    ///     var referenceDataSet = new AzureNative.TimeSeriesInsights.V20200515.ReferenceDataSet("referenceDataSet", new()
    ///     {
    ///         EnvironmentName = "env1",
    ///         KeyProperties = new[]
    ///         {
    ///             new AzureNative.TimeSeriesInsights.V20200515.Inputs.ReferenceDataSetKeyPropertyArgs
    ///             {
    ///                 Name = "DeviceId1",
    ///                 Type = "String",
    ///             },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20200515:ReferenceDataSet")]
    public partial class ReferenceDataSet : global::Pulumi.CustomResource
    {
        ...
        public ReferenceDataSet(string name, ReferenceDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20200515:ReferenceDataSet", name, args ?? new ReferenceDataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReferenceDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20200515:ReferenceDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ReferenceDataSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TimeSeriesInsights.V20200515.DataStringComparisonBehavior>? DataStringComparisonBehavior { get; set; }
