...
namespace Pulumi.AzureRM.TimeSeriesInsights.V20200515
{
    public static class GetEventSource
    {
        public static Task<GetEventSourceResult> InvokeAsync(GetEventSourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEventSourceResult>("azurerm:timeseriesinsights/v20200515:getEventSource", args ?? new GetEventSourceArgs(), options.WithVersion());
    }
