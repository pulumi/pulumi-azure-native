...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20200515
{
    ...
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20200515:EventSource")]
    public partial class EventSource : global::Pulumi.CustomResource
    {
        ...
        public EventSource(string name, EventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20200515:EventSource", name, args ?? new EventSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20200515:EventSource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventSourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TimeSeriesInsights.V20200515.EventSourceKind> Kind { get; set; } = null!;
