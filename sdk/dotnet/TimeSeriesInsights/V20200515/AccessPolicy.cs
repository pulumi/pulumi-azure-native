...
namespace Pulumi.AzureNextGen.TimeSeriesInsights.V20200515
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:timeseriesinsights/v20200515:AccessPolicy")]
    public partial class AccessPolicy : Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:timeseriesinsights/v20200515:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:timeseriesinsights/v20200515:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccessPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("roles")]
        private InputList<Union<string, Pulumi.AzureNextGen.TimeSeriesInsights.V20200515.AccessPolicyRole>>? _roles;

        /// <summary>
        /// The list of roles the principal is assigned on the environment.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.TimeSeriesInsights.V20200515.AccessPolicyRole>> Roles
        {
            get => _roles ?? (_roles = new InputList<Union<string, Pulumi.AzureNextGen.TimeSeriesInsights.V20200515.AccessPolicyRole>>());
            set => _roles = value;
        }
