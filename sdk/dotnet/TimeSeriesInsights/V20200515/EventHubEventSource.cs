...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20200515
{
    ...
    /// {
    ///     var eventHubEventSource = new AzureNative.TimeSeriesInsights.V20200515.EventHubEventSource("eventHubEventSource", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:timeseriesinsights/v20200515:EventHubEventSource")]
    public partial class EventHubEventSource : global::Pulumi.CustomResource
    {
        ...
        public EventHubEventSource(string name, EventHubEventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20200515:EventHubEventSource", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EventHubEventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20200515:EventHubEventSource", name, null, MakeResourceOptions(options, id))
        {
        }
