...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20200515
{
    public static class GetGen2Environment
    {
        ...
        public static Task<GetGen2EnvironmentResult> InvokeAsync(GetGen2EnvironmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGen2EnvironmentResult>("azure-native:timeseriesinsights/v20200515:getGen2Environment", args ?? new GetGen2EnvironmentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the environment with the specified name in the specified subscription and resource group.
        /// </summary>
        public static Output<GetGen2EnvironmentResult> Invoke(GetGen2EnvironmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGen2EnvironmentResult>("azure-native:timeseriesinsights/v20200515:getGen2Environment", args ?? new GetGen2EnvironmentInvokeArgs(), options.WithDefaults());
    }
