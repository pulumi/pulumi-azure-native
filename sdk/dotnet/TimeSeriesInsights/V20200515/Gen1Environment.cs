...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20200515
{
    ...
    public partial class Gen1Environment : Pulumi.CustomResource
    {
        ...
        public Gen1Environment(string name, Gen1EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20200515:Gen1Environment", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private Gen1Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20200515:Gen1Environment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class Gen1EnvironmentArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TimeSeriesInsights.V20200515.StorageLimitExceededBehavior>? StorageLimitExceededBehavior { get; set; }
