...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20171115
{
    ...
    public partial class EventHubEventSource : Pulumi.CustomResource
    {
        ...
        public EventHubEventSource(string name, EventHubEventSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20171115:EventHubEventSource", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EventHubEventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20171115:EventHubEventSource", name, null, MakeResourceOptions(options, id))
        {
        }
