...
namespace Pulumi.AzureNextGen.TimeSeriesInsights.V20171115
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:timeseriesinsights/v20171115:Environment")]
    public partial class Environment : Pulumi.CustomResource
    {
        ...
        public Environment(string name, EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:timeseriesinsights/v20171115:Environment", name, args ?? new EnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:timeseriesinsights/v20171115:Environment", name, null, MakeResourceOptions(options, id))
        {
        }
