...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20171115
{
    ...
    public partial class Environment : global::Pulumi.CustomResource
    {
        ...
        public Environment(string name, EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20171115:Environment", name, args ?? new EnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20171115:Environment", name, null, MakeResourceOptions(options, id))
        {
        }
