...
namespace Pulumi.AzureRM.TimeSeriesInsights.V20171115
{
    ...
    ///     public MyStack()
    ///     {
    ///         var eventSource = new AzureRM.TimeSeriesInsights.V20171115.EventSource("eventSource", new AzureRM.TimeSeriesInsights.V20171115.EventSourceArgs
    ///         {
    ...
    public partial class EventSource : Pulumi.CustomResource
    {
        ...
        public EventSource(string name, EventSourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights/v20171115:EventSource", name, args ?? new EventSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights/v20171115:EventSource", name, null, MakeResourceOptions(options, id))
        {
        }
