...
namespace Pulumi.AzureRM.TimeSeriesInsights.V20171115
{
    ...
    ///     public MyStack()
    ///     {
    ///         var referenceDataSet = new AzureRM.TimeSeriesInsights.V20171115.ReferenceDataSet("referenceDataSet", new AzureRM.TimeSeriesInsights.V20171115.ReferenceDataSetArgs
    ///         {
    ///             EnvironmentName = "env1",
    ///             KeyProperties = 
    ///             {
    ///                 new AzureRM.TimeSeriesInsights.V20171115.Inputs.ReferenceDataSetKeyPropertyArgs
    ///                 {
    ///                     Name = "DeviceId1",
    ///                     Type = "String",
    ///                 },
    ...
    public partial class ReferenceDataSet : Pulumi.CustomResource
    {
        ...
        public ReferenceDataSet(string name, ReferenceDataSetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights/v20171115:ReferenceDataSet", name, args ?? new ReferenceDataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReferenceDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:timeseriesinsights/v20171115:ReferenceDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
