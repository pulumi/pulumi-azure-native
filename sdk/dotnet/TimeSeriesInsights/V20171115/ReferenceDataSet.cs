...
namespace Pulumi.AzureNextGen.TimeSeriesInsights.V20171115
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:timeseriesinsights/v20171115:ReferenceDataSet")]
    public partial class ReferenceDataSet : Pulumi.CustomResource
    {
        ...
        public ReferenceDataSet(string name, ReferenceDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:timeseriesinsights/v20171115:ReferenceDataSet", name, args ?? new ReferenceDataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReferenceDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:timeseriesinsights/v20171115:ReferenceDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ReferenceDataSetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.TimeSeriesInsights.V20171115.DataStringComparisonBehavior>? DataStringComparisonBehavior { get; set; }
