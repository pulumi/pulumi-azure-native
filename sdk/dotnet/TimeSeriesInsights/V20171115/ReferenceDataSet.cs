...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20171115
{
    ...
    public partial class ReferenceDataSet : global::Pulumi.CustomResource
    {
        ...
        public ReferenceDataSet(string name, ReferenceDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20171115:ReferenceDataSet", name, args ?? new ReferenceDataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReferenceDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:timeseriesinsights/v20171115:ReferenceDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
