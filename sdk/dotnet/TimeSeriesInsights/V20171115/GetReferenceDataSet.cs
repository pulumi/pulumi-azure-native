...
namespace Pulumi.AzureNative.TimeSeriesInsights.V20171115
{
    public static class GetReferenceDataSet
    {
        ...
        public static Output<GetReferenceDataSetResult> Invoke(GetReferenceDataSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetReferenceDataSetResult>("azure-native:timeseriesinsights/v20171115:getReferenceDataSet", args ?? new GetReferenceDataSetInvokeArgs(), options.WithVersion());
    }
