...
namespace Pulumi.AzureNative.BotService.V20230915Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:botservice/v20230915preview:Bot")]
    public partial class Bot : global::Pulumi.CustomResource
    {
        ...
        public Bot(string name, BotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20230915preview:Bot", name, args ?? new BotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20230915preview:Bot", name, null, MakeResourceOptions(options, id))
        {
        }
