...
namespace Pulumi.AzureNative.BotService.V20230915Preview
{
    public static class GetBotConnection
    {
        ...
        public static Task<GetBotConnectionResult> InvokeAsync(GetBotConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBotConnectionResult>("azure-native:botservice/v20230915preview:getBotConnection", args ?? new GetBotConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Connection Setting registration for a Bot Service
        /// </summary>
        public static Output<GetBotConnectionResult> Invoke(GetBotConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBotConnectionResult>("azure-native:botservice/v20230915preview:getBotConnection", args ?? new GetBotConnectionInvokeArgs(), options.WithDefaults());
    }
