...
namespace Pulumi.AzureNative.BotService.V20230915Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:botservice/v20230915preview:BotConnection")]
    public partial class BotConnection : global::Pulumi.CustomResource
    {
        ...
        public BotConnection(string name, BotConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20230915preview:BotConnection", name, args ?? new BotConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BotConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20230915preview:BotConnection", name, null, MakeResourceOptions(options, id))
        {
        }
