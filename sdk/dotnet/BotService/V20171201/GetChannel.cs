...
namespace Pulumi.AzureNative.BotService.V20171201
{
    public static class GetChannel
    {
        ...
        public static Task<GetChannelResult> InvokeAsync(GetChannelArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetChannelResult>("azure-native:botservice/v20171201:getChannel", args ?? new GetChannelArgs(), options.WithVersion());

        /// <summary>
        /// Bot channel resource definition
        /// </summary>
        public static Output<GetChannelResult> Invoke(GetChannelInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetChannelResult>("azure-native:botservice/v20171201:getChannel", args ?? new GetChannelInvokeArgs(), options.WithVersion());
    }
