...
namespace Pulumi.AzureRM.BotService.V20171201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var channel = new AzureRM.BotService.V20171201.Channel("channel", new AzureRM.BotService.V20171201.ChannelArgs
    ///         {
    ///             ChannelName = "EmailChannel",
    ///             Location = "global",
    ///             Properties = new AzureRM.BotService.V20171201.Inputs.ChannelArgs
    ///             {
    ...
    public partial class Channel : Pulumi.CustomResource
    {
        ...
        public Channel(string name, ChannelArgs args, CustomResourceOptions? options = null)
            : base("azurerm:botservice/v20171201:Channel", name, args ?? new ChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Channel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:botservice/v20171201:Channel", name, null, MakeResourceOptions(options, id))
        {
        }
