...
namespace Pulumi.AzureNative.BotService.V20220615Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:botservice/v20220615preview:Channel")]
    public partial class Channel : global::Pulumi.CustomResource
    {
        ...
        public Channel(string name, ChannelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20220615preview:Channel", name, args ?? new ChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Channel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20220615preview:Channel", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ChannelArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.BotService.V20220615Preview.Kind>? Kind { get; set; }
