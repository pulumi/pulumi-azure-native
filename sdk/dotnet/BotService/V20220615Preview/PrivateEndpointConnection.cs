...
namespace Pulumi.AzureNative.BotService.V20220615Preview
{
    /// <summary>
    /// The Private Endpoint Connection resource.
    /// </summary>
    [Obsolete(@"azure-native:botservice/v20220615preview:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:botservice/v20220915:PrivateEndpointConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:botservice/v20220615preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20220615preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20220615preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
