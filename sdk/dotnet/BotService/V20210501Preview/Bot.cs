...
namespace Pulumi.AzureNative.BotService.V20210501Preview
{
    ...
    public partial class Bot : global::Pulumi.CustomResource
    {
        ...
        public Bot(string name, BotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20210501preview:Bot", name, args ?? new BotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20210501preview:Bot", name, null, MakeResourceOptions(options, id))
        {
        }
