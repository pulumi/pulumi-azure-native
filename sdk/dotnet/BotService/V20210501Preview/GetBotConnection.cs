...
namespace Pulumi.AzureNative.BotService.V20210501Preview
{
    public static class GetBotConnection
    {
        ...
        public static Task<GetBotConnectionResult> InvokeAsync(GetBotConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBotConnectionResult>("azure-native:botservice/v20210501preview:getBotConnection", args ?? new GetBotConnectionArgs(), options.WithVersion());

        /// <summary>
        /// Bot channel resource definition
        /// </summary>
        public static Output<GetBotConnectionResult> Invoke(GetBotConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBotConnectionResult>("azure-native:botservice/v20210501preview:getBotConnection", args ?? new GetBotConnectionInvokeArgs(), options.WithVersion());
    }
