...
namespace Pulumi.AzureNative.BotService.V20210501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:botservice/v20210501preview:Channel is being removed in the next major version of this provider. Upgrade to at least azure-native:botservice/v20220915:Channel to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:botservice/v20210501preview:Channel")]
    public partial class Channel : global::Pulumi.CustomResource
    {
        ...
        public Channel(string name, ChannelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20210501preview:Channel", name, args ?? new ChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Channel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20210501preview:Channel", name, null, MakeResourceOptions(options, id))
        {
        }
