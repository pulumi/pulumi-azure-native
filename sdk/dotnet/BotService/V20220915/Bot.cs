...
namespace Pulumi.AzureNative.BotService.V20220915
{
    ...
    /// {
    ///     var bot = new AzureNative.BotService.V20220915.Bot("bot", new()
    ///     {
    ///         Kind = "sdk",
    ///         Location = "West US",
    ///         Properties = new AzureNative.BotService.V20220915.Inputs.BotPropertiesArgs
    ///         {
    ...
    ///         Sku = new AzureNative.BotService.V20220915.Inputs.SkuArgs
    ///         {
    ///             Name = "S1",
    ///         },
    ///         Tags = 
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:botservice/v20220915:Bot")]
    public partial class Bot : global::Pulumi.CustomResource
    {
        ...
        public Bot(string name, BotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20220915:Bot", name, args ?? new BotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20220915:Bot", name, null, MakeResourceOptions(options, id))
        {
        }
