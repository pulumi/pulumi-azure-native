...
namespace Pulumi.AzureNative.BotService.V20220915.Inputs
{
    ...
    public sealed class BotPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("msaAppType")]
        public InputUnion<string, Pulumi.AzureNative.BotService.V20220915.MsaAppType>? MsaAppType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.BotService.V20220915.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
