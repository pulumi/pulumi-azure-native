...
namespace Pulumi.AzureNative.BotService.V20220915
{
    ...
    public partial class Channel : global::Pulumi.CustomResource
    {
        ...
        public Channel(string name, ChannelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20220915:Channel", name, args ?? new ChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Channel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20220915:Channel", name, null, MakeResourceOptions(options, id))
        {
        }
