...
namespace Pulumi.AzureNative.BotService.V20210301
{
    public static class GetBot
    {
        ...
        public static Task<GetBotResult> InvokeAsync(GetBotArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBotResult>("azure-native:botservice/v20210301:getBot", args ?? new GetBotArgs(), options.WithDefaults());

        /// <summary>
        /// Returns a BotService specified by the parameters.
        /// </summary>
        public static Output<GetBotResult> Invoke(GetBotInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBotResult>("azure-native:botservice/v20210301:getBot", args ?? new GetBotInvokeArgs(), options.WithDefaults());
    }
