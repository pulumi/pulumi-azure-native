...
namespace Pulumi.AzureNative.BotService.V20210301
{
    public static class GetBot
    {
        ...
        public static Task<GetBotResult> InvokeAsync(GetBotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBotResult>("azure-native:botservice/v20210301:getBot", args ?? new GetBotArgs(), options.WithVersion());

        /// <summary>
        /// Bot resource definition
        /// </summary>
        public static Output<GetBotResult> Invoke(GetBotInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBotResult>("azure-native:botservice/v20210301:getBot", args ?? new GetBotInvokeArgs(), options.WithVersion());
    }
