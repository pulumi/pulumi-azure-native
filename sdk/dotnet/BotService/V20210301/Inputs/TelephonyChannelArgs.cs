...
namespace Pulumi.AzureNative.BotService.V20210301.Inputs
{
    ...
    /// </summary>
    public sealed class TelephonyChannelArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The channel name
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.TelephonyChannelPropertiesArgs>? Properties { get; set; }

        public TelephonyChannelArgs()
        {
            Location = "global";
        }
        public static new TelephonyChannelArgs Empty => new TelephonyChannelArgs();
    }
}
