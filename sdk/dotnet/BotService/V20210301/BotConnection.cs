...
namespace Pulumi.AzureNative.BotService.V20210301
{
    ...
    /// {
    ///     var botConnection = new AzureNative.BotService.V20210301.BotConnection("botConnection", new()
    ///     {
    ///         ConnectionName = "sampleConnection",
    ///         Location = "West US",
    ///         Properties = new AzureNative.BotService.V20210301.Inputs.ConnectionSettingPropertiesArgs
    ///         {
    ///             ClientId = "sampleclientid",
    ///             ClientSecret = "samplesecret",
    ///             Parameters = new[]
    ///             {
    ///                 new AzureNative.BotService.V20210301.Inputs.ConnectionSettingParameterArgs
    ///                 {
    ///                     Key = "key1",
    ///                     Value = "value1",
    ///                 },
    ...
    public partial class BotConnection : global::Pulumi.CustomResource
    {
        ...
        public BotConnection(string name, BotConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20210301:BotConnection", name, args ?? new BotConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BotConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20210301:BotConnection", name, null, MakeResourceOptions(options, id))
        {
        }
