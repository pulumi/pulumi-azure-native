...
namespace Pulumi.AzureRM.BotService.V20180712
{
    ...
    public partial class Channel : Pulumi.CustomResource
    {
        ...
        public Channel(string name, ChannelArgs args, CustomResourceOptions? options = null)
            : base("azurerm:botservice/v20180712:Channel", name, args ?? new ChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Channel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:botservice/v20180712:Channel", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:botservice/preview:Channel"},
                    new Pulumi.Alias { Type = "azurerm:botservice/v20171201:Channel"},
                    new Pulumi.Alias { Type = "azurerm:botservice/v20200602:Channel"},
                },
            };
