...
namespace Pulumi.AzureNative.BotService.V20180712
{
    public static class GetBot
    {
        ...
        public static Task<GetBotResult> InvokeAsync(GetBotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBotResult>("azure-native:botservice/v20180712:getBot", args ?? new GetBotArgs(), options.WithDefaults());

        /// <summary>
        /// Bot resource definition
        /// </summary>
        public static Output<GetBotResult> Invoke(GetBotInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBotResult>("azure-native:botservice/v20180712:getBot", args ?? new GetBotInvokeArgs(), options.WithDefaults());
    }
