...
namespace Pulumi.AzureNative.BotService.V20180712
{
    public static class GetEnterpriseChannel
    {
        ...
        /// Returns an Enterprise Channel specified by the parameters.
        /// </summary>
        public static Output<GetEnterpriseChannelResult> Invoke(GetEnterpriseChannelInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetEnterpriseChannelResult>("azure-native:botservice/v20180712:getEnterpriseChannel", args ?? new GetEnterpriseChannelInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetEnterpriseChannelArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public static new GetEnterpriseChannelArgs Empty => new GetEnterpriseChannelArgs();
    }

    public sealed class GetEnterpriseChannelInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The name of the Bot resource group in the user subscription.
        /// </summary>
        ...
        public GetEnterpriseChannelInvokeArgs()
        {
        }
        public static new GetEnterpriseChannelInvokeArgs Empty => new GetEnterpriseChannelInvokeArgs();
    }
