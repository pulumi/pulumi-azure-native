...
namespace Pulumi.AzureRM.BotService.V20180712
{
    ...
    ///     public MyStack()
    ///     {
    ///         var bot = new AzureRM.BotService.V20180712.Bot("bot", new AzureRM.BotService.V20180712.BotArgs
    ///         {
    ///             Etag = "etag1",
    ///             Kind = "sdk",
    ///             Location = "West US",
    ...
    public partial class Bot : Pulumi.CustomResource
    {
        ...
        public Bot(string name, BotArgs args, CustomResourceOptions? options = null)
            : base("azurerm:botservice/v20180712:Bot", name, args ?? new BotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:botservice/v20180712:Bot", name, null, MakeResourceOptions(options, id))
        {
        }
