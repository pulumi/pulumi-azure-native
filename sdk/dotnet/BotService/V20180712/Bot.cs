...
namespace Pulumi.AzureNative.BotService.V20180712
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:botservice/v20180712:Bot is being removed in the next major version of this provider. Upgrade to at least azure-native:botservice/v20220915:Bot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:botservice/v20180712:Bot")]
    public partial class Bot : global::Pulumi.CustomResource
    {
        ...
        public Bot(string name, BotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20180712:Bot", name, args ?? new BotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20180712:Bot", name, null, MakeResourceOptions(options, id))
        {
        }
