...
namespace Pulumi.AzureNative.BotService.V20180712
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:botservice/v20180712:BotConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:botservice/v20220915:BotConnection to guarantee forwards compatibility.")]
    ...
    public partial class BotConnection : global::Pulumi.CustomResource
    {
        ...
        public BotConnection(string name, BotConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20180712:BotConnection", name, args ?? new BotConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BotConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20180712:BotConnection", name, null, MakeResourceOptions(options, id))
        {
        }
