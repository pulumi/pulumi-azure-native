...
namespace Pulumi.AzureNative.BotService.V20200602
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:botservice/v20200602:BotConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:botservice/v20220915:BotConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:botservice/v20200602:BotConnection")]
    public partial class BotConnection : global::Pulumi.CustomResource
    {
        ...
        public BotConnection(string name, BotConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20200602:BotConnection", name, args ?? new BotConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BotConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/v20200602:BotConnection", name, null, MakeResourceOptions(options, id))
        {
        }
