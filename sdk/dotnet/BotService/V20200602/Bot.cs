...
namespace Pulumi.AzureRM.BotService.V20200602
{
    ...
    public partial class Bot : Pulumi.CustomResource
    {
        ...
        public Bot(string name, BotArgs args, CustomResourceOptions? options = null)
            : base("azurerm:botservice/v20200602:Bot", name, args ?? new BotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:botservice/v20200602:Bot", name, null, MakeResourceOptions(options, id))
        {
        }
