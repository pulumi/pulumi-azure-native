...
namespace Pulumi.AzureNative.BotService.V20200602
{
    public static class ListChannelWithKeys
    {
        ...
        public static Task<ListChannelWithKeysResult> InvokeAsync(ListChannelWithKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListChannelWithKeysResult>("azure-native:botservice/v20200602:listChannelWithKeys", args ?? new ListChannelWithKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Bot channel resource definition
        /// </summary>
        public static Output<ListChannelWithKeysResult> Invoke(ListChannelWithKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListChannelWithKeysResult>("azure-native:botservice/v20200602:listChannelWithKeys", args ?? new ListChannelWithKeysInvokeArgs(), options.WithDefaults());
    }
