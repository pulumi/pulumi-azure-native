...
namespace Pulumi.AzureNative.BotService.Inputs
{
    ...
    public sealed class BotPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("msaAppType")]
        public InputUnion<string, Pulumi.AzureNative.BotService.MsaAppType>? MsaAppType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.BotService.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
