...
namespace Pulumi.AzureRM.BotService.Preview
{
    public static class GetEnterpriseChannel
    {
        public static Task<GetEnterpriseChannelResult> InvokeAsync(GetEnterpriseChannelArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEnterpriseChannelResult>("azurerm:botservice/preview:getEnterpriseChannel", args ?? new GetEnterpriseChannelArgs(), options.WithVersion());
    }
