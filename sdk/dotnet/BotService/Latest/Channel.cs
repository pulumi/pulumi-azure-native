...
namespace Pulumi.AzureNextGen.BotService.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:botservice:Channel'.")]
    ...
    public partial class Channel : Pulumi.CustomResource
    {
        ...
        public Channel(string name, ChannelArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:botservice/latest:Channel", name, args ?? new ChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Channel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:botservice/latest:Channel", name, null, MakeResourceOptions(options, id))
        {
        }
