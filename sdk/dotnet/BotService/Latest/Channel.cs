...
namespace Pulumi.AzureNative.BotService.Latest
{
    ...
    public partial class Channel : Pulumi.CustomResource
    {
        ...
        public Channel(string name, ChannelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:botservice/latest:Channel", name, args ?? new ChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Channel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:botservice/latest:Channel", name, null, MakeResourceOptions(options, id))
        {
        }
