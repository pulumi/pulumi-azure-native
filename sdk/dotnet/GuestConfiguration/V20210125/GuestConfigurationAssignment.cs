...
namespace Pulumi.AzureNative.GuestConfiguration.V20210125
{
    ...
    public partial class GuestConfigurationAssignment : global::Pulumi.CustomResource
    {
        ...
        public GuestConfigurationAssignment(string name, GuestConfigurationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/v20210125:GuestConfigurationAssignment", name, args ?? new GuestConfigurationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestConfigurationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/v20210125:GuestConfigurationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
