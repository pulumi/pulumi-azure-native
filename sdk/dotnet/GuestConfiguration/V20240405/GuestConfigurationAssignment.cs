...
namespace Pulumi.AzureNative.GuestConfiguration.V20240405
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:guestconfiguration/v20240405:GuestConfigurationAssignment")]
    public partial class GuestConfigurationAssignment : global::Pulumi.CustomResource
    {
        ...
        public GuestConfigurationAssignment(string name, GuestConfigurationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/v20240405:GuestConfigurationAssignment", name, args ?? new GuestConfigurationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestConfigurationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/v20240405:GuestConfigurationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
