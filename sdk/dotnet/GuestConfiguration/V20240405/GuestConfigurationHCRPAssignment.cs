...
namespace Pulumi.AzureNative.GuestConfiguration.V20240405
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:guestconfiguration/v20240405:GuestConfigurationHCRPAssignment")]
    public partial class GuestConfigurationHCRPAssignment : global::Pulumi.CustomResource
    {
        ...
        public GuestConfigurationHCRPAssignment(string name, GuestConfigurationHCRPAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/v20240405:GuestConfigurationHCRPAssignment", name, args ?? new GuestConfigurationHCRPAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestConfigurationHCRPAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/v20240405:GuestConfigurationHCRPAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
