...
namespace Pulumi.AzureNative.GuestConfiguration.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:guestconfiguration:GuestConfigurationAssignment'.")]
    [AzureNativeResourceType("azure-native:guestconfiguration/latest:GuestConfigurationAssignment")]
    public partial class GuestConfigurationAssignment : Pulumi.CustomResource
    {
        ...
        public GuestConfigurationAssignment(string name, GuestConfigurationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/latest:GuestConfigurationAssignment", name, args ?? new GuestConfigurationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestConfigurationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/latest:GuestConfigurationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
