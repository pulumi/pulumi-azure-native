...
namespace Pulumi.AzureNextGen.GuestConfiguration.Latest
{
    ...
    public partial class GuestConfigurationAssignment : Pulumi.CustomResource
    {
        ...
        public GuestConfigurationAssignment(string name, GuestConfigurationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:guestconfiguration/latest:GuestConfigurationAssignment", name, args ?? new GuestConfigurationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestConfigurationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:guestconfiguration/latest:GuestConfigurationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
