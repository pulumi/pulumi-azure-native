...
namespace Pulumi.AzureNative.GuestConfiguration.V20220125
{
    ...
    /// {
    ///     var guestConfigurationHCRPAssignment = new AzureNative.GuestConfiguration.V20220125.GuestConfigurationHCRPAssignment("guestConfigurationHCRPAssignment", new()
    ///     {
    ///         GuestConfigurationAssignmentName = "NotInstalledApplicationForWindows",
    ///         Location = "westcentralus",
    ///         MachineName = "myMachineName",
    ///         Name = "NotInstalledApplicationForWindows",
    ///         Properties = new AzureNative.GuestConfiguration.V20220125.Inputs.GuestConfigurationAssignmentPropertiesArgs
    ///         {
    ///             Context = "Azure policy",
    ///             GuestConfiguration = new AzureNative.GuestConfiguration.V20220125.Inputs.GuestConfigurationNavigationArgs
    ///             {
    ///                 AssignmentType = "ApplyAndAutoCorrect",
    ///                 ConfigurationParameter = new[]
    ///                 {
    ///                     new AzureNative.GuestConfiguration.V20220125.Inputs.ConfigurationParameterArgs
    ///                     {
    ...
    public partial class GuestConfigurationHCRPAssignment : global::Pulumi.CustomResource
    {
        ...
        public GuestConfigurationHCRPAssignment(string name, GuestConfigurationHCRPAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/v20220125:GuestConfigurationHCRPAssignment", name, args ?? new GuestConfigurationHCRPAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestConfigurationHCRPAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/v20220125:GuestConfigurationHCRPAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
