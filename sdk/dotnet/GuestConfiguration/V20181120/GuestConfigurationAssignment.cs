...
namespace Pulumi.AzureNative.GuestConfiguration.V20181120
{
    ...
    /// </summary>
    [Obsolete(@"Version v20181120 will be removed in the next major version of the provider. Upgrade to version v20220125 or later.")]
    [AzureNativeResourceType("azure-native:guestconfiguration/v20181120:GuestConfigurationAssignment")]
    public partial class GuestConfigurationAssignment : Pulumi.CustomResource
    {
        ...
        public GuestConfigurationAssignment(string name, GuestConfigurationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/v20181120:GuestConfigurationAssignment", name, args ?? new GuestConfigurationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestConfigurationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/v20181120:GuestConfigurationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
