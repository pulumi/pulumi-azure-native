...
namespace Pulumi.AzureNextGen.GuestConfiguration.V20200625
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:guestconfiguration/v20200625:GuestConfigurationHCRPAssignment")]
    public partial class GuestConfigurationHCRPAssignment : Pulumi.CustomResource
    {
        ...
        public GuestConfigurationHCRPAssignment(string name, GuestConfigurationHCRPAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:guestconfiguration/v20200625:GuestConfigurationHCRPAssignment", name, args ?? new GuestConfigurationHCRPAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestConfigurationHCRPAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:guestconfiguration/v20200625:GuestConfigurationHCRPAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
