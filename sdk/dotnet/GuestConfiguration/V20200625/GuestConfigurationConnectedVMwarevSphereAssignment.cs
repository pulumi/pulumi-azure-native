...
namespace Pulumi.AzureNative.GuestConfiguration.V20200625
{
    ...
    public partial class GuestConfigurationConnectedVMwarevSphereAssignment : global::Pulumi.CustomResource
    {
        ...
        public GuestConfigurationConnectedVMwarevSphereAssignment(string name, GuestConfigurationConnectedVMwarevSphereAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/v20200625:GuestConfigurationConnectedVMwarevSphereAssignment", name, args ?? new GuestConfigurationConnectedVMwarevSphereAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private GuestConfigurationConnectedVMwarevSphereAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:guestconfiguration/v20200625:GuestConfigurationConnectedVMwarevSphereAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
