...
namespace Pulumi.AzureNextGen.GuestConfiguration.V20200625
{
    /// <summary>
    /// Guest configuration assignment is an association between a machine and guest configuration.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:guestconfiguration/v20200625:GuestConfigurationAssignment")]
    public partial class GuestConfigurationAssignment : Pulumi.CustomResource
    {
        ...
        public GuestConfigurationAssignment(string name, GuestConfigurationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:guestconfiguration/v20200625:GuestConfigurationAssignment", name, args ?? new GuestConfigurationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestConfigurationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:guestconfiguration/v20200625:GuestConfigurationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
