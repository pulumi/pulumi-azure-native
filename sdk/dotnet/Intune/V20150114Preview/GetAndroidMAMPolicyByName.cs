...
namespace Pulumi.AzureRM.Intune.V20150114Preview
{
    public static class GetAndroidMAMPolicyByName
    {
        public static Task<GetAndroidMAMPolicyByNameResult> InvokeAsync(GetAndroidMAMPolicyByNameArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAndroidMAMPolicyByNameResult>("azurerm:intune/v20150114preview:getAndroidMAMPolicyByName", args ?? new GetAndroidMAMPolicyByNameArgs(), options.WithVersion());
    }
