...
namespace Pulumi.AzureRM.Intune.V20150114Preview
{
    public static class GetIoMAMPolicyByName
    {
        public static Task<GetIoMAMPolicyByNameResult> InvokeAsync(GetIoMAMPolicyByNameArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIoMAMPolicyByNameResult>("azurerm:intune/v20150114preview:getIoMAMPolicyByName", args ?? new GetIoMAMPolicyByNameArgs(), options.WithVersion());
    }
