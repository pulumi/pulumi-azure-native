...
namespace Pulumi.AzureNative.IoTSecurity
{
    public static class GetSensor
    {
        ...
        public static Task<GetSensorResult> InvokeAsync(GetSensorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSensorResult>("azure-native:iotsecurity:getSensor", args ?? new GetSensorArgs(), options.WithDefaults());
        ...
        public static Output<GetSensorResult> Invoke(GetSensorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSensorResult>("azure-native:iotsecurity:getSensor", args ?? new GetSensorInvokeArgs(), options.WithDefaults());
    }
