...
namespace Pulumi.AzureNative.IoTSecurity
{
    ...
    public partial class Sensor : Pulumi.CustomResource
    {
        ...
        public Sensor(string name, SensorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotsecurity:Sensor", name, args ?? new SensorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Sensor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotsecurity:Sensor", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:iotsecurity/v20210901preview:Sensor"},
                    new Pulumi.Alias { Type = "azure-nextgen:iotsecurity/v20210901preview:Sensor"},
                },
            };
