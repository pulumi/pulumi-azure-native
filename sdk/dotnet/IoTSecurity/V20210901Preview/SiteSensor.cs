...
namespace Pulumi.AzureNative.IoTSecurity.V20210901Preview
{
    ...
    /// IoT sensor model
    /// </summary>
    [AzureNativeResourceType("azure-native:iotsecurity/v20210901preview:SiteSensor")]
    public partial class SiteSensor : Pulumi.CustomResource
    {
        ...
        public SiteSensor(string name, SiteSensorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotsecurity/v20210901preview:SiteSensor", name, args ?? new SiteSensorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SiteSensor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotsecurity/v20210901preview:SiteSensor", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:iotsecurity:SiteSensor"},
    ...
    public sealed class SiteSensorArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("sensorType")]
        public InputUnion<string, Pulumi.AzureNative.IoTSecurity.V20210901Preview.SensorType>? SensorType { get; set; }
