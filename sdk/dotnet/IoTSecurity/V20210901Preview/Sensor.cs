...
namespace Pulumi.AzureNative.IoTSecurity.V20210901Preview
{
    ...
    /// IoT sensor model
    /// </summary>
    [AzureNativeResourceType("azure-native:iotsecurity/v20210901preview:Sensor")]
    public partial class Sensor : Pulumi.CustomResource
    {
        ...
        public Sensor(string name, SensorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotsecurity/v20210901preview:Sensor", name, args ?? new SensorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Sensor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotsecurity/v20210901preview:Sensor", name, null, MakeResourceOptions(options, id))
        {
        }
