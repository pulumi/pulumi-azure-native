...
namespace Pulumi.AzureNative.IoTSecurity.V20210901Preview
{
    ...
    /// IoT site model
    /// </summary>
    [AzureNativeResourceType("azure-native:iotsecurity/v20210901preview:Site")]
    public partial class Site : Pulumi.CustomResource
    {
        ...
        public Site(string name, SiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotsecurity/v20210901preview:Site", name, args ?? new SiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Site(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotsecurity/v20210901preview:Site", name, null, MakeResourceOptions(options, id))
        {
        }
