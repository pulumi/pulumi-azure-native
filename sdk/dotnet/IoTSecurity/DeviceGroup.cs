...
namespace Pulumi.AzureNative.IoTSecurity
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotsecurity:DeviceGroup")]
    public partial class DeviceGroup : global::Pulumi.CustomResource
    {
        ...
        public DeviceGroup(string name, DeviceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotsecurity:DeviceGroup", name, args ?? new DeviceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeviceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotsecurity:DeviceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:iotsecurity/v20210201preview:DeviceGroup"},
                },
            };
