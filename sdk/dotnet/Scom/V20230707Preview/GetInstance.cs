...
namespace Pulumi.AzureNative.Scom.V20230707Preview
{
    public static class GetInstance
    {
        ...
        public static Task<GetInstanceResult> InvokeAsync(GetInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInstanceResult>("azure-native:scom/v20230707preview:getInstance", args ?? new GetInstanceArgs(), options.WithDefaults());
