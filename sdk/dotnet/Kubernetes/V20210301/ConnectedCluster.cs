...
namespace Pulumi.AzureNextGen.Kubernetes.V20210301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:kubernetes/v20210301:ConnectedCluster")]
    public partial class ConnectedCluster : Pulumi.CustomResource
    {
        ...
        public ConnectedCluster(string name, ConnectedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:kubernetes/v20210301:ConnectedCluster", name, args ?? new ConnectedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:kubernetes/v20210301:ConnectedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectedClusterArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Kubernetes.V20210301.ProvisioningState>? ProvisioningState { get; set; }
