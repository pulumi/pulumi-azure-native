...
namespace Pulumi.AzureNative.Kubernetes.V20210301
{
    ...
    /// {
    ///     var connectedCluster = new AzureNative.Kubernetes.V20210301.ConnectedCluster("connectedCluster", new()
    ///     {
    ...
    ///         Identity = new AzureNative.Kubernetes.V20210301.Inputs.ConnectedClusterIdentityArgs
    ///         {
    ///             Type = AzureNative.Kubernetes.V20210301.ResourceIdentityType.SystemAssigned,
    ///         },
    ///         Location = "East US",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetes/v20210301:ConnectedCluster")]
    public partial class ConnectedCluster : global::Pulumi.CustomResource
    {
        ...
        public ConnectedCluster(string name, ConnectedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetes/v20210301:ConnectedCluster", name, args ?? new ConnectedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetes/v20210301:ConnectedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectedClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kubernetes.V20210301.ProvisioningState>? ProvisioningState { get; set; }
