...
namespace Pulumi.AzureNative.Kubernetes.V20241201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetes/v20241201preview:ConnectedCluster")]
    public partial class ConnectedCluster : global::Pulumi.CustomResource
    {
        ...
        public ConnectedCluster(string name, ConnectedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetes/v20241201preview:ConnectedCluster", name, args ?? new ConnectedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetes/v20241201preview:ConnectedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectedClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kubernetes.V20241201Preview.AzureHybridBenefit>? AzureHybridBenefit { get; set; }
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Kubernetes.V20241201Preview.ConnectedClusterKind>? Kind { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Kubernetes.V20241201Preview.PrivateLinkState>? PrivateLinkState { get; set; }

        /// <summary>
        /// Provisioning state of the connected cluster resource.
        /// </summary>
        [Input("provisioningState")]
        public InputUnion<string, Pulumi.AzureNative.Kubernetes.V20241201Preview.ProvisioningState>? ProvisioningState { get; set; }
