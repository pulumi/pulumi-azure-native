...
namespace Pulumi.AzureNative.Kubernetes.V20200101Preview
{
    ...
    /// {
    ///     var connectedCluster = new AzureNative.Kubernetes.V20200101Preview.ConnectedCluster("connectedCluster", new()
    ///     {
    ///         AadProfile = new AzureNative.Kubernetes.V20200101Preview.Inputs.ConnectedClusterAADProfileArgs
    ///         {
    ...
    ///         Identity = new AzureNative.Kubernetes.V20200101Preview.Inputs.ConnectedClusterIdentityArgs
    ///         {
    ///             Type = AzureNative.Kubernetes.V20200101Preview.ResourceIdentityType.SystemAssigned,
    ///         },
    ///         Location = "East US",
