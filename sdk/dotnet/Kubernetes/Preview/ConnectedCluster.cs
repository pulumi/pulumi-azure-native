...
namespace Pulumi.AzureRM.Kubernetes.Preview
{
    ...
    public partial class ConnectedCluster : Pulumi.CustomResource
    {
        ...
        public ConnectedCluster(string name, ConnectedClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kubernetes/preview:ConnectedCluster", name, args ?? new ConnectedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kubernetes/preview:ConnectedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
