...
namespace Pulumi.AzureRM.Kubernetes.Preview
{
    public static class GetConnectedCluster
    {
        public static Task<GetConnectedClusterResult> InvokeAsync(GetConnectedClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConnectedClusterResult>("azurerm:kubernetes/preview:getConnectedCluster", args ?? new GetConnectedClusterArgs(), options.WithVersion());
    }
