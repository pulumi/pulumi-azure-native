...
namespace Pulumi.AzureNative.Kubernetes.V20221001Preview
{
    ...
    /// {
    ///     var connectedCluster = new AzureNative.Kubernetes.V20221001Preview.ConnectedCluster("connectedCluster", new()
    ///     {
    ...
    ///         Identity = new AzureNative.Kubernetes.V20221001Preview.Inputs.ConnectedClusterIdentityArgs
    ///         {
    ///             Type = AzureNative.Kubernetes.V20221001Preview.ResourceIdentityType.SystemAssigned,
    ///         },
    ///         Location = "East US",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetes/v20221001preview:ConnectedCluster")]
    public partial class ConnectedCluster : global::Pulumi.CustomResource
    {
        ...
        public ConnectedCluster(string name, ConnectedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetes/v20221001preview:ConnectedCluster", name, args ?? new ConnectedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetes/v20221001preview:ConnectedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
