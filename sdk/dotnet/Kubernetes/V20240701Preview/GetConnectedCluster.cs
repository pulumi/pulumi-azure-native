...
namespace Pulumi.AzureNative.Kubernetes.V20240701Preview
{
    public static class GetConnectedCluster
    {
        ...
        public static Task<GetConnectedClusterResult> InvokeAsync(GetConnectedClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectedClusterResult>("azure-native:kubernetes/v20240701preview:getConnectedCluster", args ?? new GetConnectedClusterArgs(), options.WithDefaults());
