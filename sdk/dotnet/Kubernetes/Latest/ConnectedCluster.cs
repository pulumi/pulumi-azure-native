...
namespace Pulumi.AzureRM.Kubernetes.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var connectedCluster = new AzureRM.Kubernetes.Latest.ConnectedCluster("connectedCluster", new AzureRM.Kubernetes.Latest.ConnectedClusterArgs
    ///         {
    ///             AadProfile = new AzureRM.Kubernetes.Latest.Inputs.ConnectedClusterAADProfileArgs
    ///             {
    ...
    ///             Identity = new AzureRM.Kubernetes.Latest.Inputs.ConnectedClusterIdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "East US",
    ...
    public partial class ConnectedCluster : Pulumi.CustomResource
    {
        ...
        public ConnectedCluster(string name, ConnectedClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kubernetes/latest:ConnectedCluster", name, args ?? new ConnectedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kubernetes/latest:ConnectedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:kubernetes/v20200101preview:ConnectedCluster"},
                },
            };
