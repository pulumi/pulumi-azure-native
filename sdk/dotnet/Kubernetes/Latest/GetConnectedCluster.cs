...
namespace Pulumi.AzureRM.Kubernetes.Latest
{
    public static class GetConnectedCluster
    {
        public static Task<GetConnectedClusterResult> InvokeAsync(GetConnectedClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConnectedClusterResult>("azurerm:kubernetes/latest:getConnectedCluster", args ?? new GetConnectedClusterArgs(), options.WithVersion());
    }
