...
namespace Pulumi.AzureNative.Kubernetes.V20210401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:kubernetes/v20210401preview:ConnectedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetes/v20221001preview:ConnectedCluster to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:kubernetes/v20210401preview:ConnectedCluster")]
    public partial class ConnectedCluster : global::Pulumi.CustomResource
    {
        ...
        public ConnectedCluster(string name, ConnectedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetes/v20210401preview:ConnectedCluster", name, args ?? new ConnectedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetes/v20210401preview:ConnectedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectedClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kubernetes.V20210401Preview.ProvisioningState>? ProvisioningState { get; set; }
