...
namespace Pulumi.AzureNextGen.Search.V20200313
{
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:search/v20200313:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:search/v20200313:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : Pulumi.ResourceArgs
    {
        ...
        public ServiceArgs()
        {
            HostingMode = Pulumi.AzureNextGen.Search.V20200313.HostingMode.@Default;
            PartitionCount = 1;
            PublicNetworkAccess = Pulumi.AzureNextGen.Search.V20200313.PublicNetworkAccess.Enabled;
            ReplicaCount = 1;
        }
    }
}
