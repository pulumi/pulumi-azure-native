...
namespace Pulumi.AzureNative.Search.V20200313.Inputs
{
    ...
    public sealed class PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNative.Search.V20200313.PrivateLinkServiceConnectionStatus>? Status { get; set; }
