...
namespace Pulumi.AzureRM.Search
{
    ...
    public partial class SearchServicePrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        private SearchServicePrivateEndpointConnection(string name, Input<string> id, SearchServicePrivateEndpointConnectionState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:search:SearchServicePrivateEndpointConnection", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SearchServicePrivateEndpointConnection Get(string name, Input<string> id, SearchServicePrivateEndpointConnectionState? state = null, CustomResourceOptions? options = null)
        {
            return new SearchServicePrivateEndpointConnection(name, id, state, options);
        }
    }
    ...
    public sealed class SearchServicePrivateEndpointConnectionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the private endpoint connection.
        /// </summary>
        ...
        public SearchServicePrivateEndpointConnectionState()
        {
        }
    }
}
