...
namespace Pulumi.AzureNative.Search.V20210104
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct EncryptionEnforcementStatus : IEquatable<EncryptionEnforcementStatus>
    {
        private readonly string _value;

        private EncryptionEnforcementStatus(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static EncryptionEnforcementStatus Unspecified { get; } = new EncryptionEnforcementStatus("unspecified");
        public static EncryptionEnforcementStatus Enabled { get; } = new EncryptionEnforcementStatus("enabled");
        public static EncryptionEnforcementStatus Disabled { get; } = new EncryptionEnforcementStatus("disabled");

        public static bool operator ==(EncryptionEnforcementStatus left, EncryptionEnforcementStatus right) => left.Equals(right);
        public static bool operator !=(EncryptionEnforcementStatus left, EncryptionEnforcementStatus right) => !left.Equals(right);

        public static explicit operator string(EncryptionEnforcementStatus value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is EncryptionEnforcementStatus other && Equals(other);
        public bool Equals(EncryptionEnforcementStatus other) => string.Equals(_value, other._value, StringComparison.Ordinal);
