...
namespace Pulumi.AzureNative.Search.V20210104.Inputs
{
    ...
    public sealed class SharedPrivateLinkResourcePropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Search.V20210104.SharedPrivateLinkResourceProvisioningState>? ProvisioningState { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNative.Search.V20210104.SharedPrivateLinkResourceStatus>? Status { get; set; }
