...
namespace Pulumi.AzureRM.Search.Preview
{
    public static class ListAdminKey
    {
        public static Task<ListAdminKeyResult> InvokeAsync(ListAdminKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAdminKeyResult>("azurerm:search/preview:listAdminKey", args ?? new ListAdminKeyArgs(), options.WithVersion());
    }
