...
namespace Pulumi.AzureNative.Search.V20200801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:search/v20200801preview:SharedPrivateLinkResource is being removed in the next major version of this provider. Please upgrade to azure-native:search/v20220901:SharedPrivateLinkResource to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:search/v20200801preview:SharedPrivateLinkResource")]
    public partial class SharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public SharedPrivateLinkResource(string name, SharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:search/v20200801preview:SharedPrivateLinkResource", name, args ?? new SharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:search/v20200801preview:SharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
