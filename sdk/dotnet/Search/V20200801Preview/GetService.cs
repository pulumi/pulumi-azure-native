...
namespace Pulumi.AzureNative.Search.V20200801Preview
{
    public static class GetService
    {
        ...
        public static Task<GetServiceResult> InvokeAsync(GetServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServiceResult>("azure-native:search/v20200801preview:getService", args ?? new GetServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the search service with the given name in the given resource group.
        /// </summary>
        public static Output<GetServiceResult> Invoke(GetServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServiceResult>("azure-native:search/v20200801preview:getService", args ?? new GetServiceInvokeArgs(), options.WithDefaults());
    }
