...
namespace Pulumi.AzureNative.Search.V20250201Preview.Inputs
{
    ...
    public sealed class SharedPrivateLinkResourcePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Search.V20250201Preview.SharedPrivateLinkResourceProvisioningState>? ProvisioningState { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.Search.V20250201Preview.SharedPrivateLinkResourceStatus>? Status { get; set; }
