...
namespace Pulumi.AzureNative.Search.V20210401Preview.Inputs
{
    ...
    public sealed class SharedPrivateLinkResourcePropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Search.V20210401Preview.SharedPrivateLinkResourceProvisioningState>? ProvisioningState { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.Search.V20210401Preview.SharedPrivateLinkResourceStatus>? Status { get; set; }
