...
namespace Pulumi.AzureNative.Search.V20200801
{
    /// <summary>
    ...
    /// {
    ///     var service = new AzureNative.Search.V20200801.Service("service", new()
    ///     {
    ///         HostingMode = AzureNative.Search.V20200801.HostingMode.@Default,
    ///         Location = "westus",
    ///         PartitionCount = 1,
    ///         ReplicaCount = 3,
    ///         ResourceGroupName = "rg1",
    ///         SearchServiceName = "mysearchservice",
    ///         Sku = new AzureNative.Search.V20200801.Inputs.SkuArgs
    ///         {
    ///             Name = AzureNative.Search.V20200801.SkuName.Standard,
    ///         },
    ///         Tags = 
    ///         {
    ...
    ///         Location = "westus",
    ///         PartitionCount = 1,
    ///         PublicNetworkAccess = AzureNative.Search.V20200801.PublicNetworkAccess.Disabled,
    ///         ReplicaCount = 3,
    ///         ResourceGroupName = "rg1",
    ///         SearchServiceName = "mysearchservice",
    ///         Sku = new AzureNative.Search.V20200801.Inputs.SkuArgs
    ...
    ///         HostingMode = AzureNative.Search.V20200801.HostingMode.@Default,
    ///         Location = "westus",
    ///         NetworkRuleSet = new AzureNative.Search.V20200801.Inputs.NetworkRuleSetArgs
    ///         {
    ///             IpRules = new[]
    ///             {
    ///                 new AzureNative.Search.V20200801.Inputs.IpRuleArgs
    ///                 {
    ///                     Value = "123.4.5.6",
    ///                 },
    ///                 new AzureNative.Search.V20200801.Inputs.IpRuleArgs
    ...
    ///     {
    ///         HostingMode = AzureNative.Search.V20200801.HostingMode.@Default,
    ///         Identity = new AzureNative.Search.V20200801.Inputs.IdentityArgs
    ///         {
    ///             Type = AzureNative.Search.V20200801.IdentityType.SystemAssigned,
    ///         },
    ///         Location = "westus",
    ///         PartitionCount = 1,
    ///         ReplicaCount = 3,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:search/v20200801:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:search/v20200801:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:search/v20200801:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostingMode")]
        public Input<Pulumi.AzureNative.Search.V20200801.HostingMode>? HostingMode { get; set; }
        ...
        public Input<Pulumi.AzureNative.Search.V20200801.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public ServiceArgs()
        {
            HostingMode = Pulumi.AzureNative.Search.V20200801.HostingMode.@Default;
            PartitionCount = 1;
            PublicNetworkAccess = Pulumi.AzureNative.Search.V20200801.PublicNetworkAccess.Enabled;
            ReplicaCount = 1;
        }
