...
namespace Pulumi.AzureNative.Search.V20200801.Inputs
{
    ...
    public sealed class SharedPrivateLinkResourcePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Search.V20200801.SharedPrivateLinkResourceProvisioningState>? ProvisioningState { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNative.Search.V20200801.SharedPrivateLinkResourceStatus>? Status { get; set; }
