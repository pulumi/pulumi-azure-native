...
namespace Pulumi.AzureNative.Search.V20240301Preview.Inputs
{
    ...
    public sealed class SharedPrivateLinkResourcePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Search.V20240301Preview.SharedPrivateLinkResourceProvisioningState>? ProvisioningState { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.Search.V20240301Preview.SharedPrivateLinkResourceStatus>? Status { get; set; }
