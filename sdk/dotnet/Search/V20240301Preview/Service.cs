...
namespace Pulumi.AzureNative.Search.V20240301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:search/v20240301preview:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:search/v20240301preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:search/v20240301preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Search.V20240301Preview.SearchDisabledDataExfiltrationOption>>? _disabledDataExfiltrationOptions;

        /// <summary>
        /// A list of data exfiltration scenarios that are explicitly disallowed for the search service. Currently, the only supported value is 'All' to disable all possible data export scenarios with more fine grained controls planned for the future.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Search.V20240301Preview.SearchDisabledDataExfiltrationOption>> DisabledDataExfiltrationOptions
        {
            get => _disabledDataExfiltrationOptions ?? (_disabledDataExfiltrationOptions = new InputList<Union<string, Pulumi.AzureNative.Search.V20240301Preview.SearchDisabledDataExfiltrationOption>>());
        ...
        /// </summary>
        [Input("hostingMode")]
        public Input<Pulumi.AzureNative.Search.V20240301Preview.HostingMode>? HostingMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Search.V20240301Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Search.V20240301Preview.SearchSemanticSearch>? SemanticSearch { get; set; }
        ...
        public ServiceArgs()
        {
            HostingMode = Pulumi.AzureNative.Search.V20240301Preview.HostingMode.Default;
            PartitionCount = 1;
