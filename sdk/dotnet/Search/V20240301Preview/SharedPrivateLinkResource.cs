...
namespace Pulumi.AzureNative.Search.V20240301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:search/v20240301preview:SharedPrivateLinkResource")]
    public partial class SharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public SharedPrivateLinkResource(string name, SharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:search/v20240301preview:SharedPrivateLinkResource", name, args ?? new SharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:search/v20240301preview:SharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
