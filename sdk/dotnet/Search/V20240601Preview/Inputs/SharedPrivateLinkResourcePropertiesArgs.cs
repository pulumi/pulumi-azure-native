...
namespace Pulumi.AzureNative.Search.V20240601Preview.Inputs
{
    ...
    public sealed class SharedPrivateLinkResourcePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Search.V20240601Preview.SharedPrivateLinkResourceProvisioningState>? ProvisioningState { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.Search.V20240601Preview.SharedPrivateLinkResourceStatus>? Status { get; set; }
