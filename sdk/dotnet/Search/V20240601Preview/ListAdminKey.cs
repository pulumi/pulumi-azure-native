...
namespace Pulumi.AzureNative.Search.V20240601Preview
{
    public static class ListAdminKey
    {
        ...
        public static Task<ListAdminKeyResult> InvokeAsync(ListAdminKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAdminKeyResult>("azure-native:search/v20240601preview:listAdminKey", args ?? new ListAdminKeyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the primary and secondary admin API keys for the specified Azure AI Search service.
        /// </summary>
        public static Output<ListAdminKeyResult> Invoke(ListAdminKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListAdminKeyResult>("azure-native:search/v20240601preview:listAdminKey", args ?? new ListAdminKeyInvokeArgs(), options.WithDefaults());
