...
namespace Pulumi.AzureNative.Search.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:search/v20240601preview:SharedPrivateLinkResource")]
    public partial class SharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public SharedPrivateLinkResource(string name, SharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:search/v20240601preview:SharedPrivateLinkResource", name, args ?? new SharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:search/v20240601preview:SharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
