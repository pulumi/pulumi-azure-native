...
namespace Pulumi.AzureNextGen.Search
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:search:Service")]
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:search:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:search:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostingMode")]
        public Input<Pulumi.AzureNextGen.Search.HostingMode>? HostingMode { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Search.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public ServiceArgs()
        {
            HostingMode = Pulumi.AzureNextGen.Search.HostingMode.@Default;
            PartitionCount = 1;
            PublicNetworkAccess = Pulumi.AzureNextGen.Search.PublicNetworkAccess.Enabled;
            ReplicaCount = 1;
        }
    }
}
