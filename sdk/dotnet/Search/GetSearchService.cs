...
{
    public static class GetSearchService
    {
        public static Task<GetSearchServiceResult> InvokeAsync(GetSearchServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSearchServiceResult>("azurerm:search:getSearchService", args ?? new GetSearchServiceArgs(), options.WithVersion());
    }


    public sealed class GetSearchServiceArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetSearchServiceResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetSearchServiceResult(
