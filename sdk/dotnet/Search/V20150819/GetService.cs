...
namespace Pulumi.AzureNative.Search.V20150819
{
    public static class GetService
    {
        ...
        public static Task<GetServiceResult> InvokeAsync(GetServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceResult>("azure-native:search/v20150819:getService", args ?? new GetServiceArgs(), options.WithVersion());

        /// <summary>
        /// Describes an Azure Cognitive Search service and its current state.
        /// </summary>
        public static Output<GetServiceResult> Invoke(GetServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceResult>("azure-native:search/v20150819:getService", args ?? new GetServiceInvokeArgs(), options.WithVersion());
    }
