...
namespace Pulumi.AzureRM.Search.V20150819
{
    ...
    ///     public MyStack()
    ///     {
    ///         var service = new AzureRM.Search.V20150819.Service("service", new AzureRM.Search.V20150819.ServiceArgs
    ///         {
    ///             HostingMode = "default",
    ///             Location = "westus",
    ///             PartitionCount = 1,
    ...
    ///             Sku = new AzureRM.Search.V20150819.Inputs.SkuArgs
    ///             {
    ///                 Name = "standard",
    ///             },
    ///             Tags = 
    ...
    ///         {
    ///             HostingMode = "default",
    ///             Identity = new AzureRM.Search.V20150819.Inputs.IdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "westus",
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:search/v20150819:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:search/v20150819:Service", name, null, MakeResourceOptions(options, id))
        {
        }
