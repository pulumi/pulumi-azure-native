...
namespace Pulumi.AzureRM.Search.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var service = new AzureRM.Search.Latest.Service("service", new AzureRM.Search.Latest.ServiceArgs
    ///         {
    ///             HostingMode = "default",
    ///             Location = "westus",
    ///             PartitionCount = 1,
    ...
    ///             Sku = new AzureRM.Search.Latest.Inputs.SkuArgs
    ///             {
    ///                 Name = "standard",
    ///             },
    ///             Tags = 
    ...
    ///             HostingMode = "default",
    ///             Location = "westus",
    ///             NetworkRuleSet = new AzureRM.Search.Latest.Inputs.NetworkRuleSetArgs
    ///             {
    ///                 IpRules = 
    ///                 {
    ///                     new AzureRM.Search.Latest.Inputs.IpRuleArgs
    ///                     {
    ///                         Value = "123.4.5.6",
    ///                     },
    ///                     new AzureRM.Search.Latest.Inputs.IpRuleArgs
    ...
    ///         {
    ///             HostingMode = "default",
    ///             Identity = new AzureRM.Search.Latest.Inputs.IdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "westus",
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:search/latest:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:search/latest:Service", name, null, MakeResourceOptions(options, id))
        {
        }
