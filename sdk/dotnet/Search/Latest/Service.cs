...
namespace Pulumi.AzureNative.Search.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:search:Service'.")]
    [AzureNativeResourceType("azure-native:search/latest:Service")]
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:search/latest:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:search/latest:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostingMode")]
        public Input<Pulumi.AzureNative.Search.Latest.HostingMode>? HostingMode { get; set; }
        ...
        public Input<Pulumi.AzureNative.Search.Latest.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public ServiceArgs()
        {
            HostingMode = Pulumi.AzureNative.Search.Latest.HostingMode.@Default;
            PartitionCount = 1;
            PublicNetworkAccess = Pulumi.AzureNative.Search.Latest.PublicNetworkAccess.Enabled;
            ReplicaCount = 1;
        }
    }
}
