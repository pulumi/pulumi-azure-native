...
namespace Pulumi.AzureNextGen.Search.Latest
{
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:search/latest:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:search/latest:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostingMode")]
        public Input<Pulumi.AzureNextGen.Search.Latest.HostingMode>? HostingMode { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Search.Latest.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public ServiceArgs()
        {
            HostingMode = Pulumi.AzureNextGen.Search.Latest.HostingMode.@Default;
            PartitionCount = 1;
            PublicNetworkAccess = Pulumi.AzureNextGen.Search.Latest.PublicNetworkAccess.Enabled;
            ReplicaCount = 1;
        }
    }
}
