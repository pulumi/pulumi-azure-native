...
namespace Pulumi.AzureRM.ChangeAnalysis.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var configurationProfile = new AzureRM.ChangeAnalysis.Latest.ConfigurationProfile("configurationProfile", new AzureRM.ChangeAnalysis.Latest.ConfigurationProfileArgs
    ///         {
    ///             ProfileName = "default",
    ///         });
    ///     }
    ...
    public partial class ConfigurationProfile : Pulumi.CustomResource
    {
        ...
        public ConfigurationProfile(string name, ConfigurationProfileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:changeanalysis/latest:ConfigurationProfile", name, args ?? new ConfigurationProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:changeanalysis/latest:ConfigurationProfile", name, null, MakeResourceOptions(options, id))
        {
        }
