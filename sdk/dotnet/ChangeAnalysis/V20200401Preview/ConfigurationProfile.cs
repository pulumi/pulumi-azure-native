...
namespace Pulumi.AzureRM.ChangeAnalysis.V20200401Preview
{
    ...
    public partial class ConfigurationProfile : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ConfigurationProfileResourcePropertiesResponseResult> Properties { get; private set; } = null!;
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:changeanalysis/preview:ConfigurationProfile"},
                },
            };
