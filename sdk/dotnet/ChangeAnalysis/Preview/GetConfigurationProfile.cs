...
namespace Pulumi.AzureRM.ChangeAnalysis.Preview
{
    public static class GetConfigurationProfile
    {
        public static Task<GetConfigurationProfileResult> InvokeAsync(GetConfigurationProfileArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConfigurationProfileResult>("azurerm:changeanalysis/preview:getConfigurationProfile", args ?? new GetConfigurationProfileArgs(), options.WithVersion());
    }
