...
namespace Pulumi.AzureRM.ChangeAnalysis.Preview
{
    /// <summary>
    ...
    public partial class ConfigurationProfile : Pulumi.CustomResource
    {
        ...
        public ConfigurationProfile(string name, ConfigurationProfileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:changeanalysis/preview:ConfigurationProfile", name, args ?? new ConfigurationProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:changeanalysis/preview:ConfigurationProfile", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:changeanalysis/v20200401preview:ConfigurationProfile"},
                },
            };
