...
namespace Pulumi.AzureNative.NotificationHubs.V20160301
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:notificationhubs/v20160301:Namespace myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName} 
    /// ```
    /// </summary>
    ...
    public partial class Namespace : global::Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20160301:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20160301:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("namespaceType")]
        public Input<Pulumi.AzureNative.NotificationHubs.V20160301.NamespaceType>? NamespaceType { get; set; }
