...
namespace Pulumi.AzureRM.NotificationHubs.V20160301
{
    public static class ListNotificationHubKeys
    {
        public static Task<ListNotificationHubKeysResult> InvokeAsync(ListNotificationHubKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNotificationHubKeysResult>("azurerm:notificationhubs/v20160301:listNotificationHubKeys", args ?? new ListNotificationHubKeysArgs(), options.WithVersion());
    }
