...
namespace Pulumi.AzureNative.NotificationHubs.V20160301
{
    ...
    /// </summary>
    [Obsolete(@"Version v20160301 will be removed in the next major version of the provider. Upgrade to version v20170401 or later.")]
    [AzureNativeResourceType("azure-native:notificationhubs/v20160301:NotificationHubAuthorizationRule")]
    public partial class NotificationHubAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public NotificationHubAuthorizationRule(string name, NotificationHubAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20160301:NotificationHubAuthorizationRule", name, args ?? new NotificationHubAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationHubAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20160301:NotificationHubAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
