...
namespace Pulumi.AzureRM.NotificationHubs.V20160301
{
    ...
    public partial class NotificationHub : Pulumi.CustomResource
    {
        ...
        public NotificationHub(string name, NotificationHubArgs args, CustomResourceOptions? options = null)
            : base("azurerm:notificationhubs/v20160301:NotificationHub", name, args ?? new NotificationHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:notificationhubs/v20160301:NotificationHub", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Alias { Type = "azurerm:notificationhubs/v20170401:NotificationHub"},
                },
            };
