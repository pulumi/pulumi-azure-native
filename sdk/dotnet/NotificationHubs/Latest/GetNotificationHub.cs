...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:notificationhubs:getNotificationHub'.")]
    public static class GetNotificationHub
    {
        ...
        public static Task<GetNotificationHubResult> InvokeAsync(GetNotificationHubArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNotificationHubResult>("azure-native:notificationhubs/latest:getNotificationHub", args ?? new GetNotificationHubArgs(), options.WithVersion());
    }
