...
namespace Pulumi.AzureNative.NotificationHubs.V20170401
{
    ...
    public partial class NotificationHub : Pulumi.CustomResource
    {
        ...
        public NotificationHub(string name, NotificationHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20170401:NotificationHub", name, args ?? new NotificationHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20170401:NotificationHub", name, null, MakeResourceOptions(options, id))
        {
        }
