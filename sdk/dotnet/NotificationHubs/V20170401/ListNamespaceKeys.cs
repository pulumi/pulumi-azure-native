...
namespace Pulumi.AzureNative.NotificationHubs.V20170401
{
    public static class ListNamespaceKeys
    {
        ...
        public static Task<ListNamespaceKeysResult> InvokeAsync(ListNamespaceKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceKeysResult>("azure-native:notificationhubs/v20170401:listNamespaceKeys", args ?? new ListNamespaceKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Namespace/NotificationHub Connection String
        /// </summary>
        public static Output<ListNamespaceKeysResult> Invoke(ListNamespaceKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListNamespaceKeysResult>("azure-native:notificationhubs/v20170401:listNamespaceKeys", args ?? new ListNamespaceKeysInvokeArgs(), options.WithDefaults());
    }
