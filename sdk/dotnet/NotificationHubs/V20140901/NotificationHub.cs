...
namespace Pulumi.AzureNative.NotificationHubs.V20140901
{
    ...
    public partial class NotificationHub : Pulumi.CustomResource
    {
        ...
        public NotificationHub(string name, NotificationHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20140901:NotificationHub", name, args ?? new NotificationHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20140901:NotificationHub", name, null, MakeResourceOptions(options, id))
        {
        }
