...
namespace Pulumi.AzureNative.NotificationHubs.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:notificationhubs/v20230901:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20230901:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20230901:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
