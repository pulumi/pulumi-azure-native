...
namespace Pulumi.AzureNative.NotificationHubs.V20230901.Inputs
{
    ...
    public sealed class SharedAccessAuthorizationRulePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.NotificationHubs.V20230901.AccessRights>>? _rights;

        /// <summary>
        /// Gets or sets the rights associated with the rule.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.NotificationHubs.V20230901.AccessRights>> Rights
        {
            get => _rights ?? (_rights = new InputList<Union<string, Pulumi.AzureNative.NotificationHubs.V20230901.AccessRights>>());
            set => _rights = value;
        }
