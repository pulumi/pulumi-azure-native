...
namespace Pulumi.AzureRM.NotificationHubs.Preview
{
    public static class ListNamespaceKeys
    {
        public static Task<ListNamespaceKeysResult> InvokeAsync(ListNamespaceKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceKeysResult>("azurerm:notificationhubs/preview:listNamespaceKeys", args ?? new ListNamespaceKeysArgs(), options.WithVersion());
    }
