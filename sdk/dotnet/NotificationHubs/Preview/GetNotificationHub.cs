...
namespace Pulumi.AzureRM.NotificationHubs.Preview
{
    public static class GetNotificationHub
    {
        public static Task<GetNotificationHubResult> InvokeAsync(GetNotificationHubArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNotificationHubResult>("azurerm:notificationhubs/preview:getNotificationHub", args ?? new GetNotificationHubArgs(), options.WithVersion());
    }
