...
namespace Pulumi.AzureRM.NotificationHubs
{
    ...
    public partial class NamespaceNotificationHub : Pulumi.CustomResource
    {
        ...
        private NamespaceNotificationHub(string name, Input<string> id, NamespaceNotificationHubState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:notificationhubs:NamespaceNotificationHub", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NamespaceNotificationHub Get(string name, Input<string> id, NamespaceNotificationHubState? state = null, CustomResourceOptions? options = null)
        {
            return new NamespaceNotificationHub(name, id, state, options);
        }
    }
    ...
    public sealed class NamespaceNotificationHubState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Resource location
        /// </summary>
        ...
        /// </summary>
        [Input("properties", required: true)]
        public Input<Inputs.NotificationHubPropertiesResponseGetArgs> Properties { get; set; } = null!;
        ...
        public NamespaceNotificationHubState()
        {
        }
    }
}
