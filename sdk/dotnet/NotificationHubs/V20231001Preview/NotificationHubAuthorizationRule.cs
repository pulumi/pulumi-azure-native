...
namespace Pulumi.AzureNative.NotificationHubs.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:notificationhubs/v20231001preview:NotificationHubAuthorizationRule")]
    public partial class NotificationHubAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public NotificationHubAuthorizationRule(string name, NotificationHubAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20231001preview:NotificationHubAuthorizationRule", name, args ?? new NotificationHubAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationHubAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20231001preview:NotificationHubAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
