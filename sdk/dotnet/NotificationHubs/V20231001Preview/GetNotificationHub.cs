...
namespace Pulumi.AzureNative.NotificationHubs.V20231001Preview
{
    public static class GetNotificationHub
    {
        ...
        public static Task<GetNotificationHubResult> InvokeAsync(GetNotificationHubArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNotificationHubResult>("azure-native:notificationhubs/v20231001preview:getNotificationHub", args ?? new GetNotificationHubArgs(), options.WithDefaults());

        /// <summary>
        /// Notification Hub Resource.
        /// </summary>
        public static Output<GetNotificationHubResult> Invoke(GetNotificationHubInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNotificationHubResult>("azure-native:notificationhubs/v20231001preview:getNotificationHub", args ?? new GetNotificationHubInvokeArgs(), options.WithDefaults());
    }
