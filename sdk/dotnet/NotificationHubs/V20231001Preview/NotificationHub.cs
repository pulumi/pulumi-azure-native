...
namespace Pulumi.AzureNative.NotificationHubs.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:notificationhubs/v20231001preview:NotificationHub")]
    public partial class NotificationHub : global::Pulumi.CustomResource
    {
        ...
        public NotificationHub(string name, NotificationHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20231001preview:NotificationHub", name, args ?? new NotificationHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20231001preview:NotificationHub", name, null, MakeResourceOptions(options, id))
        {
        }
