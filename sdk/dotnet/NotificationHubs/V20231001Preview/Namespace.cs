...
namespace Pulumi.AzureNative.NotificationHubs.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:notificationhubs/v20231001preview:Namespace")]
    public partial class Namespace : global::Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20231001preview:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20231001preview:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
