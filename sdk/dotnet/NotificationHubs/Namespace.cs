...
namespace Pulumi.AzureRM.NotificationHubs
{
    ...
    public partial class Namespace : Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:notificationhubs:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, NamespaceState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:notificationhubs:Namespace", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.NamespacePropertiesResponseGetArgs> Properties { get; set; } = null!;
