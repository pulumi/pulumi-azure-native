...
namespace Pulumi.AzureNative.NotificationHubs.V20230101Preview
{
    public static class GetNamespacePnsCredentials
    {
        ...
        public static Task<GetNamespacePnsCredentialsResult> InvokeAsync(GetNamespacePnsCredentialsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNamespacePnsCredentialsResult>("azure-native:notificationhubs/v20230101preview:getNamespacePnsCredentials", args ?? new GetNamespacePnsCredentialsArgs(), options.WithDefaults());
        ...
        public static Output<GetNamespacePnsCredentialsResult> Invoke(GetNamespacePnsCredentialsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNamespacePnsCredentialsResult>("azure-native:notificationhubs/v20230101preview:getNamespacePnsCredentials", args ?? new GetNamespacePnsCredentialsInvokeArgs(), options.WithDefaults());
    }
