...
namespace Pulumi.AzureNative.NotificationHubs.V20230101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:notificationhubs/v20230101preview:NotificationHub")]
    public partial class NotificationHub : global::Pulumi.CustomResource
    {
        ...
        public NotificationHub(string name, NotificationHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20230101preview:NotificationHub", name, args ?? new NotificationHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20230101preview:NotificationHub", name, null, MakeResourceOptions(options, id))
        {
        }
