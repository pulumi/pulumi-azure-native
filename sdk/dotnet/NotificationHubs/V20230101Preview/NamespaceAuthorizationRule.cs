...
namespace Pulumi.AzureNative.NotificationHubs.V20230101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:notificationhubs/v20230101preview:NamespaceAuthorizationRule")]
    public partial class NamespaceAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public NamespaceAuthorizationRule(string name, NamespaceAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20230101preview:NamespaceAuthorizationRule", name, args ?? new NamespaceAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:notificationhubs/v20230101preview:NamespaceAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
