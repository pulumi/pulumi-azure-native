...
namespace Pulumi.AzureNextGen.Aad.V20170101.Inputs
{
    ...
    public sealed class LdapsSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Aad.V20170101.ExternalAccess>? ExternalAccess { get; set; }

        /// <summary>
        /// A flag to determine whether or not Secure LDAP is enabled or disabled.
        /// </summary>
        [Input("ldaps")]
        public InputUnion<string, Pulumi.AzureNextGen.Aad.V20170101.Ldaps>? Ldaps { get; set; }
