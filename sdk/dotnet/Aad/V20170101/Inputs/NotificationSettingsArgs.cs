...
namespace Pulumi.AzureNative.Aad.V20170101.Inputs
{
    ...
    public sealed class NotificationSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Aad.V20170101.NotifyDcAdmins>? NotifyDcAdmins { get; set; }

        /// <summary>
        /// Should global admins be notified
        /// </summary>
        [Input("notifyGlobalAdmins")]
        public InputUnion<string, Pulumi.AzureNative.Aad.V20170101.NotifyGlobalAdmins>? NotifyGlobalAdmins { get; set; }
