...
namespace Pulumi.AzureNative.Aad.V20170601
{
    public static class GetOuContainer
    {
        ...
        public static Output<GetOuContainerResult> Invoke(GetOuContainerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOuContainerResult>("azure-native:aad/v20170601:getOuContainer", args ?? new GetOuContainerInvokeArgs(), options.WithVersion());
    }
