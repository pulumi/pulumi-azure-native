...
namespace Pulumi.AzureNative.Aad.V20210501
{
    ...
    public static class GetDomainService
    {
        ...
        public static Task<GetDomainServiceResult> InvokeAsync(GetDomainServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainServiceResult>("azure-native:aad/v20210501:getDomainService", args ?? new GetDomainServiceArgs(), options.WithDefaults());

        /// <summary>
        /// The Get Domain Service operation retrieves a json representation of the Domain Service.
        /// </summary>
        public static Output<GetDomainServiceResult> Invoke(GetDomainServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDomainServiceResult>("azure-native:aad/v20210501:getDomainService", args ?? new GetDomainServiceInvokeArgs(), options.WithDefaults());
    }
