...
namespace Pulumi.AzureNative.Aad.V20210501.Inputs
{
    ...
    public sealed class LdapsSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Aad.V20210501.ExternalAccess>? ExternalAccess { get; set; }

        /// <summary>
        /// A flag to determine whether or not Secure LDAP is enabled or disabled.
        /// </summary>
        [Input("ldaps")]
        public InputUnion<string, Pulumi.AzureNative.Aad.V20210501.Ldaps>? Ldaps { get; set; }
