...
namespace Pulumi.AzureNative.Aad.V20210501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:aad/v20210501:OuContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:aad/v20221201:OuContainer to guarantee forwards compatibility.")]
    ...
    public partial class OuContainer : global::Pulumi.CustomResource
    {
        ...
        public OuContainer(string name, OuContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:aad/v20210501:OuContainer", name, args ?? new OuContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OuContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:aad/v20210501:OuContainer", name, null, MakeResourceOptions(options, id))
        {
        }
