...
namespace Pulumi.AzureNative.Aad.Latest.Inputs
{
    ...
    public sealed class LdapsSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Aad.Latest.ExternalAccess>? ExternalAccess { get; set; }

        /// <summary>
        /// A flag to determine whether or not Secure LDAP is enabled or disabled.
        /// </summary>
        [Input("ldaps")]
        public InputUnion<string, Pulumi.AzureNative.Aad.Latest.Ldaps>? Ldaps { get; set; }
