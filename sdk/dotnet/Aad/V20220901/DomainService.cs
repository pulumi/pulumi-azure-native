...
namespace Pulumi.AzureNative.Aad.V20220901
{
    ...
    /// Domain service.
    /// </summary>
    [Obsolete(@"azure-native:aad/v20220901:DomainService is being removed in the next major version of this provider. Upgrade to at least azure-native:aad/v20221201:DomainService to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:aad/v20220901:DomainService")]
    public partial class DomainService : global::Pulumi.CustomResource
    {
        ...
        public DomainService(string name, DomainServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:aad/v20220901:DomainService", name, args ?? new DomainServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:aad/v20220901:DomainService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DomainServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("filteredSync")]
        public InputUnion<string, Pulumi.AzureNative.Aad.V20220901.FilteredSync>? FilteredSync { get; set; }
        ...
        /// </summary>
        [Input("syncScope")]
        public InputUnion<string, Pulumi.AzureNative.Aad.V20220901.SyncScope>? SyncScope { get; set; }
