...
namespace Pulumi.AzureNative.Aad.V20210301
{
    public static class GetDomainService
    {
        ...
        public static Task<GetDomainServiceResult> InvokeAsync(GetDomainServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDomainServiceResult>("azure-native:aad/v20210301:getDomainService", args ?? new GetDomainServiceArgs(), options.WithVersion());

        /// <summary>
        /// Domain service.
        /// </summary>
        public static Output<GetDomainServiceResult> Invoke(GetDomainServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDomainServiceResult>("azure-native:aad/v20210301:getDomainService", args ?? new GetDomainServiceInvokeArgs(), options.WithVersion());
    }
