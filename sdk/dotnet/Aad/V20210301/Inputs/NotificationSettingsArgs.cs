...
namespace Pulumi.AzureNative.Aad.V20210301.Inputs
{
    ...
    public sealed class NotificationSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Aad.V20210301.NotifyDcAdmins>? NotifyDcAdmins { get; set; }

        /// <summary>
        /// Should global admins be notified
        /// </summary>
        [Input("notifyGlobalAdmins")]
        public InputUnion<string, Pulumi.AzureNative.Aad.V20210301.NotifyGlobalAdmins>? NotifyGlobalAdmins { get; set; }
