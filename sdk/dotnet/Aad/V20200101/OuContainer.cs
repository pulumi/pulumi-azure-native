...
namespace Pulumi.AzureNative.Aad.V20200101
{
    ...
    /// </summary>
    [Obsolete(@"Version v20200101 will be removed in the next major version of the provider. Upgrade to version v20210301 or later.")]
    [AzureNativeResourceType("azure-native:aad/v20200101:OuContainer")]
    public partial class OuContainer : Pulumi.CustomResource
    {
        ...
        public OuContainer(string name, OuContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:aad/v20200101:OuContainer", name, args ?? new OuContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OuContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:aad/v20200101:OuContainer", name, null, MakeResourceOptions(options, id))
        {
        }
