...
namespace Pulumi.AzureNextGen.Aad.V20200101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:aad/v20200101:OuContainer")]
    public partial class OuContainer : Pulumi.CustomResource
    {
        ...
        public OuContainer(string name, OuContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:aad/v20200101:OuContainer", name, args ?? new OuContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OuContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:aad/v20200101:OuContainer", name, null, MakeResourceOptions(options, id))
        {
        }
