...
namespace Pulumi.AzureNative.Aad.V20200101
{
    ...
    /// Domain service.
    /// </summary>
    [AzureNativeResourceType("azure-native:aad/v20200101:DomainService")]
    public partial class DomainService : Pulumi.CustomResource
    {
        ...
        public DomainService(string name, DomainServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:aad/v20200101:DomainService", name, args ?? new DomainServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:aad/v20200101:DomainService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DomainServiceArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("filteredSync")]
        public InputUnion<string, Pulumi.AzureNative.Aad.V20200101.FilteredSync>? FilteredSync { get; set; }
