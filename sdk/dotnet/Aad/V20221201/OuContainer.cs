...
namespace Pulumi.AzureNative.Aad.V20221201
{
    ...
    /// {
    ///     var ouContainer = new AzureNative.Aad.V20221201.OuContainer("ouContainer", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:aad/v20221201:OuContainer OuContainer.com/OuContainer1 /subscriptions/1639790a-76a2-4ac4-98d9-8562f5dfcb4d/resourceGroups/ouContainerResourceGroup/providers/Microsoft.AAD/domainServices/ouContainer.com/ouContainer/ouContainer1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:aad/v20221201:OuContainer")]
    public partial class OuContainer : global::Pulumi.CustomResource
    {
        ...
        public OuContainer(string name, OuContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:aad/v20221201:OuContainer", name, args ?? new OuContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OuContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:aad/v20221201:OuContainer", name, null, MakeResourceOptions(options, id))
        {
        }
