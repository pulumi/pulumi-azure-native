...
namespace Pulumi.AzureNative.Aad.V20221201
{
    ...
    /// {
    ///     var domainService = new AzureNative.Aad.V20221201.DomainService("domainService", new()
    ///     {
    ///         DomainName = "TestDomainService.com",
    ///         DomainSecuritySettings = new AzureNative.Aad.V20221201.Inputs.DomainSecuritySettingsArgs
    ///         {
    ///             NtlmV1 = "Enabled",
    ...
    ///         LdapsSettings = new AzureNative.Aad.V20221201.Inputs.LdapsSettingsArgs
    ///         {
    ...
    ///         },
    ///         NotificationSettings = new AzureNative.Aad.V20221201.Inputs.NotificationSettingsArgs
    ///         {
    ...
    ///         ReplicaSets = new[]
    ///         {
    ///             new AzureNative.Aad.V20221201.Inputs.ReplicaSetArgs
    ///             {
    ///                 Location = "West US",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:aad/v20221201:DomainService")]
    public partial class DomainService : global::Pulumi.CustomResource
    {
        ...
        public DomainService(string name, DomainServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:aad/v20221201:DomainService", name, args ?? new DomainServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:aad/v20221201:DomainService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DomainServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("filteredSync")]
        public InputUnion<string, Pulumi.AzureNative.Aad.V20221201.FilteredSync>? FilteredSync { get; set; }
        ...
        /// </summary>
        [Input("syncScope")]
        public InputUnion<string, Pulumi.AzureNative.Aad.V20221201.SyncScope>? SyncScope { get; set; }
