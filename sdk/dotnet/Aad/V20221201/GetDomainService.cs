...
namespace Pulumi.AzureNative.Aad.V20221201
{
    public static class GetDomainService
    {
        ...
        public static Task<GetDomainServiceResult> InvokeAsync(GetDomainServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainServiceResult>("azure-native:aad/v20221201:getDomainService", args ?? new GetDomainServiceArgs(), options.WithDefaults());
