...
namespace Pulumi.AzureNative.Aad.V20221201
{
    public static class GetOuContainer
    {
        ...
        public static Task<GetOuContainerResult> InvokeAsync(GetOuContainerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOuContainerResult>("azure-native:aad/v20221201:getOuContainer", args ?? new GetOuContainerArgs(), options.WithDefaults());
