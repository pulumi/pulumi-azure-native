...
namespace Pulumi.AzureNextGen.Aad.Inputs
{
    ...
    public sealed class LdapsSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Aad.ExternalAccess>? ExternalAccess { get; set; }

        /// <summary>
        /// A flag to determine whether or not Secure LDAP is enabled or disabled.
        /// </summary>
        [Input("ldaps")]
        public InputUnion<string, Pulumi.AzureNextGen.Aad.Ldaps>? Ldaps { get; set; }
