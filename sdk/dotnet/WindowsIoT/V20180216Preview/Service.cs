...
namespace Pulumi.AzureRM.WindowsIoT.V20180216Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var service = new AzureRM.WindowsIoT.V20180216Preview.Service("service", new AzureRM.WindowsIoT.V20180216Preview.ServiceArgs
    ///         {
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:windowsiot/v20180216preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:windowsiot/v20180216preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
