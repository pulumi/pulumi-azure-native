...
namespace Pulumi.AzureRM.WindowsIoT.Latest
{
    /// <summary>
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:windowsiot/latest:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:windowsiot/latest:Service", name, null, MakeResourceOptions(options, id))
        {
        }
