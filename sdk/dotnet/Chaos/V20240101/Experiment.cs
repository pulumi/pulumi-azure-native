...
namespace Pulumi.AzureNative.Chaos.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:chaos/v20240101:Experiment")]
    public partial class Experiment : global::Pulumi.CustomResource
    {
        ...
        public Experiment(string name, ExperimentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20240101:Experiment", name, args ?? new ExperimentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Experiment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20240101:Experiment", name, null, MakeResourceOptions(options, id))
        {
        }
