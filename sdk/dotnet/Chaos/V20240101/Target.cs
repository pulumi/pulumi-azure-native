...
namespace Pulumi.AzureNative.Chaos.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:chaos/v20240101:Target")]
    public partial class Target : global::Pulumi.CustomResource
    {
        ...
        public Target(string name, TargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20240101:Target", name, args ?? new TargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Target(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20240101:Target", name, null, MakeResourceOptions(options, id))
        {
        }
