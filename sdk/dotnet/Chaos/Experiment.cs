...
namespace Pulumi.AzureNative.Chaos
{
    ...
    public partial class Experiment : Pulumi.CustomResource
    {
        ...
        public Experiment(string name, ExperimentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos:Experiment", name, args ?? new ExperimentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Experiment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos:Experiment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:chaos:Experiment"},
                    new Pulumi.Alias { Type = "azure-native:chaos/v20210915preview:Experiment"},
                    new Pulumi.Alias { Type = "azure-nextgen:chaos/v20210915preview:Experiment"},
                },
            };
