...
namespace Pulumi.AzureNative.Chaos.V20241101Preview
{
    public static class GetPrivateAccess
    {
        ...
        public static Task<GetPrivateAccessResult> InvokeAsync(GetPrivateAccessArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateAccessResult>("azure-native:chaos/v20241101preview:getPrivateAccess", args ?? new GetPrivateAccessArgs(), options.WithDefaults());

        /// <summary>
        /// Get a private access resource
        /// </summary>
        public static Output<GetPrivateAccessResult> Invoke(GetPrivateAccessInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPrivateAccessResult>("azure-native:chaos/v20241101preview:getPrivateAccess", args ?? new GetPrivateAccessInvokeArgs(), options.WithDefaults());
