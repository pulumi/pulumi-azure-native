...
namespace Pulumi.AzureNative.Chaos.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:chaos/v20241101preview:Capability")]
    public partial class Capability : global::Pulumi.CustomResource
    {
        ...
        public Capability(string name, CapabilityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20241101preview:Capability", name, args ?? new CapabilityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Capability(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20241101preview:Capability", name, null, MakeResourceOptions(options, id))
        {
        }
