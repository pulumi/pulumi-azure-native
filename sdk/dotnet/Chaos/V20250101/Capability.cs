...
namespace Pulumi.AzureNative.Chaos.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:chaos/v20250101:Capability")]
    public partial class Capability : global::Pulumi.CustomResource
    {
        ...
        public Output<string> ParametersSchema { get; private set; } = null!;
        ...
        public Capability(string name, CapabilityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20250101:Capability", name, args ?? new CapabilityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Capability(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20250101:Capability", name, null, MakeResourceOptions(options, id))
        {
        }
