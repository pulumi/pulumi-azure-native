...
namespace Pulumi.AzureNative.Chaos.V20231027Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:chaos/v20231027preview:PrivateAccess")]
    public partial class PrivateAccess : global::Pulumi.CustomResource
    {
        ...
        public PrivateAccess(string name, PrivateAccessArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20231027preview:PrivateAccess", name, args ?? new PrivateAccessArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateAccess(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20231027preview:PrivateAccess", name, null, MakeResourceOptions(options, id))
        {
        }
