...
namespace Pulumi.AzureNative.Chaos.V20231027Preview
{
    public static class GetPrivateAccess
    {
        ...
        public static Task<GetPrivateAccessResult> InvokeAsync(GetPrivateAccessArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateAccessResult>("azure-native:chaos/v20231027preview:getPrivateAccess", args ?? new GetPrivateAccessArgs(), options.WithDefaults());
