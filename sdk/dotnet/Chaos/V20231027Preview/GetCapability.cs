...
namespace Pulumi.AzureNative.Chaos.V20231027Preview
{
    public static class GetCapability
    {
        ...
        public static Task<GetCapabilityResult> InvokeAsync(GetCapabilityArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCapabilityResult>("azure-native:chaos/v20231027preview:getCapability", args ?? new GetCapabilityArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Capability resource that extends a Target resource.
        /// </summary>
        public static Output<GetCapabilityResult> Invoke(GetCapabilityInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCapabilityResult>("azure-native:chaos/v20231027preview:getCapability", args ?? new GetCapabilityInvokeArgs(), options.WithDefaults());
    }
