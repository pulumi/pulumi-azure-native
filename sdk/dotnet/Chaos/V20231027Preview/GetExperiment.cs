...
namespace Pulumi.AzureNative.Chaos.V20231027Preview
{
    public static class GetExperiment
    {
        ...
        public static Task<GetExperimentResult> InvokeAsync(GetExperimentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExperimentResult>("azure-native:chaos/v20231027preview:getExperiment", args ?? new GetExperimentArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Experiment resource.
        /// </summary>
        public static Output<GetExperimentResult> Invoke(GetExperimentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExperimentResult>("azure-native:chaos/v20231027preview:getExperiment", args ?? new GetExperimentInvokeArgs(), options.WithDefaults());
    }
