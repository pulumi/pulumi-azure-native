...
namespace Pulumi.AzureNative.Chaos.V20210915Preview
{
    ...
    public partial class Target : Pulumi.CustomResource
    {
        ...
        public Target(string name, TargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20210915preview:Target", name, args ?? new TargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Target(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20210915preview:Target", name, null, MakeResourceOptions(options, id))
        {
        }
