...
namespace Pulumi.AzureNative.Chaos.V20210915Preview
{
    ...
    public partial class Capability : global::Pulumi.CustomResource
    {
        ...
        public Capability(string name, CapabilityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20210915preview:Capability", name, args ?? new CapabilityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Capability(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20210915preview:Capability", name, null, MakeResourceOptions(options, id))
        {
        }
