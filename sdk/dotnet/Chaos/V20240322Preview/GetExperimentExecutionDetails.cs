...
namespace Pulumi.AzureNative.Chaos.V20240322Preview
{
    public static class GetExperimentExecutionDetails
    {
        ...
        public static Task<GetExperimentExecutionDetailsResult> InvokeAsync(GetExperimentExecutionDetailsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExperimentExecutionDetailsResult>("azure-native:chaos/v20240322preview:getExperimentExecutionDetails", args ?? new GetExperimentExecutionDetailsArgs(), options.WithDefaults());
        ...
        public static Output<GetExperimentExecutionDetailsResult> Invoke(GetExperimentExecutionDetailsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExperimentExecutionDetailsResult>("azure-native:chaos/v20240322preview:getExperimentExecutionDetails", args ?? new GetExperimentExecutionDetailsInvokeArgs(), options.WithDefaults());
