...
namespace Pulumi.AzureNative.Chaos.V20240322Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:chaos/v20240322preview:PrivateAccess")]
    public partial class PrivateAccess : global::Pulumi.CustomResource
    {
        ...
        public PrivateAccess(string name, PrivateAccessArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20240322preview:PrivateAccess", name, args ?? new PrivateAccessArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateAccess(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20240322preview:PrivateAccess", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PrivateAccessArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Chaos.V20240322Preview.PublicNetworkAccessOption>? PublicNetworkAccess { get; set; }
