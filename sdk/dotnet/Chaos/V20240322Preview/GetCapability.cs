...
namespace Pulumi.AzureNative.Chaos.V20240322Preview
{
    public static class GetCapability
    {
        ...
        public static Task<GetCapabilityResult> InvokeAsync(GetCapabilityArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCapabilityResult>("azure-native:chaos/v20240322preview:getCapability", args ?? new GetCapabilityArgs(), options.WithDefaults());
