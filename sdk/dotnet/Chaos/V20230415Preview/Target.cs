...
namespace Pulumi.AzureNative.Chaos.V20230415Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:chaos/v20230415preview:Target")]
    public partial class Target : global::Pulumi.CustomResource
    {
        ...
        public Target(string name, TargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20230415preview:Target", name, args ?? new TargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Target(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20230415preview:Target", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:chaos/v20230901preview:Target" },
                    new global::Pulumi.Alias { Type = "azure-native:chaos/v20231027preview:Target" },
                    new global::Pulumi.Alias { Type = "azure-native:chaos/v20231101:Target" },
