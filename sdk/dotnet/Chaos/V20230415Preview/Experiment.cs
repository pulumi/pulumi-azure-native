...
namespace Pulumi.AzureNative.Chaos.V20230415Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:chaos/v20230415preview:Experiment")]
    public partial class Experiment : global::Pulumi.CustomResource
    {
        ...
        public Experiment(string name, ExperimentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20230415preview:Experiment", name, args ?? new ExperimentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Experiment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20230415preview:Experiment", name, null, MakeResourceOptions(options, id))
        {
        }
