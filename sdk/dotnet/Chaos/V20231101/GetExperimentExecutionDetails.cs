...
namespace Pulumi.AzureNative.Chaos.V20231101
{
    public static class GetExperimentExecutionDetails
    {
        ...
        public static Task<GetExperimentExecutionDetailsResult> InvokeAsync(GetExperimentExecutionDetailsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExperimentExecutionDetailsResult>("azure-native:chaos/v20231101:getExperimentExecutionDetails", args ?? new GetExperimentExecutionDetailsArgs(), options.WithDefaults());
