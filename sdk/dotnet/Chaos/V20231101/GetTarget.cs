...
namespace Pulumi.AzureNative.Chaos.V20231101
{
    public static class GetTarget
    {
        ...
        public static Task<GetTargetResult> InvokeAsync(GetTargetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTargetResult>("azure-native:chaos/v20231101:getTarget", args ?? new GetTargetArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Target resource that extends a tracked regional resource.
        /// </summary>
        public static Output<GetTargetResult> Invoke(GetTargetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTargetResult>("azure-native:chaos/v20231101:getTarget", args ?? new GetTargetInvokeArgs(), options.WithDefaults());
