...
namespace Pulumi.AzureNative.Chaos.V20221001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:chaos/v20221001preview:Experiment is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Experiment to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:chaos/v20221001preview:Experiment")]
    public partial class Experiment : global::Pulumi.CustomResource
    {
        ...
        public Experiment(string name, ExperimentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20221001preview:Experiment", name, args ?? new ExperimentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Experiment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20221001preview:Experiment", name, null, MakeResourceOptions(options, id))
        {
        }
