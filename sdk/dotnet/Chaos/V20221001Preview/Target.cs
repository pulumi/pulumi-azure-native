...
namespace Pulumi.AzureNative.Chaos.V20221001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:chaos/v20221001preview:Target is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Target to guarantee forwards compatibility.")]
    ...
    public partial class Target : global::Pulumi.CustomResource
    {
        ...
        public Target(string name, TargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20221001preview:Target", name, args ?? new TargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Target(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20221001preview:Target", name, null, MakeResourceOptions(options, id))
        {
        }
