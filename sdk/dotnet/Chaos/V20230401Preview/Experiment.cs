...
namespace Pulumi.AzureNative.Chaos.V20230401Preview
{
    ...
    public partial class Experiment : global::Pulumi.CustomResource
    {
        ...
        public Experiment(string name, ExperimentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20230401preview:Experiment", name, args ?? new ExperimentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Experiment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:chaos/v20230401preview:Experiment", name, null, MakeResourceOptions(options, id))
        {
        }
