...
namespace Pulumi.AzureNative.ContainerInstance.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerinstance/v20241101preview:CGProfile")]
    public partial class CGProfile : global::Pulumi.CustomResource
    {
        ...
        public CGProfile(string name, CGProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20241101preview:CGProfile", name, args ?? new CGProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CGProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20241101preview:CGProfile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CGProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20241101Preview.OperatingSystemTypes>? OsType { get; set; }

        /// <summary>
        /// The priority of the container group.
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20241101Preview.ContainerGroupPriority>? Priority { get; set; }
