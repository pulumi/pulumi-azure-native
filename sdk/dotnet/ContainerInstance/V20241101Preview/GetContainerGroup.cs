...
namespace Pulumi.AzureNative.ContainerInstance.V20241101Preview
{
    public static class GetContainerGroup
    {
        ...
        public static Task<GetContainerGroupResult> InvokeAsync(GetContainerGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContainerGroupResult>("azure-native:containerinstance/v20241101preview:getContainerGroup", args ?? new GetContainerGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified container group in the specified subscription and resource group. The operation returns the properties of each container group including containers, image registry credentials, restart policy, IP address type, OS type, state, and volumes.
        /// </summary>
        public static Output<GetContainerGroupResult> Invoke(GetContainerGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContainerGroupResult>("azure-native:containerinstance/v20241101preview:getContainerGroup", args ?? new GetContainerGroupInvokeArgs(), options.WithDefaults());
    ...
    public sealed class GetContainerGroupResult
    {
        ...
        /// </summary>
        public readonly Outputs.IdentityAclsResponse? IdentityAcls;
        /// <summary>
        ...
        private GetContainerGroupResult(
            ...
            Outputs.IdentityAclsResponse? identityAcls,
