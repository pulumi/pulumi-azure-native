...
namespace Pulumi.AzureNative.ContainerInstance.V20241101Preview
{
    ...
    /// A container group.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerinstance/v20241101preview:ContainerGroup")]
    public partial class ContainerGroup : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("identityAcls")]
        public Output<Outputs.IdentityAclsResponse?> IdentityAcls { get; private set; } = null!;
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20241101preview:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20241101preview:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("identityAcls")]
        public Input<Inputs.IdentityAclsArgs>? IdentityAcls { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20241101Preview.OperatingSystemTypes> OsType { get; set; } = null!;

        /// <summary>
        /// The priority of the container group.
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20241101Preview.Priority>? Priority { get; set; }
        ...
        /// </summary>
        [Input("restartPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20241101Preview.ContainerGroupRestartPolicy>? RestartPolicy { get; set; }
        ...
        /// </summary>
        [Input("sku")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20241101Preview.ContainerGroupSku>? Sku { get; set; }
