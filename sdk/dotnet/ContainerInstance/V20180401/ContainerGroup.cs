...
namespace Pulumi.AzureRM.ContainerInstance.V20180401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var containerGroup = new AzureRM.ContainerInstance.V20180401.ContainerGroup("containerGroup", new AzureRM.ContainerInstance.V20180401.ContainerGroupArgs
    ///         {
    ///             ContainerGroupName = "demo1",
    ///             Containers = 
    ///             {
    ///                 new AzureRM.ContainerInstance.V20180401.Inputs.ContainerArgs
    ///                 {
    ///                     Name = "demo1",
    ///                 },
    ///             },
    ///             ImageRegistryCredentials = {},
    ///             IpAddress = new AzureRM.ContainerInstance.V20180401.Inputs.IpAddressArgs
    ///             {
    ///                 DnsNameLabel = "dnsnamelabel1",
    ///                 Ports = 
    ///                 {
    ///                     new AzureRM.ContainerInstance.V20180401.Inputs.PortArgs
    ///                     {
    ///                         Port = 80,
    ///                         Protocol = "TCP",
    ///                     },
    ...
    ///             Volumes = 
    ///             {
    ///                 new AzureRM.ContainerInstance.V20180401.Inputs.VolumeArgs
    ///                 {
    ///                     AzureFile = new AzureRM.ContainerInstance.V20180401.Inputs.AzureFileVolumeArgs
    ///                     {
    ///                         ShareName = "shareName",
    ...
    public partial class ContainerGroup : Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerinstance/v20180401:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerinstance/v20180401:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
