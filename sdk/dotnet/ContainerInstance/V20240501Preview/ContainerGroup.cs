...
namespace Pulumi.AzureNative.ContainerInstance.V20240501Preview
{
    ...
    /// A container group.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerinstance/v20240501preview:ContainerGroup")]
    public partial class ContainerGroup : global::Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20240501preview:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20240501preview:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20240501Preview.OperatingSystemTypes>? OsType { get; set; }
