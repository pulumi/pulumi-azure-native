...
namespace Pulumi.AzureNative.ContainerInstance.V20210301
{
    ...
    /// {
    ///     var containerGroup = new AzureNative.ContainerInstance.V20210301.ContainerGroup("containerGroup", new()
    ///     {
    ///         ContainerGroupName = "demo1",
    ///         Containers = new[]
    ///         {
    ///             new AzureNative.ContainerInstance.V20210301.Inputs.ContainerArgs
    ///             {
    ///                 Command = new[] {},
    ...
    ///                 Ports = new[]
    ///                 {
    ///                     new AzureNative.ContainerInstance.V20210301.Inputs.ContainerPortArgs
    ///                     {
    ///                         Port = 80,
    ///                     },
    ///                 },
    ///                 Resources = new AzureNative.ContainerInstance.V20210301.Inputs.ResourceRequirementsArgs
    ///                 {
    ///                     Requests = new AzureNative.ContainerInstance.V20210301.Inputs.ResourceRequestsArgs
    ///                     {
    ///                         Cpu = 1,
    ///                         Gpu = new AzureNative.ContainerInstance.V20210301.Inputs.GpuResourceArgs
    ///                         {
    ///                             Count = 1,
    ///                             Sku = "K80",
    ///                         },
    ...
    ///                 VolumeMounts = new[]
    ///                 {
    ///                     new AzureNative.ContainerInstance.V20210301.Inputs.VolumeMountArgs
    ///                     {
    ...
    ///             },
    ///         },
    ///         Diagnostics = new AzureNative.ContainerInstance.V20210301.Inputs.ContainerGroupDiagnosticsArgs
    ///         {
    ///             LogAnalytics = new AzureNative.ContainerInstance.V20210301.Inputs.LogAnalyticsArgs
    ///             {
    ...
    ///             },
    ///         },
    ///         DnsConfig = new AzureNative.ContainerInstance.V20210301.Inputs.DnsConfigurationArgs
    ///         {
    ///             NameServers = new[]
    ///             {
    ///                 "1.1.1.1",
    ...
    ///         },
    ///         Identity = new AzureNative.ContainerInstance.V20210301.Inputs.ContainerGroupIdentityArgs
    ///         {
    ///             Type = AzureNative.ContainerInstance.V20210301.ResourceIdentityType.SystemAssigned_UserAssigned,
    ...
    ///         IpAddress = new AzureNative.ContainerInstance.V20210301.Inputs.IpAddressArgs
    ///         {
    ///             DnsNameLabel = "dnsnamelabel1",
    ///             Ports = new[]
    ///             {
    ///                 new AzureNative.ContainerInstance.V20210301.Inputs.PortArgs
    ///                 {
    ///                     Port = 80,
    ///                     Protocol = "TCP",
    ///                 },
    ...
    ///         },
    ///         Location = "west us",
    ///         NetworkProfile = new AzureNative.ContainerInstance.V20210301.Inputs.ContainerGroupNetworkProfileArgs
    ///         {
    ...
    ///         Volumes = new[]
    ///         {
    ///             new AzureNative.ContainerInstance.V20210301.Inputs.VolumeArgs
    ///             {
    ///                 AzureFile = new AzureNative.ContainerInstance.V20210301.Inputs.AzureFileVolumeArgs
    ///                 {
    ///                     ShareName = "shareName",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerinstance/v20210301:ContainerGroup")]
    public partial class ContainerGroup : global::Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20210301:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20210301:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20210301.OperatingSystemTypes> OsType { get; set; } = null!;
        ...
        /// </summary>
        [Input("restartPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20210301.ContainerGroupRestartPolicy>? RestartPolicy { get; set; }

        /// <summary>
        /// The SKU for a container group.
        /// </summary>
        [Input("sku")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20210301.ContainerGroupSku>? Sku { get; set; }
