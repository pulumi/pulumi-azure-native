...
namespace Pulumi.AzureNextGen.ContainerInstance.V20180201Preview
{
    ...
    public sealed class ContainerGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.ContainerInstance.V20180201Preview.OperatingSystemTypes> OsType { get; set; } = null!;
        ...
        /// </summary>
        [Input("restartPolicy")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerInstance.V20180201Preview.ContainerGroupRestartPolicy>? RestartPolicy { get; set; }
