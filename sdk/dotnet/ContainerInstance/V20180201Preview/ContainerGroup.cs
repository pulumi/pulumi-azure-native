...
namespace Pulumi.AzureRM.ContainerInstance.V20180201Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var containerGroup = new AzureRM.ContainerInstance.V20180201Preview.ContainerGroup("containerGroup", new AzureRM.ContainerInstance.V20180201Preview.ContainerGroupArgs
    ///         {
    ///             ContainerGroupName = "demo1",
    ///             Containers = 
    ///             {
    ///                 new AzureRM.ContainerInstance.V20180201Preview.Inputs.ContainerArgs
    ///                 {
    ///                     Name = "demo1",
    ///                 },
    ///             },
    ///             ImageRegistryCredentials = {},
    ///             IpAddress = new AzureRM.ContainerInstance.V20180201Preview.Inputs.IpAddressArgs
    ///             {
    ///                 DnsNameLabel = "dnsnamelabel1",
    ///                 Ports = 
    ///                 {
    ///                     new AzureRM.ContainerInstance.V20180201Preview.Inputs.PortArgs
    ///                     {
    ///                         Port = 80,
    ///                         Protocol = "TCP",
    ///                     },
    ...
    ///             Volumes = 
    ///             {
    ///                 new AzureRM.ContainerInstance.V20180201Preview.Inputs.VolumeArgs
    ///                 {
    ///                     AzureFile = new AzureRM.ContainerInstance.V20180201Preview.Inputs.AzureFileVolumeArgs
    ///                     {
    ///                         ShareName = "shareName",
    ...
    public partial class ContainerGroup : Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerinstance/v20180201preview:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerinstance/v20180201preview:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
