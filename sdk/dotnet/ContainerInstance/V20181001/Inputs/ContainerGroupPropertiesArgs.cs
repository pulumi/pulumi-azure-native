...
namespace Pulumi.AzureNative.ContainerInstance.V20181001.Inputs
{
    ...
    public sealed class ContainerGroupPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20181001.OperatingSystemTypes> OsType { get; set; } = null!;
        ...
        /// </summary>
        [Input("restartPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20181001.ContainerGroupRestartPolicy>? RestartPolicy { get; set; }
