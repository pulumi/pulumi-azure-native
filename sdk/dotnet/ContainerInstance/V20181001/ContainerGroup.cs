...
namespace Pulumi.AzureRM.ContainerInstance.V20181001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var containerGroup = new AzureRM.ContainerInstance.V20181001.ContainerGroup("containerGroup", new AzureRM.ContainerInstance.V20181001.ContainerGroupArgs
    ///         {
    ///             ContainerGroupName = "demo1",
    ///             Containers = 
    ///             {
    ///                 new AzureRM.ContainerInstance.V20181001.Inputs.ContainerArgs
    ///                 {
    ///                     Name = "demo1",
    ///                 },
    ///             },
    ///             Diagnostics = new AzureRM.ContainerInstance.V20181001.Inputs.ContainerGroupDiagnosticsArgs
    ///             {
    ///                 LogAnalytics = new AzureRM.ContainerInstance.V20181001.Inputs.LogAnalyticsArgs
    ///                 {
    ...
    ///                 },
    ///             },
    ///             DnsConfig = new AzureRM.ContainerInstance.V20181001.Inputs.DnsConfigurationArgs
    ///             {
    ///                 NameServers = 
    ///                 {
    ///                     "1.1.1.1",
    ...
    ///             },
    ///             Identity = new AzureRM.ContainerInstance.V20181001.Inputs.ContainerGroupIdentityArgs
    ///             {
    ///                 Type = "SystemAssigned, UserAssigned",
    ///             },
    ///             ImageRegistryCredentials = {},
    ///             IpAddress = new AzureRM.ContainerInstance.V20181001.Inputs.IpAddressArgs
    ///             {
    ///                 DnsNameLabel = "dnsnamelabel1",
    ///                 Ports = 
    ///                 {
    ///                     new AzureRM.ContainerInstance.V20181001.Inputs.PortArgs
    ///                     {
    ///                         Port = 80,
    ///                         Protocol = "TCP",
    ///                     },
    ...
    ///             },
    ///             Location = "west us",
    ///             NetworkProfile = new AzureRM.ContainerInstance.V20181001.Inputs.ContainerGroupNetworkProfileArgs
    ///             {
    ...
    ///             Volumes = 
    ///             {
    ///                 new AzureRM.ContainerInstance.V20181001.Inputs.VolumeArgs
    ///                 {
    ///                     AzureFile = new AzureRM.ContainerInstance.V20181001.Inputs.AzureFileVolumeArgs
    ///                     {
    ///                         ShareName = "shareName",
