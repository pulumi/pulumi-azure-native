...
namespace Pulumi.AzureNextGen.ContainerInstance.V20181001
{
    ...
    /// A container group.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:containerinstance/v20181001:ContainerGroup")]
    ...
    public sealed class ContainerGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.ContainerInstance.V20181001.OperatingSystemTypes> OsType { get; set; } = null!;
        ...
        /// </summary>
        [Input("restartPolicy")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerInstance.V20181001.ContainerGroupRestartPolicy>? RestartPolicy { get; set; }
