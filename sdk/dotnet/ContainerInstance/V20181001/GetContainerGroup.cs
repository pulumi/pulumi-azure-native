...
namespace Pulumi.AzureNative.ContainerInstance.V20181001
{
    public static class GetContainerGroup
    {
        ...
        public static Output<GetContainerGroupResult> Invoke(GetContainerGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetContainerGroupResult>("azure-native:containerinstance/v20181001:getContainerGroup", args ?? new GetContainerGroupInvokeArgs(), options.WithVersion());
    }
