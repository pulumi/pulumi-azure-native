...
namespace Pulumi.AzureNative.ContainerInstance.V20230501.Inputs
{
    ...
    public sealed class IpAddressArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20230501.DnsNameLabelReusePolicy>? AutoGeneratedDomainNameLabelScope { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20230501.ContainerGroupIpAddressType> Type { get; set; } = null!;
