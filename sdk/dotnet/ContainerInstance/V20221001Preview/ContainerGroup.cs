...
namespace Pulumi.AzureNative.ContainerInstance.V20221001Preview
{
    ...
    /// A container group.
    /// </summary>
    [Obsolete(@"azure-native:containerinstance/v20221001preview:ContainerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:containerinstance/v20230201preview:ContainerGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:containerinstance/v20221001preview:ContainerGroup")]
    public partial class ContainerGroup : global::Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20221001preview:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20221001preview:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
