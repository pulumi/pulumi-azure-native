...
namespace Pulumi.AzureNative.ContainerInstance.V20171201Preview
{
    /// <summary>
    /// A container group.
    /// </summary>
    [Obsolete(@"Version v20171201preview will be removed in the next major version of the provider. Upgrade to version v20210301 or later.")]
    ...
    public partial class ContainerGroup : Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20171201preview:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20171201preview:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
