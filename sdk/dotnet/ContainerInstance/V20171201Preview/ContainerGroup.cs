...
namespace Pulumi.AzureRM.ContainerInstance.V20171201Preview
{
    /// <summary>
    /// A container group.
    /// </summary>
    public partial class ContainerGroup : Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerinstance/v20171201preview:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerinstance/v20171201preview:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
