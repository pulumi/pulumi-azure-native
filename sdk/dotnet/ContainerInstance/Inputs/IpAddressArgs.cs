...
namespace Pulumi.AzureNative.ContainerInstance.Inputs
{
    ...
    public sealed class IpAddressArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.DnsNameLabelReusePolicy>? AutoGeneratedDomainNameLabelScope { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.ContainerGroupIpAddressType> Type { get; set; } = null!;
