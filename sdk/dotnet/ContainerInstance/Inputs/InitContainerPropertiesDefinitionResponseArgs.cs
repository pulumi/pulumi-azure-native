...
namespace Pulumi.AzureRM.ContainerInstance.Inputs
{
    ...
    /// </summary>
    public sealed class InitContainerPropertiesDefinitionResponseArgs : Pulumi.ResourceArgs
    {
        [Input("command")]
        ...
        public Input<Inputs.InitContainerPropertiesDefinitionResponsePropertiesArgs> InstanceView { get; set; } = null!;
        ...
        public InitContainerPropertiesDefinitionResponseArgs()
        {
        }
    }
}
