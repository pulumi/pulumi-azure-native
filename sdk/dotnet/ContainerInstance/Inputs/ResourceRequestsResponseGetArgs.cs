...
namespace Pulumi.AzureRM.ContainerInstance.Inputs
{
    ...
    /// </summary>
    public sealed class ResourceRequestsResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("gpu")]
        public Input<Inputs.GpuResourceResponseGetArgs>? Gpu { get; set; }
        ...
        public ResourceRequestsResponseGetArgs()
        {
        }
    }
}
