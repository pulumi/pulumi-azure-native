...
namespace Pulumi.AzureNative.ContainerInstance.V20210701
{
    public static class GetContainerGroup
    {
        ...
        public static Task<GetContainerGroupResult> InvokeAsync(GetContainerGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContainerGroupResult>("azure-native:containerinstance/v20210701:getContainerGroup", args ?? new GetContainerGroupArgs(), options.WithVersion());

        /// <summary>
        /// A container group.
        /// </summary>
        public static Output<GetContainerGroupResult> Invoke(GetContainerGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetContainerGroupResult>("azure-native:containerinstance/v20210701:getContainerGroup", args ?? new GetContainerGroupInvokeArgs(), options.WithVersion());
    }
