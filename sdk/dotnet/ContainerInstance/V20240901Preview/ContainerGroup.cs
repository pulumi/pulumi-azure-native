...
namespace Pulumi.AzureNative.ContainerInstance.V20240901Preview
{
    ...
    /// A container group.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerinstance/v20240901preview:ContainerGroup")]
    public partial class ContainerGroup : global::Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20240901preview:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20240901preview:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:containerinstance/v20241101preview:ContainerGroup" },
    ...
    public sealed class ContainerGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20240901Preview.OperatingSystemTypes> OsType { get; set; } = null!;

        /// <summary>
        /// The priority of the container group.
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20240901Preview.ContainerGroupPriority>? Priority { get; set; }
        ...
        /// </summary>
        [Input("restartPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20240901Preview.ContainerGroupRestartPolicy>? RestartPolicy { get; set; }

        /// <summary>
        /// The SKU for a container group.
        /// </summary>
        [Input("sku")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20240901Preview.ContainerGroupSku>? Sku { get; set; }
