...
namespace Pulumi.AzureNative.ContainerInstance.V20240901Preview
{
    public static class GetNGroup
    {
        ...
        public static Task<GetNGroupResult> InvokeAsync(GetNGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNGroupResult>("azure-native:containerinstance/v20240901preview:getNGroup", args ?? new GetNGroupArgs(), options.WithDefaults());
