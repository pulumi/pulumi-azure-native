...
namespace Pulumi.AzureNative.ContainerInstance.V20230201Preview
{
    ...
    public partial class ContainerGroup : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("isCustomProvisioningTimeout")]
        public Output<string> IsCustomProvisioningTimeout { get; private set; } = null!;
        ...
        /// </summary>
        [Output("provisioningTimeoutInSeconds")]
        public Output<int?> ProvisioningTimeoutInSeconds { get; private set; } = null!;
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20230201preview:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20230201preview:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20230201Preview.OperatingSystemTypes> OsType { get; set; } = null!;

        /// <summary>
        /// Time in seconds in which a container group deployment would timeout and fail. The allowed maximum value is 1800 seconds. If value is not provided, property is given maximum value by default.
        /// </summary>
        [Input("provisioningTimeoutInSeconds")]
        public Input<int>? ProvisioningTimeoutInSeconds { get; set; }
        ...
        /// </summary>
        [Input("restartPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20230201Preview.ContainerGroupRestartPolicy>? RestartPolicy { get; set; }

        /// <summary>
        /// The SKU for a container group.
        /// </summary>
        [Input("sku")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20230201Preview.ContainerGroupSku>? Sku { get; set; }
