...
namespace Pulumi.AzureRM.ContainerInstance.Latest
{
    ...
    public partial class ContainerGroup : Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerinstance/latest:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerinstance/latest:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
