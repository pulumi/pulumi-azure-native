...
namespace Pulumi.AzureNative.ContainerInstance.V20210901
{
    ...
    /// A container group.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerinstance/v20210901:ContainerGroup")]
    public partial class ContainerGroup : global::Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20210901:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20210901:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
