...
namespace Pulumi.AzureNative.ContainerInstance.V20241001Preview.Inputs
{
    ...
    public sealed class IpAddressArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20241001Preview.DnsNameLabelReusePolicy>? AutoGeneratedDomainNameLabelScope { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20241001Preview.ContainerGroupIpAddressType> Type { get; set; } = null!;
