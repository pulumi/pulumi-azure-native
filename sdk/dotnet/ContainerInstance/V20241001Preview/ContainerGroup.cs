...
namespace Pulumi.AzureNative.ContainerInstance.V20241001Preview
{
    ...
    /// A container group.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerinstance/v20241001preview:ContainerGroup")]
    public partial class ContainerGroup : global::Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20241001preview:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20241001preview:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20241001Preview.OperatingSystemTypes> OsType { get; set; } = null!;

        /// <summary>
        /// The priority of the container group.
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20241001Preview.ContainerGroupPriority>? Priority { get; set; }
        ...
        /// </summary>
        [Input("restartPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20241001Preview.ContainerGroupRestartPolicy>? RestartPolicy { get; set; }
        ...
        /// </summary>
        [Input("sku")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20241001Preview.ContainerGroupSku>? Sku { get; set; }
