...
namespace Pulumi.AzureRM.ContainerInstance
{
    /// <summary>
    /// A container group.
    /// </summary>
    public partial class ContainerGroup : Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerinstance:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, ContainerGroupState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:containerinstance:ContainerGroup", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerGroupState : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("identity")]
        public Input<Inputs.ContainerGroupIdentityResponseGetArgs>? Identity { get; set; }
        ...
        /// </summary>
        [Input("properties", required: true)]
        public Input<Inputs.ContainerGroupResponsePropertiesGetArgs> Properties { get; set; } = null!;
