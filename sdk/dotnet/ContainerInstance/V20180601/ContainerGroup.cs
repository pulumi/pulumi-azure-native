...
namespace Pulumi.AzureNextGen.ContainerInstance.V20180601
{
    ...
    /// A container group.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:containerinstance/v20180601:ContainerGroup")]
    public partial class ContainerGroup : Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:containerinstance/v20180601:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:containerinstance/v20180601:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.ContainerInstance.V20180601.OperatingSystemTypes> OsType { get; set; } = null!;
        ...
        /// </summary>
        [Input("restartPolicy")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerInstance.V20180601.ContainerGroupRestartPolicy>? RestartPolicy { get; set; }
