...
namespace Pulumi.AzureNative.ContainerInstance.V20180601
{
    ...
    /// A container group.
    /// </summary>
    [Obsolete(@"Version v20180601 will be removed in the next major version of the provider. Upgrade to version v20210301 or later.")]
    [AzureNativeResourceType("azure-native:containerinstance/v20180601:ContainerGroup")]
    public partial class ContainerGroup : Pulumi.CustomResource
    {
        ...
        public ContainerGroup(string name, ContainerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20180601:ContainerGroup", name, args ?? new ContainerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerinstance/v20180601:ContainerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
