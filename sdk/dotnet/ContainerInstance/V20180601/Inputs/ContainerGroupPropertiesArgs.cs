...
namespace Pulumi.AzureNative.ContainerInstance.V20180601.Inputs
{
    ...
    public sealed class ContainerGroupPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20180601.OperatingSystemTypes> OsType { get; set; } = null!;
        ...
        /// </summary>
        [Input("restartPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerInstance.V20180601.ContainerGroupRestartPolicy>? RestartPolicy { get; set; }
