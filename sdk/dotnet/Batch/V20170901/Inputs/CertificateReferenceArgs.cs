...
namespace Pulumi.AzureNative.Batch.V20170901.Inputs
{
    ...
    public sealed class CertificateReferenceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("storeLocation")]
        public Input<Pulumi.AzureNative.Batch.V20170901.CertificateStoreLocation>? StoreLocation { get; set; }
        ...
        [Input("visibility")]
        private InputList<Pulumi.AzureNative.Batch.V20170901.CertificateVisibility>? _visibility;
        ...
        /// </summary>
        public InputList<Pulumi.AzureNative.Batch.V20170901.CertificateVisibility> Visibility
        {
            get => _visibility ?? (_visibility = new InputList<Pulumi.AzureNative.Batch.V20170901.CertificateVisibility>());
