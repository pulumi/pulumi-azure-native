...
namespace Pulumi.AzureNative.Batch.V20170901
{
    ...
    /// {
    ///     var application = new AzureNative.Batch.V20170901.Application("application", new()
    ///     {
    ...
    public partial class Application : global::Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20170901:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20170901:Application", name, null, MakeResourceOptions(options, id))
        {
        }
