...
namespace Pulumi.AzureRM.Batch.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationPackage = new AzureRM.Batch.V20200501.ApplicationPackage("applicationPackage", new AzureRM.Batch.V20200501.ApplicationPackageArgs
    ///         {
    ...
    public partial class ApplicationPackage : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:batch/latest:ApplicationPackage"},
