...
namespace Pulumi.AzureRM.Batch.V20200501
{
    ...
    public partial class ApplicationPackage : Pulumi.CustomResource
    {
        ...
        public ApplicationPackage(string name, ApplicationPackageArgs args, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20200501:ApplicationPackage", name, args ?? new ApplicationPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20200501:ApplicationPackage", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:batch/v20181201:ApplicationPackage"},
                    new Alias { Type = "azurerm:batch/v20190401:ApplicationPackage"},
                    new Alias { Type = "azurerm:batch/v20190801:ApplicationPackage"},
                    new Alias { Type = "azurerm:batch/v20200301:ApplicationPackage"},
                },
            };
