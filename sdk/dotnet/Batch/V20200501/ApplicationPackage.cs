...
azure-native:batch/v20200501:ApplicationPackage is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20221001:ApplicationPackage to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:batch/v20200501:ApplicationPackage")]
    public partial class ApplicationPackage : global::Pulumi.CustomResource
    {
        ...
        public ApplicationPackage(string name, ApplicationPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20200501:ApplicationPackage", name, args ?? new ApplicationPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20200501:ApplicationPackage", name, null, MakeResourceOptions(options, id))
        {
        }
