...
namespace Pulumi.AzureNative.Batch.V20200501.Inputs
{
    ...
    public sealed class DataDiskArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNative.Batch.V20200501.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNative.Batch.V20200501.StorageAccountType>? StorageAccountType { get; set; }
