...
namespace Pulumi.AzureRM.Batch.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var batchAccount = new AzureRM.Batch.V20200501.BatchAccount("batchAccount", new AzureRM.Batch.V20200501.BatchAccountArgs
    ///         {
    ///             AccountName = "sampleacct",
    ///             AutoStorage = new AzureRM.Batch.V20200501.Inputs.AutoStorageBasePropertiesArgs
    ///             {
    ///                 StorageAccountId = "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Storage/storageAccounts/samplestorage",
    ///             },
    ///             KeyVaultReference = new AzureRM.Batch.V20200501.Inputs.KeyVaultReferenceArgs
    ///             {
    ...
    ///                 StorageAccountId = "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Storage/storageAccounts/samplestorage",
    ///             },
    ///             Identity = new AzureRM.Batch.V20200501.Inputs.BatchAccountIdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "japaneast",
    ...
    public partial class BatchAccount : Pulumi.CustomResource
    {
        ...
        public BatchAccount(string name, BatchAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20200501:BatchAccount", name, args ?? new BatchAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20200501:BatchAccount", name, null, MakeResourceOptions(options, id))
        {
        }
