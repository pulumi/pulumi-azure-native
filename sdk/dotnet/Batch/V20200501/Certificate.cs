...
namespace Pulumi.AzureNextGen.Batch.V20200501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:batch/v20200501:Certificate")]
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20200501:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20200501:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CertificateArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public Input<Pulumi.AzureNextGen.Batch.V20200501.CertificateFormat>? Format { get; set; }
