...
namespace Pulumi.AzureNextGen.Batch.V20200501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:batch/v20200501:Pool")]
    public partial class Pool : Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20200501:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20200501:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PoolArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Batch.V20200501.InterNodeCommunicationState>? InterNodeCommunication { get; set; }
