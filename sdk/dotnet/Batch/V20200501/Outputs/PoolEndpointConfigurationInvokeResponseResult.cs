...
namespace Pulumi.AzureNextGen.Batch.V20200501.Outputs
{
    ...
    [OutputType]
    public sealed class PoolEndpointConfigurationInvokeResponseResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private PoolEndpointConfigurationInvokeResponseResult(ImmutableArray<Outputs.InboundNatPoolInvokeResponseResult> inboundNatPools)
        {
