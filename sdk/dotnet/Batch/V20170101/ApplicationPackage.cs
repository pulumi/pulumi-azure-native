...
namespace Pulumi.AzureRM.Batch.V20170101
{
    ...
    public partial class ApplicationPackage : Pulumi.CustomResource
    {
        ...
        public ApplicationPackage(string name, ApplicationPackageArgs args, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20170101:ApplicationPackage", name, args ?? new ApplicationPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20170101:ApplicationPackage", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:batch/v20151201:ApplicationPackage"},
                    new Alias { Type = "azurerm:batch/v20170501:ApplicationPackage"},
                    new Alias { Type = "azurerm:batch/v20170901:ApplicationPackage"},
                },
            };
