...
namespace Pulumi.AzureNextGen.Batch.V20170101
{
    public static class ListBatchAccountKeys
    {
        public static Task<ListBatchAccountKeysResult> InvokeAsync(ListBatchAccountKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListBatchAccountKeysResult>("azure-nextgen:batch/v20170101:listBatchAccountKeys", args ?? new ListBatchAccountKeysArgs(), options.WithVersion());
    }
