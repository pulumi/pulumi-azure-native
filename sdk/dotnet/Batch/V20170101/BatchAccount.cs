...
namespace Pulumi.AzureNextGen.Batch.V20170101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:batch/v20170101:BatchAccount")]
    public partial class BatchAccount : Pulumi.CustomResource
    {
        ...
        public BatchAccount(string name, BatchAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20170101:BatchAccount", name, args ?? new BatchAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20170101:BatchAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BatchAccountArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Batch.V20170101.PoolAllocationMode>? PoolAllocationMode { get; set; }
