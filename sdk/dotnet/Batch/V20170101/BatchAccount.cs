...
namespace Pulumi.AzureNative.Batch.V20170101
{
    ...
    /// {
    ///     var batchAccount = new AzureNative.Batch.V20170101.BatchAccount("batchAccount", new()
    ///     {
    ///         AccountName = "sampleacct",
    ///         AutoStorage = new AzureNative.Batch.V20170101.Inputs.AutoStorageBasePropertiesArgs
    ///         {
    ///             StorageAccountId = "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Storage/storageAccounts/samplestorage",
    ///         },
    ///         KeyVaultReference = new AzureNative.Batch.V20170101.Inputs.KeyVaultReferenceArgs
    ///         {
    ///             Id = "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.KeyVault/vaults/sample",
    ///             Url = "http://sample.vault.azure.net/",
    ///         },
    ///         Location = "japaneast",
    ///         PoolAllocationMode = AzureNative.Batch.V20170101.PoolAllocationMode.UserSubscription,
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:batch/v20170101:BatchAccount sampleacct /subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Batch/batchAccounts/sampleacct 
    /// ```
    /// </summary>
    ...
    public partial class BatchAccount : global::Pulumi.CustomResource
    {
        ...
        public BatchAccount(string name, BatchAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20170101:BatchAccount", name, args ?? new BatchAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20170101:BatchAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BatchAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Batch.V20170101.PoolAllocationMode>? PoolAllocationMode { get; set; }
