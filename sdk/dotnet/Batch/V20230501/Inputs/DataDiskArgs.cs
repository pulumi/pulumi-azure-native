...
namespace Pulumi.AzureNative.Batch.V20230501.Inputs
{
    ...
    public sealed class DataDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNative.Batch.V20230501.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNative.Batch.V20230501.StorageAccountType>? StorageAccountType { get; set; }
