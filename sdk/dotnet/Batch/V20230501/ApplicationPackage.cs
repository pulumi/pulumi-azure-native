...
namespace Pulumi.AzureNative.Batch.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:batch/v20230501:ApplicationPackage")]
    public partial class ApplicationPackage : global::Pulumi.CustomResource
    {
        ...
        public ApplicationPackage(string name, ApplicationPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20230501:ApplicationPackage", name, args ?? new ApplicationPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20230501:ApplicationPackage", name, null, MakeResourceOptions(options, id))
        {
        }
