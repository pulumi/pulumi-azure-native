...
namespace Pulumi.AzureNextGen.Batch.V20210101.Inputs
{
    ...
    public sealed class DataDiskArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNextGen.Batch.V20210101.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Batch.V20210101.StorageAccountType>? StorageAccountType { get; set; }
