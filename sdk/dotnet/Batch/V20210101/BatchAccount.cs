...
namespace Pulumi.AzureNative.Batch.V20210101
{
    ...
    /// {
    ///     var batchAccount = new AzureNative.Batch.V20210101.BatchAccount("batchAccount", new()
    ///     {
    ///         AccountName = "sampleacct",
    ///         AutoStorage = new AzureNative.Batch.V20210101.Inputs.AutoStorageBasePropertiesArgs
    ///         {
    ///             StorageAccountId = "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Storage/storageAccounts/samplestorage",
    ///         },
    ///         KeyVaultReference = new AzureNative.Batch.V20210101.Inputs.KeyVaultReferenceArgs
    ///         {
    ///             Id = "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.KeyVault/vaults/sample",
    ///             Url = "http://sample.vault.azure.net/",
    ///         },
    ///         Location = "japaneast",
    ///         PoolAllocationMode = AzureNative.Batch.V20210101.PoolAllocationMode.UserSubscription,
    ...
    ///             StorageAccountId = "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Storage/storageAccounts/samplestorage",
    ///         },
    ///         Identity = new AzureNative.Batch.V20210101.Inputs.BatchAccountIdentityArgs
    ///         {
    ///             Type = AzureNative.Batch.V20210101.ResourceIdentityType.SystemAssigned,
    ///         },
    ///         Location = "japaneast",
    ///         ResourceGroupName = "default-azurebatch-japaneast",
    ///     });
    ...
    ///         Identity = new AzureNative.Batch.V20210101.Inputs.BatchAccountIdentityArgs
    ///         {
    ///             Type = AzureNative.Batch.V20210101.ResourceIdentityType.UserAssigned,
    ...
    ///         },
    ///         Location = "japaneast",
    ///         PublicNetworkAccess = AzureNative.Batch.V20210101.PublicNetworkAccessType.Disabled,
    ///         ResourceGroupName = "default-azurebatch-japaneast",
    ///     });
    /// 
    /// });
    ...
    public partial class BatchAccount : global::Pulumi.CustomResource
    {
        ...
        public BatchAccount(string name, BatchAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20210101:BatchAccount", name, args ?? new BatchAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20210101:BatchAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BatchAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Batch.V20210101.PoolAllocationMode>? PoolAllocationMode { get; set; }

        /// <summary>
        /// If not specified, the default value is 'enabled'.
        /// </summary>
        [Input("publicNetworkAccess")]
        public Input<Pulumi.AzureNative.Batch.V20210101.PublicNetworkAccessType>? PublicNetworkAccess { get; set; }
