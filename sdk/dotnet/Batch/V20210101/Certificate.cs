...
namespace Pulumi.AzureNative.Batch.V20210101
{
    ...
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20210101:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20210101:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CertificateArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public Input<Pulumi.AzureNative.Batch.V20210101.CertificateFormat>? Format { get; set; }
