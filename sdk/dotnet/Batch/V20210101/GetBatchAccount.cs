...
namespace Pulumi.AzureNextGen.Batch.V20210101
{
    public static class GetBatchAccount
    {
        public static Task<GetBatchAccountResult> InvokeAsync(GetBatchAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBatchAccountResult>("azure-nextgen:batch/v20210101:getBatchAccount", args ?? new GetBatchAccountArgs(), options.WithVersion());
    }
