...
namespace Pulumi.AzureNative.Batch.V20181201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:batch/v20181201:ApplicationPackage")]
    public partial class ApplicationPackage : Pulumi.CustomResource
    {
        ...
        public ApplicationPackage(string name, ApplicationPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20181201:ApplicationPackage", name, args ?? new ApplicationPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20181201:ApplicationPackage", name, null, MakeResourceOptions(options, id))
        {
        }
