...
namespace Pulumi.AzureNextGen.Batch.V20181201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:batch/v20181201:ApplicationPackage")]
    public partial class ApplicationPackage : Pulumi.CustomResource
    {
        ...
        public ApplicationPackage(string name, ApplicationPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20181201:ApplicationPackage", name, args ?? new ApplicationPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20181201:ApplicationPackage", name, null, MakeResourceOptions(options, id))
        {
        }
