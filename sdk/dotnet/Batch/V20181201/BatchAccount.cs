...
namespace Pulumi.AzureRM.Batch.V20181201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var batchAccount = new AzureRM.Batch.V20181201.BatchAccount("batchAccount", new AzureRM.Batch.V20181201.BatchAccountArgs
    ///         {
    ///             AccountName = "sampleacct",
    ///             AutoStorage = new AzureRM.Batch.V20181201.Inputs.AutoStorageBasePropertiesArgs
    ///             {
    ///                 StorageAccountId = "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Storage/storageAccounts/samplestorage",
    ///             },
    ///             KeyVaultReference = new AzureRM.Batch.V20181201.Inputs.KeyVaultReferenceArgs
    ///             {
    ...
    public partial class BatchAccount : Pulumi.CustomResource
    {
        ...
        public BatchAccount(string name, BatchAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20181201:BatchAccount", name, args ?? new BatchAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20181201:BatchAccount", name, null, MakeResourceOptions(options, id))
        {
        }
