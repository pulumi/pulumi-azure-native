...
namespace Pulumi.AzureNextGen.Batch.V20181201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:batch/v20181201:BatchAccount")]
    public partial class BatchAccount : Pulumi.CustomResource
    {
        ...
        public BatchAccount(string name, BatchAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20181201:BatchAccount", name, args ?? new BatchAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20181201:BatchAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BatchAccountArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Batch.V20181201.PoolAllocationMode>? PoolAllocationMode { get; set; }
