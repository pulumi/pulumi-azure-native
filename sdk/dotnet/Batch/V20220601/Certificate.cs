...
namespace Pulumi.AzureNative.Batch.V20220601
{
    ...
    /// {
    ///     var certificate = new AzureNative.Batch.V20220601.Certificate("certificate", new()
    ///     {
    ///         AccountName = "sampleacct",
    ///         CertificateName = "sha1-0a0e4f50d51beadeac1d35afc5116098e7902e6e",
    ///         Data = "MIIJsgIBAzCCCW4GCSqGSIb3DQE...",
    ///         Format = AzureNative.Batch.V20220601.CertificateFormat.Pfx,
    ...
    ///         Format = AzureNative.Batch.V20220601.CertificateFormat.Cer,
    ///         ResourceGroupName = "default-azurebatch-japaneast",
    ///     });
    /// 
    /// });
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:batch/v20220601:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20220601:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20220601:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CertificateArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public Input<Pulumi.AzureNative.Batch.V20220601.CertificateFormat>? Format { get; set; }
