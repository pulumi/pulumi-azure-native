...
namespace Pulumi.AzureNative.Batch.V20220601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:batch/v20220601:BatchAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20221001:BatchAccount to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:batch/v20220601:BatchAccount")]
    public partial class BatchAccount : global::Pulumi.CustomResource
    {
        ...
        public BatchAccount(string name, BatchAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20220601:BatchAccount", name, args ?? new BatchAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20220601:BatchAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BatchAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.AzureNative.Batch.V20220601.AuthenticationMode>? _allowedAuthenticationModes;

        /// <summary>
        /// List of allowed authentication modes for the Batch account that can be used to authenticate with the data plane. This does not affect authentication with the control plane.
        /// </summary>
        public InputList<Pulumi.AzureNative.Batch.V20220601.AuthenticationMode> AllowedAuthenticationModes
        {
            get => _allowedAuthenticationModes ?? (_allowedAuthenticationModes = new InputList<Pulumi.AzureNative.Batch.V20220601.AuthenticationMode>());
        ...
        public Input<Pulumi.AzureNative.Batch.V20220601.PoolAllocationMode>? PoolAllocationMode { get; set; }

        /// <summary>
        /// If not specified, the default value is 'enabled'.
        /// </summary>
        [Input("publicNetworkAccess")]
        public Input<Pulumi.AzureNative.Batch.V20220601.PublicNetworkAccessType>? PublicNetworkAccess { get; set; }
