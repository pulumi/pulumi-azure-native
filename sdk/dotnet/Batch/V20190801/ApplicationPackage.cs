...
namespace Pulumi.AzureRM.Batch.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationPackage = new AzureRM.Batch.V20190801.ApplicationPackage("applicationPackage", new AzureRM.Batch.V20190801.ApplicationPackageArgs
    ///         {
    ...
    public partial class ApplicationPackage : Pulumi.CustomResource
    {
        ...
        public ApplicationPackage(string name, ApplicationPackageArgs args, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20190801:ApplicationPackage", name, args ?? new ApplicationPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20190801:ApplicationPackage", name, null, MakeResourceOptions(options, id))
        {
        }
