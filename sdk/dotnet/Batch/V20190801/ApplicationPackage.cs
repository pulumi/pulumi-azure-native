...
namespace Pulumi.AzureNextGen.Batch.V20190801
{
    ...
    public partial class ApplicationPackage : Pulumi.CustomResource
    {
        ...
        public ApplicationPackage(string name, ApplicationPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20190801:ApplicationPackage", name, args ?? new ApplicationPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20190801:ApplicationPackage", name, null, MakeResourceOptions(options, id))
        {
        }
