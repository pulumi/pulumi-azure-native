...
namespace Pulumi.AzureNextGen.Batch.V20190801.Inputs
{
    ...
    public sealed class DataDiskArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNextGen.Batch.V20190801.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Batch.V20190801.StorageAccountType>? StorageAccountType { get; set; }
