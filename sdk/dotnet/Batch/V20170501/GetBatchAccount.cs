...
namespace Pulumi.AzureNative.Batch.V20170501
{
    public static class GetBatchAccount
    {
        ...
        public static Task<GetBatchAccountResult> InvokeAsync(GetBatchAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBatchAccountResult>("azure-native:batch/v20170501:getBatchAccount", args ?? new GetBatchAccountArgs(), options.WithVersion());

        /// <summary>
        /// Contains information about an Azure Batch account.
        /// </summary>
        public static Output<GetBatchAccountResult> Invoke(GetBatchAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBatchAccountResult>("azure-native:batch/v20170501:getBatchAccount", args ?? new GetBatchAccountInvokeArgs(), options.WithVersion());
    }
