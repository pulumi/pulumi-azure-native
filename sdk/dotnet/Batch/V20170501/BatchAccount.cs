...
namespace Pulumi.AzureNextGen.Batch.V20170501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:batch/v20170501:BatchAccount")]
    public partial class BatchAccount : Pulumi.CustomResource
    {
        ...
        public BatchAccount(string name, BatchAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20170501:BatchAccount", name, args ?? new BatchAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20170501:BatchAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BatchAccountArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Batch.V20170501.PoolAllocationMode>? PoolAllocationMode { get; set; }
