...
namespace Pulumi.AzureNative.Batch.V20190401
{
    ...
    [AzureNativeResourceType("azure-native:batch/v20190401:Application")]
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20190401:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20190401:Application", name, null, MakeResourceOptions(options, id))
        {
        }
