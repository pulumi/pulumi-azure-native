...
namespace Pulumi.AzureRM.Batch.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationPackage = new AzureRM.Batch.V20190401.ApplicationPackage("applicationPackage", new AzureRM.Batch.V20190401.ApplicationPackageArgs
    ///         {
    ...
    public partial class ApplicationPackage : Pulumi.CustomResource
    {
        ...
        public ApplicationPackage(string name, ApplicationPackageArgs args, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20190401:ApplicationPackage", name, args ?? new ApplicationPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20190401:ApplicationPackage", name, null, MakeResourceOptions(options, id))
        {
        }
