...
namespace Pulumi.AzureNative.Batch.V20190401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:batch/v20190401:Pool")]
    public partial class Pool : Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20190401:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20190401:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PoolArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Batch.V20190401.InterNodeCommunicationState>? InterNodeCommunication { get; set; }
