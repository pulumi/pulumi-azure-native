...
namespace Pulumi.AzureNative.Batch.V20240701.Inputs
{
    ...
    public sealed class CertificateReferenceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("storeLocation")]
        public Input<Pulumi.AzureNative.Batch.V20240701.CertificateStoreLocation>? StoreLocation { get; set; }
        ...
        [Input("visibility")]
        private InputList<Pulumi.AzureNative.Batch.V20240701.CertificateVisibility>? _visibility;
        public InputList<Pulumi.AzureNative.Batch.V20240701.CertificateVisibility> Visibility
        {
            get => _visibility ?? (_visibility = new InputList<Pulumi.AzureNative.Batch.V20240701.CertificateVisibility>());
