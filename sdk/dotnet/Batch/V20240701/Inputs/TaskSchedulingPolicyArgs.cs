...
namespace Pulumi.AzureNative.Batch.V20240701.Inputs
{
    ...
    public sealed class TaskSchedulingPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Batch.V20240701.ComputeNodeFillType> NodeFillType { get; set; } = null!;

        public TaskSchedulingPolicyArgs()
        {
            NodeFillType = Pulumi.AzureNative.Batch.V20240701.ComputeNodeFillType.Spread;
        }
