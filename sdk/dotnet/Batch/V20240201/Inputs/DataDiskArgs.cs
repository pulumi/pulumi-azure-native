...
namespace Pulumi.AzureNative.Batch.V20240201.Inputs
{
    ...
    public sealed class DataDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNative.Batch.V20240201.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNative.Batch.V20240201.StorageAccountType>? StorageAccountType { get; set; }
