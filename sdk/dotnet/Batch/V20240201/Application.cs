...
namespace Pulumi.AzureNative.Batch.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:batch/v20240201:Application")]
    public partial class Application : global::Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20240201:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20240201:Application", name, null, MakeResourceOptions(options, id))
        {
        }
