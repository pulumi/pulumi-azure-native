...
namespace Pulumi.AzureNative.Batch.V20240201
{
    public static class GetBatchAccount
    {
        ...
        public static Task<GetBatchAccountResult> InvokeAsync(GetBatchAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBatchAccountResult>("azure-native:batch/v20240201:getBatchAccount", args ?? new GetBatchAccountArgs(), options.WithDefaults());
