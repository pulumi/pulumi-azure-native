...
namespace Pulumi.AzureNative.Batch.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:batch/v20240201:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20240201:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20240201:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Batch.V20240201.InterNodeCommunicationState>? InterNodeCommunication { get; set; }
        ...
        public Input<Pulumi.AzureNative.Batch.V20240201.NodeCommunicationMode>? TargetNodeCommunicationMode { get; set; }
