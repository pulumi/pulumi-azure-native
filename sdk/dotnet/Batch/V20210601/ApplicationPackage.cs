...
namespace Pulumi.AzureNative.Batch.V20210601
{
    ...
    [AzureNativeResourceType("azure-native:batch/v20210601:ApplicationPackage")]
    public partial class ApplicationPackage : global::Pulumi.CustomResource
    {
        ...
        public ApplicationPackage(string name, ApplicationPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20210601:ApplicationPackage", name, args ?? new ApplicationPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20210601:ApplicationPackage", name, null, MakeResourceOptions(options, id))
        {
        }
