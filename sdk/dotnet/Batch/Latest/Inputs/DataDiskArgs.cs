...
namespace Pulumi.AzureNative.Batch.Latest.Inputs
{
    ...
    public sealed class DataDiskArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNative.Batch.Latest.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNative.Batch.Latest.StorageAccountType>? StorageAccountType { get; set; }
