...
namespace Pulumi.AzureNextGen.Batch.Latest.Inputs
{
    ...
    public sealed class DataDiskArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNextGen.Batch.Latest.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Batch.Latest.StorageAccountType>? StorageAccountType { get; set; }
