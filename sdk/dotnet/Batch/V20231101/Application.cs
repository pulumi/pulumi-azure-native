...
namespace Pulumi.AzureNative.Batch.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:batch/v20231101:Application")]
    public partial class Application : global::Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20231101:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20231101:Application", name, null, MakeResourceOptions(options, id))
        {
        }
