...
namespace Pulumi.AzureNative.Batch.V20231101
{
    public static class GetBatchAccount
    {
        ...
        public static Task<GetBatchAccountResult> InvokeAsync(GetBatchAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBatchAccountResult>("azure-native:batch/v20231101:getBatchAccount", args ?? new GetBatchAccountArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about the specified Batch account.
        /// </summary>
        public static Output<GetBatchAccountResult> Invoke(GetBatchAccountInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBatchAccountResult>("azure-native:batch/v20231101:getBatchAccount", args ?? new GetBatchAccountInvokeArgs(), options.WithDefaults());
