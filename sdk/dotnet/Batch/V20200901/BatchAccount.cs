...
namespace Pulumi.AzureNextGen.Batch.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:batch/v20200901:BatchAccount")]
    public partial class BatchAccount : Pulumi.CustomResource
    {
        ...
        public BatchAccount(string name, BatchAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20200901:BatchAccount", name, args ?? new BatchAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20200901:BatchAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BatchAccountArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Batch.V20200901.PoolAllocationMode>? PoolAllocationMode { get; set; }

        /// <summary>
        /// If not specified, the default value is 'enabled'.
        /// </summary>
        [Input("publicNetworkAccess")]
        public Input<Pulumi.AzureNextGen.Batch.V20200901.PublicNetworkAccessType>? PublicNetworkAccess { get; set; }
