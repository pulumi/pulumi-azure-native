...
namespace Pulumi.AzureNextGen.Batch.V20200901.Outputs
{
    ...
    [OutputType]
    public sealed class ResizeOperationStatusInvokeResponseResult
    {
        /// <summary>
        /// This property is set only if an error occurred during the last pool resize, and only when the pool allocationState is Steady.
        /// </summary>
        public readonly ImmutableArray<Outputs.ResizeErrorInvokeResponseResult> Errors;
        /// <summary>
        ...
        [OutputConstructor]
        private ResizeOperationStatusInvokeResponseResult(
            ImmutableArray<Outputs.ResizeErrorInvokeResponseResult> errors,
