...
namespace Pulumi.AzureNextGen.Batch.V20200901.Inputs
{
    ...
    public sealed class DataDiskArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNextGen.Batch.V20200901.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Batch.V20200901.StorageAccountType>? StorageAccountType { get; set; }
