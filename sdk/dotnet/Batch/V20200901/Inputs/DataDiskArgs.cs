...
namespace Pulumi.AzureNative.Batch.V20200901.Inputs
{
    ...
    public sealed class DataDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNative.Batch.V20200901.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNative.Batch.V20200901.StorageAccountType>? StorageAccountType { get; set; }
