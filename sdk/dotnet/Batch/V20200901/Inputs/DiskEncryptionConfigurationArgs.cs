...
namespace Pulumi.AzureNative.Batch.V20200901.Inputs
{
    ...
    {
        [Input("targets")]
        private InputList<Pulumi.AzureNative.Batch.V20200901.DiskEncryptionTarget>? _targets;

        /// <summary>
        /// On Linux pool, only "TemporaryDisk" is supported; on Windows pool, "OsDisk" and "TemporaryDisk" must be specified.
        /// </summary>
        public InputList<Pulumi.AzureNative.Batch.V20200901.DiskEncryptionTarget> Targets
        {
            get => _targets ?? (_targets = new InputList<Pulumi.AzureNative.Batch.V20200901.DiskEncryptionTarget>());
            set => _targets = value;
        }
