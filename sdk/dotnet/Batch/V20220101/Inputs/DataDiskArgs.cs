...
namespace Pulumi.AzureNative.Batch.V20220101.Inputs
{
    ...
    public sealed class DataDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNative.Batch.V20220101.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNative.Batch.V20220101.StorageAccountType>? StorageAccountType { get; set; }
