...
namespace Pulumi.AzureNative.Batch.V20220101
{
    ...
    /// {
    ///     var batchAccount = new AzureNative.Batch.V20220101.BatchAccount("batchAccount", new()
    ///     {
    ///         AccountName = "sampleacct",
    ///         AutoStorage = new AzureNative.Batch.V20220101.Inputs.AutoStorageBasePropertiesArgs
    ///         {
    ///             StorageAccountId = "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Storage/storageAccounts/samplestorage",
    ///         },
    ///         KeyVaultReference = new AzureNative.Batch.V20220101.Inputs.KeyVaultReferenceArgs
    ///         {
    ///             Id = "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.KeyVault/vaults/sample",
    ///             Url = "http://sample.vault.azure.net/",
    ///         },
    ///         Location = "japaneast",
    ///         PoolAllocationMode = AzureNative.Batch.V20220101.PoolAllocationMode.UserSubscription,
    ...
    ///             StorageAccountId = "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Storage/storageAccounts/samplestorage",
    ///         },
    ///         Identity = new AzureNative.Batch.V20220101.Inputs.BatchAccountIdentityArgs
    ///         {
    ///             Type = AzureNative.Batch.V20220101.ResourceIdentityType.SystemAssigned,
    ///         },
    ///         Location = "japaneast",
    ///         ResourceGroupName = "default-azurebatch-japaneast",
    ///     });
    ...
    ///         Identity = new AzureNative.Batch.V20220101.Inputs.BatchAccountIdentityArgs
    ///         {
    ///             Type = AzureNative.Batch.V20220101.ResourceIdentityType.UserAssigned,
    ...
    ///         },
    ///         Location = "japaneast",
    ///         PublicNetworkAccess = AzureNative.Batch.V20220101.PublicNetworkAccessType.Disabled,
    ///         ResourceGroupName = "default-azurebatch-japaneast",
    ///     });
    /// 
    /// });
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:batch/v20220101:BatchAccount sampleacct /subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Batch/batchAccounts/sampleacct 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:batch/v20220101:BatchAccount")]
    public partial class BatchAccount : global::Pulumi.CustomResource
    {
        ...
        public BatchAccount(string name, BatchAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20220101:BatchAccount", name, args ?? new BatchAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20220101:BatchAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BatchAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.AzureNative.Batch.V20220101.AuthenticationMode>? _allowedAuthenticationModes;

        /// <summary>
        /// List of allowed authentication modes for the Batch account that can be used to authenticate with the data plane. This does not affect authentication with the control plane.
        /// </summary>
        public InputList<Pulumi.AzureNative.Batch.V20220101.AuthenticationMode> AllowedAuthenticationModes
        {
            get => _allowedAuthenticationModes ?? (_allowedAuthenticationModes = new InputList<Pulumi.AzureNative.Batch.V20220101.AuthenticationMode>());
        ...
        public Input<Pulumi.AzureNative.Batch.V20220101.PoolAllocationMode>? PoolAllocationMode { get; set; }

        /// <summary>
        /// If not specified, the default value is 'enabled'.
        /// </summary>
        [Input("publicNetworkAccess")]
        public Input<Pulumi.AzureNative.Batch.V20220101.PublicNetworkAccessType>? PublicNetworkAccess { get; set; }
