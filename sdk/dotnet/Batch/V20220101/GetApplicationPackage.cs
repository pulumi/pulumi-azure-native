...
namespace Pulumi.AzureNative.Batch.V20220101
{
    public static class GetApplicationPackage
    {
        ...
        public static Task<GetApplicationPackageResult> InvokeAsync(GetApplicationPackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApplicationPackageResult>("azure-native:batch/v20220101:getApplicationPackage", args ?? new GetApplicationPackageArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about the specified application package.
        /// </summary>
        public static Output<GetApplicationPackageResult> Invoke(GetApplicationPackageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApplicationPackageResult>("azure-native:batch/v20220101:getApplicationPackage", args ?? new GetApplicationPackageInvokeArgs(), options.WithDefaults());
    }
