...
namespace Pulumi.AzureNative.Batch.V20221001.Inputs
{
    ...
    public sealed class DataDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNative.Batch.V20221001.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNative.Batch.V20221001.StorageAccountType>? StorageAccountType { get; set; }
