...
namespace Pulumi.AzureNative.Batch.V20221001
{
    ...
    /// {
    ///     var applicationPackage = new AzureNative.Batch.V20221001.ApplicationPackage("applicationPackage", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:batch/v20221001:ApplicationPackage")]
    public partial class ApplicationPackage : global::Pulumi.CustomResource
    {
        ...
        public ApplicationPackage(string name, ApplicationPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20221001:ApplicationPackage", name, args ?? new ApplicationPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20221001:ApplicationPackage", name, null, MakeResourceOptions(options, id))
        {
        }
