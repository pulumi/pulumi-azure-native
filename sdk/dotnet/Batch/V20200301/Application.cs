...
namespace Pulumi.AzureNative.Batch.V20200301
{
    /// <summary>
    /// Contains information about an application in a Batch account.
    /// </summary>
    [Obsolete(@"Version v20200301 will be removed in the next major version of the provider. Upgrade to version v20210101 or later.")]
    [AzureNativeResourceType("azure-native:batch/v20200301:Application")]
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20200301:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20200301:Application", name, null, MakeResourceOptions(options, id))
        {
        }
