...
namespace Pulumi.AzureRM.Batch.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var application = new AzureRM.Batch.V20200301.Application("application", new AzureRM.Batch.V20200301.ApplicationArgs
    ///         {
    ...
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20200301:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:batch/v20200301:Application", name, null, MakeResourceOptions(options, id))
        {
        }
