...
namespace Pulumi.AzureNative.Batch.V20200301.Inputs
{
    ...
    {
        [Input("targets")]
        private InputList<Pulumi.AzureNative.Batch.V20200301.DiskEncryptionTarget>? _targets;

        /// <summary>
        /// On Linux pool, only "TemporaryDisk" is supported; on Windows pool, "OsDisk" and "TemporaryDisk" must be specified.
        /// </summary>
        public InputList<Pulumi.AzureNative.Batch.V20200301.DiskEncryptionTarget> Targets
        {
            get => _targets ?? (_targets = new InputList<Pulumi.AzureNative.Batch.V20200301.DiskEncryptionTarget>());
            set => _targets = value;
        }
