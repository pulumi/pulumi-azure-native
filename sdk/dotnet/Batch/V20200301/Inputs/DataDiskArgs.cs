...
namespace Pulumi.AzureNextGen.Batch.V20200301.Inputs
{
    ...
    public sealed class DataDiskArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNextGen.Batch.V20200301.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Batch.V20200301.StorageAccountType>? StorageAccountType { get; set; }
