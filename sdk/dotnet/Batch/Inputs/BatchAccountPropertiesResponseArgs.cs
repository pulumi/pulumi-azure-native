...
namespace Pulumi.AzureRM.Batch.Inputs
{
    ...
    /// </summary>
    public sealed class BatchAccountPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.AutoStoragePropertiesResponseArgs> AutoStorage { get; set; } = null!;
        ...
        private InputList<Inputs.VirtualMachineFamilyCoreQuotaResponseArgs>? _dedicatedCoreQuotaPerVMFamily;

        /// <summary>
        /// A list of the dedicated core quota per Virtual Machine family for the Batch account. For accounts with PoolAllocationMode set to UserSubscription, quota is managed on the subscription so this value is not returned.
        /// </summary>
        public InputList<Inputs.VirtualMachineFamilyCoreQuotaResponseArgs> DedicatedCoreQuotaPerVMFamily
        {
            get => _dedicatedCoreQuotaPerVMFamily ?? (_dedicatedCoreQuotaPerVMFamily = new InputList<Inputs.VirtualMachineFamilyCoreQuotaResponseArgs>());
        ...
        public Input<Inputs.EncryptionPropertiesResponseArgs> Encryption { get; set; } = null!;

        /// <summary>
        /// Identifies the Azure key vault associated with a Batch account.
        /// </summary>
        [Input("keyVaultReference", required: true)]
        public Input<Inputs.KeyVaultReferenceResponseArgs> KeyVaultReference { get; set; } = null!;
        ...
        public BatchAccountPropertiesResponseArgs()
        {
        }
    }
}
