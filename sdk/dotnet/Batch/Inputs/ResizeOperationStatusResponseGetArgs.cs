...
namespace Pulumi.AzureRM.Batch.Inputs
{
    ...
    /// </summary>
    public sealed class ResizeOperationStatusResponseGetArgs : Pulumi.ResourceArgs
    {
        [Input("errors")]
        private InputList<Inputs.ResizeErrorResponseGetArgs>? _errors;

        /// <summary>
        /// This property is set only if an error occurred during the last pool resize, and only when the pool allocationState is Steady.
        /// </summary>
        public InputList<Inputs.ResizeErrorResponseGetArgs> Errors
        {
            get => _errors ?? (_errors = new InputList<Inputs.ResizeErrorResponseGetArgs>());
            set => _errors = value;
        }
        ...
        public ResizeOperationStatusResponseGetArgs()
        {
        }
    }
}
