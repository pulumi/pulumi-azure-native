...
namespace Pulumi.AzureNextGen.Batch.Inputs
{
    ...
    public sealed class DataDiskArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNextGen.Batch.CachingType>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Batch.StorageAccountType>? StorageAccountType { get; set; }
