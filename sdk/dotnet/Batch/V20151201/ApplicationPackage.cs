...
namespace Pulumi.AzureNative.Batch.V20151201
{
    ...
    [AzureNativeResourceType("azure-native:batch/v20151201:ApplicationPackage")]
    public partial class ApplicationPackage : global::Pulumi.CustomResource
    {
        ...
        public ApplicationPackage(string name, ApplicationPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20151201:ApplicationPackage", name, args ?? new ApplicationPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batch/v20151201:ApplicationPackage", name, null, MakeResourceOptions(options, id))
        {
        }
