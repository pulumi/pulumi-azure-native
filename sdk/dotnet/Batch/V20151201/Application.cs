...
namespace Pulumi.AzureNextGen.Batch.V20151201
{
    ...
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20151201:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:batch/v20151201:Application", name, null, MakeResourceOptions(options, id))
        {
        }
