...
namespace Pulumi.AzureRM.Batch.Preview
{
    public static class GetBatchAccount
    {
        public static Task<GetBatchAccountResult> InvokeAsync(GetBatchAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBatchAccountResult>("azurerm:batch/preview:getBatchAccount", args ?? new GetBatchAccountArgs(), options.WithVersion());
    }
    ...
    public sealed class GetBatchAccountResult
    {
        ...
        /// </summary>
        public readonly Outputs.BatchAccountIdentityResponseResult? Identity;
        /// <summary>
        ...
        private GetBatchAccountResult(
            ...
            Outputs.BatchAccountIdentityResponseResult? identity,
