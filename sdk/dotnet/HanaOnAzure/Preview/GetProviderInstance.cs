...
namespace Pulumi.AzureRM.HanaOnAzure.Preview
{
    public static class GetProviderInstance
    {
        public static Task<GetProviderInstanceResult> InvokeAsync(GetProviderInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProviderInstanceResult>("azurerm:hanaonazure/preview:getProviderInstance", args ?? new GetProviderInstanceArgs(), options.WithVersion());
    }
