...
namespace Pulumi.AzureRM.HanaOnAzure.Preview
{
    ...
    public partial class SapMonitor : Pulumi.CustomResource
    {
        ...
        public SapMonitor(string name, SapMonitorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hanaonazure/preview:SapMonitor", name, args ?? new SapMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SapMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hanaonazure/preview:SapMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
