...
namespace Pulumi.AzureRM.HanaOnAzure.Preview
{
    ...
    public partial class ProviderInstance : Pulumi.CustomResource
    {
        ...
        public ProviderInstance(string name, ProviderInstanceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hanaonazure/preview:ProviderInstance", name, args ?? new ProviderInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProviderInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hanaonazure/preview:ProviderInstance", name, null, MakeResourceOptions(options, id))
        {
        }
