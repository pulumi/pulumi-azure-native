...
namespace Pulumi.AzureRM.HanaOnAzure.Preview
{
    public static class GetHanaInstance
    {
        public static Task<GetHanaInstanceResult> InvokeAsync(GetHanaInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHanaInstanceResult>("azurerm:hanaonazure/preview:getHanaInstance", args ?? new GetHanaInstanceArgs(), options.WithVersion());
    }
