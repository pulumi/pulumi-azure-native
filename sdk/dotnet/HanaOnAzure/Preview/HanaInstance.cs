...
namespace Pulumi.AzureRM.HanaOnAzure.Preview
{
    ...
    public partial class HanaInstance : Pulumi.CustomResource
    {
        ...
        public HanaInstance(string name, HanaInstanceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hanaonazure/preview:HanaInstance", name, args ?? new HanaInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HanaInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hanaonazure/preview:HanaInstance", name, null, MakeResourceOptions(options, id))
        {
        }
