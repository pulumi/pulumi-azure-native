...
namespace Pulumi.AzureRM.HanaOnAzure.Latest
{
    public static class GetHanaInstance
    {
        public static Task<GetHanaInstanceResult> InvokeAsync(GetHanaInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHanaInstanceResult>("azurerm:hanaonazure/latest:getHanaInstance", args ?? new GetHanaInstanceArgs(), options.WithVersion());
    }
