...
namespace Pulumi.AzureRM.HanaOnAzure.Latest
{
    public static class GetProviderInstance
    {
        public static Task<GetProviderInstanceResult> InvokeAsync(GetProviderInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProviderInstanceResult>("azurerm:hanaonazure/latest:getProviderInstance", args ?? new GetProviderInstanceArgs(), options.WithVersion());
    }
