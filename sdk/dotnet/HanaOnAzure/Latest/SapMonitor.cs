...
namespace Pulumi.AzureRM.HanaOnAzure.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sapMonitor = new AzureRM.HanaOnAzure.Latest.SapMonitor("sapMonitor", new AzureRM.HanaOnAzure.Latest.SapMonitorArgs
    ///         {
    ...
    public partial class SapMonitor : Pulumi.CustomResource
    {
        ...
        public SapMonitor(string name, SapMonitorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hanaonazure/latest:SapMonitor", name, args ?? new SapMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SapMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hanaonazure/latest:SapMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
