...
namespace Pulumi.AzureRM.HanaOnAzure.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var providerInstance = new AzureRM.HanaOnAzure.Latest.ProviderInstance("providerInstance", new AzureRM.HanaOnAzure.Latest.ProviderInstanceArgs
    ///         {
    ///             Metadata = "{\"key\":\"value\"}",
    ...
    public partial class ProviderInstance : Pulumi.CustomResource
    {
        ...
        public ProviderInstance(string name, ProviderInstanceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hanaonazure/latest:ProviderInstance", name, args ?? new ProviderInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProviderInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hanaonazure/latest:ProviderInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:hanaonazure/v20200207preview:ProviderInstance"},
                },
            };
