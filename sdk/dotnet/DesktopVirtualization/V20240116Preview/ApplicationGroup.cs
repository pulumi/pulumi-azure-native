...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240116Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20240116preview:ApplicationGroup")]
    public partial class ApplicationGroup : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGroup(string name, ApplicationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240116preview:ApplicationGroup", name, args ?? new ApplicationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240116preview:ApplicationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApplicationGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.ApplicationGroupType> ApplicationGroupType { get; set; } = null!;
