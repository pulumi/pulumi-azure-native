...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240116Preview
{
    public static class GetAppAttachPackage
    {
        ...
        public static Task<GetAppAttachPackageResult> InvokeAsync(GetAppAttachPackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppAttachPackageResult>("azure-native:desktopvirtualization/v20240116preview:getAppAttachPackage", args ?? new GetAppAttachPackageArgs(), options.WithDefaults());

        /// <summary>
        /// Get an app attach package.
        /// </summary>
        public static Output<GetAppAttachPackageResult> Invoke(GetAppAttachPackageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppAttachPackageResult>("azure-native:desktopvirtualization/v20240116preview:getAppAttachPackage", args ?? new GetAppAttachPackageInvokeArgs(), options.WithDefaults());
    }
