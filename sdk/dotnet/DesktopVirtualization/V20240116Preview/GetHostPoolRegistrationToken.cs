...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240116Preview
{
    public static class GetHostPoolRegistrationToken
    {
        ...
        public static Task<GetHostPoolRegistrationTokenResult> InvokeAsync(GetHostPoolRegistrationTokenArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHostPoolRegistrationTokenResult>("azure-native:desktopvirtualization/v20240116preview:getHostPoolRegistrationToken", args ?? new GetHostPoolRegistrationTokenArgs(), options.WithDefaults());
        ...
        public static Output<GetHostPoolRegistrationTokenResult> Invoke(GetHostPoolRegistrationTokenInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHostPoolRegistrationTokenResult>("azure-native:desktopvirtualization/v20240116preview:getHostPoolRegistrationToken", args ?? new GetHostPoolRegistrationTokenInvokeArgs(), options.WithDefaults());
    }
