...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240116Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20240116preview:ScalingPlanPersonalSchedule")]
    public partial class ScalingPlanPersonalSchedule : global::Pulumi.CustomResource
    {
        ...
        public ScalingPlanPersonalSchedule(string name, ScalingPlanPersonalScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240116preview:ScalingPlanPersonalSchedule", name, args ?? new ScalingPlanPersonalScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlanPersonalSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240116preview:ScalingPlanPersonalSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("daysOfWeek")]
        private InputList<Union<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.DayOfWeek>>? _daysOfWeek;

        /// <summary>
        /// Set of days of the week on which this schedule is active.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.DayOfWeek>> DaysOfWeek
        {
            get => _daysOfWeek ?? (_daysOfWeek = new InputList<Union<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.DayOfWeek>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.SessionHandlingOperation>? OffPeakActionOnDisconnect { get; set; }

        /// <summary>
        /// Action to be taken after a logoff during the off-peak period.
        /// </summary>
        [Input("offPeakActionOnLogoff")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.SessionHandlingOperation>? OffPeakActionOnLogoff { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.SetStartVMOnConnect>? OffPeakStartVMOnConnect { get; set; }

        /// <summary>
        /// Action to be taken after a user disconnect during the peak period.
        /// </summary>
        [Input("peakActionOnDisconnect")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.SessionHandlingOperation>? PeakActionOnDisconnect { get; set; }

        /// <summary>
        /// Action to be taken after a logoff during the peak period.
        /// </summary>
        [Input("peakActionOnLogoff")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.SessionHandlingOperation>? PeakActionOnLogoff { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.SetStartVMOnConnect>? PeakStartVMOnConnect { get; set; }

        /// <summary>
        /// Action to be taken after a user disconnect during the ramp down period.
        /// </summary>
        [Input("rampDownActionOnDisconnect")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.SessionHandlingOperation>? RampDownActionOnDisconnect { get; set; }

        /// <summary>
        /// Action to be taken after a logoff during the ramp down period.
        /// </summary>
        [Input("rampDownActionOnLogoff")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.SessionHandlingOperation>? RampDownActionOnLogoff { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.SetStartVMOnConnect>? RampDownStartVMOnConnect { get; set; }

        /// <summary>
        /// Action to be taken after a user disconnect during the ramp up period.
        /// </summary>
        [Input("rampUpActionOnDisconnect")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.SessionHandlingOperation>? RampUpActionOnDisconnect { get; set; }

        /// <summary>
        /// Action to be taken after a logoff during the ramp up period.
        /// </summary>
        [Input("rampUpActionOnLogoff")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.SessionHandlingOperation>? RampUpActionOnLogoff { get; set; }

        /// <summary>
        /// The desired startup behavior during the ramp up period for personal vms in the hostpool.
        /// </summary>
        [Input("rampUpAutoStartHosts")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.StartupBehavior>? RampUpAutoStartHosts { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240116Preview.SetStartVMOnConnect>? RampUpStartVMOnConnect { get; set; }
