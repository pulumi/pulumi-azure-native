...
namespace Pulumi.AzureNative.DesktopVirtualization.V20220401Preview
{
    ...
    /// {
    ///     var applicationGroup = new AzureNative.DesktopVirtualization.V20220401Preview.ApplicationGroup("applicationGroup", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:desktopvirtualization/v20220401preview:ApplicationGroup applicationGroup1 /subscriptions/daefabc0-95b4-48b3-b645-8a753a63c4fa/resourceGroups/resourceGroup1/providers/Microsoft.DesktopVirtualization/applicationGroups/applicationGroup1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20220401preview:ApplicationGroup")]
    public partial class ApplicationGroup : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGroup(string name, ApplicationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20220401preview:ApplicationGroup", name, args ?? new ApplicationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20220401preview:ApplicationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
