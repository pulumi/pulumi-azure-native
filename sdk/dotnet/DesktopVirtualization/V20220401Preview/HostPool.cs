...
namespace Pulumi.AzureNative.DesktopVirtualization.V20220401Preview
{
    ...
    public partial class HostPool : global::Pulumi.CustomResource
    {
        ...
        public HostPool(string name, HostPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20220401preview:HostPool", name, args ?? new HostPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HostPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20220401preview:HostPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class HostPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20220401Preview.HostPoolType> HostPoolType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20220401Preview.LoadBalancerType> LoadBalancerType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20220401Preview.PersonalDesktopAssignmentType>? PersonalDesktopAssignmentType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20220401Preview.PreferredAppGroupType> PreferredAppGroupType { get; set; } = null!;

        /// <summary>
        /// Enabled allows this resource to be accessed from both public and private networks, Disabled allows this resource to only be accessed via private endpoints
        /// </summary>
        [Input("publicNetworkAccess")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20220401Preview.HostpoolPublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        /// </summary>
        [Input("ssoSecretType")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20220401Preview.SSOSecretType>? SsoSecretType { get; set; }
