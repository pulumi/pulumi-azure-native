...
namespace Pulumi.AzureNative.DesktopVirtualization
{
    public static class GetSessionHostConfiguration
    {
        ...
        public static Task<GetSessionHostConfigurationResult> InvokeAsync(GetSessionHostConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSessionHostConfigurationResult>("azure-native:desktopvirtualization:getSessionHostConfiguration", args ?? new GetSessionHostConfigurationArgs(), options.WithVersion());
    }
