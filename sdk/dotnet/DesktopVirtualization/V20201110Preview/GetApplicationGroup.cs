...
namespace Pulumi.AzureNextGen.DesktopVirtualization.V20201110Preview
{
    public static class GetApplicationGroup
    {
        ...
        public static Task<GetApplicationGroupResult> InvokeAsync(GetApplicationGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationGroupResult>("azure-nextgen:desktopvirtualization/v20201110preview:getApplicationGroup", args ?? new GetApplicationGroupArgs(), options.WithVersion());
    }
