...
namespace Pulumi.AzureNextGen.DesktopVirtualization.V20201110Preview
{
    public static class GetHostPool
    {
        public static Task<GetHostPoolResult> InvokeAsync(GetHostPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHostPoolResult>("azure-nextgen:desktopvirtualization/v20201110preview:getHostPool", args ?? new GetHostPoolArgs(), options.WithVersion());
    }
