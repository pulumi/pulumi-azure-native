...
namespace Pulumi.AzureNative.DesktopVirtualization.V20201110Preview
{
    ...
    /// {
    ///     var workspace = new AzureNative.DesktopVirtualization.V20201110Preview.Workspace("workspace", new()
    ///     {
    ///         Description = "des1",
    ...
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20201110preview:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20201110preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20201110preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
