...
namespace Pulumi.AzureNextGen.DesktopVirtualization.V20201102Preview
{
    public static class GetMSIXPackage
    {
        public static Task<GetMSIXPackageResult> InvokeAsync(GetMSIXPackageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMSIXPackageResult>("azure-nextgen:desktopvirtualization/v20201102preview:getMSIXPackage", args ?? new GetMSIXPackageArgs(), options.WithVersion());
    }
