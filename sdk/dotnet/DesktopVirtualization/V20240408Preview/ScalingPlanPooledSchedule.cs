...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240408Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20240408preview:ScalingPlanPooledSchedule")]
    public partial class ScalingPlanPooledSchedule : global::Pulumi.CustomResource
    {
        ...
        public ScalingPlanPooledSchedule(string name, ScalingPlanPooledScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240408preview:ScalingPlanPooledSchedule", name, args ?? new ScalingPlanPooledScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlanPooledSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240408preview:ScalingPlanPooledSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScalingPlanPooledScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SessionHostLoadBalancingAlgorithm>? OffPeakLoadBalancingAlgorithm { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SessionHostLoadBalancingAlgorithm>? PeakLoadBalancingAlgorithm { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SessionHostLoadBalancingAlgorithm>? RampDownLoadBalancingAlgorithm { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.StopHostsWhen>? RampDownStopHostsWhen { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SessionHostLoadBalancingAlgorithm>? RampUpLoadBalancingAlgorithm { get; set; }
