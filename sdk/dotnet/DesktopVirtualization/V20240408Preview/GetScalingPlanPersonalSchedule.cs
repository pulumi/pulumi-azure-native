...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240408Preview
{
    public static class GetScalingPlanPersonalSchedule
    {
        ...
        public static Task<GetScalingPlanPersonalScheduleResult> InvokeAsync(GetScalingPlanPersonalScheduleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScalingPlanPersonalScheduleResult>("azure-native:desktopvirtualization/v20240408preview:getScalingPlanPersonalSchedule", args ?? new GetScalingPlanPersonalScheduleArgs(), options.WithDefaults());
        ...
        public static Output<GetScalingPlanPersonalScheduleResult> Invoke(GetScalingPlanPersonalScheduleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScalingPlanPersonalScheduleResult>("azure-native:desktopvirtualization/v20240408preview:getScalingPlanPersonalSchedule", args ?? new GetScalingPlanPersonalScheduleInvokeArgs(), options.WithDefaults());
