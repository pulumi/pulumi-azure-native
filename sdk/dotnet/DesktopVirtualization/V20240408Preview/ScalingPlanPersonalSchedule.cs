...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240408Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20240408preview:ScalingPlanPersonalSchedule")]
    public partial class ScalingPlanPersonalSchedule : global::Pulumi.CustomResource
    {
        ...
        public ScalingPlanPersonalSchedule(string name, ScalingPlanPersonalScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240408preview:ScalingPlanPersonalSchedule", name, args ?? new ScalingPlanPersonalScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlanPersonalSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240408preview:ScalingPlanPersonalSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("daysOfWeek")]
        private InputList<Union<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.DayOfWeek>>? _daysOfWeek;

        /// <summary>
        /// Set of days of the week on which this schedule is active.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.DayOfWeek>> DaysOfWeek
        {
            get => _daysOfWeek ?? (_daysOfWeek = new InputList<Union<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.DayOfWeek>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SessionHandlingOperation>? OffPeakActionOnDisconnect { get; set; }

        /// <summary>
        /// Action to be taken after a logoff during the off-peak period.
        /// </summary>
        [Input("offPeakActionOnLogoff")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SessionHandlingOperation>? OffPeakActionOnLogoff { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SetStartVMOnConnect>? OffPeakStartVMOnConnect { get; set; }

        /// <summary>
        /// Action to be taken after a user disconnect during the peak period.
        /// </summary>
        [Input("peakActionOnDisconnect")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SessionHandlingOperation>? PeakActionOnDisconnect { get; set; }

        /// <summary>
        /// Action to be taken after a logoff during the peak period.
        /// </summary>
        [Input("peakActionOnLogoff")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SessionHandlingOperation>? PeakActionOnLogoff { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SetStartVMOnConnect>? PeakStartVMOnConnect { get; set; }

        /// <summary>
        /// Action to be taken after a user disconnect during the ramp down period.
        /// </summary>
        [Input("rampDownActionOnDisconnect")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SessionHandlingOperation>? RampDownActionOnDisconnect { get; set; }

        /// <summary>
        /// Action to be taken after a logoff during the ramp down period.
        /// </summary>
        [Input("rampDownActionOnLogoff")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SessionHandlingOperation>? RampDownActionOnLogoff { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SetStartVMOnConnect>? RampDownStartVMOnConnect { get; set; }

        /// <summary>
        /// Action to be taken after a user disconnect during the ramp up period.
        /// </summary>
        [Input("rampUpActionOnDisconnect")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SessionHandlingOperation>? RampUpActionOnDisconnect { get; set; }

        /// <summary>
        /// Action to be taken after a logoff during the ramp up period.
        /// </summary>
        [Input("rampUpActionOnLogoff")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SessionHandlingOperation>? RampUpActionOnLogoff { get; set; }

        /// <summary>
        /// The desired startup behavior during the ramp up period for personal vms in the hostpool.
        /// </summary>
        [Input("rampUpAutoStartHosts")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.StartupBehavior>? RampUpAutoStartHosts { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240408Preview.SetStartVMOnConnect>? RampUpStartVMOnConnect { get; set; }
