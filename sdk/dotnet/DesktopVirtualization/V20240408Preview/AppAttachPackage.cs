...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240408Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20240408preview:AppAttachPackage")]
    public partial class AppAttachPackage : global::Pulumi.CustomResource
    {
        ...
        public AppAttachPackage(string name, AppAttachPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240408preview:AppAttachPackage", name, args ?? new AppAttachPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppAttachPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240408preview:AppAttachPackage", name, null, MakeResourceOptions(options, id))
        {
        }
