...
namespace Pulumi.AzureNextGen.DesktopVirtualization.V20210201Preview.Inputs
{
    ...
    public sealed class ScalingScheduleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20210201Preview.SessionHostLoadBalancingAlgorithm>? OffPeakLoadBalancingAlgorithm { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20210201Preview.SessionHostLoadBalancingAlgorithm>? PeakLoadBalancingAlgorithm { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20210201Preview.SessionHostLoadBalancingAlgorithm>? RampDownLoadBalancingAlgorithm { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20210201Preview.StopHostsWhen>? RampDownStopHostsWhen { get; set; }

        /// <summary>
        /// Load balancing algorithm for ramp up period.
        /// </summary>
        [Input("rampUpAlgorithm")]
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20210201Preview.SessionHostLoadBalancingAlgorithm>? RampUpAlgorithm { get; set; }
