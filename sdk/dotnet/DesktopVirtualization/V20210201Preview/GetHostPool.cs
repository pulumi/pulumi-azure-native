...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210201Preview
{
    public static class GetHostPool
    {
        ...
        public static Task<GetHostPoolResult> InvokeAsync(GetHostPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHostPoolResult>("azure-native:desktopvirtualization/v20210201preview:getHostPool", args ?? new GetHostPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Represents a HostPool definition.
        /// </summary>
        public static Output<GetHostPoolResult> Invoke(GetHostPoolInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetHostPoolResult>("azure-native:desktopvirtualization/v20210201preview:getHostPool", args ?? new GetHostPoolInvokeArgs(), options.WithDefaults());
    }
