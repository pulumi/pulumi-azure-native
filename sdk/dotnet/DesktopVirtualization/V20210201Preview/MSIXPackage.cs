...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210201Preview
{
    ...
    /// {
    ///     var msixPackage = new AzureNative.DesktopVirtualization.V20210201Preview.MSIXPackage("msixPackage", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.DesktopVirtualization.V20210201Preview.Inputs.MsixPackageApplicationsArgs
    ///             {
    ///                 AppId = "ApplicationId",
    ...
    ///         {
    ///             new AzureNative.DesktopVirtualization.V20210201Preview.Inputs.MsixPackageDependenciesArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:desktopvirtualization/v20210201preview:MSIXPackage hostpool1/MsixPackageFullName /subscriptions/daefabc0-95b4-48b3-b645-8a753a63c4fa/resourcegroups/resourcegroup1/providers/Microsoft.DesktopVirtualization/hostpools/hostpool1/msixpackages/msixPackageFullName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20210201preview:MSIXPackage")]
    public partial class MSIXPackage : global::Pulumi.CustomResource
    {
        ...
        public MSIXPackage(string name, MSIXPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210201preview:MSIXPackage", name, args ?? new MSIXPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MSIXPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210201preview:MSIXPackage", name, null, MakeResourceOptions(options, id))
        {
        }
