...
namespace Pulumi.AzureNextGen.DesktopVirtualization.V20210201Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:desktopvirtualization/v20210201preview:ScalingPlan")]
    public partial class ScalingPlan : Pulumi.CustomResource
    {
        ...
        public ScalingPlan(string name, ScalingPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:desktopvirtualization/v20210201preview:ScalingPlan", name, args ?? new ScalingPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:desktopvirtualization/v20210201preview:ScalingPlan", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScalingPlanArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostPoolType")]
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20210201Preview.HostPoolType>? HostPoolType { get; set; }
