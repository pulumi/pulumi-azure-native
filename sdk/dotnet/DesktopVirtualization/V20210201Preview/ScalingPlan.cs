...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210201Preview
{
    ...
    /// {
    ///     var scalingPlan = new AzureNative.DesktopVirtualization.V20210201Preview.ScalingPlan("scalingPlan", new()
    ///     {
    ///         Description = "des1",
    ///         ExclusionTag = "value",
    ...
    ///         {
    ///             new AzureNative.DesktopVirtualization.V20210201Preview.Inputs.ScalingHostPoolReferenceArgs
    ///             {
    ...
    ///         Schedules = new[]
    ///         {
    ///             new AzureNative.DesktopVirtualization.V20210201Preview.Inputs.ScalingScheduleArgs
    ///             {
    ///                 DaysOfWeek = new[]
    ///                 {
    ///                     "Monday",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20210201preview:ScalingPlan")]
    public partial class ScalingPlan : global::Pulumi.CustomResource
    {
        ...
        public ScalingPlan(string name, ScalingPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210201preview:ScalingPlan", name, args ?? new ScalingPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210201preview:ScalingPlan", name, null, MakeResourceOptions(options, id))
        {
        }
