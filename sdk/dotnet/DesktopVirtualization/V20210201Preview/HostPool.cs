...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210201Preview
{
    ...
    /// {
    ///     var hostPool = new AzureNative.DesktopVirtualization.V20210201Preview.HostPool("hostPool", new()
    ///     {
    ///         Description = "des1",
    ...
    ///         RegistrationInfo = new AzureNative.DesktopVirtualization.V20210201Preview.Inputs.RegistrationInfoArgs
    ///         {
    ...
    public sealed class HostPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20210201Preview.LoadBalancerType> LoadBalancerType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20210201Preview.PreferredAppGroupType> PreferredAppGroupType { get; set; } = null!;
        ...
        /// </summary>
        [Input("ssoSecretType")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20210201Preview.SSOSecretType>? SsoSecretType { get; set; }
