...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210903Preview
{
    ...
    public partial class PrivateEndpointConnectionByWorkspace : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionByWorkspace(string name, PrivateEndpointConnectionByWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210903preview:PrivateEndpointConnectionByWorkspace", name, args ?? new PrivateEndpointConnectionByWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionByWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210903preview:PrivateEndpointConnectionByWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:desktopvirtualization/v20210903preview:PrivateEndpointConnectionByWorkspace"},
                    new Pulumi.Alias { Type = "azure-native:desktopvirtualization:PrivateEndpointConnectionByWorkspace"},
                    new Pulumi.Alias { Type = "azure-nextgen:desktopvirtualization:PrivateEndpointConnectionByWorkspace"},
                    new Pulumi.Alias { Type = "azure-native:desktopvirtualization/v20210401preview:PrivateEndpointConnectionByWorkspace"},
                    new Pulumi.Alias { Type = "azure-nextgen:desktopvirtualization/v20210401preview:PrivateEndpointConnectionByWorkspace"},
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PrivateEndpointConnectionByWorkspace Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
