...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210903Preview
{
    public static class GetScalingPlan
    {
        ...
        public static Task<GetScalingPlanResult> InvokeAsync(GetScalingPlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScalingPlanResult>("azure-native:desktopvirtualization/v20210903preview:getScalingPlan", args ?? new GetScalingPlanArgs(), options.WithDefaults());

        /// <summary>
        /// Represents a scaling plan definition.
        /// </summary>
        public static Output<GetScalingPlanResult> Invoke(GetScalingPlanInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetScalingPlanResult>("azure-native:desktopvirtualization/v20210903preview:getScalingPlan", args ?? new GetScalingPlanInvokeArgs(), options.WithDefaults());
    }
