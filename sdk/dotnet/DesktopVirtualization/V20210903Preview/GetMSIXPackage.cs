...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210903Preview
{
    public static class GetMSIXPackage
    {
        ...
        public static Task<GetMSIXPackageResult> InvokeAsync(GetMSIXPackageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMSIXPackageResult>("azure-native:desktopvirtualization/v20210903preview:getMSIXPackage", args ?? new GetMSIXPackageArgs(), options.WithVersion());

        /// <summary>
        /// Schema for MSIX Package properties.
        /// </summary>
        public static Output<GetMSIXPackageResult> Invoke(GetMSIXPackageInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMSIXPackageResult>("azure-native:desktopvirtualization/v20210903preview:getMSIXPackage", args ?? new GetMSIXPackageInvokeArgs(), options.WithVersion());
    }
