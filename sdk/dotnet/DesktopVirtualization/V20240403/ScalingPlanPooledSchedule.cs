...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240403
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20240403:ScalingPlanPooledSchedule")]
    public partial class ScalingPlanPooledSchedule : global::Pulumi.CustomResource
    {
        ...
        public ScalingPlanPooledSchedule(string name, ScalingPlanPooledScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240403:ScalingPlanPooledSchedule", name, args ?? new ScalingPlanPooledScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlanPooledSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240403:ScalingPlanPooledSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("daysOfWeek")]
        private InputList<Union<string, Pulumi.AzureNative.DesktopVirtualization.V20240403.DayOfWeek>>? _daysOfWeek;

        /// <summary>
        /// Set of days of the week on which this schedule is active.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.DesktopVirtualization.V20240403.DayOfWeek>> DaysOfWeek
        {
            get => _daysOfWeek ?? (_daysOfWeek = new InputList<Union<string, Pulumi.AzureNative.DesktopVirtualization.V20240403.DayOfWeek>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240403.SessionHostLoadBalancingAlgorithm>? OffPeakLoadBalancingAlgorithm { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240403.SessionHostLoadBalancingAlgorithm>? PeakLoadBalancingAlgorithm { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240403.SessionHostLoadBalancingAlgorithm>? RampDownLoadBalancingAlgorithm { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240403.StopHostsWhen>? RampDownStopHostsWhen { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240403.SessionHostLoadBalancingAlgorithm>? RampUpLoadBalancingAlgorithm { get; set; }
