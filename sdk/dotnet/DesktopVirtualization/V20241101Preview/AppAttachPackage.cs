...
namespace Pulumi.AzureNative.DesktopVirtualization.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20241101preview:AppAttachPackage")]
    public partial class AppAttachPackage : global::Pulumi.CustomResource
    {
        ...
        public AppAttachPackage(string name, AppAttachPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20241101preview:AppAttachPackage", name, args ?? new AppAttachPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppAttachPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20241101preview:AppAttachPackage", name, null, MakeResourceOptions(options, id))
        {
        }
