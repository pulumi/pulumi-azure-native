...
namespace Pulumi.AzureNative.DesktopVirtualization.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20241101preview:PrivateEndpointConnectionByWorkspace")]
    public partial class PrivateEndpointConnectionByWorkspace : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionByWorkspace(string name, PrivateEndpointConnectionByWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20241101preview:PrivateEndpointConnectionByWorkspace", name, args ?? new PrivateEndpointConnectionByWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionByWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20241101preview:PrivateEndpointConnectionByWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
