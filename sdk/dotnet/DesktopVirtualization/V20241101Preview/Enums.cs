...
namespace Pulumi.AzureNative.DesktopVirtualization.V20241101Preview
{
    ...
    public readonly struct ScalingMethod : IEquatable<ScalingMethod>
    {
        ...
        private ScalingMethod(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static ScalingMethod PowerManage { get; } = new ScalingMethod("PowerManage");
        /// <summary>
        ...
        /// </summary>
        public static ScalingMethod CreateDeletePowerManage { get; } = new ScalingMethod("CreateDeletePowerManage");

        public static bool operator ==(ScalingMethod left, ScalingMethod right) => left.Equals(right);
        public static bool operator !=(ScalingMethod left, ScalingMethod right) => !left.Equals(right);

        public static explicit operator string(ScalingMethod value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ScalingMethod other && Equals(other);
        public bool Equals(ScalingMethod other) => string.Equals(_value, other._value, StringComparison.Ordinal);
