...
namespace Pulumi.AzureNative.DesktopVirtualization.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20241101preview:ScalingPlanPooledSchedule")]
    public partial class ScalingPlanPooledSchedule : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("createDelete")]
        public Output<Outputs.CreateDeletePropertiesResponse?> CreateDelete { get; private set; } = null!;
        ...
        /// </summary>
        [Output("scalingMethod")]
        public Output<string?> ScalingMethod { get; private set; } = null!;
        ...
        public ScalingPlanPooledSchedule(string name, ScalingPlanPooledScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20241101preview:ScalingPlanPooledSchedule", name, args ?? new ScalingPlanPooledScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlanPooledSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20241101preview:ScalingPlanPooledSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScalingPlanPooledScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createDelete")]
        public Input<Inputs.CreateDeletePropertiesArgs>? CreateDelete { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20241101Preview.SessionHostLoadBalancingAlgorithm>? OffPeakLoadBalancingAlgorithm { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20241101Preview.SessionHostLoadBalancingAlgorithm>? PeakLoadBalancingAlgorithm { get; set; }
        ...
        /// Capacity threshold for ramp down period.
        /// </summary>
        [Input("rampDownCapacityThresholdPct", required: true)]
        public Input<int> RampDownCapacityThresholdPct { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20241101Preview.SessionHostLoadBalancingAlgorithm>? RampDownLoadBalancingAlgorithm { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20241101Preview.StopHostsWhen>? RampDownStopHostsWhen { get; set; }
        ...
        /// Capacity threshold for ramp up period.
        /// </summary>
        [Input("rampUpCapacityThresholdPct", required: true)]
        public Input<int> RampUpCapacityThresholdPct { get; set; } = null!;

        /// <summary>
        /// Load balancing algorithm for ramp up period.
        /// </summary>
        [Input("rampUpLoadBalancingAlgorithm")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20241101Preview.SessionHostLoadBalancingAlgorithm>? RampUpLoadBalancingAlgorithm { get; set; }
        ...
        /// </summary>
        [Input("scalingMethod")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20241101Preview.ScalingMethod>? ScalingMethod { get; set; }
