...
namespace Pulumi.AzureNative.DesktopVirtualization.V20230707Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20230707preview:PrivateEndpointConnectionByHostPool")]
    public partial class PrivateEndpointConnectionByHostPool : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionByHostPool(string name, PrivateEndpointConnectionByHostPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20230707preview:PrivateEndpointConnectionByHostPool", name, args ?? new PrivateEndpointConnectionByHostPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionByHostPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20230707preview:PrivateEndpointConnectionByHostPool", name, null, MakeResourceOptions(options, id))
        {
        }
