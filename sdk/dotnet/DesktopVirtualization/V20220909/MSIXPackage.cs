...
namespace Pulumi.AzureNative.DesktopVirtualization.V20220909
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:desktopvirtualization/v20220909:MSIXPackage is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:MSIXPackage to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20220909:MSIXPackage")]
    public partial class MSIXPackage : global::Pulumi.CustomResource
    {
        ...
        public MSIXPackage(string name, MSIXPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20220909:MSIXPackage", name, args ?? new MSIXPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MSIXPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20220909:MSIXPackage", name, null, MakeResourceOptions(options, id))
        {
        }
