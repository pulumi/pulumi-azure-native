...
namespace Pulumi.AzureRM.DesktopVirtualization.V20190123Preview
{
    public static class GetHostPool
    {
        public static Task<GetHostPoolResult> InvokeAsync(GetHostPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHostPoolResult>("azurerm:desktopvirtualization/v20190123preview:getHostPool", args ?? new GetHostPoolArgs(), options.WithVersion());
    }
