...
namespace Pulumi.AzureRM.DesktopVirtualization.V20190123Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var application = new AzureRM.DesktopVirtualization.V20190123Preview.Application("application", new AzureRM.DesktopVirtualization.V20190123Preview.ApplicationArgs
    ///         {
    ...
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/v20190123preview:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/v20190123preview:Application", name, null, MakeResourceOptions(options, id))
        {
        }
