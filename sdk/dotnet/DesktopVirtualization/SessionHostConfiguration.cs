...
namespace Pulumi.AzureNative.DesktopVirtualization
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization:SessionHostConfiguration")]
    public partial class SessionHostConfiguration : Pulumi.CustomResource
    {
        ...
        public SessionHostConfiguration(string name, SessionHostConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization:SessionHostConfiguration", name, args ?? new SessionHostConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SessionHostConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization:SessionHostConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:desktopvirtualization/v20210513preview:SessionHostConfiguration"},
    ...
    public sealed class SessionHostConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("diskType")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.VirtualMachineDiskType>? DiskType { get; set; }
