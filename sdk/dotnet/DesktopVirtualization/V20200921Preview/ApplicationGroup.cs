...
namespace Pulumi.AzureNextGen.DesktopVirtualization.V20200921Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:desktopvirtualization/v20200921preview:ApplicationGroup")]
    public partial class ApplicationGroup : Pulumi.CustomResource
    {
        ...
        public ApplicationGroup(string name, ApplicationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:desktopvirtualization/v20200921preview:ApplicationGroup", name, args ?? new ApplicationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:desktopvirtualization/v20200921preview:ApplicationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApplicationGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20200921Preview.ApplicationGroupType> ApplicationGroupType { get; set; } = null!;
