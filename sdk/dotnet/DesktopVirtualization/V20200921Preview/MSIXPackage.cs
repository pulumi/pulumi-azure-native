...
namespace Pulumi.AzureNative.DesktopVirtualization.V20200921Preview
{
    ...
    public partial class MSIXPackage : Pulumi.CustomResource
    {
        ...
        public MSIXPackage(string name, MSIXPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20200921preview:MSIXPackage", name, args ?? new MSIXPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MSIXPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20200921preview:MSIXPackage", name, null, MakeResourceOptions(options, id))
        {
        }
