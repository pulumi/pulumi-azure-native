...
namespace Pulumi.AzureNextGen.DesktopVirtualization.V20210114Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:desktopvirtualization/v20210114preview:MSIXPackage")]
    public partial class MSIXPackage : Pulumi.CustomResource
    {
        ...
        public MSIXPackage(string name, MSIXPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:desktopvirtualization/v20210114preview:MSIXPackage", name, args ?? new MSIXPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MSIXPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:desktopvirtualization/v20210114preview:MSIXPackage", name, null, MakeResourceOptions(options, id))
        {
        }
