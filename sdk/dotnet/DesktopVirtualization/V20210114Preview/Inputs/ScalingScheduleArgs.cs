...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210114Preview.Inputs
{
    ...
    public sealed class ScalingScheduleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20210114Preview.SessionHostLoadBalancingAlgorithm>? RampUpLoadBalancingAlgorithm { get; set; }
