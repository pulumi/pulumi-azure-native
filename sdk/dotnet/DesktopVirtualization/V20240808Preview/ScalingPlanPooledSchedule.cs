...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240808Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20240808preview:ScalingPlanPooledSchedule")]
    public partial class ScalingPlanPooledSchedule : global::Pulumi.CustomResource
    {
        ...
        public ScalingPlanPooledSchedule(string name, ScalingPlanPooledScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240808preview:ScalingPlanPooledSchedule", name, args ?? new ScalingPlanPooledScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlanPooledSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240808preview:ScalingPlanPooledSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
