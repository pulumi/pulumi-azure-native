...
namespace Pulumi.AzureNative.DesktopVirtualization.V20231004Preview
{
    public static class GetScalingPlan
    {
        ...
        public static Task<GetScalingPlanResult> InvokeAsync(GetScalingPlanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScalingPlanResult>("azure-native:desktopvirtualization/v20231004preview:getScalingPlan", args ?? new GetScalingPlanArgs(), options.WithDefaults());

        /// <summary>
        /// Get a scaling plan.
        /// </summary>
        public static Output<GetScalingPlanResult> Invoke(GetScalingPlanInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScalingPlanResult>("azure-native:desktopvirtualization/v20231004preview:getScalingPlan", args ?? new GetScalingPlanInvokeArgs(), options.WithDefaults());
