...
namespace Pulumi.AzureNative.DesktopVirtualization.V20231004Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20231004preview:ScalingPlanPersonalSchedule")]
    public partial class ScalingPlanPersonalSchedule : global::Pulumi.CustomResource
    {
        ...
        public ScalingPlanPersonalSchedule(string name, ScalingPlanPersonalScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20231004preview:ScalingPlanPersonalSchedule", name, args ?? new ScalingPlanPersonalScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlanPersonalSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20231004preview:ScalingPlanPersonalSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScalingPlanPersonalScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.SessionHandlingOperation>? OffPeakActionOnDisconnect { get; set; }

        /// <summary>
        /// Action to be taken after a logoff during the off-peak period.
        /// </summary>
        [Input("offPeakActionOnLogoff")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.SessionHandlingOperation>? OffPeakActionOnLogoff { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.SetStartVMOnConnect>? OffPeakStartVMOnConnect { get; set; }

        /// <summary>
        /// Action to be taken after a user disconnect during the peak period.
        /// </summary>
        [Input("peakActionOnDisconnect")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.SessionHandlingOperation>? PeakActionOnDisconnect { get; set; }

        /// <summary>
        /// Action to be taken after a logoff during the peak period.
        /// </summary>
        [Input("peakActionOnLogoff")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.SessionHandlingOperation>? PeakActionOnLogoff { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.SetStartVMOnConnect>? PeakStartVMOnConnect { get; set; }

        /// <summary>
        /// Action to be taken after a user disconnect during the ramp down period.
        /// </summary>
        [Input("rampDownActionOnDisconnect")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.SessionHandlingOperation>? RampDownActionOnDisconnect { get; set; }

        /// <summary>
        /// Action to be taken after a logoff during the ramp down period.
        /// </summary>
        [Input("rampDownActionOnLogoff")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.SessionHandlingOperation>? RampDownActionOnLogoff { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.SetStartVMOnConnect>? RampDownStartVMOnConnect { get; set; }

        /// <summary>
        /// Action to be taken after a user disconnect during the ramp up period.
        /// </summary>
        [Input("rampUpActionOnDisconnect")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.SessionHandlingOperation>? RampUpActionOnDisconnect { get; set; }

        /// <summary>
        /// Action to be taken after a logoff during the ramp up period.
        /// </summary>
        [Input("rampUpActionOnLogoff")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.SessionHandlingOperation>? RampUpActionOnLogoff { get; set; }

        /// <summary>
        /// The desired startup behavior during the ramp up period for personal vms in the hostpool.
        /// </summary>
        [Input("rampUpAutoStartHosts")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.StartupBehavior>? RampUpAutoStartHosts { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20231004Preview.SetStartVMOnConnect>? RampUpStartVMOnConnect { get; set; }
