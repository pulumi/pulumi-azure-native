...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210513Preview
{
    public static class GetHostPool
    {
        ...
        public static Task<GetHostPoolResult> InvokeAsync(GetHostPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHostPoolResult>("azure-native:desktopvirtualization/v20210513preview:getHostPool", args ?? new GetHostPoolArgs(), options.WithVersion());
    }
    ...
    public sealed class GetHostPoolResult
    {
        ...
        /// </summary>
        public readonly Outputs.SessionHostComponentUpdateConfigurationPropertiesResponse? SessionHostComponentUpdateConfiguration;
        ...
        private GetHostPoolResult(
            ...
            Outputs.SessionHostComponentUpdateConfigurationPropertiesResponse? sessionHostComponentUpdateConfiguration,
            ...
            string? vmTemplate)
        {
            ...
            Ring = ring;
            SessionHostComponentUpdateConfiguration = sessionHostComponentUpdateConfiguration;
            Sku = sku;
