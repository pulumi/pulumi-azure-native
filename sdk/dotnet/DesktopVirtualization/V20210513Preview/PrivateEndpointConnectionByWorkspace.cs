...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210513Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20210513preview:PrivateEndpointConnectionByWorkspace")]
    public partial class PrivateEndpointConnectionByWorkspace : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionByWorkspace(string name, PrivateEndpointConnectionByWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210513preview:PrivateEndpointConnectionByWorkspace", name, args ?? new PrivateEndpointConnectionByWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionByWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210513preview:PrivateEndpointConnectionByWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
